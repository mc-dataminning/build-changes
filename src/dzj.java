...
public class dzj extends dzd<ebi> {
   private static final is[] a = is.values();

   public dzj(Codec<ebi> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dzf<ebi> $$0) {
      ebi $$1 = $$0.f();
      ayg $$2 = $$0.d();
      in $$3 = $$0.e();
      day $$4 = $$0.b();
      int $$5 = $$1.l;
      int $$6 = $$1.n;
      List<Pair<in, Integer>> $$7 = Lists.newLinkedList();
      int $$8 = $$1.j.a($$2);
      dwy $$9 = new dwy(new dwa($$4.C()));
      eld $$10 = eld.a($$9, -4, 1.0);
      List<in> $$11 = Lists.newLinkedList();
      ...
      List<in> $$31 = Lists.newArrayList();
      Predicate<dqh> $$32 = a($$1.c.g);

      for (in $$33 : in.c($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         double $$34 = $$10.a((double)$$33.u(), (double)$$33.v(), (double)$$33.w()) * $$1.o;
         double $$35 = 0.0;
         double $$36 = 0.0;

         for (Pair<in, Integer> $$37 : $$7) {
            $$35 += axz.f($$33.j((jr)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (in $$38 : $$11) {
            $$36 += axz.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, ddg.a.n(), $$32);
      ...
      for (in $$44 : $$31) {
         ...
         for (is $$46 : a) {
            ...
            dqh $$48 = $$4.a_($$47);
            if ($$45.b(dqx.C)) {
               $$45 = $$45.a(dqx.C, Boolean.valueOf($$48.u().b()));
            }
