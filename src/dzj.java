...
@Deprecated
public class dzj extends dyu<dzj.a> {
   private static final dpy a = dcx.nc.n();

   public dzj(Codec<dzj.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dyw<dzj.a> $$0) {
      im $$1 = $$0.e();
      dap $$2 = $$0.b();
      ayd $$3 = $$0.d();
      dzj.a $$4 = $$0.f();
   ...
   public static record a(ecz b, ecz c) implements eay {
      public static final Codec<dzj.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(ecz.a.fieldOf("fluid").forGetter(dzj.a::a), ecz.a.fieldOf("barrier").forGetter(dzj.a::b)).apply($$0, dzj.a::new)
      );
