...
public class ern {
   ...
   private void a(n $$0, ui $$1) {
      this.b.l.d().a(ui.i().b(ui.c("debug.prefix").a($$0, n.r)).b(uh.u).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(ui.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.l(2)) {
                  ...
                  this.b.s.cn.d("gamemode " + ((cqw)MoreObjects.firstNonNull(this.b.q.k(), cqw.b)).b());
               }
            ...
            case 81:
               ...
               etk $$3 = this.b.l.d();
               $$3.a(ui.c("debug.reload_chunks.help"));
               $$3.a(ui.c("debug.show_hitboxes.help"));
               $$3.a(ui.c("debug.copy_location.help"));
               $$3.a(ui.c("debug.clear_chat.help"));
               $$3.a(ui.c("debug.chunk_boundaries.help"));
               $$3.a(ui.c("debug.advanced_tooltips.help"));
               $$3.a(ui.c("debug.inspect.help"));
               $$3.a(ui.c("debug.profiling.help"));
               $$3.a(ui.c("debug.creative_spectator.help"));
               $$3.a(ui.c("debug.pause_focus.help"));
               $$3.a(ui.c("debug.help.help"));
               $$3.a(ui.c("debug.dump_dynamic_textures.help"));
               $$3.a(ui.c("debug.reload_resourcepacks.help"));
               $$3.a(ui.c("debug.pause.help"));
               $$3.a(ui.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.p.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.Y().a($$5);
               ui $$6 = ui.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new ug(ug.a.b, $$5.toFile().toString())));
            ...
            case b:
               ...
               if ($$0) {
                  if ($$1) {
                     ...
                     ddx $$5 = this.b.s.dL().c_($$3);
                     rt $$6 = $$5 != null ? $$5.o() : null;
                     this.a($$4, $$3, $$6);
   ...
   private void a(dgb $$0, ht $$1, @Nullable rt $$2) {
   ...
   private void a(afw $$0, eif $$1, @Nullable rt $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = sg.c((sn)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aM().i()) {
         boolean $$5 = elc.a(ero.O().aM().i(), 292);
         if (this.d > 0L) {
            if (!elc.a(ero.O().aM().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (elc.a(ero.O().aM().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof ezx) || ((ezx)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aM().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               erz.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aV().a() && this.b.m.r().c()) {
            boolean $$7 = $$6 == null || !($$6.t() instanceof ets) || !((ets)$$6.t()).e();
            if ($$3 != 0 && $$1 == 66 && ezd.p() && $$7) {
               boolean $$8 = this.b.m.ao().c() == erq.a;
               this.b.m.ao().a(erq.a(this.b.m.ao().c().a() + 1));
               if ($$6 instanceof ezf) {
                  ((ezf)$$6).l();
               }
         ...
         if (this.b.y == null || this.b.y instanceof eyz $$10 && !$$10.l()) {
            elc.a $$11 = elc.a($$1, $$2);
            if ($$3 == 0) {
               erm.a($$11, false);
               if ($$1 == 292) {
      ...
      if ($$0 == this.b.aM().i()) {
         ...
         if ($$3 != null && this.b.aJ() == null) {
            if (Character.charCount($$1) == 1) {
               ezd.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  ezd.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", asy.f((float)$$1 / 1000.0F));
            }
