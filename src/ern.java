...
public class ern extends ghw {
   ...
   private static final uv z = uv.c("mco.upload.verifying");
   private final erg A;
   private final eet B;
   ...
   private volatile uv H = uv.c("mco.upload.preparing");
   ...
   public ern(long $$0, int $$1, erg $$2, eet $$3) {
      super(eta.a);
      this.C = $$0;
      this.D = $$1;
      this.A = $$2;
   ...
   @Override
   public void aQ_() {
      this.N = this.d(eve.a(uu.k, $$0 -> this.C()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.N.j = false;
      this.O = this.d(eve.a(uu.e, $$0 -> this.D()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.M) {
         if (this.A.b == -1) {
            this.F();
         } else {
   ...
   private void C() {
      this.f.a(new eqr(new eom(new fbe()), this.C));
   }
   ...
   private void d(eut $$0) {
      ...
      $$0.a(this.i, uv.a("mco.upload.percent", this.I), this.g / 2, 84, 16777215);
   }
   ...
   private uv E() {
      List<uv> $$0 = Lists.newArrayList();
      $$0.add(this.H);
      if (this.I != null) {
         $$0.add(uv.a("mco.upload.percent", this.I));
      }
            ...
            () -> {
               ...
               try {
                  if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                     this.H = uv.c("mco.upload.close.failure");
                  } else {
                     epw $$3 = null;
                     ...
                     if ($$3 == null) {
                        ...
                        if (!$$3.c()) {
                           ...
                           if (this.J) {
                              ...
                              this.H = uv.a("mco.upload.uploading", this.B.b());
                              eop $$11 = new eop($$0, this.C, this.D, $$3, this.f.U(), aa.b().c(), this.E);
                              $$11.a($$1x -> {
                                 if ($$1x.a >= 200 && $$1x.a < 300) {
                                    this.K = true;
                                    this.H = uv.c("mco.upload.done");
                                    this.N.b(uu.d);
                                    esa.b($$2);
                                 } else if ($$1x.a == 400 && $$1x.b != null) {
                                    this.a(uv.a("mco.upload.failed", $$1x.b));
                                 } else {
                                    this.a(uv.a("mco.upload.failed", $$1x.a));
                                 }
                              });
                              ...
                              long $$7 = $$0.length();
                              eon $$8 = eon.a($$7);
                              eon $$9 = eon.a(5368709120L);
                              if (eon.b($$7, $$8).equals(eon.b(5368709120L, $$9)) && $$8 != eon.a) {
                                 eon $$10 = eon.values()[$$8.ordinal() - 1];
                                 this.a(
                                    uv.a("mco.upload.size.failure.line1", this.B.b()),
                                    uv.a("mco.upload.size.failure.line2", eon.b($$7, $$10), eon.b(5368709120L, $$10))
                                 );
                              } else {
                                 this.a(
                                    uv.a("mco.upload.size.failure.line1", this.B.b()),
                                    uv.a("mco.upload.size.failure.line2", eon.b($$7, $$8), eon.b(5368709120L, $$9))
                                 );
                              }
                           }
                        }
                  ...
                  this.a(uv.a("mco.upload.failed", var21.getMessage()));
               } catch (eqe var22) {
                  this.a(uv.a("mco.upload.failed", var22.a.b()));
   ...
   private void G() {
      this.H = uv.c("mco.upload.cancelled");
