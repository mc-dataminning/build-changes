...
public class fkb {
   private static final ajt a = new ajt("advancements/title_box");
   ...
   private final aww r;
   private final int s;
   private final List<aww> t;
   private final fbp u;
   @Nullable
   private fkb v;
   private final List<fkb> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fkb(fjz $$0, fbp $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = th.a().a($$1.h.a($$3.a(), 163));
      this.y = axk.d($$3.f() * 28.0F);
      this.z = axk.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = th.a().a(this.a(wj.a($$3.b().f(), xd.a.a($$3.e().a())), $$7));
   ...
   private static float a(fcb $$0, List<wl> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<wl> a(wg $$0, int $$1) {
      fcb $$2 = this.u.h.b();
      List<wl> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<wl> $$6 = $$2.b($$0, $$1 - $$5, xd.a);
   ...
   public void a(fdc $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      boolean $$6 = $$4 + $$1 + this.y + this.s + 26 >= this.o.f().k;
      wg $$7 = this.x == null ? null : this.x.d();
      int $$8 = $$7 == null ? 0 : this.u.h.a($$7);
      boolean $$9 = 113 - $$2 - this.z - 26 <= 6 + this.t.size() * 9;
      float $$10 = this.x == null ? 0.0F : this.x.c();
      int $$11 = axk.d($$10 * (float)this.s);
      fkc $$12;
      fkc $$13;
      fkc $$14;
      if ($$10 >= 1.0F) {
