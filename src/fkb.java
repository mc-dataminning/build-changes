public class fkb extends hhp {
   ...
   public void aT_() {
      ...
      fny $$2 = fny.a(xv.c($$1), $$0x -> {
         if (this.D.e == fic.c.b) {
            this.m.a(fjx.a(this, xv.c("mco.configure.world.close.question.line1"), $$0xx -> this.C.b()));
         } else {
            this.C.b(false);
         }
      }).a(this.n / 2 - 53, g(0), 106, 20).a();
      this.c($$2);
      this.F = new foh(this.m.h, $$0, g(4), 212, 20, xv.c("mco.configure.world.name"));
      this.F.f(32);
      this.F.a(this.D.b());
      this.c(this.F);
      this.E = new foh(this.m.h, $$0, g(8), 212, 20, xv.c("mco.configure.world.description"));
      this.E.f(32);
      this.E.a(this.D.a());
      this.c(this.E);
      fny $$3 = this.c(fny.a(xv.c("mco.configure.world.buttons.done"), $$0x -> this.g()).a($$0 - 2, g(12), 106, 20).a());
      this.F.b($$1x -> $$3.j = !bbb.h($$1x));
      this.c(fny.a(xu.e, $$0x -> this.aP_()).a(this.n / 2 + 2, g(12), 106, 20).a());
   }
