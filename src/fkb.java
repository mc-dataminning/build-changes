...
public enum fkb {
   ...
   private fkb(final String... $$0) {
      this.c = $$0;
   }

   public List<auz<InputStream>> a(att $$0) throws IOException {
      return List.of(
   ...
   public auz<InputStream> b(att $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private auz<InputStream> a(att $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      auz<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
