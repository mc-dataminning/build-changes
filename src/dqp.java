...
@Deprecated
public class dqp extends dqa<dqp.a> {
   private static final dhn a = cvh.nc.o();

   public dqp(Codec<dqp.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dqc<dqp.a> $$0) {
      hx $$1 = $$0.e();
      csz $$2 = $$0.b();
      atw $$3 = $$0.d();
      dqp.a $$4 = $$0.f();
   ...
   public static record a(duf b, duf c) implements dse {
      public static final Codec<dqp.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(duf.a.fieldOf("fluid").forGetter(dqp.a::a), duf.a.fieldOf("barrier").forGetter(dqp.a::b)).apply($$0, dqp.a::new)
      );
