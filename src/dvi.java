...
public abstract class dvi {
   public static final Codec<dvi> a = jd.U.q().dispatch(dvi::e, dvr::codec);
   public static final Codec<hg<dvi>> b = aet.a(je.az, a);
   ...
   public dvq a(hu $$0, dhg $$1, cqx $$2, dlg $$3, dzc $$4, long $$5, cpc $$6, int $$7, cpx $$8, Predicate<hg<cqt>> $$9) {
   ...
   public static record a(hu a, dhg b, cqx c, dlg d, dzc e, dlr f, long g, cpc h, cpx i, Predicate<hg<cqt>> j) {

      public a(hu $$0, dhg $$1, cqx $$2, dlg $$3, dzc $$4, long $$5, cpc $$6, cpx $$7, Predicate<hg<cqt>> $$8) {
   ...
   public static record c(hk<cqt> b, Map<bjj, dvp> c, dko.b d, dvt e) {
      public static final MapCodec<dvi.c> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  hv.a(je.ap).fieldOf("biomes").forGetter(dvi.c::a),
