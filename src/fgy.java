...
public abstract class fgy<E extends fgy.a<E>> extends fgv {
   ...
   private final List<E> p = new fgy.b();
   ...
   public fgy(ffe $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xn.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = ayy.a($$1 - (double)this.D()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.l() ? this.aD_().get($$7) : null;
   }

   public void a(int $$0, fkq $$1) {
      this.b($$0, $$1.d(), $$1.c());
   }
   ...
   protected void a(fgq $$0) {
      RenderSystem.enableBlend();
      ale $$1 = this.c.r == null ? fnc.h : fnc.j;
      ale $$2 = this.c.r == null ? fnc.i : fnc.k;
   ...
   public void a(double $$0) {
      this.q = ayy.a($$0, 0.0, (double)this.o());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.D()) {
            ...
            int $$6 = this.h;
            int $$7 = ayy.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(flh $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(flh $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fkx.a t() {
      if (this.aH_()) {
         ...
         return this.v != null ? fkx.a.b : fkx.a.a;
      }
   }
   ...
   protected void a(fkz $$0, E $$1) {
      List<E> $$2 = this.aD_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fky.b, xo.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fgy.a<E>> implements fiz {
      @Deprecated
      fgy<E> a;
      ...
      public abstract void a(fgq var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
