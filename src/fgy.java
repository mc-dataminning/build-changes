...
public record fgy(int i, int j, fgy.a k, fgy.b l, int m) {
   public static final int a = 32;
   private static final fgy[] n = new fgy[32];
   private static final List<fgy> o = new ArrayList<>(32);
   public static final fgy b = a(0, 0, fgy.a.a, fgy.b.a, 3);
   public static final fgy c = a(1, 0, fgy.a.b, fgy.b.c, 4);
   public static final fgy d = a(2, 0, fgy.a.a, fgy.b.d, 2);
   public static final fgy e = d;
   public static final fgy f = a(3, 1, fgy.a.e, fgy.b.d, 2);
   public static final fgy g = a(4, 2, fgy.a.e, fgy.b.d, 2);
   public static final fgy h = a(5, 0, fgy.a.c, fgy.b.b, 3);

   public fgy(int i, int j, fgy.a k, fgy.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fgy a(int $$0, int $$1, fgy.a $$2, fgy.b $$3, int $$4) {
      fgy $$5 = new fgy($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, fgy.b $$1) {
      return $$0 == 0 || $$1 == fgy.b.d;
   }
   ...
   public static Stream<fgy> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fgy.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
