...
public class fgy {
   ...
   private static final Comparator<eww> K = Comparator.comparing(eww::d).reversed().thenComparing(eww::c, String.CASE_INSENSITIVE_ORDER);
   ...
   public float a = 1.0F;
   private int ae;
   private cua af = cua.l;
   private final fhu ag;
   private final fiu ah;
   private final fjl ai;
   private final fin aj;
   private final fhl ak;
   private int al;
   @Nullable
   private wu am;
   @Nullable
   ...
   public fgy(ffn $$0) {
      ...
      this.ai = new fjl($$0);
      this.Y = new fhn($$0);
      this.aj = new fin($$0, this);
      this.ak = new fhl($$0);
      this.ah = new fiu($$0);
      this.a();
      fhb $$1 = new fhb().a(this::c).a(this::j).a(this::l).a(this::n).a(this::k).a(($$0x, $$1x) -> this.ak.a($$0x));
      fhb $$2 = new fhb().a(this::o).a(($$0x, $$1x) -> {
         if (this.ag.d()) {
            this.ag.a($$0x);
         }
   ...
   private void c(fgz $$0, float $$1) {
      if (ffn.N()) {
         this.a($$0, this.X.an());
      }

      float $$2 = this.X.au();
      this.ay = aye.i(0.5F * $$2, this.ay, 1.125F);
      if (this.X.m.aA().a()) {
         if (this.X.s.gw()) {
            this.p($$0, this.ay);
         } else {
            this.ay = 0.5F;
            cua $$3 = this.X.s.fY().e(3);
            if ($$3.a(dfh.ee.r())) {
               this.a($$0, H, 1.0F);
            }
         }
      ...
      float $$4 = aye.i($$1, this.X.s.cK, this.X.s.cJ);
      if ($$4 > 0.0F && !this.X.s.b(brn.i)) {
         this.q($$0, $$4);
      }
   }

   private void d(fgz $$0, float $$1) {
      if (this.X.s.gc() > 0) {
         this.X.aI().a("sleep");
         float $$2 = (float)this.X.s.gc();
         float $$3 = $$2 / 100.0F;
         if ($$3 > 1.0F) {
         ...
         $$0.a(gef.E(), 0, 0, $$0.a(), $$0.b(), $$4);
         this.X.aI().c();
      }
   }

   private void e(fgz $$0, float $$1) {
      fgx $$2 = this.f();
      if (this.aa != null && this.ab > 0) {
         ...
         if ($$4 > 8) {
            ...
            int $$5 = 16777215;
            if (this.ac) {
               $$5 = aye.h($$3 / 50.0F, 0.7F, 0.6F) & 16777215;
            }
   ...
   private void g(fgz $$0, float $$1) {
      if (!this.Y.e()) {
         ezk $$2 = this.X.aO();
         int $$3 = aye.a(this.X.n.e() * (double)$$2.o() / (double)$$2.m());
         int $$4 = aye.a(this.X.n.f() * (double)$$2.p() / (double)$$2.n());
         this.Y.a($$0, this.Z, $$3, $$4, false);
      }
   }

   private void h(fgz $$0, float $$1) {
      exd $$2 = this.X.r.M();
      ewv $$3 = null;
      ewy $$4 = $$2.e(this.X.s.cB());
      if ($$4 != null) {
         ewu $$5 = ewu.a($$4.n());
         if ($$5 != null) {
            $$3 = $$2.a($$5);
      ...
      ewv $$6 = $$3 != null ? $$3 : $$2.a(ewu.b);
      if ($$6 != null) {
         this.a($$0, $$6);
      }
   }

   private void i(fgz $$0, float $$1) {
      exd $$2 = this.X.r.M();
      ewv $$3 = $$2.a(ewu.a);
      if (!this.X.m.K.e() || this.X.T() && this.X.s.cB.l().size() <= 1 && $$3 == null) {
         this.aj.a(false);
      } else {
         this.aj.a(true);
         this.aj.a($$0, $$0.a(), $$2, $$3);
   ...
   private void a(fgz $$0, fgx $$1, int $$2, int $$3, int $$4) {
   ...
   private void j(fgz $$0, float $$1) {
      ffr $$2 = this.X.m;
      if ($$2.aA().a()) {
         if (this.X.q.j() != dca.d || this.a(this.X.v)) {
            RenderSystem.enableBlend();
            if (this.ag.d() && !this.X.s.go() && !$$2.V().c()) {
               fey $$3 = this.X.j.l();
               ...
               if (this.X.m.D().c() == fex.b) {
                  float $$6 = this.X.s.E(0.0F);
                  boolean $$7 = false;
                  if (this.X.u != null && this.X.u instanceof bsy && $$6 >= 1.0F) {
                     $$7 = this.X.s.gr() > 5.0F;
                     $$7 &= this.X.u.bD();
                  }
   ...
   private boolean a(@Nullable evx $$0) {
      if ($$0 == null) {
         return false;
      } else if ($$0.c() == evx.a.c) {
         return ((evw)$$0).a() instanceof bqh;
      } else if ($$0.c() == evx.a.b) {
         ja $$1 = ((evv)$$0).a();
         dcd $$2 = this.X.r;
   ...
   private void k(fgz $$0, float $$1) {
      Collection<brl> $$2 = this.X.s.et();
      if (!$$2.isEmpty()) {
         if (this.X.y instanceof fok $$3 && $$3.K()) {
            return;
         }
         ...
         for (brl $$8 : Ordering.natural().reverse().sortedCopy($$2)) {
            jj<brj> $$9 = $$8.c();
            if ($$8.h()) {
               int $$10 = $$0.a();
               int $$11 = 1;
               ...
               if ($$8.f()) {
                  ...
                  if ($$8.a(200)) {
                     int $$13 = $$8.d();
                     int $$14 = 10 - $$13 / 20;
                     $$12 = aye.a((float)$$13 / 10.0F / 5.0F * 0.5F, 0.0F, 0.5F)
                        + aye.b((float)$$13 * (float) Math.PI / 5.0F) * aye.a((float)$$14 / 10.0F * 0.25F, 0.0F, 0.25F);
                  }
               }
   ...
   private void m(fgz $$0, float $$1) {
      ...
      if ($$2 != null) {
         ...
         $$0.a(i, $$5 - 91 - 1 + $$2.fY().k * 20, $$0.b() - 22 - 1, 24, 23);
         if (!$$3.e()) {
            if ($$4 == bss.a) {
         ...
         for (int $$9 = 0; $$9 < 9; $$9++) {
            int $$10 = $$5 - 90 + $$9 * 20 + 2;
            int $$11 = $$0.b() - 16 - 3;
            this.a($$0, $$10, $$11, $$1, $$2, $$2.fY().h.get($$9), $$8++);
         }
         ...
         if (this.X.m.D().c() == fex.c) {
            RenderSystem.enableBlend();
            float $$13 = this.X.s.E(0.0F);
            if ($$13 < 1.0F) {
               int $$14 = $$0.b() - 20;
               int $$15 = $$5 + 91 + 6;
               if ($$4 == bss.b) {
   ...
   private void a(btj $$0, fgz $$1, int $$2) {
      this.X.aI().a("jumpBar");
      float $$3 = this.X.s.v();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
   ...
   private void a(fgz $$0, int $$1) {
      this.X.aI().a("expBar");
      int $$2 = this.X.s.gh();
      if ($$2 > 0) {
         int $$3 = 182;
         int $$4 = (int)(this.X.s.cs * 183.0F);
         int $$5 = $$0.b() - 32 + 3;
         RenderSystem.enableBlend();
         $$0.a(q, $$1, $$5, 182, 5);
         if ($$4 > 0) {
   ...
   private void o(fgz $$0, float $$1) {
      if (this.X.K()) {
         ...
         if (this.X.r.Z() >= 120500L) {
            ...
            $$2 = wu.a("demo.remainingTime", aza.a((int)(120500L - this.X.r.Z()), this.X.r.s().f()));
         }
   ...
   @Nullable
   private cmh n() {
      return this.X.an() instanceof cmh $$0 ? $$0 : null;
   }
   ...
   private void b(fgz $$0) {
      ...
      if ($$1 != null) {
         ...
         int $$7 = $$0.a() / 2 + 91;
         int $$8 = $$0.b() - 39;
         float $$9 = Math.max((float)$$1.g(bug.s), (float)Math.max($$5, $$2));
         int $$10 = aye.f($$1.fo());
         int $$11 = aye.f(($$9 + (float)$$10) / 2.0F / 10.0F);
         int $$12 = Math.max(10 - ($$11 - 2), 3);
         int $$13 = $$8 - 10;
         int $$14 = -1;
         if ($$1.b(brn.j)) {
            $$14 = this.Z % aye.f($$9 + 5.0F);
         }
         ...
         if ($$1.a(awa.a) || $$18 < $$17) {
            int $$19 = this.a($$16) - 1;
            $$13 -= $$19 * 10;
            int $$20 = aye.c((double)($$18 - 2) * 10.0 / (double)$$17);
            int $$21 = aye.c((double)$$18 * 10.0 / (double)$$17) - $$20;
            RenderSystem.enableBlend();
   ...
   private static void a(fgz $$0, cmh $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$1.eK();
      if ($$6 > 0) {
         RenderSystem.enableBlend();
         int $$7 = $$2 - ($$3 - 1) * $$4 - 10;
   ...
   private void a(fgz $$0, cmh $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      fgy.b $$11 = fgy.b.a($$1);
      boolean $$12 = $$1.dP().A_().l();
      int $$13 = aye.c((double)$$6 / 2.0);
      int $$14 = aye.c((double)$$9 / 2.0);
      int $$15 = $$13 * 2;
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, fgy.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == fgy.b.d ? $$11 : fgy.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(fgz $$0, fgy.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      RenderSystem.enableBlend();
      $$0.a($$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
      RenderSystem.disableBlend();
   }

   private void a(fgz $$0, cmh $$1, int $$2, int $$3) {
      cpa $$4 = $$1.gi();
      int $$5 = $$4.a();
      RenderSystem.enableBlend();
   ...
   private void a(fgz $$0, akk $$1, float $$2) {
      RenderSystem.disableDepthTest();
   ...
   private void p(fgz $$0, float $$1) {
      ...
      RenderSystem.disableBlend();
      $$0.a(gef.E(), 0, $$10, $$0.a(), $$0.b(), -90, -16777216);
      $$0.a(gef.E(), 0, 0, $$0.a(), $$8, -90, -16777216);
      $$0.a(gef.E(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(gef.E(), $$9, $$8, $$0.a(), $$10, -90, -16777216);
   }

   private void a(bsd $$0) {
      ja $$1 = ja.a($$0.du(), $$0.dy(), $$0.dA());
      float $$2 = gdw.a($$0.dP().D_(), $$0.dP().A($$1));
      float $$3 = aye.a(1.0F - $$2, 0.0F, 1.0F);
      this.a = this.a + ($$3 - this.a) * 0.01F;
   }

   private void a(fgz $$0, @Nullable bsd $$1) {
      dty $$2 = this.X.r.C_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
   ...
   private void a(fgz $$0, int $$1, int $$2, float $$3, cmh $$4, cua $$5, int $$6) {
      if (!$$5.e()) {
         float $$7 = (float)$$5.G() - $$3;
         if ($$7 > 0.0F) {
            float $$8 = 1.0F + $$7 / 5.0F;
   ...
   private void p() {
      ...
      if (this.X.s != null) {
         ...
         if ($$1.e()) {
            this.ae = 0;
         } else if (this.af.e() || !$$1.a(this.af.g()) || !$$1.w().equals(this.af.w())) {
   ...
   private void q() {
      ...
      this.aw = this.av;
      this.av = aye.i(0.2F, this.av, $$1 ? 1.0F : 0.0F);
   }
   ...
   public void b(fgz $$0, float $$1) {
      if (this.X.m.af().c() && (this.av > 0.0F || this.aw > 0.0F)) {
         int $$2 = aye.d(255.0F * aye.a(aye.i(this.X.at(), this.aw, this.av), 0.0F, 1.0F));
         if ($$2 > 8) {
            fgx $$3 = this.f();
            int $$4 = $$3.a(M);
