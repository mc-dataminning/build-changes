...
public abstract class fgy extends fhc implements fih, fja {
   private static final fir a = new fir(new alf("widget/text_field"), new alf("widget/text_field_highlighted"));
   ...
   public fgy(int $$0, int $$1, int $$2, int $$3, xp $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(fgr var1, int var2, int var3, float var4);
}
