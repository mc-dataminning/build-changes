...
public class fgy {
   ...
   public void a(fir $$0, String $$1, fjo.a $$2, evw $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fgy.b $$13 = new fgy.b($$1.trim(), this.f, $$3, $$2);
                  fgy.a $$14 = new fgy.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fgy.c $$30 = new fgy.c(this.f, $$2, $$0);
                        fgy.a $$31 = new fgy.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fiv(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, evw $$2) throws IOException {
      ...
      File $$15 = new File(flz.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final evw d;
      private final fjo.a e;

      b(final String $$0, final File $$1, final evw $$2, final fjo.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fgy.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fgy.this.b && !fgy.this.d) {
            try {
               fgy.this.e = true;
               fgy.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fgy.a.error("Error extracting archive", var3);
               fgy.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fjo.a c;
      private final fir d;

      c(final File $$0, final fjo.a $$1, final fir $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fgy.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fgy.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fgy.this.g);
                  fgy.this.c = true;
               } else {
                  fgy.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fgy.this.d = true;
               }
            } catch (IOException var3) {
               fgy.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fgy.this.d = true;
            }
         }
      }
