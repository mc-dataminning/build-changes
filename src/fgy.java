...
public class fgy {
   ...
   public void a(fir $$0, String $$1, fjo.a $$2, evv $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
   ...
   void a(String $$0, @Nullable File $$1, evv $$2) throws IOException {
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final evv $$2, final fjo.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
