...
public class foj {
   ...
   public foc a(Vector3f $$0, Vector3f $$1, foe $$2, fyg $$3, hb $$4, gap $$5, @Nullable fof $$6, boolean $$7, aep $$8) {
      fog $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = aro.i($$11, $$9.a[0], $$12);
      $$9.a[2] = aro.i($$11, $$9.a[2], $$12);
      $$9.a[1] = aro.i($$11, $$9.a[1], $$13);
      $$9.a[3] = aro.i($$11, $$9.a[3], $$13);
      ...
      return new foc($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fog a(fog $$0, hb $$1, j $$2, aep $$3) {
      Matrix4f $$4 = gu.a($$2, $$1, () -> "Unable to resolve UVLock for model: " + $$3).c();
      float $$5 = $$0.a($$0.c(0));
      float $$6 = $$0.b($$0.c(0));
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(aro.b($$23), aro.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fog(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fog $$0, fyg $$1, hb $$2, float[] $$3, j $$4, @Nullable fof $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[hb.values().length];
      $$2[fmx.a.f] = $$0.x() / 16.0F;
      $$2[fmx.a.e] = $$0.y() / 16.0F;
      $$2[fmx.a.d] = $$0.z() / 16.0F;
      $$2[fmx.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, hb $$2, fog $$3, float[] $$4, fyg $$5, j $$6, @Nullable fof $$7, boolean $$8) {
      fmx.b $$9 = fmx.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, fyg $$3, fog $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fof $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static hb a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? hb.b : $$7;
      }
   }

   private void a(int[] $$0, hb $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[hb.values().length];
      $$3[fmx.a.f] = 999.0F;
      $$3[fmx.a.e] = 999.0F;
      $$3[fmx.a.d] = 999.0F;
      $$3[fmx.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (aro.a($$13, $$18) && aro.a($$14, $$19) && aro.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
