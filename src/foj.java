...
public class foj extends foa<cpz> {
   ...
   private void a(fgq $$0, @Nullable eph $$1, @Nullable epj $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.z;
      int $$8 = this.A;
      if ($$4 && !$$6) {
   ...
   private void a(fgq $$0, @Nullable eph $$1, @Nullable epj $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
