...
public abstract class foj<E extends foj.a<E>> extends fog {
   ...
   private final List<E> n = new foj.b();
   ...
   public foj(flh $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wn.a);
      this.c = $$0;
      this.d = $$4;
   }

   public foj(flh $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected final E c(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = ayy.a($$1 - (double)this.G()) - this.f + (int)this.g() - 4;
      int $$7 = $$6 / this.d;
   ...
   protected void b(fob $$0) {
      aku $$1 = this.c.s == null ? fui.h : fui.j;
      aku $$2 = this.c.s == null ? fui.i : fui.k;
      $$0.a(gmf::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(gmf::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(fob $$0) {
      aku $$1 = this.c.s == null ? a : m;
      $$0.a(gmf::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }
   ...
   @Override
   public Optional<fqn> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(fsv $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(fsv $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(fob $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public fsl.a w() {
      if (this.aM_()) {
         ...
         return this.q != null ? fsl.a.b : fsl.a.a;
      }
   }
   ...
   protected void a(fsn $$0, E $$1) {
      List<E> $$2 = this.aH_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fsm.b, wo.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends foj.a<E>> implements fqn {
      @Deprecated
      foj<E> a;
      ...
      public abstract void a(fob var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
