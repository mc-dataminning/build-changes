...
public class aue implements aua {
   ...
   aue(atz $$0, ats $$1, Set<String> $$2, List<Path> $$3, Map<auc, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(auc $$0, alr $$1, Consumer<Path> $$2) {
      w.d($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(auc $$0, String $$1, String $$2, aua.a $$3) {
      w.d($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<alr, avg<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(aua.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      aud.a($$1, $$4, $$3, $$0);
   }
   ...
   public avg<InputStream> a(auc $$0, alr $$1) {
      return (avg<InputStream>)w.d($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = w.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && aud.a($$5)) {
               return avg.create($$5);
            }
         }
   ...
   public <T> T a(aun<T> $$0) {
      avg<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public avr d() {
      return $$0 -> Optional.ofNullable(this.a(auc.a, $$0)).map($$0x -> new avm(this, $$0x));
   }
}
