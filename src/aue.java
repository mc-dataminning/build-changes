...
class aue implements Path {
   private static final BasicFileAttributes a = new auc() {
      @Override
   ...
   private static final BasicFileAttributes b = new auc() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<aue> c = Comparator.comparing(aue::n);
   ...
   public aue(aug $$0, String $$1, @Nullable aue $$2, auh $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private aue a(@Nullable aue $$0, String $$1) {
      return new aue(this.e, $$1, $$0, auh.b);
   }
   ...
   aue a(String $$0) {
      if (a(this.i)) {
         return new aue(this.e, $$0, this, this.i);
      } else if (this.i instanceof auh.a $$1) {
         aue $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new aue(this.e, $$0, this, auh.a);
      } else if (this.i instanceof auh.b) {
         return new aue(this.e, $$0, this, auh.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(auh $$0) {
      return $$0 == auh.a || $$0 == auh.b;
   }
   ...
   private aue c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof aue $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof auh.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public auh.a i() {
      return this.i instanceof auh.a $$0 ? $$0 : null;
   }
