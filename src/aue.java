...
public class aue {
   ...
   public static ih<cmt> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return kd.h
            .b(ahf.a(ke.F, new ahg($$2)))
   ...
   public static ih<cmt> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ih<cmt> a(JsonObject $$0, String $$1, @Nullable ih<cmt> $$2) {
