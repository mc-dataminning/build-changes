...
public class aue implements aub {
   ...
   private final Map<String, auc> c;
   private final List<asx> d;

   public aue(asz $$0, List<asx> $$1) {
      this.d = List.copyOf($$1);
      Map<String, auc> $$2 = new HashMap<>();
   ...
   public Map<alb, auj> b(String $$0, Predicate<alb> $$1) {
      a($$0);
      Map<alb, auj> $$2 = new TreeMap<>();

      for (auc $$3 : this.c.values()) {
         $$2.putAll($$3.b($$0, $$1));
      }
   ...
   public Map<alb, List<auj>> c(String $$0, Predicate<alb> $$1) {
      a($$0);
      Map<alb, List<auj>> $$2 = new TreeMap<>();
