public class giv extends gjq {
   private final gjl a;

   giv(gfi $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gjl $$7) {
   ...
   public static class a implements git<lw> {
      ...
      public giq a(lw $$0, gfi $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new giv($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements git<lw> {
      ...
      public giq a(lw $$0, gfi $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         giq $$8 = new giv($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
