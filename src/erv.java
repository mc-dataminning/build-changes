...
public class erv {
   ...
   private final eql d;
   private final elf e;
   private final fnu.a f;
   private final erv.a g = new erv.a();
   private final erw h;
   private boolean i;

   private erv(eql $$0, elf $$1, fnu.a $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.h = $$0.aF();
   ...
   public void a(int $$0, int $$1, int $$2, int $$3) {
      this.a(foc.C(), $$0, $$1, $$2, $$3);
   }

   public void a(foc $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$2 < $$1) {
         int $$5 = $$1;
         $$1 = $$2;
         $$2 = $$5;
   ...
   public void b(int $$0, int $$1, int $$2, int $$3) {
      this.b(foc.C(), $$0, $$1, $$2, $$3);
   }

   public void b(foc $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$3 < $$2) {
         int $$5 = $$2;
         $$2 = $$3;
         $$3 = $$5;
   ...
   public void c(int $$0, int $$1, int $$2, int $$3) {
      this.a(this.g.a(new ewi($$0, $$1, $$2 - $$0, $$3 - $$1)));
   }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a(foc.C(), $$0, $$1, $$2, $$3, $$4, $$5);
   }

   public void a(foc $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, 0, $$5);
   }

   public void a(foc $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      this.a(foc.C(), $$0, $$1, $$2, $$3, $$5, $$6, $$4);
   }

   public void a(foc $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      elj $$8 = this.f.getBuffer($$0);
      this.a($$8, $$1, $$2, $$3, $$4, $$7, $$5, $$6);
      this.g();
   }

   private void a(elj $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
   ...
   public void a(ert $$0, String $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.b($$1) / 2, $$3, $$4);
   }

   public void a(ert $$0, tf $$1, int $$2, int $$3, int $$4) {
      arc $$5 = $$1.f();
      this.b($$0, $$5, $$2 - $$0.a($$5) / 2, $$3, $$4);
   }

   public void a(ert $$0, arc $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.a($$1) / 2, $$3, $$4);
   }

   public int b(ert $$0, @Nullable String $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(ert $$0, @Nullable String $$1, int $$2, int $$3, int $$4, boolean $$5) {
      if ($$1 == null) {
         return 0;
      } else {
         int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, ert.a.a, 0, 15728880, $$0.a());
         this.g();
         return $$6;
      }
   }

   public int b(ert $$0, arc $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(ert $$0, arc $$1, int $$2, int $$3, int $$4, boolean $$5) {
      int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, ert.a.a, 0, 15728880);
      this.g();
      return $$6;
   }

   public int b(ert $$0, tf $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(ert $$0, tf $$1, int $$2, int $$3, int $$4, boolean $$5) {
      return this.a($$0, $$1.f(), $$2, $$3, $$4, $$5);
   }

   public void a(ert $$0, tj $$1, int $$2, int $$3, int $$4, int $$5) {
      for (arc $$6 : $$0.c($$1, $$4)) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, fyu $$5) {
      this.a($$5, $$0, $$1, $$2, $$3, $$4);
   }

   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, fyu $$5, float $$6, float $$7, float $$8, float $$9) {
   ...
   public void a(aer $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      fyu $$6 = this.h.a($$0);
      gam $$7 = this.h.a($$6);
      if ($$7 instanceof gam.b) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5);
      } else if ($$7 instanceof gam.c $$8) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5, 0, 0, $$8.b(), $$8.c(), $$8.b(), $$8.c());
      } else if ($$7 instanceof gam.a $$9) {
   ...
   private void a(fyu $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9) {
      if ($$8 != 0 && $$9 != 0) {
         this.a(
            $$0.i(),
            $$5,
   ...
   private void a(fyu $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      if ($$4 != 0 && $$5 != 0) {
   ...
   private void a(fyu $$0, gam.a $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      gam.a.a $$7 = $$1.d();
   ...
   private void a(fyu $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9, int $$10, int $$11) {
      if ($$4 > 0 && $$5 > 0) {
         if ($$8 > 0 && $$9 > 0) {
   ...
   public void a(cix $$0, int $$1, int $$2) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, 0);
   }

   public void a(cix $$0, int $$1, int $$2, int $$3) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3);
   }

   public void a(cix $$0, int $$1, int $$2, int $$3, int $$4) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3, $$4);
   }

   public void b(cix $$0, int $$1, int $$2) {
      this.a(null, this.d.r, $$0, $$1, $$2, 0);
   }

   public void a(biy $$0, cix $$1, int $$2, int $$3, int $$4) {
      this.a($$0, $$0.dK(), $$1, $$2, $$3, $$4);
   }

   private void a(@Nullable biy $$0, @Nullable cpl $$1, cix $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 0);
   }

   private void a(@Nullable biy $$0, @Nullable cpl $$1, cix $$2, int $$3, int $$4, int $$5, int $$6) {
      if (!$$2.b()) {
         gav $$7 = this.d.aq().a($$2, $$1, $$0, $$5);
         this.e.a();
         ...
         try {
            ...
            this.d.aq().a($$2, ciu.g, false, this.e, this.d(), 15728880, fyl.d, $$7);
            this.e();
            if ($$8) {
               ekb.b();
            }
   ...
   public void a(ert $$0, cix $$1, int $$2, int $$3) {
      this.a($$0, $$1, $$2, $$3, null);
   }

   public void a(ert $$0, cix $$1, int $$2, int $$3, @Nullable String $$4) {
      if (!$$1.b()) {
         this.e.a();
         if ($$1.L() != 1 || $$4 != null) {
         ...
         if ($$1.m()) {
            ...
            int $$8 = $$2 + 2;
            int $$9 = $$3 + 13;
            this.a(foc.D(), $$8, $$9, $$8 + 13, $$9 + 2, -16777216);
            this.a(foc.D(), $$8, $$9, $$8 + $$6, $$9 + 1, $$7 | 0xFF000000);
         }
         ...
         if ($$11 > 0.0F) {
            ...
            this.a(foc.D(), $$2, $$12, $$2 + 16, $$13, Integer.MAX_VALUE);
         }
   ...
   public void b(ert $$0, cix $$1, int $$2, int $$3) {
      this.a($$0, eya.a(this.d, $$1), $$1.a(), $$2, $$3);
   }

   public void a(ert $$0, List<tf> $$1, Optional<cgd> $$2, int $$3, int $$4) {
      List<faq> $$5 = $$1.stream().map(tf::f).map(faq::a).collect(Collectors.toList());
      $$2.ifPresent($$1x -> $$5.add(1, faq.a($$1x)));
      this.a($$0, $$5, $$3, $$4, fas.a);
   }

   public void a(ert $$0, tf $$1, int $$2, int $$3) {
      this.b($$0, List.of($$1.f()), $$2, $$3);
   }

   public void a(ert $$0, List<tf> $$1, int $$2, int $$3) {
      this.b($$0, Lists.transform($$1, tf::f), $$2, $$3);
   }

   public void b(ert $$0, List<? extends arc> $$1, int $$2, int $$3) {
      this.a($$0, $$1.stream().map(faq::a).collect(Collectors.toList()), $$2, $$3, fas.a);
   }

   public void a(ert $$0, List<arc> $$1, far $$2, int $$3, int $$4) {
      this.a($$0, $$1.stream().map(faq::a).collect(Collectors.toList()), $$3, $$4, $$2);
   }

   private void a(ert $$0, List<faq> $$1, int $$2, int $$3, far $$4) {
      if (!$$1.isEmpty()) {
         int $$5 = 0;
         int $$6 = $$1.size() == 1 ? -2 : 0;
         ...
         this.e.a();
         int $$14 = 400;
         this.a(() -> fau.a(this, $$12, $$13, $$9, $$10, 400));
   ...
   public void a(ert $$0, @Nullable ub $$1, int $$2, int $$3) {
      if ($$1 != null && $$1.i() != null) {
         tk $$4 = $$1.i();
         tk.c $$5 = $$4.a(tk.a.b);
         if ($$5 != null) {
   ...
   static class a {
      private final Deque<ewi> a = new ArrayDeque<>();

      public ewi a(ewi $$0) {
         ewi $$1 = this.a.peekLast();
         if ($$1 != null) {
            ewi $$2 = Objects.requireNonNullElse($$0.b($$1), ewi.a());
            this.a.addLast($$2);
            return $$2;
         } else {
            this.a.addLast($$0);
