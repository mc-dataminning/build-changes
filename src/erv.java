...
public class erv extends erz implements erx {
   ...
   public erv.c a() {
      return new erv.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, esf.a $$1) {
   ...
   private erv.b q() {
      ...
      this.k += $$5;
      this.j++;
      erv.a $$9 = new erv.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new erv.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == esf.b.a || this.q == esf.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<esg> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      esg $$1 = (esg)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == esg.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == esg.b.c) {
         erx.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, erx.a($$11));
         this.a($$14 + 5, erx.a($$12));
         this.a($$14 + 6, erx.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(esf a, int b, int c, esf.b d, esf.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(esf.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable esi $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
