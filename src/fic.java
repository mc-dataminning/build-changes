...
public class fic {
   ...
   private static final Queue<fic.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fic.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fic::a), fhz::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fic::a), fhz::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fic.a(this.b) + ", type=" + fic.b(this.c) + ", severity=" + fic.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
