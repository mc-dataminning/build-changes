...
public class fic {
   ...
   private static final Map<dyg.a, String> e = ac.a(new EnumMap<>(dyg.a.class), $$0 -> {
      $$0.put(dyg.a.a, "SW");
      $$0.put(dyg.a.b, "S");
      $$0.put(dyg.a.c, "OW");
      $$0.put(dyg.a.d, "O");
   ...
   private dur l;
   @Nullable
   private CompletableFuture<dur> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final blh r = new blh(1);
   private final blh s = new blh(blm.values().length);
   private final blh t = new blh(1);
   private final blh u = new blh(1);
   private final Map<bli, blh> v = Map.of(bli.a, this.s);
   private final fjl w;
   private final fjn x;
   private final fjm y;
   private final fjk z;
   ...
   public fic(ffw $$0) {
      ...
      this.g = new fic.a();
      this.h = $$0.h;
      this.w = new fjl(this.h, this.r);
      this.x = new fjn(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fjm(this.h, this.t);
      this.z = new fjk(this.h, this.u);
   }
   ...
   private void a(fhh $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.av()) {
         ...
         $$25.add("");
         $$25.add(String.format(Locale.ROOT, "XYZ: %.3f / %.5f / %.3f", this.f.an().dw(), this.f.an().dy(), this.f.an().dC()));
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, ayg.g($$15.dH()), ayg.g($$15.dJ())));
         dur $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(dcp.a, $$14);
            int $$30 = this.f.r.a(dcp.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dur $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dyg.a $$33 : dyg.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.am()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.u();
                  bqf $$37 = new bqf($$23.al(), $$23.aa(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dcr.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<btf> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(btf.values())
   ...
   private static String a(jj<ddg> $$0) {
   ...
   private dcg r() {
      return (dcg)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.af()))), this.f.r);
   }
   ...
   private dur s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dvi.n, false).thenApply($$0x -> (dur)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ezh.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ffw.Q().aM().k(), ffw.Q().aM().l(), ezh.a()),
            ezh.c(),
            ezh.d()
         }
      );
      if (this.f.av()) {
         ...
         if (this.i.c() == ewf.a.b) {
            ...
            for (Entry<dto<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ewf.a.b) {
            ...
            for (Entry<dto<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(lq.f.b($$11.am())));
         }
   ...
   private String a(Entry<dto<?>, Comparable<?>> $$0) {
      dto<?> $$1 = $$0.getKey();
