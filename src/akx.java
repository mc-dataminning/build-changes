...
public class akx {
   ...
   public akx(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<akx.a> b(Scanner $$0) {
      aju<czg> $$1 = (aju<czg>)alg.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new akx.a($$1, new esj((double)$$2, (double)$$3, (double)$$4), new esi($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<apv> $$1 = this.e.ah().t();
         if (!$$1.isEmpty()) {
            apv $$2 = $$1.get(0);
            apu $$3 = this.e.I();
            dv $$4 = new dv($$2, esj.a($$3.U()), esi.a, $$3, 4, "", wh.a, this.e, $$2);
            dw $$5 = this.e.aH();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(aju<czg> a, esj b, esi c) {
   }
}
