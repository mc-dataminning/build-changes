...
public class akx {
   ...
   private static final Dynamic4CommandExceptionType b = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> vd.b("commands.spreadplayers.failed.teams", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic4CommandExceptionType c = new Dynamic4CommandExceptionType(
      ($$0, $$1, $$2, $$3) -> vd.b("commands.spreadplayers.failed.entities", $$0, $$1, $$2, $$3)
   );
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> vd.b("commands.spreadplayers.failed.invalid.height", $$0, $$1)
   );
   ...
   private static int a(ds $$0, ell $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends blp> $$6) throws CommandSyntaxException {
      amz $$7 = $$0.e();
      int $$8 = $$7.J_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         akx.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
         a($$1, (double)$$2, $$7, $$9, $$10, $$11, $$12, $$13, $$4, $$14, $$5);
         double $$15 = a($$6, $$7, $$14, $$4, $$5);
         $$0.a(
            () -> vd.a("commands.spreadplayers.success." + ($$5 ? "teams" : "entities"), $$14.length, $$1.i, $$1.j, String.format(Locale.ROOT, "%.2f", $$15)),
            true
         );
         return $$14.length;
      }
   ...
   private static int a(Collection<? extends blp> $$0) {
      Set<ems> $$1 = Sets.newHashSet();
   ...
   private static void a(ell $$0, double $$1, amz $$2, aup $$3, double $$4, double $$5, double $$6, double $$7, int $$8, akx.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends blp> $$0, amz $$1, akx.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<ems, akx.a> $$7 = Maps.newHashMap();

      for (blp $$8 : $$0) {
         akx.a $$10;
         if ($$4) {
            ems $$9 = $$8 instanceof cfb ? $$8.cg() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)aui.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)aui.a($$10.b) + 0.5, Set.of(), $$8.dC(), $$8.dE());
   ...
   private static akx.a[] a(aup $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      akx.a[] $$6 = new akx.a[$$1];
   ...
   static class a {
      ...
      public boolean b(cso $$0, int $$1) {
         hx $$2 = hx.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         dja $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.k() && !$$3.a(asb.aJ);
      }

      public void a(aup $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = aui.a($$0, $$1, $$3);
         this.b = aui.a($$0, $$2, $$4);
      }
   }
