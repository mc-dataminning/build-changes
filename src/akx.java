...
public final class akx<E> implements Codec<jn<E>> {
   private final ala<? extends ka<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> akx<E> a(ala<? extends ka<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> akx<E> a(ala<? extends ka<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new akx<>($$0, $$1, $$2);
   }

   private akx(ala<? extends ka<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
