...
public class ekq extends eje<eme> {
   private static final int a = 19;

   public ekq(Codec<eme> $$0) {
      super($$0);
   }

   public static boolean b(djb $$0, iu $$1) {
      return $$0.a($$1, $$0x -> $$0x.a(dmc.fu));
   }

   public static boolean c(djb $$0, iu $$1) {
      return $$0.a($$1, $$0x -> $$0x.l() || $$0x.a(axc.Q));
   }

   private static void b(djd $$0, iu $$1, dzz $$2) {
      $$0.a($$1, $$2, 19);
   }

   public static boolean d(djb $$0, iu $$1) {
      return $$0.a($$1, $$0x -> $$0x.l() || $$0x.a(axc.cr));
   }

   private boolean a(dju $$0, azv $$1, iu $$2, BiConsumer<iu, dzz> $$3, BiConsumer<iu, dzz> $$4, emu.b $$5, eme $$6) {
      int $$7 = $$6.d.a($$1);
      int $$8 = $$6.f.a($$1, $$7, $$6);
      int $$9 = $$7 - $$8;
      int $$10 = $$6.f.a($$1, $$9);
      ...
      if ($$12 >= $$0.G_() + 1 && $$13 <= $$0.ao() + 1) {
         ...
         if ($$15 >= $$7 || !$$14.isEmpty() && $$15 >= $$14.getAsInt()) {
            if ($$6.g.isPresent() && !$$6.g.get().a($$0, $$3, $$1, $$2, $$11, $$6)) {
               ...
               List<emu.a> $$16 = $$6.d.a($$0, $$4, $$1, $$15, $$11, $$6);
   ...
   private int a(djb $$0, int $$1, iu $$2, eme $$3) {
      iu.a $$4 = new iu.a();
   ...
   @Override
   public final boolean a(ejg<eme> $$0) {
      final dju $$1 = $$0.b();
      azv $$2 = $$0.d();
      iu $$3 = $$0.e();
      eme $$4 = $$0.f();
      ...
      BiConsumer<iu, dzz> $$9 = ($$2x, $$3x) -> {
         $$5.add($$2x.j());
         $$1.a($$2x, $$3x, 19);
      };
      BiConsumer<iu, dzz> $$10 = ($$2x, $$3x) -> {
         $$6.add($$2x.j());
         $$1.a($$2x, $$3x, 19);
      };
      emu.b $$11 = new emu.b() {
         @Override
         public void a(iu $$0, dzz $$1x) {
            $$7.add($$0.j());
            $$1.a($$0, $$1, 19);
         }
      ...
      if ($$13 && (!$$6.isEmpty() || !$$7.isEmpty())) {
         if (!$$4.i.isEmpty()) {
            eod.a $$14 = new eod.a($$1, $$12, $$2, $$6, $$7, $$5);
            $$4.i.forEach($$1x -> $$1x.a($$14));
         }

         return eql.a(Iterables.concat($$5, $$6, $$7, $$8)).map($$4x -> {
            fer $$5x = a($$1, $$4x, $$6, $$8, $$5);
            euv.a($$1, 3, $$5x, $$4x.h(), $$4x.i(), $$4x.j());
            return true;
         }).orElse(false);
      } else {
         return false;
   ...
   private static fer a(diw $$0, eql $$1, Set<iu> $$2, Set<iu> $$3, Set<iu> $$4) {
      fer $$5 = new fel($$1.d(), $$1.e(), $$1.f());
      int $$6 = 7;
      ...
      while (true) {
         while ($$11 >= 7 || !$$7.get($$11).isEmpty()) {
            ...
            if ($$1.b($$13)) {
               if ($$11 != 0) {
                  dzz $$14 = $$0.a_($$13);
                  b($$0, $$13, $$14.b(eap.aF, Integer.valueOf($$11)));
               }
   ...
   public static List<iu> a(eod.a $$0) {
