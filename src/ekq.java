...
public class ekq extends ekt {
   public static final int a = 854;
   public static final int b = 480;
   static final ekq.b l = new ekq.b(854, 480);

   public ekq(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final ekq.a[] e = values();
   ...
   static class b {
      ...
      static List<ekq.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ekq.b($$0, $$1), ekq.l) : ImmutableList.of(ekq.l);
      }
