...
public class eym extends eye {
   private static final Logger a = LogUtils.getLogger();
   private static final aez b = new aez("textures/misc/vignette.png");
   ...
   private int z;
   private final etb A = new etb(false);
   ...
   private void a(String $$0, eym.a $$1) {
      try (Reader $$2 = this.f.Z().openAsReader(new aez($$0))) {
         $$1.read($$2);
