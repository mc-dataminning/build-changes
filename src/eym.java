...
public class eym {
   ...
   public eym(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<eyn> $$1) throws IOException {
   ...
   public List<eyn> a(Path $$0) throws IOException {
      List<eyn> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<eyn> a(Path $$0, boolean $$1) throws IOException {
      List<eyn> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<eyn> $$1) throws IOException {
