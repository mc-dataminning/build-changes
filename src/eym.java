...
public class eym {
   public static List<ezo> a(eym.a... $$0) {
      for (eym.a $$1 : $$0) {
         a($$1.j);
      }

      List<ezo> $$2 = Lists.newArrayList();

      for (eym.a $$3 : $$0) {
         $$2.add(new ezo($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(ezo::a));
      return $$2;
   }
   ...
   public static List<ezo> a() {
      return a(eym.a.values());
   }
