...
public class eym extends eyb {
   public static final MapCodec<eym> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  akt.a(mc.bi).fieldOf("name").forGetter($$0x -> $$0x.b),
   ...
   private final akt<ewt> b;
   private final long c;
   private final jr<duu<?>> d;

   private eym(List<ezx> $$0, akt<ewt> $$1, long $$2, jr<duu<?>> $$3) {
      super($$0);
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public cxh a(cxh $$0, ewo $$1) {
      if ($$0.f()) {
         ...
         $$0.b(kv.ar, new daf(this.b, this.c));
         return $$0;
      }
   }
   ...
   public static eyb.a<?> a(duu<?> $$0, akt<ewt> $$1) {
      return a($$2 -> new eym($$2, $$1, 0L, $$0.a()));
   }

   public static eyb.a<?> a(duu<?> $$0, akt<ewt> $$1, long $$2) {
