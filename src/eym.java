...
public class eym {
   ...
   @Nullable
   private eym v;
   private final List<eym> w = Lists.newArrayList();
   @Nullable
   private ag x;
   private final int y;
   private final int z;

   public eym(eyk $$0, eqm $$1, ae $$2, an $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
   ...
   private static float a(eqy $$0, List<tj> $$1) {
   ...
   public void a(erw $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
