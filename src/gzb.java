public abstract class gzb<M extends gfg> extends gyt<hbw, M> {
   private final gew a;
   private final ald b;
   private final gzb.a c;

   public gzb(gvg<?, hbw, M> $$0, gew $$1, ald $$2, gzb.a $$3) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   protected abstract int a(hbw var1);
   ...
   private void a(fho $$0, gny $$1, int $$2, float $$3, float $$4, float $$5) {
      ...
      this.a.a($$0, $$1.getBuffer(this.a.a(this.b)), $$2, hgi.d);
   }
