...
public class hbq {
   ...
   public static class a extends Thread {
      private final hbq.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hbq.b $$0) throws IOException {
         super("LanServerDetector #" + hbq.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hbq.b));
   ...
   public static class b {
      private final List<hbp> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hbp> a() {
         if (this.b) {
            List<hbp> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
