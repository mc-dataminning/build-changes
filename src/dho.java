...
public abstract class dho implements dhn {
   public static final Codec<dho> a = mb.Z.q().dispatchStable(dho::a, Function.identity());
   private final Supplier<Set<jr<dhk>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));
   ...
   protected abstract Stream<jr<dhk>> b();
   ...
   @Nullable
   public Pair<ji, jr<dhk>> a(int $$0, int $$1, int $$2, int $$3, Predicate<jr<dhk>> $$4, azh $$5, dht.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<ji, jr<dhk>> a(ji $$0, int $$1, int $$2, int $$3, Predicate<jr<dhk>> $$4, dht.f $$5, dgl $$6) {
      Set<jr<dhk>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         ...
         for (ji.a $$10 : ji.a(ji.c, $$8, jn.f, jn.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = kc.a($$15);
               jr<dhk> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = ab.ar ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               jr<dhk> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract jr<dhk> getNoiseBiome(int var1, int var2, int var3, dht.f var4);
