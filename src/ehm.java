...
public class ehm extends efx<eja> {
   public ehm(Codec<eja> $$0) {
      super($$0);
   }

   @Override
   public boolean a(efz<eja> $$0) {
      dhf $$1 = $$0.b();
      eja $$2 = $$0.f();
      azh $$3 = $$0.d();
      ji $$4 = $$0.e();
      Predicate<dww> $$5 = $$1x -> $$1x.a($$2.b);
      int $$6 = $$2.j.a($$3) + 1;
      int $$7 = $$2.j.a($$3) + 1;
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, dwv.a::l) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(efz<eja> $$0, dhf $$1, eja $$2, azh $$3, Set<ji> $$4, int $$5, int $$6) {
      for (ji $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(dhf $$0, eja $$1, Predicate<dww> $$2, azh $$3, ji.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         dww $$7 = $$1.c.a($$3, $$4);
         dww $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
