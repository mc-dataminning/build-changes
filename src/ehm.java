...
public class ehm extends LongLinkedOpenHashSet {
   private final ehm.a a;

   public ehm(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new ehm.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = awm.f(60000000);
      private static final int b = awm.f(60000000);
