...
public class amt {
   ...
   public static final SuggestionProvider<ee> b = ($$0, $$1) -> {
      alc $$2 = ((ee)$$0.getSource()).l().aF();
      ej.a($$2.e(), $$1, "#");
      return ej.a($$2.d(), $$1);
   };
   static final amt.b<ee> e = new amt.b<ee>() {
      public void a(ee $$0, akn $$1, int $$2) {
   ...
   public static void a(CommandDispatcher<ee> $$0) {
      ...
      for (apd.c $$2 : apd.c) {
         $$2.a($$1, $$1x -> $$1x.executes(new amt.c() {
               @Override
               protected ud a(CommandContext<ee> $$0) throws CommandSyntaxException {
                  return $$2.a($$0).a();
               }
            }).then(ef.a("path", ew.a()).executes(new amt.c() {
               @Override
               protected ud a(CommandContext<ee> $$0) throws CommandSyntaxException {
                  return amt.a(ew.a($$0, "path"), $$2.a($$0));
               }
            })));
      }
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)ef.a("function").requires($$0x -> $$0x.c(2)))
            .then(((RequiredArgumentBuilder)((RequiredArgumentBuilder)ef.a("name", gm.a()).suggests(b).executes(new amt.c() {
               @Nullable
               @Override
               protected ud a(CommandContext<ee> $$0) {
                  return null;
               }
            })).then(ef.a("arguments", eo.a()).executes(new amt.c() {
               @Override
               protected ud a(CommandContext<ee> $$0) {
   ...
   static ud a(ew.g $$0, apc $$1) throws CommandSyntaxException {
      va $$2 = apd.a($$0, $$1);
      if ($$2 instanceof ud) {
         return (ud)$$2;
      } else {
   ...
   public static <T extends eg<T>> void a(Collection<hq<T>> $$0, @Nullable ud $$1, T $$2, T $$3, he<T> $$4, amt.b<T> $$5, gy $$6) throws CommandSyntaxException {
      if ($$6.c()) {
         a($$0, $$1, $$2, $$3, $$4, $$5);
      } else {
         b($$0, $$1, $$2, $$3, $$4, $$5);
   ...
   private static <T extends eg<T>> void a(@Nullable ud $$0, he<T> $$1, CommandDispatcher<T> $$2, T $$3, hq<T> $$4, akn $$5, eb $$6, boolean $$7) throws CommandSyntaxException {
      try {
         hs<T> $$8 = $$4.a($$0, $$2);
   ...
   private static <T extends eg<T>> eb a(T $$0, amt.b<T> $$1, akn $$2, eb $$3) {
      return $$0.y() ? $$3 : ($$4, $$5) -> {
         $$1.a($$0, $$2, $$5);
         $$3.onResult($$4, $$5);
      };
   ...
   private static <T extends eg<T>> void a(Collection<hq<T>> $$0, @Nullable ud $$1, T $$2, T $$3, he<T> $$4, amt.b<T> $$5) throws CommandSyntaxException {
   ...
   private static <T extends eg<T>> void b(Collection<hq<T>> $$0, @Nullable ud $$1, T $$2, T $$3, he<T> $$4, amt.b<T> $$5) throws CommandSyntaxException {
      CommandDispatcher<T> $$6 = $$2.x();
      T $$7 = $$3.a_();
      eb $$8 = $$2.p();
      if (!$$0.isEmpty()) {
   ...
   public interface b<T> {
      void a(T var1, akn var2, int var3);
   }
   ...
   abstract static class c extends ha.b<ee> implements ha.a<ee> {
      ...
      public void a(ee $$0, ContextChain<ee> $$1, gy $$2, he<ee> $$3) throws CommandSyntaxException {
         ...
         Pair<akn, Collection<hq<ee>>> $$5 = gm.c($$4, "name");
         Collection<hq<ee>> $$6 = (Collection<hq<ee>>)$$5.getSecond();
         if ($$6.isEmpty()) {
            throw amt.d.create(wx.a((akn)$$5.getFirst()));
         } else {
            ud $$7 = this.a($$4);
            ee $$8 = amt.a($$0);
            if ($$6.size() == 1) {
