...
public class amt {
   ...
   private static int a(ej $$0, Collection<? extends avn<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> xa.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> xa.a("commands.banlist.list", $$1.size()), false);

         for (avn<?> $$2 : $$1) {
            $$0.a(() -> xa.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
