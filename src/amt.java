...
public class amt {
   ...
   private static int a(du $$0, Collection<apb> $$1, ib $$2, float $$3) {
      ajb<cwe> $$4 = $$0.e().ad();
      ...
      if ($$1.size() == 1) {
         $$0.a(() -> vs.a("commands.spawnpoint.success.single", $$2.u(), $$2.v(), $$2.w(), $$3, $$6, $$1.iterator().next().Q_()), true);
      } else {
         $$0.a(() -> vs.a("commands.spawnpoint.success.multiple", $$2.u(), $$2.v(), $$2.w(), $$3, $$6, $$1.size()), true);
      }
