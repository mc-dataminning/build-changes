...
public class dtr extends dtw {
   public static final Codec<dtr> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, dtr::new));
   ...
   public List<dse.a> a(crf $$0, BiConsumer<ht, dgb> $$1, ate $$2, int $$3, ht $$4, dro $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = asy.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, asy.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<dtr.a> $$13 = Lists.newArrayList();
      $$13.add(new dtr.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               ht $$21 = $$4.b(asy.a($$19), $$12 - 1, asy.a($$20));
               ht $$22 = $$21.b(5);
      ...
      List<dse.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(crf $$0, BiConsumer<ht, dgb> $$1, ate $$2, ht $$3, ht $$4, boolean $$5, dro $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ht $$13 = $$3.b(asy.d(0.5F + (float)$$12 * $$9), asy.d(0.5F + (float)$$12 * $$10), asy.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dak.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(crf $$0, BiConsumer<ht, dgb> $$1, ate $$2, int $$3, ht $$4, List<dtr.a> $$5, dro $$6) {
      for (dtr.a $$7 : $$5) {
         int $$8 = $$7.a();
