...
public class dtr {
   ...
   private final cxd p;
   private static final List<dac> q = List.of(dae.l, dae.L, dae.i, dae.b, dae.k, dae.I, dae.K, dae.fl, dae.dP, dae.iA, dae.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<il<cya>>> t;
   ...
   public static final Codec<dtr> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dtr::a, Function.identity());

   private static DataResult<dtr> a(dtr $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dtr(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<il<cya>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = je.c($$0);
      int $$5 = je.c($$1) - $$4;
   ...
   @Nullable
   public static dtr a(apm $$0, int $$1, int $$2) {
      dox $$3 = $$0.a($$1, $$2);
      dtr $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dpc.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<ii> a(cxw $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dox $$1, int $$2, int $$3) {
   ...
   private int a(dox $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dso.a.a)) {
         $$3 = Math.min($$0.a(dso.a.a, $$1, $$2) + 1, this.p.ak());
      } else {
         $$3 = this.p.ak();
      }
   ...
   private static double a(dox $$0, ib.a $$1) {
      return a($$0, (ib)$$1.c(ih.a)) ? 1.0 : -1.0;
   }

   private static double b(dox $$0, ib.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dox $$0, int $$1, int $$2, int $$3) {
   ...
   private List<il<cya>> b(dox $$0, int $$1, int $$2) {
      ObjectArrayList<il<cya>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dox $$0, ib $$1) {
      dnb $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(aun.O)) {
         ...
         return $$2.a(dae.eT) || $$2.a(dae.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dtr.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dtr.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, il<cya> var3);
   }
