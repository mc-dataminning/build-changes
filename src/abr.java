...
public class abr implements ze<abq> {
   ...
   public abr(brw $$0, int $$1) {
      this($$0.al(), $$0.cz(), $$0.du(), $$0.dw(), $$0.dA(), $$0.dH(), $$0.dF(), $$0.ak(), $$1, $$0.ds(), (double)$$0.cs());
   }

   public abr(brw $$0, int $$1, io $$2) {
      this($$0.al(), $$0.cz(), (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), $$0.dH(), $$0.dF(), $$0.ak(), $$1, $$0.ds(), (double)$$0.cs());
   }

   public abr(int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, bsc<?> $$7, int $$8, eum $$9, double $$10) {
      this.d = $$0;
      this.e = $$1;
      this.g = $$2;
      this.h = $$3;
      this.i = $$4;
      this.m = (byte)ayf.d($$5 * 256.0F / 360.0F);
      this.n = (byte)ayf.d($$6 * 256.0F / 360.0F);
      this.o = (byte)ayf.a($$10 * 256.0 / 360.0);
      this.f = $$7;
      this.p = $$8;
      this.j = (int)(ayf.a($$9.c, -3.9, 3.9) * 8000.0);
      this.k = (int)(ayf.a($$9.d, -3.9, 3.9) * 8000.0);
      this.l = (int)(ayf.a($$9.e, -3.9, 3.9) * 8000.0);
   }
