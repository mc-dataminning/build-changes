...
public class ayr implements AutoCloseable {
   ...
   private ayr(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ayr.a a(Path $$0) {
         return new ayr.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
