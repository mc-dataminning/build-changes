...
public class hay implements hbb.a, AutoCloseable {
   ...
   public hay(alz $$0, hcs $$1, ffl $$2, avx $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      hcq $$4 = $$3.a(hcq.a).orElse(hcq.e);
   ...
   @Nullable
   private hay.a a(hcs $$0, int $$1, int $$2, hcq $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<hay.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new hay.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new hay.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<hay.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            hay.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new hay.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }
   ...
   class a {
      ...
      a(final List<hay.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * hay.this.c;
         int $$4 = this.b($$2) * hay.this.d;
         hay.this.a($$0, $$1, $$3, $$4, hay.this.f);
      }

      public hba a() {
         return hay.this.new d(this, this.d ? hay.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ffl[] b = new ffl[hay.this.f.length];
      ...
      void a(int $$0, int $$1, hay.d $$2) {
         ...
         if ($$7 != $$8) {
            ...
            hay.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(hay.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return hay.this.f[$$2].a($$3 + ($$0.a($$1) * hay.this.c >> $$2), $$4 + ($$0.b($$1) * hay.this.d >> $$2));
      }
   ...
   class d implements hba {
      int a;
      int b;
      final hay.a c;
      @Nullable
      private final hay.c d;

      d(final hay.a $$0, @Nullable final hay.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
