...
public class ckm extends btr implements cjv {
   private static final akk<Integer> bZ = ako.a(ckm.class, akm.b);
   ...
   public ckm(bta<? extends ckm> $$0, dby $$1) {
      super($$0, $$1);
      this.cG();
      this.bP = new ckm.d(this);
   }

   @Override
   protected void z() {
      this.bS.a(1, new ckm.b(this));
      this.bS.a(2, new ckm.a(this));
      this.bS.a(3, new ckm.e(this));
      this.bS.a(5, new ckm.c(this));
   ...
   public void a(int $$0, boolean $$1) {
      ...
      this.at();
      this.j_();
      this.f(bux.q).a((double)($$2 * $$2));
      this.f(bux.r).a((double)(0.2F + 0.1F * (float)$$2));
      this.f(bux.c).a((double)$$2);
      if ($$1) {
         this.t(this.eR());
      }
   ...
   @Override
   public bta<? extends ckm> ak() {
      return (bta<? extends ckm>)super.ak();
   }
   ...
   protected void j(btp $$0) {
      if (this.bD()) {
         int $$1 = this.gr();
         if (this.g((bsu)$$0) < 0.6 * (double)$$1 * 0.6 * (double)$$1 && this.E($$0) && $$0.a(this.dQ().b((btp)this), this.go())) {
   ...
   protected evr a(bsu $$0, bsx $$1, float $$2) {
      return new evr(0.0, (double)$$1.b() - 0.015625 * (double)this.gr() * (double)$$2, 0.0);
   }
   ...
   public static boolean c(bta<ckm> $$0, dbz $$1, btt $$2, iz $$3, azh $$4) {
      if (btt.a($$2)) {
         return a($$0, $$1, $$2, $$3, $$4);
      } else {
         if ($$1.al() != bqr.a) {
            ...
            dbf $$5 = new dbf($$3);
            boolean $$6 = dyt.a($$5.e, $$5.f, ((dct)$$1).C(), 987234911L).a(10) == 0;
   ...
   static class a extends can {
      ...
      public boolean a() {
         ...
         if ($$0 == null) {
            ...
            return !this.a.c($$0) ? false : this.a.H() instanceof ckm.d;
         }
      }
      ...
      public void e() {
         ...
         if (this.a.H() instanceof ckm.d $$1) {
   ...
   static class b extends can {
      ...
      @Override
      public boolean a() {
         return (this.a.be() || this.a.bs()) && this.a.H() instanceof ckm.d;
      }
      ...
      public void e() {
         ...
         if (this.a.H() instanceof ckm.d $$0) {
            $$0.a(1.2);
         }
      }
   }
   ...
   static class d extends bzq {
      ...
      public void a() {
         ...
         if (this.k != bzq.a.b) {
            ...
            this.k = bzq.a.a;
            if (this.d.aE()) {
               this.d.y((float)(this.h * this.d.g(bux.r)));
               if (this.m-- <= 0) {
                  this.m = this.n.y();
                  if (this.o) {
                     this.m /= 3;
   ...
   static class e extends can {
      ...
      @Override
      public boolean a() {
         return this.a.p() == null && (this.a.aE() || this.a.be() || this.a.bs() || this.a.b(bse.y)) && this.a.H() instanceof ckm.d;
      }
