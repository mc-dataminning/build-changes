...
public abstract class dko implements dkn {
   public static final Codec<dko> a = mg.Z.q().dispatchStable(dko::a, Function.identity());
   private final Supplier<Set<jf<dkk>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));
   ...
   protected abstract Stream<jf<dkk>> b();
   ...
   @Nullable
   public Pair<iv, jf<dkk>> a(int $$0, int $$1, int $$2, int $$3, Predicate<jf<dkk>> $$4, azv $$5, dkt.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<iv, jf<dkk>> a(iv $$0, int $$1, int $$2, int $$3, Predicate<jf<dkk>> $$4, dkt.f $$5, djk $$6) {
      Set<jf<dkk>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         ...
         for (iv.a $$10 : iv.a(iv.c, $$8, jb.f, jb.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = jq.a($$15);
               jf<dkk> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = ac.as ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               jf<dkk> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract jf<dkk> getNoiseBiome(int var1, int var2, int var3, dkt.f var4);
