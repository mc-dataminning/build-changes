...
public class cal extends cao {
   private final bts a;
   private final Predicate<bts> b;
   @Nullable
   private bts c;
   ...
   public cal(bts $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean a() {
      List<bts> $$0 = this.a.dP().a(bts.class, this.a.cK().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (bts $$1 : $$0) {
            if (!$$1.ch()) {
               this.c = $$1;
