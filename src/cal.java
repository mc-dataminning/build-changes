...
public class cal extends can {
   ...
   public cal(bum $$0, double $$1, float $$2, float $$3, boolean $$4) {
      this.e = $$0;
      this.g = $$0.dP();
      this.h = $$1;
      this.i = $$0.K();
   ...
   public boolean a() {
      ...
      if ($$0 == null) {
         ...
         return false;
      } else if (this.e.g((bsu)$$0) < (double)(this.l * this.l)) {
         return false;
      } else {
         this.f = $$0;
         return true;
   ...
   public boolean b() {
      if (this.i.l()) {
         ...
         return this.h() ? false : !(this.e.g((bsu)this.f) <= (double)(this.k * this.k));
      }
   }
   ...
   private boolean a(iz $$0) {
      eom $$1 = eor.b(this.e, $$0);
      if ($$1 != eom.c) {
         return false;
      } else {
         dsc $$2 = this.g.a_($$0.d());
         if (!this.n && $$2.b() instanceof djj) {
            return false;
         } else {
            iz $$3 = $$0.b(this.e.dp());
