...
public abstract class fol extends fnw {
   ...
   public static fol a(int $$0, int $$1, alz $$2, int $$3, int $$4) {
      return new fol.b(0, 0, $$0, $$1, $$2, $$3, $$4);
   }

   public static fol a(int $$0, int $$1, alz $$2) {
   ...
   static class a extends fol {
      ...
      public void b(fnl $$0, int $$1, int $$2, float $$3) {
         $$0.a(glo::B, this.a, this.D(), this.E(), this.y(), this.w());
      }
   }
   ...
   static class b extends fol {
      ...
      protected void b(fnl $$0, int $$1, int $$2, float $$3) {
         $$0.a(glo::B, this.a, this.D(), this.E(), 0.0F, 0.0F, this.y(), this.w(), this.b, this.c);
      }
   }
}
