...
public class fol {
   ...
   @Nullable
   private fol v;
   private final List<fol> w = Lists.newArrayList();
   @Nullable
   private ai x;
   private final int y;
   private final int z;

   public fol(foj $$0, fgo $$1, ah $$2, as $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
   ...
   private static float a(fgz $$0, List<xe> $$1) {
   ...
   public void a(fhz $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
