public class fol extends fny<cpz> implements frk {
   private static final akk D = new akk("textures/gui/container/crafting_table.png");
   private final fre E = new fre();
   private boolean F;

   public fol(cpz $$0, cmj $$1, wu $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aP_() {
      ...
      this.c(new fie(this.z + 5, this.n / 2 - 49, 20, 18, fre.a, $$0 -> {
         this.E.e();
         this.z = this.E.a(this.m, this.c);
