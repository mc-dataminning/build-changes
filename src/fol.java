...
public abstract class fol<E extends fol.a<E>> extends foi {
   ...
   protected final flj c;
   protected final int d;
   private final List<E> n = new fol.b();
   ...
   public fol(flj $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wn.a);
      this.c = $$0;
      this.d = $$4;
   }

   public fol(flj $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected void b(fod $$0) {
      aku $$1 = this.c.s == null ? fuk.h : fuk.j;
      aku $$2 = this.c.s == null ? fuk.i : fuk.k;
      $$0.a(gmh::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(gmh::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(fod $$0) {
      aku $$1 = this.c.s == null ? a : m;
      $$0.a(gmh::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }
   ...
   @Override
   public Optional<fqp> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(fsx $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(fsx $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fsn.a w() {
      if (this.aM_()) {
         ...
         return this.q != null ? fsn.a.b : fsn.a.a;
      }
   }
   ...
   protected void a(fsp $$0, E $$1) {
      List<E> $$2 = this.aH_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fso.b, wo.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fol.a<E>> implements fqp {
      @Deprecated
      fol<E> a;
      ...
      public abstract void a(fod var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
