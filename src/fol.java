...
public abstract class fol<E extends fol.a<E>> extends foi {
   ...
   public fol(fli $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wo.a);
      this.c = $$0;
      this.d = $$4;
   }

   public fol(fli $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected void b(fod $$0) {
      akv $$1 = this.c.s == null ? fuk.h : fuk.j;
      akv $$2 = this.c.s == null ? fuk.i : fuk.k;
   ...
   protected void a(fsp $$0, E $$1) {
      ...
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fso.b, wp.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }
