...
public abstract class fol {
   ...
   protected static class i extends fol.e {
      private final Optional<aew> aS;

      i(ImmutableList<Triple<aew, Boolean, Boolean>> $$0) {
         super(() -> {
            int $$1 = 0;
            UnmodifiableIterator var2 = $$0.iterator();

            while (var2.hasNext()) {
               Triple<aew, Boolean, Boolean> $$2 = (Triple<aew, Boolean, Boolean>)var2.next();
               fzf $$3 = eqv.O().Y();
               $$3.b((aew)$$2.getLeft()).a((Boolean)$$2.getMiddle(), (Boolean)$$2.getRight());
               RenderSystem.setShaderTexture($$1++, (aew)$$2.getLeft());
            }
         }, () -> {
         });
      ...
      public static final class a {
         private final Builder<Triple<aew, Boolean, Boolean>> a = new Builder();

         public fol.i.a a(aew $$0, boolean $$1, boolean $$2) {
   ...
   protected static class n extends fol.e {
      ...
      public n(aew $$0, boolean $$1, boolean $$2) {
         super(() -> {
            fzf $$3 = eqv.O().Y();
            $$3.b($$0).a($$1, $$2);
