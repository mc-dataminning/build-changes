...
public class fol {
   ...
   private static final Map<edp.a, String> e = ae.a(new EnumMap<>(edp.a.class), $$0 -> {
      $$0.put(edp.a.a, "SW");
      $$0.put(edp.a.b, "S");
      $$0.put(edp.a.c, "OW");
      $$0.put(edp.a.d, "O");
   ...
   private dzz l;
   @Nullable
   private CompletableFuture<dzz> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final boc r = new boc(1);
   private final boc s = new boc(boh.values().length);
   private final boc t = new boc(1);
   private final boc u = new boc(1);
   private final Map<bod, boc> v = Map.of(bod.a, this.s);
   private final fpv w;
   private final fpy x;
   private final fpw y;
   private final fpu z;
   ...
   public fol(fme $$0) {
      ...
      this.g = new fol.a();
      this.h = $$0.h;
      this.w = new fpv(this.h, this.r);
      this.x = new fpy(this.h, this.s, () -> $$0.s.t().g());
      this.y = new fpw(this.h, this.t);
      this.z = new fpu(this.h, this.u);
      this.A = new fpx(this.h);
   }
   ...
   private void a(fnq $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         if ($$27.B()) {
            ...
            int $$29 = this.f.s.a(dhq.a, $$14);
            int $$30 = this.f.s.a(dhq.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dzz $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (edp.a $$33 : edp.a.values()) {
               if ($$33.b()) {
         ...
         if ($$38 != null) {
            ...
            dhs.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bwi> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bwi.values())
   ...
   private static String a(jq<dij> $$0) {
   ...
   private dhh s() {
      return (dhh)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ah()))), this.f.s);
   }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ffj.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fme.Q().aO().k(), fme.Q().aO().l(), ffj.a()),
            ffj.c(),
            ffj.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == fbv.a.b) {
            ...
            for (Entry<dyw<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == fbv.a.b) {
            ...
            for (Entry<dyw<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dyw<?>, Comparable<?>> $$0) {
      dyw<?> $$1 = $$0.getKey();
