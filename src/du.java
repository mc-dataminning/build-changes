...
public record du(@Nullable Float c, @Nullable Float d) {
   public static final du a = new du(null, null);
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(wu.c("argument.range.ints"));

   public static du a(float $$0) {
      return new du($$0, $$0);
   }

   public static du a(float $$0, float $$1) {
      return new du($$0, $$1);
   }

   public static du b(float $$0) {
      return new du($$0, null);
   }

   public static du c(float $$0) {
      return new du(null, $$0);
   }
   ...
   public static du a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         return a;
      } else if (axp.b($$0)) {
         float $$1 = axp.e($$0, "value");
         return new du($$1, $$1);
      } else {
         JsonObject $$2 = axp.m($$0, "value");
         Float $$3 = $$2.has("min") ? axp.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? axp.m($$2, "max") : null;
         return new du($$3, $$4);
      }
   }

   public static du a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return a($$0, $$1, $$0x -> $$0x);
   }

   public static du a(StringReader $$0, boolean $$1, Function<Float, Float> $$2) throws CommandSyntaxException {
      if (!$$0.canRead()) {
         throw ct.a.createWithContext($$0);
      } else {
         int $$3 = $$0.getCursor();
         Float $$4 = a(b($$0, $$1), $$2);
         Float $$5;
