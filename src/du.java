...
public class du extends dy<du.a> {
   ...
   public void a(asi $$0, aly<dcd<?>> $$1, List<cxo> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static record a(Optional<bh> b, aly<dcd<?>> c, List<cu> d) implements dy.a {
      ...
      public static ap<du.a> a(aly<dcd<?>> $$0, List<cu.a> $$1) {
         return ao.ac.a(new du.a(Optional.empty(), $$0, $$1.stream().map(cu.a::b).toList()));
      }

      public static ap<du.a> a(aly<dcd<?>> $$0) {
         return ao.ac.a(new du.a(Optional.empty(), $$0, List.of()));
      }

      public static ap<du.a> b(aly<dcd<?>> $$0) {
         return ao.ad.a(new du.a(Optional.empty(), $$0, List.of()));
      }

      boolean b(aly<dcd<?>> $$0, List<cxo> $$1) {
         if ($$0 != this.c) {
            return false;
         } else {
            List<cxo> $$2 = new ArrayList<>($$1);

            for (cu $$3 : this.d) {
               boolean $$4 = false;
               Iterator<cxo> $$5 = $$2.iterator();
