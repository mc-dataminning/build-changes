...
public class glh extends auu<Optional<glh.b>> implements AutoCloseable {
   ...
   protected Optional<glh.b> a(aup $$0, bot $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new glh.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<glh.b> $$0, aup $$1, bot $$2) {
   ...
   private void a(gmi $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      gli $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private fft a(ffw $$0, int $$1, int $$2, fkv $$3, glh.a $$4, gmi $$5) {
      float $$6 = 0.8F;
   ...
   private void a(glh.a $$0, ffp $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(glh.a $$0, ffp $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
