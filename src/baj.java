...
public class baj implements ayj {
   ...
   public baj(int $$0, int $$1) {
      this($$0, $$1, (long[])null);
   }

   public baj(int $$0, int $$1, @Nullable long[] $$2) {
      ...
      if ($$2 != null) {
         if ($$2.length != $$4) {
            throw new baj.a("Invalid length given for storage, got: " + $$2.length + " but expected: " + $$4);
         }
   ...
   @Override
   public ayj d() {
      return new baj(this.c, this.e, (long[])this.b.clone());
   }
