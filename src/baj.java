...
public class baj extends bex {
   public baj(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bfy.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bfy.s, "minecraft:jukebox");
