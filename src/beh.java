...
public class beh extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      if (!($$1.findFieldType("TileEntities") instanceof ListType<?> $$3)) {
         ...
         Type<?> $$5 = this.getInputSchema().getType(bdn.c);
         ...
         if (!($$8 instanceof ListType)) {
            ...
            return TypeRewriteRule.seq(
               new axv(this.getOutputSchema(), "AddTrappedChestFix", bdn.s).makeRule(),
               this.fixTypeEverywhereTyped("Trapped Chest fix", $$5, $$4x -> $$4x.updateTyped($$6, $$3xx -> {
                     ...
                     if ($$4xx.isEmpty()) {
                        ...
                        for (Typed<?> $$7x : $$5x) {
                           beh.a $$8x = new beh.a($$7x, this.getInputSchema());
                           if (!$$8x.b()) {
                        ...
                        TaggedChoiceType<String> $$14 = this.getInputSchema().findChoiceType(bdn.s);
                        return $$3xx.updateTyped($$4, $$4xxx -> $$4xxx.updateTyped($$14.finder(), $$4xxxx -> {
                              ...
                              return $$6x.contains(bcc.a($$6xx, $$7xx, $$8xx)) ? $$4xxxx.update($$14.finder(), $$0xxxxx -> $$0xxxxx.mapFirst($$0xxxxxx -> {
