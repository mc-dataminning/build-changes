...
public class beh extends bav {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), beh::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", beh::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", beh::k);
         $$0 = this.a($$0, "minecraft:fox", beh::j);
         $$0 = this.a($$0, "minecraft:item", beh::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", beh::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", beh::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", beh::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", beh::e);
         return this.a($$0, "minecraft:piglin", beh::d);
      });
   }
