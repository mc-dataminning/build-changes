...
public class beh extends DataFix {
   ...
   public beh(Schema $$0, TypeReference $$1) {
      super($$0, false);
      this.a = $$1;
   }

   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityFallDistanceFloatToDoubleFixFor" + this.a.typeName(), this.getOutputSchema().getType(this.a), beh::a);
   }
