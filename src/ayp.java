...
public interface ayp<C, I extends bat<C>> extends bat<C> {
   @bax
   String a();

   ayp<C, I> a(ayp.d<I> var1);

   static <C, I extends bat<C>> Codec<ayp<C, I>> a(Codec<I> $$0) {
      MutableObject<Codec<ayp<C, I>>> $$1 = new MutableObject();

      record a<C, I extends bat<C>>(float a, ayp<C, I> b, float c) {
      }
   ...
   static <C, I extends bat<C>> ayp<C, I> a(float $$0) {
      return new ayp.c<>($$0);
   }

   static <C, I extends bat<C>> ayp.b<C, I> a(I $$0) {
      return new ayp.b<>($$0);
   }

   static <C, I extends bat<C>> ayp.b<C, I> a(I $$0, bat<Float> $$1) {
      return new ayp.b<>($$0, $$1);
   }

   public static final class b<C, I extends bat<C>> {
      private final I a;
      private final bat<Float> b;
   ...
   @bax
   public static record c<C, I extends bat<C>>(float b) implements ayp<C, I> {
      @Override
      public float a(C $$0) {
         return this.b;
      }
   ...
   @bax
   public static record e<C, I extends bat<C>>(I b, float[] c, List<ayp<C, I>> d, float[] e, float f, float g) implements ayp<C, I> {
      ...
      static <C, I extends bat<C>> ayp.e<C, I> a(I $$0, float[] $$1, List<ayp<C, I>> $$2, float[] $$3) {
         a($$1, $$2, $$3);
         int $$4 = $$1.length - 1;
      ...
      private static <C, I extends bat<C>> void a(float[] $$0, List<ayp<C, I>> $$1, float[] $$2) {
      ...
      public float a(C $$0) {
         ...
         if ($$2 < 0) {
            ...
            float $$5 = this.c[$$2 + 1];
            float $$6 = ($$1 - $$4) / ($$5 - $$4);
            bat<C> $$7 = (bat<C>)this.d.get($$2);
            bat<C> $$8 = (bat<C>)this.d.get($$2 + 1);
            float $$9 = this.e[$$2];
            float $$10 = this.e[$$2 + 1];
            float $$11 = $$7.a($$0);
            float $$12 = $$8.a($$0);
            ...
            return azo.h($$6, $$11, $$12) + $$6 * (1.0F - $$6) * azo.h($$6, $$13, $$14);
         }
      }

      private static int a(float[] $$0, float $$1) {
         return azo.a(0, $$0.length, $$2 -> $$1 < $$0[$$2]) - 1;
      }
