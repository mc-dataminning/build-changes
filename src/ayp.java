...
public class ayp {
   ...
   public static ji<cuk> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static ji<cuk> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ji<cuk> a(JsonObject $$0, String $$1, @Nullable ji<cuk> $$2) {
