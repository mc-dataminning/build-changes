...
public class ayp {
   ...
   private static final Optional<Object> b = Optional.of(ayy.a);

   private static boolean a(xp $$0, axj $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, xp $$1, axj $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, xp $$1, axj $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, xp $$1, axj $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, xp $$2, axj $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, xp $$2, xp $$3, axj $$4) {
      int $$5 = $$0.length();
      xp $$6 = $$2;
   ...
   public static boolean a(wx $$0, xp $$1, axj $$2) {
