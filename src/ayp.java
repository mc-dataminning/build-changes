...
public class ayp {
   ...
   ayp(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static ayp.a a() {
      return new ayp.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(ayp::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public ayp.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public ayp a(Writer $$0) throws IOException {
         return new ayp($$0, this.a);
      }
   }
}
