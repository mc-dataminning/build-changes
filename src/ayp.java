...
public class ayp {
   ...
   public static jr<cwk> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static jr<cwk> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static jr<cwk> a(JsonObject $$0, String $$1, @Nullable jr<cwk> $$2) {
