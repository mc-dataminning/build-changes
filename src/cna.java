public class cna extends cnd {
   ...
   public cna(cnd.a $$0, int $$1, bil... $$2) {
      super($$0, cne.f, $$2);
      this.d = $$1;
   }
   ...
   public float a(int $$0, bjb $$1) {
      ...
      } else if (this.d == 1 && $$1 == bjb.b) {
         return (float)$$0 * 2.5F;
      } else {
         return this.d == 2 && $$1 == bjb.c ? (float)$$0 * 2.5F : 0.0F;
      }
   }

   @Override
   public boolean a(cnd $$0) {
      return !($$0 instanceof cna);
   }

   @Override
   public boolean a(ciw $$0) {
      return $$0.d() instanceof cgl ? true : super.a($$0);
   }

   @Override
   public void a(biw $$0, big $$1, int $$2) {
      if ($$1 instanceof biw $$3 && this.d == 2 && $$2 > 0 && $$3.eQ() == bjb.c) {
         int $$4 = 20 + $$0.ee().a(10 * $$2);
         $$3.b(new bht(bhv.b, $$4, 3));
      }
   }
}
