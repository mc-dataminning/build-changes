...
public final class cqm {
   public static final Codec<cqm> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ki.h.r().fieldOf("id").forGetter(cqm::e),
               Codec.INT.fieldOf("Count").forGetter(cqm::M),
               ta.a.optionalFieldOf("tag").forGetter($$0x -> Optional.ofNullable($$0x.w()))
            )
            .apply($$0, cqm::new)
   );
   private static final Codec<cqh> p = awe.b(
      ki.h.q(), (Function<cqh, DataResult<cqh>>)($$0 -> $$0 == cqp.a ? DataResult.error(() -> "Item must not be minecraft:air") : DataResult.success($$0))
   );
   public static final Codec<cqm> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(ki.h.r().fieldOf("item").forGetter(cqm::e), awe.a(ty.i, "nbt").forGetter($$0x -> Optional.ofNullable($$0x.w())))
            .apply($$0, ($$0x, $$1) -> new cqm($$0x, 1, $$1))
   );
   public static final Codec<cqm> c = RecordCodecBuilder.create(
      $$0 -> $$0.group(p.fieldOf("item").forGetter(cqm::d), awe.a(awe.k, "count", Integer.valueOf(1)).forGetter(cqm::M)).apply($$0, cqm::new)
   );
   public static final Codec<cqm> d = p.xmap(cqm::new, cqm::d);
   public static final MapCodec<cqm> e = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(ki.h.q().fieldOf("result").forGetter(cqm::d), Codec.INT.fieldOf("count").forGetter(cqm::M)).apply($$0, cqm::new)
   );
   public static final xs<vf, cqm> f = new xs<vf, cqm>() {
      private static final xs<vf, cqh> a = xq.a(kj.F);
   ...
   public static final xs<vf, List<cqm>> g = f.a(xq.a(iu::a));
   private static final Logger q = LogUtils.getLogger();
   public static final cqm h = new cqm((Void)null);
   ...
   public cqm(il<cqh> $$0, int $$1, Optional<ta> $$2) {
      this($$0, $$1);
      $$2.ifPresent(this::c);
   }

   public cqm(il<cqh> $$0, int $$1) {
      this($$0.a(), $$1);
   }

   public cqm(cxa $$0, int $$1) {
      this.B = $$0.l();
      this.z = $$1;
      if (this.B.p()) {
         this.b(this.l());
   ...
   public boolean b() {
      return this == h || this.B == cqp.a || this.z <= 0;
   }
   ...
   public boolean a(Predicate<il<cqh>> $$0) {
      return $$0.test(this.d().k());
   }

   public boolean a(il<cqh> $$0) {
      return this.d().k() == $$0;
   }

   public boolean a(ip<cqh> $$0) {
      return $$0.a(this.e());
   }

   public Stream<avd<cqh>> f() {
      return this.d().k().c();
   }
   ...
   public void a(int $$0, bpp $$1, bpe $$2) {
      if (!$$1.dM().B) {
         if ($$1 instanceof ciu $$3 && $$3.fM()) {
            return;
         }
   ...
   public boolean a(cnl $$0, cly $$1, ciu $$2) {
      return this.d().a(this, $$0, $$1, $$2);
   }

   public boolean a(cqm $$0, cnl $$1, cly $$2, ciu $$3, bqg $$4) {
      return this.d().a(this, $$0, $$1, $$2, $$3, $$4);
   }

   public void a(bpp $$0, ciu $$1) {
      cqh $$2 = this.d();
      if ($$2.a(this, $$0, $$1)) {
         $$1.b(aui.c.b($$2));
      }
   ...
   public void a(cxb $$0, dnb $$1, ib $$2, ciu $$3) {
      cqh $$4 = this.d();
      if ($$4.a(this, $$0, $$1, $$2, $$3)) {
         $$3.b(aui.c.b($$4));
      }
   ...
   public boolean b(dnb $$0) {
      return this.d().a_($$0);
   }

   public bnd a(ciu $$0, bpp $$1, bnc $$2) {
      return this.d().a(this, $$0, $$1, $$2);
   }
   ...
   public cqm a(cxa $$0, int $$1) {
      return this.b() ? h : this.b($$0, $$1);
   }

   public cqm b(cxa $$0, int $$1) {
      cqm $$2 = new cqm($$0, $$1);
      if (this.C != null) {
         $$2.c(this.C.h());
      }
   ...
   public static boolean b(cqm $$0, cqm $$1) {
      return $$0.a($$1.d());
   }

   public static boolean c(cqm $$0, cqm $$1) {
      if (!$$0.a($$1.d())) {
         return false;
      } else {
   ...
   public static MapCodec<cqm> a(String $$0) {
   ...
   public void a(cxb $$0, box $$1, int $$2, boolean $$3) {
      if (this.A > 0) {
         this.A--;
      }
   ...
   public void a(cxb $$0, ciu $$1, int $$2) {
   ...
   public void a(cxb $$0, bpp $$1, int $$2) {
      this.d().a(this, $$0, $$1, $$2);
   }
   ...
   public List<vu> a(@Nullable ciu $$0, csd $$1) {
      ...
      if (a($$5, cqm.a.h) && $$0 != null) {
         cso.a(this, $$0.dM().H_(), $$2);
      }
      ...
      if (a($$5, cqm.a.b)) {
         for (bpe $$12 : bpe.values()) {
            Multimap<il<bqr>, bqu> $$13 = this.a($$12);
            if (!$$13.isEmpty()) {
               $$2.add(vt.a);
               $$2.add(vu.c("item.modifiers." + $$12.e()).a(n.h));

               for (Entry<il<bqr>, bqu> $$14 : $$13.entries()) {
                  bqu $$15 = $$14.getValue();
                  double $$16 = $$15.c();
                  boolean $$17 = false;
                  if ($$0 != null) {
                  ...
                  double $$18;
                  if ($$15.b() == bqu.a.b || $$15.b() == bqu.a.c) {
                     $$18 = $$16 * 100.0;
                  } else if ($$14.getKey().a(bqw.n)) {
                     $$18 = $$16 * 10.0;
                  } else {
                     $$18 = $$16;
                  }
      ...
      if (a($$5, cqm.a.c) && this.C != null && this.C.q("Unbreakable")) {
         $$2.add(vu.c("item.unbreakable").a(n.j));
      }

      if (a($$5, cqm.a.d) && this.C != null && this.C.b("CanDestroy", 9)) {
      ...
      if (a($$5, cqm.a.e) && this.C != null && this.C.b("CanPlaceOn", 9)) {
   ...
   private static boolean a(int $$0, cqm.a $$1) {
      return ($$0 & $$1.a()) == 0;
   }
   ...
   public static void a(List<vu> $$0, tg $$1) {
      for (int $$2 = 0; $$2 < $$1.size(); $$2++) {
         ta $$3 = $$1.a($$2);
         ki.f.b(cux.b($$3)).ifPresent($$2x -> $$0.add($$2x.d(cux.a($$3))));
      }
   }
      ...
      try {
         return (Collection<vu>)fm.b(ki.e.p(), $$0, true)
            .map(
               ...
               $$0x -> $$0x.a().a().map($$0xx -> ((dac)$$0xx.a()).f().a(n.i)).collect(Collectors.toList())
            );
   ...
   public void a(cuw $$0, int $$1) {
      Map<cuw, Integer> $$2 = cux.a(this);
      if ($$1 != 0) {
   ...
   @Nullable
   public cex H() {
      return this.D instanceof cex ? (cex)this.I() : null;
   }
   ...
   public void a(il<bqr> $$0, bqu $$1, @Nullable bpe $$2) {
      this.x();
   ...
   public boolean a(iy<dac> $$0, dnf $$1) {
      if (this.F == null) {
         this.F = new cnv("CanPlaceOn");
      }

      return this.F.a(this, $$0, $$1);
   }

   public boolean b(iy<dac> $$0, dnf $$1) {
      if (this.E == null) {
         this.E = new cnv("CanDestroy");
      }
   ...
   public void a(int $$0, @Nullable bpp $$1) {
      if ($$1 == null || !$$1.fM()) {
         this.h($$0);
      }
   }

   public void b(cxb $$0, bpp $$1, int $$2) {
      this.d().a($$0, $$1, this, $$2);
   }
