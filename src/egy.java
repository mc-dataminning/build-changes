...
public class egy {
   private static final eah a = dmh.hK.m();
   private static final eah b = dmh.hL.m();
   private static final eah c = dmh.jc.m();
   private static final eah d = dmh.hO.m();
   private static final eah e = dmh.hW.m();
   private static final eah f = dmh.hY.m();
   private static final eah g = dmh.hS.m();
   private static final eah h = dmh.je.m();
   private static final eah i = dmh.ef.m();
   private final eah j;
   private final int k;
   private final eah[] l;
   private final evr m;
   ...
   public egy(egu $$0, eah $$1, int $$2, egt $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(egp.P);
   ...
   public void a(egu $$0, dkf $$1, jr<dkd> $$2, boolean $$3, ehd $$4, final ece $$5, egk $$6, egx.o $$7) {
      ...
      egx.g $$13 = new egx.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      egx.u $$14 = $$7.apply($$13);
      iu.a $$15 = new iu.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(egg.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            je<dkd> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dkk.C)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(egg.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<eah> a(egx.o $$0, eih $$1, Function<iu, je<dkd>> $$2, ece $$3, egk $$4, iu $$5, boolean $$6) {
      egx.g $$7 = new egx.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().f(mg.aG), $$1);
      egx.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      eah $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(ecb $$0, int $$1, int $$2, int $$3, djc $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dkd $$1, ecb $$2, iu.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).l() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dmh.J) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(azv $$0, eah[] $$1, int $$2, eah $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected eah a(int $$0, int $$1, int $$2) {
