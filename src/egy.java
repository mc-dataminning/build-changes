...
public class egy {
   ...
   public egy(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<egz> $$1) throws IOException {
   ...
   public List<egz> a(Path $$0) throws IOException {
      List<egz> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<egz> a(Path $$0, boolean $$1) throws IOException {
      List<egz> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<egz> $$1) throws IOException {
