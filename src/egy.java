...
public class egy {
   ...
   public egy(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public egy(gu $$0, gu $$1) {
      this((double)$$0.u(), (double)$$0.v(), (double)$$0.w(), (double)$$1.u(), (double)$$1.v(), (double)$$1.w());
   }

   public egy(ehd $$0, ehd $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static egy a(duq $$0) {
      return new egy((double)$$0.g(), (double)$$0.h(), (double)$$0.i(), (double)($$0.j() + 1), (double)($$0.k() + 1), (double)($$0.l() + 1));
   }

   public static egy a(ehd $$0) {
      return new egy($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public egy a(double $$0) {
      return new egy($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public egy b(double $$0) {
      return new egy(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public egy c(double $$0) {
      return new egy(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public egy d(double $$0) {
      return new egy(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public egy e(double $$0) {
      return new egy(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public egy f(double $$0) {
      return new egy(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public egy b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public egy c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public egy d(double $$0, double $$1, double $$2) {
      return new egy(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public egy f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public egy h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ehd> b(ehd $$0, ehd $$1) {
   ...
   @Nullable
   public static egz a(Iterable<egy> $$0, ehd $$1, ehd $$2, gu $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new egz($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ha a(egy $$0, ehd $$1, double[] $$2, @Nullable ha $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public ehd f() {
      return new ehd(arp.d(0.5, this.a, this.d), arp.d(0.5, this.b, this.e), arp.d(0.5, this.c, this.f));
   }

   public static egy a(ehd $$0, double $$1, double $$2, double $$3) {
      return new egy($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
