...
public abstract class bie extends DataFix {
   private final String a;

   public bie(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(bhs.z.typeName(), bjg.a());
      if (!Objects.equals(this.getOutputSchema().getType(bhs.z), $$2)) {
