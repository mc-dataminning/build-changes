...
public class bie extends bhp {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bgd.H, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), c, d));
   }

   protected static Map<String, Supplier<TypeTemplate>> a(Schema $$0) {
      Supplier<TypeTemplate> $$1 = () -> DSL.optionalFields("id", bgd.D.in($$0));
      Supplier<TypeTemplate> $$2 = () -> DSL.optionalFields("id", bgd.C.in($$0));
      Supplier<TypeTemplate> $$3 = () -> DSL.optionalFields("id", bgd.z.in($$0));
