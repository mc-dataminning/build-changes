...
public class eiy {
   ...
   static class a implements eiy.i {
      @Override
      public boolean a(eiy.v $$0) {
         return $$0.c[is.f.d()] && !$$0.b[is.f.d()].d;
      }

      @Override
      public eiy.r a(is $$0, eiy.v $$1, ayg $$2) {
         $$1.d = true;
         $$1.b[is.f.d()].d = true;
         return new eiy.k($$0, $$1);
      }
   }

   static class b implements eiy.i {
      @Override
      public boolean a(eiy.v $$0) {
         if ($$0.c[is.f.d()] && !$$0.b[is.f.d()].d && $$0.c[is.b.d()] && !$$0.b[is.b.d()].d) {
            eiy.v $$1 = $$0.b[is.f.d()];
            return $$1.c[is.b.d()] && !$$1.b[is.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public eiy.r a(is $$0, eiy.v $$1, ayg $$2) {
         ...
         $$1.b[is.f.d()].d = true;
         $$1.b[is.b.d()].d = true;
         $$1.b[is.f.d()].b[is.b.d()].d = true;
         return new eiy.l($$0, $$1);
      }
   }

   static class c implements eiy.i {
      @Override
      public boolean a(eiy.v $$0) {
         return $$0.c[is.b.d()] && !$$0.b[is.b.d()].d;
      }
      ...
      public eiy.r a(is $$0, eiy.v $$1, ayg $$2) {
         $$1.d = true;
         $$1.b[is.b.d()].d = true;
         return new eiy.m($$0, $$1);
      }
   }

   static class d implements eiy.i {
      @Override
      public boolean a(eiy.v $$0) {
         if ($$0.c[is.c.d()] && !$$0.b[is.c.d()].d && $$0.c[is.b.d()] && !$$0.b[is.b.d()].d) {
            eiy.v $$1 = $$0.b[is.c.d()];
            return $$1.c[is.b.d()] && !$$1.b[is.b.d()].d;
         } else {
            return false;
      ...
      public eiy.r a(is $$0, eiy.v $$1, ayg $$2) {
         ...
         $$1.b[is.c.d()].d = true;
         $$1.b[is.b.d()].d = true;
         $$1.b[is.c.d()].b[is.b.d()].d = true;
         return new eiy.n($$0, $$1);
      }
   }

   static class e implements eiy.i {
      @Override
      public boolean a(eiy.v $$0) {
         return $$0.c[is.c.d()] && !$$0.b[is.c.d()].d;
      }

      @Override
      public eiy.r a(is $$0, eiy.v $$1, ayg $$2) {
         eiy.v $$3 = $$1;
         if (!$$1.c[is.c.d()] || $$1.b[is.c.d()].d) {
            $$3 = $$1.b[is.d.d()];
         }

         $$3.d = true;
         $$3.b[is.c.d()].d = true;
         return new eiy.o($$0, $$3);
      }
   }

   static class f implements eiy.i {
      @Override
      public boolean a(eiy.v $$0) {
         return true;
      }
      ...
      public eiy.r a(is $$0, eiy.v $$1, ayg $$2) {
         $$1.d = true;
         return new eiy.s($$0, $$1, $$2);
      }
   }

   static class g implements eiy.i {
      @Override
      public boolean a(eiy.v $$0) {
         return !$$0.c[is.e.d()] && !$$0.c[is.f.d()] && !$$0.c[is.c.d()] && !$$0.c[is.d.d()] && !$$0.c[is.b.d()];
      }

      @Override
      public eiy.r a(is $$0, eiy.v $$1, ayg $$2) {
         $$1.d = true;
         return new eiy.t($$0, $$1);
      }
   }

   public static class h extends eiy.r {
      ...
      private eiy.v G;
      private eiy.v H;
      private final List<eiy.r> I = Lists.newArrayList();

      public h(ayg $$0, int $$1, int $$2, is $$3) {
         super(ehg.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eiy.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eiy.p($$3, this.G));
         this.I.add(new eiy.j($$3, this.H));
         List<eiy.i> $$5 = Lists.newArrayList();
         $$5.add(new eiy.b());
         $$5.add(new eiy.d());
         $$5.add(new eiy.e());
         $$5.add(new eiy.a());
         ...
         egh $$10 = egh.a(this.b(1, 1, 1), this.b(23, 8, 21));
         egh $$11 = egh.a(this.b(34, 1, 1), this.b(56, 8, 21));
         egh $$12 = egh.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eiy.u($$3, $$10, $$13++));
         this.I.add(new eiy.u($$3, $$11, $$13++));
         this.I.add(new eiy.q($$3, $$12));
      }
      ...
      private List<eiy.v> b(ayg $$0) {
         eiy.v[] $$1 = new eiy.v[75];
         ...
         eiy.v $$23 = new eiy.v(1003);
         eiy.v $$24 = new eiy.v(1001);
         eiy.v $$25 = new eiy.v(1002);
         $$1[v].a(is.b, $$23);
         $$1[w].a(is.d, $$24);
         $$1[x].a(is.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[is.f.d()].d = true;
         this.H.b[is.c.d()].d = true;
         this.H.b[is.f.d()].b[is.c.d()].d = true;
         this.H.b[is.b.d()].d = true;
         this.H.b[is.f.d()].b[is.b.d()].d = true;
         this.H.b[is.c.d()].b[is.b.d()].d = true;
         this.H.b[is.f.d()].b[is.c.d()].b[is.b.d()].d = true;
         ObjectArrayList<eiy.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, day $$2, ayg $$3, egh $$4) {
         int $$5 = 24;
      ...
      private void a(day $$0, ayg $$1, egh $$2) {
      ...
      private void b(day $$0, ayg $$1, egh $$2) {
      ...
      private void c(day $$0, ayg $$1, egh $$2) {
      ...
      private void d(day $$0, ayg $$1, egh $$2) {
      ...
      private void e(day $$0, ayg $$1, egh $$2) {
      ...
      private void f(day $$0, ayg $$1, egh $$2) {
   ...
   interface i {
      boolean a(eiy.v var1);

      eiy.r a(is var1, eiy.v var2, ayg var3);
   }

   public static class j extends eiy.r {
      public j(is $$0, eiy.v $$1) {
         super(ehg.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(day $$0, daw $$1, dse $$2, ayg $$3, egh $$4, czk $$5, in $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, ddg.ch.n(), ddg.ch.n(), false);
   ...
   public static class k extends eiy.r {
      public k(is $$0, eiy.v $$1) {
         super(ehg.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(day $$0, daw $$1, dse $$2, ayg $$3, egh $$4, czk $$5, in $$6) {
         eiy.v $$7 = this.B.b[is.f.d()];
         eiy.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[is.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[is.a.d()]);
         }
   ...
   public static class l extends eiy.r {
      public l(is $$0, eiy.v $$1) {
         super(ehg.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eiy.r {
      public m(is $$0, eiy.v $$1) {
         super(ehg.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(day $$0, daw $$1, dse $$2, ayg $$3, egh $$4, czk $$5, in $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[is.a.d()]);
         }

         eiy.v $$7 = this.B.b[is.b.d()];
         if ($$7.b[is.b.d()] == null) {
   ...
   public static class n extends eiy.r {
      public n(is $$0, eiy.v $$1) {
         super(ehg.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(day $$0, daw $$1, dse $$2, ayg $$3, egh $$4, czk $$5, in $$6) {
         eiy.v $$7 = this.B.b[is.c.d()];
         eiy.v $$8 = this.B;
         eiy.v $$9 = $$7.b[is.b.d()];
         eiy.v $$10 = $$8.b[is.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[is.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[is.a.d()]);
         }
   ...
   public static class o extends eiy.r {
      public o(is $$0, eiy.v $$1) {
         super(ehg.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eiy.r {
      public p(is $$0, eiy.v $$1) {
         super(ehg.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eiy.r {
      public q(is $$0, egh $$1) {
         super(ehg.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends egt {
      protected static final dqh b = ddg.hZ.n();
      protected static final dqh c = ddg.ia.n();
      protected static final dqh d = ddg.ib.n();
      protected static final dqh h = c;
      protected static final dqh i = ddg.ii.n();
      protected static final boolean j = true;
      protected static final dqh k = ddg.G.n();
      protected static final Set<dde> l = ImmutableSet.builder().add(ddg.dO).add(ddg.iC).add(ddg.mW).add(k.b()).build();
      ...
      public r(ehg $$0, is $$1, int $$2, egh $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ehg $$0, int $$1, is $$2, eiy.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static egh a(is $$0, eiy.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         egh $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(day $$0, egh $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dqh $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(day $$0, egh $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(day $$0, egh $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dqh $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(egh $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(day $$0, egh $$1, int $$2, int $$3, int $$4) {
         in $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cic $$6 = brn.D.a((dad)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eP());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dn()), bse.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eiy.r {
      private int a;

      public s(is $$0, eiy.v $$1, ayg $$2) {
         super(ehg.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(day $$0, daw $$1, dse $$2, ayg $$3, egh $$4, czk $$5, in $$6) {
         ...
         if (this.B.b[is.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[is.a.d()] && !this.B.c[is.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends eiy.r {
      public t(is $$0, eiy.v $$1) {
         super(ehg.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eiy.r {
      private int a;

      public u(is $$0, egh $$1, int $$2) {
         super(ehg.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
