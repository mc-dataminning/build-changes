...
public class eiy extends eje<elg> {
   public eiy(Codec<elg> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejg<elg> $$0) {
      dju $$1 = $$0.b();
      iu $$2 = $$0.e();
      elg $$3 = $$0.f();
      azv $$4 = $$0.d();
   ...
   private void a(dju $$0, azv $$1, iu $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, elg $$9) {
      Optional<efo> $$10 = efo.a($$0, $$2, $$9.b, eiz::c, eiz::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((diy)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((diy)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               eiz.a($$0, $$2.h($$11.getAsInt() - 1), ja.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               eiz.a($$0, $$2.h($$17.getAsInt() + 1), ja.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(diy $$0, iu $$1) {
      return $$0.a_($$1).a(dmc.K);
   }

   private int a(azv $$0, int $$1, int $$2, float $$3, int $$4, elg $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(dju $$0, iu $$1) {
      dzz $$2 = $$0.a_($$1);
      if (!$$2.a(dmc.J) && !$$2.a(dmc.sZ) && !$$2.a(dmc.sY)) {
         if ($$0.a_($$1.d()).y().a(axh.a)) {
            return false;
         } else {
            for (ja $$3 : ja.c.a) {
               if (!this.a((diw)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((diw)$$0, $$1.e());
         }
      } else {
         return false;
      }
   ...
   private boolean a(diw $$0, iu $$1) {
      dzz $$2 = $$0.a_($$1);
      return $$2.a(axc.bg) || $$2.y().a(axh.a);
   }

   private void a(dju $$0, iu $$1, int $$2, ja $$3) {
      iu.a $$4 = $$1.k();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, elg $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
