...
public class eiy {
   ...
   public eiy(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<eiz> $$1) throws IOException {
   ...
   public List<eiz> a(Path $$0) throws IOException {
      List<eiz> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<eiz> a(Path $$0, boolean $$1) throws IOException {
      List<eiz> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<eiz> $$1) throws IOException {
