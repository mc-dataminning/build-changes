...
public abstract class eiy {
   ...
   public eia a() {
      if (this.c()) {
         ...
         return new eia(this.b(hx.a.a), this.b(hx.a.b), this.b(hx.a.c), this.c(hx.a.a), this.c(hx.a.b), this.c(hx.a.c));
      }
   }

   public eiy b() {
      return this.c() ? eiv.a() : eiv.a(this.b(hx.a.a), this.b(hx.a.b), this.b(hx.a.c), this.c(hx.a.a), this.c(hx.a.b), this.c(hx.a.c));
   }
   ...
   public eiy a(double $$0, double $$1, double $$2) {
      return (eiy)(this.c() ? eiv.a() : new eih(this.a, new eiu(this.a(hx.a.a), $$0), new eiu(this.a(hx.a.b), $$1), new eiu(this.a(hx.a.c), $$2)));
   }

   public eiy d() {
      eiy[] $$0 = new eiy[]{eiv.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = eiv.b($$0[0], eiv.a($$1, $$2, $$3, $$4, $$5, $$6), eij.o));
      return $$0[0];
   }

   public void a(eiv.a $$0) {
      this.a
         .a(
   ...
   public List<eia> e() {
      List<eia> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new eia($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(hx.a $$0, double $$1) {
      return asy.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public eib a(eif $$0, eif $$1, ht $$2) {
      if (this.c()) {
         return null;
      } else {
         eif $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(hx.a.a, $$4.c - (double)$$2.u()), this.a(hx.a.b, $$4.d - (double)$$2.v()), this.a(hx.a.c, $$4.e - (double)$$2.w()))
               ? new eib($$4, hx.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : eia.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<eif> a(eif $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         eif[] $$1 = new eif[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = asy.a($$0.a(), $$2, $$5);
            double $$9 = asy.a($$0.b(), $$3, $$6);
            double $$10 = asy.a($$0.c(), $$4, $$7);
   ...
   public eiy a(hx $$0) {
      if (!this.c() && this != eiv.b()) {
         if (this.b != null) {
            eiy $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private eiy b(hx $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new eiw(this, $$1, $$4);
      }
   }

   public double a(hx.a $$0, eia $$1, double $$2) {
      return this.a(hr.a($$0, hx.a.a), $$1, $$2);
   }

   protected double a(hr $$0, eia $$1, double $$2) {
      if (this.c()) {
         return $$2;
