...
public class ebg implements dly.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ebg> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final atc<ebg> a = atc.a(f);
   private final ebk g;
   private final ebk h;
   private final ebk i;
   ...
   public static ebg a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ebg(new dng(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ebg(ebk $$0, ebk $$1, ebk $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ebg(ato $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ebk.a($$0, IntStream.rangeClosed(-15, 0)),
         ebk.a($$0, IntStream.rangeClosed(-15, 0)),
         ebk.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ebg a(ato $$0) {
      return new ebg($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dly.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         ebh $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ebk.b($$4 * $$13), ebk.b($$5 * $$13), ebk.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ebk.b($$1 * $$13);
         double $$21 = ebk.b($$2 * $$13);
         double $$22 = ebk.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            ebh $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return ati.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
