...
public class ebg extends eba<edf> {
   private static final je[] a = je.values();

   public ebg(Codec<edf> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebc<edf> $$0) {
      edf $$1 = $$0.f();
      azh $$2 = $$0.d();
      iz $$3 = $$0.e();
      dcv $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dyv $$9 = new dyv(new dxx($$4.C()));
      ena $$10 = ena.a($$9, -4, 1.0);
      ...
      for (iz $$33 : iz.c($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<iz, Integer> $$37 : $$7) {
            $$35 += ayz.f($$33.j((kd)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }
      ...
      for (iz $$44 : $$31) {
         ...
         for (je $$46 : a) {
            ...
            dse $$48 = $$4.a_($$47);
            if ($$45.b(dsu.C)) {
               $$45 = $$45.a(dsu.C, Boolean.valueOf($$48.u().b()));
            }
