...
public class ebg extends eba {
   ...
   public int a(eaz[] $$0, eaz $$1) {
      ...
      if (this.b.a($$4) >= 0.0F && $$5 != eax.w) {
         $$3 = arw.d(Math.max(1.0F, this.b.dF()));
      }

      double $$6 = this.d(new gw($$1.a, $$1.b, $$1.c));
      eaz $$7 = this.a($$1.a, $$1.b, $$1.c + 1, $$3, $$6, ha.d, $$5);
      if (this.a($$7, $$1)) {
         $$0[$$2++] = $$7;
      }

      eaz $$8 = this.a($$1.a - 1, $$1.b, $$1.c, $$3, $$6, ha.e, $$5);
      if (this.a($$8, $$1)) {
         $$0[$$2++] = $$8;
      }

      eaz $$9 = this.a($$1.a + 1, $$1.b, $$1.c, $$3, $$6, ha.f, $$5);
      if (this.a($$9, $$1)) {
         $$0[$$2++] = $$9;
      }

      eaz $$10 = this.a($$1.a, $$1.b, $$1.c - 1, $$3, $$6, ha.c, $$5);
      if (this.a($$10, $$1)) {
         $$0[$$2++] = $$10;
      }

      eaz $$11 = this.a($$1.a - 1, $$1.b, $$1.c - 1, $$3, $$6, ha.c, $$5);
      if (this.a($$1, $$8, $$10, $$11)) {
         $$0[$$2++] = $$11;
      }

      eaz $$12 = this.a($$1.a + 1, $$1.b, $$1.c - 1, $$3, $$6, ha.c, $$5);
      if (this.a($$1, $$9, $$10, $$12)) {
         $$0[$$2++] = $$12;
      }

      eaz $$13 = this.a($$1.a - 1, $$1.b, $$1.c + 1, $$3, $$6, ha.d, $$5);
      if (this.a($$1, $$8, $$7, $$13)) {
         $$0[$$2++] = $$13;
      }

      eaz $$14 = this.a($$1.a + 1, $$1.b, $$1.c + 1, $$3, $$6, ha.d, $$5);
      if (this.a($$1, $$9, $$7, $$14)) {
         $$0[$$2++] = $$14;
      }
   ...
   protected double d(gw $$0) {
      return (this.f() || this.c()) && this.a.b_($$0).a(apx.a) ? (double)$$0.v() + 0.5 : a(this.a, $$0);
   }
   ...
   @Nullable
   protected eaz a(int $$0, int $$1, int $$2, int $$3, double $$4, ha $$5, eax $$6) {
      eaz $$7 = null;
      gw.a $$8 = new gw.a();
   ...
   protected static eax b(cpb $$0, gw $$1) {
      ...
      if ($$2.i()) {
         return eax.b;
      } else if ($$2.a(aps.P) || $$2.a(csw.fm) || $$2.a(csw.rC)) {
         return eax.e;
      } else if ($$2.a(csw.qC)) {
         return eax.f;
         ...
         if ($$4.a(apx.b)) {
            ...
            return eax.v;
         } else if (!$$2.a(aps.S) && !$$2.a(aps.L) && (!($$3 instanceof cvq) || $$2.c(cvq.a))) {
            if (!$$2.a($$0, $$1, ebc.a)) {
               return eax.a;
            } else {
               return $$4.a(apx.a) ? eax.j : eax.b;
            }
         } else {
            return eax.h;
         }
   ...
   public static boolean a(dfj $$0) {
      return $$0.a(aps.aJ) || $$0.a(csw.H) || $$0.a(csw.kJ) || cti.g($$0) || $$0.a(csw.fv);
   }
}
