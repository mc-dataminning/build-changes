...
public class fvi {
   private static final fvu a = fvu.t(new aiy("textures/map/map_background.png"));
   private static final fvu b = fvu.t(new aiy("textures/map/map_background_checkerboard.png"));
   ...
   private float az;
   private float aA;
   private final gar aB;
   private final gbr aC;

   public fvi(exh $$0, gar $$1, gbr $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bog $$0, coz $$1, cow $$2, boolean $$3, esa $$4, fvm $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dM(), $$6, ggl.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private void a(esa $$0, fvm $$1, int $$2, boa $$3) {
      gfx $$4 = (gfx)this.aB.<ful>a(this.au.s);
      $$0.a();
   ...
   private void a(esa $$0, fvm $$1, int $$2, float $$3, boa $$4, float $$5, coz $$6) {
   ...
   private void a(esa $$0, fvm $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = awh.c($$5);
   ...
   private void a(esa $$0, fvm $$1, int $$2, coz $$3) {
   ...
   private void a(esa $$0, fvm $$1, int $$2, float $$3, float $$4, boa $$5) {
      boolean $$6 = $$5 != boa.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = awh.c($$4);
   ...
   public void a(float $$0, esa $$1, fvm.a $$2, fuo $$3, int $$4) {
      float $$5 = $$3.x($$0);
   ...
   static fvi.a a(fuo $$0) {
      ...
      if (!$$3 && !$$4) {
         ...
         return a($$1) ? fvi.a.b : fvi.a.a;
      }
   }

   private static fvi.a b(fuo $$0) {
      coz $$1 = $$0.fp();
      blt $$2 = $$0.fo();
      if (!$$1.a(cpc.ot) && !$$1.a(cpc.vP)) {
         return $$2 == blt.a && a($$0.eU()) ? fvi.a.b : fvi.a.a;
      } else {
         return fvi.a.a($$2);
      }
   }
   ...
   private void a(ful $$0, float $$1, float $$2, blt $$3, float $$4, coz $$5, float $$6, esa $$7, fvm $$8, int $$9) {
      if (!$$0.gr()) {
         boolean $$10 = $$3 == blt.a;
