public abstract class fvi<T extends cub> extends fug<T> implements ctl {
   private final alz G;

   public fvi(T $$0, cpr $$1, xv $$2, alz $$3) {
      super($$0, $$1, $$2);
      this.G = $$3;
   }
   ...
   protected void a(fnl $$0, float $$1, int $$2, int $$3) {
      $$0.a(glo::B, this.G, this.C, this.D, 0.0F, 0.0F, this.s, this.u, 256, 256);
