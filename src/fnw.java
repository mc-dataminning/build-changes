...
public class fnw extends fon {
   ...
   protected void b(fmj $$0) {
      if (this.d) {
         $$0.a(fmi.a, xe.c("narrator.loading.done"));
      } else {
         $$0.a(fmi.a, this.B());
      }
   }
   ...
   private xe B() {
      return xe.a("loading.progress", aym.a(this.b.f(), 0, 100));
   }
   ...
   public void a(fia $$0, int $$1, int $$2, float $$3) {
      ...
      a($$0, this.b, $$5, $$6, 2, 0);
      int $$7 = this.b.e() + 9 + 2;
      $$0.a(this.p, this.B(), $$5, $$6 - $$7, 16777215);
   }

   public static void a(fia $$0, arg $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$4 + $$5;
      int $$7 = $$1.d();
      int $$8 = $$7 * $$6 - $$5;
      int $$9 = $$1.e();
