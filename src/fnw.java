...
public class fnw extends fno<cpu> implements fps {
   private float D;
   private float E;
   ...
   public fnw(clw $$0) {
      super($$0.cb, $$0.gc(), wx.c("container.crafting"));
      this.r = 97;
   }
   ...
   public void C() {
      if (this.m.q.f()) {
         this.m.a(new fnl(this.m.s, this.m.s.h.y(), this.m.m.I().c()));
      } else {
         this.F.h();
      }
   }
   ...
   protected void aM_() {
      if (this.m.q.f()) {
         ...
         this.c(new fgl(this.z + 104, this.o / 2 - 22, 20, 18, fpm.a, $$0 -> {
            this.F.e();
            this.z = this.F.a(this.n, this.c);
   ...
   public static void a(ffm $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bso $$9) {
   ...
   public static void a(ffm $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bso $$7) {
      $$0.c().a();
