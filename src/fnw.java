...
public class fnw {
   ...
   public static class b extends fpj {
      b(flj $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * atm.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends fov {
      private boolean b;
      private boolean F;
      private final fok G;
      private float H;
      ...
      c(flj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fok $$7, fpe $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fnw.c $$0 = new fnw.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fol<jv> {
      ...
      public foi a(jv $$0, flj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fnw.c $$8 = new fnw.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, etd.N().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fog {
      private int a;
      private final fok b;
      private sf D;
      private boolean E;

      public e(flj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fok $$7, @Nullable rz $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, aqs.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }

         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            int $$6 = this.a / 2;
            rz $$7 = this.D.a($$6);
            ckn.a $$8 = ckn.a.a($$7.f("Type"));
            boolean $$9 = $$7.q("Trail");
            ...
            foi $$17 = this.b.a(js.J, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
         ...
         if (this.a > this.t) {
            if (this.E) {
               boolean $$18 = this.c();
               aqq $$19 = $$18 ? aqr.if : aqr.ie;
               this.c.a(this.g, this.h, this.i, $$19, aqs.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fnw.c $$10 = (fnw.c)this.b.a(js.A, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = atm.d($$18, $$13, $$16) * $$0;
                  double $$20 = atm.d($$18, $$14, $$17) * $$0;
