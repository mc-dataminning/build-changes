...
public class fnw implements elc, AutoCloseable {
   ...
   private final List<eli> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, eli> l = Maps.newHashMap();
   private final int m;
   ...
   public fnw(anv $$0, String $$1) throws IOException {
      aey $$2 = new aey("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      ant $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.p = a(arp.a($$5, "blend", null));
         this.s = a($$0, elf.a.a, $$6);
         this.t = a($$0, elf.a.b, $$7);
         this.m = elg.a();
         elg.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = eli.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static eld a(anv $$0, elf.a $$1, String $$2) throws IOException {
      elf $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof eld)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         eld $$7;
         if ($$3 == null) {
            aey $$4 = new aey("shaders/program/" + $$2 + $$1.b());
            ant $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static elb a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new elb();
      } else {
         int $$1 = 32774;
