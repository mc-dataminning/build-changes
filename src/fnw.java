...
public class fnw {
   ...
   public fnw(fqe $$0, cpk $$1, int $$2, fne $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
   ...
   public void a(int $$0, int $$1, int $$2, boolean $$3) {
      ...
      fqe.b $$7 = this.f[this.a($$4, $$5, $$6)];
      $$7.a($$3);
   }

   @Nullable
   protected fqe.b a(gv $$0) {
      int $$1 = aro.a($$0.v() - this.b.C_(), 16);
      if ($$1 >= 0 && $$1 < this.c) {
         int $$2 = aro.b(aro.a($$0.u(), 16), this.d);
         int $$3 = aro.b(aro.a($$0.w(), 16), this.e);
