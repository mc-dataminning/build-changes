...
public class anh {
   ...
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> ww.b("commands.execute.blocks.toobig", $$0, $$1));
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(ww.c("commands.execute.conditional.fail"));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> ww.b("commands.execute.conditional.fail_count", $$0));
   @VisibleForTesting
   public static final Dynamic2CommandExceptionType a = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> ww.b("commands.execute.function.instantiationFailure", $$0, $$1)
   );
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ej.a(
                                       ...
                                       .then(ej.a("at").then(ej.a("targets", ev.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bwa $$2x : ev.c($$0x, "targets")) {
                                             $$1x.add(((ei)$$0x.getSource()).a((aro)$$2x.dV()).a($$2x.dt()).a($$2x.bU()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)ej.a("positioned")
                                       ...
                                       .then(ej.a("over").then(ej.a("heightmap", ey.a()).redirect($$2, $$0x -> {
                                          fdw $$1x = ((ei)$$0x.getSource()).d();
                                          aro $$2x = ((ei)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(jx.b($$3), jx.b($$4))) {
                                             throw gf.a.create();
                                          } else {
                                             int $$5 = $$2x.a(ey.a($$0x, "heightmap"), azk.a($$3), azk.a($$4));
                                             return ((ei)$$0x.getSource()).a(new fdw($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
         ...
         ej.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)ej.a("id", fj.a())
                     .suggests(amr.a)
                     .then(ej.a("value").redirect($$0, $$1x -> a((ei)$$1x.getSource(), amr.a($$1x), true, $$2))))
                  .then(ej.a("max").redirect($$0, $$1x -> a((ei)$$1x.getSource(), amr.a($$1x), false, $$2)))
            )
      );
   ...
   private static ei a(ei $$0, Collection<ffa> $$1, fet $$2, boolean $$3) {
      ffb $$4 = $$0.l().aJ();
      return $$0.a(($$4x, $$5) -> {
         for (ffa $$6 : $$1) {
            fez $$7 = $$4.c($$6, $$2);
   ...
   private static ei a(ei $$0, amg $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static ei a(ei $$0, apx $$1, fa.g $$2, IntFunction<uu> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            tx $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(aro $$0, iu $$1) {
      dhw $$2 = new dhw($$1);
      ebv $$3 = $$0.m().a($$2.h, $$2.i);
      return $$3 == null ? false : $$3.F() == arc.d && $$0.c($$2.a());
   }
                                          ...
                                          ej.a("pos", gf.a())
                                             .then(
                                                a(
                                                   ...
                                                   ej.a("block", gb.a($$3)),
                                                   $$2,
                                                   $$0x -> gb.a($$0x, "block").test(new dzs(((ei)$$0x.getSource()).e(), gf.a($$0x, "pos"), true))
                                                )
                                             )
                                       )
                                 ))
                     ...
                     ej.a("entity")
                        .then(
                           ((RequiredArgumentBuilder)ej.a("entities", ev.b()).fork($$0, $$1x -> a($$1x, $$2, !ev.c($$1x, "entities").isEmpty())))
                              .executes(a($$2, (anh.a)($$0x -> ev.c($$0x, "entities").size())))
                        )
                  ))
               .then(ej.a("predicate").then(a($$0, ej.a("predicate", fk.c($$3)).suggests(f), $$2, $$0x -> a((ei)$$0x.getSource(), fk.c($$0x, "predicate"))))))
            .then(ej.a("function").then(ej.a("name", gr.a()).suggests(anm.b).fork($$0, new anh.c($$2)))))
         .then(
                                 ...
                                 ej.a("slots", fs.a())
                                    .then(
                                       ((RequiredArgumentBuilder)ej.a("item_predicate", gv.a($$3))
                                          ...
                                          .executes(a($$2, (anh.a)($$0x -> a(ev.b($$0x, "entities"), fs.a($$0x, "slots"), gv.a($$0x, "item_predicate")))))
                                    )
                              )
                        )
                  ))
                              ...
                              ej.a("slots", fs.a())
                                 .then(
                                    ((RequiredArgumentBuilder)ej.a("item_predicate", gv.a($$3))
                                       ...
                                       .executes(
                                          a($$2, (anh.a)($$0x -> a((ei)$$0x.getSource(), gf.a($$0x, "pos"), fs.a($$0x, "slots"), gv.a($$0x, "item_predicate"))))
                                       )
                                 )
                           )
                     )
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)ej.a("path", fa.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), fa.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (anh.a)($$1xx -> a($$4.a($$1xx), fa.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static int a(Iterable<? extends bwa> $$0, cwi $$1, Predicate<cys> $$2) {
      int $$3 = 0;
   ...
   private static int a(ei $$0, iu $$1, cwi $$2, Predicate<cys> $$3) throws CommandSyntaxException {
      int $$4 = 0;
      btr $$5 = ans.a($$0, $$1, ans.b);
      int $$6 = $$5.b();
      IntList $$7 = $$2.a();
   ...
   private static Command<ei> a(boolean $$0, anh.a $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((ei)$$1x.getSource()).a(() -> ww.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw d.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((ei)$$1x.getSource()).a(() -> ww.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw e.create($$2);
         }
   ...
   private static int a(apx $$0, fa.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<ei> $$0, anh.d $$1) throws CommandSyntaxException {
      ffa $$2 = fo.a($$0, "target");
      fet $$3 = fc.a($$0, "targetObjective");
      ffa $$4 = fo.a($$0, "source");
      fet $$5 = fc.a($$0, "sourceObjective");
      ffb $$6 = ((ei)$$0.getSource()).l().aJ();
      fex $$7 = $$6.d($$2, $$3);
      fex $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<ei> $$0, cv.d $$1) throws CommandSyntaxException {
      ffa $$2 = fo.a($$0, "target");
      fet $$3 = fc.a($$0, "targetObjective");
      ffb $$4 = ((ei)$$0.getSource()).l().aJ();
      fex $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(ei $$0, je<fbw> $$1) {
      aro $$2 = $$0.e();
      eyq $$3 = new eyq.a($$2).a(fbh.f, $$0.d()).b(fbh.a, $$0.f()).a(fbg.d);
      eyn $$4 = new eyn.a($$3).a(Optional.empty());
      $$4.b(eyn.a($$1.a()));
      return $$1.a().test($$4);
   }
   ...
   private static ArgumentBuilder<ei, ?> a(CommandNode<ei> $$0, ArgumentBuilder<ei, ?> $$1, boolean $$2, anh.b $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((ei)$$2x.getSource()).a(() -> ww.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create();
         }
   ...
   private static int a(CommandContext<ei> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((ei)$$0.getSource()).a(() -> ww.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw d.create();
      }
   ...
   private static int b(CommandContext<ei> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((ei)$$0.getSource()).a(() -> ww.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(aro $$0, iu $$1, iu $$2, iu $$3, boolean $$4) throws CommandSyntaxException {
      eqa $$5 = eqa.a($$1, $$2);
      eqa $$6 = eqa.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<ei> a(Function<bwa, Optional<bwa>> $$0) {
      return $$1 -> {
         ei $$2 = (ei)$$1.getSource();
         bwa $$3 = $$2.f();
   ...
   private static RedirectModifier<ei> b(Function<bwa, Stream<bwa>> $$0) {
      return $$1 -> {
         ei $$2 = (ei)$$1.getSource();
         bwa $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<ei> a(CommandNode<ei> $$0, LiteralArgumentBuilder<ei> $$1) {
      return (LiteralArgumentBuilder<ei>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              ej.a("owner")
                                 .fork(
                                    $$0, a((Function<bwa, Optional<bwa>>)($$0x -> $$0x instanceof bxg $$1x ? Optional.ofNullable($$1x.e()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              ej.a("leasher")
                                 .fork(
                                    $$0, a((Function<bwa, Optional<bwa>>)($$0x -> $$0x instanceof bwx $$1x ? Optional.ofNullable($$1x.C()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           ej.a("target")
                              .fork($$0, a((Function<bwa, Optional<bwa>>)($$0x -> $$0x instanceof bxw $$1x ? Optional.ofNullable($$1x.f()) : Optional.empty())))
                        ))
                     .then(
                        ej.a("attacker")
                           .fork($$0, a((Function<bwa, Optional<bwa>>)($$0x -> $$0x instanceof bvt $$1x ? Optional.ofNullable($$1x.am()) : Optional.empty())))
                     ))
                  .then(ej.a("vehicle").fork($$0, a((Function<bwa, Optional<bwa>>)($$0x -> Optional.ofNullable($$0x.dk()))))))
               .then(ej.a("controller").fork($$0, a((Function<bwa, Optional<bwa>>)($$0x -> Optional.ofNullable($$0x.cW()))))))
            .then(
               ej.a("origin").fork($$0, a((Function<bwa, Optional<bwa>>)($$0x -> $$0x instanceof bxx $$1x ? Optional.ofNullable($$1x.q()) : Optional.empty())))
            ))
         .then(ej.a("passengers").fork($$0, b((Function<bwa, Stream<bwa>>)($$0x -> $$0x.cY().stream()))));
   }

   private static ei a(ei $$0, je.c<bwj<?>> $$1) throws CommandSyntaxException {
      bwa $$2 = aph.a($$0, $$1, $$0.d(), new tx(), true);
      return $$0.a($$2);
   }
   ...
   public static <T extends ek<T>> void a(
      ...
      @Nullable tx $$5,
      hk<T> $$6,
      anr<CommandContext<T>, Collection<hw<T>>> $$7,
      he $$8
   ) {
   ...
   static class c implements hh.a<ei> {
      ...
      public void a(ei $$0, List<ei> $$1, ContextChain<ei> $$2, he $$3, hk<ei> $$4) {
         anh.a($$0, $$1, anm::a, this.a, $$2, null, $$4, $$0x -> gr.a($$0x, "name"), $$3);
      }
   }
