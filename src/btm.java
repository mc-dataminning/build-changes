...
public class btm extends btg {
   public static final MapCodec<btm> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static btm a(float $$0, float $$1, float $$2) {
      return new btm($$0, $$1, $$2);
   }

   private btm(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
   }
