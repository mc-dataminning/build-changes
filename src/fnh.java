...
public abstract class fnh {
   ...
   public static <T1 extends Comparable<T1>> fnh.a<T1> a(dxz<T1> $$0) {
      return new fnh.a<>($$0);
   }

   public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>> fnh.b<T1, T2> a(dxz<T1> $$0, dxz<T2> $$1) {
      return new fnh.b<>($$0, $$1);
   }

   public static <T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> fnh.c<T1, T2, T3> a(dxz<T1> $$0, dxz<T2> $$1, dxz<T3> $$2) {
