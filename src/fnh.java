...
public class fnh {
   private static final fnt a = fnt.s(new aer("textures/map/map_background.png"));
   private static final fnt b = fnt.s(new aer("textures/map/map_background_checkerboard.png"));
   ...
   private final eqm au;
   private ciy av = ciy.b;
   private ciy aw = ciy.b;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final fsm aB;
   private final ftm aC;

   public fnh(eqm $$0, fsm $$1, ftm $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(biy $$0, ciy $$1, civ $$2, boolean $$3, elg $$4, fnl $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dK(), $$6, fyc.d, $$0.ah() + $$2.ordinal());
      }
   }
   ...
   private void a(elg $$0, fnl $$1, int $$2, bis $$3) {
      fxo $$4 = (fxo)this.aB.<fmk>a(this.au.v);
      $$0.a();
   ...
   private void a(elg $$0, fnl $$1, int $$2, float $$3, bis $$4, float $$5, ciy $$6) {
   ...
   private void a(elg $$0, fnl $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = arp.c($$5);
   ...
   private void a(elg $$0, fnl $$1, int $$2, ciy $$3) {
      ...
      Integer $$4 = cjf.d($$3);
      ebn $$5 = cjf.a($$4, this.au.u);
      elk $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(elg $$0, fnl $$1, int $$2, float $$3, float $$4, bis $$5) {
      boolean $$6 = $$5 != bis.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = arp.c($$4);
   ...
   private void a(elg $$0, float $$1, bis $$2, ciy $$3) {
      float $$4 = (float)this.au.v.fo() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.r();
      if ($$5 < 0.8F) {
   ...
   private void a(elg $$0, float $$1, bis $$2, ciy $$3, float $$4) {
      this.b($$0, $$2, $$4);
      float $$5 = (float)(this.au.v.fo() % 10);
      float $$6 = $$5 - $$1 + 1.0F;
   ...
   private void a(elg $$0, bis $$1, float $$2) {
      int $$3 = $$1 == bis.b ? 1 : -1;
   ...
   private void b(elg $$0, bis $$1, float $$2) {
      int $$3 = $$1 == bis.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, elg $$1, fnl.a $$2, fmn $$3, int $$4) {
      float $$5 = $$3.x($$0);
   ...
   @VisibleForTesting
   static fnh.a a(fmn $$0) {
      ciy $$1 = $$0.eR();
      ciy $$2 = $$0.eS();
      boolean $$3 = $$1.a(cjb.nG) || $$2.a(cjb.nG);
      boolean $$4 = $$1.a(cjb.uZ) || $$2.a(cjb.uZ);
      if (!$$3 && !$$4) {
         return fnh.a.a;
      } else if ($$0.fl()) {
         return b($$0);
      } else {
         return a($$1) ? fnh.a.b : fnh.a.a;
      }
   }

   private static fnh.a b(fmn $$0) {
      ciy $$1 = $$0.fn();
      bgp $$2 = $$0.fm();
      if (!$$1.a(cjb.nG) && !$$1.a(cjb.uZ)) {
         return $$2 == bgp.a && a($$0.eS()) ? fnh.a.b : fnh.a.a;
      } else {
         return fnh.a.a($$2);
      }
   }
   ...
   private static boolean a(ciy $$0) {
      return $$0.a(cjb.uZ) && chg.d($$0);
   }

   private void a(fmk $$0, float $$1, float $$2, bgp $$3, float $$4, ciy $$5, float $$6, elg $$7, fnl $$8, int $$9) {
      if (!$$0.go()) {
         boolean $$10 = $$3 == bgp.a;
         ...
         if ($$5.b()) {
            ...
            if ($$0.fl() && $$0.fo() > 0 && $$0.fm() == $$3) {
               ...
               float $$15 = (float)$$5.r() - ((float)this.au.v.fo() - $$1 + 1.0F);
               float $$16 = $$15 / (float)chg.k($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }
            ...
            this.a($$0, $$5, $$13 ? civ.e : civ.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bis.b;
            if ($$0.fl() && $$0.fo() > 0 && $$0.fm() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.s()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.r() - ((float)this.au.v.fo() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.r() - ((float)this.au.v.fo() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$23 ? civ.e : civ.d, !$$23, $$7, $$8, $$9);
         }
