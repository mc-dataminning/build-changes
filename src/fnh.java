...
public class fnh extends fnc {
   ...
   public fnh(boolean $$0) {
      this($$0, null);
   }

   public fnh(boolean $$0, @Nullable fhu $$1) {
      super(b);
      this.x = $$0;
      this.A = Objects.requireNonNullElseGet($$1, () -> new fhu(false));
   }
   ...
   public static CompletableFuture<Void> a(goz $$0, Executor $$1) {
      return CompletableFuture.allOf($$0.a(fhu.a, $$1), $$0.a(fhu.c, $$1), $$0.a(gdp.a, $$1), e.a($$0, $$1));
   }
   ...
   protected void aM_() {
      ...
      fii $$4 = this.c(fhh.a(20, $$0x -> this.m.a(new fml(this, this.m.m, this.m.ag())), true));
      $$4.c(this.n / 2 - 124, $$3 + 72 + 12);
      this.c(fhd.a(xo.c("menu.options"), $$0x -> this.m.a(new fmt(this, this.m.m))).a(this.n / 2 - 100, $$3 + 72 + 12, 98, 20).a());
      this.c(fhd.a(xo.c("menu.quit"), $$0x -> this.m.q()).a(this.n / 2 + 2, $$3 + 72 + 12, 98, 20).a());
      fii $$5 = this.c(fhh.b(20, $$0x -> this.m.a(new fln(this, this.m.m)), true));
      $$5.c(this.n / 2 + 104, $$3 + 72 + 12);
      this.c(new fib($$1, this.o - 10, $$0, 10, c, $$0x -> this.m.a(new fly(this)), this.p));
      if (this.v == null) {
         this.v = new fcw();
      }
   ...
   private void a(int $$0, int $$1) {
      this.c(fhd.a(xo.c("menu.singleplayer"), $$0x -> this.m.a(new frx(this))).a(this.n / 2 - 100, $$0, 200, 20).a());
      xo $$2 = this.E();
      boolean $$3 = $$2 == null;
      fio $$4 = $$2 != null ? fio.a($$2) : null;
      this.c(fhd.a(xo.c("menu.multiplayer"), $$0x -> {
         fnc $$1x = (fnc)(this.m.m.v ? new fqa(this) : new fqb(this));
         this.m.a($$1x);
      }).a(this.n / 2 - 100, $$0 + $$1 * 1, 200, 20).a($$4).a()).j = $$3;
      this.c(fhd.a(xo.c("menu.online"), $$0x -> this.m.a(new fai(this))).a(this.n / 2 - 100, $$0 + $$1 * 2, 200, 20).a($$4).a()).j = $$3;
   }
   ...
   private void b(int $$0, int $$1) {
      boolean $$2 = this.F();
      this.c(fhd.a(xo.c("menu.playdemo"), $$1x -> {
         if ($$2) {
            this.m.x().a("Demo_World", () -> this.m.a(this));
         } else {
            this.m.x().a("Demo_World", MinecraftServer.d, dyr.b, ehz::a, this);
         }
   ...
   private boolean F() {
      try {
         boolean var2;
         try (epv.c $$0 = this.m.m().e("Demo_World")) {
            var2 = $$0.m();
         }
   ...
   public void a(fgq $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.x) {
         ...
         if ($$5 > 1.0F) {
            ...
            this.w = ayy.b($$5, 0.0F, 0.5F, 0.0F, 1.0F);
         }
   ...
   private void c(boolean $$0) {
      if ($$0) {
         try (epv.c $$1 = this.m.m().e("Demo_World")) {
            $$1.k();
         } catch (IOException var7) {
            fjl.b(this.m, "Demo_World");
   ...
   static record a(fgo a, fhw b, int c, int d) {
      public void a(fgq $$0, int $$1) {
