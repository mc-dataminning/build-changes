...
public class aim<C extends blp> implements ail<Integer> {
   private static final Logger d = LogUtils.getLogger();
   protected final chp a = new chp();
   protected chk b;
   protected cls<C> c;
   ...
   public void a(aox $$0, @Nullable csh<? extends csf<C>> $$1, boolean $$2) {
      if ($$1 != null && $$0.I().b($$1)) {
         this.b = $$0.fT();
         if (this.b() || $$0.f()) {
            this.a.a();
   ...
   protected void a(csh<? extends csf<C>> $$0, boolean $$1) {
   ...
   private boolean b() {
      ...
      for (int $$2 = 0; $$2 < this.c.n() * this.c.o() + 1; $$2++) {
         if ($$2 != this.c.m()) {
            cpd $$3 = this.c.b($$2).g().q();
            if (!$$3.b()) {
               int $$4 = this.b.d($$3);
               if ($$4 == -1 && $$0.size() <= $$1) {
                  for (cpd $$5 : $$0) {
                     if (cpd.b($$5, $$3) && $$5.M() != $$5.g() && $$5.M() + $$3.M() <= $$5.g()) {
                        $$5.g($$3.M());
                        $$3.f(0);
                        break;
                     }
