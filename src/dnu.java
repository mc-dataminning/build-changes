...
public class dnu<T> implements dnw<T> {
   ...
   private dnu(io<T> $$0, int $$1, dnx<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dnu(io<T> $$0, T[] $$1, dnx<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dnw<T> c() {
      return new dnu<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
