...
public class dnu {
   ...
   private final csc p;
   private static final List<cva> q = List.of(cvc.l, cvc.L, cvc.i, cvc.b, cvc.k, cvc.I, cvc.K, cvc.fl, cvc.dP, cvc.iA, cvc.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ib<csy>>> t;
   ...
   public static final Codec<dnu> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dnu::a, Function.identity());

   private static DataResult<dnu> a(dnu $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dnu(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ib<csy>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = iu.c($$0);
      int $$5 = iu.c($$1) - $$4;
   ...
   @Nullable
   public static dnu a(aml $$0, int $$1, int $$2) {
      dje $$3 = $$0.a($$1, $$2);
      dnu $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(djj.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<hy> a(csu $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dje $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, atm.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dje $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dmr.a.a)) {
         $$3 = Math.min($$0.a(dmr.a.a, $$1, $$2) + 1, this.p.ak());
      } else {
         $$3 = this.p.ak();
      }
   ...
   private static double a(dje $$0, ht.a $$1) {
      return a($$0, (ht)$$1.c(hx.a)) ? 1.0 : -1.0;
   }

   private static double b(dje $$0, ht.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dje $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      ht.a $$5 = new ht.a($$1, this.p.ak(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<ib<csy>> b(dje $$0, int $$1, int $$2) {
      ObjectArrayList<ib<csy>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dje $$0, ht $$1) {
      dhi $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(arg.O)) {
         ...
         return $$2.a(cvc.eT) || $$2.a(cvc.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dnu.a $$3) {
      if ($$1 >= in.a(this.p.I_()) && $$1 < in.a(this.p.ak())) {
         int $$4 = $$1 - in.a(this.p.I_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               ib<csy> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dnu.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dnu.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ib<csy> var3);
   }
