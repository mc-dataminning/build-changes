...
public interface dnu<T extends Enum<T>> {
   int x_ = 4;

   Optional<eat> k_(eat var1);

   float ar_();

   default void a_(eat $$0, arq $$1, iv $$2, azv $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<eat> c(eat $$0, arq $$1, iv $$2, azv $$3) {
      ...
      for (iv $$7 : iv.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof dnu<?> $$9) {
            Enum<?> $$10 = $$9.c();
