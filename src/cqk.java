...
public class cqk extends cqh {
   ...
   public cqk(bvi<? extends cqk> $$0, dgz $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public cqk(dgz $$0, bvx $$1, bvb $$2, jm.a $$3) {
      this(bvi.bd, $$0);
      this.c($$1);
      fbr $$4 = $$1.cR().f();
   ...
   private void a(@Nullable jm.a $$0) {
      ...
      if (this.b == null) {
         ...
         $$2 = jh.a(this.b.dB(), this.b.dD() + $$1, this.b.dH());
      }
   ...
   public void h() {
      ...
      if (!this.dW().C) {
         if (this.b == null && this.h != null) {
            this.b = ((arx)this.dW()).a(this.h);
            if (this.b == null) {
               this.h = null;
            }
         }

         if (this.b == null || !this.b.bL() || this.b instanceof cpo && this.b.aa_()) {
            this.bf();
         } else {
            this.e = azu.a(this.e * 1.025, -1.0, 1.0);
            this.f = azu.a(this.f * 1.025, -1.0, 1.0);
            this.g = azu.a(this.g * 1.025, -1.0, 1.0);
            fbr $$1 = this.dz();
      ...
      if ($$0 != null && this.bL() && $$0.d() != fbp.a.a) {
         this.b($$0);
      }

      cqj.a(this, 0.5F);
      if (this.dW().C) {
         this.dW().a(ls.t, this.dB() - $$2.d, this.dD() - $$2.e + 0.15, this.dH() - $$2.f, 0.0, 0.0, 0.0);
   ...
   protected void a(fbo $$0) {
      ...
      bvb $$1 = $$0.a();
      bvb $$2 = this.p();
      bvx $$3 = $$2 instanceof bvx ? (bvx)$$2 : null;
      btr $$4 = this.dX().a(this, $$3);
      ...
      if ($$5) {
         ...
         if ($$1 instanceof bvx $$7) {
            $$7.b(new bug(bui.y, 200), (bvb)MoreObjects.firstNonNull($$2, this));
         }
      }
   }
   ...
   protected void a(fbn $$0) {
      super.a($$0);
      ((arx)this.dW()).a(ls.w, this.dB(), this.dD(), this.dH(), 2, 0.2, 0.2, 0.2, 0.0);
      this.a(awv.xo, 1.0F, 1.0F);
   }

   private void m() {
      this.at();
      this.dW().a(eck.o, this.du(), eck.a.a(this));
   }
   ...
   public boolean a(arx $$0, btr $$1, float $$2) {
      this.a(awv.xp, 1.0F, 1.0F);
      $$0.a(ls.f, this.dB(), this.dD(), this.dH(), 15, 0.2, 0.2, 0.2, 0.0);
      this.m();
      return true;
   }
