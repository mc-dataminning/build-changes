...
public class cqk {
   public static final int a = hr.a(8);
   private static final int b = 2;
   private static final int c = 4;
   private static final int d = 3;
   private final cqk.a e;
   private final long f;

   public cqk(cqk.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public cqk a(cqk.a $$0) {
      return new cqk($$0, this.f);
   }

   public hf<cqi> a(gv $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public hf<cqi> a(double $$0, double $$1, double $$2) {
      int $$3 = hr.a(aro.a($$0));
      int $$4 = hr.a(aro.a($$1));
      int $$5 = hr.a(aro.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = ark.a($$7, $$0);
      double $$10 = b($$7);
      return aro.k($$6 + $$10) + aro.k($$5 + $$9) + aro.k($$4 + $$8);
   }
   ...
   public interface a {
      hf<cqi> getNoiseBiome(int var1, int var2, int var3);
   }
}
