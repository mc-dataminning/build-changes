...
public abstract class dbx implements es {
   private static final SimpleDateFormat b = new SimpleDateFormat("HH:mm:ss");
   private static final wz c = wz.b("@");
   private long d = -1L;
   ...
   public wz l() {
      return this.h == null ? wy.a : this.h;
   }
   ...
   public ub a(ub $$0, jo.a $$1) {
      ...
      if (this.j != null) {
         $$0.a("CustomName", wz.a.a(this.j, $$1));
      }

      $$0.a("TrackOutput", this.g);
      if (this.h != null && this.g) {
         $$0.a("LastOutput", wz.a.a(this.h, $$1));
      }
   ...
   public void b(ub $$0, jo.a $$1) {
      this.i = $$0.l("Command");
      this.f = $$0.h("SuccessCount");
      if ($$0.b("CustomName", 8)) {
         this.b(dqh.a($$0.l("CustomName"), $$1));
      } else {
         this.b(null);
      }
      ...
      if ($$0.b("LastOutput", 8) && this.g) {
         try {
            this.h = wz.a.a($$0.l("LastOutput"), $$1);
         } catch (Throwable var4) {
            this.h = wz.b(var4.getMessage());
         }
      } else {
         this.h = null;
      }
   ...
   public void a(wz $$0) {
      if (this.g) {
         this.h = wz.b("[" + b.format(new Date()) + "] ").b($$0);
         this.f();
      }
   }

   public abstract aqu e();
   ...
   @Override
   public boolean k_() {
      return this.e().ab().b(dcs.p) && this.g;
   }
