...
public class dul extends dur {
   public static final Codec<dul> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, dul::new));

   public dul(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<dsz.a> a(cry $$0, BiConsumer<ht, dgw> $$1, ato $$2, int $$3, ht $$4, dsj $$5) {
      ...
      $$6.add(new dsz.a(new ht($$14, $$16, $$15), 0, true));
      ...
      for (int $$20 = -1; $$20 <= 2; $$20++) {
         for (int $$21 = -1; $$21 <= 2; $$21++) {
            if (($$20 < 0 || $$20 > 1 || $$21 < 0 || $$21 > 1) && $$2.a(3) <= 0) {
               ...
               $$6.add(new dsz.a(new ht($$14 + $$20, $$16, $$15 + $$21), 0, false));
            }
         }
      }
