...
public class dul {
   ...
   public dul(deg $$0, je $$1, jj $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      duo $$0 = this.b.a_(this.e);
      if (!duh.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == equ.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(duo $$0) {
      return $$0.a(dhl.hV) || $$0.a(dhl.pg);
   }

   private static boolean a(duo $$0, duo $$1) {
      if ($$0.a(dhl.pg) && $$1.a(dhl.hV)) {
         return false;
      } else {
         return $$0.a(dhl.hV) && $$1.a(dhl.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(je $$0, jj $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!duh.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               duo $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !duh.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!duh.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
