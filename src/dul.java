...
public class dul<T> implements dun<T> {
   ...
   private dul(jn<T> $$0, int $$1, duo<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dul(jn<T> $$0, T[] $$1, duo<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dun<T> c() {
      return new dul<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
