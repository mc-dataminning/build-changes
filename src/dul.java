...
public class dul extends dvf implements css {
   ...
   private ka<cwn> n = ka.a(9, cwn.j);
   private int r = 0;
   protected final csm k = new csm() {
   ...
   protected csa a(int $$0, cou $$1) {
      return new csq($$0, $$1, this, this.k);
   }
   ...
   private boolean a(int $$0, cwn $$1, int $$2) {
      for (int $$3 = $$2 + 1; $$3 < 9; $$3++) {
         if (!this.c($$3)) {
            cwn $$4 = this.a($$3);
            if ($$4.f() || $$4.M() < $$0 && cwn.c($$4, $$1)) {
               return true;
            }
         }
      }
   ...
   public static void a(dgg $$0, ji $$1, dwv $$2, dul $$3) {
      int $$4 = $$3.r - 1;
      if ($$4 >= 0) {
         $$3.r = $$4;
         if ($$4 == 0) {
            $$0.a($$1, $$2.b(dld.b, Boolean.valueOf(false)), 3);
         }
      }
   }
