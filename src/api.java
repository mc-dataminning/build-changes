...
public interface api {
   api a = new api() {
      ...
      @Override
      public void a(Consumer<cyn> $$0) {
      }
   };

   static api a(cyn $$0, int $$1) {
      return new api.a($$0, $$1);
   }

   static void a(api $$0, api $$1, Consumer<cyn> $$2, Consumer<cyn> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof api.a $$4 && $$1 instanceof api.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new cyn($$10, $$11));
                     } else {
                        $$3.accept(new cyn($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(cyn b, int c) implements api {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(api.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return api.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
