...
public class api {
   ...
   private static int a(ex $$0, int $$1) {
      $$0.l().J().a(a($$0, $$1, arc.b), 0, false, false);
      $$0.a(() -> wo.c("commands.weather.set.clear"), true);
      return $$1;
   }

   private static int b(ex $$0, int $$1) {
      $$0.l().J().a(0, a($$0, $$1, arc.c), true, false);
      $$0.a(() -> wo.c("commands.weather.set.rain"), true);
      return $$1;
   }

   private static int c(ex $$0, int $$1) {
      $$0.l().J().a(0, a($$0, $$1, arc.d), true, true);
      $$0.a(() -> wo.c("commands.weather.set.thunder"), true);
      return $$1;
   }
}
