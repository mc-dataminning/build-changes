...
public class api extends eie implements AutoCloseable {
   public static final int a = 1000;
   private static final Logger d = LogUtils.getLogger();
   private final blw<Runnable> e;
   private final ObjectList<Pair<api.a, Runnable>> f = new ObjectArrayList();
   private final aop g;
   private final blv<aor.a<Runnable>> h;
   private final int i = 1000;
   private final AtomicBoolean j = new AtomicBoolean();

   public api(dpl $$0, aop $$1, boolean $$2, blw<Runnable> $$3, blv<aor.a<Runnable>> $$4) {
      super($$0, true, $$2);
      this.g = $$1;
      this.h = $$4;
      this.e = $$3;
   ...
   protected void a(cwi $$0) {
      this.a($$0.e, $$0.f, () -> 0, api.a.a, ac.a((Runnable)(() -> {
         ...
         for (int $$1 = this.d(); $$1 < this.e(); $$1++) {
            super.a(cxk.b, je.a($$0, $$1), null);
            super.a(cxk.a, je.a($$0, $$1), null);
         }
   ...
   private void a(int $$0, int $$1, api.a $$2, Runnable $$3) {
      this.a($$0, $$1, this.g.c(cwi.c($$0, $$1)), $$2, $$3);
   }
   ...
   public CompletableFuture<dox> a(dox $$0, boolean $$1) {
      cwi $$2 = $$0.f();
   ...
   public CompletableFuture<dox> b(dox $$0, boolean $$1) {
      cwi $$2 = $$0.f();
      $$0.b(false);
      this.a($$2.e, $$2.f, api.a.a, ac.a((Runnable)(() -> {
         if (!$$1) {
