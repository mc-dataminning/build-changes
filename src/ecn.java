...
public class ecn extends LongLinkedOpenHashSet {
   private final ecn.a a;

   public ecn(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new ecn.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = atm.f(60000000);
      private static final int b = atm.f(60000000);
