...
public class ecn extends ecr {
   public static final Codec<ecn> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               eca.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               aws.a(ih.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, ecn::new)
   );
   ...
   protected final eca e;
   protected final int f;
   protected final List<ih> g;

   public ecn(float $$0, int $$1, int $$2, eca $$3, int $$4, List<ih> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(ecr.a $$0, ib $$1, ih $$2) {
