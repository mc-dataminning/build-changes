...
public class ecn extends ecd<ecm> {
   ...
   private static boolean a(dds $$0, jd $$1, ecm $$2, boolean $$3) {
      if ($$0.a($$1, dtb.a::r)) {
         return true;
      } else {
   ...
   private void a(dds $$0, ayw $$1, ecm $$2, jd $$3, int $$4, boolean $$5) {
      jd.a $$6 = new jd.a();
      dtc $$7 = $$2.c;
      int $$8 = $$5 ? 1 : 0;
   ...
   private void b(dds $$0, ayw $$1, ecm $$2, jd $$3, int $$4, boolean $$5) {
      jd.a $$6 = new jd.a();
   ...
   private void a(dcx $$0, ayw $$1, ecm $$2, jd.a $$3, float $$4, float $$5, float $$6) {
      if ($$1.i() < $$4) {
         this.a($$0, $$3, $$2.e);
      } else if ($$1.i() < $$5) {
         this.a($$0, $$3, $$2.d);
