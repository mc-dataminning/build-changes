...
public class edx extends eec {
   public static final Codec<edx> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, edx::new));
   ...
   public List<eck.a> a(daa $$0, BiConsumer<im, dpy> $$1, ayd $$2, int $$3, im $$4, ebu $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = axw.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, axw.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<edx.a> $$13 = Lists.newArrayList();
      $$13.add(new edx.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               im $$21 = $$4.b(axw.a($$19), $$12 - 1, axw.a($$20));
               im $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  im $$27 = new im($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new edx.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<eck.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(daa $$0, BiConsumer<im, dpy> $$1, ayd $$2, im $$3, im $$4, boolean $$5, ebu $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         im $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            im $$13 = $$3.b(axw.d(0.5F + (float)$$12 * $$9), axw.d(0.5F + (float)$$12 * $$10), axw.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(djh.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(daa $$0, BiConsumer<im, dpy> $$1, ayd $$2, int $$3, im $$4, List<edx.a> $$5, ebu $$6) {
      for (edx.a $$7 : $$5) {
         int $$8 = $$7.a();
         im $$9 = new im($$4.u(), $$8, $$4.w());
