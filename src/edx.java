...
public class edx implements edu, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bsy c;
   private final eec d;
   private final SequencedMap<dio, edx.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected edx(eee $$0, Path $$1, boolean $$2) {
      this.d = new eec($$0, $$1, $$2);
      this.c = new bsy(edx.b.values().length, ag.i(), "IOWorker-" + $$0.c());
   }

   public boolean a(dio $$0, int $$1) {
      dio $$2 = new dio($$0.h - $$1, $$0.i - $$1);
      dio $$3 = new dio($$0.h + $$1, $$0.i + $$1);
   ...
   public CompletableFuture<Void> a(dio $$0, Supplier<tz> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         tz $$2 = $$1.get();
         edx.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new edx.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<tz>> a(dio $$0) {
      return this.a((edx.c<Optional<tz>>)(() -> {
         edx.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((edx.c<Void>)(() -> {
            try {
               this.d.a();
               return null;
   ...
   @Override
   public CompletableFuture<Void> a(dio $$0, ut $$1) {
      return this.a((edx.c<Void>)(() -> {
         try {
            edx.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(edx.c<T> $$0) {
      return this.c.a(edx.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<dio, edx.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new bta.c(edx.b.b.ordinal(), this::b));
   }

   private void a(dio $$0, edx.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(edx.b.c.ordinal(), $$0 -> $$0.complete(bau.a)).join();
   }
