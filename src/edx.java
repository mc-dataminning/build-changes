...
public interface edx {
   static edx a(eep $$0, dgw $$1, eer $$2, eey $$3, int $$4, int $$5, edx.a $$6) {
      return new edx.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static edx a(final edx.a $$0) {
      return new edx() {
         @Nullable
         @Override
         public dym a(eee.b $$0x, double $$1) {
   ...
   @Nullable
   dym a(eee.b var1, double var2);

   boolean a();

   public interface a {
      edx.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, dym b) {

      public dym a(int $$0) {
         return $$0 < this.a ? this.b : dkw.a.m();
      }
   }

   public static class c implements edx {
      ...
      private final eee p;
      private final eey q;
      private final edx.b[] r;
      private final long[] s;
      private final edx.a t;
      private final eee u;
      private final eee v;
      private boolean w;
      private final int x;
      ...
      c(eep $$0, dgw $$1, eer $$2, eey $$3, int $$4, int $$5, edx.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public dym a(eee.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            edx.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dkw.K)) {
               this.w = false;
               return dkw.K.m();
            } else {
                  ...
                  for (int $$18 = -1; $$18 <= 1; $$18++) {
                     for (int $$19 = 0; $$19 <= 1; $$19++) {
                        ...
                        if ($$24 != Long.MAX_VALUE) {
                           ...
                           $$25 = jj.a($$20 * 16 + $$26.a(10), $$21 * 12 + $$26.a(9), $$22 * 16 + $$26.a(10));
                           this.s[$$23] = $$25;
                        }
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(dkw.J) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dkw.K)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(eee.b $$0, MutableDouble $$1, edx.b $$2, edx.b $$3) {
         int $$4 = $$0.b();
         dym $$5 = $$2.a($$4);
         dym $$6 = $$3.a($$4);
         if ((!$$5.a(dkw.K) || !$$6.a(dkw.J)) && (!$$5.a(dkw.J) || !$$6.a(dkw.K))) {
      ...
      private edx.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            edx.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private edx.b b(int $$0, int $$1, int $$2) {
         edx.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               edx.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new edx.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, edx.b $$3, int $$4, boolean $$5) {
         eee.e $$6 = new eee.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dji.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new eee.e($$6, $$7, $$8)) * 10.0;
         int $$12 = azk.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private dym a(int $$0, int $$1, int $$2, edx.b $$3, int $$4) {
         dym $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != ecj.g && $$3.b != dkw.K.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new eee.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dkw.K.m();
            }
         }
