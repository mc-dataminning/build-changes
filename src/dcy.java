...
public class dcy {
   ...
   private final dcy.a e;
   private final long f;

   public dcy(dcy.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public dcy a(dcy.a $$0) {
      return new dcy($$0, this.f);
   }

   public ji<dcw> a(iz $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ji<dcw> a(double $$0, double $$1, double $$2) {
      int $$3 = jt.a(ayy.a($$0));
      int $$4 = jt.a(ayy.a($$1));
      int $$5 = jt.a(ayy.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = ayt.a($$7, $$0);
      double $$10 = b($$7);
      return ayy.k($$6 + $$10) + ayy.k($$5 + $$9) + ayy.k($$4 + $$8);
   }
   ...
   public interface a {
      ji<dcw> getNoiseBiome(int var1, int var2, int var3);
   }
}
