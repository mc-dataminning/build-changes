public class epl {
   ...
   private int a(dvw $$0, int $$1, int $$2, int $$3) {
      int $$4 = kg.c($$0.g($$1) + 1);
   ...
   public boolean a(dcx $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dcx $$0, int $$1, int $$2, je $$3, dua $$4, je $$5, dua $$6) {
      int $$7 = $$3.v();
      if (a($$4, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dcx $$0, je $$1, dua $$2) {
      je.a $$3 = this.e.g($$1);
