...
public class epl implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<epl.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public epl(List<epl.a> $$0) {
      this.c = $$0;
   }
   ...
   public static epl a(BufferedReader $$0) {
      return new epl($$0.lines().flatMap($$0x -> epl.a.a($$0x).stream()).toList());
   }

   public static record a(epl.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<epl.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new epl.a(epl.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new epl.a(epl.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new epl.a(epl.b.b, $$3));
      ...
      static epl.a b(String $$0) {
         return new epl.a(epl.b.a, "glob:" + $$0);
      }

      static epl.a c(String $$0) {
         return new epl.a(epl.b.a, "regex:" + $$0);
      }

      static epl.a d(String $$0) {
         return new epl.a(epl.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      epl.b a = FileSystem::getPathMatcher;
      epl.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
