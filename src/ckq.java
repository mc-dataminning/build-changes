...
public class ckq extends clz implements cmd {
   private static final ajy<Integer> a = akc.a(ckq.class, aka.b);
   private static final ajy<Integer> b = akc.a(ckq.class, aka.b);
   private static final ajy<Integer> c = akc.a(ckq.class, aka.b);
   private static final List<ajy<Integer>> d = ImmutableList.of(a, b, c);
   private static final ajy<Integer> bY = akc.a(ckq.class, aka.b);
   ...
   private int cg;
   private final aqz ch = (aqz)new aqz(this.p_(), bsb.a.f, bsb.b.a).a(true);
   private static final cfz.a ci = ($$0, $$1) -> !$$0.aq().a(awt.y) && $$0.fM();
   private static final cfz cj = cfz.a().a(20.0).a(ci);

   public ckq(but<? extends ckq> $$0, dgj $$1) {
      super($$0, $$1);
   ...
   @Override
   public void d_() {
      fbb $$0 = this.dy().d(1.0, 0.6, 1.0);
      if (!this.dV().C && this.c(0) > 0) {
         bum $$1 = this.dV().a(this.c(0));
         if ($$1 != null) {
            double $$2 = $$0.e;
            ...
            $$0 = new fbb($$0.d, $$2, $$0.f);
            fbb $$3 = new fbb($$1.dA() - this.dA(), 0.0, $$1.dG() - this.dG());
            if ($$3.j() > 9.0) {
               fbb $$4 = $$3.d();
   ...
   protected void a(ard $$0) {
      if (this.gs() > 0) {
         ...
         if ($$1 <= 0) {
            $$0.a(this, this.dA(), this.dE(), this.dG(), 7.0F, false, dgj.a.c);
            if (!this.bb()) {
               $$0.b(1023, this.dv(), 0);
            }
         }
         ...
         for (int $$2 = 1; $$2 < 3; $$2++) {
            if (this.af >= this.ce[$$2 - 1]) {
               ...
               if (($$0.am() == bsi.c || $$0.am() == bsi.d) && this.cf[$$2 - 1]++ > 15) {
                  float $$3 = 10.0F;
                  float $$4 = 5.0F;
               ...
               if ($$8 > 0) {
                  bvi $$9 = (bvi)$$0.a($$8);
                  if ($$9 != null && this.c($$9) && !(this.g((bum)$$9) > 900.0) && this.E($$9)) {
                     this.a($$2 + 1, $$9);
                  ...
                  List<bvi> $$10 = $$0.a(bvi.class, cj, this, this.cR().c(20.0, 8.0, 20.0));
                  if (!$$10.isEmpty()) {
                     bvi $$11 = $$10.get(this.ae.a($$10.size()));
                     this.a($$2, $$11.ar());
                  }
               }
            }
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      cqf $$12 = new cqf(this.dV(), this, $$11.d());
      $$12.c(this);
      if ($$4) {
         $$12.a(true);
      }
   ...
   public boolean a(ard $$0, btc $$1, float $$2) {
      if (this.a($$0, $$1)) {
         return false;
      } else if ($$1.a(awr.t) || $$1.d() instanceof ckq) {
         return false;
         ...
         if (this.gt()) {
            bum $$3 = $$1.c();
            if ($$3 instanceof cpf || $$3 instanceof cqj) {
               return false;
            }
         }
   ...
   public static bwp.a p() {
      return clz.gx().a(bwq.s, 300.0).a(bwq.v, 0.6F).a(bwq.l, 0.6F).a(bwq.m, 40.0).a(bwq.a, 4.0);
   }
   ...
   class a extends ccg {
      public a() {
         this.a(EnumSet.of(ccg.a.a, ccg.a.c, ccg.a.b));
      }

      @Override
      public boolean b() {
         return ckq.this.gs() > 0;
      }
   }
}
