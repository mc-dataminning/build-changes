...
public abstract class eqt<T extends eqt<T>> {
   ...
   public eqt(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = eqr.a();
         if ($$3 != null) {
         ...
         throw new esc(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new esc(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new esc(var2.getMessage(), var2);
      }
   }
   ...
   public static eqt<?> a(String $$0) {
      return new eqt.b($$0, 5000, 60000);
   }

   public static eqt<?> a(String $$0, int $$1, int $$2) {
      return new eqt.b($$0, $$1, $$2);
   }

   public static eqt<?> b(String $$0, String $$1) {
      return new eqt.c($$0, $$1, 5000, 60000);
   }

   public static eqt<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new eqt.c($$0, $$1, $$2, $$3);
   }

   public static eqt<?> b(String $$0) {
      return new eqt.a($$0, 5000, 60000);
   }

   public static eqt<?> c(String $$0, String $$1) {
      return new eqt.d($$0, $$1, 5000, 60000);
   }

   public static eqt<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new eqt.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends eqt<eqt.a> {
   ...
   public static class b extends eqt<eqt.b> {
   ...
   public static class c extends eqt<eqt.c> {
      ...
      public eqt.c f() {
         try {
            ...
            throw new esc(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends eqt<eqt.d> {
      private final String c;
