...
public class eqt {
   ...
   static class a implements eqt.i {
      @Override
      public boolean a(eqt.v $$0) {
         return $$0.c[jn.f.d()] && !$$0.b[jn.f.d()].d;
      }

      @Override
      public eqt.r a(jn $$0, eqt.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[jn.f.d()].d = true;
         return new eqt.k($$0, $$1);
      }
   }

   static class b implements eqt.i {
      @Override
      public boolean a(eqt.v $$0) {
      ...
      public eqt.r a(jn $$0, eqt.v $$1, azh $$2) {
         ...
         return new eqt.l($$0, $$1);
      }
   }

   static class c implements eqt.i {
      @Override
      public boolean a(eqt.v $$0) {
      ...
      public eqt.r a(jn $$0, eqt.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[jn.b.d()].d = true;
         return new eqt.m($$0, $$1);
      }
   }

   static class d implements eqt.i {
      @Override
      public boolean a(eqt.v $$0) {
      ...
      public eqt.r a(jn $$0, eqt.v $$1, azh $$2) {
         ...
         return new eqt.n($$0, $$1);
      }
   }

   static class e implements eqt.i {
      @Override
      public boolean a(eqt.v $$0) {
      ...
      public eqt.r a(jn $$0, eqt.v $$1, azh $$2) {
         ...
         $$3.d = true;
         $$3.b[jn.c.d()].d = true;
         return new eqt.o($$0, $$3);
      }
   }

   static class f implements eqt.i {
      @Override
      public boolean a(eqt.v $$0) {
         return true;
      }
      ...
      public eqt.r a(jn $$0, eqt.v $$1, azh $$2) {
         $$1.d = true;
         return new eqt.s($$0, $$1, $$2);
      }
   }

   static class g implements eqt.i {
      @Override
      public boolean a(eqt.v $$0) {
      ...
      public eqt.r a(jn $$0, eqt.v $$1, azh $$2) {
         $$1.d = true;
         return new eqt.t($$0, $$1);
      }
   }

   public static class h extends eqt.r {
      ...
      private eqt.v G;
      private eqt.v H;
      private final List<eqt.r> I = Lists.newArrayList();

      public h(azh $$0, int $$1, int $$2, jn $$3) {
         super(epa.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eqt.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eqt.p($$3, this.G));
         this.I.add(new eqt.j($$3, this.H));
         List<eqt.i> $$5 = Lists.newArrayList();
         $$5.add(new eqt.b());
         $$5.add(new eqt.d());
         $$5.add(new eqt.e());
         $$5.add(new eqt.a());
         ...
         eob $$10 = eob.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eob $$11 = eob.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eob $$12 = eob.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eqt.u($$3, $$10, $$13++));
         this.I.add(new eqt.u($$3, $$11, $$13++));
         this.I.add(new eqt.q($$3, $$12));
      }
      ...
      private List<eqt.v> b(azh $$0) {
         eqt.v[] $$1 = new eqt.v[75];
         ...
         eqt.v $$23 = new eqt.v(1003);
         eqt.v $$24 = new eqt.v(1001);
         eqt.v $$25 = new eqt.v(1002);
         $$1[v].a(jn.b, $$23);
         $$1[w].a(jn.d, $$24);
         $$1[x].a(jn.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eqt.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dhy $$2, azh $$3, eob $$4) {
         int $$5 = 24;
      ...
      private void a(dhy $$0, azh $$1, eob $$2) {
      ...
      private void b(dhy $$0, azh $$1, eob $$2) {
      ...
      private void c(dhy $$0, azh $$1, eob $$2) {
      ...
      private void d(dhy $$0, azh $$1, eob $$2) {
      ...
      private void e(dhy $$0, azh $$1, eob $$2) {
      ...
      private void f(dhy $$0, azh $$1, eob $$2) {
   ...
   interface i {
      boolean a(eqt.v var1);

      eqt.r a(jn var1, eqt.v var2, azh var3);
   }

   public static class j extends eqt.r {
      public j(jn $$0, eqt.v $$1) {
         super(epa.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dhy $$0, dhv $$1, dzn $$2, azh $$3, eob $$4, dgg $$5, ji $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dkg.co.m(), dkg.co.m(), false);
   ...
   public static class k extends eqt.r {
      public k(jn $$0, eqt.v $$1) {
         super(epa.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eqt.r {
      public l(jn $$0, eqt.v $$1) {
         super(epa.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eqt.r {
      public m(jn $$0, eqt.v $$1) {
         super(epa.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eqt.r {
      public n(jn $$0, eqt.v $$1) {
         super(epa.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eqt.r {
      public o(jn $$0, eqt.v $$1) {
         super(epa.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eqt.r {
      public p(jn $$0, eqt.v $$1) {
         super(epa.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eqt.r {
      public q(jn $$0, eob $$1) {
         super(epa.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eon {
      protected static final dxq b = dkg.ix.m();
      protected static final dxq c = dkg.iy.m();
      protected static final dxq d = dkg.iz.m();
      protected static final dxq h = c;
      protected static final dxq i = dkg.iG.m();
      protected static final boolean j = true;
      protected static final dxq k = dkg.J.m();
      protected static final Set<dke> l = ImmutableSet.builder().add(dkg.eb).add(dkg.ja).add(dkg.ny).add(k.b()).build();
      ...
      public r(epa $$0, jn $$1, int $$2, eob $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(epa $$0, int $$1, jn $$2, eqt.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eob a(jn $$0, eqt.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eob $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dhy $$0, eob $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dxq $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dhy $$0, eob $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dhy $$0, eob $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dxq $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eob $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dhy $$0, eob $$1, int $$2, int $$3, int $$4) {
         ji $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cmh $$6 = bvi.M.a($$0.a(), bvh.d);
            if ($$6 != null) {
               $$6.c($$6.eS());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.du()), bvh.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eqt.r {
      private int a;

      public s(jn $$0, eqt.v $$1, azh $$2) {
         super(epa.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eqt.r {
      public t(jn $$0, eqt.v $$1) {
         super(epa.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eqt.r {
      private int a;

      public u(jn $$0, eob $$1, int $$2) {
         super(epa.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
