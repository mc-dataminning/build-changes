...
public class eqt {
   ...
   public static final Codec<eqt> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> af.a($$0, 6).map($$0x -> new eqt($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public eqt(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static eqt a() {
      return new eqt(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static eqt a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, ja $$9) {
      switch ($$9) {
         case d:
         default:
            return new eqt($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new eqt($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new eqt($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new eqt($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }
   ...
   public Stream<dih> b() {
      ...
      int $$2 = jx.a(this.k());
      int $$3 = jx.a(this.m());
      return dih.a(new dih($$0, $$1), new dih($$2, $$3));
   }
   ...
   public static Optional<eqt> a(Iterable<iu> $$0) {
      Iterator<iu> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         eqt $$2 = new eqt($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<eqt> b(Iterable<eqt> $$0) {
      Iterator<eqt> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         eqt $$2 = $$1.next();
         eqt $$3 = new eqt($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   public eqt b(int $$0, int $$1, int $$2) {
      return new eqt(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }
   ...
   public eqt c(int $$0, int $$1, int $$2) {
      return new eqt(this.h() - $$0, this.i() - $$1, this.j() - $$2, this.k() + $$0, this.l() + $$1, this.m() + $$2);
   }
