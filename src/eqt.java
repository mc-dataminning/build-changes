...
public class eqt extends anp<Map<String, List<eqt.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<eqt.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(eqt.a::a),
                     Codec.LONG.fieldOf("period").forGetter(eqt.a::b),
                     Codec.STRING.fieldOf("title").forGetter(eqt.a::c),
                     Codec.STRING.fieldOf("message").forGetter(eqt.a::d)
                  )
                  .apply($$0, eqt.a::new)
         )
         .listOf()
   ...
   public eqt(aep $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<eqt.a>> a(ank $$0, bde $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<eqt.a>> $$0, ank $$1, bde $$2) {
      List<eqt.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<eqt.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<eqt.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<eqt.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public eqt.b a(List<eqt.a> $$0, long $$1) {
         this.cancel();
         return new eqt.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (eqt.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> eui.a(eqn.N().ay(), eui.a.g, te.a($$2.c, $$3), te.a($$2.d, $$3)));
                  return;
               }
            }
         }
