...
public class eqt {
   ...
   static class a implements eqt.i {
      ...
      @Override
      public eqt.r a(jm $$0, eqt.v $$1, bam $$2) {
         $$1.d = true;
         $$1.b[jm.f.d()].d = true;
   ...
   public static class h extends eqt.r {
      ...
      private void a(boolean $$0, int $$1, dif $$2, bam $$3, eob $$4) {
         int $$5 = 24;
      ...
      private void a(dif $$0, bam $$1, eob $$2) {
      ...
      private void b(dif $$0, bam $$1, eob $$2) {
      ...
      private void c(dif $$0, bam $$1, eob $$2) {
      ...
      private void d(dif $$0, bam $$1, eob $$2) {
      ...
      private void e(dif $$0, bam $$1, eob $$2) {
      ...
      private void f(dif $$0, bam $$1, eob $$2) {
   ...
   interface i {
      ...
      eqt.r a(jm var1, eqt.v var2, bam var3);
   }

   public static class j extends eqt.r {
      public j(jm $$0, eqt.v $$1) {
      ...
      public void a(dif $$0, did $$1, dzq $$2, bam $$3, eob $$4, dgn $$5, jh $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dkn.co.m(), dkn.co.m(), false);
   ...
   protected abstract static class r extends eon {
      protected static final dxu b = dkn.iq.m();
      protected static final dxu c = dkn.ir.m();
      protected static final dxu d = dkn.is.m();
      protected static final dxu h = c;
      protected static final dxu i = dkn.iz.m();
      protected static final boolean j = true;
      protected static final dxu k = dkn.J.m();
      protected static final Set<dkl> l = ImmutableSet.builder().add(dkn.eb).add(dkn.iT).add(dkn.nr).add(k.b()).build();
      ...
      public r(epa $$0, jm $$1, int $$2, eob $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(epa $$0, int $$1, jm $$2, eqt.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eob a(jm $$0, eqt.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
      ...
      protected void b(dif $$0, eob $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dxu $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dif $$0, eob $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dif $$0, eob $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dxu $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected void a(dif $$0, eob $$1, int $$2, int $$3, int $$4) {
         jh $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
