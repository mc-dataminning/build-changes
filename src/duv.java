...
public class duv<T> implements dux<T> {
   ...
   private duv(jo<T> $$0, int $$1, duy<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private duv(jo<T> $$0, T[] $$1, duy<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dux<T> c() {
      return new duv<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
