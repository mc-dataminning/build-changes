...
public class ey implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> ti.a("slot.unknown", $$0));
   private static final Map<String, Integer> c = ac.a(Maps.newHashMap(), $$0 -> {
      ...
      $$0.put("weapon", biq.a.a(98));
      $$0.put("weapon.mainhand", biq.a.a(98));
      $$0.put("weapon.offhand", biq.b.a(98));
      $$0.put("armor.head", biq.f.a(100));
      $$0.put("armor.chest", biq.e.a(100));
      $$0.put("armor.legs", biq.d.a(100));
      $$0.put("armor.feet", biq.c.a(100));
   ...
   public static int a(CommandContext<dt> $$0, String $$1) {
