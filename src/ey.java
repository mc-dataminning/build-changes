...
public class ey implements ArgumentType<Integer> {
   ...
   private static final Map<String, Integer> c = ac.a(Maps.newHashMap(), $$0 -> {
      ...
      $$0.put("weapon", biv.a.a(98));
      $$0.put("weapon.mainhand", biv.a.a(98));
      $$0.put("weapon.offhand", biv.b.a(98));
      $$0.put("armor.head", biv.f.a(100));
      $$0.put("armor.chest", biv.e.a(100));
      $$0.put("armor.legs", biv.d.a(100));
      $$0.put("armor.feet", biv.c.a(100));
