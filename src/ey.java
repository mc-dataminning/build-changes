...
public class ey implements ArgumentType<xo> {
   ...
   public static xo a(CommandContext<ep> $$0, String $$1) {
   ...
   public xo a(StringReader $$0) throws CommandSyntaxException {
      try {
         return et.a(this.c, $$0, xq.a);
