...
public class ey implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tn.a("slot.unknown", $$0));
   private static final Map<String, Integer> c = ac.a(Maps.newHashMap(), $$0 -> {
      ...
      $$0.put("weapon", bix.a.a(98));
      $$0.put("weapon.mainhand", bix.a.a(98));
      $$0.put("weapon.offhand", bix.b.a(98));
      $$0.put("armor.head", bix.f.a(100));
      $$0.put("armor.chest", bix.e.a(100));
      $$0.put("armor.legs", bix.d.a(100));
      $$0.put("armor.feet", bix.c.a(100));
