...
public class ey implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tf.a("team.notFound", $$0));
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      return $$0.getSource() instanceof du ? du.b(((du)$$0.getSource()).r(), $$1) : Suggestions.empty();
   }
