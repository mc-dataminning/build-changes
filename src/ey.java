...
public class ey implements ArgumentType<Integer> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tl.b("slot.unknown", $$0));
   private static final Map<String, Integer> c = ac.a(Maps.newHashMap(), $$0 -> {
      ...
      $$0.put("weapon", bjb.a.a(98));
      $$0.put("weapon.mainhand", bjb.a.a(98));
      $$0.put("weapon.offhand", bjb.b.a(98));
      $$0.put("armor.head", bjb.f.a(100));
      $$0.put("armor.chest", bjb.e.a(100));
      $$0.put("armor.legs", bjb.d.a(100));
      $$0.put("armor.feet", bjb.c.a(100));
