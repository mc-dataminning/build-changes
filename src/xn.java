...
public class xn<B extends ByteBuf, V, T> implements xo<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<xn.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   xn(Function<V, ? extends T> $$0, List<xn.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         vh.a($$0, $$3);
         xn.b<B, V, T> $$4 = this.c.get($$3);

         try {
            xo<? super B, V> $$5 = (xo<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> xn.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new xn.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<xn.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public xn.a<B, V, T> a(T $$0, xo<? super B, ? extends V> $$1) {
         this.a.add(new xn.b<>($$1, $$0));
         return this;
      }
      ...
      public xn<B, V, T> a() {
         ...
         return new xn<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(xo<? super B, ? extends V> a, T b) {
   }
}
