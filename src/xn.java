...
public class xn {
   ...
   private xn(String $$0, List<xm> $$1, Int2IntFunction $$2) {
      this.a = $$0;
   ...
   public static xn a(wu $$0) {
      return a($$0, $$0x -> $$0x, $$0x -> $$0x);
   }

   public static xn a(wu $$0, Int2IntFunction $$1, UnaryOperator<String> $$2) {
      ...
      return new xn($$2.apply($$3.toString()), $$4, $$1);
   }
}
