...
public final class xn {
   ...
   public static final Codec<xn> a = Codec.STRING.comapFlatMap(xn::a, xn::b);
   private static final Map<n, xn> c = Stream.of(n.values())
      .filter(n::e)
      .collect(ImmutableMap.toImmutableMap(Function.identity(), $$0 -> new xn($$0.f(), $$0.g())));
   private static final Map<String, xn> d = c.values().stream().collect(ImmutableMap.toImmutableMap($$0 -> $$0.f, Function.identity()));
   private final int e;
   @Nullable
   private final String f;

   private xn(int $$0, String $$1) {
      this.e = $$0 & 16777215;
      this.f = $$1;
   }
   ...
   public static DataResult<xn> a(String $$0) {
      if ($$0.startsWith("#")) {
         try {
