...
public record xz(int b, UUID c, UUID d) {
   public static final Codec<xz> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(axu.i.fieldOf("index").forGetter(xz::b), ju.a.fieldOf("sender").forGetter(xz::c), ju.a.fieldOf("session_id").forGetter(xz::d))
            .apply($$0, xz::new)
   );
   ...
   public void a(ayx.a $$0) throws SignatureException {
      $$0.update(ju.b(this.c));
      $$0.update(ju.b(this.d));
