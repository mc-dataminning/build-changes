...
public final class xz {
   ...
   public static final Codec<xz> a = Codec.STRING.comapFlatMap(xz::a, xz::b);
   private static final Map<o, xz> c = Stream.of(o.values())
      .filter(o::e)
      .collect(ImmutableMap.toImmutableMap(Function.identity(), $$0 -> new xz($$0.f(), $$0.g())));
   private static final Map<String, xz> d = c.values().stream().collect(ImmutableMap.toImmutableMap($$0 -> $$0.f, Function.identity()));
   private final int e;
   @Nullable
   private final String f;

   private xz(int $$0, String $$1) {
      this.e = $$0 & 16777215;
      this.f = $$1;
   }
   ...
   public static DataResult<xz> a(String $$0) {
      if ($$0.startsWith("#")) {
         try {
