...
public record xz<S>(List<xz.a<S>> a) {
   public static <S> boolean a(ParseResults<S> $$0) {
      return !b($$0).a().isEmpty();
   }

   public static <S> xz<S> b(ParseResults<S> $$0) {
   ...
   private static <S> List<xz.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<xz.a<S>> $$2 = new ArrayList<>();
