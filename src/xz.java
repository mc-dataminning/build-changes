...
public class xz implements wp {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ayh.b.validate(xz::b);
   private static final Codec<Object> e = Codec.either(d, wq.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof wo $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<xz> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final wp.a<xz> c = new wp.a<>(b, "translatable");
   private static final wt f = wt.e("%");
   private static final wt g = wt.e("null");
   ...
   @Nullable
   private tl k;
   private List<wt> l = ImmutableList.of();
   ...
   private static xz a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new xz($$0, $$1.orElse(null), a($$2));
   }

   public xz(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<wt> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (ya var4) {
            this.l = ImmutableList.of(wt.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<wt> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new ya(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private wt a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof wo) {
            ...
            return $$1 == null ? g : wt.e($$1.toString());
         }
      } else {
         throw new ya(this, $$0);
      }
   ...
   public xc a(@Nullable ex $$0, @Nullable buj $$1, int $$2) throws CommandSyntaxException {
      ...
      return xc.a(new xz(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof xz $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
