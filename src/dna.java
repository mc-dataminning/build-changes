...
public class dna extends dgl {
   public static final MapCodec<dna> c = b(dna::new);
   public static final dur d = duq.r;
   private static final Map<dcx, List<dna.a>> h = new WeakHashMap<>();
   ...
   private static boolean a(dds $$0, je $$1, boolean $$2) {
      List<dna.a> $$3 = h.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new dna.a($$1.j(), $$0.aa()));
      }
