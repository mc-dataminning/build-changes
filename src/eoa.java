...
public class eoa extends gei {
   ...
   public eoa(exz $$0, end $$1, String $$2, BooleanConsumer $$3) {
      super(eqe.a);
      this.W = $$3;
      this.B = $$0;
      this.G = $$2;
   ...
   private void B() {
      if (!this.N) {
         if (!this.V && this.a(this.C.a) >= 5368709120L) {
            tf $$0 = tf.a("mco.download.confirmation.line1", els.b(5368709120L));
   ...
   private void a(erw $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.i, tf.a("mco.download.speed", els.b($$1)), this.g / 2 + $$2 / 2 + 15, 84, 16777215, false);
      }
   }
