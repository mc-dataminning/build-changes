...
public class gpv implements gpx.a {
   final flj a;
   ...
   public void a(ffu $$0, glx $$1, double $$2, double $$3, double $$4) {
      ...
      if (this.d != null) {
         ...
         for (Entry<dfo, String> $$9 : this.d.a.entrySet()) {
            ...
            for (String $$14 : $$12) {
               gpx.a($$0, $$1, $$14, (double)kk.a($$10.h, 8), $$8 + (double)$$13, (double)kk.a($$10.i, 8), -1, 0.15F, true, 0.0F, true);
               $$13 -= 2;
            }
         }
      }
   ...
   final class a {
      ...
      a(final hiw $$0, final double $$1, final double $$2) {
         gfy $$3 = gpv.this.a.s;
         akt<dgi> $$4 = $$3.ai();
         int $$5 = kk.a($$1);
         int $$6 = kk.a($$2);
