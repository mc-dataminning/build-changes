...
public class gpv implements ave, AutoCloseable {
   ...
   private final gsl j;
   private final gqi k;
   private final gqw l = new gqw();
   private final gpi m = new gpi();
   private final grc n = new grc();
   private final grb o = new grb();
   @Nullable
   private gjz p;
   private final gqp q = new gqp();
   private final ObjectArrayList<gtp.b> r = new ObjectArrayList(10000);
   private final ObjectArrayList<gtp.b> s = new ObjectArrayList(50);
   private final Set<dxf> t = Sets.newHashSet();
   @Nullable
   private gqz u;
   private int v;
   ...
   private gtp I;
   private int J = -1;
   private final List<bwf> K = new ArrayList<>();
   private int L;
   private gtt M;
   private boolean N;
   @Nullable
   ...
   public gpv(foz $$0, gwf $$1, gsl $$2, gqi $$3) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
      this.k = $$3;
   ...
   public void a() {
      ...
      this.y = new fhv(this.h.aO().k(), this.h.aO().l(), true);
   ...
   public void e() {
      if (this.p != null) {
         this.p.f();
         if (this.I == null) {
            this.I = new gtp(this.p, this, af.h(), this.k, this.h.ap(), this.h.ar());
         } else {
            this.I.a(this.p);
         }
         ...
         this.u = new gqz(this.I, this.p, this.h.n.aH(), this);
         this.q.a(this.u);
         this.B();
         fog $$0 = this.h.j.k();
         this.u.a(jx.a($$0.b()));
   ...
   private void a(fog $$0, gtt $$1, boolean $$2, boolean $$3) {
      feq $$4 = $$0.b();
   ...
   public static gtt a(gtt $$0) {
      return new gtt($$0).a(8);
   }

   private void b(gtt $$0) {
      if (!foz.Q().bx()) {
         throw new IllegalStateException("applyFrustum called from wrong thread: " + Thread.currentThread().getName());
      } else {
         bqn.a().a("apply_frustum");
         this.B();
   ...
   public void a(gtp.b $$0) {
      this.q.a($$0);
   }

   public void a(feq $$0, Matrix4f $$1, Matrix4f $$2) {
      this.M = new gtt($$1, $$2);
      this.M.a($$0.a(), $$0.b(), $$0.c());
   }

   public void a(fit $$0, foo $$1, boolean $$2, fog $$3, gpq $$4, Matrix4f $$5, Matrix4f $$6) {
      float $$7 = $$1.a(false);
      ...
      gtt $$14 = $$13 ? this.O : this.M;
      bqn.a().b("captureFrustum");
      if (this.N) {
         this.O = $$13 ? new gtt($$5, $$6) : $$14;
         this.O.a($$10, $$11, $$12);
         this.N = false;
      }
      ...
      Vector4f $$17 = gpp.a($$3, $$7, this.h.s, this.h.n.aH(), $$4.c($$7));
      gpo $$18 = gpp.a($$3, gpp.d.b, $$17, $$15, $$16, $$7);
      gpo $$19 = gpp.a($$3, gpp.d.a, $$17, $$15, $$16, $$7);
      $$8.b("cullEntities");
   ...
   private void a(fho $$0, gtt $$1, fog $$2, Matrix4f $$3, Matrix4f $$4, gpo $$5, boolean $$6, boolean $$7, foo $$8, bqo $$9) {
      fhp $$10 = $$0.a("main");
      ...
      $$10.a(() -> {
         ...
         double $$16 = $$13x.c();
         $$9.a("terrain");
         this.a(gqk.c(), $$14x, $$15, $$16, $$3, $$4);
         this.a(gqk.d(), $$14x, $$15, $$16, $$3, $$4);
         this.a(gqk.e(), $$14x, $$15, $$16, $$3, $$4);
         if (this.p.c().e()) {
            fig.a();
         } else {
            fig.b();
         ...
         $$9.b("translucent");
         this.a(gqk.f(), $$14x, $$15, $$16, $$3, $$4);
         $$9.b("string");
         this.a(gqk.s(), $$14x, $$15, $$16, $$3, $$4);
         if ($$6) {
            this.a($$2, $$18, $$17, true);
         }
   ...
   private void a(fho $$0, fog $$1, float $$2, gpo $$3) {
      fhp $$4 = $$0.a("particles");
      if (this.z.n != null) {
   ...
   private void a(fho $$0, Matrix4f $$1, Matrix4f $$2, fok $$3, feq $$4, float $$5, int $$6, float $$7) {
      fhp $$8 = $$0.a("clouds");
      if (this.z.p != null) {
   ...
   private void a(fho $$0, feq $$1, float $$2, gpo $$3) {
   ...
   private void a(fho $$0, feq $$1, gpo $$2) {
      fhp $$3 = $$0.a("late_debug");
   ...
   private boolean a(fog $$0, gtt $$1, List<bwf> $$2) {
      feq $$3 = $$0.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      boolean $$7 = false;
      boolean $$8 = this.d();
      bwf.b(azm.a((double)this.h.n.aH() / 8.0, 1.0, 2.5) * this.h.n.g().c());

      for (bwf $$9 : this.p.d()) {
         if (this.i.a($$9, $$1, $$4, $$5, $$6) || $$9.A(this.h.t)) {
            iu $$10 = $$9.dv();
            if ((this.p.e($$10.v()) || this.a($$10))
               && ($$9 != $$0.g() || $$0.i() || $$0.g() instanceof bxe && ((bxe)$$0.g()).fR())
               && (!($$9 instanceof gox) || $$0.g() == $$9)) {
               $$2.add($$9);
               if ($$8 && this.h.b($$9)) {
                  $$7 = true;
               }
   ...
   private void a(fjj $$0, gqa.a $$1, fog $$2, foo $$3, List<bwf> $$4) {
      feq $$5 = $$2.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
   ...
   private void a(fjj $$0, gqa.a $$1, gqa.a $$2, fog $$3, float $$4) {
      feq $$5 = $$3.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
         ...
         if (!$$10.isEmpty()) {
            for (dxf $$11 : $$10) {
               ...
               if ($$14 != null && !$$14.isEmpty()) {
                  ...
                  if ($$15 >= 0) {
                     fjj.a $$16 = $$0.c();
                     fjn $$17 = new fjk($$2.getBuffer(hlh.l.get($$15)), $$16, 1.0F);
                     $$13 = $$2x -> {
                        fjn $$3x = $$1.getBuffer($$2x);
                        return $$2x.X() ? fjq.a($$17, $$3x) : $$3x;
                     };
                  }
               }
   ...
   private void a(fjj $$0, fog $$1, gqa.a $$2) {
      feq $$3 = $$1.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      ...
      while (var11.hasNext()) {
         ...
         if (!($$8.c($$4, $$5, $$6) > 1024.0)) {
            ...
            if ($$9 != null && !$$9.isEmpty()) {
               ...
               fjj.a $$11 = $$0.c();
               fjn $$12 = new fjk($$2.getBuffer(hlh.l.get($$10)), $$11, 1.0F);
   ...
   private void a(fog $$0, gqa.a $$1, fjj $$2, boolean $$3) {
      if (this.h.w instanceof fem $$4) {
         if ($$4.d() != feo.a.a) {
            iu $$6 = $$4.b();
            eah $$7 = this.p.a_($$6);
            if (!$$7.l() && this.p.A_().a($$6)) {
               ...
               if ($$10) {
                  fjn $$11 = $$1.getBuffer(gqk.z());
                  this.a($$2, $$11, $$0.g(), $$9.d, $$9.e, $$9.f, $$6, $$7, -16777216);
               }

               fjn $$12 = $$1.getBuffer(gqk.y());
   ...
   private void a(bwf $$0, double $$1, double $$2, double $$3, float $$4, fjj $$5, gqa $$6) {
   ...
   private void a(feq $$0) {
      if (!this.r.isEmpty()) {
         ...
         bqn.a().a("translucent_sort");
         gtp.d $$3 = new gtp.d();
         ObjectListIterator $$5 = this.s.iterator();

         while ($$5.hasNext()) {
            gtp.b $$4 = (gtp.b)$$5.next();
            this.a($$4, $$3, $$0, $$2, true);
         }
         ...
         while ($$5x-- > 0) {
            ...
            this.a((gtp.b)this.r.get($$6), $$3, $$0, $$2, false);
         }
   ...
   private void a(gtp.b $$0, gtp.d $$1, feq $$2, boolean $$3, boolean $$4) {
      $$1.b($$2, $$0.g());
   ...
   private void a(gqk $$0, double $$1, double $$2, double $$3, Matrix4f $$4, Matrix4f $$5) {
      RenderSystem.assertOnRenderThread();
      bqt $$6 = bqn.a().c(() -> "render_" + $$0.b);
      $$6.a($$0::toString);
      boolean $$7 = $$0 != gqk.f();
      ObjectListIterator<gtp.b> $$8 = this.r.listIterator($$7 ? 0 : this.r.size());
      $$0.a();
      gpj $$9 = RenderSystem.getShader();
      if ($$9 == null) {
         $$0.b();
         $$6.close();
      } else {
         $$9.a(fjo.c.h, $$4, $$5, this.h.aO());
         $$9.b();
         fjb $$10 = $$9.o;

         while ($$7 ? $$8.hasNext() : $$8.hasPrevious()) {
            gtp.b $$11 = $$7 ? (gtp.b)$$8.next() : (gtp.b)$$8.previous();
            if (!$$11.d().a($$0)) {
               fjm $$12 = $$11.a($$0);
               iu $$13 = $$11.f();
               if ($$10 != null) {
   ...
   private void b(fho $$0, fog $$1, float $$2, gpo $$3) {
      ewq $$4 = $$1.k();
      if ($$4 != ewq.c && $$4 != ewq.a && !this.b($$1)) {
         gpm $$5 = this.p.c();
         gpm.d $$6 = $$5.c();
         if ($$6 != gpm.d.a) {
            fhp $$7 = $$0.a("sky");
   ...
   private boolean b(fog $$0) {
      return !($$0.g() instanceof bxe $$1) ? false : $$1.b(bvl.o) || $$1.b(bvl.G);
   }

   private void c(fog $$0) {
      bqo $$1 = bqn.a();
      $$1.a("populate_sections_to_compile");
      gtn $$2 = new gtn();
      iu $$3 = $$0.c();
      List<gtp.b> $$4 = Lists.newArrayList();
      ObjectListIterator var6 = this.r.iterator();

      while (var6.hasNext()) {
         gtp.b $$5 = (gtp.b)var6.next();
         if ($$5.i() && $$5.a()) {
            boolean $$6 = false;
            if (this.h.n.m().c() == fpf.c) {
               iu $$7 = jx.a($$5.g()).k();
               $$6 = $$7.j($$3) < 768.0 || $$5.j();
            } else if (this.h.n.m().c() == fpf.b) {
               $$6 = $$5.j();
            }
   ...
   private void a(fjj $$0, fjn $$1, bwf $$2, double $$3, double $$4, double $$5, iu $$6, eah $$7, int $$8) {
      gqu.a($$0, $$1, $$7.a(this.p, $$6, fev.a($$2)), (double)$$6.u() - $$3, (double)$$6.v() - $$4, (double)$$6.w() - $$5, $$8);
   }

   public void a(dig $$0, iu $$1, eah $$2, eah $$3, int $$4) {
      this.a($$1, ($$4 & 8) != 0);
   }
   ...
   @Nullable
   gni b(lv $$0, boolean $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      return this.b($$0, $$1, false, $$2, $$3, $$4, $$5, $$6, $$7);
   }

   @Nullable
   private gni b(lv $$0, boolean $$1, boolean $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8) {
      fog $$9 = this.h.j.k();
      ari $$10 = this.a($$2);
      if ($$1) {
   ...
   public void a(Collection<dxf> $$0, Collection<dxf> $$1) {
      synchronized (this.t) {
         this.t.removeAll($$0);
         this.t.addAll($$1);
      }
   ...
   public static int a(did $$0, eah $$1, iu $$2) {
      if ($$1.b($$0, $$2)) {
         return 15728880;
      } else {
         int $$3 = $$0.a(djj.a, $$2);
   ...
   @bav
   public ObjectArrayList<gtp.b> w() {
      return this.r;
   }
