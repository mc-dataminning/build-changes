...
public class buk implements btw, cwx {
   private final int b;
   private final jn<czd> c;
   @Nullable
   private List<bty> d;
   ...
   @Override
   public czd a(int $$0) {
      return $$0 >= 0 && $$0 < this.c.size() ? this.c.get($$0) : czd.k;
   }

   public List<czd> f() {
      List<czd> $$0 = this.c.stream().filter($$0x -> !$$0x.f()).collect(Collectors.toList());
      this.a();
      return $$0;
   }
   ...
   public void a(uf $$0, jg.a $$1) {
      ...
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         czd.a($$1, (uw)$$0.a($$2)).ifPresent(this::b);
      }
   }
