...
public class cck extends biw implements bkj {
   ...
   public cck(bja<? extends cck> $$0, cqb $$1) {
      super($$0, $$1);
   }

   public cck(cqb $$0, double $$1, double $$2, double $$3, float $$4, int $$5, bjm $$6) {
      this(bja.H, $$0);
      this.e = $$5;
      this.a($$6);
   ...
   @Nullable
   public bjm q() {
      if (this.i == null && this.j != null && this.dL() instanceof akt) {
         biw $$0 = ((akt)this.dL()).a(this.j);
         if ($$0 instanceof bjm) {
            this.i = (bjm)$$0;
         }
      }
         ...
         if (this.h) {
            ...
            if (this.g == 14) {
               for (int $$0 = 0; $$0 < 12; $$0++) {
                  ...
                  this.dL().a(iv.g, $$1, $$2 + 1.0, $$3, $$4, $$5, $$6);
               }
            }
         }
      } else if (--this.e < 0) {
         if (this.e == -8) {
            for (bjm $$8 : this.dL().a(bjm.class, this.cG().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
   ...
   public void b(byte $$0) {
      ...
      if ($$0 == 4) {
         this.h = true;
         if (!this.aS()) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apg.hu, this.da(), 1.0F, this.ag.i() * 0.2F + 0.85F, false);
         }
      }
   }
