...
public class dtx extends dtz {
   ...
   private void b() {
      ...
      if (this.n.ad() > this.l + 60L || this.m == null) {
         ...
         this.m = this.n.a(bvh.class, $$1);
      }

      if (!this.n.C) {
         for (bvh $$2 : this.m) {
            if ($$2.bL() && !$$2.dQ() && $$0.a($$2.dt(), 32.0)) {
               $$2.eb().a(cel.D, this.n.ad());
            }
         }
      }
   }

   private static boolean a(ji $$0, List<bvh> $$1) {
      for (bvh $$2 : $$1) {
   ...
   private static void a(dgi $$0, ji $$1, List<bvh> $$2) {
      $$2.stream().filter($$1x -> a($$1, $$1x)).forEach(dtx::a);
   }

   private static void b(dgi $$0, ji $$1, List<bvh> $$2) {
   ...
   private static boolean a(ji $$0, bvh $$1) {
   ...
   @FunctionalInterface
   interface a {
      void run(dgi var1, ji var2, List<bvh> var3);
   }
}
