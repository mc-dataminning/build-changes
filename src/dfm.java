         ...
         if ($$6 || $$7) {
            ...
            if ($$9 < $$8.size()) {
               ...
               if ($$6) {
                  ...
                  $$0.a(null, (double)((float)$$10.a() + 0.5F), (double)$$10.d(), (double)((float)$$10.b() + 0.5F), 5.0F, cmm.a.b);
                  dnm $$14 = new dnm(true, ImmutableList.of($$10), new gu(0, 128, 0));
   ...
   d {
      ...
      public void a(aif $$0, dfn $$1, List<bua> $$2, int $$3, gu $$4) {
         if ($$3 >= 100) {
            ...
            for (bua $$5 : $$2) {
               $$5.a(null);
               $$0.a($$5, $$5.dn(), $$5.dp(), $$5.dt(), 6.0F, cmm.a.a);
               $$5.ai();
            }
         } else if ($$3 >= 80) {
            $$0.c(3001, new gu(0, 128, 0), 0);
