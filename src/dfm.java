...
public class dfm {
   public static final Codec<dfm> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> af.a($$0, 2).map($$0x -> new dfm($$0x[0], $$0x[1])), $$0 -> IntStream.of($$0.h, $$0.i))
      .stable();
   public static final ym<ByteBuf, dfm> b = new ym<ByteBuf, dfm>() {
      public dfm a(ByteBuf $$0) {
         return vl.c($$0);
      }

      public void a(ByteBuf $$0, dfm $$1) {
         vl.a($$0, $$1);
      }
   };
   private static final int j = 1056;
   public static final long c = c(1875066, 1875066);
   private static final int k = (32 + dzq.a.a(dzr.n).c().b() + 1) * 2;
   public static final int d = kk.a(ji.f) - k;
   public static final dfm e = new dfm(0, 0);
   ...
   public static dfm a(int $$0, int $$1) {
      return new dfm($$0 << 5, $$1 << 5);
   }

   public static dfm b(int $$0, int $$1) {
      return new dfm(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dfm $$1) ? false : this.h == $$1.h && this.i == $$1.i;
      }
   }
   ...
   public static Stream<dfm> a(dfm $$0, int $$1) {
      return a(new dfm($$0.h - $$1, $$0.i - $$1), new dfm($$0.h + $$1, $$0.i + $$1));
   }

   public static Stream<dfm> a(final dfm $$0, final dfm $$1) {
      int $$2 = Math.abs($$0.h - $$1.h) + 1;
      int $$3 = Math.abs($$0.i - $$1.i) + 1;
      final int $$4 = $$0.h < $$1.h ? 1 : -1;
      final int $$5 = $$0.i < $$1.i ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<dfm>((long)($$2 * $$3), 64) {
         @Nullable
         private dfm e;

         @Override
         public boolean tryAdvance(Consumer<? super dfm> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.h;
               ...
               if ($$1 == $$1.h) {
                  ...
                  this.e = new dfm($$0.h, $$2 + $$5);
               } else {
                  this.e = new dfm($$1 + $$4, $$2);
               }
            }
