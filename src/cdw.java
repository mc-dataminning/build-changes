...
public class cdw<T extends cms & cmw> extends ccw {
   private final T a;
   ...
   public cdw(T $$0, double $$1, int $$2, float $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3 * $$3;
   ...
   public void a() {
      bvy $$0 = this.a.f();
      if ($$0 != null) {
         double $$1 = this.a.i($$0.dz(), $$0.dB(), $$0.dF());
