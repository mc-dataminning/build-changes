public abstract class cdw extends cef {
   ...
   protected boolean h() {
      if (!this.f) {
         ...
         eat $$0 = this.d.dU().a_(this.e);
         if (!($$0.b() instanceof doy)) {
            this.f = false;
            return false;
         } else {
            return $$0.c(doy.e);
   ...
   protected void a(boolean $$0) {
      if (this.f) {
         eat $$1 = this.d.dU().a_(this.e);
         if ($$1.b() instanceof doy) {
            ((doy)$$1.b()).a(this.d, this.d.dU(), $$1, this.e, $$0);
         }
      }
   }
