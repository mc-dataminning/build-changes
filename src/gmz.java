...
public class gmz {
   ...
   public gms a(Vector3f $$0, Vector3f $$1, gmu $$2, hbl $$3, jm $$4, hec $$5, @Nullable gmv $$6, boolean $$7, int $$8) {
      gmw $$9 = $$2.d();
      if ($$5.c()) {
         $$9 = a($$2.d(), $$4, $$5.b());
      }
      ...
      return new gms($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static gmw a(gmw $$0, jm $$1, j $$2) {
      ...
      return new gmw(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private int[] a(gmw $$0, hbl $$1, jm $$2, float[] $$3, j $$4, @Nullable gmv $$5) {
      int[] $$6 = new int[32];
   ...
   private void a(int[] $$0, int $$1, jm $$2, gmw $$3, float[] $$4, hbl $$5, j $$6, @Nullable gmv $$7) {
      gky.b $$8 = gky.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, hbl $$3, gmw $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gmv $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
