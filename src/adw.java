...
public class adw implements ze<abq> {
   ...
   public adw(EnumSet<adw.a> $$0, Collection<aqn> $$1) {
      this.b = $$0;
      this.c = $$1.stream().map(adw.b::new).toList();
   }

   public adw(adw.a $$0, aqn $$1) {
      this.b = EnumSet.of($$0);
      this.c = List.of(new adw.b($$1));
   }

   public static adw a(Collection<aqn> $$0) {
   ...
   public static enum a {
      ...
      c(($$0, $$1) -> $$0.e = dau.a($$1.l()), ($$0, $$1) -> $$0.c($$1.e().a())),
   ...
   public static record b(UUID a, @Nullable GameProfile b, boolean c, int d, dau e, @Nullable wx f, @Nullable xo.a g) {

      b(aqn $$0) {
         this($$0.cz(), $$0.gb(), true, $$0.d.l(), $$0.f.b(), $$0.N(), x.a($$0.ab(), xo::a));
      }
   }
