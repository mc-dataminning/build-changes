...
public class bav extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgq.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bgq.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bgq.s);
