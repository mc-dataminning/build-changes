...
public final class fgo implements AutoCloseable {
   ...
   public fgo(int $$0, int $$1, boolean $$2) {
      this(fgo.a.a, $$0, $$1, $$2);
   }

   public fgo(fgo.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   private fgo(fgo.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   public static fgo a(InputStream $$0) throws IOException {
      return a(fgo.a.a, $$0);
   }

   public static fgo a(@Nullable fgo.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static fgo a(ByteBuffer $$0) throws IOException {
      return a(fgo.a.a, $$0);
   }

   public static fgo a(byte[] $$0) throws IOException {
   ...
   private static fgo a(ByteBuffer $$0, byte[] $$1) throws IOException {
      $$0.put($$1);
      $$0.rewind();
      return a($$0);
   }

   public static fgo a(@Nullable fgo.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            b.malloc($$7, $$6.limit());
            var9 = new fgo($$0 == null ? fgo.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, $$7);
         } catch (Throwable var11) {
            if ($$2 != null) {
               try {
                  $$2.close();
   ...
   public fgo a(IntUnaryOperator $$0) {
      if (this.d != fgo.a.a) {
         ...
         this.j();
         fgo $$1 = new fgo(this.e, this.f, false);
         int $$2 = this.e * this.f;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (ftp.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(fgo $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, fgo $$4) {
      this.j();
      if ($$4.c() != this.d) {
