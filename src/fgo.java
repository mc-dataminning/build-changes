...
public class fgo extends hdk {
   ...
   public fgo(@Nullable fhl $$0, long $$1, int $$2, fgh $$3, esw $$4) {
      super(fic.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aR_() {
      this.U = this.aa.b(fkk.a(xc.k, $$0x -> this.D()).a());
      this.U.k = false;
      this.V = this.aa.b(fkk.a(xc.e, $$0x -> this.E()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.G();
         } else {
            List<fhj> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new fhr(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new ffz(this.G, $$0.toArray(new fhj[0])));
         }
      }
   ...
   private void D() {
      this.m.a(new fft(new fdp(new fqf()), this.J));
   }
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.Q) {
                              ...
                              fds $$10 = new fds($$0, this.J, this.K, $$2, this.m.X(), ab.b().c(), this.H.l().c(), this.L);
                              $$10.a($$0x -> {
                              ...
                              long $$6 = $$0.length();
                              fdq $$7 = fdq.a($$6);
                              fdq $$8 = fdq.a(5368709120L);
                              if (fdq.b($$6, $$7).equals(fdq.b(5368709120L, $$8)) && $$7 != fdq.a) {
                                 fdq $$9 = fdq.values()[$$7.ordinal() - 1];
                                 this.a(
                                    xd.a("mco.upload.size.failure.line1", this.H.b()),
                                    xd.a("mco.upload.size.failure.line2", fdq.b($$6, $$9), fdq.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    xd.a("mco.upload.size.failure.line1", this.H.b()),
                                    xd.a("mco.upload.size.failure.line2", fdq.b($$6, $$7), fdq.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
