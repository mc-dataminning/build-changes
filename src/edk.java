...
public class edk implements doc.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<edk> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final auc<edk> a = auc.a(f);
   private final edo g;
   private final edo h;
   private final edo i;
   ...
   public static edk a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new edk(new dpk(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private edk(edo $$0, edo $$1, edo $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public edk(aup $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         edo.a($$0, IntStream.rangeClosed(-15, 0)),
         edo.a($$0, IntStream.rangeClosed(-15, 0)),
         edo.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public edk a(aup $$0) {
      return new edk($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(doc.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         edl $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(edo.b($$4 * $$13), edo.b($$5 * $$13), edo.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = edo.b($$1 * $$13);
         double $$21 = edo.b($$2 * $$13);
         double $$22 = edo.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            edl $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return aui.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
