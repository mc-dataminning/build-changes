...
public class edk extends edp {
   public static final MapCodec<edk> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, edk::new));
   protected final int b;

   protected static <P extends edk> P3<Mu<P>, bpb, bpb, Integer> a(Instance<P> $$0) {
      return b($$0).and(Codec.intRange(0, 16).fieldOf("height").forGetter($$0x -> $$0x.b));
   }

   public edk(bpb $$0, bpb $$1, int $$2) {
      super($$0, $$1);
      this.b = $$2;
   }
