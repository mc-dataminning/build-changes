...
public class blv {
   ...
   private blv(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static blv a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new blv($$0, $$1);
   }

   public blv.d a() throws IOException {
      blv.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new blv.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private blv.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         blv.c $$3 = blv.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new blv.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new blv.a($$0, $$3);
            }
         }
   ...
   public blv.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<blv.c> $$2 = this.a().c();
      ...
      blv.e $$4 = new blv.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, blv.c b) implements blv.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static blv.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new blv.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<blv.b> {
      private final List<blv.b> a;

      d(List<blv.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public blv.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            blv.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  blv.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public blv.d a() {
         ListIterator<blv.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               blv.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<blv.b> iterator() {
         return this.a.iterator();
      }

      public Stream<blv.b> b() {
         return this.a.stream();
      }

      public Set<blv.c> c() {
         return this.a.stream().map(blv.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, blv.c b) implements blv.b {
