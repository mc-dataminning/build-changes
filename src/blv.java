...
public class blv extends blp {
   ...
   public blv(cti $$0, double $$1, double $$2, double $$3, int $$4) {
      this(blt.K, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public blv(blt<? extends blv> $$0, cti $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         elm $$0 = new elm(this.k.dr() - this.dr(), this.k.dt() + (double)this.k.cI() / 2.0 - this.dt(), this.k.dx() - this.dx());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void u() {
      ...
      if (this.dM() instanceof amz) {
         for (blv $$1 : this.dM().a(dmy.a(blv.class), this.cH().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(amz $$0, elm $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new blv($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(amz $$0, elm $$1, int $$2) {
      elh $$3 = elh.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.F_().a(40);
      List<blv> $$5 = $$0.a(dmy.a(blv.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         blv $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private static boolean a(blv $$0, int $$1, int $$2) {
   ...
   private int a(cfb $$0, int $$1) {
      Entry<blu, cmr> $$2 = cre.a(crg.L, $$0, cmr::j);
      if ($$2 != null) {
         cmr $$3 = $$2.getValue();
