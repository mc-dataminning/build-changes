...
public class gib implements gig.a {
   ...
   private final fgi J;
   private final Map<jd, gib.a> K = Maps.newHashMap();
   private final Map<UUID, aaf.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bsq $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dL();
      });
   }

   private void b(fbc $$0, get $$1, double $$2, double $$3, double $$4) {
      jd $$5 = jd.a($$2, $$3, $$4);
   ...
   private void a(fbc $$0, get $$1, gib.a $$2) {
      int $$3 = 0;
   ...
   private void a(fbc $$0, get $$1, aaf.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gio.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fbc $$0, get $$1, aaf.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fbc $$0, get $$1, String $$2, gib.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(gib.a $$0) {
      return this.b($$0.a).stream().map(agd::a).collect(Collectors.toSet());
   }

   private Set<String> c(gib.a $$0) {
      return this.c($$0.a).stream().map(agd::a).collect(Collectors.toSet());
   }
   ...
   private boolean c(aaf.a $$0) {
      cmv $$1 = this.J.s;
      jd $$2 = jd.a($$1.dv(), $$0.h().b(), $$1.dB());
      jd $$3 = jd.a((jw)$$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(jd $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(aaf.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(jd $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(aaf.a::a).collect(Collectors.toSet());
   }

   private Map<jd, List<String>> c() {
      Map<jd, List<String>> $$0 = Maps.newHashMap();

      for (aaf.a $$1 : this.L.values()) {
   ...
   private void d() {
      gig.a(this.J.an(), 8).ifPresent($$0 -> this.M = $$0.cA());
   }
