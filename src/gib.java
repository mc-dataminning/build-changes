...
public class gib extends gjs {
   private final float a;
   private final gjn b;

   gib(gfk $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gjn $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements giv<lk> {
      ...
      public gis a(lk $$0, gfk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.l() && $$8.o() == dqv.a) {
            ...
            jh $$9 = jh.a($$2, $$3, $$4);
            int $$10 = fmg.Q().aw().a($$8, $$1, $$9);
            if ($$8.b() instanceof dnj) {
               $$10 = ((dnj)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new gib($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
