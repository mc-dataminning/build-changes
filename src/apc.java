...
class apc implements Path {
   private static final BasicFileAttributes a = new apa() {
      @Override
   ...
   private static final BasicFileAttributes b = new apa() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<apc> c = Comparator.comparing(apc::n);
   ...
   public apc(ape $$0, String $$1, @Nullable apc $$2, apf $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private apc a(@Nullable apc $$0, String $$1) {
      return new apc(this.e, $$1, $$0, apf.b);
   }
   ...
   apc a(String $$0) {
      if (a(this.i)) {
         return new apc(this.e, $$0, this, this.i);
      } else if (this.i instanceof apf.a $$1) {
         apc $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new apc(this.e, $$0, this, apf.a);
      } else if (this.i instanceof apf.b) {
         return new apc(this.e, $$0, this, apf.a);
      } else {
   ...
   private apc c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof apc $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof apf.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public apf.a i() {
      return this.i instanceof apf.a $$0 ? $$0 : null;
   }
