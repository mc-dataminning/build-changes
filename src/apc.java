...
public class apc extends aph {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<apd<?>> e = Sets.newHashSet();

   public apc(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cbm $$0, apd<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<apd<?>> d() {
      Set<apd<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  qr $$4 = a($$3.getAsJsonObject());
                  $$4 = ass.g.a($$0, $$4, rd.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<apd<T>> a(apf<T> $$0, String $$1) {
      return Optional.ofNullable(aer.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }
   ...
   protected String b() {
      Map<apf<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apd<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apd<?>>)$$3.next();
         apd<?> $$2 = (apd<?>)$$1.getKey();
      ...
      for (Entry<apf<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(jb.y.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> aer b(apd<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(akl $$0) {
      Object2IntMap<apd<?>> $$1 = new Object2IntOpenHashMap();
