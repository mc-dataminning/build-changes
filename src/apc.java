...
public class apc implements aoz {
   ...
   public static final Function<String, apa.c> a = $$0 -> new apa.c() {
         @Override
         public aoz a(CommandContext<eq> $$0x) {
            return new apc(apc.a($$0), fr.c($$0, $$0));
         }

         @Override
         public ArgumentBuilder<eq, ?> a(ArgumentBuilder<eq, ?> $$0x, Function<ArgumentBuilder<eq, ?>, ArgumentBuilder<eq, ?>> $$1) {
            return $$0.then(er.a("storage").then($$1.apply(er.a($$0, fr.a()).suggests(apc.b))));
         }
      };
   private final ept c;
   private final akk d;

   static ept a(CommandContext<eq> $$0) {
      return ((eq)$$0.getSource()).l().aL();
   }
