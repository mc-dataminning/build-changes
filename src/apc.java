                     ...
                     ((LiteralArgumentBuilder)el.a("facing")
                              ...
                              el.a("entity")
                                 .then(
                                    ((RequiredArgumentBuilder)el.a("facingEntity", ex.a())
                                          .executes($$0x -> a((ek)$$0x.getSource(), ex.a($$0x, "target"), new aol.a(ex.a($$0x, "facingEntity"), ew.a.a))))
                                       .then(
                        ...
                        .then(
                           el.a("facingLocation", go.a())
                              .executes($$0x -> a((ek)$$0x.getSource(), ex.a($$0x, "target"), new aol.b(go.a($$0x, "facingLocation"))))
                        )
                  )
            )
      );
