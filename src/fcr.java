...
public abstract class fcr {
   ...
   public fbs a() {
      if (this.c()) {
         ...
         return new fbs(this.b(jn.a.a), this.b(jn.a.b), this.b(jn.a.c), this.c(jn.a.a), this.c(jn.a.b), this.c(jn.a.c));
      }
   }

   public fcr b() {
      return this.c() ? fco.a() : fco.a(this.b(jn.a.a), this.b(jn.a.b), this.b(jn.a.c), this.c(jn.a.a), this.c(jn.a.b), this.c(jn.a.c));
   }
   ...
   public fcr a(double $$0, double $$1, double $$2) {
      return (fcr)(this.c() ? fco.a() : new fbz(this.a, new fcn(this.a(jn.a.a), $$0), new fcn(this.a(jn.a.b), $$1), new fcn(this.a(jn.a.c), $$2)));
   }
      ...
      if (this.c()) {
         ...
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(jn.a.a, $$4.d - (double)$$2.u()), this.a(jn.a.b, $$4.e - (double)$$2.v()), this.a(jn.a.c, $$4.f - (double)$$2.w()))
               ? new fbt($$4, jn.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : fbs.a(this.e(), $$0, $$1, $$2);
         }
      }
   }
   ...
   public double a(jn.a $$0, fbs $$1, double $$2) {
      return this.a(jf.a($$0, jn.a.a), $$1, $$2);
   }

   protected double a(jf $$0, fbs $$1, double $$2) {
      if (this.c()) {
         return $$2;
