...
public class cii {
   ...
   private static void b(bwj<cih> $$0) {
      $$0.a(cqo.a, 0, ImmutableList.of(new bzu(0.8F), new cii.b(2.0F), new byg(45, 90), new byk() {
         @Override
         protected boolean a(ard $$0, bvj $$1) {
            if ($$1 instanceof cih $$2 && $$2.t()) {
               return false;
            }
   ...
   private static void d(bwj<cih> $$0) {
      $$0.a(cqo.g, ImmutableList.of(Pair.of(0, new cii.a())), Set.of(Pair.of(cel.G, cem.a), Pair.of(cel.Z, cem.b)));
   }

   public static void a(cih $$0) {
      $$0.eb().a(ImmutableList.of(cqo.g, cqo.b));
   }
   ...
   public static class a extends bxa<cih> {
      ...
      protected void a(ard $$0, cih $$1, long $$2) {
         super.c($$0, $$1, $$2);
         if (this.f > 0) {
            this.f--;
         }
      ...
      protected boolean a(ard $$0, cih $$1) {
         return $$1.aJ();
      }

      protected boolean b(ard $$0, cih $$1, long $$2) {
         return $$1.gt().a();
      }

      protected void c(ard $$0, cih $$1, long $$2) {
         $$1.gu();
      }

      protected void d(ard $$0, cih $$1, long $$2) {
         if (!$$1.gE()) {
            $$1.gv();
         }
      }
