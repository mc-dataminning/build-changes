...
public class cii extends brw implements btp {
   private static final ajs<ctq> d = ajw.a(cii.class, aju.h);
   ...
   public cii(bsc<? extends cii> $$0, daz $$1) {
      super($$0, $$1);
      this.c = this.ah.i() * (float) Math.PI * 2.0F;
      this.r(this.ah.i() * 360.0F);
   }

   public cii(daz $$0, double $$1, double $$2, double $$3, ctq $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$0.z.j() * 0.2 - 0.1, 0.2, $$0.z.j() * 0.2 - 0.1);
   }

   public cii(daz $$0, double $$1, double $$2, double $$3, ctq $$4, double $$5, double $$6, double $$7) {
      this(bsc.ag, $$0);
      this.a_($$1, $$2, $$3);
      this.o($$5, $$6, $$7);
      this.a($$4);
   ...
   public brw s() {
      if (this.m != null && !this.m.dK()) {
         return this.m;
      } else if (this.l != null && this.dP() instanceof aqn $$0) {
         this.m = $$0.a(this.l);
         return this.m;
      } else {
         return null;
   ...
   public void l() {
      if (this.p().e()) {
         ...
         this.N = this.dA();
         eum $$0 = this.ds();
         if (this.be() && this.b(awc.a) > 0.1F) {
            this.D();
         } else if (this.bs() && this.b(awc.b) > 0.1F) {
            this.E();
         } else {
            this.ba();
         }
         ...
         if (!this.aE() || this.ds().i() > 1.0E-5F || (this.ai + this.al()) % 4 == 0) {
            ...
            this.g(this.ds().d((double)$$1, 0.98, (double)$$1));
            if (this.aE()) {
               eum $$2 = this.ds();
               if ($$2.d < 0.0) {
         ...
         boolean $$3 = ayf.a(this.L) != ayf.a(this.du()) || ayf.a(this.M) != ayf.a(this.dw()) || ayf.a(this.N) != ayf.a(this.dA());
         int $$4 = $$3 ? 2 : 40;
   ...
   private void G() {
      if (this.H()) {
         for (cii $$1 : this.dP().a(cii.class, this.cK().c(0.5, 0.0, 0.5), $$0 -> $$0 != this && $$0.H())) {
            if ($$1.H()) {
               this.a($$1);
               if (this.dK()) {
                  break;
   ...
   public static boolean a(ctq $$0, ctq $$1) {
      return $$1.I() + $$0.I() > $$1.j() ? false : ctq.c($$0, $$1);
   }

   public static ctq a(ctq $$0, ctq $$1, int $$2) {
   ...
   private static void a(cii $$0, ctq $$1, ctq $$2) {
      ctq $$3 = a($$1, $$2, 64);
      $$0.a($$3);
   }

   private static void a(cii $$0, ctq $$1, cii $$2, ctq $$3) {
      a($$0, $$1, $$3);
   ...
   public boolean a(bqp $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if (!this.p().e() && this.p().a(ctt.us) && $$0.a(avz.m)) {
         return false;
      } else if (!this.p().a($$0)) {
         return false;
      } else if (this.dP().B) {
   ...
   public void a(ud $$0) {
      ...
      if ($$0.b("Item", 10)) {
         ud $$1 = $$0.p("Item");
         this.a(ctq.a(this.dR(), (va)$$1).orElse(ctq.i));
      } else {
         this.a(ctq.i);
      }
   ...
   public wx af() {
      wx $$0 = this.ah();
      return (wx)($$0 != null ? $$0 : wx.c(this.p().t()));
   }
