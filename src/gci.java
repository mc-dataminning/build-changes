...
public class gci {
   ...
   public gcb a(Vector3f $$0, Vector3f $$1, gcd $$2, gmo $$3, ir $$4, gow $$5, @Nullable gce $$6, boolean $$7, akf $$8) {
      gcf $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = axw.i($$11, $$9.a[0], $$12);
      $$9.a[2] = axw.i($$11, $$9.a[2], $$12);
      $$9.a[1] = axw.i($$11, $$9.a[1], $$13);
      $$9.a[3] = axw.i($$11, $$9.a[3], $$13);
      ...
      return new gcb($$14, $$2.c, $$15, $$3, $$7);
   }

   public static gcf a(gcf $$0, ir $$1, j $$2, akf $$3) {
      Matrix4f $$4 = il.a($$2, $$1, () -> "Unable to resolve UVLock for model: " + $$3).c();
      float $$5 = $$0.a($$0.c(0));
      float $$6 = $$0.b($$0.c(0));
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(axw.b($$23), axw.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new gcf(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(gcf $$0, gmo $$1, ir $$2, float[] $$3, j $$4, @Nullable gce $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[ir.values().length];
      $$2[gav.a.f] = $$0.x() / 16.0F;
      $$2[gav.a.e] = $$0.y() / 16.0F;
      $$2[gav.a.d] = $$0.z() / 16.0F;
      $$2[gav.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, ir $$2, gcf $$3, float[] $$4, gmo $$5, j $$6, @Nullable gce $$7, boolean $$8) {
      gav.b $$9 = gav.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gmo $$3, gcf $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gce $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static ir a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? ir.b : $$7;
      }
   }

   private void a(int[] $$0, ir $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[ir.values().length];
      $$3[gav.a.f] = 999.0F;
      $$3[gav.a.e] = 999.0F;
      $$3[gav.a.d] = 999.0F;
      $$3[gav.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (axw.a($$13, $$18) && axw.a($$14, $$19) && axw.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
