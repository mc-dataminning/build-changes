public class gci extends gca<gyw> {
   public static final gfl a = gfl.scaling(2.35F);
   ...
   private final gfc m;
   private final gfc n;
   private final gfc[] o = new gfc[12];
   private final gfc[] p;
   ...
   public static gfi a() {
      ...
      gfh $$3 = gfh.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, gfe.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", gfh.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), gfe.a(0.0F, 0.0F, -8.25F));
      gfm $$11 = $$2.a("tail0", gfh.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), gfe.a);
      gfm $$12 = $$11.a("tail1", gfh.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), gfe.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", gfh.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), gfe.a(0.5F, 0.5F, 6.0F));
   ...
   public void a(gyw $$0) {
      ...
      if ($$0.e != null && $$0.d != null) {
         ...
         faz $$3 = $$0.d;
         $$3 = new faz($$3.d, 0.0, $$3.f);
         faz $$4 = new faz($$0.c.d - $$0.e.d, 0.0, $$0.c.f - $$0.e.f).d().b((float) (Math.PI / 2));
         double $$5 = $$3.b($$4);
