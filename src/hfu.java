...
public class hfu extends MinecraftServer {
   ...
   public hfu(Thread $$0, fme $$1, ewc.c $$2, avg $$3, amy $$4, amu $$5, ass $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hft(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   @Override
   public dhe bd() {
      return this.r() && !this.w_() ? (dhe)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
