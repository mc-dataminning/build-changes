...
public class fkk {
   public static class a implements fkz<iz> {
      ...
      public fkw a(iz $$0, fie $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fkk.b $$8 = new fkk.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends flw {
      b(fie $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * aro.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends fli {
      private boolean b;
      private boolean F;
      private final fky G;
      private float H;
      ...
      c(fie $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fky $$7, flr $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fkk.c $$0 = new fkk.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fkz<iz> {
      ...
      public fkw a(iz $$0, fie $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fkk.c $$8 = new fkk.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, eqn.N().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fku {
      private int a;
      private final fky b;
      private qy D;
      private boolean E;

      public e(fie $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fky $$7, @Nullable qs $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, aov.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }

         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            int $$6 = this.a / 2;
            qs $$7 = this.D.a($$6);
            cia.a $$8 = cia.a.a($$7.f("Type"));
            boolean $$9 = $$7.q("Trail");
            ...
            fkw $$17 = this.b.a(iw.J, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
         ...
         if (this.a > this.t) {
            if (this.E) {
               boolean $$18 = this.c();
               aot $$19 = $$18 ? aou.hL : aou.hK;
               this.c.a(this.g, this.h, this.i, $$19, aov.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fkk.c $$10 = (fkk.c)this.b.a(iw.A, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = aro.d($$18, $$13, $$16) * $$0;
                  double $$20 = aro.d($$18, $$14, $$17) * $$0;
