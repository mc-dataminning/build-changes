...
public class fkk extends hhw {
   ...
   public void aT_() {
      this.a(this.J.a);
      this.c(fof.a(xv.c("mco.configure.world.subscription.extend"), $$0 -> fsv.a(this, aza.a(this.J.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.J.j) {
         this.c(
            fof.a(xv.c("mco.configure.world.delete.button"), $$0 -> this.m.a(fke.b(this, xv.c("mco.configure.world.delete.question.line1"), $$0x -> this.E())))
               .a(this.n / 2 - 100, g(10), 200, 20)
               .a()
         );
      } else if (fhd.b() && this.J.u != null) {
         this.c(new fop(this.n / 2 - 100, g(8), 200, 46, xv.a("mco.snapshot.subscription.info", this.J.u), this.p));
      } else {
         this.c(new fop(this.n / 2 - 100, g(8), 200, 46, H, this.p));
      }

      this.c(fof.a(xu.k, $$0 -> this.aP_()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
      ...
      (new Thread("Realms-delete-realm") {
         ...
         public void run() {
            try {
               ...
               fkk.a.error("Couldn't delete world", var2);
            }

            fkk.this.m.execute(() -> fkk.this.m.a(fkk.this.K));
         }
      }).start();
      this.m.a(this);
   }
