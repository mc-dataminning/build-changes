...
public class fkk {
   private static final ajv a = new ajv("advancements/title_box");
   ...
   public fkk(fki $$0, fby $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = tj.a().a($$1.h.a($$3.a(), 163));
      this.y = axm.d($$3.f() * 28.0F);
      this.z = axm.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = tj.a().a(this.a(wl.a($$3.b().f(), xf.a.a($$3.e().a())), $$7));
   ...
   private static float a(fck $$0, List<wn> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<wn> a(wi $$0, int $$1) {
      fck $$2 = this.u.h.b();
      List<wn> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<wn> $$6 = $$2.b($$0, $$1 - $$5, xf.a);
