...
public final class fkk {
   ...
   private static final fkk c = new fkk(HostAndPort.fromParts("server.invalid", 25565));

   public fkk(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fkk(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fkk a(String $$0) {
      if ($$0 == null) {
         ...
         try {
            ...
            return $$1.getHost().isEmpty() ? c : new fkk($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fkk ? this.b.equals(((fkk)$$0).b) : false;
      }
   }
