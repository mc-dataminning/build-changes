...
public class fav {
   public static List<fbx> a(fav.a... $$0) {
      for (fav.a $$1 : $$0) {
         a($$1.j);
      }

      List<fbx> $$2 = Lists.newArrayList();

      for (fav.a $$3 : $$0) {
         $$2.add(new fbx($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fbx::a));
      return $$2;
   }
   ...
   public static List<fbx> a() {
      return a(fav.a.values());
   }
