...
public class fav {
   ...
   public fav(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public fav(fba $$0, fba $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static fav a(ene $$0) {
      return new fav((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static fav a(fba $$0) {
      return new fav($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static fav a(ji $$0, ji $$1) {
      return new fav(
   ...
   public fav a(double $$0) {
      return new fav($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public fav b(double $$0) {
      return new fav(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public fav c(double $$0) {
      return new fav(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public fav d(double $$0) {
      return new fav(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public fav e(double $$0) {
      return new fav(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public fav f(double $$0) {
      return new fav(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public fav b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public fav c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public fav d(double $$0, double $$1, double $$2) {
      return new fav(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public fav f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public fav h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<fba> b(fba $$0, fba $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<fba> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fba $$6, fba $$7) {
   ...
   @Nullable
   public static faw a(Iterable<fav> $$0, fba $$1, fba $$2, ji $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new faw($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jn a(fav $$0, fba $$1, double[] $$2, @Nullable jn $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jn a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fba $$6, double[] $$7, @Nullable jn $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(fba $$0, List<fav> $$1) {
      fba $$2 = this.f();
      fba $$3 = $$2.e($$0);

      for (fav $$4 : $$1) {
         fav $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public fba f() {
      return new fba(ayz.d(0.5, this.a, this.d), ayz.d(0.5, this.b, this.e), ayz.d(0.5, this.c, this.f));
   }

   public fba g() {
      return new fba(ayz.d(0.5, this.a, this.d), this.b, ayz.d(0.5, this.c, this.f));
   }
   ...
   public fba i() {
      return new fba(this.d, this.e, this.f);
   }

   public static fav a(fba $$0, double $$1, double $$2, double $$3) {
      return new fav($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
}
