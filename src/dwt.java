...
public class dwt {
   ...
   private static final int j = jg.a(16);
   ...
   private final czw p;
   private static final List<dcv> q = List.of(dcx.l, dcx.L, dcx.i, dcx.b, dcx.k, dcx.I, dcx.K, dcx.fl, dcx.dP, dcx.iA, dcx.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<iv<dat>>> t;
   ...
   public static final Codec<dwt> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dwt::a, Function.identity());

   private static DataResult<dwt> a(dwt $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dwt(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<iv<dat>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = jo.c($$0);
      int $$5 = jo.c($$1) - $$4;
   ...
   @Nullable
   public static dwt a(aql $$0, int $$1, int $$2) {
      dru $$3 = $$0.a($$1, $$2);
      dwt $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dst.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<is> a(dap $$0, int $$1, int $$2, boolean $$3) {
      Set<is> $$4 = EnumSet.noneOf(is.class);
   ...
   private void a(dru $$0, Set<is> $$1) {
      if (!this.r) {
         if ($$1.contains(is.a) || $$1.contains(is.g) || $$1.contains(is.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(is.c) && $$1.contains(is.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(is.c) && $$1.contains(is.e) && $$1.contains(is.d)) {
   ...
   private void a(int $$0, dru $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, axw.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dru $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dvq.a.a)) {
         $$3 = Math.min($$0.a(dvq.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }

      int $$5 = this.p.I_();
      im.a $$6 = new im.a($$1, $$3, $$2);
   ...
   private static double a(dru $$0, im.a $$1) {
      return a($$0, (im)$$1.c(ir.a)) ? 1.0 : -1.0;
   }

   private static double b(dru $$0, im.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dru $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      im.a $$5 = new im.a($$1, this.p.al(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<iv<dat>> b(dru $$0, int $$1, int $$2) {
      ObjectArrayList<iv<dat>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + jg.a(this.p.I_());
         $$3.set($$4, $$0.getNoiseBiome(jg.a($$1), $$5, jg.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dru $$0, im $$1) {
      dpy $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(avo.O)) {
         ...
         return $$2.a(dcx.eT) || $$2.a(dcx.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dwt.a $$3) {
      if ($$1 >= jg.a(this.p.I_()) && $$1 < jg.a(this.p.al())) {
         int $$4 = $$1 - jg.a(this.p.I_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               iv<dat> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dwt.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dwt.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, iv<dat> var3);
   }
