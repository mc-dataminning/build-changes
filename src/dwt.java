...
public class dwt extends dtz {
   ...
   private static void a(dgi $$0, ji $$1, float $$2, dwt $$3) {
      ...
      if (!$$6.c()) {
         fav $$7 = a($$1, $$6.a(), $$3);
         List<bul> $$8 = $$0.a_(null, dws.a($$7, $$4, $$5).b($$7));
         if (!$$8.isEmpty()) {
            List<fav> $$9 = $$6.e();
   ...
   private static void a(jn $$0, bul $$1, double $$2, jn $$3) {
      h.set($$0);
      $$1.a(bvl.c, new fba($$2 * (double)$$3.j(), $$2 * (double)$$3.k(), $$2 * (double)$$3.l()));
      $$1.aK();
      h.set(null);
   }
   ...
   private static boolean a(fav $$0, bul $$1, ji $$2) {
      return $$1.n_() == ete.a && $$1.aJ() && ($$1.d($$2) || $$1.dA() >= $$0.a && $$1.dA() <= $$0.d && $$1.dG() >= $$0.c && $$1.dG() <= $$0.f);
   }
   ...
   private static void a(ji $$0, bul $$1, jn $$2, double $$3) {
      fav $$4 = $$1.cR();
      fav $$5 = fbr.b().a().a($$0);
      if ($$4.c($$5)) {
         jn $$6 = $$2.g();
   ...
   public void k() {
      if (this.n != null && (this.j < 1.0F || this.n.C)) {
         ...
         this.n.o(this.o);
         this.av_();
         if (this.n.a_(this.o).a(djo.bX)) {
            dwx $$0;
            if (this.g) {
               $$0 = djo.a.m();
            } else {
               $$0 = djm.b(this.d, this.n, this.o);
            }

            this.n.a(this.o, $$0, 3);
            this.n.b(this.o, $$0.b(), eud.a(this.n, this.s(), null));
         }
      }
   }
   ...
   protected void a(tq $$0, jt.a $$1) {
      super.a($$0, $$1);
      js<djm> $$2 = (js<djm>)(this.n != null ? this.n.a(mc.f) : mb.e);
