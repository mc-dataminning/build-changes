...
public class arj {
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (arj.this.e.an()) {
                  $$1.addLast("legacy_query", new are(arj.this.d()));
               }

               vp.a($$1, zc.a, false, null);
               int $$2 = arj.this.e.o();
               vp $$3 = (vp)($$2 > 0 ? new we($$2) : new vp(zc.a));
               arj.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new arl(arj.this.e, $$3));
            }
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<arj.a.a> d = Lists.newArrayList();
