...
public class arj {
   ...
   private static void a(arn $$0, aqn $$1, dtj $$2) {
      $$0.b(new adc($$2, $$1.y_(), null, null));
      dag $$3 = $$2.f();
      agb.a($$1, $$3);
   }

   private List<dtj> a(apw $$0, dag $$1) {
      int $$2 = ayf.d(this.i);
      List<dtj> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : ayf.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
