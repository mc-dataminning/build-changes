...
public class arj {
   ...
   public static final Codec<Object> b = a(aru.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(arr.e($$0));
   ...
   public static final Codec<arj.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? aez.b($$0.substring(1)).map($$0x -> new arj.f($$0x, true)) : aez.b($$0).map($$0x -> new arj.f($$0x, false)), arj.f::c
      );
   ...
   private static final MapCodec<GameProfile> z = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(hx.c.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !aez.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> arj.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new arj.b<>($$0, $$1);
   }

   public static <K, V> arj.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new arj.e<>($$0, $$1);
   }
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof arj.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(aez a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
