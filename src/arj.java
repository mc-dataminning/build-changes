...
public class arj {
   ...
   public static hg<civ> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return jd.i
            .b(aet.a(je.D, new aeu($$2)))
   ...
   public static hg<civ> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static hg<civ> a(JsonObject $$0, String $$1, @Nullable hg<civ> $$2) {
