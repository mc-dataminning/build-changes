...
public final class arj<T> implements Comparable<arj<?>> {
   private final ark<T> a;
   private final int b;
   private final T c;
   private long d;

   protected arj(ark<T> $$0, int $$1, T $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof arj<?> $$1) ? false : this.b == $$1.b && Objects.equals(this.a, $$1.a) && Objects.equals(this.c, $$1.c);
      }
   }
