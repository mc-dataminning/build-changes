...
public class bmj implements bmc {
   ...
   public static Set<bma> a() {
      Builder<bma> $$0 = ImmutableSet.builder();

      try {
         bmj.a $$1 = new bmj.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bma.a("cpu#" + $$1x, blz.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bma.a("heap MiB", blz.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bmb.a.a());
      return $$0.build();
   }
   ...
   public static bma a(final LongSupplier $$0) {
      ...
      bma.d $$3 = new bma.d(2.0F);
      return bma.a("ticktime", blz.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
