...
public class ftl extends fuk {
   ...
   public ftl(fzj $$0, Consumer<elp> $$1, elp $$2) {
      super(b);
      this.a = $$0;
      this.z = $$1;
      this.A = $$2;
   ...
   protected void aR_() {
      ...
      fsk $$1 = $$0.a(fsk.e().a(8));
      fsk $$2 = $$0.a(fsk.e().a(8));
      this.C = $$1.a(fos.a(wo.c("createWorld.customize.flat.removeLayer"), $$0x -> {
         if (this.E()) {
      ...
      $$1.a(fos.a(wo.c("createWorld.customize.presets"), $$0x -> {
   ...
   class a extends fpo<ftl.a.a> {
      ...
      class a extends fpo.a<ftl.a.a> {
         ...
         public void a(fod $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            elm $$10 = ftl.this.A.e().get(ftl.this.A.e().size() - $$1 - 1);
            dwx $$11 = $$10.b();
            cwp $$12 = this.a($$11);
            this.a($$0, $$3, $$2, $$12);
            int $$13 = $$2 + $$5 / 2 - 9 / 2;
         ...
         @Override
         public wo a() {
            elm $$0 = ftl.this.A.e().get(ftl.this.A.e().size() - a.this.aH_().indexOf(this) - 1);
            cwp $$1 = this.a($$0.b());
         ...
         private void a(fod $$0, int $$1, int $$2, cwp $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            if (!$$3.f()) {
               $$0.b($$3, $$1 + 2, $$2 + 2);
            }
