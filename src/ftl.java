...
public class ftl extends ftg<biw> {
   private static final aex a = new aex("textures/entity/experience_orb.png");
   ...
   protected int a(biw $$0, gw $$1) {
      return arx.a(super.a($$0, $$1) + 7, 0, 15);
   }
   ...
   public void a(biw $$0, float $$1, float $$2, elp $$3, foe $$4, int $$5) {
      ...
      int $$16 = (int)((arx.a($$15 + 0.0F) + 1.0F) * 0.5F * 255.0F);
      int $$17 = 255;
      int $$18 = (int)((arx.a($$15 + (float) (Math.PI * 4.0 / 3.0)) + 1.0F) * 0.1F * 255.0F);
      $$3.a(0.0F, 0.1F, 0.0F);
      $$3.a(this.c.b());
