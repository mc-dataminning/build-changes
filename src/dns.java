...
public class dns extends dnm<dpr> {
   private static final ha[] a = ha.values();

   public dns(Codec<dpr> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dno<dpr> $$0) {
      dpr $$1 = $$0.f();
      aru $$2 = $$0.d();
      gu $$3 = $$0.e();
      cqf $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dlh $$9 = new dlh(new dkj($$4.A()));
      dzf $$10 = dzf.a($$9, -4, 1.0);
      ...
      for (gu $$44 : $$31) {
         ...
         for (ha $$46 : a) {
            ...
            dez $$48 = $$4.a_($$47);
            if ($$45.b(dfp.C)) {
               $$45 = $$45.a(dfp.C, Boolean.valueOf($$48.u().b()));
            }
