...
public class cnv extends bxy<cns> {
   ...
   public static boolean a(ash $$0, cns $$1) {
      if (!$$1.aJ() && !$$1.bj()) {
         ...
         return false;
      } else if ($$1.ec().a(cfj.ba, cfk.a)) {
         return true;
      } else {
         bwf $$2 = $$1.ec().c(cfj.o).orElse(null);
         if ($$2 == null) {
            return false;
         } else if (a($$1, $$2)) {
            $$1.ec().b(cfj.o);
   ...
   protected boolean a(ash $$0, cns $$1, long $$2) {
      return $$1.aw() != bwr.a && !$$1.ec().a(cfj.aU);
   }

   protected void b(ash $$0, cns $$1, long $$2) {
      if ($$1.ec().a(cfj.aZ, cfk.b)) {
         $$1.ec().a(cfj.aZ, bbk.a, (long)f);
      }

      $$1.b(bwr.r);
      $$0.a(null, $$1, axf.cE, axg.f, 1.0F, 1.0F);
      $$1.ec().c(cfj.ba).ifPresent($$1x -> $$1.a(fi.a.b, $$1x.b()));
   }

   protected void c(ash $$0, cns $$1, long $$2) {
      boolean $$3 = $$1.bj();
      if (!$$3 && $$1.ec().a(cfj.bb, cfk.a)) {
         $$1.ec().b(cfj.bb);
      }

      if (a($$1)) {
         fbx $$4 = $$1.ec().c(cfj.ba).flatMap($$1x -> a($$1, $$1.dZ(), fbx.c($$1x))).orElse(null);
         if ($$4 == null) {
            $$1.b(bwr.a);
            return;
         }
         ...
         $$1.b(bwr.a);
         $$1.r(false);
         boolean $$5 = $$1.ec().a(cfj.x);
         $$1.ec().a(cfj.aU, bbk.a, $$5 ? 2L : 10L);
         $$1.ec().a(cfj.aV, bbk.a, 100L);
      }
   }
   ...
   private static boolean a(cns $$0) {
      return $$0.ec().c(cfj.aZ).isEmpty() && $$0.aw() == bwr.r;
   }

   private static boolean b(cns $$0) {
      boolean $$1 = $$0.aw() == bwr.g;
      boolean $$2 = $$0.aJ();
      boolean $$3 = $$0.bj() && $$0.ec().a(cfj.bb, cfk.b);
      return $$1 && ($$2 || $$3);
   }
