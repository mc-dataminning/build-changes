...
public class bxn extends bxm {
   ...
   private static final agj<Byte> bS = agm.a(bxn.class, agl.a);
   private static final int bT = 1;
   private static final bwt bU = bwt.b().a(4.0);
   public final bll d = new bll();
   public final bll e = new bll();
   @Nullable
   private hx bV;

   public bxn(blt<? extends bxn> $$0, cti $$1) {
      super($$0, $$1);
      if (!$$1.B) {
         this.w(true);
      }
   ...
   @Override
   public arl y() {
      return this.w() && this.ag.a(4) != 0 ? null : arm.bq;
   }
   ...
   public void l() {
      ...
      if (this.w()) {
         this.g(elm.b);
         this.p(this.dr(), (double)aui.a(this.dt()) + 1.0 - (double)this.dh(), this.dx());
      } else {
   ...
   protected void Z() {
      ...
      if (this.w()) {
         ...
         elm $$6 = this.dp();
         elm $$7 = $$6.b((Math.signum($$3) * 0.5 - $$6.c) * 0.1F, (Math.signum($$4) * 0.7F - $$6.d) * 0.1F, (Math.signum($$5) * 0.5 - $$6.e) * 0.1F);
         this.g($$7);
         float $$8 = (float)(aui.d($$7.e, $$7.c) * 180.0F / (float)Math.PI) - 90.0F;
         float $$9 = aui.g($$8 - this.dC());
         this.bm = 0.5F;
         this.r(this.dC() + $$9);
   ...
   public static boolean b(blt<bxn> $$0, ctj $$1, bmj $$2, hx $$3, aup $$4) {
      if ($$3.v() >= $$1.A_()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
