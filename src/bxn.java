...
public class bxn extends byi {
   ...
   @Nullable
   private esa k() {
      return cbl.a(this.b, 10, 7);
   }

   @Nullable
   private esa l() {
      aps $$0 = (aps)this.b.dM();
      List<cjg> $$1 = $$0.a(bqb.bi, this.b.cH().g(32.0), this::a);
      if ($$1.isEmpty()) {
         return null;
      } else {
         cjg $$2 = $$1.get(this.b.dM().z.a($$1.size()));
         esa $$3 = $$2.dk();
         return cbl.a(this.b, 10, 7, $$3);
      }
   }
   ...
   private esa m() {
      ...
      if ($$0 == null) {
         ...
         ib $$1 = this.a($$0);
         return $$1 == null ? null : cbl.a(this.b, 10, 7, esa.c($$1));
      }
   }
   ...
   private ib a(je $$0) {
      aps $$1 = (aps)this.b.dM();
      cbr $$2 = $$1.y();
      List<ib> $$3 = $$2.c($$0x -> true, $$0.q(), 8, cbr.b.b).map(cbs::f).collect(Collectors.toList());
