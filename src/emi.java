...
public abstract class emi<T extends emi<T>> {
   ...
   public emi(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = emg.a();
         if ($$3 != null) {
         ...
         throw new enr(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new enr(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new enr(var2.getMessage(), var2);
      }
   }
   ...
   public static emi<?> a(String $$0) {
      return new emi.b($$0, 5000, 60000);
   }

   public static emi<?> a(String $$0, int $$1, int $$2) {
      return new emi.b($$0, $$1, $$2);
   }

   public static emi<?> c(String $$0, String $$1) {
      return new emi.c($$0, $$1, 5000, 60000);
   }

   public static emi<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new emi.c($$0, $$1, $$2, $$3);
   }

   public static emi<?> b(String $$0) {
      return new emi.a($$0, 5000, 60000);
   }

   public static emi<?> d(String $$0, String $$1) {
      return new emi.d($$0, $$1, 5000, 60000);
   }

   public static emi<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new emi.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends emi<emi.a> {
   ...
   public static class b extends emi<emi.b> {
   ...
   public static class c extends emi<emi.c> {
      ...
      public emi.c f() {
         try {
            ...
            throw new enr(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends emi<emi.d> {
      private final String c;
