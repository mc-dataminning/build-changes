...
public abstract class emi<M extends emf<M>> {
   private final dbg i;
   ...
   protected final Long2ObjectMap<dtc> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected emi(dbg $$0, dtk $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dtc a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dtc a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dtc c(long $$0) {
      dtc $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected void a(eml<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dtc>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dtc> $$6 = (Entry<dtc>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dtc $$8 = (dtc)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dtc $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = jq.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, emi.a.a($$9, emi.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public emi.b k(long $$0) {
      return emi.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static emi.b c(byte $$0) {
         if ($$0 == 0) {
            return emi.b.a;
         } else {
            return a($$0) ? emi.b.c : emi.b.b;
         }
      }
   }
