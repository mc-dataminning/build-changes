...
public class gtp extends gqx<chm, gzq, gcx> {
   private static final Map<chm.a, akv> a = af.a(Maps.newEnumMap(chm.a.class), $$0 -> {
      $$0.put(chm.a.a, akv.b("textures/entity/panda/panda.png"));
      $$0.put(chm.a.b, akv.b("textures/entity/panda/lazy_panda.png"));
      $$0.put(chm.a.c, akv.b("textures/entity/panda/worried_panda.png"));
      $$0.put(chm.a.d, akv.b("textures/entity/panda/playful_panda.png"));
      $$0.put(chm.a.e, akv.b("textures/entity/panda/brown_panda.png"));
      $$0.put(chm.a.f, akv.b("textures/entity/panda/weak_panda.png"));
      $$0.put(chm.a.g, akv.b("textures/entity/panda/aggressive_panda.png"));
   });
   ...
   protected void a(gzq $$0, fft $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.l > 0.0F) {
         float $$4 = ayz.i($$0.l);
         int $$5 = ayz.d($$0.l);
