...
public class cgo extends cho {
   ...
   public cgo(int $$0, cdt $$1) {
      this($$0, $$1, cgx.a);
   }

   public cgo(int $$0, cdt $$1, cgx $$2) {
      super(cht.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected chp l() {
      return chp.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   protected void a(cdu $$0, clj $$1) {
      ...
      this.o.a(($$1x, $$2x) -> {
         dhi $$3 = $$1x.a_($$2x);
         if (!$$0.fU().d && $$3.a(arg.M) && $$0.eh().i() < 0.12F) {
            dhi $$4 = cua.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         clj $$4 = $$0.p();
         clj $$5 = this.q.a(1);
         Map<cpu, Integer> $$6 = cpw.a($$4);
         $$2 += $$0.I() + ($$5.b() ? 0 : $$5.I());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(clm.uo) && !ckf.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<cpu, Integer> $$16 = cpw.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (cpu $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fU().d || $$0.a(clm.uo)) {
                        $$22 = true;
                     }
