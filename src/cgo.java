...
public class cgo {
   ...
   private int g = awi.b(awp.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jc.a.fieldOf("uuid").forGetter(Pair::getFirst), avq.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bnq> j;
   @VisibleForTesting
   protected final ArrayList<bnq> c;
   private final cgo.a k;
   @VisibleForTesting
   protected final Object2IntMap<bnq> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cgo> a(Predicate<bnq> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cgo::b)).apply($$1, $$1x -> new cgo($$0, $$1x))
      );
   }

   public cgo(Predicate<bnq> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cgo.a(this);
   ...
   public void a(aow $$0, Predicate<bnq> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bnq>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bnq> $$6 = (Entry<bnq>)$$5.next();
         int $$7 = $$6.getIntValue();
         bnq $$8 = (bnq)$$6.getKey();
         bnq.c $$9 = $$8.dI();
   ...
   public int b(@Nullable bnq $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<boi> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof boi).map($$0 -> (boi)$$0);
   }

   @VisibleForTesting
   protected static record a(cgo a) implements Comparator<bnq> {
      public int a(bnq $$0, bnq $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof chl;
               boolean $$7 = $$1 instanceof chl;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
