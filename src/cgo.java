...
public abstract class cgo {
   ...
   public cgo(bxg $$0, dja $$1) {
      this.a = $$0;
      this.b = $$1;
      this.v = this.a(azm.a($$0.i(byk.m) * 16.0));
   }
   ...
   private float r() {
      return Math.max((float)this.a.h(byk.m), this.x);
   }
   ...
   protected abstract exe a(int var1);
   ...
   @Nullable
   public final exc a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(iu.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public exc a(Stream<iu> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public exc a(Set<iu> $$0, int $$1) {
   ...
   @Nullable
   protected exc a(Set<iu> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, this.r());
   }

   @Nullable
   protected exc a(Set<iu> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$7 = (int)($$4 + (float)$$1);
         djn $$8 = new djn(this.b, $$6.b(-$$7, -$$7, -$$7), $$6.b($$7, $$7, $$7));
         exc $$9 = this.v.a($$8, this.a, $$0, $$4, $$3, this.u);
         $$5.c();
         if ($$9 != null && $$9.l() != null) {
            this.s = $$9.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable exc $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   protected double a(feq $$0) {
      iu $$1 = iu.a((jo)$$0);
      return this.b.a_($$1.e()).l() ? $$0.e : exk.a(this.b, $$1);
   }
   ...
   private boolean c(feq $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         feq $$1 = feq.c(this.c.g());
         if (!$$0.a((jo)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            feq $$2 = feq.c(this.c.d(this.c.f() + 1));
            feq $$3 = $$1.d($$0);
            feq $$4 = $$2.d($$0);
            double $$5 = $$3.h();
            double $$6 = $$4.h();
   ...
   protected void d() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            exa $$1 = this.c.a($$0);
            exa $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            eah $$3 = this.b.a_(new iu($$1.a, $$1.b, $$1.c));
            if ($$3.a(axc.bo)) {
   ...
   public boolean b(exf $$0) {
      return $$0 != exf.n && $$0 != exf.p && $$0 != exf.d;
   }

   protected static boolean a(bxg $$0, feq $$1, feq $$2, boolean $$3) {
      feq $$4 = new feq($$2.d, $$2.e + (double)$$0.dr() * 0.5, $$2.f);
      return $$0.dV().a(new dij($$1, $$4, dij.a.a, $$3 ? dij.b.c : dij.b.a, $$0)).d() == feo.a.a;
   }
   ...
   public boolean b(iu $$0) {
      if (this.m) {
         ...
         exa $$1 = this.c.d();
         feq $$2 = new feq(((double)$$1.a + this.a.dA()) / 2.0, ((double)$$1.b + this.a.dC()) / 2.0, ((double)$$1.c + this.a.dG()) / 2.0);
