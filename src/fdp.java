...
public class fdp {
   ...
   private final aua r;
   private final int s;
   private final List<aua> t;
   private final evi u;
   @Nullable
   private fdp v;
   private final List<fdp> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fdp(fdn $$0, evi $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = si.a().a($$1.h.a($$3.a(), 163));
      this.y = auo.d($$3.f() * 28.0F);
      this.z = auo.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
   ...
   private static float a(evu $$0, List<vk> $$1) {
   ...
   public void a(ewu $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
