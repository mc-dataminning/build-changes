...
public class div {
   ...
   public div(akr $$0, long $$1, div.a $$2) {
      this($$0, $$1, $$2, gw.b);
   }

   public div(akr $$0, long $$1, div.a $$2, gw $$3) {
      this.l = $$0;
      this.m = $$3;
   ...
   public void c() {
      ...
      if (!this.k.h().isEmpty()) {
         this.l.k().a(akw.b, new cpc(0, 0), 9, asx.a);
         boolean $$0 = this.n();
         if (this.x && $$0) {
            this.j();
            this.x = false;
         ...
         this.l.k().b(akw.b, new cpc(0, 0), 9, asx.a);
      }
   }
   ...
   private void o() {
      Set<aks> $$0 = Sets.newHashSet();

      for (aks $$1 : this.l.a(this.j)) {
         this.k.a($$1);
         $$0.add($$1);
      }

      Set<aks> $$2 = Sets.newHashSet(this.k.h());
      $$2.removeAll($$0);
   ...
   private void q() {
      if (!this.n.isEmpty()) {
         ...
         int $$1 = arx.a(96.0 * Math.cos(2.0 * (-Math.PI + (Math.PI / 20) * (double)$$0)));
         int $$2 = arx.a(96.0 * Math.sin(2.0 * (-Math.PI + (Math.PI / 20) * (double)$$0)));
   ...
   public static record a(boolean c, boolean d, boolean e, boolean f, Optional<UUID> g, Optional<gw> h, Optional<List<Integer>> i) {
      public static final Codec<div.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ...
                  ia.a.optionalFieldOf("Dragon").forGetter(div.a::e),
