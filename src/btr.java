...
public abstract class btr extends btp implements bte, bun {
   private static final akk<Byte> b = ako.a(btr.class, akm.a);
   ...
   protected bzq bP;
   protected bzo bQ;
   private final bzl bZ;
   protected cdb bR;
   protected final cao bS;
   protected final cao bT;
   @Nullable
   private btp ca;
   private final cdy cb;
   ...
   private boolean cf;
   private boolean cg;
   private final Map<eom, Float> ch = Maps.newEnumMap(eom.class);
   @Nullable
   private ale<eqn> ci;
   private long cj;
   @Nullable
   ...
   protected btr(bta<? extends btr> $$0, dby $$1) {
      super($$0, $$1);
      this.bS = new cao($$1.ah());
      this.bT = new cao($$1.ah());
      this.bO = new bzp(this);
      this.bP = new bzq(this);
   ...
   public static buw.a A() {
      return btp.dU().a(bux.k, 16.0).a(bux.d);
   }
   ...
   public float a(eom $$0) {
      btr $$2;
      label17: {
         if (this.dd() instanceof btr $$1 && $$1.B()) {
            $$2 = $$1;
            break label17;
         }
   ...
   public bzq H() {
      return this.dd() instanceof btr $$0 ? $$0.H() : this.bP;
   }
   ...
   public cdb K() {
      return this.dd() instanceof btr $$0 ? $$0.K() : this.bR;
   }
   ...
   public btp cQ() {
      bsu $$0 = this.cT();
      if (!this.gg() && $$0 instanceof btr $$1 && $$0.bU()) {
         return $$1;
      }
   ...
   @Nullable
   protected final btp N() {
      return this.dS().c(cct.o).orElse(null);
   }
   ...
   protected void S() {
      boolean $$0 = !(this.cQ() instanceof btr);
      boolean $$1 = !(this.dc() instanceof cov);
      this.bS.a(can.a.a, $$0);
      this.bS.a(can.a.c, $$0 && $$1);
      this.bS.a(can.a.b, $$0);
   }
   ...
   public void b(us $$0) {
      ...
      if (this.ck instanceof btp) {
         $$9 = Either.left(this.ck.cz());
      } else if (this.ck instanceof ciz $$10) {
         $$9 = Either.right($$10.D());
      }
   ...
   public void a(us $$0) {
      ...
      if ($$0.b("body_armor_item", 10)) {
         this.ce = cup.a(this.dR(), (vp)$$0.p("body_armor_item")).orElse(cup.l);
   ...
   public void n_() {
      ...
      if (!this.dP().B && this.fV() && this.bD() && !this.be && this.dP().ab().b(dbu.c)) {
         kd $$0 = this.V();

         for (cjh $$2 : this.dP().a(cjh.class, this.cK().c((double)$$0.u(), (double)$$0.v(), (double)$$0.w()))) {
   ...
   protected boolean b(cup $$0, cup $$1) {
      if ($$1.e()) {
         return true;
      } else if ($$0.g() instanceof cwc) {
         if (!($$1.g() instanceof cwc)) {
            return true;
         } else {
            double $$2 = this.o($$0);
            double $$3 = this.o($$1);
      ...
      } else if ($$0.g() instanceof css && $$1.g() instanceof css) {
         return this.c($$0, $$1);
      } else if ($$0.g() instanceof ctc && $$1.g() instanceof ctc) {
         return this.c($$0, $$1);
      } else if ($$0.g() instanceof cse $$4) {
         if (dab.f($$1)) {
            return false;
         } else if (!($$1.g() instanceof cse)) {
            return true;
         } else {
            cse $$5 = (cse)$$1.g();
            if ($$4.k() != $$5.k()) {
   ...
   private double o(cup $$0) {
      cxk $$1 = $$0.a(km.n, cxk.a);
      return $$1.a(this.h(bux.c), btb.a);
   }
   ...
   private static boolean p(cup $$0) {
      ki $$1 = $$0.a();
      int $$2 = $$1.d();
   ...
   @Override
   public void dB() {
      if (this.dP().al() == bqr.a && this.X()) {
         this.ao();
      } else if (!this.fW() && !this.W()) {
         bsu $$0 = this.dP().a(this, -1.0);
         if ($$0 != null) {
            double $$1 = $$0.g(this);
            int $$2 = this.ak().f().f();
            int $$3 = $$2 * $$2;
   ...
   public void a(bsu $$0, float $$1, float $$2) {
   ...
   public static boolean a(bta<? extends btr> $$0, dbz $$1, btt $$2, iz $$3, azh $$4) {
      iz $$5 = $$3.d();
      return $$2 == btt.c || $$1.a_($$5).a($$1, $$5, $$0);
   }

   public boolean a(dbz $$0, btt $$1) {
      return true;
   }
   ...
   public Iterable<cup> fb() {
      return (Iterable<cup>)(this.ce.e() ? this.cd : Iterables.concat(this.cd, List.of(this.ce)));
   }

   @Override
   public cup a(btb $$0) {
      return switch ($$0.a()) {
         case a -> (cup)this.cc.get($$0.b());
         case b -> (cup)this.cd.get($$0.b());
         case c -> this.ce;
      };
   }
   ...
   protected void a(brn $$0, int $$1, boolean $$2) {
      ...
      for (btb $$3 : btb.values()) {
         ...
         float $$5 = this.g($$3);
         boolean $$6 = $$5 > 1.0F;
         if (!$$4.e() && !dab.g($$4) && ($$2 || $$6) && Math.max(this.ah.i() - (float)$$1 * 0.01F, 0.0F) < $$5) {
            if (!$$6 && $$4.l()) {
   ...
   private eql c(arf $$0) {
      return new eql.a($$0).a(ete.f, this.dn()).a(ete.a, this).a(etd.h);
   }
   ...
   public void a(ale<eqn> $$0, Map<btb, Float> $$1) {
   ...
   protected void a(azh $$0, bqs $$1) {
      if ($$0.i() < 0.15F * $$1.d()) {
         int $$2 = $$0.a(2);
         float $$3 = this.dP().al() == bqr.d ? 0.1F : 0.25F;
         if ($$0.i() < 0.095F) {
            $$2++;
         }
   ...
   @Nullable
   public static cuk a(btb $$0, int $$1) {
      switch ($$0) {
         case f:
            if ($$1 == 0) {
               return cus.py;
   ...
   protected void a(azh $$0, float $$1) {
      if (!this.eX().e() && $$0.i() < 0.25F * $$1) {
         this.a(btb.a, dab.a(this.dP().J(), $$0, this.eX(), (int)(5.0F + $$1 * (float)$$0.a(18)), false));
      }
   }

   protected void a(azh $$0, float $$1, btb $$2) {
      cup $$3 = this.a($$2);
      if (!$$3.e() && $$0.i() < 0.5F * $$1) {
         this.a($$2, dab.a(this.dP().J(), $$0, $$3, (int)(5.0F + $$1 * (float)$$0.a(18)), false));
      }
   }
   ...
   public bui a(dcn $$0, bqs $$1, btt $$2, @Nullable bui $$3) {
      azh $$4 = $$0.E_();
      this.f(bux.k).d(new buv("Random spawn bonus", $$4.a(0.0, 0.11485000000000001), buv.a.b));
      this.u($$4.i() < 0.05F);
      return $$3;
   }
   ...
   @Override
   public final bqu a(cmx $$0, bqt $$1) {
      if (!this.bD()) {
         return bqu.e;
      } else if (this.gf() == $$0) {
         this.a(true, !$$0.fP());
   ...
   private bqu c(cmx $$0, bqt $$1) {
      cup $$2 = $$0.b($$1);
      if ($$2.a(cus.uK) && this.a($$0)) {
         this.b($$0, true);
         $$2.h(1);
         return bqu.a(this.dP().B);
      } else {
         ...
         if ($$2.g() instanceof cvw) {
            if (this.dP() instanceof arf) {
               cvw $$4 = (cvw)$$2.g();
               Optional<btr> $$5 = $$4.a($$0, this, (bta<? extends btr>)this.ak(), (arf)this.dP(), this.dn(), $$2);
               $$5.ifPresent($$1x -> this.a($$0, $$1x));
               return $$5.isPresent() ? bqu.a : bqu.e;
            } else {
               return bqu.c;
            }
         } else {
   ...
   @Nullable
   public <T extends btr> T a(bta<T> $$0, boolean $$1) {
      if (this.dK()) {
         return null;
      } else {
         T $$2 = (T)$$0.a(this.dP());
   ...
   public boolean a(cmx $$0) {
      return !this.gd() && !(this instanceof cjv);
   }
   ...
   private void gm() {
      if (this.cm != null && this.dP() instanceof arf $$0) {
         ...
         if ($$1.isPresent()) {
            ...
            this.b(cjb.b(this.dP(), $$2.get()), true);
            return;
         }
   ...
   protected evm gj() {
      ...
      if ($$0 != null) {
         evm $$1 = $$0.cK();
         evm $$2 = this.cK();
         $$3 = new evm(Math.min($$2.a, $$1.a), $$2.b, Math.min($$2.c, $$1.c), Math.max($$2.d, $$1.d), $$2.e, Math.max($$2.f, $$1.f));
      } else {
         $$3 = this.cK();
      }
   ...
   public boolean C(bsu $$0) {
      ...
      float $$2 = (float)this.g(bux.d);
      if ($$0 instanceof btp) {
         $$1 += dab.a(this.eX(), $$0.ak());
         $$2 += (float)dab.c(this);
      }
      ...
      boolean $$4 = $$0.a(this.dQ().b((btp)this), $$1);
      if ($$4) {
         if ($$2 > 0.0F && $$0 instanceof btp) {
            ((btp)$$0).q((double)($$2 * 0.5F), (double)ayz.a(this.dF() * (float) (Math.PI / 180.0)), (double)(-ayz.b(this.dF() * (float) (Math.PI / 180.0))));
