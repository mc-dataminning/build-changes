...
public abstract class btr extends bsw implements bst {
   ...
   private static final bux bF = new bux(UUID.fromString("662A6B8D-DA3E-4C1C-8813-96EA6097278D"), "Sprinting speed boost", 0.3F, bux.a.c);
   ...
   protected static final akk<Byte> aF = ako.a(btr.class, akm.a);
   private static final akk<Float> bK = ako.a(btr.class, akm.d);
   private static final akk<List<lg>> bL = ako.a(btr.class, akm.m);
   private static final akk<Boolean> bM = ako.a(btr.class, akm.k);
   private static final akk<Integer> bN = ako.a(btr.class, akm.b);
   private static final akk<Integer> bO = ako.a(btr.class, akm.b);
   private static final akk<Optional<iz>> bP = ako.a(btr.class, akm.p);
   private static final int bQ = 15;
   protected static final bsz aG = bsz.c(0.2F, 0.2F).b(0.2F);
   public static final float aH = 0.5F;
   public static final float aI = 0.5F;
   private static final float bR = 0.21875F;
   private final buw bS;
   private final brm bT = new brm(this);
   private final Map<ji<bsc>, bse> bU = Maps.newHashMap();
   private final jr<cur> bV = jr.a(2, cur.l);
   private final jr<cur> bW = jr.a(4, cur.l);
   private cur bX = cur.l;
   public boolean aJ;
   ...
   protected btr(btc<? extends btr> $$0, dca $$1) {
      super($$0, $$1);
      this.bS = new buw(bva.a($$0));
      this.t(this.eR());
      this.J = true;
   ...
   protected but.b<?> dT() {
      return but.a(ImmutableList.of(), ImmutableList.of());
   }
   ...
   public static buy.a dU() {
      return buy.a().a(buz.q).a(buz.n).a(buz.r).a(buz.a).a(buz.b).a(buz.p).a(buz.v).a(buz.t).a(buz.l).a(buz.s).a(buz.i).a(buz.m);
   }
   ...
   public void au() {
      ...
      if (this.bD()) {
         ...
         if (this.a(awv.a) && !this.dP().a_(iz.a(this.du(), this.dy(), this.dA())).a(dfd.nd)) {
            boolean $$3 = !this.dV() && !bsf.c(this) && (!$$0 || !((cmz)this).gd().a);
            if ($$3) {
   ...
   public boolean dW() {
      return this.ai % 5 == 0 && this.ds().c != 0.0 && this.ds().e != 0.0 && !this.N_() && dad.k(this) && this.dY();
   }
   ...
   @Override
   protected float aN() {
      return this.dY() && dad.a(daf.l, this) > 0 ? 1.0F : super.aN();
   }

   @Override
   protected boolean c(dse $$0) {
      return !$$0.i() || this.fE();
   }
   ...
   protected void ea() {
      if (!this.bo().i()) {
         ...
         if ($$0 > 0 && this.dY()) {
            ...
            $$1.c(new bux(d, "Soul speed boost", (double)(0.03F * (1.0F + (float)$$0 * 0.35F)), bux.a.a));
            if (this.el().i() < 0.04F) {
               cur $$2 = this.a(btd.c);
               $$2.a(1, this, btd.c);
            }
   ...
   protected void ec() {
      if (!this.bo().i()) {
         ...
         if ($$0 > 0) {
            ...
            $$1.c(new bux(e, "Powder snow slow", (double)$$2, bux.a.a));
         }
      }
   }

   protected void c(iz $$0) {
      int $$1 = dad.a(daf.j, this);
      if ($$1 > 0) {
         dag.a(this, this.dP(), $$0, $$1);
      }
   ...
   public float ee() {
      buw $$0 = this.eW();
      return $$0 == null ? 1.0F : this.b((float)$$0.c(buz.t));
   }
   ...
   protected boolean b(btd $$0) {
      return true;
   }

   public void a(btd $$0, cur $$1, cur $$2) {
      boolean $$3 = $$2.e() && $$1.e();
      if (!$$3 && !cur.c($$1, $$2) && !this.an) {
         ctt $$4 = ctt.c_($$2);
   ...
   protected void es() {
      Iterator<ji<bsc>> $$0 = this.bU.keySet().iterator();
   ...
   private void s() {
      List<lg> $$0 = this.bU.values().stream().filter(bse::g).map(bse::a).toList();
      this.ao.a(bL, $$0);
   ...
   public double B(@Nullable bsw $$0) {
      double $$1 = 1.0;
      if (this.bY()) {
         $$1 *= 0.8;
      }
   ...
   public boolean c(btr $$0) {
      return $$0 instanceof cmz && this.dP().al() == bqt.a ? false : $$0.et();
   }

   public boolean a(btr $$0, cei $$1) {
      return $$1.a(this, $$0);
   }
   ...
   public static boolean c(Collection<bse> $$0) {
      for (bse $$1 : $$0) {
         if ($$1.g() && !$$1.f()) {
            return false;
         }
   ...
   public boolean ew() {
      if (this.dP().B) {
         ...
         Iterator<bse> $$0 = this.bU.values().iterator();
   ...
   public Collection<bse> ex() {
      return this.bU.values();
   }

   public Map<ji<bsc>, bse> ey() {
      return this.bU;
   }

   public boolean b(ji<bsc> $$0) {
      return this.bU.containsKey($$0);
   }

   @Nullable
   public bse c(ji<bsc> $$0) {
      return this.bU.get($$0);
   }

   public final boolean b(bse $$0) {
   ...
   public boolean c(bse $$0) {
      if (this.ak().a(awt.G)) {
         ...
         return !this.ak().a(awt.w) ? true : !$$0.a(bsg.j) && !$$0.a(bsg.s);
      }
   }

   public void c(bse $$0, @Nullable bsw $$1) {
      if (this.c($$0)) {
         bse $$2 = this.bU.put($$0.c(), $$0);
         if ($$2 == null) {
            this.a($$0, $$1);
         } else {
            $$0.d($$2);
   ...
   protected void a(bse $$0, @Nullable bsw $$1) {
      this.bZ = true;
      if (!this.dP().B) {
         $$0.c().a().a(this.eW(), $$0.e());
         this.d($$0);
   ...
   protected void a(bse $$0, boolean $$1, @Nullable bsw $$2) {
      this.bZ = true;
      if ($$1 && !this.dP().B) {
         bsc $$3 = $$0.c().a();
         $$3.a(this.eW());
   ...
   public boolean a(brp $$0, float $$1) {
      if (this.b($$0)) {
         ...
         return false;
      } else if ($$0.a(awr.j) && this.b(bsg.l)) {
         return false;
      } else {
         ...
         if ($$1 > 0.0F && this.f($$0)) {
            ...
            $$4 = $$1;
            $$1 = 0.0F;
            if (!$$0.a(awr.k) && $$0.c() instanceof btr $$6) {
               this.d($$6);
            }
         ...
         bsw $$8 = $$0.d();
         if ($$8 != null) {
            if ($$8 instanceof btr $$9 && !$$0.a(awr.r) && (!$$0.a(brs.G) || !this.ak().a(awt.E))) {
               this.a($$9);
            }

            if ($$8 instanceof cmz $$10) {
               this.bd = 100;
               this.bc = $$10;
            } else if ($$8 instanceof cgk $$11 && $$11.s()) {
               this.bd = 100;
               if ($$11.P_() instanceof cmz $$12) {
                  this.bc = $$12;
               } else {
                  this.bc = null;
               }
   ...
   private boolean h(brp $$0) {
      if ($$0.a(awr.e)) {
         ...
         if ($$1 != null) {
            ...
            this.t(1.0F);
            this.ew();
            this.b(new bse(bsg.j, 900, 1));
            this.b(new bse(bsg.v, 100, 1));
            this.b(new bse(bsg.l, 800, 0));
   ...
   public boolean f(brp $$0) {
      bsw $$1 = $$0.c();
      boolean $$2 = false;
      if ($$1 instanceof cnf $$3 && $$3.D() > 0) {
         $$2 = true;
      }
      ...
      if (!$$0.a(awr.d) && this.fC() && !$$2) {
         evt $$4 = $$0.h();
         if ($$4 != null) {
            evt $$5 = this.b(0.0F, this.cs());
            evt $$6 = $$4.a(this.dn());
            $$6 = new evt($$6.c, 0.0, $$6.e).d();
            return $$6.b($$5) < 0.0;
         }
      }
   ...
   protected void f(@Nullable btr $$0) {
      if (!this.dP().B) {
         boolean $$1 = false;
         if ($$0 instanceof cix) {
            if (this.dP().ab().b(dbw.c)) {
               iz $$2 = this.dp();
               dse $$3 = dfd.cd.o();
               if (this.dP().a_($$2).i() && $$3.a((dcd)this.dP(), $$2)) {
                  this.dP().a($$2, $$3, 3);
                  $$1 = true;
               }
            }
            ...
            if (!$$1) {
               cjj $$4 = new cjj(this.dP(), this.du(), this.dw(), this.dA(), new cur(cuu.dw));
               this.dP().b($$4);
            }
         }
      }
   ...
   protected void eE() {
      if (this.dP() instanceof arf && !this.eI() && (this.ek() || this.bd > 0 && this.eh() && this.dP().ab().b(dbw.f))) {
         bth.a((arf)this.dP(), this.dn(), this.ej());
      }
   }
   ...
   protected void a(brp $$0, boolean $$1) {
      ale<eqp> $$2 = this.eF();
      eqp $$3 = this.dP().o().be().b($$2);
      eqn.a $$4 = new eqn.a((arf)this.dP()).a(etg.a, this).a(etg.f, this.dn()).a(etg.c, $$0).b(etg.d, $$0.d()).b(etg.e, $$0.c());
      if ($$1 && this.bc != null) {
         $$4 = $$4.a(etg.b, this.bc).a(this.bc.gy());
      }
   ...
   public btr.a eL() {
      return new btr.a(awa.kh, awa.jZ);
   }
   ...
   public boolean q_() {
      if (this.N_()) {
         ...
         if ($$1.a(awp.aP)) {
            ...
            return true;
         } else if ($$1.b() instanceof dno && this.c($$0, $$1)) {
            this.ci = Optional.of($$0);
            return true;
         } else {
            return false;
   ...
   private boolean c(iz $$0, dse $$1) {
      if ($$1.c(dno.b)) {
         dse $$2 = this.dP().a_($$0.d());
         if ($$2.a(dfd.cO) && $$2.c(djh.b) == $$1.c(dno.aE)) {
            return true;
         }
      }
   ...
   protected int d(float $$0, float $$1) {
      if (this.ak().a(awt.o)) {
         ...
         float $$2 = (float)this.g(buz.s);
         float $$3 = $$0 - $$2;
         return ayz.c((double)($$3 * $$1) * this.g(buz.i));
      }
   }
   ...
   public int eO() {
      return ayz.a(this.g(buz.a));
   }

   protected void b(brp $$0, float $$1) {
   }

   protected void c(brp $$0, float $$1) {
   }

   protected void v(float $$0) {
   }

   protected void a(brp $$0, float $$1, btd... $$2) {
      if (!($$1 <= 0.0F)) {
         int $$3 = (int)Math.max(1.0F, $$1 / 4.0F);

         for (btd $$4 : $$2) {
            cur $$5 = this.a($$4);
            if ($$5.g() instanceof csg && $$5.a($$0)) {
               $$5.a($$3, this, $$4);
            }
         }
      }
   ...
   protected float d(brp $$0, float $$1) {
      if (!$$0.a(awr.c)) {
         this.b($$0, $$1);
         $$1 = brl.a($$1, $$0, (float)this.eO(), (float)this.g(buz.b));
      }
   ...
   protected float e(brp $$0, float $$1) {
      if ($$0.a(awr.g)) {
         ...
         if (this.b(bsg.k) && !$$0.a(awr.h)) {
            int $$2 = (this.c(bsg.k).e() + 1) * 5;
            int $$3 = 25 - $$2;
            float $$4 = $$1 * (float)$$3;
            float $$5 = $$1;
   ...
   public final float eR() {
      return (float)this.g(buz.q);
   }

   public final float eS() {
      return (float)this.g(buz.p);
   }
   ...
   private int A() {
      if (bsf.a(this)) {
         return 6 - (1 + bsf.b(this));
      } else {
         return this.b(bsg.d) ? 6 + (1 + this.c(bsg.d).e()) * 2 : 6;
      }
   }
   ...
   @Nullable
   public buv f(ji<buu> $$0) {
      return this.eW().a($$0);
   }

   public double g(ji<buu> $$0) {
      return this.eW().c($$0);
   }

   public double h(ji<buu> $$0) {
      return this.eW().d($$0);
   }
   ...
   public boolean b(Predicate<cur> $$0) {
   ...
   public abstract Iterable<cur> eZ();

   public abstract cur a(btd var1);

   public abstract void a(btd var1, cur var2);
   ...
   public Iterable<cur> fc() {
      return Iterables.concat(this.fa(), this.fb());
   }

   protected void e(cur $$0) {
      $$0.g().n($$0);
   }

   public float fd() {
      Iterable<cur> $$0 = this.eZ();
      int $$1 = 0;
      int $$2 = 0;
   ...
   protected float w(float $$0) {
      return (float)this.g(buz.m) * $$0 * this.aM() + this.fi();
   }

   public float fi() {
      return this.b(bsg.h) ? 0.1F * ((float)this.c(bsg.h).e() + 1.0F) : 0.0F;
   }
   ...
   protected void fj() {
      ...
      if (!($$0 <= 1.0E-5F)) {
         ...
         if (this.cb()) {
            ...
            this.i(new evt((double)(-ayz.a($$2)) * 0.2, 0.0, (double)ayz.b($$2) * 0.2));
         }
   ...
   public void a(evt $$0) {
      if (this.da()) {
         ...
         if (this.be() && this.ef() && !this.a($$3)) {
            ...
            evt $$8 = this.ds();
            if (this.Q && this.q_()) {
               $$8 = new evt($$8.c, 0.2, $$8.e);
            }

            this.h($$8.d((double)$$5, 0.8F, (double)$$5));
            evt $$9 = this.a($$1, $$2, this.ds());
            this.h($$9);
            ...
            double $$29 = $$28.d;
            if (this.b(bsg.y)) {
               $$29 += (0.05 * (double)(this.c(bsg.y).e() + 1) - $$28.d) * 0.2;
            ...
            if (this.er()) {
               ...
               this.o($$28.c * (double)$$27, this instanceof cfq ? $$29 * (double)$$27 : $$29 * 0.98F, $$28.e * (double)$$27);
            }
         }
      }

      this.r(this instanceof cfq);
   }

   private void c(cmz $$0, evt $$1) {
      evt $$2 = this.b($$0, $$1);
      this.a($$0, $$2);
      if (this.da()) {
         this.y(this.e($$0));
   ...
   public evt a(evt $$0, float $$1) {
      ...
      this.a(btw.a, this.ds());
      evt $$2 = this.ds();
      if ((this.Q || this.bn) && (this.q_() || this.dq().a(dfd.qP) && dkv.a(this))) {
         $$2 = new evt($$2.c, 0.2, $$2.e);
      }

      return $$2;
   }

   public evt a(double $$0, boolean $$1, evt $$2) {
      if ($$0 != 0.0 && !this.cb()) {
         double $$3;
   ...
   private evt k(evt $$0) {
      if (this.q_()) {
         ...
         if ($$4 < 0.0 && !this.dq().a(dfd.nS) && this.fD() && this instanceof cmz) {
            $$4 = 0.0;
         }
   ...
   protected float fm() {
      return this.cQ() instanceof cmz ? this.fn() * 0.1F : 0.02F;
   }
   ...
   private void a(Map<btd, cur> $$0) {
      cur $$1 = $$0.get(btd.a);
      cur $$2 = $$0.get(btd.b);
      if ($$1 != null && $$2 != null && cur.a($$1, this.g(btd.b)) && cur.a($$2, this.g(btd.a))) {
   ...
   private void b(Map<btd, cur> $$0) {
      List<Pair<btd, cur>> $$1 = Lists.newArrayListWithCapacity($$0.size());
      $$0.forEach(($$1x, $$2) -> {
         cur $$3 = $$2.s();
         $$1.add(Pair.of($$1x, $$3));
         switch ($$1x.a()) {
   ...
   public void n_() {
      ...
      this.G();
      evo $$8 = this.cK();
      evt $$9 = new evt((double)this.bo, (double)this.bp, (double)this.bq);
      if (this.b(bsg.B) || this.b(bsg.y)) {
         this.n();
      }

      label104: {
         if (this.cQ() instanceof cmz $$10 && this.bD()) {
            this.c($$10, $$9);
            break label104;
         }
   ...
   private void G() {
      boolean $$0 = this.j(7);
      if ($$0 && !this.aE() && !this.bR() && !this.b(bsg.y)) {
         cur $$1 = this.a(btd.e);
         if ($$1.a(cuu.nT) && ctn.j($$1)) {
            $$0 = true;
            int $$2 = this.bB + 1;
            if (!this.dP().B && $$2 % 10 == 0) {
               int $$3 = $$2 / 10;
   ...
   protected void q() {
      if (this.dP().x_()) {
         this.dP().a(dwl.a(cmz.class), this.cK(), btb.a(this)).forEach(this::D);
      } else {
         List<bsw> $$0 = this.dP().a(this, this.cK(), btb.a(this));
         if (!$$0.isEmpty()) {
            int $$1 = this.dP().ab().c(dbw.u);
   ...
   protected void a(evo $$0, evo $$1) {
      evo $$2 = $$0.b($$1);
      List<bsw> $$3 = this.dP().a_(this, $$2);
      if (!$$3.isEmpty()) {
         for (bsw $$4 : $$3) {
            if ($$4 instanceof btr) {
               this.g((btr)$$4);
   ...
   public void a(bsw $$0, int $$1) {
      if (!$$0.dK() && !this.dP().B && ($$0 instanceof cjj || $$0 instanceof cnf || $$0 instanceof bth)) {
   ...
   public boolean E(bsw $$0) {
      if ($$0.dP() != this.dP()) {
         ...
         evt $$1 = new evt(this.du(), this.dy(), this.dA());
         evt $$2 = new evt($$0.du(), $$0.dy(), $$0.dA());
         return $$2.f($$1) > 128.0 ? false : this.dP().a(new dbj($$1, $$2, dbj.a.a, dbj.b.a, this)).c() == evr.a.a;
      }
   }
   ...
   public static evt j(evt $$0) {
      return new evt($$0.c, $$0.d, 0.0);
   }
   ...
   public bqv fw() {
      return (this.ao.a(aF) & 2) > 0 ? bqv.b : bqv.a;
   }

   private void H() {
      if (this.fv()) {
         if (cur.b(this.b(this.fw()), this.bz)) {
   ...
   private void a(cur $$0, int $$1) {
      for (int $$2 = 0; $$2 < $$1; $$2++) {
         ...
         evt $$5 = new evt(((double)this.ah.i() - 0.5) * 0.3, $$4, 0.6);
   ...
   public boolean fC() {
      if (this.fv() && !this.bz.e()) {
         cum $$0 = this.bz.g();
         return $$0.c(this.bz) != cwm.d ? false : $$0.b(this.bz) - this.bA >= 5;
      } else {
         return false;
      }
   }
   ...
   @Override
   public boolean cd() {
      return super.cd() || !this.fE() && this.c(bud.b);
   }
   ...
   @Override
   public final bsz a(bud $$0) {
      return $$0 == bud.c ? aG : this.e($$0).a(this.ee());
   }

   protected bsz e(bud $$0) {
      return this.ak().n().a(this.ed());
   }

   public ImmutableList<bud> fI() {
      return ImmutableList.of(bud.a);
   }

   public evo f(bud $$0) {
      bsz $$1 = this.a($$0);
      return new evo((double)(-$$1.a() / 2.0F), 0.0, (double)(-$$1.a() / 2.0F), (double)($$1.a() / 2.0F), (double)$$1.b(), (double)($$1.a() / 2.0F));
   }

   protected boolean g(bud $$0) {
      evo $$1 = this.a($$0).a(this.dn());
   ...
   public void b(iz $$0) {
      ...
      if ($$1.b() instanceof deu) {
         this.dP().a($$0, $$1.a(deu.c, Boolean.valueOf(true)), 3);
      }
   ...
   private boolean M() {
      return this.fJ().map($$0 -> this.dP().a_($$0).b() instanceof deu).orElse(false);
   }
   ...
   public void fM() {
      this.fJ().filter(this.dP()::B).ifPresent($$0x -> {
         ...
         if ($$1.b() instanceof deu) {
            je $$2 = $$1.c(deu.aE);
            this.dP().a($$0x, $$1.a(deu.c, Boolean.valueOf(false)), 3);
            evt $$3 = deu.a(this.ak(), this.dP(), $$0x, $$2, this.dF()).orElseGet(() -> {
               iz $$1x = $$0x.c();
               return new evt((double)$$1x.u() + 0.5, (double)$$1x.v() + 0.1, (double)$$1x.w() + 0.5);
            });
            evt $$4 = evt.c($$0x).d($$3).d();
   ...
   public je fN() {
      ...
      return $$0 != null ? deu.a(this.dP(), $$0) : null;
   }
   ...
   public static btd d(bqv $$0) {
      return $$0 == bqv.a ? btd.a : btd.b;
   }

   @Override
   public evo h_() {
      if (this.a(btd.f).a(cuu.uq)) {
         float $$0 = 0.5F;
   ...
   public static btd h(cur $$0) {
      ctt $$1 = ctt.c_($$0);
      return $$1 != null ? $$1.m() : btd.a;
   }

   private static buj a(btr $$0, btd $$1) {
      return $$1 != btd.f && $$1 != btd.a && $$1 != btd.b ? buj.a($$0, $$1, $$1x -> $$1x.e() || btt.h($$1x) == $$1) : buj.a($$0, $$1);
   }

   @Nullable
   private static btd s(int $$0) {
      if ($$0 == 100 + btd.f.b()) {
         return btd.f;
      } else if ($$0 == 100 + btd.e.b()) {
         return btd.e;
      } else if ($$0 == 100 + btd.d.b()) {
         return btd.d;
      } else if ($$0 == 100 + btd.c.b()) {
         return btd.c;
      } else if ($$0 == 98) {
         return btd.a;
      } else if ($$0 == 99) {
   ...
   public boolean dD() {
      if (this.N_()) {
         ...
         boolean $$0 = !this.a(btd.f).a(awy.ba) && !this.a(btd.e).a(awy.ba) && !this.a(btd.d).a(awy.ba) && !this.a(btd.c).a(awy.ba) && !this.a(btd.g).a(awy.ba);
         return $$0 && super.dD();
      }
   }
   ...
   @Override
   public boolean cg() {
      return !this.dP().x_() && this.b(bsg.x) || super.cg();
   }
   ...
   public boolean fO() {
      return this.eX().g() instanceof csl;
   }

   @Override
   public float dJ() {
      float $$0 = (float)this.g(buz.v);
      return this.cQ() instanceof cmz ? Math.max($$0, 1.0F) : $$0;
   }
