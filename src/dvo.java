...
public class dvo extends dtz {
   ...
   protected void b(tq $$0, jt.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (un)czo.a.encodeStart(ue.a, this.i).getOrThrow());
      }
   ...
   protected void a(tq $$0, jt.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         czo.a.parse(ue.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }
   ...
   public static void a(dgi $$0, ji $$1, dwx $$2, dvo $$3) {
      if ($$2.b(dqt.a) && $$2.c(dqt.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
