...
public class dhu extends dlz {
   ...
   protected dhu(dtb.d $$0) {
      super($$0);
      this.k(this.E.b().a(a, iw.b));
   }
   ...
   public void a(dtc $$0, dca $$1, ir $$2, ayt $$3) {
      ...
      if ($$3.a(5) == 0) {
         $$1.a(lb.t, $$5 + (double)$$4.j() * $$8, $$6 + (double)$$4.k() * $$8, $$7 + (double)$$4.l() * $$8, $$3.k() * 0.005, $$3.k() * 0.005, $$3.k() * 0.005);
      }
   }
