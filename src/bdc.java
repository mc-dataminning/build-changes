...
public class bdc<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public bdc(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> bdc<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bdd<T> a() throws IOException {
      if (this.d.get() <= 0) {
         throw new IOException("Event log has already been closed");
      } else {
         this.d.incrementAndGet();
         final bdd<T> $$0 = bdd.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bdd<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  bdc.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = bdc.this.c.position();
               }
