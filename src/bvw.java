...
public class bvw {
   ...
   private static boolean a(bjg $$0, bkg<?> $$1, hf $$2) {
   ...
   public static Optional<aks> a(bjg $$0) {
      cpv $$1 = $$0.dL();
      if (!$$1.w_() && $$1 instanceof akr $$2) {
         Optional<UUID> $$3 = $$0.dN().c(bsh.aL);
         if ($$3.isPresent()) {
            if ($$2.a($$3.get()) instanceof aks $$5 && ($$5.e.d() || $$5.e.e()) && $$5.a($$0, 64.0)) {
