...
public class ffz {
   ...
   private final avu r;
   private final int s;
   private final List<avu> t;
   private final exo u;
   @Nullable
   private ffz v;
   private final List<ffz> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public ffz(ffx $$0, exo $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = sr.a().a($$1.h.a($$3.a(), 163));
      this.y = awi.d($$3.f() * 28.0F);
      this.z = awi.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
   ...
   private static float a(eya $$0, List<vv> $$1) {
   ...
   public void a(ezb $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
