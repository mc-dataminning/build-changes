...
public class ffz implements ffy {
   public static final MapCodec<ffz> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               Codec.INT.optionalFieldOf("Score", 0).forGetter(ffz::a),
               Codec.BOOL.optionalFieldOf("Locked", false).forGetter(ffz::b),
   ...
   private ffz(int $$0, boolean $$1, Optional<wy> $$2, Optional<yo> $$3) {
      this.b = $$0;
      this.c = $$1;
