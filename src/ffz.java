...
public interface ffz {
   ffz a(float var1, float var2, float var3);

   ffz a(int var1, int var2, int var3, int var4);

   ffz a(float var1, float var2);

   ffz a(int var1, int var2);

   ffz b(int var1, int var2);

   ffz b(float var1, float var2, float var3);
   ...
   default ffz a(float $$0, float $$1, float $$2, float $$3) {
   ...
   default void a(ffv.a $$0, gng $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(ffv.a $$0, gng $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      int[] $$10 = $$1.b();
      km $$11 = $$1.e().q();
      Matrix4f $$12 = $$0.a();
      ...
      try {
         ByteBuffer $$19 = $$18.malloc(fft.b.b());
   ...
   default ffz a(Vector3f $$0) {
      return this.a($$0.x(), $$0.y(), $$0.z());
   }

   default ffz a(ffv.a $$0, Vector3f $$1) {
      return this.a($$0, $$1.x(), $$1.y(), $$1.z());
   }

   default ffz a(ffv.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default ffz a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a($$4.x(), $$4.y(), $$4.z());
   }

   default ffz b(ffv.a $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.a($$1, $$2, $$3, new Vector3f());
      return this.b($$4.x(), $$4.y(), $$4.z());
   }

   default ffz b(ffv.a $$0, Vector3f $$1) {
