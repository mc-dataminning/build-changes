...
public record ffz(int i, int j, ffz.a k, ffz.b l, int m) {
   public static final int a = 32;
   private static final ffz[] n = new ffz[32];
   private static final List<ffz> o = new ArrayList<>(32);
   public static final ffz b = a(0, 0, ffz.a.a, ffz.b.a, 3);
   public static final ffz c = a(1, 0, ffz.a.b, ffz.b.c, 4);
   public static final ffz d = a(2, 0, ffz.a.a, ffz.b.d, 2);
   public static final ffz e = d;
   public static final ffz f = a(3, 1, ffz.a.e, ffz.b.d, 2);
   public static final ffz g = a(4, 2, ffz.a.e, ffz.b.d, 2);
   public static final ffz h = a(5, 0, ffz.a.c, ffz.b.b, 3);

   public ffz(int i, int j, ffz.a k, ffz.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static ffz a(int $$0, int $$1, ffz.a $$2, ffz.b $$3, int $$4) {
      ffz $$5 = new ffz($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, ffz.b $$1) {
      return $$0 == 0 || $$1 == ffz.b.d;
   }
   ...
   @Nullable
   public static ffz a(int $$0) {
      return n[$$0];
   }

   public static Stream<ffz> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final ffz.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
