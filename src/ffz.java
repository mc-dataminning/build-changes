...
public class ffz {
   public static void a(ful<?> $$0, ffx $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<ffw>> $$6 : $$1.c().entrySet()) {
         Optional<fxc> $$7 = $$0.a($$6.getKey());
         List<ffw> $$8 = $$6.getValue();
   ...
   private static float a(ffx $$0, long $$1) {
