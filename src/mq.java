...
public class mq implements mm {
   ...
   public static final List<bus<?>> b = List.of(bus.bA, bus.ab, bus.bi);
   ...
   public void a(jt.a $$0, Consumer<ai> $$1) {
      ...
      ai $$7 = ah.a.a()
         .a($$6)
         .a(cwt.qb, wp.c("advancements.husbandry.plant_seed.title"), wp.c("advancements.husbandry.plant_seed.description"), null, ao.a, true, true, false)
         .a(al.a.b)
      ...
      a(ah.a.a(), $$3)
         .a($$7)
         .a(cwt.oZ, wp.c("advancements.husbandry.balanced_diet.title"), wp.c("advancements.husbandry.balanced_diet.description"), null, ao.b, true, true, false)
         .a(am.a.a(100))
         .a($$1, "husbandry/balanced_diet");
      ah.a.a()
         .a($$7)
         .a(cwt.pU, wp.c("advancements.husbandry.netherite_hoe.title"), wp.c("advancements.husbandry.netherite_hoe.description"), null, ao.b, true, true, false)
         .a(am.a.a(100))
      ...
      ah.a.a()
         .a($$12)
         .a("kill_axolotl_target", bq.a.a(bx.a.a().a($$2, bus.h)))
         .a(
            cwt.rp,
      ...
      a(ah.a.a(), $$0)
         .a($$9)
         .a(cwt.sw, wp.c("advancements.husbandry.whole_pack.title"), wp.c("advancements.husbandry.whole_pack.description"), null, ao.b, true, true, false)
         .a(am.a.a(50))
      ...
      ai $$14 = ah.a.a()
         .a($$13)
         .a(cwt.xA, wp.c("advancements.husbandry.wax_on.title"), wp.c("advancements.husbandry.wax_on.description"), null, ao.a, true, true, false)
         .a("wax_on", cz.a.a(di.a.a().a(ay.a.a().a($$4, cwg.a.get().keySet())), cv.a.a().a($$3, cwt.xA)))
         .a($$1, "husbandry/wax_on");
      ah.a.a()
         .a($$14)
         .a(cwt.pz, wp.c("advancements.husbandry.wax_off.title"), wp.c("advancements.husbandry.wax_off.description"), null, ao.a, true, true, false)
      ...
      ah.a.a()
         .a($$16)
         .a(cwt.yr, wp.c("advancements.husbandry.froglights.title"), wp.c("advancements.husbandry.froglights.description"), null, ao.b, true, true, false)
      ...
      ah.a.a()
         ...
         .a("ride_a_boat_with_a_goat", ee.a.a(bx.a.a().a(bx.a.a().a($$2, awt.I).b(bx.a.a().a($$2, bus.ah)))))
      ...
      ai $$17 = ah.a.a()
         ...
         .a("allay_deliver_item_to_player", dp.a.a(Optional.empty(), Optional.empty(), Optional.of(bx.a(bx.a.a().a($$2, bus.c)))))
      ...
      ai $$19 = ah.a.a()
         .a($$18)
         .a(cwt.wi, wp.c("advancements.husbandry.feed_snifflet.title"), wp.c("advancements.husbandry.feed_snifflet.description"), null, ao.a, true, true, true)
         .a("feed_snifflet", dr.a.a(cv.a.a().a($$3, awy.aa), Optional.of(bx.a(bx.a.a().a($$2, bus.bi).a(bv.a.a().g(true))))))
      ...
      ah.a.a()
         ...
         .a("remove_wolf_armor", dr.a.a(cv.a.a().a($$3, cwt.sS), Optional.of(bx.a(bx.a.a().a($$2, bus.bL)))))
      ...
      ah.a.a()
         ...
         .a(
            "repair_wolf_armor",
            dr.a.a(cv.a.a().a($$3, cwt.oV), Optional.of(bx.a(bx.a.a().a($$2, bus.bL).a(bu.a.a().e(cv.a.a().a($$3, cwt.oW).a(kt.a().a(kv.e, 0).a()))))))
         )
         .a($$1, "husbandry/repair_wolf_armor");
   }

   public static ai a(ai $$0, Consumer<ai> $$1, js<bus<?>> $$2, Stream<bus<?>> $$3, Stream<bus<?>> $$4) {
   ...
   private static ah.a a(js<bus<?>> $$0, js<cwl> $$1, ah.a $$2) {
      mb.aj.c().forEach($$3 -> $$2.a($$3.h().a().toString(), dr.a.a(cv.a.a().a($$1, cwt.vK), Optional.of(bx.a(bx.a.a().a($$0, bus.ab).a(bz.b($$3)))))));
      return $$2;
   }
   ...
   private static ah.a a(ah.a $$0, Stream<bus<?>> $$1, js<bus<?>> $$2, Stream<bus<?>> $$3) {
      $$1.forEach($$2x -> $$0.a(bus.a($$2x).toString(), az.a.a(bx.a.a().a($$2, $$2x))));
      $$3.forEach(
         $$2x -> $$0.a(bus.a($$2x).toString(), az.a.a(Optional.of(bx.a.a().a($$2, $$2x).b()), Optional.of(bx.a.a().a($$2, $$2x).b()), Optional.empty()))
      );
      return $$0;
   }
