...
public class cdd<T extends clw & cma> extends ccd {
   private final T a;
   ...
   public cdd(T $$0, double $$1, int $$2, float $$3) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3 * $$3;
   ...
   protected boolean h() {
      return this.a.b(cwr.pa);
   }

   @Override
   public boolean c() {
      return (this.b() || !this.a.L().k()) && this.h();
   }
