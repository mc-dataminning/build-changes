public class cdd implements ccz {
   ...
   public void a() {
      if (this.k == cdd.a.c) {
         ...
         iu $$14 = this.d.dv();
         eah $$15 = this.d.dV().a_($$14);
         ffk $$16 = $$15.g(this.d.dV(), $$14);
      ...
      } else if (this.k == cdd.a.d) {
         this.d.B((float)(this.h * this.d.h(byk.v)));
         if (this.d.aJ() || this.d.bm() && this.d.em()) {
            this.k = cdd.a.a;
         }
      } else {
         this.d.G(0.0F);
   ...
   private boolean b(float $$0, float $$1) {
      ...
      if ($$2 != null) {
         exb $$3 = $$2.n();
         if ($$3 != null && $$3.a(this.d, iu.a(this.d.dA() + (double)$$0, (double)this.d.dB(), this.d.dG() + (double)$$1)) != exf.c) {
            return false;
         }
      }
