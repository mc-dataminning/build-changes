...
public class fwk<T extends bjm, M extends fgd<T>> extends fxu<T, M> {
   private static final aez a = new aez("textures/entity/bee/bee_stinger.png");

   public fwk(fue<T, M> $$0) {
      super($$0);
   }
   ...
   private static void a(eln $$0, Matrix4f $$1, Matrix3f $$2, float $$3, int $$4, float $$5, float $$6, int $$7) {
      $$0.a($$1, $$3, (float)$$4, 0.0F).a(255, 255, 255, 255).a($$5, $$6).c(fyr.d).b($$7).a($$2, 0.0F, 1.0F, 0.0F).e();
   }
}
