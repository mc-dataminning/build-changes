...
public class fwk implements fwi {
   ...
   private final fwk.a n;
   private final List<azk> o;
   private fwi.a p = fwi.a.a;
   private long q;
   private float r;
   private float s;
   ...
   public fwk(fti $$0, fwk.a $$1, xg $$2, @Nullable xg $$3, boolean $$4, int $$5) {
      this.n = $$1;
   ...
   public fwk(fti $$0, fwk.a $$1, xg $$2, @Nullable xg $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, 0);
   }
   ...
   public void a(fwj $$0, long $$1) {
      if (this.u > 0) {
         ...
         this.r = azz.b(this.r, this.s, (float)($$1 - this.q) / 100.0F);
         this.q = $$1;
      }
   }
   ...
   public static enum a {
      a(alr.b("toast/movement_keys")),
      b(alr.b("toast/mouse")),
      c(alr.b("toast/tree")),
      d(alr.b("toast/recipe_book")),
      e(alr.b("toast/wooden_planks")),
      f(alr.b("toast/social_interactions")),
      g(alr.b("toast/right_click"));
