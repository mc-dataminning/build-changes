...
public class bjj extends bjd {
   public static final Codec<bjj> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bjj a(float $$0, float $$1, float $$2) {
      return new bjj($$0, $$1, $$2);
   }

   private bjj(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
   }
