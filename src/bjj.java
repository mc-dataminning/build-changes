...
public class bjj extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$2 = this.getInputSchema().getType(bjb.D);
      Type<?> $$3 = this.getOutputSchema().getType(bjb.D);
      Type<?> $$4 = bbf.a($$2, $$2, $$3);
      return this.fixTypeEverywhereTyped("SaddleEquipmentSlotFix", $$2, $$3, $$3x -> {
         String $$4x = $$3x.getOptional($$1).<String>map(Pair::getFirst).map(bkw::a).orElse("");
         Typed<?> $$5 = bbf.a($$4, $$3x);
         if (a.contains($$4x)) {
            return ag.a($$5, $$3, bjj::a);
         } else {
            return b.contains($$4x) ? ag.a($$5, $$3, bjj::b) : bbf.a($$3, $$3x);
         }
      });
   }
