public interface czf {
   int a = 256;
   float b = 7.0F;
   alf<czd> c = a("ponder_goat_horn");
   alf<czd> d = a("sing_goat_horn");
   alf<czd> e = a("seek_goat_horn");
   alf<czd> f = a("feel_goat_horn");
   alf<czd> g = a("admire_goat_horn");
   alf<czd> h = a("call_goat_horn");
   alf<czd> i = a("yearn_goat_horn");
   alf<czd> j = a("dream_goat_horn");

   private static alf<czd> a(String $$0) {
      return alf.a(mh.aU, alg.b($$0));
   }

   static void a(qh<czd> $$0) {
   ...
   static void a(qh<czd> $$0, alf<czd> $$1, jf<awm> $$2, float $$3, float $$4) {
      xm $$5 = wy.c(ag.a("instrument", $$1.a()));
      $$0.a($$1, new czd($$2, $$3, $$4, $$5));
   }
}
