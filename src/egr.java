...
public class egr extends efw<eii> {
   ...
   protected boolean a(
      dhe $$0, azg $$1, eii $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dwv $$0, Function<ji, dwv> $$1, azg $$2, eii $$3, eii.a $$4, ji.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
