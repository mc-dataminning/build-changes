...
public interface egr {
   static egr a(ehj $$0, dje $$1, ehl $$2, ehs $$3, int $$4, int $$5, egr.a $$6) {
      return new egr.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static egr a(final egr.a $$0) {
      return new egr() {
         @Nullable
         @Override
         public ebg a(egy.b $$0x, double $$1) {
   ...
   @Nullable
   ebg a(egy.b var1, double var2);

   boolean a();

   public interface a {
      egr.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, ebg b) {

      public ebg a(int $$0) {
         return $$0 < this.a ? this.b : dng.a.m();
      }
   }
   ...
   public static class c implements egr {
      ...
      private static final double k = a(azq.h(10), azq.h(12));
      private final ehj l;
      private final egy m;
      private final egy n;
      private final egy o;
      private final egy p;
      private final ehs q;
      private final egr.b[] r;
      private final long[] s;
      private final egr.a t;
      private final egy u;
      private final egy v;
      private boolean w;
      private final int x;
      ...
      c(ehj $$0, dje $$1, ehl $$2, ehs $$3, int $$4, int $$5, egr.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public ebg a(egy.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            egr.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dng.K)) {
               this.w = false;
               return dng.K.m();
            } else {
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(dng.J) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dng.K)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(egy.b $$0, MutableDouble $$1, egr.b $$2, egr.b $$3) {
         int $$4 = $$0.b();
         ebg $$5 = $$2.a($$4);
         ebg $$6 = $$3.a($$4);
         if ((!$$5.a(dng.K) || !$$6.a(dng.J)) && (!$$5.a(dng.J) || !$$6.a(dng.K))) {
      ...
      private egr.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            egr.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private egr.b b(int $$0, int $$1, int $$2) {
         egr.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               egr.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new egr.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, egr.b $$3, int $$4, boolean $$5) {
         egy.e $$6 = new egy.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dls.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
            int $$10 = 64;
            double $$11 = $$5 ? azq.a((double)$$9, 0.0, 64.0, 1.0, 0.0) : 0.0;
            double $$12 = azq.a(this.n.a($$6), -1.0, 1.0);
            double $$13 = azq.b($$11, 1.0, 0.0, -0.3, 0.8);
            double $$14 = azq.b($$11, 1.0, 0.0, -0.8, 0.4);
            $$7 = $$12 - $$14;
            $$8 = $$12 - $$13;
         }
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new egy.e($$6, $$7, $$8)) * 10.0;
         int $$12 = azq.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private ebg a(int $$0, int $$1, int $$2, egr.b $$3, int $$4) {
         ebg $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != efd.g && $$3.b != dng.K.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new egy.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dng.K.m();
            }
         }
