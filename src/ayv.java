...
public class ayv {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> axx.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> axx.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayv.c> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alj.d($$0.substring(1)).map($$0x -> new ayv.c($$0x, true)) : alj.d($$0).map($$0x -> new ayv.c($$0x, false)), ayv.c::c
      );
   ...
   public static Codec<String> C = Codec.STRING
      .validate($$0 -> !alj.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ayv.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayv.b<>($$0, $$1);
   }
   ...
   public static record c(alj a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
