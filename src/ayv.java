...
public class ayv implements AutoCloseable {
   ...
   private ayv(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ayv.a a(Path $$0) {
         return new ayv.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
