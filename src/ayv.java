...
public class ayv extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bbg.x);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", ayv::c), this.a("minecraft:arrow", ayv::a), this.a("minecraft:spectral_arrow", ayv::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, ayv.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bbg.x, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bbg.x, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, ayv.a<?> $$1, Type<?> $$2, Type<T> $$3) {
