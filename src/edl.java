...
public abstract class edl extends edj {
   ...
   protected static <T extends edl> P4<Mu<T>, Integer, Integer, List<efp>, List<eed>> b(Instance<T> $$0) {
      return $$0.group(
            arg.a(Codec.INT, "weight", Integer.valueOf(1)).forGetter($$0x -> $$0x.g), arg.a(Codec.INT, "quality", Integer.valueOf(0)).forGetter($$0x -> $$0x.h)
         )
         .and(a($$0).t1())
         .and(arg.a(eef.b.listOf(), "functions", List.of()).forGetter($$0x -> $$0x.i));
   }
   ...
   protected abstract class c implements edi {
      ...
      public int a(float $$0) {
         return Math.max(arx.d((float)edl.this.g + (float)edl.this.h * $$0), 0);
      }
   }
