...
public class fmc {
   ...
   public void a(fnv $$0, String $$1, fot.a $$2, ezx $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fmc.b $$13 = new fmc.b($$1.trim(), this.f, $$3, $$2);
                  fmc.a $$14 = new fmc.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fmc.c $$30 = new fmc.c(this.f, $$2, $$0);
                        fmc.a $$31 = new fmc.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fnz(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ezx $$2) throws IOException {
      ...
      File $$15 = new File(frf.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ezx d;
      private final fot.a e;

      b(final String $$0, final File $$1, final ezx $$2, final fot.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fmc.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fmc.this.b && !fmc.this.d) {
            try {
               fmc.this.e = true;
               fmc.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fmc.a.error("Error extracting archive", var3);
               fmc.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fot.a c;
      private final fnv d;

      c(final File $$0, final fot.a $$1, final fnv $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fmc.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fmc.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fmc.this.g);
                  fmc.this.c = true;
               } else {
                  fmc.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fmc.this.d = true;
               }
            } catch (IOException var3) {
               fmc.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fmc.this.d = true;
            }
         }
      }
