...
public class fmc extends fne {
   private static final alf a = new alf("icon/draft_report");
   private int b;
   private final xp c;
   private final boolean d;
   private xp r;
   private final List<fhf> s = Lists.newArrayList();
   @Nullable
   private fhf u;

   public fmc(@Nullable xp $$0, boolean $$1) {
   ...
   protected void aM_() {
      ...
      this.s.add(this.c(fhf.a($$0, $$0x -> {
         this.m.s.ga();
         $$0x.j = false;
      }).a(this.n / 2 - 100, this.o / 4 + 72, 200, 20).a()));
      this.u = this.c(
         fhf.a(xp.c("deathScreen.titleScreen"), $$0x -> this.m.aZ().a(this.m, this, this::m, true)).a(this.n / 2 - 100, this.o / 4 + 96, 200, 20).a()
      );
      this.s.add(this.u);
      this.c(false);
   ...
   private void E() {
      ...
      this.m.b(new fmk(xp.c("menu.savingLevel")));
      this.m.a(new fnj());
   }
   ...
   static void a(fgs $$0, int $$1, int $$2) {
