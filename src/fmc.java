...
public abstract class fmc extends flp {
   protected float D = 0.1F * (this.r.i() * 0.5F + 0.5F) * 2.0F;

   protected fmc(fis $$0, double $$1, double $$2, double $$3) {
      super($$0, $$1, $$2, $$3);
   }

   protected fmc(fis $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }
   ...
   public void a(elo $$0, eqb $$1, float $$2) {
      ehi $$3 = $$1.b();
      float $$4 = (float)(ars.d((double)$$2, this.d, this.g) - $$3.a());
      float $$5 = (float)(ars.d((double)$$2, this.e, this.h) - $$3.b());
      float $$6 = (float)(ars.d((double)$$2, this.f, this.i) - $$3.c());
      Quaternionf $$7;
      if (this.z == 0.0F) {
         $$7 = $$1.f();
      } else {
         $$7 = new Quaternionf($$1.f());
         $$7.rotateZ(ars.i($$2, this.A, this.z));
      }
