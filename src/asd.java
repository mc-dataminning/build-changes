...
public class asd {
   ...
   private static List<asd.b> a(final Path $$0) throws IOException {
      try {
         final List<asd.b> $$1 = new ArrayList<>();
   ...
   private static List<asd.a> a(List<asd.b> $$0) {
      List<asd.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (asd.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new asd.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<asd.a> a = Comparator.comparing(asd.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<asd.b> a = Comparator.comparing(asd.b::b).reversed();
