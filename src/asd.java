...
public class asd {
   ...
   private static void a(asi $$0, arg $$1, dwg $$2) {
      $$0.b(new adl($$2, $$1.x_(), null, null));
      dcy $$3 = $$2.f();
      agn.a($$1, $$3);
   }

   private List<dwg> a(aqm $$0, dcy $$1) {
      int $$2 = azc.d(this.i);
      List<dwg> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : azc.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
