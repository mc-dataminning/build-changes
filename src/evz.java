...
public class evz implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<evz.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public evz(List<evz.a> $$0) {
      this.c = $$0;
   }
   ...
   public static evz a(BufferedReader $$0) {
      return new evz($$0.lines().flatMap($$0x -> evz.a.a($$0x).stream()).toList());
   }

   public static record a(evz.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<evz.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new evz.a(evz.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new evz.a(evz.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new evz.a(evz.b.b, $$3));
      ...
      static evz.a b(String $$0) {
         return new evz.a(evz.b.a, "glob:" + $$0);
      }

      static evz.a c(String $$0) {
         return new evz.a(evz.b.a, "regex:" + $$0);
      }

      static evz.a d(String $$0) {
         return new evz.a(evz.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      evz.b a = FileSystem::getPathMatcher;
      evz.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
