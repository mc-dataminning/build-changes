...
public class big implements bhz {
   ...
   public static Set<bhx> a() {
      Builder<bhx> $$0 = ImmutableSet.builder();

      try {
         big.a $$1 = new big.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bhx.a("cpu#" + $$1x, bhw.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bhx.a("heap MiB", bhw.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bhy.a.a());
      return $$0.build();
   }
   ...
   public static bhx a(final LongSupplier $$0) {
      ...
      bhx.d $$3 = new bhx.d(2.0F);
      return bhx.a("ticktime", bhw.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
