...
public interface big<T, F> {
   ...
   public static final class a implements big<big.b, Runnable> {
   ...
   public static final class c<T> implements big<T, T> {
