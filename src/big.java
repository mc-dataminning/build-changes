...
public abstract class big extends bjk {
   private static final aec<Boolean> bT = aef.a(big.class, aee.k);
   ...
   protected big(bip<? extends big> $$0, cpq $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract big a(akn var1, big var2);
   ...
   @Override
   protected void m() {
      if (!this.i_() && this.bN() && this.cY() instanceof cdi $$0 && !$$0.a((bil)this)) {
         this.aa();
      }
   }
