...
public abstract class big extends DataFix {
   ...
   public big(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bhu.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bhu.B);
      Type<Pair<String, String>> $$2 = DSL.named(bhu.z.typeName(), bji.a());
      if (!Objects.equals(this.getOutputSchema().getType(bhu.z), $$2)) {
