...
public class hke {
   ...
   public static class a extends Thread {
      private final hke.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hke.b $$0) throws IOException {
         super("LanServerDetector #" + hke.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hke.b));
   ...
   public static class b {
      private final List<hkd> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hkd> a() {
         if (this.b) {
            List<hkd> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
