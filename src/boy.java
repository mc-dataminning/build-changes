...
public class boy {
   ...
   private static void a(bpg $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bpb $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dxp, bpk<bpa>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bpk)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ad.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dxp, bpk<bpa>> $$3 : $$0) {
         bpk<bpa> $$4 = (bpk<bpa>)$$3.getSecond();
         JsonObject $$5 = ad.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dxp)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bpi> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bon.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bow $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), boy::a));
      $$1.add("chunksWritten", this.a($$0.m(), boy::a));
      return $$1;
   }

   private JsonElement a(bpd.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bow $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), boy::a));
      $$1.add("received", this.a($$0.k(), boy::a));
      return $$1;
   }

   private <T> JsonElement a(bpf<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bpc> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bpc>, ToDoubleFunction<bpc>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bpc::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bpc::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bpc::c));
      return $$1;
   }
}
