...
public class boy implements boz {
   ...
   private static final boy k = new boy();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(box $$0) {
      URL $$1 = boy.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, box $$1) {
      if (this.c()) {
         ...
         try {
            ...
            this.l = ae.a(new Recording($$2), $$2x -> {
               h.forEach($$2x::enable);
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bpb a = new bpb(() -> boy.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == boy.this.l && $$0.getState() == RecordingState.STOPPED) {
