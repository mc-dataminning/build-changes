...
public interface boy<T, F> {
   ...
   public static final class a implements boy<boy.b, Runnable> {
   ...
   public static final class c<T> implements boy<T, T> {
