...
public class flb {
   ...
   public void a(flm $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == flm.a) {
            frd.b($$1, frd.a.a, wp.c("narrator.toast.disabled"), null);
         } else {
            frd.b($$1, frd.a.a, wp.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         frd.b($$1, frd.a.a, wp.c("narrator.toast.disabled"), wp.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new flb.a("Narrator library is not active");
      }
   }
