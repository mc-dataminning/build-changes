...
public class flb extends fkt {
   private static final Logger a = LogUtils.getLogger();
   private static final akf b = new akf("textures/misc/credits_vignette.png");
   private static final ws c = ws.b("============").a(n.p);
   ...
   private int F;
   private final ffl G = new ffl(false);

   public flb(boolean $$0, Runnable $$1) {
      super(fcm.a);
      this.v = $$0;
      this.w = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, flb.a $$1) {
      try (Reader $$2 = this.m.ab().openAsReader(new akf($$0))) {
         $$1.read($$2);
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : axm.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(ws.b($$4).a(n.o), true);
         this.a(c, true);
         this.D();
         this.D();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(ws.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(ws.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.y.addAll(this.m.h.c(ws.b($$0), 256));
   }

   private void a(ws $$0, boolean $$1) {
      if ($$1) {
