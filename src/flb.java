public class flb extends flw {
   private final flr a;

   flb(fie $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, flr $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cbl $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dr();
            if (this.h > $$1) {
   ...
   public static class b implements fkz<iz> {
      ...
      public fkw a(iz $$0, fie $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fkw $$8 = new flb($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
