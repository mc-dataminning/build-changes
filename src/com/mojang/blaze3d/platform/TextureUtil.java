...
public class TextureUtil {
   ...
   public static void prepareImage(int $$0, int $$1, int $$2) {
      prepareImage(ezp.b.a, $$0, 0, $$1, $$2);
   }

   public static void prepareImage(ezp.b $$0, int $$1, int $$2, int $$3) {
      prepareImage($$0, $$1, 0, $$2, $$3);
   }

   public static void prepareImage(int $$0, int $$1, int $$2, int $$3) {
      prepareImage(ezp.b.a, $$0, $$1, $$2, $$3);
   }

   public static void prepareImage(ezp.b $$0, int $$1, int $$2, int $$3, int $$4) {
      RenderSystem.assertOnRenderThreadOrInit();
      bind($$1);
      if ($$2 >= 0) {
