...
public class GlStateManager {
   ...
   public static void upload(int $$0, int $$1, int $$2, int $$3, int $$4, eou.a $$5, IntBuffer $$6, Consumer<IntBuffer> $$7) {
   ...
   private static void _upload(int $$0, int $$1, int $$2, int $$3, int $$4, eou.a $$5, IntBuffer $$6, Consumer<IntBuffer> $$7) {
      try {
         RenderSystem.assertOnRenderThreadOrInit();
         _pixelStore(3314, $$3);
         _pixelStore(3316, 0);
