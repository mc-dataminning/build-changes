...
public class GLX {
   ...
   public static int _getRefreshRate(fev $$0) {
      RenderSystem.assertOnRenderThread();
   ...
   public static boolean _shouldClose(fev $$0) {
   ...
   public static void _renderCrosshair(int $$0, boolean $$1, boolean $$2, boolean $$3) {
      if ($$1 || $$2 || $$3) {
         ...
         RenderSystem.setShader(glg.X);
         ffu $$4 = RenderSystem.renderThreadTesselator();
         ffn $$5 = $$4.a(ffx.c.a, ffq.g);
