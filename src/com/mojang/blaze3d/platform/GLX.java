...
public class GLX {
   ...
   public static int _getRefreshRate(fht $$0) {
      RenderSystem.assertOnRenderThread();
   ...
   public static boolean _shouldClose(fht $$0) {
   ...
   public static void _renderCrosshair(int $$0, boolean $$1, boolean $$2, boolean $$3) {
      if ($$1 || $$2 || $$3) {
         ...
         RenderSystem.setShader(gon.X);
         fis $$4 = RenderSystem.renderThreadTesselator();
         fil $$5 = $$4.a(fiv.c.a, fio.g);
