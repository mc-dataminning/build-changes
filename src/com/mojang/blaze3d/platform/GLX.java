...
public class GLX {
   ...
   public static int _getRefreshRate(fex $$0) {
      RenderSystem.assertOnRenderThread();
   ...
   public static boolean _shouldClose(fex $$0) {
   ...
   public static void _renderCrosshair(int $$0, boolean $$1, boolean $$2, boolean $$3) {
      if ($$1 || $$2 || $$3) {
         ...
         RenderSystem.setShader(gli.X);
         ffw $$4 = RenderSystem.renderThreadTesselator();
         ffp $$5 = $$4.a(ffz.c.a, ffs.g);
