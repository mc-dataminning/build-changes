...
public class GLX {
   ...
   public static int _getRefreshRate(fch $$0) {
      RenderSystem.assertOnRenderThread();
   ...
   public static boolean _shouldClose(fch $$0) {
   ...
   public static void _renderCrosshair(int $$0, boolean $$1, boolean $$2, boolean $$3) {
      if ($$1 || $$2 || $$3) {
         ...
         RenderSystem.setShader(ggq.W);
         fdg $$4 = RenderSystem.renderThreadTesselator();
         fcz $$5 = $$4.a(fdj.c.a, fdc.g);
