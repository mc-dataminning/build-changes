...
public class GLX {
   ...
   public static int _getRefreshRate(ffv $$0) {
      RenderSystem.assertOnRenderThread();
   ...
   public static boolean _shouldClose(ffv $$0) {
   ...
   public static void _renderCrosshair(int $$0, boolean $$1, boolean $$2, boolean $$3) {
      if ($$1 || $$2 || $$3) {
         ...
         RenderSystem.setShader(gkv.X);
         fgu $$4 = RenderSystem.renderThreadTesselator();
         fgn $$5 = $$4.a(fgx.c.a, fgq.g);
