...
public class GLX {
   ...
   public static int _getRefreshRate(ffo $$0) {
      RenderSystem.assertOnRenderThread();
   ...
   public static boolean _shouldClose(ffo $$0) {
   ...
   public static void _renderCrosshair(int $$0, boolean $$1, boolean $$2, boolean $$3) {
      if ($$1 || $$2 || $$3) {
         ...
         RenderSystem.setShader(gko.W);
         fgn $$4 = RenderSystem.renderThreadTesselator();
         fgg $$5 = $$4.a(fgq.c.a, fgj.g);
