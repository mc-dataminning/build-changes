...
public class GLX {
   ...
   public static int _getRefreshRate(fgr $$0) {
      RenderSystem.assertOnRenderThread();
   ...
   public static boolean _shouldClose(fgr $$0) {
   ...
   public static void _renderCrosshair(int $$0, boolean $$1, boolean $$2, boolean $$3) {
      if ($$1 || $$2 || $$3) {
         ...
         RenderSystem.setShader(gnj.X);
         fhq $$4 = RenderSystem.renderThreadTesselator();
         fhj $$5 = $$4.a(fht.c.a, fhm.g);
