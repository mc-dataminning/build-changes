...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<eju> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final elm RENDER_THREAD_TESSELATOR = new elm();
   ...
   private static els vertexSorting = els.a;
   private static els savedVertexSorting = els.a;
   private static final elk modelViewStack = new elk();
   ...
   public static void recordRenderCall(eju $$0) {
   ...
   public static void setShaderFogShape(ekx $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(ekx $$0) {
      shaderFogShape = $$0;
   }

   public static ekx getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(fom $$0) {
      assertOnRenderThread();
      if ($$0.h != null) {
   ...
   public static aso.a initBackendSystem() {
      assertInInitPhase();
   ...
   public static elm renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<fom> $$0) {
      if (!isOnRenderThread()) {
   ...
   @Nullable
   public static fom getShader() {
      assertOnRenderThread();
      return shader;
   }

   public static void setShaderTexture(int $$0, aeu $$1) {
      if (!isOnRenderThread()) {
   ...
   public static void _setShaderTexture(int $$0, aeu $$1) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, els $$1) {
   ...
   public static elk getModelViewStack() {
   ...
   public static RenderSystem.a getSequentialBuffer(elp.b $$0) {
      assertOnRenderThread();
   ...
   public static els getVertexSorting() {
      assertOnRenderThread();
