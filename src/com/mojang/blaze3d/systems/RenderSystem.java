...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<eoj> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final eqb RENDER_THREAD_TESSELATOR = new eqb(1536);
   ...
   private static eqh vertexSorting = eqh.a;
   private static eqh savedVertexSorting = eqh.a;
   private static final epz modelViewStack = new epz();
   ...
   public static void recordRenderCall(eoj $$0) {
   ...
   public static void setShaderFogShape(epm $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(epm $$0) {
      shaderFogShape = $$0;
   }

   public static epm getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(ftt $$0) {
      assertOnRenderThread();
      if ($$0.h != null) {
   ...
   public static eqb renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<ftt> $$0) {
      if (!isOnRenderThread()) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, eqh $$1) {
   ...
   public static epz getModelViewStack() {
   ...
   public static RenderSystem.a getSequentialBuffer(eqe.b $$0) {
      assertOnRenderThread();
   ...
   public static eqh getVertexSorting() {
      assertOnRenderThread();
