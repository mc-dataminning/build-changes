...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<eyk> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final fac RENDER_THREAD_TESSELATOR = new fac(1536);
   ...
   private static fai vertexSorting = fai.a;
   private static fai savedVertexSorting = fai.a;
   ...
   public static void recordRenderCall(eyk $$0) {
   ...
   public static void setShaderFogShape(ezn $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(ezn $$0) {
      shaderFogShape = $$0;
   }

   public static ezn getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(gee $$0) {
      assertOnRenderThread();
      if ($$0.g != null) {
   ...
   public static azy.a initBackendSystem() {
      assertInInitPhase();
   ...
   public static fac renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<gee> $$0) {
      if (!isOnRenderThread()) {
   ...
   @Nullable
   public static gee getShader() {
      assertOnRenderThread();
      return shader;
   }

   public static void setShaderTexture(int $$0, alf $$1) {
      if (!isOnRenderThread()) {
   ...
   public static void _setShaderTexture(int $$0, alf $$1) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, fai $$1) {
   ...
   public static RenderSystem.a getSequentialBuffer(faf.b $$0) {
      assertOnRenderThread();
   ...
   public static fai getVertexSorting() {
      assertOnRenderThread();
