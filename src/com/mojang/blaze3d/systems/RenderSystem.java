...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<eqk> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final esc RENDER_THREAD_TESSELATOR = new esc(1536);
   ...
   private static esi vertexSorting = esi.a;
   private static esi savedVertexSorting = esi.a;
   private static final esa modelViewStack = new esa();
   ...
   private static ern shaderFogShape = ern.a;
   ...
   public static void recordRenderCall(eqk $$0) {
   ...
   public static void setShaderFogShape(ern $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(ern $$0) {
      shaderFogShape = $$0;
   }

   public static ern getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static esc renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setProjectionMatrix(Matrix4f $$0, esi $$1) {
   ...
   public static esa getModelViewStack() {
   ...
   public static RenderSystem.a getSequentialBuffer(esf.b $$0) {
      assertOnRenderThread();
   ...
   public static esi getVertexSorting() {
      assertOnRenderThread();
