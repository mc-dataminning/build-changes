...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<eok> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final eqc RENDER_THREAD_TESSELATOR = new eqc(1536);
   ...
   private static eqi vertexSorting = eqi.a;
   private static eqi savedVertexSorting = eqi.a;
   private static final eqa modelViewStack = new eqa();
   ...
   public static void recordRenderCall(eok $$0) {
   ...
   public static void setShaderFogShape(epn $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(epn $$0) {
      shaderFogShape = $$0;
   }

   public static epn getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(ftu $$0) {
      assertOnRenderThread();
      if ($$0.h != null) {
   ...
   public static avn.a initBackendSystem() {
      assertInInitPhase();
   ...
   public static eqc renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<ftu> $$0) {
      if (!isOnRenderThread()) {
   ...
   @Nullable
   public static ftu getShader() {
      assertOnRenderThread();
      return shader;
   }

   public static void setShaderTexture(int $$0, ahg $$1) {
      if (!isOnRenderThread()) {
   ...
   public static void _setShaderTexture(int $$0, ahg $$1) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, eqi $$1) {
   ...
   public static eqa getModelViewStack() {
   ...
   public static RenderSystem.a getSequentialBuffer(eqf.b $$0) {
      assertOnRenderThread();
   ...
   public static eqi getVertexSorting() {
      assertOnRenderThread();
