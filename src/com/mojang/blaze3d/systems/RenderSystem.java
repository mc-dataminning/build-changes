...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<esl> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final eud RENDER_THREAD_TESSELATOR = new eud(1536);
   ...
   private static euj vertexSorting = euj.a;
   private static euj savedVertexSorting = euj.a;
   ...
   public static void recordRenderCall(esl $$0) {
   ...
   public static void setShaderFogShape(eto $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(eto $$0) {
      shaderFogShape = $$0;
   }

   public static eto getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(fyg $$0) {
      assertOnRenderThread();
      if ($$0.g != null) {
   ...
   public static eud renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<fyg> $$0) {
      if (!isOnRenderThread()) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, euj $$1) {
   ...
   public static RenderSystem.a getSequentialBuffer(eug.b $$0) {
      assertOnRenderThread();
   ...
   public static euj getVertexSorting() {
      assertOnRenderThread();
