...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<emg> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final eny RENDER_THREAD_TESSELATOR = new eny(1536);
   ...
   private static eoe vertexSorting = eoe.a;
   private static eoe savedVertexSorting = eoe.a;
   private static final enw modelViewStack = new enw();
   ...
   public static void recordRenderCall(emg $$0) {
   ...
   public static void setShaderFogShape(enj $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(enj $$0) {
      shaderFogShape = $$0;
   }

   public static enj getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(fri $$0) {
      assertOnRenderThread();
      if ($$0.h != null) {
   ...
   public static auk.a initBackendSystem() {
      assertInInitPhase();
   ...
   public static eny renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<fri> $$0) {
      if (!isOnRenderThread()) {
   ...
   @Nullable
   public static fri getShader() {
      assertOnRenderThread();
      return shader;
   }

   public static void setShaderTexture(int $$0, agi $$1) {
      if (!isOnRenderThread()) {
   ...
   public static void _setShaderTexture(int $$0, agi $$1) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, eoe $$1) {
   ...
   public static enw getModelViewStack() {
   ...
   public static RenderSystem.a getSequentialBuffer(eob.b $$0) {
      assertOnRenderThread();
   ...
   public static eoe getVertexSorting() {
      assertOnRenderThread();
