...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<ejt> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final ell RENDER_THREAD_TESSELATOR = new ell();
   ...
   private static elr vertexSorting = elr.a;
   private static elr savedVertexSorting = elr.a;
   private static final elj modelViewStack = new elj();
   ...
   public static void recordRenderCall(ejt $$0) {
   ...
   public static void setShaderFogShape(ekw $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(ekw $$0) {
      shaderFogShape = $$0;
   }

   public static ekw getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(fon $$0) {
      assertOnRenderThread();
      if ($$0.h != null) {
   ...
   public static asy.a initBackendSystem() {
      assertInInitPhase();
   ...
   public static ell renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<fon> $$0) {
      if (!isOnRenderThread()) {
   ...
   @Nullable
   public static fon getShader() {
      assertOnRenderThread();
      return shader;
   }

   public static void setShaderTexture(int $$0, aez $$1) {
      if (!isOnRenderThread()) {
   ...
   public static void _setShaderTexture(int $$0, aez $$1) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, elr $$1) {
   ...
   public static elj getModelViewStack() {
   ...
   public static RenderSystem.a getSequentialBuffer(elo.b $$0) {
      assertOnRenderThread();
   ...
   public static elr getVertexSorting() {
      assertOnRenderThread();
