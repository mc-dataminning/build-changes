...
public class RenderSystem {
   ...
   private static eks shaderFogShape = eks.a;
   ...
   public static void recordRenderCall(ejp $$0) {
   ...
   public static void setShaderFogShape(eks $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(eks $$0) {
      shaderFogShape = $$0;
   }
   ...
   public static void setupShaderLights(foh $$0) {
      assertOnRenderThread();
      if ($$0.h != null) {
   ...
   public static void setShader(Supplier<foh> $$0) {
      if (!isOnRenderThread()) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, eln $$1) {
   ...
   public static RenderSystem.a getSequentialBuffer(elk.b $$0) {
      assertOnRenderThread();
