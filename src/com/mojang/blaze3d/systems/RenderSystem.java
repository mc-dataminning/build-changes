...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<eyq> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final fai RENDER_THREAD_TESSELATOR = new fai(1536);
   ...
   private static fao vertexSorting = fao.a;
   private static fao savedVertexSorting = fao.a;
   ...
   public static void recordRenderCall(eyq $$0) {
   ...
   public static void setShaderFogShape(ezt $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(ezt $$0) {
      shaderFogShape = $$0;
   }

   public static ezt getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(gel $$0) {
      assertOnRenderThread();
      if ($$0.g != null) {
   ...
   public static fai renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<gel> $$0) {
      if (!isOnRenderThread()) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, fao $$1) {
   ...
   public static RenderSystem.a getSequentialBuffer(fal.b $$0) {
      assertOnRenderThread();
   ...
   public static fao getVertexSorting() {
      assertOnRenderThread();
