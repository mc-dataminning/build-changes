...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<eml> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final eod RENDER_THREAD_TESSELATOR = new eod(1536);
   ...
   private static eoj vertexSorting = eoj.a;
   private static eoj savedVertexSorting = eoj.a;
   private static final eob modelViewStack = new eob();
   ...
   public static void recordRenderCall(eml $$0) {
   ...
   public static void setShaderFogShape(eno $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(eno $$0) {
      shaderFogShape = $$0;
   }

   public static eno getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(frn $$0) {
      assertOnRenderThread();
      if ($$0.h != null) {
   ...
   public static auo.a initBackendSystem() {
      assertInInitPhase();
   ...
   public static eod renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<frn> $$0) {
      if (!isOnRenderThread()) {
   ...
   @Nullable
   public static frn getShader() {
      assertOnRenderThread();
      return shader;
   }

   public static void setShaderTexture(int $$0, agm $$1) {
      if (!isOnRenderThread()) {
   ...
   public static void _setShaderTexture(int $$0, agm $$1) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, eoj $$1) {
   ...
   public static eob getModelViewStack() {
   ...
   public static RenderSystem.a getSequentialBuffer(eog.b $$0) {
      assertOnRenderThread();
   ...
   public static eoj getVertexSorting() {
      assertOnRenderThread();
