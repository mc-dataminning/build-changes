...
public class RenderSystem {
   ...
   private static final ConcurrentLinkedQueue<eyh> recordingQueue = Queues.newConcurrentLinkedQueue();
   private static final ezz RENDER_THREAD_TESSELATOR = new ezz(1536);
   ...
   private static faf vertexSorting = faf.a;
   private static faf savedVertexSorting = faf.a;
   ...
   public static void recordRenderCall(eyh $$0) {
   ...
   public static void setShaderFogShape(ezk $$0) {
      assertOnRenderThread();
      _setShaderFogShape($$0);
   }

   private static void _setShaderFogShape(ezk $$0) {
      shaderFogShape = $$0;
   }

   public static ezk getShaderFogShape() {
      assertOnRenderThread();
   ...
   public static void setupShaderLights(geb $$0) {
      assertOnRenderThread();
      if ($$0.g != null) {
   ...
   public static azx.a initBackendSystem() {
      assertInInitPhase();
   ...
   public static ezz renderThreadTesselator() {
      assertOnRenderThread();
   ...
   public static void setShader(Supplier<geb> $$0) {
      if (!isOnRenderThread()) {
   ...
   public static void _setShaderTexture(int $$0, ale $$1) {
   ...
   public static void setProjectionMatrix(Matrix4f $$0, faf $$1) {
   ...
   public static RenderSystem.a getSequentialBuffer(fac.b $$0) {
      assertOnRenderThread();
   ...
   public static faf getVertexSorting() {
      assertOnRenderThread();
