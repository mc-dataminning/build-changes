...
public class gyy implements gzb.a, AutoCloseable {
   ...
   fdr[] f;
   @Nullable
   private final gyy.a g;
   private final avf h;

   public gyy(alj $$0, has $$1, fdr $$2, avf $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      haq $$4 = $$3.a(haq.a).orElse(haq.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new fdr[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gyt.a(this.f, $$0);
   ...
   @Nullable
   private gyy.a a(has $$0, int $$1, int $$2, haq $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gyy.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gyy.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gyy.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gyy.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gyy.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gyy.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fdr[] $$4) {
   ...
   class a {
      ...
      a(final List<gyy.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gyy.this.c;
         int $$4 = this.b($$2) * gyy.this.d;
         gyy.this.a($$0, $$1, $$3, $$4, gyy.this.f);
      }

      public gza a() {
         return gyy.this.new d(this, this.d ? gyy.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fdr[] b = new fdr[gyy.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gyy.this.c >> $$0;
            int $$2 = gyy.this.d >> $$0;
            this.b[$$0] = new fdr($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gyy.d $$2) {
         gyy.a $$3 = $$2.c;
         List<gyy.b> $$4 = $$3.b;
         gyy.b $$5 = $$4.get($$2.a);
            ...
            for (int $$9 = 0; $$9 < this.b.length; $$9++) {
               ...
               for (int $$12 = 0; $$12 < $$11; $$12++) {
                  for (int $$13 = 0; $$13 < $$10; $$13++) {
                     ...
                     this.b[$$9].a($$13, $$12, axx.a($$6, $$14, $$15));
                  }
               }
            }

            gyy.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gyy.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gyy.this.f[$$2].a($$3 + ($$0.a($$1) * gyy.this.c >> $$2), $$4 + ($$0.b($$1) * gyy.this.d >> $$2));
      }
   ...
   class d implements gza {
      ...
      final gyy.a c;
      @Nullable
      private final gyy.c d;

      d(final gyy.a $$0, @Nullable final gyy.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
