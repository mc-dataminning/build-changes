...
public class drk {
   ...
   final boolean g;
   private final ayk<dkm> h;
   private final int i;
   private final int j;
   private final int k;
   private final int l;
   private List<drk.a> m = new ArrayList<>();
   private static final Logger n = LogUtils.getLogger();

   public drk(boolean $$0, ayk<dkm> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.j = $$3;
   ...
   public static drk a() {
      return new drk(false, axu.bU, 10, 4, 10, 5);
   }

   public static drk b() {
      return new drk(true, axu.bV, 50, 1, 5, 10);
   }
   ...
   public void a(ux $$0) {
      if ($$0.b("cursors", 9)) {
         this.m.clear();
         List<drk.a> $$1 = (List<drk.a>)drk.a.b.listOf().parse(new Dynamic(vl.a, $$0.c("cursors", 10))).resultOrPartial(n::error).orElseGet(ArrayList::new);
   ...
   public void b(ux $$0) {
      drk.a.b.listOf().encodeStart(vl.a, this.m).resultOrPartial(n::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(jh $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new drk.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(drk.a $$0) {
      if (this.m.size() < 32) {
         this.m.add($$0);
      }
   }

   public void a(dhj $$0, jh $$1, bam $$2, boolean $$3) {
      if (!this.m.isEmpty()) {
         List<drk.a> $$4 = new ArrayList<>();
         Map<jh, drk.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<drk.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  jh.a.fieldOf("pos").forGetter(drk.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(drk.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(drk.a::c),
      ...
      private boolean a(dhj $$0, jh $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(dhj $$0, jh $$1, bam $$2, drk $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.g)) {
            if (this.f > 0) {
               this.f--;
            } else {
      ...
      private static drf a(dxv $$0) {
         return $$0.b() instanceof drf $$1 ? $$1 : drf.u_;
      }
      ...
      @Nullable
      private static jh a(dhj $$0, jh $$1, bam $$2) {
         jh.a $$3 = $$1.k();
         jh.a $$4 = $$1.k();
      ...
      private static boolean a(dhj $$0, jh $$1, jh $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            jh $$3 = $$2.b($$1);
      ...
      private static boolean a(dhj $$0, jh $$1, jm $$2) {
         jh $$3 = $$1.a($$2);
