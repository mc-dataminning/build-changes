...
public class fee extends feo {
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fib.Q().al();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fgl.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fib.Q().b($$4)) {
               try {
