...
public class fee implements AutoCloseable {
   private final fee.a a;
   private int b;
   private int c;
   private int d;
   @Nullable
   ...
   private feg a(fea.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(fea.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
         GlStateManager._glBindBuffer(34963, this.c);
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, @Nullable ghq $$2) {
      if ($$2 != null) {
         RenderSystem.assertOnRenderThread();
         $$2.a(this.i, $$0, $$1, fji.Q().aO());
         $$2.b();
         this.c();
         $$2.a();
      }
