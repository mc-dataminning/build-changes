...
public final class fee {
   ...
   public boolean l;
   private final List<fee.a> m;
   private final Map<String, fee> n;
   private feg o = feg.a;

   public fee(List<fee.a> $$0, Map<String, fee> $$1) {
      this.m = $$0;
      this.n = $$1;
   }
   ...
   public void a(eij $$0, fee.d $$1) {
      this.a($$0, $$1, "");
   }

   private void a(eij $$0, fee.d $$1, String $$2) {
      if (!this.m.isEmpty() || !this.n.isEmpty()) {
         $$0.a();
         this.a($$0);
         eij.a $$3 = $$0.c();
   ...
   public static class a {
      ...
      public a(
         ...
         fee.c $$19 = new fee.c($$2, $$3, $$4, 0.0F, 0.0F);
         fee.c $$20 = new fee.c($$15, $$3, $$4, 0.0F, 8.0F);
         fee.c $$21 = new fee.c($$15, $$16, $$4, 8.0F, 8.0F);
         fee.c $$22 = new fee.c($$2, $$16, $$4, 8.0F, 0.0F);
         fee.c $$23 = new fee.c($$2, $$3, $$17, 0.0F, 0.0F);
         fee.c $$24 = new fee.c($$15, $$3, $$17, 0.0F, 8.0F);
         fee.c $$25 = new fee.c($$15, $$16, $$17, 8.0F, 8.0F);
         fee.c $$26 = new fee.c($$2, $$16, $$17, 8.0F, 0.0F);
         float $$27 = (float)$$0;
         float $$28 = (float)$$0 + $$7;
         ...
         int $$36 = 0;
         if ($$14.contains(ha.a)) {
            this.g[$$36++] = new fee.b(new fee.c[]{$$24, $$23, $$19, $$20}, $$28, $$33, $$29, $$34, $$12, $$13, $$11, ha.a);
         }

         if ($$14.contains(ha.b)) {
            this.g[$$36++] = new fee.b(new fee.c[]{$$21, $$22, $$26, $$25}, $$29, $$34, $$30, $$33, $$12, $$13, $$11, ha.b);
         }

         if ($$14.contains(ha.e)) {
            this.g[$$36++] = new fee.b(new fee.c[]{$$19, $$23, $$26, $$22}, $$27, $$34, $$28, $$35, $$12, $$13, $$11, ha.e);
         }

         if ($$14.contains(ha.c)) {
            this.g[$$36++] = new fee.b(new fee.c[]{$$20, $$19, $$22, $$21}, $$28, $$34, $$29, $$35, $$12, $$13, $$11, ha.c);
         }

         if ($$14.contains(ha.f)) {
            this.g[$$36++] = new fee.b(new fee.c[]{$$24, $$20, $$21, $$25}, $$29, $$34, $$31, $$35, $$12, $$13, $$11, ha.f);
         }

         if ($$14.contains(ha.d)) {
            this.g[$$36] = new fee.b(new fee.c[]{$$23, $$24, $$25, $$26}, $$31, $$34, $$32, $$35, $$12, $$13, $$11, ha.d);
         }
      }
   ...
   static class b {
      public final fee.c[] a;
      public final Vector3f b;

      public b(fee.c[] $$0, float $$1, float $$2, float $$3, float $$4, float $$5, float $$6, boolean $$7, ha $$8) {
         this.a = $$0;
         float $$9 = 0.0F / $$5;
         float $$10 = 0.0F / $$6;
   ...
   static class c {
      ...
      public fee.c a(float $$0, float $$1) {
         return new fee.c(this.a, $$0, $$1);
      }
   ...
   @FunctionalInterface
   public interface d {
      void visit(eij.a var1, String var2, int var3, fee.a var4);
   }
}
