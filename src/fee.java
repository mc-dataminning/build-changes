...
public class fee {
   ...
   public static List<fee.a> a(String $$0, fee.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fee.a> a(String $$0, List<fee.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fee.a> a(List<String> $$0, List<fee.b> $$1) {
      int $$2 = 0;
      List<fee.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fee.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fee.b a(String $$0, String $$1) {
         return new fee.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fee.b a(String $$0) {
         return new fee.b($$0);
      }
   }
}
