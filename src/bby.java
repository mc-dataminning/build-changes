...
public class bby extends ber {
   public bby(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bfs.z, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bfs.B.typeName(), bhc.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bfs.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bfs.B.typeName(), "minecraft:saddle"));
