...
public abstract class bby extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$1 = DSL.named(bhv.C.typeName(), bjj.a());
      if (!Objects.equals($$0, $$1)) {
         ...
         TypeRewriteRule $$3 = this.fixTypeEverywhereTyped(
            this.a + " for block_state", this.getInputSchema().getType(bhv.u), $$0x -> $$0x.update(DSL.remainderFinder(), this::a)
         );
         TypeRewriteRule $$4 = this.fixTypeEverywhereTyped(
            this.a + " for flat_block_state",
            this.getInputSchema().getType(bhv.v),
            $$0x -> $$0x.update(
