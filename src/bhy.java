...
public abstract class bhy extends DataFix {
   private final String a;

   public bhy(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bhm.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bhm.B);
      Type<Pair<String, String>> $$2 = DSL.named(bhm.z.typeName(), biz.a());
      if (!Objects.equals(this.getOutputSchema().getType(bhm.z), $$2)) {
