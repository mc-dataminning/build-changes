public class gjg extends giy<cnn> {
   ...
   public void a(cnn $$0, float $$1, float $$2, faa $$3, gdq $$4, int $$5) {
      cmz $$6 = $$0.u();
      if ($$6 != null) {
         $$3.a();
         $$3.a();
   ...
   private evt a(cmz $$0, float $$1, float $$2) {
      int $$3 = $$0.fu() == btl.b ? 1 : -1;
      cur $$4 = $$0.eX();
      if (!$$4.a(cuu.qV)) {
         $$3 = -$$3;
      }

      if (this.c.d.aA().a() && $$0 == ffh.Q().s) {
         double $$12 = 960.0 / (double)this.c.d.ah().c().intValue();
         evt $$13 = this.c.b.j().a((float)$$3 * 0.525F, -0.1F).a($$12).b($$1 * 0.5F).a(-$$1 * 0.7F);
         return $$0.j($$2).e($$13);
      } else {
   ...
   private static void a(fae $$0, faa.a $$1, int $$2, float $$3, int $$4, int $$5, int $$6) {
      $$0.a($$1, $$3 - 0.5F, (float)$$4 - 0.5F, 0.0F).a(255, 255, 255, 255).a((float)$$5, (float)$$6).c(gos.d).b($$2).b($$1, 0.0F, 1.0F, 0.0F).e();
   }

   private static void a(float $$0, float $$1, float $$2, fae $$3, faa.a $$4, float $$5, float $$6) {
      float $$7 = $$0 * $$5;
