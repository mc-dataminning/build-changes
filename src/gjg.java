public abstract class gjg<T extends cnd> extends gkg<T> {
   public gjg(gkh.a $$0) {
      super($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, fbg $$3, gex $$4, int $$5) {
      ...
      $$3.a(-4.0F, 0.0F, 0.0F);
      fbk $$18 = $$4.getBuffer(gff.d(this.a($$0)));
      fbg.a $$19 = $$3.c();
   ...
   public void a(fbg.a $$0, fbk $$1, int $$2, int $$3, int $$4, float $$5, float $$6, int $$7, int $$8, int $$9, int $$10) {
      $$1.a($$0, (float)$$2, (float)$$3, (float)$$4).a(-1).a($$5, $$6).b(gqa.d).c($$10).b($$0, (float)$$7, (float)$$9, (float)$$8);
   }
}
