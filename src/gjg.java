public class gjg implements gjc<dri> {
   private final gnq a;
   ...
   public void a(dri $$0, float $$1, fcu $$2, ggv $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.m().c(duq.bv);
         if ($$6 > 0) {
            jj $$7 = $$0.d();
            if ($$7 != null) {
               ...
               if (!$$8.f()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = ggr.a($$0.i(), $$0.m(), $$0.aD_().a($$7));
                  this.a.a($$8, cvi.i, $$11, gwb.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
