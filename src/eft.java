...
public abstract class eft {
   ...
   public void a(ddc $$0, eft.b $$1, ayw $$2, efd $$3, int $$4, eft.a $$5, int $$6, int $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a($$2));
   }

   protected abstract void a(ddc var1, eft.b var2, ayw var3, efd var4, int var5, eft.a var6, int var7, int var8, int var9);

   public abstract int a(ayw var1, int var2, efd var3);
   ...
   protected void a(ddc $$0, eft.b $$1, ayw $$2, efd $$3, jd $$4, int $$5, int $$6, boolean $$7) {
      int $$8 = $$7 ? 1 : 0;
      jd.a $$9 = new jd.a();
   ...
   protected final void a(ddc $$0, eft.b $$1, ayw $$2, efd $$3, jd $$4, int $$5, int $$6, boolean $$7, float $$8, float $$9) {
   ...
   private static boolean a(ddc $$0, eft.b $$1, ayw $$2, efd $$3, float $$4, jd $$5, jd.a $$6) {
      if ($$6.k($$5) >= 7) {
         return false;
      } else {
   ...
   protected static boolean a(ddc $$0, eft.b $$1, ayw $$2, efd $$3, jd $$4) {
      if (!edp.c($$0, $$4)) {
         return false;
      } else {
         dtc $$5 = $$3.e.a($$2, $$4);
         if ($$5.b(dts.C)) {
            $$5 = $$5.a(dts.C, Boolean.valueOf($$0.b($$4, $$0x -> $$0x.a(epd.c))));
         }
