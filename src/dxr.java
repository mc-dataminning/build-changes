...
public class dxr {
   ...
   public dxr(dhh $$0, jh $$1, jm $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dxu $$0 = this.b.a_(this.e);
      if (!dxn.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == eub.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dxu $$0) {
      return $$0.a(dkn.im) || $$0.a(dkn.pB);
   }

   private static boolean a(dxu $$0, dxu $$1) {
      if ($$0.a(dkn.pB) && $$1.a(dkn.im)) {
         return false;
      } else {
         return $$0.a(dkn.im) && $$1.a(dkn.pB) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(jh $$0, jm $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!dxn.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dxu $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !dxn.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dxn.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
