...
public interface jn<T> {
   ...
   public static class c<T> implements jn<T> {
      ...
      protected c(jn.c.a $$0, jq<T> $$1, @Nullable ala<T> $$2, @Nullable T $$3) {
         this.a = $$1;
         this.c = $$0;
         this.d = $$2;
         this.e = $$3;
      ...
      public static <T> jn.c<T> a(jq<T> $$0, ala<T> $$1) {
