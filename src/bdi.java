...
public class bdi extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bga.z);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bdi::c), this.a("minecraft:arrow", bdi::a), this.a("minecraft:spectral_arrow", bdi::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bdi.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bga.z, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bga.z, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bdi.a<?> $$1, Type<?> $$2, Type<T> $$3) {
