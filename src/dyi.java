...
public class dyi extends dxv<dzs> {
   public dyi(Codec<dzs> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dxx<dzs> $$0) {
      ib $$1 = $$0.e();
      czs $$2 = $$0.b();
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? axk.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(axr $$0, cyy $$1, int $$2, int $$3, ib $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, ib $$2, cyy $$3, boolean $$4, double $$5, ib $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(cyy $$0, ib $$1) {
      if ($$0.a_($$1.c()).a(dca.dN)) {
         this.a($$0, $$1.c(), dca.a.n());
      }
   }

   private void a(cyy $$0, axr $$1, ib $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, doz $$13) {
   ...
   private void a(ib $$0, cyy $$1, axr $$2, int $$3, int $$4, boolean $$5, boolean $$6, doz $$7) {
      doz $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(dca.dP) || $$8.a(dca.dO) || $$8.a(dca.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dca.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dca.dP.n());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, ib $$2, int $$3, axr $$4) {
      float $$5 = 10.0F * axk.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(axr $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(axr $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(doz $$0) {
      return $$0.a(dca.iC) || $$0.a(dca.dP) || $$0.a(dca.mW);
   }
   ...
   private void a(cyy $$0, ib $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dca.dN)) {
                  if (this.a((cyd)$$0, $$10)) {
                     this.a($$0, $$10, dca.a.n());
                     this.a($$0, $$10.c(), dca.a.n());
                  } else if (c($$11)) {
                     doz[] $$12 = new doz[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
