...
public class fct extends gvm {
   ...
   public void aO_() {
      this.B.a(a, this.o);
      this.C = this.B.c(new fct.a(this.l));
      this.B.b(fhm.a(wt.k, $$0 -> this.d()).a());
      this.c();
      this.B.a($$1 -> {
   ...
   private wu a(String $$0) {
      try {
         return fdp.a.get(Integer.parseInt($$0)).b();
   ...
   private wu b(String $$0) {
      try {
         return fdp.b.get(Integer.parseInt($$0)).e();
      } catch (Exception var3) {
         return b;
      }
   }

   class a extends fii<fct.b> {
      public a(final ffn $$0) {
         super($$0, fct.this.m, fct.this.B.d(), fct.this.B.c(), 36);
         if (fct.this.A.e != null) {
            fct.this.A.e.forEach(($$0x, $$1) -> this.b(fct.this.new b($$0x, $$1)));
         }
      }
   }

   class b extends fii.a<fct.b> {
      ...
      public void a(fgz $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         $$0.b(fct.this.o, this.a(this.m), $$3, $$2, -6250336);
         $$0.b(fct.this.o, fct.this.a(this.m, this.n), $$3, $$2 + 12, -1);
      }
