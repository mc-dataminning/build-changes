...
public class fct {
   ...
   private static final Queue<fct.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fct.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fct::a), fcq::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fct::a), fcq::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fct.a(this.b) + ", type=" + fct.b(this.c) + ", severity=" + fct.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
