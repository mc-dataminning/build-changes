...
public final class fct implements AutoCloseable {
   ...
   public fct(int $$0, int $$1, boolean $$2) {
      this(fct.a.a, $$0, $$1, $$2);
   }

   public fct(fct.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private fct(fct.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static fct a(InputStream $$0) throws IOException {
      return a(fct.a.a, $$0);
   }

   public static fct a(@Nullable fct.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static fct a(ByteBuffer $$0) throws IOException {
      return a(fct.a.a, $$0);
   }

   public static fct a(byte[] $$0) throws IOException {
   ...
   public static fct a(@Nullable fct.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new fct($$0 == null ? fct.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public fct a(IntUnaryOperator $$0) {
      if (this.c != fct.a.a) {
         ...
         this.j();
         fct $$1 = new fct(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (fob.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(fct $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, fct $$4) {
      this.j();
      if ($$4.c() != this.c) {
