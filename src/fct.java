...
public class fct extends fcl<chn> implements feo {
   private float x;
   private float y;
   private final fei z = new fei();
   private boolean A;
   private boolean B;

   public fct(cdu $$0) {
      super($$0.bR, $$0.fT(), ur.c("container.crafting"));
      this.l = 97;
   }
   ...
   public void C() {
      if (this.f.q.g()) {
         this.f.a(new fci(this.f.s, this.f.s.cn.y(), this.f.m.G().c()));
      } else {
         this.z.h();
      }
   }
   ...
   protected void aP_() {
      if (this.f.q.g()) {
         ...
         this.d(new evl(this.t + 104, this.h / 2 - 22, 20, 18, fei.a, $$0 -> {
            this.z.f();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(euo $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, blg $$9) {
   ...
   public static void a(euo $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, blg $$7) {
      $$0.c().a();
