public class eej {
   ...
   private int a(dll $$0, int $$1, int $$2, int $$3) {
      int $$4 = iz.c($$0.g($$1) + 1);
   ...
   public boolean a(ctd $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(ctd $$0, int $$1, int $$2, hx $$3, djp $$4, hx $$5, djp $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(ctd $$0, hx $$1, djp $$2) {
      hx.a $$3 = this.e.g($$1);
   ...
   private static boolean a(ctd $$0, hx $$1, djp $$2, hx $$3, djp $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         emv $$5 = eeq.a($$0, $$1, $$2, ic.a);
         emv $$6 = eeq.a($$0, $$3, $$4, ic.b);
         return ems.b($$5, $$6);
      }
   }
