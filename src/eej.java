...
@Deprecated
public class eej extends edu<eej.a> {
   private static final dus a = dho.nc.n();

   public eej(Codec<eej.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(edw<eej.a> $$0) {
      jf $$1 = $$0.e();
      dfg $$2 = $$0.b();
      azn $$3 = $$0.d();
      eej.a $$4 = $$0.f();
   ...
   public static record a(ehz b, ehz c) implements efy {
      public static final Codec<eej.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(ehz.a.fieldOf("fluid").forGetter(eej.a::a), ehz.a.fieldOf("barrier").forGetter(eej.a::b)).apply($$0, eej.a::new)
      );
