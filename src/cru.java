...
public class cru extends cqy {
   ...
   @Nullable
   private cyz<czn> y;
   private final List<cyz<czn>> z;

   public cru(int $$0, cmy $$1) {
      this($$0, $$1, cqh.a);
   }

   public cru(int $$0, cmy $$1, cqh $$2) {
      super(crd.v, $$0, $$1, $$2);
      this.x = $$1.l.dP();
      this.z = this.x.r().a(czc.g);
   }
   ...
   @Override
   public void m() {
      List<cyz<czn>> $$0 = this.x.r().b(czc.g, this.q, this.x);
      if ($$0.isEmpty()) {
         this.r.a(0, cur.l);
      } else {
         cyz<czn> $$1 = $$0.get(0);
         cur $$2 = $$1.b().a(this.q, this.x.H_());
         if ($$2.a(this.x.J())) {
            this.y = $$1;
            this.r.a($$1);
            this.r.a(0, $$2);
   ...
   private static OptionalInt a(czn $$0, cur $$1) {
      if ($$0.a($$1)) {
