...
public class cru extends cps {
   ...
   private final dcu v;
   private List<cyz<czu>> w = Lists.newArrayList();
   private cuo x = cuo.l;
   long y;
   final cro m;
   final cro n;
   ...
   public cru(int $$0, cmu $$1) {
      this($$0, $$1, cqe.a);
   }

   public cru(int $$0, cmu $$1, final cqe $$2) {
      super(cra.y, $$0);
      this.t = $$2;
      this.v = $$1.l.dQ();
      ...
      this.n = this.a(new cro(this.A, 1, 143, 33) {
         ...
         public void a(cmv $$0, cuo $$1) {
            ...
            $$2.a(($$0x, $$1x) -> {
               long $$2xxx = $$0x.Z();
               if (cru.this.y != $$2xxx) {
                  $$0x.a(null, $$1x, avo.Av, avp.e, 1.0F, 1.0F);
                  cru.this.y = $$2xxx;
               }
            });
            super.a($$0, $$1);
   ...
   private static czn c(bqj $$0) {
      return new czn($$0.a(0));
   }

   private void a(bqj $$0, cuo $$1) {
      this.w.clear();
      this.u.a(-1);
      this.n.f(cuo.l);
      if (!$$1.e()) {
         this.w = this.v.r().b(czd.f, c($$0), this.v);
      }
   }

   void p() {
      if (!this.w.isEmpty() && this.e(this.u.b())) {
         cyz<czu> $$0 = this.w.get(this.u.b());
         cuo $$1 = $$0.b().a(c(this.o), this.v.H_());
         if ($$1.a(this.v.J())) {
            this.A.a($$0);
            this.n.f($$1);
         } else {
   ...
   public cuo b(cmv $$0, int $$1) {
      ...
      if ($$3 != null && $$3.h()) {
         ...
         } else if (this.v.r().a(czd.f, new czn($$4), this.v).isPresent()) {
