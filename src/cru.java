...
public abstract class cru extends cso implements bwe {
   private static final alc<Boolean> h = alg.a(cru.class, ale.k);
   private static final alc<Boolean> i = alg.a(cru.class, ale.k);
   private static final alc<Integer> j = alg.a(cru.class, ale.b);
   ...
   public cru(bvr<? extends cru> $$0, dhi $$1, Supplier<cxl> $$2) {
      super($$0, $$1);
      this.aO = $$2;
      this.I = true;
   }
   ...
   public static boolean a(bvk $$0, bvk $$1) {
   ...
   public fby a(jm.a $$0, l.a $$1) {
      return bwg.j(super.a($$0, $$1));
   }

   protected abstract double b(bvn var1);
   ...
   protected fby a(bvk $$0, bvn $$1, float $$2) {
      ...
      return new fby(0.0, this.b($$1), (double)$$3).b(-this.dM() * (float) (Math.PI / 180.0));
   }
   ...
   public void l(boolean $$0) {
      ...
      this.dW().a(ls.an, this.dB() + (double)this.ae.i(), this.dD() + 0.7, this.dH() + (double)this.ae.i(), 0.0, 0.0, 0.0);
      if (this.ae.a(20) == 0) {
         this.dW().a(this.dB(), this.dD(), this.dH(), this.aW(), this.dn(), 1.0F, 0.8F + 0.4F * this.ae.i(), false);
         this.a(ecr.O, this.cX());
      }
   }
   ...
   public void h() {
      this.aG = this.aF;
      this.aF = this.F();
      if (this.aF != cru.a.b && this.aF != cru.a.c) {
         this.o = 0.0F;
      } else {
         this.o++;
      }
      ...
      if (this.di()) {
         ...
         if (this.dW().C) {
            this.J();
            this.dW().a(new ain(this.c(0), this.c(1)));
         }
      ...
      List<bvk> $$5 = this.dW().a(this, this.cR().c(0.2F, -0.01F, 0.2F), bvp.a(this));
      if (!$$5.isEmpty()) {
         boolean $$6 = !this.dW().C && !(this.cX() instanceof cpx);
   ...
   private void D() {
      if (this.dW().C) {
         ...
         this.aM = this.aL;
         this.aL = 10.0F * (float)Math.sin((double)(0.5F * (float)this.dW().ac())) * this.aK;
      } else {
         if (!this.aI) {
            this.m(0);
         }
         ...
         if ($$1 > 0) {
            ...
            if ($$2 > 0 && $$1 == 0) {
               ...
               if (this.aJ) {
                  ...
                  this.n($$3.d, this.a($$0 -> $$0 instanceof cpx) ? 2.7 : 0.6, $$3.f);
               }
            }
   ...
   @Override
   public fby cT() {
      return new fby(0.0, (double)(0.88F * this.cS()), (double)(this.dr() * 0.64F));
   }

   @Override
   public void b(bvk $$0, float $$1) {
      fby $$2 = $$0.du().d(this.du()).d().c((double)$$1 - 6.0);
      fby $$3 = this.dz();
      boolean $$4 = $$3.b($$2) > 0.0;
   ...
   public float p() {
      fbt $$0 = this.cR();
      fbt $$1 = new fbt($$0.a, $$0.b - 0.001, $$0.c, $$0.d, $$0.b, $$0.f);
      int $$2 = bae.a($$1.a) - 1;
      int $$3 = bae.c($$1.d) + 1;
      int $$4 = bae.a($$1.b) - 1;
      int $$5 = bae.c($$1.e) + 1;
         ...
         for (int $$13 = $$6; $$13 < $$7; $$13++) {
            ...
            if ($$14 != 2) {
               for (int $$15 = $$4; $$15 < $$5; $$15++) {
                  if ($$14 <= 0 || $$15 != $$4 && $$15 != $$5 - 1) {
                     $$11.d($$12, $$15, $$13);
                     dxv $$16 = this.dW().a_($$11);
                     if (!($$16.b() instanceof dts) && fcp.c($$16.g(this.dW(), $$11).a((double)$$12, (double)$$15, (double)$$13), $$8, fcc.i)) {
                        $$9 += $$16.b().g();
                        $$10++;
                     }
                  }
      ...
      for (int $$10 = $$2; $$10 < $$3; $$10++) {
         for (int $$11 = $$4; $$11 < $$5; $$11++) {
            for (int $$12 = $$6; $$12 < $$7; $$12++) {
               $$9.d($$10, $$11, $$12);
               etx $$13 = this.dW().b_($$9);
               if ($$13.a(aya.a) && $$1 < (double)((float)$$9.v() + $$13.a(this.dW(), $$9))) {
                  if (!$$13.b()) {
                     return cru.a.c;
                  }
   ...
   private void I() {
      ...
      double $$1 = 0.0;
      this.n = 0.05F;
      if (this.aG == cru.a.e && this.aF != cru.a.e && this.aF != cru.a.d) {
         this.aD = this.e(1.0);
         ...
         if (this.aF == cru.a.a) {
            ...
            this.n = 0.9F;
         } else if (this.aF == cru.a.c) {
            $$0 = -7.0E-4;
            this.n = 0.9F;
         } else if (this.aF == cru.a.b) {
            $$1 = 0.01F;
            this.n = 0.45F;
         } else if (this.aF == cru.a.e) {
            this.n = 0.9F;
         } else if (this.aF == cru.a.d) {
            this.n = this.aE;
            if (this.cX() instanceof cpx) {
               this.aE /= 2.0F;
            }
         }
   ...
   private void J() {
      if (this.ca()) {
         ...
         this.h(this.dz().b((double)(bae.a(-this.dM() * (float) (Math.PI / 180.0)) * $$0), 0.0, (double)(bae.b(this.dM() * (float) (Math.PI / 180.0)) * $$0)));
   ...
   protected void a(bvk $$0, bvk.a $$1) {
      ...
      if (!$$0.aq().a(axy.s)) {
         ...
         $$0.q($$0.cA() + this.p);
         this.c($$0);
         if ($$0 instanceof chx && this.cZ().size() == this.t()) {
            int $$2 = $$0.ar() % 2 == 0 ? 90 : 270;
            $$0.r(((chx)$$0).aX + (float)$$2);
            $$0.q($$0.cA() + (float)$$2);
         }
      }
   }
   ...
   @Override
   public fby b(bwg $$0) {
      fby $$1 = a((double)(this.dr() * bae.g), (double)$$0.dr(), $$0.dM());
      double $$2 = this.dB() + $$1.d;
      double $$3 = this.dH() + $$1.f;
      jh $$4 = jh.a($$2, this.cR().e, $$3);
      jh $$5 = $$4.e();
      if (!this.dW().z($$5)) {
         List<fby> $$6 = Lists.newArrayList();
         double $$7 = this.dW().j($$4);
         if (csc.a($$7)) {
            $$6.add(new fby($$2, (double)$$4.v() + $$7, $$3));
         }

         double $$8 = this.dW().j($$5);
         if (csc.a($$8)) {
            $$6.add(new fby($$2, (double)$$5.v() + $$8, $$3));
         }

         UnmodifiableIterator var14 = $$0.fO().iterator();

         while (var14.hasNext()) {
            bws $$9 = (bws)var14.next();

            for (fby $$10 : $$6) {
               if (csc.a(this.dW(), $$10, $$0, $$9)) {
                  $$0.b($$9);
                  return $$10;
               }
            }
   ...
   protected void c(bvk $$0) {
      $$0.r(this.dM());
      float $$1 = bae.h($$0.dM() - this.dM());
   ...
   public btj a(cpx $$0, bti $$1) {
      ...
      if ($$2 != btj.e) {
         ...
         return (btj)($$0.fY() || !(this.o < 60.0F) || !this.dW().C && !$$0.n(this) ? btj.e : btj.a);
      }
   }
   ...
   protected void a(double $$0, boolean $$1, dxv $$2, jh $$3) {
      ...
      if (!this.bZ()) {
         if ($$1) {
            this.k();
         } else if (!this.dW().b_(this.dw().e()).a(aya.a) && $$0 < 0.0) {
            this.Z -= (float)$$0;
         }
      }
   }
   ...
   @Override
   public bwg cX() {
      return this.da() instanceof bwg $$0 ? $$0 : super.cX();
   }
   ...
   @Override
   public boolean bo() {
      return this.aF == cru.a.b || this.aF == cru.a.c;
   }

   @Override
   protected final cxl u() {
      return this.aO.get();
   }
