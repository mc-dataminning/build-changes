...
public class grh implements avw {
   private static final glo e = glo.n(alz.b("textures/misc/shadow.png"));
   private static final float f = 32.0F;
   private static final float g = 0.5F;
   private Map<bvm<?>, gri<?, ?>> h = ImmutableMap.of();
   private Map<hcf.a, gri<? extends cps, ?>> i = Map.of();
   public final hbf a;
   private dha j;
   public fli b;
   ...
   public <E extends bvf> int a(E $$0, float $$1) {
      return this.a($$0).a($$0, $$1);
   }

   public grh(flz $$0, hbf $$1, gsh $$2, gld $$3, gmh $$4, fnj $$5, fmd $$6, ged $$7, hdl $$8) {
      this.a = $$1;
      this.l = $$2;
      this.m = $$3;
      this.o = new gkx($$0, this, $$2);
      this.n = $$4;
      this.p = $$5;
      this.d = $$6;
      this.q = $$7;
   ...
   public <T extends bvf> gri<? super T, ?> a(T $$0) {
      if ($$0 instanceof gjx $$1) {
         hcf.a $$2 = $$1.d().e();
         gri<? extends cps, ?> $$3 = this.i.get($$2);
         return (gri<? super T, ?>)($$3 != null ? $$3 : this.i.get(hcf.a.b));
      } else {
         return (gri<? super T, ?>)this.h.get($$0.aq());
      }
   }

   public void a(dha $$0, fli $$1, bvf $$2) {
      this.j = $$0;
      this.b = $$1;
      this.k = $$1.f();
      this.c = $$2;
   ...
   public <E extends bvf> boolean a(E $$0, gov $$1, double $$2, double $$3, double $$4) {
      gri<? super E, ?> $$5 = this.a($$0);
      return $$5.a($$0, $$1, $$2, $$3, $$4);
   }

   public <E extends bvf> void a(E $$0, double $$1, double $$2, double $$3, float $$4, fgl $$5, gle $$6, int $$7) {
      gri<? super E, ?> $$8 = this.a($$0);
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8);
   }

   private <E extends bvf, S extends gxo> void a(E $$0, double $$1, double $$2, double $$3, float $$4, fgl $$5, gle $$6, int $$7, gri<? super E, S> $$8) {
      try {
         S $$9 = $$8.b($$0, $$4);
         fbs $$10 = $$8.a($$9);
         double $$11 = $$1 + $$10.a();
         ...
         if (this.t && !$$9.u && !flz.Q().az()) {
            a($$5, $$6.getBuffer(glo.y()), $$0, $$4, 1.0F, 1.0F, 1.0F);
         }
   ...
   private static void a(fgl $$0, bvf $$1, gle $$2) {
      bvf $$3 = c($$1);
      if ($$3 == null) {
         gpe.a($$0, $$2, "Missing", $$1.dA(), $$1.cR().e + 1.5, $$1.dG(), -65536);
      } else {
         $$0.a();
         $$0.a($$3.dA() - $$1.dA(), $$3.dC() - $$1.dC(), $$3.dG() - $$1.dG());
         a($$0, $$2.getBuffer(glo.y()), $$3, 1.0F, 0.0F, 1.0F, 0.0F);
         gly.a($$0, $$2.getBuffer(glo.y()), new Vector3f(), $$3.dy(), -256);
         $$0.b();
      }
   }

   @Nullable
   private static bvf c(bvf $$0) {
      hfp $$1 = flz.Q().V();
      if ($$1 != null) {
         ash $$2 = $$1.a($$0.dV().ah());
         if ($$2 != null) {
   ...
   private static void a(fgl $$0, fgp $$1, bvf $$2, float $$3, float $$4, float $$5, float $$6) {
      fbn $$7 = $$2.cR().d(-$$2.dA(), -$$2.dC(), -$$2.dG());
      gly.a($$0, $$1, $$7, $$4, $$5, $$6, 1.0F);
      if ($$2 instanceof ckp) {
         ...
         for (ckm $$11 : ((ckp)$$2).x()) {
            ...
            $$0.a($$12, $$13, $$14);
            gly.a($$0, $$1, $$11.cR().d(-$$11.dA(), -$$11.dC(), -$$11.dG()), 0.25F, 1.0F, 0.0F, 1.0F);
            $$0.b();
         }
      }
      ...
      if ($$2 instanceof bwb) {
         float $$15 = 0.01F;
         gly.a($$0, $$1, $$7.a, (double)($$2.cS() - 0.01F), $$7.c, $$7.d, (double)($$2.cS() + 0.01F), $$7.f, 1.0F, 0.0F, 0.0F, 1.0F);
      }
      ...
      gly.a($$0, $$1, new Vector3f(0.0F, $$2.cS(), 0.0F), $$2.g($$3).c(2.0), -16776961);
   }

   private void a(fgl $$0, gle $$1, gxo $$2, Quaternionf $$3) {
      hbe $$4 = hdq.a.c();
      hbe $$5 = hdq.b.c();
      $$0.a();
      float $$6 = $$2.q * 1.4F;
   ...
   private static void a(fgl $$0, gle $$1, gxo $$2, float $$3, float $$4, dhd $$5, float $$6) {
   ...
   private static void a(fgl.a $$0, fgp $$1, dzi $$2, dhd $$3, jh $$4, double $$5, double $$6, double $$7, float $$8, float $$9) {
      jh $$10 = $$4.e();
      dxn $$11 = $$2.a_($$10);
      if ($$11.o() != dqn.a && $$3.A($$4) > 3) {
         if ($$11.m($$2, $$10)) {
            fcm $$12 = $$11.f($$2, $$10);
            if (!$$12.c()) {
               float $$13 = glc.a($$3.G_(), $$3.A($$4));
               float $$14 = $$9 * 0.5F * $$13;
               if ($$14 >= 0.0F) {
                  if ($$14 > 1.0F) {
                     $$14 = 1.0F;
   ...
   private static void a(fgl.a $$0, fgp $$1, int $$2, float $$3, float $$4, float $$5, float $$6, float $$7) {
      ...
      $$1.a($$8.x(), $$8.y(), $$8.z(), $$2, $$6, $$7, hav.d, 15728880, 0.0F, 1.0F, 0.0F);
   }
   ...
   @Override
   public void a(avv $$0) {
      grj.a $$1 = new grj.a(this, this.l, this.m, this.n, $$0, this.q, this.r, this.p);
      this.h = grk.a($$1);
      this.i = grk.b($$1);
   }
}
