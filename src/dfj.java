...
public abstract class dfj {
   ...
   public void a(bus<?> $$0, @Nullable dgi $$1, azh $$2, ji $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!bwd.a($$7.get(), $$0, bur.c, $$13, $$0.H_())) {
                     continue;
                  }
                  ...
                  if ($$15 instanceof bvj $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, bur.c) || !$$17.a((dgl)$$0)) {
                        continue;
                     }
   ...
   public void a(@Nullable dgi $$0, ji $$1, tq $$2) {
      ...
      if ($$5) {
         ...
         this.e = dhc.c.parse(ue.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bqs::b);
      } else {
         this.e = bqs.a(this.f != null ? this.f : new dhc());
      }
   ...
   private dhc a(@Nullable dgi $$0, azh $$1, ji $$2) {
      if (this.f != null) {
         ...
         this.a($$0, $$2, this.e.b($$1).map(bqu.b::b).orElseGet(dhc::new));
         return this.f;
      }
   }
