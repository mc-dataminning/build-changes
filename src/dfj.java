...
public class dfj extends cwp {
   public static final MapCodec<dfj> a = b(dfj::new);
   public static final djx b = dcc.f;
   public static final djx c = dcc.b;
   public static final djx d = dcc.c;
   public static final djx e = dcc.d;
   public static final djx f = dcc.e;
   public static final Map<ic, djx> g = dcc.h.entrySet().stream().filter($$0 -> $$0.getKey() != ic.a).collect(ac.a());
   protected static final float h = 1.0F;
   private static final eml i = cwp.a(0.0, 15.0, 0.0, 16.0, 16.0, 16.0);
   private static final eml j = cwp.a(0.0, 0.0, 0.0, 1.0, 16.0, 16.0);
   private static final eml k = cwp.a(15.0, 0.0, 0.0, 16.0, 16.0, 16.0);
   private static final eml l = cwp.a(0.0, 0.0, 0.0, 16.0, 16.0, 1.0);
   private static final eml m = cwp.a(0.0, 0.0, 15.0, 16.0, 16.0, 16.0);
   private final Map<djg, eml> n;
   ...
   public dfj(djf.d $$0) {
      ...
      this.n = ImmutableMap.copyOf(this.E.a().stream().collect(Collectors.toMap(Function.identity(), dfj::h)));
   }
   ...
   private boolean b(csu $$0, hx $$1, ic $$2) {
      if ($$2 == ic.a) {
         return false;
      } else {
         hx $$3 = $$1.a($$2);
   ...
   public static boolean a(csu $$0, hx $$1, ic $$2) {
      return dbo.a($$0, $$2, $$1, $$0.a_($$1));
   }

   private djg i(djg $$0, csu $$1, hx $$2) {
      hx $$3 = $$2.c();
      if ($$0.c(b)) {
         ...
         if ($$3.a(4) == 0) {
            ...
            if ($$4.o().d() && !$$0.c(a($$4))) {
               ...
               if ($$2.v() > $$1.J_()) {
                  ...
                  djg $$18 = $$1.a_($$17);
                  if ($$18.i() || $$18.a(this)) {
                     djg $$19 = $$18.i() ? this.o() : $$18;
                     djg $$20 = this.a($$0, $$19, $$3);
                     if ($$19 != $$20 && this.p($$20)) {
                        $$1.a($$17, $$20, 2);
                     }
                  }
   ...
   private djg a(djg $$0, djg $$1, auu $$2) {
      for (ic $$3 : ic.c.a) {
         if ($$2.h()) {
            djx $$4 = a($$3);
            if ($$0.c($$4)) {
