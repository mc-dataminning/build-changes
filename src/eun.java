...
public class eun {
   ...
   static class a implements eun.i {
      @Override
      public boolean a(eun.v $$0) {
         return $$0.c[jc.f.d()] && !$$0.b[jc.f.d()].d;
      }

      @Override
      public eun.r a(jc $$0, eun.v $$1, azz $$2) {
         $$1.d = true;
         $$1.b[jc.f.d()].d = true;
         return new eun.k($$0, $$1);
      }
   }

   static class b implements eun.i {
      @Override
      public boolean a(eun.v $$0) {
         if ($$0.c[jc.f.d()] && !$$0.b[jc.f.d()].d && $$0.c[jc.b.d()] && !$$0.b[jc.b.d()].d) {
            eun.v $$1 = $$0.b[jc.f.d()];
            return $$1.c[jc.b.d()] && !$$1.b[jc.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public eun.r a(jc $$0, eun.v $$1, azz $$2) {
         ...
         $$1.b[jc.f.d()].d = true;
         $$1.b[jc.b.d()].d = true;
         $$1.b[jc.f.d()].b[jc.b.d()].d = true;
         return new eun.l($$0, $$1);
      }
   }

   static class c implements eun.i {
      @Override
      public boolean a(eun.v $$0) {
         return $$0.c[jc.b.d()] && !$$0.b[jc.b.d()].d;
      }
      ...
      public eun.r a(jc $$0, eun.v $$1, azz $$2) {
         $$1.d = true;
         $$1.b[jc.b.d()].d = true;
         return new eun.m($$0, $$1);
      }
   }

   static class d implements eun.i {
      @Override
      public boolean a(eun.v $$0) {
         if ($$0.c[jc.c.d()] && !$$0.b[jc.c.d()].d && $$0.c[jc.b.d()] && !$$0.b[jc.b.d()].d) {
            eun.v $$1 = $$0.b[jc.c.d()];
            return $$1.c[jc.b.d()] && !$$1.b[jc.b.d()].d;
         } else {
            return false;
      ...
      public eun.r a(jc $$0, eun.v $$1, azz $$2) {
         ...
         $$1.b[jc.c.d()].d = true;
         $$1.b[jc.b.d()].d = true;
         $$1.b[jc.c.d()].b[jc.b.d()].d = true;
         return new eun.n($$0, $$1);
      }
   }

   static class e implements eun.i {
      @Override
      public boolean a(eun.v $$0) {
         return $$0.c[jc.c.d()] && !$$0.b[jc.c.d()].d;
      }

      @Override
      public eun.r a(jc $$0, eun.v $$1, azz $$2) {
         eun.v $$3 = $$1;
         if (!$$1.c[jc.c.d()] || $$1.b[jc.c.d()].d) {
            $$3 = $$1.b[jc.d.d()];
         }

         $$3.d = true;
         $$3.b[jc.c.d()].d = true;
         return new eun.o($$0, $$3);
      }
   }

   static class f implements eun.i {
      @Override
      public boolean a(eun.v $$0) {
         return true;
      }
      ...
      public eun.r a(jc $$0, eun.v $$1, azz $$2) {
         $$1.d = true;
         return new eun.s($$0, $$1, $$2);
      }
   }

   static class g implements eun.i {
      @Override
      public boolean a(eun.v $$0) {
         return !$$0.c[jc.e.d()] && !$$0.c[jc.f.d()] && !$$0.c[jc.c.d()] && !$$0.c[jc.d.d()] && !$$0.c[jc.b.d()];
      }

      @Override
      public eun.r a(jc $$0, eun.v $$1, azz $$2) {
         $$1.d = true;
         return new eun.t($$0, $$1);
      }
   }

   public static class h extends eun.r {
      ...
      private eun.v G;
      private eun.v H;
      private final List<eun.r> I = Lists.newArrayList();

      public h(azz $$0, int $$1, int $$2, jc $$3) {
         super(esu.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eun.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eun.p($$3, this.G));
         this.I.add(new eun.j($$3, this.H));
         List<eun.i> $$5 = Lists.newArrayList();
         $$5.add(new eun.b());
         $$5.add(new eun.d());
         $$5.add(new eun.e());
         $$5.add(new eun.a());
         ...
         erv $$10 = erv.a(this.b(1, 1, 1), this.b(23, 8, 21));
         erv $$11 = erv.a(this.b(34, 1, 1), this.b(56, 8, 21));
         erv $$12 = erv.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eun.u($$3, $$10, $$13++));
         this.I.add(new eun.u($$3, $$11, $$13++));
         this.I.add(new eun.q($$3, $$12));
      }
      ...
      private List<eun.v> b(azz $$0) {
         eun.v[] $$1 = new eun.v[75];
         ...
         eun.v $$23 = new eun.v(1003);
         eun.v $$24 = new eun.v(1001);
         eun.v $$25 = new eun.v(1002);
         $$1[v].a(jc.b, $$23);
         $$1[w].a(jc.d, $$24);
         $$1[x].a(jc.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jc.f.d()].d = true;
         this.H.b[jc.c.d()].d = true;
         this.H.b[jc.f.d()].b[jc.c.d()].d = true;
         this.H.b[jc.b.d()].d = true;
         this.H.b[jc.f.d()].b[jc.b.d()].d = true;
         this.H.b[jc.c.d()].b[jc.b.d()].d = true;
         this.H.b[jc.f.d()].b[jc.c.d()].b[jc.b.d()].d = true;
         ObjectArrayList<eun.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dky $$2, azz $$3, erv $$4) {
         int $$5 = 24;
      ...
      private void a(dky $$0, azz $$1, erv $$2) {
      ...
      private void b(dky $$0, azz $$1, erv $$2) {
      ...
      private void c(dky $$0, azz $$1, erv $$2) {
      ...
      private void d(dky $$0, azz $$1, erv $$2) {
      ...
      private void e(dky $$0, azz $$1, erv $$2) {
      ...
      private void f(dky $$0, azz $$1, erv $$2) {
   ...
   interface i {
      boolean a(eun.v var1);

      eun.r a(jc var1, eun.v var2, azz var3);
   }

   public static class j extends eun.r {
      public j(jc $$0, eun.v $$1) {
         super(esu.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dky $$0, dkv $$1, ede $$2, azz $$3, erv $$4, dje $$5, iw $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dng.cr.m(), dng.cr.m(), false);
   ...
   public static class k extends eun.r {
      public k(jc $$0, eun.v $$1) {
         super(esu.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dky $$0, dkv $$1, ede $$2, azz $$3, erv $$4, dje $$5, iw $$6) {
         eun.v $$7 = this.B.b[jc.f.d()];
         eun.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jc.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jc.a.d()]);
         }
   ...
   public static class l extends eun.r {
      public l(jc $$0, eun.v $$1) {
         super(esu.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eun.r {
      public m(jc $$0, eun.v $$1) {
         super(esu.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dky $$0, dkv $$1, ede $$2, azz $$3, erv $$4, dje $$5, iw $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jc.a.d()]);
         }

         eun.v $$7 = this.B.b[jc.b.d()];
         if ($$7.b[jc.b.d()] == null) {
   ...
   public static class n extends eun.r {
      public n(jc $$0, eun.v $$1) {
         super(esu.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dky $$0, dkv $$1, ede $$2, azz $$3, erv $$4, dje $$5, iw $$6) {
         eun.v $$7 = this.B.b[jc.c.d()];
         eun.v $$8 = this.B;
         eun.v $$9 = $$7.b[jc.b.d()];
         eun.v $$10 = $$8.b[jc.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jc.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jc.a.d()]);
         }
   ...
   public static class o extends eun.r {
      public o(jc $$0, eun.v $$1) {
         super(esu.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eun.r {
      public p(jc $$0, eun.v $$1) {
         super(esu.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eun.r {
      public q(jc $$0, erv $$1) {
         super(esu.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends esh {
      protected static final ebg b = dng.iB.m();
      protected static final ebg c = dng.iC.m();
      protected static final ebg d = dng.iD.m();
      protected static final ebg h = c;
      protected static final ebg i = dng.iK.m();
      protected static final boolean j = true;
      protected static final ebg k = dng.J.m();
      protected static final Set<dne> l = ImmutableSet.builder().add(dng.ee).add(dng.je).add(dng.nC).add(k.b()).build();
      ...
      public r(esu $$0, jc $$1, int $$2, erv $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(esu $$0, int $$1, jc $$2, eun.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static erv a(jc $$0, eun.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         erv $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dky $$0, erv $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  ebg $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dky $$0, erv $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dky $$0, erv $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, ebg $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(erv $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dky $$0, erv $$1, int $$2, int $$3, int $$4) {
         iw $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            coq $$6 = bxe.N.a($$0.a(), bxd.d);
            if ($$6 != null) {
               $$6.c($$6.eU());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dv()), bxd.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eun.r {
      private int a;

      public s(jc $$0, eun.v $$1, azz $$2) {
         super(esu.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dky $$0, dkv $$1, ede $$2, azz $$3, erv $$4, dje $$5, iw $$6) {
         ...
         if (this.B.b[jc.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jc.a.d()] && !this.B.c[jc.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends eun.r {
      public t(jc $$0, eun.v $$1) {
         super(esu.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eun.r {
      private int a;

      public u(jc $$0, erv $$1, int $$2) {
         super(esu.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
