...
public class ewu implements AutoCloseable {
   ...
   private eww a(ewm.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(ewm.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, gaw $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, gaw $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.n != null && (this.i == eww.b.a || this.i == eww.b.b)) {
