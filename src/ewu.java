...
public class ewu extends epa {
   ...
   private void a(ux $$0, jk.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            ewv.b $$9 = ewv.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            ewv.b $$10 = ewv.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            ewv.a $$11 = ewv.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(ux $$0, jk.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         eww $$5 = eww.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, eww.b.d());
            return eww.b;
         });
         String $$6 = $$3.l("Name");
         xo $$7 = xo.a.a($$3.l("DisplayName"), $$1);
         eww.a $$8 = eww.a.a($$3.l("RenderType"));
