...
public class ewu extends gpe {
   ...
   public ewu(fhh $$0, evy $$1, String $$2, BooleanConsumer $$3) {
      super(eza.a);
      this.T = $$3;
      this.y = $$0;
      this.D = $$2;
   ...
   private void E() {
      if (!this.K) {
         if (!this.S && this.a(this.z.a) >= 5368709120L) {
            vu $$0 = vu.a("mco.download.confirmation.line1", eun.b(5368709120L));
   ...
   private vu H() {
      ...
      if (this.H != null) {
         ...
         $$0.add(vu.a("mco.download.speed.narration", eun.b(this.O)));
      }
   ...
   private void a(fav $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.i, vu.a("mco.download.speed", eun.b($$1)), this.g / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
