...
public class ewu implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ewu.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ewu(List<ewu.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ewu a(BufferedReader $$0) {
      return new ewu($$0.lines().flatMap($$0x -> ewu.a.a($$0x).stream()).toList());
   }

   public static record a(ewu.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ewu.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ewu.a(ewu.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ewu.a(ewu.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ewu.a(ewu.b.b, $$3));
      ...
      static ewu.a b(String $$0) {
         return new ewu.a(ewu.b.a, "glob:" + $$0);
      }

      static ewu.a c(String $$0) {
         return new ewu.a(ewu.b.a, "regex:" + $$0);
      }

      static ewu.a d(String $$0) {
         return new ewu.a(ewu.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ewu.b a = FileSystem::getPathMatcher;
      ewu.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
