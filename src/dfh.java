...
public abstract class dfh implements ew {
   ...
   public tq a(tq $$0, jt.a $$1) {
      ...
      if (this.j != null) {
         $$0.a("CustomName", wp.a.a(this.j, $$1));
      }

      $$0.a("TrackOutput", this.g);
      if (this.h != null && this.g) {
         $$0.a("LastOutput", wp.a.a(this.h, $$1));
      }
   ...
   public void b(tq $$0, jt.a $$1) {
      ...
      if ($$0.b("LastOutput", 8) && this.g) {
         try {
            this.h = wp.a.a($$0.l("LastOutput"), $$1);
         } catch (Throwable var4) {
            this.h = wp.b(var4.getMessage());
         }
      } else {
         this.h = null;
      }
   ...
   public abstract faz g();

   public abstract ex i();

   @Override
   public boolean y_() {
      return this.e().O().b(dgd.p) && this.g;
   }
