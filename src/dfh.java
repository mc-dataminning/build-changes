...
public class dfh extends cwo {
   ...
   public static final MapCodec<dfh> d = RecordCodecBuilder.mapCodec($$0 -> $$0.group(c.forGetter($$0x -> $$0x.e), u()).apply($$0, dfh::new));
