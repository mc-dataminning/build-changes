...
public abstract class dak extends dbw {
   ...
   @Override
   public List<dcj> g() {
      return List.of(new dci(this.k().c(), dcp.a.c, new dcp.f(this.l()), new dcp.d(this.f()), this.e, this.d));
   }
   ...
   public static class b<T extends dak> implements dbo<T> {
      ...
      public b(dak.a<T> $$0, int $$1) {
         ...
         this.x = yn.a(yl.o, dbw::j, daq.e, dak::e, dba.a, dbw::k, cwp.h, dbw::l, yl.l, dak::c, yl.g, dak::d, $$0::create);
      }
