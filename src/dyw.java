...
public class dyw implements azh {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<dyw> b = dyv.a.xmap($$0 -> new dyw($$0), $$0 -> $$0.e);
   private dyv e;
   private final dxx f = new dxx(this);

   public dyw(long $$0) {
      this.e = new dyv(dyk.c($$0));
   }
   ...
   @Override
   public azh d() {
      return new dyw(this.e.a(), this.e.a());
   }

   @Override
   public dyi e() {
      return new dyw.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements dyi {
      ...
      public azh a(int $$0, int $$1, int $$2) {
         long $$3 = ayz.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new dyw($$4, this.b);
      }

      @Override
      public azh a(String $$0) {
         dyk.a $$1 = dyk.a($$0);
         return new dyw($$1.a(this.a, this.b));
      }
