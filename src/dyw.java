...
public abstract class dyw<T extends Comparable<T>> {
   ...
   private final Codec<dyw.a<T>> e = this.d.xmap(this::c, dyw.a::b);

   protected dyw(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dyw.a<T> c(T $$0) {
      return new dyw.a<>(this, $$0);
   }

   public dyw.a<T> a(dxw<?, ?> $$0) {
      return new dyw.a<>(this, $$0.c(this));
   }

   public Stream<dyw.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dyw<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends dxw<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.b(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dyw<T> a, T b) {
      public a(dyw<T> a, T b) {
         if (!a.a().contains(b)) {
