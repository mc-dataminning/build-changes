...
public class dyw {
   ...
   private static final int j = jt.a(16);
   ...
   private final dbz p;
   private static final List<dey> q = List.of(dfa.l, dfa.L, dfa.i, dfa.b, dfa.k, dfa.I, dfa.K, dfa.fl, dfa.dP, dfa.iA, dfa.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ji<dcw>>> t;
   ...
   public static final Codec<dyw> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dyw::a, Function.identity());

   private static DataResult<dyw> a(dyw $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dyw(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ji<dcw>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kb.c($$0);
      int $$5 = kb.c($$1) - $$4;
   ...
   @Nullable
   public static dyw a(arl $$0, int $$1, int $$2) {
      dtx $$3 = $$0.a($$1, $$2);
      dyw $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(duw.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jf> a(dcs $$0, int $$1, int $$2, boolean $$3) {
      Set<jf> $$4 = EnumSet.noneOf(jf.class);
   ...
   private void a(dtx $$0, Set<jf> $$1) {
      if (!this.r) {
         if ($$1.contains(jf.a) || $$1.contains(jf.g) || $$1.contains(jf.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(jf.c) && $$1.contains(jf.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(jf.c) && $$1.contains(jf.e) && $$1.contains(jf.d)) {
   ...
   private void a(int $$0, dtx $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ayy.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dtx $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dxt.a.a)) {
         $$3 = Math.min($$0.a(dxt.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }

      int $$5 = this.p.I_();
      iz.a $$6 = new iz.a($$1, $$3, $$2);
   ...
   private static double a(dtx $$0, iz.a $$1) {
      return a($$0, (iz)$$1.c(je.a)) ? 1.0 : -1.0;
   }

   private static double b(dtx $$0, iz.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dtx $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      iz.a $$5 = new iz.a($$1, this.p.am(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<ji<dcw>> b(dtx $$0, int $$1, int $$2) {
      ObjectArrayList<ji<dcw>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + jt.a(this.p.I_());
         $$3.set($$4, $$0.getNoiseBiome(jt.a($$1), $$5, jt.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dtx $$0, iz $$1) {
      dsb $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(awo.O)) {
         ...
         return $$2.a(dfa.eT) || $$2.a(dfa.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dyw.a $$3) {
      if ($$1 >= jt.a(this.p.I_()) && $$1 < jt.a(this.p.am())) {
         int $$4 = $$1 - jt.a(this.p.I_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               ji<dcw> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dyw.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dyw.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ji<dcw> var3);
   }
