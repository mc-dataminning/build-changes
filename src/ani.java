...
public class ani {
   ...
   private static int a(ex $$0, ji $$1, int $$2, jr<exe> $$3) throws CommandSyntaxException {
      bsc $$4 = a($$0, $$1, a);
      if ($$2 >= 0 && $$2 < $$4.b()) {
         cwo $$5 = a($$0, $$3, $$4.a($$2));
         $$4.a($$2, $$5);
   ...
   private static int a(ex $$0, Collection<? extends buk> $$1, int $$2, jr<exe> $$3) throws CommandSyntaxException {
      Map<buk, cwo> $$4 = Maps.newHashMapWithExpectedSize($$1.size());
      ...
      if ($$4.isEmpty()) {
         ...
         if ($$4.size() == 1) {
            Entry<buk, cwo> $$8 = $$4.entrySet().iterator().next();
   ...
   private static int a(ex $$0, ji $$1, int $$2, cwo $$3) throws CommandSyntaxException {
      bsc $$4 = a($$0, $$1, a);
      if ($$2 >= 0 && $$2 < $$4.b()) {
         $$4.a($$2, $$3);
   ...
   private static int a(ex $$0, Collection<? extends buk> $$1, int $$2, cwo $$3) throws CommandSyntaxException {
   ...
   private static int a(ex $$0, ji $$1, int $$2, Collection<? extends buk> $$3, int $$4, jr<exe> $$5) throws CommandSyntaxException {
   ...
   private static int a(ex $$0, ji $$1, int $$2, ji $$3, int $$4, jr<exe> $$5) throws CommandSyntaxException {
      return a($$0, $$3, $$4, a($$0, $$5, a($$0, $$1, $$2)));
   }
   ...
   private static int a(ex $$0, buk $$1, int $$2, ji $$3, int $$4, jr<exe> $$5) throws CommandSyntaxException {
   ...
   private static int a(ex $$0, buk $$1, int $$2, Collection<? extends buk> $$3, int $$4, jr<exe> $$5) throws CommandSyntaxException {
      return a($$0, $$3, $$4, a($$0, $$5, a($$1, $$2)));
   }

   private static cwo a(ex $$0, jr<exe> $$1, cwo $$2) {
      ard $$3 = $$0.e();
      evt $$4 = new evt.a($$3).a(eyk.f, $$0.d()).b(eyk.a, $$0.f()).a(eyj.d);
   ...
   private static cwo a(buk $$0, int $$1) throws CommandSyntaxException {
      bvy $$2 = $$0.a_($$1);
      if ($$2 == bvy.a) {
         throw d.create($$1);
      } else {
   ...
   private static cwo a(ex $$0, ji $$1, int $$2) throws CommandSyntaxException {
      bsc $$3 = a($$0, $$1, b);
      if ($$2 >= 0 && $$2 < $$3.b()) {
         return $$3.a($$2).v();
      } else {
