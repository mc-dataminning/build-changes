...
public class ani implements anf {
   ...
   private final Map<String, ang> b;
   private final List<amd> c;

   public ani(ame $$0, List<amd> $$1) {
      this.c = List.copyOf($$1);
      Map<String, ang> $$2 = new HashMap<>();
      List<String> $$3 = $$1.stream().flatMap($$1x -> $$1x.a($$0).stream()).distinct().toList();

      for (amd $$4 : $$1) {
         ano $$5 = this.a($$4);
         Set<String> $$6 = $$4.a($$0);
         Predicate<aeu> $$7 = $$5 != null ? $$1x -> $$5.b($$1x.a()) : null;
   ...
   public Map<aeu, ann> b(String $$0, Predicate<aeu> $$1) {
      a($$0);
      Map<aeu, ann> $$2 = new TreeMap<>();

      for (ang $$3 : this.b.values()) {
         $$2.putAll($$3.b($$0, $$1));
      }
   ...
   public Map<aeu, List<ann>> c(String $$0, Predicate<aeu> $$1) {
      a($$0);
      Map<aeu, List<ann>> $$2 = new TreeMap<>();
