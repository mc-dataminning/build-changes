...
public class el implements ArgumentType<el.a> {
   ...
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(sw.c("arguments.operation.invalid"));
   private static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(sw.c("arguments.operation.div0"));

   public static el a() {
      return new el();
   }

   public static el.a a(CommandContext<ds> $$0, String $$1) {
   ...
   @FunctionalInterface
   public interface a {
      void apply(eff var1, eff var2) throws CommandSyntaxException;
   }
   ...
   interface b extends el.a {
      ...
      @Override
      default void apply(eff $$0, eff $$1) throws CommandSyntaxException {
