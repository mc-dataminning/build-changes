...
public record el(@Nullable Float c, @Nullable Float d) {
   public static final el a = new el(null, null);
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xe.c("argument.range.ints"));

   public static el a(float $$0) {
      return new el($$0, $$0);
   }

   public static el a(float $$0, float $$1) {
      return new el($$0, $$1);
   }

   public static el b(float $$0) {
      return new el($$0, null);
   }

   public static el c(float $$0) {
      return new el(null, $$0);
   }
   ...
   public static el a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         return a;
      } else if (ayv.b($$0)) {
         float $$1 = ayv.e($$0, "value");
         return new el($$1, $$1);
      } else {
         JsonObject $$2 = ayv.m($$0, "value");
         Float $$3 = $$2.has("min") ? ayv.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? ayv.m($$2, "max") : null;
         return new el($$3, $$4);
      }
   }

   public static el a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return a($$0, $$1, $$0x -> $$0x);
   }

   public static el a(StringReader $$0, boolean $$1, Function<Float, Float> $$2) throws CommandSyntaxException {
      if (!$$0.canRead()) {
