...
public class dsr {
   ...
   private final Map<Character, Predicate<dsp>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dsr a(char $$0, Predicate<dsp> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dsq b() {
      return new dsq(this.c());
   }

   private Predicate<dsp>[][][] c() {
      this.d();
      Predicate<dsp>[][][] $$0 = (Predicate<dsp>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dsp>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
