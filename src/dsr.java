...
public class dsr<T> implements dst<T> {
   ...
   private dsr(jb<T> $$0, int $$1, dsu<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dsr(jb<T> $$0, T[] $$1, dsu<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dst<T> c() {
      return new dsr<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
