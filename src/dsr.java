...
public class dsr extends dju {
   ...
   public static final MapCodec<dsr> d = RecordCodecBuilder.mapCodec($$0 -> $$0.group(c.forGetter($$0x -> $$0x.e), t()).apply($$0, dsr::new));
