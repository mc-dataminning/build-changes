...
public abstract class fzo<B extends gid.a<?>> extends fvi {
   ...
   protected final fvi x;
   protected final gih y;
   protected final fti z = fti.d().a(8);
   protected B A;
   private fps L;
   protected fpq B;

   protected fzo(wp $$0, fvi $$1, gih $$2, B $$3) {
      super($$0);
      this.x = $$1;
      this.y = $$2;
      this.A = $$3;
   ...
   protected fqi a(int $$0, int $$1, Consumer<String> $$2) {
      AbuseReportLimits $$3 = this.y.a().b();
      fqi $$4 = new fqi(this.p, 0, 0, $$0, $$1, H, I);
      $$4.a(this.A.g());
   ...
   protected void m() {
      this.z.a(new fqx(this.l, this.p));
   }

   protected abstract void E();

   protected void F() {
      this.L = this.z.a(fps.a(J, this.p).a(this.A.h()).a(280).a(($$0x, $$1) -> {
         this.A.a($$1);
         this.G();
      }).a());
      fti $$0 = this.z.a(fti.e().a(8));
      $$0.a(fpq.a(wo.k, $$0x -> this.aO_()).a(120).a());
      this.B = $$0.a(fpq.a(a, $$0x -> this.H()).a(120).a());
   }

   protected void G() {
      gid.b $$0 = this.A.c();
      this.B.j = $$0 == null && this.L.a();
      this.B.a(x.a($$0, gid.b::a));
   }
   ...
   private void I() {
      this.M();
      this.m.a(fuu.a(E, C, wo.d, () -> this.m.a(null)));
   }
   ...
   private void a(wp $$0) {
      wp $$1 = $$0.f().a(n.m);
      this.m.a(fuu.a(F, $$1, wo.k, () -> this.m.a(this)));
   }
