...
public final class fzo {
   ...
   private static final fzo c = new fzo(HostAndPort.fromParts("server.invalid", 25565));

   public fzo(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fzo(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fzo a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new fzo($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fzo ? this.b.equals(((fzo)$$0).b) : false;
      }
   }
