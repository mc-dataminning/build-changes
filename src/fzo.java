...
public abstract class fzo<T extends bml, M extends fjx<T>> extends fym<T> implements gai<T, M> {
   ...
   protected M f;
   protected final List<gcy<T, M>> g = Lists.newArrayList();

   public fzo(fyn.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gcy<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, eqb $$3, fth $$4, int $$5) {
      ...
      this.f.d = $$0.bO();
      this.f.e = $$0.o_();
      float $$6 = auo.j($$2, $$0.aV, $$0.aU);
      float $$7 = auo.j($$2, $$0.aX, $$0.aW);
      float $$8 = $$7 - $$6;
      if ($$0.bO() && $$0.cZ() instanceof bml $$9) {
         $$6 = auo.j($$2, $$9.aV, $$9.aU);
         $$8 = $$7 - $$6;
         float $$10 = auo.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected ftp a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      ahg $$4 = this.a($$0);
      if ($$2) {
         return ftp.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? ftp.r($$4) : null;
      }
   }

   public static int c(bml $$0, float $$1) {
      return gee.a(gee.a($$1), gee.a($$0.aK > 0 || $$0.aM > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return evi.K() && $$0 != $$3.am() && $$5 && !$$0.bP();
      }
   }

   public static boolean e(bml $$0) {
      if ($$0 instanceof cfi || $$0.ae()) {
         String $$1 = n.a($$0.ad().getString());
         if ("Dinnerbone".equals($$1) || "Grumm".equals($$1)) {
            return !($$0 instanceof cfi) || ((cfi)$$0).a(cfj.a);
         }
      }
