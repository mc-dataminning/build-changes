...
public class enl extends LongLinkedOpenHashSet {
   private final enl.a a;

   public enl(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new enl.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = ayu.f(60000000);
      private static final int b = ayu.f(60000000);
