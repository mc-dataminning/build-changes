...
public record brf(Instant a, String b, long c) {
   ...
   public static brf a(RecordedEvent $$0) {
      ...
      return new brf($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static brf.a a(List<brf> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<brf>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            brf $$3 = (brf)$$2x.get(0);
            brf $$4 = (brf)$$2x.get($$2x.size() - 1);
