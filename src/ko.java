...
public interface ko {
   ...
   bsj interact(dwx var1, dgi var2, ji var3, cox var4, bsi var5, cwp var6);
   ...
   static bsj a(dwx $$0, dgi $$1, ji $$2, cox $$3, bsi $$4, cwp $$5, cwp $$6, Predicate<dwx> $$7, avz $$8) {
      if (!$$7.test($$0)) {
         return bsj.f;
      } else {
         if (!$$1.C) {
   ...
   static bsj a(dgi $$0, ji $$1, cox $$2, bsi $$3, cwp $$4, dwx $$5, avz $$6) {
      if (!$$0.C) {
         cwl $$7 = $$4.h();
   ...
   private static bsj a(dwx $$0, dgi $$1, ji $$2, cox $$3, bsi $$4, cwp $$5) {
      return a($$1, $$2, $$3, $$4, $$5, djo.fP.m().b(dnx.g, Integer.valueOf(3)), awa.dd);
   }

   private static bsj b(dwx $$0, dgi $$1, ji $$2, cox $$3, bsi $$4, cwp $$5) {
      return (bsj)(a($$1, $$2) ? bsj.c : a($$1, $$2, $$3, $$4, $$5, djo.fQ.m(), awa.dg));
   }

   private static bsj c(dwx $$0, dgi $$1, ji $$2, cox $$3, bsi $$4, cwp $$5) {
      return (bsj)(a($$1, $$2) ? bsj.c : a($$1, $$2, $$3, $$4, $$5, djo.fR.m().b(dnx.g, Integer.valueOf(3)), awa.dh));
   }

   private static bsj d(dwx $$0, dgi $$1, ji $$2, cox $$3, bsi $$4, cwp $$5) {
      djm $$6 = djm.a($$5.h());
      if (!($$6 instanceof dqq)) {
         return bsj.f;
      } else {
   ...
   private static bsj e(dwx $$0, dgi $$1, ji $$2, cox $$3, bsi $$4, cwp $$5) {
   ...
   private static bsj f(dwx $$0, dgi $$1, ji $$2, cox $$3, bsi $$4, cwp $$5) {
      if (!$$5.a(awy.bP)) {
         return bsj.f;
      } else if (!$$5.b(kv.J)) {
         return bsj.f;
