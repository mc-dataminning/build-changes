...
public class cqt {
   public static <T> List<cqt.b> a(List<T> $$0, Function<T, List<hi<duc>>> $$1, boolean $$2) {
      Object2IntMap<duc> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, duc c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<hi<duc>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (he<duc> $$12 : $$10.get($$11)) {
               duc $$13 = $$12.a();
      ...
      Builder<cqt.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<duc> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new cqt.b($$28));
      }
   ...
   public static record b(List<duc> a, ToIntFunction<duc> b) {
      b(List<duc> $$0) {
