...
public abstract class dmz extends dms {
   protected dmz(dsk.d $$0) {
      super($$0);
   }
   ...
   private static boolean c(dsl $$0, dcj $$1, ja $$2) {
      ja $$3 = $$2.c();
      ...
      if (!b($$0, $$1, $$2)) {
         ...
         if ($$1.A($$2.c()) >= 9) {
            ...
            for (int $$5 = 0; $$5 < 4; $$5++) {
               ...
               if ($$1.a_($$6).a(dfk.j) && c($$4, $$1, $$6)) {
                  $$1.b($$6, $$4.a(c, Boolean.valueOf($$1.a_($$6.c()).a(dfk.dN))));
               }
            }
         }
      }
