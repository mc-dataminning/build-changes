public class ggk extends ghf {
   private final gha a;

   ggk(gcy $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gha $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cor $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dF();
            if (this.h > $$1) {
               this.h = this.h + ($$1 - this.h) * 0.2;
               this.k = this.k + ($$0.dB().e - this.k) * 0.2;
   ...
   public static class a implements ggi<lw> {
      ...
      public ggf a(lw $$0, gcy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new ggk($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements ggi<lw> {
      ...
      public ggf a(lw $$0, gcy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ggf $$8 = new ggk($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
