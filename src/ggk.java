...
public class ggk {
   ...
   public ggd a(Vector3f $$0, Vector3f $$1, ggf $$2, gqy $$3, iw $$4, gth $$5, @Nullable ggg $$6, boolean $$7, akt $$8) {
      ggh $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = aym.i($$11, $$9.a[0], $$12);
      $$9.a[2] = aym.i($$11, $$9.a[2], $$12);
      $$9.a[1] = aym.i($$11, $$9.a[1], $$13);
      $$9.a[3] = aym.i($$11, $$9.a[3], $$13);
      ...
      return new ggd($$14, $$2.c, $$15, $$3, $$7);
   }

   public static ggh a(ggh $$0, iw $$1, j $$2, akt $$3) {
      Matrix4f $$4 = iq.a($$2, $$1, () -> "Unable to resolve UVLock for model: " + $$3).c();
      float $$5 = $$0.a($$0.c(0));
      float $$6 = $$0.b($$0.c(0));
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(aym.b($$23), aym.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new ggh(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(ggh $$0, gqy $$1, iw $$2, float[] $$3, j $$4, @Nullable ggg $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[iw.values().length];
      $$2[gex.a.f] = $$0.x() / 16.0F;
      $$2[gex.a.e] = $$0.y() / 16.0F;
      $$2[gex.a.d] = $$0.z() / 16.0F;
      $$2[gex.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, iw $$2, ggh $$3, float[] $$4, gqy $$5, j $$6, @Nullable ggg $$7, boolean $$8) {
      gex.b $$9 = gex.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gqy $$3, ggh $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable ggg $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static iw a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? iw.b : $$7;
      }
   }

   private void a(int[] $$0, iw $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[iw.values().length];
      $$3[gex.a.f] = 999.0F;
      $$3[gex.a.e] = 999.0F;
      $$3[gex.a.d] = 999.0F;
      $$3[gex.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (aym.a($$13, $$18) && aym.a($$14, $$19) && aym.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
