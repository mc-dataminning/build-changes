...
public class emc {
   ...
   static class a implements emc.i {
      @Override
      public boolean a(emc.v $$0) {
         return $$0.c[iw.f.d()] && !$$0.b[iw.f.d()].d;
      }

      @Override
      public emc.r a(iw $$0, emc.v $$1, ayt $$2) {
         $$1.d = true;
         $$1.b[iw.f.d()].d = true;
         return new emc.k($$0, $$1);
      }
   }

   static class b implements emc.i {
      @Override
      public boolean a(emc.v $$0) {
         if ($$0.c[iw.f.d()] && !$$0.b[iw.f.d()].d && $$0.c[iw.b.d()] && !$$0.b[iw.b.d()].d) {
            emc.v $$1 = $$0.b[iw.f.d()];
            return $$1.c[iw.b.d()] && !$$1.b[iw.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public emc.r a(iw $$0, emc.v $$1, ayt $$2) {
         ...
         $$1.b[iw.f.d()].d = true;
         $$1.b[iw.b.d()].d = true;
         $$1.b[iw.f.d()].b[iw.b.d()].d = true;
         return new emc.l($$0, $$1);
      }
   }

   static class c implements emc.i {
      @Override
      public boolean a(emc.v $$0) {
         return $$0.c[iw.b.d()] && !$$0.b[iw.b.d()].d;
      }
      ...
      public emc.r a(iw $$0, emc.v $$1, ayt $$2) {
         $$1.d = true;
         $$1.b[iw.b.d()].d = true;
         return new emc.m($$0, $$1);
      }
   }

   static class d implements emc.i {
      @Override
      public boolean a(emc.v $$0) {
         if ($$0.c[iw.c.d()] && !$$0.b[iw.c.d()].d && $$0.c[iw.b.d()] && !$$0.b[iw.b.d()].d) {
            emc.v $$1 = $$0.b[iw.c.d()];
            return $$1.c[iw.b.d()] && !$$1.b[iw.b.d()].d;
         } else {
            return false;
      ...
      public emc.r a(iw $$0, emc.v $$1, ayt $$2) {
         ...
         $$1.b[iw.c.d()].d = true;
         $$1.b[iw.b.d()].d = true;
         $$1.b[iw.c.d()].b[iw.b.d()].d = true;
         return new emc.n($$0, $$1);
      }
   }

   static class e implements emc.i {
      @Override
      public boolean a(emc.v $$0) {
         return $$0.c[iw.c.d()] && !$$0.b[iw.c.d()].d;
      }

      @Override
      public emc.r a(iw $$0, emc.v $$1, ayt $$2) {
         emc.v $$3 = $$1;
         if (!$$1.c[iw.c.d()] || $$1.b[iw.c.d()].d) {
            $$3 = $$1.b[iw.d.d()];
         }

         $$3.d = true;
         $$3.b[iw.c.d()].d = true;
         return new emc.o($$0, $$3);
      }
   }

   static class f implements emc.i {
      @Override
      public boolean a(emc.v $$0) {
         return true;
      }
      ...
      public emc.r a(iw $$0, emc.v $$1, ayt $$2) {
         $$1.d = true;
         return new emc.s($$0, $$1, $$2);
      }
   }

   static class g implements emc.i {
      @Override
      public boolean a(emc.v $$0) {
         return !$$0.c[iw.e.d()] && !$$0.c[iw.f.d()] && !$$0.c[iw.c.d()] && !$$0.c[iw.d.d()] && !$$0.c[iw.b.d()];
      }

      @Override
      public emc.r a(iw $$0, emc.v $$1, ayt $$2) {
         $$1.d = true;
         return new emc.t($$0, $$1);
      }
   }

   public static class h extends emc.r {
      ...
      private emc.v G;
      private emc.v H;
      private final List<emc.r> I = Lists.newArrayList();

      public h(ayt $$0, int $$1, int $$2, iw $$3) {
         super(ekk.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<emc.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new emc.p($$3, this.G));
         this.I.add(new emc.j($$3, this.H));
         List<emc.i> $$5 = Lists.newArrayList();
         $$5.add(new emc.b());
         $$5.add(new emc.d());
         $$5.add(new emc.e());
         $$5.add(new emc.a());
         ...
         ejl $$10 = ejl.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ejl $$11 = ejl.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ejl $$12 = ejl.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new emc.u($$3, $$10, $$13++));
         this.I.add(new emc.u($$3, $$11, $$13++));
         this.I.add(new emc.q($$3, $$12));
      }
      ...
      private List<emc.v> b(ayt $$0) {
         emc.v[] $$1 = new emc.v[75];
         ...
         emc.v $$23 = new emc.v(1003);
         emc.v $$24 = new emc.v(1001);
         emc.v $$25 = new emc.v(1002);
         $$1[v].a(iw.b, $$23);
         $$1[w].a(iw.d, $$24);
         $$1[x].a(iw.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[iw.f.d()].d = true;
         this.H.b[iw.c.d()].d = true;
         this.H.b[iw.f.d()].b[iw.c.d()].d = true;
         this.H.b[iw.b.d()].d = true;
         this.H.b[iw.f.d()].b[iw.b.d()].d = true;
         this.H.b[iw.c.d()].b[iw.b.d()].d = true;
         this.H.b[iw.f.d()].b[iw.c.d()].b[iw.b.d()].d = true;
         ObjectArrayList<emc.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dcv $$2, ayt $$3, ejl $$4) {
         int $$5 = 24;
      ...
      private void a(dcv $$0, ayt $$1, ejl $$2) {
      ...
      private void b(dcv $$0, ayt $$1, ejl $$2) {
      ...
      private void c(dcv $$0, ayt $$1, ejl $$2) {
      ...
      private void d(dcv $$0, ayt $$1, ejl $$2) {
      ...
      private void e(dcv $$0, ayt $$1, ejl $$2) {
      ...
      private void f(dcv $$0, ayt $$1, ejl $$2) {
   ...
   interface i {
      boolean a(emc.v var1);

      emc.r a(iw var1, emc.v var2, ayt var3);
   }

   public static class j extends emc.r {
      public j(iw $$0, emc.v $$1) {
         super(ekk.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dcv $$0, dct $$1, duz $$2, ayt $$3, ejl $$4, dbh $$5, ir $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dfe.cS.n(), dfe.cS.n(), false);
   ...
   public static class k extends emc.r {
      public k(iw $$0, emc.v $$1) {
         super(ekk.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dcv $$0, dct $$1, duz $$2, ayt $$3, ejl $$4, dbh $$5, ir $$6) {
         emc.v $$7 = this.B.b[iw.f.d()];
         emc.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[iw.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[iw.a.d()]);
         }
   ...
   public static class l extends emc.r {
      public l(iw $$0, emc.v $$1) {
         super(ekk.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends emc.r {
      public m(iw $$0, emc.v $$1) {
         super(ekk.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dcv $$0, dct $$1, duz $$2, ayt $$3, ejl $$4, dbh $$5, ir $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[iw.a.d()]);
         }

         emc.v $$7 = this.B.b[iw.b.d()];
         if ($$7.b[iw.b.d()] == null) {
   ...
   public static class n extends emc.r {
      public n(iw $$0, emc.v $$1) {
         super(ekk.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dcv $$0, dct $$1, duz $$2, ayt $$3, ejl $$4, dbh $$5, ir $$6) {
         emc.v $$7 = this.B.b[iw.c.d()];
         emc.v $$8 = this.B;
         emc.v $$9 = $$7.b[iw.b.d()];
         emc.v $$10 = $$8.b[iw.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[iw.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[iw.a.d()]);
         }
   ...
   public static class o extends emc.r {
      public o(iw $$0, emc.v $$1) {
         super(ekk.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends emc.r {
      public p(iw $$0, emc.v $$1) {
         super(ekk.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends emc.r {
      public q(iw $$0, ejl $$1) {
         super(ekk.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ejx {
      protected static final dtc b = dfe.iT.n();
      protected static final dtc c = dfe.iU.n();
      protected static final dtc d = dfe.iV.n();
      protected static final dtc h = c;
      protected static final dtc i = dfe.jc.n();
      protected static final boolean j = true;
      protected static final dtc k = dfe.al.n();
      protected static final Set<dfc> l = ImmutableSet.builder().add(dfe.eC).add(dfe.jw).add(dfe.nU).add(k.b()).build();
      ...
      public r(ekk $$0, iw $$1, int $$2, ejl $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ekk $$0, int $$1, iw $$2, emc.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ejl a(iw $$0, emc.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ejl $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dcv $$0, ejl $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dtc $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dcv $$0, ejl $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dcv $$0, ejl $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dtc $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ejl $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dcv $$0, ejl $$1, int $$2, int $$3, int $$4) {
         ir $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cir $$6 = bsb.F.a((dca)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eZ());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.du()), bss.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends emc.r {
      private int a;

      public s(iw $$0, emc.v $$1, ayt $$2) {
         super(ekk.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dcv $$0, dct $$1, duz $$2, ayt $$3, ejl $$4, dbh $$5, ir $$6) {
         ...
         if (this.B.b[iw.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[iw.a.d()] && !this.B.c[iw.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends emc.r {
      public t(iw $$0, emc.v $$1) {
         super(ekk.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends emc.r {
      private int a;

      public u(iw $$0, ejl $$1, int $$2) {
         super(ekk.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
