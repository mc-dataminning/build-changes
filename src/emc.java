...
public class emc extends emg implements eme {
   ...
   public emc.c a() {
      return new emc.c(this.p, this.l, this.t, this.u);
   }

   public void a(emc.c $$0) {
      this.h.rewind();
      this.p = $$0.a;
      this.l = $$0.b;
      this.k = this.j;
   ...
   private IntConsumer a(int $$0, emm.a $$1) {
   ...
   private emc.b o() {
      ...
      this.j += $$5;
      this.i++;
      emc.a $$9 = new emc.a(this.o, this.l, $$0, this.p, $$2, this.v, $$4);
      return new emc.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.n != 0) {
         ...
         this.l++;
         this.l();
         if (this.p == emm.b.a || this.p == emm.b.b) {
            int $$0 = this.o.b();
   ...
   @Override
   public void f() {
      ImmutableList<emn> $$0 = this.o.c();
      this.n = (this.n + 1) % $$0.size();
      this.k = this.k + this.m.e();
      emn $$1 = (emn)$$0.get(this.n);
      this.m = $$1;
      if ($$1.b() == emn.b.e) {
         this.f();
      }

      if (this.a && this.m.b() == emn.b.c) {
         eme.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, eme.a($$11));
         this.a($$14 + 5, eme.a($$12));
         this.a($$14 + 6, eme.a($$13));
         this.k += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(emm a, int b, int c, emm.b d, emm.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(emm.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable emp $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
