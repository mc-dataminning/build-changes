...
public abstract class emc<T extends emc<T>> {
   ...
   public emc(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = ema.a();
         if ($$3 != null) {
         ...
         throw new enl(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new enl(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new enl(var2.getMessage(), var2);
      }
   }
   ...
   public static emc<?> a(String $$0) {
      return new emc.b($$0, 5000, 60000);
   }

   public static emc<?> a(String $$0, int $$1, int $$2) {
      return new emc.b($$0, $$1, $$2);
   }

   public static emc<?> c(String $$0, String $$1) {
      return new emc.c($$0, $$1, 5000, 60000);
   }

   public static emc<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new emc.c($$0, $$1, $$2, $$3);
   }

   public static emc<?> b(String $$0) {
      return new emc.a($$0, 5000, 60000);
   }

   public static emc<?> d(String $$0, String $$1) {
      return new emc.d($$0, $$1, 5000, 60000);
   }

   public static emc<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new emc.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends emc<emc.a> {
   ...
   public static class b extends emc<emc.b> {
   ...
   public static class c extends emc<emc.c> {
      ...
      public emc.c f() {
         try {
            ...
            throw new enl(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends emc<emc.d> {
      private final String c;
