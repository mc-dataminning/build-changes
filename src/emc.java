...
public class emc implements elx {
   public static final Codec<emc> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               mg.e.q().fieldOf("block").flatXmap(emc::a, DataResult::success).orElse((drt)dmo.fy).forGetter($$0x -> $$0x.b),
   ...
   public final jj<dmm> h;
   private final ObjectArrayList<jb> i;

   private static DataResult<drt> a(dmm $$0) {
      return $$0 instanceof drt $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface spreadeable block");
   }

   public emc(drt $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jj<dmm> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
