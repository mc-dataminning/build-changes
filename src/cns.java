...
public class cns extends cnq implements bwl {
   private static final bvn c = bvr.bR.n().a(0.5F).b(0.97F);
   private static final alz cc = alz.b("attacking");
   private static final bxm cd = new bxm(cc, 0.05, bxm.a.a);
   private static final bsu ce = bbg.a(0, 1);
   private int cf;
   ...
   private static final bsu ck = bbg.a(4, 6);
   private int cl;

   public cns(bvr<? extends cns> $$0, dhi $$1) {
      super($$0, $$1);
      this.a(euo.i, 8.0F);
   }
   ...
   protected void p() {
      ...
      this.bU.a(2, new cex<>(this, cpx.class, 10, true, false, this::a));
      this.bU.a(3, new cfd<>(this, true));
   }

   public static bxn.a gx() {
      return cnq.gr().a(bxo.A, 0.0).a(bxo.v, 0.23F).a(bxo.c, 5.0);
   }
   ...
   private void gA() {
      double $$0 = this.h(bxo.m);
      fbt $$1 = fbt.a(this.du()).c($$0, 10.0, $$0);
      this.dW()
         .a(cns.class, $$1, bvp.f)
         .stream()
         .filter($$0x -> $$0x != this)
   ...
   public static boolean b(bvr<cns> $$0, dhj $$1, bvq $$2, jh $$3, bam $$4) {
      return $$1.al() != btg.a && !$$1.a_($$3.e()).a(dko.lf);
   }
