...
public record cns(cns.a d) {
   ...
   public static final Codec<cns> c = cns.a.a.xmap(cns::new, cns::b);

   public static cns a(azp $$0, UUID $$1, cns.a $$2) throws cns.b {
      if (!$$2.a($$0, $$1)) {
         throw new cns.b(e);
      } else {
         return new cns($$2);
   ...
   public azp a() {
      return azp.a(this.d.c, "SHA256withRSA");
   }
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cns.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ayl.o.fieldOf("expires_at").forGetter(cns.a::b), aya.f.fieldOf("key").forGetter(cns.a::c), ayl.p.fieldOf("signature_v2").forGetter(cns.a::d)
               )
               .apply($$0, cns.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof cns.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
