...
public class cns {
   ...
   private int g = azn.b(azv.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kk.a.fieldOf("uuid").forGetter(Pair::getFirst), ayw.l.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bui> j;
   @VisibleForTesting
   protected final ArrayList<bui> c;
   private final cns.a k;
   @VisibleForTesting
   protected final Object2IntMap<bui> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cns> a(Predicate<bui> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cns::b)).apply($$1, $$1x -> new cns($$0, $$1x))
      );
   }

   public cns(Predicate<bui> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cns.a(this);
   ...
   private List<Pair<UUID, Integer>> b() {
      return Streams.concat(
            new Stream[]{
               this.c.stream().map($$0 -> Pair.of($$0.cI(), this.d.getInt($$0))),
   ...
   public void a(arq $$0, Predicate<bui> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bui>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bui> $$6 = (Entry<bui>)$$5.next();
         int $$7 = $$6.getIntValue();
         bui $$8 = (bui)$$6.getKey();
         bui.c $$9 = $$8.dU();
   ...
   public int b(@Nullable bui $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bve> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bve).map($$0 -> (bve)$$0);
   }

   @VisibleForTesting
   protected static record a(cns a) implements Comparator<bui> {
      public int a(bui $$0, bui $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cor;
               boolean $$7 = $$1 instanceof cor;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
