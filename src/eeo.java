...
public class eeo extends eew<ehh> {
   private static final dwe a = dwe.a(dis.I);
   private final dvv b = dis.I.m();
   private final dvv c = dis.jF.m();
   private final dvv d = dis.aV.m();
   private final dvv ao = dis.G.m();

   public eeo(Codec<ehh> $$0) {
      super($$0);
   }
   ...
   private static void b(dgk $$0, jh $$1) {
      $$0.a($$1, dis.J.m(), 3);
      $$0.a($$1, dta.N).ifPresent($$1x -> $$1x.a(euj.aX, $$1.a()));
   }
}
