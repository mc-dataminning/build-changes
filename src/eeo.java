...
public class eeo extends eet {
   public static final MapCodec<eeo> a = eec.a.fieldOf("provider").xmap(eeo::new, $$0 -> $$0.b);
   private final eec b;
