...
public class yk implements xa {
   ...
   private static final Codec<Object> e = Codec.either(d, xb.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof wz $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yk> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   private static yk a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yk($$0, $$1.orElse(null), a($$2));
   }

   public yk(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xe> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yl var4) {
            this.l = ImmutableList.of(xe.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xe> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yl(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xe a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof wz) {
            ...
            return $$1 == null ? g : xe.e($$1.toString());
         }
      } else {
         throw new yl(this, $$0);
      }
   ...
   public xn a(@Nullable et $$0, @Nullable bsr $$1, int $$2) throws CommandSyntaxException {
      ...
      return xn.a(new yk(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yk $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
