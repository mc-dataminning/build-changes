...
public class ejg {
   ...
   @Nullable
   private String g;
   private static final ejg.a h = new ejg.a() {
      @Nullable
      @Override
      public ejf a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ejj.a(this.d, "Get capabilities")) {
         ...
         int $$5 = this.i();
         int $$6 = ars.a((int)ars.c((float)$$5), 2, 8);
         int $$7 = ars.a($$5 - $$6, 8, 255);
         this.i = new ejg.b($$7);
         this.j = new ejg.b($$6);
         ALCapabilities $$8 = AL.createCapabilities($$2);
         ejj.a("Initialization");
         if (!$$8.AL_EXT_source_distance_model) {
            ...
            if (!$$8.AL_EXT_LINEAR_DISTANCE) {
               ...
               ejj.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ejj.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ejf a(ejg.c $$0) {
      return ($$0 == ejg.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements ejg.a {
      private final int a;
      private final Set<ejf> b = Sets.newIdentityHashSet();
      ...
      public ejf a() {
         if (this.b.size() >= this.a) {
            if (aa.aS) {
               ejg.a.warn("Maximum sound pool size {} reached", this.a);
            }
