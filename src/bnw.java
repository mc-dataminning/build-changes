...
public class bnw extends bno {
   ...
   public bnw(cvn $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bnu.L, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bnw(bnu<? extends bnw> $$0, cvn $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         ens $$0 = new ens(this.k.dr() - this.dr(), this.k.dt() + (double)this.k.cI() / 2.0 - this.dt(), this.k.dx() - this.dx());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void u() {
      ...
      if (this.dM() instanceof aov) {
         for (bnw $$1 : this.dM().a(dpd.a(bnw.class), this.cH().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(aov $$0, ens $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bnw($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(aov $$0, ens $$1, int $$2) {
      enn $$3 = enn.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.F_().a(40);
      List<bnw> $$5 = $$0.a(dpd.a(bnw.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bnw $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bnw $$0) {
      return $$0 != this && a($$0, this.aj(), this.i);
   }

   private static boolean a(bnw $$0, int $$1, int $$2) {
      return !$$0.dH() && ($$0.aj() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bnw $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(chh $$0, int $$1) {
      Entry<bnv, coz> $$2 = ctj.a(ctl.L, $$0, coz::k);
      if ($$2 != null) {
         coz $$3 = $$2.getValue();
