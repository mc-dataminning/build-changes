...
public class bnw {
   ...
   private static void a(bnz $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dvx, boi<bny>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((boi)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ad.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dvx, boi<bny>> $$3 : $$0) {
         boi<bny> $$4 = (boi<bny>)$$3.getSecond();
   ...
   private JsonElement b(List<bog> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bnl.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bnu $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bnw::a));
      $$1.add("chunksWritten", this.a($$0.m(), bnw::a));
      return $$1;
   }
   ...
   private JsonElement c(bnu $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bnw::a));
      $$1.add("received", this.a($$0.k(), bnw::a));
      return $$1;
   }

   private <T> JsonElement a(bod<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<boa> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<boa>, ToDoubleFunction<boa>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, boa::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, boa::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, boa::c));
      return $$1;
   }
}
