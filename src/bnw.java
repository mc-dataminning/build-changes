...
public record bnw(Instant a, String b, long c) {
   ...
   public static bnw a(RecordedEvent $$0) {
      ...
      return new bnw($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bnw.a a(List<bnw> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bnw>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bnw $$3 = (bnw)$$2x.get(0);
            bnw $$4 = (bnw)$$2x.get($$2x.size() - 1);
