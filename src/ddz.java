...
public abstract class ddz extends dfh {
   ...
   protected ddz(dsj.d $$0) {
      super($$0);
   }

   protected abstract Iterable<ewf> b(dsk var1);
   ...
   private static void a(dcf $$0, ewf $$1, ayo $$2) {
      float $$3 = $$2.i();
      if ($$3 < 0.3F) {
   ...
   public static void a(@Nullable cmk $$0, dsk $$1, dcg $$2, ja $$3) {
      a($$2, $$1, $$3, false);
      if ($$1.b() instanceof ddz) {
         ((ddz)$$1.b())
            .b($$1)
   ...
   private static void a(dcg $$0, dsk $$1, ja $$2, boolean $$3) {
