...
public class ddz {
   ...
   public static ddz a(dhy $$0, long $$1, cno $$2, Stream<he<dsg>> $$3) {
      List<he<dsg>> $$4 = $$3.filter($$1x -> a((dsg)$$1x.a(), $$2)).toList();
      return new ddz($$0, $$2, $$1, 0L, $$4);
   }

   public static ddz a(dhy $$0, long $$1, cno $$2, hg<dsg> $$3) {
      List<he<dsg>> $$4 = $$3.b().filter($$1x -> a((dsg)$$1x.a(), $$2)).collect(Collectors.toUnmodifiableList());
      return new ddz($$0, $$2, $$1, $$1, $$4);
   }

   private static boolean a(dsg $$0, cno $$1) {
      Stream<he<cnk>> $$2 = $$0.a().stream().flatMap($$0x -> {
         dsa $$1x = $$0x.a().a();
         return $$1x.a().a();
      });
   ...
   private CompletableFuture<List<clt>> a(he<dsg> $$0, dsu $$1) {
      if ($$1.c() == 0) {
         ...
         int $$3 = $$1.a();
         int $$4 = $$1.c();
         List<CompletableFuture<clt>> $$5 = new ArrayList<>($$4);
         int $$6 = $$1.b();
         hi<cnk> $$7 = $$1.d();
         apf $$8 = apf.a();
         $$8.b(this.e);
         ...
         for (int $$12 = 0; $$12 < $$4; $$12++) {
            ...
            $$5.add(CompletableFuture.supplyAsync(() -> {
               Pair<gu, he<cnk>> $$4x = this.c.a(hx.a($$14, 8), 0, hx.a($$15, 8), 112, $$7::a, $$16, this.b.b());
               if ($$4x != null) {
                  gu $$5x = (gu)$$4x.getFirst();
                  return new clt(hx.a($$5x.u()), hx.a($$5x.w()));
               } else {
