...
public class ddz extends dea {
   ...
   public static void a(cpl $$0, gu $$1, dez $$2, ddz $$3) {
      $$3.g++;
      if ($$3.d()) {
         $$3.h--;
      }
   ...
   public static void b(cpl $$0, gu $$1, dez $$2, ddz $$3) {
      boolean $$4 = $$3.c();
      boolean $$5 = $$3.d();
      $$3.g++;
      if ($$5) {
         ...
         List<bii> $$6 = $$0.a(bii.class, new egy($$1), ddz::a);
         if (!$$6.isEmpty()) {
   ...
   private static void c(cpl $$0, gu $$1, dez $$2, ddz $$3) {
      if (!$$0.B) {
         $$3.h = 40;
         $$0.a($$1, $$2.b(), 1, 0);
         a($$0, $$1, $$2);
   ...
   public static void a(cpl $$0, gu $$1, dez $$2, bii $$3, ddz $$4) {
      if ($$0 instanceof akk && !$$4.d()) {
         akk $$5 = (akk)$$0;
         $$4.h = 100;
         if ($$4.i == null && $$0.ac() == cpl.j) {
            gu $$6 = a($$5, $$1);
            $$6 = $$6.b(10);
   ...
   private static gu a(cpl $$0, gu $$1) {
   ...
   private static gu a(akk $$0, gu $$1) {
      ...
      if ($$4 == null) {
         ...
         $$0.B_().c(jc.as).flatMap($$0x -> $$0x.b(ol.e)).ifPresent($$2x -> ((dmz)$$2x.a()).a($$0, $$0.k().g(), aru.a($$5.a()), $$5));
         $$4 = $$5;
      } else {
   ...
   private static ehd b(akk $$0, gu $$1) {
      ehd $$2 = new ehd((double)$$1.u(), 0.0, (double)$$1.w()).d();
      int $$3 = 1024;
      ehd $$4 = $$2.a(1024.0);
   ...
   private static boolean a(akk $$0, ehd $$1) {
      return a((cpl)$$0, $$1).a() == -1;
   }

   private static gu a(cor $$0, gu $$1, int $$2, boolean $$3) {
      gu $$4 = null;
   ...
   private static dhg a(cpl $$0, ehd $$1) {
      return $$0.d(arp.a($$1.c / 16.0), arp.a($$1.e / 16.0));
   }

   @Nullable
   private static gu a(dhg $$0) {
      cos $$1 = $$0.f();
      ...
      for (gu $$7 : gu.a($$2, $$4)) {
         ...
         gu $$9 = $$7.c();
         gu $$10 = $$7.b(2);
         if ($$8.a(csm.fz) && !$$0.a_($$9).r($$0, $$9) && !$$0.a_($$10).r($$0, $$10)) {
   ...
   private static void a(akk $$0, gu $$1, dpp $$2) {
      dnm.L.a($$2, $$0, $$0.k().g(), aru.a(), $$1);
   }

   @Override
   public boolean a(ha $$0) {
      return csl.a(this.q(), this.o, this.p(), $$0, this.p().a($$0));
   }
