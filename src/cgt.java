public abstract class cgt extends chz implements cgz {
   private static final ajx<Boolean> a = akb.a(cgt.class, ajz.k);

   public cgt(bur<? extends cgt> $$0, dgi $$1) {
      super($$0, $$1);
      this.bP = new cgt.a(this);
   }

   public static bwn.a m() {
      return bvi.C().a(bwo.s, 3.0);
   }
   ...
   protected void B() {
      ...
      this.bS.a(2, new cbl<>(this, cox.class, 8.0F, 1.6, 1.4, bup.f::test));
