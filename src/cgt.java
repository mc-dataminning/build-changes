...
public class cgt extends cht {
   ...
   public cgt(int $$0, cdy $$1) {
      this($$0, $$1, chc.a);
   }

   public cgt(int $$0, cdy $$1, chc $$2) {
      super(chy.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected chu l() {
      return chu.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   protected boolean a(cdz $$0, boolean $$1) {
      return ($$0.fU().d || $$0.cf >= this.w.b()) && this.w.b() > 0;
   }
   ...
   protected void a(cdz $$0, clo $$1) {
      ...
      this.o.a(($$1x, $$2x) -> {
         dhn $$3 = $$1x.a_($$2x);
         if (!$$0.fU().d && $$3.a(ark.M) && $$0.eh().i() < 0.12F) {
            dhn $$4 = cuf.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         clo $$4 = $$0.p();
         clo $$5 = this.q.a(1);
         Map<cpz, Integer> $$6 = cqb.a($$4);
         $$2 += $$0.I() + ($$5.b() ? 0 : $$5.I());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(clr.uo) && !ckk.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<cpz, Integer> $$16 = cqb.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (cpz $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fU().d || $$0.a(clr.uo)) {
                        $$22 = true;
                     }
