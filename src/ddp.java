...
public class ddp {
   public static <T> List<ddp.b> a(List<T> $$0, Function<T, List<jn<eia>>> $$1, boolean $$2) {
      Object2IntMap<eia> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, eia c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jn<eia>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (jj<eia> $$12 : $$10.get($$11)) {
               eia $$13 = $$12.a();
      ...
      Builder<ddp.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<eia> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new ddp.b($$28));
      }
   ...
   public static record b(List<eia> a, ToIntFunction<eia> b) {
      b(List<eia> $$0) {
         this($$0, ac.h($$0));
      }
   }
