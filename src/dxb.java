...
public class dxb {
   ...
   static class a implements dxb.i {
      @Override
      public boolean a(dxb.v $$0) {
         return $$0.c[ha.f.d()] && !$$0.b[ha.f.d()].d;
      }

      @Override
      public dxb.r a(ha $$0, dxb.v $$1, aru $$2) {
         $$1.d = true;
         $$1.b[ha.f.d()].d = true;
         return new dxb.k($$0, $$1);
      }
   }

   static class b implements dxb.i {
      @Override
      public boolean a(dxb.v $$0) {
      ...
      public dxb.r a(ha $$0, dxb.v $$1, aru $$2) {
         ...
         return new dxb.l($$0, $$1);
      }
   }

   static class c implements dxb.i {
      @Override
      public boolean a(dxb.v $$0) {
      ...
      public dxb.r a(ha $$0, dxb.v $$1, aru $$2) {
         $$1.d = true;
         $$1.b[ha.b.d()].d = true;
         return new dxb.m($$0, $$1);
      }
   }

   static class d implements dxb.i {
      @Override
      public boolean a(dxb.v $$0) {
      ...
      public dxb.r a(ha $$0, dxb.v $$1, aru $$2) {
         ...
         return new dxb.n($$0, $$1);
      }
   }

   static class e implements dxb.i {
      @Override
      public boolean a(dxb.v $$0) {
      ...
      public dxb.r a(ha $$0, dxb.v $$1, aru $$2) {
         ...
         $$3.d = true;
         $$3.b[ha.c.d()].d = true;
         return new dxb.o($$0, $$3);
      }
   }

   static class f implements dxb.i {
      @Override
      public boolean a(dxb.v $$0) {
         return true;
      }
      ...
      public dxb.r a(ha $$0, dxb.v $$1, aru $$2) {
         $$1.d = true;
         return new dxb.s($$0, $$1, $$2);
      }
   }

   static class g implements dxb.i {
      @Override
      public boolean a(dxb.v $$0) {
      ...
      public dxb.r a(ha $$0, dxb.v $$1, aru $$2) {
         $$1.d = true;
         return new dxb.t($$0, $$1);
      }
   }

   public static class h extends dxb.r {
      ...
      private dxb.v G;
      private dxb.v H;
      private final List<dxb.r> I = Lists.newArrayList();

      public h(aru $$0, int $$1, int $$2, ha $$3) {
         super(dvq.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dxb.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dxb.p($$3, this.G));
         this.I.add(new dxb.j($$3, this.H));
         List<dxb.i> $$5 = Lists.newArrayList();
         $$5.add(new dxb.b());
         $$5.add(new dxb.d());
         $$5.add(new dxb.e());
         $$5.add(new dxb.a());
         ...
         dur $$10 = dur.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dur $$11 = dur.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dur $$12 = dur.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dxb.u($$3, $$10, $$13++));
         this.I.add(new dxb.u($$3, $$11, $$13++));
         this.I.add(new dxb.q($$3, $$12));
      }
      ...
      private List<dxb.v> b(aru $$0) {
         dxb.v[] $$1 = new dxb.v[75];
         ...
         dxb.v $$23 = new dxb.v(1003);
         dxb.v $$24 = new dxb.v(1001);
         dxb.v $$25 = new dxb.v(1002);
         $$1[v].a(ha.b, $$23);
         $$1[w].a(ha.d, $$24);
         $$1[x].a(ha.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<dxb.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cqg $$2, aru $$3, dur $$4) {
         int $$5 = 24;
      ...
      private void a(cqg $$0, aru $$1, dur $$2) {
      ...
      private void b(cqg $$0, aru $$1, dur $$2) {
      ...
      private void c(cqg $$0, aru $$1, dur $$2) {
      ...
      private void d(cqg $$0, aru $$1, dur $$2) {
      ...
      private void e(cqg $$0, aru $$1, dur $$2) {
      ...
      private void f(cqg $$0, aru $$1, dur $$2) {
   ...
   interface i {
      boolean a(dxb.v var1);

      dxb.r a(ha var1, dxb.v var2, aru var3);
   }

   public static class j extends dxb.r {
      public j(ha $$0, dxb.v $$1) {
         super(dvq.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cqg $$0, cqe $$1, dgx $$2, aru $$3, dur $$4, cot $$5, gu $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, csn.ch.n(), csn.ch.n(), false);
   ...
   public static class k extends dxb.r {
      public k(ha $$0, dxb.v $$1) {
         super(dvq.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends dxb.r {
      public l(ha $$0, dxb.v $$1) {
         super(dvq.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dxb.r {
      public m(ha $$0, dxb.v $$1) {
         super(dvq.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends dxb.r {
      public n(ha $$0, dxb.v $$1) {
         super(dvq.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends dxb.r {
      public o(ha $$0, dxb.v $$1) {
         super(dvq.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dxb.r {
      public p(ha $$0, dxb.v $$1) {
         super(dvq.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dxb.r {
      public q(ha $$0, dur $$1) {
         super(dvq.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dvd {
      protected static final dfa b = csn.hZ.n();
      protected static final dfa c = csn.ia.n();
      protected static final dfa d = csn.ib.n();
      protected static final dfa h = c;
      protected static final dfa i = csn.ii.n();
      protected static final boolean j = true;
      protected static final dfa k = csn.G.n();
      protected static final Set<csm> l = ImmutableSet.builder().add(csn.dO).add(csn.iC).add(csn.mW).add(k.b()).build();
      ...
      public r(dvq $$0, ha $$1, int $$2, dur $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dvq $$0, int $$1, ha $$2, dxb.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dur a(ha $$0, dxb.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dur $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cqg $$0, dur $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dfa $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cqg $$0, dur $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cqg $$0, dur $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dfa $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dur $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cqg $$0, dur $$1, int $$2, int $$3, int $$4) {
         gu $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            byq $$6 = bim.A.a((cpm)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eK());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dk()), bjc.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dxb.r {
      private int a;

      public s(ha $$0, dxb.v $$1, aru $$2) {
         super(dvq.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends dxb.r {
      public t(ha $$0, dxb.v $$1) {
         super(dvq.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dxb.r {
      private int a;

      public u(ha $$0, dur $$1, int $$2) {
         super(dvq.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
