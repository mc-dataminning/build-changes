...
public final class dxb extends dvi {
   ...
   public static final Codec<dxb> e = arg.<dxb>a(
         RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     a($$0),
                     dwr.b.fieldOf("start_pool").forGetter($$0x -> $$0x.f),
                     aex.a.optionalFieldOf("start_jigsaw_name").forGetter($$0x -> $$0x.g),
      ...
      .codec();
   private final hg<dwr> f;
   private final Optional<aex> g;
   private final int h;
   private final dtp i;
   ...
   public dxb(dvi.c $$0, hg<dwr> $$1, Optional<aex> $$2, int $$3, dtp $$4, boolean $$5, Optional<dks.a> $$6, int $$7) {
      super($$0);
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public dxb(dvi.c $$0, hg<dwr> $$1, int $$2, dtp $$3, boolean $$4, dks.a $$5) {
      this($$0, $$1, Optional.empty(), $$2, $$3, $$4, Optional.of($$5), 80);
   }

   public dxb(dvi.c $$0, hg<dwr> $$1, int $$2, dtp $$3, boolean $$4) {
