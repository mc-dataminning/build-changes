...
public abstract class gxu<T extends bxj, S extends hdz, M extends ggk<? super S>> extends gws<T, S> implements gyq<S, M> {
   private static final float a = 0.1F;
   protected M g;
   protected final hga h;
   protected final List<hbh<S, M>> i = Lists.newArrayList();

   public gxu(gwt.a $$0, M $$1, float $$2) {
      super($$0);
      this.h = $$0.b();
      this.g = $$1;
      this.e = $$2;
   ...
   protected final boolean a(hbh<S, M> $$0) {
      return this.i.add($$0);
   }
   ...
   public void a(S $$0, fjy $$1, gqm $$2, int $$3) {
      ...
      boolean $$7 = this.d($$0);
      boolean $$8 = !$$7 && !$$0.an;
      gqx $$9 = this.a($$0, $$7, $$8, $$0.ao);
      if ($$9 != null) {
         fkc $$10 = $$2.getBuffer($$9);
         int $$11 = a($$0, this.c($$0));
   ...
   @Nullable
   protected gqx a(S $$0, boolean $$1, boolean $$2, boolean $$3) {
      alg $$4 = this.b($$0);
      if ($$2) {
         return gqx.i($$4);
      } else if ($$1) {
         ...
         return $$3 ? gqx.s($$4) : null;
      }
   }

   public static int a(hdz $$0, float $$1) {
      return hja.a(hja.a($$1), hja.a($$0.am));
   }
   ...
   protected void a(S $$0, fjy $$1, float $$2, float $$3) {
      if (this.a($$0)) {
   ...
   public void a(T $$0, S $$1, float $$2) {
      ...
      label48: {
         ...
         $$1.am = $$0.aN > 0 || $$0.aP > 0;
         czk $$5 = $$0.a(bws.f);
         if ($$5.h() instanceof cxs $$6 && $$6.c() instanceof dli $$7) {
            $$1.au = $$7.b();
            $$1.av = $$5.a(kk.ak);
            $$1.as.b();
            break label48;
