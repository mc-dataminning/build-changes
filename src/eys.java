...
public class eys {
   private static final aeu a = new aeu("advancements/title_box");
   ...
   private final arf r;
   private final int s;
   private final List<arf> t;
   private final eqq u;
   @Nullable
   private eys v;
   private final List<eys> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public eys(eyq $$0, eqq $$1, ag $$2, aq $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = qp.a().a($$1.h.a($$3.a(), 163));
      this.y = ars.d($$3.f() * 28.0F);
      this.z = ars.d($$3.g() * 27.0F);
      int $$4 = $$2.a().g().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = qp.a().a(this.a(tk.a($$3.b().e(), ue.a.a($$3.e().b())), $$7));
   ...
   private static float a(erc $$0, List<tm> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<tm> a(ti $$0, int $$1) {
      erc $$2 = this.u.h.b();
      List<tm> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<tm> $$6 = $$2.b($$0, $$1 - $$5, ue.a);
   ...
   public void a(esa $$0, int $$1, int $$2, boolean $$3) {
      if (this.v != null) {
         int $$4 = $$1 + this.v.y + 13;
   ...
   public void a(esa $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
