...
public class eys {
   ...
   public static final eys.a bv;

   public static eys.a a(int $$0, int $$1) {
      return $$0 == -1 ? eys.b.b.a($$1) : eys.b.a.a($$0);
   }

   public static eys.a a(String $$0) {
      if (eys.a.e.containsKey($$0)) {
         return eys.a.e.get($$0);
      } else {
         for (eys.b $$1 : eys.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eys.b b;
      private final int c;
      private final ays<xo> d;
      static final Map<String, eys.a> e = Maps.newHashMap();

      a(String $$0, eys.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      c("key.mouse", ($$0, $$1) -> um.a().b($$1) ? xo.c($$1) : xo.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<eys.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xo> g;

      private static void a(eys.b $$0, String $$1, int $$2) {
         eys.a $$3 = new eys.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public eys.a a(int $$0) {
         return (eys.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
