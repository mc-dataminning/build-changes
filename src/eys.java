...
public class eys {
   private static final aez a = new aez("advancements/title_box");
   ...
   public eys(eyq $$0, eqp $$1, ag $$2, aq $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = qr.a().a($$1.h.a($$3.a(), 163));
      this.y = asb.d($$3.f() * 28.0F);
      this.z = asb.d($$3.g() * 27.0F);
      int $$4 = $$2.a().g().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = qr.a().a(this.a(to.a($$3.b().f(), ui.a.a($$3.e().b())), $$7));
   ...
   private static float a(erb $$0, List<tq> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<tq> a(tl $$0, int $$1) {
      erb $$2 = this.u.h.b();
      List<tq> $$3 = null;
   ...
   public void a(erz $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
