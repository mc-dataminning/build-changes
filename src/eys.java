...
public class eys {
   ...
   private static final Queue<eys.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eys.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eys::a), eyq::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eys::a), eyq::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eys.a(this.b) + ", type=" + eys.b(this.c) + ", severity=" + eys.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
