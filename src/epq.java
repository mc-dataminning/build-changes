...
public class epq {
   ...
   public void a(era $$0, String $$1, erw.a $$2, efu $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  epq.b $$13 = new epq.b($$1.trim(), this.f, $$3, $$2);
                  epq.a $$14 = new epq.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        epq.c $$30 = new epq.c(this.f, $$2, $$0);
                        epq.a $$31 = new epq.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new ere(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, efu $$2) throws IOException {
      ...
      File $$15 = new File(euk.N().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final efu d;
      private final erw.a e;

      b(String $$0, File $$1, efu $$2, erw.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((epq.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !epq.this.b && !epq.this.d) {
            try {
               epq.this.e = true;
               epq.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               epq.a.error("Error extracting archive", var3);
               epq.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final erw.a c;
      private final era d;

      c(File $$0, erw.a $$1, era $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((epq.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !epq.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, epq.this.g);
                  epq.this.c = true;
               } else {
                  epq.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  epq.this.d = true;
               }
            } catch (IOException var3) {
               epq.a.error("Error copying resourcepack file: {}", var3.getMessage());
               epq.this.d = true;
            }
         }
      }
