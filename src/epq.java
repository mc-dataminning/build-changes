...
public class epq {
   ...
   public ir a() {
      return new ir(this.a, this.b, this.c);
   }

   public ewu b() {
      return new ewu((double)this.a, (double)this.b, (double)this.c);
   }
   ...
   public static epq b(we $$0) {
      epq $$1 = new epq($$0.readInt(), $$0.readInt(), $$0.readInt());
      a($$0, $$1);
      return $$1;
   }

   protected static void a(we $$0, epq $$1) {
      $$1.j = $$0.readFloat();
      $$1.k = $$0.readFloat();
      $$1.i = $$0.readBoolean();
      $$1.l = $$0.b(epv.class);
