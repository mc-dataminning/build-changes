...
public enum epq implements axg {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final axg.a<epq> t = axg.a(epq::values);
   public static final IntFunction<epq> u = ave.a(epq::a, values(), ave.a.a);
   private final int v;
   private final String w;

   private epq(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
