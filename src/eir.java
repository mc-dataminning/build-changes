...
public class eir implements eib {
   public static final Codec<eir> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               emp.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               ekc.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               ekc.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               edy.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, eir::new)
   );
   ...
   public eir(jr<emp> $$0, int $$1, int $$2, axf<djl> $$3, ekc $$4, int $$5, int $$6, int $$7, int $$8, ekc $$9, int $$10, int $$11, edy $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
