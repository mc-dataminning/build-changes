...
public class eir {
   private static final eir a = new eir(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public eir.a a(int $$0, int $$1) {
         return new eir.a(1.0, 0.0);
      }
   ...
   private static final exd b = exd.b(new eiq(42L), qm.a);
   ...
   private final Long2ObjectOpenHashMap<eis> h;
   private final Long2ObjectOpenHashMap<eis> i;

   public static eir a() {
      return a;
   }

   public static eir a(@Nullable asj $$0) {
      if ($$0 == null) {
         return a;
      } else {
         djo $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<eis> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<eis> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = azz.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new eir($$2, $$3);
         }
      }
   }

   eir(Long2ObjectOpenHashMap<eis> $$0, Long2ObjectOpenHashMap<eis> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public eir.a a(int $$0, int $$1) {
      int $$2 = jr.a($$0);
      int $$3 = jr.a($$1);
      double $$4 = this.a($$2, 0, $$3, eis::a);
      if ($$4 != Double.MAX_VALUE) {
         return new eir.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(jr.d(djo.a($$5x)), jr.d(djo.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = (double)azz.f((float)($$2 - $$5xx), (float)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = azz.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new eir.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(ehi.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(jr.d(djo.a($$6x)), jr.d(djo.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = azz.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = azz.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return azz.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, eir.b $$3) {
      int $$4 = jr.e($$0);
      int $$5 = jr.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(eir.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      eis $$6 = (eis)this.h.get(djo.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - jr.d($$1), $$4, $$5 - jr.d($$2)) : Double.MAX_VALUE;
   }

   public dlp a(dlp $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jg<dlm> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jg<dlm> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jg<dlm>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(jr.d(djo.a($$5x)), $$1, jr.d(djo.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = (double)azz.f((float)($$0 - $$4xx), (float)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = azz.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (jg)$$4.getValue();
      }
   }

   public static void a(asj $$0, edn $$1) {
      djo $$2 = $$1.f();
      boolean $$3 = $$1.u();
      iw.a $$4 = new iw.a();
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(ehp.a.e, $$16, $$17)) + 1;
   ...
   private static void a(edn $$0, iw $$1) {
      ebq $$2 = $$0.a_($$1);
      if ($$2.a(axn.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(dli $$0, eeh $$1) {
      djo $$2 = $$1.f();
      Builder<jd, eis> $$3 = ImmutableMap.builder();
   ...
   public static eir.c a(@Nullable eis $$0, Map<jd, eis> $$1) {
      List<eir.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static eir.c a(@Nullable jd $$0, eis $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jc $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return azz.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(eis var1, int var2, int var3, int var4);
   }
