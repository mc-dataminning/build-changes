...
public class dii extends dil<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dii(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dii $$1 && super.equals($$0)) {
   ...
   public static dii a(String $$0, int $$1, int $$2) {
      return new dii($$0, $$1, $$2);
   }
