...
public final class gha {
   ...
   private static final gha c = new gha(HostAndPort.fromParts("server.invalid", 25565));

   public gha(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private gha(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static gha a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new gha($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof gha ? this.b.equals(((gha)$$0).b) : false;
      }
   }
