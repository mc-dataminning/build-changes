...
public interface gha {
   static gha a(ghg $$0, UserApiService $$1) {
      return new gha.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, ghi var2, AbuseReport var3);
   ...
   public static record b(ghg a, UserApiService b) implements gha {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, ghi $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               wp $$5 = this.a(var7);
               throw new CompletionException(new gha.a($$5, var7));
            } catch (MinecraftClientException var8) {
               wp $$7 = this.a(var8);
               throw new CompletionException(new gha.a($$7, var8));
            }
         }, af.i());
      }
