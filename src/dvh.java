...
public class dvh implements dvd, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bpn<bpp.b> c;
   private final dvm d;
   private final Map<dbf, dvh.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dvh(dvo $$0, Path $$1, boolean $$2) {
      this.d = new dvm($$0, $$1, $$2);
      this.c = new bpn<>(new bpp.a(dvh.b.values().length), ac.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dbf $$0, int $$1) {
      dbf $$2 = new dbf($$0.e - $$1, $$0.f - $$1);
      dbf $$3 = new dbf($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(dbf $$0, @Nullable us $$1) {
      return this.a(() -> {
         dvh.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dvh.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(dbf $$0, vm $$1) {
      return this.a(() -> {
         try {
            dvh.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new bpp.b(dvh.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<dbf, dvh.a>> $$0 = this.e.entrySet().iterator();
         Entry<dbf, dvh.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new bpp.b(dvh.b.b.ordinal(), this::a));
   }

   private void a(dbf $$0, dvh.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new bpp.b(dvh.b.c.ordinal(), () -> $$0.a(bac.a))).join();
         this.c.close();
