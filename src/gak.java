...
public class gak extends gcb {
   private final float a;
   private final gbw b;

   gak(fxu $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gbw $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements gbe<la> {
      ...
      public gbb a(la $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == dle.a) {
            ...
            iz $$9 = iz.a($$2, $$3, $$4);
            int $$10 = ffe.Q().av().a($$8, $$1, $$9);
            if ($$8.b() instanceof dhu) {
               $$10 = ((dhu)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new gak($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
