...
public class gak extends fyz<cbw> {
   public gak(fza.a $$0) {
      super($$0);
   }

   public void a(cbw $$0, float $$1, float $$2, eqk $$3, ftt $$4, int $$5) {
      $$3.a();
      $$3.a(a.d.rotationDegrees(180.0F - $$1));
      cbx $$6 = $$0.q().a();
      float $$7 = 0.0625F;
      $$3.b(0.0625F, 0.0625F, 0.0625F);
      eqo $$8 = $$4.getBuffer(fub.c(this.a($$0)));
      gfz $$9 = evr.O().aD();
   ...
   private void a(eqk $$0, eqo $$1, cbw $$2, int $$3, int $$4, gfb $$5, gfb $$6) {
      eqk.a $$7 = $$0.c();
      Matrix4f $$8 = $$7.a();
      Matrix3f $$9 = $$7.b();
      ...
      for (int $$29 = 0; $$29 < $$25; $$29++) {
         for (int $$30 = 0; $$30 < $$26; $$30++) {
            ...
            int $$35 = $$2.dp();
            int $$36 = aup.a($$2.ds() + (double)(($$33 + $$34) / 2.0F / 16.0F));
            int $$37 = $$2.dv();
            ic $$38 = $$2.cE();
            if ($$38 == ic.c) {
               $$35 = aup.a($$2.dq() + (double)(($$31 + $$32) / 2.0F / 16.0F));
            }

            if ($$38 == ic.e) {
               $$37 = aup.a($$2.dw() - (double)(($$31 + $$32) / 2.0F / 16.0F));
            }
            ...
            int $$39 = ftr.a($$2.dL(), new hx($$35, $$36, $$37));
   ...
   private void a(Matrix4f $$0, Matrix3f $$1, eqo $$2, float $$3, float $$4, float $$5, float $$6, float $$7, int $$8, int $$9, int $$10, int $$11) {
      $$2.a($$0, $$3, $$4, $$7).a(255, 255, 255, 255).a($$5, $$6).c(ges.d).b($$11).a($$1, (float)$$8, (float)$$9, (float)$$10).e();
   }
}
