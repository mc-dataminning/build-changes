...
public interface ho<T> {
   ...
   hq<T> a(@Nullable ty var1, CommandDispatcher<T> var2) throws ef;
   ...
   static <T extends ee<T>> ho<T> a(akf $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      hp<T> $$4 = new hp<>();
   ...
   static <T extends ee<T>> hf<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new hh.c<>($$2.getString(), $$4.get());
      }
   }
}
