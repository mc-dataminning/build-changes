...
public final class cxm {
   ...
   public static final cxm a = new cxm(jv.a());
   public static final Codec<cxm> b = cxm.a.a.sizeLimitedListOf(256).xmap(cxm::b, cxm::f);
   public static final yw<wj, cxm> c = cuo.h.a(yu.c(256)).a(cxm::new, $$0 -> $$0.f);
   private final jv<cuo> f;
   private final int g;

   private cxm(jv<cuo> $$0) {
      if ($$0.size() > 256) {
   ...
   private static cxm b(List<cxm.a> $$0) {
      OptionalInt $$1 = $$0.stream().mapToInt(cxm.a::a).max();
      if ($$1.isEmpty()) {
         return a;
      } else {
         cxm $$2 = new cxm($$1.getAsInt() + 1);
   ...
   public static cxm a(List<cuo> $$0) {
      int $$1 = c($$0);
      if ($$1 == -1) {
         return a;
      } else {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof cxm $$1 && cuo.a(this.f, $$1.f)) {
            return true;
         }
   ...
   static record a(int b, cuo c) {
      public static final Codec<cxm.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.intRange(0, 255).fieldOf("slot").forGetter(cxm.a::a), cuo.b.fieldOf("item").forGetter(cxm.a::b)).apply($$0, cxm.a::new)
      );
