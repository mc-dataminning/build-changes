...
public class fjb implements AutoCloseable {
   private final fiz.a a;
   @Nullable
   private fiz.a b;
   private final fjb.a c;

   public fjb(fiz.a $$0, fjb.a $$1) {
      this.a = $$0;
      this.c = $$1;
   }

   private static Vector3f[] a(ByteBuffer $$0, int $$1, fjh $$2) {
      int $$3 = $$2.a(fji.b);
      if ($$3 == -1) {
   ...
   @Nullable
   public fjb.b a(fiz $$0, fjk $$1) {
      if (this.c.d() != fjh.c.h) {
         return null;
      } else {
         Vector3f[] $$2 = a(this.a.a(), this.c.b(), this.c.a());
         fjb.b $$3 = new fjb.b($$2, this.c.e());
         this.b = $$3.a($$0, $$1);
         return $$3;
      }
   }
   ...
   public static record a(fjh a, int b, int c, fjh.c d, fjh.b e) {
   }

   public static record b(Vector3f[] a, fjh.b b) {
      @Nullable
      public fiz.a a(fiz $$0, fjk $$1) {
         int[] $$2 = $$1.sort(this.a);
      ...
      private IntConsumer a(long $$0, fjh.b $$1) {
