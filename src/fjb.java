...
public class fjb extends hlf {
   ...
   private static final hlg b = new hlg(Duration.ofSeconds(5L));
   private final List<fki> c;
   private final fum C;
   private final fsm D = fsm.d();
   private volatile wp E;
   @Nullable
   private fpj F;

   public fjb(fum $$0, fki... $$1) {
      super(flb.a);
      this.C = $$0;
      this.c = List.of($$1);
      if (this.c.isEmpty()) {
         ...
         $$3.setUncaughtExceptionHandler(new fif(a));
         $$3.start();
      }
   }
   ...
   public void aR_() {
      ...
      this.D.a(fou.a(wo.e, $$0 -> this.f()).a());
      this.D.a($$1 -> {
