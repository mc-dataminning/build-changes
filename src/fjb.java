...
public class fjb {
   ...
   private int k;
   private double l;
   private final baa m = new baa();
   private final baa n = new baa();
   private double o;
   private double p;
   private final fjk q;
      ...
      if ($$0 == this.b.aP().i()) {
         ...
         if (this.b.aN() == null) {
            if (this.b.z == null) {
               ...
               if ($$4) {
                  $$9.x();
                  fqs.a(() -> $$6[0] = $$9.a($$7, $$8, $$5), "mouseClicked event handler", $$9.getClass().getCanonicalName());
               } else {
                  fqs.a(() -> $$6[0] = $$9.b($$7, $$8, $$5), "mouseReleased event handler", $$9.getClass().getCanonicalName());
               }
            }
         }
            ...
            if (this.b.z != null) {
               ...
               if (this.b.t.R_()) {
                  if (this.b.m.g().a()) {
                     ...
                     float $$11 = azj.a(this.b.t.gl().a() + (float)$$9.y * 0.005F, 0.0F, 0.2F);
                     this.b.t.gl().a($$11);
                  }
               } else {
                  cog $$12 = this.b.t.gk();
                  $$12.e(fjk.a((double)$$10, $$12.j, cog.g()));
               }
            }
         }
      }
   ...
   public void a() {
      ...
      if (this.b.aC()) {
         ...
         if ($$2 != null && this.b.aN() == null && $$3) {
            ...
            fqs.a(() -> $$2.f($$4, $$5), "mouseMoved event handler", $$2.getClass().getCanonicalName());
            if (this.i != -1 && this.l > 0.0) {
               ...
               fqs.a(() -> $$2.a($$4, $$5, this.i, $$6, $$7), "mouseDragged event handler", $$2.getClass().getCanonicalName());
            }
   ...
   public void i() {
      if (this.b.aC()) {
         if (!this.s) {
            ...
            fco.a(this.b.aP().i(), 212995, this.f, this.g);
            this.b.a(null);
            this.b.x = 10000;
            this.j = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.f = (double)(this.b.aP().n() / 2);
         this.g = (double)(this.b.aP().o() / 2);
         fco.a(this.b.aP().i(), 212993, this.f, this.g);
      }
   }
