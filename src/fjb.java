...
public class fjb<T extends blu> extends fke<T> {
   private final fmv a;
   private final fmv[] b;
   private final fmv f;
   ...
   public static fnb b() {
      fnd $$0 = new fnd();
      fne $$1 = $$0.a();
      $$1.a("head", fna.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), fmx.a);
      float $$2 = 0.0F;
      fna $$3 = fna.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = aun.b($$2) * 9.0F;
         float $$6 = -2.0F + aun.b((float)($$4 * 2) * 0.25F);
         float $$7 = aun.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, fmx.a($$5, $$6, $$7));
         $$2++;
      }
