...
public class qy extends qt<qz> {
   private static final int b = 24;
   public static final rp<qy> a = new rp.b<qy>() {
      public qy a(DataInput $$0, int $$1, rd $$2) throws IOException {
         $$2.a(24L);
         int $$3 = $$0.readInt();
         $$2.a(4L * (long)$$3);
         int[] $$4 = new int[$$3];
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof qy && Arrays.equals(this.c, ((qy)$$0).c);
   }
   ...
   public boolean b(int $$0, rn $$1) {
      if ($$1 instanceof rh) {
         this.c = ArrayUtils.add(this.c, $$0, ((rh)$$1).g());
         return true;
      } else {
         return false;
      }
