...
public class arl extends ark {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, arl.a> s;
   private final arg t;
   private long u;
   private final ahw v;

   private arl(ahw $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == arh.c($$2, 7, $$0.getLength());
      }
   }
