...
public class arl extends ark implements abg, wl {
   ...
   public arl(MinecraftServer $$0, vv $$1, arc $$2) {
      super($$0, $$1, $$2);
      this.g = $$2.a();
      this.j = $$2.c();
   }
   ...
   public void m() {
      ...
      je<akw> $$0 = this.c.bd();
      List<ate> $$1 = this.c.bg().b().flatMap($$0x -> $$0x.a().d().stream()).toList();
      this.b(new abd(coo.e.b(this.c.bb().K())));
      this.k = new arw($$1, $$0);
      this.h.add(this.k);
      this.o();
      this.h.add(new aru());
   ...
   private void o() {
      this.c.X().ifPresent($$0 -> this.h.add(new arv($$0)));
   }
   ...
   public void a(abh $$0) {
      zh.a($$0, this, this.c);
      this.a(aru.a);
      this.d.a(agd.b.bind(wi.a(this.c.bc())));
   ...
   private void a(ard.a $$0) {
      ard.a $$1 = this.i != null ? this.i.a() : null;
      if (!$$0.equals($$1)) {
