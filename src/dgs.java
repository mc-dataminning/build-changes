...
public class dgs extends dfg implements dfa {
   public static final MapCodec<dgs> d = b(dgs::new);
   public static final int e = 7;
   public static final dta f = dsq.av;
   private static final ewi[] a = new ewi[]{
      ...
      dex.a(0.0, 0.0, 0.0, 16.0, 10.0, 16.0),
      dex.a(0.0, 0.0, 0.0, 16.0, 12.0, 16.0),
      dex.a(0.0, 0.0, 0.0, 16.0, 14.0, 16.0),
      dex.a(0.0, 0.0, 0.0, 16.0, 16.0, 16.0)
   };
   ...
   public void a(dbw $$0, iz $$1, dsa $$2) {
   ...
   protected int a(dbw $$0) {
      return ayx.a($$0.z, 2, 5);
   }

   protected static float a(dex $$0, dbc $$1, iz $$2) {
      float $$3 = 1.0F;
      iz $$4 = $$2.d();
