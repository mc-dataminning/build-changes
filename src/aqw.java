...
class aqw implements Path {
   private static final BasicFileAttributes a = new aqu() {
      @Override
   ...
   private static final BasicFileAttributes b = new aqu() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<aqw> c = Comparator.comparing(aqw::n);
   ...
   public aqw(aqy $$0, String $$1, @Nullable aqw $$2, aqz $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private aqw a(@Nullable aqw $$0, String $$1) {
      return new aqw(this.e, $$1, $$0, aqz.b);
   }
   ...
   aqw a(String $$0) {
      if (a(this.i)) {
         return new aqw(this.e, $$0, this, this.i);
      } else if (this.i instanceof aqz.a $$1) {
         aqw $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new aqw(this.e, $$0, this, aqz.a);
      } else if (this.i instanceof aqz.b) {
         return new aqw(this.e, $$0, this, aqz.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(aqz $$0) {
      return $$0 == aqz.a || $$0 == aqz.b;
   }
   ...
   private aqw c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof aqw $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof aqz.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public aqz.a i() {
      return this.i instanceof aqz.a $$0 ? $$0 : null;
   }
