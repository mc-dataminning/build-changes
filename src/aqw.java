...
public class aqw implements aqt {
   ...
   private final Map<aqu, List<Path>> g;

   aqw(aqm $$0, Set<String> $$1, List<Path> $$2, Map<aqu, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(aqu $$0, ajc $$1, Consumer<Path> $$2) {
   ...
   public void a(aqu $$0, String $$1, String $$2, aqt.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<ajc, arx<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(aqt.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      aqv.a($$1, $$4, $$3, $$0);
   }
   ...
   public arx<InputStream> a(aqu $$0, ajc $$1) {
      return (arx<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && aqv.a($$5)) {
               return arx.create($$5);
            }
         }
   ...
   public <T> T a(arf<T> $$0) {
      arx<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public asi c() {
      return $$0 -> Optional.ofNullable(this.a(aqu.a, $$0)).map($$0x -> new asd(this, $$0x));
   }
}
