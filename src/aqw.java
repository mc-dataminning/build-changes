...
public class aqw {
   ...
   public static final Codec<te> b = a.flatXmap($$0 -> {
      try {
         return DataResult.success(te.a.a($$0));
      } catch (JsonParseException var2) {
         return DataResult.error(var2::getMessage);
      }
   }, $$0 -> {
      try {
         return DataResult.success(te.a.c($$0));
      } catch (IllegalArgumentException var2) {
         return DataResult.error(var2::getMessage);
      }
   });
   public static final Codec<te> c = Codec.STRING.flatXmap($$0 -> {
      try {
         return DataResult.success(te.a.a($$0));
      } catch (JsonParseException var2) {
         return DataResult.error(var2::getMessage);
   ...
   public static final Codec<aqw.d> o = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? aep.b($$0.substring(1)).map($$0x -> new aqw.d($$0x, true)) : aep.b($$0).map($$0x -> new aqw.d($$0x, false)), aqw.d::c
      );
   ...
   private static final MapCodec<GameProfile> y = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(hz.c.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
   ...
   public static Codec<String> w = a(
      Codec.STRING, $$0 -> !aep.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );

   public static <F, S> Codec<Either<F, S>> a(Codec<F> $$0, Codec<S> $$1) {
      return new aqw.e($$0, $$1);
   }
   ...
   public static <T> Codec<hj<T>> b(Codec<hj<T>> $$0) {
      return a(
         $$0,
         (Function<hj<T>, DataResult<hj<T>>>)($$0x -> $$0x.c().right().filter(List::isEmpty).isPresent()
   ...
   public static <T> Codec<T> c(Codec<T> $$0, Codec<T> $$1) {
   ...
   public static record d(aep a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
