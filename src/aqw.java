...
public class aqw implements AutoCloseable {
   ...
   private aqw(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static aqw.a a(Path $$0) {
         return new aqw.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
