...
public interface aqw {
   aqw a = new aqw() {
      ...
      @Override
      public void a(Consumer<dgw> $$0) {
      }
   };

   static aqw a(dgw $$0, int $$1) {
      return new aqw.a($$0, $$1);
   }

   static void a(aqw $$0, aqw $$1, Consumer<dgw> $$2, Consumer<dgw> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aqw.a $$4 && $$1 instanceof aqw.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new dgw($$10, $$11));
                     } else {
                        $$3.accept(new dgw($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(dgw b, int c) implements aqw {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(aqw.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return aqw.a(this.b.h, this.b.i, this.c, $$0, $$1, $$2);
      }
