...
public class efp implements dqh.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<efp> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final awb<efp> a = awb.a(f);
   private final eft g;
   private final eft h;
   private final eft i;
   ...
   public static efp a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new efp(new drp(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private efp(eft $$0, eft $$1, eft $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public efp(awo $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eft.a($$0, IntStream.rangeClosed(-15, 0)),
         eft.a($$0, IntStream.rangeClosed(-15, 0)),
         eft.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public efp a(awo $$0) {
      return new efp($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dqh.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         efq $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eft.b($$4 * $$13), eft.b($$5 * $$13), eft.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eft.b($$1 * $$13);
         double $$21 = eft.b($$2 * $$13);
         double $$22 = eft.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            efq $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return awh.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
