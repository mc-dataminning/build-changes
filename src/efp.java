...
public class efp {
   ...
   private static final djg.f e = ($$0, $$1, $$2) -> $$0.a(cws.co);
   ...
   public static Optional<efp> a(ctq $$0, hx $$1, ic.a $$2) {
      return a($$0, $$1, $$0x -> $$0x.a() && $$0x.k == 0, $$2);
   }

   public static Optional<efp> a(ctq $$0, hx $$1, Predicate<efp> $$2, ic.a $$3) {
      Optional<efp> $$4 = Optional.of(new efp($$0, $$1, $$3)).filter($$2);
      if ($$4.isPresent()) {
         return $$4;
      } else {
         ic.a $$5 = $$3 == ic.a.a ? ic.a.c : ic.a.a;
         return Optional.of(new efp($$0, $$1, $$5)).filter($$2);
      }
   }

   public efp(ctq $$0, hx $$1, ic.a $$2) {
      this.h = $$0;
      this.i = $$2;
   ...
   private static boolean a(djh $$0) {
      return $$0.i() || $$0.a(ash.aJ) || $$0.a(cws.ed);
   }
   ...
   public static elt a(l.a $$0, ic.a $$1, elt $$2, blw $$3) {
      ...
      if ($$4 > 0.0) {
         ...
         $$8 = auo.a(auo.c($$2.a($$1) - $$7, 0.0, $$4), 0.0, 1.0);
      } else {
         $$8 = 0.5;
      }
      ...
      if ($$5 > 0.0) {
         ic.a $$10 = ic.a.b;
         $$11 = auo.a(auo.c($$2.a($$10) - (double)$$6.a($$10), 0.0, $$5), 0.0, 1.0);
      } else {
         $$11 = 0.0;
      }
      ...
      return new elt($$8, $$11, $$14);
   }

   public static efo a(and $$0, l.a $$1, ic.a $$2, elt $$3, blv $$4, elt $$5, float $$6, float $$7) {
      hx $$8 = $$1.a;
      djh $$9 = $$0.a_($$8);
      ic.a $$10 = $$9.d(djx.H).orElse(ic.a.a);
      double $$11 = (double)$$1.b;
      double $$12 = (double)$$1.c;
      blw $$13 = $$4.a($$4.ap());
      int $$14 = $$2 == $$10 ? 0 : 90;
      elt $$15 = $$2 == $$10 ? $$5 : new elt($$5.e, $$5.d, -$$5.c);
      double $$16 = (double)$$13.a / 2.0 + ($$11 - (double)$$13.a) * $$3.a();
      double $$17 = ($$12 - (double)$$13.b) * $$3.b();
      double $$18 = 0.5 + $$3.c();
      boolean $$19 = $$10 == ic.a.a;
      elt $$20 = new elt((double)$$8.u() + ($$19 ? $$16 : $$18), (double)$$8.v() + $$17, (double)$$8.w() + ($$19 ? $$18 : $$16));
      elt $$21 = a($$20, $$0, $$4, $$13);
      return new efo($$21, $$15, $$6 + (float)$$14, $$7);
   }

   private static elt a(elt $$0, and $$1, blv $$2, blw $$3) {
      if (!($$3.a > 4.0F) && !($$3.b > 4.0F)) {
         double $$4 = (double)$$3.b / 2.0;
         elt $$5 = $$0.b(0.0, $$4, 0.0);
         emm $$6 = emj.a(elo.a($$5, (double)$$3.a, 0.0, (double)$$3.a).b(0.0, 1.0, 0.0).g(1.0E-6));
         Optional<elt> $$7 = $$1.a($$2, $$6, $$5, (double)$$3.a, (double)$$3.b, (double)$$3.a);
         Optional<elt> $$8 = $$7.map($$1x -> $$1x.a(0.0, $$4, 0.0));
         return $$8.orElse($$0);
      } else {
         return $$0;
      }
