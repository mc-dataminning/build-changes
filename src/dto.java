...
public class dto {
   private static final dto a = new dto(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dto.a a(int $$0, int $$1) {
         return new dto.a(1.0, 0.0);
      }
   ...
   private static final ehq b = ehq.b(new dtn(42L), pp.a);
   ...
   private final Long2ObjectOpenHashMap<dtp> h;
   private final Long2ObjectOpenHashMap<dtp> i;

   public static dto a() {
      return a;
   }

   public static dto a(@Nullable apm $$0) {
      if ($$0 == null) {
         return a;
      } else {
         cwg $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dtp> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dtp> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = aww.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dto($$2, $$3);
         }
      }
   }

   dto(Long2ObjectOpenHashMap<dtp> $$0, Long2ObjectOpenHashMap<dtp> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dto.a a(int $$0, int $$1) {
      int $$2 = iw.a($$0);
      int $$3 = iw.a($$1);
      double $$4 = this.a($$2, 0, $$3, dtp::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dto.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(iw.d(cwg.a($$5x)), iw.d(cwg.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(dsf.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(iw.d(cwg.a($$6x)), iw.d(cwg.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, dto.b $$3) {
      int $$4 = iw.e($$0);
      int $$5 = iw.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dto.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dtp $$6 = (dtp)this.h.get(cwg.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - iw.d($$1), $$4, $$5 - iw.d($$2)) : Double.MAX_VALUE;
   }

   public cyb a(cyb $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         il<cxy> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private il<cxy> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<il<cxy>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(iw.d(cwg.a($$5x)), $$1, iw.d(cwg.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(apm $$0, dov $$1) {
      cwg $$2 = $$1.f();
      boolean $$3 = $$1.s();
      ib.a $$4 = new ib.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dsm.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dov $$0, ib $$1) {
      dmz $$2 = $$0.a_($$1);
      if ($$2.a(aun.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(cxu $$0, dpq $$1) {
      cwg $$2 = $$1.f();
      Builder<ii, dtp> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dsi.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dto.c a(@Nullable dtp $$0, Map<ii, dtp> $$1) {
      List<dto.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dto.c a(@Nullable ii $$0, dtp $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (ih $$4 : $$0.a()) {
   ...
   interface b {
      double get(dtp var1, int var2, int var3, int var4);
   }
