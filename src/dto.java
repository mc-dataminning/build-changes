...
public class dto {
   ...
   private double j;
   int k = 29999984;
   private dto.a l = new dto.d(5.999997E7F);
   public static final dto.c d = new dto.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public iz b(double $$0, double $$1, double $$2) {
      return iz.a(ayu.a($$0, this.e(), this.g()), $$1, ayu.a($$2, this.f(), this.h()));
   }

   public double a(bsp $$0) {
   ...
   public boolean a(bsp $$0, evh $$1) {
      double $$2 = Math.max(ayu.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dto.a)($$0 == $$1 ? new dto.d($$1) : new dto.b($$0, $$1, $$2));
   ...
   class b implements dto.a {
      ...
      @Override
      public double a() {
         return ayu.a(dto.this.a() - this.e() / 2.0, (double)(-dto.this.k), (double)dto.this.k);
      }

      @Override
      public double c() {
         return ayu.a(dto.this.b() - this.e() / 2.0, (double)(-dto.this.k), (double)dto.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? ayu.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dtn i() {
         return this.c < this.b ? dtn.b : dtn.a;
      }
      ...
      @Override
      public dto.a l() {
         return (dto.a)(this.g() <= 0L ? dto.this.new d(this.c) : this);
      }
      ...
      public ewf m() {
         return ewc.a(
            ewc.c,
            ewc.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evq.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dto.c a(DynamicLike<?> $$0, dto.c $$1) {
         double $$2 = ayu.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = ayu.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dto.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dto.a {
      ...
      private void n() {
         this.c = ayu.a(dto.this.a() - this.b / 2.0, (double)(-dto.this.k), (double)dto.this.k);
         this.d = ayu.a(dto.this.b() - this.b / 2.0, (double)(-dto.this.k), (double)dto.this.k);
         this.e = ayu.a(dto.this.a() + this.b / 2.0, (double)(-dto.this.k), (double)dto.this.k);
         this.f = ayu.a(dto.this.b() + this.b / 2.0, (double)(-dto.this.k), (double)dto.this.k);
         this.g = ewc.a(
            ewc.c,
            ewc.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evq.e
