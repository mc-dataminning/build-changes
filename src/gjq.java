...
public interface gjq {
   ...
   public static record a(int d, int e, gjq.a.a f) implements gjq {
      public static final Codec<gjq.a> c = avu.a(
         RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     avu.j.fieldOf("width").forGetter(gjq.a::b), avu.j.fieldOf("height").forGetter(gjq.a::c), gjq.a.a.g.fieldOf("border").forGetter(gjq.a::d)
                  )
                  .apply($$0, gjq.a::new)
         ),
         gjq.a::a
      ...
      public static record a(int a, int b, int c, int d) {
         private static final Codec<gjq.a.a> e = avu.j.flatComapMap($$0 -> new gjq.a.a($$0, $$0, $$0, $$0), $$0 -> {
            OptionalInt $$1 = $$0.e();
            return $$1.isPresent() ? DataResult.success($$1.getAsInt()) : DataResult.error(() -> "Border has different side sizes");
         });
         private static final Codec<gjq.a.a> f = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     avu.i.fieldOf("left").forGetter(gjq.a.a::a),
                     avu.i.fieldOf("top").forGetter(gjq.a.a::b),
                     avu.i.fieldOf("right").forGetter(gjq.a.a::c),
                     avu.i.fieldOf("bottom").forGetter(gjq.a.a::d)
                  )
                  .apply($$0, gjq.a.a::new)
         );
   ...
   public static record c(int d, int e) implements gjq {
      public static final Codec<gjq.c> c = RecordCodecBuilder.create(
         $$0 -> $$0.group(avu.j.fieldOf("width").forGetter(gjq.c::b), avu.j.fieldOf("height").forGetter(gjq.c::c)).apply($$0, gjq.c::new)
      );
