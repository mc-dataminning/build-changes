...
public class gjq {
   public static class a implements gkj<lx> {
      ...
      public gkg a(lx $$0, ggy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gjq.b $$8 = new gjq.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends glg {
      b(ggy $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gks {
      ...
      c(ggy $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gki $$7, glb $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gjq.c $$0 = new gjq.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gkj<lx> {
      ...
      public gkg a(lx $$0, ggy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gjq.c $$8 = new gjq.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fmg.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gke {
      ...
      private int D;
      private final gki E;
      private final List<czu> F;
      private boolean G;

      public e(ggy $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gki $$7, List<czu> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gkg $$12 = this.E.a(lt.P, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gjq.c $$10 = (gjq.c)this.E.a(lt.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
