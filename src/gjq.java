...
public class gjq implements ajb {
   ...
   private final AtomicReference<gjq.a> l = new AtomicReference<>(gjq.a.a);

   public gjq(vr $$0, fos $$1, @Nullable gkg $$2, @Nullable fxu $$3, boolean $$4, @Nullable Duration $$5, Consumer<wy> $$6, @Nullable gkk $$7) {
      this.f = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a(gjq.a $$0) {
      gjq.a $$1 = this.l.updateAndGet($$1x -> {
         if (!$$0.f.contains($$1x)) {
   ...
   public void a(ajg $$0) {
      ...
      this.f
         .a(
            abj.d,
            new gjp(this.b, this.f, new gjw($$1, this.b.u().a(this.g, this.h, this.i), gju.a().a(), cuj.h, null, this.c, this.d, this.j, null, Map.of(), aly.a))
         );
      this.f.a(ajn.a);
      this.f.a(abj.b);
   ...
   public void a(vt $$0) {
      ...
      if (this.c != null && this.c.e()) {
         this.b.a(new hoy(this.d, $$1, $$0.a()));
      } else {
         this.b.a(new fxb(this.d, $$1, $$0));
      }
   }
   ...
   static enum a {
      ...
      private a(final wy $$0, final Set<gjq.a> $$1) {
         this.e = $$0;
         this.f = $$1;
      }
   }
