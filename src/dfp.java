...
public class dfp {
   ...
   private final Map<Character, Predicate<dfn>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dfp a(char $$0, Predicate<dfn> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dfo b() {
      return new dfo(this.c());
   }

   private Predicate<dfn>[][][] c() {
      this.d();
      Predicate<dfn>[][][] $$0 = (Predicate<dfn>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dfn>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
