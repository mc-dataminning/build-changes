...
public class fwn extends dtb {
   ...
   public fwn(fwr $$0, int $$1) {
      this.e = $$0;
      this.b = new dtd($$0, new dae(0, 0), $$0.H_().d(lf.az).g(dcd.b));
      this.c = new emj(this, true, $$0.D_().g());
   ...
   private static boolean a(@Nullable dth $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         dae $$3 = $$0.f();
   ...
   @Nullable
   public dth b(int $$0, int $$1, dtw $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         dth $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public dth a(int $$0, int $$1, vx $$2, ud $$3, Consumer<adb.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         dth $$6 = this.d.b.get($$5);
         dae $$7 = new dae($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new dth(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   public void a(dbg $$0, jq $$1) {
      fdz.Q().f.b($$1.a(), $$1.b(), $$1.c());
   }

   final class a {
      final AtomicReferenceArray<dth> b;
      final int c;
      private final int d;
      volatile int e;
      volatile int f;
      ...
      protected void a(int $$0, @Nullable dth $$1) {
         dth $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.g--;
            fwn.this.e.a($$2);
         }
      ...
      protected dth a(int $$0, dth $$1, @Nullable dth $$2) {
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.f - $$2; $$3 <= this.f + $$2; $$3++) {
               for (int $$4 = this.e - $$2; $$4 <= this.e + $$2; $$4++) {
                  dth $$5 = fwn.this.d.b.get(fwn.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     dae $$6 = $$5.f();
