...
public class fwn extends fwd<cud> {
   ...
   private final fvs aa = new fvs(0);
   private final fvs ab = new fvs(1);
   private final fvs ac = new fvs(2);
   @Nullable
   private cks ad;

   public fwn(cud $$0, cox $$1, wp $$2) {
   ...
   @Override
   protected void G() {
      this.ad = new cks(this.m.s, 0.0, 0.0, 0.0);
      this.ad.b(true);
      this.ad.a(true);
      this.ad.aX = 210.0F;
      this.ad.w(25.0F);
   ...
   public void E() {
      super.E();
      Optional<cxw> $$0 = this.H();
      this.aa.a(L);
      this.ab.a($$0.map(cxw::d).orElse(List.of()));
      this.ac.a($$0.map(cxw::o).orElse(List.of()));
   }

   private Optional<cxw> H() {
      cwq $$0 = this.z.b(0).g();
      return !$$0.f() && $$0.h() instanceof cxw $$1 ? Optional.of($$1) : Optional.empty();
   }
   ...
   protected void a(fof $$0, float $$1, int $$2, int $$3) {
      ...
      fwc.a($$0, (float)(this.C + 141), (float)(this.D + 75), 25.0F, V, W, null, this.ad);
   }
   ...
   protected void c(fof $$0, int $$1, int $$2) {
      if (this.I()) {
         $$0.a(gmj::H, G, $$1 + 65, $$2 + 46, 28, 21);
      }
   }

   private void d(fof $$0, int $$1, int $$2) {
      ...
      if (this.B != null) {
         ...
         } else if ($$4.h() instanceof cxw $$6 && $$5.f()) {
            if (this.B.d == 1) {
               $$3 = Optional.of($$6.b());
            } else if (this.B.d == 2) {
               $$3 = Optional.of($$6.c());
