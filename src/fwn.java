...
public class fwn implements fws.a {
   ...
   private final evi J;
   private final Map<hx, fwn.a> K = Maps.newHashMap();
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         blv $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dH();
      });
   }

   private void b(eqb $$0, fth $$1, double $$2, double $$3, double $$4) {
      hx $$5 = hx.a($$2, $$3, $$4);
   ...
   private void a(eqb $$0, fth $$1, fwn.a $$2) {
      int $$3 = 0;
   ...
   private void a(eqb $$0, fth $$1, xx.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         fxa.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(eqb $$0, fth $$1, xx.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(eqb $$0, fth $$1, String $$2, fwn.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      fws.a(this.J.am(), 8).ifPresent($$0 -> this.M = $$0.cw());
   }
