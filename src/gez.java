...
public class gez extends dzm {
   ...
   public gez(gfd $$0, int $$1) {
      this.e = $$0;
      this.b = new dzo($$0, new dgg(0, 0), $$0.K_().e(mb.aH).b(dij.b));
      this.c = new ete(this, true, $$0.G_().g());
      this.d = new gez.a(b($$1));
   }
   ...
   private static boolean a(@Nullable dzs $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         dgg $$3 = $$0.f();
   ...
   @Nullable
   public dzs b(int $$0, int $$1, eaj $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         dzs $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public dzs a(int $$0, int $$1, ws $$2, ux $$3, Consumer<aed.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         dzs $$6 = this.d.b.get($$5);
         dgg $$7 = new dgg($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new dzs(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<dzs> b;
      ...
      void a(int $$0, @Nullable dzs $$1) {
         dzs $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            gez.this.e.a($$2);
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  dzs $$5 = gez.this.d.b.get(gez.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     dgg $$6 = $$5.f();
            ...
            gez.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
