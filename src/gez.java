public class gez<T extends cag> extends gfe<T, flu<T>> {
   private final fwg a;

   public gez(gco<T, flu<T>> $$0, fwg $$1) {
      super($$0);
      this.a = $$1;
   }
   ...
   private void a(esa $$0, fvm $$1, int $$2, boolean $$3, dlf $$4, int $$5, giu $$6) {
      if ($$3) {
         this.a.b().a($$0.c(), $$1.getBuffer(fvu.r(ggt.e)), $$4, $$6, 0.0F, 0.0F, 0.0F, $$2, $$5);
      } else {
         this.a.a($$4, $$0, $$1, $$2, $$5);
      }
   }
