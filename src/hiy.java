...
public class hiy {
   ...
   public static class a extends Thread {
      private final hiy.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hiy.b $$0) throws IOException {
         super("LanServerDetector #" + hiy.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(hiy.b));
   ...
   public static class b {
      private final List<hix> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hix> a() {
         if (this.b) {
            List<hix> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
