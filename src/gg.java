...
public class gg implements ArgumentType<cuu> {
   ...
   public static cuu a(CommandContext<ex> $$0, String $$1) {
      return (cuu)$$0.getArgument($$1, cuu.class);
   }

   public cuu a(StringReader $$0) throws CommandSyntaxException {
