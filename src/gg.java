...
public class gg implements ArgumentType<cty> {
   ...
   public static cty a(CommandContext<ex> $$0, String $$1) {
      return (cty)$$0.getArgument($$1, cty.class);
   }

   public cty a(StringReader $$0) throws CommandSyntaxException {
