...
public class dfe {
   ...
   private boolean a(ib $$0) {
      return cyu.a(this.a, $$0) || cyu.a(this.a, $$0.c()) || cyu.a(this.a, $$0.d());
   }
   ...
   private dfe b(ib $$0) {
      dme $$2 = this.a.a_($$0);
      if (cyu.g($$2)) {
         return new dfe(this.a, $$0, $$2);
      } else {
         ib $$1 = $$0.c();
         $$2 = this.a.a_($$1);
         if (cyu.g($$2)) {
            return new dfe(this.a, $$1, $$2);
         } else {
            $$1 = $$0.d();
            $$2 = this.a.a_($$1);
            return cyu.g($$2) ? new dfe(this.a, $$1, $$2) : null;
         }
      }
   }
   ...
   public dfe a(boolean $$0, boolean $$1, dni $$2) {
      ib $$3 = this.b.e();
      ib $$4 = this.b.f();
      ib $$5 = this.b.g();
      ib $$6 = this.b.h();
