...
public class csf {
   ...
   public static final csf b = new csf(0, 0);
   ...
   public static csf a(int $$0, int $$1) {
      return new csf($$0 << 5, $$1 << 5);
   }

   public static csf b(int $$0, int $$1) {
      return new csf(($$0 << 5) + 31, ($$1 << 5) + 31);
   }
   ...
   public static long a(hv $$0) {
      return c(ix.a($$0.u()), ix.a($$0.w()));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof csf $$1) ? false : this.e == $$1.e && this.f == $$1.f;
      }
   }
   ...
   public hv a(int $$0, int $$1, int $$2) {
      return new hv(this.a($$0), $$1, this.b($$2));
   }

   public int a(int $$0) {
      return ix.a(this.e, $$0);
   }

   public int b(int $$0) {
      return ix.a(this.f, $$0);
   }

   public hv c(int $$0) {
      return new hv(this.b(), $$0, this.c());
   }
   ...
   public static Stream<csf> a(csf $$0, int $$1) {
      return a(new csf($$0.e - $$1, $$0.f - $$1), new csf($$0.e + $$1, $$0.f + $$1));
   }

   public static Stream<csf> a(final csf $$0, final csf $$1) {
      int $$2 = Math.abs($$0.e - $$1.e) + 1;
      int $$3 = Math.abs($$0.f - $$1.f) + 1;
      final int $$4 = $$0.e < $$1.e ? 1 : -1;
      final int $$5 = $$0.f < $$1.f ? 1 : -1;
      return StreamSupport.stream(new AbstractSpliterator<csf>((long)($$2 * $$3), 64) {
         @Nullable
         private csf e;

         @Override
         public boolean tryAdvance(Consumer<? super csf> $$0x) {
            if (this.e == null) {
               this.e = $$0;
            } else {
               int $$1 = this.e.e;
               ...
               if ($$1 == $$1.e) {
                  ...
                  this.e = new csf($$0.e, $$2 + $$5);
               } else {
                  this.e = new csf($$1 + $$4, $$2);
               }
            }
