...
class asi implements Path {
   private static final BasicFileAttributes a = new asg() {
      @Override
   ...
   private static final BasicFileAttributes b = new asg() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<asi> c = Comparator.comparing(asi::n);
   ...
   public asi(ask $$0, String $$1, @Nullable asi $$2, asl $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private asi a(@Nullable asi $$0, String $$1) {
      return new asi(this.e, $$1, $$0, asl.b);
   }
   ...
   asi a(String $$0) {
      if (a(this.i)) {
         return new asi(this.e, $$0, this, this.i);
      } else if (this.i instanceof asl.a $$1) {
         asi $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new asi(this.e, $$0, this, asl.a);
      } else if (this.i instanceof asl.b) {
         return new asi(this.e, $$0, this, asl.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(asl $$0) {
      return $$0 == asl.a || $$0 == asl.b;
   }
   ...
   private asi c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof asi $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof asl.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public asl.a i() {
      return this.i instanceof asl.a $$0 ? $$0 : null;
   }
