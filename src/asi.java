...
public class asi {
   ...
   final List<vx> g = Collections.synchronizedList(Lists.newArrayList());

   public asi(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (asi.this.e.am()) {
                  $$1.addLast("legacy_query", new asb(asi.this.d()));
               }

               vx.a($$1, zl.a, false, null);
               int $$2 = asi.this.e.o();
               vx $$3 = (vx)($$2 > 0 ? new wn($$2) : new vx(zl.a));
               asi.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new ask(asi.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     xd $$3 = xd.b("Internal server error");
                     $$1.a(new zt($$3), wk.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<asi.a.a> d = Lists.newArrayList();
