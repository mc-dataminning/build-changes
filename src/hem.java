...
public class hem implements hep.a, AutoCloseable {
   ...
   feu[] f;
   @Nullable
   private final hem.a g;
   private final aur h;

   public hem(akv $$0, hgg $$1, feu $$2, aur $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      this.g = $$3.a(hgf.b).map($$2x -> this.a($$1, $$2.a(), $$2.b(), $$2x)).orElse(null);
      this.e = $$2;
   ...
   @Nullable
   private hem.a a(hgg $$0, int $$1, int $$2, hgf $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      int $$7 = $$3.d();
      ...
      if ($$3.a().isEmpty()) {
         ...
         for (hge $$12 : $$10) {
            $$8.add(new hem.b($$12.a(), $$12.a($$7)));
         }

         int $$13 = 0;
         IntSet $$14 = new IntOpenHashSet();

         for (Iterator<hem.b> $$15 = $$8.iterator(); $$15.hasNext(); $$13++) {
            hem.b $$16 = $$15.next();
            boolean $$17 = true;
            if ($$16.b <= 0) {
      ...
      return $$8.size() <= 1 ? null : new hem.a(List.copyOf($$8), $$4, $$3.e());
   }
   ...
   class a {
      ...
      a(final List<hem.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * hem.this.c;
         int $$4 = this.b($$2) * hem.this.d;
         hem.this.a($$0, $$1, $$3, $$4, hem.this.f);
      }

      public heo a() {
         return hem.this.new d(this, this.d ? hem.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final feu[] b = new feu[hem.this.f.length];
      ...
      void a(int $$0, int $$1, hem.d $$2) {
         ...
         if ($$7 != $$8) {
            ...
            hem.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(hem.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return hem.this.f[$$2].a($$3 + ($$0.a($$1) * hem.this.c >> $$2), $$4 + ($$0.b($$1) * hem.this.d >> $$2));
      }
   ...
   class d implements heo {
      int a;
      int b;
      final hem.a c;
      @Nullable
      private final hem.c d;

      d(final hem.a $$0, @Nullable final hem.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
