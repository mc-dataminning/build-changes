...
public class lj {
   ...
   public static final li<la> b = a("block", false, la::a, la::b);
   public static final li<la> c = a("block_marker", true, la::a, la::b);
   ...
   public static final li<ld> n = a("dust", false, $$0 -> ld.c, $$0 -> ld.d);
   public static final li<lc> o = a("dust_color_transition", false, $$0 -> lc.c, $$0 -> lc.d);
   ...
   public static final li<lb> u = a("entity_effect", false, lb::a, lb::b);
   ...
   public static final li<la> C = a("falling_dust", false, la::a, la::b);
   ...
   public static final li<lk> J = a("sculk_charge", true, $$0 -> lk.a, $$0 -> lk.b);
   ...
   public static final li<ln> T = a("vibration", true, $$0 -> ln.a, $$0 -> ln.b);
   ...
   public static final li<ll> aV = a("shriek", false, $$0 -> ll.a, $$0 -> ll.b);
   ...
   public static final li<la> bb = a("dust_pillar", true, la::a, la::b);
   ...
   public static final Codec<lh> bf = lp.j.q().dispatch("type", lh::a, li::c);
   public static final zj<ww, lh> bg = zh.a(lq.T).b(lh::a, li::d);

   private static lm a(String $$0, boolean $$1) {
      return jv.a(lp.j, $$0, new lm($$1));
   }

   private static <T extends lh> li<T> a(String $$0, boolean $$1, final Function<li<T>, MapCodec<T>> $$2, final Function<li<T>, zj<? super ww, T>> $$3) {
      return jv.a(lp.j, $$0, new li<T>($$1) {
         @Override
         public MapCodec<T> c() {
            return $$2.apply(this);
         }
