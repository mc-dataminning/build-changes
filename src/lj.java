...
public class lj {
   ...
   private static lj.a a(Function<cpn, lh> $$0, lf $$1) {
   ...
   public interface a {
      ...
      default acq create(cpn $$0, BiConsumer<acq, Supplier<JsonElement>> $$1) {
         return this.get($$0).a($$0, $$1);
      }

      default acq createWithSuffix(cpn $$0, String $$1, BiConsumer<acq, Supplier<JsonElement>> $$2) {
