...
public class gfk extends gfg implements acr, xj {
   ...
   private gfj s;
   private gfj.a t;
   private final Map<UUID, gfv> u = Maps.newHashMap();
   private final Set<gfv> v = new ReferenceOpenHashSet();
   private final gfe w;
   private final gfn x;
   private final flu y = new flu(this);
   private int z = 3;
   private int A = 3;
   private final bam B = bam.b();
   private CommandDispatcher<fb> C = new CommandDispatcher();
   private gfl D = new gfl(Map.of(), dcq.b.a());
   ...
   private final ggb Z = new ggb();

   public gfk(fmf $$0, wp $$1, gfo $$2) {
      super($$0, $$1, $$2);
      this.r = $$2.a();
      this.G = $$2.c();
      this.H = $$2.d();
      this.w = new gfe($$0, this.e);
      this.x = new gfn(this, $$0);
      this.S = new gfu(this, $$0.aQ().m());
      this.T = new gfp(this, $$0.aQ());
      if ($$2.i() != null) {
         $$0.m.d().a($$2.i());
      }
   ...
   public void a(aej $$0) {
      ...
      boolean $$6 = $$1.g();
      int $$7 = $$1.j();
      gfj.a $$8 = new gfj.a(btf.c, $$0.e(), $$6);
      this.t = $$8;
      this.s = new gfj(this, $$8, $$3, $$4, this.z, this.A, this.a.f, $$5, $$1.c(), $$7);
      this.a.a(this.s, ftv.a.c);
      if (this.a.t == null) {
         this.a.t = this.a.r.a(this.s, new axq(), new flq());
         this.a.t.v(-180.0F);
         if (this.a.V() != null) {
      ...
      this.a.t.e($$0.b());
      this.s.d(this.a.t);
      this.a.t.j = new gkf(this.a.n);
      this.a.r.a(this.a.t);
      this.a.u = this.a.t;
      this.a(this.a.t, this.s, ftv.a.c);
      this.a.t.v($$0.j());
      this.a.t.b($$0.k());
      this.a.t.x($$0.l());
      this.a.t.c($$1.h());
      ...
      if (this.c != null && !this.W && !this.F()) {
         fqo $$9 = fqo.a(this.a, fqo.a.k, m, n);
         this.a.aA().a($$9);
         this.W = true;
      }
   }
   ...
   public void a(agu $$0) {
      ...
      this.a.ba().d();
      this.G();
      fof.b $$1 = this.a.m.d().k();
      this.a.c(new fwq(p, this.b));
      this.b.a(acg.d, new gfh(this.a, this.b, new gfo(this.r, this.e, this.G, this.H, this.d, this.c, this.f, this.h, $$1, this.i, this.j)));
      this.b(aia.a);
      this.b.a(acg.b);
   }
   ...
   public void a(agz $$0) {
      ...
      if ($$1 != null) {
         ...
         this.a.g.a(new gil(this.a.aq(), this.a.aR(), this.s, $$1, $$2));
   ...
   public void a(afk $$0) {
      ...
      aly<dhh> $$5 = $$4.dW().ah();
      boolean $$6 = $$2 != $$5;
      ftv.a $$7 = this.a($$4.eF(), $$2, $$5);
      if ($$6) {
         Map<evo, evq> $$8 = this.s.k();
         boolean $$9 = $$1.f();
         boolean $$10 = $$1.g();
         int $$11 = $$1.j();
         gfj.a $$12 = new gfj.a(this.t.q(), this.t.l(), $$10);
         this.t = $$12;
         this.s = new gfj(this, $$12, $$2, $$3, this.z, this.A, this.a.f, $$9, $$1.c(), $$11);
         this.s.a($$8);
         this.a.a(this.s, $$7);
      }
      ...
      $$13.cG = $$4.cG;
      $$13.cH = $$4.cH;
      if (this.a.z instanceof ftb || this.a.z instanceof ftb.a) {
         this.a.a(null);
      }
   ...
   private ftv.a a(boolean $$0, aly<dhh> $$1, aly<dhh> $$2) {
      ftv.a $$3 = ftv.a.c;
      if (!$$0) {
         if ($$1 == dhh.j || $$2 == dhh.j) {
            $$3 = ftv.a.a;
   ...
   public void a(aea $$0) {
      ...
      if (this.s.a($$0.f()) instanceof cka $$2) {
         ...
         cud $$6 = new cud($$0.b(), $$3.gi(), $$5, $$2, $$4);
         $$3.cd = $$6;
         this.a.a(new fvm($$6, $$3.gi(), $$2, $$4));
      }
   }
   ...
   public void a(acy $$0) {
      ...
      this.a.s.a($$1, $$0.e()).ifPresent($$1x -> {
         ...
         if ($$1x instanceof dvg && this.a.z instanceof fux) {
            ((fux)this.a.z).G();
         }
      });
   }
   ...
   private void a(gkg $$0, gfj $$1, ftv.a $$2) {
      this.U = new gfs($$0, $$1, this.a.f);
      this.a.a(new ftv(this.U::b, $$2));
   }
   ...
   public void a(aex $$0) {
      ...
      if ($$1 == this.a.t) {
         if (this.a.t.t()) {
            this.a.a(new ftb($$0.e(), this.s.j().l()));
         } else {
            this.a.t.gg();
         }
      }
   ...
   public void a(afo $$0) {
      ...
      if (this.c != null) {
         this.c.d = $$0.b();
         $$0.e().map(gfy::b).ifPresent(this.c::a);
         gfz.b(this.c);
      }
   }
   ...
   public void a(aez $$0) {
      ...
      for (aez.b $$1 : $$0.f()) {
         gfv $$2 = new gfv(Objects.requireNonNull($$1.b()), this.F());
   ...
   private void a(aez.a $$0, aez.b $$1, gfv $$2) {
      switch ($$0) {
         case b:
            this.a($$1, $$2);
            break;
   ...
   public Collection<gfv> l() {
      return this.v;
   }

   public Collection<gfv> m() {
   ...
   @Nullable
   public gfv a(String $$0) {
      for (gfv $$1 : this.u.values()) {
