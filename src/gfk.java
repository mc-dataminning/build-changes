...
public class gfk {
   ...
   public gfk(fwr $$0, gci $$1, Executor $$2, gcq $$3) {
      ...
      this.g = $$3.b();
      this.k = $$2;
      this.j = bop.a($$2, "Section Renderer");
      this.j.a(this::j);
   }
      ...
      if (!this.i && !this.g.b()) {
         ...
         if ($$0 != null) {
            ...
            CompletableFuture.supplyAsync(ac.a($$0.b(), () -> $$0.a($$1)), this.k).thenCompose($$0x -> $$0x).whenComplete(($$1x, $$2) -> {
               if ($$2 != null) {
                  feb.Q().a(o.a($$2, "Batching sections"));
               } else {
                  this.j.a(() -> {
                     if ($$1x == gfk.c.a) {
                        $$1.a();
   ...
   public CompletableFuture<Void> a(eyp.b $$0, eyx $$1) {
   ...
   public static class a {
      ...
      final List<doi> c = Lists.newArrayList();
      gfm d = new gfm();
      @Nullable
      eyp.c e;
   ...
   public class b {
      ...
      @Nullable
      private gfk.b.c g;
      private final Set<doi> h = Sets.newHashSet();
      private final Map<gcs, eyx> i = gcs.H().stream().collect(Collectors.toMap($$0x -> $$0x, $$0x -> new eyx(eyx.a.a)));
      private euh j;
      ...
      private boolean a(io $$0) {
         return gfk.this.l.a(jq.a($$0.u()), jq.a($$0.w()), dty.n, false) != null;
      }
      ...
      public void a(int $$0, int $$1, int $$2) {
         this.k();
         this.l.d($$0, $$1, $$2);
         this.j = new euh((double)$$0, (double)$$1, (double)$$2, (double)($$0 + 16), (double)($$1 + 16), (double)($$2 + 16));
      ...
      public void e() {
         this.k();
         this.i.values().forEach(eyx::close);
      }
      ...
      void a(Collection<doi> $$0) {
         Set<doi> $$1 = Sets.newHashSet($$0);
         Set<doi> $$2;
         synchronized (this.h) {
      ...
      abstract class a implements Comparable<gfk.b.a> {
         ...
         public a(gfk.b var1, double $$0, boolean $$1) {
            this.a = $$0;
            this.c = $$1;
         }
      ...
      class b extends gfk.b.a {
               ...
               if (this.b.get()) {
                  ...
                  return ac.e($$7).handle(($$1x, $$2x) -> {
                     if ($$2x != null && !($$2x instanceof CancellationException) && !($$2x instanceof InterruptedException)) {
                        feb.Q().a(o.a($$2x, "Rendering section"));
                     }
         ...
         private gfk.b.b.a a(float $$0, float $$1, float $$2, gcv $$3) {
            ...
            if ($$9 != null) {
               ...
               if ($$11.contains(gcs.f())) {
                  eyp $$22 = $$3.a(gcs.f());
                  if (!$$22.b()) {
                     $$22.a(ezc.a($$0 - (float)$$6.u(), $$1 - (float)$$6.v(), $$2 - (float)$$6.w()));
                     $$4.e = $$22.a();
                  }
               }
         ...
         private <E extends doi> void a(gfk.b.b.a $$0, E $$1) {
            gek<E> $$2 = feb.Q().aq().a($$1);
            if ($$2 != null) {
               $$0.b.add($$1);
               if ($$2.a($$1)) {
                  $$0.a.add($$1);
         ...
         static final class a {
            public final List<doi> a = new ArrayList<>();
            public final List<doi> b = new ArrayList<>();
            public final Map<gcs, eyp.b> c = new Reference2ObjectArrayMap();
      ...
      class c extends gfk.b.a {
         ...
         public CompletableFuture<gfk.c> a(gcv $$0) {
            if (this.b.get()) {
               ...
               float $$4 = (float)$$1.e;
               eyp.c $$5 = this.e.e;
               if ($$5 != null && !this.e.a(gcs.f())) {
                  eyp $$6 = $$0.a(gcs.f());
                  b.this.a($$6);
                  $$6.a($$5);
                  $$6.a(ezc.a($$2 - (float)b.this.l.u(), $$3 - (float)b.this.l.v(), $$4 - (float)b.this.l.w()));
                  this.e.e = $$6.a();
                  eyp.b $$7 = $$6.d();
                  if (this.b.get()) {
                     $$7.e();
                     ...
                     return $$8.handle(($$0x, $$1x) -> {
                        if ($$1x != null && !($$1x instanceof CancellationException) && !($$1x instanceof InterruptedException)) {
                           feb.Q().a(o.a($$1x, "Rendering section"));
                        }
