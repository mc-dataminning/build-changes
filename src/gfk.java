...
public class gfk extends dhi {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final ece e = new ece();
   private final eck<bvk> f = new eck<>(bvk.class, new gfk.b());
   private final gfl E;
   private final glh F;
   private final glg G;
   private final gfk.a H;
   private final gkx I;
   private final bts J;
   private final fmg K = fmg.Q();
   final List<gke> L = Lists.newArrayList();
   private final Map<evp, evr> M = Maps.newHashMap();
   private static final int N = -1;
   private int O;
   private final Object2ObjectArrayMap<dgs, fnj> P = ae.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gkr.a, new fnj($$0xx -> this.b($$0xx, gkr.a)));
      $$0x.put(gkr.b, new fnj($$0xx -> this.b($$0xx, gkr.b)));
      $$0x.put(gkr.c, new fnj($$0xx -> this.b($$0xx, gkr.c)));
   });
   private final gfg Q;
   private final Deque<Runnable> R = Queues.newArrayDeque();
   private int S;
   private final ggx T = new ggx();
   private final int U;
   private boolean V;
   private static final Set<cxl> W = Set.of(cxt.hP, cxt.hQ);

   public void b(int $$0) {
      this.T.a($$0, this);
   }

   public void b(jh $$0, dxv $$1, int $$2) {
      if (!this.T.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(jh $$0, dxv $$1, fby $$2) {
      dxv $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cpx $$4 = this.K.t;
   ...
   public gfk(gfl $$0, gfk.a $$1, aly<dhi> $$2, jq<ebq> $$3, int $$4, int $$5, glh $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.Q = new gfg(this, $$4);
      this.J = new bts();
      this.H = $$1;
      this.F = $$6;
      this.U = $$9;
      this.G = new glg(this.K, this, $$6);
      this.I = gkx.a($$3.a());
   ...
   private void a(bvk $$0, bvk $$1) {
      if ($$1.dR() || $$1.dl() != $$0) {
         $$1.ae();
      } else if ($$1 instanceof cpx || this.e.c($$1)) {
         $$1.bz();
         $$1.af++;
         $$1.r();
   ...
   private dkm n() {
      if (this.K.r.j() == dhf.b) {
         cxp $$0 = this.K.t.eZ();
         cxl $$1 = $$0.h();
         if (W.contains($$1) && $$1 instanceof cvv $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, bam $$4, @Nullable dkm $$5, jh.a $$6) {
   ...
   private void a(jh $$0, dxv $$1, lq $$2, boolean $$3) {
      if ($$1.y().c()) {
         fcs $$4 = $$1.g(this, $$0);
         double $$5 = $$4.c(jm.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(jh $$0, lq $$1, fcs $$2, double $$3) {
   ...
   public void a(@Nullable cpx $$0, bvk $$1, jq<axe> $$2, axg $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hfi)(new hez($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bvk $$0, axe $$1, axg $$2, float $$3, float $$4) {
      this.K.ak().a((hfi)(new hez($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, axe $$3, axg $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      hfd $$10 = new hfd($$3, $$4, $$5, $$6, bam.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<dae> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.K.g.a(new gic.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
   ...
   public jq<dik> a(int $$0, int $$1, int $$2) {
      return this.K_().e(mb.aI).b(dir.b);
   }
   ...
   public int a(fby $$0, float $$1) {
      float $$2 = this.f($$1);
      fby $$3 = $$0.a(2.0, 2.0, 2.0).c(0.25);
      fby $$4 = azf.a($$3, ($$0x, $$1x, $$2x) -> fby.a(this.I_().a($$0x, $$1x, $$2x).a().a()));
   ...
   public int a(jh $$0, dgs $$1) {
      fnj $$2 = (fnj)this.P.get($$1);
      return $$2.a($$0);
   }

   public int b(jh $$0, dgs $$1) {
      int $$2 = fmg.Q().n.G().c();
      if ($$2 == 0) {
   ...
   protected Map<evp, evr> k() {
      return ImmutableMap.copyOf(this.M);
   }

   protected void a(Map<evp, evr> $$0) {
      this.M.putAll($$0);
   }
   ...
   public static class a implements ewk {
      ...
      public a(btg $$0, boolean $$1, boolean $$2) {
         this.h = $$0;
         this.a = $$1;
         this.b = $$2;
      }
   ...
   final class b implements ecg<bvk> {
      public void a(bvk $$0) {
      }
