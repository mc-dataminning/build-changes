...
public interface fgp {
   ...
   default fgp a(int $$0) {
      return this.a(ayf.b($$0), ayf.c($$0), ayf.d($$0), ayf.a($$0));
   }

   default fgp d(int $$0) {
      return this.a(ayf.c($$0, -1));
   }
   ...
   default void a(fgl.a $$0, gmn $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(fgl.a $$0, gmn $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      int[] $$10 = $$1.b();
      kl $$11 = $$1.e().q();
      Matrix4f $$12 = $$0.a();
      ...
      try {
         ...
         for (int $$21 = 0; $$21 < $$15; $$21++) {
            ...
            int $$34 = ayf.a($$16, (int)$$28, (int)$$29, (int)$$30);
            int $$35 = gle.b($$7[$$21], $$17);
