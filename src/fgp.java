...
public class fgp implements agt<cpz>, eyj, ezb, fax, fgu {
   public static final eyt a = new eyt(new ahg("recipe_book/button"), new ahg("recipe_book/button_highlighted"));
   ...
   private int o;
   private int p;
   protected final fgn e = new fgn();
   private final List<fgr> q = Lists.newArrayList();
   @Nullable
   private fgr r;
   protected eym f;
   protected cjo<?> g;
   ...
   private String u = "";
   private euv v;
   private final fgq w = new fgq();
   private final cfm x = new cfm();
   private int y;
   private boolean z;
   private boolean A;
   private boolean B;

   public void a(int $$0, int $$1, evi $$2, boolean $$3, cjo<?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      this.t = new exp(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, vf.c("itemGroup.search"));
      this.t.f(50);
      this.t.g(true);
      this.t.g(16777215);
      this.t.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new eym($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (evr $$3 : evr.a(this.g.t())) {
         this.q.add(new fgr($$3));
      }
   ...
   private void b() {
      this.f.a(this.f.a() ? eyr.a(this.c()) : eyr.a(m));
   }
   ...
   private void c(boolean $$0) {
      List<fgt> $$1 = this.v.a(this.r.b());
      $$1.forEach($$0x -> $$0x.a(this.x, this.g.n(), this.g.o(), this.v));
      List<fgt> $$2 = Lists.newArrayList($$1);
      $$2.removeIf($$0x -> !$$0x.b());
      $$2.removeIf($$0x -> !$$0x.d());
      String $$3 = this.t.a();
      if (!$$3.isEmpty()) {
         ObjectSet<fgt> $$4 = new ObjectLinkedOpenHashSet(this.h.a(gim.c).search($$3.toLowerCase(Locale.ROOT)));
   ...
   private void b(ewu $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fdb.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(ewu $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.f() && !this.h.s.P_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.bS.j, $$3, fdb.t());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   public void a(cqe<?> $$0, List<cjw> $$1) {
      ...
      this.e.a($$0);
      this.e.a(cpz.a($$2), $$1.get(0).f, $$1.get(0).g);
   ...
   @Override
   public fax.a s() {
      return this.A ? fax.a.b : fax.a.a;
   }

   @Override
   public void b(faz $$0) {
      List<fax> $$1 = Lists.newArrayList();
      this.w.a($$1x -> {
         if ($$1x.A()) {
            $$1.add($$1x);
         }
