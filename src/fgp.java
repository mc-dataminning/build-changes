...
public class fgp extends fgh {
   private static final Logger a = LogUtils.getLogger();
   private static final ajc b = new ajc("textures/misc/vignette.png");
   private static final vs c = vs.b("============").a(n.p);
   ...
   private int z;
   private final fbb A = new fbb(false);

   public fgp(boolean $$0, Runnable $$1) {
      super(eyc.a);
      this.o = $$0;
      this.p = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fgp.a $$1) {
      try (Reader $$2 = this.f.aa().openAsReader(new ajc($$0))) {
         $$1.read($$2);
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : awc.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(vs.b($$4).a(n.o), true);
         this.a(c, true);
         this.H();
         this.H();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(vs.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(vs.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.r.addAll(this.f.h.c(vs.b($$0), 256));
   }

   private void a(vs $$0, boolean $$1) {
      if ($$1) {
