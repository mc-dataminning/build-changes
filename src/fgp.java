...
public class fgp {
   ...
   @Nullable
   private String g;
   private static final fgp.a h = new fgp.a() {
      @Nullable
      @Override
      public fgo a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fgs.a(this.d, "Get capabilities")) {
         ...
         if (fgs.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fgs.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fgs.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fgo a(fgp.c $$0) {
      return ($$0 == fgp.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fgp.a {
      private final int a;
      private final Set<fgo> b = Sets.newIdentityHashSet();
      ...
      public fgo a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fgp.a.warn("Maximum sound pool size {} reached", this.a);
            }
