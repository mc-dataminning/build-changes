...
public abstract class asw implements AutoCloseable {
   ...
   protected asw(URL $$0, asw.b $$1, asw.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected CompletableFuture<ash> a(GameProfile $$0, String $$1, asw.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(ash.a) : CompletableFuture.supplyAsync(() -> {
   ...
   protected abstract ash a(String var1, asw.a var2, JsonObject var3);

   protected xa a(String $$0, JsonArray $$1, asw.a $$2) {
      if ($$1.isEmpty()) {
         return xa.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xa.b;
      } else {
         xa $$3 = new xa($$0.length());
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new asw.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   public interface a {
      asw.a a = ($$0, $$1) -> false;
      asw.a b = ($$0, $$1) -> $$0.length() == $$1;

      static asw.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static asw.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   protected class c implements asx {
      protected final GameProfile b;
      protected final Executor c;

      protected c(final GameProfile $$1) {
         this.b = $$1;
         bso $$2 = new bso(asw.this.g, "chat stream for " + $$1.getName());
         this.c = $$2::a_;
      }

      @Override
      public CompletableFuture<List<ash>> a(List<String> $$0) {
         List<CompletableFuture<ash>> $$1 = $$0.stream().map($$0x -> asw.this.a(this.b, $$0x, asw.this.f, this.c)).collect(ImmutableList.toImmutableList());
         return af.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<ash> a(String $$0) {
         return asw.this.a(this.b, $$0, asw.this.f, this.c);
      }
   }
