...
public class asw implements AutoCloseable {
   ...
   public static asw a(Path $$0) throws IOException {
   ...
   private asw(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static asw.a a(Path $$0) {
         return new asw.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
