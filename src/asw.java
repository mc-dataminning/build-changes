...
public class asw {
   ...
   private static List<asw.b> a(final Path $$0) throws IOException {
      try {
         final List<asw.b> $$1 = new ArrayList<>();
   ...
   private static List<asw.a> a(List<asw.b> $$0) {
      List<asw.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (asw.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new asw.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<asw.a> a = Comparator.comparing(asw.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<asw.b> a = Comparator.comparing(asw.b::b).reversed();
