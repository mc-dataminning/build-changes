...
public class asw {
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (asw.this.e.am()) {
                  $$1.addLast("legacy_query", new asp(asw.this.d()));
               }

               vv.a($$1, zk.a, false, null);
               int $$2 = asw.this.e.o();
               vv $$3 = (vv)($$2 > 0 ? new wm($$2) : new vv(zk.a));
               asw.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new asy(asw.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     xc $$3 = xc.b("Internal server error");
                     $$1.a(new zs($$3), wj.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<asw.a.a> d = Lists.newArrayList();
