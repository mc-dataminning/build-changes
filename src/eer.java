...
public class eer extends eef<egq> {
   ...
   public boolean a(eeh<egq> $$0) {
      ...
      if (!$$3.a_($$1).a(dia.dP)) {
         ...
         for (int $$6 = 0; $$6 < $$4; $$6++) {
            ...
            for (int $$9 = -$$8; $$9 <= $$8; $$9++) {
               float $$10 = (float)azj.a($$9) - 0.25F;

               for (int $$11 = -$$8; $$11 <= $$8; $$11++) {
                  float $$12 = (float)azj.a($$11) - 0.25F;
                  if (($$9 == 0 && $$11 == 0 || !($$10 * $$10 + $$12 * $$12 > $$7 * $$7))
                     && ($$9 != -$$8 && $$9 != $$8 && $$11 != -$$8 && $$11 != $$8 || !($$2.i() > 0.75F))) {
                     dvd $$13 = $$3.a_($$1.b($$9, $$6, $$11));
                     if ($$13.l() || b($$13) || $$13.a(dia.dP) || $$13.a(dia.dO)) {
                        this.a($$3, $$1.b($$9, $$6, $$11), dia.iC.m());
                     }
         ...
         for (int $$15 = -$$14; $$15 <= $$14; $$15++) {
            for (int $$16 = -$$14; $$16 <= $$14; $$16++) {
               ...
               while ($$17.v() > 50) {
                  dvd $$19 = $$3.a_($$17);
                  if (!$$19.l() && !b($$19) && !$$19.a(dia.dP) && !$$19.a(dia.dO) && !$$19.a(dia.iC)) {
                     break;
                  }

                  this.a($$3, $$17, dia.iC.m());
                  $$17 = $$17.e();
                  if (--$$18 <= 0) {
                     $$17 = $$17.c($$2.a(5) + 1);
                     $$18 = $$2.a(5);
