...
public class eer implements ees, eet {
   ...
   private final ejh<MinecraftServer> I;
   ...
   public eer(cse $$0, dnp $$1, eer.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         0,
   ...
   public static <T> eer a(Dynamic<T> $$0, cse $$1, eer.a $$2, dnp $$3, Lifecycle $$4) {
      ...
      return new eer(
         ...
         new ejh<>(ejg.a, $$0.get("ScheduledEvents").asStream()),
         (rz)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dku.a.a).resultOrPartial(f::error).orElse(dku.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(ip $$0, rz $$1, @Nullable rz $$2) {
      ...
      $$1.a("Version", $$3);
      so.g($$1);
      DynamicOps<sw> $$4 = agg.a(sn.a, $$0);
      dnn.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dku.a.a.encodeStart(sn.a, this.A), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<sw> $$5 = cst.b.encodeStart(sn.a, this.g.g());
   ...
   @Override
   public boolean B() {
      return this.i == eer.a.b;
   }

   @Override
   public boolean C() {
      return this.i == eer.a.c;
   }
