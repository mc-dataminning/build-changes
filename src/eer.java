...
public class eer {
   private static final eer a = new eer(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public eer.a a(int $$0, int $$1) {
         return new eer.a(1.0, 0.0);
      }
   ...
   private static final esz b = esz.b(new eeq(42L), ro.a);
   ...
   private final Long2ObjectOpenHashMap<ees> h;
   private final Long2ObjectOpenHashMap<ees> i;

   public static eer a() {
      return a;
   }

   public static eer a(@Nullable asp $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dgn $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<ees> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<ees> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = bae.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new eer($$2, $$3);
         }
      }
   }

   eer(Long2ObjectOpenHashMap<ees> $$0, Long2ObjectOpenHashMap<ees> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public eer.a a(int $$0, int $$1) {
      int $$2 = kb.a($$0);
      int $$3 = kb.a($$1);
      double $$4 = this.a($$2, 0, $$3, ees::a);
      if ($$4 != Double.MAX_VALUE) {
         return new eer.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(kb.d(dgn.a($$5x)), kb.d(dgn.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(edi.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(kb.d(dgn.a($$6x)), kb.d(dgn.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, eer.b $$3) {
      int $$4 = kb.e($$0);
      int $$5 = kb.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(eer.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      ees $$6 = (ees)this.h.get(dgn.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - kb.d($$1), $$4, $$5 - kb.d($$2)) : Double.MAX_VALUE;
   }

   public dim a(dim $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jq<dij> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jq<dij> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jq<dij>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(kb.d(dgn.a($$5x)), $$1, kb.d(dgn.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(edp.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dzp $$0, jh $$1) {
      dxu $$2 = $$0.a_($$1);
      if ($$2.a(axu.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(dif $$0, eaj $$1) {
      dgn $$2 = $$1.f();
   ...
   public static eer.c a(@Nullable ees $$0, Map<jn, ees> $$1) {
      List<eer.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static eer.c a(@Nullable jn $$0, ees $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jm $$4 : $$0.a()) {
   ...
   interface b {
      double get(ees var1, int var2, int var3, int var4);
   }
