...
public class eer extends eev {
   public static final MapCodec<eer> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               eee.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               axn.a(it.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, eer::new)
   );
   ...
   protected final eee e;
   protected final int f;
   protected final List<it> g;

   public eer(float $$0, int $$1, int $$2, eee $$3, int $$4, List<it> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(eev.a $$0, io $$1, it $$2) {
