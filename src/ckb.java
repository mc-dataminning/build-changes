...
public abstract class ckb {
   ...
   private final is<coz> l = is.a();
   public final is<clw> i = is.a();
   private final List<ckt> m = Lists.newArrayList();
   private coz n = coz.h;
   private final is<coz> o = is.a();
   ...
   private int t = -1;
   private int u;
   private final Set<clw> v = Sets.newHashSet();
   private final List<ckn> w = Lists.newArrayList();
   @Nullable
   private cko x;
   private boolean y;

   protected ckb(@Nullable cli<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(ckm $$0, chh $$1, cyo $$2) {
   ...
   protected static void a(bln $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(ckl $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   protected ckt a(ckt $$0) {
      this.m.add($$0);
      this.p.add(0);
      return $$0;
   }

   protected void a(ckl $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         this.a(ckt.a($$0, $$1));
      }
   }
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         coz $$1 = this.i.get($$0).g();
         Supplier<coz> $$2 = Suppliers.memoize($$1::q);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, coz $$1, Supplier<coz> $$2) {
      coz $$3 = this.l.get($$0);
      if (!coz.a($$3, $$1)) {
         coz $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, coz $$1, Supplier<coz> $$2) {
      if (!this.y) {
         coz $$3 = this.o.get($$0);
         if (!coz.a($$3, $$1)) {
            coz $$4 = $$2.get();
   ...
   public abstract coz a(chh var1, int var2);

   public void a(int $$0, int $$1, ckk $$2, chh $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, ckk $$2, chh $$3) {
      chg $$4 = $$3.fT();
      if ($$2 == ckk.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == ckk.a || $$2 == ckk.b) && ($$1 == 0 || $$1 == 1)) {
         ckj $$16 = $$1 == 0 ? ckj.a : ckj.b;
         if ($$0 == -999) {
            if (!this.g().b()) {
               if ($$16 == ckj.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.b()) {
                  if (!$$21.b()) {
                     int $$22 = $$16 == ckj.a ? $$21.M() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.b()) {
                     int $$23 = $$16 == ckj.a ? $$20.M() : ($$20.M() + 1) / 2;
                     Optional<coz> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<coz> $$26 = $$19.a($$20.M(), $$21.g() - $$21.M(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.M());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == ckk.d && $$3.fU().d && this.g().b() && $$0 >= 0) {
         clw $$32 = this.i.get($$0);
         if ($$32.h()) {
            coz $$33 = $$32.g();
            this.b($$33.c($$33.g()));
         }
      } else if ($$2 == ckk.e && this.g().b() && $$0 >= 0) {
         clw $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().M();
         coz $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == ckk.g && $$0 >= 0) {
         clw $$37 = this.i.get($$0);
         coz $$38 = this.g();
         if (!$$38.b() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.M() < $$38.g(); $$42 += $$40) {
                  clw $$43 = this.i.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     coz $$44 = $$43.g();
                     if ($$41 != 0 || $$44.M() != $$44.g()) {
                        coz $$45 = $$43.b($$44.M(), $$38.g() - $$38.M(), $$3);
                        $$38.g($$45.M());
                     }
                  }
               }
   ...
   private boolean a(chh $$0, ckj $$1, clw $$2, coz $$3, coz $$4) {
      cjs $$5 = $$0.dM().I();
   ...
   public void a(int $$0, int $$1, coz $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<coz> $$1, coz $$2) {
   ...
   public abstract boolean a(chh var1);

   protected boolean a(coz $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, chh $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable clw $$0, coz $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && coz.c($$1, $$0.g()) ? $$0.g().M() + ($$2 ? 0 : $$1.M()) <= $$1.g() : $$3;
   }

   public static int a(Set<clw> $$0, int $$1, coz $$2) {
      return switch ($$1) {
         case 0 -> awh.d((float)$$2.M() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.d().k();
         default -> $$2.M();
      };
   ...
   public static int a(@Nullable dit $$0) {
      return $$0 instanceof bln ? b((bln)$$0) : 0;
   }

   public static int b(@Nullable bln $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(ckb $$0) {
      Table<bln, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bln $$0, int $$1) {
