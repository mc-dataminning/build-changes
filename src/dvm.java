...
public abstract class dvm {
   ...
   protected static dva a(int $$0, int $$1, int $$2, ha $$3, int $$4, int $$5, int $$6) {
      return $$3.o() == ha.a.c
         ? new dva($$0, $$1, $$2, $$0 + $$4 - 1, $$1 + $$5 - 1, $$2 + $$6 - 1)
         : new dva($$0, $$1, $$2, $$0 + $$6 - 1, $$1 + $$5 - 1, $$2 + $$4 - 1);
   }

   protected static ha a(asc $$0) {
      return ha.c.a.a($$0);
   }

   public final qw a(dvy $$0) {
      qw $$1 = new qw();
   ...
   protected abstract void a(dvy var1, qw var2);
   ...
   protected boolean a(cqk $$0, dva $$1, asc $$2, gw $$3, aew $$4, @Nullable dfj $$5) {
   ...
   protected boolean a(cqp $$0, dva $$1, asc $$2, int $$3, int $$4, int $$5, ha $$6, aew $$7) {
      gw $$8 = this.b($$3, $$4, $$5);
