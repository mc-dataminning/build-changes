...
public class dvm implements dvi, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bow<boy.b> c;
   private final dvr d;
   private final Map<dbk, dvm.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dvm(dvt $$0, Path $$1, boolean $$2) {
      this.d = new dvr($$0, $$1, $$2);
      this.c = new bow<>(new boy.a(dvm.b.values().length), ac.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dbk $$0, int $$1) {
      dbk $$2 = new dbk($$0.e - $$1, $$0.f - $$1);
      dbk $$3 = new dbk($$0.e + $$1, $$0.f + $$1);
   ...
   public CompletableFuture<Void> a(dbk $$0, @Nullable tx $$1) {
      return this.a(() -> {
         dvm.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dvm.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(dbk $$0, ur $$1) {
      return this.a(() -> {
         try {
            dvm.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new boy.b(dvm.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<dbk, dvm.a>> $$0 = this.e.entrySet().iterator();
         Entry<dbk, dvm.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new boy.b(dvm.b.b.ordinal(), this::a));
   }

   private void a(dbk $$0, dvm.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new boy.b(dvm.b.c.ordinal(), () -> $$0.a(azh.a))).join();
         this.c.close();
