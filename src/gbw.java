public class gbw extends gaz<cdw> {
   ...
   public void a(cdw $$0, float $$1, float $$2, esh $$3, fvt $$4, int $$5) {
      $$3.a();
      cpd $$6 = $$0.q();
      int $$7 = $$6.b() ? 187 : coy.a($$6.d()) + $$6.l();
      this.n.b((long)$$7);
      gjb $$8 = this.m.a($$6, $$0.dM(), null, $$0.aj());
      boolean $$9 = $$8.b();
      int $$10 = this.a($$6);
      float $$11 = 0.25F;
      float $$12 = awi.a(((float)$$0.s() + $$2) / 10.0F + $$0.c) * 0.1F + 0.1F;
      float $$13 = $$8.f().a(cpa.h).d.y();
      ...
      for (int $$21 = 0; $$21 < $$10; $$21++) {
         ...
         this.m.a($$6, cpa.h, false, $$3, $$4, $$5, ggs.d, $$8);
         $$3.b();
         if (!$$9) {
