public class gbw extends gcr {
   private final gcm a;

   gbw(fyj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gcm $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cmk $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dx();
            if (this.h > $$1) {
   ...
   public static class b implements gbu<ln> {
      ...
      public gbr a(ln $$0, fyj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbr $$8 = new gbw($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
