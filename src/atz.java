...
class atz implements Path {
   private static final BasicFileAttributes a = new atx() {
      @Override
   ...
   private static final BasicFileAttributes b = new atx() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atz> c = Comparator.comparing(atz::n);
   ...
   public atz(aub $$0, String $$1, @Nullable atz $$2, auc $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atz a(@Nullable atz $$0, String $$1) {
      return new atz(this.e, $$1, $$0, auc.b);
   }
   ...
   atz a(String $$0) {
      if (a(this.i)) {
         return new atz(this.e, $$0, this, this.i);
      } else if (this.i instanceof auc.a $$1) {
         atz $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atz(this.e, $$0, this, auc.a);
      } else if (this.i instanceof auc.b) {
         return new atz(this.e, $$0, this, auc.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(auc $$0) {
      return $$0 == auc.a || $$0 == auc.b;
   }
   ...
   private atz c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atz $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof auc.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public auc.a i() {
      return this.i instanceof auc.a $$0 ? $$0 : null;
   }
