...
public class atz {
   ...
   private List<atw> c(Collection<String> $$0) {
      List<atw> $$1 = this.d($$0).collect(af.b());
   ...
   public crr f() {
      return this.g().stream().map(atw::e).reduce(crr::c).orElse(crr.a());
   }

   public Collection<atw> g() {
      return this.c;
   }
