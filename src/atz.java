...
public class atz extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(azd.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(azd.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(azd.s);
