public class ggt extends geb<hdq> {
   public ggt(giu $$0) {
      super($$0);
   }
   ...
   public void a(hdq $$0) {
      ...
      } else if ($$3 == cpp.a && $$2 == 0.0F) {
         this.b($$0);
      } else if ($$3 == cpp.b) {
         gef.a(this.r, this.s, this.o, $$0.e == bwv.b);
      } else if ($$3 == cpp.c) {
         gef.a(this.r, this.s, $$0.c, $$0.K, $$0.e == bwv.b);
      } else if ($$3 == cpp.d) {
         this.o.e = 0.5F;
         this.o.f = 0.0F;
         if ($$0.e == bwv.a) {
   ...
   protected void a(hdq $$0, float $$1) {
      float $$2 = $$0.H;
      if ($$2 > 0.0F && $$0.d == cpp.a) {
         gef.a(this.r, this.s, $$0.e, $$2, $$0.u);
      } else {
         super.a($$0, $$1);
      }
   }

   private void b(hdq $$0) {
      if ($$0.e == bwv.a) {
         this.s.e = -1.8F;
      } else {
         this.r.e = -1.8F;
