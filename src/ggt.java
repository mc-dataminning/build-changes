public class ggt extends gho {
   private final ghj a;

   ggt(gdh $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, ghj $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cou $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dC();
            if (this.h > $$1) {
   ...
   public static class a implements ggr<lw> {
      ...
      public ggo a(lw $$0, gdh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new ggt($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements ggr<lw> {
      ...
      public ggo a(lw $$0, gdh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ggo $$8 = new ggt($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
