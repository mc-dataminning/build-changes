public class ggt extends ggk<hdm> {
   public static final gjx a = gjx.scaling(2.35F);
   ...
   private final gjo m;
   private final gjo n;
   private final gjo[] o = new gjo[12];
   private final gjo[] p;
   ...
   public static gju a() {
      ...
      gjt $$3 = gjt.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, gjq.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", gjt.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), gjq.a(0.0F, 0.0F, -8.25F));
      gjy $$11 = $$2.a("tail0", gjt.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), gjq.a);
      gjy $$12 = $$11.a("tail1", gjt.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), gjq.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", gjt.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), gjq.a(0.5F, 0.5F, 6.0F));
   ...
   public void a(hdm $$0) {
      ...
      if ($$0.e != null && $$0.d != null) {
         ...
         fex $$3 = $$0.d;
         $$3 = new fex($$3.d, 0.0, $$3.f);
         fex $$4 = new fex($$0.c.d - $$0.e.d, 0.0, $$0.c.f - $$0.e.f).d().b((float) (Math.PI / 2));
         double $$5 = $$3.b($$4);
