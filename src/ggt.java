...
public class ggt {
   ...
   private ggt(int $$0, List<ggv> $$1) {
      this.a = $$1.toArray(ggv[]::new);
      this.b = $$1.size();
   }

   private List<ggv> c() {
      List<ggv> $$0 = new ArrayList<>(this.d());
