...
public class aur extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getInputSchema().getType(aym.t);
      OpticFinder<Pair<String, String>> $$2 = DSL.fieldFinder("id", DSL.named(aym.z.typeName(), azu.a()));
      OpticFinder<?> $$3 = $$1.findField("tag");
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("EffectDurationEntity", $$0.getType(aym.x), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped("EffectDurationPlayer", $$0.getType(aym.b), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
