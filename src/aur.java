...
public class aur extends axr {
   private static final String a = tf.a.a(te.a);
   private static final String[] b = new String[]{
      "Text1", "Text2", "Text3", "Text4", "FilteredText1", "FilteredText2", "FilteredText3", "FilteredText4", "Color", "GlowingText"
   };

   public aur(Schema $$0, String $$1, String $$2) {
      super($$0, false, $$1, ayp.s, $$2);
   }

   private static <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = $$0.update("front_text", aur::b);
      $$0 = $$0.update("back_text", aur::b);
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), aur::a);
   }
}
