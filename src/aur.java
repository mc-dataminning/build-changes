...
public class aur extends auq {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aur.a> s;
   private final aum t;
   private long u;
   private final akv v;

   private aur(akv $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aun.c($$2, 7, $$0.getLength());
      }
   }
