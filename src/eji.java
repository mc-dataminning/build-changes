...
public class eji extends ejn {
   ...
   public List<ehv.a> a(dfb $$0, BiConsumer<jg, dvd> $$1, azr $$2, int $$3, jg $$4, ehf $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azj.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azj.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<eji.a> $$13 = Lists.newArrayList();
      $$13.add(new eji.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jg $$21 = $$4.b(azj.a($$19), $$12 - 1, azj.a($$20));
               jg $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  jg $$27 = new jg($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new eji.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<ehv.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dfb $$0, BiConsumer<jg, dvd> $$1, azr $$2, jg $$3, jg $$4, boolean $$5, ehf $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         jg $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jg $$13 = $$3.b(azj.d(0.5F + (float)$$12 * $$9), azj.d(0.5F + (float)$$12 * $$10), azj.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dok.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dfb $$0, BiConsumer<jg, dvd> $$1, azr $$2, int $$3, jg $$4, List<eji.a> $$5, ehf $$6) {
      for (eji.a $$7 : $$5) {
         int $$8 = $$7.a();
         jg $$9 = new jg($$4.u(), $$8, $$4.w());
