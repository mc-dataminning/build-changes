...
public class eji extends ejl<ejh> {
   public eji(Codec<ejh> $$0) {
      super($$0);
   }

   public boolean a(ejh $$0, azz $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(ejg $$0, ejh $$1, edd $$2, Function<iw, jg<dlc>> $$3, azz $$4, egr $$5, dje $$6, edc $$7) {
      int $$8 = jz.c(this.d() * 2 - 1);
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         ejl.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      ejg $$0, ejh $$1, edd $$2, Function<iw, jg<dlc>> $$3, egr $$4, double $$5, double $$6, double $$7, float $$8, double $$9, edc $$10, ejl.a $$11
   ) {
      double $$12 = 1.5 + (double)(azq.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(azq.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = azq.b($$13);
         $$6 += (double)(azq.b($$12) * $$27);
         $$7 += (double)azq.a($$13);
         $$8 += (double)(azq.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
