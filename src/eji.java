...
@Deprecated
public class eji extends eit<eji.a> {
   private static final dzo a = dlw.nE.m();

   public eji(Codec<eji.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eiv<eji.a> $$0) {
      iu $$1 = $$0.e();
      djo $$2 = $$0.b();
      azt $$3 = $$0.d();
      eji.a $$4 = $$0.f();
   ...
   public static record a(emy b, emy c) implements ekx {
      public static final Codec<eji.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(emy.a.fieldOf("fluid").forGetter(eji.a::a), emy.a.fieldOf("barrier").forGetter(eji.a::b)).apply($$0, eji.a::new)
      );
