...
public class cep extends cfn {
   ...
   public cep(int $$0, cbv $$1) {
      this($$0, $$1, cey.a);
   }

   public cep(int $$0, cbv $$1, cey $$2) {
      super(cfs.h, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected cfo l() {
      return cfo.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   protected void a(cbw $$0, cjh $$1) {
      ...
      this.o.a(($$1x, $$2x) -> {
         dfl $$3 = $$1x.a_($$2x);
         if (!$$0.fS().d && $$3.a(apu.M) && $$0.ef().i() < 0.12F) {
            dfl $$4 = cry.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         cjh $$4 = $$0.p();
         cjh $$5 = this.q.a(1);
         Map<cnq, Integer> $$6 = cns.a($$4);
         $$2 += $$0.I() + ($$5.b() ? 0 : $$5.I());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(cjk.tC) && !cid.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<cnq, Integer> $$16 = cns.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (cnq $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fS().d || $$0.a(cjk.tC)) {
                        $$22 = true;
                     }
