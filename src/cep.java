...
public class cep {
   ...
   @Nullable
   public static evs a(btz $$0, Supplier<iz> $$1) {
      return a($$1, $$0::d);
   }

   @Nullable
   public static evs a(Supplier<iz> $$0, ToDoubleFunction<iz> $$1) {
      ...
      return $$3 != null ? evs.c($$3) : null;
   }

   public static iz a(btz $$0, int $$1, azh $$2, iz $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.gb() && $$1 > 1) {
         iz $$6 = $$0.fY();
