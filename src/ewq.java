...
public class ewq implements gsf {
   ...
   public ewq(InputStream $$0) throws IOException {
      this.d = $$0;
      this.e.limit(0);
   ...
   private boolean a(ewq.a $$0) throws IOException {
      if (this.b == 0L) {
         return false;
      } else {
         MemoryStack $$1 = MemoryStack.stackPush();
   ...
   private void a(FloatBuffer $$0, ewq.a $$1) {
      while ($$0.hasRemaining()) {
         $$1.a($$0.get());
      }
   }

   private void a(FloatBuffer $$0, FloatBuffer $$1, ewq.a $$2) {
   ...
   static class a {
      ...
      public void a(float $$0) {
         ...
         int $$1 = ayd.a((int)($$0 * 32767.5F - 0.5F), -32768, 32767);
