...
public class ewq extends ewf implements exk {
   private static final exu d = new exu(new agt("widget/text_field"), new agt("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, atk> D = ($$0x, $$1x) -> atk.forward($$0x, vy.a);
   @Nullable
   private vb E;
   private long F = ac.b();

   public ewq(evu $$0, int $$1, int $$2, vb $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public ewq(evu $$0, int $$1, int $$2, int $$3, int $$4, vb $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public ewq(evu $$0, int $$1, int $$2, int $$3, int $$4, @Nullable ewq $$5, vb $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, atk> $$0) {
      this.D = $$0;
   }
   ...
   protected vp aM_() {
      vb $$0 = this.l();
      return vb.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void k(int $$0) {
      this.w = aty.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = aty.a($$0) - this.p();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fcc.q());
   }
   ...
   public void b(evw $$0, int $$1, int $$2, float $$3) {
      if (this.u()) {
         ...
         int $$12 = $$10;
         int $$13 = aty.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(fsq.C(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void o(int $$0) {
      this.x = aty.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = aty.a(this.v, 0, this.p.length());
      }
   }
