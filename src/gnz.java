public class gnz extends got<gdw, fwn<gdw>> {
   public gnz(gmd<gdw, fwn<gdw>> $$0) {
      super($$0);
   }
   ...
   public void a(fbg $$0, gex $$1, int $$2, gdw $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
      if ("deadmau5".equals($$3.ah().getString()) && !$$3.ci()) {
         fbk $$10 = $$1.getBuffer(gff.c($$3.b().a()));
         int $$11 = gli.c($$3, 0.0F);

         for (int $$12 = 0; $$12 < 2; $$12++) {
            float $$13 = ayo.i($$6, $$3.O, $$3.dF()) - ayo.i($$6, $$3.aZ, $$3.aY);
            float $$14 = ayo.i($$6, $$3.P, $$3.dH());
            $$0.a();
