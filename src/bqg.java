...
public class bqg implements bql {
   ...
   private final Map<String, bqg.a> f = Maps.newHashMap();
   ...
   private final Set<Pair<String, brx>> o = new ObjectArraySet();

   public bqg(LongSupplier $$0, IntSupplier $$1, BooleanSupplier $$2) {
      this.i = $$0.getAsLong();
      this.h = $$0;
      this.j = $$1.getAsInt();
      this.g = $$1;
   ...
   public void b() {
      if (!this.l) {
         ...
         this.l = false;
         if (!this.k.isEmpty()) {
            c.error("Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", LogUtils.defer(() -> bqm.b(this.k)));
         }
      }
   }
   ...
   public void c() {
      if (!this.l) {
         ...
         if ($$2 > a && !this.n.getAsBoolean()) {
            c.warn("Something's taking too long! '{}' took aprox {} ms", LogUtils.defer(() -> bqm.b(this.k)), LogUtils.defer(() -> (double)$$2 / 1000000.0));
         }
   ...
   private bqg.a f() {
      if (this.m == null) {
         this.m = this.f.computeIfAbsent(this.k, $$0 -> new bqg.a());
      }
   ...
   @Override
   public bqm d() {
      return new bqj(this.f, this.i, this.j, this.h.getAsLong(), this.g.getAsInt());
   }

   @Nullable
   @Override
   public bqg.a c(String $$0) {
      return this.f.get($$0);
   }

   @Override
   public Set<Pair<String, brx>> e() {
      return this.o;
   }
