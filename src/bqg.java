...
public class bqg implements bqd {
   ...
   protected void b() {
      if (!this.a.L().l()) {
         this.a.aW = asy.c(this.a.aW, this.a.aU, (float)this.a.Z());
      }
   }
   ...
   protected Optional<Float> h() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$3) > 1.0E-5F) ? Optional.empty() : Optional.of((float)(-(asy.d($$1, $$3) * 180.0F / (float)Math.PI)));
   }
   ...
   protected Optional<Float> i() {
      ...
      return !(Math.abs($$1) > 1.0E-5F) && !(Math.abs($$0) > 1.0E-5F)
         ? Optional.empty()
         : Optional.of((float)(asy.d($$1, $$0) * 180.0F / (float)Math.PI) - 90.0F);
   }
   ...
   private static double b(bjt $$0) {
      return $$0 instanceof bkj ? $$0.du() : ($$0.cG().b + $$0.cG().e) / 2.0;
   }
}
