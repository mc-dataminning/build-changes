...
public final class bow implements DynamicMBean {
   private static final Logger a = LogUtils.getLogger();
   private final MinecraftServer b;
   private final MBeanInfo c;
   private final Map<String, bow.a> d = Stream.of(
         new bow.a("tickTimes", this::b, "Historical tick times (ms)", long[].class),
         new bow.a("averageTickTime", this::a, "Current average tick time (ms)", long.class)
      )
      .collect(Collectors.toMap($$0x -> $$0x.a, Function.identity()));

   private bow(MinecraftServer $$0) {
      this.b = $$0;
      MBeanAttributeInfo[] $$1 = this.d.values().stream().map(bow.a::a).toArray(MBeanAttributeInfo[]::new);
      this.c = new MBeanInfo(bow.class.getSimpleName(), "metrics for dedicated server", $$1, null, null, new MBeanNotificationInfo[0]);
   }

   public static void a(MinecraftServer $$0) {
      try {
         ManagementFactory.getPlatformMBeanServer().registerMBean(new bow($$0), new ObjectName("net.minecraft.server:type=Server"));
