...
public abstract class bow extends box {
   ...
   private static final aim<Integer> q = aiq.a(bow.class, aio.b);
   private static final aim<Integer> r = aiq.a(bow.class, aio.b);
   private static final aim<Integer> s = aiq.a(bow.class, aio.b);
   private static final aim<Vector3f> t = aiq.a(bow.class, aio.B);
   private static final aim<Vector3f> u = aiq.a(bow.class, aio.B);
   private static final aim<Quaternionf> v = aiq.a(bow.class, aio.C);
   private static final aim<Quaternionf> aE = aiq.a(bow.class, aio.C);
   private static final aim<Byte> aF = aiq.a(bow.class, aio.a);
   private static final aim<Integer> aG = aiq.a(bow.class, aio.b);
   private static final aim<Float> aH = aiq.a(bow.class, aio.d);
   private static final aim<Float> aI = aiq.a(bow.class, aio.d);
   private static final aim<Float> aJ = aiq.a(bow.class, aio.d);
   private static final aim<Float> aK = aiq.a(bow.class, aio.d);
   private static final aim<Float> aL = aiq.a(bow.class, aio.d);
   private static final aim<Integer> aM = aiq.a(bow.class, aio.b);
   ...
   protected void a(ta $$0) {
      ...
      if ($$0.b("billboard", 8)) {
         bow.a.e.decode(to.a, $$0.c("billboard")).resultOrPartial(ac.a("Display entity", p::error)).ifPresent($$0x -> this.a((bow.a)$$0x.getFirst()));
      }
   ...
   protected void b(ta $$0) {
      ...
      bow.a.e.encodeStart(to.a, this.w()).result().ifPresent($$1x -> $$0.a("billboard", $$1x));
   ...
   public void a(double $$0, double $$1, double $$2, float $$3, float $$4, int $$5) {
      int $$6 = this.v();
      this.aY = new bow.j($$6, $$0, $$1, $$2, (double)$$3, (double)$$4);
   }
   ...
   private void a(bow.a $$0) {
      this.an.a(aF, $$0.a());
   }

   private bow.a w() {
      return bow.a.f.apply(this.an.a(aF));
   }
   ...
   private void G() {
      ...
      if ($$0 != 0.0F && $$1 != 0.0F) {
         ...
         double $$4 = this.dt();
         double $$5 = this.dx();
         this.aU = new epo($$3 - (double)$$2, $$4, $$5 - (double)$$2, $$3 + (double)$$2, $$4 + (double)$$1, $$5 + (double)$$2);
      } else {
         this.at = true;
      }
   }
   ...
   private bow.k H() {
      return new bow.k(bow.e.constant(a(this.an)), this.w(), this.y(), bow.d.constant(this.A()), bow.d.constant(this.B()), this.D());
   }

   private bow.k a(bow.k $$0, float $$1) {
      j $$2 = $$0.a.get($$1);
      float $$3 = $$0.d.get($$1);
      float $$4 = $$0.e.get($$1);
      return new bow.k(new bow.m($$2, a(this.an)), this.w(), this.y(), new bow.h($$3, this.A()), new bow.h($$4, this.B()), this.D());
   }
   ...
   public static enum a implements axq {
      ...
      public static final Codec<bow.a> e = axq.a(bow.a::values);
      public static final IntFunction<bow.a> f = avn.a(bow.a::a, values(), avn.a.a);
   ...
   public static class b extends bow {
      public static final String p = "block_state";
      private static final aim<dnb> q = aiq.a(bow.b.class, aio.i);
      @Nullable
      private bow.b.a r;

      public b(bpd<?> $$0, cxb $$1) {
         super($$0, $$1);
      }
      ...
      protected void a(boolean $$0, float $$1) {
         this.r = new bow.b.a(this.s());
      }

      public static record a(dnb a) {
      }
   }

   static record c(int a, int b) implements bow.f {
      @Override
   ...
   public static class g extends bow {
      private static final String p = "item";
      private static final String q = "item_display";
      private static final aim<cqm> r = aiq.a(bow.g.class, aio.h);
      private static final aim<Byte> s = aiq.a(bow.g.class, aio.a);
      private final bqg t = new bqg() {
         @Override
         public cqm a() {
            return g.this.s();
         }
      ...
      private cqj v() {
         return cqj.k.apply(this.an.a(s));
      }
      ...
      protected void a(ta $$0) {
         ...
         if ($$0.b("item_display", 8)) {
            cqj.j.decode(to.a, $$0.c("item_display")).resultOrPartial(ac.a("Display entity", bow.p::error)).ifPresent($$0x -> this.a((cqj)$$0x.getFirst()));
         }
      }
      ...
      protected void b(ta $$0) {
         ...
         cqj.j.encodeStart(to.a, this.v()).result().ifPresent($$1 -> $$0.a("item_display", $$1));
      }

      @Override
      public bqg a_(int $$0) {
         return $$0 == 0 ? this.t : bqg.b;
      }
      ...
      protected void a(boolean $$0, float $$1) {
         cqm $$2 = this.s();
         $$2.a(this);
         this.u = new bow.g.a($$2, this.v());
      }

      public static record a(cqm a, cqj b) {
      }
   }

   static record h(float a, float b) implements bow.d {
      @Override
   ...
   static record i(int a, int b) implements bow.f {
      @Override
      public int get(float $$0) {
   ...
   public static record k(bow.e<j> a, bow.a b, int c, bow.d d, bow.d e, int f) {
   }

   public static class l extends bow {
      ...
      private static final aim<vu> aM = aiq.a(bow.l.class, aio.f);
      private static final aim<Integer> aN = aiq.a(bow.l.class, aio.b);
      private static final aim<Integer> aO = aiq.a(bow.l.class, aio.b);
      private static final aim<Byte> aP = aiq.a(bow.l.class, aio.a);
      private static final aim<Byte> aQ = aiq.a(bow.l.class, aio.a);
      ...
      protected void a(ta $$0) {
         ...
         Optional<bow.l.a> $$2 = bow.l.a.d.decode(to.a, $$0.c("alignment")).resultOrPartial(ac.a("Display entity", bow.p::error)).map(Pair::getFirst);
         if ($$2.isPresent()) {
            $$1 = switch ((bow.l.a)$$2.get()) {
               case a -> $$1;
               case b -> (byte)($$1 | 8);
               case c -> (byte)($$1 | 16);
            };
         ...
         if ($$0.b("text", 8)) {
            ...
            try {
               ...
               bow.p.warn("Failed to parse display entity text {}", $$3, var8);
            }
         }
      }
      ...
      protected void b(ta $$0) {
         ...
         bow.l.a.d.encodeStart(to.a, a($$1)).result().ifPresent($$1x -> $$0.a("alignment", $$1x));
      }
      ...
      private bow.l.e z() {
         return new bow.l.e(this.s(), this.v(), bow.f.constant(this.w()), bow.f.constant(this.x()), this.y());
      }

      private bow.l.e a(bow.l.e $$0, float $$1) {
         int $$2 = $$0.d.get($$1);
         int $$3 = $$0.c.get($$1);
         return new bow.l.e(this.s(), this.v(), new bow.i($$3, this.w()), new bow.c($$2, this.x()), this.y());
      }

      public bow.l.b a(bow.l.d $$0) {
         if (this.aS == null) {
            if (this.aT != null) {
               this.aS = $$0.split(this.aT.a(), this.aT.b());
            } else {
               this.aS = new bow.l.b(List.of(), 0);
            }
         }
      ...
      public static bow.l.a a(byte $$0) {
         if (($$0 & 8) != 0) {
            return bow.l.a.b;
         } else {
            return ($$0 & 16) != 0 ? bow.l.a.c : bow.l.a.a;
         }
      }
      ...
      public static enum a implements axq {
         ...
         public static final Codec<bow.l.a> d = axq.a(bow.l.a::values);
      ...
      public static record b(List<bow.l.c> a, int b) {
      }
      ...
      @FunctionalInterface
      public interface d {
         bow.l.b split(vu var1, int var2);
      }

      public static record e(vu a, int b, bow.f c, bow.f d, byte e) {
      }
   }

   static record m(j a, j b) implements bow.e<j> {
      public j a(float $$0) {
