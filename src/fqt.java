...
public class fqt implements gaf {
   ...
   protected void a(foe $$0, float $$1, int $$2, int $$3, gag $$4) {
      int $$5 = axk.a($$1);
      $$0.a(gmi::H, a, $$2 - 91, $$3, 182, 22, $$5);
      if ($$4.a() >= 0) {
         $$0.a(gmi::H, b, $$2 - 91 - 1 + $$4.a() * 20, $$3 - 1, 24, 23, $$5);
      }
   ...
   private void a(foe $$0, int $$1, int $$2, float $$3, float $$4, gae $$5) {
      if ($$5 != gac.a) {
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == gac.a || !this.g.a($$1).aT_())) {
         $$1 += $$0;
      }
