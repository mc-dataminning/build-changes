...
public class fqt implements fqe<def> {
   ...
   private static final Map<czx.a, aex> b = ac.a(Maps.newHashMap(), $$0 -> {
      $$0.put(czx.b.a, new aex("textures/entity/skeleton/skeleton.png"));
      $$0.put(czx.b.b, new aex("textures/entity/skeleton/wither_skeleton.png"));
      $$0.put(czx.b.d, new aex("textures/entity/zombie/zombie.png"));
      $$0.put(czx.b.e, new aex("textures/entity/creeper/creeper.png"));
      $$0.put(czx.b.g, new aex("textures/entity/enderdragon/dragon.png"));
      $$0.put(czx.b.f, new aex("textures/entity/piglin/piglin.png"));
      $$0.put(czx.b.c, fzw.a());
   });
   ...
   public static void a(@Nullable hc $$0, float $$1, float $$2, elp $$3, foe $$4, int $$5, fha $$6, fom $$7) {
      $$3.a();
      if ($$0 == null) {
         $$3.a(0.5F, 0.0F, 0.5F);
      } else {
