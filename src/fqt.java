...
public abstract class fqt {
   ...
   protected fqt(fnq $$0, double $$1, double $$2, double $$3) {
      this.c = $$0;
      this.b(0.2F, 0.2F);
      this.c($$1, $$2, $$3);
      this.d = $$1;
   ...
   public fqt(fnq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      this($$0, $$1, $$2, $$3);
   ...
   public abstract void a(eqd var1, eur var2, float var3);
   ...
   protected int a(float $$0) {
      ...
      return this.c.B($$1) ? ftd.a(this.c, $$1) : 0;
   }
