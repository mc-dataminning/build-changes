...
public class fqt<T extends deo> implements fqa<T> {
   public static final aez a = new aez("textures/environment/end_sky.png");
   public static final aez b = new aez("textures/entity/end_portal.png");
   ...
   private void a(T $$0, Matrix4f $$1, eln $$2) {
      float $$3 = this.c();
      float $$4 = this.b();
   ...
   private void a(T $$0, Matrix4f $$1, eln $$2, float $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9, float $$10, ha $$11) {
      if ($$0.a($$11)) {
         $$2.a($$1, $$3, $$5, $$7).e();
         $$2.a($$1, $$4, $$5, $$8).e();
         $$2.a($$1, $$4, $$6, $$9).e();
