...
public class flu extends flv {
   private static final xp d = xp.c("chat.copy");
   private static final xp r = xp.c("chat.link.warning");
   private final String s;
   private final boolean u;

   public flu(BooleanConsumer $$0, String $$1, boolean $$2) {
      this($$0, c($$2), xp.b($$1), $$1, $$2 ? xo.e : xo.g, $$2);
   }

   public flu(BooleanConsumer $$0, xp $$1, String $$2, boolean $$3) {
      this($$0, $$1, a($$3, $$2), $$2, $$3 ? xo.e : xo.g, $$3);
   }

   public flu(BooleanConsumer $$0, xp $$1, xp $$2, String $$3, xp $$4, boolean $$5) {
      super($$0, $$1, $$2);
   ...
   protected void a(int $$0) {
      this.c(fhe.a(this.a, $$0x -> this.c.accept(true)).a(this.n / 2 - 50 - 105, $$0, 100, 20).a());
      this.c(fhe.a(d, $$0x -> {
         this.l();
         this.c.accept(false);
      }).a(this.n / 2 - 50, $$0, 100, 20).a());
      this.c(fhe.a(this.b, $$0x -> this.c.accept(false)).a(this.n / 2 - 50 + 105, $$0, 100, 20).a());
   }
   ...
   public static fhe.c b(fnd $$0, String $$1) {
      return $$2 -> a($$0, $$1);
   }
}
