...
public class flu {
   ...
   public static flr a(flr $$0) {
      return $$0;
   }

   public static flr a(flr $$0, flr $$1) {
   ...
   static class a implements flr {
      private final flr a;
      private final flr b;

      public a(flr $$0, flr $$1) {
         if ($$0 == $$1) {
   ...
   static record b(flr[] a) implements flr {
      b(flr[] a) {
