public class flu extends fmp {
   private final fmk a;

   flu(fis $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fmk $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cbp $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dr();
            if (this.h > $$1) {
               this.h = this.h + ($$1 - this.h) * 0.2;
               this.k = this.k + ($$0.dn().d - this.k) * 0.2;
   ...
   public static class b implements fls<ja> {
      ...
      public flp a(ja $$0, fis $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         flp $$8 = new flu($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
