...
public class flu {
   ...
   public static List<flu.a> a(String $$0, flu.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<flu.a> a(String $$0, List<flu.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<flu.a> a(List<String> $$0, List<flu.b> $$1) {
      int $$2 = 0;
      List<flu.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<flu.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static flu.b a(String $$0, String $$1) {
         return new flu.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static flu.b a(String $$0) {
         return new flu.b($$0);
      }
   }
}
