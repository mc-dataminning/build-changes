...
public class flu extends fne {
   ...
   protected void aM_() {
      ...
      this.b = new fho(this.m.i, 4, this.o - 12, this.n - 4, 12, xp.c("chat.editBox")) {
         @Override
         protected yd aJ_() {
            return super.aJ_().b(flu.this.v.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.v = new fhi(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.v.b(false);
      this.v.d();
   }
   ...
   public void a(fgs $$0, int $$1, int $$2, float $$3) {
      ...
      this.v.a($$0, $$1, $$2);
      $$0.c().b();
      ffb $$4 = this.m.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(flb $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fla.a, xp.a("chat_screen.message", $$1));
      }
   }
