...
public class dxm {
   ...
   static class a implements dxm.i {
      @Override
      public boolean a(dxm.v $$0) {
         return $$0.c[hc.f.d()] && !$$0.b[hc.f.d()].d;
      }

      @Override
      public dxm.r a(hc $$0, dxm.v $$1, ase $$2) {
         $$1.d = true;
         $$1.b[hc.f.d()].d = true;
         return new dxm.k($$0, $$1);
      }
   }

   static class b implements dxm.i {
      @Override
      public boolean a(dxm.v $$0) {
         if ($$0.c[hc.f.d()] && !$$0.b[hc.f.d()].d && $$0.c[hc.b.d()] && !$$0.b[hc.b.d()].d) {
            dxm.v $$1 = $$0.b[hc.f.d()];
            return $$1.c[hc.b.d()] && !$$1.b[hc.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public dxm.r a(hc $$0, dxm.v $$1, ase $$2) {
         ...
         $$1.b[hc.f.d()].d = true;
         $$1.b[hc.b.d()].d = true;
         $$1.b[hc.f.d()].b[hc.b.d()].d = true;
         return new dxm.l($$0, $$1);
      }
   }

   static class c implements dxm.i {
      @Override
      public boolean a(dxm.v $$0) {
         return $$0.c[hc.b.d()] && !$$0.b[hc.b.d()].d;
      }
      ...
      public dxm.r a(hc $$0, dxm.v $$1, ase $$2) {
         $$1.d = true;
         $$1.b[hc.b.d()].d = true;
         return new dxm.m($$0, $$1);
      }
   }

   static class d implements dxm.i {
      @Override
      public boolean a(dxm.v $$0) {
         if ($$0.c[hc.c.d()] && !$$0.b[hc.c.d()].d && $$0.c[hc.b.d()] && !$$0.b[hc.b.d()].d) {
            dxm.v $$1 = $$0.b[hc.c.d()];
            return $$1.c[hc.b.d()] && !$$1.b[hc.b.d()].d;
         } else {
            return false;
      ...
      public dxm.r a(hc $$0, dxm.v $$1, ase $$2) {
         ...
         $$1.b[hc.c.d()].d = true;
         $$1.b[hc.b.d()].d = true;
         $$1.b[hc.c.d()].b[hc.b.d()].d = true;
         return new dxm.n($$0, $$1);
      }
   }

   static class e implements dxm.i {
      @Override
      public boolean a(dxm.v $$0) {
         return $$0.c[hc.c.d()] && !$$0.b[hc.c.d()].d;
      }

      @Override
      public dxm.r a(hc $$0, dxm.v $$1, ase $$2) {
         dxm.v $$3 = $$1;
         if (!$$1.c[hc.c.d()] || $$1.b[hc.c.d()].d) {
            $$3 = $$1.b[hc.d.d()];
         }

         $$3.d = true;
         $$3.b[hc.c.d()].d = true;
         return new dxm.o($$0, $$3);
      }
   }

   static class f implements dxm.i {
      @Override
      public boolean a(dxm.v $$0) {
         return true;
      }
      ...
      public dxm.r a(hc $$0, dxm.v $$1, ase $$2) {
         $$1.d = true;
         return new dxm.s($$0, $$1, $$2);
      }
   }

   static class g implements dxm.i {
      @Override
      public boolean a(dxm.v $$0) {
         return !$$0.c[hc.e.d()] && !$$0.c[hc.f.d()] && !$$0.c[hc.c.d()] && !$$0.c[hc.d.d()] && !$$0.c[hc.b.d()];
      }

      @Override
      public dxm.r a(hc $$0, dxm.v $$1, ase $$2) {
         $$1.d = true;
         return new dxm.t($$0, $$1);
      }
   }

   public static class h extends dxm.r {
      ...
      private dxm.v G;
      private dxm.v H;
      private final List<dxm.r> I = Lists.newArrayList();

      public h(ase $$0, int $$1, int $$2, hc $$3) {
         super(dwb.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dxm.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dxm.p($$3, this.G));
         this.I.add(new dxm.j($$3, this.H));
         List<dxm.i> $$5 = Lists.newArrayList();
         $$5.add(new dxm.b());
         $$5.add(new dxm.d());
         $$5.add(new dxm.e());
         $$5.add(new dxm.a());
         ...
         dvc $$10 = dvc.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dvc $$11 = dvc.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dvc $$12 = dvc.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dxm.u($$3, $$10, $$13++));
         this.I.add(new dxm.u($$3, $$11, $$13++));
         this.I.add(new dxm.q($$3, $$12));
      }
      ...
      private List<dxm.v> b(ase $$0) {
         dxm.v[] $$1 = new dxm.v[75];
         ...
         dxm.v $$23 = new dxm.v(1003);
         dxm.v $$24 = new dxm.v(1001);
         dxm.v $$25 = new dxm.v(1002);
         $$1[v].a(hc.b, $$23);
         $$1[w].a(hc.d, $$24);
         $$1[x].a(hc.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[hc.f.d()].d = true;
         this.H.b[hc.c.d()].d = true;
         this.H.b[hc.f.d()].b[hc.c.d()].d = true;
         this.H.b[hc.b.d()].d = true;
         this.H.b[hc.f.d()].b[hc.b.d()].d = true;
         this.H.b[hc.c.d()].b[hc.b.d()].d = true;
         this.H.b[hc.f.d()].b[hc.c.d()].b[hc.b.d()].d = true;
         ObjectArrayList<dxm.v> $$26 = new ObjectArrayList();
      ...
      public void a(cqr $$0, cqp $$1, dhi $$2, ase $$3, dvc $$4, cpe $$5, gw $$6) {
         int $$7 = Math.max($$0.y_(), 64) - this.f.h();
      ...
      private void a(boolean $$0, int $$1, cqr $$2, ase $$3, dvc $$4) {
         int $$5 = 24;
      ...
      private void a(cqr $$0, ase $$1, dvc $$2) {
      ...
      private void b(cqr $$0, ase $$1, dvc $$2) {
      ...
      private void c(cqr $$0, ase $$1, dvc $$2) {
      ...
      private void d(cqr $$0, ase $$1, dvc $$2) {
      ...
      private void e(cqr $$0, ase $$1, dvc $$2) {
      ...
      private void f(cqr $$0, ase $$1, dvc $$2) {
   ...
   interface i {
      boolean a(dxm.v var1);

      dxm.r a(hc var1, dxm.v var2, ase var3);
   }

   public static class j extends dxm.r {
      public j(hc $$0, dxm.v $$1) {
         super(dwb.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cqr $$0, cqp $$1, dhi $$2, ase $$3, dvc $$4, cpe $$5, gw $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, csy.ch.n(), csy.ch.n(), false);
   ...
   public static class k extends dxm.r {
      public k(hc $$0, dxm.v $$1) {
         super(dwb.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(cqr $$0, cqp $$1, dhi $$2, ase $$3, dvc $$4, cpe $$5, gw $$6) {
         dxm.v $$7 = this.B.b[hc.f.d()];
         dxm.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[hc.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[hc.a.d()]);
         }
   ...
   public static class l extends dxm.r {
      public l(hc $$0, dxm.v $$1) {
         super(dwb.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dxm.r {
      public m(hc $$0, dxm.v $$1) {
         super(dwb.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(cqr $$0, cqp $$1, dhi $$2, ase $$3, dvc $$4, cpe $$5, gw $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[hc.a.d()]);
         }

         dxm.v $$7 = this.B.b[hc.b.d()];
         if ($$7.b[hc.b.d()] == null) {
   ...
   public static class n extends dxm.r {
      public n(hc $$0, dxm.v $$1) {
         super(dwb.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(cqr $$0, cqp $$1, dhi $$2, ase $$3, dvc $$4, cpe $$5, gw $$6) {
         dxm.v $$7 = this.B.b[hc.c.d()];
         dxm.v $$8 = this.B;
         dxm.v $$9 = $$7.b[hc.b.d()];
         dxm.v $$10 = $$8.b[hc.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[hc.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[hc.a.d()]);
         }
   ...
   public static class o extends dxm.r {
      public o(hc $$0, dxm.v $$1) {
         super(dwb.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dxm.r {
      public p(hc $$0, dxm.v $$1) {
         super(dwb.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dxm.r {
      public q(hc $$0, dvc $$1) {
         super(dwb.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dvo {
      protected static final dfl b = csy.hZ.n();
      protected static final dfl c = csy.ia.n();
      protected static final dfl d = csy.ib.n();
      protected static final dfl h = c;
      protected static final dfl i = csy.ii.n();
      protected static final boolean j = true;
      protected static final dfl k = csy.G.n();
      protected static final Set<csx> l = ImmutableSet.builder().add(csy.dO).add(csy.iC).add(csy.mW).add(k.b()).build();
      ...
      public r(dwb $$0, hc $$1, int $$2, dvc $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dwb $$0, int $$1, hc $$2, dxm.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dvc a(hc $$0, dxm.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dvc $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cqr $$0, dvc $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dfl $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.y_() && $$11 != k) {
                        this.a($$0, csy.a.n(), $$9, $$8, $$10, $$1);
                     } else {
                        this.a($$0, k, $$9, $$8, $$10, $$1);
                     }
                  }
      ...
      protected void a(cqr $$0, dvc $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cqr $$0, dvc $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dfl $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dvc $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cqr $$0, dvc $$1, int $$2, int $$3, int $$4) {
         gw $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            byz $$6 = biw.A.a((cpx)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eL());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dl()), bjm.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends dxm.r {
      private int a;

      public s(hc $$0, dxm.v $$1, ase $$2) {
         super(dwb.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(cqr $$0, cqp $$1, dhi $$2, ase $$3, dvc $$4, cpe $$5, gw $$6) {
         ...
         if (this.B.b[hc.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[hc.a.d()] && !this.B.c[hc.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends dxm.r {
      public t(hc $$0, dxm.v $$1) {
         super(dwb.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dxm.r {
      private int a;

      public u(hc $$0, dvc $$1, int $$2) {
         super(dwb.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
