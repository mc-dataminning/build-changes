...
public record dxm(String s, boolean t, boolean u, boolean v, dxm.a w, dre x, avz y, avz z, avz A, avz B, avz C, avz D, avz E, avz F) {
   ...
   public static final dxm b = a(new dxm("iron", false, false, false, dxm.a.a, dre.g, awa.nK, awa.nL, awa.nS, awa.nT, awa.pg, awa.ph, awa.zT, awa.zU));
   public static final dxm c = a(new dxm("copper", true, true, false, dxm.a.a, dre.aj, awa.fP, awa.fQ, awa.fW, awa.fX, awa.pg, awa.ph, awa.zT, awa.zU));
   public static final dxm d = a(new dxm("gold", false, true, false, dxm.a.a, dre.g, awa.nK, awa.nL, awa.nS, awa.nT, awa.pg, awa.ph, awa.zT, awa.zU));
   public static final dxm e = a(new dxm("stone", true, true, false, dxm.a.b, dre.f, awa.nK, awa.nL, awa.nS, awa.nT, awa.zY, awa.zZ, awa.zT, awa.zU));
   public static final dxm f = a(
      new dxm("polished_blackstone", true, true, false, dxm.a.b, dre.f, awa.nK, awa.nL, awa.nS, awa.nT, awa.zY, awa.zZ, awa.zT, awa.zU)
   );
   ...
   public dxm(String $$0) {
      this($$0, true, true, true, dxm.a.a, dre.b, awa.DK, awa.DL, awa.DM, awa.DN, awa.DQ, awa.DR, awa.DO, awa.DP);
   }
