...
public record xg<S>(List<xg.a<S>> a) {
   public static <S> boolean a(ParseResults<S> $$0) {
      return !b($$0).a().isEmpty();
   }

   public static <S> xg<S> b(ParseResults<S> $$0) {
   ...
   private static <S> List<xg.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<xg.a<S>> $$2 = new ArrayList<>();
