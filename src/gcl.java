...
public class gcl implements gck {
   ...
   private final gck.a b = gck.a(new eyp(1536));
   private int c = 255;
   private int d = 255;
   private int e = 255;
   private int f = 255;
   ...
   public eyy getBuffer(gcs $$0) {
      if ($$0.M()) {
         eyy $$1 = this.b.getBuffer($$0);
         return new gcl.a($$1, this.c, this.d, this.e, this.f);
      } else {
         eyy $$2 = this.a.getBuffer($$0);
         Optional<gcs> $$3 = $$0.L();
         if ($$3.isPresent()) {
            eyy $$4 = this.b.getBuffer($$3.get());
   ...
   static class a extends eyt {
      ...
      a(eyy $$0, int $$1, int $$2, int $$3, int $$4) {
         this.f = $$0;
         super.b($$1, $$2, $$3, $$4);
      }
