...
public class gcl extends gcg<cam, fnh<cam>> {
   private static final Map<cam.a, aiy> a = ac.a(Maps.newEnumMap(cam.a.class), $$0 -> {
      $$0.put(cam.a.a, new aiy("textures/entity/panda/panda.png"));
      $$0.put(cam.a.b, new aiy("textures/entity/panda/lazy_panda.png"));
      $$0.put(cam.a.c, new aiy("textures/entity/panda/worried_panda.png"));
      $$0.put(cam.a.d, new aiy("textures/entity/panda/playful_panda.png"));
      $$0.put(cam.a.e, new aiy("textures/entity/panda/brown_panda.png"));
      $$0.put(cam.a.f, new aiy("textures/entity/panda/weak_panda.png"));
      $$0.put(cam.a.g, new aiy("textures/entity/panda/aggressive_panda.png"));
   });

   public gcl(gba.a $$0) {
      super($$0, new fnh<>($$0.a(fpi.aB)), 0.9F);
      this.a(new gfh(this, $$0.d()));
   }

   public aiy a(cam $$0) {
      return a.getOrDefault($$0.gs(), a.get(cam.a.a));
   }

   protected void a(cam $$0, esh $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.bU > 0) {
         int $$6 = $$0.bU;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(awi.i($$25, $$0.dE(), $$0.dE() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(awi.i($$27, $$0.dE(), $$0.dE() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? awi.i($$3, $$0, $$1) : $$0;
   }
}
