public class gcl extends fzv {
   private static final int a = 12235202;

   protected gcl(fxw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gby $$8) {
   ...
   public static class a implements gbg<lm> {
      ...
      public gbd a(lm $$0, fxw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         return new gcl($$1, $$2, $$3, $$4, $$9, $$10, $$11, 1.0F, this.a);
      }
   }
}
