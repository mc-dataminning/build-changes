...
public class grn extends auj<List<String>> {
   ...
   protected List<String> a(aue $$0, bnf $$1) {
      try {
         List var4;
         try (BufferedReader $$2 = fgo.Q().ab().openAsReader(a)) {
   ...
   public fjq a() {
      ...
      if ($$0.get(2) + 1 == 12 && $$0.get(5) == 24) {
         ...
         return this.d != null && b.a(this.c.size()) == 42 ? new fjq(this.d.c().toUpperCase(Locale.ROOT) + " IS YOU") : new fjq(this.c.get(b.a(this.c.size())));
      }
   }
}
