public class grn extends gri<bvr, gxs> {
   private static final alz a = alz.b("textures/entity/experience_orb.png");
   private static final glo b = glo.h(a);
   ...
   protected int a(bvr $$0, jh $$1) {
      return bae.a(super.a($$0, $$1) + 7, 0, 15);
   }

   public void a(gxs $$0, fgl $$1, gle $$2, int $$3) {
      $$1.a();
      int $$4 = $$0.a;
   ...
   private static void a(fgp $$0, fgl.a $$1, float $$2, float $$3, int $$4, int $$5, int $$6, float $$7, float $$8, int $$9) {
      $$0.a($$1, $$2, $$3, 0.0F).a($$4, $$5, $$6, 128).a($$7, $$8).b(hav.d).c($$9).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(bvr $$0, gxs $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.m();
   }
}
