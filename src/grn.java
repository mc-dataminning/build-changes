...
public class grn implements avw {
   private static final glu e = glu.o(alz.b("textures/misc/shadow.png"));
   private static final float f = 32.0F;
   private static final float g = 0.5F;
   private Map<bvq<?>, gro<?, ?>> h = ImmutableMap.of();
   private Map<hcl.a, gro<? extends cpw, ?>> i = Map.of();
   public final hbl a;
   private dhh j;
   public flo b;
   ...
   public grn(fmf $$0, hbl $$1, gsn $$2, glj $$3, gmn $$4, fnp $$5, fmj $$6, gej $$7, hdr $$8) {
      this.a = $$1;
      this.l = $$2;
      this.m = $$3;
      this.o = new gld($$0, this, $$2);
      this.n = $$4;
      this.p = $$5;
      this.d = $$6;
      this.q = $$7;
   ...
   public <T extends bvj> gro<? super T, ?> a(T $$0) {
      if ($$0 instanceof gkd $$1) {
         hcl.a $$2 = $$1.d().e();
         gro<? extends cpw, ?> $$3 = this.i.get($$2);
         return (gro<? super T, ?>)($$3 != null ? $$3 : this.i.get(hcl.a.b));
      } else {
         return (gro<? super T, ?>)this.h.get($$0.aq());
      }
   }

   public void a(dhh $$0, flo $$1, bvj $$2) {
      this.j = $$0;
      this.b = $$1;
      this.k = $$1.f();
      this.c = $$2;
   ...
   public <E extends bvj> boolean a(E $$0, gpb $$1, double $$2, double $$3, double $$4) {
      gro<? super E, ?> $$5 = this.a($$0);
      return $$5.a($$0, $$1, $$2, $$3, $$4);
   }

   public <E extends bvj> void a(E $$0, double $$1, double $$2, double $$3, float $$4, fgr $$5, glk $$6, int $$7) {
      gro<? super E, ?> $$8 = this.a($$0);
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8);
   }

   private <E extends bvj, S extends gxu> void a(E $$0, double $$1, double $$2, double $$3, float $$4, fgr $$5, glk $$6, int $$7, gro<? super E, S> $$8) {
      try {
         S $$9 = $$8.b($$0, $$4);
         fbx $$10 = $$8.a($$9);
         double $$11 = $$1 + $$10.a();
         ...
         if (this.t && !$$9.u && !fmf.Q().az()) {
            a($$5, $$6.getBuffer(glu.y()), $$0, $$4, 1.0F, 1.0F, 1.0F);
         }
   ...
   private static void a(fgr $$0, bvj $$1, glk $$2) {
      bvj $$3 = c($$1);
      if ($$3 == null) {
         gpk.a($$0, $$2, "Missing", $$1.dB(), $$1.cR().e + 1.5, $$1.dH(), -65536);
      } else {
         $$0.a();
         $$0.a($$3.dB() - $$1.dB(), $$3.dD() - $$1.dD(), $$3.dH() - $$1.dH());
         a($$0, $$2.getBuffer(glu.y()), $$3, 1.0F, 0.0F, 1.0F, 0.0F);
         gme.a($$0, $$2.getBuffer(glu.y()), new Vector3f(), $$3.dz(), -256);
         $$0.b();
      }
   }
   ...
   private static void a(fgr $$0, fgv $$1, bvj $$2, float $$3, float $$4, float $$5, float $$6) {
      fbs $$7 = $$2.cR().d(-$$2.dB(), -$$2.dD(), -$$2.dH());
      gme.a($$0, $$1, $$7, $$4, $$5, $$6, 1.0F);
      if ($$2 instanceof ckt) {
         ...
         for (ckq $$11 : ((ckt)$$2).x()) {
            ...
            $$0.a($$12, $$13, $$14);
            gme.a($$0, $$1, $$11.cR().d(-$$11.dB(), -$$11.dD(), -$$11.dH()), 0.25F, 1.0F, 0.0F, 1.0F);
            $$0.b();
         }
      }
      ...
      if ($$2 instanceof bwf) {
         float $$15 = 0.01F;
         gme.a($$0, $$1, $$7.a, (double)($$2.cS() - 0.01F), $$7.c, $$7.d, (double)($$2.cS() + 0.01F), $$7.f, 1.0F, 0.0F, 0.0F, 1.0F);
      }
      ...
      gme.a($$0, $$1, new Vector3f(0.0F, $$2.cS(), 0.0F), $$2.g($$3).c(2.0), -16776961);
   }

   private void a(fgr $$0, glk $$1, gxu $$2, Quaternionf $$3) {
      hbk $$4 = hdw.a.c();
      hbk $$5 = hdw.b.c();
      $$0.a();
      float $$6 = $$2.q * 1.4F;
   ...
   private static void a(fgr $$0, glk $$1, gxu $$2, float $$3, float $$4, dhk $$5, float $$6) {
   ...
   private static void a(fgr.a $$0, fgv $$1, dzp $$2, dhk $$3, jh $$4, double $$5, double $$6, double $$7, float $$8, float $$9) {
      jh $$10 = $$4.e();
      dxu $$11 = $$2.a_($$10);
   ...
   private static void a(fgr.a $$0, fgv $$1, int $$2, float $$3, float $$4, float $$5, float $$6, float $$7) {
      ...
      $$1.a($$8.x(), $$8.y(), $$8.z(), $$2, $$6, $$7, hbb.d, 15728880, 0.0F, 1.0F, 0.0F);
   }
   ...
   @Override
   public void a(avv $$0) {
      grp.a $$1 = new grp.a(this, this.l, this.m, this.n, $$0, this.q, this.r, this.p);
      this.h = grq.a($$1);
      this.i = grq.b($$1);
   }
}
