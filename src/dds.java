...
public class dds {
   ...
   private double j;
   int k = 29999984;
   private dds.a l = new dds.d(5.999997E7F);
   public static final dds.c e = new dds.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dds.a)($$0 == $$1 ? new dds.d($$1) : new dds.b($$0, $$1, $$2));
   ...
   class b implements dds.a {
      ...
      @Override
      public dds.a l() {
         return (dds.a)(this.g() <= 0L ? dds.this.new d(this.c) : this);
      }
      ...
      public efb m() {
         return eey.a(
            eey.c,
            eey.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            eem.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dds.c a(DynamicLike<?> $$0, dds.c $$1) {
         ...
         return new dds.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
