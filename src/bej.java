...
public class bej extends bhp {
   public bej(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bit.D, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bit.F.typeName(), bko.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bit.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bit.F.typeName(), "minecraft:saddle"));
