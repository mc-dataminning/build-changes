...
public class bej extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("EffectDurationEntity", $$0.getType(bjm.D), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped("EffectDurationPlayer", $$0.getType(bjm.b), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
