...
public interface exr {
   exr a(double var1, double var3, double var5);

   exr a(int var1, int var2, int var3, int var4);

   exr a(float var1, float var2);

   exr a(int var1, int var2);

   exr b(int var1, int var2);

   exr a(float var1, float var2, float var3);
   ...
   default exr a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default exr a(int $$0) {
      return this.a(axg.b.b($$0), axg.b.c($$0), axg.b.d($$0), axg.b.a($$0));
   }
   ...
   default void a(exn.a $$0, gcb $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(exn.a $$0, gcb $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      ...
      try {
         ByteBuffer $$19 = $$18.malloc(exl.j.b());
   ...
   default exr a(exn.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default exr a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default exr b(exn.a $$0, float $$1, float $$2, float $$3) {
