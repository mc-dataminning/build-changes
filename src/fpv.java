...
public class fpv extends fii<fpv.a> {
   ...
   private final fps N;
   private final List<fpv.d> O = Lists.newArrayList();
   private final fpv.a P = new fpv.b();
   private final List<fpv.c> Q = Lists.newArrayList();

   public fpv(fps $$0, ffn $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public void a(@Nullable fpv.a $$0) {
      super.a($$0);
      this.N.E();
   }
   ...
   public void a(fys $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.O.add(new fpv.d(this.N, $$0.a($$1)));
      }

      this.J();
   }

   public void a(List<gtl> $$0) {
      int $$1 = $$0.size() - this.Q.size();
      this.Q.clear();

      for (gtl $$2 : $$0) {
         this.Q.add(new fpv.c(this.N, $$2));
      }

      this.J();

      for (int $$3 = this.Q.size() - $$1; $$3 < this.Q.size(); $$3++) {
         fpv.c $$4 = this.Q.get($$3);
   ...
   public abstract static class a extends fii.a<fpv.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends fpv.a {
      private final ffn a = ffn.Q();

      @Override
      public void a(fgz $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.a(this.a.h, fpv.G, this.a.y.m / 2 - this.a.h.a(fpv.G) / 2, $$10, 16777215, false);
         String $$11 = fms.a(ac.c());
   ...
   public static class c extends fpv.a {
      ...
      protected final gtl b;
      private long g;

      protected c(fps $$0, gtl $$1) {
         this.f = $$0;
         this.b = $$1;
         this.a = ffn.Q();
      }
   ...
   public class d extends fpv.a {
      ...
      protected d(final fps $$1, final fyr $$2) {
         this.g = $$1;
         this.i = $$2;
         this.h = ffn.Q();
         this.j = fmn.b(this.h.aa(), $$2.b);
         this.d();
      }
      ...
      public void a(fgz $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            fpv.F.submit(() -> {
               try {
                  this.g.F().a(this.i, () -> this.h.execute(this::b), () -> {
                     this.i.a(this.i.g == aa.b().e() ? fyr.b.e : fyr.b.d);
         ...
         wu $$15 = (wu)(this.i.g() == fyr.b.d ? this.i.h.f().a(n.m) : this.i.c);
      ...
      protected void a(fgz $$0, int $$1, int $$2, akk $$3) {
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               fpv.E.error("Invalid icon for server {} ({})", new Object[]{this.i.a, this.i.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)fpv.this.s();
         double $$4 = $$1 - (double)fpv.this.g(fpv.this.aF_().indexOf(this));
         if ($$3 <= 32.0) {
