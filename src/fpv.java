...
public class fpv {
   ...
   private static final Comparator<ggm> p = Comparator.<ggm>comparingInt($$0 -> -$$0.k())
      .thenComparingInt($$0 -> $$0.e() == dgg.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), fcb::b, ""))
   ...
   private wp t;
   private boolean u;
   private final Map<UUID, fpv.a> v = new Object2ObjectOpenHashMap();

   public fpv(flk $$0, foe $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public wp a(ggm $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, fcb.a($$0.h(), wp.b($$0.a().getName())));
   }

   private wp a(ggm $$0, xd $$1) {
      return $$0.e() == dgg.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(fof $$0, int $$1, fcg $$2, @Nullable fby $$3) {
      List<ggm> $$4 = this.b();
      List<fpv.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            GameProfile $$43 = $$41.a();
            if ($$21) {
               coy $$44 = this.q.s.b($$43.getId());
               boolean $$45 = $$44 != null && gtg.b($$44);
               fpt.a($$0, $$41.g().a(), $$39, $$40, 8, $$41.j(), $$45, -1);
               $$39 += 9;
            }

            $$0.b(this.q.h, $$42.a, $$39, $$40, $$41.e() == dgg.d ? -1862270977 : -1);
            if ($$3 != null && $$41.e() != dgg.d) {
               int $$46 = $$39 + $$7 + 1;
               int $$47 = $$46 + $$22;
               if ($$47 - $$46 > 5) {
   ...
   protected void a(fof $$0, int $$1, int $$2, int $$3, ggm $$4) {
      akv $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
      ...
      $$0.a(gmj::H, $$5, $$2 + $$1 - 11, $$3, 10, 8);
      $$0.c().b();
   }

   private void a(fby $$0, int $$1, fpv.b $$2, int $$3, int $$4, UUID $$5, fof $$6) {
      if ($$0.h() == fcj.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, fof $$4, int $$5) {
      fpv.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new fpv.a($$5));
      $$6.a($$5, (long)this.r.e());
      ...
      if ($$7 > 0) {
         ...
         if ($$10 <= 3) {
            ...
            for (int $$18 = $$7; $$18 < $$8; $$18++) {
               $$4.a(gmj::H, $$17, $$1 + $$18 * $$10, $$0, 9, 9);
            }

            for (int $$19 = 0; $$19 < $$7; $$19++) {
               $$4.a(gmj::H, $$17, $$1 + $$19 * $$10, $$0, 9, 9);
               if ($$9) {
                  if ($$19 * 2 + 1 < $$6.a()) {
                     $$4.a(gmj::H, j, $$1 + $$19 * $$10, $$0, 9, 9);
                  }

                  if ($$19 * 2 + 1 == $$6.a()) {
                     $$4.a(gmj::H, k, $$1 + $$19 * $$10, $$0, 9, 9);
                  }
               }

               if ($$19 * 2 + 1 < $$5) {
                  $$4.a(gmj::H, $$19 >= 10 ? l : m, $$1 + $$19 * $$10, $$0, 9, 9);
               }

               if ($$19 * 2 + 1 == $$5) {
                  $$4.a(gmj::H, $$19 >= 10 ? n : o, $$1 + $$19 * $$10, $$0, 9, 9);
               }
            }
         }
      }
