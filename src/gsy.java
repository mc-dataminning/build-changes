...
public class gsy implements gtf.a {
   ...
   private final fof w;
   private final Map<iu, gsy.a> x = new HashMap<>();
   private final Map<UUID, aac.a> y = new HashMap<>();
   @Nullable
   private UUID z;
   ...
   public void a(aan.a $$0, long $$1) {
      this.x.put($$0.a(), new gsy.a($$0, $$1));
   }

   public void a(aac.a $$0) {
      this.y.put($$0.b(), $$0);
   }
   ...
   private void a(fiq $$0, gpd $$1) {
      ...
      for (iu $$3 : this.x.keySet()) {
         if ($$2.a($$3, 30.0)) {
            a($$0, $$1, $$3);
         }
      }

      Map<iu, Set<UUID>> $$4 = this.d();
   ...
   private Map<iu, Set<UUID>> d() {
      Map<iu, Set<UUID>> $$0 = Maps.newHashMap();
      this.y.values().forEach($$1 -> $$1.j().forEach($$2 -> $$0.computeIfAbsent($$2, $$0xxx -> Sets.newHashSet()).add($$1.b())));
      return $$0;
   }

   private void b(fiq $$0, gpd $$1) {
      Map<iu, Set<UUID>> $$2 = Maps.newHashMap();
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(agj::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gtf.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(agj::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(fiq $$0, gpd $$1, iu $$2) {
      float $$3 = 0.05F;
      gtf.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(fiq $$0, gpd $$1, iu $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gtf.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(fiq $$0, gpd $$1, aan.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(fiq $$0, gpd $$1, aac.a $$2) {
      if ($$2.e() != null) {
         gto.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(fiq $$0, gpd $$1, aac.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(fiq $$0, gpd $$1, String $$2, aan.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(fiq $$0, gpd $$1, String $$2, iu $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      gtf.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(fiq $$0, gpd $$1, jo $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      iu $$9 = iu.a($$2);
      ...
      float $$13 = 0.5F;
      gtf.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(aan.a $$0) {
      return this.a($$0.a()).stream().map(agj::a).collect(Collectors.toSet());
   }

   private String a(aac.a $$0, iu $$1) {
      double $$2 = Math.sqrt($$1.b($$0.d()));
      double $$3 = (double)Math.round($$2 * 10.0) / 10.0;
      return $$1.x() + " (dist " + $$3 + ")";
   }

   private boolean b(aac.a $$0) {
      return Objects.equals(this.z, $$0.b());
   }

   private boolean c(aac.a $$0) {
      cqs $$1 = this.w.t;
      iu $$2 = iu.a($$1.dA(), $$0.d().b(), $$1.dG());
      iu $$3 = iu.a((jo)$$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(iu $$0) {
      return this.y.values().stream().filter($$1 -> $$1.a($$0)).map(aac.a::b).collect(Collectors.toSet());
   }

   private Map<iu, List<String>> f() {
      Map<iu, List<String>> $$0 = Maps.newHashMap();

      for (aac.a $$1 : this.y.values()) {
   ...
   private void g() {
      gtf.a(this.w.ao(), 8).ifPresent($$0 -> this.z = $$0.cG());
   }

   static record a(aan.a a, long b) {
   }
}
