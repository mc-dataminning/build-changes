...
public record gsy<T>(String F, String G, Codec<T> H, gsy.a<T> I) {
   ...
   public static final gsy<Instant> m = a("event_timestamp_utc", "eventTimestampUtc", axn.m, ($$0, $$1, $$2) -> $$0.addProperty($$1, J.format($$2)));
   ...
   public static enum b implements ayz {
      ...
      public static final Codec<gsy.b> f = ayz.a(gsy.b::values);
   ...
   public static enum c implements ayz {
      ...
      public static final Codec<gsy.c> d = ayz.a(gsy.c::values);
