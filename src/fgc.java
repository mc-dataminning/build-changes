...
public class fgc extends eyb<fgc.a> {
   ...
   private final ffy O;
   private final List<fgc.d> P = Lists.newArrayList();
   private final fgc.a Q = new fgc.b();
   private final List<fgc.c> R = Lists.newArrayList();

   public fgc(ffy $$0, evh $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.O = $$0;
   }
   ...
   public void a(@Nullable fgc.a $$0) {
      super.a($$0);
      this.O.D();
   }
   ...
   public void a(fod $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.P.add(new fgc.d(this.O, $$0.a($$1)));
      }

      this.e();
   }

   public void a(List<gir> $$0) {
      int $$1 = $$0.size() - this.R.size();
      this.R.clear();

      for (gir $$2 : $$0) {
         this.R.add(new fgc.c(this.O, $$2));
      }

      this.e();

      for (int $$3 = this.R.size() - $$1; $$3 < this.R.size(); $$3++) {
         fgc.c $$4 = this.R.get($$3);
   ...
   public abstract static class a extends eyb.a<fgc.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends fgc.a {
      private final evh a = evh.O();

      @Override
      public void a(ewt $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.a(this.a.h, fgc.H, this.a.y.g / 2 - this.a.h.a(fgc.H) / 2, $$10, 16777215, false);
         String $$11 = fcl.a(ac.b());
   ...
   public static class c extends fgc.a {
      ...
      protected final gir b;
      private long g;

      protected c(ffy $$0, gir $$1) {
         this.f = $$0;
         this.b = $$1;
         this.a = evh.O();
      }
   ...
   public class d extends fgc.a {
      ...
      protected d(ffy $$1, foc $$2) {
         this.e = $$1;
         this.g = $$2;
         this.f = evh.O();
         this.h = fcf.b(this.f.Y(), $$2.b);
      }
      ...
      protected void a(ewt $$0, int $$1, int $$2, ahg $$3) {
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               fgc.E.error("Invalid icon for server {} ({})", new Object[]{this.g.a, this.g.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)fgc.this.q();
         double $$4 = $$1 - (double)fgc.this.g(fgc.this.l().indexOf(this));
         if ($$3 <= 32.0) {
