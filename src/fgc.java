...
public class fgc {
   ...
   public static ffz a(ffz $$0) {
      return $$0;
   }

   public static ffz a(ffz $$0, ffz $$1) {
   ...
   static class a implements ffz {
      private final ffz a;
      private final ffz b;

      public a(ffz $$0, ffz $$1) {
         if ($$0 == $$1) {
   ...
   static record b(ffz[] a) implements ffz {
      b(ffz[] a) {
