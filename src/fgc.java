...
public class fgc extends hct {
   ...
   public void aT_() {
      this.a(this.I.a);
      this.c(fka.a(xd.c("mco.configure.world.subscription.extend"), $$0 -> fop.a(this, axy.a(this.I.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.I.j) {
         this.c(
            fka.a(xd.c("mco.configure.world.delete.button"), $$0 -> this.m.a(ffv.b(this, xd.c("mco.configure.world.delete.question.line1"), $$0x -> this.D())))
               .a(this.n / 2 - 100, g(10), 200, 20)
               .a()
         );
      } else if (fdf.b() && this.I.s != null) {
         this.c(new fkk(this.n / 2 - 100, g(8), 200, 46, xd.a("mco.snapshot.subscription.info", this.I.s), this.p));
      } else {
         this.c(new fkk(this.n / 2 - 100, g(8), 200, 46, G, this.p));
      }

      this.c(fka.a(xc.k, $$0 -> this.d()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
      ...
      (new Thread("Realms-delete-realm") {
         ...
         public void run() {
            try {
               ...
               fgc.a.error("Couldn't delete world", var2);
            }

            fgc.this.m.execute(() -> fgc.this.m.a(fgc.this.J));
         }
      }).start();
      this.m.a(this);
   }
