...
public class gco extends fxu {
   ...
   private final fvq M = new fvq(this);
   @Nullable
   private final fxu N;
   gcn O;
   fsl P;
   private String Q = "";
   private gco.a R = gco.a.a;
   private fsc S;
   private fsc T;
   private fsc U;
   private fsc V;
   ...
   protected void aN_() {
      this.M.a(c, this.p);
      this.O = new gcn(this, this.m, this.n, this.E() - 88, 88, 36);
      int $$0 = this.O.a() / 3;
      int $$1 = this.O.u();
      int $$2 = this.O.v();
      this.S = this.c(fsc.a(u, $$0x -> this.a(gco.a.a)).a($$1, 45, $$0, 20).a());
      this.T = this.c(fsc.a(v, $$0x -> this.a(gco.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.U = this.c(fsc.a(w, $$0x -> this.a(gco.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.P != null ? this.P.a() : "";
      this.P = new fsl(this.p, this.F() + 28, 74, 200, 15, A) {
         @Override
         protected xm d() {
            return !gco.this.P.a().isEmpty() && gco.this.O.b() ? super.d().f(", ").b(gco.B) : super.d();
         }
      };
      this.P.f(16);
      this.P.g(true);
      ...
      this.c(this.P);
      this.d(this.O);
      this.V = this.c(fsc.a(E, fwr.b(this, ayh.o)).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.a(this.R);
      this.M.b(fsc.a(wx.d, $$0x -> this.aK_()).a(200).a());
      this.M.a($$1x -> {
   ...
   public void b(fro $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      int $$4 = this.F() + 3;
      $$0.a(gqc::H, d, $$4, 64, 236, this.m() + 16);
      $$0.a(gqc::H, s, $$4 + 10, 76, 12, 12);
   }
