...
public enum fan implements baj {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final baj.a<fan> t = baj.a(fan::values);
   public static final IntFunction<fan> u = aye.a(fan::a, values(), aye.a.a);
   private final int v;
   private final String w;

   private fan(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
