...
public class fan extends fao {
   ...
   private fan(boolean $$0, @Nullable String $$1, URI $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   @Nullable
   public static fan a(String $$0) {
      try {
         JsonParser $$1 = new JsonParser();
         JsonObject $$2 = $$1.parse($$0).getAsJsonObject();
         String $$3 = fcl.b("uploadEndpoint", $$2, null);
         if ($$3 != null) {
            int $$4 = fcl.a("port", $$2, -1);
            URI $$5 = a($$3, $$4);
            if ($$5 != null) {
               boolean $$6 = fcl.a("worldClosed", $$2, false);
               String $$7 = fcl.b("token", $$2, null);
               return new fan($$6, $$7, $$5);
            }
         }
