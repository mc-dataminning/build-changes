...
public class fan {
   ...
   public void a(fbx $$0, String $$1, fct.a $$2, epy $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fan.b $$13 = new fan.b($$1.trim(), this.f, $$3, $$2);
                  fan.a $$14 = new fan.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fan.c $$30 = new fan.c(this.f, $$2, $$0);
                        fan.a $$31 = new fan.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fcb(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, epy $$2) throws IOException {
      ...
      File $$15 = new File(ffh.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final epy $$2, final fct.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fan.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fan.this.b && !fan.this.d) {
            try {
               fan.this.e = true;
               fan.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fan.a.error("Error extracting archive", var3);
               fan.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      c(final File $$0, final fct.a $$1, final fbx $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fan.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fan.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fan.this.g);
                  fan.this.c = true;
               } else {
                  fan.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fan.this.d = true;
               }
            } catch (IOException var3) {
               fan.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fan.this.d = true;
            }
         }
      }
