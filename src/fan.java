...
public class fan {
   public static List<fbp> a(fan.a... $$0) {
      for (fan.a $$1 : $$0) {
         a($$1.j);
      }

      List<fbp> $$2 = Lists.newArrayList();

      for (fan.a $$3 : $$0) {
         $$2.add(new fbp($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fbp::a));
      return $$2;
   }
   ...
   public static List<fbp> a() {
      return a(fan.a.values());
   }
