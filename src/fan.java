...
public class fan extends ezi<cfs> {
   private static final aex x = new aex("container/villager/out_of_stock");
   private static final aex y = new aex("container/villager/experience_bar_background");
   private static final aex z = new aex("container/villager/experience_bar_current");
   private static final aex A = new aex("container/villager/experience_bar_result");
   private static final aex B = new aex("container/villager/scroller");
   private static final aex C = new aex("container/villager/scroller_disabled");
   private static final aex D = new aex("container/villager/trade_arrow_out_of_stock");
   private static final aex E = new aex("container/villager/trade_arrow");
   private static final aex F = new aex("container/villager/discount_strikethrough");
   private static final aex G = new aex("textures/gui/container/villager.png");
   ...
   private void a(esf $$0, int $$1, int $$2, cot $$3) {
      ...
      if ($$4 < 5) {
         ...
         if ($$5 >= $$6 && cbi.d($$4)) {
            ...
            int $$9 = Math.min(arx.d($$8 * (float)($$5 - $$6)), 102);
            $$0.a(z, 102, 5, 0, 0, $$1 + 136, $$2 + 16, 0, $$9, 5);
            int $$10 = this.p.m();
            if ($$10 > 0) {
               int $$11 = Math.min(arx.d((float)$$10 * $$8), 102 - $$9);
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      ...
      if (this.a($$4)) {
         int $$5 = $$4 - 7;
         this.ad = arx.a((int)((double)this.ad - $$3), 0, $$5);
      }
