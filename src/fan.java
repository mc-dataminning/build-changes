public class fan implements fap {
   ...
   @Override
   public void a(eru $$0, int $$1, int $$2, erw $$3) {
      int $$4 = this.d();
      int $$5 = this.e();
   ...
   private void a(int $$0, int $$1, int $$2, boolean $$3, erw $$4, eru $$5) {
      if ($$2 >= this.f.size()) {
         this.a($$4, $$0, $$1, $$3 ? fan.a.a : fan.a.b);
      } else {
         ciy $$6 = this.f.get($$2);
         this.a($$4, $$0, $$1, fan.a.b);
         $$4.a($$6, $$0 + 1, $$1 + 1, $$2);
         $$4.a($$5, $$6, $$0 + 1, $$1 + 1);
         if ($$2 == 0) {
            eyx.a($$4, $$0 + 1, $$1 + 1, 0);
   ...
   private void a(erw $$0, int $$1, int $$2, fan.a $$3) {
