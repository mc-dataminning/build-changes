...
public class bnp implements bnq {
   ...
   private static final bnp k = new bnp();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bno $$0) {
      URL $$1 = bnp.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bno $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bns a = new bns(() -> bnp.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bnp.this.l && $$0.getState() == RecordingState.STOPPED) {
