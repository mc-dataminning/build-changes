...
public class bnp {
   ...
   protected bnp(String $$0, bno $$1, DoubleSupplier $$2, @Nullable Runnable $$3, @Nullable bnp.c $$4) {
      this.b = $$0;
      this.c = $$1;
      this.h = $$3;
      this.d = $$2;
   ...
   public static bnp a(String $$0, bno $$1, DoubleSupplier $$2) {
      return new bnp($$0, $$1, $$2, null, null);
   }

   public static <T> bnp a(String $$0, bno $$1, T $$2, ToDoubleFunction<T> $$3) {
      return a($$0, $$1, $$3, $$2).a();
   }

   public static <T> bnp.a<T> a(String $$0, bno $$1, ToDoubleFunction<T> $$2, T $$3) {
      return new bnp.a<>($$0, $$1, $$2, $$3);
   }
   ...
   public static class a<T> {
      ...
      public a(String $$0, bno $$1, ToDoubleFunction<T> $$2, T $$3) {
         this.a = $$0;
         this.b = $$1;
      ...
      public bnp.a<T> a(Consumer<T> $$0) {
         this.e = () -> $$0.accept(this.d);
         return this;
      }

      public bnp.a<T> a(bnp.c $$0) {
         this.f = $$0;
         return this;
      }

      public bnp a() {
         return new bnp(this.a, this.b, this.c, this.e, this.f);
      }
   }
   ...
   public static class d implements bnp.c {
