...
public abstract class gjy<T extends btp, M extends fua<T>> extends giw<T> implements gkt<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gnj<T, M>> g = Lists.newArrayList();

   public gjy(gix.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gnj<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   @Nullable
   protected gdw a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      alf $$4 = this.a($$0);
      if ($$2) {
         return gdw.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? gdw.r($$4) : null;
      }
   }

   public static int c(btp $$0, float $$1) {
      return goq.a(goq.a($$1), goq.a($$0.aO > 0 || $$0.aQ > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return fff.M() && $$0 != $$3.an() && $$5 && !$$0.bS();
      }
   }

   public static boolean e(btp $$0) {
      if ($$0 instanceof cmx || $$0.ag()) {
