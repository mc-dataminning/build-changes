...
public class sb extends MinecraftServer {
   ...
   private final bix o = new bix(4);
   private List<rq> p = new ArrayList<>();
   private final List<sq> q;
   private final ib r;
   private final Stopwatch s = Stopwatch.createUnstarted();
   private static final cwx t = ac.a(new cwx(), $$0 -> {
      $$0.a(cwx.e).a(false, null);
      $$0.a(cwx.v).a(false, null);
   });
   private static final dtm u = new dtm(0L, false, false);
   @Nullable
   private sh v;

   public static sb a(Thread $$0, ekm.c $$1, arz $$2, Collection<sq> $$3, ib $$4) {
      if ($$3.isEmpty()) {
         throw new IllegalArgumentException("No test functions were given!");
      } else {
         $$2.a();
         cxv $$5 = new cxv(new cwp(new ArrayList<>($$2.b()), List.of()), clj.e.a());
         cxf $$6 = new cxf("Test Level", cwy.b, false, bna.c, true, t, $$5);
         ...
         try {
            ...
            akd $$10 = ac.<akd>c($$2x -> akc.a($$8, $$1xx -> {
                  iy<dqp> $$2xx = new it<>(kj.aO, Lifecycle.stable()).l();
                  dtj.b $$3x = $$1xx.c().d(kj.aL).g(ecu.b).a().a().a($$2xx);
                  return new akc.b<>(new ekq($$6, u, $$3x.d(), $$3x.a()), $$3x.b());
               }, akd::new, ac.f(), $$2x)).get();
            $$9.stop();
   ...
   private sb(Thread $$0, ekm.c $$1, arz $$2, akd $$3, Collection<sq> $$4, ib $$5) {
