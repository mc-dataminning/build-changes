...
public class acb {
   ...
   private final bfj d;
   private final Int2ObjectMap<acb.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   private <T> acb.a<T> c(aby<T> $$0) {
      this.f.readLock().lock();

      acb.a<T> $$1;
      try {
         $$1 = (acb.a<T>)this.e.get($$0.a());
   ...
   private <T> void a(acb.a<T> $$0, acb.b<?> $$1) {
   ...
   public static record b<T>(int a, abz<T> b, T c) {

      public static <T> acb.b<T> a(aby<T> $$0, T $$1) {
         abz<T> $$2 = $$0.b();
         return new acb.b<>($$0.a(), $$2, $$2.a($$1));
      }
      ...
      public static acb.b<?> a(sf $$0, int $$1) {
         int $$2 = $$0.m();
         abz<?> $$3 = aca.a($$2);
         if ($$3 == null) {
      ...
      private static <T> acb.b<T> a(sf $$0, int $$1, abz<T> $$2) {
         return new acb.b<>($$1, $$2, $$2.a($$0));
      }
   }
}
