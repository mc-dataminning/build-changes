...
public interface cor extends cpn {
   @Nullable
   dcl c_(gu var1);
   ...
   default egz a(cot $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dez $$2 = this.a_($$1);
         ehd $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new egz($$0x.a(), ha.a($$3.c, $$3.d, $$3.e), gu.a($$0x.a()), false) : null;
      }, $$0x -> {
         ehd $$1 = $$0x.b().d($$0x.a());
         return egz.a($$0x.a(), ha.a($$1.c, $$1.d, $$1.e), gu.a($$0x.a()));
      });
   }
   ...
   @Nullable
   default egz a(ehd $$0, ehd $$1, gu $$2, ehw $$3, dez $$4) {
      egz $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         egz $$6 = $$4.m(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(ehw $$0, Supplier<ehw> $$1) {
      if (!$$0.c()) {
         return $$0.c(ha.a.b);
      } else {
   ...
   static <T, C> T a(ehd $$0, ehd $$1, C $$2, BiFunction<C, gu, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
