...
public class cor implements dfv {
   ...
   private boolean a(ard $$0) {
      ...
      if ($$1 == null) {
         ...
         int $$3 = 48;
         cgm $$4 = $$0.A();
         Optional<ji> $$5 = $$4.d($$0x -> $$0x.a(cgq.o), $$0x -> true, $$2, 48, cgm.b.c);
         ji $$6 = $$5.orElse($$2);
         ji $$7 = this.a($$0, $$6, 48);
   ...
   private void a(ard $$0, coq $$1, int $$2) {
      ji $$3 = this.a($$0, $$1.dv(), $$2);
      if ($$3 != null) {
         cjl $$4 = but.bx.a($$0, $$3, bus.h);
         if ($$4 != null) {
            $$4.b($$1, true);
         }
      }
   ...
   private ji a(dgm $$0, ji $$1, int $$2) {
      ...
      for (int $$5 = 0; $$5 < 10; $$5++) {
         ...
         int $$8 = $$0.a(ect.a.b, $$6, $$7);
         ji $$9 = new ji($$6, $$8, $$7);
         if ($$4.isSpawnPositionOk($$0, $$9, but.bE)) {
            $$3 = $$9;
            break;
         }
      }
