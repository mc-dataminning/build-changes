...
public class cor extends coo {
   ...
   public cor(btv<? extends cor> $$0, deg $$1) {
      super($$0, $$1);
      this.ae = true;
   }

   public cor(deg $$0, buk $$1, bto $$2, jj.a $$3) {
      this(btv.aL, $$0);
      this.c($$1);
      eys $$4 = $$1.cO().f();
   ...
   public void l() {
      ...
      if (!this.dS().B) {
         if (this.c == null && this.i != null) {
            this.c = ((arh)this.dS()).a(this.i);
            if (this.c == null) {
               this.i = null;
            }
         }

         if (this.c == null || !this.c.bI() || this.c instanceof cnu && this.c.P_()) {
            this.be();
         } else {
            this.f = azd.a(this.f * 1.025, -1.0, 1.0);
            this.g = azd.a(this.g * 1.025, -1.0, 1.0);
            this.h = azd.a(this.h * 1.025, -1.0, 1.0);
            eys $$0 = this.dv();
   ...
   protected void a(eyp $$0) {
      ...
      bto $$1 = $$0.a();
      bto $$2 = this.s();
      buk $$3 = $$2 instanceof buk ? (buk)$$2 : null;
      bsg $$4 = this.dT().a(this, $$3);
      ...
      if ($$5) {
         ...
         if ($$1 instanceof buk $$7) {
            $$7.b(new bsv(bsx.y, 200), (bto)MoreObjects.firstNonNull($$2, this));
         }
      }
   }
   ...
   protected void a(eyo $$0) {
      super.a($$0);
      ((arh)this.dS()).a(ln.w, this.dx(), this.dz(), this.dD(), 2, 0.2, 0.2, 0.2, 0.0);
      this.a(awe.wP, 1.0F, 1.0F);
   }

   private void o() {
      this.as();
      this.dS().a(dzl.o, this.dq(), dzl.a.a(this));
   }
   ...
   public boolean a(bsg $$0, float $$1) {
      if (!this.dS().B) {
         this.a(awe.wQ, 1.0F, 1.0F);
         ((arh)this.dS()).a(ln.f, this.dx(), this.dz(), this.dD(), 15, 0.2, 0.2, 0.2, 0.0);
         this.o();
      }
