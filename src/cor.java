...
public class cor<T> {
   ...
   public boolean a(List<cor.a<T>> $$0, int $$1, @Nullable cor.b<T> $$2) {
      return new cor.c($$0).a($$1, $$2);
   }

   public int b(List<cor.a<T>> $$0, int $$1, @Nullable cor.b<T> $$2) {
      return new cor.c($$0).b($$1, $$2);
   }
   ...
   class c {
      ...
      public boolean a(int $$0, @Nullable cor.b<T> $$1) {
         if ($$0 <= 0) {
            return true;
         } else {
            int $$2 = 0;
      ...
      private List<T> b() {
         ...
         for (cor.a<T> $$1 : this.c) {
            $$0.addAll($$1.a());
         }

         $$0.removeIf($$0x -> !cor.this.a((T)$$0x));
      ...
      public int b(int $$0, @Nullable cor.b<T> $$1) {
         int $$2 = 0;
      ...
      private int o() {
         ...
         for (cor.a<T> $$1 : this.c) {
            ...
            for (T $$3 : $$1.a()) {
               $$2 = Math.max($$2, cor.this.a.getInt($$3));
            }
