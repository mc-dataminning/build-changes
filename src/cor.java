...
public abstract class cor extends cpe {
   private static final evp c = new evp(0.0, 0.0, 0.0);
   private static final akj<Integer> d = akn.a(cor.class, akl.b);
   private static final akj<Integer> e = akn.a(cor.class, akl.b);
   private static final akj<Boolean> i = akn.a(cor.class, akl.k);
   private static final ImmutableMap<btz, ImmutableList<Integer>> j = ImmutableMap.of(
      btz.a, ImmutableList.of(0, 1, -1), btz.f, ImmutableList.of(0, 1, -1), btz.d, ImmutableList.of(0, 1)
   );
   ...
   private double r;
   private evp s = evp.b;
   private static final Map<dte, Pair<kd, kd>> t = ac.a(Maps.newEnumMap(dte.class), $$0 -> {
      kd $$1 = je.e.q();
      kd $$2 = je.f.q();
      kd $$3 = je.c.q();
      kd $$4 = je.d.q();
      ...
      kd $$7 = $$3.o();
      kd $$8 = $$4.o();
      $$0.put(dte.a, Pair.of($$3, $$4));
      $$0.put(dte.b, Pair.of($$1, $$2));
      $$0.put(dte.c, Pair.of($$5, $$2));
      $$0.put(dte.d, Pair.of($$1, $$6));
      $$0.put(dte.e, Pair.of($$3, $$8));
      $$0.put(dte.f, Pair.of($$7, $$4));
      $$0.put(dte.g, Pair.of($$4, $$2));
      $$0.put(dte.h, Pair.of($$4, $$1));
      $$0.put(dte.i, Pair.of($$3, $$1));
      $$0.put(dte.j, Pair.of($$3, $$2));
   });

   protected cor(bsy<?> $$0, dbw $$1) {
      super($$0, $$1);
      this.J = true;
   }

   protected cor(bsy<?> $$0, dbw $$1, double $$2, double $$3, double $$4) {
      this($$0, $$1);
      this.a_($$2, $$3, $$4);
      this.L = $$2;
      this.M = $$3;
   ...
   public static cor a(are $$0, double $$1, double $$2, double $$3, cor.a $$4, cun $$5, @Nullable cmv $$6) {
      cor $$7 = (cor)(switch ($$4) {
   ...
   public evp b(btn $$0) {
      ...
      if ($$1.o() == je.a.b) {
         ...
         while ($$14.hasNext()) {
            ...
            while ($$16.hasNext()) {
               ...
               for (int[] $$10 : $$2) {
                  ...
                  double $$11 = this.dP().a(cow.a(this.dP(), $$4), () -> cow.a(this.dP(), $$4.d()));
                  if (cow.a($$11)) {
                     evk $$12 = new evk((double)(-$$8), 0.0, (double)(-$$8), (double)$$8, (double)$$7.b(), (double)$$8);
                     evp $$13 = evp.a($$4, $$11);
                     if (cow.a(this.dP(), $$0, $$12.c($$13))) {
                        $$0.b($$6);
                        return $$13;
                     }
                  }
         ...
         while (var22.hasNext()) {
            btz $$15 = (btz)var22.next();
            double $$16 = (double)$$0.a($$15).b();
            int $$17 = ayx.c($$14x - (double)$$4.v() + $$16);
            double $$18 = cow.a($$4, $$17, $$0x -> this.dP().a_($$0x).k(this.dP(), $$0x));
            if ($$14x + $$16 <= $$18) {
               $$0.b($$15);
               break;
            }
   ...
   private static Pair<kd, kd> a(dte $$0) {
      return t.get($$0);
   }
   ...
   public void l() {
      ...
      if (this.dP().B) {
         ...
         if ($$5 * $$5 + $$6 * $$6 > 0.001) {
            this.r((float)(ayx.d($$6, $$5) * 180.0 / Math.PI));
            if (this.k) {
               this.r(this.dF() + 180.0F);
            }
         }

         double $$7 = (double)ayx.g(this.dF() - this.O);
         if ($$7 < -170.0 || $$7 >= 170.0) {
            this.r(this.dF() + 180.0F);
            this.k = !this.k;
         }
         ...
         this.a(this.dF(), this.dH());
         if (this.v() == cor.a.a && this.ds().i() > 0.01) {
            List<bss> $$8 = this.dP().a(this, this.cK().c(0.2F, 0.0, 0.2F), bsx.a(this));
            if (!$$8.isEmpty()) {
               for (bss $$9 : $$8) {
                  if (!($$9 instanceof cmv) && !($$9 instanceof cfp) && !($$9 instanceof cor) && !this.bS() && !$$9.bR()) {
                     $$9.n(this);
                  } else {
                     $$9.h(this);
                  }
            ...
            for (bss $$10 : this.dP().a_(this, this.cK().c(0.2F, 0.0, 0.2F))) {
               if (!this.x($$10) && $$10.bA() && $$10 instanceof cor) {
                  $$10.h(this);
               }
            }
         }
   ...
   protected void s() {
      double $$0 = this.p();
      evp $$1 = this.ds();
      this.o(ayx.a($$1.c, -$$0, $$0), $$1.d, ayx.a($$1.e, -$$0, $$0));
      if (this.aE()) {
   ...
   protected void c(iz $$0, dsa $$1) {
      ...
      $$9 = new evp($$18 * $$14 / $$16, $$9.d, $$18 * $$15 / $$16);
      this.h($$9);
      bss $$19 = this.cT();
      ...
      double $$34 = this.p();
      $$9 = this.ds();
      this.a(bts.a, new evp(ayx.a($$33 * $$9.c, -$$34, $$34), 0.0, ayx.a($$33 * $$9.e, -$$34, $$34)));
      if ($$12.v() != 0 && ayx.a(this.du()) - $$0.u() == $$12.u() && ayx.a(this.dA()) - $$0.w() == $$12.w()) {
         this.a_(this.du(), this.dw() + (double)$$12.v(), this.dA());
      } else if ($$13.v() != 0 && ayx.a(this.du()) - $$0.u() == $$13.u() && ayx.a(this.dA()) - $$0.w() == $$13.w()) {
         this.a_(this.du(), this.dw() + (double)$$13.v(), this.dA());
      }

      this.u();
      evp $$35 = this.q(this.du(), this.dw(), this.dA());
      if ($$35 != null && $$5 != null) {
      ...
      int $$39 = ayx.a(this.du());
      int $$40 = ayx.a(this.dA());
      if ($$39 != $$0.u() || $$40 != $$0.w()) {
         evp $$41 = this.ds();
         double $$42 = $$41.h();
   ...
   @Nullable
   public evp a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = ayx.a($$0);
      int $$5 = ayx.a($$1);
      int $$6 = ayx.a($$2);
      ...
      if (dem.g($$7)) {
         ...
         $$0 += $$12 * $$3;
         $$2 += $$13 * $$3;
         if ($$10.v() != 0 && ayx.a($$0) - $$4 == $$10.u() && ayx.a($$2) - $$6 == $$10.w()) {
            $$1 += (double)$$10.v();
         } else if ($$11.v() != 0 && ayx.a($$0) - $$4 == $$11.u() && ayx.a($$2) - $$6 == $$11.w()) {
            $$1 += (double)$$11.v();
         }
   ...
   @Nullable
   public evp q(double $$0, double $$1, double $$2) {
      int $$3 = ayx.a($$0);
      int $$4 = ayx.a($$1);
      int $$5 = ayx.a($$2);
            ...
            if (!this.x($$0)) {
               ...
               if ($$3 >= 1.0E-4F) {
                  ...
                  if ($$0 instanceof cor) {
                     ...
                     evp $$7 = new evp($$5, 0.0, $$6).d();
                     evp $$8 = new evp((double)ayx.b(this.dF() * (float) (Math.PI / 180.0)), 0.0, (double)ayx.a(this.dF() * (float) (Math.PI / 180.0))).d();
   ...
   public dsa w() {
      return !this.A() ? this.x() : dex.a(this.ap().a(d));
   }
