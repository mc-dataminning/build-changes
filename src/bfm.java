...
public class bfm implements bfn {
   ...
   private static final bfm j = new bfm();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bfl $$0) {
      URL $$1 = bfm.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bfl $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bfp a = new bfp(() -> bfm.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bfm.this.k && $$0.getState() == RecordingState.STOPPED) {
