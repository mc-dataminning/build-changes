...
public class bsd {
   ...
   private final List<bsb> d = Lists.newArrayList();
   private final buk e;
   private int f;
   private int g;
   private int h;
   ...
   public void a(bsg $$0, float $$1) {
      this.c();
      bsl $$2 = bsl.a(this.e);
      bsb $$3 = new bsb($$0, $$1, $$2, this.e.aa);
      this.d.add($$3);
      this.f = this.e.ag;
      this.j = true;
   ...
   private static boolean a(bsg $$0) {
      return $$0.d() instanceof buk;
   }

   private xd a(bto $$0, xd $$1, String $$2, String $$3) {
      cvp $$5 = $$0 instanceof buk $$4 ? $$4.eW() : cvp.k;
      return !$$5.f() && $$5.b(kr.g) ? xd.a($$2, this.e.Q_(), $$1, $$5.H()) : xd.a($$3, this.e.Q_(), $$1);
   }

   private xd a(bsb $$0, @Nullable bto $$1) {
      bsg $$2 = $$0.a();
      if (!$$2.a(awv.m) && !$$2.a(awv.s)) {
         xd $$4 = a($$1);
         bto $$5 = $$2.d();
         xd $$6 = a($$5);
         ...
         bsl $$3 = Objects.requireNonNullElse($$0.c(), bsl.a);
         return xd.a($$3.a(), this.e.Q_());
      }
   }

   @Nullable
   private static xd a(@Nullable bto $$0) {
   ...
   public xd a() {
      if (this.d.isEmpty()) {
         ...
         bsb $$0 = this.d.get(this.d.size() - 1);
         bsg $$1 = $$0.a();
         bsb $$2 = this.d();
         bsk $$3 = $$1.k().e();
         if ($$3 == bsk.b && $$2 != null) {
   ...
   private bsb d() {
      ...
      for (int $$4 = 0; $$4 < this.d.size(); $$4++) {
         bsb $$5 = this.d.get($$4);
         bsb $$6 = $$4 > 0 ? this.d.get($$4 - 1) : null;
         bsg $$7 = $$5.a();
         boolean $$8 = $$7.a(awv.s);
         float $$9 = $$8 ? Float.MAX_VALUE : $$5.d();
         if (($$7.a(awv.m) || $$8) && $$9 > 0.0F && ($$0 == null || $$9 > $$3)) {
            if ($$4 > 0) {
               $$0 = $$6;
            } else {
               $$0 = $$5;
