...
public class ane {
   ...
   private static int a(ew $$0, arq $$1) {
      GameProfile $$2 = $$1.gf();
      $$1.f.n();
      $$0.a(() -> xj.b("Switched player " + $$2.getName() + "(" + $$2.getId() + ") to config mode"), false);
      return 1;
   }
   ...
   private static int a(ew $$0, UUID $$1) {
      ...
      $$0.b(xj.b("Can't find player to unconfig"));
      return 0;
   }
}
