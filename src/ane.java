...
public class ane {
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("enchant").requires($$0x -> $$0x.c(2)))
            .then(
               eu.a("targets", fg.b())
                  .then(
                     ((RequiredArgumentBuilder)eu.a("enchantment", fs.a($$1, lv.aM))
   ...
   private static int a(et $$0, Collection<? extends bto> $$1, jn<dbk> $$2, int $$3) throws CommandSyntaxException {
      dbk $$4 = $$2.a();
      if ($$3 > $$4.e()) {
         ...
         if ($$5 == 0) {
            ...
            if ($$1.size() == 1) {
               $$0.a(() -> xd.a("commands.enchant.success.single", dbk.a($$2, $$3), $$1.iterator().next().Q_()), true);
            } else {
               $$0.a(() -> xd.a("commands.enchant.success.multiple", dbk.a($$2, $$3), $$1.size()), true);
            }
