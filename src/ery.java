...
public class ery implements eck.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ery> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ays<ery> a = ays.a(f);
   private final esc g;
   private final esc h;
   private final esc i;
   ...
   public static ery a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ery(new eds(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ery(esc $$0, esc $$1, esc $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ery(azh $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         esc.a($$0, IntStream.rangeClosed(-15, 0)),
         esc.a($$0, IntStream.rangeClosed(-15, 0)),
         esc.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ery a(azh $$0) {
      return new ery($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(eck.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         erz $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(esc.b($$4 * $$13), esc.b($$5 * $$13), esc.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = esc.b($$1 * $$13);
         double $$21 = esc.b($$2 * $$13);
         double $$22 = esc.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            erz $$24 = this.g.a($$19);
            if ($$24 != null) {
