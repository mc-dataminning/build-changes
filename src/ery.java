...
public class ery {
   ...
   public static final ery.a bv;

   public static ery.a a(int $$0, int $$1) {
      return $$0 == -1 ? ery.b.b.a($$1) : ery.b.a.a($$0);
   }

   public static ery.a a(String $$0) {
      if (ery.a.e.containsKey($$0)) {
         return ery.a.e.get($$0);
      } else {
         for (ery.b $$1 : ery.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ery.b b;
      private final int c;
      private final awh<vs> d;
      static final Map<String, ery.a> e = Maps.newHashMap();

      a(String $$0, ery.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new awh<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? vs.b($$2.toUpperCase(Locale.ROOT)) : vs.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? vs.b($$2) : vs.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> st.a().b($$1) ? vs.c($$1) : vs.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ery.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vs> g;

      private static void a(ery.b $$0, String $$1, int $$2) {
         ery.a $$3 = new ery.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, vs> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ery.a a(int $$0) {
         return (ery.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
