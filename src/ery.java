...
public class ery {
   ...
   public void a(ery.b $$0, List<anh> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new ery.c($$0, $$1.stream().map(anh::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new ery.c(ery.b.c, ImmutableList.of());
      }

      this.b.c = new ery.a($$0);
   }
   ...
   static class c {
      private final ery.b a;
      private final List<String> b;
      @Nullable
      ery.a c;
      boolean d;

      c(ery.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
