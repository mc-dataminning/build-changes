...
public class fks {
   ...
   private void a() {
      for (Entry<ha, fkt> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<fks> {
      ...
      private Map<ha, fkt> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ha, fkt> $$2 = Maps.newEnumMap(ha.class);
         JsonObject $$3 = aor.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ha $$5 = this.a($$4.getKey());
            $$2.put($$5, (fkt)$$0.deserialize($$4.getValue(), fkt.class));
         }
