...
public class fks extends fju {
   ...
   public fks(fjl $$0, int $$1, int $$2, int $$3, int $$4, xd $$5, xd $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new fkv($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fnx $$0) {
      $$0.a(fnw.a, xd.a("gui.narrate.editBox", this.z(), this.j()));
   }
   ...
   protected void c(fjn $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$4.isEmpty() && !this.aO_()) {
         $$0.a(this.m, (xi)this.n, this.D() + this.a(), this.E() + this.a(), this.g - this.b(), -857677600);
      } else {
         int $$5 = this.o.d();
   ...
   protected void a(fjn $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         xd $$2 = xd.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void k() {
      double $$0 = this.c();
      fkv.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         fkv.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
