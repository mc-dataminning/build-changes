...
public class fks {
   ...
   private static final Map<eak.a, String> e = ad.a(new EnumMap<>(eak.a.class), $$0 -> {
      $$0.put(eak.a.a, "SW");
      $$0.put(eak.a.b, "S");
      $$0.put(eak.a.c, "OW");
      $$0.put(eak.a.d, "O");
   ...
   private dwu l;
   @Nullable
   private CompletableFuture<dwu> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bmo r = new bmo(1);
   private final bmo s = new bmo(bmt.values().length);
   private final bmo t = new bmo(1);
   private final bmo u = new bmo(1);
   private final Map<bmp, bmo> v = Map.of(bmp.a, this.s);
   private final fmb w;
   private final fme x;
   private final fmc y;
   private final fma z;
   ...
   public fks(fil $$0) {
      ...
      this.g = new fks.a();
      this.h = $$0.h;
      this.w = new fmb(this.h, this.r);
      this.x = new fme(this.h, this.s, () -> $$0.s.s().g());
      this.y = new fmc(this.h, this.t);
      this.z = new fma(this.h, this.u);
      this.A = new fmd(this.h);
   }
   ...
   private void a(fjx $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         deg $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof arh ? ((arh)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add("");
         $$25.add(String.format(Locale.ROOT, "XYZ: %.3f / %.5f / %.3f", this.f.ao().dx(), this.f.ao().dz(), this.f.ao().dD()));
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, azd.g($$15.dI()), azd.g($$15.dK())));
         dwu $$27 = this.u();
         if ($$27.B()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.s.h().p().a($$14, 0);
            int $$29 = this.f.s.a(dep.a, $$14);
            int $$30 = this.f.s.a(dep.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dwu $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (eak.a $$33 : eak.a.values()) {
               if ($$33.b()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ar();
                  long $$36 = $$31.t();
                  brn $$37 = new brn($$23.am(), $$23.ab(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            der.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bun> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bun.values())
   ...
   private static String a(jn<dfh> $$0) {
   ...
   private deg s() {
      return (deg)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.ag()))), this.f.s);
   }
   ...
   private dwu t() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dxl.n, false).thenApply($$0x -> (dwu)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", fbx.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fil.Q().aP().l(), fil.Q().aP().m(), fbx.a()),
            fbx.c(),
            fbx.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == eyq.a.b) {
            ...
            for (Entry<dvr<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == eyq.a.b) {
            ...
            for (Entry<dvr<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dvr<?>, Comparable<?>> $$0) {
      dvr<?> $$1 = $$0.getKey();
