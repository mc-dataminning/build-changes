...
public class fks implements eyp {
   static final Logger b = LogUtils.getLogger();
   private final ezn c;
   private final fkg<fks.b> d;

   fks(ezn $$0, fkg<fks.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(akk c, int d, int e, int[][] f) implements fku {
      ...
      public static final MapCodec<fks.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     akk.a.fieldOf("file").forGetter(fks.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fks.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fks.a::e),
                     g.fieldOf("chars").forGetter(fks.a::f)
                  )
                  .apply($$0, fks.a::new)
         )
         .validate(fks.a::a);
      ...
      private static DataResult<fks.a> a(fks.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fks.b $$15 = $$9.a($$12, new fks.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fks.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(ezn $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, ezn b, int c, int d, int e, int f, int g, int h) implements eyo {
