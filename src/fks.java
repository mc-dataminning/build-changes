...
public class fks implements fcj, fdc {
   ...
   private final List<fks.a> n = Lists.newArrayList();
   private boolean o;
   private int p;
   private int q;
   private ezg r;
   ...
   public void a(ezg $$0, fkx $$1, int $$2, int $$3, int $$4, int $$5, float $$6) {
      this.r = $$0;
      this.t = $$1;
      if ($$0.s.bZ instanceof clp) {
         this.w = true;
      }

      boolean $$7 = $$0.s.m().a((cnb<?>)$$0.s.bZ);
      List<ctp<?>> $$8 = $$1.b(true);
      List<ctp<?>> $$9 = $$7 ? Collections.emptyList() : $$1.b(false);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         boolean $$21 = $$20 < $$10;
         ctp<?> $$22 = $$21 ? $$8.get($$20) : $$9.get($$20 - $$10);
         int $$23 = this.p + 4 + 25 * ($$20 % $$12);
         int $$24 = this.q + 5 + 25 * ($$20 / $$12);
         if (this.w) {
            this.n.add(new fks.b($$23, $$24, $$22, $$21));
         } else {
            this.n.add(new fks.a($$23, $$24, $$22, $$21));
         }
      }
   ...
   class a extends fbe implements aiu<ctk> {
      final ctp<?> c;
      private final boolean d;
      protected final List<fks.a.a> a = Lists.newArrayList();

      public a(int $$0, int $$1, ctp<?> $$2, boolean $$3) {
      ...
      public void a(Iterator<ctk> $$0, int $$1, int $$2, int $$3, int $$4) {
         cqk[] $$5 = $$0.next().a();
         if ($$5.length != 0) {
            this.a.add(new fks.a.a(3 + $$4 * 7, 3 + $$3 * 7, $$5));
         }
      }
      ...
      public void b(fat $$0, int $$1, int $$2, float $$3) {
         ...
         if (this.d) {
            if (fks.this.w) {
               $$4 = this.z() ? fks.c : fks.d;
            } else {
               $$4 = this.z() ? fks.e : fks.f;
            }
         } else if (fks.this.w) {
            $$4 = this.z() ? fks.g : fks.h;
         } else {
            $$4 = this.z() ? fks.i : fks.j;
         }
         ...
         for (fks.a.a $$8 : this.a) {
            $$0.c().a();
            $$0.c().a((double)$$8.b, (double)$$8.c, 0.0);
            $$0.c().b(0.375F, 0.375F, 1.0F);
            $$0.c().a(-8.0, -8.0, 0.0);
            if ($$8.a.length > 0) {
               $$0.a($$8.a[aww.d(fks.this.v / 30.0F) % $$8.a.length], 0, 0);
            }
   ...
   class b extends fks.a {
      public b(int $$0, int $$1, ctp<?> $$2, boolean $$3) {
         super($$0, $$1, $$2, $$3);
      }
      ...
      protected void a(ctp<?> $$0) {
         ctk $$1 = $$0.b().a().get(0);
         cqk[] $$2 = $$1.a();
         this.a.add(new fks.a.a(10, 10, $$2));
      }
   }
}
