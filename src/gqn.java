...
public class gqn implements gpz.a {
   private final flj a;
   ...
   private void a(ffu $$0, gly $$1, double $$2, double $$3, double $$4, bul $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.ax.ifPresent($$10 -> {
   ...
   private void a(ji $$0, ffu $$1, double $$2, double $$3, double $$4, gly $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      gms.a($$1, $$5.getBuffer(gmi.y()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      gpz.a(
         $$1,
         $$5.getBuffer(gmi.y()),
