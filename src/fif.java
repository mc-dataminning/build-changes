...
public class fif {
   ...
   private static final Comparator<fyg> p = Comparator.<fyg>comparingInt($$0 -> $$0.e() == dbv.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), ewq::b, ""))
   ...
   private xp t;
   private boolean u;
   private final Map<UUID, fif.a> v = new Object2ObjectOpenHashMap();

   public fif(fff $$0, fgq $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public xp a(fyg $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, ewq.a($$0.h(), xp.b($$0.a().getName())));
   }

   private xp a(fyg $$0, yd $$1) {
      return $$0.e() == dbv.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(fgr $$0, int $$1, ewv $$2, @Nullable ewn $$3) {
      List<fyg> $$4 = this.b();
      List<fif.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            if ($$21) {
               ...
               boolean $$45 = $$44 != null && gjy.e($$44);
               boolean $$46 = $$44 != null && $$44.a(cmy.g);
               fid.a($$0, $$41.g().a(), $$39, $$40, 8, $$46, $$45);
               $$39 += 9;
            }

            $$0.b(this.q.h, $$42.a, $$39, $$40, $$41.e() == dbv.d ? -1862270977 : -1);
            if ($$3 != null && $$41.e() != dbv.d) {
               int $$47 = $$39 + $$7 + 1;
               int $$48 = $$47 + $$22;
               if ($$48 - $$47 > 5) {
   ...
   protected void a(fgr $$0, int $$1, int $$2, int $$3, fyg $$4) {
      alf $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
   ...
   private void a(ewn $$0, int $$1, fif.b $$2, int $$3, int $$4, UUID $$5, fgr $$6) {
      if ($$0.h() == ewy.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, fgr $$4, int $$5) {
      fif.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new fif.a($$5));
      $$6.a($$5, (long)this.r.e());
