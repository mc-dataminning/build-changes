...
public class fif {
   ...
   private static final fih e = new fif.a();
   private static final fih f = new fif.b(-1, true);
   private static final fih g = new fif.b(1, true);
   private static final fih h = new fif.b(1, false);
   ...
   public static final fih a = new fih() {
      @Override
      public void a(fif $$0) {
      }
   ...
   public fih a(int $$0) {
      ...
      if (this.p > 0 && $$0 == 0) {
         ...
         return $$1 >= 0 && $$1 < this.n.a().size() ? (fih)MoreObjects.firstNonNull(this.n.a().get($$1), a) : a;
      }
   }

   public List<fih> a() {
      List<fih> $$0 = Lists.newArrayList();
