...
public class fif extends fiq {
      ...
      try {
         ...
         if (azu.d($$3, "lists")) {
            for (JsonElement $$5 : $$3.getAsJsonArray("lists")) {
               ...
               String $$7 = fkm.b("playerList", $$6, null);
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = flz.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fkm.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !flz.Q().b($$4)) {
               try {
