...
public class fif implements AutoCloseable {
   private static final int a = -1;
   private final ale b;
   private int c;

   private fif(int $$0, ale $$1) {
      this.b = $$1;
      this.c = $$0;
   }

   public static fif a(ale $$0, fif.a $$1, String $$2) throws gpu.b {
      ...
      if (GlStateManager.glGetShaderi($$3, 35713) == 0) {
         ...
         throw new gpu.b("Couldn't compile " + $$1.a() + " shader (" + $$0 + ") : " + $$4);
      } else {
         return new fif($$3, $$0);
      }
   }
   ...
   public static enum a {
      ...
      private static final fif.a[] c = values();
