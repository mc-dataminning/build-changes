...
public abstract class fif<E extends fif.a<E>> extends fic {
   ...
   private final List<E> p = new fif.b();
   ...
   public fif(fgm $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wy.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = ayo.a($$1 - (double)this.E()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
   ...
   protected void a(fhx $$0) {
      RenderSystem.enableBlend();
      akr $$1 = this.c.r == null ? fob.g : fob.i;
      akr $$2 = this.c.r == null ? fob.h : fob.j;
   ...
   public void a(double $$0) {
      this.q = ayo.a($$0, 0.0, (double)this.p());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.E()) {
            ...
            int $$6 = this.h;
            int $$7 = ayo.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fmo $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fmo $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fme.a u() {
      if (this.aO_()) {
         ...
         return this.v != null ? fme.a.b : fme.a.a;
      }
   }
   ...
   protected void a(fmg $$0, E $$1) {
      List<E> $$2 = this.aK_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fmf.b, wz.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fif.a<E>> implements fkg {
      @Deprecated
      fif<E> a;
      ...
      public abstract void a(fhx var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
