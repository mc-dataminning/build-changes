public abstract class fif<T extends clp> extends fie<T> implements fkz {
   public final fkp x;
   private boolean y;
   private final ajh z;
   private final ajh A;
   ...
   public fif(T $$0, fkp $$1, cir $$2, vu $$3, ajh $$4, ajh $$5, ajh $$6) {
      super($$0, $$2, $$3);
      this.x = $$1;
      this.z = $$4;
      this.A = $$5;
   ...
   public void aO_() {
      ...
      this.c(new fbs(this.t + 20, this.h / 2 - 49, 20, 18, fkt.a, $$0 -> {
         this.x.e();
         this.t = this.x.a(this.g, this.c);
