...
public class gle extends aut<Optional<gle.b>> implements AutoCloseable {
   ...
   private gle.a o = gle.a.b;
   @Nullable
   private fkt p;
   @Nullable
   private gle.b q;
   private final ffv r = new ffv(fdm.b);
   private boolean s;

   protected Optional<gle.b> a(auo $$0, bor $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gle.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gle.b> $$0, auo $$1, bor $$2) {
   ...
   public void a(int $$0, fkt $$1, float $$2, Matrix4f $$3, Matrix4f $$4, fay $$5, float $$6) {
      if (this.q != null) {
         ...
         $$12 -= (double)ayy.a($$12 / $$14) * $$14;
         $$13 -= (double)ayy.a($$13 / $$15) * $$15;
         int $$16 = ayy.a($$12 / 12.0);
         int $$17 = ayy.a($$13 / 12.0);
         float $$18 = (float)($$12 - (double)((float)$$16 * 12.0F));
         float $$19 = (float)($$13 - (double)((float)$$17 * 12.0F));
         gmf $$20 = $$1 == fkt.c ? gmf.w() : gmf.v();
         this.r.a();
         if (this.l || $$16 != this.m || $$17 != this.n || $$9 != this.o || $$1 != this.p) {
            ...
            this.o = $$9;
            this.p = $$1;
            ffr $$21 = this.a(ffu.b(), $$16, $$17, $$1, $$9, $$20);
            if ($$21 != null) {
               this.r.a($$21);
               this.s = false;
            } else {
         ...
         if (!this.s) {
            RenderSystem.setShaderColor(axj.j($$0), axj.k($$0), axj.l($$0), 1.0F);
            if ($$1 == fkt.c) {
               this.a(gmf.x(), $$3, $$4, $$18, $$7, $$19);
            }
   ...
   private void a(gmf $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      glf $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private ffr a(ffu $$0, int $$1, int $$2, fkt $$3, gle.a $$4, gmf $$5) {
      float $$6 = 0.8F;
      int $$7 = axj.a(0.8F, 1.0F, 1.0F, 1.0F);
      int $$8 = axj.a(0.8F, 0.9F, 0.9F, 0.9F);
      int $$9 = axj.a(0.8F, 0.7F, 0.7F, 0.7F);
      int $$10 = axj.a(0.8F, 0.8F, 0.8F, 0.8F);
      ffn $$11 = $$0.a($$5.T(), $$5.S());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == fkt.c);
      return $$11.a();
   }

   private void a(gle.a $$0, ffn $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
         ...
         for (int $$13 = -32; $$13 <= 32; $$13++) {
            for (int $$14 = -32; $$14 <= 32; $$14++) {
               ...
               if ($$17 != 0L) {
                  int $$18 = a($$17);
                  if ($$8) {
                     this.a($$0, $$1, axj.a($$4, $$18), axj.a($$5, $$18), axj.a($$6, $$18), axj.a($$7, $$18), $$14, $$13, $$17);
                  } else {
                     this.a($$1, axj.a($$5, $$18), $$14, $$13);
                  }
               }
            }
         }
   ...
   private void a(gle.a $$0, ffn $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
