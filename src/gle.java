...
public class gle {
   private static final glv a = glv.u(alz.b("textures/map/map_background.png"));
   private static final glv b = glv.u(alz.b("textures/map/map_background_checkerboard.png"));
   ...
   private final hau av = new hau();
   private cxp aw = cxp.j;
   private cxp ax = cxp.j;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gro aC;
   private final gso aD;

   public gle(fmg $$0, gro $$1, gso $$2) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
   }

   public void a(bwg $$0, cxp $$1, cxn $$2, boolean $$3, fgs $$4, gll $$5, int $$6) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dW(), $$6, hbc.d, $$0.ar() + $$2.ordinal());
      }
   }
   ...
   private void a(fgs $$0, gll $$1, int $$2, bwa $$3) {
      gwx $$4 = (gwx)this.aC.<gke>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == bwa.b ? 1.0F : -1.0F;
      ...
      alz $$6 = this.au.t.d().a();
      if ($$3 == bwa.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(cpy.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(cpy.c));
      }

      $$0.b();
   }

   private void a(fgs $$0, gll $$1, int $$2, float $$3, bwa $$4, float $$5, cxp $$6) {
      float $$7 = $$4 == bwa.b ? 1.0F : -1.0F;
   ...
   private void a(fgs $$0, gll $$1, int $$2, cxp $$3) {
      ...
      evp $$4 = $$3.a(ku.L);
      evr $$5 = cyc.a($$4, this.au.s);
      fgw $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(fgs $$0, gll $$1, int $$2, float $$3, float $$4, bwa $$5) {
      boolean $$6 = $$5 != bwa.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = bae.c($$4);
      ...
      gwx $$15 = (gwx)this.aC.<gke>a($$14);
      alz $$16 = $$14.d().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(cpy.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(cpy.c));
      }
   }

   private void a(fgs $$0, float $$1, bwa $$2, cxp $$3, cpx $$4) {
      float $$5 = (float)$$4.fC() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((bwg)$$4);
      if ($$6 < 0.8F) {
   ...
   private void a(fgs $$0, float $$1, bwa $$2, cxp $$3, cpx $$4, float $$5) {
      this.b($$0, $$2, $$5);
   ...
   private void a(fgs $$0, bwa $$1, float $$2) {
      int $$3 = $$1 == bwa.b ? 1 : -1;
   ...
   private void b(fgs $$0, bwa $$1, float $$2) {
      int $$3 = $$1 == bwa.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, fgs $$1, gll.a $$2, gkh $$3, int $$4) {
      float $$5 = $$3.D($$0);
      bti $$6 = (bti)MoreObjects.firstNonNull($$3.aJ, bti.a);
      float $$7 = $$3.j($$0);
      gle.a $$8 = a($$3);
      ...
      if ($$8.d) {
         float $$11 = $$6 == bti.a ? $$5 : 0.0F;
         float $$12 = 1.0F - bae.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, bti.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bti.b ? $$5 : 0.0F;
         float $$14 = 1.0F - bae.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, bti.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gle.a a(gkh $$0) {
      cxp $$1 = $$0.eZ();
      cxp $$2 = $$0.fa();
      boolean $$3 = $$1.a(cxt.oR) || $$2.a(cxt.oR);
      boolean $$4 = $$1.a(cxt.wL) || $$2.a(cxt.wL);
      if (!$$3 && !$$4) {
         return gle.a.a;
      } else if ($$0.fz()) {
         return b($$0);
      } else {
         return a($$1) ? gle.a.b : gle.a.a;
      }
   }

   private static gle.a b(gkh $$0) {
      cxp $$1 = $$0.fB();
      bti $$2 = $$0.fA();
      if (!$$1.a(cxt.oR) && !$$1.a(cxt.wL)) {
         return $$2 == bti.a && a($$0.fa()) ? gle.a.b : gle.a.a;
      } else {
         return gle.a.a($$2);
      }
   }
   ...
   private static boolean a(cxp $$0) {
      return $$0.a(cxt.wL) && cwg.g($$0);
   }

   private void a(gke $$0, float $$1, float $$2, bti $$3, float $$4, cxp $$5, float $$6, fgs $$7, gll $$8, int $$9) {
      if (!$$0.gH()) {
         boolean $$10 = $$3 == bti.a;
         bwa $$11 = $$10 ? $$0.fy() : $$0.fy().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.cp()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3) {
               ...
               float $$15 = (float)$$5.a((bwg)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cwg.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }
            ...
            this.a($$0, $$5, $$13 ? cxn.e : cxn.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bwa.b;
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.a((bwg)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.a((bwg)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$23 ? cxn.e : cxn.d, !$$23, $$7, $$8, $$9);
         }
