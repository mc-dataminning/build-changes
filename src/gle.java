...
public class gle implements AutoCloseable {
   ...
   private float b(float $$0) {
      bug $$1 = this.i.t.c(bui.G);
      return $$1 != null ? $$1.a(this.i.t, $$0) : 0.0F;
   }

   private float a(bvx $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, azu.b(((float)$$0.af - $$2) * (float) Math.PI * 0.025F) * $$3);
   }
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$2 != null) {
            ...
            if (this.i.t.b(bui.p)) {
               $$10 = gkw.a(this.i.t, $$0);
            } else if ($$9 > 0.0F && this.i.t.b(bui.C)) {
               $$10 = $$9;
            } else {
               $$10 = 0.0F;
            }
            ...
            gkp $$18 = Objects.requireNonNull(RenderSystem.setShader(gkq.b), "Lightmap shader not loaded");
   ...
   public static float a(ebj $$0, int $$1) {
      return a($$0.s(), $$1);
   }
