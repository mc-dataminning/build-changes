...
public class gle {
   ...
   private final dhh b;
   private final glf c;
   private final Map<jh, hfg> d = new HashMap<>();

   public gle(fme $$0, dhh $$1, glf $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public void b(int $$0, jh $$1, int $$2) {
      ...
      switch ($$0) {
         ...
         case 1031:
            ...
            break;
         case 1032:
            this.a.ak().a(hfb.b(axf.vc, $$3.i() * 0.4F + 0.8F, 0.25F));
            break;
         case 1033:
         ...
         case 2007:
            ...
            for (int $$15 = 0; $$15 < 100; $$15++) {
               ...
               giq $$21 = this.c.b($$14, $$14.a().b(), $$9.d + $$18 * 0.1, $$9.e + 0.3, $$9.f + $$20 * 0.1, $$18, $$19, $$20);
               if ($$21 != null) {
         ...
         case 2006:
            for (int $$69 = 0; $$69 < 200; $$69++) {
               ...
               giq $$75 = this.c.b(ls.h, false, (double)$$1.u() + $$72 * 0.1, (double)$$1.v() + 0.3, (double)$$1.w() + $$74 * 0.1, $$72, $$73, $$74);
               if ($$75 != null) {
                  $$75.c($$70);
               }
            }
