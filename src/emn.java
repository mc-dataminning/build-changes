...
public class emn implements elx {
   public static final Codec<emn> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               eqm.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               eny.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               eny.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               ehu.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, emn::new)
   );
   ...
   public emn(jf<eqm> $$0, int $$1, int $$2, axr<dmm> $$3, eny $$4, int $$5, int $$6, int $$7, int $$8, eny $$9, int $$10, int $$11, ehu $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
