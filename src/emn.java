...
public enum emn implements avj {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final avj.a<emn> t = avj.a(emn::values);
   public static final IntFunction<emn> u = atf.a(emn::a, values(), atf.a.a);
   private final int v;
   private final String w;

   private emn(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
