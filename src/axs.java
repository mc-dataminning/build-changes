...
public class axs extends axd {
               ...
               $$2.get("CriteriaName")
                  ...
                  .map($$0x -> {
                     ...
                     if ($$1x < 0) {
                        ...
                        try {
                           acq $$2x = acq.a($$0x.substring(0, $$1x), '.');
                           acq $$3 = acq.a($$0x.substring($$1x + 1), '.');
               ...
               $$1x -> {
                  ...
                  if ($$2x.isPresent() && $$3x.isPresent()) {
                     ...
                     return $$4.equals("_special")
                        ? Optional.of($$2.createString($$3x.get()))
                        : Optional.of($$1x.createString(this.a($$4) + ":" + this.a($$3x.get())));
                  } else {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, avw.w, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), c, d));
   }

   protected static Map<String, Supplier<TypeTemplate>> a(Schema $$0) {
      Supplier<TypeTemplate> $$1 = () -> DSL.optionalFields("id", avw.s.in($$0));
      Supplier<TypeTemplate> $$2 = () -> DSL.optionalFields("id", avw.r.in($$0));
      Supplier<TypeTemplate> $$3 = () -> DSL.optionalFields("id", avw.o.in($$0));
