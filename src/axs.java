...
public class axs<T> extends AbstractList<T> implements azb<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return axs.this.get(this.b--);
      }

      @Override
      public void remove() {
         axs.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements azb<T> {
      private final axs<T> b;

      public b(final axs<T> $$0) {
         this.b = $$0;
      }
