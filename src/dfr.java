...
public class dfr {
   ...
   private final Map<Character, Predicate<dfp>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dfr a(char $$0, Predicate<dfp> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dfq b() {
      return new dfq(this.c());
   }

   private Predicate<dfp>[][][] c() {
      this.d();
      Predicate<dfp>[][][] $$0 = (Predicate<dfp>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dfp>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
