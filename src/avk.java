...
public class avk extends azt {
   public avk(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bat.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bat.s, "minecraft:piston");
