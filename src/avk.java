...
public class avk {
   ...
   private static final Optional<Object> b = Optional.of(avt.a);

   private static boolean a(wd $$0, auc $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, wd $$1, auc $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, wd $$1, auc $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, wd $$1, auc $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, wd $$2, auc $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, wd $$2, wd $$3, auc $$4) {
      int $$5 = $$0.length();
      wd $$6 = $$2;
   ...
   public static boolean a(vl $$0, wd $$1, auc $$2) {
