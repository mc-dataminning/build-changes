...
public class ang {
   private static final DynamicCommandExceptionType a = new DynamicCommandExceptionType($$0 -> xg.b("clear.failed.single", $$0));
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> xg.b("clear.failed.multiple", $$0));
   ...
   private static int a(ek $$0, Collection<asc> $$1, Predicate<dak> $$2) throws CommandSyntaxException {
      return a($$0, $$1, $$2, -1);
   }

   private static int a(ek $$0, Collection<asc> $$1, Predicate<dak> $$2, int $$3) throws CommandSyntaxException {
      int $$4 = 0;
