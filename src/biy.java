...
public class biy extends bhs {
   public biy(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", biw.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bkr.a($$0.get("id").asString("minecraft:air"));
