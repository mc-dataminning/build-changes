...
public class biy extends bgv {
   private static final Logger a = LogUtils.getLogger();

   public biy(Schema $$0) {
      super($$0, false, "TrialSpawnerConfigInRegistryFix", bia.s, "minecraft:trial_spawner");
   }
   ...
   public Dynamic<?> a(Dynamic<vi> $$0) {
      ...
      if ($$1.isEmpty()) {
         ...
         if ($$2.isEmpty()) {
            ...
            alj $$3 = biy.a.a.get(Pair.of($$1.get(), $$2.get()));
            return $$3 == null
               ? $$0
   ...
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), $$0x -> {
         ...
         Dynamic<?> $$2 = this.a($$0x.convert(uz.a));
         return $$2.convert($$1);
      });
   }

   static final class a {
      public static final Map<Pair<Dynamic<vi>, Dynamic<vi>>, alj> a = new HashMap<>();

      private a() {
      }

      private static void a(alj $$0, String $$1, String $$2) {
         try {
            ul $$3 = a($$1);
            ul $$4 = a($$2);
            ul $$5 = $$3.i().a($$4);
      ...
      private static Dynamic<vi> a(ul $$0) {
         return new Dynamic(uz.a, $$0);
      }
      ...
      static {
         ...
         a(
            alj.b("trial_chamber/melee/husk"),
         ...
         a(
            alj.b("trial_chamber/melee/spider"),
         ...
         a(
            alj.b("trial_chamber/melee/zombie"),
         ...
         a(
            alj.b("trial_chamber/ranged/poison_skeleton"),
         ...
         a(
            alj.b("trial_chamber/ranged/skeleton"),
         ...
         a(
            alj.b("trial_chamber/ranged/stray"),
         ...
         a(
            alj.b("trial_chamber/slow_ranged/poison_skeleton"),
         ...
         a(
            alj.b("trial_chamber/slow_ranged/skeleton"),
         ...
         a(
            alj.b("trial_chamber/slow_ranged/stray"),
         ...
         a(
            alj.b("trial_chamber/small_melee/baby_zombie"),
         ...
         a(
            alj.b("trial_chamber/small_melee/cave_spider"),
         ...
         a(
            alj.b("trial_chamber/small_melee/silverfish"),
         ...
         a(
            alj.b("trial_chamber/small_melee/slime"),
