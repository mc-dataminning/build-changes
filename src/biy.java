...
public class biy extends DataFix {
   ...
   public biy(Schema $$0, boolean $$1) {
      super($$0, $$1);
   }

   public TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getChoiceType(bhw.B, "minecraft:villager");
      ...
      return this.fixTypeEverywhereTyped("Villager level and xp rebuild", this.getInputSchema().getType(bhw.B), $$5x -> $$5x.updateTyped($$1, $$0, $$3xx -> {
