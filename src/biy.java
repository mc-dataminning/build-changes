...
public class biy extends bis {
   ...
   public biy(cpx $$0, double $$1, double $$2, double $$3, int $$4) {
      this(biw.J, $$0);
      this.e($$1, $$2, $$3);
   ...
   public biy(biw<? extends biy> $$0, cpx $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         ehp $$0 = new ehp(this.k.dq() - this.dq(), this.k.ds() + (double)this.k.cH() / 2.0 - this.ds(), this.k.dw() - this.dw());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void t() {
      ...
      if (this.dL() instanceof aks) {
         for (biy $$1 : this.dL().a(djj.a(biy.class), this.cG().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(aks $$0, ehp $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new biy($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(aks $$0, ehp $$1, int $$2) {
      ehk $$3 = ehk.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.D_().a(40);
      List<biy> $$5 = $$0.a(djj.a(biy.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         biy $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private static boolean a(biy $$0, int $$1, int $$2) {
      return !$$0.dG() && ($$0.ah() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(biy $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cbw $$0, int $$1) {
      Entry<bix, cjh> $$2 = cns.a(cnu.L, $$0, cjh::j);
      if ($$2 != null) {
         cjh $$3 = $$2.getValue();
