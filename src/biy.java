...
public class biy extends bii {
   public biy(int $$0, Schema $$1) {
      super($$0, $$1);
   }

   protected static void a(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> bij.a($$0));
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:donkey", $$1x -> DSL.optionalFields("Items", DSL.list(bgx.t.in($$0)), "SaddleItem", bgx.t.in($$0), bij.a($$0)));
      ...
      $$0.register($$1, "minecraft:enderman", $$1x -> DSL.optionalFields("carriedBlockState", bgx.u.in($$0), bij.a($$0)));
      ...
      $$0.register($$1, "minecraft:horse", $$1x -> DSL.optionalFields("ArmorItem", bgx.t.in($$0), "SaddleItem", bgx.t.in($$0), bij.a($$0)));
      ...
      $$0.register($$1, "minecraft:mule", $$1x -> DSL.optionalFields("Items", DSL.list(bgx.t.in($$0)), "SaddleItem", bgx.t.in($$0), bij.a($$0)));
      ...
      $$0.register($$1, "minecraft:skeleton_horse", $$1x -> DSL.optionalFields("SaddleItem", bgx.t.in($$0), bij.a($$0)));
      ...
      $$0.register($$1, "minecraft:zombie_horse", $$1x -> DSL.optionalFields("SaddleItem", bgx.t.in($$0), bij.a($$0)));
      a($$0, $$1, "minecraft:zombie_pigman");
      $$0.register($$1, "minecraft:zombie_villager", $$1x -> DSL.optionalFields("Offers", DSL.optionalFields("Recipes", DSL.list(bgx.x.in($$0))), bij.a($$0)));
      return $$1;
   }
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      Map<String, Supplier<TypeTemplate>> $$4 = bix.a($$0);
      $$0.registerType(false, bgx.H, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), bix.c, bix.d));
      $$0.registerType(false, bgx.I, DSL::remainder);
