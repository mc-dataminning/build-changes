...
public class biy extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(
         "RaidRenamesDataFix", this.getInputSchema().getType(bjd.l), $$0 -> $$0.update(DSL.remainderFinder(), $$0x -> $$0x.update("data", biy::a))
      );
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Raids", "raids", $$0x -> $$0x.createList($$0x.asStream().map(biy::b)))
         .renameField("Tick", "tick")
         .renameField("NextAvailableID", "next_id");
   }

   private static Dynamic<?> b(Dynamic<?> $$0) {
      return bbh.a($$0, "CX", "CY", "CZ", "center")
         .renameField("Id", "id")
