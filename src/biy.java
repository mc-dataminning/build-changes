...
public class biy extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$2 = this.getInputSchema().getType(biq.D);
      Type<?> $$3 = this.getOutputSchema().getType(biq.D);
      Type<?> $$4 = baz.a($$2, $$2, $$3);
      return this.fixTypeEverywhereTyped("SaddleEquipmentSlotFix", $$2, $$3, $$3x -> {
         String $$4x = $$3x.getOptional($$1).<String>map(Pair::getFirst).map(bkj::a).orElse("");
         Typed<?> $$5 = baz.a($$4, $$3x);
         if (a.contains($$4x)) {
            return af.a($$5, $$3, biy::a);
         } else {
            return b.contains($$4x) ? af.a($$5, $$3, biy::b) : baz.a($$3, $$3x);
         }
      });
   }
