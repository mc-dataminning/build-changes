...
public class eed extends edq<efn> {
   public eed(Codec<efn> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? azd.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(azl $$0, deh $$1, int $$2, int $$3, je $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, je $$2, deh $$3, boolean $$4, double $$5, je $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(deh $$0, je $$1) {
      if ($$0.a_($$1.d()).a(dhl.dN)) {
         this.a($$0, $$1.d(), dhl.a.o());
      }
   }

   private void a(deh $$0, azl $$1, je $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, duo $$13) {
   ...
   private void a(je $$0, deh $$1, azl $$2, int $$3, int $$4, boolean $$5, boolean $$6, duo $$7) {
      duo $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dhl.dP) || $$8.a(dhl.dO) || $$8.a(dhl.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dhl.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dhl.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, je $$2, int $$3, azl $$4) {
      float $$5 = 10.0F * azd.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(azl $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(azl $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(duo $$0) {
      return $$0.a(dhl.iC) || $$0.a(dhl.dP) || $$0.a(dhl.mW);
   }
   ...
   private void a(deh $$0, je $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dhl.dN)) {
                  if (this.a((ddl)$$0, $$10)) {
                     this.a($$0, $$10, dhl.a.o());
                     this.a($$0, $$10.d(), dhl.a.o());
                  } else if (c($$11)) {
                     duo[] $$12 = new duo[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
