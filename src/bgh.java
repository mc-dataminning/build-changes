...
public class bgh implements bgi {
   ...
   private static final bgh j = new bgh();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bgg $$0) {
      URL $$1 = bgh.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bgg $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bgk a = new bgk(() -> bgh.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bgh.this.k && $$0.getState() == RecordingState.STOPPED) {
