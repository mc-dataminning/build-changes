...
public class aoj implements AutoCloseable {
   ...
   private aoj(URL $$0, aoj.c $$1, URL $$2, aoj.b $$3, URL $$4, aoj.b $$5, String $$6, aoj.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? auf.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static aoj a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = auf.a($$0);
            URI $$2 = new URI(auf.i($$1, "apiServer"));
            String $$3 = auf.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = auf.a($$1, "ruleId", 1);
               String $$5 = auf.a($$1, "serverId", "");
               String $$6 = auf.a($$1, "roomId", "Java:Chat");
               int $$7 = auf.a($$1, "hashesToDrop", -1);
               int $$8 = auf.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = auf.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, aoj.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<anv> a(GameProfile $$0, String $$1, aoj.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(anv.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = auf.a($$4, "response", false);
            if ($$5) {
               return anv.a($$1);
            } else {
               String $$6 = auf.a($$4, "hashed", null);
               if ($$6 == null) {
                  return anv.b($$1);
               } else {
                  JsonArray $$7 = auf.v($$4, "hashes");
                  vk $$8 = this.a($$1, $$7, $$2);
                  return new anv($$1, $$8);
               }
            }
   ...
   private vk a(String $$0, JsonArray $$1, aoj.a $$2) {
      if ($$1.isEmpty()) {
         return vk.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return vk.b;
      } else {
         vk $$3 = new vk($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new aoj.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public aoi a(GameProfile $$0) {
      return new aoj.d($$0);
   }
   ...
   public interface a {
      aoj.a a = ($$0, $$1) -> false;
      aoj.a b = ($$0, $$1) -> $$0.length() == $$1;

      static aoj.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static aoj.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements aoi {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         biv<Runnable> $$1 = biv.a(aoj.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         aoj.this.a(this.c, aoj.this.g, aoj.this.h, this.d);
      }

      @Override
      public void b() {
         aoj.this.a(this.c, aoj.this.i, aoj.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<anv>> a(List<String> $$0) {
         List<CompletableFuture<anv>> $$1 = $$0.stream().map($$0x -> aoj.this.a(this.c, $$0x, aoj.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<anv> a(String $$0) {
         return aoj.this.a(this.c, $$0, aoj.this.l, this.d);
      }
   }
