...
public class aoj implements aog {
   ...
   private final Map<aoh, List<Path>> g;

   aoj(aob $$0, Set<String> $$1, List<Path> $$2, Map<aoh, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(aoh $$0, agt $$1, Consumer<Path> $$2) {
   ...
   public void a(aoh $$0, String $$1, String $$2, aog.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<agt, apk<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(aog.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      aoi.a($$1, $$4, $$3, $$0);
   }
   ...
   public apk<InputStream> a(aoh $$0, agt $$1) {
      return (apk<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && aoi.a($$5)) {
               return apk.create($$5);
            }
         }
   ...
   public <T> T a(aos<T> $$0) {
      apk<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public apv c() {
      return $$0 -> Optional.ofNullable(this.a(aoh.a, $$0)).map($$0x -> new apq(this, $$0x));
   }
}
