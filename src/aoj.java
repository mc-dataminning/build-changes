...
public class aoj {
   ...
   private static int a(ei $$0, Collection<arr> $$1, alg $$2, awo $$3, fei $$4, float $$5, float $$6, float $$7) throws CommandSyntaxException {
      ...
      for (arr $$12 : $$1) {
         ...
         if ($$16 > $$9) {
            ...
            $$17 = new fei($$12.dA() + $$13 / $$19 * 2.0, $$12.dC() + $$14 / $$19 * 2.0, $$12.dG() + $$15 / $$19 * 2.0);
            $$18 = $$7;
         }
