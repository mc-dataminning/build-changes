   ...
   private static int a(ep $$0, int $$1, boolean $$2) {
      ...
      for (int $$11 = $$7; $$11 <= $$8; $$11++) {
         for (int $$12 = $$9; $$12 <= $$10; $$12++) {
            dbd $$13 = new dbd($$12, $$11);
            dug $$14 = $$4.a($$12, $$11, false);
            if ($$14 != null && (!$$2 || !$$14.s())) {
      ...
      bpl<Runnable> $$16 = bpl.a(ac.g(), "worldgen-resetchunks");
      long $$17 = System.currentTimeMillis();
      int $$18 = ($$1 * 2 + 1) * ($$1 * 2 + 1);
      UnmodifiableIterator var34 = ImmutableList.of(duv.f, duv.g, duv.h, duv.i, duv.j, duv.k).iterator();

      while (var34.hasNext()) {
         duv $$19 = (duv)var34.next();
         long $$20 = System.currentTimeMillis();
         CompletableFuture<Unit> $$21 = CompletableFuture.supplyAsync(() -> Unit.INSTANCE, $$16::a);
         duz $$22 = new duz($$3, $$4.g(), $$3.q(), $$4.a());

         for (int $$23 = $$6.f - $$1; $$23 <= $$6.f + $$1; $$23++) {
            for (int $$24 = $$6.e - $$1; $$24 <= $$6.e + $$1; $$24++) {
               dbd $$25 = new dbd($$24, $$23);
               dug $$26 = $$4.a($$24, $$23, false);
               if ($$26 != null && (!$$2 || !$$26.s())) {
                  List<dtw> $$27 = Lists.newArrayList();
                  int $$28 = Math.max(1, $$19.e());

                  for (int $$29 = $$25.f - $$28; $$29 <= $$25.f + $$28; $$29++) {
                     for (int $$30 = $$25.e - $$28; $$30 <= $$25.e + $$28; $$30++) {
                        dtw $$31 = $$4.a($$30, $$29, $$19.d(), true);
                        dtw $$32;
                        if ($$31 instanceof duf) {
                           $$32 = new duf(((duf)$$31).C(), true);
                        } else if ($$31 instanceof dug) {
                           $$32 = new duf((dug)$$31, true);
                        } else {
                           $$32 = $$31;
                        }
      ...
      for (int $$36 = $$6.f - $$1; $$36 <= $$6.f + $$1; $$36++) {
         for (int $$37 = $$6.e - $$1; $$37 <= $$6.e + $$1; $$37++) {
            dbd $$38 = new dbd($$37, $$36);
            dug $$39 = $$4.a($$37, $$36, false);
            if ($$39 != null && (!$$2 || !$$39.s())) {
