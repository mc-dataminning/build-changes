...
public interface aoj {
   aoj a = new aoj() {
      ...
      @Override
      public void a(Consumer<cuu> $$0) {
      }
   };

   static aoj a(cuu $$0, int $$1) {
      return new aoj.a($$0, $$1);
   }

   static void a(aoj $$0, aoj $$1, Consumer<cuu> $$2, Consumer<cuu> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aoj.a $$4 && $$1 instanceof aoj.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new cuu($$10, $$11));
                     } else {
                        $$3.accept(new cuu($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(cuu b, int c) implements aoj {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(aoj.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return aoj.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
