...
public class gga extends dgj {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final ebh e = new ebh();
   private final ebn<bum> f = new ebn<>(bum.class, new gga.b());
   private final ggb E;
   private final glv F;
   private final glu G;
   private final gga.a H;
   private final glm I;
   private final bsu J;
   private final flk K = flk.Q();
   final List<gku> L = Lists.newArrayList();
   final List<cjt> M = Lists.newArrayList();
   private final Map<eus, euu> N = Maps.newHashMap();
   private static final int O = -1;
   private int P;
   private final Object2ObjectArrayMap<dft, fmn> Q = af.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(glh.a, new fmn($$0xx -> this.b($$0xx, glh.a)));
      $$0x.put(glh.b, new fmn($$0xx -> this.b($$0xx, glh.b)));
      $$0x.put(glh.c, new fmn($$0xx -> this.b($$0xx, glh.c)));
   });
   private final gfw R;
   private final Deque<Runnable> S = Queues.newArrayDeque();
   private int T;
   private final ghn U = new ghn();
   private final int V;
   private boolean W;
   private static final Set<cwm> X = Set.of(cwu.hY, cwu.hZ);

   public void b(int $$0) {
      this.U.a($$0, this);
   }

   public void b(ji $$0, dwy $$1, int $$2) {
      if (!this.U.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(ji $$0, dwy $$1, fbb $$2) {
      dwy $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         coy $$4 = this.K.t;
   ...
   public gga(ggb $$0, gga.a $$1, aku<dgj> $$2, jr<eat> $$3, int $$4, int $$5, glv $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.R = new gfw(this, $$4);
      this.J = new bsu();
      this.H = $$1;
      this.F = $$6;
      this.V = $$9;
      this.G = new glu(this.K, this, $$6);
      this.I = glm.a($$3.a());
   ...
   private void a(bum $$0, bum $$1) {
      if ($$1.dQ() || $$1.dk() != $$0) {
         $$1.ae();
      } else if ($$1 instanceof coy || this.e.c($$1)) {
         $$1.bz();
         $$1.af++;
         $$1.r();
   ...
   private djn o() {
      if (this.K.r.j() == dgg.b) {
         cwq $$0 = this.K.t.eZ();
         cwm $$1 = $$0.h();
         if (X.contains($$1) && $$1 instanceof cuw $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, azh $$4, @Nullable djn $$5, ji.a $$6) {
   ...
   private void a(ji $$0, dwy $$1, lr $$2, boolean $$3) {
      if ($$1.y().c()) {
         fbv $$4 = $$1.g(this, $$0);
         double $$5 = $$4.c(jn.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(ji $$0, lr $$1, fbv $$2, double $$3) {
   ...
   public void a(@Nullable coy $$0, bum $$1, jr<avz> $$2, awb $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hiq)(new hih($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bum $$0, avz $$1, awb $$2, float $$3, float $$4) {
      this.K.ak().a((hiq)(new hih($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avz $$3, awb $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      hil $$10 = new hil($$3, $$4, $$5, $$6, azh.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<czf> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.K.g.a(new gis.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
   ...
   public jr<dhl> a(int $$0, int $$1, int $$2) {
      return this.K_().e(mc.aI).b(dhs.b);
   }
   ...
   public int a(fbb $$0, float $$1) {
      float $$2 = this.f($$1);
      fbb $$3 = $$0.a(2.0, 2.0, 2.0).c(0.25);
      fbb $$4 = aya.a($$3, ($$0x, $$1x, $$2x) -> fbb.a(this.I_().a($$0x, $$1x, $$2x).a().a()));
   ...
   public int a(ji $$0, dft $$1) {
      fmn $$2 = (fmn)this.Q.get($$1);
      return $$2.a($$0);
   }

   public int b(ji $$0, dft $$1) {
      int $$2 = flk.Q().n.G().c();
      if ($$2 == 0) {
   ...
   protected Map<eus, euu> l() {
      return ImmutableMap.copyOf(this.N);
   }

   protected void a(Map<eus, euu> $$0) {
      this.N.putAll($$0);
   }
   ...
   public static class a implements evn {
      ...
      public a(bsi $$0, boolean $$1, boolean $$2) {
         this.h = $$0;
         this.a = $$1;
         this.b = $$2;
      }
   ...
   final class b implements ebj<bum> {
      public void a(bum $$0) {
      }
      ...
      public void e(bum $$0) {
         ...
         switch ($$0) {
            case gku $$1:
               ...
               break;
            case cjw $$2:
               gga.this.M.addAll(Arrays.asList($$2.x()));
               break;
         }
      }
      ...
      public void f(bum $$0) {
         ...
         switch ($$0) {
            case gku $$1:
               ...
               break;
            case cjw $$2:
               gga.this.M.removeAll(Arrays.asList($$2.x()));
               break;
         }
      }
