public abstract class fuz<T extends ctp> extends fux<T> implements fyk {
   private final fyf<?> G;
   private boolean H;

   public fuz(T $$0, fyf<?> $$1, cou $$2, wo $$3) {
      super($$0, $$2, $$3);
      this.G = $$1;
   }
   ...
   protected abstract fsw G();

   private void M() {
      fsw $$0 = this.G();
      this.c(new fpc($$0.a(), $$0.b(), 20, 18, fyf.a, $$0x -> {
         this.G.c();
         this.C = this.G.a(this.n, this.s);
         fsw $$1 = this.G();
         $$0x.c($$1.a(), $$1.b());
