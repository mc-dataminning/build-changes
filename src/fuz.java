...
public abstract class fuz<T extends csc> extends fuk implements fwf<T> {
   ...
   protected List<wo> a(cwp $$0) {
      return a(this.m, $$0);
   }

   private void a(fod $$0, cwp $$1, int $$2, int $$3, @Nullable String $$4) {
      $$0.c().a();
