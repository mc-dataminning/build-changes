...
public abstract class fuz<T extends csb> extends fuk implements fwf<T> {
   ...
   private cwo V = cwo.j;
   private long W;
   protected final Set<cty> E = Sets.newHashSet();
   protected boolean F;
   private int X;
   private int Y;
   private boolean Z;
   ...
   private int ac;
   private boolean ad;
   private cwo ae = cwo.j;

   public fuz(T $$0, cov $$1, wp $$2) {
      super($$2);
      this.z = $$0;
      this.A = $$1.p_();
      this.Z = true;
   ...
   public void a(fod $$0, int $$1, int $$2, float $$3) {
      ...
      this.b($$0, $$1, $$2);
      cwo $$7 = this.R.f() ? this.z.g() : this.R;
      if (!$$7.f()) {
         int $$8 = 8;
         int $$9 = this.R.f() ? 8 : 16;
         String $$10 = null;
   ...
   private void d(fod $$0) {
      if (this.B != null && this.B.e()) {
         $$0.a(gmh::H, G, this.B.e - 4, this.B.f - 4, 24, 24);
      }
   }

   private void e(fod $$0) {
      if (this.B != null && this.B.e()) {
         $$0.a(gmh::F, H, this.B.e - 4, this.B.f - 4, 24, 24);
      }
   }
   ...
   private boolean b(cwo $$0) {
      return $$0.b().map(fwu::a).map(fwu::a).orElse(false);
   }

   protected List<wp> a(cwo $$0) {
      return a(this.m, $$0);
   }

   private void a(fod $$0, cwo $$1, int $$2, int $$3, @Nullable String $$4) {
      $$0.c().a();
   ...
   protected abstract void a(fod var1, float var2, int var3, int var4);

   protected void a(fod $$0, cty $$1) {
      int $$2 = $$1.e;
      int $$3 = $$1.f;
      cwo $$4 = $$1.g();
      boolean $$5 = false;
      ...
      if ($$1 == this.M && !this.R.f() && this.Q && !$$4.f()) {
         ...
         if (csb.a($$1, $$7, true) && this.z.b($$1)) {
            $$5 = true;
            int $$9 = Math.min($$7.k(), $$1.a_($$7));
            int $$10 = $$1.g().f() ? 0 : $$1.g().M();
            int $$11 = csb.a(this.E, this.X, $$7) + $$10;
            if ($$11 > $$9) {
               $$11 = $$9;
               $$8 = n.o.toString() + $$9;
            }
      ...
      if (!$$0.f() && this.F) {
         if (this.X == 2) {
            ...
            for (cty $$1 : this.E) {
               ...
               int $$5 = Math.min(csb.a(this.E, this.X, $$0) + $$3, $$4);
               this.aa -= $$5 - $$3;
            }
         }
      }
   ...
   @Nullable
   private cty b(double $$0, double $$1) {
      for (cty $$2 : this.z.k) {
         if ($$2.d() && this.a($$2, $$0, $$1)) {
            return $$2;
         }
               ...
               if (this.m.n.ac().c()) {
                  ...
                  if (this.z.g().f()) {
                     if ($$3) {
                        ...
                        boolean $$10 = $$9 != -999 && (feo.a(fli.Q().aO().h(), 340) || feo.a(fli.Q().aO().h(), 344));
                        csm $$11 = csm.a;
                        if ($$10) {
                           this.ae = $$4 != null && $$4.h() ? $$4.g().v() : cwo.j;
                           $$11 = csm.b;
                        } else if ($$9 == -999) {
                           $$11 = csm.e;
                        }
   ...
   private void a(int $$0) {
      if (this.B != null && this.z.g().f()) {
         if (this.m.n.D.a($$0)) {
            this.a(this.B, this.B.d, 40, csm.c);
            return;
         }

         for (int $$1 = 0; $$1 < 9; $$1++) {
            if (this.m.n.S[$$1].a($$0)) {
               this.a(this.B, this.B.d, $$1, csm.c);
            }
         }
      }
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      ...
      if (this.M != null && this.m.n.ac().c()) {
         if ($$2 == 0 || $$2 == 1) {
            ...
            } else if (this.R.M() > 1 && $$5 != null && csb.a($$5, this.R, false)) {
               long $$7 = af.c();
               if (this.O == $$5) {
                  if ($$7 - this.W > 500L) {
                     this.a(this.M, this.M.d, 0, csm.a);
                     this.a($$5, $$5.d, 1, csm.a);
                     this.a(this.M, this.M.d, 0, csm.a);
                     this.W = $$7 + 750L;
                     this.R.h(1);
                  }
      ...
      } else if (this.F && $$5 != null && !$$6.f() && ($$6.M() > this.E.size() || this.X == 2) && csb.a($$5, $$6, true) && $$5.a($$6) && this.z.b($$5)) {
         this.E.add($$5);
         this.G();
      }
   ...
   public boolean b(double $$0, double $$1, int $$2) {
      ...
      if (this.ad && $$3 != null && $$2 == 0 && this.z.a(cwo.j, $$3)) {
         if (t()) {
            if (!this.ae.f()) {
               for (cty $$8 : this.z.k) {
                  if ($$8 != null && $$8.a(this.m.t) && $$8.h() && $$8.c == $$3.c && csb.a($$8, this.ae, true)) {
                     this.a($$8, $$8.d, $$2, csm.b);
                  }
               }
            }
         } else {
         ...
         if (this.M != null && this.m.n.ac().c()) {
            if ($$2 == 0 || $$2 == 1) {
               ...
               boolean $$9 = csb.a($$3, this.R, false);
               if ($$7 != -1 && !this.R.f() && $$9) {
                  this.a(this.M, this.M.d, $$2, csm.a);
                  this.a($$3, $$7, 0, csm.a);
                  if (this.z.g().f()) {
                     this.V = cwo.j;
                  } else {
            ...
            this.a(null, -999, csb.c(0, this.X), csm.f);

            for (cty $$10 : this.E) {
               this.a($$10, $$10.d, csb.c(1, this.X), csm.f);
            }

            this.a(null, -999, csb.c(2, this.X), csm.f);
         } else if (!this.z.g().f()) {
            if (this.m.n.H.a($$2)) {
               this.a($$3, $$7, $$2, csm.d);
            } else {
               boolean $$11 = $$7 != -999 && (feo.a(fli.Q().aO().h(), 340) || feo.a(fli.Q().aO().h(), 344));
               if ($$11) {
                  this.ae = $$3 != null && $$3.h() ? $$3.g().v() : cwo.j;
               }

               this.a($$3, $$7, $$2, $$11 ? csm.b : csm.a);
            }
         }
      }
   ...
   private boolean a(cty $$0, double $$1, double $$2) {
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if (this.B != null && this.B.h()) {
            if (this.m.n.H.a($$0, $$1)) {
               this.a(this.B, this.B.d, 0, csm.d);
            } else if (this.m.n.E.a($$0, $$1)) {
               this.a(this.B, this.B.d, s() ? 1 : 0, csm.e);
            }
         }
      ...
      if (this.z.g().f() && this.B != null) {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            if (this.m.n.S[$$2].a($$0, $$1)) {
               this.a(this.B, this.B.d, $$2, csm.c);
               return true;
            }
         }
      }
