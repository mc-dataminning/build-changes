public class fpp extends fod {
   private static final fpt a = new fpt(
   ...
   public fpp(fqk $$0, fqj $$1, int $$2, int $$3) {
      super(0, 0, $$2, $$3, $$1.a());
      this.m = $$0;
      this.n = $$1;
   }
   ...
   public void b(fns $$0, int $$1, int $$2, float $$3) {
      $$0.a(glv::C, a.a(this.b(), this.B()), this.D(), this.E(), this.g, this.h);
      fnq $$4 = fmg.Q().h;
   ...
   protected void a(fns $$0, int $$1, int $$2, int $$3, int $$4) {
      fty.a($$0, fty.g, $$1, $$2, 0.0F, 0.0F, $$3 - $$1, $$4 - $$2);
   }
   ...
   private void b(fns $$0, fnq $$1, int $$2) {
   ...
   protected void a(fsd $$0) {
      $$0.a(fsc.a, xv.a("gui.narrate.tab", this.n.a()));
   }
