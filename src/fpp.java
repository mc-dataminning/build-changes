...
public class fpp {
   public static void a(ggu $$0, fpn $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fpm>> $$6 : $$1.c().entrySet()) {
         Optional<gjc> $$7 = $$0.a($$6.getKey());
         List<fpm> $$8 = $$6.getValue();
   ...
   private static float a(fpn $$0, long $$1) {
