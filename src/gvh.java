...
public abstract class gvh extends fne {
   ...
   private final List<gvf> a = Lists.newArrayList();
   ...
   protected gvf a(gvf $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xp m() {
      return xo.a(this.a.stream().map(gvf::a).collect(Collectors.toList()));
   }
}
