public class gvh implements gvl {
   ...
   private static final wu f = wu.a("tutorial.move.title", gvk.a("forward"), gvk.a("left"), gvk.a("back"), gvk.a("right"));
   private static final wu g = wu.a("tutorial.move.description", gvk.a("jump"));
