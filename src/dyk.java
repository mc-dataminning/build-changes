...
public class dyk implements dxu {
   public static final Codec<dyk> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ecg.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               avd.b(kj.f).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               dzv.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               dzv.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dtt.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, dyk::new)
   );
   ...
   public dyk(il<ecg> $$0, int $$1, int $$2, avd<daa> $$3, dzv $$4, int $$5, int $$6, int $$7, int $$8, dzv $$9, int $$10, int $$11, dtt $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
