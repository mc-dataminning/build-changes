...
public class dzg<T> implements dzi<T> {
   ...
   private dzg(jw<T> $$0, int $$1, dzj<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dzg(jw<T> $$0, T[] $$1, dzj<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dzi<T> a(dzj<T> $$0) {
      return new dzg<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
