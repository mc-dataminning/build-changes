...
public class dzg implements dkf.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<dzg> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final arv<dzg> a = arv.a(f);
   private final dzk g;
   private final dzk h;
   private final dzk i;
   ...
   public static dzg a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new dzg(new dln(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private dzg(dzk $$0, dzk $$1, dzk $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public dzg(ash $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         dzk.a($$0, IntStream.rangeClosed(-15, 0)),
         dzk.a($$0, IntStream.rangeClosed(-15, 0)),
         dzk.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public dzg a(ash $$0) {
      return new dzg($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dkf.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         dzh $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(dzk.b($$4 * $$13), dzk.b($$5 * $$13), dzk.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = dzk.b($$1 * $$13);
         double $$21 = dzk.b($$2 * $$13);
         double $$22 = dzk.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            dzh $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return asb.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
