...
public class dzg {
   ...
   @Deprecated
   public static dzg a(aru $$0, dzg.a $$1) {
      return new dzg($$0, $$1, false);
   }

   public static dzg a(aru $$0, int $$1, double... $$2) {
      return b($$0, new dzg.a($$1, new DoubleArrayList($$2)));
   }

   public static dzg b(aru $$0, dzg.a $$1) {
      return new dzg($$0, $$1, true);
   }

   private dzg(aru $$0, dzg.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<dzg.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(dzg.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(dzg.a::b))
               .apply($$0, dzg.a::new)
      );
      public static final Codec<he<dzg.a>> b = aen.a(jc.ax, a);
