...
public class fqo implements akr<cyq>, fif, fiy, fkw, fqt {
   public static final fip a = new fip(new ale("recipe_book/button"), new ale("recipe_book/button_highlighted"));
   private static final fip i = new fip(
      new ale("recipe_book/filter_enabled"),
      new ale("recipe_book/filter_disabled"),
      new ale("recipe_book/filter_enabled_highlighted"),
      new ale("recipe_book/filter_disabled_highlighted")
   );
   protected static final ale b = new ale("textures/gui/recipe_book.png");
   private static final xo j = xo.c("gui.recipebook.search_hint").a(n.u).a(n.h);
   public static final int c = 147;
   public static final int d = 166;
   private static final int k = 86;
   private static final xo l = xo.c("gui.recipebook.toggleRecipes.craftable");
   private static final xo m = xo.c("gui.recipebook.toggleRecipes.all");
   private int n;
   private int o;
   private int p;
   protected final fqm e = new fqm();
   private final List<fqq> q = Lists.newArrayList();
   @Nullable
   private fqq r;
   protected fii f;
   protected crf<?> g;
   ...
   private String u = "";
   private feq v;
   private final fqp w = new fqp();
   private final cmz x = new cmz();
   private int y;
   private boolean z;
   private boolean A;
   private boolean B;

   public void a(int $$0, int $$1, ffd $$2, boolean $$3, crf<?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      this.s = new fhl(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, xo.c("itemGroup.search"));
      this.s.f(50);
      this.s.g(true);
      this.s.g(16777215);
      this.s.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new fii($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (ffl $$3 : ffl.a(this.g.t())) {
         this.q.add(new fqq($$3));
      }
   ...
   private void b() {
      this.f.a(this.f.a() ? fin.a(this.c()) : fin.a(m));
   }
   ...
   private void c(boolean $$0) {
      List<fqs> $$1 = this.v.a(this.r.b());
      $$1.forEach($$0x -> $$0x.a(this.x, this.g.n(), this.g.o(), this.v));
      List<fqs> $$2 = Lists.newArrayList($$1);
      $$2.removeIf($$0x -> !$$0x.b());
      $$2.removeIf($$0x -> !$$0x.d());
      String $$3 = this.s.a();
      if (!$$3.isEmpty()) {
         ObjectSet<fqs> $$4 = new ObjectLinkedOpenHashSet(this.h.a(gsx.c).search($$3.toLowerCase(Locale.ROOT)));
   ...
   private void b(fgp $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fnb.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(fgp $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.f() && !this.h.s.N_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.cb.j, $$3, fnb.s());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (!this.f() || this.h.s.N_()) {
         ...
         return true;
      } else if (this.h.m.J.a($$0, $$1) && !this.s.aI_()) {
         this.z = true;
         this.s.a(true);
         return true;
      } else {
   ...
   public void a(cyv<?> $$0, List<crn> $$1) {
      ...
      this.e.a($$0);
      this.e.a(cyq.a($$2), $$1.get(0).e, $$1.get(0).f);
   ...
   protected void j() {
      if (this.h.L() != null) {
         ...
         this.h.L().b(new aic($$0, $$1, $$2));
      }
   }

   @Override
   public fkw.a t() {
      return this.A ? fkw.a.b : fkw.a.a;
   }
