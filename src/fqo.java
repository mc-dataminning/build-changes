...
public class fqo extends apm<fqo.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final agi b = new agi("gpu_warnlist.json");
   ...
   protected fqo.a a(aph $$0, bfo $$1) {
      ...
      $$1.b();
      return new fqo.a($$2, $$3, $$4);
   }

   protected void a(fqo.a $$0, aph $$1, bfo $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aph $$0, bfo $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, emp.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, emp.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, emp.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
