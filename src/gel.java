...
public class gel {
   ...
   public final Map<je, gem> c;
   public final gen d;
   public final boolean e;

   public gel(Vector3f $$0, Vector3f $$1, Map<je, gem> $$2, @Nullable gen $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<je, gem> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gel> {
      ...
      public gel a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         gen $$6 = this.a($$3);
         Map<je, gem> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !ayo.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = ayo.a($$3, "shade", true);
            return new gel($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private gen a(JsonObject $$0) {
         gen $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<je, gem> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<je, gem> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<je, gem> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<je, gem> $$2 = Maps.newEnumMap(je.class);
         JsonObject $$3 = ayo.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            je $$5 = this.a($$4.getKey());
            $$2.put($$5, (gem)$$0.deserialize($$4.getValue(), gem.class));
         }
