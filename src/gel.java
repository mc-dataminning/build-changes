...
public class gel {
   ...
   static final ThreadLocal<gel.d> f = ThreadLocal.withInitial(gel.d::new);

   public gel(fgj $$0) {
      this.d = $$0;
   }

   public void a(dbc $$0, grb $$1, dsd $$2, iz $$3, ezz $$4, fad $$5, boolean $$6, azh $$7, long $$8, int $$9) {
      boolean $$10 = ffg.P() && $$2.h() == 0 && $$1.a();
      evs $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(dbc $$0, grb $$1, dsd $$2, iz $$3, ezz $$4, fad $$5, boolean $$6, azh $$7, long $$8, int $$9) {
      ...
      for (je $$14 : c) {
         $$7.b($$8);
         List<gem> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || dfa.a($$2, $$0, $$3, $$14, $$13)) {
      ...
      $$7.b($$8);
      List<gem> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dbc $$0, grb $$1, dsd $$2, iz $$3, ezz $$4, fad $$5, boolean $$6, azh $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      iz.a $$11 = $$3.j();

      for (je $$12 : c) {
         $$7.b($$8);
         List<gem> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || dfa.a($$2, $$0, $$3, $$12, $$11)) {
               int $$14 = gdn.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gem> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dbc $$0, dsd $$1, iz $$2, ezz $$3, fad $$4, List<gem> $$5, float[] $$6, BitSet $$7, gel.b $$8, int $$9) {
      for (gem $$10 : $$5) {
   ...
   private void a(
      dbc $$0, dsd $$1, iz $$2, fad $$3, ezz.a $$4, gem $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dbc $$0, dsd $$1, iz $$2, int[] $$3, je $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(dbc $$0, dsd $$1, iz $$2, int $$3, int $$4, boolean $$5, ezz $$6, fad $$7, List<gem> $$8, BitSet $$9) {
      for (gem $$10 : $$8) {
         if ($$5) {
   ...
   public void a(ezz.a $$0, fad $$1, @Nullable dsd $$2, grb $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      azh $$9 = azh.a();
      long $$10 = 42L;
   ...
   private static void a(ezz.a $$0, fad $$1, float $$2, float $$3, float $$4, List<gem> $$5, int $$6, int $$7) {
      for (gem $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gel.e[]{gel.e.k, gel.e.d, gel.e.k, gel.e.j, gel.e.e, gel.e.j, gel.e.e, gel.e.d},
         new gel.e[]{gel.e.k, gel.e.c, gel.e.k, gel.e.i, gel.e.e, gel.e.i, gel.e.e, gel.e.c},
         new gel.e[]{gel.e.l, gel.e.c, gel.e.l, gel.e.i, gel.e.f, gel.e.i, gel.e.f, gel.e.c},
         new gel.e[]{gel.e.l, gel.e.d, gel.e.l, gel.e.j, gel.e.f, gel.e.j, gel.e.f, gel.e.d}
      ),
      b(
         new je[]{je.f, je.e, je.c, je.d},
         1.0F,
         true,
         new gel.e[]{gel.e.f, gel.e.d, gel.e.f, gel.e.j, gel.e.l, gel.e.j, gel.e.l, gel.e.d},
         new gel.e[]{gel.e.f, gel.e.c, gel.e.f, gel.e.i, gel.e.l, gel.e.i, gel.e.l, gel.e.c},
         new gel.e[]{gel.e.e, gel.e.c, gel.e.e, gel.e.i, gel.e.k, gel.e.i, gel.e.k, gel.e.c},
         new gel.e[]{gel.e.e, gel.e.d, gel.e.e, gel.e.j, gel.e.k, gel.e.j, gel.e.k, gel.e.d}
      ),
      c(
         new je[]{je.b, je.a, je.f, je.e},
         0.8F,
         true,
         new gel.e[]{gel.e.b, gel.e.k, gel.e.b, gel.e.e, gel.e.h, gel.e.e, gel.e.h, gel.e.k},
         new gel.e[]{gel.e.b, gel.e.l, gel.e.b, gel.e.f, gel.e.h, gel.e.f, gel.e.h, gel.e.l},
         new gel.e[]{gel.e.a, gel.e.l, gel.e.a, gel.e.f, gel.e.g, gel.e.f, gel.e.g, gel.e.l},
         new gel.e[]{gel.e.a, gel.e.k, gel.e.a, gel.e.e, gel.e.g, gel.e.e, gel.e.g, gel.e.k}
      ),
      d(
         new je[]{je.e, je.f, je.a, je.b},
         0.8F,
         true,
         new gel.e[]{gel.e.b, gel.e.k, gel.e.h, gel.e.k, gel.e.h, gel.e.e, gel.e.b, gel.e.e},
         new gel.e[]{gel.e.a, gel.e.k, gel.e.g, gel.e.k, gel.e.g, gel.e.e, gel.e.a, gel.e.e},
         new gel.e[]{gel.e.a, gel.e.l, gel.e.g, gel.e.l, gel.e.g, gel.e.f, gel.e.a, gel.e.f},
         new gel.e[]{gel.e.b, gel.e.l, gel.e.h, gel.e.l, gel.e.h, gel.e.f, gel.e.b, gel.e.f}
      ),
      e(
         new je[]{je.b, je.a, je.c, je.d},
         0.6F,
         true,
         new gel.e[]{gel.e.b, gel.e.d, gel.e.b, gel.e.j, gel.e.h, gel.e.j, gel.e.h, gel.e.d},
         new gel.e[]{gel.e.b, gel.e.c, gel.e.b, gel.e.i, gel.e.h, gel.e.i, gel.e.h, gel.e.c},
         new gel.e[]{gel.e.a, gel.e.c, gel.e.a, gel.e.i, gel.e.g, gel.e.i, gel.e.g, gel.e.c},
         new gel.e[]{gel.e.a, gel.e.d, gel.e.a, gel.e.j, gel.e.g, gel.e.j, gel.e.g, gel.e.d}
      ),
      f(
         new je[]{je.a, je.b, je.c, je.d},
         0.6F,
         true,
         new gel.e[]{gel.e.g, gel.e.d, gel.e.g, gel.e.j, gel.e.a, gel.e.j, gel.e.a, gel.e.d},
         new gel.e[]{gel.e.g, gel.e.c, gel.e.g, gel.e.i, gel.e.a, gel.e.i, gel.e.a, gel.e.c},
         new gel.e[]{gel.e.h, gel.e.c, gel.e.h, gel.e.i, gel.e.b, gel.e.i, gel.e.b, gel.e.c},
         new gel.e[]{gel.e.h, gel.e.d, gel.e.h, gel.e.j, gel.e.b, gel.e.j, gel.e.b, gel.e.d}
      );
      ...
      final gel.e[] k;
      final gel.e[] l;
      private static final gel.a[] m = ac.a(new gel.a[6], $$0 -> {
         $$0[je.a.d()] = a;
         $$0[je.b.d()] = b;
         $$0[je.c.d()] = c;
         $$0[je.d.d()] = d;
      ...
      private a(final je[] $$0, final float $$1, final boolean $$2, final gel.e[] $$3, final gel.e[] $$4, final gel.e[] $$5, final gel.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(dbc $$0, dsd $$1, iz $$2, je $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dsd $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.p($$0, $$9) || $$23.b($$0, $$9) == 0;
         dsd $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.p($$0, $$9) || $$25.b($$0, $$9) == 0;
         dsd $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.p($$0, $$9) || $$27.b($$0, $$9) == 0;
         dsd $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gel.c[] k = ac.a(new gel.c[6], $$0 -> {
         $$0[je.a.d()] = a;
         $$0[je.b.d()] = b;
         $$0[je.c.d()] = c;
         $$0[je.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dsd $$0, dbc $$1, iz $$2) {
         long $$3 = $$2.a();
         if (this.a) {
