...
public class dmb extends dfm {
   public static final MapCodec<dmb> c = b(dmb::new);
   public static final dtr d = dtq.r;
   private static final Map<dca, List<dmb.a>> h = new WeakHashMap<>();
   ...
   private static boolean a(dcu $$0, jd $$1, boolean $$2) {
      List<dmb.a> $$3 = h.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new dmb.a($$1.i(), $$0.Z()));
      }
