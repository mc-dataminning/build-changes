...
public class dmb {
   ...
   public dmb(cwe $$0, ib $$1, ih $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dme $$0 = this.b.a_(this.e);
      if (!dlx.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == ehw.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dme $$0) {
      return $$0.a(czh.hV) || $$0.a(czh.pg);
   }

   private static boolean a(dme $$0, dme $$1) {
      if ($$0.a(czh.pg) && $$1.a(czh.hV)) {
         return false;
      } else {
         return $$0.a(czh.hV) && $$1.a(czh.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(ib $$0, ih $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dlx.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dme $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dlx.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dlx.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
