...
public class vy extends SimpleChannelInboundHandler<zl<?>> {
   ...
   private static final wm<aix> j = aiw.b;
   private final zm k;
   private volatile boolean l = true;
   private final Queue<Consumer<vy>> m = Queues.newConcurrentLinkedQueue();
   private Channel n;
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               ...
               if ($$2) {
                  ...
                  if (this.g() == zm.b) {
                     zl<?> $$7 = (zl<?>)(this.l ? new aje($$3) : new zu($$3));
   ...
   public void a(String $$0, int $$1, ajz $$2) {
      this.a($$0, $$1, akf.b, akf.d, $$2, ait.a);
   }

   public void a(String $$0, int $$1, aiz $$2) {
      this.a($$0, $$1, ajg.b, ajg.d, $$2, ait.b);
   }

   public <S extends wq, C extends vv> void a(String $$0, int $$1, wm<S> $$2, wm<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? ait.c : ait.b);
   }

   private <S extends wq, C extends vv> void a(String $$0, int $$1, wm<S> $$2, wm<C> $$3, C $$4, ait $$5) {
      if ($$2.a() != $$3.a()) {
         throw new IllegalStateException("Mismatched initial protocols");
      } else {
         this.p = $$4;
         this.a((Consumer<vy>)($$6 -> {
            this.a($$3, $$4);
            $$6.b(new aiu(ab.b().e(), $$0, $$1, $$5), null, true);
            this.a($$2);
         }));
      }
   }
   ...
   protected void c() {
      this.x = azf.h(0.75F, (float)this.v, this.x);
      this.w = azf.h(0.75F, (float)this.u, this.w);
      this.v = 0;
      this.u = 0;
   }
   ...
   public static vy a(InetSocketAddress $$0, boolean $$1, @Nullable bmr $$2) {
      vy $$3 = new vy(zm.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static ChannelFuture a(InetSocketAddress $$0, boolean $$1, final vy $$2) {
   ...
   public static void a(ChannelPipeline $$0, zm $$1, boolean $$2, @Nullable vr $$3) {
      zm $$4 = $$1.a();
      boolean $$5 = $$1 == zm.a;
      boolean $$6 = $$4 == zm.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wi<aix>(j) : new wt.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wj<aix>(j) : new wt.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new wf() : new wy());
   }

   private static ChannelInboundHandler a(@Nullable vr $$0, boolean $$1) {
      if (!$$1) {
         return new wx($$0);
      } else {
         return (ChannelInboundHandler)($$0 != null ? new wd($$0) : new we());
      }
   }
   ...
   public static vy a(SocketAddress $$0) {
      final vy $$1 = new vy(zm.b);
   ...
   public void a(Cipher $$0, Cipher $$1) {
      this.s = true;
      this.n.pipeline().addBefore("splitter", "decrypt", new vt($$0));
      this.n.pipeline().addBefore("prepender", "encrypt", new vu($$1));
   }
   ...
   public void a(int $$0, boolean $$1) {
      if ($$0 >= 0) {
         if (this.n.pipeline().get("decompress") instanceof vw $$2) {
            $$2.a($$0, $$1);
         } else {
            this.n.pipeline().addAfter("splitter", "decompress", new vw($$0, $$1));
         }

         if (this.n.pipeline().get("compress") instanceof vx $$3) {
            $$3.a($$0);
         } else {
            this.n.pipeline().addAfter("prepender", "compress", new vx($$0));
         }
      } else {
         if (this.n.pipeline().get("decompress") instanceof vw) {
            this.n.pipeline().remove("decompress");
         }

         if (this.n.pipeline().get("compress") instanceof vx) {
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            if ($$1 != null) {
               wa $$2 = Objects.requireNonNullElseGet(this.l(), () -> new wa(xe.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
