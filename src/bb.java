...
public class bb extends dz<bb.a> {
   ...
   public void a(are $$0, aku<dgj> $$1, aku<dgj> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static record a(Optional<bi> b, Optional<aku<dgj>> c, Optional<aku<dgj>> d) implements dz.a {
