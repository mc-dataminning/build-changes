...
public class bb extends dz<bb.a> {
   ...
   public void a(are $$0, aku<dgi> $$1, aku<dgi> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static record a(Optional<bi> b, Optional<aku<dgi>> c, Optional<aku<dgi>> d) implements dz.a {
