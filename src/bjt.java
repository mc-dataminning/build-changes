...
public class bjt {
   ...
   private JsonElement a(List<Pair<dof, bkd<bjv>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bkd)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dof, bkd<bjv>> $$3 : $$0) {
         bkd<bjv> $$4 = (bkd<bjv>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dof)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bkb> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bjj.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bjr $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bjz $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bjz.b $$3 = (bjz.b)$$1x.getFirst();
         bjz.a $$4 = (bjz.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bjw> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bjw>, ToDoubleFunction<bjw>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bjw::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bjw::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bjw::c));
      return $$1;
   }
}
