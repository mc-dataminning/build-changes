...
public class bne extends bkx<cbh> {
   ...
   public boolean a(akq $$0, cbh $$1, long $$2) {
      return this.a($$0, $$1) && this.i > 0 && $$1.dN().c(bsh.q).isPresent();
   }

   public void b(akq $$0, cbh $$1, long $$2) {
      super.d($$0, $$1, $$2);
      this.d($$1);
      this.g = 0;
      this.h = 0;
   ...
   public void c(akq $$0, cbh $$1, long $$2) {
      bjg $$3 = this.d($$1);
      this.a($$3, $$1);
      if (!this.f.isEmpty()) {
         this.e($$1);
   ...
   public void d(akq $$0, cbh $$1, long $$2) {
      super.b($$0, $$1, $$2);
      $$1.dN().b(bsh.q);
      c($$1);
      this.e = null;
