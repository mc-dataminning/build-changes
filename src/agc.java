...
public class agc {
   ...
   private static final Object2IntMap<Class<? extends blf>> b = new Object2IntOpenHashMap();
   private static final int c = 254;
   private final blf d;
   private final Int2ObjectMap<agc.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   public static <T> afz<T> a(Class<? extends blf> $$0, aga<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> void c(afz<T> $$0, T $$1) {
      agc.a<T> $$2 = new agc.a<>($$0, $$1);
      this.f.writeLock().lock();
      this.e.put($$0.a(), $$2);
      this.f.writeLock().unlock();
   }

   public <T> boolean a(afz<T> $$0) {
      return this.e.containsKey($$0.a());
   }

   private <T> agc.a<T> c(afz<T> $$0) {
      this.f.readLock().lock();

      agc.a<T> $$1;
      try {
         $$1 = (agc.a<T>)this.e.get($$0.a());
   ...
   public <T> T b(afz<T> $$0) {
      return this.c($$0).b();
   }

   public <T> void b(afz<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(afz<T> $$0, T $$1, boolean $$2) {
      agc.a<T> $$3 = this.c($$0);
   ...
   public void a(List<agc.b<?>> $$0) {
      this.f.writeLock().lock();

      try {
         for (agc.b<?> $$1 : $$0) {
            agc.a<?> $$2 = (agc.a<?>)this.e.get($$1.a);
            if ($$2 != null) {
               this.a($$2, $$1);
               this.d.a($$2.a());
            }
   ...
   private <T> void a(agc.a<T> $$0, agc.b<?> $$1) {
   ...
   public static class a<T> {
      ...
      public agc.b<T> e() {
         return agc.b.a(this.a, this.b);
      }
   }

   public static record b<T>(int a, aga<T> b, T c) {

      public static <T> agc.b<T> a(afz<T> $$0, T $$1) {
         aga<T> $$2 = $$0.b();
         return new agc.b<>($$0.a(), $$2, $$2.a($$1));
      }
      ...
      public static agc.b<?> a(ue $$0, int $$1) {
         int $$2 = $$0.n();
         aga<?> $$3 = agb.a($$2);
         if ($$3 == null) {
      ...
      private static <T> agc.b<T> a(ue $$0, int $$1, aga<T> $$2) {
         return new agc.b<>($$1, $$2, $$2.a($$0));
      }
   }
}
