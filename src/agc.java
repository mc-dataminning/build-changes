public class agc implements zv<ach> {
   public static final zm<wz, agc> a = zv.a(agc::a, agc::new);
   ...
   public agc(ji<avy> $$0, awa $$1, double $$2, double $$3, double $$4, float $$5, float $$6, long $$7) {
      this.c = $$0;
      this.d = $$1;
      this.e = (int)($$2 * 8.0);
      this.f = (int)($$3 * 8.0);
