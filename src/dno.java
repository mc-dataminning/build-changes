...
public class dno<T> implements dnw<T> {
   private final io<T> a;
   private final avf<T> b;
   private final dnx<T> c;
   private final int d;

   public dno(io<T> $$0, int $$1, dnx<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dno(io<T> $$0, int $$1, dnx<T> $$2) {
      this($$0, $$1, $$2, avf.c(1 << $$1));
   }

   private dno(io<T> $$0, int $$1, dnx<T> $$2, avf<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dnw<T> c() {
      return new dno<>(this.a, this.d, this.c, this.b.c());
   }
}
