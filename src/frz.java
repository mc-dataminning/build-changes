...
public class frz extends fro {
   private static final ftd d = new ftd(ale.b("widget/text_field"), ale.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayw> D = ($$0x, $$1x) -> ayw.forward($$0x, xt.a);
   @Nullable
   private ww E;
   private long F = af.c();

   public frz(fra $$0, int $$1, int $$2, ww $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public frz(fra $$0, int $$1, int $$2, int $$3, int $$4, ww $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public frz(fra $$0, int $$1, int $$2, int $$3, int $$4, @Nullable frz $$5, ww $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   protected xk d() {
      ww $$0 = this.B();
      return ww.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, fxi.t());
   }
   ...
   public void b(frc $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            ale $$4 = d.a(this.E(), this.aI_());
            $$0.a(gpn::H, $$4, this.F(), this.G(), this.A(), this.y());
         }
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gpn.L(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
