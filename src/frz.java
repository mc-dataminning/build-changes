...
public class frz extends frw {
   private static final alj a = alj.b("textures/misc/credits_vignette.png");
   private static final Logger b = LogUtils.getLogger();
   private static final xj c = xj.b("============").a(n.p);
   private static final String d = "           ";
   private static final String s = "" + n.p + n.q + n.k + n.l;
   private static final float u = 5.0F;
   private static final float v = 15.0F;
   private static final alj w = alj.b("texts/end.txt");
   private static final alj x = alj.b("texts/credits.json");
   private static final alj y = alj.b("texts/postcredits.txt");
   ...
   private int J;
   private final fmu K = new fmu(false);

   public frz(boolean $$0, Runnable $$1) {
      super(fjv.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
      ...
      for (JsonElement $$2 : azc.b($$0)) {
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(xj.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(xj.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.C.addAll(this.m.h.c(xj.b($$0), 256));
   }

   private void a(xj $$0, boolean $$1) {
      if ($$1) {
   ...
   private void c(flq $$0) {
      $$0.a(gjq::C, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
