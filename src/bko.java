...
public class bko extends bki {
   ...
   public bko(crs $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bkm.J, $$0);
      this.e($$1, $$2, $$3);
   ...
   public bko(bkm<? extends bko> $$0, crs $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null && (this.k.N_() || this.k.ev())) {
         this.k = null;
      }

      if (this.k != null) {
         eji $$0 = new eji(this.k.dq() - this.dq(), this.k.ds() + (double)this.k.cH() / 2.0 - this.ds(), this.k.dw() - this.dw());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
      ...
      float $$3 = 0.98F;
      if (this.aA()) {
         $$3 = this.dL().a_(this.aG()).b().i() * 0.98F;
      }
   ...
   private void t() {
      ...
      if (this.dL() instanceof ama) {
         for (bko $$1 : this.dL().a(dku.a(bko.class), this.cG().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(ama $$0, eji $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bko($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(ama $$0, eji $$1, int $$2) {
      ejd $$3 = ejd.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<bko> $$5 = $$0.a(dku.a(bko.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bko $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bko $$0) {
      return $$0 != this && a($$0, this.ah(), this.i);
   }

   private static boolean a(bko $$0, int $$1, int $$2) {
      return !$$0.dG() && ($$0.ah() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bko $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cdm $$0, int $$1) {
      Entry<bkn, clb> $$2 = cpo.a(cpq.L, $$0, clb::j);
      if ($$2 != null) {
         clb $$3 = $$2.getValue();
