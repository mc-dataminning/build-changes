...
public class bpp extends bpt {
   ...
   public static bpp a(float $$0, float $$1, float $$2, float $$3) {
      return new bpp($$0, $$1, $$2, $$3);
   }

   private bpp(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(ayv $$0, float $$1, float $$2, float $$3, float $$4) {
      return ayn.a(ayn.c($$0, $$1, $$2), $$3, $$4);
   }
