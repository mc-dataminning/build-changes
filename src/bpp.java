...
public abstract class bpp extends bqw {
   private static final aiy<Boolean> bX = ajc.a(bpp.class, aja.k);
   ...
   protected bpp(bqb<? extends bpp> $$0, cyx $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bpp a(aps var1, bpp var2);
   ...
   protected void k() {
      if (!this.p_() && this.bO() && this.cZ() instanceof clq $$0 && !$$0.b((bpv)this)) {
         this.ac();
      }
   }
