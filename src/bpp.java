...
public interface bpp<T, F> {
   ...
   public static final class a implements bpp<bpp.b, Runnable> {
   ...
   public static final class c<T> implements bpp<T, T> {
