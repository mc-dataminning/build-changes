...
public final class edg {
   ...
   private final edf f;
   private final edf g;
   private final Map<aku<esc.a>, esc> h;
   private final Map<akv, edf> i;

   public static edg a(js.a $$0, aku<ecx> $$1, long $$2) {
      ...
      class a implements ecl.f {
         ...
         private ecl a(ecl $$0) {
            if ($$0 instanceof erz $$1) {
               azh $$2 = $$3 ? this.a(0L) : edg.this.a.a(akv.b("terrain"));
               return $$1.a($$2);
            } else {
