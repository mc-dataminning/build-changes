...
public class edg implements edi {
   public static final Codec<edg> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bpi.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bpi.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bpi.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bpg.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bpg.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public edg(int $$0, bpi $$1, bpi $$2, int $$3, int $$4, bpi $$5, bpg $$6, bpg $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
