...
public class ehc extends egw<ejb> {
   private static final jm[] a = jm.values();

   public ehc(Codec<ejb> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egy<ejb> $$0) {
      ejb $$1 = $$0.f();
      bam $$2 = $$0.d();
      jh $$3 = $$0.e();
      dig $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      eep $$9 = new eep(new edr($$4.D()));
      eta $$10 = eta.a($$9, -4, 1.0);
      ...
      for (jh $$33 : jh.c($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<jh, Integer> $$37 : $$7) {
            $$35 += bae.f($$33.j((kl)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (jh $$38 : $$11) {
            $$36 += bae.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, dko.a.m(), $$32);
      ...
      for (jh $$44 : $$31) {
         ...
         for (jm $$46 : a) {
            ...
            dxv $$48 = $$4.a_($$47);
            if ($$45.b(dyl.D)) {
               $$45 = $$45.b(dyl.D, Boolean.valueOf($$48.y().b()));
            }
