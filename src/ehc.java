...
public class ehc extends egp<eim> {
   public ehc(Codec<eim> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egr<eim> $$0) {
      jh $$1 = $$0.e();
      dhx $$2 = $$0.b();
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? azu.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(bac $$0, dha $$1, int $$2, int $$3, jh $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, jh $$2, dha $$3, boolean $$4, double $$5, jh $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dha $$0, jh $$1) {
      if ($$0.a_($$1.d()).a(dkf.ea)) {
         this.a($$0, $$1.d(), dkf.a.m());
      }
   }

   private void a(dha $$0, bac $$1, jh $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dxo $$13) {
   ...
   private void a(jh $$0, dha $$1, bac $$2, int $$3, int $$4, boolean $$5, boolean $$6, dxo $$7) {
      dxo $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dkf.ec) || $$8.a(dkf.eb) || $$8.a(dkf.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dkf.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dkf.ec.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, jh $$2, int $$3, bac $$4) {
      float $$5 = 10.0F * azu.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(bac $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(bac $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dxo $$0) {
      return $$0.a(dkf.ja) || $$0.a(dkf.ec) || $$0.a(dkf.ny);
   }
   ...
   private void a(dha $$0, jh $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dkf.ea)) {
                  if (this.a((dge)$$0, $$10)) {
                     this.a($$0, $$10, dkf.a.m());
                     this.a($$0, $$10.d(), dkf.a.m());
                  } else if (c($$11)) {
                     dxo[] $$12 = new dxo[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
