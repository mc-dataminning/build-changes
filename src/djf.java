...
public interface djf<T extends Enum<T>> {
   int z_ = 4;

   Optional<dvj> k_(dvj var1);

   float av_();

   default void a_(dvj $$0, arn $$1, jh $$2, azs $$3) {
      float $$4 = 0.05688889F;
      if ($$3.i() < 0.05688889F) {
   ...
   default Optional<dvj> c(dvj $$0, arn $$1, jh $$2, azs $$3) {
      ...
      for (jh $$7 : jh.a($$2, 4, 4, 4)) {
         ...
         if (!$$7.equals($$2) && $$1.a_($$7).b() instanceof djf<?> $$9) {
            Enum<?> $$10 = $$9.c();
