...
public class uz implements uy {
   ...
   private static final ww v = ww.b("<...>").a(n.h);
   private static final ww w = ww.b("b").a(i);
   private static final ww x = ww.b("s").a(i);
   private static final ww y = ww.b("I").a(i);
   private static final ww z = ww.b("L").a(i);
   private static final ww A = ww.b("f").a(i);
   private static final ww B = ww.b("d").a(i);
   private static final ww C = ww.b("B").a(i);
   private final String D;
   private int E;
   private int F;
   private final xk G = ww.i();
   ...
   public void a(us $$0) {
      ...
      ww $$3 = ww.b($$1.substring(1, $$1.length() - 1)).a(g);
      this.G.f($$2).b($$3).f($$2);
   }

   @Override
   public void a(tv $$0) {
      this.G.b(ww.b(String.valueOf($$0.l())).a(h)).b(w);
   }

   @Override
   public void a(up $$0) {
      this.G.b(ww.b(String.valueOf($$0.l())).a(h)).b(x);
   }

   @Override
   public void a(uc $$0) {
      this.G.b(ww.b(String.valueOf($$0.l())).a(h));
   }

   @Override
   public void a(uf $$0) {
      this.G.b(ww.b(String.valueOf($$0.l())).a(h)).b(z);
   }

   @Override
   public void a(ua $$0) {
      this.G.b(ww.b(String.valueOf($$0.k())).a(h)).b(A);
   }

   @Override
   public void a(ty $$0) {
      this.G.b(ww.b(String.valueOf($$0.j())).a(h)).b(B);
   }
   ...
   public void a(tu $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         xk $$3 = ww.b(String.valueOf($$1[$$2])).a(h);
         this.G.f(" ").b($$3).b(C);
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
   ...
   public void a(ub $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         this.G.f(" ").b(ww.b(String.valueOf($$1[$$2])).a(h));
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
      }
   ...
   public void a(ue $$0) {
      ...
      for (int $$2 = 0; $$2 < $$1.length && $$2 < 128; $$2++) {
         ww $$3 = ww.b(String.valueOf($$1[$$2])).a(h);
         this.G.f(" ").b($$3).b(z);
         if ($$2 != $$1.length - 1) {
            this.G.f(s);
         }
   ...
   protected static ww a(String $$0) {
      if (j.matcher($$0).matches()) {
         return ww.b($$0).a(f);
      } else {
         String $$1 = us.b($$0);
         String $$2 = $$1.substring(0, 1);
         ww $$3 = ww.b($$1.substring(1, $$1.length() - 1)).a(f);
         return ww.b($$2).b($$3).f($$2);
      }
   }
