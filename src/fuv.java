...
public class fuv extends fty {
   public static final int a = 16;
   public static final int b = 36;
   public static final int c = 30;
   private static final int y = 256;
   private static final int z = 256;
   public static final fuv.a d = new fuv.a(List.of());
   ...
   protected void l() {
      this.c(fof.a(xu.d, $$0 -> this.aP_()).a(this.n / 2 - 100, 196, 200, 20).a());
   }

   protected void E() {
      int $$0 = (this.n - 192) / 2;
      int $$1 = 2;
      this.F = this.c(new fvw($$0 + 116, 159, true, $$0x -> this.J(), this.H));
      this.G = this.c(new fvw($$0 + 43, 159, false, $$0x -> this.G(), this.H));
      this.L();
   }
   ...
   public void b(fns $$0, int $$1, int $$2, float $$3) {
      this.b($$0);
      $$0.a(glv::C, s, (this.n - 192) / 2, 2, 0.0F, 0.0F, 192, 192, 256, 256);
   }
   ...
   public static record a(List<xv> a) {
      ...
      @Nullable
      public static fuv.a a(cxp $$0) {
         boolean $$1 = fmg.Q().aU();
         dax $$2 = $$0.a(ku.T);
         if ($$2 != null) {
            return new fuv.a($$2.a($$1));
         } else {
            daw $$3 = $$0.a(ku.S);
            return $$3 != null ? new fuv.a($$3.a($$1).map(xv::b).toList()) : null;
         }
      }
