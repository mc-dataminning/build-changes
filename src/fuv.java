...
public class fuv<T extends chk> extends fuc<T> {
   private final fxc a;
   private final fxc b;
   private final fxc f;
   private final fxc g;
   ...
   public static fxi a(fxg $$0) {
      ...
      $$2.a(
         ...
         fxe.a(0.0F, 7.0F, -6.0F)
      );
      $$2.a("body", fxh.c().a(29, 0).a(-6.0F, -10.0F, -7.0F, 12.0F, 18.0F, 10.0F, $$0), fxe.a(0.0F, 5.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("right_chest", fxh.c().a(45, 28).a(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, $$0), fxe.a(-8.5F, 3.0F, 3.0F, 0.0F, (float) (Math.PI / 2), 0.0F));
      $$2.a("left_chest", fxh.c().a(45, 41).a(-3.0F, 0.0F, 0.0F, 8.0F, 8.0F, 3.0F, $$0), fxe.a(5.5F, 3.0F, 3.0F, 0.0F, (float) (Math.PI / 2), 0.0F));
      int $$3 = 4;
      int $$4 = 14;
      fxh $$5 = fxh.c().a(29, 29).a(-2.0F, 0.0F, -2.0F, 4.0F, 14.0F, 4.0F, $$0);
      $$2.a("right_hind_leg", $$5, fxe.a(-3.5F, 10.0F, 6.0F));
      $$2.a("left_hind_leg", $$5, fxe.a(3.5F, 10.0F, 6.0F));
      $$2.a("right_front_leg", $$5, fxe.a(-3.5F, 10.0F, -5.0F));
      $$2.a("left_front_leg", $$5, fxe.a(3.5F, 10.0F, -5.0F));
      return fxi.a($$1, 128, 64);
   }
