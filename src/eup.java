...
public class eup implements eus {
   private static final aez d = new aez("toast/advancement");
   ...
   public eus.a a(erz $$0, eut $$1, long $$2) {
      ...
      if ($$3 != null) {
         ...
         if ($$4.size() == 1) {
            ...
            float $$7 = 300.0F;
            if ($$2 < 1500L) {
               int $$8 = asb.d(asb.a((float)(1500L - $$2) / 300.0F, 0.0F, 1.0F) * 255.0F) << 24 | 67108864;
               $$0.a($$1.b().h, $$3.e().c(), 30, 11, $$5 | $$8, false);
            } else {
               int $$9 = asb.d(asb.a((float)($$2 - 1500L) / 300.0F, 0.0F, 1.0F) * 252.0F) << 24 | 67108864;
         ...
         if (!this.f && $$2 > 0L) {
            this.f = true;
            if ($$3.e() == ar.b) {
               $$1.b().ai().a(gcd.a(apg.yA, 1.0F, 1.0F));
            }
         }
