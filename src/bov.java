...
public class bov {
   ...
   private static void a(bpd $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(boy $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dxl, bph<box>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bph)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ad.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dxl, bph<box>> $$3 : $$0) {
         bph<box> $$4 = (bph<box>)$$3.getSecond();
         JsonObject $$5 = ad.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dxl)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bpf> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bok.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bot $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bov::a));
      $$1.add("chunksWritten", this.a($$0.m(), bov::a));
      return $$1;
   }

   private JsonElement a(bpa.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bot $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bov::a));
      $$1.add("received", this.a($$0.k(), bov::a));
      return $$1;
   }

   private <T> JsonElement a(bpc<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<boz> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<boz>, ToDoubleFunction<boz>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, boz::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, boz::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, boz::c));
      return $$1;
   }
}
