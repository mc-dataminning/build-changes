...
public interface bov<T, F> {
   ...
   public static final class a implements bov<bov.b, Runnable> {
   ...
   public static final class c<T> implements bov<T, T> {
