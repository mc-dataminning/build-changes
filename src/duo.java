...
public class duo extends dur {
   public static final Codec<duo> a = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(duo::new, $$0 -> $$0.d).codec();
   ...
   public void a(dur.a $$0) {
      ...
      if (!($$1.i() >= this.d)) {
         ...
         if (!$$5.isEmpty()) {
            ...
            if (!$$6.isEmpty()) {
               $$0.a($$6.get(), cvc.pe.o().a(cuu.b, b));
               $$0.a().a($$6.get(), dff.H).ifPresent($$1x -> {
                  int $$2x = 2 + $$1.a(2);

                  for (int $$3x = 0; $$3x < $$2x; $$3x++) {
                     rz $$4x = new rz();
                     $$4x.a("id", jy.h.b(bku.h).toString());
