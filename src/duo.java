...
public class duo implements dty {
   public static final Codec<duo> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dyk.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               asw.b(ke.f).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               dvz.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               dvz.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dpx.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, duo::new)
   );
   ...
   public duo(ih<dyk> $$0, int $$1, int $$2, asw<cwq> $$3, dvz $$4, int $$5, int $$6, int $$7, int $$8, dvz $$9, int $$10, int $$11, dpx $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
