...
public interface als {
   als a = new als() {
      ...
      @Override
      public void a(Consumer<crh> $$0) {
      }
   };

   static als a(crh $$0, int $$1) {
      return new als.a($$0, $$1);
   }

   static void a(als $$0, als $$1, Consumer<crh> $$2, Consumer<crh> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof als.a $$4 && $$1 instanceof als.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new crh($$10, $$11));
                     } else {
                        $$3.accept(new crh($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(crh b, int c) implements als {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(als.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return als.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
