...
public class ekv {
   ...
   static class a implements ekv.i {
      @Override
      public boolean a(ekv.v $$0) {
         return $$0.c[je.f.d()] && !$$0.b[je.f.d()].d;
      }

      @Override
      public ekv.r a(je $$0, ekv.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[je.f.d()].d = true;
         return new ekv.k($$0, $$1);
      }
   }

   static class b implements ekv.i {
      @Override
      public boolean a(ekv.v $$0) {
      ...
      public ekv.r a(je $$0, ekv.v $$1, azh $$2) {
         ...
         return new ekv.l($$0, $$1);
      }
   }

   static class c implements ekv.i {
      @Override
      public boolean a(ekv.v $$0) {
      ...
      public ekv.r a(je $$0, ekv.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[je.b.d()].d = true;
         return new ekv.m($$0, $$1);
      }
   }

   static class d implements ekv.i {
      @Override
      public boolean a(ekv.v $$0) {
      ...
      public ekv.r a(je $$0, ekv.v $$1, azh $$2) {
         ...
         return new ekv.n($$0, $$1);
      }
   }

   static class e implements ekv.i {
      @Override
      public boolean a(ekv.v $$0) {
      ...
      public ekv.r a(je $$0, ekv.v $$1, azh $$2) {
         ...
         $$3.d = true;
         $$3.b[je.c.d()].d = true;
         return new ekv.o($$0, $$3);
      }
   }

   static class f implements ekv.i {
      @Override
      public boolean a(ekv.v $$0) {
         return true;
      }
      ...
      public ekv.r a(je $$0, ekv.v $$1, azh $$2) {
         $$1.d = true;
         return new ekv.s($$0, $$1, $$2);
      }
   }

   static class g implements ekv.i {
      @Override
      public boolean a(ekv.v $$0) {
      ...
      public ekv.r a(je $$0, ekv.v $$1, azh $$2) {
         $$1.d = true;
         return new ekv.t($$0, $$1);
      }
   }

   public static class h extends ekv.r {
      ...
      private ekv.v G;
      private ekv.v H;
      private final List<ekv.r> I = Lists.newArrayList();

      public h(azh $$0, int $$1, int $$2, je $$3) {
         super(ejd.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ekv.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ekv.p($$3, this.G));
         this.I.add(new ekv.j($$3, this.H));
         List<ekv.i> $$5 = Lists.newArrayList();
         $$5.add(new ekv.b());
         $$5.add(new ekv.d());
         $$5.add(new ekv.e());
         $$5.add(new ekv.a());
         ...
         eie $$10 = eie.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eie $$11 = eie.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eie $$12 = eie.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ekv.u($$3, $$10, $$13++));
         this.I.add(new ekv.u($$3, $$11, $$13++));
         this.I.add(new ekv.q($$3, $$12));
      }
      ...
      private List<ekv.v> b(azh $$0) {
         ekv.v[] $$1 = new ekv.v[75];
         ...
         ekv.v $$23 = new ekv.v(1003);
         ekv.v $$24 = new ekv.v(1001);
         ekv.v $$25 = new ekv.v(1002);
         $$1[v].a(je.b, $$23);
         $$1[w].a(je.d, $$24);
         $$1[x].a(je.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ekv.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dcv $$2, azh $$3, eie $$4) {
         int $$5 = 24;
      ...
      private void a(dcv $$0, azh $$1, eie $$2) {
      ...
      private void b(dcv $$0, azh $$1, eie $$2) {
      ...
      private void c(dcv $$0, azh $$1, eie $$2) {
      ...
      private void d(dcv $$0, azh $$1, eie $$2) {
      ...
      private void e(dcv $$0, azh $$1, eie $$2) {
      ...
      private void f(dcv $$0, azh $$1, eie $$2) {
   ...
   interface i {
      boolean a(ekv.v var1);

      ekv.r a(je var1, ekv.v var2, azh var3);
   }

   public static class j extends ekv.r {
      public j(je $$0, ekv.v $$1) {
         super(ejd.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dcv $$0, dct $$1, dub $$2, azh $$3, eie $$4, dbh $$5, iz $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dfd.ch.o(), dfd.ch.o(), false);
   ...
   public static class k extends ekv.r {
      public k(je $$0, ekv.v $$1) {
         super(ejd.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ekv.r {
      public l(je $$0, ekv.v $$1) {
         super(ejd.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ekv.r {
      public m(je $$0, ekv.v $$1) {
         super(ejd.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ekv.r {
      public n(je $$0, ekv.v $$1) {
         super(ejd.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ekv.r {
      public o(je $$0, ekv.v $$1) {
         super(ejd.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ekv.r {
      public p(je $$0, ekv.v $$1) {
         super(ejd.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ekv.r {
      public q(je $$0, eie $$1) {
         super(ejd.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eiq {
      protected static final dse b = dfd.hZ.o();
      protected static final dse c = dfd.ia.o();
      protected static final dse d = dfd.ib.o();
      protected static final dse h = c;
      protected static final dse i = dfd.ii.o();
      protected static final boolean j = true;
      protected static final dse k = dfd.G.o();
      protected static final Set<dfb> l = ImmutableSet.builder().add(dfd.dO).add(dfd.iC).add(dfd.mW).add(k.b()).build();
      ...
      public r(ejd $$0, je $$1, int $$2, eie $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ejd $$0, int $$1, je $$2, ekv.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eie a(je $$0, ekv.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eie $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dcv $$0, eie $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dse $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dcv $$0, eie $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dcv $$0, eie $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dse $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eie $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dcv $$0, eie $$1, int $$2, int $$3, int $$4) {
         iz $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cju $$6 = btc.D.a((dca)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eR());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dp()), btv.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ekv.r {
      private int a;

      public s(je $$0, ekv.v $$1, azh $$2) {
         super(ejd.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ekv.r {
      public t(je $$0, ekv.v $$1) {
         super(ejd.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ekv.r {
      private int a;

      public u(je $$0, eie $$1, int $$2) {
         super(ejd.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
