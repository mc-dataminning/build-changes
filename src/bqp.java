...
public abstract class bqp<E extends box> implements bqq<E> {
   public static final int a = 60;
   protected final Map<bya<?>, byb> b;
   private bqp.a c = bqp.a.a;
   private long d;
   private final int e;
   private final int f;

   public bqp(Map<bya<?>, byb> $$0) {
      this($$0, 60);
   }

   public bqp(Map<bya<?>, byb> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public bqp(Map<bya<?>, byb> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<bya<?>, byb> $$1 : this.b.entrySet()) {
         bya<?> $$2 = $$1.getKey();
         byb $$3 = $$1.getValue();
         if (!$$0.dM().a($$2, $$3)) {
            return false;
