...
public class css extends cul {
   ...
   public bqs<cuq> a(dcw $$0, cmx $$1, bqq $$2) {
      List<bsn> $$3 = $$0.a(bsn.class, $$1.cL().g(2.0), $$0x -> $$0x != null && $$0x.bE() && $$0x.q() instanceof cia);
      cuq $$4 = $$1.b($$2);
      if (!$$3.isEmpty()) {
         bsn $$5 = $$3.get(0);
         $$5.a($$5.g() - 0.5F);
         $$0.a(null, $$1.du(), $$1.dw(), $$1.dA(), avp.cD, avq.g, 1.0F, 1.0F);
         $$0.a($$1, dxz.y, $$1.dn());
         ...
         if ($$7.c() == ewy.a.a) {
            ...
            if ($$7.c() == ewy.a.b) {
               ...
               if ($$0.b_($$8).a(awk.a)) {
                  $$0.a($$1, $$1.du(), $$1.dw(), $$1.dA(), avp.cC, avq.g, 1.0F, 1.0F);
                  $$0.a($$1, dxz.y, $$8);
