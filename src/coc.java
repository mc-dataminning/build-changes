...
public class coc {
   ...
   public static OptionalInt a(ard $$0, ji $$1, are $$2) {
      if (a($$0, $$1)) {
         ...
         if ($$3.stream().anyMatch($$0x -> $$0x.ac().map(coc::d).orElse(false))) {
            return OptionalInt.empty();
         } else {
            Optional<coc> $$4 = $$3.stream().flatMap($$0x -> $$0x.ac().stream()).max(Comparator.comparingInt(coc::c));
            if ($$4.isPresent()) {
               coc $$5 = $$4.get();
               $$5.e();
   ...
   private static boolean a(ard $$0, ji $$1) {
      faw $$2 = faw.a(fbb.b($$1), 48.0, 48.0, 48.0);
      return !$$0.a(coa.class, $$2).isEmpty();
   }
