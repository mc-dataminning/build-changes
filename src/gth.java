...
public class gth {
   ...
   public static class a extends Thread {
      ...
      public a(gth.b $$0) throws IOException {
         super("LanServerDetector #" + gth.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gth.b));
   ...
   public static class b {
      private final List<gtg> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gtg> a() {
         if (this.b) {
            List<gtg> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
