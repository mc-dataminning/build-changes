...
public class fnt extends fnx {
   ...
   private static final IntSupplier f = () -> fgo.Q().m.a().c() ? e : d;
   ...
   public fnt(fgo $$0, aua $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fhz $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(gfh.F(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(gfh.F(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         ...
         GlStateManager._clear(16384, fgo.a);
         $$10 = 1.0F;
      }
   ...
   private void a(fhz $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
   ...
   static class a extends gqe {
      ...
      protected gqe.a b(aue $$0) {
         asu $$1 = fgo.Q().ad();
         atw<InputStream> $$2 = $$1.a(ass.a, fnt.c);
         if ($$2 == null) {
            return new gqe.a(new FileNotFoundException(fnt.c.toString()));
         } else {
            try {
               gqe.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gqe.a(new gsi(true, true), faj.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new gqe.a(var9);
            }
         }
      }
   }
