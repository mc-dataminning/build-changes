...
public abstract class fnt {
   private static final Object2ObjectMap<aew, fnt> a = ac.a(new Object2ObjectArrayMap(), $$0 -> {
      fnt.c $$1 = new fnt.c();
   ...
   public float[] a(float $$0, float $$1) {
      float $$2 = 0.4F;
      float $$3 = arw.b($$0 * (float) (Math.PI * 2)) - 0.0F;
      float $$4 = -0.0F;
      if ($$3 >= -0.4F && $$3 <= 0.4F) {
         float $$5 = ($$3 - -0.0F) / 0.4F * 0.5F + 0.5F;
         float $$6 = 1.0F - (1.0F - arw.a($$5 * (float) Math.PI)) * 0.99F;
         $$6 *= $$6;
