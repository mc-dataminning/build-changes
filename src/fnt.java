...
public class fnt {
   ...
   @Nullable
   private fnt v;
   private final List<fnt> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fnt(fnr $$0, ffw $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
   ...
   private static float a(fgh $$0, List<wz> $$1) {
   ...
   public void a(fhh $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
