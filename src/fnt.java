...
public abstract class fnt<E extends fnt.a<E>> extends fnq {
   ...
   protected void a(fnl $$0) {
      alz $$1 = this.c.s == null ? ftr.h : ftr.j;
      alz $$2 = this.c.s == null ? ftr.i : ftr.k;
      $$0.a(glo::B, $$1, this.D(), this.E() - 2, 0.0F, 0.0F, this.y(), 2, 32, 2);
      $$0.a(glo::B, $$2, this.D(), this.G(), 0.0F, 0.0F, this.y(), 2, 32, 2);
   }

   protected void b(fnl $$0) {
      alz $$1 = this.c.s == null ? n : o;
      $$0.a(glo::B, $$1, this.D(), this.E(), (float)this.F(), (float)(this.G() + (int)this.n()), this.y(), this.w(), 32, 32);
   }
   ...
   protected void f(E $$0) {
      int $$1 = this.g(this.aI_().indexOf($$0));
   ...
   protected void a(frw $$0, E $$1) {
      ...
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(frv.b, xv.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }
