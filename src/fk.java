...
public class fk implements ArgumentType<fk.b> {
   ...
   public static fk.b a(in<dby> $$0, StringReader $$1) throws CommandSyntaxException {
      return (fk.b)fm.b($$0, $$1, true).map($$0x -> new fk.a($$0x.a(), $$0x.b().keySet(), $$0x.c()), $$0x -> new fk.c($$0x.a(), $$0x.b(), $$0x.c()));
   }

   public static Predicate<dpd> a(CommandContext<du> $$0, String $$1) throws CommandSyntaxException {
      return (Predicate<dpd>)$$0.getArgument($$1, fk.b.class);
   }
   ...
   static class a implements fk.b {
      ...
      public a(doz $$0, Set<dqc<?>> $$1, @Nullable tm $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public interface b extends Predicate<dpd> {
      boolean a();
   }

   static class c implements fk.b {
      private final ip<dby> a;
      @Nullable
      private final tm b;
      private final Map<String, String> c;

      c(ip<dby> $$0, Map<String, String> $$1, @Nullable tm $$2) {
         this.a = $$0;
         this.c = $$1;
         this.b = $$2;
      }
      ...
      public boolean a(dpd $$0) {
         ...
         if (!$$1.a(this.a)) {
            ...
            if (this.b == null) {
               ...
               dmf $$5 = $$0.b();
               return $$5 != null && ub.a(this.b, $$5.b($$0.c().H_()), true);
            }
         }
      }
