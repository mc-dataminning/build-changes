...
public class fk implements ga<fk.a> {
   ...
   static final Dynamic2CommandExceptionType b = new Dynamic2CommandExceptionType(($$0, $$1) -> wz.b("argument.message.too_long", $$0, $$1));

   public static fk a() {
      return new fk();
   }

   public static wz a(CommandContext<et> $$0, String $$1) throws CommandSyntaxException {
      fk.a $$2 = (fk.a)$$0.getArgument($$1, fk.a.class);
      return $$2.a((et)$$0.getSource());
   }

   public static void a(CommandContext<et> $$0, String $$1, Consumer<xp> $$2) throws CommandSyntaxException {
   ...
   private static void a(Consumer<xp> $$0, et $$1, xp $$2) {
      MinecraftServer $$3 = $$1.l();
      CompletableFuture<arm> $$4 = a($$1, $$2);
      wz $$5 = $$3.bm().decorate($$1.i(), $$2.d());
      $$1.o().append($$4, $$3x -> {
         xp $$4x = $$2.a($$5).a($$3x.e());
         $$0.accept($$4x);
      });
   ...
   private static void b(Consumer<xp> $$0, et $$1, xp $$2) {
      wu $$3 = $$1.l().bm();
      wz $$4 = $$3.decorate($$1.i(), $$2.d());
      $$0.accept($$2.a($$4));
   }
   ...
   public static record a(String a, fk.b[] b) {
      ...
      public wz a(et $$0, boolean $$1) throws CommandSyntaxException {
         if (this.b.length != 0 && $$1) {
            xn $$2 = wz.b(this.a.substring(0, this.b[0].a()));
            int $$3 = this.b[0].a();
   ...
   public static record b(int a, int b, hi c) {
      public wz a(et $$0) throws CommandSyntaxException {
