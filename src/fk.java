...
public class fk implements ArgumentType<fm> {
   ...
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(tn.c("argument.pos.outofworld"));
   public static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(tn.c("argument.pos.outofbounds"));
   ...
   public static gw a(CommandContext<dt> $$0, String $$1) throws CommandSyntaxException {
      aks $$2 = ((dt)$$0.getSource()).e();
      return a($$0, $$2, $$1);
   }

   public static gw a(CommandContext<dt> $$0, aks $$1, String $$2) throws CommandSyntaxException {
      gw $$3 = b($$0, $$2);
      if (!$$1.A($$3)) {
         throw a.create();
      } else if (!$$1.j($$3)) {
