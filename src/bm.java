...
public record bm(List<ds<buu>> b, Optional<bx> c, Optional<bx> d, Optional<Boolean> e) {
   public static final Codec<bm> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ds.a(mg.aM).listOf().optionalFieldOf("tags", List.of()).forGetter(bm::a),
   ...
   public boolean a(arr $$0, bus $$1) {
      return this.a($$0.y(), $$0.dt(), $$1);
   }

   public boolean a(arq $$0, fei $$1, bus $$2) {
      for (ds<buu> $$3 : this.b) {
         if (!$$3.a($$2.l())) {
            return false;
         }
   ...
   public static class a {
      private final Builder<ds<buu>> a = ImmutableList.builder();
