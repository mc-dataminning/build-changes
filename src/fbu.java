...
public interface fbu {
   ...
   static fbu a(int $$0, String $$1) {
      if ($$0 == 429) {
         ...
         try {
            ...
            String $$3 = ayd.a($$2, "reason", null);
            String $$4 = ayd.a($$2, "errorMsg", null);
            int $$5 = ayd.a($$2, "errorCode", -1);
   ...
   public static record b(int e, @Nullable wy f) implements fbu {
      public static final fbu.b c = new fbu.b(429, wy.c("mco.errorMessage.serviceBusy"));
      public static final wy d = wy.c("mco.errorMessage.retry");

      public static fbu.b a(String $$0) {
         return new fbu.b(500, wy.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fbu.b a(fdc $$0) {
         return new fbu.b(500, wy.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }
