...
public enum fbu implements azu {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final azu.a<fbu> t = azu.a(fbu::values);
   public static final IntFunction<fbu> u = axp.a(fbu::a, values(), axp.a.a);
   private final int v;
   private final String w;

   private fbu(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
