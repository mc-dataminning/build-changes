...
public abstract class cha extends chn {
   private static final float c = 0.0F;
   private static final float d = 0.1875F;
   private static final agm<Integer> e = agp.a(cha.class, ago.b);
   private static final agm<Integer> i = agp.a(cha.class, ago.b);
   private static final agm<Boolean> j = agp.a(cha.class, ago.k);
   private static final ImmutableMap<bmx, ImmutableList<Integer>> k = ImmutableMap.of(
      bmx.a, ImmutableList.of(0, 1, -1), bmx.f, ImmutableList.of(0, 1, -1), bmx.d, ImmutableList.of(0, 1)
   );
   ...
   private double s;
   private elt t = elt.b;
   private static final Map<dkl, Pair<jb, jb>> u = ac.a(Maps.newEnumMap(dkl.class), $$0 -> {
      jb $$1 = ic.e.q();
      jb $$2 = ic.f.q();
      jb $$3 = ic.c.q();
      jb $$4 = ic.d.q();
      ...
      jb $$7 = $$3.o();
      jb $$8 = $$4.o();
      $$0.put(dkl.a, Pair.of($$3, $$4));
      $$0.put(dkl.b, Pair.of($$1, $$2));
      $$0.put(dkl.c, Pair.of($$5, $$2));
      $$0.put(dkl.d, Pair.of($$1, $$6));
      $$0.put(dkl.e, Pair.of($$3, $$8));
      $$0.put(dkl.f, Pair.of($$7, $$4));
      $$0.put(dkl.g, Pair.of($$4, $$2));
      $$0.put(dkl.h, Pair.of($$4, $$1));
      $$0.put(dkl.i, Pair.of($$3, $$1));
      $$0.put(dkl.j, Pair.of($$3, $$2));
   });

   protected cha(blz<?> $$0, ctp $$1) {
      super($$0, $$1);
      this.I = true;
   }

   protected cha(blz<?> $$0, ctp $$1, double $$2, double $$3, double $$4) {
      this($$0, $$1);
      this.a_($$2, $$3, $$4);
      this.K = $$2;
      this.L = $$3;
   ...
   public static cha a(and $$0, double $$1, double $$2, double $$3, cha.a $$4, cmy $$5, @Nullable cfi $$6) {
      cha $$7 = (cha)(switch ($$4) {
         case b -> new chh($$0, $$1, $$2, $$3);
         case c -> new chj($$0, $$1, $$2, $$3);
         case d -> new chm($$0, $$1, $$2, $$3);
         case e -> new chl($$0, $$1, $$2, $$3);
         case f -> new chk($$0, $$1, $$2, $$3);
         case g -> new chi($$0, $$1, $$2, $$3);
         default -> new chg($$0, $$1, $$2, $$3);
      });
      blz.<cha>a($$0, $$5, $$6).accept($$7);
      return $$7;
   }
   ...
   protected Vector3f a(blv $$0, blw $$1, float $$2) {
      boolean $$3 = $$0 instanceof cev || $$0 instanceof cfb;
   ...
   public elt b(bml $$0) {
      ...
      if ($$1.o() == ic.a.b) {
         ...
         while ($$14.hasNext()) {
            ...
            while ($$16.hasNext()) {
               ...
               for (int[] $$10 : $$2) {
                  ...
                  double $$11 = this.dM().a(chf.a(this.dM(), $$4), () -> chf.a(this.dM(), $$4.d()));
                  if (chf.a($$11)) {
                     elo $$12 = new elo((double)(-$$8), 0.0, (double)(-$$8), (double)$$8, (double)$$7.b, (double)$$8);
                     elt $$13 = elt.a($$4, $$11);
                     if (chf.a(this.dM(), $$0, $$12.c($$13))) {
                        $$0.b($$6);
                        return $$13;
                     }
                  }
         ...
         while (var22.hasNext()) {
            bmx $$15 = (bmx)var22.next();
            double $$16 = (double)$$0.a($$15).b;
            int $$17 = auo.c($$14x - (double)$$4.v() + $$16);
            double $$18 = chf.a($$4, $$17, $$0x -> this.dM().a_($$0x).k(this.dM(), $$0x));
            if ($$14x + $$16 <= $$18) {
               $$0.b($$15);
               break;
            }
   ...
   protected float aL() {
      ...
      return $$0.a(ash.N) ? 1.0F : super.aL();
   }
   ...
   private static Pair<jb, jb> a(dkl $$0) {
      return u.get($$0);
   }
   ...
   public void l() {
      ...
      if (this.dM().B) {
         ...
         int $$2 = auo.a(this.dt());
         int $$3 = auo.a(this.dx());
         if (this.dM().a_(new hx($$1, $$2 - 1, $$3)).a(ash.N)) {
            $$2--;
         }
         ...
         if ($$6 * $$6 + $$7 * $$7 > 0.001) {
            this.r((float)(auo.d($$7, $$6) * 180.0 / Math.PI));
            if (this.l) {
               this.r(this.dC() + 180.0F);
            }
         }

         double $$8 = (double)auo.g(this.dC() - this.N);
         if ($$8 < -170.0 || $$8 >= 170.0) {
            this.r(this.dC() + 180.0F);
            this.l = !this.l;
         }
         ...
         this.a(this.dC(), this.dE());
         if (this.w() == cha.a.a && this.dp().i() > 0.01) {
            List<blv> $$9 = this.dM().a(this, this.cH().c(0.2F, 0.0, 0.2F), bly.a(this));
            if (!$$9.isEmpty()) {
               for (blv $$10 : $$9) {
                  if (!($$10 instanceof cfi) && !($$10 instanceof byk) && !($$10 instanceof cha) && !this.bP() && !$$10.bO()) {
                     $$10.n(this);
                  } else {
                     $$10.g(this);
                  }
            ...
            for (blv $$11 : this.dM().a_(this, this.cH().c(0.2F, 0.0, 0.2F))) {
               if (!this.x($$11) && $$11.bu() && $$11 instanceof cha) {
                  $$11.g(this);
               }
            }
         }
   ...
   protected void s() {
      double $$0 = this.q();
      elt $$1 = this.dp();
      this.o(auo.a($$1.c, -$$0, $$0), $$1.d, auo.a($$1.e, -$$0, $$0));
      if (this.aC()) {
   ...
   protected void c(hx $$0, djh $$1) {
      ...
      $$9 = new elt($$18 * $$14 / $$16, $$9.d, $$18 * $$15 / $$16);
      this.g($$9);
      blv $$19 = this.cQ();
      if ($$19 instanceof cfi) {
         elt $$20 = $$19.dp();
         double $$21 = $$20.i();
         double $$22 = this.dp().i();
      ...
      double $$34 = this.q();
      $$9 = this.dp();
      this.a(bmr.a, new elt(auo.a($$33 * $$9.c, -$$34, $$34), 0.0, auo.a($$33 * $$9.e, -$$34, $$34)));
      if ($$12.v() != 0 && auo.a(this.dr()) - $$0.u() == $$12.u() && auo.a(this.dx()) - $$0.w() == $$12.w()) {
         this.a_(this.dr(), this.dt() + (double)$$12.v(), this.dx());
      } else if ($$13.v() != 0 && auo.a(this.dr()) - $$0.u() == $$13.u() && auo.a(this.dx()) - $$0.w() == $$13.w()) {
         this.a_(this.dr(), this.dt() + (double)$$13.v(), this.dx());
      }

      this.u();
      elt $$35 = this.q(this.dr(), this.dt(), this.dx());
      if ($$35 != null && $$5 != null) {
      ...
      int $$39 = auo.a(this.dr());
      int $$40 = auo.a(this.dx());
      if ($$39 != $$0.u() || $$40 != $$0.w()) {
         elt $$41 = this.dp();
         double $$42 = $$41.h();
   ...
   @Nullable
   public elt a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = auo.a($$0);
      int $$5 = auo.a($$1);
      int $$6 = auo.a($$2);
      if (this.dM().a_(new hx($$4, $$5 - 1, $$6)).a(ash.N)) {
         $$5--;
      }

      djh $$7 = this.dM().a_(new hx($$4, $$5, $$6));
      if (cwf.g($$7)) {
         dkl $$8 = $$7.c(((cwf)$$7.b()).c());
         $$1 = (double)$$5;
         if ($$8.b()) {
         ...
         $$0 += $$12 * $$3;
         $$2 += $$13 * $$3;
         if ($$10.v() != 0 && auo.a($$0) - $$4 == $$10.u() && auo.a($$2) - $$6 == $$10.w()) {
            $$1 += (double)$$10.v();
         } else if ($$11.v() != 0 && auo.a($$0) - $$4 == $$11.u() && auo.a($$2) - $$6 == $$11.w()) {
            $$1 += (double)$$11.v();
         }
   ...
   @Nullable
   public elt q(double $$0, double $$1, double $$2) {
      int $$3 = auo.a($$0);
      int $$4 = auo.a($$1);
      int $$5 = auo.a($$2);
      if (this.dM().a_(new hx($$3, $$4 - 1, $$5)).a(ash.N)) {
         $$4--;
      }

      djh $$6 = this.dM().a_(new hx($$3, $$4, $$5));
      if (cwf.g($$6)) {
         dkl $$7 = $$6.c(((cwf)$$6.b()).c());
         Pair<jb, jb> $$8 = a($$7);
         jb $$9 = (jb)$$8.getFirst();
            ...
            if (!this.x($$0)) {
               ...
               if ($$3 >= 1.0E-4F) {
                  ...
                  if ($$0 instanceof cha) {
                     ...
                     elt $$7 = new elt($$5, 0.0, $$6).d();
                     elt $$8 = new elt((double)auo.b(this.dC() * (float) (Math.PI / 180.0)), 0.0, (double)auo.a(this.dC() * (float) (Math.PI / 180.0))).d();
                     ...
                     elt $$10 = this.dp();
                     elt $$11 = $$0.dp();
                     if (((cha)$$0).w() == cha.a.c && this.w() != cha.a.c) {
                        this.g($$10.d(0.2, 1.0, 0.2));
                        this.j($$11.c - $$1, 0.0, $$11.e - $$2);
                        $$0.g($$11.d(0.95, 1.0, 0.95));
                     } else if (((cha)$$0).w() != cha.a.c && this.w() == cha.a.c) {
   ...
   public void l(double $$0, double $$1, double $$2) {
      this.t = new elt($$0, $$1, $$2);
      this.g(this.t);
   }

   public abstract cha.a w();

   public djh x() {
      return !this.B() ? this.y() : cwq.a(this.an().b(e));
   }
