...
public class cha {
   ...
   @Nullable
   public static fbs a(bwj $$0, Supplier<jh> $$1) {
      return a($$1, $$0::c);
   }

   @Nullable
   public static fbs a(Supplier<jh> $$0, ToDoubleFunction<jh> $$1) {
      ...
      return $$3 != null ? fbs.c($$3) : null;
   }

   public static jh a(bwj $$0, int $$1, bam $$2, jh $$3) {
      int $$4 = $$3.u();
      int $$5 = $$3.w();
      if ($$0.fY() && $$1 > 1) {
         jh $$6 = $$0.fV();
