...
public class cha extends bsq implements ciu {
   ...
   public static final ajr<Integer> b = ajv.a(cha.class, ajt.b);
   private static final cdf ce = cdf.a().a(64.0);
   ...
   public int d = -1;
   private final cgy[] ck;
   public final cgy e;
   private final cgy cl;
   private final cgy cm;
   private final cgy cn;
   private final cgy co;
   private final cgy cp;
   private final cgy cq;
   private final cgy cr;
   public float bX;
   public float bY;
   public boolean bZ;
   public int ca;
   ...
   private duw cs;
   private io ct = io.c;
   private final chr cu;
   private int cv = 100;
   private float cw;
   private final eng[] cx = new eng[24];
   private final int[] cy = new int[24];
   private final ene cA = new ene();

   public cha(bsa<? extends cha> $$0, dax $$1) {
      super(bsa.F, $$1);
      this.e = new cgy(this, "head", 1.0F, 1.0F);
      this.cl = new cgy(this, "neck", 3.0F, 3.0F);
      this.cm = new cgy(this, "body", 5.0F, 3.0F);
      this.cn = new cgy(this, "tail", 2.0F, 2.0F);
      this.co = new cgy(this, "tail", 2.0F, 2.0F);
      this.cp = new cgy(this, "tail", 2.0F, 2.0F);
      this.cq = new cgy(this, "wing", 4.0F, 2.0F);
      this.cr = new cgy(this, "wing", 4.0F, 2.0F);
      this.ck = new cgy[]{this.e, this.cl, this.cm, this.cn, this.co, this.cp, this.cq, this.cr};
      this.t(this.eR());
      this.ag = true;
      this.au = true;
      this.cu = new chr(this);
   }
   ...
   public static btv.a u() {
      return bsq.A().a(btw.q, 200.0);
   }

   @Override
   public boolean aV() {
      float $$0 = ayd.b(this.bY * (float) (Math.PI * 2));
      float $$1 = ayd.b(this.bX * (float) (Math.PI * 2));
   ...
   public void aU() {
      if (this.dP().B && !this.aW()) {
         this.dP().a(this.du(), this.dw(), this.dA(), avh.id, this.de(), 5.0F, 0.8F + this.ah.i() * 0.3F, false);
      }
   }
   ...
   public double[] a(int $$0, float $$1) {
      ...
      double $$5 = this.c[$$2][0];
      double $$6 = ayd.d(this.c[$$3][0] - $$5);
      $$4[0] = $$5 + $$6 * (double)$$1;
      $$5 = this.c[$$2][1];
      $$6 = this.c[$$3][1] - $$5;
      $$4[1] = $$5 + $$6 * (double)$$1;
      $$4[2] = ayd.d((double)$$1, this.c[$$2][2], this.c[$$3][2]);
      return $$4;
   }
   ...
   public void n_() {
      ...
      if (this.dP().B) {
         ...
         if (!this.aW() && !this.cu.a().a() && --this.cv < 0) {
            this.dP().a(this.du(), this.dw(), this.dA(), avh.ie, this.de(), 2.5F, 0.8F + this.ah.i() * 0.3F, false);
            this.cv = 200 + this.ah.a(200);
         }
      }

      if (this.cs == null && this.dP() instanceof aqm $$0) {
         duw $$1 = $$0.D();
         ...
         if (this.gf()) {
            ...
            if (this.dP().B) {
               ...
               if ($$9 != null) {
                  ...
                  if ($$15 > 0.0) {
                     $$11 = ayd.a($$11 / $$15, (double)(-$$14), (double)$$14);
                  }

                  this.g(this.ds().b(0.0, $$11 * 0.01, 0.0));
                  this.r(ayd.g(this.dF()));
                  euk $$16 = $$9.a(this.du(), this.dw(), this.dA()).d();
                  euk $$17 = new euk((double)ayd.a(this.dF() * (float) (Math.PI / 180.0)), this.ds().d, (double)(-ayd.b(this.dF() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$18 = Math.max(((float)$$17.b($$16) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$10) > 1.0E-5F || Math.abs($$12) > 1.0E-5F) {
                     float $$19 = ayd.a(ayd.g(180.0F - (float)ayd.d($$10, $$12) * (180.0F / (float)Math.PI) - this.dF()), -50.0F, 50.0F);
                     this.cb *= 0.8F;
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new euk(0.0, 0.0, -1.0));
                  if (this.bZ) {
                     this.a(bst.a, this.ds().a(0.8F));
                  } else {
            ...
            this.aZ = this.dF();
            euk[] $$24 = new euk[this.ck.length];

            for (int $$25 = 0; $$25 < this.ck.length; $$25++) {
               $$24[$$25] = new euk(this.ck[$$25].du(), this.ck[$$25].dw(), this.ck[$$25].dA());
            }
            ...
            if (!this.dP().B && this.aP == 0) {
               this.b(this.dP().a(this, this.cq.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), brz.e));
               this.b(this.dP().a(this, this.cr.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), brz.e));
               this.c(this.dP().a(this, this.e.cK().g(1.0), brz.e));
               this.c(this.dP().a(this, this.cl.cK().g(1.0), brz.e));
            }

            float $$32 = ayd.a(this.dF() * (float) (Math.PI / 180.0) - this.cb * 0.01F);
            float $$33 = ayd.b(this.dF() * (float) (Math.PI / 180.0) - this.cb * 0.01F);
            float $$34 = this.go();
   ...
   private void gp() {
      ...
      if (this.ah.a(10) == 0) {
         List<cgz> $$0 = this.dP().a(cgz.class, this.cK().g(32.0));
         cgz $$1 = null;
   ...
   private void b(List<bru> $$0) {
      ...
      for (bru $$3 : $$0) {
         if ($$3 instanceof bso) {
            ...
            if (!this.cu.a().a() && ((bso)$$3).en() < $$3.ai - 2) {
               $$3.a(this.dQ().b((bso)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bru> $$0) {
      for (bru $$1 : $$0) {
         if ($$1 instanceof bso) {
            $$1.a(this.dQ().b((bso)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               drb $$13 = this.dP().a_($$12);
               if (!$$13.i() && !$$13.a(avw.aD)) {
                  if (this.dP().aa().b(dat.c) && !$$13.a(avw.aC)) {
   ...
   public boolean a(cgy $$0, bqn $$1, float $$2) {
      if (this.cu.a().i() == chq.j) {
         return false;
      } else {
         $$2 = this.cu.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof clw || $$1.a(avy.z)) {
               float $$3 = this.eA();
               this.g($$1, $$2);
   ...
   protected boolean g(bqn $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void eg() {
      ...
      if (this.dP() instanceof aqm) {
         if (this.ca > 150 && this.ca % 5 == 0 && $$3) {
            bse.a((aqm)this.dP(), this.dn(), ayd.d((float)$$4 * 0.08F));
         }
      ...
      this.a(bst.a, new euk(0.0, 0.1F, 0.0));
      if (this.ca == 200 && this.dP() instanceof aqm) {
         if ($$3) {
            bse.a((aqm)this.dP(), this.dn(), ayd.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cx[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$4;
            if ($$0 < 12) {
               $$3 = ayd.d(60.0F * ayd.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
               $$4 = ayd.d(60.0F * ayd.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
            } else if ($$0 < 20) {
               int $$2 = $$0 - 12;
               $$3 = ayd.d(40.0F * ayd.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$4 = ayd.d(40.0F * ayd.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$1 += 10;
            } else {
               int var7 = $$0 - 20;
               $$3 = ayd.d(20.0F * ayd.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
               $$4 = ayd.d(20.0F * ayd.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
            }

            int $$9 = Math.max(this.dP().z_() + 10, this.dP().a(dwt.a.f, new io($$3, 0, $$4)).v() + $$1);
            this.cx[$$0] = new eng($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eng $$5 = new eng(ayd.a($$0), ayd.a($$1), ayd.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eni a(int $$0, int $$1, @Nullable eng $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eng $$4 = this.cx[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eni a(eng $$0, eng $$1) {
      List<eng> $$2 = Lists.newArrayList();
      eng $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new eni($$2, new io($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(ud $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cu.a(chq.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      ...
      double $$7;
      if ($$4 == chq.d || $$4 == chq.e) {
         io $$5 = this.dP().a(dwt.a.f, dzw.a(this.ct));
   ...
   public euk F(float $$0) {
      chk $$1 = this.cu.a();
      chq<? extends chk> $$2 = $$1.i();
      euk $$8;
      if ($$2 == chq.d || $$2 == chq.e) {
         io $$3 = this.dP().a(dwt.a.f, dzw.a(this.ct));
   ...
   public void a(cgz $$0, io $$1, bqn $$2) {
      clw $$3;
      if ($$2.d() instanceof clw) {
         $$3 = (clw)$$2.d();
      } else {
