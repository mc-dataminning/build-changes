...
public abstract class cha extends cgz implements chd {
   private iq<cmx> c = iq.a(36, cmx.f);
   @Nullable
   private ahg d;
   private long e;

   protected cha(bly<?> $$0, cto $$1) {
      super($$0, $$1);
   }

   protected cha(bly<?> $$0, double $$1, double $$2, double $$3, cto $$4) {
      super($$0, $$4, $$1, $$2, $$3);
   }
