...
public class fyx<T extends gvd> extends fyk<T> implements fxh, fyt {
   public static final gbv i = new fxm(true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F, Set.of("head"));
   ...
   public fyx(gbm $$0, Function<ali, gir> $$1) {
      super($$0, $$1);
      this.o = $$0.b("head");
      this.p = this.o.b("hat");
      this.q = $$0.b("body");
   ...
   public static gbu a(gbq $$0, float $$1) {
      gbu $$2 = new gbu();
      gbw $$3 = $$2.a();
      gbw $$4 = $$3.a("head", gbr.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gbo.a(0.0F, 0.0F + $$1, 0.0F));
      $$4.a("hat", gbr.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), gbo.a);
      $$3.a("body", gbr.c().a(16, 16).a(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, $$0), gbo.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("right_arm", gbr.c().a(40, 16).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gbo.a(-5.0F, 2.0F + $$1, 0.0F));
      $$3.a("left_arm", gbr.c().a(40, 16).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gbo.a(5.0F, 2.0F + $$1, 0.0F));
      $$3.a("right_leg", gbr.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gbo.a(-1.9F, 12.0F + $$1, 0.0F));
      $$3.a("left_leg", gbr.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gbo.a(1.9F, 12.0F + $$1, 0.0F));
      return $$2;
   }

   protected fyx.a a(T $$0, buu $$1) {
      return fyx.a.a;
   }

   public void a(T $$0) {
      super.a($$0);
      fyx.a $$1 = this.a($$0, buu.a);
      fyx.a $$2 = this.a($$0, buu.b);
      float $$3 = $$0.B;
      boolean $$4 = $$0.J;
      ...
      float $$5 = $$0.X;
      float $$6 = $$0.Y;
      this.r.e = azk.b($$5 * 0.6662F + (float) Math.PI) * 2.0F * $$6 * 0.5F / $$0.D;
      this.s.e = azk.b($$5 * 0.6662F) * 2.0F * $$6 * 0.5F / $$0.D;
      this.t.e = azk.b($$5 * 0.6662F) * 1.4F * $$6 / $$0.D;
      this.u.e = azk.b($$5 * 0.6662F + (float) Math.PI) * 1.4F * $$6 / $$0.D;
      this.t.f = 0.005F;
      this.u.f = -0.005F;
      this.t.g = 0.005F;
      this.u.g = -0.005F;
      ...
      if ($$2 != fyx.a.h) {
         fxf.a(this.r, $$0.p, 1.0F);
      }

      if ($$1 != fyx.a.h) {
         fxf.a(this.s, $$0.p, -1.0F);
      }

      if ($$3 > 0.0F) {
         float $$10 = $$5 % 26.0F;
         buu $$11 = $$0.G;
         float $$12 = $$11 == buu.b && $$0.C > 0.0F ? 0.0F : $$3;
         float $$13 = $$11 == buu.a && $$0.C > 0.0F ? 0.0F : $$3;
         if (!$$0.M) {
            if ($$10 < 14.0F) {
   ...
   private void a(T $$0, fyx.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            fxf.a(this.r, this.s, $$0.E, $$0.F, true);
            break;
         case g:
            fxf.a(this.r, this.s, this.o, true);
            break;
         case h:
            this.r.e = azk.a(this.o.e - 1.9198622F - ($$0.I ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F);
   ...
   private void b(T $$0, fyx.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            fxf.a(this.r, this.s, $$0.E, $$0.F, false);
            break;
         case g:
            fxf.a(this.r, this.s, this.o, false);
            break;
         case h:
            this.s.e = azk.a(this.o.e - 1.9198622F - ($$0.I ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F);
   ...
   private void a(gbm $$0, boolean $$1) {
   ...
   protected gbm a(buu $$0) {
      return $$0 == buu.a ? this.s : this.r;
   }
