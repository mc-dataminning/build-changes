public class fyx extends fzs {
   private final fzn a;

   fyx(fvm $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fzn $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         ckl $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.du();
            if (this.h > $$1) {
   ...
   public static class a implements fyv<kz> {
      ...
      public fys a(kz $$0, fvm $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fyx($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements fyv<kz> {
      ...
      public fys a(kz $$0, fvm $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fys $$8 = new fyx($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
