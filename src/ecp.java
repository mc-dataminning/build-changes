...
@Deprecated
public class ecp extends eca<ecp.a> {
   private static final dta a = dfy.nc.o();

   public ecp(Codec<ecp.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ecc<ecp.a> $$0) {
      jd $$1 = $$0.e();
      ddq $$2 = $$0.b();
      ayv $$3 = $$0.d();
      ecp.a $$4 = $$0.f();
   ...
   public static record a(egf b, egf c) implements eee {
      public static final Codec<ecp.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(egf.a.fieldOf("fluid").forGetter(ecp.a::a), egf.a.fieldOf("barrier").forGetter(ecp.a::b)).apply($$0, ecp.a::new)
      );
