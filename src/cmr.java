...
public class cmr implements cmb {
   final int a;
   final int b;
   final hp<cmi> c;
   final cjh d;
   ...
   public cmr(String $$0, cma $$1, int $$2, int $$3, hp<cmi> $$4, cjh $$5, boolean $$6) {
      this.e = $$0;
      this.f = $$1;
      this.a = $$2;
      this.b = $$3;
   ...
   public cmr(String $$0, cma $$1, int $$2, int $$3, hp<cmi> $$4, cjh $$5) {
   ...
   private boolean a(cfb $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   public static class a implements cmo<cmr> {
      ...
      private static final Codec<cmr> z = cmr.a.a.a.flatXmap($$0 -> {
         String[] $$1 = cmr.a($$0.e);
         int $$2 = $$1[0].length();
         int $$3 = $$1.length;
         hp<cmi> $$4 = hp.a($$2 * $$3, cmi.a);
         ...
         for (int $$6 = 0; $$6 < $$1.length; $$6++) {
            ...
            for (int $$8 = 0; $$8 < $$7.length(); $$8++) {
               ...
               cmi $$10 = $$9.equals(" ") ? cmi.a : $$0.d.get($$9);
               if ($$10 == null) {
         ...
         if (!$$5.isEmpty()) {
            ...
            cmr $$11 = new cmr($$0.b, $$0.c, $$2, $$3, $$4, $$0.f, $$0.g);
      ...
      public cmr b(sq $$0) {
         ...
         return new cmr($$3, $$4, $$1, $$2, $$5, $$7, $$8);
      }

      public void a(sq $$0, cmr $$1) {
         $$0.c($$1.a);
         $$0.c($$1.b);
         $$0.a($$1.e);
         $$0.a($$1.f);
      ...
      static record a(String b, cma c, Map<String, cmi> d, List<String> e, cjh f, boolean g) {
         public static final Codec<cmr.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     arh.a(Codec.STRING, "group", "").forGetter($$0x -> $$0x.b),
                     cma.e.fieldOf("category").orElse(cma.d).forGetter($$0x -> $$0x.c),
                     arh.d(cmr.a.y, cmi.c).fieldOf("key").forGetter($$0x -> $$0x.d),
                     cmr.a.x.fieldOf("pattern").forGetter($$0x -> $$0x.e),
                     cmc.a.fieldOf("result").forGetter($$0x -> $$0x.f),
                     arh.a(Codec.BOOL, "show_notification", true).forGetter($$0x -> $$0x.g)
                  )
                  .apply($$0, cmr.a.a::new)
         );
