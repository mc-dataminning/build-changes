...
public class gdr extends fve {
   private static final fvl c = new fvl(alr.b("recipe_book/tab"), alr.b("recipe_book/tab_selected"));
   ...
   public void a(fqb $$0, boolean $$1) {
      gdt.a $$2 = $$1 ? gdt.a.b : gdt.a.a;

      for (gdt $$4 : $$0.a(this.d.c())) {
         for (dgi $$5 : $$4.a($$2)) {
            if ($$0.b($$5.a())) {
               this.f = 15.0F;
               return;
   ...
   public void b(ftk $$0, int $$1, int $$2, float $$3) {
      if (this.a != null) {
         ...
         alr $$5 = this.a.a(true, this.b);
         int $$6 = this.F();
         if (this.b) {
            $$6 -= 2;
         }

         $$0.a(gry::H, $$5, $$6, this.G(), this.g, this.h);
         this.a($$0);
         if (this.f > 0.0F) {
            $$0.c().b();
            this.f -= $$3;
   ...
   public boolean a(fqb $$0) {
      List<gdt> $$1 = $$0.a(this.d.c());
      this.k = false;
