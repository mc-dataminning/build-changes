...
public class gdr extends atz<gdr.a> {
   ...
   protected gdr.a a(atu $$0, bmr $$1) {
      ...
      $$1.b();
      return new gdr.a($$2, $$3, $$4);
   }

   protected void a(gdr.a $$0, atu $$1, bmr $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(atu $$0, bmr $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eyz.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eyz.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eyz.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
