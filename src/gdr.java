...
public class gdr implements gdq {
   private final gdq.a a;
   private final gdq.a b = gdq.a(new ezv(1536));
   private int c = 255;
   private int d = 255;
   private int e = 255;
   private int f = 255;
   ...
   public fae getBuffer(gdy $$0) {
      if ($$0.M()) {
         fae $$1 = this.b.getBuffer($$0);
         return new gdr.a($$1, this.c, this.d, this.e, this.f);
      } else {
         fae $$2 = this.a.getBuffer($$0);
         Optional<gdy> $$3 = $$0.L();
         if ($$3.isPresent()) {
            fae $$4 = this.b.getBuffer($$3.get());
            gdr.a $$5 = new gdr.a($$4, this.c, this.d, this.e, this.f);
            return fah.a($$5, $$2);
         } else {
            return $$2;
         }
   ...
   static class a extends ezz {
      ...
      a(fae $$0, int $$1, int $$2, int $$3, int $$4) {
         this.f = $$0;
         super.b($$1, $$2, $$3, $$4);
      }
