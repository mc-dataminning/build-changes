...
public abstract class euk<M extends eue<M>, S extends euh<M>> implements eug {
   public static final int a = 15;
   protected static final int b = 1;
   protected static final long c = euk.a.a(1);
   private static final int g = 512;
   protected static final jo[] d = jo.values();
   protected final eaw e;
   protected final S f;
   ...
   private final eav[] m = new eav[2];

   protected euk(eaw $$0, S $$1) {
      this.e = $$0;
      this.f = $$1;
      this.c();
   }

   public static boolean a(dym $$0, dym $$1) {
      return $$1 == $$0 ? false : $$1.g() != $$0.g() || $$1.k() != $$0.k() || $$1.j() || $$0.j();
   }

   public static int a(dym $$0, dym $$1, jo $$2, int $$3) {
      boolean $$4 = a($$0);
      boolean $$5 = a($$1);
      if ($$4 && $$5) {
         return $$3;
         ...
         fdo $$6 = $$4 ? fdl.a() : $$0.h();
         fdo $$7 = $$5 ? fdl.a() : $$1.h();
         return fdl.b($$6, $$7, $$2) ? 16 : $$3;
      }
   }

   public static fdo a(dym $$0, jo $$1) {
      return a($$0) ? fdl.a() : $$0.a($$1);
   }
   ...
   protected dym c(jj $$0) {
      int $$1 = kl.a($$0.u());
      int $$2 = kl.a($$0.w());
      eav $$3 = this.a($$1, $$2);
      return $$3 == null ? dkw.I.m() : $$3.a_($$0);
   }

   protected int b(dym $$0) {
      return Math.max(1, $$0.g());
   }

   protected boolean a(dym $$0, dym $$1, jo $$2) {
      fdo $$3 = a($$0, $$2);
      fdo $$4 = a($$1, $$2.g());
      return fdl.b($$3, $$4);
   }
   ...
   public void a(long $$0, @Nullable eao $$1) {
      this.f.a($$0, $$1);
   }

   public void b(dgw $$0, boolean $$1) {
      this.f.c(kl.b($$0.h, $$0.i), $$1);
   }
   ...
   public static class a {
      ...
      public static long a(int $$0, jo $$1) {
         long $$2 = c(1008L, $$1);
         return a($$2, $$0);
      }
      ...
      public static long a(int $$0, boolean $$1, jo $$2) {
         long $$3 = c(1008L, $$2);
         if ($$1) {
            $$3 |= 1024L;
         }
      ...
      public static long b(int $$0, boolean $$1, jo $$2) {
         long $$3 = 0L;
         if ($$1) {
            $$3 |= 1024L;
         }
      ...
      public static boolean a(long $$0, jo $$1) {
      ...
      private static long b(long $$0, jo $$1) {
         return $$0 | 1L << $$1.ordinal() + 4;
      }

      private static long c(long $$0, jo $$1) {
         return $$0 & ~(1L << $$1.ordinal() + 4);
      }
   }
}
