...
public enum euk implements ayt {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final ayt.a<euk> t = ayt.a(euk::values);
   public static final IntFunction<euk> u = awq.a(euk::a, values(), awq.a.a);
   private final int v;
