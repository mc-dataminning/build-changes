...
public class gli {
   ...
   private final glh r;
   private final glj s = new glj();
   private final gle t = new gle(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<gli.a> w = new AtomicReference<>(gli.a.c);
   private final Map<gkh, gle.a> x = Maps.newHashMap();
   private final Multimap<atl, gkh> y = HashMultimap.create();
   private final List<gki> z = Lists.newArrayList();
   private final Map<gkh, Integer> A = Maps.newHashMap();
   private final Map<gkh, Integer> B = Maps.newHashMap();
   private final List<glk> C = Lists.newArrayList();
   private final List<gki> D = Lists.newArrayList();
   private final List<gke> E = Lists.newArrayList();

   public gli(gll $$0, exl $$1, asd $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new glh($$2);
   }
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(gli.a.c, gli.a.a)) {
               String $$2 = this.n.aq().c();
               ac.g().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(gli.a.a, gli.a.b);
                     }
                  ...
                  this.w.compareAndSet(gli.a.a, gli.a.c);
               });
            }
         }

         return this.w.compareAndSet(gli.a.b, gli.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(gkh::s).forEach(this::c);
      this.D.clear();
      ...
      Iterator<Entry<gkh, gle.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<gkh, gle.a> $$6 = $$5.next();
         gle.a $$7 = $$6.getValue();
         gkh $$8 = $$6.getKey();
      ...
      Iterator<Entry<gkh, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<gkh, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            gkh $$13 = $$12.getKey();
            if ($$13 instanceof gki) {
               ((gki)$$13).q();
            }
   ...
   private static boolean d(gkh $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(gkh $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(gkh $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(gkh $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != gll.d) {
                  if ($$3 == gll.a) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != gkh.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<gle.a> $$16 = this.t.a($$3.g() ? epv.c.b : epv.c.a);
                           gle.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (aa.aU) {
   ...
   private float g(gkh $$0) {
      return awh.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(gkh $$0) {
