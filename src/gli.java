...
public class gli implements AutoCloseable {
   ...
   private float b(float $$0) {
      buo $$1 = this.i.t.c(buq.G);
      return $$1 != null ? $$1.a(this.i.t, $$0) : 0.0F;
   }

   private float a(bwf $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$2 != null) {
            ...
            if (this.i.t.b(buq.p)) {
               $$10 = gla.a(this.i.t, $$0);
            } else if ($$9 > 0.0F && this.i.t.b(buq.C)) {
               $$10 = $$9;
            } else {
               $$10 = 0.0F;
            }
            ...
            gkt $$18 = Objects.requireNonNull(RenderSystem.setShader(gku.b), "Lightmap shader not loaded");
   ...
   public static float a(ebp $$0, int $$1) {
      return a($$0.s(), $$1);
   }
