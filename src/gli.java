...
public class gli extends auu<Optional<gli.b>> implements AutoCloseable {
   ...
   private gli.a o = gli.a.b;
   @Nullable
   private fkw p;
   @Nullable
   private gli.b q;
   private final ffy r = new ffy(fdp.b);
   private boolean s;

   protected Optional<gli.b> a(aup $$0, bou $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gli.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gli.b> $$0, aup $$1, bou $$2) {
   ...
   public void a(int $$0, fkw $$1, float $$2, Matrix4f $$3, Matrix4f $$4, fbb $$5, float $$6) {
      if (this.q != null) {
         ...
         if (this.l || $$16 != this.m || $$17 != this.n || $$9 != this.o || $$1 != this.p) {
            ...
            this.o = $$9;
            this.p = $$1;
            ffu $$21 = this.a(ffx.b(), $$16, $$17, $$1, $$9, $$20);
            if ($$21 != null) {
               this.r.a($$21);
               this.s = false;
            } else {
   ...
   private void a(gmj $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      glj $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private ffu a(ffx $$0, int $$1, int $$2, fkw $$3, gli.a $$4, gmj $$5) {
      float $$6 = 0.8F;
      ...
      ffq $$11 = $$0.a($$5.T(), $$5.S());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == fkw.c);
      return $$11.a();
   }

   private void a(gli.a $$0, ffq $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(ffq $$0, int $$1, int $$2, int $$3) {
   ...
   private void a(gli.a $$0, ffq $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
