...
public class euo {
   ...
   @Nullable
   public <T extends eun> T a(Class<? extends T> $$0, Object $$1) {
      for (euo.a<?> $$2 : this.d) {
   ...
   class a<T extends eun> {
      ...
      private float a(long $$0) {
         float $$1 = arp.a((float)($$0 - this.f) / 600.0F, 0.0F, 1.0F);
         $$1 *= $$1;
      ...
      public boolean a(int $$0, erv $$1) {
         ...
         if (this.f == -1L) {
            this.f = $$2;
            this.h.a(euo.this.c.ai());
         }

         if (this.h == eun.a.a && $$2 - this.f <= 600L) {
            this.g = $$2;
         }

         $$1.c().a();
         $$1.c().a((float)$$0 - (float)this.c.a() * this.a($$2), (float)(this.d * 32), 800.0F);
         eun.a $$3 = this.c.a($$1, euo.this, $$2 - this.g);
         $$1.c().b();
         if ($$3 != this.h) {
         ...
         return this.h == eun.a.b && $$2 - this.f > 600L;
      }
   }
}
