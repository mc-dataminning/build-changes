...
public class euo {
   ...
   public Optional<jh> a(jh $$0, boolean $$1, dze $$2) {
      chb $$3 = this.n.A();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(chf.r), $$0, $$4, chb.b.c)
         .map(chc::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(dye.K))
   ...
   public Optional<l.a> a(jh $$0, jm.a $$1) {
      ...
      for (jh.a $$11 : jh.a($$0, 16, jm.f, jm.d)) {
         int $$12 = Math.min($$8, this.n.a(edj.a.e, $$11.u(), $$11.w()));
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new jh($$0.u() - $$2.j() * 1, azu.a($$0.v(), $$17, $$18), $$0.w() - $$2.l() * 1).j();
         $$4 = $$7.b($$4);
         jm $$19 = $$2.h();
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, dkf.cv.m(), 3);
            }
         }
      }

      dxo $$26 = dkf.eq.m().b(dpk.b, $$1);
