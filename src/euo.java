...
public class euo {
   ...
   public void a(evy $$0, String $$1, ewu.a $$2, ekm $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  euo.b $$13 = new euo.b($$1.trim(), this.f, $$3, $$2);
                  euo.a $$14 = new euo.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        euo.c $$30 = new euo.c(this.f, $$2, $$0);
                        euo.a $$31 = new euo.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new ewc(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ekm $$2) throws IOException {
      ...
      File $$15 = new File(ezi.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ekm d;
      private final ewu.a e;

      b(String $$0, File $$1, ekm $$2, ewu.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((euo.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !euo.this.b && !euo.this.d) {
            try {
               euo.this.e = true;
               euo.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               euo.a.error("Error extracting archive", var3);
               euo.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final ewu.a c;
      private final evy d;

      c(File $$0, ewu.a $$1, evy $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((euo.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !euo.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, euo.this.g);
                  euo.this.c = true;
               } else {
                  euo.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  euo.this.d = true;
               }
            } catch (IOException var3) {
               euo.a.error("Error copying resourcepack file: {}", var3.getMessage());
               euo.this.d = true;
            }
         }
      }
