...
public class ftb extends aqn<ftb.a> {
   ...
   protected ftb.a a(aqi $$0, bgs $$1) {
      ...
      $$1.b();
      return new ftb.a($$2, $$3, $$4);
   }

   protected void a(ftb.a $$0, aqi $$1, bgs $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aqi $$0, bgs $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eou.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eou.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eou.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
