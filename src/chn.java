...
public class chn extends btd implements cji {
   private static final Logger cf = LogUtils.getLogger();
   public static final ajp<Integer> b = ajt.a(chn.class, ajr.b);
   private static final cds cg = cds.a().a(64.0);
   ...
   public int d = -1;
   private final chl[] cm;
   public final chl e;
   private final chl cn;
   private final chl co;
   private final chl cp;
   private final chl cq;
   private final chl cr;
   private final chl cs;
   private final chl ct;
   public float bZ;
   public float ca;
   public boolean cb;
   public int cc;
   ...
   private dwi cu;
   private ja cv = ja.c;
   private final cie cw;
   private int cx = 100;
   private float cy;
   private final eot[] cz = new eot[24];
   private final int[] cB = new int[24];
   private final eor cC = new eor();

   public chn(bsm<? extends chn> $$0, dcf $$1) {
      super(bsm.F, $$1);
      this.e = new chl(this, "head", 1.0F, 1.0F);
      this.cn = new chl(this, "neck", 3.0F, 3.0F);
      this.co = new chl(this, "body", 5.0F, 3.0F);
      this.cp = new chl(this, "tail", 2.0F, 2.0F);
      this.cq = new chl(this, "tail", 2.0F, 2.0F);
      this.cr = new chl(this, "tail", 2.0F, 2.0F);
      this.cs = new chl(this, "wing", 4.0F, 2.0F);
      this.ct = new chl(this, "wing", 4.0F, 2.0F);
      this.cm = new chl[]{this.e, this.cn, this.co, this.cp, this.cq, this.cr, this.cs, this.ct};
      this.u(this.eO());
      this.ag = true;
      this.au = true;
      this.cw = new cie(this);
   }
   ...
   public void aV() {
      if (this.dQ().B && !this.aX()) {
         this.dQ().a(this.dv(), this.dx(), this.dB(), avh.id, this.df(), 5.0F, 0.8F + this.ah.i() * 0.3F, false);
      }
   }
   ...
   public void n_() {
      ...
      if (this.dQ().B) {
         ...
         if (!this.aX() && !this.cw.a().a() && --this.cx < 0) {
            this.dQ().a(this.dv(), this.dx(), this.dB(), avh.ie, this.df(), 2.5F, 0.8F + this.ah.i() * 0.3F, false);
            this.cx = 200 + this.ah.a(200);
         }
      }

      if (this.cu == null && this.dQ() instanceof aqm $$0) {
         dwi $$1 = $$0.D();
      ...
      if (this.ey()) {
         ...
         this.dQ().a(lj.w, this.dv() + (double)$$2, this.dx() + 2.0 + (double)$$3, this.dB() + (double)$$4, 0.0, 0.0, 0.0);
      } else {
         this.go();
         ewf $$5 = this.dt();
         ...
         if (this.gd()) {
            ...
            if (this.dQ().B) {
               ...
               if ($$9 != null) {
                  ...
                  this.s(ayg.g(this.dG()));
                  ewf $$16 = $$9.a(this.dv(), this.dx(), this.dB()).d();
                  ewf $$17 = new ewf((double)ayg.a(this.dG() * (float) (Math.PI / 180.0)), this.dt().d, (double)(-ayg.b(this.dG() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$18 = Math.max(((float)$$17.b($$16) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$10) > 1.0E-5F || Math.abs($$12) > 1.0E-5F) {
                     float $$19 = ayg.a(ayg.g(180.0F - (float)ayg.d($$10, $$12) * (180.0F / (float)Math.PI) - this.dG()), -50.0F, 50.0F);
                     this.cd *= 0.8F;
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new ewf(0.0, 0.0, -1.0));
                  if (this.cb) {
                     this.a(btg.a, this.dt().a(0.8F));
                  } else {
            ...
            this.aY = this.dG();
            ewf[] $$24 = new ewf[this.cm.length];

            for (int $$25 = 0; $$25 < this.cm.length; $$25++) {
               $$24[$$25] = new ewf(this.cm[$$25].dv(), this.cm[$$25].dx(), this.cm[$$25].dB());
            }
            ...
            if (this.dQ() instanceof aqm $$32 && this.aO == 0) {
               this.a($$32, $$32.a(this, this.cs.cL().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bsl.e));
               this.a($$32, $$32.a(this, this.ct.cL().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bsl.e));
               this.b($$32.a(this, this.e.cL().g(1.0), bsl.e));
               this.b($$32.a(this, this.cn.cL().g(1.0), bsl.e));
            }

            float $$33 = ayg.a(this.dG() * (float) (Math.PI / 180.0) - this.cd * 0.01F);
            float $$34 = ayg.b(this.dG() * (float) (Math.PI / 180.0) - this.cd * 0.01F);
            float $$35 = this.gn();
   ...
   private void a(chl $$0, double $$1, double $$2, double $$3) {
   ...
   private void go() {
      ...
      if (this.ah.a(10) == 0) {
         List<chm> $$0 = this.dQ().a(chm.class, this.cL().g(32.0));
         chm $$1 = null;
   ...
   private void a(aqm $$0, List<bsg> $$1) {
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dsk $$13 = this.dQ().a_($$12);
               if (!$$13.i() && !$$13.a(avw.aD)) {
                  if (this.dQ().ab().b(dcb.c) && !$$13.a(avw.aC)) {
   ...
   public boolean a(chl $$0, bqz $$1, float $$2) {
      if (this.cw.a().i() == cid.j) {
         return false;
      } else {
         $$2 = this.cw.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof cmk || $$1.a(avy.z)) {
               float $$3 = this.ex();
               this.g($$1, $$2);
   ...
   protected boolean g(bqz $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void ee() {
      ...
      if (this.cc >= 180 && this.cc <= 200) {
         ...
         float $$2 = (this.ah.i() - 0.5F) * 8.0F;
         this.dQ().a(lj.v, this.dv() + (double)$$0, this.dx() + 2.0 + (double)$$1, this.dB() + (double)$$2, 0.0, 0.0, 0.0);
      }

      boolean $$3 = this.dQ().ab().b(dcb.f);
      int $$4 = 500;
      ...
      if (this.dQ() instanceof aqm) {
         if (this.cc > 150 && this.cc % 5 == 0 && $$3) {
            bsr.a((aqm)this.dQ(), this.do(), ayg.d((float)$$4 * 0.08F));
         }
      ...
      this.a(btg.a, new ewf(0.0, 0.1F, 0.0));
      if (this.cc == 200 && this.dQ() instanceof aqm) {
         if ($$3) {
            bsr.a((aqm)this.dQ(), this.do(), ayg.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cz[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(this.dQ().z_() + 10, this.dQ().a(dyf.a.f, new ja($$3, 0, $$4)).v() + $$1);
            this.cz[$$0] = new eot($$3, $$9, $$4);
         }
      ...
      return this.r(this.dv(), this.dx(), this.dB());
   }

   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eot $$5 = new eot(ayg.a($$0), ayg.a($$1), ayg.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eov a(int $$0, int $$1, @Nullable eot $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eot $$4 = this.cz[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eov a(eot $$0, eot $$1) {
      List<eot> $$2 = Lists.newArrayList();
      eot $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new eov($$2, new ja($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(tx $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cw.a(cid.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      chx $$3 = this.cw.a();
      cid<? extends chx> $$4 = $$3.i();
      double $$7;
      if ($$4 == cid.d || $$4 == cid.e) {
         ja $$5 = this.dQ().a(dyf.a.f, ebj.a(this.cv));
   ...
   public ewf G(float $$0) {
      chx $$1 = this.cw.a();
      cid<? extends chx> $$2 = $$1.i();
      ewf $$8;
      if ($$2 == cid.d || $$2 == cid.e) {
         ja $$3 = this.dQ().a(dyf.a.f, ebj.a(this.cv));
   ...
   public void a(chm $$0, ja $$1, bqz $$2) {
      cmk $$3;
      if ($$2.d() instanceof cmk) {
         $$3 = (cmk)$$2.d();
      } else {
