...
public class fcj extends fcl {
   ...
   static final fcj.b l = new fcj.b(854, 480);

   public fcj(int $$0, int $$1) {
      super(true);
      this.e($$0, $$1);
   }
   ...
   static enum a {
      ...
      private static final fcj.a[] e = values();
   ...
   static class b {
      ...
      static List<fcj.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new fcj.b($$0, $$1), fcj.l) : ImmutableList.of(fcj.l);
      }
