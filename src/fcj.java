...
public class fcj {
   ...
   public static void a(File $$0, evd $$1, Consumer<wi> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, evd $$2, Consumer<wi> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, evd $$2, Consumer<wi> $$3) {
      evs $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            wi $$3x = wi.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new wg(wg.a.b, $$6.getAbsolutePath())));
            $$3.accept(wi.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(wi.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static evs a(evd $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      evs $$3 = new evs($$1, $$2, false);
   ...
   public fcj(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
