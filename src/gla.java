...
public class gla extends awa<gla.a> {
   ...
   protected gla.a a(avv $$0, bps $$1) {
      ...
      return new gla.a($$2, $$3, $$4);
   }

   protected void a(gla.a $$0, avv $$1, bps $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(avv $$0, bps $$1) {
      try {
         JsonObject var4;
         try (
            bpx $$2 = $$1.d("parse_json");
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, ffj.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, ffj.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, ffj.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
