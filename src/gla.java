...
public class gla implements glg.a {
   ...
   private final fil F;
   private final Map<je, gla.a> G = Maps.newHashMap();
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bto $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dN();
      });
   }

   private void b(fde $$0, ghg $$1, double $$2, double $$3, double $$4) {
      je $$5 = je.a($$2, $$3, $$4);
   ...
   private void a(fde $$0, ghg $$1, gla.a $$2) {
      int $$3 = 0;
   ...
   private void a(fde $$0, ghg $$1, aak.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         glp.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fde $$0, ghg $$1, aak.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fde $$0, ghg $$1, String $$2, gla.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      glg.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cD());
   }
