...
public class ob {
   ...
   public static ob a(dfh $$0) {
      akk $$1 = G($$0);
      return b($$1);
   }

   public static ob b(dfh $$0) {
      akk $$1 = G($$0);
      return a($$1);
   }
   ...
   public static ob f(dfh $$0) {
      return d(oc.t, G($$0));
   }

   public static ob g(dfh $$0) {
   ...
   public static ob h(dfh $$0) {
      return d(oc.y, G($$0));
   }

   public static ob a(dfh $$0, dfh $$1) {
      return new ob().a(oc.y, G($$0)).a(oc.z, G($$1));
   }

   public static ob i(dfh $$0) {
      return d(oc.u, G($$0));
   }

   public static ob j(dfh $$0) {
      return d(oc.x, G($$0));
   }
   ...
   public static ob b(dfh $$0, dfh $$1) {
   ...
   public static ob t(dfh $$0) {
      return new ob().a(oc.f, a($$0, "_top")).a(oc.e, a($$0, "_bottom"));
   }

   public static ob u(dfh $$0) {
   ...
   public static ob v(dfh $$0) {
      return new ob().a(oc.C, a($$0, "_0"));
   }

   public static ob w(dfh $$0) {
      return new ob().a(oc.C, a($$0, "_1"));
   }

   public static ob x(dfh $$0) {
      return new ob().a(oc.D, G($$0));
   }

   public static ob y(dfh $$0) {
   ...
   public static ob a(dfh $$0, String $$1, String $$2) {
      return new ob().a(oc.i, a($$0, $$1)).a(oc.f, a($$0, $$2)).a(oc.e, a($$0, "_bottom"));
   }

   public static ob a(dfh $$0, String $$1, String $$2, String $$3, String $$4) {
      return new ob().a(oc.g, a($$0, $$1)).a(oc.i, a($$0, $$2)).a(oc.f, a($$0, $$3)).a(oc.e, a($$0, $$4));
   }

   public static ob a(ctx $$0) {
      return new ob().a(oc.c, c($$0));
   }

   public static ob z(dfh $$0) {
   ...
   public static ob c(dfh $$0, dfh $$1) {
      return new ob()
         .a(oc.c, a($$0, "_front"))
         .a(oc.o, G($$1))
         .a(oc.n, a($$0, "_top"))
   ...
   public static ob d(dfh $$0, dfh $$1) {
      return new ob()
         .a(oc.c, a($$0, "_front"))
         .a(oc.o, G($$1))
         .a(oc.n, a($$0, "_top"))
   ...
   public static ob a(String $$0) {
      return new ob()
         .a(oc.c, a(dfj.mg, $$0 + "_north"))
         .a(oc.e, a(dfj.mg, $$0 + "_bottom"))
         .a(oc.f, a(dfj.mg, $$0 + "_top"))
         .a(oc.j, a(dfj.mg, $$0 + "_north"))
         .a(oc.k, a(dfj.mg, $$0 + "_south"))
         .a(oc.l, a(dfj.mg, $$0 + "_east"))
         .a(oc.m, a(dfj.mg, $$0 + "_west"));
   }
   ...
   public static ob a(dfh $$0, boolean $$1) {
      return new ob()
         .a(oc.c, a(dfj.eg, "_side"))
         .a(oc.e, a(dfj.eg, "_bottom"))
         .a(oc.f, a(dfj.eg, "_top"))
         .a(oc.i, a(dfj.eg, "_side"))
         .a(oc.L, a($$0, $$1 ? "_lit" : ""));
   }

   public static ob j(akk $$0) {
      return new ob()
         .a(oc.c, a(dfj.ft, "_side"))
         .a(oc.i, a(dfj.ft, "_side"))
         .a(oc.f, a(dfj.ft, "_top"))
         .a(oc.e, a(dfj.ft, "_bottom"))
         .a(oc.M, a(dfj.ft, "_inner"))
         .a(oc.N, $$0);
   }
   ...
   public static ob a(boolean $$0) {
      ...
      return new ob()
         .a(oc.c, a(dfj.qV, "_bottom"))
         .a(oc.i, a(dfj.qV, "_side"))
         .a(oc.f, a(dfj.qV, "_top"))
         .a(oc.O, a(dfj.qV, $$1 + "_inner_top"))
         .a(oc.e, a(dfj.qV, "_bottom"));
   }

   public static ob b(ctx $$0) {
