...
public record boe(Instant a, String b, long c) {
   ...
   public static boe a(RecordedEvent $$0) {
      ...
      return new boe($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static boe.a a(List<boe> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<boe>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            boe $$3 = (boe)$$2x.get(0);
            boe $$4 = (boe)$$2x.get($$2x.size() - 1);
