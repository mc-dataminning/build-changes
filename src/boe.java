...
public class boe implements bnx {
   ...
   public static Set<bnv> a() {
      Builder<bnv> $$0 = ImmutableSet.builder();

      try {
         boe.a $$1 = new boe.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bnv.a("cpu#" + $$1x, bnu.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bnv.a("heap MiB", bnu.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bnw.a.a());
      return $$0.build();
   }
   ...
   public static bnv a(final LongSupplier $$0) {
      ...
      bnv.d $$3 = new bnv.d(2.0F);
      return bnv.a("ticktime", bnu.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
