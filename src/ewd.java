...
public class ewd {
   ...
   private final ewd.a g;

   @Deprecated
   public static ewd a(azv $$0, ewd.a $$1) {
      return new ewd($$0, $$1, false);
   }

   public static ewd a(azv $$0, int $$1, double... $$2) {
      return b($$0, new ewd.a($$1, new DoubleArrayList($$2)));
   }

   public static ewd b(azv $$0, ewd.a $$1) {
      return new ewd($$0, $$1, true);
   }

   private ewd(azv $$0, ewd.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<ewd.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(ewd.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(ewd.a::b))
               .apply($$0, ewd.a::new)
      );
      public static final Codec<jf<ewd.a>> b = alc.a(mh.aY, a);
