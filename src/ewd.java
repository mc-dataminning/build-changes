...
public class ewd extends ewh implements ewf {
   ...
   public ewd.c a() {
      return new ewd.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(ewn.b $$0, ewn $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (ewo)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(ewn $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == ewg.k;
         boolean $$2 = $$0 == ewg.j;
   ...
   private IntConsumer a(int $$0, ewn.a $$1) {
   ...
   private ewd.b q() {
      ...
      this.k += $$5;
      this.j++;
      ewd.a $$9 = new ewd.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new ewd.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == ewn.b.a || this.q == ewn.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<ewo> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      ewo $$1 = (ewo)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == ewo.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == ewo.b.c) {
         ewf.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ewf.a($$11));
         this.a($$14 + 5, ewf.a($$12));
         this.a($$14 + 6, ewf.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(ewn a, int b, int c, ewn.b d, ewn.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(ewn.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable ewq $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
