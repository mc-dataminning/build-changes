...
public class cly {
   ...
   private int g = ayn.b(ayv.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kg.a.fieldOf("uuid").forGetter(Pair::getFirst), axv.k.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bsq> j;
   @VisibleForTesting
   protected final ArrayList<bsq> c;
   private final cly.a k;
   @VisibleForTesting
   protected final Object2IntMap<bsq> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cly> a(Predicate<bsq> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cly::b)).apply($$1, $$1x -> new cly($$0, $$1x))
      );
   }

   public cly(Predicate<bsq> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
   ...
   public void a(aqt $$0, Predicate<bsq> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bsq>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bsq> $$6 = (Entry<bsq>)$$5.next();
         int $$7 = $$6.getIntValue();
         bsq $$8 = (bsq)$$6.getKey();
         bsq.c $$9 = $$8.dM();
   ...
   public int b(@Nullable bsq $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<btl> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof btl).map($$0 -> (btl)$$0);
   }

   @VisibleForTesting
   protected static record a(cly a) implements Comparator<bsq> {
      public int a(bsq $$0, bsq $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
