...
public class aoa {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xp.c("commands.pardonip.invalid"));
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xp.c("commands.pardonip.failed"));
   ...
   private static int a(ep $$0, String $$1) throws CommandSyntaxException {
      if (!InetAddresses.isInetAddress($$1)) {
         ...
         if (!$$2.a($$1)) {
            ...
            $$2.c($$1);
            $$0.a(() -> xp.a("commands.pardonip.success", $$1), true);
            return 1;
         }
      }
   }
