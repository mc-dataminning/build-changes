...
public class mt implements mf {
   private final mh d;
   private final CompletableFuture<js.a> e;

   public mt(mh $$0, CompletableFuture<js.a> $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public CompletableFuture<?> a(md $$0) {
      Path $$1 = this.d.a(mh.b.c).resolve("blocks.json");
      return this.e
         .thenCompose(
            $$2 -> {
               ...
               $$2.d(lz.f)
                  ...
                  .forEach(
                     $$2x -> {
                        ...
                        $$3x.add("states", $$9);
                        String $$14 = $$2x.g();
                        JsonElement $$15 = (JsonElement)dif.a
                           .codec()
                           .encodeStart($$4, (die)$$2x.a())
