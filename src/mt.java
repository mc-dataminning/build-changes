...
public class mt implements lw {
   ...
   private final Set<ale<eqp>> f;
   private final List<mt.a> g;
   private final CompletableFuture<jk.a> h;

   public mt(ly $$0, Set<ale<eqp>> $$1, List<mt.a> $$2, CompletableFuture<jk.a> $$3) {
   ...
   private CompletableFuture<?> a(lu $$0, jk.a $$1) {
      ke<eqp> $$2 = new jq<>(lq.aU, Lifecycle.experimental());
      Map<dyl.a, alf> $$3 = new Object2ObjectOpenHashMap();
      this.g.forEach($$3x -> $$3x.a().get().generate($$1, ($$3xx, $$4x) -> {
            alf $$5x = a($$3xx);
            alf $$6x = $$3.put(brc.a($$5x), $$5x);
            if ($$6x != null) {
      ...
      eqq $$6 = new eqq($$4, etf.q, $$5);

      for (ale<eqp> $$8 : Sets.difference(this.f, $$2.f())) {
         $$4.b("Missing built-in table: " + $$8.a());
      }

      $$2.h().forEach($$1x -> ((eqp)$$1x.a()).a($$6.a(((eqp)$$1x.a()).a()).a("{" + $$1x.h().a() + "}", $$1x.h())));
      ...
      if (!$$9.isEmpty()) {
         ...
         return CompletableFuture.allOf($$2.g().stream().map($$2x -> {
            ale<eqp> $$3x = (ale<eqp>)$$2x.getKey();
            eqp $$4x = (eqp)$$2x.getValue();
            Path $$5x = this.e.a($$3x.a());
            return lw.a($$0, $$1, eqp.d, $$4x, $$5x);
         }).toArray(CompletableFuture[]::new));
      }
   }

   private static alf a(ale<eqp> $$0) {
      return $$0.a();
   }
   ...
   public static record a(Supplier<mu> a, ete b) {
   }
}
