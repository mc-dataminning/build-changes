...
public class mt implements lw {
   ...
   private final Set<ale<eqo>> f;
   private final List<mt.a> g;
   private final CompletableFuture<jk.a> h;

   public mt(ly $$0, Set<ale<eqo>> $$1, List<mt.a> $$2, CompletableFuture<jk.a> $$3) {
   ...
   private CompletableFuture<?> a(lu $$0, jk.a $$1) {
      ke<eqo> $$2 = new jq<>(lq.aU, Lifecycle.experimental());
      Map<dyk.a, alf> $$3 = new Object2ObjectOpenHashMap();
      this.g.forEach($$3x -> $$3x.a().get().generate($$1, ($$3xx, $$4x) -> {
            alf $$5x = a($$3xx);
            alf $$6x = $$3.put(brb.a($$5x), $$5x);
            if ($$6x != null) {
      ...
      eqp $$6 = new eqp($$4, ete.q, $$5);

      for (ale<eqo> $$8 : Sets.difference(this.f, $$2.f())) {
         $$4.b("Missing built-in table: " + $$8.a());
      }

      $$2.h().forEach($$1x -> ((eqo)$$1x.a()).a($$6.a(((eqo)$$1x.a()).a()).a("{" + $$1x.h().a() + "}", $$1x.h())));
      ...
      if (!$$9.isEmpty()) {
         ...
         return CompletableFuture.allOf($$2.g().stream().map($$2x -> {
            ale<eqo> $$3x = (ale<eqo>)$$2x.getKey();
            eqo $$4x = (eqo)$$2x.getValue();
            Path $$5x = this.e.a($$3x.a());
            return lw.a($$0, $$1, eqo.d, $$4x, $$5x);
         }).toArray(CompletableFuture[]::new));
      }
   }

   private static alf a(ale<eqo> $$0) {
      return $$0.a();
   }
   ...
   public static record a(Supplier<mu> a, etd b) {
   }
}
