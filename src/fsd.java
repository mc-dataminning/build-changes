...
public class fsd<T extends cdz> extends fqw<T> {
   public final fvb a;
   private final fvb b;
   private final fvb f;
   private final fvb g;
   ...
   public static fvh c() {
      fvj $$0 = new fvj();
      fvk $$1 = $$0.a();
      fvk $$2 = $$1.a("head", fvg.c().a(1, 5).a(-3.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F), fvd.a(-1.0F, 16.5F, -3.0F));
      $$2.a("right_ear", fvg.c().a(8, 1).a(-3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fvd.a);
      $$2.a("left_ear", fvg.c().a(15, 1).a(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fvd.a);
      $$2.a("nose", fvg.c().a(6, 18).a(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), fvd.a);
      fvk $$3 = $$1.a("body", fvg.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), fvd.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fvf $$4 = new fvf(0.001F);
      fvg $$5 = fvg.c().a(4, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      fvg $$6 = fvg.c().a(13, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      $$1.a("right_hind_leg", $$6, fvd.a(-5.0F, 17.5F, 7.0F));
      $$1.a("left_hind_leg", $$5, fvd.a(-1.0F, 17.5F, 7.0F));
      $$1.a("right_front_leg", $$6, fvd.a(-5.0F, 17.5F, 0.0F));
      $$1.a("left_front_leg", $$5, fvd.a(-1.0F, 17.5F, 0.0F));
      $$3.a("tail", fvg.c().a(30, 0).a(2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 5.0F), fvd.a(-4.0F, 15.0F, -1.0F, -0.05235988F, 0.0F, 0.0F));
      return fvh.a($$0, 48, 32);
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.fJ()) {
         this.a.e = 0.0F;
         this.a.f = (float) (-Math.PI * 2.0 / 3.0);
         this.a.g = axz.b($$3 * 0.027F) / 22.0F;
      }

      if ($$0.bY()) {
         float $$6 = axz.b($$3) * 0.01F;
         this.b.f = $$6;
         this.f.g = $$6;
         this.g.g = $$6;
         this.h.g = $$6 / 2.0F;
      ...
      if ($$0.gp()) {
         float $$7 = 0.1F;
         this.n += 0.67F;
         this.f.e = axz.b(this.n * 0.4662F) * 0.1F;
         this.g.e = axz.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.h.e = axz.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.i.e = axz.b(this.n * 0.4662F) * 0.1F;
      }
   }
}
