...
public class fsd {
   ...
   private final List<fok> k = Lists.newArrayList();
   private final List<fok.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fsd.a> o = new ArrayList<>();
   ...
   public void a(fro $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
   ...
   private void a(fro $$0, int $$1, int $$2, fol.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fok.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.n.n().c() == cqv.c;
   }
   ...
   public void a(wy $$0) {
      this.a($$0, null, this.i.W() ? fol.b() : fol.a());
   }

   public void a(wy $$0, @Nullable xk $$1, @Nullable fol $$2) {
      fok $$3 = new fok(this.i.m.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }

   private void a(fok $$0) {
      String $$1 = $$0.c().getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$2 = x.a($$0.e(), fol::h);
      if ($$2 != null) {
         a.info("[{}] [CHAT] {}", $$2, $$1);
      } else {
         a.info("[CHAT] {}", $$1);
   ...
   private void b(fok $$0) {
      ...
      List<ayy> $$3 = fsh.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fok.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fsd.a b(xk $$0) {
      int $$1 = this.i.m.e();
      ListIterator<fok> $$2 = this.k.listIterator();
   ...
   private fok d(fok $$0) {
      return new fok($$0.b(), h, null, fol.a());
   }
   ...
   private void n() {
      ...
      for (fok $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public fol c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fok.a $$1, fol $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fol.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.z instanceof fwq;
   }
   ...
   public fsd.b k() {
      return new fsd.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }
   ...
   public static class b {
      ...
      public b(List<fok> $$0, List<String> $$1, List<fsd.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
