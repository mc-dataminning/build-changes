...
public abstract class fsd<E extends fsd.a<E>> extends fsa {
   ...
   private final List<E> n = new fsd.b();
   ...
   public fsd(foz $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wx.a);
      this.c = $$0;
      this.d = $$4;
   }

   public fsd(foz $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected void b(frv $$0) {
      alg $$1 = this.c.s == null ? fyb.h : fyb.j;
      alg $$2 = this.c.s == null ? fyb.i : fyb.k;
      $$0.a(gqk::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(gqk::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(frv $$0) {
      alg $$1 = this.c.s == null ? a : m;
      $$0.a(gqk::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }

   protected void d(frv $$0) {
   ...
   @Override
   public Optional<fug> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(fwo $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(fwo $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fwe.a w() {
      if (this.aJ_()) {
         ...
         return this.q != null ? fwe.a.b : fwe.a.a;
      }
   }
   ...
   protected void a(fwg $$0, E $$1) {
      List<E> $$2 = this.aE_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fwf.b, wy.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fsd.a<E>> implements fug {
      @Deprecated
      fsd<E> a;
      ...
      public abstract void a(frv var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
