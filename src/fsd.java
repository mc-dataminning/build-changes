...
public class fsd extends fik {
   ...
   public List<wz> e() {
      ...
      List<wz> $$1 = Lists.newArrayList(fod.a(fgo.Q(), $$0));
      if (this.q.a(this.p.a(this.o)).size() > 1) {
         $$1.add(n);
      }
   ...
   public void a(fmi $$0) {
      ...
      $$0.a(fmh.a, wz.a("narration.recipe", $$1.w()));
      if (this.q.a(this.p.a(this.o)).size() > 1) {
         $$0.a(fmh.d, wz.c("narration.button.usage.hovered"), wz.c("narration.recipe.usage.more"));
      } else {
