...
public abstract class fzg<T extends bmf, M extends fjp<T>> extends fye<T> implements gaa<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gcq<T, M>> g = Lists.newArrayList();

   public fzg(fyf.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gcq<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, ept $$3, fsz $$4, int $$5) {
      ...
      this.f.d = $$0.bO();
      this.f.e = $$0.o_();
      float $$6 = aui.j($$2, $$0.aV, $$0.aU);
      float $$7 = aui.j($$2, $$0.aX, $$0.aW);
      float $$8 = $$7 - $$6;
      if ($$0.bO() && $$0.cZ() instanceof bmf $$9) {
         $$6 = aui.j($$2, $$9.aV, $$9.aU);
         $$8 = $$7 - $$6;
         float $$10 = aui.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected fth a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      ahd $$4 = this.a($$0);
      if ($$2) {
         return fth.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? fth.r($$4) : null;
      }
   }

   public static int c(bmf $$0, float $$1) {
      return gdw.a(gdw.a($$1), gdw.a($$0.aK > 0 || $$0.aM > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return eva.J() && $$0 != $$3.al() && $$5 && !$$0.bP();
      }
   }

   public static boolean e(bmf $$0) {
      if ($$0 instanceof cfb || $$0.ae()) {
         String $$1 = n.a($$0.ad().getString());
         if ("Dinnerbone".equals($$1) || "Grumm".equals($$1)) {
            return !($$0 instanceof cfb) || ((cfb)$$0).a(cfc.a);
         }
      }
