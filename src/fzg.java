...
public class fzg implements fzz {
   ...
   private CompletableFuture<Optional<cma>> g;
   private Instant h = Instant.EPOCH;

   public fzg(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
      this.f = $$2.resolve(d).resolve($$1 + ".json");
      this.g = CompletableFuture.<Optional<cma>>supplyAsync(() -> this.c().filter($$0x -> !$$0x.c().b().a()), ad.f()).thenCompose(this::a);
   }
   ...
   private void a(@Nullable cma $$0) {
      ...
      if ($$0 != null) {
         if (ab.aX) {
            cma.a.encodeStart(JsonOps.INSTANCE, $$0).result().ifPresent($$0x -> {
               try {
   ...
   private cma a(UserApiService $$0) throws axl, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cmb.a $$2 = a($$1);
         return new cma(axk.a($$1.keyPair().privateKey()), new cmb($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         throw new IOException("Could not retrieve profile key pair");
      }
   }

   private static cmb.a a(KeyPairResponse $$0) throws axl {
      KeyPair $$1 = $$0.keyPair();
