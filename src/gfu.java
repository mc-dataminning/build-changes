...
public class gfu {
   ...
   public void a(final gfs $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final ggv $$3 = ggv.a($$0.b);
      Optional<InetSocketAddress> $$4 = ggx.a.a($$3).map(ggu::d);
      if ($$4.isEmpty()) {
         this.a(fsq.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final ggv $$1, final gfs $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)wp.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new gfl($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(gfs.b.d);
               $$2.h = xv.b($$2xx);
               $$2.d = xv.b($$3);
               $$2.c = gfu.a($$4, $$5);
