...
public record va<S>(List<va.a<S>> a) {
   public static <S> va<S> a(ParseResults<S> $$0) {
   ...
   private static <S> List<va.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<va.a<S>> $$2 = new ArrayList<>();
