...
public class va implements uz {
   ...
   public void a(ut $$0) {
      ...
      ws $$3 = ws.b($$1.substring(1, $$1.length() - 1)).a(e);
      this.t = ws.b($$2).b($$3).f($$2);
   }

   @Override
   public void a(tw $$0) {
      ws $$1 = ws.b("b").a(g);
      this.t = ws.b(String.valueOf($$0.l())).b($$1).a(f);
   }
   ...
   @Override
   public void a(ud $$0) {
      this.t = ws.b(String.valueOf($$0.l())).a(f);
   }
   ...
   public void a(ub $$0) {
      ws $$1 = ws.b("f").a(g);
      this.t = ws.b(String.valueOf($$0.k())).b($$1).a(f);
   }

   @Override
   public void a(tz $$0) {
      ws $$1 = ws.b("d").a(g);
      this.t = ws.b(String.valueOf($$0.j())).b($$1).a(f);
   }
   ...
   public void a(tv $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         xg $$5 = ws.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(uc $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         $$2.f(" ").b(ws.b(String.valueOf($$3[$$4])).a(f));
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
      }
   ...
   public void a(uf $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         ws $$5 = ws.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(ue $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
            ...
            $$2.b(new va(this.r, this.s).a($$0.k($$3)));
         }
         ...
         for (int $$5 = 0; $$5 < $$0.size(); $$5++) {
            xg $$6 = ws.b(Strings.repeat(this.r, this.s + 1));
            $$6.b(new va(this.r, this.s + 1).a($$0.k($$5)));
            if ($$5 != $$0.size() - 1) {
   ...
   public void a(ty $$0) {
      if ($$0.g()) {
         ...
         while ($$4.hasNext()) {
            String $$5 = $$4.next();
            xg $$6 = ws.b(Strings.repeat(this.r, this.s + 1)).b(a($$5)).f(i).f(" ").b(new va(this.r, this.s + 1).a($$0.c($$5)));
            if ($$4.hasNext()) {
               $$6.f(j).f(this.r.isEmpty() ? " " : "\n");
            }
   ...
   protected static ws a(String $$0) {
      if (h.matcher($$0).matches()) {
         return ws.b($$0).a(d);
      } else {
         String $$1 = ut.b($$0);
         String $$2 = $$1.substring(0, 1);
         ws $$3 = ws.b($$1.substring(1, $$1.length() - 1)).a(d);
         return ws.b($$2).b($$3).f($$2);
      }
   }
