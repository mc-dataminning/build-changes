...
public class bex implements bey {
   ...
   private static final bex j = new bex();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bew $$0) {
      URL $$1 = bex.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bew $$1) {
      if (this.c()) {
         ...
         try {
            ...
            this.k = ac.a(new Recording($$2), $$2x -> {
               g.forEach($$2x::enable);
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bfa a = new bfa(() -> bex.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bex.this.k && $$0.getState() == RecordingState.STOPPED) {
