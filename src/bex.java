...
public final class bex implements DynamicMBean {
   private static final Logger a = LogUtils.getLogger();
   private final MinecraftServer b;
   private final MBeanInfo c;
   private final Map<String, bex.a> d = Stream.of(
         new bex.a("tickTimes", this::b, "Historical tick times (ms)", long[].class),
         new bex.a("averageTickTime", this::a, "Current average tick time (ms)", long.class)
      )
      .collect(Collectors.toMap($$0x -> $$0x.a, Function.identity()));

   private bex(MinecraftServer $$0) {
      this.b = $$0;
      MBeanAttributeInfo[] $$1 = this.d.values().stream().map(bex.a::a).toArray(MBeanAttributeInfo[]::new);
      this.c = new MBeanInfo(bex.class.getSimpleName(), "metrics for dedicated server", $$1, null, null, new MBeanNotificationInfo[0]);
   }

   public static void a(MinecraftServer $$0) {
      try {
         ManagementFactory.getPlatformMBeanServer().registerMBean(new bex($$0), new ObjectName("net.minecraft.server:type=Server"));
