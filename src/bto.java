...
public abstract class bto extends bst implements bsq {
   ...
   private static final buu bF = new buu(UUID.fromString("662A6B8D-DA3E-4C1C-8813-96EA6097278D"), "Sprinting speed boost", 0.3F, buu.a.c);
   ...
   protected static final akj<Byte> aF = akn.a(bto.class, akl.a);
   private static final akj<Float> bK = akn.a(bto.class, akl.d);
   private static final akj<List<lg>> bL = akn.a(bto.class, akl.m);
   private static final akj<Boolean> bM = akn.a(bto.class, akl.k);
   private static final akj<Integer> bN = akn.a(bto.class, akl.b);
   private static final akj<Integer> bO = akn.a(bto.class, akl.b);
   private static final akj<Optional<iz>> bP = akn.a(bto.class, akl.p);
   private static final int bQ = 15;
   protected static final bsw aG = bsw.c(0.2F, 0.2F).b(0.2F);
   public static final float aH = 0.5F;
   public static final float aI = 0.5F;
   private static final float bR = 0.21875F;
   private final but bS;
   private final brj bT = new brj(this);
   private final Map<ji<brz>, bsb> bU = Maps.newHashMap();
   private final jr<cuo> bV = jr.a(2, cuo.l);
   private final jr<cuo> bW = jr.a(4, cuo.l);
   private cuo bX = cuo.l;
   public boolean aJ;
   ...
   protected bto(bsz<? extends bto> $$0, dbx $$1) {
      super($$0, $$1);
      this.bS = new but(bux.a($$0));
      this.t(this.eR());
      this.J = true;
   ...
   public static buv.a dU() {
      return buv.a().a(buw.q).a(buw.n).a(buw.r).a(buw.a).a(buw.b).a(buw.p).a(buw.v).a(buw.t).a(buw.l).a(buw.s).a(buw.i).a(buw.m);
   }
   ...
   protected void a(double $$0, boolean $$1, dsb $$2, iz $$3) {
      ...
      if (!this.dP().B && $$1 && this.ac > 0.0F) {
         ...
         if ((double)this.ac > $$4 && !$$2.i()) {
            ...
            float $$12 = (float)ayy.c((double)this.ac - $$4);
         ...
         if (!this.dP().B) {
            if (this.bE()) {
               ...
               if ($$1 < 0.0) {
                  ...
                  if ($$2 > 0.0) {
                     this.a(this.dQ().v(), (float)Math.max(1, ayy.a(-$$1 * $$2)));
                  }
               }
            }
         }

         if (this.a(awu.a) && !this.dP().a_(iz.a(this.du(), this.dy(), this.dA())).a(dfa.nd)) {
            boolean $$3 = !this.dV() && !bsc.c(this) && (!$$0 || !((cmw)this).gd().a);
            if ($$3) {
   ...
   public boolean dW() {
      return this.ai % 5 == 0 && this.ds().c != 0.0 && this.ds().e != 0.0 && !this.N_() && daa.k(this) && this.dY();
   }
   ...
   @Override
   protected float aN() {
      return this.dY() && daa.a(dac.l, this) > 0 ? 1.0F : super.aN();
   }
   ...
   protected void ea() {
      if (!this.bo().i()) {
         ...
         if ($$0 > 0 && this.dY()) {
            ...
            $$1.c(new buu(d, "Soul speed boost", (double)(0.03F * (1.0F + (float)$$0 * 0.35F)), buu.a.a));
            if (this.el().i() < 0.04F) {
               cuo $$2 = this.a(bta.c);
               $$2.a(1, this, bta.c);
            }
   ...
   protected void ec() {
      if (!this.bo().i()) {
         ...
         if ($$0 > 0) {
            ...
            $$1.c(new buu(e, "Powder snow slow", (double)$$2, buu.a.a));
         }
      }
   }

   protected void c(iz $$0) {
      int $$1 = daa.a(dac.j, this);
      if ($$1 > 0) {
         dad.a(this, this.dP(), $$0, $$1);
      }
   ...
   public float ee() {
      but $$0 = this.eW();
      return $$0 == null ? 1.0F : this.b((float)$$0.c(buw.t));
   }
   ...
   public void a(bta $$0, cuo $$1, cuo $$2) {
      boolean $$3 = $$2.e() && $$1.e();
   ...
   protected void es() {
      Iterator<ji<brz>> $$0 = this.bU.keySet().iterator();
   ...
   private void s() {
      List<lg> $$0 = this.bU.values().stream().filter(bsb::g).map(bsb::a).toList();
      this.ao.a(bL, $$0);
   ...
   public double B(@Nullable bst $$0) {
      double $$1 = 1.0;
      if (this.bY()) {
         $$1 *= 0.8;
      }
   ...
   public boolean c(bto $$0) {
      return $$0 instanceof cmw && this.dP().al() == bqq.a ? false : $$0.et();
   }

   public boolean a(bto $$0, cef $$1) {
      return $$1.a(this, $$0);
   }
   ...
   public static boolean c(Collection<bsb> $$0) {
      for (bsb $$1 : $$0) {
         if ($$1.g() && !$$1.f()) {
            return false;
         }
   ...
   public boolean ew() {
      if (this.dP().B) {
         ...
         Iterator<bsb> $$0 = this.bU.values().iterator();
   ...
   public Collection<bsb> ex() {
      return this.bU.values();
   }

   public Map<ji<brz>, bsb> ey() {
      return this.bU;
   }

   public boolean b(ji<brz> $$0) {
      return this.bU.containsKey($$0);
   }

   @Nullable
   public bsb c(ji<brz> $$0) {
      return this.bU.get($$0);
   }

   public final boolean b(bsb $$0) {
      return this.b($$0, null);
   }

   public boolean b(bsb $$0, @Nullable bst $$1) {
      if (!this.c($$0)) {
         return false;
      } else {
         bsb $$2 = this.bU.get($$0.c());
         boolean $$3 = false;
         if ($$2 == null) {
            this.bU.put($$0.c(), $$0);
            this.a($$0, $$1);
   ...
   public boolean c(bsb $$0) {
      if (this.ak().a(aws.G)) {
         ...
         return !this.ak().a(aws.w) ? true : !$$0.a(bsd.j) && !$$0.a(bsd.s);
      }
   }

   public void c(bsb $$0, @Nullable bst $$1) {
      if (this.c($$0)) {
         bsb $$2 = this.bU.put($$0.c(), $$0);
         if ($$2 == null) {
            this.a($$0, $$1);
         } else {
            $$0.d($$2);
   ...
   @Nullable
   public bsb d(ji<brz> $$0) {
      return this.bU.remove($$0);
   }

   public boolean e(ji<brz> $$0) {
      bsb $$1 = this.d($$0);
      if ($$1 != null) {
         this.a($$1);
         return true;
   ...
   public void t(float $$0) {
      this.ao.a(bK, ayy.a($$0, 0.0F, this.eR()));
   }
   ...
   public boolean a(brm $$0, float $$1) {
      if (this.b($$0)) {
         ...
         return false;
      } else if ($$0.a(awq.j) && this.b(bsd.l)) {
         return false;
      } else {
         ...
         if ($$1 > 0.0F && this.f($$0)) {
            ...
            $$4 = $$1;
            $$1 = 0.0F;
            if (!$$0.a(awq.k) && $$0.c() instanceof bto $$6) {
               this.d($$6);
            }
         ...
         bst $$8 = $$0.d();
         if ($$8 != null) {
            if ($$8 instanceof bto $$9 && !$$0.a(awq.r) && (!$$0.a(brp.G) || !this.ak().a(aws.E))) {
               this.a($$9);
            }

            if ($$8 instanceof cmw $$10) {
               this.bd = 100;
               this.bc = $$10;
            } else if ($$8 instanceof cgh $$11 && $$11.s()) {
               this.bd = 100;
               if ($$11.P_() instanceof cmw $$12) {
                  this.bc = $$12;
               } else {
                  this.bc = null;
               }
   ...
   private boolean h(brm $$0) {
      if ($$0.a(awq.e)) {
         ...
         if ($$1 != null) {
            ...
            this.t(1.0F);
            this.ew();
            this.b(new bsb(bsd.j, 900, 1));
            this.b(new bsb(bsd.v, 100, 1));
            this.b(new bsb(bsd.l, 800, 0));
   ...
   public boolean f(brm $$0) {
      bst $$1 = $$0.c();
      boolean $$2 = false;
      if ($$1 instanceof cnc $$3 && $$3.D() > 0) {
         $$2 = true;
      }
      ...
      if (!$$0.a(awq.d) && this.fC() && !$$2) {
         evq $$4 = $$0.h();
         if ($$4 != null) {
            evq $$5 = this.b(0.0F, this.cs());
            evq $$6 = $$4.a(this.dn());
            $$6 = new evq($$6.c, 0.0, $$6.e).d();
            return $$6.b($$5) < 0.0;
         }
      }
   ...
   protected void f(@Nullable bto $$0) {
      if (!this.dP().B) {
         boolean $$1 = false;
         if ($$0 instanceof ciu) {
            if (this.dP().ab().b(dbt.c)) {
               iz $$2 = this.dp();
               dsb $$3 = dfa.cd.o();
               if (this.dP().a_($$2).i() && $$3.a((dca)this.dP(), $$2)) {
                  this.dP().a($$2, $$3, 3);
                  $$1 = true;
               }
            }
            ...
            if (!$$1) {
               cjg $$4 = new cjg(this.dP(), this.du(), this.dw(), this.dA(), new cuo(cur.dw));
               this.dP().b($$4);
            }
         }
      }
   ...
   protected void eE() {
      if (this.dP() instanceof are && !this.eI() && (this.ek() || this.bd > 0 && this.eh() && this.dP().ab().b(dbt.f))) {
         bte.a((are)this.dP(), this.dn(), this.ej());
      }
   }
   ...
   protected void a(brm $$0, boolean $$1) {
      ald<eqm> $$2 = this.eF();
      eqm $$3 = this.dP().o().be().b($$2);
      eqk.a $$4 = new eqk.a((are)this.dP()).a(etd.a, this).a(etd.f, this.dn()).a(etd.c, $$0).b(etd.d, $$0.d()).b(etd.e, $$0.c());
      if ($$1 && this.bc != null) {
         $$4 = $$4.a(etd.b, this.bc).a(this.bc.gy());
      }
   ...
   public bto.a eL() {
      return new bto.a(avz.kh, avz.jZ);
   }
   ...
   public boolean q_() {
      if (this.N_()) {
         ...
         if ($$1.a(awo.aP)) {
            ...
            return true;
         } else if ($$1.b() instanceof dnl && this.c($$0, $$1)) {
            this.ci = Optional.of($$0);
            return true;
         } else {
            return false;
   ...
   private boolean c(iz $$0, dsb $$1) {
      if ($$1.c(dnl.b)) {
         dsb $$2 = this.dP().a_($$0.d());
         if ($$2.a(dfa.cO) && $$2.c(dje.b) == $$1.c(dnl.aE)) {
            return true;
         }
      }
   ...
   protected int d(float $$0, float $$1) {
      if (this.ak().a(aws.o)) {
         ...
         float $$2 = (float)this.g(buw.s);
         float $$3 = $$0 - $$2;
         return ayy.c((double)($$3 * $$1) * this.g(buw.i));
      }
   }
   ...
   protected void eN() {
      if (!this.aW()) {
         int $$0 = ayy.a(this.du());
         int $$1 = ayy.a(this.dw() - 0.2F);
         int $$2 = ayy.a(this.dA());
         dsb $$3 = this.dP().a_(new iz($$0, $$1, $$2));
         if (!$$3.i()) {
            dml $$4 = $$3.w();
   ...
   protected void a(brm $$0, float $$1, bta... $$2) {
      if (!($$1 <= 0.0F)) {
   ...
   protected float d(brm $$0, float $$1) {
      if (!$$0.a(awq.c)) {
         this.b($$0, $$1);
         $$1 = bri.a($$1, $$0, (float)this.eO(), (float)this.g(buw.b));
      }
   ...
   protected float e(brm $$0, float $$1) {
      if ($$0.a(awq.g)) {
         ...
         if (this.b(bsd.k) && !$$0.a(awq.h)) {
            int $$2 = (this.c(bsd.k).e() + 1) * 5;
            int $$3 = 25 - $$2;
            float $$4 = $$1 * (float)$$3;
            float $$5 = $$1;
   ...
   private int A() {
      if (bsc.a(this)) {
         return 6 - (1 + bsc.b(this));
      } else {
         return this.b(bsd.d) ? 6 + (1 + this.c(bsd.d).e()) * 2 : 6;
      }
   }
   ...
   public void a(bqs $$0, boolean $$1) {
      if (!this.aJ || this.aL >= this.A() / 2 || this.aL < 0) {
         ...
         if (this.dP() instanceof are) {
            ack $$2 = new ack(this, $$0 == bqs.a ? 0 : 3);
            arc $$3 = ((are)this.dP()).l();
            if ($$1) {
               $$3.a(this, $$2);
            } else {
      ...
      switch ($$0) {
         ...
         case 46:
            ...
            for (int $$3 = 0; $$3 < 128; $$3++) {
               ...
               double $$8 = ayy.d($$4, this.L, this.du()) + (this.ah.j() - 0.5) * (double)this.dj() * 2.0;
               double $$9 = ayy.d($$4, this.M, this.dw()) + this.ah.j() * (double)this.dk();
               double $$10 = ayy.d($$4, this.N, this.dA()) + (this.ah.j() - 0.5) * (double)this.dj() * 2.0;
   ...
   @Nullable
   public bus f(ji<bur> $$0) {
      return this.eW().a($$0);
   }

   public double g(ji<bur> $$0) {
      return this.eW().c($$0);
   }

   public double h(ji<bur> $$0) {
      return this.eW().d($$0);
   }
   ...
   public abstract Iterable<cuo> eZ();

   public abstract cuo a(bta var1);

   public abstract void a(bta var1, cuo var2);
   ...
   protected float w(float $$0) {
      return (float)this.g(buw.m) * $$0 * this.aM() + this.fi();
   }

   public float fi() {
      return this.b(bsd.h) ? 0.1F * ((float)this.c(bsd.h).e() + 1.0F) : 0.0F;
   }
   ...
   protected void fj() {
      ...
      if (!($$0 <= 1.0E-5F)) {
         ...
         if (this.cb()) {
            ...
            this.i(new evq((double)(-ayy.a($$2)) * 0.2, 0.0, (double)ayy.b($$2) * 0.2));
         }
   ...
   public void a(evq $$0) {
      if (this.da()) {
         ...
         if (this.be() && this.ef() && !this.a($$3)) {
            ...
            evq $$8 = this.ds();
            if (this.Q && this.q_()) {
               $$8 = new evq($$8.c, 0.2, $$8.e);
            }

            this.h($$8.d((double)$$5, 0.8F, (double)$$5));
            evq $$9 = this.a($$1, $$2, this.ds());
            this.h($$9);
            ...
            if ($$15 < 0.0F && $$16 > 0.0) {
               double $$21 = $$17 * (double)(-ayy.a($$15)) * 0.04;
            ...
            double $$29 = $$28.d;
            if (this.b(bsd.y)) {
               $$29 += (0.05 * (double)(this.c(bsd.y).e() + 1) - $$28.d) * 0.2;
            ...
            if (this.er()) {
               ...
               this.o($$28.c * (double)$$27, this instanceof cfn ? $$29 * (double)$$27 : $$29 * 0.98F, $$28.e * (double)$$27);
            }
         }
      }
   ...
   public void r(boolean $$0) {
      float $$1 = (float)ayy.g(this.du() - this.L, $$0 ? this.dw() - this.M : 0.0, this.dA() - this.N);
      this.x($$1);
   }
   ...
   public evq a(evq $$0, float $$1) {
      ...
      this.a(btt.a, this.ds());
      evq $$2 = this.ds();
      if ((this.Q || this.bn) && (this.q_() || this.dq().a(dfa.qP) && dks.a(this))) {
         $$2 = new evq($$2.c, 0.2, $$2.e);
      }

      return $$2;
   }

   public evq a(double $$0, boolean $$1, evq $$2) {
      if ($$0 != 0.0 && !this.cb()) {
         double $$3;
   ...
   private evq k(evq $$0) {
      if (this.q_()) {
         this.n();
         float $$1 = 0.15F;
         double $$2 = ayy.a($$0.c, -0.15F, 0.15F);
         double $$3 = ayy.a($$0.e, -0.15F, 0.15F);
         double $$4 = Math.max($$0.d, -0.15F);
         if ($$4 < 0.0 && !this.dq().a(dfa.nS) && this.fD() && this instanceof cmw) {
            $$4 = 0.0;
         }
   ...
   protected float fm() {
      return this.cQ() instanceof cmw ? this.fn() * 0.1F : 0.02F;
   }
   ...
   private void a(Map<bta, cuo> $$0) {
      cuo $$1 = $$0.get(bta.a);
      cuo $$2 = $$0.get(bta.b);
      if ($$1 != null && $$2 != null && cuo.a($$1, this.g(bta.b)) && cuo.a($$2, this.g(bta.a))) {
   ...
   private void b(Map<bta, cuo> $$0) {
      List<Pair<bta, cuo>> $$1 = Lists.newArrayListWithCapacity($$0.size());
      $$0.forEach(($$1x, $$2) -> {
         cuo $$3 = $$2.s();
         $$1.add(Pair.of($$1x, $$3));
         switch ($$1x.a()) {
   ...
   private void c(bta $$0, cuo $$1) {
      this.bV.set($$0.b(), $$1);
   }

   protected float e(float $$0, float $$1) {
      float $$2 = ayy.g($$0 - this.aY);
      this.aY += $$2 * 0.3F;
      float $$3 = ayy.g(this.dF() - this.aY);
      float $$4 = this.fo();
      if (Math.abs($$3) > $$4) {
         this.aY = this.aY + ($$3 - (float)ayy.j((double)$$3) * $$4);
      }
   ...
   public void n_() {
      ...
      this.G();
      evl $$8 = this.cK();
      evq $$9 = new evq((double)this.bo, (double)this.bp, (double)this.bq);
      if (this.b(bsd.B) || this.b(bsd.y)) {
         this.n();
      }

      label104: {
         if (this.cQ() instanceof cmw $$10 && this.bD()) {
            this.c($$10, $$9);
            break label104;
         }
   ...
   private void G() {
      boolean $$0 = this.j(7);
      if ($$0 && !this.aE() && !this.bR() && !this.b(bsd.y)) {
         cuo $$1 = this.a(bta.e);
         if ($$1.a(cur.nT) && ctk.j($$1)) {
            $$0 = true;
            int $$2 = this.bB + 1;
            if (!this.dP().B && $$2 % 10 == 0) {
               int $$3 = $$2 / 10;
   ...
   protected void q() {
      if (this.dP().x_()) {
         this.dP().a(dwi.a(cmw.class), this.cK(), bsy.a(this)).forEach(this::D);
      } else {
         List<bst> $$0 = this.dP().a(this, this.cK(), bsy.a(this));
         if (!$$0.isEmpty()) {
            int $$1 = this.dP().ab().c(dbt.u);
   ...
   protected void a(evl $$0, evl $$1) {
      evl $$2 = $$0.b($$1);
      List<bst> $$3 = this.dP().a_(this, $$2);
      if (!$$3.isEmpty()) {
         for (bst $$4 : $$3) {
            if ($$4 instanceof bto) {
               this.g((bto)$$4);
   ...
   public void a(bst $$0, int $$1) {
      if (!$$0.dK() && !this.dP().B && ($$0 instanceof cjg || $$0 instanceof cnc || $$0 instanceof bte)) {
   ...
   public boolean E(bst $$0) {
      if ($$0.dP() != this.dP()) {
         ...
         evq $$1 = new evq(this.du(), this.dy(), this.dA());
         evq $$2 = new evq($$0.du(), $$0.dy(), $$0.dA());
         return $$2.f($$1) > 128.0 ? false : this.dP().a(new dbg($$1, $$2, dbg.a.a, dbg.b.a, this)).c() == evo.a.a;
      }
   }

   @Override
   public float h(float $$0) {
      return $$0 == 1.0F ? this.ba : ayy.i($$0, this.bb, this.ba);
   }
   ...
   public static evq j(evq $$0) {
      return new evq($$0.c, $$0.d, 0.0);
   }
   ...
   public bqs fw() {
      return (this.ao.a(aF) & 2) > 0 ? bqs.b : bqs.a;
   }

   private void H() {
      if (this.fv()) {
         if (cuo.b(this.b(this.fw()), this.bz)) {
   ...
   private void a(cuo $$0, int $$1) {
      for (int $$2 = 0; $$2 < $$1; $$2++) {
         ...
         evq $$5 = new evq(((double)this.ah.i() - 0.5) * 0.3, $$4, 0.6);
   ...
   public boolean fC() {
      if (this.fv() && !this.bz.e()) {
         cuj $$0 = this.bz.g();
         return $$0.c(this.bz) != cwj.d ? false : $$0.b(this.bz) - this.bA >= 5;
      } else {
         return false;
      }
   }
   ...
   @Override
   public boolean cd() {
      return super.cd() || !this.fE() && this.c(bua.b);
   }
   ...
   @Override
   public final bsw a(bua $$0) {
      return $$0 == bua.c ? aG : this.e($$0).a(this.ee());
   }

   protected bsw e(bua $$0) {
   ...
   public evl f(bua $$0) {
      bsw $$1 = this.a($$0);
      return new evl((double)(-$$1.a() / 2.0F), 0.0, (double)(-$$1.a() / 2.0F), (double)($$1.a() / 2.0F), (double)$$1.b(), (double)($$1.a() / 2.0F));
   }

   protected boolean g(bua $$0) {
      evl $$1 = this.a($$0).a(this.dn());
   ...
   public void b(iz $$0) {
      ...
      dsb $$1 = this.dP().a_($$0);
      if ($$1.b() instanceof der) {
         this.dP().a($$0, $$1.a(der.c, Boolean.valueOf(true)), 3);
      }
   ...
   private boolean M() {
      return this.fJ().map($$0 -> this.dP().a_($$0).b() instanceof der).orElse(false);
   }
   ...
   public void fM() {
      this.fJ().filter(this.dP()::B).ifPresent($$0x -> {
         ...
         if ($$1.b() instanceof der) {
            je $$2 = $$1.c(der.aE);
            this.dP().a($$0x, $$1.a(der.c, Boolean.valueOf(false)), 3);
            evq $$3 = der.a(this.ak(), this.dP(), $$0x, $$2, this.dF()).orElseGet(() -> {
               iz $$1x = $$0x.c();
               return new evq((double)$$1x.u() + 0.5, (double)$$1x.v() + 0.1, (double)$$1x.w() + 0.5);
            });
            evq $$4 = evq.c($$0x).d($$3).d();
            float $$5 = (float)ayy.d(ayy.d($$4.e, $$4.c) * 180.0F / (float)Math.PI - 90.0);
            this.a_($$3.c, $$3.d, $$3.e);
            this.r($$5);
            this.s(0.0F);
         }
   ...
   public je fN() {
      ...
      return $$0 != null ? der.a(this.dP(), $$0) : null;
   }
   ...
   public static bta d(bqs $$0) {
      return $$0 == bqs.a ? bta.a : bta.b;
   }

   @Override
   public evl h_() {
      if (this.a(bta.f).a(cur.uq)) {
         float $$0 = 0.5F;
   ...
   public static bta h(cuo $$0) {
      ctq $$1 = ctq.c_($$0);
      return $$1 != null ? $$1.m() : bta.a;
   }

   private static bug a(bto $$0, bta $$1) {
      return $$1 != bta.f && $$1 != bta.a && $$1 != bta.b ? bug.a($$0, $$1, $$1x -> $$1x.e() || btq.h($$1x) == $$1) : bug.a($$0, $$1);
   }

   @Nullable
   private static bta s(int $$0) {
      if ($$0 == 100 + bta.f.b()) {
         return bta.f;
      } else if ($$0 == 100 + bta.e.b()) {
         return bta.e;
      } else if ($$0 == 100 + bta.d.b()) {
         return bta.d;
      } else if ($$0 == 100 + bta.c.b()) {
         return bta.c;
      } else if ($$0 == 98) {
         return bta.a;
      } else if ($$0 == 99) {
   ...
   public boolean dD() {
      if (this.N_()) {
         ...
         boolean $$0 = !this.a(bta.f).a(awx.ba) && !this.a(bta.e).a(awx.ba) && !this.a(bta.d).a(awx.ba) && !this.a(bta.c).a(awx.ba) && !this.a(bta.g).a(awx.ba);
         return $$0 && super.dD();
      }
   }
   ...
   @Override
   public boolean cg() {
      return !this.dP().x_() && this.b(bsd.x) || super.cg();
   }
   ...
   public boolean fO() {
      return this.eX().g() instanceof csi;
   }

   @Override
   public float dJ() {
      float $$0 = (float)this.g(buw.v);
      return this.cQ() instanceof cmw ? Math.max($$0, 1.0F) : $$0;
   }
   ...
   protected void a(int $$0, double $$1) {
      this.ba = (float)ayy.e(1.0 / (double)$$0, (double)this.ba, $$1);
   }

   @Override
   public void h(int $$0) {
      super.h(dai.a(this, $$0));
   }
