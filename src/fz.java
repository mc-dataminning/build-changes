...
public class fz implements ArgumentType<UUID> {
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ww.c("argument.uuid.invalid"));
   ...
   public static UUID a(CommandContext<ei> $$0, String $$1) {
