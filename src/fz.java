...
public class fz implements Predicate<cmx> {
   ...
   private final ih<cms> b;
   @Nullable
   private final sn c;

   public fz(ih<cms> $$0, @Nullable sn $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public cmx a(int $$0, boolean $$1) throws CommandSyntaxException {
      cmx $$2 = new cmx(this.b, $$0);
      if (this.c != null) {
         $$2.c(this.c);
      }
