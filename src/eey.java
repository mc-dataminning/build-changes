...
public class eey extends eel<egi> {
   public eey(Codec<egi> $$0) {
      super($$0);
   }
   ...
   private void a(azs $$0, dfc $$1, int $$2, int $$3, jh $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, jh $$2, dfc $$3, boolean $$4, double $$5, jh $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dfc $$0, jh $$1) {
      if ($$0.a_($$1.d()).a(dig.dN)) {
         this.a($$0, $$1.d(), dig.a.m());
      }
   }

   private void a(dfc $$0, azs $$1, jh $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dvj $$13) {
   ...
   private void a(jh $$0, dfc $$1, azs $$2, int $$3, int $$4, boolean $$5, boolean $$6, dvj $$7) {
      dvj $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dig.dP) || $$8.a(dig.dO) || $$8.a(dig.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dig.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dig.dP.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, jh $$2, int $$3, azs $$4) {
   ...
   private static boolean c(dvj $$0) {
      return $$0.a(dig.iC) || $$0.a(dig.dP) || $$0.a(dig.mW);
   }
   ...
   private void a(dfc $$0, jh $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dig.dN)) {
                  if (this.a((deg)$$0, $$10)) {
                     this.a($$0, $$10, dig.a.m());
                     this.a($$0, $$10.d(), dig.a.m());
                  } else if (c($$11)) {
                     dvj[] $$12 = new dvj[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
