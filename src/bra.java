...
public abstract class bra<R extends Runnable> implements bqh, brg<R>, Executor {
   ...
   @Override
   public List<bqe> bw() {
      return ImmutableList.of(bqe.a(this.b + "-pending-tasks", bqd.b, this::by));
   }
