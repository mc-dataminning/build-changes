...
public class hkr {
   ...
   private final hkq r;
   private final hks s = new hks();
   private final hki t = new hki(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hkr.a> w = new AtomicReference<>(hkr.a.c);
   private final Map<hjo, hki.a> x = Maps.newHashMap();
   private final Multimap<awb, hjo> y = HashMultimap.create();
   private final List<hjp> z = Lists.newArrayList();
   private final Map<hjo, Integer> A = Maps.newHashMap();
   private final Map<hjo, Integer> B = Maps.newHashMap();
   private final List<hkt> C = Lists.newArrayList();
   private final List<hjp> D = Lists.newArrayList();
   private final List<hjl> E = Lists.newArrayList();

   public hkr(hku $$0, fmk $$1, aus $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hkq($$2);
   }
   ...
   public void a(hjo $$0, float $$1) {
      if (this.o) {
         hki.a $$2 = this.x.get($$0);
         if ($$2 != null) {
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hkr.a.c, hkr.a.a)) {
               String $$2 = this.n.aw().c();
               af.i().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hkr.a.a, hkr.a.b);
                     }
                  ...
                  this.w.compareAndSet(hkr.a.a, hkr.a.c);
               });
            }
         }

         return this.w.compareAndSet(hkr.a.b, hkr.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hjo::s).forEach(this::c);
      this.D.clear();
      ...
      Iterator<Entry<hjo, hki.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hjo, hki.a> $$6 = $$5.next();
         hki.a $$7 = $$6.getValue();
         hjo $$8 = $$6.getKey();
      ...
      Iterator<Entry<hjo, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hjo, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hjo $$13 = $$12.getKey();
            if ($$13 instanceof hjp) {
               ((hjp)$$13).q();
            }
   ...
   private static boolean d(hjo $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hjo $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hjo $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hjo $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hku.e) {
                  if ($$3 == hku.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hjo.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hki.a> $$16 = this.t.a($$3.g() ? fee.c.b : fee.c.a);
                           hki.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hjo $$0) {
      return ayz.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hjo $$0) {
