...
public class dqs implements dqc {
   public static final Codec<dqs> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               duo.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               aqj.b(je.e).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               dsd.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               dsd.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dmb.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, dqs::new)
   );
   ...
   public dqs(hg<duo> $$0, int $$1, int $$2, aqj<csx> $$3, dsd $$4, int $$5, int $$6, int $$7, int $$8, dsd $$9, int $$10, int $$11, dmb $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
