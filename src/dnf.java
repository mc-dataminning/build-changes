...
public class dnf {
   ...
   private final Map<Character, Predicate<dnd>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dnf a(char $$0, Predicate<dnd> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dne b() {
      return new dne(this.c());
   }

   private Predicate<dnd>[][][] c() {
      this.d();
      Predicate<dnd>[][][] $$0 = (Predicate<dnd>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dnd>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
