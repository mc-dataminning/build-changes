...
public class ccy extends ccf {
   ...
   protected double g;
   protected boolean h;
   private final Function<bvp, axf<btd>> a;

   public ccy(bvp $$0, double $$1) {
      this($$0, $$1, awr.F);
   }

   public ccy(bvp $$0, double $$1, axf<btd> $$2) {
      this($$0, $$1, $$1x -> $$2);
   }

   public ccy(bvp $$0, double $$1, Function<bvp, axf<btd>> $$2) {
      this.c = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   @Nullable
   protected ji a(dfn $$0, bul $$1, int $$2) {
      ji $$3 = $$1.dv();
