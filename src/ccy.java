...
public class ccy extends cca {
   private static final aee<Byte> g = aeh.a(ccy.class, aeg.a);
   private static final aee<Boolean> h = aeh.a(ccy.class, aeg.k);
   ...
   private boolean K() {
      biq $$0 = this.v();
      return $$0 == null || !$$0.bv() ? false : !($$0 instanceof akr) || !$$0.M_();
   }
   ...
   protected void a(ehk $$0) {
      ...
      float $$8 = 1.0F;
      if (this.dL() instanceof akq && this.dL().Y() && this.I()) {
         gw $$9 = $$1.dl();
         if (this.dL().g($$9)) {
            bjf $$10 = biu.ai.a(this.dL());
            if ($$10 != null) {
               $$10.d(ehn.c($$9));
               $$10.b($$4 instanceof akr ? (akr)$$4 : null);
               this.dL().b($$10);
               $$6 = apd.xU;
               $$8 = 5.0F;
            }
