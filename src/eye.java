...
public class eye {
   private final List<ConcurrentLinkedQueue<eyd>> a = ImmutableList.of(
   ...
   public void a(eyd $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eyd> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eyd> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eyd> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eyd> j() {
