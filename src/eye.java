...
public class eye implements eyb {
   @Nullable
   ...
   public eye(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      ...
      try {
         FT_Vector $$11 = fkf.a(FT_Vector.malloc($$10), $$8, $$9);
   ...
   public eya a(int $$0) {
      ...
      if (this.e.contains($$0)) {
         ...
         if ($$2 == 0) {
            ...
            fkf.a(FreeType.FT_Load_Glyph($$1, $$2, 4194312), "Loading glyph");
            FT_GlyphSlot $$3 = Objects.requireNonNull($$1.glyph(), "Glyph not initialized");
            float $$4 = fkf.a($$3.advance());
            FT_Bitmap $$5 = $$3.bitmap();
            int $$6 = $$3.bitmap_left();
            int $$7 = $$3.bitmap_top();
            int $$8 = $$5.width();
            int $$9 = $$5.rows();
            return (eya)($$8 > 0 && $$9 > 0 ? new eye.a((float)$$6, (float)$$7, $$8, $$9, $$4, $$2) : () -> $$4 / this.d);
         }
      }
   }
   ...
   public void close() {
      if (this.c != null) {
         synchronized (fkf.a) {
            fkf.b(FreeType.FT_Done_Face(this.c), "Deleting face");
         }
      ...
      public fjz bake(Function<eyc, fjz> $$0) {
         return $$0.apply(new eyc() {
            ...
            public void a(int $$0, int $$1) {
               FT_Face $$2 = eye.this.b();
               eyz $$3 = new eyz(eyz.a.d, a.this.b, a.this.c, false);
               if ($$3.a($$2, a.this.g)) {
