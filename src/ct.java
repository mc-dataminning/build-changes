...
public class ct extends cw<ct.a> {
   protected ct.a a(JsonObject $$0, Optional<bc> $$1, bg $$2) {
      aey $$3 = new aey(arp.i($$0, "recipe_id"));
      List<cb> $$4 = cb.b($$0.get("ingredients"));
      return new ct.a($$1, $$3, $$4);
   }

   public void a(akt $$0, aey $$1, List<cjh> $$2) {
   ...
   public static class a extends at {
      ...
      public a(Optional<bc> $$0, aey $$1, List<cb> $$2) {
         super($$0);
         this.a = $$1;
         this.b = $$2;
      }

      public static am<ct.a> a(aey $$0, List<cb.a> $$1) {
         return al.Z.a(new ct.a(Optional.empty(), $$0, $$1.stream().map(cb.a::b).toList()));
      }

      public static am<ct.a> a(aey $$0) {
         return al.Z.a(new ct.a(Optional.empty(), $$0, List.of()));
      }

      boolean b(aey $$0, List<cjh> $$1) {
         if (!$$0.equals(this.a)) {
            return false;
         } else {
            List<cjh> $$2 = new ArrayList<>($$1);

            for (cb $$3 : this.b) {
               boolean $$4 = false;
               Iterator<cjh> $$5 = $$2.iterator();
