...
public class ct extends cx<ct.a> {
   ...
   public static record a(Optional<bc> b) implements cx.a {
      public static final Codec<ct.a> a = RecordCodecBuilder.create($$0 -> $$0.group(aws.a(br.b, "player").forGetter(ct.a::a)).apply($$0, ct.a::new));
      ...
      public static an<ct.a> a(dby $$0, cre $$1) {
