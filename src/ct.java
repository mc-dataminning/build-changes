...
public class ct extends cx<ct.a> {
   ...
   public static record a(Optional<bc> b) implements cx.a {
      public static final Codec<ct.a> a = RecordCodecBuilder.create($$0 -> $$0.group(awu.a(br.b, "player").forGetter(ct.a::a)).apply($$0, ct.a::new));
      ...
      public static an<ct.a> a(dch $$0, crn $$1) {
