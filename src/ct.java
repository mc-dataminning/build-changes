...
public class ct extends cw<ct.a> {
   protected ct.a a(JsonObject $$0, Optional<bc> $$1, bg $$2) {
      aex $$3 = new aex(aro.i($$0, "recipe_id"));
      List<cb> $$4 = cb.b($$0.get("ingredients"));
      return new ct.a($$1, $$3, $$4);
   }

   public void a(aks $$0, aex $$1, List<cjf> $$2) {
   ...
   public static class a extends at {
      ...
      public a(Optional<bc> $$0, aex $$1, List<cb> $$2) {
         super($$0);
         this.a = $$1;
         this.b = $$2;
      }

      public static am<ct.a> a(aex $$0, List<cb.a> $$1) {
         return al.Z.a(new ct.a(Optional.empty(), $$0, $$1.stream().map(cb.a::b).toList()));
      }

      public static am<ct.a> a(aex $$0) {
         return al.Z.a(new ct.a(Optional.empty(), $$0, List.of()));
      }

      boolean b(aex $$0, List<cjf> $$1) {
         if (!$$0.equals(this.a)) {
            return false;
         } else {
