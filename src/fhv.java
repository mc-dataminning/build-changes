...
public class fhv<T extends bvw> extends few<T> {
   ...
   public static fik c() {
      ...
      fin $$1 = $$0.a();
      float $$2 = 13.5F;
      fin $$3 = $$1.a("head", fij.c(), fig.a(-1.0F, 13.5F, -7.0F));
      $$3.a(
         "real_head",
         fij.c()
            .a(0, 0)
      ...
      $$1.a("body", fij.c().a(18, 14).a(-3.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F), fig.a(0.0F, 14.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$1.a("upper_body", fij.c().a(21, 0).a(-3.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F), fig.a(-1.0F, 14.0F, -3.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fij $$4 = fij.c().a(0, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F);
      $$1.a("right_hind_leg", $$4, fig.a(-2.5F, 16.0F, 7.0F));
      $$1.a("left_hind_leg", $$4, fig.a(0.5F, 16.0F, 7.0F));
      $$1.a("right_front_leg", $$4, fig.a(-2.5F, 16.0F, -4.0F));
      $$1.a("left_front_leg", $$4, fig.a(0.5F, 16.0F, -4.0F));
      fin $$5 = $$1.a("tail", fij.c(), fig.a(-1.0F, 12.0F, 8.0F, (float) (Math.PI / 5), 0.0F, 0.0F));
      $$5.a("real_tail", fij.c().a(9, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F), fig.a);
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      if ($$0.X_()) {
         ...
         this.n.f = ary.b($$1 * 0.6662F) * 1.4F * $$2;
      }
      ...
      if ($$0.y()) {
         ...
         this.j.e = ary.b($$1 * 0.6662F) * 1.4F * $$2;
         this.k.e = ary.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.l.e = ary.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.m.e = ary.b($$1 * 0.6662F) * 1.4F * $$2;
      }
