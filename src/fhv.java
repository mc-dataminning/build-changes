...
public class fhv extends fhk implements fip {
   private static final fiz d = new fiz(new akk("widget/text_field"), new akk("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, axq> D = ($$0x, $$1x) -> axq.forward($$0x, xr.a);
   @Nullable
   private wu E;
   private long F = ac.c();

   public fhv(fgx $$0, int $$1, int $$2, wu $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fhv(fgx $$0, int $$1, int $$2, int $$3, int $$4, wu $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fhv(fgx $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fhv $$5, wu $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, axq> $$0) {
      this.D = $$0;
   }
   ...
   protected xi aL_() {
      wu $$0 = this.z();
      return wu.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = aye.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void b(fgz $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         int $$12 = $$10;
         int $$13 = aye.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gef.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = aye.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = aye.a(this.v, 0, this.p.length());
      }
   }
