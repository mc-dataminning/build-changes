...
public class fhv {
   ...
   @Nullable
   private fhv v;
   private final List<fhv> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fhv(fht $$0, ezi $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
   ...
   private static float a(ezu $$0, List<vz> $$1) {
   ...
   public void a(fav $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
