...
public class fhv {
   ...
   public static fhs a(fhs $$0) {
      return $$0;
   }

   public static fhs a(fhs $$0, fhs $$1) {
      return new fhv.a($$0, $$1);
   }
   ...
   static class a implements fhs {
      private final fhs a;
      private final fhs b;

      public a(fhs $$0, fhs $$1) {
         if ($$0 == $$1) {
   ...
   static record b(fhs[] a) implements fhs {
      b(fhs[] a) {
