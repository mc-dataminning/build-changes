public class fvm extends fva<csl> {
   ...
   protected void a(foe $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(gmi::H, G, $$4, $$5, 0.0F, 0.0F, this.s, this.H * 18 + 17, 256, 256);
      $$0.a(gmi::H, G, $$4, $$5 + this.H * 18 + 17, 0.0F, 126.0F, this.s, 96, 256, 256);
   }
}
