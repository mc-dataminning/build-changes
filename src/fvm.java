public class fvm extends fum<cud> {
   ...
   public fvm(cud $$0, cpv $$1, cka $$2, int $$3) {
      super($$0, $$1, $$2.p_());
      this.L = $$2;
      this.M = $$3;
   }
   ...
   protected void a(fnr $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(glu::C, K, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      if (this.M > 0) {
         $$0.a(glu::C, G, 90, 54, 0, 0, $$4 + 79, $$5 + 17, this.M * 18, 54);
      }

      if (this.L.f()) {
         $$0.a(glu::C, H, $$4 + 7, $$5 + 35 - 18, 18, 18);
      }

      if (this.L.e(bvr.g)) {
         if (this.L instanceof ckd) {
            $$0.a(glu::C, I, $$4 + 7, $$5 + 35, 18, 18);
         } else {
            $$0.a(glu::C, J, $$4 + 7, $$5 + 35, 18, 18);
         }
      }

      fvn.a($$0, $$4 + 26, $$5 + 18, $$4 + 78, $$5 + 70, 17, 0.25F, this.N, this.O, this.L);
   }
