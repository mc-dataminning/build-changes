...
public class ckh extends clh {
   ...
   public ckh(int $$0, chk $$1) {
      this($$0, $$1, ckq.a);
   }

   public ckh(int $$0, chk $$1, ckq $$2) {
      super(clm.i, $$0, $$1, $$2);
      this.a(this.w);
   }
   ...
   @Override
   protected cli l() {
      return cli.a().a(0, 27, 47, $$0 -> true).a(1, 76, 47, $$0 -> true).a(2, 134, 47).a();
   }
   ...
   protected boolean a(chl $$0, boolean $$1) {
      return ($$0.fU().d || $$0.cj >= this.w.b()) && this.w.b() > 0;
   }
   ...
   protected void a(chl $$0, cpd $$1) {
      ...
      this.o.a(($$1x, $$2x) -> {
         dlj $$3 = $$1x.a_($$2x);
         if (!$$0.fU().d && $$3.a(aua.M) && $$0.eh().i() < 0.12F) {
            dlj $$4 = cxs.e($$3);
            if ($$4 == null) {
               $$1x.a($$2x, false);
               $$1x.c(1029, $$2x, 0);
   ...
   public void m() {
      ...
      if ($$0.b()) {
         ...
         cpd $$4 = $$0.q();
         cpd $$5 = this.q.a(1);
         Map<ctm, Integer> $$6 = ctn.a($$4);
         $$2 += $$0.J() + ($$5.b() ? 0 : $$5.J());
         this.u = 0;
         if (!$$5.b()) {
            boolean $$7 = $$5.a(cpg.us) && !cnz.d($$5).isEmpty();
            if ($$4.i() && $$4.d().a($$0, $$5)) {
               ...
               Map<ctm, Integer> $$16 = ctn.a($$5);
               boolean $$17 = false;
               boolean $$18 = false;

               for (ctm $$19 : $$16.keySet()) {
                  if ($$19 != null) {
                     int $$20 = $$6.getOrDefault($$19, 0);
                     int $$21 = $$16.get($$19);
                     $$21 = $$20 == $$21 ? $$21 + 1 : Math.max($$21, $$20);
                     boolean $$22 = $$19.a($$0);
                     if (this.p.fU().d || $$0.a(cpg.us)) {
                        $$22 = true;
                     }
