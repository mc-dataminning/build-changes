...
public class ckh extends coi {
   private static final Predicate<bst> e = $$0 -> $$0.bD() && !($$0 instanceof ckh);
   ...
   public ckh(bsz<? extends ckh> $$0, dbx $$1) {
      super($$0, $$1);
      this.bN = 20;
      this.a(eol.v, 0.0F);
   }
   ...
   protected void z() {
      ...
      this.bS.a(4, new caw(this, 1.0, true));
      this.bS.a(5, new cbz(this, 0.4));
      this.bS.a(6, new cau(this, cmw.class, 6.0F));
      this.bS.a(10, new cau(this, btq.class, 8.0F));
      this.bT.a(2, new cce(this, coi.class).a());
      this.bT.a(3, new ccf<>(this, cmw.class, true));
      this.bT.a(4, new ccf<>(this, cme.class, true, $$0 -> !$$0.p_()));
      this.bT.a(4, new ccf<>(this, cfq.class, true));
   }

   @Override
   protected void S() {
      boolean $$0 = !(this.cQ() instanceof btq) || this.cQ().ak().a(aws.c);
   ...
   public static buv.a s() {
      return ckc.gw().a(buw.q, 100.0).a(buw.r, 0.3).a(buw.n, 0.75).a(buw.c, 12.0).a(buw.d, 1.5).a(buw.k, 32.0).a(buw.v, 1.0);
   }
   ...
   public void n_() {
      ...
      if (this.bD()) {
         if (this.fg()) {
            ...
            double $$1 = this.f(buw.r).b();
            this.f(buw.r).a(ayy.d(0.1, $$1, $$0));
         }

         if (this.Q && this.dP().ab().b(dbt.c)) {
            boolean $$2 = false;
            evl $$3 = this.cK().g(0.2);

            for (iz $$4 : iz.b(ayy.a($$3.a), ayy.a($$3.b), ayy.a($$3.c), ayy.a($$3.d), ayy.a($$3.e), ayy.a($$3.f))) {
               dsb $$5 = this.dP().a_($$4);
               dey $$6 = $$5.b();
               if ($$6 instanceof dji) {
   ...
   private void gC() {
      if (this.bD()) {
         for (bto $$1 : this.dP().a(bto.class, this.cK().g(4.0), e)) {
            if (!($$1 instanceof cjj)) {
               $$1.a(this.dQ().b((bto)this), 6.0F);
            }
