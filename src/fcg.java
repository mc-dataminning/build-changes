public class fcg extends fbt<chd> implements feo {
   private static final agi x = new agi("textures/gui/container/crafting_table.png");
   private final fei y = new fei();
   private boolean z;

   public fcg(chd $$0, cdt $$1, ur $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aP_() {
      ...
      this.d(new evl(this.t + 5, this.h / 2 - 49, 20, 18, fei.a, $$0 -> {
         this.y.f();
         this.t = this.y.a(this.g, this.c);
