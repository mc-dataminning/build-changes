public class fcg<T extends bwe> extends fbo<T> {
   ...
   public static fek b() {
      ...
      fen $$3 = $$2.a("tail_base", fej.c().a(3, 20).a(-2.0F, 0.0F, 0.0F, 3.0F, 2.0F, 6.0F), feg.a(0.0F, -2.0F, 1.0F));
      $$3.a("tail_tip", fej.c().a(4, 29).a(-1.0F, 0.0F, 0.0F, 1.0F, 1.0F, 6.0F), feg.a(0.0F, 0.5F, 6.0F));
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      float $$6 = ((float)$$0.r() + $$3) * 7.448451F * (float) (Math.PI / 180.0);
      float $$7 = 16.0F;
      this.g.g = apa.b($$6) * 16.0F * (float) (Math.PI / 180.0);
      this.h.g = apa.b($$6) * 16.0F * (float) (Math.PI / 180.0);
      this.i.g = -this.g.g;
      this.j.g = -this.h.g;
      this.k.e = -(5.0F + apa.b($$6 * 2.0F) * 5.0F) * (float) (Math.PI / 180.0);
      this.l.e = -(5.0F + apa.b($$6 * 2.0F) * 5.0F) * (float) (Math.PI / 180.0);
   }
}
