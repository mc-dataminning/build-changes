...
public class cln {
   ...
   @VisibleForTesting
   protected final ArrayList<bsg> c;
   private final cln.a k;
   @VisibleForTesting
   protected final Object2IntMap<bsg> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cln> a(Predicate<bsg> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cln::b)).apply($$1, $$1x -> new cln($$0, $$1x))
      );
   }

   public cln(Predicate<bsg> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cln.a(this);
   ...
   public void a(aqm $$0, Predicate<bsg> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bsg>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bsg> $$6 = (Entry<bsg>)$$5.next();
         int $$7 = $$6.getIntValue();
         bsg $$8 = (bsg)$$6.getKey();
         bsg.c $$9 = $$8.dM();
   ...
   public int b(@Nullable bsg $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<btb> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof btb).map($$0 -> (btb)$$0);
   }

   @VisibleForTesting
   protected static record a(cln a) implements Comparator<bsg> {
      public int a(bsg $$0, bsg $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cmk;
               boolean $$7 = $$1 instanceof cmk;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
