...
public class cln extends clu {
   public static final float a = bus.M.l() / bus.ai.l();
   ...
   public cln(bus<? extends cln> $$0, dgi $$1) {
      super($$0, $$1);
      this.fY();
      if (this.c != null) {
         this.c.c(400);
   ...
   public static bwo.a m() {
      return clu.x().a(bwp.v, 0.3F).a(bwp.c, 8.0).a(bwp.s, 80.0);
   }
   ...
   protected void a(ard $$0) {
      ...
      if ((this.af + this.ar()) % 1200 == 0) {
         ...
         List<are> $$2 = btr.a($$0, this, this.dt(), 50.0, $$1, 1200);
