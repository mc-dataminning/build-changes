...
public abstract class cln extends clz {
   private static final double g = 2.0;
   private static final ajm<Byte> h = ajq.a(cln.class, ajo.a);
   private static final ajm<Byte> i = ajq.a(cln.class, ajo.a);
   ...
   protected boolean b;
   protected int c;
   public cln.a d = cln.a.a;
   public int e;
   private int n;
   private double o = 2.0;
   private int p;
   private avb q = this.r();
   @Nullable
   private IntOpenHashSet r;
   @Nullable
   private List<brh> s;
   private csz t = this.x();

   protected cln(brn<? extends cln> $$0, dad $$1) {
      super($$0, $$1);
   }

   protected cln(brn<? extends cln> $$0, dad $$1, csz $$2) {
      this($$0, $$1);
      this.t = $$2.r();
      this.b($$2.a(ka.f));
      azb $$3 = $$2.c(ka.s);
   ...
   protected cln(brn<? extends cln> $$0, double $$1, double $$2, double $$3, dad $$4, csz $$5) {
      this($$0, $$4, $$5);
      this.a_($$1, $$2, $$3);
   }

   protected cln(brn<? extends cln> $$0, bsa $$1, dad $$2, csz $$3) {
   ...
   public void l() {
      ...
      if (this.P == 0.0F && this.O == 0.0F) {
         double $$2 = $$1.h();
         this.r((float)(axz.d($$1.c, $$1.e) * 180.0F / (float)Math.PI));
         this.s((float)(axz.d($$1.d, $$2) * 180.0F / (float)Math.PI));
         this.O = this.dD();
         this.P = this.dF();
      }
      ...
      if (this.b && !$$0) {
         ...
         etp $$8 = this.dl();
         etp $$9 = $$8.e($$1);
         etn $$10 = this.dN().a(new czm($$8, $$9, czm.a.a, czm.b.a, this));
         if ($$10.c() != etn.a.a) {
            $$9 = $$10.e();
         }
         ...
         while (!this.dI() && !this.f) {
            ...
            if ($$10 != null && $$10.c() == etn.a.c) {
               brh $$12 = ((etm)$$10).a();
               brh $$13 = this.u();
               if ($$12 instanceof clh && $$13 instanceof clh && !((clh)$$13).a((clh)$$12)) {
                  $$10 = null;
                  $$11 = null;
               }
            }
         ...
         double $$21 = $$1.h();
         if ($$0) {
            this.r((float)(axz.d(-$$14, -$$16) * 180.0F / (float)Math.PI));
         } else {
            this.r((float)(axz.d($$14, $$16) * 180.0F / (float)Math.PI));
         }

         this.s((float)(axz.d($$15, $$21) * 180.0F / (float)Math.PI));
         ...
         if (this.bc()) {
            for (int $$23 = 0; $$23 < 4; $$23++) {
               float $$24 = 0.25F;
               this.dN().a(kx.d, $$18 - $$14 * 0.25, $$19 - $$15 * 0.25, $$20 - $$16 * 0.25, $$14, $$15, $$16);
            }
   ...
   private boolean H() {
      return this.b && this.dN().b(new etk(this.dl(), this.dl()).g(0.06));
   }
   ...
   protected void a(etm $$0) {
      ...
      int $$3 = axz.c(axz.a((double)$$2 * this.o, 0.0, 2.147483647E9));
      if (this.D() > 0) {
         if (this.r == null) {
      ...
      if ($$1.a($$6, (float)$$3)) {
         ...
         if ($$1 instanceof bsa $$10) {
            if (!this.dN().B && this.D() <= 0) {
               $$10.q($$10.eR() + 1);
            }

            if (this.p > 0) {
               double $$11 = Math.max(0.0, 1.0 - $$10.g(bth.n));
               etp $$12 = this.dq().d(1.0, 0.0, 1.0).d().a((double)this.p * 0.6 * $$11);
               if ($$12.g() > 0.0) {
                  $$10.j($$12.c, 0.1, $$12.e);
               }
            }

            if (!this.dN().B && $$5 instanceof bsa) {
               cyh.a($$10, $$5);
               cyh.b((bsa)$$5, $$10);
            }

            this.a($$10);
            if ($$5 != null && $$10 != $$5 && $$10 instanceof clh && $$5 instanceof aqi && !this.aU()) {
               ((aqi)$$5).d.b(new act(act.h, 0.0F));
            }
            ...
            if (!this.dN().B && $$5 instanceof aqi $$13) {
   ...
   protected void a(etl $$0) {
      ...
      super.a($$0);
      etp $$1 = $$0.e().a(this.ds(), this.du(), this.dy());
      this.g($$1);
      etp $$2 = $$1.d().a(0.05F);
   ...
   protected etm a(etp $$0, etp $$1) {
      return cmb.a(this.dN(), this, $$0, $$1, this.cI().b(this.dq()).g(1.0), this::b);
   }
   ...
   public void b(ua $$0) {
      ...
      $$0.a("SoundEvent", ld.b.b(this.q).toString());
   ...
   public void a(ua $$0) {
      ...
      if ($$0.b("inBlockState", 10)) {
         this.m = up.a(this.dN().a(le.f), $$0.p("inBlockState"));
      }
      ...
      this.d = cln.a.a($$0.f("pickup"));
      this.a($$0.q("crit"));
      this.a($$0.f("PierceLevel"));
      if ($$0.b("SoundEvent", 8)) {
         this.q = ld.b.b(new akh($$0.l("SoundEvent"))).orElse(this.r());
      }

      this.q($$0.q("ShotFromCrossbow"));
      if ($$0.b("item", 10)) {
         this.a(csz.a(this.dP(), (ux)$$0.p("item")).orElse(this.x()));
      } else {
         this.a(this.t);
      }
   }
   ...
   public void c(@Nullable brh $$0) {
      super.c($$0);
      if ($$0 instanceof clh && this.d == cln.a.a) {
         this.d = cln.a.b;
      }
   }
