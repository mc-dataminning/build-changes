...
public class bup extends bud {
   ...
   public void c() {
      if (this.g == null) {
         ...
         double $$6 = this.f == null ? 0.0 : this.f.c(this.a.dn(), this.a.dp(), this.a.dt());
         ...
         if (this.g.f(this.a) < 4096.0) {
            if (this.a.B(this.g)) {
               ...
               eei $$9 = new eei((double)apa.a(this.a.dy() * (float) (Math.PI / 180.0)), 0.0, (double)(-apa.b(this.a.dy() * (float) (Math.PI / 180.0)))).d();
