...
public class efc extends eew<ehb> {
   private static final jm[] a = jm.values();

   public efc(Codec<ehb> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eey<ehb> $$0) {
      ehb $$1 = $$0.f();
      azu $$2 = $$0.d();
      jh $$3 = $$0.e();
      dgk $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      ecp $$9 = new ecp(new ebr($$4.D()));
      eqy $$10 = eqy.a($$9, -4, 1.0);
      ...
      for (jh $$33 : jh.c($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<jh, Integer> $$37 : $$7) {
            $$35 += azm.f($$33.j((kl)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }
      ...
      for (jh $$44 : $$31) {
         ...
         for (jm $$46 : a) {
            ...
            dvv $$48 = $$4.a_($$47);
            if ($$45.b(dwl.C)) {
               $$45 = $$45.b(dwl.C, Boolean.valueOf($$48.y().b()));
            }
