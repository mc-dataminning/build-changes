...
public class efc extends eep<egm> {
   public efc(Codec<egm> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? azn.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(azv $$0, dfg $$1, int $$2, int $$3, jh $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, jh $$2, dfg $$3, boolean $$4, double $$5, jh $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dfg $$0, jh $$1) {
      if ($$0.a_($$1.d()).a(dil.dN)) {
         this.a($$0, $$1.d(), dil.a.m());
      }
   }

   private void a(dfg $$0, azv $$1, jh $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dvo $$13) {
   ...
   private void a(jh $$0, dfg $$1, azv $$2, int $$3, int $$4, boolean $$5, boolean $$6, dvo $$7) {
      dvo $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dil.dP) || $$8.a(dil.dO) || $$8.a(dil.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dil.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dil.dP.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, jh $$2, int $$3, azv $$4) {
      float $$5 = 10.0F * azn.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private static boolean c(dvo $$0) {
      return $$0.a(dil.iC) || $$0.a(dil.dP) || $$0.a(dil.mW);
   }
   ...
   private void a(dfg $$0, jh $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dil.dN)) {
                  if (this.a((dek)$$0, $$10)) {
                     this.a($$0, $$10, dil.a.m());
                     this.a($$0, $$10.d(), dil.a.m());
                  } else if (c($$11)) {
                     dvo[] $$12 = new dvo[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
