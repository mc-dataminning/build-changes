...
public class efc extends efh {
   ...
   public List<edp.a> a(dbf $$0, BiConsumer<io, drd> $$1, aym $$2, int $$3, io $$4, ecz $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = ayf.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, ayf.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<efc.a> $$13 = Lists.newArrayList();
      $$13.add(new efc.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               io $$21 = $$4.b(ayf.a($$19), $$12 - 1, ayf.a($$20));
               io $$22 = $$21.b(5);
      ...
      List<edp.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dbf $$0, BiConsumer<io, drd> $$1, aym $$2, io $$3, io $$4, boolean $$5, ecz $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            io $$13 = $$3.b(ayf.d(0.5F + (float)$$12 * $$9), ayf.d(0.5F + (float)$$12 * $$10), ayf.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dkm.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dbf $$0, BiConsumer<io, drd> $$1, aym $$2, int $$3, io $$4, List<efc.a> $$5, ecz $$6) {
      for (efc.a $$7 : $$5) {
         int $$8 = $$7.a();
