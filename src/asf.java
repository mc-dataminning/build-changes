...
public class asf {
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (asf.this.e.am()) {
                  $$1.addLast("legacy_query", new ary(asf.this.d()));
               }

               vi.a($$1, yx.a, false, null);
               int $$2 = asf.this.e.o();
               vi $$3 = (vi)($$2 > 0 ? new vz($$2) : new vi(yx.a));
               asf.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new ash(asf.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     wp $$3 = wp.b("Internal server error");
                     $$1.a(new zf($$3), vw.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<asf.a.a> d = Lists.newArrayList();
