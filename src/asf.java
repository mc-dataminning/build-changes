...
public class asf {
   public static final Codec<asf> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(arh.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), arh.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, asf::new)
   );
   ...
   private final Predicate<aey> f;

   private asf(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
