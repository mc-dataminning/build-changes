...
public class djt<T> implements djv<T> {
   ...
   private djt(ih<T> $$0, int $$1, djw<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private djt(ih<T> $$0, T[] $$1, djw<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public djv<T> c() {
      return new djt<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
