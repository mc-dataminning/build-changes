...
public class fjo implements fjm {
   private static final ale g = new ale("toast/tutorial");
   public static final int a = 154;
   public static final int d = 1;
   public static final int e = 3;
   public static final int f = 28;
   private final fjo.a h;
   private final xo i;
   @Nullable
   private final xo j;
   private fjm.a k = fjm.a.a;
   private long l;
   private float m;
   private float n;
   private final boolean o;

   public fjo(fjo.a $$0, xo $$1, @Nullable xo $$2, boolean $$3) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
      this.o = $$3;
   ...
   public fjm.a a(fgq $$0, fjn $$1, long $$2) {
      ...
      if (this.o) {
         $$0.a(3, 28, 157, 29, -1);
         float $$3 = ayy.b(this.m, this.n, (float)($$2 - this.l) / 100.0F);
         int $$4;
         if (this.n >= this.m) {
            $$4 = -16755456;
         } else {
