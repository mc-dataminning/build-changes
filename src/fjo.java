...
public class fjo extends ffe {
   ...
   protected void aQ_() {
      if (this.O) {
         ...
         this.E = new fjn(this, this.f, this.g, this.E() - 88, 88, 36);
      }
      ...
      int $$4 = 64 + this.o();
      int $$5 = (this.g - $$3) / 2 + 3;
      this.I = this.d(ezh.a(l, $$0x -> this.a(fjo.a.a)).a($$1, 45, $$0, 20).a());
      this.J = this.d(ezh.a(m, $$0x -> this.a(fjo.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.K = this.d(ezh.a(n, $$0x -> this.a(fjo.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$6 = this.F != null ? this.F.a() : "";
      this.F = new ezq(this.i, this.H() + 28, 74, 200, 15, r) {
         @Override
         protected we aN_() {
            return !fjo.this.F.a().isEmpty() && fjo.this.E.d() ? super.aN_().f(", ").b(fjo.t) : super.aN_();
         }
      };
      this.F.f(16);
      this.F.g(true);
      ...
      this.e(this.F);
      this.e(this.E);
      this.L = this.d(ezh.a(w, fdw.b(this, "https://aka.ms/javablocking")).a($$5, $$4, $$3, 20).a());
      this.O = true;
      this.a(this.H);
   }

   private void a(fjo.a $$0) {
      this.H = $$0;
      this.I.b(l);
      this.J.b(m);
      this.K.b(n);
      ...
      switch ($$0) {
         case a:
            this.I.b(o);
            Collection<UUID> $$2 = this.f.s.cq.p();
         ...
         case c:
            this.K.b(q);
            fjm $$4 = this.f.aK();
            Set<UUID> $$5 = this.f.s.cq.p().stream().filter($$4::e).collect(Collectors.toSet());
            $$1 = $$5.isEmpty();
