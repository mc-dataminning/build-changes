...
public class fjo extends hhw {
   ...
   public void aT_() {
      this.D.a(a, this.p);
      this.E = this.D.c(new fjo.a(this.m));
      this.D.b(fof.a(xu.k, $$0 -> this.aP_()).a());
      this.c();
      this.D.a($$1 -> {
   ...
   private xv a(String $$0) {
      try {
         return fkj.a.get(Integer.parseInt($$0)).b();
   ...
   private xv b(String $$0) {
      try {
         return fkj.b.get(Integer.parseInt($$0)).e();
      } catch (Exception var3) {
         return b;
      }
   }

   class a extends fpc<fjo.b> {
      public a(final fmg $$0) {
         super($$0, fjo.this.n, fjo.this.D.d(), fjo.this.D.c(), 36);
         if (fjo.this.C.e != null) {
            fjo.this.C.e.forEach(($$0x, $$1) -> this.b(fjo.this.new b($$0x, $$1)));
         }
      }
   }

   class b extends fpc.a<fjo.b> {
      ...
      public void a(fns $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         $$0.b(fjo.this.p, this.a(this.m), $$3, $$2, -6250336);
         $$0.b(fjo.this.p, fjo.this.a(this.m, this.n), $$3, $$2 + 12, -1);
      }
