...
public class fjo extends hkx implements fgy {
   ...
   @Override
   public void aR_() {
      this.U = this.X.b(fos.a(wn.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.X.b(fos.a(wn.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.H();
   ...
   private void E() {
      this.m.a(new fiu(new fgf(new fum()), this.J));
   }
