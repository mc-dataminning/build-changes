...
public class fjo implements AutoCloseable {
   private static final int a = -1;
   private final alg b;
   private int c;

   private fjo(int $$0, alg $$1) {
      this.b = $$1;
      this.c = $$0;
   }

   public static fjo a(alg $$0, fjo.a $$1, String $$2) throws grj.b {
      ...
      if (GlStateManager.glGetShaderi($$3, 35713) == 0) {
         ...
         throw new grj.b("Couldn't compile " + $$1.a() + " shader (" + $$0 + ") : " + $$4);
      } else {
         return new fjo($$3, $$0);
      }
   }
   ...
   public static enum a {
      ...
      private static final fjo.a[] c = values();
