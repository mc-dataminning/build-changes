...
public final class cfv {
   public static final Codec<cfv> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               jy.a(lr.aE).fieldOf("biomes").forGetter(cfv::d)
            )
            .apply($$0, cfv::new)
   );
   public static final Codec<jj<cfv>> b = akg.a(lr.m, a);
   private final akk c;
   private final akk d;
   private final akk e;
   private final akk f;
   private final akk g;
   private final akk h;
   private final jn<ddf> i;

   public cfv(akk $$0, akk $$1, akk $$2, jn<ddf> $$3) {
      this.c = $$0;
      this.f = a($$0);
      this.d = $$1;
      this.g = a($$1);
