...
public class cfv {
   private final Map<cfu, cfv.a> a = Maps.newHashMap();
   private int b;
   ...
   public void a() {
      this.b++;
      if (!this.a.isEmpty()) {
         Iterator<Entry<cfu, cfv.a>> $$0 = this.a.entrySet().iterator();

         while ($$0.hasNext()) {
            Entry<cfu, cfv.a> $$1 = $$0.next();
   ...
   public void a(cfu $$0, int $$1) {
      this.a.put($$0, new cfv.a(this.b, this.b + $$1));
      this.b($$0, $$1);
   }
