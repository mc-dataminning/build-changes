...
public class bsz {
   ...
   private final List<bsx> d = Lists.newArrayList();
   private final bvi e;
   private int f;
   private int g;
   private int h;
   ...
   private static boolean a(btc $$0) {
      return $$0.d() instanceof bvi;
   }

   private wp a(bum $$0, wp $$1, String $$2, String $$3) {
      cwq $$5 = $$0 instanceof bvi $$4 ? $$4.eZ() : cwq.j;
      return !$$5.f() && $$5.b(kv.g) ? wp.a($$2, this.e.p_(), $$1, $$5.K()) : wp.a($$3, this.e.p_(), $$1);
   }

   private wp a(bsx $$0, @Nullable bum $$1) {
      btc $$2 = $$0.a();
      if (!$$2.a(awr.m) && !$$2.a(awr.s)) {
         ...
         bth $$3 = Objects.requireNonNullElse($$0.c(), bth.a);
         return wp.a($$3.a(), this.e.p_());
      }
   }

   @Nullable
   private static wp a(@Nullable bum $$0) {
   ...
   public wp a() {
      if (this.d.isEmpty()) {
         ...
         bsx $$0 = this.d.get(this.d.size() - 1);
         btc $$1 = $$0.a();
         bsx $$2 = this.d();
         btg $$3 = $$1.k().e();
         if ($$3 == btg.b && $$2 != null) {
