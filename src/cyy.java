...
public record cyy(int c, int d, jr<cyn> e, Optional<cyy.a> f) {
   private static final int g = 3;
   public static final MapCodec<cyy> a = cyy.a.a
      .flatXmap(cyy::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final zj<ww, cyy> b = zj.a(cyy::a, cyy::b);

   public static cyy a(Map<Character, cyn> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cyy a(Map<Character, cyn> $$0, List<String> $$1) {
      cyy.a $$2 = new cyy.a($$0, $$1);
      return (cyy)a($$2).getOrThrow();
   }

   private static DataResult<cyy> a(cyy.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      jr<cyn> $$4 = jr.a($$2 * $$3, cyn.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cyy($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cqf $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static cyy b(ww $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      jr<cyn> $$3 = jr.a($$1 * $$2, cyn.a);
      $$3.replaceAll($$1x -> cyn.b.decode($$0));
      return new cyy($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<cyy.a> d() {
      return this.f;
   }

   public static record a(Map<Character, cyn> b, List<String> c) {
      ...
      public static final MapCodec<cyy.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(ayc.b(e, cyn.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cyy.a::new)
      );

      public Map<Character, cyn> a() {
         return this.b;
      }
