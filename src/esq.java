...
public final class esq extends eso<esr.a, esr> {
   private static final long g = eso.a.a(15);
   private static final long h = eso.a.a(15, jn.b);
   private static final long i = eso.a.a(15, false, jn.b);
   ...
   private int a(int $$0, int $$1, int $$2) {
      esh $$3 = this.b(kk.a($$0), kk.a($$1));
      return $$3 == null ? $$2 : $$3.a(kk.b($$0), kk.b($$1));
   }

   @Nullable
   private esh b(int $$0, int $$1) {
      dzc $$2 = this.e.c($$0, $$1);
         ...
         if (eso.a.a($$1, $$5)) {
            ...
            if (this.f.b(kk.e($$6))) {
               ...
               if ($$8 > $$7) {
                  ...
                  if ($$10 > $$7) {
                     if ($$3 == null) {
                        $$3 = eso.a.b($$1) ? djm.a.m() : this.c(this.j.f($$0));
                     }

                     if (!this.a($$3, $$9, $$5)) {
                        this.f.a($$6, $$10);
                        if ($$10 > 1) {
                           this.c($$6, eso.a.a($$10, a($$9), $$5.g()));
                        }
         ...
         if (eso.a.a($$1, $$4)) {
            ...
            if (this.f.b(kk.e($$5))) {
               ...
               if ($$6 != 0) {
                  if ($$6 <= $$3 - 1) {
                     this.f.a($$5, 0);
                     this.b($$5, eso.a.a($$6, $$4.g()));
                     this.a($$5, $$4, $$6, false, $$2);
                  } else {
                     this.c($$5, eso.a.b($$6, false, $$4.g()));
                  }
               }
            }
         }
               ...
               if (!this.f.b(kk.b($$8, $$10, $$9))) {
                  ...
                  for (int $$13 = 15; $$13 >= 0; $$13--) {
                     ...
                     if ($$3) {
                        this.f.a($$14, $$2);
                        if ($$2 > 1) {
                           this.c($$14, eso.a.a($$2, true, $$1.g()));
                        }
                     } else {
                        this.f.a($$14, 0);
                        this.b($$14, eso.a.a($$2, $$1.g()));
                     }
                  }
   ...
   public void a(dfm $$0, boolean $$1) {
      super.a($$0, $$1);
      if ($$1) {
         esh $$2 = Objects.requireNonNullElse(this.b($$0.h, $$0.i), this.k);
         int $$3 = $$2.a() - 1;
         int $$4 = kk.a($$3) + 1;
         long $$5 = kk.b($$0.h, $$0.i);
         int $$6 = this.f.n($$5);
   ...
   public void b(dfm $$0) {
      ...
      this.f.b($$1, true);
      esh $$2 = Objects.requireNonNullElse(this.b($$0.h, $$0.i), this.k);
      esh $$3 = Objects.requireNonNullElse(this.b($$0.h, $$0.i - 1), this.k);
      esh $$4 = Objects.requireNonNullElse(this.b($$0.h, $$0.i + 1), this.k);
      esh $$5 = Objects.requireNonNullElse(this.b($$0.h - 1, $$0.i), this.k);
      esh $$6 = Objects.requireNonNullElse(this.b($$0.h + 1, $$0.i), this.k);
      int $$7 = this.f.n($$1);
      int $$8 = this.f.c();
      int $$9 = kk.c($$0.h);
      int $$10 = kk.c($$0.i);
                  ...
                  if ($$19 <= $$15) {
                     ...
                     for (int $$25 = $$15; $$25 >= Math.max($$14, $$19); $$25--) {
                        ...
                        if ($$25 == $$19 || $$25 < $$24) {
                           ...
                           this.c($$26, eso.a.a($$25 == $$19, $$25 < $$20, $$25 < $$21, $$25 < $$22, $$25 < $$23));
                        }
                     }
