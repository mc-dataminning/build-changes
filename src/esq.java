...
public class esq extends erw {
   private static final Logger b = LogUtils.getLogger();
   public static final MapCodec<esq> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and($$0.group(euq.a.fieldOf("damage").forGetter($$0x -> $$0x.c), Codec.BOOL.fieldOf("add").orElse(false).forGetter($$0x -> $$0x.d)))
            .apply($$0, esq::new)
   );
   private final eup c;
   private final boolean d;

   private esq(List<etu> $$0, eup $$1, boolean $$2) {
      super($$0);
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public static erw.a<?> a(eup $$0) {
      return a($$1 -> new esq($$1, $$0, false));
   }

   public static erw.a<?> a(eup $$0, boolean $$1) {
      return a($$2 -> new esq($$2, $$0, $$1));
   }
}
