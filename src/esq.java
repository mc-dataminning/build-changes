...
public class esq extends gko {
   ...
   private exf S;
   private boolean T;
   private final List<esj> U = Lists.newArrayList();

   public esq(eql $$0, long $$1) {
      super(y);
      this.H = $$0;
      this.J = $$1;
   }
   ...
   public void aN_() {
      ...
      this.K = this.g / 2 - 187;
      this.L = this.g / 2 + 190;
      this.M = this.d(exf.a(vf.c("mco.configure.world.buttons.players"), $$0x -> this.f.a(new etc(this, this.I))).a(this.a(0, 3), g(0), 100, 20).a());
      this.N = this.d(exf.a(vf.c("mco.configure.world.buttons.settings"), $$0x -> this.f.a(new eti(this, this.I.g()))).a(this.a(1, 3), g(0), 100, 20).a());
      this.O = this.d(
         exf.a(vf.c("mco.configure.world.buttons.subscription"), $$0x -> this.f.a(new etk(this, this.I.g(), this.H))).a(this.a(2, 3), g(0), 100, 20).a()
      );
      this.U.clear();
      ...
      this.S = this.d(
         exf.a(vf.c("mco.configure.world.buttons.switchminigame"), $$0x -> this.f.a(new eth(vf.c("mco.template.title.minigame"), this::a, erh.d.b)))
            .a(this.b(0), g(13) - 5, 100, 20)
            .a()
      );
      this.P = this.d(
         exf.a(vf.c("mco.configure.world.buttons.options"), $$0x -> this.f.a(new etj(this, this.I.i.get(this.I.n).d(), this.I.m, this.I.n)))
            .a(this.b(0), g(13) - 5, 90, 20)
            .a()
      );
      this.Q = this.d(exf.a(vf.c("mco.configure.world.backup"), $$0x -> this.f.a(new esn(this, this.I.g(), this.I.n))).a(this.b(1), g(13) - 5, 90, 20).a());
      this.R = this.d(
         exf.a(vf.c("mco.configure.world.buttons.resetworld"), $$0x -> this.f.a(etf.a(this, this.I.g(), () -> this.f.execute(() -> this.f.a(this.f())))))
            .a(this.b(2), g(13) - 5, 90, 20)
            .a()
      );
      this.d(exf.a(ve.k, $$0x -> this.aE_()).a(this.L - 80 + 8, g(13) - 5, 70, 20).a());
      this.Q.j = true;
      if (this.I == null) {
         this.J();
         this.I();
   ...
   public void a(ewt $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.I == null) {
         ...
         String $$4 = this.I.b();
         int $$5 = this.i.b($$4);
         int $$6 = this.I.e == erh.c.a ? -6250336 : 8388479;
   ...
   private void a(long $$0) {
      new Thread(() -> {
         ...
         try {
            ...
            this.f.execute(() -> this.f.a(new esu(var5, this.H)));
         }
      }).start();
   }
   ...
   private void a(erh $$0) {
      if (this.I.e == erh.c.b) {
         eql.a($$0, new esq(this.H, this.J));
      } else {
         this.a(true, new esq(this.H, this.J));
      }
   }

   private void E() {
      eth $$0 = new eth(vf.c("mco.template.title.minigame"), this::a, erh.d.b);
      $$0.a(vf.c("mco.minigame.world.info.line1"), vf.c("mco.minigame.world.info.line2"));
      this.f.a($$0);
   }

   private void a(int $$0, erh $$1) {
      vf $$2 = vf.c("mco.configure.world.slot.switch.question.line1");
      vf $$3 = vf.c("mco.configure.world.slot.switch.question.line2");
      this.f.a(new esw($$2x -> {
         if ($$2x) {
            this.e();
            this.f.a(new esx(this.H, new euo($$1.a, $$0, () -> this.f.execute(() -> this.f.a(this.f())))));
         } else {
            this.f.a(this);
         }
      }, esw.a.b, $$2, $$3, true));
   ...
   private void b(int $$0, erh $$1) {
      vf $$2 = vf.c("mco.configure.world.slot.switch.question.line1");
      vf $$3 = vf.c("mco.configure.world.slot.switch.question.line2");
      this.f.a(new esw($$2x -> {
         if ($$2x) {
            this.e();
            etf $$3x = etf.a(this, $$0, $$1, () -> this.f.execute(() -> this.f.a(this.f())));
            this.f.a($$3x);
         } else {
            this.f.a(this);
         }
   ...
   private void a(ewt $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      } else if (this.I.e == erh.c.a) {
         this.a($$0, $$1, $$2, $$3, $$4, v, () -> D);
      } else if (this.I.e == erh.c.b) {
         if (this.I.l < 7) {
            this.a($$0, $$1, $$2, $$3, $$4, b, () -> {
               if (this.I.l <= 0) {
                  return A;
   ...
   private boolean H() {
      return this.I != null && this.I.m == erh.d.b;
   }
   ...
   public void a(boolean $$0, fda $$1) {
      this.f.a(new esx($$1, new eui(this.I, this, $$0, this.f)));
   }

   public void a(fda $$0) {
      this.f.a(new esx($$0, new euc(this.I, this)));
   }
   ...
   private void a(@Nullable ery $$0) {
      if ($$0 != null && ery.a.b == $$0.i) {
         this.e();
         this.f.a(new esx(this.H, new eun(this.I.a, $$0, this.f())));
      } else {
         this.f.a(this);
      }
   }
