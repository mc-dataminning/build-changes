...
public class hz extends ib {
   ...
   hz(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }

   public static hz a(int $$0, int $$1, int $$2) {
      return new hz($$0, $$1, $$2);
   }

   public static hz a(gw $$0) {
      return new hz(a($$0.u()), a($$0.v()), a($$0.w()));
   }

   public static hz a(cpe $$0, int $$1) {
      return new hz($$0.e, $$1, $$0.f);
   }

   public static hz a(djc $$0) {
      return a($$0.dl());
   }

   public static hz a(hq $$0) {
      return new hz(b($$0.a()), b($$0.b()), b($$0.c()));
   }

   public static hz a(long $$0) {
      return new hz(b($$0), c($$0), d($$0));
   }

   public static hz a(dhh $$0) {
      return a($$0.f(), $$0.al());
   }
   ...
   public hz d(int $$0, int $$1, int $$2) {
      return $$0 == 0 && $$1 == 0 && $$2 == 0 ? this : new hz(this.a() + $$0, this.b() + $$1, this.c() + $$2);
   }
   ...
   public static Stream<hz> a(hz $$0, int $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      int $$4 = $$0.c();
   ...
   public static Stream<hz> a(cpe $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$0.e;
      int $$5 = $$0.f;
      return a($$4 - $$1, $$2, $$5 - $$1, $$4 + $$1, $$3 - 1, $$5 + $$1);
   }

   public static Stream<hz> a(final int $$0, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5) {
      return StreamSupport.stream(new AbstractSpliterator<hz>((long)(($$3 - $$0 + 1) * ($$4 - $$1 + 1) * ($$5 - $$2 + 1)), 64) {
         final gz a = new gz($$0, $$1, $$2, $$3, $$4, $$5);

         @Override
         public boolean tryAdvance(Consumer<? super hz> $$0x) {
            if (this.a.a()) {
               $$0.accept(new hz(this.a.b(), this.a.c(), this.a.d()));
               return true;
            } else {
               return false;
            }
