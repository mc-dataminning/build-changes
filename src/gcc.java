...
public class gcc {
   ...
   public final Map<ir, gcd> c;
   public final gce d;
   public final boolean e;

   public gcc(Vector3f $$0, Vector3f $$1, Map<ir, gcd> $$2, @Nullable gce $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ir, gcd> $$0 : this.c.entrySet()) {
         float[] $$1 = this.a($$0.getKey());
         $$0.getValue().e.a($$1);
      }
   }

   private float[] a(ir $$0) {
      switch ($$0) {
         case a:
   ...
   protected static class a implements JsonDeserializer<gcc> {
      private static final boolean a = true;

      public gcc a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         gce $$6 = this.a($$3);
         Map<ir, gcd> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !axm.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = axm.a($$3, "shade", true);
            return new gcc($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private gce a(JsonObject $$0) {
         gce $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = axm.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ir.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = axm.a($$2, "rescale", false);
            $$1 = new gce($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = axm.m($$0, "angle");
         if ($$1 != 0.0F && axw.e($$1) != 22.5F && axw.e($$1) != 45.0F) {
      ...
      private ir.a c(JsonObject $$0) {
         String $$1 = axm.i($$0, "axis");
         ir.a $$2 = ir.a.a($$1.toLowerCase(Locale.ROOT));
         if ($$2 == null) {
      ...
      private Map<ir, gcd> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ir, gcd> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ir, gcd> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ir, gcd> $$2 = Maps.newEnumMap(ir.class);
         JsonObject $$3 = axm.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ir $$5 = this.a($$4.getKey());
            $$2.put($$5, (gcd)$$0.deserialize($$4.getValue(), gcd.class));
         }

         return $$2;
      }

      private ir a(String $$0) {
         ir $$1 = ir.a($$0);
         if ($$1 == null) {
