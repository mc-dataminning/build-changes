...
public class gcc extends ftp {
   private static final ftw c = new ftw(alg.b("recipe_book/tab"), alg.b("recipe_book/tab_selected"));
   private final gca.a d;
   ...
   public void a(foj $$0, boolean $$1) {
      gce.a $$2 = $$1 ? gce.a.b : gce.a.a;

      for (gce $$4 : $$0.a(this.d.c())) {
         for (dfb $$5 : $$4.a($$2)) {
            if ($$0.b($$5.a())) {
               this.f = 15.0F;
               return;
   ...
   public void b(frv $$0, int $$1, int $$2, float $$3) {
      if (this.a != null) {
         ...
         $$0.a(gqk::H, $$5, $$6, this.G(), this.g, this.h);
         this.a($$0);
         if (this.f > 0.0F) {
            $$0.c().b();
            this.f -= $$3;
   ...
   public boolean a(foj $$0) {
      List<gce> $$1 = $$0.a(this.d.c());
      this.k = false;
