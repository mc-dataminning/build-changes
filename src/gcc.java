...
public abstract class gcc {
   ...
   protected final gej v;
   protected final Function<alp, glq> w;
   private final List<gej> b;

   public gcc(gej $$0, Function<alp, glq> $$1) {
      this.v = $$0;
      this.w = $$1;
      this.b = $$0.e().toList();
   }

   public final glq a(alp $$0) {
   ...
   protected void a(but $$0, fmn $$1, float $$2) {
      this.a($$0, $$1, $$2, 1.0F);
   }
   ...
   protected void a(but $$0, fmn $$1, float $$2, float $$3) {
   ...
   public static class a extends gcc {
      public a(gej $$0, Function<alp, glq> $$1) {
         super($$0, $$1);
      }
   }
}
