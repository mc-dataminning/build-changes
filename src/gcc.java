...
public class gcc {
   ...
   private final List<vy> c = Collections.synchronizedList(Lists.newArrayList());

   public void a(final gca $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final gdd $$3 = gdd.a($$0.b);
      Optional<InetSocketAddress> $$4 = gdf.a.a($$3).map(gdc::d);
      if ($$4.isEmpty()) {
         this.a(fpg.b, $$0);
      } else {
         final InetSocketAddress $$5 = $$4.get();
         final vy $$6 = vy.a($$5, false, null);
         this.c.add($$6);
   ...
   void a(InetSocketAddress $$0, final gdd $$1, final gca $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)vy.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new gbt($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(gca.b.d);
               $$2.h = xe.b($$2xx);
               $$2.d = xe.b($$3);
               $$2.c = gcc.a($$4, $$5);
