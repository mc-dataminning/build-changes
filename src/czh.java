...
public class czh {
   ...
   final boolean f;
   private final aqa<csm> g;
   private final int h;
   private final int i;
   private final int j;
   private final int k;
   private List<czh.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public czh(boolean $$0, aqa<csm> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static czh a() {
      return new czh(false, apl.bL, 10, 4, 10, 5);
   }

   public static czh b() {
      return new czh(true, apl.bM, 50, 1, 5, 10);
   }
   ...
   public void a(qr $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<czh.a> $$1 = (List<czh.a>)czh.a.b.listOf().parse(new Dynamic(rc.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(qr $$0) {
      czh.a.b.listOf().encodeStart(rc.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(gu $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new czh.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(czh.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(cpn $$0, gu $$1, aru $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<czh.a> $$4 = new ArrayList<>();
         Map<gu, czh.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<czh.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  gu.a.fieldOf("pos").forGetter(czh.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(czh.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(czh.a::c),
      ...
      private boolean a(cpn $$0, gu $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(cpn $$0, gu $$1, aru $$2, czh $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
      ...
      private static czc a(dfa $$0) {
         return $$0.b() instanceof czc $$1 ? $$1 : czc.t_;
      }
      ...
      @Nullable
      private static gu a(cpn $$0, gu $$1, aru $$2) {
         gu.a $$3 = $$1.j();
         gu.a $$4 = $$1.j();
      ...
      private static boolean a(cpn $$0, gu $$1, gu $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            gu $$3 = $$2.b($$1);
      ...
      private static boolean a(cpn $$0, gu $$1, ha $$2) {
         gu $$3 = $$1.a($$2);
