...
public class hiw extends MinecraftServer {
   ...
   public hiw(Thread $$0, flj $$1, evf.c $$2, aua $$3, alt $$4, alp $$5, arn $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hiv(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   @Override
   public dgf bd() {
      return this.r() && !this.w_() ? (dgf)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
