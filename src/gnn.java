...
public class gnn implements gnl {
   ...
   public gnn(gnn.a $$0, InputStream $$1) throws IOException {
      this.a = $$0;
      this.c = new BufferedInputStream($$1);
      this.c.mark(Integer.MAX_VALUE);
      this.b = $$0.create(new gnn.b(this.c));
   }
   ...
   public ByteBuffer a(int $$0) throws IOException {
      ...
      if (!$$1.hasRemaining()) {
         this.b.close();
         this.c.reset();
         this.b = this.a.create(new gnn.b(this.c));
         $$1 = this.b.a($$0);
      }
   ...
   @FunctionalInterface
   public interface a {
      gnl create(InputStream var1) throws IOException;
   }
