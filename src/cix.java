...
public record cix(cix.a d) {
   ...
   public static final Codec<cix> c = cix.a.a.xmap(cix::new, cix::b);

   public static cix a(axi $$0, UUID $$1, cix.a $$2) throws cix.b {
      if (!$$2.a($$0, $$1)) {
         throw new cix.b(e);
      } else {
         return new cix($$2);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cix.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  awe.n.fieldOf("expires_at").forGetter(cix.a::b), avu.f.fieldOf("key").forGetter(cix.a::c), awe.o.fieldOf("signature_v2").forGetter(cix.a::d)
               )
               .apply($$0, cix.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof cix.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
