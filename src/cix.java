...
public class cix extends ckf implements bue, ckj {
   private static final akk<Integer> b = ako.a(cix.class, akm.b);
   private static final akk<Integer> c = ako.a(cix.class, akm.b);
   private static final akk<Integer> d = ako.a(cix.class, akm.b);
   private static final List<akk<Integer>> e = ImmutableList.of(b, c, d);
   private static final akk<Integer> bY = ako.a(cix.class, akm.b);
   ...
   private int cg;
   private final arc ch = (arc)new arc(this.O_(), bqm.a.f, bqm.b.a).a(true);
   private static final Predicate<btr> ci = $$0 -> !$$0.ak().a(awt.y) && $$0.fH();
   private static final cei cj = cei.a().a(20.0).a(ci);

   public cix(btc<? extends cix> $$0, dca $$1) {
      super($$0, $$1);
   ...
   @Override
   public void n_() {
      evt $$0 = this.ds().d(1.0, 0.6, 1.0);
      if (!this.dP().B && this.u(0) > 0) {
         bsw $$1 = this.dP().a(this.u(0));
         if ($$1 != null) {
            double $$2 = $$0.d;
            ...
            $$0 = new evt($$0.c, $$2, $$0.e);
            evt $$3 = new evt($$1.du() - this.du(), 0.0, $$1.dA() - this.dA());
            if ($$3.i() > 9.0) {
               evt $$4 = $$3.d();
   ...
   protected void Z() {
      if (this.y() > 0) {
         ...
         if ($$0 <= 0) {
            this.dP().a(this, this.du(), this.dy(), this.dA(), 7.0F, false, dca.a.c);
            if (!this.aW()) {
         ...
         for (int $$1 = 1; $$1 < 3; $$1++) {
            if (this.ai >= this.ce[$$1 - 1]) {
               ...
               if ((this.dP().al() == bqt.c || this.dP().al() == bqt.d) && this.cf[$$1 - 1]++ > 15) {
                  float $$2 = 10.0F;
                  float $$3 = 5.0F;
               ...
               int $$7 = this.u($$1);
               if ($$7 > 0) {
                  btr $$8 = (btr)this.dP().a($$7);
                  if ($$8 != null && this.c($$8) && !(this.g((bsw)$$8) > 900.0) && this.E($$8)) {
                     this.a($$1 + 1, $$8);
                  ...
                  List<btr> $$9 = this.dP().a(btr.class, cj, this, this.cK().c(20.0, 8.0, 20.0));
                  if (!$$9.isEmpty()) {
                     btr $$10 = $$9.get(this.ah.a($$9.size()));
                     this.a($$1, $$10.al());
                  }
               }
            }
         ...
         if (this.cg > 0) {
            this.cg--;
            if (this.cg == 0 && this.dP().ab().b(dbw.c)) {
               boolean $$11 = false;
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      double $$9 = $$2 - $$6;
      double $$10 = $$3 - $$7;
      cof $$11 = new cof(this.dP(), this, $$8, $$9, $$10);
      $$11.c(this);
      if ($$4) {
         $$11.a(true);
      }
   ...
   public boolean a(brp $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if ($$0.a(awr.u) || $$0.d() instanceof cix) {
         return false;
         ...
         if (this.a()) {
            bsw $$2 = $$0.c();
            if ($$2 instanceof cnf || $$2 instanceof coj) {
               return false;
            }
         }
   ...
   public static buy.a u() {
      return ckf.gw().a(buz.q, 300.0).a(buz.r, 0.6F).a(buz.j, 0.6F).a(buz.k, 40.0).a(buz.a, 4.0);
   }
   ...
   class a extends cap {
      public a() {
         this.a(EnumSet.of(cap.a.a, cap.a.c, cap.a.b));
      }
