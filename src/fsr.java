public class fsr extends fse<csl> implements fvr {
   private static final all G = all.b("textures/gui/container/crafting_table.png");
   private final fvl<?> H;
   private boolean I;

   public fsr(csl $$0, coq $$1, xl $$2) {
      super($$0, $$1, $$2);
      this.H = new fvh($$0);
   }
   ...
   protected void aS_() {
      ...
      this.c(new fmi(this.C + 5, this.o / 2 - 49, 20, 18, fvl.a, $$0 -> {
         this.H.c();
         this.C = this.H.a(this.n, this.s);
