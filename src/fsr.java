...
public class fsr implements feq {
   static final Logger b = LogUtils.getLogger();
   private final ffr c;
   private final fsf<fsr.b> d;

   fsr(ffr $$0, fsf<fsr.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(aku c, int d, int e, int[][] f) implements fst {
      ...
      public static final MapCodec<fsr.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     aku.a.fieldOf("file").forGetter(fsr.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fsr.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fsr.a::e),
                     g.fieldOf("chars").forGetter(fsr.a::f)
                  )
                  .apply($$0, fsr.a::new)
         )
         .validate(fsr.a::a);
      ...
      private static DataResult<fsr.a> a(fsr.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fsr.b $$15 = $$9.a($$12, new fsr.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fsr.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(ffr $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, ffr b, int c, int d, int e, int f, int g, int h) implements fep {
