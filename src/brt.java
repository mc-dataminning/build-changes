...
public class brt implements bru {
   ...
   private static final brt k = new brt();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(brs $$0) {
      URL $$1 = brt.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, brs $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final brw a = new brw(() -> brt.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == brt.this.l && $$0.getState() == RecordingState.STOPPED) {
