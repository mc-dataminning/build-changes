...
public class azu {
   ...
   public static jq<cxg> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
   ...
   public static jq<cxg> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static jq<cxg> a(JsonObject $$0, String $$1, @Nullable jq<cxg> $$2) {
