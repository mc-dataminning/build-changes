...
public class fpj extends foc<cre> {
   ...
   private int ah;
   private final fpj.a[] ai = new fpj.a[7];
   int aj;
   private boolean ak;

   public fpj(cre $$0, cmx $$1, xp $$2) {
      super($$0, $$1, $$2);
      this.c = 276;
      this.u = 107;
   }
   ...
   protected void aM_() {
      ...
      for (int $$3 = 0; $$3 < 7; $$3++) {
         this.ai[$$3] = this.c(new fpj.a($$0 + 5, $$2, $$3, $$0x -> {
            if ($$0x instanceof fpj.a) {
               this.ah = ((fpj.a)$$0x).a() + this.aj;
               this.I();
            }
         }));
         $$2 += 20;
   ...
   private void a(fgs $$0, int $$1, int $$2, dax $$3) {
      int $$4 = this.w.n();
      int $$5 = this.w.l();
      if ($$4 < 5) {
         ...
         if ($$5 >= $$6 && cmm.d($$4)) {
            int $$7 = 102;
            float $$8 = 102.0F / (float)(cmm.c($$4) - $$6);
   ...
   private void a(fgs $$0, int $$1, int $$2, day $$3) {
      int $$4 = $$3.size() + 1 - 7;
      if ($$4 > 1) {
   ...
   private void a(fgs $$0, dax $$1, int $$2, int $$3) {
   ...
   private void a(fgs $$0, cuq $$1, cuq $$2, int $$3, int $$4) {
      $$0.b($$1, $$3, $$4);
      if ($$2.I() == $$1.I()) {
         $$0.a(this.p, $$1, $$3, $$4);
      } else {
   ...
   class a extends fhf {
      ...
      public a(final int $$0, final int $$1, final int $$2, final fhf.c $$3) {
      ...
      public void a(fgs $$0, int $$1, int $$2) {
         if (this.i && fpj.this.w.p().size() > this.a + fpj.this.aj) {
            if ($$1 < this.C() + 20) {
               cuq $$3 = fpj.this.w.p().get(this.a + fpj.this.aj).b();
               $$0.b(fpj.this.p, $$3, $$1, $$2);
            } else if ($$1 < this.C() + 50 && $$1 > this.C() + 30) {
               cuq $$4 = fpj.this.w.p().get(this.a + fpj.this.aj).c();
               if (!$$4.e()) {
                  $$0.b(fpj.this.p, $$4, $$1, $$2);
               }
            } else if ($$1 > this.C() + 65) {
               cuq $$5 = fpj.this.w.p().get(this.a + fpj.this.aj).f();
               $$0.b(fpj.this.p, $$5, $$1, $$2);
            }
         }
      }
   }
