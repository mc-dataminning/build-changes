...
public record dv(@Nullable Float c, @Nullable Float d) {
   public static final dv a = new dv(null, null);
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(wx.c("argument.range.ints"));

   public static dv a(float $$0) {
      return new dv($$0, $$0);
   }

   public static dv a(float $$0, float $$1) {
      return new dv($$0, $$1);
   }

   public static dv b(float $$0) {
      return new dv($$0, null);
   }

   public static dv c(float $$0) {
      return new dv(null, $$0);
   }
   ...
   public static dv a(@Nullable JsonElement $$0) {
   ...
   public static dv a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return a($$0, $$1, $$0x -> $$0x);
   }

   public static dv a(StringReader $$0, boolean $$1, Function<Float, Float> $$2) throws CommandSyntaxException {
      if (!$$0.canRead()) {
