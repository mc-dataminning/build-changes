...
public class dv extends dz<dv.a> {
   ...
   public void a(ard $$0, akt<dbc<?>> $$1, List<cwn> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static record a(Optional<bi> b, akt<dbc<?>> c, List<cv> d) implements dz.a {
      ...
      public static aq<dv.a> a(akt<dbc<?>> $$0, List<cv.a> $$1) {
         return ap.ac.a(new dv.a(Optional.empty(), $$0, $$1.stream().map(cv.a::b).toList()));
      }

      public static aq<dv.a> a(akt<dbc<?>> $$0) {
         return ap.ac.a(new dv.a(Optional.empty(), $$0, List.of()));
      }

      public static aq<dv.a> b(akt<dbc<?>> $$0) {
         return ap.ad.a(new dv.a(Optional.empty(), $$0, List.of()));
      }

      boolean b(akt<dbc<?>> $$0, List<cwn> $$1) {
         if ($$0 != this.c) {
            return false;
         } else {
            List<cwn> $$2 = new ArrayList<>($$1);

            for (cv $$3 : this.d) {
               boolean $$4 = false;
               Iterator<cwn> $$5 = $$2.iterator();
