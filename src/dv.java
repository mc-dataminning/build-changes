...
public interface dv {
   ...
   default Collection<dv.b> z() {
      return Collections.singleton(dv.b.b);
   }

   default Collection<dv.b> A() {
      return Collections.singleton(dv.b.b);
   }
   ...
   default void a(hs<?> $$0, dv.a $$1, SuggestionsBuilder $$2) {
      if ($$1.a()) {
         a($$0.j().map(apy::b), $$2, "#");
      }
   ...
   CompletableFuture<Suggestions> a(aeo<? extends hs<?>> var1, dv.a var2, SuggestionsBuilder var3, CommandContext<?> var4);

   boolean c(int var1);

   static <T> void a(Iterable<T> $$0, String $$1, Function<T, aep> $$2, Consumer<T> $$3) {
   ...
   static <T> void a(Iterable<T> $$0, String $$1, String $$2, Function<T, aep> $$3, Consumer<T> $$4) {
      if ($$1.isEmpty()) {
         $$0.forEach($$4);
      } else {
   ...
   static CompletableFuture<Suggestions> a(Iterable<aep> $$0, SuggestionsBuilder $$1, String $$2) {
      String $$3 = $$1.getRemaining().toLowerCase(Locale.ROOT);
      a($$0, $$3, $$2, $$0x -> $$0x, $$2x -> $$1.suggest($$2 + $$2x));
      return $$1.buildFuture();
   }

   static CompletableFuture<Suggestions> a(Stream<aep> $$0, SuggestionsBuilder $$1, String $$2) {
      return a($$0::iterator, $$1, $$2);
   }

   static CompletableFuture<Suggestions> a(Iterable<aep> $$0, SuggestionsBuilder $$1) {
      String $$2 = $$1.getRemaining().toLowerCase(Locale.ROOT);
      a($$0, $$2, $$0x -> $$0x, $$1x -> $$1.suggest($$1x.toString()));
      return $$1.buildFuture();
   }

   static <T> CompletableFuture<Suggestions> a(Iterable<T> $$0, SuggestionsBuilder $$1, Function<T, aep> $$2, Function<T, Message> $$3) {
      String $$4 = $$1.getRemaining().toLowerCase(Locale.ROOT);
      a($$0, $$4, $$2, $$3x -> $$1.suggest($$2.apply((T)$$3x).toString(), $$3.apply((T)$$3x)));
      return $$1.buildFuture();
   }

   static CompletableFuture<Suggestions> a(Stream<aep> $$0, SuggestionsBuilder $$1) {
      return a($$0::iterator, $$1);
   }

   static <T> CompletableFuture<Suggestions> a(Stream<T> $$0, SuggestionsBuilder $$1, Function<T, aep> $$2, Function<T, Message> $$3) {
      return a($$0::iterator, $$1, $$2, $$3);
   }

   static CompletableFuture<Suggestions> a(String $$0, Collection<dv.b> $$1, SuggestionsBuilder $$2, Predicate<String> $$3) {
   ...
   static CompletableFuture<Suggestions> b(String $$0, Collection<dv.b> $$1, SuggestionsBuilder $$2, Predicate<String> $$3) {
      List<String> $$4 = Lists.newArrayList();
      if (Strings.isNullOrEmpty($$0)) {
         for (dv.b $$5 : $$1) {
            String $$6 = $$5.c + " " + $$5.e;
   ...
   public static class b {
      public static final dv.b a = new dv.b("^", "^", "^");
      public static final dv.b b = new dv.b("~", "~", "~");
