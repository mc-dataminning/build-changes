...
public class akh {
                     ...
                     dv.a("join")
                        .then(
                           ((RequiredArgumentBuilder)dv.a("team", fc.a())
                                 .executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), Collections.singleton(((du)$$0x.getSource()).h().cy()))))
                     ...
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)dv.a(
                                    ...
                                    .then(
                                       ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a("nametagVisibility")
                                                   .then(dv.a("never").executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.b.b))))
                                                .then(dv.a("hideForOtherTeams").executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.b.c))))
                                             .then(dv.a("hideForOwnTeam").executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.b.d))))
                                          .then(dv.a("always").executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.b.a)))
                                    ))
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a("deathMessageVisibility")
                                                .then(dv.a("never").executes($$0x -> b((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.b.b))))
                                             .then(dv.a("hideForOtherTeams").executes($$0x -> b((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.b.c))))
                                          .then(dv.a("hideForOwnTeam").executes($$0x -> b((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.b.d))))
                                       .then(dv.a("always").executes($$0x -> b((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.b.a)))
                                 ))
                              .then(
                                 ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a("collisionRule")
                                             .then(dv.a("never").executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.a.b))))
                                          .then(dv.a("pushOwnTeam").executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.a.d))))
                                       .then(dv.a("pushOtherTeams").executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.a.c))))
                                    .then(dv.a("always").executes($$0x -> a((du)$$0x.getSource(), fc.a($$0x, "team"), ekv.a.a)))
                              ))
                           .then(
   ...
   private static int a(du $$0, ekr $$1, Collection<String> $$2) {
      ekt $$3 = $$0.m().aH();
   ...
   private static int a(du $$0, ekr $$1, ekv.b $$2) throws CommandSyntaxException {
      if ($$1.j() == $$2) {
         throw i.create();
      } else {
         $$1.a($$2);
   ...
   private static int b(du $$0, ekr $$1, ekv.b $$2) throws CommandSyntaxException {
      if ($$1.k() == $$2) {
         throw j.create();
      } else {
         $$1.b($$2);
   ...
   private static int a(du $$0, ekr $$1, ekv.a $$2) throws CommandSyntaxException {
      if ($$1.l() == $$2) {
         throw k.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(du $$0, ekr $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.i() == $$2) {
         if ($$2) {
            throw g.create();
         } else {
   ...
   private static int b(du $$0, ekr $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.h() == $$2) {
         if ($$2) {
            throw e.create();
         } else {
   ...
   private static int a(du $$0, ekr $$1, ur $$2) throws CommandSyntaxException {
      if ($$1.c().equals($$2)) {
         throw c.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(du $$0, ekr $$1, n $$2) throws CommandSyntaxException {
      if ($$1.n() == $$2) {
         throw d.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(du $$0, ekr $$1) throws CommandSyntaxException {
      ekt $$2 = $$0.m().aH();
   ...
   private static int b(du $$0, ekr $$1) {
      ekt $$2 = $$0.m().aH();
      $$2.d($$1);
   ...
   private static int c(du $$0, ekr $$1) {
   ...
   private static int a(du $$0) {
      Collection<ekr> $$1 = $$0.m().aH().g();
      if ($$1.isEmpty()) {
         $$0.a(() -> ur.c("commands.team.list.teams.empty"), false);
      } else {
         $$0.a(() -> ur.a("commands.team.list.teams.success", $$1.size(), uu.b($$1, ekr::d)), false);
      }

      return $$1.size();
   }

   private static int b(du $$0, ekr $$1, ur $$2) {
      $$1.b($$2);
      $$0.a(() -> ur.a("commands.team.option.prefix.success", $$2), false);
      return 1;
   }

   private static int c(du $$0, ekr $$1, ur $$2) {
      $$1.c($$2);
