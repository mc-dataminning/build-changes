...
public abstract class aox {
   ...
   static final int b = aoo.a(aoy.d);
   private static final int c = 4;
   final Long2ObjectMap<ObjectSet<apg>> d = new Long2ObjectOpenHashMap();
   final Long2ObjectOpenHashMap<axn<apj<?>>> e = new Long2ObjectOpenHashMap();
   private final aox.a f = new aox.a();
   private final aox.b g = new aox.b(8);
   ...
   protected void a() {
      this.p++;
      ObjectIterator<Entry<axn<apj<?>>>> $$0 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$0.hasNext()) {
         Entry<axn<apj<?>>> $$1 = (Entry<axn<apj<?>>>)$$0.next();
         Iterator<apj<?>> $$2 = ((axn)$$1.getValue()).iterator();
         boolean $$3 = false;
         ...
         if ($$3) {
            this.f.b($$1.getLongKey(), a((axn<apj<?>>)$$1.getValue()), false);
         }

         if (((axn)$$1.getValue()).isEmpty()) {
            $$0.remove();
         }
      }
   }

   private static int a(axn<apj<?>> $$0) {
      return !$$0.isEmpty() ? $$0.b().b() : aoo.a + 1;
   }

   protected abstract boolean a(long var1);

   @Nullable
   protected abstract aon b(long var1);

   @Nullable
   protected abstract aon a(long var1, int var3, @Nullable aon var4, int var5);

   public boolean a(aop $$0) {
      this.g.a();
      this.h.a();
      this.i.a();
      ...
      if (!this.j.isEmpty()) {
         ...
         if (!this.n.isEmpty()) {
            ...
            while ($$3.hasNext()) {
               long $$4 = $$3.nextLong();
               if (this.g($$4).stream().anyMatch($$0x -> $$0x.a() == apk.c)) {
                  aon $$5 = $$0.a($$4);
                  if ($$5 == null) {
   ...
   public void b(je $$0, apg $$1) {
      ...
      if ($$4.isEmpty()) {
         ...
         this.h.b(apk.c, $$2, this.g(), $$2);
      }
   }

   private int g() {
      return Math.max(0, aoo.a(aoy.d) - this.q);
   }

   public boolean c(long $$0) {
      return aoo.c(this.h.c($$0));
   }

   public boolean d(long $$0) {
      return aoo.d(this.h.c($$0));
   }

   protected String e(long $$0) {
      axn<apj<?>> $$1 = (axn<apj<?>>)this.e.get($$0);
   ...
   public void e() {
      ImmutableSet<apk<?>> $$0 = ImmutableSet.of(apk.h, apk.g, apk.e);
      ObjectIterator<Entry<axn<apj<?>>>> $$1 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$1.hasNext()) {
         Entry<axn<apj<?>>> $$2 = (Entry<axn<apj<?>>>)$$1.next();
         Iterator<apj<?>> $$3 = ((axn)$$2.getValue()).iterator();
         boolean $$4 = false;
         ...
         if ($$4) {
            this.f.b($$2.getLongKey(), a((axn<apj<?>>)$$2.getValue()), false);
         }

         if (((axn)$$2.getValue()).isEmpty()) {
            $$1.remove();
         }
      }
   }
   ...
   class a extends aos {
      private static final int b = aoo.a + 1;
      ...
      protected int b(long $$0) {
         axn<apj<?>> $$1 = (axn<apj<?>>)aox.this.e.get($$0);
         if ($$1 == null) {
   ...
   class b extends aos {
      ...
      private boolean d(long $$0) {
         ObjectSet<apg> $$1 = (ObjectSet<apg>)aox.this.d.get($$0);
      ...
      private void a(String $$0) {
         try (FileOutputStream $$1 = new FileOutputStream(new File($$0))) {
            ...
            aox.a.error("Failed to dump chunks to {}", $$0, var9);
         }
      }
   }

   class c extends aox.b {
      private int g;
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            ...
            if ($$3) {
               ...
               aox.this.m.a(aor.a(() -> aox.this.o.execute(() -> aox.this.b($$0, $$4)), $$0, true));
            }
         }
      }
