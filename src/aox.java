...
public class aox extends aow {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aox.a> s;
   private final aos t;
   private long u;
   private final afn v;

   private aox(afn $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aot.c($$2, 7, $$0.getLength());
      }
   }
