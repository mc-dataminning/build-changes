...
class aox implements Path {
   private static final BasicFileAttributes a = new aov() {
      @Override
   ...
   private static final BasicFileAttributes b = new aov() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<aox> c = Comparator.comparing(aox::n);
   ...
   public aox(aoz $$0, String $$1, @Nullable aox $$2, apa $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private aox a(@Nullable aox $$0, String $$1) {
      return new aox(this.e, $$1, $$0, apa.b);
   }
   ...
   aox a(String $$0) {
      if (a(this.i)) {
         return new aox(this.e, $$0, this, this.i);
      } else if (this.i instanceof apa.a $$1) {
         aox $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new aox(this.e, $$0, this, apa.a);
      } else if (this.i instanceof apa.b) {
         return new aox(this.e, $$0, this, apa.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(apa $$0) {
      return $$0 == apa.a || $$0 == apa.b;
   }
   ...
   private aox c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof aox $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof apa.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public apa.a i() {
      return this.i instanceof apa.a $$0 ? $$0 : null;
   }
