...
public class aox {
   ...
   private static int a(ep $$0, evl $$1, float $$2, float $$3, int $$4, boolean $$5, Collection<? extends bsp> $$6) throws CommandSyntaxException {
      arb $$7 = $$0.e();
      int $$8 = $$7.I_();
      if ($$4 < $$8) {
         throw d.create($$4, $$8);
         ...
         aox.a[] $$14 = a($$9, $$5 ? a($$6) : $$6.size(), $$10, $$11, $$12, $$13);
   ...
   private static int a(Collection<? extends bsp> $$0) {
      Set<ews> $$1 = Sets.newHashSet();
   ...
   private static void a(evl $$0, double $$1, arb $$2, azc $$3, double $$4, double $$5, double $$6, double $$7, int $$8, aox.a[] $$9, boolean $$10) throws CommandSyntaxException {
      boolean $$11 = true;
   ...
   private static double a(Collection<? extends bsp> $$0, arb $$1, aox.a[] $$2, int $$3, boolean $$4) {
      double $$5 = 0.0;
      int $$6 = 0;
      Map<ews, aox.a> $$7 = Maps.newHashMap();

      for (bsp $$8 : $$0) {
         aox.a $$10;
         if ($$4) {
            ews $$9 = $$8 instanceof cms ? $$8.cj() : null;
            if (!$$7.containsKey($$9)) {
               $$7.put($$9, $$2[$$6++]);
            }
         ...
         $$8.a($$1, (double)ayu.a($$10.a) + 0.5, (double)$$10.a($$1, $$3), (double)ayu.a($$10.b) + 0.5, Set.of(), $$8.dF(), $$8.dH());
   ...
   private static aox.a[] a(azc $$0, int $$1, double $$2, double $$3, double $$4, double $$5) {
      aox.a[] $$6 = new aox.a[$$1];
   ...
   static class a {
      ...
      public boolean b(daz $$0, int $$1) {
         iz $$2 = iz.a(this.a, (double)(this.a($$0, $$1) - 1), this.b);
         drx $$3 = $$0.a_($$2);
         return $$2.v() < $$1 && !$$3.k() && !$$3.a(awl.aK);
      }

      public void a(azc $$0, double $$1, double $$2, double $$3, double $$4) {
         this.a = ayu.a($$0, $$1, $$3);
         this.b = ayu.a($$0, $$2, $$4);
      }
   }
