...
public class gjt extends gki {
   private static final float a = 1.0472F;
   private int b;

   gjt(gga $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   public static class a implements gjl<lw> {
      private final gkd a;
      ...
      public gji a(lw $$0, gga $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gjt $$8 = new gjt($$1, $$2, $$3, $$4, $$0.b());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
