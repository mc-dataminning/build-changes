public abstract class gjt extends gjp {
   private static final float o = 0.0F;
   private static final float p = 1.2F;
   private static final float q = 0.0F;
   protected final bzu n;
   private boolean r;

   public gjt(bzu $$0, atj $$1, atl $$2) {
      super($$1, $$2, gkg.t());
      this.n = $$0;
   ...
   public void q() {
      ...
      if (!this.n.dH() && !this.r) {
         ...
         if ($$1 >= 0.01F) {
            this.e = awh.i(awh.a($$1, this.u(), this.v()), this.u(), this.v());
            this.d = awh.i(awh.a($$1, 0.0F, 0.5F), 0.0F, 1.2F);
         } else {
            this.e = 0.0F;
            this.d = 0.0F;
         }
