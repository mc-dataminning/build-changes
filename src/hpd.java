...
public class hpd {
   ...
   public static class a extends Thread {
      private final hpd.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(hpd.b $$0) throws IOException {
         super("LanServerDetector #" + hpd.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new s(hpd.b));
   ...
   public static class b {
      private final List<hpc> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<hpc> a() {
         if (this.b) {
            List<hpc> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
