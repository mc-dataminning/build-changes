...
public class ym<B extends ByteBuf, V, T> implements yn<B, V> {
   ...
   private final List<ym.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   ym(Function<V, ? extends T> $$0, List<ym.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         wg.a($$0, $$3);
         ym.b<B, V, T> $$4 = this.c.get($$3);

         try {
            yn<? super B, V> $$5 = (yn<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> ym.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new ym.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<ym.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public ym.a<B, V, T> a(T $$0, yn<? super B, ? extends V> $$1) {
         this.a.add(new ym.b<>($$1, $$0));
         return this;
      }
      ...
      public ym<B, V, T> a() {
         ...
         return new ym<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(yn<? super B, ? extends V> a, T b) {
   }
}
