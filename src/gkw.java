public class gkw implements gks<dsq> {
   private final gpi a;
   ...
   public void a(dsq $$0, float $$1, feb $$2, gih $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.m().c(dvz.bv);
         if ($$6 > 0) {
            jm $$7 = $$0.c();
            if ($$7 != null) {
               ...
               if (!$$8.f()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = gid.a($$0.i(), $$0.m(), $$0.aB_().a($$7));
                  this.a.a($$8, cvz.i, $$11, gxu.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
