...
public class gkw extends gkt {
   ...
   private final List<hhz> cT = Lists.newArrayList();
   private int cU = 0;
   private double cV;
   private double cW;
   private double cX;
   ...
   public gkw(flj $$0, gfz $$1, gga $$2, awl $$3, fku $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.o());
      this.cC = $$0;
      this.j = $$2;
      this.cQ = $$3;
      ...
      this.dd = $$5;
      this.de = $$6;
      this.cT.add(new hir(this, $$0.ak()));
      this.cT.add(new hie(this));
      this.cT.add(new hid(this, $$0.ak(), $$1.I_()));
   }
   ...
   public boolean a(bul $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof cqw) {
            this.cC.ak().a((hip)(new hij(this, (cqw)$$0, true)));
            this.cC.ak().a((hip)(new hij(this, (cqw)$$0, false)));
         }
   ...
   @Override
   public bsj fA() {
      return Objects.requireNonNullElse(this.dl, bsj.a);
   }
   ...
   public void a(dvm $$0, boolean $$1) {
      if ($$0 instanceof duz $$2) {
         this.cC.a(new fvy($$2, $$1, this.cC.aT()));
      } else {
         this.cC.a(new fwl($$0, $$1, this.cC.aT()));
      }
   }
   ...
   public void d_() {
      ...
      boolean $$2 = this.T();
      cot $$3 = this.gj();
      this.dc = !$$3.b && !this.ck() && !this.bZ() && this.h(bvt.f) && (this.cd() || !this.fR() && !this.h(bvt.a));
      this.k.a();
      this.cC.aB().a(this.k);
      if (this.N()) {
         this.h(false);
   ...
   private boolean O() {
      return this.dk() != null && this.dk().aq() == bus.t;
   }
   ...
   private void z(boolean $$0) {
      ...
      if ($$0 && this.as != null && this.as.e()) {
         if (this.cC.z != null && !this.cC.z.k() && !(this.cC.z instanceof ftp) && !(this.cC.z instanceof fuo)) {
            if (this.cC.z instanceof fva) {
               this.p();
            }
         ...
         if (this.cI == 0.0F) {
            this.cC.ak().a(hik.b(awa.vj, this.ae.i() * 0.4F + 0.8F, 0.25F));
         }
   ...
   protected void h(float $$0, float $$1) {
      if (this.Q()) {
         ...
         if (!($$15 < -0.15F)) {
            ...
            dwx $$18 = this.dV().a_($$17);
            if ($$18.b(this.dV(), $$17, $$16).c()) {
               $$17 = $$17.d();
               dwx $$19 = this.dV().a_($$17);
               if ($$19.b(this.dV(), $$17, $$16).c()) {
                  ...
                  fba $$32 = $$23.e($$29);
                  fba $$33 = $$24.e($$29);
                  Iterable<fbu> $$34 = this.dV().d(this, $$27);
   ...
   protected boolean gb() {
      ...
      if (this.Z_()) {
         ...
         if (!$$0 && $$1) {
            ...
            this.cC.ak().a((hip)(new his.b(this)));
         }
   ...
   public fba u(float $$0) {
      if (this.cC.n.aE().a()) {
         ...
         double $$3 = this.fy() == bvb.b ? -1.0 : 1.0;
