...
public abstract class fin {
   ...
   protected abstract void a(foe var1, int var2, int var3, boolean var4);
   ...
   public static void a(foe $$0, List<fin> $$1, fom<?> $$2, int $$3, int $$4, int $$5, int $$6) {
      for (fin $$7 : $$1) {
         if ($$2.a() > $$7.a()) {
            $$7.a($$0, $$3, $$4, $$5, $$6);
         }
   ...
   public static void a(fom<?> $$0, fpp.a<?> $$1, List<fin> $$2, int $$3, double $$4, double $$5) {
