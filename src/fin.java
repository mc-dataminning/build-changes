...
public class fin {
   ...
   private final List<fgi> k = Lists.newArrayList();
   private final List<fgi.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fin.a> o = new ArrayList<>();
   ...
   public void a(fhz $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
   ...
   private void a(fhz $$0, int $$1, int $$2, fgj.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fgi.a $$0) {
   ...
   public void a(wz $$0) {
      this.a($$0, null, this.i.W() ? fgj.b() : fgj.a());
   }

   public void a(wz $$0, @Nullable xl $$1, @Nullable fgj $$2) {
      fgi $$3 = new fgi(this.i.l.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(fgi $$0) {
      ...
      List<aya> $$3 = fir.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fgi.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fin.a b(xl $$0) {
      int $$1 = this.i.l.e();
      ListIterator<fgi> $$2 = this.k.listIterator();
   ...
   private fgi d(fgi $$0) {
      return new fgi($$0.b(), h, null, fgj.a());
   }
   ...
   private void n() {
      ...
      for (fgi $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public fgj c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fgi.a $$1, fgj $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fgj.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.y instanceof fmz;
   }
   ...
   public fin.b k() {
      return new fin.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fin.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<fgi> $$0, List<String> $$1, List<fin.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
