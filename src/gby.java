...
public class gby<T extends gyk> extends gbl<T> implements gah, gbu {
   public static final gew i = new gam(true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F, Set.of("head"));
   ...
   public gby(gen $$0, Function<alz, glu> $$1) {
      super($$0, $$1);
      this.o = $$0.b("head");
      this.p = this.o.b("hat");
      this.q = $$0.b("body");
   ...
   public static gev a(ger $$0, float $$1) {
      gev $$2 = new gev();
      gex $$3 = $$2.a();
      gex $$4 = $$3.a("head", ges.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gep.a(0.0F, 0.0F + $$1, 0.0F));
      $$4.a("hat", ges.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), gep.a);
      $$3.a("body", ges.c().a(16, 16).a(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, $$0), gep.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("right_arm", ges.c().a(40, 16).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gep.a(-5.0F, 2.0F + $$1, 0.0F));
      $$3.a("left_arm", ges.c().a(40, 16).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gep.a(5.0F, 2.0F + $$1, 0.0F));
      $$3.a("right_leg", ges.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gep.a(-1.9F, 12.0F + $$1, 0.0F));
      $$3.a("left_leg", ges.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gep.a(1.9F, 12.0F + $$1, 0.0F));
      return $$2;
   }

   protected gby.a a(T $$0, bvz $$1) {
      return gby.a.a;
   }

   public void a(T $$0) {
      super.a($$0);
      gby.a $$1 = this.a($$0, bvz.a);
      gby.a $$2 = this.a($$0, bvz.b);
      float $$3 = $$0.B;
      boolean $$4 = $$0.J;
      ...
      if ($$2 != gby.a.h) {
         gaf.a(this.r, $$0.p, 1.0F);
      }

      if ($$1 != gby.a.h) {
         gaf.a(this.s, $$0.p, -1.0F);
      }
   ...
   private void a(T $$0, gby.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gaf.a(this.r, this.s, $$0.E, $$0.F, true);
            break;
         case g:
            gaf.a(this.r, this.s, this.o, true);
            break;
         case h:
   ...
   private void b(T $$0, gby.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gaf.a(this.r, this.s, $$0.E, $$0.F, false);
            break;
         case g:
            gaf.a(this.r, this.s, this.o, false);
            break;
         case h:
   ...
   private void a(gen $$0, boolean $$1) {
