...
public class gby extends gcb {
   gby(fxu $$0, gbw $$1, double $$2, double $$3, double $$4) {
      super($$0, $$2, $$3 - 0.125, $$4);
      this.b(0.01F, 0.01F);
      this.a($$1);
   ...
   gby(fxu $$0, gbw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
   ...
   public static class a implements gbe<lm> {
      ...
      public gbb a(lm $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         gby $$12 = new gby($$1, this.a, $$2, $$3, $$4, $$9, $$10, $$11);
         $$12.a(0.9F, 0.4F, 0.5F);
         return $$12;
      }
   }
   ...
   public static class b implements gbe<lm> {
      ...
      public gbb a(lm $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gby $$8 = new gby($$1, this.a, $$2, $$3, $$4, 0.0, -0.8F, 0.0) {
            @Override
            public Optional<lf> o() {
               return Optional.of(lf.a);
            }
         };
         $$8.t = ayy.b($$1.z, 500, 1000);
         $$8.u = 0.01F;
   ...
   public static class d implements gbe<lm> {
      ...
      public gbb a(lm $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         gby $$9 = new gby($$1, this.a, $$2, $$3, $$4, 0.0, $$8, 0.0);
         $$9.a(0.1F, 0.1F, 0.3F);
         $$9.b(0.001F, 0.001F);
         return $$9;
      }
