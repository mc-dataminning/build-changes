...
public abstract class cqj extends cpg {
   private static final int k = 9;
   private static final int l = 3;
   protected final cpr o;
   protected final cly p;
   protected final bpt q;
   ...
   protected abstract void a(cly var1, cuh var2);

   protected abstract boolean a(dtc var1);

   public cqj(@Nullable cqo<?> $$0, int $$1, clx $$2, cpr $$3) {
      super($$0, $$1);
      this.o = $$3;
      this.p = $$2.l;
      cqk $$4 = this.l();
