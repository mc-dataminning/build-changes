...
public class gdf implements ezk, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final ezi c = new ezi();
   private static final boolean d = true;
   private static gdf e;
   ...
   private final List<ezq> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, ezq> l = Maps.newHashMap();
   private final int m;
   ...
   public gdf(aus $$0, String $$1) throws IOException {
      alf $$2 = new alf("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      aun $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         JsonArray $$13 = ayp.a($$5, "attributes", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         JsonArray $$18 = ayp.a($$5, "uniforms", null);
         if ($$18 != null) {
            int $$19 = 0;
         ...
         this.p = a(ayp.a($$5, "blend", null));
         this.s = a($$0, ezn.a.a, $$6);
         this.t = a($$0, ezn.a.b, $$7);
         this.m = ezo.a();
         ezo.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = ezq.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static ezl a(aus $$0, ezn.a $$1, String $$2) throws IOException {
      ezn $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof ezl)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         ezl $$7;
         if ($$3 == null) {
            alf $$4 = new alf("shaders/program/" + $$2 + $$1.b());
            aun $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static ezj a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new ezj();
      } else {
         int $$1 = 32774;
         ...
         boolean $$7 = false;
         if (ayp.a($$0, "func")) {
            $$1 = ezj.a($$0.get("func").getAsString());
            if ($$1 != 32774) {
               $$6 = false;
            }
         }
         ...
         if (ayp.a($$0, "srcrgb")) {
            $$2 = ezj.b($$0.get("srcrgb").getAsString());
            if ($$2 != 1) {
               $$6 = false;
            }
         }
         ...
         if (ayp.a($$0, "dstrgb")) {
            $$3 = ezj.b($$0.get("dstrgb").getAsString());
            if ($$3 != 0) {
               $$6 = false;
            }
         }
         ...
         if (ayp.a($$0, "srcalpha")) {
            $$4 = ezj.b($$0.get("srcalpha").getAsString());
            if ($$4 != 1) {
               $$6 = false;
            }
         ...
         if (ayp.a($$0, "dstalpha")) {
            $$5 = ezj.b($$0.get("dstalpha").getAsString());
            if ($$5 != 0) {
               $$6 = false;
            }
         ...
         if ($$6) {
            ...
            return $$7 ? new ezj($$2, $$3, $$4, $$5, $$1) : new ezj($$2, $$3, $$1);
         }
      }
   }
   ...
   @Nullable
   public ezq a(String $$0) {
      RenderSystem.assertOnRenderThread();
      return this.l.get($$0);
   }

   public ezi b(String $$0) {
      RenderSystem.assertOnGameThread();
      ezq $$1 = this.a($$0);
      return (ezi)($$1 == null ? c : $$1);
   }
