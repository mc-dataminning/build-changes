...
public class cy extends cx<cy.a> {
   ...
   public static record a(Optional<bc> b, Optional<in<dch>> c, Optional<dc> d) implements cx.a {
      public static final Codec<cy.a> a = awu.b(
         RecordCodecBuilder.create(
            $$0 -> $$0.group(awu.a(br.b, "player").forGetter(cy.a::a), awu.a(kt.e.r(), "block").forGetter(cy.a::b), awu.a(dc.a, "state").forGetter(cy.a::c))
                  .apply($$0, cy.a::new)
         ),
         cy.a::a
      );
