...
public class cy extends cx<cy.a> {
   ...
   public static record a(Optional<bc> b, Optional<ij<cys>> c, Optional<db> d) implements cx.a {
      public static final Codec<cy.a> a = avq.a(
         RecordCodecBuilder.create(
            $$0 -> $$0.group(avq.a(br.b, "player").forGetter(cy.a::a), avq.a(kf.e.r(), "block").forGetter(cy.a::b), avq.a(db.a, "state").forGetter(cy.a::c))
                  .apply($$0, cy.a::new)
         ),
         cy.a::a
      );
