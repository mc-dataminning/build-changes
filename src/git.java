...
public class git implements giw.a, AutoCloseable {
   ...
   eta[] f;
   @Nullable
   private final git.a g;
   private final asq h;

   public git(ajh $$0, gkl $$1, eta $$2, asq $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gkj $$4 = $$3.a(gkj.a).orElse(gkj.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new eta[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gio.a(this.f, $$0);
   ...
   @Nullable
   private git.a a(gkl $$0, int $$1, int $$2, gkj $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<git.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new git.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new git.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<git.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            git.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new git.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, eta[] $$4) {
   ...
   class a {
      ...
      a(List<git.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * git.this.c;
         int $$4 = this.b($$2) * git.this.d;
         git.this.a($$0, $$1, $$3, $$4, git.this.f);
      }

      public giv a() {
         return git.this.new d(this, this.d ? git.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final eta[] b = new eta[git.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = git.this.c >> $$0;
            int $$2 = git.this.d >> $$0;
            this.b[$$0] = new eta($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, git.d $$2) {
         git.a $$3 = $$2.d;
         List<git.b> $$4 = $$3.b;
         git.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            git.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(git.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return git.this.f[$$2].a($$3 + ($$0.a($$1) * git.this.c >> $$2), $$4 + ($$0.b($$1) * git.this.d >> $$2));
      }
   ...
   class d implements giv {
      int b;
      int c;
      final git.a d;
      @Nullable
      private final git.c e;

      d(git.a $$0, @Nullable git.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
