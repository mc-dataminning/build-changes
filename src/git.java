...
public class git implements gim.a {
   private final fgo a;
   ...
   public void a(fbi $$0, gez $$1, double $$2, double $$3, double $$4) {
      ...
      while ($$11.hasNext()) {
         ...
         if ($$15 > 200L) {
            ...
            for (Entry<jd, Integer> $$16 : $$14.entrySet()) {
               ...
               if ($$8.add($$17)) {
                  ewx $$19 = new ewx(jd.c).g(0.002).h(0.0025 * (double)$$15).d((double)$$17.u(), (double)$$17.v(), (double)$$17.w()).d(-$$2, -$$3, -$$4);
                  gex.a($$0, $$10, $$19.a, $$19.b, $$19.c, $$19.d, $$19.e, $$19.f, 1.0F, 1.0F, 1.0F, 1.0F);
                  $$9.put($$17, $$18);
               }
            }
         }
      ...
      for (Entry<jd, Integer> $$20 : $$9.entrySet()) {
         ...
         gim.a($$0, $$1, String.valueOf($$22), $$21.u(), $$21.v(), $$21.w(), -1);
      }
   }
}
