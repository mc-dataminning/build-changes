...
public class csa extends cri {
   ...
   public boolean a(cmx $$0) {
      return $$0.d() instanceof ckh ? true : super.a($$0);
   }

   @Override
   public void b(bmk $$0, blu $$1, int $$2) {
      auu $$3 = $$0.eg();
      Entry<blz, cmx> $$4 = crk.b(crm.h, $$0);
      if (a($$2, $$3)) {
         if ($$1 != null) {
   ...
   public static boolean a(int $$0, auu $$1) {
      return $$0 <= 0 ? false : $$1.i() < 0.15F * (float)$$0;
   }

   public static int b(int $$0, auu $$1) {
