...
public class etl {
   ...
   public void b(int $$0) {
      if (!this.i()) {
         this.g = arx.a(this.f + $$0, 0, this.e.length());
      }
   ...
   public etl.a c(int $$0) {
      return this.d.get(arx.a($$0, 0, this.d.size() - 1));
   }
   ...
   public void a(eub $$0, int $$1) {
      ...
      this.f = arx.a(this.f, 0, this.e.length());
      this.l.run();
      if (!this.h) {
         this.g = this.f;
      }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = arx.a($$0);
      int $$3 = arx.a($$1 / 9.0);
      etl.a $$4 = this.d.get(arx.a($$3, 0, this.d.size() - 1));
   ...
   private etl.a f(int $$0) {
      ...
      if ($$1 < 0) {
         ...
         return this.d.get(arx.a($$1 + $$0, 0, this.d.size() - 1));
      }
   }
   ...
   public etl.a k() {
      if (this.e.isEmpty()) {
         ...
         int $$0 = arx.a(this.f, 0, this.e.length() - 1);
