...
public enum bvk implements azv {
   a(0, "any", $$0 -> true),
   b(1, "mainhand", bvj.a),
   c(2, "offhand", bvj.b),
   ...
   public static final IntFunction<bvk> k = axq.a($$0 -> $$0.n, values(), axq.a.a);
   public static final Codec<bvk> l = azv.a(bvk::values);
   public static final yn<ByteBuf, bvk> m = yl.a(k, $$0 -> $$0.n);
   private final int n;
