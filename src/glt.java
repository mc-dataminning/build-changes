...
public class glt implements AutoCloseable {
   ...
   public glt(glm $$0, flh $$1) {
      this.h = $$0;
      this.i = $$1;
      this.e = new fed(16, 16, false);
      this.e.a(9729);
   ...
   private float b(float $$0) {
      bto $$1 = this.i.t.c(btq.G);
      return $$1 != null ? $$1.a(this.i.t, $$0) : 0.0F;
   }

   private float a(bvf $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
      return Math.max(0.0F, ayy.b(((float)$$0.af - $$2) * (float) Math.PI * 0.025F) * $$3);
   }
   ...
   public void a(float $$0) {
      if (this.f) {
         ...
         if ($$2 != null) {
            ...
            if (this.i.t.b(btq.p)) {
               $$10 = glm.a(this.i.t, $$0);
            } else if ($$9 > 0.0F && this.i.t.b(btq.C)) {
               $$10 = $$9;
            } else {
               $$10 = 0.0F;
            }
            ...
            glf $$18 = Objects.requireNonNull(RenderSystem.setShader(glg.b), "Lightmap shader not loaded");
            ...
            this.e.a(true);
            ffn $$19 = RenderSystem.renderThreadTesselator().a(ffx.c.h, ffq.a);
            $$19.a(0.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 0.0F, 0.0F);
            $$19.a(1.0F, 1.0F, 0.0F);
            $$19.a(0.0F, 1.0F, 0.0F);
   ...
   public static float a(eaq $$0, int $$1) {
      return a($$0.s(), $$1);
   }
