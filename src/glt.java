...
public class glt implements gmo {
   ...
   private CompletableFuture<Optional<csa>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public glt(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(csa::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<csa>> a(Optional<csa> $$0) {
      return CompletableFuture.supplyAsync(() -> {
         if ($$0.isPresent() && !$$0.get().a()) {
            ...
            } catch (aym | MinecraftClientException | IOException var3) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = csa.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable csa $$0) {
      ...
      if ($$0 != null) {
         if (ac.aU) {
            csa.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private csa a(UserApiService $$0) throws aym, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         csb.a $$2 = a($$1);
         return new csa(ayl.a($$1.keyPair().privateKey()), new csb($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static csb.a a(KeyPairResponse $$0) throws aym {
      KeyPair $$1 = $$0.keyPair();
      if ($$1 != null && !Strings.isNullOrEmpty($$1.publicKey()) && $$0.publicKeySignature() != null && $$0.publicKeySignature().array().length != 0) {
         try {
            ...
            PublicKey $$3 = ayl.b($$1.publicKey());
            ByteBuffer $$4 = $$0.publicKeySignature();
            return new csb.a($$2, $$3, $$4.array());
         } catch (IllegalArgumentException | DateTimeException var5) {
            throw new aym(var5);
         }
      } else {
         throw new aym(new MissingException("Missing public key"));
      }
   }
}
