...
public class glt implements auq, AutoCloseable {
   ...
   private final ObjectArrayList<gpl.b> r = new ObjectArrayList(10000);
   private final ObjectArrayList<gpl.b> s = new ObjectArrayList(50);
   private final Set<dty> t = Sets.newHashSet();
   @Nullable
   private gmw u;
   private int v;
   ...
   public glt(fli $$0, gsb $$1, goi $$2, gmf $$3) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
      this.k = $$3;
   ...
   public void a() {
      ...
      this.y = new fee(this.h.aO().k(), this.h.aO().l(), true);
   ...
   public void e() {
      if (this.p != null) {
         this.p.f();
         if (this.I == null) {
            this.I = new gpl(this.p, this, af.g(), this.k, this.h.ap(), this.h.ar());
         } else {
            this.I.a(this.p);
         }
   ...
   private void a(fkq $$0, gpp $$1, boolean $$2, boolean $$3) {
      faz $$4 = $$0.b();
   ...
   public static gpp a(gpp $$0) {
      return new gpp($$0).a(8);
   }

   private void b(gpp $$0) {
      if (!fli.Q().bx()) {
   ...
   public void a(gpl.b $$0) {
      this.q.a($$0);
   }

   public void a(faz $$0, Matrix4f $$1, Matrix4f $$2) {
      this.M = new gpp($$1, $$2);
      this.M.a($$0.a(), $$0.b(), $$0.c());
   }

   public void a(ffc $$0, fky $$1, boolean $$2, fkq $$3, glo $$4, Matrix4f $$5, Matrix4f $$6) {
      float $$7 = $$1.a(false);
      ...
      gpp $$14 = $$13 ? this.O : this.M;
      bor.a().b("captureFrustum");
      if (this.N) {
         this.O = $$13 ? new gpp($$5, $$6) : $$14;
         this.O.a($$10, $$11, $$12);
         this.N = false;
      }
   ...
   private void a(fdx $$0, gpp $$1, fkq $$2, Matrix4f $$3, Matrix4f $$4, glm $$5, boolean $$6, boolean $$7, fky $$8, bos $$9) {
      fdy $$10 = $$0.a("main");
   ...
   private void a(fdx $$0, fkq $$1, float $$2, glm $$3) {
      fdy $$4 = $$0.a("particles");
      if (this.z.n != null) {
   ...
   private void a(fdx $$0, Matrix4f $$1, Matrix4f $$2, fku $$3, faz $$4, float $$5, int $$6, float $$7) {
      fdy $$8 = $$0.a("clouds");
      if (this.z.p != null) {
   ...
   private void a(fdx $$0, faz $$1, float $$2, glm $$3) {
   ...
   private void a(fdx $$0, faz $$1, glm $$2) {
      fdy $$3 = $$0.a("late_debug");
   ...
   private boolean a(fkq $$0, gpp $$1, List<buk> $$2) {
      faz $$3 = $$0.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
   ...
   private void a(fft $$0, glx.a $$1, fkq $$2, fky $$3, List<buk> $$4) {
      faz $$5 = $$2.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
   ...
   private void a(fft $$0, glx.a $$1, glx.a $$2, fkq $$3, float $$4) {
      faz $$5 = $$3.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
         ...
         if (!$$10.isEmpty()) {
            for (dty $$11 : $$10) {
               ...
               if ($$14 != null && !$$14.isEmpty()) {
                  ...
                  if ($$15 >= 0) {
                     fft.a $$16 = $$0.c();
                     ffx $$17 = new ffu($$2.getBuffer(hhb.l.get($$15)), $$16, 1.0F);
                     $$13 = $$2x -> {
                        ffx $$3x = $$1.getBuffer($$2x);
                        return $$2x.W() ? fga.a($$17, $$3x) : $$3x;
                     };
                  }
               }
   ...
   private void a(fft $$0, fkq $$1, glx.a $$2) {
      faz $$3 = $$1.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      ...
      while (var11.hasNext()) {
         ...
         if (!($$8.c($$4, $$5, $$6) > 1024.0)) {
            ...
            if ($$9 != null && !$$9.isEmpty()) {
               ...
               fft.a $$11 = $$0.c();
               ffx $$12 = new ffu($$2.getBuffer(hhb.l.get($$10)), $$11, 1.0F);
   ...
   private void a(fkq $$0, glx.a $$1, fft $$2, boolean $$3) {
      if (this.h.w instanceof fav $$4) {
         if ($$4.d() != fax.a.a) {
            ji $$6 = $$4.b();
            dww $$7 = this.p.a_($$6);
            if (!$$7.l() && this.p.F_().a($$6)) {
               ...
               if ($$10) {
                  ffx $$11 = $$1.getBuffer(gmh.z());
                  this.a($$2, $$11, $$0.g(), $$9.d, $$9.e, $$9.f, $$6, $$7, -16777216);
               }

               ffx $$12 = $$1.getBuffer(gmh.y());
   ...
   private void a(buk $$0, double $$1, double $$2, double $$3, float $$4, fft $$5, glx $$6) {
   ...
   private void a(faz $$0) {
      if (!this.r.isEmpty()) {
         ...
         while ($$5x-- > 0) {
            ...
            this.a((gpl.b)this.r.get($$6), $$3, $$0, $$2, false);
         }
   ...
   private void a(gpl.b $$0, gpl.d $$1, faz $$2, boolean $$3, boolean $$4) {
      $$1.b($$2, $$0.g());
   ...
   private void a(gmh $$0, double $$1, double $$2, double $$3, Matrix4f $$4, Matrix4f $$5) {
      ...
      $$6.a($$0::toString);
      boolean $$7 = $$0 != gmh.f();
      ObjectListIterator<gpl.b> $$8 = this.r.listIterator($$7 ? 0 : this.r.size());
      $$0.a();
      ...
      if ($$9 == null) {
         ...
         $$9.a(ffy.c.h, $$4, $$5, this.h.aO());
         $$9.b();
         ffk $$10 = $$9.o;

         while ($$7 ? $$8.hasNext() : $$8.hasPrevious()) {
            gpl.b $$11 = $$7 ? (gpl.b)$$8.next() : (gpl.b)$$8.previous();
            if (!$$11.d().a($$0)) {
               ffw $$12 = $$11.a($$0);
               ji $$13 = $$11.f();
               if ($$10 != null) {
   ...
   private void b(fdx $$0, fkq $$1, float $$2, glm $$3) {
      eta $$4 = $$1.k();
      if ($$4 != eta.c && $$4 != eta.a && !this.b($$1)) {
         glk $$5 = this.p.c();
         glk.d $$6 = $$5.c();
         if ($$6 != glk.d.a) {
            fdy $$7 = $$0.a("sky");
   ...
   private boolean b(fkq $$0) {
      return !($$0.g() instanceof bvg $$1) ? false : $$1.b(btr.o) || $$1.b(btr.G);
   }

   private void c(fkq $$0) {
      bos $$1 = bor.a();
      $$1.a("populate_sections_to_compile");
      gpj $$2 = new gpj();
      ji $$3 = $$0.c();
      List<gpl.b> $$4 = Lists.newArrayList();
      ObjectListIterator var6 = this.r.iterator();

      while (var6.hasNext()) {
         gpl.b $$5 = (gpl.b)var6.next();
         if ($$5.i() && $$5.a()) {
            boolean $$6 = false;
            if (this.h.n.m().c() == flo.c) {
               ji $$7 = $$5.f().b(8, 8, 8);
               $$6 = $$7.j($$3) < 768.0 || $$5.j();
            } else if (this.h.n.m().c() == flo.b) {
               $$6 = $$5.j();
            }
   ...
   private void a(fft $$0, ffx $$1, buk $$2, double $$3, double $$4, double $$5, ji $$6, dww $$7, int $$8) {
      gmr.a($$0, $$1, $$7.a(this.p, $$6, fbe.a($$2)), (double)$$6.u() - $$3, (double)$$6.v() - $$4, (double)$$6.w() - $$5, $$8);
   }

   public void a(dfm $$0, ji $$1, dww $$2, dww $$3, int $$4) {
      this.a($$1, ($$4 & 8) != 0);
   }
   ...
   public void a(Collection<dty> $$0, Collection<dty> $$1) {
      synchronized (this.t) {
         this.t.removeAll($$0);
         this.t.addAll($$1);
      }
   ...
   public static int a(dfj $$0, ji $$1) {
      return a($$0, $$0.a_($$1), $$1);
   }

   public static int a(dfj $$0, dww $$1, ji $$2) {
      if ($$1.b($$0, $$2)) {
         return 15728880;
      } else {
         int $$3 = $$0.a(dgq.a, $$2);
   ...
   @bag
   public ObjectArrayList<gpl.b> w() {
      return this.r;
   }
