...
public class awd extends awc {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, awd.a> s;
   private final avy t;
   private long u;
   private final alu v;

   private awd(alu $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == avz.c($$2, 7, $$0.getLength());
      }
   }
