...
public class ehh implements PathMatcher {
   ...
   public static ehh a(BufferedReader $$0) {
      return new ehh($$0.lines().flatMap($$0x -> ehh.a.a($$0x).stream()).toList());
   }

   public static record a(ehh.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ehh.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ehh.a(ehh.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ehh.a(ehh.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ehh.a(ehh.b.b, $$3));
      ...
      static ehh.a b(String $$0) {
         return new ehh.a(ehh.b.a, "glob:" + $$0);
      }

      static ehh.a c(String $$0) {
         return new ehh.a(ehh.b.a, "regex:" + $$0);
      }

      static ehh.a d(String $$0) {
         return new ehh.a(ehh.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ehh.b a = FileSystem::getPathMatcher;
      ehh.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
