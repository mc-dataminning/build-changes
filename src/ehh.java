...
public class ehh extends efx<eiv> {
   public static final int a = 10;
   private static final int b = 42;
   private static final LoadingCache<Long, List<ehh.a>> c = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).build(new ehh.b());

   public ehh(Codec<eiv> $$0) {
      super($$0);
   }

   public static List<ehh.a> a(dhf $$0) {
      azh $$1 = azh.a($$0.E());
      long $$2 = $$1.g() & 65535L;
      return (List<ehh.a>)c.getUnchecked($$2);
   }

   @Override
   public boolean a(efz<eiv> $$0) {
      eiv $$1 = $$0.f();
      dhf $$2 = $$0.b();
      azh $$3 = $$0.d();
      ji $$4 = $$0.e();
   ...
   private void a(dgy $$0, azh $$1, eiv $$2, ehh.a $$3) {
      int $$4 = $$3.c();
            ...
            for (int $$11 = -2; $$11 <= 2; $$11++) {
               for (int $$12 = 0; $$12 <= 3; $$12++) {
                  ...
                  if ($$13 || $$14 || $$15) {
                     ...
                     dww $$18 = djn.fk
                        .m()
                        .b(dno.a, Boolean.valueOf($$16 && $$11 != -2))
                        .b(dno.c, Boolean.valueOf($$16 && $$11 != 2))
                        .b(dno.d, Boolean.valueOf($$17 && $$10 != -2))
                        .b(dno.b, Boolean.valueOf($$17 && $$10 != 2));
      ...
      if ($$19 != null) {
         ...
         $$0.b($$19);
         ji $$20 = $$19.dv();
         this.a($$0, $$20.e(), djn.I.m());
         this.a($$0, $$20, dmm.a($$0, $$20));
      }
   }

   public static class a {
      public static final Codec<ehh.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      public a(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
         ...
         this.e = $$3;
         this.f = $$4;
         this.g = new fau((double)($$0 - $$2), (double)ear.e, (double)($$1 - $$2), (double)($$0 + $$2), (double)ear.d, (double)($$1 + $$2));
      }
   ...
   static class b extends CacheLoader<Long, List<ehh.a>> {
      public List<ehh.a> a(Long $$0) {
         IntArrayList $$1 = af.a(IntStream.range(0, 10), azh.a($$0));
         List<ehh.a> $$2 = Lists.newArrayList();
