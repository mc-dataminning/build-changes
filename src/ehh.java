...
public class ehh implements azv {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<ehh> b = ehg.a.xmap($$0 -> new ehh($$0), $$0 -> $$0.e);
   private ehg e;
   private final egi f = new egi(this);

   public ehh(long $$0) {
      this.e = new ehg(egv.c($$0));
   }
   ...
   @Override
   public azv d() {
      return new ehh(this.e.a(), this.e.a());
   }

   @Override
   public egt e() {
      return new ehh.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements egt {
      ...
      public azv a(int $$0, int $$1, int $$2) {
         long $$3 = azm.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new ehh($$4, this.b);
      }

      @Override
      public azv a(String $$0) {
         egv.a $$1 = egv.a($$0);
         return new ehh($$1.a(this.a, this.b));
      }

      @Override
      public azv a(long $$0) {
         return new ehh($$0 ^ this.a, $$0 ^ this.b);
      }
