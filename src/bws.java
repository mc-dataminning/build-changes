...
public class bws {
   ...
   public static buv<btk> a(float $$0) {
      ...
      return byh.a(
         (Function<byh.b<btk>, ? extends App<byh.c<btk>, byk<btk>>>)($$3 -> $$3.group($$3.c(ccf.m), $$3.c(ccf.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.Z() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cef $$7 = $$4x.y();
                        Optional<ja> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cej.n), $$5.dq(), 48, cef.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dq()) <= 4.0)) {
                           ...
                           Set<Pair<jj<cei>, ja>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cej.n), $$10, $$5.dq(), 48, cef.b.c).collect(Collectors.toSet());
                           eov $$12 = bun.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              ja $$13 = $$12.l();
                              Optional<jj<cei>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new cci($$13, $$0, 1));
                                 afy.c($$4x, $$13);
                              }
