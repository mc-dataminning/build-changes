public class gcm extends gdh {
   private final gdc a;

   gcm(fyz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gdc $$7) {
      ...
      if (!this.o) {
         ...
         if ($$0 != null) {
            ...
            if (this.h > $$1) {
               ...
               this.k = this.k + ($$0.dt().d - this.k) * 0.2;
   ...
   public static class b implements gck<lq> {
      ...
      public gch a(lq $$0, fyz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gch $$8 = new gcm($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
