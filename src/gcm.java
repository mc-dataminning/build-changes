public class gcm extends gab<gzd> {
   public gcm(gem $$0) {
      super($$0);
   }
   ...
   public void a(gzd $$0) {
      ...
      if ($$3 == com.e) {
         ...
         gae.a(this.r, this.s, this.o, $$0.ap == bvz.b);
      } else if ($$3 == com.c) {
         gae.a(this.r, this.s, $$0.c, $$0.F, $$0.ap == bvz.b);
      } else if ($$3 == com.d) {
         this.o.e = 0.5F;
         this.o.f = 0.0F;
         if ($$0.ap == bvz.a) {
   ...
   protected void a(gzd $$0, float $$1) {
      float $$2 = $$0.C;
      if ($$2 > 0.0F && $$0.d == com.a) {
         gae.a(this.r, this.s, $$0.ap, $$2, $$0.p);
      } else {
         super.a($$0, $$1);
      }
   }

   private void b(gzd $$0) {
      if ($$0.ap == bvz.a) {
         this.s.e = -1.8F;
      } else {
         this.r.e = -1.8F;
