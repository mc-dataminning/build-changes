...
public class bge {
   ...
   private bge(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bge a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bge($$0, $$1);
   }

   public bge.d a() throws IOException {
      bge.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bge.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bge.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bge.c $$3 = bge.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bge.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bge.a($$0, $$3);
            }
         }
   ...
   public bge.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bge.c> $$2 = this.a().c();
      ...
      bge.e $$4 = new bge.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bge.c b) implements bge.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bge.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bge.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bge.b> {
      private final List<bge.b> a;

      d(List<bge.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bge.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bge.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bge.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bge.d a() {
         ListIterator<bge.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bge.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bge.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bge.b> b() {
         return this.a.stream();
      }

      public Set<bge.c> c() {
         return this.a.stream().map(bge.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bge.c b) implements bge.b {
