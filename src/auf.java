...
class auf extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof aue && $$1 instanceof aue && $$0.equals($$1);
   }
   ...
   private static aue a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof aue) {
         return (aue)$$0;
      } else {
