...
public class auf extends aue {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, auf.a> s;
   private final aua t;
   private long u;
   private final akj v;

   private auf(akj $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aub.c($$2, 7, $$0.getLength());
      }
   }
