...
public class and {
   static final Dynamic3CommandExceptionType a = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> wz.b("commands.item.target.not_a_container", $$0, $$1, $$2)
   );
   static final Dynamic3CommandExceptionType b = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> wz.b("commands.item.source.not_a_container", $$0, $$1, $$2)
   );
   static final DynamicCommandExceptionType c = new DynamicCommandExceptionType($$0 -> wz.b("commands.item.target.no_such_slot", $$0));
   private static final DynamicCommandExceptionType d = new DynamicCommandExceptionType($$0 -> wz.b("commands.item.source.no_such_slot", $$0));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> wz.b("commands.item.target.no_changes", $$0));
   private static final Dynamic2CommandExceptionType f = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> wz.b("commands.item.target.no_changed.known_item", $$0, $$1)
   );
   ...
   private static int a(et $$0, jd $$1, int $$2, jm<etf> $$3) throws CommandSyntaxException {
      ...
      if ($$2 >= 0 && $$2 < $$4.b()) {
         cuq $$5 = a($$0, $$3, $$4.a($$2));
         $$4.a($$2, $$5);
         $$0.a(() -> wz.a("commands.item.block.set.success", $$1.u(), $$1.v(), $$1.w(), $$5.F()), true);
         return 1;
      } else {
         throw c.create($$2);
      }
   ...
   private static int a(et $$0, Collection<? extends bsr> $$1, int $$2, jm<etf> $$3) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         if ($$4.size() == 1) {
            Entry<bsr, cuq> $$8 = $$4.entrySet().iterator().next();
            $$0.a(() -> wz.a("commands.item.entity.set.success.single", $$8.getKey().S_(), $$8.getValue().F()), true);
         } else {
            $$0.a(() -> wz.a("commands.item.entity.set.success.multiple", $$4.size()), true);
         }
   ...
   private static int a(et $$0, jd $$1, int $$2, cuq $$3) throws CommandSyntaxException {
      bqk $$4 = a($$0, $$1, a);
      if ($$2 >= 0 && $$2 < $$4.b()) {
         $$4.a($$2, $$3);
         $$0.a(() -> wz.a("commands.item.block.set.success", $$1.u(), $$1.v(), $$1.w(), $$3.F()), true);
         return 1;
      } else {
         throw c.create($$2);
      }
   ...
   static bqk a(et $$0, jd $$1, Dynamic3CommandExceptionType $$2) throws CommandSyntaxException {
      dqh $$3 = $$0.e().c_($$1);
      if (!($$3 instanceof bqk)) {
   ...
   private static int a(et $$0, Collection<? extends bsr> $$1, int $$2, cuq $$3) throws CommandSyntaxException {
      List<bsr> $$4 = Lists.newArrayListWithCapacity($$1.size());
      ...
      if ($$4.isEmpty()) {
         ...
         if ($$4.size() == 1) {
            $$0.a(() -> wz.a("commands.item.entity.set.success.single", $$4.iterator().next().S_(), $$3.F()), true);
         } else {
            $$0.a(() -> wz.a("commands.item.entity.set.success.multiple", $$4.size(), $$3.F()), true);
         }
   ...
   private static int a(et $$0, jd $$1, int $$2, Collection<? extends bsr> $$3, int $$4) throws CommandSyntaxException {
   ...
   private static int a(et $$0, bsr $$1, int $$2, jd $$3, int $$4) throws CommandSyntaxException {
   ...
   private static int a(et $$0, bsr $$1, int $$2, Collection<? extends bsr> $$3, int $$4) throws CommandSyntaxException {
      return a($$0, $$3, $$4, a($$1, $$2));
   }
   ...
   private static cuq a(bsr $$0, int $$1) throws CommandSyntaxException {
      bug $$2 = $$0.a_($$1);
      if ($$2 == bug.a) {
         throw d.create($$1);
      } else {
   ...
   private static cuq a(et $$0, jd $$1, int $$2) throws CommandSyntaxException {
      bqk $$3 = a($$0, $$1, b);
      if ($$2 >= 0 && $$2 < $$3.b()) {
         return $$3.a($$2).s();
      } else {
