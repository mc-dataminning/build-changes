...
public class and {
   ...
   private static void a(ex $$0, are $$1, dgw $$2) {
      ...
      if ($$0.f() == $$1) {
         ...
         $$0.a(() -> wp.a("commands.gamemode.success.other", $$1.m_(), $$3), true);
      }
   }

   private static int a(CommandContext<ex> $$0, Collection<are> $$1, dgw $$2) {
      int $$3 = 0;
