...
public class ank {
   ...
   public static void a(CommandDispatcher<ew> $$0) {
      ...
      $$0.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.requires($$0x -> $$0x.c(2))).executes($$0x -> {
         bse $$1x = ((ew)$$0x.getSource()).e().ak();
         ((ew)$$0x.getSource()).a(() -> xl.a("commands.difficulty.query", $$1x.b()), false);
         return $$1x.a();
      }));
   }

   public static int a(ew $$0, bse $$1) throws CommandSyntaxException {
