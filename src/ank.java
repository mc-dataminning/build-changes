...
public class ank {
   ...
   private static void a(ano $$0, amp $$1, dkw $$2) {
      $$0.b(new zy($$2, $$1.z_(), null, null));
      csf $$3 = $$2.f();
      acv.a($$1, $$3);
   }

   private List<dkw> a(alz $$0, csf $$1) {
      int $$2 = aty.d(this.i);
      List<dkw> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : aty.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
