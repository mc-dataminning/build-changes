...
public class ank {
   ...
   private static int a(ew $$0, Collection<? extends awd<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> xv.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> xv.a("commands.banlist.list", $$1.size()), false);

         for (awd<?> $$2 : $$1) {
            $$0.a(() -> xv.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
