...
public class ank implements anh {
   ...
   private final Map<ani, List<Path>> g;

   ank(anc $$0, Set<String> $$1, List<Path> $$2, Map<ani, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(ani $$0, afw $$1, Consumer<Path> $$2) {
   ...
   public void a(ani $$0, String $$1, String $$2, anh.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<afw, aol<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(anh.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      anj.a($$1, $$4, $$3, $$0);
   }
   ...
   public aol<InputStream> a(ani $$0, afw $$1) {
      return (aol<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && anj.a($$5)) {
               return aol.create($$5);
            }
         }
   ...
   public <T> T a(ant<T> $$0) {
      aol<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public aow c() {
      return $$0 -> Optional.ofNullable(this.a(ani.a, $$0)).map($$0x -> new aor(this, $$0x));
   }
}
