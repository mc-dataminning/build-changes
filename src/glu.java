...
public record glu(Map<String, String> c, Set<String> d) {
   public static final glu a = new glu(Map.of(), Set.of());
   public static final Codec<glu> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(glu::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(glu::e)
            )
            .apply($$0, glu::new)
   );

   public static glu.a a() {
      return new glu.a();
   }
   ...
   public glu a(glu $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new glu($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public glu.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public glu.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public glu.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public glu a() {
         return new glu(this.a.build(), this.b.build());
      }
   }
}
