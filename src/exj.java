...
public class exj extends LongLinkedOpenHashSet {
   private final exj.a a;

   public exj(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new exj.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = azo.f(60000000);
      private static final int b = azo.f(60000000);
