...
public class fsp {
   public final fsp.d a;
   public final eyo b;
   public final fsp.a c;
   public final fsp.b d;
   public final fsp.c e;

   public fsp(fsp.d $$0, eyo $$1, fsp.a $$2, fsp.b $$3, fsp.c $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static class a {
      ...
      public Path a() {
         return this.d == null ? this.c.toPath() : gpt.a(this.c.toPath(), this.d);
      }
   }
   ...
   public static record c(@Nullable String a, @Nullable String b, @Nullable String c, @Nullable String d) {
      public boolean a() {
         return !azu.h(this.b) || !azu.h(this.c) || !azu.h(this.d);
      }
   ...
   public static class d {
      ...
      public d(ffs $$0, PropertyMap $$1, PropertyMap $$2, Proxy $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
