...
public class uj extends uc<va> {
   private static final int b = 37;
   public static final vc<uj> a = new vc.b<uj>() {
      public uj a(DataInput $$0, um $$1) throws IOException {
         $$1.b();
      ...
      private static uj d(DataInput $$0, um $$1) throws IOException {
         $$1.b(37L);
         byte $$2 = $$0.readByte();
         int $$3 = $$0.readInt();
         if ($$2 == 0 && $$3 > 0) {
            throw new up("Missing type on ListTag");
         } else {
            $$1.a(4L, (long)$$3);
            vc<?> $$4 = vd.a($$2);
            List<va> $$5 = Lists.newArrayListWithCapacity($$3);
   ...
   public uj e() {
      Iterable<va> $$0 = (Iterable<va>)(vd.a(this.w).d() ? this.c : Iterables.transform(this.c, va::d));
      List<va> $$1 = Lists.newArrayList($$0);
      return new uj($$1, this.w);
   }

   @Override
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof uj && Objects.equals(this.c, ((uj)$$0).c);
   }
   ...
   @Override
   public ux.b a(ux $$0) {
      switch ($$0.a(vd.a(this.w), this.c.size())) {
         case c:
            return ux.b.c;
         case b:
            return $$0.b();
