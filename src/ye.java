...
public class ye implements wz {
   ...
   private ye(String $$0, @Nullable fl.g $$1, boolean $$2, Optional<wy> $$3, ya $$4) {
      this.g = $$0;
      this.c = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public xm a(@Nullable et $$0, @Nullable bsq $$1, int $$2) throws CommandSyntaxException {
      if ($$0 != null && this.c != null) {
         ...
         if (this.e) {
            wy $$4 = (wy)DataFixUtils.orElse(xb.a($$0, this.f, $$1, $$2), xb.c);
            return $$3.flatMap($$3x -> {
               try {
                  xm $$4x = wy.a.a($$3x, $$0.v());
                  return Stream.of(xb.a($$0, $$4x, $$1, $$2));
               } catch (Exception var5x) {
                  d.warn("Failed to parse component: {}", $$3x, var5x);
                  return Stream.of();
               }
            }).reduce(($$1x, $$2x) -> $$1x.b($$4).b($$2x)).orElseGet(wy::i);
         } else {
            return xb.a($$0, this.f, $$1, $$2)
               .map($$1x -> $$3.map(wy::b).reduce(($$1xx, $$2x) -> $$1xx.b($$1x).b($$2x)).orElseGet(wy::i))
               .orElseGet(() -> wy.b($$3.collect(Collectors.joining(", "))));
         }
      } else {
         return wy.i();
      }
