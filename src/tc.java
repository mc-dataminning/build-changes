...
public class tc {
   ...
   protected tc(tc.b $$0, Collection<st> $$1, aqn $$2, tf $$3, tc.c $$4, tc.c $$5) {
      this.c = $$2;
      this.d = $$3;
      this.i = $$0;
      this.l = $$4;
         ...
         $$3.a(new ta() {
            private void a() {
               if ($$3.i()) {
                  ...
                  $$0.forEach($$0xxx -> tc.this.c.a(dag.a($$0xxx), dag.b($$0xxx), false));
                  tc.this.a($$0 + 1);
               }
            }
   ...
   public static class a {
      ...
      private a(Collection<st> $$0, aqn $$1) {
         this.f = $$0;
         this.a = $$1;
      }

      public static tc.a a(Collection<st> $$0, aqn $$1) {
         return new tc.a($$0, $$1);
      }

      public static tc.a b(Collection<sz> $$0, aqn $$1) {
