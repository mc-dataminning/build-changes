...
public class fpy implements hjo {
   private static final long a = 3000L;
   private final flh b;
   private final List<fpy.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fpy.b> e = new ArrayList<>();
   ...
   public void a(fob $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fpy.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hij $$0, hjq $$1, float $$2) {
      if ($$1.a() != null) {
         wo $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fpy.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new fay($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fpy.b($$3, $$2, new fay($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(fay a, long b) {
   }

   static class b {
      private final wo a;
      private final float b;
      private final List<fpy.a> c = new ArrayList<>();

      public b(wo $$0, float $$1, fay $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fpy.a($$2, af.c()));
      }
