...
public class ghe implements ghj.a {
   ...
   private final ffn J;
   private final Map<ja, ghe.a> K = Maps.newHashMap();
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bsd $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dK();
      });
   }

   private void b(fag $$0, gdx $$1, double $$2, double $$3, double $$4) {
      ja $$5 = ja.a($$2, $$3, $$4);
   ...
   private void a(fag $$0, gdx $$1, ghe.a $$2) {
      int $$3 = 0;
   ...
   private void a(fag $$0, gdx $$1, zz.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         ghr.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fag $$0, gdx $$1, zz.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fag $$0, gdx $$1, String $$2, ghe.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      ghj.a(this.J.an(), 8).ifPresent($$0 -> this.M = $$0.cz());
   }
