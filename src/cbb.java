...
public class cbb extends cap {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new els($$0, this.g.dt() + $$5, $$1);
         }
         ...
         if (this.g.f(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               els $$8 = new els(this.g.dr() - this.a.dr(), 0.0, this.g.dx() - this.a.dx()).d();
               els $$9 = new els((double)aun.a(this.a.dC() * (float) (Math.PI / 180.0)), 0.0, (double)(-aun.b(this.a.dC() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  els $$13 = this.a.f(1.0F);
                  ...
                  cfq $$20 = new cfq(this.a.dM(), this.a, $$17, $$18, $$19);
   ...
   public void a(bmk $$0) {
      ...
      int $$9 = aun.a(this.g.dt() + $$8);
      efd $$10 = new efd($$3, $$9, $$4);
