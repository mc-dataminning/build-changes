...
public class fev {
   ...
   private static final ws h = ws.c("chat.deleted_marker").a(n.h, n.u);
   private final fcu i;
   private final awk<String> j = new awk<>(100);
   private final List<fco> k = Lists.newArrayList();
   private final List<fco.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fev.a> o = new ArrayList<>();
   ...
   public void a(feh $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.k()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$8 = axw.f((float)this.f() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = axw.d((float)($$9 - 40) / $$7);
            ...
            if ($$32 > 0L) {
               ...
               $$0.a(-2, 0, $$8 + 4, 9, $$34 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, ws.a("chat.queue", $$32), 0, 1, 16777215 + ($$33 << 24));
               $$0.c().b();
            }
   ...
   private void a(feh $$0, int $$1, int $$2, fcp.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fco.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean k() {
      return this.i.m.m().c() == ckj.c;
   }
   ...
   public void a(ws $$0) {
      this.a($$0, null, this.i.W() ? fcp.b() : fcp.a());
   }

   public void a(ws $$0, @Nullable xe $$1, @Nullable fcp $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(ws $$0, @Nullable fcp $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, fcp::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(ws $$0, @Nullable xe $$1, int $$2, @Nullable fcp $$3, boolean $$4) {
      int $$5 = axw.a((double)this.f() / this.h());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<axi> $$6 = fez.a($$0, $$5, this.i.h);
      boolean $$7 = this.e();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new fco.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private fev.a b(xe $$0) {
      int $$1 = this.i.l.e();
      ListIterator<fco> $$2 = this.k.listIterator();
   ...
   private fco a(fco $$0) {
      return new fco($$0.a(), h, null, fcp.a());
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.e() && !this.i.m.Z && !this.k()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)axw.a((double)this.f() / this.h()) && $$4 < 0.0 && $$4 > (double)axw.a(-9.0 * this.h())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   public xp b(double $$0, double $$1) {
      ...
      if ($$4 >= 0 && $$4 < this.l.size()) {
         fco.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), axw.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public fcp c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fco.a $$1, fcp $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fcp.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.e() && !this.i.m.Z && !this.k()) {
         if (!($$0 < -4.0) && !($$0 > (double)axw.a((double)this.f() / this.h()))) {
            int $$2 = Math.min(this.j(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = axw.a($$1 + (double)this.m);
   ...
   public boolean e() {
      return this.i.y instanceof fjj;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return axw.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return axw.a($$0 * 160.0 + 20.0);
   }
