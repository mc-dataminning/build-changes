...
public class fjk extends hlf {
   ...
   private final fsi G = new fsi(this);
   ...
   public fjk(wp $$0, Consumer<fic> $$1, fhm.d $$2) {
      this($$0, $$1, $$2, null);
   }

   public fjk(wp $$0, Consumer<fic> $$1, fhm.d $$2, @Nullable fid $$3) {
      super($$0);
      this.H = $$1;
      this.J = $$2;
      if ($$3 == null) {
         this.I = new fjk.b(this);
         this.a(new fid(10));
      } else {
         this.I = new fjk.b(this, Lists.newArrayList($$3.a));
         this.a($$3);
      }
   }
   ...
   public void aR_() {
      ...
      this.I = this.G.c(new fjk.b(this, this.I.c()));
      fsm $$0 = this.G.b(fsm.e().a(10));
      $$0.c().b();
      this.L = $$0.a(fou.a(C, $$0x -> this.G()).a(100).a());
      this.K = $$0.a(fou.a(c, $$0x -> this.F()).a(100).a());
      $$0.a(fou.a(wo.e, $$0x -> this.aO_()).a(100).a());
      this.M = $$0.a(fou.a(D, $$0x -> this.H()).a(100).a());
      this.E();
      this.G.a($$1 -> {
   ...
   private void a(final fid $$0) {
      (new Thread("realms-template-fetcher") {
         ...
         public void run() {
            ...
            while ($$0 != null) {
               Either<fid, Exception> $$2 = fjk.this.a($$0, $$1);
               $$0 = fjk.this.m.a(() -> {
                  if ($$2.right().isPresent()) {
                     fjk.a.error("Couldn't fetch templates", (Throwable)$$2.right().get());
                     if (fjk.this.I.b()) {
                        fjk.this.Q = fkb.a(hgb.a("mco.template.select.failure"));
                     }

                     return null;
                  } else {
                     fid $$1x = (fid)$$2.left().get();
                     ...
                     if ($$1x.a.isEmpty()) {
                        if (fjk.this.I.b()) {
                           String $$3 = hgb.a("mco.template.select.none", "%link");
                           fkb.b $$4 = fkb.b.a(hgb.a("mco.template.select.none.linkTitle"), axv.t.toString());
                           fjk.this.Q = fkb.a($$3, $$4);
                        }
   ...
   Either<fid, Exception> a(fid $$0, fgl $$1) {
      try {
   ...
   private void a(fof $$0, int $$1, int $$2, List<fkb.a> $$3) {
   ...
   class a extends fpq.a<fjk.a> {
      ...
      public a(final fic $$0) {
         this.a = $$0;
         if (!$$0.e.isBlank()) {
            this.h = new fpg(15, 15, c, ftj.b(fjk.this, $$0.e), e);
            this.h.a(fqf.a(e));
         }

         if (!$$0.g.isBlank()) {
            this.i = new fpg(15, 15, d, ftj.b(fjk.this, $$0.g), f);
            this.i.a(fqf.a(f));
         }
      }
      ...
      public void a(fof $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         $$0.a(gmj::H, fjz.a(this.a.a, this.a.f), $$3 + 1, $$2 + 1 + 1, 0.0F, 0.0F, 38, 38, 38, 38);
         $$0.a(gmj::H, fjk.b, $$3, $$2 + 1, 40, 40);
         int $$10 = 5;
         int $$11 = fjk.this.p.b(this.a.c);
         if (this.h != null) {
         ...
         int $$12 = $$3 + 45 + 20;
         int $$13 = $$2 + 5;
         $$0.b(fjk.this.p, this.a.b, $$12, $$13, -1);
         $$0.b(fjk.this.p, this.a.c, $$3 + $$4 - $$11 - 5, $$13, 7105644);
         $$0.b(fjk.this.p, this.a.d, $$12, $$13 + 9 + 5, -6250336);
         if (!this.a.h.isBlank()) {
            $$0.b(fjk.this.p, this.a.h, $$12, $$2 + $$5 - 9 / 2 - 5, 5000268);
         }
      }
   ...
   class b extends fpq<fjk.a> {
      public b(final fjk param1) {
         this(var1, Collections.emptyList());
      }

      public b(final Iterable<fic> param1, final Iterable $$0) {
         super(flk.Q(), var1.n, var1.o - 33 - var1.I(), var1.I(), 46);
         this.a = var1;
         $$0.forEach(this::a);
      }
      ...
      public void a(@Nullable fjk.a $$0) {
         super.a($$0);
