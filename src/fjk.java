...
public class fjk extends hle {
   ...
   public void aR_() {
      ...
      fot $$2 = fot.a(wp.c($$1), $$0x -> {
         if (this.D.e == fhl.c.b) {
            this.m.a(fjg.a(this, wp.c("mco.configure.world.close.question.line1"), $$0xx -> this.C.b()));
         } else {
            this.C.b(false);
         }
      }).a(this.n / 2 - 53, g(0), 106, 20).a();
      this.c($$2);
      this.F = new fpc(this.m.h, $$0, g(4), 212, 20, wp.c("mco.configure.world.name"));
      this.F.f(32);
      this.F.a(Objects.requireNonNullElse(this.D.b(), ""));
      this.c(this.F);
      this.E = new fpc(this.m.h, $$0, g(8), 212, 20, wp.c("mco.configure.world.description"));
      this.E.f(32);
      this.E.a(this.D.a());
      this.c(this.E);
      fot $$3 = this.c(fot.a(wp.c("mco.configure.world.buttons.done"), $$0x -> this.g()).a($$0 - 2, g(12), 106, 20).a());
      this.F.b($$1x -> $$3.j = !azw.h($$1x));
      this.c(fot.a(wo.e, $$0x -> this.aO_()).a(this.n / 2 + 2, g(12), 106, 20).a());
   }
