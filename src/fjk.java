...
public abstract class fjk {
   ...
   protected abstract void a(fnr var1, int var2, int var3, boolean var4);
   ...
   public static void a(fnr $$0, List<fjk> $$1, fnz<?> $$2, int $$3, int $$4, int $$5, int $$6) {
      for (fjk $$7 : $$1) {
         if ($$2.a() > $$7.a()) {
            $$7.a($$0, $$3, $$4, $$5, $$6);
         }
   ...
   public static void a(fnz<?> $$0, fpb.a<?> $$1, List<fjk> $$2, int $$3, double $$4, double $$5) {
