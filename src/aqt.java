...
public class aqt {
   ...
   final List<vg> g = Collections.synchronizedList(Lists.newArrayList());

   public aqt(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (aqt.this.e.an()) {
                  $$1.addLast("legacy_query", new aqo(aqt.this.d()));
               }

               vg.a($$1, yq.a, null);
               int $$2 = aqt.this.e.o();
               vg $$3 = (vg)($$2 > 0 ? new vs($$2) : new vg(yq.a));
               aqt.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new aqv(aqt.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     wi $$3 = wi.b("Internal server error");
                     $$1.a(new yx($$3), vp.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<aqt.a.a> d = Lists.newArrayList();
