...
public interface aqf {
   aqf a = new aqf() {
      ...
      @Override
      public void a(Consumer<dcb> $$0) {
      }
   };

   static aqf a(dcb $$0, int $$1) {
      return new aqf.a($$0, $$1);
   }

   static void a(aqf $$0, aqf $$1, Consumer<dcb> $$2, Consumer<dcb> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aqf.a $$4 && $$1 instanceof aqf.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new dcb($$10, $$11));
                     } else {
                        $$3.accept(new dcb($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(dcb b, int c) implements aqf {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(aqf.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return aqf.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
