...
public class aqf implements AutoCloseable {
   ...
   private aqf(URL $$0, aqf.c $$1, URL $$2, aqf.b $$3, URL $$4, aqf.b $$5, String $$6, aqf.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? awc.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static aqf a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = awc.a($$0);
            URI $$2 = new URI(awc.i($$1, "apiServer"));
            String $$3 = awc.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = awc.a($$1, "ruleId", 1);
               String $$5 = awc.a($$1, "serverId", "");
               String $$6 = awc.a($$1, "roomId", "Java:Chat");
               int $$7 = awc.a($$1, "hashesToDrop", -1);
               int $$8 = awc.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = awc.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, aqf.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<apr> a(GameProfile $$0, String $$1, aqf.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(apr.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = awc.a($$4, "response", false);
            if ($$5) {
               return apr.a($$1);
            } else {
               String $$6 = awc.a($$4, "hashed", null);
               if ($$6 == null) {
                  return apr.b($$1);
               } else {
                  JsonArray $$7 = awc.v($$4, "hashes");
                  vw $$8 = this.a($$1, $$7, $$2);
                  return new apr($$1, $$8);
               }
            }
   ...
   private vw a(String $$0, JsonArray $$1, aqf.a $$2) {
      if ($$1.isEmpty()) {
         return vw.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return vw.b;
      } else {
         vw $$3 = new vw($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new aqf.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public aqe a(GameProfile $$0) {
      return new aqf.d($$0);
   }
   ...
   public interface a {
      aqf.a a = ($$0, $$1) -> false;
      aqf.a b = ($$0, $$1) -> $$0.length() == $$1;

      static aqf.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static aqf.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements aqe {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         ble<Runnable> $$1 = ble.a(aqf.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         aqf.this.a(this.c, aqf.this.g, aqf.this.h, this.d);
      }

      @Override
      public void b() {
         aqf.this.a(this.c, aqf.this.i, aqf.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<apr>> a(List<String> $$0) {
         List<CompletableFuture<apr>> $$1 = $$0.stream().map($$0x -> aqf.this.a(this.c, $$0x, aqf.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<apr> a(String $$0) {
         return aqf.this.a(this.c, $$0, aqf.this.l, this.d);
      }
   }
