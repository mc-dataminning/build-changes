...
public class aqf extends aqt {
   public static final aqi<dzw> a = aqi.a("Unloaded level chunk");
   private static final CompletableFuture<aqi<dzw>> e = CompletableFuture.completedFuture(a);
   private final dhb f;
   private volatile CompletableFuture<aqi<dzw>> g = e;
   private volatile CompletableFuture<aqi<dzw>> h = e;
   private volatile CompletableFuture<aqi<dzw>> i = e;
   private int j;
   private int k;
   private int l;
   private boolean m;
   ...
   public aqf(dgg $$0, int $$1, dhb $$2, etl $$3, aqf.a $$4, aqf.b $$5) {
      super($$0);
      this.f = $$2;
      this.q = $$3;
      this.r = $$4;
   ...
   public CompletableFuture<aqi<dzw>> a() {
      return this.h;
   }

   public CompletableFuture<aqi<dzw>> b() {
      return this.i;
   }

   public CompletableFuture<aqi<dzw>> c() {
      return this.g;
   }
   ...
   private void a(List<are> $$0, dgz $$1, ji $$2, dxq $$3) {
      if ($$3.x()) {
         this.a($$0, $$1, $$2);
      }
   }

   private void a(List<are> $$0, dgz $$1, ji $$2) {
      dus $$3 = $$1.c_($$2);
      if ($$3 != null) {
         yw<?> $$4 = $$3.ax_();
         if ($$4 != null) {
   ...
   private void a(aqh $$0, CompletableFuture<aqi<dzw>> $$1, Executor $$2, aqr $$3) {
      this.u.cancel(false);
   ...
   @FunctionalInterface
   public interface a {
      void onLevelChange(dgg var1, IntSupplier var2, int var3, IntConsumer var4);
   }

   public interface b {
      List<are> a(dgg var1, boolean var2);
   }
}
