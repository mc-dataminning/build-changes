...
public class aqf<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aqf.this.get(this.b--);
      }

      @Override
      public void remove() {
         aqf.this.remove(this.b + 1);
      }
   }
}
