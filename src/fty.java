...
public class fty extends ftx {
   ...
   protected void aT_() {
      ...
      this.z = $$0.u();
      this.A = $$0.aZ().m();
      this.c(fol.a(dhe::e).a(dhe.a, dhe.d, dhe.b, dhe.c).a(this.z).a(this.n / 2 - 155, 100, 150, 20, d, ($$0x, $$1x) -> this.z = $$1x));
      this.c(fol.b(this.A).a(this.n / 2 + 5, 100, 150, 20, c, ($$0x, $$1x) -> this.A = $$1x));
      foe $$1 = foe.a(xv.c("lanServer.start"), $$1x -> {
         this.m.a(null);
         xv $$2;
      ...
      this.C = new fon(this.p, this.n / 2 - 75, 160, 150, 20, xv.c("lanServer.port"));
      this.C.b($$1x -> {
         xv $$2 = this.a($$1x);
      ...
      this.c(this.C);
      this.c($$1);
      this.c(foe.a(xu.e, $$0x -> this.aP_()).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   }
