public class fty extends ftb<byi> {
   ...
   public void a(byi $$0, float $$1, float $$2, elk $$3, fnz $$4, int $$5) {
      $$3.a();
      cja $$6 = $$0.j();
      int $$7 = $$6.b() ? 187 : civ.a($$6.d()) + $$6.k();
      this.n.b((long)$$7);
      gba $$8 = this.m.a($$6, $$0.dK(), null, $$0.ah());
      boolean $$9 = $$8.b();
      int $$10 = this.a($$6);
      float $$11 = 0.25F;
      float $$12 = ars.a(((float)$$0.m() + $$2) / 10.0F + $$0.b) * 0.1F + 0.1F;
      float $$13 = $$8.f().a(cix.h).d.y();
      ...
      for (int $$21 = 0; $$21 < $$10; $$21++) {
         ...
         this.m.a($$6, cix.h, false, $$3, $$4, $$5, fyq.d, $$8);
         $$3.b();
         if (!$$9) {
