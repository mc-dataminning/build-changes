...
public class fty extends fqs {
   private static final int a = 20;
   private static final int b = 5;
   private static final int c = 20;
   private final xh d;
   private final List<xh> s;
   private final ImmutableList<fty.a> u;
   private fls v = fls.a;
   private int w;
   private int x;

   protected fty(xh $$0, List<xh> $$1, ImmutableList<fty.a> $$2) {
      super($$0);
      this.s = $$1;
      this.d = xg.a($$0, xk.a($$1, xg.a));
      this.u = $$2;
   }
   ...
   public void aS_() {
      ...
      while ($$1.hasNext()) {
         fty.a $$0 = (fty.a)$$1.next();
         this.x = Math.max(this.x, 20 + this.p.a($$0.a) + 20);
      }

      int $$1x = 5 + this.x + 5;
      int $$2 = $$1x * this.u.size();
      this.v = fls.a(this.p, $$2, this.s.toArray(new xh[0]));
      int $$3 = this.v.a() * 9;
      ...
      for (UnmodifiableIterator var6 = this.u.iterator(); var6.hasNext(); $$5 += $$1x) {
         fty.a $$6 = (fty.a)var6.next();
         this.c(fkz.a($$6.a, $$6.b).a($$5, $$4, this.x, 20).a());
      }
   }
