...
public class fty extends ftw {
   ...
   public fty(boolean $$0) {
      this($$0, null);
   }

   public fty(boolean $$0, @Nullable fov $$1) {
      super(b);
      this.y = $$0;
      this.A = Objects.requireNonNullElseGet($$1, () -> new fov(false));
   }
   ...
   public static CompletableFuture<Void> a(hbk $$0, Executor $$1) {
      return CompletableFuture.allOf($$0.a(fov.a, $$1), $$0.a(fov.c, $$1), $$0.a(glm.a, $$1), e.a($$0, $$1));
   }
   ...
   protected void aT_() {
      ...
      $$3 = this.a($$3, 24);
      fpj $$4 = this.c(foh.a(20, $$0x -> this.m.a(new fww(this, this.m.n, this.m.ah())), true));
      int var10001 = this.n / 2 - 124;
      $$3 += 36;
      $$4.c(var10001, $$3);
      this.c(fod.a(xv.c("menu.options"), $$0x -> this.m.a(new fwz(this, this.m.n))).a(this.n / 2 - 100, $$3, 98, 20).a());
      this.c(fod.a(xv.c("menu.quit"), $$0x -> this.m.q()).a(this.n / 2 + 2, $$3, 98, 20).a());
      fpj $$5 = this.c(foh.b(20, $$0x -> this.m.a(new fwt(this, this.m.n)), true));
      $$5.c(this.n / 2 + 104, $$3);
      this.c(new fpc($$1, this.o - 10, $$0, 10, c, $$0x -> this.m.a(new fsy(this)), this.p));
      if (this.w == null) {
         this.w = new fjy();
      }
   ...
   private int a(int $$0, int $$1) {
      if (ab.aU) {
         this.c(fod.a(xv.b("Create Test World"), $$0x -> fyv.b(this.m, this)).a(this.n / 2 - 100, $$0 += $$1, 200, 20).a());
      }
   ...
   private int b(int $$0, int $$1) {
      this.c(fod.a(xv.c("menu.singleplayer"), $$0x -> this.m.a(new fzd(this))).a(this.n / 2 - 100, $$0, 200, 20).a());
      xv $$2 = this.E();
      boolean $$3 = $$2 == null;
      fpp $$4 = $$2 != null ? fpp.a($$2) : null;
      int var6;
      this.c(fod.a(xv.c("menu.multiplayer"), $$0x -> {
         ftw $$1x = (ftw)(this.m.n.u ? new fwm(this) : new fwn(this));
         this.m.a($$1x);
      }).a(this.n / 2 - 100, var6 = $$0 + $$1, 200, 20).a($$4).a()).j = $$3;
      this.c(fod.a(xv.c("menu.online"), $$0x -> this.m.a(new fhb(this))).a(this.n / 2 - 100, $$0 = var6 + $$1, 200, 20).a($$4).a()).j = $$3;
      return $$0;
   }
   ...
   private int c(int $$0, int $$1) {
      boolean $$2 = this.F();
      this.c(fod.a(xv.c("menu.playdemo"), $$1x -> {
         if ($$2) {
