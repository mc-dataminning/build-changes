...
public class fty extends fuk {
   ...
   private long c = -1L;
   private boolean d;
   private static final Object2IntMap<dzs> s = af.a(new Object2IntOpenHashMap(), $$0 -> {
      $$0.defaultReturnValue(0);
      $$0.put(dzs.c, 5526612);
      $$0.put(dzs.d, 10066329);
      $$0.put(dzs.e, 6250897);
      $$0.put(dzs.f, 8434258);
      $$0.put(dzs.g, 13750737);
      $$0.put(dzs.h, 7497737);
      $$0.put(dzs.i, 3159410);
      $$0.put(dzs.j, 2213376);
      $$0.put(dzs.k, 13421772);
      $$0.put(dzs.l, 16769184);
      $$0.put(dzs.m, 15884384);
      $$0.put(dzs.n, 16777215);
   });
   ...
   protected void b(fsp $$0) {
      if (this.d) {
         $$0.a(fso.a, wp.c("narrator.loading.done"));
      } else {
         $$0.a(fso.a, this.m());
      }
   }
   ...
   public static void a(fod $$0, arr $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$4 + $$5;
      int $$7 = $$1.d();
      int $$8 = $$7 * $$6 - $$5;
      int $$9 = $$1.e();
