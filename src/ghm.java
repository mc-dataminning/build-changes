...
public class ghm implements gha.a {
   private final fff a;
   private double b = Double.MIN_VALUE;
   private List<bsu> c = Collections.emptyList();
   ...
   private void a(ezy $$0, gdo $$1, double $$2, double $$3, double $$4, bsu $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aE.ifPresent($$10 -> {
   ...
   private void a(iz $$0, ezy $$1, double $$2, double $$3, double $$4, gdo $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      gdm.a($$1, $$5.getBuffer(gdw.y()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      gdm.a(
         $$1,
         $$5.getBuffer(gdw.y()),
         this.a.r.a_($$0).b(this.a.r, $$0, evw.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
