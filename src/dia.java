...
public final class dia {
   ...
   private final akt<dhk>[][] C = new akt[][]{{dhr.Y, dhr.W, dhr.U, dhr.S, dhr.Q}, {dhr.X, dhr.V, dhr.T, dhr.R, dhr.Q}};
   private final akt<dhk>[][] D = new akt[][]{
   ...
   private final akt<dhk>[][] E = new akt[][]{
   ...
   private final akt<dhk>[][] F = new akt[][]{
   ...
   private final akt<dhk>[][] G = new akt[][]{
   ...
   private final akt<dhk>[][] H = new akt[][]{
   ...
   protected void a(Consumer<Pair<dht.d, akt<dhk>>> $$0) {
      if (ab.ar) {
         this.b($$0);
      } else {
         this.c($$0);
   ...
   private void b(Consumer<Pair<dht.d, akt<dhk>>> $$0) {
      jt.a $$1 = or.a();
      js<ecl> $$2 = $$1.d(mc.aM);
   ...
   private void c(Consumer<Pair<dht.d, akt<dhk>>> $$0) {
   ...
   private void d(Consumer<Pair<dht.d, akt<dhk>>> $$0) {
   ...
   private void a(Consumer<Pair<dht.d, akt<dhk>>> $$0, dht.b $$1) {
      for (int $$2 = 0; $$2 < this.p.length; $$2++) {
         dht.b $$3 = this.p[$$2];

         for (int $$4 = 0; $$4 < this.q.length; $$4++) {
            dht.b $$5 = this.q[$$4];
            akt<dhk> $$6 = this.a($$2, $$4, $$1);
            akt<dhk> $$7 = this.b($$2, $$4, $$1);
            akt<dhk> $$8 = this.c($$2, $$4, $$1);
            akt<dhk> $$9 = this.e($$2, $$4, $$1);
            akt<dhk> $$10 = this.h($$2, $$4, $$1);
            akt<dhk> $$11 = this.a($$2, $$4, $$1, $$10);
            akt<dhk> $$12 = this.f($$2, $$4, $$1);
   ...
   private void b(Consumer<Pair<dht.d, akt<dhk>>> $$0, dht.b $$1) {
      for (int $$2 = 0; $$2 < this.p.length; $$2++) {
         dht.b $$3 = this.p[$$2];
         ...
         for (int $$4 = 0; $$4 < this.q.length; $$4++) {
            ...
            akt<dhk> $$9 = this.e($$2, $$4, $$1);
            akt<dhk> $$10 = this.h($$2, $$4, $$1);
            akt<dhk> $$11 = this.a($$2, $$4, $$1, $$6);
            akt<dhk> $$12 = this.g($$2, $$4, $$1);
            akt<dhk> $$13 = this.f($$2, $$4, $$1);
   ...
   private void c(Consumer<Pair<dht.d, akt<dhk>>> $$0, dht.b $$1) {
      ...
      for (int $$2 = 0; $$2 < this.p.length; $$2++) {
         ...
         for (int $$4 = 0; $$4 < this.q.length; $$4++) {
            ...
            akt<dhk> $$7 = this.b($$2, $$4, $$1);
            akt<dhk> $$8 = this.c($$2, $$4, $$1);
            akt<dhk> $$9 = this.h($$2, $$4, $$1);
            akt<dhk> $$10 = this.e($$2, $$4, $$1);
            akt<dhk> $$11 = this.a($$2, $$4);
            akt<dhk> $$12 = this.a($$2, $$4, $$1, $$6);
            akt<dhk> $$13 = this.d($$2, $$4, $$1);
            akt<dhk> $$14 = this.g($$2, $$4, $$1);
   ...
   private void d(Consumer<Pair<dht.d, akt<dhk>>> $$0, dht.b $$1) {
      this.a($$0, this.o, this.o, this.x, dht.b.a(this.r[0], this.r[2]), $$1, 0.0F, dhr.P);
      this.a($$0, dht.b.a(this.p[1], this.p[2]), this.o, dht.b.a(this.z, this.B), this.r[6], $$1, 0.0F, dhr.g);
      this.a($$0, dht.b.a(this.p[3], this.p[4]), this.o, dht.b.a(this.z, this.B), this.r[6], $$1, 0.0F, dhr.h);
      ...
      for (int $$2 = 0; $$2 < this.p.length; $$2++) {
         ...
         for (int $$4 = 0; $$4 < this.q.length; $$4++) {
            ...
            akt<dhk> $$7 = this.b($$2, $$4, $$1);
            akt<dhk> $$8 = this.c($$2, $$4, $$1);
            akt<dhk> $$9 = this.a($$2, $$4);
            akt<dhk> $$10 = this.a($$2, $$4, $$1, $$6);
            akt<dhk> $$11 = this.d($$2, $$4, $$1);
   ...
   private void e(Consumer<Pair<dht.d, akt<dhk>>> $$0, dht.b $$1) {
   ...
   private akt<dhk> a(int $$0, int $$1, dht.b $$2) {
      if ($$2.b() < 0L) {
         return this.D[$$0][$$1];
      } else {
         akt<dhk> $$3 = this.E[$$0][$$1];
         return $$3 == null ? this.D[$$0][$$1] : $$3;
      }
   }

   private akt<dhk> b(int $$0, int $$1, dht.b $$2) {
      return $$0 == 4 ? this.a($$1, $$2) : this.a($$0, $$1, $$2);
   }

   private akt<dhk> c(int $$0, int $$1, dht.b $$2) {
      return $$0 == 0 ? this.g($$0, $$1, $$2) : this.b($$0, $$1, $$2);
   }

   private akt<dhk> a(int $$0, int $$1, dht.b $$2, akt<dhk> $$3) {
      return $$0 > 1 && $$1 < 4 && $$2.b() >= 0L ? dhr.x : $$3;
   }

   private akt<dhk> d(int $$0, int $$1, dht.b $$2) {
      akt<dhk> $$3 = $$2.b() >= 0L ? this.a($$0, $$1, $$2) : this.a($$0, $$1);
      return this.a($$0, $$1, $$2, $$3);
   }

   private akt<dhk> a(int $$0, int $$1) {
      if ($$0 == 0) {
         return dhr.O;
      } else {
   ...
   private akt<dhk> a(int $$0, dht.b $$1) {
      if ($$0 < 2) {
   ...
   private akt<dhk> e(int $$0, int $$1, dht.b $$2) {
      if ($$2.b() >= 0L) {
         akt<dhk> $$3 = this.G[$$0][$$1];
         if ($$3 != null) {
            return $$3;
         }
      }
   ...
   private akt<dhk> f(int $$0, int $$1, dht.b $$2) {
      if ($$0 <= 2) {
   ...
   private akt<dhk> g(int $$0, int $$1, dht.b $$2) {
      if ($$0 >= 3) {
         return this.e($$0, $$1, $$2);
      } else {
   ...
   private akt<dhk> h(int $$0, int $$1, dht.b $$2) {
      akt<dhk> $$3 = this.H[$$0][$$1];
      return $$3 == null ? this.a($$0, $$1, $$2) : $$3;
   }

   private void a(Consumer<Pair<dht.d, akt<dhk>>> $$0, dht.b $$1, dht.b $$2, dht.b $$3, dht.b $$4, dht.b $$5, float $$6, akt<dhk> $$7) {
      $$0.accept(Pair.of(dht.a($$1, $$2, $$3, $$4, dht.b.a(0.0F), $$5, $$6), $$7));
      $$0.accept(Pair.of(dht.a($$1, $$2, $$3, $$4, dht.b.a(1.0F), $$5, $$6), $$7));
   }

   private void b(Consumer<Pair<dht.d, akt<dhk>>> $$0, dht.b $$1, dht.b $$2, dht.b $$3, dht.b $$4, dht.b $$5, float $$6, akt<dhk> $$7) {
      $$0.accept(Pair.of(dht.a($$1, $$2, $$3, $$4, dht.b.a(0.2F, 0.9F), $$5, $$6), $$7));
   }

   private void c(Consumer<Pair<dht.d, akt<dhk>>> $$0, dht.b $$1, dht.b $$2, dht.b $$3, dht.b $$4, dht.b $$5, float $$6, akt<dhk> $$7) {
