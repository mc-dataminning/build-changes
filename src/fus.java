...
public class fus extends fun<bvg, fgc<bvg>> {
   private static final Map<bvg.a, aew> a = ac.a(Maps.newEnumMap(bvg.a.class), $$0 -> {
      $$0.put(bvg.a.a, new aew("textures/entity/panda/panda.png"));
      $$0.put(bvg.a.b, new aew("textures/entity/panda/lazy_panda.png"));
      $$0.put(bvg.a.c, new aew("textures/entity/panda/worried_panda.png"));
      $$0.put(bvg.a.d, new aew("textures/entity/panda/playful_panda.png"));
      $$0.put(bvg.a.e, new aew("textures/entity/panda/brown_panda.png"));
      $$0.put(bvg.a.f, new aew("textures/entity/panda/weak_panda.png"));
      $$0.put(bvg.a.g, new aew("textures/entity/panda/aggressive_panda.png"));
   });

   public fus(fth.a $$0) {
      super($$0, new fgc<>($$0.a(fib.az)), 0.9F);
      this.a(new fxl(this, $$0.d()));
   }

   public aew a(bvg $$0) {
      return a.getOrDefault($$0.gp(), a.get(bvg.a.a));
   }

   protected void a(bvg $$0, elp $$1, float $$2, float $$3, float $$4) {
      super.a($$0, $$1, $$2, $$3, $$4);
      if ($$0.bU > 0) {
         int $$5 = $$0.bU;
         int $$6 = $$5 + 1;
         float $$7 = 7.0F;
         float $$8 = $$0.m_() ? 0.3F : 0.8F;
         if ($$5 < 8) {
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(arw.i($$24, $$0.dD(), $$0.dD() + 90.0F)));
      ...
      float $$26 = $$0.F($$4);
      if ($$26 > 0.0F) {
         float $$27 = $$0.m_() ? 0.5F : 1.3F;
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(arw.i($$26, $$0.dD(), $$0.dD() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? arw.i($$3, $$0, $$1) : $$0;
   }
}
