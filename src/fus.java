...
public class fus extends fui implements gfr.a {
   ...
   private final fse I = new fse(this);
   @Nullable
   private final fui J;
   private final gfr K;
   private final Map<ai, fuo> L = Maps.newLinkedHashMap();
   @Nullable
   private fuo M;
   private boolean N;
   ...
   public fus(gfr $$0, @Nullable fui $$1) {
      super(H);
      this.K = $$0;
      this.J = $$1;
   }
   ...
   protected void aR_() {
      ...
      if (this.M == null && !this.L.isEmpty()) {
         fuo $$0 = this.L.values().iterator().next();
         this.K.a($$0.c().b(), true);
      } else {
         this.K.a(this.M == null ? null : this.M.c().b(), true);
      }

      this.I.b(fop.a(wn.d, $$0x -> this.aO_()).a(200).a());
      this.I.a($$1 -> {
   ...
   public void a(fob $$0, int $$1, int $$2) {
      $$0.a(gmf::H, x, $$1, $$2, 0.0F, 0.0F, 252, 140, 256, 256);
      if (this.L.size() > 1) {
         for (fuo $$3 : this.L.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.M);
         }

         for (fuo $$4 : this.L.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fob $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.M != null) {
         $$0.c().a();
   ...
   @Override
   public void a(aj $$0) {
      fuo $$1 = fuo.a(this.m, this, this.L.size(), $$0);
      if ($$1 != null) {
         this.L.put($$0.b(), $$1);
      }
   }
