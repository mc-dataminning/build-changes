...
public class fus<T extends cfc> extends ftl<T> {
   public final fxq a;
   private final fxq b;
   private final fxq f;
   private final fxq g;
   ...
   public static fxw c() {
      fxy $$0 = new fxy();
      fxz $$1 = $$0.a();
      fxz $$2 = $$1.a("head", fxv.c().a(1, 5).a(-3.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F), fxs.a(-1.0F, 16.5F, -3.0F));
      $$2.a("right_ear", fxv.c().a(8, 1).a(-3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fxs.a);
      $$2.a("left_ear", fxv.c().a(15, 1).a(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fxs.a);
      $$2.a("nose", fxv.c().a(6, 18).a(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), fxs.a);
      fxz $$3 = $$1.a("body", fxv.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), fxs.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fxu $$4 = new fxu(0.001F);
      fxv $$5 = fxv.c().a(4, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      fxv $$6 = fxv.c().a(13, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      $$1.a("right_hind_leg", $$6, fxs.a(-5.0F, 17.5F, 7.0F));
      $$1.a("left_hind_leg", $$5, fxs.a(-1.0F, 17.5F, 7.0F));
      $$1.a("right_front_leg", $$6, fxs.a(-5.0F, 17.5F, 0.0F));
      $$1.a("left_front_leg", $$5, fxs.a(-1.0F, 17.5F, 0.0F));
      $$3.a("tail", fxv.c().a(30, 0).a(2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 5.0F), fxs.a(-4.0F, 15.0F, -1.0F, -0.05235988F, 0.0F, 0.0F));
      return fxw.a($$0, 48, 32);
   }
