...
public class fus {
   private static final aku a = aku.b("advancements/title_box");
   ...
   @Nullable
   private fus x;
   private final List<fus> y = Lists.newArrayList();
   @Nullable
   private ak z;
   private final int A;
   private final int B;

   public fus(fuq $$0, flj $$1, aj $$2, au $$3) {
      this.q = $$0;
      this.r = $$2;
      this.s = $$3;
      this.w = $$1;
      ...
      int $$5 = this.e();
      int $$6 = 29 + $$4 + $$5;
      this.v = tl.a().a(this.a(wr.a($$3.b().f(), xl.a.a($$3.e().a())), $$6));
   ...
   private int e() {
      ...
      if ($$0 <= 1) {
         ...
         int $$1 = 8;
         wo $$2 = wo.a("advancements.progress", $$0, $$0);
         return this.w.h.a($$2) + 8;
      }
   }

   private static float a(flt $$0, List<wt> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<wt> a(wo $$0, int $$1) {
      flt $$2 = this.w.h.b();
      List<wt> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : p) {
         List<wt> $$6 = $$2.b($$0, $$1 - $$5, xl.a);
   ...
   public void a(fod $$0, int $$1, int $$2, boolean $$3) {
      if (this.x != null) {
         int $$4 = $$1 + this.x.A + 13;
   ...
   public void a(fod $$0, int $$1, int $$2) {
      if (!this.s.j() || this.z != null && this.z.a()) {
         ...
         $$0.a(gmh::H, $$4.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
   ...
   public void a(fod $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      fob $$6 = this.w.h;
      ...
      wo $$13 = this.z == null ? null : this.z.d();
      ...
      if (!this.v.isEmpty()) {
         if ($$15) {
            $$0.a(gmh::H, a, $$31, $$9 - $$33, this.u, $$33);
         } else {
            $$0.a(gmh::H, a, $$31, $$8, this.u, $$33);
         }
      }

      if ($$18 != $$19) {
         $$0.a(gmh::H, $$18.a(), 200, $$7, 0, 0, $$31, $$8, $$17, $$7);
         $$0.a(gmh::H, $$19.a(), 200, $$7, 200 - $$30, 0, $$31 + $$17, $$8, $$30, $$7);
      } else {
         $$0.a(gmh::H, $$18.a(), $$31, $$8, this.u, $$7);
      }

      $$0.a(gmh::H, $$20.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
      int $$34 = $$31 + 5;
      if ($$12) {
   ...
   private void a(fod $$0, List<ayl> $$1, int $$2, int $$3, int $$4) {
      fob $$5 = this.w.h;
