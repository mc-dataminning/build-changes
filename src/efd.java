...
public class efd extends efh {
   public static final MapCodec<efd> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, efd::new));

   public efd(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<edp.a> a(dbf $$0, BiConsumer<io, drd> $$1, aym $$2, int $$3, io $$4, ecz $$5) {
      ...
      if ($$13.isPresent()) {
         $$6.add(new edp.a(new io($$11, $$13.getAsInt(), $$12), 1, false));
      }
      ...
      if ($$16 != $$7) {
         ...
         if ($$13.isPresent()) {
            $$6.add(new edp.a(new io($$11, $$13.getAsInt(), $$12), 0, false));
         }
      }
