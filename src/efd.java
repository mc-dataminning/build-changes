...
public class efd {
   private static final dym a = dkw.hG.m();
   private static final dym b = dkw.hH.m();
   private static final dym c = dkw.iY.m();
   private static final dym d = dkw.hK.m();
   private static final dym e = dkw.hS.m();
   private static final dym f = dkw.hU.m();
   private static final dym g = dkw.hO.m();
   private static final dym h = dkw.ja.m();
   private static final dym i = dkw.ec.m();
   private final dym j;
   private final int k;
   private final dym[] l;
   private final etw m;
   ...
   public efd(eez $$0, dym $$1, int $$2, eey $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(eeu.P);
      this.l = a($$3.a(ald.b("clay_bands")));
      this.u = $$0.a(eeu.N);
      this.v = $$0.a(eeu.O);
      this.n = $$0.a(eeu.Q);
      this.o = $$0.a(eeu.R);
   ...
   public void a(eez $$0, diu $$1, kf<dis> $$2, boolean $$3, efi $$4, final eaj $$5, eep $$6, efc.o $$7) {
      final jj.a $$8 = new jj.a();
      final dgw $$9 = $$5.f();
      int $$10 = $$9.d();
      int $$11 = $$9.e();
      eag $$12 = new eag() {
      ...
      efc.g $$13 = new efc.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      efc.u $$14 = $$7.apply($$13);
      jj.a $$15 = new jj.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(eel.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            js<dis> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(diz.C)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(eel.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dym> a(efc.o $$0, egm $$1, Function<jj, js<dis>> $$2, eaj $$3, eep $$4, jj $$5, boolean $$6) {
      efc.g $$7 = new efc.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().f(me.aM), $$1);
      efc.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dym $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(eag $$0, int $$1, int $$2, int $$3, dhr $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dis $$1, eag $$2, jj.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).l() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dkw.J) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(azs $$0, dym[] $$1, int $$2, dym $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dym a(int $$0, int $$1, int $$2) {
