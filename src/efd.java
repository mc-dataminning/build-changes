...
public abstract class efd {
   public static efd.b a(int $$0, int $$1) {
      return new efd.b($$0 - 1, $$1 + 1);
   }

   public static efd.b b(int $$0, int $$1) {
      return new efd.b($$0, $$1);
   }

   public static efd a(int $$0) {
      return new efd.c($$0, false);
   }

   public static efd b(int $$0) {
      return new efd.c($$0 + 1, false);
   }

   public static efd c(int $$0) {
      return new efd.c($$0, true);
   }

   public static efd d(int $$0) {
      return new efd.c($$0 - 1, true);
   }
   ...
   public static efd a(OptionalInt $$0, OptionalInt $$1) {
   ...
   public efd a(OptionalInt $$0) {
      return a($$0, this.b());
   }

   public efd b(OptionalInt $$0) {
      return a(this.c(), $$0);
   }

   public static Optional<efd> a(div $$0, iu $$1, int $$2, Predicate<dzo> $$3, Predicate<dzo> $$4) {
      iu.a $$5 = $$1.k();
      if (!$$0.a($$1, $$3)) {
   ...
   private static OptionalInt a(div $$0, int $$1, Predicate<dzo> $$2, Predicate<dzo> $$3, iu.a $$4, int $$5, ja $$6) {
      $$4.q($$5);
   ...
   public static final class a extends efd {
      static final efd.a a = new efd.a();
