...
public class bve extends buy implements bjx, bke<bve.a> {
   private static final aee<String> bT = aeh.a(bve.class, aeg.e);
   ...
   public static boolean c(biu<bve> $$0, cpw $$1, bjk $$2, gw $$3, asc $$4) {
      return $$1.a_($$3.d()).a(aps.bS) && a($$1, $$3);
   }
   ...
   public bgy b(cbu $$0, bgx $$1) {
      ...
      if ($$2.a(cji.oC) && !this.m_()) {
         ...
         return bgy.a(this.dL().B);
      } else if (this.t() == bve.a.b && $$2.a(aqa.O)) {
         if (this.bX != null) {
            for (int $$9 = 0; $$9 < 2; $$9++) {
   ...
   @Override
   public void a(ape $$0) {
      this.dL().a(null, this, apd.nn, $$0, 1.0F, 1.0F);
      if (!this.dL().w_()) {
         buy $$1 = biu.t.a(this.dL());
         if ($$1 != null) {
            ((akq)this.dL()).a(iv.x, this.dq(), this.e(0.5), this.dw(), 1, 0.0, 0.0, 0.0, 0.0);
            this.ak();
