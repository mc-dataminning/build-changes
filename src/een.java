...
public class een {
   ...
   private final Map<String, eec> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public een(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends eec> T a(eec.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends eec> T b(eec.a $$0, String $$1) {
      eec $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends eec> T a(Function<sd, T> $$0, auw $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
            sd $$4 = this.a($$2, $$1, aa.b().d().c());
   ...
   public sd a(String $$0, auw $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
