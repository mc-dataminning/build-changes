...
public class gdc implements ezh, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final ezf c = new ezf();
   ...
   private final List<ezn> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, ezn> l = Maps.newHashMap();
   private final int m;
   ...
   public gdc(aur $$0, String $$1) throws IOException {
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         JsonArray $$13 = ayn.a($$5, "attributes", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         JsonArray $$18 = ayn.a($$5, "uniforms", null);
         if ($$18 != null) {
            int $$19 = 0;
         ...
         this.p = a(ayn.a($$5, "blend", null));
         this.s = a($$0, ezk.a.a, $$6);
         this.t = a($$0, ezk.a.b, $$7);
         this.m = ezl.a();
         ezl.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = ezn.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static ezi a(aur $$0, ezk.a $$1, String $$2) throws IOException {
      ezk $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof ezi)) {
   ...
   public static ezg a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new ezg();
      } else {
         int $$1 = 32774;
