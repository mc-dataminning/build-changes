...
public class gdc {
   ...
   private gdc(int $$0, List<gde> $$1) {
      this.a = $$1.toArray(gde[]::new);
      this.b = $$1.size();
   }

   private List<gde> c() {
      List<gde> $$0 = new ArrayList<>(this.d());
