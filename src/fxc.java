...
public class fxc<T extends bsr> extends fvr<T> {
   private static final int a = 7;
   private final fyi b;
   private final fyi[] f = new fyi[7];
   private final fyi[] g = new fyi[3];
   ...
   public static fyo b() {
      ...
      for (int $$4 = 0; $$4 < 7; $$4++) {
         $$1.a(
            b($$4),
            fyn.c().a(i[$$4][0], i[$$4][1]).a((float)h[$$4][0] * -0.5F, 0.0F, (float)h[$$4][2] * -0.5F, (float)h[$$4][0], (float)h[$$4][1], (float)h[$$4][2]),
            fyk.a(0.0F, (float)(24 - h[$$4][1]), $$3)
         );
         $$2[$$4] = $$3;
         if ($$4 < 6) {
      ...
      $$1.a(a(0), fyn.c().a(20, 0).a(-5.0F, 0.0F, (float)h[2][2] * -0.5F, 10.0F, 8.0F, (float)h[2][2]), fyk.a(0.0F, 16.0F, $$2[2]));
      $$1.a(a(1), fyn.c().a(20, 11).a(-3.0F, 0.0F, (float)h[4][2] * -0.5F, 6.0F, 4.0F, (float)h[4][2]), fyk.a(0.0F, 20.0F, $$2[4]));
      $$1.a(a(2), fyn.c().a(20, 18).a(-3.0F, 0.0F, (float)h[4][2] * -0.5F, 6.0F, 5.0F, (float)h[1][2]), fyk.a(0.0F, 19.0F, $$2[1]));
