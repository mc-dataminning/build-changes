public abstract class ccd extends cco {
   public double b;
   public double c;
   public double d;

   protected ccd(biw<? extends ccd> $$0, cpx $$1) {
      super($$0, $$1);
   }

   public ccd(biw<? extends ccd> $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, cpx $$7) {
      this($$0, $$7);
   ...
   public ccd(biw<? extends ccd> $$0, bji $$1, double $$2, double $$3, double $$4, cpx $$5) {
   ...
   public vf<wy> di() {
      bis $$0 = this.v();
      int $$1 = $$0 == null ? 0 : $$0.ah();
      return new wz(this.ah(), this.cv(), this.dq(), this.ds(), this.dw(), this.dD(), this.dB(), this.ag(), $$1, new ehp(this.b, this.c, this.d), 0.0);
   }
