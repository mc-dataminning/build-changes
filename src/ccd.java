...
public class ccd extends ccc {
   ...
   private static final aja<Byte> bW = aje.a(ccd.class, ajc.a);
   private static final int bX = 1;
   private static final cbj bY = cbj.b().a(4.0);
   public final bpv d = new bpv();
   public final bpv e = new bpv();
   @Nullable
   private id bZ;

   public ccd(bqg<? extends ccd> $$0, czg $$1) {
      super($$0, $$1);
      if (!$$1.B) {
         this.w(true);
      }
   ...
   @Override
   public aun v() {
      return this.u() && this.ag.a(4) != 0 ? null : auo.bF;
   }
   ...
   public void l() {
      ...
      if (this.u()) {
         this.g(esj.b);
         this.p(this.dr(), (double)axm.a(this.dt()) + 1.0 - (double)this.dh(), this.dx());
      } else {
   ...
   protected void Y() {
      ...
      if (this.u()) {
         ...
         esj $$6 = this.dp();
         esj $$7 = $$6.b((Math.signum($$3) * 0.5 - $$6.c) * 0.1F, (Math.signum($$4) * 0.7F - $$6.d) * 0.1F, (Math.signum($$5) * 0.5 - $$6.e) * 0.1F);
         this.g($$7);
         float $$8 = (float)(axm.d($$7.e, $$7.c) * 180.0F / (float)Math.PI) - 90.0F;
         float $$9 = axm.g($$8 - this.dC());
         this.bp = 0.5F;
         this.r(this.dC() + $$9);
   ...
   public static boolean b(bqg<ccd> $$0, czh $$1, bqx $$2, id $$3, axt $$4) {
      if ($$3.v() >= $$1.z_()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
