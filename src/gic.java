...
public class gic {
   public static class a implements giv<lw> {
      ...
      public gis a(lw $$0, gfk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gic.b $$8 = new gic.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gjs {
      b(gfk $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gje {
      ...
      c(gfk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, giu $$7, gjn $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gic.c $$0 = new gic.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements giv<lw> {
      ...
      public gis a(lw $$0, gfk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gic.c $$8 = new gic.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fmg.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends giq {
      ...
      private int D;
      private final giu E;
      private final List<dae> F;
      private boolean G;

      public e(gfk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, giu $$7, List<dae> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gis $$12 = this.E.a(ls.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gic.c $$10 = (gic.c)this.E.a(ls.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
