...
public class fti implements AutoCloseable {
   ...
   private final List<ftj> e = Lists.newArrayList();
   private final Map<String, eol> f = Maps.newHashMap();
   private final List<eol> g = Lists.newArrayList();
   private Matrix4f h;
   private int i;
   private int j;
   private float k;
   ...
   public fti(gem $$0, aqh $$1, eol $$2, ahg $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(gem $$0, ahg $$1) throws IOException, JsonSyntaxException {
   ...
   private void a(gem $$0, JsonElement $$1) throws IOException {
   ...
   private void b(JsonElement $$0) throws ahj {
      ...
      String $$2 = aud.i($$1, "name");
      epq $$3 = this.e.get(this.e.size() - 1).b().a($$2);
      if ($$3 == null) {
   ...
   public eol a(String $$0) {
      return this.f.get($$0);
   }

   public void a(String $$0, int $$1, int $$2) {
      eol $$3 = new eom($$1, $$2, true, evg.a);
   ...
   public ftj a(String $$0, eol $$1, eol $$2) throws IOException {
      ftj $$3 = new ftj(this.c, $$0, $$1, $$2);
   ...
   @Nullable
   private eol b(@Nullable String $$0) {
      if ($$0 == null) {
         return null;
      } else {
