...
public class cnt implements cnd {
   final int a;
   final int b;
   final il<cnk> c;
   final ckj d;
   ...
   public cnt(String $$0, cnc $$1, int $$2, int $$3, il<cnk> $$4, ckj $$5, boolean $$6) {
      this.e = $$0;
      this.f = $$1;
      this.a = $$2;
      this.b = $$3;
   ...
   public cnt(String $$0, cnc $$1, int $$2, int $$3, il<cnk> $$4, ckj $$5) {
   ...
   private boolean a(cgd $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   public static class a implements cnq<cnt> {
      ...
      private static final Codec<cnt> z = cnt.a.a.a.flatXmap($$0 -> {
         String[] $$1 = cnt.a($$0.e);
         int $$2 = $$1[0].length();
         int $$3 = $$1.length;
         il<cnk> $$4 = il.a($$2 * $$3, cnk.a);
         ...
         for (int $$6 = 0; $$6 < $$1.length; $$6++) {
            ...
            for (int $$8 = 0; $$8 < $$7.length(); $$8++) {
               ...
               cnk $$10 = $$9.equals(" ") ? cnk.a : $$0.d.get($$9);
               if ($$10 == null) {
         ...
         if (!$$5.isEmpty()) {
            ...
            cnt $$11 = new cnt($$0.b, $$0.c, $$2, $$3, $$4, $$0.f, $$0.g);
      ...
      public cnt b(tl $$0) {
         ...
         return new cnt($$3, $$4, $$1, $$2, $$5, $$7, $$8);
      }

      public void a(tl $$0, cnt $$1) {
         $$0.c($$1.a);
         $$0.c($$1.b);
         $$0.a($$1.e);
         $$0.a($$1.f);
      ...
      static record a(String b, cnc c, Map<String, cnk> d, List<String> e, ckj f, boolean g) {
         public static final Codec<cnt.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     asg.a(Codec.STRING, "group", "").forGetter($$0x -> $$0x.b),
                     cnc.e.fieldOf("category").orElse(cnc.d).forGetter($$0x -> $$0x.c),
                     asg.d(cnt.a.y, cnk.c).fieldOf("key").forGetter($$0x -> $$0x.d),
                     cnt.a.x.fieldOf("pattern").forGetter($$0x -> $$0x.e),
                     cne.a.fieldOf("result").forGetter($$0x -> $$0x.f),
                     asg.a(Codec.BOOL, "show_notification", true).forGetter($$0x -> $$0x.g)
                  )
                  .apply($$0, cnt.a.a::new)
         );
