...
public class cnt extends cok {
   ...
   private int b;
   private static final akj<Byte> c = akn.a(cnt.class, akl.a);

   public cnt(bwr<? extends cnt> $$0, djh $$1) {
      super($$0, $$1);
      this.a(exm.j, -1.0F);
      this.a(exm.i, 8.0F);
      this.a(exm.n, 0.0F);
   ...
   public static byo.a j() {
      return cok.gw().a(byp.c, 6.0).a(byp.v, 0.23F).a(byp.m, 48.0);
   }
            ...
            if ($$2 < 4.0) {
               ...
               if (this.c <= 0) {
                  ...
                  if (this.b > 1) {
                     ...
                     for (int $$7 = 0; $$7 < 1; $$7++) {
                        fex $$8 = new fex(this.a.dX().a($$3, 2.297 * $$6), $$4, this.a.dX().a($$5, 2.297 * $$6));
                        csi $$9 = new csi(this.a.dU(), this.a, $$8.d());
