...
public record cp(Optional<jm<cui>> b, de.d c, kk d, Map<cq.a<?>, cq> e) implements Predicate<cun> {
   ...
   public static class a {
      private Optional<jm<cui>> a = Optional.empty();
