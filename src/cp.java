...
public record cp(Optional<jm<cuk>> b, de.d c, kk d, Map<cq.a<?>, cq> e) implements Predicate<cup> {
   ...
   public static class a {
      private Optional<jm<cuk>> a = Optional.empty();
