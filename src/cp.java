...
public record cp(Optional<jm<cuj>> b, de.d c, kk d, Map<cq.a<?>, cq> e) implements Predicate<cuo> {
   ...
   public static class a {
      private Optional<jm<cuj>> a = Optional.empty();
