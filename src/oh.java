...
public class oh {
   ...
   public oh(dbr $$0, dbr $$1, dbr $$2, oa $$3, cxd $$4) {
      this.d = $$3;
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   ...
   public static oh a(dbr $$0, dbr $$1, dbr $$2, oa $$3, cxd $$4) {
   ...
   public void a(ob $$0, akt<dbv<?>> $$1) {
      ...
      this.f.forEach($$2::a);
      dcs $$3 = new dcs(Optional.of(this.a), Optional.of(this.b), Optional.of(this.c), new dcy(this.e));
