...
public class oh {
   ...
   public oh(daz $$0, daz $$1, daz $$2, oa $$3, cwk $$4) {
      this.d = $$3;
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   ...
   public static oh a(daz $$0, daz $$1, daz $$2, oa $$3, cwk $$4) {
   ...
   public void a(ob $$0, aku<dbd<?>> $$1) {
      ...
      this.f.forEach($$2::a);
      dca $$3 = new dca(Optional.of(this.a), Optional.of(this.b), Optional.of(this.c), new cwo(this.e));
