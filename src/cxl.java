...
public record cxl(int c, int d, jf<cxa> e, Optional<cxl.a> f) {
   private static final int g = 3;
   public static final MapCodec<cxl> a = cxl.a.a
      .flatXmap(cxl::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final ys<wf, cxl> b = ys.a(cxl::a, cxl::b);

   public static cxl a(Map<Character, cxa> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cxl a(Map<Character, cxa> $$0, List<String> $$1) {
      cxl.a $$2 = new cxl.a($$0, $$1);
      return ac.a(a($$2), IllegalArgumentException::new);
   }

   private static DataResult<cxl> a(cxl.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      jf<cxa> $$4 = jf.a($$2 * $$3, cxa.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cxl($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cou $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static cxl b(wf $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      jf<cxa> $$3 = jf.a($$1 * $$2, cxa.a);
      $$3.replaceAll($$1x -> cxa.b.decode($$0));
      return new cxl($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<cxl.a> d() {
      return this.f;
   }

   public static record a(Map<Character, cxa> b, List<String> c) {
      ...
      public static final MapCodec<cxl.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(axh.d(e, cxa.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cxl.a::new)
      );

      public Map<Character, cxa> a() {
         return this.b;
      }
