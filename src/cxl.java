...
public class cxl {
   private final Map<alz, cxl.a> a = Maps.newHashMap();
   private int b;
   ...
   public float a(cxo $$0, float $$1) {
      alz $$2 = this.b($$0);
      cxl.a $$3 = this.a.get($$2);
      if ($$3 != null) {
   ...
   public void a() {
      this.b++;
      if (!this.a.isEmpty()) {
         Iterator<Entry<alz, cxl.a>> $$0 = this.a.entrySet().iterator();

         while ($$0.hasNext()) {
            Entry<alz, cxl.a> $$1 = $$0.next();
   ...
   public void a(alz $$0, int $$1) {
      this.a.put($$0, new cxl.a(this.b, this.b + $$1));
      this.b($$0, $$1);
   }
