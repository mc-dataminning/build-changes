...
public abstract class cxl extends cwl {
   ...
   public static cwp a(bvg $$0, Predicate<cwp> $$1) {
      if ($$1.test($$0.b(bsi.b))) {
         return $$0.b(bsi.b);
      } else {
         return $$1.test($$0.b(bsi.a)) ? $$0.b(bsi.a) : cwp.j;
      }
   }

   public abstract int c();

   protected void a(arc $$0, bvg $$1, bsi $$2, cwp $$3, List<cwp> $$4, float $$5, float $$6, boolean $$7, @Nullable bvg $$8) {
   ...
   protected abstract void a(bvg var1, cpq var2, int var3, float var4, float var5, float var6, @Nullable bvg var7);
   ...
   protected static List<cwp> a(cwp $$0, cwp $$1, bvg $$2) {
      if ($$1.f()) {
         return List.of();
      } else {
         int $$4 = $$2.dW() instanceof arc $$3 ? ddb.a($$3, $$0, $$2, 1) : 1;
   ...
   protected static cwp a(cwp $$0, cwp $$1, bvg $$2, boolean $$3) {
      int $$5 = !$$3 && !$$2.fV() && $$2.dW() instanceof arc $$4 ? ddb.a($$4, $$0, $$1, 1) : 0;
      if ($$5 > $$1.M()) {
         return cwp.j;
      } else if ($$5 == 0) {
         cwp $$6 = $$1.c(1);
