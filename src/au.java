...
public class au extends cw<au.a> {
   ...
   @Nullable
   private static cua a(JsonObject $$0) {
      if ($$0.has("block")) {
         afw $$1 = new afw(aso.i($$0, "block"));
   ...
   public void a(alr $$0, dgb $$1, ckj $$2, int $$3) {
   ...
   public static class a extends at {
      ...
      public a(Optional<bc> $$0, @Nullable cua $$1, Optional<cb> $$2, cl.d $$3) {
         super($$0);
         this.a = $$1;
         this.b = $$2;
         this.c = $$3;
      ...
      public static am<au.a> a(cua $$0, cb.a $$1, cl.d $$2) {
         return al.K.a(new au.a(Optional.empty(), $$0, Optional.of($$1.b()), $$2));
      }

      public boolean a(dgb $$0, ckj $$1, int $$2) {
