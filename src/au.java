...
public class au extends dr<au.a> {
   ...
   public void a(arc $$0, drx $$1, cuk $$2, int $$3) {
      this.a($$0, $$3x -> $$3x.a($$1, $$2, $$3));
   }

   public static record a(Optional<bf> b, Optional<ji<deu>> c, Optional<cp> d, de.d e) implements dr.a {
      ...
      public static an<au.a> a(deu $$0, cp.a $$1, de.d $$2) {
         return am.L.a(new au.a(Optional.empty(), Optional.of($$0.q()), Optional.of($$1.b()), $$2));
      }

      public boolean a(drx $$0, cuk $$1, int $$2) {
