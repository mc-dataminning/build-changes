...
public class bog extends bko {
   ...
   private static TypeTemplate b(Schema $$0) {
      TypeTemplate $$1 = DSL.optionalFields("blocks", DSL.or(bit.E.in($$0), DSL.list(bit.E.in($$0))));
