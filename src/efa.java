...
public class efa implements eek {
   public static final Codec<efa> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               eix.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               awt.b(li.f).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               egl.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               egl.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               eab.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, efa::new)
   );
   ...
   public efa(ja<eix> $$0, int $$1, int $$2, awt<dfc> $$3, egl $$4, int $$5, int $$6, int $$7, int $$8, egl $$9, int $$10, int $$11, eab $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
