...
public class efa extends efb {
   ...
   public static final MapCodec<efa> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(eez.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, efa::new)
   );
   private final eez h;

   public efa(bqa $$0, efe $$1, Optional<eey> $$2, eez $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dcf $$0, BiConsumer<iz, dsd> $$1, azh $$2, iz $$3, iz $$4, edz $$5) {
   ...
   private boolean a(dcf $$0, azh $$1, iz $$2, je $$3, iz $$4, List<iz> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
