...
@Deprecated
public class efa extends eel<efa.a> {
   private static final dvj a = dig.nc.m();

   public efa(Codec<efa.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(een<efa.a> $$0) {
      jh $$1 = $$0.e();
      dfy $$2 = $$0.b();
      azs $$3 = $$0.d();
      efa.a $$4 = $$0.f();
   ...
   public static record a(eiq b, eiq c) implements egp {
      public static final Codec<efa.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eiq.a.fieldOf("fluid").forGetter(efa.a::a), eiq.a.fieldOf("barrier").forGetter(efa.a::b)).apply($$0, efa.a::new)
      );
