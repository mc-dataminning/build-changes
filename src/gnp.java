...
public class gnp implements gns.a, AutoCloseable {
   ...
   ext[] f;
   @Nullable
   private final gnp.a g;
   private final aty h;

   public gnp(akm $$0, gpi $$1, ext $$2, aty $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gpg $$4 = $$3.a(gpg.a).orElse(gpg.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ext[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gnk.a(this.f, $$0);
   ...
   @Nullable
   private gnp.a a(gpi $$0, int $$1, int $$2, gpg $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gnp.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gnp.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gnp.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gnp.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gnp.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gnp.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ext[] $$4) {
   ...
   class a {
      ...
      a(List<gnp.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gnp.this.c;
         int $$4 = this.b($$2) * gnp.this.d;
         gnp.this.a($$0, $$1, $$3, $$4, gnp.this.f);
      }

      public gnr a() {
         return gnp.this.new d(this, this.d ? gnp.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ext[] b = new ext[gnp.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gnp.this.c >> $$0;
            int $$2 = gnp.this.d >> $$0;
            this.b[$$0] = new ext($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gnp.d $$2) {
         gnp.a $$3 = $$2.d;
         List<gnp.b> $$4 = $$3.b;
         gnp.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            gnp.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gnp.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gnp.this.f[$$2].a($$3 + ($$0.a($$1) * gnp.this.c >> $$2), $$4 + ($$0.b($$1) * gnp.this.d >> $$2));
      }
   ...
   class d implements gnr {
      int b;
      int c;
      final gnp.a d;
      @Nullable
      private final gnp.c e;

      d(gnp.a $$0, @Nullable gnp.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
