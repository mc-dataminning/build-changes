...
public class gnp implements gns.a, AutoCloseable {
   ...
   public gnp(akn $$0, gpi $$1, exv $$2, atz $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
   ...
   void a(int $$0, int $$1, int $$2, int $$3, exv[] $$4) {
   ...
   final class c implements AutoCloseable {
      private final exv[] b = new exv[gnp.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gnp.this.c >> $$0;
            int $$2 = gnp.this.d >> $$0;
            this.b[$$0] = new exv($$1, $$2, false);
         }
      }
