...
public abstract class bqq extends bqd {
   ...
   public bqq(bjr $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public bqq(bjr $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(bqd.a.a, bqd.a.c));
   }
   ...
   protected abstract boolean a(cqa var1, gw var2);
}
