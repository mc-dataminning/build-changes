...
public class bqq implements bqr {
   ...
   private static final bqq k = new bqq();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bqp $$0) {
      URL $$1 = bqq.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bqp $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bqt a = new bqt(() -> bqq.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bqq.this.l && $$0.getState() == RecordingState.STOPPED) {
