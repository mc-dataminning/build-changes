...
public class chh extends cja {
   ...
   private static final int d = arw.f(0.4F, 0.4F, 1.0F);
   ...
   private static Optional<qw> a(cjf $$0, rc $$1) {
      return $$0.a(cji.qg)
         ? Optional.empty()
         : $$1.stream().filter(qw.class::isInstance).map(qw.class::cast).filter($$1x -> cjf.c(cjf.a($$1x), $$0)).findFirst();
   }
   ...
   private static Stream<cjf> q(cjf $$0) {
      ...
      if ($$1 == null) {
         ...
         rc $$2 = $$1.c("Items", 10);
         return $$2.stream().map(qw.class::cast).map(cjf::a);
      }
   }
   ...
   private void a(biq $$0) {
      $$0.a(apd.cJ, 0.8F, 0.8F + $$0.dL().D_().i() * 0.4F);
   }

   private void b(biq $$0) {
      $$0.a(apd.cI, 0.8F, 0.8F + $$0.dL().D_().i() * 0.4F);
   }

   private void c(biq $$0) {
      $$0.a(apd.cH, 0.8F, 0.8F + $$0.dL().D_().i() * 0.4F);
   }
}
