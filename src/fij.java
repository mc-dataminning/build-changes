...
public class fij {
   ...
   static class b {
      static final Optional<fij> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static fij a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fij();
      }
   }
}
