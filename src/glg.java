...
public class glg extends auu<Optional<glg.b>> implements AutoCloseable {
   ...
   @Nullable
   private glg.b q;
   private final ffw r = new ffw(fdn.b);
   private boolean s;
   ...
   public void a(int $$0, fku $$1, float $$2, Matrix4f $$3, Matrix4f $$4, faz $$5, float $$6) {
      if (this.q != null) {
         ...
         if (this.l || $$16 != this.m || $$17 != this.n || $$9 != this.o || $$1 != this.p) {
            ...
            this.o = $$9;
            this.p = $$1;
            ffs $$21 = this.a(ffv.b(), $$16, $$17, $$1, $$9, $$20);
            if ($$21 != null) {
               this.r.a($$21);
               this.s = false;
            } else {
   ...
   @Nullable
   private ffs a(ffv $$0, int $$1, int $$2, fku $$3, glg.a $$4, gmh $$5) {
      float $$6 = 0.8F;
      ...
      ffo $$11 = $$0.a($$5.T(), $$5.S());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == fku.c);
      return $$11.a();
   }

   private void a(glg.a $$0, ffo $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(ffo $$0, int $$1, int $$2, int $$3) {
   ...
   private void a(glg.a $$0, ffo $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
