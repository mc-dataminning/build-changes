...
public class glg {
   ...
   private glg(int $$0, List<gli> $$1) {
      this.a = $$1.toArray(gli[]::new);
      this.b = $$1.size();
   }

   private List<gli> c() {
      List<gli> $$0 = new ArrayList<>(this.d());
