...
public class glg implements avw, AutoCloseable {
   ...
   private final gnu j;
   private final gls k;
   private final gmg l = new gmg();
   private final gks m = new gks();
   private final gml n = new gml();
   private final gmk o = new gmk();
   @Nullable
   private gfj p;
   private final glz q = new glz();
   private final ObjectArrayList<gox.b> r = new ObjectArrayList(10000);
   private final ObjectArrayList<gox.b> s = new ObjectArrayList(50);
   ...
   public glg(fmf $$0, grn $$1, gnu $$2, gls $$3) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
      this.k = $$3;
   ...
   public void e() {
      if (this.p != null) {
         this.p.f();
         if (this.I == null) {
            this.I = new gox(this.p, this, ae.g(), this.k, this.h.ap(), this.h.ar());
         } else {
            this.I.a(this.p);
         }
         ...
         this.u = new gmi(this.I, this.p, this.h.n.aH(), this);
         this.q.a(this.u);
         this.B();
         bvj $$0 = this.h.ao();
         if ($$0 != null) {
   ...
   private void a(flo $$0, gpb $$1, boolean $$2, boolean $$3) {
      fbx $$4 = $$0.b();
   ...
   public static gpb a(gpb $$0) {
      return new gpb($$0).a(8);
   }

   private void b(gpb $$0) {
      if (!fmf.Q().bx()) {
   ...
   public void a(fga $$0, flv $$1, boolean $$2, flo $$3, gla $$4, gli $$5, Matrix4f $$6, Matrix4f $$7) {
      float $$8 = $$1.a(false);
      ...
      gpb $$15 = $$14 ? this.O : this.M;
      bpr.a().b("captureFrustum");
      if (this.N) {
         this.O = $$14 ? new gpb($$6, $$7) : $$15;
         this.O.a($$11, $$12, $$13);
         this.N = false;
      }
      ...
      Vector4f $$18 = gkz.a($$3, $$8, this.h.s, this.h.n.aH(), $$4.c($$8));
      gky $$19 = gkz.a($$3, gkz.d.b, $$18, $$16, $$17, $$8);
      gky $$20 = gkz.a($$3, gkz.d.a, $$18, $$16, $$17, $$8);
      $$9.b("cullEntities");
   ...
   private void a(fev $$0, gpb $$1, flo $$2, Matrix4f $$3, Matrix4f $$4, gky $$5, boolean $$6, boolean $$7, flv $$8, bps $$9) {
      few $$10 = $$0.a("main");
      ...
      $$10.a(() -> {
         ...
         double $$17 = $$14x.c();
         $$9.a("terrain");
         this.a(glu.c(), $$15x, $$16, $$17, $$3, $$4);
         this.a(glu.d(), $$15x, $$16, $$17, $$3, $$4);
         this.a(glu.e(), $$15x, $$16, $$17, $$3, $$4);
         if (this.p.c().e()) {
            ffn.a();
         } else {
            ffn.b();
         ...
         $$9.b("translucent");
         this.a(glu.f(), $$15x, $$16, $$17, $$3, $$4);
         $$9.b("string");
         this.a(glu.s(), $$15x, $$16, $$17, $$3, $$4);
         if ($$6) {
            this.a($$2, $$19, $$18, true);
         }
   ...
   private void a(fev $$0, flo $$1, gli $$2, float $$3, gky $$4) {
      few $$5 = $$0.a("particles");
      if (this.z.n != null) {
   ...
   private void a(fev $$0, Matrix4f $$1, Matrix4f $$2, flr $$3, fbx $$4, float $$5, int $$6, float $$7) {
      few $$8 = $$0.a("clouds");
      if (this.z.p != null) {
   ...
   private void a(fev $$0, gli $$1, fbx $$2, float $$3, gky $$4) {
   ...
   private void a(fev $$0, fbx $$1, gky $$2) {
   ...
   private boolean a(flo $$0, gpb $$1, List<bvj> $$2) {
      fbx $$3 = $$0.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      ...
      for (bvj $$9 : this.p.d()) {
         if (this.i.a($$9, $$1, $$4, $$5, $$6) || $$9.A(this.h.t)) {
            ...
            if ((this.p.e($$10.v()) || this.a($$10))
               && ($$9 != $$0.g() || $$0.i() || $$0.g() instanceof bwf && ((bwf)$$0.g()).fR())
               && (!($$9 instanceof gkg) || $$0.g() == $$9)) {
               $$2.add($$9);
               if ($$8 && this.h.b($$9)) {
                  $$7 = true;
               }
   ...
   private void a(fgr $$0, glk.a $$1, flo $$2, flv $$3, List<bvj> $$4) {
      fbx $$5 = $$2.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
   ...
   private void a(fgr $$0, glk.a $$1, glk.a $$2, flo $$3, float $$4) {
      fbx $$5 = $$3.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
         ...
         if (!$$10.isEmpty()) {
            for (duw $$11 : $$10) {
               ...
               if ($$14 != null && !$$14.isEmpty()) {
                  ...
                  if ($$15 >= 0) {
                     fgr.a $$16 = $$0.c();
                     fgv $$17 = new fgs($$2.getBuffer(hdw.l.get($$15)), $$16, 1.0F);
                     $$13 = $$2x -> {
                        fgv $$3x = $$1.getBuffer($$2x);
                        return $$2x.S() ? fgy.a($$17, $$3x) : $$3x;
                     };
                  }
               }
   ...
   private void a(fgr $$0, flo $$1, glk.a $$2) {
      fbx $$3 = $$1.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      ...
      while (var11.hasNext()) {
         ...
         if (!($$8.c($$4, $$5, $$6) > 1024.0)) {
            ...
            if ($$9 != null && !$$9.isEmpty()) {
               ...
               fgr.a $$11 = $$0.c();
               fgv $$12 = new fgs($$2.getBuffer(hdw.l.get($$10)), $$11, 1.0F);
   ...
   private void a(flo $$0, glk.a $$1, fgr $$2, boolean $$3) {
      if (this.h.w instanceof fbt $$4) {
         if ($$4.d() != fbv.a.a) {
            ...
            if (!$$7.l() && this.p.F_().a($$6)) {
               ...
               if ($$10) {
                  fgv $$11 = $$1.getBuffer(glu.z());
                  this.a($$2, $$11, $$0.g(), $$9.d, $$9.e, $$9.f, $$6, $$7, -16777216);
               }

               fgv $$12 = $$1.getBuffer(glu.y());
   ...
   private void a(bvj $$0, double $$1, double $$2, double $$3, float $$4, fgr $$5, glk $$6) {
   ...
   private void a(fbx $$0) {
      if (!this.r.isEmpty()) {
         ...
         while ($$5x-- > 0) {
            ...
            this.a((gox.b)this.r.get($$6), $$3, $$0, $$2, false);
         }
   ...
   private void a(gox.b $$0, gox.d $$1, fbx $$2, boolean $$3, boolean $$4) {
      $$1.b($$2, $$0.g());
   ...
   private void a(glu $$0, double $$1, double $$2, double $$3, Matrix4f $$4, Matrix4f $$5) {
      RenderSystem.assertOnRenderThread();
      bpx $$6 = bpr.a().c(() -> "render_" + $$0.b);
      $$6.a($$0::toString);
      boolean $$7 = $$0 != glu.f();
      ObjectListIterator<gox.b> $$8 = this.r.listIterator($$7 ? 0 : this.r.size());
      $$0.a();
      gkt $$9 = RenderSystem.getShader();
      if ($$9 == null) {
         $$0.b();
         $$6.close();
      } else {
         ...
         while ($$7 ? $$8.hasNext() : $$8.hasPrevious()) {
            gox.b $$11 = $$7 ? (gox.b)$$8.next() : (gox.b)$$8.previous();
            if (!$$11.d().a($$0)) {
               fgu $$12 = $$11.a($$0);
               jh $$13 = $$11.f();
               if ($$10 != null) {
   ...
   private void a(fev $$0, flo $$1, float $$2, gky $$3) {
      ety $$4 = $$1.k();
   ...
   private void c(flo $$0) {
      ...
      gov $$3 = new gov();
      jh $$4 = $$0.c();
      List<gox.b> $$5 = Lists.newArrayList();
      ObjectListIterator var7 = this.r.iterator();

      while (var7.hasNext()) {
         gox.b $$6 = (gox.b)var7.next();
         long $$7 = $$6.g();
         if ($$6.i() && $$6.a() && a($$2, $$7)) {
            boolean $$8 = false;
            if (this.h.n.m().c() == fml.c) {
               jh $$9 = $$6.f().b(8, 8, 8);
               $$8 = $$9.j($$4) < 768.0 || $$6.j();
            } else if (this.h.n.m().c() == fml.b) {
               $$8 = $$6.j();
            }
   ...
   private void a(fgr $$0, fgv $$1, bvj $$2, double $$3, double $$4, double $$5, jh $$6, dxu $$7, int $$8) {
      gme.a($$0, $$1, $$7.a(this.p, $$6, fcc.a($$2)), (double)$$6.u() - $$3, (double)$$6.v() - $$4, (double)$$6.w() - $$5, $$8);
   }
   ...
   @Nullable
   gir b(lq $$0, boolean $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      return this.b($$0, $$1, false, $$2, $$3, $$4, $$5, $$6, $$7);
   }

   @Nullable
   private gir b(lq $$0, boolean $$1, boolean $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8) {
      flo $$9 = this.h.j.k();
      arz $$10 = this.a($$2);
      if ($$1) {
   ...
   @bbl
   public ObjectArrayList<gox.b> w() {
      return this.r;
   }
