...
public class glg {
   ...
   private final dhi b;
   private final glh c;
   private final Map<jh, hfi> d = new HashMap<>();

   public glg(fmg $$0, dhi $$1, glh $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public void b(int $$0, jh $$1, int $$2) {
      ...
      switch ($$0) {
         ...
         case 1031:
            ...
            break;
         case 1032:
            this.a.ak().a(hfd.b(axf.vc, $$3.i() * 0.4F + 0.8F, 0.25F));
            break;
         case 1033:
         ...
         case 2007:
            ...
            for (int $$10 = 0; $$10 < 8; $$10++) {
               this.c.a(new lo(ls.S, new cxp(cxt.we)), $$9.d, $$9.e, $$9.f, $$3.k() * 0.15, $$3.j() * 0.2, $$3.k() * 0.15);
            }
            ...
            for (int $$15 = 0; $$15 < 100; $$15++) {
               ...
               gis $$21 = this.c.b($$14, $$14.a().b(), $$9.d + $$18 * 0.1, $$9.e + 0.3, $$9.f + $$20 * 0.1, $$18, $$19, $$20);
               if ($$21 != null) {
         ...
         case 2003:
            ...
            for (int $$7 = 0; $$7 < 8; $$7++) {
               this.c.a(new lo(ls.S, new cxp(cxt.tg)), $$4, $$5, $$6, $$3.k() * 0.15, $$3.j() * 0.2, $$3.k() * 0.15);
            }
         ...
         case 2006:
            for (int $$69 = 0; $$69 < 200; $$69++) {
               ...
               gis $$75 = this.c.b(ls.h, false, (double)$$1.u() + $$72 * 0.1, (double)$$1.v() + 0.3, (double)$$1.w() + $$74 * 0.1, $$72, $$73, $$74);
               if ($$75 != null) {
                  $$75.c($$70);
               }
            }
         ...
         case 3002:
            if ($$2 >= 0 && $$2 < jm.a.d.length) {
               bai.a(jm.a.d[$$2], this.b, $$1, 0.125, ls.aU, bsu.a(10, 19));
            } else {
               bai.a(this.b, $$1, ls.aU, bsu.a(3, 5));
            }
            break;
         case 3003:
            bai.a(this.b, $$1, ls.aS, bsu.a(3, 5));
            this.b.a($$1, axf.mU, axg.e, 1.0F, 1.0F, false);
            break;
         case 3004:
            bai.a(this.b, $$1, ls.aT, bsu.a(3, 5));
            break;
         case 3005:
            bai.a(this.b, $$1, ls.aV, bsu.a(3, 5));
            break;
         case 3006:
            int $$36 = $$2 >> 6;
            if ($$36 > 0) {
               ...
               bso $$40 = bsu.a(0, $$36);
               float $$41 = 0.005F;
               Supplier<fby> $$42 = () -> new fby(bae.a($$3, -0.005F, 0.005F), bae.a($$3, -0.005F, 0.005F), bae.a($$3, -0.005F, 0.005F));
               if ($$39 == 0) {
                  for (jm $$43 : jm.values()) {
         ...
         case 3007:
            for (int $$57 = 0; $$57 < 10; $$57++) {
               this.b.a(new lv($$57 * 5), false, (double)$$1.u() + 0.5, (double)$$1.v() + drj.f, (double)$$1.w() + 0.5, 0.0, 0.0, 0.0);
            }

            dxv $$58 = this.b.a_($$1);
            boolean $$59 = $$58.b(dyl.D) && $$58.c(dyl.D);
            if (!$$59) {
               this.b.a((double)$$1.u() + 0.5, (double)$$1.v() + drj.f, (double)$$1.w() + 0.5, axf.wL, axg.e, 2.0F, 0.6F + this.b.A.i() * 0.4F, false);
            }
            break;
         case 3008:
            dxv $$25 = dkm.a($$2);
            if ($$25.b() instanceof dks $$26) {
            ...
            break;
         case 3009:
            bai.a(this.b, $$1, ls.aX, bsu.a(3, 6));
            break;
         case 3011:
            dwx.a(this.b, $$1, $$3, dwx.a.a($$2).c);
            break;
         case 3012:
         ...
         case 3014:
            ...
            break;
         case 3015:
            if (this.b.c_($$1) instanceof dxd $$31) {
               dxd.a.a(this.b, $$31.aB_(), $$31.m(), $$31.c(), $$2 == 0 ? ls.aK : ls.L);
               this.b.a($$1, axf.AZ, axg.e, 1.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, true);
            }
            break;
         case 3016:
            dxd.a.a(this.b, $$1, $$2 == 0 ? ls.aK : ls.L);
   ...
   private void a(jq<cxv> $$0, jh $$1) {
      this.a($$1);
      cxv $$2 = $$0.a();
      axe $$3 = $$2.b().a();
      hfi $$4 = hfd.a($$3, fby.b($$1));
      this.d.put($$1, $$4);
      this.a.ak().a($$4);
      this.a.m.a($$2.c());
   ...
   private void a(dhi $$0, jh $$1, boolean $$2) {
      for (bwg $$4 : $$0.a(bwg.class, new fbt($$1).g(3.0))) {
         $$4.a($$1, $$2);
      }
   }
}
