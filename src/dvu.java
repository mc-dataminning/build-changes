...
public class dvu {
   ...
   private final cyz p;
   private static final List<dby> q = List.of(dca.l, dca.L, dca.i, dca.b, dca.k, dca.I, dca.K, dca.fl, dca.dP, dca.iA, dca.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<il<czw>>> t;
   ...
   public static final Codec<dvu> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dvu::a, Function.identity());
   ...
   private dvu(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<il<czw>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = je.c($$0);
      int $$5 = je.c($$1) - $$4;
   ...
   @Nullable
   public static dvu a(apz $$0, int $$1, int $$2) {
      dqv $$3 = $$0.a($$1, $$2);
      dvu $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dru.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<ii> a(czs $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dqv $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, axk.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dqv $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dur.a.a)) {
         $$3 = Math.min($$0.a(dur.a.a, $$1, $$2) + 1, this.p.al());
      } else {
         $$3 = this.p.al();
      }
   ...
   private static double a(dqv $$0, ib.a $$1) {
      return a($$0, (ib)$$1.c(ih.a)) ? 1.0 : -1.0;
   }

   private static double b(dqv $$0, ib.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dqv $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.b()];
      Arrays.fill($$4, -1.0);
      ib.a $$5 = new ib.a($$1, this.p.al(), $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<il<czw>> b(dqv $$0, int $$1, int $$2) {
      ObjectArrayList<il<czw>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dqv $$0, ib $$1) {
      doz $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(avc.O)) {
         ...
         return $$2.a(dca.eT) || $$2.a(dca.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dvu.a $$3) {
      if ($$1 >= iw.a(this.p.I_()) && $$1 < iw.a(this.p.al())) {
         int $$4 = $$1 - iw.a(this.p.I_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               il<czw> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dvu.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dvu.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, il<czw> var3);
   }
