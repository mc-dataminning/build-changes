...
public class dvu {
   ...
   private final Map<Character, Predicate<dvs>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dvu a(char $$0, Predicate<dvs> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dvt b() {
      return new dvt(this.c());
   }

   private Predicate<dvs>[][][] c() {
      this.d();
      Predicate<dvs>[][][] $$0 = (Predicate<dvs>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dvs>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
