...
public final class aki<E> implements Codec<ix<E>> {
   private final akl<? extends jk<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> aki<E> a(akl<? extends jk<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> aki<E> a(akl<? extends jk<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new aki<>($$0, $$1, $$2);
   }

   private aki(akl<? extends jk<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public <T> DataResult<T> a(ix<E> $$0, DynamicOps<T> $$1, T $$2) {
      if ($$1 instanceof akk<?> $$3) {
         ...
         if ($$4.isPresent()) {
            ...
            return (DataResult<T>)$$0.d().map($$2x -> akm.a.encode($$2x.a(), $$1, $$2), $$2x -> this.b.encode($$2x, $$1, $$2));
         }
      }
   ...
   public <T> DataResult<Pair<ix<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof akk<?> $$2) {
         ...
         if ($$3.isEmpty()) {
            ...
            iy<E> $$4 = $$3.get();
            DataResult<Pair<akm, T>> $$5 = akm.a.decode($$0, $$1);
            if ($$5.result().isEmpty()) {
               return !this.c ? DataResult.error(() -> "Inline definitions not allowed here") : this.b.decode($$0, $$1).map($$0x -> $$0x.mapFirst(ix::a));
            } else {
               Pair<akm, T> $$6 = (Pair<akm, T>)$$5.result().get();
               akl<E> $$7 = akl.a(this.a, (akm)$$6.getFirst());
               return $$4.a($$7)
