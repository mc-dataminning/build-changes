public abstract class ghv<T extends bpp, M extends fpk<T>> extends ghm<T, M> {
   public ghv(gec<T, M> $$0) {
      super($$0);
   }

   protected abstract int a(T var1);

   protected abstract void a(eub var1, fxs var2, int var3, box var4, float var5, float var6, float var7, float var8);
