...
public class ghv {
   ...
   public static class b extends gjl {
      b(gfd $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gix {
      ...
      c(gfd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gin $$7, gjg $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            ghv.c $$0 = new ghv.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gio<lw> {
      ...
      public gil a(lw $$0, gfd $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ghv.c $$8 = new ghv.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, flz.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gij {
      ...
      private int D;
      private final gin E;
      private final List<czz> F;
      private boolean G;

      public e(gfd $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gin $$7, List<czz> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gil $$12 = this.E.a(ls.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         ghv.c $$10 = (ghv.c)this.E.a(ls.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
