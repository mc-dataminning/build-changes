...
public class ffr {
   ...
   public static void a(File $$0, eym $$1, Consumer<xp> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eym $$2, Consumer<xp> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eym $$2, Consumer<xp> $$3) {
      ezb $$4 = a($$2);
   ...
   public static ezb a(eym $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ezb $$3 = new ezb($$1, $$2, false);
   ...
   public ffr(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
