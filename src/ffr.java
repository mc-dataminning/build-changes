...
public final class ffr implements AutoCloseable {
   ...
   public ffr(int $$0, int $$1, boolean $$2) {
      this(ffr.a.a, $$0, $$1, $$2);
   }

   public ffr(ffr.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   private ffr(ffr.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.d = $$0;
         this.e = $$1;
         this.f = $$2;
   ...
   public static ffr a(InputStream $$0) throws IOException {
      return a(ffr.a.a, $$0);
   }

   public static ffr a(@Nullable ffr.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static ffr a(ByteBuffer $$0) throws IOException {
      return a(ffr.a.a, $$0);
   }

   public static ffr a(byte[] $$0) throws IOException {
   ...
   public static ffr a(@Nullable ffr.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            b.malloc($$7, $$6.limit());
            var9 = new ffr($$0 == null ? ffr.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, $$7);
   ...
   public ffr a(IntUnaryOperator $$0) {
      if (this.d != ffr.a.a) {
         ...
         this.j();
         ffr $$1 = new ffr(this.e, this.f, false);
         int $$2 = this.e * this.f;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (frh.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(ffr $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, ffr $$4) {
      this.j();
      if ($$4.c() != this.d) {
