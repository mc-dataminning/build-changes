public class ffr implements fft {
   ...
   @Override
   public void a(ews $$0, int $$1, int $$2, ewu $$3) {
      int $$4 = this.d();
      int $$5 = this.e();
   ...
   private void a(int $$0, int $$1, int $$2, boolean $$3, ewu $$4, ews $$5) {
      if ($$2 >= this.f.size()) {
         this.a($$4, $$0, $$1, $$3 ? ffr.a.a : ffr.a.b);
      } else {
         cmy $$6 = this.f.get($$2);
         this.a($$4, $$0, $$1, ffr.a.b);
         $$4.a($$6, $$0 + 1, $$1 + 1, $$2);
         $$4.a($$5, $$6, $$0 + 1, $$1 + 1);
         if ($$2 == 0) {
            fea.a($$4, $$0 + 1, $$1 + 1, 0);
   ...
   private void a(ewu $$0, int $$1, int $$2, ffr.a $$3) {
