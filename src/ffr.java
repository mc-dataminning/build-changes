...
public class ffr {
   ...
   public xu a(xu $$0, int $$1, ym $$2) {
      final ffr.e $$3 = new ffr.e((float)$$1);
      return $$0.a(new xu.b<xu>() {
         private final few b = new few();
   ...
   public void a(String $$0, int $$1, ym $$2, boolean $$3, ffr.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      ym $$7 = $$2;

      while ($$5 < $$6) {
         ffr.b $$8 = new ffr.b((float)$$1);
   ...
   public void a(xu $$0, int $$1, ym $$2, BiConsumer<xu, Boolean> $$3) {
      List<ffr.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new ffr.c($$2x, $$1x));
         }
   ...
   static class a {
      ...
      public xu a(int $$0, int $$1, ym $$2) {
         few $$3 = new few();
         ListIterator<ffr.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, ym $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = ffr.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements aym {
      ...
      @Override
      public boolean accept(int $$0, ym $$1, int $$2) {
         this.b = this.b - ffr.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
