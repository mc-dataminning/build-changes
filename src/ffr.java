public class ffr<T extends byq> extends ffm<T> implements fee, ffl {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if (this.d) {
         ...
         this.j.e = arx.b($$1 * 0.6662F + (float) Math.PI) * 2.0F * $$2 * 0.5F;
         this.j.f = 0.0F;
         this.j.g = 0.0F;
         this.k.e = arx.b($$1 * 0.6662F) * 2.0F * $$2 * 0.5F;
         this.k.f = 0.0F;
         this.k.g = 0.0F;
         this.i.e = arx.b($$1 * 0.6662F) * 1.4F * $$2 * 0.5F;
         this.i.f = 0.0F;
         this.i.g = 0.0F;
         this.h.e = arx.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2 * 0.5F;
         this.h.f = 0.0F;
         this.h.g = 0.0F;
      }
      ...
      if ($$6 == byq.a.b) {
         ...
         this.k.d = 0.0F;
         this.k.b = 5.0F;
         this.j.e = arx.b($$3 * 0.6662F) * 0.25F;
         this.k.e = arx.b($$3 * 0.6662F) * 0.25F;
         ...
         this.j.d = 0.0F;
         this.j.b = -5.0F;
         this.j.e = arx.b($$3 * 0.6662F) * 0.05F;
         this.j.g = 2.670354F;
         this.j.f = 0.0F;
         this.k.d = 0.0F;
         this.k.b = 5.0F;
         this.k.e = arx.b($$3 * 0.6662F) * 0.05F;
         this.k.g = (float) (-Math.PI * 3.0 / 4.0);
         this.k.f = 0.0F;
      }
