...
public abstract class bdr extends DataFix {
   private final String a;
   private final String b;
   private final String c;

   public bdr(Schema $$0, String $$1, String $$2) {
      this($$0, $$1, $$2, $$2);
   }

   public bdr(Schema $$0, String $$1, String $$2, String $$3) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   public final TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(biz.w);
