...
public class bdr extends bgr {
   public bdr(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bhw.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bhw.D.typeName(), bjk.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bhw.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bhw.D.typeName(), "minecraft:saddle"));
