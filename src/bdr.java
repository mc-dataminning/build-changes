...
public class bdr extends DataFix {
   ...
   public bdr(Schema $$0, String $$1) {
      super($$0, false);
      this.a = $$1;
   }

   private <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = $$0.update("front_text", bdr::b);
      $$0 = $$0.update("back_text", bdr::b);
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getInputSchema().getChoiceType(bit.s, this.a);
