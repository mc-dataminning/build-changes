...
public class bdr extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         "EntityCustomNameToComponentFix", this.getInputSchema().getType(bhy.B), $$1 -> $$1.update(DSL.remainderFinder(), $$2 -> {
   ...
   public static Dynamic<?> a(Dynamic<?> $$0) {
      ...
      return $$1.isEmpty() ? $$0.remove("CustomName") : $$0.set("CustomName", baw.a($$0.getOps(), $$1));
   }
}
