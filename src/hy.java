...
public interface hy<T> {
   ...
   ia<T> a(@Nullable ua var1, CommandDispatcher<T> var2) throws en;
   ...
   static <T extends em<T>> hy<T> a(alk $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      hz<T> $$4 = new hz<>();
   ...
   static <T extends em<T>> hp<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new hr.c<>($$2.getString(), $$4.get());
      }
   }
}
