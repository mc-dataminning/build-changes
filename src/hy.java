...
public class hy<T extends ev<T>> {
   @VisibleForTesting
   public static final DynamicCommandExceptionType a = new DynamicCommandExceptionType($$0 -> wz.b("command.forkLimit", $$0));
   private final String b;
   private final ContextChain<T> c;

   public hy(String $$0, ContextChain<T> $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   protected void a(T $$0, List<T> $$1, hs<T> $$2, hu $$3, hn $$4) {
      ...
      if ($$5.getStage() != Stage.EXECUTE) {
         ...
         try {
            for (int $$8 = $$2.d(); $$5.getStage() != Stage.EXECUTE; $$5 = $$5.nextStage()) {
               ...
               if ($$10 instanceof hq<T> $$11) {
                  $$11.a($$0, $$7, $$5, $$6, ht.a($$2, $$3));
                  return;
               }
      ...
      if ($$7.isEmpty()) {
         ...
         if ($$17.getCommand() instanceof hp<T> $$19) {
            ht<T> $$20 = ht.a($$2, $$3);
            ...
            ib<T> $$23 = new ib<>(this.b, $$6, $$17);
            ia.a($$2, $$3, $$7, ($$1x, $$2x) -> new ho<>($$1x, $$23.bind((T)$$2x)));
         }
      }
   }

   protected void a(hs<T> $$0, hu $$1) {
      hv $$2 = $$0.b();
      if ($$2 != null) {
         $$2.a($$1.c(), this.b);
      }
   ...
   public static class a<T extends ev<T>> extends hy<T> implements hr<T> {
      ...
      public a(String $$0, ContextChain<T> $$1, hn $$2, T $$3, List<T> $$4) {
         super($$0, $$1);
         this.c = $$3;
         this.d = $$4;
         this.b = $$2;
   ...
   public static class b<T extends ev<T>> extends hy<T> implements hr<T> {
      ...
      public void execute(hs<T> $$0, hu $$1) {
         this.a($$0, $$1);
         this.a(this.b, List.of(this.b), $$0, $$1, hn.a);
      }
   }
