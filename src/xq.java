...
public class xq implements vf<wy> {
   ...
   private final int h;
   private final List<xq.b> i;

   public xq(RootCommandNode<dw> $$0) {
   ...
   private static void a(List<xq.b> $$0, BiPredicate<xq.b, IntSet> $$1) {
   ...
   private static void a(List<xq.b> $$0) {
      a($$0, xq.b::a);
      a($$0, xq.b::b);
   }
   ...
   private static List<xq.b> a(Object2IntMap<CommandNode<dw>> $$0) {
      ObjectArrayList<xq.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static xq.b b(sq $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.m() : 0;
      xq.e $$4 = a($$0, $$1);
      return new xq.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static xq.e a(sq $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.r();
         int $$4 = $$0.m();
         ...
         if ($$5 == null) {
            ...
            gi.a<?> $$6 = $$5.b($$0);
            aey $$7 = ($$1 & 16) != 0 ? $$0.s() : null;
            return new xq.a($$3, $$6, $$7);
         }
      } else if ($$2 == 1) {
         String $$8 = $$0.r();
         return new xq.c($$8);
   ...
   private static xq.b a(CommandNode<dw> $$0, Object2IntMap<CommandNode<dw>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<dw> a(dn $$0) {
      return (RootCommandNode<dw>)new xq.d($$0, this.i).a(this.h);
   }
   ...
   static class a implements xq.e {
      ...
      @Nullable
      private static aey a(@Nullable SuggestionProvider<dw> $$0) {
         return $$0 != null ? gm.a($$0) : null;
      }

      a(String $$0, gi.a<?> $$1, @Nullable aey $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(sq $$0, gi.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends gi.a<A>> void a(sq $$0, gi<A, T> $$1, gi.a<A> $$2) {
         $$0.c(jd.x.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
   ...
   static class b {
      ...
      b(@Nullable xq.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements xq.e {
      private final String a;
