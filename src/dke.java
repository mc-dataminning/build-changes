...
public class dke extends eyh {
   private static final int c = 4;
   private static final Logger d = LogUtils.getLogger();
   private static final Codec<Pair<dio, arw>> e = Codec.mapPair(dio.a.fieldOf("chunk_pos"), arw.a).codec();
   public static final Codec<dke> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(e.listOf().optionalFieldOf("tickets", List.of()).forGetter(dke::h)).apply($$0, dke::a)
   );
   public static final eyi<dke> b = new eyi<>("chunks", dke::new, a, bbb.i);
   ...
   private dke(Long2ObjectOpenHashMap<List<arw>> $$0, Long2ObjectOpenHashMap<List<arw>> $$1) {
      this.f = $$0;
      this.g = $$1;
      this.i();
   }
   ...
   private static dke a(List<Pair<dio, arw>> $$0) {
      Long2ObjectOpenHashMap<List<arw>> $$1 = new Long2ObjectOpenHashMap();

      for (Pair<dio, arw> $$2 : $$0) {
         dio $$3 = (dio)$$2.getFirst();
         List<arw> $$4 = (List<arw>)$$1.computeIfAbsent($$3.a(), $$0x -> new ObjectArrayList(4));
         $$4.add((arw)$$2.getSecond());
      }

      return new dke(new Long2ObjectOpenHashMap(4), $$1);
   }

   private List<Pair<dio, arw>> h() {
      List<Pair<dio, arw>> $$0 = new ArrayList<>();
      this.a((BiConsumer<dio, arw>)(($$1, $$2) -> {
         if ($$2.a().e()) {
            $$0.add(new Pair($$1, $$2));
         }
      }));
   ...
   private void a(BiConsumer<dio, arw> $$0) {
      a($$0, this.f);
      a($$0, this.g);
   }

   private static void a(BiConsumer<dio, arw> $$0, Long2ObjectOpenHashMap<List<arw>> $$1) {
      ObjectIterator var2 = Long2ObjectMaps.fastIterable($$1).iterator();

      while (var2.hasNext()) {
         Entry<List<arw>> $$2 = (Entry<List<arw>>)var2.next();
         dio $$3 = new dio($$2.getLongKey());
   ...
   public void a(@Nullable dke.a $$0) {
      this.i = $$0;
   }

   public void b(@Nullable dke.a $$0) {
      this.j = $$0;
   }
