...
public class dke extends dit {
      ...
      d = CacheBuilder.newBuilder()
         ...
         .build(new CacheLoader<String, CompletableFuture<Optional<GameProfile>>>() {
            public CompletableFuture<Optional<GameProfile>> a(String $$0x) {
               return $$2.getAsBoolean() ? CompletableFuture.completedFuture(Optional.empty()) : dke.a($$0, $$0, $$2);
            }
         });
   }
   ...
   public static void a(cvn $$0, hz $$1, dlf $$2, dke $$3) {
      if ($$2.b(dfp.a) && $$2.c(dfp.a)) {
         $$3.i = true;
         $$3.h++;
      } else {
         $$3.i = false;
   ...
   private static CompletableFuture<Optional<GameProfile>> a(String $$0) {
      ...
      return $$1 != null && chh.c($$0) ? (CompletableFuture)$$1.getUnchecked($$0) : CompletableFuture.completedFuture(Optional.empty());
   }
