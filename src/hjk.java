...
public class hjk {
   ...
   public void a() {
      ...
      if ($$3 == null) {
         ...
         if (this.d != null) {
            if ($$0.a(this.d)) {
               this.c.ak().b(this.d);
               this.f = ayy.a(this.b, 0, $$3.b() / 2);
            }

            if (!this.c.ak().c(this.d)) {
               this.d = null;
               this.f = Math.min(this.f, ayy.a(this.b, $$3.b(), $$3.c()));
            }
         }
   ...
   private boolean a(float $$0) {
      if (this.d == null) {
         ...
         if (this.e < $$0) {
            this.e = this.e + ayy.a(this.e, 5.0E-4F, 0.005F);
            if (this.e > $$0) {
               this.e = $$0;
            }
         } else {
