...
public class gwc extends gwg<cma, hcl> {
   ...
   private static final gqk j = gqk.g(h);
   private static final gqk k = gqk.m(h);
   private static final gqk l = gqk.q(i);
   private static final gqk m = gqk.l(a);
   ...
   public gwc(gwh.a $$0) {
      super($$0);
      this.e = 0.5F;
      this.o = new giw($$0.a(gjb.aT));
   }

   public void a(hcl $$0, fjj $$1, gqa $$2, int $$3) {
      $$1.a();
      float $$4 = $$0.a(7).b();
      ...
      if ($$0.b > 0.0F) {
         ...
         fjn $$8 = $$2.getBuffer(gqk.p(g));
         this.o.a($$1, $$8, $$3, hin.d, $$7);
         fjn $$9 = $$2.getBuffer(k);
         this.o.a($$1, $$9, $$3, hin.a(0.0F, $$0.c));
      } else {
         fjn $$10 = $$2.getBuffer(j);
         this.o.a($$1, $$10, $$3, hin.a(0.0F, $$0.c));
      }

      fjn $$11 = $$2.getBuffer(l);
      this.o.a($$1, $$11, $$3, hin.d);
      if ($$0.b > 0.0F) {
         float $$12 = $$0.b / 200.0F;
         $$1.a();
         $$1.a(0.0F, -1.0F, -2.0F);
         a($$1, $$12, $$2.getBuffer(gqk.q()));
         a($$1, $$12, $$2.getBuffer(gqk.r()));
         $$1.b();
      }
   ...
   private static void a(fjj $$0, float $$1, fjn $$2) {
      $$0.a();
   ...
   public static void a(float $$0, float $$1, float $$2, float $$3, fjj $$4, gqa $$5, int $$6) {
      ...
      for (int $$17 = 1; $$17 <= 8; $$17++) {
         ...
         $$9.a($$16, $$13 * 0.2F, $$14 * 0.2F, 0.0F).a(-16777216).a($$15, $$10).b(hin.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$13, $$14, $$8).a(-1).a($$15, $$11).b(hin.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$18, $$19, $$8).a(-1).a($$20, $$11).b(hin.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$18 * 0.2F, $$19 * 0.2F, 0.0F).a(-16777216).a($$20, $$10).b(hin.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$13 = $$18;
         $$14 = $$19;
         $$15 = $$20;
      }
   ...
   public void a(cma $$0, hcl $$1, float $$2) {
      super.a($$0, $$1, $$2);
      ...
      clz $$3 = $$0.bJ;
      if ($$3 != null) {
         feq $$4 = $$3.p($$2).b(0.0, (double)gwb.a((float)$$3.a + $$2), 0.0);
         $$1.d = $$4.d($$0.p($$2));
      } else {
         $$1.d = null;
      }
      ...
      $$1.e = $$5 == cmq.d || $$5 == cmq.e;
      $$1.f = $$5.a();
      iu $$6 = $$0.dV().a(egg.a.f, ejl.a($$0.j()));
      $$1.g = $$6.b($$0.dt());
      $$1.h = $$0.eH() ? 0.0F : $$2;
      $$1.i.a($$0.b);
   }

   protected boolean a(cma $$0) {
      return false;
   }
}
