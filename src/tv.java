...
public abstract class tv {
   ...
   private static tv c() {
      ...
      return new tv() {
         ...
         @Override
         public axz a(xd $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> azi.c($$2xxx, $$1x, $$1) ? Optional.empty() : xd.a, xv.a).isPresent();
         }
      };
   }
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(ayd.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract axz a(xd var1);

   public List<axz> a(List<xd> $$0) {
