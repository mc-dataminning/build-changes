...
public record tv<S>(List<tv.a<S>> a) {
   public static <S> tv<S> a(ParseResults<S> $$0) {
   ...
   private static <S> List<tv.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<tv.a<S>> $$2 = new ArrayList<>();
