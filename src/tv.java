...
public class tv extends MessageToMessageDecoder<wk<?>> {
   @Nullable
   private wj.a a;
   @Nullable
   private wj b;
   private final AttributeKey<? extends wj.b> c;

   public tv(AttributeKey<? extends wj.b> $$0) {
      this.c = $$0;
   }

   protected void a(ChannelHandlerContext $$0, wk<?> $$1, List<Object> $$2) throws Exception {
      wj.b $$3 = (wj.b)$$0.channel().attr(this.c).get();
      if ($$3 == null) {
