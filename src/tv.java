...
public abstract class tv {
   ...
   private static volatile tv e = c();
   ...
   private static tv c() {
      ...
      return new tv() {
         ...
         @Override
         public axl a(wz $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> ays.c($$2xxx, $$1x, $$1) ? Optional.empty() : wz.a, xr.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = tv.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(axp.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract axl a(wz var1);

   public List<axl> a(List<wz> $$0) {
