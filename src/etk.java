...
public class etk extends LongLinkedOpenHashSet {
   private final etk.a a;

   public etk(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new etk.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = bae.f(60000000);
      private static final int b = bae.f(60000000);
