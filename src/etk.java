...
public class etk extends gko {
   ...
   public void aN_() {
      this.a(this.C.a);
      this.d(exf.a(vf.c("mco.configure.world.subscription.extend"), $$0 -> fbs.a(this, atj.a(this.C.b, this.f.V().b()))).a(this.g / 2 - 100, g(6), 200, 20).a());
      if (this.C.j) {
         this.d(exf.a(vf.c("mco.configure.world.delete.button"), $$0 -> {
            vf $$1 = vf.c("mco.configure.world.delete.question.line1");
            vf $$2 = vf.c("mco.configure.world.delete.question.line2");
            this.f.a(new esw(this::c, esw.a.a, $$1, $$2, true));
         }).a(this.g / 2 - 100, g(10), 200, 20).a());
      } else if (eql.b() && this.C.s != null) {
         this.d(new exp(this.g / 2 - 100, g(8), 200, 46, vf.a("mco.snapshot.subscription.info", this.C.s), this.i).a(-6250336));
      } else {
         this.d(new exp(this.g / 2 - 100, g(8), 200, 46, A, this.i).a(-6250336));
      }

      this.d(exf.a(ve.k, $$0 -> this.aE_()).a(this.g / 2 - 100, g(12), 200, 20).a());
   }
         ...
         (new Thread("Realms-delete-realm") {
            ...
            public void run() {
               try {
                  ...
                  etk.a.error("Couldn't delete world", var2);
               }

               etk.this.f.execute(() -> etk.this.f.a(etk.this.D));
            }
         }).start();
      }
