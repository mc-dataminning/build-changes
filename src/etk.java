...
public class etk extends esm {
   ...
   public etk(esf $$0, int $$1, int $$2, int $$3, int $$4, tn $$5, tn $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new etn($$0, $$3 - this.b());
      this.o.a(this::w);
   }
   ...
   @Override
   public void a(ewk $$0) {
      $$0.a(ewj.a, tn.a("gui.narrate.editBox", this.m(), this.v()));
   }
   ...
   protected void a(esh $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         tn $$2 = tn.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void w() {
      double $$0 = this.c();
      etn.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         etn.a $$2 = this.o.c((int)(($$0 + (double)this.g) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
