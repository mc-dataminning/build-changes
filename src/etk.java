...
public abstract class etk<M extends eth<M>> {
   ...
   protected final Long2ObjectMap<dzu> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected etk(dhq $$0, eac $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dzu a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dzu a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dzu c(long $$0) {
      dzu $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected dzu g(long $$0) {
      dzu $$1 = (dzu)this.g.get($$0);
      return $$1 != null ? $$1 : new dzu();
   }
   ...
   protected void a(etn<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dzu>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dzu> $$6 = (Entry<dzu>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dzu $$8 = (dzu)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dzu $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
