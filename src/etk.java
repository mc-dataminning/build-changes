...
public class etk {
   ...
   public etk(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public etk(etp $$0, etp $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static etk a(egh $$0) {
      return new etk((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static etk a(etp $$0) {
      return new etk($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static etk a(in $$0, in $$1) {
      return new etk(
   ...
   public etk a(double $$0) {
      return new etk($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public etk b(double $$0) {
      return new etk(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public etk c(double $$0) {
      return new etk(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public etk d(double $$0) {
      return new etk(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public etk e(double $$0) {
      return new etk(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public etk f(double $$0) {
      return new etk(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public etk b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public etk c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public etk d(double $$0, double $$1, double $$2) {
      return new etk(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public etk f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public etk h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<etp> b(etp $$0, etp $$1) {
      double[] $$2 = new double[]{1.0};
      double $$3 = $$1.c - $$0.c;
      double $$4 = $$1.d - $$0.d;
      double $$5 = $$1.e - $$0.e;
      is $$6 = a(this, $$0, $$2, null, $$3, $$4, $$5);
      if ($$6 == null) {
   ...
   @Nullable
   public static etl a(Iterable<etk> $$0, etp $$1, etp $$2, in $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new etl($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static is a(etk $$0, etp $$1, double[] $$2, @Nullable is $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.a, $$0.b, $$0.e, $$0.c, $$0.f, is.e, $$1.c, $$1.d, $$1.e);
      } else if ($$4 < -1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.d, $$0.b, $$0.e, $$0.c, $$0.f, is.f, $$1.c, $$1.d, $$1.e);
      }

      if ($$5 > 1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.b, $$0.c, $$0.f, $$0.a, $$0.d, is.a, $$1.d, $$1.e, $$1.c);
      } else if ($$5 < -1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.e, $$0.c, $$0.f, $$0.a, $$0.d, is.b, $$1.d, $$1.e, $$1.c);
      }

      if ($$6 > 1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.c, $$0.a, $$0.d, $$0.b, $$0.e, is.c, $$1.e, $$1.c, $$1.d);
      } else if ($$6 < -1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.f, $$0.a, $$0.d, $$0.b, $$0.e, is.d, $$1.e, $$1.c, $$1.d);
      }
   ...
   public etp f() {
      return new etp(axz.d(0.5, this.a, this.d), axz.d(0.5, this.b, this.e), axz.d(0.5, this.c, this.f));
   }

   public static etk a(etp $$0, double $$1, double $$2, double $$3) {
      return new etk($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
