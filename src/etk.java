...
public class etk extends gkn {
   ...
   public void aN_() {
      int $$0 = this.g / 4 - 2;
      this.d(exe.a(vf.c("mco.terms.buttons.agree"), $$0x -> this.C()).a(this.g / 4, g(12), $$0, 20).a());
      this.d(exe.a(vf.c("mco.terms.buttons.disagree"), $$0x -> this.f.a(this.w)).a(this.g / 2 + 4, g(12), $$0, 20).a());
   }
   ...
   private void C() {
      ...
      try {
         $$0.j();
         this.f.a(new esw(this.w, new euf(this.w, this.x)));
      } catch (esc var3) {
