...
public class dma extends dko<dno> {
   ...
   private static boolean d(cms $$0, gu $$1) {
      return $$0.a($$1, $$0x -> $$0x.a(cpo.ff));
   }

   public static boolean b(cms $$0, gu $$1) {
      return $$0.a($$1, $$0x -> $$0x.i() || $$0x.a(amw.O));
   }
   ...
   public static boolean c(cms $$0, gu $$1) {
      return $$0.a($$1, $$0x -> $$0x.i() || $$0x.a(amw.cd));
   }

   private boolean a(cng $$0, apf $$1, gu $$2, BiConsumer<gu, dcb> $$3, BiConsumer<gu, dcb> $$4, doe.b $$5, dno $$6) {
      int $$7 = $$6.d.a($$1);
      int $$8 = $$6.f.a($$1, $$7, $$6);
      int $$9 = $$7 - $$8;
      int $$10 = $$6.f.a($$1, $$9);
      ...
      if ($$12 >= $$0.C_() + 1 && $$13 <= $$0.aj()) {
         ...
         if ($$15 >= $$7 || !$$14.isEmpty() && $$15 >= $$14.getAsInt()) {
            if ($$6.g.isPresent() && !$$6.g.get().a($$0, $$3, $$1, $$2, $$11, $$6)) {
               ...
               List<doe.a> $$16 = $$6.d.a($$0, $$4, $$1, $$15, $$11, $$6);
   ...
   public final boolean a(dkq<dno> $$0) {
      ...
      BiConsumer<gu, dcb> $$9 = ($$2x, $$3x) -> {
         $$5.add($$2x.i());
         $$1.a($$2x, $$3x, 19);
      };
      BiConsumer<gu, dcb> $$10 = ($$2x, $$3x) -> {
         $$6.add($$2x.i());
         $$1.a($$2x, $$3x, 19);
      };
      doe.b $$11 = new doe.b() {
         @Override
         public void a(gu $$0, dcb $$1x) {
            $$7.add($$0.i());
            $$1.a($$0, $$1, 19);
         }
      ...
      if ($$13 && (!$$6.isEmpty() || !$$7.isEmpty())) {
         if (!$$4.i.isEmpty()) {
            dpk.a $$14 = new dpk.a($$1, $$12, $$2, $$6, $$7, $$5);
            $$4.i.forEach($$1x -> $$1x.a($$14));
         }

         return drs.a(Iterables.concat($$5, $$6, $$7, $$8)).map($$4x -> {
            eer $$5x = a($$1, $$4x, $$6, $$8, $$5);
            dvt.a($$1, 3, $$5x, $$4x.g(), $$4x.h(), $$4x.i());
            return true;
         }).orElse(false);
      } else {
         return false;
      ...
      while (true) {
         while ($$11 >= 7 || !$$7.get($$11).isEmpty()) {
            ...
            if ($$1.b($$13)) {
               if ($$11 != 0) {
                  dcb $$14 = $$0.a_($$13);
                  b($$0, $$13, $$14.a(dcr.aC, Integer.valueOf($$11)));
               }
