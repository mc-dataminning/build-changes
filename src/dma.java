...
public class dma<T> implements dmc<T> {
   ...
   private dma(im<T> $$0, int $$1, dmd<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dma(im<T> $$0, T[] $$1, dmd<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dmc<T> c() {
      return new dma<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
