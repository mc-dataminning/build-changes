...
public class bxi extends bxl {
   ...
   public bxi(bqq $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean a() {
      List<bqq> $$0 = this.a.dM().a(bqq.class, this.a.cH().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (bqq $$1 : $$0) {
            if (!$$1.ce()) {
               this.c = $$1;
