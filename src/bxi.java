...
public class bxi {
   ...
   public static bvl<bua> a(float $$0) {
      Long2LongMap $$1 = new Long2LongOpenHashMap();
      MutableLong $$2 = new MutableLong(0L);
      return byx.a(
         (Function<byx.b<bua>, ? extends App<byx.c<bua>, bza<bua>>>)($$3 -> $$3.group($$3.c(ccv.m), $$3.c(ccv.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.Z() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cev $$7 = $$4x.y();
                        Optional<iz> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cez.n), $$5.dp(), 48, cev.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dp()) <= 4.0)) {
                           ...
                           Set<Pair<ji<cey>, iz>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cez.n), $$10, $$5.dp(), 48, cev.b.c).collect(Collectors.toSet());
                           eol $$12 = bvd.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              iz $$13 = $$12.l();
                              Optional<ji<cey>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new ccy($$13, $$0, 1));
                                 agt.c($$4x, $$13);
                              }
