...
public class fou {
   ...
   private int m;
   private boolean n;
   private final List<fou.a> o = new ArrayList<>();
   ...
   public void a(foe $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
   ...
   private void a(foe $$0, int $$1, int $$2, fld.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }
   ...
   public void a(wp $$0, @Nullable xb $$1, @Nullable fld $$2) {
   ...
   private void b(flc $$0) {
      ...
      List<ayl> $$3 = foy.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
   ...
   public boolean e() {
      return this.i.z instanceof fth;
   }
   ...
   public fou.b k() {
      return new fou.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fou.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<flc> $$0, List<String> $$1, List<fou.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
