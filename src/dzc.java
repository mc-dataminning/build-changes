...
public class dzc {
   ...
   private final dcf p;
   private static final List<dff> q = List.of(dfh.l, dfh.L, dfh.i, dfh.b, dfh.k, dfh.I, dfh.K, dfh.fl, dfh.dP, dfh.iA, dfh.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<jj<ddd>>> t;
   ...
   public static final Codec<dzc> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   private dzc(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<jj<ddd>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kc.c($$0);
      int $$5 = kc.c($$1) - $$4;
   ...
   @Nullable
   public static dzc a(aqr $$0, int $$1, int $$2) {
      dud $$3 = $$0.a($$1, $$2);
      dzc $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dvc.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jg> a(dcz $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dud $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, aye.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dud $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dxz.a.a)) {
         $$3 = Math.min($$0.a(dxz.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }
   ...
   private static double a(dud $$0, ja.a $$1) {
      return a($$0, (ja)$$1.c(jf.a)) ? 1.0 : -1.0;
   }

   private static double b(dud $$0, ja.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dud $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jj<ddd>> b(dud $$0, int $$1, int $$2) {
      ObjectArrayList<jj<ddd>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dud $$0, ja $$1) {
      dsh $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(avu.O)) {
         ...
         return $$2.a(dfh.eT) || $$2.a(dfh.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dzc.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dzc.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, jj<ddd> var3);
   }
