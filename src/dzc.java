...
public class dzc extends dzh {
   public static final Codec<dzc> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, dzc::new));
   ...
   public List<dxp.a> a(cvx $$0, BiConsumer<hz, dlj> $$1, awp $$2, int $$3, hz $$4, dwz $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = awi.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, awi.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<dzc.a> $$13 = Lists.newArrayList();
      $$13.add(new dzc.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               hz $$21 = $$4.b(awi.a($$19), $$12 - 1, awi.a($$20));
               hz $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  hz $$27 = new hz($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new dzc.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<dxp.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(cvx $$0, BiConsumer<hz, dlj> $$1, awp $$2, hz $$3, hz $$4, boolean $$5, dwz $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         hz $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            hz $$13 = $$3.b(awi.d(0.5F + (float)$$12 * $$9), awi.d(0.5F + (float)$$12 * $$10), awi.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dfd.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(cvx $$0, BiConsumer<hz, dlj> $$1, awp $$2, int $$3, hz $$4, List<dzc.a> $$5, dwz $$6) {
      for (dzc.a $$7 : $$5) {
         int $$8 = $$7.a();
         hz $$9 = new hz($$4.u(), $$8, $$4.w());
