...
public class dzc extends dys {
   ...
   public dzc(ard $$0, dzm $$1, @Nullable dzc.c $$2) {
   ...
   @Override
   public ebw a(int $$0) {
      return this.r instanceof ard $$1 ? (ebw)this.u.computeIfAbsent($$0, $$2 -> new ebs($$1, $$0, this::i)) : super.a($$0);
   }
   ...
   boolean h(ji $$0) {
      if (!this.r.F_().a($$0)) {
         ...
         return !(this.r instanceof ard $$1) ? true : this.F().a(aqs.c) && $$1.c(dfo.a($$0));
      }
   }
   ...
   private <T extends dtz> void a(T $$0, ard $$1) {
      djm $$2 = $$0.m().b();
      if ($$2 instanceof dmf) {
         ebv $$3 = ((dmf)$$2).a($$1, $$0);
         if ($$3 != null) {
   ...
   private <T extends dtz> void b(T $$0, ard $$1) {
      djm $$2 = $$0.m().b();
      if ($$2 instanceof dmf) {
         ebv $$3 = ((dmf)$$2).a($$1, $$0);
         if ($$3 != null) {
