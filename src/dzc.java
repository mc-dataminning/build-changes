...
public class dzc implements dkb.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<dzc> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final arj<dzc> a = arj.a(f);
   private final dzg g;
   private final dzg h;
   private final dzg i;
   ...
   public static dzc a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new dzc(new dlj(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private dzc(dzg $$0, dzg $$1, dzg $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public dzc(aru $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         dzg.a($$0, IntStream.rangeClosed(-15, 0)),
         dzg.a($$0, IntStream.rangeClosed(-15, 0)),
         dzg.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public dzc a(aru $$0) {
      return new dzc($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dkb.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         dzd $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(dzg.b($$4 * $$13), dzg.b($$5 * $$13), dzg.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = dzg.b($$1 * $$13);
         double $$21 = dzg.b($$2 * $$13);
         double $$22 = dzg.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            dzd $$24 = this.g.a($$19);
            if ($$24 != null) {
