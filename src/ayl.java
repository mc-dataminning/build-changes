...
public interface ayl {
   ...
   static ayl codepoint(int $$0, xm $$1) {
      return $$2 -> $$2.accept(0, $$1, $$0);
   }

   static ayl forward(String $$0, xm $$1) {
      return $$0.isEmpty() ? a : $$2 -> azu.a($$0, $$1, $$2);
   }

   static ayl forward(String $$0, xm $$1, Int2IntFunction $$2) {
      return $$0.isEmpty() ? a : $$3 -> azu.a($$0, $$1, decorateOutput($$3, $$2));
   }

   static ayl backward(String $$0, xm $$1) {
      return $$0.isEmpty() ? a : $$2 -> azu.b($$0, $$1, $$2);
   }

   static ayl backward(String $$0, xm $$1, Int2IntFunction $$2) {
