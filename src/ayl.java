...
public class ayl {
   ...
   ayl(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static ayl.a a() {
      return new ayl.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(ayl::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public ayl.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public ayl a(Writer $$0) throws IOException {
         return new ayl($$0, this.a);
      }
   }
}
