...
public class ayl {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, d, $$0 -> axn.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayl.c> r = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alb.d($$0.substring(1)).map($$0x -> new ayl.c($$0x, true)) : alb.d($$0).map($$0x -> new ayl.c($$0x, false)), ayl.c::c
      );
   ...
   public static final Codec<String> w = Codec.string(0, 16)
      .validate($$0 -> azz.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   private static final MapCodec<GameProfile> C = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(kh.e.fieldOf("id").forGetter(GameProfile::getId), w.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   ...
   public static Codec<String> A = Codec.STRING
      .validate($$0 -> !alb.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ayl.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
   ...
   public static record c(alb a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
