...
public class ayl extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bdt.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bdt.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bdt.s);
