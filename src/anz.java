...
public abstract class anz implements xq {
   private static final Logger d = LogUtils.getLogger();
   public static final int a = 15000;
   private static final vf e = vf.c("disconnect.timeout");
   ...
   public anz(MinecraftServer $$0, ug $$1, ans $$2) {
      this.b = $$0;
      this.c = $$1;
      this.f = ac.b();
      this.i = $$2.b();
   ...
   public void a(xv $$0) {
      xh.a($$0, this, this.b);
      if ($$0.d() == xv.a.b && this.b.V()) {
         d.info("Disconnecting {} due to resource pack {} rejection", this.j().getName(), $$0.a());
         this.b(vf.c("multiplayer.requiredTexturePrompt.disconnect"));
      }
   }
   ...
   public void b(vf $$0) {
      this.c.a(new xk($$0), up.a(() -> this.c.a($$0)));
      this.c.o();
      this.b.h(this.c::p);
   }
   ...
   protected ans a(ams $$0) {
      return new ans(this.j(), this.i, $$0);
   }
}
