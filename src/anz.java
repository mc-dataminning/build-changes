...
public class anz {
   ...
   private static ArgumentBuilder<ee, ?> a(ea $$0, ArgumentBuilder<ee, ?> $$1, anz.a $$2) {
   ...
   private static CompletableFuture<Suggestions> a(ee $$0, Collection<evn> $$1, SuggestionsBuilder $$2) {
   ...
   private static int a(ee $$0, evn $$1, evg $$2) throws CommandSyntaxException {
      evo $$3 = $$0.l().aK();
      evk $$4 = $$3.d($$1, $$2);
      if ($$4 == null) {
   ...
   private static int a(ee $$0, Collection<evn> $$1, evg $$2, fa.a $$3, Collection<evn> $$4, evg $$5) throws CommandSyntaxException {
      evo $$6 = $$0.l().aK();
      int $$7 = 0;
   ...
   private static int a(ee $$0, Collection<evn> $$1, evg $$2) throws CommandSyntaxException {
      if ($$2.c() != evr.c) {
         throw e.create();
      } else {
         evo $$3 = $$0.l().aK();
   ...
   private static int b(ee $$0, Collection<evn> $$1, evg $$2) {
      evo $$3 = $$0.l().aK();
   ...
   private static int a(ee $$0, Collection<evn> $$1, evg $$2, int $$3) {
      evo $$4 = $$0.l().aK();
   ...
   private static int a(ee $$0, Collection<evn> $$1, evg $$2, @Nullable wx $$3) {
      evo $$4 = $$0.l().aK();
   ...
   private static int a(ee $$0, Collection<evn> $$1, evg $$2, @Nullable yn $$3) {
      evo $$4 = $$0.l().aK();
   ...
   private static int b(ee $$0, Collection<evn> $$1, evg $$2, int $$3) {
      evo $$4 = $$0.l().aK();
      int $$5 = 0;
   ...
   private static int c(ee $$0, Collection<evn> $$1, evg $$2, int $$3) {
      evo $$4 = $$0.l().aK();
      int $$5 = 0;
   ...
   private static int a(ee $$0) {
      Collection<evn> $$1 = $$0.l().aK().e();
      if ($$1.isEmpty()) {
         $$0.a(() -> wx.c("commands.scoreboard.players.list.empty"), false);
      } else {
         $$0.a(() -> wx.a("commands.scoreboard.players.list.success", $$1.size(), xa.b($$1, evn::hd)), false);
      }

      return $$1.size();
   }

   private static int a(ee $$0, evn $$1) {
      Object2IntMap<evg> $$2 = $$0.l().aK().c($$1);
      if ($$2.isEmpty()) {
         ...
         Object2IntMaps.fastForEach(
            $$2, $$1x -> $$0.a(() -> wx.a("commands.scoreboard.players.list.entity.entry", ((evg)$$1x.getKey()).g(), $$1x.getIntValue()), false)
         );
      }
   ...
   private static int a(ee $$0, evf $$1) throws CommandSyntaxException {
      evo $$2 = $$0.l().aK();
      if ($$2.a($$1) == null) {
         throw b.create();
      } else {
   ...
   private static int a(ee $$0, evf $$1, evg $$2) throws CommandSyntaxException {
      evo $$3 = $$0.l().aK();
      if ($$3.a($$1) == $$2) {
         throw c.create();
      } else {
   ...
   private static int a(ee $$0, evg $$1, wx $$2) {
      if (!$$1.d().equals($$2)) {
         $$1.a($$2);
   ...
   private static int a(ee $$0, evg $$1, boolean $$2) {
      if ($$1.e() != $$2) {
         $$1.a($$2);
         if ($$2) {
   ...
   private static int a(ee $$0, evg $$1, @Nullable yn $$2) {
      $$1.b($$2);
      if ($$2 != null) {
   ...
   private static int a(ee $$0, evg $$1, evr.a $$2) {
      if ($$1.h() != $$2) {
         $$1.a($$2);
   ...
   private static int a(ee $$0, evg $$1) {
      evo $$2 = $$0.l().aK();
      $$2.j($$1);
   ...
   private static int a(ee $$0, String $$1, evr $$2, wx $$3) throws CommandSyntaxException {
      evo $$4 = $$0.l().aK();
      if ($$4.a($$1) != null) {
         throw a.create();
      } else {
   ...
   private static int b(ee $$0) {
      Collection<evg> $$1 = $$0.l().aK().c();
      if ($$1.isEmpty()) {
         $$0.a(() -> wx.c("commands.scoreboard.objectives.list.empty"), false);
      } else {
         $$0.a(() -> wx.a("commands.scoreboard.objectives.list.success", $$1.size(), xa.b($$1, evg::g)), false);
      }
