...
public class anz {
   ...
   private static void a(aod $$0, ane $$1, dlw $$2) {
      $$0.b(new aal($$2, $$1.z_(), null, null));
      cte $$3 = $$2.f();
      adj.a($$1, $$3);
   }

   private List<dlw> a(amo $$0, cte $$1) {
      int $$2 = aup.d(this.i);
      List<dlw> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : aup.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
