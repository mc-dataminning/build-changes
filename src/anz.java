...
public class anz {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, anz.a<T> $$3) throws aoa {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws aoa {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", anz::b);
   }

   public static PublicKey b(String $$0) throws aoa {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", anz::a);
   }
   ...
   interface a<T extends Key> {
      T apply(byte[] var1) throws aoa;
   }

   public static record b(long b, byte[] c) {
      public static final anz.b a = new anz.b(0L, ByteArrays.EMPTY_ARRAY);
      ...
      public static void a(sf $$0, anz.b $$1) {
         $$0.writeLong($$1.b);
         $$0.a($$1.c);
      }
