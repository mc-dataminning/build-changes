...
public class fjh {
   ...
   private void a(n $$0, xi $$1) {
      this.b.m.d().a(xi.i().b(xi.c("debug.prefix").a($$0, n.r)).b(xh.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(xi.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.l(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dey)MoreObjects.firstNonNull(this.b.r.i(), dey.b)).b());
               }
            ...
            case 81:
               ...
               fli $$3 = this.b.m.d();
               $$3.a(xi.c("debug.reload_chunks.help"));
               $$3.a(xi.c("debug.show_hitboxes.help"));
               $$3.a(xi.c("debug.copy_location.help"));
               $$3.a(xi.c("debug.clear_chat.help"));
               $$3.a(xi.c("debug.chunk_boundaries.help"));
               $$3.a(xi.c("debug.advanced_tooltips.help"));
               $$3.a(xi.c("debug.inspect.help"));
               $$3.a(xi.c("debug.profiling.help"));
               $$3.a(xi.c("debug.creative_spectator.help"));
               $$3.a(xi.c("debug.pause_focus.help"));
               $$3.a(xi.c("debug.help.help"));
               $$3.a(xi.c("debug.dump_dynamic_textures.help"));
               $$3.a(xi.c("debug.reload_resourcepacks.help"));
               $$3.a(xi.c("debug.pause.help"));
               $$3.a(xi.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.q.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.aa().a($$5);
               xi $$6 = xi.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new xg(xg.a.b, $$5.toFile().toString())));
   ...
   private void a(dvj $$0, jh $$1, @Nullable uk $$2) {
   ...
   private void a(ali $$0, ezn $$1, @Nullable uk $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().b();
         boolean $$5 = fcw.a(fji.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!fcw.a(fji.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (fcw.a(fji.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = ae.c();
            this.e = ae.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof fuk) || ((fuk)$$6).u <= ae.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               fjr.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aL_() instanceof flq) || !((flq)$$6.aL_()).c();
            if ($$7) {
               if (fra.s() && $$1 == 66 && this.b.aZ().a() && this.b.n.v().c()) {
                  boolean $$8 = this.b.n.au().c() == fjk.a;
                  this.b.n.au().a(fjk.a(this.b.n.au().c().a() + 1));
                  this.b.n.ay();
                  if ($$6 != null) {
                     $$6.e($$8);
                  }
         ...
         label180: {
            ...
            label141:
            if (!$$11) {
               if (this.b.z instanceof fqv $$12 && !$$12.m()) {
                  break label141;
               }
      ...
      if ($$0 == this.b.aO().h()) {
         ...
         if ($$3 != null && this.b.aM() == null) {
            if (Character.charCount($$1) == 1) {
               fra.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fra.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
