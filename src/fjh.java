...
public class fjh {
   ...
   private fjh(int $$0, List<fjj> $$1) {
      this.a = $$1.toArray(fjj[]::new);
      this.b = $$1.size();
   }

   private List<fjj> c() {
      List<fjj> $$0 = new ArrayList<>(this.d());
