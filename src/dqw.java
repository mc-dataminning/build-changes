...
public class dqw extends dph {
   ...
   protected void a(us $$0, jk.a $$1) {
      ...
      try {
         this.k = dlm.valueOf($$0.l("rotation"));
      } catch (IllegalArgumentException var12) {
         this.k = dlm.a;
      }

      try {
         this.j = djw.valueOf($$0.l("mirror"));
      } catch (IllegalArgumentException var11) {
         this.j = djw.a;
      }

      try {
         this.l = dtm.valueOf($$0.l("mode"));
   ...
   public void a(dtm $$0) {
      this.l = $$0;
      dsc $$1 = this.n.a_(this.ay_());
      if ($$1.a(dfb.pa)) {
         this.n.a(this.ay_(), $$1.a(dmx.b, $$0), 2);
      }
   }
   ...
   private Stream<iz> a(iz $$0, iz $$1) {
      return iz.d($$0, $$1)
         .filter($$0x -> this.n.a_($$0x).a(dfb.pa))
         .map(this.n::c_)
         .filter($$0x -> $$0x instanceof dqw)
         .map($$0x -> (dqw)$$0x)
         .filter($$0x -> $$0x.l == dtm.c && Objects.equals(this.e, $$0x.e))
         .map(dph::ay_);
   }

   private static Optional<eic> a(iz $$0, Stream<iz> $$1) {
   ...
   public boolean A() {
      return this.l != dtm.a ? false : this.b(true);
   }
   ...
   public boolean b(boolean $$0) {
      if (this.e == null) {
         ...
         $$4.a(this.n, $$1, this.i, !this.m, dfb.kN);
         $$4.a(this.f);
         if ($$0) {
            try {
               return $$3.c(this.e);
   ...
   public boolean a(arf $$0) {
      if (this.l == dtm.b && this.e != null) {
         emk $$1 = $$0.q().b(this.e).orElse(null);
         if ($$1 == null) {
            return false;
   ...
   private void a(arf $$0, emk $$1) {
      this.a($$1);
      emg $$2 = new emg().a(this.j).a(this.k).a(this.m);
      if (this.t < 1.0F) {
         $$2.b().a(new elo(ayz.a(this.t, 0.0F, 1.0F))).a(b(this.u));
      }
   ...
   public boolean C() {
      if (this.l == dtm.b && !this.n.B && this.e != null) {
         arf $$0 = (arf)this.n;
         eml $$1 = $$0.q();
