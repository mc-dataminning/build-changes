...
public class ew<T> implements ArgumentType<ew.c<T>> {
   ...
   private static final Dynamic2CommandExceptionType b = new Dynamic2CommandExceptionType(($$0, $$1) -> wg.b("argument.resource_tag.not_found", $$0, $$1));
   private static final Dynamic3CommandExceptionType c = new Dynamic3CommandExceptionType(
      ($$0, $$1, $$2) -> wg.b("argument.resource_tag.invalid_type", $$0, $$1, $$2)
   );
   private final in<T> d;
   final ajs<? extends iy<T>> e;

   public ew(dq $$0, ajs<? extends iy<T>> $$1) {
      this.e = $$1;
      this.d = $$0.b($$1);
   }

   public static <T> ew<T> a(dq $$0, ajs<? extends iy<T>> $$1) {
      return new ew<>($$0, $$1);
   }

   public static <T> ew.c<T> a(CommandContext<du> $$0, String $$1, ajs<iy<T>> $$2) throws CommandSyntaxException {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      dz.a(this.d.e().map(avr::b), $$1, "#");
      return dz.a(this.d.c().map(ajs::a), $$1);
   }
   ...
   public static class a<T> implements hn<ew<T>, ew.a<T>.a> {
      public void a(ew.a<T>.a $$0, vg $$1) {
         $$1.b($$0.b);
      }

      public ew.a<T>.a a(vg $$0) {
   ...
   static record b<T>(il.c<T> a) implements ew.c<T> {
      ...
      @Override
      public <E> Optional<ew.c<E>> a(ajs<? extends iy<E>> $$0) {
   ...
   public interface c<T> extends Predicate<il<T>> {
      ...
      <E> Optional<ew.c<E>> a(ajs<? extends iy<E>> var1);
