...
public class ew implements ey<ew>, fb {
   ...
   public ew(ev $$0, fbs $$1, fbr $$2, ash $$3, int $$4, String $$5, xv $$6, MinecraftServer $$7, @Nullable bvf $$8) {
   ...
   public bvf g() throws CommandSyntaxException {
      if (this.k == null) {
         throw b.create();
      } else {
         return this.k;
   ...
   private void c(xv $$0) {
      ...
      if (this.c != this.i && this.i.aL().b(dgw.m)) {
         this.i.a($$1);
      }
   }
