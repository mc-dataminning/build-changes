...
public class ew implements ArgumentType<Integer> {
   private static final Collection<String> a = Arrays.asList("container.5", "12", "weapon");
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tf.a("slot.unknown", $$0));
   private static final Map<String, Integer> c = ac.a(Maps.newHashMap(), $$0 -> {
      ...
      $$0.put("weapon", bin.a.a(98));
      $$0.put("weapon.mainhand", bin.a.a(98));
      $$0.put("weapon.offhand", bin.b.a(98));
      $$0.put("armor.head", bin.f.a(100));
      $$0.put("armor.chest", bin.e.a(100));
      $$0.put("armor.legs", bin.d.a(100));
      $$0.put("armor.feet", bin.c.a(100));
