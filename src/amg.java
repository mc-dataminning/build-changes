   ...
   private static int a(du $$0, int $$1, boolean $$2) {
      ...
      for (int $$11 = $$7; $$11 <= $$8; $$11++) {
         for (int $$12 = $$9; $$12 <= $$10; $$12++) {
            cvl $$13 = new cvl($$12, $$11);
            dol $$14 = $$4.a($$12, $$11, false);
            if ($$14 != null && (!$$2 || !$$14.s())) {
               for (ib $$15 : ib.b($$13.d(), $$3.J_(), $$13.e(), $$13.f(), $$3.ak() - 1, $$13.g())) {
                  $$3.a($$15, czh.a.o(), 16);
               }
            }
         }
      ...
      ble<Runnable> $$16 = ble.a(ac.f(), "worldgen-resetchunks");
      long $$17 = System.currentTimeMillis();
      int $$18 = ($$1 * 2 + 1) * ($$1 * 2 + 1);
      UnmodifiableIterator var33 = ImmutableList.of(dof.f, dof.g, dof.h, dof.i, dof.j, dof.k).iterator();

      while (var33.hasNext()) {
         dof $$19 = (dof)var33.next();
         ...
         for (int $$22 = $$6.f - $$1; $$22 <= $$6.f + $$1; $$22++) {
            for (int $$23 = $$6.e - $$1; $$23 <= $$6.e + $$1; $$23++) {
               cvl $$24 = new cvl($$23, $$22);
               dol $$25 = $$4.a($$23, $$22, false);
               if ($$25 != null && (!$$2 || !$$25.s())) {
                  List<doa> $$26 = Lists.newArrayList();
                  int $$27 = Math.max(1, $$19.e());

                  for (int $$28 = $$24.f - $$27; $$28 <= $$24.f + $$27; $$28++) {
                     for (int $$29 = $$24.e - $$27; $$29 <= $$24.e + $$27; $$29++) {
                        doa $$30 = $$4.a($$29, $$28, $$19.d(), true);
                        doa $$31;
                        if ($$30 instanceof dok) {
                           $$31 = new dok(((dok)$$30).C(), true);
                        } else if ($$30 instanceof dol) {
                           $$31 = new dok((dol)$$30, true);
                        } else {
                           $$31 = $$30;
                        }
                  ...
                  $$21 = $$21.thenComposeAsync($$5x -> $$19.a($$16::a, $$3, $$4.g(), $$3.q(), $$4.a(), $$0xx -> {
                        ...
                        if ($$19 == dof.g) {
                           $$1xx.left().ifPresent($$0xxx -> drq.a($$0xxx, dof.b));
                        }
      ...
      for (int $$35 = $$6.f - $$1; $$35 <= $$6.f + $$1; $$35++) {
         for (int $$36 = $$6.e - $$1; $$36 <= $$6.e + $$1; $$36++) {
            cvl $$37 = new cvl($$36, $$35);
            dol $$38 = $$4.a($$36, $$35, false);
            if ($$38 != null && (!$$2 || !$$38.s())) {
               for (ib $$39 : ib.b($$37.d(), $$3.J_(), $$37.e(), $$37.f(), $$3.ak() - 1, $$37.g())) {
                  $$4.a($$39);
               }
            }
         }
