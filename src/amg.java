...
public class amg implements amk {
   private final amk c;
   private final List<amk> d;

   public amg(amk $$0, List<amk> $$1) {
      this.c = $$0;
      List<amk> $$2 = new ArrayList<>($$1.size() + 1);
   ...
   public void a(aml $$0, String $$1, String $$2, amk.a $$3) {
      Map<aez, ano<InputStream>> $$4 = new HashMap<>();
