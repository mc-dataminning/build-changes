...
public class dwy<T> implements dxa<T> {
   ...
   private dwy(js<T> $$0, int $$1, dxb<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dwy(js<T> $$0, T[] $$1, dxb<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dxa<T> a(dxb<T> $$0) {
      return new dwy<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
