...
public class dwy {
   ...
   static Codec<dwy> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               cxk.b.listOf().lenientOptionalFieldOf("items_to_eject", List.of()).forGetter($$0x -> $$0x.g),
   ...
   private long f;
   private final List<cxk> g = new ObjectArrayList();
   private long h;
   private int i;
   boolean c;

   dwy(Set<UUID> $$0, long $$1, List<cxk> $$2, int $$3) {
      this.e.addAll($$0);
      this.f = $$1;
      this.g.addAll($$2);
      this.i = $$3;
   ...
   cxk f() {
      return this.g.isEmpty() ? cxk.k : Objects.requireNonNullElse(this.g.get(this.g.size() - 1), cxk.k);
   }
   ...
   cxk g() {
      if (this.g.isEmpty()) {
         ...
         this.i();
         return Objects.requireNonNullElse(this.g.remove(this.g.size() - 1), cxk.k);
      }
   }
