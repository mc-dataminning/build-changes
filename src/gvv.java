...
public class gvv implements gvq.a {
   private final fqq a;
   ...
   public void a(fld $$0, grn $$1, double $$2, double $$3, double $$4) {
      ...
      for (iw $$8 : iw.c($$6.b(-10, -10, -10), $$6.b(10, 10, 10))) {
         ...
         int $$11 = azz.g($$10, 0.9F, 0.9F);
         long $$12 = jz.e($$8.a());
         if ($$7.add($$12)) {
            gvq.a(
               $$0,
               $$1,
               $$5.S().q().a(dks.a, jz.a($$12)),
         ...
         if ($$9 != 15) {
            gvq.a($$0, $$1, String.valueOf($$9), (double)$$8.u() + 0.5, (double)$$8.v() + 0.25, (double)$$8.w() + 0.5, $$11);
         }
      }
   }
}
