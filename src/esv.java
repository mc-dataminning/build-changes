...
public class esv {
   ...
   public void a(etf $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == etf.a) {
            exg.b($$1, exg.a.b, ur.c("narrator.toast.disabled"), null);
         } else {
            exg.b($$1, exg.a.b, ur.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         exg.b($$1, exg.a.b, ur.c("narrator.toast.disabled"), ur.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new esv.a("Narrator library is not active");
      }
   }
