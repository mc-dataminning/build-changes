...
public class esv {
   ...
   public esv(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<esw> $$1) throws IOException {
   ...
   public List<esw> a(Path $$0) throws IOException {
      List<esw> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<esw> a(Path $$0, boolean $$1) throws IOException {
      List<esw> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<esw> $$1) throws IOException {
