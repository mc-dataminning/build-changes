...
public class frd implements fri.a {
   ...
   private final eqq A;
   private final Map<gw, frd.a> B = new HashMap<>();
   private final Map<UUID, vp.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   public void a(vz.a $$0, long $$1) {
      this.B.put($$0.a(), new frd.a($$0, $$1));
   }

   public void a(vp.a $$0) {
      this.C.put($$0.b(), $$0);
   }
   ...
   private void c() {
      long $$0 = this.A.r.V() - 20L;
      this.B.entrySet().removeIf($$1 -> $$1.getValue().b() < $$0);
   }

   private void a(elk $$0, fnz $$1) {
      gw $$2 = this.e().c();
      ...
      for (gw $$3 : this.B.keySet()) {
         if ($$2.a($$3, 30.0)) {
            a($$0, $$1, $$3);
         }
      }

      Map<gw, Set<UUID>> $$4 = this.d();
   ...
   private Map<gw, Set<UUID>> d() {
      Map<gw, Set<UUID>> $$0 = Maps.newHashMap();
      this.C.values().forEach($$1 -> $$1.j().forEach($$2 -> $$0.computeIfAbsent($$2, $$0xxx -> Sets.newHashSet()).add($$1.b())));
      return $$0;
   }

   private void b(elk $$0, fnz $$1) {
      Map<gw, Set<UUID>> $$2 = Maps.newHashMap();
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(aax::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         fri.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(aax::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(elk $$0, fnz $$1, gw $$2) {
      float $$3 = 0.05F;
      fri.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(elk $$0, fnz $$1, gw $$2, List<String> $$3) {
      float $$4 = 0.05F;
      fri.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(elk $$0, fnz $$1, vz.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(elk $$0, fnz $$1, vp.a $$2) {
      if ($$2.e() != null) {
         frq.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(elk $$0, fnz $$1, vp.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(elk $$0, fnz $$1, String $$2, vz.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(elk $$0, fnz $$1, String $$2, gw $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      fri.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(elk $$0, fnz $$1, hq $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      gw $$9 = gw.a($$2);
      ...
      float $$13 = 0.5F;
      fri.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(vz.a $$0) {
      return this.a($$0.a()).stream().map(aax::a).collect(Collectors.toSet());
   }

   private String a(vp.a $$0, gw $$1) {
      double $$2 = Math.sqrt($$1.b($$0.d()));
      double $$3 = (double)Math.round($$2 * 10.0) / 10.0;
      return $$1.x() + " (dist " + $$3 + ")";
   }

   private boolean b(vp.a $$0) {
      return Objects.equals(this.D, $$0.b());
   }

   private boolean c(vp.a $$0) {
      cbp $$1 = this.A.s;
      gw $$2 = gw.a($$1.dp(), $$0.d().b(), $$1.dv());
      gw $$3 = gw.a($$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(gw $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(vp.a::b).collect(Collectors.toSet());
   }

   private Map<gw, List<String>> f() {
      Map<gw, List<String>> $$0 = Maps.newHashMap();

      for (vp.a $$1 : this.C.values()) {
   ...
   private void g() {
      fri.a(this.A.am(), 8).ifPresent($$0 -> this.D = $$0.cv());
   }

   static record a(vz.a a, long b) {
   }
}
