...
public class frd implements fiv, fjo {
   ...
   private final List<frd.a> n = Lists.newArrayList();
   private boolean o;
   private int p;
   private int q;
   private fft r;
   ...
   public void a(fft $$0, fri $$1, int $$2, int $$3, int $$4, int $$5, float $$6) {
      this.r = $$0;
      this.s = $$1;
      if ($$0.s.cd instanceof cpi) {
         this.w = true;
      }

      boolean $$7 = $$0.s.m().a((cqv<?, ?>)$$0.s.cd);
      List<cyk<?>> $$8 = $$1.b(true);
      List<cyk<?>> $$9 = $$7 ? Collections.emptyList() : $$1.b(false);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         boolean $$21 = $$20 < $$10;
         cyk<?> $$22 = $$21 ? $$8.get($$20) : $$9.get($$20 - $$10);
         int $$23 = this.p + 4 + 25 * ($$20 % $$12);
         int $$24 = this.q + 5 + 25 * ($$20 / $$12);
         if (this.w) {
            this.n.add(new frd.b($$23, $$24, $$22, $$21));
         } else {
            this.n.add(new frd.a($$23, $$24, $$22, $$21));
         }
      }
   ...
   class a extends fhq implements ajx<cyf> {
      final cyk<?> c;
      private final boolean d;
      protected final List<frd.a.a> a = Lists.newArrayList();

      public a(final int $$0, final int $$1, final cyk<?> $$2, final boolean $$3) {
      ...
      public void a(cyf $$0, int $$1, int $$2, int $$3, int $$4) {
         cuc[] $$5 = $$0.a();
         if ($$5.length != 0) {
            this.a.add(new frd.a.a(3 + $$3 * 7, 3 + $$4 * 7, $$5));
         }
      }
      ...
      public void b(fhf $$0, int $$1, int $$2, float $$3) {
         ...
         if (this.d) {
            if (frd.this.w) {
               $$4 = this.B() ? frd.c : frd.d;
            } else {
               $$4 = this.B() ? frd.e : frd.f;
            }
         } else if (frd.this.w) {
            $$4 = this.B() ? frd.g : frd.h;
         } else {
            $$4 = this.B() ? frd.i : frd.j;
         }
         ...
         for (frd.a.a $$8 : this.a) {
            $$0.c().a();
            $$0.c().a((double)$$8.b, (double)$$8.c, 0.0);
            $$0.c().b(0.375F, 0.375F, 1.0F);
            $$0.c().a(-8.0, -8.0, 0.0);
            if ($$8.a.length > 0) {
               $$0.a($$8.a[ayg.d(frd.this.v / 30.0F) % $$8.a.length], 0, 0);
            }
      ...
      protected class a {
         ...
         public a(final int $$1, final int $$2, final cuc[] $$3) {
            this.b = $$1;
            this.c = $$2;
            this.a = $$3;
         }
   ...
   class b extends frd.a {
      public b(final int $$0, final int $$1, final cyk<?> $$2, final boolean $$3) {
         super($$0, $$1, $$2, $$3);
      }
      ...
      protected void a(cyk<?> $$0) {
         cyf $$1 = $$0.b().a().get(0);
         cuc[] $$2 = $$1.a();
         this.a.add(new frd.a.a(10, 10, $$2));
      }
   }
}
