...
public class bhz extends bgt {
   public bhz(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bhx.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bjl.a($$0.get("id").asString("minecraft:air"));
