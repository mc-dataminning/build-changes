...
public class bhz {
   ...
   private bhz(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bhz a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bhz($$0, $$1);
   }

   public bhz.d a() throws IOException {
      bhz.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bhz.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bhz.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bhz.c $$3 = bhz.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bhz.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bhz.a($$0, $$3);
            }
         }
   ...
   public bhz.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bhz.c> $$2 = this.a().c();
      ...
      bhz.e $$4 = new bhz.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bhz.c b) implements bhz.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bhz.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bhz.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bhz.b> {
      private final List<bhz.b> a;

      d(List<bhz.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bhz.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bhz.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bhz.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bhz.d a() {
         ListIterator<bhz.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bhz.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bhz.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bhz.b> b() {
         return this.a.stream();
      }

      public Set<bhz.c> c() {
         return this.a.stream().map(bhz.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bhz.c b) implements bhz.b {
