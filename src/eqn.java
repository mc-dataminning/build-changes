...
public class eqn {
   ...
   private static eqn.c a(eoo $$0, bam $$1, int $$2, int $$3, int $$4, @Nullable jm $$5, int $$6, eqo.a $$7) {
      int $$8 = $$1.a(100);
      if ($$8 >= 80) {
   ...
   static eqn.c a(eon $$0, eoo $$1, bam $$2, int $$3, int $$4, int $$5, jm $$6, int $$7) {
      if ($$7 > 8) {
         return null;
   ...
   public static class a extends eqn.c {
      ...
      public a(int $$0, bam $$1, eob $$2, jm $$3, eqo.a $$4) {
         super(epa.a, $$0, $$4, $$2);
         this.a($$3);
         this.b = $$1.a(3) == 0;
            ...
            switch ($$5) {
               ...
               default:
                  if ($$4 <= 1) {
                     ...
                     eqn.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() - 1 + $$2.a(3), this.f.j(), jm.e, $$3);
                  } else {
                     eqn.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() - 1 + $$2.a(3), this.f.j(), jm.f, $$3);
                  }
                  break;
               case d:
                  if ($$4 <= 1) {
                     ...
                     eqn.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() - 1 + $$2.a(3), this.f.m() - 3, jm.e, $$3);
                  } else {
                     eqn.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() - 1 + $$2.a(3), this.f.m() - 3, jm.f, $$3);
                  }
                  break;
               case e:
                  if ($$4 <= 1) {
                     ...
                     eqn.a($$0, $$1, $$2, this.f.h(), this.f.i() - 1 + $$2.a(3), this.f.j() - 1, jm.c, $$3);
                  } else {
                     eqn.a($$0, $$1, $$2, this.f.h(), this.f.i() - 1 + $$2.a(3), this.f.m() + 1, jm.d, $$3);
                  }
                  break;
               case f:
                  if ($$4 <= 1) {
                     ...
                     eqn.a($$0, $$1, $$2, this.f.k() - 3, this.f.i() - 1 + $$2.a(3), this.f.j() - 1, jm.c, $$3);
                  } else {
                     eqn.a($$0, $$1, $$2, this.f.k() - 3, this.f.i() - 1 + $$2.a(3), this.f.m() + 1, jm.d, $$3);
                  }
            }
         }
         ...
         if ($$3 < 8) {
            if ($$5 != jm.c && $$5 != jm.d) {
               for (int $$8 = this.f.h() + 3; $$8 + 3 <= this.f.k(); $$8 += 5) {
                  int $$9 = $$2.a(5);
                  if ($$9 == 0) {
                     eqn.a($$0, $$1, $$2, $$8, this.f.i(), this.f.j() - 1, jm.c, $$3 + 1);
                  } else if ($$9 == 1) {
                     eqn.a($$0, $$1, $$2, $$8, this.f.i(), this.f.m() + 1, jm.d, $$3 + 1);
                  }
               }
            } else {
               for (int $$6 = this.f.j() + 3; $$6 + 3 <= this.f.m(); $$6 += 5) {
                  int $$7 = $$2.a(5);
                  if ($$7 == 0) {
                     eqn.a($$0, $$1, $$2, this.f.h() - 1, this.f.i(), $$6, jm.e, $$3 + 1);
                  } else if ($$7 == 1) {
                     eqn.a($$0, $$1, $$2, this.f.k() + 1, this.f.i(), $$6, jm.f, $$3 + 1);
                  }
               }
            }
         }
      ...
      protected boolean a(dif $$0, eob $$1, bam $$2, int $$3, int $$4, int $$5, aly<ewt> $$6) {
         ...
         if ($$1.b($$7) && $$0.a_($$7).l() && !$$0.a_($$7.e()).l()) {
            dxu $$8 = dkn.cY.m().b(dqn.e, $$2.h() ? dyx.a : dyx.b);
            this.a($$0, $$8, $$3, $$4, $$5, $$1);
            cse $$9 = bvq.y.a($$0.a(), bvp.b);
            if ($$9 != null) {
      ...
      public void a(dif $$0, did $$1, dzq $$2, bam $$3, eob $$4, dgn $$5, jh $$6) {
         if (!this.a($$0, $$4)) {
            ...
            if (this.c) {
               this.a($$0, $$4, $$3, 0.6F, 0, 0, 0, 2, 1, $$11, dkn.bz.m(), e, false, true);
            }
            ...
            if (this.b) {
               dxu $$24 = dkn.cY.m().b(dqn.e, dyx.a);

               for (int $$25 = 0; $$25 <= $$11; $$25++) {
                  dxu $$26 = this.a($$0, 1, -1, $$25, $$4);
                  if (!$$26.l() && $$26.s()) {
      ...
      private void a(dif $$0, eob $$1, int $$2, int $$3, int $$4) {
         dxu $$5 = this.a.b();
         dxu $$6 = this.a.d();
      ...
      protected void c(dif $$0, dxu $$1, int $$2, int $$3, int $$4, eob $$5) {
         jh.a $$6 = this.b($$2, $$3, $$4);
         if ($$5.b($$6)) {
            int $$7 = $$6.v();
            int $$8 = 1;
            ...
            for (boolean $$10 = true; $$9 || $$10; $$8++) {
               if ($$9) {
                  $$6.q($$7 - $$8);
                  dxu $$11 = $$0.a_($$6);
                  boolean $$12 = this.a($$11) && !$$11.a(dkn.K);
                  if (!$$12 && this.a($$0, $$6, $$11)) {
                     a($$0, $$1, $$6, $$7 - $$8 + 1, $$7);
                     return;
                  }
      ...
      private static void a(dif $$0, dxu $$1, jh.a $$2, int $$3, int $$4) {
         for (int $$5 = $$3; $$5 < $$4; $$5++) {
            $$0.a($$2.q($$5), $$1, 2);
         }
      }

      private boolean a(dhk $$0, jh $$1, dxu $$2) {
         return $$2.c($$0, $$1, jm.b);
      }

      private boolean b(dhk $$0, jh $$1, dxu $$2) {
         return dkl.a($$0, $$1, jm.a) && !($$2.b() instanceof dni);
      }

      private void a(dif $$0, eob $$1, int $$2, int $$3, int $$4, int $$5, int $$6, bam $$7) {
         if (this.a($$0, $$1, $$2, $$6, $$5, $$4)) {
            dxu $$8 = this.a.d();
            dxu $$9 = this.a.e();
            this.a($$0, $$1, $$2, $$3, $$4, $$2, $$5 - 1, $$4, $$9.b(dnk.d, Boolean.valueOf(true)), e, false);
            this.a($$0, $$1, $$6, $$3, $$4, $$6, $$5 - 1, $$4, $$9.b(dnk.b, Boolean.valueOf(true)), e, false);
            if ($$7.a(4) == 0) {
               this.a($$0, $$1, $$2, $$5, $$4, $$2, $$5, $$4, $$8, e, false);
               this.a($$0, $$1, $$6, $$5, $$4, $$6, $$5, $$4, $$8, e, false);
            } else {
               this.a($$0, $$1, $$2, $$5, $$4, $$6, $$5, $$4, $$8, e, false);
               this.a($$0, $$1, $$7, 0.05F, $$2 + 1, $$5, $$4 - 1, dkn.cx.m().b(dtq.g, jm.d));
               this.a($$0, $$1, $$7, 0.05F, $$2 + 1, $$5, $$4 + 1, dkn.cx.m().b(dtq.g, jm.c));
            }
         }
      }

      private void a(dif $$0, eob $$1, bam $$2, float $$3, int $$4, int $$5, int $$6) {
         if (this.b($$0, $$4, $$5, $$6, $$1) && $$2.i() < $$3 && this.a($$0, $$1, $$4, $$5, $$6, 2)) {
            this.a($$0, dkn.bz.m(), $$4, $$5, $$6, $$1);
         }
      }

      private boolean a(dif $$0, eob $$1, int $$2, int $$3, int $$4, int $$5) {
         jh.a $$6 = this.b($$2, $$3, $$4);
         int $$7 = 0;
   ...
   public static class b extends eqn.c {
      ...
      public b(int $$0, eob $$1, @Nullable jm $$2, eqo.a $$3) {
         super(epa.b, $$0, $$3, $$1);
         this.b = $$2;
         this.c = $$1.e() > 3;
      }
      ...
      public void a(eon $$0, eoo $$1, bam $$2) {
         ...
         switch (this.b) {
            case c:
            default:
               eqn.a($$0, $$1, $$2, this.f.h() + 1, this.f.i(), this.f.j() - 1, jm.c, $$3);
               eqn.a($$0, $$1, $$2, this.f.h() - 1, this.f.i(), this.f.j() + 1, jm.e, $$3);
               eqn.a($$0, $$1, $$2, this.f.k() + 1, this.f.i(), this.f.j() + 1, jm.f, $$3);
               break;
            case d:
               eqn.a($$0, $$1, $$2, this.f.h() + 1, this.f.i(), this.f.m() + 1, jm.d, $$3);
               eqn.a($$0, $$1, $$2, this.f.h() - 1, this.f.i(), this.f.j() + 1, jm.e, $$3);
               eqn.a($$0, $$1, $$2, this.f.k() + 1, this.f.i(), this.f.j() + 1, jm.f, $$3);
               break;
            case e:
         ...
         if (this.c) {
            if ($$2.h()) {
               eqn.a($$0, $$1, $$2, this.f.h() + 1, this.f.i() + 3 + 1, this.f.j() - 1, jm.c, $$3);
            }

            if ($$2.h()) {
               eqn.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() + 3 + 1, this.f.j() + 1, jm.e, $$3);
            }

            if ($$2.h()) {
               eqn.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() + 3 + 1, this.f.j() + 1, jm.f, $$3);
            }

            if ($$2.h()) {
               eqn.a($$0, $$1, $$2, this.f.h() + 1, this.f.i() + 3 + 1, this.f.m() + 1, jm.d, $$3);
            }
         }
      }
      ...
      private void a(dif $$0, eob $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   abstract static class c extends eon {
      ...
      protected boolean a(dhk $$0, int $$1, int $$2, int $$3, eob $$4) {
         dxu $$5 = this.a($$0, $$1, $$2, $$3, $$4);
         return !$$5.a(this.a.d().b()) && !$$5.a(this.a.b().b()) && !$$5.a(this.a.e().b()) && !$$5.a(dkn.fl);
      }
      ...
      protected boolean a(dgm $$0, eob $$1, int $$2, int $$3, int $$4, int $$5) {
         for (int $$6 = $$2; $$6 <= $$3; $$6++) {
      ...
      protected boolean a(dhi $$0, eob $$1) {
      ...
      protected void a(dif $$0, eob $$1, dxu $$2, int $$3, int $$4, int $$5) {
         if (this.b($$0, $$3, $$4, $$5, $$1)) {
            jh $$6 = this.b($$3, $$4, $$5);
            dxu $$7 = $$0.a_($$6);
            if (!$$7.c($$0, $$6, jm.b)) {
   ...
   public static class d extends eqn.c {
      ...
      public d(int $$0, bam $$1, int $$2, int $$3, eqo.a $$4) {
      ...
      public d(ux $$0) {
         super(epa.c, $$0);
         eob.a.listOf().parse(vl.a, $$0.c("Entrances", 11)).resultOrPartial(eqn.b::error).ifPresent(this.b::addAll);
      }
      ...
      public void a(eon $$0, eoo $$1, bam $$2) {
         ...
         while ($$5 < this.f.d()) {
            ...
            eqn.c $$6 = eqn.a($$0, $$1, $$2, this.f.h() + $$5, this.f.i() + $$2.a($$4) + 1, this.f.j() - 1, jm.c, $$3);
            if ($$6 != null) {
               eob $$7 = $$6.f();
         ...
         while ($$5 < this.f.d()) {
            ...
            eqn.c $$8 = eqn.a($$0, $$1, $$2, this.f.h() + $$5, this.f.i() + $$2.a($$4) + 1, this.f.m() + 1, jm.d, $$3);
            if ($$8 != null) {
               eob $$9 = $$8.f();
         ...
         while ($$5 < this.f.f()) {
            ...
            eqn.c $$10 = eqn.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() + $$2.a($$4) + 1, this.f.j() + $$5, jm.e, $$3);
            if ($$10 != null) {
               eob $$11 = $$10.f();
         ...
         while ($$5 < this.f.f()) {
            ...
            eon $$12 = eqn.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() + $$2.a($$4) + 1, this.f.j() + $$5, jm.f, $$3);
            if ($$12 != null) {
               eob $$13 = $$12.f();
      ...
      protected void a(eoz $$0, ux $$1) {
         super.a($$0, $$1);
         eob.a.listOf().encodeStart(vl.a, this.b).resultOrPartial(eqn.b::error).ifPresent($$1x -> $$1.a("Entrances", $$1x));
      }
   }

   public static class e extends eqn.c {
      public e(int $$0, eob $$1, jm $$2, eqo.a $$3) {
         super(epa.d, $$0, $$3, $$1);
         this.a($$2);
      }
      ...
      public void a(eon $$0, eoo $$1, bam $$2) {
         ...
         if ($$4 != null) {
            switch ($$4) {
               case c:
               default:
                  eqn.a($$0, $$1, $$2, this.f.h(), this.f.i(), this.f.j() - 1, jm.c, $$3);
                  break;
               case d:
                  eqn.a($$0, $$1, $$2, this.f.h(), this.f.i(), this.f.m() + 1, jm.d, $$3);
                  break;
               case e:
                  eqn.a($$0, $$1, $$2, this.f.h() - 1, this.f.i(), this.f.j(), jm.e, $$3);
                  break;
               case f:
                  eqn.a($$0, $$1, $$2, this.f.k() + 1, this.f.i(), this.f.j(), jm.f, $$3);
            }
         }
      }
