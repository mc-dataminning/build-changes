...
public class eqn {
   ...
   static class a implements eqn.i {
      @Override
      public boolean a(eqn.v $$0) {
         return $$0.c[jm.f.d()] && !$$0.b[jm.f.d()].d;
      }

      @Override
      public eqn.r a(jm $$0, eqn.v $$1, bac $$2) {
         $$1.d = true;
         $$1.b[jm.f.d()].d = true;
         return new eqn.k($$0, $$1);
      }
   }

   static class b implements eqn.i {
      @Override
      public boolean a(eqn.v $$0) {
      ...
      public eqn.r a(jm $$0, eqn.v $$1, bac $$2) {
         ...
         return new eqn.l($$0, $$1);
      }
   }

   static class c implements eqn.i {
      @Override
      public boolean a(eqn.v $$0) {
      ...
      public eqn.r a(jm $$0, eqn.v $$1, bac $$2) {
         $$1.d = true;
         $$1.b[jm.b.d()].d = true;
         return new eqn.m($$0, $$1);
      }
   }

   static class d implements eqn.i {
      @Override
      public boolean a(eqn.v $$0) {
      ...
      public eqn.r a(jm $$0, eqn.v $$1, bac $$2) {
         ...
         return new eqn.n($$0, $$1);
      }
   }

   static class e implements eqn.i {
      @Override
      public boolean a(eqn.v $$0) {
      ...
      public eqn.r a(jm $$0, eqn.v $$1, bac $$2) {
         ...
         $$3.d = true;
         $$3.b[jm.c.d()].d = true;
         return new eqn.o($$0, $$3);
      }
   }

   static class f implements eqn.i {
      @Override
      public boolean a(eqn.v $$0) {
         return true;
      }
      ...
      public eqn.r a(jm $$0, eqn.v $$1, bac $$2) {
         $$1.d = true;
         return new eqn.s($$0, $$1, $$2);
      }
   }

   static class g implements eqn.i {
      @Override
      public boolean a(eqn.v $$0) {
      ...
      public eqn.r a(jm $$0, eqn.v $$1, bac $$2) {
         $$1.d = true;
         return new eqn.t($$0, $$1);
      }
   }

   public static class h extends eqn.r {
      ...
      private eqn.v G;
      private eqn.v H;
      private final List<eqn.r> I = Lists.newArrayList();

      public h(bac $$0, int $$1, int $$2, jm $$3) {
         super(eou.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eqn.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eqn.p($$3, this.G));
         this.I.add(new eqn.j($$3, this.H));
         List<eqn.i> $$5 = Lists.newArrayList();
         $$5.add(new eqn.b());
         $$5.add(new eqn.d());
         $$5.add(new eqn.e());
         $$5.add(new eqn.a());
         ...
         env $$10 = env.a(this.b(1, 1, 1), this.b(23, 8, 21));
         env $$11 = env.a(this.b(34, 1, 1), this.b(56, 8, 21));
         env $$12 = env.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eqn.u($$3, $$10, $$13++));
         this.I.add(new eqn.u($$3, $$11, $$13++));
         this.I.add(new eqn.q($$3, $$12));
      }
      ...
      private List<eqn.v> b(bac $$0) {
         eqn.v[] $$1 = new eqn.v[75];
         ...
         eqn.v $$23 = new eqn.v(1003);
         eqn.v $$24 = new eqn.v(1001);
         eqn.v $$25 = new eqn.v(1002);
         $$1[v].a(jm.b, $$23);
         $$1[w].a(jm.d, $$24);
         $$1[x].a(jm.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eqn.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dhx $$2, bac $$3, env $$4) {
         int $$5 = 24;
      ...
      private void a(dhx $$0, bac $$1, env $$2) {
      ...
      private void b(dhx $$0, bac $$1, env $$2) {
      ...
      private void c(dhx $$0, bac $$1, env $$2) {
      ...
      private void d(dhx $$0, bac $$1, env $$2) {
      ...
      private void e(dhx $$0, bac $$1, env $$2) {
      ...
      private void f(dhx $$0, bac $$1, env $$2) {
   ...
   interface i {
      boolean a(eqn.v var1);

      eqn.r a(jm var1, eqn.v var2, bac var3);
   }

   public static class j extends eqn.r {
      public j(jm $$0, eqn.v $$1) {
         super(eou.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dhx $$0, dhv $$1, dzk $$2, bac $$3, env $$4, dgf $$5, jh $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dkf.co.m(), dkf.co.m(), false);
   ...
   public static class k extends eqn.r {
      public k(jm $$0, eqn.v $$1) {
         super(eou.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eqn.r {
      public l(jm $$0, eqn.v $$1) {
         super(eou.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eqn.r {
      public m(jm $$0, eqn.v $$1) {
         super(eou.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eqn.r {
      public n(jm $$0, eqn.v $$1) {
         super(eou.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eqn.r {
      public o(jm $$0, eqn.v $$1) {
         super(eou.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eqn.r {
      public p(jm $$0, eqn.v $$1) {
         super(eou.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eqn.r {
      public q(jm $$0, env $$1) {
         super(eou.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eoh {
      protected static final dxo b = dkf.ix.m();
      protected static final dxo c = dkf.iy.m();
      protected static final dxo d = dkf.iz.m();
      protected static final dxo h = c;
      protected static final dxo i = dkf.iG.m();
      protected static final boolean j = true;
      protected static final dxo k = dkf.J.m();
      protected static final Set<dkd> l = ImmutableSet.builder().add(dkf.eb).add(dkf.ja).add(dkf.ny).add(k.b()).build();
      ...
      public r(eou $$0, jm $$1, int $$2, env $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eou $$0, int $$1, jm $$2, eqn.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static env a(jm $$0, eqn.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         env $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dhx $$0, env $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dxo $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dhx $$0, env $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dhx $$0, env $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dxo $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(env $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dhx $$0, env $$1, int $$2, int $$3, int $$4) {
         jh $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cmd $$6 = bvi.N.a($$0.a(), bvh.d);
            if ($$6 != null) {
               $$6.c($$6.eS());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dw()), bvh.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eqn.r {
      private int a;

      public s(jm $$0, eqn.v $$1, bac $$2) {
         super(eou.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eqn.r {
      public t(jm $$0, eqn.v $$1) {
         super(eou.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eqn.r {
      private int a;

      public u(jm $$0, env $$1, int $$2) {
         super(eou.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
