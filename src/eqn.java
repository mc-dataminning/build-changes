...
public class eqn {
   ...
   private final eqn.a g;

   @Deprecated
   public static eqn a(azs $$0, eqn.a $$1) {
      return new eqn($$0, $$1, false);
   }

   public static eqn a(azs $$0, int $$1, double... $$2) {
      return b($$0, new eqn.a($$1, new DoubleArrayList($$2)));
   }

   public static eqn b(azs $$0, eqn.a $$1) {
      return new eqn($$0, $$1, true);
   }

   private eqn(azs $$0, eqn.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<eqn.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(eqn.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(eqn.a::b))
               .apply($$0, eqn.a::new)
      );
      public static final Codec<jq<eqn.a>> b = ale.a(lz.aQ, a);
