...
public class eqn {
      ...
      if ($$0 == this.a.aN().i()) {
         ...
         if (this.a.aK() == null) {
            if (this.a.B == null) {
               ...
               if ($$4) {
                  $$9.w();
                  exz.a(() -> $$6[0] = $$9.a($$7, $$8, $$5), "mouseClicked event handler", $$9.getClass().getCanonicalName());
               } else {
                  exz.a(() -> $$6[0] = $$9.b($$7, $$8, $$5), "mouseReleased event handler", $$9.getClass().getCanonicalName());
               }
            }
         }

         if (!$$6[0] && this.a.B == null && this.a.aK() == null) {
            if ($$5 == 0) {
               this.b = $$4;
            } else if ($$5 == 2) {
               this.c = $$4;
            ...
            if (this.a.B != null) {
               ...
               if (this.a.v.G_()) {
                  if (this.a.l.g().a()) {
                     ...
                     float $$12 = arp.a(this.a.v.fR().a() + (float)$$10 * 0.005F, 0.0F, 0.2F);
                     this.a.v.fR().a($$12);
                  }
               } else {
                  this.a.v.fQ().a((double)$$11);
               }
            }
         }
      }
   ...
   private void b(long $$0, double $$1, double $$2) {
      if ($$0 == eqm.O().aN().i()) {
         ...
         exz $$3 = this.a.B;
         if ($$3 != null && this.a.aK() == null) {
            double $$4 = $$1 * (double)this.a.aN().o() / (double)this.a.aN().m();
            double $$5 = $$2 * (double)this.a.aN().p() / (double)this.a.aN().n();
            exz.a(() -> $$3.e($$4, $$5), "mouseMoved event handler", $$3.getClass().getCanonicalName());
            if (this.h != -1 && this.k > 0.0) {
               double $$6 = ($$1 - this.e) * (double)this.a.aN().o() / (double)this.a.aN().m();
               double $$7 = ($$2 - this.f) * (double)this.a.aN().p() / (double)this.a.aN().n();
               exz.a(() -> $$3.a($$4, $$5, this.h, $$6, $$7), "mouseDragged event handler", $$3.getClass().getCanonicalName());
            }
   ...
   public void a() {
      ...
      if (this.h() && this.a.aB()) {
         ...
         if (this.a.m.af) {
            ...
            $$7 = $$5;
            $$8 = $$6;
         } else if (this.a.m.au().a() && this.a.v.go()) {
            this.l.a();
            this.m.a();
            $$7 = this.n * $$3;
            $$8 = this.o * $$3;
   ...
   public void i() {
      if (this.a.aB()) {
         if (!this.s) {
            ...
            ekb.a(this.a.aN().i(), 212995, this.e, this.f);
            this.a.a(null);
            this.a.z = 10000;
            this.i = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.e = (double)(this.a.aN().m() / 2);
         this.f = (double)(this.a.aN().n() / 2);
         ekb.a(this.a.aN().i(), 212993, this.e, this.f);
      }
   }
