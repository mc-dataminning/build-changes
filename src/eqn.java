...
public class eqn {
   ...
   public void a(erx $$0, String $$1, est.a $$2, egl $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eqn.b $$13 = new eqn.b($$1.trim(), this.f, $$3, $$2);
                  eqn.a $$14 = new eqn.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eqn.c $$30 = new eqn.c(this.f, $$2, $$0);
                        eqn.a $$31 = new eqn.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new esb(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, egl $$2) throws IOException {
      ...
      File $$15 = new File(evh.O().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, egl $$2, est.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eqn.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eqn.this.b && !eqn.this.d) {
            try {
               eqn.this.e = true;
               eqn.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eqn.a.error("Error extracting archive", var3);
               eqn.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final est.a c;
      private final erx d;

      c(File $$0, est.a $$1, erx $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eqn.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eqn.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eqn.this.g);
                  eqn.this.c = true;
               } else {
                  eqn.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eqn.this.d = true;
               }
            } catch (IOException var3) {
               eqn.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eqn.this.d = true;
            }
         }
      }
