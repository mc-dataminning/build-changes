...
public class bqj implements bqc {
   ...
   public static Set<bqa> a() {
      Builder<bqa> $$0 = ImmutableSet.builder();

      try {
         bqj.a $$1 = new bqj.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bqa.a("cpu#" + $$1x, bpz.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bqa.a("heap MiB", bpz.e, () -> (double)ac.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bqb.a.a());
      return $$0.build();
   }
   ...
   public static bqa a(final LongSupplier $$0) {
      ...
      bqa.d $$3 = new bqa.d(2.0F);
      return bqa.a("ticktime", bpz.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
