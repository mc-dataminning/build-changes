...
public class bqj extends bqa {
   ...
   public bqj(czg $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bqg.M, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bqj(bqg<? extends bqj> $$0, czg $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         esj $$0 = new esj(this.k.dr() - this.dr(), this.k.dt() + (double)this.k.cI() / 2.0 - this.dt(), this.k.dx() - this.dx());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void u() {
      ...
      if (this.dM() instanceof apu) {
         for (bqj $$1 : this.dM().a(dtp.a(bqj.class), this.cH().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(apu $$0, esj $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bqj($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(apu $$0, esj $$1, int $$2) {
      ese $$3 = ese.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<bqj> $$5 = $$0.a(dtp.a(bqj.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bqj $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private boolean a(bqj $$0) {
      return $$0 != this && a($$0, this.aj(), this.i);
   }

   private static boolean a(bqj $$0, int $$1, int $$2) {
      return !$$0.dH() && ($$0.aj() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(bqj $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(cka $$0, int $$1) {
      Entry<bqh, crs> $$2 = cxa.a(cxc.L, $$0, crs::l);
      if ($$2 != null) {
         crs $$3 = $$2.getValue();
