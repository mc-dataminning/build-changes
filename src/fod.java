...
public abstract class fod extends fnd {
   private final dqr b;
   private dqs c;
   private final String[] d;
   private final boolean r;
   protected final dtp a;
   private int s;
   private int u;
   @Nullable
   private fjy v;

   public fod(dqr $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, xp.c("sign.edit"));
   }

   public fod(dqr $$0, boolean $$1, boolean $$2, xp $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.r = $$1;
      this.a = dlz.a($$0.n().b());
      this.d = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(xp::getString).toArray(String[]::new);
   }

   @Override
   protected void aM_() {
      this.c(fhe.a(xo.d, $$0 -> this.F()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.v = new fjy(() -> this.d[this.u], this::a, fjy.a(this.m), fjy.c(this.m), $$0 -> this.m.h.b($$0) <= this.b.c());
   }
   ...
   public void j() {
      fxw $$0 = this.m.L();
      if ($$0 != null) {
         $$0.b(new aip(this.b.ay_(), this.r, this.d[0], this.d[1], this.d[2], this.d[3]));
      }
   }
   ...
   protected abstract void a(fgr var1, dsc var2);
   ...
   private void d(fgr $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : ggc.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.u && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gdw.F(), $$21, $$7, $$22, $$7 + this.b.b(), -16776961);
            }
         }
      }
   }
