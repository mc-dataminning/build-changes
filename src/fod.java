public abstract class fod<T extends cpw> extends foc<T> implements fqx {
   public final fqn D;
   private boolean E;
   private final alf F;
   private final alf G;
   ...
   public fod(T $$0, fqn $$1, cmx $$2, xp $$3, alf $$4, alf $$5, alf $$6) {
      super($$0, $$2, $$3);
      this.D = $$1;
      this.F = $$4;
      this.G = $$5;
   ...
   public void aM_() {
      ...
      this.c(new fhr(this.z + 20, this.o / 2 - 49, 20, 18, fqr.a, $$0 -> {
         this.D.e();
         this.z = this.D.a(this.n, this.c);
