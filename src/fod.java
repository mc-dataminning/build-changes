...
public class fod extends hrc {
   ...
   private final fod.a L;
   @Nullable
   private volatile xg M;
   private volatile xg N = xg.c("mco.download.preparing");
   @Nullable
   ...
   public fod(fzq $$0, fng $$1, String $$2, BooleanConsumer $$3) {
      super(fqh.a);
      this.aa = $$3;
      this.F = $$0;
      this.K = $$2;
      this.G = $$1;
      this.L = new fod.a();
      this.H = xg.c("mco.download.title");
   ...
   private void E() {
      if (!this.R && !this.Z) {
         ...
         if (this.a(this.G.a) >= 5368709120L) {
            xg $$0 = xg.a("mco.download.confirmation.oversized", flm.b(5368709120L));
            this.m.a(fom.c(this, $$0, $$0x -> {
               this.m.a(this);
               this.G();
            }));
         } else {
   ...
   private xg F() {
      ...
      $$0.add(this.N);
      if (this.O != null) {
         $$0.add(xg.a("mco.download.percent", this.O));
         $$0.add(xg.a("mco.download.speed.narration", flm.b(this.V)));
      }
   ...
   private void d(ftk $$0) {
      ...
      $$0.a(this.p, xg.a("mco.download.percent", this.O), this.n / 2, 84, -1);
   }
   ...
   private void a(ftk $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.b(this.p, xg.a("mco.download.speed", flm.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1);
      }
   }
         ...
         try {
            try {
               if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                  this.N = xg.c("mco.download.failed");
                  return;
               }
               ...
               this.N = xg.a("mco.download.downloading", this.K);
               fln $$0 = new fln();
               $$0.a(this.G.a);
               ...
               while (!$$0.b()) {
                  if ($$0.c()) {
                     $$0.a();
                     this.M = xg.c("mco.download.failed");
                     this.J.b(xf.d);
                     return;
                  }
                  ...
                  if ($$0.d()) {
                     if (!this.S) {
                        this.N = xg.c("mco.download.extracting");
                     }
   ...
   private void H() {
      this.N = xg.c("mco.download.cancelled");
   }
