...
public class fod {
   ...
   private final fpb at;
   private final fqb au;
   private final fqt av;
   private final fpu aw;
   private final fos ax;
   private int ay;
   @Nullable
   private wp az;
   @Nullable
   ...
   public fod(flj $$0) {
      ...
      this.av = new fqt($$0);
      this.al = new fou($$0);
      this.aw = new fpu($$0, this);
      this.ax = new fos($$0);
      this.au = new fqb($$0);
      this.a();
      foh $$1 = new foh().a(this::c).a(this::j).a(this::l).a(this::n).a(this::k).a(($$0x, $$1x) -> this.ax.a($$0x));
      foh $$2 = new foh().a(this::o).a(($$0x, $$1x) -> {
         if (this.at.d()) {
            this.at.a($$0x);
         }
   ...
   private void d(foe $$0, fkz $$1) {
      if (this.ak.t.gn() > 0) {
         ...
         $$0.a(gmi.L(), 0, 0, $$0.a(), $$0.b(), $$4);
         bos.a().c();
      }
   }

   private void e(foe $$0, fkz $$1) {
      foc $$2 = this.f();
      if (this.an != null && this.ao > 0) {
         bos.a().a("overlayMessage");
   ...
   private void f(foe $$0, fkz $$1) {
      if (this.az != null && this.ay > 0) {
         foc $$2 = this.f();
         bos.a().a("titleAndSubtitle");
      ...
      if ($$2.aE().a()) {
         if (this.ak.r.j() != dgf.d || this.a(this.ak.w)) {
            if (this.at.d() && !this.ak.t.gz() && !$$2.Y().c()) {
               ...
               int $$5 = 15;
               $$0.a(gmi::J, c, ($$0.a() - 15) / 2, ($$0.b() - 15) / 2, 15, 15);
               if (this.ak.n.F().c() == fkq.b) {
                  float $$6 = this.ak.t.H(0.0F);
                  boolean $$7 = false;
                  if (this.ak.v != null && this.ak.v instanceof bvh && $$6 >= 1.0F) {
                     $$7 = this.ak.t.gC() > 5.0F;
                     $$7 &= this.ak.v.bL();
                  }
                  ...
                  int $$9 = $$0.a() / 2 - 8;
                  if ($$7) {
                     $$0.a(gmi::J, d, $$9, $$8, 16, 16);
                  } else if ($$6 < 1.0F) {
                     int $$10 = (int)($$6 * 17.0F);
                     $$0.a(gmi::J, e, $$9, $$8, 16, 4);
                     $$0.a(gmi::J, f, 16, 4, 0, 0, $$9, $$8, $$10, 4);
                  }
               }
            }
         }
   ...
   private void k(foe $$0, fkz $$1) {
      Collection<btq> $$2 = this.ak.t.eA();
      if (!$$2.isEmpty() && (this.ak.z == null || !this.ak.z.C())) {
         ...
         for (btq $$7 : Ordering.natural().reverse().sortedCopy($$2)) {
            ...
            if ($$7.h()) {
               ...
               float $$11 = 1.0F;
               if ($$7.f()) {
                  $$0.a(gmi::H, g, $$9, $$10, 24, 24);
               } else {
                  $$0.a(gmi::H, h, $$9, $$10, 24, 24);
                  if ($$7.a(200)) {
                     int $$12 = $$7.d();
                     int $$13 = 10 - $$12 / 20;
               ...
               $$6.add(() -> {
                  int $$5x = axk.a($$17);
                  $$0.a(gmi::H, $$14, $$15 + 3, $$16 + 3, 18, 18, $$5x);
               });
            }
         }
   ...
   private void m(foe $$0, fkz $$1) {
      ...
      if ($$2 != null) {
         ...
         $$0.a(gmi::H, i, $$5 - 91, $$0.b() - 22, 182, 22);
         $$0.a(gmi::H, j, $$5 - 91 - 1 + $$2.gi().j * 20, $$0.b() - 22 - 1, 24, 23);
         if (!$$3.f()) {
            if ($$4 == bvb.a) {
               $$0.a(gmi::H, k, $$5 - 91 - 29, $$0.b() - 23, 29, 24);
            } else {
               $$0.a(gmi::H, l, $$5 + 91, $$0.b() - 23, 29, 24);
            }
         }
         ...
         if (this.ak.n.F().c() == fkq.c) {
            ...
            if ($$13 < 1.0F) {
               ...
               int $$16 = (int)($$13 * 19.0F);
               $$0.a(gmi::H, m, $$15, $$14, 18, 18);
               $$0.a(gmi::H, n, 18, 18, 0, 18 - $$16, $$15, $$14 + 18 - $$16, 18, $$16);
            }
         }
      }
   }

   private void a(bvr $$0, foe $$1, int $$2) {
      bos.a().a("jumpBar");
      float $$3 = this.ak.t.y();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
      int $$6 = $$1.b() - 32 + 3;
      $$1.a(gmi::H, o, $$2, $$6, 182, 5);
      if ($$0.c() > 0) {
         $$1.a(gmi::H, p, $$2, $$6, 182, 5);
      } else if ($$5 > 0) {
         $$1.a(gmi::H, q, 182, 5, 0, 0, $$2, $$6, $$5, 5);
      }

      bos.a().c();
   }

   private void a(foe $$0, int $$1) {
      bos.a().a("expBar");
      int $$2 = this.ak.t.gs();
      if ($$2 > 0) {
         int $$3 = 182;
         ...
         int $$5 = $$0.b() - 32 + 3;
         $$0.a(gmi::H, r, $$1, $$5, 182, 5);
         if ($$4 > 0) {
            $$0.a(gmi::H, s, 182, 5, 0, 0, $$1, $$5, $$4, 5);
         }
      }
   ...
   private static void a(foe $$0, cox $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$1.eP();
      if ($$6 > 0) {
         int $$7 = $$2 - ($$3 - 1) * $$4 - 10;
   ...
   private void a(foe $$0, cox $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      fod.b $$11 = fod.b.a($$1);
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, fod.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == fod.b.d ? $$11 : fod.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(foe $$0, fod.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      $$0.a(gmi::H, $$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
   }

   private void a(foe $$0, cox $$1, int $$2, int $$3, int $$4) {
      int $$5 = $$1.cs();
      ...
      if ($$7 || $$6 < $$5) {
         ...
         for (int $$12 = 1; $$12 <= 10; $$12++) {
            int $$13 = $$4 - ($$12 - 1) * 8 - 9;
            if ($$12 <= $$8) {
               $$0.a(gmi::H, C, $$13, $$3, 9, 9);
            } else if ($$11 && $$12 == $$9 && $$7) {
               $$0.a(gmi::H, D, $$13, $$3, 9, 9);
               this.a($$12, $$1, $$10);
            } else if ($$12 > 10 - $$10) {
               int $$14 = $$10 == 10 && this.am % 2 == 0 ? this.aj.a(2) : 0;
               $$0.a(gmi::H, E, $$13, $$3 + $$14, 9, 9);
            }
         }
      }
   }
   ...
   private void a(foe $$0, cox $$1, int $$2, int $$3) {
      cry $$4 = $$1.gt();
      int $$5 = $$4.a();
      ...
      for (int $$6 = 0; $$6 < 10; $$6++) {
         ...
         int $$14 = $$3 - $$6 * 8 - 9;
         $$0.a(gmi::H, $$8, $$14, $$7, 9, 9);
         if ($$6 * 2 + 1 < $$5) {
            $$0.a(gmi::H, $$10, $$14, $$7, 9, 9);
         }

         if ($$6 * 2 + 1 == $$5) {
            $$0.a(gmi::H, $$9, $$14, $$7, 9, 9);
         }
      }
   }
      ...
      if ($$1 != null) {
         ...
         if ($$2 != 0) {
            ...
            for (int $$7 = 0; $$2 > 0; $$7 += 20) {
               ...
               for (int $$9 = 0; $$9 < $$8; $$9++) {
                  int $$10 = $$5 - $$9 * 8 - 9;
                  $$0.a(gmi::H, F, $$10, $$6, 9, 9);
                  if ($$9 * 2 + 1 + $$7 < $$3) {
                     $$0.a(gmi::H, G, $$10, $$6, 9, 9);
                  }

                  if ($$9 * 2 + 1 + $$7 == $$3) {
                     $$0.a(gmi::H, H, $$10, $$6, 9, 9);
                  }
               }
   ...
   private void a(foe $$0, akv $$1, float $$2) {
      int $$3 = axk.a($$2);
      $$0.a(gmi::F, $$1, 0, 0, 0.0F, 0.0F, $$0.a(), $$0.b(), $$0.a(), $$0.b(), $$3);
   }

   private void a(foe $$0, float $$1) {
      ...
      int $$9 = $$7 + $$5;
      int $$10 = $$8 + $$6;
      $$0.a(gmi::H, J, $$7, $$8, 0.0F, 0.0F, $$5, $$6, $$5, $$6);
      $$0.a(gmi.L(), 0, $$10, $$0.a(), $$0.b(), -90, -16777216);
      $$0.a(gmi.L(), 0, 0, $$0.a(), $$8, -90, -16777216);
      $$0.a(gmi.L(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(gmi.L(), $$9, $$8, $$0.a(), $$10, -90, -16777216);
   }

   private void a(bul $$0) {
      ji $$1 = ji.a($$0.dA(), $$0.dE(), $$0.dG());
      float $$2 = glw.a($$0.dV().G_(), $$0.dV().A($$1));
      float $$3 = ayz.a(1.0F - $$2, 0.0F, 1.0F);
      this.b = this.b + ($$3 - this.b) * 0.01F;
   }

   private void a(foe $$0, @Nullable bul $$1) {
      dyn $$2 = this.ak.s.F_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
      ...
      $$0.a(gmi::I, I, 0, 0, 0.0F, 0.0F, $$0.a(), $$0.b(), $$0.a(), $$0.b(), $$7);
   }

   private void b(foe $$0, float $$1) {
      if ($$1 < 1.0F) {
         $$1 *= $$1;
         $$1 *= $$1;
         $$1 = $$1 * 0.8F + 0.2F;
      ...
      int $$2 = axk.a($$1);
      hes $$3 = this.ak.ap().a().a(djo.eq.m());
      $$0.a(gmi::F, $$3, 0, 0, $$0.a(), $$0.b(), $$2);
   }

   private void c(foe $$0, float $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      $$0.c().a();
      ...
      float $$6 = 0.4F * $$1;
      float $$7 = 0.2F * $$1;
      $$0.a($$0x -> gmi.M(), a, 0, 0, 0.0F, 0.0F, $$2, $$3, $$2, $$3, axk.a(1.0F, $$5, $$6, $$7));
      $$0.c().b();
   }

   private void a(foe $$0, int $$1, int $$2, fkz $$3, cox $$4, cwp $$5, int $$6) {
      if (!$$5.f()) {
