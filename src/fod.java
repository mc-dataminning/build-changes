...
public class fod {
   ...
   private final fmf g;
   final Map<UUID, fot> h = Maps.newLinkedHashMap();
   ...
   private void a(fnr $$0, int $$1, int $$2, bsy $$3) {
   ...
   private void a(fnr $$0, int $$1, int $$2, bsy $$3, int $$4, alz[] $$5, alz[] $$6) {
      $$0.a(glu::C, $$5[$$3.k().ordinal()], 182, 5, 0, 0, $$1, $$2, $$4, 5);
      if ($$3.l() != bsy.b.a) {
         $$0.a(glu::C, $$6[$$3.l().ordinal() - 1], 182, 5, 0, 0, $$1, $$2, $$4, 5);
      }
   }
   ...
   public void a(adb $$0) {
      $$0.a(new adb.b() {
         ...
         public void a(UUID $$0, xv $$1, float $$2, bsy.a $$3, bsy.b $$4, boolean $$5, boolean $$6, boolean $$7) {
            fod.this.h.put($$0, new fot($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7));
         }
