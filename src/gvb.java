...
public abstract class gvb extends fmy {
   ...
   private final List<guz> a = Lists.newArrayList();
   ...
   protected guz a(guz $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xl m() {
      return xk.a(this.a.stream().map(guz::a).collect(Collectors.toList()));
   }
}
