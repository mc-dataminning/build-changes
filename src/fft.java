public abstract class fft extends ffx implements fhc, fhv {
   private static final fhm a = new fhm(new akm("widget/text_field"), new akm("widget/text_field_highlighted"));
   private static final akm b = new akm("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public fft(int $$0, int $$1, int $$2, int $$3, wx $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return ayd.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = ayd.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(ffm var1, int var2, int var3, float var4);
}
