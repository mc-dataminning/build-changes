...
public enum fft implements bak {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final bak.a<fft> t = bak.a(fft::values);
   public static final IntFunction<fft> u = ayc.a(fft::a, values(), ayc.a.a);
   private final int v;
   private final String w;

   private fft(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
