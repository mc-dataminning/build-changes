...
public class fft implements AutoCloseable {
   private final ffr.a a;
   @Nullable
   private ffr.a b;
   private final fft.a c;

   public fft(ffr.a $$0, fft.a $$1) {
      this.a = $$0;
      this.c = $$1;
   }

   private static Vector3f[] a(ByteBuffer $$0, int $$1, ffz $$2) {
      int $$3 = $$2.a(fga.b);
      if ($$3 == -1) {
   ...
   @Nullable
   public fft.b a(ffr $$0, fgc $$1) {
      if (this.c.d() != ffz.c.h) {
         return null;
      } else {
         Vector3f[] $$2 = a(this.a.a(), this.c.b(), this.c.a());
         fft.b $$3 = new fft.b($$2, this.c.e());
         this.b = $$3.a($$0, $$1);
         return $$3;
      }
   }
   ...
   public static record a(ffz a, int b, int c, ffz.c d, ffz.b e) {
   }

   public static record b(Vector3f[] a, ffz.b b) {
      @Nullable
      public ffr.a a(ffr $$0, fgc $$1) {
         int[] $$2 = $$1.sort(this.a);
      ...
      private IntConsumer a(long $$0, ffz.b $$1) {
