...
public class bao extends bfe {
   public bao(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bgf.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bgf.s, "minecraft:piston");
