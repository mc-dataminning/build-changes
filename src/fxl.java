...
public class fxl extends fxi {
   ...
   private int J;
   private final fsh K = new fsh(false);

   public fxl(boolean $$0, Runnable $$1) {
      super(fnw.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
      ...
      for (JsonElement $$2 : aza.b($$0)) {
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(ww.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(ww.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.C.addAll(this.m.h.c(ww.b($$0), 256));
   }

   private void a(ww $$0, boolean $$1) {
      if ($$1) {
   ...
   private void c(frc $$0) {
      $$0.a(gpn::I, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
