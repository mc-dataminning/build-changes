...
public class fxl {
   ...
   public fxl(Runnable $$0, Function<avd, alz> $$1, avg $$2, Consumer<avg> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<fxl.a> a() {
      return this.c.stream().map($$0 -> new fxl.d($$0));
   }

   public Stream<fxl.a> b() {
      return this.b.stream().map($$0 -> new fxl.c($$0));
   }
   ...
   abstract class b implements fxl.a {
      private final avd b;
      ...
      @Override
      public alz a() {
         return fxl.this.d.apply(this.b);
      }
