...
public class cnr extends cno {
   ...
   public cnr(bsz<? extends cnr> $$0, dbx $$1) {
      super($$0, $$1);
      this.ag = true;
   }

   public cnr(dbx $$0, bto $$1, bst $$2, je.a $$3) {
      this(bsz.aL, $$0);
      this.c($$1);
      evq $$4 = $$1.cK().f();
   ...
   public void l() {
      ...
      if (!this.dP().B) {
         ...
         if (this.c == null || !this.c.bD() || this.c instanceof cmw && this.c.N_()) {
            this.ba();
         } else {
            this.f = ayy.a(this.f * 1.025, -1.0, 1.0);
            this.g = ayy.a(this.g * 1.025, -1.0, 1.0);
            this.h = ayy.a(this.h * 1.025, -1.0, 1.0);
            evq $$0 = this.ds();
   ...
   protected void a(evn $$0) {
      ...
      bst $$1 = $$0.a();
      bst $$2 = this.s();
      bto $$3 = $$2 instanceof bto ? (bto)$$2 : null;
      boolean $$4 = $$1.a(this.dQ().a(this, $$3), 4.0F);
      if ($$4) {
         this.a($$3, $$1);
         if ($$1 instanceof bto $$5) {
            $$5.b(new bsb(bsd.y, 200), (bst)MoreObjects.firstNonNull($$2, this));
         }
      }
   }
   ...
   private void u() {
      this.ao();
      this.dP().a(dwu.o, this.dn(), dwu.a.a(this));
   }
