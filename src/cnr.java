...
public class cnr extends cnq implements cpl {
   private static final Logger a = LogUtils.getLogger();
   private static final alc<Boolean> b = alg.a(cnr.class, ale.k);
   private static final alc<cpk> c = alg.a(cnr.class, ale.u);
   ...
   public cnr(bvr<? extends cnr> $$0, dhi $$1) {
      super($$0, $$1);
      ma.x.a(this.ae).ifPresent($$0x -> this.a(this.gy().a((cpm)$$0x.a())));
   }
   ...
   protected void a(alg.a $$0) {
      super.a($$0);
      $$0.a(b, false);
      $$0.a(c, new cpk(cpo.c, cpm.b, 1));
   }

   @Override
   public void b(ux $$0) {
      super.b($$0);
      cpk.c.encodeStart(vl.a, this.gy()).resultOrPartial(a::error).ifPresent($$1 -> $$0.a("VillagerData", $$1));
      if (this.cj != null) {
         $$0.a("Offers", (vu)dgg.a.encodeStart(this.dY().a(vl.a), this.cj).getOrThrow());
      }
   ...
   public void a(ux $$0) {
      ...
      if ($$0.b("VillagerData", 10)) {
         DataResult<cpk> $$1 = cpk.c.parse(new Dynamic(vl.a, $$0.c("VillagerData")));
         $$1.resultOrPartial(a::error).ifPresent(this::a);
      }

      if ($$0.e("Offers")) {
         dgg.a.parse(this.dY().a(vl.a), $$0.c("Offers")).resultOrPartial(ae.a("Failed to load offers: ", a::warn)).ifPresent($$0x -> this.cj = $$0x);
      }
   ...
   private void a(@Nullable UUID $$0, int $$1) {
      ...
      this.au().a(b, true);
      this.e(bur.r);
      this.a(new bup(bur.e, $$1, Math.min(this.dW().al().a() - 1, 0)));
   ...
   private void g(ash $$0) {
      this.a(bvr.bD, bvf.a(this, false, false), $$1 -> {
         for (bvs $$2 : this.a($$0, $$0xx -> !deb.a($$0xx, dea.E))) {
            bwy $$3 = $$1.a_($$2.b() + 300);
            $$3.a(this.a($$2));
         }
         ...
         for (int $$3 = (int)this.dB() - 4; $$3 < (int)this.dB() + 4 && $$1 < 14; $$3++) {
            for (int $$4 = (int)this.dD() - 4; $$4 < (int)this.dD() + 4 && $$1 < 14; $$4++) {
               for (int $$5 = (int)this.dH() - 4; $$5 < (int)this.dH() + 4 && $$1 < 14; $$5++) {
                  dxv $$6 = this.dW().a_($$2.d($$3, $$4, $$5));
                  if ($$6.a(dko.fk) || $$6.b() instanceof dkf) {
                     if (this.ae.i() < 0.3F) {
                        $$0++;
                     }
