...
public class emy implements enb {
   public static final Codec<emy> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               buh.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               buh.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               buh.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               buf.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               buf.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public emy(int $$0, buh $$1, buh $$2, int $$3, int $$4, buh $$5, buf $$6, buf $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
