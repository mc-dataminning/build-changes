...
public class emy extends enc {
   public static final MapCodec<emy> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, emy::new));

   public emy(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<elh.a> a(dhv $$0, BiConsumer<jj, dym> $$1, azs $$2, int $$3, jj $$4, ekr $$5) {
      ...
      if ($$13.isPresent()) {
         $$6.add(new elh.a(new jj($$11, $$13.getAsInt(), $$12), 1, false));
      }
      ...
      if ($$16 != $$7) {
         ...
         if ($$13.isPresent()) {
            $$6.add(new elh.a(new jj($$11, $$13.getAsInt(), $$12), 0, false));
         }
      }
