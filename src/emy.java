...
public class emy {
   ...
   private final emy.a g;

   @Deprecated
   public static emy a(azh $$0, emy.a $$1) {
      return new emy($$0, $$1, false);
   }

   public static emy a(azh $$0, int $$1, double... $$2) {
      return b($$0, new emy.a($$1, new DoubleArrayList($$2)));
   }

   public static emy b(azh $$0, emy.a $$1) {
      return new emy($$0, $$1, true);
   }

   private emy(azh $$0, emy.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<emy.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(emy.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(emy.a::b))
               .apply($$0, emy.a::new)
      );
      public static final Codec<ji<emy.a>> b = alb.a(lq.aH, a);
