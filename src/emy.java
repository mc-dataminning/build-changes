...
public class emy {
   ...
   static class a implements emy.i {
      @Override
      public boolean a(emy.v $$0) {
         return $$0.c[jj.f.d()] && !$$0.b[jj.f.d()].d;
      }

      @Override
      public emy.r a(jj $$0, emy.v $$1, azk $$2) {
         $$1.d = true;
         $$1.b[jj.f.d()].d = true;
         return new emy.k($$0, $$1);
      }
   }

   static class b implements emy.i {
      @Override
      public boolean a(emy.v $$0) {
         if ($$0.c[jj.f.d()] && !$$0.b[jj.f.d()].d && $$0.c[jj.b.d()] && !$$0.b[jj.b.d()].d) {
            emy.v $$1 = $$0.b[jj.f.d()];
            return $$1.c[jj.b.d()] && !$$1.b[jj.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public emy.r a(jj $$0, emy.v $$1, azk $$2) {
         ...
         $$1.b[jj.f.d()].d = true;
         $$1.b[jj.b.d()].d = true;
         $$1.b[jj.f.d()].b[jj.b.d()].d = true;
         return new emy.l($$0, $$1);
      }
   }

   static class c implements emy.i {
      @Override
      public boolean a(emy.v $$0) {
         return $$0.c[jj.b.d()] && !$$0.b[jj.b.d()].d;
      }
      ...
      public emy.r a(jj $$0, emy.v $$1, azk $$2) {
         $$1.d = true;
         $$1.b[jj.b.d()].d = true;
         return new emy.m($$0, $$1);
      }
   }

   static class d implements emy.i {
      @Override
      public boolean a(emy.v $$0) {
         if ($$0.c[jj.c.d()] && !$$0.b[jj.c.d()].d && $$0.c[jj.b.d()] && !$$0.b[jj.b.d()].d) {
            emy.v $$1 = $$0.b[jj.c.d()];
            return $$1.c[jj.b.d()] && !$$1.b[jj.b.d()].d;
         } else {
            return false;
      ...
      public emy.r a(jj $$0, emy.v $$1, azk $$2) {
         ...
         $$1.b[jj.c.d()].d = true;
         $$1.b[jj.b.d()].d = true;
         $$1.b[jj.c.d()].b[jj.b.d()].d = true;
         return new emy.n($$0, $$1);
      }
   }

   static class e implements emy.i {
      @Override
      public boolean a(emy.v $$0) {
         return $$0.c[jj.c.d()] && !$$0.b[jj.c.d()].d;
      }

      @Override
      public emy.r a(jj $$0, emy.v $$1, azk $$2) {
         emy.v $$3 = $$1;
         if (!$$1.c[jj.c.d()] || $$1.b[jj.c.d()].d) {
            $$3 = $$1.b[jj.d.d()];
         }

         $$3.d = true;
         $$3.b[jj.c.d()].d = true;
         return new emy.o($$0, $$3);
      }
   }

   static class f implements emy.i {
      @Override
      public boolean a(emy.v $$0) {
         return true;
      }
      ...
      public emy.r a(jj $$0, emy.v $$1, azk $$2) {
         $$1.d = true;
         return new emy.s($$0, $$1, $$2);
      }
   }

   static class g implements emy.i {
      @Override
      public boolean a(emy.v $$0) {
         return !$$0.c[jj.e.d()] && !$$0.c[jj.f.d()] && !$$0.c[jj.c.d()] && !$$0.c[jj.d.d()] && !$$0.c[jj.b.d()];
      }

      @Override
      public emy.r a(jj $$0, emy.v $$1, azk $$2) {
         $$1.d = true;
         return new emy.t($$0, $$1);
      }
   }

   public static class h extends emy.r {
      ...
      private emy.v G;
      private emy.v H;
      private final List<emy.r> I = Lists.newArrayList();

      public h(azk $$0, int $$1, int $$2, jj $$3) {
         super(elf.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<emy.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new emy.p($$3, this.G));
         this.I.add(new emy.j($$3, this.H));
         List<emy.i> $$5 = Lists.newArrayList();
         $$5.add(new emy.b());
         $$5.add(new emy.d());
         $$5.add(new emy.e());
         $$5.add(new emy.a());
         ...
         ekg $$10 = ekg.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ekg $$11 = ekg.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ekg $$12 = ekg.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new emy.u($$3, $$10, $$13++));
         this.I.add(new emy.u($$3, $$11, $$13++));
         this.I.add(new emy.q($$3, $$12));
      }
      ...
      private List<emy.v> b(azk $$0) {
         emy.v[] $$1 = new emy.v[75];
         ...
         emy.v $$23 = new emy.v(1003);
         emy.v $$24 = new emy.v(1001);
         emy.v $$25 = new emy.v(1002);
         $$1[v].a(jj.b, $$23);
         $$1[w].a(jj.d, $$24);
         $$1[x].a(jj.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[jj.f.d()].d = true;
         this.H.b[jj.c.d()].d = true;
         this.H.b[jj.f.d()].b[jj.c.d()].d = true;
         this.H.b[jj.b.d()].d = true;
         this.H.b[jj.f.d()].b[jj.b.d()].d = true;
         this.H.b[jj.c.d()].b[jj.b.d()].d = true;
         this.H.b[jj.f.d()].b[jj.c.d()].b[jj.b.d()].d = true;
         ObjectArrayList<emy.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dep $$2, azk $$3, ekg $$4) {
         int $$5 = 24;
      ...
      private void a(dep $$0, azk $$1, ekg $$2) {
      ...
      private void b(dep $$0, azk $$1, ekg $$2) {
      ...
      private void c(dep $$0, azk $$1, ekg $$2) {
      ...
      private void d(dep $$0, azk $$1, ekg $$2) {
      ...
      private void e(dep $$0, azk $$1, ekg $$2) {
      ...
      private void f(dep $$0, azk $$1, ekg $$2) {
   ...
   interface i {
      boolean a(emy.v var1);

      emy.r a(jj var1, emy.v var2, azk var3);
   }

   public static class j extends emy.r {
      public j(jj $$0, emy.v $$1) {
         super(elf.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dep $$0, den $$1, dvx $$2, azk $$3, ekg $$4, dcy $$5, je $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dgx.ch.o(), dgx.ch.o(), false);
   ...
   public static class k extends emy.r {
      public k(jj $$0, emy.v $$1) {
         super(elf.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(dep $$0, den $$1, dvx $$2, azk $$3, ekg $$4, dcy $$5, je $$6) {
         emy.v $$7 = this.B.b[jj.f.d()];
         emy.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[jj.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jj.a.d()]);
         }
   ...
   public static class l extends emy.r {
      public l(jj $$0, emy.v $$1) {
         super(elf.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends emy.r {
      public m(jj $$0, emy.v $$1) {
         super(elf.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(dep $$0, den $$1, dvx $$2, azk $$3, ekg $$4, dcy $$5, je $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[jj.a.d()]);
         }

         emy.v $$7 = this.B.b[jj.b.d()];
         if ($$7.b[jj.b.d()] == null) {
   ...
   public static class n extends emy.r {
      public n(jj $$0, emy.v $$1) {
         super(elf.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(dep $$0, den $$1, dvx $$2, azk $$3, ekg $$4, dcy $$5, je $$6) {
         emy.v $$7 = this.B.b[jj.c.d()];
         emy.v $$8 = this.B;
         emy.v $$9 = $$7.b[jj.b.d()];
         emy.v $$10 = $$8.b[jj.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[jj.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[jj.a.d()]);
         }
   ...
   public static class o extends emy.r {
      public o(jj $$0, emy.v $$1) {
         super(elf.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends emy.r {
      public p(jj $$0, emy.v $$1) {
         super(elf.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends emy.r {
      public q(jj $$0, ekg $$1) {
         super(elf.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eks {
      protected static final dua b = dgx.hZ.o();
      protected static final dua c = dgx.ia.o();
      protected static final dua d = dgx.ib.o();
      protected static final dua h = c;
      protected static final dua i = dgx.ii.o();
      protected static final boolean j = true;
      protected static final dua k = dgx.G.o();
      protected static final Set<dgv> l = ImmutableSet.builder().add(dgx.dO).add(dgx.iC).add(dgx.mW).add(k.b()).build();
      ...
      public r(elf $$0, jj $$1, int $$2, ekg $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(elf $$0, int $$1, jj $$2, emy.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ekg a(jj $$0, emy.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ekg $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dep $$0, ekg $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dua $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dep $$0, ekg $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dep $$0, ekg $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dua $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ekg $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dep $$0, ekg $$1, int $$2, int $$3, int $$4) {
         je $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            ckk $$6 = btq.D.a($$0.E(), btp.d);
            if ($$6 != null) {
               $$6.c($$6.eQ());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.ds()), btp.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends emy.r {
      private int a;

      public s(jj $$0, emy.v $$1, azk $$2) {
         super(elf.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(dep $$0, den $$1, dvx $$2, azk $$3, ekg $$4, dcy $$5, je $$6) {
         ...
         if (this.B.b[jj.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[jj.a.d()] && !this.B.c[jj.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends emy.r {
      public t(jj $$0, emy.v $$1) {
         super(elf.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends emy.r {
      private int a;

      public u(jj $$0, ekg $$1, int $$2) {
         super(elf.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
