...
public class csr extends crt {
   public csr(bwr<? extends csr> $$0, djh $$1) {
      super($$0, $$1);
   }

   public csr(djh $$0, bxj $$1, czk $$2) {
      super(bwr.aV, $$0, $$1, $$2);
   }

   public csr(djh $$0, double $$1, double $$2, double $$3, czk $$4) {
   ...
   public void a(arq $$0, czk $$1, @Nullable bwi $$2) {
      dbg $$3 = $$1.a(kk.R, dbg.a);
      float $$4 = $$1.a(kk.S, 1.0F);
      Iterable<bvm> $$5 = $$3.a();
      fes $$6 = this.cQ().c(4.0, 2.0, 4.0);
