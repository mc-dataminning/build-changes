...
public class csr extends csi {
   ...
   public csr(dfi.d $$0) {
      super($$0);
      this.k(this.C.b().a(a, ha.c).a(b, dfx.a).a(c, Boolean.valueOf(false)));
   }
   ...
   private boolean a(dfj $$0, ha $$1, double $$2) {
   ...
   public boolean a(cpv $$0, gw $$1, @Nullable ha $$2) {
      return this.a(null, $$0, $$1, $$2);
   }

   public boolean a(@Nullable biq $$0, cpv $$1, gw $$2, @Nullable ha $$3) {
      dcv $$4 = $$1.c_($$2);
      if (!$$1.B && $$4 instanceof dct) {
         ...
         ((dct)$$4).a($$3);
         $$1.a(null, $$2, apd.bK, ape.e, 2.0F, 1.0F);
         $$1.a($$0, djt.c, $$2);
         return true;
      } else {
         return false;
   ...
   public dfj a(cln $$0) {
      ...
      ha.a $$4 = $$1.o();
      if ($$4 == ha.a.b) {
         dfj $$5 = this.n().a(b, $$1 == ha.a ? dfx.b : dfx.a).a(a, $$0.g());
         if ($$5.a((cpy)$$0.q(), $$2)) {
            return $$5;
         }
      } else {
   ...
   public boolean a(dfj $$0, cpy $$1, gw $$2) {
      ha $$3 = n($$0).g();
      return $$3 == ha.b ? csv.a($$1, $$2.c(), ha.a) : cvl.b($$1, $$2, $$3);
   }

   private static ha n(dfj $$0) {
      switch ((dfx)$$0.c(b)) {
         case a:
            return ha.b;
         case b:
