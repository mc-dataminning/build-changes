...
public class fbq extends fbs {
   ...
   static final fbq.b l = new fbq.b(854, 480);

   public fbq(int $$0, int $$1) {
      super(true);
      this.e($$0, $$1);
   }
   ...
   static enum a {
      ...
      private static final fbq.a[] e = values();
   ...
   static class b {
      ...
      static List<fbq.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new fbq.b($$0, $$1), fbq.l) : ImmutableList.of(fbq.l);
      }
