...
public class fbq {
   ...
   private int j;
   private double k;
   private final aya l = new aya();
   private final aya m = new aya();
   private double n;
   private double o;
   private double p;
   private double q;
      ...
      if ($$0 == this.a.aO().i()) {
         ...
         if (this.a.aL() == null) {
            if (this.a.y == null) {
               ...
               if ($$4) {
                  $$9.w();
                  fjo.a(() -> $$6[0] = $$9.a($$7, $$8, $$5), "mouseClicked event handler", $$9.getClass().getCanonicalName());
               } else {
                  fjo.a(() -> $$6[0] = $$9.b($$7, $$8, $$5), "mouseReleased event handler", $$9.getClass().getCanonicalName());
               }
            }
         }
            ...
            if (this.a.y != null) {
               ...
               if (this.a.s.N_()) {
                  if (this.a.l.g().a()) {
                     ...
                     float $$12 = axk.a(this.a.s.ga().a() + (float)$$10 * 0.005F, 0.0F, 0.2F);
                     this.a.s.ga().a($$12);
                  }
               } else {
   ...
   public void a() {
      ...
      if (this.a.aC()) {
         ...
         if ($$2 != null && this.a.aL() == null && (this.n != 0.0 || this.o != 0.0)) {
            ...
            fjo.a(() -> $$2.f($$3, $$4), "mouseMoved event handler", $$2.getClass().getCanonicalName());
            if (this.h != -1 && this.k > 0.0) {
               ...
               fjo.a(() -> $$2.a($$3, $$4, this.h, $$5, $$6), "mouseDragged event handler", $$2.getClass().getCanonicalName());
            }
   ...
   private void a(double $$0) {
      ...
      if (this.a.m.ab) {
         ...
         $$6 = $$4;
         $$7 = $$5;
      } else if (this.a.m.aA().a() && this.a.s.gx()) {
         this.l.a();
         this.m.a();
         $$6 = this.n * $$2;
         $$7 = this.o * $$2;
   ...
   public void i() {
      if (this.a.aC()) {
         if (!this.s) {
            ...
            evd.a(this.a.aO().i(), 212995, this.e, this.f);
            this.a.a(null);
            this.a.w = 10000;
            this.i = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.e = (double)(this.a.aO().m() / 2);
         this.f = (double)(this.a.aO().n() / 2);
         evd.a(this.a.aO().i(), 212993, this.e, this.f);
      }
   }
