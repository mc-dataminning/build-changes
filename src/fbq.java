public class fbq extends etm<fbq.a> {
   static final aew a = new aew("transferable_list/select_highlighted");
   static final aew m = new aew("transferable_list/select");
   static final aew n = new aew("transferable_list/unselect_highlighted");
   static final aew o = new aew("transferable_list/unselect");
   static final aew p = new aew("transferable_list/move_up_highlighted");
   static final aew q = new aew("transferable_list/move_up");
   static final aew s = new aew("transferable_list/move_down_highlighted");
   static final aew t = new aew("transferable_list/move_down");
   ...
   public static class a extends etm.a<fbq.a> {
      ...
      private static arj a(eqv $$0, tl $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
