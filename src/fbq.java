...
public class fbq {
   ...
   private static final Map<dso.a, String> e = ac.a(new EnumMap<>(dso.a.class), $$0 -> {
      $$0.put(dso.a.a, "SW");
      $$0.put(dso.a.b, "S");
      $$0.put(dso.a.c, "OW");
      $$0.put(dso.a.d, "O");
   ...
   private dpi l;
   @Nullable
   private CompletableFuture<dpi> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bix r = new bix(1);
   private final bix s = new bix(bjc.values().length);
   private final bix t = new bix(1);
   private final bix u = new bix(1);
   private final Map<biy, bix> v = Map.of(biy.a, this.s);
   private final fcz w;
   private final fdb x;
   private final fda y;
   private final fcy z;
   ...
   public fbq(ezi $$0) {
      ...
      this.g = new fbq.a();
      this.h = $$0.h;
      this.w = new fcz(this.h, this.r);
      this.x = new fdb(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fda(this.h, this.t);
      this.z = new fcy(this.h, this.u);
   }
   ...
   private void a(fav $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         cxb $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof apf ? ((apf)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add("");
         $$25.add(String.format(Locale.ROOT, "XYZ: %.3f / %.5f / %.3f", this.f.ao().dr(), this.f.ao().dt(), this.f.ao().dx()));
         $$25.add(String.format(Locale.ROOT, "Block: %d %d %d [%d %d %d]", $$14.u(), $$14.v(), $$14.w(), $$14.u() & 15, $$14.v() & 15, $$14.w() & 15));
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, je.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, aww.g($$15.dC()), aww.g($$15.dE())));
         dpi $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(cxk.a, $$14);
            int $$30 = this.f.r.a(cxk.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dpi $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dso.a $$33 : dso.a.values()) {
               if ($$33.b()) {
            ...
            $$25.add($$32.toString());
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.ak()) {
               $$25.add("Biome: " + a(this.f.r.t($$14)));
               if ($$31 != null) {
                  float $$35 = $$23.ao();
                  long $$36 = $$31.u();
                  bnb $$37 = new bnb($$23.aj(), $$23.Y(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            cxm.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bps> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bps.values())
   ...
   private static String a(il<cya> $$0) {
   ...
   private cxb r() {
      return (cxb)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ad()))), this.f.r);
   }
   ...
   private dpi s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dpc.n, false).thenApply($$0x -> (dpi)$$0x.map($$0xx -> (dpi)$$0xx, $$0xx -> null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", esu.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ezi.Q().aO().k(), ezi.Q().aO().l(), esu.a()),
            esu.c(),
            esu.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == epr.a.b) {
            ...
            $$4.add(String.valueOf(ki.e.b($$6.b())));

            for (Entry<doe<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == epr.a.b) {
            ...
            $$4.add(String.valueOf(ki.c.b($$9.a())));

            for (Entry<doe<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(ki.g.b($$11.ai())));
         }
   ...
   private String a(Entry<doe<?>, Comparable<?>> $$0) {
      doe<?> $$1 = $$0.getKey();
