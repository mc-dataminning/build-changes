...
public abstract class dbc {
   ...
   public void a(bsb<?> $$0, @Nullable dca $$1, ayt $$2, ir $$3) {
      this.a($$1, $$2, $$3).a().a("id", lh.g.b($$0).toString());
   }
   ...
   public void a(dca $$0, ir $$1) {
      if (!this.c($$0, $$1)) {
         ...
         $$0.a(lb.ac, $$3, $$4, $$5, 0.0, 0.0, 0.0);
         $$0.a(lb.E, $$3, $$4, $$5, 0.0, 0.0, 0.0);
         if (this.d > 0) {
            this.d--;
         }
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!btj.a($$7.get(), $$0, bss.c, $$13, $$0.F_())) {
                     continue;
                  }

                  brv $$15 = bsb.a($$6, $$0, $$3x -> {
                     $$3x.b($$10, $$11, $$12, $$3x.dK(), $$3x.dM());
                     return $$3x;
                  });
                  if ($$15 == null) {
                     this.d($$0, $$1);
                  ...
                  int $$16 = $$0.a(
                        dxj.b($$15.getClass()),
                        new ewp((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bsa.f
                     )
                     .size();
                  ...
                  $$15.b($$15.dz(), $$15.dB(), $$15.dF(), $$3.i() * 360.0F, 0.0F);
                  if ($$15 instanceof bsq $$17) {
                     ...
                     if ($$18) {
                        ((bsq)$$15).a($$0, $$0.d_($$15.du()), bss.c, null);
                     }
                  }
   ...
   public void a(@Nullable dca $$0, ir $$1, uk $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dcr $$4 = dcr.b.parse(uy.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dcr::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dcr.c.parse(uy.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bok::b);
      } else {
         this.e = bok.a(this.f != null ? this.f : new dcr());
      }
   ...
   public uk a(uk $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (vh)dcr.b.encodeStart(uy.a, this.f).result().orElseThrow(() -> new IllegalStateException("Invalid SpawnData")));
      }

      $$0.a("SpawnPotentials", (vh)dcr.c.encodeStart(uy.a, this.e).result().orElseThrow());
      return $$0;
   }

   @Nullable
   public brv b(dca $$0, ir $$1) {
      if (this.l == null) {
         uk $$2 = this.a($$0, $$0.F_(), $$1).a();
         if (!$$2.b("id", 8)) {
            return null;
         }

         this.l = bsb.a($$2, $$0, Function.identity());
   ...
   protected void a(@Nullable dca $$0, ir $$1, dcr $$2) {
      this.f = $$2;
   }

   private dcr a(@Nullable dca $$0, ayt $$1, ir $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bom.b::b).orElseGet(dcr::new));
         return this.f;
      }
   }

   public abstract void a(dca var1, ir var2, int var3);
