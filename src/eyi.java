...
public class eyi extends eyl {
   public static final int a = 854;
   public static final int b = 480;
   static final eyi.b l = new eyi.b(854, 480);
   ...
   static enum a {
      ...
      private static final eyi.a[] e = values();
   ...
   static class b {
      ...
      static List<eyi.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eyi.b($$0, $$1), eyi.l) : ImmutableList.of(eyi.l);
      }
