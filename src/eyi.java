...
public class eyi {
   ...
   @Nullable
   private String g;
   private static final eyi.a h = new eyi.a() {
      @Nullable
      @Override
      public eyh a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (eyl.a(this.d, "Get capabilities")) {
         ...
         if (eyl.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  eyl.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !eyl.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public eyh a(eyi.c $$0) {
      return ($$0 == eyi.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements eyi.a {
      private final int a;
      private final Set<eyh> b = Sets.newIdentityHashSet();
      ...
      public eyh a() {
         if (this.b.size() >= this.a) {
            if (aa.aW) {
               eyi.a.warn("Maximum sound pool size {} reached", this.a);
            }
