...
public class eyi {
   private static final aep a = new aep("advancements/title_box");
   ...
   private final ara r;
   private final int s;
   private final List<ara> t;
   private final eqn u;
   @Nullable
   private eyi v;
   private final List<eyi> w = Lists.newArrayList();
   @Nullable
   private ag x;
   private final int y;
   private final int z;

   public eyi(eyg $$0, eqn $$1, ae $$2, an $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = qn.a().a($$1.h.a($$3.a(), 163));
      this.y = aro.d($$3.f() * 28.0F);
      this.z = aro.d($$3.g() * 27.0F);
      int $$4 = $$2.i();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = qn.a().a(this.a(tg.a($$3.b().e(), ua.a.a($$3.e().b())), $$7));
   ...
   private static float a(eqz $$0, List<ti> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<ti> a(te $$0, int $$1) {
      eqz $$2 = this.u.h.b();
      List<ti> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<ti> $$6 = $$2.b($$0, $$1 - $$5, ua.a);
   ...
   public void a(erx $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
