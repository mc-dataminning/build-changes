...
public class eyi {
   private final List<ConcurrentLinkedQueue<eyh>> a = ImmutableList.of(
   ...
   public void a(eyh $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eyh> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eyh> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eyh> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eyh> j() {
