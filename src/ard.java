...
public class ard implements AutoCloseable {
   ...
   private ard(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ard.a a(Path $$0) {
         return new ard.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
