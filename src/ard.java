...
public interface ard {
   ard a = new ard() {
      ...
      @Override
      public void a(Consumer<dje> $$0) {
      }
   };

   static ard a(dje $$0, int $$1) {
      return new ard.a($$0, $$1);
   }

   static void a(ard $$0, ard $$1, Consumer<dje> $$2, Consumer<dje> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof ard.a $$4 && $$1 instanceof ard.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new dje($$10, $$11));
                     } else {
                        $$3.accept(new dje($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(dje b, int c) implements ard {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(ard.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return ard.a(this.b.h, this.b.i, this.c, $$0, $$1, $$2);
      }
