...
public class fef {
   ...
   @Nullable
   private String g;
   private static final fef.a h = new fef.a() {
      @Nullable
      @Override
      public fee a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fei.a(this.d, "Get capabilities")) {
         ...
         if (fei.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fei.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fei.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fee a(fef.c $$0) {
      return ($$0 == fef.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fef.a {
      private final int a;
      private final Set<fee> b = Sets.newIdentityHashSet();
      ...
      public fee a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fef.a.warn("Maximum sound pool size {} reached", this.a);
            }
