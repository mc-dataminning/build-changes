...
public class fef extends fda {
   ...
   private String x = "";
   private final ezx y = new ezx(this::P, this::b, this::n, this::a, $$0x -> $$0x.length() < 1024 && this.i.b($$0x, 114) <= 128);
   private final ezx z = new ezx(() -> this.x, $$0x -> this.x = $$0x, this::n, this::a, $$0x -> $$0x.length() < 16);
   private long A;
   private int B = -1;
   private ffh C;
   private ffh D;
   ...
   private final bjz I;
   @Nullable
   private fef.a J = fef.a.a;
   private vf K = ve.a;
   private final vf L;

   public fef(cfh $$0, cmx $$1, bjz $$2) {
      super(euz.a);
      this.p = $$0;
      this.q = $$1;
      this.I = $$2;
   ...
   private String n() {
      return this.f != null ? ezx.b(this.f) : "";
   }
   ...
   protected void aN_() {
      this.R();
      this.F = this.d((exf)exf.a(vf.c("book.signButton"), $$0x -> {
         this.t = true;
         this.I();
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.E = this.d((exf)exf.a(ve.d, $$0x -> {
         this.f.a(null);
         this.c(false);
      }).a(this.g / 2 + 2, 196, 98, 20).a());
      this.G = this.d((exf)exf.a(vf.c("book.finalizeButton"), $$0x -> {
         if (this.t) {
            this.c(true);
            this.f.a(null);
         }
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.H = this.d((exf)exf.a(ve.e, $$0x -> {
         if (this.t) {
            this.t = false;
         }
      ...
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.C = this.d(new ffh($$0 + 116, 159, true, $$0x -> this.H(), true));
      this.D = this.d(new ffh($$0 + 43, 159, false, $$0x -> this.E(), true));
      this.I();
   }
   ...
   public void b(ewt $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      $$0.a(feg.l, (this.g - 192) / 2, 2, 0, 0, 192, 192);
   }

   private void a(ewt $$0, fef.c $$1, boolean $$2) {
      if (this.u / 6 % 2 == 0) {
         $$1 = this.b($$1);
         if (!$$2) {
   ...
   private void a(ewt $$0, ftl[] $$1) {
      for (ftl $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(fto.D(), $$3, $$4, $$5, $$6, -16776961);
      }
   }

   private fef.c a(fef.c $$0) {
      return new fef.c($$0.a - (this.g - 192) / 2 - 36, $$0.b - 32);
   }

   private fef.c b(fef.c $$0) {
      return new fef.c($$0.a + (this.g - 192) / 2 + 36, $$0.b + 32);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if ($$2 == 0) {
            long $$3 = ac.b();
            fef.a $$4 = this.Q();
            int $$5 = $$4.a(this.i, this.a(new fef.c((int)$$0, (int)$$1)));
            if ($$5 >= 0) {
   ...
   private void b(int $$0) {
      String $$1 = this.P();
      this.y.a(evt.a($$1, -1, $$0, false), evt.a($$1, 1, $$0, false));
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$2 == 0) {
            fef.a $$5 = this.Q();
            int $$6 = $$5.a(this.i, this.a(new fef.c((int)$$0, (int)$$1)));
            this.y.c($$6, true);
            this.R();
         }
   ...
   private fef.a T() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<fef.b> $$4 = Lists.newArrayList();
         ...
         $$7.a($$0, 114, wc.a, true, ($$5x, $$6x, $$7x) -> {
            ...
            int $$11 = $$8x * 9;
            fef.c $$12 = this.b(new fef.c(0, $$11));
            $$3.add($$6x);
            $$4.add(new fef.b($$5x, $$10, $$12.a, $$12.b));
         });
         int[] $$8 = $$3.toIntArray();
         boolean $$9 = $$1 == $$0.length();
         fef.c $$10;
         if ($$9 && $$6.isTrue()) {
            $$10 = new fef.c(0, $$4.size() * 9);
         } else {
            int $$11 = a($$8, $$1);
            int $$12 = this.i.b($$0.substring($$8[$$11], $$1));
            $$10 = new fef.c($$12, $$11 * 9);
         }

         List<ftl> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
            ...
            if ($$17 == $$18) {
               ...
               for (int $$22 = $$17 + 1; $$22 < $$18; $$22++) {
                  ...
                  int $$25 = (int)$$7.a($$24);
                  $$14.add(this.a(new fef.c(0, $$23), new fef.c($$25, $$23 + 9)));
               }
         ...
         return new fef.a($$0, $$10, $$9, $$8, $$4.toArray(new fef.b[0]), $$14.toArray(new ftl[0]));
      }
   }
   ...
   private ftl a(String $$0, evt $$1, int $$2, int $$3, int $$4, int $$5) {
      String $$6 = $$0.substring($$5, $$2);
      String $$7 = $$0.substring($$5, $$3);
      fef.c $$8 = new fef.c((int)$$1.a($$6), $$4);
      fef.c $$9 = new fef.c((int)$$1.a($$7), $$4 + 9);
      return this.a($$8, $$9);
   }

   private ftl a(fef.c $$0, fef.c $$1) {
      fef.c $$2 = this.b($$0);
      fef.c $$3 = this.b($$1);
      ...
      return new ftl($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final fef.a a = new fef.a("", new fef.c(0, 0), true, new int[]{0}, new fef.b[]{new fef.b(wc.a, "", 0, 0)}, new ftl[0]);
      ...
      public a(String $$0, fef.c $$1, boolean $$2, int[] $$3, fef.b[] $$4, ftl[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
