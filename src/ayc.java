...
public class ayc {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, d, $$0 -> aye.b.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayc.c> r = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alb.b($$0.substring(1)).map($$0x -> new ayc.c($$0x, true)) : alb.b($$0).map($$0x -> new ayc.c($$0x, false)), ayc.c::c
      );
   ...
   public static final Codec<String> w = Codec.string(0, 16)
      .validate($$0 -> azq.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   ...
   public static Codec<String> A = Codec.STRING
      .validate($$0 -> !alb.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ayc.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayc.b<>($$0, $$1);
   }
