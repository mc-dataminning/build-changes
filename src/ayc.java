...
public class ayc<T> extends AbstractList<T> implements azm<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return ayc.this.get(this.b--);
      }

      @Override
      public void remove() {
         ayc.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements azm<T> {
      private final ayc<T> b;

      public b(final ayc<T> $$0) {
         this.b = $$0;
      }
