...
public class ayc extends baq {
   public ayc(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bbq.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bbq.z.typeName(), bcy.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bbq.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bbq.z.typeName(), "minecraft:saddle"));
