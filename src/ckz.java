...
public class ckz {
   ...
   private int g = ayd.b(ayk.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jr.a.fieldOf("uuid").forGetter(Pair::getFirst), axm.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bru> j;
   @VisibleForTesting
   protected final ArrayList<bru> c;
   private final ckz.a k;
   @VisibleForTesting
   protected final Object2IntMap<bru> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<ckz> a(Predicate<bru> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(ckz::b)).apply($$1, $$1x -> new ckz($$0, $$1x))
      );
   }

   public ckz(Predicate<bru> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new ckz.a(this);
   ...
   public void a(aqm $$0, Predicate<bru> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bru>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bru> $$6 = (Entry<bru>)$$5.next();
         int $$7 = $$6.getIntValue();
         bru $$8 = (bru)$$6.getKey();
         bru.c $$9 = $$8.dL();
   ...
   @VisibleForTesting
   protected static record a(ckz a) implements Comparator<bru> {
      public int a(bru $$0, bru $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof clw;
               boolean $$7 = $$1 instanceof clw;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
