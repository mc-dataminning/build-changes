...
public class ckz extends cky implements cmo {
   private static final Logger b = LogUtils.getLogger();
   private static final akk<Boolean> c = ako.a(ckz.class, akm.k);
   private static final akk<cmn> d = ako.a(ckz.class, akm.u);
   ...
   public ckz(btc<? extends ckz> $$0, dca $$1) {
      super($$0, $$1);
      lp.z.a(this.ah).ifPresent($$0x -> this.a(this.gB().a((cmp)$$0x.a())));
   }
   ...
   protected void a(ako.a $$0) {
      super.a($$0);
      $$0.a(c, false);
      $$0.a(d, new cmn(cmr.c, cmp.b, 1));
   }

   @Override
   public void b(us $$0) {
      super.b($$0);
      cmn.c.encodeStart(vg.a, this.gB()).resultOrPartial(b::error).ifPresent($$1 -> $$0.a("VillagerData", $$1));
      if (this.ci != null) {
         $$0.a("Offers", (vp)daz.a.encodeStart(this.dR().a(vg.a), this.ci).getOrThrow());
      }
   ...
   public void a(us $$0) {
      ...
      if ($$0.b("VillagerData", 10)) {
         DataResult<cmn> $$1 = cmn.c.parse(new Dynamic(vg.a, $$0.c("VillagerData")));
         $$1.resultOrPartial(b::error).ifPresent(this::a);
      }

      if ($$0.e("Offers")) {
         daz.a.parse(this.dR().a(vg.a), $$0.c("Offers")).resultOrPartial(ac.a("Failed to load offers: ", b::warn)).ifPresent($$0x -> this.ci = $$0x);
      }
   ...
   private void a(@Nullable UUID $$0, int $$1) {
      ...
      this.ap().a(c, true);
      this.e(bsg.r);
      this.b(new bse(bsg.e, $$1, Math.min(this.dP().al().a() - 1, 0)));
   ...
   private void c(arf $$0) {
      cmm $$1 = this.a(btc.bj, false);

      for (btd $$2 : btd.values()) {
         cur $$3 = this.a($$2);
         if (!$$3.e()) {
            if (dad.f($$3)) {
               $$1.a_($$2.b() + 300).a($$3);
         ...
         for (int $$3 = (int)this.du() - 4; $$3 < (int)this.du() + 4 && $$1 < 14; $$3++) {
            for (int $$4 = (int)this.dw() - 4; $$4 < (int)this.dw() + 4 && $$1 < 14; $$4++) {
               for (int $$5 = (int)this.dA() - 4; $$5 < (int)this.dA() + 4 && $$1 < 14; $$5++) {
                  dse $$6 = this.dP().a_($$2.d($$3, $$4, $$5));
                  if ($$6.a(dfd.eW) || $$6.b() instanceof deu) {
                     if (this.ah.i() < 0.3F) {
                        $$0++;
                     }
