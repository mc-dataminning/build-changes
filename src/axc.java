...
public class axc implements AutoCloseable {
   ...
   private axc(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static axc.a a(Path $$0) {
         return new axc.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
