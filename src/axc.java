...
public interface axc {
   ...
   static <E extends Enum<E> & axc> axc.a<E> a(Supplier<E[]> $$0) {
      return a($$0, $$0x -> $$0x);
   }

   static <E extends Enum<E> & axc> axc.a<E> a(Supplier<E[]> $$0, Function<String, String> $$1) {
      E[] $$2 = (E[])$$0.get();
      Function<String, E> $$3 = a($$2, $$1);
      return new axc.a<>($$2, $$3);
   }

   static <T extends axc> Codec<T> b(Supplier<T[]> $$0) {
      T[] $$1 = (T[])$$0.get();
      Function<String, T> $$2 = a($$1, $$0x -> $$0x);
      ToIntFunction<T> $$3 = ac.e(Arrays.asList($$1));
      return new axc.b<>($$1, $$2, $$3);
   }

   static <T extends axc> Function<String, T> a(T[] $$0, Function<String, String> $$1) {
      if ($$0.length > 16) {
         Map<String, T> $$2 = Arrays.<axc>stream($$0).collect(Collectors.toMap($$1x -> $$1.apply($$1x.c()), $$0x -> (T)$$0x));
   ...
   static Keyable a(final axc[] $$0) {
      return new Keyable() {
         public <T> Stream<T> keys(DynamicOps<T> $$0x) {
            return Arrays.stream($$0).map(axc::c).map($$0::createString);
         }
      };
   }

   @Deprecated
   public static class a<E extends Enum<E> & axc> extends axc.b<E> {
   ...
   public static class b<S extends axc> implements Codec<S> {
