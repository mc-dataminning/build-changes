public class bwm extends bvk {
   private static final int b = 60;
   private static final int c = 120;
   private static final String d = "spawn_item_after_ticks";
   private static final String e = "item";
   private static final alc<cxp> f = alg.a(bwm.class, ale.h);
   public static final int a = 36;
   private long g;

   public bwm(bvr<? extends bwm> $$0, dhi $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public static bwm a(dhi $$0, cxp $$1) {
      bwm $$2 = new bwm(bvr.aK, $$0);
   ...
   private void s() {
      if (this.dW() instanceof ash $$0) {
         ...
         if (!$$2.f()) {
            bvk $$4;
            if ($$2.h() instanceof cyk $$3) {
               $$4 = this.a($$0, $$3, $$2);
            } else {
               $$4 = new cmb($$0, this.dB(), this.dD(), this.dH(), $$2);
               $$0.b($$4);
            }
   ...
   private bvk a(ash $$0, cyk $$1, cxp $$2) {
      cyk.a $$3 = $$1.b();
      $$3.e().ifPresent($$1x -> $$0.c($$1x, this.dw(), 0));
      jm $$4 = jm.a;
      cqq $$5 = cqq.a($$1.a($$0, this.du(), $$2, $$4), $$0, $$2, (double)$$4.j(), (double)$$4.k(), (double)$$4.l(), $$3.d(), $$3.c());
      $$5.c(this);
      return $$5;
   }
   ...
   protected void a(ux $$0) {
      cxp $$1 = $$0.b("item", 10) ? cxp.a(this.dY(), (vu)$$0.p("item")).orElse(cxp.j) : cxp.j;
      this.a($$1);
