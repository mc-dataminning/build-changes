...
public abstract class gwq extends fod {
   ...
   private final List<gwo> a = Lists.newArrayList();
   ...
   protected gwo a(gwo $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public wz m() {
      return wy.a(this.a.stream().map(gwo::a).collect(Collectors.toList()));
   }
}
