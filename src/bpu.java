...
public record bpu(Instant a, String b, long c) {
   ...
   public static bpu a(RecordedEvent $$0) {
      ...
      return new bpu($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bpu.a a(List<bpu> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bpu>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bpu $$3 = (bpu)$$2x.get(0);
            bpu $$4 = (bpu)$$2x.get($$2x.size() - 1);
