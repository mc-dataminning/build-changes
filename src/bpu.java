...
public class bpu extends bpy {
   public static final MapCodec<bpu> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bpu a(float $$0, float $$1, float $$2, float $$3) {
      return new bpu($$0, $$1, $$2, $$3);
   }

   private bpu(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
