public abstract class bpu extends bqd {
   protected bjk d;
   protected gw e = gw.b;
   protected boolean f;
   private boolean a;
   ...
   protected boolean h() {
      if (!this.f) {
         ...
         dfl $$0 = this.d.dL().a_(this.e);
         if (!($$0.b() instanceof cuz)) {
            this.f = false;
            return false;
         } else {
            return $$0.c(cuz.b);
   ...
   protected void a(boolean $$0) {
      if (this.f) {
         dfl $$1 = this.d.dL().a_(this.e);
         if ($$1.b() instanceof cuz) {
            ((cuz)$$1.b()).a(this.d, this.d.dL(), $$1, this.e, $$0);
         }
      }
   }
