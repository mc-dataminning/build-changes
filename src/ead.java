...
public class ead {
   ...
   public ead(dja $$0, iu $$1, ja $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      eah $$0 = this.b.a_(this.e);
      if (!dzz.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == ewt.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(eah $$0) {
      return $$0.a(dmh.ix) || $$0.a(dmh.pO);
   }

   private static boolean a(eah $$0, eah $$1) {
      if ($$0.a(dmh.pO) && $$1.a(dmh.ix)) {
         return false;
      } else {
         return $$0.a(dmh.ix) && $$1.a(dmh.pO) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(iu $$0, ja $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!dzz.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               eah $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !dzz.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dzz.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
