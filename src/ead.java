...
public class ead implements ebd<buk> {
   ...
   public ead(eao $$0, arc $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
   ...
   @Override
   public CompletableFuture<eay<buk>> a(dfo $$0) {
   ...
   private static eay<buk> b(dfo $$0) {
      return new eay<>($$0, ImmutableList.of());
   }

   @Override
   public void a(eay<buk> $$0) {
      dfo $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
