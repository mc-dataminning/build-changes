public class fwo extends ftz {
   private static final int a = 12235202;

   protected fwo(fsa $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, fwb $$8) {
   ...
   public static class a implements fvj<kf> {
      ...
      public fvg a(kf $$0, fsa $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         return new fwo($$1, $$2, $$3, $$4, $$9, $$10, $$11, 1.0F, this.a);
      }
   }
}
