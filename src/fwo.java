...
public class fwo extends fuk {
   ...
   private static final ImmutableList<dyf> y = ImmutableList.copyOf(dyf.values());
   private static final ImmutableList<dyf> z = y.stream().filter($$0 -> $$0 != dyf.d).collect(ImmutableList.toImmutableList());
   private final dvq A;
   private dok B = dok.a;
   private dqd C = dqd.a;
   private dyf D = dyf.d;
   ...
   @Override
   protected void aR_() {
      this.c((fos)fos.a(wo.d, $$0x -> this.m()).a(this.n / 2 - 4 - 150, 210, 150, 20).a());
      this.c((fos)fos.a(wo.e, $$0x -> this.E()).a(this.n / 2 + 4, 210, 150, 20).a());
      this.B = this.A.k();
      this.C = this.A.s();
      this.D = this.A.u();
      this.E = this.A.v();
      this.F = this.A.D();
      this.G = this.A.E();
      this.R = this.c((fos)fos.a(wp.c("structure_block.button.save"), $$0x -> {
         if (this.A.u() == dyf.a) {
            this.a(dvq.a.b);
            this.m.a(null);
         }
      }).a(this.n / 2 + 4 + 100, 185, 50, 20).a());
      this.S = this.c((fos)fos.a(wp.c("structure_block.button.load"), $$0x -> {
         if (this.A.u() == dyf.b) {
            this.a(dvq.a.c);
            this.m.a(null);
         }
      ...
      this.c(
         foz.<dyf>a($$0x -> wp.c("structure_block.mode." + $$0x.c()))
            .a(z, y)
            .a()
            .a(this.D)
      ...
      this.X = this.c((fos)fos.a(wp.c("structure_block.button.detect_size"), $$0x -> {
         if (this.A.u() == dyf.a) {
            this.a(dvq.a.d);
            this.m.a(null);
         }
      ...
      this.Z = this.c(foz.<dok>a(dok::b).a(dok.values()).a().a(this.B).a(this.n / 2 - 20, 185, 40, 20, wp.b("MIRROR"), ($$0x, $$1x) -> this.A.a($$1x)));
      ...
      this.T = this.c((fos)fos.a(wp.b("0"), $$0x -> {
         this.A.a(dqd.a);
         this.F();
      }).a(this.n / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20).a());
      this.U = this.c((fos)fos.a(wp.b("90"), $$0x -> {
         this.A.a(dqd.b);
         this.F();
      }).a(this.n / 2 - 1 - 40 - 20, 185, 40, 20).a());
      this.V = this.c((fos)fos.a(wp.b("180"), $$0x -> {
         this.A.a(dqd.c);
         this.F();
      }).a(this.n / 2 + 1 + 20, 185, 40, 20).a());
      this.W = this.c((fos)fos.a(wp.b("270"), $$0x -> {
         this.A.a(dqd.d);
         this.F();
      }).a(this.n / 2 + 1 + 40 + 1 + 20, 185, 40, 20).a());
      this.H = new fpb(this.p, this.n / 2 - 152, 40, 300, 20, wp.c("structure_block.structure_name")) {
         @Override
      ...
      this.d(this.H);
      ji $$0 = this.A.f();
      this.I = new fpb(this.p, this.n / 2 - 152, 80, 80, 20, wp.c("structure_block.position.x"));
      this.I.f(15);
      this.I.a(Integer.toString($$0.u()));
      this.d(this.I);
      this.J = new fpb(this.p, this.n / 2 - 72, 80, 80, 20, wp.c("structure_block.position.y"));
      this.J.f(15);
      this.J.a(Integer.toString($$0.v()));
      this.d(this.J);
      this.K = new fpb(this.p, this.n / 2 + 8, 80, 80, 20, wp.c("structure_block.position.z"));
      this.K.f(15);
      this.K.a(Integer.toString($$0.w()));
      this.d(this.K);
      km $$1 = this.A.j();
      this.L = new fpb(this.p, this.n / 2 - 152, 120, 80, 20, wp.c("structure_block.size.x"));
      this.L.f(15);
      this.L.a(Integer.toString($$1.u()));
      this.d(this.L);
      this.M = new fpb(this.p, this.n / 2 - 72, 120, 80, 20, wp.c("structure_block.size.y"));
      this.M.f(15);
      this.M.a(Integer.toString($$1.v()));
      this.d(this.M);
      this.N = new fpb(this.p, this.n / 2 + 8, 120, 80, 20, wp.c("structure_block.size.z"));
      this.N.f(15);
      this.N.a(Integer.toString($$1.w()));
      this.d(this.N);
      this.O = new fpb(this.p, this.n / 2 - 152, 120, 80, 20, wp.c("structure_block.integrity.integrity"));
      this.O.f(15);
      this.O.a(this.ac.format((double)this.A.w()));
      this.d(this.O);
      this.P = new fpb(this.p, this.n / 2 - 72, 120, 80, 20, wp.c("structure_block.integrity.seed"));
      this.P.f(31);
      this.P.a(Long.toString(this.A.x()));
      this.d(this.P);
      this.Q = new fpb(this.p, this.n / 2 - 152, 120, 240, 20, wp.c("structure_block.custom_data"));
      this.Q.f(128);
      this.Q.a(this.A.t());
      this.d(this.Q);
      this.F();
