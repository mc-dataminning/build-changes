...
public abstract class fwo implements zk {
   ...
   protected final Map<akm, byte[]> h;

   protected fwo(fdz $$0, vv $$1, fwv $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2.f();
      this.d = $$2.e();
   ...
   public void a(zs $$0) {
      ...
      if (this.c == null) {
         ...
         fkr.a(Objects.requireNonNullElseGet(this.f, fmd::new), this.a, $$1, this.c, false, new fxj(this.h));
      }
   }
   ...
   protected fly b(wx $$0) {
      fly $$1 = Objects.requireNonNullElseGet(this.f, () -> new fow(new fmd()));
      return (fly)(this.c != null && this.c.e() ? new gtu($$1, i, $$0) : new fkz($$1, i, $$0));
   }
   ...
   private fly a(UUID $$0, URL $$1, String $$2, boolean $$3, @Nullable wx $$4) {
      fly $$5 = this.a.y;
   ...
   class b extends fkq {
      ...
      b(fdz $$0, @Nullable fly $$1, List<fwo.b.a> $$2, boolean $$3, @Nullable wx $$4) {
         super(
            $$5 -> {
               $$0.a($$1);
               gql $$6 = $$0.ae();
      ...
      public fwo.b a(fdz $$0, UUID $$1, URL $$2, String $$3, boolean $$4, @Nullable wx $$5) {
