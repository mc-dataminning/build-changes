...
public class amy {
                                    ...
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a("positioned")
                                       ...
                                       .then(ey.a("over").then(ey.a("heightmap", fn.a()).redirect($$2, $$0x -> {
                                          ...
                                          if (!$$2x.b(kk.b($$3), kk.b($$4))) {
                                             ...
                                             return ((ex)$$0x.getSource()).a(new faz($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
   ...
   private static ex a(ex $$0, Collection<fcd> $$1, fbw $$2, boolean $$3) {
      fce $$4 = $$0.l().aJ();
      return $$0.a(($$4x, $$5) -> {
         for (fcd $$6 : $$1) {
            fcc $$7 = $$4.c($$6, $$2);
                                          ...
                                          ey.a("pos", gt.a())
                                             .then(
                                                a(
                                                   ...
                                                   ey.a("block", gp.a($$3)),
                                                   $$2,
                                                   $$0x -> gp.a($$0x, "block").test(new dxa(((ex)$$0x.getSource()).e(), gt.a($$0x, "pos"), true))
                                                )
                                             )
                                       )
                                 ))
   ...
   private static int a(Iterable<? extends buk> $$0, ctz $$1, Predicate<cwo> $$2) {
      int $$3 = 0;
   ...
   private static int a(ex $$0, ji $$1, ctz $$2, Predicate<cwo> $$3) throws CommandSyntaxException {
      int $$4 = 0;
      bsc $$5 = ani.a($$0, $$1, ani.b);
      int $$6 = $$5.b();
      IntList $$7 = $$2.a();
   ...
   private static boolean a(CommandContext<ex> $$0, amy.e $$1) throws CommandSyntaxException {
      fcd $$2 = gc.a($$0, "target");
      fbw $$3 = fr.a($$0, "targetObjective");
      fcd $$4 = gc.a($$0, "source");
      fbw $$5 = fr.a($$0, "sourceObjective");
      fce $$6 = ((ex)$$0.getSource()).l().aJ();
      fca $$7 = $$6.d($$2, $$3);
      fca $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<ex> $$0, dk.d $$1) throws CommandSyntaxException {
      fcd $$2 = gc.a($$0, "target");
      fbw $$3 = fr.a($$0, "targetObjective");
      fce $$4 = ((ex)$$0.getSource()).l().aJ();
      fca $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(ex $$0, jr<eyz> $$1) {
      ard $$2 = $$0.e();
      evt $$3 = new evt.a($$2).a(eyk.f, $$0.d()).b(eyk.a, $$0.f()).a(eyj.d);
      evq $$4 = new evq.a($$3).a(Optional.empty());
      $$4.b(evq.a($$1.a()));
      return $$1.a().test($$4);
   }
   ...
   private static LiteralArgumentBuilder<ex> a(CommandNode<ex> $$0, LiteralArgumentBuilder<ex> $$1) {
      return (LiteralArgumentBuilder<ex>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                           ...
                           .then(
                              ey.a("leasher")
                                 .fork(
                                    $$0, a((Function<buk, Optional<buk>>)($$0x -> $$0x instanceof bve $$1x ? Optional.ofNullable($$1x.D()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           ey.a("target")
                  ...
                  .then(ey.a("vehicle").fork($$0, a((Function<buk, Optional<buk>>)($$0x -> Optional.ofNullable($$0x.dk()))))))
               .then(ey.a("controller").fork($$0, a((Function<buk, Optional<buk>>)($$0x -> Optional.ofNullable($$0x.cW()))))))
            .then(
               ey.a("origin").fork($$0, a((Function<buk, Optional<buk>>)($$0x -> $$0x instanceof bwf $$1x ? Optional.ofNullable($$1x.p()) : Optional.empty())))
            ))
         .then(ey.a("passengers").fork($$0, b((Function<buk, Stream<buk>>)($$0x -> $$0x.cY().stream()))));
   }

   private static ex a(ex $$0, jr.c<bur<?>> $$1) throws CommandSyntaxException {
      buk $$2 = aox.a($$0, $$1, $$0.d(), new tq(), true);
      return $$0.a($$2);
   }
