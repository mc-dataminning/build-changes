...
public class amy {
   ...
   public static BiMap<String, alj<djz>> a = ImmutableBiMap.of("o", djz.i, "n", djz.j, "e", djz.k);
   @Nullable
   ...
   private static int a(ek $$0) {
      if (h != null) {
         h.b();
         $$0.a(() -> xc.b("You have now stopped chasing"), false);
         h = null;
      }

      if (g != null) {
         g.b();
         $$0.a(() -> xc.b("You are no longer being chased"), false);
         g = null;
      }
   ...
   private static boolean b(ek $$0) {
      if (g != null) {
         $$0.b(xc.b("Chase server is already running. Stop it using /chase stop"));
         return true;
      } else if (h != null) {
         $$0.b(xc.b("You are already chasing someone. Stop it using /chase stop"));
         return true;
      } else {
         return false;
      }
   ...
   private static int a(ek $$0, String $$1, int $$2) {
      if (b($$0)) {
         ...
         g = new amq($$1, $$2, $$0.l().ag(), 100);

         try {
            g.a();
            $$0.a(() -> xc.b("Chase server is now running on port " + $$2 + ". Clients can follow you using /chase follow <ip> <port>"), false);
         } catch (IOException var4) {
            b.error("Failed to start chase server", var4);
            $$0.b(xc.b("Failed to start chase server on port " + $$2));
            g = null;
         }
