...
public class amy {
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               ChannelPipeline $$1 = $$0.pipeline().addLast("timeout", new ReadTimeoutHandler(30)).addLast("legacy_query", new amt(amy.this.d()));
               ts.a($$1, wl.a, null);
               int $$2 = amy.this.e.m();
               ts $$3 = (ts)($$2 > 0 ? new ud($$2) : new ts(wl.a));
               amy.this.g.add($$3);
               $$3.a($$1);
               $$3.b(new ana(amy.this.e, $$3));
            }
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<amy.a.a> d = Lists.newArrayList();
