...
public class ayf extends bcn {
   public ayf(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bdn.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bdn.s, "minecraft:piston");
