...
public class ayf {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, d, $$0 -> ayh.b.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayf.c> r = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ale.b($$0.substring(1)).map($$0x -> new ayf.c($$0x, true)) : ale.b($$0).map($$0x -> new ayf.c($$0x, false)), ayf.c::c
      );
   ...
   public static final Codec<String> w = Codec.string(0, 16)
      .validate($$0 -> azt.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   ...
   public static <K, V> ayf.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayf.b<>($$0, $$1);
   }
