public class ccf extends biq implements ccj {
   private static final aee<cjf> b = aeh.a(ccf.class, aeg.h);
   private double c;
   private double d;
   private double e;
   private int f;
   ...
   public void l() {
      ...
      double $$4 = $$0.h();
      this.s(ccm.d(this.O, (float)(arw.d($$0.d, $$4) * 180.0F / (float)Math.PI)));
      this.r(ccm.d(this.N, (float)(arw.d($$0.c, $$0.e) * 180.0F / (float)Math.PI)));
      if (!this.dL().B) {
         double $$5 = this.c - $$1;
         double $$6 = this.e - $$3;
         float $$7 = (float)Math.sqrt($$5 * $$5 + $$6 * $$6);
         float $$8 = (float)arw.d($$6, $$5);
         double $$9 = arw.d(0.0025, $$4, (double)$$7);
         double $$10 = $$0.d;
         if ($$7 < 1.0F) {
            $$9 *= 0.8;
            $$10 *= 0.8;
