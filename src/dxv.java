...
public class dxv implements dxu {
   public static final Codec<Double> a = Codec.doubleRange(0.0, 1.0);
   public static final Codec<dxv> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dsj.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dsl.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dsk.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bmh.b(1, 20).fieldOf("outer_wall_distance").orElse(bmn.a(4, 5)).forGetter($$0x -> $$0x.i),
               bmh.b(1, 20).fieldOf("distribution_points").orElse(bmn.a(3, 4)).forGetter($$0x -> $$0x.j),
               bmh.b(0, 10).fieldOf("point_offset").orElse(bmn.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public dxv(dsj $$0, dsl $$1, dsk $$2, double $$3, double $$4, boolean $$5, bmh $$6, bmh $$7, bmh $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
