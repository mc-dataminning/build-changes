...
public class ddd extends dcz {
   ...
   public ddd(gw $$0, dfd $$1) {
      super(ddb.N, $$0, $$1);
   }

   public boolean a(long $$0, cca $$1, ha $$2) {
      if (this.m == null) {
         this.m = $$2;
      }

      this.j = $$0 + 40L;
      if ($$0 >= this.k && this.o instanceof akt) {
         this.k = $$0 + 10L;
         this.a($$1);
         int $$3 = this.i();
         if (++this.i >= 10) {
            ...
            if ($$3 != $$4) {
               dfd $$5 = this.q();
               dfd $$6 = $$5.a(dft.bv, Integer.valueOf($$4));
               this.o.a(this.p(), $$6, 3);
            }
   ...
   public void a(cca $$0) {
      if (this.n != null && this.o != null && !this.o.w_() && this.o.n() != null) {
         ecs $$1 = this.o.n().aH().getLootTable(this.n);
         if ($$0 instanceof aku $$2) {
            al.N.a($$2, this.n);
         }

         ecq $$3 = new ecq.a((akt)this.o).a(eev.f, ehh.b(this.p)).a($$0.go()).a(eev.a, $$0).a(eeu.c);
         ObjectArrayList<cjl> $$4 = $$1.a($$3, this.r);
   ...
   private void b(cca $$0) {
      if (this.o != null && this.o.n() != null) {
         this.c($$0);
         dfd $$1 = this.q();
         this.o.c(3008, this.p(), ctc.i($$1));
         ctc $$4;
         if (this.q().b() instanceof cth $$3) {
            $$4 = $$3.b();
         } else {
            $$4 = cte.a;
         }
   ...
   private void c(cca $$0) {
      if (this.o != null && this.o.n() != null) {
         this.a($$0);
         if (!this.l.b()) {
            double $$1 = (double)bja.ad.k();
            double $$2 = 1.0 - $$1;
            double $$3 = $$1 / 2.0;
            ha $$4 = Objects.requireNonNullElse(this.m, ha.b);
            gw $$5 = this.p.a($$4, 1);
            double $$6 = (double)$$5.u() + 0.5 * $$2 + $$3;
            double $$7 = (double)$$5.v() + 0.5 + (double)(bja.ad.l() / 2.0F);
            double $$8 = (double)$$5.w() + 0.5 * $$2 + $$3;
            byt $$9 = new byt(this.o, $$6, $$7, $$8, this.l.a(this.o.z.a(21) + 10));
            $$9.f(ehh.b);
            this.o.b($$9);
            this.l = cjl.b;
         }
   ...
   public void c() {
      if (this.o != null) {
         if (this.i != 0 && this.o.V() >= this.j) {
            ...
            int $$1 = this.i();
            if ($$0 != $$1) {
               this.o.a(this.p(), this.q().a(dft.bv, Integer.valueOf($$1)), 3);
            }
