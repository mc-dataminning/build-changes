...
public class egh extends egm {
   ...
   public List<eeu.a> a(dcj $$0, BiConsumer<ja, dsh> $$1, aym $$2, int $$3, ja $$4, eee $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = aye.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, aye.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<egh.a> $$13 = Lists.newArrayList();
      $$13.add(new egh.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               ja $$21 = $$4.b(aye.a($$19), $$12 - 1, aye.a($$20));
               ja $$22 = $$21.b(5);
      ...
      List<eeu.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dcj $$0, BiConsumer<ja, dsh> $$1, aym $$2, ja $$3, ja $$4, boolean $$5, eee $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ja $$13 = $$3.b(aye.d(0.5F + (float)$$12 * $$9), aye.d(0.5F + (float)$$12 * $$10), aye.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dlr.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dcj $$0, BiConsumer<ja, dsh> $$1, aym $$2, int $$3, ja $$4, List<egh.a> $$5, eee $$6) {
      for (egh.a $$7 : $$5) {
         int $$8 = $$7.a();
