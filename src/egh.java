...
public class egh {
   ...
   private final Map<String, efw> b = Maps.newHashMap();
   private final DataFixer c;
   private final File d;

   public egh(File $$0, DataFixer $$1) {
      this.c = $$1;
      this.d = $$0;
   }
   ...
   public <T extends efw> T a(efw.a<T> $$0, String $$1) {
      T $$2 = this.b($$0, $$1);
      if ($$2 != null) {
         return $$2;
      } else {
   ...
   @Nullable
   public <T extends efw> T b(efw.a<T> $$0, String $$1) {
      efw $$2 = this.b.get($$1);
   ...
   @Nullable
   private <T extends efw> T a(Function<sn, T> $$0, avw $$1, String $$2) {
      try {
         File $$3 = this.a($$2);
         if ($$3.exists()) {
   ...
   public void a(String $$0, efw $$1) {
      this.b.put($$0, $$1);
   }

   public sn a(String $$0, avw $$1, int $$2) throws IOException {
      File $$3 = this.a($$0);
