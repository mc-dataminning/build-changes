...
public class egh extends efx<egg> {
   private static final float a = 0.06F;

   public egh(Codec<egg> $$0) {
      super($$0);
   }

   @Override
   public boolean a(efz<egg> $$0) {
      dhf $$1 = $$0.b();
      ji $$2 = $$0.e();
      azh $$3 = $$0.d();
      dys $$4 = $$0.c();
   ...
   private static boolean a(dhf $$0, ji $$1, egg $$2, boolean $$3) {
      if ($$0.a($$1, dwv.a::v)) {
         return true;
      } else {
   ...
   private void a(dhf $$0, azh $$1, egg $$2, ji $$3, int $$4, boolean $$5) {
      ji.a $$6 = new ji.a();
      dww $$7 = $$2.c;
      int $$8 = $$5 ? 1 : 0;
   ...
   private void b(dhf $$0, azh $$1, egg $$2, ji $$3, int $$4, boolean $$5) {
      ji.a $$6 = new ji.a();
      boolean $$7 = $$2.d.a(djn.lm);
   ...
   private void a(dgi $$0, azh $$1, egg $$2, ji.a $$3, float $$4, float $$5, float $$6) {
      if ($$1.i() < $$4) {
         this.a($$0, $$3, $$2.e);
      } else if ($$1.i() < $$5) {
         this.a($$0, $$3, $$2.d);
   ...
   private void a(dgi $$0, azh $$1, ji $$2, dww $$3, boolean $$4) {
      if ($$0.a_($$2.e()).a($$3.b())) {
         this.a($$0, $$2, $$3);
   ...
   private static void a(ji $$0, dgi $$1, azh $$2) {
      ji.a $$3 = $$0.k().c(jn.a);
      if ($$1.u($$3)) {
         int $$4 = ayz.a($$2, 1, 5);
         if ($$2.a(7) == 0) {
