...
public final class gho {
   ...
   private static final gho c = new gho(HostAndPort.fromParts("server.invalid", 25565));

   public gho(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private gho(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static gho a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new gho($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof gho ? this.b.equals(((gho)$$0).b) : false;
      }
   }
