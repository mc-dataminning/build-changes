...
public class dmu extends dmx<dmt> {
   ...
   public boolean a(dms $$0, dmt $$1, dhf $$2, Function<gw, he<cqt>> $$3, asc $$4, dke $$5, cpc $$6, dhe $$7) {
   ...
   protected void a(
      dms $$0, dmt $$1, dhf $$2, Function<gw, he<cqt>> $$3, dke $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dhe $$10, dmx.a $$11
   ) {
      double $$12 = 1.5 + (double)(arw.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(arw.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = arw.b($$13);
         $$6 += (double)(arw.b($$12) * $$27);
         $$7 += (double)arw.a($$13);
         $$8 += (double)(arw.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
