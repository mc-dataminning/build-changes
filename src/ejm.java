...
public class ejm extends ejt {
   private static final Codec<bro> b = bro.a
      .codec()
      .validate(
         $$0 -> $$0.b() - $$0.a() < 1
   ...
   public static final MapCodec<ejm> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bri.b(1, 3).fieldOf("branch_count").forGetter($$0x -> $$0x.h),
                  bri.b(2, 16).fieldOf("branch_horizontal_length").forGetter($$0x -> $$0x.i),
                  bri.a(-16, 0, b).fieldOf("branch_start_offset_from_top").forGetter($$0x -> $$0x.j),
                  bri.b(-16, 16).fieldOf("branch_end_offset_from_top").forGetter($$0x -> $$0x.l)
               )
            )
            .apply($$0, ejm::new)
   );
   ...
   public ejm(int $$0, int $$1, int $$2, bri $$3, bri $$4, bro $$5, bri $$6) {
      super($$0, $$1, $$2);
      this.h = $$3;
      this.i = $$4;
      this.j = $$5;
      this.k = bro.a($$5.a(), $$5.b() - 1);
      this.l = $$6;
   }
   ...
   public List<eib.a> a(dfh $$0, BiConsumer<jh, dvj> $$1, azs $$2, int $$3, jh $$4, ehl $$5) {
      ...
      List<eib.a> $$15 = new ArrayList<>();
      if ($$9) {
         $$15.add(new eib.a($$4.b($$11), 0, false));
      }

      jh.a $$16 = new jh.a();
      jm $$17 = jm.c.a.a($$2);
      Function<dvj, dvj> $$18 = $$1x -> $$1x.c(doq.i, $$17.o());
   ...
   private eib.a a(dfh $$0, BiConsumer<jh, dvj> $$1, azs $$2, int $$3, jh $$4, ehl $$5, Function<dvj, dvj> $$6, jm $$7, int $$8, boolean $$9, jh.a $$10) {
      $$10.g($$4).c(jm.b, $$8);
