...
public class ejm implements ejj {
   @Nullable
   ...
   public ejm(ByteBuffer $$0, STBTTFontinfo $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$3;
         ...
         label61: {
            ...
            label62: {
               try {
                  ...
                  if ($$11 > 0 && $$12 > 0) {
                     var18 = new ejm.a($$4.get(0), $$6.get(0), -$$5.get(0), -$$7.get(0), $$10, (float)$$9.get(0) * this.g, $$3);
                     break label62;
                  }
   ...
   class a implements eji {
      ...
      a(int $$0, int $$1, int $$2, int $$3, float $$4, float $$5, int $$6) {
         ...
         this.c = $$2 - $$3;
         this.f = $$4 / ejm.this.c;
         this.d = ($$5 + (float)$$0 + ejm.this.e) / ejm.this.c;
         this.e = (ejm.this.h - (float)$$2 + ejm.this.f) / ejm.this.c;
         this.g = $$6;
      }
      ...
      public euy bake(Function<ejk, euy> $$0) {
         return $$0.apply(new ejk() {
            ...
            public void a(int $$0, int $$1) {
               STBTTFontinfo $$2 = ejm.this.b();
               ekh $$3 = new ekh(ekh.a.d, a.this.b, a.this.c, false);
               $$3.a($$2, a.this.g, a.this.b, a.this.c, ejm.this.g, ejm.this.g, ejm.this.e, ejm.this.f, 0, 0);
