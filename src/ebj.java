...
public class ebj extends eaz<ebi> {
   private static final float a = 0.06F;

   public ebj(Codec<ebi> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebb<ebi> $$0) {
      dcu $$1 = $$0.b();
      iz $$2 = $$0.e();
      azh $$3 = $$0.d();
      dua $$4 = $$0.c();
   ...
   private static boolean a(dcu $$0, iz $$1, ebi $$2, boolean $$3) {
      if ($$0.a($$1, dsc.a::r)) {
         return true;
      } else {
   ...
   private void a(dcu $$0, azh $$1, ebi $$2, iz $$3, int $$4, boolean $$5) {
      iz.a $$6 = new iz.a();
      dsd $$7 = $$2.c;
      int $$8 = $$5 ? 1 : 0;
   ...
   private void b(dcu $$0, azh $$1, ebi $$2, iz $$3, int $$4, boolean $$5) {
      iz.a $$6 = new iz.a();
      boolean $$7 = $$2.d.a(dfc.kK);
   ...
   private void a(dca $$0, azh $$1, ebi $$2, iz.a $$3, float $$4, float $$5, float $$6) {
      if ($$1.i() < $$4) {
         this.a($$0, $$3, $$2.e);
      } else if ($$1.i() < $$5) {
         this.a($$0, $$3, $$2.d);
   ...
   private void a(dca $$0, azh $$1, iz $$2, dsd $$3, boolean $$4) {
      if ($$0.a_($$2.d()).a($$3.b())) {
         this.a($$0, $$2, $$3);
   ...
   private static void a(iz $$0, dca $$1, azh $$2) {
      iz.a $$3 = $$0.j().c(je.a);
      if ($$1.u($$3)) {
         int $$4 = ayz.a($$2, 1, 5);
         if ($$2.a(7) == 0) {
