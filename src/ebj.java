...
public class ebj extends eaw<ect> {
   public ebj(Codec<ect> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eay<ect> $$0) {
      iz $$1 = $$0.e();
      dcr $$2 = $$0.b();
      $$1 = new iz($$1.u(), $$0.c().f(), $$1.w());
      azf $$3 = $$0.d();
      boolean $$4 = $$3.j() > 0.7;
      dsa $$5 = $$0.f().b;
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? ayx.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(azf $$0, dbx $$1, int $$2, int $$3, iz $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, iz $$2, dbx $$3, boolean $$4, double $$5, iz $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dbx $$0, iz $$1) {
      if ($$0.a_($$1.c()).a(dez.dN)) {
         this.a($$0, $$1.c(), dez.a.o());
      }
   }

   private void a(dbx $$0, azf $$1, iz $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dsa $$13) {
   ...
   private void a(iz $$0, dbx $$1, azf $$2, int $$3, int $$4, boolean $$5, boolean $$6, dsa $$7) {
      dsa $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(dez.dP) || $$8.a(dez.dO) || $$8.a(dez.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dez.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dez.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, iz $$2, int $$3, azf $$4) {
      float $$5 = 10.0F * ayx.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(azf $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(azf $$0, int $$1, int $$2, int $$3) {
      float $$4 = 1.0F + $$0.i() / 2.0F;
      float $$5 = (1.0F - (float)$$1 / ((float)$$2 * $$4)) * (float)$$3;
      return ayx.f($$5 / 2.0F);
   }

   private static boolean c(dsa $$0) {
      return $$0.a(dez.iC) || $$0.a(dez.dP) || $$0.a(dez.mW);
   }
   ...
   private void a(dbx $$0, iz $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dez.dN)) {
                  if (this.a((dbc)$$0, $$10)) {
                     this.a($$0, $$10, dez.a.o());
                     this.a($$0, $$10.c(), dez.a.o());
                  } else if (c($$11)) {
                     dsa[] $$12 = new dsa[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
