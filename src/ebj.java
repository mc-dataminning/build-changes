...
public class ebj {
   ...
   @Deprecated
   public static ebj a(ato $$0, ebj.a $$1) {
      return new ebj($$0, $$1, false);
   }

   public static ebj a(ato $$0, int $$1, double... $$2) {
      return b($$0, new ebj.a($$1, new DoubleArrayList($$2)));
   }

   public static ebj b(ato $$0, ebj.a $$1) {
      return new ebj($$0, $$1, true);
   }

   private ebj(ato $$0, ebj.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<ebj.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(ebj.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(ebj.a::b))
               .apply($$0, ebj.a::new)
      );
      public static final Codec<ib<ebj.a>> b = agc.a(jz.az, a);
