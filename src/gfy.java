...
public class gfy extends dgh {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final ebf e = new ebf();
   private final ebl<buk> f = new ebl<>(buk.class, new gfy.b());
   private final gfz E;
   private final glt F;
   private final gls G;
   private final gfy.a H;
   private final glk I;
   private final bss J;
   private final fli K = fli.Q();
   final List<gks> L = Lists.newArrayList();
   final List<cjr> M = Lists.newArrayList();
   private final Map<euq, eus> N = Maps.newHashMap();
   private static final int O = -1;
   private int P;
   private final Object2ObjectArrayMap<dfr, fml> Q = af.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(glf.a, new fml($$0xx -> this.b($$0xx, glf.a)));
      $$0x.put(glf.b, new fml($$0xx -> this.b($$0xx, glf.b)));
      $$0x.put(glf.c, new fml($$0xx -> this.b($$0xx, glf.c)));
   });
   private final gfu R;
   private final Deque<Runnable> S = Queues.newArrayDeque();
   private int T;
   private final ghl U = new ghl();
   private final int V;
   private boolean W;
   private static final Set<cwk> X = Set.of(cws.hY, cws.hZ);

   public void b(int $$0) {
      this.U.a($$0, this);
   }

   public void b(ji $$0, dww $$1, int $$2) {
      if (!this.U.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(ji $$0, dww $$1, faz $$2) {
      dww $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cow $$4 = this.K.t;
   ...
   public gfy(gfz $$0, gfy.a $$1, aku<dgh> $$2, jr<ear> $$3, int $$4, int $$5, glt $$6, boolean $$7, long $$8, int $$9) {
      super($$1, $$2, $$0.v(), $$3, true, $$7, $$8, 1000000);
      this.E = $$0;
      this.R = new gfu(this, $$4);
      this.J = new bss();
      this.H = $$1;
      this.F = $$6;
      this.V = $$9;
      this.G = new gls(this.K, this, $$6);
      this.I = glk.a($$3.a());
   ...
   private void a(buk $$0, buk $$1) {
      if ($$1.dQ() || $$1.dk() != $$0) {
         $$1.ae();
      } else if ($$1 instanceof cow || this.e.c($$1)) {
         $$1.bz();
         $$1.af++;
         $$1.r();
   ...
   private djl o() {
      if (this.K.r.j() == dge.b) {
         cwo $$0 = this.K.t.eZ();
         cwk $$1 = $$0.h();
         if (X.contains($$1) && $$1 instanceof cuu $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, azh $$4, @Nullable djl $$5, ji.a $$6) {
   ...
   private void a(ji $$0, dww $$1, lr $$2, boolean $$3) {
      if ($$1.y().c()) {
         fbt $$4 = $$1.g(this, $$0);
         double $$5 = $$4.c(jn.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(ji $$0, lr $$1, fbt $$2, double $$3) {
   ...
   public void a(@Nullable cow $$0, buk $$1, jr<avz> $$2, awb $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hio)(new hif($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(buk $$0, avz $$1, awb $$2, float $$3, float $$4) {
      this.K.ak().a((hio)(new hif($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avz $$3, awb $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      hij $$10 = new hij($$3, $$4, $$5, $$6, azh.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<czd> $$6) {
      if ($$6.isEmpty()) {
         ...
         this.K.g.a(new giq.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.K.g, $$6));
      }
   }
   ...
   public jr<dhj> a(int $$0, int $$1, int $$2) {
      return this.K_().e(mc.aI).b(dhq.b);
   }
   ...
   public int a(faz $$0, float $$1) {
      float $$2 = this.f($$1);
      faz $$3 = $$0.a(2.0, 2.0, 2.0).c(0.25);
      faz $$4 = aya.a($$3, ($$0x, $$1x, $$2x) -> faz.a(this.I_().a($$0x, $$1x, $$2x).a().a()));
   ...
   public int a(ji $$0, dfr $$1) {
      fml $$2 = (fml)this.Q.get($$1);
      return $$2.a($$0);
   }

   public int b(ji $$0, dfr $$1) {
      int $$2 = fli.Q().n.G().c();
      if ($$2 == 0) {
   ...
   protected Map<euq, eus> l() {
      return ImmutableMap.copyOf(this.N);
   }

   protected void a(Map<euq, eus> $$0) {
      this.N.putAll($$0);
   }
   ...
   public static class a implements evl {
      ...
      public a(bsg $$0, boolean $$1, boolean $$2) {
         this.h = $$0;
         this.a = $$1;
         this.b = $$2;
      }
   ...
   final class b implements ebh<buk> {
      public void a(buk $$0) {
      }
      ...
      public void e(buk $$0) {
         ...
         switch ($$0) {
            case gks $$1:
               ...
               break;
            case cju $$2:
               gfy.this.M.addAll(Arrays.asList($$2.x()));
               break;
         }
      }
      ...
      public void f(buk $$0) {
         ...
         switch ($$0) {
            case gks $$1:
               ...
               break;
            case cju $$2:
               gfy.this.M.removeAll(Arrays.asList($$2.x()));
               break;
         }
      }
