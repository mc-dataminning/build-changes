...
public class gfy extends dgi {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final ebg e = new ebg();
   private final ebm<buk> f = new ebm<>(buk.class, new gfy.b());
   private final gfz E;
   private final glt F;
   private final gls G;
   ...
   private final Object2ObjectArrayMap<dfs, fmm> Q = af.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(glf.a, new fmm($$0xx -> this.b($$0xx, glf.a)));
      $$0x.put(glf.b, new fmm($$0xx -> this.b($$0xx, glf.b)));
      $$0x.put(glf.c, new fmm($$0xx -> this.b($$0xx, glf.c)));
   });
   private final gfu R;
   ...
   public gfy(gfz $$0, gfy.a $$1, akt<dgi> $$2, jr<eas> $$3, int $$4, int $$5, glt $$6, boolean $$7, long $$8, int $$9) {
   ...
   public void a(@Nullable cox $$0, buk $$1, jr<avz> $$2, awb $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.K.t) {
         this.K.ak().a((hii)(new hhz($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(buk $$0, avz $$1, awb $$2, float $$3, float $$4) {
      this.K.ak().a((hii)(new hhz($$1, $$2, $$3, $$4, $$0, this.A.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avz $$3, awb $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      hid $$10 = new hid($$3, $$4, $$5, $$6, azh.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   final class b implements ebi<buk> {
      public void a(buk $$0) {
      }
