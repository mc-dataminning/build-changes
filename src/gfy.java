...
public class gfy implements api<gfx> {
   public gfx b(JsonObject $$0) {
      Builder<gfw> $$1 = ImmutableList.builder();
      int $$2 = aue.a($$0, "frametime", 1);
      if ($$2 != 1) {
      ...
      int $$8 = aue.a($$0, "width", -1);
      int $$9 = aue.a($$0, "height", -1);
      if ($$8 != -1) {
      ...
      boolean $$10 = aue.a($$0, "interpolate", false);
      return new gfx($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gfw a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gfw(aue.g($$1, "frames[" + $$0 + "]"));
      } else if ($$1.isJsonObject()) {
         JsonObject $$2 = aue.m($$1, "frames[" + $$0 + "]");
         int $$3 = aue.a($$2, "time", -1);
         if ($$2.has("time")) {
