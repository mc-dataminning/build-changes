...
public class gfy {
   public static class a implements ggr<lw> {
      ...
      public ggo a(lw $$0, gdh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gfy.b $$8 = new gfy.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gho {
      b(gdh $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gha {
      ...
      c(gdh $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, ggq $$7, ghj $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gfy.c $$0 = new gfy.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements ggr<lw> {
      ...
      public ggo a(lw $$0, gdh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gfy.c $$8 = new gfy.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fke.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends ggm {
      ...
      public e(gdh $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, ggq $$7, List<czb> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            ggo $$12 = this.E.a(ls.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)axx.b($$11) / 255.0F, (float)axx.c($$11) / 255.0F, (float)axx.d($$11) / 255.0F);
         }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gfy.c $$10 = (gfy.c)this.E.a(ls.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
