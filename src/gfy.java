...
public class gfy extends gfx implements aat, wd {
   private static final Logger l = LogUtils.getLogger();
   private final GameProfile m;
   private cru n;
   private final kf.b o;
   private final ggo p = new ggo();
   @Nullable
   private ggh q;
   @Nullable
   protected fov.b k;

   public gfy(flk $$0, vi $$1, ggf $$2) {
      super($$0, $$1, $$2);
      this.m = $$2.a();
      this.o = $$2.c();
      this.n = $$2.d();
   ...
   public void a(aau $$0) {
      ...
      this.b.a(agf.b.a(wa.a($$1)), new ggb(this.a, this.b, new ggf(this.m, this.e, $$1, this.n, this.d, this.c, this.f, this.h, this.k, this.i, this.j)));
      this.b.a(abc.a);
