...
public class gfy {
   ...
   private gfy(int $$0, List<gga> $$1) {
      this.a = $$1.toArray(gga[]::new);
      this.b = $$1.size();
   }

   private List<gga> c() {
      List<gga> $$0 = new ArrayList<>(this.d());
