...
public class bkf {
   ...
   private bkf(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bkf a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bkf($$0, $$1);
   }

   public bkf.d a() throws IOException {
      bkf.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bkf.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bkf.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bkf.c $$3 = bkf.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bkf.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bkf.a($$0, $$3);
            }
         }
   ...
   public bkf.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bkf.c> $$2 = this.a().c();
      ...
      bkf.e $$4 = new bkf.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bkf.c b) implements bkf.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bkf.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bkf.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bkf.b> {
      private final List<bkf.b> a;

      d(List<bkf.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bkf.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bkf.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bkf.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bkf.d a() {
         ListIterator<bkf.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bkf.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bkf.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bkf.b> b() {
         return this.a.stream();
      }

      public Set<bkf.c> c() {
         return this.a.stream().map(bkf.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bkf.c b) implements bkf.b {
