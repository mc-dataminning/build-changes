...
public class bkf extends bki implements blv {
   private static final Logger d = LogUtils.getLogger();
   private static final int e = 5;
   private static final afm<Float> f = afp.a(bkf.class, afo.d);
   private static final afm<Integer> g = afp.a(bkf.class, afo.b);
   private static final afm<Boolean> h = afp.a(bkf.class, afo.k);
   private static final afm<jq> i = afp.a(bkf.class, afo.l);
   ...
   private cmy n = cnb.b;
   private final List<bjv> o = Lists.newArrayList();
   private final Map<bki, Integer> p = Maps.newHashMap();
   private int q = 600;
   private int r = 20;
   private int s = 20;
   private boolean t;
   ...
   public bkf(bkm<? extends bkf> $$0, crs $$1) {
      super($$0, $$1);
      this.af = true;
   }

   public bkf(crs $$0, double $$1, double $$2, double $$3) {
      this(bkm.c, $$0);
      this.e($$1, $$2, $$3);
   }
   ...
   public void a(float $$0) {
      if (!this.dL().B) {
         this.al().b(f, ati.a($$0, 0.0F, 32.0F));
      }
   }
   ...
   private void w() {
      if (this.n == cnb.b && this.o.isEmpty()) {
         this.al().b(g, 0);
      } else {
         this.al().b(g, cna.a(cna.a(this.n, this.o)));
      }
   }
   ...
   public void l() {
      ...
      if (this.dL().B) {
         ...
         if ($$0) {
            ...
            $$3 = ati.f((float) Math.PI * $$1 * $$1);
            $$4 = $$1;
         }

         for (int $$7 = 0; $$7 < $$3; $$7++) {
            float $$8 = this.ag.i() * (float) (Math.PI * 2);
            float $$9 = ati.c(this.ag.i()) * $$4;
            double $$10 = this.dq() + (double)(ati.b($$8) * $$9);
            double $$11 = this.ds();
            double $$12 = this.dw() + (double)(ati.a($$8) * $$9);
            double $$14;
            double $$15;
            double $$16;
            if ($$2.b() == js.v) {
         ...
         if (this.ah % 5 == 0) {
            ...
            List<bjv> $$24 = Lists.newArrayList();

            for (bjv $$25 : this.n.a()) {
               $$24.add(new bjv($$25.c(), $$25.a($$0x -> $$0x / 4), $$25.e(), $$25.f(), $$25.g()));
            }
            ...
            if ($$24.isEmpty()) {
               ...
               List<bky> $$26 = this.dL().a(bky.class, this.cG());
               if (!$$26.isEmpty()) {
                  for (bky $$27 : $$26) {
   ...
   @Nullable
   public bky s() {
      if (this.aF == null && this.aG != null && this.dL() instanceof ama) {
         bki $$0 = ((ama)this.dL()).a(this.aG);
         if ($$0 instanceof bky) {
            this.aF = (bky)$$0;
         }
      }
