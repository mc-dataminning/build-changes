...
public class eya {
   ...
   private final ewr c;
   private final List<eya.a> d = Lists.newArrayList();
   private String e;
   private int f;
   private int g;
   private boolean h;
   ...
   public eya.a e() {
      return new eya.a(Math.min(this.g, this.f), Math.max(this.g, this.f));
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = aun.a($$0);
      int $$3 = aun.a($$1 / 9.0);
      eya.a $$4 = this.d.get(aun.a($$3, 0, this.d.size() - 1));
   ...
   private void o() {
      ...
      if (this.e.isEmpty()) {
         ...
         this.c.b().a(this.e, this.j, wc.a, false, ($$0, $$1, $$2) -> this.d.add(new eya.a($$1, $$2)));
         if (this.e.charAt(this.e.length() - 1) == '\n') {
            this.d.add(new eya.a(this.e.length(), this.e.length()));
         }
      }
   }
   ...
   protected static record a(int a, int b) {
      static final eya.a c = new eya.a(0, 0);
   }
}
