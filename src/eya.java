...
public class eya extends exe {
   ...
   private eya(List<eza> $$0, Optional<wo> $$1, Optional<evr.b> $$2, eya.a $$3) {
      super($$0);
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public static UnaryOperator<wo> a(evr $$0, @Nullable evr.b $$1) {
      if ($$1 != null) {
         buk $$2 = $$0.c($$1.a());
         if ($$2 != null) {
            ex $$3 = $$2.d($$0.d()).a(2);
   ...
   public static exe.a<?> a(wo $$0, eya.a $$1) {
      return a($$2 -> new eya($$2, Optional.of($$0), Optional.empty(), $$1));
   }

   public static exe.a<?> a(wo $$0, eya.a $$1, evr.b $$2) {
