...
public class eya {
   ...
   public vv a(vv $$0, int $$1, wn $$2) {
      final eya.e $$3 = new eya.e((float)$$1);
      return $$0.a(new vv.b<vv>() {
         private final exe c = new exe();
   ...
   public void a(String $$0, int $$1, wn $$2, boolean $$3, eya.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      wn $$7 = $$2;

      while ($$5 < $$6) {
         eya.b $$8 = new eya.b((float)$$1);
   ...
   public void a(vv $$0, int $$1, wn $$2, BiConsumer<vv, Boolean> $$3) {
      List<eya.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new eya.c($$2x, $$1x));
         }
   ...
   static class a {
      ...
      public vv a(int $$0, int $$1, wn $$2) {
         exe $$3 = new exe();
         ListIterator<eya.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, wn $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = eya.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements avv {
      ...
      @Override
      public boolean accept(int $$0, wn $$1, int $$2) {
         this.b = this.b - eya.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
