...
public interface bnv {
   static bnp<StringReader> a(String $$0) {
      return new bnv.b($$0);
   }

   static bnp<StringReader> a(char $$0) {
      return new bnv.a($$0);
   }

   public static record a(char a) implements bnp<StringReader> {
      @Override
      public boolean a(bnl<StringReader> $$0, bnn $$1, bnh $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements bnp<StringReader> {
      @Override
      public boolean a(bnl<StringReader> $$0, bnn $$1, bnh $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
