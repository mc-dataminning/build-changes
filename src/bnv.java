...
public class bnv extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bny.a(new Dynamic($$0, $$1), bnv.a, bny.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), biw.s.typeName()) ? super.getChoiceType($$0, bkk.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), biw.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, biw.s, () -> DSL.optionalFields("components", biw.w.in($$0), DSL.taggedChoiceLazy("id", bkk.a(), $$2)));
      $$0.registerType(
         true,
         biw.t,
         () -> DSL.hook(
