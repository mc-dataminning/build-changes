...
public class bbi extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bjb.D), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bbi::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bbi::a);
      return this.a($$0, "minecraft:trident", bbi::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bjb.D, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bjb.D, $$1);
