...
public class bbi extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped(this.a + " (Components)", this.getInputSchema().getType(bhu.w), this::a),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped(this.a + " (Entity)", this.getInputSchema().getType(bhu.B), this::b),
            this.fixTypeEverywhereTyped(this.a + " (Player)", this.getInputSchema().getType(bhu.b), this::b)
         }
      );
   }
   ...
   private Dynamic<?> a(Dynamic<?> $$0) {
      return bav.a($$0, "id", this.b);
   }

   private Dynamic<?> b(Dynamic<?> $$0) {
      return bav.a($$0, "type", this.b);
   }
}
