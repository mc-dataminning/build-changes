...
public class bmf implements bmg {
   ...
   private static final bmf k = new bmf();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bme $$0) {
      URL $$1 = bmf.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bme $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bmi a = new bmi(() -> bmf.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bmf.this.l && $$0.getState() == RecordingState.STOPPED) {
