...
public class fum {
   ...
   public fum(fuk $$0, float $$1, float $$2, float $$3, float $$4, float $$5, float $$6, float $$7, float $$8) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public void a(fum.b $$0, Matrix4f $$1, fiu $$2, int $$3) {
      xt $$4 = $$0.f();
      boolean $$5 = $$4.d();
      float $$6 = $$0.a();
      float $$7 = $$0.b();
   ...
   private void a(boolean $$0, float $$1, float $$2, Matrix4f $$3, fiu $$4, int $$5, boolean $$6, int $$7) {
      this.a($$0, $$1, $$2, 0.0F, $$3, $$4, $$5, $$6, $$7);
   }

   private void a(boolean $$0, float $$1, float $$2, float $$3, Matrix4f $$4, fiu $$5, int $$6, boolean $$7, int $$8) {
      float $$9 = $$1 + this.g;
      float $$10 = $$1 + this.h;
      float $$11 = $$2 + this.i;
      float $$12 = $$2 + this.j;
   ...
   public void a(fum.a $$0, Matrix4f $$1, fiu $$2, int $$3) {
      if ($$0.i()) {
   ...
   private void a(fum.a $$0, float $$1, float $$2, int $$3, fiu $$4, int $$5, Matrix4f $$6) {
   ...
   public static record b(float a, float b, int c, int d, fum e, xt f, float g, float h) {
      boolean i() {
         return this.d() != 0;
      }
   }
