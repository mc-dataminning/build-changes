...
public class fum extends ful {
   ...
   protected void aR_() {
      ...
      this.z = $$0.u();
      this.A = $$0.aZ().m();
      this.c(fpa.a(dgf::e).a(dgf.a, dgf.d, dgf.b, dgf.c).a(this.z).a(this.n / 2 - 155, 100, 150, 20, d, ($$0x, $$1x) -> this.z = $$1x));
      this.c(fpa.b(this.A).a(this.n / 2 + 5, 100, 150, 20, c, ($$0x, $$1x) -> this.A = $$1x));
      fot $$1 = fot.a(wp.c("lanServer.start"), $$1x -> {
         this.m.a(null);
         wp $$2;
      ...
      this.C = new fpc(this.p, this.n / 2 - 75, 160, 150, 20, wp.c("lanServer.port"));
      this.C.b($$1x -> {
         wp $$2 = this.a($$1x);
      ...
      this.c(this.C);
      this.c($$1);
      this.c(fot.a(wo.e, $$0x -> this.aO_()).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   }
