...
public class fum extends fuk {
   ...
   public static CompletableFuture<Void> a(hek $$0, Executor $$1) {
      return CompletableFuture.allOf($$0.a(fpj.a, $$1), $$0.a(fpj.c, $$1), $$0.a(gma.a, $$1), e.a($$0, $$1));
   }
   ...
   protected void aR_() {
      ...
      $$3 += 36;
      $$4.c(var10001, $$3);
      this.c(fos.a(wo.c("menu.options"), $$0x -> this.m.a(new fxn(this, this.m.n))).a(this.n / 2 - 100, $$3, 98, 20).a());
      this.c(fos.a(wo.c("menu.quit"), $$0x -> this.m.q()).a(this.n / 2 + 2, $$3, 98, 20).a());
   ...
   private int a(int $$0, int $$1) {
      if (ab.aU) {
         this.c(fos.a(wo.b("Create Test World"), $$0x -> fzj.b(this.m, this)).a(this.n / 2 - 100, $$0 += $$1, 200, 20).a());
      }
   ...
   private int b(int $$0, int $$1) {
      this.c(fos.a(wo.c("menu.singleplayer"), $$0x -> this.m.a(new fzr(this))).a(this.n / 2 - 100, $$0, 200, 20).a());
      wo $$2 = this.E();
      boolean $$3 = $$2 == null;
      fqd $$4 = $$2 != null ? fqd.a($$2) : null;
      int var6;
      this.c(fos.a(wo.c("menu.multiplayer"), $$0x -> {
         fuk $$1x = (fuk)(this.m.n.u ? new fxa(this) : new fxb(this));
         this.m.a($$1x);
      }).a(this.n / 2 - 100, var6 = $$0 + $$1, 200, 20).a($$4).a()).j = $$3;
      this.c(fos.a(wo.c("menu.online"), $$0x -> this.m.a(new fgf(this))).a(this.n / 2 - 100, $$0 = var6 + $$1, 200, 20).a($$4).a()).j = $$3;
      return $$0;
   }
   ...
   private int c(int $$0, int $$1) {
      boolean $$2 = this.F();
      this.c(fos.a(wo.c("menu.playdemo"), $$1x -> {
         if ($$2) {
