...
public class fum extends fuk {
   ...
   public fum(boolean $$0) {
      this($$0, null);
   }

   public fum(boolean $$0, @Nullable fpj $$1) {
      super(b);
      this.y = $$0;
      this.A = Objects.requireNonNullElseGet($$1, () -> new fpj(false));
   }
   ...
   protected void aR_() {
      ...
      $$3 = this.a($$3, 24);
      fpx $$4 = this.c(fow.a(20, $$0x -> this.m.a(new fxk(this, this.m.n, this.m.ah())), true));
      int var10001 = this.n / 2 - 124;
      $$3 += 36;
      $$4.c(var10001, $$3);
      this.c(fos.a(wp.c("menu.options"), $$0x -> this.m.a(new fxn(this, this.m.n))).a(this.n / 2 - 100, $$3, 98, 20).a());
      this.c(fos.a(wp.c("menu.quit"), $$0x -> this.m.q()).a(this.n / 2 + 2, $$3, 98, 20).a());
      fpx $$5 = this.c(fow.b(20, $$0x -> this.m.a(new fxh(this, this.m.n)), true));
      $$5.c(this.n / 2 + 104, $$3);
      this.c(new fpq($$1, this.o - 10, $$0, 10, c, $$0x -> this.m.a(new ftm(this)), this.p));
      if (this.w == null) {
         this.w = new fjb();
      }
   ...
   private int a(int $$0, int $$1) {
      if (ab.aU) {
         this.c(fos.a(wp.b("Create Test World"), $$0x -> fzj.b(this.m, this)).a(this.n / 2 - 100, $$0 += $$1, 200, 20).a());
      }
   ...
   private int b(int $$0, int $$1) {
      this.c(fos.a(wp.c("menu.singleplayer"), $$0x -> this.m.a(new fzr(this))).a(this.n / 2 - 100, $$0, 200, 20).a());
      wp $$2 = this.E();
      boolean $$3 = $$2 == null;
      fqd $$4 = $$2 != null ? fqd.a($$2) : null;
      int var6;
      this.c(fos.a(wp.c("menu.multiplayer"), $$0x -> {
         fuk $$1x = (fuk)(this.m.n.u ? new fxa(this) : new fxb(this));
         this.m.a($$1x);
      }).a(this.n / 2 - 100, var6 = $$0 + $$1, 200, 20).a($$4).a()).j = $$3;
      this.c(fos.a(wp.c("menu.online"), $$0x -> this.m.a(new fge(this))).a(this.n / 2 - 100, $$0 = var6 + $$1, 200, 20).a($$4).a()).j = $$3;
      return $$0;
   }
   ...
   private int c(int $$0, int $$1) {
      boolean $$2 = this.F();
      this.c(fos.a(wp.c("menu.playdemo"), $$1x -> {
         if ($$2) {
            this.m.x().a("Demo_World", () -> this.m.a(this));
         } else {
            this.m.x().a("Demo_World", MinecraftServer.d, edp.b, enb::a, this);
         }
   ...
   private boolean F() {
      try {
         boolean var2;
         try (eve.c $$0 = this.m.m().e("Demo_World")) {
            var2 = $$0.m();
         }
   ...
   private void c(boolean $$0) {
      if ($$0) {
         try (eve.c $$1 = this.m.m().e("Demo_World")) {
            $$1.k();
         } catch (IOException var7) {
            frb.b(this.m, "Demo_World");
