public class fum<T extends cdl> extends ftg<T> {
   private static final aew f = new aew("textures/entity/minecart.png");
   ...
   public void a(T $$0, float $$1, float $$2, elp $$3, foe $$4, int $$5) {
      ...
      $$3.a($$7, $$8, $$9);
      double $$10 = arw.d((double)$$2, $$0.ac, $$0.dq());
      double $$11 = arw.d((double)$$2, $$0.ad, $$0.ds());
      double $$12 = arw.d((double)$$2, $$0.ae, $$0.dw());
      double $$13 = 0.3F;
      ehn $$14 = $$0.q($$10, $$11, $$12);
      float $$15 = arw.i($$2, $$0.O, $$0.dD());
      if ($$14 != null) {
      ...
      if ($$19 > 0.0F) {
         $$3.a(a.b.rotationDegrees(arw.a($$19) * $$19 * $$20 / 10.0F * (float)$$0.y()));
      }
