...
public class edu implements edp {
   public static final Codec<edu> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               lq.e.r().fieldOf("block").flatXmap(edu::a, DataResult::success).orElse((dki)dfk.fg).forGetter($$0x -> $$0x.b),
   ...
   public final jn<dfi> h;
   private final ObjectArrayList<jf> i;

   private static DataResult<dki> a(dfi $$0) {
      return $$0 instanceof dki $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public edu(dki $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jn<dfi> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
