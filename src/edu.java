...
public class edu {
   ...
   private final dgj o;
   private static final List<djl> p = List.of(djn.l, djn.O, djn.i, djn.b, djn.k, djn.L, djn.N, djn.fA, djn.ec, djn.iY, djn.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jr<dhj>>> s;
   private final transient double[][] t;

   private edu(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> af.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jr<dhj>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kk.c($$0);
      int $$5 = kk.c($$1) - $$4;
   ...
   @Nullable
   public static edu a(@Nullable edu.d $$0) {
      return $$0 == null ? null : new edu($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public edu.d a() {
      ...
      return new edu.d(this.o.ap(), this.o.aq() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static edu a(arl $$0, int $$1, int $$2) {
      dyr $$3 = $$0.a($$1, $$2);
      edu $$4 = $$3.v();
      if ($$4 != null && !$$3.o().d(dzs.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jo> a(dhf $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dyr $$1, int $$2, int $$3) {
   ...
   private int a(dyr $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(ecr.a.a)) {
         $$3 = Math.min($$0.a(ecr.a.a, $$1, $$2), this.o.an());
      } else {
         $$3 = this.o.an();
      }
   ...
   private static double a(dyr $$0, ji.a $$1) {
      return a($$0, (ji)$$1.c(jn.a)) ? 1.0 : -1.0;
   }

   private static double b(dyr $$0, ji.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dyr $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jr<dhj>> b(dyr $$0, int $$1, int $$2) {
      ObjectArrayList<jr<dhj>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());
   ...
   private static boolean a(dyr $$0, ji $$1) {
      dww $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(awp.Q)) {
         ...
         return $$2.a(djn.fh) || $$2.a(djn.fi) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, edu.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, edu.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jr<dhj> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<edu.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(edu.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(edu.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(edu.d::c)
                  )
                  .apply($$0, edu.d::new)
         )
         .validate(edu.d::a);

      private static DataResult<edu.d> a(edu.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != edu.n
            ? DataResult.error(() -> "heights has to be of length " + edu.n)
