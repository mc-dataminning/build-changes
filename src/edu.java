...
public class edu {
   ...
   static class a implements edu.i {
      @Override
      public boolean a(edu.v $$0) {
         return $$0.c[ie.f.d()] && !$$0.b[ie.f.d()].d;
      }

      @Override
      public edu.r a(ie $$0, edu.v $$1, awp $$2) {
         $$1.d = true;
         $$1.b[ie.f.d()].d = true;
         return new edu.k($$0, $$1);
      }
   }

   static class b implements edu.i {
      @Override
      public boolean a(edu.v $$0) {
         if ($$0.c[ie.f.d()] && !$$0.b[ie.f.d()].d && $$0.c[ie.b.d()] && !$$0.b[ie.b.d()].d) {
            edu.v $$1 = $$0.b[ie.f.d()];
            return $$1.c[ie.b.d()] && !$$1.b[ie.b.d()].d;
         } else {
            return false;
         }
      }
      ...
      public edu.r a(ie $$0, edu.v $$1, awp $$2) {
         ...
         $$1.b[ie.f.d()].d = true;
         $$1.b[ie.b.d()].d = true;
         $$1.b[ie.f.d()].b[ie.b.d()].d = true;
         return new edu.l($$0, $$1);
      }
   }

   static class c implements edu.i {
      @Override
      public boolean a(edu.v $$0) {
         return $$0.c[ie.b.d()] && !$$0.b[ie.b.d()].d;
      }
      ...
      public edu.r a(ie $$0, edu.v $$1, awp $$2) {
         $$1.d = true;
         $$1.b[ie.b.d()].d = true;
         return new edu.m($$0, $$1);
      }
   }

   static class d implements edu.i {
      @Override
      public boolean a(edu.v $$0) {
         if ($$0.c[ie.c.d()] && !$$0.b[ie.c.d()].d && $$0.c[ie.b.d()] && !$$0.b[ie.b.d()].d) {
            edu.v $$1 = $$0.b[ie.c.d()];
            return $$1.c[ie.b.d()] && !$$1.b[ie.b.d()].d;
         } else {
            return false;
      ...
      public edu.r a(ie $$0, edu.v $$1, awp $$2) {
         ...
         $$1.b[ie.c.d()].d = true;
         $$1.b[ie.b.d()].d = true;
         $$1.b[ie.c.d()].b[ie.b.d()].d = true;
         return new edu.n($$0, $$1);
      }
   }

   static class e implements edu.i {
      @Override
      public boolean a(edu.v $$0) {
         return $$0.c[ie.c.d()] && !$$0.b[ie.c.d()].d;
      }

      @Override
      public edu.r a(ie $$0, edu.v $$1, awp $$2) {
         edu.v $$3 = $$1;
         if (!$$1.c[ie.c.d()] || $$1.b[ie.c.d()].d) {
            $$3 = $$1.b[ie.d.d()];
         }

         $$3.d = true;
         $$3.b[ie.c.d()].d = true;
         return new edu.o($$0, $$3);
      }
   }

   static class f implements edu.i {
      @Override
      public boolean a(edu.v $$0) {
         return true;
      }
      ...
      public edu.r a(ie $$0, edu.v $$1, awp $$2) {
         $$1.d = true;
         return new edu.s($$0, $$1, $$2);
      }
   }

   static class g implements edu.i {
      @Override
      public boolean a(edu.v $$0) {
         return !$$0.c[ie.e.d()] && !$$0.c[ie.f.d()] && !$$0.c[ie.c.d()] && !$$0.c[ie.d.d()] && !$$0.c[ie.b.d()];
      }

      @Override
      public edu.r a(ie $$0, edu.v $$1, awp $$2) {
         $$1.d = true;
         return new edu.t($$0, $$1);
      }
   }

   public static class h extends edu.r {
      ...
      private edu.v G;
      private edu.v H;
      private final List<edu.r> I = Lists.newArrayList();

      public h(awp $$0, int $$1, int $$2, ie $$3) {
         super(ecc.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<edu.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new edu.p($$3, this.G));
         this.I.add(new edu.j($$3, this.H));
         List<edu.i> $$5 = Lists.newArrayList();
         $$5.add(new edu.b());
         $$5.add(new edu.d());
         $$5.add(new edu.e());
         $$5.add(new edu.a());
         ...
         ebd $$10 = ebd.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ebd $$11 = ebd.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ebd $$12 = ebd.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new edu.u($$3, $$10, $$13++));
         this.I.add(new edu.u($$3, $$11, $$13++));
         this.I.add(new edu.q($$3, $$12));
      }
      ...
      private List<edu.v> b(awp $$0) {
         edu.v[] $$1 = new edu.v[75];
         ...
         edu.v $$23 = new edu.v(1003);
         edu.v $$24 = new edu.v(1001);
         edu.v $$25 = new edu.v(1002);
         $$1[v].a(ie.b, $$23);
         $$1[w].a(ie.d, $$24);
         $$1[x].a(ie.d, $$25);
         $$23.d = true;
         ...
         this.H.d = true;
         this.H.b[ie.f.d()].d = true;
         this.H.b[ie.c.d()].d = true;
         this.H.b[ie.f.d()].b[ie.c.d()].d = true;
         this.H.b[ie.b.d()].d = true;
         this.H.b[ie.f.d()].b[ie.b.d()].d = true;
         this.H.b[ie.c.d()].b[ie.b.d()].d = true;
         this.H.b[ie.f.d()].b[ie.c.d()].b[ie.b.d()].d = true;
         ObjectArrayList<edu.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cwm $$2, awp $$3, ebd $$4) {
         int $$5 = 24;
      ...
      private void a(cwm $$0, awp $$1, ebd $$2) {
      ...
      private void b(cwm $$0, awp $$1, ebd $$2) {
      ...
      private void c(cwm $$0, awp $$1, ebd $$2) {
      ...
      private void d(cwm $$0, awp $$1, ebd $$2) {
      ...
      private void e(cwm $$0, awp $$1, ebd $$2) {
      ...
      private void f(cwm $$0, awp $$1, ebd $$2) {
   ...
   interface i {
      boolean a(edu.v var1);

      edu.r a(ie var1, edu.v var2, awp var3);
   }

   public static class j extends edu.r {
      public j(ie $$0, edu.v $$1) {
         super(ecc.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cwm $$0, cwk $$1, dng $$2, awp $$3, ebd $$4, cuy $$5, hz $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cyu.ch.o(), cyu.ch.o(), false);
   ...
   public static class k extends edu.r {
      public k(ie $$0, edu.v $$1) {
         super(ecc.O, 1, $$0, $$1, 2, 1, 1);
      }
      ...
      @Override
      public void a(cwm $$0, cwk $$1, dng $$2, awp $$3, ebd $$4, cuy $$5, hz $$6) {
         edu.v $$7 = this.B.b[ie.f.d()];
         edu.v $$8 = this.B;
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 8, 0, $$7.c[ie.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ie.a.d()]);
         }
   ...
   public static class l extends edu.r {
      public l(ie $$0, edu.v $$1) {
         super(ecc.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends edu.r {
      public m(ie $$0, edu.v $$1) {
         super(ecc.Q, 1, $$0, $$1, 1, 2, 1);
      }
      ...
      public void a(cwm $$0, cwk $$1, dng $$2, awp $$3, ebd $$4, cuy $$5, hz $$6) {
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 0, this.B.c[ie.a.d()]);
         }

         edu.v $$7 = this.B.b[ie.b.d()];
         if ($$7.b[ie.b.d()] == null) {
   ...
   public static class n extends edu.r {
      public n(ie $$0, edu.v $$1) {
         super(ecc.R, 1, $$0, $$1, 1, 2, 2);
      }
      ...
      @Override
      public void a(cwm $$0, cwk $$1, dng $$2, awp $$3, ebd $$4, cuy $$5, hz $$6) {
         edu.v $$7 = this.B.b[ie.c.d()];
         edu.v $$8 = this.B;
         edu.v $$9 = $$7.b[ie.b.d()];
         edu.v $$10 = $$8.b[ie.b.d()];
         if (this.B.a / 25 > 0) {
            this.a($$0, $$4, 0, 8, $$7.c[ie.a.d()]);
            this.a($$0, $$4, 0, 0, $$8.c[ie.a.d()]);
         }
   ...
   public static class o extends edu.r {
      public o(ie $$0, edu.v $$1) {
         super(ecc.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends edu.r {
      public p(ie $$0, edu.v $$1) {
         super(ecc.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends edu.r {
      public q(ie $$0, ebd $$1) {
         super(ecc.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ebp {
      protected static final dlj b = cyu.hZ.o();
      protected static final dlj c = cyu.ia.o();
      protected static final dlj d = cyu.ib.o();
      protected static final dlj h = c;
      protected static final dlj i = cyu.ii.o();
      protected static final boolean j = true;
      protected static final dlj k = cyu.G.o();
      protected static final Set<cys> l = ImmutableSet.builder().add(cyu.dO).add(cyu.iC).add(cyu.mW).add(k.b()).build();
      ...
      public r(ecc $$0, ie $$1, int $$2, ebd $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ecc $$0, int $$1, ie $$2, edu.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ebd a(ie $$0, edu.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ebd $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cwm $$0, ebd $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dlj $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cwm $$0, ebd $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cwm $$0, ebd $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dlj $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ebd $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cwm $$0, ebd $$1, int $$2, int $$3, int $$4) {
         hz $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            ceg $$6 = bnw.C.a((cvr)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eN());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), bom.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends edu.r {
      private int a;

      public s(ie $$0, edu.v $$1, awp $$2) {
         super(ecc.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
      ...
      public void a(cwm $$0, cwk $$1, dng $$2, awp $$3, ebd $$4, cuy $$5, hz $$6) {
         ...
         if (this.B.b[ie.b.d()] == null) {
            this.a($$0, $$4, 1, 4, 1, 6, 4, 6, b);
         }

         boolean $$7 = this.a != 0 && $$3.h() && !this.B.c[ie.a.d()] && !this.B.c[ie.b.d()] && this.B.c() > 1;
         if (this.a == 0) {
   ...
   public static class t extends edu.r {
      public t(ie $$0, edu.v $$1) {
         super(ecc.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends edu.r {
      private int a;

      public u(ie $$0, ebd $$1, int $$2) {
         super(ecc.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
