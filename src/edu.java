...
public class edu {
   ...
   private final edu.a g;

   @Deprecated
   public static edu a(auv $$0, edu.a $$1) {
      return new edu($$0, $$1, false);
   }

   public static edu a(auv $$0, int $$1, double... $$2) {
      return b($$0, new edu.a($$1, new DoubleArrayList($$2)));
   }

   public static edu b(auv $$0, edu.a $$1) {
      return new edu($$0, $$1, true);
   }

   private edu(auv $$0, edu.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<edu.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(edu.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(edu.a::b))
               .apply($$0, edu.a::new)
      );
      public static final Codec<ih<edu.a>> b = ahc.a(ke.aB, a);
