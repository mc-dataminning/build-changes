...
public class fyv extends fty {
   ...
   private final frt w = new frt().a(10).b(20);

   public fyv(Collection<avd> $$0, BooleanConsumer $$1) {
      super(a);
      this.v = $$0;
      this.u = $$1;
   }
   ...
   protected void aT_() {
      ...
      frt.b $$0 = this.w.d(2);
      frx $$1 = $$0.b().b();
      $$0.a(new fpn(this.l, this.p), 2, $$1);
      fpa $$2 = $$0.a(new fpa(b, this.p).b(true), 2, $$1);
      $$2.d(310);
      $$0.a(fof.a(c, $$0x -> this.m.a(new fyv.a())).a(100).a(), 2, $$1);
      $$0.a(fof.a(xu.i, $$0x -> this.u.accept(true)).a());
      $$0.a(fof.a(xu.k, $$0x -> this.u.accept(false)).a());
      this.w.a($$1x -> {
   ...
   @Override
   protected void c() {
      frs.a(this.w, 0, 0, this.n, this.o, 0.5F, 0.5F);
   }
   ...
   class a extends fty {
      ...
      protected void aT_() {
         this.c.a(b, this.p);
         this.d = this.c.c(new fyv.a.a(this.m, fyv.this.v));
         this.c.b(fof.a(xu.k, $$0 -> this.aP_()).a());
         this.c.a($$1 -> {
      ...
      class a extends fpc<fyv.a.b> {
         public a(final fmg $$0, final Collection<avd> $$1) {
            super($$0, a.this.n, a.this.c.d(), a.this.c.c(), (9 + 2) * 3);

            for (avd $$2 : $$1) {
               String $$3 = csv.a(csv.h, $$2.e());
               if (!$$3.isEmpty()) {
                  xv $$4 = xy.a($$2.b().f(), ys.a.a(true));
                  xv $$5 = xv.a("selectWorld.experimental.details.entry", $$3);
                  this.b(a.this.new b($$4, $$5, foz.a(a.this.p, $$5, this.a())));
               }
            }
         }
      ...
      class b extends fpc.a<fyv.a.b> {
         private final xv b;
         private final xv c;
         private final foz d;

         b(final xv $$0, final xv $$1, final foz $$2) {
            this.b = $$0;
            this.c = $$1;
            this.d = $$2;
         }
