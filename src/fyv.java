...
public class fyv extends ftw {
   ...
   private final frs B = new frs(this);
   final fzh C;
   private final fqi D = new fqi(this::c, $$1x -> this.e($$1x));
   private boolean E;
   private final fbn F;
   private final fyu G;
   @Nullable
   ...
   public static void a(fme $$0, @Nullable ftw $$1) {
      a($$0, $$1, ($$0x, $$1x, $$2, $$3) -> $$0x.a($$1x, (ewi)$$2));
   }

   public static void a(fme $$0, @Nullable ftw $$1, fyu $$2) {
      fzg $$3 = ($$0x, $$1x, $$2x) -> new fzf($$2x.a(), $$1x, $$0x, $$2x.b());
      Function<amx.a, eel> $$4 = $$0x -> new eel(een.a(), enz.a($$0x.c()));
      a($$0, $$1, $$4, $$3, enz.a, $$2);
   }

   public static void b(fme $$0, @Nullable ftw $$1) {
      fzg $$2 = ($$0x, $$1x, $$2x) -> new fzf($$2x.a().a(), $$2x.a().b(), $$1x, $$0x, $$2x.b(), new fza(fzh.a.c, Set.of(dhd.l, dhd.w, dhd.e), eml.h));
      Function<amx.a, eel> $$3 = $$0x -> new eel(een.b(), enz.c($$0x.c()));
      a($$0, $$1, $$3, $$2, enz.b, ($$0x, $$1x, $$2x, $$3x) -> $$0x.a($$1x, (ewi)$$2x));
   }

   private static void a(fme $$0, @Nullable ftw $$1, Function<amx.a, eel> $$2, fzg $$3, aly<eny> $$4, fyu $$5) {
      a($$0, y);
      avg $$6 = new avg(new avj($$0.bf()));
      amx.c $$7 = a($$6, die.c);
      CompletableFuture<fzf> $$8 = amx.a($$7, $$1x -> new amx.b<>(new fyw($$2.apply($$1x), $$1x.b()), $$1x.d()), ($$1x, $$2x, $$3x, $$4x) -> {
         $$1x.close();
         return $$3.apply($$2x, $$3x, $$4x);
      }, ae.g(), $$0);
      $$0.b($$8::isDone);
      $$0.a(new fyv($$0, $$1, $$8.join(), Optional.of($$4), OptionalLong.empty(), $$5));
   }

   public static fyv a(fme $$0, @Nullable ftw $$1, dhl $$2, fzf $$3, @Nullable Path $$4) {
      fyv $$5 = new fyv($$0, $$1, $$3, enz.a($$3.e()), OptionalLong.of($$3.c().c()), ($$0x, $$1x, $$2x, $$3x) -> $$0x.a($$1x, (ewi)$$2x));
      $$5.E = true;
      $$5.C.a($$2.a());
      $$5.C.a($$2.e());
      $$5.C.a($$2.d());
   ...
   private fyv(fme $$0, @Nullable ftw $$1, fzf $$2, Optional<aly<eny>> $$3, OptionalLong $$4, fyu $$5) {
      super(xv.c("selectWorld.create"));
      this.H = $$1;
      this.F = $$0.bf();
      this.G = $$5;
      this.C = new fzh($$0.m().c(), $$2, $$3, $$4);
   }
   ...
   @Override
   protected void aT_() {
      this.K = fqj.a(this.D, this.n).a(new fyv.a(), new fyv.c(), new fyv.b()).a();
      this.c(this.K);
      frw $$0 = this.B.b(frw.e().a(8));
      $$0.a(fod.a(xv.c("selectWorld.create"), $$0x -> this.F()).a());
      $$0.a(fod.a(xu.e, $$0x -> this.E()).a());
      this.B.a($$0x -> {
         $$0x.m(1);
         this.c($$0x);
      });
   ...
   public void c() {
      if (this.K != null) {
         ...
         this.K.b();
         int $$0 = this.K.H().c();
         fsl $$1 = new fsl(0, $$0, this.n, this.o - this.B.b() - $$0);
         this.D.a($$1);
         this.B.b($$0);
         this.B.a();
      }
   ...
   private static void a(fme $$0, xv $$1) {
      $$0.d(new fth($$1));
   }
   ...
   private void F() {
      ...
      fzi.a(this.m, this, $$5, () -> this.a($$2, $$8), $$6);
   }
   ...
   public void a(fnq $$0, int $$1, int $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      $$0.a(glt::B, ftw.i, 0, this.o - this.B.b() - 2, 0.0F, 0.0F, this.n, 2, 32, 2);
   }

   @Override
   protected void a(fnq $$0) {
      $$0.a(glt::B, a, 0, 0, 0.0F, 0.0F, this.n, this.B.c(), 16, 16);
   ...
   void a(die $$0) {
      ...
      if ($$1 != null) {
         this.m.a(new fyz(this, (avg)$$1.getSecond(), $$0x -> this.a($$0x, false, this::a)));
      }
   }
   ...
   void b(die $$0) {
      Pair<Path, avg> $$1 = this.c($$0);
      if ($$1 != null) {
         this.m.a(new fxm((avg)$$1.getSecond(), $$0x -> this.a($$0x, true, this::b), (Path)$$1.getFirst(), xv.c("dataPack.title")));
      }
   }
   ...
   private void a(avg $$0, die $$1, Consumer<die> $$2) {
      this.m.d(new fth(xv.c("dataPack.validation.working")));
      amx.c $$3 = a($$0, $$1);
      amx.<fyw, fzf>a(
            $$3,
            $$0x -> {
               if ($$0x.c().d(mb.bb).c().findAny().isEmpty()) {
                  ...
                  return new amx.b<>(new fyw($$5, $$0x.b()), $$0x.d());
               }
            },
            ($$0x, $$1x, $$2x, $$3x) -> {
               $$0x.close();
               return new fzf($$3x.a(), $$2x, $$1x, $$3x.b());
            },
            ae.g(),
            this.m
         )
   ...
   private static Optional<ewc.c> a(fme $$0, String $$1, @Nullable Path $$2) {
      try {
         ewc.c $$3 = $$0.m().e($$1);
         if ($$2 == null) {
   ...
   @Nullable
   public static Path a(Path $$0, fme $$1) {
   ...
   class a extends fqg {
      ...
      a() {
         super(c);
         frr.b $$0 = this.a.b(8).d(1);
         frv $$1 = $$0.b();
         this.e = new fom(fyv.this.p, 208, 20, xv.c("selectWorld.enterName"));
         this.e.a(fyv.this.C.b());
         this.e.b(fyv.this.C::a);
         fyv.this.C.a($$0x -> this.e.a(fpp.a(xv.a("selectWorld.targetFolder", xv.b($$0x.c()).a(n.u)))));
         fyv.this.b(this.e);
         $$0.a(fro.a(fyv.this.p, this.e, fyv.v), $$0.b().b());
         fok<fzh.a> $$2 = $$0.a(fok.<fzh.a>a($$0x -> $$0x.f).a(fzh.a.a, fzh.a.b, fzh.a.c).a(0, 0, 210, 20, fyv.u, ($$0x, $$1x) -> fyv.this.C.a($$1x)), $$1);
         fyv.this.C.a($$1x -> {
            $$2.a($$1x.d());
            $$2.j = !$$1x.l();
            $$2.a(fpp.a($$1x.d().a()));
         });
         fok<btf> $$3 = $$0.a(fok.a(btf::b).a(btf.values()).a(0, 0, 210, 20, xv.c("options.difficulty"), ($$0x, $$1x) -> fyv.this.C.a($$1x)), $$1);
         fyv.this.C.a($$1x -> {
            $$3.a(fyv.this.C.e());
            $$3.j = !fyv.this.C.f();
            $$3.a(fpp.a(fyv.this.C.e().d()));
         });
         fok<Boolean> $$4 = $$0.a(fok.e().a($$0x -> fpp.a(fyv.x)).a(0, 0, 210, 20, d, ($$0x, $$1x) -> fyv.this.C.a($$1x)));
         fyv.this.C.a($$1x -> {
            $$4.a(fyv.this.C.g());
            $$4.j = !fyv.this.C.l() && !fyv.this.C.f();
         });
         if (!ab.b().g()) {
            $$0.a(fod.a(fyv.w, $$0x -> fyv.this.a(fyv.this.C.k().h())).a(210).a());
         }
      }
   }
   ...
   class b extends fqg {
      ...
      b() {
         super(c);
         frr.b $$0 = this.a.b(8).d(1);
         $$0.a(fod.a(d, $$0x -> this.b()).a(210).a());
         $$0.a(fod.a(fyv.w, $$0x -> fyv.this.a(fyv.this.C.k().h())).a(210).a());
         $$0.a(fod.a(e, $$0x -> fyv.this.b(fyv.this.C.k().h())).a(210).a());
      }

      private void b() {
         fyv.this.m.a(new fyx(fyv.this.C.q().a(fyv.this.C.k().h().b()), $$0 -> {
            fyv.this.m.a(fyv.this);
            $$0.ifPresent(fyv.this.C::a);
         }));
      }
   }
   ...
   class c extends fqg {
      ...
      c() {
         super(c);
         frr.b $$0 = this.a.a(10).b(8).d(2);
         fok<fzh.b> $$1 = $$0.a(
            fok.<fzh.b>a(fzh.b::a).a(this.c()).a(fyv.c::a).a(0, 0, 150, 20, xv.c("selectWorld.mapType"), ($$0x, $$1x) -> fyv.this.C.a($$1x))
         );
         $$1.a(fyv.this.C.m());
         fyv.this.C.a($$1x -> {
            fzh.b $$2x = $$1x.m();
            ...
            $$1.j = fyv.this.C.m().c() != null;
         });
         this.l = $$0.a(fod.a(xv.c("selectWorld.customizeType"), $$0x -> this.b()).a());
         fyv.this.C.a($$0x -> this.l.j = !$$0x.l() && $$0x.n() != null);
         this.k = new fom(fyv.this.p, 308, 20, xv.c("selectWorld.enterSeed")) {
            @Override
            protected yj aR_() {
               return super.aR_().b(xu.t).b(fyv.c.i);
            }
         };
         this.k.c(i);
         this.k.a(fyv.this.C.h());
         this.k.b($$0x -> fyv.this.C.b(this.k.a()));
         $$0.a(fro.a(fyv.this.p, this.k, h), 2);
         fze.a $$2 = fze.a(310);
         $$2.a(e, fyv.this.C::i, fyv.this.C::b).a(() -> !fyv.this.C.l()).a(f);
         $$2.a(g, fyv.this.C::j, fyv.this.C::c).a(() -> !fyv.this.C.f() && !fyv.this.C.l());
         fze $$3 = $$2.a($$1x -> $$0.a($$1x, 2));
         fyv.this.C.a($$1x -> $$3.a());
      }
      ...
      private void b() {
         fzc $$0 = fyv.this.C.n();
         if ($$0 != null) {
            fyv.this.m.a($$0.createEditScreen(fyv.this, fyv.this.C.k()));
         }
      }

      private fok.c<fzh.b> c() {
         return new fok.c<fzh.b>() {
            @Override
            public List<fzh.b> a() {
               return fok.a.getAsBoolean() ? fyv.this.C.p() : fyv.this.C.o();
            }
      ...
      private static yj a(fok<fzh.b> $$0) {
