...
public class amk extends alr {
   public static final int a = 33;
   private static final int c = 4;
   protected final Long2ByteMap b = new Long2ByteOpenHashMap();
   private final Long2ObjectOpenHashMap<aud<ami<?>>> d = new Long2ObjectOpenHashMap();
   ...
   private aud<ami<?>> g(long $$0) {
      return (aud<ami<?>>)this.d.computeIfAbsent($$0, $$0x -> aud.a(4));
   }

   private int a(aud<ami<?>> $$0) {
      return $$0.isEmpty() ? 34 : $$0.b().b();
   }

   public void a(long $$0, ami<?> $$1) {
      aud<ami<?>> $$2 = this.g($$0);
      int $$3 = this.a($$2);
      $$2.add($$1);
      if ($$1.b() < $$3) {
   ...
   public void a(int $$0) {
      ...
      for (Pair<ami<crh>, Long> $$4 : $$1) {
         Long $$5 = (Long)$$4.getSecond();
         ami<crh> $$6 = (ami<crh>)$$4.getFirst();
         this.b($$5, $$6);
         crh $$7 = new crh($$5);
         amj<crh> $$8 = $$6.a();
         this.a($$8, $$7, $$0, $$7);
   ...
   protected int b(long $$0) {
      aud<ami<?>> $$1 = (aud<ami<?>>)this.d.get($$0);
