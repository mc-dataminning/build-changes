...
public class amk {
   ...
   private static int a(ex $$0, Collection<are> $$1, Predicate<cwq> $$2) throws CommandSyntaxException {
      return a($$0, $$1, $$2, -1);
   }

   private static int a(ex $$0, Collection<are> $$1, Predicate<cwq> $$2, int $$3) throws CommandSyntaxException {
      int $$4 = 0;
      ...
      if ($$4 == 0) {
         ...
         if ($$3 == 0) {
            if ($$1.size() == 1) {
               $$0.a(() -> wp.a("commands.clear.test.single", $$6, $$1.iterator().next().p_()), true);
            } else {
               $$0.a(() -> wp.a("commands.clear.test.multiple", $$6, $$1.size()), true);
            }
         } else if ($$1.size() == 1) {
            $$0.a(() -> wp.a("commands.clear.success.single", $$6, $$1.iterator().next().p_()), true);
         } else {
