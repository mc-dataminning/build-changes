...
public class amk {
   ...
   private amk(jx<ami> $$0, js.a $$1, css $$2, ex.a $$3, List<kd.a<?>> $$4, int $$5) {
   ...
   public static CompletableFuture<amk> a(avv $$0, jx<ami> $$1, List<kd.a<?>> $$2, css $$3, ex.a $$4, int $$5, Executor $$6, Executor $$7) {
