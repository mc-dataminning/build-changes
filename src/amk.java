...
public class amk {
   ...
   private static int a(ee $$0, Collection<? extends bru> $$1, ix<bra> $$2, @Nullable Integer $$3, int $$4, boolean $$5) throws CommandSyntaxException {
      bra $$6 = $$2.a();
      int $$7 = 0;
      int $$8;
      if ($$3 != null) {
   ...
   private static int a(ee $$0, Collection<? extends bru> $$1) throws CommandSyntaxException {
      int $$2 = 0;

      for (bru $$3 : $$1) {
         if ($$3 instanceof bso && ((bso)$$3).ew()) {
            $$2++;
         }
      }
   ...
   private static int a(ee $$0, Collection<? extends bru> $$1, ix<bra> $$2) throws CommandSyntaxException {
      bra $$3 = $$2.a();
      int $$4 = 0;
