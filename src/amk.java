...
public class amk implements amh {
   ...
   amk(amc $$0, Set<String> $$1, List<Path> $$2, Map<ami, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(ami $$0, aew $$1, Consumer<Path> $$2) {
   ...
   public void a(ami $$0, String $$1, String $$2, amh.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<aew, anl<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(amh.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      amj.a($$1, $$4, $$3, $$0);
   }
   ...
   public anl<InputStream> a(ami $$0, aew $$1) {
      return (anl<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && amj.a($$5)) {
               return anl.create($$5);
            }
         }
   ...
   public <T> T a(amt<T> $$0) {
      anl<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public anw c() {
      return $$0 -> Optional.ofNullable(this.a(ami.a, $$0)).map($$0x -> new anr(this, $$0x));
   }
}
