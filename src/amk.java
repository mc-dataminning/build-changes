...
public class amk {
   ...
   private static bvi a(btj $$0, jn<bvh> $$1) throws CommandSyntaxException {
      bvi $$2 = a($$0).eV().a($$1);
      if ($$2 == null) {
   ...
   private static buf a(btj $$0) throws CommandSyntaxException {
      if (!($$0 instanceof buf)) {
         throw a.create($$0.aj());
      } else {
         return (buf)$$0;
   ...
   private static buf b(btj $$0, jn<bvh> $$1) throws CommandSyntaxException {
      buf $$2 = a($$0);
      if (!$$2.eV().b($$1)) {
         throw b.create($$0.aj(), a($$1));
      } else {
   ...
   private static int a(et $$0, btj $$1, jn<bvh> $$2, double $$3) throws CommandSyntaxException {
      buf $$4 = b($$1, $$2);
      double $$5 = $$4.h($$2);
   ...
   private static int b(et $$0, btj $$1, jn<bvh> $$2, double $$3) throws CommandSyntaxException {
      buf $$4 = b($$1, $$2);
      double $$5 = $$4.i($$2);
   ...
   private static int a(et $$0, btj $$1, jn<bvh> $$2, alb $$3, double $$4) throws CommandSyntaxException {
      buf $$5 = b($$1, $$2);
      bvj $$6 = $$5.eV();
      if (!$$6.a($$2, $$3)) {
   ...
   private static int c(et $$0, btj $$1, jn<bvh> $$2, double $$3) throws CommandSyntaxException {
      a($$1, $$2).a($$3);
      $$0.a(() -> xd.a("commands.attribute.base_value.set.success", a($$2), $$1.aj(), $$3), false);
      return 1;
   }

   private static int a(et $$0, btj $$1, jn<bvh> $$2, alb $$3, double $$4, bvk.a $$5) throws CommandSyntaxException {
      bvi $$6 = a($$1, $$2);
      bvk $$7 = new bvk($$3, $$4, $$5);
      if ($$6.b($$3)) {
   ...
   private static int a(et $$0, btj $$1, jn<bvh> $$2, alb $$3) throws CommandSyntaxException {
      bvi $$4 = a($$1, $$2);
      if ($$4.c($$3)) {
