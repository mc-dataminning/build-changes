...
class amk implements Path {
   private static final BasicFileAttributes a = new ami() {
      @Override
   ...
   private static final BasicFileAttributes b = new ami() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<amk> c = Comparator.comparing(amk::n);
   ...
   public amk(amm $$0, String $$1, @Nullable amk $$2, amn $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private amk a(@Nullable amk $$0, String $$1) {
      return new amk(this.e, $$1, $$0, amn.b);
   }
   ...
   amk a(String $$0) {
      if (a(this.i)) {
         return new amk(this.e, $$0, this, this.i);
      } else if (this.i instanceof amn.a $$1) {
         amk $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new amk(this.e, $$0, this, amn.a);
      } else if (this.i instanceof amn.b) {
         return new amk(this.e, $$0, this, amn.a);
      } else {
   ...
   private amk c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof amk $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof amn.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public amn.a i() {
      return this.i instanceof amn.a $$0 ? $$0 : null;
   }
