...
public class bad extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bfs.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bfs.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bfs.s);
