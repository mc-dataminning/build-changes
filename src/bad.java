...
public final class bad implements DynamicMBean {
   private static final Logger a = LogUtils.getLogger();
   private final MinecraftServer b;
   private final MBeanInfo c;
   private final Map<String, bad.a> d = Stream.of(
         new bad.a("tickTimes", this::b, "Historical tick times (ms)", long[].class),
         new bad.a("averageTickTime", this::a, "Current average tick time (ms)", long.class)
      )
      .collect(Collectors.toMap($$0x -> $$0x.a, Function.identity()));

   private bad(MinecraftServer $$0) {
      this.b = $$0;
      MBeanAttributeInfo[] $$1 = this.d.values().stream().map(bad.a::a).toArray(MBeanAttributeInfo[]::new);
