...
class amo implements Path {
   private static final BasicFileAttributes a = new amm() {
      @Override
   ...
   private static final BasicFileAttributes b = new amm() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<amo> c = Comparator.comparing(amo::n);
   ...
   public amo(amq $$0, String $$1, @Nullable amo $$2, amr $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private amo a(@Nullable amo $$0, String $$1) {
      return new amo(this.e, $$1, $$0, amr.b);
   }
   ...
   amo a(String $$0) {
      if (a(this.i)) {
         return new amo(this.e, $$0, this, this.i);
      } else if (this.i instanceof amr.a $$1) {
         amo $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new amo(this.e, $$0, this, amr.a);
      } else if (this.i instanceof amr.b) {
         return new amo(this.e, $$0, this, amr.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(amr $$0) {
      return $$0 == amr.a || $$0 == amr.b;
   }
   ...
   private amo c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof amo $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof amr.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public amr.a i() {
      return this.i instanceof amr.a $$0 ? $$0 : null;
   }
