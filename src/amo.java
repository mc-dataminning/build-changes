...
public class amo {
                        ...
                        ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)eu.a(
                                          ...
                                          .then(
                                             ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a(
                                                                  ...
                                                                  .then(eu.a("pink").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.a.a))))
                                                               .then(eu.a("blue").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.a.b))))
                                                            .then(eu.a("red").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.a.c))))
                                                         .then(eu.a("green").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.a.d))))
                                                      .then(eu.a("yellow").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.a.e))))
                                                   .then(eu.a("purple").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.a.f))))
                                                .then(eu.a("white").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.a.g)))
                                          ))
                                       .then(
                                          ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("style")
                                                         .then(eu.a("progress").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.b.a))))
                                                      .then(eu.a("notched_6").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.b.b))))
                                                   .then(eu.a("notched_10").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.b.c))))
                                                .then(eu.a("notched_12").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.b.d))))
                                             .then(eu.a("notched_20").executes($$0x -> a((et)$$0x.getSource(), a($$0x), bra.b.e)))
                                       ))
                                    .then(
                                       eu.a("value")
                                          .then(
   ...
   private static int d(et $$0, amd $$1) {
      if ($$1.g().isEmpty()) {
         $$0.a(() -> xd.a("commands.bossbar.get.players.none", $$1.e()), true);
      } else {
         $$0.a(() -> xd.a("commands.bossbar.get.players.some", $$1.e(), $$1.g().size(), xg.b($$1.g(), cnp::Q_)), true);
      }

      return $$1.g().size();
   }

   private static int a(et $$0, amd $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.f() == $$2) {
         if ($$2) {
            throw k.create();
         } else {
   ...
   private static int a(et $$0, amd $$1, int $$2) throws CommandSyntaxException {
      if ($$1.c() == $$2) {
         throw h.create();
      } else {
         $$1.a($$2);
   ...
   private static int b(et $$0, amd $$1, int $$2) throws CommandSyntaxException {
      if ($$1.d() == $$2) {
         throw i.create();
      } else {
         $$1.b($$2);
   ...
   private static int a(et $$0, amd $$1, bra.a $$2) throws CommandSyntaxException {
      if ($$1.k().equals($$2)) {
         throw f.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(et $$0, amd $$1, bra.b $$2) throws CommandSyntaxException {
      if ($$1.l().equals($$2)) {
         throw g.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(et $$0, amd $$1, xd $$2) throws CommandSyntaxException {
   ...
   private static int a(et $$0, amd $$1, Collection<arh> $$2) throws CommandSyntaxException {
      boolean $$3 = $$1.a($$2);
      if (!$$3) {
         throw d.create();
      } else {
         if ($$1.g().isEmpty()) {
            ...
            $$0.a(() -> xd.a("commands.bossbar.set.players.success.some", $$1.e(), $$2.size(), xg.b($$2, cnp::Q_)), true);
         }
   ...
   private static int a(et $$0) {
      Collection<amd> $$1 = $$0.l().aM().b();
      if ($$1.isEmpty()) {
         $$0.a(() -> xd.c("commands.bossbar.list.bars.none"), false);
      } else {
         $$0.a(() -> xd.a("commands.bossbar.list.bars.some", $$1.size(), xg.b($$1, amd::e)), false);
      }

      return $$1.size();
   }

   private static int a(et $$0, alb $$1, xd $$2) throws CommandSyntaxException {
      ame $$3 = $$0.l().aM();
      if ($$3.a($$1) != null) {
         throw b.create($$1.toString());
      } else {
         amd $$4 = $$3.a($$1, xg.a($$0, $$2, null, 0));
         $$0.a(() -> xd.a("commands.bossbar.create.success", $$4.e()), true);
         return $$3.b().size();
      }
   }

   private static int e(et $$0, amd $$1) {
      ame $$2 = $$0.l().aM();
      $$1.b();
      $$2.a($$1);
   ...
   public static amd a(CommandContext<et> $$0) throws CommandSyntaxException {
      alb $$1 = fu.c($$0, "id");
      amd $$2 = ((et)$$0.getSource()).l().aM().a($$1);
      if ($$2 == null) {
