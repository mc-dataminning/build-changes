...
public class amo {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wp.c("commands.deop.failed"));
   ...
   private static int a(ex $$0, Collection<GameProfile> $$1) throws CommandSyntaxException {
      ...
      for (GameProfile $$4 : $$1) {
         if ($$2.f($$4)) {
            $$2.b($$4);
            $$3++;
            $$0.a(() -> wp.a("commands.deop.success", $$1.iterator().next().getName()), true);
         }
      }
