...
public class bbf extends bfu {
   public bbf(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bgw.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bgw.s, "minecraft:jukebox");
