...
public class bbf extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgx.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bgx.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bgx.s);
