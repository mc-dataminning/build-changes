...
public class eem extends LongLinkedOpenHashSet {
   private final eem.a a;

   public eem(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new eem.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = auo.f(60000000);
      private static final int b = auo.f(60000000);
