...
public class eem implements efm<bwt> {
   ...
   public eem(eex $$0, ars $$1, Executor $$2) {
      this.e = $$0;
      this.d = $$1;
      this.g = new btg($$2, "entity-deserializer");
   }

   @Override
   public CompletableFuture<efh<bwt>> a(djc $$0) {
      if (this.f.contains($$0.a())) {
         ...
         return $$1.thenApplyAsync($$1x -> {
            if ($$1x.isEmpty()) {
               ...
               try {
                  djc $$2 = ((tz)$$1x.get()).<djc>a("Position", djc.a).orElseThrow();
               ...
               uf $$5 = $$4.p("Entities");
               List<bwt> $$6 = bxc.a($$5, this.d, bxb.r).collect(ImmutableList.toImmutableList());
               return new efh<>($$0, $$6);
            }
         }, this.g::a_);
      }
   ...
   private static efh<bwt> b(djc $$0) {
      return new efh<>($$0, ImmutableList.of());
   }

   @Override
   public void a(efh<bwt> $$0) {
      djc $$1 = $$0.a();
      if ($$0.c()) {
         if (this.f.add($$1.a())) {
         ...
         tz $$3 = uo.e(new tz());
         $$3.a("Entities", $$2);
         $$3.a("Position", djc.a, $$1);
         this.a(this.e.a($$1, $$3), $$1);
         this.f.remove($$1.a());
      }
   }

   private void a(CompletableFuture<?> $$0, djc $$1) {
      $$0.exceptionally($$1x -> {
   ...
   private void b(CompletableFuture<?> $$0, djc $$1) {
      $$0.exceptionally($$1x -> {
