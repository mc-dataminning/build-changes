...
public class eem {
   ...
   private final dhb o;
   private static final List<dkd> p = List.of(dkf.l, dkf.O, dkf.i, dkf.b, dkf.k, dkf.L, dkf.N, dkf.fA, dkf.ec, dkf.iY, dkf.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jq<dib>>> s;
   private final transient double[][] t;

   private eem(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> ae.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jq<dib>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kj.c($$0);
      int $$5 = kj.c($$1) - $$4;
   ...
   @Nullable
   public static eem a(@Nullable eem.d $$0) {
      return $$0 == null ? null : new eem($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public eem.d a() {
      ...
      return new eem.d(this.o.ap(), this.o.aq() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static eem a(asf $$0, int $$1, int $$2) {
      dzj $$3 = $$0.a($$1, $$2);
      eem $$4 = $$3.v();
      if ($$4 != null && !$$3.o().d(eak.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jn> a(dhx $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dzj $$1, int $$2, int $$3) {
      if (this.r[$$0] == Double.MAX_VALUE) {
         this.r[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.t[$$0] = this.a($$1, $$2, $$3, azu.a(this.r[$$0]));
      this.s.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dzj $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(edj.a.a)) {
         $$3 = Math.min($$0.a(edj.a.a, $$1, $$2), this.o.an());
      } else {
         $$3 = this.o.an();
      }
   ...
   private static double a(dzj $$0, jh.a $$1) {
      return a($$0, (jh)$$1.c(jm.a)) ? 1.0 : -1.0;
   }

   private static double b(dzj $$0, jh.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dzj $$0, int $$1, int $$2, int $$3) {
      double[] $$4 = new double[this.c()];
      Arrays.fill($$4, -1.0);
      jh.a $$5 = new jh.a($$1, this.o.an() + 1, $$2);
      double $$6 = b($$0, $$5);
   ...
   private List<jq<dib>> b(dzj $$0, int $$1, int $$2) {
      ObjectArrayList<jq<dib>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + kb.a(this.o.L_());
   ...
   private static boolean a(dzj $$0, jh $$1) {
      dxo $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(axk.Q)) {
         ...
         return $$2.a(dkf.fh) || $$2.a(dkf.fi) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, eem.a $$3) {
      if ($$1 >= kb.a(this.o.L_()) && $$1 <= kb.a(this.o.an())) {
         int $$4 = $$1 - kb.a(this.o.L_());

         for (int $$5 = 0; $$5 < this.s.size(); $$5++) {
            if (this.s.get($$5) != null) {
               jq<dib> $$6 = this.s.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, eem.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, eem.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jq<dib> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<eem.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(eem.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(eem.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(eem.d::c)
                  )
                  .apply($$0, eem.d::new)
         )
         .validate(eem.d::a);

      private static DataResult<eem.d> a(eem.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != eem.n
            ? DataResult.error(() -> "heights has to be of length " + eem.n)
