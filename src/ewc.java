...
public class ewc {
   ...
   public ewc(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ewc(ewh $$0, ewh $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static ewc a(eip $$0) {
      return new ewc((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static ewc a(ewh $$0) {
      return new ewc($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static ewc a(ja $$0, ja $$1) {
      return new ewc(
   ...
   public ewc a(double $$0) {
      return new ewc($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ewc b(double $$0) {
      return new ewc(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ewc c(double $$0) {
      return new ewc(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ewc d(double $$0) {
      return new ewc(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ewc e(double $$0) {
      return new ewc(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ewc f(double $$0) {
      return new ewc(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ewc b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ewc c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ewc d(double $$0, double $$1, double $$2) {
      return new ewc(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ewc f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ewc h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ewh> b(ewh $$0, ewh $$1) {
   ...
   @Nullable
   public static ewd a(Iterable<ewc> $$0, ewh $$1, ewh $$2, ja $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ewd($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jf a(ewc $$0, ewh $$1, double[] $$2, @Nullable jf $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public ewh f() {
      return new ewh(ayg.d(0.5, this.a, this.d), ayg.d(0.5, this.b, this.e), ayg.d(0.5, this.c, this.f));
   }

   public static ewc a(ewh $$0, double $$1, double $$2, double $$3) {
      return new ewc($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
