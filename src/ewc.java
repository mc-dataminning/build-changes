...
public class ewc {
   ...
   public static void a(File $$0, eow $$1, Consumer<vg> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eow $$2, Consumer<vg> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eow $$2, Consumer<vg> $$3) {
      epl $$4 = a($$2);
      ...
      ac.g().execute(() -> {
         try {
            $$4.a($$6);
            vg $$3x = vg.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new ve(ve.a.b, $$6.getAbsolutePath())));
            $$3.accept(vg.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(vg.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static epl a(eow $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      epl $$3 = new epl($$1, $$2, false);
   ...
   public ewc(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
