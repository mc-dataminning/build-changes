...
public class ewc implements evx {
   protected static final evx a = new ewc(false, -Double.MAX_VALUE, cuq.l, $$0 -> false, null) {
      @Override
      public boolean a(ewl $$0, iz $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected ewc(boolean $$0, double $$1, cuq $$2, Predicate<enw> $$3, @Nullable bsv $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected ewc(bsv $$0) {
      ...
      // 00: aload 0
      // 01: aload 1
      // 02: invokevirtual bsv.bZ ()Z
      // 05: aload 1
      // 06: invokevirtual bsv.dw ()D
      // 09: aload 1
      // 0a: instanceof btq
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast btq
      // 14: invokevirtual btq.eX ()Lcuq;
      // 17: goto 1d
      ...
      // 2c: pop
      // 2d: invokedynamic test (Lbtq;)Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, btq.a (Lenw;)Z, (Lenw;)Z ]
      // 32: goto 3a
      // 35: invokedynamic test ()Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, ewc.a (Lenw;)Z, (Lenw;)Z ]
      // 3a: aload 1
      // 3b: invokespecial ewc.<init> (ZDLcuq;Ljava/util/function/Predicate;Lbsv;)V
      // 3e: return
   }
