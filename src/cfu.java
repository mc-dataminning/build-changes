...
public class cfu {
   ...
   public boolean a(cqk<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(cqk<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cfu.a($$0).a($$2, $$1);
   }

   public int a(cqm<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(cqm<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cfu.a($$0.b()).b($$1, $$2);
   }

   public static cng a(int $$0) {
      return $$0 == 0 ? cng.f : new cng(cnb.b($$0));
   }
   ...
   class a {
      ...
      public boolean a(int $$0, @Nullable IntList $$1) {
         if ($$0 <= 0) {
            ...
            int $$2;
            for ($$2 = 0; this.a($$0); $$2++) {
               cfu.this.a(this.e[this.h.getInt(0)], $$0);
               int $$3 = this.h.size() - 1;
