...
public class cfu extends bpg implements cfs {
   private static final aim<Boolean> b = aiq.a(cfu.class, aio.k);
   private int c = 1;

   public cfu(bpd<? extends cfu> $$0, cxb $$1) {
      super($$0, $$1);
      this.bM = 5;
      this.bO = new cfu.b(this);
   }

   @Override
   protected void z() {
      this.bR.a(5, new cfu.d(this));
      this.bR.a(7, new cfu.a(this));
      this.bR.a(7, new cfu.c(this));
   ...
   private static boolean h(bnw $$0) {
      return $$0.c() instanceof cjk && $$0.d() instanceof ciu;
   }
   ...
   public static bqv.a y() {
      return bpr.A().a(bqw.q, 10.0).a(bqw.k, 100.0);
   }
   ...
   public static boolean b(bpd<cfu> $$0, cxc $$1, bpt $$2, ib $$3, axd $$4) {
      return $$1.aj() != bna.a && $$4.a(20) == 0 && a($$0, $$1, $$2, $$3, $$4);
   }
         ...
         if ($$0 != null) {
            ...
            if ($$0.g(this.b) < 4096.0 && this.b.E($$0)) {
               ...
               if (this.a == 20) {
                  ...
                  cjk $$8 = new cjk($$2, this.b, $$5, $$6, $$7, this.b.s());
