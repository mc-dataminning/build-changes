...
public class so extends ByteBuf {
   ...
   public <T> T a(DynamicOps<rq> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, rg.a);
   }

   @Deprecated
   public <T> T a(DynamicOps<rq> $$0, Codec<T> $$1, rg $$2) {
      rq $$3 = this.a($$2);
   ...
   public <T> void a(hl<hg<T>> $$0, hg<T> $$1, so.b<T> $$2) {
      switch ($$1.f()) {
         case a:
            int $$3 = $$0.a($$1);
            if ($$3 == -1) {
   ...
   public <T> hg<T> a(hl<hg<T>> $$0, so.a<T> $$1) {
      int $$2 = this.m();
      if ($$2 == 0) {
   ...
   @Nullable
   public qx p() {
      rq $$0 = this.a(new rg(2097152L));
      if ($$0 != null && !($$0 instanceof qx)) {
