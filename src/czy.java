...
public class czy {
   ...
   private final czy.a e;
   private final long f;

   public czy(czy.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public czy a(czy.a $$0) {
      return new czy($$0, this.f);
   }

   public il<czw> a(ib $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public il<czw> a(double $$0, double $$1, double $$2) {
      int $$3 = iw.a(axk.a($$0));
      int $$4 = iw.a(axk.a($$1));
      int $$5 = iw.a(axk.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = axg.a($$7, $$0);
      double $$10 = b($$7);
      return axk.k($$6 + $$10) + axk.k($$5 + $$9) + axk.k($$4 + $$8);
   }
   ...
   public interface a {
      il<czw> getNoiseBiome(int var1, int var2, int var3);
   }
}
