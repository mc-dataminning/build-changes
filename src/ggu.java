...
public class ggu implements ggz.a {
   ...
   private final ffe J;
   private final Map<iz, ggu.a> K = Maps.newHashMap();
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bst $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dK();
      });
   }

   private void b(ezx $$0, gdn $$1, double $$2, double $$3, double $$4) {
      iz $$5 = iz.a($$2, $$3, $$4);
   ...
   private static void a(ezx $$0, gdn $$1, iz $$2) {
      float $$3 = 0.05F;
      ggz.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(ezx $$0, gdn $$1, iz $$2, List<String> $$3) {
      float $$4 = 0.05F;
      ggz.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(ezx $$0, gdn $$1, ggu.a $$2) {
      int $$3 = 0;
   ...
   private void a(ezx $$0, gdn $$1, aat.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         ghh.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(ezx $$0, gdn $$1, aat.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(ezx $$0, gdn $$1, String $$2, ggu.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }

   private static void a(ezx $$0, gdn $$1, String $$2, iz $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      ggz.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(ezx $$0, gdn $$1, js $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      iz $$9 = iz.a($$2);
      ...
      float $$13 = 0.5F;
      ggz.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }

   private Set<String> b(ggu.a $$0) {
      return this.b($$0.a).stream().map(agr::a).collect(Collectors.toSet());
   }

   private Set<String> c(ggu.a $$0) {
   ...
   private void d() {
      ggz.a(this.J.an(), 8).ifPresent($$0 -> this.M = $$0.cz());
   }
