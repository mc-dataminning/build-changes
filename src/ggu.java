...
public class ggu {
   ...
   private ggu(int $$0, List<ggw> $$1) {
      this.a = $$1.toArray(ggw[]::new);
      this.b = $$1.size();
   }

   private List<ggw> c() {
      List<ggw> $$0 = new ArrayList<>(this.d());
