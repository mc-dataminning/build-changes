public class ctk extends crz {
   ...
   public ctk(int $$0, cot $$1) {
      this($$0, $$1, new coc($$1.k));
   }

   public ctk(int $$0, cot $$1, dei $$2) {
      super(cti.t, $$0);
      this.x = $$2;
      this.y = new ctj($$2);
      this.a(new ctw(this.y, 0, 136, 37));
      this.a(new ctw(this.y, 1, 162, 37));
      this.a(new ctl($$1.k, $$2, this.y, 2, 220, 37));
      this.c($$1, 108, 84);
   }
   ...
   private void r() {
      if (!this.x.gu()) {
         bul $$0 = (bul)this.x;
         $$0.dV().a($$0.dA(), $$0.dC(), $$0.dG(), this.x.gq(), awo.g, 1.0F, 1.0F, false);
      }
   }
   ...
   public void a(cou $$0) {
      ...
      this.x.a(null);
      if (!this.x.gu()) {
         if (!$$0.bL() || $$0 instanceof arq && ((arq)$$0).u()) {
            cwm $$1 = this.y.b(0);
            if (!$$1.f()) {
               $$0.a($$1, false);
            }
   ...
   private void a(int $$0, deh $$1) {
      for (int $$2 = 3; $$2 < 39; $$2++) {
         cwm $$3 = this.k.get($$2).g();
         if (!$$3.f() && $$1.a($$3)) {
            cwm $$4 = this.y.a($$0);
            if ($$4.f() || cwm.c($$3, $$4)) {
               int $$5 = $$3.k();
