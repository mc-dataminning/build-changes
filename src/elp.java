...
public class elp {
   ...
   public static final Codec<elp> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> ae.a($$0, 6).map($$0x -> new elp($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public elp(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static elp a() {
      return new elp(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static elp a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, jm $$9) {
      switch ($$9) {
         case d:
         default:
            return new elp($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new elp($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new elp($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new elp($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }
   ...
   public Stream<deh> b() {
      ...
      int $$2 = kj.a(this.k());
      int $$3 = kj.a(this.m());
      return deh.a(new deh($$0, $$1), new deh($$2, $$3));
   }

   public boolean a(elp $$0) {
   ...
   public static Optional<elp> a(Iterable<jh> $$0) {
      Iterator<jh> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         elp $$2 = new elp($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<elp> b(Iterable<elp> $$0) {
      Iterator<elp> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         elp $$2 = $$1.next();
         elp $$3 = new elp($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   @Deprecated
   public elp a(int $$0, int $$1, int $$2) {
      this.c += $$0;
      this.d += $$1;
      this.e += $$2;
      this.f += $$0;
   ...
   public elp b(int $$0, int $$1, int $$2) {
      return new elp(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }
   ...
   public elp c(int $$0, int $$1, int $$2) {
      return new elp(this.h() - $$0, this.i() - $$1, this.j() - $$2, this.k() + $$0, this.l() + $$1, this.m() + $$2);
   }
