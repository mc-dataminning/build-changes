...
public class fad {
   private final fad.a a;
   private final fad.b b;
   private final int c;
   private final int d;
   private final int e;

   public fad(int $$0, fad.a $$1, fad.b $$2, int $$3) {
      if (this.a($$0, $$2)) {
         this.b = $$2;
         this.a = $$1;
         this.c = $$0;
   ...
   private boolean a(int $$0, fad.b $$1) {
      return $$0 == 0 || $$1 == fad.b.d;
   }

   public final fad.a a() {
      return this.a;
   }

   public final fad.b b() {
      return this.b;
   }
   ...
   public static enum b {
      ...
      private final fad.b.b h;
      private final fad.b.a i;

      private b(final String $$0, final fad.b.b $$1, final fad.b.a $$2) {
         this.g = $$0;
         this.h = $$1;
         this.i = $$2;
      }
