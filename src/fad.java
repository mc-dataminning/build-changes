...
public class fad {
   private final ImmutableList<fae> a;
   private final ImmutableMap<String, fae> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private fab e;

   public fad(ImmutableMap<String, fae> $$0) {
      this.b = $$0;
