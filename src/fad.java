...
public interface fad {
   fad a(double var1, double var3, double var5);

   fad a(int var1, int var2, int var3, int var4);

   fad a(float var1, float var2);

   fad a(int var1, int var2);

   fad b(int var1, int var2);

   fad a(float var1, float var2, float var3);
   ...
   default fad a(float $$0, float $$1, float $$2, float $$3) {
   ...
   default void a(ezz.a $$0, gem $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(ezz.a $$0, gem $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      ...
      try {
         ByteBuffer $$19 = $$18.malloc(ezx.j.b());
   ...
   default fad a(ezz.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default fad a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default fad b(ezz.a $$0, float $$1, float $$2, float $$3) {
