...
public class dxa {
   ...
   private final List<dwy> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dxa.a l = new dxa.d(5.999997E7F);
   public static final dxa.c d = new dxa.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(jh $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(ezn $$0) {
   ...
   public ezn c(double $$0, double $$1, double $$2) {
      return new ezn(azk.a($$0, this.e(), this.g() - 1.0E-5F), $$1, azk.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dxa.a)($$0 == $$1 ? new dxa.d($$1) : new dxa.b($$0, $$1, $$2));
   ...
   public dxa.c t() {
      return new dxa.c(this);
   }

   public void a(dxa.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dxa.a {
      ...
      @Override
      public double a() {
         return azk.a(dxa.this.a() - this.e() / 2.0, (double)(-dxa.this.k), (double)dxa.this.k);
      }

      @Override
      public double c() {
         return azk.a(dxa.this.b() - this.e() / 2.0, (double)(-dxa.this.k), (double)dxa.this.k);
      }
      ...
      @Override
      public dwz i() {
         return this.c < this.b ? dwz.b : dwz.a;
      }
      ...
      @Override
      public dxa.a l() {
         return (dxa.a)(this.g() <= 0L ? dxa.this.new d(this.c) : this);
      }
      ...
      public fah m() {
         return fae.a(
            fae.c,
            fae.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ezr.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dxa.c a(DynamicLike<?> $$0, dxa.c $$1) {
         ...
         return new dxa.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dxa.a {
      ...
      private void n() {
         this.c = azk.a(dxa.this.a() - this.b / 2.0, (double)(-dxa.this.k), (double)dxa.this.k);
         this.d = azk.a(dxa.this.b() - this.b / 2.0, (double)(-dxa.this.k), (double)dxa.this.k);
         this.e = azk.a(dxa.this.a() + this.b / 2.0, (double)(-dxa.this.k), (double)dxa.this.k);
         this.f = azk.a(dxa.this.b() + this.b / 2.0, (double)(-dxa.this.k), (double)dxa.this.k);
         this.g = fae.a(
            fae.c,
            fae.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ezr.e
