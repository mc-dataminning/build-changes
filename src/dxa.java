...
public abstract class dxa<O, S> {
   ...
   private static final Function<Entry<dya<?>, Comparable<?>>, String> a = new Function<Entry<dya<?>, Comparable<?>>, String>() {
      public String a(@Nullable Entry<dya<?>, Comparable<?>> $$0) {
         if ($$0 == null) {
            return "<NULL>";
         } else {
            dya<?> $$1 = $$0.getKey();
      ...
      private <T extends Comparable<T>> String a(dya<T> $$0, Comparable<?> $$1) {
         return $$0.b((T)$$1);
      }
   };
   protected final O d;
   ...
   protected dxa(O $$0, Reference2ObjectArrayMap<dya<?>, Comparable<?>> $$1, MapCodec<S> $$2) {
      this.d = $$0;
      this.f = $$1;
      this.e = $$2;
   }

   public <T extends Comparable<T>> S a(dya<T> $$0) {
   ...
   public <T extends Comparable<T>> boolean b(dya<T> $$0) {
      return this.f.containsKey($$0);
   }

   public <T extends Comparable<T>> T c(dya<T> $$0) {
   ...
   public <T extends Comparable<T>> Optional<T> d(dya<T> $$0) {
      return Optional.ofNullable(this.e($$0));
   }

   public <T extends Comparable<T>> T a(dya<T> $$0, T $$1) {
      return Objects.requireNonNullElse(this.e($$0), $$1);
   }

   @Nullable
   public <T extends Comparable<T>> T e(dya<T> $$0) {
      Comparable<?> $$1 = (Comparable<?>)this.f.get($$0);
      return $$1 == null ? null : $$0.g().cast($$1);
   }

   public <T extends Comparable<T>, V extends T> S b(dya<T> $$0, V $$1) {
   ...
   public <T extends Comparable<T>, V extends T> S c(dya<T> $$0, V $$1) {
      Comparable<?> $$2 = (Comparable<?>)this.f.get($$0);
      return (S)($$2 == null ? this : this.a($$0, $$1, $$2));
   }

   private <T extends Comparable<T>, V extends T> S a(dya<T> $$0, V $$1, Comparable<?> $$2) {
      if ($$2.equals($$1)) {
         return (S)this;
      } else {
         int $$3 = $$0.a((T)$$1);
   ...
   public void a(Map<Map<dya<?>, Comparable<?>>, S> $$0) {
      if (this.g != null) {
         throw new IllegalStateException();
      } else {
         Map<dya<?>, S[]> $$1 = new Reference2ObjectArrayMap(this.f.size());
         ObjectIterator var3 = this.f.entrySet().iterator();

         while (var3.hasNext()) {
            Entry<dya<?>, Comparable<?>> $$2 = (Entry<dya<?>, Comparable<?>>)var3.next();
            dya<?> $$3 = $$2.getKey();
   ...
   private Map<dya<?>, Comparable<?>> d(dya<?> $$0, Comparable<?> $$1) {
      Map<dya<?>, Comparable<?>> $$2 = new Reference2ObjectArrayMap(this.f);
      $$2.put($$0, $$1);
      return $$2;
   }
   ...
   protected static <O, S extends dxa<O, S>> Codec<S> a(Codec<O> $$0, Function<O, S> $$1) {
