...
public class dxa {
   ...
   static class a implements dxa.i {
      @Override
      public boolean a(dxa.v $$0) {
         return $$0.c[ha.f.d()] && !$$0.b[ha.f.d()].d;
      }

      @Override
      public dxa.r a(ha $$0, dxa.v $$1, aru $$2) {
         $$1.d = true;
         $$1.b[ha.f.d()].d = true;
         return new dxa.k($$0, $$1);
      }
   }

   static class b implements dxa.i {
      @Override
      public boolean a(dxa.v $$0) {
      ...
      public dxa.r a(ha $$0, dxa.v $$1, aru $$2) {
         ...
         return new dxa.l($$0, $$1);
      }
   }

   static class c implements dxa.i {
      @Override
      public boolean a(dxa.v $$0) {
      ...
      public dxa.r a(ha $$0, dxa.v $$1, aru $$2) {
         $$1.d = true;
         $$1.b[ha.b.d()].d = true;
         return new dxa.m($$0, $$1);
      }
   }

   static class d implements dxa.i {
      @Override
      public boolean a(dxa.v $$0) {
      ...
      public dxa.r a(ha $$0, dxa.v $$1, aru $$2) {
         ...
         return new dxa.n($$0, $$1);
      }
   }

   static class e implements dxa.i {
      @Override
      public boolean a(dxa.v $$0) {
      ...
      public dxa.r a(ha $$0, dxa.v $$1, aru $$2) {
         ...
         $$3.d = true;
         $$3.b[ha.c.d()].d = true;
         return new dxa.o($$0, $$3);
      }
   }

   static class f implements dxa.i {
      @Override
      public boolean a(dxa.v $$0) {
         return true;
      }
      ...
      public dxa.r a(ha $$0, dxa.v $$1, aru $$2) {
         $$1.d = true;
         return new dxa.s($$0, $$1, $$2);
      }
   }

   static class g implements dxa.i {
      @Override
      public boolean a(dxa.v $$0) {
      ...
      public dxa.r a(ha $$0, dxa.v $$1, aru $$2) {
         $$1.d = true;
         return new dxa.t($$0, $$1);
      }
   }

   public static class h extends dxa.r {
      ...
      private dxa.v G;
      private dxa.v H;
      private final List<dxa.r> I = Lists.newArrayList();

      public h(aru $$0, int $$1, int $$2, ha $$3) {
         super(dvp.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<dxa.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new dxa.p($$3, this.G));
         this.I.add(new dxa.j($$3, this.H));
         List<dxa.i> $$5 = Lists.newArrayList();
         $$5.add(new dxa.b());
         $$5.add(new dxa.d());
         $$5.add(new dxa.e());
         $$5.add(new dxa.a());
         ...
         duq $$10 = duq.a(this.b(1, 1, 1), this.b(23, 8, 21));
         duq $$11 = duq.a(this.b(34, 1, 1), this.b(56, 8, 21));
         duq $$12 = duq.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new dxa.u($$3, $$10, $$13++));
         this.I.add(new dxa.u($$3, $$11, $$13++));
         this.I.add(new dxa.q($$3, $$12));
      }
      ...
      private List<dxa.v> b(aru $$0) {
         dxa.v[] $$1 = new dxa.v[75];
         ...
         dxa.v $$23 = new dxa.v(1003);
         dxa.v $$24 = new dxa.v(1001);
         dxa.v $$25 = new dxa.v(1002);
         $$1[v].a(ha.b, $$23);
         $$1[w].a(ha.d, $$24);
         $$1[x].a(ha.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<dxa.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cqf $$2, aru $$3, duq $$4) {
         int $$5 = 24;
      ...
      private void a(cqf $$0, aru $$1, duq $$2) {
      ...
      private void b(cqf $$0, aru $$1, duq $$2) {
      ...
      private void c(cqf $$0, aru $$1, duq $$2) {
      ...
      private void d(cqf $$0, aru $$1, duq $$2) {
      ...
      private void e(cqf $$0, aru $$1, duq $$2) {
      ...
      private void f(cqf $$0, aru $$1, duq $$2) {
   ...
   interface i {
      boolean a(dxa.v var1);

      dxa.r a(ha var1, dxa.v var2, aru var3);
   }

   public static class j extends dxa.r {
      public j(ha $$0, dxa.v $$1) {
         super(dvp.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cqf $$0, cqd $$1, dgw $$2, aru $$3, duq $$4, cos $$5, gu $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, csm.ch.n(), csm.ch.n(), false);
   ...
   public static class k extends dxa.r {
      public k(ha $$0, dxa.v $$1) {
         super(dvp.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends dxa.r {
      public l(ha $$0, dxa.v $$1) {
         super(dvp.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends dxa.r {
      public m(ha $$0, dxa.v $$1) {
         super(dvp.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends dxa.r {
      public n(ha $$0, dxa.v $$1) {
         super(dvp.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends dxa.r {
      public o(ha $$0, dxa.v $$1) {
         super(dvp.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends dxa.r {
      public p(ha $$0, dxa.v $$1) {
         super(dvp.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends dxa.r {
      public q(ha $$0, duq $$1) {
         super(dvp.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dvc {
      protected static final dez b = csm.hZ.n();
      protected static final dez c = csm.ia.n();
      protected static final dez d = csm.ib.n();
      protected static final dez h = c;
      protected static final dez i = csm.ii.n();
      protected static final boolean j = true;
      protected static final dez k = csm.G.n();
      protected static final Set<csl> l = ImmutableSet.builder().add(csm.dO).add(csm.iC).add(csm.mW).add(k.b()).build();
      ...
      public r(dvp $$0, ha $$1, int $$2, duq $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dvp $$0, int $$1, ha $$2, dxa.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static duq a(ha $$0, dxa.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         duq $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cqf $$0, duq $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dez $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(cqf $$0, duq $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cqf $$0, duq $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dez $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(duq $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cqf $$0, duq $$1, int $$2, int $$3, int $$4) {
         gu $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            byp $$6 = bim.A.a((cpl)$$0.C());
            if ($$6 != null) {
               $$6.b($$6.eK());
   ...
   public static class s extends dxa.r {
      private int a;

      public s(ha $$0, dxa.v $$1, aru $$2) {
         super(dvp.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends dxa.r {
      public t(ha $$0, dxa.v $$1) {
         super(dvp.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends dxa.r {
      private int a;

      public u(ha $$0, duq $$1, int $$2) {
         super(dvp.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
