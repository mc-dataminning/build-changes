...
public final class ezy {
   ...
   private static final fab d = ad.a(() -> {
      ezq $$0 = new ezk(1, 1, 1);
      $$0.c(0, 0, 0);
      return new ezo($$0);
   });
   public static final fab c = a(
   ...
   private static final fab e = new ezj(
      new ezk(0, 0, 0), new DoubleArrayList(new double[]{0.0}), new DoubleArrayList(new double[]{0.0}), new DoubleArrayList(new double[]{0.0})
   );
   ...
   public static fab b(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
   ...
   public static fab a(fab $$0, fab... $$1) {
      return Arrays.stream($$1).reduce($$0, ezy::a);
   }

   public static fab a(fab $$0, fab $$1, ezl $$2) {
      return b($$0, $$1, $$2).d();
   }

   public static fab b(fab $$0, fab $$1, ezl $$2) {
      if ($$2.apply(false, false)) {
         ...
         if ($$0.c()) {
            ...
            ezt $$5 = a(1, $$0.a(jl.a.a), $$1.a(jl.a.a), $$3, $$4);
            ezt $$6 = a($$5.size() - 1, $$0.a(jl.a.b), $$1.a(jl.a.b), $$3, $$4);
            ezt $$7 = a(($$5.size() - 1) * ($$6.size() - 1), $$0.a(jl.a.c), $$1.a(jl.a.c), $$3, $$4);
            ezk $$8 = ezk.a($$0.a, $$1.a, $$5, $$6, $$7, $$2);
            return (fab)($$5 instanceof ezp && $$6 instanceof ezp && $$7 instanceof ezp ? new ezo($$8) : new ezj($$8, $$5.a(), $$6.a(), $$7.a()));
         }
      }
   }

   public static boolean c(fab $$0, fab $$1, ezl $$2) {
      if ($$2.apply(false, false)) {
         throw (IllegalArgumentException)ad.b(new IllegalArgumentException());
      } else {
         boolean $$3 = $$0.c();
         ...
         if (!$$3 && !$$4) {
            if ($$0 == $$1) {
               ...
               ezt $$8 = a(1, $$0.a(jl.a.a), $$1.a(jl.a.a), $$5, $$6);
               ezt $$9 = a($$8.size() - 1, $$0.a(jl.a.b), $$1.a(jl.a.b), $$5, $$6);
               ezt $$10 = a(($$8.size() - 1) * ($$9.size() - 1), $$0.a(jl.a.c), $$1.a(jl.a.c), $$5, $$6);
   ...
   private static boolean a(ezt $$0, ezt $$1, ezt $$2, ezq $$3, ezq $$4, ezl $$5) {
      return !$$0.a(($$5x, $$6, $$7) -> $$1.a(($$6x, $$7x, $$8) -> $$2.a(($$7xx, $$8x, $$9) -> !$$5.apply($$3.e($$5x, $$6x, $$7xx), $$4.e($$6, $$7x, $$8x)))));
   }

   public static double a(jl.a $$0, ezc $$1, Iterable<fab> $$2, double $$3) {
      for (fab $$4 : $$2) {
   ...
   public static boolean a(fab $$0, fab $$1, jl $$2) {
      if ($$0 == b() && $$1 == b()) {
         return true;
      } else if ($$1.c()) {
         return false;
         ...
         fab $$5 = $$4 == jl.b.a ? $$0 : $$1;
         fab $$6 = $$4 == jl.b.a ? $$1 : $$0;
         ezl $$7 = $$4 == jl.b.a ? ezl.e : ezl.c;
         return DoubleMath.fuzzyEquals($$5.c($$3), 1.0, 1.0E-7)
            && DoubleMath.fuzzyEquals($$6.b($$3), 0.0, 1.0E-7)
            && !c(new ezz($$5, $$3, $$5.a.c($$3) - 1), new ezz($$6, $$3, 0), $$7);
      }
   }

   public static boolean b(fab $$0, fab $$1, jl $$2) {
      if ($$0 != b() && $$1 != b()) {
         jl.a $$3 = $$2.o();
         jl.b $$4 = $$2.f();
         fab $$5 = $$4 == jl.b.a ? $$0 : $$1;
         ...
         return !c(b(), b(new ezz($$5, $$3, $$5.a.c($$3) - 1), new ezz($$6, $$3, 0), ezl.o), ezl.e);
      } else {
         return true;
      }
   }

   public static boolean b(fab $$0, fab $$1) {
      if ($$0 == b() || $$1 == b()) {
         return true;
      } else {
         return $$0.c() && $$1.c() ? false : !c(b(), b($$0, $$1, ezl.o), ezl.e);
      }
   }

   @VisibleForTesting
   protected static ezt a(int $$0, DoubleList $$1, DoubleList $$2, boolean $$3, boolean $$4) {
      int $$5 = $$1.size() - 1;
      int $$6 = $$2.size() - 1;
      if ($$1 instanceof ezn && $$2 instanceof ezn) {
         long $$7 = a($$5, $$6);
         if ((long)$$0 * $$7 <= 256L) {
            return new ezp($$5, $$6);
         }
      ...
      if ($$1.getDouble($$5) < $$2.getDouble(0) - 1.0E-7) {
         return new ezw($$1, $$2, false);
      } else if ($$2.getDouble($$6) < $$1.getDouble(0) - 1.0E-7) {
         return new ezw($$2, $$1, true);
      } else {
         return (ezt)($$5 == $$6 && Objects.equals($$1, $$2) ? new ezs($$1) : new ezu($$1, $$2, $$3, $$4));
      }
   }
