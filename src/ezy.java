...
public class ezy {
   ...
   public static final ezy.a bv;

   public static ezy.a a(int $$0, int $$1) {
      return $$0 == -1 ? ezy.b.b.a($$1) : ezy.b.a.a($$0);
   }

   public static ezy.a a(String $$0) {
      if (ezy.a.e.containsKey($$0)) {
         return ezy.a.e.get($$0);
      } else {
         for (ezy.b $$1 : ezy.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ezy.b b;
      private final int c;
      private final ayh<wy> d;
      static final Map<String, ezy.a> e = Maps.newHashMap();

      a(String $$0, ezy.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      c("key.mouse", ($$0, $$1) -> tv.a().b($$1) ? wy.c($$1) : wy.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ezy.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wy> g;

      private static void a(ezy.b $$0, String $$1, int $$2) {
         ezy.a $$3 = new ezy.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public ezy.a a(int $$0) {
         return (ezy.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
