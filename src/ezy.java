...
public class ezy {
   private final ImmutableList<ezz> a;
   private final ImmutableMap<String, ezz> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private ezw e;

   public ezy(ImmutableMap<String, ezz> $$0) {
      this.b = $$0;
