...
public class ezy extends esb {
   ...
   private void a(ul $$0, jp.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         if ($$3.b("NameTagVisibility", 8)) {
            ezz.b $$9 = ezz.b.a($$3.l("NameTagVisibility"));
            if ($$9 != null) {
               $$5.a($$9);
            }
         }
         ...
         if ($$3.b("DeathMessageVisibility", 8)) {
            ezz.b $$10 = ezz.b.a($$3.l("DeathMessageVisibility"));
            if ($$10 != null) {
               $$5.b($$10);
            }
         }
         ...
         if ($$3.b("CollisionRule", 8)) {
            ezz.a $$11 = ezz.a.a($$3.l("CollisionRule"));
            if ($$11 != null) {
               $$5.a($$11);
            }
         }
   ...
   private void b(ul $$0, jp.a $$1) {
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         ...
         faa $$5 = faa.a($$4).orElseGet(() -> {
            b.warn("Unknown scoreboard criteria {}, replacing with {}", $$4, faa.b.d());
            return faa.b;
         });
         String $$6 = $$3.l("Name");
         xd $$7 = xd.a.a($$3.l("DisplayName"), $$1);
         faa.a $$8 = faa.a.a($$3.l("RenderType"));
