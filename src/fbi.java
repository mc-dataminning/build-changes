...
public record fbi(int i, int j, fbi.a k, fbi.b l, int m) {
   public static final int a = 32;
   private static final fbi[] n = new fbi[32];
   private static final List<fbi> o = new ArrayList<>(32);
   public static final fbi b = a(0, 0, fbi.a.a, fbi.b.a, 3);
   public static final fbi c = a(1, 0, fbi.a.b, fbi.b.c, 4);
   public static final fbi d = a(2, 0, fbi.a.a, fbi.b.d, 2);
   public static final fbi e = d;
   public static final fbi f = a(3, 1, fbi.a.e, fbi.b.d, 2);
   public static final fbi g = a(4, 2, fbi.a.e, fbi.b.d, 2);
   public static final fbi h = a(5, 0, fbi.a.c, fbi.b.b, 3);

   public fbi(int i, int j, fbi.a k, fbi.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fbi a(int $$0, int $$1, fbi.a $$2, fbi.b $$3, int $$4) {
      fbi $$5 = new fbi($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   public static Stream<fbi> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fbi.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
