...
public class fbi extends fbt {
   private static final Logger c = LogUtils.getLogger();
   public long a;
   public List<UUID> b;

   public static fbi a(JsonObject $$0) {
      fbi $$1 = new fbi();

      try {
         $$1.a = fdq.a("serverId", $$0, -1L);
         String $$2 = fdq.b("playerList", $$0, null);
         if ($$2 != null) {
   ...
   private static List<UUID> a(JsonArray $$0) {
      ...
      for (JsonElement $$2 : $$0) {
         if ($$2.isJsonObject()) {
            UUID $$3 = fdq.a("playerId", $$2.getAsJsonObject(), null);
            if ($$3 != null) {
               $$1.add($$3);
            }
         }
