...
public class fbi {
   ...
   public fbi(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<fbj> $$1) throws IOException {
   ...
   public List<fbj> a(Path $$0) throws IOException {
      List<fbj> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<fbj> a(Path $$0, boolean $$1) throws IOException {
      List<fbj> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<fbj> $$1) throws IOException {
