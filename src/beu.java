...
public class beu extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bhs.B);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         bau.a(this.a("minecraft:trident", beu::c), this.a("minecraft:arrow", beu::a), this.a("minecraft:spectral_arrow", beu::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, beu.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bhs.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bhs.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, beu.a<?> $$1, Type<?> $$2, Type<T> $$3) {
