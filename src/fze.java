...
public class fze extends foo {
   ...
   private fze.a c(boolean $$0) {
      ...
      List<hkd> $$2 = new ArrayList<>(hkd.g());
      $$2.sort(Comparator.comparing(hkd::d));
   ...
   private void a(fze.b $$0, hkd $$1, boolean $$2) {
   ...
   private void a(hkd $$0, fze.b $$1, boolean $$2) {
      for (hkf<?> $$3 : $$0.b()) {
   ...
   static class b {
      ...
      public void a(fob $$0, wp $$1) {
         this.a($$0, $$1, 0);
      }

      public void a(fob $$0, wp $$1, int $$2) {
         this.b.a(new fpm($$1, $$0).d(this.a), $$1x -> $$1x.e($$2));
         this.c.b($$1).f("\n");
      }

      public void b(fob $$0, wp $$1) {
