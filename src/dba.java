...
public abstract class dba {
   ...
   public void a(bta<?> $$0, @Nullable dby $$1, azh $$2, iz $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!bul.a($$7.get(), $$0, btt.c, $$13, $$0.E_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        dwj.b($$15.getClass()),
                        new evm((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bsz.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof btr $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, btt.c) || !$$17.a($$0)) {
                        continue;
                     }

                     boolean $$18 = $$4.a().f() == 1 && $$4.a().b("id", 8);
                     if ($$18) {
                        ((btr)$$15).a($$0, $$0.d_($$15.dp()), btt.c, null);
                     }
   ...
   private void d(dby $$0, iz $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dcp)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dby $$0, iz $$1, us $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dcp $$4 = dcp.b.parse(vg.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dcp::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dcp.c.parse(vg.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bpe::b);
      } else {
         this.e = bpe.a(this.f != null ? this.f : new dcp());
      }
   ...
   public us a(us $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (vp)dcp.b.encodeStart(vg.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (vp)dcp.c.encodeStart(vg.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bsu b(dby $$0, iz $$1) {
      if (this.l == null) {
         ...
         this.l = bta.a($$2, $$0, Function.identity());
         if ($$2.f() == 1 && this.l instanceof btr) {
         }
      }
   ...
   protected void a(@Nullable dby $$0, iz $$1, dcp $$2) {
      this.f = $$2;
   }

   private dcp a(@Nullable dby $$0, azh $$1, iz $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bpg.b::b).orElseGet(dcp::new));
         return this.f;
      }
   }

   public abstract void a(dby var1, iz var2, int var3);
