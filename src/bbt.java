...
public class bbt extends bhp {
   ...
   public bbt(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bit.s, "minecraft:banner");
   }
   ...
   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(bbt::b)));
   }
   ...
   private static Dynamic<?> b(Dynamic<?> $$0) {
      ...
      $$0 = $$0.set("color", $$0.createString(bbb.a($$0.get("Color").asInt(0))));
