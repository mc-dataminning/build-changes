public class gtc<T extends ckw> extends gse<T, gzj> {
   ...
   protected int a(T $$0, ji $$1) {
      return $$0.aq() == but.af ? Math.max(5, super.a($$0, $$1)) : super.a($$0, $$1);
   }

   public void a(gzj $$0, ffv $$1, glz $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      $$1.a();
      jn $$4 = $$0.a;
      fbb $$5 = this.a($$0);
      ...
      if (!$$0.z) {
         ...
         $$1.a();
         $$1.a(-0.5F, -0.5F, -0.5F);
         this.j.b().a($$1.c(), $$2.getBuffer(gmj.e(hes.d)), null, $$11.a($$12), 1.0F, 1.0F, 1.0F, $$3, hej.d);
         $$1.b();
      }
   ...
   private static hhi b(gzj $$0) {
      if ($$0.e != null) {
         return $$0.d ? hgv.a : hgv.c;
      } else {
         return $$0.d ? hgv.b : hgv.d;
      }
   }

   public fbb a(gzj $$0) {
      return new fbb((double)((float)$$0.a.j() * 0.3F), -0.25, (double)((float)$$0.a.l() * 0.3F));
   }

   protected boolean a(T $$0, double $$1) {
      return flk.M() && this.e.c == $$0 && $$0.A().z() != null;
   }
