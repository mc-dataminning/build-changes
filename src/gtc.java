...
public class gtc extends MinecraftServer {
   ...
   public gtc(Thread $$0, ffd $$1, epu.c $$2, atz $$3, amb $$4, aly $$5, aro $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.as(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new gtb(this, this.bd(), this.g));
      this.m = $$1;
   }
   ...
   @Override
   public dbt bf() {
      return this.r() ? (dbt)MoreObjects.firstNonNull(this.p, this.j.k()) : null;
   }
