...
public class gtc extends gqk<cim, gzb, gcj> {
   private static final Map<cim.a, alz> a = ae.a(Maps.newEnumMap(cim.a.class), $$0 -> {
      $$0.put(cim.a.a, alz.b("textures/entity/panda/panda.png"));
      $$0.put(cim.a.b, alz.b("textures/entity/panda/lazy_panda.png"));
      $$0.put(cim.a.c, alz.b("textures/entity/panda/worried_panda.png"));
      $$0.put(cim.a.d, alz.b("textures/entity/panda/playful_panda.png"));
      $$0.put(cim.a.e, alz.b("textures/entity/panda/brown_panda.png"));
      $$0.put(cim.a.f, alz.b("textures/entity/panda/weak_panda.png"));
      $$0.put(cim.a.g, alz.b("textures/entity/panda/aggressive_panda.png"));
   });

   public gtc(grq.a $$0) {
      super($$0, new gcj($$0.a(gen.bI)), new gcj($$0.a(gen.bJ)), 0.9F);
      this.a(new gwb(this, $$0.b()));
   }

   public alz a(gzb $$0) {
      return a.getOrDefault($$0.a, a.get(cim.a.a));
   }
   ...
   protected void a(gzb $$0, fgs $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.k > 0.0F) {
         float $$4 = bae.i($$0.k);
         int $$5 = bae.d($$0.k);
