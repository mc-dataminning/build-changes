...
public class frv extends fnc {
   private static final Logger a = LogUtils.getLogger();
   private static final ToIntFunction<ald<dbx>> b = ac.a(new Reference2IntOpenHashMap(), $$0 -> {
      $$0.put(dbx.h, -13408734);
      $$0.put(dbx.i, -10075085);
      $$0.put(dbx.j, -8943531);
   ...
   @Nullable
   public static frv a(ffe $$0, BooleanConsumer $$1, DataFixer $$2, epv.c $$3, boolean $$4) {
      try {
         fsb $$5 = $$0.x();
         atz $$6 = auc.a($$3);
   ...
   private frv(BooleanConsumer $$0, DataFixer $$1, epv.c $$2, dcb $$3, boolean $$4, jw $$5) {
      super(xo.a("optimizeWorld.title", $$3.a()));
      this.c = $$0;
      this.d = new bqh($$2, $$1, $$5, $$4, false);
   }
   ...
   public void a(fgq $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.d.e() > 0) {
         ...
         xo $$13 = xo.a("optimizeWorld.progress.percentage", ayy.d(this.d.d() * 100.0F));
