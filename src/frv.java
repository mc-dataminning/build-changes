...
public class frv extends fnd {
   ...
   public frv(fnd $$0, aua $$1, Consumer<aua> $$2) {
      super(a);
      this.r = $$0;
      this.s = $$1;
      this.u = $$2;
   ...
   protected void aM_() {
      this.d.a(a, this.p);
      fkv $$0 = this.d.c(fkv.d());
      $$0.a(new fhy(b, this.p).d(310), $$0x -> $$0x.e(15));
      frz.a $$1 = frz.a(310).a(2, true).b(4);
      this.v.forEach(($$1x, $$2x) -> $$1.a(a($$1x), () -> this.v.getBoolean($$1x), $$1xx -> this.v.put($$1x, $$1xx)).a($$1x.c()));
      $$1.a($$0::a);
      fkv $$2 = this.d.b(fkv.e().a(8));
      $$2.a(fhe.a(xo.d, $$0x -> this.m()).a());
      $$2.a(fhe.a(xo.e, $$0x -> this.d()).a());
      this.d.a($$1x -> {
