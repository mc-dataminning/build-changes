...
public record gmb(Map<String, String> c, Set<String> d) {
   public static final gmb a = new gmb(Map.of(), Set.of());
   public static final Codec<gmb> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(gmb::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(gmb::e)
            )
            .apply($$0, gmb::new)
   );

   public static gmb.a a() {
      return new gmb.a();
   }
   ...
   public gmb a(gmb $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new gmb($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public gmb.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public gmb.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gmb.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public gmb a() {
         return new gmb(this.a.build(), this.b.build());
      }
   }
}
