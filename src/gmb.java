...
public class gmb implements gmh.a {
   ...
   private final fji F;
   private final Map<jh, gmb.a> G = Maps.newHashMap();
   private final Map<UUID, aap.a> H = Maps.newHashMap();
   @Nullable
   private UUID I;
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         bue $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dS();
      });
   }

   private void b(feb $$0, gih $$1, double $$2, double $$3, double $$4) {
      jh $$5 = jh.a($$2, $$3, $$4);
   ...
   private void a(feb $$0, gih $$1, gmb.a $$2) {
      int $$3 = 0;
   ...
   private void a(feb $$0, gih $$1, aap.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gmq.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(feb $$0, gih $$1, aap.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(feb $$0, gih $$1, String $$2, gmb.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private boolean c(aap.a $$0) {
      com $$1 = this.F.t;
      jh $$2 = jh.a($$1.dC(), $$0.h().b(), $$1.dI());
      jh $$3 = jh.a((ka)$$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(jh $$0) {
      return this.H.values().stream().filter($$1 -> $$1.a($$0)).map(aap.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(jh $$0) {
      return this.H.values().stream().filter($$1 -> $$1.b($$0)).map(aap.a::a).collect(Collectors.toSet());
   }

   private Map<jh, List<String>> c() {
      Map<jh, List<String>> $$0 = Maps.newHashMap();

      for (aap.a $$1 : this.H.values()) {
   ...
   private void d() {
      gmh.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cH());
   }
