...
public final class emp extends emn<emq.a, emq> {
   private static final long g = emn.a.a(15);
   private static final long h = emn.a.a(15, it.b);
   private static final long i = emn.a.a(15, false, it.b);
   ...
   private int a(int $$0, int $$1, int $$2) {
      emg $$3 = this.b(jq.a($$0), jq.a($$1));
      return $$3 == null ? $$2 : $$3.a(jq.b($$0), jq.b($$1));
   }

   @Nullable
   private emg b(int $$0, int $$1) {
      dtl $$2 = this.e.c($$0, $$1);
         ...
         if (emn.a.a($$1, $$5)) {
            ...
            if (this.f.b(jq.e($$6))) {
               ...
               if ($$8 > $$7) {
                  ...
                  if ($$10 > $$7) {
                     if ($$3 == null) {
                        $$3 = emn.a.b($$1) ? dec.a.n() : this.c(this.j.f($$0));
                     }

                     if (!this.a($$0, $$3, $$6, $$9, $$5)) {
                        this.f.a($$6, $$10);
                        if ($$10 > 1) {
                           this.c($$6, emn.a.a($$10, a($$9), $$5.g()));
                        }
         ...
         if (emn.a.a($$1, $$4)) {
            ...
            if (this.f.b(jq.e($$5))) {
               ...
               if ($$6 != 0) {
                  if ($$6 <= $$3 - 1) {
                     this.f.a($$5, 0);
                     this.b($$5, emn.a.a($$6, $$4.g()));
                     this.a($$5, $$4, $$6, false, $$2);
                  } else {
                     this.c($$5, emn.a.b($$6, false, $$4.g()));
                  }
               }
            }
         }
               ...
               if (!this.f.b(jq.b($$8, $$10, $$9))) {
                  ...
                  for (int $$13 = 15; $$13 >= 0; $$13--) {
                     ...
                     if ($$3) {
                        this.f.a($$14, $$2);
                        if ($$2 > 1) {
                           this.c($$14, emn.a.a($$2, true, $$1.g()));
                        }
                     } else {
                        this.f.a($$14, 0);
                        this.b($$14, emn.a.a($$2, $$1.g()));
                     }
                  }
   ...
   public void a(dag $$0, boolean $$1) {
      super.a($$0, $$1);
      if ($$1) {
         emg $$2 = Objects.requireNonNullElse(this.b($$0.e, $$0.f), this.k);
         int $$3 = $$2.a() - 1;
         int $$4 = jq.a($$3) + 1;
         long $$5 = jq.b($$0.e, $$0.f);
         int $$6 = this.f.m($$5);
   ...
   public void b(dag $$0) {
      ...
      this.f.b($$1, true);
      emg $$2 = Objects.requireNonNullElse(this.b($$0.e, $$0.f), this.k);
      emg $$3 = Objects.requireNonNullElse(this.b($$0.e, $$0.f - 1), this.k);
      emg $$4 = Objects.requireNonNullElse(this.b($$0.e, $$0.f + 1), this.k);
      emg $$5 = Objects.requireNonNullElse(this.b($$0.e - 1, $$0.f), this.k);
      emg $$6 = Objects.requireNonNullElse(this.b($$0.e + 1, $$0.f), this.k);
      int $$7 = this.f.m($$1);
      int $$8 = this.f.c();
      int $$9 = jq.c($$0.e);
      int $$10 = jq.c($$0.f);
                  ...
                  if ($$19 <= $$15) {
                     ...
                     for (int $$25 = $$15; $$25 >= Math.max($$14, $$19); $$25--) {
                        ...
                        if ($$25 == $$19 || $$25 < $$24) {
                           ...
                           this.c($$26, emn.a.a($$25 == $$19, $$25 < $$20, $$25 < $$21, $$25 < $$22, $$25 < $$23));
                        }
                     }
