...
public abstract class chk {
   ...
   private final io<cmh> l = io.a();
   public final io<cjf> i = io.a();
   private final List<cic> m = Lists.newArrayList();
   private cmh n = cmh.f;
   private final io<cmh> o = io.a();
   ...
   private int t = -1;
   private int u;
   private final Set<cjf> v = Sets.newHashSet();
   private final List<chw> w = Lists.newArrayList();
   @Nullable
   private chx x;
   private boolean y;

   protected chk(@Nullable cir<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(chv $$0, cer $$1, cvz $$2) {
   ...
   protected static void a(bje $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(chu $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   protected cic a(cic $$0) {
      this.m.add($$0);
      this.p.add(0);
      return $$0;
   }

   protected void a(chu $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         this.a(cic.a($$0, $$1));
      }
   }
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cmh $$1 = this.i.get($$0).g();
         Supplier<cmh> $$2 = Suppliers.memoize($$1::p);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cmh $$1, Supplier<cmh> $$2) {
      cmh $$3 = this.l.get($$0);
      if (!cmh.a($$3, $$1)) {
         cmh $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cmh $$1, Supplier<cmh> $$2) {
      if (!this.y) {
         cmh $$3 = this.o.get($$0);
         if (!cmh.a($$3, $$1)) {
            cmh $$4 = $$2.get();
   ...
   public abstract cmh a(cer var1, int var2);

   public void a(int $$0, int $$1, cht $$2, cer $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
      } catch (Exception var8) {
         o $$5 = o.a(var8, "Container click");
         p $$6 = $$5.a("Click info");
         $$6.a("Menu Type", () -> this.s != null ? kb.r.b(this.s).toString() : "<no type>");
   ...
   private void b(int $$0, int $$1, cht $$2, cer $$3) {
      ceq $$4 = $$3.fS();
      if ($$2 == cht.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cht.a || $$2 == cht.b) && ($$1 == 0 || $$1 == 1)) {
         chs $$16 = $$1 == 0 ? chs.a : chs.b;
         if ($$0 == -999) {
            if (!this.g().b()) {
               if ($$16 == chs.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.b()) {
                  if (!$$21.b()) {
                     int $$22 = $$16 == chs.a ? $$21.L() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.b()) {
                     int $$23 = $$16 == chs.a ? $$20.L() : ($$20.L() + 1) / 2;
                     Optional<cmh> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cmh> $$26 = $$19.a($$20.L(), $$21.g() - $$21.L(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.L());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cht.d && $$3.fT().d && this.g().b() && $$0 >= 0) {
         cjf $$32 = this.i.get($$0);
         if ($$32.h()) {
            cmh $$33 = $$32.g();
            this.b($$33.c($$33.g()));
         }
      } else if ($$2 == cht.e && this.g().b() && $$0 >= 0) {
         cjf $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().L();
         cmh $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cht.g && $$0 >= 0) {
         cjf $$37 = this.i.get($$0);
         cmh $$38 = this.g();
         if (!$$38.b() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.L() < $$38.g(); $$42 += $$40) {
                  cjf $$43 = this.i.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cmh $$44 = $$43.g();
                     if ($$41 != 0 || $$44.L() != $$44.g()) {
                        cmh $$45 = $$43.b($$44.L(), $$38.g() - $$38.L(), $$3);
                        $$38.g($$45.L());
                     }
                  }
               }
   ...
   private boolean a(cer $$0, chs $$1, cjf $$2, cmh $$3, cmh $$4) {
      chb $$5 = $$0.dM().H();
   ...
   public void a(int $$0, int $$1, cmh $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cmh> $$1, cmh $$2) {
   ...
   public abstract boolean a(cer var1);

   protected boolean a(cmh $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cer $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cjf $$0, cmh $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cmh.c($$1, $$0.g()) ? $$0.g().L() + ($$2 ? 0 : $$1.L()) <= $$1.g() : $$3;
   }

   public static int a(Set<cjf> $$0, int $$1, cmh $$2) {
      return switch ($$1) {
         case 0 -> aty.d((float)$$2.L() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.d().l();
         default -> $$2.L();
      };
   ...
   public static int a(@Nullable dgd $$0) {
      return $$0 instanceof bje ? b((bje)$$0) : 0;
   }

   public static int b(@Nullable bje $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(chk $$0) {
      Table<bje, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bje $$0, int $$1) {
