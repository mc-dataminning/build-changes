...
public record chk(chk.a d) {
   ...
   public static final Codec<chk> c = chk.a.a.xmap(chk::new, chk::b);

   public static chk a(awu $$0, UUID $$1, chk.a $$2) throws chk.b {
      if (!$$2.a($$0, $$1)) {
         throw new chk.b(e);
      } else {
         return new chk($$2);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<chk.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avp.m.fieldOf("expires_at").forGetter(chk.a::b), avf.f.fieldOf("key").forGetter(chk.a::c), avp.n.fieldOf("signature_v2").forGetter(chk.a::d)
               )
               .apply($$0, chk.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof chk.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
