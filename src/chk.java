...
public abstract class chk extends cfg implements bqq, btj, bty, bub, bug {
   ...
   private static final Predicate<btq> ch = $$0 -> $$0 instanceof chk && ((chk)$$0).gK();
   private static final ceh ci = ceh.b().a(16.0).d().a(ch);
   private static final akk<Byte> cz = ako.a(chk.class, akm.a);
   ...
   private final bqo cQ = new exd() {
      ...
      public boolean a(cmy $$0) {
         return $$0.dc() == chk.this || $$0.b(chk.this, 4.0);
      }
   };

   protected chk(btb<? extends chk> $$0, dbz $$1) {
      super($$0, $$1);
      this.gM();
   }
   ...
   @Override
   protected void z() {
      this.bS.a(1, new cbh(this, 1.2));
      this.bS.a(1, new cbs(this, 1.2));
      this.bS.a(2, new caa(this, 1.0, chk.class));
      this.bS.a(4, new can(this, 1.0));
      this.bS.a(6, new ccb(this, 0.7));
      this.bS.a(7, new caw(this, cmy.class, 6.0F));
      this.bS.a(8, new cbj(this));
      if (this.gw()) {
         this.bS.a(9, new cbk(this));
      }
   ...
   protected void gG() {
      ...
      this.bS.a(3, new cbw(this, 1.25, $$0 -> $$0.a(awy.ag), false));
   }
   ...
   public void a(@Nullable awb $$0) {
      this.cs.a(0, new cuq(cut.nL));
   }

   public void b(cmy $$0, cuq $$1) {
      if (this.l($$1)) {
         this.m($$1.c(1));
         $$1.a(1, $$0);
      }
   ...
   private boolean b(dmn $$0) {
      return $$0 == dmn.b || $$0 == dmn.aT || $$0 == dmn.B || $$0 == dmn.aU || $$0 == dmn.aS;
   }
   ...
   public static bux.a gP() {
      return bts.A().a(buy.m, 0.7).a(buy.q, 53.0).a(buy.r, 0.225F).a(buy.v, 1.0).a(buy.s, 6.0).a(buy.i, 0.5);
   }
   ...
   public void n_() {
      ...
      if (!this.dP().B && this.bD()) {
         ...
         if (this.gS()) {
            if (!this.gI() && !this.bS() && this.ah.a(300) == 0 && this.dP().a_(this.dp().d()).a(dfc.i)) {
               this.A(true);
            }
   ...
   protected void gR() {
      if (this.gK() && this.p_() && !this.gI()) {
         btq $$0 = this.dP().a(chk.class, ci, this, this.du(), this.dw(), this.dA(), this.cK().g(16.0));
         if ($$0 != null && this.g((bsv)$$0) > 4.0) {
            this.bR.a($$0, 0);
         }
      }
   }
   ...
   protected evs b(cmy $$0, evs $$1) {
      if (this.aE() && this.cu == 0.0F && this.gJ() && !this.cv) {
         ...
         return new evs((double)$$2, 0.0, (double)$$3);
      }
   }
   ...
   public void a(us $$0) {
      ...
      if ($$0.b("SaddleItem", 10)) {
         cuq $$4 = cuq.a(this.dR(), (vp)$$0.p("SaddleItem")).orElse(cuq.l);
         if ($$4.a(cut.nL)) {
            this.cs.a(0, $$4);
         }
      }
   ...
   protected void a(bsp $$0, chk $$1) {
      this.a($$0, $$1, buy.q, (double)cd, (double)ce);
      this.a($$0, $$1, buy.m, (double)cb, (double)cc);
      this.a($$0, $$1, buy.r, (double)bY, (double)bZ);
   }

   private void a(bsp $$0, chk $$1, ji<but> $$2, double $$3, double $$4) {
   ...
   public bui a_(int $$0) {
      ...
      if ($$1 == 0) {
         ...
         int $$2 = $$0 - 500 + 1;
         return $$2 >= 1 && $$2 < this.cs.b() ? bui.a(this.cs, $$2) : super.a_($$0);
      }
   }
   ...
   private evs a(evs $$0, btq $$1) {
      ...
      while (var10.hasNext()) {
         ...
         do {
            ...
            if (coz.a($$8)) {
               evn $$9 = $$1.f($$6);
               evs $$10 = new evs($$2, (double)$$5.v() + $$8, $$4);
               if (coz.a(this.dP(), $$1, $$9.c($$10))) {
                  $$1.b($$6);
                  return $$10;
               }
            }
   ...
   @Override
   public evs b(btq $$0) {
      evs $$1 = a((double)this.dj(), (double)$$0.dj(), this.dF() + ($$0.fu() == btk.b ? 90.0F : -90.0F));
      evs $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         evs $$3 = a((double)this.dj(), (double)$$0.dj(), this.dF() + ($$0.fu() == btk.a ? 90.0F : -90.0F));
         evs $$4 = this.a($$3, $$0);
   ...
   protected evs a(bsv $$0, bsy $$1, float $$2) {
      return super.a($$0, $$1, $$2)
         .e(new evs(0.0, 0.15 * (double)this.cM * (double)$$2, -0.7 * (double)this.cM * (double)$$2).b(-this.dF() * (float) (Math.PI / 180.0)));
   }
