...
public class fzx implements amm<fzw> {
   public fzw b(JsonObject $$0) {
      Builder<fzv> $$1 = ImmutableList.builder();
      ...
      return new fzw($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private fzv a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new fzv(arg.g($$1, "frames[" + $$0 + "]"));
