public class fzx extends gay {
   fzx(fwr $$0, double $$1, double $$2, double $$3, double $$4) {
      ...
      this.l *= 0.01F;
      this.k += 0.2;
      this.v = Math.max(0.0F, ayd.a(((float)$$4 + 0.0F) * (float) (Math.PI * 2)) * 0.65F + 0.35F);
      this.w = Math.max(0.0F, ayd.a(((float)$$4 + 0.33333334F) * (float) (Math.PI * 2)) * 0.65F + 0.35F);
      this.x = Math.max(0.0F, ayd.a(((float)$$4 + 0.6666667F) * (float) (Math.PI * 2)) * 0.65F + 0.35F);
      this.D *= 1.5F;
      this.t = 6;
   }
