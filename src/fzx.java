...
public class fzx implements gac.a {
   ...
   private final eyk J;
   private final Map<ib, fzx.a> K = Maps.newHashMap();
   private final Map<UUID, yx.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bof $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dE();
      });
   }

   private void b(etd $$0, fwq $$1, double $$2, double $$3, double $$4) {
      ib $$5 = ib.a($$2, $$3, $$4);
   ...
   private void a(etd $$0, fwq $$1, fzx.a $$2) {
      int $$3 = 0;
   ...
   private void a(etd $$0, fwq $$1, yx.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gak.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(etd $$0, fwq $$1, yx.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(etd $$0, fwq $$1, String $$2, fzx.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(fzx.a $$0) {
      return this.b($$0.a).stream().map(aer::a).collect(Collectors.toSet());
   }

   private Set<String> c(fzx.a $$0) {
      return this.c($$0.a).stream().map(aer::a).collect(Collectors.toSet());
   }

   private boolean b(yx.a $$0) {
      return Objects.equals(this.M, $$0.a());
   }

   private boolean c(yx.a $$0) {
      cia $$1 = this.J.s;
      ib $$2 = ib.a($$1.do(), $$0.h().b(), $$1.du());
      ib $$3 = ib.a($$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(ib $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(yx.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(ib $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(yx.a::a).collect(Collectors.toSet());
   }

   private Map<ib, List<String>> c() {
      Map<ib, List<String>> $$0 = Maps.newHashMap();

      for (yx.a $$1 : this.L.values()) {
   ...
   private void d() {
      gac.a(this.J.an(), 8).ifPresent($$0 -> this.M = $$0.ct());
   }
