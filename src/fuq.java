public class fuq extends fmd<fuq.a> {
   ...
   static final xi u = xi.c("pack.incompatible");
   static final xi v = xi.c("pack.incompatible.confirm.title");
   private final xi w;
   final fup x;

   public fuq(fji $$0, fup $$1, int $$2, int $$3, xi $$4) {
      super($$0, $$2, $$3, 33, 36);
      this.x = $$1;
      this.w = $$4;
      this.e = false;
   ...
   public static class a extends fmd.a<fuq.a> {
      private static final int b = 157;
      private static final int c = 157;
      private static final String d = "...";
      private final fuq e;
      protected final fji a;
      private final fuo.a f;
      private final ayw g;
      private final fma h;
      private final ayw i;
      private final fma j;

      public a(fji $$0, fuq $$1, fuo.a $$2) {
         this.a = $$0;
         this.f = $$2;
         this.e = $$1;
         this.g = a($$0, $$2.d());
      ...
      private static ayw a(fji $$0, xi $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
            xn $$3 = xn.a($$0.h.a($$1, 157 - $$0.h.b("...")), xn.e("..."));
            return uf.a().a($$3);
         } else {
            return $$1.g();
         }
      ...
      private static fma b(fji $$0, xi $$1) {
         return fma.a($$0.h, 157, 2, $$1);
      }

      @Override
      public xi a() {
         return xi.a("narrator.select", this.f.d());
      }
      ...
      public void a(fku $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         $$0.a(gir::B, this.f.a(), $$3, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
         ayw $$12 = this.g;
         fma $$13 = this.h;
         if (this.d() && (this.a.n.ab().c() || $$8 || this.e.h() == this && this.e.aM_())) {
            ...
            if (this.f.o()) {
               if ($$14 < 32) {
                  $$0.a(gir::B, fuq.a, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gir::B, fuq.m, $$3, $$2, 32, 32);
               }
            } else {
               if (this.f.p()) {
                  if ($$14 < 16) {
                     $$0.a(gir::B, fuq.n, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gir::B, fuq.o, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.q()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 < 16) {
                     $$0.a(gir::B, fuq.p, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gir::B, fuq.q, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.r()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 > 16) {
                     $$0.a(gir::B, fuq.r, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gir::B, fuq.s, $$3, $$2, 32, 32);
                  }
               }
            }
         }
