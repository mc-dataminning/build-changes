...
public class fuq<T extends cfb> extends ftj<T> {
   public final fxo a;
   private final fxo b;
   private final fxo f;
   private final fxo g;
   ...
   public static fxu c() {
      fxw $$0 = new fxw();
      fxx $$1 = $$0.a();
      fxx $$2 = $$1.a("head", fxt.c().a(1, 5).a(-3.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F), fxq.a(-1.0F, 16.5F, -3.0F));
      $$2.a("right_ear", fxt.c().a(8, 1).a(-3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fxq.a);
      $$2.a("left_ear", fxt.c().a(15, 1).a(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fxq.a);
      $$2.a("nose", fxt.c().a(6, 18).a(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), fxq.a);
      fxx $$3 = $$1.a("body", fxt.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), fxq.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fxs $$4 = new fxs(0.001F);
      fxt $$5 = fxt.c().a(4, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      fxt $$6 = fxt.c().a(13, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      $$1.a("right_hind_leg", $$6, fxq.a(-5.0F, 17.5F, 7.0F));
      $$1.a("left_hind_leg", $$5, fxq.a(-1.0F, 17.5F, 7.0F));
      $$1.a("right_front_leg", $$6, fxq.a(-5.0F, 17.5F, 0.0F));
      $$1.a("left_front_leg", $$5, fxq.a(-1.0F, 17.5F, 0.0F));
      $$3.a("tail", fxt.c().a(30, 0).a(2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 5.0F), fxq.a(-4.0F, 15.0F, -1.0F, -0.05235988F, 0.0F, 0.0F));
      return fxu.a($$0, 48, 32);
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      ...
      if ($$0.cb()) {
         this.b.e = 1.6755161F;
         float $$4 = $$0.I($$3);
         this.b.a(0.0F, 16.0F + $$0.I($$3), -6.0F);
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.fI()) {
         this.a.e = 0.0F;
         this.a.f = (float) (-Math.PI * 2.0 / 3.0);
         this.a.g = ayg.b($$3 * 0.027F) / 22.0F;
      }

      if ($$0.cb()) {
         float $$6 = ayg.b($$3) * 0.01F;
         this.b.f = $$6;
         this.f.g = $$6;
         this.g.g = $$6;
         this.h.g = $$6 / 2.0F;
      ...
      if ($$0.go()) {
         float $$7 = 0.1F;
         this.n += 0.67F;
         this.f.e = ayg.b(this.n * 0.4662F) * 0.1F;
         this.g.e = ayg.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.h.e = ayg.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.i.e = ayg.b(this.n * 0.4662F) * 0.1F;
      }
   }
}
