...
public class aov {
   ...
   private static int a(ep $$0, iz $$1, gg $$2, aov.b $$3, @Nullable Predicate<dsi> $$4) throws CommandSyntaxException {
      arf $$5 = $$0.e();
      if ($$4 != null && !$$4.test(new dsi($$5, $$1, true))) {
         throw a.create();
      } else {
         boolean $$6;
         if ($$3 == aov.b.b) {
   ...
   public interface a {
      @Nullable
      gg filter(eie var1, iz var2, gg var3, arf var4);
   }
