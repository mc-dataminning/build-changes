...
public class aov extends aop {
   ...
   private final aov.b d;
   private final String e;

   aov(String $$0, aov.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(aoy $$0, ahh $$1) {
   ...
   @Nullable
   private aqb<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : aqb.create($$1, $$2);
      }
   }
   ...
   public static class a implements apr.c {
      ...
      public aox a(String $$0) {
         aov.b $$1 = new aov.b(this.a);
         return new aov($$0, $$1, this.b, "");
      }

      @Override
      public aox a(String $$0, apr.a $$1) {
         aov.b $$2 = new aov.b(this.a);
         aox $$3 = new aov($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<aox> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new aov($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  aov.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
