...
public class aov {
   ...
   private static int a(ex $$0, Collection<are> $$1, @Nullable awb $$2, @Nullable aku $$3) {
      afo $$4 = new afo($$3, $$2);
      ...
      if ($$2 != null) {
         if ($$3 != null) {
            $$0.a(() -> wp.a("commands.stopsound.success.source.sound", wp.a($$3), $$2.a()), true);
         } else {
            $$0.a(() -> wp.a("commands.stopsound.success.source.any", $$2.a()), true);
         }
      } else if ($$3 != null) {
         $$0.a(() -> wp.a("commands.stopsound.success.sourceless.sound", wp.a($$3)), true);
      } else {
         $$0.a(() -> wp.c("commands.stopsound.success.sourceless.any"), true);
      }
