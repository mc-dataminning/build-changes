...
public class faw {
   ...
   @Nullable
   private String g;
   private static final faw.a h = new faw.a() {
      @Nullable
      @Override
      public fav a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (faz.a(this.d, "Get capabilities")) {
         ...
         if (faz.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  faz.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !faz.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fav a(faw.c $$0) {
      return ($$0 == faw.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements faw.a {
      private final int a;
      private final Set<fav> b = Sets.newIdentityHashSet();
      ...
      public fav a() {
         if (this.b.size() >= this.a) {
            if (ab.aW) {
               faw.a.warn("Maximum sound pool size {} reached", this.a);
            }
