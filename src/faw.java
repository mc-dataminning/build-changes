...
public class faw {
   ...
   public faw(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public faw(fbb $$0, fbb $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static faw a(enf $$0) {
      return new faw((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static faw a(fbb $$0) {
      return new faw($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static faw a(ji $$0, ji $$1) {
      return new faw(
   ...
   public faw a(double $$0) {
      return new faw($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public faw b(double $$0) {
      return new faw(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public faw c(double $$0) {
      return new faw(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public faw d(double $$0) {
      return new faw(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public faw e(double $$0) {
      return new faw(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public faw f(double $$0) {
      return new faw(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public faw b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public faw c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public faw d(double $$0, double $$1, double $$2) {
      return new faw(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public faw f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public faw h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<fbb> b(fbb $$0, fbb $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<fbb> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fbb $$6, fbb $$7) {
   ...
   @Nullable
   public static fax a(Iterable<faw> $$0, fbb $$1, fbb $$2, ji $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new fax($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jn a(faw $$0, fbb $$1, double[] $$2, @Nullable jn $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jn a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, fbb $$6, double[] $$7, @Nullable jn $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(fbb $$0, List<faw> $$1) {
      fbb $$2 = this.f();
      fbb $$3 = $$2.e($$0);

      for (faw $$4 : $$1) {
         faw $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public fbb f() {
      return new fbb(ayz.d(0.5, this.a, this.d), ayz.d(0.5, this.b, this.e), ayz.d(0.5, this.c, this.f));
   }

   public fbb g() {
      return new fbb(ayz.d(0.5, this.a, this.d), this.b, ayz.d(0.5, this.c, this.f));
   }
   ...
   public fbb i() {
      return new fbb(this.d, this.e, this.f);
   }

   public static faw a(fbb $$0, double $$1, double $$2, double $$3) {
      return new faw($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
}
