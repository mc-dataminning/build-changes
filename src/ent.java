public class ent {
   ...
   private int a(duh $$0, int $$1, int $$2, int $$3) {
      int $$4 = kc.c($$0.g($$1) + 1);
   ...
   public boolean a(dbm $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dbm $$0, int $$1, int $$2, ja $$3, dsl $$4, ja $$5, dsl $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dbm $$0, ja $$1, dsl $$2) {
      ja.a $$3 = this.e.g($$1);
   ...
   private static boolean a(dbm $$0, ja $$1, dsl $$2, ja $$3, dsl $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         exa $$5 = eoa.a($$0, $$1, $$2, jf.a);
         exa $$6 = eoa.a($$0, $$3, $$4, jf.b);
         return ewx.b($$5, $$6);
      }
   }
