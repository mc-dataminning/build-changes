...
public class ent extends alc<Map<String, List<ent.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<ent.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(ent.a::a),
                     Codec.LONG.fieldOf("period").forGetter(ent.a::b),
                     Codec.STRING.fieldOf("title").forGetter(ent.a::c),
                     Codec.STRING.fieldOf("message").forGetter(ent.a::d)
                  )
                  .apply($$0, ent.a::new)
         )
         .listOf()
   ...
   protected Map<String, List<ent.a>> a(akx $$0, ban $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<ent.a>> $$0, akx $$1, ban $$2) {
      List<ent.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<ent.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<ent.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<ent.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public ent.b a(List<ent.a> $$0, long $$1) {
         this.cancel();
         return new ent.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (ent.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> erf.a(enn.N().az(), erf.a.g, sw.a($$2.c, $$3), sw.a($$2.d, $$3)));
                  return;
               }
            }
         }
