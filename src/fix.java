...
public class fix extends cpv {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final djg e = new djg();
   private final djm<biq> f = new djm<>(biq.class, new fix.b());
   private final fiy D;
   private final foc E;
   private final fix.a F;
   private final fnt G;
   private final eqv H = eqv.O();
   final List<fnd> I = Lists.newArrayList();
   private eim J = new eim();
   private final Map<String, ebw> K = Maps.newHashMap();
   private static final long L = 16777215L;
   private int M;
   private final Object2ObjectArrayMap<cpg, erx> N = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(fnq.a, new erx($$0xx -> this.b($$0xx, fnq.a)));
      $$0x.put(fnq.b, new erx($$0xx -> this.b($$0xx, fnq.b)));
      $$0x.put(fnq.c, new erx($$0xx -> this.b($$0xx, fnq.c)));
   });
   private final fit O;
   private final Deque<Runnable> P = Queues.newArrayDeque();
   private int Q;
   private final fkd R = new fkd();
   private static final Set<cja> S = Set.of(cji.hf, cji.hg);

   public void b(int $$0) {
      this.R.a($$0, this);
   }

   public void b(gw $$0, dfj $$1, int $$2) {
      if (!this.R.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(gw $$0, dfj $$1, ehn $$2) {
      dfj $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cbu $$4 = this.H.s;
   ...
   public fix(fiy $$0, fix.a $$1, aew<cpv> $$2, hg<dis> $$3, int $$4, int $$5, Supplier<bdp> $$6, foc $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.f(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.O = new fit(this, $$4);
      this.F = $$1;
      this.E = $$7;
      this.G = fnt.a($$3.a());
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.X().a(cpr.k).a(false, null);
      } else {
         this.X().a(cpr.k).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<biq> e() {
      return this.E().a();
   }
   ...
   private csv p() {
      if (this.H.q.l() == cps.b) {
         cjf $$0 = this.H.s.eS();
         cja $$1 = $$0.d();
         if (S.contains($$1) && $$1 instanceof cgy $$2) {
            return $$2.e();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, asc $$4, @Nullable csv $$5, gw.a $$6) {
   ...
   private void a(gw $$0, dfj $$1, iv $$2, boolean $$3) {
      if ($$1.u().c()) {
         eig $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(hc.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(gw $$0, iv $$1, eig $$2, double $$3) {
   ...
   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, iv $$5) {
      this.a($$5, arx.d(this.z.j(), $$0, $$1), $$4, arx.d(this.z.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }
   ...
   @Override
   public void a(@Nullable cbu $$0, double $$1, double $$2, double $$3, hg<apd> $$4, apf $$5, float $$6, float $$7, long $$8) {
      if ($$0 == this.H.s) {
   ...
   @Override
   public void a(@Nullable cbu $$0, biq $$1, hg<apd> $$2, apf $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.H.s) {
         this.H.ai().a((gcm)(new gcd($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(double $$0, double $$1, double $$2, apd $$3, apf $$4, float $$5, float $$6, boolean $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.z.g());
   }

   private void a(double $$0, double $$1, double $$2, apd $$3, apf $$4, float $$5, float $$6, boolean $$7, long $$8) {
      double $$9 = this.H.j.m().b().c($$0, $$1, $$2);
      gch $$10 = new gch($$3, $$4, $$5, $$6, asc.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   @Override
   public hg<cqt> a(int $$0, int $$1, int $$2) {
      return this.G_().d(je.ap).f(cra.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (arx.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = arx.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public ehn a(ehn $$0, float $$1) {
      float $$2 = this.f($$1);
      ehn $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      cqv $$4 = this.E_();
      ehn $$5 = ara.a($$3, ($$1x, $$2x, $$3x) -> ehn.a($$4.a($$1x, $$2x, $$3x).a().a()));
      float $$6 = arx.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$6 = arx.a($$6, 0.0F, 1.0F);
      float $$7 = (float)$$5.c * $$6;
      float $$8 = (float)$$5.d * $$6;
      float $$9 = (float)$$5.e * $$6;
      ...
      return new ehn((double)$$7, (double)$$8, (double)$$9);
   }

   public ehn h(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = arx.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$2 = arx.a($$2, 0.0F, 1.0F);
      float $$3 = 1.0F;
      float $$4 = 1.0F;
      float $$5 = 1.0F;
      ...
      return new ehn((double)$$3, (double)$$4, (double)$$5);
   }

   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (arx.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = arx.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(gw $$0, cpg $$1) {
      erx $$2 = (erx)this.N.get($$1);
      return $$2.a($$0);
   }

   public int b(gw $$0, cpg $$1) {
      int $$2 = eqv.O().m.B().c();
      if ($$2 == 0) {
   ...
   protected Map<String, ebw> l() {
      return ImmutableMap.copyOf(this.K);
   }

   protected void a(Map<String, ebw> $$0) {
      this.K.putAll($$0);
   }
   ...
   public static class a implements ecn {
      ...
      public a(bgv $$0, boolean $$1, boolean $$2) {
         this.k = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new cpr();
   ...
   final class b implements dji<biq> {
      public void a(biq $$0) {
      }
