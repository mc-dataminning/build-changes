...
public class fix {
   ...
   public void a(fix.b $$0, List<ath> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fix.c($$0, $$1.stream().map(ath::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fix.c(fix.b.c, ImmutableList.of());
      }

      this.b.c = new fix.a($$0);
   }
   ...
   static class c {
      private final fix.b a;
      private final List<String> b;
      @Nullable
      fix.a c;
      boolean d;

      c(fix.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
