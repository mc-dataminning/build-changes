...
public class fix extends hkx {
   ...
   public fix(fuk $$0, fia $$1, String $$2, BooleanConsumer $$3) {
      super(fla.a);
      this.aa = $$3;
      this.F = $$0;
      this.K = $$2;
   ...
   @Override
   public void aR_() {
      this.J = this.c(fos.a(wn.e, $$0 -> this.aO_()).a((this.n - 200) / 2, this.o - 42, 200, 20).a());
      this.E();
   }
   ...
   private void E() {
      if (!this.R && !this.Z) {
         ...
         if (this.a(this.G.a) >= 5368709120L) {
            wo $$0 = wo.a("mco.download.confirmation.oversized", fgg.b(5368709120L));
   ...
   private wo F() {
      ...
      if (this.O != null) {
         ...
         $$0.add(wo.a("mco.download.speed.narration", fgg.b(this.V)));
      }
   ...
   private void a(fod $$0, long $$1) {
      if ($$1 > 0L) {
         int $$2 = this.p.b(this.O);
         $$0.b(this.p, wo.a("mco.download.speed", fgg.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1);
      }
   }
