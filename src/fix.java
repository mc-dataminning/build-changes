...
public class fix extends cpv {
   ...
   public fix(fiy $$0, fix.a $$1, aev<cpv> $$2, he<dis> $$3, int $$4, int $$5, Supplier<bdp> $$6, foc $$7, boolean $$8, long $$9) {
   ...
   private void a(gw $$0, dfj $$1, it $$2, boolean $$3) {
      if ($$1.u().c()) {
         eig $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(ha.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(gw $$0, it $$1, eig $$2, double $$3) {
   ...
   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, it $$5) {
      this.a($$5, arw.d(this.z.j(), $$0, $$1), $$4, arw.d(this.z.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }
   ...
   private void a(double $$0, double $$1, double $$2, apc $$3, ape $$4, float $$5, float $$6, boolean $$7, long $$8) {
   ...
   public he<cqt> a(int $$0, int $$1, int $$2) {
      return this.G_().d(jc.ap).f(cra.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (arw.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = arw.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public ehn a(ehn $$0, float $$1) {
      ...
      cqv $$4 = this.E_();
      ehn $$5 = aqz.a($$3, ($$1x, $$2x, $$3x) -> ehn.a($$4.a($$1x, $$2x, $$3x).a().a()));
      float $$6 = arw.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$6 = arw.a($$6, 0.0F, 1.0F);
      float $$7 = (float)$$5.c * $$6;
      float $$8 = (float)$$5.d * $$6;
      float $$9 = (float)$$5.e * $$6;
   ...
   public ehn h(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = arw.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$2 = arw.a($$2, 0.0F, 1.0F);
      float $$3 = 1.0F;
      float $$4 = 1.0F;
      float $$5 = 1.0F;
   ...
   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (arw.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = arw.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
