...
public abstract class hpj extends fyb {
   ...
   private final List<hpi> a = Lists.newArrayList();
   ...
   protected hpi a(hpi $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public wy m() {
      return wx.a(this.a.stream().map(hpi::a).collect(Collectors.toList()));
   }
}
