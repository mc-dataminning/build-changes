...
public abstract class csp extends ctc {
   private static final int c = 8;
   private final float d;
   protected static final float a = 1.0F;
   protected static final eia b = ctc.a(0.0, 0.0, 0.0, 16.0, 1.0, 16.0);

   public csp(dfc.d $$0, float $$1) {
      super($$0);
      this.d = $$1;
   }

   @Override
   protected abstract MapCodec<? extends csp> a();
   ...
   public static dfd a(cph $$0, gw $$1) {
      gw $$2 = $$1.d();
      dfd $$3 = $$0.a_($$2);
      return dal.h($$3) ? cte.cs.o() : ((cwa)cte.cr).b($$0, $$1);
   }
   ...
   public void a(dfd $$0, cqb $$1, gw $$2, ash $$3) {
      if ($$3.a(24) == 0) {
         $$1.a((double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, apg.hM, aph.e, 1.0F + $$3.i(), $$3.i() * 0.7F + 0.3F, false);
      }
   ...
   protected abstract boolean f(dfd var1);
   ...
   public void b(dfd $$0, cqb $$1, gw $$2, dfd $$3, boolean $$4) {
      if (!$$3.a($$0.b())) {
         if (a($$1)) {
            Optional<ebe> $$5 = ebe.a($$1, $$2, ha.a.a);
            if ($$5.isPresent()) {
               $$5.get().b();
               return;
            }
   ...
   private static boolean a(cqb $$0) {
      return $$0.ac() == cqb.h || $$0.ac() == cqb.i;
   }
   ...
   public static boolean a(cqb $$0, gw $$1, ha $$2) {
      dfd $$3 = $$0.a_($$1);
      return !$$3.i() ? false : a($$0, $$1).a((cqe)$$0, $$1) || b($$0, $$1, $$2);
   }

   private static boolean b(cqb $$0, gw $$1, ha $$2) {
      if (!a($$0)) {
         return false;
      } else {
         gw.a $$3 = $$1.j();
