...
public class feg extends fdb {
   ...
   private static final aua n = aua.forward("_", wc.a.a(n.a));
   private static final aua o = aua.forward("_", wc.a.a(n.h));
   private final cfi p;
   private final cmy q;
   private boolean r;
   private boolean t;
   ...
   private String x = "";
   private final ezy y = new ezy(this::P, this::b, this::n, this::a, $$0x -> $$0x.length() < 1024 && this.i.b($$0x, 114) <= 128);
   private final ezy z = new ezy(() -> this.x, $$0x -> this.x = $$0x, this::n, this::a, $$0x -> $$0x.length() < 16);
   private long A;
   private int B = -1;
   private ffi C;
   private ffi D;
   ...
   private final bka I;
   @Nullable
   private feg.a J = feg.a.a;
   private vf K = ve.a;
   private final vf L;

   public feg(cfi $$0, cmy $$1, bka $$2) {
      super(eva.a);
      this.p = $$0;
      this.q = $$1;
      this.I = $$2;
   ...
   private String n() {
      return this.f != null ? ezy.b(this.f) : "";
   }
   ...
   protected void aN_() {
      this.R();
      this.F = this.d((exg)exg.a(vf.c("book.signButton"), $$0x -> {
         this.t = true;
         this.I();
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.E = this.d((exg)exg.a(ve.d, $$0x -> {
         this.f.a(null);
         this.c(false);
      }).a(this.g / 2 + 2, 196, 98, 20).a());
      this.G = this.d((exg)exg.a(vf.c("book.finalizeButton"), $$0x -> {
         if (this.t) {
            this.c(true);
            this.f.a(null);
         }
      }).a(this.g / 2 - 100, 196, 98, 20).a());
      this.H = this.d((exg)exg.a(ve.e, $$0x -> {
         if (this.t) {
            this.t = false;
         }
      ...
      int $$0 = (this.g - 192) / 2;
      int $$1 = 2;
      this.C = this.d(new ffi($$0 + 116, 159, true, $$0x -> this.H(), true));
      this.D = this.d(new ffi($$0 + 43, 159, false, $$0x -> this.E(), true));
      this.I();
   }
   ...
   private void c(boolean $$0) {
      if (this.r) {
         this.J();
         this.e($$0);
         int $$1 = this.I == bka.a ? this.p.fS().l : 40;
   ...
   public void a(ewu $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.t) {
         ...
         aua $$7 = aua.composite(aua.forward(this.x, wc.a), $$6 ? n : o);
         int $$8 = this.i.a(l);
   ...
   public void b(ewu $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      $$0.a(feh.l, (this.g - 192) / 2, 2, 0, 0, 192, 192);
   }

   private void a(ewu $$0, feg.c $$1, boolean $$2) {
      if (this.u / 6 % 2 == 0) {
         $$1 = this.b($$1);
         if (!$$2) {
   ...
   private void a(ewu $$0, ftm[] $$1) {
      for (ftm $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(ftp.D(), $$3, $$4, $$5, $$6, -16776961);
      }
   }

   private feg.c a(feg.c $$0) {
      return new feg.c($$0.a - (this.g - 192) / 2 - 36, $$0.b - 32);
   }

   private feg.c b(feg.c $$0) {
      return new feg.c($$0.a + (this.g - 192) / 2 + 36, $$0.b + 32);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if ($$2 == 0) {
            long $$3 = ac.b();
            feg.a $$4 = this.Q();
            int $$5 = $$4.a(this.i, this.a(new feg.c((int)$$0, (int)$$1)));
            if ($$5 >= 0) {
   ...
   private void b(int $$0) {
      String $$1 = this.P();
      this.y.a(evu.a($$1, -1, $$0, false), evu.a($$1, 1, $$0, false));
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$2 == 0) {
            feg.a $$5 = this.Q();
            int $$6 = $$5.a(this.i, this.a(new feg.c((int)$$0, (int)$$1)));
            this.y.c($$6, true);
            this.R();
         }
   ...
   private feg.a Q() {
      if (this.J == null) {
         this.J = this.T();
         this.K = vf.a("book.pageIndicator", this.v + 1, this.D());
      }
   ...
   private feg.a T() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<feg.b> $$4 = Lists.newArrayList();
         ...
         $$7.a($$0, 114, wc.a, true, ($$5x, $$6x, $$7x) -> {
            ...
            int $$11 = $$8x * 9;
            feg.c $$12 = this.b(new feg.c(0, $$11));
            $$3.add($$6x);
            $$4.add(new feg.b($$5x, $$10, $$12.a, $$12.b));
         });
         int[] $$8 = $$3.toIntArray();
         boolean $$9 = $$1 == $$0.length();
         feg.c $$10;
         if ($$9 && $$6.isTrue()) {
            $$10 = new feg.c(0, $$4.size() * 9);
         } else {
            int $$11 = a($$8, $$1);
            int $$12 = this.i.b($$0.substring($$8[$$11], $$1));
            $$10 = new feg.c($$12, $$11 * 9);
         }

         List<ftm> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
            ...
            if ($$17 == $$18) {
               ...
               for (int $$22 = $$17 + 1; $$22 < $$18; $$22++) {
                  ...
                  int $$25 = (int)$$7.a($$24);
                  $$14.add(this.a(new feg.c(0, $$23), new feg.c($$25, $$23 + 9)));
               }
         ...
         return new feg.a($$0, $$10, $$9, $$8, $$4.toArray(new feg.b[0]), $$14.toArray(new ftm[0]));
      }
   }
   ...
   private ftm a(String $$0, evu $$1, int $$2, int $$3, int $$4, int $$5) {
      String $$6 = $$0.substring($$5, $$2);
      String $$7 = $$0.substring($$5, $$3);
      feg.c $$8 = new feg.c((int)$$1.a($$6), $$4);
      feg.c $$9 = new feg.c((int)$$1.a($$7), $$4 + 9);
      return this.a($$8, $$9);
   }

   private ftm a(feg.c $$0, feg.c $$1) {
      feg.c $$2 = this.b($$0);
      feg.c $$3 = this.b($$1);
      ...
      return new ftm($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final feg.a a = new feg.a("", new feg.c(0, 0), true, new int[]{0}, new feg.b[]{new feg.b(wc.a, "", 0, 0)}, new ftm[0]);
      ...
      public a(String $$0, feg.c $$1, boolean $$2, int[] $$3, feg.b[] $$4, ftm[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
