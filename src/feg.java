...
public class feg {
   ...
   private static final Map<dva.a, String> e = ac.a(new EnumMap<>(dva.a.class), $$0 -> {
      $$0.put(dva.a.a, "SW");
      $$0.put(dva.a.b, "S");
      $$0.put(dva.a.c, "OW");
      $$0.put(dva.a.d, "O");
   ...
   private dro l;
   @Nullable
   private CompletableFuture<dro> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bjz r = new bjz(1);
   private final bjz s = new bjz(bke.values().length);
   private final bjz t = new bjz(1);
   private final bjz u = new bjz(1);
   private final Map<bka, bjz> v = Map.of(bka.a, this.s);
   private final ffp w;
   private final ffr x;
   private final ffq y;
   private final ffo z;
   ...
   public feg(fby $$0) {
      ...
      this.g = new feg.a();
      this.h = $$0.h;
      this.w = new ffp(this.h, this.r);
      this.x = new ffr(this.h, this.s, () -> $$0.r.s().g());
      this.y = new ffq(this.h, this.t);
      this.z = new ffo(this.h, this.u);
   }
   ...
   private void a(fdl $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         czg $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof apu ? ((apu)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, jg.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, axm.g($$15.dC()), axm.g($$15.dE())));
         dro $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(czp.a, $$14);
            int $$30 = this.f.r.a(czp.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dro $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dva.a $$33 : dva.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.al()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ap();
                  long $$36 = $$31.u();
                  bod $$37 = new bod($$23.ak(), $$23.Z(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            czr.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bqw> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bqw.values())
   ...
   private static String a(in<daf> $$0) {
   ...
   private czg r() {
      return (czg)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ae()))), this.f.r);
   }
   ...
   private dro s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dsd.n, false).thenApply($$0x -> (dro)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", evk.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fby.Q().aO().k(), fby.Q().aO().l(), evk.a()),
            evk.c(),
            evk.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == esh.a.b) {
            ...
            $$4.add(String.valueOf(kt.e.b($$6.b())));

            for (Entry<dql<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == esh.a.b) {
            ...
            $$4.add(String.valueOf(kt.c.b($$9.a())));

            for (Entry<dql<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(kt.g.b($$11.ai())));
         }
   ...
   private String a(Entry<dql<?>, Comparable<?>> $$0) {
      dql<?> $$1 = $$0.getKey();
