...
public class feg {
   ...
   public feg(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<feh> $$1) throws IOException {
   ...
   public List<feh> a(Path $$0) throws IOException {
      List<feh> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<feh> a(Path $$0, boolean $$1) throws IOException {
      List<feh> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<feh> $$1) throws IOException {
