...
public class feg implements esc {
   static final Logger b = LogUtils.getLogger();
   private final eta c;
   private final fdu<feg.b> d;

   feg(eta $$0, fdu<feg.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(ajh c, int d, int e, int[][] f) implements fei {
      ...
      public static final MapCodec<feg.a> a = awe.a(
         RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     ajh.a.fieldOf("file").forGetter(feg.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(feg.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(feg.a::e),
                     g.fieldOf("chars").forGetter(feg.a::f)
                  )
                  .apply($$0, feg.a::new)
         ),
         feg.a::a
      ...
      private static DataResult<feg.a> a(feg.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     feg.b $$15 = $$9.a($$12, new feg.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        feg.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(eta $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, eta b, int c, int d, int e, int f, int g, int h) implements esb {
