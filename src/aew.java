...
public class aew implements Comparable<aew> {
   public static final Codec<aew> a = Codec.STRING.comapFlatMap(aew::b, aew::toString).stable();
   ...
   protected aew(String $$0, String $$1, @Nullable aew.a $$2) {
      this.f = $$0;
      this.g = $$1;
   }

   public aew(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private aew(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static aew a(String $$0, char $$1) {
      return new aew(b($$0, $$1));
   }
   ...
   @Nullable
   public static aew a(String $$0, String $$1) {
      try {
         return new aew($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<aew> b(String $$0) {
      try {
         return DataResult.success(new aew($$0));
      } catch (z var2) {
   ...
   public aew c(String $$0) {
      return new aew(this.f, d(this.f, $$0), null);
   }

   public aew a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.g));
   }

   public aew d(String $$0) {
      return this.c($$0 + this.g);
   }

   public aew e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof aew $$1) ? false : this.f.equals($$1.f) && this.g.equals($$1.g);
      }
   }
   ...
   public static aew a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<aew>, JsonSerializer<aew> {
      public aew a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new aew(arn.a($$0, "location"));
      }

      public JsonElement a(aew $$0, Type $$1, JsonSerializationContext $$2) {
