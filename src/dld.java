...
@Deprecated
public class dld extends dko<dld.a> {
   private static final dcb a = cpo.nc.n();

   public dld(Codec<dld.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dkq<dld.a> $$0) {
      gu $$1 = $$0.e();
      cng $$2 = $$0.b();
      apf $$3 = $$0.d();
      dld.a $$4 = $$0.f();
   ...
   public static record a(dot b, dot c) implements dms {
      public static final Codec<dld.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(dot.a.fieldOf("fluid").forGetter(dld.a::a), dot.a.fieldOf("barrier").forGetter(dld.a::b)).apply($$0, dld.a::new)
      );
