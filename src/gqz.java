...
public class gqz {
   ...
   public gqz(gtp $$0, dja $$1, int $$2, gpv $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
   ...
   @Nullable
   protected gtp.b a(iu $$0) {
      return this.a(jx.c($$0));
   }

   @Nullable
   protected gtp.b a(long $$0) {
      int $$1 = jx.b($$0);
      int $$2 = jx.c($$0);
      int $$3 = jx.d($$0);
      return this.b($$1, $$2, $$3);
   ...
   @Nullable
   private gtp.b b(int $$0, int $$1, int $$2) {
      if (!this.c($$0, $$1, $$2)) {
         return null;
      } else {
         int $$3 = $$1 - this.b.aq();
