...
public abstract class ts {
   ...
   private static volatile ts e = c();
   ...
   private static ts c() {
      ...
      return new ts() {
         ...
         @Override
         public ayw a(xb $$0) {
            return $$1 -> $$0.a(($$1x, $$2) -> bah.c($$2, $$1x, $$1) ? Optional.empty() : xb.a, xt.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = ts.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public abstract ayw a(xb var1);

   public List<ayw> a(List<xb> $$0) {
