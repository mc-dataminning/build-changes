...
public class ts {
   ...
   public static final Codec<ts> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               tu.a.optionalFieldOf("color").forGetter($$0x -> Optional.ofNullable($$0x.d)),
               ...
               acq.a.optionalFieldOf("font").forGetter($$0x -> Optional.ofNullable($$0x.m))
            )
            .apply($$0, ts::a)
   );
   ...
   public static class b implements JsonDeserializer<ts>, JsonSerializer<ts> {
      @Nullable
      ...
      private static tb b(JsonObject $$0) {
         if ($$0.has("hoverEvent")) {
            JsonObject $$1 = aor.u($$0, "hoverEvent");
            tb $$2 = tb.a($$1);
            if ($$2 != null && $$2.a().a()) {
               return $$2;
            }
