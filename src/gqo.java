...
public class gqo implements gqa.a {
   private final flk a;
   private double b = Double.MIN_VALUE;
   private List<bum> c = Collections.emptyList();
   ...
   private void a(ffv $$0, glz $$1, double $$2, double $$3, double $$4, bum $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.ax.ifPresent($$10 -> {
   ...
   private double a(bum $$0) {
      return 0.02 * (double)(String.valueOf((double)$$0.ar() + 0.132453657).hashCode() % 1000) / 1000.0;
   }

   private void a(ji $$0, ffv $$1, double $$2, double $$3, double $$4, glz $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      gmt.a($$1, $$5.getBuffer(gmj.y()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      gqa.a(
         $$1,
         $$5.getBuffer(gmj.y()),
         this.a.s.a_($$0).b(this.a.s, $$0, fbg.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
