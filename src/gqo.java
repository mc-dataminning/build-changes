...
public class gqo {
   ...
   public static final Codec<gqo> a = Codec.PASSTHROUGH.listOf().validate($$0 -> ag.a($$0, c)).xmap(gqo::new, $$0 -> $$0.f);
   ...
   public List<dak> a(ji.a $$0) {
      return this.f
         .stream()
         .map($$1 -> dak.f.parse(alp.a($$1, $$0)).resultOrPartial($$0xx -> b.warn("Could not parse hotbar item: {}", $$0xx)).orElse(dak.l))
         .toList();
   }

   public void a(csh $$0, ju $$1) {
      alp<va> $$2 = $$1.a(d);
      Builder<Dynamic<?>> $$3 = ImmutableList.builderWithExpectedSize(c);

      for (int $$4 = 0; $$4 < c; $$4++) {
         dak $$5 = $$0.a($$4);
         Optional<Dynamic<?>> $$6 = dak.f
            .encodeStart($$2, $$5)
