...
public final class kc {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ac.a($$0, 4).map(kc::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static final zn<ByteBuf, UUID> g = new zn<ByteBuf, UUID>() {
