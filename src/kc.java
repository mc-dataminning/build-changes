...
public class kc extends ke {
   ...
   kc(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }

   public static kc a(int $$0, int $$1, int $$2) {
      return new kc($$0, $$1, $$2);
   }

   public static kc a(ja $$0) {
      return new kc(a($$0.u()), a($$0.v()), a($$0.w()));
   }

   public static kc a(dbk $$0, int $$1) {
      return new kc($$0.e, $$1, $$0.f);
   }

   public static kc a(dwh $$0) {
      return a($$0.dp());
   }

   public static kc a(jt $$0) {
      return new kc(b($$0.a()), b($$0.b()), b($$0.c()));
   }

   public static kc a(long $$0) {
      return new kc(b($$0), c($$0), d($$0));
   }

   public static kc a(dud $$0) {
      return a($$0.f(), $$0.ao());
   }
   ...
   public ja g(short $$0) {
      return new ja(this.d($$0), this.e($$0), this.f($$0));
   }
   ...
   public static long e(long $$0) {
      return b(a(ja.a($$0)), a(ja.b($$0)), a(ja.c($$0)));
   }
   ...
   public ja j() {
      return new ja(c(this.a()), c(this.b()), c(this.c()));
   }
   ...
   public kc d(int $$0, int $$1, int $$2) {
      return $$0 == 0 && $$1 == 0 && $$2 == 0 ? this : new kc(this.a() + $$0, this.b() + $$1, this.c() + $$2);
   }

   public Stream<ja> t() {
      return ja.a(this.d(), this.e(), this.f(), this.g(), this.h(), this.i());
   }

   public static Stream<kc> a(kc $$0, int $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      int $$4 = $$0.c();
   ...
   public static Stream<kc> a(dbk $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$0.e;
      int $$5 = $$0.f;
      return a($$4 - $$1, $$2, $$5 - $$1, $$4 + $$1, $$3 - 1, $$5 + $$1);
   }

   public static Stream<kc> a(final int $$0, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5) {
      return StreamSupport.stream(new AbstractSpliterator<kc>((long)(($$3 - $$0 + 1) * ($$4 - $$1 + 1) * ($$5 - $$2 + 1)), 64) {
         final jc a = new jc($$0, $$1, $$2, $$3, $$4, $$5);

         @Override
         public boolean tryAdvance(Consumer<? super kc> $$0x) {
            if (this.a.a()) {
               $$0.accept(new kc(this.a.b(), this.a.c(), this.a.d()));
               return true;
            } else {
               return false;
            }
   ...
   public static void a(ja $$0, LongConsumer $$1) {
      a($$0.u(), $$0.v(), $$0.w(), $$1);
   }

   public static void a(long $$0, LongConsumer $$1) {
      a(ja.a($$0), ja.b($$0), ja.c($$0), $$1);
   }
