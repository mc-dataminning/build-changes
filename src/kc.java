...
public class kc implements ji {
   ...
   public kc(jk $$0, Set<acq> $$1, List<kc.a> $$2) {
   ...
   public CompletableFuture<?> a(jg $$0) {
      final Map<acq, dzs> $$1 = Maps.newHashMap();
      Map<dhz.a, acq> $$2 = new Object2ObjectOpenHashMap();
      this.g.forEach($$2x -> $$2x.a().get().generate(($$3x, $$4) -> {
            acq $$5x = $$2.put(bec.a($$3x), $$3x);
            if ($$5x != null) {
      ...
      dzv $$3 = new dzv(ebv.m, new dzo() {
         ...
         public <T> T getElement(dzm<T> $$0) {
            return (T)($$0.a() == dzp.c ? $$1.get($$0.b()) : null);
         }
      });

      for (acq $$5 : Sets.difference(this.f, $$1.keySet())) {
         $$3.a("Missing built-in table: " + $$5);
      }

      $$1.forEach(($$1x, $$2x) -> $$2x.a($$3.a($$2x.a()).a("{" + $$1x + "}", new dzm<>(dzp.c, $$1x))));
      ...
      if (!$$6.isEmpty()) {
         ...
         return CompletableFuture.allOf($$1.entrySet().stream().map($$1x -> {
            acq $$2x = (acq)$$1x.getKey();
            dzs $$3x = (dzs)$$1x.getValue();
            Path $$4 = this.e.a($$2x);
            return ji.a($$0, dzp.c.a().toJsonTree($$3x), $$4);
   ...
   public static record a(Supplier<kd> a, ebu b) {
   }
}
