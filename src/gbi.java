...
public class gbi extends dws {
   ...
   public gbi(gbm $$0, int $$1) {
      this.e = $$0;
      this.b = new dwu($$0, new ddp(0, 0), $$0.G_().e(lw.aH).b(dfr.b));
      this.c = new eqi(this, true, $$0.C_().g());
      this.d = new gbi.a(b($$1));
   }
   ...
   private static boolean a(@Nullable dwy $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         ddp $$3 = $$0.f();
   ...
   @Nullable
   public dwy b(int $$0, int $$1, dxp $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         dwy $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public dwy a(int $$0, int $$1, wb $$2, ug $$3, Consumer<adl.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         dwy $$6 = this.d.b.get($$5);
         ddp $$7 = new ddp($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new dwy(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<dwy> b;
      ...
      void a(int $$0, @Nullable dwy $$1) {
         dwy $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            gbi.this.e.a($$2);
      ...
      private void a(dwy $$0) {
         ...
         for (int $$2 = 0; $$2 < $$1.length; $$2++) {
            ddp $$3 = $$0.f();
            this.c.remove(kh.b($$3.e, $$0.h($$2), $$3.f));
         }
      }
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  dwy $$5 = gbi.this.d.b.get(gbi.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     ddp $$6 = $$5.f();
            ...
            gbi.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
