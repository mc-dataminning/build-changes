...
public class frx {
   ...
   public final Map<ib, fry> c;
   public final frz d;
   public final boolean e;

   public frx(Vector3f $$0, Vector3f $$1, Map<ib, fry> $$2, @Nullable frz $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ib, fry> $$0 : this.c.entrySet()) {
         float[] $$1 = this.a($$0.getKey());
         $$0.getValue().e.a($$1);
      }
   }

   private float[] a(ib $$0) {
      switch ($$0) {
         case a:
   ...
   protected static class a implements JsonDeserializer<frx> {
      ...
      public frx a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         frz $$6 = this.a($$3);
         Map<ib, fry> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !atg.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = atg.a($$3, "shade", true);
            return new frx($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private frz a(JsonObject $$0) {
         frz $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = atg.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ib.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = atg.a($$2, "rescale", false);
            $$1 = new frz($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = atg.m($$0, "angle");
         if ($$1 != 0.0F && atq.e($$1) != 22.5F && atq.e($$1) != 45.0F) {
      ...
      private ib.a c(JsonObject $$0) {
         String $$1 = atg.i($$0, "axis");
         ib.a $$2 = ib.a.a($$1.toLowerCase(Locale.ROOT));
         if ($$2 == null) {
      ...
      private Map<ib, fry> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ib, fry> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ib, fry> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ib, fry> $$2 = Maps.newEnumMap(ib.class);
         JsonObject $$3 = atg.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ib $$5 = this.a($$4.getKey());
            $$2.put($$5, (fry)$$0.deserialize($$4.getValue(), fry.class));
         }

         return $$2;
      }

      private ib a(String $$0) {
         ib $$1 = ib.a($$0);
         if ($$1 == null) {
