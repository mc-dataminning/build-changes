...
public class fln extends auu<Map<String, List<fln.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<fln.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(fln.a::a),
                     Codec.LONG.fieldOf("period").forGetter(fln.a::b),
                     Codec.STRING.fieldOf("title").forGetter(fln.a::c),
                     Codec.STRING.fieldOf("message").forGetter(fln.a::d)
                  )
                  .apply($$0, fln.a::new)
         )
         .listOf()
   ...
   public fln(akv $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<fln.a>> a(aup $$0, bos $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<fln.a>> $$0, aup $$1, bos $$2) {
      List<fln.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<fln.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<fln.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<fln.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public fln.b a(List<fln.a> $$0, long $$1) {
         this.cancel();
         return new fln.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (fln.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> frb.a(fli.Q().aA(), frb.a.g, wp.a($$2.c, $$3), wp.a($$2.d, $$3)));
                  return;
               }
            }
         }
