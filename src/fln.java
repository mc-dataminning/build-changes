...
public class fln {
   ...
   public void a(fng $$0, String $$1, fod.a $$2, fah $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fln.b $$13 = new fln.b($$1.trim(), this.f, $$3, $$2);
                  fln.a $$14 = new fln.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fln.c $$30 = new fln.c(this.f, $$2, $$0);
                        fln.a $$31 = new fln.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fnk(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, fah $$2) throws IOException {
      ...
      File $$15 = new File(fqq.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final fah d;
      private final fod.a e;

      b(final String $$0, final File $$1, final fah $$2, final fod.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fln.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fln.this.b && !fln.this.d) {
            try {
               fln.this.e = true;
               fln.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fln.a.error("Error extracting archive", var3);
               fln.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fod.a c;
      private final fng d;

      c(final File $$0, final fod.a $$1, final fng $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fln.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fln.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fln.this.g);
                  fln.this.c = true;
               } else {
                  fln.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fln.this.d = true;
               }
            } catch (IOException var3) {
               fln.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fln.this.d = true;
            }
         }
      }
