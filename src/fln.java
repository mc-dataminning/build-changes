...
public class fln implements ezf {
   static final Logger b = LogUtils.getLogger();
   private final fad c;
   private final flb<fln.b> d;

   fln(fad $$0, flb<fln.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(akt c, int d, int e, int[][] f) implements flp {
      private static final Codec<int[][]> g = axu.b(Codec.STRING.listOf().xmap($$0 -> {
         int $$1 = $$0.size();
         int[][] $$2 = new int[$$1][];
      ...
      public static final MapCodec<fln.a> a = axu.a(
         RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     akt.a.fieldOf("file").forGetter(fln.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fln.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fln.a::e),
                     g.fieldOf("chars").forGetter(fln.a::f)
                  )
                  .apply($$0, fln.a::new)
         ),
         fln.a::a
      ...
      private static DataResult<fln.a> a(fln.a $$0) {
      ...
      private ezf a(aud $$0) throws IOException {
         ...
         try (InputStream $$2 = $$0.open($$1)) {
            ...
            flb<fln.b> $$9 = new flb<>(fln.b[]::new, fln.b[][]::new);
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fln.b $$15 = $$9.a($$12, new fln.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fln.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
   ...
   static record b(float a, fad b, int c, int d, int e, int f, int g, int h) implements eze {
