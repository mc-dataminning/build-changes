...
public class flw {
   ...
   public void a(fmh $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == fmh.a) {
            fqo.b($$1, fqo.a.a, xv.c("narrator.toast.disabled"), null);
         } else {
            fqo.b($$1, fqo.a.a, xv.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fqo.b($$1, fqo.a.a, xv.c("narrator.toast.disabled"), xv.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new flw.a("Narrator library is not active");
      }
   }
