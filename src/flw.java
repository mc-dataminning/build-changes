...
public class flw {
   ...
   public void a(final flu $$0, final Runnable $$1) throws UnknownHostException {
      final fmv $$2 = fmv.a($$0.b);
      Optional<InetSocketAddress> $$3 = fmx.a.a($$2).map(fmu::d);
      if ($$3.isEmpty()) {
         this.a(ezo.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final fmv $$1, final flu $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)ts.g.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new flo($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.g = -1;
               $$2.h = ur.b($$2xx);
               $$2.d = ur.b($$3);
               $$2.c = flw.a($$4, $$5);
               $$2.e = new afj.b($$5, $$4, List.of());
            })});
         }
