...
public class hiv<T> implements hiz<T> {
   protected final Comparator<T> a;
   protected final hiy<T> b;

   public hiv(Function<T, Stream<akv>> $$0, List<T> $$1) {
   ...
   protected List<T> a(String $$0, String $$1) {
      List<T> $$2 = this.b.a($$0);
      List<T> $$3 = this.b.b($$1);
      return ImmutableList.copyOf(new hiw<T>($$2.iterator(), $$3.iterator(), this.a));
   }
}
