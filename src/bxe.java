...
public class bxe {
   ...
   public static bvh<btw> a(float $$0) {
      ...
      return byt.a(
         (Function<byt.b<btw>, ? extends App<byt.c<btw>, byw<btw>>>)($$3 -> $$3.group($$3.c(ccr.m), $$3.c(ccr.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.Z() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cer $$7 = $$4x.y();
                        Optional<iz> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cev.n), $$5.dp(), 48, cer.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dp()) <= 4.0)) {
                           ...
                           Set<Pair<ji<ceu>, iz>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cev.n), $$10, $$5.dp(), 48, cer.b.c).collect(Collectors.toSet());
                           eoh $$12 = buz.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              iz $$13 = $$12.l();
                              Optional<ji<ceu>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new ccu($$13, $$0, 1));
                                 ags.c($$4x, $$13);
                              }
