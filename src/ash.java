...
public abstract class ash implements asq {
   ...
   public <T> T a(atd<T> $$0) throws IOException {
      atw<InputStream> $$1 = this.a(new String[]{"pack.mcmeta"});
      if ($$1 == null) {
         return null;
      } else {
         Object var4;
   ...
   @Nullable
   public static <T> T a(atd<T> $$0, InputStream $$1) {
      JsonObject $$3;
