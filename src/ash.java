...
public class ash implements asd {
   ...
   private final Map<asf, List<Path>> h;

   ash(asc $$0, arv $$1, Set<String> $$2, List<Path> $$3, Map<asf, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(asf $$0, akh $$1, Consumer<Path> $$2) {
   ...
   public void a(asf $$0, String $$1, String $$2, asd.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<akh, atj<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(asd.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      asg.a($$1, $$4, $$3, $$0);
   }
   ...
   public atj<InputStream> a(asf $$0, akh $$1) {
      return (atj<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && asg.a($$5)) {
               return atj.create($$5);
            }
         }
   ...
   public <T> T a(asq<T> $$0) {
      atj<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public atu d() {
      return $$0 -> Optional.ofNullable(this.a(asf.a, $$0)).map($$0x -> new atp(this, $$0x));
   }
}
