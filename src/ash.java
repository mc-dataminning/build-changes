...
public class ash {
   ...
   public static SecretKey a() throws asi {
      try {
   ...
   public static KeyPair b() throws asi {
      try {
   ...
   public static byte[] a(String $$0, PublicKey $$1, SecretKey $$2) throws asi {
      try {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, ash.a<T> $$3) throws asi {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws asi {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", ash::b);
   }

   public static PublicKey b(String $$0) throws asi {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", ash::a);
   }
   ...
   private static PrivateKey b(byte[] $$0) throws asi {
      try {
   ...
   public static PublicKey a(byte[] $$0) throws asi {
      try {
   ...
   public static SecretKey a(PrivateKey $$0, byte[] $$1) throws asi {
      byte[] $$2 = b($$0, $$1);
   ...
   public static byte[] a(Key $$0, byte[] $$1) throws asi {
      return a(1, $$0, $$1);
   }

   public static byte[] b(Key $$0, byte[] $$1) throws asi {
      return a(2, $$0, $$1);
   }

   private static byte[] a(int $$0, Key $$1, byte[] $$2) throws asi {
      try {
   ...
   public static Cipher a(int $$0, Key $$1) throws asi {
      try {
   ...
   interface a<T extends Key> {
      T apply(byte[] var1) throws asi;
   }

   public static record b(long b, byte[] c) {
      public static final ash.b a = new ash.b(0L, ByteArrays.EMPTY_ARRAY);
      ...
      public static void a(tu $$0, ash.b $$1) {
         $$0.b($$1.b);
         $$0.a($$1.c);
      }
