...
public class ash implements AutoCloseable {
   ...
   private ash(URL $$0, ash.c $$1, URL $$2, ash.b $$3, URL $$4, ash.b $$5, String $$6, ash.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   public static ash a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            JsonObject $$1 = ayk.a($$0);
            URI $$2 = new URI(ayk.i($$1, "apiServer"));
            String $$3 = ayk.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = ayk.a($$1, "ruleId", 1);
               String $$5 = ayk.a($$1, "serverId", "");
               String $$6 = ayk.a($$1, "roomId", "Java:Chat");
               int $$7 = ayk.a($$1, "hashesToDrop", -1);
               int $$8 = ayk.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = ayk.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, ash.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<art> a(GameProfile $$0, String $$1, ash.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(art.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = ayk.a($$4, "response", false);
            if ($$5) {
               return art.a($$1);
            } else {
               String $$6 = ayk.a($$4, "hashed", null);
               if ($$6 == null) {
                  return art.b($$1);
               } else {
                  JsonArray $$7 = ayk.v($$4, "hashes");
                  xp $$8 = this.a($$1, $$7, $$2);
                  return new art($$1, $$8);
               }
            }
   ...
   private xp a(String $$0, JsonArray $$1, ash.a $$2) {
      if ($$1.isEmpty()) {
         return xp.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xp.b;
      } else {
         xp $$3 = new xp($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new ash.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public asg a(GameProfile $$0) {
      return new ash.d($$0);
   }
   ...
   public interface a {
      ash.a a = ($$0, $$1) -> false;
      ash.a b = ($$0, $$1) -> $$0.length() == $$1;

      static ash.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static ash.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements asg {
      private final GameProfile c;
      private final Executor d;

      d(final GameProfile $$0) {
         this.c = $$0;
         bpi<Runnable> $$1 = bpi.a(ash.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         ash.this.a(this.c, ash.this.g, ash.this.h, this.d);
      }

      @Override
      public void b() {
         ash.this.a(this.c, ash.this.i, ash.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<art>> a(List<String> $$0) {
         List<CompletableFuture<art>> $$1 = $$0.stream().map($$0x -> ash.this.a(this.c, $$0x, ash.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<art> a(String $$0) {
         return ash.this.a(this.c, $$0, ash.this.l, this.d);
      }
   }
