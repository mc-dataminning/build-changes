...
public class ash implements aix, wc {
   ...
   public void d() {
      ...
      if (this.i++ == 600) {
         this.a(wo.c("multiplayer.disconnect.slow_login"));
      }
   }
   ...
   private void c(GameProfile $$0) {
      ...
      if ($$2 != null) {
         ...
         if (this.f.az() >= 0 && !this.g.e()) {
            this.g.a(new ais(this.f.az()), vv.a(() -> this.g.a(this.f.az(), true)));
         }
   ...
   public void a(aja $$0) {
      ...
      Thread $$8 = new Thread("User Authenticator #" + b.incrementAndGet()) {
         ...
         public void run() {
            ...
            try {
               ProfileResult $$1 = ash.this.f.aq().hasJoinedServer($$0, $$5, this.a());
               if ($$1 != null) {
                  GameProfile $$2 = $$1.profile();
                  ash.c.info("UUID of player {} is {}", $$2.getName(), $$2.getId());
                  ash.this.b($$2);
               } else if (ash.this.f.U()) {
                  ash.c.warn("Failed to verify username but will let them in anyway!");
                  ash.this.b(kl.b($$0));
               } else {
                  ash.this.a(wo.c("multiplayer.disconnect.unverified_username"));
               ...
               if (ash.this.f.U()) {
                  ...
                  ash.this.a(wo.c("multiplayer.disconnect.authservers_down"));
         ...
         private InetAddress a() {
            ...
            return ash.this.f.ab() && $$0 instanceof InetSocketAddress ? ((InetSocketAddress)$$0).getAddress() : null;
         }
      };
   ...
   public void a(ajb $$0) {
      ...
      this.g.a(aaz.d);
      ars $$1 = ars.a(Objects.requireNonNull(this.k), this.m);
