...
public class dje {
   ...
   private final List<djc> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dje.a l = new dje.d(5.999997E7F);
   public static final dje.c e = new dje.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public boolean a(eju $$0) {
      return $$0.d > this.e() && $$0.a < this.g() && $$0.f > this.f() && $$0.c < this.h();
   }

   public hx b(double $$0, double $$1, double $$2) {
      return hx.a(atq.a($$0, this.e(), this.g()), $$1, atq.a($$2, this.f(), this.h()));
   }

   public double a(bkv $$0) {
   ...
   public boolean a(bkv $$0, eju $$1) {
      double $$2 = Math.max(atq.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dje.a)($$0 == $$1 ? new dje.d($$1) : new dje.b($$0, $$1, $$2));
   ...
   class b implements dje.a {
      ...
      @Override
      public double a() {
         return atq.a(dje.this.a() - this.e() / 2.0, (double)(-dje.this.k), (double)dje.this.k);
      }

      @Override
      public double c() {
         return atq.a(dje.this.b() - this.e() / 2.0, (double)(-dje.this.k), (double)dje.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? atq.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public djd i() {
         return this.c < this.b ? djd.b : djd.a;
      }
      ...
      @Override
      public dje.a l() {
         return (dje.a)(this.g() <= 0L ? dje.this.new d(this.c) : this);
      }
      ...
      public eks m() {
         return ekp.a(
            ekp.c,
            ekp.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ekd.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dje.c a(DynamicLike<?> $$0, dje.c $$1) {
         double $$2 = atq.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = atq.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dje.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dje.a {
      ...
      private void n() {
         this.c = atq.a(dje.this.a() - this.b / 2.0, (double)(-dje.this.k), (double)dje.this.k);
         this.d = atq.a(dje.this.b() - this.b / 2.0, (double)(-dje.this.k), (double)dje.this.k);
         this.e = atq.a(dje.this.a() + this.b / 2.0, (double)(-dje.this.k), (double)dje.this.k);
         this.f = atq.a(dje.this.b() + this.b / 2.0, (double)(-dje.this.k), (double)dje.this.k);
         this.g = ekp.a(
            ekp.c,
            ekp.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            ekd.e
