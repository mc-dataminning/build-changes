...
public class dje {
   ...
   public dje(ctp $$0, hx $$1, ic $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      djh $$0 = this.b.a_(this.e);
      if (!dja.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == eew.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(djh $$0) {
      return $$0.a(cws.hV) || $$0.a(cws.pg);
   }

   private static boolean a(djh $$0, djh $$1) {
      if ($$0.a(cws.pg) && $$1.a(cws.hV)) {
         return false;
      } else {
         return $$0.a(cws.hV) && $$1.a(cws.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(hx $$0, ic $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dja.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               djh $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dja.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dja.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
