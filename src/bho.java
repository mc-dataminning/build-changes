...
public class bho extends bgz {
               ...
               $$2.get("CriteriaName")
                  ...
                  .map($$0x -> {
                     ...
                     if ($$1x < 0) {
                        ...
                        try {
                           akf $$2x = akf.a($$0x.substring(0, $$1x), '.');
                           akf $$3 = akf.a($$0x.substring($$1x + 1), '.');
   ...
   protected static final HookFunction d = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         Dynamic<T> $$2 = new Dynamic($$0, $$1);
         Optional<Dynamic<T>> $$3 = $$2.get("CriteriaType").get().get().left().flatMap($$1x -> {
            ...
            if ($$2x.isPresent() && $$3x.isPresent()) {
               String $$4 = $$2x.get();
               return $$4.equals("_special") ? Optional.of($$2.createString($$3x.get())) : Optional.of($$1x.createString(bho.b($$4) + ":" + bho.b($$3x.get())));
            } else {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bfp.F, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), c, d));
   }

   protected static Map<String, Supplier<TypeTemplate>> a(Schema $$0) {
      Supplier<TypeTemplate> $$1 = () -> DSL.optionalFields("id", bfp.B.in($$0));
      Supplier<TypeTemplate> $$2 = () -> DSL.optionalFields("id", bfp.A.in($$0));
      Supplier<TypeTemplate> $$3 = () -> DSL.optionalFields("id", bfp.x.in($$0));
