...
public final class agz<E> implements Codec<ih<E>> {
   private final ahc<? extends it<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> agz<E> a(ahc<? extends it<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> agz<E> a(ahc<? extends it<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new agz<>($$0, $$1, $$2);
   }

   private agz(ahc<? extends it<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public <T> DataResult<T> a(ih<E> $$0, DynamicOps<T> $$1, T $$2) {
      if ($$1 instanceof ahb<?> $$3) {
         ...
         if ($$4.isPresent()) {
            ...
            return (DataResult<T>)$$0.d().map($$2x -> ahd.a.encode($$2x.a(), $$1, $$2), $$2x -> this.b.encode($$2x, $$1, $$2));
         }
      }
