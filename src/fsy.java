...
public class fsy<T extends ceo> extends frr<T> {
   public final fvw a;
   private final fvw b;
   private final fvw f;
   private final fvw g;
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.fL()) {
         this.a.e = 0.0F;
         this.a.f = (float) (-Math.PI * 2.0 / 3.0);
         this.a.g = ayd.b($$3 * 0.027F) / 22.0F;
      }

      if ($$0.ca()) {
         float $$6 = ayd.b($$3) * 0.01F;
         this.b.f = $$6;
         this.f.g = $$6;
         this.g.g = $$6;
         this.h.g = $$6 / 2.0F;
      ...
      if ($$0.gp()) {
         float $$7 = 0.1F;
         this.n += 0.67F;
         this.f.e = ayd.b(this.n * 0.4662F) * 0.1F;
         this.g.e = ayd.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.h.e = ayd.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.i.e = ayd.b(this.n * 0.4662F) * 0.1F;
      }
   }
}
