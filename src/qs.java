...
public abstract class qs {
   ...
   private static volatile qs e = c();
   ...
   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = qs.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public abstract ark a(tp var1);

   public List<ark> a(List<tp> $$0) {
