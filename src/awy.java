...
public class awy extends awx {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, awy.a> s;
   private final awt t;
   private long u;
   private final amq v;

   private awy(amq $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == awu.c($$2, 7, $$0.getLength());
      }
   }
