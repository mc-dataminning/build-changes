...
public class fqp extends fql {
   ...
   protected void m() {
      ...
      ffw<Integer> $$6 = new ffw<>("options.fullscreen.resolution", ffw.a(), ($$1x, $$2x) -> {
         if ($$2 == null) {
            return wu.c("options.fullscreen.unavailable");
         } else if ($$2x == -1) {
            return ffx.a($$1x, wu.c("options.fullscreen.current"));
         } else {
            ezp $$3x = $$2.a($$2x);
            return ffx.a($$1x, wu.a("options.fullscreen.entry", $$3x.a(), $$3x.b(), $$3x.f(), $$3x.c() + $$3x.d() + $$3x.e()));
         }
      }, new ffw.f(-1, $$2 != null ? $$2.e() - 1 : -1), $$3, $$2x -> {
         if ($$2 != null) {
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         if (this.y.g()) {
            ...
            this.l.a(new fqo(v, $$3, ImmutableList.of(new fqo.a(w, $$0x -> {
               this.c.j().a(ffm.c);
               fft.Q().f.f();
               this.y.e();
               this.l.a(this);
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (fnj.s()) {
         ffw<Integer> $$4 = this.c.aq();
         if ($$4.e() instanceof ffw.c $$5) {
            int $$6 = $$4.c();
            int $$7 = $$6 == 0 ? $$5.b() + 1 : $$6;
            int $$8 = $$7 + (int)Math.signum($$3);
            if ($$8 != 0 && $$8 <= $$5.b() && $$8 >= $$5.d()) {
               fhz<Integer> $$9 = (fhz<Integer>)this.q.b($$4);
               if ($$9 != null) {
                  $$4.a($$8);
                  $$9.a($$8);
                  this.q.b(0.0);
