...
public class fqp implements akr<cyr>, fig, fiz, fkx, fqu {
   public static final fiq a = new fiq(new ale("recipe_book/button"), new ale("recipe_book/button_highlighted"));
   ...
   private int o;
   private int p;
   protected final fqn e = new fqn();
   private final List<fqr> q = Lists.newArrayList();
   @Nullable
   private fqr r;
   protected fij f;
   protected crg<?> g;
   ...
   public void a(int $$0, int $$1, ffe $$2, boolean $$3, crg<?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      this.s = new fhm(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, xo.c("itemGroup.search"));
      this.s.f(50);
      this.s.g(true);
      this.s.g(16777215);
      this.s.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new fij($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (ffm $$3 : ffm.a(this.g.t())) {
         this.q.add(new fqr($$3));
      }
   ...
   private void b() {
      this.f.a(this.f.a() ? fio.a(this.c()) : fio.a(m));
   }
   ...
   private void c(boolean $$0) {
      List<fqt> $$1 = this.v.a(this.r.b());
      $$1.forEach($$0x -> $$0x.a(this.x, this.g.n(), this.g.o(), this.v));
      List<fqt> $$2 = Lists.newArrayList($$1);
      $$2.removeIf($$0x -> !$$0x.b());
      $$2.removeIf($$0x -> !$$0x.d());
      String $$3 = this.s.a();
      if (!$$3.isEmpty()) {
         ObjectSet<fqt> $$4 = new ObjectLinkedOpenHashSet(this.h.a(gsy.c).search($$3.toLowerCase(Locale.ROOT)));
   ...
   private void b(fgq $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fnc.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(fgq $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.f() && !this.h.s.N_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.cb.j, $$3, fnc.t());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   public void a(cyw<?> $$0, List<cro> $$1) {
      ...
      this.e.a($$0);
      this.e.a(cyr.a($$2), $$1.get(0).e, $$1.get(0).f);
   ...
   @Override
   public fkx.a t() {
      return this.A ? fkx.a.b : fkx.a.a;
   }

   @Override
   public void b(fkz $$0) {
      List<fkx> $$1 = Lists.newArrayList();
      this.w.a($$1x -> {
         if ($$1x.B()) {
            $$1.add($$1x);
         }
