...
public class fqp implements fih, fja {
   ...
   private final List<fqp.a> n = Lists.newArrayList();
   private boolean o;
   private int p;
   private int q;
   private fff r;
   ...
   public void a(fff $$0, fqu $$1, int $$2, int $$3, int $$4, int $$5, float $$6) {
      this.r = $$0;
      this.s = $$1;
      if ($$0.s.cb instanceof cpv) {
         this.w = true;
      }

      boolean $$7 = $$0.s.m().a((crh<?>)$$0.s.cb);
      List<cyx<?>> $$8 = $$1.b(true);
      List<cyx<?>> $$9 = $$7 ? Collections.emptyList() : $$1.b(false);
      int $$10 = $$8.size();
      int $$11 = $$10 + $$9.size();
      int $$12 = $$11 <= 16 ? 4 : 5;
      ...
      for (int $$20 = 0; $$20 < $$11; $$20++) {
         boolean $$21 = $$20 < $$10;
         cyx<?> $$22 = $$21 ? $$8.get($$20) : $$9.get($$20 - $$10);
         int $$23 = this.p + 4 + 25 * ($$20 % $$12);
         int $$24 = this.q + 5 + 25 * ($$20 / $$12);
         if (this.w) {
            this.n.add(new fqp.b($$23, $$24, $$22, $$21));
         } else {
            this.n.add(new fqp.a($$23, $$24, $$22, $$21));
         }
      }
   ...
   class a extends fhc implements aks<cys> {
      final cyx<?> c;
      private final boolean d;
      protected final List<fqp.a.a> a = Lists.newArrayList();

      public a(final int $$0, final int $$1, final cyx<?> $$2, final boolean $$3) {
      ...
      public void a(Iterator<cys> $$0, int $$1, int $$2, int $$3, int $$4) {
         cup[] $$5 = $$0.next().a();
         if ($$5.length != 0) {
            this.a.add(new fqp.a.a(3 + $$4 * 7, 3 + $$3 * 7, $$5));
         }
      }
      ...
      public void b(fgr $$0, int $$1, int $$2, float $$3) {
         ...
         if (this.d) {
            if (fqp.this.w) {
               $$4 = this.A() ? fqp.c : fqp.d;
            } else {
               $$4 = this.A() ? fqp.e : fqp.f;
            }
         } else if (fqp.this.w) {
            $$4 = this.A() ? fqp.g : fqp.h;
         } else {
            $$4 = this.A() ? fqp.i : fqp.j;
         }
         ...
         for (fqp.a.a $$8 : this.a) {
            $$0.c().a();
            $$0.c().a((double)$$8.b, (double)$$8.c, 0.0);
            $$0.c().b(0.375F, 0.375F, 1.0F);
            $$0.c().a(-8.0, -8.0, 0.0);
            if ($$8.a.length > 0) {
               $$0.a($$8.a[ayz.d(fqp.this.v / 30.0F) % $$8.a.length], 0, 0);
            }
      ...
      protected class a {
         ...
         public a(final int $$1, final int $$2, final cup[] $$3) {
            this.b = $$1;
            this.c = $$2;
            this.a = $$3;
         }
   ...
   class b extends fqp.a {
      public b(final int $$0, final int $$1, final cyx<?> $$2, final boolean $$3) {
         super($$0, $$1, $$2, $$3);
      }
      ...
      protected void a(cyx<?> $$0) {
         cys $$1 = $$0.b().a().get(0);
         cup[] $$2 = $$1.a();
         this.a.add(new fqp.a.a(10, 10, $$2));
      }
   }
}
