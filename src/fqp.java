...
public class fqp {
   ...
   private void a(o $$0, xg $$1) {
      this.b.m.d().a(xg.i().b(xg.c("debug.prefix").a($$0, o.r)).b(xf.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(xg.b(MessageFormat.format($$0, $$1)));
   }
      ...
      if (this.d > 0L && this.d < ag.c() - 100L) {
         ...
         switch ($$0) {
            ...
            case 81:
               ...
               ftz $$3 = this.b.m.d();
               $$3.a(xg.c("debug.reload_chunks.help"));
               $$3.a(xg.c("debug.show_hitboxes.help"));
               $$3.a(xg.c("debug.copy_location.help"));
               $$3.a(xg.c("debug.clear_chat.help"));
               $$3.a(xg.c("debug.chunk_boundaries.help"));
               $$3.a(xg.c("debug.advanced_tooltips.help"));
               $$3.a(xg.c("debug.inspect.help"));
               $$3.a(xg.c("debug.profiling.help"));
               $$3.a(xg.c("debug.creative_spectator.help"));
               $$3.a(xg.c("debug.pause_focus.help"));
               $$3.a(xg.c("debug.help.help"));
               $$3.a(xg.c("debug.dump_dynamic_textures.help"));
               $$3.a(xg.c("debug.reload_resourcepacks.help"));
               $$3.a(xg.c("debug.pause.help"));
               $$3.a(xg.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.q.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.aa().a($$5);
               xg $$6 = xg.b($$4.relativize($$5).toString()).a(o.t).a($$1x -> $$1x.a(new xe.d($$5)));
   ...
   private void a(ebq $$0, iw $$1, @Nullable ua $$2) {
   ...
   private void a(alr $$0, fgc $$1, @Nullable ua $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().d();
         boolean $$5 = fka.a(fqq.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!fka.a(fqq.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (fka.a(fqq.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = ag.c();
            this.e = ag.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof gdd) || ((gdd)$$6).u <= ag.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
               boolean $$7 = this.b.aO().i();
               this.b.n.ad().a($$7);
               this.b.n.az();
               if (this.b.z instanceof gda $$8) {
                  $$8.c($$7);
               }
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               fqy.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }
         ...
         if ($$3 != 0) {
            ...
            if ($$9) {
               if (fzq.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  ...
                  this.b.n.av().a(fqs.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$10);
                  }
         ...
         label201: {
            ...
            label157:
            if (!$$15) {
               if (this.b.z instanceof fzl $$16 && !$$16.m()) {
                  break label157;
               }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", azz.f((float)$$1 / 1000.0F));
            }
