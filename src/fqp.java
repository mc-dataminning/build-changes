...
public class fqp implements fqu.a {
   ...
   private final eqm A;
   private final Map<gu, fqp.a> B = new HashMap<>();
   private final Map<UUID, vm.a> C = new HashMap<>();
   @Nullable
   private UUID D;
   ...
   public void a(vw.a $$0, long $$1) {
      this.B.put($$0.a(), new fqp.a($$0, $$1));
   }
   ...
   private void b() {
      this.C.entrySet().removeIf($$0 -> this.A.u.a($$0.getValue().c()) == null);
   }

   private void c() {
      long $$0 = this.A.u.V() - 20L;
      this.B.entrySet().removeIf($$1 -> $$1.getValue().b() < $$0);
   }

   private void a(elg $$0, fnl $$1) {
      gu $$2 = this.e().c();
   ...
   private void b(elg $$0, fnl $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(aau::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         fqu.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(aau::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(elg $$0, fnl $$1, gu $$2) {
      float $$3 = 0.05F;
      fqu.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(elg $$0, fnl $$1, gu $$2, List<String> $$3) {
      float $$4 = 0.05F;
      fqu.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(elg $$0, fnl $$1, vw.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(elg $$0, fnl $$1, vm.a $$2) {
      if ($$2.e() != null) {
         frc.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(elg $$0, fnl $$1, vm.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(elg $$0, fnl $$1, String $$2, vw.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(elg $$0, fnl $$1, String $$2, gu $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      fqu.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(elg $$0, fnl $$1, ho $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      gu $$9 = gu.a($$2);
      ...
      float $$13 = 0.5F;
      fqu.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(vw.a $$0) {
      return this.a($$0.a()).stream().map(aau::a).collect(Collectors.toSet());
   }

   private String a(vm.a $$0, gu $$1) {
   ...
   private boolean c(vm.a $$0) {
      cbn $$1 = this.A.v;
      gu $$2 = gu.a($$1.dp(), $$0.d().b(), $$1.dv());
      gu $$3 = gu.a($$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(gu $$0) {
      return this.C.values().stream().filter($$1 -> $$1.a($$0)).map(vm.a::b).collect(Collectors.toSet());
   }

   private Map<gu, List<String>> f() {
      Map<gu, List<String>> $$0 = Maps.newHashMap();

      for (vm.a $$1 : this.C.values()) {
   ...
   private void g() {
      fqu.a(this.A.am(), 8).ifPresent($$0 -> this.D = $$0.cv());
   }

   static record a(vw.a a, long b) {
   }
}
