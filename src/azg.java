...
public class azg extends bee {
   ...
   public azg(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bff.s, "minecraft:banner");
   }
   ...
   private static Dynamic<?> a(Dynamic<?> $$0) {
      return ayu.a($$0, "Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(azg::b)));
   }
   ...
   private static Dynamic<?> b(Dynamic<?> $$0) {
      ...
      return ayu.a($$0, "Color", "color", $$0x -> $$0x.createString(a($$0x.asInt(0))));
   }
