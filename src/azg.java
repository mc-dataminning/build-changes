...
public class azg {
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, c, $$0 -> ayh.a(1.0F, $$0.x(), $$0.y(), $$0.z()));
   public static final Codec<Integer> j = Codec.withAlternative(Codec.INT, d, $$0 -> ayh.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<azg.d> t = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? alr.d($$0.substring(1)).map($$0x -> new azg.d($$0x, true)) : alr.d($$0).map($$0x -> new azg.d($$0x, false)), azg.d::c
      );
   ...
   public static final Codec<String> y = Codec.string(0, 16)
      .validate($$0 -> bay.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   private static final MapCodec<GameProfile> G = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(ka.e.fieldOf("id").forGetter(GameProfile::getId), y.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   ...
   public static final Codec<String> C = Codec.STRING
      .validate($$0 -> !alr.i($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> azg.c<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new azg.c<>($$0, $$1);
   }
   ...
   public static <T> Codec<jk<T>> c(Codec<jk<T>> $$0) {
      return $$0.validate(
   ...
   public static class b<I, V> {
      ...
      public Codec<V> a(Codec<I> $$0) {
         ...
         return azg.a($$0, this.a::get, $$1::get);
      }

      public azg.b<I, V> a(I $$0, V $$1) {
   ...
   public static record d(alr a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
