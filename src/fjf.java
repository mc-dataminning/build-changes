...
public class fjf extends avf<Map<String, List<fjf.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<fjf.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(fjf.a::a),
                     Codec.LONG.fieldOf("period").forGetter(fjf.a::b),
                     Codec.STRING.fieldOf("title").forGetter(fjf.a::c),
                     Codec.STRING.fieldOf("message").forGetter(fjf.a::d)
                  )
                  .apply($$0, fjf.a::new)
         )
         .listOf()
   ...
   public fjf(alh $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<fjf.a>> a(ava $$0, bok $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<fjf.a>> $$0, ava $$1, bok $$2) {
      List<fjf.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<fjf.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<fjf.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<fjf.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public fjf.b a(List<fjf.a> $$0, long $$1) {
         this.cancel();
         return new fjf.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (fjf.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fni.a(fja.Q().aA(), fni.a.g, xh.a($$2.c, $$3), xh.a($$2.d, $$3)));
                  return;
               }
            }
         }
