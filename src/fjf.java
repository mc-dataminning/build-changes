...
public class fjf {
   ...
   public void a(final fjd $$0, final Runnable $$1) throws UnknownHostException {
      final fke $$2 = fke.a($$0.b);
      Optional<InetSocketAddress> $$3 = fkg.a.a($$2).map(fkd::d);
      if ($$3.isEmpty()) {
         this.a(ewz.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final fke $$1, final fjd $$2) {
