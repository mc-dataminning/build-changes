...
public class fjf {
   public static List<fkq> a(fjf.a... $$0) {
      for (fjf.a $$1 : $$0) {
         a($$1.j);
      }

      List<fkq> $$2 = Lists.newArrayList();

      for (fjf.a $$3 : $$0) {
         $$2.add(new fkq($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fkq::a));
      return $$2;
   }
   ...
   public static List<fkq> a() {
      return a(fjf.a.values());
   }
