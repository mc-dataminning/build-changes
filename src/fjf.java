...
public class fjf implements fsm {
   ...
   protected void a(fgt $$0, float $$1, int $$2, int $$3, fsn $$4) {
   ...
   private void a(fgt $$0, int $$1, int $$2, float $$3, float $$4, fsl $$5) {
      if ($$5 != fsj.a) {
         int $$6 = (int)($$4 * 255.0F);
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == fsj.a || !this.g.a($$1).aO_())) {
         $$1 += $$0;
      }
