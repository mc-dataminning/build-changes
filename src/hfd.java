...
public class hfd implements hew {
   static final Logger c = LogUtils.getLogger();
   public static final MapCodec<hfd> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   private hfd(List<akv> $$0, akv $$1, Map<String, akv> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(hfc a, Supplier<IntUnaryOperator> b, akv c) implements hew.b {
      @Nullable
      public hel a(hev $$0) {
         Object var3;
         try {
            fet $$1 = this.a.a().a(this.b.get());
            return new hel(this.c, new hgf($$1.a(), $$1.b()), $$1, aur.a);
         } catch (IllegalArgumentException | IOException var7) {
            hfd.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
