...
public abstract class cfj {
   ...
   public cfj(bvz $$0, dgz $$1) {
      ...
      this.a = $$0;
      this.b = $$1;
      this.v = this.a(azu.a($$0.i(bxf.m) * 16.0));
   }

   public void g() {
      int $$0 = azu.d(this.e() * 16.0F);
      this.v.a($$0);
   }
   ...
   private float e() {
      return Math.max((float)this.a.h(bxf.m), this.x);
   }
   ...
   protected abstract eug a(int var1);
   ...
   @Nullable
   public final eue a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(jh.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public eue a(Stream<jh> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public eue a(Set<jh> $$0, int $$1) {
   ...
   @Nullable
   protected eue a(Set<jh> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, this.e());
   }

   @Nullable
   protected eue a(Set<jh> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         eue $$9 = this.v.a($$8, this.a, $$0, $$4, $$3, this.u);
         $$5.c();
         if ($$9 != null && $$9.l() != null) {
            this.s = $$9.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable eue $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.m()) {
         if (this.a()) {
            ...
            if ($$0.e > $$1.e && !this.a.aJ() && azu.a($$0.d) == azu.a($$1.d) && azu.a($$0.f) == azu.a($$1.f)) {
               this.c.a();
            }
         }
   ...
   protected double a(fbr $$0) {
      jh $$1 = jh.a((ka)$$0);
      return this.b.a_($$1.e()).l() ? $$0.e : eum.a(this.b, $$1);
   }
   ...
   private boolean c(fbr $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         fbr $$1 = fbr.c(this.c.g());
         if (!$$0.a((ka)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            fbr $$2 = fbr.c(this.c.d(this.c.f() + 1));
            fbr $$3 = $$1.d($$0);
            fbr $$4 = $$2.d($$0);
            double $$5 = $$3.h();
            double $$6 = $$4.h();
   ...
   protected void W_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            euc $$1 = this.c.a($$0);
            euc $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dxo $$3 = this.b.a_(new jh($$1.a, $$1.b, $$1.c));
            if ($$3.a(axk.bn)) {
   ...
   public boolean b(euh $$0) {
      return $$0 != euh.n && $$0 != euh.p && $$0 != euh.d;
   }

   protected static boolean a(bvz $$0, fbr $$1, fbr $$2, boolean $$3) {
      fbr $$4 = new fbr($$2.d, $$2.e + (double)$$0.ds() * 0.5, $$2.f);
      return $$0.dW().a(new dgh($$1, $$4, dgh.a.a, $$3 ? dgh.b.c : dgh.b.a, $$0)).d() == fbp.a.a;
   }
   ...
   public boolean b(jh $$0) {
      if (this.m) {
         ...
         euc $$1 = this.c.d();
         fbr $$2 = new fbr(((double)$$1.a + this.a.dB()) / 2.0, ((double)$$1.b + this.a.dD()) / 2.0, ((double)$$1.c + this.a.dH()) / 2.0);
