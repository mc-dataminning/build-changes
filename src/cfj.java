...
public class cfj extends bun implements buq<ji<cfk>> {
   public static final double cb = 0.6;
   public static final double cc = 0.8;
   public static final double cd = 1.33;
   private static final akk<ji<cfk>> ce = ako.a(cfj.class, akm.x);
   private static final akk<Boolean> cf = ako.a(cfj.class, akm.k);
   private static final akk<Boolean> cg = ako.a(cfj.class, akm.k);
   private static final akk<Integer> ch = ako.a(cfj.class, akm.b);
   private static final ale<cfk> ci = cfk.b;
   @Nullable
   private cfj.a<cmy> cj;
   @Nullable
   private cbw ck;
   private float cl;
   private float cm;
   ...
   public cfj(btb<? extends cfj> $$0, dbz $$1) {
      super($$0, $$1);
      this.gC();
   }
   ...
   @Override
   protected void z() {
      this.ck = new cfj.c(this, 0.6, $$0 -> $$0.a(awy.ae), true);
      this.bS.a(1, new cai(this));
      this.bS.a(1, new cbh(this, 1.5));
      this.bS.a(2, new cbt(this));
      this.bS.a(3, new cfj.b(this));
      this.bS.a(4, this.ck);
      this.bS.a(5, new cab(this, 1.1, 8));
      this.bS.a(6, new cam(this, 1.0, 10.0F, 5.0F, false));
      this.bS.a(7, new cac(this, 0.8));
      this.bS.a(8, new cau(this, 0.3F));
      this.bS.a(9, new cbe(this));
      this.bS.a(10, new caa(this, 0.8));
      this.bS.a(11, new ccb(this, 0.8, 1.0000001E-5F));
      this.bS.a(12, new caw(this, cmy.class, 10.0F));
      this.bT.a(1, new cck<>(this, cga.class, false, null));
      this.bT.a(1, new cck<>(this, cgh.class, false, cgh.bY));
   }
   ...
   public static bux.a gB() {
      return bts.A().a(buy.q, 10.0).a(buy.r, 0.3F).a(buy.c, 3.0);
   }
   ...
   public boolean C(bsv $$0) {
      return $$0.a(this.dQ().b((btq)this), this.gE());
   }
   ...
   public boolean a(cfg $$0) {
      if (!this.s()) {
         ...
         return !($$0 instanceof cfj $$1) ? false : $$1.s() && super.a($$0);
      }
   }
   ...
   protected void gC() {
      if (this.cj == null) {
         this.cj = new cfj.a<>(this, cmy.class, 16.0F, 0.8, 1.33);
      }
   ...
   static class b extends cao {
      ...
      public boolean a() {
         if (!this.a.s()) {
            ...
            if ($$0 instanceof cmy) {
               ...
               if (this.a.g((bsv)this.b) > 100.0) {
                  return false;
               }

               iz $$1 = this.b.dp();
               dsd $$2 = this.a.dP().a_($$1);
               if ($$2.a(awp.R)) {
                  this.c = $$2.d(det.aE).map($$1x -> $$1.a($$1x.g())).orElseGet(() -> new iz($$1));
                  return !this.h();
               }
            }
      ...
      private boolean h() {
         for (cfj $$1 : this.a.dP().a(cfj.class, new evn(this.c).g(2.0))) {
      ...
      private void i() {
         ...
         $$1.g(this.a.dp());
         eqo $$2 = this.a.dP().o().be().b(eqf.aG);
         eqm $$3 = new eqm.a((arf)this.a.dP()).a(etf.f, this.a.dn()).a(etf.a, this.a).a(ete.j);
   ...
   static class c extends cbw {
      ...
      public c(cfj $$0, double $$1, Predicate<cuq> $$2, boolean $$3) {
         super($$0, $$1, $$2, $$3);
         this.d = $$0;
      }
