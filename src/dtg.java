...
public class dtg {
   private static final dnb a = dae.hj.o();
   private static final dnb b = dae.hk.o();
   private static final dnb c = dae.iA.o();
   private static final dnb d = dae.hn.o();
   private static final dnb e = dae.hv.o();
   private static final dnb f = dae.hx.o();
   private static final dnb g = dae.hr.o();
   private static final dnb h = dae.iC.o();
   private static final dnb i = dae.dP.o();
   private final dnb j;
   private final int k;
   private final dnb[] l;
   private final ehs m;
   ...
   public dtg(dtc $$0, dnb $$1, int $$2, dtb $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dsx.P);
   ...
   public void a(dtc $$0, cyc $$1, iy<cya> $$2, boolean $$3, dtl $$4, final dox $$5, dss $$6, dtf.o $$7) {
      ...
      dtf.g $$13 = new dtf.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dtf.u $$14 = $$7.apply($$13);
      ib.a $$15 = new ib.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dso.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            il<cya> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(cyh.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dso.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dnb> a(dtf.o $$0, duo $$1, Function<ib, il<cya>> $$2, dox $$3, dss $$4, ib $$5, boolean $$6) {
      dtf.g $$7 = new dtf.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(kj.au), $$1);
      dtf.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dnb $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dou $$0, int $$1, int $$2, int $$3, cxd $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, cya $$1, dou $$2, ib.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dae.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(axd $$0, dnb[] $$1, int $$2, dnb $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dnb a(int $$0, int $$1, int $$2) {
