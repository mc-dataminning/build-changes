...
public class dtg {
   ...
   private final Map<Character, Predicate<dte>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dtg a(char $$0, Predicate<dte> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dtf b() {
      return new dtf(this.c());
   }

   private Predicate<dte>[][][] c() {
      this.d();
      Predicate<dte>[][][] $$0 = (Predicate<dte>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dte>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
