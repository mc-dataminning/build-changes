...
public interface eo {
   ...
   default Collection<eo.b> A() {
      return Collections.singleton(eo.b.b);
   }

   default Collection<eo.b> B() {
      return Collections.singleton(eo.b.b);
   }
   ...
   CompletableFuture<Suggestions> a(alh<? extends js<?>> var1, eo.a var2, SuggestionsBuilder var3, CommandContext<?> var4);
   ...
   static CompletableFuture<Suggestions> a(String $$0, Collection<eo.b> $$1, SuggestionsBuilder $$2, Predicate<String> $$3) {
   ...
   static CompletableFuture<Suggestions> b(String $$0, Collection<eo.b> $$1, SuggestionsBuilder $$2, Predicate<String> $$3) {
      List<String> $$4 = Lists.newArrayList();
      if (Strings.isNullOrEmpty($$0)) {
         for (eo.b $$5 : $$1) {
            String $$6 = $$5.c + " " + $$5.e;
   ...
   public static class b {
      public static final eo.b a = new eo.b("^", "^", "^");
      public static final eo.b b = new eo.b("~", "~", "~");
