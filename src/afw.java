...
public class afw<C extends biq> implements afv<Integer> {
   private static final Logger d = LogUtils.getLogger();
   protected final cdy a = new cdy();
   protected cdt b;
   protected chz<C> c;
   ...
   public void a(amf $$0, @Nullable coq<? extends coo<C>> $$1, boolean $$2) {
      if ($$1 != null && $$0.I().b($$1)) {
         this.b = $$0.fT();
         if (this.b() || $$0.f()) {
            this.a.a();
   ...
   protected void a(coq<? extends coo<C>> $$0, boolean $$1) {
   ...
   private boolean b() {
      ...
      for (int $$2 = 0; $$2 < this.c.n() * this.c.o() + 1; $$2++) {
         if ($$2 != this.c.m()) {
            clj $$3 = this.c.b($$2).f().p();
            if (!$$3.b()) {
               int $$4 = this.b.d($$3);
               if ($$4 == -1 && $$0.size() <= $$1) {
                  for (clj $$5 : $$0) {
                     if (clj.b($$5, $$3) && $$5.L() != $$5.g() && $$5.L() + $$3.L() <= $$5.g()) {
                        $$5.g($$3.L());
                        $$3.f(0);
                        break;
                     }
