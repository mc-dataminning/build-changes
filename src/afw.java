...
public class afw implements Comparable<afw> {
   public static final Codec<afw> a = Codec.STRING.comapFlatMap(afw::b, afw::toString).stable();
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(ui.c("argument.id.invalid"));
   ...
   protected afw(String $$0, String $$1, @Nullable afw.a $$2) {
      this.f = $$0;
      this.g = $$1;
   }

   public afw(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private afw(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static afw a(String $$0, char $$1) {
      return new afw(b($$0, $$1));
   }
   ...
   @Nullable
   public static afw a(String $$0, String $$1) {
      try {
         return new afw($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<afw> b(String $$0) {
      try {
         return DataResult.success(new afw($$0));
      } catch (z var2) {
   ...
   public afw c(String $$0) {
      return new afw(this.f, d(this.f, $$0), null);
   }

   public afw a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.g));
   }

   public afw d(String $$0) {
      return this.c($$0 + this.g);
   }

   public afw e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof afw $$1) ? false : this.f.equals($$1.f) && this.g.equals($$1.g);
      }
   }
   ...
   public static afw a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<afw>, JsonSerializer<afw> {
      public afw a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new afw(aso.a($$0, "location"));
      }

      public JsonElement a(afw $$0, Type $$1, JsonSerializationContext $$2) {
