...
public class gyv extends gxu<bye, hfd> {
   public gyv(gxv.a $$0) {
      super($$0);
   }

   public void a(hfd $$0, fld $$1, grn $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bye $$0, hfd $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bye $$0) {
      return false;
   }
}
