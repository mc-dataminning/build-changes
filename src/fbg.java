public class fbg extends etc<fbg.a> {
   ...
   public fbg(eql $$0, fbf $$1, int $$2, int $$3, tf $$4) {
   ...
   public static class a extends etc.a<fbg.a> {
      private static final int b = 157;
      private static final int c = 157;
      private static final String d = "...";
      private final fbg e;
      protected final eql a;
      private final fbe.a f;
      private final arc g;
      private final esz h;
      private final arc i;
      private final esz j;

      public a(eql $$0, fbg $$1, fbe.a $$2) {
         this.a = $$0;
         this.f = $$2;
         this.e = $$1;
         this.g = a($$0, $$2.d());
      ...
      private static arc a(eql $$0, tf $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static esz b(eql $$0, tf $$1) {
         return esz.a($$0.h, $$1, 157, 2);
      }
      ...
      public void a(erv $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         arc $$11 = this.g;
         esz $$12 = this.h;
         if (this.e() && (this.a.m.V().c() || $$8 || this.e.f() == this && this.e.aw_())) {
