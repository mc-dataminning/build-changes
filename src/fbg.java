...
public class fbg implements fbd {
   ...
   private FT_Face c;
   final float d;
   private final fmz<fbg.b> e = new fmz<>(fbg.b[]::new, fbg.b[][]::new);

   public fbg(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      ...
      try {
         FT_Vector $$12 = fnm.a(FT_Vector.malloc($$11), $$9, $$10);
   ...
   private fbc a(int $$0, FT_Face $$1, int $$2) {
      int $$3 = FreeType.FT_Load_Glyph($$1, $$2, 4194312);
      if ($$3 != 0) {
         fnm.a($$3, String.format(Locale.ROOT, "Loading glyph U+%06X", $$0));
      }
      ...
      if ($$4 == null) {
         ...
         float $$5 = fnm.a($$4.advance());
         FT_Bitmap $$6 = $$4.bitmap();
         int $$7 = $$4.bitmap_left();
         int $$8 = $$4.bitmap_top();
         int $$9 = $$6.width();
         int $$10 = $$6.rows();
         return (fbc)($$9 > 0 && $$10 > 0 ? new fbg.a((float)$$7, (float)$$8, $$9, $$10, $$5, $$2) : () -> $$5 / this.d);
      }
   }
   ...
   public void close() {
      if (this.c != null) {
         synchronized (fnm.a) {
            fnm.b(FreeType.FT_Done_Face(this.c), "Deleting face");
         }
      ...
      public fng bake(Function<fbe, fng> $$0) {
         return $$0.apply(new fbe() {
            ...
            public void a(int $$0, int $$1) {
               FT_Face $$2 = fbg.this.b();
               fce $$3 = new fce(fce.a.d, a.this.b, a.this.c, false);
               if ($$3.a($$2, a.this.g)) {
