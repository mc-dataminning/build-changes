...
public class akl {
   ...
   private static int a(du $$0, Collection<? extends cdm> $$1, int $$2) {
      for (cdm $$3 : $$1) {
         $$3.Y().ifPresent($$1x -> $$1x.a($$2));
      }

      if ($$1.size() == 1) {
         $$0.a(() -> ur.a("commands.warden_spawn_tracker.set.success.single", $$1.iterator().next().O_()), true);
      } else {
   ...
   private static int a(du $$0, Collection<? extends cdm> $$1) {
      for (cdm $$2 : $$1) {
         $$2.Y().ifPresent(ccs::b);
      }

      if ($$1.size() == 1) {
         $$0.a(() -> ur.a("commands.warden_spawn_tracker.clear.success.single", $$1.iterator().next().O_()), true);
      } else {
