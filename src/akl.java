...
public class akl {
   ...
   public static void a(CommandDispatcher<du> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a(
                     ...
                     .then(
                        ((LiteralArgumentBuilder)dv.a("step").then(dv.a("stop").executes($$0x -> b((du)$$0x.getSource()))))
                           .then(
                              dv.a("time", ff.a(1))
   ...
   private static String a(long $$0) {
      return String.format("%.1f", (float)$$0 / (float)aul.b);
   }
   ...
   private static int a(du $$0, float $$1) {
      ...
      $$0.a(() -> ur.a("commands.tick.rate.success", $$3), true);
      return (int)$$1;
   }
   ...
   private static int a(du $$0) {
      ...
      if ($$1.a()) {
         $$0.a(() -> ur.c("commands.tick.status.sprinting"), false);
         $$0.a(() -> ur.a("commands.tick.query.rate.sprinting", $$4, $$2), false);
      } else {
         if ($$1.l()) {
            $$0.a(() -> ur.c("commands.tick.status.frozen"), false);
         } else {
            $$0.a(() -> ur.c("commands.tick.status.running"), false);
         }

         String $$5 = a($$1.h());
         $$0.a(() -> ur.a("commands.tick.query.rate.running", $$4, $$2, $$5), false);
      }

      long[] $$6 = Arrays.copyOf($$0.m().aQ(), $$0.m().aQ().length);
      Arrays.sort($$6);
      String $$7 = a($$6[$$6.length / 2]);
      String $$8 = a($$6[(int)((double)$$6.length * 0.95)]);
      String $$9 = a($$6[(int)((double)$$6.length * 0.99)]);
      $$0.a(() -> ur.a("commands.tick.query.percentiles", $$7, $$8, $$9, $$6.length), false);
      return (int)$$3;
   }

   private static int a(du $$0, int $$1) {
      boolean $$2 = $$0.m().aO().b($$1);
      if ($$2) {
         $$0.a(() -> ur.c("commands.tick.sprint.stop.success"), true);
      }

      $$0.a(() -> ur.c("commands.tick.status.sprinting"), true);
      return 1;
   }
   ...
   private static int a(du $$0, boolean $$1) {
      ...
      $$2.a($$1);
      if ($$1) {
         $$0.a(() -> ur.c("commands.tick.status.frozen"), true);
      } else {
         $$0.a(() -> ur.c("commands.tick.status.running"), true);
      }
   ...
   private static int b(du $$0, int $$1) {
      ...
      boolean $$3 = $$2.a($$1);
      if ($$3) {
         $$0.a(() -> ur.a("commands.tick.step.success", $$1), true);
      } else {
         $$0.b(ur.c("commands.tick.step.fail"));
      }
   ...
   private static int b(du $$0) {
      ...
      boolean $$2 = $$1.b();
      if ($$2) {
         $$0.a(() -> ur.c("commands.tick.step.stop.success"), true);
         return 1;
      } else {
         $$0.b(ur.c("commands.tick.step.stop.fail"));
         return 0;
      }
   }
   ...
   private static int c(du $$0) {
      ...
      if ($$2) {
         ...
         $$0.b(ur.c("commands.tick.sprint.stop.fail"));
         return 0;
      }
   }
}
