...
public class fyj extends ftr {
   ...
   protected void aT_() {
      ...
      this.c(this.P);
      this.d(this.O);
      this.V = this.c(fny.a(E, fso.b(this, aza.o)).a(this.n / 2 - 100, 64 + this.l(), 200, 20).a());
      this.a(this.R);
      this.M.b(fny.a(xu.d, $$0x -> this.aP_()).a(200).a());
      this.M.a($$1x -> {
   ...
   public void b(fnl $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      int $$4 = this.F() + 3;
      $$0.a(glo::B, d, $$4, 64, 236, this.l() + 16);
      $$0.a(glo::B, s, $$4 + 10, 76, 12, 12);
   }
