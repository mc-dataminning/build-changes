public class cbi implements cbe {
   ...
   public void a() {
      if (this.k == cbi.a.c) {
         ...
         $$2 *= $$4;
         $$3 *= $$4;
         float $$5 = ayz.a(this.d.dL() * (float) (Math.PI / 180.0));
         float $$6 = ayz.b(this.d.dL() * (float) (Math.PI / 180.0));
         float $$7 = $$2 * $$6 - $$3 * $$5;
         float $$8 = $$3 * $$6 + $$2 * $$5;
         if (!this.b($$7, $$8)) {
            this.i = 1.0F;
         ...
         ji $$14 = this.d.dv();
         dwx $$15 = this.d.dV().a_($$14);
         fbu $$16 = $$15.g(this.d.dV(), $$14);
         if ($$11 > (double)this.d.dP() && $$9 * $$9 + $$10 * $$10 < (double)Math.max(1.0F, this.d.dq())
            || !$$16.c() && this.d.dC() < $$16.c(jn.a.b) + (double)$$14.v() && !$$15.a(awp.q) && !$$15.a(awp.U)) {
            this.d.O().a();
            this.k = cbi.a.d;
         }
      } else if (this.k == cbi.a.d) {
         this.d.C((float)(this.h * this.d.h(bwp.v)));
         if (this.d.aJ()) {
            this.k = cbi.a.a;
         }
   ...
   private boolean b(float $$0, float $$1) {
      ...
      if ($$2 != null) {
         etm $$3 = $$2.n();
         if ($$3 != null && $$3.a(this.d, ji.a(this.d.dA() + (double)$$0, (double)this.d.dB(), this.d.dG() + (double)$$1)) != etq.c) {
            return false;
         }
      }
