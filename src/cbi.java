public class cbi implements cbe {
   ...
   public void a() {
      if (this.k == cbi.a.c) {
         ...
         jh $$14 = this.d.dv();
         dvv $$15 = this.d.dV().a_($$14);
         fas $$16 = $$15.g(this.d.dV(), $$14);
         if ($$11 > (double)this.d.dP() && $$9 * $$9 + $$10 * $$10 < (double)Math.max(1.0F, this.d.dq())
            || !$$16.c() && this.d.dC() < $$16.c(jm.a.b) + (double)$$14.v() && !$$15.a(axc.q) && !$$15.a(axc.T)) {
            this.d.J().a();
            this.k = cbi.a.d;
         }
   ...
   private boolean b(float $$0, float $$1) {
      ...
      if ($$2 != null) {
         esi $$3 = $$2.p();
         if ($$3 != null && $$3.a(this.d, jh.a(this.d.dA() + (double)$$0, (double)this.d.dB(), this.d.dG() + (double)$$1)) != esm.c) {
            return false;
         }
      }
