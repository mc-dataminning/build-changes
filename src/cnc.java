...
public record cnc(cnc.a d) {
   ...
   public static final Codec<cnc> c = cnc.a.a.xmap(cnc::new, cnc::b);

   public static cnc a(azm $$0, UUID $$1, cnc.a $$2) throws cnc.b {
      if (!$$2.a($$0, $$1)) {
         throw new cnc.b(e);
      } else {
         return new cnc($$2);
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cnc.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  ayh.o.fieldOf("expires_at").forGetter(cnc.a::b), axw.f.fieldOf("key").forGetter(cnc.a::c), ayh.p.fieldOf("signature_v2").forGetter(cnc.a::d)
               )
               .apply($$0, cnc.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof cnc.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
