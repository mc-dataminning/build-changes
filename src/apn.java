...
public class apn {
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a("time").requires($$0x -> $$0x.c(2)))
                  .then(
                     ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a("set")
                        ...
                        .then(ey.a("time", gn.a()).executes($$0x -> a((ex)$$0x.getSource(), IntegerArgumentType.getInteger($$0x, "time"))))
                  ))
               .then(ey.a("add").then(ey.a("time", gn.a()).executes($$0x -> b((ex)$$0x.getSource(), IntegerArgumentType.getInteger($$0x, "time"))))))
            .then(
               ((LiteralArgumentBuilder)((LiteralArgumentBuilder)ey.a("query")
                     ...
                     .then(ey.a("gametime").executes($$0x -> c((ex)$$0x.getSource(), (int)(((ex)$$0x.getSource()).e().ae() % 2147483647L)))))
                  .then(ey.a("day").executes($$0x -> c((ex)$$0x.getSource(), (int)(((ex)$$0x.getSource()).e().af() / 24000L % 2147483647L))))
            )
      );
   }
   ...
   private static int c(ex $$0, int $$1) {
      $$0.a(() -> wv.a("commands.time.query", $$1), false);
      return $$1;
   }
   ...
   public static int a(ex $$0, int $$1) {
      ...
      $$0.l().H();
      $$0.a(() -> wv.a("commands.time.set", $$1), true);
      return a($$0.e());
   }
   ...
   public static int b(ex $$0, int $$1) {
      ...
      $$0.l().H();
      int $$3 = a($$0.e());
      $$0.a(() -> wv.a("commands.time.set", $$3), true);
      return $$3;
   }
}
