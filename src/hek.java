...
public class hek {
   ...
   public static CompletableFuture<akv> a(akv $$0, Path $$1, String $$2, boolean $$3) {
      return CompletableFuture.<fet>supplyAsync(() -> {
         fet $$3x;
         try {
            $$3x = a($$1, $$2);
   ...
   private static fet a(Path $$0, String $$1) throws IOException {
      if (Files.isRegularFile($$0)) {
         ...
         fet $$7;
         try {
            $$3 = (HttpURLConnection)$$4.toURL().openConnection(fli.Q().Z());
            $$3.setDoInput(true);
            $$3.setDoOutput(false);
            $$3.connect();
   ...
   private static CompletableFuture<akv> a(akv $$0, fet $$1) {
      fli $$2 = fli.Q();
   ...
   private static fet a(fet $$0, String $$1) {
      int $$2 = $$0.b();
      int $$3 = $$0.a();
      if ($$3 == 64 && ($$2 == 32 || $$2 == 64)) {
         boolean $$4 = $$2 == 32;
         if ($$4) {
            fet $$5 = new fet(64, 64, true);
            $$5.a($$0);
            $$0.close();
            $$0 = $$5;
            $$5.a(0, 32, 64, 32, 0);
   ...
   private static void a(fet $$0, int $$1, int $$2, int $$3, int $$4) {
      for (int $$5 = $$1; $$5 < $$3; $$5++) {
         for (int $$6 = $$2; $$6 < $$4; $$6++) {
            int $$7 = $$0.a($$5, $$6);
            if (axk.a($$7) < 128) {
   ...
   private static void b(fet $$0, int $$1, int $$2, int $$3, int $$4) {
      for (int $$5 = $$1; $$5 < $$3; $$5++) {
         for (int $$6 = $$2; $$6 < $$4; $$6++) {
