...
public class vt implements uj {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = asg.a(asg.b, vt::b);
   private static final Codec<Object> e = Codec.either(d, uk.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof ui $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<vt> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               asg.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, vt::a)
   );
   public static final uj.a<vt> c = new uj.a<>(b, "translatable");
   private static final un f = un.e("%");
   private static final un g = un.e("null");
   ...
   @Nullable
   private ro k;
   private List<un> l = ImmutableList.of();
   ...
   private static vt a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new vt($$0, $$1.orElse(null), a($$2));
   }

   public vt(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<un> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (vu var4) {
            this.l = ImmutableList.of(un.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<un> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new vu(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private un a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof ui) {
            ...
            return $$1 == null ? g : un.e($$1.toString());
         }
      } else {
         throw new vu(this, $$0);
      }
   ...
   public uw a(@Nullable du $$0, @Nullable bjt $$1, int $$2) throws CommandSyntaxException {
      ...
      return uw.a(new vt(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof vt $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
