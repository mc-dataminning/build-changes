...
public class vt extends SimpleChannelInboundHandler<zh<?>> {
   ...
   private static final wi<ajb> j = aja.b;
   private final zi k;
   ...
   @Nullable
   private volatile wg p;
   @Nullable
   private volatile wg q;
   @Nullable
   private vv r;
   private boolean s;
   private boolean t;
   ...
   public void channelInactive(ChannelHandlerContext $$0) {
      this.a(xa.c("disconnect.endOfStream"));
   }
      ...
      if ($$1 instanceof wn) {
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               i.debug("Timeout", $$1);
               this.a(xa.c("disconnect.timeout"));
            } else {
               xa $$3 = xa.a("disconnect.genericReason", "Internal Exception: " + $$1);
               wg $$4 = this.q;
               vv $$5;
               if ($$4 != null) {
                  $$5 = $$4.a($$3, $$1);
               ...
               if ($$2) {
                  ...
                  if (this.g() == zi.b) {
                     zh<?> $$7 = (zh<?>)(this.l ? new ajh($$3) : new zq($$3));
                     this.a($$7, wh.a(() -> this.a($$5)));
                  } else {
                     this.a($$5);
                  }
   ...
   protected void a(ChannelHandlerContext $$0, zh<?> $$1) {
      if (this.n.isOpen()) {
         wg $$2 = this.q;
         if ($$2 == null) {
            ...
            if ($$2.a($$1)) {
               try {
                  ...
                  this.a(xa.c("multiplayer.disconnect.server_shutdown"));
               } catch (ClassCastException var7) {
                  i.error("Received {} that couldn't be processed", $$1.getClass(), var7);
                  this.a(xa.c("multiplayer.disconnect.invalid_packet"));
               }
   ...
   private static <T extends wg> void a(zh<T> $$0, wg $$1) {
      $$0.a((T)$$1);
   }

   private void b(wi<?> $$0, wg $$1) {
   ...
   public <T extends wg> void a(wi<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(wg $$0) {
      ...
      } else if (this.k == zi.a && $$0.a() == zi.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public <S extends wm, C extends vq> void a(String $$0, int $$1, wi<S> $$2, wi<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? aix.c : aix.b);
   }

   private <S extends wm, C extends vq> void a(String $$0, int $$1, wi<S> $$2, wi<C> $$3, C $$4, aix $$5) {
      if ($$2.a() != $$3.a()) {
         ...
         this.a((Consumer<vt>)($$6 -> {
            this.a($$3, $$4);
            $$6.b(new aiy(ac.b().e(), $$0, $$1, $$5), null, true);
            this.a($$2);
         }));
      }
   }
   ...
   public void a(zh<?> $$0, @Nullable wh $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(zh<?> $$0, @Nullable wh $$1, boolean $$2) {
      this.v++;
   ...
   private void c(zh<?> $$0, @Nullable wh $$1, boolean $$2) {
   ...
   protected void c() {
      this.x = azo.h(0.75F, (float)this.v, this.x);
      this.w = azo.h(0.75F, (float)this.u, this.w);
      this.v = 0;
      this.u = 0;
   }
   ...
   public static vt a(InetSocketAddress $$0, boolean $$1, @Nullable bpc $$2) {
      vt $$3 = new vt(zi.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static void a(ChannelPipeline $$0, zi $$1, boolean $$2, @Nullable vm $$3) {
      zi $$4 = $$1.a();
      boolean $$5 = $$1 == zi.a;
      boolean $$6 = $$4 == zi.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new we<ajb>(j) : new wp.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wf<ajb>(j) : new wp.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new wa() : new wu());
   }
   ...
   private static ChannelInboundHandler a(@Nullable vm $$0, boolean $$1) {
      if (!$$1) {
         ...
         return (ChannelInboundHandler)($$0 != null ? new wb($$0) : new vz());
      }
   }

   public static void a(ChannelPipeline $$0, zi $$1) {
      a($$0, $$1, true, null);
   }

   public static vt a(SocketAddress $$0) {
      final vt $$1 = new vt(zi.b);
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            wg $$0 = this.k();
            wg $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               vv $$2 = Objects.requireNonNullElseGet(this.l(), () -> new vv(xa.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
