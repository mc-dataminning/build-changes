...
public class ajc implements Comparable<ajc> {
   public static final Codec<ajc> a = Codec.STRING.comapFlatMap(ajc::b, ajc::toString).stable();
   public static final xq<ByteBuf, ajc> b = xo.i.a(ajc::new, ajc::toString);
   private static final SimpleCommandExceptionType f = new SimpleCommandExceptionType(vs.c("argument.id.invalid"));
   ...
   protected ajc(String $$0, String $$1, @Nullable ajc.a $$2) {
      this.g = $$0;
      this.h = $$1;
   }

   public ajc(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private ajc(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static ajc a(String $$0, char $$1) {
      return new ajc(b($$0, $$1));
   }
   ...
   @Nullable
   public static ajc a(String $$0, String $$1) {
      try {
         return new ajc($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<ajc> b(String $$0) {
      try {
         return DataResult.success(new ajc($$0));
      } catch (z var2) {
   ...
   public ajc c(String $$0) {
      return new ajc(this.g, d(this.g, $$0), null);
   }

   public ajc a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.h));
   }

   public ajc d(String $$0) {
      return this.c($$0 + this.h);
   }

   public ajc e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof ajc $$1) ? false : this.g.equals($$1.g) && this.h.equals($$1.h);
      }
   }
   ...
   public static ajc a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<ajc>, JsonSerializer<ajc> {
      public ajc a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new ajc(awc.a($$0, "location"));
      }

      public JsonElement a(ajc $$0, Type $$1, JsonSerializationContext $$2) {
