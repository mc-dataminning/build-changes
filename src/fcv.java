...
public enum fcv {
   ...
   private fcv(final String... $$0) {
      this.c = $$0;
   }

   public List<aus<InputStream>> a(atm $$0) throws IOException {
      return List.of(
   ...
   public aus<InputStream> b(atm $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private aus<InputStream> a(atm $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      aus<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
