...
public class fcv extends fcz {
   ...
   protected void aN_() {
      ...
      this.x = new exn(this.i, 50, 40, this.g - 100, 20, this.t);
      this.x.f(1230);
      fhx $$0 = this.r.a.n().k();
      iu $$1 = $$0.a();
      chr $$2 = $$0.g().b();
      ...
      this.y = this.r.m();
      this.e(this.x);
      this.v = this.d(new fcv.a($$1, $$2));
      this.w = this.d(exe.a(vf.c("createWorld.customize.presets.select"), $$4x -> {
         dxi $$5x = a($$6, $$3, $$4, $$5, this.x.a(), this.y);
         this.r.a($$5x);
         this.f.a(this.r);
      }).a(this.g / 2 - 155, this.h - 28, 150, 20).a());
      this.d(exe.a(ve.e, $$0x -> this.f.a(this.r)).a(this.g / 2 + 5, this.h - 28, 150, 20).a());
   ...
   class a extends eya<fcv.a.a> {
      public a(iu $$0, chr $$1) {
         super(fcv.this.f, fcv.this.g, fcv.this.h - 117, 80, 24);
         ...
         for (ih<dxg> $$2 : $$0.d(ke.az).c(ask.a)) {
            ...
            if (!$$3.isEmpty()) {
               ...
               this.b(new fcv.a.a($$2));
            }
         }
      }

      public void a(@Nullable fcv.a.a $$0) {
         super.a($$0);
         fcv.this.c($$0 != null);
      }
      ...
      public class a extends eya.a<fcv.a.a> {
         ...
         public a(ih<dxg> $$1) {
            this.c = $$1.a();
            this.d = $$1.e().map($$0x -> vf.c($$0x.a().f("flat_world_preset"))).orElse(fcv.a);
         }

         @Override
         public void a(ews $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            this.a($$0, $$3, $$2, this.c.a().a());
            $$0.a(fcv.this.i, this.d, $$3 + 18 + 5, $$2 + 6, 16777215, false);
         }
         ...
         void b() {
            a.this.a(this);
            fcv.this.y = this.c.b();
            fcv.this.x.a(fcv.a(fcv.this.y));
            fcv.this.x.b(false);
         }

         private void a(ews $$0, int $$1, int $$2, cms $$3) {
            this.a($$0, $$1 + 1, $$2 + 1);
            $$0.b(new cmx($$3), $$1 + 2, $$2 + 2);
         }

         private void a(ews $$0, int $$1, int $$2) {
            $$0.a(fcv.b, $$1, $$2, 0, 18, 18);
         }
