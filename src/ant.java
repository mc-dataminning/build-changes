...
public class ant extends anp {
   static final Logger c = LogUtils.getLogger();
   private final ant.b d;
   private final String e;

   ant(String $$0, ant.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(anw $$0, agi $$1) {
   ...
   @Nullable
   private aoz<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : aoz.create($$1, $$2);
      }
   }
   ...
   public static class a implements aop.c {
      ...
      @Override
      public anv a(String $$0) {
         ant.b $$1 = new ant.b(this.a);
         return new ant($$0, $$1, this.b, "");
      }

      @Override
      public anv a(String $$0, aop.a $$1) {
         ant.b $$2 = new ant.b(this.a);
         anv $$3 = new ant($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<anv> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new ant($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  ant.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
