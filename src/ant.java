...
public class ant {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(wo.c("commands.particle.failed"));
   ...
   private static int a(ex $$0, lr $$1, fay $$2, fay $$3, float $$4, int $$5, boolean $$6, Collection<ard> $$7) throws CommandSyntaxException {
      ...
      if ($$8 == 0) {
         ...
         $$0.a(() -> wo.a("commands.particle.success", mb.i.b($$1.a()).toString()), true);
         return $$8;
      }
   }
}
