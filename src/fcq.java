...
public class fcq extends gvi {
   ...
   private fhg Y;
   private boolean Z;
   private final List<fcj> aa = Lists.newArrayList();

   public fcq(fal $$0, long $$1) {
      super(E);
      this.N = $$0;
      this.P = $$1;
   }
   ...
   public void aM_() {
      ...
      this.Q = this.n / 2 - 187;
      this.R = this.n / 2 + 190;
      this.S = this.c(fhg.a(xp.c("mco.configure.world.buttons.players"), $$0x -> this.m.a(new fdc(this, this.O))).a(this.a(0, 3), g(0), 100, 20).a());
      this.T = this.c(fhg.a(xp.c("mco.configure.world.buttons.settings"), $$0x -> this.m.a(new fdi(this, this.O.g()))).a(this.a(1, 3), g(0), 100, 20).a());
      this.U = this.c(
         fhg.a(xp.c("mco.configure.world.buttons.subscription"), $$0x -> this.m.a(new fdk(this, this.O.g(), this.N))).a(this.a(2, 3), g(0), 100, 20).a()
      );
      this.aa.clear();
      ...
      this.Y = this.c(
         fhg.a(xp.c("mco.configure.world.buttons.switchminigame"), $$0x -> this.m.a(new fdh(xp.c("mco.template.title.minigame"), this::a, fbh.d.b)))
            .a(this.b(0), g(13) - 5, 100, 20)
            .a()
      );
      this.V = this.c(
         fhg.a(xp.c("mco.configure.world.buttons.options"), $$0x -> this.m.a(new fdj(this, this.O.i.get(this.O.n).d(), this.O.m, this.O.n)))
            .a(this.b(0), g(13) - 5, 90, 20)
            .a()
      );
      this.W = this.c(fhg.a(xp.c("mco.configure.world.backup"), $$0x -> this.m.a(new fcn(this, this.O.g(), this.O.n))).a(this.b(1), g(13) - 5, 90, 20).a());
      this.X = this.c(
         fhg.a(xp.c("mco.configure.world.buttons.resetworld"), $$0x -> this.m.a(fdf.a(this, this.O.g(), () -> this.m.execute(() -> this.m.a(this.f())))))
            .a(this.b(2), g(13) - 5, 90, 20)
            .a()
      );
      this.c(fhg.a(xo.k, $$0x -> this.d()).a(this.R - 80 + 8, g(13) - 5, 70, 20).a());
      this.W.j = true;
      if (this.O == null) {
         this.K();
         this.J();
   ...
   public void a(fgt $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.O == null) {
         ...
         String $$4 = this.O.b();
         int $$5 = this.p.b($$4);
         int $$6 = this.O.e == fbh.c.a ? -6250336 : 8388479;
   ...
   private void a(long $$0) {
      new Thread(() -> {
         ...
         try {
            ...
            this.m.execute(() -> this.m.a(new fcu(var5, this.N)));
         }
      }).start();
   }
   ...
   private void a(fbh $$0) {
      if (this.O.e == fbh.c.b) {
         fal.a($$0, new fcq(this.N, this.P));
      } else {
         this.a(true, new fcq(this.N, this.P));
      }
   }

   private void F() {
      fdh $$0 = new fdh(xp.c("mco.template.title.minigame"), this::a, fbh.d.b);
      $$0.a(xp.c("mco.minigame.world.info.line1"), xp.c("mco.minigame.world.info.line2"));
      this.m.a($$0);
   }

   private void a(int $$0, fbh $$1) {
      xp $$2 = xp.c("mco.configure.world.slot.switch.question.line1");
      xp $$3 = xp.c("mco.configure.world.slot.switch.question.line2");
      this.m.a(new fcw($$2x -> {
         if ($$2x) {
            this.b();
            this.m.a(new fcx(this.N, new fep($$1.a, $$0, () -> this.m.execute(() -> this.m.a(this.f())))));
         } else {
            this.m.a(this);
         }
      }, fcw.a.b, $$2, $$3, true));
   ...
   private void b(int $$0, fbh $$1) {
      xp $$2 = xp.c("mco.configure.world.slot.switch.question.line1");
      xp $$3 = xp.c("mco.configure.world.slot.switch.question.line2");
      this.m.a(new fcw($$2x -> {
         if ($$2x) {
            this.b();
            fdf $$3x = fdf.a(this, $$0, $$1, () -> this.m.execute(() -> this.m.a(this.f())));
            this.m.a($$3x);
         } else {
            this.m.a(this);
         }
   ...
   private void b(fgt $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      } else if (this.O.e == fbh.c.a) {
         this.a($$0, $$1, $$2, $$3, $$4, B, () -> J);
      } else if (this.O.e == fbh.c.b) {
         if (this.O.l < 7) {
            this.a($$0, $$1, $$2, $$3, $$4, b, () -> {
               if (this.O.l <= 0) {
                  return G;
   ...
   private boolean I() {
      return this.O != null && this.O.m == fbh.d.b;
   }
   ...
   public void a(boolean $$0, fnf $$1) {
      this.m.a(new fcx($$1, new fei(this.O, this, $$0, this.m)));
   }

   public void a(fnf $$0) {
      this.m.a(new fcx($$0, new fec(this.O, this)));
   }
   ...
   private void a(@Nullable fby $$0) {
      if ($$0 != null && fby.a.b == $$0.i) {
         this.b();
         this.m.a(new fcx(this.N, new feo(this.O.a, $$0, this.f())));
      } else {
         this.m.a(this);
      }
   }
