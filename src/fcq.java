...
public class fcq {
   private static final agt a = new agt("advancements/title_box");
   ...
   private final atk r;
   private final int s;
   private final List<atk> t;
   private final euk u;
   @Nullable
   private fcq v;
   private final List<fcq> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fcq(fco $$0, euk $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = se.a().a($$1.h.a($$3.a(), 163));
      this.y = aty.d($$3.f() * 28.0F);
      this.z = aty.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = se.a().a(this.a(ve.a($$3.b().f(), vy.a.a($$3.e().a())), $$7));
   ...
   private static float a(euw $$0, List<vg> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<vg> a(vb $$0, int $$1) {
      euw $$2 = this.u.h.b();
      List<vg> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<vg> $$6 = $$2.b($$0, $$1 - $$5, vy.a);
