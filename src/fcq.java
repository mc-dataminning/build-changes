...
public class fcq extends fda {
      ...
      try {
         ...
         if (aye.d($$3, "lists")) {
            for (JsonElement $$5 : $$3.getAsJsonArray("lists")) {
               ...
               String $$7 = fex.b("playerList", $$6, null);
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fgm.Q().al();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fex.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fgm.Q().b($$4)) {
               try {
