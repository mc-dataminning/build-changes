...
public class fcq extends gvf {
   ...
   public fcq(fnc $$0, fbu $$1, String $$2, BooleanConsumer $$3) {
      super(few.a);
      this.Z = $$3;
      this.E = $$0;
      this.J = $$2;
   ...
   private void E() {
      if (!this.Q) {
         if (!this.Y && this.a(this.F.a) >= 5368709120L) {
            xo $$0 = xo.a("mco.download.confirmation.line1", faj.b(5368709120L));
   ...
   private xo F() {
      ...
      if (this.N != null) {
         ...
         $$0.add(xo.a("mco.download.speed.narration", faj.b(this.U)));
      }
   ...
   private void a(fgq $$0, long $$1) {
      if ($$1 > 0L) {
         ...
         $$0.a(this.p, xo.a("mco.download.speed", faj.b($$1)), this.n / 2 + $$2 / 2 + 15, 84, -1, false);
      }
   }
