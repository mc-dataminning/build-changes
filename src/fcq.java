...
public class fcq implements gns {
   private static final long a = 3000L;
   private final ezi b;
   private final List<fcq.a> c = Lists.newArrayList();
   private boolean d;
   private final List<fcq.a> e = new ArrayList<>();
   ...
   public void a(fav $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fcq.a> $$10 = this.e.iterator();
   ...
   @Override
   public void a(gmp $$0, gnu $$1, float $$2) {
      if ($$1.a() != null) {
         vu $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fcq.a $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.a(new ept($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fcq.a($$3, $$2, new ept($$0.h(), $$0.i(), $$0.j())));
      }
   }
