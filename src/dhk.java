...
public class dhk {
   ...
   private static CompletableFuture<Either<dhf, ajy.a>> a(akt $$0, dhf $$1) {
      $$1.A();
      ((dia)$$1).a($$0);
      boolean $$2 = a($$1);
   ...
   private static CompletableFuture<Either<dhf, ajy.a>> b(akt $$0, dhf $$1) {
      boolean $$2 = a($$1);
   ...
   private static dhk a(String $$0, @Nullable dhk $$1, int $$2, boolean $$3, EnumSet<dks.a> $$4, dhk.a $$5, dhk.b $$6, dhk.c $$7) {
      return hq.a(jb.o, $$0, new dhk($$1, $$2, $$3, $$4, $$5, $$6, $$7));
   }
   ...
   public CompletableFuture<Either<dhf, ajy.a>> a(
      Executor $$0, akq $$1, dhg $$2, dzc $$3, akt $$4, Function<dhf, CompletableFuture<Either<dhf, ajy.a>>> $$5, List<dhf> $$6
   ) {
   ...
   public CompletableFuture<Either<dhf, ajy.a>> a(akq $$0, dzc $$1, akt $$2, Function<dhf, CompletableFuture<Either<dhf, ajy.a>>> $$3, dhf $$4) {
   ...
   interface b {
      CompletableFuture<Either<dhf, ajy.a>> doWork(
         dhk var1, Executor var2, akq var3, dhg var4, dzc var5, akt var6, Function<dhf, CompletableFuture<Either<dhf, ajy.a>>> var7, List<dhf> var8, dhf var9
      );
   }

   interface c {
      CompletableFuture<Either<dhf, ajy.a>> doWork(dhk var1, akq var2, dzc var3, akt var4, Function<dhf, CompletableFuture<Either<dhf, ajy.a>>> var5, dhf var6);
   }

   interface d extends dhk.b {
      @Override
      default CompletableFuture<Either<dhf, ajy.a>> doWork(
         dhk $$0, Executor $$1, akq $$2, dhg $$3, dzc $$4, akt $$5, Function<dhf, CompletableFuture<Either<dhf, ajy.a>>> $$6, List<dhf> $$7, dhf $$8
      ) {
         this.doWork($$0, $$2, $$3, $$7, $$8);
         return CompletableFuture.completedFuture(Either.left($$8));
      }

      void doWork(dhk var1, akq var2, dhg var3, List<dhf> var4, dhf var5);
   }
}
