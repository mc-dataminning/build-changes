...
public class dhk {
   ...
   public static void a(ddx $$0, Set<dhk.a> $$1) {
      int $$2 = $$1.size();
      ObjectList<dhk> $$3 = new ObjectArrayList($$2);
      ObjectListIterator<dhk> $$4 = $$3.iterator();
      int $$5 = $$0.b() + 16;
      gu.a $$6 = new gu.a();
   ...
   public void a(ddx $$0, dhk.a $$1, long[] $$2) {
      long[] $$3 = this.d.a();
   ...
   public static enum a implements apr {
      a("WORLD_SURFACE_WG", dhk.b.a, dhk.b),
      b("WORLD_SURFACE", dhk.b.c, dhk.b),
      c("OCEAN_FLOOR_WG", dhk.b.a, dhk.c),
      d("OCEAN_FLOOR", dhk.b.b, dhk.c),
      e("MOTION_BLOCKING", dhk.b.c, $$0 -> $$0.d() || !$$0.u().c()),
      f("MOTION_BLOCKING_NO_LEAVES", dhk.b.b, $$0 -> ($$0.d() || !$$0.u().c()) && !($$0.b() instanceof ctu));

      public static final Codec<dhk.a> g = apr.a(dhk.a::values);
      private final String h;
      private final dhk.b i;
      private final Predicate<dcb> j;

      private a(String $$0, dhk.b $$1, Predicate<dcb> $$2) {
         this.h = $$0;
         this.i = $$1;
         this.j = $$2;
      }
