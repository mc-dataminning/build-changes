...
public class fma extends fmb {
   ...
   public fma(BooleanConsumer $$0, String $$1, boolean $$2) {
      this($$0, c($$2), wu.b($$1), $$1, $$2 ? wt.e : wt.g, $$2);
   }

   public fma(BooleanConsumer $$0, wu $$1, String $$2, boolean $$3) {
      this($$0, $$1, a($$3, $$2), $$2, $$3 ? wt.e : wt.g, $$3);
   }

   public fma(BooleanConsumer $$0, wu $$1, wu $$2, String $$3, wu $$4, boolean $$5) {
      super($$0, $$1, $$2);
   ...
   protected void a(int $$0) {
      this.c(fhm.a(this.a, $$0x -> this.c.accept(true)).a(this.m / 2 - 50 - 105, $$0, 100, 20).a());
      this.c(fhm.a(q, $$0x -> {
         this.l();
         this.c.accept(false);
      }).a(this.m / 2 - 50, $$0, 100, 20).a());
      this.c(fhm.a(this.b, $$0x -> this.c.accept(false)).a(this.m / 2 - 50 + 105, $$0, 100, 20).a());
   }
   ...
   public static fhm.c b(fnd $$0, String $$1) {
      return $$2 -> a($$0, $$1);
   }
}
