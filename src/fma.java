...
public class fma {
   ...
   private int k;
   private double l;
   private final bav m = new bav();
   private final bav n = new bav();
   private double o;
   private double p;
   private final fmi q;
      ...
      if ($$0 == this.b.aO().h()) {
         ...
         if (this.b.aM() == null) {
            if (this.b.z == null) {
               ...
               if ($$4) {
                  $$9.v();
                  ftr.a(() -> $$6[0] = $$9.a($$7, $$8, $$5), "mouseClicked event handler", $$9.getClass().getCanonicalName());
               } else {
                  ftr.a(() -> $$6[0] = $$9.b($$7, $$8, $$5), "mouseReleased event handler", $$9.getClass().getCanonicalName());
               }
            }
         }
            ...
            if (this.b.z != null) {
               ...
               if (this.b.t.aa_()) {
                  if (this.b.m.g().a()) {
                     ...
                     float $$11 = bae.a(this.b.t.gh().a() + (float)$$9.y * 0.005F, 0.0F, 0.2F);
                     this.b.t.gh().a($$11);
                  }
               } else {
                  cpr $$12 = this.b.t.gg();
                  $$12.e(fmi.a((double)$$10, $$12.j, cpr.g()));
               }
            }
         }
      }
   ...
   public void a() {
      ...
      if (this.b.aC()) {
         ...
         if ($$2 != null && this.b.aM() == null && $$3) {
            ...
            ftr.a(() -> $$2.f($$4, $$5), "mouseMoved event handler", $$2.getClass().getCanonicalName());
            if (this.i != -1 && this.l > 0.0) {
               ...
               ftr.a(() -> $$2.a($$4, $$5, this.i, $$6, $$7), "mouseDragged event handler", $$2.getClass().getCanonicalName());
            }
   ...
   private void a(double $$0) {
      ...
      if (this.b.n.Z) {
         ...
         $$6 = $$4;
         $$7 = $$5;
      } else if (this.b.n.aE().a() && this.b.t.gF()) {
         this.m.a();
         this.n.a();
         $$6 = this.o * $$2;
         $$7 = this.p * $$2;
   ...
   public void i() {
      if (this.b.aC()) {
         if (!this.s) {
            ...
            ffg.a(this.b.aO().h(), 212995, this.f, this.g);
            this.b.a(null);
            this.b.x = 10000;
            this.j = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.f = (double)(this.b.aO().m() / 2);
         this.g = (double)(this.b.aO().n() / 2);
         ffg.a(this.b.aO().h(), 212993, this.f, this.g);
      }
   }
