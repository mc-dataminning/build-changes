...
public class zt {
   ...
   public static <T extends wp> void a(zq<T> $$0, T $$1, arp $$2) throws alv {
      a($$0, $$1, $$2.p());
   }

   public static <T extends wp> void a(zq<T> $$0, T $$1, bqz<?> $$2) throws alv {
      if (!$$2.bx()) {
         $$2.c(() -> {
            if ($$1.a($$0)) {
               try {
   ...
   public static <T extends wp> z a(Exception $$0, zq<T> $$1, T $$2) {
      if ($$0 instanceof z $$3) {
         a($$3.a(), $$2, $$1);
         return $$3;
      } else {
   ...
   public static <T extends wp> void a(o $$0, T $$1, @Nullable zq<T> $$2) {
      if ($$2 != null) {
