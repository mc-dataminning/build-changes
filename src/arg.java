...
public class arg {
   ...
   final List<vs> g = Collections.synchronizedList(Lists.newArrayList());

   public arg(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (arg.this.e.an()) {
                  $$1.addLast("legacy_query", new arb(arg.this.d()));
               }

               vs.a($$1, zc.a, null);
               int $$2 = arg.this.e.o();
               vs $$3 = (vs)($$2 > 0 ? new we($$2) : new vs(zc.a));
               arg.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new ari(arg.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     wu $$3 = wu.b("Internal server error");
                     $$1.a(new zj($$3), wb.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<arg.a.a> d = Lists.newArrayList();
