...
public class arg {
   ...
   private static void a(ark $$0, aqk $$1, dun $$2) {
      $$0.b(new acz($$2, $$1.y_(), null, null));
      dbk $$3 = $$2.f();
      afy.a($$1, $$3);
   }

   private List<dun> a(apt $$0, dbk $$1) {
      int $$2 = aye.d(this.i);
      List<dun> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : aye.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
