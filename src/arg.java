...
public class arg extends ChannelInboundHandlerAdapter {
   ...
   private static String a(ala $$0) {
      return String.format(Locale.ROOT, "%s§%d§%d", $$0.ag(), $$0.N(), $$0.O());
   }

   private static String b(ala $$0) {
      return String.format(Locale.ROOT, "§1\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", 127, $$0.M(), $$0.ag(), $$0.N(), $$0.O());
   }
