...
public abstract class ewj {
   ...
   public evl a() {
      if (this.c()) {
         ...
         return new evl(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
      }
   }

   public ewj b() {
      return this.c() ? ewg.a() : ewg.a(this.b(je.a.a), this.b(je.a.b), this.b(je.a.c), this.c(je.a.a), this.c(je.a.b), this.c(je.a.c));
   }
   ...
   public ewj a(double $$0, double $$1, double $$2) {
      return (ewj)(this.c() ? ewg.a() : new evs(this.a, new ewf(this.a(je.a.a), $$0), new ewf(this.a(je.a.b), $$1), new ewf(this.a(je.a.c), $$2)));
   }

   public ewj d() {
      ewj[] $$0 = new ewj[]{ewg.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ewg.b($$0[0], ewg.a($$1, $$2, $$3, $$4, $$5, $$6), evu.o));
      return $$0[0];
   }

   public void a(ewg.a $$0) {
      this.a
         .a(
   ...
   public List<evl> e() {
      List<evl> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new evl($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(je.a $$0, double $$1) {
      return ayy.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public evm a(evq $$0, evq $$1, iz $$2) {
      if (this.c()) {
         return null;
      } else {
         evq $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.e(this.a(je.a.a, $$4.c - (double)$$2.u()), this.a(je.a.b, $$4.d - (double)$$2.v()), this.a(je.a.c, $$4.e - (double)$$2.w()))
               ? new evm($$4, je.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : evl.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<evq> a(evq $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         evq[] $$1 = new evq[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = ayy.a($$0.a(), $$2, $$5);
            double $$9 = ayy.a($$0.b(), $$3, $$6);
            double $$10 = ayy.a($$0.c(), $$4, $$7);
   ...
   public ewj a(je $$0) {
      if (!this.c() && this != ewg.b()) {
         if (this.b != null) {
            ewj $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ewj b(je $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ewh(this, $$1, $$4);
      }
   }

   public double a(je.a $$0, evl $$1, double $$2) {
      return this.a(iw.a($$0, je.a.a), $$1, $$2);
   }

   protected double a(iw $$0, evl $$1, double $$2) {
      if (this.c()) {
         return $$2;
