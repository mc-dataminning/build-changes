...
public class ewj implements ewe {
   protected static final ewe a = new ewj(false, -Double.MAX_VALUE, cua.l, $$0 -> false, null) {
      @Override
      public boolean a(ews $$0, ja $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected ewj(boolean $$0, double $$1, cua $$2, Predicate<eob> $$3, @Nullable bsd $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected ewj(bsd $$0) {
      ...
      // 00: aload 0
      // 01: aload 1
      // 02: invokevirtual bsd.bZ ()Z
      // 05: aload 1
      // 06: invokevirtual bsd.dw ()D
      // 09: aload 1
      // 0a: instanceof bsy
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast bsy
      // 14: invokevirtual bsy.eT ()Lcua;
      // 17: goto 1d
      // 1a: getstatic cua.l Lcua;
      // 1d: aload 1
      // 1e: instanceof bsy
      // 21: ifeq 35
      // 24: aload 1
