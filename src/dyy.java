...
public class dyy extends dxf implements dxi {
   ...
   protected void a(tz $$0, jg.a $$1) {
      ...
      try {
         this.k = dsz.valueOf($$0.l("rotation"));
      } catch (IllegalArgumentException var12) {
         this.k = dsz.a;
      }

      try {
         this.j = dri.valueOf($$0.l("mirror"));
      } catch (IllegalArgumentException var11) {
         this.j = dri.a;
      }

      try {
         this.l = ebr.valueOf($$0.l("mode"));
   ...
   public void a(ebr $$0) {
      this.l = $$0;
      eah $$1 = this.n.a_(this.ax_());
      if ($$1.a(dmh.pG)) {
         this.n.a(this.ax_(), $$1.b(dun.b, $$0), 2);
      }
   }
   ...
   private Stream<iu> a(iu $$0, iu $$1) {
      return iu.d($$0, $$1)
         .filter($$0x -> this.n.a_($$0x).a(dmh.pG))
         .map(this.n::c_)
         .filter($$0x -> $$0x instanceof dyy)
         .map($$0x -> (dyy)$$0x)
         .filter($$0x -> $$0x.l == ebr.c && Objects.equals(this.e, $$0x.e))
         .map(dxf::ax_);
   }

   private static Optional<eqt> a(iu $$0, Stream<iu> $$1) {
   ...
   public boolean B() {
      return this.l != ebr.a ? false : this.c(true);
   }

   public boolean c(boolean $$0) {
      if (this.e != null && this.n instanceof arq $$1) {
         iu var4 = this.ax_().a((jz)this.h);
   ...
   public boolean a(arq $$0) {
      if (this.l == ebr.b && this.e != null) {
         evd $$1 = $$0.r().b(this.e).orElse(null);
         if ($$1 == null) {
            return false;
   ...
   private void a(arq $$0, evd $$1) {
      this.a($$1);
      euz $$2 = new euz().a(this.j).a(this.k).a(this.m).b(this.q);
      if (this.u < 1.0F) {
         $$2.b().a(new eug(azm.a(this.u, 0.0F, 1.0F))).a(b(this.v));
      }

      iu $$3 = this.ax_().a((jz)this.h);
   ...
   public boolean D() {
      if (this.l == ebr.b && !this.n.C && this.e != null) {
         arq $$0 = (arq)this.n;
         eve $$1 = $$0.r();
   ...
   @Override
   public dxi.a b() {
      if (this.l != ebr.a && this.l != ebr.b) {
         return dxi.a.a;
      } else if (this.l == ebr.a && this.s) {
         return dxi.a.c;
      } else {
         return this.l != ebr.a && !this.t ? dxi.a.a : dxi.a.b;
      }
   }
   ...
   public dxi.b c() {
      ...
      return dxi.b.a($$24, $$4, $$25, $$26, $$5, $$27);
   }
