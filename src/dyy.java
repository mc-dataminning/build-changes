...
public class dyy {
   ...
   private final dcb p;
   private static final List<dfa> q = List.of(dfc.l, dfc.L, dfc.i, dfc.b, dfc.k, dfc.I, dfc.K, dfc.fl, dfc.dP, dfc.iA, dfc.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ji<dcy>>> t;
   ...
   public static final Codec<dyy> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dyy::a, Function.identity());

   private static DataResult<dyy> a(dyy $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dyy(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ji<dcy>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kb.c($$0);
      int $$5 = kb.c($$1) - $$4;
   ...
   @Nullable
   public static dyy a(arm $$0, int $$1, int $$2) {
      dtz $$3 = $$0.a($$1, $$2);
      dyy $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(duy.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jf> a(dcu $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dtz $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ayz.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dtz $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dxv.a.a)) {
         $$3 = Math.min($$0.a(dxv.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }
   ...
   private static double a(dtz $$0, iz.a $$1) {
      return a($$0, (iz)$$1.c(je.a)) ? 1.0 : -1.0;
   }

   private static double b(dtz $$0, iz.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dtz $$0, int $$1, int $$2, int $$3) {
   ...
   private List<ji<dcy>> b(dtz $$0, int $$1, int $$2) {
      ObjectArrayList<ji<dcy>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dtz $$0, iz $$1) {
      dsd $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(awp.O)) {
         ...
         return $$2.a(dfc.eT) || $$2.a(dfc.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dyy.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dyy.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ji<dcy> var3);
   }
