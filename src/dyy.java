...
public class dyy<T> implements dzg<T> {
   private final jw<T> a;
   private final axv<T> b;
   private final dzh<T> c;
   private final int d;

   public dyy(jw<T> $$0, int $$1, dzh<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dyy(jw<T> $$0, int $$1, dzh<T> $$2) {
      this($$0, $$1, $$2, axv.c(1 << $$1));
   }

   private dyy(jw<T> $$0, int $$1, dzh<T> $$2, axv<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   public dzg<T> a(dzh<T> $$0) {
      return new dyy<>(this.a, this.d, $$0, this.b.b());
   }
}
