...
public class dpo {
   ...
   private final Map<Character, Predicate<dpm>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dpo a(char $$0, Predicate<dpm> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dpn b() {
      return new dpn(this.c());
   }

   private Predicate<dpm>[][][] c() {
      this.d();
      Predicate<dpm>[][][] $$0 = (Predicate<dpm>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dpm>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
