...
public class gdk implements gdj {
   private final gdj.a a;
   private final gdj.a b = gdj.a(new ezo(1536));
   private int c = 255;
   private int d = 255;
   private int e = 255;
   private int f = 255;
   ...
   public ezx getBuffer(gdr $$0) {
      if ($$0.M()) {
         ezx $$1 = this.b.getBuffer($$0);
         return new gdk.a($$1, this.c, this.d, this.e, this.f);
      } else {
         ezx $$2 = this.a.getBuffer($$0);
         Optional<gdr> $$3 = $$0.L();
         if ($$3.isPresent()) {
            ezx $$4 = this.b.getBuffer($$3.get());
            gdk.a $$5 = new gdk.a($$4, this.c, this.d, this.e, this.f);
            return faa.a($$5, $$2);
         } else {
            return $$2;
         }
   ...
   static class a extends ezs {
      ...
      a(ezx $$0, int $$1, int $$2, int $$3, int $$4) {
         this.f = $$0;
         super.b($$1, $$2, $$3, $$4);
      }
