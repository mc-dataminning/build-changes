...
public class gdk extends auu<gdk.a> {
   ...
   protected gdk.a a(aup $$0, bnk $$1) {
      ...
      $$1.b();
      return new gdk.a($$2, $$3, $$4);
   }

   protected void a(gdk.a $$0, aup $$1, bnk $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(aup $$0, bnk $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eyt.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eyt.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eyt.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
