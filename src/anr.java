...
public class anr {
   ...
   private static Optional<? extends jm.b<eif>> a(ft.c<eif> $$0, jv<eif> $$1) {
      return (Optional<? extends jm.b<eif>>)$$0.a().map($$1x -> $$1.b($$1x).map($$0xx -> jm.a($$0xx)), $$1::b);
   }

   private static int a(ep $$0, ft.c<eif> $$1) throws CommandSyntaxException {
      jv<eif> $$2 = $$0.e().H_().d(lq.aJ);
      jm<eif> $$3 = (jm<eif>)a($$1, $$2).orElseThrow(() -> c.create($$1.b()));
      iz $$4 = iz.a($$0.d());
      arb $$5 = $$0.e();
      Stopwatch $$6 = Stopwatch.createStarted(ac.d);
      Pair<iz, ji<eif>> $$7 = $$5.l().g().a($$5, $$3, $$4, 100, false);
      $$6.stop();
      if ($$7 == null) {
         throw b.create($$1.b());
      } else {
   ...
   private static int a(ep $$0, fs.c<dcs> $$1) throws CommandSyntaxException {
      iz $$2 = iz.a($$0.d());
      Stopwatch $$3 = Stopwatch.createStarted(ac.d);
      Pair<iz, ji<dcs>> $$4 = $$0.e().a($$1, $$2, 6400, 32, 64);
      $$3.stop();
      if ($$4 == null) {
         throw d.create($$1.b());
      } else {
   ...
   private static int b(ep $$0, fs.c<cer> $$1) throws CommandSyntaxException {
      iz $$2 = iz.a($$0.d());
      arb $$3 = $$0.e();
      Stopwatch $$4 = Stopwatch.createStarted(ac.d);
      Optional<Pair<ji<cer>, iz>> $$5 = $$3.y().e($$1, $$2, 256, ceo.b.c);
      $$4.stop();
      if ($$5.isEmpty()) {
         throw e.create($$1.b());
      } else {
   ...
   private static int a(ep $$0, iz $$1, Pair<iz, ? extends ji<?>> $$2, String $$3, boolean $$4, String $$5, Duration $$6) {
      iz $$7 = (iz)$$2.getFirst();
      int $$8 = $$4 ? ayu.d(ayu.c((float)$$1.j($$7))) : ayu.d(a($$1.u(), $$1.w(), $$7.u(), $$7.w()));
