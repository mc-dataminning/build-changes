...
public class anr {
   ...
   private static int a(du $$0, int $$1) {
      $$0.e().a(a($$0, $$1, apf.b), 0, false, false);
      $$0.a(() -> vu.c("commands.weather.set.clear"), true);
      return $$1;
   }

   private static int b(du $$0, int $$1) {
      $$0.e().a(0, a($$0, $$1, apf.c), true, false);
      $$0.a(() -> vu.c("commands.weather.set.rain"), true);
      return $$1;
   }

   private static int c(du $$0, int $$1) {
      $$0.e().a(0, a($$0, $$1, apf.d), true, true);
      $$0.a(() -> vu.c("commands.weather.set.thunder"), true);
      return $$1;
   }
}
