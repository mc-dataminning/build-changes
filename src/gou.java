...
public class gou implements gox.a, AutoCloseable {
   ...
   eza[] f;
   @Nullable
   private final gou.a g;
   private final aur h;

   public gou(alf $$0, gqn $$1, eza $$2, aur $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gql $$4 = $$3.a(gql.a).orElse(gql.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new eza[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gop.a(this.f, $$0);
   ...
   @Nullable
   private gou.a a(gqn $$0, int $$1, int $$2, gql $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gou.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gou.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gou.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gou.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gou.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gou.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, eza[] $$4) {
   ...
   class a {
      ...
      a(final List<gou.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gou.this.c;
         int $$4 = this.b($$2) * gou.this.d;
         gou.this.a($$0, $$1, $$3, $$4, gou.this.f);
      }

      public gow a() {
         return gou.this.new d(this, this.d ? gou.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final eza[] b = new eza[gou.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gou.this.c >> $$0;
            int $$2 = gou.this.d >> $$0;
            this.b[$$0] = new eza($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gou.d $$2) {
         gou.a $$3 = $$2.c;
         List<gou.b> $$4 = $$3.b;
         gou.b $$5 = $$4.get($$2.a);
         ...
         if ($$7 != $$8) {
            ...
            gou.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gou.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gou.this.f[$$2].a($$3 + ($$0.a($$1) * gou.this.c >> $$2), $$4 + ($$0.b($$1) * gou.this.d >> $$2));
      }
   ...
   class d implements gow {
      int a;
      int b;
      final gou.a c;
      @Nullable
      private final gou.c d;

      d(final gou.a $$0, @Nullable final gou.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
