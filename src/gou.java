...
public class gou {
   public static class a implements gpn<mc> {
      ...
      public gpk a(mc $$0, gmb $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gou.b $$8 = new gou.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gqk {
      b(gmb $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * azo.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends gpw {
      private boolean b;
      private boolean F;
      private final gpm G;
      private float H;
      ...
      c(gmb $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gpm $$7, gqf $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gou.c $$0 = new gou.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gpn<mc> {
      ...
      public gpk a(mc $$0, gmb $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gou.c $$8 = new gou.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, frd.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gpi {
      ...
      private int D;
      private final gpm E;
      private final List<dcm> F;
      private boolean G;

      public e(gmb $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gpm $$7, List<dcm> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, awq.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gpk $$12 = this.E.a(ly.P, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)axy.b($$11) / 255.0F, (float)axy.c($$11) / 255.0F, (float)axy.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               awo $$14 = $$13 ? awp.jw : awp.jv;
               this.c.a(this.g, this.h, this.i, $$14, awq.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gou.c $$10 = (gou.c)this.E.a(ly.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = azo.d($$18, $$13, $$16) * $$0;
                  double $$20 = azo.d($$18, $$14, $$17) * $$0;
