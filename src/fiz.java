...
public class fiz implements ewv {
   static final Logger b = LogUtils.getLogger();
   private final ext c;
   private final fin<fiz.b> d;

   fiz(ext $$0, fin<fiz.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(akm c, int d, int e, int[][] f) implements fjb {
      ...
      public static final MapCodec<fiz.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     akm.a.fieldOf("file").forGetter(fiz.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fiz.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fiz.a::e),
                     g.fieldOf("chars").forGetter(fiz.a::f)
                  )
                  .apply($$0, fiz.a::new)
         )
         .validate(fiz.a::a);
      ...
      private static DataResult<fiz.a> a(fiz.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fiz.b $$15 = $$9.a($$12, new fiz.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fiz.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(ext $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, ext b, int c, int d, int e, int f, int g, int h) implements ewu {
