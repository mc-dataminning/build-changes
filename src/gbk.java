...
public class gbk {
   private static final gbw a = gbw.t(new akh("textures/map/map_background.png"));
   private static final gbw b = gbw.t(new akh("textures/map/map_background_checkerboard.png"));
   ...
   private final fde au;
   private csz av = csz.i;
   private csz aw = csz.i;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final ggv aB;
   private final ghv aC;

   public gbk(fde $$0, ggv $$1, ghv $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bsa $$0, csz $$1, csw $$2, boolean $$3, exx $$4, gbo $$5, int $$6) {
      if (!$$1.d()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dN(), $$6, gmp.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = axz.a($$1, 0.0F, 1.0F);
      return -axz.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(exx $$0, gbo $$1, int $$2, bru $$3) {
      gmb $$4 = (gmb)this.aB.<gan>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bru.b ? 1.0F : -1.0F;
   ...
   private void a(exx $$0, gbo $$1, int $$2, float $$3, bru $$4, float $$5, csz $$6) {
      float $$7 = $$4 == bru.b ? 1.0F : -1.0F;
      ...
      float $$8 = axz.c($$5);
      float $$9 = axz.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * axz.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * axz.a($$5 * (float) Math.PI);
   ...
   private void a(exx $$0, gbo $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = axz.c($$5);
      float $$7 = -0.2F * axz.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * axz.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = axz.a($$6 * (float) Math.PI);
   ...
   private void a(exx $$0, gbo $$1, int $$2, csz $$3) {
      ...
      enn $$4 = $$3.a(ka.z);
      enp $$5 = cth.a($$4, this.au.r);
      eyb $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(exx $$0, gbo $$1, int $$2, float $$3, float $$4, bru $$5) {
      boolean $$6 = $$5 != bru.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = axz.c($$4);
      float $$9 = -0.3F * axz.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * axz.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * axz.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = axz.a($$4 * $$4 * (float) Math.PI);
      float $$13 = axz.a($$8 * (float) Math.PI);
   ...
   private void a(exx $$0, float $$1, bru $$2, csz $$3) {
      float $$4 = (float)this.au.s.fw() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.t();
      if ($$5 < 0.8F) {
         float $$6 = axz.e(axz.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(exx $$0, float $$1, bru $$2, csz $$3, float $$4) {
      this.b($$0, $$2, $$4);
      float $$5 = (float)(this.au.s.fw() % 10);
      float $$6 = $$5 - $$1 + 1.0F;
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * axz.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bru.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(exx $$0, bru $$1, float $$2) {
      int $$3 = $$1 == bru.b ? 1 : -1;
      float $$4 = axz.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = axz.a(axz.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(exx $$0, bru $$1, float $$2) {
      int $$3 = $$1 == bru.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, exx $$1, gbo.a $$2, gaq $$3, int $$4) {
      float $$5 = $$3.z($$0);
      bpl $$6 = (bpl)MoreObjects.firstNonNull($$3.aL, bpl.a);
      float $$7 = axz.i($$0, $$3.P, $$3.dF());
      gbk.a $$8 = a($$3);
      float $$9 = axz.i($$0, $$3.cG, $$3.cE);
      float $$10 = axz.i($$0, $$3.cF, $$3.cD);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bpl.a ? $$5 : 0.0F;
         float $$12 = 1.0F - axz.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bpl.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bpl.b ? $$5 : 0.0F;
         float $$14 = 1.0F - axz.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bpl.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gbk.a a(gaq $$0) {
      csz $$1 = $$0.eV();
      csz $$2 = $$0.eW();
      boolean $$3 = $$1.a(ctc.ou) || $$2.a(ctc.ou);
      boolean $$4 = $$1.a(ctc.vT) || $$2.a(ctc.vT);
      if (!$$3 && !$$4) {
         return gbk.a.a;
      } else if ($$0.ft()) {
         return b($$0);
      } else {
         return a($$1) ? gbk.a.b : gbk.a.a;
      }
   }

   private static gbk.a b(gaq $$0) {
      csz $$1 = $$0.fv();
      bpl $$2 = $$0.fu();
      if (!$$1.a(ctc.ou) && !$$1.a(ctc.vT)) {
         return $$2 == bpl.a && a($$0.eW()) ? gbk.a.b : gbk.a.a;
      } else {
         return gbk.a.a($$2);
      }
   }
   ...
   private static boolean a(csz $$0) {
      return $$0.a(ctc.vT) && crm.j($$0);
   }

   private void a(gan $$0, float $$1, float $$2, bpl $$3, float $$4, csz $$5, float $$6, exx $$7, gbo $$8, int $$9) {
      if (!$$0.gy()) {
         boolean $$10 = $$3 == bpl.a;
         bru $$11 = $$10 ? $$0.fs() : $$0.fs().e();
         $$7.a();
         if ($$5.d()) {
            if ($$10 && !$$0.cf()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.ft() && $$0.fw() > 0 && $$0.fu() == $$3) {
               ...
               float $$15 = (float)$$5.t() - ((float)this.au.s.fw() - $$1 + 1.0F);
               float $$16 = $$15 / (float)crm.l($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = axz.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * axz.a(axz.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * axz.a(axz.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * axz.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? csw.e : csw.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bru.b;
            if ($$0.ft() && $$0.fw() > 0 && $$0.fu() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.u()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.t() - ((float)this.au.s.fw() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.t() - ((float)this.au.s.fw() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
               ...
               float $$36 = -0.4F * axz.a(axz.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * axz.a(axz.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * axz.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? csw.e : csw.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.B()) {
         this.ax = axz.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = axz.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.D(1.0F);
         this.ax = this.ax + axz.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + axz.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
