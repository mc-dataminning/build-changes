...
public abstract class gbk extends gax {
   protected float D;
   private final Quaternionf a = new Quaternionf();

   protected gbk(fxq $$0, double $$1, double $$2, double $$3) {
      super($$0, $$1, $$2, $$3);
      this.D = 0.1F * (this.r.i() * 0.5F + 0.5F) * 2.0F;
   }

   protected gbk(fxq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.D = 0.1F * (this.r.i() * 0.5F + 0.5F) * 2.0F;
   }
   ...
   public void a(ezx $$0, fel $$1, float $$2) {
      evm $$3 = $$1.b();
      float $$4 = (float)(ayu.d((double)$$2, this.d, this.g) - $$3.a());
      float $$5 = (float)(ayu.d((double)$$2, this.e, this.h) - $$3.b());
      float $$6 = (float)(ayu.d((double)$$2, this.f, this.i) - $$3.c());
      this.p().setRotation(this.a, $$1, $$2);
      if (this.z != 0.0F) {
         this.a.rotateZ(ayu.i($$2, this.A, this.z));
      }
   ...
   public interface a {
      gbk.a a = ($$0, $$1, $$2) -> $$0.set($$1.f());
      gbk.a b = ($$0, $$1, $$2) -> $$0.set(0.0F, $$1.f().y, 0.0F, $$1.f().w);

      void setRotation(Quaternionf var1, fel var2, float var3);
   }
}
