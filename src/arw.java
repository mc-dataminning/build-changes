...
public class arw extends ash<arw.a> {
   private static final Logger c = LogUtils.getLogger();
   private final Stopwatch d = Stopwatch.createUnstarted();

   public arw(asb $$0, List<arv> $$1, Executor $$2, Executor $$3, CompletableFuture<axk> $$4) {
      super($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5) -> {
         AtomicLong $$6 = new AtomicLong();
         AtomicLong $$7 = new AtomicLong();
         big $$8 = new big(ac.b, () -> 0, false);
         big $$9 = new big(ac.b, () -> 0, false);
         ...
         return $$10.thenApplyAsync($$5x -> {
            ...
            return new arw.a($$3x.c(), $$8.d(), $$9.d(), $$6, $$7);
         }, $$3);
      }, $$4);
      this.d.start();
   ...
   private List<arw.a> a(List<arw.a> $$0) {
      this.d.stop();
      long $$1 = 0L;
   ...
   public static class a {
      ...
      a(String $$0, bim $$1, bim $$2, AtomicLong $$3, AtomicLong $$4) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
