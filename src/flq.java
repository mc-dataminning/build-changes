public abstract class flq extends flu {
   private static final fnj a = new fnj(all.b("widget/text_field"), all.b("widget/text_field_highlighted"));
   private static final all b = all.b("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public flq(int $$0, int $$1, int $$2, int $$3, xl $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return azn.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = azn.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(flj var1, int var2, int var3, float var4);
}
