...
public class flq {
   ...
   public static void a(File $$0, fed $$1, Consumer<wp> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fed $$2, Consumer<wp> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fed $$2, Consumer<wp> $$3) {
      fet $$4 = a($$2);
      ...
      af.h().execute(() -> {
         try {
            $$4.a($$6);
            wp $$3x = wp.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new wn(wn.a.b, $$6.getAbsolutePath())));
            $$3.accept(wp.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(wp.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static fet a(fed $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fet $$3 = new fet($$1, $$2, false);
   ...
   public flq(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
