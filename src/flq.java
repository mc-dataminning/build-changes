...
public class flq {
   ...
   public void a(fmb $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == fmb.a) {
            fqi.b($$1, fqi.a.a, xv.c("narrator.toast.disabled"), null);
         } else {
            fqi.b($$1, fqi.a.a, xv.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fqi.b($$1, fqi.a.a, xv.c("narrator.toast.disabled"), xv.c("options.narrator.notavailable"));
      }
   }
