...
public class bfz extends bgd {
   ...
   public static bfz a(float $$0, float $$1, float $$2, float $$3) {
      return new bfz($$0, $$1, $$2, $$3);
   }

   private bfz(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(ase $$0, float $$1, float $$2, float $$3, float $$4) {
      return ary.a(ary.c($$0, $$1, $$2), $$3, $$4);
   }
