...
public class bfz extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bgc.a(new Dynamic($$0, $$1), bfz.a, "ArmorStand");
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bbw.s.typeName()) ? super.getChoiceType($$0, bde.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bbw.z.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bbw.s, () -> DSL.taggedChoiceLazy("id", bde.a(), $$2));
      $$0.registerType(
         true,
         bbw.t,
         () -> DSL.hook(
