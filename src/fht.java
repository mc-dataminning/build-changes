...
public class fht<T extends bvu> extends feu<T> {
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      if ($$0.X_()) {
         ...
         this.n.f = arw.b($$1 * 0.6662F) * 1.4F * $$2;
      }
      ...
      if ($$0.y()) {
         ...
         this.j.e = arw.b($$1 * 0.6662F) * 1.4F * $$2;
         this.k.e = arw.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.l.e = arw.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.m.e = arw.b($$1 * 0.6662F) * 1.4F * $$2;
      }
