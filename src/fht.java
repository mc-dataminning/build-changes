...
public class fht {
   private static final ajh a = new ajh("advancements/title_box");
   ...
   private final awi r;
   private final int s;
   private final List<awi> t;
   private final ezg u;
   @Nullable
   private fht v;
   private final List<fht> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public fht(fhr $$0, ezg $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = sv.a().a($$1.h.a($$3.a(), 163));
      this.y = aww.d($$3.f() * 28.0F);
      this.z = aww.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = sv.a().a(this.a(vx.a($$3.b().f(), wr.a.a($$3.e().a())), $$7));
   ...
   private static float a(ezs $$0, List<vz> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<vz> a(vu $$0, int $$1) {
      ezs $$2 = this.u.h.b();
      List<vz> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<vz> $$6 = $$2.b($$0, $$1 - $$5, wr.a);
   ...
   public void a(fat $$0, int $$1, int $$2, boolean $$3) {
      if (this.v != null) {
         int $$4 = $$1 + this.v.y + 13;
