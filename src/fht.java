public class fht extends fhg<cll> implements fkb {
   private static final ajc x = new ajc("textures/gui/container/crafting_table.png");
   private final fjv y = new fjv();
   private boolean z;

   public fht(cll $$0, chz $$1, vs $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aP_() {
      ...
      this.c(new faw(this.t + 5, this.h / 2 - 49, 20, 18, fjv.a, $$0 -> {
         this.y.e();
         this.t = this.y.a(this.g, this.c);
