...
public interface bna<T, F> {
   ...
   public static final class a implements bna<bna.b, Runnable> {
   ...
   public static final class c<T> implements bna<T, T> {
