...
public class bna {
   ...
   private static void a(bni $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bnd $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dtw, bnm<bnc>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bnm)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dtw, bnm<bnc>> $$3 : $$0) {
         bnm<bnc> $$4 = (bnm<bnc>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dtw)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bnk> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bmp.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bmy $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bna::a));
      $$1.add("chunksWritten", this.a($$0.m(), bna::a));
      return $$1;
   }

   private JsonElement a(bnf.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bmy $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bna::a));
      $$1.add("received", this.a($$0.k(), bna::a));
      return $$1;
   }

   private <T> JsonElement a(bnh<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bne> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bne>, ToDoubleFunction<bne>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bne::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bne::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bne::c));
      return $$1;
   }
}
