...
public class bna extends bnf {
   public static final Codec<bna> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bna a(float $$0, float $$1, int $$2, int $$3) {
      return new bna($$0, $$1, $$2, $$3);
   }

   private bna(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(axr $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)axk.a(axk.c($$0, $$1, $$2), $$3, $$4);
   }
