...
public interface dcc extends dbc, dbj, dcp, dda.a {
   @Nullable
   dtz a(int var1, int var2, duy var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(dxv.a var1, int var2, int var3);

   int B_();

   dda F_();

   default ji<dcy> t(iz $$0) {
      return this.F_().a($$0);
   }

   default Stream<dsd> c(evn $$0) {
      int $$1 = ayz.a($$0.a);
      int $$2 = ayz.a($$0.d);
      int $$3 = ayz.a($$0.b);
      int $$4 = ayz.a($$0.e);
   ...
   @Override
   default int a(iz $$0, dbk $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default ji<dcy> getNoiseBiome(int $$0, int $$1, int $$2) {
      dtz $$3 = this.a(jt.e($$0), jt.e($$2), duy.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   ji<dcy> a(int var1, int var2, int var3);
   ...
   default dtz a(int $$0, int $$1) {
      return this.a($$0, $$1, duy.n, true);
   }

   default dtz a(int $$0, int $$1, duy $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dbf c(int $$0, int $$1) {
