...
public class ddj {
   ...
   final boolean f;
   private final asv<cwp> g;
   private final int h;
   private final int i;
   private final int j;
   private final int k;
   private List<ddj.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public ddj(boolean $$0, asv<cwp> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static ddj a() {
      return new ddj(false, asg.bL, 10, 4, 10, 5);
   }

   public static ddj b() {
      return new ddj(true, asg.bM, 50, 1, 5, 10);
   }
   ...
   public void a(sn $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<ddj.a> $$1 = (List<ddj.a>)ddj.a.b.listOf().parse(new Dynamic(tb.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(sn $$0) {
      ddj.a.b.listOf().encodeStart(tb.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(hx $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new ddj.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(ddj.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(ctp $$0, hx $$1, auu $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<ddj.a> $$4 = new ArrayList<>();
         Map<hx, ddj.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<ddj.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  hx.a.fieldOf("pos").forGetter(ddj.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(ddj.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(ddj.a::c),
      ...
      private boolean a(ctp $$0, hx $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(ctp $$0, hx $$1, auu $$2, ddj $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
               ...
               if ($$4 && $$6.a($$0, this.d, $$5, this.h, $$3.h())) {
                  ...
                  $$0.a(null, this.d, arr.uW, ars.e, 1.0F, 1.0F);
               }
      ...
      private static dde a(djg $$0) {
         return $$0.b() instanceof dde $$1 ? $$1 : dde.u_;
      }

      private static List<jb> a(auu $$0) {
         return ac.a(c, $$0);
      }

      @Nullable
      private static hx a(ctp $$0, hx $$1, auu $$2) {
         hx.a $$3 = $$1.j();
         hx.a $$4 = $$1.j();
      ...
      private static boolean a(ctp $$0, hx $$1, hx $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            hx $$3 = $$2.b($$1);
      ...
      private static boolean a(ctp $$0, hx $$1, ic $$2) {
         hx $$3 = $$1.a($$2);
