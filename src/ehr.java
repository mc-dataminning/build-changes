...
public class ehr extends egw<eji> {
   ...
   protected boolean a(
      dig $$0, bam $$1, eji $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
   ...
   public static boolean a(dxv $$0, Function<jh, dxv> $$1, bam $$2, eji $$3, eji.a $$4, jh.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
