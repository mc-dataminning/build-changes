...
public class ffg {
   ...
   public static final ffg.a bv;

   public static ffg.a a(int $$0, int $$1) {
      return $$0 == -1 ? ffg.b.b.a($$1) : ffg.b.a.a($$0);
   }

   public static ffg.a a(String $$0) {
      if (ffg.a.e.containsKey($$0)) {
         return ffg.a.e.get($$0);
      } else {
         for (ffg.b $$1 : ffg.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ffg.b b;
      private final int c;
      private final azo<xk> d;
      static final Map<String, ffg.a> e = Maps.newHashMap();

      a(String $$0, ffg.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new azo<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xk.b($$2.toUpperCase(Locale.ROOT)) : xk.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xk.b($$2) : xk.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> uh.a().b($$1) ? xk.c($$1) : xk.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ffg.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xk> g;

      private static void a(ffg.b $$0, String $$1, int $$2) {
         ffg.a $$3 = new ffg.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xk> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public ffg.a a(int $$0) {
         return (ffg.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
