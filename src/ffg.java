...
public class ffg extends auq<Map<String, List<ffg.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<ffg.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(ffg.a::a),
                     Codec.LONG.fieldOf("period").forGetter(ffg.a::b),
                     Codec.STRING.fieldOf("title").forGetter(ffg.a::c),
                     Codec.STRING.fieldOf("message").forGetter(ffg.a::d)
                  )
                  .apply($$0, ffg.a::new)
         )
         .listOf()
   ...
   public ffg(alb $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<ffg.a>> a(aul $$0, bnd $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<ffg.a>> $$0, aul $$1, bnd $$2) {
      List<ffg.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<ffg.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<ffg.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<ffg.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public ffg.b a(List<ffg.a> $$0, long $$1) {
         this.cancel();
         return new ffg.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (ffg.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fjh.a(ffa.Q().ax(), fjh.a.f, xl.a($$2.c, $$3), xl.a($$2.d, $$3)));
                  return;
               }
            }
         }
