...
public class ffg {
   ...
   private void a(n $$0, xp $$1) {
      this.b.l.d().a(xp.i().b(xp.c("debug.prefix").a($$0, n.r)).b(xo.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(xp.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.m(2)) {
                  ...
                  this.b.s.cz.d("gamemode " + ((dbx)MoreObjects.firstNonNull(this.b.q.i(), dbx.b)).b());
               }
            ...
            case 81:
               ...
               fhh $$3 = this.b.l.d();
               $$3.a(xp.c("debug.reload_chunks.help"));
               $$3.a(xp.c("debug.show_hitboxes.help"));
               $$3.a(xp.c("debug.copy_location.help"));
               $$3.a(xp.c("debug.clear_chat.help"));
               $$3.a(xp.c("debug.chunk_boundaries.help"));
               $$3.a(xp.c("debug.advanced_tooltips.help"));
               $$3.a(xp.c("debug.inspect.help"));
               $$3.a(xp.c("debug.profiling.help"));
               $$3.a(xp.c("debug.creative_spectator.help"));
               $$3.a(xp.c("debug.pause_focus.help"));
               $$3.a(xp.c("debug.help.help"));
               $$3.a(xp.c("debug.dump_dynamic_textures.help"));
               $$3.a(xp.c("debug.reload_resourcepacks.help"));
               $$3.a(xp.c("debug.pause.help"));
               $$3.a(xp.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.p.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.aa().a($$5);
               xp $$6 = xp.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new xn(xn.a.b, $$5.toFile().toString())));
   ...
   private void a(dse $$0, iz $$1, @Nullable us $$2) {
   ...
   private void a(alf $$0, evt $$1, @Nullable us $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = vh.c((vp)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().i()) {
         boolean $$5 = eyv.a(ffh.Q().aO().i(), 292);
         if (this.d > 0L) {
            if (!eyv.a(ffh.Q().aO().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (eyv.a(ffh.Q().aO().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.c();
            this.e = ac.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fny) || ((fny)$$6).r <= ac.c() - 20L)) {
            if (this.b.m.Q.a($$1, $$2)) {
               this.b.aO().h();
            ...
            if (this.b.m.N.a($$1, $$2)) {
               ...
               ffr.a(this.b.p, this.b.h(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aG_() instanceof fhp) || !((fhp)$$6.aG_()).c();
            if ($$7) {
               if (fnf.s() && $$1 == 66 && this.b.aX().a() && this.b.m.u().c()) {
                  boolean $$8 = this.b.m.as().c() == ffj.a;
                  this.b.m.as().a(ffj.a(this.b.m.as().c().a() + 1));
                  this.b.m.av();
                  if ($$6 instanceof fnh) {
                     ((fnh)$$6).E();
                  }
         ...
         label187: {
            ...
            label147:
            if (!$$11) {
               if (this.b.y instanceof fna $$12 && !$$12.m()) {
                  break label147;
               }
      ...
      if ($$0 == this.b.aO().i()) {
         ...
         if ($$3 != null && this.b.aL() == null) {
            if (Character.charCount($$1) == 1) {
               fnf.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fnf.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", ayz.f((float)$$1 / 1000.0F));
            }
