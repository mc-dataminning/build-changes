...
public class ffg implements gqi {
   private static final long a = 3000L;
   private final fby b;
   private final List<ffg.a> c = Lists.newArrayList();
   private boolean d;
   private final List<ffg.a> e = new ArrayList<>();
   ...
   public void a(fdl $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<ffg.a> $$10 = this.e.iterator();
            ...
            for (ffg.a $$12 : this.e) {
               ...
               int $$24 = axm.d(axm.b(255.0F, 75.0F, (float)(ac.b() - $$12.b()) / (float)(3000.0 * $$9)));
   ...
   @Override
   public void a(gpf $$0, gqk $$1, float $$2) {
      if ($$1.a() != null) {
         wi $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (ffg.a $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.a(new esj($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new ffg.a($$3, $$2, new esj($$0.h(), $$0.i(), $$0.j())));
      }
   }
   ...
   public static class a {
      ...
      public boolean b(esj $$0) {
         return Float.isInfinite(this.b) || $$0.a((ix)this.d, (double)this.b);
      }
   }
}
