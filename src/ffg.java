...
public class ffg {
   ...
   public ffg(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<ffh> $$1) throws IOException {
   ...
   public List<ffh> a(Path $$0) throws IOException {
      List<ffh> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<ffh> a(Path $$0, boolean $$1) throws IOException {
      List<ffh> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<ffh> $$1) throws IOException {
