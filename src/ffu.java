...
public class ffu extends ffv {
   ...
   private ffu(boolean $$0, @Nullable String $$1, URI $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   @Nullable
   public static ffu a(String $$0) {
      try {
         JsonParser $$1 = new JsonParser();
         JsonObject $$2 = $$1.parse($$0).getAsJsonObject();
         String $$3 = fhs.b("uploadEndpoint", $$2, null);
         if ($$3 != null) {
            int $$4 = fhs.a("port", $$2, -1);
            URI $$5 = a($$3, $$4);
            if ($$5 != null) {
               boolean $$6 = fhs.a("worldClosed", $$2, false);
               String $$7 = fhs.b("token", $$2, null);
               return new ffu($$6, $$7, $$5);
            }
         }
