public abstract class ffu extends ffy implements fhd, fhw {
   private static final fhn a = new fhn(new akn("widget/text_field"), new akn("widget/text_field_highlighted"));
   private static final akn b = new akn("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public ffu(int $$0, int $$1, int $$2, int $$3, wx $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return ayf.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = ayf.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(ffn var1, int var2, int var3, float var4);
}
