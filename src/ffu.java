...
public class ffu implements AutoCloseable {
   private final ffs.a a;
   @Nullable
   private ffs.a b;
   private final ffu.a c;

   public ffu(ffs.a $$0, ffu.a $$1) {
      this.a = $$0;
      this.c = $$1;
   }

   private static Vector3f[] a(ByteBuffer $$0, int $$1, fga $$2) {
      int $$3 = $$2.a(fgb.b);
      if ($$3 == -1) {
   ...
   @Nullable
   public ffu.b a(ffs $$0, fgd $$1) {
      if (this.c.d() != fga.c.h) {
         return null;
      } else {
         Vector3f[] $$2 = a(this.a.a(), this.c.b(), this.c.a());
         ffu.b $$3 = new ffu.b($$2, this.c.e());
         this.b = $$3.a($$0, $$1);
         return $$3;
      }
   }
   ...
   public static record a(fga a, int b, int c, fga.c d, fga.b e) {
   }

   public static record b(Vector3f[] a, fga.b b) {
      @Nullable
      public ffs.a a(ffs $$0, fgd $$1) {
         int[] $$2 = $$1.sort(this.a);
      ...
      private IntConsumer a(long $$0, fga.b $$1) {
