...
public class aij {
   ...
   public aij(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<aij.a> b(Scanner $$0) {
      ahg<ctx> $$1 = (ahg<ctx>)ais.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new aij.a($$1, new emc((double)$$2, (double)$$3, (double)$$4), new emb($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<anf> $$1 = this.e.ae().t();
         if (!$$1.isEmpty()) {
            anf $$2 = $$1.get(0);
            ane $$3 = this.e.F();
            ds $$4 = new ds($$2, emc.a($$3.T()), emb.a, $$3, 4, "", vf.a, this.e, $$2);
            dt $$5 = this.e.aE();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(ahg<ctx> a, emc b, emb c) {
   }
}
