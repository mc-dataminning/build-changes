...
public class aij {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tl.b("commands.schedule.cleared.failure", $$0));
   ...
   private static int a(dt $$0, Pair<aez, Either<dp, Collection<dp>>> $$1, int $$2, boolean $$3) throws CommandSyntaxException {
      if ($$2 == 0) {
         throw a.create();
      } else {
         long $$4 = $$0.e().V() + (long)$$2;
         aez $$5 = (aez)$$1.getFirst();
         egu<MinecraftServer> $$6 = $$0.l().aT().K().u();
         ((Either)$$1.getSecond()).ifLeft($$6x -> {
            ...
            $$6.a($$7, $$4, new egq($$5));
            $$0.a(() -> tl.a("commands.schedule.created.function", tl.a($$5), $$2, $$4), true);
         }).ifRight($$6x -> {
            String $$7 = "#" + $$5;
            if ($$3) {
               $$6.a($$7);
            ...
            $$6.a($$7, $$4, new egr($$5));
            $$0.a(() -> tl.a("commands.schedule.created.tag", tl.a($$5), $$2, $$4), true);
         });
