...
public class eqj extends eqm {
   public static final int a = 854;
   public static final int b = 480;
   static final eqj.b l = new eqj.b(854, 480);

   public eqj(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eqj.a[] e = values();
   ...
   static class b {
      ...
      static List<eqj.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eqj.b($$0, $$1), eqj.l) : ImmutableList.of(eqj.l);
      }
