...
public class kk extends km {
   ...
   kk(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }

   public static kk a(int $$0, int $$1, int $$2) {
      return new kk($$0, $$1, $$2);
   }

   public static kk a(ji $$0) {
      return new kk(a($$0.u()), a($$0.v()), a($$0.w()));
   }

   public static kk a(dfn $$0, int $$1) {
      return new kk($$0.h, $$1, $$0.i);
   }

   public static kk a(eaz $$0) {
      return a($$0.dv());
   }

   public static kk a(kb $$0) {
      return new kk(b($$0.a()), b($$0.b()), b($$0.c()));
   }

   public static kk a(long $$0) {
      return new kk(b($$0), c($$0), d($$0));
   }

   public static kk a(dyr $$0) {
      return a($$0.f(), $$0.ap());
   }
   ...
   public ji g(short $$0) {
      return new ji(this.d($$0), this.e($$0), this.f($$0));
   }
   ...
   public static long e(long $$0) {
      return b(a(ji.a($$0)), a(ji.b($$0)), a(ji.c($$0)));
   }
   ...
   public kk d(int $$0, int $$1, int $$2) {
      return $$0 == 0 && $$1 == 0 && $$2 == 0 ? this : new kk(this.a() + $$0, this.b() + $$1, this.c() + $$2);
   }

   public Stream<ji> t() {
      return ji.a(this.d(), this.e(), this.f(), this.g(), this.h(), this.i());
   }

   public static Stream<kk> a(kk $$0, int $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      int $$4 = $$0.c();
   ...
   public static Stream<kk> a(dfn $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$0.h;
      int $$5 = $$0.i;
      return a($$4 - $$1, $$2, $$5 - $$1, $$4 + $$1, $$3, $$5 + $$1);
   }

   public static Stream<kk> a(final int $$0, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5) {
      return StreamSupport.stream(new AbstractSpliterator<kk>((long)(($$3 - $$0 + 1) * ($$4 - $$1 + 1) * ($$5 - $$2 + 1)), 64) {
         final jk a = new jk($$0, $$1, $$2, $$3, $$4, $$5);

         @Override
         public boolean tryAdvance(Consumer<? super kk> $$0x) {
            if (this.a.a()) {
               $$0.accept(new kk(this.a.b(), this.a.c(), this.a.d()));
               return true;
            } else {
               return false;
            }
   ...
   public static void a(ji $$0, LongConsumer $$1) {
      a($$0.u(), $$0.v(), $$0.w(), $$1);
   }

   public static void a(long $$0, LongConsumer $$1) {
      a(ji.a($$0), ji.b($$0), ji.c($$0), $$1);
   }
