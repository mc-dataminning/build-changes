...
public final class kk {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ae.a($$0, 4).map(kk::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static final zi<ByteBuf, UUID> g = new zi<ByteBuf, UUID>() {
