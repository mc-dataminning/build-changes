...
public class fiw extends fil implements fjq {
   private static final fka d = new fka(new akt("widget/text_field"), new akt("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, axy> D = ($$0x, $$1x) -> axy.forward($$0x, yb.a);
   @Nullable
   private xe E;
   private long F = ad.b();

   public fiw(fhy $$0, int $$1, int $$2, xe $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fiw(fhy $$0, int $$1, int $$2, int $$3, int $$4, xe $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fiw(fhy $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fiw $$5, xe $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, axy> $$0) {
      this.D = $$0;
   }
   ...
   protected xs aK_() {
      xe $$0 = this.y();
      return xe.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = aym.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = aym.a($$0) - this.C();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fon.s());
   }
   ...
   public void b(fia $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         boolean $$9 = this.aI_() && (ad.b() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.C() + 4 : this.C();
         int $$11 = this.r ? this.D() + (this.h - 8) / 2 : this.D();
         int $$12 = $$10;
         int $$13 = aym.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gfo.F(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = aym.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = aym.a(this.v, 0, this.p.length());
      }
   }
