...
public record fiw(int i, int j, fiw.a k, fiw.b l, int m) {
   public static final int a = 32;
   private static final fiw[] n = new fiw[32];
   private static final List<fiw> o = new ArrayList<>(32);
   public static final fiw b = a(0, 0, fiw.a.a, fiw.b.a, 3);
   public static final fiw c = a(1, 0, fiw.a.b, fiw.b.c, 4);
   public static final fiw d = a(2, 0, fiw.a.a, fiw.b.d, 2);
   public static final fiw e = d;
   public static final fiw f = a(3, 1, fiw.a.e, fiw.b.d, 2);
   public static final fiw g = a(4, 2, fiw.a.e, fiw.b.d, 2);
   public static final fiw h = a(5, 0, fiw.a.c, fiw.b.b, 3);

   public fiw(int i, int j, fiw.a k, fiw.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fiw a(int $$0, int $$1, fiw.a $$2, fiw.b $$3, int $$4) {
      fiw $$5 = new fiw($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, fiw.b $$1) {
      return $$0 == 0 || $$1 == fiw.b.d;
   }
   ...
   public static Stream<fiw> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fiw.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
