...
public class fiw implements flb {
   ...
   @Override
   public fld a(flj $$0, OptionalInt $$1) {
      return this.a($$0, $$1, null, OptionalDouble.empty());
   }

   @Override
   public fld a(flj $$0, OptionalInt $$1, @Nullable flj $$2, OptionalDouble $$3) {
      if (this.f) {
         ...
         this.f = true;
         int $$4 = ((fje)$$0).a(this.b.m(), $$2);
         GlStateManager._glBindFramebuffer(36160, $$4);
         int $$5 = 0;
         if ($$1.isPresent()) {
            int $$6 = $$1.getAsInt();
            GL11.glClearColor(aya.j($$6), aya.k($$6), aya.l($$6), aya.i($$6));
            $$5 |= 16384;
         }
         ...
         this.e = null;
         return new fjb(this, $$2 != null);
      }
   }

   @Override
   public void a(flj $$0, int $$1) {
      if (this.f) {
         throw new IllegalStateException("Close the existing render pass before creating a new one!");
      } else if (!$$0.d().b()) {
         throw new IllegalStateException("Trying to clear a non-color texture as color");
      } else {
         this.b.m().a(this.d, ((fje)$$0).a, 0, 0, true);
         GL11.glClearColor(aya.j($$1), aya.k($$1), aya.l($$1), aya.i($$1));
         GlStateManager._disableScissorTest();
         GlStateManager._colorMask(true, true, true, true);
   ...
   @Override
   public void a(flj $$0, int $$1, flj $$2, double $$3) {
      if (this.f) {
         throw new IllegalStateException("Close the existing render pass before creating a new one!");
      } else if (!$$0.d().b()) {
         throw new IllegalStateException("Trying to clear a non-color texture as color");
   ...
   @Override
   public void a(flj $$0, double $$1) {
      if (this.f) {
         throw new IllegalStateException("Close the existing render pass before creating a new one!");
      } else if (!$$0.d().c()) {
         throw new IllegalStateException("Trying to clear a non-depth texture as depth");
      } else {
         this.b.m().a(this.d, 0, ((fje)$$0).a, 0, true);
         GL11.glDrawBuffer(0);
         GL11.glClearDepth($$1);
         GlStateManager._depthMask(true);
         GlStateManager._disableScissorTest();
   ...
   @Override
   public void a(fii $$0, ByteBuffer $$1, int $$2) {
      fiv $$3 = (fiv)$$0;
      if ($$3.c) {
   ...
   @Override
   public fii.a a(fii $$0) {
      return this.a($$0, 0, $$0.a());
   }

   @Override
   public fii.a a(fii $$0, int $$1, int $$2) {
      fiv $$3 = (fiv)$$0;
      if ($$3.c) {
         throw new IllegalStateException("Buffer already closed");
      } else if (!$$3.c().a()) {
         ...
         if ($$4 == null) {
            ...
            return new fiv.a(GlConst.toGl($$3.b()), $$4);
         }
      }
   }

   @Override
   public void a(flj $$0, fki $$1) {
      int $$2 = $$0.a(0);
      int $$3 = $$0.b(0);
      if ($$1.a() == $$2 && $$1.b() == $$3) {
   ...
   @Override
   public void a(flj $$0, fki $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      if ($$2 >= 0 && $$2 < $$0.c()) {
         if ($$7 + $$5 > $$1.a() || $$8 + $$6 > $$1.b()) {
            throw new IllegalArgumentException(
            ...
            GlStateManager._bindTexture(((fje)$$0).a);
   ...
   @Override
   public void a(flj $$0, IntBuffer $$1, fki.a $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      if ($$3 >= 0 && $$3 < $$0.c()) {
         if ($$6 * $$7 > $$1.remaining()) {
            throw new IllegalArgumentException(
   ...
   @Override
   public void a(flj $$0, fii $$1, int $$2, Runnable $$3, int $$4) {
      if (this.f) {
   ...
   @Override
   public void a(flj $$0, fii $$1, int $$2, Runnable $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      if (this.f) {
         throw new IllegalStateException("Close the existing render pass before performing additional commands");
      } else if ($$4 >= 0 && $$4 < $$0.c()) {
         if ($$0.a($$4) * $$0.b($$4) * $$0.d().a() + $$2 > $$1.a()) {
            ...
            GlStateManager._glBindBuffer(GlConst.toGl($$1.b()), ((fiv)$$1).f);
            GlStateManager._glFramebufferTexture2D(36008, 36064, 3553, ((fje)$$0).b(), $$4);
   ...
   @Override
   public void a(flj $$0, flj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      if (this.f) {
         throw new IllegalStateException("Close the existing render pass before performing additional commands");
         ...
         if ($$3 + $$7 > $$1.a($$2) || $$4 + $$8 > $$1.b($$2)) {
            ...
            boolean $$9 = $$0.d().c();
            GlStateManager._glFramebufferTexture2D(36008, $$9 ? '贀' : '賠', 3553, ((fje)$$0).b(), $$2);
            GlStateManager._glFramebufferTexture2D(36009, $$9 ? '贀' : '賠', 3553, ((fje)$$1).b(), $$2);
   ...
   public void a(flj $$0) {
      if (this.f) {
         ...
         GlStateManager._glFramebufferTexture2D(36008, 36064, 3553, ((fje)$$0).b(), 0);
         GlStateManager._glBlitFrameBuffer(0, 0, $$0.a(0), $$0.b(0), 0, 0, $$0.a(0), $$0.b(0), 16384, 9728);
         GlStateManager._glBindFramebuffer(36008, 0);
      }
   }

   protected void a(fjb $$0, Collection<fld.a> $$1) {
      if (this.a($$0)) {
         for (fld.a $$2 : $$1) {
            $$0.a($$2.c(), $$2.d());
            $$0.a($$2.a(), $$2.b());
   ...
   protected void a(fjb $$0, int $$1, int $$2, @Nullable flu.b $$3) {
      if (this.a($$0)) {
         if (fjb.b) {
            if ($$0.e == null && $$3 != null) {
               throw new IllegalStateException("Missing index buffer");
   ...
   private void a(fjb $$0, int $$1, int $$2, @Nullable flu.b $$3, fjc $$4) {
      this.b.n().a($$4.b().l(), (fiv)$$0.d[0]);
      if ($$3 != null) {
         GlStateManager._glBindBuffer(34963, ((fiv)$$0.e).f);
   ...
   private boolean a(fjb $$0) {
      ...
      fkm $$14 = frf.Q() == null ? null : frf.Q().aO();
      $$5.a(
         $$4.m(),
