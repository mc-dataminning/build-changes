...
public final class fna {
   ...
   private static final fna c = new fna(HostAndPort.fromParts("server.invalid", 25565));

   public fna(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fna(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fna a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new fna($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fna ? this.b.equals(((fna)$$0).b) : false;
      }
   }
