...
public class ahg implements Comparable<ahg> {
   public static final Codec<ahg> a = Codec.STRING.comapFlatMap(ahg::b, ahg::toString).stable();
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(vf.c("argument.id.invalid"));
   ...
   protected ahg(String $$0, String $$1, @Nullable ahg.a $$2) {
      this.f = $$0;
      this.g = $$1;
   }

   public ahg(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private ahg(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static ahg a(String $$0, char $$1) {
      return new ahg(b($$0, $$1));
   }
   ...
   @Nullable
   public static ahg a(String $$0, String $$1) {
      try {
         return new ahg($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<ahg> b(String $$0) {
      try {
         return DataResult.success(new ahg($$0));
      } catch (z var2) {
   ...
   public ahg c(String $$0) {
      return new ahg(this.f, d(this.f, $$0), null);
   }

   public ahg a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.g));
   }

   public ahg d(String $$0) {
      return this.c($$0 + this.g);
   }

   public ahg e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof ahg $$1) ? false : this.f.equals($$1.f) && this.g.equals($$1.g);
      }
   }
   ...
   public static ahg a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
