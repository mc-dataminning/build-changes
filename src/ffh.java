...
public class ffh implements AutoCloseable {
   private static final int a = -1;
   private final aku b;
   private int c;

   private ffh(int $$0, aku $$1) {
      this.b = $$1;
      this.c = $$0;
   }

   public static ffh a(aku $$0, ffh.a $$1, String $$2) throws gmm.b {
      ...
      if (GlStateManager.glGetShaderi($$3, 35713) == 0) {
         ...
         throw new gmm.b("Couldn't compile " + $$1.a() + " shader (" + $$0 + ") : " + $$4);
      } else {
         return new ffh($$3, $$0);
      }
   }
   ...
   public static enum a {
      ...
      private static final ffh.a[] c = values();
