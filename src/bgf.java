...
public class bgf implements bfy {
   ...
   public static Set<bfw> a() {
      Builder<bfw> $$0 = ImmutableSet.builder();

      try {
         bgf.a $$1 = new bgf.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bfw.a("cpu#" + $$1x, bfv.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bfw.a("heap MiB", bfv.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bfx.a.a());
      return $$0.build();
   }
   ...
   public static bfw a(final LongSupplier $$0) {
      ...
      bfw.d $$3 = new bfw.d(2.0F);
      return bfw.a("ticktime", bfv.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
