...
public class bgf {
   ...
   private JsonElement a(List<Pair<djj, bgp<bgh>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bgp)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<djj, bgp<bgh>> $$3 : $$0) {
         bgp<bgh> $$4 = (bgp<bgh>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((djj)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bgn> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bfv.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bgd $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bgl $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bgl.b $$3 = (bgl.b)$$1x.getFirst();
         bgl.a $$4 = (bgl.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bgi> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bgi>, ToDoubleFunction<bgi>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bgi::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bgi::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bgi::c));
      return $$1;
   }
}
