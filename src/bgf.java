...
public class bgf {
   ...
   private bgf(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bgf a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bgf($$0, $$1);
   }

   public bgf.d a() throws IOException {
      bgf.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bgf.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bgf.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bgf.c $$3 = bgf.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bgf.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bgf.a($$0, $$3);
            }
         }
   ...
   public bgf.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bgf.c> $$2 = this.a().c();
      ...
      bgf.e $$4 = new bgf.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bgf.c b) implements bgf.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bgf.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bgf.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bgf.b> {
      private final List<bgf.b> a;

      d(List<bgf.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bgf.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bgf.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bgf.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bgf.d a() {
         ListIterator<bgf.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bgf.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bgf.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bgf.b> b() {
         return this.a.stream();
      }

      public Set<bgf.c> c() {
         return this.a.stream().map(bgf.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bgf.c b) implements bgf.b {
