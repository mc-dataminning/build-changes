...
public class bgf extends bfb {
   public bgf(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bgd.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bhp.a($$0.get("id").asString("minecraft:air"));
