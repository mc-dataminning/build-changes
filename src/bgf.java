...
public class bgf extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("LevelFlatGeneratorInfoFix", this.getInputSchema().getType(bhu.a), $$0 -> $$0.update(DSL.remainderFinder(), this::a));
   }
      ...
      if ($$0.isEmpty()) {
         ...
         if ($$3 >= 0 && $$3 <= 3) {
            ...
            $$7.append(StreamSupport.<String>stream(d.split($$4).spliterator(), false).map($$2x -> {
               ...
               return ($$4x == 1 ? "" : $$4x + "*") + bcg.b($$11 << 4 | $$13).get("Name").asString("");
