...
public class ejw extends ejm<ejv> {
   private static final float a = 0.06F;

   public ejw(Codec<ejv> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejo<ejv> $$0) {
      djz $$1 = $$0.b();
      iu $$2 = $$0.e();
      azv $$3 = $$0.d();
      ecf $$4 = $$0.c();
   ...
   private static boolean a(djz $$0, iu $$1, ejv $$2, boolean $$3) {
      if ($$0.a($$1, eag.a::v)) {
         return true;
      } else {
   ...
   private void a(djz $$0, azv $$1, ejv $$2, iu $$3, int $$4, boolean $$5) {
      iu.a $$6 = new iu.a();
      eah $$7 = $$2.c;
      int $$8 = $$5 ? 1 : 0;
   ...
   private void b(djz $$0, azv $$1, ejv $$2, iu $$3, int $$4, boolean $$5) {
      iu.a $$6 = new iu.a();
      boolean $$7 = $$2.d.a(dmh.lq);
   ...
   private void a(djb $$0, azv $$1, ejv $$2, iu.a $$3, float $$4, float $$5, float $$6) {
      if ($$1.i() < $$4) {
         this.a($$0, $$3, $$2.e);
      } else if ($$1.i() < $$5) {
         this.a($$0, $$3, $$2.d);
   ...
   private void a(djb $$0, azv $$1, iu $$2, eah $$3, boolean $$4) {
      if ($$0.a_($$2.e()).a($$3.b())) {
         this.a($$0, $$2, $$3);
   ...
   private static void a(iu $$0, djb $$1, azv $$2) {
      iu.a $$3 = $$0.k().c(ja.a);
      if ($$1.v($$3)) {
         int $$4 = azm.a($$2, 1, 5);
         if ($$2.a(7) == 0) {
