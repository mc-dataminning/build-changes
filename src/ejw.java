...
public record ejw(ejw.a b, byte c, byte d, byte e, Optional<vu> f) {
   public static final xs<vf, ejw> a = xs.a(ejw.a.K, ejw::c, xq.b, ejw::d, xq.b, ejw::e, xq.b, ejw::f, vw.c, ejw::g, ejw::new);

   public ejw(ejw.a b, byte c, byte d, byte e, Optional<vu> f) {
      e = (byte)(e & 15);
      this.b = b;
      this.c = c;
      this.d = d;
   ...
   public static enum a implements axq {
      ...
      B(27, "village_desert", true, eit.w.ak, false, true),
      C(28, "village_plains", true, eit.w.ak, false, true),
      D(29, "village_savanna", true, eit.w.ak, false, true),
      E(30, "village_snowy", true, eit.w.ak, false, true),
      F(31, "village_taiga", true, eit.w.ak, false, true),
      G(32, "jungle_temple", true, eit.w.ak, false, true),
      H(33, "swamp_hut", true, eit.w.ak, false, true);

      public static final IntFunction<ejw.a> I = avn.a(ejw.a::a, values(), avn.a.a);
      public static final Codec<ejw.a> J = axq.a(ejw.a::values);
      public static final xs<ByteBuf, ejw.a> K = xq.a(I, ejw.a::a);
      private final int L;
      ...
      public static ejw.a a(byte $$0) {
         return values()[aww.a($$0, 0, values().length - 1)];
      }
