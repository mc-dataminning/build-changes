...
public class dxx<T> implements dxz<T> {
   ...
   private dxx(jv<T> $$0, int $$1, dya<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dxx(jv<T> $$0, T[] $$1, dya<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dxz<T> a(dya<T> $$0) {
      return new dxx<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
