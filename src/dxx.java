...
public class dxx {
   private static final dxx a = new dxx(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dxx.a a(int $$0, int $$1) {
         return new dxx.a(1.0, 0.0);
      }
   ...
   private static final elz b = elz.b(new dxw(42L), qs.a);
   ...
   private final Long2ObjectOpenHashMap<dxy> h;
   private final Long2ObjectOpenHashMap<dxy> i;

   public static dxx a() {
      return a;
   }

   public static dxx a(@Nullable aqu $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dag $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dxy> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dxy> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = ayf.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dxx($$2, $$3);
         }
      }
   }

   dxx(Long2ObjectOpenHashMap<dxy> $$0, Long2ObjectOpenHashMap<dxy> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dxx.a a(int $$0, int $$1) {
      int $$2 = ji.a($$0);
      int $$3 = ji.a($$1);
      double $$4 = this.a($$2, 0, $$3, dxy::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dxx.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(ji.d(dag.a($$5x)), ji.d(dag.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = ayf.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = ayf.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new dxx.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(dwo.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(ji.d(dag.a($$6x)), ji.d(dag.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = ayf.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = ayf.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return ayf.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, dxx.b $$3) {
      int $$4 = ji.e($$0);
      int $$5 = ji.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dxx.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dxy $$6 = (dxy)this.h.get(dag.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - ji.d($$1), $$4, $$5 - ji.d($$2)) : Double.MAX_VALUE;
   }

   public dcb a(dcb $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         ix<dby> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private ix<dby> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<ix<dby>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(ji.d(dag.a($$5x)), $$1, ji.d(dag.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = ayf.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = ayf.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (ix)$$4.getValue();
      }
   }

   public static void a(aqu $$0, dsz $$1) {
      dag $$2 = $$1.f();
      boolean $$3 = $$1.s();
      io.a $$4 = new io.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dwv.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dsz $$0, io $$1) {
      drd $$2 = $$0.a_($$1);
      if ($$2.a(avx.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(dbu $$0, dtt $$1) {
      dag $$2 = $$1.f();
      Builder<iu, dxy> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dwr.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dxx.c a(@Nullable dxy $$0, Map<iu, dxy> $$1) {
      List<dxx.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dxx.c a(@Nullable iu $$0, dxy $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (it $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return ayf.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(dxy var1, int var2, int var3, int var4);
   }
