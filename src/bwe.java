...
public class bwe {
   ...
   public static buh<bsw> a(float $$0) {
      ...
      return bxt.a(
         (Function<bxt.b<bsw>, ? extends App<bxt.c<bsw>, bxw<bsw>>>)($$3 -> $$3.group($$3.c(cbr.m), $$3.c(cbr.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.Z() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cdr $$7 = $$4x.y();
                        Optional<ir> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cdv.n), $$5.du(), 48, cdr.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.du()) <= 4.0)) {
                           MutableInt $$9 = new MutableInt(0);
                           $$2.setValue($$4x.Z() + (long)$$4x.F_().a(20));
                           Predicate<ir> $$10 = $$3xxx -> {
                              long $$4xx = $$3xxx.a();
                           ...
                           Set<Pair<ja<cdu>, ir>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cdv.n), $$10, $$5.du(), 48, cdr.b.c).collect(Collectors.toSet());
                           eps $$12 = btz.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              ir $$13 = $$12.l();
                              Optional<ja<cdu>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new cbu($$13, $$0, 1));
                                 agi.c($$4x, $$13);
                              }
