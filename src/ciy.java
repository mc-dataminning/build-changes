...
public class ciy {
   ...
   private static final cfx r = cfx.a().a(($$0, $$1) -> !$$0.aq().equals(bur.ai) && (!$$1.O().b(dge.c) || !$$0.aq().equals(bur.f)) && $$1.F_().a($$0.cR()));
   ...
   private static void b(bwi<cix> $$0) {
      $$0.a(cqo.a, 0, ImmutableList.of(new bzt(0.8F), new bwu(2.0F), new byf(45, 90), new byj(), new bxf(cek.P), new bxf(cek.S), new bxf(cek.V)));
   }
   ...
   private static void d(bwi<cix> $$0) {
      $$0.a(
         cqo.q,
         ImmutableList.of(Pair.of(0, new bya(o, awa.lB)), Pair.of(1, new byc<>(o, 5, 5, 3.5714288F, $$0x -> $$0x.gB() ? awa.lx : awa.lo))),
   ...
   private static void e(bwi<cix> $$0) {
      $$0.a(
         cqo.r,
         ImmutableList.of(
            Pair.of(0, new byp($$0x -> $$0x.gB() ? q : p, r, 3.0F, $$0x -> $$0x.e_() ? 1.0 : 2.5, $$0x -> $$0x.gB() ? awa.lA : awa.lr, $$0x -> awa.ls)),
            Pair.of(1, new byo<>($$0x -> $$0x.gB() ? q.a() : p.a(), 4, 7, 1.25F, r, 20, $$0x -> $$0x.gB() ? awa.lz : awa.lq))
         ),
   ...
   public static void a(cix $$0) {
      $$0.ec().a(ImmutableList.of(cqo.r, cqo.q, cqo.b));
   }
