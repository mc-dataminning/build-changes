...
public class ciy extends bsh implements ciw {
   private static final ajs<Boolean> b = ajw.a(ciy.class, aju.k);
   private int c = 1;

   public ciy(bsc<? extends ciy> $$0, daz $$1) {
      super($$0, $$1);
      this.bN = 5;
      this.bP = new ciy.b(this);
   }

   @Override
   protected void z() {
      this.bS.a(5, new ciy.d(this));
      this.bS.a(7, new ciy.a(this));
      this.bS.a(7, new ciy.c(this));
   ...
   private static boolean h(bqp $$0) {
      return $$0.c() instanceof cmo && $$0.d() instanceof cly;
   }

   @Override
   public boolean b(bqp $$0) {
      return this.cu() && !$$0.a(avz.e) || !h($$0) && super.b($$0);
   }
   ...
   public static btx.a y() {
      return bss.A().a(bty.q, 10.0).a(bty.k, 100.0);
   }
   ...
   public static boolean b(bsc<ciy> $$0, dba $$1, bsu $$2, io $$3, aym $$4) {
      return $$1.ak() != bpt.a && $$4.a(20) == 0 && a($$0, $$1, $$2, $$3, $$4);
   }
   ...
   static class a extends bzo {
      ...
      public void e() {
         if (this.a.p() == null) {
            eum $$0 = this.a.ds();
            this.a.r(-((float)ayf.d($$0.c, $$0.e)) * (180.0F / (float)Math.PI));
            this.a.aY = this.a.dF();
         } else {
            bsq $$1 = this.a.p();
            double $$2 = 64.0;
            if ($$1.g(this.a) < 4096.0) {
               ...
               this.a.r(-((float)ayf.d($$3, $$4)) * (180.0F / (float)Math.PI));
               this.a.aY = this.a.dF();
            }
         }
      }
         ...
         if ($$0 != null) {
            ...
            if ($$0.g(this.b) < 4096.0 && this.b.E($$0)) {
               ...
               if (this.a == 20) {
                  ...
                  cmo $$8 = new cmo($$2, this.b, $$5, $$6, $$7, this.b.u());
