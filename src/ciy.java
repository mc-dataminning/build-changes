...
public final class ciy {
   public static final Codec<ciy> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               jb.i.q().fieldOf("id").forGetter(ciy::d),
               Codec.INT.fieldOf("Count").forGetter(ciy::L),
               qr.a.optionalFieldOf("tag").forGetter($$0x -> Optional.ofNullable($$0x.v()))
            )
            .apply($$0, ciy::new)
   );
   private static final Logger j = LogUtils.getLogger();
   public static final ciy b = new ciy((Void)null);
   ...
   private ciy(cpl $$0, int $$1, Optional<qr> $$2) {
      this($$0, $$1);
      $$2.ifPresent(this::c);
   }

   public ciy(he<cit> $$0, int $$1) {
      this($$0.a(), $$1);
   }

   public ciy(cpl $$0, int $$1) {
      this.u = $$0.k();
      this.s = $$1;
      if (this.u.o()) {
         this.b(this.k());
   ...
   public boolean b() {
      return this == b || this.u == cjb.a || this.s <= 0;
   }
   ...
   public boolean a(Predicate<he<cit>> $$0) {
      return $$0.test(this.d().j());
   }

   public boolean a(he<cit> $$0) {
      return this.d().j() == $$0;
   }

   public boolean a(hi<cit> $$0) {
      return $$0.a(this.e());
   }

   public Stream<aqa<cit>> f() {
      return this.d().j().c();
   }
   ...
   public <T extends biy> void a(int $$0, T $$1, Consumer<T> $$2) {
      if (!$$1.dK().B && (!($$1 instanceof cbn) || !((cbn)$$1).fR().d)) {
         if (this.i()) {
   ...
   public boolean a(cfw $$0, cem $$1, cbn $$2) {
      return this.d().a(this, $$0, $$1, $$2);
   }

   public boolean a(ciy $$0, cfw $$1, cem $$2, cbn $$3, bjr $$4) {
      return this.d().a(this, $$0, $$1, $$2, $$3, $$4);
   }

   public void a(biy $$0, cbn $$1) {
      cit $$2 = this.d();
      if ($$2.a(this, $$0, $$1)) {
         $$1.b(apg.c.b($$2));
      }
   ...
   public void a(cpm $$0, dfa $$1, gu $$2, cbn $$3) {
      cit $$4 = this.d();
      if ($$4.a(this, $$0, $$1, $$2, $$3)) {
         $$3.b(apg.c.b($$4));
      }
   ...
   public boolean b(dfa $$0) {
      return this.d().a_($$0);
   }

   public bgq a(cbn $$0, biy $$1, bgp $$2) {
      return this.d().a(this, $$0, $$1, $$2);
   }
   ...
   public static boolean b(ciy $$0, ciy $$1) {
      return $$0.a($$1.d());
   }

   public static boolean c(ciy $$0, ciy $$1) {
      if (!$$0.a($$1.d())) {
         return false;
      } else {
   ...
   public void a(cpm $$0, bii $$1, int $$2, boolean $$3) {
      if (this.t > 0) {
         this.t--;
      }
   ...
   public void a(cpm $$0, cbn $$1, int $$2) {
   ...
   public void a(cpm $$0, biy $$1, int $$2) {
      this.d().a(this, $$0, $$1, $$2);
   }
   ...
   public List<tf> a(@Nullable cbn $$0, ckp $$1) {
      ...
      $$2.add($$3);
      if (!$$1.a() && !this.A() && this.a(cjb.rf)) {
         Integer $$4 = cjf.d(this);
         if ($$4 != null) {
            $$2.add(tf.b("#" + $$4).a(n.h));
         }
      }
      ...
      if (this.u()) {
         if (a($$5, ciy.a.h) && $$0 != null) {
            cla.a(this, $$0.dK().B_(), $$2);
         }
      ...
      if (a($$5, ciy.a.b)) {
         for (bin $$12 : bin.values()) {
            Multimap<bka, bkd> $$13 = this.a($$12);
            if (!$$13.isEmpty()) {
               $$2.add(te.a);
               $$2.add(tf.c("item.modifiers." + $$12.e()).a(n.h));

               for (Entry<bka, bkd> $$14 : $$13.entries()) {
                  bkd $$15 = $$14.getValue();
                  double $$16 = $$15.d();
                  boolean $$17 = false;
                  if ($$0 != null) {
                  ...
                  double $$18;
                  if ($$15.c() == bkd.a.b || $$15.c() == bkd.a.c) {
                     $$18 = $$16 * 100.0;
                  } else if ($$14.getKey().equals(bkf.c)) {
                     $$18 = $$16 * 10.0;
                  } else {
                     $$18 = $$16;
                  }
      ...
      if (this.u()) {
         if (a($$5, ciy.a.c) && this.v.q("Unbreakable")) {
            $$2.add(tf.c("item.unbreakable").a(n.j));
         }

         if (a($$5, ciy.a.d) && this.v.b("CanDestroy", 9)) {
         ...
         if (a($$5, ciy.a.e) && this.v.b("CanPlaceOn", 9)) {
   ...
   private static boolean a(int $$0, ciy.a $$1) {
      return ($$0 & $$1.a()) == 0;
   }
   ...
   public static void a(List<tf> $$0, qx $$1) {
      for (int $$2 = 0; $$2 < $$1.size(); $$2++) {
         qr $$3 = $$1.a($$2);
         jb.g.b(cnh.b($$3)).ifPresent($$2x -> $$0.add($$2x.d(cnh.a($$3))));
      }
   }
      ...
      try {
         return (Collection<tf>)fg.b(jb.f.p(), $$0, true)
            .map(
               ...
               $$0x -> $$0x.a().a().map($$0xx -> ((csm)$$0xx.a()).e().a(n.i)).collect(Collectors.toList())
            );
   ...
   @Nullable
   public bxz G() {
      return this.w instanceof bxz ? (bxz)this.H() : null;
   }
      ...
      if (this.u() && this.v.b("AttributeModifiers", 9)) {
         ...
         for (int $$3 = 0; $$3 < $$2.size(); $$3++) {
            ...
            if (!$$4.b("Slot", 8) || $$4.l("Slot").equals($$0.e())) {
               Optional<bka> $$5 = jb.v.b(aer.a($$4.l("AttributeName")));
               if (!$$5.isEmpty()) {
                  bkd $$6 = bkd.a($$4);
   ...
   public void a(bka $$0, bkd $$1, @Nullable bin $$2) {
      this.w();
   ...
   public boolean a(hr<csm> $$0, dfe $$1) {
      if (this.y == null) {
         this.y = new cgg("CanPlaceOn");
      }

      return this.y.a(this, $$0, $$1);
   }

   public boolean b(hr<csm> $$0, dfe $$1) {
      if (this.x == null) {
         this.x = new cgg("CanDestroy");
      }
   ...
   public void b(cpm $$0, biy $$1, int $$2) {
      this.d().a($$0, $$1, this, $$2);
   }
