...
public class ciy extends btq {
   ...
   private static final bsy bV = bsy.c(0.0F, 0.0F);
   private static final bsy bW = btb.d.n().a(0.5F).b(0.9875F);
   ...
   public static final akk<Byte> bG = ako.a(ciy.class, akm.a);
   public static final akk<ka> bH = ako.a(ciy.class, akm.n);
   public static final akk<ka> bI = ako.a(ciy.class, akm.n);
   public static final akk<ka> bJ = ako.a(ciy.class, akm.n);
   public static final akk<ka> bK = ako.a(ciy.class, akm.n);
   public static final akk<ka> bL = ako.a(ciy.class, akm.n);
   public static final akk<ka> bM = ako.a(ciy.class, akm.n);
   private static final Predicate<bsv> cb = $$0 -> $$0 instanceof cou && ((cou)$$0).v() == cou.a.a;
   ...
   public ciy(btb<? extends ciy> $$0, dbz $$1) {
      super($$0, $$1);
   }

   public ciy(dbz $$0, double $$1, double $$2, double $$3) {
      this(btb.d, $$0);
      this.a_($$1, $$2, $$3);
   }

   public static bux.a s() {
      return dU().a(buy.v, 0.0);
   }
   ...
   @Override
   protected void q() {
      for (bsv $$1 : this.dP().a(this, this.cK(), cb)) {
         if (this.g($$1) <= 0.2) {
            $$1.h(this);
         }
      }
   ...
   private btc k(evs $$0) {
      ...
      if ($$3 >= 0.1 && $$3 < 0.1 + ($$2 ? 0.8 : 0.45) && this.c($$4)) {
         $$1 = btc.c;
      } else if ($$3 >= 0.9 + ($$2 ? 0.3 : 0.0) && $$3 < 0.9 + ($$2 ? 1.0 : 0.7) && this.c(btc.e)) {
         $$1 = btc.e;
      } else if ($$3 >= 0.4 && $$3 < 0.4 + ($$2 ? 1.0 : 0.8) && this.c(btc.d)) {
         $$1 = btc.d;
      } else if ($$3 >= 1.6 && this.c(btc.f)) {
         $$1 = btc.f;
      } else if (!this.c(btc.a) && this.c(btc.b)) {
         $$1 = btc.b;
      }
   ...
   private boolean f(btc $$0) {
      return (this.cf & 1 << $$0.d()) != 0 || $$0.a() == btc.a.a && !this.v();
   }

   private boolean a(cmy $$0, btc $$1, cuq $$2, bqu $$3) {
      cuq $$4 = this.a($$1);
   ...
   public boolean a(bro $$0, float $$1) {
      if (this.dP().B || this.dK()) {
         ...
         if (!$$2 && !$$3) {
            ...
            if ($$0.d() instanceof cmy $$4 && !$$4.gd().e) {
               return false;
            }
   ...
   private void h(bro $$0) {
      cuq $$1 = new cuq(cut.uF);
      $$1.b(km.g, this.ah());
      dfa.a(this.dP(), this.dp(), $$1);
      this.i($$0);
   }

   private void i(bro $$0) {
      this.M();
      this.g($$0);
   ...
   public boolean u(bsv $$0) {
      return $$0 instanceof cmy && !this.dP().a((cmy)$$0, this.dp());
   }
   ...
   @Override
   public btq.a eL() {
      return new btq.a(awa.aB, awa.aB);
   }
   ...
   public evs k(float $$0) {
      if (this.z()) {
         evn $$1 = this.v(false).a(this.dn());
         iz $$2 = this.dp();
         int $$3 = Integer.MIN_VALUE;

         for (iz $$4 : iz.c(iz.a($$1.a, $$1.b, $$1.c), iz.a($$1.d, $$1.e, $$1.f))) {
            int $$5 = Math.max(this.dP().a(dci.b, $$4), this.dP().a(dci.a, $$4));
            if ($$5 == 15) {
               return evs.b($$4);
            }
