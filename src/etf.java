...
public class etf {
   ...
   public etf(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<etg> $$1) throws IOException {
   ...
   public List<etg> a(Path $$0) throws IOException {
      List<etg> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<etg> a(Path $$0, boolean $$1) throws IOException {
      List<etg> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<etg> $$1) throws IOException {
