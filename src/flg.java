...
public interface flg {
   flg a(float var1, float var2, float var3);

   flg a(int var1, int var2, int var3, int var4);

   flg a(float var1, float var2);

   flg a(int var1, int var2);

   flg b(int var1, int var2);

   flg b(float var1, float var2, float var3);
   ...
   default flg a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default flg a(int $$0) {
      return this.a(ayh.b($$0), ayh.c($$0), ayh.d($$0), ayh.a($$0));
   }

   default flg d(int $$0) {
      return this.a(ayh.c($$0, -1));
   }
   ...
   default void a(fld.a $$0, gst $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(fld.a $$0, gst $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      int[] $$10 = $$1.b();
      Vector3fc $$11 = $$1.d().s();
      Matrix4f $$12 = $$0.a();
      ...
      try {
         ByteBuffer $$19 = $$18.malloc(flb.b.getVertexSize());
         ...
         for (int $$21 = 0; $$21 < $$15; $$21++) {
            ...
            int $$34 = ayh.a($$16, (int)$$28, (int)$$29, (int)$$30);
            int $$35 = grk.b($$7[$$21], $$17);
   ...
   default flg a(Vector3f $$0) {
      return this.a($$0.x(), $$0.y(), $$0.z());
   }

   default flg a(fld.a $$0, Vector3f $$1) {
      return this.a($$0, $$1.x(), $$1.y(), $$1.z());
   }

   default flg a(fld.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default flg a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a($$4.x(), $$4.y(), $$4.z());
   }

   default flg b(fld.a $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.a($$1, $$2, $$3, new Vector3f());
      return this.b($$4.x(), $$4.y(), $$4.z());
   }

   default flg b(fld.a $$0, Vector3f $$1) {
