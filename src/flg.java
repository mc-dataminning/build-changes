...
public class flg implements Comparable<flg> {
   private static final Map<String, flg> h = Maps.newHashMap();
   private static final Map<feo.a, flg> i = Maps.newHashMap();
   ...
   private final feo.a m;
   private final String n;
   private feo.a o;
   private boolean p;
   private int q;

   public static void a(feo.a $$0) {
      flg $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(feo.a $$0, boolean $$1) {
      flg $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (flg $$0 : h.values()) {
         if ($$0.o.a() == feo.b.a && $$0.o.b() != feo.bv.b()) {
            $$0.a(feo.a(fli.Q().aO().h(), $$0.o.b()));
         }
      }
   }
   ...
   public flg(String $$0, int $$1, String $$2) {
      this($$0, feo.b.a, $$1, $$2);
   }

   public flg(String $$0, feo.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(feo.a $$0) {
      this.o = $$0;
   }

   public int a(flg $$0) {
      return this.n.equals($$0.n) ? hfz.a(this.l).compareTo(hfz.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(flg $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(feo.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == feo.bv.b() ? this.o.a() == feo.b.b && this.o.b() == $$1 : this.o.a() == feo.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == feo.b.c && this.o.b() == $$0;
   }
