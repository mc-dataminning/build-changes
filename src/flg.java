public class flg extends fmb {
   private final flw a;

   flg(fii $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, flw $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cbn $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dr();
            if (this.h > $$1) {
   ...
   public static class a implements fle<iy> {
      ...
      public flb a(iy $$0, fii $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new flg($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements fle<iy> {
      ...
      public flb a(iy $$0, fii $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         flb $$8 = new flg($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
