...
public class flg {
   private static final akf a = new akf("advancements/title_box");
   ...
   private final axi r;
   private final int s;
   private final List<axi> t;
   private final fcu u;
   @Nullable
   private flg v;
   private final List<flg> w = Lists.newArrayList();
   @Nullable
   private ah x;
   private final int y;
   private final int z;

   public flg(fle $$0, fcu $$1, ag $$2, ar $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = tt.a().a($$1.h.a($$3.a(), 163));
      this.y = axw.d($$3.f() * 28.0F);
      this.z = axw.d($$3.g() * 27.0F);
      int $$4 = $$2.a().f().a();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = tt.a().a(this.a(wv.a($$3.b().f(), xp.a.a($$3.e().a())), $$7));
   ...
   private static float a(fdg $$0, List<wx> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<wx> a(ws $$0, int $$1) {
      fdg $$2 = this.u.h.b();
      List<wx> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<wx> $$6 = $$2.b($$0, $$1 - $$5, xp.a);
