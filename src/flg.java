...
public class flg {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dgd)MoreObjects.firstNonNull(this.b.r.i(), dgd.b)).b());
               }
   ...
   private void a(dwv $$0, ji $$1, @Nullable tq $$2) {
   ...
   private void a(aku $$0, fay $$1, @Nullable tq $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().b();
         boolean $$5 = fen.a(flh.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!fen.a(flh.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (fen.a(flh.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = af.c();
            this.e = af.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof fxt) || ((fxt)$$6).u <= af.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               flp.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aL_() instanceof foz) || !((foz)$$6.aL_()).c();
            if ($$7) {
               if (fui.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  boolean $$8 = this.b.n.av().c() == flj.a;
                  this.b.n.av().a(flj.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$8);
                  }
         ...
         label197: {
            ...
            label153:
            if (!$$13) {
               if (this.b.z instanceof fud $$14 && !$$14.m()) {
                  break label153;
               }
