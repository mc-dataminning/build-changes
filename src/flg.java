...
public class flg {
   ...
   public flg(Supplier<String> $$0, Consumer<String> $$1, Supplier<String> $$2, Consumer<String> $$3, Predicate<String> $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static Supplier<String> a(fgo $$0) {
      return () -> b($$0);
   }

   public static String b(fgo $$0) {
      return n.a($$0.o.a().replaceAll("\\r", ""));
   }

   public static Consumer<String> c(fgo $$0) {
      return $$1 -> a($$0, $$1);
   }
   ...
   public void a(int $$0, boolean $$1, flg.a $$2) {
      switch ($$2) {
         case a:
            this.a($$0, $$1);
            break;
   ...
   public void b(int $$0, boolean $$1) {
      this.f = fgz.a(this.a.get(), $$0, this.f, true);
      this.c($$1);
   }

   public void a(int $$0, flg.a $$1) {
      switch ($$1) {
         case a:
            this.e($$0);
            break;
   ...
   public void d(int $$0) {
      int $$1 = fgz.a(this.a.get(), $$0, this.f, true);
      this.e($$1 - this.f);
   }
