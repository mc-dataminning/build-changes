...
public class bzv extends bur implements bjd, bjw {
   ...
   private static final aee<Integer> ca = aeh.a(bzv.class, aeg.b);
   private static final aee<Boolean> cb = aeh.a(bzv.class, aeg.k);
   private static final aee<Boolean> cc = aeh.a(bzv.class, aeg.k);
   ...
   public void a(@Nullable ape $$0) {
      this.cd.a(true);
      if ($$0 != null) {
         this.dL().a(null, this, apd.wr, $$0, 0.5F, 1.0F);
      }
   }
   ...
   protected Vector3f a(biq $$0, bir $$1, float $$2) {
      ...
      float $$4 = this.aQ.b();
      float $$5 = 0.12F * arw.b($$4 * 1.5F) * 2.0F * $$3;
   ...
   protected void b(gw $$0, dfj $$1) {
      this.a(this.bl() ? apd.wp : apd.wo, 1.0F, 1.0F);
   }
   ...
   public void l() {
      if (this.y() && this.ag.a(140) == 0) {
         this.a(apd.wk, 1.0F, this.eW());
      } else if (this.ga() && this.ag.a(60) == 0) {
         this.a(apd.wl, 1.0F, this.eW());
      }
      ...
      if (!this.fT()) {
         ...
         label36: {
            ...
            dfj $$1 = this.bh();
            $$2 = $$0.a(aps.aT) || $$1.a(aps.aT) || this.b(apx.b) > 0.0;
   ...
   private void gd() {
      if (this.bl()) {
         ehs $$0 = ehs.a(this);
         if ($$0.a(cxi.c, this.dl(), true) && !this.dL().b_(this.dl().c()).a(apx.b)) {
            this.c(true);
         } else {
   ...
   @Override
   protected apc w() {
      return !this.ga() && !this.y() ? apd.wj : null;
   }
   ...
   public bgy b(cbu $$0, bgx $$1) {
      ...
      if (!$$2 && this.i() && !this.bO() && !$$0.fH()) {
         ...
         if (!$$3.a()) {
            ...
            if ($$2 && !this.aS()) {
               this.dL().a(null, this.dq(), this.ds(), this.dw(), apd.wq, this.da(), 1.0F, 1.0F + (this.ag.i() - this.ag.i()) * 0.2F);
            }
