...
public class dpd extends dpf {
   ...
   private static void a(dbw $$0, iz $$1, dsa $$2, dpd $$3, dpd.a $$4) {
      if ($$3.b) {
         $$3.a++;
      }
   ...
   public static void a(dbw $$0, iz $$1, dsa $$2, dpd $$3) {
      a($$0, $$1, $$2, $$3, dpd::b);
   }

   public static void b(dbw $$0, iz $$1, dsa $$2, dpd $$3) {
      a($$0, $$1, $$2, $$3, dpd::a);
   }
      ...
      if (!this.n.B) {
         for (btn $$2 : this.m) {
            if ($$2.bD() && !$$2.dK() && $$0.a($$2.dn(), 32.0)) {
               $$2.dS().a(ccr.D, this.n.Z());
            }
         }
      }
   }

   private static boolean a(iz $$0, List<btn> $$1) {
      for (btn $$2 : $$1) {
   ...
   private static void a(dbw $$0, iz $$1, List<btn> $$2) {
      $$2.stream().filter($$1x -> a($$1, $$1x)).forEach(dpd::a);
   }

   private static void b(dbw $$0, iz $$1, List<btn> $$2) {
   ...
   private static boolean a(iz $$0, btn $$1) {
      return $$1.bD() && !$$1.dK() && $$0.a($$1.dn(), 48.0) && $$1.ak().a(aws.c);
   }

   private static void a(btn $$0) {
      $$0.b(new bsa(bsc.x, 60));
   }

   @FunctionalInterface
   interface a {
      void run(dbw var1, iz var2, List<btn> var3);
   }
}
