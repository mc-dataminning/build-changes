...
@Deprecated
public class dpd extends doo<dpd.a> {
   private static final dgb a = cuc.nc.o();

   public dpd(Codec<dpd.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(doq<dpd.a> $$0) {
      ht $$1 = $$0.e();
      crt $$2 = $$0.b();
      ate $$3 = $$0.d();
      dpd.a $$4 = $$0.f();
   ...
   public static record a(dst b, dst c) implements dqs {
      public static final Codec<dpd.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(dst.a.fieldOf("fluid").forGetter(dpd.a::a), dst.a.fieldOf("barrier").forGetter(dpd.a::b)).apply($$0, dpd.a::new)
      );
