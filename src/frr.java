...
public enum frr implements fds {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static feu a(int $$0, int $$1, frr.a $$2) {
      feu $$3 = new feu(feu.a.a, $$0, $$1, false);
   ...
   private frr(final Supplier<feu> $$0) {
      this.c = $$0.get();
   }
