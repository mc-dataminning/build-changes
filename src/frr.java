...
public class frr {
   ...
   private static final ww h = ww.c("chat.deleted_marker").a(n.h, n.u);
   private final fof i;
   private final axw<String> j = new axw<>(100);
   private final List<fny> k = Lists.newArrayList();
   private final List<fny.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<frr.a> o = new ArrayList<>();
   ...
   public void a(frc $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            if ($$33 > 0L) {
               ...
               $$0.a(-2, 0, $$9 + 4, 9, $$35 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, ww.a("chat.queue", $$33), 0, 1, 16777215 + ($$34 << 24));
               $$0.c().b();
            }
   ...
   private void a(frc $$0, int $$1, int $$2, fnz.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fny.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.n.n().c() == cqp.c;
   }
   ...
   public void a(ww $$0) {
      this.a($$0, null, this.i.W() ? fnz.b() : fnz.a());
   }

   public void a(ww $$0, @Nullable xi $$1, @Nullable fnz $$2) {
      fny $$3 = new fny(this.i.m.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(fny $$0) {
      ...
      List<ayw> $$3 = frv.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fny.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private frr.a b(xi $$0) {
      int $$1 = this.i.m.e();
      ListIterator<fny> $$2 = this.k.listIterator();
   ...
   private fny d(fny $$0) {
      return new fny($$0.b(), h, null, fnz.a());
   }
   ...
   private void n() {
      ...
      for (fny $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public fnz c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fny.a $$1, fnz $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fnz.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.z instanceof fwe;
   }
   ...
   public frr.b k() {
      return new frr.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(frr.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<fny> $$0, List<String> $$1, List<frr.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
