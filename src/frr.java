...
public class frr extends fmy {
   private static final Logger a = LogUtils.getLogger();
   private static final ToIntFunction<ala<dbt>> b = ac.a(new Reference2IntOpenHashMap(), $$0 -> {
      $$0.put(dbt.h, -13408734);
      $$0.put(dbt.i, -10075085);
      $$0.put(dbt.j, -8943531);
   ...
   @Nullable
   public static frr a(ffa $$0, BooleanConsumer $$1, DataFixer $$2, epr.c $$3, boolean $$4) {
      try {
         frx $$5 = $$0.x();
         atw $$6 = atz.a($$3);

         frr var10;
         try (aly $$7 = $$5.a($$3.h(), false, $$6)) {
            epx $$8 = $$7.d();
            jw.b $$9 = $$7.c().a();
            $$3.a($$9, $$8);
            var10 = new frr($$1, $$2, $$3, $$8.J(), $$4, $$9);
         }
   ...
   private frr(BooleanConsumer $$0, DataFixer $$1, epr.c $$2, dbx $$3, boolean $$4, jw $$5) {
      super(xl.a("optimizeWorld.title", $$3.a()));
      this.c = $$0;
      this.d = new bqd($$2, $$1, $$5, $$4, false);
   }
   ...
   public void a(fgm $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.d.e() > 0) {
         ...
         for (ala<dbt> $$9 : this.d.c()) {
            int $$10 = ayu.d(this.d.a($$9) * (float)($$5 - $$4));
         ...
         xl $$13 = xl.a("optimizeWorld.progress.percentage", ayu.d(this.d.d() * 100.0F));
