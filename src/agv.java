...
public class agv {
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a(
                                       ...
                                       .then(du.a("at").then(du.a("targets", ee.b()).fork($$2, $$0x -> {
                                          ...
                                          for (biq $$2x : ee.c($$0x, "targets")) {
                                             $$1x.add(((dt)$$0x.getSource()).a((akq)$$2x.dL()).a($$2x.dj()).a($$2x.bF()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("positioned")
                                       ...
                                       .then(du.a("over").then(du.a("heightmap", eh.a()).redirect($$2, $$0x -> {
                                          ehn $$1x = ((dt)$$0x.getSource()).d();
                                          akq $$2x = ((dt)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(hw.b($$3), hw.b($$4))) {
                                             throw fk.a.create();
                                          } else {
                                             int $$5 = $$2x.a(eh.a($$0x, "heightmap"), arw.a($$3), arw.a($$4));
                                             return ((dt)$$0x.getSource()).a(new ehn($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
               ...
               .then(du.a("summon").then(du.a("entity", eq.a($$1, jc.s)).suggests(gm.d).redirect($$2, $$0x -> a((dt)$$0x.getSource(), eq.e($$0x, "entity"))))))
            .then(a($$2, du.a("on")))
      );
   }
         ...
         du.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)du.a("id", es.a())
                     .suggests(agf.a)
                     .then(du.a("value").redirect($$0, $$1x -> a((dt)$$1x.getSource(), agf.a($$1x), true, $$2))))
                  .then(du.a("max").redirect($$0, $$1x -> a((dt)$$1x.getSource(), agf.a($$1x), false, $$2)))
            )
      );
   ...
   private static dt a(dt $$0, Collection<String> $$1, eij $$2, boolean $$3) {
      eim $$4 = $$0.l().aF();
      return $$0.a(($$4x, $$5, $$6) -> {
         for (String $$7 : $$1) {
            eil $$8 = $$4.c($$7, $$2);
   ...
   private static dt a(dt $$0, afu $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4, $$5) -> {
         int $$6 = $$3 ? $$5 : ($$4 ? 1 : 0);
         if ($$2) {
            $$1.a($$6);
   ...
   private static dt a(dt $$0, ajg $$1, ej.g $$2, IntFunction<rq> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5, $$6) -> {
         try {
            qw $$7 = $$1.a();
            int $$8 = $$4 ? $$6 : ($$5 ? 1 : 0);
   ...
   private static boolean a(akq $$0, gw $$1) {
      cpc $$2 = new cpc($$1);
      dhq $$3 = $$0.k().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.D() == akj.d && $$0.c($$2.a());
   }
                                    ...
                                    du.a("pos", fk.a())
                                       .then(
                                          a(
                                             ...
                                             du.a("block", fg.a($$3)),
                                             $$2,
                                             $$0x -> fg.a($$0x, "block").test(new dfn(((dt)$$0x.getSource()).e(), fk.a($$0x, "pos"), true))
                                          )
                                       )
                                 )
                           ))
                                 ...
                                 .then(
                                    du.a("pos", fk.a())
                                       .then(
                                          a(
                                             $$0,
                                             du.a("biome", et.a($$3, jc.ap)),
                                             $$2,
                                             $$0x -> et.a($$0x, "biome", jc.ap).test(((dt)$$0x.getSource()).e().s(fk.a($$0x, "pos")))
                                          )
                                       )
                                 )
                           ))
               ...
               du.a("entity")
                  .then(
                     ((RequiredArgumentBuilder)du.a("entities", ee.b()).fork($$0, $$1x -> a($$1x, $$2, !ee.c($$1x, "entities").isEmpty())))
                        .executes(a($$2, (agv.a)($$0x -> ee.c($$0x, "entities").size())))
                  )
            ))
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)du.a("path", ej.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), ej.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (agv.a)($$1xx -> a($$4.a($$1xx), ej.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static Command<dt> a(boolean $$0, agv.a $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
   ...
   private static int a(ajg $$0, ej.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }
   ...
   private static boolean a(CommandContext<dt> $$0, BiPredicate<Integer, Integer> $$1) throws CommandSyntaxException {
      ...
      eij $$3 = el.a($$0, "targetObjective");
      String $$4 = ev.a($$0, "source");
      eij $$5 = el.a($$0, "sourceObjective");
      eim $$6 = ((dt)$$0.getSource()).l().aF();
      if ($$6.b($$2, $$3) && $$6.b($$4, $$5)) {
         eil $$7 = $$6.c($$2, $$3);
         eil $$8 = $$6.c($$4, $$5);
   ...
   private static boolean a(CommandContext<dt> $$0, cl.d $$1) throws CommandSyntaxException {
      String $$2 = ev.a($$0, "target");
      eij $$3 = el.a($$0, "targetObjective");
      eim $$4 = ((dt)$$0.getSource()).l().aF();
      return !$$4.b($$2, $$3) ? false : $$1.d($$4.c($$2, $$3).b());
   }

   private static boolean a(dt $$0, efp $$1) {
      akq $$2 = $$0.e();
      ecw $$3 = new ecw.a($$2).a(efb.f, $$0.d()).b(efb.a, $$0.f()).a(efa.d);
      ecq $$4 = new ecq.a($$3).a(Optional.empty());
      $$4.b(ecq.a($$1));
      return $$1.test($$4);
   }
   ...
   private static ArgumentBuilder<dt, ?> a(CommandNode<dt> $$0, ArgumentBuilder<dt, ?> $$1, boolean $$2, agv.b $$3) {
   ...
   private static OptionalInt a(akq $$0, gw $$1, gw $$2, gw $$3, boolean $$4) throws CommandSyntaxException {
      dva $$5 = dva.a($$1, $$2);
      dva $$6 = dva.a($$3, $$3.a($$5.b()));
   ...
   private static RedirectModifier<dt> a(Function<biq, Optional<biq>> $$0) {
      return $$1 -> {
         dt $$2 = (dt)$$1.getSource();
         biq $$3 = $$2.f();
   ...
   private static RedirectModifier<dt> b(Function<biq, Stream<biq>> $$0) {
      return $$1 -> {
         dt $$2 = (dt)$$1.getSource();
         biq $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<dt> a(CommandNode<dt> $$0, LiteralArgumentBuilder<dt> $$1) {
      return (LiteralArgumentBuilder<dt>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              du.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<biq, Optional<biq>>)($$0x -> $$0x instanceof bjo $$1x ? Optional.ofNullable($$1x.O_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              du.a("leasher")
                                 .fork(
                                    $$0,
                                    a((Function<biq, Optional<biq>>)($$0x -> $$0x instanceof bji $$1x ? Optional.ofNullable($$1x.fS()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           du.a("target")
                              .fork($$0, a((Function<biq, Optional<biq>>)($$0x -> $$0x instanceof bkc $$1x ? Optional.ofNullable($$1x.q()) : Optional.empty())))
                        ))
                     .then(
                        du.a("attacker")
   ...
   private static dt a(dt $$0, he.c<biu<?>> $$1) throws CommandSyntaxException {
      biq $$2 = ais.a($$0, $$1, $$0.d(), new qw(), true);
      return $$0.a($$2);
   }
