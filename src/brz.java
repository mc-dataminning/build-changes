...
public class brz extends bsd {
   public static final MapCodec<brz> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static brz a(float $$0, float $$1, float $$2, float $$3) {
      return new brz($$0, $$1, $$2, $$3);
   }

   private brz(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(bac $$0, float $$1, float $$2, float $$3, float $$4) {
      return azu.a(azu.c($$0, $$1, $$2), $$3, $$4);
   }
