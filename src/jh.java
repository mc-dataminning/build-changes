...
public final class jh {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ac.a($$0, 4).map(jh::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static yg<ByteBuf, UUID> g = new yg<ByteBuf, UUID>() {
