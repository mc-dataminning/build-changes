...
public class fvl extends fvi {
   ...
   private int J;
   private final fqh K = new fqh(false);

   public fvl(boolean $$0, Runnable $$1) {
      super(flx.a);
      this.z = $$0;
      this.A = $$1;
      if (!$$0) {
   ...
   private void c(fpc $$0) {
      $$0.a(gnh::I, a, 0, 0, 0.0F, 0.0F, this.n, this.o, this.n, this.o);
   }
