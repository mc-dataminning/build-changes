public class fvl extends fwg {
   private final fwb a;

   fvl(fsa $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fwb $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         ciu $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dt();
            if (this.h > $$1) {
   ...
   public static class a implements fvj<kf> {
      ...
      public fvg a(kf $$0, fsa $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fvl($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements fvj<kf> {
      ...
      public fvg a(kf $$0, fsa $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fvg $$8 = new fvl($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
