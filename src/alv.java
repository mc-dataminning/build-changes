...
public class alv implements AutoCloseable {
   ...
   private alv(URL $$0, alv.c $$1, URL $$2, alv.b $$3, URL $$4, alv.b $$5, String $$6, alv.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? arn.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static alv a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = arn.a($$0);
            URI $$2 = new URI(arn.i($$1, "apiServer"));
            String $$3 = arn.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = arn.a($$1, "ruleId", 1);
               String $$5 = arn.a($$1, "serverId", "");
               String $$6 = arn.a($$1, "roomId", "Java:Chat");
               int $$7 = arn.a($$1, "hashesToDrop", -1);
               int $$8 = arn.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = arn.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, alv.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<alh> a(GameProfile $$0, String $$1, alv.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(alh.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = arn.a($$4, "response", false);
            if ($$5) {
               return alh.a($$1);
            } else {
               String $$6 = arn.a($$4, "hashed", null);
               if ($$6 == null) {
                  return alh.b($$1);
               } else {
                  JsonArray $$7 = arn.v($$4, "hashes");
                  to $$8 = this.a($$1, $$7, $$2);
                  return new alh($$1, $$8);
               }
            }
   ...
   private to a(String $$0, JsonArray $$1, alv.a $$2) {
      if ($$1.isEmpty()) {
         return to.c;
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new alv.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public alu a(GameProfile $$0) {
      return new alv.d($$0);
   }
   ...
   public interface a {
      alv.a a = ($$0, $$1) -> false;
      alv.a b = ($$0, $$1) -> $$0.length() == $$1;

      static alv.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static alv.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements alu {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bfr<Runnable> $$1 = bfr.a(alv.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         alv.this.a(this.c, alv.this.g, alv.this.h, this.d);
      }

      @Override
      public void b() {
         alv.this.a(this.c, alv.this.i, alv.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<alh>> a(List<String> $$0) {
         List<CompletableFuture<alh>> $$1 = $$0.stream().map($$0x -> alv.this.a(this.c, $$0x, alv.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<alh> a(String $$0) {
         return alv.this.a(this.c, $$0, alv.this.l, this.d);
      }
   }
