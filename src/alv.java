...
public final class alv<E> implements Codec<jq<E>> {
   private final aly<? extends kd<E>> a;
   private final Codec<E> b;
   private final boolean c;

   public static <E> alv<E> a(aly<? extends kd<E>> $$0, Codec<E> $$1) {
      return a($$0, $$1, true);
   }

   public static <E> alv<E> a(aly<? extends kd<E>> $$0, Codec<E> $$1, boolean $$2) {
      return new alv<>($$0, $$1, $$2);
   }

   private alv(aly<? extends kd<E>> $$0, Codec<E> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
   ...
   public <T> DataResult<T> a(jq<E> $$0, DynamicOps<T> $$1, T $$2) {
      if ($$1 instanceof alx<?> $$3) {
         ...
         if ($$4.isPresent()) {
            ...
            return (DataResult<T>)$$0.d().map($$2x -> alz.a.encode($$2x.a(), $$1, $$2), $$2x -> this.b.encode($$2x, $$1, $$2));
         }
      }
   ...
   public <T> DataResult<Pair<jq<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof alx<?> $$2) {
         ...
         if ($$3.isEmpty()) {
            ...
            jr<E> $$4 = $$3.get();
            DataResult<Pair<alz, T>> $$5 = alz.a.decode($$0, $$1);
            if ($$5.result().isEmpty()) {
               return !this.c ? DataResult.error(() -> "Inline definitions not allowed here") : this.b.decode($$0, $$1).map($$0x -> $$0x.mapFirst(jq::a));
            } else {
               Pair<alz, T> $$6 = (Pair<alz, T>)$$5.result().get();
               aly<E> $$7 = aly.a(this.a, (alz)$$6.getFirst());
               return $$4.a($$7)
