...
public enum ezc implements enf {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static eoe a(int $$0, int $$1, ezc.a $$2) {
      eoe $$3 = new eoe(eoe.a.a, $$0, $$1, false);
