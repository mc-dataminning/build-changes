...
public class ezc {
   ...
   public ezc(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ezc(ezh $$0, ezh $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static ezc a(elj $$0) {
      return new ezc((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static ezc a(ezh $$0) {
      return new ezc($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static ezc a(jg $$0, jg $$1) {
      return new ezc(
   ...
   public ezc a(double $$0) {
      return new ezc($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ezc b(double $$0) {
      return new ezc(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ezc c(double $$0) {
      return new ezc(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ezc d(double $$0) {
      return new ezc(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ezc e(double $$0) {
      return new ezc(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ezc f(double $$0) {
      return new ezc(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ezc b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ezc c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ezc d(double $$0, double $$1, double $$2) {
      return new ezc(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ezc f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ezc h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ezh> b(ezh $$0, ezh $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<ezh> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, ezh $$6, ezh $$7) {
      double[] $$8 = new double[]{1.0};
      double $$9 = $$7.d - $$6.d;
      double $$10 = $$7.e - $$6.e;
      double $$11 = $$7.f - $$6.f;
      jl $$12 = a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$8, null, $$9, $$10, $$11);
      if ($$12 == null) {
   ...
   @Nullable
   public static ezd a(Iterable<ezc> $$0, ezh $$1, ezh $$2, jg $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ezd($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jl a(ezc $$0, ezh $$1, double[] $$2, @Nullable jl $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jl a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, ezh $$6, double[] $$7, @Nullable jl $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
         $$8 = a($$7, $$8, $$9, $$10, $$11, $$0, $$1, $$4, $$2, $$5, jl.e, $$6.d, $$6.e, $$6.f);
      } else if ($$9 < -1.0E-7) {
         $$8 = a($$7, $$8, $$9, $$10, $$11, $$3, $$1, $$4, $$2, $$5, jl.f, $$6.d, $$6.e, $$6.f);
      }

      if ($$10 > 1.0E-7) {
         $$8 = a($$7, $$8, $$10, $$11, $$9, $$1, $$2, $$5, $$0, $$3, jl.a, $$6.e, $$6.f, $$6.d);
      } else if ($$10 < -1.0E-7) {
         $$8 = a($$7, $$8, $$10, $$11, $$9, $$4, $$2, $$5, $$0, $$3, jl.b, $$6.e, $$6.f, $$6.d);
      }

      if ($$11 > 1.0E-7) {
         $$8 = a($$7, $$8, $$11, $$9, $$10, $$2, $$0, $$3, $$1, $$4, jl.c, $$6.f, $$6.d, $$6.e);
      } else if ($$11 < -1.0E-7) {
         $$8 = a($$7, $$8, $$11, $$9, $$10, $$5, $$0, $$3, $$1, $$4, jl.d, $$6.f, $$6.d, $$6.e);
      }
   ...
   public boolean a(ezh $$0, List<ezc> $$1) {
      ezh $$2 = this.f();
      ezh $$3 = $$2.e($$0);

      for (ezc $$4 : $$1) {
         ezc $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public ezh f() {
      return new ezh(azj.d(0.5, this.a, this.d), azj.d(0.5, this.b, this.e), azj.d(0.5, this.c, this.f));
   }

   public ezh g() {
      return new ezh(azj.d(0.5, this.a, this.d), this.b, azj.d(0.5, this.c, this.f));
   }
   ...
   public ezh i() {
      return new ezh(this.d, this.e, this.f);
   }

   public static ezc a(ezh $$0, double $$1, double $$2, double $$3) {
      return new ezc($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
}
