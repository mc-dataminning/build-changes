...
public class ezc extends eyy<ceg> {
   ...
   private final List<ezc.a> G = Lists.newArrayList();
   @Nullable
   bht H;
   @Nullable
   bht I;

   public ezc(final ceg $$0, cbl $$1, tf $$2) {
      super($$0, $$1, $$2);
      this.c = 230;
      this.k = 219;
      $$0.a(new cep() {
         @Override
         public void a(ced $$0x, int $$1, cix $$2) {
         }

         @Override
         public void a(ced $$0x, int $$1, int $$2) {
            ezc.this.H = $$0.m();
            ezc.this.I = $$0.n();
         }
      });
   ...
   private <T extends ese & ezc.a> void a(T $$0) {
      this.d($$0);
      this.G.add($$0);
   }
   ...
   protected void aC_() {
      super.aC_();
      this.G.clear();
      this.a(new ezc.c(this.t + 164, this.u + 107));
      this.a(new ezc.b(this.t + 190, this.u + 107));

      for (int $$0 = 0; $$0 <= 2; $$0++) {
         int $$1 = dcg.a[$$0].length;
         int $$2 = $$1 * 22 + ($$1 - 1) * 2;

         for (int $$3 = 0; $$3 < $$1; $$3++) {
            bht $$4 = dcg.a[$$0][$$3];
            ezc.d $$5 = new ezc.d(this.t + 76 + $$3 * 24 - $$2 / 2, this.u + 22 + $$0 * 25, $$4, true, $$0);
            $$5.i = false;
            this.a($$5);
         }
      }
      ...
      int $$6 = 3;
      int $$7 = dcg.a[3].length + 1;
      int $$8 = $$7 * 22 + ($$7 - 1) * 2;

      for (int $$9 = 0; $$9 < $$7 - 1; $$9++) {
         bht $$10 = dcg.a[3][$$9];
         ezc.d $$11 = new ezc.d(this.t + 167 + $$9 * 24 - $$8 / 2, this.u + 47, $$10, false, 3);
         $$11.i = false;
         this.a($$11);
      }

      ezc.d $$12 = new ezc.g(this.t + 167 + ($$7 - 1) * 24 - $$8 / 2, this.u + 47, dcg.a[0][0]);
      $$12.j = false;
      this.a($$12);
   }
   ...
   protected void a(erv $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(new cix(cja.nV), $$4 + 20, $$5 + 109);
      $$0.a(new cix(cja.nL), $$4 + 41, $$5 + 109);
      $$0.a(new cix(cja.nK), $$4 + 41 + 22, $$5 + 109);
      $$0.a(new cix(cja.nU), $$4 + 42 + 44, $$5 + 109);
      $$0.a(new cix(cja.nQ), $$4 + 42 + 66, $$5 + 109);
      $$0.c().b();
   }
   ...
   class b extends ezc.f {
      public b(int $$0, int $$1) {
         super($$0, $$1, ezc.D, te.e);
      }
   ...
   class c extends ezc.f {
      public c(int $$0, int $$1) {
         super($$0, $$1, ezc.C, te.d);
      }

      @Override
      public void c() {
         ezc.this.f.J().b(new ach(Optional.ofNullable(ezc.this.H), Optional.ofNullable(ezc.this.I)));
         ezc.this.f.s.q();
      }

      @Override
      public void a(int $$0) {
         this.i = ezc.this.p.o() && ezc.this.H != null;
      }
   }

   class d extends ezc.e {
      ...
      public void a(int $$0) {
         this.i = this.a < $$0;
         this.b(this.d == (this.c ? ezc.this.H : ezc.this.I));
      }
   ...
   abstract static class e extends ery implements ezc.a {
      private boolean a;
      ...
      protected abstract void a(erv var1);
   ...
   abstract static class f extends ezc.e {
      private final aer a;
