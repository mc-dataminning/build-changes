...
public class aph {
   ...
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> wz.b("commands.data.get.invalid", $$0));
   private static final DynamicCommandExceptionType f = new DynamicCommandExceptionType($$0 -> wz.b("commands.data.get.unknown", $$0));
   private static final SimpleCommandExceptionType g = new SimpleCommandExceptionType(wz.c("commands.data.get.multiple"));
   private static final DynamicCommandExceptionType h = new DynamicCommandExceptionType($$0 -> wz.b("commands.data.modify.expected_object", $$0));
   private static final DynamicCommandExceptionType i = new DynamicCommandExceptionType($$0 -> wz.b("commands.data.modify.expected_value", $$0));
   private static final Dynamic2CommandExceptionType j = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> wz.b("commands.data.modify.invalid_substring", $$0, $$1)
   );
   public static final List<Function<String, aph.c>> a = ImmutableList.of(api.a, apf.a, apj.a);
   public static final List<aph.c> b = a.stream().map($$0 -> $$0.apply("target")).collect(ImmutableList.toImmutableList());
   public static final List<aph.c> c = a.stream().map($$0 -> $$0.apply("source")).collect(ImmutableList.toImmutableList());
   ...
   public static void a(CommandDispatcher<et> $$0) {
      ...
      for (aph.c $$2 : b) {
         ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
            ...
            .then(
               a(
                  (BiConsumer<ArgumentBuilder<et, ?>, aph.b>)(($$0x, $$1x) -> $$0x.then(
                           eu.a("insert")
                              .then(
                        ...
                        .then(eu.a("set").then($$1x.create(($$0xx, $$1xx, $$2x, $$3) -> $$2x.a($$1xx, (uy)Iterables.getLast($$3)))))
                        .then(eu.a("merge").then($$1x.create(($$0xx, $$1xx, $$2x, $$3) -> {
                           ...
                           Collection<uy> $$7 = $$2x.a($$1xx, ub::new);
                           int $$8 = 0;

                           for (uy $$9 : $$7) {
                              if (!($$9 instanceof ub $$10)) {
                                 throw h.create($$9);
                              }
   ...
   private static List<uy> a(List<uy> $$0, aph.d $$1) throws CommandSyntaxException {
   ...
   private static ArgumentBuilder<et, ?> a(BiConsumer<ArgumentBuilder<et, ?>, aph.b> $$0) {
         ...
         $$2.a(
            ...
            $$2x -> {
               ...
               $$0.accept($$3, $$1xx -> eu.a("value").then(eu.a("value", fm.a()).executes($$2xx -> {
                     List<uy> $$3x = Collections.singletonList(fm.a($$2xx, "value"));
   ...
   private static List<uy> a(CommandContext<et> $$0, aph.c $$1) throws CommandSyntaxException {
      apg $$2 = $$1.a($$0);
      return Collections.singletonList($$2.a());
   }

   private static List<uy> b(CommandContext<et> $$0, aph.c $$1) throws CommandSyntaxException {
      apg $$2 = $$1.a($$0);
      fl.g $$3 = fl.a($$0, "sourcePath");
      return $$3.a($$2.a());
   }

   private static int a(CommandContext<et> $$0, aph.c $$1, aph.a $$2, List<uy> $$3) throws CommandSyntaxException {
      apg $$4 = $$1.a($$0);
   ...
   private static int a(et $$0, apg $$1, fl.g $$2) throws CommandSyntaxException {
      ub $$3 = $$1.a();
      int $$4 = $$2.c($$3);
      if ($$4 == 0) {
         throw d.create();
   ...
   public static uy a(fl.g $$0, apg $$1) throws CommandSyntaxException {
   ...
   private static int b(et $$0, apg $$1, fl.g $$2) throws CommandSyntaxException {
      uy $$3 = a($$2, $$1);
      int $$4;
      if ($$3 instanceof ur) {
         $$4 = ayo.a(((ur)$$3).j());
   ...
   private static int a(et $$0, apg $$1, fl.g $$2, double $$3) throws CommandSyntaxException {
      uy $$4 = a($$2, $$1);
      if (!($$4 instanceof ur)) {
         throw e.create($$2.toString());
      } else {
         int $$5 = ayo.a(((ur)$$4).j() * $$3);
         $$0.a(() -> $$1.a($$2, $$3, $$5), false);
         return $$5;
      }
   }

   private static int a(et $$0, apg $$1) throws CommandSyntaxException {
      ub $$2 = $$1.a();
      $$0.a(() -> $$1.a((uy)$$2), false);
      return 1;
   }

   private static int a(et $$0, apg $$1, ub $$2) throws CommandSyntaxException {
      ub $$3 = $$1.a();
      if (fl.g.a($$2, 0)) {
         throw fl.b.create();
      } else {
   ...
   @FunctionalInterface
   interface a {
      int modify(CommandContext<et> var1, ub var2, fl.g var3, List<uy> var4) throws CommandSyntaxException;
   }

   @FunctionalInterface
   interface b {
      ArgumentBuilder<et, ?> create(aph.a var1);
   }

   public interface c {
      apg a(CommandContext<et> var1) throws CommandSyntaxException;
