...
public class abo implements xg<zb> {
   private static final int a = 12;
   private final iz b;
   private final short[] c;
   private final djp[] d;

   public abo(iz $$0, ShortSet $$1, dlx $$2) {
      this.b = $$0;
      int $$3 = $$1.size();
      this.c = new short[$$3];
      this.d = new djp[$$3];
   ...
   public void a(uj $$0) {
      ...
      for (int $$1 = 0; $$1 < this.c.length; $$1++) {
         $$0.a((long)cwy.i(this.d[$$1]) << 12 | (long)this.c[$$1]);
      }
   }
   ...
   public void a(BiConsumer<hx, djp> $$0) {
      hx.a $$1 = new hx.a();
