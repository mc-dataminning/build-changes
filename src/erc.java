...
public class erc {
   ...
   public static final erc.a bv;

   public static erc.a a(int $$0, int $$1) {
      return $$0 == -1 ? erc.b.b.a($$1) : erc.b.a.a($$0);
   }

   public static erc.a a(String $$0) {
      if (erc.a.e.containsKey($$0)) {
         return erc.a.e.get($$0);
      } else {
         for (erc.b $$1 : erc.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final erc.b b;
      private final int c;
      private final awd<vq> d;
      static final Map<String, erc.a> e = Maps.newHashMap();

      a(String $$0, erc.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new awd<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? vq.b($$2.toUpperCase(Locale.ROOT)) : vq.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? vq.b($$2) : vq.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> sr.a().b($$1) ? vq.c($$1) : vq.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<erc.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vq> g;

      private static void a(erc.b $$0, String $$1, int $$2) {
         erc.a $$3 = new erc.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, vq> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public erc.a a(int $$0) {
         return (erc.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
