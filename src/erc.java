...
public abstract class erc<M extends eqz<M>> {
   private final dfo i;
   protected final dxw a;
   ...
   protected final Long2ObjectMap<dxo> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected erc(dfo $$0, dxw $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dxo a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dxo a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dxo c(long $$0) {
      dxo $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected dxo g(long $$0) {
      dxo $$1 = (dxo)this.g.get($$0);
      return $$1 != null ? $$1 : new dxo();
   }
   ...
   protected void a(erf<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<dxo>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dxo> $$6 = (Entry<dxo>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dxo $$8 = (dxo)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dxo $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = kj.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, erc.a.a($$9, erc.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public erc.b l(long $$0) {
      return erc.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static erc.b c(byte $$0) {
         if ($$0 == 0) {
            return erc.b.a;
         } else {
            return a($$0) ? erc.b.c : erc.b.b;
         }
      }
   }
