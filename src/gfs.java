...
public class gfs extends dyu {
   ...
   public gfs(gfw $$0, int $$1) {
      this.e = $$0;
      this.b = new dyw($$0, new dfm(0, 0), $$0.K_().e(mc.aI).b(dhp.b));
      this.c = new esm(this, true, $$0.G_().g());
      this.d = new gfs.a(b($$1));
   }
   ...
   private static boolean a(@Nullable dza $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         dfm $$3 = $$0.f();
   ...
   @Nullable
   public dza b(int $$0, int $$1, dzr $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         dza $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public dza a(int $$0, int $$1, vl $$2, tq $$3, Consumer<acw.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         dza $$6 = this.d.b.get($$5);
         dfm $$7 = new dfm($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new dza(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<dza> b;
      ...
      void a(int $$0, @Nullable dza $$1) {
         dza $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            gfs.this.e.a($$2);
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  dza $$5 = gfs.this.d.b.get(gfs.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     dfm $$6 = $$5.f();
            ...
            gfs.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
