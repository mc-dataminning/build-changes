...
public class bwg extends bvh<btq> {
   ...
   protected boolean c(are $$0, btq $$1, long $$2) {
   ...
   private void a(btq $$0, iz $$1) {
      $$0.dS().a(ccs.m, new ccv($$1, this.g, 0));
   }

   private boolean b(are $$0, btq $$1) {
      return this.c($$0, $$1) || this.a($$1).isPresent();
   }

   private boolean c(are $$0, btq $$1) {
      iz $$2 = $$1.dp();
      iz $$3 = $$2.d();
      return this.a($$0, $$2) || this.a($$0, $$3);
   }

   private boolean d(are $$0, btq $$1) {
   ...
   private Optional<iz> a(btq $$0) {
      return $$0.dS().c(ccs.w);
   }

   private boolean e(are $$0, btq $$1) {
      return !this.c($$0, $$1) && this.i <= 0;
   }

   private boolean f(are $$0, btq $$1) {
