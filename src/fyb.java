public class fyb extends fyz<cun> {
   ...
   private static final ww K = ww.c("container.repair.expensive");
   private frz L;
   private final cqs M;

   public fyb(cun $$0, cqr $$1, ww $$2) {
      super($$0, $$1, $$2, J);
      this.M = $$1.k;
      this.v = 60;
   }
   ...
   protected void G() {
      ...
      this.L = new frz(this.p, $$0 + 62, $$1 + 24, 103, 12, ww.c("container.repair"));
      this.L.f(false);
      this.L.m(-1);
      this.L.n(-1);
      this.L.d(false);
   ...
   protected void b(frc $$0, int $$1, int $$2) {
      ...
      if ($$3 > 0) {
         ...
         if ($$3 >= 40 && !this.m.t.fU()) {
            ...
            $$5 = ww.a("container.repair.cost", $$3);
   ...
   protected void a(frc $$0, float $$1, int $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      $$0.a(gpn::H, this.z.b(0).h() ? G : H, this.C + 59, this.D + 20, 110, 16);
   }

   @Override
   public void d(frc $$0, int $$1, int $$2, float $$3) {
      this.L.a($$0, $$1, $$2, $$3);
   }
