...
public abstract class ahx {
   ...
   private final ahx.a f = new ahx.a();
   private final ahx.b g = new ahx.b(8);
   private final ail h = new ail();
   private final ahx.c i = new ahx.c(32);
   ...
   protected ahx(Executor $$0, Executor $$1) {
      ...
      aht $$3 = new aht(ImmutableList.of($$2), $$0, 4);
      this.k = $$3;
      this.l = $$3.a($$2, true);
      this.m = $$3.a($$2);
      this.o = $$1;
   ...
   protected void a() {
      this.p++;
      ObjectIterator<Entry<apo<aij<?>>>> $$0 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$0.hasNext()) {
         Entry<apo<aij<?>>> $$1 = (Entry<apo<aij<?>>>)$$0.next();
         Iterator<aij<?>> $$2 = ((apo)$$1.getValue()).iterator();
         boolean $$3 = false;
         ...
         if ($$3) {
            this.f.b($$1.getLongKey(), a((apo<aij<?>>)$$1.getValue()), false);
         }

         if (((apo)$$1.getValue()).isEmpty()) {
            $$0.remove();
         }
      }
   }
   ...
   public boolean a(ahr $$0) {
      ...
      if (!this.j.isEmpty()) {
         ...
         if (!this.n.isEmpty()) {
            ...
            while ($$3.hasNext()) {
               long $$4 = $$3.nextLong();
               if (this.g($$4).stream().anyMatch($$0x -> $$0x.a() == aik.c)) {
                  ahp $$5 = $$0.a($$4);
                  if ($$5 == null) {
                  ...
                  $$6.thenAccept($$1x -> this.o.execute(() -> this.m.a(aht.a(() -> {
                        }, $$4, false))));
               }
            }
   ...
   public <T> void c(aik<T> $$0, clt $$1, int $$2, T $$3) {
      aij<T> $$4 = new aij<>($$0, ahq.a(ahy.b) - $$2, $$3);
      long $$5 = $$1.a();
      this.a($$5, $$4);
      this.h.a($$5, $$4);
   }
   ...
   private apo<aij<?>> g(long $$0) {
      return (apo<aij<?>>)this.e.computeIfAbsent($$0, $$0x -> apo.a(4));
   }

   protected void a(clt $$0, boolean $$1) {
      aij<clt> $$2 = new aij<>(aik.d, ahr.b, $$0);
      long $$3 = $$0.a();
      if ($$1) {
         this.a($$3, $$2);
         this.h.a($$3, $$2);
   ...
   public void b(hx $$0, aig $$1) {
      clt $$2 = $$0.r();
      long $$3 = $$2.a();
      ObjectSet<aig> $$4 = (ObjectSet<aig>)this.d.get($$3);
      $$4.remove($$1);
      if ($$4.isEmpty()) {
         this.d.remove($$3);
   ...
   protected String e(long $$0) {
      apo<aij<?>> $$1 = (apo<aij<?>>)this.e.get($$0);
   ...
   public void e() {
      ImmutableSet<aik<?>> $$0 = ImmutableSet.of(aik.h, aik.g, aik.e);
      ObjectIterator<Entry<apo<aij<?>>>> $$1 = this.e.long2ObjectEntrySet().fastIterator();

      while ($$1.hasNext()) {
         Entry<apo<aij<?>>> $$2 = (Entry<apo<aij<?>>>)$$1.next();
         Iterator<aij<?>> $$3 = ((apo)$$2.getValue()).iterator();
         boolean $$4 = false;
         ...
         if ($$4) {
            this.f.b($$2.getLongKey(), a((apo<aij<?>>)$$2.getValue()), false);
         }

         if (((apo)$$2.getValue()).isEmpty()) {
            $$1.remove();
         }
      }
   }
   ...
   class a extends ahu {
      ...
      protected int b(long $$0) {
         apo<aij<?>> $$1 = (apo<aij<?>>)ahx.this.e.get($$0);
         if ($$1 == null) {
   ...
   class b extends ahu {
      ...
      private boolean d(long $$0) {
         ObjectSet<aig> $$1 = (ObjectSet<aig>)ahx.this.d.get($$0);
      ...
      private void a(String $$0) {
         try (FileOutputStream $$1 = new FileOutputStream(new File($$0))) {
            ...
            ahx.a.error("Failed to dump chunks to {}", $$0, var9);
         }
      }
   }

   class c extends ahx.b {
      private int g;
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            aij<?> $$4 = new aij<>(aik.c, ahx.b, new clt($$0));
            if ($$3) {
      ...
      public void a() {
         ...
         if (!this.i.isEmpty()) {
            ...
            while ($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  ahx.this.k.onLevelChange(new clt($$1), () -> this.h.get($$1), $$3, $$1x -> {
