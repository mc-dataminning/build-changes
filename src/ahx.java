...
public class ahx {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tl.b("commands.publish.alreadyPublished", $$0));

   public static void a(CommandDispatcher<dt> $$0) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)du.a("publish").requires($$0x -> $$0x.c(4)))
               .executes($$0x -> a((dt)$$0x.getSource(), ars.a(), false, null)))
            .then(
               ((RequiredArgumentBuilder)du.a("allowCommands", BoolArgumentType.bool())
                     .executes($$0x -> a((dt)$$0x.getSource(), ars.a(), BoolArgumentType.getBool($$0x, "allowCommands"), null)))
                  .then(
                     ((RequiredArgumentBuilder)du.a("gamemode", ef.a())
                           .executes($$0x -> a((dt)$$0x.getSource(), ars.a(), BoolArgumentType.getBool($$0x, "allowCommands"), ef.a($$0x, "gamemode"))))
                        .then(
   ...
   private static int a(dt $$0, int $$1, boolean $$2, @Nullable cpy $$3) throws CommandSyntaxException {
      if ($$0.l().p()) {
