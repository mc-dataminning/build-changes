   ...
   private static int a(dt $$0, int $$1, boolean $$2) {
      ...
      for (int $$11 = $$7; $$11 <= $$8; $$11++) {
         for (int $$12 = $$9; $$12 <= $$10; $$12++) {
            cox $$13 = new cox($$12, $$11);
            dhl $$14 = $$4.a($$12, $$11, false);
            if ($$14 != null && (!$$2 || !$$14.s())) {
               for (gw $$15 : gw.b($$13.d(), $$3.C_(), $$13.e(), $$13.f(), $$3.aj() - 1, $$13.g())) {
                  $$3.a($$15, csr.a.n(), 16);
               }
            }
         }
      ...
      bfm<Runnable> $$16 = bfm.a(ac.f(), "worldgen-resetchunks");
      long $$17 = System.currentTimeMillis();
      int $$18 = ($$1 * 2 + 1) * ($$1 * 2 + 1);
      UnmodifiableIterator var33 = ImmutableList.of(dhf.f, dhf.g, dhf.h, dhf.i, dhf.j, dhf.k).iterator();

      while (var33.hasNext()) {
         dhf $$19 = (dhf)var33.next();
         ...
         for (int $$22 = $$6.f - $$1; $$22 <= $$6.f + $$1; $$22++) {
            for (int $$23 = $$6.e - $$1; $$23 <= $$6.e + $$1; $$23++) {
               cox $$24 = new cox($$23, $$22);
               dhl $$25 = $$4.a($$23, $$22, false);
               if ($$25 != null && (!$$2 || !$$25.s())) {
                  List<dha> $$26 = Lists.newArrayList();
                  int $$27 = Math.max(1, $$19.e());

                  for (int $$28 = $$24.f - $$27; $$28 <= $$24.f + $$27; $$28++) {
                     for (int $$29 = $$24.e - $$27; $$29 <= $$24.e + $$27; $$29++) {
                        dha $$30 = $$4.a($$29, $$28, $$19.d(), true);
                        dha $$31;
                        if ($$30 instanceof dhk) {
                           $$31 = new dhk(((dhk)$$30).C(), true);
                        } else if ($$30 instanceof dhl) {
                           $$31 = new dhk((dhl)$$30, true);
                        } else {
                           $$31 = $$30;
                        }
                  ...
                  $$21 = $$21.thenComposeAsync($$5x -> $$19.a($$16::a, $$3, $$4.g(), $$3.p(), $$4.a(), $$0xx -> {
                        ...
                        if ($$19 == dhf.g) {
                           $$1xx.left().ifPresent($$0xxx -> dkn.a($$0xxx, dhf.b));
                        }
      ...
      for (int $$35 = $$6.f - $$1; $$35 <= $$6.f + $$1; $$35++) {
         for (int $$36 = $$6.e - $$1; $$36 <= $$6.e + $$1; $$36++) {
            cox $$37 = new cox($$36, $$35);
            dhl $$38 = $$4.a($$36, $$35, false);
            if ($$38 != null && (!$$2 || !$$38.s())) {
               for (gw $$39 : gw.b($$37.d(), $$3.C_(), $$37.e(), $$37.f(), $$3.aj() - 1, $$37.g())) {
                  $$4.a($$39);
               }
            }
         }
