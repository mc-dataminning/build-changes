...
public class ahx {
   ...
   private static int a(dt $$0, Collection<akr> $$1, Collection<cmk<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
   ...
   private static int b(dt $$0, Collection<akr> $$1, Collection<cmk<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
