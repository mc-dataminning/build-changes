...
public class pk implements mg {
   private final mi d;
   private final CompletableFuture<js.a> e;

   public pk(mi $$0, CompletableFuture<js.a> $$1) {
      this.e = $$1;
      this.d = $$0;
   }
   ...
   public CompletableFuture<?> a(me $$0) {
      return this.e.thenCompose($$1 -> {
         ...
         return CompletableFuture.allOf(alg.a.stream().flatMap($$3 -> this.a($$0, $$1, $$2, (alg.d<?>)$$3).stream()).toArray(CompletableFuture[]::new));
      });
   }

   private <T> Optional<CompletableFuture<?>> a(me $$0, js.a $$1, DynamicOps<JsonElement> $$2, alg.d<T> $$3) {
      alk<? extends kd<T>> $$4 = $$3.a();
      return $$1.a($$4).map($$4x -> {
         mi.a $$5 = this.d.a($$4);
