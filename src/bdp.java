...
public class bdp implements bdq {
   ...
   private static final bdp j = new bdp();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bdo $$0) {
      URL $$1 = bdp.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bdo $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bds a = new bds(() -> bdp.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bdp.this.k && $$0.getState() == RecordingState.STOPPED) {
