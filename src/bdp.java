...
public class bdp extends DataFix {
   ...
   public bdp(Schema $$0, String $$1) {
      super($$0, false);
      this.a = $$1;
   }

   private <T> Dynamic<T> a(Dynamic<T> $$0) {
      $$0 = $$0.update("front_text", bdp::b);
      $$0 = $$0.update("back_text", bdp::b);
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getInputSchema().getChoiceType(biq.s, this.a);
