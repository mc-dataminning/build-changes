...
public class ams {
                           ...
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)eu.a("damageType", fs.a($$1, lv.s))
                                    .executes(
                                       $$0x -> a(
                                             ...
                                             new bsb(fs.a($$0x, "damageType", lv.s))
                                          )
                                    ))
                                 .then(
                                    eu.a("at")
                                          ...
                                          eu.a("location", gw.a())
                                             .executes(
                                                $$0x -> a(
                                                      ...
                                                      fg.a($$0x, "target"),
                                                      FloatArgumentType.getFloat($$0x, "amount"),
                                                      new bsb(fs.a($$0x, "damageType", lv.s), gw.a($$0x, "location"))
                                                   )
                                             )
                                       )
                                 ))
                                       ...
                                       ((RequiredArgumentBuilder)eu.a("entity", fg.a())
                                             .executes(
                                                $$0x -> a(
                                                      ...
                                                      fg.a($$0x, "target"),
                                                      FloatArgumentType.getFloat($$0x, "amount"),
                                                      new bsb(fs.a($$0x, "damageType", lv.s), fg.a($$0x, "entity"))
                                                   )
                                             ))
                                          .then(
                                             eu.a("from")
                                                   ...
                                                   eu.a("cause", fg.a())
                                                      .executes(
                                                         $$0x -> a(
                                                               ...
                                                               fg.a($$0x, "target"),
                                                               FloatArgumentType.getFloat($$0x, "amount"),
                                                               new bsb(fs.a($$0x, "damageType", lv.s), fg.a($$0x, "entity"), fg.a($$0x, "cause"))
                                                            )
                                                      )
                                                )
                                          )
   ...
   private static int a(et $$0, btj $$1, float $$2, bsb $$3) throws CommandSyntaxException {
      if ($$1.a($$3, $$2)) {
