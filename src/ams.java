...
public class ams {
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a(
                                       ...
                                       .then(eu.a("at").then(eu.a("targets", fg.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bsq $$2x : fg.c($$0x, "targets")) {
                                             $$1x.add(((et)$$0x.getSource()).a((aqt)$$2x.dQ()).a($$2x.do()).a($$2x.bN()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)eu.a("positioned")
                                          ...
                                          .then(eu.a("as").then(eu.a("targets", fg.b()).fork($$2, $$0x -> {
                                             ...
                                             for (bsq $$2x : fg.c($$0x, "targets")) {
                                                $$1x.add(((et)$$0x.getSource()).a($$2x.do()));
                                             }

                                             return $$1x;
                                          }))))
                                       .then(eu.a("over").then(eu.a("heightmap", fj.a()).redirect($$2, $$0x -> {
                                          eww $$1x = ((et)$$0x.getSource()).d();
                                          aqt $$2x = ((et)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(kf.b($$3), kf.b($$4))) {
                                             throw gp.a.create();
                                          } else {
                                             int $$5 = $$2x.a(fj.a($$0x, "heightmap"), ayn.a($$3), ayn.a($$4));
                                             return ((et)$$0x.getSource()).a(new eww($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
         ...
         eu.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)eu.a("id", fu.a())
                     .suggests(amc.a)
                     .then(eu.a("value").redirect($$0, $$1x -> a((et)$$1x.getSource(), amc.a($$1x), true, $$2))))
                  .then(eu.a("max").redirect($$0, $$1x -> a((et)$$1x.getSource(), amc.a($$1x), false, $$2)))
            )
      );
   ...
   private static et a(et $$0, Collection<exz> $$1, exs $$2, boolean $$3) {
      eya $$4 = $$0.l().aK();
      return $$0.a(($$4x, $$5) -> {
         for (exz $$6 : $$1) {
            exy $$7 = $$4.c($$6, $$2);
   ...
   private static et a(et $$0, alr $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static et a(et $$0, apf $$1, fl.g $$2, IntFunction<ux> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            ua $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(aqt $$0, jd $$1) {
      dcb $$2 = new dcb($$1);
      dvg $$3 = $$0.l().a($$2.e, $$2.f);
      return $$3 == null ? false : $$3.D() == aqk.d && $$0.c($$2.a());
   }
                                          ...
                                          eu.a("pos", gp.a())
                                             .then(
                                                a(
                                                   ...
                                                   eu.a("block", gl.a($$3)),
                                                   $$2,
                                                   $$0x -> gl.a($$0x, "block").test(new dte(((et)$$0x.getSource()).e(), gp.a($$0x, "pos"), true))
                                                )
                                             )
                                       )
                                 ))
                     ...
                     eu.a("entity")
                        .then(
                           ((RequiredArgumentBuilder)eu.a("entities", fg.b()).fork($$0, $$1x -> a($$1x, $$2, !fg.c($$1x, "entities").isEmpty())))
                              .executes(a($$2, (ams.b)($$0x -> fg.c($$0x, "entities").size())))
                        )
                  ))
               .then(eu.a("predicate").then(a($$0, eu.a("predicate", fv.c($$3)).suggests(f), $$2, $$0x -> a((et)$$0x.getSource(), fv.c($$0x, "predicate"))))))
            .then(eu.a("function").then(eu.a("name", hb.a()).suggests(amx.b).fork($$0, new ams.d($$2)))))
         .then(
                                 ...
                                 eu.a("slots", gc.a())
                                    .then(
                                       ((RequiredArgumentBuilder)eu.a("item_predicate", hf.a($$3))
                                          ...
                                          .executes(a($$2, (ams.b)($$0x -> a(fg.b($$0x, "entities"), gc.a($$0x, "slots"), hf.a($$0x, "item_predicate")))))
                                    )
                              )
                        )
                  ))
                              ...
                              eu.a("slots", gc.a())
                                 .then(
                                    ((RequiredArgumentBuilder)eu.a("item_predicate", hf.a($$3))
                                       ...
                                       .executes(
                                          a($$2, (ams.b)($$0x -> a((et)$$0x.getSource(), gp.a($$0x, "pos"), gc.a($$0x, "slots"), hf.a($$0x, "item_predicate"))))
                                       )
                                 )
                           )
                     )
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)eu.a("path", fl.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), fl.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (ams.b)($$1xx -> a($$4.a($$1xx), fl.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static int a(Iterable<? extends bsq> $$0, crp $$1, Predicate<cuo> $$2) {
      int $$3 = 0;
   ...
   private static int a(et $$0, jd $$1, crp $$2, Predicate<cuo> $$3) throws CommandSyntaxException {
      int $$4 = 0;
      bqj $$5 = anc.a($$0, $$1, anc.b);
      int $$6 = $$5.b();
      IntList $$7 = $$2.a();
   ...
   private static Command<et> a(boolean $$0, ams.b $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((et)$$1x.getSource()).a(() -> wy.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw d.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((et)$$1x.getSource()).a(() -> wy.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw e.create($$2);
         }
   ...
   private static int a(apf $$0, fl.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<et> $$0, ams.e $$1) throws CommandSyntaxException {
      exz $$2 = fy.a($$0, "target");
      exs $$3 = fn.a($$0, "targetObjective");
      exz $$4 = fy.a($$0, "source");
      exs $$5 = fn.a($$0, "sourceObjective");
      eya $$6 = ((et)$$0.getSource()).l().aK();
      exw $$7 = $$6.d($$2, $$3);
      exw $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<et> $$0, dh.d $$1) throws CommandSyntaxException {
      exz $$2 = fy.a($$0, "target");
      exs $$3 = fn.a($$0, "targetObjective");
      eya $$4 = ((et)$$0.getSource()).l().aK();
      exw $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(et $$0, jm<euw> $$1) {
      aqt $$2 = $$0.e();
      ero $$3 = new ero.a($$2).a(euh.f, $$0.d()).b(euh.a, $$0.f()).a(eug.d);
      erl $$4 = new erl.a($$3).a(Optional.empty());
      $$4.b(erl.a($$1.a()));
      return $$1.a().test($$4);
   }
   ...
   private static ArgumentBuilder<et, ?> a(CommandNode<et> $$0, ArgumentBuilder<et, ?> $$1, boolean $$2, ams.c $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((et)$$2x.getSource()).a(() -> wy.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create();
         }
   ...
   private static int a(CommandContext<et> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((et)$$0.getSource()).a(() -> wy.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw d.create();
      }
   ...
   private static int b(CommandContext<et> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((et)$$0.getSource()).a(() -> wy.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(aqt $$0, jd $$1, jd $$2, jd $$3, boolean $$4) throws CommandSyntaxException {
      eje $$5 = eje.a($$1, $$2);
      eje $$6 = eje.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<et> a(Function<bsq, Optional<bsq>> $$0) {
      return $$1 -> {
         et $$2 = (et)$$1.getSource();
         bsq $$3 = $$2.f();
         return (Collection)($$3 == null ? List.of() : $$0.apply($$3).filter($$0xx -> !$$0xx.dL()).map($$1x -> List.of($$2.a($$1x))).orElse(List.of()));
      };
   }

   private static RedirectModifier<et> b(Function<bsq, Stream<bsq>> $$0) {
      return $$1 -> {
         et $$2 = (et)$$1.getSource();
         bsq $$3 = $$2.f();
         return $$3 == null ? List.of() : $$0.apply($$3).filter($$0xx -> !$$0xx.dL()).map($$2::a).toList();
      };
   }
   ...
   private static LiteralArgumentBuilder<et> a(CommandNode<et> $$0, LiteralArgumentBuilder<et> $$1) {
      return (LiteralArgumentBuilder<et>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              eu.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<bsq, Optional<bsq>>)($$0x -> $$0x instanceof btt $$1x ? Optional.ofNullable($$1x.P_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              eu.a("leasher")
                                 .fork(
                                    $$0,
                                    a((Function<bsq, Optional<bsq>>)($$0x -> $$0x instanceof btn $$1x ? Optional.ofNullable($$1x.ga()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           eu.a("target")
                              .fork($$0, a((Function<bsq, Optional<bsq>>)($$0x -> $$0x instanceof buk $$1x ? Optional.ofNullable($$1x.p()) : Optional.empty())))
                        ))
                     .then(
                        eu.a("attacker")
                           .fork($$0, a((Function<bsq, Optional<bsq>>)($$0x -> $$0x instanceof bsn $$1x ? Optional.ofNullable($$1x.T_()) : Optional.empty())))
                     ))
                  .then(eu.a("vehicle").fork($$0, a((Function<bsq, Optional<bsq>>)($$0x -> Optional.ofNullable($$0x.dd()))))))
               .then(eu.a("controller").fork($$0, a((Function<bsq, Optional<bsq>>)($$0x -> Optional.ofNullable($$0x.cR()))))))
            .then(
               eu.a("origin").fork($$0, a((Function<bsq, Optional<bsq>>)($$0x -> $$0x instanceof bul $$1x ? Optional.ofNullable($$1x.s()) : Optional.empty())))
            ))
         .then(eu.a("passengers").fork($$0, b((Function<bsq, Stream<bsq>>)($$0x -> $$0x.cT().stream()))));
   }

   private static et a(et $$0, jm.c<bsw<?>> $$1) throws CommandSyntaxException {
      bsq $$2 = aop.a($$0, $$1, $$0.d(), new ua(), true);
      return $$0.a($$2);
   }

   public static <T extends ev<T>> void a(
      T $$0, List<T> $$1, Function<T, T> $$2, IntPredicate $$3, ContextChain<T> $$4, @Nullable ua $$5, ht<T> $$6, ams.a<T, Collection<ig<T>>> $$7, hn $$8
   ) {
   ...
   static class d implements hq.a<et> {
      ...
      public void a(et $$0, List<et> $$1, ContextChain<et> $$2, hn $$3, ht<et> $$4) {
         ams.a($$0, $$1, amx::a, this.a, $$2, null, $$4, $$0x -> hb.a($$0x, "name"), $$3);
      }
   }
