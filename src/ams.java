...
class ams extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof amr && $$1 instanceof amr && $$0.equals($$1);
   }
   ...
   private static amr a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof amr) {
         return (amr)$$0;
      } else {
