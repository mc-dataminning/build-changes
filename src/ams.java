...
public interface ams {
   ams a = new ams() {
      ...
      @Override
      public void a(Consumer<cte> $$0) {
      }
   };

   static ams a(cte $$0, int $$1) {
      return new ams.a($$0, $$1);
   }

   static void a(ams $$0, ams $$1, Consumer<cte> $$2, Consumer<cte> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof ams.a $$4 && $$1 instanceof ams.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new cte($$10, $$11));
                     } else {
                        $$3.accept(new cte($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(cte b, int c) implements ams {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(ams.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return ams.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
