...
public class ams {
   public static void a(CommandDispatcher<eq> $$0) {
      ...
      dbz.a(
         new dbz.c() {
            @Override
            public <T extends dbz.g<T>> void a(dbz.e<T> $$0, dbz.f<T> $$1x) {
               $$1.then(
   ...
   static <T extends dbz.g<T>> int a(CommandContext<eq> $$0, dbz.e<T> $$1) {
      eq $$2 = (eq)$$0.getSource();
      T $$3 = $$2.l().aM().a($$1);
      $$3.b($$0, "value");
   ...
   static <T extends dbz.g<T>> int a(eq $$0, dbz.e<T> $$1) {
      T $$2 = $$0.l().aM().a($$1);
