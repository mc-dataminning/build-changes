...
public class fhn extends fhc implements fih {
   private static final fir d = new fir(new alf("widget/text_field"), new alf("widget/text_field_highlighted"));
   ...
   public fhn(fgp $$0, int $$1, int $$2, xp $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fhn(fgp $$0, int $$1, int $$2, int $$3, int $$4, xp $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fhn(fgp $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fhn $$5, xp $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, fnd.t());
   }
   ...
   public void b(fgr $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gdw.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
