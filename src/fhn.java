...
public abstract class fhn<E extends fhn.a<E>> extends fhk {
   ...
   private final List<E> p = new fhn.b();
   ...
   public fhn(fft $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wt.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected void a(fhf $$0) {
      RenderSystem.enableBlend();
      akk $$1 = this.c.r == null ? fnj.g : fnj.i;
      akk $$2 = this.c.r == null ? fnj.h : fnj.j;
   ...
   @Nullable
   protected E a(flw $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(flw $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void c(fhf $$0, int $$1, int $$2, float $$3) {
      int $$4 = this.s();
      int $$5 = this.b();
      int $$6 = this.d - 4;
      int $$7 = this.l();
   ...
   public flm.a u() {
      if (this.aK_()) {
         ...
         return this.v != null ? flm.a.b : flm.a.a;
      }
   }
   ...
   protected void a(flo $$0, E $$1) {
      List<E> $$2 = this.aG_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fln.b, wu.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fhn.a<E>> implements fjo {
      @Deprecated
      fhn<E> a;
      ...
      public abstract void a(fhf var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
