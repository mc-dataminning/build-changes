...
public class fhn extends fhy {
      ...
      try {
         ...
         if (ayp.d($$3, "lists")) {
            for (JsonElement $$5 : $$3.getAsJsonArray("lists")) {
               ...
               String $$7 = fju.b("playerList", $$6, null);
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fli.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fju.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fli.Q().b($$4)) {
               try {
