...
public class fhn {
   ...
   private static final Map<dxv.a, String> e = ac.a(new EnumMap<>(dxv.a.class), $$0 -> {
      $$0.put(dxv.a.a, "SW");
      $$0.put(dxv.a.b, "S");
      $$0.put(dxv.a.c, "OW");
      $$0.put(dxv.a.d, "O");
   ...
   private duj l;
   @Nullable
   private CompletableFuture<duj> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final blv r = new blv(1);
   private final blv s = new blv(bma.values().length);
   private final blv t = new blv(1);
   private final blv u = new blv(1);
   private final Map<blw, blv> v = Map.of(blw.a, this.s);
   private final fiw w;
   private final fiy x;
   private final fix y;
   private final fiv z;
   ...
   public fhn(ffg $$0) {
      ...
      this.g = new fhn.a();
      this.h = $$0.h;
      this.w = new fiw(this.h, this.r);
      this.x = new fiy(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fix(this.h, this.t);
      this.z = new fiv(this.h, this.u);
   }
   ...
   private void a(fgs $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.aw()) {
         ...
         dbz $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof arf ? ((arf)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, ayz.g($$15.dF()), ayz.g($$15.dH())));
         duj $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(dci.a, $$14);
            int $$30 = this.f.r.a(dci.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            duj $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dxv.a $$33 : dxv.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.am()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.u();
                  bqt $$37 = new bqt($$23.al(), $$23.aa(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dck.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<btt> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(btt.values())
   ...
   private static String a(ji<dcy> $$0) {
   ...
   private dbz r() {
      return (dbz)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.af()))), this.f.r);
   }
   ...
   private duj s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, duy.n, false).thenApply($$0x -> (duj)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eys.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ffg.Q().aO().k(), ffg.Q().aO().l(), eys.a()),
            eys.c(),
            eys.d()
         }
      );
      if (this.f.aw()) {
         ...
         if (this.i.c() == evq.a.b) {
            ...
            for (Entry<dtg<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == evq.a.b) {
            ...
            for (Entry<dtg<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dtg<?>, Comparable<?>> $$0) {
      dtg<?> $$1 = $$0.getKey();
