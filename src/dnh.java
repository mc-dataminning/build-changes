...
public class dnh {
   ...
   private final Map<Character, Predicate<dnf>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dnh a(char $$0, Predicate<dnf> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dng b() {
      return new dng(this.c());
   }

   private Predicate<dnf>[][][] c() {
      this.d();
      Predicate<dnf>[][][] $$0 = (Predicate<dnf>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dnf>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
