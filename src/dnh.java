...
public class dnh extends dnm<dpo> {
   public dnh(Codec<dpo> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dno<dpo> $$0) {
      cqf $$1 = $$0.b();
      gu $$2 = $$0.e();
      dpo $$3 = $$0.f();
      aru $$4 = $$0.d();
   ...
   private void a(cqf $$0, aru $$1, gu $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, dpo $$9) {
      Optional<djy> $$10 = djy.a($$0, $$2, $$9.b, dni::c, dni::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((cpo)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((cpo)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               dni.a($$0, $$2.h($$11.getAsInt() - 1), ha.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               dni.a($$0, $$2.h($$17.getAsInt() + 1), ha.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(cpo $$0, gu $$1) {
      return $$0.a_($$1).a(csm.H);
   }

   private int a(aru $$0, int $$1, int $$2, float $$3, int $$4, dpo $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(cqf $$0, gu $$1) {
      dez $$2 = $$0.a_($$1);
      if (!$$2.a(csm.G) && !$$2.a(csm.rt) && !$$2.a(csm.rs)) {
         if ($$0.a_($$1.c()).u().a(apq.a)) {
            return false;
         } else {
            for (ha $$3 : ha.c.a) {
               if (!this.a((cpm)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((cpm)$$0, $$1.d());
         }
      } else {
         return false;
      }
   ...
   private void a(cqf $$0, gu $$1, int $$2, ha $$3) {
      gu.a $$4 = $$1.j();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, dpo $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
