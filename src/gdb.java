...
public class gdb extends fxu {
   private static final Logger a = LogUtils.getLogger();
   private static final ToIntFunction<alf<div>> b = af.a(new Reference2IntOpenHashMap(), $$0 -> {
      $$0.put(div.i, -13408734);
      $$0.put(div.j, -10075085);
      $$0.put(div.k, -8943531);
   ...
   @Nullable
   public static gdb a(fos $$0, BooleanConsumer $$1, DataFixer $$2, eyn.c $$3, boolean $$4) {
      try {
         gdi $$5 = $$0.x();
         aun $$6 = auq.a($$3);
   ...
   private gdb(BooleanConsumer $$0, DataFixer $$1, eyn.c $$2, eyt $$3, boolean $$4, js $$5) {
      super(wy.a("optimizeWorld.title", $$3.J().a()));
      this.c = $$0;
      this.d = new btp($$2, $$1, $$3, $$5, $$4, false);
   }
