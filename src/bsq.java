...
public abstract class bsq<R extends Runnable> implements brz, bsw<R>, Executor {
   ...
   @Override
   public List<brw> bw() {
      return ImmutableList.of(brw.a(this.b + "-pending-tasks", brv.b, this::by));
   }
