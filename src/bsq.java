...
public class bsq extends bsu implements buo {
   private static final Logger d = LogUtils.getLogger();
   private static final int e = 5;
   private static final akk<Float> f = ako.a(bsq.class, akm.d);
   private static final akk<Boolean> g = ako.a(bsq.class, akm.k);
   private static final akk<lg> h = ako.a(bsq.class, akm.l);
   ...
   private cwq l = cwq.a;
   private final Map<bsu, Integer> m = Maps.newHashMap();
   private int n = 600;
   private int o = 20;
   private int p = 20;
   private int q;
   ...
   public bsq(bta<? extends bsq> $$0, dby $$1) {
      super($$0, $$1);
      this.ag = true;
   }

   public bsq(dby $$0, double $$1, double $$2, double $$3) {
      this(bta.b, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   private void u() {
      ...
      if ($$0 instanceof lb $$1) {
         int $$2 = this.l.equals(cwq.a) ? 0 : this.l.b();
      ...
      if (this.dP().B) {
         ...
         if (this.ai % 5 == 0) {
            ...
            if (!this.l.c()) {
               ...
               List<bsc> $$14 = Lists.newArrayList();
               if (this.l.e().isPresent()) {
                  for (bsc $$15 : this.l.e().get().a().a()) {
                     $$14.add(new bsc($$15.c(), $$15.a($$0x -> $$0x / 4), $$15.e(), $$15.f(), $$15.g()));
                  }
               }

               $$14.addAll(this.l.d());
               List<btp> $$16 = this.dP().a(btp.class, this.cK());
               if (!$$16.isEmpty()) {
                  for (btp $$17 : $$16) {
   ...
   protected void a(us $$0) {
      ...
      if ($$0.e("potion_contents")) {
         cwq.b.parse($$1, $$0.c("potion_contents")).resultOrPartial($$0x -> d.warn("Failed to parse area effect cloud potions: '{}'", $$0x)).ifPresent(this::a);
      }
   }
   ...
   protected void b(us $$0) {
      ...
      if (!this.l.equals(cwq.a)) {
         vp $$2 = (vp)cwq.b.encodeStart($$1, this.l).getOrThrow();
