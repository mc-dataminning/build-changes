...
public abstract class hhv extends ftx {
   ...
   private final List<hhu> a = Lists.newArrayList();
   ...
   protected hhu a(hhu $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public xv l() {
      return xu.a(this.a.stream().map(hhu::a).collect(Collectors.toList()));
   }
}
