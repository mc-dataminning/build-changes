...
public abstract class bik extends DataFix {
   private final String a;

   public bik(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bhy.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bhy.B);
      Type<Pair<String, String>> $$2 = DSL.named(bhy.z.typeName(), bjm.a());
      if (!Objects.equals(this.getOutputSchema().getType(bhy.z), $$2)) {
