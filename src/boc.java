...
public class boc {
   ...
   private static void a(bok $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<duz, boo<boe>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((boo)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<duz, boo<boe>> $$3 : $$0) {
         boo<boe> $$4 = (boo<boe>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((duz)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bom> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bnr.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(boa $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), boc::a));
      $$1.add("chunksWritten", this.a($$0.m(), boc::a));
      return $$1;
   }
   ...
   private JsonElement c(boa $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), boc::a));
      $$1.add("received", this.a($$0.k(), boc::a));
      return $$1;
   }

   private <T> JsonElement a(boj<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bog> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bog>, ToDoubleFunction<bog>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bog::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bog::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bog::c));
      return $$1;
   }
}
