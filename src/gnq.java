...
public class gnq {
   public static final Set<asw<?>> a = Set.of(gpg.a);
   ...
   public gnq(akn $$0, int $$1, int $$2, int $$3) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public gnq.a a(List<gnp> $$0, int $$1, Executor $$2) {
      ...
      for (gnp $$7 : $$0) {
         ...
         if ($$8 < $$6) {
            b.warn("Texture {} with size {}x{} limits mip level from {} to {}", new Object[]{$$7.c(), $$7.a(), $$7.b(), ayf.f($$6), ayf.f($$8)});
            $$6 = $$8;
         }
   ...
   public CompletableFuture<gnq.a> a(atx $$0, akn $$1, int $$2, Executor $$3) {
      return this.a($$0, $$1, $$2, $$3, a);
   }

   public CompletableFuture<gnq.a> a(atx $$0, akn $$1, int $$2, Executor $$3, Collection<asw<?>> $$4) {
      gny $$5 = gny.create($$4);
   ...
   private Map<akn, gnv> a(gns<gnp> $$0, int $$1, int $$2) {
      Map<akn, gnv> $$3 = new HashMap<>();
      $$0.a(($$3x, $$4, $$5) -> $$3.put($$3x.c(), new gnv(this.c, $$3x, $$1, $$2, $$4, $$5)));
      return $$3;
   }

   public static record a(int a, int b, int c, gnv d, Map<akn, gnv> e, CompletableFuture<Void> f) {
