...
public class ack implements zd<abs> {
   public static final yu<vs, ack> a = zd.a(ack::a, ack::new);
   ...
   private final int i;
   private final List<ack.b> j;

   public ack(RootCommandNode<en> $$0) {
   ...
   private static void a(List<ack.b> $$0, BiPredicate<ack.b, IntSet> $$1) {
   ...
   private static void a(List<ack.b> $$0) {
      a($$0, ack.b::a);
      a($$0, ack.b::b);
   }
   ...
   private static List<ack.b> a(Object2IntMap<CommandNode<en>> $$0) {
      ObjectArrayList<ack.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static ack.b b(vs $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.l() : 0;
      ack.e $$4 = a($$0, $$1);
      return new ack.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static ack.e a(vs $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
   ...
   private static ack.b a(CommandNode<en> $$0, Object2IntMap<CommandNode<en>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<en> a(ee $$0) {
      return (RootCommandNode<en>)new ack.d($$0, this.j).a(this.i);
   }

   static class a implements ack.e {
      ...
      @Nullable
      private static ale a(@Nullable SuggestionProvider<en> $$0) {
         return $$0 != null ? ij.a($$0) : null;
      }

      a(String $$0, ie.a<?> $$1, @Nullable ale $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(vs $$0, ie.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends ie.a<A>> void a(vs $$0, ie<A, T> $$1, ie.a<A> $$2) {
         $$0.c(mf.u.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
   ...
   static class b {
      ...
      b(@Nullable ack.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements ack.e {
      private final String a;
