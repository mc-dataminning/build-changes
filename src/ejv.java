...
public abstract class ejv {
   ...
   protected ejv(eki $$0, int $$1, ejj $$2) {
      this.h = $$0;
      this.g = $$1;
      this.f = $$2;
   }

   public ejv(eki $$0, ub $$1) {
      this($$0, $$1.h("GD"), (ejj)ejj.a.parse(up.a, $$1.c("BB")).getOrThrow($$0x -> new IllegalArgumentException("Invalid boundingbox: " + $$0x)));
      int $$2 = $$1.h("O");
      this.a($$2 == -1 ? null : ji.b($$2));
   }

   protected static ejj a(int $$0, int $$1, int $$2, ji $$3, int $$4, int $$5, int $$6) {
      return $$3.o() == ji.a.c
         ? new ejj($$0, $$1, $$2, $$0 + $$4 - 1, $$1 + $$5 - 1, $$2 + $$6 - 1)
         : new ejj($$0, $$1, $$2, $$0 + $$6 - 1, $$1 + $$5 - 1, $$2 + $$4 - 1);
   }
   ...
   public final ub a(ekh $$0) {
      ub $$1 = new ub();
      $$1.a("id", lt.Q.b(this.k()).toString());
      ejj.a.encodeStart(up.a, this.f).resultOrPartial(a::error).ifPresent($$1x -> $$1.a("BB", $$1x));
      ji $$2 = this.i();
      $$1.a("O", $$2 == null ? -1 : $$2.e());
      $$1.a("GD", this.g);
      this.a($$0, $$1);
   ...
   protected abstract void a(ekh var1, ub var2);

   public void a(ejv $$0, ejw $$1, ayw $$2) {
   }

   public abstract void a(dds var1, ddq var2, duz var3, ayw var4, ejj var5, dcd var6, jd var7);
   ...
   protected void a(dds $$0, dtc $$1, int $$2, int $$3, int $$4, ejj $$5) {
      jd $$6 = this.b($$2, $$3, $$4);
      if ($$5.b($$6)) {
   ...
   protected dtc a(dcc $$0, int $$1, int $$2, int $$3, ejj $$4) {
      jd $$5 = this.b($$1, $$2, $$3);
      return !$$4.b($$5) ? dga.a.o() : $$0.a_($$5);
   }

   protected boolean b(dcz $$0, int $$1, int $$2, int $$3, ejj $$4) {
      jd $$5 = this.b($$1, $$2 + 1, $$3);
      return !$$4.b($$5) ? false : $$5.v() < $$0.a(dyy.a.c, $$5.u(), $$5.w());
   }

   protected void a(dds $$0, ejj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      for (int $$8 = $$3; $$8 <= $$6; $$8++) {
         for (int $$9 = $$2; $$9 <= $$5; $$9++) {
   ...
   protected void a(dds $$0, ejj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dtc $$8, dtc $$9, boolean $$10) {
   ...
   protected void a(dds $$0, ejj $$1, ejj $$2, dtc $$3, dtc $$4, boolean $$5) {
      this.a($$0, $$1, $$2.h(), $$2.i(), $$2.j(), $$2.k(), $$2.l(), $$2.m(), $$3, $$4, $$5);
   }

   protected void a(dds $$0, ejj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, ayw $$9, ejv.a $$10) {
      for (int $$11 = $$3; $$11 <= $$6; $$11++) {
         for (int $$12 = $$2; $$12 <= $$5; $$12++) {
            for (int $$13 = $$4; $$13 <= $$7; $$13++) {
   ...
   protected void a(dds $$0, ejj $$1, ejj $$2, boolean $$3, ayw $$4, ejv.a $$5) {
      this.a($$0, $$1, $$2.h(), $$2.i(), $$2.j(), $$2.k(), $$2.l(), $$2.m(), $$3, $$4, $$5);
   }

   protected void a(dds $$0, ejj $$1, ayw $$2, float $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9, dtc $$10, dtc $$11, boolean $$12, boolean $$13) {
   ...
   protected void a(dds $$0, ejj $$1, ayw $$2, float $$3, int $$4, int $$5, int $$6, dtc $$7) {
      if ($$2.i() < $$3) {
         this.a($$0, $$7, $$4, $$5, $$6, $$1);
      }
   }

   protected void a(dds $$0, ejj $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dtc $$8, boolean $$9) {
   ...
   protected boolean a(ddl $$0, ejj $$1, ayw $$2, jd $$3, akq<erw> $$4, @Nullable dtc $$5) {
   ...
   protected boolean a(dds $$0, ejj $$1, ayw $$2, int $$3, int $$4, int $$5, ji $$6, akq<erw> $$7) {
      jd $$8 = this.b($$3, $$4, $$5);
   ...
   public static ejj a(Stream<ejv> $$0) {
      return ejj.b($$0.map(ejv::f)::iterator).orElseThrow(() -> new IllegalStateException("Unable to calculate boundingbox without pieces"));
   }

   @Nullable
   public static ejv a(List<ejv> $$0, ejj $$1) {
      for (ejv $$2 : $$0) {
         if ($$2.f().a($$1)) {
            return $$2;
         }
