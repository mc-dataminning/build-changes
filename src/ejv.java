...
public class ejv {
   private final List<ConcurrentLinkedQueue<eju>> a = ImmutableList.of(
   ...
   public void a(eju $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eju> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eju> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eju> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eju> j() {
