...
public class ejv extends ejt {
   public static final MapCodec<ejv> a = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  bri.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  bri.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
                  kf.a(lz.f).fieldOf("can_grow_through").forGetter($$0x -> $$0x.j)
               )
            )
            .apply($$0, ejv::new)
   );
   ...
   private final bri i;
   private final ju<die> j;

   public ejv(int $$0, int $$1, int $$2, bri $$3, float $$4, bri $$5, ju<die> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<eib.a> a(dfh $$0, BiConsumer<jh, dvj> $$1, azs $$2, int $$3, jh $$4, ehl $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new eib.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dfh $$0, BiConsumer<jh, dvj> $$1, azs $$2, int $$3, ehl $$4, List<eib.a> $$5, jh.a $$6, int $$7, jm $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new eib.a($$16, 0, false));
         $$5.add(new eib.a($$16.c(2), 0, false));
      }
   }
