...
public interface cl<T extends Number> {
   SimpleCommandExceptionType a = new SimpleCommandExceptionType(tn.c("argument.range.empty"));
   SimpleCommandExceptionType b = new SimpleCommandExceptionType(tn.c("argument.range.swapped"));
   ...
   static <T extends Number, R extends cl<T>> Codec<R> a(Codec<T> $$0, cl.a<T, R> $$1) {
      Codec<R> $$2 = RecordCodecBuilder.create(
         $$2x -> $$2x.group(arh.a($$0, "min").forGetter(cl::a), arh.a($$0, "max").forGetter(cl::b)).apply($$2x, $$1::create)
      );
