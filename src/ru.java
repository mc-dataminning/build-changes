...
public class ru {
   ...
   public static akt<emq> a(String $$0) {
      return akt.a(mc.aT, aku.b($$0));
   }

   public static void a(qe<emq> $$0, akt<emq> $$1, jr<efk<?, ?>> $$2, List<emt> $$3) {
      $$0.a($$1, new emq($$2, List.copyOf($$3)));
   }

   public static void a(qe<emq> $$0, akt<emq> $$1, jr<efk<?, ?>> $$2, emt... $$3) {
      a($$0, $$1, $$2, List.of($$3));
   }
