...
public abstract class clm extends bvf {
   private static final Logger b = LogUtils.getLogger();
   private int c;
   protected jh a;

   protected clm(bvm<? extends clm> $$0, dha $$1) {
      super($$0, $$1);
   }

   protected clm(bvm<? extends clm> $$0, dha $$1, jh $$2) {
      this($$0, $$1);
      this.a = $$2;
   }
   ...
   public abstract void a(ash var1, @Nullable bvf var2);
