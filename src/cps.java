...
public abstract class cps {
   ...
   private final jr<cun> l = jr.a();
   public final jr<crn> i = jr.a();
   private final List<cqk> m = Lists.newArrayList();
   private cun n = cun.l;
   private final jr<cun> o = jr.a();
   ...
   private int t = -1;
   private int u;
   private final Set<crn> v = Sets.newHashSet();
   private final List<cqe> w = Lists.newArrayList();
   @Nullable
   private cqf x;
   private boolean y;

   protected cps(@Nullable cqz<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cqd $$0, cmv $$1, dex $$2) {
   ...
   protected static void a(bql $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cqc $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   protected cqk a(cqk $$0) {
      this.m.add($$0);
      this.p.add(0);
      return $$0;
   }

   protected void a(cqc $$0) {
      for (int $$1 = 0; $$1 < $$0.a(); $$1++) {
         this.a(cqk.a($$0, $$1));
      }
   }
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.i.size(); $$0++) {
         cun $$1 = this.i.get($$0).g();
         Supplier<cun> $$2 = Suppliers.memoize($$1::s);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cun $$1, Supplier<cun> $$2) {
      cun $$3 = this.l.get($$0);
      if (!cun.a($$3, $$1)) {
         cun $$4 = $$2.get();
         this.l.set($$0, $$4);
   ...
   private void b(int $$0, cun $$1, Supplier<cun> $$2) {
      if (!this.y) {
         cun $$3 = this.o.get($$0);
         if (!cun.a($$3, $$1)) {
            cun $$4 = $$2.get();
   ...
   public abstract cun a(cmv var1, int var2);

   public void a(int $$0, int $$1, cqb $$2, cmv $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cqb $$2, cmv $$3) {
      cmu $$4 = $$3.gc();
      if ($$2 == cqb.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         this.f();
      } else if (($$2 == cqb.a || $$2 == cqb.b) && ($$1 == 0 || $$1 == 1)) {
         cqa $$16 = $$1 == 0 ? cqa.a : cqa.b;
         if ($$0 == -999) {
            if (!this.g().e()) {
               if ($$16 == cqa.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.e()) {
                  if (!$$21.e()) {
                     int $$22 = $$16 == cqa.a ? $$21.I() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.e()) {
                     int $$23 = $$16 == cqa.a ? $$20.I() : ($$20.I() + 1) / 2;
                     Optional<cun> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cun> $$26 = $$19.a($$20.I(), $$21.j() - $$21.I(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.I());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cqb.d && $$3.fP() && this.g().e() && $$0 >= 0) {
         crn $$32 = this.i.get($$0);
         if ($$32.h()) {
            cun $$33 = $$32.g();
            this.b($$33.c($$33.j()));
         }
      } else if ($$2 == cqb.e && this.g().e() && $$0 >= 0) {
         crn $$34 = this.i.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().I();
         cun $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
      } else if ($$2 == cqb.g && $$0 >= 0) {
         crn $$37 = this.i.get($$0);
         cun $$38 = this.g();
         if (!$$38.e() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.i.size() && $$38.I() < $$38.j(); $$42 += $$40) {
                  crn $$43 = this.i.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cun $$44 = $$43.g();
                     if ($$41 != 0 || $$44.I() != $$44.j()) {
                        cun $$45 = $$43.b($$44.I(), $$38.j() - $$38.I(), $$3);
                        $$38.g($$45.I());
                     }
                  }
               }
   ...
   private boolean a(cmv $$0, cqa $$1, crn $$2, cun $$3, cun $$4) {
      cpj $$5 = $$0.dP().J();
   ...
   public void a(int $$0, int $$1, cun $$2) {
      this.b($$0).f($$2);
      this.r = $$1;
   }

   public void a(int $$0, List<cun> $$1, cun $$2) {
   ...
   public abstract boolean a(cmv var1);

   protected boolean a(cun $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(@Nullable crn $$0, cun $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cun.c($$1, $$0.g()) ? $$0.g().I() + ($$2 ? 0 : $$1.I()) <= $$1.j() : $$3;
   }

   public static int a(Set<crn> $$0, int $$1, cun $$2) {
      return switch ($$1) {
         case 0 -> ayx.d((float)$$2.I() / (float)$$0.size());
         case 1 -> 1;
         case 2 -> $$2.j();
         default -> $$2.I();
      };
   ...
   public static int a(@Nullable dpf $$0) {
      return $$0 instanceof bql ? b((bql)$$0) : 0;
   }

   public static int b(@Nullable bql $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cps $$0) {
      Table<bql, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bql $$0, int $$1) {
