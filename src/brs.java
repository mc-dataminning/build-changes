...
public interface brs<T extends Runnable> {
   @Nullable
   Runnable a();
   ...
   public static final class a implements brs<brs.c> {
   ...
   public static final class b implements brs<Runnable> {
      private final Queue<Runnable> a;
