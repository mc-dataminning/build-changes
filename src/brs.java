...
public record brs(Instant a, String b, long c) {
   ...
   public static brs a(RecordedEvent $$0) {
      ...
      return new brs($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static brs.a a(List<brs> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<brs>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            brs $$3 = (brs)$$2x.get(0);
            brs $$4 = (brs)$$2x.get($$2x.size() - 1);
