...
public class bqv implements bqw {
   ...
   private static final bqv k = new bqv();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bqu $$0) {
      URL $$1 = bqv.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bqu $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bqy a = new bqy(() -> bqv.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bqv.this.l && $$0.getState() == RecordingState.STOPPED) {
