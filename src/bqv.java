...
public class bqv {
   ...
   private static void a(brd $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bqy $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<bre> $$0) {
      JsonObject $$1 = new JsonObject();
      bri<bre> $$2 = bri.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(bre::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         bri<bre> $$6 = bri.a((List<bre>)$$4);
         ...
         Function<bre, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<ebk, bri<bqx>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bri)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = af.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<ebk, bri<bqx>> $$3 : $$0) {
         bri<bqx> $$4 = (bri<bqx>)$$3.getSecond();
         JsonObject $$5 = af.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((ebk)$$3.getFirst()).toString());
   ...
   private JsonElement c(List<brg> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bqk.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bqt $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bqv::a));
      $$1.add("chunksWritten", this.a($$0.m(), bqv::a));
      return $$1;
   }

   private JsonElement a(bra.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bqt $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bqv::a));
      $$1.add("received", this.a($$0.k(), bqv::a));
      return $$1;
   }

   private <T> JsonElement a(brc<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<bqz> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bqz>, ToDoubleFunction<bqz>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bqz::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bqz::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bqz::c));
      return $$1;
   }
}
