...
public record bqv(Instant a, String b, long c) {
   ...
   public static bqv a(RecordedEvent $$0) {
      ...
      return new bqv($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bqv.a a(List<bqv> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bqv>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bqv $$3 = (bqv)$$2x.get(0);
            bqv $$4 = (bqv)$$2x.get($$2x.size() - 1);
