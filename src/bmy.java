...
public class bmy implements bnd {
   ...
   private final Map<String, bmy.a> f = Maps.newHashMap();
   ...
   private final Set<Pair<String, bol>> o = new ObjectArraySet();

   public bmy(LongSupplier $$0, IntSupplier $$1, boolean $$2) {
      this.i = $$0.getAsLong();
      this.h = $$0;
      this.j = $$1.getAsInt();
      this.g = $$1;
   ...
   public void b() {
      if (!this.l) {
         ...
         this.l = false;
         if (!this.k.isEmpty()) {
            c.error("Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", LogUtils.defer(() -> bne.b(this.k)));
         }
      }
   }
   ...
   public void c() {
      if (!this.l) {
         ...
         $$3.b = Math.min($$3.b, $$2);
         if (this.n && $$2 > a) {
            c.warn("Something's taking too long! '{}' took aprox {} ms", LogUtils.defer(() -> bne.b(this.k)), LogUtils.defer(() -> (double)$$2 / 1000000.0));
         }
   ...
   private bmy.a f() {
      if (this.m == null) {
         this.m = this.f.computeIfAbsent(this.k, $$0 -> new bmy.a());
      }
   ...
   @Override
   public bne d() {
      return new bnb(this.f, this.i, this.j, this.h.getAsLong(), this.g.getAsInt());
   }

   @Nullable
   @Override
   public bmy.a c(String $$0) {
      return this.f.get($$0);
   }

   @Override
   public Set<Pair<String, bol>> e() {
      return this.o;
   }
