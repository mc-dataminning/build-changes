...
public class bmy {
   ...
   private bmy(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bmy a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bmy($$0, $$1);
   }

   public bmy.d a() throws IOException {
      bmy.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bmy.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bmy.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bmy.c $$3 = bmy.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bmy.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bmy.a($$0, $$3);
            }
         }
   ...
   public bmy.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bmy.c> $$2 = this.a().c();
      ...
      bmy.e $$4 = new bmy.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bmy.c b) implements bmy.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bmy.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bmy.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bmy.b> {
      private final List<bmy.b> a;

      d(List<bmy.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bmy.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bmy.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bmy.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bmy.d a() {
         ListIterator<bmy.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bmy.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bmy.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bmy.b> b() {
         return this.a.stream();
      }

      public Set<bmy.c> c() {
         return this.a.stream().map(bmy.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bmy.c b) implements bmy.b {
