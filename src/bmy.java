...
public interface bmy {
   static bms<StringReader> a(String $$0) {
      return new bmy.b($$0);
   }

   static bms<StringReader> a(char $$0) {
      return new bmy.a($$0);
   }

   public static record a(char a) implements bms<StringReader> {
      @Override
      public boolean a(bmo<StringReader> $$0, bmq $$1, bmk $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements bms<StringReader> {
      @Override
      public boolean a(bmo<StringReader> $$0, bmq $$1, bmk $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
