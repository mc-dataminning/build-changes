...
public interface jo<T> {
   ...
   public static record a<T>(T a) implements jo<T> {
      @Override
      public boolean b() {
         return true;
      }
   ...
   public static class c<T> implements jo<T> {
      private final jr<T> a;
      @Nullable
      private Set<axl<T>> b;
      private final jo.c.a c;
      @Nullable
      private ald<T> d;
      @Nullable
      private T e;

      protected c(jo.c.a $$0, jr<T> $$1, @Nullable ald<T> $$2, @Nullable T $$3) {
         this.a = $$1;
         this.c = $$0;
         this.d = $$2;
         this.e = $$3;
      ...
      public static <T> jo.c<T> a(jr<T> $$0, ald<T> $$1) {
         return new jo.c<>(jo.c.a.a, $$0, $$1, null);
      }

      @Deprecated
      public static <T> jo.c<T> a(jr<T> $$0, @Nullable T $$1) {
         return new jo.c<>(jo.c.a.b, $$0, null, $$1);
      }
