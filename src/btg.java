...
public class btg extends btl {
   public static final MapCodec<btg> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static btg a(float $$0, float $$1, int $$2, int $$3) {
      return new btg($$0, $$1, $$2, $$3);
   }

   private btg(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
