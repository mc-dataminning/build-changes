...
public abstract class bso extends bty {
   private static final akk<Boolean> bY = ako.a(bso.class, akm.k);
   ...
   protected bso(bta<? extends bso> $$0, dby $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract bso a(arf var1, bso var2);
   ...
   protected void k() {
      if (!this.p_() && this.bR() && this.dc() instanceof cov $$0 && !$$0.b((bsu)this)) {
         this.ac();
      }
   }
