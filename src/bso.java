...
public class bso extends eul {
   private static final Logger a = LogUtils.getLogger();
   private final long b;
   private int c;
   private boolean d = true;
   private boolean e = true;
   private final Map<aku, bsn> f = new Object2ObjectOpenHashMap();

   public static eul.a<bso> a(long $$0) {
      return new eul.a<>(() -> new bso($$0), ($$1, $$2) -> a($$0, $$1), ban.m);
   }
   ...
   private bsn b(aku $$0, int $$1, boolean $$2, boolean $$3) {
      long $$4 = ($$2 ? this.b : 0L) ^ (long)$$1;
      return new bsn($$4, $$3 ? Optional.of($$0) : Optional.empty());
   }

   public void a(BiConsumer<aku, bsn> $$0) {
      this.f.forEach($$0);
   }
