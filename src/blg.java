...
public class blg {
   ...
   private static void a(blo $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(blj $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dru, bls<bli>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bls)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dru, bls<bli>> $$3 : $$0) {
         bls<bli> $$4 = (bls<bli>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dru)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<blq> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bkv.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(ble $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), blg::a));
      $$1.add("chunksWritten", this.a($$0.m(), blg::a));
      return $$1;
   }

   private JsonElement a(bll.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(ble $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), blg::a));
      $$1.add("received", this.a($$0.k(), blg::a));
      return $$1;
   }

   private <T> JsonElement a(bln<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<blk> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<blk>, ToDoubleFunction<blk>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, blk::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, blk::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, blk::c));
      return $$1;
   }
}
