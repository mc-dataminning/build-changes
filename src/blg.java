...
public class blg {
   ...
   private blg(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static blg a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new blg($$0, $$1);
   }

   public blg.d a() throws IOException {
      blg.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new blg.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private blg.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         blg.c $$3 = blg.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new blg.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new blg.a($$0, $$3);
            }
         }
   ...
   public blg.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<blg.c> $$2 = this.a().c();
      ...
      blg.e $$4 = new blg.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, blg.c b) implements blg.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static blg.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new blg.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<blg.b> {
      private final List<blg.b> a;

      d(List<blg.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public blg.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            blg.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  blg.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public blg.d a() {
         ListIterator<blg.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               blg.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<blg.b> iterator() {
         return this.a.iterator();
      }

      public Stream<blg.b> b() {
         return this.a.stream();
      }

      public Set<blg.c> c() {
         return this.a.stream().map(blg.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, blg.c b) implements blg.b {
