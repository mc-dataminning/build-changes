...
public class agq {
   ...
   private static final Object2IntMap<Class<? extends blw>> b = new Object2IntOpenHashMap();
   private static final int c = 254;
   private final blw d;
   private final Int2ObjectMap<agq.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   public static <T> agn<T> a(Class<? extends blw> $$0, ago<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> void c(agn<T> $$0, T $$1) {
      agq.a<T> $$2 = new agq.a<>($$0, $$1);
      this.f.writeLock().lock();
      this.e.put($$0.a(), $$2);
      this.f.writeLock().unlock();
   }

   public <T> boolean a(agn<T> $$0) {
      return this.e.containsKey($$0.a());
   }

   private <T> agq.a<T> c(agn<T> $$0) {
      this.f.readLock().lock();

      agq.a<T> $$1;
      try {
         $$1 = (agq.a<T>)this.e.get($$0.a());
   ...
   public <T> T b(agn<T> $$0) {
      return this.c($$0).b();
   }

   public <T> void b(agn<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(agn<T> $$0, T $$1, boolean $$2) {
      agq.a<T> $$3 = this.c($$0);
   ...
   public void a(List<agq.b<?>> $$0) {
      this.f.writeLock().lock();

      try {
         for (agq.b<?> $$1 : $$0) {
            agq.a<?> $$2 = (agq.a<?>)this.e.get($$1.a);
            if ($$2 != null) {
               this.a($$2, $$1);
               this.d.a($$2.a());
            }
   ...
   private <T> void a(agq.a<T> $$0, agq.b<?> $$1) {
   ...
   public static class a<T> {
      ...
      public agq.b<T> e() {
         return agq.b.a(this.a, this.b);
      }
   }

   public static record b<T>(int a, ago<T> b, T c) {

      public static <T> agq.b<T> a(agn<T> $$0, T $$1) {
         ago<T> $$2 = $$0.b();
         return new agq.b<>($$0.a(), $$2, $$2.a($$1));
      }
      ...
      public static agq.b<?> a(uj $$0, int $$1) {
         int $$2 = $$0.n();
         ago<?> $$3 = agp.a($$2);
         if ($$3 == null) {
      ...
      private static <T> agq.b<T> a(uj $$0, int $$1, ago<T> $$2) {
         return new agq.b<>($$1, $$2, $$2.a($$0));
      }
   }
}
