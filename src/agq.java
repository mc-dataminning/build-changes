...
public final class agq<E> implements Codec<ie<E>> {
   private final ags<? extends ir<E>> a;

   public static <E> agq<E> a(ags<? extends ir<E>> $$0) {
      return new agq<>($$0);
   }

   private agq(ags<? extends ir<E>> $$0) {
      this.a = $$0;
   }
