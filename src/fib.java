...
public enum fib implements evz {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static ewy a(int $$0, int $$1, fib.a $$2) {
      ewy $$3 = new ewy(ewy.a.a, $$0, $$1, false);
