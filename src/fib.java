...
public class fib {
   ...
   public void a(fju $$0, String $$1, fkr.a $$2, ewz $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fib.b $$13 = new fib.b($$1.trim(), this.f, $$3, $$2);
                  fib.a $$14 = new fib.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fib.c $$30 = new fib.c(this.f, $$2, $$0);
                        fib.a $$31 = new fib.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fjy(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ewz $$2) throws IOException {
      ...
      File $$15 = new File(fnd.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ewz d;
      private final fkr.a e;

      b(final String $$0, final File $$1, final ewz $$2, final fkr.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fib.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fib.this.b && !fib.this.d) {
            try {
               fib.this.e = true;
               fib.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fib.a.error("Error extracting archive", var3);
               fib.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fkr.a c;
      private final fju d;

      c(final File $$0, final fkr.a $$1, final fju $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fib.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fib.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fib.this.g);
                  fib.this.c = true;
               } else {
                  fib.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fib.this.d = true;
               }
            } catch (IOException var3) {
               fib.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fib.this.d = true;
            }
         }
      }
