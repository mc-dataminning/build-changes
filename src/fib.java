...
public class fib extends fhq implements fiv {
   private static final fjf d = new fjf(new akk("widget/text_field"), new akk("widget/text_field_highlighted"));
   ...
   public fib(fhd $$0, int $$1, int $$2, wu $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fib(fhd $$0, int $$1, int $$2, int $$3, int $$4, wu $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fib(fhd $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fib $$5, wu $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(double $$0, double $$1) {
      ...
      this.b(this.o.a($$3, $$2).length() + this.v, fnj.t());
   }
   ...
   public void b(fhf $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gel.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
