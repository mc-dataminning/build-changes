public class fib implements fid {
   ...
   @Override
   public void a(eyz $$0, int $$1, int $$2, ezb $$3) {
      int $$4 = this.d();
      int $$5 = this.e();
   ...
   private void a(int $$0, int $$1, int $$2, boolean $$3, ezb $$4, eyz $$5) {
      if ($$2 >= this.f.size()) {
         this.a($$4, $$0, $$1, $$3 ? fib.a.a : fib.a.b);
      } else {
         cpd $$6 = this.f.get($$2);
         this.a($$4, $$0, $$1, fib.a.b);
         $$4.a($$6, $$0 + 1, $$1 + 1, $$2);
         $$4.a($$5, $$6, $$0 + 1, $$1 + 1);
         if ($$2 == 0) {
            fgk.a($$4, $$0 + 1, $$1 + 1, 0);
   ...
   private void a(ezb $$0, int $$1, int $$2, fib.a $$3) {
