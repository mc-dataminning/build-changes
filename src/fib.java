...
public class fib {
   ...
   static final xk h = xk.c("mco.notification.visitUrl.buttonText.default");
   final UUID i;
   final boolean j;
   final boolean k;
   final String l;
   ...
   public static class a extends fib {
      ...
      private a(fib $$0, fih $$1, fih $$2, alp $$3, @Nullable fib.b $$4) {
      ...
      public fpb a(ftr $$0, Consumer<UUID> $$1) {
         ...
         if ($$2 == null) {
            ...
            fpb.a $$3 = new fpb.a($$0, $$2).a(this.g).a(this.f.a(xj.a));
            if (this.h != null) {
   ...
   public static class c extends fib {
      ...
      public xk d() {
         return this.f.a(xk.c("mco.notification.visitUrl.message.default"));
      }
