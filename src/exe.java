...
public class exe {
   ...
   public void a(eyo $$0, String $$1, ezk.a $$2, ena $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  exe.b $$13 = new exe.b($$1.trim(), this.f, $$3, $$2);
                  exe.a $$14 = new exe.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        exe.c $$30 = new exe.c(this.f, $$2, $$0);
                        exe.a $$31 = new exe.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new eys(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ena $$2) throws IOException {
      ...
      File $$15 = new File(fby.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ena d;
      private final ezk.a e;

      b(String $$0, File $$1, ena $$2, ezk.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((exe.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !exe.this.b && !exe.this.d) {
            try {
               exe.this.e = true;
               exe.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               exe.a.error("Error extracting archive", var3);
               exe.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final ezk.a c;
      private final eyo d;

      c(File $$0, ezk.a $$1, eyo $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((exe.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !exe.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, exe.this.g);
                  exe.this.c = true;
               } else {
                  exe.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  exe.this.d = true;
               }
            } catch (IOException var3) {
               exe.a.error("Error copying resourcepack file: {}", var3.getMessage());
               exe.this.d = true;
            }
         }
      }
