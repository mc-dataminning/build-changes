...
public abstract class exe implements eyj, ezb, fas, fax {
   ...
   public exe(int $$0, int $$1, int $$2, int $$3, vf $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(ewu $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(ewu var1, int var2, int var3, float var4);

   protected static void a(ewu $$0, ews $$1, vf $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(ewu $$0, ews $$1, vf $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
         ...
         double $$16 = auo.d($$15, 0.0, (double)$$12);
         $$0.c($$4, $$5, $$6, $$7);
         $$0.b($$1, $$2, $$4 - (int)$$16, $$10, $$8);
         $$0.f();
      } else {
         int $$17 = auo.a($$3, $$4 + $$9 / 2, $$6 - $$9 / 2);
         $$0.a($$1, $$2, $$17, $$10, $$8);
      }
   }

   protected void a(ewu $$0, ews $$1, int $$2, int $$3) {
      int $$4 = this.B() + $$2;
   ...
   public ewr a(fbf $$0) {
      if (!this.j || !this.k) {
         ...
         return !this.aI_() ? ewr.a(this) : null;
      }
   }
   ...
   protected void c(faz $$0) {
      $$0.a(fay.a, this.aK_());
      if (this.j) {
         if (this.aI_()) {
            $$0.a(fay.d, vf.c("narration.button.usage.focused"));
         } else {
