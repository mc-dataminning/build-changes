...
public abstract class fmb implements fng, foa, fpu, fpz {
   ...
   private int f;
   private boolean m;
   private final fnr n = new fnr();

   public fmb(int $$0, int $$1, int $$2, int $$3, xj $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(flq $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
         this.i = $$0.a($$1, $$2) && $$1 >= this.D() && $$2 >= this.E() && $$1 < this.D() + this.g && $$2 < this.E() + this.h;
         this.b($$0, $$1, $$2, $$3);
         this.n.a(this.A(), this.aL_(), this.H());
      }
   }
   ...
   public static xx a_(xj $$0) {
      return xj.a("gui.narrate.button", $$0);
   }

   protected abstract void b(flq var1, int var2, int var3, float var4);

   protected static void a(flq $$0, flo $$1, xj $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(flq $$0, flo $$1, xj $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(flq $$0, flo $$1, int $$2, int $$3) {
      int $$4 = this.D() + $$2;
   ...
   public static void b(heg $$0) {
      $$0.a(hcw.a(awn.Av, 1.0F));
   }
   ...
   public fpz.a u() {
      if (this.aL_()) {
         ...
         return this.i ? fpz.a.b : fpz.a.a;
      }
   }

   @Override
   public final void b(fqb $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fqb var1);

   protected void c(fqb $$0) {
      $$0.a(fqa.a, this.aN_());
      if (this.j) {
         if (this.aL_()) {
            $$0.a(fqa.d, xj.c("narration.button.usage.focused"));
         } else {
