public class fmb extends fmw {
   private final fmr a;

   fmb(fiz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fmr $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cbw $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.ds();
            if (this.h > $$1) {
   ...
   public static class b implements flz<ja> {
      ...
      public flw a(ja $$0, fiz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         flw $$8 = new fmb($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
