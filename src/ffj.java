...
public class ffj implements AutoCloseable {
   ...
   private ffj(int $$0, akv $$1) {
      this.b = $$1;
      this.c = $$0;
   }

   public static ffj a(akv $$0, ffj.a $$1, String $$2) throws gmp.b {
      ...
      if (GlStateManager.glGetShaderi($$3, 35713) == 0) {
         ...
         throw new gmp.b("Couldn't compile " + $$1.a() + " shader (" + $$0 + ") : " + $$4);
      } else {
         return new ffj($$3, $$0);
      }
   }
