...
public class ffj extends fez<cjw> {
   ...
   private final feo R = new feo(0);
   private final feo S = new feo(1);
   private final feo T = new feo(2);
   @Nullable
   private cbj U;

   public ffj(cjw $$0, cfg $$1, vf $$2) {
   ...
   protected void a(ews $$0, float $$1, int $$2, int $$3) {
      ...
      fey.a($$0, (float)(this.t + 141), (float)(this.u + 75), 25, M, N, null, this.U);
   }
   ...
   private void d(ews $$0, int $$1, int $$2) {
