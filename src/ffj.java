...
public class ffj extends aut<Map<String, List<ffj.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<ffj.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(ffj.a::a),
                     Codec.LONG.fieldOf("period").forGetter(ffj.a::b),
                     Codec.STRING.fieldOf("title").forGetter(ffj.a::c),
                     Codec.STRING.fieldOf("message").forGetter(ffj.a::d)
                  )
                  .apply($$0, ffj.a::new)
         )
         .listOf()
   ...
   public ffj(ale $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<ffj.a>> a(auo $$0, bng $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<ffj.a>> $$0, auo $$1, bng $$2) {
      List<ffj.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<ffj.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<ffj.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<ffj.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public ffj.b a(List<ffj.a> $$0, long $$1) {
         this.cancel();
         return new ffj.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (ffj.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fjk.a(ffd.Q().ax(), fjk.a.f, xo.a($$2.c, $$3), xo.a($$2.d, $$3)));
                  return;
               }
            }
         }
