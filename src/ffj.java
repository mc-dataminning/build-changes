...
public class ffj {
   ...
   public void a(ffj.b $$0, List<asx> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new ffj.c($$0, $$1.stream().map(asx::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new ffj.c(ffj.b.c, ImmutableList.of());
      }

      this.b.c = new ffj.a($$0);
   }
   ...
   static class c {
      private final ffj.b a;
      private final List<String> b;
      @Nullable
      ffj.a c;
      boolean d;

      c(ffj.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
