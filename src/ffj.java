...
public class ffj {
   ...
   private static final Queue<ffj.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ffj.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ffj::a), ffg::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ffj::a), ffg::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ffj.a(this.b) + ", type=" + ffj.b(this.c) + ", severity=" + ffj.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
