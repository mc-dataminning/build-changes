...
public class gdo {
   public static class a implements geh<lr> {
      ...
      public gee a(lr $$0, gax $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gdo.b $$8 = new gdo.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gfe {
      b(gax $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * azc.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends geq {
      private boolean b;
      private boolean F;
      private final geg G;
      private float H;
      ...
      c(gax $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, geg $$7, gez $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gdo.c $$0 = new gdo.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements geh<lr> {
      ...
      public gee a(lr $$0, gax $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gdo.c $$8 = new gdo.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fib.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gec {
      ...
      private int D;
      private final geg E;
      private final List<cye> F;
      private boolean G;

      public e(gax $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, geg $$7, List<cye> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.D == 0) {
            ...
            this.c.a(this.g, this.h, this.i, $$3, awe.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gee $$12 = this.E.a(ln.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)axn.b($$11) / 255.0F, (float)axn.c($$11) / 255.0F, (float)axn.d($$11) / 255.0F);
         }
         ...
         if (this.D > this.t) {
            if (this.G) {
               boolean $$13 = this.c();
               awc $$14 = $$13 ? awd.iT : awd.iS;
               this.c.a(this.g, this.h, this.i, $$14, awe.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gdo.c $$10 = (gdo.c)this.E.a(ln.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = azc.d($$18, $$13, $$16) * $$0;
                  double $$20 = azc.d($$18, $$14, $$17) * $$0;
