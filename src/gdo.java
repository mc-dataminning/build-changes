...
public class gdo implements AutoCloseable {
   ...
   public gdo(gdi $$0, ffg $$1) {
      this.i = $$0;
      this.j = $$1;
      this.d = new gon(16, 16, false);
   ...
   private float b(float $$0) {
      bsd $$1 = this.j.s.c(bsf.G);
      return $$1 != null ? $$1.a(this.j.s, $$0) : 0.0F;
   }

   private float a(btq $$0, float $$1, float $$2) {
      float $$3 = 0.45F * $$1;
   ...
   public void a(float $$0) {
      if (this.g) {
         ...
         if ($$1 != null) {
            ...
            if (this.j.s.b(bsf.p)) {
               $$9 = gdi.a(this.j.s, $$0);
            } else if ($$8 > 0.0F && this.j.s.b(bsf.C)) {
               $$9 = $$8;
            } else {
               $$9 = 0.0F;
            }
   ...
   public static float a(dvv $$0, int $$1) {
