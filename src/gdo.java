...
public class gdo extends gaf {
   private static final int a = 20;
   private static final int b = 5;
   private static final int c = 20;
   private final xc d;
   private final List<xc> s;
   private final ImmutableList<gdo.a> u;
   private fvg v = fvg.a;
   private int w;
   private int x;

   protected gdo(xc $$0, List<xc> $$1, ImmutableList<gdo.a> $$2) {
      super($$0);
      this.s = $$1;
      this.d = xb.a($$0, xf.a($$1, xb.a));
      this.u = $$2;
   }
   ...
   public void aS_() {
      ...
      while ($$1.hasNext()) {
         gdo.a $$0 = (gdo.a)$$1.next();
         this.x = Math.max(this.x, 20 + this.p.a($$0.a) + 20);
      }

      int $$1x = 5 + this.x + 5;
      int $$2 = $$1x * this.u.size();
      this.v = fvg.a(this.p, $$2, this.s.toArray(new xc[0]));
      int $$3 = this.v.a() * 9;
      ...
      for (UnmodifiableIterator var6 = this.u.iterator(); var6.hasNext(); $$5 += $$1x) {
         gdo.a $$6 = (gdo.a)var6.next();
         this.c(fun.a($$6.a, $$6.b).a($$5, $$4, this.x, 20).a());
      }
   }
