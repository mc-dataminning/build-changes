...
public class gdo {
   ...
   public gdh a(Vector3f $$0, Vector3f $$1, gdj $$2, gnv $$3, it $$4, gqe $$5, @Nullable gdk $$6, boolean $$7, akm $$8) {
      gdl $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = ayd.i($$11, $$9.a[0], $$12);
      $$9.a[2] = ayd.i($$11, $$9.a[2], $$12);
      $$9.a[1] = ayd.i($$11, $$9.a[1], $$13);
      $$9.a[3] = ayd.i($$11, $$9.a[3], $$13);
      ...
      return new gdh($$14, $$2.c, $$15, $$3, $$7);
   }

   public static gdl a(gdl $$0, it $$1, j $$2, akm $$3) {
      Matrix4f $$4 = in.a($$2, $$1, () -> "Unable to resolve UVLock for model: " + $$3).c();
      float $$5 = $$0.a($$0.c(0));
      float $$6 = $$0.b($$0.c(0));
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(ayd.b($$23), ayd.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new gdl(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(gdl $$0, gnv $$1, it $$2, float[] $$3, j $$4, @Nullable gdk $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[it.values().length];
      $$2[gcb.a.f] = $$0.x() / 16.0F;
      $$2[gcb.a.e] = $$0.y() / 16.0F;
      $$2[gcb.a.d] = $$0.z() / 16.0F;
      $$2[gcb.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, it $$2, gdl $$3, float[] $$4, gnv $$5, j $$6, @Nullable gdk $$7, boolean $$8) {
      gcb.b $$9 = gcb.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gnv $$3, gdl $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gdk $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static it a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? it.b : $$7;
      }
   }

   private void a(int[] $$0, it $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[it.values().length];
      $$3[gcb.a.f] = 999.0F;
      $$3[gcb.a.e] = 999.0F;
      $$3[gcb.a.d] = 999.0F;
      $$3[gcb.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (ayd.a($$13, $$18) && ayd.a($$14, $$19) && ayd.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
