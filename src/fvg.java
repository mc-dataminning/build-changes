...
public class fvg extends fun<bzo, fgw<bzo>> {
   private static final aew a = new aew("textures/" + fot.i.b().a() + ".png");
   private static final aew[] i = fot.j.stream().map($$0 -> new aew("textures/" + $$0.b().a() + ".png")).toArray(aew[]::new);
   ...
   public static aew a(@Nullable cht $$0) {
