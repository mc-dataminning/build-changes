...
public class fvg<T extends cfm> extends ftz<T> {
   public final fye a;
   private final fye b;
   private final fye f;
   private final fye g;
   ...
   public static fyk c() {
      fym $$0 = new fym();
      fyn $$1 = $$0.a();
      fyn $$2 = $$1.a("head", fyj.c().a(1, 5).a(-3.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F), fyg.a(-1.0F, 16.5F, -3.0F));
      $$2.a("right_ear", fyj.c().a(8, 1).a(-3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fyg.a);
      $$2.a("left_ear", fyj.c().a(15, 1).a(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fyg.a);
      $$2.a("nose", fyj.c().a(6, 18).a(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), fyg.a);
      fyn $$3 = $$1.a("body", fyj.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), fyg.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fyi $$4 = new fyi(0.001F);
      fyj $$5 = fyj.c().a(4, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      fyj $$6 = fyj.c().a(13, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      $$1.a("right_hind_leg", $$6, fyg.a(-5.0F, 17.5F, 7.0F));
      $$1.a("left_hind_leg", $$5, fyg.a(-1.0F, 17.5F, 7.0F));
      $$1.a("right_front_leg", $$6, fyg.a(-5.0F, 17.5F, 0.0F));
      $$1.a("left_front_leg", $$5, fyg.a(-1.0F, 17.5F, 0.0F));
      $$3.a("tail", fyj.c().a(30, 0).a(2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 5.0F), fyg.a(-4.0F, 15.0F, -1.0F, -0.05235988F, 0.0F, 0.0F));
      return fyk.a($$0, 48, 32);
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.fI()) {
         this.a.e = 0.0F;
         this.a.f = (float) (-Math.PI * 2.0 / 3.0);
         this.a.g = ayn.b($$3 * 0.027F) / 22.0F;
      }

      if ($$0.cb()) {
         float $$6 = ayn.b($$3) * 0.01F;
         this.b.f = $$6;
         this.f.g = $$6;
         this.g.g = $$6;
         this.h.g = $$6 / 2.0F;
      ...
      if ($$0.gm()) {
         float $$7 = 0.1F;
         this.n += 0.67F;
         this.f.e = ayn.b(this.n * 0.4662F) * 0.1F;
         this.g.e = ayn.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.h.e = ayn.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.i.e = ayn.b(this.n * 0.4662F) * 0.1F;
      }
   }
}
