...
public class fvg extends asf<fvg.a> {
   private static final Logger a = LogUtils.getLogger();
   private static final aiy b = new aiy("gpu_warnlist.json");
   ...
   protected fvg.a a(asa $$0, bil $$1) {
      ...
      $$1.b();
      return new fvg.a($$2, $$3, $$4);
   }

   protected void a(fvg.a $$0, asa $$1, bil $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(asa $$0, bil $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, eqt.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, eqt.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, eqt.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
