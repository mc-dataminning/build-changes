...
public class fvg extends fuk {
   ...
   public fvg(cow $$0, cwo $$1, bsi $$2, czv $$3) {
      super(fkz.a);
      this.z = $$0;
      this.A = $$1;
      this.R = $$2;
      $$3.a(fli.Q().aT()).forEach(this.F::add);
      if (this.F.isEmpty()) {
         this.F.add("");
      }
   ...
   protected void aR_() {
      this.T();
      this.O = this.c((fos)fos.a(wp.c("book.signButton"), $$0x -> {
         this.C = true;
         this.H();
      }).a(this.n / 2 - 100, 196, 98, 20).a());
      this.N = this.c((fos)fos.a(wo.d, $$0x -> {
         this.m.a(null);
         this.c(false);
      }).a(this.n / 2 + 2, 196, 98, 20).a());
      this.P = this.c((fos)fos.a(wp.c("book.finalizeButton"), $$0x -> {
         if (this.C) {
            this.c(true);
            this.m.a(null);
         }
      }).a(this.n / 2 - 100, 196, 98, 20).a());
      this.Q = this.c((fos)fos.a(wo.e, $$0x -> {
         if (this.C) {
            this.C = false;
         }
   ...
   private void L() {
      this.A.b(kv.S, new czv(this.F.stream().map(arv::a).toList()));
   }
   ...
   private void b(int $$0) {
      String $$1 = this.R();
      this.H.a(fls.a($$1, -1, $$0, false), fls.a($$1, 1, $$0, false));
   }
   ...
   private gme a(String $$0, fls $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   static class a {
      static final fvg.a a = new fvg.a("", new fvg.c(0, 0), true, new int[]{0}, new fvg.b[]{new fvg.b(xm.a, "", 0, 0)}, new gme[0]);
