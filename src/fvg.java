public class fvg extends fug<ctz> {
   ...
   public fvg(ctz $$0, cpr $$1, cjw $$2, int $$3) {
      super($$0, $$1, $$2.p_());
      this.L = $$2;
      this.M = $$3;
   }
   ...
   protected void a(fnl $$0, float $$1, int $$2, int $$3) {
      ...
      $$0.a(glo::B, K, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      if (this.M > 0) {
         $$0.a(glo::B, G, 90, 54, 0, 0, $$4 + 79, $$5 + 17, this.M * 18, 54);
      }

      if (this.L.f()) {
         $$0.a(glo::B, H, $$4 + 7, $$5 + 35 - 18, 18, 18);
      }

      if (this.L.e(bvn.g)) {
         if (this.L instanceof cjz) {
            $$0.a(glo::B, I, $$4 + 7, $$5 + 35, 18, 18);
         } else {
            $$0.a(glo::B, J, $$4 + 7, $$5 + 35, 18, 18);
         }
      }

      fvh.a($$0, $$4 + 26, $$5 + 18, $$4 + 78, $$5 + 70, 17, 0.25F, this.N, this.O, this.L);
   }
