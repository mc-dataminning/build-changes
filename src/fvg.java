...
public class fvg extends fuk {
   ...
   private static final ayl x = ayl.forward("_", xl.a.a(n.a));
   private static final ayl y = ayl.forward("_", xl.a.a(n.h));
   private final cox z;
   private final cwp A;
   private boolean B;
   private boolean C;
   ...
   private String G = "";
   private final frn H = new frn(this::R, this::b, this::m, this::a, $$0x -> $$0x.length() < 1024 && this.p.b($$0x, 114) <= 128);
   private final frn I = new frn(() -> this.G, $$0x -> this.G = $$0x, this::m, this::a, $$0x -> $$0x.length() < 16);
   private long J;
   private int K = -1;
   private fwi L;
   private fwi M;
   ...
   private final bsi R;
   @Nullable
   private fvg.a S = fvg.a.a;
   private wo T = wn.a;
   private final wo U;

   public fvg(cox $$0, cwp $$1, bsi $$2, czw $$3) {
      super(fla.a);
      this.z = $$0;
      this.A = $$1;
      this.R = $$2;
   ...
   private String m() {
      return this.m != null ? frn.b(this.m) : "";
   }
   ...
   protected void aR_() {
      this.T();
      this.O = this.c((fos)fos.a(wo.c("book.signButton"), $$0x -> {
         this.C = true;
         this.H();
      }).a(this.n / 2 - 100, 196, 98, 20).a());
      this.N = this.c((fos)fos.a(wn.d, $$0x -> {
         this.m.a(null);
         this.c(false);
      }).a(this.n / 2 + 2, 196, 98, 20).a());
      this.P = this.c((fos)fos.a(wo.c("book.finalizeButton"), $$0x -> {
         if (this.C) {
            this.c(true);
            this.m.a(null);
         }
      }).a(this.n / 2 - 100, 196, 98, 20).a());
      this.Q = this.c((fos)fos.a(wn.e, $$0x -> {
         if (this.C) {
            this.C = false;
         }
      ...
      int $$0 = (this.n - 192) / 2;
      int $$1 = 2;
      this.L = this.c(new fwi($$0 + 116, 159, true, $$0x -> this.G(), true));
      this.M = this.c(new fwi($$0 + 43, 159, false, $$0x -> this.F(), true));
      this.H();
   }
   ...
   private void c(boolean $$0) {
      if (this.B) {
         this.I();
         this.L();
         int $$1 = this.R == bsi.a ? this.z.gi().j : 40;
         this.m.L().b(new agz($$1, this.F, $$0 ? Optional.of(this.G.trim()) : Optional.empty()));
      }
   }

   private void L() {
      this.A.b(kv.S, new czw(this.F.stream().map(aru::a).toList()));
   }
   ...
   public void a(fod $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.C) {
         ...
         ayl $$7 = ayl.composite(ayl.forward(this.G, xl.a), $$6 ? x : y);
         int $$8 = this.p.a(v);
   ...
   public void b(fod $$0, int $$1, int $$2, float $$3) {
      this.b($$0);
      $$0.a(gmh::H, fvh.s, (this.n - 192) / 2, 2, 0.0F, 0.0F, 192, 192, 256, 256);
   }

   private void a(fod $$0, fvg.c $$1, boolean $$2) {
      if (this.D / 6 % 2 == 0) {
         $$1 = this.b($$1);
         if (!$$2) {
   ...
   private void a(fod $$0, gme[] $$1) {
      for (gme $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(gmh.N(), $$3, $$4, $$5, $$6, -16776961);
      }
   }

   private fvg.c a(fvg.c $$0) {
      return new fvg.c($$0.a - (this.n - 192) / 2 - 36, $$0.b - 32);
   }

   private fvg.c b(fvg.c $$0) {
      return new fvg.c($$0.a + (this.n - 192) / 2 + 36, $$0.b + 32);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if ($$2 == 0) {
            long $$3 = af.c();
            fvg.a $$4 = this.S();
            int $$5 = $$4.a(this.p, this.a(new fvg.c((int)$$0, (int)$$1)));
            if ($$5 >= 0) {
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$2 == 0) {
            fvg.a $$5 = this.S();
            int $$6 = $$5.a(this.p, this.a(new fvg.c((int)$$0, (int)$$1)));
            this.H.c($$6, true);
            this.T();
         }
   ...
   private fvg.a V() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<fvg.b> $$4 = Lists.newArrayList();
         ...
         $$7.a($$0, 114, xl.a, true, ($$5x, $$6x, $$7x) -> {
            ...
            int $$11 = $$8x * 9;
            fvg.c $$12 = this.b(new fvg.c(0, $$11));
            $$3.add($$6x);
            $$4.add(new fvg.b($$5x, $$10, $$12.a, $$12.b));
         });
         int[] $$8 = $$3.toIntArray();
         boolean $$9 = $$1 == $$0.length();
         fvg.c $$10;
         if ($$9 && $$6.isTrue()) {
            $$10 = new fvg.c(0, $$4.size() * 9);
         } else {
            int $$11 = a($$8, $$1);
            int $$12 = this.p.b($$0.substring($$8[$$11], $$1));
            $$10 = new fvg.c($$12, $$11 * 9);
         }

         List<gme> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
            ...
            if ($$17 == $$18) {
               ...
               for (int $$22 = $$17 + 1; $$22 < $$18; $$22++) {
                  ...
                  int $$25 = (int)$$7.a($$24);
                  $$14.add(this.a(new fvg.c(0, $$23), new fvg.c($$25, $$23 + 9)));
               }
         ...
         return new fvg.a($$0, $$10, $$9, $$8, $$4.toArray(new fvg.b[0]), $$14.toArray(new gme[0]));
      }
   }
   ...
   private gme a(String $$0, flt $$1, int $$2, int $$3, int $$4, int $$5) {
      String $$6 = $$0.substring($$5, $$2);
      String $$7 = $$0.substring($$5, $$3);
      fvg.c $$8 = new fvg.c((int)$$1.a($$6), $$4);
      fvg.c $$9 = new fvg.c((int)$$1.a($$7), $$4 + 9);
      return this.a($$8, $$9);
   }

   private gme a(fvg.c $$0, fvg.c $$1) {
      fvg.c $$2 = this.b($$0);
      fvg.c $$3 = this.b($$1);
      ...
      return new gme($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final fvg.a a = new fvg.a("", new fvg.c(0, 0), true, new int[]{0}, new fvg.b[]{new fvg.b(xl.a, "", 0, 0)}, new gme[0]);
      ...
      public a(String $$0, fvg.c $$1, boolean $$2, int[] $$3, fvg.b[] $$4, gme[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
