...
public class fvg {
   ...
   final fpo c;
   private final List<fvg.a<?>> d = new ArrayList<>();
   private final BitSet e = new BitSet(5);
   private final Deque<fvf> f = Queues.newArrayDeque();
      ...
      if (!this.f.isEmpty() && this.e() > 0) {
         this.f.removeIf($$0x -> {
            ...
            if ($$2 == -1) {
               ...
               this.d.add(new fvg.a<>($$0x, $$2, $$1));
               this.e.set($$2, $$2 + $$1);
               awm $$3 = $$0x.b();
               if ($$3 != null && this.g.add($$3)) {
                  this.c.ak().a(hnc.a($$3, 1.0F, 1.0F));
               }
   ...
   @Nullable
   public <T extends fvf> T a(Class<? extends T> $$0, Object $$1) {
      for (fvg.a<?> $$2 : this.d) {
   ...
   class a<T extends fvf> {
      ...
      public void c() {
         ...
         if (this.h == fvf.a.a && $$0 - this.f <= 600L) {
            this.g = $$0;
         }

         this.i = $$0 - this.g;
         this.a($$0);
         this.c.a(fvg.this, this.i);
         fvf.a $$1 = this.c.a();
         if ($$1 != this.h) {
         ...
         this.k = this.h == fvf.a.b && $$0 - this.f > 600L;
      }

      public void a(fsh $$0, int $$1) {
         $$0.c().a();
         $$0.c().a((float)$$1 - (float)this.c.c() * this.j, (float)(this.d * 32), 800.0F);
         this.c.a($$0, fvg.this.c.h, this.i);
         $$0.c().b();
      }
   }
}
