...
public class aed {
   ...
   private static final Dynamic2CommandExceptionType d = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> sw.a("commands.datapack.enable.failed.no_flags", $$0, $$1)
   );
   private static final SuggestionProvider<ds> e = ($$0, $$1) -> du.b(
   ...
   private static final SuggestionProvider<ds> f = ($$0, $$1) -> {
      ...
      return du.b(
         $$2.c().stream().filter($$1x -> $$1x.d().a($$4)).map(akg::f).filter($$1x -> !$$3.contains($$1x)).map(StringArgumentType::escapeIfRequired), $$1
      );
   };
   ...
   private static int a(ds $$0, akg $$1, aed.a $$2) throws CommandSyntaxException {
      aki $$3 = $$0.l().aB();
      List<akg> $$4 = Lists.newArrayList($$3.f());
      $$2.apply($$4, $$1);
   ...
   private static int a(ds $$0, akg $$1) {
      aki $$2 = $$0.l().aB();
      List<akg> $$3 = Lists.newArrayList($$2.f());
      $$3.remove($$1);
   ...
   private static int b(ds $$0) {
      ...
      caw $$4 = $$0.w();
      List<akg> $$5 = $$3.stream().filter($$2x -> !$$2.contains($$2x) && $$2x.d().a($$4)).toList();
      if ($$5.isEmpty()) {
         $$0.a(() -> sw.c("commands.datapack.list.available.none"), false);
      } else {
         $$0.a(() -> sw.a("commands.datapack.list.available.success", $$5.size(), sy.b($$5, $$0xx -> $$0xx.a(false))), false);
      }
   ...
   private static int c(ds $$0) {
      aki $$1 = $$0.l().aB();
      $$1.a();
      Collection<? extends akg> $$2 = $$1.f();
      if ($$2.isEmpty()) {
         $$0.a(() -> sw.c("commands.datapack.list.enabled.none"), false);
      } else {
         $$0.a(() -> sw.a("commands.datapack.list.enabled.success", $$2.size(), sy.b($$2, $$0xx -> $$0xx.a(true))), false);
      }
   ...
   interface a {
      void apply(List<akg> var1, akg var2) throws CommandSyntaxException;
   }
}
