...
public class kn {
   ...
   final Map<String, ko> e = new LinkedHashMap<>();
   private final ad f;
   private final boolean g;

   public kn(Path $$0, ad $$1, boolean $$2) {
      this.b = $$0;
   ...
   public void a() throws IOException {
      kp $$0 = new kp(this.b, this.d, this.f);
   ...
   public kn.a a(boolean $$0) {
      return new kn.a($$0, "vanilla", this.c);
   }

   public kn.a a(boolean $$0, String $$1) {
      Path $$2 = this.c.a(kq.b.a).resolve("minecraft").resolve("datapacks").resolve($$1);
      return new kn.a($$0, $$1, new kq($$2));
   }
   ...
   public class a {
      ...
      a(boolean $$1, String $$2, kq $$3) {
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
      }

      public <T extends ko> T a(ko.a<T> $$0) {
         T $$1 = $$0.create(this.d);
         String $$2 = this.c + "/" + $$1.a();
         if (!kn.this.d.add($$2)) {
