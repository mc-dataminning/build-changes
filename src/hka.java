...
public enum hka implements hkp {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, hka> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (hka)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   private hka(final int $$0, final int $$1) {
      this.u = b($$0, $$1);
   ...
   public static hka a(int $$0, int $$1) {
