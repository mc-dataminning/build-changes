...
public abstract class alb extends alc<Map<acq, JsonElement>> {
   ...
   protected Map<acq, JsonElement> a(akx $$0, ban $$1) {
      Map<acq, JsonElement> $$2 = new HashMap<>();
      a($$0, this.c, this.b, $$2);
      return $$2;
   }
   ...
   public static void a(akx $$0, String $$1, Gson $$2, Map<acq, JsonElement> $$3) {
      ...
      for (Entry<acq, akv> $$5 : $$4.a($$0).entrySet()) {
         acq $$6 = $$5.getKey();
         acq $$7 = $$4.b($$6);

         try (Reader $$8 = $$5.getValue().e()) {
            JsonElement $$9 = aor.a($$2, $$8, JsonElement.class);
