...
public abstract class buh<E extends bso> implements bui<E> {
   public static final int a = 60;
   protected final Map<cbs<?>, cbt> b;
   private buh.a c = buh.a.a;
   private long d;
   private final int e;
   private final int f;

   public buh(Map<cbs<?>, cbt> $$0) {
      this($$0, 60);
   }

   public buh(Map<cbs<?>, cbt> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public buh(Map<cbs<?>, cbt> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<cbs<?>, cbt> $$1 : this.b.entrySet()) {
         cbs<?> $$2 = $$1.getKey();
         cbt $$3 = $$1.getValue();
         if (!$$0.dS().a($$2, $$3)) {
            return false;
