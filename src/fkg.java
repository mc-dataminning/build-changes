...
public class fkg {
   ...
   public static void a(File $$0, fcu $$1, Consumer<xl> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fcu $$2, Consumer<xl> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fcu $$2, Consumer<xl> $$3) {
      fdk $$4 = a($$2);
   ...
   public static fdk a(fcu $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fdk $$3 = new fdk($$1, $$2, false);
   ...
   public fkg(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
