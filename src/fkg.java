...
public class fkg {
   ...
   private fkg(int $$0, List<fki> $$1) {
      this.a = $$1.toArray(fki[]::new);
      this.b = $$1.size();
   }

   private List<fki> c() {
      List<fki> $$0 = new ArrayList<>(this.d());
