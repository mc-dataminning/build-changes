...
public class fkg implements eyd {
   static final Logger b = LogUtils.getLogger();
   private final ezb c;
   private final fju<fkg.b> d;

   fkg(ezb $$0, fju<fkg.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(alf c, int d, int e, int[][] f) implements fki {
      ...
      public static final MapCodec<fkg.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     alf.a.fieldOf("file").forGetter(fkg.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fkg.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fkg.a::e),
                     g.fieldOf("chars").forGetter(fkg.a::f)
                  )
                  .apply($$0, fkg.a::new)
         )
         .validate(fkg.a::a);
      ...
      private static DataResult<fkg.a> a(fkg.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fkg.b $$15 = $$9.a($$12, new fkg.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fkg.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(ezb $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, ezb b, int c, int d, int e, int f, int g, int h) implements eyc {
