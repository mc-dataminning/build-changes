...
public class fkg extends fkh {
            ...
            case 6006:
               ...
               a(
                  (fuk)($$3
                     ...
                     : new fiy(wo.c("mco.brokenworld.nonowner.title"), wo.c("mco.brokenworld.nonowner.error"), this.f))
               );
               return;
            default:
               this.a(var5);
   ...
   private fpu a(fhm $$0, UUID $$1, Function<fhm, fuk> $$2) {
      ...
      return fjg.a(this.f, $$3, $$3x -> {
         ...
         this.a($$0, $$1).thenRun(() -> a($$2.apply($$0))).exceptionally($$1xx -> {
            ...
            a(new fiy(wo.c("mco.download.resourcePack.fail"), this.f));
            return null;
         });
      });
   }
