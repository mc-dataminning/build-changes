...
public class agx {
   public static void a(CommandDispatcher<dr> $$0) {
      ...
      cpi.a(
         new cpi.c() {
            @Override
            public <T extends cpi.g<T>> void a(cpi.e<T> $$0, cpi.f<T> $$1x) {
               $$1.then(
   ...
   static <T extends cpi.g<T>> int a(CommandContext<dr> $$0, cpi.e<T> $$1) {
      dr $$2 = (dr)$$0.getSource();
      T $$3 = $$2.l().aI().a($$1);
      $$3.b($$0, "value");
   ...
   static <T extends cpi.g<T>> int a(dr $$0, cpi.e<T> $$1) {
      T $$2 = $$0.l().aI().a($$1);
