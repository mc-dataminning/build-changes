...
public class agx<E> implements Codec<il<E>> {
   ...
   public static <E> Codec<il<E>> a(ahc<? extends it<E>> $$0, Codec<ih<E>> $$1, boolean $$2) {
      return new agx<>($$0, $$1, $$2);
   }

   private agx(ahc<? extends it<E>> $$0, Codec<ih<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
      this.d = Codec.either(asq.b($$0), this.c);
   }

   public <T> DataResult<Pair<il<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof ahb<T> $$2) {
