...
public class bqt implements bqu {
   ...
   private static final bqt k = new bqt();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bqs $$0) {
      URL $$1 = bqt.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bqs $$1) {
      if (this.c()) {
         ...
         try {
            ...
            this.l = af.a(new Recording($$2), $$2x -> {
               h.forEach($$2x::enable);
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bqw a = new bqw(() -> bqt.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bqt.this.l && $$0.getState() == RecordingState.STOPPED) {
