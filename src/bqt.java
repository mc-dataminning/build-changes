...
public class bqt implements bqy {
   ...
   private final Map<String, bqt.a> f = Maps.newHashMap();
   ...
   private final Set<Pair<String, bsk>> o = new ObjectArraySet();

   public bqt(LongSupplier $$0, IntSupplier $$1, BooleanSupplier $$2) {
      this.i = $$0.getAsLong();
      this.h = $$0;
      this.j = $$1.getAsInt();
      this.g = $$1;
   ...
   public void b() {
      if (!this.l) {
         ...
         this.l = false;
         if (!this.k.isEmpty()) {
            c.error("Profiler tick ended before path was fully popped (remainder: '{}'). Mismatched push/pop?", LogUtils.defer(() -> bqz.b(this.k)));
         }
      }
   }
   ...
   public void c() {
      if (!this.l) {
         ...
         if ($$2 > a && !this.n.getAsBoolean()) {
            c.warn("Something's taking too long! '{}' took aprox {} ms", LogUtils.defer(() -> bqz.b(this.k)), LogUtils.defer(() -> (double)$$2 / 1000000.0));
         }
   ...
   private bqt.a f() {
      if (this.m == null) {
         this.m = this.f.computeIfAbsent(this.k, $$0 -> new bqt.a());
      }
   ...
   @Override
   public bqz d() {
      return new bqw(this.f, this.i, this.j, this.h.getAsLong(), this.g.getAsInt());
   }

   @Nullable
   @Override
   public bqt.a c(String $$0) {
      return this.f.get($$0);
   }

   @Override
   public Set<Pair<String, bsk>> e() {
      return this.o;
   }

   public static class a implements brc {
