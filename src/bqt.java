...
public class bqt extends bqn {
   public static final MapCodec<bqt> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bqt a(float $$0, float $$1, float $$2) {
      return new bqt($$0, $$1, $$2);
   }

   private bqt(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
   }
