...
public class gp implements ArgumentType<gp.b> {
   ...
   public static gp.b a(jt<djn> $$0, StringReader $$1) throws CommandSyntaxException {
      return (gp.b)gr.b($$0, $$1, true).map($$0x -> new gp.a($$0x.a(), $$0x.b().keySet(), $$0x.c()), $$0x -> new gp.c($$0x.a(), $$0x.b(), $$0x.c()));
   }

   public static Predicate<dxc> a(CommandContext<ex> $$0, String $$1) throws CommandSyntaxException {
      return (Predicate<dxc>)$$0.getArgument($$1, gp.b.class);
   }
   ...
   static class a implements gp.b {
      ...
      public a(dwy $$0, Set<dya<?>> $$1, @Nullable tq $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public interface b extends Predicate<dxc> {
      boolean a();
   }

   static class c implements gp.b {
      private final jv<djn> a;
      @Nullable
      private final tq b;
      private final Map<String, String> c;

      c(jv<djn> $$0, Map<String, String> $$1, @Nullable tq $$2) {
         this.a = $$0;
         this.c = $$1;
         this.b = $$2;
      }
