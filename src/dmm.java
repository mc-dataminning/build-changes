...
public class dmm {
   private static final dmm a = new dmm(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public dmm.a a(int $$0, int $$1) {
         return new dmm.a(1.0, 0.0);
      }
   ...
   private static final eah b = eah.b(new dml(42L), os.a);
   ...
   private final Long2ObjectOpenHashMap<dmn> h;
   private final Long2ObjectOpenHashMap<dmn> i;

   public static dmm a() {
      return a;
   }

   public static dmm a(@Nullable alx $$0) {
      if ($$0 == null) {
         return a;
      } else {
         cqg $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<dmn> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<dmn> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = asy.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new dmm($$2, $$3);
         }
      }
   }

   dmm(Long2ObjectOpenHashMap<dmn> $$0, Long2ObjectOpenHashMap<dmn> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public dmm.a a(int $$0, int $$1) {
      int $$2 = in.a($$0);
      int $$3 = in.a($$1);
      double $$4 = this.a($$2, 0, $$3, dmn::a);
      if ($$4 != Double.MAX_VALUE) {
         return new dmm.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(in.d(cqg.a($$5x)), in.d(cqg.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
               double $$8x = asy.f((double)($$2 - $$5xx), (double)($$3 - $$6xx));
               if (!($$8x > (double)c)) {
                  if ($$8x < $$7.doubleValue()) {
                     $$7.setValue($$8x);
                  }
         ...
         if ($$7.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$9 = asy.a($$7.doubleValue() / (double)(c + 1), 0.0, 1.0);
            $$9 = 3.0 * $$9 * $$9 - 2.0 * $$9 * $$9 * $$9;
            return new dmm.a($$9, a($$8));
         }
      }
   }
   ...
   public double a(dld.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(in.d(cqg.a($$6x)), in.d(cqg.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
               double $$10x = asy.g((double)($$2 - $$6xx), (double)(($$3 - $$7xx) * 2), (double)($$4 - $$8x));
               if (!($$10x > 2.0)) {
         ...
         if ($$8.doubleValue() == Double.POSITIVE_INFINITY) {
            ...
            double $$10 = asy.a($$8.doubleValue() / 3.0, 0.0, 1.0);
            return asy.d($$10, $$9, $$1);
         }
      }
   }

   private double a(int $$0, int $$1, int $$2, dmm.b $$3) {
      int $$4 = in.e($$0);
      int $$5 = in.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(dmm.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      dmn $$6 = (dmn)this.h.get(cqg.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - in.d($$1), $$4, $$5 - in.d($$2)) : Double.MAX_VALUE;
   }

   public csa a(csa $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         ib<crx> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private ib<crx> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<ib<crx>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(in.d(cqg.a($$5x)), $$1, in.d(cqg.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
            double $$7 = asy.f((double)($$0 - $$4xx), (double)($$2 - $$5xx));
            if (!($$7 > (double)c)) {
               if ($$7 < $$3.doubleValue()) {
                  $$4.setValue($$6xx);
                  $$3.setValue($$7);
      ...
      if ($$3.doubleValue() == Double.POSITIVE_INFINITY) {
         ...
         double $$6 = asy.a(($$3.doubleValue() + $$5) / (double)(c + 1), 0.0, 1.0);
         return $$6 > 0.5 ? null : (ib)$$4.getValue();
      }
   }

   public static void a(alx $$0, dhx $$1) {
      cqg $$2 = $$1.f();
      boolean $$3 = $$1.s();
      ht.a $$4 = new ht.a();
            ...
            if ($$0.a($$2.e + $$11.j(), $$2.f + $$11.l()).s() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(dlk.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dhx $$0, ht $$1) {
      dgb $$2 = $$0.a_($$1);
      if ($$2.a(aqs.O)) {
         $$0.e($$1);
      }
   ...
   public static void a(crt $$0, dis $$1) {
      cqg $$2 = $$1.f();
      Builder<hy, dmn> $$3 = ImmutableMap.builder();
      ...
      if ($$1.s() || !$$8.isEmpty()) {
         ...
         Stream.of(dlg.a.values()).map($$1::b).forEach($$1x -> $$1x.a($$10));
      }
   }

   public static dmm.c a(@Nullable dmn $$0, Map<hy, dmn> $$1) {
      List<dmm.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static dmm.c a(@Nullable hy $$0, dmn $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (hx $$4 : $$0.a()) {
   ...
   private static double a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      ...
      return asy.g(Math.max(0.0, $$6), Math.max(0.0, $$7), Math.max(0.0, $$8));
   }
   ...
   interface b {
      double get(dmn var1, int var2, int var3, int var4);
   }
