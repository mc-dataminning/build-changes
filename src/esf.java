...
public class esf {
   ...
   private final esf.a g = new esf.a();
   private final esg h;
   private boolean i;

   private esf(eqv $$0, elp $$1, foe.a $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.h = $$0.aF();
   ...
   public void a(int $$0, int $$1, int $$2, int $$3) {
      this.a(fom.C(), $$0, $$1, $$2, $$3);
   }

   public void a(fom $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$2 < $$1) {
         int $$5 = $$1;
         $$1 = $$2;
         $$2 = $$5;
   ...
   public void b(int $$0, int $$1, int $$2, int $$3) {
      this.b(fom.C(), $$0, $$1, $$2, $$3);
   }

   public void b(fom $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$3 < $$2) {
         int $$5 = $$2;
         $$2 = $$3;
         $$3 = $$5;
   ...
   public void c(int $$0, int $$1, int $$2, int $$3) {
      this.a(this.g.a(new ews($$0, $$1, $$2 - $$0, $$3 - $$1)));
   }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a(fom.C(), $$0, $$1, $$2, $$3, $$4, $$5);
   }

   public void a(fom $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, 0, $$5);
   }

   public void a(fom $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      ...
      float $$10 = (float)arh.b.a($$6) / 255.0F;
      float $$11 = (float)arh.b.b($$6) / 255.0F;
      float $$12 = (float)arh.b.c($$6) / 255.0F;
      float $$13 = (float)arh.b.d($$6) / 255.0F;
      elt $$14 = this.f.getBuffer($$0);
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      this.a(fom.C(), $$0, $$1, $$2, $$3, $$5, $$6, $$4);
   }

   public void a(fom $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      elt $$8 = this.f.getBuffer($$0);
      this.a($$8, $$1, $$2, $$3, $$4, $$7, $$5, $$6);
      this.g();
   }

   private void a(elt $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      float $$8 = (float)arh.b.a($$6) / 255.0F;
      float $$9 = (float)arh.b.b($$6) / 255.0F;
      float $$10 = (float)arh.b.c($$6) / 255.0F;
      float $$11 = (float)arh.b.d($$6) / 255.0F;
      float $$12 = (float)arh.b.a($$7) / 255.0F;
      float $$13 = (float)arh.b.b($$7) / 255.0F;
      float $$14 = (float)arh.b.c($$7) / 255.0F;
      float $$15 = (float)arh.b.d($$7) / 255.0F;
   ...
   public void a(esd $$0, String $$1, int $$2, int $$3, int $$4) {
   ...
   public void a(esd $$0, arj $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.a($$1) / 2, $$3, $$4);
   }

   public int b(esd $$0, @Nullable String $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(esd $$0, @Nullable String $$1, int $$2, int $$3, int $$4, boolean $$5) {
      if ($$1 == null) {
         return 0;
      } else {
         int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, esd.a.a, 0, 15728880, $$0.a());
         this.g();
         return $$6;
      }
   }

   public int b(esd $$0, arj $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(esd $$0, arj $$1, int $$2, int $$3, int $$4, boolean $$5) {
      int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, esd.a.a, 0, 15728880);
      this.g();
      return $$6;
   }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, fze $$5) {
      this.a($$5, $$0, $$1, $$2, $$3, $$4);
   }

   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, fze $$5, float $$6, float $$7, float $$8, float $$9) {
   ...
   public void a(aew $$0, int $$1, int $$2, int $$3, int $$4) {
      this.a($$0, $$1, $$2, 0, $$3, $$4);
   }

   public void a(aew $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      fze $$6 = this.h.a($$0);
      gaw $$7 = this.h.a($$6);
      if ($$7 instanceof gaw.b) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5);
      } else if ($$7 instanceof gaw.c $$8) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5, 0, 0, $$8.b(), $$8.c(), $$8.b(), $$8.c());
      } else if ($$7 instanceof gaw.a $$9) {
         this.a($$6, $$9, $$1, $$2, $$3, $$4, $$5);
      }
   }

   public void a(aew $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0, $$7, $$8);
   }

   public void a(aew $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9) {
      fze $$10 = this.h.a($$0);
      gaw $$11 = this.h.a($$10);
      if ($$11 instanceof gaw.b) {
   ...
   private void a(fze $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9) {
      if ($$8 != 0 && $$9 != 0) {
         this.a(
            $$0.i(),
            $$5,
   ...
   private void a(fze $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      if ($$4 != 0 && $$5 != 0) {
         this.a($$0.i(), $$1, $$1 + $$4, $$2, $$2 + $$5, $$3, $$0.c(), $$0.d(), $$0.g(), $$0.h());
      }
   }

   public void a(aew $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      this.a($$0, $$1, $$2, 0, (float)$$3, (float)$$4, $$5, $$6, 256, 256);
   }

   public void a(aew $$0, int $$1, int $$2, int $$3, float $$4, float $$5, int $$6, int $$7, int $$8, int $$9) {
      this.a($$0, $$1, $$1 + $$6, $$2, $$2 + $$7, $$3, $$6, $$7, $$4, $$5, $$8, $$9);
   }

   public void a(aew $$0, int $$1, int $$2, int $$3, int $$4, float $$5, float $$6, int $$7, int $$8, int $$9, int $$10) {
      this.a($$0, $$1, $$1 + $$3, $$2, $$2 + $$4, 0, $$7, $$8, $$5, $$6, $$9, $$10);
   }

   public void a(aew $$0, int $$1, int $$2, float $$3, float $$4, int $$5, int $$6, int $$7, int $$8) {
      this.a($$0, $$1, $$2, $$5, $$6, $$3, $$4, $$5, $$6, $$7, $$8);
   }

   void a(aew $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, float $$8, float $$9, int $$10, int $$11) {
      this.a(
         $$0,
         $$1,
         $$2,
   ...
   void a(aew $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, float $$9) {
   ...
   void a(aew $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, float $$9, float $$10, float $$11, float $$12, float $$13) {
      RenderSystem.setShaderTexture(0, $$0);
   ...
   private void a(fze $$0, gaw.a $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      gaw.a.a $$7 = $$1.d();
   ...
   private void a(fze $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9, int $$10, int $$11) {
      if ($$4 > 0 && $$5 > 0) {
         if ($$8 > 0 && $$9 > 0) {
   ...
   public void a(cjf $$0, int $$1, int $$2) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, 0);
   }

   public void a(cjf $$0, int $$1, int $$2, int $$3) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3);
   }

   public void a(cjf $$0, int $$1, int $$2, int $$3, int $$4) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3, $$4);
   }

   public void b(cjf $$0, int $$1, int $$2) {
      this.a(null, this.d.r, $$0, $$1, $$2, 0);
   }

   public void a(bjg $$0, cjf $$1, int $$2, int $$3, int $$4) {
      this.a($$0, $$0.dL(), $$1, $$2, $$3, $$4);
   }

   private void a(@Nullable bjg $$0, @Nullable cpv $$1, cjf $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 0);
   }

   private void a(@Nullable bjg $$0, @Nullable cpv $$1, cjf $$2, int $$3, int $$4, int $$5, int $$6) {
      if (!$$2.b()) {
         gbf $$7 = this.d.aq().a($$2, $$1, $$0, $$5);
         this.e.a();
         ...
         try {
            ...
            this.d.aq().a($$2, cjc.g, false, this.e, this.d(), 15728880, fyv.d, $$7);
            this.e();
            if ($$8) {
               ekl.b();
            }
   ...
   public void a(esd $$0, cjf $$1, int $$2, int $$3) {
      this.a($$0, $$1, $$2, $$3, null);
   }

   public void a(esd $$0, cjf $$1, int $$2, int $$3, @Nullable String $$4) {
      if (!$$1.b()) {
         this.e.a();
         if ($$1.L() != 1 || $$4 != null) {
         ...
         if ($$1.m()) {
            ...
            int $$8 = $$2 + 2;
            int $$9 = $$3 + 13;
            this.a(fom.D(), $$8, $$9, $$8 + 13, $$9 + 2, -16777216);
            this.a(fom.D(), $$8, $$9, $$8 + $$6, $$9 + 1, $$7 | 0xFF000000);
         }

         fng $$10 = this.d.s;
         float $$11 = $$10 == null ? 0.0F : $$10.gm().a($$1.d(), this.d.as());
         if ($$11 > 0.0F) {
            int $$12 = $$3 + arw.d(16.0F * (1.0F - $$11));
            int $$13 = $$12 + arw.f(16.0F * $$11);
            this.a(fom.D(), $$2, $$12, $$2 + 16, $$13, Integer.MAX_VALUE);
         }
   ...
   public void b(esd $$0, cjf $$1, int $$2, int $$3) {
   ...
   public void b(esd $$0, List<? extends arj> $$1, int $$2, int $$3) {
      this.a($$0, $$1.stream().map(fba::a).collect(Collectors.toList()), $$2, $$3, fbc.a);
   }

   public void a(esd $$0, List<arj> $$1, fbb $$2, int $$3, int $$4) {
      this.a($$0, $$1.stream().map(fba::a).collect(Collectors.toList()), $$3, $$4, $$2);
   }

   private void a(esd $$0, List<fba> $$1, int $$2, int $$3, fbb $$4) {
      if (!$$1.isEmpty()) {
         int $$5 = 0;
         int $$6 = $$1.size() == 1 ? -2 : 0;
         ...
         this.e.a();
         int $$14 = 400;
         this.a(() -> fbe.a(this, $$12, $$13, $$9, $$10, 400));
   ...
   static class a {
      private final Deque<ews> a = new ArrayDeque<>();

      public ews a(ews $$0) {
         ews $$1 = this.a.peekLast();
         if ($$1 != null) {
            ews $$2 = Objects.requireNonNullElse($$0.b($$1), ews.a());
            this.a.addLast($$2);
            return $$2;
         } else {
            this.a.addLast($$0);
