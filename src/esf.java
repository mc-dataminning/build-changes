...
public abstract class esf implements eti, eua, evq, evv {
   ...
   public esf(int $$0, int $$1, int $$2, int $$3, tf $$4) {
      this.c = $$0;
      this.d = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   private void a() {
      if (this.n != null) {
         boolean $$0 = this.h || this.ax_() && eqm.O().aU().b();
         if ($$0 != this.q) {
            if ($$0) {
               this.p = ac.b();
            }
   ...
   protected faq i() {
      return (faq)(!this.h && this.ax_() && eqm.O().aU().b() ? new fam(this) : new fas(this));
   }
   ...
   protected abstract void b(erw var1, int var2, int var3, float var4);

   protected static void a(erw $$0, eru $$1, tf $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(erw $$0, eru $$1, tf $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(erw $$0, eru $$1, int $$2, int $$3) {
      int $$4 = this.p() + $$2;
   ...
   public evv.a q() {
      if (this.ax_()) {
         ...
         return this.h ? evv.a.b : evv.a.a;
      }
   }

   @Override
   public final void b(evx $$0) {
      this.a($$0);
      if (this.n != null) {
         this.n.b($$0);
      }
   ...
   protected abstract void a(evx var1);

   protected void c(evx $$0) {
      $$0.a(evw.a, this.aB_());
      if (this.i) {
         if (this.ax_()) {
            $$0.a(evw.d, tf.c("narration.button.usage.focused"));
         } else {
