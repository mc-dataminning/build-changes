...
public class esf {
   ...
   private final eql g;
   final Map<UUID, esu> h = Maps.newLinkedHashMap();
   ...
   private void a(erv $$0, int $$1, int $$2, bgg $$3) {
   ...
   private void a(erv $$0, int $$1, int $$2, bgg $$3, int $$4, aer[] $$5, aer[] $$6) {
   ...
   public void a(xa $$0) {
      $$0.a(new xa.b() {
         ...
         public void a(UUID $$0, tf $$1, float $$2, bgg.a $$3, bgg.b $$4, boolean $$5, boolean $$6, boolean $$7) {
            esf.this.h.put($$0, new esu($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7));
         }
