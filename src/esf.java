public abstract class esf extends esj implements etn, euf {
   private static final etx a = new etx(new aeu("widget/text_field"), new aeu("widget/text_field_highlighted"));
   private static final aeu b = new aeu("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean l;

   public esf(int $$0, int $$1, int $$2, int $$3, ti $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int w() {
      return ars.a((int)((float)(this.g * this.g) / (float)this.x()), 32, this.g);
   }
   ...
   protected void a(double $$0) {
      this.e = ars.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(esa $$0, int $$1, int $$2, int $$3, int $$4) {
      aeu $$5 = a.a(this.az_(), this.ay_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(esa var1, int var2, int var3, float var4);
}
