...
public interface dfi extends deh, deo, dfx, dgj.a {
   @Nullable
   dxj a(int var1, int var2, dyk var3, boolean var4);

   @Deprecated
   boolean b(int var1, int var2);

   int a(ebj.a var1, int var2, int var3);

   int B_();

   dgj F_();

   default jq<dgh> t(jh $$0) {
      return this.F_().a($$0);
   }

   default Stream<dvo> c(ezm $$0) {
      int $$1 = azn.a($$0.a);
      int $$2 = azn.a($$0.d);
      int $$3 = azn.a($$0.b);
      int $$4 = azn.a($$0.e);
   ...
   @Override
   default int a(jh $$0, dep $$1) {
      return $$1.getColor(this.t($$0).a(), (double)$$0.u(), (double)$$0.w());
   }

   @Override
   default jq<dgh> getNoiseBiome(int $$0, int $$1, int $$2) {
      dxj $$3 = this.a(kb.e($$0), kb.e($$2), dyk.f, false);
      return $$3 != null ? $$3.getNoiseBiome($$0, $$1, $$2) : this.a($$0, $$1, $$2);
   }

   jq<dgh> a(int var1, int var2, int var3);
   ...
   default dxj a(int $$0, int $$1) {
      return this.a($$0, $$1, dyk.n, true);
   }

   default dxj a(int $$0, int $$1, dyk $$2) {
      return this.a($$0, $$1, $$2, true);
   }

   @Nullable
   @Override
   default dek c(int $$0, int $$1) {
   ...
   default <T> js<T> a(alk<? extends kd<? extends T>> $$0) {
      kd<T> $$1 = this.H_().e($$0);
      return $$1.a(this.J());
   }
}
