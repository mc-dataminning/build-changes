...
public class dfi {
   ...
   public dfi(cpx $$0, gw $$1, hc $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dfl $$0 = this.b.a_(this.e);
      if (!dfe.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == eat.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dfl $$0) {
      return $$0.a(csy.hV) || $$0.a(csy.pg);
   }

   private static boolean a(dfl $$0, dfl $$1) {
      if ($$0.a(csy.pg) && $$1.a(csy.hV)) {
         return false;
      } else {
         return $$0.a(csy.hV) && $$1.a(csy.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(gw $$0, hc $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dfe.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dfl $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dfe.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dfe.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
