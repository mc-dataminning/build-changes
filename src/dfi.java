...
public abstract class dfi {
   ...
   public void a(bur<?> $$0, @Nullable dgh $$1, azh $$2, ji $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  int $$16 = $$0.a(
                        ebg.b($$15.getClass()),
                        new fau((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bup.f
                     )
                     .size();
                  ...
                  if ($$15 instanceof bvi $$17) {
                     if ($$4.b().isEmpty() && !$$17.a($$0, buq.c) || !$$17.a((dgk)$$0)) {
                        continue;
                     }

                     boolean $$18 = $$4.a().f() == 1 && $$4.a().b("id", 8);
                     if ($$18) {
                        ((bvi)$$15).a($$0, $$0.d_($$15.dv()), buq.c, null);
                     }
   ...
   private void d(dgh $$0, ji $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dhb)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dgh $$0, ji $$1, tq $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dhb $$4 = dhb.b.parse(ue.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dhb::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dhb.c.parse(ue.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bqr::b);
      } else {
         this.e = bqr.a(this.f != null ? this.f : new dhb());
      }
   ...
   public tq a(tq $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (un)dhb.b.encodeStart(ue.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (un)dhb.c.encodeStart(ue.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public buk b(dgh $$0, ji $$1) {
      if (this.l == null) {
   ...
   protected void a(@Nullable dgh $$0, ji $$1, dhb $$2) {
      this.f = $$2;
   }

   private dhb a(@Nullable dgh $$0, azh $$1, ji $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bqt.b::b).orElseGet(dhb::new));
         return this.f;
      }
   }

   public abstract void a(dgh var1, ji var2, int var3);
