...
public class byc<E extends bvi> extends bwz<E> {
   ...
   protected boolean a(arc $$0, bvi $$1) {
      boolean $$2 = $$1.aJ() && !$$1.bj() && !$$1.bx() && !$$0.a_($$1.dw()).a(djo.pI);
      if (!$$2) {
         $$1.ec().a(cek.S, this.p.a($$0.A) / 2);
      }

      return $$2;
   }

   protected boolean b(arc $$0, bvi $$1, long $$2) {
      boolean $$3 = this.i.isPresent() && this.i.get().equals($$1.du()) && this.k > 0 && !$$1.bm() && (this.j != null || !this.h.isEmpty());
      if (!$$3 && $$1.ec().c(cek.T).isEmpty()) {
         $$1.ec().a(cek.S, this.p.a($$0.A) / 2);
         $$1.ec().b(cek.n);
      }
