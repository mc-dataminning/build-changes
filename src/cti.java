...
public class cti {
   public static <T> List<cti.b> a(List<T> $$0, Function<T, List<ig<dwl>>> $$1, boolean $$2) {
      Object2IntMap<dwl> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, dwl c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<ig<dwl>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (ib<dwl> $$12 : $$10.get($$11)) {
               dwl $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && atb.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<cti.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<dwl> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new cti.b($$28));
      }
   ...
   public static record b(List<dwl> a, ToIntFunction<dwl> b) {
      b(List<dwl> $$0) {
         this($$0, ac.f($$0));
      }
   }
