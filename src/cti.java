...
public class cti extends csi implements czw {
   ...
   public void a(dfj $$0, cpv $$1, gw $$2, asc $$3) {
      if ($$0.c(b)) {
         if ($$3.a(10) == 0) {
            $$1.a((double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, apd.db, ape.e, 0.5F + $$3.i(), $$3.i() * 0.7F + 0.6F, false);
         }
   ...
   public boolean a(cpw $$0, gw $$1, dfj $$2, eam $$3) {
      if (!$$2.c(dfz.C) && $$3.a() == ean.c) {
         ...
         if ($$4) {
            if (!$$0.w_()) {
               $$0.a(null, $$1, apd.iY, ape.e, 1.0F, 1.0F);
            }
   ...
   public static boolean h(dfj $$0) {
      return $$0.a(aps.aU, $$0x -> $$0x.b(d) && $$0x.b(b)) && !$$0.c(d) && !$$0.c(b);
   }
}
