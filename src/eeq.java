...
public class eeq {
   private static final eeq a = new eeq(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public eeq.a a(int $$0, int $$1) {
         return new eeq.a(1.0, 0.0);
      }
   ...
   private static final esz b = esz.b(new eep(42L), qi.a);
   ...
   private final Long2ObjectOpenHashMap<eer> h;
   private final Long2ObjectOpenHashMap<eer> i;

   public static eeq a() {
      return a;
   }

   public static eeq a(@Nullable arl $$0) {
      if ($$0 == null) {
         return a;
      } else {
         dgg $$1 = $$0.b();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<eer> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<eer> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = ayz.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new eeq($$2, $$3);
         }
      }
   }

   eeq(Long2ObjectOpenHashMap<eer> $$0, Long2ObjectOpenHashMap<eer> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public eeq.a a(int $$0, int $$1) {
      int $$2 = kc.a($$0);
      int $$3 = kc.a($$1);
      double $$4 = this.a($$2, 0, $$3, eer::a);
      if ($$4 != Double.MAX_VALUE) {
         return new eeq.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(kc.d(dgg.a($$5x)), kc.d(dgg.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(edh.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(kc.d(dgg.a($$6x)), kc.d(dgg.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, eeq.b $$3) {
      int $$4 = kc.e($$0);
      int $$5 = kc.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(eeq.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      eer $$6 = (eer)this.h.get(dgg.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - kc.d($$1), $$4, $$5 - kc.d($$2)) : Double.MAX_VALUE;
   }

   public dif a(dif $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jr<dic> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jr<dic> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jr<dic>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(kc.d(dgg.a($$5x)), $$1, kc.d(dgg.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(arl $$0, dzm $$1) {
      dgg $$2 = $$1.f();
      boolean $$3 = $$1.u();
      ji.a $$4 = new ji.a();
            ...
            if ($$0.a($$2.h + $$11.j(), $$2.i + $$11.l()).u() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(edo.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dzm $$0, ji $$1) {
      dxq $$2 = $$0.a_($$1);
      if ($$2.a(awp.Q)) {
         $$0.e($$1);
      }
   ...
   public static void a(dhy $$0, eag $$1) {
      dgg $$2 = $$1.f();
      Builder<jo, eer> $$3 = ImmutableMap.builder();
   ...
   public static eeq.c a(@Nullable eer $$0, Map<jo, eer> $$1) {
      List<eeq.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static eeq.c a(@Nullable jo $$0, eer $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jn $$4 : $$0.a()) {
   ...
   interface b {
      double get(eer var1, int var2, int var3, int var4);
   }
