...
public class eeq implements bam {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<eeq> b = eep.a.xmap($$0 -> new eeq($$0), $$0 -> $$0.e);
   private eep e;
   private final edr f = new edr(this);

   public eeq(long $$0) {
      this.e = new eep(eee.c($$0));
   }
   ...
   @Override
   public bam d() {
      return new eeq(this.e.a(), this.e.a());
   }

   @Override
   public eec e() {
      return new eeq.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements eec {
      ...
      public bam a(int $$0, int $$1, int $$2) {
         long $$3 = bae.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new eeq($$4, this.b);
      }

      @Override
      public bam a(String $$0) {
         eee.a $$1 = eee.a($$0);
         return new eeq($$1.a(this.a, this.b));
      }

      @Override
      public bam a(long $$0) {
         return new eeq($$0 ^ this.a, $$0 ^ this.b);
      }
