...
public class eeq extends eew<egy> {
   public eeq(Codec<egy> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eey<egy> $$0) {
      dgk $$1 = $$0.b();
      jh $$2 = $$0.e();
      egy $$3 = $$0.f();
      azu $$4 = $$0.d();
   ...
   private void a(dgk $$0, azu $$1, jh $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, egy $$9) {
      Optional<ebg> $$10 = ebg.a($$0, $$2, $$9.b, eer::c, eer::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((dfp)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((dfp)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               eer.a($$0, $$2.h($$11.getAsInt() - 1), jm.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               eer.a($$0, $$2.h($$17.getAsInt() + 1), jm.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(dfp $$0, jh $$1) {
      return $$0.a_($$1).a(dis.H);
   }

   private int a(azu $$0, int $$1, int $$2, float $$3, int $$4, egy $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(dgk $$0, jh $$1) {
      dvv $$2 = $$0.a_($$1);
      if (!$$2.a(dis.G) && !$$2.a(dis.su) && !$$2.a(dis.st)) {
         if ($$0.a_($$1.d()).y().a(axi.a)) {
            return false;
         } else {
            for (jm $$3 : jm.c.a) {
               if (!this.a((dfn)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((dfn)$$0, $$1.e());
         }
      } else {
         return false;
      }
   ...
   private boolean a(dfn $$0, jh $$1) {
      dvv $$2 = $$0.a_($$1);
      return $$2.a(axc.bf) || $$2.y().a(axi.a);
   }

   private void a(dgk $$0, jh $$1, int $$2, jm $$3) {
      jh.a $$4 = $$1.k();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, egy $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
   ...
   private static float a(azu $$0, float $$1, float $$2, float $$3, float $$4) {
      return brj.a($$0, $$3, $$4, $$1, $$2);
   }
}
