...
public class ffc {
   ...
   private static final Map<dvq.a, String> e = ac.a(new EnumMap<>(dvq.a.class), $$0 -> {
      $$0.put(dvq.a.a, "SW");
      $$0.put(dvq.a.b, "S");
      $$0.put(dvq.a.c, "OW");
      $$0.put(dvq.a.d, "O");
   ...
   private dse l;
   @Nullable
   private CompletableFuture<dse> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bkk r = new bkk(1);
   private final bkk s = new bkk(bkp.values().length);
   private final bkk t = new bkk(1);
   private final bkk u = new bkk(1);
   private final Map<bkl, bkk> v = Map.of(bkl.a, this.s);
   private final fgl w;
   private final fgn x;
   private final fgm y;
   private final fgk z;
   ...
   public ffc(fcu $$0) {
      ...
      this.g = new ffc.a();
      this.h = $$0.h;
      this.w = new fgl(this.h, this.r);
      this.x = new fgn(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fgm(this.h, this.t);
      this.z = new fgk(this.h, this.u);
   }
   ...
   private void a(feh $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         czu $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof aqe ? ((aqe)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Chunk: %d %d %d [%d %d in r.%d.%d.mca]", $$22.e, jo.a($$14.v()), $$22.f, $$22.j(), $$22.k(), $$22.h(), $$22.i()));
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, axw.g($$15.dD()), axw.g($$15.dF())));
         dse $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(dad.a, $$14);
            int $$30 = this.f.r.a(dad.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dse $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dvq.a $$33 : dvq.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.al()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ap();
                  long $$36 = $$31.u();
                  boo $$37 = new boo($$23.ak(), $$23.Z(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            daf.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<brh> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(brh.values())
   ...
   private static String a(iv<dat> $$0) {
   ...
   private czu r() {
      return (czu)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ae()))), this.f.r);
   }
   ...
   private dse s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dst.n, false).thenApply($$0x -> (dse)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", ewg.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fcu.Q().aO().k(), fcu.Q().aO().l(), ewg.a()),
            ewg.c(),
            ewg.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == etd.a.b) {
            ...
            $$4.add(String.valueOf(lc.e.b($$6.b())));

            for (Entry<drb<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == etd.a.b) {
            ...
            $$4.add(String.valueOf(lc.c.b($$9.a())));

            for (Entry<drb<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(lc.g.b($$11.ai())));
         }
   ...
   private String a(Entry<drb<?>, Comparable<?>> $$0) {
      drb<?> $$1 = $$0.getKey();
