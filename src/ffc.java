...
public abstract class ffc {
   ...
   public fed a() {
      if (this.c()) {
         ...
         return new fed(this.b(ja.a.a), this.b(ja.a.b), this.b(ja.a.c), this.c(ja.a.a), this.c(ja.a.b), this.c(ja.a.c));
      }
   }

   public ffc b() {
      return this.c() ? fez.a() : fez.a(this.b(ja.a.a), this.b(ja.a.b), this.b(ja.a.c), this.c(ja.a.a), this.c(ja.a.b), this.c(ja.a.c));
   }
   ...
   public ffc a(double $$0, double $$1, double $$2) {
      return (ffc)(this.c() ? fez.a() : new fek(this.a, new fey(this.a(ja.a.a), $$0), new fey(this.a(ja.a.b), $$1), new fey(this.a(ja.a.c), $$2)));
   }

   public ffc d() {
      ffc[] $$0 = new ffc[]{fez.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = fez.b($$0[0], fez.a($$1, $$2, $$3, $$4, $$5, $$6), fem.o));
      return $$0[0];
   }

   public void a(fez.a $$0) {
      this.a
         .a(
   ...
   public List<fed> e() {
      List<fed> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new fed($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.h() < 1.0E-7) {
            ...
            return this.a.e(this.a(ja.a.a, $$4.d - (double)$$2.u()), this.a(ja.a.b, $$4.e - (double)$$2.v()), this.a(ja.a.c, $$4.f - (double)$$2.w()))
               ? new fee($$4, ja.a($$3.d, $$3.e, $$3.f).g(), $$2, true)
               : fed.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<fei> b(fei $$0) {
      if (this.c()) {
   ...
   public ffc a(ja $$0) {
      if (!this.c() && this != fez.b()) {
         if (this.b != null) {
            ffc $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ffc b(ja $$0) {
      ...
      if (this.d($$1)) {
         ...
         ffa $$4 = new ffa(this, $$1, $$3);
         if ($$4.c()) {
            return fez.a();
         } else {
            return (ffc)($$4.f() ? fez.b() : $$4);
         }
      }
   }
   ...
   public double a(ja.a $$0, fed $$1, double $$2) {
      return this.a(ir.a($$0, ja.a.a), $$1, $$2);
   }

   protected double a(ir $$0, fed $$1, double $$2) {
      if (this.c()) {
         return $$2;
