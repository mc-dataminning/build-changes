...
public class ffc extends fdy<cjf> {
   ...
   protected void aN_() {
      super.aN_();
      this.P = this.f.aP().a(fmu.f).b("flag");
   }
   ...
   protected void a(ews $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.Q != null && !this.V) {
         ...
         this.P.e = 0.0F;
         this.P.c = -32.0F;
         fva.a($$0.c(), $$0.d(), 15728880, gec.d, this.P, ggq.f, true, this.Q);
         $$0.c().b();
         $$0.e();
      } else if (this.V) {
   ...
   private void a(ews $$0, ih<dgl> $$1, int $$2, int $$3) {
      sn $$4 = new sn();
      ...
      fva.a($$7, $$0.d(), 15728880, gec.d, this.P, ggq.f, true, $$9);
      $$7.b();
      $$0.e();
   }
