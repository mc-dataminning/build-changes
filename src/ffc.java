...
public class ffc {
   ...
   public static List<ffc.a> a(String $$0, ffc.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<ffc.a> a(String $$0, List<ffc.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<ffc.a> a(List<String> $$0, List<ffc.b> $$1) {
      int $$2 = 0;
      List<ffc.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<ffc.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static ffc.b a(String $$0, String $$1) {
         return new ffc.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static ffc.b a(String $$0) {
         return new ffc.b($$0);
      }
   }
}
