...
public abstract class ffc implements fgh, fha, fit, fiy {
   ...
   private int f;
   private boolean m;
   private final fgs n = new fgs();

   public ffc(int $$0, int $$1, int $$2, int $$3, wu $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(fer $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(fer var1, int var2, int var3, float var4);

   protected static void a(fer $$0, fep $$1, wu $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(fer $$0, fep $$1, wu $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
         ...
         double $$16 = axz.d($$15, 0.0, (double)$$12);
         $$0.c($$4, $$5, $$6, $$7);
         $$0.b($$1, $$2, $$4 - (int)$$16, $$10, $$8);
         $$0.f();
      } else {
         int $$17 = axz.a($$3, $$4 + $$9 / 2, $$6 - $$9 / 2);
         $$0.a($$1, $$2, $$17, $$10, $$8);
      }
   }

   protected void a(fer $$0, fep $$1, int $$2, int $$3) {
      int $$4 = this.C() + $$2;
   ...
   public fiy.a t() {
      if (this.aI_()) {
         ...
         return this.i ? fiy.a.b : fiy.a.a;
      }
   }

   @Override
   public final void b(fja $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fja var1);

   protected void c(fja $$0) {
      $$0.a(fiz.a, this.aK_());
      if (this.j) {
         if (this.aI_()) {
            $$0.a(fiz.d, wu.c("narration.button.usage.focused"));
         } else {
