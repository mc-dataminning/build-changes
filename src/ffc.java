...
public class ffc {
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.m(2)) {
                  ...
                  this.b.s.cz.d("gamemode " + ((dbt)MoreObjects.firstNonNull(this.b.q.i(), dbt.b)).b());
               }
   ...
   private void a(dsa $$0, iz $$1, @Nullable ur $$2) {
   ...
   private void a(ale $$0, evp $$1, @Nullable ur $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().i()) {
         boolean $$5 = eyr.a(ffd.Q().aO().i(), 292);
         if (this.d > 0L) {
            if (!eyr.a(ffd.Q().aO().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (eyr.a(ffd.Q().aO().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.c();
            this.e = ac.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fnu) || ((fnu)$$6).r <= ac.c() - 20L)) {
            if (this.b.m.Q.a($$1, $$2)) {
               this.b.aO().h();
            ...
            if (this.b.m.N.a($$1, $$2)) {
               ...
               ffn.a(this.b.p, this.b.h(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aH_() instanceof fhl) || !((fhl)$$6.aH_()).d();
            if ($$7) {
               if (fnb.r() && $$1 == 66 && this.b.aX().a() && this.b.m.u().c()) {
                  boolean $$8 = this.b.m.as().c() == fff.a;
                  this.b.m.as().a(fff.a(this.b.m.as().c().a() + 1));
                  this.b.m.av();
                  if ($$6 instanceof fnd) {
                     ((fnd)$$6).D();
                  }
         ...
         label187: {
            ...
            label147:
            if (!$$11) {
               if (this.b.y instanceof fmw $$12 && !$$12.m()) {
                  break label147;
               }
      ...
      if ($$0 == this.b.aO().i()) {
         ...
         if ($$3 != null && this.b.aL() == null) {
            if (Character.charCount($$1) == 1) {
               fnb.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fnb.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", ayx.f((float)$$1 / 1000.0F));
            }
