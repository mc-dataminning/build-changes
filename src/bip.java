...
public class bip extends bhj {
   public bip(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bin.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bkb.a($$0.get("id").asString("minecraft:air"));
