...
public abstract class bip extends biq {
   ...
   private static final aef<Integer> q = aei.a(bip.class, aeh.b);
   private static final aef<Integer> r = aei.a(bip.class, aeh.b);
   private static final aef<Integer> s = aei.a(bip.class, aeh.b);
   private static final aef<Vector3f> t = aei.a(bip.class, aeh.A);
   private static final aef<Vector3f> u = aei.a(bip.class, aeh.A);
   private static final aef<Quaternionf> v = aei.a(bip.class, aeh.B);
   private static final aef<Quaternionf> aE = aei.a(bip.class, aeh.B);
   private static final aef<Byte> aF = aei.a(bip.class, aeh.a);
   private static final aef<Integer> aG = aei.a(bip.class, aeh.b);
   private static final aef<Float> aH = aei.a(bip.class, aeh.d);
   private static final aef<Float> aI = aei.a(bip.class, aeh.d);
   private static final aef<Float> aJ = aei.a(bip.class, aeh.d);
   private static final aef<Float> aK = aei.a(bip.class, aeh.d);
   private static final aef<Float> aL = aei.a(bip.class, aeh.d);
   private static final aef<Integer> aM = aei.a(bip.class, aeh.b);
   ...
   public float a(float $$0) {
      ...
      if ($$1 <= 0) {
         ...
         float $$3 = $$2 + $$0;
         float $$4 = arx.a(arx.g($$3, 0.0F, (float)$$1), 0.0F, 1.0F);
         this.aT = $$4;
         return $$4;
      }
   }
   ...
   public static enum a implements asp {
      ...
      public static final IntFunction<bip.a> f = aqs.a(bip.a::a, values(), aqs.a.a);
   ...
   public static class b extends bip {
      ...
      private static final aef<dfj> q = aei.a(bip.b.class, aeh.i);
      @Nullable
      private bip.b.a r;
   ...
   static record c(int a, int b) implements bip.f {
      ...
      public int get(float $$0) {
         return ari.b.a($$0, this.a, this.b);
      }
   }
   ...
   public static class g extends bip {
      ...
      private static final aef<cjf> r = aei.a(bip.g.class, aeh.h);
      private static final aef<Byte> s = aei.a(bip.g.class, aeh.a);
   ...
   public static class l extends bip {
      ...
      private static final aef<Byte> aQ = aei.a(bip.l.class, aeh.a);
      ...
      public static record c(ark a, int b) {
      }
