...
public abstract class bip extends biq {
   ...
   private static final aee<Integer> q = aeh.a(bip.class, aeg.b);
   private static final aee<Integer> r = aeh.a(bip.class, aeg.b);
   private static final aee<Integer> s = aeh.a(bip.class, aeg.b);
   private static final aee<Vector3f> t = aeh.a(bip.class, aeg.A);
   private static final aee<Vector3f> u = aeh.a(bip.class, aeg.A);
   private static final aee<Quaternionf> v = aeh.a(bip.class, aeg.B);
   private static final aee<Quaternionf> aE = aeh.a(bip.class, aeg.B);
   private static final aee<Byte> aF = aeh.a(bip.class, aeg.a);
   private static final aee<Integer> aG = aeh.a(bip.class, aeg.b);
   private static final aee<Float> aH = aeh.a(bip.class, aeg.d);
   private static final aee<Float> aI = aeh.a(bip.class, aeg.d);
   private static final aee<Float> aJ = aeh.a(bip.class, aeg.d);
   private static final aee<Float> aK = aeh.a(bip.class, aeg.d);
   private static final aee<Float> aL = aeh.a(bip.class, aeg.d);
   private static final aee<Integer> aM = aeh.a(bip.class, aeg.b);
   ...
   protected void a(qw $$0) {
      ...
      if ($$0.b("brightness", 10)) {
         aqq.b.decode(ri.a, $$0.c("brightness")).resultOrPartial(ac.a("Display entity", p::error)).ifPresent($$0x -> this.a((aqq)$$0x.getFirst()));
      } else {
         this.a(null);
      }
   }
   ...
   protected void b(qw $$0) {
      ...
      aqq $$1 = this.x();
      if ($$1 != null) {
         aqq.b.encodeStart(ri.a, $$1).result().ifPresent($$1x -> $$0.a("brightness", $$1x));
      }
   }
   ...
   public void a(double $$0, double $$1, double $$2, float $$3, float $$4, int $$5) {
      int $$6 = this.v();
      this.aY = new bip.j($$6, $$0, $$1, $$2, (double)$$3, (double)$$4);
   }
   ...
   private void a(bip.a $$0) {
      this.an.b(aF, $$0.a());
   }

   private bip.a w() {
      return bip.a.f.apply(this.an.b(aF));
   }

   private void a(@Nullable aqq $$0) {
   ...
   public float a(float $$0) {
      ...
      if ($$1 <= 0) {
         ...
         float $$3 = $$2 + $$0;
         float $$4 = arw.a(arw.g($$3, 0.0F, (float)$$1), 0.0F, 1.0F);
         this.aT = $$4;
         return $$4;
      }
   }
   ...
   private void G() {
      ...
      if ($$0 != 0.0F && $$1 != 0.0F) {
         ...
         double $$4 = this.ds();
         double $$5 = this.dw();
         this.aU = new ehi($$3 - (double)$$2, $$4, $$5 - (double)$$2, $$3 + (double)$$2, $$4 + (double)$$1, $$5 + (double)$$2);
      } else {
         this.at = true;
      }
   }
   ...
   public boolean a(double $$0) {
      return $$0 < arw.k((double)this.z() * 64.0 * cz());
   }
   ...
   private bip.k H() {
      return new bip.k(bip.e.constant(a(this.an)), this.w(), this.y(), bip.d.constant(this.A()), bip.d.constant(this.B()), this.E());
   }

   private bip.k a(bip.k $$0, float $$1) {
      j $$2 = $$0.a.get($$1);
      float $$3 = $$0.d.get($$1);
      float $$4 = $$0.e.get($$1);
      return new bip.k(new bip.m($$2, a(this.an)), this.w(), this.y(), new bip.h($$3, this.A()), new bip.h($$4, this.B()), this.E());
   }
   ...
   public static enum a implements asp {
      ...
      public static final Codec<bip.a> e = asp.a(bip.a::values);
      public static final IntFunction<bip.a> f = aqr.a(bip.a::a, values(), aqr.a.a);
   ...
   public static class b extends bip {
      ...
      private static final aee<dfj> q = aeh.a(bip.b.class, aeg.i);
      @Nullable
      private bip.b.a r;

      public b(biu<?> $$0, cpv $$1) {
         super($$0, $$1);
      }
      ...
      protected void a(boolean $$0, float $$1) {
         this.r = new bip.b.a(this.t());
      }

      public static record a(dfj a) {
      }
   }

   static record c(int a, int b) implements bip.f {
      @Override
      public int get(float $$0) {
         return arh.b.a($$0, this.a, this.b);
      }
   }

   @FunctionalInterface
   public interface d {
      static bip.d constant(float $$0) {
         return $$1 -> $$0;
      }
   ...
   public static class g extends bip {
      ...
      private static final aee<cjf> r = aeh.a(bip.g.class, aeg.h);
      private static final aee<Byte> s = aeh.a(bip.g.class, aeg.a);
      private final bjy t = new bjy() {
         @Override
         public cjf a() {
            return g.this.t();
         }
      ...
      private cjc v() {
         return cjc.k.apply(this.an.b(s));
      }
      ...
      @Override
      protected void a(boolean $$0, float $$1) {
         this.u = new bip.g.a(this.t(), this.v());
      }

      public static record a(cjf a, cjc b) {
      }
   }

   static record h(float a, float b) implements bip.d {
      @Override
      public float get(float $$0) {
         return arw.i($$0, this.a, this.b);
      }
   }

   static record i(int a, int b) implements bip.f {
      @Override
      public int get(float $$0) {
         return arw.a($$0, this.a, this.b);
      }
   }
   ...
   public static record k(bip.e<j> a, bip.a b, int c, bip.d d, bip.d e, int f) {
   }
   ...
   public static class l extends bip {
      ...
      private static final aee<tl> aM = aeh.a(bip.l.class, aeg.f);
      private static final aee<Integer> aN = aeh.a(bip.l.class, aeg.b);
      private static final aee<Integer> aO = aeh.a(bip.l.class, aeg.b);
      private static final aee<Byte> aP = aeh.a(bip.l.class, aeg.a);
      private static final aee<Byte> aQ = aeh.a(bip.l.class, aeg.a);
      ...
      private bip.l.e z() {
         return new bip.l.e(this.t(), this.v(), bip.f.constant(this.w()), bip.f.constant(this.x()), this.y());
      }

      private bip.l.e a(bip.l.e $$0, float $$1) {
         int $$2 = $$0.d.get($$1);
         int $$3 = $$0.c.get($$1);
         return new bip.l.e(this.t(), this.v(), new bip.i($$3, this.w()), new bip.c($$2, this.x()), this.y());
      }

      public bip.l.b a(bip.l.d $$0) {
         if (this.aS == null) {
            if (this.aT != null) {
               this.aS = $$0.split(this.aT.a(), this.aT.b());
            } else {
               this.aS = new bip.l.b(List.of(), 0);
            }
         }
      ...
      public static bip.l.a a(byte $$0) {
         if (($$0 & 8) != 0) {
            return bip.l.a.b;
         } else {
            return ($$0 & 16) != 0 ? bip.l.a.c : bip.l.a.a;
         }
      }
      ...
      public static enum a implements asp {
         ...
         public static final Codec<bip.l.a> d = asp.a(bip.l.a::values);
      ...
      public static record b(List<bip.l.c> a, int b) {
      }

      public static record c(arj a, int b) {
      }
   ...
   static record m(j a, j b) implements bip.e<j> {
      public j a(float $$0) {
