...
public class frs extends frk<crz> implements fuf {
   private float G;
   private float H;
   private final ftz<?> I;
   private boolean J;
   ...
   public frs(cnu $$0) {
      super($$0.bY, $$0.gc(), xd.c("container.crafting"));
      this.v = 97;
      this.I = new ftv($$0.bY);
   }
   ...
   public void D() {
      if (this.m.r.f()) {
         this.m.a(new frh(this.m.t, this.m.t.cw.y(), this.m.n.K().c()));
      } else {
         this.I.e();
      }
   }
   ...
   protected void aR_() {
      if (this.m.r.f()) {
         ...
         this.c(new fkw(this.C + 104, this.o / 2 - 22, 20, 18, ftz.a, $$0 -> {
            this.I.c();
            this.C = this.I.a(this.n, this.s);
   ...
   protected void a(fjx $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(ghq::B, a, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      a($$0, $$4 + 26, $$5 + 8, $$4 + 75, $$5 + 78, 30, 0.0625F, this.G, this.H, this.m.t);
   }

   public static void a(fjx $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, buk $$9) {
   ...
   public static void a(fjx $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, buk $$7) {
      $$0.c().a();
