public class frs<T extends ccv> extends frw<T> {
   public frs(ftm $$0) {
   ...
   public static fts c() {
      ...
      $$1.a(
         ...
         fto.a(0.0F, 10.0F, -16.0F)
      );
      $$1.a(
         "body",
         ftr.c().a(0, 19).a(-5.0F, -13.0F, -7.0F, 14.0F, 14.0F, 11.0F).a(39, 0).a(-4.0F, -25.0F, -7.0F, 12.0F, 12.0F, 10.0F),
         fto.a(-2.0F, 9.0F, 12.0F, (float) (Math.PI / 2), 0.0F, 0.0F)
      );
      int $$2 = 10;
      ftr $$3 = ftr.c().a(50, 22).a(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 8.0F);
      $$1.a("right_hind_leg", $$3, fto.a(-4.5F, 14.0F, 6.0F));
      $$1.a("left_hind_leg", $$3, fto.a(4.5F, 14.0F, 6.0F));
      ftr $$4 = ftr.c().a(50, 40).a(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 6.0F);
      $$1.a("right_front_leg", $$4, fto.a(-3.5F, 14.0F, -8.0F));
      $$1.a("left_front_leg", $$4, fto.a(3.5F, 14.0F, -8.0F));
