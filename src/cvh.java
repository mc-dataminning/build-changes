...
public class cvh extends cty {
   ...
   public cvh(wu $$0, wu $$1, wu $$2, wu $$3, wu $$4, List<akk> $$5, List<akk> $$6, cox... $$7) {
      super(new cty.a().a($$7));
      this.J = $$0;
      this.K = $$1;
      this.L = $$2;
   ...
   public static cvh a(akj<cwk> $$0, cox... $$1) {
      return a($$0.a(), $$1);
   }

   public static cvh a(akk $$0, cox... $$1) {
      return new cvh(l, m, wu.c(ac.a("trim_pattern", $$0)).a(a), n, o, x(), y(), $$1);
   }

   public static cvh h() {
      return new cvh(p, q, k, r, s, z(), A());
   }
