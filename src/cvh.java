...
public class cvh extends cxm {
   ...
   private static final cvh.b t = new cvh.b(Optional.of(awa.gL), Optional.of(awa.gK), Optional.of(awa.gJ));
   ...
   private static float a(cyv $$0) {
      return $$0.a(cwu.vt) ? 1.6F : 3.15F;
   }
   ...
   private static boolean a(bvi $$0, cwq $$1) {
      List<cwq> $$2 = a($$1, $$0.d($$1), $$0);
      if (!$$2.isEmpty()) {
         $$1.b(kv.O, cyv.a($$2));
         return true;
      } else {
   ...
   private static Vector3f a(bvi $$0, fbb $$1, float $$2) {
   ...
   protected cpr a(dgj $$0, bvi $$1, cwq $$2, cwq $$3, boolean $$4) {
      if ($$3.a(cwu.vt)) {
         return new cpm($$0, $$3, $$1, $$1.dA(), $$1.dE() - 0.15F, $$1.dG(), true);
      } else {
         cpr $$5 = super.a($$0, $$1, $$2, $$3, $$4);
         if ($$5 instanceof cpf $$6) {
            $$6.b(awa.gI);
         }
   ...
   protected int h(cwq $$0) {
      return $$0.a(cwu.vt) ? 3 : 1;
   }

   public void a(dgj $$0, bvi $$1, bsk $$2, cwq $$3, float $$4, float $$5, @Nullable bvi $$6) {
      if ($$0 instanceof ard $$7) {
         cyv $$9 = $$3.b(kv.O, cyv.a);
         if ($$9 != null && !$$9.b()) {
            this.a($$7, $$1, $$2, $$3, $$9.a(), $$4, $$5, $$1 instanceof coy, $$6);
   ...
   public static int b(cwq $$0, bvi $$1) {
      float $$2 = ddc.a($$0, $$1, 1.25F);
   ...
   cvh.b i(cwq $$0) {
      return ddc.b($$0, ddb.B).orElse(t);
   }

   private static float a(int $$0, cwq $$1, bvi $$2) {
   ...
   public static enum a implements azv {
      ...
      public static final Codec<cvh.a> d = azv.a(cvh.a::values);
   ...
   public static record b(Optional<jr<avz>> b, Optional<jr<avz>> c, Optional<jr<avz>> d) {
      public static final Codec<cvh.b> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avz.b.optionalFieldOf("start").forGetter(cvh.b::a),
                  avz.b.optionalFieldOf("mid").forGetter(cvh.b::b),
                  avz.b.optionalFieldOf("end").forGetter(cvh.b::c)
               )
               .apply($$0, cvh.b::new)
      );
