...
public class afi {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(sw.c("commands.particle.failed"));
   ...
   public static void a(CommandDispatcher<ds> $$0, dm $$1) {
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)dt.a("particle").requires($$0x -> $$0x.c(2)))
            .then(
               ((RequiredArgumentBuilder)dt.a("name", em.a($$1))
                     .executes(
                        $$0x -> a(
                              (ds)$$0x.getSource(), em.a($$0x, "name"), ((ds)$$0x.getSource()).d(), eei.b, 0.0F, 0, false, ((ds)$$0x.getSource()).l().ac().t()
                           )
                     ))
                  .then(
                     ((RequiredArgumentBuilder)dt.a("pos", fp.a())
                           .executes(
                              $$0x -> a((ds)$$0x.getSource(), em.a($$0x, "name"), fp.a($$0x, "pos"), eei.b, 0.0F, 0, false, ((ds)$$0x.getSource()).l().ac().t())
                           ))
                        .then(
                           dt.a("delta", fp.a(false))
                              .then(
   ...
   private static int a(ds $$0, it $$1, eei $$2, eei $$3, float $$4, int $$5, boolean $$6, Collection<aig> $$7) throws CommandSyntaxException {
      ...
      if ($$8 == 0) {
         ...
         $$0.a(() -> sw.a("commands.particle.success", jb.k.b($$1.b()).toString()), true);
         return $$8;
      }
   }
}
