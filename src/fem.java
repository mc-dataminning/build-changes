...
public class fem {
   ...
   private static final Queue<fem.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fem.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fem::a), fej::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fem::a), fej::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fem.a(this.b) + ", type=" + fem.b(this.c) + ", severity=" + fem.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
