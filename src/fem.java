...
public abstract class fem<T extends fem<T>> {
   ...
   public fem(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fek.a();
         if ($$3 != null) {
         ...
         throw new fft(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fft(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fft(var2.getMessage(), var2);
      }
   }
   ...
   public static fem<?> a(String $$0) {
      return new fem.b($$0, 5000, 60000);
   }

   public static fem<?> a(String $$0, int $$1, int $$2) {
      return new fem.b($$0, $$1, $$2);
   }

   public static fem<?> b(String $$0, String $$1) {
      return new fem.c($$0, $$1, 5000, 60000);
   }

   public static fem<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fem.c($$0, $$1, $$2, $$3);
   }

   public static fem<?> b(String $$0) {
      return new fem.a($$0, 5000, 60000);
   }

   public static fem<?> c(String $$0, String $$1) {
      return new fem.d($$0, $$1, 5000, 60000);
   }

   public static fem<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fem.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fem<fem.a> {
   ...
   public static class b extends fem<fem.b> {
   ...
   public static class c extends fem<fem.c> {
      ...
      public fem.c f() {
         try {
            ...
            throw new fft(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fem<fem.d> {
      private final String c;
