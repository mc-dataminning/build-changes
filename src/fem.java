...
public class fem {
   ...
   public xu a(xc $$0, int $$1) {
      fem.e $$2 = new fem.e((float)$$1);
      return $$0.<xu>a(($$1x, $$2x) -> ayy.c($$2x, $$1x, $$2) ? Optional.empty() : Optional.of($$1x), xu.a).orElse(null);
   }

   @Nullable
   public xu a(axr $$0, int $$1) {
      fem.e $$2 = new fem.e((float)$$1);
   ...
   public xc a(xc $$0, int $$1, xu $$2) {
      final fem.e $$3 = new fem.e((float)$$1);
      return $$0.a(new xc.b<xc>() {
         private final fdr b = new fdr();
   ...
   public void a(String $$0, int $$1, xu $$2, boolean $$3, fem.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      xu $$7 = $$2;

      while ($$5 < $$6) {
         fem.b $$8 = new fem.b((float)$$1);
   ...
   public void a(xc $$0, int $$1, xu $$2, BiConsumer<xc, Boolean> $$3) {
      List<fem.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new fem.c($$2x, $$1x));
         }
   ...
   static class a {
      ...
      public xc a(int $$0, int $$1, xu $$2) {
         fdr $$3 = new fdr();
         ListIterator<fem.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, xu $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = fem.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements axs {
      ...
      @Override
      public boolean accept(int $$0, xu $$1, int $$2) {
         this.b = this.b - fem.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
