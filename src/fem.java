...
public enum fem {
   ...
   private fem(final String... $$0) {
      this.c = $$0;
   }

   public List<aug<InputStream>> a(atb $$0) throws IOException {
      return List.of(
   ...
   public aug<InputStream> b(atb $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private aug<InputStream> a(atb $$0, String $$1) throws IOException {
