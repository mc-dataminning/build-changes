...
public class fem {
   ...
   public static List<fem.a> a(String $$0, fem.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fem.a> a(String $$0, List<fem.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fem.a> a(List<String> $$0, List<fem.b> $$1) {
      int $$2 = 0;
      List<fem.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fem.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fem.b a(String $$0, String $$1) {
         return new fem.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fem.b a(String $$0) {
         return new fem.b($$0);
      }
   }
}
