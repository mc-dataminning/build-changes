...
public class arp {
   ...
   private static void a(art $$0, aqt $$1, dvg $$2) {
      $$0.b(new adf($$2, $$1.y_(), null, null));
      dcb $$3 = $$2.f();
      age.a($$1, $$3);
   }

   private List<dvg> a(aqa $$0, dcb $$1) {
      int $$2 = ayn.d(this.i);
      List<dvg> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : ayn.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
