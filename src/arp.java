      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$4x -> $$4x.updateTyped(
               ...
               $$3xx -> {
                  ...
                  MutableObject<Supplier<ars.a>> $$14 = new MutableObject((Supplier<ars.a>)() -> null);
                  $$3xx = $$3xx.updateTyped(
                     $$2,
                     $$6,
                     $$7x -> {
                  ...
                  return $$3xx.update(DSL.remainderFinder(), $$5xx -> {
                     ...
                     return a($$5xx, $$8, $$9.booleanValue(), "minecraft:noise".equals($$7), (Supplier<ars.a>)$$14.getValue());
                  });
               }
            )
      );
