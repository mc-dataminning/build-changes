...
public class arp {
   ...
   public static hg<cjc> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return jd.i
            .b(aex.a(je.D, new aey($$2)))
   ...
   public static hg<cjc> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static hg<cjc> a(JsonObject $$0, String $$1, @Nullable hg<cjc> $$2) {
