...
public class apl extends apq {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<apm<?>> e = Sets.newHashSet();

   public apl(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cbw $$0, apm<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<apm<?>> d() {
      Set<apm<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
   ...
   private <T> Optional<apm<T>> a(apo<T> $$0, String $$1) {
      return Optional.ofNullable(aey.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }
   ...
   protected String b() {
      Map<apo<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apm<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<apm<?>>)$$3.next();
         apm<?> $$2 = (apm<?>)$$1.getKey();
      ...
      for (Entry<apo<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> aey b(apm<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(akt $$0) {
      Object2IntMap<apm<?>> $$1 = new Object2IntOpenHashMap();
