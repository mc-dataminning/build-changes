...
public interface bpb<T, F> {
   ...
   public static final class a implements bpb<bpb.b, Runnable> {
   ...
   public static final class c<T> implements bpb<T, T> {
