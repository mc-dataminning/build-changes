...
public class ua {
   ...
   private static final ub.a<ua.a> n = new ub.a<>(ua.a::new);

   private static ArgumentBuilder<ew, ?> a(
      ArgumentBuilder<ew, ?> $$0, Function<CommandContext<ew>, ua.a> $$1, Function<ArgumentBuilder<ew, ?>, ArgumentBuilder<ew, ?>> $$2
   ) {
      return $$0.executes($$1x -> $$1.apply($$1x).d())
         .then(
            ((RequiredArgumentBuilder)ex.a("numberOfTimes", IntegerArgumentType.integer(0))
                  .executes($$1x -> $$1.apply($$1x).a(new tv(IntegerArgumentType.getInteger($$1x, "numberOfTimes"), false))))
               .then(
                  $$2.apply(
                     ex.a("untilFailed", BoolArgumentType.bool())
                        .executes(
                           $$1x -> $$1.apply($$1x)
                                 .a(new tv(IntegerArgumentType.getInteger($$1x, "numberOfTimes"), BoolArgumentType.getBool($$1x, "untilFailed")))
                        )
                  )
               )
         );
   ...
   private static ArgumentBuilder<ew, ?> a(ArgumentBuilder<ew, ?> $$0, Function<CommandContext<ew>, ua.a> $$1) {
      return a($$0, $$1, $$0x -> $$0x);
   }

   private static ArgumentBuilder<ew, ?> b(ArgumentBuilder<ew, ?> $$0, Function<CommandContext<ew>, ua.a> $$1) {
      return a(
         $$0,
         $$1,
         $$1x -> $$1x.then(
               ((RequiredArgumentBuilder)ex.a("rotationSteps", IntegerArgumentType.integer())
                     .executes(
                        $$1xx -> $$1.apply($$1xx)
                              .a(
                                 new tv(IntegerArgumentType.getInteger($$1xx, "numberOfTimes"), BoolArgumentType.getBool($$1xx, "untilFailed")),
   ...
   public static void a(CommandDispatcher<ew> $$0) {
      ...
      ArgumentBuilder<ew, ?> $$2 = b(ex.a("testClassName", tz.a()), $$0x -> n.a($$0x, tz.a($$0x, "testClassName")));
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a(
                                                                                 ...
                                                                                 .then(
                                                                                    ex.a("run")
                                                                                       .then(b(ex.a("testName", ud.a()), $$0x -> n.b($$0x, "testName")))
                                                                                 ))
                                                                              .then(
                                                                                 ex.a("runmultiple")
                                                                                    .then(
                                                                                       ((RequiredArgumentBuilder)ex.a("testName", ud.a())
                                                            ...
                                                            .then(ex.a("verify").then(ex.a("testName", ud.a()).executes($$0x -> n.b($$0x, "testName").f()))))
                                                         .then(
                                                            ex.a("verifyclass")
                                                               .then(ex.a("testClassName", tz.a()).executes($$0x -> n.a($$0x, tz.a($$0x, "testClassName")).f()))
                                                         ))
                                                      .then(
                                                         ex.a("locate")
                                                            .then(
                                                               ex.a("testName", ud.a())
                                                                  .executes($$0x -> n.c($$0x, "minecraft:" + ud.a($$0x, "testName").d()).e())
                                                            )
                                                      ))
                           ...
                           ((LiteralArgumentBuilder)ex.a("clearall").executes($$0x -> n.a($$0x, 200).b()))
                              .then(
                                 ex.a("radius", IntegerArgumentType.integer())
                                    .executes($$0x -> n.a($$0x, azn.a(IntegerArgumentType.getInteger($$0x, "radius"), 0, 1024)).b())
                              )
                        ))
                     .then(
                        ex.a("import")
   ...
   private static int a(ti $$0) {
      $$0.g().a_(null, $$0.e()).stream().forEach($$0x -> $$0x.a(bui.c.b));
      $$0.f().c($$0.g());
      ty.a($$0.e(), $$0.g());
   ...
   static Stream<ti> a(ew $$0, tv $$1, tw $$2) {
      return $$2.findStructureBlockPos().map($$2x -> a($$2x, $$0.e(), $$1)).flatMap(Optional::stream);
   }

   static Stream<ti> a(ew $$0, tv $$1, ue $$2, int $$3) {
      return $$2.findTestFunctions().filter($$1x -> a($$0.e(), $$1x.d())).map($$3x -> new ti($$3x, ty.a($$3), $$0.e(), $$1));
   }

   private static Optional<ti> a(jh $$0, arq $$1, tv $$2) {
      dui $$3 = (dui)$$1.c_($$0);
      if ($$3 == null) {
   ...
   private static int a(ew $$0, String $$1, int $$2, int $$3, int $$4) {
      if ($$2 <= 48 && $$3 <= 48 && $$4 <= 48) {
         arq $$5 = $$0.e();
         jh $$6 = a($$0).e();
         ty.a($$1.toLowerCase(), $$6, new kl($$2, $$3, $$4), dow.a, $$5);
         jh $$7 = $$6.d();
         jh $$8 = $$7.b($$2 - 1, 0, $$4 - 1);
         jh.d($$7, $$8).forEach($$1x -> $$5.b($$1x, dil.F.m()));
         ty.a($$6, new jh(1, 0, -1), dow.a, $$5);
         return 0;
      } else {
   ...
   private static int a(ew $$0, String $$1) throws CommandSyntaxException {
      ezn $$2 = (ezn)$$0.h().a(10.0, 1.0F, false);
      jh $$3 = $$2.b();
      arq $$4 = $$0.e();
      Optional<jh> $$5 = ty.a($$3, 15, $$4);
      if ($$5.isEmpty()) {
         $$5 = ty.a($$3, 200, $$4);
      }

      if ($$5.isEmpty()) {
         $$0.b(xl.b("Can't find a structure block that contains the targeted pos " + $$3));
         return 0;
      } else {
         dui $$6 = (dui)$$4.c_($$5.get());
         if ($$6 == null) {
            ...
            xl $$10 = xl.b($$8)
               .b(
                  yi.a
                     .a(true)
                     .a(n.k)
                     .a(new xr(xr.a.a, xl.b("Click to copy to clipboard")))
                     .a(new xj(xj.a.f, "final BlockPos " + $$1 + " = new BlockPos(" + $$8 + ");"))
               );
            $$0.a(() -> xl.b("Position relative to " + $$9 + ": ").b($$10), false);
            agv.a($$4, new jh($$3), $$8, -2147418368, 10000);
            return 1;
         }
      }
   }
   ...
   private static int b(ew $$0, String $$1) {
      Path $$2 = Paths.get(ty.c);
      all $$3 = all.a($$1);
      Path $$4 = $$0.e().q().a($$3, ".nbt");
      Path $$5 = pp.a(me.a, $$4, $$3.a(), $$2);
      if ($$5 == null) {
   ...
   private static boolean a(arq $$0, String $$1) {
      if ($$0.q().b(all.a($$1)).isEmpty()) {
   ...
   static void a(arq $$0, String $$1, n $$2) {
      $$0.a($$0x -> true).forEach($$2x -> $$2x.a(xl.b($$1).a($$2)));
   }

   public static class a {
      private final ub<ua.a> a;
      ...
      public int a() {
         ua.a();
         return ua.a(this.a.a(), tv.a(), this.a).map(ua::a).toList().isEmpty() ? 0 : 1;
      }
      ...
      public int b() {
         ...
         }, () -> ua.a($$1, "Could not find any structures to clear", n.m), $$1x -> ua.c($$0, "Cleared " + $$1x + " structures"));
         return 1;
      }
      ...
      public int c() {
         ...
         this.a(this.a.findStructureBlockPos(), $$3 -> {
            dui $$4 = (dui)$$2.c_($$3);
            if ($$4 == null) {
               ua.a($$2, "Structure block entity could not be found", n.m);
               $$0.setFalse();
               return 0;
            } else {
               if (ua.a($$1, $$4) != 0) {
         ...
         }, () -> ua.a($$2, "Could not find any structures to export", n.m), $$1x -> ua.c($$1, "Exported " + $$1x + " structures"));
      ...
      int f() {
         ...
         arq $$1 = $$0.e();
         jh $$2 = ua.a($$0);
         Collection<ti> $$3 = Stream.concat(ua.a($$0, tv.a(), this.a), ua.a($$0, tv.a(), this.a, 0)).toList();
         tl.a($$1);
         tk.d();
         Collection<tc> $$4 = new ArrayList<>();

         for (ti $$5 : $$3) {
            for (dow $$6 : dow.values()) {
               Collection<ti> $$7 = new ArrayList<>();

               for (int $$8 = 0; $$8 < 100; $$8++) {
                  ti $$9 = new ti($$5.v(), $$6, $$1, new tv(1, true));
                  $$7.add($$9);
               }

               tc $$10 = td.a($$7, $$5.v().b(), (long)$$6.ordinal());
               $$4.add($$10);
            }
         }

         tx $$11 = new tx($$2, 10, true);
         tl $$12 = tl.a.a($$4, $$1).a(td.a(100)).a((tl.c)$$11).a($$11).a(true).a();
         return ua.a($$0, $$1, $$12);
      }

      public int a(tv $$0, int $$1, int $$2) {
         ua.a();
         ew $$3 = this.a.a();
         arq $$4 = $$3.e();
         jh $$5 = ua.a($$3);
         Collection<ti> $$6 = Stream.concat(ua.a($$3, $$0, this.a), ua.a($$3, $$0, this.a, $$1)).toList();
         if ($$6.isEmpty()) {
            ua.c($$3, "No tests found");
            return 0;
         } else {
            tl.a($$4);
            tk.d();
            ua.c($$3, "Running " + $$6.size() + " tests...");
            tl $$7 = tl.a.b($$6, $$4).a((tl.c)(new tx($$5, $$2, false))).a();
            return ua.a($$3, $$4, $$7);
         }
      }

      public int a(int $$0, int $$1) {
         return this.a(tv.a(), $$0, $$1);
      }

      public int a(int $$0) {
         return this.a(tv.a(), $$0, 8);
      }

      public int a(tv $$0, int $$1) {
         return this.a($$0, $$1, 8);
      }
      ...
      public int e() {
         ua.c(this.a.a(), "Started locating test structures, this might take a while..");
            ...
            .forEach(
               $$2x -> {
                  ...
                  if ($$3 != null) {
                     ...
                     int $$8 = $$1.u() - $$2x.u();
                     int $$9 = $$1.w() - $$2x.w();
                     int $$10 = azn.d(azn.c((float)($$8 * $$8 + $$9 * $$9)));
                     xl $$11 = xo.a((xl)xl.a("chat.coordinates", $$2x.u(), $$2x.v(), $$2x.w()))
                        .a($$1xx -> $$1xx.a(n.k).a(new xj(xj.a.d, $$7)).a(new xr(xr.a.a, xl.c("chat.coordinates.tooltip"))));
                     xl $$12 = xl.b("Found structure at: ").b($$11).f(" (distance: " + $$10 + ")");
                     this.a.a().a(() -> $$12, false);
                     $$0.increment();
                  }
               }
         ...
         int $$2 = $$0.intValue();
         if ($$2 == 0) {
            ua.a(this.a.a().e(), "No such test structure found", n.m);
            return 0;
         } else {
            ua.a(this.a.a().e(), "Finished locating, found " + $$2 + " structure(s)", n.k);
            return 1;
         }
      }
   }

   static record b(ew a) implements te {
      @Override
      public void a(tc $$0) {
         ua.c(this.a, "Starting batch: " + $$0.a());
      }
   ...
   public static record c(arq a, tt b) implements tj {
      @Override
      public void a(ti $$0) {
      }
      ...
      private static void a(arq $$0, tt $$1) {
         if ($$1.i()) {
            ua.a($$0, "GameTest done! " + $$1.h() + " tests were run", n.p);
            if ($$1.d()) {
               ua.a($$0, $$1.a() + " required tests failed :(", n.m);
            } else {
               ua.a($$0, "All required tests passed :)", n.k);
            }

            if ($$1.e()) {
               ua.a($$0, $$1.b() + " optional tests failed", n.h);
            }
         }
      }
   }
