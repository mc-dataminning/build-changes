...
public class ua implements ux {
   public static final Codec<ua> a = Codec.PASSTHROUGH.comapFlatMap($$0 -> {
      ...
      return $$1 instanceof ua $$2 ? DataResult.success($$2 == $$0.getValue() ? $$2.h() : $$2) : DataResult.error(() -> "Not a compound tag: " + $$1);
   }, $$0 -> new Dynamic(uo.a, $$0.h()));
   ...
   public byte[] m(String $$0) {
      try {
         ...
         throw new y(this.a($$0, tx.a, var3));
      }
   ...
   public ug c(String $$0, int $$1) {
      try {
         ...
         throw new y(this.a($$0, ug.a, var4));
      }
