...
public class ua implements ux {
   public static final Codec<ua> a = Codec.PASSTHROUGH.comapFlatMap($$0 -> {
      ux $$1 = (ux)$$0.convert(uo.a).getValue();
      return $$1 instanceof ua $$2 ? DataResult.success($$2 == $$0.getValue() ? $$2.i() : $$2) : DataResult.error(() -> "Not a compound tag: " + $$1);
   }, $$0 -> new Dynamic(uo.a, $$0.i()));
   private static final int c = 48;
   private static final int w = 32;
   public static final uz<ua> b = new uz.b<ua>() {
      ...
      private static ua d(DataInput $$0, uj $$1) throws IOException {
         $$1.b(48L);
         Map<String, ux> $$2 = Maps.newHashMap();

         byte $$3;
         while (($$3 = $$0.readByte()) != 0) {
            String $$4 = e($$0, $$1);
            ux $$5 = ua.a(va.a($$3), $$4, $$0, $$1);
            if ($$2.put($$4, $$5) == null) {
               $$1.b(36L);
            }
         }
   ...
   private final Map<String, ux> x;

   protected ua(Map<String, ux> $$0) {
      this.x = $$0;
   }
   ...
   public int a() {
      ...
      for (Entry<String, ux> $$1 : this.x.entrySet()) {
   ...
   public UUID a(String $$0) {
      return up.a(this.c($$0));
   }

   public boolean b(String $$0) {
      ux $$1 = this.c($$0);
      return $$1 != null && $$1.c() == ue.a && ((ue)$$1).g().length == 4;
   }
   ...
   public ua p(String $$0) {
      try {
         if (this.b($$0, 10)) {
            return (ua)this.x.get($$0);
         }
      } catch (ClassCastException var3) {
   ...
   public ug c(String $$0, int $$1) {
      try {
         if (this.d($$0) == 9) {
            ug $$2 = (ug)this.x.get($$0);
            if (!$$2.isEmpty() && $$2.f() != $$1) {
               return new ug();
            }
         ...
         throw new z(this.a($$0, ug.a, var4));
      }
   ...
   private o a(String $$0, uz<?> $$1, ClassCastException $$2) {
   ...
   public ua i() {
      Map<String, ux> $$0 = Maps.newHashMap(Maps.transformValues(this.x, ux::d));
      return new ua($$0);
   }
   ...
   private static void a(String $$0, ux $$1, DataOutput $$2) throws IOException {
      $$2.writeByte($$1.b());
      if ($$1.b() != 0) {
         $$2.writeUTF($$0);
         $$1.a($$2);
   ...
   static ux a(uz<?> $$0, String $$1, DataInput $$2, uj $$3) {
      try {
         return $$0.c($$2, $$3);
   ...
   protected Set<Entry<String, ux>> j() {
