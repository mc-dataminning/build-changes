...
public class cgp extends cfg {
   ...
   private static final akk<cgp.a> ch = ako.a(cgp.class, akm.B);
   private long ci = 0L;
   ...
   public cgp(btb<? extends cfg> $$0, dbz $$1) {
      super($$0, $$1);
      this.K().a(true);
      this.cj = this.gC();
   }
   ...
   public bsp a(arf $$0, bsp $$1) {
      return btb.c.a((dbz)$$0);
   }

   public static bux.a s() {
      return bts.A().a(buy.q, 12.0).a(buy.r, 0.14);
   }
   ...
   public boolean gq() {
      return this.gw() == cgp.a.b && this.ci > (long)cgp.a.b.b();
   }
   ...
   protected void Z() {
      ...
      ((bus<cgp>)this.bD).a((arf)this.dP(), this);
      this.dP().ag().c();
   ...
   public static boolean c(btb<cgp> $$0, dca $$1, btu $$2, iz $$3, azh $$4) {
   ...
   protected void f(bro $$0, float $$1) {
      super.f($$0, $$1);
      if (!this.gg() && !this.eB()) {
         if ($$0.d() instanceof btq) {
            this.dS().a(ccu.G, true, 80L);
            if (this.gB()) {
               this.gx();
            }
         } else if (this.gz()) {
   ...
   public static enum a implements azu {
      ...
      private static final azu.a<cgp.a> f = azu.a(cgp.a::values);
      private static final IntFunction<cgp.a> g = axp.a(cgp.a::d, values(), axp.a.a);
      public static final zn<ByteBuf, cgp.a> e = zl.a(g, cgp.a::d);
