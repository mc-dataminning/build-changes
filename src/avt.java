...
public class avt extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bbq.x), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", avt::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", avt::a);
      return this.a($$0, "minecraft:trident", avt::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bbq.x, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bbq.x, $$1);
