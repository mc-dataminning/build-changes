...
public class avt extends ayf {
   public avt(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", azd.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(azd.z.typeName(), bal.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(azd.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(azd.z.typeName(), "minecraft:saddle"));
