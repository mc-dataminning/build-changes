...
public class bcm extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bfa.z);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         this.a(this.a("minecraft:trident", bcm::c), this.a("minecraft:arrow", bcm::a), this.a("minecraft:spectral_arrow", bcm::b))
      );
   }
   ...
   private Function<Typed<?>, Typed<?>> a(String $$0, bcm.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bfa.z, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bfa.z, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bcm.a<?> $$1, Type<?> $$2, Type<T> $$3) {
