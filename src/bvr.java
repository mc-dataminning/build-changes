...
public class bvr extends bvf {
   ...
   public bvr(dha $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bvm.W, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bvr(bvm<? extends bvr> $$0, dha $$1) {
      super($$0, $$1);
   }
   ...
   public void h() {
      ...
      if (this.j != null) {
         fbs $$0 = new fbs(this.j.dA() - this.dA(), this.j.dC() + (double)this.j.cS() / 2.0 - this.dC(), this.j.dG() - this.dG());
         double $$1 = $$0.h();
         if ($$1 < 64.0) {
   ...
   private void p() {
      ...
      if (this.dV() instanceof ash) {
         for (bvr $$1 : this.dV().a(ebx.a(bvr.class), this.cR().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(ash $$0, fbs $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bvr($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(ash $$0, fbs $$1, int $$2) {
      fbn $$3 = fbn.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.H_().a(40);
      List<bvr> $$5 = $$0.a(ebx.a(bvr.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bvr $$6 = $$5.get(0);
         $$6.i++;
         $$6.f = 0;
   ...
   private static boolean a(bvr $$0, int $$1, int $$2) {
      return !$$0.dQ() && ($$0.ar() - $$1) % 40 == 0 && $$0.h == $$2;
   }

   private void b(bvr $$0) {
      this.i = this.i + $$0.i;
   ...
   private int a(asi $$0, int $$1) {
      Optional<ddq> $$2 = ddt.a(dds.z, $$0, cxk::n);
      if ($$2.isPresent()) {
         cxk $$3 = $$2.get().a();
         int $$4 = ddt.c($$0.y(), $$3, $$1);
