...
public class bvr extends buq implements bke<bvr.b> {
   ...
   private static final aee<Integer> d = aeh.a(bvr.class, aeg.b);
   ...
   public static boolean b(biu<bvr> $$0, cpw $$1, bjk $$2, gw $$3, asc $$4) {
      return $$1.b_($$3.d()).a(apx.a) && $$1.a_($$3.c()).a(csw.G) && ($$1.s($$3).a(apr.am) || bvt.c($$0, $$1, $$2, $$3, $$4));
   }
   ...
   public static enum b implements asp {
      ...
      private static final IntFunction<bvr.b> n = aqr.a(bvr.b::b, values(), a);
