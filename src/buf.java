...
public class buf extends dio<buh> {
   ...
   public buf(Path $$0, DataFixer $$1, boolean $$2, hu $$3, cpx $$4) {
   ...
   public long a(Predicate<hg<bui>> $$0, gw $$1, int $$2, buf.b $$3) {
      return this.c($$0, $$1, $$2, $$3).count();
   }

   public boolean a(aew<bui> $$0, gw $$1) {
      return this.a($$1, (Predicate<hg<bui>>)($$1x -> $$1x.a($$0)));
   }

   public Stream<bug> b(Predicate<hg<bui>> $$0, gw $$1, int $$2, buf.b $$3) {
   ...
   public Stream<bug> c(Predicate<hg<bui>> $$0, gw $$1, int $$2, buf.b $$3) {
      int $$4 = $$2 * $$2;
      return this.b($$0, $$1, $$2, $$3).filter($$2x -> $$2x.f().j($$1) <= (double)$$4);
   }

   @asy
   public Stream<bug> a(Predicate<hg<bui>> $$0, cpc $$1, buf.b $$2) {
   ...
   public Stream<gw> a(Predicate<hg<bui>> $$0, Predicate<gw> $$1, gw $$2, int $$3, buf.b $$4) {
      return this.c($$0, $$2, $$3, $$4).map(bug::f).filter($$1);
   }

   public Stream<Pair<hg<bui>, gw>> b(Predicate<hg<bui>> $$0, Predicate<gw> $$1, gw $$2, int $$3, buf.b $$4) {
      return this.c($$0, $$2, $$3, $$4).filter($$1x -> $$1.test($$1x.f())).map($$0x -> Pair.of($$0x.g(), $$0x.f()));
   }

   public Stream<Pair<hg<bui>, gw>> c(Predicate<hg<bui>> $$0, Predicate<gw> $$1, gw $$2, int $$3, buf.b $$4) {
      return this.b($$0, $$1, $$2, $$3, $$4).sorted(Comparator.comparingDouble($$1x -> ((gw)$$1x.getSecond()).j($$2)));
   }

   public Optional<gw> d(Predicate<hg<bui>> $$0, Predicate<gw> $$1, gw $$2, int $$3, buf.b $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4).findFirst();
   }

   public Optional<gw> d(Predicate<hg<bui>> $$0, gw $$1, int $$2, buf.b $$3) {
      return this.c($$0, $$1, $$2, $$3).map(bug::f).min(Comparator.comparingDouble($$1x -> $$1x.j($$1)));
   }

   public Optional<Pair<hg<bui>, gw>> e(Predicate<hg<bui>> $$0, gw $$1, int $$2, buf.b $$3) {
      return this.c($$0, $$1, $$2, $$3).min(Comparator.comparingDouble($$1x -> $$1x.f().j($$1))).map($$0x -> Pair.of($$0x.g(), $$0x.f()));
   }

   public Optional<gw> e(Predicate<hg<bui>> $$0, Predicate<gw> $$1, gw $$2, int $$3, buf.b $$4) {
      return this.c($$0, $$2, $$3, $$4).map(bug::f).filter($$1).min(Comparator.comparingDouble($$1x -> $$1x.j($$2)));
   }

   public Optional<gw> a(Predicate<hg<bui>> $$0, BiPredicate<hg<bui>, gw> $$1, gw $$2, int $$3) {
   ...
   public Optional<gw> a(Predicate<hg<bui>> $$0, Predicate<gw> $$1, buf.b $$2, gw $$3, int $$4, asc $$5) {
   ...
   boolean g(long $$0) {
      ...
      return $$1 == null ? false : $$1.<Boolean>map($$0x -> $$0x.a($$0xx -> $$0xx.a(aqd.b), buf.b.b).findAny().isPresent()).orElse(false);
   }
   ...
   private void a(dhr $$0, hz $$1, BiConsumer<gw, hg<bui>> $$2) {
      $$1.t().forEach($$2x -> {
         dfj $$3 = $$0.a(hz.b($$2x.u()), hz.b($$2x.v()), hz.b($$2x.w()));
         buj.a($$3).ifPresent($$2xx -> $$2.accept($$2x, $$2xx));
      });
   }

   public void a(cpy $$0, gw $$1, int $$2) {
      hz.a(new cpc($$1), Math.floorDiv($$2, 16), this.c.al(), this.c.am())
