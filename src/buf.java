...
public class buf extends bum implements bwh {
   private static final Logger c = LogUtils.getLogger();
   private static final int d = 5;
   private static final ajy<Float> e = akc.a(buf.class, aka.d);
   private static final ajy<Boolean> f = akc.a(buf.class, aka.k);
   private static final ajy<lr> g = akc.a(buf.class, aka.l);
   ...
   private cyp k = cyp.a;
   private final Map<bum, Integer> l = Maps.newHashMap();
   private int m = 600;
   private int n = 20;
   private int o = 20;
   private int p;
   ...
   public buf(but<? extends buf> $$0, dgj $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public buf(dgj $$0, double $$1, double $$2, double $$3) {
      this(but.d, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   private void s() {
      ...
      if ($$0 instanceof lm $$1) {
         int $$2 = this.k.equals(cyp.a) ? 0 : this.k.b();
   ...
   private void t() {
      ...
      if (!$$0 || !this.ae.h()) {
         ...
         for (int $$7 = 0; $$7 < $$3; $$7++) {
            ...
            double $$10 = this.dA() + (double)(ayz.b($$8) * $$9);
            double $$11 = this.dC();
            double $$12 = this.dG() + (double)(ayz.a($$8) * $$9);
            if ($$2.a() == lt.u) {
               if ($$0 && this.ae.h()) {
                  this.dV().b(lm.a(lt.u, -1), $$10, $$11, $$12, 0.0, 0.0, 0.0);
               } else {
         ...
         if (!$$2) {
            ...
            if (this.af % 5 == 0) {
               ...
               if (!this.k.c()) {
                  ...
                  List<btr> $$4 = Lists.newArrayList();
                  if (this.k.e().isPresent()) {
                     for (btr $$5 : this.k.e().get().a().a()) {
                        $$4.add(new btr($$5.c(), $$5.a($$0x -> $$0x / 4), $$5.e(), $$5.f(), $$5.g()));
                     }
                  }

                  $$4.addAll(this.k.d());
                  List<bvi> $$6 = this.dV().a(bvi.class, this.cR());
                  if (!$$6.isEmpty()) {
                     for (bvi $$7 : $$6) {
   ...
   public bvi n() {
      if (this.s != null && !this.s.dQ()) {
         ...
         if (this.t != null && this.dV() instanceof ard $$0) {
            this.s = $$0.a(this.t) instanceof bvi $$1 ? $$1 : null;
         }
   ...
   protected void a(tq $$0) {
      ...
      if ($$0.e("potion_contents")) {
         cyp.c.parse($$1, $$0.c("potion_contents")).resultOrPartial($$0x -> c.warn("Failed to parse area effect cloud potions: '{}'", $$0x)).ifPresent(this::a);
      }
   }
   ...
   protected void b(tq $$0) {
      ...
      if (!this.k.equals(cyp.a)) {
         un $$2 = (un)cyp.c.encodeStart($$1, this.k).getOrThrow();
