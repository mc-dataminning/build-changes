...
public class gkn implements arn<gkm> {
   public gkm b(JsonObject $$0) {
      Builder<gkl> $$1 = ImmutableList.builder();
      ...
      return new gkm($$1.build(), $$8, $$9, $$2, $$10);
   }

   @Nullable
   private gkl a(int $$0, JsonElement $$1) {
      if ($$1.isJsonPrimitive()) {
         return new gkl(awm.g($$1, "frames[" + $$0 + "]"));
