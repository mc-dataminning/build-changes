...
public class gkn implements gkq.a {
   public static final jj[] a = jj.values();
   private final fib b;
   ...
   public void a(fcu $$0, ggv $$1, double $$2, double $$3, double $$4) {
      ...
      if (this.b.C || this.b.D) {
         ghj $$6 = $$5.y();
         ObjectListIterator $$27 = $$5.x().iterator();

         while ($$27.hasNext()) {
            gkd.b $$7 = (gkd.b)$$27.next();
            ghj.d $$8 = $$6.b($$7);
            if ($$8 != null) {
               je $$9 = $$7.f();
               $$0.a();
               ...
               Matrix4f $$10 = $$0.c().a();
               if (this.b.C) {
                  fcy $$11 = $$1.getBuffer(ghe.z());
                  int $$12 = $$8.b == 0 ? 0 : azc.g((float)$$8.b / 50.0F, 0.9F, 0.9F);
                  int $$13 = $$12 >> 16 & 0xFF;
                  int $$14 = $$12 >> 8 & 0xFF;
                  int $$15 = $$12 & 0xFF;
   ...
   private void a(fcy $$0, Matrix4f $$1, Vector4f $$2) {
      $$0.a($$1, $$2.x(), $$2.y(), $$2.z()).a(-16777216).b(0.0F, 0.0F, -1.0F);
   }

   private void a(fcy $$0, Matrix4f $$1, Vector4f[] $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9) {
      float $$10 = 0.25F;
