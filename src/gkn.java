...
public class gkn implements AutoCloseable {
   private static final ffz p = new ffz();
   private static final int q = -1;
   private final List<glx.a> r = new ArrayList<>();
   ...
   public static gkn a(fga $$0, fga $$1, fgq $$2) throws glv.b {
      int $$3 = GlStateManager.glCreateProgram();
      if ($$3 <= 0) {
         throw new glv.b("Could not create shader program (returned program ID " + $$3 + ")");
      } else {
         $$2.a($$3);
         ...
         if ($$4 == 0) {
            ...
            throw new glv.b("Error encountered when linking program containing VS " + $$0.a() + " and FS " + $$1.a() + ". Log output: " + $$5);
         } else {
            return new gkn($$3);
         }
      }
   ...
   public void a(List<glx.b> $$0, List<glx.a> $$1) {
      RenderSystem.assertOnRenderThread();

      for (glx.b $$2 : $$0) {
         String $$3 = $$2.a();
         int $$4 = fgc.a(this.w, $$3);
         if ($$4 != -1) {
            fgc $$5 = this.a($$2);
            $$5.b($$4);
            this.u.add($$5);
   ...
   public void a(fgq.c $$0, Matrix4f $$1, Matrix4f $$2, ffo $$3) {
      ...
      gks $$6 = RenderSystem.getShaderFog();
      if (this.i != null) {
         this.i.a($$6.a());
      }
