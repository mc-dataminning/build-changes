...
public class bns<E extends bla> extends bmp<E> {
   ...
   protected List<bns.a> h = Lists.newArrayList();
   protected Optional<eji> i = Optional.empty();
   @Nullable
   protected eji j;
   protected int k;
   protected long l;
   private final Function<E, aqm> q;
   private final BiPredicate<E, ht> r;

   public bns(bib $$0, int $$1, int $$2, float $$3, Function<E, aqm> $$4) {
      this($$0, $$1, $$2, $$3, $$4, bns::a);
   }

   public static <E extends bla> boolean a(E $$0, ht $$1) {
      crs $$2 = $$0.dL();
      ht $$3 = $$1.d();
      return $$2.a_($$3).i($$2, $$3) && $$0.a(eda.a($$2, $$1.j())) == 0.0F;
   }

   public bns(bib $$0, int $$1, int $$2, float $$3, Function<E, aqm> $$4, BiPredicate<E, ht> $$5) {
      super(ImmutableMap.of(btz.n, bua.c, btz.R, bua.b, btz.S, bua.b), 200);
      this.p = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected boolean a(ama $$0, bla $$1) {
      boolean $$2 = $$1.aA() && !$$1.aX() && !$$1.bl() && !$$0.a_($$1.dl()).a(cuv.pg);
      if (!$$2) {
         $$1.dN().a(btz.R, this.p.a($$0.z) / 2);
      }

      return $$2;
   }

   protected boolean b(ama $$0, bla $$1, long $$2) {
      boolean $$3 = this.i.isPresent() && this.i.get().equals($$1.dj()) && this.k > 0 && !$$1.ba() && (this.j != null || !this.h.isEmpty());
      if (!$$3 && $$1.dN().c(btz.S).isEmpty()) {
         $$1.dN().a(btz.R, this.p.a($$0.z) / 2);
         $$1.dN().b(btz.n);
      }
   ...
   protected void a(ama $$0, E $$1, long $$2) {
      ...
      this.h = ht.a($$4 - this.f, $$5 - this.e, $$6 - this.f, $$4 + this.f, $$5 + this.e, $$6 + this.f)
         ...
         .map($$1x -> new bns.a($$1x.i(), ati.c($$3.j($$1x))))
   ...
   protected void c(ama $$0, E $$1, long $$2) {
      if (this.j != null) {
         if ($$2 - this.l >= 40L) {
            ...
            $$1.f(this.j.a($$4 / $$3));
            $$1.dN().a(btz.S, true);
            $$0.a(null, $$1, this.q.apply($$1), aqo.g, 1.0F, 1.0F);
         }
      } else {
         this.k--;
         this.d($$0, $$1, $$2);
   ...
   protected Optional<bns.a> a(ama $$0) {
      Optional<bns.a> $$1 = bhd.a($$0.z, this.h);
      $$1.ifPresent(this.h::remove);
      return $$1;
   }

   private boolean a(ama $$0, E $$1, ht $$2) {
      ht $$3 = $$1.dl();
      int $$4 = $$3.u();
      int $$5 = $$3.w();
   ...
   @Nullable
   private eji a(bla $$0, eji $$1, int $$2) {
      eji $$3 = $$0.dj();
      eji $$4 = new eji($$1.c - $$3.c, 0.0, $$1.e - $$3.e).d().a(0.5);
      $$1 = $$1.d($$4);
      eji $$5 = $$1.d($$3);
      ...
      if ($$18 < 0.0) {
         ...
         if ($$19 > (double)this.g) {
            ...
            for (int $$26 = 0; $$26 < $$22 - 1; $$26++) {
               ...
               double $$28 = $$23 * $$17;
               double $$29 = $$23 * $$16;
               eji $$30 = new eji($$3.c + $$28, $$3.d + $$27, $$3.e + $$29);
            ...
            return new eji($$20 * $$17, $$21, $$20 * $$16).a(0.95F);
         }
      }
   }

   private boolean a(bla $$0, bkj $$1, eji $$2, eji $$3) {
      eji $$4 = $$3.d($$2);
   ...
   public static class a extends bhc.a {
      private final ht a;
