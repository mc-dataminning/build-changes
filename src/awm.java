...
public class awm extends awr {
   ...
   private final Set<awn<?>> e = Sets.newHashSet();

   public awm(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<awn<?>> d() {
      Set<awn<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  ug $$4 = a($$3.getAsJsonObject());
                  $$4 = bao.g.a($$0, $$4, uv.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<awn<T>> a(awp<T> $$0, String $$1) {
      return Optional.ofNullable(ale.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static ug a(JsonObject $$0) {
      ug $$1 = new ug();
   ...
   protected String b() {
      Map<awp<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awn<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awn<?>>)$$3.next();
         awn<?> $$2 = (awn<?>)$$1.getKey();
      ...
      for (Entry<awp<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(lv.v.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> ale b(awn<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(ark $$0) {
      Object2IntMap<awn<?>> $$1 = new Object2IntOpenHashMap();
