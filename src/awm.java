...
public class awm extends bav {
   public awm(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bbv.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bbv.s, "minecraft:piston");
