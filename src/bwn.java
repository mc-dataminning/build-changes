...
public class bwn {
   ...
   private static void d(bkg<bwm> $$0) {
      $$0.a(
         cdf.q,
         ImmutableList.of(Pair.of(0, new bly(p, apd.jW)), Pair.of(1, new bma<>(p, 5, 5, 1.5F, $$0x -> $$0x.gn() ? apd.jR : apd.jH))),
      ...
      $$0.a(
         ...
         ImmutableList.of(
            Pair.of(
               0,
               new bmm(
                  $$0x -> $$0x.gn() ? r : q, s, 3.0F, $$0x -> $$0x.m_() ? 1.0 : 2.5, $$0x -> $$0x.gn() ? apd.jU : apd.jK, $$0x -> $$0x.gn() ? apd.jV : apd.jL
               )
            ),
            Pair.of(1, new bml<>($$0x -> $$0x.gn() ? r.a() : q.a(), 4, 7, 1.25F, s, 20, $$0x -> $$0x.gn() ? apd.jT : apd.jJ))
         ),
