...
public class cgw {
   ...
   public boolean a(ash $$0, @Nullable bwf $$1, bwf $$2) {
      if ($$1 == $$2) {
         ...
         if ($$1 == null) {
            ...
            if (this.e && $$1 instanceof bwh $$6 && !$$6.N().a($$2)) {
               return false;
            }
         }
   ...
   @FunctionalInterface
   public interface a {
      boolean test(bwf var1, ash var2);
   }
}
