...
public class enz extends eoe {
   public static final MapCodec<enz> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, enz::new));
   ...
   public List<emj.a> a(div $$0, BiConsumer<iu, dzo> $$1, azt $$2, int $$3, iu $$4, elt $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azk.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azk.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<enz.a> $$13 = Lists.newArrayList();
      $$13.add(new enz.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               iu $$21 = $$4.b(azk.a($$19), $$12 - 1, azk.a($$20));
               iu $$22 = $$21.b(5);
      ...
      List<emj.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(div $$0, BiConsumer<iu, dzo> $$1, azt $$2, iu $$3, iu $$4, boolean $$5, elt $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            iu $$13 = $$3.b(azk.d(0.5F + (float)$$12 * $$9), azk.d(0.5F + (float)$$12 * $$10), azk.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dsl.d, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(div $$0, BiConsumer<iu, dzo> $$1, azt $$2, int $$3, iu $$4, List<enz.a> $$5, elt $$6) {
      for (enz.a $$7 : $$5) {
         int $$8 = $$7.a();
