...
public class enz {
   ...
   @Nullable
   public ts a(ta $$0, int $$1) {
      enz.e $$2 = new enz.e((float)$$1);
      return $$0.<ts>a(($$1x, $$2x) -> apq.c($$2x, $$1x, $$2) ? Optional.empty() : Optional.of($$1x), ts.a).orElse(null);
   }

   @Nullable
   public ts a(aom $$0, int $$1) {
      enz.e $$2 = new enz.e((float)$$1);
      MutableObject<ts> $$3 = new MutableObject();
      $$0.accept(($$2x, $$3x, $$4) -> {
         if (!$$2.accept($$2x, $$3x, $$4)) {
            $$3.setValue($$3x);
            return false;
   ...
   public ta a(ta $$0, int $$1, ts $$2) {
      final enz.e $$3 = new enz.e((float)$$1);
   ...
   public void a(String $$0, int $$1, ts $$2, boolean $$3, enz.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      ts $$7 = $$2;

      while ($$5 < $$6) {
         enz.b $$8 = new enz.b((float)$$1);
   ...
   public List<ta> g(String $$0, int $$1, ts $$2) {
      List<ta> $$3 = Lists.newArrayList();
      this.a($$0, $$1, $$2, false, ($$2x, $$3x, $$4) -> $$3.add(ta.a($$0.substring($$3x, $$4), $$2x)));
      return $$3;
   }

   public List<ta> b(ta $$0, int $$1, ts $$2) {
      List<ta> $$3 = Lists.newArrayList();
      this.a($$0, $$1, $$2, ($$1x, $$2x) -> $$3.add($$1x));
      return $$3;
   }

   public List<ta> a(ta $$0, int $$1, ts $$2, ta $$3) {
      List<ta> $$4 = Lists.newArrayList();
      this.a($$0, $$1, $$2, ($$2x, $$3x) -> $$4.add($$3x ? ta.a($$3, $$2x) : $$2x));
      return $$4;
   }

   public void a(ta $$0, int $$1, ts $$2, BiConsumer<ta, Boolean> $$3) {
      List<enz.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new enz.c($$2x, $$1x));
         }
      ...
      while ($$6) {
         $$6 = false;
         enz.b $$9 = new enz.b((float)$$1);

         for (enz.c $$10 : $$5.a) {
            boolean $$11 = apq.a($$10.c, 0, $$10.d, $$2, $$9);
            if (!$$11) {
               int $$12 = $$9.a();
               ts $$13 = $$9.b();
               char $$14 = $$5.a($$12);
   ...
   static class a {
      ...
      public ta a(int $$0, int $$1, ts $$2) {
         ...
         ListIterator<enz.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
   ...
   @FunctionalInterface
   public interface d {
      void accept(ts var1, int var2, int var3);
   }

   class e implements aon {
      private float b;
      private int c;
      ...
      @Override
      public boolean accept(int $$0, ts $$1, int $$2) {
         this.b = this.b - enz.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
   ...
   @FunctionalInterface
   public interface f {
      float getWidth(int var1, ts var2);
   }
}
