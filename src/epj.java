...
public class epj {
   ...
   private int m;
   private boolean n;
   private final List<epj.a> o = new ArrayList<>();
      ...
      if (!this.j()) {
         ...
         if ($$5 > 0) {
            ...
            if ($$32 > 0L) {
               ...
               $$0.a(-2, 0, $$8 + 4, 9, $$34 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, sw.a("chat.queue", $$32), 0, 1, 16777215 + ($$33 << 24));
               $$0.c().b();
            }
            ...
            if ($$6) {
               ...
               if ($$36 != $$37) {
                  ...
                  $$0.a($$42 + 2, -$$38, $$42 + 1, -$$38 - $$39, 13421772 + ($$40 << 24));
               }
            }
