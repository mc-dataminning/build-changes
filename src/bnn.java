...
public class bnn implements bno {
   ...
   private static final bnn k = new bnn();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bnm $$0) {
      URL $$1 = bnn.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bnm $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bnq a = new bnq(() -> bnn.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bnn.this.l && $$0.getState() == RecordingState.STOPPED) {
