...
public class bnn {
   ...
   private static void a(bnv $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bnq $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dvi, bnz<bnp>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bnz)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dvi, bnz<bnp>> $$3 : $$0) {
         bnz<bnp> $$4 = (bnz<bnp>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dvi)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bnx> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bnc.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bnl $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bnn::a));
      $$1.add("chunksWritten", this.a($$0.m(), bnn::a));
      return $$1;
   }

   private JsonElement a(bns.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bnl $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bnn::a));
      $$1.add("received", this.a($$0.k(), bnn::a));
      return $$1;
   }

   private <T> JsonElement a(bnu<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bnr> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bnr>, ToDoubleFunction<bnr>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bnr::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bnr::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bnr::c));
      return $$1;
   }
}
