...
public class clv {
   ...
   private int g = ayu.b(azc.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(kc.a.fieldOf("uuid").forGetter(Pair::getFirst), ayc.k.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<bsp> j;
   @VisibleForTesting
   protected final ArrayList<bsp> c;
   private final clv.a k;
   @VisibleForTesting
   protected final Object2IntMap<bsp> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<clv> a(Predicate<bsp> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(clv::b)).apply($$1, $$1x -> new clv($$0, $$1x))
      );
   }

   public clv(Predicate<bsp> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new clv.a(this);
   ...
   public void a(arb $$0, Predicate<bsp> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bsp>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bsp> $$6 = (Entry<bsp>)$$5.next();
         int $$7 = $$6.getIntValue();
         bsp $$8 = (bsp)$$6.getKey();
         bsp.c $$9 = $$8.dL();
   ...
   public int b(@Nullable bsp $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<btk> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof btk).map($$0 -> (btk)$$0);
   }

   @VisibleForTesting
   protected static record a(clv a) implements Comparator<bsp> {
      public int a(bsp $$0, bsp $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cms;
               boolean $$7 = $$1 instanceof cms;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
