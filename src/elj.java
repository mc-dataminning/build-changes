...
public class elj implements eli {
   ...
   public static final Codec<elj> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               efv.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               efx.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               efw.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               btg.b(1, 20).fieldOf("outer_wall_distance").orElse(btm.a(4, 5)).forGetter($$0x -> $$0x.i),
               btg.b(1, 20).fieldOf("distribution_points").orElse(btm.a(3, 4)).forGetter($$0x -> $$0x.j),
               btg.b(0, 10).fieldOf("point_offset").orElse(btm.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public elj(efv $$0, efx $$1, efw $$2, double $$3, double $$4, boolean $$5, btg $$6, btg $$7, btg $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
