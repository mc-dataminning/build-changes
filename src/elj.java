...
public class elj {
   ...
   public elj(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<elk> $$1) throws IOException {
   ...
   public List<elk> a(Path $$0) throws IOException {
      List<elk> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<elk> a(Path $$0, boolean $$1) throws IOException {
      List<elk> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<elk> $$1) throws IOException {
