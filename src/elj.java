...
public class elj extends elh {
   ...
   private final bro i;
   private final jv<djl> j;

   public elj(int $$0, int $$1, int $$2, bro $$3, float $$4, bro $$5, jv<djl> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<ejn.a> a(dgn $$0, BiConsumer<ji, dww> $$1, azh $$2, int $$3, ji $$4, eix $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new ejn.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(dgn $$0, BiConsumer<ji, dww> $$1, azh $$2, int $$3, eix $$4, List<ejn.a> $$5, ji.a $$6, int $$7, jn $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new ejn.a($$16, 0, false));
         $$5.add(new ejn.a($$16.c(2), 0, false));
      }
   }
