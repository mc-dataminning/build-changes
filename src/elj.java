...
public class elj implements AutoCloseable {
   ...
   private ell a(elb.a $$0, ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(elb.a $$0, ByteBuffer $$1) {
      if (!$$0.m()) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, fny $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, fny $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.o != null && (this.i == ell.b.a || this.i == ell.b.b)) {
