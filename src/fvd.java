public abstract class fvd<T extends cts> extends fvb<T> implements fyo {
   private final fyj<?> G;
   private boolean H;

   public fvd(T $$0, fyj<?> $$1, cox $$2, wp $$3) {
      super($$0, $$2, $$3);
      this.G = $$1;
   }
   ...
   protected abstract fta G();

   private void M() {
      fta $$0 = this.G();
      this.c(new fpg($$0.a(), $$0.b(), 20, 18, fyj.a, $$0x -> {
         this.G.c();
         this.C = this.G.a(this.n, this.s);
         fta $$1 = this.G();
         $$0x.c($$1.a(), $$1.b());
