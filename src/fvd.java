...
public class fvd implements fhb {
   static final Logger b = LogUtils.getLogger();
   private final fic c;
   private final fur<fvd.b> d;

   fvd(fic $$0, fur<fvd.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(alg c, int d, int e, int[][] f) implements fvf {
      ...
      public static final MapCodec<fvd.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     alg.a.fieldOf("file").forGetter(fvd.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fvd.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fvd.a::e),
                     g.fieldOf("chars").forGetter(fvd.a::f)
                  )
                  .apply($$0, fvd.a::new)
         )
         .validate(fvd.a::a);
      ...
      private static DataResult<fvd.a> a(fvd.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fvd.b $$15 = $$9.a($$12, new fvd.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fvd.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(fic $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, fic b, int c, int d, int e, int f, int g, int h) implements fha {
