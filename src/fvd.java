...
public class fvd<T extends btc> extends ftl<T> implements ftp, fuy {
   ...
   public final fxq p;
   public final fxq q;
   public fvd.a r = fvd.a.a;
   public fvd.a s = fvd.a.a;
   public boolean t;
   public float u;
   ...
   public fvd(fxq $$0, Function<akk, gen> $$1) {
   ...
   public static fxy a(fxu $$0, float $$1) {
      fxy $$2 = new fxy();
      fxz $$3 = $$2.a();
      $$3.a("head", fxv.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), fxs.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("hat", fxv.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), fxs.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("body", fxv.c().a(16, 16).a(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, $$0), fxs.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("right_arm", fxv.c().a(40, 16).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), fxs.a(-5.0F, 2.0F + $$1, 0.0F));
      $$3.a("left_arm", fxv.c().a(40, 16).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), fxs.a(5.0F, 2.0F + $$1, 0.0F));
      $$3.a("right_leg", fxv.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), fxs.a(-1.9F, 12.0F + $$1, 0.0F));
      $$3.a("left_leg", fxv.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), fxs.a(1.9F, 12.0F + $$1, 0.0F));
      return $$2;
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      this.n.f = 0.0F;
      this.o.f = 0.0F;
      boolean $$9 = $$0.fs() == bsw.b;
      if ($$0.ft()) {
         boolean $$10 = $$0.fu() == bqg.a;
         if ($$10 == $$9) {
            this.a($$0);
         } else {
            this.b($$0);
      ...
      if (this.u > 0.0F) {
         float $$12 = $$1 % 26.0F;
         bsw $$13 = this.c($$0);
         float $$14 = $$13 == bsw.b && this.c > 0.0F ? 0.0F : this.u;
         float $$15 = $$13 == bsw.a && this.c > 0.0F ? 0.0F : this.u;
         if (!$$0.ft()) {
            if ($$12 < 14.0F) {
   ...
   private void a(T $$0) {
      switch (this.s) {
         ...
         case e:
            ...
            break;
         case f:
            ftn.a(this.n, this.o, $$0, true);
            break;
         case g:
            ftn.a(this.n, this.o, this.k, true);
            break;
         case h:
            this.n.e = ayg.a(this.k.e - 1.9198622F - ($$0.cc() ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F);
   ...
   private void b(T $$0) {
      switch (this.r) {
         ...
         case e:
            ...
            break;
         case f:
            ftn.a(this.n, this.o, $$0, false);
            break;
         case g:
            ftn.a(this.n, this.o, this.k, false);
            break;
         case h:
            this.o.e = ayg.a(this.k.e - 1.9198622F - ($$0.cc() ? (float) (Math.PI / 12) : 0.0F), -2.4F, 3.3F);
   ...
   private void a(fxq $$0, boolean $$1) {
   ...
   protected fxq a(bsw $$0) {
      return $$0 == bsw.a ? this.o : this.n;
   }
