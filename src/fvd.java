...
public abstract class fvd<T extends cef> extends fwb<T> {
   public fvd(fwc.a $$0) {
      super($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, eob $$3, fqz $$4, int $$5) {
      ...
      $$3.a(-4.0F, 0.0F, 0.0F);
      eof $$18 = $$4.getBuffer(frh.d(this.a($$0)));
      eob.a $$19 = $$3.c();
      Matrix4f $$20 = $$19.a();
      Matrix3f $$21 = $$19.b();
   ...
   public void a(Matrix4f $$0, Matrix3f $$1, eof $$2, int $$3, int $$4, int $$5, float $$6, float $$7, int $$8, int $$9, int $$10, int $$11) {
      $$2.a($$0, (float)$$3, (float)$$4, (float)$$5).a(255, 255, 255, 255).a($$6, $$7).c(gbq.d).b($$11).a($$1, (float)$$8, (float)$$10, (float)$$9).e();
   }
}
