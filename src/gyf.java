...
public class gyf extends gvn<cjs, heg, ghi> {
   ...
   public gyf(gwt.a $$0) {
      super($$0, new ghi($$0.a(gjn.bZ)), new ghi($$0.a(gjn.ca)), 0.9F);
      this.a(new hbd(this));
   }
   ...
   public void a(cjs $$0, heg $$1, float $$2) {
      super.a($$0, $$1, $$2);
      hdo.a($$0, $$1, this.h);
      $$1.a = $$0.gH();
      $$1.b = $$0.q() > 0;
   ...
   protected void a(heg $$0, fjy $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.l > 0.0F) {
         float $$4 = azm.i($$0.l);
         int $$5 = azm.d($$0.l);
