...
public class wo implements ve {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = atq.a(atq.b, wo::b);
   private static final Codec<Object> e = Codec.either(d, vf.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof vd $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<wo> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               atq.a(e.listOf(), "with").forGetter($$0x -> a($$0x.j))
            )
            .apply($$0, wo::a)
   );
   public static final ve.a<wo> c = new ve.a<>(b, "translatable");
   private static final vi f = vi.e("%");
   private static final vi g = vi.e("null");
   ...
   @Nullable
   private sg k;
   private List<vi> l = ImmutableList.of();
   ...
   private static wo a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new wo($$0, $$1.orElse(null), a($$2));
   }

   public wo(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<vi> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (wp var4) {
            this.l = ImmutableList.of(vi.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<vi> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new wp(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private vi a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof vd) {
            ...
            return $$1 == null ? g : vi.e($$1.toString());
         }
      } else {
         throw new wp(this, $$0);
      }
   ...
   public vr a(@Nullable ds $$0, @Nullable blp $$1, int $$2) throws CommandSyntaxException {
      ...
      return vr.a(new wo(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof wo $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
