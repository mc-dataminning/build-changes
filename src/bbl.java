...
public class bbl extends ayj {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bbl::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bbl::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bbl::k);
         $$0 = this.a($$0, "minecraft:fox", bbl::j);
         $$0 = this.a($$0, "minecraft:item", bbl::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bbl::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bbl::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bbl::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bbl::e);
         return this.a($$0, "minecraft:piglin", bbl::d);
      });
   }
