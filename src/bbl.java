...
public class bbl extends bee {
   public bbl(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bff.z, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bff.B.typeName(), bgp.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bff.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bff.B.typeName(), "minecraft:saddle"));
