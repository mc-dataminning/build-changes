...
public class bbl extends bgp {
   ...
   public bbl(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bhu.s, "minecraft:banner");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bbl::a);
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(bbl::b)));
   }
