...
public class bbl extends bgf {
   public bbl(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bhk.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bhk.s, "minecraft:piston");
