...
public interface mc {
   ...
   CompletableFuture<?> a(ma var1);

   String a();

   static <T> CompletableFuture<?> a(ma $$0, jq.a $$1, Codec<T> $$2, T $$3, Path $$4) {
      alc<JsonElement> $$5 = $$1.a(JsonOps.INSTANCE);
      JsonElement $$6 = (JsonElement)$$2.encodeStart($$5, $$3).getOrThrow();
      return a($$0, $$6, $$4);
   }

   static CompletableFuture<?> a(ma $$0, JsonElement $$1, Path $$2) {
   ...
   @FunctionalInterface
   public interface a<T extends mc> {
      T create(me var1);
   }
}
