...
public class ed implements ArgumentType<ed.a> {
   ...
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tl.b("argument.anchor.invalid", $$0));
   ...
   public static enum a {
      a("feet", ($$0, $$1) -> $$0),
      b("eyes", ($$0, $$1) -> new ehh($$0.c, $$0.d + (double)$$1.cH(), $$0.e));
      ...
      private final BiFunction<ehh, biw, ehh> e;

      private a(String $$0, BiFunction<ehh, biw, ehh> $$1) {
         this.d = $$0;
         this.e = $$1;
      }
