...
public class eyo {
   ...
   public static final eyo.a bv;

   public static eyo.a a(int $$0, int $$1) {
      return $$0 == -1 ? eyo.b.b.a($$1) : eyo.b.a.a($$0);
   }

   public static eyo.a a(String $$0) {
      if (eyo.a.e.containsKey($$0)) {
         return eyo.a.e.get($$0);
      } else {
         for (eyo.b $$1 : eyo.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eyo.b b;
      private final int c;
      private final ayo<xl> d;
      static final Map<String, eyo.a> e = Maps.newHashMap();

      a(String $$0, eyo.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ayo<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xl.b($$2.toUpperCase(Locale.ROOT)) : xl.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xl.b($$2) : xl.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> um.a().b($$1) ? xl.c($$1) : xl.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<eyo.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xl> g;

      private static void a(eyo.b $$0, String $$1, int $$2) {
         eyo.a $$3 = new eyo.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xl> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public eyo.a a(int $$0) {
         return (eyo.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
