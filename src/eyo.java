...
public class eyo implements Comparable<eyo> {
   ...
   public eyo(diz $$0, eyp $$1, String $$2, boolean $$3, boolean $$4, boolean $$5, Path $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.f = $$4;
   ...
   public static class b extends eyo {
   ...
   public static class c extends eyo {
