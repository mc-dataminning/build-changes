...
public class eyo extends exz implements fid.a {
   ...
   private final fid z;
   private final Map<ae, eyk> A = Maps.newLinkedHashMap();
   @Nullable
   private eyk B;
   private boolean C;
   ...
   public void a(erw $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (eyk $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (eyk $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ae $$0) {
      eyk $$1 = eyk.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0, $$1);
      }
   }
