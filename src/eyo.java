public class eyo extends exd {
   private static final eys a = new eys(
   ...
   public eyo(ezh $$0, ezg $$1, int $$2, int $$3) {
      super(0, 0, $$2, $$3, $$1.a());
      this.m = $$0;
      this.n = $$1;
   }
   ...
   private void b(ewt $$0, ewr $$1, int $$2) {
   ...
   protected void a(fay $$0) {
      $$0.a(fax.a, vf.a("gui.narrate.tab", this.n.a()));
   }
