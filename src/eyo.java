...
public class eyo {
   ...
   private static final Queue<eyo.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eyo.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eyo::a), eym::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eyo::a), eym::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eyo.a(this.b) + ", type=" + eyo.b(this.c) + ", severity=" + eyo.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
