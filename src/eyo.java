...
public class eyo implements gjd {
   private static final long a = 3000L;
   private final evi b;
   private final List<eyo.a> c = Lists.newArrayList();
   private boolean d;
   private final List<eyo.a> e = new ArrayList<>();
   ...
   public void a(ewu $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<eyo.a> $$10 = this.e.iterator();
            ...
            for (eyo.a $$12 : this.e) {
               ...
               int $$24 = auo.d(auo.b(255.0F, 75.0F, (float)(ac.b() - $$12.b()) / (float)(3000.0 * $$9)));
   ...
   @Override
   public void a(gia $$0, gjf $$1, float $$2) {
      if ($$1.a() != null) {
         vf $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (eyo.a $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.a(new elt($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new eyo.a($$3, $$2, new elt($$0.h(), $$0.i(), $$0.j())));
      }
   }
