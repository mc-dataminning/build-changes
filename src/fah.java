...
public class fah extends ezz<cfk> implements fcc {
   private float x;
   private float y;
   private final fbw z = new fbw();
   private boolean A;
   private boolean B;
   ...
   protected void aH_() {
      if (this.f.q.g()) {
         ...
         this.d(new etc(this.t + 104, this.h / 2 - 22, 20, 18, fbw.a, $$0 -> {
            this.z.f();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(esf $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, bjg $$9) {
   ...
   public static void a(esf $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, bjg $$7) {
      $$0.c().a();
