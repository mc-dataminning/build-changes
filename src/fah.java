...
public class fah {
   ...
   static class b {
      static final Optional<fah> a = Optional.ofNullable(a());
      ...
      private static fah a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fah();
      }
   }
}
