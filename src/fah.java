...
public class fah extends fal implements faj {
   ...
   public fah.c a() {
      return new fah.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(far.b $$0, far $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (fas)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(far $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == fak.k;
         boolean $$2 = $$0 == fak.j;
   ...
   private IntConsumer a(int $$0, far.a $$1) {
   ...
   private fah.b q() {
      ...
      this.k += $$5;
      this.j++;
      fah.a $$9 = new fah.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new fah.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == far.b.a || this.q == far.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<fas> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      fas $$1 = (fas)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == fas.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == fas.b.c) {
         faj.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, faj.a($$11));
         this.a($$14 + 5, faj.a($$12));
         this.a($$14 + 6, faj.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(far a, int b, int c, far.b d, far.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(far.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable fau $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
