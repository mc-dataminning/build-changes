...
public class bag extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bgs.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", bag::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", bag::a);
      return this.a($$0, "minecraft:trident", bag::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bgs.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bgs.B, $$1);
