...
public class bag extends bfe {
   ...
   public bag(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bgf.s, "minecraft:banner");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), bag::a);
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return azu.a($$0, "Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(bag::b)));
   }
   ...
   private static Dynamic<?> b(Dynamic<?> $$0) {
      ...
      return azu.a($$0, "Color", "color", $$0x -> $$0x.createString(a($$0x.asInt(0))));
   }
