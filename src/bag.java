...
public class bag<T> extends AbstractSet<T> {
   private static final int a = 10;
   private final Comparator<T> b;
   T[] c;
   int d;

   private bag(int $$0, Comparator<T> $$1) {
      this.b = $$1;
      if ($$0 < 0) {
   ...
   public static <T extends Comparable<T>> bag<T> a() {
      return a(10);
   }

   public static <T extends Comparable<T>> bag<T> a(int $$0) {
      return new bag<>($$0, Comparator.naturalOrder());
   }

   public static <T> bag<T> a(Comparator<T> $$0) {
      return a($$0, 10);
   }

   public static <T> bag<T> a(Comparator<T> $$0, int $$1) {
      return new bag<>($$1, $$0);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof bag<?> $$1 && this.b.equals($$1.b)) {
   ...
   class a implements Iterator<T> {
      ...
      public boolean hasNext() {
         return this.b < bag.this.d;
      }

      @Override
      public T next() {
         if (this.b >= bag.this.d) {
            throw new NoSuchElementException();
         } else {
            this.c = this.b++;
            return bag.this.c[this.c];
         }
      }
