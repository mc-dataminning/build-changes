...
public class bag implements bal {
   ...
   private final Map<String, bag.a> f = Maps.newHashMap();
   ...
   private bag.a f() {
      if (this.m == null) {
         this.m = this.f.computeIfAbsent(this.k, $$0 -> new bag.a());
      }
   ...
   public static class a implements bao {
