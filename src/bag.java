...
public class bag extends bex {
   public bag(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bfy.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bfy.s, "minecraft:piston");
