...
public class ccw extends ccz {
   private final bwd a;
   private final Predicate<bwd> b;
   @Nullable
   private bwd c;
   ...
   public ccw(bwd $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean b() {
      List<bwd> $$0 = this.a.dV().a(bwd.class, this.a.cR().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (bwd $$1 : $$0) {
            if (!$$1.cp()) {
               this.c = $$1;
