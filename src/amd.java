...
public interface amd {
   amd a = new amd() {
      ...
      @Override
      public void a(Consumer<csf> $$0) {
      }
   };

   static amd a(csf $$0, int $$1) {
      return new amd.a($$0, $$1);
   }

   static void a(amd $$0, amd $$1, Consumer<csf> $$2, Consumer<csf> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof amd.a $$4 && $$1 instanceof amd.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new csf($$10, $$11));
                     } else {
                        $$3.accept(new csf($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(csf b, int c) implements amd {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(amd.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return amd.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
