...
public class amd implements ama {
   ...
   amd(alv $$0, Set<String> $$1, List<Path> $$2, Map<amb, List<Path>> $$3) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(amb $$0, aer $$1, Consumer<Path> $$2) {
   ...
   public void a(amb $$0, String $$1, String $$2, ama.a $$3) {
      v.c($$2).get().ifLeft($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<aer, ane<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(ama.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      amc.a($$1, $$4, $$3, $$0);
   }
   ...
   public ane<InputStream> a(amb $$0, aer $$1) {
      return (ane<InputStream>)v.c($$1.a()).get().map($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.g.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && amc.a($$5)) {
               return ane.create($$5);
            }
         }
   ...
   public <T> T a(amm<T> $$0) {
      ane<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public anp c() {
      return $$0 -> Optional.ofNullable(this.a(amb.a, $$0)).map($$0x -> new ank(this, $$0x));
   }
}
