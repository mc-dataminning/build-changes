...
public class amd {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vs.c("commands.random.error.range_too_large"));
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(vs.c("commands.random.error.range_too_small"));
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a("random").then(a("value", false))).then(a("roll", true)))
            .then(
               ((LiteralArgumentBuilder)((LiteralArgumentBuilder)dv.a("reset").requires($$0x -> $$0x.c(2)))
                  ...
                  .then(
                     ((RequiredArgumentBuilder)dv.a("sequence", ev.a()).suggests(amd::a).executes($$0x -> a((du)$$0x.getSource(), ev.e($$0x, "sequence"))))
                        .then(
                           ((RequiredArgumentBuilder)dv.a("seed", IntegerArgumentType.integer())
      ...
      return (LiteralArgumentBuilder<du>)dv.a($$0)
         .then(
            ((RequiredArgumentBuilder)dv.a("range", es.a()).executes($$1x -> a((du)$$1x.getSource(), es.b.a($$1x, "range"), null, $$1)))
               .then(
                  ((RequiredArgumentBuilder)dv.a("sequence", ev.a()).suggests(amd::a).requires($$0x -> $$0x.c(2)))
   ...
   private static int a(du $$0, cm.d $$1, @Nullable ajc $$2, boolean $$3) throws CommandSyntaxException {
      awt $$4;
      if ($$2 != null) {
         $$4 = $$0.e().a($$2);
      } else {
      ...
      if ($$8 == 0L) {
         ...
         int $$9 = awm.b($$4, $$6, $$7);
         if ($$3) {
            $$0.l().ah().a(vs.a("commands.random.roll", $$0.b(), $$9, $$6, $$7), false);
         } else {
            $$0.a(() -> vs.a("commands.random.sample.success", $$9), false);
         }
   ...
   private static int a(du $$0, ajc $$1) throws CommandSyntaxException {
      $$0.e().J().b($$1);
      $$0.a(() -> vs.a("commands.random.reset.success", vs.a($$1)), false);
      return 1;
   }

   private static int a(du $$0, ajc $$1, int $$2, boolean $$3, boolean $$4) throws CommandSyntaxException {
      $$0.e().J().a($$1, $$2, $$3, $$4);
      $$0.a(() -> vs.a("commands.random.reset.success", vs.a($$1)), false);
      return 1;
   }
   ...
   private static int a(du $$0) {
      int $$1 = $$0.e().J().a();
      $$0.a(() -> vs.a("commands.random.reset.all.success", $$1), false);
      return $$1;
   }
   ...
   private static int a(du $$0, int $$1, boolean $$2, boolean $$3) {
      ...
      $$4.a($$1, $$2, $$3);
      int $$5 = $$4.a();
      $$0.a(() -> vs.a("commands.random.reset.all.success", $$5), false);
      return $$5;
   }
}
