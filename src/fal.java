...
public class fal extends ezi<cfo> {
   private static final aex x = new aex("container/loom/banner_slot");
   private static final aex y = new aex("container/loom/dye_slot");
   private static final aex z = new aex("container/loom/pattern_slot");
   private static final aex A = new aex("container/loom/scroller");
   private static final aex B = new aex("container/loom/scroller_disabled");
   private static final aex C = new aex("container/loom/pattern_selected");
   private static final aex D = new aex("container/loom/pattern_highlighted");
   private static final aex E = new aex("container/loom/pattern");
   private static final aex F = new aex("container/loom/error");
   private static final aex G = new aex("textures/gui/container/loom.png");
   ...
   private fic P;
   @Nullable
   private List<Pair<hg<dcm>, cht>> Q;
   private cjf R = cjf.b;
   private cjf S = cjf.b;
   private cjf T = cjf.b;
   private boolean U;
   ...
   private void a(esf $$0, hg<dcm> $$1, int $$2, int $$3) {
      ...
      this.P.e = 0.0F;
      this.P.c = -32.0F;
      List<Pair<hg<dcm>, cht>> $$9 = dcl.a(cht.h, dcl.a($$6));
