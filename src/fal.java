...
public class fal implements fam, fan {
   ...
   public fal(dkn $$0, ein $$1, fal.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         iw.c,
   ...
   public static <T> fal a(Dynamic<T> $$0, dkn $$1, fal.a $$2, ein $$3, Lifecycle $$4) {
      ...
      return new fal(
         ...
         new ffp<>(ffo.a, $$0.get("ScheduledEvents").asStream()),
         (ua)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(efq.a.a).resultOrPartial(f::error).orElse(efq.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(ju $$0, ua $$1, @Nullable ua $$2) {
      ...
      eil.a($$4, this.h, $$0).resultOrPartial(ag.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", efq.a.a, this.y);
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }
   ...
   @Override
   public boolean z() {
      return this.i == fal.a.b;
   }

   @Override
   public boolean A() {
      return this.i == fal.a.c;
   }
