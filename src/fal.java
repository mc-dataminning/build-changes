...
public class fal {
   private final ImmutableList<fam> a;
   private final ImmutableMap<String, fam> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private faj e;

   public fal(ImmutableMap<String, fam> $$0) {
      this.b = $$0;
