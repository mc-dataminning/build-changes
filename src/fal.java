...
public class fal {
   ...
   public void a(fbv $$0, String $$1, fcr.a $$2, epw $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fal.b $$13 = new fal.b($$1.trim(), this.f, $$3, $$2);
                  fal.a $$14 = new fal.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fal.c $$30 = new fal.c(this.f, $$2, $$0);
                        fal.a $$31 = new fal.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fbz(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, epw $$2) throws IOException {
      ...
      File $$15 = new File(fff.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final epw d;
      private final fcr.a e;

      b(final String $$0, final File $$1, final epw $$2, final fcr.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fal.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fal.this.b && !fal.this.d) {
            try {
               fal.this.e = true;
               fal.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fal.a.error("Error extracting archive", var3);
               fal.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fcr.a c;
      private final fbv d;

      c(final File $$0, final fcr.a $$1, final fbv $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fal.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fal.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fal.this.g);
                  fal.this.c = true;
               } else {
                  fal.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fal.this.d = true;
               }
            } catch (IOException var3) {
               fal.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fal.this.d = true;
            }
         }
      }
