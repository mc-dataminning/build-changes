...
public class uv implements to {
   private static final Logger c = LogUtils.getLogger();
   private final String d;
   @Nullable
   private final gc e;
   protected final Optional<tn> b;

   public uv(String $$0, Optional<tn> $$1) {
      this.d = $$0;
      this.b = $$1;
      this.e = a($$0);
   }
   ...
   public ua a(@Nullable dt $$0, @Nullable bis $$1, int $$2) throws CommandSyntaxException {
      if ($$0 != null && this.e != null) {
         Optional<? extends tn> $$3 = tp.a($$0, this.b, $$1, $$2);
         return tp.a(this.e.b($$0), $$3, bis::N_);
      } else {
         return tn.h();
      }
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof uv $$1 && this.d.equals($$1.d) && this.b.equals($$1.b)) {
            return true;
         }
