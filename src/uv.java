...
public class uv extends uq<uw> {
   private static final int b = 24;
   public static final vq<uv> a = new vq.b<uv>() {
      public uv a(DataInput $$0, va $$1) throws IOException {
         return new uv(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof uv && Arrays.equals(this.c, ((uv)$$0).c);
   }
   ...
   public uw a(int $$0) {
      return uw.a(this.c[$$0]);
   }

   public uw a(int $$0, uw $$1) {
      int $$2 = this.c[$$0];
      this.c[$$0] = $$1.g();
      return uw.a($$2);
   }

   public void b(int $$0, uw $$1) {
   ...
   public boolean b(int $$0, vo $$1) {
      if ($$1 instanceof vh) {
         this.c = ArrayUtils.add(this.c, $$0, ((vh)$$1).g());
         return true;
      } else {
         return false;
      }
