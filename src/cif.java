...
public class cif {
   ...
   private static void b(bwj<cie> $$0) {
      $$0.a(cqo.a, 0, ImmutableList.of(new bzu(0.8F), new bwv(2.5F), new byg(45, 90), new byk(), new bxg(cel.aO), new bxg(cel.aP)));
   }
   ...
   public static void a(bvh $$0, ji $$1) {
      bwj<?> $$2 = $$0.eb();
      jq $$3 = jq.a($$0.dV().ai(), $$1);
      Optional<jq> $$4 = $$2.c(cel.aN);
      if ($$4.isEmpty()) {
         $$2.a(cel.aN, $$3);
         $$2.a(cel.aO, 600);
   ...
   private static boolean a(bvh $$0, bwj<?> $$1, jq $$2) {
      Optional<Integer> $$3 = $$1.c(cel.aO);
      dgi $$4 = $$0.dV();
      return $$2.a($$4.ai(), $$0.dv(), 1024) && $$4.a_($$2.b()).a(djo.bf) && $$3.isPresent();
   }
   ...
   public static Optional<are> a(bvh $$0) {
      dgi $$1 = $$0.dV();
