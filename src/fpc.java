...
public enum fpc implements fcp {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static fdr a(int $$0, int $$1, fpc.a $$2) {
      fdr $$3 = new fdr(fdr.a.a, $$0, $$1, false);
   ...
   private fpc(final Supplier<fdr> $$0) {
      this.c = $$0.get();
   }
