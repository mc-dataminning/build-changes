...
public class fpc extends foq {
   private static final fqg d = new fqg(akv.b("widget/text_field"), akv.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayl> D = ($$0x, $$1x) -> ayl.forward($$0x, xm.a);
   @Nullable
   private wp E;
   private long F = af.c();

   public fpc(foc $$0, int $$1, int $$2, wp $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fpc(foc $$0, int $$1, int $$2, int $$3, int $$4, wp $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fpc(foc $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fpc $$5, wp $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   protected xd d() {
      wp $$0 = this.B();
      return wp.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = ayz.a($$0) - this.F();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, ful.t());
   }
   ...
   public void b(foe $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.g()) {
            akv $$4 = d.a(this.E(), this.aM_());
            $$0.a(gmi::H, $$4, this.F(), this.G(), this.A(), this.y());
         }
         ...
         boolean $$9 = this.aM_() && (af.c() - this.F) / 300L % 2L == 0L && $$8;
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gmi.L(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   private void a(foe $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$1 < $$3) {
         int $$5 = $$1;
         $$1 = $$3;
         $$3 = $$5;
