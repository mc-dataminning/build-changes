...
public class fpc {
   ...
   public final Map<ha, fpd> c;
   public final fpe d;
   public final boolean e;

   public fpc(Vector3f $$0, Vector3f $$1, Map<ha, fpd> $$2, @Nullable fpe $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ha, fpd> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<fpc> {
      ...
      public fpc a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         fpe $$6 = this.a($$3);
         Map<ha, fpd> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !arn.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = arn.a($$3, "shade", true);
      ...
      private fpe a(JsonObject $$0) {
         fpe $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = arn.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ha.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = arn.a($$2, "rescale", false);
            $$1 = new fpe($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = arn.m($$0, "angle");
         if ($$1 != 0.0F && arw.e($$1) != 22.5F && arw.e($$1) != 45.0F) {
      ...
      private Map<ha, fpd> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ha, fpd> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ha, fpd> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ha, fpd> $$2 = Maps.newEnumMap(ha.class);
         JsonObject $$3 = arn.u($$1, "faces");
