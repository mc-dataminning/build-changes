...
public class eae<T> implements eag<T> {
   ...
   private eae(jv<T> $$0, int $$1, eah<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private eae(jv<T> $$0, T[] $$1, eah<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public eag<T> a(eah<T> $$0) {
      return new eae<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
