...
public class eae implements eab, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final brc c;
   private final eaj d;
   private final SequencedMap<dfo, eae.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected eae(eal $$0, Path $$1, boolean $$2) {
      this.d = new eaj($$0, $$1, $$2);
      this.c = new brc(eae.b.values().length, af.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dfo $$0, int $$1) {
      dfo $$2 = new dfo($$0.h - $$1, $$0.i - $$1);
      dfo $$3 = new dfo($$0.h + $$1, $$0.i + $$1);
   ...
   public CompletableFuture<Void> a(dfo $$0, Supplier<tq> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         tq $$2 = $$1.get();
         eae.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new eae.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<tq>> a(dfo $$0) {
      return this.a((eae.c<Optional<tq>>)(() -> {
         eae.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((eae.c<Void>)(() -> {
            try {
               this.d.a();
               return null;
   ...
   @Override
   public CompletableFuture<Void> a(dfo $$0, uk $$1) {
      return this.a((eae.c<Void>)(() -> {
         try {
            eae.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(eae.c<T> $$0) {
      return this.c.a(eae.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<dfo, eae.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new bre.c(eae.b.b.ordinal(), this::b));
   }

   private void a(dfo $$0, eae.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(eae.b.c.ordinal(), $$0 -> $$0.complete(baf.a)).join();
   }
