...
public class eae extends eac {
   public static final Codec<eae> a = RecordCodecBuilder.create(
      $$0 -> a($$0)
            .and(
               $$0.group(
                  blq.e.fieldOf("extra_branch_steps").forGetter($$0x -> $$0x.b),
                  Codec.floatRange(0.0F, 1.0F).fieldOf("place_branch_per_log_probability").forGetter($$0x -> $$0x.h),
                  blq.d.fieldOf("extra_branch_length").forGetter($$0x -> $$0x.i),
                  iz.a(ki.f).fieldOf("can_grow_through").forGetter($$0x -> $$0x.j)
               )
            )
            .apply($$0, eae::new)
   );
   ...
   private final blq i;
   private final ip<czf> j;

   public eae(int $$0, int $$1, int $$2, blq $$3, float $$4, blq $$5, ip<czf> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<dyk.a> a(cwk $$0, BiConsumer<ib, dme> $$1, awt $$2, int $$3, ib $$4, dxu $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new dyk.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(cwk $$0, BiConsumer<ib, dme> $$1, awt $$2, int $$3, dxu $$4, List<dyk.a> $$5, ib.a $$6, int $$7, ih $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new dyk.a($$16, 0, false));
         $$5.add(new dyk.a($$16.c(2), 0, false));
      }
   }
