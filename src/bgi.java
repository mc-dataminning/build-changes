...
public class bgi extends bfe {
   public bgi(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bgg.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bhs.a($$0.get("id").asString("minecraft:air"));
