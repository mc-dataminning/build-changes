...
public class gps implements gpy.a {
   ...
   private final fli F;
   private final Map<ji, gps.a> G = Maps.newHashMap();
   private final Map<UUID, zw.a> H = Maps.newHashMap();
   @Nullable
   private UUID I;
   ...
   private void b() {
      this.H.entrySet().removeIf($$0 -> {
         buk $$1 = this.F.s.a($$0.getValue().b());
         return $$1 == null || $$1.dQ();
      });
   }

   private void b(fft $$0, glx $$1, double $$2, double $$3, double $$4) {
      ji $$5 = ji.a($$2, $$3, $$4);
   ...
   private static void a(fft $$0, glx $$1, ji $$2) {
      float $$3 = 0.05F;
      gpy.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(fft $$0, glx $$1, ji $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gpy.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(fft $$0, glx $$1, gps.a $$2) {
      int $$3 = 0;
   ...
   private void a(fft $$0, glx $$1, zw.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         gqh.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fft $$0, glx $$1, zw.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fft $$0, glx $$1, String $$2, gps.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }

   private static void a(fft $$0, glx $$1, String $$2, ji $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      gpy.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(fft $$0, glx $$1, kb $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      ji $$9 = ji.a($$2);
      ...
      float $$13 = 0.5F;
      gpy.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }

   private Set<String> b(gps.a $$0) {
      return this.b($$0.a).stream().map(agc::a).collect(Collectors.toSet());
   }

   private Set<String> c(gps.a $$0) {
      return this.c($$0.a).stream().map(agc::a).collect(Collectors.toSet());
   }
   ...
   private boolean c(zw.a $$0) {
      cow $$1 = this.F.t;
      ji $$2 = ji.a($$1.dA(), $$0.h().b(), $$1.dG());
      ji $$3 = ji.a((kb)$$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(ji $$0) {
      return this.H.values().stream().filter($$1 -> $$1.a($$0)).map(zw.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(ji $$0) {
      return this.H.values().stream().filter($$1 -> $$1.b($$0)).map(zw.a::a).collect(Collectors.toSet());
   }

   private Map<ji, List<String>> c() {
      Map<ji, List<String>> $$0 = Maps.newHashMap();

      for (zw.a $$1 : this.H.values()) {
   ...
   private void d() {
      gpy.a(this.F.ao(), 8).ifPresent($$0 -> this.I = $$0.cG());
   }
