...
public class gps implements gpz.a {
   ...
   private final flj w;
   private final Map<ji, gps.a> x = new HashMap<>();
   ...
   private void b(ffu $$0, gly $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         ...
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gpz.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private void a(ffu $$0, gly $$1, aag.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(ffu $$0, gly $$1, zv.a $$2) {
      if ($$2.e() != null) {
         gqi.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(ffu $$0, gly $$1, zv.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(ffu $$0, gly $$1, String $$2, aag.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }
   ...
   private void g() {
      gpz.a(this.w.ao(), 8).ifPresent($$0 -> this.z = $$0.cG());
   }
