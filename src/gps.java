public class gps implements gpj<dvo> {
   public static final hhy a = new hhy(hfq.d, aku.b("entity/enchanting_table_book"));
   private final gci b;

   public gps(gpk.a $$0) {
      this.b = new gci($$0.a(ggb.J));
   }

   public void a(dvo $$0, float $$1, fgr $$2, gmx $$3, int $$4, int $$5) {
      $$2.a();
      $$2.a(0.5F, 0.75F, 0.5F);
      float $$6 = (float)$$0.a + $$1;
