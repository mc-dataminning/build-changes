...
public class dqz extends dra {
   ...
   protected void a(us $$0, jk.a $$1) {
      super.a($$0, $$1);
      this.g = $$0.i("Age");
      vh.a($$0, "exit_portal").filter(dca::l).ifPresent($$0x -> this.i = $$0x);
      this.j = $$0.q("ExactTeleport");
   }

   public static void a(dca $$0, iz $$1, dse $$2, dqz $$3) {
      $$3.g++;
      if ($$3.c()) {
         $$3.h--;
      }
   ...
   public static void b(dca $$0, iz $$1, dse $$2, dqz $$3) {
      boolean $$4 = $$3.b();
      boolean $$5 = $$3.c();
      $$3.g++;
      if ($$5) {
         ...
         List<bsw> $$6 = $$0.a(bsw.class, new evo($$1), dqz::a);
         if (!$$6.isEmpty()) {
   ...
   private static void c(dca $$0, iz $$1, dse $$2, dqz $$3) {
      if (!$$0.B) {
         $$3.h = 40;
         $$0.a($$1, $$2.b(), 1, 0);
         a($$0, $$1, $$2);
   ...
   public static void a(dca $$0, iz $$1, dse $$2, bsw $$3, dqz $$4) {
   ...
   private static iz a(dca $$0, iz $$1) {
   ...
   private static iz a(arf $$0, iz $$1) {
      ...
      if ($$4 == null) {
         ...
         $$0.H_().c(lq.aC).flatMap($$0x -> $$0x.b(sh.e)).ifPresent($$2x -> ((ean)$$2x.a()).a($$0, $$0.l().g(), azh.a($$5.a()), $$5));
         $$4 = $$5;
      } else {
   ...
   private static evt b(arf $$0, iz $$1) {
      evt $$2 = new evt((double)$$1.u(), 0.0, (double)$$1.w()).d();
      int $$3 = 1024;
      evt $$4 = $$2.a(1024.0);
   ...
   private static boolean a(arf $$0, evt $$1) {
      return a((dca)$$0, $$1).a() == -1;
   }

   private static iz a(dbg $$0, iz $$1, int $$2, boolean $$3) {
      iz $$4 = null;
   ...
   private static duk a(dca $$0, evt $$1) {
      return $$0.d(ayz.a($$1.c / 16.0), ayz.a($$1.e / 16.0));
   }

   @Nullable
   private static iz a(duk $$0) {
      dbh $$1 = $$0.f();
      ...
      for (iz $$7 : iz.c($$2, $$4)) {
         ...
         iz $$9 = $$7.c();
         iz $$10 = $$7.b(2);
         if ($$8.a(dfd.fz) && !$$0.a_($$9).r($$0, $$9) && !$$0.a_($$10).r($$0, $$10)) {
   ...
   private static void a(arf $$0, iz $$1, edd $$2) {
      eba.L.a($$2, $$0, $$0.l().g(), azh.a(), $$1);
   }

   @Override
   public boolean a(je $$0) {
      return dfb.a(this.n(), this.n, this.ay_(), $$0, this.ay_().a($$0));
   }
