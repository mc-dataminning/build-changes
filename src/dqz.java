...
public class dqz {
   ...
   private double j;
   int k = 29999984;
   private dqz.a l = new dqz.d(5.999997E7F);
   public static final dqz.c e = new dqz.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public id b(double $$0, double $$1, double $$2) {
      return id.a(axm.a($$0, this.e(), this.g()), $$1, axm.a($$2, this.f(), this.h()));
   }
   ...
   public boolean a(bqa $$0, ese $$1) {
      double $$2 = Math.max(axm.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dqz.a)($$0 == $$1 ? new dqz.d($$1) : new dqz.b($$0, $$1, $$2));
   ...
   class b implements dqz.a {
      ...
      @Override
      public double a() {
         return axm.a(dqz.this.a() - this.e() / 2.0, (double)(-dqz.this.k), (double)dqz.this.k);
      }

      @Override
      public double c() {
         return axm.a(dqz.this.b() - this.e() / 2.0, (double)(-dqz.this.k), (double)dqz.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? axm.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dqy i() {
         return this.c < this.b ? dqy.b : dqy.a;
      }
      ...
      @Override
      public dqz.a l() {
         return (dqz.a)(this.g() <= 0L ? dqz.this.new d(this.c) : this);
      }
      ...
      public etc m() {
         return esz.a(
            esz.c,
            esz.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            esn.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dqz.c a(DynamicLike<?> $$0, dqz.c $$1) {
         double $$2 = axm.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = axm.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dqz.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dqz.a {
      ...
      private void n() {
         this.c = axm.a(dqz.this.a() - this.b / 2.0, (double)(-dqz.this.k), (double)dqz.this.k);
         this.d = axm.a(dqz.this.b() - this.b / 2.0, (double)(-dqz.this.k), (double)dqz.this.k);
         this.e = axm.a(dqz.this.a() + this.b / 2.0, (double)(-dqz.this.k), (double)dqz.this.k);
         this.f = axm.a(dqz.this.b() + this.b / 2.0, (double)(-dqz.this.k), (double)dqz.this.k);
         this.g = esz.a(
            esz.c,
            esz.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            esn.e
