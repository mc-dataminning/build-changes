...
public class dqz implements dqa {
   public static final Codec<dqz> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               aqi.b(je.e).fieldOf("replaceable").forGetter($$0x -> $$0x.b),
   ...
   public final aqi<csv> b;
   public final dsb c;
   public final hg<dum> d;
   public final dud e;
   public final bgd f;
   ...
   public dqz(aqi<csv> $$0, dsb $$1, hg<dum> $$2, dud $$3, bgd $$4, float $$5, int $$6, float $$7, bgd $$8, float $$9) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
