...
public class emu implements dxm.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<emu> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ayr<emu> a = ayr.a(f);
   private final emy g;
   private final emy h;
   private final emy i;
   ...
   public static emu a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new emu(new dyu(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private emu(emy $$0, emy $$1, emy $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public emu(azg $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         emy.a($$0, IntStream.rangeClosed(-15, 0)),
         emy.a($$0, IntStream.rangeClosed(-15, 0)),
         emy.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public emu a(azg $$0) {
      return new emu($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dxm.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         emv $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(emy.b($$4 * $$13), emy.b($$5 * $$13), emy.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = emy.b($$1 * $$13);
         double $$21 = emy.b($$2 * $$13);
         double $$22 = emy.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            emv $$24 = this.g.a($$19);
            if ($$24 != null) {
