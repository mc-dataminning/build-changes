...
public abstract class cjb extends cgx implements bse, buz, bvn, bvq, bvw {
   ...
   private static final ajx<Byte> cz = akb.a(cjb.class, ajz.a);
   ...
   private final bsc cS = new fcm() {
      ...
      public boolean a(cox $$0) {
         return $$0.dl() == cjb.this || $$0.b(cjb.this, 4.0);
      }
   };

   protected cjb(bur<? extends cjb> $$0, dgi $$1) {
      super($$0, $$1);
      this.gO();
   }
   ...
   protected boolean f(bus $$0) {
      return $$0 == bus.g && this.gG() || super.f($$0);
   }
   ...
   public int u(int $$0) {
      int $$1 = ayz.a(this.gM() + $$0, 0, this.gS());
      this.t($$1);
      return $$1;
   }
   ...
   public static bwn.a gR() {
      return cgx.gu().a(bwo.o, 0.7).a(bwo.s, 53.0).a(bwo.v, 0.225F).a(bwo.B, 1.0).a(bwo.x, 6.0).a(bwo.k, 0.5);
   }
   ...
   public bsj c(cox $$0, cwp $$1) {
      boolean $$2 = this.a($$0, $$1);
      if ($$2) {
         $$1.a(1, $$0);
      }

      return (bsj)(!$$2 && !this.dW().C ? bsj.e : bsj.b);
   }
   ...
   public void d_() {
      ...
      if (this.dW() instanceof arc $$0 && this.bL()) {
         ...
         if (this.gT()) {
            if (!this.gJ() && !this.ca() && this.ae.a(300) == 0 && $$0.a_(this.dw().e()).a(djo.i)) {
               this.B(true);
            }
   ...
   protected void g(arc $$0) {
      if (this.gL() && this.e_() && !this.gJ()) {
         bvg $$1 = $$0.a(cjb.class, ci, this, this.dB(), this.dD(), this.dH(), this.cR().g(16.0));
   ...
   protected void b(float $$0, fba $$1) {
      ...
      this.ar = true;
      if ($$1.f > 0.0) {
         float $$4 = ayz.a(this.dM() * (float) (Math.PI / 180.0));
         float $$5 = ayz.b(this.dM() * (float) (Math.PI / 180.0));
   ...
   public void a(tq $$0) {
      ...
      if ($$0.b("SaddleItem", 10)) {
         cwp $$4 = cwp.a(this.dY(), (un)$$0.p("SaddleItem")).orElse(cwp.j);
         if ($$4.a(cwt.on)) {
            this.ct.a(0, $$4);
         }
      }
   ...
   @Override
   public fba b(bvg $$0) {
      fba $$1 = a((double)this.dr(), (double)$$0.dr(), this.dM() + ($$0.fy() == bva.b ? 90.0F : -90.0F));
      fba $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         fba $$3 = a((double)this.dr(), (double)$$0.dr(), this.dM() + ($$0.fy() == bva.a ? 90.0F : -90.0F));
         fba $$4 = this.a($$3, $$0);
   ...
   protected fba a(buk $$0, bun $$1, float $$2) {
      return super.a($$0, $$1, $$2)
         .e(new fba(0.0, 0.15 * (double)this.cO * (double)$$2, -0.7 * (double)this.cO * (double)$$2).b(-this.dM() * (float) (Math.PI / 180.0)));
   }
