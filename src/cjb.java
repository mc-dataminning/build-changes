...
public abstract class cjb extends cgx implements bse, buz, bvn, bvq, bvw {
   ...
   private static final cfx.a ch = ($$0, $$1) -> {
      if ($$0 instanceof cjb $$2 && $$2.gO()) {
         return true;
      }

      return false;
   };
   private static final cfx ci = cfx.b().a(16.0).d().a(ch);
   private static final ajy<Byte> cz = akc.a(cjb.class, aka.a);
   ...
   private final bsc cS = new fcl() {
      ...
      public boolean a(cow $$0) {
         return $$0.dk() == cjb.this || $$0.b(cjb.this, 4.0);
      }
   };

   protected cjb(bur<? extends cjb> $$0, dgh $$1) {
      super($$0, $$1);
      this.gR();
   }
   ...
   protected void E() {
      ...
      this.bS.a(2, new cbq(this, 1.0, cjb.class));
      this.bS.a(4, new ccd(this, 1.0));
      this.bS.a(6, new cdr(this, 0.7));
   ...
   protected void gK() {
      ...
      this.bS.a(3, new cdm(this, 1.25, $$0 -> $$0.a(awy.aj), false));
   }
   ...
   protected boolean f(bus $$0) {
      return $$0 == bus.g && this.gJ() || super.f($$0);
   }
   ...
   private boolean b(drd $$0) {
      return $$0 == drd.b || $$0 == drd.aT || $$0 == drd.B || $$0 == drd.aU || $$0 == drd.aS;
   }
   ...
   public static bwn.a gU() {
      return cgx.gx().a(bwo.o, 0.7).a(bwo.s, 53.0).a(bwo.v, 0.225F).a(bwo.B, 1.0).a(bwo.x, 6.0).a(bwo.k, 0.5);
   }
   ...
   public bsj c(cow $$0, cwo $$1) {
      boolean $$2 = this.a($$0, $$1);
      if ($$2) {
         $$1.a(1, $$0);
      }

      return (bsj)(!$$2 && !this.dV().C ? bsj.e : bsj.b);
   }
   ...
   public void d_() {
      ...
      if (this.dV() instanceof ard $$0 && this.bL()) {
         ...
         if (this.gW()) {
            if (!this.gM() && !this.ca() && this.ae.a(300) == 0 && $$0.a_(this.dv().e()).a(djn.i)) {
               this.B(true);
            }
   ...
   protected void g(ard $$0) {
      if (this.gO() && this.e_() && !this.gM()) {
         bvg $$1 = $$0.a(cjb.class, ci, this, this.dA(), this.dC(), this.dG(), this.cR().g(16.0));
   ...
   protected faz b(cow $$0, faz $$1) {
      if (this.aJ() && this.cv == 0.0F && this.gN() && !this.cw) {
         ...
         return new faz((double)$$2, 0.0, (double)$$3);
      }
   }
   ...
   public void a(tq $$0) {
      ...
      if ($$0.b("SaddleItem", 10)) {
         cwo $$4 = cwo.a(this.dX(), (un)$$0.p("SaddleItem")).orElse(cwo.j);
         if ($$4.a(cws.on)) {
            this.ct.a(0, $$4);
         }
      }
   ...
   protected void a(bub $$0, cjb $$1) {
      this.a($$0, $$1, bwo.s, (double)cd, (double)ce);
      this.a($$0, $$1, bwo.o, (double)ca, (double)cc);
      this.a($$0, $$1, bwo.v, (double)bY, (double)bZ);
   }

   private void a(bub $$0, cjb $$1, jr<bwj> $$2, double $$3, double $$4) {
   ...
   public bvy a_(int $$0) {
      ...
      if ($$1 == 0) {
         ...
         int $$2 = $$0 - 500 + 1;
         return $$2 >= 1 && $$2 < this.ct.b() ? bvy.a(this.ct, $$2) : super.a_($$0);
      }
   }
   ...
   private faz a(faz $$0, bvg $$1) {
      ...
      while (var10.hasNext()) {
         ...
         do {
            ...
            if (crb.a($$8)) {
               fau $$9 = $$1.f($$6);
               faz $$10 = new faz($$2, (double)$$5.v() + $$8, $$4);
               if (crb.a(this.dV(), $$1, $$9.c($$10))) {
                  $$1.b($$6);
                  return $$10;
               }
            }
   ...
   @Override
   public faz b(bvg $$0) {
      faz $$1 = a((double)this.dq(), (double)$$0.dq(), this.dL() + ($$0.fy() == bva.b ? 90.0F : -90.0F));
      faz $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         faz $$3 = a((double)this.dq(), (double)$$0.dq(), this.dL() + ($$0.fy() == bva.a ? 90.0F : -90.0F));
         faz $$4 = this.a($$3, $$0);
   ...
   protected faz a(buk $$0, bun $$1, float $$2) {
      return super.a($$0, $$1, $$2)
         .e(new faz(0.0, 0.15 * (double)this.cO * (double)$$2, -0.7 * (double)this.cO * (double)$$2).b(-this.dL() * (float) (Math.PI / 180.0)));
   }
