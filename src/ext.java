...
public final class ext implements AutoCloseable {
   ...
   public ext(int $$0, int $$1, boolean $$2) {
      this(ext.a.a, $$0, $$1, $$2);
   }

   public ext(ext.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private ext(ext.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static ext a(InputStream $$0) throws IOException {
      return a(ext.a.a, $$0);
   }

   public static ext a(@Nullable ext.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static ext a(ByteBuffer $$0) throws IOException {
      return a(ext.a.a, $$0);
   }

   public static ext a(byte[] $$0) throws IOException {
   ...
   public static ext a(@Nullable ext.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new ext($$0 == null ? ext.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public ext a(IntUnaryOperator $$0) {
      if (this.c != ext.a.a) {
         ...
         this.j();
         ext $$1 = new ext(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public void b(int $$0, int $$1, int $$2) {
      if (this.c != ext.a.a) {
         ...
         int $$3 = this.a($$0, $$1);
         float $$4 = (float)axo.a.a($$2) / 255.0F;
         float $$5 = (float)axo.a.d($$2) / 255.0F;
         float $$6 = (float)axo.a.c($$2) / 255.0F;
         float $$7 = (float)axo.a.b($$2) / 255.0F;
         float $$8 = (float)axo.a.a($$3) / 255.0F;
         float $$9 = (float)axo.a.d($$3) / 255.0F;
         float $$10 = (float)axo.a.c($$3) / 255.0F;
         float $$11 = (float)axo.a.b($$3) / 255.0F;
         float $$13 = 1.0F - $$4;
         float $$14 = $$4 * $$4 + $$8 * $$13;
         float $$15 = $$5 * $$4 + $$9 * $$13;
         float $$16 = $$6 * $$4 + $$10 * $$13;
         ...
         this.a($$0, $$1, axo.a.a($$18, $$19, $$20, $$21));
      }
   }
      ...
      if (this.c != ext.a.a) {
         ...
         for (int $$1 = 0; $$1 < this.b(); $$1++) {
            for (int $$2 = 0; $$2 < this.a(); $$2++) {
               int $$3 = this.a($$2, $$1);
               $$0[$$2 + $$1 * this.a()] = axo.b.a(axo.a.a($$3), axo.a.b($$3), axo.a.c($$3), axo.a.d($$3));
            }
         }
   ...
   public void a(FT_Face $$0, int $$1) {
      if (this.c.a() != 1) {
         ...
         fja.a(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph");
   ...
   public void a(ext $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, ext $$4) {
      this.j();
      if ($$4.c() != this.c) {
