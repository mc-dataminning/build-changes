...
public class ext extends eye {
   private static final Logger c = LogUtils.getLogger();
   public long a;
   public List<UUID> b;

   public static ext a(JsonObject $$0) {
      ext $$1 = new ext();

      try {
         $$1.a = fab.a("serverId", $$0, -1L);
         String $$2 = fab.b("playerList", $$0, null);
         if ($$2 != null) {
   ...
   private static List<UUID> a(JsonArray $$0) {
      ...
      for (JsonElement $$2 : $$0) {
         if ($$2.isJsonObject()) {
            UUID $$3 = fab.a("playerId", $$2.getAsJsonObject(), null);
            if ($$3 != null) {
               $$1.add($$3);
            }
         }
