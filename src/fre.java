...
public class fre implements ajx<cyf>, fiv, fjo, flm, frj {
   public static final fjf a = new fjf(new akk("recipe_book/button"), new akk("recipe_book/button_highlighted"));
   ...
   private int o;
   private int p;
   protected final frc e = new frc();
   private final List<frg> q = Lists.newArrayList();
   @Nullable
   private frg r;
   protected fiy f;
   protected cqv<?, ?> g;
   ...
   private String u = "";
   private ffg v;
   private final frf w = new frf();
   private final cmo x = new cmo();
   private int y;
   private boolean z;
   private boolean A;
   private boolean B;

   public void a(int $$0, int $$1, fft $$2, boolean $$3, cqv<?, ?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      this.s = new fib(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, wu.c("itemGroup.search"));
      this.s.f(50);
      this.s.g(true);
      this.s.g(16777215);
      this.s.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new fiy($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (fgb $$3 : fgb.a(this.g.t())) {
         this.q.add(new frg($$3));
      }
   ...
   private void b() {
      this.f.a(this.f.a() ? fjd.a(this.c()) : fjd.a(m));
   }
   ...
   private void c(boolean $$0) {
      List<fri> $$1 = this.v.a(this.r.b());
      $$1.forEach($$0x -> $$0x.a(this.x, this.g.n(), this.g.o(), this.v));
      List<fri> $$2 = Lists.newArrayList($$1);
      $$2.removeIf($$0x -> !$$0x.b());
      $$2.removeIf($$0x -> !$$0x.d());
      String $$3 = this.s.a();
      if (!$$3.isEmpty()) {
         fyk $$4 = this.h.L();
         if ($$4 != null) {
            ObjectSet<fri> $$5 = new ObjectLinkedOpenHashSet($$4.B().b().search($$3.toLowerCase(Locale.ROOT)));
   ...
   private void b(fhf $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fnj.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(fhf $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.f() && !this.h.s.N_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.cd.j, $$3, fnj.t());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   public void a(cyk<?> $$0, List<crd> $$1) {
      ...
      this.e.a($$0);
      this.e.a(cyf.a($$2), $$1.get(0).e, $$1.get(0).f);
      this.a(this.g.n(), this.g.o(), this.g.m(), $$0, $$0.b().a().iterator(), 0);
   }

   public void a(cyf $$0, int $$1, int $$2, int $$3, int $$4) {
      if (!$$0.c()) {
         crd $$5 = this.g.i.get($$1);
         this.e.a($$0, $$5.e, $$5.f);
      }
   }
   ...
   @Override
   public flm.a u() {
      return this.A ? flm.a.b : flm.a.a;
   }

   @Override
   public void b(flo $$0) {
      List<flm> $$1 = Lists.newArrayList();
      this.w.a($$1x -> {
         if ($$1x.C()) {
            $$1.add($$1x);
         }
