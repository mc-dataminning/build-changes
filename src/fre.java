...
public class fre implements fri.a {
   ...
   private final eqq J;
   private final Map<gw, fre.a> K = Maps.newHashMap();
   private final Map<UUID, vq.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bil $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dF();
      });
   }

   private void b(elk $$0, fnz $$1, double $$2, double $$3, double $$4) {
      gw $$5 = gw.a($$2, $$3, $$4);
   ...
   private void a(elk $$0, fnz $$1, fre.a $$2) {
      int $$3 = 0;
   ...
   private void a(elk $$0, fnz $$1, vq.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         frq.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(elk $$0, fnz $$1, vq.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(elk $$0, fnz $$1, String $$2, fre.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(fre.a $$0) {
      return this.b($$0.a).stream().map(aax::a).collect(Collectors.toSet());
   }

   private Set<String> c(fre.a $$0) {
      return this.c($$0.a).stream().map(aax::a).collect(Collectors.toSet());
   }

   private boolean b(vq.a $$0) {
      return Objects.equals(this.M, $$0.a());
   }

   private boolean c(vq.a $$0) {
      cbp $$1 = this.J.s;
      gw $$2 = gw.a($$1.dp(), $$0.h().b(), $$1.dv());
      gw $$3 = gw.a($$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(gw $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(vq.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(gw $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(vq.a::a).collect(Collectors.toSet());
   }

   private Map<gw, List<String>> c() {
      Map<gw, List<String>> $$0 = Maps.newHashMap();

      for (vq.a $$1 : this.L.values()) {
   ...
   private void d() {
      fri.a(this.J.am(), 8).ifPresent($$0 -> this.M = $$0.cv());
   }
