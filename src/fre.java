...
public class fre {
   ...
   final flj c;
   private final List<fre.a<?>> d = new ArrayList<>();
   private final BitSet e = new BitSet(5);
   private final Deque<frd> f = Queues.newArrayDeque();
   ...
   @Nullable
   public <T extends frd> T a(Class<? extends T> $$0, Object $$1) {
      for (fre.a<?> $$2 : this.d) {
   ...
   class a<T extends frd> {
      ...
      public void c() {
         ...
         if (this.f == -1L) {
            this.f = $$0;
            this.h.a(fre.this.c.ak());
         }

         if (this.h == frd.a.a && $$0 - this.f <= 600L) {
            this.g = $$0;
         }

         this.i = $$0 - this.g;
         this.a($$0);
         this.c.a(fre.this, this.i);
         frd.a $$1 = this.c.a();
         if ($$1 != this.h) {
         ...
         this.k = this.h == frd.a.b && $$0 - this.f > 600L;
      }

      public void a(foe $$0, int $$1) {
         $$0.c().a();
         $$0.c().a((float)$$1 - (float)this.c.b() * this.j, (float)(this.d * 32), 800.0F);
         this.c.a($$0, fre.this.c.h, this.i);
         $$0.c().b();
      }
   }
}
