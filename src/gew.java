...
public class gew {
   private final alf a;
   private final List<gew.b> b;

   public gew(alf $$0, List<gew.b> $$1) {
      this.a = $$0;
   ...
   protected static class a implements JsonDeserializer<gew> {
      public gew a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         List<gew.b> $$5 = this.a($$3);
         return new gew($$4, $$5);
      }

      protected List<gew.b> a(JsonObject $$0) {
         ...
         return $$1.entrySet().stream().map($$0x -> new gew.b((alf)$$0x.getKey(), (Float)$$0x.getValue())).collect(ImmutableList.toImmutableList());
      }
   }
