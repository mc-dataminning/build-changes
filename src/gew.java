...
public class gew implements fan, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final fal c = new fal();
   private static final boolean d = true;
   private static gew e;
   ...
   private final List<fat> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, fat> l = Maps.newHashMap();
   private final int m;
   ...
   public gew(aug $$0, String $$1) throws IOException {
      akt $$2 = new akt("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      aub $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         JsonArray $$13 = ayc.a($$5, "attributes", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         JsonArray $$18 = ayc.a($$5, "uniforms", null);
         if ($$18 != null) {
            int $$19 = 0;
         ...
         this.p = a(ayc.a($$5, "blend", null));
         this.s = a($$0, faq.a.a, $$6);
         this.t = a($$0, faq.a.b, $$7);
         this.m = far.a();
         far.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = fat.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static fao a(aug $$0, faq.a $$1, String $$2) throws IOException {
      faq $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof fao)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         fao $$7;
         if ($$3 == null) {
            akt $$4 = new akt("shaders/program/" + $$2 + $$1.b());
            aub $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static fam a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new fam();
      } else {
         int $$1 = 32774;
