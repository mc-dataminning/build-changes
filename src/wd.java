...
public class wd extends SimpleChannelInboundHandler<zq<?>> {
   ...
   private static final wr<ajc> j = ajb.b;
   private final zr k;
   ...
   public void channelInactive(ChannelHandlerContext $$0) {
      this.a(xj.c("disconnect.endOfStream"));
   }
      ...
      if ($$1 instanceof ww) {
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               i.debug("Timeout", $$1);
               this.a(xj.c("disconnect.timeout"));
            } else {
               xj $$3 = xj.a("disconnect.genericReason", "Internal Exception: " + $$1);
               wp $$4 = this.q;
               wf $$5;
               if ($$4 != null) {
                  $$5 = $$4.a($$3, $$1);
               ...
               if ($$2) {
                  ...
                  if (this.g() == zr.b) {
                     zq<?> $$7 = (zq<?>)(this.l ? new aji($$3) : new zz($$3));
                     this.a($$7, wq.a(() -> this.a($$5)));
                  } else {
                     this.a($$5);
                  }
   ...
   protected void a(ChannelHandlerContext $$0, zq<?> $$1) {
      if (this.n.isOpen()) {
         wp $$2 = this.q;
         if ($$2 == null) {
            ...
            if ($$2.a($$1)) {
               try {
                  ...
                  this.a(xj.c("multiplayer.disconnect.server_shutdown"));
               } catch (ClassCastException var7) {
                  i.error("Received {} that couldn't be processed", $$1.getClass(), var7);
                  this.a(xj.c("multiplayer.disconnect.invalid_packet"));
               }
   ...
   private static <T extends wp> void a(zq<T> $$0, wp $$1) {
      $$0.a((T)$$1);
   }

   private void b(wr<?> $$0, wp $$1) {
   ...
   public <T extends wp> void a(wr<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(wp $$0) {
      ...
      } else if (this.k == zr.a && $$0.a() == zr.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public void a(String $$0, int $$1, ake $$2) {
      this.a($$0, $$1, akk.b, akk.d, $$2, aiy.a);
   }

   public void a(String $$0, int $$1, aje $$2) {
      this.a($$0, $$1, ajl.b, ajl.d, $$2, aiy.b);
   }

   public <S extends wv, C extends wa> void a(String $$0, int $$1, wr<S> $$2, wr<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? aiy.c : aiy.b);
   }

   private <S extends wv, C extends wa> void a(String $$0, int $$1, wr<S> $$2, wr<C> $$3, C $$4, aiy $$5) {
      if ($$2.a() != $$3.a()) {
         ...
         this.a((Consumer<wd>)($$6 -> {
            this.a($$3, $$4);
            $$6.b(new aiz(ab.b().e(), $$0, $$1, $$5), null, true);
            this.a($$2);
         }));
      }
   }
   ...
   public void a(zq<?> $$0, @Nullable wq $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(zq<?> $$0, @Nullable wq $$1, boolean $$2) {
      this.v++;
   ...
   private void c(zq<?> $$0, @Nullable wq $$1, boolean $$2) {
   ...
   protected void c() {
      this.x = azm.h(0.75F, (float)this.v, this.x);
      this.w = azm.h(0.75F, (float)this.u, this.w);
      this.v = 0;
      this.u = 0;
   }
   ...
   public static wd a(InetSocketAddress $$0, boolean $$1, @Nullable bne $$2) {
      wd $$3 = new wd(zr.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static void a(ChannelPipeline $$0, zr $$1, boolean $$2, @Nullable vw $$3) {
      zr $$4 = $$1.a();
      boolean $$5 = $$1 == zr.a;
      boolean $$6 = $$4 == zr.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wn<ajc>(j) : new wy.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wo<ajc>(j) : new wy.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new wk() : new xd());
   }
   ...
   private static ChannelInboundHandler a(@Nullable vw $$0, boolean $$1) {
      if (!$$1) {
         ...
         return (ChannelInboundHandler)($$0 != null ? new wi($$0) : new wj());
      }
   }

   public static void a(ChannelPipeline $$0, zr $$1) {
      a($$0, $$1, true, null);
   }

   public static wd a(SocketAddress $$0) {
      final wd $$1 = new wd(zr.b);
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            wp $$0 = this.k();
            wp $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               wf $$2 = Objects.requireNonNullElseGet(this.l(), () -> new wf(xj.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
