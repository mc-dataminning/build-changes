...
public class fsl {
   ...
   public final fsl.b d;
   public final fsl.c e;

   public fsl(fsl.d $$0, eyk $$1, fsl.a $$2, fsl.b $$3, fsl.c $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static class a {
      ...
      public Path a() {
         return this.d == null ? this.c.toPath() : gpp.a(this.c.toPath(), this.d);
      }
   }
   ...
   public static record c(@Nullable String a, @Nullable String b, @Nullable String c, @Nullable String d) {
      public boolean a() {
         return !azq.h(this.b) || !azq.h(this.c) || !azq.h(this.d);
      }
   ...
   public static class d {
      ...
      public d(ffo $$0, PropertyMap $$1, PropertyMap $$2, Proxy $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
