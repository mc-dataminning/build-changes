public class fsl extends ftr {
   ...
   public fsl(Runnable $$0, fsl.a $$1, xv $$2, xv $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, a, $$4);
   }

   public fsl(Runnable $$0, fsl.a $$1, xv $$2, xv $$3, xv $$4, boolean $$5) {
      super($$2);
      this.u = $$0;
      this.b = $$1;
      this.v = $$3;
   ...
   protected void aT_() {
      ...
      int $$0 = (this.x.a() + 1) * 9;
      this.y = foa.a(xv.c("selectWorld.backupEraseCache"), this.p).a(this.n / 2 - 155 + 80, 76 + $$0).a();
      if (this.w) {
         this.c(this.y);
      }
      ...
      this.c(fny.a(xu.e, $$0x -> this.u.run()).a(this.n / 2 - 155 + 80, 124 + $$0, 150, 20).a());
   }
