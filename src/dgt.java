...
public class dgt {
   ...
   private final ht e;
   private final hx f;
   private final List<ht> g = Lists.newArrayList();
   private final List<ht> h = Lists.newArrayList();
   private final hx i;

   public dgt(crs $$0, ht $$1, hx $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dgw $$0 = this.b.a_(this.e);
      if (!dgp.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == ecl.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dgw $$0) {
      return $$0.a(cuv.hV) || $$0.a(cuv.pg);
   }

   private static boolean a(dgw $$0, dgw $$1) {
      if ($$0.a(cuv.pg) && $$1.a(cuv.hV)) {
         return false;
      } else {
         return $$0.a(cuv.hV) && $$1.a(cuv.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(ht $$0, hx $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dgp.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dgw $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dgp.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dgp.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
