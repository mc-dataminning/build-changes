...
public class dgt extends dfi {
   ...
   public dgt(hx $$0, dhn $$1) {
      super(dfk.p, $$0, $$1);
   }

   public static void a(final ahf $$0, Executor $$1) {
      c = $$1;
      ...
      d = CacheBuilder.newBuilder()
         ...
         .build(new CacheLoader<String, CompletableFuture<Optional<GameProfile>>>() {
            public CompletableFuture<Optional<GameProfile>> a(String $$0x) {
               return $$2.getAsBoolean() ? CompletableFuture.completedFuture(Optional.empty()) : dgt.a($$0, $$0, $$2);
            }
         });
   }
   ...
   static CompletableFuture<Optional<GameProfile>> a(String $$0, ahf $$1, BooleanSupplier $$2) {
   ...
   public void a(sd $$0) {
      ...
      if ($$0.b("note_block_sound", 8)) {
         this.g = agm.a($$0.l("note_block_sound"));
      }
   }

   public static void a(csf $$0, hx $$1, dhn $$2, dgt $$3) {
      if ($$2.b(dcg.a) && $$2.c(dcg.a)) {
         $$3.i = true;
         $$3.h++;
      } else {
         $$3.i = false;
   ...
   @Nullable
   public static GameProfile d(sd $$0) {
      if ($$0.b("SkullOwner", 10)) {
         return ss.a($$0.p("SkullOwner"));
      } else {
         if ($$0.b("SkullOwner", 8)) {
   ...
   private static void a(sd $$0, String $$1) {
      a($$1).thenAccept($$2 -> $$0.a("SkullOwner", ss.a(new sd(), $$2.orElse(new GameProfile(ac.d, $$1)))));
   }
   ...
   private static CompletableFuture<Optional<GameProfile>> a(String $$0) {
      ...
      return $$1 != null && cdz.c($$0) ? (CompletableFuture)$$1.getUnchecked($$0) : CompletableFuture.completedFuture(Optional.empty());
   }
