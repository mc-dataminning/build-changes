...
public class dil {
   ...
   public static jh a(List<dil.d> $$0, dil.f $$1) {
   ...
   public static record b(long b, long c) {
      public static final Codec<dil.b> a = azn.a(
   ...
   static class g {
      ...
      private static dil.g.a a(List<dil.d> $$0, dil.f $$1, int $$2, int $$3) {
         ...
         return new dil.g.a(new jh($$2, 0, $$3), $$9);
      }
