...
public class bud extends buk implements bwf {
   ...
   private static final ajy<Float> e = akc.a(bud.class, aka.d);
   private static final ajy<Boolean> f = akc.a(bud.class, aka.k);
   private static final ajy<lr> g = akc.a(bud.class, aka.l);
   ...
   public bud(bur<? extends bud> $$0, dgh $$1) {
      super($$0, $$1);
      this.ad = true;
   }

   public bud(dgh $$0, double $$1, double $$2, double $$3) {
      this(bur.d, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   private void s() {
      ...
      if ($$0 instanceof lm $$1) {
         int $$2 = this.k.equals(cyn.a) ? 0 : this.k.b();
         ...
         if (!$$2) {
            ...
            if (this.af % 5 == 0) {
               ...
               if (!this.k.c()) {
                  ...
                  $$4.addAll(this.k.d());
                  List<bvg> $$6 = this.dV().a(bvg.class, this.cR());
                  if (!$$6.isEmpty()) {
                     for (bvg $$7 : $$6) {
   ...
   protected void a(tq $$0) {
      ...
      if ($$0.e("potion_contents")) {
         cyn.c.parse($$1, $$0.c("potion_contents")).resultOrPartial($$0x -> c.warn("Failed to parse area effect cloud potions: '{}'", $$0x)).ifPresent(this::a);
      }
   }
   ...
   protected void b(tq $$0) {
      ...
      if (!this.k.equals(cyn.a)) {
         un $$2 = (un)cyn.c.encodeStart($$1, this.k).getOrThrow();
