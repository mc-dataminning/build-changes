...
public class goz extends gny<buu, guz> {
   public goz(gnz.a $$0) {
      super($$0);
   }

   public void a(guz $$0, fdt $$1, ghw $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(buu $$0, guz $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.b;
   }

   protected boolean a(buu $$0) {
      return false;
   }
}
