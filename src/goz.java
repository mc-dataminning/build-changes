...
public class goz {
   ...
   public void a(fgl $$0, gle $$1, double $$2, double $$3, double $$4) {
      gka $$5 = this.h.t;
      $$5.dV().a(bvm.r, $$5.cR().g(100.0), $$0x -> true).forEach($$6 -> {
         ...
         $$7.map(abe.a::d).map($$1xx -> $$5.dV().a($$1xx)).map($$0xx -> $$0xx.o(this.h.av().a(true))).ifPresent($$6x -> {
            ...
            fbs $$7x = $$6x.b(0.0, 0.01F, 0.0);
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(glo.a(2.0)), $$7x, 4.0F, c);
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(glo.a(2.0)), $$7x, 8.0F, d);
            a($$0.c().a(), $$2, $$3, $$4, $$1.getBuffer(glo.a(2.0)), $$7x, 24.0F, e);
         });
         $$7.map(abe.a::e).ifPresent($$6x -> {
            a($$0, $$1, $$2, $$3, $$4, $$6.dt(), $$6x.b(), a);
            gpe.a($$0, $$1, fbn.a(fbs.a($$6x)).d(-$$2, -$$3, -$$4), 1.0F, 0.0F, 0.0F, 1.0F);
         });
      });
   }

   private static void a(fgl $$0, gle $$1, double $$2, double $$3, double $$4, fbs $$5, fbs $$6, int $$7) {
      fgp $$8 = $$1.getBuffer(glo.a(2.0));
      $$8.a($$0.c(), (float)($$5.d - $$2), (float)($$5.e - $$3), (float)($$5.f - $$4)).a($$7);
      $$8.a($$0.c(), (float)($$6.d - $$2), (float)($$6.e - $$3), (float)($$6.f - $$4)).a($$7);
   }

   private static void a(Matrix4f $$0, double $$1, double $$2, double $$3, fgp $$4, fbs $$5, float $$6, int $$7) {
      for (int $$8 = 0; $$8 < 20; $$8++) {
         a($$8, $$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7);
      }
   ...
   private static void a(int $$0, Matrix4f $$1, double $$2, double $$3, double $$4, fgp $$5, fbs $$6, float $$7, int $$8) {
      float $$9 = (float)$$0 * (float) (Math.PI / 10);
      fbs $$10 = $$6.b((double)$$7 * Math.cos((double)$$9), 0.0, (double)$$7 * Math.sin((double)$$9));
