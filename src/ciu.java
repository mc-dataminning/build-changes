...
public class ciu extends ckc implements bub, ckg {
   private static final akj<Integer> b = akn.a(ciu.class, akl.b);
   private static final akj<Integer> c = akn.a(ciu.class, akl.b);
   private static final akj<Integer> d = akn.a(ciu.class, akl.b);
   private static final List<akj<Integer>> e = ImmutableList.of(b, c, d);
   private static final akj<Integer> bY = akn.a(ciu.class, akl.b);
   ...
   private int cg;
   private final arb ch = (arb)new arb(this.O_(), bqj.a.f, bqj.b.a).a(true);
   private static final Predicate<bto> ci = $$0 -> !$$0.ak().a(aws.y) && $$0.fH();
   private static final cef cj = cef.a().a(20.0).a(ci);

   public ciu(bsz<? extends ciu> $$0, dbx $$1) {
      super($$0, $$1);
   ...
   @Override
   public void n_() {
      evq $$0 = this.ds().d(1.0, 0.6, 1.0);
      if (!this.dP().B && this.u(0) > 0) {
         bst $$1 = this.dP().a(this.u(0));
         if ($$1 != null) {
            double $$2 = $$0.d;
            ...
            $$0 = new evq($$0.c, $$2, $$0.e);
            evq $$3 = new evq($$1.du() - this.du(), 0.0, $$1.dA() - this.dA());
            if ($$3.i() > 9.0) {
               evq $$4 = $$3.d();
      ...
      this.h($$0);
      if ($$0.i() > 0.05) {
         this.r((float)ayy.d($$0.e, $$0.c) * (180.0F / (float)Math.PI) - 90.0F);
      }
   ...
   protected void Z() {
      if (this.y() > 0) {
         ...
         if ($$0 <= 0) {
            this.dP().a(this, this.du(), this.dy(), this.dA(), 7.0F, false, dbx.a.c);
            if (!this.aW()) {
         ...
         for (int $$1 = 1; $$1 < 3; $$1++) {
            if (this.ai >= this.ce[$$1 - 1]) {
               ...
               if ((this.dP().al() == bqq.c || this.dP().al() == bqq.d) && this.cf[$$1 - 1]++ > 15) {
                  float $$2 = 10.0F;
                  float $$3 = 5.0F;
                  double $$4 = ayy.a(this.ah, this.du() - 10.0, this.du() + 10.0);
                  double $$5 = ayy.a(this.ah, this.dw() - 5.0, this.dw() + 5.0);
                  double $$6 = ayy.a(this.ah, this.dA() - 10.0, this.dA() + 10.0);
               ...
               int $$7 = this.u($$1);
               if ($$7 > 0) {
                  bto $$8 = (bto)this.dP().a($$7);
                  if ($$8 != null && this.c($$8) && !(this.g((bst)$$8) > 900.0) && this.E($$8)) {
                     this.a($$1 + 1, $$8);
                  ...
                  List<bto> $$9 = this.dP().a(bto.class, cj, this, this.cK().c(20.0, 8.0, 20.0));
                  if (!$$9.isEmpty()) {
                     bto $$10 = $$9.get(this.ah.a($$9.size()));
                     this.a($$1, $$10.al());
                  }
               }
            }
         ...
         if (this.cg > 0) {
            this.cg--;
            if (this.cg == 0 && this.dP().ab().b(dbt.c)) {
               boolean $$11 = false;
               int $$12 = ayy.d(this.dj() / 2.0F + 1.0F);
               int $$13 = ayy.d(this.dk());

               for (iz $$14 : iz.b(this.dt() - $$12, this.dv(), this.dz() - $$12, this.dt() + $$12, this.dv() + $$13, this.dz() + $$12)) {
                  dsb $$15 = this.dP().a_($$14);
                  if (d($$15)) {
   ...
   private void a(int $$0, double $$1, double $$2, double $$3, boolean $$4) {
      ...
      double $$9 = $$2 - $$6;
      double $$10 = $$3 - $$7;
      coc $$11 = new coc(this.dP(), this, $$8, $$9, $$10);
      $$11.c(this);
      if ($$4) {
         $$11.a(true);
      }
   ...
   public boolean a(brm $$0, float $$1) {
      if (this.b($$0)) {
         return false;
      } else if ($$0.a(awq.u) || $$0.d() instanceof ciu) {
         return false;
         ...
         if (this.a()) {
            bst $$2 = $$0.c();
            if ($$2 instanceof cnc || $$2 instanceof cog) {
               return false;
            }
         }
   ...
   public static buv.a u() {
      return ckc.gw().a(buw.q, 300.0).a(buw.r, 0.6F).a(buw.j, 0.6F).a(buw.k, 40.0).a(buw.a, 4.0);
   }
