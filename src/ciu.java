...
public abstract class ciu extends bsp {
   private static final Logger e = LogUtils.getLogger();
   protected static final Predicate<bsp> b = $$0 -> $$0 instanceof ciu;
   private int f;
   protected iz c;
   protected je d;

   protected ciu(bsv<? extends ciu> $$0, dbt $$1) {
      super($$0, $$1);
      this.d = je.d;
   }

   protected ciu(bsv<? extends ciu> $$0, dbt $$1, iz $$2) {
      this($$0, $$1);
      this.c = $$2;
   }
   ...
   protected void y() {
      if (this.d != null) {
         ...
         $$8 /= 32.0;
         $$9 /= 32.0;
         this.a(new evh($$0 - $$7, $$1 - $$8, $$2 - $$9, $$0 + $$7, $$1 + $$8, $$2 + $$9));
      }
   }
   ...
   @Override
   public void a(ur $$0) {
      iz $$1 = new iz($$0.h("TileX"), $$0.h("TileY"), $$0.h("TileZ"));
      if (!$$1.a(this.dp(), 16.0)) {
   ...
   public abstract void b(@Nullable bsp var1);
