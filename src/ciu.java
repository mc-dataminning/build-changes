...
public class ciu extends cht implements bww, cna {
   ...
   public void d_() {
      ...
      if (this.dW() instanceof ash $$0) {
         ...
         for (int $$2 = 0; $$2 < 4; $$2++) {
            ...
            jh $$6 = new jh($$3, $$4, $$5);
            if (this.dW().a_($$6).l() && $$1.a((dhk)this.dW(), $$6)) {
               this.dW().b($$6, $$1);
               this.dW().a(ecq.i, $$6, ecq.a.a(this, $$1));
            }
         }
      }
   }
   ...
   public void a(bwf $$0, float $$1) {
      ...
      if (this.dW() instanceof ash $$6) {
         ...
         cqp.a(new cqu($$6, this, $$7), $$6, $$7, $$4x -> $$4x.c($$2, $$3 + $$5 - $$4x.dD(), $$4, 1.6F, 12.0F));
      }
   ...
   @Override
   public fbx cT() {
      return new fbx(0.0, (double)(0.75F * this.cS()), (double)(this.dr() * 0.4F));
   }
}
