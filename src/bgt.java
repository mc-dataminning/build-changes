...
public class bgt extends DataFix {
   ...
   public bgt(Schema $$0, String $$1, Map<String, String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getOutputSchema().getType(bgf.F);
      Type<?> $$1 = this.getInputSchema().getType(bgf.F);
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(bgf.g);
      Type<?> $$1 = this.getInputSchema().getType(bgf.g);
