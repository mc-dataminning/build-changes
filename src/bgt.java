...
public class bgt {
   ...
   private JsonElement a(List<Pair<dkq, bhd<bgv>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bhd)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dkq, bhd<bgv>> $$3 : $$0) {
         bhd<bgv> $$4 = (bhd<bgv>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dkq)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bhb> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bgj.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bgr $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bgz $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bgz.b $$3 = (bgz.b)$$1x.getFirst();
         bgz.a $$4 = (bgz.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bgw> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bgw>, ToDoubleFunction<bgw>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bgw::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bgw::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bgw::c));
      return $$1;
   }
}
