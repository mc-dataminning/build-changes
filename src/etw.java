...
public abstract class etw<T extends etw<T>> {
   ...
   public etw(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = etu.a();
         if ($$3 != null) {
         ...
         throw new evf(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new evf(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new evf(var2.getMessage(), var2);
      }
   }
   ...
   public static etw<?> a(String $$0) {
      return new etw.b($$0, 5000, 60000);
   }

   public static etw<?> a(String $$0, int $$1, int $$2) {
      return new etw.b($$0, $$1, $$2);
   }

   public static etw<?> b(String $$0, String $$1) {
      return new etw.c($$0, $$1, 5000, 60000);
   }

   public static etw<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new etw.c($$0, $$1, $$2, $$3);
   }

   public static etw<?> b(String $$0) {
      return new etw.a($$0, 5000, 60000);
   }

   public static etw<?> c(String $$0, String $$1) {
      return new etw.d($$0, $$1, 5000, 60000);
   }

   public static etw<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new etw.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends etw<etw.a> {
   ...
   public static class b extends etw<etw.b> {
   ...
   public static class c extends etw<etw.c> {
      ...
      public etw.c f() {
         try {
            ...
            throw new evf(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends etw<etw.d> {
      private final String c;
