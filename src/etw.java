...
public class etw {
   ...
   public Optional<ji> a(ji $$0, boolean $$1, dym $$2) {
      cgk $$3 = this.n.A();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(cgo.r), $$0, $$4, cgk.b.c)
         .map(cgl::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(dxm.K))
   ...
   public Optional<l.a> a(ji $$0, jn.a $$1) {
      ...
      for (ji.a $$11 : ji.a($$0, 16, jn.f, jn.d)) {
         int $$12 = Math.min($$8, this.n.a(ecr.a.e, $$11.u(), $$11.w()));
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, djn.cv.m(), 3);
            }
         }
      }

      dww $$26 = djn.eq.m().b(dos.b, $$1);
