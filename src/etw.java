...
public class etw extends gld {
   ...
   private static final vg z = vg.c("mco.upload.verifying");
   private final etp A;
   private final egw B;
   ...
   private volatile vg H = vg.c("mco.upload.preparing");
   ...
   public etw(long $$0, int $$1, etp $$2, egw $$3) {
      super(evj.a);
      this.C = $$0;
      this.D = $$1;
      this.A = $$2;
   ...
   @Override
   public void aP_() {
      this.N = this.d(exr.a(vf.k, $$0 -> this.E()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.N.k = false;
      this.O = this.d(exr.a(vf.e, $$0 -> this.H()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.M) {
         if (this.A.b == -1) {
            this.J();
         } else {
   ...
   private void E() {
      this.f.a(new eta(new eqv(new fdr()), this.C));
   }
   ...
   private void d(exe $$0) {
      ...
      $$0.a(this.i, vg.a("mco.upload.percent", this.I), this.g / 2, 84, 16777215);
   }

   private void e(exe $$0) {
      if (this.P % 20 == 0) {
         if (this.Q != null) {
            long $$1 = ac.b() - this.R;
            if ($$1 == 0L) {
   ...
   private vg I() {
      List<vg> $$0 = Lists.newArrayList();
      $$0.add(this.H);
      if (this.I != null) {
         $$0.add(vg.a("mco.upload.percent", this.I));
      }
            ...
            () -> {
               ...
               try {
                  if (!b.tryLock(1L, TimeUnit.SECONDS)) {
                     this.H = vg.c("mco.upload.close.failure");
                  } else {
                     esf $$3 = null;
                     ...
                     if ($$3 == null) {
                        ...
                        if (!$$3.c()) {
                           ...
                           if (this.J) {
                              ...
                              this.H = vg.a("mco.upload.uploading", this.B.b());
                              eqy $$11 = new eqy($$0, this.C, this.D, $$3, this.f.V(), aa.b().c(), this.E);
                              $$11.a($$1x -> {
                                 if ($$1x.a >= 200 && $$1x.a < 300) {
                                    this.K = true;
                                    this.H = vg.c("mco.upload.done");
                                    this.N.b(vf.d);
                                    euj.b($$2);
                                 } else if ($$1x.a == 400 && $$1x.b != null) {
                                    this.a(vg.a("mco.upload.failed", $$1x.b));
                                 } else {
                                    this.a(vg.a("mco.upload.failed", $$1x.a));
                                 }
                              });
                              ...
                              long $$7 = $$0.length();
                              eqw $$8 = eqw.a($$7);
                              eqw $$9 = eqw.a(5368709120L);
                              if (eqw.b($$7, $$8).equals(eqw.b(5368709120L, $$9)) && $$8 != eqw.a) {
                                 eqw $$10 = eqw.values()[$$8.ordinal() - 1];
                                 this.a(
                                    vg.a("mco.upload.size.failure.line1", this.B.b()),
                                    vg.a("mco.upload.size.failure.line2", eqw.b($$7, $$10), eqw.b(5368709120L, $$10))
                                 );
                              } else {
                                 this.a(
                                    vg.a("mco.upload.size.failure.line1", this.B.b()),
                                    vg.a("mco.upload.size.failure.line2", eqw.b($$7, $$8), eqw.b(5368709120L, $$9))
                                 );
                              }
                           }
                        }
                  ...
                  this.a(vg.a("mco.upload.failed", var21.getMessage()));
               } catch (esn var22) {
                  this.a(vg.a("mco.upload.failed", var22.a.b()));
   ...
   private void K() {
      this.H = vg.c("mco.upload.cancelled");
