...
public class abv implements yw<abl> {
   ...
   public static abv b(brz $$0) {
      return new abv($$0.h(), new abv.f($$0.j()));
   }

   public static abv c(brz $$0) {
      return new abv($$0.h(), new abv.e($$0.i()));
   }

   public static abv d(brz $$0) {
      return new abv($$0.h(), new abv.h($$0.k(), $$0.l()));
   }

   public static abv e(brz $$0) {
   ...
   public interface b {
      default void a(UUID $$0, wp $$1, float $$2, brz.a $$3, brz.b $$4, boolean $$5, boolean $$6, boolean $$7) {
      }
