...
public class ph implements me {
   private final mg d;
   private final CompletableFuture<jr.a> e;

   public ph(mg $$0, CompletableFuture<jr.a> $$1) {
      this.e = $$1;
      this.d = $$0;
   }
   ...
   public CompletableFuture<?> a(mc $$0) {
      return this.e.thenCompose($$1 -> {
         ...
         return CompletableFuture.allOf(alc.a.stream().flatMap($$3 -> this.a($$0, $$1, $$2, (alc.d<?>)$$3).stream()).toArray(CompletableFuture[]::new));
      });
   }

   private <T> Optional<CompletableFuture<?>> a(mc $$0, jr.a $$1, DynamicOps<JsonElement> $$2, alc.d<T> $$3) {
      alg<? extends kc<T>> $$4 = $$3.a();
      return $$1.a($$4).map($$4x -> {
         mg.a $$5 = this.d.a($$4);
