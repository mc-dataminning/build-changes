...
public class bmh extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bmk.a(new Dynamic($$0, $$1), bmh.a, bmk.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bhm.s.typeName()) ? super.getChoiceType($$0, biz.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bhm.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bhm.s, () -> DSL.optionalFields("components", bhm.w.in($$0), DSL.taggedChoiceLazy("id", biz.a(), $$2)));
      $$0.registerType(
         true,
         bhm.t,
         () -> DSL.hook(
