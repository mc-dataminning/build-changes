...
public class ftk implements hnr {
   private static final long a = 3000L;
   private final fos b;
   private final List<ftk.b> c = Lists.newArrayList();
   private boolean d;
   private final List<ftk.b> e = new ArrayList<>();
   ...
   public void a(fro $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<ftk.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hmm $$0, hnt $$1, float $$2) {
      if ($$1.a() != null) {
         wy $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (ftk.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new fei($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new ftk.b($$3, $$2, new fei($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(fei a, long b) {
   }

   static class b {
      private final wy a;
      private final float b;
      private final List<ftk.a> c = new ArrayList<>();

      public b(wy $$0, float $$1, fei $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new ftk.a($$2, af.c()));
      }
      ...
      public void b(fei $$0) {
         ...
         this.c.add(new ftk.a($$0, af.c()));
      }

      public boolean c(fei $$0) {
