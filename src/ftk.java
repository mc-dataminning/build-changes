...
public class ftk extends ftz {
   ...
   ftk(fpx $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   public static class a implements ftc<kb> {
      private final ftu a;
      ...
      public fsz a(kb $$0, fpx $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ftk $$8 = new ftk($$1, $$2, $$3, $$4, $$0.c());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
