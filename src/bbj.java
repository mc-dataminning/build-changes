...
public class bbj extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      TaggedChoiceType<?> $$1 = this.getInputSchema().findChoiceType(bhs.s);
   ...
   private Typed<?> a(Typed<?> $$0, OpticFinder<?> $$1) {
      ...
      boolean $$4 = $$3.asString().result().flatMap(bar::a).filter($$0x -> $$0x.equals("block.minecraft.ominous_banner")).isPresent();
      if ($$4) {
