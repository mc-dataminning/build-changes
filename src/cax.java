...
public class cax extends cap {
   ...
   protected final Class<? extends btr> f;
   protected final cei g;

   public cax(btt $$0, Class<? extends btr> $$1, float $$2) {
      this($$0, $$1, $$2, 0.02F);
   }

   public cax(btt $$0, Class<? extends btr> $$1, float $$2, float $$3) {
      this($$0, $$1, $$2, $$3, false);
   }

   public cax(btt $$0, Class<? extends btr> $$1, float $$2, float $$3, boolean $$4) {
      this.b = $$0;
      this.f = $$1;
      this.d = $$2;
      this.e = $$3;
      ...
      if ($$1 == cmz.class) {
         this.g = cei.b().a((double)$$2).a($$1x -> btb.b($$0).test($$1x));
      } else {
         this.g = cei.b().a((double)$$2);
      }
   }
