...
public class cax {
   ...
   private int g = arx.b(asc.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(ia.a.fieldOf("uuid").forGetter(Pair::getFirst), arg.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<biq> j;
   @VisibleForTesting
   protected final ArrayList<biq> c;
   private final cax.a k;
   @VisibleForTesting
   protected final Object2IntMap<biq> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cax> a(Predicate<biq> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cax::b)).apply($$1, $$1x -> new cax($$0, $$1x))
      );
   }

   public cax(Predicate<biq> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cax.a(this);
   ...
   public void a(akr $$0, Predicate<biq> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<biq>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<biq> $$6 = (Entry<biq>)$$5.next();
         int $$7 = $$6.getIntValue();
         biq $$8 = (biq)$$6.getKey();
         biq.c $$9 = $$8.dH();
   ...
   public int b(@Nullable biq $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bjg> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bjg).map($$0 -> (bjg)$$0);
   }

   @VisibleForTesting
   protected static record a(cax a) implements Comparator<biq> {
      public int a(biq $$0, biq $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cbu;
               boolean $$7 = $$1 instanceof cbu;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
