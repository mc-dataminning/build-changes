...
public abstract class cax extends cak {
   ...
   public cax(btu $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public cax(btu $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(cak.a.a, cak.a.c));
   }
   ...
   protected abstract boolean a(dcx var1, jd var2);
}
