...
public class cax {
   ...
   private int g = arw.b(asc.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(hx.a.fieldOf("uuid").forGetter(Pair::getFirst), arf.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   ...
   public void a(akq $$0, Predicate<biq> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
