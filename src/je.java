...
public class je extends ki {
   public static final Codec<je> a = Codec.INT_STREAM
      .comapFlatMap($$0 -> ad.a($$0, 3).map($$0x -> new je($$0x[0], $$0x[1], $$0x[2])), $$0 -> IntStream.of($$0.u(), $$0.v(), $$0.w()))
      .stable();
   public static final zb<ByteBuf, je> b = new zb<ByteBuf, je>() {
   ...
   public static long a(long $$0, jj $$1) {
   ...
   public static je d(long $$0) {
      return new je(a($$0), b($$0), c($$0));
   }
   ...
   public static je a(je $$0, je $$1) {
      return new je(Math.min($$0.u(), $$1.u()), Math.min($$0.v(), $$1.v()), Math.min($$0.w(), $$1.w()));
   }

   public static je b(je $$0, je $$1) {
      return new je(Math.max($$0.u(), $$1.u()), Math.max($$0.v(), $$1.v()), Math.max($$0.w(), $$1.w()));
   }
   ...
   public je a(int $$0) {
      if ($$0 == 1) {
         ...
         return $$0 == 0 ? c : new je(this.u() * $$0, this.v() * $$0, this.w() * $$0);
      }
   }
   ...
   public je g(int $$0) {
      return this.a(jj.f, $$0);
   }

   public je a(jj $$0) {
      return new je(this.u() + $$0.j(), this.v() + $$0.k(), this.w() + $$0.l());
   }

   public je a(jj $$0, int $$1) {
      return $$1 == 0 ? this : new je(this.u() + $$0.j() * $$1, this.v() + $$0.k() * $$1, this.w() + $$0.l() * $$1);
   }

   public je a(jj.a $$0, int $$1) {
      if ($$1 == 0) {
         return this;
      } else {
         int $$2 = $$0 == jj.a.a ? $$1 : 0;
         int $$3 = $$0 == jj.a.b ? $$1 : 0;
         int $$4 = $$0 == jj.a.c ? $$1 : 0;
         return new je(this.u() + $$2, this.v() + $$3, this.w() + $$4);
      }
   }
   ...
   public je a(dnx $$0) {
      switch ($$0) {
         ...
         default:
            return this;
         case b:
            return new je(-this.w(), this.v(), this.u());
         case c:
            return new je(-this.u(), this.v(), -this.w());
         case d:
            return new je(this.w(), this.v(), -this.u());
      }
   }
   ...
   public je c(ki $$0) {
      return new je(this.v() * $$0.w() - this.w() * $$0.v(), this.w() * $$0.u() - this.u() * $$0.w(), this.u() * $$0.v() - this.v() * $$0.u());
   }

   public je h(int $$0) {
      return new je(this.u(), $$0, this.w());
   }
   ...
   @Deprecated
   public static Stream<je> a(je $$0) {
   ...
   public static Iterable<je> a(azl $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      ...
      int $$9 = $$6 - $$3 + 1;
      int $$10 = $$7 - $$4 + 1;
      return () -> new AbstractIterator<je>() {
            final je.a a = new je.a();
            int b = $$1;

            protected je a() {
               if (this.b <= 0) {
                  return (je)this.endOfData();
               } else {
                  je $$0 = this.a.d($$2 + $$0.a($$8), $$3 + $$0.a($$9), $$4 + $$0.a($$10));
                  this.b--;
                  return $$0;
               }
            }
   ...
   public static Iterable<je> a(je $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$1 + $$2 + $$3;
      int $$5 = $$0.u();
      int $$6 = $$0.v();
      int $$7 = $$0.w();
      return () -> new AbstractIterator<je>() {
            private final je.a h = new je.a();
            private int i;
            private int j;
            private int k;
            private int l;
   ...
   public static Optional<je> a(je $$0, int $$1, int $$2, Predicate<je> $$3) {
      for (je $$4 : a($$0, $$1, $$2, $$1)) {
         if ($$3.test($$4)) {
   ...
   public static Stream<je> b(je $$0, int $$1, int $$2, int $$3) {
   ...
   public static Iterable<je> c(je $$0, je $$1) {
      return b(
         Math.min($$0.u(), $$1.u()),
         Math.min($$0.v(), $$1.v()),
         Math.min($$0.w(), $$1.w()),
   ...
   public static Stream<je> d(je $$0, je $$1) {
   ...
   public static Iterable<je> b(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$3 - $$0 + 1;
      int $$7 = $$4 - $$1 + 1;
      int $$8 = $$5 - $$2 + 1;
      int $$9 = $$6 * $$7 * $$8;
   ...
   public static Iterable<je.a> a(je $$0, int $$1, jj $$2, jj $$3) {
      Validate.validState($$2.o() != $$3.o(), "The two directions cannot be on the same axis", new Object[0]);
      return () -> new AbstractIterator<je.a>() {
            private final jj[] e = new jj[]{$$2, $$3, $$2.g(), $$3.g()};
            private final je.a f = $$0.k().c($$3);
   ...
   public static int a(je $$0, int $$1, int $$2, BiConsumer<je, Consumer<je>> $$3, Predicate<je> $$4) {
      Queue<Pair<je, Integer>> $$5 = new ArrayDeque<>();
      LongSet $$6 = new LongOpenHashSet();
      $$5.add(Pair.of($$0, 0));
      int $$7 = 0;

      while (!$$5.isEmpty()) {
         Pair<je, Integer> $$8 = $$5.poll();
         je $$9 = (je)$$8.getLeft();
   ...
   public static class a extends je {
      ...
      public je.a d(int $$0, int $$1, int $$2) {
         this.p($$0);
         this.q($$1);
         this.r($$2);
         return this;
      ...
      public je.a f(long $$0) {
         return this.d(a($$0), b($$0), c($$0));
      }

      public je.a a(jb $$0, int $$1, int $$2, int $$3) {
         return this.d($$0.a($$1, $$2, $$3, jj.a.a), $$0.a($$1, $$2, $$3, jj.a.b), $$0.a($$1, $$2, $$3, jj.a.c));
      }

      public je.a a(ki $$0, jj $$1) {
         return this.d($$0.u() + $$1.j(), $$0.v() + $$1.k(), $$0.w() + $$1.l());
      }

      public je.a a(ki $$0, int $$1, int $$2, int $$3) {
         return this.d($$0.u() + $$1, $$0.v() + $$2, $$0.w() + $$3);
      }

      public je.a a(ki $$0, ki $$1) {
      ...
      public je.a c(jj $$0, int $$1) {
         return this.d(this.u() + $$0.j() * $$1, this.v() + $$0.k() * $$1, this.w() + $$0.l() * $$1);
      }

      public je.a e(int $$0, int $$1, int $$2) {
