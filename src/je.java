...
public final class je {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ac.a($$0, 4).map(je::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static xq<ByteBuf, UUID> g = new xq<ByteBuf, UUID>() {
