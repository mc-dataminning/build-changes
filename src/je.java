...
public class je extends jg {
   ...
   public static je a(ib $$0) {
      return new je(a($$0.u()), a($$0.v()), a($$0.w()));
   }

   public static je a(cwg $$0, int $$1) {
      return new je($$0.e, $$1, $$0.f);
   }

   public static je a(dqu $$0) {
      return a($$0.dm());
   }

   public static je a(iv $$0) {
      return new je(b($$0.a()), b($$0.b()), b($$0.c()));
   }

   public static je a(long $$0) {
      return new je(b($$0), c($$0), d($$0));
   }

   public static je a(dov $$0) {
      return a($$0.f(), $$0.am());
   }
   ...
   public je d(int $$0, int $$1, int $$2) {
      return $$0 == 0 && $$1 == 0 && $$2 == 0 ? this : new je(this.a() + $$0, this.b() + $$1, this.c() + $$2);
   }
   ...
   public static Stream<je> a(je $$0, int $$1) {
      int $$2 = $$0.a();
      int $$3 = $$0.b();
      int $$4 = $$0.c();
   ...
   public static Stream<je> a(cwg $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$0.e;
      int $$5 = $$0.f;
      return a($$4 - $$1, $$2, $$5 - $$1, $$4 + $$1, $$3 - 1, $$5 + $$1);
   }

   public static Stream<je> a(final int $$0, final int $$1, final int $$2, final int $$3, final int $$4, final int $$5) {
      return StreamSupport.stream(new AbstractSpliterator<je>((long)(($$3 - $$0 + 1) * ($$4 - $$1 + 1) * ($$5 - $$2 + 1)), 64) {
         final id a = new id($$0, $$1, $$2, $$3, $$4, $$5);

         @Override
         public boolean tryAdvance(Consumer<? super je> $$0x) {
            if (this.a.a()) {
               $$0.accept(new je(this.a.b(), this.a.c(), this.a.d()));
               return true;
            } else {
               return false;
            }
