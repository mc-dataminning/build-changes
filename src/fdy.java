...
public class fdy extends fdn implements fes {
   private static final ffc d = new ffc(new ajt("widget/text_field"), new ajt("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, aww> D = ($$0x, $$1x) -> aww.forward($$0x, xd.a);
   @Nullable
   private wg E;
   private long F = ac.b();

   public fdy(fda $$0, int $$1, int $$2, wg $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fdy(fda $$0, int $$1, int $$2, int $$3, int $$4, wg $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fdy(fda $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fdy $$5, wg $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, aww> $$0) {
      this.D = $$0;
   }
   ...
   protected wu aL_() {
      wg $$0 = this.y();
      return wg.a("gui.narrate.editBox", $$0, this.p);
   }
   ...
   public void e(int $$0) {
      this.w = axk.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = axk.a($$0) - this.C();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fjo.s());
   }
   ...
   public void b(fdc $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         ...
         boolean $$9 = this.aJ_() && (ac.b() - this.F) / 300L % 2L == 0L && $$8;
         int $$10 = this.r ? this.C() + 4 : this.C();
         int $$11 = this.r ? this.D() + (this.h - 8) / 2 : this.D();
         int $$12 = $$10;
         int $$13 = axk.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(gah.E(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = axk.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = axk.a(this.v, 0, this.p.length());
      }
   }
