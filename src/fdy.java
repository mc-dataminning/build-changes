...
public abstract class fdy<T extends cia> extends fcz implements ffd<T> {
   ...
   public static void a(ews $$0, int $$1, int $$2, int $$3) {
      $$0.a(ftn.C(), $$1, $$2, $$1 + 16, $$2 + 16, -2130706433, -2130706433, $$3);
   }
   ...
   private void a(ews $$0, cmx $$1, int $$2, int $$3, String $$4) {
      $$0.c().a();
   ...
   protected abstract void a(ews var1, float var2, int var3, int var4);

   protected void a(ews $$0, cjv $$1) {
      int $$2 = $$1.f;
      int $$3 = $$1.g;
      cmx $$4 = $$1.g();
      boolean $$5 = false;
      ...
      if ($$4.b() && $$1.d()) {
         Pair<ahg, ahg> $$12 = $$1.c();
         if ($$12 != null) {
            gel $$13 = this.f.a((ahg)$$12.getFirst()).apply((ahg)$$12.getSecond());
            $$0.a($$2, $$3, 0, 16, 16, $$13);
            $$6 = true;
         }
      }
               ...
               if (this.f.m.W().c()) {
                  ...
                  if (this.p.g().b()) {
                     if ($$3) {
                        ...
                        boolean $$10 = $$9 != -999 && (eou.a(evg.O().aM().i(), 340) || eou.a(evg.O().aM().i(), 344));
                        cij $$11 = cij.a;
                        if ($$10) {
      ...
      if (this.R && $$3 != null && $$2 == 0 && this.p.a(cmx.f, $$3)) {
         ...
         if (this.A != null && this.f.m.W().c()) {
            ...
            if (this.f.m.J.a($$2)) {
               ...
               boolean $$11 = $$7 != -999 && (eou.a(evg.O().aM().i(), 340) || eou.a(evg.O().aM().i(), 344));
               if ($$11) {
      ...
      if (super.a($$0, $$1, $$2)) {
         ...
         if (this.r != null && this.r.h()) {
            if (this.f.m.J.a($$0, $$1)) {
               ...
               this.a(this.r, this.r.e, r() ? 1 : 0, cij.e);
            }
         }
