...
public class fdy {
   ...
   public static List<fdy.a> a(String $$0, fdy.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fdy.a> a(String $$0, List<fdy.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fdy.a> a(List<String> $$0, List<fdy.b> $$1) {
      int $$2 = 0;
      List<fdy.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fdy.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fdy.b a(String $$0, String $$1) {
         return new fdy.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fdy.b a(String $$0) {
         return new fdy.b($$0);
      }
   }
}
