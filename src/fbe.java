...
public interface fbe {
      ...
      if ($$0 == 429) {
         ...
         try {
            ...
            if ($$4 != null || $$3 != null || $$5 != -1) {
               return new fbe.c($$0, $$5 != -1 ? $$5 : $$0, $$3, $$4);
            }
         } catch (Exception var6) {
            b.error("Could not parse RealmsError", var6);
         }

         return new fbe.d($$0, $$1);
      }
   }

   public static record a(String d) implements fbe {
   ...
   public static record b(int e, @Nullable wu f) implements fbe {
      public static final fbe.b c = new fbe.b(429, wu.c("mco.errorMessage.serviceBusy"));
      public static final wu d = wu.c("mco.errorMessage.retry");

      public static fbe.b a(String $$0) {
         return new fbe.b(500, wu.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fbe.b a(fco $$0) {
         return new fbe.b(500, wu.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }

      public static fbe.b a(int $$0) {
         return new fbe.b($$0, d);
      }

      public static fbe.b b(int $$0) {
         return new fbe.b($$0, null);
      }
   ...
   public static record c(int c, int d, @Nullable String e, @Nullable String f) implements fbe {
      @Override
      public int a() {
         return this.d;
      }
   ...
   public static record d(int c, String d) implements fbe {
      @Override
      public int a() {
         return this.c;
      }
