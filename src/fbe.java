...
public abstract class fbe implements fcj, fdc, fev, ffa {
   ...
   private int f;
   private boolean m;
   private final fcu n = new fcu();

   public fbe(int $$0, int $$1, int $$2, int $$3, vu $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(fat $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(fat var1, int var2, int var3, float var4);

   protected static void a(fat $$0, far $$1, vu $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(fat $$0, far $$1, vu $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(fat $$0, far $$1, int $$2, int $$3) {
      int $$4 = this.B() + $$2;
   ...
   protected void c(ffc $$0) {
      $$0.a(ffb.a, this.aL_());
      if (this.j) {
         if (this.aJ_()) {
            $$0.a(ffb.d, vu.c("narration.button.usage.focused"));
         } else {
