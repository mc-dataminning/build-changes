...
public final class fpe {
   ...
   private static final fpe c = new fpe(HostAndPort.fromParts("server.invalid", 25565));

   public fpe(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fpe(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fpe a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new fpe($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fpe ? this.b.equals(((fpe)$$0).b) : false;
      }
   }
