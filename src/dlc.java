...
public class dlc extends dfa {
   public static final MapCodec<dlc> a = b(dlc::new);
   public static final dtb<dti> b = dst.ab;
   public static final dtb<dti> c = dst.aa;
   public static final dtb<dti> d = dst.ac;
   public static final dtb<dti> e = dst.ad;
   public static final dtd f = dst.aT;
   public static final Map<je, dtb<dti>> g = Maps.newEnumMap(ImmutableMap.of(je.c, b, je.f, c, je.d, d, je.e, e));
   protected static final int h = 1;
   protected static final int i = 3;
   protected static final int j = 13;
   protected static final int k = 3;
   protected static final int l = 13;
   private static final ewl m = dfa.a(3.0, 0.0, 3.0, 13.0, 1.0, 13.0);
   private static final Map<je, ewl> n = Maps.newEnumMap(
      ImmutableMap.of(
         je.c,
         dfa.a(3.0, 0.0, 0.0, 13.0, 1.0, 13.0),
         je.d,
         dfa.a(3.0, 0.0, 3.0, 13.0, 1.0, 16.0),
         je.f,
         dfa.a(3.0, 0.0, 3.0, 16.0, 1.0, 13.0),
         je.e,
         dfa.a(0.0, 0.0, 3.0, 13.0, 1.0, 13.0)
      )
   );
   private static final Map<je, ewl> o = Maps.newEnumMap(
      ImmutableMap.of(
         je.c,
         ewi.a(n.get(je.c), dfa.a(3.0, 0.0, 0.0, 13.0, 16.0, 1.0)),
         je.d,
         ewi.a(n.get(je.d), dfa.a(3.0, 0.0, 15.0, 13.0, 16.0, 16.0)),
         je.f,
         ewi.a(n.get(je.f), dfa.a(15.0, 0.0, 3.0, 16.0, 16.0, 13.0)),
         je.e,
         ewi.a(n.get(je.e), dfa.a(0.0, 0.0, 3.0, 1.0, 16.0, 13.0))
      )
   );
   private static final Map<dsd, ewl> F = Maps.newHashMap();
   private static final evs[] G = ac.a(new evs[16], $$0 -> {
      for (int $$1 = 0; $$1 <= 15; $$1++) {
         float $$2 = (float)$$1 / 15.0F;
         float $$3 = $$2 * 0.6F + ($$2 > 0.0F ? 0.4F : 0.3F);
         float $$4 = ayz.a($$2 * $$2 * 0.7F - 0.5F, 0.0F, 1.0F);
         float $$5 = ayz.a($$2 * $$2 * 0.6F - 0.7F, 0.0F, 1.0F);
         $$0[$$1] = new evs((double)$$3, (double)$$4, (double)$$5);
      }
   });
   ...
   public dlc(dsc.d $$0) {
      super($$0);
      this.k(this.E.b().a(b, dti.c).a(c, dti.c).a(d, dti.c).a(e, dti.c).a(f, Integer.valueOf(0)));
      this.I = this.o().a(b, dti.b).a(c, dti.b).a(d, dti.b).a(e, dti.b);
   ...
   private dsd a(dbf $$0, dsd $$1, iz $$2) {
      boolean $$3 = p($$1);
   ...
   private dsd b(dbf $$0, dsd $$1, iz $$2) {
      boolean $$3 = !$$0.a_($$2.c()).g($$0, $$2);

      for (je $$4 : je.c.a) {
         if (!$$1.c(g.get($$4)).a()) {
            dti $$5 = this.a($$0, $$2, $$4, $$3);
            $$1 = $$1.a(g.get($$4), $$5);
         }
      }
   ...
   protected void a(dsd $$0, dca $$1, iz $$2, int $$3, int $$4) {
      ...
      for (je $$6 : je.c.a) {
         dti $$7 = $$0.c(g.get($$6));
         if ($$7 != dti.c && !$$1.a_($$5.a($$2, $$6)).a(this)) {
            $$5.c(je.a);
            dsd $$8 = $$1.a_($$5);
            if ($$8.a(this)) {
               iz $$9 = $$5.a($$6.g());
   ...
   private dti a(dbf $$0, iz $$1, je $$2) {
      return this.a($$0, $$1, $$2, !$$0.a_($$1.c()).g($$0, $$1));
   }

   private dti a(dbf $$0, iz $$1, je $$2, boolean $$3) {
      iz $$4 = $$1.a($$2);
      dsd $$5 = $$0.a_($$4);
      if ($$3) {
         boolean $$6 = $$5.b() instanceof dnn || this.a($$0, $$4, $$5);
         if ($$6 && m($$0.a_($$4.c()))) {
            if ($$5.d($$0, $$4, $$2.g())) {
               return dti.a;
            }
      ...
      return !a($$5, $$2) && ($$5.g($$0, $$4) || !m($$0.a_($$4.d()))) ? dti.c : dti.b;
   }
   ...
   private boolean a(dbf $$0, iz $$1, dsd $$2) {
      return $$2.d($$0, $$1, je.b) || $$2.a(dfc.hc);
   }
   ...
   protected static boolean m(dsd $$0) {
      return a($$0, null);
   }

   protected static boolean a(dsd $$0, @Nullable je $$1) {
      if ($$0.a(dfc.cw)) {
         return true;
      } else if ($$0.a(dfc.eh)) {
         je $$2 = $$0.c(dlh.aE);
         ...
         return $$0.a(dfc.kO) ? $$1 == $$0.c(dkl.a) : $$0.m() && $$1 != null;
      }
   }
   ...
   private void a(dbz $$0, azh $$1, iz $$2, evs $$3, je $$4, je $$5, float $$6, float $$7) {
      float $$8 = $$7 - $$6;
      if (!($$1.i() >= 0.2F * $$8)) {
         float $$9 = 0.4375F;
         float $$10 = $$6 + $$8 * $$1.i();
   ...
   private void a(dbz $$0, iz $$1, dsd $$2, dsd $$3) {
      for (je $$4 : je.c.a) {
         iz $$5 = $$1.a($$4);
