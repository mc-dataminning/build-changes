...
public class zf {
   ...
   public static <T extends wb> void a(zc<T> $$0, T $$1, arn $$2) throws alp {
      a($$0, $$1, $$2.p());
   }

   public static <T extends wb> void a(zc<T> $$0, T $$1, bsf<?> $$2) throws alp {
      if (!$$2.bx()) {
         $$2.c(() -> {
            if ($$1.a($$0)) {
               try {
   ...
   public static <T extends wb> z a(Exception $$0, zc<T> $$1, T $$2) {
      if ($$0 instanceof z $$3) {
         a($$3.a(), $$2, $$1);
         return $$3;
      } else {
   ...
   public static <T extends wb> void a(o $$0, T $$1, @Nullable zc<T> $$2) {
      if ($$2 != null) {
