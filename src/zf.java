...
public class zf<B extends ByteBuf, V, T> implements zg<B, V> {
   private static final int a = -1;
   private final Function<V, ? extends T> b;
   private final List<zf.b<B, V, T>> c;
   private final Object2IntMap<T> d;

   zf(Function<V, ? extends T> $$0, List<zf.b<B, V, T>> $$1, Object2IntMap<T> $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }
   ...
   public void a(B $$0, V $$1) {
      ...
      if ($$3 == -1) {
         ...
         wz.a($$0, $$3);
         zf.b<B, V, T> $$4 = this.c.get($$3);

         try {
            zg<? super B, V> $$5 = (zg<? super B, V>)$$4.a;
            $$5.encode($$0, $$1);
   ...
   public static <B extends ByteBuf, V, T> zf.a<B, V, T> a(Function<V, ? extends T> $$0) {
      return new zf.a<>($$0);
   }

   public static class a<B extends ByteBuf, V, T> {
      private final List<zf.b<B, V, T>> a = new ArrayList<>();
      private final Function<V, ? extends T> b;
      ...
      public zf.a<B, V, T> a(T $$0, zg<? super B, ? extends V> $$1) {
         this.a.add(new zf.b<>($$1, $$0));
         return this;
      }
      ...
      public zf<B, V, T> a() {
         ...
         return new zf<>(this.b, List.copyOf(this.a), $$0);
      }
   }

   static record b<B, V, T>(zg<? super B, ? extends V> a, T b) {
   }
}
