...
public class fkc {
   ...
   public static final fkc.a bv;

   public static fkc.a a(int $$0, int $$1) {
      return $$0 == -1 ? fkc.b.b.a($$1) : fkc.b.a.a($$0);
   }

   public static fkc.a a(String $$0) {
      if (fkc.a.e.containsKey($$0)) {
         return fkc.a.e.get($$0);
      } else {
         for (fkc.b $$1 : fkc.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fkc.b b;
      private final int c;
      private final azk<xc> d;
      static final Map<String, fkc.a> e = Maps.newHashMap();

      a(String $$0, fkc.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new azk<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xc.b($$2.toUpperCase(Locale.ROOT)) : xc.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xc.b($$2) : xc.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> tv.a().b($$1) ? xc.c($$1) : xc.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fkc.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xc> g;

      private static void a(fkc.b $$0, String $$1, int $$2) {
         fkc.a $$3 = new fkc.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xc> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fkc.a a(int $$0) {
         return (fkc.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
