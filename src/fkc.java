public class fkc extends fke<cck> {
   ...
   public static fnb b() {
      ...
      fna $$3 = fna.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, fmx.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", fna.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), fmx.a(0.0F, 0.0F, -8.25F));
      fne $$11 = $$2.a("tail0", fna.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), fmx.a);
      fne $$12 = $$11.a("tail1", fna.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), fmx.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", fna.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), fmx.a(0.5F, 0.5F, 6.0F));
