...
public class fry {
   ...
   private static final Map<efn.a, String> e = Maps.newEnumMap(Map.of(efn.a.a, "SW", efn.a.b, "S", efn.a.c, "OW", efn.a.d, "O", efn.a.e, "M", efn.a.f, "ML"));
   private final fof f;
   private final fry.a g;
   private final fra h;
   private fdu i;
   private fdu j;
   @Nullable
   ...
   private ebv l;
   @Nullable
   private CompletableFuture<ebv> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bot r = new bot(1);
   private final bot s = new bot(boy.values().length);
   private final bot t = new bot(1);
   private final bot u = new bot(1);
   private final Map<bou, bot> v = Map.of(bou.a, this.s);
   private final fth w;
   private final ftk x;
   private final fti y;
   private final ftg z;
   ...
   public fry(fof $$0) {
      ...
      this.g = new fry.a();
      this.h = $$0.h;
      this.w = new fth(this.h, this.r);
      this.x = new ftk(this.h, this.s, () -> $$0.s.u().g());
      this.y = new fti(this.h, this.t);
      this.z = new ftg(this.h, this.u);
      this.A = new ftj(this.h);
   }
   ...
   private void a(frc $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.az()) {
         ...
         dip $$23 = this.s();
         LongSet $$24 = (LongSet)($$23 instanceof aro ? ((aro)$$23).y() : LongSets.EMPTY_SET);
         ...
         if ($$27.E()) {
            ...
            int $$29 = this.f.s.a(diy.a, $$14);
            int $$30 = this.f.s.a(diy.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            ebv $$31 = this.t();
            StringBuilder $$32 = new StringBuilder("CH");

            for (efn.a $$33 : efn.a.values()) {
               if ($$33.b()) {
            ...
            if (this.f.s.d($$14.v())) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.as();
                  long $$36 = $$31.w();
                  btw $$37 = new btw($$23.an(), $$23.af(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dja.d $$44 = $$39.o();
            if ($$44 != null) {
               Object2IntMap<bxc> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bxc.values())
   ...
   private static String a(je<djs> $$0) {
   ...
   private dip s() {
      return (dip)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.s.aj()))), this.f.s);
   }
   ...
   private ebv t() {
      if (this.m == null) {
         ...
         this.m = $$0.m().b(this.k.h, this.k.i, ecm.n, false).thenApply($$0x -> (ebv)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", fhj.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fof.Q().aO().k(), fof.Q().aO().l(), fhj.a()),
            fhj.c(),
            fhj.d()
         }
      );
      if (this.f.az()) {
         ...
         if (this.i.d() == fdu.a.b) {
            ...
            for (Entry<ear<?>, Comparable<?>> $$7 : $$6.G().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.d() == fdu.a.b) {
            ...
            for (Entry<ear<?>, Comparable<?>> $$10 : $$9.G().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<ear<?>, Comparable<?>> $$0) {
      ear<?> $$1 = $$0.getKey();
