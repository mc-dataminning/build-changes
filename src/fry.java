...
public class fry<T> {
   ...
   public static final fry<?> a = new fry<>(bbk.a, ($$0, $$1) -> {
   });
   ...
   public static fry<?> a(xv $$0) {
      return new fry<>($$0, ($$0x, $$1) -> $$0x.accept($$1.getString()));
   }

   public static fry<?> a(List<xv> $$0) {
      return new fry<>($$0, ($$1, $$2) -> $$0.stream().map(xv::getString).forEach($$1));
   }
