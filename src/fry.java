...
public abstract class fry<T extends cbs> extends fsw<T> {
   public fry(fsx.a $$0) {
      super($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, elf $$3, fnu $$4, int $$5) {
      ...
      $$3.a(-4.0F, 0.0F, 0.0F);
      elj $$18 = $$4.getBuffer(foc.d(this.a($$0)));
      elf.a $$19 = $$3.c();
      Matrix4f $$20 = $$19.a();
      Matrix3f $$21 = $$19.b();
   ...
   public void a(Matrix4f $$0, Matrix3f $$1, elj $$2, int $$3, int $$4, int $$5, float $$6, float $$7, int $$8, int $$9, int $$10, int $$11) {
      $$2.a($$0, (float)$$3, (float)$$4, (float)$$5).a(255, 255, 255, 255).a($$6, $$7).c(fyl.d).b($$11).a($$1, (float)$$8, (float)$$10, (float)$$9).e();
   }
}
