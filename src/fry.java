...
public record fry(akv c, float d, float e, fry.a f, String g) implements frv {
   ...
   public static final MapCodec<fry> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               akv.a.fieldOf("file").forGetter(fry::c),
      ...
      try {
         ...
         try (InputStream $$3 = $$0.open(this.c.f("font/"))) {
            ...
            synchronized (fru.a) {
               ...
               var20 = new fdv($$2, $$1, this.d, this.e, this.f.c, this.f.d, this.g);
            }
         }
