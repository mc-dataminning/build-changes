...
public class fvo implements fvt.a {
   ...
   private final euk J;
   private final Map<hv, fvo.a> K = Maps.newHashMap();
   private final Map<UUID, xl.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         blf $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dH();
      });
   }

   private void b(epd $$0, fsi $$1, double $$2, double $$3, double $$4) {
      hv $$5 = hv.a($$2, $$3, $$4);
   ...
   private void a(epd $$0, fsi $$1, fvo.a $$2) {
      int $$3 = 0;
   ...
   private void a(epd $$0, fsi $$1, xl.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         fwb.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(epd $$0, fsi $$1, xl.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(epd $$0, fsi $$1, String $$2, fvo.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private Set<String> b(fvo.a $$0) {
      return this.b($$0.a).stream().map(acu::a).collect(Collectors.toSet());
   }

   private Set<String> c(fvo.a $$0) {
      return this.c($$0.a).stream().map(acu::a).collect(Collectors.toSet());
   }

   private boolean b(xl.a $$0) {
      return Objects.equals(this.M, $$0.a());
   }

   private boolean c(xl.a $$0) {
      cer $$1 = this.J.s;
      hv $$2 = hv.a($$1.dr(), $$0.h().b(), $$1.dx());
      hv $$3 = hv.a($$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(hv $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(xl.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(hv $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(xl.a::a).collect(Collectors.toSet());
   }

   private Map<hv, List<String>> c() {
      Map<hv, List<String>> $$0 = Maps.newHashMap();

      for (xl.a $$1 : this.L.values()) {
         for (hv $$2 : Iterables.concat($$1.q(), $$1.r())) {
   ...
   private void d() {
      fvt.a(this.J.al(), 8).ifPresent($$0 -> this.M = $$0.cw());
   }
