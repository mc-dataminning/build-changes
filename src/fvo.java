...
public class fvo implements AutoCloseable {
   private static final String a = "minecraft:main";
   private final eqm b;
   private final asa c;
   private final String d;
   private final List<fvp> e = Lists.newArrayList();
   ...
   public fvo(ggu $$0, asa $$1, eqm $$2, aiy $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(ggu $$0, aiy $$1) throws IOException, JsonSyntaxException {
   ...
   private void a(ggu $$0, JsonElement $$1) throws IOException {
   ...
   public fvp a(String $$0, eqm $$1, eqm $$2) throws IOException {
      fvp $$3 = new fvp(this.c, $$0, $$1, $$2);
