...
public class axn {
   ...
   public static final Codec<Quaternionf> f = Codec.withAlternative(d, e.xmap(Quaternionf::new, AxisAngle4f::new));
   ...
   public static final Codec<axn.c> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? akn.b($$0.substring(1)).map($$0x -> new axn.c($$0x, true)) : akn.b($$0).map($$0x -> new axn.c($$0x, false)), axn.c::c
      );
   ...
   public static final Codec<String> u = Codec.string(0, 16)
   ...
   private static final MapCodec<GameProfile> A = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(jr.e.fieldOf("id").forGetter(GameProfile::getId), u.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   public static final Codec<GameProfile> v = RecordCodecBuilder.create(
      $$0 -> $$0.group(A.forGetter(Function.identity()), t.lenientOptionalFieldOf("properties", new PropertyMap()).forGetter(GameProfile::getProperties))
            .apply($$0, ($$0x, $$1) -> {
               $$1.forEach(($$1x, $$2) -> $$0x.getProperties().put($$1x, $$2));
               return $$0x;
            })
   );
   public static final Codec<String> w = Codec.STRING
   ...
   public static Codec<String> y = Codec.STRING
      .validate($$0 -> !akn.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> axn.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new axn.b<>($$0, $$1);
   }
   ...
   public static <T> Codec<jb<T>> b(Codec<jb<T>> $$0) {
      return $$0.validate(
   ...
   public static record c(akn a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
