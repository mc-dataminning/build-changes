...
public class axn {
   ...
   axn(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static axn.a a() {
      return new axn.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(axn::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public axn.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public axn a(Writer $$0) throws IOException {
         return new axn($$0, this.a);
      }
   }
}
