...
public class axn {
   ...
   private axn(alh $$0, boolean $$1, boolean $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }

   private axn(ays.c $$0, boolean $$1) {
      this.c = $$0.a();
      this.d = $$0.b();
      this.e = $$1;
   }
   ...
   private ays.c a() {
      return new ays.c(this.c, this.d);
   }

   public static axn a(alh $$0) {
      return new axn($$0, false, true);
   }

   public static axn b(alh $$0) {
      return new axn($$0, false, false);
   }

   public static axn c(alh $$0) {
      return new axn($$0, true, true);
   }

   public static axn d(alh $$0) {
   ...
   public boolean a(Predicate<alh> $$0, Predicate<alh> $$1) {
