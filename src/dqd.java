...
public class dqd extends doo<drr> {
   public dqd(Codec<drr> $$0) {
      super($$0);
   }

   @Override
   public boolean a(doq<drr> $$0) {
      crt $$1 = $$0.b();
      drr $$2 = $$0.f();
      ate $$3 = $$0.d();
      ht $$4 = $$0.e();
      Predicate<dgb> $$5 = $$1x -> $$1x.a($$2.b);
      int $$6 = $$2.j.a($$3) + 1;
      int $$7 = $$2.j.a($$3) + 1;
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, dga.a::i) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(doq<drr> $$0, crt $$1, drr $$2, ate $$3, Set<ht> $$4, int $$5, int $$6) {
      for (ht $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(crt $$0, drr $$1, Predicate<dgb> $$2, ate $$3, ht.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         dgb $$7 = $$1.c.a($$3, $$4);
         dgb $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
