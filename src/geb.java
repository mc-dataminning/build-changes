...
public enum geb implements gei {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, geb> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (geb)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   public static geb a(int $$0, int $$1) {
      return r.get(b(atq.b($$0, 360), atq.b($$1, 360)));
   }
