...
public class geb {
   ...
   private geb(int $$0, List<ged> $$1) {
      this.a = $$1.toArray(ged[]::new);
      this.b = $$1.size();
   }

   private List<ged> c() {
      List<ged> $$0 = new ArrayList<>(this.d());
