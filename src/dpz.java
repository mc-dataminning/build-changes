...
public class dpz extends dpf implements bqx {
   public int a;
   public float b;
   public float c;
   public float d;
   ...
   public float i;
   public float j;
   private static final azf k = azf.a();
   @Nullable
   private xo l;

   public dpz(iz $$0, dsa $$1) {
      super(dph.m, $$0, $$1);
   }
   ...
   public static void a(dbw $$0, iz $$1, dsa $$2, dpz $$3) {
      $$3.g = $$3.f;
      $$3.i = $$3.h;
