...
public interface euf {
   euf a(double var1, double var3, double var5);

   euf a(int var1, int var2, int var3, int var4);

   euf a(float var1, float var2);

   euf a(int var1, int var2);

   euf b(int var1, int var2);

   euf a(float var1, float var2, float var3);
   ...
   default euf a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default euf a(int $$0) {
      return this.a(awg.b.b($$0), awg.b.c($$0), awg.b.d($$0), awg.b.a($$0));
   }
   ...
   default void a(eub.a $$0, fyp $$1, float $$2, float $$3, float $$4, int $$5, int $$6) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, new int[]{$$5, $$5, $$5, $$5}, $$6, false);
   }

   default void a(eub.a $$0, fyp $$1, float[] $$2, float $$3, float $$4, float $$5, int[] $$6, int $$7, boolean $$8) {
      float[] $$9 = new float[]{$$2[0], $$2[1], $$2[2], $$2[3]};
      int[] $$10 = new int[]{$$6[0], $$6[1], $$6[2], $$6[3]};
      int[] $$11 = $$1.b();
      jg $$12 = $$1.e().q();
      Matrix4f $$13 = $$0.a();
      Vector3f $$14 = $$0.a((float)$$12.u(), (float)$$12.v(), (float)$$12.w(), new Vector3f());
      int $$15 = 8;
      int $$16 = $$11.length / 8;
      MemoryStack $$17 = MemoryStack.stackPush();

      try {
         ByteBuffer $$18 = $$17.malloc(etz.j.b());
   ...
   default euf a(eub.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default euf a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default euf b(eub.a $$0, float $$1, float $$2, float $$3) {
