...
public class cyw extends csv {
   ...
   public static final Map<hc, dgh<dgo>> f = Maps.newEnumMap(ImmutableMap.of(hc.c, a, hc.f, b, hc.d, c, hc.e, d));
   ...
   private static final Map<hc, eig> m = Maps.newEnumMap(
      ImmutableMap.of(
         hc.c,
   ...
   private static final Map<hc, eig> n = Maps.newEnumMap(
      ImmutableMap.of(
         hc.c,
         eid.a(m.get(hc.c), csv.a(3.0, 0.0, 0.0, 13.0, 16.0, 1.0)),
         hc.d,
         eid.a(m.get(hc.d), csv.a(3.0, 0.0, 15.0, 13.0, 16.0, 16.0)),
         hc.f,
         eid.a(m.get(hc.f), csv.a(15.0, 0.0, 3.0, 16.0, 16.0, 13.0)),
         hc.e,
         eid.a(m.get(hc.e), csv.a(0.0, 0.0, 3.0, 1.0, 16.0, 13.0))
      )
   );
   ...
   private static final ehn[] E = ac.a(new ehn[16], $$0 -> {
      for (int $$1 = 0; $$1 <= 15; $$1++) {
         ...
         float $$4 = arx.a($$2 * $$2 * 0.7F - 0.5F, 0.0F, 1.0F);
         float $$5 = arx.a($$2 * $$2 * 0.6F - 0.7F, 0.0F, 1.0F);
   ...
   private dgo a(cpb $$0, gw $$1, hc $$2) {
      return this.a($$0, $$1, $$2, !$$0.a_($$1.c()).g($$0, $$1));
   }

   private dgo a(cpb $$0, gw $$1, hc $$2, boolean $$3) {
      gw $$4 = $$1.a($$2);
      dfj $$5 = $$0.a_($$4);
      if ($$3) {
   ...
   private boolean b(cpb $$0, gw $$1, dfj $$2) {
      return $$2.d($$0, $$1, hc.b) || $$2.a(csw.hc);
   }
   ...
   protected static boolean a(dfj $$0, @Nullable hc $$1) {
      if ($$0.a(csw.cw)) {
         return true;
      } else if ($$0.a(csw.ei)) {
         hc $$2 = $$0.c(czb.aC);
   ...
   public static int b(int $$0) {
      ehn $$1 = E[$$0];
      return arx.f((float)$$1.a(), (float)$$1.b(), (float)$$1.c());
   }

   private void a(cpv $$0, asc $$1, gw $$2, ehn $$3, hc $$4, hc $$5, float $$6, float $$7) {
      float $$8 = $$7 - $$6;
      if (!($$1.i() >= 0.2F * $$8)) {
         float $$9 = 0.4375F;
         float $$10 = $$6 + $$8 * $$1.i();
