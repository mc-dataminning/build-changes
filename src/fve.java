public class fve extends fwc<csf> {
   ...
   protected void G() {
      ...
      this.L = new fpc(this.p, $$0 + 62, $$1 + 24, 103, 12, wp.c("container.repair"));
      this.L.f(false);
      this.L.m(-1);
      this.L.n(-1);
      this.L.d(false);
   ...
   protected void a(foe $$0, float $$1, int $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      $$0.a(gmi::H, this.z.b(0).h() ? G : H, this.C + 59, this.D + 20, 110, 16);
   }

   @Override
   public void d(foe $$0, int $$1, int $$2, float $$3) {
      this.L.a($$0, $$1, $$2, $$3);
   }
