...
public class aqd {
                     ...
                     ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)ex.a(
                                    ...
                                    .then(
                                       ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a("nametagVisibility")
                                                   .then(ex.a("never").executes($$0x -> a((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.b.b))))
                                                .then(ex.a("hideForOtherTeams").executes($$0x -> a((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.b.c))))
                                             .then(ex.a("hideForOwnTeam").executes($$0x -> a((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.b.d))))
                                          .then(ex.a("always").executes($$0x -> a((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.b.a)))
                                    ))
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a("deathMessageVisibility")
                                                .then(ex.a("never").executes($$0x -> b((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.b.b))))
                                             .then(ex.a("hideForOtherTeams").executes($$0x -> b((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.b.c))))
                                          .then(ex.a("hideForOwnTeam").executes($$0x -> b((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.b.d))))
                                       .then(ex.a("always").executes($$0x -> b((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.b.a)))
                                 ))
                              .then(
                                 ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a("collisionRule")
                                             .then(ex.a("never").executes($$0x -> a((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.a.b))))
                                          .then(ex.a("pushOwnTeam").executes($$0x -> a((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.a.d))))
                                       .then(ex.a("pushOtherTeams").executes($$0x -> a((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.a.c))))
                                    .then(ex.a("always").executes($$0x -> a((ew)$$0x.getSource(), gi.a($$0x, "team"), fcz.a.a)))
                              ))
                           .then(
                              ex.a("prefix")
   ...
   private static int a(ew $$0, Collection<fcw> $$1) {
      ...
      if ($$1.size() == 1) {
         $$0.a(() -> xv.a("commands.team.leave.success.single", a($$1)), true);
      } else {
         $$0.a(() -> xv.a("commands.team.leave.success.multiple", $$1.size()), true);
      }

      return $$1.size();
   }

   private static int a(ew $$0, fcs $$1, Collection<fcw> $$2) {
      fcx $$3 = $$0.l().aJ();
      ...
      if ($$2.size() == 1) {
         $$0.a(() -> xv.a("commands.team.join.success.single", a($$2), $$1.d()), true);
      } else {
         $$0.a(() -> xv.a("commands.team.join.success.multiple", $$2.size(), $$1.d()), true);
      }

      return $$2.size();
   }

   private static int a(ew $$0, fcs $$1, fcz.b $$2) throws CommandSyntaxException {
      if ($$1.j() == $$2) {
         throw i.create();
      } else {
         $$1.a($$2);
         $$0.a(() -> xv.a("commands.team.option.nametagVisibility.success", $$1.d(), $$2.b()), true);
         return 0;
      }
   }

   private static int b(ew $$0, fcs $$1, fcz.b $$2) throws CommandSyntaxException {
      if ($$1.k() == $$2) {
         throw j.create();
      } else {
         $$1.b($$2);
         $$0.a(() -> xv.a("commands.team.option.deathMessageVisibility.success", $$1.d(), $$2.b()), true);
         return 0;
      }
   }

   private static int a(ew $$0, fcs $$1, fcz.a $$2) throws CommandSyntaxException {
      if ($$1.l() == $$2) {
         throw k.create();
      } else {
         $$1.a($$2);
         $$0.a(() -> xv.a("commands.team.option.collisionRule.success", $$1.d(), $$2.a()), true);
         return 0;
      }
   }

   private static int a(ew $$0, fcs $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.i() == $$2) {
         if ($$2) {
            throw g.create();
         } else {
         ...
         $$1.b($$2);
         $$0.a(() -> xv.a("commands.team.option.seeFriendlyInvisibles." + ($$2 ? "enabled" : "disabled"), $$1.d()), true);
         return 0;
      }
   }

   private static int b(ew $$0, fcs $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.h() == $$2) {
         if ($$2) {
            throw e.create();
         } else {
         ...
         $$1.a($$2);
         $$0.a(() -> xv.a("commands.team.option.friendlyfire." + ($$2 ? "enabled" : "disabled"), $$1.d()), true);
         return 0;
      }
   }

   private static int a(ew $$0, fcs $$1, xv $$2) throws CommandSyntaxException {
      if ($$1.c().equals($$2)) {
         throw c.create();
      } else {
         $$1.a($$2);
         $$0.a(() -> xv.a("commands.team.option.name.success", $$1.d()), true);
         return 0;
      }
   }

   private static int a(ew $$0, fcs $$1, n $$2) throws CommandSyntaxException {
      if ($$1.n() == $$2) {
         throw d.create();
      } else {
         $$1.a($$2);
         $$0.a(() -> xv.a("commands.team.option.color.success", $$1.d(), $$2.g()), true);
         return 0;
      }
   }

   private static int a(ew $$0, fcs $$1) throws CommandSyntaxException {
      fcx $$2 = $$0.l().aJ();
      ...
      if ($$3.isEmpty()) {
         ...
         $$0.a(() -> xv.a("commands.team.empty.success", $$3.size(), $$1.d()), true);
         return $$3.size();
      }
   }

   private static int b(ew $$0, fcs $$1) {
      fcx $$2 = $$0.l().aJ();
      $$2.d($$1);
      $$0.a(() -> xv.a("commands.team.remove.success", $$1.d()), true);
      return $$2.g().size();
   }
   ...
   private static int a(ew $$0, String $$1, xv $$2) throws CommandSyntaxException {
      fcx $$3 = $$0.l().aJ();
      if ($$3.b($$1) != null) {
         throw a.create();
      } else {
         fcs $$4 = $$3.c($$1);
         $$4.a($$2);
         $$0.a(() -> xv.a("commands.team.add.success", $$4.d()), true);
         return $$3.g().size();
      }
   }

   private static int c(ew $$0, fcs $$1) {
      Collection<String> $$2 = $$1.g();
      if ($$2.isEmpty()) {
         $$0.a(() -> xv.a("commands.team.list.members.empty", $$1.d()), false);
      } else {
         $$0.a(() -> xv.a("commands.team.list.members.success", $$1.d(), $$2.size(), xy.a($$2)), false);
      }
   ...
   private static int a(ew $$0) {
      Collection<fcs> $$1 = $$0.l().aJ().g();
      if ($$1.isEmpty()) {
         $$0.a(() -> xv.c("commands.team.list.teams.empty"), false);
      } else {
         $$0.a(() -> xv.a("commands.team.list.teams.success", $$1.size(), xy.b($$1, fcs::d)), false);
      }

      return $$1.size();
   }

   private static int b(ew $$0, fcs $$1, xv $$2) {
      $$1.b($$2);
      $$0.a(() -> xv.a("commands.team.option.prefix.success", $$2), false);
      return 1;
   }

   private static int c(ew $$0, fcs $$1, xv $$2) {
      $$1.c($$2);
      $$0.a(() -> xv.a("commands.team.option.suffix.success", $$2), false);
      return 1;
   }
}
