...
public class gbh extends gcb<gzk> {
   private final gfd[] a;
   private final gfd b;
   ...
   public static gfj a() {
      gfl $$0 = new gfl();
      gfn $$1 = $$0.a();
      $$1.a("head", gfi.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), gff.a);
      float $$2 = 0.0F;
      gfi $$3 = gfi.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = ayz.b($$2) * 9.0F;
         float $$6 = -2.0F + ayz.b((float)($$4 * 2) * 0.25F);
         float $$7 = ayz.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, gff.a($$5, $$6, $$7));
         $$2++;
      }
