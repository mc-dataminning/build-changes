...
public class gbh extends gbz<cej, fmi> {
   ...
   private static final fvu j = fvu.e(i);

   public gbh(gat.a $$0) {
      this($$0, 0.5F, fpb.ai);
   }

   protected gbh(gat.a $$0, float $$1, fpa $$2) {
      super($$0, new fmi($$0.a($$2)), $$1);
   }

   public boolean a(cej $$0, fyp $$1, double $$2, double $$3, double $$4) {
   ...
   public void a(cej $$0, float $$1, float $$2, esa $$3, fvm $$4, int $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      bog $$6 = $$0.gj();
      if ($$6 != null) {
         float $$7 = $$0.G($$2);
   ...
   private static void a(ese $$0, Matrix4f $$1, Matrix3f $$2, float $$3, float $$4, float $$5, int $$6, int $$7, int $$8, float $$9, float $$10) {
      $$0.a($$1, $$3, $$4, $$5).a($$6, $$7, $$8, 255).a($$9, $$10).c(ggl.d).b(15728880).a($$2, 0.0F, 1.0F, 0.0F).e();
   }
