public class gbh extends gcc {
   private final gbx a;

   gbh(fxv $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbx $$7) {
   ...
   public static class a implements gbf<lm> {
      ...
      public gbc a(lm $$0, fxv $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gbh($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gbf<lm> {
      ...
      public gbc a(lm $$0, fxv $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbc $$8 = new gbh($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
