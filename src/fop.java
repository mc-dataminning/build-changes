...
public class fop {
   ...
   public fop(fqx $$0, cpq $$1, int $$2, fnx $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
   ...
   public void a(int $$0, int $$1, int $$2, boolean $$3) {
      ...
      fqx.b $$7 = this.f[this.a($$4, $$5, $$6)];
      $$7.a($$3);
   }

   @Nullable
   protected fqx.b a(gw $$0) {
      int $$1 = ars.a($$0.v() - this.b.C_(), 16);
      if ($$1 >= 0 && $$1 < this.c) {
         int $$2 = ars.b(ars.a($$0.u(), 16), this.d);
         int $$3 = ars.b(ars.a($$0.w(), 16), this.e);
