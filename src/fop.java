...
public abstract class fop implements fpv, fqp, fsi, fsn {
   ...
   private int f;
   private boolean m;
   private final fqg n = new fqg();

   public fop(int $$0, int $$1, int $$2, int $$3, wo $$4) {
      this.c = $$0;
      this.d = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   @Override
   public final void a(fod $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(fod var1, int var2, int var3, float var4);

   protected static void a(fod $$0, fob $$1, wo $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(fod $$0, fob $$1, wo $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(fod $$0, fob $$1, int $$2, int $$3) {
      int $$4 = this.F() + $$2;
   ...
   public static void b(hjo $$0) {
      $$0.a(hid.a(awa.Bg, 1.0F));
   }
   ...
   public fsn.a w() {
      if (this.aM_()) {
         ...
         return this.i ? fsn.a.b : fsn.a.a;
      }
   }

   @Override
   public final void b(fsp $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fsp var1);

   protected void c(fsp $$0) {
      $$0.a(fso.a, this.d());
      if (this.j) {
         if (this.aM_()) {
            $$0.a(fso.d, wo.c("narration.button.usage.focused"));
         } else {
