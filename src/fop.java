...
public class fop extends fot<fop.b> {
   ...
   private boolean aa;
   private boolean ab;
   private final Set<axe<cuj>> ac = new HashSet<>();
   private final boolean ad;

   public fop(cmw $$0, cpk $$1, boolean $$2) {
      super(new fop.b($$0), $$0.gc(), xn.a);
      $$0.cb = this.w;
      this.d = 136;
      this.c = 195;
      this.ad = $$2;
      cta.a($$1, this.a($$0), $$0.dP().H_());
   }
   ...
   private void a(cpk $$0, boolean $$1, jk.a $$2) {
      if (cta.a($$0, $$1, $$2)) {
         for (csz $$3 : cta.d()) {
            Collection<cuo> $$4 = $$3.l();
            if ($$3 == T) {
               if ($$3.k() == csz.h.a && $$4.isEmpty()) {
                  this.a(cta.b());
               } else {
                  this.a($$4);
               }
      ...
      if ($$0 == null && T.k() != csz.h.b && $$3 != cqc.f) {
         ...
         if ($$0 == this.Y && $$4) {
            ...
            if ($$0 == this.Y) {
               ...
               this.m.s.a($$6, true);
               this.m.q.a($$6);
               this.m.q.a($$7, ((fop.c)$$0).a.d);
            } else if ($$3 == cqc.e && !this.w.g().e()) {
               this.m.s.a(this.w.g(), true);
               this.m.q.a(this.w.g());
               this.w.b(cuo.l);
            } else {
               this.m.s.ca.a($$0 == null ? $$1 : ((fop.c)$$0).a.d, $$2, $$3, this.m.s);
               this.m.s.ca.d();
            }
         } else if ($$3 != cqc.f && $$0.c == Q) {
            cuo $$8 = this.w.g();
            cuo $$9 = $$0.g();
            if ($$3 == cqc.c) {
               if (!$$9.e()) {
   ...
   protected void aM_() {
      if (this.m.q.f()) {
         super.aM_();
         this.W = new fhm(this.p, this.z + 82, this.A + 6, 80, 9, xo.c("itemGroup.search"));
         this.W.f(50);
         this.W.d(false);
         this.W.g(false);
         this.W.g(16777215);
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (T.k() != csz.h.d) {
         ...
         boolean $$4 = eys.a($$0, $$1).e().isPresent();
         if ($$3 && $$4 && this.a($$0, $$1)) {
            this.aa = true;
            return true;
         } else {
   ...
   private void a(csz $$0) {
            ...
            if ($$4.a()) {
               for (int $$5 = 0; $$5 < 9; $$5++) {
                  if ($$5 == $$3) {
                     ...
                     xo $$7 = this.m.m.T[$$3].k();
                     xo $$8 = this.m.m.U.k();
                     $$6.b(km.h, xo.a("inventory.hotbarInfo", $$8, $$7));
                     this.w.k.add($$6);
                  } else {
                     this.w.k.add(cuo.l);
                  }
      ...
      if (T.k() == csz.h.b) {
         ...
         for (int $$10 = 0; $$10 < $$9.i.size(); $$10++) {
            ...
            cro $$26 = new fop.c($$9.i.get($$10), $$10, $$14, $$15);
            this.w.i.add($$26);
         }

         this.Y = new cro(Q, 0, 173, 112);
         this.w.i.add(this.Y);
      } else if ($$1.k() == csz.h.b) {
         this.w.i.clear();
   ...
   public void a(fgq $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.Y != null && T.k() == csz.h.b && this.a(this.Y.e, this.Y.f, 16, 16, (double)$$1, (double)$$2)) {
         $$0.a(this.p, R, $$1, $$2);
      }
   ...
   @Override
   public List<xo> a(cuo $$0) {
      boolean $$1 = this.y != null && this.y instanceof fop.a;
      boolean $$2 = T.k() == csz.h.a;
      boolean $$3 = T.k() == csz.h.d;
      cwh.a $$4 = this.m.m.m ? cwh.a.b : cwh.a.a;
      cwh $$5 = $$1 ? $$4.c() : $$4;
      List<xo> $$6 = $$0.a(cuj.b.a(this.m.r), this.m.s, $$5);
      if ($$2 && $$1) {
         return $$6;
      } else {
   ...
   protected void a(fgq $$0, float $$1, int $$2, int $$3) {
      ...
      this.a($$0, T);
      if (T.k() == csz.h.b) {
         fpb.a($$0, this.z + 73, this.A + 6, this.z + 105, this.A + 49, 20, 0.0625F, (float)$$2, (float)$$3, this.m.s);
      }
   }
   ...
   protected boolean a(csz $$0, double $$1, double $$2) {
      int $$3 = this.b($$0);
      int $$4 = this.c($$0);
      return $$1 >= (double)$$3 && $$1 <= (double)($$3 + 26) && $$2 >= (double)$$4 && $$2 <= (double)($$4 + 32);
   }

   protected boolean a(fgq $$0, csz $$1, int $$2, int $$3) {
      int $$4 = this.b($$1);
      int $$5 = this.c($$1);
   ...
   protected void a(fgq $$0, csz $$1) {
      boolean $$2 = $$1 == T;
      boolean $$3 = $$1.g() == csz.f.a;
      int $$4 = $$1.f();
      ...
      $$0.a($$7[ayy.a($$4, 0, $$7.length)], $$5, $$6, 26, 32);
      $$0.c().a();
   ...
   public static void a(ffe $$0, int $$1, boolean $$2, boolean $$3) {
      gcp $$4 = $$0.s;
      jw $$5 = $$4.dP().H_();
      ffa $$6 = $$0.aC();
      gcr $$7 = $$6.a($$1);
   ...
   static class a extends cro {
      public a(bqm $$0, int $$1, int $$2, int $$3) {
         super($$0, $$1, $$2, $$3);
      }
