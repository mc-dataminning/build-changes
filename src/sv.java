...
public class sv extends sx<sw> {
   private static final int b = 24;
   public static final tx<sv> a = new tx.b<sv>() {
      public sv a(DataInput $$0, th $$1) throws IOException {
         return new sv(d($$0, $$1));
      }
   ...
   public boolean b(int $$0, tv $$1) {
      if ($$1 instanceof to) {
         this.c = ArrayUtils.add(this.c, $$0, ((to)$$1).i());
         return true;
      } else {
         return false;
      }
