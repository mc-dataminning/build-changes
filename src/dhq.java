...
public class dhq {
   public static final Codec<dhq> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bqs.a(avx.a).optionalFieldOf("music").forGetter($$0x -> $$0x.m),
   ...
   private final Optional<bqs<avx>> m;
   ...
   public static class a {
      ...
      private Optional<bqs<avx>> l = Optional.empty();
      ...
      public dhq.a a(@Nullable avx $$0) {
         if ($$0 == null) {
            ...
            this.l = Optional.of(bqs.a($$0));
            return this;
         }
      }

      public dhq.a a() {
         return this.a(bqs.b()).a(0.0F);
      }

      public dhq.a a(bqs<avx> $$0) {
