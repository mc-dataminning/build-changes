...
public class dhq extends dhf {
   ...
   public dhq(akr $$0, dia $$1, @Nullable dhq.c $$2) {
   ...
   @Override
   public djw a(int $$0) {
      return this.r instanceof akr $$1 ? (djw)this.u.computeIfAbsent($$0, $$2 -> new djs($$1, $$0, this::c)) : super.a($$0);
   }
   ...
   boolean k(gw $$0) {
      if (!this.r.B_().a($$0)) {
         ...
         return !(this.r instanceof akr $$1) ? true : this.D().a(akk.c) && $$1.c(cpc.a($$0));
      }
   }
   ...
   private <T extends dcv> void a(T $$0, akr $$1) {
      csv $$2 = $$0.q().b();
      if ($$2 instanceof cvj) {
         djv $$3 = ((cvj)$$2).a($$1, $$0);
         if ($$3 != null) {
   ...
   public akk D() {
      return this.s == null ? akk.b : this.s.get();
   }

   public void b(Supplier<akk> $$0) {
      this.s = $$0;
   }
   ...
   private <T extends dcv> void b(T $$0, akr $$1) {
      csv $$2 = $$0.q().b();
      if ($$2 instanceof cvj) {
         djv $$3 = ((cvj)$$2).a($$1, $$0);
         if ($$3 != null) {
