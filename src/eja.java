...
public class eja implements eiz {
   ...
   public static final Codec<eja> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               edm.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               edo.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               edn.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bsn.b(1, 20).fieldOf("outer_wall_distance").orElse(bst.a(4, 5)).forGetter($$0x -> $$0x.i),
               bsn.b(1, 20).fieldOf("distribution_points").orElse(bst.a(3, 4)).forGetter($$0x -> $$0x.j),
               bsn.b(0, 10).fieldOf("point_offset").orElse(bst.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public eja(edm $$0, edo $$1, edn $$2, double $$3, double $$4, boolean $$5, bsn $$6, bsn $$7, bsn $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
