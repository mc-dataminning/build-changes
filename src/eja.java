...
public class eja implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<eja.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public eja(List<eja.a> $$0) {
      this.c = $$0;
   }
   ...
   public static eja a(BufferedReader $$0) {
      return new eja($$0.lines().flatMap($$0x -> eja.a.a($$0x).stream()).toList());
   }

   public static record a(eja.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<eja.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new eja.a(eja.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new eja.a(eja.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new eja.a(eja.b.b, $$3));
      ...
      static eja.a b(String $$0) {
         return new eja.a(eja.b.a, "glob:" + $$0);
      }

      static eja.a c(String $$0) {
         return new eja.a(eja.b.a, "regex:" + $$0);
      }

      static eja.a d(String $$0) {
         return new eja.a(eja.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      eja.b a = FileSystem::getPathMatcher;
      eja.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
