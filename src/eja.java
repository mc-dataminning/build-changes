...
public enum eja implements atr {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final atr.a<eja> t = atr.a(eja::values);
   public static final IntFunction<eja> u = arr.a(eja::a, values(), arr.a.a);
   private final int v;
   private final String w;

   private eja(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
