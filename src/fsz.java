...
public interface fsz {
   static fsz a(ftf $$0, UserApiService $$1) {
      return new fsz.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, fth var2, AbuseReport var3);
   ...
   public static record b(ftf a, UserApiService b) implements fsz {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, fth $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               vu $$5 = this.a(var7);
               throw new CompletionException(new fsz.a($$5, var7));
            } catch (MinecraftClientException var8) {
               vu $$7 = this.a(var8);
               throw new CompletionException(new fsz.a($$7, var8));
            }
         }, ac.g());
      }
