...
public class hfe implements hex {
   ...
   private hfe(List<akv> $$0, akv $$1, Map<String, akv> $$2) {
      this.d = $$0;
      this.e = $$2;
      this.f = $$1;
   }
   ...
   static record a(hfd a, Supplier<IntUnaryOperator> b, akv c) implements hex.b {
      @Nullable
      public hem a(hew $$0) {
         Object var3;
         try {
            feu $$1 = this.a.a().a(this.b.get());
            return new hem(this.c, new hgg($$1.a(), $$1.b()), $$1, aur.a);
         } catch (IllegalArgumentException | IOException var7) {
            hfe.c.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
