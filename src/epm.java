...
public class epm extends epx {
   private static final Logger c = LogUtils.getLogger();
   public long a;
   public List<UUID> b;

   public static epm a(JsonObject $$0) {
      epm $$1 = new epm();

      try {
         $$1.a = eru.a("serverId", $$0, -1L);
         String $$2 = eru.b("playerList", $$0, null);
         if ($$2 != null) {
   ...
   private static List<UUID> a(JsonArray $$0) {
      ...
      for (JsonElement $$2 : $$0) {
         if ($$2.isJsonObject()) {
            UUID $$3 = eru.a("playerId", $$2.getAsJsonObject(), null);
            if ($$3 != null) {
               $$1.add($$3);
            }
         }
