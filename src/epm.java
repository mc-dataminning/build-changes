...
public class epm extends epe {
   ...
   public final int c;
   public final int d;
   public final ale<dca> e;
   private final boolean l;
   private final boolean m;
   public final byte f;
   public byte[] g = new byte[16384];
   public final boolean h;
   private final List<epm.a> n = Lists.newArrayList();
   private final Map<cmz, epm.a> o = Maps.newHashMap();
   private final Map<String, epf> p = Maps.newHashMap();
   final Map<String, epg> q = Maps.newLinkedHashMap();
   ...
   private epm(int $$0, int $$1, byte $$2, boolean $$3, boolean $$4, boolean $$5, ale<dca> $$6) {
      this.f = $$2;
      this.c = $$0;
      this.d = $$1;
      this.e = $$6;
   ...
   public static epm a(double $$0, double $$1, byte $$2, boolean $$3, boolean $$4, ale<dca> $$5) {
      int $$6 = 128 * (1 << $$2);
      int $$7 = ayz.a(($$0 + 64.0) / (double)$$6);
      int $$8 = ayz.a(($$1 + 64.0) / (double)$$6);
      int $$9 = $$7 * $$6 + $$6 / 2 - 64;
      int $$10 = $$8 * $$6 + $$6 / 2 - 64;
      return new epm($$9, $$10, $$2, $$3, $$4, false, $$5);
   }

   public static epm a(byte $$0, boolean $$1, ale<dca> $$2) {
      return new epm(0, 0, $$0, false, false, $$1, $$2);
   }

   public static epm b(us $$0, jk.a $$1) {
      ale<dca> $$2 = (ale<dca>)dvw.a(new Dynamic(vg.a, $$0.c("dimension")))
      ...
      for (epf $$13 : epf.b.parse($$11, $$0.c("banners")).resultOrPartial($$0x -> i.warn("Failed to parse map banner: '{}'", $$0x)).orElse(List.of())) {
         $$9.p.put($$13.b(), $$13);
      ...
      for (int $$15 = 0; $$15 < $$14.size(); $$15++) {
         epj $$16 = epj.a($$14.a($$15));
         if ($$16 != null) {
            $$9.r.put($$16.e(), $$16);
            $$9.a(epi.b, null, "frame-" + $$16.d(), (double)$$16.b().u(), (double)$$16.b().w(), (double)$$16.c(), null);
         }
      }
   ...
   public us a(us $$0, jk.a $$1) {
      ...
      $$0.a("locked", this.h);
      ald<vp> $$2 = $$1.a(vg.a);
      $$0.a("banners", (vp)epf.b.encodeStart($$2, List.copyOf(this.p.values())).getOrThrow());
      uy $$3 = new uy();

      for (epj $$4 : this.r.values()) {
         $$3.add($$4.a());
      }
   ...
   public epm b() {
      epm $$0 = new epm(this.c, this.d, this.f, this.l, this.m, true, this.e);
      $$0.p.putAll(this.p);
      $$0.q.putAll(this.q);
      $$0.s = this.s;
   ...
   private static Predicate<cur> a(cur $$0) {
      epk $$1 = $$0.a(km.B);
   ...
   public void a(cmz $$0, cur $$1) {
      ...
      if ($$1.D() && this.l) {
         cjc $$7 = $$1.E();
         iz $$8 = $$7.D();
         epj $$9 = this.r.get(epj.a($$8));
         if ($$9 != null && $$7.al() != $$9.d() && this.r.containsKey($$9.e())) {
            this.a("frame-" + $$9.d());
         }

         epj $$10 = new epj($$8, $$7.cH().e() * 90, $$7.al());
         this.a(epi.b, $$0.dP(), "frame-" + $$7.al(), (double)$$8.u(), (double)$$8.w(), (double)($$7.cH().e() * 90), null);
         this.r.put($$10.e(), $$10);
      }

      cxq $$11 = $$1.a(km.C, cxq.a);
   ...
   public static void a(cur $$0, iz $$1, String $$2, ji<eph> $$3) {
      cxq.a $$4 = new cxq.a($$3, (double)$$1.u(), (double)$$1.w(), 180.0F);
      $$0.a(km.C, cxq.a, $$2x -> $$2x.a($$2, $$4));
      if ($$3.a().a()) {
         $$0.b(km.A, new cxr($$3.a().d()));
      }
   }

   private void a(ji<eph> $$0, @Nullable dcb $$1, String $$2, double $$3, double $$4, double $$5, @Nullable xp $$6) {
      int $$7 = 1 << this.f;
      ...
      epg $$18 = new epg($$0, $$10, $$11, $$13, Optional.ofNullable($$6));
      epg $$19 = this.q.put($$2, $$18);
      if (!$$18.equals($$19)) {
         if ($$19 != null && $$19.c().a().f()) {
            this.s--;
         }
   ...
   @Nullable
   public zw<?> a(epk $$0, cmz $$1) {
      epm.a $$2 = this.o.get($$1);
   ...
   private void i() {
      this.c();
      this.n.forEach(epm.a::b);
   }

   public epm.a a(cmz $$0) {
      epm.a $$1 = this.o.get($$0);
      if ($$1 == null) {
         $$1 = new epm.a($$0);
         this.o.put($$0, $$1);
         this.n.add($$1);
   ...
   public void a(dbg $$0, int $$1, int $$2) {
      Iterator<epf> $$3 = this.p.values().iterator();
   ...
   public class a {
      ...
      private epm.b a() {
         ...
         for (int $$5 = 0; $$5 < $$2; $$5++) {
            for (int $$6 = 0; $$6 < $$3; $$6++) {
               $$4[$$5 + $$6 * $$2] = epm.this.g[$$0 + $$5 + ($$1 + $$6) * 128];
            }
         }

         return new epm.b($$0, $$1, $$2, $$3, $$4);
      }
      ...
      zw<?> a(epk $$0) {
         ...
         return $$3 == null && $$1 == null ? null : new aea($$0, epm.this.f, epm.this.h, $$3, $$1);
      }
   ...
   public static record b(int b, int c, int d, int e, byte[] f) {
      public static final zn<ByteBuf, Optional<epm.b>> a = zn.a(epm.b::a, epm.b::a);

      private static void a(ByteBuf $$0, Optional<epm.b> $$1) {
         if ($$1.isPresent()) {
            epm.b $$2 = $$1.get();
            $$0.writeByte($$2.d);
            $$0.writeByte($$2.e);
      ...
      private static Optional<epm.b> a(ByteBuf $$0) {
         ...
         if ($$1 > 0) {
            ...
            byte[] $$5 = wm.a($$0);
            return Optional.of(new epm.b($$3, $$4, $$1, $$2, $$5));
         } else {
