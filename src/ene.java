...
public class ene {
   ...
   private final ene.a g;

   @Deprecated
   public static ene a(aym $$0, ene.a $$1) {
      return new ene($$0, $$1, false);
   }

   public static ene a(aym $$0, int $$1, double... $$2) {
      return b($$0, new ene.a($$1, new DoubleArrayList($$2)));
   }

   public static ene b(aym $$0, ene.a $$1) {
      return new ene($$0, $$1, true);
   }

   private ene(aym $$0, ene.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<ene.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(ene.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(ene.a::b))
               .apply($$0, ene.a::new)
      );
      public static final Codec<jj<ene.a>> b = akg.a(lr.aO, a);
