public class ene {
   ...
   private int a(dtx $$0, int $$1, int $$2, int $$3) {
      int $$4 = kb.c($$0.g($$1) + 1);
   ...
   public boolean a(dbd $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dbd $$0, int $$1, int $$2, iz $$3, dsb $$4, iz $$5, dsb $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dbd $$0, iz $$1, dsb $$2) {
      iz.a $$3 = this.e.g($$1);
   ...
   private static boolean a(dbd $$0, iz $$1, dsb $$2, iz $$3, dsb $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         ewj $$5 = enl.a($$0, $$1, $$2, je.a);
         ewj $$6 = enl.a($$0, $$3, $$4, je.b);
         return ewg.b($$5, $$6);
      }
   }
