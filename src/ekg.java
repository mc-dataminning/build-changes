...
public class ekg extends ejt<elq> {
   public ekg(Codec<elq> $$0) {
      super($$0);
   }
   ...
   private void a(azv $$0, dji $$1, int $$2, int $$3, iv $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, iv $$2, dji $$3, boolean $$4, double $$5, iv $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dji $$0, iv $$1) {
      if ($$0.a_($$1.d()).a(dmo.ed)) {
         this.a($$0, $$1.d(), dmo.a.m());
      }
   }

   private void a(dji $$0, azv $$1, iv $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, eao $$13) {
   ...
   private void a(iv $$0, dji $$1, azv $$2, int $$3, int $$4, boolean $$5, boolean $$6, eao $$7) {
      eao $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dmo.ef) || $$8.a(dmo.ee) || $$8.a(dmo.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dmo.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dmo.ef.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, iv $$2, int $$3, azv $$4) {
   ...
   private static boolean c(eao $$0) {
      return $$0.a(dmo.je) || $$0.a(dmo.ef) || $$0.a(dmo.nC);
   }
   ...
   private void a(dji $$0, iv $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dmo.ed)) {
                  if (this.a((din)$$0, $$10)) {
                     this.a($$0, $$10, dmo.a.m());
                     this.a($$0, $$10.d(), dmo.a.m());
                  } else if (c($$11)) {
                     eao[] $$12 = new eao[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
