...
public class dap extends csv implements czw {
   ...
   protected dap(dfj $$0, dfi.d $$1) {
      super($$1);
      this.k(this.C.b().a(a, ha.c).a(b, dgi.b).a(c, dgs.a).a(d, Boolean.valueOf(false)));
      this.G = $$0.b();
      this.H = $$0;
   }
   ...
   public dfj a(cln $$0) {
      ...
      dfj $$4 = this.n()
         .a(a, $$0.g())
         .a(b, $$1 != ha.a && ($$1 == ha.b || !($$0.l().d - (double)$$2.v() > 0.5)) ? dgi.b : dgi.a)
   ...
   private static boolean c(dfj $$0, cpb $$1, gw $$2, ha $$3) {
      dfj $$4 = $$1.a_($$2.a($$3));
