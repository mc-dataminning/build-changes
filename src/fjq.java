...
public class fjq {
   ...
   final ffh c;
   private final List<fjq.a<?>> d = new ArrayList<>();
   private final BitSet e = new BitSet(5);
   private final Deque<fjp> f = Queues.newArrayDeque();
   ...
   @Nullable
   public <T extends fjp> T a(Class<? extends T> $$0, Object $$1) {
      for (fjq.a<?> $$2 : this.d) {
   ...
   class a<T extends fjp> {
      ...
      private float a(long $$0) {
         ...
         $$1 *= $$1;
         return this.h == fjp.a.b ? 1.0F - $$1 : $$1;
      }

      public boolean a(int $$0, fgt $$1) {
         long $$2 = ac.c();
         if (this.f == -1L) {
            this.f = $$2;
            this.h.a(fjq.this.c.aj());
         }

         if (this.h == fjp.a.a && $$2 - this.f <= 600L) {
            this.g = $$2;
         }

         $$1.c().a();
         $$1.c().a((float)$$0 - (float)this.c.a() * this.a($$2), (float)(this.d * 32), 800.0F);
         fjp.a $$3 = this.c.a($$1, fjq.this, $$2 - this.g);
         $$1.c().b();
         if ($$3 != this.h) {
         ...
         return this.h == fjp.a.b && $$2 - this.f > 600L;
      }
   }
}
