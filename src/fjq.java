...
public class fjq {
   ...
   public static fjn a(fjn $$0) {
      return $$0;
   }

   public static fjn a(fjn $$0, fjn $$1) {
   ...
   static class a implements fjn {
      private final fjn a;
      private final fjn b;

      public a(fjn $$0, fjn $$1) {
         if ($$0 == $$1) {
   ...
   static record b(fjn[] a) implements fjn {
      b(fjn[] a) {
