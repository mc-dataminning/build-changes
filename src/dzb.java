...
public class dzb implements dka.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<dzb> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ari<dzb> a = ari.a(f);
   private final dzf g;
   private final dzf h;
   private final dzf i;
   ...
   public static dzb a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new dzb(new dli(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private dzb(dzf $$0, dzf $$1, dzf $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public dzb(art $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         dzf.a($$0, IntStream.rangeClosed(-15, 0)),
         dzf.a($$0, IntStream.rangeClosed(-15, 0)),
         dzf.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public dzb a(art $$0) {
      return new dzb($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dka.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         dzc $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(dzf.b($$4 * $$13), dzf.b($$5 * $$13), dzf.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = dzf.b($$1 * $$13);
         double $$21 = dzf.b($$2 * $$13);
         double $$22 = dzf.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            dzc $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return aro.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
