...
public class dzb<T> implements dzj<T> {
   private final jw<T> a;
   private final axw<T> b;
   private final dzk<T> c;
   private final int d;

   public dzb(jw<T> $$0, int $$1, dzk<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dzb(jw<T> $$0, int $$1, dzk<T> $$2) {
      this($$0, $$1, $$2, axw.c(1 << $$1));
   }

   private dzb(jw<T> $$0, int $$1, dzk<T> $$2, axw<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   public dzj<T> a(dzk<T> $$0) {
      return new dzb<>(this.a, this.d, $$0, this.b.b());
   }
}
