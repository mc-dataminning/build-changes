...
public class eag implements eai {
   public static final Codec<eag> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bnk.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bnk.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bnk.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bni.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bni.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public eag(int $$0, bnk $$1, bnk $$2, int $$3, int $$4, bnk $$5, bni $$6, bni $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
