...
public class ti {
   ...
   public void a(final Consumer<sx> $$0) {
      this.a(new sy() {
         @Override
         public void a(sx $$0x) {
         }
   ...
   public int a() {
      return (int)this.f.stream().filter(sx::h).filter(sx::q).count();
   }

   public int b() {
      return (int)this.f.stream().filter(sx::h).filter(sx::r).count();
   }

   public int c() {
      return (int)this.f.stream().filter(sx::j).count();
   }
   ...
   public Collection<sx> f() {
      return this.f.stream().filter(sx::h).filter(sx::q).collect(Collectors.toList());
   }

   public Collection<sx> g() {
      return this.f.stream().filter(sx::h).filter(sx::r).collect(Collectors.toList());
   }
