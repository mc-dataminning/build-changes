public class geq extends gca<haw> {
   ...
   public static gfi a(gfg $$0) {
      gfk $$1 = new gfk();
      gfm $$2 = $$1.a();
      $$2.a("shoulders", gfh.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), gfe.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         gfh.c()
         ...
         gfe.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         gfh.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         gfe.a(-2.0F, 6.9F + ayz.b(0.20420352F) * 10.0F, -0.5F + ayz.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", gfh.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gfe.a);
      gfh $$4 = gfh.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, gfe.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, gfe.a(10.0F, 4.0F, 0.0F));
   ...
   private static void a(haw $$0, gfc $$1, int $$2) {
