...
public abstract class eou<T extends eou<T>> {
   ...
   public eou(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = eos.a();
         if ($$3 != null) {
         ...
         throw new eqd(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new eqd(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new eqd(var2.getMessage(), var2);
      }
   }
   ...
   public static eou<?> a(String $$0) {
      return new eou.b($$0, 5000, 60000);
   }

   public static eou<?> a(String $$0, int $$1, int $$2) {
      return new eou.b($$0, $$1, $$2);
   }

   public static eou<?> b(String $$0, String $$1) {
      return new eou.c($$0, $$1, 5000, 60000);
   }

   public static eou<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new eou.c($$0, $$1, $$2, $$3);
   }

   public static eou<?> b(String $$0) {
      return new eou.a($$0, 5000, 60000);
   }

   public static eou<?> c(String $$0, String $$1) {
      return new eou.d($$0, $$1, 5000, 60000);
   }

   public static eou<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new eou.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends eou<eou.a> {
   ...
   public static class b extends eou<eou.b> {
   ...
   public static class c extends eou<eou.c> {
      ...
      public eou.c f() {
         try {
            ...
            throw new eqd(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends eou<eou.d> {
      private final String c;
