...
public class eou extends gfd {
   private static final tn a = tn.c("mco.selectServer.popup");
   private static final tn b = tn.c("mco.selectServer.close");
   private static final aey c = new aey("popup/background");
   private static final aey y = new aey("icon/trial_available");
   private static final eue z = new eue(new aey("widget/cross_button"), new aey("widget/cross_button_highlighted"));
   ...
   private static List<aey> M = List.of();
   private final eym N;
   ...
   public eou(eym $$0, boolean $$1) {
      super(a);
      this.N = $$0;
      this.O = $$1;
   }

   public static void a(anv $$0) {
      Collection<aey> $$1 = $$0.b("textures/gui/images", $$0x -> $$0x.a().endsWith(".png")).keySet();
   ...
   protected void aH_() {
      ...
      if (this.O) {
         this.P = this.d(ess.a(tn.c("mco.selectServer.trial"), $$0x -> this.f.a(new exe($$0xx -> {
               if ($$0xx) {
      ...
      this.a(this.d(ess.a(tn.c("mco.selectServer.buy"), $$0x -> this.f.a(new exe($$0xx -> {
            if ($$0xx) {
      ...
      ete $$0 = this.d(new ete(this.D() + 4, this.E() + 4, 14, 14, z, $$0x -> this.az_(), b));
      $$0.a(euc.a(b));
      int $$1 = 142 - (this.O ? 40 : 20);
      etc $$2 = new etc(this.F() - 10 - 100, this.E() + 10, 100, $$1, a, this.i);
      if ($$2.v()) {
         $$2.d(100 - $$2.f());
      }
   ...
   public static void a(esh $$0, ess $$1) {
      int $$2 = 8;
      $$0.c().a();
