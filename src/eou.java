...
public enum eou {
   ...
   public List<apz<InputStream>> a(aov $$0) throws IOException {
      return List.of(
   ...
   public apz<InputStream> b(aov $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private apz<InputStream> a(aov $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      apz<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
