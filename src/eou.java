...
public class eou extends gex {
   private static final Logger a = LogUtils.getLogger();
   private static final tl b = tl.c("mco.terms.title");
   private static final tl c = tl.c("mco.terms.sentence.1");
   private static final tl y = tk.a().b(tl.c("mco.terms.sentence.2").c(ui.a.c(true)));
   private final eye z;
   private final emq A;
   private boolean B;

   public eou(eye $$0, emq $$1) {
      super(b);
      this.z = $$0;
      this.A = $$1;
   }
   ...
   public void aH_() {
      int $$0 = this.g / 4 - 2;
      this.d(esk.a(tl.c("mco.terms.buttons.agree"), $$0x -> this.D()).a(this.g / 4, h(12), $$0, 20).a());
      this.d(esk.a(tl.c("mco.terms.buttons.disagree"), $$0x -> this.f.a(this.z)).a(this.g / 2 + 4, h(12), $$0, 20).a());
   }
   ...
   private void D() {
      ...
      try {
         $$0.i();
         this.f.a(new eog(this.z, new epo(this.z, this.A)));
      } catch (enm var3) {
