...
public class eou {
   ...
   public static final eou.a bv;

   public static eou.a a(int $$0, int $$1) {
      return $$0 == -1 ? eou.b.b.a($$1) : eou.b.a.a($$0);
   }

   public static eou.a a(String $$0) {
      if (eou.a.e.containsKey($$0)) {
         return eou.a.e.get($$0);
      } else {
         for (eou.b $$1 : eou.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eou.b b;
      private final int c;
      private final aui<vf> d;
      static final Map<String, eou.a> e = Maps.newHashMap();

      a(String $$0, eou.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<eou.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vf> g;

      private static void a(eou.b $$0, String $$1, int $$2) {
         eou.a $$3 = new eou.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public eou.a a(int $$0) {
         return (eou.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
