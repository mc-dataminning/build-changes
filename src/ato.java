...
public class ato extends FileSystem {
   private static final Set<String> b = Set.of("basic");
   public static final String a = "/";
   private static final Splitter c = Splitter.on('/');
   private final FileStore d;
   private final FileSystemProvider e = new atn();
   private final atm f;

   ato(String $$0, ato.b $$1) {
      this.d = new atl($$0);
      this.f = a($$1, this, "", null);
   }

   private static atm a(ato.b $$0, ato $$1, String $$2, @Nullable atm $$3) {
      Object2ObjectOpenHashMap<String, atm> $$4 = new Object2ObjectOpenHashMap();
      atm $$5 = new atm($$1, $$2, $$3, new atp.a($$4));
      $$0.b.forEach(($$3x, $$4x) -> $$4.put($$3x, new atm($$1, $$3x, $$5, new atp.b($$4x))));
   ...
   public static ato.a c() {
      return new ato.a();
   }

   public static class a {
      private final ato.b a = new ato.b();

      public ato.a a(List<String> $$0, String $$1, Path $$2) {
         ato.b $$3 = this.a;

         for (String $$4 : $$0) {
            $$3 = $$3.a.computeIfAbsent($$4, $$0x -> new ato.b());
         }
      ...
      public ato.a a(List<String> $$0, Path $$1) {
         if ($$0.isEmpty()) {
   ...
   static record b(Map<String, ato.b> a, Map<String, Path> b) {
