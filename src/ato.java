...
public class ato extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(ays.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(ays.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(ays.s);
