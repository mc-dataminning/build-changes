...
class ato extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atn && $$1 instanceof atn && $$0.equals($$1);
   }
   ...
   private static atn a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atn) {
         return (atn)$$0;
      } else {
