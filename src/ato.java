...
public class ato {
   ...
   public static ie<cmc> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return kb.h
            .b(ags.a(kc.F, new agt($$2)))
   ...
   public static ie<cmc> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ie<cmc> a(JsonObject $$0, String $$1, @Nullable ie<cmc> $$2) {
