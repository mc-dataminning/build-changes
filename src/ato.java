...
public class ato extends ati {
   static final Logger c = LogUtils.getLogger();
   private final ato.b d;
   private final String e;

   ato(atq $$0, ato.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(att $$0, ali $$1) {
   ...
   @Nullable
   private auw<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : auw.create($$1, $$2);
      }
   }
   ...
   public static class a implements aum.c {
      ...
      @Override
      public atr a(atq $$0) {
         ato.b $$1 = new ato.b(this.a);
         return new ato($$0, $$1, "");
      }

      @Override
      public atr a(atq $$0, aum.a $$1) {
         ato.b $$2 = new ato.b(this.a);
         atr $$3 = new ato($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<atr> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  ato.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
