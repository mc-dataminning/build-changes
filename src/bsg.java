...
public class bsg {
   ...
   private static void a(bso $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bsj $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<bsp> $$0) {
      JsonObject $$1 = new JsonObject();
      bst<bsp> $$2 = bst.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(bsp::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         bst<bsp> $$6 = bst.a((List<bsp>)$$4);
         ...
         Function<bsp, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<eeo, bst<bsi>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bst)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ag.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<eeo, bst<bsi>> $$3 : $$0) {
         bst<bsi> $$4 = (bst<bsi>)$$3.getSecond();
         JsonObject $$5 = ag.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((eeo)$$3.getFirst()).toString());
   ...
   private JsonElement c(List<bsr> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = brv.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bse $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bsg::a));
      $$1.add("chunksWritten", this.a($$0.m(), bsg::a));
      return $$1;
   }

   private JsonElement a(bsl.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bse $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bsg::a));
      $$1.add("received", this.a($$0.k(), bsg::a));
      return $$1;
   }

   private <T> JsonElement a(bsn<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<bsk> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bsk>, ToDoubleFunction<bsk>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bsk::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bsk::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bsk::c));
      return $$1;
   }
}
