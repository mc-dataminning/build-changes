...
public class bsg extends brw {
   ...
   public bsg(daz $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bsc.M, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public bsg(bsc<? extends bsg> $$0, daz $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         eum $$0 = new eum(this.k.du() - this.du(), this.k.dw() + (double)this.k.cL() / 2.0 - this.dw(), this.k.dA() - this.dA());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
            double $$2 = 1.0 - Math.sqrt($$1) / 8.0;
            this.g(this.ds().e($$0.d().a($$2 * $$2 * 0.1)));
         }
      }
      ...
      this.g(this.ds().d((double)$$3, 0.98, (double)$$3));
      if (this.aE()) {
         this.g(this.ds().d(1.0, -0.9, 1.0));
      }
   ...
   private void u() {
      ...
      if (this.dP() instanceof aqn) {
         for (bsg $$1 : this.dP().a(dvk.a(bsg.class), this.cK().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(aqn $$0, eum $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new bsg($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(aqn $$0, eum $$1, int $$2) {
      euh $$3 = euh.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<bsg> $$5 = $$0.a(dvk.a(bsg.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         bsg $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private static boolean a(bsg $$0, int $$1, int $$2) {
   ...
   private int a(cly $$0, int $$1) {
      Entry<bsd, ctq> $$2 = czc.a(cze.O, $$0, ctq::m);
      if ($$2 != null) {
         ctq $$3 = $$2.getValue();
