...
public class bsg extends brr {
   ...
   public bsg(cua $$0, bks $$1, double $$2, int $$3) {
      super($$1, $$2, 24, $$3);
      this.g = $$0;
      this.h = $$1;
   }
         ...
         if (this.i > 60) {
            ...
            if (!$$0.B) {
               for (int $$7 = 0; $$7 < 20; $$7++) {
                  ...
                  double $$9 = $$3.k() * 0.02;
                  double $$10 = $$3.k() * 0.02;
                  ((alq)$$0).a(js.W, (double)$$2.u() + 0.5, (double)$$2.v(), (double)$$2.w() + 0.5, 1, $$8, $$9, $$10, 0.15F);
               }
   ...
   protected boolean a(crc $$0, ht $$1) {
      dhx $$2 = $$0.a(iu.a($$1.u()), iu.a($$1.w()), dic.n, false);
