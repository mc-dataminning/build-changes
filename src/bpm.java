public class bpm extends bpk {
   ...
   public bpm(bjo $$0, int $$1, int $$2, float $$3, float $$4, boolean $$5) {
      super($$0);
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a() {
      ...
      if (this.k == bpk.a.b && !this.d.L().l()) {
         ...
         if ($$3 < 2.5000003E-7F) {
            ...
            this.d.aU = this.d.dB();
            this.d.aW = this.d.dB();
            float $$5 = (float)(this.h * this.d.b(bks.m));
            if (this.d.aX()) {
               this.d.w($$5 * this.p);
               double $$6 = Math.sqrt($$0 * $$0 + $$2 * $$2);
               if (Math.abs($$1) > 1.0E-5F || Math.abs($$6) > 1.0E-5F) {
                  float $$7 = -((float)(asb.d($$1, $$6) * 180.0F / (float)Math.PI));
                  $$7 = asb.a(asb.g($$7), (float)(-this.n), (float)this.n);
                  this.d.s(this.a(this.d.dD(), $$7, 5.0F));
               }

               float $$8 = asb.b(this.d.dD() * (float) (Math.PI / 180.0));
               float $$9 = asb.a(this.d.dD() * (float) (Math.PI / 180.0));
               this.d.bm = $$8 * $$5;
               this.d.bl = -$$9 * $$5;
            } else {
               float $$10 = Math.abs(asb.g(this.d.dB() - $$4));
               float $$11 = a($$10);
   ...
   private static float a(float $$0) {
      return 1.0F - asb.a(($$0 - 10.0F) / 50.0F, 0.0F, 1.0F);
   }
}
