...
public class bpm {
   ...
   private static void a(bpu $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bpp $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<bpv> $$0) {
      JsonObject $$1 = new JsonObject();
      bpz<bpv> $$2 = bpz.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(bpv::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         bpz<bpv> $$6 = bpz.a((List<bpv>)$$4);
         ...
         Function<bpv, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<dzt, bpz<bpo>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bpz)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = af.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dzt, bpz<bpo>> $$3 : $$0) {
         bpz<bpo> $$4 = (bpz<bpo>)$$3.getSecond();
   ...
   private JsonElement c(List<bpx> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bpb.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bpk $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bpm::a));
      $$1.add("chunksWritten", this.a($$0.m(), bpm::a));
      return $$1;
   }

   private JsonElement a(bpr.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bpk $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bpm::a));
      $$1.add("received", this.a($$0.k(), bpm::a));
      return $$1;
   }

   private <T> JsonElement a(bpt<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<bpq> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bpq>, ToDoubleFunction<bpq>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bpq::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bpq::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bpq::c));
      return $$1;
   }
}
