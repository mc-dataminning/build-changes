...
public interface bpm<T, F> {
   ...
   public static final class a implements bpm<bpm.b, Runnable> {
   ...
   public static final class c<T> implements bpm<T, T> {
