...
public interface ese {
   ese a(double var1, double var3, double var5);

   ese a(int var1, int var2, int var3, int var4);

   ese a(float var1, float var2);

   ese a(int var1, int var2);

   ese b(int var1, int var2);

   ese a(float var1, float var2, float var3);
   ...
   default ese a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default ese a(int $$0) {
      return this.a(avr.b.b($$0), avr.b.c($$0), avr.b.d($$0), avr.b.a($$0));
   }
   ...
   default void a(esa.a $$0, fwi $$1, float[] $$2, float $$3, float $$4, float $$5, int[] $$6, int $$7, boolean $$8) {
      ...
      try {
         ByteBuffer $$18 = $$17.malloc(ery.j.b());
   ...
   default ese a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector4f $$4 = $$0.transform(new Vector4f($$1, $$2, $$3, 1.0F));
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default ese a(Matrix3f $$0, float $$1, float $$2, float $$3) {
