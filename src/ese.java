public abstract class ese extends esi implements etn, euf {
   private static final etx a = new etx(new aez("widget/text_field"), new aez("widget/text_field_highlighted"));
   private static final aez b = new aez("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean l;

   public ese(int $$0, int $$1, int $$2, int $$3, tl $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int w() {
      return asb.a((int)((float)(this.g * this.g) / (float)this.x()), 32, this.g);
   }
   ...
   protected void a(double $$0) {
      this.e = asb.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(erz $$0, int $$1, int $$2, int $$3, int $$4) {
      aez $$5 = a.a(this.aD_(), this.aC_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(erz var1, int var2, int var3, float var4);
}
