...
public class ese {
   private static final aex b = new aex("hud/crosshair");
   private static final aex c = new aex("hud/crosshair_attack_indicator_full");
   private static final aex d = new aex("hud/crosshair_attack_indicator_background");
   private static final aex e = new aex("hud/crosshair_attack_indicator_progress");
   private static final aex f = new aex("hud/effect_background_ambient");
   private static final aex g = new aex("hud/effect_background");
   private static final aex h = new aex("hud/hotbar");
   private static final aex i = new aex("hud/hotbar_selection");
   private static final aex j = new aex("hud/hotbar_offhand_left");
   private static final aex k = new aex("hud/hotbar_offhand_right");
   private static final aex l = new aex("hud/hotbar_attack_indicator_background");
   private static final aex m = new aex("hud/hotbar_attack_indicator_progress");
   private static final aex n = new aex("hud/jump_bar_background");
   private static final aex o = new aex("hud/jump_bar_cooldown");
   private static final aex p = new aex("hud/jump_bar_progress");
   private static final aex q = new aex("hud/experience_bar_background");
   private static final aex r = new aex("hud/experience_bar_progress");
   private static final aex s = new aex("hud/armor_empty");
   private static final aex t = new aex("hud/armor_half");
   private static final aex u = new aex("hud/armor_full");
   private static final aex v = new aex("hud/food_empty_hunger");
   private static final aex w = new aex("hud/food_half_hunger");
   private static final aex x = new aex("hud/food_full_hunger");
   private static final aex y = new aex("hud/food_empty");
   private static final aex z = new aex("hud/food_half");
   private static final aex A = new aex("hud/food_full");
   private static final aex B = new aex("hud/air");
   private static final aex C = new aex("hud/air_bursting");
   private static final aex D = new aex("hud/heart/vehicle_container");
   private static final aex E = new aex("hud/heart/vehicle_full");
   private static final aex F = new aex("hud/heart/vehicle_half");
   private static final aex G = new aex("textures/misc/vignette.png");
   ...
   public void a(esf $$0, float $$1) {
      ...
      float $$4 = this.W.av();
      this.az = arx.i(0.5F * $$4, this.az, 1.125F);
      if (this.W.m.aw().a()) {
         if (this.W.s.gp()) {
            this.b($$0, this.az);
         } else {
      ...
      if (!this.W.m.Z) {
         if (this.aa != null && this.ab > 0) {
            ...
            if ($$13 > 8) {
               ...
               int $$14 = 16777215;
               if (this.ac) {
                  $$14 = arx.h($$12 / 50.0F, 0.7F, 0.6F) & 16777215;
               }
         ...
         RenderSystem.enableBlend();
         int $$28 = arx.a(this.W.n.e() * (double)$$2.o() / (double)$$2.m());
         int $$29 = arx.a(this.W.n.f() * (double)$$2.p() / (double)$$2.n());
         this.W.aG().a("chat");
   ...
   private void a(esf $$0, esd $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != 0) {
         int $$6 = -$$3 / 2;
         $$0.a($$6 - 2, $$2 - 2, $$6 + $$3 + 2, $$2 + 9 + 2, ari.b.a($$5, $$4));
      }
   }
            ...
            if ($$7.h()) {
               ...
               if ($$7.f()) {
                  ...
                  if ($$7.a(200)) {
                     int $$12 = $$7.d();
                     int $$13 = 10 - $$12 / 20;
                     $$11 = arx.a((float)$$12 / 10.0F / 5.0F * 0.5F, 0.0F, 0.5F)
                        + arx.b((float)$$12 * (float) Math.PI / 5.0F) * arx.a((float)$$13 / 10.0F * 0.25F, 0.0F, 0.25F);
                  }
               }
   ...
   private void e(esf $$0) {
      ...
      if ($$1 != null) {
         ...
         int $$12 = arx.f($$1.fj());
         int $$13 = arx.f(($$11 + (float)$$12) / 2.0F / 10.0F);
         ...
         if ($$1.a(apy.a) || $$33 < $$32) {
            int $$34 = this.a($$22) - 1;
            $$16 -= $$34 * 10;
            int $$35 = arx.c((double)($$33 - 2) * 10.0 / (double)$$32);
            int $$36 = arx.c((double)$$33 * 10.0 / (double)$$32) - $$35;
   ...
   private void a(esf $$0, cbu $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      ...
      int $$13 = arx.c((double)$$6 / 2.0);
      int $$14 = arx.c((double)$$9 / 2.0);
      int $$15 = $$13 * 2;
   ...
   private void a(esf $$0, aex $$1, float $$2) {
   ...
   private void a(biq $$0) {
      if ($$0 != null) {
         ...
         float $$3 = arx.a(1.0F - $$2, 0.0F, 1.0F);
   ...
   private void g(esf $$0) {
      if (this.W.m.ab().c() && (this.ax > 0.0F || this.ay > 0.0F)) {
         int $$1 = arx.d(255.0F * arx.a(arx.i(this.W.as(), this.ay, this.ax), 0.0F, 1.0F));
         if ($$1 > 8) {
            esd $$2 = this.f();
            int $$3 = $$2.a(L);
   ...
   static enum a {
      a(
         new aex("hud/heart/container"),
         new aex("hud/heart/container_blinking"),
         new aex("hud/heart/container"),
         new aex("hud/heart/container_blinking"),
         new aex("hud/heart/container_hardcore"),
         new aex("hud/heart/container_hardcore_blinking"),
         new aex("hud/heart/container_hardcore"),
         new aex("hud/heart/container_hardcore_blinking")
      ),
      b(
         new aex("hud/heart/full"),
         new aex("hud/heart/full_blinking"),
         new aex("hud/heart/half"),
         new aex("hud/heart/half_blinking"),
         new aex("hud/heart/hardcore_full"),
         new aex("hud/heart/hardcore_full_blinking"),
         new aex("hud/heart/hardcore_half"),
         new aex("hud/heart/hardcore_half_blinking")
      ),
      c(
         new aex("hud/heart/poisoned_full"),
         new aex("hud/heart/poisoned_full_blinking"),
         new aex("hud/heart/poisoned_half"),
         new aex("hud/heart/poisoned_half_blinking"),
         new aex("hud/heart/poisoned_hardcore_full"),
         new aex("hud/heart/poisoned_hardcore_full_blinking"),
         new aex("hud/heart/poisoned_hardcore_half"),
         new aex("hud/heart/poisoned_hardcore_half_blinking")
      ),
      d(
         new aex("hud/heart/withered_full"),
         new aex("hud/heart/withered_full_blinking"),
         new aex("hud/heart/withered_half"),
         new aex("hud/heart/withered_half_blinking"),
         new aex("hud/heart/withered_hardcore_full"),
         new aex("hud/heart/withered_hardcore_full_blinking"),
         new aex("hud/heart/withered_hardcore_half"),
         new aex("hud/heart/withered_hardcore_half_blinking")
      ),
      e(
         new aex("hud/heart/absorbing_full"),
         new aex("hud/heart/absorbing_full_blinking"),
         new aex("hud/heart/absorbing_half"),
         new aex("hud/heart/absorbing_half_blinking"),
         new aex("hud/heart/absorbing_hardcore_full"),
         new aex("hud/heart/absorbing_hardcore_full_blinking"),
         new aex("hud/heart/absorbing_hardcore_half"),
         new aex("hud/heart/absorbing_hardcore_half_blinking")
      ),
      f(
         new aex("hud/heart/frozen_full"),
         new aex("hud/heart/frozen_full_blinking"),
         new aex("hud/heart/frozen_half"),
         new aex("hud/heart/frozen_half_blinking"),
         new aex("hud/heart/frozen_hardcore_full"),
         new aex("hud/heart/frozen_hardcore_full_blinking"),
         new aex("hud/heart/frozen_hardcore_half"),
         new aex("hud/heart/frozen_hardcore_half_blinking")
      );
      ...
      private a(aex $$0, aex $$1, aex $$2, aex $$3, aex $$4, aex $$5, aex $$6, aex $$7) {
         this.g = $$0;
         this.h = $$1;
         this.i = $$2;
         this.j = $$3;
      ...
      public aex a(boolean $$0, boolean $$1, boolean $$2) {
         if (!$$0) {
            if ($$1) {
