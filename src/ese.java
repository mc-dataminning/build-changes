...
public class ese {
   ...
   public ese(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ese(esj $$0, esj $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static ese a(efi $$0) {
      return new ese((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static ese a(esj $$0) {
      return new ese($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static ese a(id $$0, id $$1) {
      return new ese(
   ...
   public ese a(double $$0) {
      return new ese($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ese b(double $$0) {
      return new ese(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ese c(double $$0) {
      return new ese(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ese d(double $$0) {
      return new ese(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ese e(double $$0) {
      return new ese(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ese f(double $$0) {
      return new ese(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ese b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ese c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ese d(double $$0, double $$1, double $$2) {
      return new ese(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ese f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ese h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<esj> b(esj $$0, esj $$1) {
      double[] $$2 = new double[]{1.0};
      double $$3 = $$1.c - $$0.c;
      double $$4 = $$1.d - $$0.d;
      double $$5 = $$1.e - $$0.e;
      ij $$6 = a(this, $$0, $$2, null, $$3, $$4, $$5);
      if ($$6 == null) {
   ...
   @Nullable
   public static esf a(Iterable<ese> $$0, esj $$1, esj $$2, id $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new esf($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static ij a(ese $$0, esj $$1, double[] $$2, @Nullable ij $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.a, $$0.b, $$0.e, $$0.c, $$0.f, ij.e, $$1.c, $$1.d, $$1.e);
      } else if ($$4 < -1.0E-7) {
         $$3 = a($$2, $$3, $$4, $$5, $$6, $$0.d, $$0.b, $$0.e, $$0.c, $$0.f, ij.f, $$1.c, $$1.d, $$1.e);
      }

      if ($$5 > 1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.b, $$0.c, $$0.f, $$0.a, $$0.d, ij.a, $$1.d, $$1.e, $$1.c);
      } else if ($$5 < -1.0E-7) {
         $$3 = a($$2, $$3, $$5, $$6, $$4, $$0.e, $$0.c, $$0.f, $$0.a, $$0.d, ij.b, $$1.d, $$1.e, $$1.c);
      }

      if ($$6 > 1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.c, $$0.a, $$0.d, $$0.b, $$0.e, ij.c, $$1.e, $$1.c, $$1.d);
      } else if ($$6 < -1.0E-7) {
         $$3 = a($$2, $$3, $$6, $$4, $$5, $$0.f, $$0.a, $$0.d, $$0.b, $$0.e, ij.d, $$1.e, $$1.c, $$1.d);
      }
   ...
   public esj f() {
      return new esj(axm.d(0.5, this.a, this.d), axm.d(0.5, this.b, this.e), axm.d(0.5, this.c, this.f));
   }

   public static ese a(esj $$0, double $$1, double $$2, double $$3) {
      return new ese($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
