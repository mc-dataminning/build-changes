...
public abstract class bka extends DataFix {
   private final String a;

   public bka(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(bjm.B.typeName(), blh.a());
      if (!Objects.equals(this.getOutputSchema().getType(bjm.B), $$2)) {
