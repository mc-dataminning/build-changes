...
public class bka {
   ...
   private bka(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bka a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bka($$0, $$1);
   }

   public bka.d a() throws IOException {
      bka.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bka.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bka.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bka.c $$3 = bka.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bka.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bka.a($$0, $$3);
            }
         }
   ...
   public bka.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bka.c> $$2 = this.a().c();
      ...
      bka.e $$4 = new bka.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bka.c b) implements bka.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bka.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bka.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bka.b> {
      private final List<bka.b> a;

      d(List<bka.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bka.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bka.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bka.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bka.d a() {
         ListIterator<bka.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bka.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bka.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bka.b> b() {
         return this.a.stream();
      }

      public Set<bka.c> c() {
         return this.a.stream().map(bka.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bka.c b) implements bka.b {
