...
public class bka extends DataFix {
   ...
   private static final ImmutableMap<String, bka.a> j = ImmutableMap.builder()
      .put("minecraft:village", new bka.a(32, 8, 10387312))
      .put("minecraft:desert_pyramid", new bka.a(32, 8, 14357617))
      .put("minecraft:igloo", new bka.a(32, 8, 14357618))
      .put("minecraft:jungle_pyramid", new bka.a(32, 8, 14357619))
      .put("minecraft:swamp_hut", new bka.a(32, 8, 14357620))
      .put("minecraft:pillager_outpost", new bka.a(32, 8, 165745296))
      .put("minecraft:monument", new bka.a(32, 5, 10387313))
      .put("minecraft:endcity", new bka.a(20, 11, 10387313))
      .put("minecraft:mansion", new bka.a(80, 20, 10387319))
      .build();
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("WorldGenSettings building", this.getInputSchema().getType(bis.M), $$0 -> $$0.update(DSL.remainderFinder(), bka::a));
   }
   ...
   private static <T> Map<Dynamic<T>, Dynamic<T>> a(DynamicOps<T> $$0, OptionalDynamic<T> $$1) {
      ...
      Map<String, bka.a> $$6 = Maps.newHashMap();
      if ($$1.result().isEmpty()) {
         $$5.setTrue();
         $$6.put("minecraft:village", (bka.a)j.get("minecraft:village"));
      }
                        ...
                        switch ($$9) {
                           ...
                           case "separation":
                              if ("oceanmonument".equals($$8)) {
                                 bka.a $$11 = $$6.getOrDefault("minecraft:monument", (bka.a)j.get("minecraft:monument"));
                                 int $$12 = a($$10, $$11.c, 1);
                                 $$6.put("minecraft:monument", new bka.a($$12, $$11.c, $$11.d));
                              }
      ...
      $$7.put(
         ...
         $$1.createMap(
            $$6.entrySet().stream().collect(Collectors.toMap($$1x -> $$1.createString((String)$$1x.getKey()), $$1x -> ((bka.a)$$1x.getValue()).a($$0)))
         )
      );
      if ($$5.isTrue()) {
         $$7.put(
   ...
   private static void a(Map<String, bka.a> $$0, String $$1, String $$2, int $$3) {
      bka.a $$4 = $$0.getOrDefault($$1, (bka.a)j.get($$1));
      int $$5 = a($$2, $$4.b, $$3);
      $$0.put($$1, new bka.a($$5, $$4.c, $$4.d));
   }

   static final class a {
      public static final Codec<bka.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
