...
public class dw {
   private static final ThreadLocal<gu<dv>> f = new ThreadLocal<>();
   ...
   private final CommandDispatcher<dv> h = new CommandDispatcher();

   public dw(dw.a $$0, dr $$1) {
      ala.a(this.h);
      alb.a(this.h, $$1);
      alv.a(this.h, $$1);
      alf.a(this.h, $$1);
   ...
   public void a(dv $$0, String $$1) {
      $$1 = $$1.startsWith("/") ? $$1.substring(1) : $$1;
      this.a(this.h.parse($$1, $$0), $$1);
   }

   public void a(ParseResults<dv> $$0, String $$1) {
      dv $$2 = (dv)$$0.getContext().getSource();
      $$2.l().aU().a(() -> "/" + $$1);
      ContextChain<dv> $$3 = a($$0, $$1, $$2);

      try {
         if ($$3 != null) {
            a($$2, $$3x -> gu.a($$3x, $$1, $$3, $$2, ds.a));
         }
      } catch (Exception var12) {
         ww $$5 = wi.b(var12.getMessage() == null ? var12.getClass().getName() : var12.getMessage());
         if (g.isDebugEnabled()) {
         ...
         $$2.b(wi.c("command.failed").a($$1x -> $$1x.a(new wo(wo.a.a, $$5))));
         if (aa.aW) {
            $$2.b(wi.b(ac.c(var12)));
   ...
   @Nullable
   private static ContextChain<dv> a(ParseResults<dv> $$0, String $$1, dv $$2) {
      try {
         a($$0);
         return (ContextChain<dv>)ContextChain.tryFlatten($$0.getContext().build($$1))
            .orElseThrow(() -> CommandSyntaxException.BUILT_IN_EXCEPTIONS.dispatcherUnknownCommand().createWithContext($$0.getReader()));
      } catch (CommandSyntaxException var7) {
         $$2.b(wl.a(var7.getRawMessage()));
         if (var7.getInput() != null && var7.getCursor() >= 0) {
            int $$4 = Math.min(var7.getInput().length(), var7.getCursor());
            ww $$5 = wi.i().a(n.h).a($$1x -> $$1x.a(new wg(wg.a.d, "/" + $$1)));
            if ($$4 > 10) {
               $$5.b(wh.u);
            }
            ...
            if ($$4 < var7.getInput().length()) {
               wi $$6 = wi.b(var7.getInput().substring($$4)).a(n.m, n.t);
               $$5.b($$6);
            }

            $$5.b(wi.c("command.context.here").a(n.m, n.u));
            $$2.b($$5);
         }
   ...
   public static void a(dv $$0, Consumer<gu<dv>> $$1) {
      MinecraftServer $$2 = $$0.l();
      gu<dv> $$3 = f.get();
      boolean $$4 = $$3 == null;
      if ($$4) {
         int $$5 = Math.max(1, $$2.aN().c(czc.x));
         int $$6 = $$2.aN().c(czc.y);

         try (gu<dv> $$7 = new gu<>($$5, $$6, $$2.aU())) {
            f.set($$7);
            $$1.accept($$7);
            $$7.a();
         } finally {
   ...
   public void a(apv $$0) {
      Map<CommandNode<dv>, CommandNode<ea>> $$1 = Maps.newHashMap();
      RootCommandNode<ea> $$2 = new RootCommandNode();
      $$1.put(this.h.getRoot(), $$2);
      this.a(this.h.getRoot(), $$2, $$0.dd(), $$1);
      $$0.d.b(new abt($$2));
   }

   private void a(CommandNode<dv> $$0, CommandNode<ea> $$1, dv $$2, Map<CommandNode<dv>, CommandNode<ea>> $$3) {
      for (CommandNode<dv> $$4 : $$0.getChildren()) {
         if ($$4.canUse($$2)) {
            ArgumentBuilder<ea, ?> $$5 = $$4.createBuilder();
            $$5.requires($$0x -> true);
            ...
            if ($$5 instanceof RequiredArgumentBuilder) {
               RequiredArgumentBuilder<ea, ?> $$6 = (RequiredArgumentBuilder<ea, ?>)$$5;
               if ($$6.getSuggestionsProvider() != null) {
                  $$6.suggests(ht.b($$6.getSuggestionsProvider()));
               }
            }
   ...
   public static LiteralArgumentBuilder<dv> a(String $$0) {
      return LiteralArgumentBuilder.literal($$0);
   }

   public static <T> RequiredArgumentBuilder<dv, T> a(String $$0, ArgumentType<T> $$1) {
      return RequiredArgumentBuilder.argument($$0, $$1);
   }

   public static Predicate<String> a(dw.b $$0) {
      return $$1 -> {
         try {
   ...
   public static dr a(final ip.a $$0) {
      return new dr() {
         @Override
         ...
         @Override
         public <T> Optional<ip.b<T>> a(aju<? extends ja<? extends T>> $$0x) {
            return $$0.a($$0).map(this::a);
         }

         private <T> ip.b.a<T> a(final ip.b<T> $$0x) {
            return new ip.b.a<T>() {
               @Override
               public ip.b<T> a() {
                  return $$0;
               ...
               @Override
               public Optional<ir.c<T>> a(avt<T> $$0xx) {
                  return Optional.of(this.b($$0));
               }

               @Override
               public ir.c<T> b(avt<T> $$0xx) {
                  Optional<ir.c<T>> $$1 = this.a().a($$0);
                  return $$1.orElseGet(() -> ir.a(this.a(), $$0));
               }
            };
         }
      };
   ...
   public static void b() {
      dr $$0 = a(oj.a());
      CommandDispatcher<dv> $$1 = new dw(dw.a.a, $$0).a();
      RootCommandNode<dv> $$2 = $$1.getRoot();
      $$1.findAmbiguities(
         ($$1x, $$2x, $$3x, $$4x) -> g.warn("Ambiguity between arguments {} and {} with inputs: {}", new Object[]{$$1.getPath($$2x), $$1.getPath($$3x), $$4x})
      );
      Set<ArgumentType<?>> $$3 = hr.a($$2);
      Set<ArgumentType<?>> $$4 = $$3.stream().filter($$0x -> !hq.a($$0x.getClass())).collect(Collectors.toSet());
      if (!$$4.isEmpty()) {
