...
public class akp<E> implements Codec<jv<E>> {
   ...
   public static <E> Codec<jv<E>> a(aku<? extends ke<E>> $$0, Codec<jr<E>> $$1, boolean $$2) {
      return new akp<>($$0, $$1, $$2);
   }

   private akp(aku<? extends ke<E>> $$0, Codec<jr<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
