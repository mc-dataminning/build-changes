...
public class akp {
   ...
   private static int a(du $$0, Collection<? extends asw<?>> $$1) {
      if ($$1.isEmpty()) {
         $$0.a(() -> vu.c("commands.banlist.none"), false);
      } else {
         $$0.a(() -> vu.a("commands.banlist.list", $$1.size()), false);

         for (asw<?> $$2 : $$1) {
            $$0.a(() -> vu.a("commands.banlist.entry", $$2.e(), $$2.b(), $$2.d()), false);
         }
      }
