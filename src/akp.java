...
public class akp {
   ...
   private boolean t;
   @Nullable
   private List<aeh.b<?>> u;

   public akp(akq $$0, biq $$1, int $$2, boolean $$3, Consumer<vd<?>> $$4) {
      this.f = $$0;
      this.j = $$4;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
      this.k.e($$1.dk());
      this.l = arw.d($$1.dB() * 256.0F / 360.0F);
      this.m = arw.d($$1.dD() * 256.0F / 360.0F);
      this.n = arw.d($$1.co() * 256.0F / 360.0F);
      this.t = $$1.aA();
      this.u = $$1.al().c();
   }
   ...
   public void a() {
      ...
      if (!$$0.equals(this.r)) {
         this.j.accept(new aae(this.g));
         a($$0, this.r).forEach($$0x -> {
            if ($$0x instanceof akr $$1) {
      ...
      if (this.p % this.h == 0 || this.g.au || this.g.al().a()) {
         if (this.g.bN()) {
            int $$7 = arw.d(this.g.dB() * 256.0F / 360.0F);
            int $$8 = arw.d(this.g.dD() * 256.0F / 360.0F);
            boolean $$9 = Math.abs($$7 - this.l) >= 1 || Math.abs($$8 - this.m) >= 1;
            if ($$9) {
               this.j.accept(new yo.c(this.g.ah(), (byte)$$7, (byte)$$8, this.g.aA()));
               this.l = $$7;
               this.m = $$8;
            }
            ...
            this.q++;
            int $$10 = arw.d(this.g.dB() * 256.0F / 360.0F);
            int $$11 = arw.d(this.g.dD() * 256.0F / 360.0F);
            ehn $$12 = this.g.dk();
            ...
            if (this.p > 0 || this.g instanceof cca) {
               ...
               if ($$22 || this.q > 400 || this.s || this.t != this.g.aA()) {
                  ...
                  if ($$15) {
                     $$14 = new yo.a(this.g.ah(), (short)((int)$$19), (short)((int)$$20), (short)((int)$$21), this.g.aA());
                     $$17 = true;
                  } else if ($$16) {
                     $$14 = new yo.c(this.g.ah(), (byte)$$10, (byte)$$11, this.g.aA());
                     $$18 = true;
                  }
               } else {
                  $$14 = new yo.b(this.g.ah(), (short)((int)$$19), (short)((int)$$20), (short)((int)$$21), (byte)$$10, (byte)$$11, this.g.aA());
                  $$17 = true;
                  $$18 = true;
               }
            }
            ...
            if ((this.i || this.g.au || this.g instanceof bjg && ((bjg)this.g).fv()) && this.p > 0) {
               ...
               if ($$24 > 1.0E-7 || $$24 > 0.0 && $$23.g() == 0.0) {
                  this.o = $$23;
                  this.j.accept(new zz(this.g.ah(), this.o));
               }
            }
         ...
         int $$25 = arw.d(this.g.co() * 256.0F / 360.0F);
         if (Math.abs($$25 - this.n) >= 1) {
            this.j.accept(new zh(this.g, (byte)$$25));
            this.n = $$25;
         }
   ...
   public void a(akr $$0, Consumer<vd<ww>> $$1) {
      if (this.g.dG()) {
         b.warn("Fetching packet for removed entity {}", this.g);
      }

      vd<ww> $$2 = this.g.di();
      this.n = arw.d(this.g.co() * 256.0F / 360.0F);
      $$1.accept($$2);
      if (this.u != null) {
         $$1.accept(new zx(this.g.ah(), this.u));
      }
      ...
      if ($$3 && !(this.g instanceof bjg)) {
         $$1.accept(new zz(this.g.ah(), this.o));
      }
      ...
      if (this.g instanceof bjg) {
         ...
         if (!$$5.isEmpty()) {
            $$1.accept(new aaa(this.g.ah(), $$5));
         }
      }

      if (!this.g.cP().isEmpty()) {
         $$1.accept(new aae(this.g));
      }

      if (this.g.bN()) {
         $$1.accept(new aae(this.g.cY()));
      }

      if (this.g instanceof bji $$8 && $$8.fR()) {
         $$1.accept(new zy($$8, $$8.fS()));
      }
   }
   ...
   private void b() {
      ...
      if ($$1 != null) {
         this.u = $$0.c();
         this.a(new zx(this.g.ah(), $$1));
      }

      if (this.g instanceof bjg) {
         Set<bki> $$2 = ((bjg)this.g).eQ().a();
         if (!$$2.isEmpty()) {
            this.a(new aaw(this.g.ah(), $$2));
         }
