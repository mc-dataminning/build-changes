...
public class blj implements blk {
   ...
   private static final blj k = new blj();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bli $$0) {
      URL $$1 = blj.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bli $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final blm a = new blm(() -> blj.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == blj.this.l && $$0.getState() == RecordingState.STOPPED) {
