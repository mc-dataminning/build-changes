...
public class blj {
   ...
   private blj(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static blj a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new blj($$0, $$1);
   }

   public blj.d a() throws IOException {
      blj.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new blj.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private blj.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         blj.c $$3 = blj.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new blj.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new blj.a($$0, $$3);
            }
         }
   ...
   public blj.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<blj.c> $$2 = this.a().c();
      ...
      blj.e $$4 = new blj.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, blj.c b) implements blj.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static blj.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new blj.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<blj.b> {
      private final List<blj.b> a;

      d(List<blj.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public blj.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            blj.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  blj.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public blj.d a() {
         ListIterator<blj.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               blj.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<blj.b> iterator() {
         return this.a.iterator();
      }

      public Stream<blj.b> b() {
         return this.a.stream();
      }

      public Set<blj.c> c() {
         return this.a.stream().map(blj.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, blj.c b) implements blj.b {
