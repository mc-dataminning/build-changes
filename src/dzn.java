...
public class dzn {
   private static final dta a = dfy.hj.o();
   private static final dta b = dfy.hk.o();
   private static final dta c = dfy.iA.o();
   private static final dta d = dfy.hn.o();
   private static final dta e = dfy.hv.o();
   private static final dta f = dfy.hx.o();
   private static final dta g = dfy.hr.o();
   private static final dta h = dfy.iC.o();
   private static final dta i = dfy.dP.o();
   private final dta j;
   private final int k;
   private final dta[] l;
   private final eob m;
   ...
   public dzn(dzj $$0, dta $$1, int $$2, dzi $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dze.P);
      this.l = a($$3.a(akq.b("clay_bands")));
      this.u = $$0.a(dze.N);
      this.v = $$0.a(dze.O);
      this.n = $$0.a(dze.Q);
      this.o = $$0.a(dze.R);
   ...
   public void a(dzj $$0, ddw $$1, jz<ddu> $$2, boolean $$3, dzs $$4, final duw $$5, dyz $$6, dzm.o $$7) {
      ...
      dzm.g $$13 = new dzm.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dzm.u $$14 = $$7.apply($$13);
      jd.a $$15 = new jd.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dyv.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            jm<ddu> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(deb.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dyv.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dta> a(dzm.o $$0, eaw $$1, Function<jd, jm<ddu>> $$2, duw $$3, dyz $$4, jd $$5, boolean $$6) {
      dzm.g $$7 = new dzm.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(lu.aF), $$1);
      dzm.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dta $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dut $$0, int $$1, int $$2, int $$3, dcw $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, ddu $$1, dut $$2, jd.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dfy.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(ayv $$0, dta[] $$1, int $$2, dta $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dta a(int $$0, int $$1, int $$2) {
