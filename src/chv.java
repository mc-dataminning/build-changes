...
public class chv {
   ...
   @VisibleForTesting
   protected final ArrayList<bow> c;
   private final chv.a k;
   @VisibleForTesting
   protected final Object2IntMap<bow> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<chv> a(Predicate<bow> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(chv::b)).apply($$1, $$1x -> new chv($$0, $$1x))
      );
   }

   public chv(Predicate<bow> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new chv.a(this);
   ...
   public void a(apf $$0, Predicate<bow> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<bow>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<bow> $$6 = (Entry<bow>)$$5.next();
         int $$7 = $$6.getIntValue();
         bow $$8 = (bow)$$6.getKey();
         bow.c $$9 = $$8.dI();
   ...
   public int b(@Nullable bow $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bpo> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bpo).map($$0 -> (bpo)$$0);
   }

   @VisibleForTesting
   protected static record a(chv a) implements Comparator<bow> {
      public int a(bow $$0, bow $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cis;
               boolean $$7 = $$1 instanceof cis;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
