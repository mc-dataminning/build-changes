...
public class chv extends bwy implements bxb<jq<chw>> {
   public static final double cd = 0.6;
   public static final double ce = 0.8;
   public static final double cf = 1.33;
   private static final alc<jq<chw>> cg = alg.a(chv.class, ale.x);
   private static final alc<Boolean> ch = alg.a(chv.class, ale.k);
   private static final alc<Boolean> ci = alg.a(chv.class, ale.k);
   private static final alc<Integer> cj = alg.a(chv.class, ale.b);
   private static final aly<chw> ck = chw.c;
   @Nullable
   private chv.a<cps> cl;
   @Nullable
   private ceh cm;
   private float cn;
   private float co;
   ...
   public chv(bvm<? extends chv> $$0, dha $$1) {
      super($$0, $$1);
      this.gE();
   }
   ...
   @Override
   protected void B() {
      this.cm = new chv.c(this, 0.6, $$0 -> $$0.a(ayd.aj), true);
      this.bT.a(1, new cct(this));
      this.bT.a(1, new bwy.a(1.5));
      this.bT.a(2, new cee(this));
      this.bT.a(3, new chv.b(this));
      this.bT.a(4, this.cm);
      this.bT.a(5, new ccm(this, 1.1, 8));
      this.bT.a(6, new ccx(this, 1.0, 10.0F, 5.0F));
      this.bT.a(7, new ccn(this, 0.8));
      this.bT.a(8, new cdf(this, 0.3F));
      this.bT.a(9, new cdp(this));
      this.bT.a(10, new ccl(this, 0.8));
      this.bT.a(11, new cem(this, 0.8, 1.0000001E-5F));
      this.bT.a(12, new cdh(this, cps.class, 10.0F));
      this.bU.a(1, new cev<>(this, cim.class, false, null));
      this.bU.a(1, new cev<>(this, cit.class, false, cit.bZ));
   }
   ...
   protected axe u() {
      if (this.p()) {
         if (this.gw()) {
            ...
            return this.ae.a(4) == 0 ? axf.dZ : axf.dR;
         }
      } else {
         return axf.dS;
      }
   ...
   private void gG() {
      if ((this.gz() || this.gF()) && this.af % 5 == 0) {
         this.a(axf.dY, 0.6F + 0.4F * (this.ae.i() - this.ae.i()), 1.0F);
      }
      ...
      if (this.gz()) {
         ...
         for (cps $$2 : this.dV().a(cps.class, new fbn($$0).c(2.0, 2.0, 2.0))) {
            if ($$2.fP()) {
               this.cr = true;
               break;
            }
   ...
   @Nullable
   public chv b(ash $$0, buw $$1) {
      chv $$2 = bvm.u.a($$0, bvl.e);
      if ($$2 != null && $$1 instanceof chv $$3) {
         if (this.ae.h()) {
            $$2.j(this.gy());
         } else {
            $$2.j($$3.gy());
   ...
   public boolean a(chs $$0) {
      if (!this.p()) {
         ...
         return !($$0 instanceof chv $$1) ? false : $$1.p() && super.a($$0);
      }
   }
   ...
   protected void gE() {
      if (this.cl == null) {
         this.cl = new chv.a<>(this, cps.class, 16.0F, 0.8, 1.33);
      }
   ...
   static class a<T extends bwb> extends ccg<T> {
      ...
      public a(chv $$0, Class<T> $$1, float $$2, double $$3, double $$4) {
   ...
   static class b extends ccz {
      ...
      public boolean b() {
         if (!this.a.p()) {
            ...
            if ($$0 instanceof cps) {
               ...
               jh $$1 = this.b.dv();
               dxn $$2 = this.a.dV().a_($$1);
               if ($$2.a(axu.T)) {
                  this.c = $$2.d(djx.aF).map($$1x -> $$1.a($$1x.g())).orElseGet(() -> new jh($$1));
                  return !this.h();
               }
            }
      ...
      private boolean h() {
         for (chv $$1 : this.a.dV().a(chv.class, new fbn(this.c).g(2.0))) {
   ...
   static class c extends ceh {
      @Nullable
      private cps c;
      private final chv d;

      public c(chv $$0, double $$1, Predicate<cxk> $$2, boolean $$3) {
         super($$0, $$1, $$2, $$3);
         this.d = $$0;
      }
