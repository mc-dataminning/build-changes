...
public class fmo {
   ...
   public ya a(ya $$0, int $$1, ys $$2) {
      final fmo.e $$3 = new fmo.e((float)$$1);
   ...
   public void a(String $$0, int $$1, ys $$2, boolean $$3, fmo.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      ys $$7 = $$2;

      while ($$5 < $$6) {
         fmo.b $$8 = new fmo.b((float)$$1);
   ...
   public void a(ya $$0, int $$1, ys $$2, BiConsumer<ya, Boolean> $$3) {
      List<fmo.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new fmo.c($$2x, $$1x));
         }
   ...
   static class a {
      ...
      public ya a(int $$0, int $$1, ys $$2) {
         fls $$3 = new fls();
         ListIterator<fmo.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, ys $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = fmo.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements azr {
      ...
      @Override
      public boolean accept(int $$0, ys $$1, int $$2) {
         this.b = this.b - fmo.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
