...
public class fmo extends fmw {
   ...
   private static final int d = ayi.b.a(255, 239, 50, 61);
   private static final int e = ayi.b.a(255, 0, 0, 0);
   private static final IntSupplier f = () -> ffe.Q().m.a().c() ? e : d;
   ...
   public fmo(ffe $$0, auk $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(fgq $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         $$0.a(gdv.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         ...
         $$0.a(gdv.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         ...
         GlStateManager._clear(16384, ffe.a);
         $$10 = 1.0F;
      }
      ...
      float $$25 = this.n.b();
      this.q = ayy.a(this.q * 0.95F + $$25 * 0.050000012F, 0.0F, 1.0F);
      if ($$7 < 1.0F) {
         this.a($$0, $$4 / 2 - $$23, $$24 - 5, $$4 / 2 + $$23, $$24 + 5, 1.0F - ayy.a($$7, 0.0F, 1.0F));
      }
   ...
   private void a(fgq $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      int $$6 = ayy.f((float)($$3 - $$1 - 2) * this.q);
      int $$7 = Math.round($$5 * 255.0F);
      int $$8 = ayi.b.a($$7, 255, 255, 255);
   ...
   static class a extends gor {
      ...
      protected gor.a b(auo $$0) {
         ate $$1 = ffe.Q().ad();
         aug<InputStream> $$2 = $$1.a(atc.a, fmo.c);
         if ($$2 == null) {
            return new gor.a(new FileNotFoundException(fmo.c.toString()));
         } else {
            try {
               gor.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gor.a(new gqv(true, true), eyy.a($$3));
               }

               return var5;
            } catch (IOException var9) {
               return new gor.a(var9);
            }
         }
      }
   }
