...
public class fmo {
   ...
   public static void a(File $$0, ffc $$1, Consumer<xv> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, ffc $$2, Consumer<xv> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, ffc $$2, Consumer<xv> $$3) {
      ffs $$4 = a($$2);
   ...
   public static ffs a(ffc $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      ffs $$3 = new ffs($$1, $$2, false);
   ...
   public fmo(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
