...
public record cz(ct.d d, Optional<dau> e, List<cz.e<?>> f, Object2BooleanMap<akm> g, Map<akm, cz.c> h, Optional<br> i) implements bs {
   public static final int b = 100;
   public static final MapCodec<cz> c = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ct.d.d.optionalFieldOf("level", ct.d.c).forGetter(cz::b),
               dau.f.optionalFieldOf("gamemode").forGetter(cz::c),
               cz.e.a.listOf().optionalFieldOf("stats", List.of()).forGetter(cz::d),
               axm.d(akm.a).optionalFieldOf("recipes", Object2BooleanMaps.emptyMap()).forGetter(cz::e),
               Codec.unboundedMap(akm.a, cz.c.b).optionalFieldOf("advancements", Map.of()).forGetter(cz::f),
   ...
   public boolean a(bru $$0, aqm $$1, @Nullable euk $$2) {
      if (!($$0 instanceof aqn $$3)) {
         ...
         while (var13.hasNext()) {
            Entry<akm> $$8 = (Entry<akm>)var13.next();
            if ($$7.b((akm)$$8.getKey()) != $$8.getBooleanValue()) {
               return false;
            }
         }
         ...
         if (!this.h.isEmpty()) {
            ...
            for (java.util.Map.Entry<akm, cz.c> $$11 : this.h.entrySet()) {
         ...
         if (this.i.isPresent()) {
            euk $$13 = $$3.bx();
            euk $$14 = $$3.f(1.0F);
            euk $$15 = $$13.b($$14.c * 100.0, $$14.d * 100.0, $$14.e * 100.0);
            euh $$16 = cmq.a($$3.dP(), $$3, $$13, $$15, new euf($$13, $$15).g(1.0), $$0x -> !$$0x.N_(), 0.0F);
            if ($$16 == null || $$16.c() != eui.a.c) {
               return false;
            }
   ...
   public Object2BooleanMap<akm> e() {
      return this.g;
   }

   public Map<akm, cz.c> f() {
      return this.h;
   }
   ...
   static record a(Object2BooleanMap<String> c) implements cz.c {
      public static final Codec<cz.a> a = axm.d(Codec.STRING).xmap(cz.a::new, cz.a::a);
   ...
   public static class d {
      ...
      private Optional<dau> b = Optional.empty();
      private final Builder<cz.e<?>> c = ImmutableList.builder();
      private final Object2BooleanMap<akm> d = new Object2BooleanOpenHashMap();
      private final Map<akm, cz.c> e = Maps.newHashMap();
      ...
      public <T> cz.d a(avq<T> $$0, ix.c<T> $$1, ct.d $$2) {
         this.c.add(new cz.e<>($$0, $$1, $$2));
         return this;
      }

      public cz.d a(akm $$0, boolean $$1) {
         this.d.put($$0, $$1);
         return this;
      }
      ...
      public cz.d b(akm $$0, boolean $$1) {
         this.e.put($$0, new cz.b($$1));
         return this;
      }

      public cz.d a(akm $$0, Map<String, Boolean> $$1) {
   ...
   static record e<T>(avq<T> b, ix<T> c, ct.d d, Supplier<avo<T>> e) {
      public static final Codec<cz.e<?>> a = le.x.q().dispatch(cz.e::a, cz.e::a);

      public e(avq<T> $$0, ix<T> $$1, ct.d $$2) {
         this($$0, $$1, $$2, Suppliers.memoize(() -> $$0.b($$1.a())));
      }

      private static <T> MapCodec<cz.e<T>> a(avq<T> $$0) {
