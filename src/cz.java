...
public record cz(List<cz.c> b) {
   ...
   public <S extends dir<?, S>> boolean a(diq<?, S> $$0, S $$1) {
      for (cz.c $$2 : this.b) {
         if (!$$2.a($$0, $$1)) {
            return false;
         }
   ...
   public Optional<String> a(diq<?, ?> $$0) {
      for (cz.c $$1 : this.b) {
   ...
   public static class a {
      ...
      public cz.a a(djs<?> $$0, String $$1) {
         this.a.add(new cz.c($$0.f(), new cz.b($$1)));
         return this;
      }

      public cz.a a(djs<Integer> $$0, int $$1) {
         return this.a($$0, Integer.toString($$1));
      }

      public cz.a a(djs<Boolean> $$0, boolean $$1) {
         return this.a($$0, Boolean.toString($$1));
      }

      public <T extends Comparable<T> & aut> cz.a a(djs<T> $$0, T $$1) {
         return this.a($$0, $$1.c());
      }
   ...
   static record b(String c) implements cz.e {
      ...
      @Override
      public <T extends Comparable<T>> boolean a(dir<?, ?> $$0, djs<T> $$1) {
         T $$2 = $$0.c($$1);
   ...
   static record d(Optional<String> c, Optional<String> d) implements cz.e {
      public static final Codec<cz.d> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(atg.a(Codec.STRING, "min").forGetter(cz.d::a), atg.a(Codec.STRING, "max").forGetter(cz.d::b)).apply($$0, cz.d::new)
      );
   ...
   interface e {
      ...
      <T extends Comparable<T>> boolean a(dir<?, ?> var1, djs<T> var2);
   }
}
