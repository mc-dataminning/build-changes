...
public class ecy extends edd {
   public static final Codec<ecy> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, ecy::new));
   ...
   public List<ebl.a> a(czd $$0, BiConsumer<ib, doz> $$1, axr $$2, int $$3, ib $$4, eav $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = axk.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, axk.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<ecy.a> $$13 = Lists.newArrayList();
      $$13.add(new ecy.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               ib $$21 = $$4.b(axk.a($$19), $$12 - 1, axk.a($$20));
               ib $$22 = $$21.b(5);
      ...
      List<ebl.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(czd $$0, BiConsumer<ib, doz> $$1, axr $$2, ib $$3, ib $$4, boolean $$5, eav $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ib $$13 = $$3.b(axk.d(0.5F + (float)$$12 * $$9), axk.d(0.5F + (float)$$12 * $$10), axk.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dij.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(czd $$0, BiConsumer<ib, doz> $$1, axr $$2, int $$3, ib $$4, List<ecy.a> $$5, eav $$6) {
      for (ecy.a $$7 : $$5) {
         int $$8 = $$7.a();
