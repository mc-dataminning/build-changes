...
public class aeh {
   ...
   private final biq d;
   private final Int2ObjectMap<aeh.a<?>> e = new Int2ObjectOpenHashMap();
   ...
   public static <T> aee<T> a(Class<? extends biq> $$0, aef<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> void c(aee<T> $$0, T $$1) {
      aeh.a<T> $$2 = new aeh.a<>($$0, $$1);
      this.f.writeLock().lock();
      this.e.put($$0.a(), $$2);
      this.f.writeLock().unlock();
   }

   public <T> boolean a(aee<T> $$0) {
      return this.e.containsKey($$0.a());
   }

   private <T> aeh.a<T> c(aee<T> $$0) {
      this.f.readLock().lock();

      aeh.a<T> $$1;
      try {
         $$1 = (aeh.a<T>)this.e.get($$0.a());
   ...
   public <T> T b(aee<T> $$0) {
      return this.c($$0).b();
   }

   public <T> void b(aee<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(aee<T> $$0, T $$1, boolean $$2) {
      aeh.a<T> $$3 = this.c($$0);
   ...
   private <T> void a(aeh.a<T> $$0, aeh.b<?> $$1) {
   ...
   public static class a<T> {
      ...
      public aeh.b<T> e() {
         return aeh.b.a(this.a, this.b);
      }
   }

   public static record b<T>(int a, aef<T> b, T c) {

      public static <T> aeh.b<T> a(aee<T> $$0, T $$1) {
         aef<T> $$2 = $$0.b();
         return new aeh.b<>($$0.a(), $$2, $$2.a($$1));
      }
      ...
      public static aeh.b<?> a(so $$0, int $$1) {
         int $$2 = $$0.m();
         aef<?> $$3 = aeg.a($$2);
         if ($$3 == null) {
      ...
      private static <T> aeh.b<T> a(so $$0, int $$1, aef<T> $$2) {
         return new aeh.b<>($$1, $$2, $$2.a($$0));
      }
   }
}
