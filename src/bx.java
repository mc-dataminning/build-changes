...
public record bx(
   ...
   public static bi a(bx $$0) {
      fcq $$1 = fct.a(ezh.b.a, $$0).build();
      return new bi(List.of($$1));
   }

   public boolean a(arr $$0, @Nullable bwf $$1) {
      return this.a($$0.y(), $$0.dt(), $$1);
   }

   public boolean a(arq $$0, @Nullable feq $$1, @Nullable bwf $$2) {
      if ($$2 == null) {
         return false;
         ...
         if (this.f.b.isPresent() && !this.f.b.get().a($$0, $$2.dA(), $$2.dC(), $$2.dG())) {
            ...
            if (this.g.isPresent() && !this.g.get().a($$2)) {
               ...
               return false;
            } else if (this.o.isPresent() && !this.o.get().a($$0, $$1, $$2 instanceof bxg ? ((bxg)$$2).f() : null)) {
               return false;
   ...
   public static ezh b(arr $$0, bwf $$1) {
      ezk $$2 = new ezk.a($$0.y()).a(fcb.a, $$1).a(fcb.f, $$0.dt()).a(fca.n);
      return new ezh.a($$2).a(Optional.empty());
   }
   ...
   public static class a {
      ...
      public bx.a a(jf<bwo<?>> $$0, bwo<?> $$1) {
         this.a = Optional.of(ca.a($$0, $$1));
         return this;
      }

      public bx.a a(jf<bwo<?>> $$0, axr<bwo<?>> $$1) {
         this.a = Optional.of(ca.a($$0, $$1));
         return this;
      }
