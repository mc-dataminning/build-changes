...
public record bx(
   ...
   public boolean a(ard $$0, @Nullable buk $$1) {
      return this.a($$0.y(), $$0.du(), $$1);
   }

   public boolean a(arc $$0, @Nullable fba $$1, @Nullable buk $$2) {
      if ($$2 == null) {
         return false;
   ...
   public static evr b(ard $$0, buk $$1) {
      evu $$2 = new evu.a($$0.y()).a(eyl.a, $$1).a(eyl.f, $$0.du()).a(eyk.n);
