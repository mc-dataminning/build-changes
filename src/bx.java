...
public record bx(Optional<Boolean> d) implements bs {
   ...
   public static final MapCodec<bx> c = RecordCodecBuilder.mapCodec($$0 -> $$0.group(axh.a(Codec.BOOL, "in_open_water").forGetter(bx::b)).apply($$0, bx::new));
   ...
   public boolean a(brh $$0, aqh $$1, @Nullable etp $$2) {
      if (this.d.isEmpty()) {
         ...
         return $$0 instanceof clv $$3 ? this.d.get() == $$3.p() : false;
      }
   }
