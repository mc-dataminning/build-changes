public abstract class ewb extends ewf implements exk, eyc {
   private static final exu a = new exu(new agt("widget/text_field"), new agt("widget/text_field_highlighted"));
   private static final agt b = new agt("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean l;

   public ewb(int $$0, int $$1, int $$2, int $$3, vb $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int v() {
      return aty.a((int)((float)(this.g * this.g) / (float)this.w()), 32, this.g);
   }
   ...
   protected void a(double $$0) {
      this.e = aty.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(evw $$0, int $$1, int $$2, int $$3, int $$4) {
      agt $$5 = a.a(this.aL_(), this.aJ_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(evw var1, int var2, int var3, float var4);
}
