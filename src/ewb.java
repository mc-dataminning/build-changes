...
public class ewb {
   ...
   public void a(ewb.b $$0, List<aox> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new ewb.c($$0, $$1.stream().map(aox::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new ewb.c(ewb.b.c, ImmutableList.of());
      }

      this.b.c = new ewb.a($$0);
   }
   ...
   static class c {
      private final ewb.b a;
      private final List<String> b;
      @Nullable
      ewb.a c;
      boolean d;

      c(ewb.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
