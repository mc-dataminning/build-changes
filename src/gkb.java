public class gkb extends ghk {
   private static final int a = 12235202;

   protected gkb(gfk $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gjn $$8) {
   ...
   public static class a implements giv<lw> {
      ...
      public gis a(lw $$0, gfk $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         return new gkb($$1, $$2, $$3, $$4, $$9, $$10, $$11, 1.0F, this.a);
      }
   }
}
