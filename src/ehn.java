...
public class ehn extends ehl {
   ...
   public ehn(int $$0, int $$1, int $$2, bpw $$3, float $$4, bpw $$5, jq<dfy> $$6) {
      super($$0, $$1, $$2);
      this.b = $$3;
      this.h = $$4;
      this.i = $$5;
   ...
   public List<eft.a> a(ddc $$0, BiConsumer<jd, dtc> $$1, ayw $$2, int $$3, jd $$4, efd $$5) {
      ...
      for (int $$8 = 0; $$8 < $$3; $$8++) {
         ...
         if ($$8 == $$3 - 1) {
            $$6.add(new eft.a($$7.d($$4.u(), $$9 + 1, $$4.w()), 0, false));
         }
      }
   ...
   private void a(ddc $$0, BiConsumer<jd, dtc> $$1, ayw $$2, int $$3, efd $$4, List<eft.a> $$5, jd.a $$6, int $$7, ji $$8, int $$9, int $$10) {
      int $$11 = $$7 + $$9;
      int $$12 = $$6.u();
      int $$13 = $$6.w();
      int $$14 = $$9;
      ...
      if ($$11 - $$7 > 1) {
         ...
         $$5.add(new eft.a($$16, 0, false));
         $$5.add(new eft.a($$16.c(2), 0, false));
      }
   }
