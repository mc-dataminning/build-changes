...
public class ehn implements dsf.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ehn> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final awq<ehn> a = awq.a(f);
   private final ehr g;
   private final ehr h;
   private final ehr i;
   ...
   public static ehn a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ehn(new dtn(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ehn(ehr $$0, ehr $$1, ehr $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ehn(axd $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ehr.a($$0, IntStream.rangeClosed(-15, 0)),
         ehr.a($$0, IntStream.rangeClosed(-15, 0)),
         ehr.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ehn a(axd $$0) {
      return new ehn($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dsf.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eho $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ehr.b($$4 * $$13), ehr.b($$5 * $$13), ehr.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ehr.b($$1 * $$13);
         double $$21 = ehr.b($$2 * $$13);
         double $$22 = ehr.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eho $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return aww.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
