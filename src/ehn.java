...
public class ehn implements hq {
   ...
   public static ehn a(ib $$0) {
      return new ehn((double)$$0.u(), (double)$$0.v(), (double)$$0.w());
   }

   public static ehn a(ib $$0, double $$1, double $$2, double $$3) {
      return new ehn((double)$$0.u() + $$1, (double)$$0.v() + $$2, (double)$$0.w() + $$3);
   }

   public static ehn b(ib $$0) {
      return a($$0, 0.5, 0.5, 0.5);
   }

   public static ehn c(ib $$0) {
      return a($$0, 0.5, 0.0, 0.5);
   }

   public static ehn a(ib $$0, double $$1) {
   ...
   public ehn a(ehn $$0, double $$1) {
      return new ehn(arx.d($$1, this.c, $$0.c), arx.d($$1, this.d, $$0.d), arx.d($$1, this.e, $$0.e));
   }
   ...
   public static ehn a(float $$0, float $$1) {
      float $$2 = arx.b(-$$1 * (float) (Math.PI / 180.0) - (float) Math.PI);
      float $$3 = arx.a(-$$1 * (float) (Math.PI / 180.0) - (float) Math.PI);
      float $$4 = -arx.b(-$$0 * (float) (Math.PI / 180.0));
      float $$5 = arx.a(-$$0 * (float) (Math.PI / 180.0));
      return new ehn((double)($$3 * $$4), (double)$$5, (double)($$2 * $$4));
   }

   public ehn a(EnumSet<hc.a> $$0) {
      double $$1 = $$0.contains(hc.a.a) ? (double)arx.a(this.c) : this.c;
      double $$2 = $$0.contains(hc.a.b) ? (double)arx.a(this.d) : this.d;
      double $$3 = $$0.contains(hc.a.c) ? (double)arx.a(this.e) : this.e;
      return new ehn($$1, $$2, $$3);
   }
