...
public class dsh {
   ...
   private final Map<Character, Predicate<dsf>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dsh a(char $$0, Predicate<dsf> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dsg b() {
      return new dsg(this.c());
   }

   private Predicate<dsf>[][][] c() {
      this.d();
      Predicate<dsf>[][][] $$0 = (Predicate<dsf>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dsf>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
