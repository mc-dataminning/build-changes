...
public class bxo extends bxq {
   ...
   public bxo(brp $$0, double $$1, float $$2, float $$3, boolean $$4) {
      this.e = $$0;
      this.g = $$0.dM();
      this.h = $$1;
      this.i = $$0.K();
      ...
      if (!($$0.K() instanceof cad) && !($$0.K() instanceof cac)) {
   ...
   public boolean a() {
      ...
      if ($$0 == null) {
         ...
         return false;
      } else if (this.e.g((bqa)$$0) < (double)(this.l * this.l)) {
         return false;
      } else {
         this.f = $$0;
         return true;
   ...
   public boolean b() {
      if (this.i.l()) {
         ...
         return this.h() ? false : !(this.e.g((bqa)this.f) <= (double)(this.k * this.k));
      }
   }
   ...
   private boolean a(id $$0) {
      els $$1 = elx.b(this.e, $$0);
      if ($$1 != els.c) {
         return false;
      } else {
         dpi $$2 = this.g.a_($$0.d());
         if (!this.n && $$2.b() instanceof dgq) {
            return false;
         } else {
            id $$3 = $$0.b(this.e.dm());
