...
public class bhj {
   ...
   private JsonElement a(List<Pair<dli, bht<bhl>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bht)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dli, bht<bhl>> $$3 : $$0) {
         bht<bhl> $$4 = (bht<bhl>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dli)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bhr> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bgz.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bhh $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bhp $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bhp.b $$3 = (bhp.b)$$1x.getFirst();
         bhp.a $$4 = (bhp.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bhm> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bhm>, ToDoubleFunction<bhm>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bhm::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bhm::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bhm::c));
      return $$1;
   }
}
