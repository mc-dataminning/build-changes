...
public record cdp(cdp.a d) {
   ...
   public static final Codec<cdp> c = cdp.a.a.xmap(cdp::new, cdp::b);

   public static cdp a(att $$0, UUID $$1, cdp.a $$2) throws cdp.b {
      if (!$$2.a($$0, $$1)) {
         throw new cdp.b(e);
      } else {
         return new cdp($$2);
   ...
   public att a() {
      return att.a(this.d.c, "SHA256withRSA");
   }
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cdp.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  asq.m.fieldOf("expires_at").forGetter(cdp.a::b), ash.f.fieldOf("key").forGetter(cdp.a::c), asq.n.fieldOf("signature_v2").forGetter(cdp.a::d)
               )
               .apply($$0, cdp.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof cdp.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
