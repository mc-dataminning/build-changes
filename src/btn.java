...
public abstract class btn extends bss implements bsp {
   ...
   private static final but bF = new but(UUID.fromString("662A6B8D-DA3E-4C1C-8813-96EA6097278D"), "Sprinting speed boost", 0.3F, but.a.c);
   ...
   protected static final akj<Byte> aF = akn.a(btn.class, akl.a);
   private static final akj<Float> bK = akn.a(btn.class, akl.d);
   private static final akj<List<lg>> bL = akn.a(btn.class, akl.m);
   private static final akj<Boolean> bM = akn.a(btn.class, akl.k);
   private static final akj<Integer> bN = akn.a(btn.class, akl.b);
   private static final akj<Integer> bO = akn.a(btn.class, akl.b);
   private static final akj<Optional<iz>> bP = akn.a(btn.class, akl.p);
   private static final int bQ = 15;
   protected static final bsv aG = bsv.c(0.2F, 0.2F).b(0.2F);
   public static final float aH = 0.5F;
   public static final float aI = 0.5F;
   private static final float bR = 0.21875F;
   private final bus bS;
   private final bri bT = new bri(this);
   private final Map<ji<bry>, bsa> bU = Maps.newHashMap();
   private final jr<cun> bV = jr.a(2, cun.l);
   private final jr<cun> bW = jr.a(4, cun.l);
   private cun bX = cun.l;
   public boolean aJ;
   ...
   protected btn(bsy<? extends btn> $$0, dbw $$1) {
      super($$0, $$1);
      this.bS = new bus(buw.a($$0));
      this.t(this.eR());
      this.J = true;
   ...
   protected bup.b<?> dT() {
      return bup.a(ImmutableList.of(), ImmutableList.of());
   }
   ...
   public static buu.a dU() {
      return buu.a().a(buv.q).a(buv.n).a(buv.r).a(buv.a).a(buv.b).a(buv.p).a(buv.v).a(buv.t).a(buv.l).a(buv.s).a(buv.i).a(buv.m);
   }
   ...
   protected void a(double $$0, boolean $$1, dsa $$2, iz $$3) {
      ...
      if (!this.dP().B && $$1 && this.ac > 0.0F) {
         ...
         if ((double)this.ac > $$4 && !$$2.i()) {
            ...
            float $$12 = (float)ayx.c((double)this.ac - $$4);
            double $$13 = Math.min((double)(0.2F + $$12 / 15.0F), 2.5);
            int $$14 = (int)(150.0 * $$13);
            ((are)this.dP()).a(new la(li.b, $$2), $$5, $$6, $$7, $$14, 0.0, 0.0, 0.0, 0.15F);
         }
      }
   ...
   public void au() {
         ...
         if (!this.dP().B) {
            if (this.bE()) {
               ...
               if ($$1 < 0.0) {
                  ...
                  if ($$2 > 0.0) {
                     this.a(this.dQ().v(), (float)Math.max(1, ayx.a(-$$1 * $$2)));
                  }
               }
            }
         }

         if (this.a(awu.a) && !this.dP().a_(iz.a(this.du(), this.dy(), this.dA())).a(dez.nd)) {
            boolean $$3 = !this.dV() && !bsb.c(this) && (!$$0 || !((cmv)this).gd().a);
            if ($$3) {
      ...
      if (this.am > 0 && !(this instanceof arf)) {
         this.am--;
      }
   ...
   public boolean dW() {
      return this.ai % 5 == 0 && this.ds().c != 0.0 && this.ds().e != 0.0 && !this.N_() && czz.k(this) && this.dY();
   }
   ...
   protected void dX() {
      ...
      this.a(avz.xN, $$1, 0.6F + this.ah.i() * 0.4F);
   }

   protected boolean dY() {
      return this.dP().a_(this.aK()).a(awo.aN);
   }

   @Override
   protected float aN() {
      return this.dY() && czz.a(dab.l, this) > 0 ? 1.0F : super.aN();
   }
   ...
   protected void ea() {
      if (!this.bo().i()) {
         ...
         if ($$0 > 0 && this.dY()) {
            ...
            $$1.c(new but(d, "Soul speed boost", (double)(0.03F * (1.0F + (float)$$0 * 0.35F)), but.a.a));
            if (this.el().i() < 0.04F) {
               cun $$2 = this.a(bsz.c);
               $$2.a(1, this, bsz.c);
            }
   ...
   protected void ec() {
      if (!this.bo().i()) {
         ...
         if ($$0 > 0) {
            ...
            $$1.c(new but(e, "Powder snow slow", (double)$$2, but.a.a));
         }
      }
   }

   protected void c(iz $$0) {
      int $$1 = czz.a(dab.j, this);
      if ($$1 > 0) {
         dac.a(this, this.dP(), $$0, $$1);
      }
   ...
   public float ee() {
      bus $$0 = this.eW();
      return $$0 == null ? 1.0F : this.b((float)$$0.c(buv.t));
   }
   ...
   public void a(bsz $$0, cun $$1, cun $$2) {
      boolean $$3 = $$2.e() && $$1.e();
      if (!$$3 && !cun.c($$1, $$2) && !this.an) {
         ctp $$4 = ctp.c_($$2);
   ...
   protected void es() {
      Iterator<ji<bry>> $$0 = this.bU.keySet().iterator();
   ...
   private void s() {
      List<lg> $$0 = this.bU.values().stream().filter(bsa::g).map(bsa::a).toList();
      this.ao.a(bL, $$0);
   ...
   public double B(@Nullable bss $$0) {
      double $$1 = 1.0;
      if (this.bY()) {
         $$1 *= 0.8;
      }
   ...
   public boolean c(btn $$0) {
      return $$0 instanceof cmv && this.dP().al() == bqp.a ? false : $$0.et();
   }

   public boolean a(btn $$0, cee $$1) {
      return $$1.a(this, $$0);
   }
   ...
   public static boolean c(Collection<bsa> $$0) {
      for (bsa $$1 : $$0) {
         if ($$1.g() && !$$1.f()) {
            return false;
         }
   ...
   public boolean ew() {
      if (this.dP().B) {
         ...
         Iterator<bsa> $$0 = this.bU.values().iterator();
   ...
   public Collection<bsa> ex() {
      return this.bU.values();
   }

   public Map<ji<bry>, bsa> ey() {
      return this.bU;
   }

   public boolean b(ji<bry> $$0) {
      return this.bU.containsKey($$0);
   }

   @Nullable
   public bsa c(ji<bry> $$0) {
      return this.bU.get($$0);
   }

   public final boolean b(bsa $$0) {
   ...
   public boolean c(bsa $$0) {
      if (this.ak().a(aws.G)) {
         return !$$0.a(bsc.M);
      } else if (this.ak().a(aws.F)) {
         return !$$0.a(bsc.L);
      } else {
         return !this.ak().a(aws.w) ? true : !$$0.a(bsc.j) && !$$0.a(bsc.s);
      }
   }

   public void c(bsa $$0, @Nullable bss $$1) {
      if (this.c($$0)) {
         bsa $$2 = this.bU.put($$0.c(), $$0);
         if ($$2 == null) {
            this.a($$0, $$1);
         } else {
            $$0.d($$2);
   ...
   public void t(float $$0) {
      this.ao.a(bK, ayx.a($$0, 0.0F, this.eR()));
   }
   ...
   public boolean a(brl $$0, float $$1) {
      if (this.b($$0)) {
         ...
         return false;
      } else if ($$0.a(awq.j) && this.b(bsc.l)) {
         return false;
      } else {
         ...
         if ($$1 > 0.0F && this.f($$0)) {
            ...
            $$4 = $$1;
            $$1 = 0.0F;
            if (!$$0.a(awq.k) && $$0.c() instanceof btn $$6) {
               this.d($$6);
            }
         ...
         if ($$0.a(awq.p) && this.ak().a(aws.l)) {
            $$1 *= 5.0F;
         }

         if ($$0.a(awq.a) && !this.a(bsz.f).e()) {
            this.c($$0, $$1);
            $$1 *= 0.75F;
         }
         ...
         this.aU.a(1.5F);
         boolean $$7 = true;
         if ((float)this.am > 10.0F && !$$0.a(awq.f)) {
            if ($$1 <= this.bm) {
               return false;
            }
         ...
         bss $$8 = $$0.d();
         if ($$8 != null) {
            if ($$8 instanceof btn $$9 && !$$0.a(awq.r) && (!$$0.a(bro.G) || !this.ak().a(aws.E))) {
               this.a($$9);
            }
            ...
            if ($$8 instanceof cmv $$10) {
               this.bd = 100;
               this.bc = $$10;
            } else if ($$8 instanceof cgg $$11 && $$11.s()) {
               this.bd = 100;
         ...
         if (this instanceof arf) {
            am.i.a((arf)this, $$0, $$2, $$1, $$3);
            if ($$4 > 0.0F && $$4 < 3.4028235E37F) {
               ((arf)this).a(awj.K, Math.round($$4 * 10.0F));
            }
         }

         if ($$8 instanceof arf) {
            am.h.a((arf)$$8, this, $$0, $$2, $$1, $$3);
         }
   ...
   private boolean h(brl $$0) {
      if ($$0.a(awq.e)) {
         ...
         if ($$1 != null) {
            ...
            this.t(1.0F);
            this.ew();
            this.b(new bsa(bsc.j, 900, 1));
            this.b(new bsa(bsc.v, 100, 1));
            this.b(new bsa(bsc.l, 800, 0));
   ...
   public boolean f(brl $$0) {
      ...
      if (!$$0.a(awq.d) && this.fC() && !$$2) {
         evp $$4 = $$0.h();
         if ($$4 != null) {
            evp $$5 = this.b(0.0F, this.cs());
            evp $$6 = $$4.a(this.dn());
            $$6 = new evp($$6.c, 0.0, $$6.e).d();
            return $$6.b($$5) < 0.0;
         }
      }
   ...
   protected void f(@Nullable btn $$0) {
      if (!this.dP().B) {
         boolean $$1 = false;
         if ($$0 instanceof cit) {
            if (this.dP().ab().b(dbs.c)) {
               iz $$2 = this.dp();
               dsa $$3 = dez.cd.o();
               if (this.dP().a_($$2).i() && $$3.a((dbz)this.dP(), $$2)) {
                  this.dP().a($$2, $$3, 3);
                  $$1 = true;
               }
            }
            ...
            if (!$$1) {
               cjf $$4 = new cjf(this.dP(), this.du(), this.dw(), this.dA(), new cun(cuq.dw));
               this.dP().b($$4);
            }
         }
      }
   ...
   protected void eE() {
      if (this.dP() instanceof are && !this.eI() && (this.ek() || this.bd > 0 && this.eh() && this.dP().ab().b(dbs.f))) {
         btd.a((are)this.dP(), this.dn(), this.ej());
      }
   }
   ...
   protected void a(brl $$0, boolean $$1) {
      ald<eql> $$2 = this.eF();
      eql $$3 = this.dP().o().be().b($$2);
      eqj.a $$4 = new eqj.a((are)this.dP()).a(etc.a, this).a(etc.f, this.dn()).a(etc.c, $$0).b(etc.d, $$0.d()).b(etc.e, $$0.c());
      if ($$1 && this.bc != null) {
         $$4 = $$4.a(etc.b, this.bc).a(this.bc.gy());
      }
   ...
   public btn.a eL() {
      return new btn.a(avz.kh, avz.jZ);
   }
   ...
   public boolean q_() {
      if (this.N_()) {
         ...
         if ($$1.a(awo.aP)) {
            ...
            return true;
         } else if ($$1.b() instanceof dnk && this.c($$0, $$1)) {
            this.ci = Optional.of($$0);
            return true;
         } else {
            return false;
   ...
   private boolean c(iz $$0, dsa $$1) {
      if ($$1.c(dnk.b)) {
         dsa $$2 = this.dP().a_($$0.d());
         if ($$2.a(dez.cO) && $$2.c(djd.b) == $$1.c(dnk.aE)) {
            return true;
         }
      }
   ...
   protected int d(float $$0, float $$1) {
      if (this.ak().a(aws.o)) {
         ...
         float $$2 = (float)this.g(buv.s);
         float $$3 = $$0 - $$2;
         return ayx.c((double)($$3 * $$1) * this.g(buv.i));
      }
   }
   ...
   protected void eN() {
      if (!this.aW()) {
         int $$0 = ayx.a(this.du());
         int $$1 = ayx.a(this.dw() - 0.2F);
         int $$2 = ayx.a(this.dA());
         dsa $$3 = this.dP().a_(new iz($$0, $$1, $$2));
         if (!$$3.i()) {
            dmk $$4 = $$3.w();
   ...
   protected void a(brl $$0, float $$1, bsz... $$2) {
      if (!($$1 <= 0.0F)) {
         int $$3 = (int)Math.max(1.0F, $$1 / 4.0F);

         for (bsz $$4 : $$2) {
            cun $$5 = this.a($$4);
            if ($$5.g() instanceof csc && $$5.a($$0)) {
               $$5.a($$3, this, $$4);
            }
         }
      }
   ...
   protected float d(brl $$0, float $$1) {
      if (!$$0.a(awq.c)) {
         this.b($$0, $$1);
         $$1 = brh.a($$1, $$0, (float)this.eO(), (float)this.g(buv.b));
      }
   ...
   protected float e(brl $$0, float $$1) {
      if ($$0.a(awq.g)) {
         ...
         if (this.b(bsc.k) && !$$0.a(awq.h)) {
            int $$2 = (this.c(bsc.k).e() + 1) * 5;
            int $$3 = 25 - $$2;
            float $$4 = $$1 * (float)$$3;
            float $$5 = $$1;
            ...
            if ($$6 > 0.0F && $$6 < 3.4028235E37F) {
               if (this instanceof arf) {
                  ((arf)this).a(awj.M, Math.round($$6 * 10.0F));
               } else if ($$0.d() instanceof arf) {
                  ((arf)$$0.d()).a(awj.I, Math.round($$6 * 10.0F));
               }
            }
         }
   ...
   protected void f(brl $$0, float $$1) {
      if (!this.b($$0)) {
         ...
         float $$3 = $$1 - var9;
         if ($$3 > 0.0F && $$3 < 3.4028235E37F && $$0.d() instanceof arf $$4) {
            $$4.a(awj.H, Math.round($$3 * 10.0F));
         }
   ...
   public final float eR() {
      return (float)this.g(buv.q);
   }

   public final float eS() {
      return (float)this.g(buv.p);
   }
   ...
   private int A() {
      if (bsb.a(this)) {
         return 6 - (1 + bsb.b(this));
      } else {
         return this.b(bsc.d) ? 6 + (1 + this.c(bsc.d).e()) * 2 : 6;
      }
   }
   ...
   public void b(byte $$0) {
      switch ($$0) {
         case 3:
            ...
            break;
         case 29:
            this.a(avz.wA, 1.0F, 0.8F + this.dP().z.i() * 0.4F);
            break;
         case 30:
         ...
         case 46:
            ...
            for (int $$3 = 0; $$3 < 128; $$3++) {
               ...
               double $$8 = ayx.d($$4, this.L, this.du()) + (this.ah.j() - 0.5) * (double)this.dj() * 2.0;
               double $$9 = ayx.d($$4, this.M, this.dw()) + this.ah.j() * (double)this.dk();
               double $$10 = ayx.d($$4, this.N, this.dA()) + (this.ah.j() - 0.5) * (double)this.dj() * 2.0;
   ...
   @Nullable
   public bur f(ji<buq> $$0) {
      return this.eW().a($$0);
   }

   public double g(ji<buq> $$0) {
      return this.eW().c($$0);
   }

   public double h(ji<buq> $$0) {
      return this.eW().d($$0);
   }
   ...
   public abstract Iterable<cun> eZ();

   public abstract cun a(bsz var1);

   public abstract void a(bsz var1, cun var2);
   ...
   public Iterable<cun> fc() {
      return Iterables.concat(this.fa(), this.fb());
   }

   protected void e(cun $$0) {
      $$0.g().n($$0);
   }

   public float fd() {
      Iterable<cun> $$0 = this.eZ();
      int $$1 = 0;
      int $$2 = 0;
   ...
   private void b(bss $$0) {
      ...
      if (this.dK()) {
         $$1 = this.dn();
      } else if (!$$0.dK() && !this.dP().a_($$0.dp()).a(awo.aJ)) {
         $$1 = $$0.b(this);
      } else {
         double $$2 = Math.max(this.dw(), $$0.dw());
         $$1 = new evp(this.du(), $$2, this.dA());
      }
   ...
   protected float w(float $$0) {
      return (float)this.g(buv.m) * $$0 * this.aM() + this.fi();
   }

   public float fi() {
      return this.b(bsc.h) ? 0.1F * ((float)this.c(bsc.h).e() + 1.0F) : 0.0F;
   }
   ...
   protected void fj() {
      ...
      if (!($$0 <= 1.0E-5F)) {
         ...
         if (this.cb()) {
            ...
            this.i(new evp((double)(-ayx.a($$2)) * 0.2, 0.0, (double)ayx.b($$2) * 0.2));
         }
   ...
   public void a(evp $$0) {
      if (this.da()) {
         ...
         if (this.be() && this.ef() && !this.a($$3)) {
            ...
            evp $$8 = this.ds();
            if (this.Q && this.q_()) {
               $$8 = new evp($$8.c, 0.2, $$8.e);
            }

            this.h($$8.d((double)$$5, 0.8F, (double)$$5));
            evp $$9 = this.a($$1, $$2, this.ds());
            this.h($$9);
            ...
            this.a(0.02F, $$0);
            this.a(bts.a, this.ds());
            if (this.b(awu.b) <= this.di()) {
               this.h(this.ds().d(0.5, 0.8F, 0.5));
               evp $$11 = this.a($$1, $$2, this.ds());
               this.h($$11);
            } else {
            ...
            if ($$15 < 0.0F && $$16 > 0.0) {
               double $$21 = $$17 * (double)(-ayx.a($$15)) * 0.04;
            ...
            double $$29 = $$28.d;
            if (this.b(bsc.y)) {
               $$29 += (0.05 * (double)(this.c(bsc.y).e() + 1) - $$28.d) * 0.2;
            ...
            if (this.er()) {
               ...
               this.o($$28.c * (double)$$27, this instanceof cfm ? $$29 * (double)$$27 : $$29 * 0.98F, $$28.e * (double)$$27);
            }
         }
      }

      this.r(this instanceof cfm);
   }

   private void c(cmv $$0, evp $$1) {
      evp $$2 = this.b($$0, $$1);
      this.a($$0, $$2);
      if (this.da()) {
         this.y(this.e($$0));
   ...
   public void r(boolean $$0) {
      float $$1 = (float)ayx.g(this.du() - this.L, $$0 ? this.dw() - this.M : 0.0, this.dA() - this.N);
      this.x($$1);
   }
   ...
   public evp a(evp $$0, float $$1) {
      ...
      this.a(bts.a, this.ds());
      evp $$2 = this.ds();
      if ((this.Q || this.bn) && (this.q_() || this.dq().a(dez.qP) && dkr.a(this))) {
         $$2 = new evp($$2.c, 0.2, $$2.e);
      }

      return $$2;
   }

   public evp a(double $$0, boolean $$1, evp $$2) {
      if ($$0 != 0.0 && !this.cb()) {
         double $$3;
   ...
   private evp k(evp $$0) {
      if (this.q_()) {
         this.n();
         float $$1 = 0.15F;
         double $$2 = ayx.a($$0.c, -0.15F, 0.15F);
         double $$3 = ayx.a($$0.e, -0.15F, 0.15F);
         double $$4 = Math.max($$0.d, -0.15F);
         if ($$4 < 0.0 && !this.dq().a(dez.nS) && this.fD() && this instanceof cmv) {
            $$4 = 0.0;
         }
   ...
   protected float fm() {
      return this.cQ() instanceof cmv ? this.fn() * 0.1F : 0.02F;
   }
   ...
   public void l() {
      ...
      if ($$4 > 0.0025000002F) {
         ...
         float $$8 = (float)ayx.d($$3, $$2) * (180.0F / (float)Math.PI) - 90.0F;
         float $$9 = ayx.e(ayx.g(this.dF()) - $$8);
         if (95.0F < $$9 && $$9 < 265.0F) {
            $$5 = $$8 - 180.0F;
         } else {
            $$5 = $$8;
   ...
   private void a(Map<bsz, cun> $$0) {
      cun $$1 = $$0.get(bsz.a);
      cun $$2 = $$0.get(bsz.b);
      if ($$1 != null && $$2 != null && cun.a($$1, this.g(bsz.b)) && cun.a($$2, this.g(bsz.a))) {
         ((are)this.dP()).l().b(this, new adl(this, (byte)55));
         $$0.remove(bsz.a);
         $$0.remove(bsz.b);
         this.c(bsz.a, $$1.s());
         this.c(bsz.b, $$2.s());
   ...
   private void b(Map<bsz, cun> $$0) {
      List<Pair<bsz, cun>> $$1 = Lists.newArrayListWithCapacity($$0.size());
      $$0.forEach(($$1x, $$2) -> {
         cun $$3 = $$2.s();
         $$1.add(Pair.of($$1x, $$3));
         switch ($$1x.a()) {
      ...
      ((are)this.dP()).l().b(this, new afp(this.al(), $$1));
   }
   ...
   private void c(bsz $$0, cun $$1) {
      this.bV.set($$0.b(), $$1);
   }

   protected float e(float $$0, float $$1) {
      float $$2 = ayx.g($$0 - this.aY);
      this.aY += $$2 * 0.3F;
      float $$3 = ayx.g(this.dF() - this.aY);
      float $$4 = this.fo();
      if (Math.abs($$3) > $$4) {
         this.aY = this.aY + ($$3 - (float)ayx.j((double)$$3) * $$4);
      }
   ...
   public void n_() {
      ...
      this.G();
      evk $$8 = this.cK();
      evp $$9 = new evp((double)this.bo, (double)this.bp, (double)this.bq);
      if (this.b(bsc.B) || this.b(bsc.y)) {
         this.n();
      }

      label104: {
         if (this.cQ() instanceof cmv $$10 && this.bD()) {
            this.c($$10, $$9);
            break label104;
         }
   ...
   private void G() {
      boolean $$0 = this.j(7);
      if ($$0 && !this.aE() && !this.bR() && !this.b(bsc.y)) {
         cun $$1 = this.a(bsz.e);
         if ($$1.a(cuq.nT) && ctj.j($$1)) {
            $$0 = true;
            int $$2 = this.bB + 1;
            if (!this.dP().B && $$2 % 10 == 0) {
               int $$3 = $$2 / 10;
   ...
   protected void q() {
      if (this.dP().x_()) {
         this.dP().a(dwh.a(cmv.class), this.cK(), bsx.a(this)).forEach(this::D);
      } else {
         List<bss> $$0 = this.dP().a(this, this.cK(), bsx.a(this));
         if (!$$0.isEmpty()) {
            int $$1 = this.dP().ab().c(dbs.u);
   ...
   protected void a(evk $$0, evk $$1) {
      evk $$2 = $$0.b($$1);
      List<bss> $$3 = this.dP().a_(this, $$2);
      if (!$$3.isEmpty()) {
         for (bss $$4 : $$3) {
            if ($$4 instanceof btn) {
               this.g((btn)$$4);
   ...
   public void a(cjf $$0) {
      bss $$1 = $$0.s();
      if ($$1 instanceof arf) {
         am.R.a((arf)$$1, $$0.p(), this);
      }
   }

   public void a(bss $$0, int $$1) {
      if (!$$0.dK() && !this.dP().B && ($$0 instanceof cjf || $$0 instanceof cnb || $$0 instanceof btd)) {
         ((are)this.dP()).l().b($$0, new agi($$0.al(), this.al(), $$1));
      }
   }
   ...
   public boolean E(bss $$0) {
      if ($$0.dP() != this.dP()) {
         ...
         evp $$1 = new evp(this.du(), this.dy(), this.dA());
         evp $$2 = new evp($$0.du(), $$0.dy(), $$0.dA());
         return $$2.f($$1) > 128.0 ? false : this.dP().a(new dbf($$1, $$2, dbf.a.a, dbf.b.a, this)).c() == evn.a.a;
      }
   }

   @Override
   public float h(float $$0) {
      return $$0 == 1.0F ? this.ba : ayx.i($$0, this.bb, this.ba);
   }
   ...
   public static evp j(evp $$0) {
      return new evp($$0.c, $$0.d, 0.0);
   }
   ...
   public bqr fw() {
      return (this.ao.a(aF) & 2) > 0 ? bqr.b : bqr.a;
   }

   private void H() {
      if (this.fv()) {
         if (cun.b(this.b(this.fw()), this.bz)) {
   ...
   private void a(cun $$0, int $$1) {
      for (int $$2 = 0; $$2 < $$1; $$2++) {
         ...
         evp $$5 = new evp(((double)this.ah.i() - 0.5) * 0.3, $$4, 0.6);
   ...
   public boolean fC() {
      if (this.fv() && !this.bz.e()) {
         cui $$0 = this.bz.g();
         return $$0.c(this.bz) != cwi.d ? false : $$0.b(this.bz) - this.bA >= 5;
      } else {
         return false;
      }
   }
   ...
   @Override
   public boolean cd() {
      return super.cd() || !this.fE() && this.c(btz.b);
   }
   ...
   @Override
   public final bsv a(btz $$0) {
      return $$0 == btz.c ? aG : this.e($$0).a(this.ee());
   }

   protected bsv e(btz $$0) {
      return this.ak().n().a(this.ed());
   }

   public ImmutableList<btz> fI() {
      return ImmutableList.of(btz.a);
   }

   public evk f(btz $$0) {
      bsv $$1 = this.a($$0);
      return new evk((double)(-$$1.a() / 2.0F), 0.0, (double)(-$$1.a() / 2.0F), (double)($$1.a() / 2.0F), (double)$$1.b(), (double)($$1.a() / 2.0F));
   }

   protected boolean g(btz $$0) {
      evk $$1 = this.a($$0).a(this.dn());
   ...
   public void b(iz $$0) {
      ...
      if ($$1.b() instanceof deq) {
         this.dP().a($$0, $$1.a(deq.c, Boolean.valueOf(true)), 3);
      }
   ...
   private boolean M() {
      return this.fJ().map($$0 -> this.dP().a_($$0).b() instanceof deq).orElse(false);
   }
   ...
   public void fM() {
      this.fJ().filter(this.dP()::B).ifPresent($$0x -> {
         ...
         if ($$1.b() instanceof deq) {
            je $$2 = $$1.c(deq.aE);
            this.dP().a($$0x, $$1.a(deq.c, Boolean.valueOf(false)), 3);
            evp $$3 = deq.a(this.ak(), this.dP(), $$0x, $$2, this.dF()).orElseGet(() -> {
               iz $$1x = $$0x.c();
               return new evp((double)$$1x.u() + 0.5, (double)$$1x.v() + 0.1, (double)$$1x.w() + 0.5);
            });
            evp $$4 = evp.c($$0x).d($$3).d();
            float $$5 = (float)ayx.d(ayx.d($$4.e, $$4.c) * 180.0F / (float)Math.PI - 90.0);
            this.a_($$3.c, $$3.d, $$3.e);
            this.r($$5);
            this.s(0.0F);
         }
   ...
   public je fN() {
      ...
      return $$0 != null ? deq.a(this.dP(), $$0) : null;
   }
   ...
   public cun a(dbw $$0, cun $$1) {
      cpp $$2 = $$1.a(km.u);
      if ($$2 != null) {
         $$0.a(null, this.du(), this.dw(), this.dA(), this.d($$1), awa.g, 1.0F, 1.0F + ($$0.z.i() - $$0.z.i()) * 0.4F);
         this.a($$2);
         $$1.a(1, this);
         this.a(dwt.m);
      }
   ...
   public static bsz d(bqr $$0) {
      return $$0 == bqr.a ? bsz.a : bsz.b;
   }

   @Override
   public evk h_() {
      if (this.a(bsz.f).a(cuq.uq)) {
         float $$0 = 0.5F;
   ...
   public static bsz h(cun $$0) {
      ctp $$1 = ctp.c_($$0);
      return $$1 != null ? $$1.m() : bsz.a;
   }

   private static buf a(btn $$0, bsz $$1) {
      return $$1 != bsz.f && $$1 != bsz.a && $$1 != bsz.b ? buf.a($$0, $$1, $$1x -> $$1x.e() || btp.h($$1x) == $$1) : buf.a($$0, $$1);
   }

   @Nullable
   private static bsz s(int $$0) {
      if ($$0 == 100 + bsz.f.b()) {
         return bsz.f;
      } else if ($$0 == 100 + bsz.e.b()) {
         return bsz.e;
      } else if ($$0 == 100 + bsz.d.b()) {
         return bsz.d;
      } else if ($$0 == 100 + bsz.c.b()) {
         return bsz.c;
      } else if ($$0 == 98) {
         return bsz.a;
      } else if ($$0 == 99) {
   ...
   public boolean dD() {
      if (this.N_()) {
         ...
         boolean $$0 = !this.a(bsz.f).a(awx.ba) && !this.a(bsz.e).a(awx.ba) && !this.a(bsz.d).a(awx.ba) && !this.a(bsz.c).a(awx.ba) && !this.a(bsz.g).a(awx.ba);
         return $$0 && super.dD();
      }
   }
   ...
   @Override
   public boolean cg() {
      return !this.dP().x_() && this.b(bsc.x) || super.cg();
   }
   ...
   public boolean fO() {
      return this.eX().g() instanceof csh;
   }

   @Override
   public float dJ() {
      float $$0 = (float)this.g(buv.v);
      return this.cQ() instanceof cmv ? Math.max($$0, 1.0F) : $$0;
   }
   ...
   protected void a(int $$0, double $$1) {
      this.ba = (float)ayx.e(1.0 / (double)$$0, (double)this.ba, $$1);
   }

   @Override
   public void h(int $$0) {
      super.h(dah.a(this, $$0));
   }
