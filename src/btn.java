...
public class btn implements crp {
   public static final Codec<jr<btn>> a = mb.d.r();
   public static final yn<wa, jr<btn>> b = yl.b(mc.W);
   ...
   public void a(ard $$0, @Nullable buk $$1, @Nullable buk $$2, bvg $$3, int $$4, double $$5) {
      this.a($$0, $$3, $$4);
   }
   ...
   public void a(ard $$0, bvg $$1, int $$2, buk.d $$3) {
   }

   public void a(ard $$0, bvg $$1, int $$2, bta $$3, float $$4) {
   }
   ...
   public btn a(jr<bwj> $$0, akv $$1, double $$2, bwm.a $$3) {
   ...
   static record a(akv a, double b, bwm.a c) {
      public bwm a(int $$0) {
