...
public interface btn<T extends Runnable> {
   @Nullable
   Runnable a();
   ...
   public static final class a implements btn<btn.c> {
   ...
   public static final class b implements btn<Runnable> {
      private final Queue<Runnable> a;
