...
public class avm extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bat.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bat.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bat.s);
