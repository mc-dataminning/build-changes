...
public class avm extends axr {
   ...
   public avm(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityPaintingMotiveFix", ayp.x, "minecraft:painting");
   }
   ...
   public Dynamic<?> a(Dynamic<?> $$0) {
      ...
      if ($$1.isPresent()) {
         ...
         return $$0.set("Motive", $$0.createString(new aer(a.getOrDefault($$2, $$2)).toString()));
      } else {
         return $$0;
      }
   }
