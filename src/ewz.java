public abstract class ewz extends exd implements eyi, eza {
   private static final eys a = new eys(new ahg("widget/text_field"), new ahg("widget/text_field_highlighted"));
   private static final ahg b = new ahg("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public ewz(int $$0, int $$1, int $$2, int $$3, vf $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return aun.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = aun.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(ewt $$0, int $$1, int $$2, int $$3, int $$4) {
      ahg $$5 = a.a(this.A(), this.aI_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(ewt var1, int var2, int var3, float var4);
}
