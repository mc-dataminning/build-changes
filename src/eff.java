...
public record eff(hg<cno> b, List<Float> c) implements efp {
   public static final Codec<eff> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(jd.g.r().fieldOf("enchantment").forGetter(eff::c), Codec.FLOAT.listOf().fieldOf("chances").forGetter(eff::d)).apply($$0, eff::new)
   );
