...
public class eff extends efg {
   ...
   public static final MapCodec<eff> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(efe.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, eff::new)
   );
   private final efe h;

   public eff(bpi $$0, efj $$1, Optional<efd> $$2, efe $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dcj $$0, BiConsumer<ja, dsh> $$1, aym $$2, ja $$3, ja $$4, eee $$5) {
   ...
   private boolean a(dcj $$0, aym $$1, ja $$2, jf $$3, ja $$4, List<ja> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
   ...
   protected List<ja> a(ja $$0, jf $$1, aym $$2, ja $$3) {
      ja $$4 = $$0.d();
      ja $$5 = $$0.a($$1);
      int $$6 = $$0.k($$3);
      int $$7 = this.h.d();
