...
public class gfh {
   ...
   public static void a(fgm $$0, fbg $$1) {
      cmx $$2 = $$0.s;
      if (!$$2.ag) {
         dtc $$3 = a($$2);
         if ($$3 != null) {
   ...
   private static dtc a(cmx $$0) {
      ...
      for (int $$2 = 0; $$2 < 8; $$2++) {
         double $$3 = $$0.du() + (double)(((float)(($$2 >> 0) % 2) - 0.5F) * $$0.dk() * 0.8F);
         double $$4 = $$0.dy() + (double)(((float)(($$2 >> 1) % 2) - 0.5F) * 0.1F * $$0.ec());
         double $$5 = $$0.dA() + (double)(((float)(($$2 >> 2) % 2) - 0.5F) * $$0.dk() * 0.8F);
         $$1.b($$3, $$4, $$5);
         dtc $$6 = $$0.dP().a_($$1);
         if ($$6.l() != dmf.a && $$6.p($$0.dP(), $$1)) {
            return $$6;
         }
      }
   ...
   private static void a(gqj $$0, fbg $$1) {
   ...
   private static void b(fgm $$0, fbg $$1) {
      RenderSystem.setShader(geq::q);
      RenderSystem.setShaderTexture(0, a);
      jd $$2 = jd.a($$0.s.du(), $$0.s.dy(), $$0.s.dA());
      float $$3 = gew.a($$0.s.dP().D_(), $$0.s.dP().A($$2));
      ...
      float $$8 = 1.0F;
      float $$9 = -0.5F;
      float $$10 = -$$0.s.dF() / 64.0F;
      float $$11 = $$0.s.dH() / 64.0F;
      Matrix4f $$12 = $$1.c().a();
      fbb $$13 = fbi.b().a(fbl.c.h, fbe.i);
   ...
   private static void c(fgm $$0, fbg $$1) {
      RenderSystem.setShader(geq::r);
