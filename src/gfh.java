public class gfh extends gfe {
   ...
   protected gfh(gax $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gez $$8) {
      ...
      this.l += $$6;
      this.D *= 0.75F * $$7;
      this.t = (int)(8.0F / azc.b(this.r, 0.5F, 1.0F) * $$7);
   ...
   public static class a implements geh<lr> {
      ...
      public gee a(lr $$0, gax $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gfh($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
