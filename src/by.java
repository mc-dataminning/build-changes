...
public class by extends cv<by.a> {
   ...
   public void a(ane $$0, cfg $$1, cmx $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(ane $$0, cfg $$1, cmx $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bb> b, by.a.a c, List<ca> d) implements cv.a {
      public static final Codec<by.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  atv.a(bp.b, "player").forGetter(by.a::a),
                  atv.a(by.a.a.a, "slots", by.a.a.b).forGetter(by.a::b),
                  atv.a(ca.a.listOf(), "items", List.of()).forGetter(by.a::c)
               )
               .apply($$0, by.a::new)
      );
      ...
      public boolean a(cfg $$0, cmx $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
      ...
      public static record a(ck.d c, ck.d d, ck.d e) {
         public static final Codec<by.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     atv.a(ck.d.d, "occupied", ck.d.c).forGetter(by.a.a::a),
                     atv.a(ck.d.d, "full", ck.d.c).forGetter(by.a.a::b),
                     atv.a(ck.d.d, "empty", ck.d.c).forGetter(by.a.a::c)
                  )
                  .apply($$0, by.a.a::new)
         );
