...
public class by extends cv<by.a> {
   ...
   public void a(anf $$0, cfp $$1, cng $$2) {
      int $$3 = 0;
      int $$4 = 0;
      int $$5 = 0;
   ...
   private void a(anf $$0, cfp $$1, cng $$2, int $$3, int $$4, int $$5) {
   ...
   public static record a(Optional<bb> b, by.a.a c, List<ca> d) implements cv.a {
      public static final Codec<by.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  atx.a(bp.b, "player").forGetter(by.a::a),
                  atx.a(by.a.a.a, "slots", by.a.a.b).forGetter(by.a::b),
                  atx.a(ca.a.listOf(), "items", List.of()).forGetter(by.a::c)
               )
               .apply($$0, by.a::new)
      );
      ...
      public static an<by.a> a(ctw... $$0) {
         ca[] $$1 = new ca[$$0.length];

         for (int $$2 = 0; $$2 < $$0.length; $$2++) {
            $$1[$$2] = new ca(Optional.empty(), Optional.of(il.a($$0[$$2].j().i())), ck.d.c, ck.d.c, List.of(), List.of(), Optional.empty(), Optional.empty());
         }

         return a($$1);
      }

      public boolean a(cfp $$0, cng $$1, int $$2, int $$3, int $$4) {
         if (!this.c.a($$2, $$3, $$4)) {
            return false;
      ...
      public static record a(ck.d c, ck.d d, ck.d e) {
         public static final Codec<by.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     atx.a(ck.d.d, "occupied", ck.d.c).forGetter(by.a.a::a),
                     atx.a(ck.d.d, "full", ck.d.c).forGetter(by.a.a::b),
                     atx.a(ck.d.d, "empty", ck.d.c).forGetter(by.a.a::c)
                  )
                  .apply($$0, by.a.a::new)
         );
