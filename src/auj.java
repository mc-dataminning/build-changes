...
class auj extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof aui && $$1 instanceof aui && $$0.equals($$1);
   }
   ...
   private static aui a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof aui) {
         return (aui)$$0;
      } else {
