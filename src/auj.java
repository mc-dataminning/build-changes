...
public class auj {
   ...
   private static final Optional<Object> b = Optional.of(aus.a);

   private static boolean a(vs $$0, atd $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, vs $$1, atd $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, vs $$1, atd $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, vs $$1, atd $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, vs $$2, atd $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, vs $$2, vs $$3, atd $$4) {
      int $$5 = $$0.length();
      vs $$6 = $$2;
   ...
   public static boolean a(va $$0, vs $$1, atd $$2) {
