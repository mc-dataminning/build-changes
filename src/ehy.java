...
public enum ehy implements ash {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final ash.a<ehy> t = ash.a(ehy::values);
   public static final IntFunction<ehy> u = aqk.a(ehy::a, values(), aqk.a.a);
   private final int v;
   private final String w;

   private ehy(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
