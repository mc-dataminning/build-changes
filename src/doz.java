...
public class doz {
   ...
   final boolean f;
   private final axq<die> g;
   private final int h;
   private final int i;
   private final int j;
   private final int k;
   private List<doz.a> l = new ArrayList<>();
   private static final Logger m = LogUtils.getLogger();

   public doz(boolean $$0, axq<die> $$1, int $$2, int $$3, int $$4, int $$5) {
      this.f = $$0;
      this.g = $$1;
      this.h = $$2;
      this.i = $$3;
   ...
   public static doz a() {
      return new doz(false, axa.bT, 10, 4, 10, 5);
   }

   public static doz b() {
      return new doz(true, axa.bU, 50, 1, 5, 10);
   }
   ...
   public void a(uk $$0) {
      if ($$0.b("cursors", 9)) {
         this.l.clear();
         List<doz.a> $$1 = (List<doz.a>)doz.a.b.listOf().parse(new Dynamic(uy.a, $$0.c("cursors", 10))).resultOrPartial(m::error).orElseGet(ArrayList::new);
   ...
   public void b(uk $$0) {
      doz.a.b.listOf().encodeStart(uy.a, this.l).resultOrPartial(m::error).ifPresent($$1 -> $$0.a("cursors", $$1));
   }

   public void a(jh $$0, int $$1) {
      while ($$1 > 0) {
         int $$2 = Math.min($$1, 1000);
         this.a(new doz.a($$0, $$2));
         $$1 -= $$2;
      }
   }

   private void a(doz.a $$0) {
      if (this.l.size() < 32) {
         this.l.add($$0);
      }
   }

   public void a(dfc $$0, jh $$1, azs $$2, boolean $$3) {
      if (!this.l.isEmpty()) {
         List<doz.a> $$4 = new ArrayList<>();
         Map<jh, doz.a> $$5 = new HashMap<>();
   ...
   public static class a {
      ...
      public static final Codec<doz.a> b = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  jh.a.fieldOf("pos").forGetter(doz.a::a),
                  Codec.intRange(0, 1000).fieldOf("charge").orElse(0).forGetter(doz.a::b),
                  Codec.intRange(0, 1).fieldOf("decay_delay").orElse(1).forGetter(doz.a::c),
      ...
      private boolean a(dfc $$0, jh $$1, boolean $$2) {
         if (this.e <= 0) {
            return false;
         } else if ($$2) {
            return true;
      ...
      public void a(dfc $$0, jh $$1, azs $$2, doz $$3, boolean $$4) {
         if (this.a($$0, $$1, $$3.f)) {
            if (this.f > 0) {
               this.f--;
            } else {
               ...
               if ($$4 && $$6.a($$0, this.d, $$5, this.h, $$3.h())) {
                  ...
                  $$0.a(null, this.d, awl.vS, awm.e, 1.0F, 1.0F);
               }
      ...
      private static dou a(dvj $$0) {
         return $$0.b() instanceof dou $$1 ? $$1 : dou.w_;
      }

      private static List<kl> a(azs $$0) {
         return ae.a(c, $$0);
      }

      @Nullable
      private static jh a(dfc $$0, jh $$1, azs $$2) {
         jh.a $$3 = $$1.k();
         jh.a $$4 = $$1.k();
      ...
      private static boolean a(dfc $$0, jh $$1, jh $$2) {
         if ($$1.k($$2) == 1) {
            return true;
         } else {
            jh $$3 = $$2.b($$1);
      ...
      private static boolean a(dfc $$0, jh $$1, jm $$2) {
         jh $$3 = $$1.a($$2);
