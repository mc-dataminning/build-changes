...
public class doz implements auf {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<doz> b = doy.a.xmap($$0 -> new doz($$0), $$0 -> $$0.e);
   private doy e;
   private final doa f = new doa(this);

   public doz(long $$0) {
      this.e = new doy(don.c($$0));
   }
   ...
   @Override
   public auf d() {
      return new doz(this.e.a(), this.e.a());
   }

   @Override
   public dol e() {
      return new doz.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements dol {
      ...
      public auf a(int $$0, int $$1, int $$2) {
         long $$3 = aty.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new doz($$4, this.b);
      }

      @Override
      public auf a(String $$0) {
         don.a $$1 = don.a($$0);
         return new doz($$1.a(this.a, this.b));
      }
