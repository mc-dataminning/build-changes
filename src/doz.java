...
public class doz extends dnn<dqn> {
   ...
   private static boolean d(cps $$0, gu $$1) {
      return $$0.a($$1, $$0x -> $$0x.a(csn.ff));
   }

   public static boolean b(cps $$0, gu $$1) {
      return $$0.a($$1, $$0x -> $$0x.i() || $$0x.a(apl.O));
   }

   private static void b(cpu $$0, gu $$1, dfa $$2) {
      $$0.a($$1, $$2, 19);
   }

   public static boolean c(cps $$0, gu $$1) {
      return $$0.a($$1, $$0x -> $$0x.i() || $$0x.a(apl.cf));
   }

   private boolean a(cqg $$0, aru $$1, gu $$2, BiConsumer<gu, dfa> $$3, BiConsumer<gu, dfa> $$4, drd.b $$5, dqn $$6) {
      int $$7 = $$6.d.a($$1);
      int $$8 = $$6.f.a($$1, $$7, $$6);
      int $$9 = $$7 - $$8;
      int $$10 = $$6.f.a($$1, $$9);
      ...
      if ($$12 >= $$0.C_() + 1 && $$13 <= $$0.aj()) {
         ...
         if ($$15 >= $$7 || !$$14.isEmpty() && $$15 >= $$14.getAsInt()) {
            if ($$6.g.isPresent() && !$$6.g.get().a($$0, $$3, $$1, $$2, $$11, $$6)) {
               ...
               List<drd.a> $$16 = $$6.d.a($$0, $$4, $$1, $$15, $$11, $$6);
   ...
   private int a(cps $$0, int $$1, gu $$2, dqn $$3) {
      gu.a $$4 = new gu.a();
   ...
   @Override
   public final boolean a(dnp<dqn> $$0) {
      final cqg $$1 = $$0.b();
      aru $$2 = $$0.d();
      gu $$3 = $$0.e();
      dqn $$4 = $$0.f();
      ...
      BiConsumer<gu, dfa> $$9 = ($$2x, $$3x) -> {
         $$5.add($$2x.i());
         $$1.a($$2x, $$3x, 19);
      };
      BiConsumer<gu, dfa> $$10 = ($$2x, $$3x) -> {
         $$6.add($$2x.i());
         $$1.a($$2x, $$3x, 19);
      };
      drd.b $$11 = new drd.b() {
         @Override
         public void a(gu $$0, dfa $$1x) {
            $$7.add($$0.i());
            $$1.a($$0, $$1, 19);
         }
      ...
      if ($$13 && (!$$6.isEmpty() || !$$7.isEmpty())) {
         if (!$$4.i.isEmpty()) {
            dsj.a $$14 = new dsj.a($$1, $$12, $$2, $$6, $$7, $$5);
            $$4.i.forEach($$1x -> $$1x.a($$14));
         }

         return dur.a(Iterables.concat($$5, $$6, $$7, $$8)).map($$4x -> {
            ehn $$5x = a($$1, $$4x, $$6, $$8, $$5);
            dys.a($$1, 3, $$5x, $$4x.g(), $$4x.h(), $$4x.i());
            return true;
         }).orElse(false);
      } else {
         return false;
   ...
   private static ehn a(cpn $$0, dur $$1, Set<gu> $$2, Set<gu> $$3, Set<gu> $$4) {
      ehn $$5 = new ehh($$1.c(), $$1.d(), $$1.e());
      int $$6 = 7;
      ...
      while (true) {
         while ($$11 >= 7 || !$$7.get($$11).isEmpty()) {
            ...
            if ($$1.b($$13)) {
               if ($$11 != 0) {
                  dfa $$14 = $$0.a_($$13);
                  b($$0, $$13, $$14.a(dfq.aC, Integer.valueOf($$11)));
               }
