...
public abstract class ddk implements ddj {
   public static final Codec<ddk> a = lq.Z.r().dispatchStable(ddk::a, Function.identity());
   private final Supplier<Set<jj<ddg>>> b = Suppliers.memoize(() -> this.b().distinct().collect(ImmutableSet.toImmutableSet()));
   ...
   protected abstract Stream<jj<ddg>> b();
   ...
   @Nullable
   public Pair<ja, jj<ddg>> a(int $$0, int $$1, int $$2, int $$3, Predicate<jj<ddg>> $$4, ayo $$5, ddp.f $$6) {
      return this.a($$0, $$1, $$2, $$3, 1, $$4, $$5, false, $$6);
   }

   @Nullable
   public Pair<ja, jj<ddg>> a(ja $$0, int $$1, int $$2, int $$3, Predicate<jj<ddg>> $$4, ddp.f $$5, dcj $$6) {
      Set<jj<ddg>> $$7 = this.c().stream().filter($$4).collect(Collectors.toUnmodifiableSet());
      if ($$7.isEmpty()) {
         return null;
      } else {
         ...
         for (ja.a $$10 : ja.a(ja.c, $$8, jf.f, jf.d)) {
            ...
            for (int $$15 : $$9) {
               int $$16 = ju.a($$15);
               jj<ddg> $$17 = this.getNoiseBiome($$13, $$16, $$14, $$5);
               if ($$7.contains($$17)) {
      ...
      while ($$16 <= $$11) {
         for (int $$17 = aa.aq ? 0 : -$$16; $$17 <= $$16; $$17 += $$4) {
            ...
            for (int $$19 = -$$16; $$19 <= $$16; $$19 += $$4) {
               ...
               int $$21 = $$9 + $$19;
               int $$22 = $$10 + $$17;
               jj<ddg> $$23 = this.getNoiseBiome($$21, $$12, $$22, $$8);
               if ($$5.test($$23)) {
   ...
   @Override
   public abstract jj<ddg> getNoiseBiome(int var1, int var2, int var3, ddp.f var4);
