...
public abstract class cdb {
   ...
   public cdb(btr $$0, dby $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = ayz.a($$0.g(bux.k) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract eol a(int var1);
   ...
   @Nullable
   public final eoj a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(iz.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public eoj a(Stream<iz> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public eoj a(Set<iz> $$0, int $$1) {
   ...
   @Nullable
   protected eoj a(Set<iz> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.g(bux.k));
   }

   @Nullable
   protected eoj a(Set<iz> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$6 = (int)($$4 + (float)$$1);
         dcl $$7 = new dcl(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         eoj $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ag().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable eoj $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   protected double a(evr $$0) {
      iz $$1 = iz.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : eor.a(this.b, $$1);
   }
   ...
   private boolean c(evr $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         evr $$1 = evr.c(this.c.g());
         if (!$$0.a((js)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            evr $$2 = evr.c(this.c.d(this.c.f() + 1));
            evr $$3 = $$1.d($$0);
            evr $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void S_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            eoh $$1 = this.c.a($$0);
            eoh $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dsc $$3 = this.b.a_(new iz($$1.a, $$1.b, $$1.c));
            if ($$3.a(awp.bl)) {
   ...
   public boolean b(eom $$0) {
      return $$0 != eom.n && $$0 != eom.p && $$0 != eom.d;
   }

   protected static boolean a(btr $$0, evr $$1, evr $$2, boolean $$3) {
      evr $$4 = new evr($$2.c, $$2.d + (double)$$0.dk() * 0.5, $$2.e);
      return $$0.dP().a(new dbh($$1, $$4, dbh.a.a, $$3 ? dbh.b.c : dbh.b.a, $$0)).c() == evp.a.a;
   }
   ...
   public boolean b(iz $$0) {
      if (this.m) {
         ...
         eoh $$1 = this.c.d();
         evr $$2 = new evr(((double)$$1.a + this.a.du()) / 2.0, ((double)$$1.b + this.a.dw()) / 2.0, ((double)$$1.c + this.a.dA()) / 2.0);
