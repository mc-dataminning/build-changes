...
public class cdb extends cde {
   private final bwi a;
   private final Predicate<bwi> b;
   @Nullable
   private bwi c;
   ...
   public cdb(bwi $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean b() {
      List<bwi> $$0 = this.a.dW().a(bwi.class, this.a.cR().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (bwi $$1 : $$0) {
            if (!$$1.cp()) {
               this.c = $$1;
