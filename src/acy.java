...
public class acy implements zq<acf> {
   public static final zh<wg, acy> a = zq.a(acy::a, acy::new);
   ...
   private final int i;
   private final List<acy.b> j;

   public acy(RootCommandNode<fb> $$0) {
   ...
   private static void a(List<acy.b> $$0, BiPredicate<acy.b, IntSet> $$1) {
   ...
   private static void a(List<acy.b> $$0) {
      a($$0, acy.b::a);
      a($$0, acy.b::b);
   }
   ...
   private static List<acy.b> a(Object2IntMap<CommandNode<fb>> $$0) {
      ObjectArrayList<acy.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static acy.b b(wg $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.l() : 0;
      acy.e $$4 = a($$0, $$1);
      return new acy.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static acy.e a(wg $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
         ...
         if ($$5 == null) {
            ...
            is.a<?> $$6 = $$5.b($$0);
            alj $$7 = ($$1 & 16) != 0 ? $$0.q() : null;
            return new acy.a($$3, $$6, $$7);
         }
      } else if ($$2 == 1) {
         String $$8 = $$0.p();
         return new acy.c($$8);
   ...
   private static acy.b a(CommandNode<fb> $$0, Object2IntMap<CommandNode<fb>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<fb> a(es $$0) {
      return (RootCommandNode<fb>)new acy.d($$0, this.j).a(this.i);
   }

   static class a implements acy.e {
      ...
      @Nullable
      private static alj a(@Nullable SuggestionProvider<fb> $$0) {
         return $$0 != null ? iw.a($$0) : null;
      }

      a(String $$0, is.a<?> $$1, @Nullable alj $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(wg $$0, is.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends is.a<A>> void a(wg $$0, is<A, T> $$1, is.a<A> $$2) {
         $$0.c(lz.u.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
   ...
   static class b {
      ...
      b(@Nullable acy.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements acy.e {
      private final String a;
