...
public class bpv implements bpw {
   ...
   private static final bpv k = new bpv();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bpu $$0) {
      URL $$1 = bpv.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bpu $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bpy a = new bpy(() -> bpv.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bpv.this.l && $$0.getState() == RecordingState.STOPPED) {
