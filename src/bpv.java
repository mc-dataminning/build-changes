...
public record bpv<T>(bpn<StringReader> a, bpl<T> b) {
   public Optional<T> a(bpq<StringReader> $$0) {
      return $$0.a(this.b);
   }

   public T a(StringReader $$0) throws CommandSyntaxException {
      bpo.a<StringReader> $$1 = new bpo.a<>();
      bpz $$2 = new bpz(this.a(), $$1, $$0);
      ...
      if ($$3.isPresent()) {
         ...
         if ($$4.size() == 1 && $$4.get(0) instanceof RuntimeException $$7) {
            ...
            throw new IllegalStateException("Failed to parse: " + $$1.a().stream().map(bpp::toString).collect(Collectors.joining(", ")));
         }
      }
   }
   ...
   public CompletableFuture<Suggestions> a(SuggestionsBuilder $$0) {
      ...
      bpo.a<StringReader> $$2 = new bpo.a<>();
      bpz $$3 = new bpz(this.a(), $$2, $$1);
      this.a($$3);
      List<bpp<StringReader>> $$4 = $$2.a();
      if ($$4.isEmpty()) {
         return $$0.buildFuture();
      } else {
         SuggestionsBuilder $$5 = $$0.createOffset($$2.b());

         for (bpp<StringReader> $$6 : $$4) {
            if ($$6.b() instanceof bpy $$7) {
               en.a($$7.a(), $$5);
            } else {
