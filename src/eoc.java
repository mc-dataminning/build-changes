...
public class eoc extends eor {
   public static final MapCodec<eoc> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               jj.a.e.fieldOf("axis").orElse(jj.a.b).forGetter($$0x -> $$0x.g)
            )
            .apply($$0, eoc::new)
   );
   ...
   public eoc(float $$0, float $$1, int $$2, int $$3, jj.a $$4) {
      if ($$2 >= $$3) {
