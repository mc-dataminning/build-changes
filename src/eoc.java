...
public class eoc implements dyr.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<eoc> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ayh<eoc> a = ayh.a(f);
   private final eog g;
   private final eog h;
   private final eog i;
   ...
   public static eoc a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new eoc(new dzz(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private eoc(eog $$0, eog $$1, eog $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public eoc(ayw $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eog.a($$0, IntStream.rangeClosed(-15, 0)),
         eog.a($$0, IntStream.rangeClosed(-15, 0)),
         eog.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public eoc a(ayw $$0) {
      return new eoc($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dyr.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eod $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eog.b($$4 * $$13), eog.b($$5 * $$13), eog.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eog.b($$1 * $$13);
         double $$21 = eog.b($$2 * $$13);
         double $$22 = eog.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eod $$24 = this.g.a($$19);
            if ($$24 != null) {
