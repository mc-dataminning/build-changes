...
public class eoc implements Comparable<eoc> {
   ...
   public eoc(dah $$0, eod $$1, String $$2, boolean $$3, boolean $$4, boolean $$5, Path $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.f = $$4;
   ...
   public xi k() {
      return ayu.b(this.c.c()) ? wu.c("selectWorld.versionUnknown") : wu.b(this.c.c());
   }
