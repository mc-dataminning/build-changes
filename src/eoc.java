...
public class eoc {
   ...
   public static final Codec<eoc> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> ae.a($$0, 6).map($$0x -> new eoc($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public eoc(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static eoc a() {
      return new eoc(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static eoc a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, jm $$9) {
      switch ($$9) {
         case d:
         default:
            return new eoc($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new eoc($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new eoc($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new eoc($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }
   ...
   public Stream<dgo> b() {
      ...
      int $$2 = kj.a(this.k());
      int $$3 = kj.a(this.m());
      return dgo.a(new dgo($$0, $$1), new dgo($$2, $$3));
   }
   ...
   public static Optional<eoc> a(Iterable<jh> $$0) {
      Iterator<jh> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         eoc $$2 = new eoc($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<eoc> b(Iterable<eoc> $$0) {
      Iterator<eoc> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         eoc $$2 = $$1.next();
         eoc $$3 = new eoc($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   public eoc b(int $$0, int $$1, int $$2) {
      return new eoc(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }
   ...
   public eoc c(int $$0, int $$1, int $$2) {
      return new eoc(this.h() - $$0, this.i() - $$1, this.j() - $$2, this.k() + $$0, this.l() + $$1, this.m() + $$2);
   }
