...
public class eoc extends gfb {
   ...
   static final tm b = tm.c("mco.backup.button.restore");
   static final tm c = tm.c("mco.backup.changes.tooltip");
   private static final tm y = tm.c("mco.configure.world.backup");
   private static final tm z = tm.c("mco.backup.nobackups");
   private final eof A;
   ...
   public void aI_() {
      ...
      this.F = this.d((esq)esq.a(tm.c("mco.backup.button.download"), $$0 -> this.G()).a(this.g - 135, h(1), 120, 20).a());
      this.G = this.d((esq)esq.a(tm.c("mco.backup.button.restore"), $$0 -> this.a(this.D)).a(this.g - 135, h(3), 120, 20).a());
      this.H = this.d((esq)esq.a(tm.c("mco.backup.changes.tooltip"), $$0 -> {
         this.f.a(new eob(this, this.B.get(this.D)));
         this.D = -1;
      }).a(this.g - 135, h(5), 120, 20).a());
      this.d((esq)esq.a(tl.k, $$0 -> this.f.a(this.A)).a(this.g - 100, this.h - 35, 85, 20).a());
      this.e(this.C);
      this.b(this.C);
      this.D();
   }
   ...
   void a(int $$0) {
      if ($$0 >= 0 && $$0 < this.B.size() && !this.J.j) {
         ...
         tm $$3 = epm.a($$1);
         tm $$4 = tm.a("mco.configure.world.restore.question.line1", $$2, $$3);
         tm $$5 = tm.c("mco.configure.world.restore.question.line2");
         this.f.a(new eol($$0x -> {
            if ($$0x) {
               this.I();
            } else {
   ...
   private void G() {
      tm $$0 = tm.c("mco.configure.world.restore.download.question.line1");
      tm $$1 = tm.c("mco.configure.world.restore.download.question.line2");
      this.f.a(new eol($$0x -> {
         if ($$0x) {
            this.H();
         } else {
   ...
   class b extends etm.a<eoc.b> {
      ...
      private void b() {
         ...
         this.i = new etc($$2, $$3, 9, 9, d, $$0x -> eoc.this.f.a(new eob(eoc.this, this.f)), tl.a);
      ...
      private void d() {
         ...
         int $$3 = eoc.this.C.h(eoc.this.B.indexOf(this.f)) + 2;
         this.h = new etc($$2, $$3, 17, 10, e, $$0x -> eoc.this.a(eoc.this.B.indexOf(this.f)), tl.a);
      ...
      public void a(esf $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         $$0.a(eoc.this.i, tm.a("mco.backup.entry", epm.a(this.f.b)), $$3, $$2 + 1, $$10, false);
      ...
      @Override
      public tm a() {
         return tm.a("narrator.select", this.f.b.toString());
      }
   }
}
