...
public class bfa implements Comparable<bfa> {
   ...
   @Nullable
   private bfa i;
   private final Optional<bfa.a> j;
   ...
   public bfa(bey $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable bfa $$6, Optional<bfa.a> $$7) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public boolean a(bfz $$0, Runnable $$1) {
      if (this.j()) {
         int $$2 = this.b() ? $$0.ag : this.d;
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof bfa $$1) ? false : this.d == $$1.d && this.e == $$1.e && this.f == $$1.f && this.c.equals($$1.c);
      }
   }
   ...
   private void c(qr $$0) {
      ...
      this.j.ifPresent($$1x -> bfa.a.a.encodeStart(rc.a, $$1x).resultOrPartial(b::error).ifPresent($$1xx -> $$0.a("FactorCalculationData", $$1xx)));
   }
   ...
   private static bfa a(bey $$0, qr $$1) {
      ...
      if ($$1.b("FactorCalculationData", 10)) {
         $$8 = bfa.a.a.parse(new Dynamic(rc.a, $$1.p("FactorCalculationData"))).resultOrPartial(b::error);
      } else {
         $$8 = Optional.empty();
      }

      return new bfa($$0, $$3, Math.max($$2, 0), $$4, $$5, $$6, $$7, $$8);
   }
   ...
   public static class a {
      public static final Codec<bfa.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  aoi.i.fieldOf("padding_duration").forGetter($$0x -> $$0x.b),
                  ...
                  aoi.i.fieldOf("ticks_active").orElse(0).forGetter($$0x -> $$0x.f),
