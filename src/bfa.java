...
public class bfa extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         baz.a(this.a("minecraft:trident", bfa::c), this.a("minecraft:arrow", bfa::a), this.a("minecraft:spectral_arrow", bfa::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bfa.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bhy.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bhy.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bfa.a<?> $$1, Type<?> $$2, Type<T> $$3) {
