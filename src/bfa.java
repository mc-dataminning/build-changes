...
public abstract class bfa extends DataFix {
   private final String a;
   private final Predicate<String> b;

   public bfa(Schema $$0, String $$1, Predicate<String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   public static UnaryOperator<Typed<?>> a(Type<?> $$0, Predicate<String> $$1, UnaryOperator<Dynamic<?>> $$2) {
      OpticFinder<Pair<String, String>> $$3 = DSL.fieldFinder("id", DSL.named(bgw.D.typeName(), bih.a()));
