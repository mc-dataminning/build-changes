...
public class bfa extends bde {
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
         ...
         () -> DSL.fields(
               ...
               DSL.optionalFields(
                  ...
                  DSL.list(
                     DSL.optionalFields(
                        "biomes",
                        DSL.optionalFields("palette", DSL.list(bbw.H.in($$0))),
                        "block_states",
      ...
      $$0.registerType(false, bbw.I, () -> DSL.constType(a()));
      $$0.registerType(
         false,
         bbw.J,
         () -> DSL.fields(
                           ...
                           (Supplier<TypeTemplate>)() -> DSL.optionalFields(
                                 ...
                                 DSL.taggedChoiceLazy(
                                    ...
                                    ImmutableMap.of(
                                       ...
                                       (Supplier<TypeTemplate>)() -> DSL.or(DSL.fields("preset", bbw.I.in($$0)), DSL.list(DSL.fields("biome", bbw.H.in($$0)))),
