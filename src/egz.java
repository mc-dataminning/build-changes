...
public class egz implements eha, ehb {
   ...
   private final elp<MinecraftServer> I;
   ...
   public egz(cub $$0, dpw $$1, egz.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         0,
   ...
   public static <T> egz a(Dynamic<T> $$0, cub $$1, egz.a $$2, dpw $$3, Lifecycle $$4) {
      long $$5 = $$0.get("Time").asLong(0L);
      return new egz(
         (so)so.a.parse($$0.get("Player").orElseEmptyMap()).result().orElse(null),
         ...
         new elp<>(elo.a, $$0.get("ScheduledEvents").asStream()),
         (so)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dnb.a.a).resultOrPartial(f::error).orElse(dnb.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   @Override
   public so a(iu $$0, @Nullable so $$1) {
      if ($$1 == null) {
         $$1 = this.q;
      }
   ...
   private void a(iu $$0, so $$1, @Nullable so $$2) {
      ...
      $$1.a("Version", $$3);
      td.g($$1);
      DynamicOps<tl> $$4 = ahf.a(tc.a, $$0);
      dpu.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dnb.a.a.encodeStart(tc.a, this.A), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<tl> $$5 = cur.b.encodeStart(tc.a, this.g.g());
      $$5.get().ifLeft($$1x -> $$1.a((so)$$1x)).ifRight($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.B != null) {
   ...
   private static su a(Set<String> $$0) {
      su $$1 = new su();
      $$0.stream().map(tj::a).forEach($$1::add);
      return $$1;
   }
   ...
   @Override
   public boolean B() {
      return this.i == egz.a.b;
   }

   @Override
   public boolean C() {
      return this.i == egz.a.c;
   }
