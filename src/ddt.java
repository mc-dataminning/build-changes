...
public class ddt {
   public static final ddt a = new ddt(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<ddt> b = RecordCodecBuilder.create(
   ...
   public ddt(List<String> $$0, List<String> $$1) {
