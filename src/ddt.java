...
public class ddt extends ddy implements dds {
   ...
   private static IntStream a(bgr $$0, hc $$1) {
      return $$0 instanceof bhh ? IntStream.of(((bhh)$$0).a($$1)) : IntStream.range(0, $$0.b());
   }

   private static boolean b(bgr $$0, hc $$1) {
   ...
   private static boolean c(bgr $$0, hc $$1) {
   ...
   private static boolean a(dds $$0, bgr $$1, int $$2, hc $$3) {
      cjf $$4 = $$1.a($$2);
      if (!$$4.b() && a($$0, $$1, $$4, $$2, $$3)) {
         cjf $$5 = $$4.p();
   ...
   public static cjf a(@Nullable bgr $$0, bgr $$1, cjf $$2, @Nullable hc $$3) {
   ...
   private static boolean a(bgr $$0, cjf $$1, int $$2, @Nullable hc $$3) {
      if (!$$0.b($$2, $$1)) {
         return false;
      } else {
   ...
   private static boolean a(bgr $$0, bgr $$1, cjf $$2, int $$3, hc $$4) {
      if (!$$1.a($$0, $$3, $$2)) {
         return false;
      } else {
   ...
   private static cjf b(@Nullable bgr $$0, bgr $$1, cjf $$2, int $$3, @Nullable hc $$4) {
      cjf $$5 = $$1.a($$3);
      if (a($$1, $$2, $$3, $$4)) {
         boolean $$6 = false;
         boolean $$7 = $$1.af_();
