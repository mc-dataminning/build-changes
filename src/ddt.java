...
public record ddt(boolean d, Optional<jr<btd>> e, Optional<ddg> f, Optional<jv<djm>> g, fba h, ddg i, boolean j, dgi.a k, lr l, lr m, jr<avz> n) implements ddq {
   public static final MapCodec<ddt> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               btd.b.optionalFieldOf("damage_type").forGetter(ddt::c),
