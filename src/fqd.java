...
public class fqd implements agw {
   ...
   private final AtomicReference<fqd.a> l = new AtomicReference<>(fqd.a.a);

   public fqd(uo $$0, exo $$1, @Nullable fqq $$2, @Nullable ffl $$3, boolean $$4, @Nullable Duration $$5, Consumer<vq> $$6, @Nullable fqt $$7) {
      this.f = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a(fqd.a $$0) {
      fqd.a $$1 = this.l.updateAndGet($$1x -> {
         if (!$$0.f.contains($$1x)) {
   ...
   public void a(agz $$0) {
      ...
      try {
         SecretKey $$1 = avg.a();
         PublicKey $$2 = $$0.e();
         $$3 = new BigInteger(avg.a($$0.b(), $$2, $$1)).toString(16);
         $$4 = avg.a(2, $$1);
         $$5 = avg.a(1, $$1);
         byte[] $$6 = $$0.f();
         $$7 = new ahh($$1, $$2, $$6);
   ...
   public void a(agy $$0) {
      this.a(fqd.a.d);
      GameProfile $$1 = $$0.b();
      this.f.a(zw.b, new fqc(this.b, this.f, new fqi($$1, this.b.t().a(this.g, this.h, this.i), fqg.a().a(), cjy.h, null, this.c, this.d, this.j)));
      this.f.a(ahi.a);
      this.f.a(zw.a);
   ...
   public void a(vq $$0) {
      ...
      if (this.c != null && this.c.e()) {
         this.b.a(new gmz(this.d, $$1, $$0));
      } else {
         this.b.a(new fen(this.d, $$1, $$0));
      }
   }
