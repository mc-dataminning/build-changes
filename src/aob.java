...
public class aob {
   ...
   private static int a(ex $$0, Collection<are> $$1, Collection<dbi<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
   ...
   private static int b(ex $$0, Collection<are> $$1, Collection<dbi<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
