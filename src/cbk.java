...
public class cbk extends bml {
   ...
   private static final blw bR = new blw(0.0F, 0.0F, true);
   private static final blw bS = blz.d.n().a(0.5F);
   ...
   public static final agm<Byte> bC = agp.a(cbk.class, ago.a);
   public static final agm<iy> bD = agp.a(cbk.class, ago.m);
   public static final agm<iy> bE = agp.a(cbk.class, ago.m);
   public static final agm<iy> bF = agp.a(cbk.class, ago.m);
   public static final agm<iy> bG = agp.a(cbk.class, ago.m);
   public static final agm<iy> bH = agp.a(cbk.class, ago.m);
   public static final agm<iy> bI = agp.a(cbk.class, ago.m);
   private static final Predicate<blv> bX = $$0 -> $$0 instanceof cha && ((cha)$$0).w() == cha.a.a;
   private final iq<cmy> bY = iq.a(2, cmy.f);
   private final iq<cmy> bZ = iq.a(4, cmy.f);
   private boolean ca;
   public long bJ;
   private int cb;
   private iy cc = bL;
   ...
   public cbk(blz<? extends cbk> $$0, ctp $$1) {
      super($$0, $$1);
      this.t(0.0F);
   }

   public cbk(ctp $$0, double $$1, double $$2, double $$3) {
      this(blz.d, $$0);
      this.a_($$1, $$2, $$3);
   }
   ...
   @Override
   protected void M_() {
      for (blv $$1 : this.dM().a(this, this.cH(), bX)) {
         if (this.f($$1) <= 0.2) {
            $$1.g(this);
         }
      }
   ...
   private bma j(elt $$0) {
      ...
      if ($$3 >= 0.1 && $$3 < 0.1 + ($$2 ? 0.8 : 0.45) && this.b($$4)) {
         $$1 = bma.c;
      } else if ($$3 >= 0.9 + ($$2 ? 0.3 : 0.0) && $$3 < 0.9 + ($$2 ? 1.0 : 0.7) && this.b(bma.e)) {
         $$1 = bma.e;
      } else if ($$3 >= 0.4 && $$3 < 0.4 + ($$2 ? 1.0 : 0.8) && this.b(bma.d)) {
         $$1 = bma.d;
      } else if ($$3 >= 1.6 && this.b(bma.f)) {
         $$1 = bma.f;
      } else if (!this.b(bma.a) && this.b(bma.b)) {
         $$1 = bma.b;
      }
   ...
   private boolean e(bma $$0) {
      return (this.cb & 1 << $$0.d()) != 0 || $$0.a() == bma.a.a && !this.w();
   }

   private boolean a(cfi $$0, bma $$1, cmy $$2, bka $$3) {
      cmy $$4 = this.c($$1);
   ...
   public boolean a(bkt $$0, float $$1) {
      if (this.dM().B || this.dH()) {
         ...
         return false;
      } else if ($$0.a(asj.w) && this.ev() > 0.5F) {
         this.g($$0, 4.0F);
         return false;
      } else {
         boolean $$2 = $$0.a(asj.C);
         ...
         if (!$$2 && !$$3) {
            ...
            if ($$0.d() instanceof cfi $$4 && !$$4.fT().e) {
               return false;
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 32) {
         if (this.dM().B) {
            this.dM().a(this.dr(), this.dt(), this.dx(), ars.an, this.db(), 0.3F, 1.0F, false);
            this.bJ = this.dM().X();
         }
      } else {
         super.b($$0);
   ...
   private void h(bkt $$0) {
      cmy $$1 = new cmy(cnb.uy);
      if (this.ae()) {
         $$1.a(this.af());
      }

      cwq.a(this.dM(), this.dm(), $$1);
      this.i($$0);
   }

   private void i(bkt $$0) {
      this.N();
      this.g($$0);
   ...
   private void N() {
      this.dM().a(null, this.dr(), this.dt(), this.dx(), ars.al, this.db(), 1.0F, 1.0F);
   }
   ...
   public boolean u(blv $$0) {
      return $$0 instanceof cfi && !this.dM().a((cfi)$$0, this.dm());
   }
   ...
   @Override
   public bml.a eG() {
      return new bml.a(ars.am, ars.am);
   }
   ...
   public elt k(float $$0) {
      if (this.A()) {
         elo $$1 = this.v(false).a(this.dk());
         hx $$2 = this.dm();
         int $$3 = Integer.MIN_VALUE;

         for (hx $$4 : hx.a(hx.a($$1.a, $$1.b, $$1.c), hx.a($$1.d, $$1.e, $$1.f))) {
            int $$5 = Math.max(this.dM().a(cty.b, $$4), this.dM().a(cty.a, $$4));
            if ($$5 == 15) {
               return elt.b($$4);
            }
