...
public class ezs {
   ...
   public void a(cer $$0, erz $$1, float $$2, int $$3, int $$4) {
      cgj $$5 = $$0.b(this.d);
   ...
   private void a(cgj $$0, aez $$1, float $$2, erz $$3, int $$4, int $$5) {
      fza $$6 = eqp.O().a(fyz.e).apply($$1);
