...
public class ezs {
   ...
   public vz a(vz $$0, int $$1, wr $$2) {
      final ezs.e $$3 = new ezs.e((float)$$1);
      return $$0.a(new vz.b<vz>() {
         private final eyw c = new eyw();
   ...
   public void a(String $$0, int $$1, wr $$2, boolean $$3, ezs.d $$4) {
      int $$5 = 0;
      int $$6 = $$0.length();
      wr $$7 = $$2;

      while ($$5 < $$6) {
         ezs.b $$8 = new ezs.b((float)$$1);
   ...
   public void a(vz $$0, int $$1, wr $$2, BiConsumer<vz, Boolean> $$3) {
      List<ezs.c> $$4 = Lists.newArrayList();
      $$0.a(($$1x, $$2x) -> {
         if (!$$2x.isEmpty()) {
            $$4.add(new ezs.c($$2x, $$1x));
         }
   ...
   static class a {
      ...
      public vz a(int $$0, int $$1, wr $$2) {
         eyw $$3 = new eyw();
         ListIterator<ezs.c> $$4 = this.a.listIterator();
         int $$5 = $$0;
         boolean $$6 = false;
      ...
      public boolean accept(int $$0, wr $$1, int $$2) {
         ...
         switch ($$2) {
            ...
            case 32:
               ...
               this.h = $$1;
            default:
               float $$4 = ezs.this.a.getWidth($$2, $$1);
               this.f += $$4;
   ...
   class e implements awj {
      ...
      @Override
      public boolean accept(int $$0, wr $$1, int $$2) {
         this.b = this.b - ezs.this.a.getWidth($$2, $$1);
         if (this.b >= 0.0F) {
