...
public class ezs {
   ...
   static class b {
      static final Optional<ezs> a = Optional.ofNullable(a());
      ...
      private static ezs a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ezs();
      }
   }
}
