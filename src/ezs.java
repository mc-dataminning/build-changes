...
public class ezs extends ezk<cfb> implements fbn {
   private float x;
   private float y;
   private final fbh z = new fbh();
   private boolean A;
   private boolean B;

   public ezs(cbl $$0) {
      super($$0.bP, $$0.fQ(), te.c("container.crafting"));
      this.l = 97;
   }
   ...
   public void B() {
      if (this.f.r.g()) {
         this.f.a(new ezh(this.f.t, this.f.t.cl.x(), this.f.m.E().c()));
      } else {
         this.z.h();
      }
   }
   ...
   protected void aE_() {
      if (this.f.r.g()) {
         ...
         this.d(new esu(this.t + 104, this.h / 2 - 22, 20, 18, fbh.a, $$0 -> {
            this.z.f();
            this.t = this.z.a(this.g, this.c);
   ...
   protected void a(erx $$0, float $$1, int $$2, int $$3) {
      ...
      a($$0, $$4 + 26, $$5 + 8, $$4 + 75, $$5 + 78, 30, 0.0625F, this.x, this.y, this.f.t);
   }

   public static void a(erx $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, biw $$9) {
   ...
   public static void a(erx $$0, float $$1, float $$2, int $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, biw $$7) {
      $$0.c().a();
