...
public class ezs extends ezw implements ezu {
   ...
   public ezs.c a() {
      return new ezs.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(fac.b $$0, fac $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (fad)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(fac $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == ezv.k;
         boolean $$2 = $$0 == ezv.j;
   ...
   private IntConsumer a(int $$0, fac.a $$1) {
   ...
   private ezs.b q() {
      ...
      this.k += $$5;
      this.j++;
      ezs.a $$9 = new ezs.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new ezs.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == fac.b.a || this.q == fac.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<fad> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      fad $$1 = (fad)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == fad.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == fad.b.c) {
         ezu.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ezu.a($$11));
         this.a($$14 + 5, ezu.a($$12));
         this.a($$14 + 6, ezu.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(fac a, int b, int c, fac.b d, fac.a e, boolean f, boolean g) {
   ...
   public class b {
      private final int b;
      private final ezs.a c;
      private boolean d;

      b(final int $$1, final ezs.a $$2) {
         this.b = $$1;
         this.c = $$2;
      }
   ...
   public static class c {
      ...
      c(fac.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable faf $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
