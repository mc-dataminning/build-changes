...
public enum ezs implements bab {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final bab.a<ezs> t = bab.a(ezs::values);
   public static final IntFunction<ezs> u = axw.a(ezs::a, values(), axw.a.a);
   private final int v;
   private final String w;

   private ezs(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
