public class fxb extends fyn {
   static final axr a = axr.a();
   private final fyi b;

   fxb(fuh $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fyi $$7) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.B = 0.96F;
      this.C = true;
      this.b = $$7;
   ...
   public static class a implements fxq<ko> {
      ...
      public fxn a(ko $$0, fuh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fxb $$8 = new fxb($$1, $$2, $$3, $$4, 0.0, 0.0, 0.0, this.b);
         $$8.a(1.0F, 0.9F, 1.0F);
   ...
   public static class b implements fxq<ko> {
      ...
      public fxn a(ko $$0, fuh $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fxb $$8 = new fxb($$1, $$2, $$3, $$4, 0.5 - fxb.a.j(), $$6, 0.5 - fxb.a.j(), this.a);
         if ($$1.z.h()) {
            $$8.a(0.6F, 1.0F, 0.8F);
         } else {
            $$8.a(0.08F, 0.4F, 0.4F);
