...
public class gkm implements gkq.a {
   private final fib a;
   private static final int b = axn.a(255, 0, 155, 155);
   private static final int c = axn.a(255, 255, 255, 0);
   ...
   public void a(fcu $$0, ggv $$1, double $$2, double $$3, double $$4) {
      ...
      float $$7 = (float)((double)this.a.s.an() - $$3);
      dcy $$8 = $$5.du();
      float $$9 = (float)((double)$$8.d() - $$2);
      float $$10 = (float)((double)$$8.e() - $$4);
      fcy $$11 = $$1.getBuffer(ghe.a(1.0));
      Matrix4f $$12 = $$0.c().a();
      ...
      for (int $$19 = this.a.s.G_(); $$19 <= this.a.s.an(); $$19 += 2) {
      ...
      for (int $$24 = this.a.s.G_(); $$24 <= this.a.s.an(); $$24 += 16) {
