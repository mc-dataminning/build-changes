...
public class gkm extends ecu {
   ...
   public gkm(gkq $$0, int $$1) {
      this.e = $$0;
      this.b = new ecw($$0, new dir(0, 0), $$0.F_().f(mh.aG).b(dkw.b));
      this.c = new ewp(this, true, $$0.B_().g());
      this.d = new gkm.a(b($$1));
   }
   ...
   private static boolean a(@Nullable eda $$0, int $$1, int $$2) {
      if ($$0 == null) {
         return false;
      } else {
         dir $$3 = $$0.f();
   ...
   @Nullable
   public eda b(int $$0, int $$1, edr $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
         eda $$4 = this.d.a(this.d.a($$0, $$1));
         if (a($$4, $$0, $$1)) {
            return $$4;
         }
      }
   ...
   @Nullable
   public eda a(int $$0, int $$1, vu $$2, Map<egs.a, long[]> $$3, Consumer<adf.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         int $$5 = this.d.a($$0, $$1);
         eda $$6 = this.d.b.get($$5);
         dir $$7 = new dir($$0, $$1);
         if (!a($$6, $$0, $$1)) {
            $$6 = new eda(this.e, $$7);
            $$6.a($$2, $$3, $$4);
   ...
   final class a {
      final AtomicReferenceArray<eda> b;
      ...
      void a(int $$0, @Nullable eda $$1) {
         eda $$2 = this.b.getAndSet($$0, $$1);
         if ($$2 != null) {
            this.h--;
            this.a($$2);
            gkm.this.e.a($$2);
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.g - $$2; $$3 <= this.g + $$2; $$3++) {
               for (int $$4 = this.f - $$2; $$4 <= this.f + $$2; $$4++) {
                  eda $$5 = gkm.this.d.b.get(gkm.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     dir $$6 = $$5.f();
            ...
            gkm.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
