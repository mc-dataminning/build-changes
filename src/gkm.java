...
public class gkm extends gki implements abu, wm {
   ...
   private gkl s;
   private gkl.a t;
   private final Map<UUID, gkx> u = Maps.newHashMap();
   private final Set<gkx> v = new ReferenceOpenHashSet();
   private final gkg w;
   private final gkp x;
   private final fpd y = new fpd(this);
   private int z = 3;
   private int A = 3;
   private final azv B = azv.b();
   private CommandDispatcher<eo> C = new CommandDispatcher();
   private gkn D = new gkn(Map.of(), deo.b.a());
   private final UUID E = UUID.randomUUID();
   private Set<alf<djh>> F;
   ...
   private xl O = xl.a();
   @Nullable
   private CompletableFuture<Optional<crm>> P;
   @Nullable
   private ara Q;
   private final gkf R = new gkf();
   private final gkw S;
   private final gkr T;
   @Nullable
   private gku U;
   ...
   private final fgc Y = new fgc();
   private final gld Z = new gld();
   private final List<WeakReference<gke<?, ?>>> aa = new ArrayList<>();

   public gkm(fpo $$0, vr $$1, gkq $$2) {
      super($$0, $$1, $$2);
      this.r = $$2.a();
      this.G = $$2.c();
      this.H = $$2.d();
      this.w = new gkg($$0, this.e);
      this.x = new gkp(this, $$0);
      this.S = new gkw(this, $$0.aQ().m());
      this.T = new gkr(this, $$0.aQ());
      if ($$2.i() != null) {
         $$0.m.d().a($$2.i());
      }

      this.I = dbf.a(this.H);
      this.J = dyl.a($$2.c(), this.H);
   }
   ...
   private void F() {
      for (WeakReference<gke<?, ?>> $$0 : this.aa) {
         gke<?, ?> $$1 = $$0.get();
         if ($$1 != null) {
            $$1.a();
         }
   ...
   public void a(adl $$0) {
      zi.a($$0, this, this.a);
      this.a.r = new gkv(this.a, this);
      agk $$1 = $$0.m();
      List<alf<djh>> $$2 = Lists.newArrayList($$0.f());
      ...
      boolean $$6 = $$1.g();
      int $$7 = $$1.j();
      gkl.a $$8 = new gkl.a(bud.c, $$0.e(), $$6);
      this.t = $$8;
      this.s = new gkl(this, $$8, $$3, $$4, this.z, this.A, this.a.f, $$5, $$1.c(), $$7);
      this.a.a(this.s, fyl.a.c);
      if (this.a.t == null) {
         this.a.t = this.a.r.a(this.s, new awy(), new foz());
         this.a.t.w(-180.0F);
         if (this.a.V() != null) {
      ...
      this.a.t.e($$0.b());
      this.s.d(this.a.t);
      this.a.t.k = new gpi(this.a.n);
      this.a.r.a(this.a.t);
      this.a.u = this.a.t;
      this.a(this.a.t, this.s, fyl.a.c);
      this.a.t.u($$0.j());
      this.a.t.b($$0.k());
      this.a.t.x($$0.l());
      this.a.t.c($$1.h());
      ...
      if (this.c != null && !this.W && !this.G()) {
         fve $$9 = fve.a(this.a, fve.a.k, m, n);
         this.a.aA().a($$9);
         this.W = true;
      }
   }
   ...
   private bwi b(abv $$0) {
      ...
      if ($$1 == bwr.bS) {
         ...
         if ($$2 == null) {
            ...
            return new gpk(this.s, $$2.a());
         }
      } else {
         return $$1.a(this.s, bwq.r);
      }
   }

   private void a(bwi $$0) {
      if ($$0 instanceof ctw $$1) {
         this.a.ak().a((hnh)(new hna($$1)));
   ...
   public void a(agc $$0) {
      ...
      if ($$1 == null) {
         if (this.K.isPresent() && this.K.getAsInt() == $$0.b()) {
            ...
            this.b.a(new aho.b(this.a.t.dz(), this.a.t.dB(), this.a.t.dF(), this.a.t.dK(), this.a.t.dM(), false, false));
         }
      } else {
         boolean $$2 = $$0.f().contains(bxx.a) || $$0.f().contains(bxx.b) || $$0.f().contains(bxx.c);
   ...
   public void a(ado $$0) {
      ...
      if ($$1 != null) {
         if ($$1.df()) {
            ait $$2 = $$1.am();
            fex $$3 = $$2.a((long)$$0.b(), (long)$$0.e(), (long)$$0.f());
            $$2.e($$3);
         } else {
            if ($$0.j()) {
               ait $$4 = $$1.am();
               fex $$5 = $$4.a((long)$$0.b(), (long)$$0.e(), (long)$$0.f());
               $$4.e($$5);
               if ($$0.i()) {
                  $$1.d($$5, $$0.g(), $$0.h());
               } else {
   ...
   public void a(adp $$0) {
      zi.a($$0, this, this.a);
      if ($$0.a(this.s) instanceof ctw $$2) {
         if ($$2.f() instanceof cul $$4) {
            $$4.e.addAll($$0.e());
         }
      }
   }
   ...
   public void a(aed $$0) {
      ...
      this.b.a(new aho.b($$1.dz(), $$1.dB(), $$1.dF(), $$1.dK(), $$1.dM(), false, false));
   }

   private static boolean a(bxw $$0, Set<bxx> $$1, bwi $$2, boolean $$3) {
      bxw $$4 = bxw.a($$2);
      bxw $$5 = bxw.a($$4, $$0, $$1);
      ...
      if ($$3 && !$$6) {
         ...
         $$2.w($$5.c());
         $$2.x($$5.d());
         bxw $$7 = new bxw($$2.bz(), fex.c, $$2.N, $$2.O);
         bxw $$8 = bxw.a($$7, $$0, $$1);
         $$2.c($$8.a(), $$8.c(), $$8.d());
         return false;
      }
   ...
   public void a(aee $$0) {
      ...
      $$1.x($$0.e());
      $$1.by();
      this.b.a(new aho.c($$1.dK(), $$1.dM(), false, false));
   }
   ...
   private void a(ecv $$0, int $$1, int $$2) {
      ewk $$3 = this.s.h().q();
      ecw[] $$4 = $$0.d();
      dio $$5 = $$0.f();
   ...
   public void a(afw $$0) {
      ...
      this.a.aZ().d();
      this.H();
      fsw.b $$1 = this.a.m.d().k();
      this.a.c(new gbi(p, this.b));
      this.b.a(abj.d, new gkj(this.a, this.b, new gkq(this.r, this.e, this.G, this.H, this.d, this.c, this.f, this.h, $$1, this.i, this.j)));
      this.b(ahd.a);
      this.b.a(abj.b);
   }
   ...
   public void a(agb $$0) {
      ...
      if ($$1 != null) {
         if ($$1 instanceof bww) {
            this.s.a($$1.dz(), $$1.dB(), $$1.dF(), awn.jf, awo.h, 0.1F, (this.B.i() - this.B.i()) * 0.35F + 0.9F, false);
         } else {
            this.s.a($$1.dz(), $$1.dB(), $$1.dF(), awn.oj, awo.h, 0.2F, (this.B.i() - this.B.i()) * 1.4F + 2.0F, false);
         }

         this.a.g.a(new gno(this.a.aq(), this.s, $$1, $$2));
         if ($$1 instanceof cno $$3) {
            czk $$4 = $$3.f();
            if (!$$4.f()) {
               $$4.h($$0.f());
            }
   ...
   public void a(afe $$0) {
      zi.a($$0, this, this.a);
      if (this.s.a($$0.b()) instanceof bxh $$2) {
         $$2.e_($$0.e());
      }
   }

   private static czk a(crj $$0) {
   ...
   public void a(acx $$0) {
      ...
      if ($$1 != null) {
         switch ($$0.b()) {
            case 21:
               this.a.ak().a((hnh)(new hmz((cog)$$1)));
               break;
            case 35:
               int $$2 = 40;
               this.a.g.a($$1, ly.an, 30);
               this.s.a($$1.dz(), $$1.dB(), $$1.dF(), awn.AD, $$1.dl(), 1.0F, 1.0F, false);
               if ($$1 == this.a.t) {
                  this.a.j.a(a((crj)this.a.t));
               }
               break;
            case 63:
               this.a.ak().a((hnh)(new hnd((cmb)$$1)));
               break;
            default:
               $$1.b($$0.b());
         }
   ...
   public void a(aem $$0) {
      ...
      alf<djh> $$5 = $$4.dU().aj();
      boolean $$6 = $$2 != $$5;
      fyl.a $$7 = this.a($$4.eG(), $$2, $$5);
      if ($$6) {
         Map<eyo, eyq> $$8 = this.s.l();
         boolean $$9 = $$1.f();
         boolean $$10 = $$1.g();
         int $$11 = $$1.j();
         gkl.a $$12 = new gkl.a(this.t.q(), this.t.l(), $$10);
         this.t = $$12;
         this.s = new gkl(this, $$12, $$2, $$3, this.z, this.A, this.a.f, $$9, $$1.c(), $$11);
         this.s.a($$8);
         this.a.a(this.s, $$7);
      }
      ...
      gpj $$13;
      if ($$0.a((byte)2)) {
         $$13 = this.a.r.a(this.s, $$4.l(), $$4.m(), $$4.cb(), $$4.ch());
      } else {
      ...
      $$13.cw = $$4.cw;
      $$13.cx = $$4.cx;
      if (this.a.z instanceof fxr || this.a.z instanceof fxr.a) {
         this.a.a(null);
      }
   ...
   private fyl.a a(boolean $$0, alf<djh> $$1, alf<djh> $$2) {
      fyl.a $$3 = fyl.a.c;
      if (!$$0) {
         if ($$1 == djh.j || $$2 == djh.j) {
            $$3 = fyl.a.a;
         } else if ($$1 == djh.k || $$2 == djh.k) {
            $$3 = fyl.a.b;
         }
      }
   ...
   public void a(adc $$0) {
      zi.a($$0, this, this.a);
      if (this.s.a($$0.f()) instanceof cll $$2) {
         gpj $$3 = this.a.t;
         int $$4 = $$0.e();
         bun $$5 = new bun(cll.v($$4));
         cwe $$6 = new cwe($$0.b(), $$3.gi(), $$5, $$2, $$4);
         $$3.bR = $$6;
         this.a.a(new gac($$6, $$3.gi(), $$2, $$4));
      }
   }
   ...
   public void a(adt $$0) {
      zi.a($$0, this, this.a);
      iv $$1 = $$0.b();
      if (this.s.c_($$1) instanceof dza $$2) {
         this.a.t.a($$2, $$0.e());
      } else {
   ...
   public void a(aca $$0) {
      ...
      this.a.s.a($$1, $$0.e()).ifPresent($$1x -> {
         $$1x.c($$0.f(), this.G);
         if ($$1x instanceof dxx && this.a.z instanceof fzn) {
            ((fzn)this.a.z).G();
         }
      });
   }
   ...
   public void a(afg $$0) {
      zi.a($$0, this, this.a);
      if (this.s.a($$0.b()) instanceof bxj $$2) {
         $$0.e().forEach($$1 -> $$2.a((bws)$$1.getFirst(), (czk)$$1.getSecond()));
      }
   }
   ...
   public void a(adb $$0) {
      ...
      if ($$2 == adb.b) {
         ...
         this.s.a($$1, $$1.dz(), $$1.dD(), $$1.dF(), awn.aF, awo.h, 0.18F, 0.45F);
      } else if ($$2 == adb.i) {
         this.s.e($$3);
      } else if ($$2 == adb.j) {
         this.s.c($$3);
      } else if ($$2 == adb.k) {
         this.s.a($$1, $$1.dz(), $$1.dB(), $$1.dF(), awn.vJ, awo.g, 1.0F, 1.0F);
      } else if ($$2 == adb.l) {
         this.s.a(ly.q, $$1.dz(), $$1.dB(), $$1.dF(), 0.0, 0.0, 0.0);
         if ($$4 == 1) {
            this.s.a($$1, $$1.dz(), $$1.dB(), $$1.dF(), awn.io, awo.f, 1.0F, 1.0F);
         }
      } else if ($$2 == adb.m) {
         this.a.t.b($$3 == 0.0F);
      } else if ($$2 == adb.n) {
   ...
   private void a(gpj $$0, gkl $$1, fyl.a $$2) {
      this.U = new gku($$0, $$1, this.a.f);
      this.a.a(new fyl(this.U::b, $$2));
   }
   ...
   public void a(agi $$0) {
      ...
      if ($$1 instanceof bxj) {
         jf<bvk> $$2 = $$0.e();
         bvm $$3 = new bvm($$2, $$0.g(), $$0.f(), $$0.i(), $$0.h(), $$0.j(), null);
         if (!$$0.k()) {
            $$3.k();
         }
   ...
   private <T> js.a<T> a(alf<? extends js<? extends T>> $$0, axt.a $$1) {
      js<T> $$2 = this.G.f($$0);
      return $$2.a($$1.a($$2));
   }
   ...
   public void a(zw $$0) {
      ...
      $$1.forEach(js.a::d);
      this.J = dyl.a(this.G, this.H);
      List<czk> $$3 = List.copyOf(cyc.e().l());
      this.Z.a($$3);
   }
   ...
   public void a(adz $$0) {
      ...
      if ($$1 == this.a.t) {
         if (this.a.t.n()) {
            this.a.a(new fxr($$0.e(), this.s.k().l()));
         } else {
            this.a.t.gf();
         }
      }
   ...
   public void a(aeq $$0) {
      ...
      if (this.c != null) {
         this.c.d = $$0.b();
         $$0.e().map(gla::b).ifPresent(this.c::a);
         glb.b(this.c);
      }
   }
   ...
   public void a(aek $$0) {
      zi.a($$0, this, this.a);
      if ($$0.a(this.s) instanceof bxj $$1) {
         $$1.d($$0.e());
      }
   }
   ...
   public void a(aeb $$0) {
      ...
      for (aeb.b $$1 : $$0.f()) {
         gkx $$2 = new gkx(Objects.requireNonNull($$1.b()), this.G());
   ...
   private void a(aeb.a $$0, aeb.b $$1, gkx $$2) {
      switch ($$0) {
         case b:
            this.a($$1, $$2);
            break;
   ...
   public void a(afk $$0) {
      ...
      String $$1 = $$0.b();
      if ($$0.f() == 0) {
         this.Y.a($$1, fgf.c, $$0.e(), $$0.g(), false, $$0.h().orElse(null));
      } else {
         ffu $$2 = this.Y.a($$1);
         if ($$2 != null) {
            if ($$0.f() == 1) {
   ...
   private void a(int $$0, int $$1, adk $$2, boolean $$3) {
      ...
      this.a($$0, $$1, $$4, djq.a, $$5, $$6, $$7, $$3);
      BitSet $$8 = $$2.d();
      BitSet $$9 = $$2.e();
      Iterator<byte[]> $$10 = $$2.f().iterator();
      this.a($$0, $$1, $$4, djq.b, $$8, $$9, $$10, $$3);
      $$4.a(new dio($$0, $$1), true);
   }
   ...
   public void a(aef $$0) {
      zi.a($$0, this, this.a);
      if (this.s.a($$0.b()) instanceof crs $$2) {
         $$2.c = $$0.e();
      }
   }
   ...
   public void a(agd $$0) {
      zi.a($$0, this, this.a);
      if (this.a.z instanceof gat $$1) {
         $$1.a($$0.b(), $$0.e());
      }
   }

   private void a(int $$0, int $$1, ewk $$2, djq $$3, BitSet $$4, BitSet $$5, Iterator<byte[]> $$6, boolean $$7) {
      for (int $$8 = 0; $$8 < $$2.c(); $$8++) {
         int $$9 = $$2.d() + $$8;
         boolean $$10 = $$4.get($$8);
         boolean $$11 = $$5.get($$8);
         if ($$10 || $$11) {
            $$2.a($$3, jy.a($$0, $$9, $$1), $$10 ? new ecq((byte[])$$6.next().clone()) : new ecq());
            if ($$7) {
               this.s.c($$0, $$9, $$1);
            }
         }
   ...
   public Collection<gkx> l() {
      return this.v;
   }

   public Collection<gkx> m() {
   ...
   @Nullable
   public gkx a(String $$0) {
      for (gkx $$1 : this.u.values()) {
