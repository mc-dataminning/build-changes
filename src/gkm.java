...
public class gkm extends awa<Optional<gkm.b>> implements AutoCloseable {
   ...
   protected Optional<gkm.b> a(avv $$0, bpo $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gkm.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gkm.b> $$0, avv $$1, bpo $$2) {
   ...
   public void a(int $$0, fll $$1, float $$2, Matrix4f $$3, Matrix4f $$4, fbs $$5, float $$6) {
      if (this.q != null) {
         ...
         if (!this.s) {
            RenderSystem.setShaderColor(ayp.h(ayp.b($$0)), ayp.h(ayp.c($$0)), ayp.h(ayp.d($$0)), 1.0F);
            if ($$1 == fll.c) {
               this.a(glo.x(), $$3, $$4, $$18, $$7, $$19);
            }
   ...
   private void a(glo $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      gkn $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private fgk a(fgn $$0, int $$1, int $$2, fll $$3, gkm.a $$4, glo $$5) {
      float $$6 = 0.8F;
   ...
   private void a(gkm.a $$0, fgg $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(gkm.a $$0, fgg $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
