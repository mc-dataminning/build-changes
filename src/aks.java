...
public class aks extends ald<aks.a> {
   private static final Logger c = LogUtils.getLogger();
   private final Stopwatch d = Stopwatch.createUnstarted();

   public aks(akx $$0, List<akr> $$1, Executor $$2, Executor $$3, CompletableFuture<apz> $$4) {
      super($$2, $$3, $$0, $$1, ($$1x, $$2x, $$3x, $$4x, $$5) -> {
         ...
         return $$10.thenApplyAsync($$5x -> {
            ...
            return new aks.a($$3x.c(), $$8.d(), $$9.d(), $$6, $$7);
         }, $$3);
      }, $$4);
      this.d.start();
   ...
   private List<aks.a> a(List<aks.a> $$0) {
      this.d.stop();
      long $$1 = 0L;
