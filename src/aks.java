...
public class aks {
   ...
   static final ayg c = new ayg();
   private final akr d;
   private final aks.b<?>[] e;
   private boolean f;
   ...
   public static <T> ako<T> a(Class<? extends akr> $$0, akp<T> $$1) {
      if (a.isDebugEnabled()) {
         try {
   ...
   private <T> aks.b<T> b(ako<T> $$0) {
      return (aks.b<T>)this.e[$$0.a()];
   }

   public <T> T a(ako<T> $$0) {
      return this.b($$0).b();
   }

   public <T> void a(ako<T> $$0, T $$1) {
      this.a($$0, $$1, false);
   }

   public <T> void a(ako<T> $$0, T $$1, boolean $$2) {
      aks.b<T> $$3 = this.b($$0);
   ...
   private <T> void a(aks.b<T> $$0, aks.c<?> $$1) {
   ...
   public static class a {
      private final akr a;
      private final aks.b<?>[] b;

      public a(akr $$0) {
         this.a = $$0;
         this.b = new aks.b[aks.c.b($$0.getClass())];
      }

      public <T> aks.a a(ako<T> $$0, T $$1) {
         int $$2 = $$0.a();
         if ($$2 > this.b.length) {
   ...
   public static class b<T> {
      ...
      public aks.c<T> e() {
         return aks.c.a(this.a, this.b);
      }
   }

   public static record c<T>(int a, akp<T> b, T c) {

      public static <T> aks.c<T> a(ako<T> $$0, T $$1) {
         akp<T> $$2 = $$0.b();
         return new aks.c<>($$0.a(), $$2, $$2.copy($$1));
      }
      ...
      public static aks.c<?> a(ww $$0, int $$1) {
         int $$2 = $$0.l();
         akp<?> $$3 = akq.a($$2);
         if ($$3 == null) {
      ...
      private static <T> aks.c<T> a(ww $$0, int $$1, akp<T> $$2) {
         return new aks.c<>($$1, $$2, $$2.codec().decode($$0));
      }
   }
}
