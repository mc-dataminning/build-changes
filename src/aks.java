...
public class aks extends cbu {
   ...
   public final akt e;
   private final aff co;
   private final apk cp;
   ...
   private akf cR = akf.a;
   private aew<cpv> cS = cpv.h;
   @Nullable
   private gw cT;
   private boolean cU;
   private float cV;
   private final alv cW;
   private boolean cX;
   private boolean cY;
   private cba cZ = new cba(0, 0, 0);
   private final cey da = new cey() {
      @Override
      public void a(cel $$0, hp<cjf> $$1, cjf $$2, int[] $$3) {
         aks.this.c.b(new xr($$0.j, $$0.k(), $$1, $$2));
      ...
      public void a(cel $$0, int $$1, cjf $$2) {
         aks.this.c.b(new xt($$0.j, $$0.k(), $$1, $$2));
      }

      @Override
      public void a(cel $$0, cjf $$1) {
         aks.this.c.b(new xt(-1, $$0.k(), -1, $$1));
      }
   ...
   public aks(MinecraftServer $$0, akr $$1, GameProfile $$2, akg $$3) {
      super($$1, $$1.R(), $$1.S(), $$2);
      this.cW = $$0.a(this);
      this.e = $$0.b(this);
      this.d = $$0;
   ...
   private void e(akr $$0) {
      ...
      if ($$0.C_().g() && $$0.n().aT().m() != cps.c) {
         ...
         int $$3 = arx.a($$0.B_().b((double)$$1.u(), (double)$$1.w()));
         if ($$3 < $$2) {
            $$2 = $$3;
         }
         ...
         for (int $$9 = 0; $$9 < $$6; $$9++) {
            ...
            int $$11 = $$10 % ($$2 * 2 + 1);
            int $$12 = $$10 / ($$2 * 2 + 1);
            gw $$13 = akm.a($$0, $$1.u() + $$11 - $$2, $$1.w() + $$12 - $$2);
            if ($$13 != null) {
               this.a($$13, 0.0F, 0.0F);
               if ($$0.g(this)) {
                  break;
   ...
   public void a(int $$0) {
      ...
      float $$2 = ($$1 - 1.0F) / $$1;
      this.ch = arx.a((float)$$0 / $$1, 0.0F, $$2);
      this.cz = -1;
   }
   ...
   public void m() {
      try {
         ...
         if (this.eI() != this.ct) {
            this.ct = this.eI();
            this.a(eip.i, arx.f((float)this.ct));
         }

         if (this.cg != this.cv) {
            this.cv = this.cg;
            this.a(eip.j, arx.f((float)this.cv));
         }

         if (this.cf != this.cu) {
            this.cu = this.cf;
            this.a(eip.k, arx.f((float)this.cu));
         }
   ...
   public boolean a(bho $$0, float $$1) {
      if (this.b($$0)) {
         ...
         boolean $$2 = this.d.l() && this.gs() && $$0.a(apv.m);
         if (!$$2 && this.cA > 0 && !$$0.a(apv.d)) {
            return false;
         } else {
            biq $$3 = $$0.d();
   ...
   protected Optional<l.a> a(akr $$0, gw $$1, boolean $$2, dha $$3) {
      ...
      if ($$4.isPresent()) {
         ...
         hc.a $$5 = this.dL().a_(this.ax).d(cxx.a).orElse(hc.a.a);
   ...
   private void f(akr $$0) {
      aew<cpv> $$1 = $$0.ac();
      aew<cpv> $$2 = this.dL().ac();
      al.v.a(this, $$1, $$2);
   ...
   public void c(@Nullable biq $$0) {
      ...
      if ($$1 != this.cE) {
         if (this.cE.dL() instanceof akr $$2) {
   ...
   public void a(aew<cpv> $$0, @Nullable gw $$1, float $$2, boolean $$3, boolean $$4) {
      if ($$1 != null) {
   ...
   public void a(apd $$0, apf $$1, float $$2, float $$3) {
      this.c.b(new aao(jd.c.d($$0), $$1, this.dq(), this.ds(), this.dw(), $$2, $$3, this.ag.g()));
   }
   ...
   public void a(double $$0, double $$1) {
      this.cl = (float)(arx.d($$1, $$0) * 180.0F / (float)Math.PI - (double)this.dB());
