...
public class boz extends blh {
   ...
   private static TypeTemplate b(Schema $$0) {
      TypeTemplate $$1 = DSL.optionalFields("blocks", DSL.or(bjm.E.in($$0), DSL.list(bjm.E.in($$0))));
