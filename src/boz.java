...
public class boz implements bpa {
   ...
   private static final boz k = new boz();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(boy $$0) {
      URL $$1 = boz.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, boy $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bpc a = new bpc(() -> boz.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == boz.this.l && $$0.getState() == RecordingState.STOPPED) {
