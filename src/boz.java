...
public class boz implements bos {
   ...
   public static Set<boq> a() {
      Builder<boq> $$0 = ImmutableSet.builder();

      try {
         boz.a $$1 = new boz.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> boq.a("cpu#" + $$1x, bop.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(boq.a("heap MiB", bop.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bor.a.a());
      return $$0.build();
   }
   ...
   public static boq a(final LongSupplier $$0) {
      ...
      boq.d $$3 = new boq.d(2.0F);
      return boq.a("ticktime", bop.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
