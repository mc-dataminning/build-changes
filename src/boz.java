...
public record boz(Instant a, String b, long c) {
   ...
   public static boz a(RecordedEvent $$0) {
      ...
      return new boz($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static boz.a a(List<boz> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<boz>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            boz $$3 = (boz)$$2x.get(0);
            boz $$4 = (boz)$$2x.get($$2x.size() - 1);
