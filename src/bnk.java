...
public abstract class bnk<C, V> implements bne<StringReader, V>, bnl {
   private final bmy<alb> b;
   protected final C a;

   protected bnk(bmy<alb> $$0, C $$1) {
      this.b = $$0;
      this.a = $$1;
   }

   @Override
   public Optional<V> a(bnd<StringReader> $$0) {
      $$0.b().skipWhitespace();
      int $$1 = $$0.c();
