...
public class bnk implements bnl {
   ...
   private static final bnk k = new bnk();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bnj $$0) {
      URL $$1 = bnk.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bnj $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bnn a = new bnn(() -> bnk.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bnk.this.l && $$0.getState() == RecordingState.STOPPED) {
