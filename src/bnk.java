...
public class bnk {
   ...
   private bnk(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bnk a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bnk($$0, $$1);
   }

   public bnk.d a() throws IOException {
      bnk.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bnk.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bnk.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bnk.c $$3 = bnk.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bnk.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bnk.a($$0, $$3);
            }
         }
   ...
   public bnk.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bnk.c> $$2 = this.a().c();
      ...
      bnk.e $$4 = new bnk.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bnk.c b) implements bnk.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bnk.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bnk.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bnk.b> {
      private final List<bnk.b> a;

      d(List<bnk.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bnk.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bnk.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bnk.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bnk.d a() {
         ListIterator<bnk.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bnk.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bnk.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bnk.b> b() {
         return this.a.stream();
      }

      public Set<bnk.c> c() {
         return this.a.stream().map(bnk.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bnk.c b) implements bnk.b {
