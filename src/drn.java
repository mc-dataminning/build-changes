...
public class drn {
   private static final dlj a = cyu.hj.o();
   private static final dlj b = cyu.hk.o();
   private static final dlj c = cyu.iA.o();
   private static final dlj d = cyu.hn.o();
   private static final dlj e = cyu.hv.o();
   private static final dlj f = cyu.hx.o();
   private static final dlj g = cyu.hr.o();
   private static final dlj h = cyu.iC.o();
   private static final dlj i = cyu.dP.o();
   private final dlj j;
   private final int k;
   private final dlj[] l;
   private final efz m;
   ...
   public drn(drj $$0, dlj $$1, int $$2, dri $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dre.P);
   ...
   public void a(drj $$0, cws $$1, iv<cwq> $$2, boolean $$3, drs $$4, final dnf $$5, dqz $$6, drm.o $$7) {
      ...
      drm.g $$13 = new drm.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      drm.u $$14 = $$7.apply($$13);
      hz.a $$15 = new hz.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dqv.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            ij<cwq> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(cwx.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dqv.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   private boolean a(dlj $$0) {
      return !$$0.i() && $$0.u().c();
   }

   @Deprecated
   public Optional<dlj> a(drm.o $$0, dsv $$1, Function<hz, ij<cwq>> $$2, dnf $$3, dqz $$4, hz $$5, boolean $$6) {
      drm.g $$7 = new drm.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(kg.at), $$1);
      drm.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dlj $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dnc $$0, int $$1, int $$2, int $$3, cvt $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, cwq $$1, dnc $$2, hz.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(cyu.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(awp $$0, dlj[] $$1, int $$2, dlj $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dlj a(int $$0, int $$1, int $$2) {
