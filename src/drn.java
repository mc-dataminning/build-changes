...
public class drn extends dro {
   ...
   public static final Codec<drn> c = RecordCodecBuilder.create(
      $$0 -> a($$0).and(drm.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, drn::new)
   );
   private final drm h;

   public drn(bfv $$0, drr $$1, Optional<drl> $$2, drm $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(cpr $$0, BiConsumer<gu, dez> $$1, aru $$2, gu $$3, gu $$4, dqm $$5) {
   ...
   private boolean a(cpr $$0, aru $$1, gu $$2, ha $$3, gu $$4, List<gu> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
