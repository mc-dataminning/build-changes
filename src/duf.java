...
public class duf extends dsr {
   ...
   public duf(jh $$0, dvo $$1) {
      super(dst.p, $$0, $$1);
   }

   public static void a(final amg $$0, Executor $$1) {
      f = $$1;
   ...
   static CompletableFuture<Optional<GameProfile>> a(String $$0, amg $$1) {
      return $$1.f()
         .b($$0)
         .thenCompose(
            $$0x -> {
   ...
   static CompletableFuture<Optional<GameProfile>> a(UUID $$0, amg $$1, BooleanSupplier $$2) {
   ...
   protected void b(un $$0, js.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (vk)cze.a.encodeStart(vb.a, this.i).getOrThrow());
      }
   ...
   protected void a(un $$0, js.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         cze.a.parse(vb.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }

      if ($$0.b("note_block_sound", 8)) {
         this.j = all.c($$0.l("note_block_sound"));
      }
   ...
   public static void a(dff $$0, jh $$1, dvo $$2, duf $$3) {
      if ($$2.b(dpl.a) && $$2.c(dpl.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
   ...
   public static CompletableFuture<Optional<GameProfile>> a(String $$0) {
      ...
      return $$1 != null && bak.f($$0) ? (CompletableFuture)$$1.getUnchecked($$0) : CompletableFuture.completedFuture(Optional.empty());
   }
