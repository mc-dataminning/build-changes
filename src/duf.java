...
public class duf extends dtz implements bsb {
   ...
   public static void a(ard $$0, ji $$1, dwx $$2, duf $$3, dbl.a<dbx, dap> $$4) {
      boolean $$5 = false;
      ...
      for (int $$6 = 0; $$6 < $$3.c.size(); $$6++) {
         ...
         if (!$$7.f()) {
            ...
            if ($$3.d[$$6] >= $$3.e[$$6]) {
               ...
               if ($$9.a($$0.K())) {
                  bsg.a($$0, (double)$$1.u(), (double)$$1.v(), (double)$$1.w(), $$9);
                  $$3.c.set($$6, cwp.j);
                  $$0.a($$1, $$2, $$2, 3);
   ...
   public boolean a(ard $$0, @Nullable bvh $$1, cwp $$2) {
