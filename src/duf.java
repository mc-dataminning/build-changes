...
public class duf extends dtz<dwe> {
   private static final ie[] a = ie.values();

   public duf(Codec<dwe> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dub<dwe> $$0) {
      dwe $$1 = $$0.f();
      awp $$2 = $$0.d();
      hz $$3 = $$0.e();
      cwm $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dru $$9 = new dru(new dqw($$4.C()));
      efz $$10 = efz.a($$9, -4, 1.0);
      ...
      for (hz $$33 : hz.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<hz, Integer> $$37 : $$7) {
            $$35 += awi.f($$33.j((jd)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (hz $$38 : $$11) {
            $$36 += awi.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, cyu.a.o(), $$32);
      ...
      for (hz $$44 : $$31) {
         ...
         for (ie $$46 : a) {
            ...
            dlj $$48 = $$4.a_($$47);
            if ($$45.b(dlz.C)) {
               $$45 = $$45.a(dlz.C, Boolean.valueOf($$48.u().b()));
            }
