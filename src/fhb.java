...
public class fhb {
   ...
   private static CompletableFuture<fhb.a> b() {
      fmr $$0 = fmf.Q().X();
      return $$0.g() != fmr.a.c ? CompletableFuture.completedFuture(new fhb.a(fhb.b.d)) : CompletableFuture.supplyAsync(() -> {
         fhh $$0x = fhh.a();
   ...
   public static record a(fhb.b a, @Nullable fjd b) {
      ...
      @Nullable
      public ftx a(ftx $$0) {
         return (ftx)(switch (this.a) {
            case a -> null;
            case b -> new fjq($$0);
            case c -> new fka($$0);
            case d -> new fjv(xv.c("mco.error.invalid.session.title"), xv.c("mco.error.invalid.session.message"), $$0);
