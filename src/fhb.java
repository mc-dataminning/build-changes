...
public abstract class fhb<E extends fhb.a<E>> extends fgy {
   ...
   private final List<E> p = new fhb.b();
   ...
   public fhb(ffh $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xo.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected void a(fgt $$0) {
      RenderSystem.enableBlend();
      alf $$1 = this.c.r == null ? fnf.h : fnf.j;
      alf $$2 = this.c.r == null ? fnf.i : fnf.k;
   ...
   @Nullable
   protected E a(flk $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(flk $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fla.a t() {
      if (this.aH_()) {
         ...
         return this.v != null ? fla.a.b : fla.a.a;
      }
   }
   ...
   protected void a(flc $$0, E $$1) {
      List<E> $$2 = this.aD_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(flb.b, xp.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fhb.a<E>> implements fjc {
      @Deprecated
      fhb<E> a;
      ...
      public abstract void a(fgt var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
