...
public class bnx {
   ...
   private static void a(bof $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(boa $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dvz, boj<bnz>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((boj)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ad.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dvz, boj<bnz>> $$3 : $$0) {
         boj<bnz> $$4 = (boj<bnz>)$$3.getSecond();
         JsonObject $$5 = ad.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dvz)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<boh> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bnm.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bnv $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bnx::a));
      $$1.add("chunksWritten", this.a($$0.m(), bnx::a));
      return $$1;
   }

   private JsonElement a(boc.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bnv $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bnx::a));
      $$1.add("received", this.a($$0.k(), bnx::a));
      return $$1;
   }

   private <T> JsonElement a(boe<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bob> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bob>, ToDoubleFunction<bob>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bob::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bob::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bob::c));
      return $$1;
   }
}
