...
public class alo {
   ...
   private static void a(als $$0, akt $$1, dhk $$2) {
      $$0.b(new yh($$2, $$1.x_(), null, null));
      cpi $$3 = $$2.f();
      abc.a($$1, $$3);
   }

   private List<dhk> a(akd $$0, cpi $$1) {
      int $$2 = asb.d(this.i);
      List<dhk> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : asb.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
