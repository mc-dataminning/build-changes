...
public class alo extends fce {
   private final MinecraftServer b;
   private final Set<fbw> c = Sets.newHashSet();
   ...
   public euk.a<fcf> b() {
      return new euk.a<>(this::h, this::a, ban.n);
   }
