...
public class alo implements AutoCloseable {
   ...
   private alo(URL $$0, alo.c $$1, URL $$2, alo.b $$3, URL $$4, alo.b $$5, String $$6, alo.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? arg.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static alo a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = arg.a($$0);
            URI $$2 = new URI(arg.i($$1, "apiServer"));
            String $$3 = arg.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = arg.a($$1, "ruleId", 1);
               String $$5 = arg.a($$1, "serverId", "");
               String $$6 = arg.a($$1, "roomId", "Java:Chat");
               int $$7 = arg.a($$1, "hashesToDrop", -1);
               int $$8 = arg.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = arg.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, alo.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<ala> a(GameProfile $$0, String $$1, alo.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(ala.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = arg.a($$4, "response", false);
            if ($$5) {
               return ala.a($$1);
            } else {
               String $$6 = arg.a($$4, "hashed", null);
               if ($$6 == null) {
                  return ala.b($$1);
               } else {
                  JsonArray $$7 = arg.v($$4, "hashes");
                  ti $$8 = this.a($$1, $$7, $$2);
                  return new ala($$1, $$8);
               }
            }
   ...
   private ti a(String $$0, JsonArray $$1, alo.a $$2) {
      if ($$1.isEmpty()) {
         return ti.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return ti.b;
      } else {
         ti $$3 = new ti($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new alo.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public aln a(GameProfile $$0) {
      return new alo.d($$0);
   }
   ...
   public interface a {
      alo.a a = ($$0, $$1) -> false;
      alo.a b = ($$0, $$1) -> $$0.length() == $$1;

      static alo.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static alo.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements aln {
      ...
      d(GameProfile $$0) {
         this.c = $$0;
         bfj<Runnable> $$1 = bfj.a(alo.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }
      ...
      public CompletableFuture<List<ala>> a(List<String> $$0) {
         List<CompletableFuture<ala>> $$1 = $$0.stream().map($$0x -> alo.this.a(this.c, $$0x, alo.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<ala> a(String $$0) {
         return alo.this.a(this.c, $$0, alo.this.l, this.d);
      }
   }
