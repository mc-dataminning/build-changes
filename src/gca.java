public class gca extends gbx {
   private final gbs a;
   private static final int b = 8;

   protected gca(fxq $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gbs $$8) {
      ...
      this.l += $$6;
      this.D *= 0.75F * $$7;
      this.t = (int)(8.0F / ayu.b(this.r, 0.5F, 1.0F) * $$7);
   ...
   public static class a implements gba<lm> {
      ...
      public gax a(lm $$0, fxq $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gca($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
