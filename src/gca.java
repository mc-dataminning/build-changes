...
public class gca implements eyd, AutoCloseable {
   private static final String a = "shaders/program/";
   private static final Logger b = LogUtils.getLogger();
   private static final eyb c = new eyb();
   ...
   private final List<eyj> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, eyj> l = Maps.newHashMap();
   private final int m;
   ...
   public gca(atz $$0, String $$1) throws IOException {
      akm $$2 = new akm("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         JsonArray $$13 = axu.a($$5, "attributes", null);
         if ($$13 != null) {
            int $$14 = 0;
         ...
         JsonArray $$18 = axu.a($$5, "uniforms", null);
         if ($$18 != null) {
            int $$19 = 0;
         ...
         this.p = a(axu.a($$5, "blend", null));
         this.s = a($$0, eyg.a.a, $$6);
         this.t = a($$0, eyg.a.b, $$7);
         this.m = eyh.a();
         eyh.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = eyj.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static eye a(atz $$0, eyg.a $$1, String $$2) throws IOException {
      eyg $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof eye)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         eye $$7;
         if ($$3 == null) {
            akm $$4 = new akm("shaders/program/" + $$2 + $$1.b());
   ...
   public static eyc a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new eyc();
      } else {
         int $$1 = 32774;
         ...
         boolean $$7 = false;
         if (axu.a($$0, "func")) {
            $$1 = eyc.a($$0.get("func").getAsString());
            if ($$1 != 32774) {
               $$6 = false;
            }
         }
         ...
         if (axu.a($$0, "srcrgb")) {
            $$2 = eyc.b($$0.get("srcrgb").getAsString());
            if ($$2 != 1) {
               $$6 = false;
            }
         }
         ...
         if (axu.a($$0, "dstrgb")) {
            $$3 = eyc.b($$0.get("dstrgb").getAsString());
            if ($$3 != 0) {
               $$6 = false;
            }
         }
         ...
         if (axu.a($$0, "srcalpha")) {
            $$4 = eyc.b($$0.get("srcalpha").getAsString());
            if ($$4 != 1) {
               $$6 = false;
            }
         ...
         if (axu.a($$0, "dstalpha")) {
            $$5 = eyc.b($$0.get("dstalpha").getAsString());
            if ($$5 != 0) {
               $$6 = false;
            }
         ...
         if ($$6) {
            ...
            return $$7 ? new eyc($$2, $$3, $$4, $$5, $$1) : new eyc($$2, $$3, $$1);
         }
      }
   }
   ...
   private void b(JsonElement $$0) throws akp {
      JsonObject $$1 = axu.m($$0, "uniform");
      String $$2 = axu.i($$1, "name");
      int $$3 = eyj.a(axu.i($$1, "type"));
      int $$4 = axu.o($$1, "count");
      float[] $$5 = new float[Math.max($$4, 16)];
      JsonArray $$6 = axu.v($$1, "values");
      if ($$6.size() != $$4 && $$6.size() > 1) {
         throw new akp("Invalid amount of values specified (expected " + $$4 + ", found " + $$6.size() + ")");
      } else {
         int $$7 = 0;
