public class gca<S extends gym> extends gbm<S> implements gai, gbv {
   private final geo a;
   private final geo b;
   private final geo c;
   private final geo d;
   ...
   public static geu a() {
      gew $$0 = new gew();
      gey $$1 = $$0.a();
      gey $$2 = $$1.a("head", get.c().a(0, 0).a(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F), geq.a(0.0F, 0.0F, 0.0F));
      $$2.a("hat", get.c().a(32, 0).a(-4.0F, -10.0F, -4.0F, 8.0F, 12.0F, 8.0F, new ges(0.45F)), geq.a);
      $$2.a("nose", get.c().a(24, 0).a(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F, 2.0F), geq.a(0.0F, -2.0F, 0.0F));
      $$1.a(
         "body",
         get.c().a(16, 20).a(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F).a(0, 38).a(-4.0F, 0.0F, -3.0F, 8.0F, 20.0F, 6.0F, new ges(0.5F)),
         geq.a(0.0F, 0.0F, 0.0F)
      );
      gey $$3 = $$1.a(
         "arms",
         get.c().a(44, 22).a(-8.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F).a(40, 38).a(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F),
         geq.a(0.0F, 3.0F, -1.0F, -0.75F, 0.0F, 0.0F)
      );
      $$3.a("left_shoulder", get.c().a(44, 22).a().a(4.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F), geq.a);
      ...
      $$1.a("right_arm", get.c().a(40, 46).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F), geq.a(-5.0F, 2.0F, 0.0F));
      $$1.a("left_arm", get.c().a(40, 46).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F), geq.a(5.0F, 2.0F, 0.0F));
   ...
   public void a(S $$0) {
      ...
      if ($$3 == cme.a.b) {
         if ($$0.aY_().f()) {
            gag.a(this.g, this.f, true, $$0.h, $$0.p);
         } else {
            gag.a(this.f, this.g, $$0.d, $$0.h, $$0.p);
         }
      } else if ($$3 == cme.a.c) {
         this.f.d = 0.0F;
         this.f.b = -5.0F;
         ...
         gag.a(this.f, this.g, this.a, true);
      } else if ($$3 == cme.a.f) {
         gag.a(this.f, this.g, (float)$$0.f, $$0.g, true);
      } else if ($$3 == cme.a.g) {
         this.f.d = 0.0F;
         this.f.b = -5.0F;
