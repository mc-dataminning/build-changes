...
public interface bmv {
   static bmp<StringReader> a(String $$0) {
      return new bmv.b($$0);
   }

   static bmp<StringReader> a(char $$0) {
      return new bmv.a($$0);
   }

   public static record a(char a) implements bmp<StringReader> {
      @Override
      public boolean a(bml<StringReader> $$0, bmn $$1, bmh $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements bmp<StringReader> {
      @Override
      public boolean a(bml<StringReader> $$0, bmn $$1, bmh $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
