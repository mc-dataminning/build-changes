...
public class bmv extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bmy.a(new Dynamic($$0, $$1), bmv.a, bmy.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bhw.s.typeName()) ? super.getChoiceType($$0, bjk.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bhw.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bhw.s, () -> DSL.optionalFields("components", bhw.w.in($$0), DSL.taggedChoiceLazy("id", bjk.a(), $$2)));
      $$0.registerType(
         true,
         bhw.t,
         () -> DSL.hook(
