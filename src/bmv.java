...
public class bmv {
   ...
   private bmv(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bmv a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bmv($$0, $$1);
   }

   public bmv.d a() throws IOException {
      bmv.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bmv.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bmv.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bmv.c $$3 = bmv.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bmv.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bmv.a($$0, $$3);
            }
         }
   ...
   public bmv.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bmv.c> $$2 = this.a().c();
      ...
      bmv.e $$4 = new bmv.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bmv.c b) implements bmv.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bmv.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bmv.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bmv.b> {
      private final List<bmv.b> a;

      d(List<bmv.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bmv.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bmv.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bmv.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bmv.d a() {
         ListIterator<bmv.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bmv.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bmv.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bmv.b> b() {
         return this.a.stream();
      }

      public Set<bmv.c> c() {
         return this.a.stream().map(bmv.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bmv.c b) implements bmv.b {
