...
public class gqe {
   ...
   public static void a(fos $$0, fjc $$1, gps $$2) {
      cqy $$3 = $$0.t;
      if (!$$3.ad) {
         dzz $$4 = a($$3);
         if ($$4 != null) {
   ...
   private static void a(hip $$0, fjc $$1, gps $$2) {
      float $$3 = 0.1F;
   ...
   private static void b(fos $$0, fjc $$1, gps $$2) {
      iu $$3 = iu.a($$0.t.dA(), $$0.t.dE(), $$0.t.dG());
      float $$4 = gpp.a($$0.t.dV().B_(), $$0.t.dV().B($$3));
   ...
   private static void a(fjc $$0, gps $$1) {
      hip $$2 = hkz.b.c();
      fjg $$3 = $$1.getBuffer(gqc.E($$2.i()));
      float $$4 = $$2.c();
      float $$5 = $$2.d();
      float $$6 = ($$4 + $$5) / 2.0F;
      float $$7 = $$2.g();
