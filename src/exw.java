...
public class exw {
   ...
   @Nullable
   private String g;
   private static final exw.a h = new exw.a() {
      @Nullable
      @Override
      public exv a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (exz.a(this.d, "Get capabilities")) {
         ...
         if (exz.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  exz.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !exz.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public exv a(exw.c $$0) {
      return ($$0 == exw.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements exw.a {
      private final int a;
      private final Set<exv> b = Sets.newIdentityHashSet();
      ...
      public exv a() {
         if (this.b.size() >= this.a) {
            if (aa.aX) {
               exw.a.warn("Maximum sound pool size {} reached", this.a);
            }
