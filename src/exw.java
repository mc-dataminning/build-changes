...
public class exw implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<exw.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public exw(List<exw.a> $$0) {
      this.c = $$0;
   }
   ...
   public static exw a(BufferedReader $$0) {
      return new exw($$0.lines().flatMap($$0x -> exw.a.a($$0x).stream()).toList());
   }

   public static record a(exw.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<exw.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new exw.a(exw.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new exw.a(exw.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new exw.a(exw.b.b, $$3));
      ...
      static exw.a b(String $$0) {
         return new exw.a(exw.b.a, "glob:" + $$0);
      }

      static exw.a c(String $$0) {
         return new exw.a(exw.b.a, "regex:" + $$0);
      }

      static exw.a d(String $$0) {
         return new exw.a(exw.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      exw.b a = FileSystem::getPathMatcher;
      exw.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
