...
public class exw extends ewy {
   ...
   public exw(ewq $$0, int $$1, int $$2, int $$3, int $$4, vf $$5, vf $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new exz($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fax $$0) {
      $$0.a(faw.a, vf.a("gui.narrate.editBox", this.x(), this.j()));
   }
   ...
   private void k() {
      double $$0 = this.c();
      exz.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         exz.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
