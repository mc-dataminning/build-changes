...
public class afq<E> implements Codec<ig<E>> {
   ...
   public static <E> Codec<ig<E>> a(afv<? extends io<E>> $$0, Codec<ib<E>> $$1, boolean $$2) {
      return new afq<>($$0, $$1, $$2);
   }

   private afq(afv<? extends io<E>> $$0, Codec<ib<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
      this.d = Codec.either(arh.b($$0), this.c);
   }

   public <T> DataResult<Pair<ig<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof afu<T> $$2) {
