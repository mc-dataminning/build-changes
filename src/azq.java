...
public class azq extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bff.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bff.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bff.s);
