...
public class azq extends beo {
   ...
   public azq(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bfp.s, "minecraft:banner");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), azq::a);
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return aze.a($$0, "Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(azq::b)));
   }
   ...
   private static Dynamic<?> b(Dynamic<?> $$0) {
      ...
      return aze.a($$0, "Color", "color", $$0x -> $$0x.createString(a($$0x.asInt(0))));
   }
