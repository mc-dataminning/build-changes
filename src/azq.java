...
public class azq extends axu {
   public azq(Schema $$0, boolean $$1) {
      super($$0, $$1, "Villager trade fix", ays.x, "minecraft:villager");
   }
   ...
   protected Typed<?> a(Typed<?> $$0) {
      ...
      if (!($$2.type() instanceof ListType<?> $$4)) {
         ...
         OpticFinder<Pair<String, String>> $$10 = DSL.fieldFinder("id", DSL.named(ays.z.typeName(), baa.a()));
