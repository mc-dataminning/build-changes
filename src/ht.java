...
public class ht extends iw {
   ...
   private static final int e = 1 + atm.f(atm.c(30000000));
   ...
   public static ht a(double $$0, double $$1, double $$2) {
      return new ht(atm.a($$0), atm.a($$1), atm.a($$2));
   }
   ...
   public static Iterable<ht> a(ats $$0, int $$1, ht $$2, int $$3) {
   ...
   public static Iterable<ht> a(ats $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      int $$8 = $$5 - $$2 + 1;
      int $$9 = $$6 - $$3 + 1;
      int $$10 = $$7 - $$4 + 1;
   ...
   public static Stream<ht> a(dwz $$0) {
      return a(
         Math.min($$0.g(), $$0.j()),
         Math.min($$0.h(), $$0.k()),
         Math.min($$0.i(), $$0.l()),
   ...
   public static Stream<ht> a(ejp $$0) {
      return a(atm.a($$0.a), atm.a($$0.b), atm.a($$0.c), atm.a($$0.d), atm.a($$0.e), atm.a($$0.f));
   }
   ...
   public static class a extends ht {
      ...
      public ht.a b(double $$0, double $$1, double $$2) {
         return this.d(atm.a($$0), atm.a($$1), atm.a($$2));
      }
      ...
      public ht.a a(hx.a $$0, int $$1, int $$2) {
         switch ($$0) {
            case a:
               return this.d(atm.a(this.u(), $$1, $$2), this.v(), this.w());
            case b:
               return this.d(this.u(), atm.a(this.v(), $$1, $$2), this.w());
            case c:
               return this.d(this.u(), this.v(), atm.a(this.w(), $$1, $$2));
            default:
