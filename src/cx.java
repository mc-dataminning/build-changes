...
public abstract class cx<T extends cx.a> implements ap<T> {
   private final Map<ajp, Set<ap.a<T>>> a = Maps.newIdentityHashMap();

   @Override
   public final void a(ajp $$0, ap.a<T> $$1) {
      this.a.computeIfAbsent($$0, $$0x -> Sets.newHashSet()).add($$1);
   }

   @Override
   public final void b(ajp $$0, ap.a<T> $$1) {
   ...
   @Override
   public final void a(ajp $$0) {
      this.a.remove($$0);
   }

   protected void a(apg $$0, Predicate<T> $$1) {
      ajp $$2 = $$0.Q();
