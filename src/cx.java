...
public abstract class cx<T extends cx.a> implements ap<T> {
   private final Map<akb, Set<ap.a<T>>> a = Maps.newIdentityHashMap();

   @Override
   public final void a(akb $$0, ap.a<T> $$1) {
      this.a.computeIfAbsent($$0, $$0x -> Sets.newHashSet()).add($$1);
   }

   @Override
   public final void b(akb $$0, ap.a<T> $$1) {
   ...
   @Override
   public final void a(akb $$0) {
      this.a.remove($$0);
   }

   protected void a(apt $$0, Predicate<T> $$1) {
      akb $$2 = $$0.Q();
