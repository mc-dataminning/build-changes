...
public abstract class fvb<T extends csd> extends fum implements fwh<T> {
   ...
   private cwq V = cwq.j;
   private long W;
   protected final Set<cua> E = Sets.newHashSet();
   protected boolean F;
   private int X;
   private int Y;
   private boolean Z;
   ...
   private int ac;
   private boolean ad;
   private cwq ae = cwq.j;

   public fvb(T $$0, cox $$1, wp $$2) {
      super($$2);
      this.z = $$0;
      this.A = $$1.p_();
      this.Z = true;
   ...
   public void a(fof $$0, int $$1, int $$2, float $$3) {
      ...
      this.b($$0, $$1, $$2);
      cwq $$7 = this.R.f() ? this.z.g() : this.R;
      if (!$$7.f()) {
         int $$8 = 8;
         int $$9 = this.R.f() ? 8 : 16;
         String $$10 = null;
   ...
   private void d(fof $$0) {
      if (this.B != null && this.B.e()) {
         $$0.a(gmj::H, G, this.B.e - 4, this.B.f - 4, 24, 24);
      }
   }

   private void e(fof $$0) {
      if (this.B != null && this.B.e()) {
         $$0.a(gmj::F, H, this.B.e - 4, this.B.f - 4, 24, 24);
      }
   }
   ...
   private boolean b(cwq $$0) {
      return $$0.b().map(fww::a).map(fww::a).orElse(false);
   }

   protected List<wp> a(cwq $$0) {
      return a(this.m, $$0);
   }

   private void a(fof $$0, cwq $$1, int $$2, int $$3, @Nullable String $$4) {
      $$0.c().a();
   ...
   protected abstract void a(fof var1, float var2, int var3, int var4);

   protected void a(fof $$0, cua $$1) {
      int $$2 = $$1.e;
      int $$3 = $$1.f;
      cwq $$4 = $$1.g();
      boolean $$5 = false;
      ...
      if ($$1 == this.M && !this.R.f() && this.Q && !$$4.f()) {
         ...
         if (csd.a($$1, $$7, true) && this.z.b($$1)) {
            $$5 = true;
            int $$9 = Math.min($$7.k(), $$1.a_($$7));
            int $$10 = $$1.g().f() ? 0 : $$1.g().M();
            int $$11 = csd.a(this.E, this.X, $$7) + $$10;
            if ($$11 > $$9) {
               $$11 = $$9;
               $$8 = n.o.toString() + $$9;
            }
      ...
      if (!$$0.f() && this.F) {
         if (this.X == 2) {
            ...
            for (cua $$1 : this.E) {
               ...
               int $$5 = Math.min(csd.a(this.E, this.X, $$0) + $$3, $$4);
               this.aa -= $$5 - $$3;
            }
         }
      }
   ...
   @Nullable
   private cua b(double $$0, double $$1) {
      for (cua $$2 : this.z.k) {
         if ($$2.d() && this.a($$2, $$0, $$1)) {
            return $$2;
         }
               ...
               if (this.m.n.ac().c()) {
                  ...
                  if (this.z.g().f()) {
                     if ($$3) {
                        ...
                        boolean $$10 = $$9 != -999 && (feq.a(flk.Q().aO().h(), 340) || feq.a(flk.Q().aO().h(), 344));
                        cso $$11 = cso.a;
                        if ($$10) {
                           this.ae = $$4 != null && $$4.h() ? $$4.g().v() : cwq.j;
                           $$11 = cso.b;
                        } else if ($$9 == -999) {
                           $$11 = cso.e;
                        }
   ...
   private void a(int $$0) {
      if (this.B != null && this.z.g().f()) {
         if (this.m.n.D.a($$0)) {
            this.a(this.B, this.B.d, 40, cso.c);
            return;
         }

         for (int $$1 = 0; $$1 < 9; $$1++) {
            if (this.m.n.S[$$1].a($$0)) {
               this.a(this.B, this.B.d, $$1, cso.c);
            }
         }
      }
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      ...
      if (this.M != null && this.m.n.ac().c()) {
         if ($$2 == 0 || $$2 == 1) {
            ...
            } else if (this.R.M() > 1 && $$5 != null && csd.a($$5, this.R, false)) {
               long $$7 = af.c();
               if (this.O == $$5) {
                  if ($$7 - this.W > 500L) {
                     this.a(this.M, this.M.d, 0, cso.a);
                     this.a($$5, $$5.d, 1, cso.a);
                     this.a(this.M, this.M.d, 0, cso.a);
                     this.W = $$7 + 750L;
                     this.R.h(1);
                  }
      ...
      } else if (this.F && $$5 != null && !$$6.f() && ($$6.M() > this.E.size() || this.X == 2) && csd.a($$5, $$6, true) && $$5.a($$6) && this.z.b($$5)) {
         this.E.add($$5);
         this.G();
      }
   ...
   public boolean b(double $$0, double $$1, int $$2) {
      ...
      if (this.ad && $$3 != null && $$2 == 0 && this.z.a(cwq.j, $$3)) {
         if (t()) {
            if (!this.ae.f()) {
               for (cua $$8 : this.z.k) {
                  if ($$8 != null && $$8.a(this.m.t) && $$8.h() && $$8.c == $$3.c && csd.a($$8, this.ae, true)) {
                     this.a($$8, $$8.d, $$2, cso.b);
                  }
               }
            }
         } else {
         ...
         if (this.M != null && this.m.n.ac().c()) {
            if ($$2 == 0 || $$2 == 1) {
               ...
               boolean $$9 = csd.a($$3, this.R, false);
               if ($$7 != -1 && !this.R.f() && $$9) {
                  this.a(this.M, this.M.d, $$2, cso.a);
                  this.a($$3, $$7, 0, cso.a);
                  if (this.z.g().f()) {
                     this.V = cwq.j;
                  } else {
            ...
            this.a(null, -999, csd.c(0, this.X), cso.f);

            for (cua $$10 : this.E) {
               this.a($$10, $$10.d, csd.c(1, this.X), cso.f);
            }

            this.a(null, -999, csd.c(2, this.X), cso.f);
         } else if (!this.z.g().f()) {
            if (this.m.n.H.a($$2)) {
               this.a($$3, $$7, $$2, cso.d);
            } else {
               boolean $$11 = $$7 != -999 && (feq.a(flk.Q().aO().h(), 340) || feq.a(flk.Q().aO().h(), 344));
               if ($$11) {
                  this.ae = $$3 != null && $$3.h() ? $$3.g().v() : cwq.j;
               }

               this.a($$3, $$7, $$2, $$11 ? cso.b : cso.a);
            }
         }
      }
   ...
   private boolean a(cua $$0, double $$1, double $$2) {
   ...
   protected void a(cua $$0, int $$1, int $$2, cso $$3) {
      if ($$0 != null) {
         $$1 = $$0.d;
      }
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if (this.B != null && this.B.h()) {
            if (this.m.n.H.a($$0, $$1)) {
               this.a(this.B, this.B.d, 0, cso.d);
            } else if (this.m.n.E.a($$0, $$1)) {
               this.a(this.B, this.B.d, s() ? 1 : 0, cso.e);
            }
         }
      ...
      if (this.z.g().f() && this.B != null) {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            if (this.m.n.S[$$2].a($$0, $$1)) {
               this.a(this.B, this.B.d, $$2, cso.c);
               return true;
            }
         }
      }
