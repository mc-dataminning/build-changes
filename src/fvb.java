...
public class fvb implements erl, AutoCloseable {
   ...
   private final List<err> j = Lists.newArrayList();
   private final List<Integer> k = Lists.newArrayList();
   private final Map<String, err> l = Maps.newHashMap();
   private final int m;
   ...
   public fvb(asa $$0, String $$1) throws IOException {
      aiy $$2 = new aiy("shaders/program/" + $$1 + ".json");
      this.n = $$1;
      ary $$3 = $$0.getResourceOrThrow($$2);
      ...
      try (Reader $$4 = $$3.e()) {
         ...
         this.p = a(avx.a($$5, "blend", null));
         this.s = a($$0, ero.a.a, $$6);
         this.t = a($$0, ero.a.b, $$7);
         this.m = erp.a();
         erp.b(this);
         this.i();
         if (this.r != null) {
            for (String $$23 : this.r) {
               int $$24 = err.b(this.m, $$23);
               this.q.add($$24);
            }
         }
   ...
   public static erm a(asa $$0, ero.a $$1, String $$2) throws IOException {
      ero $$3 = $$1.c().get($$2);
      if ($$3 != null && !($$3 instanceof erm)) {
         throw new InvalidClassException("Program is not of type EffectProgram");
      } else {
         erm $$7;
         if ($$3 == null) {
            aiy $$4 = new aiy("shaders/program/" + $$2 + $$1.b());
            ary $$5 = $$0.getResourceOrThrow($$4);
   ...
   public static erk a(@Nullable JsonObject $$0) {
      if ($$0 == null) {
         return new erk();
      } else {
         int $$1 = 32774;
