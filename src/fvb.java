...
public class fvb extends fwf {
   public static final double a = 7.0;
   private static final wv c = wv.c("chat_screen.usage");
   ...
   protected void aN_() {
      ...
      this.b = new fqw(this.m.i, 4, this.o - 12, this.n - 4, 12, wv.c("chat.editBox")) {
         @Override
         protected xj d() {
            return super.d().b(fvb.this.w.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.d(this.b);
      this.w = new fqq(this.m, this, this.b, this.p, false, false, 1, 10, true, -805306368);
      this.w.b(false);
      this.w.d();
   }
   ...
   public void a(fpz $$0, int $$1, int $$2, float $$3) {
      ...
      this.w.a($$0, $$1, $$2);
      $$0.c().b();
      fmx $$4 = this.m.m.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
         $$0.b(this.p, this.p.c($$4.g(), 210), $$1, $$2);
      } else {
         xs $$5 = this.b((double)$$1, (double)$$2);
         if ($$5 != null && $$5.j() != null) {
            $$0.a(this.p, $$5, $$1, $$2);
         }
      }
   ...
   protected void a(fuk $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fuj.a, wv.a("chat_screen.message", $$1));
      }
   }

   @Nullable
   private xs b(double $$0, double $$1) {
