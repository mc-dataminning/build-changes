...
public class fvb extends fve {
   fvb(fra $$0, fuz $$1, double $$2, double $$3, double $$4) {
      super($$0, $$2, $$3 - 0.125, $$4);
      this.b(0.01F, 0.01F);
      this.a($$1);
   ...
   fvb(fra $$0, fuz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
   ...
   public static class a implements fuh<ke> {
      ...
      public fue a(ke $$0, fra $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         fvb $$12 = new fvb($$1, this.a, $$2, $$3, $$4, $$9, $$10, $$11);
         $$12.a(0.9F, 0.4F, 0.5F);
         return $$12;
      }
   }
   ...
   public static class b implements fuh<ke> {
      ...
      public fue a(ke $$0, fra $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fvb $$8 = new fvb($$1, this.a, $$2, $$3, $$4, 0.0, -0.8F, 0.0) {
            @Override
            public Optional<jy> o() {
               return Optional.of(jy.a);
            }
         };
         $$8.t = awm.b($$1.z, 500, 1000);
         $$8.u = 0.01F;
   ...
   public static class d implements fuh<ke> {
      ...
      public fue a(ke $$0, fra $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         fvb $$9 = new fvb($$1, this.a, $$2, $$3, $$4, 0.0, $$8, 0.0);
         $$9.a(0.1F, 0.1F, 0.3F);
         $$9.b(0.001F, 0.001F);
         return $$9;
      }
