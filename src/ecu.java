...
public class ecu extends ebk<eei> {
   public static final int a = 10;
   private static final int b = 42;
   private static final LoadingCache<Long, List<ecu.a>> c = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).build(new ecu.b());

   public ecu(Codec<eei> $$0) {
      super($$0);
   }

   public static List<ecu.a> a(ddb $$0) {
      ayo $$1 = ayo.a($$0.C());
      long $$2 = $$1.g() & 65535L;
      return (List<ecu.a>)c.getUnchecked($$2);
   }

   @Override
   public boolean a(ebm<eei> $$0) {
      eei $$1 = $$0.f();
      ddb $$2 = $$0.b();
      ayo $$3 = $$0.d();
      ja $$4 = $$0.e();
   ...
   private void a(dcu $$0, ayo $$1, eei $$2, ecu.a $$3) {
      int $$4 = $$3.c();
            ...
            for (int $$11 = -2; $$11 <= 2; $$11++) {
               for (int $$12 = 0; $$12 <= 3; $$12++) {
                  ...
                  if ($$13 || $$14 || $$15) {
                     ...
                     dsk $$18 = dfj.eW
                        .o()
                        .a(dji.a, Boolean.valueOf($$16 && $$11 != -2))
                        .a(dji.c, Boolean.valueOf($$16 && $$11 != 2))
                        .a(dji.d, Boolean.valueOf($$17 && $$10 != -2))
                        .a(dji.b, Boolean.valueOf($$17 && $$10 != 2));
      ...
      if ($$19 != null) {
         ...
         $$0.b($$19);
         ja $$20 = $$19.dq();
         this.a($$0, $$20.d(), dfj.F.o());
         this.a($$0, $$20, dih.a($$0, $$20));
      }
   }
   ...
   public static class a {
      ...
      public a(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
         ...
         this.e = $$3;
         this.f = $$4;
         this.g = new ewa((double)($$0 - $$2), (double)dwf.e, (double)($$1 - $$2), (double)($$0 + $$2), (double)dwf.d, (double)($$1 + $$2));
      }
   ...
   static class b extends CacheLoader<Long, List<ecu.a>> {
      public List<ecu.a> a(Long $$0) {
         IntArrayList $$1 = ac.a(IntStream.range(0, 10), ayo.a($$0));
         List<ecu.a> $$2 = Lists.newArrayList();
