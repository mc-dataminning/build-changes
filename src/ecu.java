...
public class ecu {
   ...
   public static final Codec<ecu> a = Codec.INT_STREAM
      .comapFlatMap(
         $$0 -> ac.a($$0, 6).map($$0x -> new ecu($$0x[0], $$0x[1], $$0x[2], $$0x[3], $$0x[4], $$0x[5])),
   ...
   public ecu(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static ecu a() {
      return new ecu(Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE);
   }

   public static ecu a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, ih $$9) {
      switch ($$9) {
         case d:
         default:
            return new ecu($$0 + $$3, $$1 + $$4, $$2 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$8 - 1 + $$5);
         case c:
            return new ecu($$0 + $$3, $$1 + $$4, $$2 - $$8 + 1 + $$5, $$0 + $$6 - 1 + $$3, $$1 + $$7 - 1 + $$4, $$2 + $$5);
         case e:
            return new ecu($$0 - $$8 + 1 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
         case f:
            return new ecu($$0 + $$5, $$1 + $$4, $$2 + $$3, $$0 + $$8 - 1 + $$5, $$1 + $$7 - 1 + $$4, $$2 + $$6 - 1 + $$3);
      }
   }
   ...
   public Stream<cwg> b() {
      ...
      int $$2 = je.a(this.k());
      int $$3 = je.a(this.m());
      return cwg.a(new cwg($$0, $$1), new cwg($$2, $$3));
   }
   ...
   public static Optional<ecu> a(Iterable<ib> $$0) {
      Iterator<ib> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         ecu $$2 = new ecu($$1.next());
         $$1.forEachRemaining($$2::a);
         return Optional.of($$2);
      }
   }

   public static Optional<ecu> b(Iterable<ecu> $$0) {
      Iterator<ecu> $$1 = $$0.iterator();
      if (!$$1.hasNext()) {
         return Optional.empty();
      } else {
         ecu $$2 = $$1.next();
         ecu $$3 = new ecu($$2.c, $$2.d, $$2.e, $$2.f, $$2.g, $$2.h);
   ...
   @Deprecated
   public ecu a(int $$0, int $$1, int $$2) {
      this.c += $$0;
      this.d += $$1;
      this.e += $$2;
      this.f += $$0;
   ...
   public ecu b(int $$0, int $$1, int $$2) {
      return new ecu(this.c + $$0, this.d + $$1, this.e + $$2, this.f + $$0, this.g + $$1, this.h + $$2);
   }

   public ecu a(int $$0) {
      return new ecu(this.h() - $$0, this.i() - $$0, this.j() - $$0, this.k() + $$0, this.l() + $$0, this.m() + $$0);
   }
