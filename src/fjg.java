...
public class fjg implements Comparable<fjg> {
   private static final Map<String, fjg> h = Maps.newHashMap();
   private static final Map<fcw.a, fjg> i = Maps.newHashMap();
   ...
   private final fcw.a m;
   private final String n;
   private fcw.a o;
   private boolean p;
   private int q;

   public static void a(fcw.a $$0) {
      fjg $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(fcw.a $$0, boolean $$1) {
      fjg $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (fjg $$0 : h.values()) {
         if ($$0.o.a() == fcw.b.a && $$0.o.b() != fcw.bv.b()) {
            $$0.a(fcw.a(fji.Q().aO().h(), $$0.o.b()));
         }
      }
   }
   ...
   public fjg(String $$0, int $$1, String $$2) {
      this($$0, fcw.b.a, $$1, $$2);
   }

   public fjg(String $$0, fcw.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public void b(fcw.a $$0) {
      this.o = $$0;
   }

   public int a(fjg $$0) {
      return this.n.equals($$0.n) ? gzk.a(this.l).compareTo(gzk.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }

   public static Supplier<xi> a(String $$0) {
      fjg $$1 = h.get($$0);
      return $$1 == null ? () -> xi.c($$0) : $$1::k;
   }

   public boolean b(fjg $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(fcw.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == fcw.bv.b() ? this.o.a() == fcw.b.b && this.o.b() == $$1 : this.o.a() == fcw.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == fcw.b.c && this.o.b() == $$0;
   }
