...
public class fjg extends hhp {
   ...
   private static final fpm D = new fpm(alz.b("widget/cross_button"), alz.b("widget/cross_button_highlighted"));
   ...
   protected void aT_() {
      ...
      if (this.S) {
         this.T = this.c(fny.a(xv.c("mco.selectServer.trial"), fso.b(this, aza.q)).a(this.G() - 10 - 99, this.J() - 10 - 4 - 40, 99, 20).a());
      }

      this.c(fny.a(xv.c("mco.selectServer.buy"), fso.b(this, aza.r)).a(this.G() - 10 - 99, this.J() - 10 - 20, 99, 20).a());
   ...
   public static void a(fnl $$0, fny $$1) {
      ...
      $$0.a(glo::B, C, $$1.D() + $$1.y() - 8 - 4, $$1.E() + $$1.w() / 2 - 4, 8, 8);
      $$0.c().b();
   }
   ...
   public void b(fnl $$0, int $$1, int $$2, float $$3) {
      ...
      this.A();
      this.b($$0);
      $$0.a(glo::B, c, this.E(), this.F(), 320, 172);
      if (!Q.isEmpty()) {
         $$0.a(glo::B, Q.get(this.U), this.E() + 10, this.F() + 10, 0.0F, 0.0F, 195, 152, 195, 152);
      }
   }
