...
public class esd {
   ...
   private final esd.a g;

   @Deprecated
   public static esd a(azh $$0, esd.a $$1) {
      return new esd($$0, $$1, false);
   }

   public static esd a(azh $$0, int $$1, double... $$2) {
      return b($$0, new esd.a($$1, new DoubleArrayList($$2)));
   }

   public static esd b(azh $$0, esd.a $$1) {
      return new esd($$0, $$1, true);
   }

   private esd(azh $$0, esd.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<esd.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(esd.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(esd.a::b))
               .apply($$0, esd.a::new)
      );
      public static final Codec<jr<esd.a>> b = akr.a(mc.aS, a);
