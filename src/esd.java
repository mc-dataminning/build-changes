...
public class esd implements AutoCloseable {
   private final esd.a a;
   private int b;
   private int c;
   private int d;
   @Nullable
   ...
   private esf a(erv.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(erv.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, fvz $$2) {
      ...
      if ($$2.o != null && (this.i == esf.b.a || this.i == esf.b.b)) {
