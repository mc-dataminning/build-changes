...
public record bw(Optional<Boolean> d) implements bs {
   ...
   public static final MapCodec<bw> c = RecordCodecBuilder.mapCodec($$0 -> $$0.group(avu.a(Codec.BOOL, "in_open_water").forGetter(bw::b)).apply($$0, bw::new));
   ...
   public boolean a(bof $$0, apa $$1, @Nullable eov $$2) {
      if (this.d.isEmpty()) {
         ...
         return $$0 instanceof cio $$3 ? this.d.get() == $$3.q() : false;
      }
   }
