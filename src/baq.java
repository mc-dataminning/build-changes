...
public class baq extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("AbstractArrowPickupFix", $$0.getType(bhk.B), this::a);
   }

   private Typed<?> a(Typed<?> $$0) {
      $$0 = this.a($$0, "minecraft:arrow", baq::a);
      $$0 = this.a($$0, "minecraft:spectral_arrow", baq::a);
      return this.a($$0, "minecraft:trident", baq::a);
   }
   ...
   private Typed<?> a(Typed<?> $$0, String $$1, Function<Dynamic<?>, Dynamic<?>> $$2) {
      Type<?> $$3 = this.getInputSchema().getChoiceType(bhk.B, $$1);
      Type<?> $$4 = this.getOutputSchema().getChoiceType(bhk.B, $$1);
