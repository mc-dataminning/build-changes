...
public class baq extends bfq {
   ...
   public baq(Schema $$0) {
      super($$0, false, "BannerPatternFormatFix", bgs.s, "minecraft:banner");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      return $$0.update(DSL.remainderFinder(), baq::a);
   }

   private static Dynamic<?> a(Dynamic<?> $$0) {
      return $$0.renameAndFixField("Patterns", "patterns", $$0x -> $$0x.createList($$0x.asStream().map(baq::b)));
   }
