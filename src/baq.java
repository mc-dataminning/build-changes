...
public class baq extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgf.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bgf.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bgf.s);
