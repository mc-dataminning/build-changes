...
public class baq implements aym {
   ...
   public baq(int $$0, int $$1, @Nullable long[] $$2) {
      ...
      if ($$2 != null) {
         if ($$2.length != $$4) {
            throw new baq.a("Invalid length given for storage, got: " + $$2.length + " but expected: " + $$4);
         }
   ...
   @Override
   public aym d() {
      return new baq(this.c, this.e, (long[])this.b.clone());
   }
