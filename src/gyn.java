...
public class gyn implements gyq.a, AutoCloseable {
   ...
   fdk[] f;
   @Nullable
   private final gyn.a g;
   private final avg h;

   public gyn(all $$0, hah $$1, fdk $$2, avg $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      haf $$4 = $$3.a(haf.a).orElse(haf.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new fdk[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gyi.a(this.f, $$0);
   ...
   @Nullable
   private gyn.a a(hah $$0, int $$1, int $$2, haf $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gyn.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gyn.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gyn.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gyn.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gyn.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gyn.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, fdk[] $$4) {
   ...
   class a {
      ...
      a(final List<gyn.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gyn.this.c;
         int $$4 = this.b($$2) * gyn.this.d;
         gyn.this.a($$0, $$1, $$3, $$4, gyn.this.f);
      }

      public gyp a() {
         return gyn.this.new d(this, this.d ? gyn.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fdk[] b = new fdk[gyn.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gyn.this.c >> $$0;
            int $$2 = gyn.this.d >> $$0;
            this.b[$$0] = new fdk($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gyn.d $$2) {
         gyn.a $$3 = $$2.c;
         List<gyn.b> $$4 = $$3.b;
         gyn.b $$5 = $$4.get($$2.a);
            ...
            for (int $$9 = 0; $$9 < this.b.length; $$9++) {
               ...
               for (int $$12 = 0; $$12 < $$11; $$12++) {
                  for (int $$13 = 0; $$13 < $$10; $$13++) {
                     ...
                     this.b[$$9].a($$13, $$12, axy.a($$6, $$14, $$15));
                  }
               }
            }

            gyn.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gyn.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gyn.this.f[$$2].a($$3 + ($$0.a($$1) * gyn.this.c >> $$2), $$4 + ($$0.b($$1) * gyn.this.d >> $$2));
      }
   ...
   class d implements gyp {
      int a;
      int b;
      final gyn.a c;
      @Nullable
      private final gyn.c d;

      d(final gyn.a $$0, @Nullable final gyn.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
