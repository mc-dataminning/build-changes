...
public class bqm implements bqf {
   ...
   public static Set<bqd> a() {
      Builder<bqd> $$0 = ImmutableSet.builder();

      try {
         bqm.a $$1 = new bqm.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bqd.a("cpu#" + $$1x, bqc.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bqd.a("heap MiB", bqc.e, () -> (double)ad.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bqe.a.a());
      return $$0.build();
   }
   ...
   public static bqd a(final LongSupplier $$0) {
      ...
      bqd.d $$3 = new bqd.d(2.0F);
      return bqd.a("ticktime", bqc.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
