...
public class bqm {
   ...
   private static void a(bqu $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bqp $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<eaq, bqy<bqo>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bqy)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ae.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<eaq, bqy<bqo>> $$3 : $$0) {
         bqy<bqo> $$4 = (bqy<bqo>)$$3.getSecond();
         JsonObject $$5 = ae.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((eaq)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bqw> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bqb.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bqk $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bqm::a));
      $$1.add("chunksWritten", this.a($$0.m(), bqm::a));
      return $$1;
   }

   private JsonElement a(bqr.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bqk $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bqm::a));
      $$1.add("received", this.a($$0.k(), bqm::a));
      return $$1;
   }

   private <T> JsonElement a(bqt<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<bqq> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bqq>, ToDoubleFunction<bqq>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bqq::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bqq::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bqq::c));
      return $$1;
   }
}
