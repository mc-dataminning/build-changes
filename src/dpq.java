...
public class dpq {
   private static final djp a = cxa.hj.o();
   private static final djp b = cxa.hk.o();
   private static final djp c = cxa.iA.o();
   private static final djp d = cxa.hn.o();
   private static final djp e = cxa.hv.o();
   private static final djp f = cxa.hx.o();
   private static final djp g = cxa.hr.o();
   private static final djp h = cxa.iC.o();
   private static final djp i = cxa.dP.o();
   private final djp j;
   private final int k;
   private final djp[] l;
   private final eec m;
   ...
   public dpq(dpm $$0, djp $$1, int $$2, dpl $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dph.P);
      this.l = a($$3.a(new ahh("clay_bands")));
      this.u = $$0.a(dph.N);
      this.v = $$0.a(dph.O);
      this.n = $$0.a(dph.Q);
      this.o = $$0.a(dph.R);
   ...
   public void a(dpm $$0, cuy $$1, it<cuw> $$2, boolean $$3, dpv $$4, final dll $$5, dpc $$6, dpp.o $$7) {
      ...
      dpp.g $$13 = new dpp.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dpp.u $$14 = $$7.apply($$13);
      hx.a $$15 = new hx.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(doy.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            ih<cuw> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(cvd.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(doy.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   private boolean a(djp $$0) {
      return !$$0.i() && $$0.u().c();
   }

   @Deprecated
   public Optional<djp> a(dpp.o $$0, dqy $$1, Function<hx, ih<cuw>> $$2, dll $$3, dpc $$4, hx $$5, boolean $$6) {
      dpp.g $$7 = new dpp.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(ke.at), $$1);
      dpp.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      djp $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dli $$0, int $$1, int $$2, int $$3, ctz $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, cuw $$1, dli $$2, hx.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(cxa.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(auw $$0, djp[] $$1, int $$2, djp $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected djp a(int $$0, int $$1, int $$2) {
