...
public class gbj extends fsw {
   private static final ftd c = new ftd(ale.b("recipe_book/tab"), ale.b("recipe_book/tab_selected"));
   private final gbh.a d;
   ...
   public void a(fnq $$0, boolean $$1) {
      gbl.a $$2 = $$1 ? gbl.a.b : gbl.a.a;

      for (gbl $$4 : $$0.a(this.d.c())) {
         for (deq $$5 : $$4.a($$2)) {
            if ($$0.b($$5.a())) {
               this.f = 15.0F;
               return;
   ...
   public void b(frc $$0, int $$1, int $$2, float $$3) {
      if (this.a != null) {
         ...
         $$0.a(gpn::H, $$5, $$6, this.G(), this.g, this.h);
         this.a($$0);
         if (this.f > 0.0F) {
            $$0.c().b();
            this.f -= $$3;
