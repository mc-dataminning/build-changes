...
public class awh extends awg {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, awh.a> s;
   private final awc t;
   private long u;
   private final amc v;

   private awh(amc $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == awd.c($$2, 7, $$0.getLength());
      }
   }
