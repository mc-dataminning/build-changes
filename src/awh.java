...
public class awh<K> implements iq<K> {
   ...
   private awh(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> awh<A> c(int $$0) {
      return new awh((int)((float)$$0 / 0.8F));
   }
   ...
   private int e(@Nullable K $$0) {
      return (axk.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public awh<K> c() {
      return new awh<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
