...
public class awh extends atf {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), awh::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", awh::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", awh::k);
         $$0 = this.a($$0, "minecraft:fox", awh::j);
         $$0 = this.a($$0, "minecraft:item", awh::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", awh::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", awh::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", awh::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", awh::e);
         return this.a($$0, "minecraft:piglin", awh::d);
      });
   }
