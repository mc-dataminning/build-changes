...
public class awh extends baq {
   public awh(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bbq.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bbq.s, "minecraft:piston");
