...
public class fjl extends fji implements AutoCloseable {
   ...
   private void b(int $$0, int $$1, int $$2) {
      this.d.position(0);
      if (this.c == fjl.a.a || this.c == fjl.a.b) {
         this.d.put(0, $$0);
      }
   ...
   public static enum a implements bak {
      ...
      public static final bak.a<fjl.a> h = bak.a(fjl.a::values);
      final int i;
      final String j;
