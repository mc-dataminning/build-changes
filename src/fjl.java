...
public class fjl extends hhu {
   ...
   private static final fpr D = new fpr(alz.b("widget/cross_button"), alz.b("widget/cross_button_highlighted"));
   ...
   protected void aT_() {
      ...
      if (this.S) {
         this.T = this.c(fod.a(xv.c("mco.selectServer.trial"), fst.b(this, aza.q)).a(this.G() - 10 - 99, this.J() - 10 - 4 - 40, 99, 20).a());
      }

      this.c(fod.a(xv.c("mco.selectServer.buy"), fst.b(this, aza.r)).a(this.G() - 10 - 99, this.J() - 10 - 20, 99, 20).a());
      fop $$0 = this.c(new fop(this.E() + 4, this.F() + 4, 14, 14, D, $$0x -> this.aP_(), b));
      $$0.a(fpp.a(b));
      int $$1 = 142 - (this.S ? 40 : 20);
      fon $$2 = new fon(this.G() - 10 - 100, this.F() + 10, 100, $$1, a, this.p);
      if ($$2.j()) {
         $$2.i(100 - $$2.g());
      }
   ...
   public static void a(fnq $$0, fod $$1) {
      int $$2 = 8;
      $$0.c().a();
      $$0.c().a(0.0F, 0.0F, 110.0F);
      $$0.a(glt::B, C, $$1.D() + $$1.y() - 8 - 4, $$1.E() + $$1.w() / 2 - 4, 8, 8);
      $$0.c().b();
   }
   ...
   public void b(fnq $$0, int $$1, int $$2, float $$3) {
      ...
      this.A();
      this.b($$0);
      $$0.a(glt::B, c, this.E(), this.F(), 320, 172);
      if (!Q.isEmpty()) {
         $$0.a(glt::B, Q.get(this.U), this.E() + 10, this.F() + 10, 0.0F, 0.0F, 195, 152, 195, 152);
      }
   }
