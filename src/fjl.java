...
public class fjl extends fjh {
   ...
   private final List<fjl.a> d = new ArrayList<>();
   ...
   public <T extends fjo> T a(T $$0, int $$1, int $$2) {
      return this.a($$0, $$1, $$2, this.b());
   }

   public <T extends fjo> T a(T $$0, int $$1, int $$2, fjp $$3) {
      return this.a($$0, $$1, $$2, 1, 1, $$3);
   }

   public <T extends fjo> T a(T $$0, int $$1, int $$2, Consumer<fjp> $$3) {
      return this.a($$0, $$1, $$2, 1, 1, ac.a(this.b(), $$3));
   }

   public <T extends fjo> T a(T $$0, int $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, this.b());
   }

   public <T extends fjo> T a(T $$0, int $$1, int $$2, int $$3, int $$4, fjp $$5) {
      if ($$3 < 1) {
         throw new IllegalArgumentException("Occupied rows must be at least 1");
      } else if ($$4 < 1) {
         throw new IllegalArgumentException("Occupied columns must be at least 1");
      } else {
         this.d.add(new fjl.a($$0, $$1, $$2, $$3, $$4, $$5));
         this.c.add($$0);
         return $$0;
      }
   }

   public <T extends fjo> T a(T $$0, int $$1, int $$2, int $$3, int $$4, Consumer<fjp> $$5) {
   ...
   static class a extends fjh.a {
      ...
      a(fjo $$0, int $$1, int $$2, int $$3, int $$4, fjp $$5) {
         super($$0, $$5.h());
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
   ...
   public final class b {
      ...
      public <T extends fjo> T a(T $$0, int $$1) {
      ...
      public <T extends fjo> T a(T $$0, int $$1, fjp $$2) {
         int $$3 = this.c / this.b;
         int $$4 = this.c % this.b;
         if ($$4 + $$1 > this.b) {
            $$3++;
            $$4 = 0;
            this.c = ayd.d(this.c, this.b);
         }

         this.c += $$1;
         return fjl.this.a($$0, $$3, $$4, 1, $$1, $$2);
      }
