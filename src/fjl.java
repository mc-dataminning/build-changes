...
public class fjl implements fss {
   ...
   private float c() {
      ...
      return aye.a((float)$$0 / 2000.0F, 0.0F, 1.0F);
   }
   ...
   protected void a(fgz $$0, float $$1, int $$2, int $$3, fst $$4) {
   ...
   private void a(fgz $$0, int $$1, int $$2, float $$3, float $$4, fsr $$5) {
      if ($$5 != fsp.a) {
         int $$6 = (int)($$4 * 255.0F);
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == fsp.a || !this.g.a($$1).aR_())) {
         $$1 += $$0;
      }
