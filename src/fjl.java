...
public class fjl {
   ...
   private fjl(int $$0, List<fjn> $$1) {
      this.a = $$1.toArray(fjn[]::new);
      this.b = $$1.size();
   }

   private List<fjn> c() {
      List<fjn> $$0 = new ArrayList<>(this.d());
