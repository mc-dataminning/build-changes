...
public abstract class fkr<T extends fkr<T>> {
   ...
   public fkr(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fkp.a();
         if ($$3 != null) {
         ...
         throw new fmj(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fmj(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fmj(var2.getMessage(), var2);
      }
   }
   ...
   public static fkr<?> a(String $$0) {
      return new fkr.b($$0, 5000, 60000);
   }

   public static fkr<?> a(String $$0, int $$1, int $$2) {
      return new fkr.b($$0, $$1, $$2);
   }

   public static fkr<?> b(String $$0, String $$1) {
      return new fkr.c($$0, $$1, 5000, 60000);
   }

   public static fkr<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fkr.c($$0, $$1, $$2, $$3);
   }

   public static fkr<?> b(String $$0) {
      return new fkr.a($$0, 5000, 60000);
   }

   public static fkr<?> c(String $$0, String $$1) {
      return new fkr.d($$0, $$1, 5000, 60000);
   }

   public static fkr<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fkr.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fkr<fkr.a> {
   ...
   public static class b extends fkr<fkr.b> {
   ...
   public static class c extends fkr<fkr.c> {
      ...
      public fkr.c f() {
         try {
            ...
            throw new fmj(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fkr<fkr.d> {
      private final String c;
