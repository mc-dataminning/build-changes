...
public class fkr {
   ...
   public void a(dfn $$0, buk $$1, boolean $$2, boolean $$3, float $$4) {
      this.f = true;
      this.g = $$0;
      this.h = $$1;
      this.q = $$2;
      this.t = $$4;
      if ($$1.bZ() && $$1.dl() instanceof crd $$5 && $$5.l() instanceof crl $$6 && $$6.t()) {
         fba $$7 = $$5.m($$1).d($$5.du()).d($$1.l($$5)).e(new fba(0.0, (double)ayz.h($$4, this.s, this.r), 0.0));
         this.a($$1.i($$4), $$1.h($$4));
         this.a($$6.e($$4).e($$7));
      } else {
         this.a($$1.i($$4), $$1.h($$4));
         this.a(
            ayz.d((double)$$4, $$1.K, $$1.dB()), ayz.d((double)$$4, $$1.L, $$1.dD()) + (double)ayz.h($$4, this.s, this.r), ayz.d((double)$$4, $$1.M, $$1.dH())
         );
      }
      ...
      if ($$2) {
         ...
         float $$9 = $$1 instanceof bvg $$8 ? $$8.ek() : 1.0F;
