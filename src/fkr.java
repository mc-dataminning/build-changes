public class fkr extends fmb {
   static final aru a = aru.a();
   private final flw b;

   fkr(fii $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, flw $$7) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
      this.B = 0.96F;
      this.C = true;
      this.b = $$7;
   ...
   public static class a implements fle<iy> {
      ...
      public flb a(iy $$0, fii $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fkr $$8 = new fkr($$1, $$2, $$3, $$4, 0.0, 0.0, 0.0, this.b);
         $$8.a(1.0F, 0.9F, 1.0F);
   ...
   public static class b implements fle<iy> {
      ...
      public flb a(iy $$0, fii $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fkr $$8 = new fkr($$1, $$2, $$3, $$4, 0.5 - fkr.a.j(), $$6, 0.5 - fkr.a.j(), this.a);
         if ($$1.z.h()) {
            $$8.a(0.6F, 1.0F, 0.8F);
         } else {
            $$8.a(0.08F, 0.4F, 0.4F);
