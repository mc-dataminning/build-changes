...
public record tk<EnvironmentType>(EnvironmentType b, alg c, int d, int e, boolean f, dtl g, boolean h, int i, int j, boolean k) {
   public static final MapCodec<tk<jf<tl>>> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               dtl.f.optionalFieldOf("rotation", dtl.a).forGetter(tk::f),
