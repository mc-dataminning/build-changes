...
public class tk extends MinecraftServer {
   private static final Logger l = LogUtils.getLogger();
   private static final int m = 20;
   private static final int n = 14999992;
   private static final amd o = new amd(null, ServicesKeySet.EMPTY, null, null);
   private static final crf p = crh.f.a().d(crf.a(crh.d));
   private final bmx q = new bmx(4);
   private List<sz> r = new ArrayList<>();
   private final List<tz> s;
   private final jh t;
   private final Stopwatch u = Stopwatch.createUnstarted();
   private static final dex v = ae.a(new dex(p), $$0 -> {
      $$0.a(dex.e).a(false, null);
      $$0.a(dex.v).a(false, null);
      $$0.a(dex.o).a(0, null);
      $$0.a(dex.b).a(false, null);
   });
   private static final ecd w = new ecd(0L, false, false);
   @Nullable
   private tq x;

   public static tk a(Thread $$0, etq.c $$1, aul $$2, Collection<tz> $$3, jh $$4) {
      if ($$3.isEmpty()) {
         throw new IllegalArgumentException("No test functions were given!");
      } else {
         $$2.a();
         dfx $$5 = new dfx(new deo(new ArrayList<>($$2.c()), List.of()), p);
         dff $$6 = new dff("Test Level", dey.b, false, bsa.c, true, v, $$5);
         amg.d $$7 = new amg.d($$2, $$5, false, true);
         amg.c $$8 = new amg.c($$7, ex.a.b, 4);

         try {
            l.debug("Starting resource loading");
            Stopwatch $$9 = Stopwatch.createStarted();
            amh $$10 = ae.<amh>c($$2x -> amg.a($$8, $$1xx -> {
                  kd<dzg> $$2xx = new jy<>(lz.bc, Lifecycle.stable()).n();
                  eca.b $$3x = $$1xx.c().d(lz.aZ).b(eln.b).a().a().a($$2xx);
                  return new amg.b<>(new etu($$6, w, $$3x.d(), $$3x.a()), $$3x.b());
               }, amh::new, ae.g(), $$2x)).get();
            $$9.stop();
            l.debug("Finished resource loading after {} ms", $$9.elapsed(TimeUnit.MILLISECONDS));
            return new tk($$0, $$1, $$2, $$10, $$3, $$4);
   ...
   private tk(Thread $$0, etq.c $$1, aul $$2, amh $$3, Collection<tz> $$4, jh $$5) {
      super($$0, $$1, $$2, $$3, Proxy.NO_PROXY, bau.a(), o, arz::b);
   ...
   public boolean e() {
      ...
      this.t_();
      arn $$0 = this.J();
      this.r = Lists.newArrayList(ta.a(this.s, $$0));
      $$0.a(this.t, 0.0F);
      int $$1 = 20000000;
   ...
   private void b(arn $$0) {
      ...
      ti $$2 = ti.a.a(this.r, $$0).a((ti.c)(new tu($$1, 8, false))).a();
      Collection<tf> $$3 = $$2.a();
      this.x = new tq($$3);
