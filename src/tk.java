...
public record tk<EnvironmentType>(EnvironmentType b, alg c, int d, int e, boolean f, dtg g, boolean h, int i, int j, boolean k) {
   public static final MapCodec<tk<jf<tl>>> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               dtg.f.optionalFieldOf("rotation", dtg.a).forGetter(tk::f),
