...
public class eoi extends eol {
   ...
   static final eoi.b l = new eoi.b(854, 480);

   public eoi(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eoi.a[] e = values();
   ...
   static class b {
      ...
      static List<eoi.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eoi.b($$0, $$1), eoi.l) : ImmutableList.of(eoi.l);
      }
