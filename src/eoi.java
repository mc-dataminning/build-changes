...
public class eoi {
   ...
   public static eof a(eof $$0) {
      return $$0;
   }

   public static eof a(eof $$0, eof $$1) {
   ...
   static class a implements eof {
      private final eof a;
      private final eof b;

      public a(eof $$0, eof $$1) {
         if ($$0 == $$1) {
