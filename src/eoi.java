...
public class eoi {
   ...
   protected eoi(ayt $$0, Pair<Integer, DoubleList> $$1, boolean $$2) {
   ...
   public static double b(double $$0) {
      return $$0 - (double)aym.b($$0 / 3.3554432E7 + 0.5) * 3.3554432E7;
   }
