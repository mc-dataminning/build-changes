...
public class eoi extends eot {
   ...
   public eoj a() {
      ...
      if (this.f() && this.b.be()) {
         ...
         for (dse $$2 = this.a.a($$1); $$2.a(dfd.G); $$2 = this.a.a($$1)) {
            $$1.b(this.b.du(), (double)(++$$0), this.b.dA());
         }
      } else {
         $$0 = ayz.a(this.b.dw() + 0.5);
      }
   ...
   private boolean b(@Nullable eoj $$0) {
      return $$0 != null && $$0.k >= 0.0F;
   }

   private boolean c(@Nullable eoj $$0) {
      return $$0 != null && !$$0.i;
   }
   ...
   protected eoo b(int $$0, int $$1, int $$2) {
      return (eoo)this.l.computeIfAbsent(iz.a($$0, $$1, $$2), $$3 -> this.a(this.a, $$0, $$1, $$2, this.b));
   }

   @Override
   public eoo a(eoq $$0, int $$1, int $$2, int $$3) {
      eoo $$4 = $$0.a($$1, $$2, $$3);
      if ($$4 == eoo.b && $$2 >= $$0.a().I_() + 1) {
         iz $$5 = new iz($$1, $$2 - 1, $$3);
         eoo $$6 = $$0.a($$5.u(), $$5.v(), $$5.w());
         if ($$6 == eoo.o || $$6 == eoo.i) {
            $$4 = eoo.o;
         } else if ($$6 == eoo.q) {
            $$4 = eoo.q;
            ...
            $$4 = $$6 != eoo.c && $$6 != eoo.b && $$6 != eoo.j ? eoo.c : eoo.b;
         }
      }
   ...
   private Iterable<iz> a(btt $$0) {
      ...
      if (!$$2) {
         ...
         evo $$6 = $$1.c($$4, $$5, $$3);
         return iz.a($$0.el(), 10, ayz.a($$6.a), ayz.a($$6.b), ayz.a($$6.c), ayz.a($$6.d), ayz.a($$6.e), ayz.a($$6.f));
      }
   }
}
