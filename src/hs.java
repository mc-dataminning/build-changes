...
public interface hs extends hg.b {
   ...
   <E> Optional<hr<E>> c(aeq<? extends hr<? extends E>> var1);

   @Override
   default <T> Optional<hg.c<T>> a(aeq<? extends hr<? extends T>> $$0) {
      return this.c($$0).map(hr::p);
   }

   default <E> hr<E> d(aeq<? extends hr<? extends E>> $$0) {
   ...
   static hs.b a(final hr<? extends hr<?>> $$0) {
      return new hs.b() {
         @Override
         public <T> Optional<hr<T>> c(aeq<? extends hr<? extends T>> $$0x) {
            hr<hr<T>> $$1 = (hr<hr<T>>)$$0;
            return $$1.d((aeq<hr<T>>)$$0);
         }
   ...
   public static class c implements hs {
      ...
      public c(Map<? extends aeq<? extends hr<?>>, ? extends hr<?>> $$0) {
         this.c = Map.copyOf($$0);
      }
      ...
      @Override
      public <E> Optional<hr<E>> c(aeq<? extends hr<? extends E>> $$0) {
   ...
   public static record d<T>(aeq<? extends hr<T>> a, hr<T> b) {

      private static <T, R extends hr<? extends T>> hs.d<T> a(Entry<? extends aeq<? extends hr<?>>, R> $$0) {
         return a((aeq<? extends hr<?>>)$$0.getKey(), $$0.getValue());
      }

      private static <T> hs.d<T> a(aeq<? extends hr<?>> $$0, hr<?> $$1) {
         return new hs.d<>((aeq<? extends hr<T>>)$$0, (hr<T>)$$1);
      }
