...
public class erx implements AutoCloseable {
   private static final aer a = new aer("textures/map/map_icons.png");
   static final foc b = foc.s(a);
   private static final int c = 128;
   private static final int d = 128;
   final fyv e;
   private final Int2ObjectMap<erx.a> f = new Int2ObjectOpenHashMap();

   public erx(fyv $$0) {
      this.e = $$0;
   }

   public void a(int $$0, ebm $$1) {
      this.b($$0, $$1).a();
   }

   public void a(elf $$0, fnu $$1, int $$2, ebm $$3, boolean $$4, int $$5) {
      this.b($$2, $$3).a($$0, $$1, $$4, $$5);
   }

   private erx.a b(int $$0, ebm $$1) {
      return (erx.a)this.f.compute($$0, ($$1x, $$2) -> {
         if ($$2 == null) {
            return new erx.a($$1x, $$1);
         } else {
            $$2.a($$1);
            return $$2;
         }
   ...
   class a implements AutoCloseable {
      ...
      a(int $$0, ebm $$1) {
         this.b = $$1;
         this.c = new fyh(128, 128, true);
         aer $$2 = erx.this.e.a("map/" + $$0, this.c);
         this.d = foc.s($$2);
      }
      ...
      private void b() {
         for (int $$0 = 0; $$0 < 128; $$0++) {
            for (int $$1 = 0; $$1 < 128; $$1++) {
               int $$2 = $$1 + $$0 * 128;
               this.c.e().a($$1, $$0, eag.b(this.b.g[$$2]));
            }
         }
      ...
      void a(elf $$0, fnu $$1, boolean $$2, int $$3) {
         if (this.e) {
            this.b();
            this.e = false;
         }
         ...
         for (ebj $$10 : this.b.g()) {
            if (!$$2 || $$10.b()) {
               ...
               if ($$10.g() != null) {
                  ...
                  float $$22 = arp.a(25.0F / $$21, 0.0F, 6.0F / 9.0F);
                  $$0.a();
                  $$0.a(0.0F + (float)$$10.d() / 2.0F + 64.0F - $$21 * $$22 / 2.0F, 0.0F + (float)$$10.e() / 2.0F + 64.0F + 4.0F, -0.025F);
                  $$0.b($$22, $$22, 1.0F);
                  $$0.a(0.0F, 0.0F, -0.1F);
                  $$19.a($$20, 0.0F, 0.0F, -1, false, $$0.c().a(), $$1, ert.a.a, Integer.MIN_VALUE, $$3);
                  $$0.b();
               }
