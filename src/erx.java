...
public class erx implements ecj.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<erx> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ayr<erx> a = ayr.a(f);
   private final esb g;
   private final esb h;
   private final esb i;
   ...
   public static erx a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new erx(new edr(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private erx(esb $$0, esb $$1, esb $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public erx(azg $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         esb.a($$0, IntStream.rangeClosed(-15, 0)),
         esb.a($$0, IntStream.rangeClosed(-15, 0)),
         esb.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public erx a(azg $$0) {
      return new erx($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(ecj.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         ery $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(esb.b($$4 * $$13), esb.b($$5 * $$13), esb.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = esb.b($$1 * $$13);
         double $$21 = esb.b($$2 * $$13);
         double $$22 = esb.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            ery $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return ayy.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
