...
public class ra extends qv<rb> {
   ...
   public static final rs<ra> a = new rs.b<ra>() {
      public ra a(DataInput $$0, rf $$1) throws IOException {
         return new ra(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof ra && Arrays.equals(this.c, ((ra)$$0).c);
   }
   ...
   public rb a(int $$0) {
      return rb.a(this.c[$$0]);
   }

   public rb a(int $$0, rb $$1) {
      int $$2 = this.c[$$0];
      this.c[$$0] = $$1.g();
      return rb.a($$2);
   }

   public void b(int $$0, rb $$1) {
