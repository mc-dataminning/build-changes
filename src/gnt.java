...
public class gnt extends goi {
   private static final float a = 1.0472F;
   private int b;

   gnt(gjz $$0, double $$1, double $$2, double $$3, int $$4) {
   ...
   public static class a implements gnl<ma> {
      private final god a;
      ...
      public gni a(ma $$0, gjz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gnt $$8 = new gnt($$1, $$2, $$3, $$4, $$0.b());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
