...
public class aia {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(ti.c("commands.save.failed"));
   ...
   private static int a(dt $$0, boolean $$1) throws CommandSyntaxException {
      $$0.a(() -> ti.c("commands.save.saving"), false);
      MinecraftServer $$2 = $$0.l();
      boolean $$3 = $$2.b(true, $$1, true);
      if (!$$3) {
         throw a.create();
      } else {
         $$0.a(() -> ti.c("commands.save.success"), true);
         return 1;
      }
   }
}
