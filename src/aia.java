...
public class aia {
   ...
   private static int a(dt $$0, Collection<aku> $$1, Collection<cmq<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
   ...
   private static int b(dt $$0, Collection<aku> $$1, Collection<cmq<?>> $$2) throws CommandSyntaxException {
      int $$3 = 0;
