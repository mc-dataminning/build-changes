...
public final class tu {
   ...
   private static final Map<n, tu> c = Stream.of(n.values())
      .filter(n::e)
      .collect(ImmutableMap.toImmutableMap(Function.identity(), $$0 -> new tu($$0.f(), $$0.g())));
   private static final Map<String, tu> d = c.values().stream().collect(ImmutableMap.toImmutableMap($$0 -> $$0.f, Function.identity()));
   private final int e;
   @Nullable
