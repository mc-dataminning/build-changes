...
public class fir {
   ...
   private static final Queue<fir.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile fir.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(fir::a), fio::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(fir::a), fio::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + fir.a(this.b) + ", type=" + fir.b(this.c) + ", severity=" + fir.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
