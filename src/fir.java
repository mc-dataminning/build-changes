...
public class fir extends hkx {
   ...
   class b extends foy.a<fir.b> {
      ...
      public b(final fha $$0) {
         ...
         this.a($$0);
         if (!$$0.e.isEmpty()) {
            this.e = fos.a(fir.C, $$0x -> fir.this.m.a(new fiq(fir.this, this.c)))
         ...
         if (!fir.this.N.j) {
            this.d = fos.a(fir.c, $$0x -> this.g()).a(8 + fir.this.p.a(fir.C)).a($$0x -> wn.a(wo.a("mco.backup.narration", this.c()), (wo)$$0x.get())).a();
            this.f.add(this.d);
         }
      }
      ...
      public void a(fod $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         $$0.b(fir.this.p, wo.a("mco.backup.entry", fjz.a(this.c.b)), $$3, $$11, $$13);
