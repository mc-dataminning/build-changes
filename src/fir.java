public class fir extends fie<cmf> implements fkz {
   private static final ajh x = new ajh("textures/gui/container/crafting_table.png");
   private final fkt y = new fkt();
   private boolean z;

   public fir(cmf $$0, cir $$1, vu $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aO_() {
      ...
      this.c(new fbs(this.t + 5, this.h / 2 - 49, 20, 18, fkt.a, $$0 -> {
         this.y.e();
         this.t = this.y.a(this.g, this.c);
