...
public class bcj extends bhv {
   public bcj(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bjb.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bjb.s, "minecraft:jukebox");
