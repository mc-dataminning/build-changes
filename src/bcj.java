...
public class bcj extends DataFix {
   ...
   public bcj(Schema $$0, String $$1, Map<String, String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   private TypeRewriteRule a() {
      ...
      if ($$4 == null) {
         ...
         OpticFinder<String> $$6 = DSL.fieldFinder("id", bde.a());
   ...
   private TypeRewriteRule b() {
      Type<?> $$0 = this.getOutputSchema().getType(bbw.g);
      Type<?> $$1 = this.getInputSchema().getType(bbw.g);
      OpticFinder<?> $$2 = $$1.findField("stats");
      OpticFinder<?> $$3 = $$2.type().findField("minecraft:custom");
      OpticFinder<String> $$4 = bde.a().finder();
      return this.fixTypeEverywhereTyped(
         this.a,
         $$1,
         $$0,
