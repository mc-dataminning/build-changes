...
public abstract class dhg {
   public static final Codec<dhg> a = jb.ad.q().dispatchStable(dhg::a, Function.identity());
   protected final cqx b;
   private final Supplier<List<crd.b>> c;
   private final Function<he<cqt>, cqu> d;

   public dhg(cqx $$0) {
      this($$0, $$0x -> ((cqt)$$0x.a()).d());
   }

   public dhg(cqx $$0, Function<he<cqt>, cqu> $$1) {
      this.b = $$0;
      this.d = $$1;
   ...
   public Optional<aev<Codec<? extends dhg>>> b() {
   ...
   public abstract void a(akx var1, long var2, dlg var4, cqv var5, cqn var6, dhf var7, dko.a var8);

   @Nullable
   public Pair<gw, he<dvi>> a(akq $$0, hi<dvi> $$1, gw $$2, int $$3, boolean $$4) {
      dhh $$5 = $$0.k().h();
      Map<dwf, Set<he<dvi>>> $$6 = new Object2ObjectArrayMap();
      ...
      if ($$6.isEmpty()) {
         ...
         Pair<gw, he<dvi>> $$9 = null;
         double $$10 = Double.MAX_VALUE;
         cqn $$11 = $$0.a();
         List<Entry<dwf, Set<he<dvi>>>> $$12 = new ArrayList<>($$6.size());

         for (Entry<dwf, Set<he<dvi>>> $$13 : $$6.entrySet()) {
            dwf $$14 = $$13.getKey();
            if ($$14 instanceof dwc) {
               dwc $$15 = (dwc)$$14;
               Pair<gw, he<dvi>> $$16 = this.a($$13.getValue(), $$0, $$11, $$2, $$4, $$15);
               if ($$16 != null) {
         ...
         if (!$$12.isEmpty()) {
            ...
            for (int $$21 = 0; $$21 <= $$3; $$21++) {
               ...
               for (Entry<dwf, Set<he<dvi>>> $$23 : $$12) {
                  dwd $$24 = (dwd)$$23.getKey();
                  Pair<gw, he<dvi>> $$25 = a($$23.getValue(), $$0, $$11, $$19, $$20, $$21, $$4, $$5.d(), $$24);
                  if ($$25 != null) {
                     $$22 = true;
   ...
   @Nullable
   private Pair<gw, he<dvi>> a(Set<he<dvi>> $$0, akq $$1, cqn $$2, gw $$3, boolean $$4, dwc $$5) {
      List<cpc> $$6 = $$1.k().h().a($$5);
      if ($$6 == null) {
         throw new IllegalStateException("Somehow tried to find structures for a placement that doesn't exist");
      } else {
         Pair<gw, he<dvi>> $$7 = null;
         ...
         for (cpc $$10 : $$6) {
            ...
            if ($$12) {
               Pair<gw, he<dvi>> $$13 = a($$0, $$1, $$2, $$4, $$5, $$10);
               if ($$13 != null) {
                  $$7 = $$13;
                  $$8 = $$11;
               }
   ...
   @Nullable
   private static Pair<gw, he<dvi>> a(Set<he<dvi>> $$0, cpy $$1, cqn $$2, int $$3, int $$4, int $$5, boolean $$6, long $$7, dwd $$8) {
      int $$9 = $$8.a();
      ...
      for (int $$10 = -$$5; $$10 <= $$5; $$10++) {
         ...
         for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
            ...
            if ($$11 || $$13) {
               ...
               int $$15 = $$4 + $$9 * $$12;
               cpc $$16 = $$8.a($$7, $$14, $$15);
               Pair<gw, he<dvi>> $$17 = a($$0, $$1, $$2, $$6, $$8, $$16);
               if ($$17 != null) {
                  return $$17;
               }
            }
   ...
   @Nullable
   private static Pair<gw, he<dvi>> a(Set<he<dvi>> $$0, cpy $$1, cqn $$2, boolean $$3, dwf $$4, cpc $$5) {
      for (he<dvi> $$6 : $$0) {
         dvk $$7 = $$2.a($$5, $$6.a(), $$3);
         if ($$7 != dvk.b) {
            if (!$$3 && $$7 == dvk.a) {
   ...
   public void a(cqp $$0, dhf $$1, cqn $$2) {
      ...
      if (!aa.a($$3)) {
         ...
         Set<he<cqt>> $$11 = new ObjectArraySet();
         ...
         try {
            ...
            for (int $$15 = 0; $$15 < $$14; $$15++) {
               ...
               if ($$15 < $$12) {
                  ...
                  for (he<cqt> $$23 : $$11) {
                     List<hi<dum>> $$24 = this.d.apply($$23).b();
                     if ($$15 < $$24.size()) {
                        hi<dum> $$25 = $$24.get($$15);
                        crd.b $$26 = $$8.get($$15);
   ...
   public abstract void a(akx var1, cqn var2, dlg var3, dhf var4);

   public abstract void a(akx var1);
   ...
   public bfm<crf.c> a(he<cqt> $$0, cqn $$1, bjj $$2, gw $$3) {
   ...
   public void a(hr $$0, dhh $$1, cqn $$2, dhf $$3, dzc $$4) {
      cpc $$5 = $$3.f();
      hw $$6 = hw.a($$3);
      dlg $$7 = $$1.c();
      $$1.a().forEach($$8 -> {
   ...
   private boolean a(dvo.a $$0, cqn $$1, hr $$2, dlg $$3, dzc $$4, long $$5, dhf $$6, cpc $$7, hw $$8) {
      dvi $$9 = $$0.a().a();
      int $$10 = a($$1, $$6, $$8, $$9);
      hi<cqt> $$11 = $$9.a();
      Predicate<he<cqt>> $$12 = $$11::a;
   ...
   private static int a(cqn $$0, dhf $$1, hw $$2, dvi $$3) {
      dvq $$4 = $$0.a($$2, $$3, $$1);
      return $$4 != null ? $$4.f() : 0;
   }
         ...
         for (int $$11 = $$6 - 8; $$11 <= $$6 + 8; $$11++) {
            ...
            for (dvq $$13 : $$0.a($$10, $$11).g().values()) {
               try {
                  ...
                  p $$16 = $$15.a("Structure");
                  Optional<? extends hq<dvi>> $$17 = $$0.G_().c(jc.az);
