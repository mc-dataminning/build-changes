...
public class gmf {
   ...
   public static class a extends Thread {
      private final gmf.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(gmf.b $$0) throws IOException {
         super("LanServerDetector #" + gmf.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(gmf.b));
   ...
   public static class b {
      private final List<gme> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gme> a() {
         if (this.b) {
            List<gme> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
