...
public abstract class aqr {
   ...
   protected aqr(Executor $$0, Executor $$1) {
      brg<Runnable> $$2 = brg.a("player ticket throttler", $$1);
         ...
         if (!this.l.isEmpty()) {
            ...
            while ($$5.hasNext()) {
               ...
               if (this.g($$6).stream().anyMatch($$0x -> $$0x.a() == arj.c)) {
                  ...
                  CompletableFuture<aqj<dzd>> $$8 = $$7.b();
   ...
   public <T> void c(arj<T> $$0, dfp $$1, int $$2, T $$3) {
   ...
   public <T> void d(arj<T> $$0, dfp $$1, int $$2, T $$3) {
      ari<T> $$4 = new ari<>($$0, aqh.a(aqs.b) - $$2, $$3);
      long $$5 = $$1.a();
      this.b($$5, $$4);
      this.h.b($$5, $$4);
   ...
   protected void a(dfp $$0, boolean $$1) {
      ari<dfp> $$2 = new ari<>(arj.d, aqi.c, $$0);
      long $$3 = $$0.a();
      if ($$1) {
         this.a($$3, $$2);
         this.h.a($$3, $$2);
   ...
   class c extends aqr.b {
      ...
      private void a(long $$0, int $$1, boolean $$2, boolean $$3) {
         if ($$2 != $$3) {
            ari<?> $$4 = new ari<>(arj.c, aqr.b, new dfp($$0));
            if ($$3) {
      ...
      public void a() {
         ...
         if (!this.i.isEmpty()) {
            ...
            while ($$0.hasNext()) {
               ...
               int $$3 = this.c($$1);
               if ($$2 != $$3) {
                  aqr.this.k.onLevelChange(new dfp($$1), () -> this.h.get($$1), $$3, $$1x -> {
