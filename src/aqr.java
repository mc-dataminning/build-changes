...
public class aqr<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aqr.this.get(this.b--);
      }

      @Override
      public void remove() {
         aqr.this.remove(this.b + 1);
      }
   }
}
