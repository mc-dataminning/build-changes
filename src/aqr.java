...
public abstract class aqr<T> extends ara<T> {
   ...
   public aqr(@Nullable T $$0, @Nullable Date $$1, @Nullable String $$2, @Nullable Date $$3, @Nullable String $$4) {
      super($$0);
   ...
   protected aqr(@Nullable T $$0, JsonObject $$1) {
      super($$0);
