...
public class aqr<K> implements hl<K> {
   ...
   private aqr(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> aqr<A> c(int $$0) {
      return new aqr((int)((float)$$0 / 0.8F));
   }
   ...
   private int d(@Nullable K $$0) {
      return (ars.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public aqr<K> c() {
      return new aqr<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
