...
public class aqr implements Runnable {
      ...
      while (this.d.x()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)baw.a),
               String.format(Locale.ROOT, "%.2f", this.d.aP().g() / (float)baw.c)
            );
            ...
            $$4.a("Random tick rate", () -> this.d.aZ().o().a(dgv.o).toString());
