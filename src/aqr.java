...
public class aqr {
   ...
   private static final ecp f = ecl.a.a(ecm.n);
   ...
   public static ecm a(int $$0, @Nullable ecm $$1) {
      if ($$0 > a) {
         return $$1;
      } else {
         return $$0 <= 0 ? ecm.n : f.c().a($$0);
      }
   }

   public static ecm b(int $$0) {
      return a($$0, ecm.c);
   }

   public static int a(ecm $$0) {
      return 33 + f.a($$0);
   }
