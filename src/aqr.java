...
public class aqr {
   ...
   final List<ve> g = Collections.synchronizedList(Lists.newArrayList());

   public aqr(MinecraftServer $$0) {
      this.e = $$0;
      this.c = true;
   }
      ...
      synchronized (this.f) {
         ...
         this.f.add(((ServerBootstrap)((ServerBootstrap)new ServerBootstrap().channel($$2)).childHandler(new ChannelInitializer<Channel>() {
            protected void initChannel(Channel $$0) {
               ...
               if (aqr.this.e.an()) {
                  $$1.addLast("legacy_query", new aqm(aqr.this.d()));
               }

               ve.a($$1, yo.a, null);
               int $$2 = aqr.this.e.o();
               ve $$3 = (ve)($$2 > 0 ? new vq($$2) : new ve(yo.a));
               aqr.this.g.add($$3);
               $$3.a($$1);
               $$3.a(new aqt(aqr.this.e, $$3));
            }
            ...
            if (!$$1.j()) {
               if ($$1.i()) {
                  try {
                     ...
                     wg $$3 = wg.b("Internal server error");
                     $$1.a(new yv($$3), vn.a(() -> $$1.a($$3)));
                     $$1.m();
                  }
               } else {
                  $$0.remove();
   ...
   static class a extends ChannelInboundHandlerAdapter {
      ...
      private final int b;
      private final int c;
      private final List<aqr.a.a> d = Lists.newArrayList();
