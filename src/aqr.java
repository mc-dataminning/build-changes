...
public class aqr {
   ...
   aqr(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static aqr.a a() {
      return new aqr.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(aqr::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public aqr.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public aqr a(Writer $$0) throws IOException {
         return new aqr($$0, this.a);
      }
   }
}
