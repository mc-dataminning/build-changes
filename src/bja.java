...
public class bja extends bje {
   ...
   public static bja a(float $$0, float $$1, float $$2, float $$3) {
      return new bja($$0, $$1, $$2, $$3);
   }

   private bja(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(auv $$0, float $$1, float $$2, float $$3, float $$4) {
      return auo.a(auo.c($$0, $$1, $$2), $$3, $$4);
   }
