...
public class fhf {
   public static List<fiq> a(fhf.a... $$0) {
      for (fhf.a $$1 : $$0) {
         a($$1.j);
      }

      List<fiq> $$2 = Lists.newArrayList();

      for (fhf.a $$3 : $$0) {
         $$2.add(new fiq($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fiq::a));
      return $$2;
   }
   ...
   public static List<fiq> a() {
      return a(fhf.a.values());
   }
