...
public class fhf {
   ...
   private final List<fez> k = Lists.newArrayList();
   private final List<fez.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fhf.a> o = new ArrayList<>();
   ...
   public void a(fgr $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
   ...
   private void a(fgr $$0, int $$1, int $$2, ffa.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fez.a $$0) {
   ...
   public void a(xp $$0) {
      this.a($$0, null, this.i.W() ? ffa.b() : ffa.a());
   }

   public void a(xp $$0, @Nullable yb $$1, @Nullable ffa $$2) {
      fez $$3 = new fez(this.i.l.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }
   ...
   private void b(fez $$0) {
      ...
      List<ayl> $$3 = fhj.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new fez.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fhf.a b(yb $$0) {
      int $$1 = this.i.l.e();
      ListIterator<fez> $$2 = this.k.listIterator();
   ...
   private fez d(fez $$0) {
      return new fez($$0.b(), h, null, ffa.a());
   }
   ...
   private void n() {
      ...
      for (fez $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public ffa c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fez.a $$1, ffa $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         ffa.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.y instanceof flt;
   }
   ...
   public fhf.b k() {
      return new fhf.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fhf.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<fez> $$0, List<String> $$1, List<fhf.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
