...
public class fhf {
   ...
   public void a(fiy $$0, String $$1, fjv.a $$2, ewd $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fhf.b $$13 = new fhf.b($$1.trim(), this.f, $$3, $$2);
                  fhf.a $$14 = new fhf.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fhf.c $$30 = new fhf.c(this.f, $$2, $$0);
                        fhf.a $$31 = new fhf.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fjc(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ewd $$2) throws IOException {
      ...
      File $$15 = new File(fmg.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ewd d;
      private final fjv.a e;

      b(final String $$0, final File $$1, final ewd $$2, final fjv.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fhf.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fhf.this.b && !fhf.this.d) {
            try {
               fhf.this.e = true;
               fhf.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fhf.a.error("Error extracting archive", var3);
               fhf.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fjv.a c;
      private final fiy d;

      c(final File $$0, final fjv.a $$1, final fiy $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fhf.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fhf.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fhf.this.g);
                  fhf.this.c = true;
               } else {
                  fhf.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fhf.this.d = true;
               }
            } catch (IOException var3) {
               fhf.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fhf.this.d = true;
            }
         }
      }
