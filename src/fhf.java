...
public class fhf {
   public static void a(fvt<?> $$0, fhd $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<fhc>> $$6 : $$1.c().entrySet()) {
         Optional<fyk> $$7 = $$0.a($$6.getKey());
         List<fhc> $$8 = $$6.getValue();
   ...
   private static float a(fhd $$0, long $$1) {
