public class fhf extends ffe {
   ...
   private void I() {
      this.f.J().b(new afm(this.q.aE_(), this.y, this.z));
   }
   ...
   @Override
   protected void aQ_() {
      this.u = new ezq(this.i, this.g / 2 - 153, 20, 300, 20, b);
      this.u.f(128);
      this.u.a(this.q.f().a().toString());
      this.u.b($$0x -> this.J());
      this.e(this.u);
      this.r = new ezq(this.i, this.g / 2 - 153, 55, 300, 20, c);
      this.r.f(128);
      this.r.a(this.q.c().toString());
      this.r.b($$0x -> this.J());
      this.e(this.r);
      this.t = new ezq(this.i, this.g / 2 - 153, 90, 300, 20, k);
      this.t.f(128);
      this.t.a(this.q.d().toString());
      this.t.b($$0x -> this.J());
      this.e(this.t);
      this.v = new ezq(this.i, this.g / 2 - 153, 125, 300, 20, l);
      this.v.f(256);
      this.v.a(this.q.g());
      this.e(this.v);
      this.w = new ezq(this.i, this.g / 2 - 153, 160, 98, 20, o);
      this.w.f(3);
      this.w.a(Integer.toString(this.q.m()));
      this.w.a(fas.a(p));
      this.e(this.w);
      this.x = new ezq(this.i, this.g / 2 - 50, 160, 98, 20, m);
      this.x.f(3);
      this.x.a(Integer.toString(this.q.l()));
      this.x.a(fas.a(n));
      this.e(this.x);
      this.D = this.q.k();
      this.A = this.d(ezo.<djt.a>a(djt.a::a).a(djt.a.values()).a(this.D).a().a(this.g / 2 + 54, 160, 100, 20, a, ($$0x, $$1) -> this.D = $$1));
      boolean $$0 = dcp.m(this.q.r()).o().b();
      this.A.j = $$0;
      this.A.k = $$0;
      this.d(new ezd(this.g / 2 - 154, 185, 100, 20, vp.a, 0.0) {
         {
            this.b();
         }
         ...
         @Override
         protected void b() {
            this.b(vq.a("jigsaw_block.levels", fhf.this.y));
         }

         @Override
         protected void a() {
            fhf.this.y = awh.a(awh.b(0.0, 20.0, this.c));
         }
      });
      this.d(ezo.b(this.z).a(this.g / 2 - 50, 185, 100, 20, vq.c("jigsaw_block.keep_jigsaws"), ($$0x, $$1) -> this.z = $$1));
      this.C = this.d(ezh.a(vq.c("jigsaw_block.generate"), $$0x -> {
         this.o();
         this.I();
      }).a(this.g / 2 + 54, 185, 100, 20).a());
      this.B = this.d(ezh.a(vp.d, $$0x -> this.o()).a(this.g / 2 - 4 - 150, 210, 150, 20).a());
