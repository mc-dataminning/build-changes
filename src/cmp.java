...
public class cmp implements clz {
   ...
   public cmp(String $$0, cly $$1, int $$2, int $$3, hn<cmg> $$4, cjf $$5, boolean $$6) {
      this.e = $$0;
      this.f = $$1;
      this.a = $$2;
      this.b = $$3;
   ...
   public cmp(String $$0, cly $$1, int $$2, int $$3, hn<cmg> $$4, cjf $$5) {
   ...
   public static class a implements cmm<cmp> {
      ...
      static record a(String b, cly c, Map<String, cmg> d, List<String> e, cjf f, boolean g) {
         public static final Codec<cmp.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     arf.a(Codec.STRING, "group", "").forGetter($$0x -> $$0x.b),
                     cly.e.fieldOf("category").orElse(cly.d).forGetter($$0x -> $$0x.c),
                     arf.d(cmp.a.y, cmg.c).fieldOf("key").forGetter($$0x -> $$0x.d),
                     cmp.a.x.fieldOf("pattern").forGetter($$0x -> $$0x.e),
                     cma.a.fieldOf("result").forGetter($$0x -> $$0x.f),
                     arf.a(Codec.BOOL, "show_notification", true).forGetter($$0x -> $$0x.g)
                  )
                  .apply($$0, cmp.a.a::new)
         );
