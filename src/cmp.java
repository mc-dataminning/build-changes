...
public class cmp implements clz {
   final int a;
   final int b;
   final hp<cmg> c;
   final cjf d;
   ...
   public cmp(String $$0, cly $$1, int $$2, int $$3, hp<cmg> $$4, cjf $$5, boolean $$6) {
      this.e = $$0;
      this.f = $$1;
      this.a = $$2;
      this.b = $$3;
   ...
   public cmp(String $$0, cly $$1, int $$2, int $$3, hp<cmg> $$4, cjf $$5) {
   ...
   private boolean a(cez $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   public static class a implements cmm<cmp> {
      ...
      private static final Codec<cmp> z = cmp.a.a.a.flatXmap($$0 -> {
         String[] $$1 = cmp.a($$0.e);
         int $$2 = $$1[0].length();
         int $$3 = $$1.length;
         hp<cmg> $$4 = hp.a($$2 * $$3, cmg.a);
         ...
         for (int $$6 = 0; $$6 < $$1.length; $$6++) {
            ...
            for (int $$8 = 0; $$8 < $$7.length(); $$8++) {
               ...
               cmg $$10 = $$9.equals(" ") ? cmg.a : $$0.d.get($$9);
               if ($$10 == null) {
         ...
         if (!$$5.isEmpty()) {
            ...
            cmp $$11 = new cmp($$0.b, $$0.c, $$2, $$3, $$4, $$0.f, $$0.g);
      ...
      static record a(String b, cly c, Map<String, cmg> d, List<String> e, cjf f, boolean g) {
         public static final Codec<cmp.a.a> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     arg.a(Codec.STRING, "group", "").forGetter($$0x -> $$0x.b),
                     cly.e.fieldOf("category").orElse(cly.d).forGetter($$0x -> $$0x.c),
                     arg.d(cmp.a.y, cmg.c).fieldOf("key").forGetter($$0x -> $$0x.d),
                     cmp.a.x.fieldOf("pattern").forGetter($$0x -> $$0x.e),
                     cma.a.fieldOf("result").forGetter($$0x -> $$0x.f),
                     arg.a(Codec.BOOL, "show_notification", true).forGetter($$0x -> $$0x.g)
                  )
                  .apply($$0, cmp.a.a::new)
         );
