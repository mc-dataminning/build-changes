...
public class cmp {
   ...
   public void a(cud $$0, int $$1) {
      if (!$$0.e()) {
         int $$2 = c($$0);
         int $$3 = Math.min($$1, $$0.H());
         this.b($$2, $$3);
      }
   }

   public static int c(cud $$0) {
      return lq.g.a($$0.g());
   }
   ...
   public boolean a(cyj<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, $$1, 1);
   }

   public boolean a(cyj<?> $$0, @Nullable IntList $$1, int $$2) {
      return new cmp.a($$0).a($$2, $$1);
   }

   public int a(cyl<?> $$0, @Nullable IntList $$1) {
      return this.a($$0, Integer.MAX_VALUE, $$1);
   }

   public int a(cyl<?> $$0, int $$1, @Nullable IntList $$2) {
      return new cmp.a($$0.b()).b($$1, $$2);
   }

   public static cud a(int $$0) {
      return $$0 == 0 ? cud.l : new cud(cty.b($$0));
   }
   ...
   class a {
      private final cyj<?> b;
      private final List<cyg> c = Lists.newArrayList();
      private final int d;
      private final int[] e;
      private final int f;
      ...
      public a(final cyj<?> $$0) {
         this.b = $$0;
         this.c.addAll($$0.a());
         this.c.removeIf(cyg::c);
         this.d = this.c.size();
         this.e = this.a();
      ...
      public boolean a(int $$0, @Nullable IntList $$1) {
         if ($$0 <= 0) {
            ...
            int $$2;
            for ($$2 = 0; this.a($$0); $$2++) {
               cmp.this.a(this.e[this.h.getInt(0)], $$0);
               int $$3 = this.h.size() - 1;
