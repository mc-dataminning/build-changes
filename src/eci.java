...
public class eci {
   ...
   private final dfd o;
   private static final List<die> p = List.of(dig.l, dig.L, dig.i, dig.b, dig.k, dig.I, dig.K, dig.fl, dig.dP, dig.iA, dig.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jq<dgc>>> s;
   private final transient double[][] t;

   private eci(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> ae.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jq<dgc>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kj.c($$0);
      int $$5 = kj.c($$1) - $$4;
   ...
   @Nullable
   public static eci a(@Nullable eci.d $$0) {
      return $$0 == null ? null : new eci($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public eci.d a() {
      ...
      return new eci.d(this.o.an(), this.o.ao() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static eci a(arv $$0, int $$1, int $$2) {
      dxf $$3 = $$0.a($$1, $$2);
      eci $$4 = $$3.s();
      if ($$4 != null && !$$3.m().d(dyg.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jn> a(dfy $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dxf $$1, int $$2, int $$3) {
   ...
   private int a(dxf $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(ebf.a.a)) {
         $$3 = Math.min($$0.a(ebf.a.a, $$1, $$2), this.o.al());
      } else {
         $$3 = this.o.al();
      }
   ...
   private static double a(dxf $$0, jh.a $$1) {
      return a($$0, (jh)$$1.c(jm.a)) ? 1.0 : -1.0;
   }

   private static double b(dxf $$0, jh.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dxf $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jq<dgc>> b(dxf $$0, int $$1, int $$2) {
      ObjectArrayList<jq<dgc>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());
   ...
   private static boolean a(dxf $$0, jh $$1) {
      dvj $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(axa.P)) {
         ...
         return $$2.a(dig.eT) || $$2.a(dig.eU) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, eci.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, eci.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jq<dgc> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<eci.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(eci.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(eci.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(eci.d::c)
                  )
                  .apply($$0, eci.d::new)
         )
         .validate(eci.d::a);

      private static DataResult<eci.d> a(eci.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != eci.n
            ? DataResult.error(() -> "heights has to be of length " + eci.n)
