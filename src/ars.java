...
public class ars {
   ...
   public static void a(ha.a $$0, cpm $$1, gu $$2, double $$3, it $$4, bgb $$5) {
      ...
      for (int $$11 = 0; $$11 < $$10; $$11++) {
         double $$12 = $$6.c + arp.a($$1.z, -1.0, 1.0) * ($$7 ? 0.5 : $$3);
         double $$13 = $$6.d + arp.a($$1.z, -1.0, 1.0) * ($$8 ? 0.5 : $$3);
         double $$14 = $$6.e + arp.a($$1.z, -1.0, 1.0) * ($$9 ? 0.5 : $$3);
         double $$15 = $$7 ? arp.a($$1.z, -1.0, 1.0) : 0.0;
         double $$16 = $$8 ? arp.a($$1.z, -1.0, 1.0) : 0.0;
         double $$17 = $$9 ? arp.a($$1.z, -1.0, 1.0) : 0.0;
   ...
   public static void a(cpm $$0, gu $$1, ha $$2, it $$3, ehe $$4, double $$5) {
      ...
      int $$8 = $$2.k();
      int $$9 = $$2.l();
      double $$10 = $$6.c + ($$7 == 0 ? arp.a($$0.z, -0.5, 0.5) : (double)$$7 * $$5);
      double $$11 = $$6.d + ($$8 == 0 ? arp.a($$0.z, -0.5, 0.5) : (double)$$8 * $$5);
      double $$12 = $$6.e + ($$9 == 0 ? arp.a($$0.z, -0.5, 0.5) : (double)$$9 * $$5);
