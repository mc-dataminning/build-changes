...
public class ars extends arx {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<art<?>> e = Sets.newHashSet();

   public ars(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cfb $$0, art<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<art<?>> d() {
      Set<art<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  sl $$4 = a($$3.getAsJsonObject());
                  $$4 = avq.g.a($$0, $$4, ta.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<art<T>> a(arv<T> $$0, String $$1) {
      return Optional.ofNullable(ahd.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }

   private static sl a(JsonObject $$0) {
      sl $$1 = new sl();
   ...
   protected String b() {
      Map<arv<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<art<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<art<?>>)$$3.next();
         art<?> $$2 = (art<?>)$$1.getKey();
      ...
      for (Entry<arv<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(kd.x.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> ahd b(art<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(ana $$0) {
      Object2IntMap<art<?>> $$1 = new Object2IntOpenHashMap();
