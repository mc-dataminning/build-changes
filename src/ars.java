...
public class ars implements AutoCloseable {
   ...
   public static ars a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            JsonObject $$1 = axw.a($$0);
            URI $$2 = new URI(axw.i($$1, "apiServer"));
            String $$3 = axw.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = axw.a($$1, "ruleId", 1);
               String $$5 = axw.a($$1, "serverId", "");
               String $$6 = axw.a($$1, "roomId", "Java:Chat");
               int $$7 = axw.a($$1, "hashesToDrop", -1);
               int $$8 = axw.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = axw.a($$1, "endpoints", null);
   ...
   CompletableFuture<are> a(GameProfile $$0, String $$1, ars.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(are.a) : CompletableFuture.supplyAsync(() -> {
         ...
         try {
            ...
            boolean $$5 = axw.a($$4, "response", false);
            if ($$5) {
               return are.a($$1);
            } else {
               String $$6 = axw.a($$4, "hashed", null);
               if ($$6 == null) {
                  return are.b($$1);
               } else {
                  JsonArray $$7 = axw.v($$4, "hashes");
                  wy $$8 = this.a($$1, $$7, $$2);
                  return new are($$1, $$8);
               }
            }
   ...
   private wy a(String $$0, JsonArray $$1, ars.a $$2) {
      if ($$1.isEmpty()) {
         return wy.c;
