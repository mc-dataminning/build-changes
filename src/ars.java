...
public class ars implements AutoCloseable {
   ...
   private ars(URL $$0, ars.c $$1, URL $$2, ars.b $$3, URL $$4, ars.b $$5, String $$6, ars.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   void a(GameProfile $$0, URL $$1, ars.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<are> a(GameProfile $$0, String $$1, ars.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(are.a) : CompletableFuture.supplyAsync(() -> {
   ...
   private xb a(String $$0, JsonArray $$1, ars.a $$2) {
      if ($$1.isEmpty()) {
         return xb.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xb.b;
      } else {
         xb $$3 = new xb($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new ars.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public arr a(GameProfile $$0) {
      return new ars.d($$0);
   }
   ...
   public interface a {
      ars.a a = ($$0, $$1) -> false;
      ars.a b = ($$0, $$1) -> $$0.length() == $$1;

      static ars.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static ars.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements arr {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bon<Runnable> $$1 = bon.a(ars.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         ars.this.a(this.c, ars.this.g, ars.this.h, this.d);
      }

      @Override
      public void b() {
         ars.this.a(this.c, ars.this.i, ars.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<are>> a(List<String> $$0) {
         List<CompletableFuture<are>> $$1 = $$0.stream().map($$0x -> ars.this.a(this.c, $$0x, ars.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<are> a(String $$0) {
         return ars.this.a(this.c, $$0, ars.this.l, this.d);
      }
   }
