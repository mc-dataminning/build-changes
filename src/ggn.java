...
public class ggn implements ggq.a, AutoCloseable {
   ...
   erb[] f;
   @Nullable
   private final ggn.a g;
   private final asc h;

   public ggn(aiy $$0, gif $$1, erb $$2, asc $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gid $$4 = $$3.a(gid.a).orElse(gid.e);
   ...
   @Nullable
   private ggn.a a(gif $$0, int $$1, int $$2, gid $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<ggn.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new ggn.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new ggn.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<ggn.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            ggn.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new ggn.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }
   ...
   class a {
      ...
      a(List<ggn.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * ggn.this.c;
         int $$4 = this.b($$2) * ggn.this.d;
         ggn.this.a($$0, $$1, $$3, $$4, ggn.this.f);
      }

      public ggp a() {
         return ggn.this.new d(this, this.d ? ggn.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final erb[] b = new erb[ggn.this.f.length];
      ...
      void a(int $$0, int $$1, ggn.d $$2) {
         ...
         if ($$7 != $$8) {
            ...
            ggn.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(ggn.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return ggn.this.f[$$2].a($$3 + ($$0.a($$1) * ggn.this.c >> $$2), $$4 + ($$0.b($$1) * ggn.this.d >> $$2));
      }
   ...
   class d implements ggp {
      ...
      final ggn.a d;
      @Nullable
      private final ggn.c e;

      d(ggn.a $$0, @Nullable ggn.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
