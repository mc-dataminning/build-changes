...
public class ggn extends ggf {
   ...
   protected static class a implements Closeable {
      ...
      public a(@Nullable giq $$0, erb $$1) {
         this.c = null;
         this.a = $$0;
         this.b = $$1;
      }

      public static ggn.a a(asa $$0, aiy $$1) {
         try {
            ...
            try {
               $$6 = $$2.f().a(giq.a).orElse(null);
            } catch (RuntimeException var8) {
               ggn.f.warn("Failed reading metadata of: {}", $$1, var8);
            }

            return new ggn.a($$6, $$4);
         } catch (IOException var10) {
            return new ggn.a(var10);
         }
      }
