...
public class ggn {
   ...
   public void a(final ggl $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final gho $$3 = gho.a($$0.b);
      Optional<InetSocketAddress> $$4 = ghq.a.a($$3).map(ghn::d);
      if ($$4.isEmpty()) {
         this.a(fth.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final gho $$1, final ggl $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)vi.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new gge($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(ggl.b.d);
               $$2.h = wo.b($$2xx);
               $$2.d = wo.b($$3);
               $$2.c = ggn.a($$4, $$5);
