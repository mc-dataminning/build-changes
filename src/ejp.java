public abstract class ejp extends ejv {
   protected final int a;
   protected final int b;
   protected final int c;
   protected int d = -1;

   protected ejp(eki $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, ji $$7) {
      super($$0, 0, ejv.a($$1, $$2, $$3, $$7, $$4, $$5, $$6));
      this.a = $$4;
      this.b = $$5;
      this.c = $$6;
      this.a($$7);
   ...
   protected boolean a(dcx $$0, ejj $$1, int $$2) {
      if (this.d >= 0) {
         return true;
      } else {
         int $$3 = 0;
