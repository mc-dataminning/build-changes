...
public class ejp {
   ...
   public ejp(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ejp(eju $$0, eju $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static ejp a(dwz $$0) {
      return new ejp((double)$$0.g(), (double)$$0.h(), (double)$$0.i(), (double)($$0.j() + 1), (double)($$0.k() + 1), (double)($$0.l() + 1));
   }

   public static ejp a(eju $$0) {
      return new ejp($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static ejp a(ht $$0, ht $$1) {
      return new ejp(
   ...
   public ejp a(double $$0) {
      return new ejp($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ejp b(double $$0) {
      return new ejp(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ejp c(double $$0) {
      return new ejp(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ejp d(double $$0) {
      return new ejp(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ejp e(double $$0) {
      return new ejp(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ejp f(double $$0) {
      return new ejp(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ejp b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ejp c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ejp d(double $$0, double $$1, double $$2) {
      return new ejp(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ejp f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ejp h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<eju> b(eju $$0, eju $$1) {
   ...
   @Nullable
   public static ejq a(Iterable<ejp> $$0, eju $$1, eju $$2, ht $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ejq($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static hx a(ejp $$0, eju $$1, double[] $$2, @Nullable hx $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public eju f() {
      return new eju(atm.d(0.5, this.a, this.d), atm.d(0.5, this.b, this.e), atm.d(0.5, this.c, this.f));
   }

   public static ejp a(eju $$0, double $$1, double $$2, double $$3) {
      return new ejp($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
