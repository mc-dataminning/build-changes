...
public class ejp extends ejs {
   ...
   static final ejp.b l = new ejp.b(854, 480);

   public ejp(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final ejp.a[] e = values();
   ...
   static class b {
      ...
      static List<ejp.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ejp.b($$0, $$1), ejp.l) : ImmutableList.of(ejp.l);
      }
