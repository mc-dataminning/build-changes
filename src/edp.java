...
public class edp extends ecd<efd> {
   private static final int a = 19;

   public edp(Codec<efd> $$0) {
      super($$0);
   }
   ...
   public static boolean c(ddc $$0, jd $$1) {
      return $$0.a($$1, $$0x -> $$0x.i() || $$0x.a(awe.cn));
   }

   private boolean a(dds $$0, ayw $$1, jd $$2, BiConsumer<jd, dtc> $$3, BiConsumer<jd, dtc> $$4, eft.b $$5, efd $$6) {
      int $$7 = $$6.d.a($$1);
      int $$8 = $$6.f.a($$1, $$7, $$6);
      int $$9 = $$7 - $$8;
      int $$10 = $$6.f.a($$1, $$9);
      ...
      if ($$12 >= $$0.I_() + 1 && $$13 <= $$0.am()) {
         ...
         if ($$15 >= $$7 || !$$14.isEmpty() && $$15 >= $$14.getAsInt()) {
            if ($$6.g.isPresent() && !$$6.g.get().a($$0, $$3, $$1, $$2, $$11, $$6)) {
               ...
               List<eft.a> $$16 = $$6.d.a($$0, $$4, $$1, $$15, $$11, $$6);
   ...
   private int a(ddc $$0, int $$1, jd $$2, efd $$3) {
      jd.a $$4 = new jd.a();
   ...
   @Override
   public final boolean a(ecf<efd> $$0) {
      final dds $$1 = $$0.b();
      ayw $$2 = $$0.d();
      jd $$3 = $$0.e();
      efd $$4 = $$0.f();
      ...
      if ($$13 && (!$$6.isEmpty() || !$$7.isEmpty())) {
         if (!$$4.i.isEmpty()) {
            egz.a $$14 = new egz.a($$1, $$12, $$2, $$6, $$7, $$5);
            $$4.i.forEach($$1x -> $$1x.a($$14));
         }

         return ejh.a(Iterables.concat($$5, $$6, $$7, $$8)).map($$4x -> {
            exj $$5x = a($$1, $$4x, $$6, $$8, $$5);
            enr.a($$1, 3, $$5x, $$4x.h(), $$4x.i(), $$4x.j());
            return true;
         }).orElse(false);
      } else {
         return false;
   ...
   private static exj a(dcx $$0, ejh $$1, Set<jd> $$2, Set<jd> $$3, Set<jd> $$4) {
      exj $$5 = new exd($$1.d(), $$1.e(), $$1.f());
      int $$6 = 7;
