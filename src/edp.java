...
public class edp extends edc<eez> {
   public edp(Codec<eez> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? azc.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(azk $$0, ddt $$1, int $$2, int $$3, je $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, je $$2, ddt $$3, boolean $$4, double $$5, je $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(ddt $$0, je $$1) {
      if ($$0.a_($$1.d()).a(dgx.dN)) {
         this.a($$0, $$1.d(), dgx.a.o());
      }
   }

   private void a(ddt $$0, azk $$1, je $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dua $$13) {
      double $$14 = $$9 ? this.a($$4, $$6, je.c, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, je.c, $$7, $$1);
      if ($$14 < 0.0) {
         je $$15 = $$2.b($$4, $$5, $$6);
   ...
   private void a(je $$0, ddt $$1, azk $$2, int $$3, int $$4, boolean $$5, boolean $$6, dua $$7) {
      dua $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dgx.dP) || $$8.a(dgx.dO) || $$8.a(dgx.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dgx.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dgx.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, je $$2, int $$3, azk $$4) {
      float $$5 = 10.0F * azc.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
      return (double)$$5 + Math.pow((double)($$0 - $$2.u()), 2.0) + Math.pow((double)($$1 - $$2.w()), 2.0) - Math.pow((double)$$3, 2.0);
   }

   private double a(int $$0, int $$1, je $$2, int $$3, int $$4, double $$5) {
   ...
   private int a(azk $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(azk $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dua $$0) {
      return $$0.a(dgx.iC) || $$0.a(dgx.dP) || $$0.a(dgx.mW);
   }
   ...
   private void a(ddt $$0, je $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dgx.dN)) {
                  if (this.a((dcx)$$0, $$10)) {
                     this.a($$0, $$10, dgx.a.o());
                     this.a($$0, $$10.d(), dgx.a.o());
                  } else if (c($$11)) {
                     dua[] $$12 = new dua[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
