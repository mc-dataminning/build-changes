...
public class edp implements edo {
   ...
   public static final Codec<edp> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dyc.i.fieldOf("blocks").forGetter($$0x -> $$0x.c),
               dye.a.fieldOf("layers").forGetter($$0x -> $$0x.d),
               dyd.a.fieldOf("crack").forGetter($$0x -> $$0x.e),
               ...
               bpl.b(1, 20).fieldOf("outer_wall_distance").orElse(bpr.a(4, 5)).forGetter($$0x -> $$0x.i),
               bpl.b(1, 20).fieldOf("distribution_points").orElse(bpr.a(3, 4)).forGetter($$0x -> $$0x.j),
               bpl.b(0, 10).fieldOf("point_offset").orElse(bpr.a(1, 2)).forGetter($$0x -> $$0x.k),
   ...
   public edp(dyc $$0, dye $$1, dyd $$2, double $$3, double $$4, boolean $$5, bpl $$6, bpl $$7, bpl $$8, int $$9, int $$10, double $$11, int $$12) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
