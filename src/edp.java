...
public class edp<T> implements edr<T> {
   ...
   private edp(jk<T> $$0, int $$1, eds<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private edp(jk<T> $$0, T[] $$1, eds<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public edr<T> a(eds<T> $$0) {
      return new edp<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
