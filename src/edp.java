...
public class edp extends eca<efd> {
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, dsz.a::i) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(ecc<efd> $$0, ddq $$1, efd $$2, ayv $$3, Set<jd> $$4, int $$5, int $$6) {
      for (jd $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(ddq $$0, efd $$1, Predicate<dta> $$2, ayv $$3, jd.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         dta $$7 = $$1.c.a($$3, $$4);
         dta $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
