...
public class btt {
   ...
   private final Map<ix<btr>, bts> b = new Object2ObjectOpenHashMap();
   private final Set<bts> c = new ObjectOpenHashSet();
   private final btv d;
