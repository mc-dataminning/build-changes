...
public class btt extends bty {
   ...
   public static btt a(float $$0, float $$1, int $$2, int $$3) {
      return new btt($$0, $$1, $$2, $$3);
   }

   private btt(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(azz $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)azq.a(azq.c($$0, $$1, $$2), $$3, $$4);
   }
