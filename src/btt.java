...
public class btt extends bth {
   ...
   public btt(bmu $$0, double $$1, boolean $$2, int $$3, BooleanSupplier $$4) {
      this.a = $$0;
      this.b = $$1;
      this.e = $$2;
      this.g = $$3;
      ...
      if (!bxe.a(this.a)) {
         ...
         if (this.e && this.a.dM().P()) {
            ...
            if (!$$0.a($$1, 6)) {
               ...
               elt $$2 = bxg.a(this.a, 15, 7, $$2x -> {
                  if (!$$0.c($$2x)) {
                     return Double.NEGATIVE_INFINITY;
                  } else {
                     Optional<hx> $$3x = $$0.y().d($$0xx -> $$0xx.a(asr.b), this::a, $$2x, 10, bxm.b.b);
               ...
               if ($$2 == null) {
                  ...
                  Optional<hx> $$3 = $$0.y().d($$0x -> $$0x.a(asr.b), this::a, hx.a($$2), 10, bxm.b.b);
                  if ($$3.isEmpty()) {
                     return false;
                  } else {
                     this.d = $$3.get().i();
                     ...
                     $$4.b($$5);
                     if (this.c == null) {
                        elt $$6 = bxd.a(this.a, 10, 7, elt.c(this.d), (float) (Math.PI / 2));
                        if ($$6 == null) {
                           return false;
                        }
