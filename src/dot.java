...
public class dot extends dfw {
   public static final MapCodec<dot> a = b(dot::new);
   public static final dtr b = dlk.f;
   public static final dtr c = dlk.b;
   public static final dtr d = dlk.c;
   public static final dtr e = dlk.d;
   public static final dtr f = dlk.e;
   public static final Map<ji, dtr> g = dlk.h.entrySet().stream().filter($$0 -> $$0.getKey() != ji.a).collect(ad.a());
   protected static final float h = 1.0F;
   private static final exp i = dfw.a(0.0, 15.0, 0.0, 16.0, 16.0, 16.0);
   private static final exp j = dfw.a(0.0, 0.0, 0.0, 1.0, 16.0, 16.0);
   private static final exp k = dfw.a(15.0, 0.0, 0.0, 16.0, 16.0, 16.0);
   private static final exp l = dfw.a(0.0, 0.0, 0.0, 16.0, 16.0, 1.0);
   private static final exp m = dfw.a(0.0, 0.0, 15.0, 16.0, 16.0, 16.0);
   private final Map<dta, exp> n;
   ...
   public dot(dsz.d $$0) {
      ...
      this.n = ImmutableMap.copyOf(this.E.a().stream().collect(Collectors.toMap(Function.identity(), dot::m)));
   }
   ...
   private boolean b(dca $$0, jd $$1, ji $$2) {
      if ($$2 == ji.a) {
         return false;
      } else {
         jd $$3 = $$1.a($$2);
   ...
   public static boolean a(dca $$0, jd $$1, ji $$2) {
      return dkw.a($$0, $$2, $$1, $$0.a_($$1));
   }

   private dta i(dta $$0, dca $$1, jd $$2) {
      jd $$3 = $$2.c();
      if ($$0.c(b)) {
         ...
         if ($$3.a(4) == 0) {
            ...
            if ($$4.o().d() && !$$0.c(a($$4))) {
               if (this.a($$1, $$2)) {
                  ...
                  if ($$7.i()) {
                     ...
                     if ($$10 && a($$1, $$12, $$8)) {
                        ...
                        } else if ((double)$$3.i() < 0.05 && a($$1, $$6.c(), ji.b)) {
               ...
               if ($$2.v() > $$1.I_()) {
                  ...
                  dta $$18 = $$1.a_($$17);
                  if ($$18.i() || $$18.a(this)) {
                     dta $$19 = $$18.i() ? this.o() : $$18;
                     dta $$20 = this.a($$0, $$19, $$3);
                     if ($$19 != $$20 && this.p($$20)) {
                        $$1.a($$17, $$20, 2);
                     }
                  }
   ...
   private dta a(dta $$0, dta $$1, ayv $$2) {
      for (ji $$3 : ji.c.a) {
         if ($$2.h()) {
            dtr $$4 = a($$3);
            if ($$0.c($$4)) {
