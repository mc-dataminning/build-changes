...
public class dot extends djm implements dpj {
   ...
   protected void b(dwx $$0, arc $$1, ji $$2, azh $$3) {
      if ($$1.G_().j() && $$1.O().b(dge.e) && $$3.a(2000) < $$1.am().a()) {
         ...
         if ($$1.a_($$2).a($$1, $$2, bur.bR)) {
            buk $$4 = bur.bR.a($$1, $$2.d(), buq.d);
            if ($$4 != null) {
               $$4.aB();
               buk $$5 = $$4.dl();
               if ($$5 != null) {
   ...
   public etz a(arc $$0, buk $$1, ji $$2) {
      akt<dgi> $$3 = $$0.ai() == dgi.j ? dgi.i : dgi.j;
      arc $$4 = $$0.p().a($$3);
      if ($$4 == null) {
         return null;
      } else {
   ...
   @Nullable
   private etz a(arc $$0, buk $$1, ji $$2, ji $$3, boolean $$4, dyn $$5) {
   ...
   private static etz a(buk $$0, ji $$1, l.a $$2, arc $$3, etz.a $$4) {
      dwx $$5 = $$0.dW().a_($$1);
      jn.a $$6;
      fba $$8;
      if ($$5.b(dxn.K)) {
   ...
   private static etz a(arc $$0, l.a $$1, jn.a $$2, fba $$3, buk $$4, etz.a $$5) {
      ji $$6 = $$1.a;
      dwx $$7 = $$0.a_($$6);
      ...
      return new etz($$0, $$18, fba.c, (float)$$12, 0.0F, bvu.a(bvu.l, bvu.k), $$5);
   }
