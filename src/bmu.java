public abstract class bmu extends bmn {
   protected static final float bS = 0.0F;

   protected bmu(blz<? extends bmu> $$0, ctp $$1) {
      super($$0, $$1);
   }
   ...
   public boolean gb() {
      return this.bz.a(bvn.Y) ? this.bz.c(bvn.Y).isPresent() : this.bO.c().anyMatch($$0 -> $$0.k() instanceof bua);
   }
   ...
   protected void fR() {
      ...
      if ($$0 != null && $$0.dM() == this.dM()) {
         this.a($$0.dm(), 5);
         float $$1 = this.e($$0);
         if (this instanceof bng && ((bng)this).A()) {
            if ($$1 > 10.0F) {
               this.a(true, true);
            }
         ...
         if ($$1 > 10.0F) {
            ...
            this.bO.b(bth.a.a);
            float $$5 = 2.0F;
            elt $$6 = new elt($$0.dr() - this.dr(), $$0.dt() - this.dt(), $$0.dx() - this.dx()).d().a((double)Math.max($$1 - 2.0F, 0.0F));
