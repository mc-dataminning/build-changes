...
public class bmu implements bmn {
   ...
   public static Set<bml> a() {
      Builder<bml> $$0 = ImmutableSet.builder();

      try {
         bmu.a $$1 = new bmu.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bml.a("cpu#" + $$1x, bmk.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bml.a("heap MiB", bmk.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bmm.a.a());
      return $$0.build();
   }
   ...
   public static bml a(final LongSupplier $$0) {
      ...
      bml.d $$3 = new bml.d(2.0F);
      return bml.a("ticktime", bmk.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
