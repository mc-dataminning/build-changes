...
public class bmu {
   ...
   public static bky<bjp> a(float $$0) {
      ...
      return boj.a(
         (Function<boj.b<bjp>, ? extends App<boj.c<bjp>, bom<bjp>>>)($$3 -> $$3.group($$3.c(bsh.m), $$3.c(bsh.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.V() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        buf $$7 = $$4x.w();
                        Optional<gw> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(buj.n), $$5.dl(), 48, buf.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dl()) <= 4.0)) {
                           ...
                           Set<Pair<hg<bui>, gw>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(buj.n), $$10, $$5.dl(), 48, buf.b.c).collect(Collectors.toSet());
                           ebb $$12 = bkq.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              gw $$13 = $$12.l();
                              Optional<hg<bui>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new bsk($$13, $$0, 1));
                                 abc.c($$4x, $$13);
                              }
