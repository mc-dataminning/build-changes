...
public abstract class bmu<C, V> implements bmo<StringReader, V>, bmv {
   private final bmi<alf> b;
   protected final C a;

   protected bmu(bmi<alf> $$0, C $$1) {
      this.b = $$0;
      this.a = $$1;
   }

   @Override
   public Optional<V> a(bmn<StringReader> $$0) {
      $$0.b().skipWhitespace();
      int $$1 = $$0.c();
