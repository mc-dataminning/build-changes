...
public class cqy extends cqt implements bxy, cra {
   private static final Logger bM = LogUtils.getLogger();
   private static final akj<cqz> bN = akn.a(cqy.class, akl.u);
   public static final int bI = 12;
   public static final Map<czj, Integer> bJ = ImmutableMap.of(czr.ql, 4, czr.vq, 1, czr.vp, 1, czr.wv, 1);
   ...
   private static final ImmutableList<chs<? extends chr<? super cqy>>> cj = ImmutableList.of(chs.c, chs.d, chs.b, chs.e, chs.f, chs.g, chs.h, chs.i, chs.j);
   public static final Map<cgl<je>, BiPredicate<cqy, jf<cio>>> bL = ImmutableMap.of(
      cgl.b,
      (BiPredicate<cqy, jf>)($$0, $$1) -> $$1.a(cip.n),
      cgl.c,
      (BiPredicate<cqy, jf>)($$0, $$1) -> $$0.gB().b().a().b().test($$1),
      cgl.d,
      (BiPredicate<cqy, jf>)($$0, $$1) -> crb.a.test($$1),
      cgl.e,
      (BiPredicate<cqy, jf>)($$0, $$1) -> $$1.a(cip.o)
   );

   public cqy(bwr<? extends cqy> $$0, djm $$1) {
      this($$0, $$1, crd.c);
   }

   public cqy(bwr<? extends cqy> $$0, djm $$1, alf<crd> $$2) {
      this($$0, $$1, $$1.F_().d($$2));
   }

   public cqy(bwr<? extends cqy> $$0, djm $$1, jf<crd> $$2) {
      super($$0, $$1);
      ((cgs)this.O()).b(true);
      this.O().a(true);
      this.O().a(48.0F);
      this.a_(true);
      this.a(this.gB().a($$2).b($$1.F_(), crb.b));
   }

   @Override
   public byj<cqy> eb() {
      return (byj<cqy>)super.eb();
   }

   @Override
   protected byj.b<cqy> ec() {
      return byj.a(ci, cj);
   }

   @Override
   protected byj<?> a(Dynamic<?> $$0) {
      byj<cqy> $$1 = this.ec().a($$0);
      this.a($$1);
      return $$1;
   }
   ...
   private void a(byj<cqy> $$0) {
      jf<crb> $$1 = this.gB().b();
      if (this.n_()) {
         $$0.a(cti.e);
         $$0.a(ctg.d, ccg.a(0.5F));
      } else {
         $$0.a(cti.f);
         $$0.a(ctg.c, ccg.b($$1, 0.5F), ImmutableSet.of(Pair.of(cgl.c, cgm.a)));
      }

      $$0.a(ctg.a, ccg.a($$1, 0.5F));
      $$0.a(ctg.f, ccg.d($$1, 0.5F), ImmutableSet.of(Pair.of(cgl.e, cgm.a)));
      $$0.a(ctg.e, ccg.c($$1, 0.5F));
      $$0.a(ctg.b, ccg.e($$1, 0.5F));
      $$0.a(ctg.g, ccg.f($$1, 0.5F));
      $$0.a(ctg.i, ccg.g($$1, 0.5F));
      $$0.a(ctg.h, ccg.h($$1, 0.5F));
      $$0.a(ctg.j, ccg.i($$1, 0.5F));
   ...
   public bug b(crm $$0, buf $$1) {
      czn $$2 = $$0.b($$1);
      if ($$2.a(czr.uR) || !this.bI() || this.gt() || this.fQ()) {
         return super.b($$0, $$1);
      } else if (this.n_()) {
         this.gO();
         return bug.a;
   ...
   public static cqz gH() {
      return new cqz(mg.w.b(crd.c), mg.x.b(crb.b), 1);
   }

   @Override
   public void b(tz $$0) {
      super.b($$0);
      $$0.a("VillagerData", cqz.c, this.gB());
   ...
   public void a(tz $$0) {
      super.a($$0);
      this.al.a(bN, $$0.<cqz>a("VillagerData", cqz.c).orElseGet(cqy::gH));
      if ($$0.b("FoodLevel", 1)) {
      ...
      if (this.dU() instanceof arq) {
         ...
         this.bs.c($$0).ifPresent($$2 -> {
            ...
            if ($$3 != null) {
               ...
               BiPredicate<cqy, jf<cio>> $$6 = bL.get($$0);
   ...
   private boolean gY() {
      int $$0 = this.gB().c();
      return cqz.d($$0) && this.cd >= cqz.c($$0);
   }
   ...
   public byb a(dkd $$0, bue $$1, bwq $$2, @Nullable byb $$3) {
      if ($$2 == bwq.e) {
         this.a(this.gB().b($$0.F_(), crb.b));
      }

      if ($$2 == bwq.n || $$2 == bwq.m || bwq.a($$2) || $$2 == bwq.o) {
         this.a(this.gB().a($$0.F_(), crd.a($$0.u(this.du()))));
      }
   ...
   @Nullable
   public cqy b(arq $$0, bvy $$1) {
      double $$2 = this.ae.j();
      jf<crd> $$3;
      if ($$2 < 0.5) {
         $$3 = $$0.F_().d(crd.a($$0.u(this.du())));
      } else if ($$2 < 0.75) {
         $$3 = this.gB().a();
      } else {
         $$3 = ((cqy)$$1).gB().a();
   ...
   public void a(arq $$0, bxi $$1) {
      if ($$0.an() != bud.a) {
         ...
         cpe $$2 = this.a(bwr.bI, bwc.a(this, false, false), $$1x -> {
   ...
   protected void gz() {
      cqz $$0 = this.gB();
      alf<crb> $$1 = $$0.b().e().orElse(null);
      if ($$1 != null) {
         Int2ObjectMap<crc.g[]> $$3;
         if (this.dU().K().b(cuy.b)) {
            Int2ObjectMap<crc.g[]> $$2 = crc.c.get($$1);
            $$3 = $$2 != null ? $$2 : crc.a.get($$1);
         } else {
            $$3 = crc.a.get($$1);
         }

         if ($$3 != null && !$$3.isEmpty()) {
            crc.g[] $$5 = (crc.g[])$$3.get($$0.c());
            if ($$5 != null) {
               dij $$6 = this.gu();
               this.a($$6, $$5, 2);
            }
   ...
   public void a(arq $$0, cqy $$1, long $$2) {
   ...
   public void a(arq $$0, long $$1, int $$2) {
      if (this.a($$1)) {
         fex $$3 = this.cQ().c(10.0, 10.0, 10.0);
         List<cqy> $$4 = $$0.a(cqy.class, $$3);
         List<cqy> $$5 = $$4.stream().filter($$1x -> $$1x.a($$1)).limit(5L).toList();
         if ($$5.size() >= $$2) {
