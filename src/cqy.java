...
public class cqy {
   public static <T> List<cqy.b> a(List<T> $$0, Function<T, List<hk<duh>>> $$1, boolean $$2) {
      Object2IntMap<duh> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, duh c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<hk<duh>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (hg<duh> $$12 : $$10.get($$11)) {
               duh $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && ari.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<cqy.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<duh> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new cqy.b($$28));
      }
   ...
   public static record b(List<duh> a, ToIntFunction<duh> b) {
      b(List<duh> $$0) {
