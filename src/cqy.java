...
public abstract class cqy extends cpw {
   private static final int k = 9;
   private static final int l = 3;
   protected final cqh o;
   protected final cmz p;
   protected final bqp q;
   private final List<Integer> m;
   protected final crm r = new crm();
   private final int n;

   protected abstract boolean a(cmz var1, boolean var2);

   protected abstract void a(cmz var1, cur var2);

   protected abstract boolean a(dse var1);

   public cqy(@Nullable crd<?> $$0, int $$1, cmy $$2, cqh $$3) {
      super($$0, $$1);
      this.o = $$3;
      this.p = $$2.l;
      cqz $$4 = this.l();
   ...
   private void a(cqz $$0) {
      for (final cqz.b $$1 : $$0.c()) {
         this.a(new crr(this.q, $$1.a(), $$1.b(), $$1.c()) {
            @Override
   ...
   private void b(cqz $$0) {
      this.a(new crr(this.r, $$0.b().a(), $$0.b().b(), $$0.b().c()) {
         @Override
         public boolean a(cur $$0) {
            return false;
         }
   ...
   private void a(cmy $$0) {
      for (int $$1 = 0; $$1 < 3; $$1++) {
         for (int $$2 = 0; $$2 < 9; $$2++) {
            this.a(new crr($$0, $$2 + $$1 * 9 + 9, 8 + $$2 * 18, 84 + $$1 * 18));
         }
      }

      for (int $$3 = 0; $$3 < 9; $$3++) {
         this.a(new crr($$0, $$3, 8 + $$3 * 18, 142));
      }
   }

   public abstract void m();

   protected abstract cqz l();
