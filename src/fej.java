...
public class fej implements AutoCloseable {
   private final feh.a a;
   @Nullable
   private feh.a b;
   private final fej.a c;

   public fej(feh.a $$0, fej.a $$1) {
      this.a = $$0;
      this.c = $$1;
   }

   private static Vector3f[] a(ByteBuffer $$0, int $$1, fep $$2) {
      int $$3 = $$2.a(feq.b);
      if ($$3 == -1) {
   ...
   @Nullable
   public fej.b a(feh $$0, fes $$1) {
      if (this.c.d() != fep.c.h) {
         return null;
      } else {
         Vector3f[] $$2 = a(this.a.a(), this.c.b(), this.c.a());
         fej.b $$3 = new fej.b($$2, this.c.e());
         this.b = $$3.a($$0, $$1);
         return $$3;
      }
   }
   ...
   public static record a(fep a, int b, int c, fep.c d, fep.b e) {
   }

   public static record b(Vector3f[] a, fep.b b) {
      @Nullable
      public feh.a a(feh $$0, fes $$1) {
         int[] $$2 = $$1.sort(this.a);
      ...
      private IntConsumer a(long $$0, fep.b $$1) {
