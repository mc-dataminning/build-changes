...
public interface eqd {
   eqd a(double var1, double var3, double var5);

   eqd a(int var1, int var2, int var3, int var4);

   eqd a(float var1, float var2);

   eqd a(int var1, int var2);

   eqd b(int var1, int var2);

   eqd a(float var1, float var2, float var3);
   ...
   default eqd a(float $$0, float $$1, float $$2, float $$3) {
      return this.a((int)($$0 * 255.0F), (int)($$1 * 255.0F), (int)($$2 * 255.0F), (int)($$3 * 255.0F));
   }

   default eqd a(int $$0) {
      return this.a(atx.b.b($$0), atx.b.c($$0), atx.b.d($$0), atx.b.a($$0));
   }
   ...
   default void a(epz.a $$0, fuc $$1, float $$2, float $$3, float $$4, int $$5, int $$6) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, new int[]{$$5, $$5, $$5, $$5}, $$6, false);
   }

   default void a(epz.a $$0, fuc $$1, float[] $$2, float $$3, float $$4, float $$5, int[] $$6, int $$7, boolean $$8) {
      ...
      try {
         ByteBuffer $$18 = $$17.malloc(epx.j.b());
   ...
   default eqd a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector4f $$4 = $$0.transform(new Vector4f($$1, $$2, $$3, 1.0F));
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default eqd a(Matrix3f $$0, float $$1, float $$2, float $$3) {
