public class eqd {
   ...
   private final int c;
   private final axu d;
   private final jf.a e = new jf.a();
   private final jf.a f = new jf.a();

   public eqd(del $$0) {
      this.c = $$0.H_() - 1;
      int $$1 = $$0.an() + 1;
      int $$2 = azf.e($$1 - this.c + 1);
   ...
   private int a(dwo $$0, int $$1, int $$2, int $$3) {
      int $$4 = kh.c($$0.h($$1) + 1);
      jf.a $$5 = this.e.d($$2, $$4, $$3);
      jf.a $$6 = this.f.a($$5, jk.a);
      dus $$7 = dho.a.n();
   ...
   public boolean a(ddo $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(ddo $$0, int $$1, int $$2, jf $$3, dus $$4, jf $$5, dus $$6) {
      int $$7 = $$3.v();
      if (a($$4, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(ddo $$0, jf $$1, dus $$2) {
      jf.a $$3 = this.e.g($$1);
      jf.a $$4 = this.f.a($$1, jk.a);
      dus $$5 = $$2;
