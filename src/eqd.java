...
public class eqd implements AutoCloseable {
   ...
   private eqf a(epv.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(epv.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, ftu $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, ftu $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.o != null && (this.i == eqf.b.a || this.i == eqf.b.b)) {
