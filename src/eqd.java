...
public class eqd {
   ...
   static class b {
      static final Optional<eqd> a = Optional.ofNullable(a());
      ...
      private static eqd a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new eqd();
      }
   }
}
