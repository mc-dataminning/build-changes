...
public class eqd implements epy {
   protected static final epy a = new eqd(false, -Double.MAX_VALUE, cqm.h, $$0 -> false, null) {
      @Override
      public boolean a(eqm $$0, ib $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected eqd(boolean $$0, double $$1, cqm $$2, Predicate<eip> $$3, @Nullable box $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected eqd(box $$0) {
      ...
      // 00: aload 0
      // 01: aload 1
      // 02: invokevirtual box.bW ()Z
      // 05: aload 1
      // 06: invokevirtual box.dt ()D
      // 09: aload 1
      // 0a: instanceof bpp
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast bpp
      // 14: invokevirtual bpp.eU ()Lcqm;
      // 17: goto 1d
      // 1a: getstatic cqm.h Lcqm;
      // 1d: aload 1
      // 1e: instanceof bpp
      // 21: ifeq 35
      // 24: aload 1
      ...
      // 2c: pop
      // 2d: invokedynamic test (Lbpp;)Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, bpp.a (Leip;)Z, (Leip;)Z ]
      // 32: goto 3a
      // 35: invokedynamic test ()Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, eqd.a (Leip;)Z, (Leip;)Z ]
      // 3a: aload 1
      // 3b: invokespecial eqd.<init> (ZDLcqm;Ljava/util/function/Predicate;Lbox;)V
      // 3e: return
   }
