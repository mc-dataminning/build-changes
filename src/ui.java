...
public class ui {
   ...
   public static final Codec<ui> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               uk.a.optionalFieldOf("color").forGetter($$0x -> Optional.ofNullable($$0x.d)),
   ...
   public ui a(@Nullable uk $$0) {
      return new ui($$0, this.e, this.f, this.g, this.h, this.i, this.j, this.k, this.l, this.m);
   }
   ...
   public ui a(@Nullable Boolean $$0) {
      return new ui(this.d, $$0, this.f, this.g, this.h, this.i, this.j, this.k, this.l, this.m);
   }

   public ui b(@Nullable Boolean $$0) {
      return new ui(this.d, this.e, $$0, this.g, this.h, this.i, this.j, this.k, this.l, this.m);
   }

   public ui c(@Nullable Boolean $$0) {
      return new ui(this.d, this.e, this.f, $$0, this.h, this.i, this.j, this.k, this.l, this.m);
   }

   public ui d(@Nullable Boolean $$0) {
      return new ui(this.d, this.e, this.f, this.g, $$0, this.i, this.j, this.k, this.l, this.m);
   }

   public ui e(@Nullable Boolean $$0) {
      return new ui(this.d, this.e, this.f, this.g, this.h, $$0, this.j, this.k, this.l, this.m);
   }

   public ui a(@Nullable tk $$0) {
      return new ui(this.d, this.e, this.f, this.g, this.h, this.i, $$0, this.k, this.l, this.m);
   }

   public ui a(@Nullable tr $$0) {
      return new ui(this.d, this.e, this.f, this.g, this.h, this.i, this.j, $$0, this.l, this.m);
   }

   public ui a(@Nullable String $$0) {
      return new ui(this.d, this.e, this.f, this.g, this.h, this.i, this.j, this.k, $$0, this.m);
   }

   public ui a(@Nullable aex $$0) {
      return new ui(this.d, this.e, this.f, this.g, this.h, this.i, this.j, this.k, this.l, $$0);
   }
   ...
   public ui b(n $$0) {
      ...
      return new ui($$1, $$2, $$3, $$5, $$4, $$6, this.j, this.k, this.l, this.m);
   }
   ...
   public static class b implements JsonDeserializer<ui>, JsonSerializer<ui> {
      @Nullable
      public ui a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         if ($$0.isJsonObject()) {
            ...
            if ($$3 == null) {
               ...
               tr $$12 = b($$3);
               aex $$13 = a($$3);
               return new ui($$9, $$4, $$5, $$6, $$7, $$8, $$11, $$12, $$10, $$13);
            }
         } else {
            return null;
         }
      ...
      @Nullable
      private static tr b(JsonObject $$0) {
         if ($$0.has("hoverEvent")) {
      ...
      @Nullable
      private static tk c(JsonObject $$0) {
         if ($$0.has("clickEvent")) {
            JsonObject $$1 = aro.u($$0, "clickEvent");
            String $$2 = aro.a($$1, "action", null);
            tk.a $$3 = $$2 == null ? null : tk.a.a($$2);
      ...
      @Nullable
      private static uk e(JsonObject $$0) {
         if ($$0.has("color")) {
