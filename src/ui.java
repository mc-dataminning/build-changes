...
public class ui extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<tk> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, sw.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<tk> $$0, Codec<T> $$1, sw $$2) {
      tk $$3 = this.a($$2);
      return ac.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> ui a(DynamicOps<tk> $$0, Codec<T> $$1, T $$2) {
      tk $$3 = ac.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }
   ...
   public <T> void a(im<ih<T>> $$0, ih<T> $$1, ui.b<T> $$2) {
      switch ($$1.f()) {
         case a:
            int $$3 = $$0.a($$1);
            if ($$3 == -1) {
   ...
   public <T> ih<T> a(im<ih<T>> $$0, ui.a<T> $$1) {
      int $$2 = this.n();
      if ($$2 == 0) {
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, ui.a<T> $$1) {
      int $$2 = this.n();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, ui.b<T> $$1) {
      this.c($$0.size());
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, ui.a<K> $$1, ui.a<V> $$2) {
      int $$3 = this.n();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(ui.a<K> $$0, ui.a<V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, ui.b<K> $$1, ui.b<V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.accept(this, (K)$$2x);
         $$2.accept(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, ui.b<T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.accept(this, $$0.get());
      } else {
   ...
   public <L, R> void a(Either<L, R> $$0, ui.b<L> $$1, ui.b<R> $$2) {
      $$0.ifLeft($$1x -> {
         this.a(true);
         $$1.accept(this, (L)$$1x);
      }).ifRight($$1x -> {
   ...
   public <L, R> Either<L, R> b(ui.a<L> $$0, ui.a<R> $$1) {
   ...
   public vf l() {
      return this.a(tb.a, vh.a, sw.a(2097152L));
   }

   public vf m() {
      return this.a(tb.a, vh.a);
   }

   public ui a(vf $$0) {
      return this.a(tb.a, vh.a, $$0);
   }
   ...
   public <T> ui a(ToIntFunction<T> $$0, T $$1) {
   ...
   public ui a(@Nullable tk $$0) {
      if ($$0 == null) {
         $$0 = sp.b;
      }

      try {
         ta.a($$0, new ByteBufOutputStream(this));
         return this;
   ...
   @Nullable
   public sn q() {
      tk $$0 = this.a(sw.a(2097152L));
      if ($$0 != null && !($$0 instanceof sn)) {
   ...
   public tk a(sw $$0) {
      try {
         tk $$1 = ta.b(new ByteBufInputStream(this), $$0);
         return $$1.b() == 0 ? null : $$1;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public String d(int $$0) {
      return uv.a(this.d, $$0);
   }

   public ui a(String $$0) {
      return this.a($$0, 32767);
   }

   public ui a(String $$0, int $$1) {
      uv.a(this.d, $$0, $$1);
      return this;
   }

   public ahg t() {
      return new ahg(this.d(32767));
   }
   ...
   public <T> ahf<T> a(ahf<? extends it<T>> $$0) {
      ahg $$1 = this.t();
      return ahf.a($$0, $$1);
   }
   ...
   public void a(PropertyMap $$0) {
      this.a($$0.values(), ui::a);
   }

   public Property C() {
      String $$0 = this.s();
      String $$1 = this.s();
      String $$2 = this.c(ui::s);
   ...
   public ui a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ui a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public ui a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ui a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ui a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ui a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public ui a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public ui b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public ui c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public ui d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public ui e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public ui f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public ui g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public ui h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public ui a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public ui b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public ui i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public ui a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public ui a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public ui b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public ui b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public ui b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ui b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public ui b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public ui b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public ui a(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public ui a(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public ui a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public ui a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public ui a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public ui a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public ui a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public ui b(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public ui b(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public ui b(ByteBuf $$0, int $$1, int $$2) {
   ...
   @FunctionalInterface
   public interface a<T> extends Function<ui, T> {
      default ui.a<Optional<T>> asOptional() {
         return $$0 -> $$0.b(this);
      }
   }

   @FunctionalInterface
   public interface b<T> extends BiConsumer<ui, T> {
      default ui.b<Optional<T>> asOptional() {
