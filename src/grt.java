...
public class grt {
   private static final gsl a = gsl.u(ali.b("textures/map/map_background.png"));
   private static final gsl b = gsl.u(ali.b("textures/map/map_background_checkerboard.png"));
   ...
   private final frd au;
   private final hkj av = new hkj();
   private czy aw = czy.k;
   private czy ax = czy.k;
   private float ay;
   private float az;
   private float aA;
   private float aB;
   private final gyg aC;
   private final gzg aD;
   private final hhq aE;

   public grt(frd $$0, gyg $$1, gzg $$2, hhq $$3) {
      this.au = $$0;
      this.aC = $$1;
      this.aD = $$2;
      this.aE = $$3;
   ...
   public void a(bxu $$0, czy $$1, czw $$2, flo $$3, gsa $$4, int $$5) {
      if (!$$1.f()) {
         this.aD.a($$0, $$1, $$2, $$3, $$4, $$0.dV(), $$5, hkq.d, $$0.ao() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = azo.a($$1, 0.0F, 1.0F);
      return -azo.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(flo $$0, gsa $$1, int $$2, bxl $$3) {
      hdp $$4 = (hdp)this.aC.<gqw>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == bxl.b ? 1.0F : -1.0F;
      ...
      ali $$6 = this.au.t.c().a();
      if ($$3 == bxl.b) {
         $$4.a($$0, $$1, $$2, $$6, this.au.t.a(crz.d));
      } else {
         $$4.b($$0, $$1, $$2, $$6, this.au.t.a(crz.c));
      }

      $$0.b();
   }

   private void a(flo $$0, gsa $$1, int $$2, float $$3, bxl $$4, float $$5, czy $$6) {
      float $$7 = $$4 == bxl.b ? 1.0F : -1.0F;
      ...
      float $$8 = azo.c($$5);
      float $$9 = azo.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * azo.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * azo.a($$5 * (float) Math.PI);
   ...
   private void a(flo $$0, gsa $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = azo.c($$5);
      float $$7 = -0.2F * azo.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * azo.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = azo.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.aw);
   }

   private void a(flo $$0, gsa $$1, int $$2, czy $$3) {
      ...
      ezh $$4 = $$3.a(kk.M);
      ezj $$5 = dal.a($$4, this.au.s);
      flr $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(flo $$0, gsa $$1, int $$2, float $$3, float $$4, bxl $$5) {
      boolean $$6 = $$5 != bxl.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = azo.c($$4);
      float $$9 = -0.3F * azo.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * azo.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * azo.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = azo.a($$4 * $$4 * (float) Math.PI);
      float $$13 = azo.a($$8 * (float) Math.PI);
      ...
      hdp $$15 = (hdp)this.aC.<gqw>a($$14);
      ali $$16 = $$14.c().a();
      if ($$6) {
         $$15.a($$0, $$1, $$2, $$16, $$14.a(crz.d));
      } else {
         $$15.b($$0, $$1, $$2, $$16, $$14.a(crz.c));
      }
   }

   private void a(flo $$0, float $$1, bxl $$2, czy $$3, crx $$4) {
      float $$5 = (float)$$4.fC() - $$1 + 1.0F;
      float $$6 = $$5 / (float)$$3.a((bxu)$$4);
      if ($$6 < 0.8F) {
         float $$7 = azo.e(azo.b($$5 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$7, 0.0F);
      }
   ...
   private void a(flo $$0, float $$1, bxl $$2, czy $$3, crx $$4, float $$5) {
      this.b($$0, $$2, $$5);
      ...
      float $$12 = -15.0F;
      int $$13 = 2;
      float $$14 = -15.0F + 75.0F * azo.b($$8 * 2.0F * (float) Math.PI);
      if ($$2 != bxl.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(flo $$0, bxl $$1, float $$2) {
      int $$3 = $$1 == bxl.b ? 1 : -1;
      float $$4 = azo.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = azo.a(azo.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(flo $$0, bxl $$1, float $$2) {
      int $$3 = $$1 == bxl.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, flo $$1, gsa.a $$2, gqz $$3, int $$4) {
      float $$5 = $$3.D($$0);
      buq $$6 = (buq)MoreObjects.firstNonNull($$3.aJ, buq.a);
      float $$7 = $$3.k($$0);
      grt.a $$8 = a($$3);
      float $$9 = azo.h($$0, $$3.cv, $$3.ct);
      float $$10 = azo.h($$0, $$3.cu, $$3.cs);
      $$1.a(a.b.rotationDegrees(($$3.i($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.j($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == buq.a ? $$5 : 0.0F;
         float $$12 = 1.0F - azo.h($$0, this.az, this.ay);
         this.a($$3, $$0, $$7, buq.a, $$11, this.aw, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == buq.b ? $$5 : 0.0F;
         float $$14 = 1.0F - azo.h($$0, this.aB, this.aA);
         this.a($$3, $$0, $$7, buq.b, $$13, this.ax, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static grt.a a(gqz $$0) {
      czy $$1 = $$0.fb();
      czy $$2 = $$0.fc();
      boolean $$3 = $$1.a(dac.pj) || $$2.a(dac.pj);
      boolean $$4 = $$1.a(dac.xg) || $$2.a(dac.xg);
      if (!$$3 && !$$4) {
         return grt.a.a;
      } else if ($$0.fz()) {
         return b($$0);
      } else {
         return a($$1) ? grt.a.b : grt.a.a;
      }
   }

   private static grt.a b(gqz $$0) {
      czy $$1 = $$0.fB();
      buq $$2 = $$0.fA();
      if (!$$1.a(dac.pj) && !$$1.a(dac.xg)) {
         return $$2 == buq.a && a($$0.fc()) ? grt.a.b : grt.a.a;
      } else {
         return grt.a.a($$2);
      }
   }
   ...
   private static boolean a(czy $$0) {
      return $$0.a(dac.xg) && cyr.g($$0);
   }

   private void a(gqw $$0, float $$1, float $$2, buq $$3, float $$4, czy $$5, float $$6, flo $$7, gsa $$8, int $$9) {
      if (!$$0.gH()) {
         boolean $$10 = $$3 == buq.a;
         bxl $$11 = $$10 ? $$0.fy() : $$0.fy().e();
         $$7.a();
         if ($$5.f()) {
            if ($$10 && !$$0.co()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3 && !$$12) {
               ...
               float $$15 = (float)$$5.a((bxu)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
               float $$16 = $$15 / (float)cyr.b($$5, $$0);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = azo.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
            ...
            this.a($$0, $$5, $$13 ? czw.e : czw.d, $$7, $$8, $$9);
         } else {
            boolean $$20 = $$11 == bxl.b;
            int $$21 = $$20 ? 1 : -1;
            if ($$0.fz() && $$0.fC() > 0 && $$0.fA() == $$3) {
               switch ($$5.w()) {
                  ...
                  case e:
                     ...
                     float $$22 = (float)$$5.a((bxu)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$23 = $$22 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$21 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$21 * -9.785F));
                     float $$27 = (float)$$5.a((bxu)$$0) - ((float)$$0.fC() - $$1 + 1.0F);
                     float $$28 = $$27 / 10.0F;
                     if ($$28 > 1.0F) {
                        $$28 = 1.0F;
                     }
            ...
            this.a($$0, $$5, $$20 ? czw.e : czw.d, $$7, $$8, $$9);
         }
   ...
   private void a(float $$0, float $$1, flo $$2, int $$3, bxl $$4) {
      float $$5 = -0.4F * azo.a(azo.c($$0) * (float) Math.PI);
      float $$6 = 0.2F * azo.a(azo.c($$0) * (float) (Math.PI * 2));
      float $$7 = -0.2F * azo.a($$0 * (float) Math.PI);
      $$2.a((float)$$3 * $$5, $$6, $$7);
      this.b($$2, $$4, $$1);
      this.a($$2, $$4, $$0);
   }
   ...
   private boolean a(czy $$0, czy $$1) {
      return czy.a($$0, $$1) ? true : !this.aE.a($$1);
   }
   ...
   public void a() {
      ...
      if ($$0.B()) {
         this.ay = azo.a(this.ay - 0.4F, 0.0F, 1.0F);
         this.aA = azo.a(this.aA - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.H(1.0F);
         float $$4 = this.aw != $$1 ? 0.0F : $$3 * $$3 * $$3;
         float $$5 = this.ax != $$2 ? 0.0F : 1.0F;
         this.ay = this.ay + azo.a($$4 - this.ay, -0.4F, 0.4F);
         this.aA = this.aA + azo.a($$5 - this.aA, -0.4F, 0.4F);
      }
