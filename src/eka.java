...
public class eka {
   ...
   public static final eka.a bv;

   public static eka.a a(int $$0, int $$1) {
      return $$0 == -1 ? eka.b.b.a($$1) : eka.b.a.a($$0);
   }

   public static eka.a a(String $$0) {
      if (eka.a.e.containsKey($$0)) {
         return eka.a.e.get($$0);
      } else {
         for (eka.b $$1 : eka.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eka.b b;
      private final int c;
      private final ark<tf> d;
      static final Map<String, eka.a> e = Maps.newHashMap();

      a(String $$0, eka.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ark<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? tf.b($$2.toUpperCase(Locale.ROOT)) : tf.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? tf.b($$2) : tf.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> qm.a().b($$1) ? tf.c($$1) : tf.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<eka.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, tf> g;

      private static void a(eka.b $$0, String $$1, int $$2) {
         eka.a $$3 = new eka.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, tf> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public eka.a a(int $$0) {
         return (eka.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
