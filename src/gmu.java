...
public class gmu {
   ...
   public gmn a(Vector3f $$0, Vector3f $$1, gmp $$2, hbg $$3, jm $$4, hdx $$5, @Nullable gmq $$6, boolean $$7, int $$8) {
      gmr $$9 = $$2.d();
      if ($$5.c()) {
         $$9 = a($$2.d(), $$4, $$5.b());
      }
      ...
      $$9.a[0] = azu.h($$11, $$9.a[0], $$12);
      $$9.a[2] = azu.h($$11, $$9.a[2], $$12);
      $$9.a[1] = azu.h($$11, $$9.a[1], $$13);
      $$9.a[3] = azu.h($$11, $$9.a[3], $$13);
      ...
      return new gmn($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static gmr a(gmr $$0, jm $$1, j $$2) {
      ...
      Vector3f $$24 = $$23.transform(new Vector3f(azu.b($$22), azu.a($$22), 0.0F));
      int $$25 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$24.y(), (double)$$24.x())) / 90.0)) * 90, 360);
      return new gmr(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private int[] a(gmr $$0, hbg $$1, jm $$2, float[] $$3, j $$4, @Nullable gmq $$5) {
      int[] $$6 = new int[32];
   ...
   private void a(int[] $$0, int $$1, jm $$2, gmr $$3, float[] $$4, hbg $$5, j $$6, @Nullable gmq $$7) {
      gkt.b $$8 = gkt.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, hbg $$3, gmr $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gmq $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, jm $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (azu.a($$13, $$18) && azu.a($$14, $$19) && azu.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
