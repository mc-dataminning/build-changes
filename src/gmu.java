public class gmu extends gnh<cfn, fua<cfn>> {
   private final gdi a;

   public gmu(gkr<cfn, fua<cfn>> $$0, gdi $$1) {
      super($$0);
      this.a = $$1;
   }

   public void a(ezw $$0, gdm $$1, int $$2, cfn $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9) {
      boolean $$10 = $$3.fL();
      boolean $$11 = $$3.p_();
      $$0.a();
      if ($$11) {
