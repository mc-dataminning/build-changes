...
public class fli {
   ...
   private void a(akv $$0, fba $$1, @Nullable tq $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         ...
         if ($$3 == 1 && (!(this.b.z instanceof fxw) || ((fxw)$$6).u <= af.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
         ...
         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aL_() instanceof fpc) || !((fpc)$$6.aL_()).c();
            if ($$7) {
               if (ful.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
         ...
         label197: {
            ...
            label153:
            if (!$$13) {
               if (this.b.z instanceof fug $$14 && !$$14.m()) {
                  break label153;
               }
