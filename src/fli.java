...
public class fli implements hbi {
   private static final long a = 3000L;
   private final fib b;
   private final List<fli.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fli.b> e = new ArrayList<>();
   ...
   public void a(fjn $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fli.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hae $$0, hbk $$1, float $$2) {
      if ($$1.a() != null) {
         xd $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fli.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new eye($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fli.b($$3, $$2, new eye($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(eye a, long b) {
   }

   static class b {
      private final xd a;
      private final float b;
      private final List<fli.a> c = new ArrayList<>();

      public b(xd $$0, float $$1, eye $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fli.a($$2, ad.c()));
      }
      ...
      public void b(eye $$0) {
         ...
         this.c.add(new fli.a($$0, ad.c()));
      }

      public boolean c(eye $$0) {
