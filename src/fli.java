...
public class fli {
   ...
   public static class b extends fmu {
      ...
      public float b(float $$0) {
         return 7.1F * arx.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }
   ...
   public static class e extends fls {
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, apf.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }
         ...
         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            ...
            flu $$17 = this.b.a(ix.J, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
         ...
         if (this.a > this.t) {
            if (this.E) {
               boolean $$18 = this.c();
               apd $$19 = $$18 ? ape.hL : ape.hK;
               this.c.a(this.g, this.h, this.i, $$19, apf.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fli.c $$10 = (fli.c)this.b.a(ix.A, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = arx.d($$18, $$13, $$16) * $$0;
                  double $$20 = arx.d($$18, $$14, $$17) * $$0;
