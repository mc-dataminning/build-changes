...
public class fli {
   ...
   private void a(n $$0, wo $$1) {
      this.b.m.d().a(wo.i().b(wo.c("debug.prefix").a($$0, n.r)).b(wn.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(wo.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dgf)MoreObjects.firstNonNull(this.b.r.i(), dgf.b)).b());
               }
            ...
            case 81:
               ...
               fot $$3 = this.b.m.d();
               $$3.a(wo.c("debug.reload_chunks.help"));
               $$3.a(wo.c("debug.show_hitboxes.help"));
               $$3.a(wo.c("debug.copy_location.help"));
               $$3.a(wo.c("debug.clear_chat.help"));
               $$3.a(wo.c("debug.chunk_boundaries.help"));
               $$3.a(wo.c("debug.advanced_tooltips.help"));
               $$3.a(wo.c("debug.inspect.help"));
               $$3.a(wo.c("debug.profiling.help"));
               $$3.a(wo.c("debug.creative_spectator.help"));
               $$3.a(wo.c("debug.pause_focus.help"));
               $$3.a(wo.c("debug.help.help"));
               $$3.a(wo.c("debug.dump_dynamic_textures.help"));
               $$3.a(wo.c("debug.reload_resourcepacks.help"));
               $$3.a(wo.c("debug.pause.help"));
               $$3.a(wo.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.q.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.aa().a($$5);
               wo $$6 = wo.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new wm(wm.a.b, $$5.toFile().toString())));
   ...
   private void a(dwx $$0, ji $$1, @Nullable tq $$2) {
      StringBuilder $$3 = new StringBuilder(gr.a($$0));
      if ($$2 != null) {
         $$3.append($$2);
      }
   ...
   private void a(aku $$0, fba $$1, @Nullable tq $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = uf.c((un)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         this.b.aP().b();
         boolean $$5 = fep.a(flj.Q().aO().h(), 292);
         if (this.d > 0L) {
            if (!fep.a(flj.Q().aO().h(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (fep.a(flj.Q().aO().h(), 67) && $$5) {
            this.g = true;
            this.d = af.c();
            this.e = af.c();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.z instanceof fxv) || ((fxv)$$6).u <= af.c() - 20L)) {
            if (this.b.n.P.a($$1, $$2)) {
               this.b.aO().g();
            ...
            if (this.b.n.M.a($$1, $$2)) {
               ...
               flr.a(this.b.q, this.b.h(), $$0x -> this.b.execute(() -> this.b.m.d().a($$0x)));
               return;
            }
         }

         if ($$3 != 0) {
            boolean $$7 = $$6 == null || !($$6.aL_() instanceof fpb) || !((fpb)$$6.aL_()).c();
            if ($$7) {
               if (fuk.s() && $$1 == 66 && this.b.aY().a() && this.b.n.w().c()) {
                  boolean $$8 = this.b.n.av().c() == fll.a;
                  this.b.n.av().a(fll.a(this.b.n.av().c().a() + 1));
                  this.b.n.az();
                  if ($$6 != null) {
                     $$6.e($$8);
                  }
         ...
         label197: {
            ...
            label153:
            if (!$$13) {
               if (this.b.z instanceof fuf $$14 && !$$14.m()) {
                  break label153;
               }
