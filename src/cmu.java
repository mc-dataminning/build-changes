   ...
   public void a(arq $$0) {
      ...
      if ($$1 != null) {
         if (this.h > 25) {
            ...
            fex $$2 = new fex($$1.dz() - this.a.dz(), 0.0, $$1.dF() - this.a.dF()).d();
            fex $$3 = new fex((double)azm.a(this.a.dK() * (float) (Math.PI / 180.0)), 0.0, (double)(-azm.b(this.a.dK() * (float) (Math.PI / 180.0)))).d();
            float $$4 = (float)$$3.b($$2);
         ...
         if ($$1 != null) {
            this.a.t().a(cmx.i);
            this.a.t().b(cmx.i).a(new fex($$1.dz(), $$1.dB(), $$1.dF()));
         }
      }
   }
