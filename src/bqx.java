...
public abstract class bqx<R extends Runnable> implements bqe, brd<R>, Executor {
   ...
   @Override
   public List<bqb> bw() {
      return ImmutableList.of(bqb.a(this.b + "-pending-tasks", bqa.b, this::by));
   }
