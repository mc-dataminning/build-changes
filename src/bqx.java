...
public class bqx implements bqy {
   ...
   private static final bqx k = new bqx();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bqw $$0) {
      URL $$1 = bqx.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bqw $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bra a = new bra(() -> bqx.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bqx.this.l && $$0.getState() == RecordingState.STOPPED) {
