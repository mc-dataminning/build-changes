...
public interface bqx<T extends Runnable> {
   @Nullable
   Runnable a();
   ...
   public static final class a implements bqx<bqx.c> {
   ...
   public static final class b implements bqx<Runnable> {
      private final Queue<Runnable> a;
