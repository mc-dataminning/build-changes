...
public abstract class dja extends djn {
   ...
   public static dwy a(dfo $$0, ji $$1) {
      ji $$2 = $$1.e();
      dwy $$3 = $$0.a_($$2);
      return drd.o($$3) ? djp.cz.m() : ((dmo)djp.cy).b($$0, $$1);
   }
   ...
   protected abstract boolean g(dwy var1);
   ...
   protected void b(dwy $$0, dgj $$1, ji $$2, dwy $$3, boolean $$4) {
      if (!$$3.a($$0.b())) {
         if (a($$1)) {
            Optional<etz> $$5 = etz.a((dgk)$$1, $$2, jn.a.a);
            if ($$5.isPresent()) {
               $$5.get().a($$1);
               return;
            }
   ...
   public static boolean a(dgj $$0, ji $$1, jn $$2) {
      dwy $$3 = $$0.a_($$1);
      return !$$3.l() ? false : a($$0, $$1).a((dgm)$$0, $$1) || b($$0, $$1, $$2);
   }

   private static boolean b(dgj $$0, ji $$1, jn $$2) {
      if (!a($$0)) {
         return false;
      } else {
         ji.a $$3 = $$1.k();
         ...
         if (!$$4) {
            ...
            return etz.a((dgk)$$0, $$1, $$6).isPresent();
         }
      }
   }
}
