...
public class cic extends chx {
   private static final bvn ch = bvr.z.n().a(0.5F).b(0.2975F);
   public float bZ;
   public float ca;
   public float cb;
   public float cd;
   ...
   public cic(bvr<? extends cic> $$0, dhi $$1) {
      super($$0, $$1);
      this.a(euo.j, 0.0F);
   }
   ...
   protected void B() {
      ...
      this.bT.a(1, new cdx(this, 1.4));
      this.bT.a(2, new ccq(this, 1.0));
      this.bT.a(3, new cem(this, 1.0, $$0 -> $$0.a(ayd.ap), false));
   ...
   public static bxn.a p() {
      return chx.gt().a(bxo.s, 4.0).a(bxo.v, 0.25);
   }
   ...
   @Nullable
   public cic b(ash $$0, bvb $$1) {
      return bvr.z.a($$0, bvq.e);
   }
