...
public class cic extends bts implements cjw {
   private static final Logger cd = LogUtils.getLogger();
   public static final akk<Integer> b = ako.a(cic.class, akm.b);
   private static final ceh ce = ceh.a().a(64.0);
   ...
   public int d = -1;
   private final cia[] ck;
   public final cia e;
   private final cia cl;
   private final cia cm;
   private final cia cn;
   private final cia co;
   private final cia cp;
   private final cia cq;
   private final cia cr;
   public float bX;
   public float bY;
   public boolean bZ;
   public int ca;
   ...
   private dvy cs;
   private iz ct = iz.c;
   private final cit cu;
   private int cv = 100;
   private float cw;
   private final eoi[] cx = new eoi[24];
   private final int[] cz = new int[24];
   private final eog cA = new eog();

   public cic(btb<? extends cic> $$0, dbz $$1) {
      super(btb.F, $$1);
      this.e = new cia(this, "head", 1.0F, 1.0F);
      this.cl = new cia(this, "neck", 3.0F, 3.0F);
      this.cm = new cia(this, "body", 5.0F, 3.0F);
      this.cn = new cia(this, "tail", 2.0F, 2.0F);
      this.co = new cia(this, "tail", 2.0F, 2.0F);
      this.cp = new cia(this, "tail", 2.0F, 2.0F);
      this.cq = new cia(this, "wing", 4.0F, 2.0F);
      this.cr = new cia(this, "wing", 4.0F, 2.0F);
      this.ck = new cia[]{this.e, this.cl, this.cm, this.cn, this.co, this.cp, this.cq, this.cr};
      this.t(this.eR());
      this.ag = true;
      this.au = true;
      this.cu = new cit(this);
   }
         ...
         if (this.gg()) {
            ...
            if (this.dP().B) {
               ...
               if ($$9 != null) {
                  ...
                  this.r(ayz.g(this.dF()));
                  evs $$16 = $$9.a(this.du(), this.dw(), this.dA()).d();
                  evs $$17 = new evs((double)ayz.a(this.dF() * (float) (Math.PI / 180.0)), this.ds().d, (double)(-ayz.b(this.dF() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new evs(0.0, 0.0, -1.0));
                  if (this.bZ) {
                     this.a(btv.a, this.ds().a(0.8F));
                  } else {
            ...
            this.aY = this.dF();
            evs[] $$24 = new evs[this.ck.length];

            for (int $$25 = 0; $$25 < this.ck.length; $$25++) {
               $$24[$$25] = new evs(this.ck[$$25].du(), this.ck[$$25].dw(), this.ck[$$25].dA());
            }
            ...
            if (!this.dP().B && this.aO == 0) {
               this.b(this.dP().a(this, this.cq.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bta.e));
               this.b(this.dP().a(this, this.cr.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bta.e));
               this.c(this.dP().a(this, this.e.cK().g(1.0), bta.e));
               this.c(this.dP().a(this, this.cl.cK().g(1.0), bta.e));
            }
   ...
   private void a(cia $$0, double $$1, double $$2, double $$3) {
   ...
   private void gq() {
      ...
      if (this.ah.a(10) == 0) {
         List<cib> $$0 = this.dP().a(cib.class, this.cK().g(32.0));
         cib $$1 = null;
   ...
   private void b(List<bsv> $$0) {
      ...
      for (bsv $$3 : $$0) {
         if ($$3 instanceof btq) {
            ...
            if (!this.cu.a().a() && ((btq)$$3).en() < $$3.ai - 2) {
               $$3.a(this.dQ().b((btq)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bsv> $$0) {
      for (bsv $$1 : $$0) {
         if ($$1 instanceof btq) {
            $$1.a(this.dQ().b((btq)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dsd $$13 = this.dP().a_($$12);
               if (!$$13.i() && !$$13.a(awp.aD)) {
                  if (this.dP().ab().b(dbv.c) && !$$13.a(awp.aC)) {
   ...
   public boolean a(cia $$0, bro $$1, float $$2) {
      if (this.cu.a().i() == cis.j) {
         return false;
      } else {
         $$2 = this.cu.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof cmy || $$1.a(awr.z)) {
               float $$3 = this.eA();
               this.g($$1, $$2);
   ...
   protected boolean g(bro $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void eg() {
      ...
      if (this.dP() instanceof arf) {
         if (this.ca > 150 && this.ca % 5 == 0 && $$3) {
            btg.a((arf)this.dP(), this.dn(), ayz.d((float)$$4 * 0.08F));
         }
      ...
      this.a(btv.a, new evs(0.0, 0.1F, 0.0));
      if (this.ca == 200 && this.dP() instanceof arf) {
         if ($$3) {
            btg.a((arf)this.dP(), this.dn(), ayz.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cx[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(this.dP().z_() + 10, this.dP().a(dxv.a.f, new iz($$3, 0, $$4)).v() + $$1);
            this.cx[$$0] = new eoi($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eoi $$5 = new eoi(ayz.a($$0), ayz.a($$1), ayz.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eok a(int $$0, int $$1, @Nullable eoi $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eoi $$4 = this.cx[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eok a(eoi $$0, eoi $$1) {
      ...
      return new eok($$2, new iz($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(us $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cu.a(cis.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      cim $$3 = this.cu.a();
      cis<? extends cim> $$4 = $$3.i();
      double $$7;
      if ($$4 == cis.d || $$4 == cis.e) {
         iz $$5 = this.dP().a(dxv.a.f, eay.a(this.ct));
   ...
   public evs F(float $$0) {
      cim $$1 = this.cu.a();
      cis<? extends cim> $$2 = $$1.i();
      evs $$8;
      if ($$2 == cis.d || $$2 == cis.e) {
         iz $$3 = this.dP().a(dxv.a.f, eay.a(this.ct));
   ...
   public void a(cib $$0, iz $$1, bro $$2) {
      cmy $$3;
