...
public class bev extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         bao.a(this.a("minecraft:trident", bev::c), this.a("minecraft:arrow", bev::a), this.a("minecraft:spectral_arrow", bev::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bev.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bhv.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bhv.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, bev.a<?> $$1, Type<?> $$2, Type<T> $$3) {
