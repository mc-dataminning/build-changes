...
public class fjs implements gvc {
   private static final long a = 3000L;
   private final fgm b;
   private final List<fjs.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fjs.b> e = new ArrayList<>();
   ...
   public void a(fhx $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fjs.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(gty $$0, gve $$1, float $$2) {
      if ($$1.a() != null) {
         wz $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fjs.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new exa($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fjs.b($$3, $$2, new exa($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(exa a, long b) {
   }

   static class b {
      private final wz a;
      private final float b;
      private final List<fjs.a> c = new ArrayList<>();

      public b(wz $$0, float $$1, exa $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fjs.a($$2, ad.c()));
      }
