...
public class fjs extends fhf {
   ...
   private static final ImmutableList<doj> q = ImmutableList.copyOf(doj.values());
   private static final ImmutableList<doj> r = q.stream().filter($$0 -> $$0 != doj.d).collect(ImmutableList.toImmutableList());
   private final dlu t;
   private dew u = dew.a;
   private dgm v = dgm.a;
   private doj w = doj.d;
   ...
   private fbg P;
   private fbg Q;
   private fbn<Boolean> R;
   private fbn<dew> S;
   private fbn<Boolean> T;
   private fbn<Boolean> U;
   ...
   @Override
   protected void aO_() {
      this.c((fbg)fbg.a(vt.d, $$0x -> this.o()).a(this.g / 2 - 4 - 150, 210, 150, 20).a());
      ...
      this.y = this.t.C();
      this.z = this.t.D();
      this.K = this.c((fbg)fbg.a(vu.c("structure_block.button.save"), $$0x -> {
         if (this.t.t() == doj.a) {
            this.a(dlu.a.b);
            this.f.a(null);
         }
      }).a(this.g / 2 + 4 + 100, 185, 50, 20).a());
      this.L = this.c((fbg)fbg.a(vu.c("structure_block.button.load"), $$0x -> {
         if (this.t.t() == doj.b) {
            this.a(dlu.a.c);
            this.f.a(null);
         }
      ...
      this.c(
         fbn.<doj>a($$0x -> vu.c("structure_block.mode." + $$0x.c()))
            .a(r, q)
            .a()
            .a(this.w)
      ...
      this.Q = this.c((fbg)fbg.a(vu.c("structure_block.button.detect_size"), $$0x -> {
         if (this.t.t() == doj.a) {
            this.a(dlu.a.d);
            this.f.a(null);
         }
      }).a(this.g / 2 + 4 + 100, 120, 50, 20).a());
      this.R = this.c(fbn.b(!this.t.u()).a().a(this.g / 2 + 4 + 100, 160, 50, 20, m, ($$0x, $$1x) -> this.t.a(!$$1x)));
      this.S = this.c(fbn.<dew>a(dew::b).a(dew.values()).a().a(this.u).a(this.g / 2 - 20, 185, 40, 20, vu.b("MIRROR"), ($$0x, $$1x) -> this.t.a($$1x)));
      this.T = this.c(fbn.b(this.t.C()).a().a(this.g / 2 + 4 + 100, 80, 50, 20, o, ($$0x, $$1x) -> this.t.d($$1x)));
      this.U = this.c(fbn.b(this.t.D()).a().a(this.g / 2 + 4 + 100, 80, 50, 20, p, ($$0x, $$1x) -> this.t.e($$1x)));
      this.M = this.c((fbg)fbg.a(vu.b("0"), $$0x -> {
         this.t.a(dgm.a);
         this.H();
      }).a(this.g / 2 - 1 - 40 - 1 - 40 - 20, 185, 40, 20).a());
      this.N = this.c((fbg)fbg.a(vu.b("90"), $$0x -> {
         this.t.a(dgm.b);
         this.H();
      }).a(this.g / 2 - 1 - 40 - 20, 185, 40, 20).a());
      this.O = this.c((fbg)fbg.a(vu.b("180"), $$0x -> {
         this.t.a(dgm.c);
         this.H();
      }).a(this.g / 2 + 1 + 20, 185, 40, 20).a());
      this.P = this.c((fbg)fbg.a(vu.b("270"), $$0x -> {
         this.t.a(dgm.d);
         this.H();
      }).a(this.g / 2 + 1 + 40 + 1 + 20, 185, 40, 20).a());
      this.A = new fbp(this.i, this.g / 2 - 152, 40, 300, 20, vu.c("structure_block.structure_name")) {
         @Override
         public boolean a(char $$0, int $$1) {
            return !fjs.this.a(this.a(), $$0, this.e()) ? false : super.a($$0, $$1);
         }
      };
      this.A.f(128);
      this.A.a(this.t.c());
      this.d(this.A);
      ib $$0 = this.t.f();
      this.B = new fbp(this.i, this.g / 2 - 152, 80, 80, 20, vu.c("structure_block.position.x"));
      this.B.f(15);
      this.B.a(Integer.toString($$0.u()));
      this.d(this.B);
      this.C = new fbp(this.i, this.g / 2 - 72, 80, 80, 20, vu.c("structure_block.position.y"));
      this.C.f(15);
      this.C.a(Integer.toString($$0.v()));
      this.d(this.C);
      this.D = new fbp(this.i, this.g / 2 + 8, 80, 80, 20, vu.c("structure_block.position.z"));
      this.D.f(15);
      this.D.a(Integer.toString($$0.w()));
      this.d(this.D);
      jg $$1 = this.t.j();
      this.E = new fbp(this.i, this.g / 2 - 152, 120, 80, 20, vu.c("structure_block.size.x"));
      this.E.f(15);
      this.E.a(Integer.toString($$1.u()));
      this.d(this.E);
      this.F = new fbp(this.i, this.g / 2 - 72, 120, 80, 20, vu.c("structure_block.size.y"));
      this.F.f(15);
      this.F.a(Integer.toString($$1.v()));
      this.d(this.F);
      this.G = new fbp(this.i, this.g / 2 + 8, 120, 80, 20, vu.c("structure_block.size.z"));
      this.G.f(15);
      this.G.a(Integer.toString($$1.w()));
      this.d(this.G);
      this.H = new fbp(this.i, this.g / 2 - 152, 120, 80, 20, vu.c("structure_block.integrity.integrity"));
      this.H.f(15);
      this.H.a(this.V.format((double)this.t.v()));
      this.d(this.H);
      this.I = new fbp(this.i, this.g / 2 - 72, 120, 80, 20, vu.c("structure_block.integrity.seed"));
      this.I.f(31);
      this.I.a(Long.toString(this.t.w()));
      this.d(this.I);
      this.J = new fbp(this.i, this.g / 2 - 152, 120, 240, 20, vu.c("structure_block.custom_data"));
      this.J.f(128);
      this.J.a(this.t.s());
      this.d(this.J);
      this.H();
