...
public class fjs {
   ...
   static class b {
      static final Optional<fjs> a = Optional.ofNullable(a());
      ...
      private static fjs a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new fjs();
      }
   }
}
