...
public class xa {
   ...
   public static Optional<xl> a(@Nullable ee $$0, Optional<wx> $$1, @Nullable brw $$2, int $$3) throws CommandSyntaxException {
      return $$1.isPresent() ? Optional.of(a($$0, $$1.get(), $$2, $$3)) : Optional.empty();
   }

   public static xl a(@Nullable ee $$0, wx $$1, @Nullable brw $$2, int $$3) throws CommandSyntaxException {
      if ($$3 > 100) {
         return $$1.f();
      } else {
         xl $$4 = $$1.b().a($$0, $$2, $$3 + 1);
   ...
   private static xu a(@Nullable ee $$0, xu $$1, @Nullable brw $$2, int $$3) throws CommandSyntaxException {
      xd $$4 = $$1.i();
      if ($$4 != null) {
         wx $$5 = $$4.a(xd.a.a);
         if ($$5 != null) {
