...
public class xa {
   public static <T extends wr> xa.b a(wt<T> $$0) {
      return a(new wp<T>($$0));
   }

   private static xa.b a(ChannelInboundHandler $$0) {
      return $$1 -> {
   ...
   public static <T extends wr> xa.d b(wt<T> $$0) {
      return a(new wq<T>($$0));
   }

   private static xa.d a(ChannelOutboundHandler $$0) {
      return $$1 -> $$1.pipeline().replace($$1.name(), "encoder", $$0);
   }

   public static class a extends ChannelDuplexHandler {
      public void channelRead(ChannelHandlerContext $$0, Object $$1) {
         if (!($$1 instanceof ByteBuf) && !($$1 instanceof zs)) {
            $$0.fireChannelRead($$1);
         } else {
