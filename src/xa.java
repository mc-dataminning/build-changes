...
public record xa<S>(List<xa.a<S>> a) {
   public static <S> xa<S> a(ParseResults<S> $$0) {
   ...
   private static <S> List<xa.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<xa.a<S>> $$2 = new ArrayList<>();
