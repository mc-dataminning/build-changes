...
public class gdm extends fys {
   ...
   private final fwo M = new fwo(this);
   @Nullable
   private final fys N;
   gdl O;
   ftj P;
   private String Q = "";
   private gdm.a R = gdm.a.a;
   private fta S;
   private fta T;
   private fta U;
   private fta V;
   ...
   protected void aO_() {
      this.M.a(c, this.p);
      this.O = new gdl(this, this.m, this.n, this.E() - 88, 88, 36);
      int $$0 = this.O.a() / 3;
      int $$1 = this.O.u();
      int $$2 = this.O.v();
      this.S = this.c(fta.a(u, $$0x -> this.a(gdm.a.a)).a($$1, 45, $$0, 20).a());
      this.T = this.c(fta.a(v, $$0x -> this.a(gdm.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.U = this.c(fta.a(w, $$0x -> this.a(gdm.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.P != null ? this.P.a() : "";
      this.P = new ftj(this.p, this.F() + 28, 74, 200, 15, A) {
         @Override
         protected xm d() {
            return !gdm.this.P.a().isEmpty() && gdm.this.O.b() ? super.d().f(", ").b(gdm.B) : super.d();
         }
      };
      this.P.f(16);
      this.P.g(true);
      ...
      this.c(this.P);
      this.d(this.O);
      this.V = this.c(fta.a(E, fxp.b(this, ayh.o)).a(this.n / 2 - 100, 64 + this.m(), 200, 20).a());
      this.a(this.R);
      this.M.b(fta.a(wx.d, $$0x -> this.aL_()).a(200).a());
      this.M.a($$1x -> {
   ...
   public void b(fsm $$0, int $$1, int $$2, float $$3) {
      super.b($$0, $$1, $$2, $$3);
      int $$4 = this.F() + 3;
      $$0.a(grc::H, d, $$4, 64, 236, this.m() + 16);
      $$0.a(grc::H, s, $$4 + 10, 76, 12, 12);
   }
