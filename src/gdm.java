...
public class gdm {
   private static final gdy a = gdy.t(new alf("textures/map/map_background.png"));
   private static final gdy b = gdy.t(new alf("textures/map/map_background_checkerboard.png"));
   ...
   private final ffh au;
   private cur av = cur.l;
   private cur aw = cur.l;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final gix aB;
   private final gjx aC;

   public gdm(ffh $$0, gix $$1, gjx $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(btr $$0, cur $$1, cuo $$2, boolean $$3, faa $$4, gdq $$5, int $$6) {
      if (!$$1.e()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dP(), $$6, gos.d, $$0.al() + $$2.ordinal());
      }
   }
   ...
   private void a(faa $$0, gdq $$1, int $$2, btl $$3) {
      goe $$4 = (goe)this.aB.<gcp>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == btl.b ? 1.0F : -1.0F;
   ...
   private void a(faa $$0, gdq $$1, int $$2, float $$3, btl $$4, float $$5, cur $$6) {
      float $$7 = $$4 == btl.b ? 1.0F : -1.0F;
   ...
   private void a(faa $$0, gdq $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = ayz.c($$5);
   ...
   private void a(faa $$0, gdq $$1, int $$2, cur $$3) {
      ...
      epk $$4 = $$3.a(km.B);
      epm $$5 = cuz.a($$4, this.au.r);
      fae $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(faa $$0, gdq $$1, int $$2, float $$3, float $$4, btl $$5) {
      boolean $$6 = $$5 != btl.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = ayz.c($$4);
   ...
   private void a(faa $$0, float $$1, btl $$2, cur $$3) {
   ...
   private void a(faa $$0, float $$1, btl $$2, cur $$3, float $$4) {
      this.b($$0, $$2, $$4);
   ...
   private void a(faa $$0, btl $$1, float $$2) {
      int $$3 = $$1 == btl.b ? 1 : -1;
   ...
   private void b(faa $$0, btl $$1, float $$2) {
      int $$3 = $$1 == btl.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, faa $$1, gdq.a $$2, gcs $$3, int $$4) {
      float $$5 = $$3.z($$0);
      bqv $$6 = (bqv)MoreObjects.firstNonNull($$3.aK, bqv.a);
      ...
      if ($$8.d) {
         float $$11 = $$6 == bqv.a ? $$5 : 0.0F;
         float $$12 = 1.0F - ayz.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bqv.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bqv.b ? $$5 : 0.0F;
         float $$14 = 1.0F - ayz.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bqv.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static gdm.a a(gcs $$0) {
      cur $$1 = $$0.eX();
      cur $$2 = $$0.eY();
      boolean $$3 = $$1.a(cuu.ou) || $$2.a(cuu.ou);
      boolean $$4 = $$1.a(cuu.vT) || $$2.a(cuu.vT);
      if (!$$3 && !$$4) {
         return gdm.a.a;
      } else if ($$0.fv()) {
         return b($$0);
      } else {
         return a($$1) ? gdm.a.b : gdm.a.a;
      }
   }

   private static gdm.a b(gcs $$0) {
      cur $$1 = $$0.fx();
      bqv $$2 = $$0.fw();
      if (!$$1.a(cuu.ou) && !$$1.a(cuu.vT)) {
         return $$2 == bqv.a && a($$0.eY()) ? gdm.a.b : gdm.a.a;
      } else {
         return gdm.a.a($$2);
      }
   }
   ...
   private static boolean a(cur $$0) {
      return $$0.a(cuu.vT) && cte.j($$0);
   }

   private void a(gcp $$0, float $$1, float $$2, bqv $$3, float $$4, cur $$5, float $$6, faa $$7, gdq $$8, int $$9) {
      if (!$$0.gA()) {
         boolean $$10 = $$3 == bqv.a;
         btl $$11 = $$10 ? $$0.fu() : $$0.fu().e();
         $$7.a();
         if ($$5.e()) {
            if ($$10 && !$$0.ch()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            this.a($$0, $$5, $$13 ? cuo.e : cuo.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == btl.b;
            if ($$0.fv() && $$0.fy() > 0 && $$0.fw() == $$3) {
               int $$24 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cuo.e : cuo.d, !$$23, $$7, $$8, $$9);
         }
