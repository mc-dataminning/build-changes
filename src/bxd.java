...
public abstract class bxd extends chx implements bwn {
   public static final int bZ = 144;
   private static final int cd = 2;
   private static final int ce = 3;
   private static final int cf = 1;
   protected static final alc<Byte> ca = alg.a(bxd.class, ale.a);
   protected static final alc<Optional<UUID>> cb = alg.a(bxd.class, ale.r);
   private boolean cg;

   protected bxd(bvr<? extends bxd> $$0, dhi $$1) {
      super($$0, $$1);
   }
   ...
   @Override
   public void a(bua $$0) {
      if (this.dW() instanceof ash $$1 && $$1.N().b(dhe.n) && this.ah_() instanceof asi $$2) {
         $$2.a(this.eQ().a());
      }
   ...
   public boolean gq() {
      bwg $$0 = this.ah_();
      return $$0 != null && this.g((bvk)this.ah_()) >= 144.0;
   }
   ...
   public class a extends cdx {
      public a(final double param3, final ayk<buc> bxd.this) {
         super(bxd.this, $$1, $$2);
      }
