public class bxd {
   ...
   public void a() {
      ...
      if (this.i.fJ()) {
         ...
         $$3 = azz.h($$0, (float) (Math.PI / 12), (float) (Math.PI / 9));
         $$4 = azz.h($$0, (float) (-Math.PI / 12), (float) (-Math.PI / 2));
         $$5 = 0.0F;
      } else if (this.i.ch()) {
   ...
   public float a(float $$0) {
      return azz.h($$0, this.f, this.c);
   }

   public float b(float $$0) {
      return azz.h($$0, this.g, this.d);
   }

   public float c(float $$0) {
      return azz.h($$0, this.h, this.e);
   }
}
