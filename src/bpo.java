...
public interface bpo<T, F> {
   ...
   public static final class a implements bpo<bpo.b, Runnable> {
   ...
   public static final class c<T> implements bpo<T, T> {
