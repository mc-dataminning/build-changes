...
public class bpo {
   ...
   private static void a(bpw $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(bpr $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<bpx> $$0) {
      JsonObject $$1 = new JsonObject();
      bqb<bpx> $$2 = bqb.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(bpx::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         bqb<bpx> $$6 = bqb.a((List<bpx>)$$4);
         $$5.addProperty("count", $$6.d());
         $$5.addProperty("durationNanosTotal", $$6.f().toNanos());
         $$5.addProperty("durationNanosAvg", $$6.f().toNanos() / (long)$$6.d());
         JsonObject $$7 = af.a(new JsonObject(), $$1xx -> $$5.add("durationNanosPercentiles", $$1xx));
         $$6.e().forEach(($$1xx, $$2xx) -> $$7.addProperty("p" + $$1xx, $$2xx));
         Function<bpx, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement b(List<Pair<dzu, bqb<bpq>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bqb)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = af.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dzu, bqb<bpq>> $$3 : $$0) {
         bqb<bpq> $$4 = (bqb<bpq>)$$3.getSecond();
         JsonObject $$5 = af.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dzu)$$3.getFirst()).toString());
         $$5.addProperty("count", $$4.d());
         $$5.addProperty("durationNanosTotal", $$4.f().toNanos());
         $$5.addProperty("durationNanosAvg", $$4.f().toNanos() / (long)$$4.d());
         JsonObject $$6 = af.a(new JsonObject(), $$1x -> $$5.add("durationNanosPercentiles", $$1x));
         $$4.e().forEach(($$1x, $$2x) -> $$6.addProperty("p" + $$1x, $$2x));
         Function<bpq, JsonElement> $$7 = $$0x -> {
   ...
   private JsonElement a(bpy.a $$0) {
      JsonArray $$1 = new JsonArray();
      $$0.a().forEach(($$1x, $$2) -> $$1.add(af.a(new JsonObject(), $$2x -> {
   ...
   private JsonElement c(List<bpz> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bpd.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bpm $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), bpo::a));
      $$1.add("chunksWritten", this.a($$0.m(), bpo::a));
      return $$1;
   }

   private JsonElement a(bpt.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bpm $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), bpo::a));
      $$1.add("received", this.a($$0.k(), bpo::a));
      return $$1;
   }

   private <T> JsonElement a(bpv<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<bps> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bps>, ToDoubleFunction<bps>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bps::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bps::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bps::c));
      return $$1;
   }
}
