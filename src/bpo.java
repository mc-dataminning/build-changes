...
public class bpo {
   ...
   private JsonElement a(List<Pair<dyr, bqa<bpq>>> $$0) {
      JsonObject $$1 = new JsonObject();
      ...
      for (Pair<dyr, bqa<bpq>> $$3 : $$0) {
         bqa<bpq> $$4 = (bqa<bpq>)$$3.getSecond();
         JsonObject $$5 = ae.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dyr)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bpy> $$0) {
      if ($$0.isEmpty()) {
   ...
   private JsonElement c(List<bps> $$0) {
      JsonObject $$1 = new JsonObject();
