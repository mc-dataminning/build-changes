...
public class ets {
   public static List<euu> a(ets.a... $$0) {
      for (ets.a $$1 : $$0) {
         a($$1.j);
      }

      List<euu> $$2 = Lists.newArrayList();

      for (ets.a $$3 : $$0) {
         $$2.add(new euu($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(euu::a));
      return $$2;
   }
   ...
   public static List<euu> a() {
      return a(ets.a.values());
   }
