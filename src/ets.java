...
public class ets implements gdl {
   ...
   public void a(erz $$0) {
      ...
      if (this.d && !this.c.isEmpty()) {
         ehh $$1 = new ehh(this.b.s.dq(), this.b.s.du(), this.b.s.dw());
         ehh $$2 = new ehh(0.0, 0.0, -1.0).a(-this.b.s.dD() * (float) (Math.PI / 180.0)).b(-this.b.s.dB() * (float) (Math.PI / 180.0));
         ehh $$3 = new ehh(0.0, 1.0, 0.0).a(-this.b.s.dD() * (float) (Math.PI / 180.0)).b(-this.b.s.dB() * (float) (Math.PI / 180.0));
         ehh $$4 = $$2.c($$3);
         int $$5 = 0;
         int $$6 = 0;
         ...
         for (ets.a $$10 : this.c) {
            ...
            int $$22 = asb.d(asb.b(255.0F, 75.0F, (float)(ac.b() - $$10.b()) / (float)(3000.0 * $$7)));
   ...
   @Override
   public void a(gci $$0, gdn $$1) {
      if ($$1.a() != null) {
         tl $$2 = $$1.a();
         if (!this.c.isEmpty()) {
            for (ets.a $$3 : this.c) {
               if ($$3.a().equals($$2)) {
                  $$3.a(new ehh($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new ets.a($$2, new ehh($$0.h(), $$0.i(), $$0.j())));
      }
   }
