...
public class ets {
   ...
   static class b {
      static final Optional<ets> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static ets a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ets();
      }
   }
}
