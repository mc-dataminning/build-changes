...
public class ets {
   ...
   static class a implements ets.i {
      @Override
      public boolean a(ets.v $$0) {
         return $$0.c[jb.f.d()] && !$$0.b[jb.f.d()].d;
      }

      @Override
      public ets.r a(jb $$0, ets.v $$1, azv $$2) {
         $$1.d = true;
         $$1.b[jb.f.d()].d = true;
         return new ets.k($$0, $$1);
      }
   }

   static class b implements ets.i {
      @Override
      public boolean a(ets.v $$0) {
      ...
      public ets.r a(jb $$0, ets.v $$1, azv $$2) {
         ...
         return new ets.l($$0, $$1);
      }
   }

   static class c implements ets.i {
      @Override
      public boolean a(ets.v $$0) {
      ...
      public ets.r a(jb $$0, ets.v $$1, azv $$2) {
         $$1.d = true;
         $$1.b[jb.b.d()].d = true;
         return new ets.m($$0, $$1);
      }
   }

   static class d implements ets.i {
      @Override
      public boolean a(ets.v $$0) {
      ...
      public ets.r a(jb $$0, ets.v $$1, azv $$2) {
         ...
         return new ets.n($$0, $$1);
      }
   }

   static class e implements ets.i {
      @Override
      public boolean a(ets.v $$0) {
      ...
      public ets.r a(jb $$0, ets.v $$1, azv $$2) {
         ...
         $$3.d = true;
         $$3.b[jb.c.d()].d = true;
         return new ets.o($$0, $$3);
      }
   }

   static class f implements ets.i {
      @Override
      public boolean a(ets.v $$0) {
         return true;
      }
      ...
      public ets.r a(jb $$0, ets.v $$1, azv $$2) {
         $$1.d = true;
         return new ets.s($$0, $$1, $$2);
      }
   }

   static class g implements ets.i {
      @Override
      public boolean a(ets.v $$0) {
      ...
      public ets.r a(jb $$0, ets.v $$1, azv $$2) {
         $$1.d = true;
         return new ets.t($$0, $$1);
      }
   }

   public static class h extends ets.r {
      ...
      private ets.v G;
      private ets.v H;
      private final List<ets.r> I = Lists.newArrayList();

      public h(azv $$0, int $$1, int $$2, jb $$3) {
         super(erz.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ets.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ets.p($$3, this.G));
         this.I.add(new ets.j($$3, this.H));
         List<ets.i> $$5 = Lists.newArrayList();
         $$5.add(new ets.b());
         $$5.add(new ets.d());
         $$5.add(new ets.e());
         $$5.add(new ets.a());
         ...
         era $$10 = era.a(this.b(1, 1, 1), this.b(23, 8, 21));
         era $$11 = era.a(this.b(34, 1, 1), this.b(56, 8, 21));
         era $$12 = era.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ets.u($$3, $$10, $$13++));
         this.I.add(new ets.u($$3, $$11, $$13++));
         this.I.add(new ets.q($$3, $$12));
      }
      ...
      private List<ets.v> b(azv $$0) {
         ets.v[] $$1 = new ets.v[75];
         ...
         ets.v $$23 = new ets.v(1003);
         ets.v $$24 = new ets.v(1001);
         ets.v $$25 = new ets.v(1002);
         $$1[v].a(jb.b, $$23);
         $$1[w].a(jb.d, $$24);
         $$1[x].a(jb.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ets.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dkg $$2, azv $$3, era $$4) {
         int $$5 = 24;
      ...
      private void a(dkg $$0, azv $$1, era $$2) {
      ...
      private void b(dkg $$0, azv $$1, era $$2) {
      ...
      private void c(dkg $$0, azv $$1, era $$2) {
      ...
      private void d(dkg $$0, azv $$1, era $$2) {
      ...
      private void e(dkg $$0, azv $$1, era $$2) {
      ...
      private void f(dkg $$0, azv $$1, era $$2) {
   ...
   interface i {
      boolean a(ets.v var1);

      ets.r a(jb var1, ets.v var2, azv var3);
   }

   public static class j extends ets.r {
      public j(jb $$0, ets.v $$1) {
         super(erz.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dkg $$0, dkd $$1, ecm $$2, azv $$3, era $$4, dio $$5, iv $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dmo.cr.m(), dmo.cr.m(), false);
   ...
   public static class k extends ets.r {
      public k(jb $$0, ets.v $$1) {
         super(erz.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ets.r {
      public l(jb $$0, ets.v $$1) {
         super(erz.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ets.r {
      public m(jb $$0, ets.v $$1) {
         super(erz.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ets.r {
      public n(jb $$0, ets.v $$1) {
         super(erz.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ets.r {
      public o(jb $$0, ets.v $$1) {
         super(erz.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ets.r {
      public p(jb $$0, ets.v $$1) {
         super(erz.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ets.r {
      public q(jb $$0, era $$1) {
         super(erz.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends erm {
      protected static final eao b = dmo.iB.m();
      protected static final eao c = dmo.iC.m();
      protected static final eao d = dmo.iD.m();
      protected static final eao h = c;
      protected static final eao i = dmo.iK.m();
      protected static final boolean j = true;
      protected static final eao k = dmo.J.m();
      protected static final Set<dmm> l = ImmutableSet.builder().add(dmo.ee).add(dmo.je).add(dmo.nC).add(k.b()).build();
      ...
      public r(erz $$0, jb $$1, int $$2, era $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(erz $$0, int $$1, jb $$2, ets.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static era a(jb $$0, ets.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         era $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dkg $$0, era $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  eao $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dkg $$0, era $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dkg $$0, era $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, eao $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(era $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dkg $$0, era $$1, int $$2, int $$3, int $$4) {
         iv $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cnz $$6 = bwr.M.a($$0.a(), bwq.d);
            if ($$6 != null) {
               $$6.c($$6.eT());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.du()), bwq.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ets.r {
      private int a;

      public s(jb $$0, ets.v $$1, azv $$2) {
         super(erz.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ets.r {
      public t(jb $$0, ets.v $$1) {
         super(erz.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ets.r {
      private int a;

      public u(jb $$0, era $$1, int $$2) {
         super(erz.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
