...
public class dfw {
   public static final Codec<dfw> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dfu.a.fieldOf("buy").forGetter($$0x -> $$0x.c),
               dfu.a.lenientOptionalFieldOf("buyB").forGetter($$0x -> $$0x.d),
               cxg.a.fieldOf("sell").forGetter($$0x -> $$0x.e),
   ...
   public static final zi<wv, dfw> b = zi.a(dfw::a, dfw::a);
   private final dfu c;
   private final Optional<dfu> d;
   private final cxg e;
   private int f;
   private final int g;
   ...
   private dfw(dfu $$0, Optional<dfu> $$1, cxg $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dfw(dfu $$0, cxg $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dfw(dfu $$0, Optional<dfu> $$1, cxg $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dfw(dfu $$0, Optional<dfu> $$1, cxg $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dfw(dfu $$0, Optional<dfu> $$1, cxg $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   private int a(dfu $$0) {
      int $$1 = $$0.b();
      int $$2 = Math.max(0, azu.d((float)($$1 * this.j) * this.k));
      return azu.a($$1 + $$2 + this.i, 1, $$0.d().k());
   }

   public cxg c() {
      return this.d.map(dfu::d).orElse(cxg.j);
   }
   ...
   private static void a(wv $$0, dfw $$1) {
      dfu.b.encode($$0, $$1.d());
      cxg.h.encode($$0, $$1.f());
      dfu.c.encode($$0, $$1.e());
      $$0.a($$1.r());
   ...
   public static dfw a(wv $$0) {
      dfu $$1 = dfu.b.decode($$0);
      cxg $$2 = cxg.h.decode($$0);
      Optional<dfu> $$3 = dfu.c.decode($$0);
      ...
      float $$9 = $$0.readFloat();
      int $$10 = $$0.readInt();
      dfw $$11 = new dfw($$1, $$3, $$2, $$5, $$6, $$7, $$9, $$10);
      if ($$4) {
         $$11.s();
      }
