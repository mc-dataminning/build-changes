...
public class dfx {
   public static final Codec<dfx> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               cxk.b.fieldOf("sell").forGetter($$0x -> $$0x.e),
   ...
   public static final zt<xg, dfx> b = zt.a(dfx::a, dfx::a);
   private final dfv c;
   ...
   private dfx(dfv $$0, Optional<dfv> $$1, cxk $$2, int $$3, int $$4, boolean $$5, int $$6, int $$7, float $$8, int $$9) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public dfx(dfv $$0, cxk $$1, int $$2, int $$3, float $$4) {
      this($$0, Optional.empty(), $$1, $$2, $$3, $$4);
   }

   public dfx(dfv $$0, Optional<dfv> $$1, cxk $$2, int $$3, int $$4, float $$5) {
      this($$0, $$1, $$2, 0, $$3, $$4, $$5);
   }

   public dfx(dfv $$0, Optional<dfv> $$1, cxk $$2, int $$3, int $$4, int $$5, float $$6) {
      this($$0, $$1, $$2, $$3, $$4, $$5, $$6, 0);
   }

   public dfx(dfv $$0, Optional<dfv> $$1, cxk $$2, int $$3, int $$4, int $$5, float $$6, int $$7) {
   ...
   public cxk c() {
      return this.d.map(dfv::d).orElse(cxk.k);
   }
   ...
   private static void a(xg $$0, dfx $$1) {
      dfv.b.encode($$0, $$1.d());
      cxk.i.encode($$0, $$1.f());
      dfv.c.encode($$0, $$1.e());
      $$0.a($$1.r());
   ...
   public static dfx a(xg $$0) {
      dfv $$1 = dfv.b.decode($$0);
      cxk $$2 = cxk.i.decode($$0);
