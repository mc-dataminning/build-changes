...
public class dfx<T extends dfs> {
   ...
   public Stream<dfw<T>> b(long $$0) {
      return this.a($$0).<dfw<T>>mapToObj(this.c::get).filter(Objects::nonNull);
   }
   ...
   public dfw<T> c(long $$0) {
      return (dfw<T>)this.c.computeIfAbsent($$0, this::g);
   }

   @Nullable
   public dfw<T> d(long $$0) {
      return (dfw<T>)this.c.get($$0);
   }

   private dfw<T> g(long $$0) {
      long $$1 = f($$0);
      dgf $$2 = (dgf)this.b.get($$1);
      this.d.add($$0);
      return new dfw<>(this.a, $$2);
   }
