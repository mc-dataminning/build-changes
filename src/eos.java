...
public class eos {
   ...
   static class a implements eos.i {
      @Override
      public boolean a(eos.v $$0) {
         return $$0.c[jm.f.d()] && !$$0.b[jm.f.d()].d;
      }

      @Override
      public eos.r a(jm $$0, eos.v $$1, azu $$2) {
         $$1.d = true;
         $$1.b[jm.f.d()].d = true;
         return new eos.k($$0, $$1);
      }
   }

   static class b implements eos.i {
      @Override
      public boolean a(eos.v $$0) {
      ...
      public eos.r a(jm $$0, eos.v $$1, azu $$2) {
         ...
         return new eos.l($$0, $$1);
      }
   }

   static class c implements eos.i {
      @Override
      public boolean a(eos.v $$0) {
      ...
      public eos.r a(jm $$0, eos.v $$1, azu $$2) {
         $$1.d = true;
         $$1.b[jm.b.d()].d = true;
         return new eos.m($$0, $$1);
      }
   }

   static class d implements eos.i {
      @Override
      public boolean a(eos.v $$0) {
      ...
      public eos.r a(jm $$0, eos.v $$1, azu $$2) {
         ...
         return new eos.n($$0, $$1);
      }
   }

   static class e implements eos.i {
      @Override
      public boolean a(eos.v $$0) {
      ...
      public eos.r a(jm $$0, eos.v $$1, azu $$2) {
         ...
         $$3.d = true;
         $$3.b[jm.c.d()].d = true;
         return new eos.o($$0, $$3);
      }
   }

   static class f implements eos.i {
      @Override
      public boolean a(eos.v $$0) {
         return true;
      }
      ...
      public eos.r a(jm $$0, eos.v $$1, azu $$2) {
         $$1.d = true;
         return new eos.s($$0, $$1, $$2);
      }
   }

   static class g implements eos.i {
      @Override
      public boolean a(eos.v $$0) {
      ...
      public eos.r a(jm $$0, eos.v $$1, azu $$2) {
         $$1.d = true;
         return new eos.t($$0, $$1);
      }
   }

   public static class h extends eos.r {
      ...
      private eos.v G;
      private eos.v H;
      private final List<eos.r> I = Lists.newArrayList();

      public h(azu $$0, int $$1, int $$2, jm $$3) {
         super(emz.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eos.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eos.p($$3, this.G));
         this.I.add(new eos.j($$3, this.H));
         List<eos.i> $$5 = Lists.newArrayList();
         $$5.add(new eos.b());
         $$5.add(new eos.d());
         $$5.add(new eos.e());
         $$5.add(new eos.a());
         ...
         ema $$10 = ema.a(this.b(1, 1, 1), this.b(23, 8, 21));
         ema $$11 = ema.a(this.b(34, 1, 1), this.b(56, 8, 21));
         ema $$12 = ema.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eos.u($$3, $$10, $$13++));
         this.I.add(new eos.u($$3, $$11, $$13++));
         this.I.add(new eos.q($$3, $$12));
      }
      ...
      private List<eos.v> b(azu $$0) {
         eos.v[] $$1 = new eos.v[75];
         ...
         eos.v $$23 = new eos.v(1003);
         eos.v $$24 = new eos.v(1001);
         eos.v $$25 = new eos.v(1002);
         $$1[v].a(jm.b, $$23);
         $$1[w].a(jm.d, $$24);
         $$1[x].a(jm.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eos.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dgk $$2, azu $$3, ema $$4) {
         int $$5 = 24;
      ...
      private void a(dgk $$0, azu $$1, ema $$2) {
      ...
      private void b(dgk $$0, azu $$1, ema $$2) {
      ...
      private void c(dgk $$0, azu $$1, ema $$2) {
      ...
      private void d(dgk $$0, azu $$1, ema $$2) {
      ...
      private void e(dgk $$0, azu $$1, ema $$2) {
      ...
      private void f(dgk $$0, azu $$1, ema $$2) {
   ...
   interface i {
      boolean a(eos.v var1);

      eos.r a(jm var1, eos.v var2, azu var3);
   }

   public static class j extends eos.r {
      public j(jm $$0, eos.v $$1) {
         super(emz.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dgk $$0, dgi $$1, dxr $$2, azu $$3, ema $$4, des $$5, jh $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dis.ch.m(), dis.ch.m(), false);
   ...
   public static class k extends eos.r {
      public k(jm $$0, eos.v $$1) {
         super(emz.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eos.r {
      public l(jm $$0, eos.v $$1) {
         super(emz.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eos.r {
      public m(jm $$0, eos.v $$1) {
         super(emz.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eos.r {
      public n(jm $$0, eos.v $$1) {
         super(emz.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eos.r {
      public o(jm $$0, eos.v $$1) {
         super(emz.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eos.r {
      public p(jm $$0, eos.v $$1) {
         super(emz.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eos.r {
      public q(jm $$0, ema $$1) {
         super(emz.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends emm {
      protected static final dvv b = dis.hZ.m();
      protected static final dvv c = dis.ia.m();
      protected static final dvv d = dis.ib.m();
      protected static final dvv h = c;
      protected static final dvv i = dis.ii.m();
      protected static final boolean j = true;
      protected static final dvv k = dis.G.m();
      protected static final Set<diq> l = ImmutableSet.builder().add(dis.dO).add(dis.iC).add(dis.mW).add(k.b()).build();
      ...
      public r(emz $$0, jm $$1, int $$2, ema $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(emz $$0, int $$1, jm $$2, eos.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static ema a(jm $$0, eos.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         ema $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dgk $$0, ema $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dvv $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dgk $$0, ema $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dgk $$0, ema $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dvv $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(ema $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dgk $$0, ema $$1, int $$2, int $$3, int $$4) {
         jh $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cln $$6 = bus.L.a($$0.a(), bur.d);
            if ($$6 != null) {
               $$6.c($$6.eR());
   ...
   public static class s extends eos.r {
      private int a;

      public s(jm $$0, eos.v $$1, azu $$2) {
         super(emz.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eos.r {
      public t(jm $$0, eos.v $$1) {
         super(emz.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eos.r {
      private int a;

      public u(jm $$0, ema $$1, int $$2) {
         super(emz.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
