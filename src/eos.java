...
public abstract class eos<M extends eop<M>> {
   private final dcj i;
   ...
   protected final Long2ObjectMap<dvd> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected eos(dcj $$0, dvl $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dvd a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dvd a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dvd c(long $$0) {
      dvd $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = jt.e($$0);
      dvd $$2 = this.a($$1, true);
      return $$2.a(jt.b(ir.a($$0)), jt.b(ir.b($$0)), jt.b(ir.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(jt.b(ir.a($$0)), jt.b(ir.b($$0)), jt.b(ir.c($$0)), $$1);
      jt.a($$0, this.f::add);
   }
   ...
   protected void a(eov<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            dvd $$2 = (dvd)this.g.remove($$1);
            dvd $$3 = this.d.d($$1);
            if (this.k.contains(jt.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<dvd>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dvd> $$6 = (Entry<dvd>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dvd $$8 = (dvd)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dvd $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = jt.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, eos.a.a($$9, eos.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public eos.b k(long $$0) {
      return eos.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static eos.b c(byte $$0) {
         if ($$0 == 0) {
            return eos.b.a;
         } else {
            return a($$0) ? eos.b.c : eos.b.b;
         }
      }
   }
