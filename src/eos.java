...
public class eos {
   ...
   private static final Queue<eos.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eos.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eos::a), eoq::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eos::a), eoq::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eos.a(this.b) + ", type=" + eos.b(this.c) + ", severity=" + eos.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
