...
public class cjp extends cjm {
   ...
   public cjp(bpd<? extends cjp> $$0, cxb $$1) {
      super($$0, $$1);
      this.af = true;
   }

   public cjp(cxb $$0, bpp $$1, box $$2, ih.a $$3) {
      this(bpd.aL, $$0);
      this.c($$1);
      ib $$4 = $$1.dm();
   ...
   public void l() {
      ...
      if (!this.dM().B) {
         ...
         if (this.c == null || !this.c.bA() || this.c instanceof ciu && this.c.N_()) {
            this.aY();
         } else {
   ...
   protected void a(epq $$0) {
      ...
      box $$1 = $$0.a();
      box $$2 = this.af_();
      bpp $$3 = $$2 instanceof bpp ? (bpp)$$2 : null;
      boolean $$4 = $$1.a(this.dN().a(this, $$3), 4.0F);
      if ($$4) {
         this.a($$3, $$1);
         if ($$1 instanceof bpp $$5) {
            $$5.b(new bok(bom.y, 200), (box)MoreObjects.firstNonNull($$2, this));
         }
      }
   }
   ...
   protected void a(epp $$0) {
      ...
      this.a(aty.wp, 1.0F, 1.0F);
   }

   private void r() {
      this.am();
      this.dM().a(drp.o, this.dk(), drp.a.a(this));
   }
