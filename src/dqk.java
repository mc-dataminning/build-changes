...
public class dqk implements dpu {
   public static final Codec<dqk> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dug.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               aqk.b(jc.e).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               drv.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               drv.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dlt.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, dqk::new)
   );
   ...
   public dqk(he<dug> $$0, int $$1, int $$2, aqk<ctc> $$3, drv $$4, int $$5, int $$6, int $$7, int $$8, drv $$9, int $$10, int $$11, dlt $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
