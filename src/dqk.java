...
@Deprecated
public class dqk extends dpv<dqk.a> {
   private static final dhi a = cvc.nc.o();

   public dqk(Codec<dqk.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dpx<dqk.a> $$0) {
      ht $$1 = $$0.e();
      csu $$2 = $$0.b();
      ats $$3 = $$0.d();
      dqk.a $$4 = $$0.f();
   ...
   public static record a(dua b, dua c) implements drz {
      public static final Codec<dqk.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(dua.a.fieldOf("fluid").forGetter(dqk.a::a), dua.a.fieldOf("barrier").forGetter(dqk.a::b)).apply($$0, dqk.a::new)
      );
