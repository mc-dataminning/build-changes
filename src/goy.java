...
public class goy implements avc, AutoCloseable {
   private static final Logger d = LogUtils.getLogger();
   private static final ale e = ale.b("transparency");
   private static final ale f = ale.b("entity_outline");
   ...
   private final gro j;
   private final gpl k;
   private final gpz l = new gpz();
   private final gol m = new gol();
   private final gqf n = new gqf();
   private final gqe o = new gqe();
   @Nullable
   private gjd p;
   private final gps q = new gps();
   private final ObjectArrayList<gss.b> r = new ObjectArrayList(10000);
   private final ObjectArrayList<gss.b> s = new ObjectArrayList(50);
   private final Set<dwn> t = Sets.newHashSet();
   @Nullable
   private gqc u;
   private int v;
   ...
   private gss I;
   private int J = -1;
   private final List<bwa> K = new ArrayList<>();
   private int L;
   private gsw M;
   private boolean N;
   @Nullable
   ...
   public goy(fof $$0, gvi $$1, gro $$2, gpl $$3) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
      this.k = $$3;
   ...
   public void a() {
      ...
      this.y = new fhb(this.h.aO().k(), this.h.aO().l(), true);
   ...
   public void e() {
      if (this.p != null) {
         this.p.f();
         if (this.I == null) {
            this.I = new gss(this.p, this, af.h(), this.k, this.h.ap(), this.h.ar());
         } else {
            this.I.a(this.p);
         }
         ...
         this.u = new gqc(this.I, this.p, this.h.n.aH(), this);
         this.q.a(this.u);
         this.B();
         fnn $$0 = this.h.j.k();
         this.u.a(jx.a($$0.b()));
   ...
   private void a(fnn $$0, gsw $$1, boolean $$2, boolean $$3) {
      fdw $$4 = $$0.b();
   ...
   public static gsw a(gsw $$0) {
      return new gsw($$0).a(8);
   }

   private void b(gsw $$0) {
      if (!fof.Q().bx()) {
         throw new IllegalStateException("applyFrustum called from wrong thread: " + Thread.currentThread().getName());
      } else {
         bqi.a().a("apply_frustum");
         this.B();
   ...
   public void a(fdw $$0, Matrix4f $$1, Matrix4f $$2) {
      this.M = new gsw($$1, $$2);
      this.M.a($$0.a(), $$0.b(), $$0.c());
   }

   public void a(fhz $$0, fnv $$1, boolean $$2, fnn $$3, got $$4, Matrix4f $$5, Matrix4f $$6) {
      float $$7 = $$1.a(false);
      ...
      gsw $$14 = $$13 ? this.O : this.M;
      bqi.a().b("captureFrustum");
      if (this.N) {
         this.O = $$13 ? new gsw($$5, $$6) : $$14;
         this.O.a($$10, $$11, $$12);
         this.N = false;
      }
      ...
      Vector4f $$17 = gos.a($$3, $$7, this.h.s, this.h.n.aH(), $$4.c($$7));
      gor $$18 = gos.a($$3, gos.d.b, $$17, $$15, $$16, $$7);
      gor $$19 = gos.a($$3, gos.d.a, $$17, $$15, $$16, $$7);
      $$8.b("cullEntities");
   ...
   private void a(fgu $$0, gsw $$1, fnn $$2, Matrix4f $$3, Matrix4f $$4, gor $$5, boolean $$6, boolean $$7, fnv $$8, bqj $$9) {
      fgv $$10 = $$0.a("main");
      ...
      $$10.a(() -> {
         ...
         double $$16 = $$13x.c();
         $$9.a("terrain");
         this.a(gpn.c(), $$14x, $$15, $$16, $$3, $$4);
         this.a(gpn.d(), $$14x, $$15, $$16, $$3, $$4);
         this.a(gpn.e(), $$14x, $$15, $$16, $$3, $$4);
         if (this.p.c().e()) {
            fhm.a();
         } else {
            fhm.b();
         ...
         $$9.b("translucent");
         this.a(gpn.f(), $$14x, $$15, $$16, $$3, $$4);
         $$9.b("string");
         this.a(gpn.s(), $$14x, $$15, $$16, $$3, $$4);
         if ($$6) {
            this.a($$2, $$18, $$17, true);
         }
   ...
   private void a(fgu $$0, fnn $$1, float $$2, gor $$3) {
      fgv $$4 = $$0.a("particles");
      if (this.z.n != null) {
   ...
   private void a(fgu $$0, Matrix4f $$1, Matrix4f $$2, fnr $$3, fdw $$4, float $$5, int $$6, float $$7) {
      fgv $$8 = $$0.a("clouds");
      if (this.z.p != null) {
   ...
   private void a(fgu $$0, fdw $$1, float $$2, gor $$3) {
   ...
   private void a(fgu $$0, fdw $$1, gor $$2) {
      fgv $$3 = $$0.a("late_debug");
   ...
   private boolean a(fnn $$0, gsw $$1, List<bwa> $$2) {
      fdw $$3 = $$0.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      boolean $$7 = false;
      boolean $$8 = this.d();
      bwa.b(azk.a((double)this.h.n.aH() / 8.0, 1.0, 2.5) * this.h.n.g().c());

      for (bwa $$9 : this.p.d()) {
         if (this.i.a($$9, $$1, $$4, $$5, $$6) || $$9.A(this.h.t)) {
            iu $$10 = $$9.dv();
            if ((this.p.e($$10.v()) || this.a($$10))
               && ($$9 != $$0.g() || $$0.i() || $$0.g() instanceof bwz && ((bwz)$$0.g()).fQ())
               && (!($$9 instanceof goa) || $$0.g() == $$9)) {
               $$2.add($$9);
               if ($$8 && this.h.b($$9)) {
                  $$7 = true;
               }
   ...
   private void a(fiq $$0, gpd.a $$1, fnn $$2, fnv $$3, List<bwa> $$4) {
      fdw $$5 = $$2.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
   ...
   private void a(fiq $$0, gpd.a $$1, gpd.a $$2, fnn $$3, float $$4) {
      fdw $$5 = $$3.b();
      double $$6 = $$5.a();
      double $$7 = $$5.b();
      double $$8 = $$5.c();
         ...
         if (!$$10.isEmpty()) {
            for (dwn $$11 : $$10) {
               ...
               if ($$14 != null && !$$14.isEmpty()) {
                  ...
                  if ($$15 >= 0) {
                     fiq.a $$16 = $$0.c();
                     fiu $$17 = new fir($$2.getBuffer(hkj.l.get($$15)), $$16, 1.0F);
                     $$13 = $$2x -> {
                        fiu $$3x = $$1.getBuffer($$2x);
                        return $$2x.W() ? fix.a($$17, $$3x) : $$3x;
                     };
                  }
               }
   ...
   private void a(fiq $$0, fnn $$1, gpd.a $$2) {
      fdw $$3 = $$1.b();
      double $$4 = $$3.a();
      double $$5 = $$3.b();
      double $$6 = $$3.c();
      ...
      while (var11.hasNext()) {
         ...
         if (!($$8.c($$4, $$5, $$6) > 1024.0)) {
            ...
            if ($$9 != null && !$$9.isEmpty()) {
               ...
               fiq.a $$11 = $$0.c();
               fiu $$12 = new fir($$2.getBuffer(hkj.l.get($$10)), $$11, 1.0F);
   ...
   private void a(fnn $$0, gpd.a $$1, fiq $$2, boolean $$3) {
      if (this.h.w instanceof fds $$4) {
         if ($$4.d() != fdu.a.a) {
            iu $$6 = $$4.b();
            dzo $$7 = this.p.a_($$6);
            if (!$$7.l() && this.p.A_().a($$6)) {
               ...
               if ($$10) {
                  fiu $$11 = $$1.getBuffer(gpn.z());
                  this.a($$2, $$11, $$0.g(), $$9.d, $$9.e, $$9.f, $$6, $$7, -16777216);
               }

               fiu $$12 = $$1.getBuffer(gpn.y());
   ...
   private void a(fiq $$0) {
      if (!$$0.d()) {
         throw new IllegalStateException("Pose stack not empty");
      }
   }

   private void a(bwa $$0, double $$1, double $$2, double $$3, float $$4, fiq $$5, gpd $$6) {
   ...
   private void a(fdw $$0) {
      if (!this.r.isEmpty()) {
         ...
         bqi.a().a("translucent_sort");
         gss.d $$3 = new gss.d();
         ObjectListIterator $$5 = this.s.iterator();

         while ($$5.hasNext()) {
            gss.b $$4 = (gss.b)$$5.next();
            this.a($$4, $$3, $$0, $$2, true);
         }
         ...
         while ($$5x-- > 0) {
            ...
            this.a((gss.b)this.r.get($$6), $$3, $$0, $$2, false);
         }
   ...
   private void a(gss.b $$0, gss.d $$1, fdw $$2, boolean $$3, boolean $$4) {
      $$1.b($$2, $$0.g());
   ...
   private void a(gpn $$0, double $$1, double $$2, double $$3, Matrix4f $$4, Matrix4f $$5) {
      RenderSystem.assertOnRenderThread();
      bqo $$6 = bqi.a().c(() -> "render_" + $$0.b);
      $$6.a($$0::toString);
      boolean $$7 = $$0 != gpn.f();
      ObjectListIterator<gss.b> $$8 = this.r.listIterator($$7 ? 0 : this.r.size());
      $$0.a();
      gom $$9 = RenderSystem.getShader();
      if ($$9 == null) {
         $$0.b();
         $$6.close();
      } else {
         $$9.a(fiv.c.h, $$4, $$5, this.h.aO());
         $$9.b();
         fih $$10 = $$9.o;

         while ($$7 ? $$8.hasNext() : $$8.hasPrevious()) {
            gss.b $$11 = $$7 ? (gss.b)$$8.next() : (gss.b)$$8.previous();
            if (!$$11.d().a($$0)) {
               fit $$12 = $$11.a($$0);
               iu $$13 = $$11.f();
               if ($$10 != null) {
   ...
   private void b(fgu $$0, fnn $$1, float $$2, gor $$3) {
      evx $$4 = $$1.k();
      if ($$4 != evx.c && $$4 != evx.a && !this.b($$1)) {
         gop $$5 = this.p.c();
         gop.d $$6 = $$5.c();
         if ($$6 != gop.d.a) {
            fgv $$7 = $$0.a("sky");
   ...
   private boolean b(fnn $$0) {
      return !($$0.g() instanceof bwz $$1) ? false : $$1.b(bvg.o) || $$1.b(bvg.G);
   }

   private void c(fnn $$0) {
      bqj $$1 = bqi.a();
      $$1.a("populate_sections_to_compile");
      gsq $$2 = new gsq();
      iu $$3 = $$0.c();
      List<gss.b> $$4 = Lists.newArrayList();
      ObjectListIterator var6 = this.r.iterator();

      while (var6.hasNext()) {
         gss.b $$5 = (gss.b)var6.next();
         if ($$5.i() && $$5.a()) {
            boolean $$6 = false;
            if (this.h.n.m().c() == fol.c) {
               iu $$7 = jx.a($$5.g()).k();
               $$6 = $$7.j($$3) < 768.0 || $$5.j();
            } else if (this.h.n.m().c() == fol.b) {
               $$6 = $$5.j();
            }
   ...
   private void a(fiq $$0, fiu $$1, bwa $$2, double $$3, double $$4, double $$5, iu $$6, dzo $$7, int $$8) {
      gpx.a($$0, $$1, $$7.a(this.p, $$6, feb.a($$2)), (double)$$6.u() - $$3, (double)$$6.v() - $$4, (double)$$6.w() - $$5, $$8);
   }

   public void a(dhv $$0, iu $$1, dzo $$2, dzo $$3, int $$4) {
      this.a($$1, ($$4 & 8) != 0);
   }

   private void a(iu $$0, boolean $$1) {
      for (int $$2 = $$0.w() - 1; $$2 <= $$0.w() + 1; $$2++) {
         for (int $$3 = $$0.u() - 1; $$3 <= $$0.u() + 1; $$3++) {
            for (int $$4 = $$0.v() - 1; $$4 <= $$0.v() + 1; $$4++) {
               this.a(jx.a($$3), jx.a($$4), jx.a($$2), $$1);
            }
         }
      }
   }
   ...
   public void a(lv $$0, boolean $$1, boolean $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8) {
      try {
         ...
         $$11.a("ID", mf.i.b($$0.a()));
         $$11.a("Parameters", () -> lx.bj.encodeStart(this.p.F_().a(ul.a), $$0).toString());
         $$11.a("Position", () -> p.a(this.p, $$3, $$4, $$5));
         throw new z($$10);
      }
   }

   public <T extends lv> void a(T $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6) {
      this.a($$0, $$0.a().b(), $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   gml b(lv $$0, boolean $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      return this.b($$0, $$1, false, $$2, $$3, $$4, $$5, $$6, $$7);
   }

   @Nullable
   private gml b(lv $$0, boolean $$1, boolean $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8) {
      fnn $$9 = this.h.j.k();
      arg $$10 = this.a($$2);
      if ($$1) {
   ...
   public void a(Collection<dwn> $$0, Collection<dwn> $$1) {
      synchronized (this.t) {
         this.t.removeAll($$0);
         this.t.addAll($$1);
      }
   ...
   public static int a(dhs $$0, iu $$1) {
      return a($$0, $$0.a_($$1), $$1);
   }

   public static int a(dhs $$0, dzo $$1, iu $$2) {
      if ($$1.b($$0, $$2)) {
         return 15728880;
      } else {
         int $$3 = $$0.a(diy.a, $$2);
   ...
   @bat
   public ObjectArrayList<gss.b> w() {
      return this.r;
   }
