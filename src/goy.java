...
public class goy extends gpq<cln, gva, fys> {
   private static final ali a = ali.b("textures/entity/guardian.png");
   private static final ali b = ali.b("textures/entity/guardian_beam.png");
   private static final gir k = gir.f(b);

   public goy(gok.a $$0) {
      this($$0, 0.5F, gbl.aL);
   }

   protected goy(gok.a $$0, float $$1, gbk $$2) {
      super($$0, new fys($$0.a($$2)), $$1);
   }

   public boolean a(cln $$0, gly $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.gw()) {
            bva $$5 = $$0.gx();
            if ($$5 != null) {
               ezn $$6 = this.a($$5, (double)$$5.dt() * 0.5, 1.0F);
               ezn $$7 = this.a($$0, (double)$$0.cT(), 1.0F);
               return $$1.a(new ezi($$7.d, $$7.e, $$7.f, $$6.d, $$6.e, $$6.f));
            }
         }
   ...
   private ezn a(bva $$0, double $$1, float $$2) {
      double $$3 = azk.d((double)$$2, $$0.ab, $$0.dC());
      double $$4 = azk.d((double)$$2, $$0.ac, $$0.dE()) + $$1;
      double $$5 = azk.d((double)$$2, $$0.ad, $$0.dI());
      return new ezn($$3, $$4, $$5);
   }

   public void a(gva $$0, feb $$1, gih $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      ezn $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(feb $$0, fef $$1, ezn $$2, float $$3, float $$4, float $$5) {
   ...
   private static void a(fef $$0, feb.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(gxu.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(cln $$0, gva $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.K($$2);
      $$1.b = $$0.J($$2);
      $$1.c = $$0.m($$2);
   ...
   @Nullable
   private static bue a(cln $$0) {
      bue $$1 = fji.Q().ao();
      return (bue)($$0.gw() ? $$0.gx() : $$1);
   }
}
