...
public class ffl {
   ...
   static class b {
      static final Optional<ffl> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static ffl a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ffl();
      }
   }
}
