...
public class ffl extends ffv {
      ...
      try {
         ...
         if (aza.d($$3, "lists")) {
            for (JsonElement $$5 : $$3.getAsJsonArray("lists")) {
               ...
               String $$7 = fhs.b("playerList", $$6, null);
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = fji.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fhs.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !fji.Q().b($$4)) {
               try {
