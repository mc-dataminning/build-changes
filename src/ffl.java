...
public class ffl {
   ...
   public static final ffl.a bv;

   public static ffl.a a(int $$0, int $$1) {
      return $$0 == -1 ? ffl.b.b.a($$1) : ffl.b.a.a($$0);
   }

   public static ffl.a a(String $$0) {
      if (ffl.a.e.containsKey($$0)) {
         return ffl.a.e.get($$0);
      } else {
         for (ffl.b $$1 : ffl.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ffl.b b;
      private final int c;
      private final azy<xv> d;
      static final Map<String, ffl.a> e = Maps.newHashMap();

      a(String $$0, ffl.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<ffl.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xv> g;

      private static void a(ffl.b $$0, String $$1, int $$2) {
         ffl.a $$3 = new ffl.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public ffl.a a(int $$0) {
         return (ffl.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
