...
public enum ffl {
   ...
   private ffl(final String... $$0) {
      this.c = $$0;
   }

   public List<avn<InputStream>> a(aug $$0) throws IOException {
      return List.of(
   ...
   public avn<InputStream> b(aug $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private avn<InputStream> a(aug $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      avn<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
