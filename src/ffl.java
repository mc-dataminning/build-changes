...
public class ffl {
   ...
   public ffl(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ffl(ffq $$0, ffq $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static ffl a(ert $$0) {
      return new ffl((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static ffl a(ffq $$0) {
      return new ffl($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static ffl a(iv $$0, iv $$1) {
      return new ffl(
   ...
   public ffl a(double $$0) {
      return new ffl($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ffl b(double $$0) {
      return new ffl(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ffl c(double $$0) {
      return new ffl(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ffl d(double $$0) {
      return new ffl(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ffl e(double $$0) {
      return new ffl(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ffl f(double $$0) {
      return new ffl(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ffl b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ffl c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ffl d(double $$0, double $$1, double $$2) {
      return new ffl(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ffl f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ffl h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<ffq> b(ffq $$0, ffq $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<ffq> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, ffq $$6, ffq $$7) {
   ...
   @Nullable
   public static ffm a(Iterable<ffl> $$0, ffq $$1, ffq $$2, iv $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new ffm($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jb a(ffl $$0, ffq $$1, double[] $$2, @Nullable jb $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jb a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, ffq $$6, double[] $$7, @Nullable jb $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
   ...
   public boolean a(ffq $$0, List<ffl> $$1) {
      ffq $$2 = this.f();
      ffq $$3 = $$2.e($$0);

      for (ffl $$4 : $$1) {
         ffl $$5 = $$4.c(this.b() * 0.5, this.c() * 0.5, this.d() * 0.5);
         if ($$5.d($$3) || $$5.d($$2)) {
            return true;
         }
   ...
   public ffq f() {
      return new ffq(azo.d(0.5, this.a, this.d), azo.d(0.5, this.b, this.e), azo.d(0.5, this.c, this.f));
   }

   public ffq g() {
      return new ffq(azo.d(0.5, this.a, this.d), this.b, azo.d(0.5, this.c, this.f));
   }

   public ffq h() {
      return new ffq(this.a, this.b, this.c);
   }

   public ffq i() {
      return new ffq(this.d, this.e, this.f);
   }

   public static ffl a(ffq $$0, double $$1, double $$2, double $$3) {
      return new ffl($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
   ...
   public static class a {
      ...
      public ffl a() {
         return new ffl((double)this.a, (double)this.b, (double)this.c, (double)this.d, (double)this.e, (double)this.f);
      }
   }
}
