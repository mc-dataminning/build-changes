...
public class ffl extends auu<Map<String, List<ffl.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<ffl.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(ffl.a::a),
                     Codec.LONG.fieldOf("period").forGetter(ffl.a::b),
                     Codec.STRING.fieldOf("title").forGetter(ffl.a::c),
                     Codec.STRING.fieldOf("message").forGetter(ffl.a::d)
                  )
                  .apply($$0, ffl.a::new)
         )
         .listOf()
   ...
   public ffl(alf $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<ffl.a>> a(aup $$0, bni $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<ffl.a>> $$0, aup $$1, bni $$2) {
      List<ffl.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<ffl.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<ffl.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<ffl.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public ffl.b a(List<ffl.a> $$0, long $$1) {
         this.cancel();
         return new ffl.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (ffl.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fjm.a(fff.Q().ax(), fjm.a.f, xp.a($$2.c, $$3), xp.a($$2.d, $$3)));
                  return;
               }
            }
         }
