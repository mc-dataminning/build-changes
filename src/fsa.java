...
public class fsa extends fqw<csg> {
   private static final ale G = ale.b("container/loom/banner_slot");
   private static final ale H = ale.b("container/loom/dye_slot");
   private static final ale I = ale.b("container/loom/pattern_slot");
   ...
   @Nullable
   private drm Z;
   private cvs aa = cvs.k;
   private cvs ab = cvs.k;
   ...
   protected void aS_() {
      super.aS_();
      this.Y = this.m.aT().a(gap.m).b("flag");
   }
   ...
   protected void a(fkb $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(ghv::B, P, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      csw $$6 = this.z.n();
      csw $$7 = this.z.o();
      csw $$8 = this.z.p();
      csw $$9 = this.z.q();
      if (!$$6.h()) {
         $$0.a(ghv::B, G, $$4 + $$6.e, $$5 + $$6.f, 16, 16);
      }

      if (!$$7.h()) {
         $$0.a(ghv::B, H, $$4 + $$7.e, $$5 + $$7.f, 16, 16);
      }

      if (!$$8.h()) {
         $$0.a(ghv::B, I, $$4 + $$8.e, $$5 + $$8.f, 16, 16);
      }

      int $$10 = (int)(41.0F * this.af);
      ale $$11 = this.ad ? J : K;
      $$0.a(ghv::B, $$11, $$4 + 119, $$5 + 13 + $$10, 12, 15);
      $$0.e();
      fce.c();
      if (this.Z != null && !this.ae) {
         ...
         this.Y.c = -32.0F;
         cum $$13 = ((ctr)$$9.g().h()).b();
         gjr.a($$0.c(), $$0.d(), 15728880, gwx.d, this.Y, gzp.f, true, $$13, this.Z);
         $$0.c().b();
      } else if (this.ae) {
         $$0.a(ghv::B, O, $$4 + $$9.e - 5, $$5 + $$9.f - 5, 26, 26);
      }

      if (this.ad) {
         int $$14 = $$4 + 60;
         int $$15 = $$5 + 13;
         List<jo<drl>> $$16 = this.z.l();
   ...
   private void a(fkb $$0, jo<drl> $$1, int $$2, int $$3) {
      fdi $$4 = new fdi();
      $$4.a();
      ...
      this.Y.e = 0.0F;
      this.Y.c = -32.0F;
      drm $$6 = new drm.a().a($$1, cum.a).a();
      gjr.a($$4, $$0.d(), 15728880, gwx.d, this.Y, gzp.f, true, cum.h, $$6);
      $$4.b();
      $$0.e();
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      ...
      if (this.ag && this.ad && $$5 > 0) {
         ...
         this.af = azf.a(this.af, 0.0F, 1.0F);
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (super.a($$0, $$1, $$2, $$3)) {
         ...
         if (this.ad && $$4 > 0) {
            ...
            this.af = azf.a(this.af - $$5, 0.0F, 1.0F);
   ...
   private void G() {
      ...
      if ($$0.f()) {
         ...
         this.Z = $$0.a(ks.ad, drm.a);
      }

      cvs $$1 = this.z.n().g();
      cvs $$2 = this.z.o().g();
      cvs $$3 = this.z.p().g();
      drm $$4 = $$1.a(ks.ad, drm.a);
      this.ae = $$4.b().size() >= 6;
      if (this.ae) {
         this.Z = null;
      }

      if (!cvs.a($$1, this.aa) || !cvs.a($$2, this.ab) || !cvs.a($$3, this.ac)) {
