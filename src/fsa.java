...
public class fsa extends cxb {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final drc e = new drc();
   private final dri<box> f = new dri<>(box.class, new fsa.b());
   private final fsb D;
   private final fxq E;
   private final fsa.a F;
   private final fxh G;
   private final bno H;
   private final ezi I = ezi.Q();
   final List<fwr> J = Lists.newArrayList();
   private final Map<ejy, eka> K = Maps.newHashMap();
   private static final long L = 16777215L;
   private int M;
   private final Object2ObjectArrayMap<cwm, fan> N = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(fxe.a, new fan($$0xx -> this.b($$0xx, fxe.a)));
      $$0x.put(fxe.b, new fan($$0xx -> this.b($$0xx, fxe.b)));
      $$0x.put(fxe.c, new fan($$0xx -> this.b($$0xx, fxe.c)));
   });
   private final frw O;
   private final Deque<Runnable> P = Queues.newArrayDeque();
   private int Q;
   private final ftm R = new ftm();
   private static final Set<cqh> S = Set.of(cqp.hA, cqp.hB);

   public void b(int $$0) {
      this.R.a($$0, this);
   }

   public void b(ib $$0, dnb $$1, int $$2) {
      if (!this.R.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(ib $$0, dnb $$1, ept $$2) {
      dnb $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         ciu $$4 = this.I.s;
   ...
   public fsa(fsb $$0, fsa.a $$1, ajg<cxb> $$2, il<dqo> $$3, int $$4, int $$5, Supplier<bjr> $$6, fxq $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.w(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.O = new frw(this, $$4);
      this.H = new bno();
      this.F = $$1;
      this.E = $$7;
      this.G = fxh.a($$3.a());
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.Z().a(cwx.l).a(false, null);
      } else {
         this.Z().a(cwx.l).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<box> e() {
      return this.G().a();
   }
   ...
   private void a(box $$0, box $$1) {
      if ($$1.dH() || $$1.cZ() != $$0) {
         $$1.ac();
      } else if ($$1 instanceof ciu || this.e.c($$1)) {
         $$1.bs();
         $$1.ah++;
         $$1.t();
   ...
   private dac p() {
      if (this.I.q.j() == cwy.b) {
         cqm $$0 = this.I.s.eU();
         cqh $$1 = $$0.d();
         if (S.contains($$1) && $$1 instanceof coh $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, axd $$4, @Nullable dac $$5, ib.a $$6) {
   ...
   private void a(ib $$0, dnb $$1, ka $$2, boolean $$3) {
      if ($$1.u().c()) {
         eqm $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(ih.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(ib $$0, ka $$1, eqm $$2, double $$3) {
   ...
   public void a(@Nullable ciu $$0, box $$1, il<atx> $$2, atz $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.ak().a((gmp)(new gmg($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(box $$0, atx $$1, atz $$2, float $$3, float $$4) {
      this.I.ak().a((gmp)(new gmg($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, atx $$3, atz $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      gmk $$10 = new gmk($$3, $$4, $$5, $$6, axd.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, @Nullable ta $$6) {
      this.I.g.a(new fur.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
   }
   ...
   public il<cya> a(int $$0, int $$1, int $$2) {
      return this.H_().d(kj.au).g(cyh.b);
   }
   ...
   public ept a(ept $$0, float $$1) {
      float $$2 = this.f($$1);
      ept $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      cyc $$4 = this.F_();
      ept $$5 = avx.a($$3, ($$1x, $$2x, $$3x) -> ept.a($$4.a($$1x, $$2x, $$3x).a().a()));
      ...
      return new ept((double)$$7, (double)$$8, (double)$$9);
   }

   public ept h(float $$0) {
      float $$1 = this.f($$0);
      ...
      return new ept((double)$$3, (double)$$4, (double)$$5);
   }
   ...
   public int a(ib $$0, cwm $$1) {
      fan $$2 = (fan)this.N.get($$1);
      return $$2.a($$0);
   }

   public int b(ib $$0, cwm $$1) {
      int $$2 = ezi.Q().m.C().c();
      if ($$2 == 0) {
   ...
   protected Map<ejy, eka> l() {
      return ImmutableMap.copyOf(this.K);
   }

   protected void a(Map<ejy, eka> $$0) {
      this.K.putAll($$0);
   }
   ...
   public static class a implements ekt {
      ...
      public a(bna $$0, boolean $$1, boolean $$2) {
         this.i = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new cwx();
   ...
   final class b implements dre<box> {
      public void a(box $$0) {
      }
