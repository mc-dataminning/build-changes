...
public abstract class fsa implements ftf, ftz, fvs, fvx {
   ...
   @Override
   public final void a(fro $$0, int $$1, int $$2, float $$3) {
      if (this.k) {
   ...
   protected abstract void b(fro var1, int var2, int var3, float var4);

   protected static void a(fro $$0, frm $$1, wy $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      a($$0, $$1, $$2, ($$3 + $$5) / 2, $$3, $$4, $$5, $$6, $$7);
   }

   protected static void a(fro $$0, frm $$1, wy $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8) {
      int $$9 = $$1.a($$2);
      int $$10 = ($$5 + $$7 - 9) / 2 + 1;
      int $$11 = $$6 - $$4;
      if ($$9 > $$11) {
   ...
   protected void a(fro $$0, frm $$1, int $$2, int $$3) {
      int $$4 = this.F() + $$2;
   ...
   public static void b(hns $$0) {
      $$0.a(hmh.a(awn.Bs, 1.0F));
   }
   ...
   public fvx.a w() {
      if (this.aI_()) {
         ...
         return this.i ? fvx.a.b : fvx.a.a;
      }
   }

   @Override
   public final void b(fvz $$0) {
      this.a($$0);
      this.n.a($$0);
   }

   protected abstract void a(fvz var1);

   protected void c(fvz $$0) {
      $$0.a(fvy.a, this.d());
      if (this.j) {
         if (this.aI_()) {
            $$0.a(fvy.d, wy.c("narration.button.usage.focused"));
         } else {
