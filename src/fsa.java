...
public class fsa extends fnj {
   ...
   private final flf L = new flf(this);
   @Nullable
   private final fnj M;
   frz N;
   fib O;
   private String P = "";
   private fsa.a Q = fsa.a.a;
   private fhs R;
   private fhs S;
   private fhs T;
   private fhs U;
   ...
   protected void aP_() {
      ...
      if (this.X) {
         ...
         this.N = new frz(this, this.l, this.m, this.m(), 88, 36);
      }

      int $$0 = this.N.b() / 3;
      int $$1 = this.N.s();
      int $$2 = this.N.t();
      this.R = this.c(fhs.a(s, $$0x -> this.a(fsa.a.a)).a($$1, 45, $$0, 20).a());
      this.S = this.c(fhs.a(u, $$0x -> this.a(fsa.a.b)).a(($$1 + $$2 - $$0) / 2 + 1, 45, $$0, 20).a());
      this.T = this.c(fhs.a(v, $$0x -> this.a(fsa.a.c)).a($$2 - $$0 + 1, 45, $$0, 20).a());
      String $$3 = this.O != null ? this.O.a() : "";
      this.O = new fib(this.o, this.F() + 28, 74, 200, 15, z) {
         @Override
         protected xi aM_() {
            return !fsa.this.O.a().isEmpty() && fsa.this.N.c() ? super.aM_().f(", ").b(fsa.A) : super.aM_();
         }
      };
      this.O.f(16);
      this.O.g(true);
      ...
      this.c(this.O);
      this.d(this.N);
      this.U = this.c(fhs.a(D, fmg.b(this, "https://aka.ms/javablocking")).a(this.m / 2 - 100, 64 + this.m(), 200, 20).a());
      this.X = true;
      this.a(this.Q);
      this.L.b(fhs.a(wt.d, $$0x -> this.d()).a(200).a());
      this.L.a($$1x -> {
