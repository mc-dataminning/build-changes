...
@Deprecated
public class dpy extends dpj<dpy.a> {
   private static final dgw a = cuv.nc.o();

   public dpy(Codec<dpy.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dpl<dpy.a> $$0) {
      ht $$1 = $$0.e();
      csm $$2 = $$0.b();
      ato $$3 = $$0.d();
      dpy.a $$4 = $$0.f();
   ...
   public static record a(dto b, dto c) implements drn {
      public static final Codec<dpy.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(dto.a.fieldOf("fluid").forGetter(dpy.a::a), dto.a.fieldOf("barrier").forGetter(dpy.a::b)).apply($$0, dpy.a::new)
      );
