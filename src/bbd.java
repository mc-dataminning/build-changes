...
public class bbd extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgv.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bgv.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bgv.s);
