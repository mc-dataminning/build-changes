...
public class bbd extends bfv {
   public bbd(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bgx.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bgx.s, "minecraft:piston");
