...
public abstract class czn extends daa {
   ...
   public static dmz a(cwf $$0, ib $$1) {
      ib $$2 = $$1.d();
      dmz $$3 = $$0.a_($$2);
      return dhk.m($$3) ? dac.cs.o() : ((dda)dac.cr).b($$0, $$1);
   }
   ...
   public void a(dmz $$0, cwz $$1, ib $$2, axd $$3) {
      if ($$3.a(24) == 0) {
         $$1.a((double)$$2.u() + 0.5, (double)$$2.v() + 0.5, (double)$$2.w() + 0.5, aty.iI, atz.e, 1.0F + $$3.i(), $$3.i() * 0.7F + 0.3F, false);
      }
   ...
   protected abstract boolean f(dmz var1);
   ...
   protected void b(dmz $$0, cwz $$1, ib $$2, dmz $$3, boolean $$4) {
      if (!$$3.a($$0.b())) {
         if (a($$1)) {
            Optional<ejl> $$5 = ejl.a($$1, $$2, ih.a.a);
            if ($$5.isPresent()) {
               $$5.get().b();
               return;
            }
   ...
   private static boolean a(cwz $$0) {
      return $$0.ad() == cwz.h || $$0.ad() == cwz.i;
   }
   ...
   public static boolean a(cwz $$0, ib $$1, ih $$2) {
      dmz $$3 = $$0.a_($$1);
      return !$$3.i() ? false : a($$0, $$1).a((cxc)$$0, $$1) || b($$0, $$1, $$2);
   }

   private static boolean b(cwz $$0, ib $$1, ih $$2) {
      if (!a($$0)) {
         return false;
      } else {
         ib.a $$3 = $$1.j();
