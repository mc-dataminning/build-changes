...
public class fds {
   ...
   final ezi c;
   private final List<fds.a<?>> d = new ArrayList<>();
   private final BitSet e = new BitSet(5);
   private final Deque<fdr> f = Queues.newArrayDeque();
   ...
   @Nullable
   public <T extends fdr> T a(Class<? extends T> $$0, Object $$1) {
      for (fds.a<?> $$2 : this.d) {
   ...
   class a<T extends fdr> {
      ...
      private float a(long $$0) {
         ...
         $$1 *= $$1;
         return this.h == fdr.a.b ? 1.0F - $$1 : $$1;
      }

      public boolean a(int $$0, fav $$1) {
         long $$2 = ac.b();
         if (this.f == -1L) {
            this.f = $$2;
            this.h.a(fds.this.c.ak());
         }

         if (this.h == fdr.a.a && $$2 - this.f <= 600L) {
            this.g = $$2;
         }

         $$1.c().a();
         $$1.c().a((float)$$0 - (float)this.c.a() * this.a($$2), (float)(this.d * 32), 800.0F);
         fdr.a $$3 = this.c.a($$1, fds.this, $$2 - this.g);
         $$1.c().b();
         if ($$3 != this.h) {
         ...
         return this.h == fdr.a.b && $$2 - this.f > 600L;
      }
   }
}
