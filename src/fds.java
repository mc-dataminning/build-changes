...
public class fds extends gwq {
   ...
   private static final fjz C = new fjz(akr.b("widget/cross_button"), akr.b("widget/cross_button_highlighted"));
   ...
   protected void aT_() {
      ...
      if (this.R) {
         this.S = this.c(fim.a(wz.c("mco.selectServer.trial"), fna.b(this, axj.q)).a(this.E() - 10 - 99, this.F() - 10 - 4 - 40, 99, 20).a());
      }

      this.c(fim.a(wz.c("mco.selectServer.buy"), fna.b(this, axj.r)).a(this.E() - 10 - 99, this.F() - 10 - 20, 99, 20).a());
      fiy $$0 = this.c(new fiy(this.C() + 4, this.D() + 4, 14, 14, C, $$0x -> this.d(), b));
      $$0.a(fjx.a(b));
      int $$1 = 142 - (this.R ? 40 : 20);
      fiw $$2 = new fiw(this.E() - 10 - 100, this.D() + 10, 100, $$1, a, this.o);
      if ($$2.j()) {
         $$2.k(100 - $$2.f());
      }
   ...
   public static void a(fhz $$0, fim $$1) {
      int $$2 = 8;
      $$0.c().a();
