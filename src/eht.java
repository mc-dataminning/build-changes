...
public class eht implements azv {
   private static final float c = 5.9604645E-8F;
   private static final double d = 1.110223E-16F;
   public static final Codec<eht> b = ehs.a.xmap($$0 -> new eht($$0), $$0 -> $$0.e);
   private ehs e;
   private final egu f = new egu(this);

   public eht(long $$0) {
      this.e = new ehs(ehh.c($$0));
   }
   ...
   @Override
   public azv d() {
      return new eht(this.e.a(), this.e.a());
   }

   @Override
   public ehf e() {
      return new eht.a(this.e.a(), this.e.a());
   }
   ...
   public static class a implements ehf {
      ...
      public azv a(int $$0, int $$1, int $$2) {
         long $$3 = azm.b($$0, $$1, $$2);
         long $$4 = $$3 ^ this.a;
         return new eht($$4, this.b);
      }

      @Override
      public azv a(String $$0) {
         ehh.a $$1 = ehh.a($$0);
         return new eht($$1.a(this.a, this.b));
      }

      @Override
      public azv a(long $$0) {
         return new eht($$0 ^ this.a, $$0 ^ this.b);
      }
