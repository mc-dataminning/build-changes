...
public class gwz extends gvy<bxb, hde> {
   public gwz(gvz.a $$0) {
      super($$0);
   }

   public void a(hde $$0, fjc $$1, gps $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bxb $$0, hde $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bxb $$0) {
      return false;
   }
}
