public abstract class gwz<M extends gdf> extends gwr<gzu, M> {
   private final gcv a;
   private final aku b;
   private final gwz.a c;

   public gwz(gtd<?, gzu, M> $$0, gcv $$1, aku $$2, gwz.a $$3) {
      super($$0);
      this.a = $$1;
      this.b = $$2;
      this.c = $$3;
   ...
   protected abstract int a(gzu var1);
   ...
   private void a(ffu $$0, glx $$1, int $$2, float $$3, float $$4, float $$5) {
      ...
      this.a.a($$0, $$1.getBuffer(this.a.a(this.b)), $$2, hea.d);
   }
