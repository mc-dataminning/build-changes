...
public class axm {
   ...
   public static final Codec<axm.c> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? akm.b($$0.substring(1)).map($$0x -> new axm.c($$0x, true)) : akm.b($$0).map($$0x -> new axm.c($$0x, false)), axm.c::c
      );
   ...
   public static final Codec<String> u = Codec.string(0, 16)
      .validate($$0 -> ayy.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   ...
   public static Codec<String> y = Codec.STRING
      .validate($$0 -> !akm.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static record c(akm a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
