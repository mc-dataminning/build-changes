...
public class fag {
   ...
   public void a(fbq $$0, String $$1, fcm.a $$2, epr $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fag.b $$13 = new fag.b($$1.trim(), this.f, $$3, $$2);
                  fag.a $$14 = new fag.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fag.c $$30 = new fag.c(this.f, $$2, $$0);
                        fag.a $$31 = new fag.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fbu(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, epr $$2) throws IOException {
      ...
      File $$15 = new File(ffa.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final epr $$2, final fcm.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fag.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fag.this.b && !fag.this.d) {
            try {
               fag.this.e = true;
               fag.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fag.a.error("Error extracting archive", var3);
               fag.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fcm.a c;
      private final fbq d;

      c(final File $$0, final fcm.a $$1, final fbq $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fag.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fag.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fag.this.g);
                  fag.this.c = true;
               } else {
                  fag.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fag.this.d = true;
               }
            } catch (IOException var3) {
               fag.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fag.this.d = true;
            }
         }
      }
