public class fag extends ezi<cfj> {
   private static final aex x = new aex("container/horse/chest_slots");
   private static final aex y = new aex("container/horse/saddle_slot");
   private static final aex z = new aex("container/horse/llama_armor_slot");
   private static final aex A = new aex("container/horse/armor_slot");
   private static final aex B = new aex("textures/gui/container/horse.png");
   private final bwq C;
   private float D;
   private float E;
