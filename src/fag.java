...
public class fag extends ezi {
   ...
   public fag(eyz $$0, int $$1, int $$2, int $$3, int $$4, vq $$5, vq $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new faj($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fdj $$0) {
      $$0.a(fdi.a, vq.a("gui.narrate.editBox", this.x(), this.j()));
   }
   ...
   protected void c(ezb $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$4.isEmpty() && !this.aL_()) {
         ...
         int $$5 = this.o.d();
         boolean $$6 = this.aL_() && (ac.b() - this.p) / 300L % 2L == 0L;
         boolean $$7 = $$5 < $$4.length();
         int $$8 = 0;
         int $$9 = 0;
         int $$10 = this.C() + this.a();

         for (faj.a $$11 : this.o.h()) {
   ...
   protected void a(ezb $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         vq $$2 = vq.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void k() {
      double $$0 = this.c();
      faj.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         faj.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
