...
public class ela implements dvs.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ela> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final axt<ela> a = axt.a(f);
   private final ele g;
   private final ele h;
   private final ele i;
   ...
   public static ela a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ela(new dxa(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ela(ele $$0, ele $$1, ele $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ela(ayg $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ele.a($$0, IntStream.rangeClosed(-15, 0)),
         ele.a($$0, IntStream.rangeClosed(-15, 0)),
         ele.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ela a(ayg $$0) {
      return new ela($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dvs.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         elb $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ele.b($$4 * $$13), ele.b($$5 * $$13), ele.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ele.b($$1 * $$13);
         double $$21 = ele.b($$2 * $$13);
         double $$22 = ele.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            elb $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return axz.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
