...
public class ela extends elg {
   public static final MapCodec<ela> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, ela::new));

   public ela(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<ejm.a> a(dgm $$0, BiConsumer<ji, dwv> $$1, azg $$2, int $$3, ji $$4, eiw $$5) {
      ...
      $$6.add(new ejm.a(new ji($$14, $$16, $$15), 0, true));
      ...
      for (int $$20 = -1; $$20 <= 2; $$20++) {
         for (int $$21 = -1; $$21 <= 2; $$21++) {
            if (($$20 < 0 || $$20 > 1 || $$21 < 0 || $$21 > 1) && $$2.a(3) <= 0) {
               ...
               $$6.add(new ejm.a(new ji($$11 + $$20, $$16, $$13 + $$21), 0, false));
            }
         }
      }
