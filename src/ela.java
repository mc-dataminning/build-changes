...
public class ela {
   ...
   static class b {
      static final Optional<ela> a = Optional.ofNullable(a());
      ...
      private static ela a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new ela();
      }
   }
}
