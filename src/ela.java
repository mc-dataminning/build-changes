...
public class ela extends ele implements elc {
   ...
   public ela.c a() {
      return new ela.c(this.p, this.l, this.t, this.u);
   }

   public void a(ela.c $$0) {
      this.h.rewind();
      this.p = $$0.a;
      this.l = $$0.b;
      this.k = this.j;
   ...
   private IntConsumer a(int $$0, elk.a $$1) {
   ...
   private ela.b o() {
      ...
      this.j += $$5;
      this.i++;
      ela.a $$9 = new ela.a(this.o, this.l, $$0, this.p, $$2, this.v, $$4);
      return new ela.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.n != 0) {
         ...
         this.l++;
         this.l();
         if (this.p == elk.b.a || this.p == elk.b.b) {
            int $$0 = this.o.b();
   ...
   @Override
   public void f() {
      ImmutableList<ell> $$0 = this.o.c();
      this.n = (this.n + 1) % $$0.size();
      this.k = this.k + this.m.e();
      ell $$1 = (ell)$$0.get(this.n);
      this.m = $$1;
      if ($$1.b() == ell.b.e) {
         this.f();
      }

      if (this.a && this.m.b() == ell.b.c) {
         elc.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, elc.a($$11));
         this.a($$14 + 5, elc.a($$12));
         this.a($$14 + 6, elc.a($$13));
         this.k += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(elk a, int b, int c, elk.b d, elk.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(elk.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable eln $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
