...
public class gjj implements gke {
   ...
   private CompletableFuture<Optional<cra>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public gjj(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cra::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cra>> a(Optional<cra> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cra.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cra $$0) {
      ...
      if ($$0 != null) {
         if (ab.aU) {
            cra.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cra a(UserApiService $$0) throws ayk, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         crb.a $$2 = a($$1);
         return new cra(ayj.a($$1.keyPair().privateKey()), new crb($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static crb.a a(KeyPairResponse $$0) throws ayk {
      KeyPair $$1 = $$0.keyPair();
