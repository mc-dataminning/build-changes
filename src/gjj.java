public class gjj extends gke {
   private final gjz a;

   gjj(gfw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gjz $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cov $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dD();
            if (this.h > $$1) {
   ...
   public static class b implements gjh<lx> {
      ...
      public gje a(lx $$0, gfw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gje $$8 = new gjj($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
