...
public class dwq {
   ...
   private final Map<String, dwy> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public dwq(@Nullable edw $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public rz a(rz $$0) {
      rz $$1 = $$0.p("Level");
      cqz $$2 = new cqz($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(cqz.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(cqz.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable edw $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            rz $$2 = new rz();

            try {
               $$2 = $$0.a($$1, aun.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               rz $$4 = $$2.p($$3);
               long $$5 = cqz.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  rz $$14 = $$2.p($$13);
                  $$12.a(cqz.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static dwq a(agf<crs> $$0, @Nullable edw $$1) {
      if ($$0 == crs.h) {
         return new dwq(
            $$1,
         ...
         return new dwq($$1, $$2, $$2);
      } else if ($$0 == crs.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new dwq($$1, $$3, $$3);
      } else {
