...
public class dhe extends czf {
   public static final MapCodec<dhe> a = b(dhe::new);
   public static final dne b = dmu.aw;
   protected static final float c = 6.0F;
   protected static final epo d = czf.a(2.0, 0.0, 2.0, 14.0, 16.0, 14.0);
   ...
   protected boolean a(dme $$0, cwh $$1, ib $$2) {
      ...
      if ($$3.a(this)) {
         ...
         if ($$3.a(aue.af) || $$3.a(aue.H)) {
            ib $$4 = $$2.d();

            for (ih $$5 : ih.c.a) {
               dme $$6 = $$1.a_($$4.a($$5));
               ehr $$7 = $$1.b_($$4.a($$5));
               if ($$7.a(auj.a) || $$6.a(czh.kI)) {
                  return true;
               }
            }
         }
