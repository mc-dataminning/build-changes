...
public abstract class dhe<T extends Comparable<T>> {
   ...
   private final Codec<dhe.a<T>> e = this.d.xmap(this::b, dhe.a::b);

   protected dhe(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dhe.a<T> b(T $$0) {
      return new dhe.a<>(this, $$0);
   }

   public dhe.a<T> a(dgd<?, ?> $$0) {
      return new dhe.a<>(this, $$0.c(this));
   }

   public Stream<dhe.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dhe<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends dgd<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.a(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dhe<T> a, T b) {
      public a(dhe<T> a, T b) {
         if (!a.a().contains(b)) {
