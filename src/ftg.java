...
public class ftg {
   ...
   public static fti a(BooleanConsumer $$0, BanDetails $$1) {
      return new fti($$0, a($$1), b($$1), axv.n, wo.m, true);
   }

   public static fti a(Runnable $$0) {
      URI $$1 = axv.n;
      return new fti($$2 -> {
         if ($$2) {
            af.m().a($$1);
   ...
   public static fti a(String $$0, Runnable $$1) {
      URI $$2 = axv.n;
      return new fti($$2x -> {
         if ($$2x) {
            af.m().a($$2);
