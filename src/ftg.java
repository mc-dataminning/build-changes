...
public abstract class ftg<T extends biq> {
   ...
   public final int b(T $$0, float $$1) {
      gw $$2 = gw.a($$0.k($$1));
      return fod.a(this.a($$0, $$2), this.b($$0, $$2));
   }

   protected int b(T $$0, gw $$1) {
      return $$0.dL().a(cqe.a, $$1);
   }
   ...
   public boolean a(T $$0, frg $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         ...
         ehi $$5 = $$0.g_().g(0.5);
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new ehi($$0.dq() - 2.0, $$0.ds() - 2.0, $$0.dw() - 2.0, $$0.dq() + 2.0, $$0.ds() + 2.0, $$0.dw() + 2.0);
         }
   ...
   protected void a(T $$0, tl $$1, elp $$2, foe $$3, int $$4) {
      ...
      if (!($$5 > 4096.0)) {
         ...
         Matrix4f $$9 = $$2.c().a();
         float $$10 = eqv.O().m.a(0.25F);
         int $$11 = (int)($$10 * 255.0F) << 24;
         esd $$12 = this.b();
         float $$13 = (float)(-$$12.a($$1) / 2);
         $$12.a($$1, $$13, (float)$$8, 553648127, false, $$9, $$3, $$6 ? esd.a.b : esd.a.a, $$11, $$4);
         if ($$6) {
            $$12.a($$1, $$13, (float)$$8, -1, false, $$9, $$3, esd.a.a, 0, $$4);
         }
