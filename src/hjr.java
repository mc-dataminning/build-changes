...
public class hjr {
   ...
   private final flm n;
   private boolean o;
   private final fdg p = new fdg();
   private final fdh q = this.p.e();
   private final hjq r;
   private final hjs s = new hjs();
   private final hji t = new hji(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<hjr.a> w = new AtomicReference<>(hjr.a.c);
   private final Map<hio, hji.a> x = Maps.newHashMap();
   private final Multimap<awb, hio> y = HashMultimap.create();
   private final List<hip> z = Lists.newArrayList();
   private final Map<hio, Integer> A = Maps.newHashMap();
   private final Map<hio, Integer> B = Maps.newHashMap();
   private final List<hjt> C = Lists.newArrayList();
   private final List<hip> D = Lists.newArrayList();
   private final List<hil> E = Lists.newArrayList();

   public hjr(hju $$0, flm $$1, aus $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new hjq($$2);
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(fdf::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(hjr.a.c, hjr.a.a)) {
               String $$2 = this.n.aw().c();
               af.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(hjr.a.a, hjr.a.b);
                     }
                  ...
                  this.w.compareAndSet(hjr.a.a, hjr.a.c);
               });
            }
         }

         return this.w.compareAndSet(hjr.a.b, hjr.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(hio::s).forEach(this::c);
      this.D.clear();
      ...
      for (hip $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            faz $$3 = new faz($$0.h(), $$0.i(), $$0.j());
            hji.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<hio, hji.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<hio, hji.a> $$6 = $$5.next();
         hji.a $$7 = $$6.getValue();
         hio $$8 = $$6.getKey();
      ...
      Iterator<Entry<hio, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<hio, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            hio $$13 = $$12.getKey();
            if ($$13 instanceof hip) {
               ((hip)$$13).q();
            }
   ...
   private static boolean d(hio $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(hio $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(hio $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(hio $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != hju.e) {
                  if ($$3 == hju.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        faz $$11 = new faz($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != hio.a.a ? $$5 : Float.POSITIVE_INFINITY;
                        ...
                        if (this.q.a() <= 0.0F) {
                           ...
                           boolean $$14 = f($$0);
                           boolean $$15 = $$3.g();
                           CompletableFuture<hji.a> $$16 = this.t.a($$3.g() ? fdg.c.b : fdg.c.a);
                           hji.a $$17 = $$16.join();
                           if ($$17 == null) {
                              if (ab.aU) {
   ...
   private float g(hio $$0) {
      return ayz.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(hio $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fdf::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(fdf::e));
      }
   }
   ...
   public void a(fkq $$0) {
      if (this.o && $$0.h()) {
         fdi $$1 = new fdi($$0.b(), new faz($$0.l()), new faz($$0.m()));
