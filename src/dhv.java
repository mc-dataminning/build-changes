...
public interface dhv extends dir {
   int g = 16;
   ...
   default fds a(dhx $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dzo $$2 = this.a_($$1);
         fdw $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new fds($$0x.a(), ja.a($$3.d, $$3.e, $$3.f), iu.a((jo)$$0x.a()), false) : null;
      }, $$0x -> {
         fdw $$1 = $$0x.b().d($$0x.a());
         return fds.a($$0x.a(), ja.a($$1.d, $$1.e, $$1.f), iu.a((jo)$$0x.a()));
      });
   }
   ...
   @Nullable
   default fds a(fdw $$0, fdw $$1, iu $$2, feq $$3, dzo $$4) {
      fds $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         fds $$6 = $$4.i(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(feq $$0, Supplier<feq> $$1) {
      if (!$$0.c()) {
         return $$0.c(ja.a.b);
      } else {
   ...
   static <T, C> T a(fdw $$0, fdw $$1, C $$2, BiFunction<C, iu, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
   ...
   static Iterable<iu> a(fdw $$0, fdw $$1, fdr $$2) {
      fdw $$3 = $$1.d($$0);
   ...
   private static void a(Set<iu> $$0, fdw $$1, fdw $$2, fdr $$3) {
      fdw $$4 = $$2.d($$1);
      int $$5 = azk.a($$1.d);
      int $$6 = azk.a($$1.e);
      int $$7 = azk.a($$1.f);
      ...
      while ($$14 <= 1.0 || $$15 <= 1.0 || $$16 <= 1.0) {
         ...
         Optional<fdw> $$18 = fdr.a((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1), $$1, $$2);
         if (!$$18.isEmpty()) {
            fdw $$19 = $$18.get();
