...
public class bct {
   ...
   private bct(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bct a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bct($$0, $$1);
   }

   public bct.d a() throws IOException {
      bct.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bct.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bct.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bct.c $$3 = bct.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bct.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bct.a($$0, $$3);
            }
         }
   ...
   public bct.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bct.c> $$2 = this.a().c();
      ...
      bct.e $$4 = new bct.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bct.c b) implements bct.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bct.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bct.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bct.b> {
      private final List<bct.b> a;

      d(List<bct.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bct.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bct.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bct.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bct.d a() {
         ListIterator<bct.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bct.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bct.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bct.b> b() {
         return this.a.stream();
      }

      public Set<bct.c> c() {
         return this.a.stream().map(bct.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bct.c b) implements bct.b {
