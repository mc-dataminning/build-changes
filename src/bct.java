...
public class bct extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bjm.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bjm.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bjm.s);
