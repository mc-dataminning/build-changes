...
public class fyz {
   ...
   public void a(final fyx $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final gab $$3 = gab.a($$0.b);
      Optional<InetSocketAddress> $$4 = gad.a.a($$3).map(gaa::d);
      if ($$4.isEmpty()) {
         this.a(fmi.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final gab $$1, final fyx $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)vp.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new fyq($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(fyx.b.d);
               $$2.h = wu.b($$2xx);
               $$2.d = wu.b($$3);
               $$2.c = fyz.a($$4, $$5);
