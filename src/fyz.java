...
public class fyz {
   ...
   private fyz.a l = fyz.a.c;
   @Nullable
   private byte[] m;
   private fyz.c n;
   private fyz.b o = fyz.b.a;

   public fyz(String $$0, String $$1, fyz.c $$2) {
      this.a = $$0;
      this.b = $$1;
      this.n = $$2;
   }
   ...
   public static fyz a(tx $$0) {
      fyz $$1 = new fyz($$0.l("name"), $$0.l("ip"), fyz.c.c);
      if ($$0.b("icon", 8)) {
         try {
   ...
   public boolean d() {
      return this.n == fyz.c.a;
   }

   public boolean e() {
      return this.n == fyz.c.b;
   }
