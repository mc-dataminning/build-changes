public class fyz extends fqm<fyz.a> {
   ...
   public fyz(fmg $$0, fyy $$1, int $$2, int $$3, wp $$4) {
   ...
   public static class a extends fqm.a<fyz.a> {
      private static final int b = 157;
      private static final int c = 157;
      private static final String d = "...";
      private final fyz e;
      protected final fmg a;
      private final fyx.a f;
      private final ayl g;
      private final fqj h;
      private final ayl i;
      private final fqj j;

      public a(fmg $$0, fyz $$1, fyx.a $$2) {
         this.a = $$0;
         this.f = $$2;
         this.e = $$1;
         this.g = a($$0, $$2.d());
      ...
      private static ayl a(fmg $$0, wp $$1) {
         int $$2 = $$0.h.a($$1);
         if ($$2 > 157) {
      ...
      private static fqj b(fmg $$0, wp $$1) {
         return fqj.a($$0.h, 157, 2, $$1);
      }
      ...
      public void a(fpc $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         ...
         $$0.a(gnh::H, this.f.a(), $$3, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
         ayl $$12 = this.g;
         fqj $$13 = this.h;
         if (this.d() && (this.a.n.ac().c() || $$8 || this.e.p() == this && this.e.aM_())) {
            ...
            if (this.f.o()) {
               if ($$14 < 32) {
                  $$0.a(gnh::H, fyz.a, $$3, $$2, 32, 32);
               } else {
                  $$0.a(gnh::H, fyz.m, $$3, $$2, 32, 32);
               }
            } else {
               if (this.f.p()) {
                  if ($$14 < 16) {
                     $$0.a(gnh::H, fyz.n, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gnh::H, fyz.o, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.q()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 < 16) {
                     $$0.a(gnh::H, fyz.p, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gnh::H, fyz.q, $$3, $$2, 32, 32);
                  }
               }

               if (this.f.r()) {
                  if ($$14 < 32 && $$14 > 16 && $$15 > 16) {
                     $$0.a(gnh::H, fyz.r, $$3, $$2, 32, 32);
                  } else {
                     $$0.a(gnh::H, fyz.s, $$3, $$2, 32, 32);
                  }
               }
            }
         }
