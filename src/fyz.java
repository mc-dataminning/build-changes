...
public class fyz {
   public static final Set<amu<?>> a = Set.of(gap.a);
   ...
   public fyz(aex $$0, int $$1, int $$2, int $$3) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public fyz.a a(List<fyy> $$0, int $$1, Executor $$2) {
      ...
      for (fyy $$7 : $$0) {
         ...
         if ($$8 < $$6) {
            b.warn("Texture {} with size {}x{} limits mip level from {} to {}", new Object[]{$$7.c(), $$7.a(), $$7.b(), arx.f($$6), arx.f($$8)});
            $$6 = $$8;
         }
   ...
   public CompletableFuture<fyz.a> a(anu $$0, aex $$1, int $$2, Executor $$3) {
      return this.a($$0, $$1, $$2, $$3, a);
   }

   public CompletableFuture<fyz.a> a(anu $$0, aex $$1, int $$2, Executor $$3, Collection<amu<?>> $$4) {
      fzh $$5 = fzh.create($$4);
   ...
   private Map<aex, fze> a(fzb<fyy> $$0, int $$1, int $$2) {
      Map<aex, fze> $$3 = new HashMap<>();
      $$0.a(($$3x, $$4, $$5) -> $$3.put($$3x.c(), new fze(this.c, $$3x, $$1, $$2, $$4, $$5)));
      return $$3;
   }

   public static record a(int a, int b, int c, fze d, Map<aex, fze> e, CompletableFuture<Void> f) {
