...
public record cye(int c, int d, jg<cxt> e, Optional<cye.a> f) {
   private static final int g = 3;
   public static final MapCodec<cye> a = cye.a.a
      .flatXmap(cye::a, $$0 -> $$0.d().<DataResult>map(DataResult::success).orElseGet(() -> DataResult.error(() -> "Cannot encode unpacked recipe")));
   public static final yv<wi, cye> b = yv.a(cye::a, cye::b);

   public static cye a(Map<Character, cxt> $$0, String... $$1) {
      return a($$0, List.of($$1));
   }

   public static cye a(Map<Character, cxt> $$0, List<String> $$1) {
      cye.a $$2 = new cye.a($$0, $$1);
      return (cye)a($$2).getOrThrow();
   }

   private static DataResult<cye> a(cye.a $$0) {
      String[] $$1 = a($$0.c);
      int $$2 = $$1[0].length();
      int $$3 = $$1.length;
      jg<cxt> $$4 = jg.a($$2 * $$3, cxt.a);
      ...
      return !$$5.isEmpty()
         ...
         : DataResult.success(new cye($$2, $$3, $$4, Optional.of($$0)));
   }
   ...
   private boolean a(cpl $$0, int $$1, int $$2, boolean $$3) {
      for (int $$4 = 0; $$4 < $$0.f(); $$4++) {
         for (int $$5 = 0; $$5 < $$0.g(); $$5++) {
            int $$6 = $$4 - $$1;
            int $$7 = $$5 - $$2;
   ...
   private static cye b(wi $$0) {
      int $$1 = $$0.l();
      int $$2 = $$0.l();
      jg<cxt> $$3 = jg.a($$1 * $$2, cxt.a);
      $$3.replaceAll($$1x -> cxt.b.decode($$0));
      return new cye($$1, $$2, $$3, Optional.empty());
   }
   ...
   public Optional<cye.a> d() {
      return this.f;
   }

   public static record a(Map<Character, cxt> b, List<String> c) {
      ...
      public static final MapCodec<cye.a> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(axn.b(e, cxt.d).fieldOf("key").forGetter($$0x -> $$0x.b), d.fieldOf("pattern").forGetter($$0x -> $$0x.c)).apply($$0, cye.a::new)
      );

      public Map<Character, cxt> a() {
         return this.b;
      }
