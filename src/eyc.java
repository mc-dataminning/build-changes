...
public class eyc {
   ...
   public eyc a(int $$0, int $$1, int $$2) {
      eyc $$3 = new eyc($$0, $$1, $$2);
      $$3.d = this.d;
      $$3.e = this.e;
      $$3.f = this.f;
   ...
   public float b(eyc $$0) {
      float $$1 = (float)($$0.a - this.a);
      float $$2 = (float)($$0.c - this.c);
      return azq.c($$1 * $$1 + $$2 * $$2);
   }
   ...
   public ffs b() {
      return new ffs((double)this.a, (double)this.b, (double)this.c);
   }

   @Override
   public boolean equals(Object $$0) {
      return !($$0 instanceof eyc $$1) ? false : this.m == $$1.m && this.a == $$1.a && this.b == $$1.b && this.c == $$1.c;
   }
   ...
   public static eyc b(vy $$0) {
      eyc $$1 = new eyc($$0.readInt(), $$0.readInt(), $$0.readInt());
      a($$0, $$1);
      return $$1;
   }

   protected static void a(vy $$0, eyc $$1) {
      $$1.j = $$0.readFloat();
      $$1.k = $$0.readFloat();
      $$1.i = $$0.readBoolean();
      $$1.l = $$0.b(eyh.class);
