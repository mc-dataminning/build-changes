...
public class eyc {
   ...
   @Nullable
   private String g;
   private static final eyc.a h = new eyc.a() {
      @Nullable
      @Override
      public eyb a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (eyf.a(this.d, "Get capabilities")) {
         ...
         if (eyf.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  eyf.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !eyf.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public eyb a(eyc.c $$0) {
      return ($$0 == eyc.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements eyc.a {
      private final int a;
      private final Set<eyb> b = Sets.newIdentityHashSet();
      ...
      public eyb a() {
         if (this.b.size() >= this.a) {
            if (aa.aX) {
               eyc.a.warn("Maximum sound pool size {} reached", this.a);
            }
