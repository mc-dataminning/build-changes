...
public class aff implements yw<abl> {
   public static final yn<wa, aff> a = yw.a(aff::a, aff::new);
   ...
   private final Optional<aff.b> l;

   private aff(String $$0, int $$1, Optional<aff.b> $$2, Collection<String> $$3) {
      this.j = $$0;
      this.i = $$1;
      this.l = $$2;
   ...
   private aff(wa $$0) {
      ...
      this.i = $$0.readByte();
      if (b(this.i)) {
         this.l = Optional.of(new aff.b($$0));
      } else {
