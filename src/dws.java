...
public class dws {
   ...
   public dws(dgg $$0, ji $$1, jn $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      dwv $$0 = this.b.a_(this.e);
      if (!dwo.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.r() == etc.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(dwv $$0) {
      return $$0.a(djm.it) || $$0.a(djm.pI);
   }

   private static boolean a(dwv $$0, dwv $$1) {
      if ($$0.a(djm.pI) && $$1.a(djm.it)) {
         return false;
      } else {
         return $$0.a(djm.it) && $$1.a(djm.pI) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(ji $$0, jn $$1) {
      ...
      if ($$2.l()) {
         return true;
      } else if (!dwo.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               dwv $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.l() || !a($$5, $$2) || !dwo.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dwo.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
