...
public abstract class dws<M extends dwp<M>> {
   ...
   protected final Long2ObjectMap<ded> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   ...
   protected void a(dwv<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<ded>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<ded> $$6 = (Entry<ded>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
   ...
   protected static class a {
      ...
      public static dws.b c(byte $$0) {
         if ($$0 == 0) {
            return dws.b.a;
         } else {
            return a($$0) ? dws.b.c : dws.b.b;
         }
      }
   }
