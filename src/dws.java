...
public class dws<T> implements dxa<T> {
   private final js<T> a;
   private final aya<T> b;
   private final dxb<T> c;
   private final int d;

   public dws(js<T> $$0, int $$1, dxb<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public dws(js<T> $$0, int $$1, dxb<T> $$2) {
      this($$0, $$1, $$2, aya.c(1 << $$1));
   }

   private dws(js<T> $$0, int $$1, dxb<T> $$2, aya<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   public dxa<T> a(dxb<T> $$0) {
      return new dws<>(this.a, this.d, $$0, this.b.b());
   }
}
