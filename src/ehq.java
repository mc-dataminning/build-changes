...
public class ehq {
   ...
   private final ehq.a g;

   @Deprecated
   public static ehq a(axd $$0, ehq.a $$1) {
      return new ehq($$0, $$1, false);
   }

   public static ehq a(axd $$0, int $$1, double... $$2) {
      return b($$0, new ehq.a($$1, new DoubleArrayList($$2)));
   }

   public static ehq b(axd $$0, ehq.a $$1) {
      return new ehq($$0, $$1, true);
   }

   private ehq(axd $$0, ehq.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<ehq.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(ehq.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(ehq.a::b))
               .apply($$0, ehq.a::new)
      );
      public static final Codec<il<ehq.a>> b = ajd.a(kj.aC, a);
