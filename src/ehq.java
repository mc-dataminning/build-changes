...
public class ehq {
   ...
   static class a implements ehq.i {
      @Override
      public boolean a(ehq.v $$0) {
         return $$0.c[ih.f.d()] && !$$0.b[ih.f.d()].d;
      }

      @Override
      public ehq.r a(ih $$0, ehq.v $$1, axr $$2) {
         $$1.d = true;
         $$1.b[ih.f.d()].d = true;
         return new ehq.k($$0, $$1);
      }
   }

   static class b implements ehq.i {
      @Override
      public boolean a(ehq.v $$0) {
      ...
      public ehq.r a(ih $$0, ehq.v $$1, axr $$2) {
         ...
         return new ehq.l($$0, $$1);
      }
   }

   static class c implements ehq.i {
      @Override
      public boolean a(ehq.v $$0) {
      ...
      public ehq.r a(ih $$0, ehq.v $$1, axr $$2) {
         $$1.d = true;
         $$1.b[ih.b.d()].d = true;
         return new ehq.m($$0, $$1);
      }
   }

   static class d implements ehq.i {
      @Override
      public boolean a(ehq.v $$0) {
      ...
      public ehq.r a(ih $$0, ehq.v $$1, axr $$2) {
         ...
         return new ehq.n($$0, $$1);
      }
   }

   static class e implements ehq.i {
      @Override
      public boolean a(ehq.v $$0) {
      ...
      public ehq.r a(ih $$0, ehq.v $$1, axr $$2) {
         ...
         $$3.d = true;
         $$3.b[ih.c.d()].d = true;
         return new ehq.o($$0, $$3);
      }
   }

   static class f implements ehq.i {
      @Override
      public boolean a(ehq.v $$0) {
         return true;
      }
      ...
      public ehq.r a(ih $$0, ehq.v $$1, axr $$2) {
         $$1.d = true;
         return new ehq.s($$0, $$1, $$2);
      }
   }

   static class g implements ehq.i {
      @Override
      public boolean a(ehq.v $$0) {
      ...
      public ehq.r a(ih $$0, ehq.v $$1, axr $$2) {
         $$1.d = true;
         return new ehq.t($$0, $$1);
      }
   }

   public static class h extends ehq.r {
      ...
      private ehq.v G;
      private ehq.v H;
      private final List<ehq.r> I = Lists.newArrayList();

      public h(axr $$0, int $$1, int $$2, ih $$3) {
         super(efy.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ehq.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ehq.p($$3, this.G));
         this.I.add(new ehq.j($$3, this.H));
         List<ehq.i> $$5 = Lists.newArrayList();
         $$5.add(new ehq.b());
         $$5.add(new ehq.d());
         $$5.add(new ehq.e());
         $$5.add(new ehq.a());
         ...
         eez $$10 = eez.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eez $$11 = eez.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eez $$12 = eez.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ehq.u($$3, $$10, $$13++));
         this.I.add(new ehq.u($$3, $$11, $$13++));
         this.I.add(new ehq.q($$3, $$12));
      }
      ...
      private List<ehq.v> b(axr $$0) {
         ehq.v[] $$1 = new ehq.v[75];
         ...
         ehq.v $$23 = new ehq.v(1003);
         ehq.v $$24 = new ehq.v(1001);
         ehq.v $$25 = new ehq.v(1002);
         $$1[v].a(ih.b, $$23);
         $$1[w].a(ih.d, $$24);
         $$1[x].a(ih.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ehq.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, czs $$2, axr $$3, eez $$4) {
         int $$5 = 24;
      ...
      private void a(czs $$0, axr $$1, eez $$2) {
      ...
      private void b(czs $$0, axr $$1, eez $$2) {
      ...
      private void c(czs $$0, axr $$1, eez $$2) {
      ...
      private void d(czs $$0, axr $$1, eez $$2) {
      ...
      private void e(czs $$0, axr $$1, eez $$2) {
      ...
      private void f(czs $$0, axr $$1, eez $$2) {
   ...
   interface i {
      boolean a(ehq.v var1);

      ehq.r a(ih var1, ehq.v var2, axr var3);
   }

   public static class j extends ehq.r {
      public j(ih $$0, ehq.v $$1) {
         super(efy.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(czs $$0, czq $$1, dqw $$2, axr $$3, eez $$4, cye $$5, ib $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dca.ch.n(), dca.ch.n(), false);
   ...
   public static class k extends ehq.r {
      public k(ih $$0, ehq.v $$1) {
         super(efy.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ehq.r {
      public l(ih $$0, ehq.v $$1) {
         super(efy.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ehq.r {
      public m(ih $$0, ehq.v $$1) {
         super(efy.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ehq.r {
      public n(ih $$0, ehq.v $$1) {
         super(efy.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ehq.r {
      public o(ih $$0, ehq.v $$1) {
         super(efy.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ehq.r {
      public p(ih $$0, ehq.v $$1) {
         super(efy.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ehq.r {
      public q(ih $$0, eez $$1) {
         super(efy.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends efl {
      protected static final doz b = dca.hZ.n();
      protected static final doz c = dca.ia.n();
      protected static final doz d = dca.ib.n();
      protected static final doz h = c;
      protected static final doz i = dca.ii.n();
      protected static final boolean j = true;
      protected static final doz k = dca.G.n();
      protected static final Set<dby> l = ImmutableSet.builder().add(dca.dO).add(dca.iC).add(dca.mW).add(k.b()).build();
      ...
      public r(efy $$0, ih $$1, int $$2, eez $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(efy $$0, int $$1, ih $$2, ehq.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eez a(ih $$0, ehq.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eez $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(czs $$0, eez $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  doz $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(czs $$0, eez $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(czs $$0, eez $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, doz $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eez $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(czs $$0, eez $$1, int $$2, int $$3, int $$4) {
         ib $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cgo $$6 = bqb.D.a((cyx)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eO());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), bqs.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ehq.r {
      private int a;

      public s(ih $$0, ehq.v $$1, axr $$2) {
         super(efy.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ehq.r {
      public t(ih $$0, ehq.v $$1) {
         super(efy.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ehq.r {
      private int a;

      public u(ih $$0, eez $$1, int $$2) {
         super(efy.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
