...
public abstract class cuq {
   ...
   private final jn<cyy> n = jn.a();
   public final jn<cwn> k = jn.a();
   private final List<cvk> o = Lists.newArrayList();
   private cyy p = cyy.k;
   private final jn<cyy> q = jn.a();
   ...
   private int v = -1;
   private int w;
   private final Set<cwn> x = Sets.newHashSet();
   private final List<cve> y = Lists.newArrayList();
   @Nullable
   private cvf z;
   private boolean A;

   protected cuq(@Nullable cvz<?> $$0, int $$1) {
      this.u = $$0;
      this.l = $$1;
   }

   protected void a(btu $$0, int $$1, int $$2) {
      for (int $$3 = 0; $$3 < 9; $$3++) {
         this.a(new cwn($$0, $$3, $$1 + $$3 * 18, $$2));
      }
   }

   protected void b(btu $$0, int $$1, int $$2) {
      for (int $$3 = 0; $$3 < 3; $$3++) {
         for (int $$4 = 0; $$4 < 9; $$4++) {
            this.a(new cwn($$0, $$4 + ($$3 + 1) * 9, $$1 + $$4 * 18, $$2 + $$3 * 18));
         }
      }
   }

   protected void c(btu $$0, int $$1, int $$2) {
      this.b($$0, $$1, $$2);
      int $$3 = 4;
      int $$4 = 58;
      this.a($$0, $$1, $$2 + 58);
   ...
   protected static boolean a(cvd $$0, cqy $$1, dma $$2) {
   ...
   protected static void a(btu $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   protected static void a(cvc $$0, int $$1) {
      int $$2 = $$0.a();
      if ($$2 < $$1) {
   ...
   public void d() {
      for (int $$0 = 0; $$0 < this.k.size(); $$0++) {
         cyy $$1 = this.k.get($$0).g();
         Supplier<cyy> $$2 = Suppliers.memoize($$1::v);
         this.a($$0, $$1, $$2);
         this.b($$0, $$1, $$2);
      }
   ...
   private void a(int $$0, cyy $$1, Supplier<cyy> $$2) {
      cyy $$3 = this.n.get($$0);
      if (!cyy.a($$3, $$1)) {
         cyy $$4 = $$2.get();
         this.n.set($$0, $$4);
   ...
   private void b(int $$0, cyy $$1, Supplier<cyy> $$2) {
      if (!this.A) {
         cyy $$3 = this.q.get($$0);
         if (!cyy.a($$3, $$1)) {
            cyy $$4 = $$2.get();
   ...
   public abstract cyy b(cqy var1, int var2);

   public void a(int $$0, int $$1) {
      if ($$0 >= 0 && $$0 < this.k.size()) {
         cyy $$2 = this.k.get($$0).g();
         cxn.a($$2, $$1);
      }
   }

   public void a(int $$0, int $$1, cvb $$2, cqy $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cvb $$2, cqy $$3) {
      cqx $$4 = $$3.gi();
      if ($$2 == cvb.f) {
         int $$5 = this.w;
         this.w = d($$1);
         ...
         this.f();
      } else if (($$2 == cvb.a || $$2 == cvb.b) && ($$1 == 0 || $$1 == 1)) {
         cva $$16 = $$1 == 0 ? cva.a : cva.b;
         if ($$0 == -999) {
            if (!this.g().f()) {
               if ($$16 == cva.a) {
                  $$3.a(this.g(), true);
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.f()) {
                  if (!$$21.f()) {
                     int $$22 = $$16 == cva.a ? $$21.M() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.f()) {
                     int $$23 = $$16 == cva.a ? $$20.M() : ($$20.M() + 1) / 2;
                     Optional<cyy> $$24 = $$19.a($$23, Integer.MAX_VALUE, $$3);
                     $$24.ifPresent($$2x -> {
                        this.b($$2x);
                        $$19.a($$3, $$2x);
                     });
                     ...
                     Optional<cyy> $$26 = $$19.a($$20.M(), $$21.k() - $$21.M(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.M());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cvb.d && $$3.fU() && this.g().f() && $$0 >= 0) {
         cwn $$32 = this.k.get($$0);
         if ($$32.h()) {
            cyy $$33 = $$32.g();
            this.b($$33.c($$33.k()));
         }
      } else if ($$2 == cvb.e && this.g().f() && $$0 >= 0) {
         cwn $$34 = this.k.get($$0);
         int $$35 = $$1 == 0 ? 1 : $$34.g().M();
         if (!$$3.gm()) {
            return;
         ...
         cyy $$36 = $$34.b($$35, Integer.MAX_VALUE, $$3);
         $$3.a($$36, true);
         $$3.h($$36);
         if ($$1 == 1) {
            while (!$$36.f() && cyy.b($$34.g(), $$36)) {
               if (!$$3.gm()) {
                  return;
               }
         ...
         if (!$$38.f() && (!$$37.h() || !$$37.a($$3))) {
            ...
            for (int $$41 = 0; $$41 < 2; $$41++) {
               for (int $$42 = $$39; $$42 >= 0 && $$42 < this.k.size() && $$38.M() < $$38.k(); $$42 += $$40) {
                  cwn $$43 = this.k.get($$42);
                  if ($$43.h() && a($$43, $$38, true) && $$43.a($$3) && this.a($$38, $$43)) {
                     cyy $$44 = $$43.g();
                     if ($$41 != 0 || $$44.M() != $$44.k()) {
                        cyy $$45 = $$43.b($$44.M(), $$38.k() - $$38.M(), $$3);
                        $$38.g($$45.M());
                     }
                  }
               }
   ...
   private boolean a(cqy $$0, cva $$1, cwn $$2, cyy $$3, cyy $$4) {
      cuh $$5 = $$0.dV().K();
   ...
   private static void a(cqy $$0, cyy $$1) {
      boolean $$2;
      boolean var10000;
      label27: {
         $$2 = $$0.dQ() && $$0.dR() != bwd.e.e;
   ...
   public void a(int $$0, int $$1, cyy $$2) {
      this.b($$0).f($$2);
      this.t = $$1;
   }

   public void a(int $$0, List<cyy> $$1, cyy $$2) {
   ...
   public abstract boolean b(cqy var1);

   protected boolean a(cyy $$0, int $$1, int $$2, boolean $$3) {
      boolean $$4 = false;
      int $$5 = $$1;
      if ($$3) {
         $$5 = $$2 - 1;
   ...
   public static boolean a(int $$0, cqy $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable cwn $$0, cyy $$1, boolean $$2) {
      boolean $$3 = $$0 == null || !$$0.h();
      return !$$3 && cyy.c($$1, $$0.g()) ? $$0.g().M() + ($$2 ? 0 : $$1.M()) <= $$1.k() : $$3;
   }

   public static int a(Set<cwn> $$0, int $$1, cyy $$2) {
      return switch ($$1) {
   ...
   public static int a(@Nullable dwx $$0) {
      return $$0 instanceof btu ? b((btu)$$0) : 0;
   }

   public static int b(@Nullable btu $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cuq $$0) {
      Table<btu, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(btu $$0, int $$1) {
