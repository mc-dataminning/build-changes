...
public class fkm extends hhw implements fhw {
   ...
   private final int K;
   final AtomicReference<fhv> a = new AtomicReference<>();
   private final fhm L;
   ...
   private fof V;
   private int W;
   private final fru X = new fru(this);

   public fkm(@Nullable flh $$0, long $$1, int $$2, fkf $$3, ewe $$4) {
      super(flx.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aT_() {
      this.U = this.X.b(fof.a(xu.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.X.b(fof.a(xu.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.J();
            ...
            this.m.a(new fjy(this.G, $$0.toArray(new flf[0])));
         }
      }
   ...
   private void E() {
      this.m.a(new fjs(new fhd(new fua()), this.J));
   }
   ...
   private void J() {
      ...
      fip $$1 = fip.a(this.H.g(), this.H.l().c());
      fhv $$2 = new fhv($$0, $$1, this.m.X(), this.J, this.K, this);
