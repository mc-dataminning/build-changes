...
public class air {
   ...
   private static int a(ds $$0) {
      if (h != null) {
         h.b();
         $$0.a(() -> vf.b("You have now stopped chasing"), false);
         h = null;
      }

      if (g != null) {
         g.b();
         $$0.a(() -> vf.b("You are no longer being chased"), false);
         g = null;
      }
   ...
   private static boolean b(ds $$0) {
      if (g != null) {
         $$0.b(vf.b("Chase server is already running. Stop it using /chase stop"));
         return true;
      } else if (h != null) {
         $$0.b(vf.b("You are already chasing someone. Stop it using /chase stop"));
         return true;
      } else {
         return false;
      }
   ...
   private static int a(ds $$0, String $$1, int $$2) {
      if (b($$0)) {
         ...
         g = new aij($$1, $$2, $$0.l().ae(), 100);

         try {
            g.a();
            $$0.a(() -> vf.b("Chase server is now running on port " + $$2 + ". Clients can follow you using /chase follow <ip> <port>"), false);
         } catch (IOException var4) {
            b.error("Failed to start chase server", var4);
            $$0.b(vf.b("Failed to start chase server on port " + $$2));
            g = null;
         }
