...
public class ben extends bau {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), ben::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", ben::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", ben::k);
         $$0 = this.a($$0, "minecraft:fox", ben::j);
         $$0 = this.a($$0, "minecraft:item", ben::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", ben::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", ben::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", ben::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", ben::e);
         return this.a($$0, "minecraft:piglin", ben::d);
      });
   }
