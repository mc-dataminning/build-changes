...
public class ben extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bhk.B);
      return this.fixTypeEverywhereTyped(
         "Fix AbstractArrow item type",
         $$0,
         $$1,
         ban.a(this.a("minecraft:trident", ben::c), this.a("minecraft:arrow", ben::a), this.a("minecraft:spectral_arrow", ben::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, ben.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(bhk.B, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(bhk.B, $$0);
      return a($$0, $$1, $$2, $$3);
   }

   private static <T> Function<Typed<?>, Typed<?>> a(String $$0, ben.a<?> $$1, Type<?> $$2, Type<T> $$3) {
