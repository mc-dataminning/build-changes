...
public class bfh extends bbj {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bfh::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bfh::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bfh::k);
         $$0 = this.a($$0, "minecraft:fox", bfh::j);
         $$0 = this.a($$0, "minecraft:item", bfh::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bfh::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bfh::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bfh::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bfh::e);
         return this.a($$0, "minecraft:piglin", bfh::d);
      });
   }
