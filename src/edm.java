...
public class edm extends edp<edl> {
   public edm(Codec<edl> $$0) {
      super($$0);
   }

   public boolean a(edl $$0, azv $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(edk $$0, edl $$1, dxj $$2, Function<jh, jq<dgh>> $$3, azv $$4, eav $$5, del $$6, dxi $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         edp.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      edk $$0, edl $$1, dxj $$2, Function<jh, jq<dgh>> $$3, eav $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dxi $$10, edp.a $$11
   ) {
      double $$12 = 1.5 + (double)(azn.a((float) (Math.PI / 2)) * $$8);
      double $$13 = $$12 * $$9;
   ...
   protected void a(
      ...
      for (int $$24 = $$14; $$24 < $$15; $$24++) {
         double $$25 = 1.5 + (double)(azn.a((float) Math.PI * (float)$$24 / (float)$$15) * $$11);
         double $$26 = $$25 * $$16;
         float $$27 = azn.b($$13);
         $$6 += (double)(azn.b($$12) * $$27);
         $$7 += (double)azn.a($$13);
         $$8 += (double)(azn.a($$12) * $$27);
         $$13 *= $$21 ? 0.92F : 0.7F;
         $$13 += $$23 * 0.1F;
         $$12 += $$22 * 0.1F;
         $$23 *= 0.9F;
