...
public class edm implements edo {
   public static final Codec<edm> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bpl.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bpl.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bpl.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bpj.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bpj.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public edm(int $$0, bpl $$1, bpl $$2, int $$3, int $$4, bpl $$5, bpj $$6, bpj $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
