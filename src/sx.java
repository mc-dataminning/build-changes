...
public class sx {
   ...
   private jd c;
   private final aqu d;
   private final Collection<sy> e = Lists.newArrayList();
   private final int f;
   private final Collection<tb> g = Lists.newCopyOnWriteArrayList();
   ...
   public sx(tr $$0, dmm $$1, aqu $$2, tk $$3) {
      this.a = $$0;
      this.d = $$2;
      this.o = $$3;
      this.f = $$0.f();
   ...
   public void a(ta $$0) {
      if (!this.j()) {
         ...
         if (this.l || tn.b(this.t).b().allMatch($$0x -> this.d.f($$0x.l()))) {
            this.l = true;
            if (this.C()) {
               this.D();
               if (this.j()) {
   ...
   private void D() {
      ...
      if (this.m >= 0L) {
         ...
         if (this.m > (long)this.f) {
            if (this.g.isEmpty()) {
               this.a(new te("Didn't succeed or fail within " + this.a.f() + " ticks"));
            } else {
               this.g.forEach($$0x -> $$0x.b(this.m));
               if (this.s == null) {
                  this.a(new te("No sequences finished"));
               }
            }
         } else {
   ...
   public sx n() {
      jd $$0 = this.G();
      this.t = tn.a(this, $$0, this.t(), this.d);
      this.b = this.t.aD_();
      tn.a(this.b, new jd(1, 0, -1), this.t(), this.d);
      tn.a(this.d(), this.d, !this.a.l());
   ...
   public sx B() {
      sx $$0 = new sx(this.a, this.r, this.d, this.z());
      if (this.c != null) {
         $$0.b(this.c);
      }
