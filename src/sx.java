...
public class sx extends sz<sy> {
   private static final int b = 24;
   public static final tz<sx> a = new tz.b<sx>() {
      public sx a(DataInput $$0, tj $$1) throws IOException {
         return new sx(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof sx && Arrays.equals(this.c, ((sx)$$0).c);
   }
   ...
   public sy a(int $$0, sy $$1) {
      byte $$2 = this.c[$$0];
      this.c[$$0] = $$1.i();
      return sy.a($$2);
   }

   public void b(int $$0, sy $$1) {
   ...
   public boolean b(int $$0, tx $$1) {
      if ($$1 instanceof tq) {
         this.c = ArrayUtils.add(this.c, $$0, ((tq)$$1).i());
         return true;
      } else {
         return false;
      }
