...
public class fhs implements AutoCloseable {
   ...
   public fhs(fhq $$0, fhr $$1, int $$2) {
      ...
      if ($$1.k) {
         this.b();
         GlStateManager._glBufferData($$0.h, (long)$$2, $$1.j);
         c.malloc((long)this.a, $$2);
         this.g = true;
      }
   }

   public fhs(fhq $$0, fhr $$1, ByteBuffer $$2) {
   ...
   public void c() {
      GlStateManager._glBindBuffer(this.d.h, 0);
   }
