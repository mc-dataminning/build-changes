...
public class fhs extends fhu {
   public static final int a = 854;
   public static final int b = 480;
   static final fhs.b l = new fhs.b(854, 480);

   public fhs(int $$0, int $$1) {
      super(true);
      this.e($$0, $$1);
   }
   ...
   static enum a {
      ...
      private static final fhs.a[] e = values();
   ...
   static class b {
      ...
      static List<fhs.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new fhs.b($$0, $$1), fhs.l) : ImmutableList.of(fhs.l);
      }
