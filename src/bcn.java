...
public class bcn extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkHeightAndBiomeFix", $$0, $$4, $$4x -> $$4x.updateTyped($$1, $$5, $$3xx -> {
            ...
            MutableObject<Supplier<bcq.a>> $$14 = new MutableObject((Supplier<bcq.a>)() -> null);
            ...
            return $$3xx.update(DSL.remainderFinder(), $$5xx -> {
               ...
               return a($$5xx, $$8, $$9.booleanValue(), "minecraft:noise".equals($$7), (Supplier<bcq.a>)$$14.getValue());
            });
         }));
   }
   ...
   private static Dynamic<?> a(Dynamic<?> $$0, boolean $$1, boolean $$2, boolean $$3, Supplier<bcq.a> $$4) {
      $$0 = $$0.remove("Biomes");
      if (!$$1) {
         return a($$0, 16, 0);
      } else if ($$2) {
