...
public class fae {
   ...
   public static final fae.a bv;

   public static fae.a a(int $$0, int $$1) {
      return $$0 == -1 ? fae.b.b.a($$1) : fae.b.a.a($$0);
   }

   public static fae.a a(String $$0) {
      if (fae.a.e.containsKey($$0)) {
         return fae.a.e.get($$0);
      } else {
         for (fae.b $$1 : fae.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      static final Map<String, fae.a> e = Maps.newHashMap();

      a(String $$0, fae.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<fae.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wz> g;

      private static void a(fae.b $$0, String $$1, int $$2) {
         fae.a $$3 = new fae.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public fae.a a(int $$0) {
         return (fae.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
