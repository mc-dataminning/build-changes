...
public class fae extends fau {
   ...
   private long c = -1L;
   private boolean k;
   private static final Object2IntMap<djj> l = ac.a(new Object2IntOpenHashMap(), $$0 -> {
      $$0.defaultReturnValue(0);
      $$0.put(djj.c, 5526612);
      $$0.put(djj.d, 10066329);
      $$0.put(djj.e, 6250897);
      $$0.put(djj.f, 8434258);
      $$0.put(djj.g, 13750737);
      $$0.put(djj.h, 7497737);
      $$0.put(djj.i, 3159410);
      $$0.put(djj.j, 2213376);
      $$0.put(djj.k, 13421772);
      $$0.put(djj.l, 16769184);
      $$0.put(djj.m, 15884384);
      $$0.put(djj.n, 16777215);
   });
   ...
   protected void b(eys $$0) {
      if (this.k) {
         $$0.a(eyr.a, ur.c("narrator.loading.done"));
      } else {
         $$0.a(eyr.a, this.l());
      }
   }
   ...
   private ur l() {
      return ur.a("loading.progress", atm.a(this.b.e(), 0, 100));
   }
   ...
   public static void a(euo $$0, amr $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = $$4 + $$5;
      int $$7 = $$1.c();
      int $$8 = $$7 * $$6 - $$5;
      int $$9 = $$1.d();
