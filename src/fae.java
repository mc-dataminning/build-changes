public class fae extends fbo<bsp> implements fag {
   private final fee a;
   private final fee b;
   private final fee f;
   private final fee g;
   ...
   public static fek b() {
      ...
      fen $$3 = $$2.a(
         "body",
         fej.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new fei(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new fei(-0.2F)),
         feg.a(0.0F, -4.0F, 0.0F)
      );
   ...
   public void a(bsp $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.fY()) {
         ...
         float $$14 = apa.b($$13) * 16.0F * (float) (Math.PI / 180.0);
         float $$15 = $$0.E($$8);
         float $$16 = apa.b($$13) * 14.0F * (float) (Math.PI / 180.0);
         float $$17 = apa.b($$13) * 30.0F * (float) (Math.PI / 180.0);
      ...
      float $$18 = $$12 * apa.i($$10, (float) (-Math.PI / 3), -1.134464F);
      this.a.c = this.a.c + (float)Math.cos((double)$$9) * 0.25F * $$11;
      this.g.e = $$18;
      this.h.e = $$18;
      float $$19 = $$11 * (1.0F - $$12);
      float $$20 = 0.43633232F - apa.b($$9 + (float) (Math.PI * 3.0 / 2.0)) * (float) Math.PI * 0.075F * $$19;
      this.h.g = -$$20;
      this.g.g = $$20;
