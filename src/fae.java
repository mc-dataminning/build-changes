public abstract class fae extends fai implements fbn, fcg {
   private static final fbx a = new fbx(new ajc("widget/text_field"), new ajc("widget/text_field_highlighted"));
   private static final ajc b = new ajc("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public fae(int $$0, int $$1, int $$2, int $$3, vs $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return awm.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = awm.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(ezx $$0, int $$1, int $$2, int $$3, int $$4) {
      ajc $$5 = a.a(this.A(), this.aK_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(ezx var1, int var2, int var3, float var4);
}
