...
public interface fae {
   fae a(double var1, double var3, double var5);

   fae a(int var1, int var2, int var3, int var4);

   fae a(float var1, float var2);

   fae a(int var1, int var2);

   fae b(int var1, int var2);

   fae a(float var1, float var2, float var3);
   ...
   default fae a(float $$0, float $$1, float $$2, float $$3) {
   ...
   default void a(faa.a $$0, gen $$1, float $$2, float $$3, float $$4, float $$5, int $$6, int $$7) {
      this.a($$0, $$1, new float[]{1.0F, 1.0F, 1.0F, 1.0F}, $$2, $$3, $$4, $$5, new int[]{$$6, $$6, $$6, $$6}, $$7, false);
   }

   default void a(faa.a $$0, gen $$1, float[] $$2, float $$3, float $$4, float $$5, float $$6, int[] $$7, int $$8, boolean $$9) {
      ...
      try {
         ByteBuffer $$19 = $$18.malloc(ezy.j.b());
   ...
   default fae a(faa.a $$0, float $$1, float $$2, float $$3) {
      return this.a($$0.a(), $$1, $$2, $$3);
   }

   default fae a(Matrix4f $$0, float $$1, float $$2, float $$3) {
      Vector3f $$4 = $$0.transformPosition($$1, $$2, $$3, new Vector3f());
      return this.a((double)$$4.x(), (double)$$4.y(), (double)$$4.z());
   }

   default fae b(faa.a $$0, float $$1, float $$2, float $$3) {
