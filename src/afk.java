...
public class afk<C extends bhu> implements afj<Integer> {
   private static final Logger d = LogUtils.getLogger();
   protected final cdb a = new cdb();
   protected ccw b;
   protected cgz<C> c;
   ...
   public void a(alr $$0, @Nullable cno<? extends cnn<C>> $$1, boolean $$2) {
      if ($$1 != null && $$0.G().b($$1)) {
         this.b = $$0.fS();
         if (this.b() || $$0.f()) {
            this.a.a();
            $$0.fS().a(this.a);
            this.c.a(this.a);
            if (this.a.a((cnn<?>)$$1.b(), null)) {
               this.a($$1, $$2);
            } else {
               this.a();
               $$0.c.b(new zr($$0.bS.j, $$1));
            }
   ...
   protected void a(cno<? extends cnn<C>> $$0, boolean $$1) {
   ...
   private boolean b() {
      ...
      for (int $$2 = 0; $$2 < this.c.n() * this.c.o() + 1; $$2++) {
         if ($$2 != this.c.m()) {
            ckj $$3 = this.c.b($$2).e().p();
            if (!$$3.b()) {
               int $$4 = this.b.d($$3);
               if ($$4 == -1 && $$0.size() <= $$1) {
                  for (ckj $$5 : $$0) {
                     if (ckj.b($$5, $$3) && $$5.L() != $$5.g() && $$5.L() + $$3.L() <= $$5.g()) {
                        $$5.g($$3.L());
                        $$3.f(0);
                        break;
                     }
