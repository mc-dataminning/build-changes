...
public class gdq implements AutoCloseable {
   ...
   private final List<gdr> e = Lists.newArrayList();
   private final Map<String, eyj> f = Maps.newHashMap();
   private final List<eyj> g = Lists.newArrayList();
   private Matrix4f h;
   private int i;
   private int j;
   private float k;
   ...
   public gdq(goz $$0, aur $$1, eyj $$2, ale $$3) throws IOException, JsonSyntaxException {
      this.c = $$1;
      this.b = $$2;
      this.k = 0.0F;
      this.l = 0.0F;
   ...
   private void a(goz $$0, ale $$1) throws IOException, JsonSyntaxException {
      aum $$2 = this.c.getResourceOrThrow($$1);

      try {
         try (Reader $$3 = $$2.e()) {
            JsonObject $$4 = ayo.a($$3);
            if (ayo.d($$4, "targets")) {
   ...
   private void a(JsonElement $$0) throws alh {
      if (ayo.a($$0)) {
         ...
         JsonObject $$1 = ayo.m($$0, "target");
         String $$2 = ayo.i($$1, "name");
         int $$3 = ayo.a($$1, "width", this.i);
         int $$4 = ayo.a($$1, "height", this.j);
   ...
   private void a(goz $$0, JsonElement $$1) throws IOException {
      JsonObject $$2 = ayo.m($$1, "pass");
      String $$3 = ayo.i($$2, "name");
      String $$4 = ayo.i($$2, "intarget");
      String $$5 = ayo.i($$2, "outtarget");
      eyj $$6 = this.b($$4);
      eyj $$7 = this.b($$5);
      boolean $$8 = ayo.a($$2, "use_linear_filter", false);
      if ($$6 == null) {
         throw new alh("Input target '" + $$4 + "' does not exist");
      } else if ($$7 == null) {
         throw new alh("Output target '" + $$5 + "' does not exist");
      } else {
         gdr $$9 = this.a($$3, $$6, $$7, $$8);
         JsonArray $$10 = ayo.a($$2, "auxtargets", null);
         if ($$10 != null) {
            int $$11 = 0;

            for (JsonElement $$12 : $$10) {
               try {
                  JsonObject $$13 = ayo.m($$12, "auxtarget");
                  String $$14 = ayo.i($$13, "name");
                  String $$15 = ayo.i($$13, "id");
                  boolean $$16;
                  String $$17;
                  ...
                  if ($$20 == null) {
                     ...
                     $$0.a($$21);
                     goj $$22 = $$0.b($$21);
                     int $$23 = ayo.o($$13, "width");
                     int $$24 = ayo.o($$13, "height");
                     boolean $$25 = ayo.k($$13, "bilinear");
                     if ($$25) {
         ...
         JsonArray $$28 = ayo.a($$2, "uniforms", null);
         if ($$28 != null) {
            int $$29 = 0;
   ...
   private void b(JsonElement $$0) throws alh {
      ...
      String $$2 = ayo.i($$1, "name");
      ezo $$3 = this.e.get(this.e.size() - 1).b().a($$2);
      if ($$3 == null) {
         ...
         for (JsonElement $$7 : ayo.v($$1, "values")) {
            try {
               $$4[$$5] = ayo.e($$7, "value");
   ...
   public eyj a(String $$0) {
      return this.f.get($$0);
   }

   public void a(String $$0, int $$1, int $$2) {
      eyj $$3 = new eyk($$1, $$2, true, ffe.a);
   ...
   public gdr a(String $$0, eyj $$1, eyj $$2, boolean $$3) throws IOException {
      gdr $$4 = new gdr(this.c, $$0, $$1, $$2, $$3);
   ...
   @Nullable
   private eyj b(@Nullable String $$0) {
      if ($$0 == null) {
         return null;
      } else {
