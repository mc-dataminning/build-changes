public class gdq extends gdn {
   private final gdi a;
   private static final int b = 8;

   protected gdq(fzf $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gdi $$8) {
      ...
      this.l += $$6;
      this.D *= 0.75F * $$7;
      this.t = (int)(8.0F / ayo.b(this.r, 0.5F, 1.0F) * $$7);
   ...
   public static class a implements gcq<lq> {
      ...
      public gcn a(lq $$0, fzf $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gdq($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
