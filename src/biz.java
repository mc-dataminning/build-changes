...
public class biz extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<?> $$0 = this.getInputSchema().getType(bjm.y);
      Type<?> $$1 = this.getOutputSchema().getType(bjm.y);
   ...
   private static <T> Dynamic<T> a(DynamicOps<T> $$0, String $$1) {
      try {
         return new Dynamic($$0, vb.a($$0).b($$1));
   ...
   private <T> Dynamic<T> b(Dynamic<T> $$0, String $$1) {
      ...
      if ($$2 == -1) {
         $$3 = $$3.set("Name", $$0.createString(blh.a($$1)));
      } else {
         $$3 = $$3.set("Name", $$0.createString(blh.a($$1.substring(0, $$2))));
   ...
   private <T> Dynamic<T> g(Dynamic<T> $$0, String $$1) {
      try {
         ...
         $$2.expect(' ');
         int $$6 = $$2.readInt();
         Dynamic<T> $$7 = $$0.createIntList(IntStream.of(azz.d($$3), azz.d($$4), azz.d($$5)));
