...
public class biz extends bhs {
   public biz(Schema $$0) {
      super($$0, false, "RemoveEmptyItemInSuspiciousBlockFix", bix.s, "minecraft:brushable_block");
   }
   ...
   private static boolean b(Dynamic<?> $$0) {
      String $$1 = bks.a($$0.get("id").asString("minecraft:air"));
