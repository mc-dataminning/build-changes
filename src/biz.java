...
public abstract class biz extends DataFix {
   private final String a;

   public biz(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(bin.z.typeName(), bkb.a());
      if (!Objects.equals(this.getOutputSchema().getType(bin.z), $$2)) {
