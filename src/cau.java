...
public class cau extends cal {
   ...
   public void b() {
      ...
      if (this.e % 2 == 0 && this.e < 10) {
         ...
         for (int $$4 = 0; $$4 < 8; $$4++) {
            ...
            for (int $$8 = 0; $$8 < 6; $$8++) {
               this.a.dM().a(jx.i, $$5, $$6, $$7, -$$0.c * 0.08F * (double)$$8, -$$0.d * 0.6F, -$$0.e * 0.08F * (double)$$8);
            }
   ...
   public void c() {
      ...
      if (this.e >= 200) {
         ...
         elm $$0 = new elm(this.a.e.dr() - this.a.dr(), 0.0, this.a.e.dx() - this.a.dx()).d();
         float $$1 = 5.0F;
         ...
         $$5 = (double)(aui.a($$5) + 1);
         this.g = new blm(this.a.dM(), $$2, $$5, $$3);
         this.g.a(this.a);
         this.g.a(5.0F);
         this.g.b(200);
         this.g.a(jx.i);
         this.g.a(new blc(ble.g));
         this.a.dM().b(this.g);
      }
   }
