...
public class yh implements wx {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ays.b.validate(yh::b);
   private static final Codec<Object> e = Codec.either(d, wy.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof ww $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<yh> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final wx.a<yh> c = new wx.a<>(b, "translatable");
   private static final xb f = xb.e("%");
   private static final xb g = xb.e("null");
   ...
   @Nullable
   private ts k;
   private List<xb> l = ImmutableList.of();
   ...
   private static yh a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new yh($$0, $$1.orElse(null), a($$2));
   }

   public yh(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<xb> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yi var4) {
            this.l = ImmutableList.of(xb.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<xb> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yi(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private xb a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof ww) {
            ...
            return $$1 == null ? g : xb.e($$1.toString());
         }
      } else {
         throw new yi(this, $$0);
      }
   ...
   public xk a(@Nullable ei $$0, @Nullable bwa $$1, int $$2) throws CommandSyntaxException {
      ...
      return xk.a(new yh(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof yh $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
