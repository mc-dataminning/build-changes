...
public record yh<S>(List<yh.a<S>> a) {
   public static <S> boolean a(ParseResults<S> $$0) {
      return !b($$0).a().isEmpty();
   }

   public static <S> yh<S> b(ParseResults<S> $$0) {
   ...
   private static <S> List<yh.a<S>> a(String $$0, CommandContextBuilder<S> $$1) {
      List<yh.a<S>> $$2 = new ArrayList<>();
