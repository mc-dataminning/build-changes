...
public class bzs {
   ...
   public static bxv<bwj> a(float $$0) {
      ...
      return cbh.a(
         (Function<cbh.b<bwj>, ? extends App<cbh.c<bwj>, cbk<bwj>>>)($$3 -> $$3.group($$3.c(cff.m), $$3.c(cff.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.ac() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        chf $$7 = $$4x.z();
                        Optional<jh> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(chj.n), $$5.dv(), 48, chf.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dv()) <= 4.0)) {
                           ...
                           Set<Pair<jq<chi>, jh>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(chj.n), $$10, $$5.dv(), 48, chf.b.c).collect(Collectors.toSet());
                           eud $$12 = bxn.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              jh $$13 = $$12.l();
                              Optional<jq<chi>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new cfi($$13, $$0, 1));
                                 ahj.c($$4x, $$13);
                              }
