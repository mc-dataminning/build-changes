...
public class dei {
   public static final dei a = new dei(ImmutableList.of("vanilla"), ImmutableList.of());
   public static final Codec<dei> b = RecordCodecBuilder.create(
   ...
   public dei(List<String> $$0, List<String> $$1) {
