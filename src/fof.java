...
public class fof extends fnj {
   public static final int a = 16;
   public static final int b = 36;
   public static final int c = 30;
   public static final fof.a q = new fof.a(List.of());
   ...
   private fof.a x;
   private int y;
   private List<axs> z = Collections.emptyList();
   private int A = -1;
   private wu B = wt.a;
   private fph C;
   private fph D;
   ...
   private fof(fof.a $$0, boolean $$1) {
      super(ffl.a);
      this.x = $$0;
      this.E = $$1;
   }

   public void a(fof.a $$0) {
      this.x = $$0;
      this.y = ayg.a(this.y, 0, $$0.a());
      this.L();
      this.A = -1;
   }

   public boolean a(int $$0) {
      int $$1 = ayg.a($$0, 0, this.x.a() - 1);
      if ($$1 != this.y) {
         this.y = $$1;
         this.L();
         this.A = -1;
   ...
   protected void m() {
      this.c(fhs.a(wt.d, $$0 -> this.d()).a(this.m / 2 - 100, 196, 200, 20).a());
   }

   protected void E() {
      int $$0 = (this.m - 192) / 2;
      int $$1 = 2;
      this.C = this.c(new fph($$0 + 116, 159, true, $$0x -> this.J(), this.E));
      this.D = this.c(new fph($$0 + 43, 159, false, $$0x -> this.G(), this.E));
      this.L();
   }
   ...
   public xr b(double $$0, double $$1) {
      if (this.z.isEmpty()) {
         ...
         int $$2 = ayg.a($$0 - (double)((this.m - 192) / 2) - 36.0);
         int $$3 = ayg.a($$1 - 2.0 - 30.0);
         if ($$2 >= 0 && $$3 >= 0) {
   ...
   public static record a(List<wu> a) {
      ...
      @Nullable
      public static fof.a a(cuc $$0) {
         boolean $$1 = fft.Q().aS();
         cxk $$2 = $$0.a(kn.J);
         if ($$2 != null) {
            return new fof.a($$2.a($$1));
         } else {
            cxj $$3 = $$0.a(kn.I);
            return $$3 != null ? new fof.a($$3.a($$1).map(wu::b).toList()) : null;
         }
      }
