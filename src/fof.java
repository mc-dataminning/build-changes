public class fof extends fns<cpw> implements fre {
   private static final akk D = new akk("textures/gui/container/crafting_table.png");
   private final fqy E = new fqy();
   private boolean F;

   public fof(cpw $$0, cmg $$1, wu $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aO_() {
      ...
      this.c(new fhy(this.z + 5, this.n / 2 - 49, 20, 18, fqy.a, $$0 -> {
         this.E.e();
         this.z = this.E.a(this.m, this.c);
