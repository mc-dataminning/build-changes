...
public class fof {
   ...
   public void a(final fod $$0, final Runnable $$1) throws UnknownHostException {
      final fpf $$2 = fpf.a($$0.b);
      Optional<InetSocketAddress> $$3 = fph.a.a($$2).map(fpe::d);
      if ($$3.isEmpty()) {
         this.a(fbv.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final fpf $$1, final fod $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)ug.g.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new fnx($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.g = -1;
               $$2.h = vf.b($$2xx);
               $$2.d = vf.b($$3);
               $$2.c = fof.a($$4, $$5);
