...
public enum fof implements fbz {
   a(() -> a(5, 8, ($$0, $$1) -> -1)),
   b(() -> {
      int $$0 = 5;
      int $$1 = 8;
   ...
   private static fdb a(int $$0, int $$1, fof.a $$2) {
      fdb $$3 = new fdb(fdb.a.a, $$0, $$1, false);
   ...
   private fof(final Supplier<fdb> $$0) {
      this.c = $$0.get();
   }
