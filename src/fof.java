...
public abstract class fof extends fnf {
   private final dqt b;
   private dqu c;
   ...
   public fof(dqt $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, xp.c("sign.edit"));
   }

   public fof(dqt $$0, boolean $$1, boolean $$2, xp $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.r = $$1;
   ...
   @Override
   protected void aM_() {
      this.c(fhg.a(xo.d, $$0 -> this.F()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.v = new fka(() -> this.d[this.u], this::a, fka.a(this.m), fka.c(this.m), $$0 -> this.m.h.b($$0) <= this.b.c());
   }
   ...
   protected abstract void a(fgt var1, dse var2);
   ...
   private void d(fgt $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : gge.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.u && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(gdy.F(), $$21, $$7, $$22, $$7 + this.b.b(), -16776961);
            }
         }
      }
   }
