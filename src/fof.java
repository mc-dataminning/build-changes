...
public class fof {
   ...
   private fof(int $$0, List<foh> $$1) {
      this.a = $$1.toArray(foh[]::new);
      this.b = $$1.size();
   }

   private List<foh> c() {
      List<foh> $$0 = new ArrayList<>(this.d());
