...
public class gkg extends gkd {
   ...
   private final flq cP;
   private final bbe cQ = new bbe(20, 1280);
   private final List<her> cR = Lists.newArrayList();
   private int cS = 0;
   private double cT;
   private double cU;
   private double cV;
   ...
   private int dd;
   private boolean de;
   public gke j = new gke();
   private cpu df = cpu.b;
   protected final fmf k;
   protected int cz;
   public float cC;
   public float cD;
   public float cE;
   ...
   public gkg(fmf $$0, gfj $$1, gfk $$2, axq $$3, flq $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.o());
      this.k = $$0;
      this.i = $$2;
      this.cO = $$3;
      ...
      this.db = $$5;
      this.dc = $$6;
      this.cR.add(new hfj(this, $$0.ak()));
      this.cR.add(new hew(this));
      this.cR.add(new hev(this, $$0.ak(), $$1.I_()));
   }
   ...
   public boolean a(bvj $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof crv) {
            this.k.ak().a((hfh)(new hfb(this, (crv)$$0, true)));
            this.k.ak().a((hfh)(new hfb(this, (crv)$$0, false)));
         }
   ...
   public void a(alc<?> $$0) {
      ...
      if (am.equals($$0) && this.fJ() && !this.dn) {
         this.k.ak().a((hfh)(new hex(this)));
      }
   }

   @Nullable
   public bwp v() {
      if (this.dm() instanceof bwp $$0 && $$0.a()) {
         return $$0;
      }
   ...
   public void a(dwj $$0, boolean $$1) {
      if ($$0 instanceof dvw $$2) {
         this.k.a(new fvk($$2, $$1, this.k.aU()));
      } else {
         this.k.a(new fvx($$0, $$1, this.k.aU()));
      }
   }
   ...
   public void d_() {
      ...
      boolean $$2 = this.Q();
      cps $$3 = this.gj();
      this.da = !$$3.b && !this.ck() && !this.bZ() && this.h(bwr.f) && (this.cd() || !this.fR() && !this.h(bwr.a));
   ...
   private void y(boolean $$0) {
      ...
      if ($$0 && this.as != null && this.as.e()) {
         if (this.k.z != null && !this.k.z.j() && !(this.k.z instanceof ftb) && !(this.k.z instanceof fua)) {
            if (this.k.z instanceof fum) {
               this.p();
            }
         ...
         if (this.cG == 0.0F) {
            this.k.ak().a(hfc.b(axf.vd, this.ae.i() * 0.4F + 0.8F, 0.25F));
         }
   ...
   protected void h(float $$0, float $$1) {
      if (this.N()) {
         ...
         if (!($$15 < -0.15F)) {
            ...
            dxu $$18 = this.dW().a_($$17);
            if ($$18.b(this.dW(), $$17, $$16).c()) {
               $$17 = $$17.d();
               dxu $$19 = this.dW().a_($$17);
               if ($$19.b(this.dW(), $$17, $$16).c()) {
                  ...
                  fbx $$32 = $$23.e($$29);
                  fbx $$33 = $$24.e($$29);
                  Iterable<fcr> $$34 = this.dW().d(this, $$27);
   ...
   private boolean P() {
      return !this.cj() && this.Q() && this.R() && !this.fz() && !this.b(buq.o) && (!this.bZ() || this.a(this.dl())) && !this.fJ();
   }
   ...
   protected boolean gb() {
      ...
      if (this.aa_()) {
         ...
         if (!$$0 && $$1) {
            ...
            this.k.ak().a((hfh)(new hfk.b(this)));
         }
   ...
   public fbx u(float $$0) {
      if (this.k.n.aE().a()) {
         ...
         double $$3 = this.fy() == bvz.b ? -1.0 : 1.0;
