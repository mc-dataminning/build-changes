...
public class gkg extends gkc {
   private fbx h = fbx.c;
   private int i;

   public gkg(gfi $$0, GameProfile $$1) {
      super($$0, $$1);
      this.ad = true;
   }
   ...
   public void d_() {
      ...
      if (this.i > 0) {
         this.i(new fbx((this.h.d - this.dy().d) / (double)this.i, (this.h.e - this.dy().e) / (double)this.i, (this.h.f - this.dy().f) / (double)this.i));
         this.i--;
      }
