...
public abstract class gkg<T extends bsr> {
   ...
   public final int b(T $$0, float $$1) {
      jd $$2 = jd.a((jw)$$0.l($$1));
      return gew.a(this.a($$0, $$2), this.b($$0, $$2));
   }

   protected int b(T $$0, jd $$1) {
      return $$0.dP().a(ddf.a, $$1);
   }

   protected int a(T $$0, jd $$1) {
      return $$0.bR() ? 15 : $$0.dP().a(ddf.b, $$1);
   }

   public boolean a(T $$0, gic $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         return false;
      } else if ($$0.au) {
         return true;
         ...
         ewv $$5 = $$0.h_().g(0.5);
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new ewv($$0.du() - 2.0, $$0.dw() - 2.0, $$0.dA() - 2.0, $$0.du() + 2.0, $$0.dw() + 2.0, $$0.dA() + 2.0);
         }
   ...
   private <E extends bsr> void a(T $$0, float $$1, fbg $$2, gex $$3, E $$4) {
      $$2.a();
      exa $$5 = $$4.s($$1);
      ...
      double $$10 = ayo.d((double)$$1, $$0.L, $$0.du()) + $$8;
      double $$11 = ayo.d((double)$$1, $$0.M, $$0.dw()) + $$7.d;
      double $$12 = ayo.d((double)$$1, $$0.N, $$0.dA()) + $$9;
      $$2.a($$8, $$7.d, $$9);
      float $$13 = (float)($$5.c - $$10);
      float $$14 = (float)($$5.d - $$11);
      float $$15 = (float)($$5.e - $$12);
      float $$16 = 0.025F;
      fbk $$17 = $$3.getBuffer(gff.h());
      Matrix4f $$18 = $$2.c().a();
      ...
      int $$26 = $$0.dP().a(ddf.a, $$22);
      int $$27 = $$0.dP().a(ddf.a, $$23);
   ...
   protected void a(T $$0, wz $$1, fbg $$2, gex $$3, int $$4, float $$5) {
      ...
      if (!($$6 > 4096.0)) {
         ...
         if ($$7 != null) {
            ...
            Matrix4f $$10 = $$2.c().a();
            float $$11 = fgm.Q().m.a(0.25F);
            int $$12 = (int)($$11 * 255.0F) << 24;
            fhv $$13 = this.b();
            float $$14 = (float)(-$$13.a($$1) / 2);
            $$13.a($$1, $$14, (float)$$9, 553648127, false, $$10, $$3, $$8 ? fhv.a.b : fhv.a.a, $$12, $$4);
            if ($$8) {
               $$13.a($$1, $$14, (float)$$9, -1, false, $$10, $$3, fhv.a.a, 0, $$4);
            }
