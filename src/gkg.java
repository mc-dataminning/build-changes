...
public class gkg {
   ...
   @Nullable
   private gkh b;
   private final List<gkg.a> c = Lists.newArrayList();
   private final gjz d;

   public gkg(evh $$0, evl $$1) {
      this.a = $$0;
      this.d = new gjz(this, $$1);
   }
   ...
   public void a(@Nullable fnr $$0, @Nullable elq $$1) {
   ...
   public void a(ezp $$0, int $$1) {
      this.c.add(new gkg.a($$0, $$1));
      this.a.ay().a($$0);
   }
