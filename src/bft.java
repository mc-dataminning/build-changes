...
public class bft implements bfu {
   ...
   private static final bft j = new bft();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bfs $$0) {
      URL $$1 = bft.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bfs $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bfw a = new bfw(() -> bft.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bft.this.k && $$0.getState() == RecordingState.STOPPED) {
