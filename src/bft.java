...
public class bft extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         ...
         $$0,
         $$1,
         bbd.a(this.a("minecraft:trident", bft::c), this.a("minecraft:arrow", bft::a), this.a("minecraft:spectral_arrow", bft::b))
      );
   }

   private Function<Typed<?>, Typed<?>> a(String $$0, bft.a<?> $$1) {
      Type<?> $$2 = this.getInputSchema().getChoiceType(biz.D, $$0);
      Type<?> $$3 = this.getOutputSchema().getChoiceType(biz.D, $$0);
      return a($$0, $$1, $$2, $$3);
   }
