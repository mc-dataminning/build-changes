...
public class ayq implements AutoCloseable {
   ...
   private ayq(FileChannel $$0, FileLock $$1) {
      this.b = $$0;
      this.c = $$1;
   }
   ...
   public static class a extends IOException {
      ...
      public static ayq.a a(Path $$0) {
         return new ayq.a($$0, "already locked (possibly by other Minecraft instance?)");
      }
   }
}
