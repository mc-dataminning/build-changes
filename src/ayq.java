...
public class ayq extends DataFix {
   ...
   public ayq(Schema $$0, String $$1, UnaryOperator<String> $$2) {
      super($$0, false);
      this.a = $$1;
      this.b = $$2;
   }
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(
         this.a,
         this.getInputSchema().getType(ayp.c),
         $$0 -> $$0.update(
   ...
   private <T> Dynamic<T> a(Dynamic<T> $$0) {
      Optional<Dynamic<T>> $$1 = $$0.asString().result().map(azx::a).map(this.b).map($$0::createString);
