...
public class eom extends eox {
   ...
   public eon a() {
      ...
      if (this.f() && this.b.be()) {
         $$0 = this.b.dv();
         ja.a $$1 = new ja.a(this.b.du(), (double)$$0, this.b.dA());

         for (dsh $$2 = this.a.a($$1); $$2.a(dfh.G); $$2 = this.a.a($$1)) {
            $$1.b(this.b.du(), (double)(++$$0), this.b.dA());
         }
      } else {
         $$0 = aye.a(this.b.dw() + 0.5);
      }

      ja $$4 = ja.a(this.b.du(), (double)$$0, this.b.dA());
      if (!this.a($$4)) {
   ...
   private boolean b(@Nullable eon $$0) {
      return $$0 != null && $$0.k >= 0.0F;
   }

   private boolean c(@Nullable eon $$0) {
      return $$0 != null && !$$0.i;
   }
   ...
   protected eos b(int $$0, int $$1, int $$2) {
      return (eos)this.l.computeIfAbsent(ja.a($$0, $$1, $$2), $$3 -> this.a(this.a, $$0, $$1, $$2, this.b));
   }

   @Override
   public eos a(eou $$0, int $$1, int $$2, int $$3) {
      eos $$4 = $$0.a($$1, $$2, $$3);
      if ($$4 == eos.b && $$2 >= $$0.a().I_() + 1) {
         ja $$5 = new ja($$1, $$2 - 1, $$3);
         eos $$6 = $$0.a($$5.u(), $$5.v(), $$5.w());
         if ($$6 == eos.o || $$6 == eos.i) {
            $$4 = eos.o;
         } else if ($$6 == eos.q) {
            $$4 = eos.q;
            ...
            $$4 = $$6 != eos.c && $$6 != eos.b && $$6 != eos.j ? eos.c : eos.b;
         }
      }
   ...
   private Iterable<ja> a(bta $$0) {
      evu $$1 = $$0.cK();
      boolean $$2 = $$1.a() < 1.0;
      if (!$$2) {
         return List.of(
            ja.a($$1.a, (double)$$0.dv(), $$1.c),
            ja.a($$1.a, (double)$$0.dv(), $$1.f),
            ja.a($$1.d, (double)$$0.dv(), $$1.c),
            ja.a($$1.d, (double)$$0.dv(), $$1.f)
         );
      } else {
         ...
         evu $$6 = $$1.c($$4, $$5, $$3);
         return ja.a($$0.dS(), 10, aye.a($$6.a), aye.a($$6.b), aye.a($$6.c), aye.a($$6.d), aye.a($$6.e), aye.a($$6.f));
      }
   }
}
