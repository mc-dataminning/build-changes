public class fvw extends fwe {
   private static final axd a = axd.a();
   private final fvz b;

   fvw(fry $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fvz $$7) {
   ...
   public static class a implements fvh<kf> {
      ...
      public fve a(kf $$0, fry $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fve $$8 = new fvw($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
         $$8.e(0.15F);
   ...
   public static class b implements fvh<kf> {
      ...
      public fve a(kf $$0, fry $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fvw($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class e implements fvh<kf> {
      ...
      public fve a(kf $$0, fry $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fvw $$8 = new fvw($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
