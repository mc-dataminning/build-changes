public class fvw<T extends cfk> extends fwa<T> {
   public fvw(fxq $$0) {
   ...
   public static fxw c() {
      ...
      $$1.a(
         ...
         fxs.a(0.0F, 10.0F, -16.0F)
      );
      $$1.a(
         "body",
         fxv.c().a(0, 19).a(-5.0F, -13.0F, -7.0F, 14.0F, 14.0F, 11.0F).a(39, 0).a(-4.0F, -25.0F, -7.0F, 12.0F, 12.0F, 10.0F),
         fxs.a(-2.0F, 9.0F, 12.0F, (float) (Math.PI / 2), 0.0F, 0.0F)
      );
      int $$2 = 10;
      fxv $$3 = fxv.c().a(50, 22).a(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 8.0F);
      $$1.a("right_hind_leg", $$3, fxs.a(-4.5F, 14.0F, 6.0F));
      $$1.a("left_hind_leg", $$3, fxs.a(4.5F, 14.0F, 6.0F));
      fxv $$4 = fxv.c().a(50, 40).a(-2.0F, 0.0F, -2.0F, 4.0F, 10.0F, 6.0F);
      $$1.a("right_front_leg", $$4, fxs.a(-3.5F, 14.0F, -8.0F));
      $$1.a("left_front_leg", $$4, fxs.a(3.5F, 14.0F, -8.0F));
