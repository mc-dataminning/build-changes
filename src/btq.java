...
public class btq implements btc, cve {
   ...
   @Override
   public cxp a(int $$0) {
      return $$0 >= 0 && $$0 < this.c.size() ? this.c.get($$0) : cxp.j;
   }

   public List<cxp> f() {
      List<cxp> $$0 = this.c.stream().filter($$0x -> !$$0x.f()).collect(Collectors.toList());
      this.a();
      return $$0;
   }
   ...
   public void a(vd $$0, js.a $$1) {
      ...
      for (int $$2 = 0; $$2 < $$0.size(); $$2++) {
         cxp.a($$1, (vu)$$0.a($$2)).ifPresent(this::b);
      }
   }
