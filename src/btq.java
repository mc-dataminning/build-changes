...
public class btq implements Comparable<btq> {
   ...
   public static final yn<wa, btq> e = yn.a(bto.b, btq::c, btq.b.b, btq::l, btq::new);
   ...
   public btq(jr<bto> $$0, int $$1) {
      this($$0, $$1, 0);
   }

   public btq(jr<bto> $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, false, true);
   }

   public btq(jr<bto> $$0, int $$1, int $$2, boolean $$3, boolean $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$4);
   }

   public btq(jr<bto> $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5) {
      this($$0, $$1, $$2, $$3, $$4, $$5, null);
   }

   public btq(jr<bto> $$0, int $$1, int $$2, boolean $$3, boolean $$4, boolean $$5, @Nullable btq $$6) {
      this.g = $$0;
      this.h = $$1;
   ...
   public void a(ard $$0, bvh $$1, bul.d $$2) {
      this.g.a().a($$0, $$1, this.i, $$2);
   }

   public void a(ard $$0, bvh $$1, btb $$2, float $$3) {
   ...
   @Nullable
   public static btq a(tq $$0) {
      return (btq)d.parse(ue.a, $$0).resultOrPartial(f::error).orElse(null);
   }
   ...
   static record b(int c, int d, boolean e, boolean f, boolean g, Optional<btq.b> h) {
      public static final MapCodec<btq.b> a = MapCodec.recursive(
         ...
         $$0 -> RecordCodecBuilder.mapCodec(
               $$1 -> $$1.group(
                        ayi.k.optionalFieldOf("amplifier", 0).forGetter(btq.b::a),
      ...
      public static final yn<ByteBuf, btq.b> b = yn.a(
         $$0 -> yn.a(yl.h, btq.b::a, yl.h, btq.b::b, yl.b, btq.b::c, yl.b, btq.b::d, yl.b, btq.b::e, $$0.a(yl::a), btq.b::f, btq.b::new)
      );
