...
public abstract class bjg extends biq implements bio {
   ...
   protected static final aee<Byte> t = aeh.a(bjg.class, aeg.a);
   private static final aee<Float> bH = aeh.a(bjg.class, aeg.d);
   private static final aee<Integer> bI = aeh.a(bjg.class, aeg.b);
   private static final aee<Boolean> bJ = aeh.a(bjg.class, aeg.k);
   private static final aee<Integer> bK = aeh.a(bjg.class, aeg.b);
   private static final aee<Integer> bL = aeh.a(bjg.class, aeg.b);
   private static final aee<Optional<gw>> bM = aeh.a(bjg.class, aeg.o);
   ...
   private final hn<cjf> bR = hn.a(2, cjf.b);
   private final hn<cjf> bS = hn.a(4, cjf.b);
   public boolean aF;
   ...
   protected void a(double $$0, boolean $$1, dfj $$2, gw $$3) {
      ...
      if (!this.dL().B && this.ab > 3.0F && $$1 && !$$2.i()) {
         ...
         float $$11 = (float)arw.f(this.ab - 3.0F);
         double $$12 = Math.min((double)(0.2F + $$11 / 15.0F), 2.5);
         int $$13 = (int)(150.0 * $$12);
         ((akq)this.dL()).a(new in(iv.c, $$2), $$4, $$5, $$6, $$13, 0.0, 0.0, 0.0, 0.15F);
      }
   ...
   public float a(float $$0) {
      return arw.i($$0, this.ch, this.cg);
   }
   ...
   public void aq() {
         ...
         if (!this.dL().B) {
            if (this.bw()) {
               ...
               if ($$1 < 0.0) {
                  ...
                  if ($$2 > 0.0) {
                     this.a(this.dM().v(), (float)Math.max(1, arw.a(-$$1 * $$2)));
                  }
               }
            }
         }

         if (this.a(apx.a) && !this.dL().a_(gw.a(this.dq(), this.du(), this.dw())).a(csw.nd)) {
      ...
      if (this.al > 0 && !(this instanceof akr)) {
         this.al--;
      }
   ...
   protected void dS() {
      ...
      this.a(apd.wd, $$1, 0.6F + this.ag.i() * 0.4F);
   }

   protected boolean dT() {
      return this.dL().a_(this.aG()).a(aps.aM);
   }
   ...
   public void d(bid $$0) {
      for (biq $$1 : this.cP()) {
         if ($$1 instanceof akr $$2) {
            $$2.c.b(new aax(this.ah(), $$0));
         }
      }
   }
   ...
   public void c(float $$0) {
      this.an.b(bH, arw.a($$0, 0.0F, this.eL()));
   }
   ...
   public boolean a(bho $$0, float $$1) {
      if (this.b($$0)) {
         ...
         return false;
      } else if ($$0.a(apu.i) && this.a(bif.l)) {
         return false;
      } else {
         ...
         if ($$1 > 0.0F && this.f($$0)) {
            ...
            $$4 = $$1;
            $$1 = 0.0F;
            if (!$$0.a(apu.j) && $$0.c() instanceof bjg $$6) {
               this.d($$6);
            }
         ...
         if ($$0.a(apu.o) && this.ag().a(apv.j)) {
            $$1 *= 5.0F;
         }

         this.aQ.a(1.5F);
         boolean $$7 = true;
         if ((float)this.al > 10.0F && !$$0.a(apu.e)) {
            if ($$1 <= this.bi) {
               return false;
            }
         ...
         biq $$8 = $$0.d();
         if ($$8 != null) {
            if ($$8 instanceof bjg $$9 && !$$0.a(apu.q)) {
               this.a($$9);
            }
         ...
         if (this instanceof akr) {
            al.h.a((akr)this, $$0, $$2, $$1, $$3);
            if ($$4 > 0.0F && $$4 < 3.4028235E37F) {
               ((akr)this).a(apn.K, Math.round($$4 * 10.0F));
            }
         }

         if ($$8 instanceof akr) {
            al.g.a((akr)$$8, this, $$0, $$2, $$1, $$3);
         }
   ...
   private void i(cjf $$0) {
      if (!$$0.b()) {
         if (!this.aS()) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apd.lZ, this.da(), 0.8F, 0.8F + this.dL().z.i() * 0.4F, false);
         }
   ...
   protected void ey() {
      if (this.dL() instanceof akq && !this.eC() && (this.ee() || this.aZ > 0 && this.eb() && this.dL().X().b(cpr.f))) {
         biw.a((akq)this.dL(), this.dj(), this.ed());
      }
   }
   ...
   protected void a(bho $$0, boolean $$1) {
      ...
      ecw.a $$4 = new ecw.a((akq)this.dL()).a(efb.a, this).a(efb.f, this.dj()).a(efb.c, $$0).b(efb.d, $$0.d()).b(efb.e, $$0.c());
      if ($$1 && this.aY != null) {
   ...
   public bjg.a eF() {
      return new bjg.a(apd.ja, apd.iS);
   }

   protected apc c(cjf $$0) {
      return $$0.N();
   }
      ...
      if ($$0.a(apu.f)) {
         ...
         if (this.a(bif.k) && !$$0.a(apu.g)) {
            ...
            if ($$6 > 0.0F && $$6 < 3.4028235E37F) {
               if (this instanceof akr) {
                  ((akr)this).a(apn.M, Math.round($$6 * 10.0F));
               } else if ($$0.d() instanceof akr) {
                  ((akr)$$0.d()).a(apn.I, Math.round($$6 * 10.0F));
               }
            }
         }
   ...
   protected void f(bho $$0, float $$1) {
      if (!this.b($$0)) {
         ...
         float $$3 = $$1 - var9;
         if ($$3 > 0.0F && $$3 < 3.4028235E37F && $$0.d() instanceof akr $$4) {
            $$4.a(apn.H, Math.round($$3 * 10.0F));
         }
   ...
   public void b(byte $$0) {
      switch ($$0) {
         case 3:
            ...
            break;
         case 29:
            this.a(apd.uQ, 1.0F, 0.8F + this.dL().z.i() * 0.4F);
            break;
         case 30:
         ...
         case 46:
            ...
            for (int $$3 = 0; $$3 < 128; $$3++) {
               ...
               double $$8 = arw.d($$4, this.K, this.dq()) + (this.ag.j() - 0.5) * (double)this.df() * 2.0;
               double $$9 = arw.d($$4, this.L, this.ds()) + this.ag.j() * (double)this.dg();
               double $$10 = arw.d($$4, this.M, this.dw()) + (this.ag.j() - 0.5) * (double)this.df() * 2.0;
   ...
   private void a(biq $$0) {
      ...
      if (this.dG()) {
         $$1 = this.dj();
      } else if (!$$0.dG() && !this.dL().a_($$0.dl()).a(aps.aI)) {
         $$1 = $$0.b(this);
      } else {
   ...
   protected void fa() {
      ...
      if (this.bX()) {
         ...
         this.f(this.do().b((double)(-arw.a($$1) * 0.2F), 0.0, (double)(arw.b($$1) * 0.2F)));
      }
   ...
   public void h(ehn $$0) {
      if (this.cW()) {
         ...
         if (this.aX() && this.dZ() && !this.a($$3)) {
            ...
            if ($$15 < 0.0F && $$16 > 0.0) {
               double $$21 = $$17 * (double)(-arw.a($$15)) * 0.04;
   ...
   public void q(boolean $$0) {
      float $$1 = (float)arw.g(this.dq() - this.K, $$0 ? this.ds() - this.L : 0.0, this.dw() - this.M);
      this.v($$1);
   }
   ...
   private ehn j(ehn $$0) {
      if (this.c_()) {
         this.n();
         float $$1 = 0.15F;
         double $$2 = arw.a($$0.c, -0.15F, 0.15F);
         double $$3 = arw.a($$0.e, -0.15F, 0.15F);
   ...
   public void l() {
      ...
      if ($$4 > 0.0025000002F) {
         ...
         float $$8 = (float)arw.d($$3, $$2) * (180.0F / (float)Math.PI) - 90.0F;
         float $$9 = arw.e(arw.g(this.dB()) - $$8);
         if (95.0F < $$9 && $$9 < 265.0F) {
            $$5 = $$8 - 180.0F;
         } else {
            $$5 = $$8;
   ...
   private void a(Map<biv, cjf> $$0) {
      ...
      if ($$1 != null && $$2 != null && cjf.a($$1, this.f(biv.b)) && cjf.a($$2, this.f(biv.a))) {
         ((akq)this.dL()).k().b(this, new xy(this, (byte)55));
         $$0.remove(biv.a);
         $$0.remove(biv.b);
         this.c(biv.a, $$1.p());
         this.c(biv.b, $$2.p());
   ...
   private void b(Map<biv, cjf> $$0) {
      ...
      ((akq)this.dL()).k().b(this, new aaa(this.ah(), $$1));
   }
   ...
   protected float e(float $$0, float $$1) {
      float $$2 = arw.g($$0 - this.aU);
      this.aU += $$2 * 0.3F;
      float $$3 = arw.g(this.dB() - this.aU);
      if (Math.abs($$3) > 50.0F) {
         this.aU = this.aU + ($$3 - (float)(arw.j((double)$$3) * 50));
      }
   ...
   public float h(float $$0) {
      return $$0 == 1.0F ? this.aW : arw.i($$0, this.aX, this.aW);
   }
   ...
   public void fD() {
      this.fA().filter(this.dL()::A).ifPresent($$0x -> {
         ...
         if ($$1.b() instanceof cso) {
            ...
            float $$5 = (float)arw.d(arw.d($$4.e, $$4.c) * 180.0F / (float)Math.PI - 90.0);
            this.e($$3.c, $$3.d, $$3.e);
            this.r($$5);
            this.s(0.0F);
         }
   ...
   public cjf a(cpv $$0, cjf $$1) {
      if ($$1.M()) {
         $$0.a(null, this.dq(), this.ds(), this.dw(), this.d($$1), ape.g, 1.0F, 1.0F + ($$0.z.i() - $$0.z.i()) * 0.4F);
         this.a($$1, $$0, this);
   ...
   public boolean dz() {
      if (this.M_()) {
         ...
         boolean $$0 = !this.c(biv.f).a(aqa.az) && !this.c(biv.e).a(aqa.az) && !this.c(biv.d).a(aqa.az) && !this.c(biv.c).a(aqa.az);
         return $$0 && super.dz();
      }
   }
   ...
   protected void a(int $$0, double $$1) {
      this.aW = (float)arw.e(1.0 / (double)$$0, (double)this.aW, $$1);
   }

   public static record a(apc a, apc b) {
   }
}
