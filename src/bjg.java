...
public class bjg extends DataFix {
   ...
   private TypeRewriteRule a() {
      Type<?> $$0 = this.getInputSchema().getType(biq.g);
      Type<?> $$1 = this.getOutputSchema().getType(biq.g);
   ...
   private TypeRewriteRule b() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(biq.J);
      return this.fixTypeEverywhereTyped("ObjectiveStatFix", $$0, $$1, $$1x -> {
         ...
         Dynamic<?> $$3 = $$2.update("CriteriaName", $$0xx -> (Dynamic)DataFixUtils.orElse($$0xx.asString().result().map($$0xxx -> {
               if (a.contains($$0xxx)) {
                  ...
                  bjg.a $$1xx = a($$0xxx);
                  return $$1xx == null ? "dummy" : bky.b($$1xx.a) + ":" + bky.b($$1xx.b);
               }
