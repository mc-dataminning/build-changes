...
public class atc extends atb implements abv, wu {
   ...
   private final Queue<ass> i = new ConcurrentLinkedQueue<>();
   @Nullable
   private ass j;
   private arl k;
   @Nullable
   ...
   public atc(MinecraftServer $$0, vv $$1, asr $$2) {
      super($$0, $$1, $$2);
      this.h = $$2.a();
      this.k = $$2.c();
   }
   ...
   public void l() {
      ...
      jn<ama> $$1 = this.d.bb();
      List<auu> $$2 = this.d.be().b().flatMap($$0x -> $$0x.a().d().stream()).toList();
      this.b(new abs(cvu.e.b(this.d.aZ().K())));
      this.l = new atn($$2, $$1);
      this.i.add(this.l);
      this.n();
      this.i.add(new atl());
   ...
   private void n() {
      this.d.Y().ifPresent($$0 -> this.i.add(new atm($$0)));
   }
   ...
   public void a(abw $$0) {
      zr.a($$0, this, this.d);
      this.a(atl.a);
      this.e.a(agz.c.a(wp.a(this.d.ba())));
      ...
      try {
         ...
         xg $$2 = $$1.a(this.e.d(), this.h);
         if ($$2 != null) {
            this.a($$2);
            return;
         }

         asc $$3 = $$1.a(this.h, this.k);
   ...
   private void a(ass.a $$0) {
      ass.a $$1 = this.j != null ? this.j.a() : null;
      if (!$$0.equals($$1)) {
