...
public class atc {
   ...
   public static ib<cle> b(JsonElement $$0, String $$1) {
      if ($$0.isJsonPrimitive()) {
         String $$2 = $$0.getAsString();
         return jy.i
            .b(agh.a(jz.E, new agi($$2)))
   ...
   public static ib<cle> j(JsonObject $$0, String $$1) {
      if ($$0.has($$1)) {
         return b($$0.get($$1), $$1);
      } else {
   ...
   @Nullable
   @Contract("_,_,!null->!null;_,_,null->_")
   public static ib<cle> a(JsonObject $$0, String $$1, @Nullable ib<cle> $$2) {
