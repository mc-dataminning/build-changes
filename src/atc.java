...
public abstract class atc implements AutoCloseable {
   ...
   protected atc(URL $$0, atc.b $$1, atc.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? azg.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static atc a(aql $$0) {
      String $$1 = $$0.R;
      if (bap.h($$1)) {
         return null;
      } else {
   ...
   protected CompletableFuture<asn> a(GameProfile $$0, String $$1, atc.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(asn.a) : CompletableFuture.supplyAsync(() -> {
   ...
   protected abstract asn a(String var1, atc.a var2, JsonObject var3);

   protected xg a(String $$0, JsonArray $$1, atc.a $$2) {
      if ($$1.isEmpty()) {
         return xg.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return xg.b;
      } else {
         xg $$3 = new xg($$0.length());
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new atc.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   public interface a {
      atc.a a = ($$0, $$1) -> false;
      atc.a b = ($$0, $$1) -> $$0.length() == $$1;

      static atc.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static atc.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   protected class c implements atd {
      protected final GameProfile b;
      protected final Executor c;

      protected c(final GameProfile $$1) {
         this.b = $$1;
         bti $$2 = new bti(atc.this.g, "chat stream for " + $$1.getName());
         this.c = $$2::a_;
      }

      @Override
      public CompletableFuture<List<asn>> a(List<String> $$0) {
         List<CompletableFuture<asn>> $$1 = $$0.stream().map($$0x -> atc.this.a(this.b, $$0x, atc.this.f, this.c)).collect(ImmutableList.toImmutableList());
         return ag.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<asn> a(String $$0) {
         return atc.this.a(this.b, $$0, atc.this.f, this.c);
      }
   }
