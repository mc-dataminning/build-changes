...
public class atc<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return atc.this.get(this.b--);
      }

      @Override
      public void remove() {
         atc.this.remove(this.b + 1);
      }
   }
}
