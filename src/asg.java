...
public class asg {
   ...
   private static void a(asl $$0, arj $$1, dwy $$2) {
      $$0.b(new adm($$2, $$1.y_(), null, null));
      ddp $$3 = $$2.f();
      ago.a($$1, $$3);
   }

   private List<dwy> a(aqp $$0, ddp $$1) {
      int $$2 = azf.d(this.i);
      List<dwy> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : azf.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
