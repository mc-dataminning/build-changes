...
public class asg<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return asg.this.get(this.b--);
      }

      @Override
      public void remove() {
         asg.this.remove(this.b + 1);
      }
   }
}
