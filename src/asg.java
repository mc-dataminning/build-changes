...
public class asg {
   ...
   public static final Codec<Object> b = a(asr.a);
   public static final Codec<JsonElement> c = Codec.STRING.flatXmap($$0 -> {
      ...
      try {
         return DataResult.success(aso.e($$0));
   ...
   public static final Codec<asg.f> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? afw.b($$0.substring(1)).map($$0x -> new asg.f($$0x, true)) : afw.b($$0).map($$0x -> new asg.f($$0x, false)), asg.f::c
      );
   ...
   private static final MapCodec<GameProfile> z = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(iv.c.fieldOf("id").forGetter(GameProfile::getId), Codec.STRING.fieldOf("name").forGetter(GameProfile::getName))
   ...
   public static Codec<String> x = a(
      Codec.STRING, $$0 -> !afw.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> asg.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new asg.b<>($$0, $$1);
   }

   public static <K, V> asg.e<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new asg.e<>($$0, $$1);
   }
   ...
   public static <T> Codec<ig<T>> b(Codec<ig<T>> $$0) {
      return a(
         $$0,
         (Function<ig<T>, DataResult<ig<T>>>)($$0x -> $$0x.c().right().filter(List::isEmpty).isPresent()
   ...
   static final class d<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof asg.d<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record f(afw a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
