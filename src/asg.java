...
public class asg {
   ...
   private static final Optional<Object> b = Optional.of(asp.a);

   private static boolean a(ub $$0, ard $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, ub $$1, ard $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, ub $$1, ard $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, ub $$1, ard $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, ub $$2, ard $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, ub $$2, ub $$3, ard $$4) {
      int $$5 = $$0.length();
      ub $$6 = $$2;
   ...
   public static boolean a(tj $$0, ub $$1, ard $$2) {
