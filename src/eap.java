...
public class eap extends eax {
   ...
   public eaq a() {
      ...
      if (this.f() && this.b.aX()) {
         ...
         for (dfa $$2 = this.a.a_($$1); $$2.a(csn.G); $$2 = this.a.a_($$1)) {
   ...
   private boolean b(@Nullable eaq $$0) {
      return $$0 != null && $$0.k >= 0.0F;
   }

   private boolean c(@Nullable eaq $$0) {
      return $$0 != null && !$$0.i;
   }
   ...
   private eao c(int $$0, int $$1, int $$2) {
      return (eao)this.l.computeIfAbsent(gu.a($$0, $$1, $$2), $$3 -> this.a(this.a, $$0, $$1, $$2, this.b));
   }
   ...
   public eao a(cos $$0, int $$1, int $$2, int $$3, bja $$4) {
      ...
      if ($$5.contains(eao.h)) {
         ...
         return $$6 == eao.b && $$4.a($$8) == 0.0F ? eao.b : $$8;
      }
   }
   ...
   public eao a(cos $$0, int $$1, int $$2, int $$3) {
      ...
      if ($$5 == eao.b && $$2 >= $$0.C_() + 1) {
         ...
         if ($$6 == eao.o || $$6 == eao.i) {
            ...
            $$5 = $$6 != eao.c && $$6 != eao.b && $$6 != eao.j ? eao.c : eao.b;
         }
      }
