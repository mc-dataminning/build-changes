...
public class dly extends dko<dnm> {
   public static final int a = 10;
   private static final int b = 42;
   private static final LoadingCache<Long, List<dly.a>> c = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).build(new dly.b());

   public dly(Codec<dnm> $$0) {
      super($$0);
   }

   public static List<dly.a> a(cng $$0) {
      apf $$1 = apf.a($$0.A());
      long $$2 = $$1.g() & 65535L;
      return (List<dly.a>)c.getUnchecked($$2);
   }
   ...
   private void a(cnb $$0, apf $$1, dnm $$2, dly.a $$3) {
      int $$4 = $$3.c();
            ...
            for (int $$11 = -2; $$11 <= 2; $$11++) {
               for (int $$12 = 0; $$12 <= 3; $$12++) {
                  ...
                  if ($$13 || $$14 || $$15) {
                     ...
                     dcb $$18 = cpo.eX
                        .n()
                        .a(ctl.a, Boolean.valueOf($$16 && $$11 != -2))
                        .a(ctl.c, Boolean.valueOf($$16 && $$11 != 2))
                        .a(ctl.d, Boolean.valueOf($$17 && $$10 != -2))
                        .a(ctl.b, Boolean.valueOf($$17 && $$10 != 2));
   ...
   public static class a {
      ...
      public a(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
         ...
         this.e = $$3;
         this.f = $$4;
         this.g = new eed((double)($$0 - $$2), (double)dfk.e, (double)($$1 - $$2), (double)($$0 + $$2), (double)dfk.d, (double)($$1 + $$2));
      }
   ...
   static class b extends CacheLoader<Long, List<dly.a>> {
      public List<dly.a> a(Long $$0) {
         IntArrayList $$1 = ac.a(IntStream.range(0, 10), apf.a($$0));
         List<dly.a> $$2 = Lists.newArrayList();

         for (int $$3 = 0; $$3 < 10; $$3++) {
            int $$4 = apa.a(42.0 * Math.cos(2.0 * (-Math.PI + (Math.PI / 10) * (double)$$3)));
            int $$5 = apa.a(42.0 * Math.sin(2.0 * (-Math.PI + (Math.PI / 10) * (double)$$3)));
            int $$6 = $$1.get($$3);
            int $$7 = 2 + $$6 / 3;
            int $$8 = 76 + $$6 * 3;
            boolean $$9 = $$6 == 1 || $$6 == 2;
            $$2.add(new dly.a($$4, $$5, $$7, $$8, $$9));
         }
