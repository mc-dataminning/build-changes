...
public abstract class bkl extends bkj implements blf {
   private static final afc<Byte> b = aff.a(bkl.class, afe.a);
   ...
   protected bqh bL;
   protected bqf bM;
   private final bqc bU;
   protected bts bN;
   protected final brf bO;
   protected final brf bP;
   @Nullable
   private bkj bV;
   private final bun bW;
   private final il<ckj> bX = il.a(2, ckj.b);
   protected final float[] bQ = new float[2];
   private final il<ckj> bY = il.a(4, ckj.b);
   protected final float[] bR = new float[4];
   private boolean bZ;
   private boolean ca;
   private final Map<ebp, Float> cb = Maps.newEnumMap(ebp.class);
   @Nullable
   private afw cc;
   private long cd;
   @Nullable
   ...
   protected bkl(bjx<? extends bkl> $$0, cqz $$1) {
      super($$0, $$1);
      this.bO = new brf($$1.ae());
      this.bP = new brf($$1.ae());
      this.bK = new bqg(this);
      this.bL = new bqh(this);
      this.bM = new bqf(this);
      this.bU = this.F();
      this.bN = this.b($$1);
      this.bW = new bun(this);
   ...
   public static blo.a A() {
      return bkj.dP().a(blp.g, 16.0).a(blp.d);
   }
   ...
   public float a(ebp $$0) {
      bkl $$2;
      label17: {
         if (this.cZ() instanceof bkl $$1 && $$1.B()) {
            $$2 = $$1;
            break label17;
         }
   ...
   public bqh I() {
      return this.cZ() instanceof bkl $$0 ? $$0.I() : this.bL;
   }
   ...
   public bts L() {
      return this.cZ() instanceof bkl $$0 ? $$0.L() : this.bN;
   }
   ...
   public bkj cN() {
      bjt $$0 = this.cQ();
      if (!this.fU() && $$0 instanceof bkl $$1 && $$0.bQ()) {
         return $$1;
      }
   ...
   protected void R() {
      boolean $$0 = !(this.cN() instanceof bkl);
   ...
   public void b(rt $$0) {
      ...
      if (this.ce != null) {
         rt $$11 = new rt();
         if (this.ce instanceof bkj) {
            UUID $$12 = this.ce.cv();
            $$11.a("UUID", $$12);
         } else if (this.ce instanceof bzi) {
            ht $$13 = ((bzi)this.ce).E();
            $$11.a("X", $$13.u());
            $$11.a("Y", $$13.v());
            $$11.a("Z", $$13.w());
   ...
   public void a(rt $$0) {
      ...
      if ($$0.b("HandItems", 9)) {
         ...
         for (int $$4 = 0; $$4 < this.bX.size(); $$4++) {
            this.bX.set($$4, ckj.a($$3.a($$4)));
         }
      }

      if ($$0.b("ArmorDropChances", 9)) {
         rz $$5 = $$0.c("ArmorDropChances", 5);
      ...
      if ($$0.b("DeathLootTable", 8)) {
         this.cc = new afw($$0.l("DeathLootTable"));
   ...
   public void c_() {
      ...
      if (!this.dL().B && this.fK() && this.bv() && !this.ba && this.dL().X().b(cqv.c)) {
         iw $$0 = this.T();

         for (bzq $$2 : this.dL().a(bzq.class, this.cG().c((double)$$0.u(), (double)$$0.v(), (double)$$0.w()))) {
   ...
   protected boolean b(ckj $$0, ckj $$1) {
      if ($$1.b()) {
         return true;
      } else if ($$0.d() instanceof clu) {
         if (!($$1.d() instanceof clu)) {
            return true;
         } else {
            clu $$2 = (clu)$$0.d();
            clu $$3 = (clu)$$1.d();
      ...
      } else if ($$0.d() instanceof cih && $$1.d() instanceof cih) {
         return this.c($$0, $$1);
      } else if ($$0.d() instanceof cir && $$1.d() instanceof cir) {
         return this.c($$0, $$1);
      } else if ($$0.d() instanceof cht $$4) {
         if (cov.d($$1)) {
            return false;
         } else if (!($$1.d() instanceof cht)) {
            return true;
         } else {
            cht $$5 = (cht)$$1.d();
            if ($$4.e() != $$5.e()) {
         ...
         if ($$0.d() instanceof cit) {
            if ($$1.d() instanceof cic) {
               return true;
            }

            if ($$1.d() instanceof cit $$6) {
               cit $$7 = (cit)$$0.d();
               if ($$7.d() != $$6.d()) {
                  return $$7.d() > $$6.d();
               }
   ...
   public void a(bjt $$0, float $$1, float $$2) {
      double $$3 = $$0.dq() - this.dq();
      double $$4 = $$0.dw() - this.dw();
      double $$6;
      if ($$0 instanceof bkj $$5) {
         $$6 = $$5.du() - this.du();
      } else {
      ...
      float $$9 = (float)(asy.d($$4, $$3) * 180.0F / (float)Math.PI) - 90.0F;
      float $$10 = (float)(-(asy.d($$6, $$8) * 180.0F / (float)Math.PI));
   ...
   public static boolean a(bjx<? extends bkl> $$0, cra $$1, bkn $$2, ht $$3, ate $$4) {
      ht $$5 = $$3.d();
      return $$2 == bkn.c || $$1.a_($$5).a($$1, $$5, $$0);
   }
   ...
   protected void a(bir $$0, int $$1, boolean $$2) {
      ...
      for (bjy $$3 : bjy.values()) {
         ckj $$4 = this.c($$3);
         float $$5 = this.f($$3);
         boolean $$6 = $$5 > 1.0F;
         if (!$$4.b() && !cov.e($$4) && ($$2 || $$6) && Math.max(this.ag.i() - (float)$$1 * 0.01F, 0.0F) < $$5) {
            if (!$$6 && $$4.i()) {
   ...
   protected void a(ate $$0, bhz $$1) {
      if ($$0.i() < 0.15F * $$1.d()) {
         int $$2 = $$0.a(2);
         float $$3 = this.dL().ai() == bhy.d ? 0.1F : 0.25F;
         if ($$0.i() < 0.095F) {
            $$2++;
         }
   ...
   @Nullable
   public static cke a(bjy $$0, int $$1) {
      switch ($$0) {
         case f:
            if ($$1 == 0) {
               return ckm.oK;
   ...
   protected void a(ate $$0, float $$1) {
      if (!this.eS().b() && $$0.i() < 0.25F * $$1) {
         this.a(bjy.a, cov.a($$0, this.eS(), (int)(5.0F + $$1 * (float)$$0.a(18)), false));
      }
   }

   protected void a(ate $$0, float $$1, bjy $$2) {
      ckj $$3 = this.c($$2);
      if (!$$3.b() && $$0.i() < 0.5F * $$1) {
         this.a($$2, cov.a($$0, $$3, (int)(5.0F + $$1 * (float)$$0.a(18)), false));
      }
   }
   ...
   public blc a(cro $$0, bhz $$1, bkn $$2, @Nullable blc $$3, @Nullable rt $$4) {
      ate $$5 = $$0.E_();
      this.a(blp.g).c(new bln("Random spawn bonus", $$5.a(0.0, 0.11485000000000001), bln.a.b));
      if ($$5.i() < 0.05F) {
         this.u(true);
      } else {
         this.u(false);
   ...
   @Override
   public final bib a(ccx $$0, bia $$1) {
      if (!this.bv()) {
         return bib.d;
      } else if (this.fT() == $$0) {
         this.a(true, !$$0.fT().d);
   ...
   private bib c(ccx $$0, bia $$1) {
      ckj $$2 = $$0.b($$1);
      if ($$2.a(ckm.tQ) && this.a($$0)) {
         this.b($$0, true);
         $$2.h(1);
         return bib.a(this.dL().B);
      } else {
         ...
         if ($$2.d() instanceof clo) {
            if (this.dL() instanceof alq) {
               clo $$4 = (clo)$$2.d();
               Optional<bkl> $$5 = $$4.a($$0, this, (bjx<? extends bkl>)this.ag(), (alq)this.dL(), this.dj(), $$2);
               $$5.ifPresent($$1x -> this.a($$0, $$1x));
               return $$5.isPresent() ? bib.a : bib.d;
            } else {
               return bib.b;
            }
         } else {
   ...
   @Nullable
   public <T extends bkl> T a(bjx<T> $$0, boolean $$1) {
      if (this.dG()) {
         return null;
      } else {
         T $$2 = (T)$$0.a(this.dL());
   ...
   public void a(boolean $$0, boolean $$1) {
      if (this.ce != null) {
         ...
         if (!this.dL().B && $$0 && this.dL() instanceof alq) {
            ((alq)this.dL()).k().b(this, new aaw(this, null));
         }
      }
   }

   public boolean a(ccx $$0) {
      return !this.fS() && !(this instanceof cad);
   }
   ...
   public void b(bjt $$0, boolean $$1) {
      this.ce = $$0;
      this.cg = null;
      if (!this.dL().B && $$1 && this.dL() instanceof alq) {
         ((alq)this.dL()).k().b(this, new aaw(this, this.ce));
      }
   ...
   private void ga() {
      if (this.cg != null && this.dL() instanceof alq) {
         if (this.cg.b("UUID")) {
            UUID $$0 = this.cg.a("UUID");
            bjt $$1 = ((alq)this.dL()).a($$0);
            if ($$1 != null) {
               this.b($$1, true);
               return;
            }
   ...
   @Override
   public bkd fm() {
      return this.fV() ? bkd.a : bkd.b;
   }

   public boolean i(bkj $$0) {
   ...
   protected eia fX() {
      ...
      if ($$0 != null) {
         eia $$1 = $$0.cG();
         eia $$2 = this.cG();
         $$3 = new eia(Math.min($$2.a, $$1.a), $$2.b, Math.min($$2.c, $$1.c), Math.max($$2.d, $$1.d), $$2.e, Math.max($$2.f, $$1.f));
      } else {
         $$3 = this.cG();
      }
   ...
   public boolean C(bjt $$0) {
      ...
      float $$2 = (float)this.b(blp.d);
      if ($$0 instanceof bkj) {
         $$1 += cov.a(this.eS(), ((bkj)$$0).eR());
         $$2 += (float)cov.c(this);
      }
      ...
      boolean $$4 = $$0.a(this.dM().b((bkj)this), $$1);
      if ($$4) {
         if ($$2 > 0.0F && $$0 instanceof bkj) {
            ((bkj)$$0).q((double)($$2 * 0.5F), (double)asy.a(this.dB() * (float) (Math.PI / 180.0)), (double)(-asy.b(this.dB() * (float) (Math.PI / 180.0))));
            this.f(this.do().d(0.6, 1.0, 0.6));
         }

         if ($$0 instanceof ccx $$5) {
            this.a($$5, this.eS(), $$5.fn() ? $$5.fp() : ckj.b);
         }
   ...
   private void a(ccx $$0, ckj $$1, ckj $$2) {
      if (!$$1.b() && !$$2.b() && $$1.d() instanceof chy && $$2.a(ckm.uy)) {
         float $$3 = 0.25F + (float)cov.g(this) * 0.05F;
         if (this.ag.i() < $$3) {
            $$0.gn().a(ckm.uy, 100);
            this.dL().a($$0, (byte)30);
         }
