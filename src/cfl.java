...
public class cfl extends blp implements bnc {
   ...
   public cfl(blt<? extends cfl> $$0, cti $$1) {
      super($$0, $$1);
   }

   public cfl(cti $$0, double $$1, double $$2, double $$3, float $$4, int $$5, bmf $$6) {
      this(blt.I, $$0);
      this.e = $$5;
      this.a($$6);
   ...
   @Nullable
   public bmf q() {
      if (this.i == null && this.j != null && this.dM() instanceof amz) {
         blp $$0 = ((amz)this.dM()).a(this.j);
         if ($$0 instanceof bmf) {
            this.i = (bmf)$$0;
         }
      }
   ...
   public void l() {
      ...
      if (this.dM().B) {
         ...
         if (this.e == -8) {
            for (bmf $$8 : this.dM().a(bmf.class, this.cH().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
   ...
   public void b(byte $$0) {
      ...
      if ($$0 == 4) {
         this.h = true;
         if (!this.aU()) {
            this.dM().a(this.dr(), this.dt(), this.dx(), arm.hX, this.db(), 1.0F, this.ag.i() * 0.2F + 0.85F, false);
         }
      }
   }
