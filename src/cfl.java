...
public record cfl(cfl.a d) {
   ...
   public static final Codec<cfl> c = cfl.a.a.xmap(cfl::new, cfl::b);

   public static cfl a(avc $$0, UUID $$1, cfl.a $$2) throws cfl.b {
      if (!$$2.a($$0, $$1)) {
         throw new cfl.b(e);
      } else {
         return new cfl($$2);
   ...
   public avc a() {
      return avc.a(this.d.c, "SHA256withRSA");
   }
   ...
   public static record a(Instant b, PublicKey c, byte[] d) {
      ...
      public static final Codec<cfl.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  atw.m.fieldOf("expires_at").forGetter(cfl.a::b), atm.f.fieldOf("key").forGetter(cfl.a::c), atw.n.fieldOf("signature_v2").forGetter(cfl.a::d)
               )
               .apply($$0, cfl.a::new)
      );
      ...
      public boolean equals(Object $$0) {
         return !($$0 instanceof cfl.a $$1) ? false : this.b.equals($$1.b) && this.c.equals($$1.c) && Arrays.equals(this.d, $$1.d);
      }
   }
