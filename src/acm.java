...
public class acm implements zf<abt> {
   public static final yw<vv, acm> a = zf.a(acm::a, acm::new);
   ...
   public acm(RootCommandNode<ey> $$0) {
   ...
   private static List<acm.b> a(Object2IntMap<CommandNode<ey>> $$0) {
   ...
   @Nullable
   private static acm.e a(vv $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
   ...
   private static acm.b a(CommandNode<ey> $$0, Object2IntMap<CommandNode<ey>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<ey> a(ep $$0) {
      return (RootCommandNode<ey>)new acm.d($$0, this.j).a(this.i);
   }
   ...
   static class a implements acm.e {
      ...
      @Nullable
      private static akq a(@Nullable SuggestionProvider<ey> $$0) {
         return $$0 != null ? is.a($$0) : null;
      }

      a(String $$0, io.a<?> $$1, @Nullable akq $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(vv $$0, io.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends io.a<A>> void a(vv $$0, io<A, T> $$1, io.a<A> $$2) {
         $$0.c(lt.u.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
