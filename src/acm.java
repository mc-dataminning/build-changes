...
public final class acm<E> implements Codec<he<E>> {
   ...
   public <T> DataResult<T> a(he<E> $$0, DynamicOps<T> $$1, T $$2) {
      if ($$1 instanceof aco<?> $$3) {
         ...
         if ($$4.isPresent()) {
            ...
            return (DataResult<T>)$$0.d().map($$2x -> acq.a.encode($$2x.a(), $$1, $$2), $$2x -> this.b.encode($$2x, $$1, $$2));
         }
      }
