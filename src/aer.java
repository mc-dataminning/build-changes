...
public final class aer<E> implements Codec<hg<E>> {
   private final aet<? extends ht<E>> a;

   public static <E> aer<E> a(aet<? extends ht<E>> $$0) {
      return new aer<>($$0);
   }

   private aer(aet<? extends ht<E>> $$0) {
      this.a = $$0;
   }
