...
public class ffk implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<ffk.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public ffk(List<ffk.a> $$0) {
      this.c = $$0;
   }
   ...
   public static ffk a(BufferedReader $$0) {
      return new ffk($$0.lines().flatMap($$0x -> ffk.a.a($$0x).stream()).toList());
   }

   public static record a(ffk.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<ffk.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new ffk.a(ffk.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new ffk.a(ffk.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new ffk.a(ffk.b.b, $$3));
      ...
      static ffk.a b(String $$0) {
         return new ffk.a(ffk.b.a, "glob:" + $$0);
      }

      static ffk.a c(String $$0) {
         return new ffk.a(ffk.b.a, "regex:" + $$0);
      }

      static ffk.a d(String $$0) {
         return new ffk.a(ffk.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      ffk.b a = FileSystem::getPathMatcher;
      ffk.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
