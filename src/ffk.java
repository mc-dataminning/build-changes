...
public abstract class ffk<T extends ffk<T>> {
   ...
   public ffk(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = ffi.a();
         if ($$3 != null) {
         ...
         throw new fhb(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fhb(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fhb(var2.getMessage(), var2);
      }
   }
   ...
   public static ffk<?> a(String $$0) {
      return new ffk.b($$0, 5000, 60000);
   }

   public static ffk<?> a(String $$0, int $$1, int $$2) {
      return new ffk.b($$0, $$1, $$2);
   }

   public static ffk<?> b(String $$0, String $$1) {
      return new ffk.c($$0, $$1, 5000, 60000);
   }

   public static ffk<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new ffk.c($$0, $$1, $$2, $$3);
   }

   public static ffk<?> b(String $$0) {
      return new ffk.a($$0, 5000, 60000);
   }

   public static ffk<?> c(String $$0, String $$1) {
      return new ffk.d($$0, $$1, 5000, 60000);
   }

   public static ffk<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new ffk.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends ffk<ffk.a> {
   ...
   public static class b extends ffk<ffk.b> {
   ...
   public static class c extends ffk<ffk.c> {
      ...
      public ffk.c f() {
         try {
            ...
            throw new fhb(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends ffk<ffk.d> {
      private final String c;
