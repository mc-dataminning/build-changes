...
public class ffk extends ffa<cjw> {
   ...
   private final fep R = new fep(0);
   private final fep S = new fep(1);
   private final fep T = new fep(2);
   @Nullable
   private cbj U;

   public ffk(cjw $$0, cfg $$1, vf $$2) {
   ...
   @Override
   protected void H() {
      this.U = new cbj(this.f.r, 0.0, 0.0, 0.0);
      this.U.s(true);
      this.U.a(true);
      this.U.aU = 210.0F;
      this.U.s(25.0F);
   ...
   public void D() {
      super.D();
      Optional<cnz> $$0 = this.I();
      this.R.a(C);
      this.S.a($$0.map(cnz::y).orElse(List.of()));
      this.T.a($$0.map(cnz::z).orElse(List.of()));
   }

   private Optional<cnz> I() {
      cmx $$0 = this.p.b(0).g();
      return !$$0.b() && $$0.d() instanceof cnz $$1 ? Optional.of($$1) : Optional.empty();
   }
   ...
   protected void a(ewt $$0, float $$1, int $$2, int $$3) {
      ...
      fez.a($$0, (float)(this.t + 141), (float)(this.u + 75), 25, M, N, null, this.U);
   }
   ...
   @Override
   protected void c(ewt $$0, int $$1, int $$2) {
      if (this.J()) {
         $$0.a(x, $$1 + 65, $$2 + 46, 28, 21);
      }
   }

   private void d(ewt $$0, int $$1, int $$2) {
      ...
      if (this.r != null) {
         ...
         } else if ($$4.d() instanceof cnz $$6 && $$5.b()) {
            if (this.r.e == 1) {
               $$3 = Optional.of($$6.i());
            } else if (this.r.e == 2) {
               $$3 = Optional.of($$6.x());
