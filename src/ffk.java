public class ffk extends ffm<bze> {
   ...
   public void a(bze $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$8 != null) {
         ...
         double $$14 = $$12.b($$13);
         this.p.b = arx.c((float)Math.abs($$14)) * 2.0F * (float)Math.signum($$14);
      }

      this.p.k = true;
      float $$15 = $$0.E($$6);
      this.r[0].f = arx.a($$15) * (float) Math.PI * 0.05F;
      this.r[1].f = arx.a($$15) * (float) Math.PI * 0.1F;
      this.r[2].f = arx.a($$15) * (float) Math.PI * 0.15F;
   }
   ...
   private static float a(int $$0, float $$1, float $$2) {
      return 1.0F + arx.b($$1 * 1.5F + (float)$$0) * 0.01F - $$2;
   }
