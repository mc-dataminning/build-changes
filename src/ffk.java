...
public class ffk extends aut<Map<String, List<ffk.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<ffk.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(ffk.a::a),
                     Codec.LONG.fieldOf("period").forGetter(ffk.a::b),
                     Codec.STRING.fieldOf("title").forGetter(ffk.a::c),
                     Codec.STRING.fieldOf("message").forGetter(ffk.a::d)
                  )
                  .apply($$0, ffk.a::new)
         )
         .listOf()
   ...
   public ffk(ale $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<ffk.a>> a(auo $$0, bnh $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<ffk.a>> $$0, auo $$1, bnh $$2) {
      List<ffk.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<ffk.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<ffk.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<ffk.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public ffk.b a(List<ffk.a> $$0, long $$1) {
         this.cancel();
         return new ffk.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (ffk.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fjl.a(ffe.Q().ax(), fjl.a.f, xo.a($$2.c, $$3), xo.a($$2.d, $$3)));
                  return;
               }
            }
         }
