...
public class ffk {
   ...
   private static final Queue<ffk.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ffk.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ffk::a), ffh::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ffk::a), ffh::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ffk.a(this.b) + ", type=" + ffk.b(this.c) + ", severity=" + ffk.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
