...
public interface ik<T> {
   ...
   im<T> a(@Nullable ux var1, CommandDispatcher<T> var2) throws ez;
   ...
   static <T extends ey<T>> ik<T> a(alz $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      il<T> $$4 = new il<>();
   ...
   static <T extends ey<T>> ia<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new ic.c<>($$2.getString(), $$4.get());
      }
   }
}
