   ...
   public void a(frd $$0, long $$1) {
      ...
      if ($$2 == null) {
         ...
         if (!this.g && $$1 > 0L) {
            this.g = true;
            if ($$2.e() == ao.b) {
               $$0.c().ak().a(hij.a(awa.Bl, 1.0F, 1.0F));
            }
         }

         this.h = (double)$$1 >= 5000.0 * $$0.d() ? frc.a.b : frc.a.a;
      }
   }
