...
public class fqz {
   ...
   public fqz(Supplier<String> $$0, Consumer<String> $$1, Supplier<String> $$2, Consumer<String> $$3, Predicate<String> $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public static Supplier<String> a(fme $$0) {
      return () -> b($$0);
   }

   public static String b(fme $$0) {
      return n.a($$0.p.a().replaceAll("\\r", ""));
   }

   public static Consumer<String> c(fme $$0) {
      return $$1 -> a($$0, $$1);
   }
   ...
   public void a(int $$0, boolean $$1, fqz.a $$2) {
      switch ($$2) {
         case a:
            this.a($$0, $$1);
            break;
   ...
   public void b(int $$0, boolean $$1) {
      this.f = fmo.a(this.a.get(), $$0, this.f, true);
      this.c($$1);
   }

   public void a(int $$0, fqz.a $$1) {
      switch ($$1) {
         case a:
            this.e($$0);
            break;
   ...
   public void d(int $$0) {
      int $$1 = fmo.a(this.a.get(), $$0, this.f, true);
      this.e($$1 - this.f);
   }
