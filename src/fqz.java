public class fqz extends fru {
   private final frp a;

   fqz(fnr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, frp $$7) {
   ...
   public static class a implements fqx<ka> {
      ...
      public fqu a(ka $$0, fnr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fqz($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements fqx<ka> {
      ...
      public fqu a(ka $$0, fnr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fqu $$8 = new fqz($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
