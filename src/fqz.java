...
public class fqz implements frd.a {
   ...
   private final eql J;
   private final Map<gu, fqz.a> K = Maps.newHashMap();
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bii $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dF();
      });
   }

   private void b(elf $$0, fnu $$1, double $$2, double $$3, double $$4) {
      gu $$5 = gu.a($$2, $$3, $$4);
   ...
   private void a(elf $$0, fnu $$1, fqz.a $$2) {
      int $$3 = 0;
   ...
   private void a(elf $$0, fnu $$1, vn.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         frl.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(elf $$0, fnu $$1, vn.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(elf $$0, fnu $$1, String $$2, fqz.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      frd.a(this.J.am(), 8).ifPresent($$0 -> this.M = $$0.cv());
   }
