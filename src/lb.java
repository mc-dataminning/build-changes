public class lb implements lc {
   ...
   @Override
   public final cxh dispense(kz $$0, cxh $$1) {
      cxh $$2 = this.a($$0, $$1);
      this.a($$0);
      this.a($$0, $$0.d().c(dmk.b));
      return $$2;
   }
   ...
   public static void a(dgz $$0, cxh $$1, int $$2, jn $$3, kb $$4) {
      double $$5 = $$4.a();
      double $$6 = $$4.b();
      double $$7 = $$4.c();
      if ($$3.o() == jn.a.b) {
   ...
   protected cxh a(kz $$0, cxh $$1, cxh $$2) {
      $$1.h(1);
      if ($$1.f()) {
         return $$2;
      } else {
