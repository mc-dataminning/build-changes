...
public class evv implements egg.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<evv> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azf<evv> a = azf.a(f);
   private final evz g;
   private final evz h;
   private final evz i;
   ...
   public static evv a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new evv(new eho(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private evv(evz $$0, evz $$1, evz $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public evv(azv $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         evz.a($$0, IntStream.rangeClosed(-15, 0)),
         evz.a($$0, IntStream.rangeClosed(-15, 0)),
         evz.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public evv a(azv $$0) {
      return new evv($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(egg.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         evw $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(evz.b($$4 * $$13), evz.b($$5 * $$13), evz.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = evz.b($$1 * $$13);
         double $$21 = evz.b($$2 * $$13);
         double $$22 = evz.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            evw $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return azm.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
