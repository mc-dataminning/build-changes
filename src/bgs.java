...
public abstract class bgs extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$2 = DSL.named(bgg.z.typeName(), bhs.a());
      if (!Objects.equals(this.getOutputSchema().getType(bgg.z), $$2)) {
