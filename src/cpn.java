...
public class cpn extends bza<cpk> {
   ...
   public static boolean a(arq $$0, cpk $$1) {
      if (!$$1.aH() && !$$1.bh()) {
         return false;
      } else if (cbu.a($$1)) {
         return false;
         ...
         if ($$2 == null) {
            ...
            if ($$3 == null) {
               ...
               if ($$1.an().a($$4)) {
                  return false;
               } else if (!cpm.a($$1, $$3.b()) && !cpm.a($$1, $$3.b(4).b())) {
                  return false;
               } else {
                  $$1.eb().a(cgl.bb, $$3);
                  return true;
   ...
   protected boolean b(arq $$0, cpk $$1) {
      return a($$0, $$1);
   }

   protected boolean a(arq $$0, cpk $$1, long $$2) {
      return $$1.at() != bxv.a && !$$1.eb().a(cgl.aV);
   }

   protected void b(arq $$0, cpk $$1, long $$2) {
   ...
   protected void c(arq $$0, cpk $$1, long $$2) {
      boolean $$3 = $$1.bh();
      ...
      if (a($$1)) {
         ffc $$4 = $$1.eb().c(cgl.bb).flatMap($$1x -> a($$1, $$1.dX(), ffc.c($$1x))).orElse(null);
         if ($$4 == null) {
            $$1.b(bxv.a);
            return;
         }
   ...
   protected void d(arq $$0, cpk $$1, long $$2) {
   ...
   private static boolean b(cpk $$0) {
   ...
   @Nullable
   private static iv a(bxj $$0, ffc $$1) {
      dit $$2 = new dit($$1, $$1.a(jb.a, 10.0), dit.a.a, dit.b.a, $$0);
      ffa $$3 = $$0.dU().a($$2);
      if ($$3.d() == ffa.a.b) {
         return iv.a((jp)$$3.g()).d();
      } else {
         dit $$4 = new dit($$1, $$1.a(jb.b, 10.0), dit.a.a, dit.b.a, $$0);
         ffa $$5 = $$0.dU().a($$4);
         return $$5.d() == ffa.a.b ? iv.a((jp)$$5.g()).d() : null;
      }
   }

   private static boolean a(cpk $$0, bxj $$1) {
      return !$$1.a($$0, $$0.h(byp.m));
   }

   private static boolean b(cpk $$0, bxj $$1) {
      return $$1.f($$0) - 4.0F <= 0.0F;
   }

   private static boolean c(arq $$0, cpk $$1) {
      iv $$2 = $$1.du();
      if ($$0.a_($$2).a(dmt.pO)) {
         return false;
      } else {
   ...
   private static Optional<ffc> a(cpk $$0, azv $$1, ffc $$2) {
      for (int $$4 : ag.a(j, $$1)) {
         float $$5 = 0.058333334F * (float)$$0.h(byp.m);
         Optional<ffc> $$6 = cae.a($$0, $$2, $$5, $$4, false);
         if ($$6.isPresent()) {
            if ($$0.b(bvo.h)) {
