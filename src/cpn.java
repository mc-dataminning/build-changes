...
public class cpn extends cpr {
   ...
   private static final ajy<Integer> f = akc.a(cpn.class, aka.b);
   private static final ajy<Boolean> g = akc.a(cpn.class, aka.k);
   private int h;
   private int i;
   private int j;
   private int k;
   ...
   @Nullable
   private bum n;
   private cpn.a o = cpn.a.a;
   private final int p;
   private final int q;

   private cpn(but<? extends cpn> $$0, dgj $$1, int $$2, int $$3) {
      super($$0, $$1);
      this.p = Math.max(0, $$2);
      this.q = Math.max(0, $$3);
   }

   public cpn(but<? extends cpn> $$0, dgj $$1) {
      this($$0, $$1, 0, 0);
   }

   public cpn(coy $$0, dgj $$1, int $$2, int $$3) {
      this(but.bS, $$1, $$2, $$3);
      this.c($$0);
      float $$4 = $$0.dN();
      float $$5 = $$0.dL();
      ...
      this.b($$10, $$11, $$12, $$5, $$4);
      fbb $$13 = new fbb((double)(-$$7), (double)ayz.a(-($$9 / $$8), -5.0F, 5.0F), (double)(-$$6));
      double $$14 = $$13.g();
   ...
   public void h() {
      ...
      if ($$0 == null) {
         ...
         this.aK();
         this.F();
         if (this.o == cpn.a.a && (this.aJ() || this.P)) {
            this.i(fbb.c);
         }
   ...
   private boolean a(coy $$0) {
      cwq $$1 = $$0.eZ();
      cwq $$2 = $$0.fa();
      boolean $$3 = $$1.a(cwu.rS);
      boolean $$4 = $$2.a(cwu.rS);
   ...
   private void t() {
      faz $$0 = cpt.a(this, this::b);
      this.b($$0);
   }

   @Override
   protected boolean b(bum $$0) {
      return super.b($$0) || $$0.bL() && $$0 instanceof cld;
   }
   ...
   private boolean b(ji $$0) {
      ...
      for (int $$2 = -1; $$2 <= 2; $$2++) {
         cpn.b $$3 = this.a($$0.b(-2, $$2, -2), $$0.b(2, $$2, 2));
         switch ($$3) {
            case a:
               if ($$1 == cpn.b.c) {
                  return false;
   ...
   private cpn.b a(ji $$0, ji $$1) {
      return ji.d($$0, $$1).map(this::c).reduce(($$0x, $$1x) -> $$0x == $$1x ? $$0x : cpn.b.c).orElse(cpn.b.c);
   }

   private cpn.b c(ji $$0) {
      dwy $$1 = this.dV().a_($$0);
      if (!$$1.l() && !$$1.a(djp.fB)) {
         eta $$2 = $$1.y();
         return $$2.a(awv.a) && $$2.b() && $$1.g(this.dV(), $$0).c() ? cpn.b.b : cpn.b.c;
      } else {
         return cpn.b.a;
      }
   }
   ...
   public int a(cwq $$0) {
      ...
      if (!this.dV().C && $$1 != null && !this.a($$1)) {
         ...
         if (this.n != null) {
            ...
            $$2 = this.n instanceof cld ? 3 : 5;
         } else if (this.i > 0) {
            evv $$3 = new evv.a((ard)this.dV()).a(eym.f, this.dt()).a(eym.i, $$0).a(eym.a, this).a((float)this.p + $$1.gF()).a(eyl.f);
            evx $$4 = this.dV().p().bc().b(evo.am);
            List<cwq> $$5 = $$4.a($$3);
            ap.E.a((are)$$1, $$0, this, $$5);

            for (cwq $$6 : $$5) {
               cld $$7 = new cld(this.dV(), this.dA(), this.dC(), this.dG(), $$6);
               ...
               this.dV().b($$7);
               $$1.dV().b(new buy($$1.dV(), $$1.dA(), $$1.dC() + 0.5, $$1.dG() + 0.5, this.ae.a(6) + 1));
               if ($$6.a(awy.aT)) {
                  $$1.a(awk.R, 1);
               }
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 31 && this.dV().C && this.n instanceof coy && ((coy)this.n).c()) {
         this.d(this.n);
      }
   ...
   protected void d(bum $$0) {
      bum $$1 = this.p();
      if ($$1 != null) {
         fbb $$2 = new fbb($$1.dA() - this.dA(), $$1.dC() - this.dC(), $$1.dG() - this.dG()).c(0.1);
         $$0.i($$0.dy().e($$2));
      }
   }
   ...
   public coy m() {
      bum $$0 = this.p();
      return $$0 instanceof coy ? (coy)$$0 : null;
   }
