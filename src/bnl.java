...
public class bnl implements bnm {
   ...
   private static final bnl k = new bnl();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bnk $$0) {
      URL $$1 = bnl.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bnk $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bno a = new bno(() -> bnl.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bnl.this.l && $$0.getState() == RecordingState.STOPPED) {
