...
public record bnl(Instant a, String b, long c) {
   ...
   public static bnl a(RecordedEvent $$0) {
      ...
      return new bnl($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bnl.a a(List<bnl> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bnl>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bnl $$3 = (bnl)$$2x.get(0);
            bnl $$4 = (bnl)$$2x.get($$2x.size() - 1);
