...
public interface bnl<T, F> {
   ...
   public static final class a implements bnl<bnl.b, Runnable> {
   ...
   public static final class c<T> implements bnl<T, T> {
