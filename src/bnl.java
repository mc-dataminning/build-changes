...
public class bnl {
   ...
   private bnl(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bnl a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bnl($$0, $$1);
   }

   public bnl.d a() throws IOException {
      bnl.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bnl.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bnl.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bnl.c $$3 = bnl.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bnl.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bnl.a($$0, $$3);
            }
         }
   ...
   public bnl.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bnl.c> $$2 = this.a().c();
      ...
      bnl.e $$4 = new bnl.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bnl.c b) implements bnl.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bnl.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bnl.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bnl.b> {
      private final List<bnl.b> a;

      d(List<bnl.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bnl.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bnl.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bnl.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bnl.d a() {
         ListIterator<bnl.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bnl.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bnl.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bnl.b> b() {
         return this.a.stream();
      }

      public Set<bnl.c> c() {
         return this.a.stream().map(bnl.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bnl.c b) implements bnl.b {
