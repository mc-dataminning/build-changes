...
public class cji extends cjm {
   private static final Logger b = LogUtils.getLogger();
   private final axd c = axd.a();
   private boolean d;
   private int e;
   private static final int g = 10;
   private static final aim<Integer> h = aiq.a(cji.class, aio.b);
   private static final aim<Boolean> i = aiq.a(cji.class, aio.k);
   private int j;
   private int k;
   private int l;
   private int m;
   ...
   @Nullable
   private box p;
   private cji.a q = cji.a.a;
   private final int r;
   private final int s;

   private cji(bpd<? extends cji> $$0, cxb $$1, int $$2, int $$3) {
      super($$0, $$1);
      this.at = true;
      this.r = Math.max(0, $$2);
      this.s = Math.max(0, $$3);
   ...
   public cji(bpd<? extends cji> $$0, cxb $$1) {
      this($$0, $$1, 0, 0);
   }

   public cji(ciu $$0, cxb $$1, int $$2, int $$3) {
      this(bpd.bz, $$1, $$2, $$3);
      this.c($$0);
      float $$4 = $$0.dE();
      float $$5 = $$0.dC();
      ...
      this.b($$10, $$11, $$12, $$5, $$4);
      ept $$13 = new ept((double)(-$$7), (double)aww.a(-($$9 / $$8), -5.0F, 5.0F), (double)(-$$6));
      double $$14 = $$13.f();
   ...
   public void l() {
      ...
      if ($$0 == null) {
         ...
         this.I();
         if (this.q == cji.a.a && (this.aC() || this.P)) {
            this.g(ept.b);
         }
   ...
   private boolean a(ciu $$0) {
      cqm $$1 = $$0.eU();
      cqm $$2 = $$0.eV();
      boolean $$3 = $$1.a(cqp.qU);
      boolean $$4 = $$2.a(cqp.qU);
   ...
   protected boolean b(box $$0) {
      return super.b($$0) || $$0.bA() && $$0 instanceof cfe;
   }
   ...
   private void a(ib $$0) {
      ...
      if (this.k > 0) {
         ...
         if (this.m > 0) {
            ...
            this.a(aty.iQ, 0.25F, 1.0F + (this.ag.i() - this.ag.i()) * 0.4F);
   ...
   private boolean b(ib $$0) {
      ...
      for (int $$2 = -1; $$2 <= 2; $$2++) {
         cji.b $$3 = this.a($$0.b(-2, $$2, -2), $$0.b(2, $$2, 2));
         switch ($$3) {
            case c:
               return false;
            case a:
   ...
   private cji.b a(ib $$0, ib $$1) {
      return ib.b($$0, $$1).map(this::c).reduce(($$0x, $$1x) -> $$0x == $$1x ? $$0x : cji.b.c).orElse(cji.b.c);
   }

   private cji.b c(ib $$0) {
      dnb $$1 = this.dM().a_($$0);
      if (!$$1.i() && !$$1.a(dae.fm)) {
         eip $$2 = $$1.u();
         return $$2.a(aus.a) && $$2.b() && $$1.k(this.dM(), $$0).c() ? cji.b.b : cji.b.c;
      } else {
         return cji.b.a;
      }
   }
   ...
   public int a(cqm $$0) {
      ...
      if (!this.dM().B && $$1 != null && !this.a($$1)) {
         ...
         if (this.p != null) {
            ...
            $$2 = this.p instanceof cfe ? 3 : 5;
         } else if (this.k > 0) {
            elc $$3 = new elc.a((apf)this.dM()).a(enh.f, this.dk()).a(enh.i, $$0).a(enh.a, this).a((float)this.r + $$1.gv()).a(eng.f);
            ele $$4 = this.dM().o().aM().getLootTable(eku.as);
            List<cqm> $$5 = $$4.a($$3);
            am.E.a((apg)$$1, $$0, this, $$5);

            for (cqm $$6 : $$5) {
               cfe $$7 = new cfe(this.dM(), this.dr(), this.dt(), this.dx(), $$6);
               ...
               this.dM().b($$7);
               $$1.dM().b(new bpf($$1.dM(), $$1.dr(), $$1.dt() + 0.5, $$1.dx() + 0.5, this.ag.a(6) + 1));
               if ($$6.a(auv.ao)) {
                  $$1.a(aui.R, 1);
               }
            }
   ...
   public void b(byte $$0) {
      if ($$0 == 31 && this.dM().B && this.p instanceof ciu && ((ciu)this.p).g()) {
         this.d(this.p);
      }
   ...
   protected void d(box $$0) {
      box $$1 = this.af_();
      if ($$1 != null) {
         ept $$2 = new ept($$1.dr() - this.dr(), $$1.dt() - this.dt(), $$1.dx() - this.dx()).a(0.1);
         $$0.g($$0.dp().e($$2));
      }
   }
   ...
   public ciu r() {
      box $$0 = this.af_();
      return $$0 instanceof ciu ? (ciu)$$0 : null;
   }
