...
public class bcr extends bhn {
   public bcr(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bis.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bis.s, "minecraft:jukebox");
