...
public class ech {
   private static final ech a = new ech(new Long2ObjectOpenHashMap(), new Long2ObjectOpenHashMap()) {
      @Override
      public ech.a a(int $$0, int $$1) {
         return new ech.a(1.0, 0.0);
      }
   ...
   private static final eqn b = eqn.b(new ecg(42L), rc.a);
   ...
   private final Long2ObjectOpenHashMap<eci> h;
   private final Long2ObjectOpenHashMap<eci> i;

   public static ech a() {
      return a;
   }

   public static ech a(@Nullable arv $$0) {
      if ($$0 == null) {
         return a;
      } else {
         deh $$1 = $$0.a();
         if (!$$0.a($$1, d)) {
            ...
            Long2ObjectOpenHashMap<eci> $$2 = new Long2ObjectOpenHashMap();
            Long2ObjectOpenHashMap<eci> $$3 = new Long2ObjectOpenHashMap();
            int $$4 = azk.h(d + 1);
            ...
            return $$2.isEmpty() && $$3.isEmpty() ? a : new ech($$2, $$3);
         }
      }
   }

   ech(Long2ObjectOpenHashMap<eci> $$0, Long2ObjectOpenHashMap<eci> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   public ech.a a(int $$0, int $$1) {
      int $$2 = kb.a($$0);
      int $$3 = kb.a($$1);
      double $$4 = this.a($$2, 0, $$3, eci::a);
      if ($$4 != Double.MAX_VALUE) {
         return new ech.a(0.0, a($$4));
      } else {
         ...
         this.h.forEach(($$5x, $$6x) -> $$6x.a(kb.d(deh.a($$5x)), kb.d(deh.b($$5x)), ($$5xx, $$6xx, $$7x) -> {
   ...
   public double a(eay.b $$0, double $$1) {
      ...
      if ($$5 != Double.MAX_VALUE) {
         ...
         this.i.forEach(($$6x, $$7x) -> $$7x.a(kb.d(deh.a($$6x)), kb.d(deh.b($$6x)), $$3 - 1, $$3 + 1, ($$6xx, $$7xx, $$8x, $$9x) -> {
   ...
   private double a(int $$0, int $$1, int $$2, ech.b $$3) {
      int $$4 = kb.e($$0);
      int $$5 = kb.e($$2);
      boolean $$6 = ($$0 & 3) == 0;
      boolean $$7 = ($$2 & 3) == 0;
   ...
   private double a(ech.b $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      eci $$6 = (eci)this.h.get(deh.c($$1, $$2));
      return $$6 != null ? $$0.get($$6, $$3 - kb.d($$1), $$4, $$5 - kb.d($$2)) : Double.MAX_VALUE;
   }

   public dgf a(dgf $$0) {
      return ($$1, $$2, $$3, $$4) -> {
         jq<dgc> $$5 = this.a($$1, $$2, $$3);
         return $$5 == null ? $$0.getNoiseBiome($$1, $$2, $$3, $$4) : $$5;
      };
   }

   @Nullable
   private jq<dgc> a(int $$0, int $$1, int $$2) {
      MutableDouble $$3 = new MutableDouble(Double.POSITIVE_INFINITY);
      MutableObject<jq<dgc>> $$4 = new MutableObject();
      this.h.forEach(($$5x, $$6x) -> $$6x.a(kb.d(deh.a($$5x)), $$1, kb.d(deh.b($$5x)), ($$4xx, $$5xx, $$6xx) -> {
   ...
   public static void a(arv $$0, dxf $$1) {
      deh $$2 = $$1.f();
      boolean $$3 = $$1.r();
      jh.a $$4 = new jh.a();
            ...
            if ($$0.a($$2.g + $$11.j(), $$2.h + $$11.l()).r() != $$3) {
               ...
               for (int $$16 = $$12; $$16 <= $$13; $$16++) {
                  for (int $$17 = $$14; $$17 <= $$15; $$17++) {
                     int $$18 = Math.min($$8, $$1.a(ebf.a.e, $$16, $$17)) + 1;
   ...
   private static void a(dxf $$0, jh $$1) {
      dvj $$2 = $$0.a_($$1);
      if ($$2.a(axa.P)) {
         $$0.e($$1);
      }
   ...
   public static void a(dfy $$0, dxz $$1) {
      deh $$2 = $$1.f();
      Builder<jn, eci> $$3 = ImmutableMap.builder();
   ...
   public static ech.c a(@Nullable eci $$0, Map<jn, eci> $$1) {
      List<ech.c> $$2 = Lists.newArrayList();
      if ($$0 != null) {
         $$2.add(a(null, $$0));
      }
   ...
   private static ech.c a(@Nullable jn $$0, eci $$1) {
      double $$2 = 0.0;
      double $$3 = 0.0;
      if ($$0 != null) {
         for (jm $$4 : $$0.a()) {
   ...
   interface b {
      double get(eci var1, int var2, int var3, int var4);
   }
