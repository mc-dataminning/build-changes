public class ech {
   ...
   private int a(djj $$0, int $$1, int $$2, int $$3) {
      int $$4 = iy.c($$0.g($$1) + 1);
      hx.a $$5 = this.e.d($$2, $$4, $$3);
      hx.a $$6 = this.f.a($$5, ib.a);
      dhn $$7 = cvh.a.o();
   ...
   public boolean a(crl $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(crl $$0, int $$1, int $$2, hx $$3, dhn $$4, hx $$5, dhn $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(crl $$0, hx $$1, dhn $$2) {
      hx.a $$3 = this.e.g($$1);
      hx.a $$4 = this.f.a($$1, ib.a);
      dhn $$5 = $$2;
   ...
   private static boolean a(crl $$0, hx $$1, dhn $$2, hx $$3, dhn $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         eks $$5 = eco.a($$0, $$1, $$2, ib.a);
         eks $$6 = eco.a($$0, $$3, $$4, ib.b);
         return ekp.b($$5, $$6);
      }
   }
