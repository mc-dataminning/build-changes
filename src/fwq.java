...
public class fwq<T extends cgh> extends ftq<T> {
   ...
   public static fxh a(fxd $$0) {
      ...
      fxi $$2 = $$1.a();
      float $$3 = 13.5F;
      fxi $$4 = $$2.a("head", fxe.c(), fxb.a(-1.0F, 13.5F, -7.0F));
      $$4.a(
         "real_head",
         fxe.c()
            .a(0, 0)
      ...
      $$2.a("body", fxe.c().a(18, 14).a(-3.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F, $$0), fxb.a(0.0F, 14.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("upper_body", fxe.c().a(21, 0).a(-3.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F, $$0), fxb.a(-1.0F, 14.0F, -3.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fxe $$5 = fxe.c().a(0, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0);
      $$2.a("right_hind_leg", $$5, fxb.a(-2.5F, 16.0F, 7.0F));
      $$2.a("left_hind_leg", $$5, fxb.a(0.5F, 16.0F, 7.0F));
      $$2.a("right_front_leg", $$5, fxb.a(-2.5F, 16.0F, -4.0F));
      $$2.a("left_front_leg", $$5, fxb.a(0.5F, 16.0F, -4.0F));
      fxi $$6 = $$2.a("tail", fxe.c(), fxb.a(-1.0F, 12.0F, 8.0F, (float) (Math.PI / 5), 0.0F, 0.0F));
      $$6.a("real_tail", fxe.c().a(9, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0), fxb.a);
      return $$1;
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      if ($$0.Z_()) {
         ...
         this.n.f = ayy.b($$1 * 0.6662F) * 1.4F * $$2;
      }
      ...
      if ($$0.y()) {
         ...
         this.j.e = ayy.b($$1 * 0.6662F) * 1.4F * $$2;
         this.k.e = ayy.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.l.e = ayy.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.m.e = ayy.b($$1 * 0.6662F) * 1.4F * $$2;
      }
