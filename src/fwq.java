...
public class fwq extends fpa<fwq.a> {
   ...
   private final fwm N;
   private final List<fwq.d> O = Lists.newArrayList();
   private final fwq.a P = new fwq.b();
   private final List<fwq.c> Q = Lists.newArrayList();

   public fwq(fwm $$0, fme $$1, int $$2, int $$3, int $$4, int $$5) {
      super($$1, $$2, $$3, $$4, $$5);
      this.N = $$0;
   }
   ...
   public void a(@Nullable fwq.a $$0) {
      super.a($$0);
      this.N.E();
   }
   ...
   public void a(gfy $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.c(); $$1++) {
         this.O.add(new fwq.d(this.N, $$0.a($$1)));
      }

      this.c();
   }

   public void a(List<hfv> $$0) {
      int $$1 = $$0.size() - this.Q.size();
      this.Q.clear();

      for (hfv $$2 : $$0) {
         this.Q.add(new fwq.c(this.N, $$2));
      }

      this.c();

      for (int $$3 = this.Q.size() - $$1; $$3 < this.Q.size(); $$3++) {
         fwq.c $$4 = this.Q.get($$3);
   ...
   public abstract static class a extends fpa.a<fwq.a> implements AutoCloseable {
      @Override
      public void close() {
      }
   }

   public static class b extends fwq.a {
      private final fme a = fme.Q();

      @Override
      public void a(fnq $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
         int $$10 = $$2 + $$5 / 2 - 9 / 2;
         $$0.a(this.a.h, fwq.G, this.a.z.n / 2 - this.a.h.a(fwq.G) / 2, $$10, 16777215, false);
         String $$11 = ftl.a(ae.c());
   ...
   public static class c extends fwq.a {
      ...
      protected final hfv b;
      private long g;

      protected c(fwm $$0, hfv $$1) {
         this.f = $$0;
         this.b = $$1;
         this.a = fme.Q();
      }
   ...
   public class d extends fwq.a {
      ...
      protected d(final fwm $$1, final gfx $$2) {
         this.g = $$1;
         this.i = $$2;
         this.h = fme.Q();
         this.j = ftg.b(this.h.aa(), $$2.b);
         this.d();
      }
      ...
      public void a(fnq $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            fwq.F.submit(() -> {
               try {
                  this.g.F().a(this.i, () -> this.h.execute(this::b), () -> {
                     this.i.a(this.i.g == ab.b().e() ? gfx.b.e : gfx.b.d);
         ...
         xv $$15 = (xv)(this.i.g() == gfx.b.d ? this.i.h.f().a(n.m) : this.i.c);
         ...
         if (this.h.n.ac().c() || $$8) {
            ...
            if (this.e()) {
               if ($$18 < 32 && $$18 > 16) {
                  $$0.a(glt::B, fwq.y, $$3, $$2, 32, 32);
               } else {
                  $$0.a(glt::B, fwq.z, $$3, $$2, 32, 32);
               }
            }

            if ($$1 > 0) {
               if ($$18 < 16 && $$19 < 16) {
                  $$0.a(glt::B, fwq.A, $$3, $$2, 32, 32);
               } else {
                  $$0.a(glt::B, fwq.B, $$3, $$2, 32, 32);
               }
            }

            if ($$1 < this.g.G().c() - 1) {
               if ($$18 < 16 && $$19 > 16) {
                  $$0.a(glt::B, fwq.C, $$3, $$2, 32, 32);
               } else {
                  $$0.a(glt::B, fwq.D, $$3, $$2, 32, 32);
               }
            }
         }
      }
      ...
      protected void a(fnq $$0, int $$1, int $$2, alz $$3) {
         $$0.a(glt::B, $$3, $$1, $$2, 0.0F, 0.0F, 32, 32, 32, 32);
      }
      ...
      private boolean a(@Nullable byte[] $$0) {
         if ($$0 == null) {
            ...
            try {
               ...
               fwq.E.error("Invalid icon for server {} ({})", new Object[]{this.i.a, this.i.b, var3});
               return false;
            }
         }
      ...
      @Override
      public boolean a(double $$0, double $$1, int $$2) {
         double $$3 = $$0 - (double)fwq.this.s();
         double $$4 = $$1 - (double)fwq.this.e(fwq.this.aI_().indexOf(this));
         if ($$3 <= 32.0) {
