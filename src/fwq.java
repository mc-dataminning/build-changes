...
public class fwq {
   ...
   public fwj a(Vector3f $$0, Vector3f $$1, fwl $$2, ggu $$3, ie $$4, gjc $$5, @Nullable fwm $$6, boolean $$7, aiy $$8) {
      fwn $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = awh.i($$11, $$9.a[0], $$12);
      $$9.a[2] = awh.i($$11, $$9.a[2], $$12);
      $$9.a[1] = awh.i($$11, $$9.a[1], $$13);
      $$9.a[3] = awh.i($$11, $$9.a[3], $$13);
      ...
      return new fwj($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fwn a(fwn $$0, ie $$1, j $$2, aiy $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(awh.b($$23), awh.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fwn(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fwn $$0, ggu $$1, ie $$2, float[] $$3, j $$4, @Nullable fwm $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, ie $$2, fwn $$3, float[] $$4, ggu $$5, j $$6, @Nullable fwm $$7, boolean $$8) {
      fvd.b $$9 = fvd.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, ggu $$3, fwn $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fwm $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, ie $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (awh.a($$13, $$18) && awh.a($$14, $$19) && awh.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
