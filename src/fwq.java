public class fwq<T extends civ> extends fuj<T> {
   ...
   public static fxg a(fxe $$0) {
      fxi $$1 = new fxi();
      fxj $$2 = $$1.a();
      $$2.a("shoulders", fxf.c().a(0, 16).a(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, $$0), fxc.a);
      float $$3 = 0.20420352F;
      $$2.a(
         "ribcage",
         fxf.c()
         ...
         fxc.a(-2.0F, 6.9F, -0.5F, 0.20420352F, 0.0F, 0.0F)
      );
      $$2.a(
         "tail",
         fxf.c().a(12, 22).a(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 3.0F, $$0),
         fxc.a(-2.0F, 6.9F + ayz.b(0.20420352F) * 10.0F, -0.5F + ayz.a(0.20420352F) * 10.0F, 0.83252203F, 0.0F, 0.0F)
      );
      $$2.a("center_head", fxf.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), fxc.a);
      fxf $$4 = fxf.c().a(32, 0).a(-4.0F, -4.0F, -4.0F, 6.0F, 6.0F, 6.0F, $$0);
      $$2.a("right_head", $$4, fxc.a(-8.0F, 4.0F, 0.0F));
      $$2.a("left_head", $$4, fxc.a(10.0F, 4.0F, 0.0F));
   ...
   private static <T extends civ> void a(T $$0, fxa $$1, int $$2) {
