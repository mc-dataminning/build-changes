...
public class bah {
   ...
   private static void a(DataFixerBuilder $$0) {
      ...
      $$0.addFixer(new bda($$8, true));
      Schema $$9 = $$0.addSchema(110, b);
      $$0.addFixer(new bdb($$9, true));
      ...
      Schema $$16 = $$0.addSchema(501, blk::new);
      ...
      Schema $$19 = $$0.addSchema(700, bll::new);
      $$0.addFixer(new bcx($$19, true));
      Schema $$20 = $$0.addSchema(701, blm::new);
      $$0.addFixer(new bdr($$20, true));
      Schema $$21 = $$0.addSchema(702, bln::new);
      $$0.addFixer(new bdy($$21));
      Schema $$22 = $$0.addSchema(703, blo::new);
      $$0.addFixer(new bdc($$22, true));
      Schema $$23 = $$0.addSchema(704, blp::new);
      $$0.addFixer(new bbf($$23, true));
      Schema $$24 = $$0.addSchema(705, blq::new);
      ...
      Schema $$27 = $$0.addSchema(808, blr::new);
      ...
      $$0.addFixer(new bet($$29, false));
      $$0.addFixer(new bbj($$29, false));
      ...
      $$0.addFixer(new bap($$42, "RemoveNoteBlockFlowerPotFix", bgx.s));
      $$0.addFixer(new bfa($$42, false, "minecraft:spawn_egg"));
      ...
      $$0.addFixer(bbp.a($$58, "Rename kelp/kelptop", b(ImmutableMap.of("minecraft:kelp_top", "minecraft:kelp", "minecraft:kelp", "minecraft:kelp_plant"))));
      $$0.addFixer(bes.a($$58, "Rename kelptop", a("minecraft:kelp_top", "minecraft:kelp")));
      $$0.addFixer(new bfv($$58, false, "Command block block entity custom name fix", bgx.s, "minecraft:command_block") {
         @Override
         protected Typed<?> a(Typed<?> $$0) {
            return $$0.update(DSL.remainderFinder(), bcw::a);
         }
      });
      $$0.addFixer(new bfv($$58, false, "Command block minecart custom name fix", bgx.B, "minecraft:commandblock_minecart") {
         @Override
         protected Typed<?> a(Typed<?> $$0) {
            return $$0.update(DSL.remainderFinder(), bcw::a);
         }
      });
      $$0.addFixer(new bel($$58, false));
      Schema $$59 = $$0.addSchema(1490, c);
      $$0.addFixer(bbp.a($$59, "Rename melon_block", a("minecraft:melon_block", "minecraft:melon")));
      $$0.addFixer(
         bes.a(
            $$59,
      ...
      $$0.addFixer(new bch($$60, false));
      Schema $$61 = $$0.addSchema(1494, c);
      $$0.addFixer(new bey($$61, false));
      Schema $$62 = $$0.addSchema(1496, c);
      $$0.addFixer(new bfi($$62, false));
      Schema $$63 = $$0.addSchema(1500, c);
      $$0.addFixer(new bbh($$63, false));
      Schema $$64 = $$0.addSchema(1501, c);
      $$0.addFixer(new baq($$64, false));
      ...
      $$0.addFixer(new bar($$95, false, "Rename sugar recipe advancement", a("minecraft:recipes/misc/sugar", "minecraft:recipes/misc/sugar_from_sugar_cane")));
      Schema $$96 = $$0.addSchema(2202, c);
      $$0.addFixer(new bbx($$96, false));
      Schema $$97 = $$0.addSchema(2209, c);
      UnaryOperator<String> $$98 = a("minecraft:bee_hive", "minecraft:beehive");
      $$0.addFixer(bes.a($$97, "Rename bee_hive item to beehive", $$98));
      ...
      $$0.addFixer(new bei($$109, "minecraft:zombie_villager"));
      ...
      $$0.addFixer(new bfx($$124, "Biomes fix", bgx.K, b(bay.a)));
      ...
      ImmutableMap<String, String> $$134 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(bes.a($$133, "Renamed copper block items to new oxidized terms", b($$134)));
      $$0.addFixer(bbp.a($$133, "Renamed copper blocks to new oxidized terms", b($$134)));
      ...
      ImmutableMap<String, String> $$136 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(bes.a($$135, "Rename copper item suffixes", b($$136)));
      $$0.addFixer(bbp.a($$135, "Rename copper blocks suffixes", b($$136)));
      Schema $$137 = $$0.addSchema(2693, c);
      $$0.addFixer(new bao($$137, bgx.M, "has_increased_height_already", false));
      ...
      ImmutableMap<String, String> $$139 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(bes.a($$138, "Renamed grimstone block items to deepslate", b($$139)));
      $$0.addFixer(bbp.a($$138, "Renamed grimstone blocks to deepslate", b($$139)));
      ...
      $$0.addFixer(
         bbp.a($$146, "Rename azalea_leaves_flowers items", b(ImmutableMap.of("minecraft:azalea_leaves_flowers", "minecraft:flowering_azalea_leaves")))
      );
      ...
      $$0.addFixer(new bfx($$154, "Remove Deep Warm Ocean", bgx.K, a("minecraft:deep_warm_ocean", "minecraft:warm_ocean")));
      ...
      $$0.addFixer(new bdw($$166, "Change cat variant type", bgx.B, "minecraft:cat", "CatType", ac.a(new Int2ObjectOpenHashMap(), $$0x -> {
      ...
      ImmutableMap<String, String> $$167 = ImmutableMap.builder()
         ...
         .build();
      $$0.addFixer(new bck($$166, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", $$1x -> (String)$$167.getOrDefault($$1x, $$1x)));
      Schema $$168 = $$0.addSchema(3087, c);
      $$0.addFixer(new bdw($$168, "Change frog variant type", bgx.B, "minecraft:frog", "Variant", ac.a(new Int2ObjectOpenHashMap(), $$0x -> {
         $$0x.put(0, "minecraft:temperate");
         $$0x.put(1, "minecraft:warm");
         $$0x.put(2, "minecraft:cold");
      })::get));
      Schema $$169 = $$0.addSchema(3090, c);
      $$0.addFixer(new bdg($$169));
      Schema $$170 = $$0.addSchema(3093, c);
      $$0.addFixer(new bcz($$170));
      ...
      $$0.addFixer(new bgq($$172, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
      ...
      $$0.addFixer(new bap($$187, "Added calibrated sculk sensor", bgx.s));
      Schema $$188 = $$0.addSchema(3439, c);
      $$0.addFixer(new bbk($$188, "Updated sign text format for Signs", "minecraft:sign"));
      $$0.addFixer(new bbk($$188, "Updated sign text format for Hanging Signs", "minecraft:hanging_sign"));
      Schema $$189 = $$0.addSchema(3440, c);
      $$0.addFixer(new bfx($$189, "Replace experimental 1.20 overworld", bgx.L, a("minecraft:overworld_update_1_20", "minecraft:overworld")));
      $$0.addFixer(new beb($$189, "Remove 1.20 feature toggle", Set.of("minecraft:update_1_20")));
      Schema $$190 = $$0.addSchema(3441, c);
      $$0.addFixer(new bba($$190));
      ...
      $$0.addFixer(new bbz($$194));
      Schema $$195 = $$0.addSchema(3459, c);
      $$0.addFixer(new bfj($$195));
      Schema $$196 = $$0.addSchema(3564, c);
      $$0.addFixer(new bcm($$196, "Drop invalid sign datafix data", "minecraft:sign"));
      $$0.addFixer(new bcm($$196, "Drop invalid hanging sign datafix data", "minecraft:hanging_sign"));
      ...
      Schema $$214 = $$0.addSchema(3808, 2, bld::new);
      $$0.addFixer(new bek($$214, "minecraft:trader_llama", "DecorItem", false));
      Schema $$215 = $$0.addSchema(3809, c);
      $$0.addFixer(new bbv($$215));
      Schema $$216 = $$0.addSchema(3812, c);
      $$0.addFixer(new baj($$216));
      Schema $$217 = $$0.addSchema(3813, c);
      $$0.addFixer(new bbo($$217));
      Schema $$218 = $$0.addSchema(3814, c);
      $$0.addFixer(new bat($$218, "Rename jump strength attribute", a("minecraft:horse.jump_strength", "minecraft:generic.jump_strength")));
      Schema $$219 = $$0.addSchema(3816, ble::new);
      $$0.addFixer(new bap($$219, "Added Bogged", bgx.B));
      Schema $$220 = $$0.addSchema(3818, blf::new);
      $$0.addFixer(new bax($$220));
      $$0.addFixer(new bcp($$220));
      Schema $$221 = $$0.addSchema(3818, 1, c);
      $$0.addFixer(new bav($$221));
      Schema $$222 = $$0.addSchema(3818, 2, c);
      $$0.addFixer(new bhs($$222));
      Schema $$223 = $$0.addSchema(3818, 3, blg::new);
      $$0.addFixer(new bif($$223, "Inject data component types", bgx.w));
      Schema $$224 = $$0.addSchema(3818, 4, blh::new);
      $$0.addFixer(new bgn($$224));
      Schema $$225 = $$0.addSchema(3818, 5, bli::new);
      $$0.addFixer(new bew($$225));
      Schema $$226 = $$0.addSchema(3818, 6, c);
      $$0.addFixer(new bas($$226));
      Schema $$227 = $$0.addSchema(3820, c);
      $$0.addFixer(new bgo($$227));
      $$0.addFixer(new bfo($$227));
      Schema $$228 = $$0.addSchema(3825, blj::new);
      $$0.addFixer(new bex($$228));
      $$0.addFixer(new bau($$228));
      $$0.addFixer(new bhu($$228));
      $$0.addFixer(new bap($$228, "Added Ominous Item Spawner", bgx.B));
      Schema $$229 = $$0.addSchema(3828, c);
      $$0.addFixer(new bcq($$229));
      Schema $$230 = $$0.addSchema(3833, c);
      $$0.addFixer(new bgz($$230));
   }
