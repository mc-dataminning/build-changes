...
public abstract class fuk<T extends bji, M extends fff<T>> extends fti<T> implements fve<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<fxr<T, M>> g = Lists.newArrayList();

   public fuk(ftj.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(fxr<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, elr $$3, fog $$4, int $$5) {
      ...
      this.f.d = $$0.bN();
      this.f.e = $$0.m_();
      float $$6 = ary.j($$2, $$0.aV, $$0.aU);
      float $$7 = ary.j($$2, $$0.aX, $$0.aW);
      float $$8 = $$7 - $$6;
      if ($$0.bN() && $$0.cY() instanceof bji $$9) {
         $$6 = ary.j($$2, $$9.aV, $$9.aU);
         $$8 = $$7 - $$6;
         float $$10 = ary.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected foo a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      aey $$4 = this.a($$0);
      if ($$2) {
         return foo.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? foo.q($$4) : null;
      }
   }

   public static int c(bji $$0, float $$1) {
      return fyx.a(fyx.a($$1), fyx.a($$0.aK > 0 || $$0.aM > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return eqx.K() && $$0 != $$3.am() && $$5 && !$$0.bO();
      }
   }

   public static boolean e(bji $$0) {
      if ($$0 instanceof cbw || $$0.ac()) {
         String $$1 = n.a($$0.ab().getString());
         if ("Dinnerbone".equals($$1) || "Grumm".equals($$1)) {
            return !($$0 instanceof cbw) || ((cbw)$$0).a(cbx.a);
         }
      }
