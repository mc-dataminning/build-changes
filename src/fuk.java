...
public class fuk {
   ...
   public fud a(Vector3f $$0, Vector3f $$1, fuf $$2, gem $$3, ic $$4, ggu $$5, @Nullable fug $$6, boolean $$7, ahg $$8) {
      fuh $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = aun.i($$11, $$9.a[0], $$12);
      $$9.a[2] = aun.i($$11, $$9.a[2], $$12);
      $$9.a[1] = aun.i($$11, $$9.a[1], $$13);
      $$9.a[3] = aun.i($$11, $$9.a[3], $$13);
      ...
      return new fud($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fuh a(fuh $$0, ic $$1, j $$2, ahg $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(aun.b($$23), aun.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fuh(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fuh $$0, gem $$1, ic $$2, float[] $$3, j $$4, @Nullable fug $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private float[] a(Vector3f $$0, Vector3f $$1) {
      float[] $$2 = new float[ic.values().length];
      $$2[fsx.a.f] = $$0.x() / 16.0F;
      $$2[fsx.a.e] = $$0.y() / 16.0F;
      $$2[fsx.a.d] = $$0.z() / 16.0F;
      $$2[fsx.a.c] = $$1.x() / 16.0F;
   ...
   private void a(int[] $$0, int $$1, ic $$2, fuh $$3, float[] $$4, gem $$5, j $$6, @Nullable fug $$7, boolean $$8) {
      fsx.b $$9 = fsx.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gem $$3, fuh $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fug $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   public static ic a(int[] $$0) {
      ...
      if (!$$6.isFinite()) {
         ...
         return $$7 == null ? ic.b : $$7;
      }
   }

   private void a(int[] $$0, ic $$1) {
      int[] $$2 = new int[$$0.length];
      System.arraycopy($$0, 0, $$2, 0, $$0.length);
      float[] $$3 = new float[ic.values().length];
      $$3[fsx.a.f] = 999.0F;
      $$3[fsx.a.e] = 999.0F;
      $$3[fsx.a.d] = 999.0F;
      $$3[fsx.a.c] = -999.0F;
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (aun.a($$13, $$18) && aun.a($$14, $$19) && aun.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
