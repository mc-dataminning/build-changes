public class fuk extends fvi<csw> {
   private static final alp G = alp.b("container/anvil/text_field");
   private static final alp H = alp.b("container/anvil/text_field_disabled");
   private static final alp I = alp.b("container/anvil/error");
   private static final alp J = alp.b("textures/gui/container/anvil.png");
   private static final xk K = xk.c("container.repair.expensive");
   private foh L;
   private final cpo M;

   public fuk(csw $$0, cpn $$1, xk $$2) {
      super($$0, $$1, $$2, J);
      this.M = $$1.k;
      this.v = 60;
   }
   ...
   protected void G() {
      ...
      this.L = new foh(this.p, $$0 + 62, $$1 + 24, 103, 12, xk.c("container.repair"));
      this.L.f(false);
      this.L.g(-1);
      this.L.n(-1);
      this.L.d(false);
   ...
   protected void b(fnl $$0, int $$1, int $$2) {
      ...
      if ($$3 > 0) {
         ...
         if ($$3 >= 40 && !this.m.t.gj().d) {
            ...
            $$5 = xk.a("container.repair.cost", $$3);
   ...
   protected void a(fnl $$0, float $$1, int $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      $$0.a(glq::H, this.z.b(0).h() ? G : H, this.C + 59, this.D + 20, 110, 16);
   }
