...
public class fuk {
   ...
   private final frd g;
   final Map<UUID, fuz> h = Maps.newLinkedHashMap();
   ...
   private void a(ftx $$0, int $$1, int $$2, buh $$3) {
      this.a($$0, $$1, $$2, $$3, 182, c, e);
      int $$4 = azo.b($$3.k(), 0, 182);
      if ($$4 > 0) {
         this.a($$0, $$1, $$2, $$3, $$4, d, f);
      }
   }

   private void a(ftx $$0, int $$1, int $$2, buh $$3, int $$4, ali[] $$5, ali[] $$6) {
      $$0.a(gsl::H, $$5[$$3.l().ordinal()], 182, 5, 0, 0, $$1, $$2, $$4, 5);
      if ($$3.m() != buh.b.a) {
         $$0.a(gsl::H, $$6[$$3.m().ordinal() - 1], 182, 5, 0, 0, $$1, $$2, $$4, 5);
      }
   }
   ...
   public void a(acf $$0) {
      $$0.a(new acf.b() {
         @Override
         public void a(UUID $$0, xa $$1, float $$2, buh.a $$3, buh.b $$4, boolean $$5, boolean $$6, boolean $$7) {
            fuk.this.h.put($$0, new fuz($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7));
         }
         ...
         public void a(UUID $$0, float $$1) {
            fuk.this.h.get($$0).a($$1);
         }

         @Override
         public void a(UUID $$0, xa $$1) {
            fuk.this.h.get($$0).a($$1);
         }

         @Override
         public void a(UUID $$0, buh.a $$1, buh.b $$2) {
            fuz $$3 = fuk.this.h.get($$0);
            $$3.a($$1);
            $$3.a($$2);
         }
