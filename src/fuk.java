...
public class fuk<T extends cey> extends ftd<T> {
   public final fxi a;
   private final fxi b;
   private final fxi f;
   private final fxi g;
   ...
   public static fxo c() {
      fxq $$0 = new fxq();
      fxr $$1 = $$0.a();
      fxr $$2 = $$1.a("head", fxn.c().a(1, 5).a(-3.0F, -2.0F, -5.0F, 8.0F, 6.0F, 6.0F), fxk.a(-1.0F, 16.5F, -3.0F));
      $$2.a("right_ear", fxn.c().a(8, 1).a(-3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fxk.a);
      $$2.a("left_ear", fxn.c().a(15, 1).a(3.0F, -4.0F, -4.0F, 2.0F, 2.0F, 1.0F), fxk.a);
      $$2.a("nose", fxn.c().a(6, 18).a(-1.0F, 2.01F, -8.0F, 4.0F, 2.0F, 3.0F), fxk.a);
      fxr $$3 = $$1.a("body", fxn.c().a(24, 15).a(-3.0F, 3.999F, -3.5F, 6.0F, 11.0F, 6.0F), fxk.a(0.0F, 16.0F, -6.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fxm $$4 = new fxm(0.001F);
      fxn $$5 = fxn.c().a(4, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      fxn $$6 = fxn.c().a(13, 24).a(2.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, $$4);
      $$1.a("right_hind_leg", $$6, fxk.a(-5.0F, 17.5F, 7.0F));
      $$1.a("left_hind_leg", $$5, fxk.a(-1.0F, 17.5F, 7.0F));
      $$1.a("right_front_leg", $$6, fxk.a(-5.0F, 17.5F, 0.0F));
      $$1.a("left_front_leg", $$5, fxk.a(-1.0F, 17.5F, 0.0F));
      $$3.a("tail", fxn.c().a(30, 0).a(2.0F, 0.0F, -1.0F, 4.0F, 9.0F, 5.0F), fxk.a(-4.0F, 15.0F, -1.0F, -0.05235988F, 0.0F, 0.0F));
      return fxo.a($$0, 48, 32);
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.fH()) {
         this.a.e = 0.0F;
         this.a.f = (float) (-Math.PI * 2.0 / 3.0);
         this.a.g = aye.b($$3 * 0.027F) / 22.0F;
      }

      if ($$0.ca()) {
         float $$6 = aye.b($$3) * 0.01F;
         this.b.f = $$6;
         this.f.g = $$6;
         this.g.g = $$6;
         this.h.g = $$6 / 2.0F;
      ...
      if ($$0.gn()) {
         float $$7 = 0.1F;
         this.n += 0.67F;
         this.f.e = aye.b(this.n * 0.4662F) * 0.1F;
         this.g.e = aye.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.h.e = aye.b(this.n * 0.4662F + (float) Math.PI) * 0.1F;
         this.i.e = aye.b(this.n * 0.4662F) * 0.1F;
      }
   }
}
