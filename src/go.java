...
public class go<T> implements AutoCloseable {
   ...
   private static <T extends dw<T>> gq a(go<T> $$0, dq $$1) {
      return new gq(0, $$1, $$0.i::clear);
   }

   public static <T extends dw<T>> void a(go<T> $$0, hd<T> $$1, T $$2, dq $$3) {
      $$0.a(new gk<>(a($$0, $$3), new gv<>($$1, $$2.p(), false).bind($$2)));
   }

   public static <T extends dw<T>> void a(go<T> $$0, String $$1, ContextChain<T> $$2, T $$3, dq $$4) {
