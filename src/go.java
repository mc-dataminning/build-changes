...
public class go {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(xa.c("argument.pos.missing.double"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(xa.c("argument.pos.missing.int"));
   private final boolean d;
   private final double e;

   public go(boolean $$0, double $$1) {
      this.d = $$0;
      this.e = $$1;
   }
