...
public class bxw extends biy {
   ...
   public static final adz<Byte> bC = aec.a(bxw.class, aeb.a);
   public static final adz<hw> bD = aec.a(bxw.class, aeb.m);
   public static final adz<hw> bE = aec.a(bxw.class, aeb.m);
   public static final adz<hw> bF = aec.a(bxw.class, aeb.m);
   public static final adz<hw> bG = aec.a(bxw.class, aeb.m);
   public static final adz<hw> bH = aec.a(bxw.class, aeb.m);
   public static final adz<hw> bI = aec.a(bxw.class, aeb.m);
   private static final Predicate<bii> bX = $$0 -> $$0 instanceof cde && ((cde)$$0).t() == cde.a.a;
   private final hn<ciy> bY = hn.a(2, ciy.b);
   private final hn<ciy> bZ = hn.a(4, ciy.b);
   private boolean ca;
   public long bJ;
   private int cb;
   private hw cc = bL;
   ...
   public bxw(bim<? extends bxw> $$0, cpm $$1) {
      super($$0, $$1);
      this.t(0.0F);
   }

   public bxw(cpm $$0, double $$1, double $$2, double $$3) {
      this(bim.d, $$0);
      this.e($$1, $$2, $$3);
   }
   ...
   private boolean a(cbn $$0, bin $$1, ciy $$2, bgp $$3) {
      ciy $$4 = this.c($$1);
   ...
   public boolean a(bhg $$0, float $$1) {
      if (this.dK().B || this.dF()) {
         ...
         boolean $$2 = $$0.c() instanceof cbt;
         boolean $$3 = $$2 && ((cbt)$$0.c()).w() > 0;
         boolean $$4 = "player".equals($$0.e());
         if (!$$4 && !$$2) {
            return false;
         } else {
            if ($$0.d() instanceof cbn $$5 && !$$5.fR().e) {
               return false;
            }
   ...
   private void h(bhg $$0) {
      ciy $$1 = new ciy(cjb.tL);
      if (this.ac()) {
         $$1.a(this.ad());
      }

      csm.a(this.dK(), this.dk(), $$1);
      this.i($$0);
   }
   ...
   public boolean u(bii $$0) {
      return $$0 instanceof cbn && !this.dK().a((cbn)$$0, this.dk());
   }
   ...
   public ehe k(float $$0) {
      if (this.t()) {
         egz $$1 = this.v(false).a(this.di());
         gu $$2 = this.dk();
         int $$3 = Integer.MIN_VALUE;

         for (gu $$4 : gu.a(gu.a($$1.a, $$1.b, $$1.c), gu.a($$1.d, $$1.e, $$1.f))) {
            int $$5 = Math.max(this.dK().a(cpv.b, $$4), this.dK().a(cpv.a, $$4));
            if ($$5 == 15) {
               return ehe.b($$4);
            }
