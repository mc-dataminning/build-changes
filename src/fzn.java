...
public class fzn<T extends gvy> extends fyx<T> {
   private static final String a = "cape";
   private final gbm b = this.q.b("cape");
   ...
   public static gbs a() {
      ...
      $$1.a("left_leg");
      $$1.a("right_leg");
      $$3.a("cape", gbr.c().a(0, 0).a(-5.0F, 0.0F, -1.0F, 10.0F, 16.0F, 1.0F, gbq.a, 1.0F, 0.5F), gbo.a(0.0F, 0.0F, 2.0F, 0.0F, (float) Math.PI, 0.0F));
