...
public class fzn extends fui {
   private static final Logger a = LogUtils.getLogger();
   private static final ToIntFunction<akt<dgg>> b = af.a(new Reference2IntOpenHashMap(), $$0 -> {
      $$0.put(dgg.i, -13408734);
      $$0.put(dgg.j, -10075085);
      $$0.put(dgg.k, -8943531);
   ...
   @Nullable
   public static fzn a(flh $$0, BooleanConsumer $$1, DataFixer $$2, evd.c $$3, boolean $$4) {
      try {
         fzu $$5 = $$0.x();
         atz $$6 = auc.a($$3);
   ...
   private fzn(BooleanConsumer $$0, DataFixer $$1, evd.c $$2, dgk $$3, boolean $$4, kf $$5) {
      super(wo.a("optimizeWorld.title", $$3.a()));
      this.c = $$0;
      this.d = new brw($$2, $$1, $$5, $$4, false);
   }
   ...
   public void a(fob $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.d.e() > 0) {
         ...
         for (akt<dgg> $$9 : this.d.c()) {
            int $$10 = ayy.d(this.d.a($$9) * (float)($$5 - $$4));
         ...
         wo $$13 = wo.a("optimizeWorld.progress.percentage", ayy.d(this.d.d() * 100.0F));
