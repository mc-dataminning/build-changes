...
public final class fzn {
   ...
   private static final fzn c = new fzn(HostAndPort.fromParts("server.invalid", 25565));

   public fzn(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private fzn(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static fzn a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new fzn($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof fzn ? this.b.equals(((fzn)$$0).b) : false;
      }
   }
