...
public class fdv {
   ...
   public static List<fdv.a> a(String $$0, fdv.b... $$1) {
      return a($$0, Arrays.asList($$1));
   }

   private static List<fdv.a> a(String $$0, List<fdv.b> $$1) {
      List<String> $$2 = a($$0);
      return a($$2, $$1);
   }

   private static List<fdv.a> a(List<String> $$0, List<fdv.b> $$1) {
      int $$2 = 0;
      List<fdv.a> $$3 = Lists.newArrayList();

      for (String $$4 : $$0) {
         List<fdv.b> $$5 = Lists.newArrayList();
   ...
   public static class b {
      ...
      public static fdv.b a(String $$0, String $$1) {
         return new fdv.b(null, $$0, $$1);
      }

      @VisibleForTesting
      protected static fdv.b a(String $$0) {
         return new fdv.b($$0);
      }
   }
}
