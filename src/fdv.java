...
public class fdv {
   ...
   public void a(ffd $$0, String $$1, fga.a $$2, esz $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fdv.b $$13 = new fdv.b($$1.trim(), this.f, $$3, $$2);
                  fdv.a $$14 = new fdv.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fdv.c $$30 = new fdv.c(this.f, $$2, $$0);
                        fdv.a $$31 = new fdv.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new ffh(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, esz $$2) throws IOException {
      ...
      File $$15 = new File(fip.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final esz d;
      private final fga.a e;

      b(final String $$0, final File $$1, final esz $$2, final fga.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fdv.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fdv.this.b && !fdv.this.d) {
            try {
               fdv.this.e = true;
               fdv.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fdv.a.error("Error extracting archive", var3);
               fdv.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fga.a c;
      private final ffd d;

      c(final File $$0, final fga.a $$1, final ffd $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fdv.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fdv.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fdv.this.g);
                  fdv.this.c = true;
               } else {
                  fdv.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fdv.this.d = true;
               }
            } catch (IOException var3) {
               fdv.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fdv.this.d = true;
            }
         }
      }
