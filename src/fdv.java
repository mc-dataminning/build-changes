...
public class fdv extends ffe {
   ...
   protected void aQ_() {
      ...
      this.b = new ezq(this.f.i, 4, this.h - 12, this.g - 4, 12, vq.c("chat.editBox")) {
         @Override
         protected we aN_() {
            return super.aN_().b(fdv.this.o.e());
         }
      };
      this.b.f(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.e(this.b);
      this.o = new ezk(this.f, this, this.b, this.i, false, false, 1, 10, true, -805306368);
      this.o.b(false);
      this.o.d();
   }
   ...
   public void a(eyu $$0, int $$1, int $$2, float $$3) {
      ...
      this.o.a($$0, $$1, $$2);
      $$0.c().b();
      exc $$4 = this.f.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(fdc $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(fdb.a, vq.a("chat_screen.message", $$1));
      }
   }
