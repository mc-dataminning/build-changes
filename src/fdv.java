...
public class fdv {
   private static final Map<String, fdv.a> a = Maps.newHashMap();
   ...
   private static alf b(String $$0, String $$1) {
      ...
      if ($$2 != null && $$2.a().equals($$1)) {
         ...
         if ($$3 == null) {
            alf $$4 = goq.b();
            a.put($$0, new fdv.a($$1, $$4));
            return $$4;
         } else {
            alf $$5 = new alf("realms", "dynamic/" + $$0);
            ffg.Q().aa().a($$5, new gon($$3));
            a.put($$0, new fdv.a($$1, $$5));
            return $$5;
         }
      }
   }
   ...
   @Nullable
   private static eza a(String $$0) {
      byte[] $$1 = Base64.getDecoder().decode($$0);
      ByteBuffer $$2 = MemoryUtil.memAlloc($$1.length);

      try {
         return eza.a($$2.put($$1).flip());
