...
public class gkr extends awa<Optional<gkr.b>> implements AutoCloseable {
   ...
   private gkr.a o = gkr.a.b;
   @Nullable
   private flq p;
   @Nullable
   private gkr.b q;
   private final fgt r = new fgt(fek.b);
   private boolean s;

   protected Optional<gkr.b> a(avv $$0, bps $$1) {
      try {
         Optional var20;
         try (
            ...
            var20 = Optional.of(new gkr.b($$6, $$4, $$5));
         }
   ...
   protected void a(Optional<gkr.b> $$0, avv $$1, bps $$2) {
   ...
   public void a(int $$0, flq $$1, float $$2, Matrix4f $$3, Matrix4f $$4, fbx $$5, float $$6) {
      if (this.q != null) {
         ...
         if (this.l || $$16 != this.m || $$17 != this.n || $$9 != this.o || $$1 != this.p) {
            ...
            this.o = $$9;
            this.p = $$1;
            fgp $$21 = this.a(fgs.b(), $$16, $$17, $$1, $$9, $$20);
            if ($$21 != null) {
               this.r.a($$21);
               this.s = false;
            } else {
   ...
   private void a(glt $$0, Matrix4f $$1, Matrix4f $$2, float $$3, float $$4, float $$5) {
      $$0.a();
      gks $$6 = RenderSystem.getShader();
      if ($$6 != null && $$6.o != null) {
         $$6.o.a(-$$3, $$4, -$$5);
      }
   ...
   @Nullable
   private fgp a(fgs $$0, int $$1, int $$2, flq $$3, gkr.a $$4, glt $$5) {
      float $$6 = 0.8F;
      ...
      fgl $$11 = $$0.a($$5.P(), $$5.O());
      this.a($$4, $$11, $$1, $$2, $$9, $$7, $$8, $$10, $$3 == flq.c);
      return $$11.a();
   }

   private void a(gkr.a $$0, fgl $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8) {
      if (this.q != null) {
         int $$9 = 32;
         long[] $$10 = this.q.a;
         int $$11 = this.q.b;
   ...
   private void a(fgl $$0, int $$1, int $$2, int $$3) {
   ...
   private void a(gkr.a $$0, fgl $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, long $$8) {
