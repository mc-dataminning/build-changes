...
public class fob extends fns<cpl> {
   ...
   protected void a(fgz $$0, float $$1, int $$2, int $$3) {
      ...
      cua $$6 = this.w.b(1).g();
      boolean $$7 = $$6.a(cud.uj);
      boolean $$8 = $$6.a(cud.qO);
      boolean $$9 = $$6.a(cud.fT);
      cua $$10 = this.w.b(0).g();
      epo $$11 = $$10.a(kn.B);
      boolean $$12 = false;
      epq $$13;
      if ($$11 != null) {
         $$13 = cui.a($$11, this.l.r);
         if ($$13 != null) {
            if ($$13.h) {
               $$12 = true;
               if ($$8 || $$9) {
   ...
   private void a(fgz $$0, @Nullable epo $$1, @Nullable epq $$2, boolean $$3, boolean $$4, boolean $$5, boolean $$6) {
      int $$7 = this.z;
      int $$8 = this.A;
      if ($$4 && !$$6) {
   ...
   private void a(fgz $$0, @Nullable epo $$1, @Nullable epq $$2, int $$3, int $$4, float $$5) {
      if ($$1 != null && $$2 != null) {
         $$0.c().a();
