public abstract class fob<T extends cpu> extends foa<T> implements fqv {
   public final fql D;
   private boolean E;
   private final ale F;
   private final ale G;
   ...
   public fob(T $$0, fql $$1, cmv $$2, xo $$3, ale $$4, ale $$5, ale $$6) {
      super($$0, $$2, $$3);
      this.D = $$1;
      this.F = $$4;
      this.G = $$5;
   ...
   public void aM_() {
      ...
      this.c(new fhp(this.z + 20, this.o / 2 - 49, 20, 18, fqp.a, $$0 -> {
         this.D.e();
         this.z = this.D.a(this.n, this.c);
   ...
   protected void a(fgq $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.w.s()) {
         int $$6 = 14;
         int $$7 = ayy.f(this.w.r() * 13.0F) + 1;
         $$0.a(this.G, 14, 14, 0, 14 - $$7, $$4 + 56, $$5 + 36 + 14 - $$7, 14, $$7);
      }

      int $$8 = 24;
      int $$9 = ayy.f(this.w.q() * 24.0F);
