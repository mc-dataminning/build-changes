...
public abstract class fob<T extends cpu> extends fnd implements fph<T> {
   public static final alf a = new alf("textures/gui/container/inventory.png");
   ...
   private cup P = cup.l;
   private long Q;
   protected final Set<crp> B = Sets.newHashSet();
   protected boolean C;
   private int R;
   private int S;
   private boolean T;
   ...
   public void a(fgr $$0, int $$1, int $$2, float $$3) {
      ...
      this.b($$0, $$1, $$2);
      cup $$10 = this.L.e() ? this.w.g() : this.L;
      if (!$$10.e()) {
         int $$11 = 8;
         int $$12 = this.L.e() ? 8 : 16;
         String $$13 = null;
         if (!this.L.e() && this.K) {
            $$10 = $$10.c(ayz.f((float)$$10.I() / 2.0F));
   ...
   public static void a(fgr $$0, int $$1, int $$2, int $$3) {
      $$0.a(gdw.E(), $$1, $$2, $$1 + 16, $$2 + 16, -2130706433, -2130706433, $$3);
   }
   ...
   protected List<xp> a(cup $$0) {
      return a(this.m, $$0);
   }

   private void a(fgr $$0, cup $$1, int $$2, int $$3, String $$4) {
      $$0.c().a();
   ...
   protected abstract void a(fgr var1, float var2, int var3, int var4);

   protected void a(fgr $$0, crp $$1) {
      int $$2 = $$1.e;
      int $$3 = $$1.f;
      cup $$4 = $$1.g();
      boolean $$5 = false;
      ...
      if ($$1 == this.G && !this.L.e() && this.K && !$$4.e()) {
         ...
         if (cpu.a($$1, $$7, true) && this.w.b($$1)) {
            $$5 = true;
            int $$9 = Math.min($$7.j(), $$1.a_($$7));
            int $$10 = $$1.g().e() ? 0 : $$1.g().I();
            int $$11 = cpu.a(this.B, this.R, $$7) + $$10;
            if ($$11 > $$9) {
               $$11 = $$9;
               $$8 = n.o.toString() + $$9;
            }
      ...
      if ($$4.e() && $$1.d()) {
         Pair<alf, alf> $$12 = $$1.c();
         if ($$12 != null) {
            goz $$13 = this.m.a((alf)$$12.getFirst()).apply((alf)$$12.getSecond());
            $$0.a($$2, $$3, 0, 16, 16, $$13);
            $$6 = true;
         }
      }
      ...
      if (!$$0.e() && this.C) {
         if (this.R == 2) {
            ...
            for (crp $$1 : this.B) {
               ...
               int $$5 = Math.min(cpu.a(this.B, this.R, $$0) + $$3, $$4);
               this.U -= $$5 - $$3;
            }
         }
      }
   ...
   @Nullable
   private crp b(double $$0, double $$1) {
      for (int $$2 = 0; $$2 < this.w.i.size(); $$2++) {
         crp $$3 = this.w.i.get($$2);
         if (this.a($$3, $$0, $$1) && $$3.d()) {
            return $$3;
         }
      }
               ...
               if (this.m.m.Z().c()) {
                  ...
                  if (this.w.g().e()) {
                     if ($$3) {
                        ...
                        boolean $$10 = $$9 != -999 && (eyt.a(fff.Q().aO().i(), 340) || eyt.a(fff.Q().aO().i(), 344));
                        cqd $$11 = cqd.a;
                        if ($$10) {
                           this.Y = $$4 != null && $$4.h() ? $$4.g().s() : cup.l;
                           $$11 = cqd.b;
                        } else if ($$9 == -999) {
                           $$11 = cqd.e;
                        }
   ...
   private void a(int $$0) {
      if (this.y != null && this.w.g().e()) {
         if (this.m.m.E.a($$0)) {
            this.a(this.y, this.y.d, 40, cqd.c);
            return;
         }

         for (int $$1 = 0; $$1 < 9; $$1++) {
            if (this.m.m.T[$$1].a($$0)) {
               this.a(this.y, this.y.d, $$1, cqd.c);
            }
         }
      }
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      ...
      if (this.G != null && this.m.m.Z().c()) {
         if ($$2 == 0 || $$2 == 1) {
            ...
            } else if (this.L.I() > 1 && $$5 != null && cpu.a($$5, this.L, false)) {
               long $$7 = ac.c();
               if (this.I == $$5) {
                  if ($$7 - this.Q > 500L) {
                     this.a(this.G, this.G.d, 0, cqd.a);
                     this.a($$5, $$5.d, 1, cqd.a);
                     this.a(this.G, this.G.d, 0, cqd.a);
                     this.Q = $$7 + 750L;
                     this.L.h(1);
                  }
      ...
      } else if (this.C && $$5 != null && !$$6.e() && ($$6.I() > this.B.size() || this.R == 2) && cpu.a($$5, $$6, true) && $$5.a($$6) && this.w.b($$5)) {
         this.B.add($$5);
         this.K();
      }
   ...
   public boolean b(double $$0, double $$1, int $$2) {
      ...
      if (this.X && $$3 != null && $$2 == 0 && this.w.a(cup.l, $$3)) {
         if (t()) {
            if (!this.Y.e()) {
               for (crp $$8 : this.w.i) {
                  if ($$8 != null && $$8.a(this.m.s) && $$8.h() && $$8.c == $$3.c && cpu.a($$8, this.Y, true)) {
                     this.a($$8, $$8.d, $$2, cqd.b);
                  }
               }
            }
         } else {
         ...
         if (this.G != null && this.m.m.Z().c()) {
            if ($$2 == 0 || $$2 == 1) {
               ...
               boolean $$9 = cpu.a($$3, this.L, false);
               if ($$7 != -1 && !this.L.e() && $$9) {
                  this.a(this.G, this.G.d, $$2, cqd.a);
                  this.a($$3, $$7, 0, cqd.a);
                  if (this.w.g().e()) {
                     this.P = cup.l;
                  } else {
                     this.a(this.G, this.G.d, $$2, cqd.a);
                     this.M = ayz.a($$0 - (double)$$4);
                     this.N = ayz.a($$1 - (double)$$5);
                     this.H = this.G;
                     this.P = this.L;
                     this.O = ac.c();
                  }
            ...
            this.a(null, -999, cpu.b(0, this.R), cqd.f);

            for (crp $$10 : this.B) {
               this.a($$10, $$10.d, cpu.b(1, this.R), cqd.f);
            }

            this.a(null, -999, cpu.b(2, this.R), cqd.f);
         } else if (!this.w.g().e()) {
            if (this.m.m.I.a($$2)) {
               this.a($$3, $$7, $$2, cqd.d);
            } else {
               boolean $$11 = $$7 != -999 && (eyt.a(fff.Q().aO().i(), 340) || eyt.a(fff.Q().aO().i(), 344));
               if ($$11) {
                  this.Y = $$3 != null && $$3.h() ? $$3.g().s() : cup.l;
               }

               this.a($$3, $$7, $$2, $$11 ? cqd.b : cqd.a);
            }
         }
      }
   ...
   private boolean a(crp $$0, double $$1, double $$2) {
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if (this.y != null && this.y.h()) {
            if (this.m.m.I.a($$0, $$1)) {
               this.a(this.y, this.y.d, 0, cqd.d);
            } else if (this.m.m.F.a($$0, $$1)) {
               this.a(this.y, this.y.d, s() ? 1 : 0, cqd.e);
            }
         }
      ...
      if (this.w.g().e() && this.y != null) {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            if (this.m.m.T[$$2].a($$0, $$1)) {
               this.a(this.y, this.y.d, $$2, cqd.c);
               return true;
            }
         }
      }
