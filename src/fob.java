public class fob extends fpa<cpj> {
   ...
   protected void G() {
      ...
      this.I = new fib(this.o, $$0 + 62, $$1 + 24, 103, 12, wu.c("container.repair"));
      this.I.f(false);
      this.I.g(-1);
      this.I.h(-1);
      this.I.d(false);
   ...
   @Override
   public void d(fhf $$0, int $$1, int $$2, float $$3) {
      this.I.a($$0, $$1, $$2, $$3);
   }
