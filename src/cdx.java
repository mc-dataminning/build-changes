...
public class cdx extends bpq implements cfq {
   private static final Logger cc = LogUtils.getLogger();
   public static final aim<Integer> b = aiq.a(cdx.class, aio.b);
   private static final cae cd = cae.a().a(64.0);
   ...
   public int d = -1;
   private final cdv[] cj;
   public final cdv e;
   private final cdv ck;
   private final cdv cl;
   private final cdv cm;
   private final cdv cn;
   private final cdv co;
   private final cdv cp;
   private final cdv cq;
   public float bW;
   public float bX;
   public boolean bY;
   public int bZ;
   ...
   private dqp cr;
   private ib cs = ib.c;
   private final ceo ct;
   private int cu = 100;
   private float cv;
   private final eja[] cw = new eja[24];
   private final int[] cx = new int[24];
   private final eix cz = new eix();

   public cdx(bpc<? extends cdx> $$0, cwz $$1) {
      super(bpc.F, $$1);
      this.e = new cdv(this, "head", 1.0F, 1.0F);
      this.ck = new cdv(this, "neck", 3.0F, 3.0F);
      this.cl = new cdv(this, "body", 5.0F, 3.0F);
      this.cm = new cdv(this, "tail", 2.0F, 2.0F);
      this.cn = new cdv(this, "tail", 2.0F, 2.0F);
      this.co = new cdv(this, "tail", 2.0F, 2.0F);
      this.cp = new cdv(this, "wing", 4.0F, 2.0F);
      this.cq = new cdv(this, "wing", 4.0F, 2.0F);
      this.cj = new cdv[]{this.e, this.ck, this.cl, this.cm, this.cn, this.co, this.cp, this.cq};
      this.t(this.eO());
      this.af = true;
      this.at = true;
      this.ct = new ceo(this);
   }
   ...
   public void aS() {
      if (this.dM().B && !this.aU()) {
         this.dM().a(this.dr(), this.dt(), this.dx(), aty.hS, this.db(), 5.0F, 0.8F + this.ag.i() * 0.3F, false);
      }
   }
   ...
   public void m_() {
      ...
      if (this.dM().B) {
         ...
         if (!this.aU() && !this.ct.a().a() && --this.cu < 0) {
            this.dM().a(this.dr(), this.dt(), this.dx(), aty.hT, this.db(), 2.5F, 0.8F + this.ag.i() * 0.3F, false);
         ...
         if (this.gd()) {
            ...
            if (this.dM().B) {
               ...
               if ($$9 != null) {
                  ...
                  this.r(aww.g(this.dC()));
                  epr $$16 = $$9.a(this.dr(), this.dt(), this.dx()).d();
                  epr $$17 = new epr((double)aww.a(this.dC() * (float) (Math.PI / 180.0)), this.dp().d, (double)(-aww.b(this.dC() * (float) (Math.PI / 180.0))))
                     .d();
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new epr(0.0, 0.0, -1.0));
                  if (this.bY) {
                     this.a(bpt.a, this.dp().a(0.8F));
                  } else {
            ...
            this.aX = this.dC();
            epr[] $$24 = new epr[this.cj.length];

            for (int $$25 = 0; $$25 < this.cj.length; $$25++) {
               $$24[$$25] = new epr(this.cj[$$25].dr(), this.cj[$$25].dt(), this.cj[$$25].dx());
            }
            ...
            if (!this.dM().B && this.aN == 0) {
               this.b(this.dM().a(this, this.cp.cH().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bpb.e));
               this.b(this.dM().a(this, this.cq.cH().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bpb.e));
               this.c(this.dM().a(this, this.e.cH().g(1.0), bpb.e));
               this.c(this.dM().a(this, this.ck.cH().g(1.0), bpb.e));
            }
   ...
   private void a(cdv $$0, double $$1, double $$2, double $$3) {
   ...
   private void gn() {
      ...
      if (this.ag.a(10) == 0) {
         List<cdw> $$0 = this.dM().a(cdw.class, this.cH().g(32.0));
         cdw $$1 = null;
   ...
   private void b(List<bow> $$0) {
      ...
      for (bow $$3 : $$0) {
         if ($$3 instanceof bpo) {
            ...
            if (!this.ct.a().a() && ((bpo)$$3).ek() < $$3.ah - 2) {
               $$3.a(this.dN().b((bpo)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bow> $$0) {
      for (bow $$1 : $$0) {
         if ($$1 instanceof bpo) {
            $$1.a(this.dN().b((bpo)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dmz $$13 = this.dM().a_($$12);
               if (!$$13.i() && !$$13.a(aun.aD)) {
                  if (this.dM().Z().b(cwv.c) && !$$13.a(aun.aC)) {
   ...
   public boolean a(cdv $$0, bnv $$1, float $$2) {
      if (this.ct.a().i() == cen.j) {
         return false;
      } else {
         $$2 = this.ct.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof cis || $$1.a(aup.z)) {
               float $$3 = this.ex();
               this.g($$1, $$2);
   ...
   protected boolean g(bnv $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void ed() {
      ...
      if (this.dM() instanceof apf) {
         if (this.bZ > 150 && this.bZ % 5 == 0 && $$3) {
            bpe.a((apf)this.dM(), this.dk(), aww.d((float)$$4 * 0.08F));
         }
      ...
      this.a(bpt.a, new epr(0.0, 0.1F, 0.0));
      if (this.bZ == 200 && this.dM() instanceof apf) {
         if ($$3) {
            bpe.a((apf)this.dM(), this.dk(), aww.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cw[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$9 = Math.max(this.dM().z_() + 10, this.dM().a(dsm.a.f, new ib($$3, 0, $$4)).v() + $$1);
            this.cw[$$0] = new eja($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eja $$5 = new eja(aww.a($$0), aww.a($$1), aww.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public ejc a(int $$0, int $$1, @Nullable eja $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eja $$4 = this.cw[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private ejc a(eja $$0, eja $$1) {
      ...
      return new ejc($$2, new ib($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(ta $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.ct.a(cen.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      ceh $$3 = this.ct.a();
      cen<? extends ceh> $$4 = $$3.i();
      double $$7;
      if ($$4 == cen.d || $$4 == cen.e) {
         ib $$5 = this.dM().a(dsm.a.f, dvp.a(this.cs));
   ...
   public epr F(float $$0) {
      ceh $$1 = this.ct.a();
      cen<? extends ceh> $$2 = $$1.i();
      epr $$8;
      if ($$2 == cen.d || $$2 == cen.e) {
         ib $$3 = this.dM().a(dsm.a.f, dvp.a(this.cs));
   ...
   public void a(cdw $$0, ib $$1, bnv $$2) {
      cis $$3;
      if ($$2.d() instanceof cis) {
         $$3 = (cis)$$2.d();
      } else {
