...
public class cdx extends cdl {
   ...
   public void a(bho $$0) {
      double $$1 = this.do().i();
      if (!$$0.a(apu.i) && !$$0.a(apu.l) && !($$1 >= 0.01F)) {
         super.a($$0);
      } else {
         if (this.d < 0) {
            this.G();
   ...
   public void G() {
      ...
      if (!this.dL().B) {
         ...
         if (!this.aS()) {
            this.dL().a(null, this.dq(), this.ds(), this.dw(), apd.xL, ape.e, 1.0F, 1.0F);
         }
      }
   }
   ...
   public float a(cpn $$0, cpb $$1, gw $$2, dfj $$3, eam $$4, float $$5) {
      return !this.I() || !$$3.a(aps.N) && !$$1.a_($$2.c()).a(aps.N) ? super.a($$0, $$1, $$2, $$3, $$4, $$5) : 0.0F;
   }

   @Override
   public boolean a(cpn $$0, cpb $$1, gw $$2, dfj $$3, float $$4) {
      return !this.I() || !$$3.a(aps.N) && !$$1.a_($$2.c()).a(aps.N) ? super.a($$0, $$1, $$2, $$3, $$4) : false;
   }
