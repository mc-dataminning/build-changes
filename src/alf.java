...
public class alf implements Comparable<alf> {
   public static final Codec<alf> a = Codec.STRING.comapFlatMap(alf::b, alf::toString).stable();
   public static final zn<ByteBuf, alf> b = zl.l.a(alf::new, alf::toString);
   public static final SimpleCommandExceptionType c = new SimpleCommandExceptionType(xp.c("argument.id.invalid"));
   ...
   protected alf(String $$0, String $$1, @Nullable alf.a $$2) {
      this.g = $$0;
      this.h = $$1;
   }

   public alf(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private alf(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static alf a(String $$0, char $$1) {
      return new alf(b($$0, $$1));
   }
   ...
   @Nullable
   public static alf a(String $$0, String $$1) {
      try {
         return new alf($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<alf> b(String $$0) {
      try {
         return DataResult.success(new alf($$0));
      } catch (z var2) {
   ...
   public alf c(String $$0) {
      return new alf(this.g, d(this.g, $$0), null);
   }

   public alf a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.h));
   }

   public alf d(String $$0) {
      return this.c($$0 + this.h);
   }

   public alf e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof alf $$1) ? false : this.g.equals($$1.g) && this.h.equals($$1.h);
      }
   }
   ...
   public static alf a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
      String $$2 = c($$0);
   ...
   public static alf b(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
      String $$2 = c($$0);
      if ($$2.isEmpty()) {
         throw c.createWithContext($$0);
   ...
   public static class b implements JsonDeserializer<alf>, JsonSerializer<alf> {
      public alf a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new alf(ayp.a($$0, "location"));
      }

      public JsonElement a(alf $$0, Type $$1, JsonSerializationContext $$2) {
