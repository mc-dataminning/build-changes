...
public class djq implements Predicate<djh> {
   public static final Predicate<djh> a = $$0 -> true;
   private final dji<cwq, djh> b;
   private final Map<dkk<?>, Predicate<Object>> c = Maps.newHashMap();

   private djq(dji<cwq, djh> $$0) {
      this.b = $$0;
   }

   public static djq a(cwq $$0) {
      return new djq($$0.n());
   }
   ...
   public boolean a(@Nullable djh $$0) {
      if ($$0 != null && $$0.b().equals(this.b.c())) {
         if (this.c.isEmpty()) {
            ...
            for (Entry<dkk<?>, Predicate<Object>> $$1 : this.c.entrySet()) {
   ...
   protected <T extends Comparable<T>> boolean a(djh $$0, dkk<T> $$1, Predicate<Object> $$2) {
      T $$3 = $$0.c($$1);
      return $$2.test($$3);
   }

   public <V extends Comparable<V>> djq a(dkk<V> $$0, Predicate<Object> $$1) {
