...
public class dcr extends cwq {
   public static final MapCodec<dcr> a = b(dcr::new);
   public static final dkf<dkm> b = djx.ab;
   public static final dkf<dkm> c = djx.aa;
   public static final dkf<dkm> d = djx.ac;
   public static final dkf<dkm> e = djx.ad;
   public static final dkh f = djx.aT;
   public static final Map<ic, dkf<dkm>> g = Maps.newEnumMap(ImmutableMap.of(ic.c, b, ic.f, c, ic.d, d, ic.e, e));
   protected static final int h = 1;
   protected static final int i = 3;
   protected static final int j = 13;
   protected static final int k = 3;
   protected static final int l = 13;
   private static final emm m = cwq.a(3.0, 0.0, 3.0, 13.0, 1.0, 13.0);
   private static final Map<ic, emm> n = Maps.newEnumMap(
      ImmutableMap.of(
         ic.c,
         cwq.a(3.0, 0.0, 0.0, 13.0, 1.0, 13.0),
         ic.d,
         cwq.a(3.0, 0.0, 3.0, 13.0, 1.0, 16.0),
         ic.f,
         cwq.a(3.0, 0.0, 3.0, 16.0, 1.0, 13.0),
         ic.e,
         cwq.a(0.0, 0.0, 3.0, 13.0, 1.0, 13.0)
      )
   );
   private static final Map<ic, emm> o = Maps.newEnumMap(
      ImmutableMap.of(
         ic.c,
         emj.a(n.get(ic.c), cwq.a(3.0, 0.0, 0.0, 13.0, 16.0, 1.0)),
         ic.d,
         emj.a(n.get(ic.d), cwq.a(3.0, 0.0, 15.0, 13.0, 16.0, 16.0)),
         ic.f,
         emj.a(n.get(ic.f), cwq.a(15.0, 0.0, 3.0, 16.0, 16.0, 13.0)),
         ic.e,
         emj.a(n.get(ic.e), cwq.a(0.0, 0.0, 3.0, 1.0, 16.0, 13.0))
      )
   );
   private static final Map<djh, emm> F = Maps.newHashMap();
   private static final elt[] G = ac.a(new elt[16], $$0 -> {
      for (int $$1 = 0; $$1 <= 15; $$1++) {
         float $$2 = (float)$$1 / 15.0F;
         float $$3 = $$2 * 0.6F + ($$2 > 0.0F ? 0.4F : 0.3F);
         float $$4 = auo.a($$2 * $$2 * 0.7F - 0.5F, 0.0F, 1.0F);
         float $$5 = auo.a($$2 * $$2 * 0.6F - 0.7F, 0.0F, 1.0F);
         $$0[$$1] = new elt((double)$$3, (double)$$4, (double)$$5);
      }
   });
   ...
   public dcr(djg.d $$0) {
      super($$0);
      this.k(this.E.b().a(b, dkm.c).a(c, dkm.c).a(d, dkm.c).a(e, dkm.c).a(f, Integer.valueOf(0)));
      this.I = this.o().a(b, dkm.b).a(c, dkm.b).a(d, dkm.b).a(e, dkm.b);
   ...
   private djh a(csv $$0, djh $$1, hx $$2) {
      boolean $$3 = p($$1);
   ...
   private djh b(csv $$0, djh $$1, hx $$2) {
      boolean $$3 = !$$0.a_($$2.c()).g($$0, $$2);

      for (ic $$4 : ic.c.a) {
         if (!$$1.c(g.get($$4)).a()) {
            dkm $$5 = this.a($$0, $$2, $$4, $$3);
            $$1 = $$1.a(g.get($$4), $$5);
         }
      }
   ...
   public void a(djh $$0, ctq $$1, hx $$2, int $$3, int $$4) {
      ...
      for (ic $$6 : ic.c.a) {
         dkm $$7 = $$0.c(g.get($$6));
         if ($$7 != dkm.c && !$$1.a_($$5.a($$2, $$6)).a(this)) {
            $$5.c(ic.a);
            djh $$8 = $$1.a_($$5);
            if ($$8.a(this)) {
               hx $$9 = $$5.a($$6.g());
   ...
   private dkm a(csv $$0, hx $$1, ic $$2) {
      return this.a($$0, $$1, $$2, !$$0.a_($$1.c()).g($$0, $$1));
   }

   private dkm a(csv $$0, hx $$1, ic $$2, boolean $$3) {
      hx $$4 = $$1.a($$2);
      djh $$5 = $$0.a_($$4);
      if ($$3) {
         boolean $$6 = $$5.b() instanceof dfc || this.a($$0, $$4, $$5);
         if ($$6 && h($$0.a_($$4.c()))) {
            if ($$5.d($$0, $$4, $$2.g())) {
               return dkm.a;
            }
      ...
      return !a($$5, $$2) && ($$5.g($$0, $$4) || !h($$0.a_($$4.d()))) ? dkm.c : dkm.b;
   }
   ...
   private boolean a(csv $$0, hx $$1, djh $$2) {
      return $$2.d($$0, $$1, ic.b) || $$2.a(cws.hc);
   }
   ...
   protected static boolean h(djh $$0) {
      return a($$0, null);
   }

   protected static boolean a(djh $$0, @Nullable ic $$1) {
      if ($$0.a(cws.cw)) {
         return true;
      } else if ($$0.a(cws.eh)) {
         ic $$2 = $$0.c(dcw.aE);
         ...
         return $$0.a(cws.kO) ? $$1 == $$0.c(dca.a) : $$0.m() && $$1 != null;
      }
   }
   ...
   public static int b(int $$0) {
      elt $$1 = G[$$0];
      return auo.f((float)$$1.a(), (float)$$1.b(), (float)$$1.c());
   }

   private void a(ctp $$0, auv $$1, hx $$2, elt $$3, ic $$4, ic $$5, float $$6, float $$7) {
      float $$8 = $$7 - $$6;
      if (!($$1.i() >= 0.2F * $$8)) {
         float $$9 = 0.4375F;
         float $$10 = $$6 + $$8 * $$1.i();
   ...
   private void a(ctp $$0, hx $$1, djh $$2, djh $$3) {
      for (ic $$4 : ic.c.a) {
         hx $$5 = $$1.a($$4);
