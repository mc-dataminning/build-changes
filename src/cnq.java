...
public class cnq extends cnn {
   ...
   public cnq(bsy<? extends cnq> $$0, dbw $$1) {
      super($$0, $$1);
      this.ag = true;
   }

   public cnq(dbw $$0, btn $$1, bss $$2, je.a $$3) {
      this(bsy.aL, $$0);
      this.c($$1);
      evp $$4 = $$1.cK().f();
   ...
   private void a(@Nullable je $$0) {
      this.d = $$0;
   }

   private void a(@Nullable je.a $$0) {
      double $$1 = 0.5;
      iz $$2;
      if (this.c == null) {
         $$2 = this.dp().d();
         ...
         $$2 = iz.a(this.c.du(), this.c.dw() + $$1, this.c.dA());
      }
   ...
   public void l() {
      ...
      if (!this.dP().B) {
         if (this.c == null && this.i != null) {
            this.c = ((are)this.dP()).a(this.i);
            if (this.c == null) {
               this.i = null;
            }
         }

         if (this.c == null || !this.c.bD() || this.c instanceof cmv && this.c.N_()) {
            this.ba();
         } else {
            this.f = ayx.a(this.f * 1.025, -1.0, 1.0);
            this.g = ayx.a(this.g * 1.025, -1.0, 1.0);
            this.h = ayx.a(this.h * 1.025, -1.0, 1.0);
            evp $$0 = this.ds();
      ...
      cnp.a(this, 0.5F);
      if (this.dP().B) {
         this.dP().a(li.t, this.du() - $$2.c, this.dw() - $$2.d + 0.15, this.dA() - $$2.e, 0.0, 0.0, 0.0);
         ...
         if (this.d != null) {
            ...
            if (this.dP().a($$3.a(this.d), this)) {
               ...
               iz $$5 = this.c.dp();
               if ($$4 == je.a.a && $$3.u() == $$5.u() || $$4 == je.a.c && $$3.w() == $$5.w() || $$4 == je.a.b && $$3.v() == $$5.v()) {
                  this.a($$4);
               }
            }
         }
   ...
   protected void a(evm $$0) {
      ...
      if ($$4) {
         this.a($$3, $$1);
         if ($$1 instanceof btn $$5) {
            $$5.b(new bsa(bsc.y, 200), (bss)MoreObjects.firstNonNull($$2, this));
         }
      }
   }
   ...
   protected void a(evl $$0) {
      super.a($$0);
      ((are)this.dP()).a(li.w, this.du(), this.dw(), this.dA(), 2, 0.2, 0.2, 0.2, 0.0);
      this.a(avz.wL, 1.0F, 1.0F);
   }

   private void u() {
      this.ao();
      this.dP().a(dwt.o, this.dn(), dwt.a.a(this));
   }
   ...
   public boolean a(brl $$0, float $$1) {
      if (!this.dP().B) {
         this.a(avz.wM, 1.0F, 1.0F);
         ((are)this.dP()).a(li.f, this.du(), this.dw(), this.dA(), 15, 0.2, 0.2, 0.2, 0.0);
         this.u();
      }
