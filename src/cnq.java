...
public class cnq {
   ...
   public static qw a(@Nullable aew $$0, int $$1) {
      qw $$2 = new qw();
   ...
   public static int a(qw $$0) {
      return arw.a($$0.h("lvl"), 0, 255);
   }

   @Nullable
   public static aew b(qw $$0) {
      return aew.a($$0.l("id"));
   }

   @Nullable
   public static aew a(cno $$0) {
      return jb.g.b($$0);
   }
   ...
   public static Map<cno, Integer> a(cjf $$0) {
      rc $$1 = $$0.a(cji.tC) ? cib.d($$0) : $$0.x();
      return a($$1);
   }

   public static Map<cno, Integer> a(rc $$0) {
   ...
   public static List<cnr> b(asc $$0, cjf $$1, int $$2, boolean $$3) {
      ...
      if ($$6 <= 0) {
         ...
         $$2 = arw.a(Math.round((float)$$2 + (float)$$2 * $$7), 1, Integer.MAX_VALUE);
         List<cnr> $$8 = a($$2, $$1, $$3);
         if (!$$8.isEmpty()) {
