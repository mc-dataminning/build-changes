...
public abstract class cnq extends bsv implements bup {
   @Nullable
   private UUID b;
   @Nullable
   private bsv c;
   ...
   public bsv I() {
      return (bsv)MoreObjects.firstNonNull(this.s(), this);
   }
   ...
   private boolean u() {
      bsv $$0 = this.s();
      if ($$0 != null) {
         for (bsv $$1 : this.dP().a(this, this.cK().b(this.ds()).g(1.0), $$0x -> !$$0x.N_() && $$0x.bz())) {
            if ($$1.cZ() == $$0.cZ()) {
               return false;
            }
         }
   ...
   public evs d(double $$0, double $$1, double $$2, float $$3, float $$4) {
   ...
   public void a(bsv $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
   ...
   public void a(cnr $$0, @Nullable bsv $$1, @Nullable bsv $$2, boolean $$3) {
      if (!this.dP().B) {
   ...
   protected void a(evq $$0) {
      ...
      if ($$1 == evq.a.c) {
         evp $$2 = (evp)$$0;
         bsv $$3 = $$2.a();
         if ($$3.ak().a(awt.H) && $$3 instanceof cnq $$4) {
            $$4.a(cnr.c, this.s(), this.s(), true);
         }

         this.a($$2);
         this.dP().a(dww.J, $$0.e(), dww.a.a(this, null));
      } else if ($$1 == evq.a.b) {
         evo $$5 = (evo)$$0;
         this.a($$5);
         iz $$6 = $$5.a();
         this.dP().a(dww.J, $$6, dww.a.a(this, this.dP().a_($$6)));
      }
   }
   ...
   public boolean a(dbz $$0, iz $$1) {
      bsv $$2 = this.s();
      return $$2 instanceof cmy ? $$2.a($$0, $$1) : $$2 == null || $$0.ab().b(dbv.c);
   }

   public boolean b(dbz $$0) {
      return this.ak().a(awt.g) && $$0.ab().b(dbv.g);
   }
