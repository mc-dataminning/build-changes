...
public class ow {
   ...
   public ow(czp $$0, czp $$1, czp $$2, op $$3, cvg $$4) {
      this.d = $$3;
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   ...
   public static ow a(czp $$0, czp $$1, czp $$2, op $$3, cvg $$4) {
   ...
   public void a(oq $$0, alb $$1) {
      ...
      this.f.forEach($$2::a);
      dan $$3 = new dan(Optional.of(this.a), Optional.of(this.b), Optional.of(this.c), new cvl(this.e));
