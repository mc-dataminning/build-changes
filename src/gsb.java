...
public class gsb implements auq {
   private static final gmh e = gmh.o(akv.b("textures/misc/shadow.png"));
   private static final float f = 32.0F;
   private static final float g = 0.5F;
   private Map<bur<?>, gsc<?, ?>> h = ImmutableMap.of();
   private Map<hft.a, gsc<? extends cow, ?>> i = Map.of();
   public final het a;
   private dgh j;
   public fkq b;
   ...
   public gsb(fli $$0, het $$1, hbl $$2, gtb $$3, glw $$4, gnb $$5, fob $$6, flm $$7, Supplier<gey> $$8, hgw $$9) {
      this.a = $$1;
      this.l = $$2;
      this.m = $$4;
      this.o = new glr($$0, this, $$3, $$2);
      this.n = $$5;
      this.p = $$6;
      this.d = $$7;
      this.q = $$8;
   ...
   public <T extends buk> gsc<? super T, ?> a(T $$0) {
      if ($$0 instanceof gks $$1) {
         hft.a $$2 = $$1.d().e();
         gsc<? extends cow, ?> $$3 = this.i.get($$2);
         return (gsc<? super T, ?>)($$3 != null ? $$3 : this.i.get(hft.a.b));
      } else {
         return (gsc<? super T, ?>)this.h.get($$0.aq());
      }
   }

   public void a(dgh $$0, fkq $$1, buk $$2) {
      this.j = $$0;
      this.b = $$1;
      this.k = $$1.f();
      this.c = $$2;
   ...
   public <E extends buk> boolean a(E $$0, gpp $$1, double $$2, double $$3, double $$4) {
      gsc<? super E, ?> $$5 = this.a($$0);
      return $$5.a($$0, $$1, $$2, $$3, $$4);
   }

   public <E extends buk> void a(E $$0, double $$1, double $$2, double $$3, float $$4, fft $$5, glx $$6, int $$7) {
      gsc<? super E, ?> $$8 = this.a($$0);
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, $$8);
   }

   private <E extends buk, S extends gyj> void a(E $$0, double $$1, double $$2, double $$3, float $$4, fft $$5, glx $$6, int $$7, gsc<? super E, S> $$8) {
      try {
         S $$9 = $$8.b($$0, $$4);
         faz $$10 = $$8.a($$9);
         double $$11 = $$1 + $$10.a();
   ...
   private static void a(fft $$0, buk $$1, glx $$2) {
      buk $$3 = c($$1);
      if ($$3 == null) {
         gpy.a($$0, $$2, "Missing", $$1.dA(), $$1.cR().e + 1.5, $$1.dG(), -65536);
      } else {
         $$0.a();
         $$0.a($$3.dA() - $$1.dA(), $$3.dC() - $$1.dC(), $$3.dG() - $$1.dG());
         a($$0, $$2.getBuffer(gmh.y()), $$3, 1.0F, 0.0F, 1.0F, 0.0F);
         gmr.a($$0, $$2.getBuffer(gmh.y()), new Vector3f(), $$3.dy(), -256);
         $$0.b();
      }
   }
   ...
   private static void a(fft $$0, ffx $$1, buk $$2, float $$3, float $$4, float $$5, float $$6) {
      fau $$7 = $$2.cR().d(-$$2.dA(), -$$2.dC(), -$$2.dG());
      ...
      if ($$2 instanceof cju) {
         ...
         for (cjr $$11 : ((cju)$$2).x()) {
            ...
            $$0.a($$12, $$13, $$14);
            gmr.a($$0, $$1, $$11.cR().d(-$$11.dA(), -$$11.dC(), -$$11.dG()), 0.25F, 1.0F, 0.0F, 1.0F);
            $$0.b();
         }
      }
   ...
   private void a(fft $$0, glx $$1, gyj $$2, Quaternionf $$3) {
      her $$4 = hhb.a.c();
      her $$5 = hhb.b.c();
      $$0.a();
      float $$6 = $$2.v * 1.4F;
      ...
      float $$11 = 0.0F;
      int $$12 = 0;
      ffx $$13 = $$1.getBuffer(gms.i());

      for (fft.a $$14 = $$0.c(); $$9 > 0.0F; $$12++) {
         her $$15 = $$12 % 2 == 0 ? $$4 : $$5;
         float $$16 = $$15.c();
         float $$17 = $$15.g();
         float $$18 = $$15.d();
   ...
   private static void a(fft.a $$0, ffx $$1, float $$2, float $$3, float $$4, float $$5, float $$6) {
      $$1.a($$0, $$2, $$3, $$4).a(-1).a($$5, $$6).a(0, 10).c(240).b($$0, 0.0F, 1.0F, 0.0F);
   }

   private static void a(fft $$0, glx $$1, gyj $$2, float $$3, float $$4, dgk $$5, float $$6) {
   ...
   private static void a(fft.a $$0, ffx $$1, dyr $$2, dgk $$3, ji $$4, double $$5, double $$6, double $$7, float $$8, float $$9) {
      ji $$10 = $$4.e();
      dww $$11 = $$2.a_($$10);
      if ($$11.o() != dpw.a && $$3.A($$4) > 3) {
         if ($$11.m($$2, $$10)) {
            fbt $$12 = $$11.f($$2, $$10);
            if (!$$12.c()) {
   ...
   private static void a(fft.a $$0, ffx $$1, int $$2, float $$3, float $$4, float $$5, float $$6, float $$7) {
      Vector3f $$8 = $$0.a().transformPosition($$3, $$4, $$5, new Vector3f());
      $$1.a($$8.x(), $$8.y(), $$8.z(), $$2, $$6, $$7, heh.d, 15728880, 0.0F, 1.0F, 0.0F);
   }
   ...
   @Override
   public void a(aup $$0) {
      gsd.a $$1 = new gsd.a(this, this.l, this.m, this.n, $$0, this.q.get(), this.r, this.p);
      this.h = gse.a($$1);
      this.i = gse.b($$1);
   }
}
