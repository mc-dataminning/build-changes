...
public class gsb implements grx {
   ...
   private final dcz e;
   private final azh f;
   private final Object2ObjectArrayMap<dcx, gsb.a> g = new Object2ObjectArrayMap();
   private Optional<dcv> h = Optional.empty();
   private Optional<dcu> i = Optional.empty();
   private float j;
   @Nullable
   private dcx k;

   public gsb(gcq $$0, gtv $$1, dcz $$2) {
      this.f = $$0.dP().E_();
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   ...
   @Override
   public void a() {
      this.g.values().removeIf(grw::m);
      dcx $$0 = this.e.a(this.c.du(), this.c.dw(), this.c.dA()).a();
      if ($$0 != this.k) {
         this.k = $$0;
         this.h = $$0.m();
         this.i = $$0.n();
         this.g.values().forEach(gsb.a::o);
         ...
         .ifPresent(
            $$0x -> {
               ...
               if ($$4 > 0) {
                  ...
                  this.j = this.j - (float)($$1.a(dch.b, $$3) - 1) / (float)$$0x.b();
               }
               ...
               if (this.j >= 1.0F) {
                  ...
                  double $$12 = $$11 + $$0x.d();
                  gsi $$13 = gsi.a($$0x.a().a(), this.f, this.c.du() + $$8 / $$11 * $$12, this.c.dy() + $$9 / $$11 * $$12, this.c.dA() + $$10 / $$11 * $$12);
                  this.d.a($$13);
                  this.j = 0.0F;
               } else {
