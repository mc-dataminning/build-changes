...
public abstract class gsb<T extends buk, S extends gyi> {
   protected static final float c = 0.025F;
   public static final int d = 24;
   protected final gsa e;
   private final fob a;
   protected float f;
   protected float g = 1.0F;
   private final S b = this.d();

   protected gsb(gsc.a $$0) {
      this.e = $$0.a();
      this.a = $$0.j();
   }
   ...
   protected int b(T $$0, ji $$1) {
      return $$0.dW().a(dgr.a, $$1);
   }

   protected int a(T $$0, ji $$1) {
      return $$0.bY() ? 15 : $$0.dW().a(dgr.b, $$1);
   }

   public boolean a(T $$0, gpo $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         return false;
      } else if (!this.b($$0)) {
         return true;
         ...
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new fav($$0.dB() - 2.0, $$0.dD() - 2.0, $$0.dH() - 2.0, $$0.dB() + 2.0, $$0.dD() + 2.0, $$0.dH() + 2.0);
         }
   ...
   private static void a(ffu $$0, glx $$1, gyi.a $$2) {
      float $$3 = 0.025F;
   ...
   protected void a(S $$0, wo $$1, ffu $$2, glx $$3, int $$4) {
      fba $$5 = $$0.E;
      if ($$5 != null) {
         boolean $$6 = !$$0.A;
   ...
   public void a(T $$0, S $$1, float $$2) {
      $$1.r = ayz.d((double)$$2, $$0.aa, $$0.dB());
      $$1.s = ayz.d((double)$$2, $$0.ab, $$0.dD());
      $$1.t = ayz.d((double)$$2, $$0.ac, $$0.dH());
      $$1.z = $$0.cp();
      $$1.u = (float)$$0.af + $$2;
      $$1.v = $$0.dr();
      $$1.w = $$0.ds();
      $$1.x = $$0.cS();
      if ($$0.bZ() && $$0.dl() instanceof cqw $$3 && $$3.l() instanceof crl $$4 && $$4.t()) {
         double $$5 = ayz.d((double)$$2, $$3.aa, $$3.dB());
         double $$6 = ayz.d((double)$$2, $$3.ab, $$3.dD());
         double $$7 = ayz.d((double)$$2, $$3.ac, $$3.dH());
      ...
      if ($$8) {
         $$1.D = this.c($$0);
         $$1.E = $$0.dt().a(bul.c, 0, $$0.k($$2));
      } else {
         $$1.D = null;
      }

      $$1.A = $$0.cg();
      buk $$10 = $$0 instanceof bve $$9 ? $$9.A() : null;
      if ($$10 != null) {
         ...
         $$15.f = $$0.dW().a(dgr.a, $$13);
         $$15.g = $$0.dW().a(dgr.a, $$14);
      } else {
         $$1.F = null;
      }
