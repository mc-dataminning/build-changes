...
public class cce extends biq implements bkd {
   ...
   public cce(biu<? extends cce> $$0, cpv $$1) {
      super($$0, $$1);
   }

   public cce(cpv $$0, double $$1, double $$2, double $$3, float $$4, int $$5, bjg $$6) {
      this(biu.H, $$0);
      this.e = $$5;
      this.a($$6);
   ...
   @Nullable
   public bjg q() {
      if (this.i == null && this.j != null && this.dL() instanceof akq) {
         biq $$0 = ((akq)this.dL()).a(this.j);
         if ($$0 instanceof bjg) {
            this.i = (bjg)$$0;
         }
      }
   ...
   public void b(byte $$0) {
      ...
      if ($$0 == 4) {
         this.h = true;
         if (!this.aS()) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apd.hu, this.da(), 1.0F, this.ag.i() * 0.2F + 0.85F, false);
         }
      }
   }
