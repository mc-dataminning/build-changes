...
public class dpt extends dja {
   public static final MapCodec<dpt> c = b(dpt::new);
   public static final dxm d = dxl.v;
   private static final Map<dfl, List<dpt.a>> h = new WeakHashMap<>();
   ...
   private static boolean a(dgg $$0, ji $$1, boolean $$2) {
      List<dpt.a> $$3 = h.computeIfAbsent($$0, $$0x -> Lists.newArrayList());
      if ($$2) {
         $$3.add(new dpt.a($$1.j(), $$0.ad()));
      }
