...
public class dpt implements dpv {
   public static final Codec<dpt> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bfy.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bfy.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bfy.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bfw.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bfw.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public dpt(int $$0, bfy $$1, bfy $$2, int $$3, int $$4, bfy $$5, bfw $$6, bfw $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
