...
public class dpt extends dpw {
   public static final Codec<dpt> a = RecordCodecBuilder.create($$0 -> a($$0).apply($$0, dpt::new));
   ...
   public List<doe.a> a(cms $$0, BiConsumer<gu, dcb> $$1, apf $$2, int $$3, gu $$4, dno $$5) {
      ...
      return ImmutableList.of(new doe.a($$4.b($$3), 0, true));
   }
