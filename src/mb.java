...
public class mb {
   ...
   public static final ke<bto> d = a(mc.W, bts::a);
   public static final jm<djm> e = b(mc.f, "air", $$0 -> djo.a);
   public static final jm<bus<?>> f = b(mc.z, "pig", $$0 -> bus.aQ);
   ...
   public static final ke<bwk> s = a(mc.c, bwp::a);
   ...
   public static final ke<cgo> y = a(mc.aa, cgp::a);
   public static final jm<cel<?>> z = a(mc.U, "dummy", $$0 -> cel.a);
   public static final jm<cfs<?>> A = a(mc.ak, "dummy", $$0 -> cfs.a);
   ...
   public static final ke<bro<?>> J = a(mc.C, $$0 -> bro.a);
   public static final ke<brq<?>> K = a(mc.J, $$0 -> brq.a);
   ...
   public static final ke<chc> ai = a(mc.l, chc::a);
   public static final ke<chj> aj = a(mc.F, chj::a);
