...
public class mb implements kk {
   ...
   public CompletableFuture<?> a(ki $$0) {
      ...
      Consumer<cms> $$6 = $$4::add;
      new lz($$2, $$5, $$6).a();
      new ma($$5).a();
      List<cwp> $$7 = kd.e.g().stream().filter($$0x -> true).map(Entry::getValue).filter($$1x -> !$$1.containsKey($$1x)).toList();
      if (!$$7.isEmpty()) {
