...
public class mb implements ll {
   ...
   public mb(ln $$0, CompletableFuture<iz.a> $$1) {
      this.d = $$0;
      this.e = $$1;
   }
   ...
   public CompletableFuture<?> a(lj $$0) {
      Path $$1 = this.d.a(ln.b.c).resolve("blocks.json");
      return this.e
         .thenCompose(
            $$2 -> {
               JsonObject $$3 = new JsonObject();
               akk<JsonElement> $$4 = $$2.a(JsonOps.INSTANCE);
               $$2.b(lf.f)
                  .b()
                  .forEach(
                     $$2x -> {
                        JsonObject $$3x = new JsonObject();
                        drc<ddy, drb> $$4x = ((ddy)$$2x.a()).m();
                        if (!$$4x.d().isEmpty()) {
                        ...
                        $$3x.add("states", $$9);
                        String $$14 = $$2x.g();
                        JsonElement $$15 = (JsonElement)ddz.a
                           .codec()
                           .encodeStart($$4, (ddy)$$2x.a())
