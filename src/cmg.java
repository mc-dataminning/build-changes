...
public class cmg implements bpw, bqi {
   ...
   public final js<cua> h = js.a(36, cua.l);
   public final js<cua> i = js.a(4, cua.l);
   public final js<cua> j = js.a(1, cua.l);
   private final List<js<cua>> n = ImmutableList.of(this.h, this.i, this.j);
   public int k;
   public final cmh l;
   private int o;
   ...
   public cua f() {
      return d(this.k) ? this.h.get(this.k) : cua.l;
   }
   ...
   private boolean a(cua $$0, cua $$1) {
      return !$$0.e() && cua.c($$0, $$1) && $$0.k() && $$0.H() < this.e_($$0);
   }
   ...
   public int c(cua $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         if (!this.h.get($$1).e() && cua.c($$0, this.h.get($$1))) {
            return $$1;
         }
      }
   ...
   public int d(cua $$0) {
      for (int $$1 = 0; $$1 < this.h.size(); $$1++) {
         cua $$2 = this.h.get($$1);
         if (!$$2.e() && cua.c($$0, $$2) && !$$2.m() && !$$2.A() && !$$2.b(kn.g)) {
            return $$1;
         }
      }
   ...
   public int a(Predicate<cua> $$0, int $$1, bpw $$2) {
      int $$3 = 0;
      boolean $$4 = $$1 == 0;
      $$3 += bpx.a(this, $$0, $$1 - $$3, $$4);
      $$3 += bpx.a($$2, $$0, $$1 - $$3, $$4);
      cua $$5 = this.l.cd.g();
      $$3 += bpx.a($$5, $$0, $$1 - $$3, $$4);
      if ($$5.e()) {
   ...
   public void a(cua $$0, boolean $$1) {
      while (!$$0.e()) {
         ...
         if (this.c($$2, $$0.a($$3)) && $$1 && this.l instanceof aql) {
            ((aql)this.l).c.b(new ack(-2, 0, $$2, this.a($$2)));
         }
      }
   }
   ...
   public cua a(int $$0, int $$1) {
      ...
      return $$2 != null && !$$2.get($$0).e() ? bpx.a($$2, $$0, $$1) : cua.l;
   }
   ...
   public void b(ud $$0) {
      ...
      for (int $$1 = 0; $$1 < $$0.size(); $$1++) {
         tx $$2 = $$0.a($$1);
         int $$3 = $$2.f("Slot") & 255;
         cua $$4 = cua.a(this.l.dR(), (uu)$$2).orElse(cua.l);
   ...
   public cua a(boolean $$0) {
      cua $$1 = this.f();
      return $$1.e() ? cua.l : this.a(this.k, $$0 ? $$1.H() : 1);
   }
}
