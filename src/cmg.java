...
public final class cmg implements Predicate<cjf> {
   ...
   static record b(aqh<cja> b) implements cmg.c {
      static final Codec<cmg.b> c = RecordCodecBuilder.create($$0 -> $$0.group(aqh.a(jc.D).fieldOf("tag").forGetter($$0x -> $$0x.b)).apply($$0, cmg.b::new));
   ...
   interface c {
      Codec<cmg.c> a = arf.a(cmg.a.c, cmg.b.c).xmap($$0 -> (cmg.c)$$0.map($$0x -> $$0x, $$0x -> $$0x), $$0 -> {
