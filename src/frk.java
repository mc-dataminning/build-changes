...
public abstract class frk<E extends frk.a<E>> extends frh {
   private static final ale a = ale.b("textures/gui/menu_list_background.png");
   private static final ale m = ale.b("textures/gui/inworld_menu_list_background.png");
   protected final fof c;
   protected final int d;
   private final List<E> n = new frk.b();
   ...
   public frk(fof $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wv.a);
      this.c = $$0;
      this.d = $$4;
   }

   public frk(fof $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this($$0, $$1, $$2, $$3, $$4);
      this.o = true;
      this.f = $$5;
   }
   ...
   protected boolean c(int $$0) {
      return Objects.equals(this.p(), this.aD_().get($$0));
   }
   ...
   protected final E c(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = azk.a($$1 - (double)this.G()) - this.f + (int)this.g() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.t() ? this.aD_().get($$7) : null;
   }
   ...
   protected void b(frc $$0) {
      ale $$1 = this.c.s == null ? fxi.h : fxi.j;
      ale $$2 = this.c.s == null ? fxi.i : fxi.k;
      $$0.a(gpn::H, $$1, this.F(), this.G() - 2, 0.0F, 0.0F, this.A(), 2, 32, 2);
      $$0.a(gpn::H, $$2, this.F(), this.I(), 0.0F, 0.0F, this.A(), 2, 32, 2);
   }

   protected void c(frc $$0) {
      ale $$1 = this.c.s == null ? a : m;
      $$0.a(gpn::H, $$1, this.F(), this.G(), (float)this.H(), (float)(this.I() + (int)this.g()), this.A(), this.y(), 32, 32);
   }

   protected void d(frc $$0) {
   ...
   protected void f(E $$0) {
      int $$1 = this.d(this.aD_().indexOf($$0));
   ...
   @Override
   public Optional<ftn> d(double $$0, double $$1) {
   ...
   @Nullable
   protected E a(fvv $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.p());
   }

   @Nullable
   protected E a(fvv $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fvl.a w() {
      if (this.aI_()) {
         ...
         return this.q != null ? fvl.a.b : fvl.a.a;
      }
   }
   ...
   protected void a(fvn $$0, E $$1) {
      List<E> $$2 = this.aD_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fvm.b, ww.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends frk.a<E>> implements ftn {
      @Deprecated
      frk<E> a;
      ...
      public abstract void a(frc var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
