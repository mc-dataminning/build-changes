...
public final class frk {
   ...
   private static final frk c = new frk(HostAndPort.fromParts("server.invalid", 25565));

   public frk(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private frk(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static frk a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new frk($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof frk ? this.b.equals(((frk)$$0).b) : false;
      }
   }
