...
public class arx extends asc {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<ary<?>> e = Sets.newHashSet();

   public arx(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(cfh $$0, ary<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<ary<?>> d() {
      Set<ary<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  sn $$4 = a($$3.getAsJsonObject());
                  $$4 = avv.g.a($$0, $$4, tc.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<ary<T>> a(asa<T> $$0, String $$1) {
      return Optional.ofNullable(ahg.a($$1)).flatMap($$0.a()::b).map($$0::b);
   }

   private static sn a(JsonObject $$0) {
      sn $$1 = new sn();
   ...
   protected String b() {
      Map<asa<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<ary<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<ary<?>>)$$3.next();
         ary<?> $$2 = (ary<?>)$$1.getKey();
      ...
      for (Entry<asa<?>, JsonObject> $$4 : $$0.entrySet()) {
   ...
   private static <T> ahg b(ary<T> $$0) {
      return $$0.a().a().b($$0.b());
   }
   ...
   public void a(ane $$0) {
      Object2IntMap<ary<?>> $$1 = new Object2IntOpenHashMap();
