...
class arx extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof arw && $$1 instanceof arw && $$0.equals($$1);
   }
   ...
   private static arw a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof arw) {
         return (arw)$$0;
      } else {
