...
public class arx {
   ...
   private static void a(asb $$0, arb $$1, dud $$2) {
      $$0.b(new adq($$2, $$1.y_(), null, null));
      dba $$3 = $$2.f();
      agp.a($$1, $$3);
   }

   private List<dud> a(aqk $$0, dba $$1) {
      int $$2 = ayu.d(this.i);
      List<dud> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : ayu.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
