...
public class fbz extends eso {
   private static final aex b = new aex("recipe_book/slot_many_craftable");
   private static final aex c = new aex("recipe_book/slot_craftable");
   private static final aex d = new aex("recipe_book/slot_many_uncraftable");
   private static final aex e = new aex("recipe_book/slot_uncraftable");
   ...
   public void b(esf $$0, int $$1, int $$2, float $$3) {
      ...
      List<cmk<?>> $$10 = this.g();
      this.u = arx.d(this.s / 30.0F) % $$10.size();
