...
public abstract class fbz<T extends fbz<T>> {
   ...
   public fbz(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fbx.a();
         if ($$3 != null) {
         ...
         throw new fdg(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fdg(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fdg(var2.getMessage(), var2);
      }
   }
   ...
   public static fbz<?> a(String $$0) {
      return new fbz.b($$0, 5000, 60000);
   }

   public static fbz<?> a(String $$0, int $$1, int $$2) {
      return new fbz.b($$0, $$1, $$2);
   }

   public static fbz<?> b(String $$0, String $$1) {
      return new fbz.c($$0, $$1, 5000, 60000);
   }

   public static fbz<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fbz.c($$0, $$1, $$2, $$3);
   }

   public static fbz<?> b(String $$0) {
      return new fbz.a($$0, 5000, 60000);
   }

   public static fbz<?> c(String $$0, String $$1) {
      return new fbz.d($$0, $$1, 5000, 60000);
   }

   public static fbz<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fbz.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fbz<fbz.a> {
   ...
   public static class b extends fbz<fbz.b> {
   ...
   public static class c extends fbz<fbz.c> {
      ...
      public fbz.c f() {
         try {
            ...
            throw new fdg(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fbz<fbz.d> {
      private final String c;
