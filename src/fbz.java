...
public class fbz {
   ...
   public static final fbz.a bv;

   public static fbz.a a(int $$0, int $$1) {
      return $$0 == -1 ? fbz.b.b.a($$1) : fbz.b.a.a($$0);
   }

   public static fbz.a a(String $$0) {
      if (fbz.a.e.containsKey($$0)) {
         return fbz.a.e.get($$0);
      } else {
         for (fbz.b $$1 : fbz.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final fbz.b b;
      private final int c;
      private final ayx<xd> d;
      static final Map<String, fbz.a> e = Maps.newHashMap();

      a(String $$0, fbz.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ayx<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? xd.b($$2.toUpperCase(Locale.ROOT)) : xd.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? xd.b($$2) : xd.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ua.a().b($$1) ? xd.c($$1) : xd.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<fbz.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xd> g;

      private static void a(fbz.b $$0, String $$1, int $$2) {
         fbz.a $$3 = new fbz.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(final String $$0, final BiFunction<Integer, String, xd> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public fbz.a a(int $$0) {
         return (fbz.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
