...
public class gyg extends ua {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private gyg(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static gyg a(aut $$0, List<String> $$1, boolean $$2) {
      ...
      tz.a().a($$3);
      return new gyg(Map.copyOf($$3), $$2);
   }

   private static void a(String $$0, List<aur> $$1, Map<String, String> $$2) {
      for (aur $$3 : $$1) {
