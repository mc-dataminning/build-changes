...
public class eiw<T> implements eiv<T> {
   private static final Comparator<eiu<?>> a = ($$0, $$1) -> eiz.b.compare($$0.b(), $$1.b());
   ...
   private final BiConsumer<eiu<T>, eiz<T>> j = ($$0x, $$1x) -> {
      if ($$1x.equals($$0x.b())) {
         this.b($$1x);
      }
   };

   public eiw(LongPredicate $$0, Supplier<bdp> $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public void a(cpc $$0, eiu<T> $$1) {
      long $$2 = $$0.a();
      this.d.put($$2, $$1);
      eiz<T> $$3 = $$1.b();
      if ($$3 != null) {
   ...
   private void a(long $$0, int $$1, bdp $$2) {
      this.a($$0);
   ...
   private void b(eiz<T> $$0) {
      this.e.put(cpc.a($$0.b()), $$0.c());
   }

   private void a(Queue<eiu<T>> $$0, eiu<T> $$1, long $$2, int $$3) {
      if (this.a($$3)) {
         eiu<T> $$4 = $$0.peek();
         eiz<T> $$5 = $$4 != null ? $$4.b() : null;

         while (this.a($$3)) {
            eiz<T> $$6 = $$1.b();
            if ($$6 == null || $$6.c() > $$2 || $$5 != null && eiz.b.compare($$6, $$5) > 0) {
               break;
            }
   ...
   public boolean a(gw $$0, T $$1) {
      eiu<T> $$2 = (eiu<T>)this.d.get(cpc.a($$0));
   ...
   public boolean b(gw $$0, T $$1) {
      this.d();
      return this.i.contains(eiz.a($$1, $$0));
   }
   ...
   private void a(dva $$0, eiw.a<T> $$1) {
   ...
   public void a(dva $$0, hy $$1) {
      this.a(this, $$0, $$1);
   }

   public void a(eiw<T> $$0, dva $$1, hy $$2) {
      List<eiz<T>> $$3 = new ArrayList<>();
      Predicate<eiz<T>> $$4 = $$1x -> $$1.b($$1x.b());
      $$0.h.stream().filter($$4).forEach($$3::add);
      $$0.g.stream().filter($$4).forEach($$3::add);
      $$0.a($$1, ($$2x, $$3x) -> $$3x.d().filter($$4).forEach($$3::add));
      LongSummaryStatistics $$5 = $$3.stream().mapToLong(eiz::e).summaryStatistics();
      long $$6 = $$5.getMin();
      long $$7 = $$5.getMax();
      $$3.forEach($$3x -> this.a(new eiz<>((T)$$3x.a(), $$3x.b().a($$2), $$3x.c(), $$3x.d(), $$3x.e() - $$6 + $$7 + 1L)));
   }

   @Override
   public int a() {
      return this.d.values().stream().mapToInt(ejb::a).sum();
   }

   @FunctionalInterface
   interface a<T> {
      void accept(long var1, eiu<T> var3);
   }
}
