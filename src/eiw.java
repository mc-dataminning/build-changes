...
public class eiw implements eix, eiy {
   ...
   private final enm<MinecraftServer> G;
   ...
   public eiw(cvv $$0, drt $$1, eiw.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         hz.c,
   ...
   public static <T> eiw a(Dynamic<T> $$0, cvv $$1, eiw.a $$2, drt $$3, Lifecycle $$4) {
      ...
      return new eiw(
         ...
         new enm<>(enl.a, $$0.get("ScheduledEvents").asStream()),
         (sw)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(doy.a.a).resultOrPartial(f::error).orElse(doy.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(iw $$0, sw $$1, @Nullable sw $$2) {
      ...
      drr.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(doy.a.a.encodeStart(tk.a, this.y), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<tt> $$5 = cwl.b.encodeStart(tk.a, this.g.g());
   ...
   @Override
   public boolean z() {
      return this.i == eiw.a.b;
   }

   @Override
   public boolean A() {
      return this.i == eiw.a.c;
   }
