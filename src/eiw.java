...
public class eiw {
         ...
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eiw.b $$13 = new eiw.b($$1.trim(), this.f, $$3, $$2);
                  eiw.a $$14 = new eiw.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eiw.c $$30 = new eiw.c(this.f, $$2, $$0);
                        eiw.a $$31 = new eiw.a($$29);
                        $$31.a($$30);
   ...
   class b implements ActionListener {
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eiw.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eiw.this.b && !eiw.this.d) {
            try {
               eiw.this.e = true;
               eiw.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eiw.a.error("Error extracting archive", var3);
               eiw.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eiw.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eiw.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eiw.this.g);
                  eiw.this.c = true;
               } else {
                  eiw.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eiw.this.d = true;
               }
            } catch (IOException var3) {
               eiw.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eiw.this.d = true;
            }
         }
      }
