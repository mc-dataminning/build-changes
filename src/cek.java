...
public class cek {
   ...
   private int g = aun.b(auu.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(ja.a.fieldOf("uuid").forGetter(Pair::getFirst), atv.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<blu> j;
   @VisibleForTesting
   protected final ArrayList<blu> c;
   private final cek.a k;
   @VisibleForTesting
   protected final Object2IntMap<blu> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cek> a(Predicate<blu> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cek::b)).apply($$1, $$1x -> new cek($$0, $$1x))
      );
   }

   public cek(Predicate<blu> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cek.a(this);
   ...
   public void a(and $$0, Predicate<blu> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<blu>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<blu> $$6 = (Entry<blu>)$$5.next();
         int $$7 = $$6.getIntValue();
         blu $$8 = (blu)$$6.getKey();
         blu.c $$9 = $$8.dI();
   ...
   public int b(@Nullable blu $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bmk> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bmk).map($$0 -> (bmk)$$0);
   }

   @VisibleForTesting
   protected static record a(cek a) implements Comparator<blu> {
      public int a(blu $$0, blu $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cfh;
               boolean $$7 = $$1 instanceof cfh;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
