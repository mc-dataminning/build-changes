...
public class fy implements ArgumentType<crl> {
   ...
   public static crl a(CommandContext<ep> $$0, String $$1) {
      return (crl)$$0.getArgument($$1, crl.class);
   }

   public crl a(StringReader $$0) throws CommandSyntaxException {
