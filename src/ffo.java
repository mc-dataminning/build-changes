...
public class ffo {
   ...
   public static void a(File $$0, eyj $$1, Consumer<xo> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, eyj $$2, Consumer<xo> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, eyj $$2, Consumer<xo> $$3) {
      eyy $$4 = a($$2);
   ...
   public static eyy a(eyj $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      eyy $$3 = new eyy($$1, $$2, false);
   ...
   public ffo(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
