...
public class esr extends esl<esr.a> {
   protected esr(dzd $$0) {
      super(dgp.a, $$0, new esr.a(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
   }
   ...
   protected dyv g(long $$0) {
      ...
      if ($$1 != null) {
         ...
         if ($$2 != this.d.b && kk.c($$0) < $$2) {
            ...
            return this.j($$0) ? new dyv(15) : new dyv();
         }
      }
   }

   private static dyv a(dyv $$0) {
      if ($$0.c()) {
         return $$0.b();
      } else {
         byte[] $$1 = $$0.a();
   ...
   protected static final class a extends esi<esr.a> {
      int b;
      final Long2IntOpenHashMap c;

      public a(Long2ObjectOpenHashMap<dyv> $$0, Long2IntOpenHashMap $$1, int $$2) {
         super($$0);
         this.c = $$1;
      ...
      public esr.a a() {
         return new esr.a(this.a.clone(), this.c.clone(), this.b);
      }
   }
}
