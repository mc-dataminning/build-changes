...
public class esr {
   ...
   private static final Queue<esr.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile esr.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(esr::a), esp::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(esr::a), esp::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + esr.a(this.b) + ", type=" + esr.b(this.c) + ", severity=" + esr.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
