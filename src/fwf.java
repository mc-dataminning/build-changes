...
public class fwf extends fva<ctj> {
   ...
   protected void aR_() {
      super.aR_();
      this.Y = this.m.aS().a(gfc.r).b("flag");
   }
   ...
   protected void a(foe $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(gmi::H, P, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      ctz $$6 = this.z.n();
      ctz $$7 = this.z.o();
      ctz $$8 = this.z.p();
      ctz $$9 = this.z.q();
      if (!$$6.h()) {
         $$0.a(gmi::H, G, $$4 + $$6.e, $$5 + $$6.f, 16, 16);
      }

      if (!$$7.h()) {
         $$0.a(gmi::H, H, $$4 + $$7.e, $$5 + $$7.f, 16, 16);
      }

      if (!$$8.h()) {
         $$0.a(gmi::H, I, $$4 + $$8.e, $$5 + $$8.f, 16, 16);
      }

      int $$10 = (int)(41.0F * this.af);
      akv $$11 = this.ad ? J : K;
      $$0.a(gmi::H, $$11, $$4 + 119, $$5 + 13 + $$10, 12, 15);
      $$0.d();
      feq.c();
      if (this.Z != null && !this.ae) {
         ...
         cvm $$13 = ((cus)$$9.g().h()).b();
         $$0.a($$2x -> gof.a($$0.c(), $$2x, 15728880, hei.d, this.Y, hhc.f, true, $$13, this.Z));
         $$0.c().b();
      } else if (this.ae) {
         $$0.a(gmi::H, O, $$4 + $$9.e - 5, $$5 + $$9.f - 5, 26, 26);
      }
   ...
   private void a(foe $$0, jr<dtp> $$1, int $$2, int $$3) {
      ffu $$4 = new ffu();
      $$4.a();
      ...
      $$0.a($$2x -> gof.a($$4, $$2x, 15728880, hei.d, this.Y, hhc.f, true, cvm.h, $$6));
      $$4.b();
      $$0.d();
   }
