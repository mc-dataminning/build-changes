...
public abstract class blq extends bmu {
   private static final agm<Boolean> bT = agp.a(blq.class, ago.k);
   ...
   protected blq(blz<? extends blq> $$0, ctp $$1) {
      super($$0, $$1);
   }
   ...
   @Nullable
   public abstract blq a(and var1, blq var2);
   ...
   protected void m() {
      if (!this.o_() && this.bO() && this.cZ() instanceof chc $$0 && !$$0.a((blv)this)) {
         this.ac();
      }
   }
