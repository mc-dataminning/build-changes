...
public class blq extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return blq.a(new Dynamic($$0, $$1), blq.d, blq.a);
      }
   };
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bgx.z, () -> DSL.constType(bii.a()));
      ...
      $$0.registerType(false, bgx.C, () -> DSL.or(DSL.constType(DSL.intType()), DSL.constType(bii.a())));
      $$0.registerType(false, bgx.D, () -> DSL.constType(bii.a()));
   ...
   protected static <T> T a(Dynamic<T> $$0, Map<String, String> $$1, Map<String, String> $$2) {
      return (T)$$0.update("tag", $$3 -> $$3.update("BlockEntityTag", $$2xx -> {
            String $$3x = $$0.get("id").asString().result().map(bii::a).orElse("minecraft:air");
            ...
            String $$3x = bii.a($$0.get("id").asString(""));
            String $$4 = $$2.get($$3x);
