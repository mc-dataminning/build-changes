...
public class fyc extends fyb {
   ...
   protected void aO_() {
      ...
      this.z = $$0.u();
      this.A = $$0.aZ().m();
      this.c(fsq.a(dix::e).a(dix.a, dix.d, dix.b, dix.c).a(this.z).a(this.n / 2 - 155, 100, 150, 20, d, ($$0x, $$1x) -> this.z = $$1x));
      this.c(fsq.b(this.A).a(this.n / 2 + 5, 100, 150, 20, c, ($$0x, $$1x) -> this.A = $$1x));
      fsj $$1 = fsj.a(wy.c("lanServer.start"), $$1x -> {
         this.m.a(null);
         wy $$2;
      ...
      this.C = new fss(this.p, this.n / 2 - 75, 160, 150, 20, wy.c("lanServer.port"));
      this.C.b($$1x -> {
         wy $$2 = this.a($$1x);
      ...
      this.c(this.C);
      this.c($$1);
      this.c(fsj.a(wx.e, $$0x -> this.aL_()).a(this.n / 2 + 5, this.o - 28, 150, 20).a());
   }
