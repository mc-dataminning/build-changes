...
public class fyc implements fyv {
   ...
   private CompletableFuture<Optional<cmm>> g = CompletableFuture.completedFuture(Optional.empty());
   private Instant h = Instant.EPOCH;

   public fyc(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cmm::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cmm>> a(Optional<cmm> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cmm.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cmm $$0) {
      ...
      if ($$0 != null) {
         if (aa.aW) {
            cmm.a.encodeStart(JsonOps.INSTANCE, $$0).ifSuccess($$0x -> {
               try {
   ...
   @Nullable
   private cmm a(UserApiService $$0) throws axe, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cmn.a $$2 = a($$1);
         return new cmm(axd.a($$1.keyPair().privateKey()), new cmn($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         return null;
      }
   }

   private static cmn.a a(KeyPairResponse $$0) throws axe {
      KeyPair $$1 = $$0.keyPair();
