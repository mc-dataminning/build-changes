...
public class bxg extends bxt implements bku, bkz {
   public static final cnk bT = cnk.a(ckm.eA);
   ...
   public static final afc<Boolean> bY = aff.a(bxg.class, afe.k);
   public static final afc<Long> bZ = aff.a(bxg.class, afe.c);
   public final bjp ca = new bjp();
   public final bjp cb = new bjp();
   public final bjp cc = new bjp();
   public final bjp cd = new bjp();
   public final bjp ce = new bjp();
   private static final bju cD = bju.b(bjx.l.k(), bjx.l.l() - 1.43F);
   private int cE = 0;
   private int cF = 0;

   public bxg(bjx<? extends bxg> $$0, cqz $$1) {
      super($$0, $$1);
      this.t(1.5F);
      this.bL = new bxg.c();
      this.bK = new bxg.b();
   ...
   public static blo.a s() {
      return gE().a(blp.l, 32.0).a(blp.m, 0.09F).a(blp.h, 0.42F);
   }
   ...
   protected blj<?> a(Dynamic<?> $$0) {
      return bxh.a(this.dO().a($$0));
   }

   @Override
   public bju a(bkv $$0) {
      return $$0 == bkv.k ? cD.a(this.dY()) : super.a($$0);
   }
   ...
   public void l() {
      ...
      if (this.cE > 0) {
         this.cE--;
         if (this.cE == 0) {
            this.dL().a(null, this.dl(), aqd.cS, aqe.g, 1.0F, 1.0F);
         }
      }
   ...
   protected float e(ccx $$0) {
      ...
      return (float)this.b(blp.m) + $$1;
   }

   @Override
   protected eie j(bkj $$0) {
      return this.t() ? new eie(this.dD(), this.dB()) : super.j($$0);
   }

   @Override
   protected eif b(ccx $$0, eif $$1) {
      return this.t() ? eif.b : super.b($$0, $$1);
   }
   ...
   protected void b(float $$0, eif $$1) {
      double $$2 = this.b(blp.h) * (double)this.aI() + (double)this.eZ();
      this.g(this.bE().d(1.0, 0.0, 1.0).d().a((double)(22.2222F * $$0) * this.b(blp.m) * (double)this.aJ()).b(0.0, (double)(1.4285F * $$0) * $$2, 0.0));
      this.cE = 55;
      this.w(true);
      this.au = true;
   }
   ...
   protected void b(ht $$0, dgb $$1) {
      if ($$1.a(aqs.bo)) {
         this.a(aqd.da, 1.0F, 1.0F);
      } else {
         this.a(aqd.cZ, 1.0F, 1.0F);
      }
   }
   ...
   public boolean ge() {
      return this.f(this.gm() ? bkv.a : bkv.k);
   }
   ...
   public boolean a(bvu $$0) {
      if ($$0 != this && $$0 instanceof bxg $$1 && this.gM() && $$1.gM()) {
         return true;
      }
   ...
   @Nullable
   public bxg b(alq $$0, bjo $$1) {
      return bjx.l.a((cqz)$$0);
   }
   ...
   private double a(boolean $$0, float $$1, bju $$2, float $$3) {
      ...
      if ($$8) {
         ...
         float $$15 = asy.a((float)this.gs() + $$1, 0.0F, (float)$$10);
         boolean $$16 = $$15 < (float)$$11;
         float $$17 = $$16 ? $$15 / (float)$$11 : ($$15 - (float)$$11) / (float)($$10 - $$11);
         float $$18 = $$5 - $$12 * $$6;
         $$4 += $$9 ? (double)asy.i($$17, $$16 ? $$5 : $$18, $$16 ? $$18 : $$7) : (double)asy.i($$17, $$16 ? $$7 - $$5 : $$7 - $$18, $$16 ? $$7 - $$18 : 0.0F);
      }
   ...
   public eif p(float $$0) {
      bju $$1 = this.a(this.an());
      float $$2 = this.dY();
      return new eif(0.0, this.a(true, $$0, $$1, $$2) - (double)(0.2F * $$2), (double)($$1.a * 0.56F));
   }

   private void a(bjt $$0, float $$1) {
      float $$2 = $$0.co();
      float $$3 = asy.g(this.aU - $$2);
      float $$4 = asy.a(asy.g(this.aU - $$2), -$$1, $$1);
      float $$5 = $$2 + $$3 - $$4;
      $$0.n($$5);
   }
   ...
   class c extends bqh {
      ...
      @Override
      public void a() {
         if (this.k == bqh.a.b && !bxg.this.fS() && bxg.this.gm() && !bxg.this.go() && bxg.this.ge()) {
            bxg.this.gq();
         }
