...
public abstract class fnz<E extends fnz.a<E>> extends fnw {
   protected static final int b = 6;
   private static final alz a = alz.b("widget/scroller");
   private static final alz m = alz.b("widget/scroller_background");
   private static final alz n = alz.b("textures/gui/menu_list_background.png");
   private static final alz o = alz.b("textures/gui/inworld_menu_list_background.png");
   protected final fmf c;
   protected final int d;
   private final List<E> p = new fnz.b();
   ...
   public fnz(fmf $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xu.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected boolean c(int $$0) {
      return Objects.equals(this.g(), this.aI_().get($$0));
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = bae.a($$1 - (double)this.E()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.k() ? this.aI_().get($$7) : null;
   }
   ...
   public void b(fnr $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.m()) {
         int $$6 = this.q();
         int $$7 = (int)((float)(this.h * this.h) / (float)this.l());
         $$7 = bae.a($$7, 32, this.h - 8);
         int $$8 = (int)this.n() * (this.h - $$7) / this.p() + this.E();
         if ($$8 < this.E()) {
            $$8 = this.E();
         }

         $$0.a(glu::C, m, $$6, this.E(), 6, this.w());
         $$0.a(glu::C, a, $$6, $$8, 6, $$7);
      }
   ...
   protected void a(fnr $$0) {
      alz $$1 = this.c.s == null ? ftx.h : ftx.j;
      alz $$2 = this.c.s == null ? ftx.i : ftx.k;
      $$0.a(glu::C, $$1, this.D(), this.E() - 2, 0.0F, 0.0F, this.y(), 2, 32, 2);
      $$0.a(glu::C, $$2, this.D(), this.G(), 0.0F, 0.0F, this.y(), 2, 32, 2);
   }

   protected void b(fnr $$0) {
      alz $$1 = this.c.s == null ? n : o;
      $$0.a(glu::C, $$1, this.D(), this.E(), (float)this.F(), (float)(this.G() + (int)this.n()), this.y(), this.w(), 32, 32);
   }
   ...
   protected void e(E $$0) {
      this.b((double)(this.aI_().indexOf($$0) * this.d + this.d / 2 - this.h / 2));
   }

   protected void f(E $$0) {
      int $$1 = this.e(this.aI_().indexOf($$0));
   ...
   public void a(double $$0) {
      this.q = bae.a($$0, 0.0, (double)this.p());
   }
   ...
   public int p() {
      return Math.max(0, this.l() - (this.h - 4));
   }
   ...
   public boolean a(double $$0, double $$1, int $$2) {
      if (!this.d($$2)) {
         ...
         if (!this.c($$0, $$1)) {
            ...
            } else if (this.a((int)($$0 - (double)(this.D() + this.g / 2 - this.a() / 2)), (int)($$1 - (double)this.E()) + (int)this.n() - 4)) {
               return true;
            }
   ...
   public boolean b(double $$0, double $$1, int $$2) {
      return this.i() != null ? this.i().b($$0, $$1, $$2) : false;
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.E()) {
            ...
            int $$6 = this.h;
            int $$7 = bae.a((int)((float)($$6 * $$6) / (float)this.l()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fsk $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.g());
   }

   @Nullable
   protected E a(fsk $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void c(fnr $$0, int $$1, int $$2, float $$3) {
      int $$4 = this.s();
      int $$5 = this.a();
      int $$6 = this.d - 4;
      int $$7 = this.k();
   ...
   protected void a(fnr $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public int s() {
      return this.D() + this.g / 2 - this.a() / 2 + 2;
   }

   private int c() {
      return this.D() + this.g / 2 - this.a() / 2;
   }
   ...
   public fsa.a u() {
      if (this.aN_()) {
         ...
         return this.v != null ? fsa.a.b : fsa.a.a;
      }
   }
   ...
   protected void a(fsc $$0, E $$1) {
      List<E> $$2 = this.aI_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fsb.b, xv.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fnz.a<E>> implements fqc {
      @Deprecated
      fnz<E> a;
      ...
      public abstract void a(fnr var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
