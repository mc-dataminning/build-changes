public abstract class fnz extends fob {
   ...
   public fnz(int $$0, int $$1, int $$2, int $$3, xv $$4, double $$5) {
      super($$0, $$1, $$2, $$3, $$4);
      this.c = $$5;
   }
   ...
   public void a(fsb $$0) {
      ...
      if (this.j) {
         if (this.aN_()) {
            $$0.a(fsa.d, xv.c("narration.slider.usage.focused"));
         } else {
            $$0.a(fsa.d, xv.c("narration.slider.usage.hovered"));
         }
      }
   }
   ...
   public void b(fnq $$0, int $$1, int $$2, float $$3) {
      fme $$4 = fme.Q();
      $$0.a(glt::B, this.c(), this.D(), this.E(), this.y(), this.w(), ayp.a(this.l));
      $$0.a(glt::B, this.e(), this.D() + (int)(this.c * (double)(this.g - 8)), this.E(), 8, this.w(), ayp.a(this.l));
