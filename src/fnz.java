public class fnz extends foy<cpr> {
   private static final alb D = new alb("container/anvil/text_field");
   private static final alb E = new alb("container/anvil/text_field_disabled");
   private static final alb F = new alb("container/anvil/error");
   private static final alb G = new alb("textures/gui/container/anvil.png");
   private static final xl H = xl.c("container.repair.expensive");
   private fhi I;
   private final cms J;

   public fnz(cpr $$0, cmr $$1, xl $$2) {
      super($$0, $$1, $$2, G);
      this.J = $$1.l;
      this.r = 60;
   }
   ...
   protected void E() {
      ...
      this.I = new fhi(this.p, $$0 + 62, $$1 + 24, 103, 12, xl.c("container.repair"));
      this.I.f(false);
      this.I.g(-1);
      this.I.h(-1);
      this.I.d(false);
   ...
   private void a(String $$0) {
      ...
      if ($$1.h()) {
         String $$2 = $$0;
         if (!$$1.g().b(km.f) && $$0.equals($$1.g().x().getString())) {
            $$2 = "";
         }

         if (this.w.a($$2)) {
            this.m.s.cz.b(new aib($$2));
         }
      }
   }
   ...
   @Override
   public void d(fgm $$0, int $$1, int $$2, float $$3) {
      this.I.a($$0, $$1, $$2, $$3);
   }
