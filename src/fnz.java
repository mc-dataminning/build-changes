...
public abstract class fnz<T extends cps> extends fnb implements fpf<T> {
   ...
   private cun P = cun.l;
   private long Q;
   protected final Set<crn> B = Sets.newHashSet();
   protected boolean C;
   private int R;
   private int S;
   private boolean T;
   ...
   public void a(fgp $$0, int $$1, int $$2, float $$3) {
      ...
      this.b($$0, $$1, $$2);
      cun $$10 = this.L.e() ? this.w.g() : this.L;
      if (!$$10.e()) {
         int $$11 = 8;
         int $$12 = this.L.e() ? 8 : 16;
         String $$13 = null;
         if (!this.L.e() && this.K) {
            $$10 = $$10.c(ayx.f((float)$$10.I() / 2.0F));
   ...
   public static void a(fgp $$0, int $$1, int $$2, int $$3) {
      $$0.a(gdu.E(), $$1, $$2, $$1 + 16, $$2 + 16, -2130706433, -2130706433, $$3);
   }
   ...
   protected List<xo> a(cun $$0) {
      return a(this.m, $$0);
   }

   private void a(fgp $$0, cun $$1, int $$2, int $$3, String $$4) {
      $$0.c().a();
   ...
   protected abstract void a(fgp var1, float var2, int var3, int var4);

   protected void a(fgp $$0, crn $$1) {
      int $$2 = $$1.e;
      int $$3 = $$1.f;
      cun $$4 = $$1.g();
      boolean $$5 = false;
      ...
      if ($$4.e() && $$1.d()) {
         Pair<ale, ale> $$12 = $$1.c();
         if ($$12 != null) {
            gox $$13 = this.m.a((ale)$$12.getFirst()).apply((ale)$$12.getSecond());
            $$0.a($$2, $$3, 0, 16, 16, $$13);
            $$6 = true;
         }
      }
   ...
   @Nullable
   private crn b(double $$0, double $$1) {
      for (int $$2 = 0; $$2 < this.w.i.size(); $$2++) {
         crn $$3 = this.w.i.get($$2);
         if (this.a($$3, $$0, $$1) && $$3.d()) {
            return $$3;
         }
      }
               ...
               if (this.m.m.Z().c()) {
                  ...
                  if (this.w.g().e()) {
                     if ($$3) {
                        ...
                        boolean $$10 = $$9 != -999 && (eyr.a(ffd.Q().aO().i(), 340) || eyr.a(ffd.Q().aO().i(), 344));
                        cqb $$11 = cqb.a;
                        if ($$10) {
                           this.Y = $$4 != null && $$4.h() ? $$4.g().s() : cun.l;
                           $$11 = cqb.b;
                        } else if ($$9 == -999) {
                           $$11 = cqb.e;
                        }
   ...
   private void a(int $$0) {
      if (this.y != null && this.w.g().e()) {
         if (this.m.m.E.a($$0)) {
            this.a(this.y, this.y.d, 40, cqb.c);
            return;
         }

         for (int $$1 = 0; $$1 < 9; $$1++) {
            if (this.m.m.T[$$1].a($$0)) {
               this.a(this.y, this.y.d, $$1, cqb.c);
            }
         }
      }
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      ...
      if (this.G != null && this.m.m.Z().c()) {
         if ($$2 == 0 || $$2 == 1) {
            ...
            } else if (this.L.I() > 1 && $$5 != null && cps.a($$5, this.L, false)) {
               long $$7 = ac.c();
               if (this.I == $$5) {
                  if ($$7 - this.Q > 500L) {
                     this.a(this.G, this.G.d, 0, cqb.a);
                     this.a($$5, $$5.d, 1, cqb.a);
                     this.a(this.G, this.G.d, 0, cqb.a);
                     this.Q = $$7 + 750L;
                     this.L.h(1);
                  }
      ...
      } else if (this.C && $$5 != null && !$$6.e() && ($$6.I() > this.B.size() || this.R == 2) && cps.a($$5, $$6, true) && $$5.a($$6) && this.w.b($$5)) {
         this.B.add($$5);
         this.J();
      }
   ...
   public boolean b(double $$0, double $$1, int $$2) {
      ...
      if (this.X && $$3 != null && $$2 == 0 && this.w.a(cun.l, $$3)) {
         if (s()) {
            if (!this.Y.e()) {
               for (crn $$8 : this.w.i) {
                  if ($$8 != null && $$8.a(this.m.s) && $$8.h() && $$8.c == $$3.c && cps.a($$8, this.Y, true)) {
                     this.a($$8, $$8.d, $$2, cqb.b);
                  }
               }
            }
         } else {
         ...
         if (this.G != null && this.m.m.Z().c()) {
            if ($$2 == 0 || $$2 == 1) {
               ...
               if ($$7 != -1 && !this.L.e() && $$9) {
                  this.a(this.G, this.G.d, $$2, cqb.a);
                  this.a($$3, $$7, 0, cqb.a);
                  if (this.w.g().e()) {
                     this.P = cun.l;
                  } else {
                     this.a(this.G, this.G.d, $$2, cqb.a);
                     this.M = ayx.a($$0 - (double)$$4);
                     this.N = ayx.a($$1 - (double)$$5);
                     this.H = this.G;
                     this.P = this.L;
                     this.O = ac.c();
                  }
            ...
            this.a(null, -999, cps.b(0, this.R), cqb.f);

            for (crn $$10 : this.B) {
               this.a($$10, $$10.d, cps.b(1, this.R), cqb.f);
            }

            this.a(null, -999, cps.b(2, this.R), cqb.f);
         } else if (!this.w.g().e()) {
            if (this.m.m.I.a($$2)) {
               this.a($$3, $$7, $$2, cqb.d);
            } else {
               boolean $$11 = $$7 != -999 && (eyr.a(ffd.Q().aO().i(), 340) || eyr.a(ffd.Q().aO().i(), 344));
               if ($$11) {
                  this.Y = $$3 != null && $$3.h() ? $$3.g().s() : cun.l;
               }

               this.a($$3, $$7, $$2, $$11 ? cqb.b : cqb.a);
            }
         }
      }
   ...
   private boolean a(crn $$0, double $$1, double $$2) {
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if (this.y != null && this.y.h()) {
            if (this.m.m.I.a($$0, $$1)) {
               this.a(this.y, this.y.d, 0, cqb.d);
            } else if (this.m.m.F.a($$0, $$1)) {
               this.a(this.y, this.y.d, r() ? 1 : 0, cqb.e);
            }
         }
      ...
      if (this.w.g().e() && this.y != null) {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            if (this.m.m.T[$$2].a($$0, $$1)) {
               this.a(this.y, this.y.d, $$2, cqb.c);
               return true;
            }
         }
      }
