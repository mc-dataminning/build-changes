public abstract class fnz extends fod {
   private static final fpt a = new fpt(alz.b("widget/text_field"), alz.b("widget/text_field_highlighted"));
   ...
   public fnz(int $$0, int $$1, int $$2, int $$3, xv $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(fns var1, int var2, int var3, float var4);
}
