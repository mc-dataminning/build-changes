...
public class bqu extends bqn {
   public static final MapCodec<bqu> a = RecordCodecBuilder.mapCodec(
   ...
   private bqu(float $$0, float $$1) {
      this.b = $$0;
      this.d = $$1;
   }

   public static bqu b(float $$0, float $$1) {
      if ($$1 <= $$0) {
