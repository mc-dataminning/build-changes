...
public abstract class flv {
   ...
   protected abstract void a(fro var1, int var2, int var3, boolean var4);
   ...
   public static void a(fro $$0, List<flv> $$1, frw<?> $$2, int $$3, int $$4, int $$5, int $$6) {
      for (flv $$7 : $$1) {
         if ($$2.a() > $$7.a()) {
            $$7.a($$0, $$3, $$4, $$5, $$6);
         }
   ...
   public static void a(frw<?> $$0, fsy.a<?> $$1, List<flv> $$2, int $$3, double $$4, double $$5) {
