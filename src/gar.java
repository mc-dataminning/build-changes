...
public final class gar {
   ...
   private static final gar c = new gar(HostAndPort.fromParts("server.invalid", 25565));

   public gar(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private gar(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static gar a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new gar($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof gar ? this.b.equals(((gar)$$0).b) : false;
      }
   }
