public abstract class ahq implements zh<agr> {
   ...
   @Override
   public abstract zj<? extends ahq> a();
   ...
   public static class a extends ahq {
      public static final yy<vw, ahq.a> j = zh.a(ahq.a::b, ahq.a::a);

      public a(ffq $$0, boolean $$1, boolean $$2) {
   ...
   public static class b extends ahq {
      public static final yy<vw, ahq.b> j = zh.a(ahq.b::b, ahq.b::a);

      public b(ffq $$0, float $$1, float $$2, boolean $$3, boolean $$4) {
   ...
   public static class c extends ahq {
      public static final yy<vw, ahq.c> j = zh.a(ahq.c::b, ahq.c::a);

      public c(float $$0, float $$1, boolean $$2, boolean $$3) {
         super(0.0, 0.0, 0.0, $$0, $$1, $$2, $$3, false, true);
      }

      private static ahq.c a(vw $$0) {
         float $$1 = $$0.readFloat();
         float $$2 = $$0.readFloat();
   ...
   public static class d extends ahq {
      public static final yy<vw, ahq.d> j = zh.a(ahq.d::b, ahq.d::a);

      public d(boolean $$0, boolean $$1) {
         super(0.0, 0.0, 0.0, 0.0F, 0.0F, $$0, $$1, false, false);
      }

      private static ahq.d a(vw $$0) {
