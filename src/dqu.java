...
public class dqu extends dpi {
   ...
   protected void b(us $$0, jk.a $$1) {
      super.b($$0, $$1);
      if (this.i != null) {
         $$0.a("profile", (vp)cxs.a.encodeStart(vg.a, this.i).getOrThrow());
      }
   ...
   protected void a(us $$0, jk.a $$1) {
      super.a($$0, $$1);
      if ($$0.e("profile")) {
         cxs.a.parse(vg.a, $$0.c("profile")).resultOrPartial($$0x -> e.error("Failed to load profile from player head: {}", $$0x)).ifPresent(this::a);
      }
   ...
   public static void a(dbz $$0, iz $$1, dsd $$2, dqu $$3) {
      if ($$2.b(dmc.a) && $$2.c(dmc.a)) {
         $$3.l = true;
         $$3.k++;
      } else {
         $$3.l = false;
