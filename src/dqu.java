...
public class dqu extends dqr {
   public static final Codec<dqu> d = RecordCodecBuilder.create(
      $$0 -> $$0.group(
   ...
   public dqu(int $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, OptionalInt.empty());
   }

   public dqu(int $$0, int $$1, int $$2, OptionalInt $$3) {
      super($$3);
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
