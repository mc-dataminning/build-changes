...
public class ehj extends ego<eja> {
   public ehj(Codec<eja> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egq<eja> $$0) {
      bam $$1 = $$0.d();
      jh $$2 = $$0.e();
      dhy $$3 = $$0.b();
      eja $$4 = $$0.f();
      ...
      int $$7 = bae.f(((float)$$4.c / 16.0F * 2.0F + 1.0F) / 2.0F);
      ...
      int $$15 = $$2.u() - bae.f($$6) - $$7;
      int $$16 = $$2.v() - 2 - $$7;
      int $$17 = $$2.w() - bae.f($$6) - $$7;
      int $$18 = 2 * (bae.f($$6) + $$7);
      int $$19 = 2 * (2 + $$7);

      for (int $$20 = $$15; $$20 <= $$15 + $$18; $$20++) {
         for (int $$21 = $$17; $$21 <= $$17 + $$18; $$21++) {
            if ($$16 <= $$3.a(edi.a.c, $$20, $$21)) {
   ...
   protected boolean a(
      dhy $$0, bam $$1, eja $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
      ...
      for (int $$19 = 0; $$19 < $$17; $$19++) {
         ...
         double $$21 = bae.d((double)$$20, $$3, $$4);
         double $$22 = bae.d((double)$$20, $$7, $$8);
         double $$23 = bae.d((double)$$20, $$5, $$6);
         double $$24 = $$1.j() * (double)$$17 / 16.0;
         double $$25 = ((double)(bae.a((float) Math.PI * $$20) + 1.0F) * $$24 + 1.0) / 2.0;
         $$18[$$19 * 4 + 0] = $$21;
         $$18[$$19 * 4 + 1] = $$22;
         $$18[$$19 * 4 + 2] = $$23;
         $$18[$$19 * 4 + 3] = $$25;
      ...
      try (dzg $$32 = new dzg($$0)) {
         for (int $$33 = 0; $$33 < $$17; $$33++) {
            ...
            if (!($$34 < 0.0)) {
               ...
               double $$36 = $$18[$$33 * 4 + 1];
               double $$37 = $$18[$$33 * 4 + 2];
               int $$38 = Math.max(bae.a($$35 - $$34), $$9);
               int $$39 = Math.max(bae.a($$36 - $$34), $$10);
               int $$40 = Math.max(bae.a($$37 - $$34), $$11);
               int $$41 = Math.max(bae.a($$35 + $$34), $$38);
               int $$42 = Math.max(bae.a($$36 + $$34), $$39);
               int $$43 = Math.max(bae.a($$37 + $$34), $$40);
   ...
   public static boolean a(dxn $$0, Function<jh, dxn> $$1, bam $$2, eja $$3, eja.a $$4, jh.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
   ...
   protected static boolean a(bam $$0, float $$1) {
      if ($$1 <= 0.0F) {
         return true;
      } else {
