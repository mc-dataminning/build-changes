...
@Deprecated
public class ehj extends egu<ehj.a> {
   private static final dxq a = dkg.nE.m();

   public ehj(Codec<ehj.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egw<ehj.a> $$0) {
      ji $$1 = $$0.e();
      dhy $$2 = $$0.b();
      azh $$3 = $$0.d();
      ehj.a $$4 = $$0.f();
   ...
   public static record a(ekz b, ekz c) implements eiy {
      public static final Codec<ehj.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(ekz.a.fieldOf("fluid").forGetter(ehj.a::a), ekz.a.fieldOf("barrier").forGetter(ehj.a::b)).apply($$0, ehj.a::new)
      );
