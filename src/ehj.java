...
public class ehj extends egw<eit> {
   public ehj(Codec<eit> $$0) {
      super($$0);
   }
   ...
   private void a(bam $$0, dhj $$1, int $$2, int $$3, jh $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, jh $$2, dhj $$3, boolean $$4, double $$5, jh $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dhj $$0, jh $$1) {
      if ($$0.a_($$1.d()).a(dko.ea)) {
         this.a($$0, $$1.d(), dko.a.m());
      }
   }

   private void a(dhj $$0, bam $$1, jh $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dxv $$13) {
   ...
   private void a(jh $$0, dhj $$1, bam $$2, int $$3, int $$4, boolean $$5, boolean $$6, dxv $$7) {
      dxv $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dko.ec) || $$8.a(dko.eb) || $$8.a(dko.J)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dko.J) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dko.ec.m());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private static boolean c(dxv $$0) {
      return $$0.a(dko.iT) || $$0.a(dko.ec) || $$0.a(dko.nr);
   }
   ...
   private void a(dhj $$0, jh $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dko.ea)) {
                  if (this.a((dgn)$$0, $$10)) {
                     this.a($$0, $$10, dko.a.m());
                     this.a($$0, $$10.d(), dko.a.m());
                  } else if (c($$11)) {
                     dxv[] $$12 = new dxv[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
