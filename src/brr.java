...
public abstract class brr extends bre {
   ...
   public brr(bks $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public brr(bks $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(bre.a.a, bre.a.c));
   }
   ...
   protected abstract boolean a(crc var1, ht var2);
}
