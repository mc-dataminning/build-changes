...
public class pv {
   ...
   public qa a(bji $$0, gw $$1, float $$2) {
      return this.h().a(2, () -> {
   ...
   public void c(gw $$0) {
      this.b($$0, $$0x -> $$0x.a(aps.f), () -> "Expected button");
      gw $$1 = this.i($$0);
      dfj $$2 = this.a().a_($$1);
      cte $$3 = (cte)$$2.b();
      $$3.d($$2, this.a(), $$1);
   ...
   public void a(gw $$0, cbu $$1) {
      gw $$2 = this.i($$0);
      this.a($$0, $$1, new ehj(ehn.b($$2), ha.c, $$2, true));
   }
   ...
   public akr e() {
      alf $$0 = alf.a(new GameProfile(UUID.randomUUID(), "test-mock-player"));
      akr $$1 = new akr(this.a().n(), this.a(), $$0.a(), $$0.c()) {
         @Override
         public boolean M_() {
            return false;
         }
   ...
   public void a(cbu $$0, cjf $$1, gw $$2, ha $$3) {
      gw $$4 = this.i($$2.a($$3));
