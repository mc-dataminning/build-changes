...
public class bdk extends bgf {
   public bdk(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bhk.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bhk.D.typeName(), biw.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bhk.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bhk.D.typeName(), "minecraft:saddle"));
