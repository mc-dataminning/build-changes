...
public class fzj extends dvc {
   ...
   public fzj(fzn $$0, int $$1) {
      this.e = $$0;
      this.b = new dve($$0, new dbh(0, 0), $$0.I_().d(li.az).g(ddg.b));
      this.c = new eot(this, true, $$0.E_().g());
      this.d = new fzj.a(b($$1));
   }
   ...
   @Nullable
   public dvi b(int $$0, int $$1, dvx $$2, boolean $$3) {
      if (this.d.b($$0, $$1)) {
   ...
   @Nullable
   public dvi a(int $$0, int $$1, we $$2, uk $$3, Consumer<adi.b> $$4) {
      if (!this.d.b($$0, $$1)) {
         a.warn("Ignoring chunk since it's not in the view range: {}, {}", $$0, $$1);
         return null;
      } else {
         ...
         try (FileOutputStream $$1 = new FileOutputStream($$0)) {
            ...
            for (int $$3 = this.f - $$2; $$3 <= this.f + $$2; $$3++) {
               for (int $$4 = this.e - $$2; $$4 <= this.e + $$2; $$4++) {
                  dvi $$5 = fzj.this.d.b.get(fzj.this.d.a($$4, $$3));
                  if ($$5 != null) {
                     dbh $$6 = $$5.g();
            ...
            fzj.a.error("Failed to dump chunks to file {}", $$0, var10);
         }
      }
   }
}
