...
public abstract class dkk<T extends Comparable<T>> {
   ...
   private final Codec<dkk.a<T>> e = this.d.xmap(this::b, dkk.a::b);

   protected dkk(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dkk.a<T> b(T $$0) {
      return new dkk.a<>(this, $$0);
   }

   public dkk.a<T> a(djj<?, ?> $$0) {
      return new dkk.a<>(this, $$0.c(this));
   }

   public Stream<dkk.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dkk<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends djj<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.a(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dkk<T> a, T b) {
      public a(dkk<T> a, T b) {
         if (!a.a().contains(b)) {
