...
public abstract class bwt<E extends bva> implements bwu<E> {
   public static final int a = 60;
   protected final Map<cee<?>, cef> b;
   private bwt.a c = bwt.a.a;
   private long d;
   private final int e;
   private final int f;

   public bwt(Map<cee<?>, cef> $$0) {
      this($$0, 60);
   }

   public bwt(Map<cee<?>, cef> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public bwt(Map<cee<?>, cef> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<cee<?>, cef> $$1 : this.b.entrySet()) {
         cee<?> $$2 = $$1.getKey();
         cef $$3 = $$1.getValue();
         if (!$$0.ed().a($$2, $$3)) {
            return false;
