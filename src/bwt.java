...
public class bwt extends bwp implements bke<bwt.d>, bzm {
   ...
   private static final aef<Integer> bX = aei.a(bwt.class, aeh.b);
   private static final aef<Integer> bY = aei.a(bwt.class, aeh.b);
   private static final aef<Integer> bZ = aei.a(bwt.class, aeh.b);
   boolean ca;
   @Nullable
   private bwt cb;
   @Nullable
   ...
   protected void b(gw $$0, dfj $$1) {
      this.a(ape.mD, 0.15F, 1.0F);
   }

   @Override
   protected void gd() {
      this.a(ape.my, 1.0F, (this.ag.i() - this.ag.i()) * 0.2F + 1.0F);
   }
   ...
   public static enum d implements asp {
      ...
      private static final IntFunction<bwt.d> f = aqs.a(bwt.d::a, values(), aqs.a.c);
      final int g;
