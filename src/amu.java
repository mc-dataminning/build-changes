...
public class amu {
   ...
   private static final SuggestionProvider<et> g = ($$0, $$1) -> {
      aue $$2 = ((et)$$0.getSource()).l().aF();
      Collection<String> $$3 = $$2.d();
      cqn $$4 = ((et)$$0.getSource()).w();
      return ey.b(
         $$2.c().stream().filter($$1x -> $$1x.e().a($$4)).map(aub::g).filter($$1x -> !$$3.contains($$1x)).map(StringArgumentType::escapeIfRequired), $$1
      );
   };
                     ...
                     eu.a("enable")
                        .then(
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)eu.a(
                                          ...
                                          .suggests(g)
                                          .executes(
                                             $$0x -> a((et)$$0x.getSource(), a($$0x, "name", true), ($$0xx, $$1) -> $$1.k().a($$0xx, $$1, aub::h, false))
                                          ))
                                       .then(
                                          eu.a("after")
                                             .then(
   ...
   private static int a(et $$0, aub $$1, amu.a $$2) throws CommandSyntaxException {
      aue $$3 = $$0.l().aF();
      List<aub> $$4 = Lists.newArrayList($$3.f());
      $$2.apply($$4, $$1);
      $$0.a(() -> xd.a("commands.datapack.modify.enable", $$1.a(true)), true);
      aoi.a($$4.stream().map(aub::g).collect(Collectors.toList()), $$0);
      return $$4.size();
   }

   private static int a(et $$0, aub $$1) {
      aue $$2 = $$0.l().aF();
      List<aub> $$3 = Lists.newArrayList($$2.f());
      $$3.remove($$1);
      $$0.a(() -> xd.a("commands.datapack.modify.disable", $$1.a(true)), true);
      aoi.a($$3.stream().map(aub::g).collect(Collectors.toList()), $$0);
      return $$3.size();
   }
   ...
   private static int b(et $$0) {
      aue $$1 = $$0.l().aF();
      $$1.a();
      Collection<aub> $$2 = $$1.f();
      Collection<aub> $$3 = $$1.c();
      cqn $$4 = $$0.w();
      List<aub> $$5 = $$3.stream().filter($$2x -> !$$2.contains($$2x) && $$2x.e().a($$4)).toList();
      if ($$5.isEmpty()) {
   ...
   private static aub a(CommandContext<et> $$0, String $$1, boolean $$2) throws CommandSyntaxException {
      String $$3 = StringArgumentType.getString($$0, $$1);
      aue $$4 = ((et)$$0.getSource()).l().aF();
      aub $$5 = $$4.c($$3);
      if ($$5 == null) {
         throw a.create($$3);
      } else {
         ...
         if ($$2 && $$6) {
            ...
            cqn $$7 = ((et)$$0.getSource()).w();
            cqn $$8 = $$5.e();
            if (!$$2 && !$$8.b() && $$5.l() == auf.d) {
               throw d.create($$3);
            } else if (!$$8.a($$7)) {
               throw e.create($$3, cqp.a($$7, $$8));
            } else {
               return $$5;
            }
         }
   ...
   interface a {
      void apply(List<aub> var1, aub var2) throws CommandSyntaxException;
   }
}
