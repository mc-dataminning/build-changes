...
public interface dbf extends dcb {
   @Nullable
   dpi c_(iz var1);
   ...
   default evo a(dbh $$0) {
      return a($$0.b(), $$0.a(), $$0, ($$0x, $$1) -> {
         dsd $$2 = this.a_($$1);
         evs $$3 = $$0x.b().d($$0x.a());
         return $$0x.c().test($$2) ? new evo($$0x.a(), je.a($$3.c, $$3.d, $$3.e), iz.a($$0x.a()), false) : null;
      }, $$0x -> {
         evs $$1 = $$0x.b().d($$0x.a());
         return evo.a($$0x.a(), je.a($$1.c, $$1.d, $$1.e), iz.a($$0x.a()));
      });
   }
   ...
   @Nullable
   default evo a(evs $$0, evs $$1, iz $$2, ewl $$3, dsd $$4) {
      evo $$5 = $$3.a($$0, $$1, $$2);
      if ($$5 != null) {
         evo $$6 = $$4.m(this, $$2).a($$0, $$1, $$2);
   ...
   default double a(ewl $$0, Supplier<ewl> $$1) {
      if (!$$0.c()) {
         return $$0.c(je.a.b);
      } else {
   ...
   static <T, C> T a(evs $$0, evs $$1, C $$2, BiFunction<C, iz, T> $$3, Function<C, T> $$4) {
      if ($$0.equals($$1)) {
         return $$4.apply($$2);
      } else {
