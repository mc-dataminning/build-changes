...
public class erj implements erk, erl {
   ...
   private final ewp<MinecraftServer> G;
   ...
   public erj(dda $$0, dzw $$1, erj.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         jd.c,
   ...
   public static <T> erj a(Dynamic<T> $$0, dda $$1, erj.a $$2, dzw $$3, Lifecycle $$4) {
      ...
      return new erj(
         ...
         new ewp<>(ewo.a, $$0.get("ScheduledEvents").asStream()),
