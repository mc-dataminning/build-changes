...
public class erj extends LongLinkedOpenHashSet {
   private final erj.a a;

   public erj(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new erj.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = azn.f(60000000);
      private static final int b = azn.f(60000000);
