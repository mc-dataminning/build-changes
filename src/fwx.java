...
public abstract class fwx extends fwf {
   ...
   public fwx(dwz $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, wv.c("sign.edit"));
   }

   public fwx(dwz $$0, boolean $$1, boolean $$2, wv $$3) {
      super($$3);
      this.a = $$0;
      this.c = $$0.a($$1);
      this.s = $$1;
      this.b = dsa.a($$0.m().b());
      this.d = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(wv::getString).toArray(String[]::new);
   }

   @Override
   protected void aN_() {
      this.c(fqn.a(wu.d, $$0 -> this.F()).a(this.n / 2 - 100, this.o / 4 + 144, 200, 20).a());
      this.w = new fti(() -> this.d[this.v], this::a, fti.a(this.m), fti.c(this.m), $$0 -> this.m.h.b($$0) <= this.a.c());
   }
   ...
   public void aE_() {
      gia $$0 = this.m.L();
      if ($$0 != null) {
         $$0.b(new aik(this.a.aw_(), this.s, this.d[0], this.d[1], this.d[2], this.d[3]));
      }
   }
   ...
   protected abstract void c(fpz var1);
   ...
   private void e(fpz $$0) {
      ...
      Vector3f $$1 = this.m();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : gqe.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.d.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.v && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(goi.N(), $$21, $$7, $$22, $$7 + this.a.a(), -16776961);
            }
         }
      }
   }
