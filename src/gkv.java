...
public class gkv {
   ...
   public void a(dje $$0, @Nullable dje $$1) {
      this.j = $$0;
      this.k = $$1;
   ...
   public boolean a(iv $$0) {
      if (this.b.t.a(this.b.s, $$0, this.j)) {
         ...
         if (!this.b.t.fa().a($$2, $$1, $$0, this.b.t)) {
            ...
            dmm $$3 = $$2.b();
            if ($$3 instanceof dpy && !this.b.t.gF()) {
               return false;
            } else if ($$2.l()) {
               return false;
            } else {
               $$3.a($$1, $$0, $$2, (crj)this.b.t);
               ewv $$4 = $$1.b_($$0);
   ...
   public boolean b(iv $$0, jb $$1) {
      ...
      if (this.h > 0) {
         ...
         if ($$3.l()) {
            ...
            if (this.g % 4.0F == 0.0F) {
               duj $$4 = $$3.A();
               this.b.ak().a(new hnc($$4.f(), awo.e, ($$4.a() + 1.0F) / 8.0F, $$4.b() * 0.5F, hnh.t(), $$0));
            }
   ...
   private boolean b(iv $$0) {
      czk $$1 = this.b.t.fa();
      return $$0.equals(this.d) && czk.c($$1, this.e);
   }
   ...
   public bug a(gpj $$0, buf $$1, fet $$2) {
      this.l();
   ...
   private bug b(gpj $$0, buf $$1, fet $$2) {
      iv $$3 = $$2.b();
      czk $$4 = $$0.b($$1);
      if (this.j == dje.d) {
         return bug.c;
   ...
   public gpj a(gkl $$0, awy $$1, foz $$2) {
      return this.a($$0, $$1, $$2, false, false);
   }

   public gpj a(gkl $$0, awy $$1, foz $$2, boolean $$3, boolean $$4) {
      return new gpj(this.b, $$0, this.c, $$1, $$2, $$3, $$4);
   }

   public void a(crj $$0, bwi $$1) {
      this.l();
   ...
   public bug a(crj $$0, bwi $$1, buf $$2) {
      this.l();
      this.c.b(ahl.a($$1, $$0.cb(), $$2));
      return (bug)(this.j == dje.d ? bug.e : $$0.a($$1, $$2));
   }

   public bug a(crj $$0, bwi $$1, feu $$2, buf $$3) {
      this.l();
      fex $$4 = $$2.g().a($$1.dz(), $$1.dB(), $$1.dF());
      this.c.b(ahl.a($$1, $$0.cb(), $$3, $$4));
      return (bug)(this.j == dje.d ? bug.e : $$1.a($$0, $$4, $$3));
   }

   public void a(int $$0, int $$1, int $$2, cvn $$3, crj $$4) {
      cvc $$5 = $$4.bR;
      if ($$0 != $$5.l) {
         ...
         jo<cwz> $$6 = $$5.k;
         int $$7 = $$6.size();
         List<czk> $$8 = Lists.newArrayListWithCapacity($$7);
         ...
         $$5.a($$1, $$2, $$3, $$4);
         Int2ObjectMap<czk> $$10 = new Int2ObjectOpenHashMap();
   ...
   public void a(int $$0, dfj $$1, boolean $$2) {
   ...
   public void a(czk $$0) {
      boolean $$1 = this.b.z instanceof fzc && !(this.b.z instanceof fzs);
