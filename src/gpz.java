...
public class gpz implements gqc.a, AutoCloseable {
   ...
   fad[] f;
   @Nullable
   private final gpz.a g;
   private final auf h;

   public gpz(akq $$0, grs $$1, fad $$2, auf $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      grq $$4 = $$3.a(grq.a).orElse(grq.e);
   ...
   @Nullable
   private gpz.a a(grs $$0, int $$1, int $$2, grq $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gpz.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gpz.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gpz.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gpz.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gpz.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gpz.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }
   ...
   class a {
      ...
      a(final List<gpz.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gpz.this.c;
         int $$4 = this.b($$2) * gpz.this.d;
         gpz.this.a($$0, $$1, $$3, $$4, gpz.this.f);
      }

      public gqb a() {
         return gpz.this.new d(this, this.d ? gpz.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final fad[] b = new fad[gpz.this.f.length];
      ...
      void a(int $$0, int $$1, gpz.d $$2) {
         ...
         if ($$7 != $$8) {
            ...
            gpz.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gpz.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gpz.this.f[$$2].a($$3 + ($$0.a($$1) * gpz.this.c >> $$2), $$4 + ($$0.b($$1) * gpz.this.d >> $$2));
      }
   ...
   class d implements gqb {
      int a;
      int b;
      final gpz.a c;
      @Nullable
      private final gpz.c d;

      d(final gpz.a $$0, @Nullable final gpz.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
