...
public class bmo extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bmr.a(new Dynamic($$0, $$1), bmo.a, bmr.a);
      }
   };
   ...
   public Type<?> getChoiceType(TypeReference $$0, String $$1) {
      return Objects.equals($$0.typeName(), bhs.s.typeName()) ? super.getChoiceType($$0, bjg.a($$1)) : super.getChoiceType($$0, $$1);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:flower_pot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bhs.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(true, bhs.s, () -> DSL.optionalFields("components", bhs.w.in($$0), DSL.taggedChoiceLazy("id", bjg.a(), $$2)));
      $$0.registerType(
         true,
         bhs.t,
         () -> DSL.hook(
