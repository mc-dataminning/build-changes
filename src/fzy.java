...
public class fzy extends gas<cjc> {
   ...
   public void a(cjc $$0, float $$1, float $$2, esa $$3, fvm $$4, int $$5) {
      $$3.a();
      ...
      $$11.a($$3, $$12, $$5, ggl.d, 1.0F, 1.0F, 1.0F, 1.0F);
      if (!$$0.be()) {
         ese $$13 = $$4.getBuffer(fvu.i());
