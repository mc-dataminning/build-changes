...
public class fzy {
   ...
   private fzy(int $$0, List<gaa> $$1) {
      this.a = $$1.toArray(gaa[]::new);
      this.b = $$1.size();
   }

   private List<gaa> c() {
      List<gaa> $$0 = new ArrayList<>(this.d());
