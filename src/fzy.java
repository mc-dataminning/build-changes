...
public class fzy extends qm {
   private static final Logger b = LogUtils.getLogger();
   private final Map<String, String> c;
   private final boolean d;

   private fzy(Map<String, String> $$0, boolean $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   public static fzy a(anm $$0, List<String> $$1, boolean $$2) {
      ...
      return new fzy(ImmutableMap.copyOf($$3), $$2);
   }
