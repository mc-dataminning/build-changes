public class fzy extends gbf<gws> implements gab {
   private final geh a = this.v.b("head");
   private final geh b = this.v.b("body");
   private final geh c = this.b.b("right_arm");
   private final geh d = this.b.b("left_arm");
   private final geh e = this.b.b("right_wing");
   private final geh f = this.b.b("left_wing");
   ...
   public static gen a() {
      gep $$0 = new gep();
      ger $$1 = $$0.a();
      ger $$2 = $$1.a("root", gem.c(), gej.a(0.0F, 23.5F, 0.0F));
      $$2.a("head", gem.c().a(0, 0).a(-2.5F, -5.0F, -2.5F, 5.0F, 5.0F, 5.0F, new gel(0.0F)), gej.a(0.0F, -3.99F, 0.0F));
      ger $$3 = $$2.a(
         "body",
         gem.c().a(0, 10).a(-1.5F, 0.0F, -1.0F, 3.0F, 4.0F, 2.0F, new gel(0.0F)).a(0, 16).a(-1.5F, 0.0F, -1.0F, 3.0F, 5.0F, 2.0F, new gel(-0.2F)),
         gej.a(0.0F, -4.0F, 0.0F)
      );
      $$3.a("right_arm", gem.c().a(23, 0).a(-0.75F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new gel(-0.01F)), gej.a(-1.75F, 0.5F, 0.0F));
      $$3.a("left_arm", gem.c().a(23, 6).a(-0.25F, -0.5F, -1.0F, 1.0F, 4.0F, 2.0F, new gel(-0.01F)), gej.a(1.75F, 0.5F, 0.0F));
      $$3.a("right_wing", gem.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new gel(0.0F)), gej.a(-0.5F, 0.0F, 0.6F));
      $$3.a("left_wing", gem.c().a(16, 14).a(0.0F, 1.0F, 0.0F, 0.0F, 5.0F, 8.0F, new gel(0.0F)), gej.a(0.5F, 0.0F, 0.6F));
