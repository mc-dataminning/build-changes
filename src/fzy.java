...
public class fzy {
   private static final alr a = alr.b("advancements/title_box");
   ...
   private final ak r;
   private final av s;
   private final List<azk> t;
   private final int u;
   private final List<azk> v;
   private final fqq w;
   @Nullable
   private fzy x;
   private final List<fzy> y = Lists.newArrayList();
   @Nullable
   private al z;
   private final int A;
   private final int B;

   public fzy(fzw $$0, fqq $$1, ak $$2, av $$3) {
      this.q = $$0;
      this.r = $$2;
      this.s = $$3;
      this.w = $$1;
      this.t = $$1.h.c($$3.a(), 163);
      this.A = azz.d($$3.f() * 28.0F);
      this.B = azz.d($$3.g() * 27.0F);
      int $$4 = Math.max(this.t.stream().mapToInt($$1.h::a).max().orElse(0), 80);
      int $$5 = this.e();
      int $$6 = 29 + $$4 + $$5;
      this.v = tv.a().a(this.a(xj.a($$3.b().f(), yd.a.a($$3.e().a())), $$6));
   ...
   private int e() {
      ...
      if ($$0 <= 1) {
         ...
         int $$1 = 8;
         xg $$2 = xg.a("advancements.progress", $$0, $$0);
         return this.w.h.a($$2) + 8;
      }
   }

   private static float a(fra $$0, List<xl> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<xl> a(xg $$0, int $$1) {
      fra $$2 = this.w.h.b();
      List<xl> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : p) {
         List<xl> $$6 = $$2.b($$0, $$1 - $$5, yd.a);
   ...
   public void a(ftk $$0, int $$1, int $$2) {
      if (!this.s.j() || this.z != null && this.z.a()) {
         ...
         $$0.a(gry::H, $$4.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
   ...
   public void a(ftk $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
      fti $$6 = this.w.h;
      ...
      xg $$13 = this.z == null ? null : this.z.d();
      int $$14 = $$13 == null ? 0 : $$6.a($$13);
      boolean $$15 = $$9 + $$11 >= 113;
      float $$16 = this.z == null ? 0.0F : this.z.c();
      int $$17 = azz.d($$16 * (float)this.u);
      fzz $$18;
      fzz $$19;
      fzz $$20;
      if ($$16 >= 1.0F) {
      ...
      if (!this.v.isEmpty()) {
         if ($$15) {
            $$0.a(gry::H, a, $$31, $$9 - $$33, this.u, $$33);
         } else {
            $$0.a(gry::H, a, $$31, $$8, this.u, $$33);
         }
      }

      if ($$18 != $$19) {
         $$0.a(gry::H, $$18.a(), 200, $$7, 0, 0, $$31, $$8, $$17, $$7);
         $$0.a(gry::H, $$19.a(), 200, $$7, 200 - $$30, 0, $$31 + $$17, $$8, $$30, $$7);
      } else {
         $$0.a(gry::H, $$18.a(), $$31, $$8, this.u, $$7);
      }

      $$0.a(gry::H, $$20.a(this.s.e()), $$1 + this.A + 3, $$2 + this.B, 26, 26);
      int $$34 = $$31 + 5;
      if ($$12) {
   ...
   private void a(ftk $$0, List<azk> $$1, int $$2, int $$3, int $$4) {
      fti $$5 = this.w.h;
