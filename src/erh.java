...
public class erh {
   ...
   public void a(erh.b $$0, List<amj> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new erh.c($$0, $$1.stream().map(amj::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new erh.c(erh.b.c, ImmutableList.of());
      }

      this.b.c = new erh.a($$0);
   }
