...
public class erh implements eri, erj {
   ...
   private final ewn<MinecraftServer> G;
   ...
   public erh(dda $$0, dzw $$1, erh.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         jd.c,
   ...
   public static <T> erh a(Dynamic<T> $$0, dda $$1, erh.a $$2, dzw $$3, Lifecycle $$4) {
      long $$5 = $$0.get("Time").asLong(0L);
      return new erh(
         (ub)$$0.get("Player").flatMap(ub.a::parse).result().orElse(null),
         ...
         new ewn<>(ewm.a, $$0.get("ScheduledEvents").asStream()),
         (ub)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dxb.a.a).resultOrPartial(f::error).orElse(dxb.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   @Override
   public ub a(ka $$0, @Nullable ub $$1) {
      if ($$1 == null) {
         $$1 = this.o;
      }
   ...
   private void a(ka $$0, ub $$1, @Nullable ub $$2) {
      ...
      $$1.a("Version", $$3);
      uq.e($$1);
      DynamicOps<uy> $$4 = $$0.a(up.a);
      dzu.a($$4, this.h, $$0).resultOrPartial(ad.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", (uy)dxb.a.a.encodeStart(up.a, this.y).getOrThrow());
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      ddr.b.encodeStart(up.a, this.g.g()).ifSuccess($$1x -> $$1.a((ub)$$1x)).ifError($$0x -> f.warn("Failed to encode configuration {}", $$0x.message()));
      if (this.z != null) {
   ...
   private static uh a(Set<String> $$0) {
      uh $$1 = new uh();
      $$0.stream().map(uw::a).forEach($$1::add);
      return $$1;
   }
   ...
   @Override
   public boolean z() {
      return this.i == erh.a.b;
   }

   @Override
   public boolean A() {
      return this.i == erh.a.c;
   }
