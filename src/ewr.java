...
public class ewr implements ewm {
   protected static final ewm a = new ewr(false, -Double.MAX_VALUE, cud.l, $$0 -> false, null) {
      @Override
      public boolean a(exa $$0, ja $$1, boolean $$2) {
         return $$2;
      }
   };
   ...
   protected ewr(boolean $$0, double $$1, cud $$2, Predicate<eoj> $$3, @Nullable bsh $$4) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   protected ewr(bsh $$0) {
      ...
      // 00: aload 0
      // 01: aload 1
      // 02: invokevirtual bsh.cb ()Z
      // 05: aload 1
      // 06: invokevirtual bsh.dy ()D
      // 09: aload 1
      // 0a: instanceof btc
      // 0d: ifeq 1a
      // 10: aload 1
      // 11: checkcast btc
      // 14: invokevirtual btc.eV ()Lcud;
      // 17: goto 1d
      // 1a: getstatic cud.l Lcud;
      // 1d: aload 1
      // 1e: instanceof btc
      // 21: ifeq 35
      // 24: aload 1
      ...
      // 2c: pop
      // 2d: invokedynamic test (Lbtc;)Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, btc.a (Leoj;)Z, (Leoj;)Z ]
      // 32: goto 3a
      // 35: invokedynamic test ()Ljava/util/function/Predicate; bsm=java/lang/invoke/LambdaMetafactory.metafactory (Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodType;Ljava/lang/invoke/MethodHandle;Ljava/lang/invoke/MethodType;)Ljava/lang/invoke/CallSite; args=[ (Ljava/lang/Object;)Z, ewr.a (Leoj;)Z, (Leoj;)Z ]
      // 3a: aload 1
      // 3b: invokespecial ewr.<init> (ZDLcud;Ljava/util/function/Predicate;Lbsh;)V
      // 3e: return
   }
