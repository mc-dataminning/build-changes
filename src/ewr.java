...
public class ewr extends eya {
   ...
   protected void aC_() {
      ...
      this.b = new esp(this.f.i, 4, this.h - 12, this.g - 4, 12, tf.c("chat.editBox")) {
         @Override
         protected ts az_() {
            return super.az_().b(ewr.this.o.c());
         }
      };
      this.b.l(256);
      this.b.d(false);
      ...
      this.b.f(false);
      this.e(this.b);
      this.o = new esj(this.f, this, this.b, this.i, false, false, 1, 10, true, -805306368);
      this.o.b();
      this.c(this.b);
   }
   ...
   public void a(erv $$0, int $$1, int $$2, float $$3) {
      ...
      super.a($$0, $$1, $$2, $$3);
      this.o.a($$0, $$1, $$2);
      eqg $$4 = this.f.l.d().c((double)$$1, (double)$$2);
      if ($$4 != null && $$4.g() != null) {
   ...
   protected void a(evy $$0) {
      ...
      String $$1 = this.b.a();
      if (!$$1.isEmpty()) {
         $$0.a().a(evx.a, tf.a("chat_screen.message", $$1));
      }
   }
