...
public class ewr {
   ...
   private final exm ah;
   private final eym ai;
   private final ezc aj;
   private final eyf ak;
   private final exd al;
   private int am;
   @Nullable
   private vf an;
   @Nullable
   ...
   public ewr(evg $$0, fzj $$1) {
      this.X = $$0;
      this.Y = $$1;
      this.ah = new exm($$0);
      this.aj = new ezc($$0);
      this.Z = new exf($$0);
      this.ak = new eyf($$0, this);
      this.al = new exd($$0);
      this.ai = new eym($$0);
      this.a();
   }
   ...
   public void a(ews $$0, float $$1) {
      ...
      if (this.X.s.fW() > 0) {
         ...
         $$0.a(ftn.C(), 0, 0, this.aw, this.ax, $$11);
         this.X.aG().c();
      }
   ...
   private void a(ews $$0, ewq $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$1.ax().a()) {
         if (this.X.q.l() != ctl.d || this.a(this.X.v)) {
            if (this.ah.d() && !this.X.s.gi() && !$$1.S().c()) {
               eur $$2 = this.X.j.m();
               epz $$3 = RenderSystem.getModelViewStack();
               $$3.a();
               $$3.a($$0.c().c().a());
   ...
   protected void a(ews $$0) {
      ...
      if (!$$1.isEmpty()) {
         if (this.X.y instanceof feq $$2 && $$2.I()) {
            return;
         }
   ...
   public void a(bmv $$0, ews $$1, int $$2) {
      this.X.aG().a("jumpBar");
      float $$3 = this.X.s.u();
      int $$4 = 182;
      int $$5 = (int)($$3 * 183.0F);
   ...
   public void c(ews $$0) {
      ...
      if (this.X.r.X() >= 120500L) {
         ...
         $$1 = vf.a("demo.remainingTime", avk.a((int)(120500L - this.X.r.X())));
      }
   ...
   private void a(ews $$0, cfh $$1, int $$2, int $$3, int $$4, int $$5, float $$6, int $$7, int $$8, int $$9, boolean $$10) {
      ewr.b $$11 = ewr.b.a($$1);
      ...
      for (int $$16 = $$13 + $$14 - 1; $$16 >= 0; $$16--) {
         ...
         this.a($$0, ewr.b.a, $$19, $$20, $$12, $$10, false);
         int $$21 = $$16 * 2;
         boolean $$22 = $$16 >= $$13;
         if ($$22) {
            int $$23 = $$21 - $$15;
            if ($$23 < $$9) {
               boolean $$24 = $$23 + 1 == $$9;
               this.a($$0, $$11 == ewr.b.d ? $$11 : ewr.b.e, $$19, $$20, $$12, false, $$24);
            }
         }
   ...
   private void a(ews $$0, ewr.b $$1, int $$2, int $$3, boolean $$4, boolean $$5, boolean $$6) {
      $$0.a($$1.a($$4, $$6, $$5), $$2, $$3, 9, 9);
   }

   private void f(ews $$0) {
      bmk $$1 = this.n();
      if ($$1 != null) {
         int $$2 = this.a($$1);
         if ($$2 != 0) {
   ...
   private void a(ews $$0, ahg $$1, float $$2) {
   ...
   private void b(ews $$0, float $$1) {
      ...
      $$0.a(ftn.C(), 0, $$10, this.aw, this.ax, -90, -16777216);
      $$0.a(ftn.C(), 0, 0, this.aw, $$8, -90, -16777216);
      $$0.a(ftn.C(), 0, $$8, $$7, $$10, -90, -16777216);
      $$0.a(ftn.C(), $$9, $$8, this.aw, $$10, -90, -16777216);
   }

   private void a(blu $$0) {
      hx $$1 = hx.a($$0.dr(), $$0.dv(), $$0.dx());
      float $$2 = fte.a($$0.dM().E_(), $$0.dM().A($$1));
      float $$3 = aun.a(1.0F - $$2, 0.0F, 1.0F);
      this.a = this.a + ($$3 - this.a) * 0.01F;
   }

   private void a(ews $$0, @Nullable blu $$1) {
      dkx $$2 = this.X.r.D_();
      float $$3 = 0.0F;
      if ($$1 != null) {
         float $$4 = (float)$$2.a($$1);
   ...
   private void a(ews $$0, int $$1, int $$2, float $$3, cfh $$4, cmx $$5, int $$6) {
      if (!$$5.b()) {
         float $$7 = (float)$$5.K() - $$3;
         if ($$7 > 0.0F) {
            float $$8 = 1.0F + $$7 / 5.0F;
