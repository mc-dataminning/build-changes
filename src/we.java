...
public class we extends ByteBuf {
   ...
   @Deprecated
   public <T> T a(DynamicOps<vg> $$0, Codec<T> $$1) {
      return this.a($$0, $$1, us.a());
   }

   @Deprecated
   public <T> T a(DynamicOps<vg> $$0, Codec<T> $$1, us $$2) {
      vg $$3 = this.a($$2);
      return (T)$$1.parse($$0, $$3).getOrThrow($$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> we a(DynamicOps<vg> $$0, Codec<T> $$1, T $$2) {
      vg $$3 = (vg)$$1.encodeStart($$0, $$2).getOrThrow($$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = ayz.a(h, this.p(), JsonElement.class);
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zg<? super we, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, zh<? super we, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zg<? super we, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zg<? super we, K> $$1, zg<? super we, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zg<? super we, K> $$0, zg<? super we, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, zh<? super we, K> $$1, zh<? super we, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, zh<? super we, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zg<? super we, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(zg<? super we, T> $$0) {
      return a(this, $$0);
   }

   @Nullable
   public static <T, B extends ByteBuf> T a(B $$0, zg<? super B, T> $$1) {
      return $$0.readBoolean() ? $$1.decode($$0) : null;
   }

   public <T> void a(@Nullable T $$0, zh<? super we, T> $$1) {
      a(this, $$0, $$1);
   }

   public static <T, B extends ByteBuf> void a(B $$0, @Nullable T $$1, zh<? super B, T> $$2) {
      if ($$1 != null) {
         $$0.writeBoolean(true);
         $$2.encode($$0, $$1);
      } else {
   ...
   public static jg b(ByteBuf $$0) {
      return jg.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, jg $$1) {
      $$0.writeLong($$1.a());
   }

   public deb f() {
      return new deb(this.readLong());
   }
   ...
   public static ezh e(ByteBuf $$0) {
      return new ezh($$0.readDouble(), $$0.readDouble(), $$0.readDouble());
   }
   ...
   public static void a(ByteBuf $$0, ezh $$1) {
      $$0.writeDouble($$1.a());
      $$0.writeDouble($$1.b());
      $$0.writeDouble($$1.c());
   }
   ...
   public we a(@Nullable vg $$0) {
      a(this, $$0);
      return this;
   }

   public static void a(ByteBuf $$0, @Nullable vg $$1) {
      if ($$1 == null) {
         $$1 = ul.b;
      }

      try {
         uw.a($$1, new ByteBufOutputStream($$0));
   ...
   @Nullable
   public static uj g(ByteBuf $$0) {
      vg $$1 = a($$0, us.a(2097152L));
      if ($$1 != null && !($$1 instanceof uj)) {
   ...
   @Nullable
   public static vg a(ByteBuf $$0, us $$1) {
      try {
         vg $$2 = uw.b(new ByteBufInputStream($$0), $$1);
         return $$2.b() == 0 ? null : $$2;
      } catch (IOException var3) {
         throw new EncoderException(var3);
      }
   ...
   public <T> alg<T> a(alg<? extends kc<T>> $$0) {
      alh $$1 = this.q();
      return alg.a($$0, $$1);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, azj.e($$1, 8)));
      }
   }
   ...
   public we j(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public we d(ByteBuf $$0, int $$1) {
