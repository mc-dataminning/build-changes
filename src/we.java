...
public class we extends SimpleChannelInboundHandler<zr<?>> {
   ...
   private static final ws<aji> j = ajh.b;
   private final zs k;
   private volatile boolean l = true;
   private final Queue<Consumer<we>> m = Queues.newConcurrentLinkedQueue();
   private Channel n;
   private SocketAddress o;
   @Nullable
   private volatile wq p;
   @Nullable
   private volatile wq q;
   @Nullable
   private wg r;
   private boolean s;
   private boolean t;
   ...
   public void channelInactive(ChannelHandlerContext $$0) {
      this.a(xk.c("disconnect.endOfStream"));
   }
      ...
      if ($$1 instanceof wx) {
         ...
         if (this.n.isOpen()) {
            if ($$1 instanceof TimeoutException) {
               i.debug("Timeout", $$1);
               this.a(xk.c("disconnect.timeout"));
            } else {
               xk $$3 = xk.a("disconnect.genericReason", "Internal Exception: " + $$1);
               wq $$4 = this.q;
               wg $$5;
               if ($$4 != null) {
                  $$5 = $$4.a($$3, $$1);
               ...
               if ($$2) {
                  ...
                  if (this.g() == zs.b) {
                     zr<?> $$7 = (zr<?>)(this.l ? new ajo($$3) : new aaa($$3));
                     this.a($$7, wr.a(() -> this.a($$5)));
                  } else {
                     this.a($$5);
                  }
   ...
   protected void a(ChannelHandlerContext $$0, zr<?> $$1) {
      if (this.n.isOpen()) {
         wq $$2 = this.q;
         if ($$2 == null) {
            ...
            if ($$2.a($$1)) {
               try {
                  ...
                  this.a(xk.c("multiplayer.disconnect.server_shutdown"));
               } catch (ClassCastException var7) {
                  i.error("Received {} that couldn't be processed", $$1.getClass(), var7);
                  this.a(xk.c("multiplayer.disconnect.invalid_packet"));
               }
   ...
   private static <T extends wq> void a(zr<T> $$0, wq $$1) {
      $$0.a((T)$$1);
   }

   private void b(ws<?> $$0, wq $$1) {
   ...
   public <T extends wq> void a(ws<T> $$0, T $$1) {
      this.b($$0, $$1);
      if ($$0.b() != this.f()) {
   ...
   public void a(wq $$0) {
      ...
      } else if (this.k == zs.a && $$0.a() == zs.a && $$0.b() == j.a()) {
         this.q = $$0;
      } else {
   ...
   public void a(String $$0, int $$1, akk $$2) {
      this.a($$0, $$1, akq.b, akq.d, $$2, aje.a);
   }

   public void a(String $$0, int $$1, ajk $$2) {
      this.a($$0, $$1, ajr.b, ajr.d, $$2, aje.b);
   }

   public <S extends ww, C extends wb> void a(String $$0, int $$1, ws<S> $$2, ws<C> $$3, C $$4, boolean $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5 ? aje.c : aje.b);
   }

   private <S extends ww, C extends wb> void a(String $$0, int $$1, ws<S> $$2, ws<C> $$3, C $$4, aje $$5) {
      if ($$2.a() != $$3.a()) {
         throw new IllegalStateException("Mismatched initial protocols");
      } else {
         this.p = $$4;
         this.a((Consumer<we>)($$6 -> {
            this.a($$3, $$4);
            $$6.b(new ajf(ab.b().e(), $$0, $$1, $$5), null, true);
            this.a($$2);
         }));
      }
   }
   ...
   public void a(zr<?> $$0, @Nullable wr $$1) {
      this.a($$0, $$1, true);
   }

   public void a(zr<?> $$0, @Nullable wr $$1, boolean $$2) {
      if (this.i()) {
         this.r();
         this.b($$0, $$1, $$2);
      } else {
   ...
   private void b(zr<?> $$0, @Nullable wr $$1, boolean $$2) {
      this.v++;
   ...
   private void c(zr<?> $$0, @Nullable wr $$1, boolean $$2) {
   ...
   protected void c() {
      this.x = azu.h(0.75F, (float)this.v, this.x);
      this.w = azu.h(0.75F, (float)this.u, this.w);
      this.v = 0;
      this.u = 0;
   }
   ...
   public static we a(InetSocketAddress $$0, boolean $$1, @Nullable bnt $$2) {
      we $$3 = new we(zs.b);
      if ($$2 != null) {
         $$3.a($$2);
      }
   ...
   public static ChannelFuture a(InetSocketAddress $$0, boolean $$1, final we $$2) {
   ...
   public static void a(ChannelPipeline $$0, zs $$1, boolean $$2, @Nullable vx $$3) {
      zs $$4 = $$1.a();
      boolean $$5 = $$1 == zs.a;
      boolean $$6 = $$4 == zs.a;
      $$0.addLast("splitter", a($$3, $$2))
         .addLast(new ChannelHandler[]{new FlowControlHandler()})
         .addLast(c($$5), (ChannelHandler)($$5 ? new wo<aji>(j) : new wz.a()))
         .addLast("prepender", d($$2))
         .addLast(b($$6), (ChannelHandler)($$6 ? new wp<aji>(j) : new wz.c()));
   }

   private static ChannelOutboundHandler d(boolean $$0) {
      return (ChannelOutboundHandler)($$0 ? new wl() : new xe());
   }

   private static ChannelInboundHandler a(@Nullable vx $$0, boolean $$1) {
      if (!$$1) {
         return new xd($$0);
      } else {
         return (ChannelInboundHandler)($$0 != null ? new wj($$0) : new wk());
      }
   }

   public static void a(ChannelPipeline $$0, zs $$1) {
      a($$0, $$1, true, null);
   }

   public static we a(SocketAddress $$0) {
      final we $$1 = new we(zs.b);
   ...
   public void a(Cipher $$0, Cipher $$1) {
      this.s = true;
      this.n.pipeline().addBefore("splitter", "decrypt", new vz($$0));
      this.n.pipeline().addBefore("prepender", "encrypt", new wa($$1));
   }
   ...
   public void a(int $$0, boolean $$1) {
      if ($$0 >= 0) {
         if (this.n.pipeline().get("decompress") instanceof wc $$2) {
            $$2.a($$0, $$1);
         } else {
            this.n.pipeline().addAfter("splitter", "decompress", new wc($$0, $$1));
         }

         if (this.n.pipeline().get("compress") instanceof wd $$3) {
            $$3.a($$0);
         } else {
            this.n.pipeline().addAfter("prepender", "compress", new wd($$0));
         }
      } else {
         if (this.n.pipeline().get("decompress") instanceof wc) {
            this.n.pipeline().remove("decompress");
         }

         if (this.n.pipeline().get("compress") instanceof wd) {
   ...
   public void n() {
      if (this.n != null && !this.n.isOpen()) {
         if (this.t) {
            ...
            this.t = true;
            wq $$0 = this.k();
            wq $$1 = $$0 != null ? $$0 : this.p;
            if ($$1 != null) {
               wg $$2 = Objects.requireNonNullElseGet(this.l(), () -> new wg(xk.c("multiplayer.disconnect.generic")));
               $$1.a($$2);
            }
         }
      }
