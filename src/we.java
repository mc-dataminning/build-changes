...
public class we extends ByteBuf {
   ...
   public <T> T a(DynamicOps<vh> $$0, Codec<T> $$1, ut $$2) {
      vh $$3 = this.a($$2);
      return ad.a($$1.parse($$0, $$3), $$1x -> new DecoderException("Failed to decode: " + $$1x + " " + $$3));
   }

   @Deprecated
   public <T> we a(DynamicOps<vh> $$0, Codec<T> $$1, T $$2) {
      vh $$3 = ad.a($$1.encodeStart($$0, $$2), $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$2));
      this.a($$3);
      return this;
   }

   public <T> T a(Codec<T> $$0) {
      JsonElement $$1 = ayc.a(h, this.p(), JsonElement.class);
      DataResult<T> $$2 = $$0.parse(JsonOps.INSTANCE, $$1);
      return ad.a($$2, $$0x -> new DecoderException("Failed to decode json: " + $$0x));
   }

   public <T> void a(Codec<T> $$0, T $$1) {
      DataResult<JsonElement> $$2 = $$0.encodeStart(JsonOps.INSTANCE, $$1);
      this.a(h.toJson(ad.a($$2, $$1x -> new EncoderException("Failed to encode: " + $$1x + " " + $$1))));
   }
   ...
   public <T, C extends Collection<T>> C a(IntFunction<C> $$0, zd<? super we, T> $$1) {
      int $$2 = this.l();
      C $$3 = (C)$$0.apply($$2);
   ...
   public <T> void a(Collection<T> $$0, ze<? super we, T> $$1) {
      this.c($$0.size());
   ...
   public <T> List<T> a(zd<? super we, T> $$0) {
   ...
   public <K, V, M extends Map<K, V>> M a(IntFunction<M> $$0, zd<? super we, K> $$1, zd<? super we, V> $$2) {
      int $$3 = this.l();
      M $$4 = (M)$$0.apply($$3);
   ...
   public <K, V> Map<K, V> a(zd<? super we, K> $$0, zd<? super we, V> $$1) {
      return this.a(Maps::newHashMapWithExpectedSize, $$0, $$1);
   }

   public <K, V> void a(Map<K, V> $$0, ze<? super we, K> $$1, ze<? super we, V> $$2) {
      this.c($$0.size());
      $$0.forEach(($$2x, $$3) -> {
         $$1.encode(this, (K)$$2x);
         $$2.encode(this, (V)$$3);
   ...
   public <T> void a(Optional<T> $$0, ze<? super we, T> $$1) {
      if ($$0.isPresent()) {
         this.a(true);
         $$1.encode(this, $$0.get());
      } else {
   ...
   public <T> Optional<T> b(zd<? super we, T> $$0) {
      return this.readBoolean() ? Optional.of($$0.decode(this)) : Optional.empty();
   }

   @Nullable
   public <T> T c(zd<? super we, T> $$0) {
      return a(this, $$0);
   }
   ...
   public <T> void a(@Nullable T $$0, ze<? super we, T> $$1) {
      a(this, $$0, $$1);
   }
   ...
   public static ir b(ByteBuf $$0) {
      return ir.d($$0.readLong());
   }
   ...
   public static void a(ByteBuf $$0, ir $$1) {
      $$0.writeLong($$1.a());
   }

   public dbh f() {
      return new dbh(this.readLong());
   }
   ...
   public ewu k() {
      return new ewu(this.readDouble(), this.readDouble(), this.readDouble());
   }
   ...
   public <T> we a(ToIntFunction<T> $$0, T $$1) {
   ...
   public we a(String $$0, int $$1) {
      wu.a(this.d, $$0, $$1);
      return this;
   }

   public akt q() {
      return new akt(this.d(32767));
   }
   ...
   public <T> aks<T> a(aks<? extends jn<T>> $$0) {
      akt $$1 = this.q();
      return aks.a($$0, $$1);
   }
   ...
   public ewq v() {
      ir $$0 = this.e();
      iw $$1 = this.b(iw.class);
      float $$2 = this.readFloat();
      float $$3 = this.readFloat();
      float $$4 = this.readFloat();
      boolean $$5 = this.readBoolean();
      return new ewq(new ewu((double)$$0.u() + (double)$$2, (double)$$0.v() + (double)$$3, (double)$$0.w() + (double)$$4), $$1, $$0, $$5);
   }
   ...
   public void a(BitSet $$0, int $$1) {
      if ($$0.length() > $$1) {
         ...
         this.c(Arrays.copyOf($$2, aym.e($$1, 8)));
      }
   }
   ...
   public we a(int $$0, ByteBuf $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public we a(int $$0, ByteBuf $$1, int $$2) {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }

   public we a(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public we a(int $$0, byte[] $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public we a(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.getBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public we a(int $$0, ByteBuffer $$1) {
      this.d.getBytes($$0, $$1);
      return this;
   }

   public we a(int $$0, OutputStream $$1, int $$2) throws IOException {
      this.d.getBytes($$0, $$1, $$2);
      return this;
   }
   ...
   public we a(int $$0, boolean $$1) {
      this.d.setBoolean($$0, $$1);
      return this;
   }

   public we b(int $$0, int $$1) {
      this.d.setByte($$0, $$1);
      return this;
   }

   public we c(int $$0, int $$1) {
      this.d.setShort($$0, $$1);
      return this;
   }

   public we d(int $$0, int $$1) {
      this.d.setShortLE($$0, $$1);
      return this;
   }

   public we e(int $$0, int $$1) {
      this.d.setMedium($$0, $$1);
      return this;
   }

   public we f(int $$0, int $$1) {
      this.d.setMediumLE($$0, $$1);
      return this;
   }

   public we g(int $$0, int $$1) {
      this.d.setInt($$0, $$1);
      return this;
   }

   public we h(int $$0, int $$1) {
      this.d.setIntLE($$0, $$1);
      return this;
   }

   public we a(int $$0, long $$1) {
      this.d.setLong($$0, $$1);
      return this;
   }

   public we b(int $$0, long $$1) {
      this.d.setLongLE($$0, $$1);
      return this;
   }

   public we i(int $$0, int $$1) {
      this.d.setChar($$0, $$1);
      return this;
   }

   public we a(int $$0, float $$1) {
      this.d.setFloat($$0, $$1);
      return this;
   }

   public we a(int $$0, double $$1) {
      this.d.setDouble($$0, $$1);
      return this;
   }

   public we b(int $$0, ByteBuf $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public we b(int $$0, ByteBuf $$1, int $$2) {
      this.d.setBytes($$0, $$1, $$2);
      return this;
   }

   public we b(int $$0, ByteBuf $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public we b(int $$0, byte[] $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }

   public we b(int $$0, byte[] $$1, int $$2, int $$3) {
      this.d.setBytes($$0, $$1, $$2, $$3);
      return this;
   }

   public we b(int $$0, ByteBuffer $$1) {
      this.d.setBytes($$0, $$1);
      return this;
   }
   ...
   public we g(ByteBuf $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public we b(ByteBuf $$0, int $$1) {
      this.d.readBytes($$0, $$1);
      return this;
   }

   public we a(ByteBuf $$0, int $$1, int $$2) {
   ...
   public we a(byte[] $$0, int $$1, int $$2) {
      this.d.readBytes($$0, $$1, $$2);
      return this;
   }

   public we a(ByteBuffer $$0) {
      this.d.readBytes($$0);
      return this;
   }

   public we a(OutputStream $$0, int $$1) throws IOException {
      this.d.readBytes($$0, $$1);
      return this;
   }
   ...
   public we a(double $$0) {
      this.d.writeDouble($$0);
      return this;
   }

   public we h(ByteBuf $$0) {
      this.d.writeBytes($$0);
      return this;
   }

   public we c(ByteBuf $$0, int $$1) {
      this.d.writeBytes($$0, $$1);
      return this;
   }

   public we b(ByteBuf $$0, int $$1, int $$2) {
   ...
   public we b(byte[] $$0, int $$1, int $$2) {
      this.d.writeBytes($$0, $$1, $$2);
      return this;
   }

   public we b(ByteBuffer $$0) {
      this.d.writeBytes($$0);
      return this;
   }
