...
public class ejn extends ejt<elv> {
   public ejn(Codec<elv> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejv<elv> $$0) {
      dkg $$1 = $$0.b();
      iv $$2 = $$0.e();
      elv $$3 = $$0.f();
      azv $$4 = $$0.d();
   ...
   private void a(dkg $$0, azv $$1, iv $$2, int $$3, int $$4, float $$5, double $$6, int $$7, float $$8, elv $$9) {
      Optional<egd> $$10 = egd.a($$0, $$2, $$9.b, ejo::c, ejo::d);
      if (!$$10.isEmpty()) {
         ...
         if (!$$11.isEmpty() || !$$12.isEmpty()) {
            ...
            boolean $$18 = $$1.j() < $$6;
            int $$22;
            if ($$11.isPresent() && $$18 && !this.a((djk)$$0, $$2.h($$11.getAsInt()))) {
               int $$19 = $$9.g.a($$1);
            ...
            boolean $$24 = $$1.j() < $$6;
            int $$26;
            if ($$17.isPresent() && $$24 && !this.a((djk)$$0, $$2.h($$17.getAsInt()))) {
               int $$25 = $$9.g.a($$1);
            ...
            if ($$11.isPresent()) {
               ejo.a($$0, $$2.h($$11.getAsInt() - 1), jb.a, $$35, $$39);
            }

            if ($$17.isPresent()) {
               ejo.a($$0, $$2.h($$17.getAsInt() + 1), jb.b, $$36, $$39);
            }
         }
      }
   }
   ...
   private boolean a(djk $$0, iv $$1) {
      return $$0.a_($$1).a(dmo.K);
   }

   private int a(azv $$0, int $$1, int $$2, float $$3, int $$4, elv $$5) {
      if ($$0.i() > $$3) {
         return 0;
      } else {
   ...
   private boolean b(dkg $$0, iv $$1) {
      eao $$2 = $$0.a_($$1);
      if (!$$2.a(dmo.J) && !$$2.a(dmo.tc) && !$$2.a(dmo.tb)) {
         if ($$0.a_($$1.d()).y().a(axh.a)) {
            return false;
         } else {
            for (jb $$3 : jb.c.a) {
               if (!this.a((dji)$$0, $$1.a($$3))) {
                  return false;
               }
            }

            return this.a((dji)$$0, $$1.e());
         }
      } else {
         return false;
      }
   ...
   private void a(dkg $$0, iv $$1, int $$2, jb $$3) {
      iv.a $$4 = $$1.k();
   ...
   private double a(int $$0, int $$1, int $$2, int $$3, elv $$4) {
      int $$5 = $$0 - Math.abs($$2);
      int $$6 = $$1 - Math.abs($$3);
      int $$7 = Math.min($$5, $$6);
