...
public class ghc extends avb<ghc.a> {
   ...
   protected ghc.a a(auv $$0, bog $$1) {
      ...
      $$1.b();
      return new ghc.a($$2, $$3, $$4);
   }

   protected void a(ghc.a $$0, auv $$1, bog $$2) {
      this.c = $$0.a();
   }
   ...
   @Nullable
   private static JsonObject c(auv $$0, bog $$1) {
      $$1.a("parse_json");
      JsonObject $$2 = null;
   ...
   protected static final class a {
      ...
      ImmutableMap<String, String> a() {
         ...
         String $$1 = a(this.a, fcb.c());
         if (!$$1.isEmpty()) {
            $$0.put("renderer", $$1);
         }

         String $$2 = a(this.b, fcb.d());
         if (!$$2.isEmpty()) {
            $$0.put("version", $$2);
         }

         String $$3 = a(this.c, fcb.a());
         if (!$$3.isEmpty()) {
            $$0.put("vendor", $$3);
         }
