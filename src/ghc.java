...
public class ghc extends ggx<ccx, fru<ccx>> {
   private static final Map<ccx.a, ajv> a = ac.a(Maps.newEnumMap(ccx.a.class), $$0 -> {
      $$0.put(ccx.a.a, new ajv("textures/entity/panda/panda.png"));
      $$0.put(ccx.a.b, new ajv("textures/entity/panda/lazy_panda.png"));
      $$0.put(ccx.a.c, new ajv("textures/entity/panda/worried_panda.png"));
      $$0.put(ccx.a.d, new ajv("textures/entity/panda/playful_panda.png"));
      $$0.put(ccx.a.e, new ajv("textures/entity/panda/brown_panda.png"));
      $$0.put(ccx.a.f, new ajv("textures/entity/panda/weak_panda.png"));
      $$0.put(ccx.a.g, new ajv("textures/entity/panda/aggressive_panda.png"));
   });

   public ghc(gfr.a $$0) {
      super($$0, new fru<>($$0.a(ftu.aF)), 0.9F);
      this.a(new gjy(this, $$0.d()));
   }

   public ajv a(ccx $$0) {
      return a.getOrDefault($$0.gz(), a.get(ccx.a.a));
   }

   protected void a(ccx $$0, ewr $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.bY > 0) {
         int $$6 = $$0.bY;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(axm.i($$25, $$0.dE(), $$0.dE() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(axm.i($$27, $$0.dE(), $$0.dE() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? axm.i($$3, $$0, $$1) : $$0;
   }
}
