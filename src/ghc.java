...
public final class ghc {
   ...
   private static final ghc c = new ghc(HostAndPort.fromParts("server.invalid", 25565));

   public ghc(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private ghc(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static ghc a(String $$0) {
      if ($$0 == null) {
         ...
         try {
            ...
            return $$1.getHost().isEmpty() ? c : new ghc($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof ghc ? this.b.equals(((ghc)$$0).b) : false;
      }
   }
