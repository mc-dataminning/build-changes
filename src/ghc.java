...
public enum ghc implements ghj {
   a(0, 0),
   b(0, 90),
   c(0, 180),
   d(0, 270),
   ...
   private static final Map<Integer, ghc> r = Arrays.stream(values()).collect(Collectors.toMap($$0 -> $$0.u, $$0 -> (ghc)$$0));
   private final j s;
   private final h t;
   private final int u;
   ...
   public static ghc a(int $$0, int $$1) {
      return r.get(b(aup.b($$0, 360), aup.b($$1, 360)));
   }
