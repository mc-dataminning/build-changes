...
public abstract class dwp {
   public static final Codec<dwp> e = jb.ai.q().dispatch("element_type", dwp::a, dwq::codec);
   private static final he<dyz> a = he.a(new dyz(List.of()));
   @Nullable
   ...
   public abstract hy a(dzc var1, czh var2);
   ...
   public static Function<dwr.a, dwm> a(String $$0) {
      return $$1 -> new dwm(Either.left(new aew($$0)), a, $$1);
   }

   public static Function<dwr.a, dwm> a(String $$0, he<dyz> $$1) {
      return $$2 -> new dwm(Either.left(new aew($$0)), $$1, $$2);
   }

   public static Function<dwr.a, dwo> b(String $$0) {
      return $$1 -> new dwo(Either.left(new aew($$0)), a, $$1);
   }

   public static Function<dwr.a, dwo> b(String $$0, he<dyz> $$1) {
      return $$2 -> new dwo(Either.left(new aew($$0)), $$1, $$2);
   }

   public static Function<dwr.a, dwj> a(he<dum> $$0) {
