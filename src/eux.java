...
public class eux {
   ...
   static class a implements eux.i {
      @Override
      public boolean a(eux.v $$0) {
         return $$0.c[jc.f.d()] && !$$0.b[jc.f.d()].d;
      }

      @Override
      public eux.r a(jc $$0, eux.v $$1, bai $$2) {
         $$1.d = true;
         $$1.b[jc.f.d()].d = true;
         return new eux.k($$0, $$1);
      }
   }

   static class b implements eux.i {
      @Override
      public boolean a(eux.v $$0) {
      ...
      public eux.r a(jc $$0, eux.v $$1, bai $$2) {
         ...
         return new eux.l($$0, $$1);
      }
   }

   static class c implements eux.i {
      @Override
      public boolean a(eux.v $$0) {
      ...
      public eux.r a(jc $$0, eux.v $$1, bai $$2) {
         $$1.d = true;
         $$1.b[jc.b.d()].d = true;
         return new eux.m($$0, $$1);
      }
   }

   static class d implements eux.i {
      @Override
      public boolean a(eux.v $$0) {
      ...
      public eux.r a(jc $$0, eux.v $$1, bai $$2) {
         ...
         return new eux.n($$0, $$1);
      }
   }

   static class e implements eux.i {
      @Override
      public boolean a(eux.v $$0) {
      ...
      public eux.r a(jc $$0, eux.v $$1, bai $$2) {
         ...
         $$3.d = true;
         $$3.b[jc.c.d()].d = true;
         return new eux.o($$0, $$3);
      }
   }

   static class f implements eux.i {
      @Override
      public boolean a(eux.v $$0) {
         return true;
      }
      ...
      public eux.r a(jc $$0, eux.v $$1, bai $$2) {
         $$1.d = true;
         return new eux.s($$0, $$1, $$2);
      }
   }

   static class g implements eux.i {
      @Override
      public boolean a(eux.v $$0) {
      ...
      public eux.r a(jc $$0, eux.v $$1, bai $$2) {
         $$1.d = true;
         return new eux.t($$0, $$1);
      }
   }

   public static class h extends eux.r {
      ...
      private eux.v G;
      private eux.v H;
      private final List<eux.r> I = Lists.newArrayList();

      public h(bai $$0, int $$1, int $$2, jc $$3) {
         super(ete.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eux.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eux.p($$3, this.G));
         this.I.add(new eux.j($$3, this.H));
         List<eux.i> $$5 = Lists.newArrayList();
         $$5.add(new eux.b());
         $$5.add(new eux.d());
         $$5.add(new eux.e());
         $$5.add(new eux.a());
         ...
         esf $$10 = esf.a(this.b(1, 1, 1), this.b(23, 8, 21));
         esf $$11 = esf.a(this.b(34, 1, 1), this.b(56, 8, 21));
         esf $$12 = esf.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eux.u($$3, $$10, $$13++));
         this.I.add(new eux.u($$3, $$11, $$13++));
         this.I.add(new eux.q($$3, $$12));
      }
      ...
      private List<eux.v> b(bai $$0) {
         eux.v[] $$1 = new eux.v[75];
         ...
         eux.v $$23 = new eux.v(1003);
         eux.v $$24 = new eux.v(1001);
         eux.v $$25 = new eux.v(1002);
         $$1[v].a(jc.b, $$23);
         $$1[w].a(jc.d, $$24);
         $$1[x].a(jc.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eux.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dli $$2, bai $$3, esf $$4) {
         int $$5 = 24;
      ...
      private void a(dli $$0, bai $$1, esf $$2) {
      ...
      private void b(dli $$0, bai $$1, esf $$2) {
      ...
      private void c(dli $$0, bai $$1, esf $$2) {
      ...
      private void d(dli $$0, bai $$1, esf $$2) {
      ...
      private void e(dli $$0, bai $$1, esf $$2) {
      ...
      private void f(dli $$0, bai $$1, esf $$2) {
   ...
   interface i {
      boolean a(eux.v var1);

      eux.r a(jc var1, eux.v var2, bai var3);
   }

   public static class j extends eux.r {
      public j(jc $$0, eux.v $$1) {
         super(ete.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dli $$0, dlf $$1, edo $$2, bai $$3, esf $$4, djo $$5, iw $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dnq.cr.m(), dnq.cr.m(), false);
   ...
   public static class k extends eux.r {
      public k(jc $$0, eux.v $$1) {
         super(ete.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eux.r {
      public l(jc $$0, eux.v $$1) {
         super(ete.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eux.r {
      public m(jc $$0, eux.v $$1) {
         super(ete.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eux.r {
      public n(jc $$0, eux.v $$1) {
         super(ete.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eux.r {
      public o(jc $$0, eux.v $$1) {
         super(ete.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eux.r {
      public p(jc $$0, eux.v $$1) {
         super(ete.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eux.r {
      public q(jc $$0, esf $$1) {
         super(ete.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends esr {
      protected static final ebq b = dnq.iB.m();
      protected static final ebq c = dnq.iC.m();
      protected static final ebq d = dnq.iD.m();
      protected static final ebq h = c;
      protected static final ebq i = dnq.iK.m();
      protected static final boolean j = true;
      protected static final ebq k = dnq.J.m();
      protected static final Set<dno> l = ImmutableSet.builder().add(dnq.ee).add(dnq.je).add(dnq.nC).add(k.b()).build();
      ...
      public r(ete $$0, jc $$1, int $$2, esf $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ete $$0, int $$1, jc $$2, eux.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static esf a(jc $$0, eux.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         esf $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dli $$0, esf $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  ebq $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
      ...
      protected void a(dli $$0, esf $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dli $$0, esf $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, ebq $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(esf $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dli $$0, esf $$1, int $$2, int $$3, int $$4) {
         iw $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            coz $$6 = bxn.N.a($$0.a(), bxm.d);
            if ($$6 != null) {
               $$6.c($$6.eU());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dv()), bxm.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eux.r {
      private int a;

      public s(jc $$0, eux.v $$1, bai $$2) {
         super(ete.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eux.r {
      public t(jc $$0, eux.v $$1) {
         super(ete.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eux.r {
      private int a;

      public u(jc $$0, esf $$1, int $$2) {
         super(ete.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
