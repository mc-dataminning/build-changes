...
public class eux {
   ...
   private final Map<String, eux.a> b = Maps.newHashMap();
   private final eva c;
   ...
   private eux.a a(String $$0) {
      eux.a $$1 = new eux.a();
      this.b.put($$0, $$1);
      return $$1;
   }

   private eum.a<eux.a> b(String $$0) {
      return new eum.a<>(() -> this.a($$0), ($$1, $$2) -> this.a($$0).a($$1), ban.h);
   }

   public tq a(akv $$0) {
      String $$1 = $$0.b();
      eux.a $$2 = this.c.b(this.b($$1), c($$1));
