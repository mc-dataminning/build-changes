...
public class eux implements euu {
   @Nullable
   ...
   public eux(ByteBuffer $$0, FT_Face $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$3;
      ...
      try {
         FT_Vector $$11 = fgz.a(FT_Vector.malloc($$10), $$8, $$9);
   ...
   public eut a(int $$0) {
      ...
      if (this.e.contains($$0)) {
         ...
         if ($$2 == 0) {
            ...
            fgz.a(FreeType.FT_Load_Glyph($$1, $$2, 4194312), "Loading glyph");
            FT_GlyphSlot $$3 = Objects.requireNonNull($$1.glyph(), "Glyph not initialized");
            float $$4 = fgz.a($$3.advance());
            FT_Bitmap $$5 = $$3.bitmap();
            int $$6 = $$3.bitmap_left();
            int $$7 = $$3.bitmap_top();
            int $$8 = $$5.width();
            int $$9 = $$5.rows();
            return (eut)($$8 > 0 && $$9 > 0 ? new eux.a((float)$$6, (float)$$7, $$8, $$9, $$4, $$2) : () -> $$4 / this.d);
         }
      }
   }
   ...
   public void close() {
      if (this.c != null) {
         fgz.a(FreeType.FT_Done_Face(this.c), "Deleting face");
         this.c = null;
      }
      ...
      public fgt bake(Function<euv, fgt> $$0) {
         return $$0.apply(new euv() {
            ...
            public void a(int $$0, int $$1) {
               FT_Face $$2 = eux.this.b();
               evs $$3 = new evs(evs.a.d, a.this.b, a.this.c, false);
               $$3.a($$2, a.this.g);
