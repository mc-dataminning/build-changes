...
public class eux {
   ...
   public eux(Supplier<String> $$0, Consumer<String> $$1, Supplier<String> $$2, Consumer<String> $$3, Predicate<String> $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private int h(int $$0) {
      return arp.a($$0, 0, this.a.get().length());
   }
   ...
   private void a(String $$0, String $$1) {
      ...
      this.f = arp.a(this.f, 0, $$0.length());
   ...
   public void a(int $$0, boolean $$1, eux.a $$2) {
      switch ($$2) {
         case a:
            this.a($$0, $$1);
            break;
