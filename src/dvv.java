...
public abstract class dvv<T extends Comparable<T>> {
   ...
   private final Codec<dvv.a<T>> e = this.d.xmap(this::b, dvv.a::b);

   protected dvv(String $$0, Class<T> $$1) {
      this.a = $$1;
      this.b = $$0;
   }

   public dvv.a<T> b(T $$0) {
      return new dvv.a<>(this, $$0);
   }

   public dvv.a<T> a(duu<?, ?> $$0) {
      return new dvv.a<>(this, $$0.c(this));
   }

   public Stream<dvv.a<T>> c() {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof dvv<?> $$1) ? false : this.a.equals($$1.a) && this.b.equals($$1.b);
      }
   }
   ...
   public <U, S extends duu<?, S>> DataResult<S> a(DynamicOps<U> $$0, S $$1, U $$2) {
      DataResult<T> $$3 = this.d.parse($$0, $$2);
      return $$3.map($$1x -> $$1.b(this, $$1x)).setPartial($$1);
   }

   public static record a<T extends Comparable<T>>(dvv<T> a, T b) {
      public a(dvv<T> a, T b) {
         if (!a.a().contains(b)) {
