public class dvv extends dus {
   ...
   private akt<ept> j = akt.a(mc.aZ, aku.b("empty"));
   private dvv.a k = dvv.a.a;
   private String l = "minecraft:air";
   private int m;
   private int q;

   public dvv(ji $$0, dxq $$1) {
      super(duu.G, $$0, $$1);
   }
   ...
   protected void a(tq $$0, jt.a $$1) {
      ...
      this.j = akt.a(mc.aZ, aku.a($$0.l("pool")));
   ...
   public void a(ard $$0, int $$1, boolean $$2) {
      ji $$3 = this.aA_().a(this.m().c(doj.b).a());
      ke<ept> $$4 = $$0.F_().e(mc.aZ);
      jr<ept> $$5 = $$4.b(this.j);
   ...
   public static enum a implements azv {
      ...
      public static final azv.a<dvv.a> c = azv.a(dvv.a::values);
