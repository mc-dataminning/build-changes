...
public class blx {
   ...
   private blx(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static blx a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new blx($$0, $$1);
   }

   public blx.d a() throws IOException {
      blx.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new blx.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private blx.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         blx.c $$3 = blx.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new blx.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new blx.a($$0, $$3);
            }
         }
   ...
   public blx.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<blx.c> $$2 = this.a().c();
      ...
      blx.e $$4 = new blx.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, blx.c b) implements blx.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static blx.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new blx.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<blx.b> {
      private final List<blx.b> a;

      d(List<blx.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public blx.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            blx.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  blx.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public blx.d a() {
         ListIterator<blx.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               blx.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<blx.b> iterator() {
         return this.a.iterator();
      }

      public Stream<blx.b> b() {
         return this.a.stream();
      }

      public Set<blx.c> c() {
         return this.a.stream().map(blx.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, blx.c b) implements blx.b {
