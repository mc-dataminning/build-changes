...
public class fll {
   ...
   private fll(int $$0, List<fln> $$1) {
      this.a = $$1.toArray(fln[]::new);
      this.b = $$1.size();
   }

   private List<fln> c() {
      List<fln> $$0 = new ArrayList<>(this.d());
