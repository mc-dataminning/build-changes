...
public class fll<T extends cbh & bog> extends fle<T> {
   ...
   public static fpp c() {
      ...
      fps $$1 = $$0.a();
      fps $$2 = $$1.a(
         "body", fpo.c().a(0, 11).a(-4.0F, -2.0F, -9.0F, 8.0F, 4.0F, 10.0F).a(2, 17).a(0.0F, -3.0F, -8.0F, 0.0F, 5.0F, 9.0F), fpl.a(0.0F, 20.0F, 5.0F)
      );
      fpn $$3 = new fpn(0.001F);
      fps $$4 = $$2.a("head", fpo.c().a(0, 1).a(-4.0F, -3.0F, -5.0F, 8.0F, 5.0F, 5.0F, $$3), fpl.a(0.0F, 0.0F, -9.0F));
      fpo $$5 = fpo.c().a(3, 37).a(-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, $$3);
      fpo $$6 = fpo.c().a(0, 40).a(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      fpo $$7 = fpo.c().a(11, 40).a(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, $$3);
      $$4.a("top_gills", $$5, fpl.a(0.0F, -3.0F, -1.0F));
      $$4.a("left_gills", $$6, fpl.a(-4.0F, 0.0F, -1.0F));
      $$4.a("right_gills", $$7, fpl.a(4.0F, 0.0F, -1.0F));
      fpo $$8 = fpo.c().a(2, 13).a(-1.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      fpo $$9 = fpo.c().a(2, 13).a(-2.0F, 0.0F, 0.0F, 3.0F, 5.0F, 0.0F, $$3);
      $$2.a("right_hind_leg", $$9, fpl.a(-3.5F, 1.0F, -1.0F));
      $$2.a("left_hind_leg", $$8, fpl.a(3.5F, 1.0F, -1.0F));
      $$2.a("right_front_leg", $$9, fpl.a(-3.5F, 1.0F, -8.0F));
      $$2.a("left_front_leg", $$8, fpl.a(3.5F, 1.0F, -8.0F));
      $$2.a("tail", fpo.c().a(2, 19).a(0.0F, -3.0F, 0.0F, 0.0F, 5.0F, 12.0F), fpl.a(0.0F, 0.0F, 1.0F));
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      if ($$0.gm()) {
         ...
         boolean $$6 = $$2 > 1.0E-5F || $$0.dE() != $$0.N || $$0.dC() != $$0.M;
         if ($$0.bc()) {
            if ($$6) {
               this.d($$3, $$5);
            } else {
   ...
   private Vector3f a(fpj $$0) {
      return new Vector3f($$0.e, $$0.f, $$0.g);
   }

   private void a(fpj $$0, Vector3f $$1) {
      $$0.b($$1.x(), $$1.y(), $$1.z());
   }
   ...
   private void a(fpj $$0, float $$1, float $$2, float $$3) {
   ...
   private void c(float $$0, float $$1) {
      ...
      this.l.e = this.a(this.l.e, 0.6F - 0.08F * ($$3 * $$3 + 2.0F * awi.a($$2)));
      this.m.f = this.a(this.m.f, -this.l.e);
      this.n.f = this.a(this.n.f, -this.m.f);
   ...
   private void d(float $$0, float $$1) {
      ...
      this.n.f = this.a(this.n.f, -this.m.f);
      this.b.f = this.a(this.b.f, 0.3F * awi.b($$2 * 0.9F));
