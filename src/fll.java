...
public class fll {
            ...
            if (this.b.z != null) {
               ...
               if (this.b.t.Z_()) {
                  if (this.b.m.g().a()) {
                     ...
                     float $$11 = ayz.a(this.b.t.gj().a() + (float)$$9.y * 0.005F, 0.0F, 0.2F);
                     this.b.t.gj().a($$11);
                  }
               } else {
                  cox $$12 = this.b.t.gi();
                  $$12.e(flt.a((double)$$10, $$12.j, cox.g()));
               }
            }
         }
      }
   ...
   public void i() {
      if (this.b.aC()) {
         if (!this.s) {
            ...
            feq.a(this.b.aO().h(), 212995, this.f, this.g);
            this.b.a(null);
            this.b.x = 10000;
            this.j = true;
         }
   ...
   public void j() {
      if (this.s) {
         ...
         this.f = (double)(this.b.aO().m() / 2);
         this.g = (double)(this.b.aO().n() / 2);
         feq.a(this.b.aO().h(), 212993, this.f, this.g);
      }
   }
