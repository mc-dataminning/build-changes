...
public class fll extends flt {
   static final akn c = new akn("textures/gui/title/mojangstudios.png");
   private static final int d = axp.b.a(255, 239, 50, 61);
   private static final int e = axp.b.a(255, 0, 0, 0);
   private static final IntSupplier f = () -> feb.Q().m.a().c() ? e : d;
   ...
   public fll(feb $$0, att $$1, Consumer<Optional<Throwable>> $$2, boolean $$3) {
      this.m = $$0;
      this.n = $$1;
      this.o = $$2;
      this.p = $$3;
   ...
   public void a(ffn $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$7 >= 1.0F) {
         ...
         int $$9 = ayf.f((1.0F - ayf.a($$7 - 1.0F, 0.0F, 1.0F)) * 255.0F);
         $$0.a(gcs.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$9));
         $$10 = 1.0F - ayf.a($$7 - 1.0F, 0.0F, 1.0F);
      } else if (this.p) {
         if (this.m.y != null && $$8 < 1.0F) {
            this.m.y.a($$0, $$1, $$2, $$3);
         }

         int $$11 = ayf.c(ayf.a((double)$$8, 0.15, 1.0) * 255.0);
         $$0.a(gcs.E(), 0, 0, $$4, $$5, a(f.getAsInt(), $$11));
         $$10 = ayf.a($$8, 0.0F, 1.0F);
      } else {
         int $$13 = f.getAsInt();
         ...
         GlStateManager._clear(16384, feb.a);
         $$10 = 1.0F;
      }
      ...
      float $$25 = this.n.b();
      this.q = ayf.a(this.q * 0.95F + $$25 * 0.050000012F, 0.0F, 1.0F);
      if ($$7 < 1.0F) {
         this.a($$0, $$4 / 2 - $$23, $$24 - 5, $$4 / 2 + $$23, $$24 + 5, 1.0F - ayf.a($$7, 0.0F, 1.0F));
      }
   ...
   private void a(ffn $$0, int $$1, int $$2, int $$3, int $$4, float $$5) {
      int $$6 = ayf.f((float)($$3 - $$1 - 2) * this.q);
      int $$7 = Math.round($$5 * 255.0F);
      int $$8 = axp.b.a($$7, 255, 255, 255);
   ...
   static class a extends gno {
      ...
      protected gno.a b(atx $$0) {
         asn $$1 = feb.Q().ad();
         atp<InputStream> $$2 = $$1.a(asl.a, fll.c);
         if ($$2 == null) {
            return new gno.a(new FileNotFoundException(fll.c.toString()));
         } else {
            try {
               gno.a var5;
               try (InputStream $$3 = $$2.get()) {
                  var5 = new gno.a(new gps(true, true), exv.a($$3));
               }
