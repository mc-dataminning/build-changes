...
public class anb {
   ...
   public boolean a(ctf $$0) {
      if ($$0 == this.b) {
         ...
         this.a($$0, this.e);
         this.d.y();
         this.d.d.ae().a(new abb(abb.a.c, this.d));
         this.c.e();
         return true;
      }
   }

   protected void a(ctf $$0, @Nullable ctf $$1) {
      this.e = $$1;
      this.b = $$0;
      $$0.a(this.d.fT());
   }
   ...
   private float a(dja $$0, hx $$1, int $$2) {
      int $$3 = this.i - $$2;
   ...
   public void a(hx $$0, aej.a $$1, ic $$2, int $$3, int $$4) {
      if (this.d.br().g(elm.b($$0)) > any.d) {
         this.a($$0, false, $$4, "too far");
      } else if ($$0.v() >= $$3) {
         this.d.c.b(new zg($$0, this.c.a_($$0)));
         ...
         if ($$1 == aej.a.a) {
            ...
            if (!$$6.i() && $$5 >= 1.0F) {
               ...
               if (this.f) {
                  this.d.c.b(new zg(this.h, this.c.a_(this.h)));
   ...
   public boolean a(hx $$0) {
      ...
      if (!this.d.eT().d().a($$1, this.c, $$0, this.d)) {
         ...
         dgo $$2 = this.c.c_($$0);
         cwj $$3 = $$1.b();
         if ($$3 instanceof czr && !this.d.gp()) {
            this.c.a($$0, $$1, $$1, 3);
            return false;
         } else if (this.d.a(this.c, $$0, this.b)) {
            return false;
         } else {
            dja $$4 = $$3.a(this.c, $$0, $$1, (cfb)this.d);
