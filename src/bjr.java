...
public abstract class bjr extends DataFix {
   private final String a;

   public bjr(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bjd.D);
      Type<Pair<String, String>> $$2 = DSL.named(bjd.B.typeName(), bky.a());
      if (!Objects.equals(this.getOutputSchema().getType(bjd.B), $$2)) {
