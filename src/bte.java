...
public abstract class bte extends bsr {
   ...
   public bte(bme $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public bte(bme $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(bsr.a.a, bsr.a.c));
   }
   ...
   protected abstract boolean a(ctb var1, hv var2);
}
