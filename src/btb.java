...
public class btb extends bsq {
   ...
   public btb(dcu $$0, double $$1, double $$2, double $$3, int $$4) {
      this(bsw.M, $$0);
      this.a_($$1, $$2, $$3);
   ...
   public btb(bsw<? extends btb> $$0, dcu $$1) {
      super($$0, $$1);
   }
   ...
   public void l() {
      ...
      if (this.k != null) {
         eww $$0 = new eww(this.k.dv() - this.dv(), this.k.dx() + (double)this.k.cM() / 2.0 - this.dx(), this.k.dB() - this.dB());
         double $$1 = $$0.g();
         if ($$1 < 64.0) {
   ...
   private void t() {
      ...
      if (this.dQ() instanceof aqt) {
         for (btb $$1 : this.dQ().a(dxk.a(btb.class), this.cL().g(0.5), this::a)) {
            this.b($$1);
         }
      }
   }

   public static void a(aqt $$0, eww $$1, int $$2) {
      while ($$2 > 0) {
         int $$3 = b($$2);
         $$2 -= $$3;
         if (!b($$0, $$1, $$3)) {
            $$0.b(new btb($$0, $$1.a(), $$1.b(), $$1.c(), $$3));
         }
      }
   }

   private static boolean b(aqt $$0, eww $$1, int $$2) {
      ewr $$3 = ewr.a($$1, 1.0, 1.0, 1.0);
      int $$4 = $$0.E_().a(40);
      List<btb> $$5 = $$0.a(dxk.a(btb.class), $$3, $$2x -> a($$2x, $$4, $$2));
      if (!$$5.isEmpty()) {
         btb $$6 = $$5.get(0);
         $$6.j++;
         $$6.g = 0;
   ...
   private static boolean a(btb $$0, int $$1, int $$2) {
      return !$$0.dL() && ($$0.an() - $$1) % 40 == 0 && $$0.i == $$2;
   }

   private void b(btb $$0) {
      this.j = this.j + $$0.j;
   ...
   private int a(aqu $$0, int $$1) {
      Optional<czz> $$2 = dac.a(dab.z, $$0, cuo::m);
      if ($$2.isPresent()) {
         cuo $$3 = $$2.get().a();
         int $$4 = dac.c($$0.A(), $$3, $$1);
