...
public abstract class eyq<T extends eyq<T>> {
   ...
   public eyq(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = eyo.a();
         if ($$3 != null) {
         ...
         throw new ezz(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new ezz(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new ezz(var2.getMessage(), var2);
      }
   }
   ...
   public static eyq<?> a(String $$0) {
      return new eyq.b($$0, 5000, 60000);
   }

   public static eyq<?> a(String $$0, int $$1, int $$2) {
      return new eyq.b($$0, $$1, $$2);
   }

   public static eyq<?> b(String $$0, String $$1) {
      return new eyq.c($$0, $$1, 5000, 60000);
   }

   public static eyq<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new eyq.c($$0, $$1, $$2, $$3);
   }

   public static eyq<?> b(String $$0) {
      return new eyq.a($$0, 5000, 60000);
   }

   public static eyq<?> c(String $$0, String $$1) {
      return new eyq.d($$0, $$1, 5000, 60000);
   }

   public static eyq<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new eyq.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends eyq<eyq.a> {
   ...
   public static class b extends eyq<eyq.b> {
   ...
   public static class c extends eyq<eyq.c> {
      ...
      public eyq.c f() {
         try {
            ...
            throw new ezz(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends eyq<eyq.d> {
      private final String c;
