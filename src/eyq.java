...
public class eyq extends ask<Map<String, List<eyq.a>>> implements AutoCloseable {
   private static final Codec<Map<String, List<eyq.a>>> a = Codec.unboundedMap(
      Codec.STRING,
      RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.LONG.optionalFieldOf("delay", 0L).forGetter(eyq.a::a),
                     Codec.LONG.fieldOf("period").forGetter(eyq.a::b),
                     Codec.STRING.fieldOf("title").forGetter(eyq.a::c),
                     Codec.STRING.fieldOf("message").forGetter(eyq.a::d)
                  )
                  .apply($$0, eyq.a::new)
         )
         .listOf()
   ...
   public eyq(ajc $$0, Object2BooleanFunction<String> $$1) {
      this.c = $$0;
      this.d = $$1;
   }

   protected Map<String, List<eyq.a>> a(asf $$0, bjc $$1) {
      try {
         Map var4;
   ...
   protected void a(Map<String, List<eyq.a>> $$0, asf $$1, bjc $$2) {
      List<eyq.a> $$3 = $$0.entrySet()
         .stream()
   ...
   private long a(List<eyq.a> $$0, long $$1) {
   ...
   static class b extends TimerTask {
      ...
      private final List<eyq.a> b;
      private final long c;
      private final AtomicLong d;

      public b(List<eyq.a> $$0, long $$1, long $$2) {
         this.b = $$0;
         this.c = $$2;
         this.d = new AtomicLong($$1);
      }

      public eyq.b a(List<eyq.a> $$0, long $$1) {
         this.cancel();
         return new eyq.b($$0, this.d.get(), $$1);
      }
      ...
      public void run() {
         ...
         for (eyq.a $$2 : this.b) {
            if ($$0 >= $$2.a) {
               ...
               long $$4 = $$1 / $$2.b;
               if ($$3 != $$4) {
                  this.a.execute(() -> fcs.a(eyk.P().ax(), fcs.a.f, vs.a($$2.c, $$3), vs.a($$2.d, $$3)));
                  return;
               }
            }
         }
