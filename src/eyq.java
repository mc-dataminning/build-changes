...
public class eyq {
   ...
   public eyq(eqq $$0, eyu $$1, eyr $$2, int $$3, ag $$4, aq $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public void b(esa $$0, int $$1, int $$2) {
      if (!this.r) {
      ...
      aeu $$3 = Objects.requireNonNullElse(this.f.d(), fza.a);
      int $$4 = ars.a(this.k);
      int $$5 = ars.a(this.l);
      int $$6 = $$4 % 16;
      int $$7 = $$5 % 16;
   ...
   public void a(esa $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      $$0.a(0, 0, 234, 113, ars.d(this.q * 255.0F) << 24);
      boolean $$5 = false;
      int $$6 = ars.a(this.k);
      int $$7 = ars.a(this.l);
      ...
      $$0.c().b();
      if ($$5) {
         this.q = ars.a(this.q + 0.02F, 0.0F, 0.3F);
      } else {
         this.q = ars.a(this.q - 0.04F, 0.0F, 1.0F);
      }
   }
   ...
   @Nullable
   public static eyq a(eqq $$0, eyu $$1, int $$2, ag $$3) {
      Optional<aq> $$4 = $$3.a().d();
      if ($$4.isEmpty()) {
         return null;
      } else {
   ...
   public void a(double $$0, double $$1) {
      if (this.o - this.m > 234) {
         this.k = ars.a(this.k + $$0, (double)(-(this.o - 234)), 0.0);
      }

      if (this.p - this.n > 113) {
         this.l = ars.a(this.l + $$1, (double)(-(this.p - 113)), 0.0);
      }
   }
