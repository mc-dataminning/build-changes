...
public class eyq {
   ...
   private static final Queue<eyq.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eyq.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eyq::a), eyo::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eyq::a), eyo::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eyq.a(this.b) + ", type=" + eyq.b(this.c) + ", severity=" + eyq.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
