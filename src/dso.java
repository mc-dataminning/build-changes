...
public class dso {
   ...
   static Codec<dso> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               Codec.DOUBLE.lenientOptionalFieldOf("connected_particles_range", dsm.b.d()).forGetter($$0x -> $$0x.f)
            )
            .apply($$0, dso::new)
   );
   private cuq d = cuq.l;
   ...
   void a(aqu $$0, jd $$1, dsn $$2, dsm $$3, double $$4) {
