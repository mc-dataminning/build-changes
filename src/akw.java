...
public class akw<E> implements Codec<jr<E>> {
   ...
   public static <E> Codec<jr<E>> a(alb<? extends ka<E>> $$0, Codec<jn<E>> $$1, boolean $$2) {
      return new akw<>($$0, $$1, $$2);
   }

   private akw(alb<? extends ka<E>> $$0, Codec<jn<E>> $$1, boolean $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = a($$1, $$2);
      this.d = Codec.either(axj.b($$0), this.c);
   }

   public <T> DataResult<Pair<jr<E>, T>> decode(DynamicOps<T> $$0, T $$1) {
      if ($$0 instanceof ala<T> $$2) {
   ...
   private static <E> DataResult<jr<E>> a(jo<E> $$0, axj<E> $$1) {
      return $$0.a($$1)
