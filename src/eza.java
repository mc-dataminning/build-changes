...
public enum eza {
   ...
   private eza(final String... $$0) {
      this.c = $$0;
   }

   public List<atm<InputStream>> a(asg $$0) throws IOException {
      return List.of(
   ...
   public atm<InputStream> b(asg $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private atm<InputStream> a(asg $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      atm<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
