...
public class eza {
   private final eza.a a;
   private final eza.b b;
   private final int c;
   private final int d;
   private final int e;

   public eza(int $$0, eza.a $$1, eza.b $$2, int $$3) {
      if (this.a($$0, $$2)) {
         this.b = $$2;
         this.a = $$1;
         this.c = $$0;
   ...
   private boolean a(int $$0, eza.b $$1) {
      return $$0 == 0 || $$1 == eza.b.d;
   }

   public final eza.a a() {
      return this.a;
   }

   public final eza.b b() {
      return this.b;
   }
   ...
   public static enum b {
      ...
      private final eza.b.b h;
      private final eza.b.a i;

      private b(String $$0, eza.b.b $$1, eza.b.a $$2) {
         this.g = $$0;
         this.h = $$1;
         this.i = $$2;
      }
