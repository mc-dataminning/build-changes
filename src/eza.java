...
public final class eza implements AutoCloseable {
   ...
   public eza(int $$0, int $$1, boolean $$2) {
      this(eza.a.a, $$0, $$1, $$2);
   }

   public eza(eza.a $$0, int $$1, int $$2, boolean $$3) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   private eza(eza.a $$0, int $$1, int $$2, boolean $$3, long $$4) {
      if ($$1 > 0 && $$2 > 0) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
   ...
   public static eza a(InputStream $$0) throws IOException {
      return a(eza.a.a, $$0);
   }

   public static eza a(@Nullable eza.a $$0, InputStream $$1) throws IOException {
      ByteBuffer $$2 = null;
   ...
   public static eza a(ByteBuffer $$0) throws IOException {
      return a(eza.a.a, $$0);
   }

   public static eza a(byte[] $$0) throws IOException {
   ...
   public static eza a(@Nullable eza.a $$0, ByteBuffer $$1) throws IOException {
      if ($$0 != null && !$$0.w()) {
         ...
         try {
            ...
            var7 = new eza($$0 == null ? eza.a.a($$5.get(0)) : $$0, $$3.get(0), $$4.get(0), true, MemoryUtil.memAddress($$6));
   ...
   public eza a(IntUnaryOperator $$0) {
      if (this.c != eza.a.a) {
         ...
         this.j();
         eza $$1 = new eza(this.d, this.e, false);
         int $$2 = this.d * this.e;
   ...
   public boolean a(FT_Face $$0, int $$1) {
      ...
      } else if (fkg.b(FreeType.FT_Load_Glyph($$0, $$1, 4), "Loading glyph")) {
         return false;
      } else {
   ...
   public void a(eza $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, boolean $$7, boolean $$8) {
      for (int $$9 = 0; $$9 < $$6; $$9++) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, eza $$4) {
      this.j();
      if ($$4.c() != this.c) {
