...
public class eza extends eyb {
   private static final Codec<List<eza.b>> b = eza.b.a.listOf().validate($$0 -> {
      Set<jq<bum>> $$1 = new ObjectOpenHashSet();
   ...
   public cxo a(cxo $$0, ewo $$1) {
      if ($$0.a(cxs.wM) && !this.c.isEmpty()) {
         eza.b $$2 = ae.a(this.c, $$1.b());
         jq<bum> $$3 = $$2.a();
         int $$4 = $$2.b().a($$1);
         if (!$$3.a().a()) {
            $$4 *= 20;
         ...
         dap.a $$5 = new dap.a($$3, $$4);
         $$0.a(ku.R, dap.a, $$5, dap::a);
         return $$0;
      } else {
         return $$0;
      }
   ...
   static record b(jq<bum> b, fat c) {
      public static final Codec<eza.b> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(bum.a.fieldOf("type").forGetter(eza.b::a), fau.a.fieldOf("duration").forGetter(eza.b::b)).apply($$0, eza.b::new)
      );
