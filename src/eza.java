...
public abstract class eza extends eya {
   private final ddt b;
   private ddu c;
   private final String[] k;
   private final boolean l;
   protected final dgm a;
   private int m;
   private int n;
   @Nullable
   private eux o;

   public eza(ddt $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, tf.c("sign.edit"));
   }

   public eza(ddt $$0, boolean $$1, boolean $$2, tf $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
   ...
   @Override
   protected void aC_() {
      this.d(esg.a(te.d, $$0 -> this.D()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
   ...
   protected abstract void a(erv var1, dez var2);
   ...
   private void d(erv $$0) {
      ...
      Vector3f $$1 = this.l();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : fqi.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.k.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.n && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(foc.E(), $$21, $$7, $$22, $$7 + this.b.c(), -16776961);
            }
         }
      }
   }
