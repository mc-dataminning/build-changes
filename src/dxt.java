...
public class dxt<T> implements dxv<T> {
   ...
   private dxt(jv<T> $$0, int $$1, dxw<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dxt(jv<T> $$0, T[] $$1, dxw<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dxv<T> a(dxw<T> $$0) {
      return new dxt<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
