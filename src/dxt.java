...
public class dxt {
   ...
   private final Map<Character, Predicate<dxr>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public dxt a(char $$0, Predicate<dxr> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public dxs b() {
      return new dxs(this.c());
   }

   private Predicate<dxr>[][][] c() {
      this.d();
      Predicate<dxr>[][][] $$0 = (Predicate<dxr>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<dxr>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
