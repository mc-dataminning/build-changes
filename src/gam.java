...
public class gam<T extends gwz> extends fzw<T> {
   private static final String a = "cape";
   private final gcl b = this.q.b("cape");
   ...
   public static gcr a() {
      ...
      $$1.a("left_leg");
      $$1.a("right_leg");
      $$3.a("cape", gcq.c().a(0, 0).a(-5.0F, 0.0F, -1.0F, 10.0F, 16.0F, 1.0F, gcp.a, 1.0F, 0.5F), gcn.a(0.0F, 0.0F, 2.0F, 0.0F, (float) Math.PI, 0.0F));
