...
public class gam {
   public static class a implements gbf<lm> {
      ...
      public gbc a(lm $$0, fxv $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gam.b $$8 = new gam.b($$1, $$2, $$3, $$4);
         $$8.a(this.a);
         return $$8;
      }
   }

   public static class b extends gcc {
      b(fxv $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gbo {
      ...
      c(fxv $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbe $$7, gbx $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gam.c $$0 = new gam.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gbf<lm> {
      ...
      public gbc a(lm $$0, fxv $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gam.c $$8 = new gam.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, fff.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gba {
      ...
      private int D;
      private final gbe E;
      private final List<cxi> F;
      private boolean G;

      public e(fxv $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbe $$7, List<cxi> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gbc $$12 = this.E.a(li.N, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$12.a((float)ayj.b.b($$11) / 255.0F, (float)ayj.b.c($$11) / 255.0F, (float)ayj.b.d($$11) / 255.0F);
         }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gam.c $$10 = (gam.c)this.E.a(li.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
