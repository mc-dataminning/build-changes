...
public class gam extends gcd {
   private final float a;
   private final gby b;

   gam(fxw $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, gby $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements gbg<la> {
      ...
      public gbd a(la $$0, fxw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == dlg.a) {
            ...
            iz $$9 = iz.a($$2, $$3, $$4);
            int $$10 = ffg.Q().av().a($$8, $$1, $$9);
            if ($$8.b() instanceof dhw) {
               $$10 = ((dhw)$$8.b()).b($$8, $$1, $$9);
            }
            ...
            return new gam($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
