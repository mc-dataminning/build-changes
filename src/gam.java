...
public class gam extends fzh<cwm> {
   ...
   @Nullable
   private dxh Z;
   private czn aa = czn.k;
   private czn ab = czn.k;
   private czn ac = czn.k;
   private boolean ad;
   private boolean ae;
   private float af;
   private boolean ag;
   ...
   protected void aO_() {
      super.aO_();
      this.Y = this.m.aS().a(gjs.r).b("flag");
   }
   ...
   protected void a(fsm $$0, float $$1, int $$2, int $$3) {
      int $$4 = this.C;
      int $$5 = this.D;
      $$0.a(grc::H, P, $$4, $$5, 0.0F, 0.0F, this.s, this.u, 256, 256);
      cxc $$6 = this.z.n();
      cxc $$7 = this.z.o();
      cxc $$8 = this.z.p();
      cxc $$9 = this.z.q();
      if (!$$6.h()) {
         $$0.a(grc::H, G, $$4 + $$6.e, $$5 + $$6.f, 16, 16);
      }

      if (!$$7.h()) {
         $$0.a(grc::H, H, $$4 + $$7.e, $$5 + $$7.f, 16, 16);
      }

      if (!$$8.h()) {
         $$0.a(grc::H, I, $$4 + $$8.e, $$5 + $$8.f, 16, 16);
      }

      int $$10 = (int)(41.0F * this.af);
      alg $$11 = this.ad ? J : K;
      $$0.a(grc::H, $$11, $$4 + 119, $$5 + 13 + $$10, 12, 15);
      $$0.d();
      fiv.c();
      if (this.Z != null && !this.ae) {
         ...
         cyl $$13 = ((cxt)$$9.g().h()).a();
         $$0.a($$2x -> gsy.a($$0.c(), $$2x, 15728880, hjg.d, this.Y, hma.f, true, $$13, this.Z));
         $$0.c().b();
      } else if (this.ae) {
         $$0.a(grc::H, O, $$4 + $$9.e - 5, $$5 + $$9.f - 5, 26, 26);
      }

      if (this.ad) {
         int $$14 = $$4 + 60;
         int $$15 = $$5 + 13;
         List<jf<dxg>> $$16 = this.z.l();
   ...
   private void a(fsm $$0, jf<dxg> $$1, int $$2, int $$3) {
      fkd $$4 = new fkd();
      $$4.a();
      ...
      dxh $$6 = new dxh.a().a($$1, cyl.a).a();
      $$0.a($$2x -> gsy.a($$4, $$2x, 15728880, hjg.d, this.Y, hma.f, true, cyl.h, $$6));
      $$4.b();
      $$0.d();
   }
   ...
   private void H() {
      ...
      if ($$0.f()) {
         ...
         this.Z = $$0.a(kk.am, dxh.a);
      }

      czn $$1 = this.z.n().g();
      czn $$2 = this.z.o().g();
      czn $$3 = this.z.p().g();
      dxh $$4 = $$1.a(kk.am, dxh.a);
      this.ae = $$4.b().size() >= 6;
      if (this.ae) {
         this.Z = null;
      }

      if (!czn.a($$1, this.aa) || !czn.a($$2, this.ab) || !czn.a($$3, this.ac)) {
