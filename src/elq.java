...
public class elq implements eln {
   @Nullable
   ...
   public elq(ByteBuffer $$0, STBTTFontinfo $$1, float $$2, float $$3, float $$4, float $$5, String $$6) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$3;
         ...
         label61: {
            ...
            label62: {
               try {
                  ...
                  if ($$11 > 0 && $$12 > 0) {
                     var18 = new elq.a($$4.get(0), $$6.get(0), -$$5.get(0), -$$7.get(0), $$10, (float)$$9.get(0) * this.g, $$3);
                     break label62;
                  }
   ...
   class a implements elm {
      ...
      a(int $$0, int $$1, int $$2, int $$3, float $$4, float $$5, int $$6) {
         ...
         this.c = $$2 - $$3;
         this.f = $$4 / elq.this.c;
         this.d = ($$5 + (float)$$0 + elq.this.e) / elq.this.c;
         this.e = (elq.this.h - (float)$$2 + elq.this.f) / elq.this.c;
         this.g = $$6;
      }
      ...
      public exf bake(Function<elo, exf> $$0) {
         return $$0.apply(new elo() {
            ...
            public void a(int $$0, int $$1) {
               STBTTFontinfo $$2 = elq.this.b();
               eml $$3 = new eml(eml.a.d, a.this.b, a.this.c, false);
               $$3.a($$2, a.this.g, a.this.b, a.this.c, elq.this.g, elq.this.g, elq.this.e, elq.this.f, 0, 0);
