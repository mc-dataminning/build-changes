...
public class elq {
   ...
   public Optional<l.a> a(ib $$0, boolean $$1, dqq $$2) {
      cbr $$3 = this.n.y();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      Optional<cbs> $$5 = $$3.b($$0x -> $$0x.a(cbv.r), $$0, $$4, cbr.b.c)
         .filter($$1x -> $$2.a($$1x.f()))
         .sorted(Comparator.<cbs>comparingDouble($$1x -> $$1x.f().j($$0)).thenComparingInt($$0x -> $$0x.f().v()))
         .filter($$0x -> this.n.a_($$0x.f()).b(dpp.H))
         .findFirst();
      return $$5.map($$0x -> {
         ib $$1x = $$0x.f();
         this.n.l().a(apx.f, new cye($$1x), 3, $$1x);
         doz $$2x = this.n.a_($$1x);
         return l.a($$1x, $$2x.c(dpp.H), 21, ih.a.b, 21, $$1xx -> this.n.a_($$1xx) == $$2x);
      });
   }
   ...
   public Optional<l.a> a(ib $$0, ih.a $$1) {
      ...
      for (ib.a $$10 : ib.a($$0, 16, ih.f, ih.d)) {
         int $$11 = Math.min($$8, this.n.a(dur.a.e, $$10.u(), $$10.w()));
         int $$12 = 1;
      ...
      if ($$3 == -1.0) {
         ...
         $$4 = new ib($$0.u(), axk.a($$0.v(), $$17, $$18), $$0.w()).i();
         ih $$19 = $$2.h();
         if (!$$7.a($$4)) {
            return Optional.empty();
         }
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$9, dca.co.n(), 3);
            }
         }
      }

      doz $$26 = dca.ed.n().a(dhb.b, $$1);
