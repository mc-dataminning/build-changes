...
public class fdh extends gvf {
   ...
   public void aM_() {
      this.a(this.I.a);
      this.c(fhd.a(xo.c("mco.configure.world.subscription.extend"), $$0 -> flt.a(this, axt.a(this.I.b, this.m.X().b()))).a(this.n / 2 - 100, g(6), 200, 20).a());
      if (this.I.j) {
         this.c(fhd.a(xo.c("mco.configure.world.delete.button"), $$0 -> {
            xo $$1 = xo.c("mco.configure.world.delete.question.line1");
            xo $$2 = xo.c("mco.configure.world.delete.question.line2");
            this.m.a(new fct(this::c, fct.a.a, $$1, $$2, true));
         }).a(this.n / 2 - 100, g(10), 200, 20).a());
      } else if (fai.b() && this.I.s != null) {
         this.c(new fhn(this.n / 2 - 100, g(8), 200, 46, xo.a("mco.snapshot.subscription.info", this.I.s), this.p).a(-6250336));
      } else {
         this.c(new fhn(this.n / 2 - 100, g(8), 200, 46, G, this.p).a(-6250336));
      }

      this.c(fhd.a(xn.k, $$0 -> this.d()).a(this.n / 2 - 100, g(12), 200, 20).a());
   }
         ...
         (new Thread("Realms-delete-realm") {
            ...
            public void run() {
               try {
                  ...
                  fdh.a.error("Couldn't delete world", var2);
               }

               fdh.this.m.execute(() -> fdh.this.m.a(fdh.this.J));
            }
         }).start();
      }
