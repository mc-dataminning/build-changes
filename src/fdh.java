...
public class fdh {
   ...
   @Nullable
   private String g;
   private static final fdh.a h = new fdh.a() {
      @Nullable
      @Override
      public fdg a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (fdk.a(this.d, "Get capabilities")) {
         ...
         if (fdk.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  fdk.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !fdk.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public fdg a(fdh.c $$0) {
      return ($$0 == fdh.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements fdh.a {
      private final int a;
      private final Set<fdg> b = Sets.newIdentityHashSet();
      ...
      public fdg a() {
         if (this.b.size() >= this.a) {
            if (ab.aU) {
               fdh.a.warn("Maximum sound pool size {} reached", this.a);
            }
