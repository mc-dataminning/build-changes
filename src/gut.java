...
public class gut extends gvl<cnf, hax, gej> {
   private static final ald a = ald.b("textures/entity/guardian.png");
   private static final ald j = ald.b("textures/entity/guardian_beam.png");
   private static final goi k = goi.g(j);

   public gut(guf.a $$0) {
      this($$0, 0.5F, ghc.bf);
   }

   protected gut(guf.a $$0, float $$1, ghb $$2) {
      super($$0, new gej($$0.a($$2)), $$1);
   }

   public boolean a(cnf $$0, grr $$1, double $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$0.x()) {
            bwr $$5 = $$0.gq();
            if ($$5 != null) {
               fcu $$6 = this.a($$5, (double)$$5.dr() * 0.5, 1.0F);
               fcu $$7 = this.a($$0, (double)$$0.cS(), 1.0F);
               return $$1.a(new fcp($$7.d, $$7.e, $$7.f, $$6.d, $$6.e, $$6.f));
            }
         }
   ...
   private fcu a(bwr $$0, double $$1, float $$2) {
   ...
   public void a(hax $$0, fho $$1, gny $$2, int $$3) {
      super.a($$0, $$1, $$2, $$3);
      fcu $$4 = $$0.f;
      if ($$4 != null) {
   ...
   private static void a(fho $$0, fhs $$1, fcu $$2, float $$3, float $$4, float $$5) {
   ...
   private static void a(fhs $$0, fho.a $$1, float $$2, float $$3, float $$4, int $$5, int $$6, int $$7, float $$8, float $$9) {
      $$0.a($$1, $$2, $$3, $$4).a($$5, $$6, $$7, 255).a($$8, $$9).b(hgi.d).c(15728880).b($$1, 0.0F, 1.0F, 0.0F);
   }
   ...
   public void a(cnf $$0, hax $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.L($$2);
      $$1.b = $$0.K($$2);
      $$1.c = $$0.n($$2);
   ...
   @Nullable
   private static bvs a(cnf $$0) {
      bvs $$1 = fnd.Q().ao();
      return (bvs)($$0.x() ? $$0.gq() : $$1);
   }
}
