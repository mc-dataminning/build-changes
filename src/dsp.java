...
public class dsp extends dsc<dtz> {
   public dsp(Codec<dtz> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dse<dtz> $$0) {
      hx $$1 = $$0.e();
      cus $$2 = $$0.b();
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? aup.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(auw $$0, cty $$1, int $$2, int $$3, hx $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, hx $$2, cty $$3, boolean $$4, double $$5, hx $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(cty $$0, hx $$1) {
      if ($$0.a_($$1.c()).a(cxa.dN)) {
         this.a($$0, $$1.c(), cxa.a.o());
      }
   }

   private void a(cty $$0, auw $$1, hx $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, djp $$13) {
   ...
   private void a(hx $$0, cty $$1, auw $$2, int $$3, int $$4, boolean $$5, boolean $$6, djp $$7) {
      djp $$8 = $$1.a_($$0);
      if ($$8.i() || $$8.a(cxa.dP) || $$8.a(cxa.dO) || $$8.a(cxa.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(cxa.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, cxa.dP.o());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, hx $$2, int $$3, auw $$4) {
      float $$5 = 10.0F * aup.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
   ...
   private int a(auw $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(auw $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(djp $$0) {
      return $$0.a(cxa.iC) || $$0.a(cxa.dP) || $$0.a(cxa.mW);
   }
   ...
   private void a(cty $$0, hx $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(cxa.dN)) {
                  if (this.a((ctd)$$0, $$10)) {
                     this.a($$0, $$10, cxa.a.o());
                     this.a($$0, $$10.c(), cxa.a.o());
                  } else if (c($$11)) {
                     djp[] $$12 = new djp[]{$$0.a_($$10.g()), $$0.a_($$10.h()), $$0.a_($$10.e()), $$0.a_($$10.f())};
                     int $$13 = 0;
