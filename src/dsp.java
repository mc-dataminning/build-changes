...
public class dsp implements drz {
   public static final Codec<dsp> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               dwl.b.fieldOf("feature").forGetter($$0x -> $$0x.b),
               ...
               arv.b(jz.e).fieldOf("root_replaceable").forGetter($$0x -> $$0x.e),
               dua.a.fieldOf("root_state_provider").forGetter($$0x -> $$0x.f),
               ...
               dua.a.fieldOf("hanging_root_state_provider").forGetter($$0x -> $$0x.k),
               ...
               dny.b.fieldOf("allowed_tree_position").forGetter($$0x -> $$0x.o)
            )
            .apply($$0, dsp::new)
   );
   ...
   public dsp(ib<dwl> $$0, int $$1, int $$2, arv<cva> $$3, dua $$4, int $$5, int $$6, int $$7, int $$8, dua $$9, int $$10, int $$11, dny $$12) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
