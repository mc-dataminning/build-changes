...
public class dsp extends dsq {
   public static final int a = 8;
   public static final int b = 15;
   public static final Codec<dsp> c = RecordCodecBuilder.create(
      $$0 -> a($$0).and(dso.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, dsp::new)
   );
   private final dso h;

   public dsp(bhg $$0, dst $$1, Optional<dsn> $$2, dso $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(crf $$0, BiConsumer<ht, dgb> $$1, ate $$2, ht $$3, ht $$4, dro $$5) {
   ...
   private boolean a(crf $$0, ate $$1, ht $$2, hx $$3, ht $$4, List<ht> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
   ...
   protected List<ht> a(ht $$0, hx $$1, ate $$2, ht $$3) {
      ht $$4 = $$0.d();
      ht $$5 = $$0.a($$1);
      int $$6 = $$0.k($$3);
      int $$7 = this.h.d();
