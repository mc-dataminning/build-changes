...
public class dsp extends dsu {
   ...
   public List<drc.a> a(cpr $$0, BiConsumer<gu, dez> $$1, aru $$2, int $$3, gu $$4, dqm $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = arp.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, arp.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<dsp.a> $$13 = Lists.newArrayList();
      $$13.add(new dsp.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               gu $$21 = $$4.b(arp.a($$19), $$12 - 1, arp.a($$20));
               gu $$22 = $$21.b(5);
      ...
      List<drc.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(cpr $$0, BiConsumer<gu, dez> $$1, aru $$2, gu $$3, gu $$4, boolean $$5, dqm $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            gu $$13 = $$3.b(arp.d(0.5F + (float)$$12 * $$9), arp.d(0.5F + (float)$$12 * $$10), arp.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(cyw.g, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(cpr $$0, BiConsumer<gu, dez> $$1, aru $$2, int $$3, gu $$4, List<dsp.a> $$5, dqm $$6) {
      for (dsp.a $$7 : $$5) {
         int $$8 = $$7.a();
