...
public class ehe extends ehi {
   ...
   public List<efq.a> a(dda $$0, BiConsumer<jd, dta> $$1, ayv $$2, int $$3, jd $$4, efa $$5) {
      ...
      if ($$13.isPresent()) {
         $$6.add(new efq.a(new jd($$11, $$13.getAsInt(), $$12), 1, false));
      }
      ...
      if ($$16 != $$7) {
         ...
         if ($$13.isPresent()) {
            $$6.add(new efq.a(new jd($$11, $$13.getAsInt(), $$12), 0, false));
         }
      }
