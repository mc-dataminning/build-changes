...
public class ehe {
   ...
   public static final ehe.a bv;

   public static ehe.a a(int $$0, int $$1) {
      return $$0 == -1 ? ehe.b.b.a($$1) : ehe.b.a.a($$0);
   }

   public static ehe.a a(String $$0) {
      if (ehe.a.e.containsKey($$0)) {
         return ehe.a.e.get($$0);
      } else {
         for (ehe.b $$1 : ehe.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final ehe.b b;
      private final int c;
      private final aov<sw> d;
      static final Map<String, ehe.a> e = Maps.newHashMap();

      a(String $$0, ehe.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new aov<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      c("key.mouse", ($$0, $$1) -> qm.a().b($$1) ? sw.c($$1) : sw.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<ehe.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, sw> g;

      private static void a(ehe.b $$0, String $$1, int $$2) {
         ehe.a $$3 = new ehe.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public ehe.a a(int $$0) {
         return (ehe.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
