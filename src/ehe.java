...
public class ehe {
   ...
   private final Map<String, ehm> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public ehe(@Nullable eop $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public ud a(ud $$0) {
      ud $$1 = $$0.p("Level");
      dae $$2 = new dae($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dae.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dae.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable eop $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ud $$2 = new ud();

            try {
               $$2 = $$0.a($$1, azj.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               ud $$4 = $$2.p($$3);
               long $$5 = dae.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  ud $$14 = $$2.p($$13);
                  $$12.a(dae.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static ehe a(akl<dax> $$0, @Nullable eop $$1) {
      if ($$0 == dax.h) {
         return new ehe(
            $$1,
         ...
         return new ehe($$1, $$2, $$2);
      } else if ($$0 == dax.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new ehe($$1, $$3, $$3);
      } else {
