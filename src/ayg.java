...
public class ayg {
   ...
   public static final Codec<Vector4f> d = Codec.FLOAT
      .listOf()
      .comapFlatMap(
         $$0 -> ac.a($$0, 4).map($$0x -> new Vector4f((Float)$$0x.get(0), (Float)$$0x.get(1), (Float)$$0x.get(2), (Float)$$0x.get(3))),
   ...
   public static final Codec<Integer> i = Codec.withAlternative(Codec.INT, d, $$0 -> ayi.b.a($$0.w(), $$0.x(), $$0.y(), $$0.z()));
   ...
   public static final Codec<ayg.c> r = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ale.b($$0.substring(1)).map($$0x -> new ayg.c($$0x, true)) : ale.b($$0).map($$0x -> new ayg.c($$0x, false)), ayg.c::c
      );
   ...
   public static final Codec<String> w = Codec.string(0, 16)
      .validate($$0 -> azu.f($$0) ? DataResult.success($$0) : DataResult.error(() -> "Player name contained disallowed characters: '" + $$0 + "'"));
   private static final MapCodec<GameProfile> C = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(kc.e.fieldOf("id").forGetter(GameProfile::getId), w.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   ...
   public static Codec<String> A = Codec.STRING
      .validate($$0 -> !ale.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0));
   ...
   public static <K, V> ayg.b<K, V> b(Codec<K> $$0, Codec<V> $$1) {
      return new ayg.b<>($$0, $$1);
   }
   ...
   public static <T> Codec<jm<T>> b(Codec<jm<T>> $$0) {
      return $$0.validate(
