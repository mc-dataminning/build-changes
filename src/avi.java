...
public abstract class avi<T> extends avj<Map<all, T>> {
   private static final Logger a = LogUtils.getLogger();
   private final DynamicOps<JsonElement> b;
   private final Codec<T> c;
   private final String d;

   protected avi(js.a $$0, Codec<T> $$1, String $$2) {
      this($$0.a(JsonOps.INSTANCE), $$1, $$2);
   }

   protected avi(Codec<T> $$0, String $$1) {
      this(JsonOps.INSTANCE, $$0, $$1);
   }

   private avi(DynamicOps<JsonElement> $$0, Codec<T> $$1, String $$2) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
   }

   protected Map<all, T> a(ave $$0, bor $$1) {
      Map<all, T> $$2 = new HashMap<>();
      a($$0, this.d, this.b, this.c, $$2);
      return $$2;
   }

   public static <T> void a(ave $$0, String $$1, DynamicOps<JsonElement> $$2, Codec<T> $$3, Map<all, T> $$4) {
      ale $$5 = ale.a($$1);

      for (Entry<all, avc> $$6 : $$5.a($$0).entrySet()) {
         all $$7 = $$6.getKey();
         all $$8 = $$5.b($$7);
