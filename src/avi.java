...
public class avi extends avh {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, avi.a> s;
   private final avd t;
   private long u;
   private final ali v;

   private avi(ali $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == ave.c($$2, 7, $$0.getLength());
      }
   }
