...
public class avi extends azn {
   public avi(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", ban.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(ban.s, "minecraft:jukebox");
