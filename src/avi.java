...
public class avi extends avn {
   ...
   private final Set<avj<?>> e = Sets.newHashSet();

   public avi(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   @Override
   public void a(clh $$0, avj<?> $$1, int $$2) {
      super.a($$0, $$1, $$2);
      this.e.add($$1);
   }

   private Set<avj<?>> d() {
      Set<avj<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  ua $$4 = a($$3.getAsJsonObject());
                  $$4 = azf.g.a($$0, $$4, up.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<avj<T>> a(avl<T> $$0, String $$1) {
      return Optional.ofNullable(akh.a($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static ua a(JsonObject $$0) {
      ua $$1 = new ua();
   ...
   protected String b() {
      Map<avl<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avj<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<avj<?>>)$$3.next();
         avj<?> $$2 = (avj<?>)$$1.getKey();
      ...
      for (Entry<avl<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(ld.x.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> akh b(avj<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(aqi $$0) {
      Object2IntMap<avj<?>> $$1 = new Object2IntOpenHashMap();
