...
public class dzk {
   ...
   @Deprecated
   public static dzk a(arx $$0, dzk.a $$1) {
      return new dzk($$0, $$1, false);
   }

   public static dzk a(arx $$0, int $$1, double... $$2) {
      return b($$0, new dzk.a($$1, new DoubleArrayList($$2)));
   }

   public static dzk b(arx $$0, dzk.a $$1) {
      return new dzk($$0, $$1, true);
   }

   private dzk(arx $$0, dzk.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<dzk.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(dzk.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(dzk.a::b))
               .apply($$0, dzk.a::new)
      );
      public static final Codec<hg<dzk.a>> b = aeq.a(je.ax, a);
