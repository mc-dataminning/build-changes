...
public class eeh extends eep<eha> {
   private static final dvx a = dvx.a(dil.I);
   private final dvo b = dil.I.m();
   private final dvo c = dil.jF.m();
   private final dvo d = dil.aV.m();
   private final dvo ao = dil.G.m();

   public eeh(Codec<eha> $$0) {
      super($$0);
   }
   ...
   private static void b(dgd $$0, jh $$1) {
      $$0.a($$1, dil.J.m(), 3);
      $$0.a($$1, dst.N).ifPresent($$1x -> $$1x.a(euc.aX, $$1.a()));
   }
}
