...
public class eeh extends edu<efr> {
   public eeh(Codec<efr> $$0) {
      super($$0);
   }
      ...
      for (int $$19 = -$$14; $$19 < $$14; $$19++) {
         for (int $$20 = -$$14; $$20 < $$14; $$20++) {
            for (int $$21 = -1; $$21 > -$$12; $$21--) {
               int $$22 = $$9 ? azf.f((float)$$14 * (1.0F - (float)Math.pow((double)$$21, 2.0) / ((float)$$12 * 8.0F))) : $$14;
   ...
   private void a(azn $$0, dek $$1, int $$2, int $$3, jf $$4, boolean $$5, int $$6, double $$7, int $$8) {
      int $$9 = $$0.h() ? -1 : 1;
      int $$10 = $$0.h() ? -1 : 1;
   ...
   private void a(int $$0, int $$1, jf $$2, dek $$3, boolean $$4, double $$5, jf $$6, int $$7, int $$8) {
      int $$9 = $$0 + 1 + $$7 / 3;
   ...
   private void a(dek $$0, jf $$1) {
      if ($$0.a_($$1.d()).a(dho.dN)) {
         this.a($$0, $$1.d(), dho.a.n());
      }
   }

   private void a(dek $$0, azn $$1, jf $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, boolean $$9, int $$10, double $$11, boolean $$12, dus $$13) {
      double $$14 = $$9 ? this.a($$4, $$6, jf.c, $$8, this.a($$5, $$3, $$10), $$11) : this.a($$4, $$6, jf.c, $$7, $$1);
      if ($$14 < 0.0) {
         jf $$15 = $$2.b($$4, $$5, $$6);
   ...
   private void a(jf $$0, dek $$1, azn $$2, int $$3, int $$4, boolean $$5, boolean $$6, dus $$7) {
      dus $$8 = $$1.a_($$0);
      if ($$8.l() || $$8.a(dho.dP) || $$8.a(dho.dO) || $$8.a(dho.G)) {
         boolean $$9 = !$$5 || $$2.j() > 0.05;
         int $$10 = $$5 ? 3 : 2;
         if ($$6 && !$$8.a(dho.G) && (double)$$3 <= (double)$$2.a(Math.max(1, $$4 / $$10)) + (double)$$4 * 0.6 && $$9) {
            this.a($$1, $$0, dho.dP.n());
         } else {
            this.a($$1, $$0, $$7);
         }
   ...
   private double a(int $$0, int $$1, jf $$2, int $$3, azn $$4) {
      float $$5 = 10.0F * azf.a($$4.i(), 0.2F, 0.8F) / (float)$$3;
      return (double)$$5 + Math.pow((double)($$0 - $$2.u()), 2.0) + Math.pow((double)($$1 - $$2.w()), 2.0) - Math.pow((double)$$3, 2.0);
   }

   private double a(int $$0, int $$1, jf $$2, int $$3, int $$4, double $$5) {
   ...
   private int a(azn $$0, int $$1, int $$2, int $$3) {
      float $$4 = 3.5F - $$0.i();
   ...
   private int b(azn $$0, int $$1, int $$2, int $$3) {
   ...
   private static boolean c(dus $$0) {
      return $$0.a(dho.iC) || $$0.a(dho.dP) || $$0.a(dho.mW);
   }
   ...
   private void a(dek $$0, jf $$1, int $$2, int $$3, boolean $$4, int $$5) {
      int $$6 = $$4 ? $$5 : $$2 / 2;
         ...
         for (int $$8 = -$$6; $$8 <= $$6; $$8++) {
            for (int $$9 = 0; $$9 <= $$3; $$9++) {
               ...
               if (c($$11) || $$11.a(dho.dN)) {
                  if (this.a((ddo)$$0, $$10)) {
                     this.a($$0, $$10, dho.a.n());
                     this.a($$0, $$10.d(), dho.a.n());
                  } else if (c($$11)) {
                     dus[] $$12 = new dus[]{$$0.a_($$10.h()), $$0.a_($$10.i()), $$0.a_($$10.f()), $$0.a_($$10.g())};
                     int $$13 = 0;
