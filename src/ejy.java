...
public class ejy extends ejm<elx> {
   public ejy(Codec<elx> $$0) {
      super($$0);
   }
      ...
      if (!$$3.a_($$1).a(dmh.ef)) {
            ...
            for (int $$9 = -$$8; $$9 <= $$8; $$9++) {
               ...
               for (int $$11 = -$$8; $$11 <= $$8; $$11++) {
                  ...
                  if (($$9 == 0 && $$11 == 0 || !($$10 * $$10 + $$12 * $$12 > $$7 * $$7))
                     ...
                     eah $$13 = $$3.a_($$1.b($$9, $$6, $$11));
                     if ($$13.l() || b($$13) || $$13.a(dmh.ef) || $$13.a(dmh.ee)) {
                        this.a($$3, $$1.b($$9, $$6, $$11), dmh.je.m());
                     }
         ...
         for (int $$15 = -$$14; $$15 <= $$14; $$15++) {
            for (int $$16 = -$$14; $$16 <= $$14; $$16++) {
               ...
               while ($$17.v() > 50) {
                  eah $$19 = $$3.a_($$17);
                  if (!$$19.l() && !b($$19) && !$$19.a(dmh.ef) && !$$19.a(dmh.ee) && !$$19.a(dmh.je)) {
                     break;
                  }

                  this.a($$3, $$17, dmh.je.m());
                  $$17 = $$17.e();
                  if (--$$18 <= 0) {
                     $$17 = $$17.c($$2.a(5) + 1);
                     $$18 = $$2.a(5);
