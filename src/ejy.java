...
public class ejy {
   ...
   private static final Queue<ejy.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ejy.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ejy::a), ejw::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ejy::a), ejw::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ejy.a(this.b) + ", type=" + ejy.b(this.c) + ", severity=" + ejy.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
