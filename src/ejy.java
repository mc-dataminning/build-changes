...
public class ejy extends ejz {
   ...
   public static final MapCodec<ejy> c = RecordCodecBuilder.mapCodec(
      $$0 -> a($$0).and(ejx.a.fieldOf("mangrove_root_placement").forGetter($$0x -> $$0x.h)).apply($$0, ejy::new)
   );
   private final ejx h;

   public ejy(bro $$0, ekc $$1, Optional<ejw> $$2, ejx $$3) {
      super($$0, $$1, $$2);
      this.h = $$3;
   }

   @Override
   public boolean a(dgn $$0, BiConsumer<ji, dww> $$1, azh $$2, ji $$3, ji $$4, eix $$5) {
   ...
   private boolean a(dgn $$0, azh $$1, ji $$2, jn $$3, ji $$4, List<ji> $$5, int $$6) {
      int $$7 = this.h.e();
      if ($$6 != $$7 && $$5.size() <= $$7) {
