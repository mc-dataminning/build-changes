...
public class ejy extends ekb {
   public static final int a = 854;
   public static final int b = 480;
   static final ejy.b l = new ejy.b(854, 480);

   public ejy(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final ejy.a[] e = values();
   ...
   static class b {
      ...
      static List<ejy.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new ejy.b($$0, $$1), ejy.l) : ImmutableList.of(ejy.l);
      }
