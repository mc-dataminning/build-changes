...
public class bdn extends bgj {
   public bdn(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", bho.B, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(bho.D.typeName(), bjc.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(bho.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(bho.D.typeName(), "minecraft:saddle"));
