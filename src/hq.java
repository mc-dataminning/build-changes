...
public interface hq<T> {
   ...
   hs<T> a(@Nullable ud var1, CommandDispatcher<T> var2) throws eh;
   ...
   static <T extends eg<T>> hq<T> a(akm $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      hr<T> $$4 = new hr<>();
   ...
   static <T extends eg<T>> hh<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new hj.c<>($$2.getString(), $$4.get());
      }
   }
}
