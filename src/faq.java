...
public abstract class faq<T extends faq<T>> {
   ...
   public faq(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fao.a();
         if ($$3 != null) {
         ...
         throw new fbz(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fbz(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fbz(var2.getMessage(), var2);
      }
   }
   ...
   public static faq<?> a(String $$0) {
      return new faq.b($$0, 5000, 60000);
   }

   public static faq<?> a(String $$0, int $$1, int $$2) {
      return new faq.b($$0, $$1, $$2);
   }

   public static faq<?> b(String $$0, String $$1) {
      return new faq.c($$0, $$1, 5000, 60000);
   }

   public static faq<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new faq.c($$0, $$1, $$2, $$3);
   }

   public static faq<?> b(String $$0) {
      return new faq.a($$0, 5000, 60000);
   }

   public static faq<?> c(String $$0, String $$1) {
      return new faq.d($$0, $$1, 5000, 60000);
   }

   public static faq<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new faq.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends faq<faq.a> {
   ...
   public static class b extends faq<faq.b> {
   ...
   public static class c extends faq<faq.c> {
      ...
      public faq.c f() {
         try {
            ...
            throw new fbz(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends faq<faq.d> {
      private final String c;
