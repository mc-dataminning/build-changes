...
public class faq implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<faq.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public faq(List<faq.a> $$0) {
      this.c = $$0;
   }
   ...
   public static faq a(BufferedReader $$0) {
      return new faq($$0.lines().flatMap($$0x -> faq.a.a($$0x).stream()).toList());
   }

   public static record a(faq.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<faq.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new faq.a(faq.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new faq.a(faq.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new faq.a(faq.b.b, $$3));
      ...
      static faq.a b(String $$0) {
         return new faq.a(faq.b.a, "glob:" + $$0);
      }

      static faq.a c(String $$0) {
         return new faq.a(faq.b.a, "regex:" + $$0);
      }

      static faq.a d(String $$0) {
         return new faq.a(faq.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      faq.b a = FileSystem::getPathMatcher;
      faq.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
