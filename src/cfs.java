...
public class cfs extends cfg {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new esj($$0, this.g.dt() + $$5, $$1);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               esj $$8 = new esj(this.g.dr() - this.a.dr(), 0.0, this.g.dx() - this.a.dx()).d();
               esj $$9 = new esj((double)axm.a(this.a.dC() * (float) (Math.PI / 180.0)), 0.0, (double)(-axm.b(this.a.dC() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  esj $$13 = this.a.f(1.0F);
                  ...
                  ckj $$20 = new ckj(this.a.dM(), this.a, $$17, $$18, $$19);
   ...
   public void a(bqt $$0) {
      ...
      int $$9 = axm.a(this.g.dt() + $$8);
      eln $$10 = new eln($$3, $$9, $$4);
