...
public class dnw extends dnq<dpv> {
   private static final ha[] a = ha.values();

   public dnw(Codec<dpv> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dns<dpv> $$0) {
      dpv $$1 = $$0.f();
      ash $$2 = $$0.d();
      gw $$3 = $$0.e();
      cqv $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dll $$9 = new dll(new dkn($$4.A()));
      dzj $$10 = dzj.a($$9, -4, 1.0);
      ...
      for (gw $$33 : gw.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<gw, Integer> $$37 : $$7) {
            $$35 += asb.f($$33.j((hy)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (gw $$38 : $$11) {
            $$36 += asb.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, cte.a.o(), $$32);
      ...
      for (gw $$44 : $$31) {
         ...
         for (ha $$46 : a) {
            ...
            dfd $$48 = $$4.a_($$47);
            if ($$45.b(dft.C)) {
               $$45 = $$45.a(dft.C, Boolean.valueOf($$48.u().b()));
            }
