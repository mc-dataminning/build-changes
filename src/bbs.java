...
public class bbs extends bee {
   ...
   public bbs(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityPaintingMotiveFix", bff.z, "minecraft:painting");
   }
   ...
   public Dynamic<?> a(Dynamic<?> $$0) {
      ...
      if ($$1.isPresent()) {
         ...
         return $$0.set("Motive", $$0.createString(new ajv(a.getOrDefault($$2, $$2)).toString()));
      } else {
         return $$0;
      }
   }
