...
public class bbs extends bgn {
   public bbs(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bhs.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bhs.s, "minecraft:piston");
