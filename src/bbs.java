...
public class bbs {
   ...
   protected bbs(String $$0, bbr $$1, DoubleSupplier $$2, @Nullable Runnable $$3, @Nullable bbs.c $$4) {
      this.b = $$0;
      this.c = $$1;
      this.h = $$3;
      this.d = $$2;
   ...
   public static <T> bbs.a<T> a(String $$0, bbr $$1, ToDoubleFunction<T> $$2, T $$3) {
      return new bbs.a<>($$0, $$1, $$2, $$3);
   }
   ...
   public static class a<T> {
      ...
      public bbs.a<T> a(Consumer<T> $$0) {
         this.e = () -> $$0.accept(this.d);
         return this;
      }

      public bbs.a<T> a(bbs.c $$0) {
         this.f = $$0;
         return this;
      }
   ...
   public static class d implements bbs.c {
