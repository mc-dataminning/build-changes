...
public class fqc extends fps<crt> {
   ...
   private final fph Y = new fph(0);
   private final fph Z = new fph(1);
   private final fph aa = new fph(2);
   @Nullable
   private ciw ab;

   public fqc(crt $$0, cmw $$1, wz $$2) {
   ...
   protected void E() {
      ...
      this.ab.aY = 210.0F;
      this.ab.u(25.0F);
      this.ab.ba = this.ab.dF();
      this.ab.bb = this.ab.dF();
      this.b(this.x.b(3).g());
   }
   ...
   protected void a(fhx $$0, float $$1, int $$2, int $$3) {
      ...
      fpr.a($$0, (float)(this.A + 141), (float)(this.B + 75), 25.0F, T, U, null, this.ab);
   }
   ...
   private void d(fhx $$0, int $$1, int $$2) {
