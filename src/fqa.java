...
public class fqa implements hjt {
   private static final long a = 3000L;
   private final fli b;
   private final List<fqa.b> c = Lists.newArrayList();
   private boolean d;
   private final List<fqa.b> e = new ArrayList<>();
   ...
   public void a(fod $$0) {
      ...
      if (this.d) {
         ...
         if (!this.e.isEmpty()) {
            ...
            Iterator<fqa.b> $$10 = this.e.iterator();
   ...
   @Override
   public void a(hio $$0, hjv $$1, float $$2) {
      if ($$1.a() != null) {
         wp $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fqa.b $$4 : this.c) {
               if ($$4.a().equals($$3)) {
                  $$4.b(new faz($$0.h(), $$0.i(), $$0.j()));
                  return;
               }
            }
         }

         this.c.add(new fqa.b($$3, $$2, new faz($$0.h(), $$0.i(), $$0.j())));
      }
   }

   static record a(faz a, long b) {
   }

   static class b {
      private final wp a;
      private final float b;
      private final List<fqa.a> c = new ArrayList<>();

      public b(wp $$0, float $$1, faz $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c.add(new fqa.a($$2, af.c()));
      }
