...
public class fqa implements hjn {
   ...
   @Override
   public void a(hii $$0, hjp $$1, float $$2) {
      if ($$1.a() != null) {
         wo $$3 = $$1.a();
         if (!this.c.isEmpty()) {
            for (fqa.b $$4 : this.c) {
         ...
         this.c.add(new fqa.b($$3, $$2, new fba($$0.h(), $$0.i(), $$0.j())));
      }
   }
