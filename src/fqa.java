public class fqa extends fpn<cpx> implements fsl {
   private static final akt D = new akt("textures/gui/container/crafting_table.png");
   private final fsf E = new fsf();
   private boolean F;

   public fqa(cpx $$0, clx $$1, xe $$2) {
      super($$0, $$1, $$2);
   }
   ...
   protected void aN_() {
      ...
      this.c(new fiz(this.z + 5, this.o / 2 - 49, 20, 18, fsf.a, $$0 -> {
         this.E.e();
         this.z = this.E.a(this.n, this.c);
