public class fqa extends fpm {
   private static final int a = 12235202;

   protected fqa(fnr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, frp $$8) {
   ...
   public static class a implements fqx<ka> {
      ...
      public fqu a(ka $$0, fnr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fqa($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.0F, this.a);
      }
   }
}
