...
public class fsm {
   ...
   private fsm.a l = fsm.a.c;
   @Nullable
   private byte[] m;
   private fsm.c n;
   private fsm.b o = fsm.b.a;

   public fsm(String $$0, String $$1, fsm.c $$2) {
      this.a = $$0;
      this.b = $$1;
      this.n = $$2;
   }
   ...
   public static fsm a(ta $$0) {
      fsm $$1 = new fsm($$0.l("name"), $$0.l("ip"), fsm.c.c);
      if ($$0.b("icon", 8)) {
         try {
   ...
   public boolean d() {
      return this.n == fsm.c.a;
   }

   public boolean e() {
      return this.n == fsm.c.b;
   }
