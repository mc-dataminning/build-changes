...
public class cmf {
   ...
   public static OptionalInt a(arf $$0, iz $$1, arg $$2) {
      if (a($$0, $$1)) {
         ...
         if ($$3.stream().anyMatch($$0x -> $$0x.aa().map(cmf::d).orElse(false))) {
            return OptionalInt.empty();
         } else {
            Optional<cmf> $$4 = $$3.stream().flatMap($$0x -> $$0x.aa().stream()).max(Comparator.comparingInt(cmf::c));
            if ($$4.isPresent()) {
               cmf $$5 = $$4.get();
               $$5.e();
   ...
   private static boolean a(arf $$0, iz $$1) {
      evo $$2 = evo.a(evt.b($$1), 48.0, 48.0, 48.0);
      return !$$0.a(cmd.class, $$2).isEmpty();
   }

   private static List<arg> b(arf $$0, iz $$1) {
      evt $$2 = evt.b($$1);
      Predicate<arg> $$3 = $$1x -> $$1x.dn().a((js)$$2, 16.0);
      return $$0.a($$3.and(btr::bD).and(btb.f));
   }
