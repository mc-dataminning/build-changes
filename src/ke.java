...
public class ke implements jk {
   ...
   private final Set<aeu> f;
   private final List<ke.a> g;

   public ke(jm $$0, Set<aeu> $$1, List<ke.a> $$2) {
   ...
   public CompletableFuture<?> a(ji $$0) {
      final Map<aeu, ect> $$1 = Maps.newHashMap();
      Map<dlc.a, aeu> $$2 = new Object2ObjectOpenHashMap();
      this.g.forEach($$2x -> $$2x.a().get().generate(($$3x, $$4) -> {
            aeu $$5x = $$2.put(bgy.a($$3x), $$3x);
            if ($$5x != null) {
      ...
      ecu $$3 = new ecu(eev.n, new ecp() {
         @Nullable
         @Override
         public <T> T getElement(ecn<T> $$0) {
            return (T)($$0.a() == ecq.c ? $$1.get($$0.b()) : null);
         }
      });

      for (aeu $$5 : Sets.difference(this.f, $$1.keySet())) {
         $$3.a("Missing built-in table: " + $$5);
      }

      $$1.forEach(($$1x, $$2x) -> $$2x.a($$3.a($$2x.a()).a("{" + $$1x + "}", new ecn<>(ecq.c, $$1x))));
      ...
      if (!$$6.isEmpty()) {
         ...
         return CompletableFuture.allOf($$1.entrySet().stream().map($$1x -> {
            aeu $$2x = (aeu)$$1x.getKey();
            ect $$3x = (ect)$$1x.getValue();
            Path $$4 = this.e.a($$2x);
            return jk.a($$0, ect.c, $$3x, $$4);
   ...
   public static record a(Supplier<kf> a, eeu b) {
   }
}
