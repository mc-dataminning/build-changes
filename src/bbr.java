...
public class bbr extends bgj {
   public bbr(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bho.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bho.s, "minecraft:jukebox");
