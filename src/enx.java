...
public class enx extends eod {
   public static final MapCodec<enx> a = Codec.floatRange(0.0F, 1.0F).fieldOf("probability").xmap(enx::new, $$0 -> $$0.d);
      ...
      if (!$$2.isEmpty()) {
         ...
         if (!($$3.i() >= this.d)) {
            ...
            if (!$$5.isEmpty()) {
               ...
               if (!$$6.isEmpty()) {
                  $$0.a($$6.get(), dmc.pJ.m().b(dlu.b, b));
                  $$0.a().a($$6.get(), dwz.I).ifPresent($$1x -> {
                     int $$2x = 2 + $$3.a(2);

                     for (int $$3x = 0; $$3x < $$2x; $$3x++) {
                        $$1x.a(dwu.c.a($$3.a(599)));
                     }
                  });
               }
            }
