...
public class enx {
   ...
   public void a(eph $$0, String $$1, eqd.a $$2, eeb $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  enx.b $$13 = new enx.b($$1.trim(), this.f, $$3, $$2);
                  enx.a $$14 = new enx.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        enx.c $$30 = new enx.c(this.f, $$2, $$0);
                        enx.a $$31 = new enx.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new epl(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eeb $$2) throws IOException {
      ...
      File $$15 = new File(esr.N().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, eeb $$2, eqd.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((enx.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !enx.this.b && !enx.this.d) {
            try {
               enx.this.e = true;
               enx.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               enx.a.error("Error extracting archive", var3);
               enx.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final eqd.a c;
      private final eph d;

      c(File $$0, eqd.a $$1, eph $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((enx.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !enx.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, enx.this.g);
                  enx.this.c = true;
               } else {
                  enx.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  enx.this.d = true;
               }
            } catch (IOException var3) {
               enx.a.error("Error copying resourcepack file: {}", var3.getMessage());
               enx.this.d = true;
            }
         }
      }
