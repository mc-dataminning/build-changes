...
public class esw {
   ...
   static class b {
      static final Optional<esw> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static esw a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new esw();
      }
   }
}
