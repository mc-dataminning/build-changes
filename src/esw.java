...
public class esw implements edi.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<esw> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final azx<esw> a = azx.a(f);
   private final eta g;
   private final eta h;
   private final eta i;
   ...
   public static esw a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new esw(new eeq(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private esw(eta $$0, eta $$1, eta $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public esw(bam $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eta.a($$0, IntStream.rangeClosed(-15, 0)),
         eta.a($$0, IntStream.rangeClosed(-15, 0)),
         eta.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public esw a(bam $$0) {
      return new esw($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(edi.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         esx $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eta.b($$4 * $$13), eta.b($$5 * $$13), eta.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eta.b($$1 * $$13);
         double $$21 = eta.b($$2 * $$13);
         double $$22 = eta.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            esx $$24 = this.g.a($$19);
            if ($$24 != null) {
