...
public class esw implements edh.d {
   ...
   public static final ays<esw> a = ays.a(f);
   private final eta g;
   private final eta h;
   private final eta i;
   ...
   public static esw a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new esw(new eep(0L), $$0, $$1, $$2, $$3, $$4);
   }
   ...
   @VisibleForTesting
   public esw(azh $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
