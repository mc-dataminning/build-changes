...
public class esw {
   ...
   public static final esw.a bv;

   public static esw.a a(int $$0, int $$1) {
      return $$0 == -1 ? esw.b.b.a($$1) : esw.b.a.a($$0);
   }

   public static esw.a a(String $$0) {
      if (esw.a.e.containsKey($$0)) {
         return esw.a.e.get($$0);
      } else {
         for (esw.b $$1 : esw.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final esw.b b;
      private final int c;
      private final awr<vu> d;
      static final Map<String, esw.a> e = Maps.newHashMap();

      a(String $$0, esw.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new awr<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? vu.b($$2.toUpperCase(Locale.ROOT)) : vu.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? vu.b($$2) : vu.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> sv.a().b($$1) ? vu.c($$1) : vu.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<esw.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vu> g;

      private static void a(esw.b $$0, String $$1, int $$2) {
         esw.a $$3 = new esw.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, vu> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public esw.a a(int $$0) {
         return (esw.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
