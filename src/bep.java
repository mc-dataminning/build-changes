...
public record bep(Instant a, String b, long c) {
   ...
   public static bep a(RecordedEvent $$0) {
      ...
      return new bep($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bep.a a(List<bep> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bep>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bep $$3 = (bep)$$2x.get(0);
            bep $$4 = (bep)$$2x.get($$2x.size() - 1);
