...
public enum h implements bab {
   ...
   public jk a(jk $$0) {
      if (this.Z == null) {
         this.Z = Maps.newEnumMap(jk.class);
         jk.a[] $$1 = jk.a.values();

         for (jk $$2 : jk.values()) {
            jk.a $$3 = $$2.o();
            jk.b $$4 = $$2.f();
            jk.a $$5 = $$1[this.ad.a($$3.ordinal())];
            jk.b $$6 = this.a($$5) ? $$4.c() : $$4;
            jk $$7 = jk.a($$5, $$6);
            this.Z.put($$2, $$7);
         }
      }
   ...
   public jm a(jm $$0) {
      return jm.a(this.a($$0.a()), this.a($$0.b()));
   }
}
