...
public enum h implements asr {
   ...
   public hc a(hc $$0) {
      if (this.Z == null) {
         this.Z = Maps.newEnumMap(hc.class);
         hc.a[] $$1 = hc.a.values();

         for (hc $$2 : hc.values()) {
            hc.a $$3 = $$2.o();
            hc.b $$4 = $$2.f();
            hc.a $$5 = $$1[this.ad.a($$3.ordinal())];
            hc.b $$6 = this.a($$5) ? $$4.c() : $$4;
            hc $$7 = hc.a($$5, $$6);
            this.Z.put($$2, $$7);
         }
      }
   ...
   public he a(he $$0) {
      return he.a(this.a($$0.a()), this.a($$0.b()));
   }
}
