...
public enum h implements auk {
   ...
   public ib a(ib $$0) {
      if (this.Z == null) {
         this.Z = Maps.newEnumMap(ib.class);
         ib.a[] $$1 = ib.a.values();

         for (ib $$2 : ib.values()) {
            ib.a $$3 = $$2.o();
            ib.b $$4 = $$2.f();
            ib.a $$5 = $$1[this.ad.a($$3.ordinal())];
            ib.b $$6 = this.a($$5) ? $$4.c() : $$4;
            ib $$7 = ib.a($$5, $$6);
            this.Z.put($$2, $$7);
         }
      }
   ...
   public id a(id $$0) {
      return id.a(this.a($$0.a()), this.a($$0.b()));
   }
}
