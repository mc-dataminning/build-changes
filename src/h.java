...
public enum h implements baf {
   ...
   public jl a(jl $$0) {
      if (this.Z == null) {
         this.Z = Maps.newEnumMap(jl.class);
         jl.a[] $$1 = jl.a.values();

         for (jl $$2 : jl.values()) {
            jl.a $$3 = $$2.o();
            jl.b $$4 = $$2.f();
            jl.a $$5 = $$1[this.ad.a($$3.ordinal())];
            jl.b $$6 = this.a($$5) ? $$4.c() : $$4;
            jl $$7 = jl.a($$5, $$6);
            this.Z.put($$2, $$7);
         }
      }
   ...
   public jn a(jn $$0) {
      return jn.a(this.a($$0.a()), this.a($$0.b()));
   }
}
