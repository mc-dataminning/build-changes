...
public enum h implements aye {
   ...
   public ih a(ih $$0) {
      if (this.Z == null) {
         this.Z = Maps.newEnumMap(ih.class);
         ih.a[] $$1 = ih.a.values();

         for (ih $$2 : ih.values()) {
            ih.a $$3 = $$2.o();
            ih.b $$4 = $$2.f();
            ih.a $$5 = $$1[this.ad.a($$3.ordinal())];
            ih.b $$6 = this.a($$5) ? $$4.c() : $$4;
            ih $$7 = ih.a($$5, $$6);
            this.Z.put($$2, $$7);
         }
      }
   ...
   public ij a(ij $$0) {
      return ij.a(this.a($$0.a()), this.a($$0.b()));
   }
}
