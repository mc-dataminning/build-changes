...
public enum h implements aut {
   ...
   public ia a(ia $$0) {
      if (this.Z == null) {
         this.Z = Maps.newEnumMap(ia.class);
         ia.a[] $$1 = ia.a.values();

         for (ia $$2 : ia.values()) {
            ia.a $$3 = $$2.o();
            ia.b $$4 = $$2.f();
            ia.a $$5 = $$1[this.ad.a($$3.ordinal())];
            ia.b $$6 = this.a($$5) ? $$4.c() : $$4;
            ia $$7 = ia.a($$5, $$6);
            this.Z.put($$2, $$7);
         }
      }
   ...
   public ic a(ic $$0) {
      return ic.a(this.a($$0.a()), this.a($$0.b()));
   }
}
