...
public enum h implements ayg {
   ...
   public ij a(ij $$0) {
      if (this.Z == null) {
         this.Z = Maps.newEnumMap(ij.class);
         ij.a[] $$1 = ij.a.values();

         for (ij $$2 : ij.values()) {
            ij.a $$3 = $$2.o();
            ij.b $$4 = $$2.f();
            ij.a $$5 = $$1[this.ad.a($$3.ordinal())];
            ij.b $$6 = this.a($$5) ? $$4.c() : $$4;
            ij $$7 = ij.a($$5, $$6);
            this.Z.put($$2, $$7);
         }
      }
   ...
   public il a(il $$0) {
      return il.a(this.a($$0.a()), this.a($$0.b()));
   }
}
