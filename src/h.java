...
public enum h implements aug {
   ...
   public hx a(hx $$0) {
      if (this.Z == null) {
         this.Z = Maps.newEnumMap(hx.class);
         hx.a[] $$1 = hx.a.values();

         for (hx $$2 : hx.values()) {
            hx.a $$3 = $$2.o();
            hx.b $$4 = $$2.f();
            hx.a $$5 = $$1[this.ad.a($$3.ordinal())];
            hx.b $$6 = this.a($$5) ? $$4.c() : $$4;
            hx $$7 = hx.a($$5, $$6);
            this.Z.put($$2, $$7);
         }
      }
   ...
   public hz a(hz $$0) {
      return hz.a(this.a($$0.a()), this.a($$0.b()));
   }
}
