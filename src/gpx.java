...
public class gpx extends gpy {
   @Nullable
   private CompletableFuture<gpy.a> f;

   public gpx(aud $$0, akq $$1, Executor $$2) {
      super($$1);
      this.f = CompletableFuture.supplyAsync(() -> gpy.a.a($$0, $$1), $$2);
   }
   ...
   public void a(gqg $$0, aud $$1, akq $$2, Executor $$3) {
      this.f = CompletableFuture.supplyAsync(() -> gpy.a.a($$1, this.e), ad.g());
