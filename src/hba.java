...
public class hba implements hbd.a, AutoCloseable {
   ...
   ffl[] f;
   @Nullable
   private final hba.a g;
   private final avn h;

   public hba(alp $$0, hcu $$1, ffl $$2, avn $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      hcs $$4 = $$3.a(hcs.a).orElse(hcs.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ffl[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = hav.a(this.f, $$0);
   ...
   @Nullable
   private hba.a a(hcu $$0, int $$1, int $$2, hcs $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<hba.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new hba.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new hba.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<hba.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            hba.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new hba.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ffl[] $$4) {
   ...
   class a {
      ...
      a(final List<hba.b> $$0, final int $$1, final boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * hba.this.c;
         int $$4 = this.b($$2) * hba.this.d;
         hba.this.a($$0, $$1, $$3, $$4, hba.this.f);
      }

      public hbc a() {
         return hba.this.new d(this, this.d ? hba.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ffl[] b = new ffl[hba.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = hba.this.c >> $$0;
            int $$2 = hba.this.d >> $$0;
            this.b[$$0] = new ffl($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, hba.d $$2) {
         hba.a $$3 = $$2.c;
         List<hba.b> $$4 = $$3.b;
         hba.b $$5 = $$4.get($$2.a);
            ...
            for (int $$9 = 0; $$9 < this.b.length; $$9++) {
               ...
               for (int $$12 = 0; $$12 < $$11; $$12++) {
                  for (int $$13 = 0; $$13 < $$10; $$13++) {
                     ...
                     this.b[$$9].a($$13, $$12, ayf.a($$6, $$14, $$15));
                  }
               }
            }

            hba.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(hba.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return hba.this.f[$$2].a($$3 + ($$0.a($$1) * hba.this.c >> $$2), $$4 + ($$0.b($$1) * hba.this.d >> $$2));
      }
   ...
   class d implements hbc {
      int a;
      int b;
      final hba.a c;
      @Nullable
      private final hba.c d;

      d(final hba.a $$0, @Nullable final hba.c $$1) {
         this.c = $$0;
         this.d = $$1;
      }
