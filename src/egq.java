...
public class egq implements egr, egs {
   ...
   public egq(ctt $$0, dpo $$1, egq.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         0,
   ...
   public static <T> egq a(Dynamic<T> $$0, ctt $$1, egq.a $$2, dpo $$3, Lifecycle $$4) {
      ...
      return new egq(
         ...
         new elg<>(elf.a, $$0.get("ScheduledEvents").asStream()),
         (sn)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(dmt.a.a).resultOrPartial(f::error).orElse(dmt.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(iu $$0, sn $$1, @Nullable sn $$2) {
      ...
      dpm.a($$4, this.h, $$0).resultOrPartial(ac.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", ac.a(dmt.a.a.encodeStart(tb.a, this.A), IllegalStateException::new));
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }

      DataResult<tk> $$5 = cuj.b.encodeStart(tb.a, this.g.g());
   ...
   @Override
   public boolean B() {
      return this.i == egq.a.b;
   }

   @Override
   public boolean C() {
      return this.i == egq.a.c;
   }
