...
public class egq implements egx.c {
   ...
   private final ObjectListIterator<egq.a> h;
   private final ObjectListIterator<ete> i;

   public static egq a(dkt $$0, djc $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<egq.a> $$4 = new ObjectArrayList(10);
      ObjectList<ete> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != esm.a).forEach($$5x -> {
         esm $$6 = $$5x.h().d();
         ...
         for (esf $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof erx) {
                  ...
                  $$4.add(new egq.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new egq($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public egq(ObjectListIterator<egq.a> $$0, ObjectListIterator<ete> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   private static double a(double $$0, double $$1, double $$2) {
      double $$3 = azo.g($$0, $$1, $$2);
      return azo.a($$3, 0.0, 6.0, 1.0, 0.0);
   }
   ...
   private static double a(int $$0, int $$1, int $$2, int $$3) {
      ...
      if (a($$4) && a($$5) && a($$6)) {
         ...
         double $$8 = azo.f((double)$$0, $$7, (double)$$2);
         double $$9 = -$$7 * azo.g($$8 / 2.0) / 2.0;
   ...
   private static double a(int $$0, double $$1, int $$2) {
      double $$3 = azo.f((double)$$0, $$1, (double)$$2);
      return Math.pow(Math.E, -$$3 / 16.0);
   }

   @VisibleForTesting
   public static record a(ert a, esm b, int c) {
   }
}
