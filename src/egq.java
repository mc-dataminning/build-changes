...
public class egq extends efz<eik> {
   private static final Logger a = LogUtils.getLogger();
   private static final but<?>[] b = new but[]{but.be, but.bN, but.bN, but.bn};
   private static final dwy c = djp.nE.m();

   public egq(Codec<eik> $$0) {
      super($$0);
   }

   @Override
   public boolean a(egb<eik> $$0) {
      Predicate<dwy> $$1 = efz.a(awp.bQ);
      ji $$2 = $$0.e();
      azh $$3 = $$0.d();
      dhh $$4 = $$0.b();
      int $$5 = 3;
      ...
      if ($$14 >= 1 && $$14 <= 5) {
               ...
               for (int $$22 = $$12; $$22 <= $$13; $$22++) {
                  ...
                  if ($$20 == $$7 || $$21 == -1 || $$22 == $$12 || $$20 == $$8 || $$21 == 4 || $$22 == $$13) {
                     if ($$23.v() >= $$4.L_() && !$$4.a_($$23.e()).e()) {
                        $$4.a($$23, c, 2);
                     } else if ($$24.e() && !$$24.a(djp.cD)) {
                        if ($$21 == -1 && $$3.a(4) != 0) {
                           this.a($$4, $$23, djp.cu.m(), $$1);
                        } else {
                           this.a($$4, $$23, djp.m.m(), $$1);
                        }
                     }
                  } else if (!$$24.a(djp.cD) && !$$24.a(djp.cA)) {
                     this.a($$4, $$23, c, $$1);
                  }
               }
            }
         ...
         for (int $$25 = 0; $$25 < 2; $$25++) {
            for (int $$26 = 0; $$26 < 3; $$26++) {
               ...
               if ($$4.u($$30)) {
                  ...
                  if ($$31 == 1) {
                     this.a($$4, $$30, enr.a($$4, $$30, djp.cD.m()), $$1);
                     bsr.a($$4, $$3, $$30, evo.c);
                     break;
                  }
               }
         ...
         this.a($$4, $$2, djp.cA.m(), $$1);
         if ($$4.c_($$2) instanceof dvr $$34) {
            $$34.a(this.a($$3), $$3);
         } else {
