...
public class egq<T> {
   ...
   private final egp<T> e;
   private final Queue<egq.a<T>> f = new PriorityQueue<>(c());
   private UnsignedLong g = UnsignedLong.ZERO;
   private final Table<String, Long, egq.a<T>> h = HashBasedTable.create();

   private static <T> Comparator<egq.a<T>> c() {
      return Comparator.<egq.a<T>>comparingLong($$0 -> $$0.a).thenComparing($$0 -> $$0.b);
   }

   public egq(egp<T> $$0, Stream<? extends Dynamic<?>> $$1) {
      this($$0);
      this.f.clear();
      this.h.clear();
   ...
   public void a(String $$0, long $$1, ego<T> $$2) {
      if (!this.h.contains($$0, $$1)) {
         this.g = this.g.plus(UnsignedLong.ONE);
         egq.a<T> $$3 = new egq.a<>($$1, this.g, $$0, $$2);
         this.h.put($$0, $$1, $$3);
         this.f.add($$3);
      }
   }
   ...
   public int a(String $$0) {
      Collection<egq.a<T>> $$1 = this.h.row($$0).values();
   ...
   public static class a<T> {
      ...
      public final ego<T> d;

      a(long $$0, UnsignedLong $$1, String $$2, ego<T> $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
