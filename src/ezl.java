public abstract class ezl<T extends ceo> extends ezk<T> implements fce {
   public final fbu x;
   private boolean y;
   private final aey z;
   private final aey A;
   ...
   public ezl(T $$0, fbu $$1, cbv $$2, tn $$3, aey $$4, aey $$5, aey $$6) {
      super($$0, $$2, $$3);
      this.x = $$1;
      this.z = $$4;
      this.A = $$5;
   ...
   public void aH_() {
      ...
      this.d(new ete(this.t + 20, this.h / 2 - 49, 20, 18, fby.a, $$0 -> {
         this.x.f();
         this.t = this.x.a(this.g, this.c);
   ...
   protected void a(esh $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.p.s()) {
         int $$6 = 14;
         int $$7 = ary.f(this.p.r() * 13.0F) + 1;
         $$0.a(this.A, 14, 14, 0, 14 - $$7, $$4 + 56, $$5 + 36 + 14 - $$7, 14, $$7);
      }

      int $$8 = 24;
      int $$9 = ary.f(this.p.q() * 24.0F);
