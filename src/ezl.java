...
public class ezl implements ezm, ezn {
   ...
   private final fep<MinecraftServer> G;
   ...
   public ezl(djq $$0, ehq $$1, ezl.a $$2, Lifecycle $$3) {
      this(
         null,
         false,
         iv.c,
   ...
   public static <T> ezl a(Dynamic<T> $$0, djq $$1, ezl.a $$2, ehq $$3, Lifecycle $$4) {
      ...
      return new ezl(
         ...
         new fep<>(feo.a, $$0.get("ScheduledEvents").asStream()),
         (tz)$$0.get("CustomBossEvents").orElseEmptyMap().getValue(),
         $$0.get("DragonFight").read(eet.a.a).resultOrPartial(f::error).orElse(eet.a.b),
         $$1,
         $$3,
         $$2,
         $$4
   ...
   private void a(jt $$0, tz $$1, @Nullable tz $$2) {
      ...
      eho.a($$4, this.h, $$0).resultOrPartial(ag.a("WorldGenSettings: ", f::error)).ifPresent($$1x -> $$1.a("WorldGenSettings", $$1x));
      ...
      $$1.a("DragonFight", eet.a.a, this.y);
      if ($$2 != null) {
         $$1.a("Player", $$2);
      }
   ...
   @Override
   public boolean z() {
      return this.i == ezl.a.b;
   }

   @Override
   public boolean A() {
      return this.i == ezl.a.c;
   }
