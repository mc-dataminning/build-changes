public class ezl extends fai<cen> {
   private static final aew x = new aew("container/anvil/text_field");
   private static final aew y = new aew("container/anvil/text_field_disabled");
   private static final aew z = new aew("container/anvil/error");
   private static final aew A = new aew("textures/gui/container/anvil.png");
