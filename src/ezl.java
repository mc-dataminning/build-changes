...
public class ezl extends ezd {
   private static final Logger a = LogUtils.getLogger();
   private static final afw b = new afw("textures/misc/vignette.png");
   private static final ui c = ui.b("============").a(n.p);
   ...
   private int z;
   private final eua A = new eua(false);

   public ezl(boolean $$0, Runnable $$1) {
      super(erg.a);
      this.o = $$0;
      this.p = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, ezl.a $$1) {
      try (Reader $$2 = this.f.Z().openAsReader(new afw($$0))) {
         $$1.read($$2);
   ...
   private void b(Reader $$0) {
      for (JsonElement $$2 : aso.b($$0)) {
         JsonObject $$3 = $$2.getAsJsonObject();
         String $$4 = $$3.get("section").getAsString();
         this.a(c, true);
         this.a(ui.b($$4).a(n.o), true);
         this.a(c, true);
         this.D();
         this.D();
         ...
         for (JsonElement $$6 : $$3.getAsJsonArray("disciplines")) {
            ...
            for (JsonElement $$10 : $$7.getAsJsonArray("titles")) {
               ...
               this.a(ui.b($$12).a(n.h), false);

               for (JsonElement $$14 : $$13) {
                  String $$15 = $$14.getAsString();
                  this.a(ui.b("           ").f($$15).a(n.p), false);
               }
   ...
   private void a(String $$0) {
      this.s.addAll(this.f.h.c(ui.b($$0), 256));
   }

   private void a(ui $$0, boolean $$1) {
      if ($$1) {
