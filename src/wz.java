...
public class wz implements vf<wy> {
   ...
   public wz(bis $$0, int $$1) {
      this($$0.ah(), $$0.cv(), $$0.dq(), $$0.ds(), $$0.dw(), $$0.dD(), $$0.dB(), $$0.ag(), $$1, $$0.do(), (double)$$0.co());
   }

   public wz(bis $$0, int $$1, gw $$2) {
      this($$0.ah(), $$0.cv(), (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), $$0.dD(), $$0.dB(), $$0.ag(), $$1, $$0.do(), (double)$$0.co());
   }

   public wz(int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, biw<?> $$7, int $$8, ehp $$9, double $$10) {
      this.c = $$0;
      this.d = $$1;
      this.f = $$2;
      this.g = $$3;
      this.h = $$4;
      this.l = (byte)ary.d($$5 * 256.0F / 360.0F);
      this.m = (byte)ary.d($$6 * 256.0F / 360.0F);
      this.n = (byte)ary.a($$10 * 256.0 / 360.0);
      this.e = $$7;
      this.o = $$8;
      this.i = (int)(ary.a($$9.c, -3.9, 3.9) * 8000.0);
      this.j = (int)(ary.a($$9.d, -3.9, 3.9) * 8000.0);
      this.k = (int)(ary.a($$9.e, -3.9, 3.9) * 8000.0);
   }
