...
public class ako extends dhj {
   private static final List<dhk> b = dhk.a();
   private final aki c;
   final akq d;
   final Thread e;
   final akt f;
   private final ako.b g;
   public final aka a;
   private final ecc h;
   private long i;
   ...
   public ako(akq $$0, ecg.c $$1, DataFixer $$2, dzc $$3, Executor $$4, dhg $$5, int $$6, int $$7, boolean $$8, akz $$9, diz $$10, Supplier<ecc> $$11) {
      this.d = $$0;
      this.g = new ako.b($$0);
      ...
      $$12.mkdirs();
      this.h = new ecc($$12, $$2);
      this.a = new aka($$0, $$1, $$2, $$3, $$4, this.g, this, $$5, $$9, $$10, $$11, $$6, $$8);
      this.f = this.a.e();
      this.c = this.a.j();
      this.c.b($$7);
      this.r();
   ...
   public dhf a(int $$0, int $$1, dhk $$2, boolean $$3) {
      if (Thread.currentThread() != this.e) {
         ...
         CompletableFuture<Either<dhf, ajy.a>> $$8 = this.c($$0, $$1, $$2, $$3);
         this.g.c($$8::isDone);
   ...
   public dhq a(int $$0, int $$1) {
      if (Thread.currentThread() != this.e) {
         ...
         if ($$5 == null) {
            ...
            Either<dhf, ajy.a> $$6 = $$5.b(dhk.n).getNow(null);
            if ($$6 == null) {
               return null;
            } else {
   ...
   public CompletableFuture<Either<dhf, ajy.a>> b(int $$0, int $$1, dhk $$2, boolean $$3) {
      boolean $$4 = Thread.currentThread() == this.e;
      CompletableFuture<Either<dhf, ajy.a>> $$5;
      if ($$4) {
         $$5 = this.c($$0, $$1, $$2, $$3);
         this.g.c($$5::isDone);
      } else {
         $$5 = CompletableFuture.<CompletableFuture<Either<dhf, ajy.a>>>supplyAsync(() -> this.c($$0, $$1, $$2, $$3), this.g).thenCompose($$0x -> $$0x);
      }

      return $$5;
   }

   private CompletableFuture<Either<dhf, ajy.a>> c(int $$0, int $$1, dhk $$2, boolean $$3) {
      cpc $$4 = new cpc($$0, $$1);
      long $$5 = $$4.a();
      int $$6 = ajz.a($$2);
      ajy $$7 = this.b($$5);
      if ($$3) {
         this.c.a(akv.h, $$4, $$6, $$4);
         if (this.a($$7, $$6)) {
            bdp $$8 = this.d.ad();
            $$8.a("chunkLoad");
            this.s();
      ...
      return this.a($$7, $$6) ? ajy.b : $$7.a($$2, this.a);
   }

   private boolean a(@Nullable ajy $$0, int $$1) {
      return $$0 == null || $$0.m() > $$1;
   }

   @Override
   public boolean b(int $$0, int $$1) {
      ajy $$2 = this.b(new cpc($$0, $$1).a());
      int $$3 = ajz.a(dhk.n);
      return !this.a($$2, $$3);
   }
   ...
   public dhs c(int $$0, int $$1) {
      ...
      if ($$3 == null) {
         ...
         while (true) {
            dhk $$5 = b.get($$4);
            Optional<dhf> $$6 = $$3.a($$5).getNow(ajy.a).left();
            if ($$6.isPresent()) {
               return $$6.get();
            }
   ...
   public boolean a(long $$0) {
      ...
      if ($$1 == null) {
         ...
         Either<dhq, ajy.a> $$2 = $$1.a().getNow(null);
   ...
   private void t() {
      ...
      if ($$2) {
         ...
         List<ako.a> $$9 = Lists.newArrayListWithCapacity($$7);

         for (ajy $$10 : this.a.k()) {
            dhq $$11 = $$10.d();
            if ($$11 != null) {
               $$9.add(new ako.a($$11, $$10));
            }
         }
   ...
   private void a(long $$0, Consumer<dhq> $$1) {
      ajy $$2 = this.b($$0);
      if ($$2 != null) {
         $$2.c().getNow(ajy.c).left().ifPresent($$1);
      }
   }
