...
class aqx extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof aqw && $$1 instanceof aqw && $$0.equals($$1);
   }
   ...
   private static aqw a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof aqw) {
         return (aqw)$$0;
      } else {
