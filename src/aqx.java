...
public class aqx {
   ...
   public static SecretKey a() throws aqy {
      try {
   ...
   public static KeyPair b() throws aqy {
      try {
   ...
   public static byte[] a(String $$0, PublicKey $$1, SecretKey $$2) throws aqy {
      try {
   ...
   private static <T extends Key> T a(String $$0, String $$1, String $$2, aqx.a<T> $$3) throws aqy {
      int $$4 = $$0.indexOf($$1);
      if ($$4 != -1) {
         $$4 += $$1.length();
         int $$5 = $$0.indexOf($$2, $$4);
   ...
   public static PrivateKey a(String $$0) throws aqy {
      return a($$0, "-----BEGIN RSA PRIVATE KEY-----", "-----END RSA PRIVATE KEY-----", aqx::b);
   }

   public static PublicKey b(String $$0) throws aqy {
      return a($$0, "-----BEGIN RSA PUBLIC KEY-----", "-----END RSA PUBLIC KEY-----", aqx::a);
   }
   ...
   private static PrivateKey b(byte[] $$0) throws aqy {
      try {
   ...
   public static PublicKey a(byte[] $$0) throws aqy {
      try {
   ...
   public static SecretKey a(PrivateKey $$0, byte[] $$1) throws aqy {
      byte[] $$2 = b($$0, $$1);
   ...
   public static byte[] a(Key $$0, byte[] $$1) throws aqy {
      return a(1, $$0, $$1);
   }

   public static byte[] b(Key $$0, byte[] $$1) throws aqy {
      return a(2, $$0, $$1);
   }

   private static byte[] a(int $$0, Key $$1, byte[] $$2) throws aqy {
      try {
   ...
   public static Cipher a(int $$0, Key $$1) throws aqy {
      try {
