...
public class aqx extends aqu {
   private static final Logger d = LogUtils.getLogger();
   private final ServerSocket e;
   private final String f;
   private final List<aqw> g = Lists.newArrayList();
   private final ahj h;

   private aqx(ahj $$0, ServerSocket $$1, String $$2) {
      super("RCON Listener");
      this.h = $$0;
      this.e = $$1;
      this.f = $$2;
