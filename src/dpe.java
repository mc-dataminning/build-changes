...
public class dpe implements dpa, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final ble<blg.b> c;
   private final dpj d;
   private final Map<cvl, dpe.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dpe(Path $$0, boolean $$1, String $$2) {
      this.d = new dpj($$0, $$1);
      this.c = new ble<>(new blg.a(dpe.b.values().length), ac.g(), "IOWorker-" + $$2);
   }

   public boolean a(cvl $$0, int $$1) {
      cvl $$2 = new cvl($$0.e - $$1, $$0.f - $$1);
      cvl $$3 = new cvl($$0.e + $$1, $$0.f + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         cvl $$3 = cvl.b($$0, $$1);
         BitSet $$4 = new BitSet();
         cvl.a($$2, $$3).forEach($$1xx -> {
            uc $$2x = new uc(new ue(td.a, "DataVersion"), new ue(sy.b, "blending_data"));
            ...
            if ($$2x.d() instanceof sy $$5 && this.a($$5)) {
   ...
   public CompletableFuture<Void> a(cvl $$0, @Nullable sy $$1) {
      return this.a(() -> {
         dpe.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dpe.a($$1));
         $$2.a = $$1;
   ...
   @Override
   public CompletableFuture<Void> a(cvl $$0, ts $$1) {
      return this.a(() -> {
         try {
            dpe.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new blg.b(dpe.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<cvl, dpe.a>> $$0 = this.e.entrySet().iterator();
         Entry<cvl, dpe.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new blg.b(dpe.b.b.ordinal(), this::a));
   }

   private void a(cvl $$0, dpe.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new blg.b(dpe.b.c.ordinal(), () -> $$0.a(axo.a))).join();
         this.c.close();
