...
public class cnh extends bsu implements buo {
   ...
   public cnh(bta<? extends cnh> $$0, dby $$1) {
      super($$0, $$1);
   }

   public cnh(dby $$0, double $$1, double $$2, double $$3, float $$4, int $$5, btp $$6) {
      this(bta.K, $$0);
      this.e = $$5;
      this.a($$6);
   ...
   public void l() {
      ...
      if (this.dP().B) {
         ...
         if (this.e == -8) {
            for (btp $$8 : this.dP().a(btp.class, this.cK().c(0.2, 0.0, 0.2))) {
               this.c($$8);
            }
         }
