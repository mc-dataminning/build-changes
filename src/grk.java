...
public class grk {
   ...
   public grk(gub $$0, djh $$1, int $$2, gqh $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
   ...
   @Nullable
   protected gub.b a(iv $$0) {
      return this.a(jy.c($$0));
   }

   @Nullable
   protected gub.b a(long $$0) {
      int $$1 = jy.b($$0);
      int $$2 = jy.c($$0);
      int $$3 = jy.d($$0);
      return this.b($$1, $$2, $$3);
   ...
   @Nullable
   private gub.b b(int $$0, int $$1, int $$2) {
      if (!this.c($$0, $$1, $$2)) {
         return null;
      } else {
         int $$3 = $$1 - this.b.aq();
