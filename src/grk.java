...
public class grk extends gro<ckt, gxs> {
   ...
   private static final glu j = glu.g(h);
   private static final glu k = glu.m(h);
   private static final glu l = glu.q(i);
   private static final glu m = glu.l(a);
   ...
   public grk(grp.a $$0) {
      super($$0);
      this.f = 0.5F;
      this.o = new geh($$0.a(gem.aG));
   }

   public void a(gxs $$0, fgr $$1, glk $$2, int $$3) {
      $$1.a();
      float $$4 = $$0.a(7).b();
      ...
      if ($$0.b > 0.0F) {
         ...
         fgv $$8 = $$2.getBuffer(glu.p(b));
         this.o.a($$1, $$8, $$3, hbb.d, $$7);
         fgv $$9 = $$2.getBuffer(k);
         this.o.a($$1, $$9, $$3, hbb.a(0.0F, $$0.c));
      } else {
         fgv $$10 = $$2.getBuffer(j);
         this.o.a($$1, $$10, $$3, hbb.a(0.0F, $$0.c));
      }

      fgv $$11 = $$2.getBuffer(l);
      this.o.a($$1, $$11, $$3, hbb.d);
      if ($$0.b > 0.0F) {
         float $$12 = $$0.b / 200.0F;
         $$1.a();
         $$1.a(0.0F, -1.0F, -2.0F);
         a($$1, $$12, $$2.getBuffer(glu.q()));
         a($$1, $$12, $$2.getBuffer(glu.r()));
         $$1.b();
      }
   ...
   public static void a(float $$0, float $$1, float $$2, float $$3, fgr $$4, glk $$5, int $$6) {
      ...
      for (int $$17 = 1; $$17 <= 8; $$17++) {
         ...
         $$9.a($$16, $$13 * 0.2F, $$14 * 0.2F, 0.0F).a(-16777216).a($$15, $$10).b(hbb.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$13, $$14, $$8).a(-1).a($$15, $$11).b(hbb.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$18, $$19, $$8).a(-1).a($$20, $$11).b(hbb.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$18 * 0.2F, $$19 * 0.2F, 0.0F).a(-16777216).a($$20, $$10).b(hbb.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$13 = $$18;
         $$14 = $$19;
         $$15 = $$20;
      }
   ...
   public void a(ckt $$0, gxs $$1, float $$2) {
      ...
      cks $$3 = $$0.cc;
      if ($$3 != null) {
         fbx $$4 = $$3.o($$2).b(0.0, (double)grj.a((float)$$3.a + $$2), 0.0);
         $$1.d = $$4.d($$0.o($$2));
      } else {
         $$1.d = null;
      }
