public class god extends goa {
   private final fei a;

   god(gjr $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fei $$7, int $$8) {
      super($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   ...
   public static class a implements gnd<mc> {
      private final gnv a;
      ...
      public gna a(mc $$0, gjr $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         god $$8 = new god($$1, $$2, $$3, $$4, $$5, $$6, $$7, $$0.b(), $$0.c());
         $$8.a(this.a);
         $$8.a($$0.d());
         return $$8;
      }
