...
public class agl {
   ...
   private static int a(dt $$0, ako $$1) {
      GameProfile $$2 = $$1.fP();
      $$1.c.o();
      $$0.a(() -> ti.b("Switched player " + $$2.getName() + "(" + $$2.getId() + ") to config mode"), false);
      return 1;
   }
   ...
   private static int a(dt $$0, UUID $$1) {
      ...
      $$0.b(ti.b("Can't find player to unconfig"));
      return 0;
   }
}
