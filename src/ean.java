...
public class ean {
   ...
   private final Map<Character, Predicate<eal>> c = Maps.newHashMap();
   private int d;
   private int e;
   ...
   public ean a(char $$0, Predicate<eal> $$1) {
      this.c.put($$0, $$1);
      return this;
   }

   public eam b() {
      return new eam(this.c());
   }

   private Predicate<eal>[][][] c() {
      this.d();
      Predicate<eal>[][][] $$0 = (Predicate<eal>[][][])Array.newInstance(Predicate.class, this.b.size(), this.d, this.e);
   ...
   private void d() {
      ...
      for (Entry<Character, Predicate<eal>> $$1 : this.c.entrySet()) {
         if ($$1.getValue() == null) {
            $$0.add($$1.getKey());
         }
      }
