...
public record ean(
   ...
   public static ean a(dgk $$0, kf $$1, tq $$2) {
      if (!$$2.b("Status", 8)) {
         ...
         List<fcr<djm>> $$19 = fcr.a($$2.c("block_ticks", 10), $$0x -> mb.e.b(akv.c($$0x)), $$3);
         List<fcr<esy>> $$20 = fcr.a($$2.c("fluid_ticks", 10), $$0x -> mb.c.b(akv.c($$0x)), $$3);
   ...
   public dzm a(ard $$0, cgl $$1, eal $$2, dfo $$3) {
   ...
   public static ean a(ard $$0, dys $$1) {
      if (!$$1.s()) {
   ...
   @Nullable
   private static dzc.c a(ard $$0, List<tq> $$1, List<tq> $$2) {
