...
public class emf extends emi {
   ...
   static final emf.b l = new emf.b(854, 480);

   public emf(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final emf.a[] e = values();
   ...
   static class b {
      ...
      static List<emf.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new emf.b($$0, $$1), emf.l) : ImmutableList.of(emf.l);
      }
