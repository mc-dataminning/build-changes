...
public abstract class emf {
   ...
   public elh a() {
      if (this.c()) {
         ...
         return new elh(this.b(ic.a.a), this.b(ic.a.b), this.b(ic.a.c), this.c(ic.a.a), this.c(ic.a.b), this.c(ic.a.c));
      }
   }

   public emf b() {
      return this.c() ? emc.a() : emc.a(this.b(ic.a.a), this.b(ic.a.b), this.b(ic.a.c), this.c(ic.a.a), this.c(ic.a.b), this.c(ic.a.c));
   }
   ...
   public emf a(double $$0, double $$1, double $$2) {
      return (emf)(this.c() ? emc.a() : new elo(this.a, new emb(this.a(ic.a.a), $$0), new emb(this.a(ic.a.b), $$1), new emb(this.a(ic.a.c), $$2)));
   }

   public emf d() {
      emf[] $$0 = new emf[]{emc.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = emc.b($$0[0], emc.a($$1, $$2, $$3, $$4, $$5, $$6), elq.o));
      return $$0[0];
   }
   ...
   public List<elh> e() {
      List<elh> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new elh($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(ic.a $$0, double $$1) {
      return aui.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public eli a(elm $$0, elm $$1, hx $$2) {
      if (this.c()) {
         return null;
      } else {
         elm $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(ic.a.a, $$4.c - (double)$$2.u()), this.a(ic.a.b, $$4.d - (double)$$2.v()), this.a(ic.a.c, $$4.e - (double)$$2.w()))
               ? new eli($$4, ic.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : elh.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<elm> a(elm $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         elm[] $$1 = new elm[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = aui.a($$0.a(), $$2, $$5);
            double $$9 = aui.a($$0.b(), $$3, $$6);
            double $$10 = aui.a($$0.c(), $$4, $$7);
   ...
   public emf a(ic $$0) {
      if (!this.c() && this != emc.b()) {
         if (this.b != null) {
            emf $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private emf b(ic $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new emd(this, $$1, $$4);
      }
   }

   public double a(ic.a $$0, elh $$1, double $$2) {
      return this.a(hv.a($$0, ic.a.a), $$1, $$2);
   }

   protected double a(hv $$0, elh $$1, double $$2) {
      if (this.c()) {
         return $$2;
