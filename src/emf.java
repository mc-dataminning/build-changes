...
public class emf {
   ...
   public static final emf.a bv;

   public static emf.a a(int $$0, int $$1) {
      return $$0 == -1 ? emf.b.b.a($$1) : emf.b.a.a($$0);
   }

   public static emf.a a(String $$0) {
      if (emf.a.e.containsKey($$0)) {
         return emf.a.e.get($$0);
      } else {
         for (emf.b $$1 : emf.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final emf.b b;
      private final int c;
      private final atd<ur> d;
      static final Map<String, emf.a> e = Maps.newHashMap();

      a(String $$0, emf.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new atd<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? ur.b($$2.toUpperCase(Locale.ROOT)) : ur.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? ur.b($$2) : ur.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> ru.a().b($$1) ? ur.c($$1) : ur.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<emf.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, ur> g;

      private static void a(emf.b $$0, String $$1, int $$2) {
         emf.a $$3 = new emf.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, ur> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public emf.a a(int $$0) {
         return (emf.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
