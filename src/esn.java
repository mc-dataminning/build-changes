...
public class esn {
   ...
   public void a(etx $$0, String $$1, eut.a $$2, eil $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  esn.b $$13 = new esn.b($$1.trim(), this.f, $$3, $$2);
                  esn.a $$14 = new esn.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        esn.c $$30 = new esn.c(this.f, $$2, $$0);
                        esn.a $$31 = new esn.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new eub(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eil $$2) throws IOException {
      ...
      File $$15 = new File(exh.O().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, eil $$2, eut.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((esn.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !esn.this.b && !esn.this.d) {
            try {
               esn.this.e = true;
               esn.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               esn.a.error("Error extracting archive", var3);
               esn.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final eut.a c;
      private final etx d;

      c(File $$0, eut.a $$1, etx $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((esn.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !esn.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, esn.this.g);
                  esn.this.c = true;
               } else {
                  esn.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  esn.this.d = true;
               }
            } catch (IOException var3) {
               esn.a.error("Error copying resourcepack file: {}", var3.getMessage());
               esn.this.d = true;
            }
         }
      }
