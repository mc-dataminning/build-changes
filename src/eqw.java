...
public class eqw {
   ...
   private final Map<String, ere> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public eqw(@Nullable eyp $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public tz a(tz $$0) {
      tz $$1 = $$0.p("Level");
      dih $$2 = new dih($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.h, $$2.i)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dih.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dih.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable eyp $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ...
            for (String $$3 : $$2.e()) {
               tz $$4 = $$2.p($$3);
               long $$5 = dih.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if ($$11.a().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  tz $$14 = $$2.p($$13);
                  $$12.a(dih.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static eqw a(alf<dja> $$0, @Nullable eyp $$1) {
      if ($$0 == dja.i) {
         return new eqw(
            $$1,
         ...
         return new eqw($$1, $$2, $$2);
      } else if ($$0 == dja.k) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new eqw($$1, $$3, $$3);
      } else {
