...
public class eqw extends ghe {
   ...
   public eqw(long $$0, int $$1, eqp $$2, eec $$3) {
      super(esj.a);
      this.C = $$0;
      this.D = $$1;
      this.A = $$2;
   ...
   @Override
   public void aO_() {
      this.N = this.d(eum.a(uq.k, $$0 -> this.C()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.N.j = false;
      this.O = this.d(eum.a(uq.e, $$0 -> this.D()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.M) {
         if (this.A.b == -1) {
            this.F();
         } else {
   ...
   private void C() {
      this.f.a(new eqa(new env(new fam()), this.C));
   }
                     ...
                     if ($$3 == null) {
                        ...
                        if (!$$3.c()) {
                           ...
                           if (this.J) {
                              ...
                              eny $$11 = new eny($$0, this.C, this.D, $$3, this.f.U(), aa.b().c(), this.E);
                              $$11.a($$1x -> {
                              ...
                              long $$7 = $$0.length();
                              enw $$8 = enw.a($$7);
                              enw $$9 = enw.a(5368709120L);
                              if (enw.b($$7, $$8).equals(enw.b(5368709120L, $$9)) && $$8 != enw.a) {
                                 enw $$10 = enw.values()[$$8.ordinal() - 1];
                                 this.a(
                                    ur.a("mco.upload.size.failure.line1", this.B.b()),
                                    ur.a("mco.upload.size.failure.line2", enw.b($$7, $$10), enw.b(5368709120L, $$10))
                                 );
                              } else {
                                 this.a(
                                    ur.a("mco.upload.size.failure.line1", this.B.b()),
                                    ur.a("mco.upload.size.failure.line2", enw.b($$7, $$8), enw.b(5368709120L, $$9))
                                 );
                              }
                           }
                        }
