...
public class dtv {
   ...
   private final List<dtt> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dtv.a l = new dtv.d(5.999997E7F);
   public static final dtv.c d = new dtv.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dtv.a)($$0 == $$1 ? new dtv.d($$1) : new dtv.b($$0, $$1, $$2));
   ...
   class b implements dtv.a {
      ...
      @Override
      public double a() {
         return ayz.a(dtv.this.a() - this.e() / 2.0, (double)(-dtv.this.k), (double)dtv.this.k);
      }

      @Override
      public double c() {
         return ayz.a(dtv.this.b() - this.e() / 2.0, (double)(-dtv.this.k), (double)dtv.this.k);
      }
      ...
      @Override
      public dtu i() {
         return this.c < this.b ? dtu.b : dtu.a;
      }
      ...
      @Override
      public dtv.a l() {
         return (dtv.a)(this.g() <= 0L ? dtv.this.new d(this.c) : this);
      }
      ...
      public ewm m() {
         return ewj.a(
            ewj.c,
            ewj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evx.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dtv.c a(DynamicLike<?> $$0, dtv.c $$1) {
         ...
         return new dtv.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dtv.a {
      ...
      private void n() {
         this.c = ayz.a(dtv.this.a() - this.b / 2.0, (double)(-dtv.this.k), (double)dtv.this.k);
         this.d = ayz.a(dtv.this.b() - this.b / 2.0, (double)(-dtv.this.k), (double)dtv.this.k);
         this.e = ayz.a(dtv.this.a() + this.b / 2.0, (double)(-dtv.this.k), (double)dtv.this.k);
         this.f = ayz.a(dtv.this.b() + this.b / 2.0, (double)(-dtv.this.k), (double)dtv.this.k);
         this.g = ewj.a(
            ewj.c,
            ewj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            evx.e
