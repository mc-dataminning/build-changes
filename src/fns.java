...
public class fns extends fnd implements fxq.a {
   ...
   private final fnd G;
   private final fxq H;
   private final Map<af, fno> I = Maps.newLinkedHashMap();
   @Nullable
   private fno J;
   private boolean K;
   ...
   public fns(fxq $$0, @Nullable fnd $$1) {
      super(E);
      this.H = $$0;
      this.G = $$1;
   }
   ...
   protected void aM_() {
      ...
      if (this.J == null && !this.I.isEmpty()) {
         fno $$0 = this.I.values().iterator().next();
         this.H.a($$0.c().b(), true);
      } else {
         this.H.a(this.J == null ? null : this.J.c().b(), true);
      }

      this.F.b(fhe.a(xo.d, $$0x -> this.d()).a(200).a());
      this.F.a($$1 -> {
   ...
   public void a(fgr $$0, int $$1, int $$2) {
      ...
      if (this.I.size() > 1) {
         for (fno $$3 : this.I.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.J);
         }

         for (fno $$4 : this.I.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fgr $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.J != null) {
         $$0.c().a();
   ...
   @Override
   public void a(ag $$0) {
      fno $$1 = fno.a(this.m, this, this.I.size(), $$0);
      if ($$1 != null) {
         this.I.put($$0.b(), $$1);
      }
   }
