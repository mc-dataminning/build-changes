...
public class fns {
   ...
   private static fnr a(String $$0, fnu... $$1) {
      return new fnr(Optional.of(aku.b("block/" + $$0)), Optional.empty(), $$1);
   }

   private static fnr b(String $$0, fnu... $$1) {
      return new fnr(Optional.of(aku.b("item/" + $$0)), Optional.empty(), $$1);
   }

   private static fnr a(String $$0, String $$1, fnu... $$2) {
      return new fnr(Optional.of(aku.b("item/" + $$0)), Optional.of($$1), $$2);
   }

   private static fnr b(String $$0, String $$1, fnu... $$2) {
      return new fnr(Optional.of(aku.b("block/" + $$0)), Optional.of($$1), $$2);
   }
}
