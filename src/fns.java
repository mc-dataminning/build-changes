...
public class fns {
   ...
   public void a(eqv $$0, float $$1, float $$2, float $$3) {
      elr $$4 = elr.a();
      elk $$5 = $$4.c();
      Matrix4f $$6 = new Matrix4f().setPerspective(1.4835298F, (float)$$0.aM().k() / (float)$$0.aM().l(), 0.05F, 10.0F);
      RenderSystem.backupProjectionMatrix();
      RenderSystem.setProjectionMatrix($$6, elx.a);
      elp $$7 = RenderSystem.getModelViewStack();
      $$7.a();
      $$7.e();
   ...
   public CompletableFuture<Void> a(fzf $$0, Executor $$1) {
