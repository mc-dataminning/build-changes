...
public class fns extends hpw implements flc {
   ...
   private final int K;
   final AtomicReference<flb> a = new AtomicReference<>();
   private final fks L;
   ...
   private fsv V;
   private int W;
   private final fwj X = new fwj(this);

   public fns(@Nullable fon $$0, long $$1, int $$2, fnl $$3, ezd $$4) {
      super(fpf.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aO_() {
      this.U = this.X.b(fsv.a(wx.k, $$0x -> this.E()).a());
      this.U.k = false;
      this.V = this.X.b(fsv.a(wx.e, $$0x -> this.F()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.H();
         } else {
            List<fol> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new fot(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new fne(this.G, $$0.toArray(new fol[0])));
         }
      }
   ...
   private void E() {
      this.m.a(new fmy(new fkj(new fyp()), this.J));
   }
   ...
   private void H() {
      ...
      flv $$1 = flv.a(this.H.g(), true, this.H.l().c());
      flb $$2 = new flb($$0, $$1, this.m.X(), this.J, this.K, this);
