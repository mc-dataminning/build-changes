public abstract class fns extends fnw {
   private static final fpm a = new fpm(alp.b("widget/text_field"), alp.b("widget/text_field_highlighted"));
   private static final alp b = alp.b("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean f;

   public fns(int $$0, int $$1, int $$2, int $$3, xk $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int j() {
      return azu.a((int)((float)(this.h * this.h) / (float)this.k()), 32, this.h);
   }
   ...
   protected void a(double $$0) {
      this.e = azu.a($$0, 0.0, (double)this.d());
   }
   ...
   protected abstract void c(fnl var1, int var2, int var3, float var4);
}
