...
public class hfr extends MinecraftServer {
   ...
   public hfr(Thread $$0, flz $$1, evw.c $$2, auv $$3, amo $$4, amk $$5, asi $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hfq(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (ary $$1 : Lists.newArrayList(this.ag().t())) {
   ...
   @Override
   public dgw bd() {
      return this.r() && !this.w_() ? (dgw)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
