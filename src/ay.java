...
public class ay extends dk<ay.a> {
   ...
   public void a(art $$0, ebe $$1, czy $$2, int $$3) {
      this.a($$0, $$3x -> $$3x.a($$1, $$2, $$3));
   }

   public static record a(Optional<bj> b, Optional<jf<dnc>> c, Optional<cm> d, cw.d e) implements dk.a {
      ...
      public static ar<ay.a> a(dnc $$0, cm.a $$1, cw.d $$2) {
         return aq.L.a(new ay.a(Optional.empty(), Optional.of($$0.p()), Optional.of($$1.b()), $$2));
      }

      public boolean a(ebe $$0, czy $$1, int $$2) {
