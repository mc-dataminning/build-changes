...
public class ay extends cw<ay.a> {
   public ay.a a(JsonObject $$0, Optional<bc> $$1, bg $$2) {
      aev<cpv> $$3 = $$0.has("from") ? aev.a(jc.aH, new aew(arn.i($$0, "from"))) : null;
      aev<cpv> $$4 = $$0.has("to") ? aev.a(jc.aH, new aew(arn.i($$0, "to"))) : null;
      return new ay.a($$1, $$3, $$4);
   }

   public void a(akr $$0, aev<cpv> $$1, aev<cpv> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static class a extends at {
      @Nullable
      private final aev<cpv> a;
      @Nullable
      private final aev<cpv> b;

      public a(Optional<bc> $$0, @Nullable aev<cpv> $$1, @Nullable aev<cpv> $$2) {
         super($$0);
         this.a = $$1;
         this.b = $$2;
      }
      ...
      public static am<ay.a> a(aev<cpv> $$0, aev<cpv> $$1) {
         return al.v.a(new ay.a(Optional.empty(), $$0, $$1));
      }

      public static am<ay.a> a(aev<cpv> $$0) {
         return al.v.a(new ay.a(Optional.empty(), null, $$0));
      }

      public static am<ay.a> b(aev<cpv> $$0) {
         return al.v.a(new ay.a(Optional.empty(), $$0, null));
      }

      public boolean b(aev<cpv> $$0, aev<cpv> $$1) {
