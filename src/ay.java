...
public class ay extends cw<ay.a> {
   public ay.a a(JsonObject $$0, Optional<bc> $$1, bg $$2) {
      aex<cpx> $$3 = $$0.has("from") ? aex.a(je.aH, new aey(arp.i($$0, "from"))) : null;
      aex<cpx> $$4 = $$0.has("to") ? aex.a(je.aH, new aey(arp.i($$0, "to"))) : null;
      return new ay.a($$1, $$3, $$4);
   }

   public void a(akt $$0, aex<cpx> $$1, aex<cpx> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static class a extends at {
      @Nullable
      private final aex<cpx> a;
      @Nullable
      private final aex<cpx> b;

      public a(Optional<bc> $$0, @Nullable aex<cpx> $$1, @Nullable aex<cpx> $$2) {
         super($$0);
         this.a = $$1;
         this.b = $$2;
      }
      ...
      public static am<ay.a> a(aex<cpx> $$0, aex<cpx> $$1) {
         return al.v.a(new ay.a(Optional.empty(), $$0, $$1));
      }

      public static am<ay.a> a(aex<cpx> $$0) {
         return al.v.a(new ay.a(Optional.empty(), null, $$0));
      }

      public static am<ay.a> b(aex<cpx> $$0) {
         return al.v.a(new ay.a(Optional.empty(), $$0, null));
      }

      public boolean b(aex<cpx> $$0, aex<cpx> $$1) {
