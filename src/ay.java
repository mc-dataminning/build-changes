...
public class ay extends cw<ay.a> {
   public ay.a a(JsonObject $$0, Optional<bc> $$1, bg $$2) {
      afv<cqz> $$3 = $$0.has("from") ? afv.a(jz.aI, new afw(aso.i($$0, "from"))) : null;
      afv<cqz> $$4 = $$0.has("to") ? afv.a(jz.aI, new afw(aso.i($$0, "to"))) : null;
      return new ay.a($$1, $$3, $$4);
   }

   public void a(alr $$0, afv<cqz> $$1, afv<cqz> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static class a extends at {
      @Nullable
      private final afv<cqz> a;
      @Nullable
      private final afv<cqz> b;

      public a(Optional<bc> $$0, @Nullable afv<cqz> $$1, @Nullable afv<cqz> $$2) {
         super($$0);
         this.a = $$1;
         this.b = $$2;
      }
      ...
      public static am<ay.a> a(afv<cqz> $$0, afv<cqz> $$1) {
         return al.v.a(new ay.a(Optional.empty(), $$0, $$1));
      }

      public static am<ay.a> a(afv<cqz> $$0) {
         return al.v.a(new ay.a(Optional.empty(), null, $$0));
      }

      public static am<ay.a> b(afv<cqz> $$0) {
         return al.v.a(new ay.a(Optional.empty(), $$0, null));
      }

      public boolean b(afv<cqz> $$0, afv<cqz> $$1) {
