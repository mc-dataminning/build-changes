...
public class ay extends dr<ay.a> {
   ...
   public void a(arf $$0, ald<dbw> $$1, ald<dbw> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static record a(Optional<bf> b, Optional<ald<dbw>> c, Optional<ald<dbw>> d) implements dr.a {
