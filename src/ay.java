...
public class ay extends cx<ay.a> {
   ...
   public void a(apb $$0, ajb<cwe> $$1, ajb<cwe> $$2) {
      this.a($$0, $$2x -> $$2x.b($$1, $$2));
   }

   public static record a(Optional<bc> b, Optional<ajb<cwe>> c, Optional<ajb<cwe>> d) implements cx.a {
      public static final Codec<ay.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avu.a(br.b, "player").forGetter(ay.a::a), avu.a(ajb.a(ki.aN), "from").forGetter(ay.a::c), avu.a(ajb.a(ki.aN), "to").forGetter(ay.a::d)
               )
               .apply($$0, ay.a::new)
      );
