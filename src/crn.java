...
public class crn extends crf {
   ...
   public void g() {
      if (this.h() instanceof ard $$0) {
         this.a.bf();
         ji var11 = this.a.p();
         dwy $$3 = this.h().a_(var11);
         boolean $$4 = djc.h($$3);
         this.a.a($$4);
         if ($$4) {
            this.a($$0);
            if ($$3.a(djp.hE)) {
               this.a.a(var11.u(), var11.v(), var11.w(), $$3.c(dpo.f));
            }
         } else {
            this.a.e($$0);
         }
   ...
   public void a(ard $$0) {
      ...
      $$10 = new fbb($$19 * $$15 / $$17, $$10.e, $$19 * $$16 / $$17);
      this.a($$10);
      bum $$20 = this.a.cZ();
      fbb $$22;
      if (this.a.cZ() instanceof are $$21) {
         $$22 = $$21.aj();
      } else {
         $$22 = fbb.c;
      }

      if ($$20 instanceof coy && $$22.h() > 0.0) {
         fbb $$24 = $$22.d();
         double $$25 = this.j().j();
         if ($$24.h() > 0.0 && $$25 < 0.01) {
      ...
      $$10 = this.j();
      this.a.a(bvm.a, new fbb(ayz.a($$36 * $$10.d, -$$37, $$37), 0.0, ayz.a($$36 * $$10.f, -$$37, $$37)));
      if ($$13.v() != 0 && ayz.a(this.a.dA()) - $$1.u() == $$13.u() && ayz.a(this.a.dG()) - $$1.w() == $$13.w()) {
         this.c(this.a.dA(), this.a.dC() + (double)$$13.v(), this.a.dG());
      } else if ($$14.v() != 0 && ayz.a(this.a.dA()) - $$1.u() == $$14.u() && ayz.a(this.a.dG()) - $$1.w() == $$14.w()) {
         this.c(this.a.dA(), this.a.dC() + (double)$$14.v(), this.a.dG());
      }

      this.a(this.a.a(this.j()));
      fbb $$38 = this.d(this.a.dA(), this.a.dC(), this.a.dG());
      if ($$38 != null && $$6 != null) {
      ...
      int $$42 = ayz.a(this.a.dA());
      int $$43 = ayz.a(this.a.dG());
      if ($$42 != $$1.u() || $$43 != $$1.w()) {
         fbb $$44 = this.j();
         double $$45 = $$44.i();
   ...
   @Nullable
   public fbb a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = ayz.a($$0);
      int $$5 = ayz.a($$1);
      int $$6 = ayz.a($$2);
   ...
   public fbb d(double $$0, double $$1, double $$2) {
      ...
      dwy $$6 = this.h().a_(new ji($$3, $$4, $$5));
      if (djc.h($$6)) {
         dyb $$7 = $$6.c(((djc)$$6.b()).c());
         Pair<km, km> $$8 = cqx.a($$7);
         km $$9 = (km)$$8.getFirst();
   ...
   @Override
   public boolean i() {
      faw $$0 = this.a.cR().c(0.2F, 0.0, 0.2F);
      if (this.a.B() && this.j().j() >= 0.01) {
         ...
         for (bum $$3 : this.h().a_(this.a, $$0)) {
            if (!this.a.y($$3) && $$3.bI() && $$3 instanceof cqx) {
               $$3.h(this.a);
            }
         }
      }
   ...
   @Override
   public fbb c(fbb $$0) {
      return new fbb(ayz.a($$0.d, -0.4, 0.4), $$0.e, ayz.a($$0.f, -0.4, 0.4));
   }
