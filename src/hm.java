...
public class hm {
   private static final Map<String, hm.b> i = Maps.newHashMap();
   ...
   private static void a(String $$0, hm.a $$1, Predicate<hk> $$2, xe $$3) {
      i.put($$0, new hm.b($$1, $$2, $$3));
   }
   ...
   public static void a() {
      if (i.isEmpty()) {
         ...
         a("x_rotation", $$0 -> $$0.a(el.a($$0.g(), true, azf::h)), $$0 -> $$0.k() == el.a, xe.c("argument.entity.options.x_rotation.description"));
         a("y_rotation", $$0 -> $$0.b(el.a($$0.g(), true, azf::h)), $$0 -> $$0.l() == el.a, xe.c("argument.entity.options.y_rotation.description"));
         a("limit", $$0 -> {
            int $$1 = $$0.g().getCursor();
            int $$2 = $$0.g().readInt();
            if ($$2 < 1) {
         ...
         a("sort", $$0 -> {
            ...
            $$0.a(($$0x, $$1x) -> ez.b(Arrays.asList("nearest", "furthest", "random", "arbitrary"), $$0x));
         ...
         a("type", $$0 -> {
            $$0.a(($$1x, $$2x) -> {
               ez.a(lv.f.i(), $$1x, String.valueOf('!'));
               ez.a(lv.f.l().map($$0xx -> $$0xx.h().b()), $$1x, "!#");
               if (!$$0.F()) {
                  ez.a(lv.f.i(), $$1x);
                  ez.a(lv.f.l().map($$0xx -> $$0xx.h().b()), $$1x, String.valueOf('#'));
               }
            ...
            if ($$0.F() && !$$2) {
               ...
               if ($$0.f()) {
                  axl<bty<?>> $$3 = axl.a(lw.z, ale.a($$0.g()));
                  $$0.a($$2x -> $$2x.ao().a($$3) != $$2);
               } else {
                  ale $$4 = ale.a($$0.g());
                  bty<?> $$5 = lv.f.b($$4).orElseThrow(() -> {
                     $$0.g().setCursor($$1);
                     return h.createWithContext($$0.g(), $$4.toString());
                  });
                  if (Objects.equals(bty.by, $$5) && !$$2) {
                     $$0.a(false);
                  }
         ...
         a("advancements", $$0 -> {
            StringReader $$1 = $$0.g();
            Map<ale, Predicate<ai>> $$2 = Maps.newHashMap();
            $$1.expect('{');
            $$1.skipWhitespace();
            ...
            if (!$$2.isEmpty()) {
               $$0.a($$1x -> {
                  if (!($$1x instanceof ark $$2x)) {
                     return false;
                  } else {
                     alm $$4 = $$2x.T();
                     alr $$5x = $$2x.cS().aD();

                     for (Entry<ale, Predicate<ai>> $$6x : $$2.entrySet()) {
         ...
         a("predicate", $$0 -> {
            boolean $$1 = $$0.e();
            ald<eww> $$2 = ald.a(lw.bg, ale.a($$0.g()));
            $$0.a($$2x -> {
               if (!($$2x.dS() instanceof arj)) {
                  return false;
               } else {
                  arj $$3 = (arj)$$2x.dS();
                  Optional<eww> $$4 = $$3.o().bd().a().c($$2).map(jo::a);
                  if ($$4.isEmpty()) {
                     return false;
                  } else {
                     eto $$5 = new eto.a($$3).a(ewh.a, $$2x).a(ewh.f, $$2x.dq()).a(ewg.e);
   ...
   public static hm.a a(hk $$0, String $$1, int $$2) throws CommandSyntaxException {
      hm.b $$3 = i.get($$1);
      if ($$3 != null) {
         if ($$3.b.test($$0)) {
            return $$3.a;
   ...
   public static void a(hk $$0, SuggestionsBuilder $$1) {
      String $$2 = $$1.getRemaining().toLowerCase(Locale.ROOT);

      for (Entry<String, hm.b> $$3 : i.entrySet()) {
   ...
   public interface a {
      void handle(hk var1) throws CommandSyntaxException;
   }

   static record b(hm.a a, Predicate<hk> b, xe c) {
   }
}
