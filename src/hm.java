...
public class hm<T extends ej<T>> {
   @VisibleForTesting
   ...
   protected void a(T $$0, List<T> $$1, hg<T> $$2, hi $$3, hb $$4) {
      ...
      if ($$5.getStage() != Stage.EXECUTE) {
         ...
         try {
            for (int $$8 = $$2.d(); $$5.getStage() != Stage.EXECUTE; $$5 = $$5.nextStage()) {
               ...
               if ($$10 instanceof he<T> $$11) {
                  $$11.a($$0, $$7, $$5, $$6, hh.a($$2, $$3));
                  return;
               }
      ...
      if ($$7.isEmpty()) {
         ...
         if ($$17.getCommand() instanceof hd<T> $$19) {
            hh<T> $$20 = hh.a($$2, $$3);
            ...
            if ($$6.c()) {
               T $$22 = $$7.get(0);
               $$22 = $$22.b(ee.chain($$22.p(), $$3.d()));
               $$7 = List.of($$22);
            }

            hp<T> $$23 = new hp<>(this.b, $$6, $$17);
            ho.a($$2, $$3, $$7, ($$1x, $$2x) -> new hc<>($$1x, $$23.bind((T)$$2x)));
         }
      }
   }
   ...
   public static class a<T extends ej<T>> extends hm<T> implements hf<T> {
      private final hb b;
      private final T c;
   ...
   public static class b<T extends ej<T>> extends hm<T> implements hf<T> {
      private final T b;
   ...
   public static class c<T extends ej<T>> extends hm<T> implements hk<T> {
