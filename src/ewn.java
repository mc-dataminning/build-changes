...
public enum ewn implements azu {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final azu.a<ewn> t = azu.a(ewn::values);
   public static final IntFunction<ewn> u = axp.a(ewn::a, values(), axp.a.a);
   private final int v;
   private final String w;

   private ewn(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
