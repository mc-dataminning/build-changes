...
public class ewn {
   ...
   @Nullable
   private String g;
   private static final ewn.a h = new ewn.a() {
      @Nullable
      @Override
      public ewm a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ewr.a(this.d, "Get capabilities")) {
         ...
         if (ewr.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  ewr.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ewr.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ewm a(ewn.c $$0) {
      return ($$0 == ewn.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements ewn.a {
      private final int a;
      private final Set<ewm> b = Sets.newIdentityHashSet();
      ...
      public ewm a() {
         if (this.b.size() >= this.a) {
            if (aa.aX) {
               ewn.a.warn("Maximum sound pool size {} reached", this.a);
            }
