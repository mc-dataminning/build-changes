...
public class ewn extends gpb {
   ...
   public ewn(fhf $$0, long $$1, boolean $$2) {
   ...
   public void aO_() {
      this.z = this.g / 2 - 150;
      this.c(fbg.a(vt.k, $$0 -> this.d()).a((this.g - 150) / 2, g(13) - 5, 150, 20).a());
      if (this.w == null) {
         this.a(this.x);
      } else {
         this.E();
   ...
   private void E() {
      for (Entry<Integer, evn> $$0 : this.w.i.entrySet()) {
         int $$1 = $$0.getKey();
         boolean $$2 = $$1 != this.w.n || this.w.m == evg.d.b;
         fbg $$3;
         if ($$2) {
            $$3 = fbg.a(vu.c("mco.brokenworld.play"), $$1x -> this.f.a(new eww(this.v, new eyo(this.w.a, $$1, this::b)))).a(this.a($$1), g(8), 80, 20).a();
            $$3.j = !this.w.i.get($$1).n;
         } else {
            $$3 = fbg.a(vu.c("mco.brokenworld.download"), $$1x -> {
   ...
   public void a(fat $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.w != null) {
         for (Entry<Integer, evn> $$5 : this.w.i.entrySet()) {
   ...
   public void b() {
      new Thread(() -> {
         eup $$0 = eup.a();
         if (this.w.e == evg.c.a) {
            this.f.execute(() -> this.f.a(new eww(this, new eyh(this.w, this, true, this.f))));
         } else {
            try {
               evg $$1 = $$0.a(this.x);
               this.f.execute(() -> euk.a($$1, this));
            } catch (ewc var3) {
   ...
   private void b(int $$0) {
      ...
      try {
         evw $$2 = $$1.b(this.w.a, $$0);
         ews $$3 = new ews(this, $$2, this.w.a($$0), $$1x -> {
            if ($$1x) {
               this.A.add($$0);
               this.r();
               this.E();
   ...
   private boolean H() {
      return this.w != null && this.w.m == evg.d.b;
   }

   private void a(fat $$0, int $$1, int $$2, int $$3, int $$4, boolean $$5, String $$6, int $$7, long $$8, @Nullable String $$9, boolean $$10) {
      ajh $$11;
      if ($$10) {
         $$11 = ewi.a;
      } else if ($$9 != null && $$8 != -1L) {
         $$11 = exv.a(String.valueOf($$8), $$9);
      } else if ($$7 == 1) {
         $$11 = ewi.b;
      } else if ($$7 == 2) {
         $$11 = ewi.c;
         ...
         $$11 = exv.a(String.valueOf(this.w.p), this.w.q);
      }
