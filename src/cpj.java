...
public class cpj extends cpn {
   private static final Logger a = LogUtils.getLogger();
   private final azu b = azu.a();
   private boolean c;
   private int d;
   private static final int e = 10;
   private static final akm<Integer> f = akq.a(cpj.class, ako.b);
   private static final akm<Boolean> g = akq.a(cpj.class, ako.k);
   private int h;
   private int i;
   private int j;
   private int k;
   ...
   @Nullable
   private bul n;
   private cpj.a o = cpj.a.a;
   private final int p;
   private final int q;

   private cpj(bus<? extends cpj> $$0, dfm $$1, int $$2, int $$3) {
      super($$0, $$1);
      this.p = Math.max(0, $$2);
      this.q = Math.max(0, $$3);
   }

   public cpj(bus<? extends cpj> $$0, dfm $$1) {
      this($$0, $$1, 0, 0);
   }

   public cpj(cou $$0, dfm $$1, int $$2, int $$3, cwm $$4) {
      this(bus.bP, $$1, $$2, $$3);
      this.c($$0);
      float $$5 = $$0.dN();
      float $$6 = $$0.dL();
      float $$7 = azm.b(-$$6 * (float) (Math.PI / 180.0) - (float) Math.PI);
      float $$8 = azm.a(-$$6 * (float) (Math.PI / 180.0) - (float) Math.PI);
      float $$9 = -azm.b(-$$5 * (float) (Math.PI / 180.0));
      float $$10 = azm.a(-$$5 * (float) (Math.PI / 180.0));
      double $$11 = $$0.dA() - (double)$$8 * 0.3;
      double $$12 = $$0.dE();
      double $$13 = $$0.dG() - (double)$$7 * 0.3;
      this.b($$11, $$12, $$13, $$6, $$5);
      ezy $$14 = new ezy((double)(-$$8), (double)azm.a(-($$10 / $$9), -5.0F, 5.0F), (double)(-$$7));
      double $$15 = $$14.g();
      $$14 = $$14.d(0.6 / $$15 + this.ae.a(0.5, 0.0103365), 0.6 / $$15 + this.ae.a(0.5, 0.0103365), 0.6 / $$15 + this.ae.a(0.5, 0.0103365));
      this.h($$14);
      this.v((float)(azm.d($$14.d, $$14.f) * 180.0F / (float)Math.PI));
      this.w((float)(azm.d($$14.e, $$14.i()) * 180.0F / (float)Math.PI));
      this.N = this.dL();
      this.O = this.dN();
   }
   ...
   @Override
   public void h() {
      this.b.b(this.cG().getLeastSignificantBits() ^ this.dV().ab());
      super.h();
      cou $$0 = this.l();
      if ($$0 == null) {
         this.at();
         ...
         if (this.o == cpj.a.a) {
            ...
            if (this.o == cpj.a.b) {
               if (this.n != null) {
                  if (!this.n.dQ() && this.n.dV().ag() == this.dV().ag()) {
         ...
         this.aK();
         this.C();
         if (this.o == cpj.a.a && (this.aJ() || this.P)) {
            this.h(ezy.c);
         }
   ...
   private boolean a(cou $$0) {
      cwm $$1 = $$0.eX();
      cwm $$2 = $$0.eY();
      boolean $$3 = $$1.a(cwq.rm);
      boolean $$4 = $$2.a(cwq.rm);
   ...
   private void a(jh $$0) {
      ...
      if (this.i > 0) {
         ...
         if (this.k > 0) {
            ...
            this.a(awn.iY, 0.25F, 1.0F + (this.ae.i() - this.ae.i()) * 0.4F);
         ...
         if (this.ae.i() < $$14) {
            ...
            dvv $$20 = $$1.a_(jh.a($$17, $$18 - 1.0, $$19));
            if ($$20.a(dis.G)) {
               $$1.a(ls.am, $$17, $$18, $$19, 2 + this.ae.a(2), 0.1F, 0.0, 0.1F, 0.0);
            }
         }
   ...
   private boolean b(jh $$0) {
      ...
      for (int $$2 = -1; $$2 <= 2; $$2++) {
         cpj.b $$3 = this.a($$0.b(-2, $$2, -2), $$0.b(2, $$2, 2));
         switch ($$3) {
            case a:
               if ($$1 == cpj.b.c) {
                  return false;
   ...
   private cpj.b a(jh $$0, jh $$1) {
      return jh.d($$0, $$1).map(this::c).reduce(($$0x, $$1x) -> $$0x == $$1x ? $$0x : cpj.b.c).orElse(cpj.b.c);
   }

   private cpj.b c(jh $$0) {
      dvv $$1 = this.dV().a_($$0);
      if (!$$1.l() && !$$1.a(dis.fm)) {
         erv $$2 = $$1.y();
         return $$2.a(axi.a) && $$2.b() && $$1.g(this.dV(), $$0).c() ? cpj.b.b : cpj.b.c;
      } else {
         return cpj.b.a;
      }
   }
   ...
   public int a(cwm $$0) {
      ...
      if (!this.dV().C && $$1 != null && !this.a($$1)) {
         ...
         if (this.n != null) {
            this.d(this.n);
            ao.E.a((arq)$$1, $$0, this, Collections.emptyList());
            this.dV().a(this, (byte)31);
            $$2 = this.n instanceof clc ? 3 : 5;
         } else if (this.i > 0) {
            euq $$3 = new euq.a((arp)this.dV()).a(exj.f, this.dt()).a(exj.i, $$0).a(exj.a, this).a((float)this.p + $$1.gD()).a(exi.f);
            eus $$4 = this.dV().p().bc().b(euj.am);
            List<cwm> $$5 = $$4.a($$3);
            ao.E.a((arq)$$1, $$0, this, $$5);
   ...
   public void b(byte $$0) {
      if ($$0 == 31 && this.dV().C && this.n instanceof cou && ((cou)this.n).c()) {
         this.d(this.n);
      }
   ...
   protected void d(bul $$0) {
      bul $$1 = this.p();
      if ($$1 != null) {
         ezy $$2 = new ezy($$1.dA() - this.dA(), $$1.dC() - this.dC(), $$1.dG() - this.dG()).c(0.1);
         $$0.h($$0.dy().e($$2));
      }
   }
   ...
   public cou l() {
      bul $$0 = this.p();
      return $$0 instanceof cou ? (cou)$$0 : null;
   }
   ...
   public zq<acf> a(arn $$0) {
      bul $$1 = this.p();
      return new acg(this, $$0, $$1 == null ? this.ar() : $$1.ar());
   }
