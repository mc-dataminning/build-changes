...
public class cpj extends cpo implements cpl {
   private static final ajx<cwn> a = akb.a(cpj.class, ajz.h);
   private static final ajx<OptionalInt> b = akb.a(cpj.class, ajz.v);
   private static final ajx<Boolean> c = akb.a(cpj.class, ajz.k);
   private int d;
   private int e;
   @Nullable
   private bvf f;

   public cpj(buq<? extends cpj> $$0, dgg $$1) {
      super($$0, $$1);
   }

   public cpj(dgg $$0, double $$1, double $$2, double $$3, cwn $$4) {
      super(buq.Z, $$0);
      this.d = 0;
      this.a_($$1, $$2, $$3);
      this.al.a(a, $$4.v());
   ...
   public cpj(dgg $$0, @Nullable buj $$1, double $$2, double $$3, double $$4, cwn $$5) {
      this($$0, $$2, $$3, $$4, $$5);
      this.c($$1);
   }

   public cpj(dgg $$0, cwn $$1, bvf $$2) {
      this($$0, $$2, $$2.dB(), $$2.dD(), $$2.dH(), $$1);
      this.al.a(b, OptionalInt.of($$2.ar()));
      this.f = $$2;
   }

   public cpj(dgg $$0, cwn $$1, double $$2, double $$3, double $$4, boolean $$5) {
      this($$0, $$2, $$3, $$4, $$1);
      this.al.a(c, $$5);
   }

   public cpj(dgg $$0, cwn $$1, buj $$2, double $$3, double $$4, double $$5, boolean $$6) {
      this($$0, $$1, $$3, $$4, $$5, $$6);
      this.c($$2);
   }
   ...
   public void h() {
      ...
      if (!this.ad && this.bL() && $$6.d() != faw.a.a) {
         this.b($$6);
         this.ar = true;
      }
      ...
      this.F();
      if (this.d == 0 && !this.bb()) {
         this.dW().a(null, this.dB(), this.dD(), this.dH(), avz.jp, awa.i, 3.0F, 1.0F);
      }

      this.d++;
      if (this.dW().C && this.d % 2 < 2) {
         this.dW().a(lt.D, this.dB(), this.dD(), this.dH(), this.ae.k() * 0.05, -this.dz().e * 0.5, this.ae.k() * 0.05);
      }

      if (this.d > this.e && this.dW() instanceof arc $$10) {
         this.b($$10);
      }
   }
   ...
   protected void a(fau $$0) {
      ...
      if (this.dW() instanceof arc $$2 && this.s()) {
         this.b($$2);
      }
   ...
   private void e(arc $$0) {
      ...
      if ($$1 > 0.0F) {
         ...
         for (bvf $$6 : this.dW().a(bvf.class, this.cR().g(5.0))) {
            if ($$6 != this.f && !(this.g($$6) > 25.0)) {
               boolean $$7 = false;

               for (int $$8 = 0; $$8 < 2; $$8++) {
                  fay $$9 = new fay($$6.dB(), $$6.e(0.5 * (double)$$8), $$6.dH());
                  faw $$10 = this.dW().a(new dfo($$4, $$9, dfo.a.a, dfo.b.a, this));
                  if ($$10.d() == faw.a.a) {
                     $$7 = true;
                     break;
                  }
   ...
   public void a(tq $$0) {
      ...
      if ($$0.b("FireworksItem", 10)) {
         this.al.a(a, cwn.a(this.dY(), (un)$$0.p("FireworksItem")).orElseGet(cpj::v));
      } else {
         this.al.a(a, v());
      }
   ...
   private static cwn v() {
      return new cwn(cwr.vt);
   }
