...
public class hnv extends MinecraftServer {
   ...
   public hnv(Thread $$0, fpo $$1, ezc.c $$2, aun $$3, amf $$4, amb $$5, asb $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.au(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new hnu(this, this.bb(), this.g));
      this.n = $$1;
   }
   ...
   @Override
   public dje bd() {
      return this.r() && !this.r_() ? (dje)MoreObjects.firstNonNull(this.q, this.j.k()) : null;
   }
