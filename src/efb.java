...
public abstract class efb {
   ...
   public efb a(double $$0, double $$1, double $$2) {
      return (efb)(this.b() ? eey.a() : new eek(this.a, new eex(this.a(ha.a.a), $$0), new eex(this.a(ha.a.b), $$1), new eex(this.a(ha.a.c), $$2)));
   }

   public efb c() {
      efb[] $$0 = new efb[]{eey.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = eey.b($$0[0], eey.a($$1, $$2, $$3, $$4, $$5, $$6), eem.o));
      return $$0[0];
   }
   ...
   public List<eed> d() {
      List<eed> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new eed($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
      ...
      if (this.b()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(ha.a.a, $$4.c - (double)$$2.u()), this.a(ha.a.b, $$4.d - (double)$$2.v()), this.a(ha.a.c, $$4.e - (double)$$2.w()))
               ? new eee($$4, ha.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : eed.a(this.d(), $$0, $$1, $$2);
         }
      }
   }
