...
public class gj {
   ...
   private static <A extends ArgumentType<?>> void a(JsonObject $$0, gh.a<A> $$1) {
      a($$0, $$1.a(), $$1);
   }

   private static <A extends ArgumentType<?>, T extends gh.a<A>> void a(JsonObject $$0, gh<A, T> $$1, gh.a<A> $$2) {
      $$1.a((T)$$2, $$0);
   }
   ...
   private static <T extends ArgumentType<?>> void a(JsonObject $$0, T $$1) {
      ...
      $$0.addProperty("parser", jc.x.b($$2.a()).toString());
