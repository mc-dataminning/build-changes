public abstract class fug extends ful {
   public static final int b = 6;
   private double a;
   private static final alk c = alk.b("widget/scroller");
   private static final alk d = alk.b("widget/scroller_background");
   private boolean e;

   public fug(int $$0, int $$1, int $$2, int $$3, xc $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   public void a(double $$0) {
      this.a = azq.a($$0, 0.0, (double)this.i());
   }
   ...
   protected int k() {
      return azq.a((int)((float)(this.h * this.h) / (float)this.n()), 32, this.h - 8);
   }
