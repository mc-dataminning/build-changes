...
public abstract class fug<T extends csx> extends ftr implements fvm<T> {
   ...
   private cxk V = cxk.k;
   private long W;
   protected final Set<cuu> E = Sets.newHashSet();
   protected boolean F;
   private int X;
   private int Y;
   private boolean Z;
   ...
   private int ac;
   private boolean ad;
   private cxk ae = cxk.k;

   public fug(T $$0, cpr $$1, xv $$2) {
      super($$2);
      this.z = $$0;
      this.A = $$1.p_();
      this.Z = true;
   ...
   public void a(fnl $$0, int $$1, int $$2, float $$3) {
      ...
      this.b($$0, $$1, $$2);
      cxk $$7 = this.R.f() ? this.z.g() : this.R;
      if (!$$7.f()) {
         int $$8 = 8;
         int $$9 = this.R.f() ? 8 : 16;
         String $$10 = null;
   ...
   private void d(fnl $$0) {
      if (this.B != null && this.B.e()) {
         $$0.a(glo::B, G, this.B.e - 4, this.B.f - 4, 24, 24);
      }
   }

   private void e(fnl $$0) {
      if (this.B != null && this.B.e()) {
         $$0.a(glo::z, H, this.B.e - 4, this.B.f - 4, 24, 24);
      }
   }
   ...
   private boolean b(cxk $$0) {
      return $$0.b().map(fwb::a).map(fwb::a).orElse(false);
   }

   protected List<xv> a(cxk $$0) {
      return a(this.m, $$0);
   }

   private void a(fnl $$0, cxk $$1, int $$2, int $$3, @Nullable String $$4) {
      $$0.c().a();
   ...
   protected void a(fnl $$0, cuu $$1) {
      ...
      if ($$1 == this.M && !this.R.f() && this.Q && !$$4.f()) {
         ...
         if (csx.a($$1, $$7, true) && this.z.b($$1)) {
            $$5 = true;
            int $$9 = Math.min($$7.k(), $$1.a_($$7));
            int $$10 = $$1.g().f() ? 0 : $$1.g().L();
            int $$11 = csx.a(this.E, this.X, $$7) + $$10;
            if ($$11 > $$9) {
               $$11 = $$9;
               $$8 = n.o.toString() + $$9;
            }
      ...
      if ($$4.f() && $$1.d()) {
         Pair<alz, alz> $$12 = $$1.b();
         if ($$12 != null) {
            hbe $$13 = this.m.a((alz)$$12.getFirst()).apply((alz)$$12.getSecond());
            $$0.a(glo::B, $$13, $$2, $$3, 16, 16);
            $$6 = true;
         }
      }
      ...
      if (!$$0.f() && this.F) {
         if (this.X == 2) {
            ...
            for (cuu $$1 : this.E) {
               ...
               int $$5 = Math.min(csx.a(this.E, this.X, $$0) + $$3, $$4);
               this.aa -= $$5 - $$3;
            }
         }
      }
   ...
   @Nullable
   private cuu b(double $$0, double $$1) {
      for (cuu $$2 : this.z.k) {
         if ($$2.d() && this.a($$2, $$0, $$1)) {
            return $$2;
         }
               ...
               if (this.m.n.ac().c()) {
                  ...
                  if (this.z.g().f()) {
                     if ($$3) {
                        ...
                        cti $$11 = cti.a;
                        if ($$10) {
                           this.ae = $$4 != null && $$4.h() ? $$4.g().v() : cxk.k;
                           $$11 = cti.b;
                        } else if ($$9 == -999) {
                           $$11 = cti.e;
                        }
   ...
   private void a(int $$0) {
      if (this.B != null && this.z.g().f()) {
         if (this.m.n.D.a($$0)) {
            this.a(this.B, this.B.d, 40, cti.c);
            return;
         }

         for (int $$1 = 0; $$1 < 9; $$1++) {
            if (this.m.n.S[$$1].a($$0)) {
               this.a(this.B, this.B.d, $$1, cti.c);
            }
         }
      }
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      ...
      if (this.M != null && this.m.n.ac().c()) {
         if ($$2 == 0 || $$2 == 1) {
            ...
            } else if (this.R.L() > 1 && $$5 != null && csx.a($$5, this.R, false)) {
               long $$7 = ae.c();
               if (this.O == $$5) {
                  if ($$7 - this.W > 500L) {
                     this.a(this.M, this.M.d, 0, cti.a);
                     this.a($$5, $$5.d, 1, cti.a);
                     this.a(this.M, this.M.d, 0, cti.a);
                     this.W = $$7 + 750L;
                     this.R.h(1);
                  }
      ...
      } else if (this.F && $$5 != null && !$$6.f() && ($$6.L() > this.E.size() || this.X == 2) && csx.a($$5, $$6, true) && $$5.a($$6) && this.z.b($$5)) {
         this.E.add($$5);
         this.G();
      }
   ...
   public boolean b(double $$0, double $$1, int $$2) {
      ...
      if (this.ad && $$3 != null && $$2 == 0 && this.z.a(cxk.k, $$3)) {
         if (s()) {
            if (!this.ae.f()) {
               for (cuu $$8 : this.z.k) {
                  if ($$8 != null && $$8.a(this.m.t) && $$8.h() && $$8.c == $$3.c && csx.a($$8, this.ae, true)) {
                     this.a($$8, $$8.d, $$2, cti.b);
                  }
               }
            }
         } else {
         ...
         if (this.M != null && this.m.n.ac().c()) {
            if ($$2 == 0 || $$2 == 1) {
               ...
               boolean $$9 = csx.a($$3, this.R, false);
               if ($$7 != -1 && !this.R.f() && $$9) {
                  this.a(this.M, this.M.d, $$2, cti.a);
                  this.a($$3, $$7, 0, cti.a);
                  if (this.z.g().f()) {
                     this.V = cxk.k;
                  } else {
            ...
            this.a(null, -999, csx.c(0, this.X), cti.f);

            for (cuu $$10 : this.E) {
               this.a($$10, $$10.d, csx.c(1, this.X), cti.f);
            }

            this.a(null, -999, csx.c(2, this.X), cti.f);
         } else if (!this.z.g().f()) {
            if (this.m.n.H.a($$2)) {
               this.a($$3, $$7, $$2, cti.d);
            } else {
               ...
               if ($$11) {
                  this.ae = $$3 != null && $$3.h() ? $$3.g().v() : cxk.k;
               }

               this.a($$3, $$7, $$2, $$11 ? cti.b : cti.a);
            }
         }
      }
   ...
   private boolean a(cuu $$0, double $$1, double $$2) {
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      if (super.a($$0, $$1, $$2)) {
         ...
         if (this.B != null && this.B.h()) {
            if (this.m.n.H.a($$0, $$1)) {
               this.a(this.B, this.B.d, 0, cti.d);
            } else if (this.m.n.E.a($$0, $$1)) {
               this.a(this.B, this.B.d, r() ? 1 : 0, cti.e);
            }
         }
      ...
      if (this.z.g().f() && this.B != null) {
         ...
         for (int $$2 = 0; $$2 < 9; $$2++) {
            if (this.m.n.S[$$2].a($$0, $$1)) {
               this.a(this.B, this.B.d, $$2, cti.c);
               return true;
            }
         }
      }
