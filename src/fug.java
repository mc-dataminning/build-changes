...
public class fug extends ftw implements gfd.a {
   ...
   private final frs I = new frs(this);
   @Nullable
   private final ftw J;
   private final gfd K;
   private final Map<ah, fuc> L = Maps.newLinkedHashMap();
   @Nullable
   private fuc M;
   private boolean N;
   ...
   public fug(gfd $$0, @Nullable ftw $$1) {
      super(H);
      this.K = $$0;
      this.J = $$1;
   }
   ...
   protected void aT_() {
      ...
      if (this.M == null && !this.L.isEmpty()) {
         fuc $$0 = this.L.values().iterator().next();
         this.K.a($$0.c().b(), true);
      } else {
         this.K.a(this.M == null ? null : this.M.c().b(), true);
      }

      this.I.b(fod.a(xu.d, $$0x -> this.aP_()).a(200).a());
      this.I.a($$1 -> {
   ...
   public void a(fnq $$0, int $$1, int $$2) {
      $$0.a(glt::B, x, $$1, $$2, 0.0F, 0.0F, 252, 140, 256, 256);
      if (this.L.size() > 1) {
         for (fuc $$3 : this.L.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.M);
         }

         for (fuc $$4 : this.L.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   private void c(fnq $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.M != null) {
         $$0.c().a();
   ...
   @Override
   public void a(ai $$0) {
      fuc $$1 = fuc.a(this.m, this, this.L.size(), $$0);
      if ($$1 != null) {
         this.L.put($$0.b(), $$1);
      }
   }
