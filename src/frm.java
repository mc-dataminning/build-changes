public class frm extends fsh {
   private final fsc a;

   frm(foe $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fsc $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cfq $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.ds();
            if (this.h > $$1) {
   ...
   public static class b implements frk<ka> {
      ...
      public frh a(ka $$0, foe $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         frh $$8 = new frm($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
