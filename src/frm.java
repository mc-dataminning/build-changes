...
public class frm extends hed implements hee {
   private static final int d = 256;
   private final frn e;
   private final boolean f;
   private final frm.a g;

   public frm(frn $$0, boolean $$1) {
      this.f = $$1;
      this.g = new frm.a(0, 0, 256, 256);
      ...
      frm.a a(fdu $$0) {
         if (this.e != null && this.f != null) {
            ...
            if ($$2 > this.c || $$3 > this.d) {
               ...
               int $$5 = this.d - $$3;
               if ($$4 > $$5) {
                  this.e = new frm.a(this.a, this.b, $$2, this.d);
                  this.f = new frm.a(this.a + $$2 + 1, this.b, this.c - $$2 - 1, this.d);
               } else {
                  this.e = new frm.a(this.a, this.b, this.c, $$3);
                  this.f = new frm.a(this.a, this.b + $$3 + 1, this.c, this.d - $$3 - 1);
               }
