...
public class bem extends bau {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bem::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bem::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bem::k);
         $$0 = this.a($$0, "minecraft:fox", bem::j);
         $$0 = this.a($$0, "minecraft:item", bem::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bem::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bem::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bem::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bem::e);
         return this.a($$0, "minecraft:piglin", bem::d);
      });
   }
