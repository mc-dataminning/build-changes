...
public class bem extends bht {
   public bem(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", biz.D, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(biz.F.typeName(), bku.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(biz.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(biz.F.typeName(), "minecraft:saddle"));
