...
public class bem {
   ...
   private JsonElement a(List<Pair<dhe, bew<beo>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bew)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dhe, bew<beo>> $$3 : $$0) {
         bew<beo> $$4 = (bew<beo>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dhe)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<beu> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bec.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bek $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement a(bes $$0) {
      ...
      $$0.e().forEach($$1x -> {
         JsonObject $$2x = new JsonObject();
         $$2.add($$2x);
         bes.b $$3 = (bes.b)$$1x.getFirst();
         bes.a $$4 = (bes.a)$$1x.getSecond();
   ...
   private JsonElement c(List<bep> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bep>, ToDoubleFunction<bep>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bep::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bep::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bep::c));
      return $$1;
   }
}
