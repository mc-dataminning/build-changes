...
public class dxg implements dxn.c {
   ...
   private final ObjectListIterator<dxg.a> h;
   private final ObjectListIterator<ejl> i;

   public static dxg a(dcq $$0, dbe $$1) {
      int $$2 = $$1.d();
      int $$3 = $$1.e();
      ObjectList<dxg.a> $$4 = new ObjectArrayList(10);
      ObjectList<ejl> $$5 = new ObjectArrayList(32);
      $$0.a($$1, $$0x -> $$0x.d() != eiu.a).forEach($$5x -> {
         eiu $$6 = $$5x.h().d();
         ...
         for (ein $$7 : $$5x.i()) {
            if ($$7.a($$1, 12)) {
               if ($$7 instanceof eif) {
                  ...
                  $$4.add(new dxg.a($$7.f(), $$6, 0));
               }
            }
         }
      });
      return new dxg($$4.iterator(), $$5.iterator());
   }

   @VisibleForTesting
   public dxg(ObjectListIterator<dxg.a> $$0, ObjectListIterator<ejl> $$1) {
      this.h = $$0;
      this.i = $$1;
   }
   ...
   @VisibleForTesting
   public static record a(eib a, eiu b, int c) {
   }
}
