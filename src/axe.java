...
public class axe {
   ...
   axe(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static axe.a a() {
      return new axe.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(axe::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public axe.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public axe a(Writer $$0) throws IOException {
         return new axe($$0, this.a);
      }
   }
}
