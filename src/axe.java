...
public class axe {
   ...
   public static final Codec<Object> b = a(axp.a);
   ...
   public static final Codec<axe.g> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? akf.b($$0.substring(1)).map($$0x -> new axe.g($$0x, true)) : akf.b($$0).map($$0x -> new axe.g($$0x, false)), axe.g::c
      );
   ...
   public static final Codec<String> u = b(
      b(0, 16),
      (Function<String, DataResult<String>>)($$0 -> ayr.f($$0)
   ...
   private static final MapCodec<GameProfile> A = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(jp.e.fieldOf("id").forGetter(GameProfile::getId), u.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   ...
   public static Codec<String> y = b(
      Codec.STRING, $$0 -> !akf.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> axe.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new axe.b<>($$0, $$1);
   }

   public static <K, V> axe.f<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new axe.f<>($$0, $$1);
   }
   ...
   public static <T> Codec<iz<T>> b(Codec<iz<T>> $$0) {
      return b(
         $$0,
         (Function<iz<T>, DataResult<iz<T>>>)($$0x -> $$0x.c().right().filter(List::isEmpty).isPresent()
   ...
   static final class e<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof axe.e<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record g(akf a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
