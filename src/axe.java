...
public record axe<T extends Comparable<T>>(T b, T c) {
   public static final Codec<axe<Integer>> a = a(Codec.INT);
   ...
   public static <T extends Comparable<T>> Codec<axe<T>> a(Codec<T> $$0) {
      return awu.a($$0, "min_inclusive", "max_inclusive", axe::a, axe::a, axe::b);
   }

   public static <T extends Comparable<T>> Codec<axe<T>> a(Codec<T> $$0, T $$1, T $$2) {
      return awu.b(
         a($$0),
         (Function<axe<T>, DataResult<axe<T>>>)($$2x -> {
   ...
   public static <T extends Comparable<T>> DataResult<axe<T>> a(T $$0, T $$1) {
      return $$0.compareTo($$1) <= 0
         ? DataResult.success(new axe($$0, $$1))
