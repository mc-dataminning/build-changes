...
public class gfl implements faw, AutoCloseable {
   ...
   private static final fap t = new fap();
   ...
   private final List<fax> A = Lists.newArrayList();
   private final List<Integer> B = Lists.newArrayList();
   private final Map<String, fax> C = Maps.newHashMap();
   private final int D;
   ...
   public gfl(auh $$0, String $$1, fbl $$2) throws IOException {
      this.E = $$1;
      this.I = $$2;
      ...
      try (Reader $$4 = $$0.openAsReader($$3)) {
         ...
         this.G = a($$0, fau.a.a, $$6);
         this.H = a($$0, fau.a.b, $$7);
         this.D = fav.a();
         int $$18 = 0;
   ...
   private static fau a(final auh $$0, fau.a $$1, String $$2) throws IOException {
      fau $$3 = $$1.c().get($$2);
      fau $$8;
      if ($$3 == null) {
               ...
               public String a(boolean $$0x, String $$1) {
                  ...
                  if (!this.c.add($$1)) {
                     ...
                     try {
                        ...
                        gfl.s.error("Could not open GLSL import {}: {}", $$1, var9.getMessage());
   ...
   public void a(fbl.c $$0, Matrix4f $$1, Matrix4f $$2, fak $$3) {
      for (int $$4 = 0; $$4 < 12; $$4++) {
      ...
      if (this.n != null && ($$0 == fbl.c.a || $$0 == fbl.c.b)) {
