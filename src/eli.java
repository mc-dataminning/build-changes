...
public class eli {
   ...
   public eli(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<elj> $$1) throws IOException {
   ...
   public List<elj> a(Path $$0) throws IOException {
      List<elj> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<elj> a(Path $$0, boolean $$1) throws IOException {
      List<elj> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<elj> $$1) throws IOException {
