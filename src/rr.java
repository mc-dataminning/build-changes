...
public class rr implements rw {
   ...
   public void a(qy $$0) {
      ...
      for (String $$2 : $$1) {
         ...
         this.b.append(a($$2)).append(':').append(new rr().a($$0.c($$2)));
      }
   ...
   protected static String a(String $$0) {
      return a.matcher($$0).matches() ? $$0 : rq.b($$0);
   }
