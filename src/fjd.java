...
public class fjd {
   ...
   public boolean a(gw $$0, ha $$1) {
      if (this.b.s.a(this.b.r, $$0, this.j)) {
         ...
         if (this.j.g()) {
            ...
            this.a(this.b.r, $$2x -> {
               this.a($$0);
               return new ace(ace.a.a, $$0, $$1, $$2x);
            });
            this.h = 5;
         } else if (!this.i || !this.b($$0)) {
            if (this.i) {
               this.c.b(new ace(ace.a.b, this.d, $$1));
            }
   ...
   public void b() {
      if (this.i) {
         ...
         this.c.b(new ace(ace.a.b, this.d, ha.a));
         this.i = false;
         this.f = 0.0F;
   ...
   public boolean b(gw $$0, ha $$1) {
      ...
      if (this.h > 0) {
         ...
         if ($$3.i()) {
            ...
            if (this.g % 4.0F == 0.0F) {
               dai $$4 = $$3.w();
               this.b.ai().a(new gch($$4.f(), ape.e, ($$4.a() + 1.0F) / 8.0F, $$4.b() * 0.5F, gcm.t(), $$0));
            }

            this.g++;
            this.b.az().a(this.b.r, $$0, $$3, arw.a(this.f, 0.0F, 1.0F));
            if (this.f >= 1.0F) {
               this.i = false;
               this.a(this.b.r, $$2 -> {
                  this.a($$0);
                  return new ace(ace.a.c, $$0, $$1, $$2);
               });
               this.f = 0.0F;
               this.g = 0.0F;
               this.h = 5;
   ...
   public bgy a(cbu $$0, bgx $$1) {
      if (this.j == cps.d) {
         ...
         this.o();
         this.c.b(new aby.b($$0.dq(), $$0.ds(), $$0.dw(), $$0.dB(), $$0.dD(), $$0.aA()));
   ...
   public fng a(fix $$0, apo $$1, eqi $$2) {
      return this.a($$0, $$1, $$2, false, false);
   }

   public fng a(fix $$0, apo $$1, eqi $$2, boolean $$3, boolean $$4) {
      return new fng(this.b, $$0, this.c, $$1, $$2, $$3, $$4);
   }

   public void a(cbu $$0, biq $$1) {
      this.o();
      this.c.b(abv.a($$1, $$0.bR()));
      if (this.j != cps.d) {
         $$0.d($$1);
         $$0.gl();
      }
   ...
   public void a(int $$0, int $$1, int $$2, ceu $$3, cbu $$4) {
      ...
      if ($$0 != $$5.j) {
         ...
         this.c.b(new abr($$0, $$5.j(), $$1, $$2, $$3, $$5.g().p(), $$10));
      }
   }

   public void a(int $$0, cmk<?> $$1, boolean $$2) {
      this.c.b(new acc($$0, $$1, $$2));
   }

   public void a(int $$0, int $$1) {
      this.c.b(new abq($$0, $$1));
   }

   public void a(cjf $$0, int $$1) {
      if (this.j.g() && this.c.a($$0.d().m())) {
         this.c.b(new acq($$1, $$0));
      }
   }
   ...
   public void b(cbu $$0) {
      this.o();
      this.c.b(new ace(ace.a.f, gw.b, ha.a));
      $$0.fr();
   }
