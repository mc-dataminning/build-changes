...
public class fjd {
   ...
   public void a(fkw $$0, String $$1, flt.a $$2, eyb $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fjd.b $$13 = new fjd.b($$1.trim(), this.f, $$3, $$2);
                  fjd.a $$14 = new fjd.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fjd.c $$30 = new fjd.c(this.f, $$2, $$0);
                        fjd.a $$31 = new fjd.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fla(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eyb $$2) throws IOException {
      ...
      File $$15 = new File(fof.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final eyb d;
      private final flt.a e;

      b(final String $$0, final File $$1, final eyb $$2, final flt.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fjd.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fjd.this.b && !fjd.this.d) {
            try {
               fjd.this.e = true;
               fjd.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fjd.a.error("Error extracting archive", var3);
               fjd.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final flt.a c;
      private final fkw d;

      c(final File $$0, final flt.a $$1, final fkw $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fjd.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fjd.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fjd.this.g);
                  fjd.this.c = true;
               } else {
                  fjd.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fjd.this.d = true;
               }
            } catch (IOException var3) {
               fjd.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fjd.this.d = true;
            }
         }
      }
