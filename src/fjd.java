...
public class fjd implements fsk {
   ...
   protected void a(fgr $$0, float $$1, int $$2, int $$3, fsl $$4) {
   ...
   private void a(fgr $$0, int $$1, int $$2, float $$3, float $$4, fsj $$5) {
      if ($$5 != fsh.a) {
         int $$6 = (int)($$4 * 255.0F);
         $$0.c().a();
   ...
   public void b(int $$0) {
      ...
      while ($$1 >= 0 && $$1 <= 8 && (this.g.a($$1) == fsh.a || !this.g.a($$1).aO_())) {
         $$1 += $$0;
      }
