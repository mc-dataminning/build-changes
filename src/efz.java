...
public class efz {
   ...
   private static final LoadingCache<ard, efz.b> b = CacheBuilder.newBuilder()
      .weakKeys()
      .expireAfterAccess(5L, TimeUnit.MINUTES)
      .build(new CacheLoader<ard, efz.b>() {
         public efz.b a(ard $$0) {
   ...
   public static void a(ard $$0, efk<?, ?> $$1, Optional<emq> $$2) {
      try {
