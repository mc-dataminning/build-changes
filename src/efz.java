...
public interface efz {
   static efz a(egr $$0, dio $$1, egt $$2, eha $$3, int $$4, int $$5, efz.a $$6) {
      return new efz.c($$0, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   static efz a(final efz.a $$0) {
      return new efz() {
         @Nullable
         @Override
         public eao a(egg.b $$0x, double $$1) {
   ...
   @Nullable
   eao a(egg.b var1, double var2);

   boolean a();

   public interface a {
      efz.b computeFluid(int var1, int var2, int var3);
   }

   public static record b(int a, eao b) {

      public eao a(int $$0) {
         return $$0 < this.a ? this.b : dmo.a.m();
      }
   }

   public static class c implements efz {
      ...
      private final egg p;
      private final eha q;
      private final efz.b[] r;
      private final long[] s;
      private final efz.a t;
      private final egg u;
      private final egg v;
      private boolean w;
      private final int x;
      ...
      c(egr $$0, dio $$1, egt $$2, eha $$3, int $$4, int $$5, efz.a $$6) {
         this.l = $$0;
         this.m = $$2.a();
         this.n = $$2.b();
         this.o = $$2.c();
      ...
      public eao a(egg.b $$0, double $$1) {
         ...
         if ($$1 > 0.0) {
            ...
            efz.b $$5 = this.t.computeFluid($$2, $$3, $$4);
            if ($$5.a($$3).a(dmo.K)) {
               this.w = false;
               return dmo.K.m();
            } else {
               ...
               if ($$33 <= 0.0) {
                  ...
                  return $$34;
               } else if ($$34.a(dmo.J) && this.t.computeFluid($$2, $$3 - 1, $$4).a($$3 - 1).a(dmo.K)) {
                  this.w = true;
                  return $$34;
               } else {
      ...
      private double a(egg.b $$0, MutableDouble $$1, efz.b $$2, efz.b $$3) {
         int $$4 = $$0.b();
         eao $$5 = $$2.a($$4);
         eao $$6 = $$3.a($$4);
         if ((!$$5.a(dmo.K) || !$$6.a(dmo.J)) && (!$$5.a(dmo.J) || !$$6.a(dmo.K))) {
      ...
      private efz.b a(long $$0) {
         ...
         if ($$8 != null) {
            ...
            efz.b $$9 = this.b($$1, $$2, $$3);
            this.r[$$7] = $$9;
            return $$9;
         }
      }

      private efz.b b(int $$0, int $$1, int $$2) {
         efz.b $$3 = this.t.computeFluid($$0, $$1, $$2);
         ...
         for (int[] $$8 : C) {
            ...
            boolean $$14 = $$5 > $$12;
            if ($$14 || $$13) {
               efz.b $$15 = this.t.computeFluid($$9, $$12, $$10);
               if (!$$15.a($$12).l()) {
                  if ($$13) {
                     $$7 = true;
                  }
         ...
         return new efz.b($$16, this.a($$0, $$1, $$2, $$3, $$16));
      }

      private int a(int $$0, int $$1, int $$2, efz.b $$3, int $$4, boolean $$5) {
         egg.e $$6 = new egg.e($$0, $$1, $$2);
         double $$7;
         double $$8;
         if (dla.a(this.u, this.v, $$6)) {
            $$7 = -1.0;
            $$8 = -1.0;
         } else {
            int $$9 = $$4 + 8 - $$1;
      ...
      private int a(int $$0, int $$1, int $$2, int $$3) {
         ...
         int $$9 = $$7 * 40 + 20;
         int $$10 = 10;
         double $$11 = this.o.a(new egg.e($$6, $$7, $$8)) * 10.0;
         int $$12 = azm.a($$11, 3);
         int $$13 = $$9 + $$12;
         return Math.min($$3, $$13);
      }

      private eao a(int $$0, int $$1, int $$2, efz.b $$3, int $$4) {
         eao $$5 = $$3.b;
         if ($$4 <= -10 && $$4 != eel.g && $$3.b != dmo.K.m()) {
            int $$6 = 64;
            int $$7 = 40;
            int $$8 = Math.floorDiv($$0, 64);
            int $$9 = Math.floorDiv($$1, 40);
            int $$10 = Math.floorDiv($$2, 64);
            double $$11 = this.p.a(new egg.e($$8, $$9, $$10));
            if (Math.abs($$11) > 0.3) {
               $$5 = dmo.K.m();
            }
         }
