...
public class efz extends ege {
   public static final MapCodec<efz> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, efz::new));
   ...
   public List<eem.a> a(dcc $$0, BiConsumer<iz, dsa> $$1, azf $$2, int $$3, iz $$4, edw $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = ayx.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.d(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, ayx.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<efz.a> $$13 = Lists.newArrayList();
      $$13.add(new efz.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               iz $$21 = $$4.b(ayx.a($$19), $$12 - 1, ayx.a($$20));
               iz $$22 = $$21.b(5);
      ...
      List<eem.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dcc $$0, BiConsumer<iz, dsa> $$1, azf $$2, iz $$3, iz $$4, boolean $$5, edw $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            iz $$13 = $$3.b(ayx.d(0.5F + (float)$$12 * $$9), ayx.d(0.5F + (float)$$12 * $$10), ayx.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dlj.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dcc $$0, BiConsumer<iz, dsa> $$1, azf $$2, int $$3, iz $$4, List<efz.a> $$5, edw $$6) {
      for (efz.a $$7 : $$5) {
         int $$8 = $$7.a();
