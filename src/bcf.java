...
public abstract class bcf extends DataFix {
   private final String a;

   public bcf(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bbv.x);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bbv.x);
      Type<Pair<String, String>> $$2 = DSL.named(bbv.v.typeName(), bdd.a());
      if (!Objects.equals(this.getOutputSchema().getType(bbv.v), $$2)) {
