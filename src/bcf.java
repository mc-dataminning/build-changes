...
public class bcf extends ayz {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), bcf::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", bcf::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", bcf::k);
         $$0 = this.a($$0, "minecraft:fox", bcf::j);
         $$0 = this.a($$0, "minecraft:item", bcf::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", bcf::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", bcf::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", bcf::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", bcf::e);
         return this.a($$0, "minecraft:piglin", bcf::d);
      });
   }
