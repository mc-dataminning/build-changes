...
public class bcf extends bhp {
   public bcf(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bit.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bit.s, "minecraft:jukebox");
