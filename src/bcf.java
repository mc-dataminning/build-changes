...
public class bcf extends bhv {
   public bcf(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", bjb.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(bjb.s, "minecraft:piston");
