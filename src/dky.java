...
public class dky {
   ...
   private final List<dkw> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dky.a l = new dky.d(5.999997E7F);
   public static final dky.c e = new dky.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);
   ...
   public boolean a(blv $$0, elo $$1) {
      double $$2 = Math.max(auo.a($$1.b(), $$1.d()), 1.0);
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dky.a)($$0 == $$1 ? new dky.d($$1) : new dky.b($$0, $$1, $$2));
   ...
   class b implements dky.a {
      ...
      @Override
      public double a() {
         return auo.a(dky.this.a() - this.e() / 2.0, (double)(-dky.this.k), (double)dky.this.k);
      }

      @Override
      public double c() {
         return auo.a(dky.this.b() - this.e() / 2.0, (double)(-dky.this.k), (double)dky.this.k);
      }
      ...
      public double e() {
         ...
         return $$0 < 1.0 ? auo.d($$0, this.b, this.c) : this.c;
      }
      ...
      @Override
      public dkx i() {
         return this.c < this.b ? dkx.b : dkx.a;
      }
      ...
      @Override
      public dky.a l() {
         return (dky.a)(this.g() <= 0L ? dky.this.new d(this.c) : this);
      }
      ...
      public emm m() {
         return emj.a(
            emj.c,
            emj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            elx.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dky.c a(DynamicLike<?> $$0, dky.c $$1) {
         double $$2 = auo.a($$0.get("BorderCenterX").asDouble($$1.a), -2.9999984E7, 2.9999984E7);
         double $$3 = auo.a($$0.get("BorderCenterZ").asDouble($$1.b), -2.9999984E7, 2.9999984E7);
         ...
         return new dky.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dky.a {
      ...
      private void n() {
         this.c = auo.a(dky.this.a() - this.b / 2.0, (double)(-dky.this.k), (double)dky.this.k);
         this.d = auo.a(dky.this.b() - this.b / 2.0, (double)(-dky.this.k), (double)dky.this.k);
         this.e = auo.a(dky.this.a() + this.b / 2.0, (double)(-dky.this.k), (double)dky.this.k);
         this.f = auo.a(dky.this.b() + this.b / 2.0, (double)(-dky.this.k), (double)dky.this.k);
         this.g = emj.a(
            emj.c,
            emj.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            elx.e
