...
public class dky {
   ...
   private boolean a(iz $$0) {
      return den.a(this.a, $$0) || den.a(this.a, $$0.c()) || den.a(this.a, $$0.d());
   }
   ...
   private dky b(iz $$0) {
      dsb $$2 = this.a.a_($$0);
      if (den.g($$2)) {
         return new dky(this.a, $$0, $$2);
      } else {
         iz $$1 = $$0.c();
         $$2 = this.a.a_($$1);
         if (den.g($$2)) {
            return new dky(this.a, $$1, $$2);
         } else {
            $$1 = $$0.d();
            $$2 = this.a.a_($$1);
            return den.g($$2) ? new dky(this.a, $$1, $$2) : null;
         }
      }
   }

   private boolean a(dky $$0) {
      return this.c($$0.b);
   }
   ...
   private boolean b(dky $$0) {
      return this.a($$0) || this.f.size() != 2;
   }

   private void c(dky $$0) {
      this.f.add($$0.b);
      iz $$1 = this.b.e();
      iz $$2 = this.b.f();
      iz $$3 = this.b.g();
   ...
   public dky a(boolean $$0, boolean $$1, dtf $$2) {
      iz $$3 = this.b.e();
      iz $$4 = this.b.f();
      iz $$5 = this.b.g();
      iz $$6 = this.b.h();
