...
public class sn extends si<so> {
   private static final int b = 24;
   public static final ti<sn> a = new ti.b<sn>() {
      public sn a(DataInput $$0, ss $$1) throws IOException {
         return new sn(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof sn && Arrays.equals(this.c, ((sn)$$0).c);
   }
   ...
   public so a(int $$0, so $$1) {
      int $$2 = this.c[$$0];
      this.c[$$0] = $$1.g();
      return so.a($$2);
   }

   public void b(int $$0, so $$1) {
   ...
   public boolean b(int $$0, tg $$1) {
      if ($$1 instanceof sz) {
         this.c = ArrayUtils.add(this.c, $$0, ((sz)$$1).g());
         return true;
      } else {
         return false;
      }
