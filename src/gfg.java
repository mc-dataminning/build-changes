...
public class gfg extends MinecraftServer {
   ...
   public gfg(Thread $$0, esr $$1, eeb.c $$2, aoo $$3, ahb $$4, agy $$5, amk $$6) {
      super($$0, $$2, $$3, $$4, $$1.W(), $$1.aq(), $$5, $$6);
      this.b($$1.V());
      this.c($$1.H());
      this.a(new gff(this, this.aV(), this.i));
      this.p = $$1;
   }
   ...
   public void a(BooleanSupplier $$0) {
      ...
      if ($$3 && this.q) {
         ...
         super.a($$0);
         int $$4 = Math.max(2, this.p.m.e().c());
         if ($$4 != this.ac().p()) {
            n.info("Changing view distance to {}, from {}", $$4, this.ac().p());
            this.ac().a($$4);
         }

         int $$5 = Math.max(2, this.p.m.f().c());
         if ($$5 != this.v) {
   ...
   public boolean a(@Nullable crp $$0, boolean $$1, int $$2) {
      try {
         this.p.aQ();
         this.p.v().a().thenAcceptAsync($$0x -> $$0x.ifPresent($$0xx -> {
               fkx $$1x = this.p.I();
               if ($$1x != null) {
                  $$1x.a($$0xx);
               }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (amb $$1 : Lists.newArrayList(this.ac().t())) {
   ...
   @Override
   public int b(int $$0) {
      return (int)(this.p.m.g().c() * (double)$$0);
   }
   ...
   @Override
   public crp aW() {
      return this.p() ? (crp)MoreObjects.firstNonNull(this.s, this.m.m()) : null;
   }
}
