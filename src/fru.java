public class fru extends frh<csc> implements fuu {
   private static final alh G = alh.b("textures/gui/container/crafting_table.png");
   private final fuo<?> H;
   private boolean I;

   public fru(csc $$0, cog $$1, xh $$2) {
      super($$0, $$1, $$2);
      this.H = new fuk($$0);
   }
   ...
   protected void aS_() {
      ...
      this.c(new fll(this.C + 5, this.o / 2 - 49, 20, 18, fuo.a, $$0 -> {
         this.H.c();
         this.C = this.H.a(this.n, this.s);
