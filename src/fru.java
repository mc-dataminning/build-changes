...
public class fru implements fdt {
   static final Logger b = LogUtils.getLogger();
   private final feu c;
   private final fri<fru.b> d;

   fru(feu $$0, fri<fru.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(akv c, int d, int e, int[][] f) implements frw {
      ...
      public static final MapCodec<fru.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     akv.a.fieldOf("file").forGetter(fru.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fru.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fru.a::e),
                     g.fieldOf("chars").forGetter(fru.a::f)
                  )
                  .apply($$0, fru.a::new)
         )
         .validate(fru.a::a);
      ...
      private static DataResult<fru.a> a(fru.a $$0) {
      ...
      private fdt a(aup $$0) throws IOException {
         ...
         try (InputStream $$2 = $$0.open($$1)) {
            ...
            fri<fru.b> $$9 = new fri<>(fru.b[]::new, fru.b[][]::new);
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fru.b $$15 = $$9.a($$12, new fru.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fru.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
