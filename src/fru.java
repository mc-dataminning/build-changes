...
public class fru implements fri.a {
   private final eqq a;
   private double b = Double.MIN_VALUE;
   private List<bil> c = Collections.emptyList();
   ...
   private void a(elk $$0, fnz $$1, double $$2, double $$3, double $$4, bil $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aD.ifPresent($$10 -> {
   ...
   private void a(gw $$0, elk $$1, double $$2, double $$3, double $$4, fnz $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      fnx.a($$1, $$5.getBuffer(foh.x()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      fnx.a(
         $$1,
         $$5.getBuffer(foh.x()),
         this.a.r.a_($$0).b(this.a.r, $$0, ehn.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
