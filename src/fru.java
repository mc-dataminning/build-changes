...
public class fru implements akd<cyu>, fjj, fkc, fma, frz {
   public static final fjt a = new fjt(akq.b("recipe_book/button"), akq.b("recipe_book/button_highlighted"));
   private static final fjt i = new fjt(
      akq.b("recipe_book/filter_enabled"),
      akq.b("recipe_book/filter_disabled"),
      akq.b("recipe_book/filter_enabled_highlighted"),
      akq.b("recipe_book/filter_disabled_highlighted")
   );
   protected static final akq b = akq.b("textures/gui/recipe_book.png");
   ...
   private static final wy l = wy.c("gui.recipebook.toggleRecipes.craftable");
   private static final wy m = wy.c("gui.recipebook.toggleRecipes.all");
   private int n;
   private int o;
   private int p;
   protected final frs e = new frs();
   private final List<frw> q = Lists.newArrayList();
   @Nullable
   private frw r;
   protected fjm f;
   protected crg<?, ?> g;
   ...
   public void a(int $$0, int $$1, fgi $$2, boolean $$3, crg<?, ?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      this.s = new fip(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, wy.c("itemGroup.search"));
      this.s.f(50);
      this.s.g(true);
      this.s.g(16777215);
      this.s.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new fjm($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (fgq $$3 : fgq.a(this.g.t())) {
         this.q.add(new frw($$3));
      }
   ...
   private void b() {
      this.f.a(this.f.a() ? fjr.a(this.c()) : fjr.a(m));
   }
   ...
   private void c(boolean $$0) {
      List<fry> $$1 = this.v.a(this.r.b());
      $$1.forEach($$0x -> $$0x.a(this.x, this.g.n(), this.g.o(), this.v));
      List<fry> $$2 = Lists.newArrayList($$1);
      $$2.removeIf($$0x -> !$$0x.b());
      $$2.removeIf($$0x -> !$$0x.d());
      String $$3 = this.s.a();
      if (!$$3.isEmpty()) {
         fza $$4 = this.h.L();
         if ($$4 != null) {
            ObjectSet<fry> $$5 = new ObjectLinkedOpenHashSet($$4.B().b().search($$3.toLowerCase(Locale.ROOT)));
   ...
   private void b(fht $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fnx.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(fht $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.f() && !this.h.s.N_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.cd.j, $$3, fnx.s());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   protected void j() {
      if (this.h.L() != null) {
         ...
         this.h.L().b(new aho($$0, $$1, $$2));
      }
   }

   @Override
   public fma.a u() {
      return this.A ? fma.a.b : fma.a.a;
   }

   @Override
   public void b(fmc $$0) {
      List<fma> $$1 = Lists.newArrayList();
      this.w.a($$1x -> {
         if ($$1x.C()) {
            $$1.add($$1x);
         }
