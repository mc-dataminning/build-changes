      ...
      while (this.d.x()) {
         ...
         if ($$2 > this.e) {
            a.error(
               ...
               String.format(Locale.ROOT, "%.2f", (float)$$2 / (float)bal.a),
               String.format(Locale.ROOT, "%.2f", this.d.aP().g() / (float)bal.c)
            );
            ...
            $$4.a("Random tick rate", () -> this.d.aZ().o().a(dex.o).toString());
