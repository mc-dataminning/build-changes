...
public class aqi {
         ...
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a("time").requires($$0x -> $$0x.c(2)))
            ...
            .then(
               ((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a("query")
                     ...
                     .then(ex.a("gametime").executes($$0x -> c((ew)$$0x.getSource(), (int)(((ew)$$0x.getSource()).e().ac() % 2147483647L)))))
                  .then(ex.a("day").executes($$0x -> c((ew)$$0x.getSource(), (int)(((ew)$$0x.getSource()).e().ad() / 24000L % 2147483647L))))
            )
      );
   }

   private static int a(ash $$0) {
      return (int)($$0.ad() % 24000L);
   }

   private static int c(ew $$0, int $$1) {
      $$0.a(() -> xv.a("commands.time.query", $$1), false);
      return $$1;
   }
   ...
   public static int a(ew $$0, int $$1) {
      ...
      $$0.a(() -> xv.a("commands.time.set", $$1), true);
      return a($$0.e());
   }
   ...
   public static int b(ew $$0, int $$1) {
      ...
      int $$3 = a($$0.e());
      $$0.a(() -> xv.a("commands.time.set", $$3), true);
      return $$3;
   }
}
