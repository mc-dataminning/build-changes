public class flx extends fmy {
   private static final alb a = new alb("textures/gui/demo_background.png");
   private fhs b = fhs.a;
   private fhs c = fhs.a;
   ...
   protected void aN_() {
      ...
      this.b = fhs.a(
         this.p,
         xl.a("demo.help.movementShort", $$1.w.k(), $$1.x.k(), $$1.y.k(), $$1.z.k()),
         xl.c("demo.help.movementMouse"),
         xl.a("demo.help.jump", $$1.A.k()),
         xl.a("demo.help.inventory", $$1.D.k())
      );
      this.c = fhs.a(this.p, xl.c("demo.help.fullWrapped"), 218);
   }
