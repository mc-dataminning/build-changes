...
public class cpb<T> {
   ...
   public boolean a(List<cpb.a<T>> $$0, int $$1, @Nullable cpb.b<T> $$2) {
      return new cpb.c($$0).a($$1, $$2);
   }

   public int b(List<cpb.a<T>> $$0, int $$1, @Nullable cpb.b<T> $$2) {
   ...
   class c {
      ...
      private List<T> b() {
         ...
         for (cpb.a<T> $$1 : this.c) {
            $$0.addAll($$1.a());
         }

         $$0.removeIf($$0x -> !cpb.this.a((T)$$0x));
      ...
      private int o() {
         ...
         for (cpb.a<T> $$1 : this.c) {
            ...
            for (T $$3 : $$1.a()) {
               $$2 = Math.max($$2, cpb.this.a.getInt($$3));
            }
