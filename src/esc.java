...
public class esc {
   ...
   @Deprecated
   public static esc a(azh $$0, esc.a $$1) {
      return new esc($$0, $$1, false);
   }

   public static esc a(azh $$0, int $$1, double... $$2) {
      return b($$0, new esc.a($$1, new DoubleArrayList($$2)));
   }

   public static esc b(azh $$0, esc.a $$1) {
      return new esc($$0, $$1, true);
   }

   private esc(azh $$0, esc.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<esc.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(esc.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(esc.a::b))
               .apply($$0, esc.a::new)
      );
      public static final Codec<jr<esc.a>> b = akq.a(mc.aS, a);
