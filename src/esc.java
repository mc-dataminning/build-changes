public abstract class esc extends esg implements etj, etw {
   ...
   public esc(int $$0, int $$1, int $$2, int $$3, te $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int v() {
      return aro.a((int)((float)(this.g * this.g) / (float)this.w()), 32, this.g);
   }
   ...
   protected void a(double $$0) {
      this.e = aro.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(erx $$0, int $$1, int $$2, int $$3, int $$4) {
      int $$5 = this.ax_() ? -1 : -6250336;
      $$0.a($$1, $$2, $$1 + $$3, $$2 + $$4, $$5);
   ...
   private void c(erx $$0) {
      int $$1 = this.v();
      int $$2 = this.p() + this.f;
      int $$3 = this.p() + this.f + 8;
      int $$4 = Math.max(this.r(), (int)this.e * (this.g - $$1) / this.d() + this.r());
      int $$5 = $$4 + $$1;
      $$0.a($$2, $$4, $$3, $$5, -8355712);
   ...
   protected abstract void c(erx var1, int var2, int var3, float var4);
}
