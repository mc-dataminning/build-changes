...
public class esc extends esg implements ese {
   ...
   public esc.c a() {
      return new esc.c(this.q, this.m, this.u, this.v);
   }
   ...
   private IntConsumer a(int $$0, esm.a $$1) {
   ...
   private esc.b q() {
      ...
      this.k += $$5;
      this.j++;
      esc.a $$9 = new esc.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new esc.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == esm.b.a || this.q == esm.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<esn> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      esn $$1 = (esn)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == esn.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == esn.b.c) {
         ese.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, ese.a($$11));
         this.a($$14 + 5, ese.a($$12));
         this.a($$14 + 6, ese.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(esm a, int b, int c, esm.b d, esm.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(esm.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable esp $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
