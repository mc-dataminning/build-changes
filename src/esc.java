...
public abstract class esc<E extends esc.a<E>> extends ety implements eti, evv {
   protected static final int b = 6;
   private static final aer a = new aer("widget/scroller");
   protected final eqm c;
   protected final int d;
   private final List<E> m = new esc.b();
   protected int e;
   protected int f;
   protected int g;
   protected int h;
   ...
   public esc(eqm $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   protected final E a(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = arp.a($$1 - (double)this.g) - this.l + (int)this.l() - 4;
      int $$7 = $$6 / this.d;
   ...
   public void a(erw $$0, int $$1, int $$2, float $$3) {
      this.u = this.a_((double)$$1, (double)$$2) ? this.a((double)$$1, (double)$$2) : null;
      if (this.t) {
         $$0.a(0.125F, 0.125F, 0.125F, 1.0F);
         int $$4 = 32;
         $$0.a(exz.d, this.j, this.g, (float)this.i, (float)(this.h + (int)this.l()), this.i - this.j, this.h - this.g, 32, 32);
         $$0.a(1.0F, 1.0F, 1.0F, 1.0F);
         int $$5 = 4;
         $$0.a(fnt.D(), this.j, this.g, this.i, this.g + 4, -16777216, 0, 0);
         $$0.a(fnt.D(), this.j, this.h - 4, this.i, this.h, 0, -16777216, 0);
      }

      int $$6 = this.o();
      int $$7 = this.g + 4 - (int)this.l();
      this.a($$0);
      if (this.p) {
         this.a($$0, $$6, $$7);
      }
      ...
      if ($$8 > 0) {
         ...
         $$10 = arp.a($$10, 32, this.h - this.g - 8);
   ...
   public void a(double $$0) {
      this.n = arp.a($$0, 0.0, (double)this.m());
   }
   ...
   protected void c(double $$0, double $$1, int $$2) {
      this.q = $$2 == 0 && $$0 >= (double)this.c() && $$0 < (double)(this.c() + 6);
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.g) {
            ...
            int $$6 = this.h - this.g;
            int $$7 = arp.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(ewf $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.f());
   }

   @Nullable
   protected E a(ewf $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(erw $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public evv.a q() {
      if (this.ax_()) {
         ...
         return this.u != null ? evv.a.b : evv.a.a;
      }
   }
   ...
   protected void a(evx $$0, E $$1) {
      List<E> $$2 = this.i();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(evw.b, tf.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }
   ...
   @Override
   public ewh s() {
      return new ewh(this.j, this.g, this.i - this.j, this.h - this.g);
   }

   protected abstract static class a<E extends esc.a<E>> implements eua {
      @Deprecated
      esc<E> a;
      ...
      public abstract void a(erw var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
