...
public class eix implements eis {
   public static final Codec<eix> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ma.e.q().fieldOf("block").flatXmap(eix::a, DataResult::success).orElse((dpg)dkg.fu).forGetter($$0x -> $$0x.b),
   ...
   public final ju<dke> h;
   private final ObjectArrayList<jm> i;

   private static DataResult<dpg> a(dke $$0) {
      return $$0 instanceof dpg $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public eix(dpg $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, ju<dke> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
