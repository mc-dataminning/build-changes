...
public class eix extends ejc {
   ...
   public List<ehk.a> a(dep $$0, BiConsumer<jf, dus> $$1, azn $$2, int $$3, jf $$4, egu $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azf.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azf.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<eix.a> $$13 = Lists.newArrayList();
      $$13.add(new eix.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               jf $$21 = $$4.b(azf.a($$19), $$12 - 1, azf.a($$20));
               jf $$22 = $$21.b(5);
               if (this.a($$0, $$1, $$2, $$21, $$22, false, $$5)) {
                  ...
                  jf $$27 = new jf($$4.u(), $$26, $$4.w());
                  if (this.a($$0, $$1, $$2, $$27, $$21, false, $$5)) {
                     $$13.add(new eix.a($$21, $$27.v()));
                  }
               }
            }
         }
      ...
      List<ehk.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dep $$0, BiConsumer<jf, dus> $$1, azn $$2, jf $$3, jf $$4, boolean $$5, egu $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         return true;
      } else {
         jf $$7 = $$4.b(-$$3.u(), -$$3.v(), -$$3.w());
         int $$8 = this.a($$7);
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            jf $$13 = $$3.b(azf.d(0.5F + (float)$$12 * $$9), azf.d(0.5F + (float)$$12 * $$10), azf.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dnz.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dep $$0, BiConsumer<jf, dus> $$1, azn $$2, int $$3, jf $$4, List<eix.a> $$5, egu $$6) {
      for (eix.a $$7 : $$5) {
         int $$8 = $$7.a();
         jf $$9 = new jf($$4.u(), $$8, $$4.w());
