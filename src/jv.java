...
public class jv {
   ...
   static <T> jg<T> a(final jh.b<T> $$0) {
      return new jv.c<T>($$0) {
         @Override
         public Optional<jf.c<T>> a(alh<T> $$0x) {
            return $$0.a($$0);
         }
      };
   }

   static <T> jh.b<T> a(final alh<? extends js<? extends T>> $$0, final Lifecycle $$1, ji<T> $$2, final Map<alh<T>, jf.c<T>> $$3) {
      return new jv.e<T>($$2) {
         @Override
         public alh<? extends js<? extends T>> g() {
            return $$0;
         }
   ...
   public <T> jv a(alh<? extends js<T>> $$0, Lifecycle $$1, jv.i<T> $$2) {
      this.a.add(new jv.k<>($$0, $$1, $$2));
      return this;
   }

   public <T> jv a(alh<? extends js<T>> $$0, jv.i<T> $$1) {
   ...
   private static jh.a a(jv.m $$0, jt $$1, Stream<jh.b<?>> $$2) {
      record a<T>(jh.b<T> a, alg.b<T> b) {
         public static <T> a<T> a(jh.b<T> $$0) {
            return new a<>(new jv.d<>($$0, $$0), alg.b.a($$0));
         }

         public static <T> a<T> a(jv.m $$0, jh.b<T> $$1) {
            return new a<>(new jv.d<>($$0.a(), $$1), new alg.b<>($$0.a(), $$1, $$1.h()));
         }
      }

      final Map<alh<? extends js<?>>, a<?>> $$3 = new HashMap<>();
      ...
      return new jh.a() {
         ...
         <T> Optional<a<T>> f(alh<? extends js<? extends T>> $$0) {
            return Optional.ofNullable((a<T>)$$3.get($$0));
         }

         @Override
         public <T> Optional<jh.b<T>> a(alh<? extends js<? extends T>> $$0) {
   ...
   private jh.a a(jt $$0, jh.a $$1, ix.a $$2, Map<alh<? extends js<?>>, jv.j<?>> $$3, jh.a $$4) {
      jv.m $$5 = new jv.m();
   ...
   private <T> jh.b<T> a(ji<T> $$0, ix.a $$1, alh<? extends js<? extends T>> $$2, jh.a $$3, jh.a $$4, MutableObject<jh.a> $$5) {
      ix<T> $$6 = $$1.a($$2);
      if ($$6 == null) {
         throw new NullPointerException("No cloner for " + $$2.a());
      } else {
         Map<alh<T>, jf.c<T>> $$7 = new HashMap<>();
         jh.b<T> $$8 = $$3.e($$2);
         $$8.c().forEach($$5x -> {
            alh<T> $$6x = $$5x.h();
   ...
   public jv.g a(jt $$0, jh.a $$1, ix.a $$2) {
      jv.b $$3 = this.b($$0);
      Map<alh<? extends js<?>>, jv.j<?>> $$4 = new HashMap<>();
      this.a.stream().map($$1x -> $$1x.a($$3)).forEach($$1x -> $$4.put($$1x.a, $$1x));
      Set<alh<? extends js<?>>> $$5 = $$0.b().collect(Collectors.toUnmodifiableSet());
   ...
   static record b(jv.m a, jv.l b, Map<ali, jg<?>> c, Map<alh<?>, jv.h<?>> d, List<RuntimeException> e) {

      public static jv.b a(jt $$0, Stream<alh<? extends js<?>>> $$1) {
         jv.m $$2 = new jv.m();
         List<RuntimeException> $$3 = new ArrayList<>();
         jv.l $$4 = new jv.l($$2);
         Builder<ali, jg<?>> $$5 = ImmutableMap.builder();
      ...
      public <T> qh<T> a() {
         return new qh<T>() {
            @Override
            public jf.c<T> a(alh<T> $$0, T $$1, Lifecycle $$2) {
            ...
            @Override
            public <S> jg<S> a(alh<? extends js<? extends S>> $$0) {
      ...
      public void c() {
         for (alh<Object> $$0 : this.b.a.keySet()) {
   ...
   static class f<T> extends jf.c<T> {
      ...
      protected f(ji<T> $$0, @Nullable alh<T> $$1) {
   ...
   static record j<T>(alh<? extends js<? extends T>> a, Lifecycle b, Map<alh<T>, jv.n<T>> c) {

      public jh.b<T> a(jv.m $$0) {
         Map<alh<T>, jf.c<T>> $$1 = this.c.entrySet().stream().collect(Collectors.toUnmodifiableMap(Entry::getKey, $$1x -> {
            jv.n<T> $$2 = (jv.n<T>)$$1x.getValue();
            jf.c<T> $$3 = $$2.b().orElseGet(() -> jf.c.a($$0.a(), (alh<T>)$$1x.getKey()));
            $$3.b($$2.a().a());
            return $$3;
         }));
   ...
   static record k<T>(alh<? extends js<T>> a, Lifecycle b, jv.i<T> c) {
      void b(jv.b $$0) {
         this.c.run($$0.a());
      }

      public jv.j<T> a(jv.b $$0) {
         Map<alh<T>, jv.n<T>> $$1 = new HashMap<>();
         Iterator<Entry<alh<?>, jv.h<?>>> $$2 = $$0.d.entrySet().iterator();

         while ($$2.hasNext()) {
            Entry<alh<?>, jv.h<?>> $$3 = $$2.next();
            alh<?> $$4 = $$3.getKey();
            if ($$4.c(this.a)) {
               jv.h<T> $$6 = (jv.h<T>)$$3.getValue();
               jf.c<T> $$7 = (jf.c<T>)$$0.b.a.remove($$4);
               $$1.put((alh<T>)$$4, new jv.n<>($$6, Optional.ofNullable($$7)));
               $$2.remove();
            }
         }
   ...
   static class l extends jv.c<Object> {
      final Map<alh<Object>, jf.c<Object>> a = new HashMap<>();
