public class gju extends gjq {
   private final gjl a;
   private static final int b = 8;

   protected gju(gfi $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gjl $$8) {
   ...
   public static class a implements git<lw> {
      ...
      public giq a(lw $$0, gfi $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gju($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
