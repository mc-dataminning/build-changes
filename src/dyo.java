...
public class dyo {
   ...
   private final List<dym> a = Lists.newArrayList();
   ...
   private double j;
   int k = 29999984;
   private dyo.a l = new dyo.d(5.999997E7F);
   public static final dyo.c d = new dyo.c(0.0, 0.0, 0.2, 5.0, 5, 15, 5.999997E7F, 0L, 0.0);

   public boolean a(ji $$0) {
      return this.a((double)$$0.u(), (double)$$0.w());
   }

   public boolean a(fbb $$0) {
   ...
   public fbb c(double $$0, double $$1, double $$2) {
      return new fbb(ayz.a($$0, this.e(), this.g() - 1.0E-5F), $$1, ayz.a($$2, this.f(), this.h() - 1.0E-5F));
   }
   ...
   public void a(double $$0, double $$1, long $$2) {
      this.l = (dyo.a)($$0 == $$1 ? new dyo.d($$1) : new dyo.b($$0, $$1, $$2));
   ...
   public dyo.c t() {
      return new dyo.c(this);
   }

   public void a(dyo.c $$0) {
      this.c($$0.a(), $$0.b());
      this.c($$0.c());
      this.b($$0.d());
      this.c($$0.e());
   ...
   class b implements dyo.a {
      ...
      @Override
      public double a() {
         return ayz.a(dyo.this.a() - this.e() / 2.0, (double)(-dyo.this.k), (double)dyo.this.k);
      }

      @Override
      public double c() {
         return ayz.a(dyo.this.b() - this.e() / 2.0, (double)(-dyo.this.k), (double)dyo.this.k);
      }
      ...
      @Override
      public dyn i() {
         return this.c < this.b ? dyn.b : dyn.a;
      }
      ...
      @Override
      public dyo.a l() {
         return (dyo.a)(this.g() <= 0L ? dyo.this.new d(this.c) : this);
      }
      ...
      public fbv m() {
         return fbs.a(
            fbs.c,
            fbs.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fbf.e
         );
      }
   }
   ...
   public static class c {
      ...
      public static dyo.c a(DynamicLike<?> $$0, dyo.c $$1) {
         ...
         return new dyo.c($$2, $$3, $$8, $$7, $$9, $$10, $$4, $$5, $$6);
      }
   ...
   class d implements dyo.a {
      ...
      private void n() {
         this.c = ayz.a(dyo.this.a() - this.b / 2.0, (double)(-dyo.this.k), (double)dyo.this.k);
         this.d = ayz.a(dyo.this.b() - this.b / 2.0, (double)(-dyo.this.k), (double)dyo.this.k);
         this.e = ayz.a(dyo.this.a() + this.b / 2.0, (double)(-dyo.this.k), (double)dyo.this.k);
         this.f = ayz.a(dyo.this.b() + this.b / 2.0, (double)(-dyo.this.k), (double)dyo.this.k);
         this.g = fbs.a(
            fbs.c,
            fbs.a(Math.floor(this.a()), Double.NEGATIVE_INFINITY, Math.floor(this.c()), Math.ceil(this.b()), Double.POSITIVE_INFINITY, Math.ceil(this.d())),
            fbf.e
