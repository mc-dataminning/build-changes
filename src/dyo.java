...
public class dyo {
   private static final dse a = dfd.hj.o();
   private static final dse b = dfd.hk.o();
   private static final dse c = dfd.iA.o();
   private static final dse d = dfd.hn.o();
   private static final dse e = dfd.hv.o();
   private static final dse f = dfd.hx.o();
   private static final dse g = dfd.hr.o();
   private static final dse h = dfd.iC.o();
   private static final dse i = dfd.dP.o();
   private final dse j;
   private final int k;
   private final dse[] l;
   private final ena m;
   ...
   public dyo(dyk $$0, dse $$1, int $$2, dyj $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dyf.P);
   ...
   public void a(dyk $$0, ddb $$1, jv<dcz> $$2, boolean $$3, dyt $$4, final dua $$5, dya $$6, dyn.o $$7) {
      ...
      dyn.g $$13 = new dyn.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dyn.u $$14 = $$7.apply($$13);
      iz.a $$15 = new iz.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dxw.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            ji<dcz> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(ddg.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dxw.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dse> a(dyn.o $$0, dzw $$1, Function<iz, ji<dcz>> $$2, dua $$3, dya $$4, iz $$5, boolean $$6) {
      dyn.g $$7 = new dyn.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(lq.az), $$1);
      dyn.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dse $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dtx $$0, int $$1, int $$2, int $$3, dcc $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dcz $$1, dtx $$2, iz.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dfd.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(azh $$0, dse[] $$1, int $$2, dse $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dse a(int $$0, int $$1, int $$2) {
