...
public class aqb extends dwj implements apz.b, aqm {
   ...
   public static final int c = aqa.a(aql.d);
   private final Long2ObjectLinkedOpenHashMap<apz> o = new Long2ObjectLinkedOpenHashMap();
   private volatile Long2ObjectLinkedOpenHashMap<apz> p = this.o.clone();
   private final Long2ObjectLinkedOpenHashMap<apz> q = new Long2ObjectLinkedOpenHashMap();
   private final List<apy> r = new ArrayList<>();
   final aqu s;
   private final aqx t;
   ...
   private final aqo J = new aqo();
   private final Int2ObjectMap<aqb.b> K = new Int2ObjectOpenHashMap();
   ...
   public aqb(
      ...
      super(new dws($$1.f(), $$0.af(), "chunk"), $$1.a($$0.af()).resolve("region"), $$2, $$12);
      Path $$13 = $$1.a($$0.af());
      this.I = $$13.getFileName().toString();
      this.s = $$0;
      ka $$14 = $$0.H_();
      long $$15 = $$0.C();
      if ($$7 instanceof dzb $$16) {
         this.v = dzm.a($$16.h().a(), $$14.b(lu.aP), $$15);
      } else {
         this.v = dzm.a(dzd.e(), $$14.b(lu.aP), $$15);
      }

      this.w = $$7.a($$14.b(lu.aT), this.v, $$15);
      this.u = $$5;
      bpk<Runnable> $$17 = bpk.a($$4, "worldgen");
      bpj<Runnable> $$18 = bpj.a("main", $$5::i);
      this.E = $$8;
      this.F = $$9;
      bpk<Runnable> $$19 = bpk.a($$4, "light");
      this.B = new aqe(ImmutableList.of($$17, $$18, $$19), $$4, Integer.MAX_VALUE);
      this.C = this.B.a($$17, false);
      this.D = this.B.a($$18, false);
      this.t = new aqx($$6, this, this.s.D_().g(), $$19, this.B.a($$19, false));
      this.G = new aqb.a($$4, $$5);
      this.x = $$10;
      this.y = new ces(new dws($$1.f(), $$0.af(), "poi"), $$13.resolve("poi"), $$2, $$12, $$14, $$0.o(), $$0);
      this.a($$11);
      this.P = new dwe($$0, $$7, $$3, this.t, this.D);
   }
   ...
   boolean a(aqv $$0, int $$1, int $$2) {
      return $$0.X().a($$1, $$2) && !$$0.c.g.a(dcd.c($$1, $$2));
   }

   private boolean b(aqv $$0, int $$1, int $$2) {
      if (!this.a($$0, $$1, $$2)) {
         return false;
      } else {
         for (int $$3 = -1; $$3 <= 1; $$3++) {
   ...
   @Nullable
   protected apz a(long $$0) {
      return (apz)this.o.get($$0);
   }

   @Nullable
   protected apz b(long $$0) {
      return (apz)this.p.get($$0);
   }

   protected IntSupplier c(long $$0) {
      return () -> {
         apz $$1 = this.b($$0);
         return $$1 == null ? aqd.a - 1 : Math.min($$1.j(), aqd.a - 1);
      };
   }
   ...
   private CompletableFuture<aqc<List<duy>>> a(apz $$0, int $$1, IntFunction<dvz> $$2) {
      if ($$1 == 0) {
         dvz $$3 = $$2.apply(0);
         return $$0.a($$3, this).thenApply($$0x -> $$0x.a(List::of));
      } else {
         List<CompletableFuture<aqc<duy>>> $$4 = new ArrayList<>();
         dcd $$5 = $$0.r();

         for (int $$6 = -$$1; $$6 <= $$1; $$6++) {
            for (int $$7 = -$$1; $$7 <= $$1; $$7++) {
               int $$8 = Math.max(Math.abs($$7), Math.abs($$6));
               long $$9 = dcd.c($$5.e + $$7, $$5.f + $$6);
               apz $$10 = this.a($$9);
               if ($$10 == null) {
                  return g;
               }
         ...
         return ad.d($$4).thenApply($$0x -> {
            List<duy> $$1x = Lists.newArrayList();
   ...
   public z a(IllegalStateException $$0, String $$1) {
      ...
      Consumer<apz> $$3 = $$1x -> $$1x.t().forEach($$2x -> {
            dvz $$3x = (dvz)$$2x.getFirst();
            CompletableFuture<aqc<duy>> $$4x = (CompletableFuture<aqc<duy>>)$$2x.getSecond();
   ...
   public CompletableFuture<aqc<dvi>> a(apz $$0) {
      return this.a($$0, 2, $$0x -> dvz.n).thenApplyAsync($$0x -> $$0x.a($$0xx -> (dvi)$$0xx.get($$0xx.size() / 2)), this.u);
   }

   @Nullable
   apz a(long $$0, int $$1, @Nullable apz $$2, int $$3) {
      if (!aqa.f($$3) && !aqa.f($$1)) {
         return $$2;
      } else {
         if ($$2 != null) {
         ...
         if (aqa.f($$1) && $$2 == null) {
            $$2 = (apz)this.q.remove($$0);
            if ($$2 != null) {
               $$2.a($$1);
            } else {
               $$2 = new apz(new dcd($$0), $$1, this.s, this.t, this.B, this);
            }
   ...
   protected void a(boolean $$0) {
      if ($$0) {
         List<apz> $$1 = this.p.values().stream().filter(apz::k).peek(apz::l).toList();
   ...
   private void b(BooleanSupplier $$0) {
      ...
      int $$7 = 0;
      ObjectIterator<apz> $$8 = this.p.values().iterator();

      while ($$7 < 20 && $$0.getAsBoolean() && $$8.hasNext()) {
         if (this.d((apz)$$8.next())) {
            $$7++;
         }
      }
   }

   private void a(long $$0, apz $$1) {
      $$1.g().thenRunAsync(() -> {
         if (!$$1.h()) {
            this.a($$0, $$1);
         } else {
   ...
   private CompletableFuture<duy> f(dcd $$0) {
      return this.j($$0).thenApply($$1 -> $$1.filter($$1x -> {
         ...
         if ($$1.isPresent()) {
            duy $$2 = dwi.a(this.s, this.y, this.q(), $$0, $$1.get());
            this.a($$0, $$2.j().d());
            return $$2;
         } else {
            return this.g($$0);
   ...
   private static boolean b(ub $$0) {
      return $$0.b("Status", 8);
   }

   private duy a(Throwable $$0, dcd $$1) {
      ...
      boolean $$7 = $$5 instanceof IOException || $$5 instanceof um;
      if (!$$6 && $$7) {
   ...
   private duy g(dcd $$0) {
      this.h($$0);
      return new dvs($$0, dvv.a, this.s, this.s.H_().d(lu.aF), null);
   }

   private void h(dcd $$0) {
      this.L.put($$0.a(), (byte)-1);
   }

   private byte a(dcd $$0, dwd $$1) {
      return this.L.put($$0.a(), (byte)($$1 == dwd.a ? -1 : 1));
   }

   @Override
   public aqn d(long $$0) {
      apz $$1 = (apz)this.o.get($$0);
      $$1.m();
      return $$1;
   }
   ...
   @Override
   public CompletableFuture<duy> a(aqn $$0, dwc $$1, azi<aqn> $$2) {
      dcd $$3 = $$0.r();
      if ($$1.a() == dvz.c) {
         return this.f($$3);
      } else {
         try {
            ...
            if ($$5 == null) {
               ...
               CompletableFuture<duy> $$6 = $$1.a(this.P, $$2, $$5);
               this.E.a($$3, $$1.a());
               return $$6;
            }
            ...
            $$9.a("Position hash", dcd.c($$3.e, $$3.f));
   ...
   @Override
   public apy a(dvz $$0, dcd $$1) {
      apy $$2 = apy.a(this, $$0, $$1);
      this.r.add($$2);
      return $$2;
   }

   private void a(apy $$0) {
      this.C.a(aqe.a($$0.c(), () -> {
   ...
   public CompletableFuture<aqc<dvi>> b(apz $$0) {
      CompletableFuture<aqc<List<duy>>> $$1 = this.a($$0, 1, $$0x -> dvz.n);
      CompletableFuture<aqc<dvi>> $$2 = $$1.<aqc<dvi>>thenApplyAsync(
            $$0x -> $$0x.a($$0xx -> (dvi)$$0xx.get($$0xx.size() / 2)), $$1x -> this.D.a(aqe.a($$0, $$1x))
         )
   ...
   public CompletableFuture<aqc<dvi>> c(apz $$0) {
      return this.a($$0, 1, aqa::b).thenApplyAsync($$0x -> $$0x.a($$0xx -> (dvi)$$0xx.get($$0xx.size() / 2)), $$1 -> this.D.a(aqe.a($$0, $$1)));
   }
   ...
   private boolean a(duy $$0) {
      ...
      if (!$$0.i()) {
         ...
         try {
            ...
            this.s.o().b(var5, this.q(), $$1);
            return false;
         }
      }
   }

   private boolean i(dcd $$0) {
   ...
   int b(aqv $$0) {
      return ayo.a($$0.F(), 2, this.O);
   }

   private void a(aqv $$0, dcd $$1) {
      dvi $$2 = this.e($$1.a());
      if ($$2 != null) {
         a($$0, $$2);
      }
   ...
   private static void a(aqv $$0, dvi $$1) {
      $$0.c.g.a($$1);
   }

   private static void b(aqv $$0, dcd $$1) {
      $$0.c.g.a($$0, $$1);
   }
   ...
   void a(Writer $$0) throws IOException {
      ...
      while (var4.hasNext()) {
         Entry<apz> $$3 = (Entry<apz>)var4.next();
         long $$4 = $$3.getLongKey();
         dcd $$5 = new dcd($$4);
         apz $$6 = (apz)$$3.getValue();
         Optional<duy> $$7 = Optional.ofNullable($$6.p());
         ...
         $$1.a(
            ...
            $$6.i(),
            $$7.isPresent(),
            $$7.map(duy::j).orElse(null),
            $$8.map(dvi::D).orElse(null),
            a($$6.c()),
            a($$6.a()),
            a($$6.b()),
            this.G.e($$4),
   ...
   private static String a(CompletableFuture<aqc<dvi>> $$0) {
      try {
         aqc<dvi> $$1 = $$0.getNow(null);
         if ($$1 != null) {
   ...
   private CompletableFuture<Optional<ub>> j(dcd $$0) {
   ...
   public List<aqv> c(dcd $$0) {
      long $$1 = $$0.a();
      if (!this.G.f($$1)) {
         return List.of();
      } else {
         Builder<aqv> $$2 = ImmutableList.builder();
   ...
   private boolean c(aqv $$0) {
      return $$0.R_() && !this.s.ab().b(dcs.r);
   }

   void a(aqv $$0, boolean $$1) {
      boolean $$2 = this.c($$0);
   ...
   private void a(aqv $$0, aqg $$1) {
      if ($$0.dP() == this.s) {
         ...
         aqg.a($$2, $$1, $$1x -> this.a($$0, $$1x), $$1x -> b($$0, $$1x));
         $$0.a($$1);
      }
   }

   @Override
   public List<aqv> a(dcd $$0, boolean $$1) {
      Set<aqv> $$2 = this.J.a();
      Builder<aqv> $$3 = ImmutableList.builder();
      ...
      if (!($$0 instanceof chy)) {
         ...
         if ($$2 != 0) {
            ...
            if (this.K.containsKey($$0.an())) {
               ...
               aqb.b $$4 = new aqb.b($$0, $$2, $$3, $$1.q());
               this.K.put($$0.an(), $$4);
               $$4.a(this.s.x());
               if ($$0 instanceof aqv $$5) {
                  this.a($$5, true);
                  ObjectIterator var7 = this.K.values().iterator();

                  while (var7.hasNext()) {
                     aqb.b $$6 = (aqb.b)var7.next();
                     if ($$6.c != $$5) {
                        $$6.b($$5);
                     }
                  }
   ...
   protected void b(bsr $$0) {
      if ($$0 instanceof aqv $$1) {
         this.a($$1, false);
         ObjectIterator var3 = this.K.values().iterator();

         while (var3.hasNext()) {
            aqb.b $$2 = (aqb.b)var3.next();
            $$2.a($$1);
         }
      }

      aqb.b $$3 = (aqb.b)this.K.remove($$0.an());
      if ($$3 != null) {
         $$3.a();
      }
   }
   ...
   public void a(bsr $$0, zg<?> $$1) {
      aqb.b $$2 = (aqb.b)this.K.get($$0.an());
      if ($$2 != null) {
         $$2.a($$1);
      }
   }

   protected void b(bsr $$0, zg<?> $$1) {
      aqb.b $$2 = (aqb.b)this.K.get($$0.an());
      if ($$2 != null) {
         $$2.b($$1);
      }
   ...
   public void a(List<duy> $$0) {
      Map<aqv, List<dvi>> $$1 = new HashMap<>();
      ...
      for (duy $$2 : $$0) {
         ...
         for (aqv $$7 : this.a($$3, false)) {
            $$1.computeIfAbsent($$7, $$0x -> new ArrayList<>()).add($$5);
         }
      }

      $$1.forEach(($$0x, $$1x) -> $$0x.c.b(ack.a($$1x)));
   }
   ...
   public void a(dcd $$0, int $$1) {
      int $$2 = $$1 + 1;
      dcd.a($$0, $$2).forEach($$0x -> {
         apz $$1x = this.b($$0x.a());
         if ($$1x != null) {
   ...
   class a extends aqk {
      ...
      @Nullable
      @Override
      protected apz a(long $$0, int $$1, @Nullable apz $$2, int $$3) {
         return aqb.this.a($$0, $$1, $$2, $$3);
      }
   }
   ...
   class b {
      ...
      private final int d;
      kf e;
      private final Set<arx> f = Sets.newIdentityHashSet();

      public b(final bsr $$0, final int $$1, final int $$2, final boolean $$3) {
         this.b = new aqt(aqb.this.s, $$0, $$2, $$3, this::a);
         this.c = $$0;
         this.d = $$1;
         this.e = kf.a($$0);
      }
      ...
      public boolean equals(Object $$0) {
         return $$0 instanceof aqb.b ? ((aqb.b)$$0).c.an() == this.c.an() : false;
      }
