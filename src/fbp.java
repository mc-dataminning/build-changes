...
public class fbp {
   ...
   public void a(fcz $$0, String $$1, fdv.a $$2, erf $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
         ...
         this.i.setUncaughtExceptionHandler(new fdd(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, erf $$2) throws IOException {
      ...
      File $$15 = new File(fgj.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, erf $$2, fdv.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
   ...
   class c implements ActionListener {
      ...
      private final fdv.a c;
      private final fcz d;

      c(File $$0, fdv.a $$1, fcz $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
