...
public class fbp extends faz implements flj.a {
   private static final agm p = new agm("textures/gui/advancements/window.png");
   ...
   private static final uv w = uv.c("advancements.sad_label");
   private static final uv x = uv.c("advancements.empty");
   private static final uv y = uv.c("gui.advancements");
   private final flj z;
   private final Map<af, fbl> A = Maps.newLinkedHashMap();
   @Nullable
   private fbl B;
   private boolean C;
   ...
   protected void aQ_() {
      ...
      if (this.B == null && !this.A.isEmpty()) {
         fbl $$0 = this.A.values().iterator().next();
         this.z.a($$0.c().b(), true);
      } else {
   ...
   public void a(eut $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (fbl $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (fbl $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ag $$0) {
      fbl $$1 = fbl.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0.b(), $$1);
      }
   }
