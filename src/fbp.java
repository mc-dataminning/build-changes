...
public class fbp {
   ...
   public void a(fcx $$0, String $$1, fdu.a $$2, eqz $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fbp.b $$13 = new fbp.b($$1.trim(), this.f, $$3, $$2);
                  fbp.a $$14 = new fbp.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fbp.c $$30 = new fbp.c(this.f, $$2, $$0);
                        fbp.a $$31 = new fbp.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fdb(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eqz $$2) throws IOException {
      ...
      File $$15 = new File(fgi.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final eqz d;
      private final fdu.a e;

      b(final String $$0, final File $$1, final eqz $$2, final fdu.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fbp.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fbp.this.b && !fbp.this.d) {
            try {
               fbp.this.e = true;
               fbp.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fbp.a.error("Error extracting archive", var3);
               fbp.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fdu.a c;
      private final fcx d;

      c(final File $$0, final fdu.a $$1, final fcx $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fbp.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fbp.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fbp.this.g);
                  fbp.this.c = true;
               } else {
                  fbp.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fbp.this.d = true;
               }
            } catch (IOException var3) {
               fbp.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fbp.this.d = true;
            }
         }
      }
