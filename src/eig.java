...
public class eig extends egw<eju> {
   public static final int a = 10;
   private static final int b = 42;
   private static final LoadingCache<Long, List<eig.a>> c = CacheBuilder.newBuilder().expireAfterWrite(5L, TimeUnit.MINUTES).build(new eig.b());

   public eig(Codec<eju> $$0) {
      super($$0);
   }

   public static List<eig.a> a(dig $$0) {
      bam $$1 = bam.a($$0.D());
      long $$2 = $$1.g() & 65535L;
      return (List<eig.a>)c.getUnchecked($$2);
   }

   @Override
   public boolean a(egy<eju> $$0) {
      eju $$1 = $$0.f();
      dig $$2 = $$0.b();
      bam $$3 = $$0.d();
      jh $$4 = $$0.e();
   ...
   private void a(dhz $$0, bam $$1, eju $$2, eig.a $$3) {
      int $$4 = $$3.c();
            ...
            for (int $$11 = -2; $$11 <= 2; $$11++) {
               for (int $$12 = 0; $$12 <= 3; $$12++) {
                  ...
                  if ($$13 || $$14 || $$15) {
                     ...
                     dxv $$18 = dko.fk
                        .m()
                        .b(dop.a, Boolean.valueOf($$16 && $$11 != -2))
                        .b(dop.c, Boolean.valueOf($$16 && $$11 != 2))
                        .b(dop.d, Boolean.valueOf($$17 && $$10 != -2))
                        .b(dop.b, Boolean.valueOf($$17 && $$10 != 2));
      ...
      if ($$19 != null) {
         ...
         $$0.b($$19);
         jh $$20 = $$19.dw();
         this.a($$0, $$20.e(), dko.I.m());
         this.a($$0, $$20, dnn.a($$0, $$20));
      }
   }
   ...
   public static class a {
      ...
      public a(int $$0, int $$1, int $$2, int $$3, boolean $$4) {
         ...
         this.e = $$3;
         this.f = $$4;
         this.g = new fbt((double)($$0 - $$2), (double)ebq.e, (double)($$1 - $$2), (double)($$0 + $$2), (double)ebq.d, (double)($$1 + $$2));
      }
   ...
   static class b extends CacheLoader<Long, List<eig.a>> {
      public List<eig.a> a(Long $$0) {
         IntArrayList $$1 = ae.a(IntStream.range(0, 10), bam.a($$0));
         List<eig.a> $$2 = Lists.newArrayList();
