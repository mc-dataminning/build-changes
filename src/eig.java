...
public class eig extends eik {
   public static final MapCodec<eig> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, eig::new));

   public eig(int $$0, int $$1, int $$2) {
      super($$0, $$1, $$2);
   }
   ...
   public List<egs.a> a(ddy $$0, BiConsumer<je, dua> $$1, azk $$2, int $$3, je $$4, egc $$5) {
      ...
      if ($$13.isPresent()) {
         $$6.add(new egs.a(new je($$11, $$13.getAsInt(), $$12), 1, false));
      }
      ...
      if ($$16 != $$7) {
         ...
         if ($$13.isPresent()) {
            $$6.add(new egs.a(new je($$11, $$13.getAsInt(), $$12), 0, false));
         }
      }
