...
public abstract class eig {
   ...
   public ehi a() {
      if (this.c()) {
         ...
         return new ehi(this.b(hc.a.a), this.b(hc.a.b), this.b(hc.a.c), this.c(hc.a.a), this.c(hc.a.b), this.c(hc.a.c));
      }
   }

   public eig b() {
      return this.c() ? eid.a() : eid.a(this.b(hc.a.a), this.b(hc.a.b), this.b(hc.a.c), this.c(hc.a.a), this.c(hc.a.b), this.c(hc.a.c));
   }
   ...
   public eig a(double $$0, double $$1, double $$2) {
      return (eig)(this.c() ? eid.a() : new ehp(this.a, new eic(this.a(hc.a.a), $$0), new eic(this.a(hc.a.b), $$1), new eic(this.a(hc.a.c), $$2)));
   }
   ...
   protected int a(hc.a $$0, double $$1) {
      return arx.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }
      ...
      if (this.c()) {
         ...
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(hc.a.a, $$4.c - (double)$$2.u()), this.a(hc.a.b, $$4.d - (double)$$2.v()), this.a(hc.a.c, $$4.e - (double)$$2.w()))
               ? new ehj($$4, hc.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : ehi.a(this.e(), $$0, $$1, $$2);
         }
      }
   }
   ...
   public Optional<ehn> a(ehn $$0) {
      if (this.c()) {
         ...
         ehn[] $$1 = new ehn[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = arx.a($$0.a(), $$2, $$5);
            double $$9 = arx.a($$0.b(), $$3, $$6);
            double $$10 = arx.a($$0.c(), $$4, $$7);
   ...
   public double a(hc.a $$0, ehi $$1, double $$2) {
