...
public class eig implements eib {
   public static final Codec<eig> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               mb.e.q().fieldOf("block").flatXmap(eig::a, DataResult::success).orElse((doo)djn.fu).forGetter($$0x -> $$0x.b),
   ...
   public final jv<djl> h;
   private final ObjectArrayList<jn> i;

   private static DataResult<doo> a(djl $$0) {
      return $$0 instanceof doo $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface spreadeable block");
   }

   public eig(doo $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jv<djl> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
