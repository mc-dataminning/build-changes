...
public class eig {
   ...
   private final Map<String, eio> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public eig(@Nullable epr $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public us a(us $$0) {
      us $$1 = $$0.p("Level");
      dbg $$2 = new dbg($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dbg.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dbg.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable epr $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ...
            for (String $$3 : $$2.e()) {
               us $$4 = $$2.p($$3);
               long $$5 = dbg.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if (!$$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  us $$14 = $$2.p($$13);
                  $$12.a(dbg.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
   ...
   public static eig a(ale<dbz> $$0, @Nullable epr $$1) {
      if ($$0 == dbz.h) {
         return new eig(
            $$1,
         ...
         return new eig($$1, $$2, $$2);
      } else if ($$0 == dbz.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new eig($$1, $$3, $$3);
      } else {
