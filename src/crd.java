...
public class crd {
   public static <T> List<crd.b> a(List<T> $$0, Function<T, List<hk<dum>>> $$1, boolean $$2) {
      ...
      for (T $$8 : $$0) {
         ...
         List<hk<dum>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (hg<dum> $$12 : $$10.get($$11)) {
               dum $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && arn.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
