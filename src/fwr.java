...
public class fwr extends daz {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final dvj e = new dvj();
   private final dvp<brw> f = new dvp<>(brw.class, new fwr.b());
   private final fws D;
   private final gci E;
   private final fwr.a F;
   private final gbz G;
   private final bqh H;
   private final feb I = feb.Q();
   final List<gbj> J = Lists.newArrayList();
   private final Map<eoj, eol> K = Maps.newHashMap();
   private static final long L = 16777215L;
   private int M;
   private final Object2ObjectArrayMap<dak, fff> N = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gbw.a, new fff($$0xx -> this.b($$0xx, gbw.a)));
      $$0x.put(gbw.b, new fff($$0xx -> this.b($$0xx, gbw.b)));
      $$0x.put(gbw.c, new fff($$0xx -> this.b($$0xx, gbw.c)));
   });
   private final fwn O;
   private final Deque<Runnable> P = Queues.newArrayDeque();
   private int Q;
   private final fyd R = new fyd();
   private static final Set<ctl> S = Set.of(ctt.hB, ctt.hC);

   public void b(int $$0) {
      this.R.a($$0, this);
   }

   public void b(io $$0, drd $$1, int $$2) {
      if (!this.R.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(io $$0, drd $$1, eum $$2) {
      drd $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         cly $$4 = this.I.s;
   ...
   public fwr(fws $$0, fwr.a $$1, akm<daz> $$2, ix<duv> $$3, int $$4, int $$5, Supplier<bmk> $$6, gci $$7, boolean $$8, long $$9) {
      super($$1, $$2, $$0.w(), $$3, $$6, true, $$8, $$9, 1000000);
      this.D = $$0;
      this.O = new fwn(this, $$4);
      this.H = new bqh();
      this.F = $$1;
      this.E = $$7;
      this.G = gbz.a($$3.a());
      this.a(new io(8, 64, 8), 0.0F);
      this.Q = $$5;
      this.T();
      this.W();
   }
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.aa().a(dav.l).a(false, null);
      } else {
         this.aa().a(dav.l).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<brw> e() {
      return this.G().a();
   }
   ...
   @Override
   public void X() {
      this.D.l().a(wx.c("multiplayer.status.quitting"));
   }
   ...
   private dea p() {
      if (this.I.q.j() == daw.b) {
         ctq $$0 = this.I.s.eX();
         ctl $$1 = $$0.g();
         if (S.contains($$1) && $$1 instanceof cro $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, aym $$4, @Nullable dea $$5, io.a $$6) {
      ...
      if ($$5 == $$10.b()) {
         this.a(new kp(ky.c, $$10), (double)$$7 + 0.5, (double)$$8 + 0.5, (double)$$9 + 0.5, 0.0, 0.0, 0.0);
      }
   ...
   private void a(io $$0, drd $$1, kw $$2, boolean $$3) {
      if ($$1.u().c()) {
         evf $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(it.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(io $$0, kw $$1, evf $$2, double $$3) {
      this.a((double)$$0.u() + $$2.b(it.a.a), (double)$$0.u() + $$2.c(it.a.a), (double)$$0.w() + $$2.b(it.a.c), (double)$$0.w() + $$2.c(it.a.c), $$3, $$1);
   }

   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, kw $$5) {
      this.a($$5, ayf.d(this.z.j(), $$0, $$1), $$4, ayf.d(this.z.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }
   ...
   public void a(@Nullable cly $$0, brw $$1, ix<avh> $$2, avj $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.aj().a((grj)(new gra($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(brw $$0, avh $$1, avj $$2, float $$3, float $$4) {
      this.I.aj().a((grj)(new gra($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avh $$3, avj $$4, float $$5, float $$6, boolean $$7, long $$8) {
      double $$9 = this.I.j.m().b().c($$0, $$1, $$2);
      gre $$10 = new gre($$3, $$4, $$5, $$6, aym.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, List<cwj> $$6) {
      if ($$6.isEmpty()) {
         for (int $$7 = 0; $$7 < this.z.a(3) + 2; $$7++) {
            this.a(ky.ab, $$0, $$1, $$2, this.z.k() * 0.05, 0.005, this.z.k() * 0.05);
         }
      } else {
         this.I.g.a(new fzi.e(this, $$0, $$1, $$2, $$3, $$4, $$5, this.I.g, $$6));
      }
   }
   ...
   public ix<dby> a(int $$0, int $$1, int $$2) {
      return this.H_().d(lf.az).g(dcf.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (ayf.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = ayf.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public eum a(eum $$0, float $$1) {
      float $$2 = this.f($$1);
      eum $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      dca $$4 = this.F_();
      eum $$5 = axg.a($$3, ($$1x, $$2x, $$3x) -> eum.a($$4.a($$1x, $$2x, $$3x).a().a()));
      float $$6 = ayf.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$6 = ayf.a($$6, 0.0F, 1.0F);
      float $$7 = (float)$$5.c * $$6;
      float $$8 = (float)$$5.d * $$6;
      float $$9 = (float)$$5.e * $$6;
      ...
      return new eum((double)$$7, (double)$$8, (double)$$9);
   }

   public eum h(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = ayf.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$2 = ayf.a($$2, 0.0F, 1.0F);
      float $$3 = 1.0F;
      float $$4 = 1.0F;
      float $$5 = 1.0F;
      ...
      return new eum((double)$$3, (double)$$4, (double)$$5);
   }

   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (ayf.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = ayf.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(io $$0, dak $$1) {
      fff $$2 = (fff)this.N.get($$1);
      return $$2.a($$0);
   }

   public int b(io $$0, dak $$1) {
      int $$2 = feb.Q().m.E().c();
      if ($$2 == 0) {
         ...
         int $$5 = 0;
         int $$6 = 0;
         iq $$7 = new iq($$0.u() - $$2, $$0.v(), $$0.w() - $$2, $$0.u() + $$2, $$0.v(), $$0.w() + $$2);
         io.a $$8 = new io.a();
   ...
   protected Map<eoj, eol> l() {
      return ImmutableMap.copyOf(this.K);
   }

   protected void a(Map<eoj, eol> $$0) {
      this.K.putAll($$0);
   }
   ...
   public static class a implements epe {
      ...
      public a(bpt $$0, boolean $$1, boolean $$2) {
         this.i = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new dav();
   ...
   final class b implements dvl<brw> {
      public void a(brw $$0) {
      }
