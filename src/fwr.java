...
public class fwr extends dax {
   private static final Logger a = LogUtils.getLogger();
   private static final double b = 0.05;
   private static final int c = 10;
   private static final int d = 1000;
   final dvh e = new dvh();
   private final dvn<bru> f = new dvn<>(bru.class, new fwr.b());
   private final fws D;
   private final gci E;
   private final fwr.a F;
   private final gbz G;
   private final bqf H;
   private final fdz I = fdz.Q();
   final List<gbj> J = Lists.newArrayList();
   private final Map<eoh, eoj> K = Maps.newHashMap();
   private static final long L = 16777215L;
   private int M;
   private final Object2ObjectArrayMap<dai, ffe> N = ac.a(new Object2ObjectArrayMap(3), $$0x -> {
      $$0x.put(gbw.a, new ffe($$0xx -> this.b($$0xx, gbw.a)));
      $$0x.put(gbw.b, new ffe($$0xx -> this.b($$0xx, gbw.b)));
      $$0x.put(gbw.c, new ffe($$0xx -> this.b($$0xx, gbw.c)));
   });
   private final fwn O;
   private final Deque<Runnable> P = Queues.newArrayDeque();
   private int Q;
   private final fyd R = new fyd();
   private static final Set<ctj> S = Set.of(ctr.hB, ctr.hC);

   public void b(int $$0) {
      this.R.a($$0, this);
   }

   public void b(io $$0, drb $$1, int $$2) {
      if (!this.R.a($$0, $$1)) {
         super.a($$0, $$1, $$2, 512);
      }
   }

   public void a(io $$0, drb $$1, euk $$2) {
      drb $$3 = this.a_($$0);
      if ($$3 != $$1) {
         this.a($$0, $$1, 19);
         clw $$4 = this.I.s;
   ...
   public fwr(fws $$0, fwr.a $$1, akl<dax> $$2, ix<dut> $$3, int $$4, int $$5, Supplier<bmi> $$6, gci $$7, boolean $$8, long $$9) {
   ...
   public void c(long $$0) {
      if ($$0 < 0L) {
         $$0 = -$$0;
         this.aa().a(dat.l).a(false, null);
      } else {
         this.aa().a(dat.l).a(true, null);
      }

      this.F.b($$0);
   }

   public Iterable<bru> e() {
      return this.G().a();
   }
   ...
   private void a(bru $$0, bru $$1) {
      if ($$1.dK() || $$1.dc() != $$0) {
         $$1.ac();
      } else if ($$1 instanceof clw || this.e.c($$1)) {
         $$1.bu();
         $$1.ai++;
         $$1.t();
   ...
   private ddy p() {
      if (this.I.q.j() == dau.b) {
         cto $$0 = this.I.s.eX();
         ctj $$1 = $$0.g();
         if (S.contains($$1) && $$1 instanceof crm $$2) {
            return $$2.d();
         }
      }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, ayk $$4, @Nullable ddy $$5, io.a $$6) {
   ...
   private void a(io $$0, drb $$1, kw $$2, boolean $$3) {
      if ($$1.u().c()) {
         evd $$4 = $$1.k(this, $$0);
         double $$5 = $$4.c(it.a.b);
         if ($$5 < 1.0) {
   ...
   private void a(io $$0, kw $$1, evd $$2, double $$3) {
   ...
   private void a(double $$0, double $$1, double $$2, double $$3, double $$4, kw $$5) {
      this.a($$5, ayd.d(this.z.j(), $$0, $$1), $$4, ayd.d(this.z.j(), $$2, $$3), 0.0, 0.0, 0.0);
   }
   ...
   public void a(@Nullable clw $$0, bru $$1, ix<avg> $$2, avi $$3, float $$4, float $$5, long $$6) {
      if ($$0 == this.I.s) {
         this.I.ak().a((grj)(new gra($$2.a(), $$3, $$4, $$5, $$1, $$6)));
      }
   }

   @Override
   public void a(bru $$0, avg $$1, avi $$2, float $$3, float $$4) {
      this.I.ak().a((grj)(new gra($$1, $$2, $$3, $$4, $$0, this.z.g())));
   }
   ...
   private void a(double $$0, double $$1, double $$2, avg $$3, avi $$4, float $$5, float $$6, boolean $$7, long $$8) {
      ...
      gre $$10 = new gre($$3, $$4, $$5, $$6, ayk.a($$8), $$0, $$1, $$2);
      if ($$7 && $$9 > 100.0) {
   ...
   public ix<dbw> a(int $$0, int $$1, int $$2) {
      return this.H_().d(lf.az).g(dcd.b);
   }

   public float g(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (ayd.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.2F);
      $$2 = ayd.a($$2, 0.0F, 1.0F);
      $$2 = 1.0F - $$2;
   ...
   public euk a(euk $$0, float $$1) {
      float $$2 = this.f($$1);
      euk $$3 = $$0.a(2.0, 2.0, 2.0).a(0.25);
      dby $$4 = this.F_();
      euk $$5 = axf.a($$3, ($$1x, $$2x, $$3x) -> euk.a($$4.a($$1x, $$2x, $$3x).a().a()));
      float $$6 = ayd.b($$2 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$6 = ayd.a($$6, 0.0F, 1.0F);
      float $$7 = (float)$$5.c * $$6;
      float $$8 = (float)$$5.d * $$6;
      float $$9 = (float)$$5.e * $$6;
      ...
      return new euk((double)$$7, (double)$$8, (double)$$9);
   }

   public euk h(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = ayd.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.5F;
      $$2 = ayd.a($$2, 0.0F, 1.0F);
      float $$3 = 1.0F;
      float $$4 = 1.0F;
      float $$5 = 1.0F;
      ...
      return new euk((double)$$3, (double)$$4, (double)$$5);
   }

   public float i(float $$0) {
      float $$1 = this.f($$0);
      float $$2 = 1.0F - (ayd.b($$1 * (float) (Math.PI * 2)) * 2.0F + 0.25F);
      $$2 = ayd.a($$2, 0.0F, 1.0F);
      return $$2 * $$2 * 0.5F;
   }
   ...
   public int a(io $$0, dai $$1) {
      ffe $$2 = (ffe)this.N.get($$1);
      return $$2.a($$0);
   }

   public int b(io $$0, dai $$1) {
      int $$2 = fdz.Q().m.E().c();
      if ($$2 == 0) {
   ...
   protected Map<eoh, eoj> l() {
      return ImmutableMap.copyOf(this.K);
   }

   protected void a(Map<eoh, eoj> $$0) {
      this.K.putAll($$0);
   }
   ...
   public static class a implements epc {
      ...
      public a(bpr $$0, boolean $$1, boolean $$2) {
         this.i = $$0;
         this.a = $$1;
         this.c = $$2;
         this.b = new dat();
   ...
   final class b implements dvj<bru> {
      public void a(bru $$0) {
      }
