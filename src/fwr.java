...
public class fwr<T extends cgi> extends ftr<T> {
   ...
   public static fxi a(fxe $$0) {
      ...
      fxj $$2 = $$1.a();
      float $$3 = 13.5F;
      fxj $$4 = $$2.a("head", fxf.c(), fxc.a(-1.0F, 13.5F, -7.0F));
      $$4.a(
         "real_head",
         fxf.c()
            .a(0, 0)
      ...
      $$2.a("body", fxf.c().a(18, 14).a(-3.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F, $$0), fxc.a(0.0F, 14.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("upper_body", fxf.c().a(21, 0).a(-3.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F, $$0), fxc.a(-1.0F, 14.0F, -3.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      fxf $$5 = fxf.c().a(0, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0);
      $$2.a("right_hind_leg", $$5, fxc.a(-2.5F, 16.0F, 7.0F));
      $$2.a("left_hind_leg", $$5, fxc.a(0.5F, 16.0F, 7.0F));
      $$2.a("right_front_leg", $$5, fxc.a(-2.5F, 16.0F, -4.0F));
      $$2.a("left_front_leg", $$5, fxc.a(0.5F, 16.0F, -4.0F));
      fxj $$6 = $$2.a("tail", fxf.c(), fxc.a(-1.0F, 12.0F, 8.0F, (float) (Math.PI / 5), 0.0F, 0.0F));
      $$6.a("real_tail", fxf.c().a(9, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0), fxc.a);
      return $$1;
   }
