...
public class fwr {
   ...
   public final Map<ie, fws> c;
   public final fwt d;
   public final boolean e;

   public fwr(Vector3f $$0, Vector3f $$1, Map<ie, fws> $$2, @Nullable fwt $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ie, fws> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<fwr> {
      ...
      public fwr a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         Vector3f $$5 = this.d($$3);
         fwt $$6 = this.a($$3);
         Map<ie, fws> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !avy.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = avy.a($$3, "shade", true);
            return new fwr($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private fwt a(JsonObject $$0) {
         fwt $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = avy.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ie.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = avy.a($$2, "rescale", false);
            $$1 = new fwt($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = avy.m($$0, "angle");
         if ($$1 != 0.0F && awi.e($$1) != 22.5F && awi.e($$1) != 45.0F) {
      ...
      private Map<ie, fws> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ie, fws> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ie, fws> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ie, fws> $$2 = Maps.newEnumMap(ie.class);
         JsonObject $$3 = avy.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ie $$5 = this.a($$4.getKey());
            $$2.put($$5, (fws)$$0.deserialize($$4.getValue(), fws.class));
         }
