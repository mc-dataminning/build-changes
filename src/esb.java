...
public class esb implements AutoCloseable {
   private static final aez a = new aez("textures/map/map_icons.png");
   static final foi b = foi.s(a);
   private static final int c = 128;
   private static final int d = 128;
   final fzb e;
   private final Int2ObjectMap<esb.a> f = new Int2ObjectOpenHashMap();
   ...
   public void a(elj $$0, foa $$1, int $$2, ebq $$3, boolean $$4, int $$5) {
      this.b($$2, $$3).a($$0, $$1, $$4, $$5);
   }

   private esb.a b(int $$0, ebq $$1) {
      return (esb.a)this.f.compute($$0, ($$1x, $$2) -> {
         if ($$2 == null) {
            return new esb.a($$1x, $$1);
         } else {
            $$2.a($$1);
            return $$2;
         }
   ...
   class a implements AutoCloseable {
      ...
      a(int $$0, ebq $$1) {
         this.b = $$1;
         this.c = new fyn(128, 128, true);
         aez $$2 = esb.this.e.a("map/" + $$0, this.c);
         this.d = foi.s($$2);
      }
      ...
      private void b() {
         for (int $$0 = 0; $$0 < 128; $$0++) {
            for (int $$1 = 0; $$1 < 128; $$1++) {
               int $$2 = $$1 + $$0 * 128;
               this.c.e().a($$1, $$0, eak.b(this.b.g[$$2]));
            }
         }
      ...
      void a(elj $$0, foa $$1, boolean $$2, int $$3) {
         if (this.e) {
            this.b();
            this.e = false;
         }
         ...
         for (ebn $$10 : this.b.g()) {
            if (!$$2 || $$10.b()) {
               ...
               if ($$10.g() != null) {
                  ...
                  float $$22 = asb.a(25.0F / $$21, 0.0F, 6.0F / 9.0F);
                  $$0.a();
                  $$0.a(0.0F + (float)$$10.d() / 2.0F + 64.0F - $$21 * $$22 / 2.0F, 0.0F + (float)$$10.e() / 2.0F + 64.0F + 4.0F, -0.025F);
                  $$0.b($$22, $$22, 1.0F);
                  $$0.a(0.0F, 0.0F, -0.1F);
                  $$19.a($$20, 0.0F, 0.0F, -1, false, $$0.c().a(), $$1, erx.a.a, Integer.MIN_VALUE, $$3);
                  $$0.b();
               }
