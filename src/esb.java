...
public class esb {
   ...
   private final esb.a g;

   @Deprecated
   public static esb a(azh $$0, esb.a $$1) {
      return new esb($$0, $$1, false);
   }

   public static esb a(azh $$0, int $$1, double... $$2) {
      return b($$0, new esb.a($$1, new DoubleArrayList($$2)));
   }

   public static esb b(azh $$0, esb.a $$1) {
      return new esb($$0, $$1, true);
   }

   private esb(azh $$0, esb.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<esb.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(esb.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(esb.a::b))
               .apply($$0, esb.a::new)
      );
      public static final Codec<jr<esb.a>> b = akr.a(mc.aS, a);
