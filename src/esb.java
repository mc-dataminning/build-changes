public abstract class esb extends esf implements eti, eua {
   private static final ets a = new ets(new aer("widget/text_field"), new aer("widget/text_field_highlighted"));
   private static final aer b = new aer("widget/scroller");
   private static final int c = 4;
   private static final int d = 8;
   private double e;
   private boolean l;

   public esb(int $$0, int $$1, int $$2, int $$3, tf $$4) {
      super($$0, $$1, $$2, $$3, $$4);
   }
   ...
   private int v() {
      return arp.a((int)((float)(this.g * this.g) / (float)this.w()), 32, this.g);
   }
   ...
   protected void a(double $$0) {
      this.e = arp.a($$0, 0.0, (double)this.d());
   }
   ...
   protected void a(erw $$0, int $$1, int $$2, int $$3, int $$4) {
      aer $$5 = a.a(this.az_(), this.ax_());
      $$0.a($$5, $$1, $$2, $$3, $$4);
   }
   ...
   protected abstract void c(erw var1, int var2, int var3, float var4);
}
