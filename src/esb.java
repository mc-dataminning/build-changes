...
public abstract class esb<E extends esb.a<E>> extends ety implements eti, evw {
   protected static final int b = 6;
   private static final aer a = new aer("widget/scroller");
   protected final eql c;
   protected final int d;
   private final List<E> m = new esb.b();
   protected int e;
   protected int f;
   protected int g;
   protected int h;
   ...
   public esb(eql $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.c = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(erv $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.s) {
         ...
         int $$4 = 32;
         $$0.a(eya.d, this.j, this.g, (float)this.i, (float)(this.h + (int)this.l()), this.i - this.j, this.h - this.g, 32, 32);
         $$0.a(1.0F, 1.0F, 1.0F, 1.0F);
         int $$5 = 4;
         $$0.a(foc.D(), this.j, this.g, this.i, this.g + 4, -16777216, 0, 0);
         $$0.a(foc.D(), this.j, this.h - 4, this.i, this.h, 0, -16777216, 0);
      }
   ...
   @Nullable
   protected E a(ewg $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.f());
   }

   @Nullable
   protected E a(ewg $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(erv $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public evw.a q() {
      if (this.aw_()) {
         ...
         return this.t != null ? evw.a.b : evw.a.a;
      }
   }
   ...
   protected void a(evy $$0, E $$1) {
      List<E> $$2 = this.i();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(evx.b, tf.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }
   ...
   @Override
   public ewi s() {
      return new ewi(this.j, this.g, this.i - this.j, this.h - this.g);
   }

   protected abstract static class a<E extends esb.a<E>> implements eua {
      @Deprecated
      esb<E> a;
      ...
      public abstract void a(erv var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
