...
public class esb implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<esb.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public esb(List<esb.a> $$0) {
      this.c = $$0;
   }
   ...
   public static esb a(BufferedReader $$0) {
      return new esb($$0.lines().flatMap($$0x -> esb.a.a($$0x).stream()).toList());
   }

   public static record a(esb.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<esb.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new esb.a(esb.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new esb.a(esb.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new esb.a(esb.b.b, $$3));
      ...
      static esb.a b(String $$0) {
         return new esb.a(esb.b.a, "glob:" + $$0);
      }

      static esb.a c(String $$0) {
         return new esb.a(esb.b.a, "regex:" + $$0);
      }

      static esb.a d(String $$0) {
         return new esb.a(esb.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      esb.b a = FileSystem::getPathMatcher;
      esb.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
