...
public class blz<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public blz(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> blz<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bma<T> a() throws IOException {
      if (this.d.get() <= 0) {
         throw new IOException("Event log has already been closed");
      } else {
         this.d.incrementAndGet();
         final bma<T> $$0 = bma.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bma<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  blz.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = blz.this.c.position();
               }
