...
public interface blz {
   static blt<StringReader> a(String $$0) {
      return new blz.b($$0);
   }

   static blt<StringReader> a(char $$0) {
      return new blz.a($$0);
   }

   public static record a(char a) implements blt<StringReader> {
      @Override
      public boolean a(blp<StringReader> $$0, blr $$1, bll $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
   ...
   public static record b(String a) implements blt<StringReader> {
      @Override
      public boolean a(blp<StringReader> $$0, blr $$1, bll $$2) {
         $$0.b().skipWhitespace();
         int $$3 = $$0.c();
