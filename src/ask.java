...
public class ask {
   ...
   private static List<ask.b> a(final Path $$0) throws IOException {
      try {
         final List<ask.b> $$1 = new ArrayList<>();
   ...
   private static List<ask.a> a(List<ask.b> $$0) {
      List<ask.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (ask.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new ask.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<ask.a> a = Comparator.comparing(ask.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<ask.b> a = Comparator.comparing(ask.b::b).reversed();
