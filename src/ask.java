...
public class ask implements asg {
   ...
   private final Map<asi, List<Path>> h;

   ask(asf $$0, ary $$1, Set<String> $$2, List<Path> $$3, Map<asi, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(asi $$0, akk $$1, Consumer<Path> $$2) {
      v.c($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(asi $$0, String $$1, String $$2, asg.a $$3) {
      v.c($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<akk, atm<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(asg.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      asj.a($$1, $$4, $$3, $$0);
   }
   ...
   public atm<InputStream> a(asi $$0, akk $$1) {
      return (atm<InputStream>)v.c($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && asj.a($$5)) {
               return atm.create($$5);
            }
         }
   ...
   public <T> T a(ast<T> $$0) {
      atm<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public atx d() {
      return $$0 -> Optional.ofNullable(this.a(asi.a, $$0)).map($$0x -> new ats(this, $$0x));
   }
}
