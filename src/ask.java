...
public abstract class ask implements AutoCloseable {
   ...
   protected ask(URL $$0, ask.b $$1, ask.a $$2, ExecutorService $$3) {
      this.f = $$2;
      this.g = $$3;
      this.d = $$0;
      this.e = $$1;
   ...
   protected CompletableFuture<arv> a(GameProfile $$0, String $$1, ask.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(arv.a) : CompletableFuture.supplyAsync(() -> {
   ...
   protected abstract arv a(String var1, ask.a var2, JsonObject var3);

   protected ws a(String $$0, JsonArray $$1, ask.a $$2) {
      if ($$1.isEmpty()) {
         return ws.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return ws.b;
      } else {
         ws $$3 = new ws($$0.length());
   ...
   protected HttpURLConnection a(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new ask.d($$5 + " " + $$2.getResponseMessage());
      }
   }
   ...
   protected class c implements asl {
      ...
      public CompletableFuture<List<arv>> a(List<String> $$0) {
         List<CompletableFuture<arv>> $$1 = $$0.stream().map($$0x -> ask.this.a(this.b, $$0x, ask.this.f, this.c)).collect(ImmutableList.toImmutableList());
         return af.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<arv> a(String $$0) {
         return ask.this.a(this.b, $$0, ask.this.f, this.c);
      }
   }
