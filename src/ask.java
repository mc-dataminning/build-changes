...
public class ask implements AutoCloseable {
   ...
   private ask(URL $$0, ask.c $$1, URL $$2, ask.b $$3, URL $$4, ask.b $$5, String $$6, ask.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
      ...
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            ...
            if ($$3.isEmpty()) {
               ...
               return new ask($$12, $$16, $$13, $$15, $$14, $$15, $$20, $$19, $$8);
            }
   ...
   void a(GameProfile $$0, URL $$1, ask.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<arw> a(GameProfile $$0, String $$1, ask.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(arw.a) : CompletableFuture.supplyAsync(() -> {
   ...
   private xs a(String $$0, JsonArray $$1, ask.a $$2) {
      if ($$1.isEmpty()) {
         return xs.c;
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new ask.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public asj a(GameProfile $$0) {
      return new ask.d($$0);
   }
   ...
   public interface a {
      ask.a a = ($$0, $$1) -> false;
      ask.a b = ($$0, $$1) -> $$0.length() == $$1;

      static ask.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static ask.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements asj {
      ...
      @Override
      public void a() {
         ask.this.a(this.c, ask.this.g, ask.this.h, this.d);
      }

      @Override
      public void b() {
         ask.this.a(this.c, ask.this.i, ask.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<arw>> a(List<String> $$0) {
         List<CompletableFuture<arw>> $$1 = $$0.stream().map($$0x -> ask.this.a(this.c, $$0x, ask.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<arw> a(String $$0) {
         return ask.this.a(this.c, $$0, ask.this.l, this.d);
      }
   }
