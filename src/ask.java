...
public class ask {
   ...
   public void a(arn $$0, deb $$1) {
      if (!this.f.remove($$1.a()) && $$0.bM()) {
         $$0.d.b(new adj($$1));
      }
   }
   ...
   private static void a(asp $$0, arm $$1, dxj $$2) {
      $$0.b(new adp($$2, $$1.z_(), null, null));
      deb $$3 = $$2.f();
      agr.a($$1, $$3);
   }

   private List<dxj> a(aqs $$0, deb $$1) {
      int $$2 = azj.d(this.i);
      List<dxj> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : azj.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
