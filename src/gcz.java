...
public class gcz extends MinecraftServer {
   ...
   public gcz(Thread $$0, eqp $$1, eca.c $$2, anh $$3, afu $$4, afr $$5, ald $$6) {
      super($$0, $$2, $$3, $$4, $$1.X(), $$1.ar(), $$5, $$6);
      this.b($$1.W());
      this.c($$1.I());
      this.a(new gcy(this, this.aV(), this.i));
      this.p = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (aku $$1 : Lists.newArrayList(this.ac().t())) {
   ...
   @Override
   public cpy aW() {
      return this.p() ? (cpy)MoreObjects.firstNonNull(this.s, this.m.m()) : null;
   }
}
