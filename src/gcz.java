public class gcz extends gdu {
   private final gdp a;

   gcz(fzn $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gdp $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cly $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dB();
            if (this.h > $$1) {
               this.h = this.h + ($$1 - this.h) * 0.2;
               this.k = this.k + ($$0.dx().d - this.k) * 0.2;
   ...
   public static class b implements gcx<le> {
      ...
      public gcu a(le $$0, fzn $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gcu $$8 = new gcz($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
