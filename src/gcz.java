...
public class gcz extends fxu {
   ...
   private final fvq s = new fvq(this);
   private final fxu u;
   private final aun v;
   ...
   public gcz(fxu $$0, aun $$1, Consumer<aun> $$2) {
      super(a);
      this.u = $$0;
      this.v = $$1;
      this.w = $$2;
   ...
   protected void aN_() {
      this.s.a(a, this.p);
      fvu $$0 = this.s.c(fvu.d());
      $$0.a(new fsw(b, this.p).d(310), $$0x -> $$0x.e(15));
      gde.a $$1 = gde.a(299).a(2, true).b(4);
      this.x.forEach(($$1x, $$2x) -> $$1.a(a($$1x), () -> this.x.getBoolean($$1x), $$1xx -> this.x.put($$1x, $$1xx)).a($$1x.c()));
      fvr $$2 = $$1.a().a();
      this.y = new gcz.a($$2, 310, 130);
      $$0.a(this.y);
      fvu $$3 = this.s.b(fvu.e().a(8));
      $$3.a(fsc.a(wx.d, $$0x -> this.m()).a());
      $$3.a(fsc.a(wx.e, $$0x -> this.aK_()).a());
      this.s.a($$1x -> {
   ...
   public class a extends frt {
      private final List<fsa> a = new ArrayList<>();
      private final fvr c;

      public a(final fvr $$1, final int $$2, final int $$3) {
         super(0, 0, $$2, $$3, wx.a);
         this.c = $$1;
         $$1.a(this::a);
      }
      ...
      @Override
      public fwj b(fwh $$0) {
         return new fwj(this.F(), this.G(), this.g, this.n());
      }
      ...
      @Override
      public Collection<? extends fvx> L() {
         return this.a;
      }
   }
}
