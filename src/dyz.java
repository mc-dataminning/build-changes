...
public class dyz extends dye<eaq> {
   ...
   public boolean a(dyg<eaq> $$0) {
      ...
      int $$7 = axm.f(((float)$$4.c / 16.0F * 2.0F + 1.0F) / 2.0F);
      ...
      int $$15 = $$2.u() - axm.f($$6) - $$7;
      int $$16 = $$2.v() - 2 - $$7;
      int $$17 = $$2.w() - axm.f($$6) - $$7;
      int $$18 = 2 * (axm.f($$6) + $$7);
      int $$19 = 2 * (2 + $$7);

      for (int $$20 = $$15; $$20 <= $$15 + $$18; $$20++) {
         for (int $$21 = $$17; $$21 <= $$17 + $$18; $$21++) {
            if ($$16 <= $$3.a(dva.a.c, $$20, $$21)) {
   ...
   protected boolean a(
      dab $$0, axt $$1, eaq $$2, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int $$9, int $$10, int $$11, int $$12, int $$13
   ) {
      int $$14 = 0;
      ...
      for (int $$19 = 0; $$19 < $$17; $$19++) {
         ...
         double $$21 = axm.d((double)$$20, $$3, $$4);
         double $$22 = axm.d((double)$$20, $$7, $$8);
         double $$23 = axm.d((double)$$20, $$5, $$6);
         double $$24 = $$1.j() * (double)$$17 / 16.0;
         double $$25 = ((double)(axm.a((float) Math.PI * $$20) + 1.0F) * $$24 + 1.0) / 2.0;
         $$18[$$19 * 4 + 0] = $$21;
         $$18[$$19 * 4 + 1] = $$22;
         $$18[$$19 * 4 + 2] = $$23;
         $$18[$$19 * 4 + 3] = $$25;
      ...
      try (drc $$32 = new drc($$0)) {
         for (int $$33 = 0; $$33 < $$17; $$33++) {
            ...
            if (!($$34 < 0.0)) {
               ...
               double $$36 = $$18[$$33 * 4 + 1];
               double $$37 = $$18[$$33 * 4 + 2];
               int $$38 = Math.max(axm.a($$35 - $$34), $$9);
               int $$39 = Math.max(axm.a($$36 - $$34), $$10);
               int $$40 = Math.max(axm.a($$37 - $$34), $$11);
               int $$41 = Math.max(axm.a($$35 + $$34), $$38);
               int $$42 = Math.max(axm.a($$36 + $$34), $$39);
               int $$43 = Math.max(axm.a($$37 + $$34), $$40);
   ...
   public static boolean a(dpi $$0, Function<id, dpi> $$1, axt $$2, eaq $$3, eaq.a $$4, id.a $$5) {
      if (!$$4.b.a($$0, $$2)) {
         return false;
      } else {
   ...
   protected static boolean a(axt $$0, float $$1) {
      if ($$1 <= 0.0F) {
         return true;
      } else {
