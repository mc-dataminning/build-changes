...
public class dyz {
   ...
   private final dcc p;
   private static final List<dfb> q = List.of(dfd.l, dfd.L, dfd.i, dfd.b, dfd.k, dfd.I, dfd.K, dfd.fl, dfd.dP, dfd.iA, dfd.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<ji<dcz>>> t;
   ...
   public static final Codec<dyz> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dyz::a, Function.identity());

   private static DataResult<dyz> a(dyz $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dyz(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<ji<dcz>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = kb.c($$0);
      int $$5 = kb.c($$1) - $$4;
   ...
   @Nullable
   public static dyz a(arm $$0, int $$1, int $$2) {
      dua $$3 = $$0.a($$1, $$2);
      dyz $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(duz.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jf> a(dcv $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dua $$1, int $$2, int $$3) {
   ...
   private int a(dua $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dxw.a.a)) {
         $$3 = Math.min($$0.a(dxw.a.a, $$1, $$2) + 1, this.p.am());
      } else {
         $$3 = this.p.am();
      }
   ...
   private static double a(dua $$0, iz.a $$1) {
      return a($$0, (iz)$$1.c(je.a)) ? 1.0 : -1.0;
   }

   private static double b(dua $$0, iz.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dua $$0, int $$1, int $$2, int $$3) {
   ...
   private List<ji<dcz>> b(dua $$0, int $$1, int $$2) {
      ObjectArrayList<ji<dcz>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());
   ...
   private static boolean a(dua $$0, iz $$1) {
      dse $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(awp.O)) {
         ...
         return $$2.a(dfd.eT) || $$2.a(dfd.eU) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, dyz.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dyz.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, ji<dcz> var3);
   }
