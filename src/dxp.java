...
public class dxp extends dxr {
   ...
   private static void a(djm $$0, iv $$1, eat $$2, dxp $$3, dxp.a $$4) {
      if ($$3.b) {
         $$3.a++;
      }
   ...
   public static void a(djm $$0, iv $$1, eat $$2, dxp $$3) {
      a($$0, $$1, $$2, $$3, dxp::b);
   }

   public static void b(djm $$0, iv $$1, eat $$2, dxp $$3) {
      a($$0, $$1, $$2, $$3, dxp::a);
   }
   ...
   private static void a(djm $$0, iv $$1, List<bxj> $$2) {
      $$2.stream().filter($$1x -> a($$1, $$1x)).forEach(dxp::a);
   }

   private static void b(djm $$0, iv $$1, List<bxj> $$2) {
   ...
   @FunctionalInterface
   interface a {
      void run(djm var1, iv var2, List<bxj> var3);
   }
}
