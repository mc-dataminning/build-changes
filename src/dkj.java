...
public class dkj extends dhg {
   public static final Codec<dkj> c = RecordCodecBuilder.create($$0 -> $$0.group(aev.d(cra.b)).apply($$0, $$0.stable(dkj::new)));
   private static final int h = 2;
   private static final List<dfj> i = StreamSupport.stream(jd.f.spliterator(), false).flatMap($$0 -> $$0.l().a().stream()).collect(Collectors.toList());
   private static final int j = arx.f(arx.c((float)i.size()));
   private static final int k = arx.f((float)i.size() / (float)j);
   protected static final dfj d = csw.a.n();
   protected static final dfj e = csw.hW.n();
   public static final int f = 70;
   public static final int g = 60;

   public dkj(hg.c<cqt> $$0) {
      super(new cre($$0));
   }
