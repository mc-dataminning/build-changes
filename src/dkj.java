...
public class dkj extends eym {
   private static final int c = 4;
   private static final Logger d = LogUtils.getLogger();
   private static final Codec<Pair<dir, arw>> e = Codec.mapPair(dir.a.fieldOf("chunk_pos"), arw.a).codec();
   public static final Codec<dkj> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(e.listOf().optionalFieldOf("tickets", List.of()).forGetter(dkj::h)).apply($$0, dkj::a)
   );
   public static final eyn<dkj> b = new eyn<>("chunks", dkj::new, a, bbb.i);
   ...
   private dkj(Long2ObjectOpenHashMap<List<arw>> $$0, Long2ObjectOpenHashMap<List<arw>> $$1) {
      this.f = $$0;
      this.g = $$1;
      this.i();
   }
   ...
   private static dkj a(List<Pair<dir, arw>> $$0) {
      Long2ObjectOpenHashMap<List<arw>> $$1 = new Long2ObjectOpenHashMap();

      for (Pair<dir, arw> $$2 : $$0) {
         dir $$3 = (dir)$$2.getFirst();
         List<arw> $$4 = (List<arw>)$$1.computeIfAbsent($$3.a(), $$0x -> new ObjectArrayList(4));
         $$4.add((arw)$$2.getSecond());
      }

      return new dkj(new Long2ObjectOpenHashMap(4), $$1);
   }

   private List<Pair<dir, arw>> h() {
      List<Pair<dir, arw>> $$0 = new ArrayList<>();
      this.a((BiConsumer<dir, arw>)(($$1, $$2) -> {
         if ($$2.a().e()) {
            $$0.add(new Pair($$1, $$2));
         }
      }));
   ...
   private void a(BiConsumer<dir, arw> $$0) {
      a($$0, this.f);
      a($$0, this.g);
   }

   private static void a(BiConsumer<dir, arw> $$0, Long2ObjectOpenHashMap<List<arw>> $$1) {
      ObjectIterator var2 = Long2ObjectMaps.fastIterable($$1).iterator();

      while (var2.hasNext()) {
         Entry<List<arw>> $$2 = (Entry<List<arw>>)var2.next();
         dir $$3 = new dir($$2.getLongKey());
   ...
   public void a(@Nullable dkj.a $$0) {
      this.i = $$0;
   }

   public void b(@Nullable dkj.a $$0) {
      this.j = $$0;
   }
