...
public class bhf implements bgy {
   ...
   public static Set<bgw> a() {
      Builder<bgw> $$0 = ImmutableSet.builder();

      try {
         bhf.a $$1 = new bhf.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bgw.a("cpu#" + $$1x, bgv.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bgw.a("heap MiB", bgv.e, () -> (double)((float)(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / 1048576.0F)));
      $$0.addAll(bgx.a.a());
      return $$0.build();
   }
   ...
   public static bgw a(final LongSupplier $$0) {
      ...
      bgw.d $$3 = new bgw.d(2.0F);
      return bgw.a("ticktime", bgv.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
