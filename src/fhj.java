...
public abstract class fhj<T extends fhj<T>> {
   ...
   public fhj(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fhh.a();
         if ($$3 != null) {
         ...
         throw new fjb(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fjb(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fjb(var2.getMessage(), var2);
      }
   }
   ...
   public static fhj<?> a(String $$0) {
      return new fhj.b($$0, 5000, 60000);
   }

   public static fhj<?> a(String $$0, int $$1, int $$2) {
      return new fhj.b($$0, $$1, $$2);
   }

   public static fhj<?> b(String $$0, String $$1) {
      return new fhj.c($$0, $$1, 5000, 60000);
   }

   public static fhj<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fhj.c($$0, $$1, $$2, $$3);
   }

   public static fhj<?> b(String $$0) {
      return new fhj.a($$0, 5000, 60000);
   }

   public static fhj<?> c(String $$0, String $$1) {
      return new fhj.d($$0, $$1, 5000, 60000);
   }

   public static fhj<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fhj.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fhj<fhj.a> {
   ...
   public static class b extends fhj<fhj.b> {
   ...
   public static class c extends fhj<fhj.c> {
      ...
      public fhj.c f() {
         try {
            ...
            throw new fjb(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fhj<fhj.d> {
      private final String c;
