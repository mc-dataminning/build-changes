...
public class fhj extends fhg {
   private final List<fhj.a> c = new ArrayList<>();
   private int d;
   private int e;
   private final fho f = fho.i().a(0.5F, 0.5F);

   public fhj() {
      this(0, 0, 0, 0);
   }

   public fhj(int $$0, int $$1) {
      this(0, 0, $$0, $$1);
   }

   public fhj(int $$0, int $$1, int $$2, int $$3) {
      super($$0, $$1, $$2, $$3);
      this.a($$2, $$3);
   }
   ...
   public static void a(fhn $$0, int $$1, int $$2, int $$3, int $$4) {
      a($$0, $$1, $$2, $$3, $$4, 0.5F, 0.5F);
   }

   public static void a(fhn $$0, fie $$1) {
      a($$0, $$1.f().a(), $$1.f().b(), $$1.g(), $$1.h());
   }

   public static void a(fhn $$0, fie $$1, float $$2, float $$3) {
      a($$0, $$1.d(), $$1.b(), $$1.g(), $$1.h(), $$2, $$3);
   }

   public static void a(fhn $$0, int $$1, int $$2, int $$3, int $$4, float $$5, float $$6) {
      a($$1, $$3, $$0.x(), $$0::m, $$5);
      a($$2, $$4, $$0.v(), $$0::n, $$6);
   }

   public static void a(int $$0, int $$1, int $$2, Consumer<Integer> $$3, float $$4) {
      int $$5 = (int)axm.i($$4, 0.0F, (float)($$1 - $$2));
      $$3.accept($$0 + $$5);
   }
