...
public interface fhj {
   ...
   public static record b(int e, @Nullable xv f) implements fhj {
      public static final fhj.b c = new fhj.b(429, xv.c("mco.errorMessage.serviceBusy"));
      public static final xv d = xv.c("mco.errorMessage.retry");

      public static fhj.b a(String $$0) {
         return new fhj.b(500, xv.a("mco.errorMessage.realmsService.unknownCompatibility", $$0));
      }

      public static fhj.b a(fjc $$0) {
         return new fhj.b(500, xv.a("mco.errorMessage.realmsService.connectivity", $$0.getMessage()));
      }
