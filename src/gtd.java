...
public class gtd extends MinecraftServer {
   ...
   public gtd(Thread $$0, ffe $$1, epv.c $$2, atz $$3, amb $$4, aly $$5, aro $$6) {
      super($$0, $$2, $$3, $$4, $$1.Z(), $$1.as(), $$5, $$6);
      this.b($$1.Y());
      this.c($$1.K());
      this.a(new gtc(this, this.bd(), this.g));
      this.m = $$1;
   }
   ...
   public void a(boolean $$0) {
      this.h(() -> {
         for (arf $$1 : Lists.newArrayList(this.ah().t())) {
   ...
   @Override
   public dbu bf() {
      return this.r() ? (dbu)MoreObjects.firstNonNull(this.p, this.j.k()) : null;
   }
