...
public class gtd extends gsc<bvf, gzi> {
   public gtd(gsd.a $$0) {
      super($$0);
   }

   public void a(gzi $$0, fft $$1, glx $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bvf $$0, gzi $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bvf $$0) {
      return false;
   }
}
