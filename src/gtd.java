...
public record gtd(Vector3fc b, Vector3fc c, Vector3fc d) {
   ...
   protected static class a implements JsonDeserializer<gtd> {
      ...
      public gtd a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.a($$3, "rotation", c);
         Vector3f $$5 = this.a($$3, "translation", d);
         $$5.mul(0.0625F);
         $$5.set(azz.a($$5.x, -5.0F, 5.0F), azz.a($$5.y, -5.0F, 5.0F), azz.a($$5.z, -5.0F, 5.0F));
         Vector3f $$6 = this.a($$3, "scale", e);
         $$6.set(azz.a($$6.x, -4.0F, 4.0F), azz.a($$6.y, -4.0F, 4.0F), azz.a($$6.z, -4.0F, 4.0F));
         return new gtd($$4, $$5, $$6);
      }
