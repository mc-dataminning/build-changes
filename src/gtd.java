...
public abstract class gtd<T extends bvg, S extends gzi, M extends gca<? super S>> extends gsb<T, S> implements gtz<S, M> {
   private static final float a = 0.1F;
   protected M h;
   protected final hbj i;
   protected final List<gwr<S, M>> j = Lists.newArrayList();

   public gtd(gsc.a $$0, M $$1, float $$2) {
      super($$0);
      this.i = $$0.b();
      this.h = $$1;
      this.f = $$2;
   ...
   protected final boolean a(gwr<S, M> $$0) {
      return this.j.add($$0);
   }
   ...
   public static int a(gzi $$0, float $$1) {
      return hea.a(hea.a($$1), hea.a($$0.am));
   }
   ...
   protected void a(S $$0, ffu $$1, float $$2, float $$3) {
      if (this.a($$0)) {
      ...
      if ($$0.ac > 0.0F) {
         ...
         $$1.a(a.f.rotationDegrees($$4 * this.aU_()));
      } else if ($$0.al) {
         ...
         $$1.a(a.f.rotationDegrees(this.aU_()));
   ...
   public void a(T $$0, S $$1, float $$2) {
      ...
      label48: {
         ...
         $$1.am = $$0.aN > 0 || $$0.aP > 0;
         cwp $$5 = $$0.a(bus.f);
         if ($$5.h() instanceof cuv $$6 && $$6.d() instanceof dii $$7) {
            $$1.au = $$7.b();
            $$1.av = $$5.a(kv.ag);
            $$1.as.b();
            break label48;
