...
public class cux {
   public static <T> List<cux.b> a(List<T> $$0, Function<T, List<il<dyj>>> $$1, boolean $$2) {
      Object2IntMap<dyj> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, dyj c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<il<dyj>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (ih<dyj> $$12 : $$10.get($$11)) {
               dyj $$13 = $$12.a();
      ...
      for (a $$19 : $$6.keySet()) {
         ...
         if (!$$16.contains($$19) && auc.a($$6, $$16, $$17, $$18::add, $$19)) {
            if (!$$2) {
      ...
      Builder<cux.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<dyj> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new cux.b($$28));
      }
   ...
   public static record b(List<dyj> a, ToIntFunction<dyj> b) {
      b(List<dyj> $$0) {
         this($$0, ac.f($$0));
      }
   }
