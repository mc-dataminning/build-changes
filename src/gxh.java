...
public class gxh extends gwg<bxd, hdm> {
   public gxh(gwh.a $$0) {
      super($$0);
   }

   public void a(hdm $$0, fjj $$1, gqa $$2, int $$3) {
      float[] $$4 = new float[8];
      float[] $$5 = new float[8];
      float $$6 = 0.0F;
      float $$7 = 0.0F;
   ...
   public void a(bxd $$0, hdm $$1, float $$2) {
      super.a($$0, $$1, $$2);
      $$1.a = $$0.a;
   }

   protected boolean a(bxd $$0) {
      return false;
   }
}
