...
public class ebf implements ebh {
   public static final Codec<ebf> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bor.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bor.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bor.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bop.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bop.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public ebf(int $$0, bor $$1, bor $$2, int $$3, int $$4, bor $$5, bop $$6, bop $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
