...
public class ebf extends eaz<ede> {
   private static final je[] a = je.values();

   public ebf(Codec<ede> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ebb<ede> $$0) {
      ede $$1 = $$0.f();
      azh $$2 = $$0.d();
      iz $$3 = $$0.e();
      dcu $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      dyu $$9 = new dyu(new dxw($$4.C()));
      emz $$10 = emz.a($$9, -4, 1.0);
      ...
      for (iz $$44 : $$31) {
         ...
         for (je $$46 : a) {
            ...
            dsd $$48 = $$4.a_($$47);
            if ($$45.b(dst.C)) {
               $$45 = $$45.a(dst.C, Boolean.valueOf($$48.u().b()));
            }
