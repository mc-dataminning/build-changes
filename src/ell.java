...
@Deprecated
public class ell extends ekw<ell.a> {
   private static final ebq a = dnq.nI.m();

   public ell(Codec<ell.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eky<ell.a> $$0) {
      iw $$1 = $$0.e();
      dli $$2 = $$0.b();
      bai $$3 = $$0.d();
      ell.a $$4 = $$0.f();
   ...
   public static record a(epc b, epc c) implements enb {
      public static final Codec<ell.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(epc.a.fieldOf("fluid").forGetter(ell.a::a), epc.a.fieldOf("barrier").forGetter(ell.a::b)).apply($$0, ell.a::new)
      );
