public class fpf extends fne {
   ...
   @Override
   protected void aM_() {
      this.A = new fho(this.p, this.n / 2 - 153, 20, 300, 20, b);
      this.A.f(128);
      this.A.a(this.x.d().a().toString());
      this.A.b($$0x -> this.J());
      this.d(this.A);
      this.y = new fho(this.p, this.n / 2 - 153, 55, 300, 20, c);
      this.y.f(128);
      this.y.a(this.x.b().toString());
      this.y.b($$0x -> this.J());
      this.d(this.y);
      this.z = new fho(this.p, this.n / 2 - 153, 90, 300, 20, d);
      this.z.f(128);
      this.z.a(this.x.c().toString());
      this.z.b($$0x -> this.J());
      this.d(this.z);
      this.B = new fho(this.p, this.n / 2 - 153, 125, 300, 20, r);
      this.B.f(256);
      this.B.a(this.x.f());
      this.d(this.B);
      this.C = new fho(this.p, this.n / 2 - 153, 160, 98, 20, v);
      this.C.f(3);
      this.C.a(Integer.toString(this.x.l()));
      this.C.a(fiq.a(w));
      this.d(this.C);
      this.D = new fho(this.p, this.n / 2 - 50, 160, 98, 20, s);
      this.D.f(3);
      this.D.a(Integer.toString(this.x.k()));
      this.D.a(fiq.a(u));
      this.d(this.D);
      this.J = this.x.j();
      this.G = this.c(fhm.<dqi.a>a(dqi.a::a).a(dqi.a.values()).a(this.J).a().a(this.n / 2 + 54, 160, 100, 20, a, ($$0x, $$1) -> this.J = $$1));
      boolean $$0 = djc.m(this.x.n()).o().b();
      this.G.j = $$0;
      this.G.k = $$0;
      this.c(new fhb(this.n / 2 - 154, 185, 100, 20, xo.a, 0.0) {
         {
            this.b();
         }
         ...
         @Override
         protected void b() {
            this.b(xp.a("jigsaw_block.levels", fpf.this.E));
         }

         @Override
         protected void a() {
            fpf.this.E = ayz.a(ayz.b(0.0, 20.0, this.c));
         }
      });
      this.c(fhm.b(this.F).a(this.n / 2 - 50, 185, 100, 20, xp.c("jigsaw_block.keep_jigsaws"), ($$0x, $$1) -> this.F = $$1));
      this.I = this.c((fhf)fhf.a(xp.c("jigsaw_block.generate"), $$0x -> {
         this.m();
         this.I();
      }).a(this.n / 2 + 54, 185, 100, 20).a());
      this.H = this.c((fhf)fhf.a(xo.d, $$0x -> this.m()).a(this.n / 2 - 4 - 150, 210, 150, 20).a());
