...
public class fpf extends fny<cqr> {
   ...
   private int ah;
   private final fpf.a[] ai = new fpf.a[7];
   int aj;
   private boolean ak;

   public fpf(cqr $$0, cmj $$1, wu $$2) {
      super($$0, $$1, $$2);
      this.c = 276;
      this.u = 107;
   }
   ...
   protected void aP_() {
      ...
      for (int $$3 = 0; $$3 < 7; $$3++) {
         this.ai[$$3] = this.c(new fpf.a($$0 + 5, $$2, $$3, $$0x -> {
            if ($$0x instanceof fpf.a) {
               this.ah = ((fpf.a)$$0x).a() + this.aj;
               this.G();
            }
         }));
         $$2 += 20;
   ...
   private void a(fhf $$0, int $$1, int $$2, dbd $$3) {
      int $$4 = this.w.n();
      int $$5 = this.w.l();
      if ($$4 < 5) {
         ...
         if ($$5 >= $$6 && cly.d($$4)) {
            int $$7 = 102;
            float $$8 = 102.0F / (float)(cly.c($$4) - $$6);
   ...
   private void a(fhf $$0, int $$1, int $$2, dbe $$3) {
      int $$4 = $$3.size() + 1 - 7;
      if ($$4 > 1) {
   ...
   private void a(fhf $$0, dbd $$1, int $$2, int $$3) {
   ...
   private void a(fhf $$0, cuc $$1, cuc $$2, int $$3, int $$4) {
      $$0.b($$1, $$3, $$4);
      if ($$2.H() == $$1.H()) {
         $$0.a(this.o, $$1, $$3, $$4);
      } else {
   ...
   class a extends fhs {
      ...
      public a(final int $$0, final int $$1, final int $$2, final fhs.c $$3) {
      ...
      public void a(fhf $$0, int $$1, int $$2) {
         if (this.i && fpf.this.w.p().size() > this.a + fpf.this.aj) {
            if ($$1 < this.D() + 20) {
               cuc $$3 = fpf.this.w.p().get(this.a + fpf.this.aj).b();
               $$0.b(fpf.this.o, $$3, $$1, $$2);
            } else if ($$1 < this.D() + 50 && $$1 > this.D() + 30) {
               cuc $$4 = fpf.this.w.p().get(this.a + fpf.this.aj).c();
               if (!$$4.e()) {
                  $$0.b(fpf.this.o, $$4, $$1, $$2);
               }
            } else if ($$1 > this.D() + 65) {
               cuc $$5 = fpf.this.w.p().get(this.a + fpf.this.aj).f();
               $$0.b(fpf.this.o, $$5, $$1, $$2);
            }
         }
      }
   }
