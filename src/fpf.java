...
public class fpf {
   ...
   private static final Comparator<gfu> p = Comparator.<gfu>comparingInt($$0 -> -$$0.j())
      .thenComparingInt($$0 -> $$0.e() == dhe.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), fcx::b, ""))
   ...
   private xv t;
   private boolean u;
   private final Map<UUID, fpf.a> v = new Object2ObjectOpenHashMap();

   public fpf(fme $$0, fnp $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public xv a(gfu $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, fcx.a($$0.h(), xv.b($$0.a().getName())));
   }

   private xv a(gfu $$0, yj $$1) {
      return $$0.e() == dhe.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(fnq $$0, int $$1, fdc $$2, @Nullable fcu $$3) {
      List<gfu> $$4 = this.b();
      List<fpf.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            GameProfile $$43 = $$41.a();
            if ($$21) {
               cpw $$44 = this.q.s.b($$43.getId());
               boolean $$45 = $$44 != null && gsp.b($$44);
               boolean $$46 = $$44 != null && $$44.a(cpx.g);
               fpd.a($$0, $$41.g().a(), $$39, $$40, 8, $$46, $$45, -1);
               $$39 += 9;
            }

            $$0.b(this.q.h, $$42.a, $$39, $$40, $$41.e() == dhe.d ? -1862270977 : -1);
            if ($$3 != null && $$41.e() != dhe.d) {
               int $$47 = $$39 + $$7 + 1;
               int $$48 = $$47 + $$22;
               if ($$48 - $$47 > 5) {
   ...
   protected void a(fnq $$0, int $$1, int $$2, int $$3, gfu $$4) {
      alz $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
      ...
      $$0.a(glt::B, $$5, $$2 + $$1 - 11, $$3, 10, 8);
      $$0.c().b();
   }

   private void a(fcu $$0, int $$1, fpf.b $$2, int $$3, int $$4, UUID $$5, fnq $$6) {
      if ($$0.h() == fdf.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, fnq $$4, int $$5) {
      fpf.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new fpf.a($$5));
      $$6.a($$5, (long)this.r.e());
      ...
      if ($$7 > 0) {
         ...
         if ($$10 <= 3) {
            ...
            for (int $$18 = $$7; $$18 < $$8; $$18++) {
               $$4.a(glt::B, $$17, $$1 + $$18 * $$10, $$0, 9, 9);
            }

            for (int $$19 = 0; $$19 < $$7; $$19++) {
               $$4.a(glt::B, $$17, $$1 + $$19 * $$10, $$0, 9, 9);
               if ($$9) {
                  if ($$19 * 2 + 1 < $$6.a()) {
                     $$4.a(glt::B, j, $$1 + $$19 * $$10, $$0, 9, 9);
                  }

                  if ($$19 * 2 + 1 == $$6.a()) {
                     $$4.a(glt::B, k, $$1 + $$19 * $$10, $$0, 9, 9);
                  }
               }

               if ($$19 * 2 + 1 < $$5) {
                  $$4.a(glt::B, $$19 >= 10 ? l : m, $$1 + $$19 * $$10, $$0, 9, 9);
               }

               if ($$19 * 2 + 1 == $$5) {
                  $$4.a(glt::B, $$19 >= 10 ? n : o, $$1 + $$19 * $$10, $$0, 9, 9);
               }
            }
         }
      }
