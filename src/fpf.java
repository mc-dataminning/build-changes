...
public class fpf implements fcq {
   static final Logger b = LogUtils.getLogger();
   private final fdr c;
   private final fot<fpf.b> d;

   fpf(fdr $$0, fot<fpf.b> $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public static record a(alj c, int d, int e, int[][] f) implements fph {
      ...
      public static final MapCodec<fpf.a> a = RecordCodecBuilder.mapCodec(
            $$0 -> $$0.group(
                     alj.a.fieldOf("file").forGetter(fpf.a::c),
                     Codec.INT.optionalFieldOf("height", 8).forGetter(fpf.a::d),
                     Codec.INT.fieldOf("ascent").forGetter(fpf.a::e),
                     g.fieldOf("chars").forGetter(fpf.a::f)
                  )
                  .apply($$0, fpf.a::new)
         )
         .validate(fpf.a::a);
      ...
      private static DataResult<fpf.a> a(fpf.a $$0) {
            ...
            for (int $$10 = 0; $$10 < this.f.length; $$10++) {
               ...
               for (int $$12 : this.f[$$10]) {
                  ...
                  if ($$12 != 0) {
                     ...
                     fpf.b $$15 = $$9.a($$12, new fpf.b($$8, $$3, $$13 * $$6, $$10 * $$7, $$6, $$7, (int)(0.5 + (double)((float)$$14 * $$8)) + 1, this.e));
                     if ($$15 != null) {
                        fpf.b.warn("Codepoint '{}' declared multiple times in {}", Integer.toHexString($$12), $$1);
                     }
                  }
               }
            }
      ...
      private int a(fdr $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5;
         for ($$5 = $$1 - 1; $$5 >= 0; $$5--) {
            int $$6 = $$3 * $$1 + $$5;
   ...
   static record b(float a, fdr b, int c, int d, int e, int f, int g, int h) implements fcp {
