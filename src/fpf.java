...
public class fpf {
   ...
   public void a(fpq $$0) {
      ...
      if (this.d.active()) {
         if ($$0 == fpq.a) {
            fve.b($$1, fve.a.a, wy.c("narrator.toast.disabled"), null);
         } else {
            fve.b($$1, fve.a.a, wy.c("narrator.toast.enabled"), $$0.b());
         }
      } else {
         fve.b($$1, fve.a.a, wy.c("narrator.toast.disabled"), wy.c("options.narrator.notavailable"));
      }
   }
   ...
   public void a(boolean $$0) {
      if ($$0
         ...
         throw new fpf.a("Narrator library is not active");
      }
   }
