...
public class mo {
   ...
   public mo(Optional<ahg> $$0, Optional<String> $$1, mr... $$2) {
      this.a = $$0;
      this.c = $$1;
   ...
   public ahg a(ahg $$0, mq $$1, BiConsumer<ahg, Supplier<JsonElement>> $$2) {
      return this.a($$0, $$1, $$2, this::a);
   }

   public ahg a(ahg $$0, mq $$1, BiConsumer<ahg, Supplier<JsonElement>> $$2, mo.a $$3) {
      Map<mr, ahg> $$4 = this.a($$1);
      $$2.accept($$0, () -> $$3.create($$0, $$4));
      return $$0;
   }

   public JsonObject a(ahg $$0, Map<mr, ahg> $$1) {
