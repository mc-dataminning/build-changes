...
public class bfr extends bff {
   private final Supplier<Type<?>> b = Suppliers.memoize(() -> this.getOutputSchema().getChoiceType(bix.B, "ZombieVillager"));
   ...
   private Typed<?> a(Typed<?> $$0, int $$1) {
      return ae.a($$0, this.b.get(), $$1x -> $$1x.set("Profession", $$1x.createInt($$1)));
   }
}
