...
public class eyz {
   private final List<ConcurrentLinkedQueue<eyy>> a = ImmutableList.of(
   ...
   public void a(eyy $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eyy> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eyy> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eyy> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eyy> j() {
