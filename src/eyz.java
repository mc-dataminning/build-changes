...
public abstract class eyz extends exz {
   private final ddu b;
   private ddv c;
   private final String[] k;
   private final boolean l;
   protected final dgn a;
   private int m;
   private int n;
   @Nullable
   private eux o;

   public eyz(ddu $$0, boolean $$1, boolean $$2) {
      this($$0, $$1, $$2, tf.c("sign.edit"));
   }

   public eyz(ddu $$0, boolean $$1, boolean $$2, tf $$3) {
      super($$3);
      this.b = $$0;
      this.c = $$0.a($$1);
      this.l = $$1;
      this.a = czm.a($$0.q().b());
      this.k = IntStream.range(0, 4).mapToObj($$1x -> this.c.a($$1x, $$2)).map(tf::getString).toArray(String[]::new);
   }

   @Override
   protected void aE_() {
      this.d(esh.a(te.d, $$0 -> this.C()).a(this.g / 2 - 100, this.h / 4 + 144, 200, 20).a());
      this.o = new eux(() -> this.k[this.n], this::a, eux.a(this.f), eux.c(this.f), $$0 -> this.f.h.b($$0) <= this.b.d());
   }
   ...
   private boolean B() {
      return this.f != null && this.f.v != null && !this.b.r() && !this.b.b(this.f.v.cv());
   }
   ...
   public void h() {
      fij $$0 = this.f.J();
      if ($$0 != null) {
         $$0.b(new aco(this.b.p(), this.l, this.k[0], this.k[1], this.k[2], this.k[3]));
      }
   }
   ...
   protected abstract void a(erw var1, dfa var2);
   ...
   private void d(erw $$0) {
      ...
      Vector3f $$1 = this.l();
      $$0.c().b($$1.x(), $$1.y(), $$1.z());
      int $$2 = this.c.a() ? this.c.b().g() : fpz.a(this.c);
      ...
      for (int $$13 = 0; $$13 < this.k.length; $$13++) {
         ...
         if ($$14 != null && $$13 == this.n && $$4 >= 0) {
            ...
            if ($$5 != $$4) {
               ...
               $$0.a(fnt.E(), $$21, $$7, $$22, $$7 + this.b.c(), -16776961);
            }
         }
      }
   }
