...
public class eyz {
   private final ImmutableList<eza> a;
   private final ImmutableMap<String, eza> b;
   private final IntList c = new IntArrayList();
   private final int d;
   @Nullable
   private eyx e;

   public eyz(ImmutableMap<String, eza> $$0) {
      this.b = $$0;
