...
public class eyz {
   ...
   @Nullable
   private String g;
   private static final eyz.a h = new eyz.a() {
      @Nullable
      @Override
      public eyy a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ezc.a(this.d, "Get capabilities")) {
         ...
         if (ezc.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  ezc.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ezc.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public eyy a(eyz.c $$0) {
      return ($$0 == eyz.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements eyz.a {
      private final int a;
      private final Set<eyy> b = Sets.newIdentityHashSet();
      ...
      public eyy a() {
         if (this.b.size() >= this.a) {
            if (ab.aV) {
               eyz.a.warn("Maximum sound pool size {} reached", this.a);
            }
