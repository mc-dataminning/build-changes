...
public enum eyz implements azy {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final azy.a<eyz> t = azy.a(eyz::values);
   public static final IntFunction<eyz> u = axt.a(eyz::a, values(), axt.a.a);
   private final int v;
   private final String w;

   private eyz(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
