public abstract class eyz<T extends cee> extends eyy<T> implements fbs {
   public final fbi x;
   private boolean y;
   private final aer z;
   private final aer A;
   ...
   public eyz(T $$0, fbi $$1, cbl $$2, tf $$3, aer $$4, aer $$5, aer $$6) {
      super($$0, $$2, $$3);
      this.x = $$1;
      this.z = $$4;
      this.A = $$5;
   ...
   public void aC_() {
      ...
      this.d(new ess(this.t + 20, this.h / 2 - 49, 20, 18, fbm.a, $$0 -> {
         this.x.f();
         this.t = this.x.a(this.g, this.c);
