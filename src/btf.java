...
public class btf implements bsy {
   ...
   public static Set<bsw> a() {
      Builder<bsw> $$0 = ImmutableSet.builder();

      try {
         btf.a $$1 = new btf.a();
         IntStream.range(0, $$1.a).mapToObj($$1x -> bsw.a("cpu#" + $$1x, bsv.h, () -> $$1.a($$1))).forEach($$0::add);
      } catch (Throwable var2) {
         a.warn("Failed to query cpu, no cpu stats will be recorded", var2);
      }

      $$0.add(bsw.a("heap MiB", bsv.e, () -> (double)ae.a(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())));
      $$0.addAll(bsx.a.a());
      return $$0.build();
   }
   ...
   public static bsw a(final LongSupplier $$0) {
      ...
      bsw.d $$3 = new bsw.d(2.0F);
      return bsw.a("ticktime", bsv.d, $$2, $$1).a(Stopwatch::start).a($$3).a();
   }
