...
public abstract class cfd extends ceq {
   ...
   public cfd(byc $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public cfd(byc $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(ceq.a.a, ceq.a.c));
   }
   ...
   protected abstract boolean a(dka var1, iv var2);
}
