...
public abstract class bia extends DataFix {
   private final String a;

   public bia(String $$0, Schema $$1, boolean $$2) {
      super($$1, $$2);
      this.a = $$0;
   }

   public TypeRewriteRule makeRule() {
      TaggedChoiceType<String> $$0 = this.getInputSchema().findChoiceType(bho.B);
      TaggedChoiceType<String> $$1 = this.getOutputSchema().findChoiceType(bho.B);
      Type<Pair<String, String>> $$2 = DSL.named(bho.z.typeName(), bjc.a());
      if (!Objects.equals(this.getOutputSchema().getType(bho.z), $$2)) {
