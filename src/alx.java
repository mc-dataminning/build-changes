...
public class alx implements AutoCloseable {
   ...
   private alx(URL $$0, alx.c $$1, URL $$2, alx.b $$3, URL $$4, alx.b $$5, String $$6, alx.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   public static alx a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         ...
         try {
            JsonObject $$1 = arp.a($$0);
            URI $$2 = new URI(arp.i($$1, "apiServer"));
            String $$3 = arp.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = arp.a($$1, "ruleId", 1);
               String $$5 = arp.a($$1, "serverId", "");
               String $$6 = arp.a($$1, "roomId", "Java:Chat");
               int $$7 = arp.a($$1, "hashesToDrop", -1);
               int $$8 = arp.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = arp.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, alx.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<alj> a(GameProfile $$0, String $$1, alx.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(alj.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = arp.a($$4, "response", false);
            if ($$5) {
               return alj.a($$1);
            } else {
               String $$6 = arp.a($$4, "hashed", null);
               if ($$6 == null) {
                  return alj.b($$1);
               } else {
                  JsonArray $$7 = arp.v($$4, "hashes");
                  tq $$8 = this.a($$1, $$7, $$2);
                  return new alj($$1, $$8);
               }
            }
   ...
   private tq a(String $$0, JsonArray $$1, alx.a $$2) {
      if ($$1.isEmpty()) {
         return tq.c;
      } else if ($$2.shouldIgnore($$0, $$1.size())) {
         return tq.b;
      } else {
         tq $$3 = new tq($$0.length());
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new alx.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public alw a(GameProfile $$0) {
      return new alx.d($$0);
   }
   ...
   public interface a {
      alx.a a = ($$0, $$1) -> false;
      alx.a b = ($$0, $$1) -> $$0.length() == $$1;

      static alx.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static alx.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements alw {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bft<Runnable> $$1 = bft.a(alx.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         alx.this.a(this.c, alx.this.g, alx.this.h, this.d);
      }

      @Override
      public void b() {
         alx.this.a(this.c, alx.this.i, alx.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<alj>> a(List<String> $$0) {
         List<CompletableFuture<alj>> $$1 = $$0.stream().map($$0x -> alx.this.a(this.c, $$0x, alx.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<alj> a(String $$0) {
         return alx.this.a(this.c, $$0, alx.this.l, this.d);
      }
   }
