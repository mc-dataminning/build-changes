...
public class alx extends ewv {
   private final MinecraftServer b;
   private final Set<ewn> c = Sets.newHashSet();
   ...
   public List<zw<?>> d(ewn $$0) {
      List<zw<?>> $$1 = Lists.newArrayList();
      $$1.add(new aft($$0, 0));

      for (ewm $$2 : ewm.values()) {
         if (this.a($$2) == $$0) {
            $$1.add(new afm($$2, $$0));
         }
      }
   ...
   public epc.a<eww> b() {
      return new epc.a<>(this::h, this::a, bag.n);
   }
