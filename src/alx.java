...
public class alx {
   ...
   private final Queue<alx.a> b = new axp<>();
   private final Object2IntLinkedOpenHashMap<alx.b> c = new Object2IntLinkedOpenHashMap();
   ...
   public synchronized void a(String $$0, Throwable $$1) {
      ...
      this.b.add(new alx.a($$2, $$0, (Class<? extends Throwable>)$$1.getClass(), $$3));

      while (this.b.size() > 8) {
         this.b.remove();
      }

      alx.b $$4 = new alx.b($$0, (Class<? extends Throwable>)$$1.getClass());
   ...
   public synchronized String a() {
      ...
      if (!this.c.isEmpty()) {
         ...
         while (var6.hasNext()) {
            Entry<alx.b> $$3 = (Entry<alx.b>)var6.next();
            $$1.append("\t\t\t")
               .append(((alx.b)$$3.getKey()).a)
               .append(":")
               .append(((alx.b)$$3.getKey()).b)
               .append(" x ")
