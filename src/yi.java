...
public class yi implements wo<yh> {
   ...
   public yi(bkv $$0, int $$1) {
      this($$0.aj(), $$0.cw(), $$0.ds(), $$0.du(), $$0.dy(), $$0.dF(), $$0.dD(), $$0.ai(), $$1, $$0.dq(), (double)$$0.cp());
   }

   public yi(bkv $$0, int $$1, hx $$2) {
      this($$0.aj(), $$0.cw(), (double)$$2.u(), (double)$$2.v(), (double)$$2.w(), $$0.dF(), $$0.dD(), $$0.ai(), $$1, $$0.dq(), (double)$$0.cp());
   }

   public yi(int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, bkz<?> $$7, int $$8, ejz $$9, double $$10) {
      this.c = $$0;
      this.d = $$1;
      this.f = $$2;
      this.g = $$3;
      this.h = $$4;
      this.l = (byte)atq.d($$5 * 256.0F / 360.0F);
      this.m = (byte)atq.d($$6 * 256.0F / 360.0F);
      this.n = (byte)atq.a($$10 * 256.0 / 360.0);
      this.e = $$7;
      this.o = $$8;
      this.i = (int)(atq.a($$9.c, -3.9, 3.9) * 8000.0);
      this.j = (int)(atq.a($$9.d, -3.9, 3.9) * 8000.0);
      this.k = (int)(atq.a($$9.e, -3.9, 3.9) * 8000.0);
   }
