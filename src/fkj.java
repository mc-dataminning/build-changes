...
public abstract class fkj<E extends fkj.a<E>> extends fkg {
   protected static final int b = 6;
   private static final ale a = ale.b("widget/scroller");
   private static final ale m = ale.b("widget/scroller_background");
   private static final ale n = ale.b("textures/gui/menu_list_background.png");
   private static final ale o = ale.b("textures/gui/inworld_menu_list_background.png");
   protected final fip c;
   protected final int d;
   private final List<E> p = new fkj.b();
   ...
   public fkj(fip $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xd.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = azf.a($$1 - (double)this.E()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
   ...
   public void b(fkb $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.m()) {
         ...
         $$7 = azf.a($$7, 32, this.h - 8);
         int $$8 = (int)this.n() * (this.h - $$7) / this.p() + this.E();
         if ($$8 < this.E()) {
            $$8 = this.E();
         }

         $$0.a(ghv::B, m, $$6, this.E(), 6, this.w());
         $$0.a(ghv::B, a, $$6, $$8, 6, $$7);
      }
   ...
   protected void a(fkb $$0) {
      ale $$1 = this.c.s == null ? fqh.h : fqh.j;
      ale $$2 = this.c.s == null ? fqh.i : fqh.k;
      $$0.a(ghv::B, $$1, this.D(), this.E() - 2, 0.0F, 0.0F, this.y(), 2, 32, 2);
      $$0.a(ghv::B, $$2, this.D(), this.G(), 0.0F, 0.0F, this.y(), 2, 32, 2);
   }

   protected void b(fkb $$0) {
      ale $$1 = this.c.s == null ? n : o;
      $$0.a(ghv::B, $$1, this.D(), this.E(), (float)this.F(), (float)(this.G() + (int)this.n()), this.y(), this.w(), 32, 32);
   }
   ...
   public void a(double $$0) {
      this.q = azf.a($$0, 0.0, (double)this.p());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.E()) {
            ...
            int $$6 = this.h;
            int $$7 = azf.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fou $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fou $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public foj.a u() {
      if (this.aN_()) {
         ...
         return this.v != null ? foj.a.b : foj.a.a;
      }
   }
   ...
   protected void a(fol $$0, E $$1) {
      List<E> $$2 = this.aJ_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fok.b, xe.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fkj.a<E>> implements fml {
      @Deprecated
      fkj<E> a;
      ...
      public abstract void a(fkb var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
