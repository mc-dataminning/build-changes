...
public class fkj extends fjy {
   private static final fln d = new fln(alb.b("widget/text_field"), alb.b("widget/text_field_highlighted"));
   ...
   private BiFunction<String, Integer, ayo> D = ($$0x, $$1x) -> ayo.forward($$0x, ya.a);
   @Nullable
   private xd E;
   private long F = ad.c();

   public fkj(fjl $$0, int $$1, int $$2, xd $$3) {
      this($$0, 0, 0, $$1, $$2, $$3);
   }

   public fkj(fjl $$0, int $$1, int $$2, int $$3, int $$4, xd $$5) {
      this($$0, $$1, $$2, $$3, $$4, null, $$5);
   }

   public fkj(fjl $$0, int $$1, int $$2, int $$3, int $$4, @Nullable fkj $$5, xd $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.o = $$0;
      if ($$5 != null) {
         this.a($$5.a());
   ...
   public void a(BiFunction<String, Integer, ayo> $$0) {
      this.D = $$0;
   }
   ...
   public void e(int $$0) {
      this.w = azc.a($$0, 0, this.p.length());
      this.s(this.w);
   }
   ...
   public void a(double $$0, double $$1) {
      int $$2 = azc.a($$0) - this.D();
      if (this.r) {
         $$2 -= 4;
      }

      String $$3 = this.o.a(this.p.substring(this.v), this.h());
      this.b(this.o.a($$3, $$2).length() + this.v, fpt.t());
   }
   ...
   public void b(fjn $$0, int $$1, int $$2, float $$3) {
      if (this.i()) {
         if (this.f()) {
            alb $$4 = d.a(this.C(), this.aO_());
            $$0.a(ghe::C, $$4, this.D(), this.E(), this.y(), this.w());
         }
         ...
         int $$12 = $$10;
         int $$13 = azc.a(this.x - this.v, 0, $$7.length());
         if (!$$7.isEmpty()) {
         ...
         if ($$9) {
            if ($$15) {
               $$0.a(ghe.H(), $$16, $$11 - 1, $$16 + 1, $$11 + 1 + 9, -3092272);
            } else {
   ...
   public void i(int $$0) {
      this.x = azc.a($$0, 0, this.p.length());
      this.s(this.x);
   }
   ...
   private void s(int $$0) {
      if (this.o != null) {
         ...
         this.v = azc.a(this.v, 0, this.p.length());
      }
   }
