...
public class fkj extends flw {
   private final float a;
   private final flr b;

   fkj(fie $$0, double $$1, double $$2, double $$3, float $$4, float $$5, float $$6, flr $$7) {
      super($$0, $$1, $$2, $$3);
      this.b = $$7;
      this.v = $$4;
      this.w = $$5;
   ...
   public static class a implements fkz<io> {
      ...
      public fkw a(io $$0, fie $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         if (!$$8.i() && $$8.l() == cyp.a) {
            ...
            gv $$9 = gv.a($$2, $$3, $$4);
            int $$10 = eqn.N().aw().a($$8, $$1, $$9);
            if ($$8.b() instanceof cvc) {
               $$10 = ((cvc)$$8.b()).d($$8, $$1, $$9);
            }
            ...
            return new fkj($$1, $$2, $$3, $$4, $$11, $$12, $$13, this.a);
         }
      }
   }
}
