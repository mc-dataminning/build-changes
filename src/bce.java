...
public class bce extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bit.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bit.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bit.s);
