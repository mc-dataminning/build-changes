...
public class bce extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> $$2 = DSL.fieldFinder("id", DSL.named(bgq.D.typeName(), bic.a()));
      OpticFinder<?> $$3 = $$1.findField("tag");
      return TypeRewriteRule.seq(
         this.fixTypeEverywhereTyped("EffectDurationEntity", $$0.getType(bgq.B), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
         new TypeRewriteRule[]{
            this.fixTypeEverywhereTyped("EffectDurationPlayer", $$0.getType(bgq.b), $$0x -> $$0x.update(DSL.remainderFinder(), this::c)),
