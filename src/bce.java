...
public class bce extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> $$0 = DSL.or(DSL.intType(), DSL.named(beh.A.typeName(), bfq.a()));
      Type<Pair<String, String>> $$1 = DSL.named(beh.A.typeName(), bfq.a());
      OpticFinder<Either<Integer, Pair<String, String>>> $$2 = DSL.fieldFinder("id", $$0);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(beh.t),
         this.getOutputSchema().getType(beh.t),
         $$2x -> $$2x.update($$2, $$1, $$0xx -> (Pair)$$0xx.map($$0xxx -> Pair.of(beh.A.typeName(), a($$0xxx.intValue())), $$0xxx -> $$0xxx))
      );
   }
}
