...
public class bce extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getInputSchema().getType(biw.s);
      Type<?> $$2 = this.getOutputSchema().getType(biw.s);
      Type<?> $$3 = bbd.a($$1, $$1, $$2);
   ...
   public static <T> Dynamic<T> a(Dynamic<T> $$0) {
      ...
      return $$1.isEmpty() ? $$0.remove("CustomName") : $$0.set("CustomName", bbe.a($$0.getOps(), $$1));
   }
}
