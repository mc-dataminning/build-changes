...
public interface aqg {
   aqg a = new aqg() {
      ...
      @Override
      public void a(Consumer<dcd> $$0) {
      }
   };

   static aqg a(dcd $$0, int $$1) {
      return new aqg.a($$0, $$1);
   }

   static void a(aqg $$0, aqg $$1, Consumer<dcd> $$2, Consumer<dcd> $$3) {
      if (!$$0.equals($$1)) {
         if ($$0 instanceof aqg.a $$4 && $$1 instanceof aqg.a $$5 && $$4.a($$5)) {
            ...
            for (int $$10 = $$6; $$10 <= $$8; $$10++) {
               for (int $$11 = $$7; $$11 <= $$9; $$11++) {
                  ...
                  if ($$12 != $$13) {
                     if ($$13) {
                        $$2.accept(new dcd($$10, $$11));
                     } else {
                        $$3.accept(new dcd($$10, $$11));
                     }
                  }
               }
            }
   ...
   public static record a(dcd b, int c) implements aqg {
      int c() {
      ...
      @VisibleForTesting
      protected boolean a(aqg.a $$0) {
         return this.c() <= $$0.e() && this.e() >= $$0.c() && this.d() <= $$0.f() && this.f() >= $$0.d();
      }

      @Override
      public boolean a(int $$0, int $$1, boolean $$2) {
         return aqg.a(this.b.e, this.b.f, this.c, $$0, $$1, $$2);
      }
