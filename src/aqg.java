...
public class aqg extends aqf {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aqg.a> s;
   private final aqb t;
   private long u;
   private final agw v;

   private aqg(agw $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aqc.c($$2, 7, $$0.getLength());
      }
   }
