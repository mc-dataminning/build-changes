...
public abstract class gpb extends fhf {
   ...
   private final List<goz> a = Lists.newArrayList();
   ...
   protected goz a(goz $$0) {
      this.a.add($$0);
      return this.a($$0);
   }

   public vu o() {
      return vt.a(this.a.stream().map(goz::a).collect(Collectors.toList()));
   }
}
