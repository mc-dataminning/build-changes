...
public abstract class bwz<E extends bvg> implements bxa<E> {
   public static final int a = 60;
   protected final Map<cek<?>, cel> b;
   private bwz.a c = bwz.a.a;
   private long d;
   private final int e;
   private final int f;

   public bwz(Map<cek<?>, cel> $$0) {
      this($$0, 60);
   }

   public bwz(Map<cek<?>, cel> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public bwz(Map<cek<?>, cel> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<cek<?>, cel> $$1 : this.b.entrySet()) {
         cek<?> $$2 = $$1.getKey();
         cel $$3 = $$1.getValue();
         if (!$$0.eb().a($$2, $$3)) {
            return false;
