...
public class bwz {
   ...
   private final bwf b;
   private int c;
   private final bwz.a d = new bwz.a(0, feq.c, 0.0F, 0.0F);
   @Nullable
   private feq e;
   @Nullable
   private fep f;
   @Nullable
   private final Consumer<bwz> g;

   public bwz(bwf $$0) {
      this($$0, 3, null);
   }

   public bwz(bwf $$0, int $$1) {
      this($$0, $$1, null);
   }

   public bwz(bwf $$0, @Nullable Consumer<bwz> $$1) {
      this($$0, 3, $$1);
   }

   public bwz(bwf $$0, int $$1, @Nullable Consumer<bwz> $$2) {
      this.c = $$1;
      this.b = $$0;
      this.g = $$2;
   }
   ...
   public void a(feq $$0, float $$1, float $$2) {
      if (this.c == 0) {
         this.b.b($$0, $$1, $$2);
         this.f();
      } else {
         ...
         this.d.d = $$2;
         this.e = this.b.dt();
         this.f = new fep(this.b.dN(), this.b.dL());
         if (this.g != null) {
            this.g.accept(this);
         }
      }
