public class fuj extends fve {
   private final fuz a;

   fuj(fra $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fuz $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cia $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dq();
            if (this.h > $$1) {
               this.h = this.h + ($$1 - this.h) * 0.2;
               this.k = this.k + ($$0.dm().d - this.k) * 0.2;
   ...
   public static class a implements fuh<ke> {
      ...
      public fue a(ke $$0, fra $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new fuj($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements fuh<ke> {
      ...
      public fue a(ke $$0, fra $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fue $$8 = new fuj($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
