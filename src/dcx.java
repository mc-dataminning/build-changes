...
public class dcx {
   ...
   private final dcx.a e;
   private final long f;

   public dcx(dcx.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public dcx a(dcx.a $$0) {
      return new dcx($$0, this.f);
   }

   public ji<dcv> a(iz $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public ji<dcv> a(double $$0, double $$1, double $$2) {
      int $$3 = jt.a(ayx.a($$0));
      int $$4 = jt.a(ayx.a($$1));
      int $$5 = jt.a(ayx.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   private static double a(long $$0, int $$1, int $$2, int $$3, double $$4, double $$5, double $$6) {
      ...
      $$7 = ays.a($$7, $$0);
      double $$10 = b($$7);
      return ayx.k($$6 + $$10) + ayx.k($$5 + $$9) + ayx.k($$4 + $$8);
   }
   ...
   public interface a {
      ji<dcv> getNoiseBiome(int var1, int var2, int var3);
   }
}
