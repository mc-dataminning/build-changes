...
public class dcx extends dcl {
   ...
   private static final csl[] h = new csl[]{csm.hZ, csm.ia, csm.ii, csm.ib};
   public int a;
   private float i;
   private boolean j;
   private boolean k;
   ...
   public static void a(cpl $$0, gu $$1, dez $$2, dcx $$3) {
      $$3.a++;
      long $$4 = $$0.V();
      List<gu> $$5 = $$3.l;
      if ($$4 % 40L == 0L) {
   ...
   public static void b(cpl $$0, gu $$1, dez $$2, dcx $$3) {
      $$3.a++;
      long $$4 = $$0.V();
      List<gu> $$5 = $$3.l;
      if ($$4 % 40L == 0L) {
   ...
   private static void a(dcx $$0, List<gu> $$1) {
      $$0.a($$1.size() >= 42);
   }

   private static boolean a(cpl $$0, gu $$1, List<gu> $$2) {
      $$2.clear();
   ...
   private static void b(cpl $$0, gu $$1, List<gu> $$2) {
      int $$3 = $$2.size();
      int $$4 = $$3 / 7 * 16;
      int $$5 = $$1.u();
      int $$6 = $$1.v();
      int $$7 = $$1.w();
      egy $$8 = new egy((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1))
         .g((double)$$4)
   ...
   private static void a(cpl $$0, gu $$1, dez $$2, List<gu> $$3, dcx $$4) {
      biy $$5 = $$4.m;
      int $$6 = $$3.size();
      if ($$6 < 42) {
         $$4.m = null;
         ...
         List<biy> $$7 = $$0.a(biy.class, a($$1), $$0x -> $$0x instanceof bys && $$0x.aY());
         if (!$$7.isEmpty()) {
   ...
   private static void a(cpl $$0, gu $$1, dcx $$2) {
      if ($$2.n == null) {
         $$2.m = null;
   ...
   private static egy a(gu $$0) {
      int $$1 = $$0.u();
      int $$2 = $$0.v();
      int $$3 = $$0.w();
      return new egy((double)$$1, (double)$$2, (double)$$3, (double)($$1 + 1), (double)($$2 + 1), (double)($$3 + 1)).g(8.0);
   }

   @Nullable
   private static biy a(cpl $$0, gu $$1, UUID $$2) {
      List<biy> $$3 = $$0.a(biy.class, a($$1), $$1x -> $$1x.cv().equals($$2));
      return $$3.size() == 1 ? $$3.get(0) : null;
   }

   private static void a(cpl $$0, gu $$1, List<gu> $$2, @Nullable bii $$3, int $$4) {
      aru $$5 = $$0.z;
      double $$6 = (double)(arp.a((float)($$4 + 35) * 0.1F) / 2.0F + 0.5F);
      $$6 = ($$6 * $$6 + $$6) * 0.3F;
      ehd $$7 = new ehd((double)$$1.u() + 0.5, (double)$$1.v() + 1.5 + $$6, (double)$$1.w() + 0.5);
