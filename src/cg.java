...
public class cg extends cx<cg.a> {
   ...
   public void a(apb $$0, eov $$1, int $$2) {
   ...
   public static record a(Optional<bc> b, Optional<bi> c, cm.d d) implements cx.a {
      public static final Codec<cg.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
                  avu.a(br.b, "player").forGetter(cg.a::a), avu.a(bi.a, "distance").forGetter(cg.a::b), avu.a(cm.d.d, "duration", cm.d.c).forGetter(cg.a::c)
               )
               .apply($$0, cg.a::new)
      );
      ...
      public boolean a(apb $$0, eov $$1, int $$2) {
         return this.c.isPresent() && !this.c.get().a($$1.c, $$1.d, $$1.e, $$0.do(), $$0.dq(), $$0.du()) ? false : this.d.d($$2);
      }
