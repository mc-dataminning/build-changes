...
public class ya implements wv {
   ...
   public static final MapCodec<ya> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               Codec.BOOL.lenientOptionalFieldOf("interpret", false).forGetter(ya::c),
               ww.a.lenientOptionalFieldOf("separator").forGetter(ya::d),
               xw.c.forGetter(ya::e)
            )
            .apply($$0, ya::new)
   );
   ...
   private final xw h;
   @Nullable
   protected final fi.g c;

   public ya(String $$0, boolean $$1, Optional<wu> $$2, xw $$3) {
      this($$0, a($$0), $$1, $$2, $$3);
   }

   private ya(String $$0, @Nullable fi.g $$1, boolean $$2, Optional<wu> $$3, xw $$4) {
      this.g = $$0;
      this.c = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   @Nullable
   private static fi.g a(String $$0) {
      try {
