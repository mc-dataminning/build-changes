...
public class ya {
   ...
   private static <T> ya a(ya $$0, @Nullable T $$1, @Nullable T $$2) {
      return $$1 != null && $$2 == null && $$0.equals(a) ? a : $$0;
   }

   public ya a(@Nullable yc $$0) {
      return Objects.equals(this.c, $$0) ? this : a(new ya($$0, this.d, this.e, this.f, this.g, this.h, this.i, this.j, this.k, this.l), this.c, $$0);
   }

   public ya a(@Nullable n $$0) {
      return this.a($$0 != null ? yc.a($$0) : null);
   }

   public ya a(int $$0) {
      return this.a(yc.a($$0));
   }

   public ya a(@Nullable Boolean $$0) {
      return Objects.equals(this.d, $$0) ? this : a(new ya(this.c, $$0, this.e, this.f, this.g, this.h, this.i, this.j, this.k, this.l), this.d, $$0);
   }

   public ya b(@Nullable Boolean $$0) {
      return Objects.equals(this.e, $$0) ? this : a(new ya(this.c, this.d, $$0, this.f, this.g, this.h, this.i, this.j, this.k, this.l), this.e, $$0);
   }

   public ya c(@Nullable Boolean $$0) {
      return Objects.equals(this.f, $$0) ? this : a(new ya(this.c, this.d, this.e, $$0, this.g, this.h, this.i, this.j, this.k, this.l), this.f, $$0);
   }

   public ya d(@Nullable Boolean $$0) {
      return Objects.equals(this.g, $$0) ? this : a(new ya(this.c, this.d, this.e, this.f, $$0, this.h, this.i, this.j, this.k, this.l), this.g, $$0);
   }

   public ya e(@Nullable Boolean $$0) {
      return Objects.equals(this.h, $$0) ? this : a(new ya(this.c, this.d, this.e, this.f, this.g, $$0, this.i, this.j, this.k, this.l), this.h, $$0);
   }

   public ya a(@Nullable xb $$0) {
      return Objects.equals(this.i, $$0) ? this : a(new ya(this.c, this.d, this.e, this.f, this.g, this.h, $$0, this.j, this.k, this.l), this.i, $$0);
   }

   public ya a(@Nullable xj $$0) {
      return Objects.equals(this.j, $$0) ? this : a(new ya(this.c, this.d, this.e, this.f, this.g, this.h, this.i, $$0, this.k, this.l), this.j, $$0);
   }

   public ya a(@Nullable String $$0) {
   ...
   public ya b(n $$0) {
      ...
      return new ya($$1, $$2, $$3, $$5, $$4, $$6, this.i, this.j, this.k, this.l);
   }
   ...
   public static class b {
      public static final MapCodec<ya> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  yc.a.optionalFieldOf("color").forGetter($$0x -> Optional.ofNullable($$0x.c)),
      ...
      public static final Codec<ya> b = a.codec();
      public static final zb<wo, ya> c = yz.c(b);
   }
}
