...
public class ya implements wq {
   public static final Object[] a = new Object[0];
   private static final Codec<Object> d = ayi.b.validate(ya::b);
   private static final Codec<Object> e = Codec.either(d, wr.a)
      .xmap(
         $$0 -> $$0.map($$0x -> $$0x, $$0x -> Objects.requireNonNullElse($$0x.d(), $$0x)), $$0 -> $$0 instanceof wp $$1 ? Either.right($$1) : Either.left($$0)
      );
   public static final MapCodec<ya> b = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final wq.a<ya> c = new wq.a<>(b, "translatable");
   private static final wu f = wu.e("%");
   private static final wu g = wu.e("null");
   ...
   @Nullable
   private tl k;
   private List<wu> l = ImmutableList.of();
   ...
   private static ya a(String $$0, Optional<String> $$1, Optional<List<Object>> $$2) {
      return new ya($$0, $$1.orElse(null), a($$2));
   }

   public ya(String $$0, @Nullable String $$1, Object[] $$2) {
      this.h = $$0;
      this.i = $$1;
      this.j = $$2;
   }
   ...
   private void e() {
      ...
      if ($$0 != this.k) {
         ...
         try {
            Builder<wu> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.l = $$2.build();
         } catch (yb var4) {
            this.l = ImmutableList.of(wu.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<wu> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new yb(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private wu a(int $$0) {
      if ($$0 >= 0 && $$0 < this.j.length) {
         ...
         if ($$1 instanceof wp) {
            ...
            return $$1 == null ? g : wu.e($$1.toString());
         }
      } else {
         throw new yb(this, $$0);
      }
   ...
   public xd a(@Nullable ex $$0, @Nullable buk $$1, int $$2) throws CommandSyntaxException {
      ...
      return xd.a(new ya(this.h, this.i, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof ya $$1 && Objects.equals(this.h, $$1.h) && Objects.equals(this.i, $$1.i) && Arrays.equals(this.j, $$1.j)) {
            return true;
         }
