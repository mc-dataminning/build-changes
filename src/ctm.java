public class ctm extends csb {
   ...
   public ctm(int $$0, cov $$1) {
      this($$0, $$1, new coe($$1.k));
   }

   public ctm(int $$0, cov $$1, dfd $$2) {
      super(ctk.t, $$0);
      this.x = $$2;
      this.y = new ctl($$2);
      this.a(new cty(this.y, 0, 136, 37));
      this.a(new cty(this.y, 1, 162, 37));
      this.a(new ctn($$1.k, $$2, this.y, 2, 220, 37));
      this.c($$1, 108, 84);
   }
   ...
   private void a(int $$0, dfc $$1) {
      for (int $$2 = 3; $$2 < 39; $$2++) {
         cwo $$3 = this.k.get($$2).g();
         if (!$$3.f() && $$1.a($$3)) {
            cwo $$4 = this.y.a($$0);
            if ($$4.f() || cwo.c($$3, $$4)) {
               int $$5 = $$3.k();
