...
public class gfr extends ggp<hef> {
   private final gjt[] a;
   private final gjt b;
   ...
   public static gjz a() {
      gkb $$0 = new gkb();
      gkd $$1 = $$0.a();
      $$1.a("head", gjy.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), gjv.a);
      float $$2 = 0.0F;
      gjy $$3 = gjy.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = azm.b($$2) * 9.0F;
         float $$6 = -2.0F + azm.b((float)($$4 * 2) * 0.25F);
         float $$7 = azm.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, gjv.a($$5, $$6, $$7));
         $$2++;
      }
