...
public class gfr {
   ...
   public final Map<ji, gfs> c;
   public final gft d;
   public final boolean e;

   public gfr(Vector3f $$0, Vector3f $$1, Map<ji, gfs> $$2, @Nullable gft $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ji, gfs> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gfr> {
      private static final boolean a = true;

      public gfr a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         gft $$6 = this.a($$3);
         Map<ji, gfs> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !ayd.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = ayd.a($$3, "shade", true);
            return new gfr($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private gft a(JsonObject $$0) {
         gft $$1 = null;
         if ($$0.has("rotation")) {
            JsonObject $$2 = ayd.u($$0, "rotation");
            Vector3f $$3 = this.a($$2, "origin");
            $$3.mul(0.0625F);
            ji.a $$4 = this.c($$2);
            float $$5 = this.b($$2);
            boolean $$6 = ayd.a($$2, "rescale", false);
            $$1 = new gft($$3, $$4, $$5, $$6);
         }
      ...
      private float b(JsonObject $$0) {
         float $$1 = ayd.m($$0, "angle");
         if ($$1 != 0.0F && ayn.e($$1) != 22.5F && ayn.e($$1) != 45.0F) {
      ...
      private Map<ji, gfs> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ji, gfs> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ji, gfs> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ji, gfs> $$2 = Maps.newEnumMap(ji.class);
         JsonObject $$3 = ayd.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ji $$5 = this.a($$4.getKey());
            $$2.put($$5, (gfs)$$0.deserialize($$4.getValue(), gfs.class));
         }
