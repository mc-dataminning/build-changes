...
public class gfr<T extends hcg> extends gfd<T> implements gdv, gfn {
   public static final gip i = new gea(true, 16.0F, 0.0F, 2.0F, 2.0F, 24.0F, Set.of("head"));
   ...
   public gfr(gig $$0, Function<ale, gpn> $$1) {
      super($$0, $$1);
      this.o = $$0.b("head");
      this.p = this.o.b("hat");
      this.q = $$0.b("body");
   ...
   public static gio a(gik $$0, float $$1) {
      gio $$2 = new gio();
      giq $$3 = $$2.a();
      giq $$4 = $$3.a("head", gil.c().a(0, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0), gii.a(0.0F, 0.0F + $$1, 0.0F));
      $$4.a("hat", gil.c().a(32, 0).a(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, $$0.a(0.5F)), gii.a);
      $$3.a("body", gil.c().a(16, 16).a(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, $$0), gii.a(0.0F, 0.0F + $$1, 0.0F));
      $$3.a("right_arm", gil.c().a(40, 16).a(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gii.a(-5.0F, 2.0F + $$1, 0.0F));
      $$3.a("left_arm", gil.c().a(40, 16).a().a(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gii.a(5.0F, 2.0F + $$1, 0.0F));
      $$3.a("right_leg", gil.c().a(0, 16).a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gii.a(-1.9F, 12.0F + $$1, 0.0F));
      $$3.a("left_leg", gil.c().a(0, 16).a().a(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, $$0), gii.a(1.9F, 12.0F + $$1, 0.0F));
      return $$2;
   }
   ...
   public void a(T $$0) {
      ...
      if ($$2 != gfr.a.h) {
         gdt.a(this.r, $$0.u, 1.0F);
      }

      if ($$1 != gfr.a.h) {
         gdt.a(this.s, $$0.u, -1.0F);
      }

      if ($$3 > 0.0F) {
         float $$10 = $$5 % 26.0F;
         bws $$11 = $$0.L;
         float $$12 = $$11 == bws.b && $$0.H > 0.0F ? 0.0F : $$3;
         float $$13 = $$11 == bws.a && $$0.H > 0.0F ? 0.0F : $$3;
         if (!$$0.R) {
            if ($$10 < 14.0F) {
   ...
   private void a(T $$0, gfr.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gdt.a(this.r, this.s, $$0.J, $$0.K, true);
            break;
         case g:
            gdt.a(this.r, this.s, this.o, true);
            break;
         case h:
   ...
   private void b(T $$0, gfr.a $$1) {
      switch ($$1) {
         ...
         case e:
            ...
            break;
         case f:
            gdt.a(this.r, this.s, $$0.J, $$0.K, false);
            break;
         case g:
            gdt.a(this.r, this.s, this.o, false);
            break;
         case h:
   ...
   private void a(gig $$0, boolean $$1) {
   ...
   protected gig a(bws $$0) {
      return $$0 == bws.a ? this.s : this.r;
   }
