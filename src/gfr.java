public class gfr implements gfn<dpk> {
   private final gju a;
   ...
   public void a(dpk $$0, float $$1, ezx $$2, gdn $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.n().c(dsr.bv);
         if ($$6 > 0) {
            je $$7 = $$0.d();
            if ($$7 != null) {
               ...
               if (!$$8.e()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = gdl.a($$0.i(), $$0.n(), $$0.ay_().a($$7));
                  this.a.a($$8, cul.i, $$11, gop.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
