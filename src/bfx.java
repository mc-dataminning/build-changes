...
public class bfx implements bfy {
   ...
   private static final bfx j = new bfx();
   @Nullable
   Recording k;
   private float l;
   ...
   public boolean a(bfw $$0) {
      URL $$1 = bfx.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bfw $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bga a = new bga(() -> bfx.this.k = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bfx.this.k && $$0.getState() == RecordingState.STOPPED) {
