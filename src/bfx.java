...
public class bfx extends bgb {
   public static final Codec<bfx> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(
   ...
   public static bfx a(float $$0, float $$1, float $$2, float $$3) {
      return new bfx($$0, $$1, $$2, $$3);
   }

   private bfx(float $$0, float $$1, float $$2, float $$3) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
      this.f = $$3;
   ...
   public static float a(asc $$0, float $$1, float $$2, float $$3, float $$4) {
      return arx.a(arx.c($$0, $$1, $$2), $$3, $$4);
   }
