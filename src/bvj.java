...
public enum bvj implements azv {
   ...
   public static final IntFunction<bvj> j = axq.a($$0 -> $$0.p, values(), axq.a.a);
   public static final azv.a<bvj> k = azv.a(bvj::values);
   public static final yn<ByteBuf, bvj> l = yl.a(j, $$0 -> $$0.p);
