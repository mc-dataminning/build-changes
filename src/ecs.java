...
public class ecs extends LongLinkedOpenHashSet {
   private final ecs.a a;

   public ecs(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new ecs.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = atq.f(60000000);
      private static final int b = atq.f(60000000);
