...
@Deprecated
public class ecs extends ecd<ecs.a> {
   private static final dtc a = dga.nc.o();

   public ecs(Codec<ecs.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ecf<ecs.a> $$0) {
      jd $$1 = $$0.e();
      dds $$2 = $$0.b();
      ayw $$3 = $$0.d();
      ecs.a $$4 = $$0.f();
   ...
   public static record a(egi b, egi c) implements eeh {
      public static final Codec<ecs.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(egi.a.fieldOf("fluid").forGetter(ecs.a::a), egi.a.fieldOf("barrier").forGetter(ecs.a::b)).apply($$0, ecs.a::new)
      );
