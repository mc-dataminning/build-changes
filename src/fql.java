...
public class fql implements fqe<ddh> {
   public static final gbi a = new gbi(fzd.e, new aex("entity/conduit/base"));
   public static final gbi b = new gbi(fzd.e, new aex("entity/conduit/cage"));
   public static final gbi c = new gbi(fzd.e, new aex("entity/conduit/wind"));
   public static final gbi d = new gbi(fzd.e, new aex("entity/conduit/wind_vertical"));
   public static final gbi e = new gbi(fzd.e, new aex("entity/conduit/open_eye"));
   public static final gbi f = new gbi(fzd.e, new aex("entity/conduit/closed_eye"));
   private final fic g;
   private final fic h;
   private final fic i;
   private final fic j;
   ...
   public void a(ddh $$0, float $$1, elp $$2, foe $$3, int $$4, int $$5) {
      ...
      if (!$$0.d()) {
         ...
         float $$10 = arx.a($$6 * 0.1F) / 2.0F + 0.5F;
         $$10 = $$10 * $$10 + $$10;
         $$2.a();
