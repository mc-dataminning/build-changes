...
public class fql implements ako<cyn>, fic, fiv, fkt, fqq {
   public static final fim a = new fim(new alb("recipe_book/button"), new alb("recipe_book/button_highlighted"));
   private static final fim i = new fim(
      new alb("recipe_book/filter_enabled"),
      new alb("recipe_book/filter_disabled"),
      new alb("recipe_book/filter_enabled_highlighted"),
      new alb("recipe_book/filter_disabled_highlighted")
   );
   protected static final alb b = new alb("textures/gui/recipe_book.png");
   ...
   private static final xl l = xl.c("gui.recipebook.toggleRecipes.craftable");
   private static final xl m = xl.c("gui.recipebook.toggleRecipes.all");
   private int n;
   private int o;
   private int p;
   protected final fqj e = new fqj();
   private final List<fqn> q = Lists.newArrayList();
   @Nullable
   private fqn r;
   protected fif f;
   protected crc<?> g;
   ...
   private String u = "";
   private fen v;
   private final fqm w = new fqm();
   private final cmw x = new cmw();
   private int y;
   private boolean z;
   private boolean A;
   private boolean B;

   public void a(int $$0, int $$1, ffa $$2, boolean $$3, crc<?> $$4) {
      this.h = $$2;
      this.o = $$0;
      this.p = $$1;
      this.g = $$4;
   ...
   public void d() {
      ...
      this.s = new fhi(this.h.h, $$0 + 25, $$1 + 13, 81, 9 + 5, xl.c("itemGroup.search"));
      this.s.f(50);
      this.s.g(true);
      this.s.g(16777215);
      this.s.a($$2);
      ...
      this.w.a(this.h, $$0, $$1);
      this.w.a(this);
      this.f = new fif($$0 + 110, $$1 + 12, 26, 16, this.v.a(this.g));
      this.b();
      this.a();
      this.q.clear();

      for (ffi $$3 : ffi.a(this.g.t())) {
         this.q.add(new fqn($$3));
      }
   ...
   private void b() {
      this.f.a(this.f.a() ? fik.a(this.c()) : fik.a(m));
   }
   ...
   private void c(boolean $$0) {
      List<fqp> $$1 = this.v.a(this.r.b());
      $$1.forEach($$0x -> $$0x.a(this.x, this.g.n(), this.g.o(), this.v));
      List<fqp> $$2 = Lists.newArrayList($$1);
      $$2.removeIf($$0x -> !$$0x.b());
      $$2.removeIf($$0x -> !$$0x.d());
      String $$3 = this.s.a();
      if (!$$3.isEmpty()) {
         ObjectSet<fqp> $$4 = new ObjectLinkedOpenHashSet(this.h.a(gsu.c).search($$3.toLowerCase(Locale.ROOT)));
   ...
   public void a(fgm $$0, int $$1, int $$2, int $$3, int $$4) {
      if (this.f()) {
         this.w.a($$0, $$3, $$4);
         this.b($$0, $$1, $$2, $$3, $$4);
      }
   ...
   private void b(fgm $$0, int $$1, int $$2, int $$3, int $$4) {
      ...
      if ($$5 != null && this.h.y != null) {
         $$0.a(this.h.h, fmy.a(this.h, $$5), $$3, $$4);
      }
   }

   public void a(fgm $$0, int $$1, int $$2, boolean $$3, float $$4) {
      ...
      if (this.f() && !this.h.s.N_()) {
         if (this.w.a($$0, $$1, $$2, (this.o - 147) / 2 - this.n, (this.p - 166) / 2, 147, 166)) {
            ...
            if ($$3 != null && $$4 != null) {
               ...
               this.e.a();
               this.h.q.a(this.h.s.cb.j, $$3, fmy.s());
               if (!this.p()) {
                  this.b(false);
               }
            }
   ...
   public void a(cys<?> $$0, List<crk> $$1) {
      ...
      this.e.a($$0);
      this.e.a(cyn.a($$2), $$1.get(0).e, $$1.get(0).f);
   ...
   protected void j() {
      if (this.h.L() != null) {
         ...
         this.h.L().b(new ahz($$0, $$1, $$2));
      }
   }

   @Override
   public fkt.a t() {
      return this.A ? fkt.a.b : fkt.a.a;
   }

   @Override
   public void b(fkv $$0) {
      List<fkt> $$1 = Lists.newArrayList();
      this.w.a($$1x -> {
         if ($$1x.B()) {
            $$1.add($$1x);
         }
