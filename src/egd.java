...
public class egd extends efx<eic> {
   private static final jn[] a = jn.values();

   public egd(Codec<eic> $$0) {
      super($$0);
   }

   @Override
   public boolean a(efz<eic> $$0) {
      eic $$1 = $$0.f();
      azh $$2 = $$0.d();
      ji $$3 = $$0.e();
      dhf $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      edq $$9 = new edq(new ecs($$4.E()));
      esb $$10 = esb.a($$9, -4, 1.0);
      ...
      for (ji $$44 : $$31) {
         ...
         for (jn $$46 : a) {
            ...
            dww $$48 = $$4.a_($$47);
            if ($$45.b(dxm.J)) {
               $$45 = $$45.b(dxm.J, Boolean.valueOf($$48.y().b()));
            }
