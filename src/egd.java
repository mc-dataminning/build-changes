...
public abstract class egd<M extends ega<M>> {
   private final cvw i;
   ...
   protected final Long2ObjectMap<dnh> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected egd(cvw $$0, dnp $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected dnh a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected dnh a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected dnh c(long $$0) {
      dnh $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected int e(long $$0) {
      long $$1 = jb.e($$0);
      dnh $$2 = this.a($$1, true);
      return $$2.a(jb.b(hz.a($$0)), jb.b(hz.b($$0)), jb.b(hz.c($$0)));
   }
   ...
   protected void a(long $$0, int $$1) {
      ...
      $$3.a(jb.b(hz.a($$0)), jb.b(hz.b($$0)), jb.b(hz.c($$0)), $$1);
      jb.a($$0, this.f::add);
   }
   ...
   protected void f(long $$0) {
      ...
      for (int $$4 = -1; $$4 <= 1; $$4++) {
         for (int $$5 = -1; $$5 <= 1; $$5++) {
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               this.f.add(jb.b($$1 + $$5, $$2 + $$6, $$3 + $$4));
            }
         }
      }
   }

   protected dnh g(long $$0) {
      dnh $$1 = (dnh)this.g.get($$0);
      return $$1 != null ? $$1 : new dnh();
   }
   ...
   protected void a(egg<M, ?> $$0) {
      if (this.h) {
         ...
         while ($$5.hasNext()) {
            long $$1 = (Long)$$5.next();
            dnh $$2 = (dnh)this.g.remove($$1);
            dnh $$3 = this.d.d($$1);
            if (this.k.contains(jb.f($$1))) {
               if ($$2 != null) {
                  this.g.put($$1, $$2);
               } else if ($$3 != null) {
                  this.g.put($$1, $$3);
         ...
         this.l.clear();
         ObjectIterator<Entry<dnh>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<dnh> $$6 = (Entry<dnh>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               dnh $$8 = (dnh)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable dnh $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = jb.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, egd.a.a($$9, egd.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public egd.b k(long $$0) {
      return egd.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static egd.b c(byte $$0) {
         if ($$0 == 0) {
            return egd.b.a;
         } else {
            return a($$0) ? egd.b.c : egd.b.b;
         }
      }
   }
