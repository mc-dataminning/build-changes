...
class atj implements Path {
   private static final BasicFileAttributes a = new ath() {
      @Override
   ...
   private static final BasicFileAttributes b = new ath() {
      @Override
      public boolean isRegularFile() {
         return true;
      }
   ...
   private static final Comparator<atj> c = Comparator.comparing(atj::n);
   ...
   public atj(atl $$0, String $$1, @Nullable atj $$2, atm $$3) {
      this.e = $$0;
      this.d = $$1;
      this.f = $$2;
      this.i = $$3;
   ...
   private atj a(@Nullable atj $$0, String $$1) {
      return new atj(this.e, $$1, $$0, atm.b);
   }
   ...
   atj a(String $$0) {
      if (a(this.i)) {
         return new atj(this.e, $$0, this, this.i);
      } else if (this.i instanceof atm.a $$1) {
         atj $$2 = $$1.a().get($$0);
         return $$2 != null ? $$2 : new atj(this.e, $$0, this, atm.a);
      } else if (this.i instanceof atm.b) {
         return new atj(this.e, $$0, this, atm.a);
      } else {
         throw new AssertionError("All content types should be already handled");
      }
   }

   private static boolean a(atm $$0) {
      return $$0 == atm.a || $$0 == atm.b;
   }
   ...
   private atj c(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else {
         if ($$0 instanceof atj $$1 && $$1.e == this.e) {
            return $$1;
         }
   ...
   @Nullable
   public Path h() {
      return this.i instanceof atm.b $$0 ? $$0.a() : null;
   }

   @Nullable
   public atm.a i() {
      return this.i instanceof atm.a $$0 ? $$0 : null;
   }
