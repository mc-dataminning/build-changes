...
public class atj extends axr {
   public atj(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityBlockStateFix", ayp.s, "minecraft:piston");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getOutputSchema().getChoiceType(ayp.s, "minecraft:piston");
