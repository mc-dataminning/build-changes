...
public class atj extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(aym.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(aym.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(aym.s);
