...
class atj extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof ati && $$1 instanceof ati && $$0.equals($$1);
   }
   ...
   private static ati a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof ati) {
         return (ati)$$0;
      } else {
