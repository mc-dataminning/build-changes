...
public class atj implements atf {
   private static final Logger c = LogUtils.getLogger();
   private final ate d;
   private final asx e;
   private final Set<String> f;
   private final List<Path> g;
   private final Map<ath, List<Path>> h;

   atj(ate $$0, asx $$1, Set<String> $$2, List<Path> $$3, Map<ath, List<Path>> $$4) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.g = $$3;
   ...
   public void a(ath $$0, alc $$1, Consumer<Path> $$2) {
      v.d($$1.a()).ifSuccess($$3 -> {
         String $$4 = $$1.b();
   ...
   public void a(ath $$0, String $$1, String $$2, atf.a $$3) {
      v.d($$2).ifSuccess($$3x -> {
         ...
         if ($$5 == 1) {
            ...
            Map<alc, aul<InputStream>> $$6 = new HashMap<>();
   ...
   private static void a(atf.a $$0, String $$1, Path $$2, List<String> $$3) {
      Path $$4 = $$2.resolve($$1);
      ati.a($$1, $$4, $$3, $$0);
   }
   ...
   public aul<InputStream> a(ath $$0, alc $$1) {
      return (aul<InputStream>)v.d($$1.a()).mapOrElse($$2 -> {
         String $$3 = $$1.b();

         for (Path $$4 : this.h.get($$0)) {
            Path $$5 = v.a($$4.resolve($$3), $$2);
            if (Files.exists($$5) && ati.a($$5)) {
               return aul.create($$5);
            }
         }
   ...
   public <T> T a(ats<T> $$0) {
      aul<InputStream> $$1 = this.a("pack.mcmeta");
      if ($$1 != null) {
   ...
   public auw d() {
      return $$0 -> Optional.ofNullable(this.a(ath.a, $$0)).map($$0x -> new aur(this, $$0x));
   }
}
