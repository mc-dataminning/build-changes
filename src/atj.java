...
public class atj extends atd {
   ...
   private final atj.b d;
   private final String e;

   atj(atl $$0, atj.b $$1, String $$2) {
      super($$0);
      this.d = $$1;
      this.e = $$2;
   }

   private static String b(ato $$0, ald $$1) {
   ...
   @Nullable
   private aur<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : aur.create($$1, $$2);
      }
   }
   ...
   public static class a implements auh.c {
      ...
      @Override
      public atm a(atl $$0) {
         atj.b $$1 = new atj.b(this.a);
         return new atj($$0, $$1, "");
      }

      @Override
      public atm a(atl $$0, auh.a $$1) {
         atj.b $$2 = new atj.b(this.a);
         atm $$3 = new atj($$0, $$2, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<atm> $$5 = new ArrayList<>($$4.size());
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  atj.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
