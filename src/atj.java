      ...
      try {
         try {
            while (this.a) {
               ...
               int $$2 = 0;
               int $$3 = ate.b(this.l, 0, $$1);
               if ($$3 != $$1 - 4) {
                  return;
               }

               $$2 += 4;
               int $$4 = ate.b(this.l, $$2, $$1);
               $$2 += 4;
               int $$5 = ate.a(this.l, $$2);
               $$2 += 4;
               switch ($$5) {
                  case 2:
                     if (this.j) {
                        String $$7 = ate.a(this.l, $$2, $$1);
