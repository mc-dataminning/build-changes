...
public class amx {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vq.c("commands.tag.add.failed"));
   private static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(vq.c("commands.tag.remove.failed"));
   ...
   private static int a(du $$0, Collection<? extends bnq> $$1, String $$2) throws CommandSyntaxException {
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> vq.a("commands.tag.add.success.single", $$2, $$1.iterator().next().Q_()), true);
         } else {
            $$0.a(() -> vq.a("commands.tag.add.success.multiple", $$2, $$1.size()), true);
         }
   ...
   private static int b(du $$0, Collection<? extends bnq> $$1, String $$2) throws CommandSyntaxException {
      ...
      if ($$3 == 0) {
         ...
         if ($$1.size() == 1) {
            $$0.a(() -> vq.a("commands.tag.remove.success.single", $$2, $$1.iterator().next().Q_()), true);
         } else {
            $$0.a(() -> vq.a("commands.tag.remove.success.multiple", $$2, $$1.size()), true);
         }
   ...
   private static int a(du $$0, Collection<? extends bnq> $$1) {
      ...
      if ($$1.size() == 1) {
         ...
         if ($$2.isEmpty()) {
            ...
            $$0.a(() -> vq.a("commands.tag.list.single.success", $$4.Q_(), $$2.size(), vt.a($$2)), false);
         }
      } else if ($$2.isEmpty()) {
         $$0.a(() -> vq.a("commands.tag.list.multiple.empty", $$1.size()), false);
      } else {
         $$0.a(() -> vq.a("commands.tag.list.multiple.success", $$1.size(), $$2.size(), vt.a($$2)), false);
      }
