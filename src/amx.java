...
public class amx {
   ...
   private static int a(ew $$0, Collection<GameProfile> $$1, @Nullable xl $$2) throws CommandSyntaxException {
      avx $$3 = $$0.l().ag().f();
      int $$4 = 0;

      for (GameProfile $$5 : $$1) {
         if (!$$3.a($$5)) {
            avy $$6 = new avy($$5, null, $$0.c(), null, $$2 == null ? null : $$2.getString());
            $$3.a($$6);
            $$4++;
            $$0.a(() -> xl.a("commands.ban.success", xl.b($$5.getName()), $$6.d()), true);
            arr $$7 = $$0.l().ag().a($$5.getId());
            if ($$7 != null) {
               $$7.g.a(xl.c("multiplayer.disconnect.banned"));
            }
         }
      }
