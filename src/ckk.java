   ...
   public void a(ard $$0) {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new fbb($$1, this.g.dC() + $$6, $$2);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               fbb $$9 = new fbb(this.g.dA() - this.a.dA(), 0.0, this.g.dG() - this.a.dG()).d();
               fbb $$10 = new fbb((double)ayz.a(this.a.dL() * (float) (Math.PI / 180.0)), 0.0, (double)(-ayz.b(this.a.dL() * (float) (Math.PI / 180.0)))).d();
               float $$11 = (float)$$10.b($$9);
               float $$12 = (float)(Math.acos((double)$$11) * 180.0F / (float)Math.PI);
               $$12 += 0.5F;
               if (this.d >= 5 && $$12 >= 0.0F && $$12 < 10.0F) {
                  double $$13 = 1.0;
                  fbb $$14 = this.a.g(1.0F);
                  ...
                  fbb $$21 = new fbb($$18, $$19, $$20);
                  if (!this.a.bb()) {
                     $$0.a(null, 1017, this.a.dv(), 0);
                  }

                  cpi $$22 = new cpi($$0, this.a, $$21.d());
