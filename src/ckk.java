...
public class ckk {
   ...
   private int g = axz.b(ayg.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(jq.a.fieldOf("uuid").forGetter(Pair::getFirst), axh.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<brh> j;
   @VisibleForTesting
   protected final ArrayList<brh> c;
   private final ckk.a k;
   @VisibleForTesting
   protected final Object2IntMap<brh> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<ckk> a(Predicate<brh> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(ckk::b)).apply($$1, $$1x -> new ckk($$0, $$1x))
      );
   }

   public ckk(Predicate<brh> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new ckk.a(this);
   ...
   public void a(aqh $$0, Predicate<brh> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<brh>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<brh> $$6 = (Entry<brh>)$$5.next();
         int $$7 = $$6.getIntValue();
         brh $$8 = (brh)$$6.getKey();
         brh.c $$9 = $$8.dJ();
   ...
   public int b(@Nullable brh $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bsa> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bsa).map($$0 -> (bsa)$$0);
   }

   @VisibleForTesting
   protected static record a(ckk a) implements Comparator<brh> {
      public int a(brh $$0, brh $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof clh;
               boolean $$7 = $$1 instanceof clh;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
