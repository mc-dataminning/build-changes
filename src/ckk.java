...
public class ckk extends btp implements cjt {
   private static final akj<Integer> bZ = akn.a(ckk.class, akl.b);
   ...
   public ckk(bsy<? extends ckk> $$0, dbw $$1) {
      super($$0, $$1);
      this.cG();
      this.bP = new ckk.d(this);
   }

   @Override
   protected void z() {
      this.bS.a(1, new ckk.b(this));
      this.bS.a(2, new ckk.a(this));
      this.bS.a(3, new ckk.e(this));
      this.bS.a(5, new ckk.c(this));
   ...
   public void a(int $$0, boolean $$1) {
      ...
      this.at();
      this.j_();
      this.f(buv.q).a((double)($$2 * $$2));
      this.f(buv.r).a((double)(0.2F + 0.1F * (float)$$2));
      this.f(buv.c).a((double)$$2);
      if ($$1) {
         this.t(this.eR());
      }
   ...
   @Override
   public bsy<? extends ckk> ak() {
      return (bsy<? extends ckk>)super.ak();
   }
   ...
   protected void j(btn $$0) {
      if (this.bD()) {
         int $$1 = this.gr();
         if (this.g((bss)$$0) < 0.6 * (double)$$1 * 0.6 * (double)$$1 && this.E($$0) && $$0.a(this.dQ().b((btn)this), this.go())) {
   ...
   protected evp a(bss $$0, bsv $$1, float $$2) {
      return new evp(0.0, (double)$$1.b() - 0.015625 * (double)this.gr() * (double)$$2, 0.0);
   }
   ...
   public static boolean c(bsy<ckk> $$0, dbx $$1, btr $$2, iz $$3, azf $$4) {
      if (btr.a($$2)) {
         return a($$0, $$1, $$2, $$3, $$4);
      } else {
         if ($$1.al() != bqp.a) {
            ...
            dbd $$5 = new dbd($$3);
            boolean $$6 = dyr.a($$5.e, $$5.f, ((dcr)$$1).C(), 987234911L).a(10) == 0;
   ...
   static class b extends cal {
      ...
      @Override
      public boolean a() {
         return (this.a.be() || this.a.bs()) && this.a.H() instanceof ckk.d;
      }
   ...
   static class e extends cal {
      ...
      @Override
      public boolean a() {
         return this.a.p() == null && (this.a.aE() || this.a.be() || this.a.bs() || this.a.b(bsc.y)) && this.a.H() instanceof ckk.d;
      }
