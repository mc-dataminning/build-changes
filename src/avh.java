...
public class avh {
   ...
   avh(Writer $$0, List<String> $$1) throws IOException {
      this.c = $$0;
      this.d = $$1.size();
      this.a($$1.stream());
   }

   public static avh.a a() {
      return new avh.a();
   }
   ...
   private void a(Stream<?> $$0) throws IOException {
      this.c.write($$0.<CharSequence>map(avh::a).collect(Collectors.joining(",")) + "\r\n");
   }
   ...
   public static class a {
      ...
      public avh.a a(String $$0) {
         this.a.add($$0);
         return this;
      }

      public avh a(Writer $$0) throws IOException {
         return new avh($$0, this.a);
      }
   }
}
