...
public class avh<T> extends AbstractSet<T> {
   ...
   private avh(int $$0, Comparator<T> $$1) {
      this.b = $$1;
      if ($$0 < 0) {
   ...
   public static <T extends Comparable<T>> avh<T> a(int $$0) {
      return new avh<>($$0, Comparator.naturalOrder());
   }

   public static <T> avh<T> a(Comparator<T> $$0) {
      return a($$0, 10);
   }

   public static <T> avh<T> a(Comparator<T> $$0, int $$1) {
      return new avh<>($$1, $$0);
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof avh<?> $$1 && this.b.equals($$1.b)) {
