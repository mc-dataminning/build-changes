...
public class avh extends avg {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, avh.a> s;
   private final avc t;
   private long u;
   private final alk v;

   private avh(alk $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == avd.c($$2, 7, $$0.getLength());
      }
   }
