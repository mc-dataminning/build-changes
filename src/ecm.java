...
public class ecm {
   ...
   private final dfh o;
   private static final List<dij> p = List.of(dil.l, dil.L, dil.i, dil.b, dil.k, dil.I, dil.K, dil.fl, dil.dP, dil.iA, dil.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean q;
   private final double[] r;
   private final List<List<jq<dgh>>> s;
   private final transient double[][] t;

   private ecm(int $$0, int $$1, Optional<double[]> $$2) {
      this.r = $$2.orElseGet(() -> ae.a(new double[n], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.t = new double[n][];
      ObjectArrayList<List<jq<dgh>>> $$3 = new ObjectArrayList(n);
      $$3.size(n);
      this.s = $$3;
      int $$4 = kj.c($$0);
      int $$5 = kj.c($$1) - $$4;
   ...
   @Nullable
   public static ecm a(@Nullable ecm.d $$0) {
      return $$0 == null ? null : new ecm($$0.a(), $$0.b(), $$0.c());
   }
   ...
   public ecm.d a() {
      ...
      return new ecm.d(this.o.an(), this.o.ao() + 1, $$0 ? Optional.of(DoubleArrays.copy(this.r)) : Optional.empty());
   }

   @Nullable
   public static ecm a(ary $$0, int $$1, int $$2) {
      dxj $$3 = $$0.a($$1, $$2);
      ecm $$4 = $$3.s();
      if ($$4 != null && !$$3.m().d(dyk.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<jn> a(dgd $$0, int $$1, int $$2, boolean $$3) {
   ...
   private void a(int $$0, dxj $$1, int $$2, int $$3) {
      if (this.r[$$0] == Double.MAX_VALUE) {
         this.r[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.t[$$0] = this.a($$1, $$2, $$3, azn.a(this.r[$$0]));
      this.s.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dxj $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(ebj.a.a)) {
         $$3 = Math.min($$0.a(ebj.a.a, $$1, $$2), this.o.al());
      } else {
         $$3 = this.o.al();
      }
   ...
   private static double a(dxj $$0, jh.a $$1) {
      return a($$0, (jh)$$1.c(jm.a)) ? 1.0 : -1.0;
   }

   private static double b(dxj $$0, jh.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dxj $$0, int $$1, int $$2, int $$3) {
   ...
   private List<jq<dgh>> b(dxj $$0, int $$1, int $$2) {
      ObjectArrayList<jq<dgh>> $$3 = new ObjectArrayList(this.d());
      $$3.size(this.d());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + kb.a(this.o.I_());
   ...
   private static boolean a(dxj $$0, jh $$1) {
      dvo $$2 = $$0.a_($$1);
      if ($$2.l()) {
         return false;
      } else if ($$2.a(axd.P)) {
         ...
         return $$2.a(dil.eT) || $$2.a(dil.eU) ? false : !$$2.g($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, ecm.a $$3) {
      if ($$1 >= kb.a(this.o.I_()) && $$1 <= kb.a(this.o.al())) {
         int $$4 = $$1 - kb.a(this.o.I_());

         for (int $$5 = 0; $$5 < this.s.size(); $$5++) {
            if (this.s.get($$5) != null) {
               jq<dgh> $$6 = this.s.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, ecm.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, ecm.b $$4) {
      int $$5 = this.e();
   ...
   protected interface a {
      void consume(int var1, int var2, jq<dgh> var3);
   }
   ...
   public static record d(int b, int c, Optional<double[]> d) {
      ...
      public static final Codec<ecm.d> a = RecordCodecBuilder.create(
            $$0 -> $$0.group(
                     Codec.INT.fieldOf("min_section").forGetter(ecm.d::a),
                     Codec.INT.fieldOf("max_section").forGetter(ecm.d::b),
                     e.lenientOptionalFieldOf("heights").forGetter(ecm.d::c)
                  )
                  .apply($$0, ecm.d::new)
         )
         .validate(ecm.d::a);

      private static DataResult<ecm.d> a(ecm.d $$0) {
         return $$0.d.isPresent() && ((double[])$$0.d.get()).length != ecm.n
            ? DataResult.error(() -> "heights has to be of length " + ecm.n)
