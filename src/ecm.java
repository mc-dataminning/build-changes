...
public class ecm extends ecr {
   public static final Codec<ecm> a = eca.a.fieldOf("provider").xmap(ecm::new, $$0 -> $$0.b).codec();
   private final eca b;
