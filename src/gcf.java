public class gcf extends gcc {
   private final gbx a;
   private static final int b = 8;

   protected gcf(fxv $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gbx $$8) {
   ...
   public static class a implements gbf<lm> {
      ...
      public gbc a(lm $$0, fxv $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gcf($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
