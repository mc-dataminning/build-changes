public class gcf<T extends cje> extends gaz<T> {
   private static final aiy f = new aiy("textures/entity/minecart.png");
   protected final fmi<T> a;
   private final fwn g;

   public gcf(gba.a $$0, fph $$1) {
      super($$0);
      this.d = 0.7F;
      this.a = new fnd<>($$0.a($$1));
      this.g = $$0.c();
   }
   ...
   public void a(T $$0, float $$1, float $$2, esh $$3, fvt $$4, int $$5) {
      ...
      $$3.a($$7, $$8, $$9);
      double $$10 = awi.d((double)$$2, $$0.ab, $$0.dr());
      double $$11 = awi.d((double)$$2, $$0.ac, $$0.dt());
      double $$12 = awi.d((double)$$2, $$0.ad, $$0.dx());
      double $$13 = 0.3F;
      enz $$14 = $$0.q($$10, $$11, $$12);
      float $$15 = awi.i($$2, $$0.N, $$0.dE());
      if ($$14 != null) {
         enz $$16 = $$0.a($$10, $$11, $$12, 0.3F);
         enz $$17 = $$0.a($$10, $$11, $$12, -0.3F);
         if ($$16 == null) {
            $$16 = $$14;
         }
      ...
      if ($$19 > 0.0F) {
         $$3.a(a.b.rotationDegrees(awi.a($$19) * $$19 * $$20 / 10.0F * (float)$$0.P()));
      }
      ...
      esl $$24 = $$4.getBuffer(this.a.a(this.a($$0)));
      this.a.a($$3, $$24, $$5, ggs.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$3.b();
   }
   ...
   protected void a(T $$0, float $$1, dlj $$2, esh $$3, fvt $$4, int $$5) {
      this.g.a($$2, $$3, $$4, $$5, ggs.d);
   }
}
