...
public class gcf extends gda<haj> {
   private final ggc[] a;
   private final ggc b;
   ...
   public static ggi a() {
      ggk $$0 = new ggk();
      ggm $$1 = $$0.a();
      $$1.a("head", ggh.c().a(0, 0).a(-4.0F, -4.0F, -4.0F, 8.0F, 8.0F, 8.0F), gge.a);
      float $$2 = 0.0F;
      ggh $$3 = ggh.c().a(0, 16).a(0.0F, 0.0F, 0.0F, 2.0F, 8.0F, 2.0F);

      for (int $$4 = 0; $$4 < 4; $$4++) {
         float $$5 = ayz.b($$2) * 9.0F;
         float $$6 = -2.0F + ayz.b((float)($$4 * 2) * 0.25F);
         float $$7 = ayz.a($$2) * 9.0F;
         $$1.a(a($$4), $$3, gge.a($$5, $$6, $$7));
         $$2++;
      }
