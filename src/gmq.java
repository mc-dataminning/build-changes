...
public class gmq {
   ...
   static final ThreadLocal<gmq.d> f = ThreadLocal.withInitial(gmq.d::new);

   public gmq(fni $$0) {
      this.d = $$0;
   }

   public void a(dgk $$0, hdn $$1, dxv $$2, jh $$3, fgs $$4, fgw $$5, boolean $$6, bam $$7, long $$8, int $$9) {
   ...
   public void b(dgk $$0, hdn $$1, dxv $$2, jh $$3, fgs $$4, fgw $$5, boolean $$6, bam $$7, long $$8, int $$9) {
      ...
      for (jm $$14 : c) {
         $$7.b($$8);
         List<gms> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || dkm.a($$2, $$0.a_($$13), $$14)) {
      ...
      $$7.b($$8);
      List<gms> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(dgk $$0, hdn $$1, dxv $$2, jh $$3, fgs $$4, fgw $$5, boolean $$6, bam $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      jh.a $$11 = $$3.k();

      for (jm $$12 : c) {
         $$7.b($$8);
         List<gms> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || dkm.a($$2, $$0.a_($$11), $$12)) {
               int $$14 = glh.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<gms> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(dgk $$0, dxv $$1, jh $$2, fgs $$3, fgw $$4, List<gms> $$5, float[] $$6, BitSet $$7, gmq.b $$8, int $$9) {
      for (gms $$10 : $$5) {
   ...
   private void a(
      dgk $$0, dxv $$1, jh $$2, fgw $$3, fgs.a $$4, gms $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(dgk $$0, dxv $$1, jh $$2, int[] $$3, jm $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(dgk $$0, dxv $$1, jh $$2, int $$3, int $$4, boolean $$5, fgs $$6, fgw $$7, List<gms> $$8, BitSet $$9) {
      for (gms $$10 : $$8) {
         if ($$5) {
   ...
   public void a(fgs.a $$0, fgw $$1, @Nullable dxv $$2, hdn $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      bam $$9 = bam.a();
      long $$10 = 42L;
   ...
   private static void a(fgs.a $$0, fgw $$1, float $$2, float $$3, float $$4, List<gms> $$5, int $$6, int $$7) {
      for (gms $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new gmq.e[]{gmq.e.k, gmq.e.d, gmq.e.k, gmq.e.j, gmq.e.e, gmq.e.j, gmq.e.e, gmq.e.d},
         new gmq.e[]{gmq.e.k, gmq.e.c, gmq.e.k, gmq.e.i, gmq.e.e, gmq.e.i, gmq.e.e, gmq.e.c},
         new gmq.e[]{gmq.e.l, gmq.e.c, gmq.e.l, gmq.e.i, gmq.e.f, gmq.e.i, gmq.e.f, gmq.e.c},
         new gmq.e[]{gmq.e.l, gmq.e.d, gmq.e.l, gmq.e.j, gmq.e.f, gmq.e.j, gmq.e.f, gmq.e.d}
      ),
      b(
         new jm[]{jm.f, jm.e, jm.c, jm.d},
         1.0F,
         true,
         new gmq.e[]{gmq.e.f, gmq.e.d, gmq.e.f, gmq.e.j, gmq.e.l, gmq.e.j, gmq.e.l, gmq.e.d},
         new gmq.e[]{gmq.e.f, gmq.e.c, gmq.e.f, gmq.e.i, gmq.e.l, gmq.e.i, gmq.e.l, gmq.e.c},
         new gmq.e[]{gmq.e.e, gmq.e.c, gmq.e.e, gmq.e.i, gmq.e.k, gmq.e.i, gmq.e.k, gmq.e.c},
         new gmq.e[]{gmq.e.e, gmq.e.d, gmq.e.e, gmq.e.j, gmq.e.k, gmq.e.j, gmq.e.k, gmq.e.d}
      ),
      c(
         new jm[]{jm.b, jm.a, jm.f, jm.e},
         0.8F,
         true,
         new gmq.e[]{gmq.e.b, gmq.e.k, gmq.e.b, gmq.e.e, gmq.e.h, gmq.e.e, gmq.e.h, gmq.e.k},
         new gmq.e[]{gmq.e.b, gmq.e.l, gmq.e.b, gmq.e.f, gmq.e.h, gmq.e.f, gmq.e.h, gmq.e.l},
         new gmq.e[]{gmq.e.a, gmq.e.l, gmq.e.a, gmq.e.f, gmq.e.g, gmq.e.f, gmq.e.g, gmq.e.l},
         new gmq.e[]{gmq.e.a, gmq.e.k, gmq.e.a, gmq.e.e, gmq.e.g, gmq.e.e, gmq.e.g, gmq.e.k}
      ),
      d(
         new jm[]{jm.e, jm.f, jm.a, jm.b},
         0.8F,
         true,
         new gmq.e[]{gmq.e.b, gmq.e.k, gmq.e.h, gmq.e.k, gmq.e.h, gmq.e.e, gmq.e.b, gmq.e.e},
         new gmq.e[]{gmq.e.a, gmq.e.k, gmq.e.g, gmq.e.k, gmq.e.g, gmq.e.e, gmq.e.a, gmq.e.e},
         new gmq.e[]{gmq.e.a, gmq.e.l, gmq.e.g, gmq.e.l, gmq.e.g, gmq.e.f, gmq.e.a, gmq.e.f},
         new gmq.e[]{gmq.e.b, gmq.e.l, gmq.e.h, gmq.e.l, gmq.e.h, gmq.e.f, gmq.e.b, gmq.e.f}
      ),
      e(
         new jm[]{jm.b, jm.a, jm.c, jm.d},
         0.6F,
         true,
         new gmq.e[]{gmq.e.b, gmq.e.d, gmq.e.b, gmq.e.j, gmq.e.h, gmq.e.j, gmq.e.h, gmq.e.d},
         new gmq.e[]{gmq.e.b, gmq.e.c, gmq.e.b, gmq.e.i, gmq.e.h, gmq.e.i, gmq.e.h, gmq.e.c},
         new gmq.e[]{gmq.e.a, gmq.e.c, gmq.e.a, gmq.e.i, gmq.e.g, gmq.e.i, gmq.e.g, gmq.e.c},
         new gmq.e[]{gmq.e.a, gmq.e.d, gmq.e.a, gmq.e.j, gmq.e.g, gmq.e.j, gmq.e.g, gmq.e.d}
      ),
      f(
         new jm[]{jm.a, jm.b, jm.c, jm.d},
         0.6F,
         true,
         new gmq.e[]{gmq.e.g, gmq.e.d, gmq.e.g, gmq.e.j, gmq.e.a, gmq.e.j, gmq.e.a, gmq.e.d},
         new gmq.e[]{gmq.e.g, gmq.e.c, gmq.e.g, gmq.e.i, gmq.e.a, gmq.e.i, gmq.e.a, gmq.e.c},
         new gmq.e[]{gmq.e.h, gmq.e.c, gmq.e.h, gmq.e.i, gmq.e.b, gmq.e.i, gmq.e.b, gmq.e.c},
         new gmq.e[]{gmq.e.h, gmq.e.d, gmq.e.h, gmq.e.j, gmq.e.b, gmq.e.j, gmq.e.b, gmq.e.d}
      );
      ...
      final gmq.e[] k;
      final gmq.e[] l;
      private static final gmq.a[] m = ae.a(new gmq.a[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
      ...
      private a(final jm[] $$0, final float $$1, final boolean $$2, final gmq.e[] $$3, final gmq.e[] $$4, final gmq.e[] $$5, final gmq.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(dgk $$0, dxv $$1, jh $$2, jm $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dxv $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.k($$0, $$9) || $$23.g() == 0;
         dxv $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.k($$0, $$9) || $$25.g() == 0;
         dxv $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.k($$0, $$9) || $$27.g() == 0;
         dxv $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final gmq.c[] k = ae.a(new gmq.c[6], $$0 -> {
         $$0[jm.a.d()] = a;
         $$0[jm.b.d()] = b;
         $$0[jm.c.d()] = c;
         $$0[jm.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dxv $$0, dgk $$1, jh $$2) {
         long $$3 = $$2.a();
         if (this.a) {
