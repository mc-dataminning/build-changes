public class gmq extends goi {
   ...
   protected gmq(gjz $$0, double $$1, double $$2, double $$3, god $$4, float $$5, float $$6, boolean $$7, boolean $$8, float $$9, float $$10) {
      super($$0, $$1, $$2, $$3);
   ...
   public static class a implements gnl<mb> {
      ...
      public gni a(mb $$0, gjz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gmq($$1, $$2, $$3, $$4, this.a, 0.25F, 2.0F, false, true, 1.0F, 0.0F);
      }
   }
   ...
   public static class b implements gnl<mb> {
      ...
      public gni a(mb $$0, gjz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gmq($$1, $$2, $$3, $$4, this.a, 0.07F, 10.0F, true, false, 2.0F, 0.021F);
      }
   }

   public static class c implements gnl<lq> {
      private final god a;
      ...
      public gni a(lq $$0, gjz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gni $$8 = new gmq($$1, $$2, $$3, $$4, this.a, 0.07F, 10.0F, true, false, 2.0F, 0.021F);
         $$8.a($$0.b(), $$0.c(), $$0.d());
         return $$8;
      }
   }
