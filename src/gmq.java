...
public class gmq implements gmx.a {
   ...
   private final fjx w;
   private final Map<jh, gmq.a> x = new HashMap<>();
   private final Map<UUID, aar.a> y = new HashMap<>();
   @Nullable
   private UUID z;
   ...
   public void a(abc.a $$0, long $$1) {
      this.x.put($$0.a(), new gmq.a($$0, $$1));
   }
   ...
   private void b(fek $$0, gix $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(agu::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gmx.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(agu::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(fek $$0, gix $$1, jh $$2) {
      float $$3 = 0.05F;
      gmx.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(fek $$0, gix $$1, jh $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gmx.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(fek $$0, gix $$1, abc.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(fek $$0, gix $$1, aar.a $$2) {
      if ($$2.e() != null) {
         gng.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(fek $$0, gix $$1, aar.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(fek $$0, gix $$1, String $$2, abc.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(fek $$0, gix $$1, String $$2, jh $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      gmx.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(fek $$0, gix $$1, ka $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      jh $$9 = jh.a($$2);
      ...
      float $$13 = 0.5F;
      gmx.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(abc.a $$0) {
      return this.a($$0.a()).stream().map(agu::a).collect(Collectors.toSet());
   }

   private String a(aar.a $$0, jh $$1) {
      double $$2 = Math.sqrt($$1.b($$0.d()));
      double $$3 = (double)Math.round($$2 * 10.0) / 10.0;
      return $$1.x() + " (dist " + $$3 + ")";
   }

   private boolean b(aar.a $$0) {
      return Objects.equals(this.z, $$0.b());
   }

   private boolean c(aar.a $$0) {
      cor $$1 = this.w.t;
      jh $$2 = jh.a($$1.dD(), $$0.d().b(), $$1.dJ());
      jh $$3 = jh.a((ka)$$0.d());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> a(jh $$0) {
      return this.y.values().stream().filter($$1 -> $$1.a($$0)).map(aar.a::b).collect(Collectors.toSet());
   }

   private Map<jh, List<String>> f() {
      Map<jh, List<String>> $$0 = Maps.newHashMap();

      for (aar.a $$1 : this.y.values()) {
   ...
   private void g() {
      gmx.a(this.w.ao(), 8).ifPresent($$0 -> this.z = $$0.cI());
   }

   static record a(abc.a a, long b) {
   }
}
