...
public class xj {
   public static final Codec<xh> a = Codec.recursive("Component", xj::a);
   public static final zf<ws, xh> b = zd.d(a);
   public static final zf<ws, Optional<xh>> c = b.a(zd::a);
   public static final zf<ws, xh> d = zd.c(a);
   public static final zf<ws, Optional<xh>> e = d.a(zd::a);
   public static final zf<ByteBuf, xh> f = zd.a(a);
   public static final Codec<xh> g = a(Integer.MAX_VALUE);

   public static Codec<xh> a(int $$0) {
      final Codec<String> $$1 = Codec.string(0, $$0);
      return new Codec<xh>() {
         public <T> DataResult<Pair<xh, T>> decode(DynamicOps<T> $$0, T $$1x) {
            DynamicOps<JsonElement> $$2 = a($$0);
            return $$1.decode($$0, $$1).flatMap($$1xxx -> {
               try {
                  JsonElement $$2x = JsonParser.parseString((String)$$1xxx.getFirst());
                  return xj.a.parse($$2, $$2x).map($$1xxxxx -> Pair.of($$1xxxxx, $$1xxx.getSecond()));
         ...
         public <T> DataResult<T> a(xh $$0, DynamicOps<T> $$1x, T $$2) {
            DynamicOps<JsonElement> $$3 = a($$1);
            return xj.a.encodeStart($$3, $$0).flatMap($$2x -> {
               try {
                  return $$1.encodeStart($$1, ayz.e($$2x));
         ...
         private static <T> DynamicOps<JsonElement> a(DynamicOps<T> $$0) {
            return (DynamicOps<JsonElement>)($$0 instanceof alf<T> $$1 ? $$1.a(JsonOps.INSTANCE) : JsonOps.INSTANCE);
         }
      };
   }

   private static xv a(List<xh> $$0) {
      xv $$1 = $$0.get(0).f();
   ...
   public static <T extends baf, E> MapCodec<E> a(T[] $$0, Function<T, MapCodec<? extends E>> $$1, Function<E, T> $$2, String $$3) {
      MapCodec<E> $$4 = new xj.a<>(Stream.<T>of($$0).map($$1).toList(), $$2x -> (MapEncoder<? extends E>)$$1.apply($$2.apply((E)$$2x)));
      Codec<T> $$5 = baf.b((Supplier<T[]>)(() -> $$0));
      MapCodec<E> $$6 = $$5.dispatchMap($$3, $$2, $$1);
      MapCodec<E> $$7 = new xj.b($$3, $$6, $$4);
      return ays.a($$7, $$6);
   }

   private static Codec<xh> a(Codec<xh> $$0) {
      xi.a<?>[] $$1 = new xi.a[]{yo.b, ys.c, yl.b, yp.c, yq.b, yn.b};
      MapCodec<xi> $$2 = a($$1, xi.a::a, xi::a, "type");
      Codec<xh> $$3 = RecordCodecBuilder.create(
         $$2x -> $$2x.group($$2.forGetter(xh::b), ays.a($$0.listOf()).optionalFieldOf("extra", List.of()).forGetter(xh::c), ye.b.a.forGetter(xh::a))
               .apply($$2x, xv::new)
      );
      return Codec.either(Codec.either(Codec.STRING, ays.a($$0.listOf())), $$3)
         .xmap($$0x -> (xh)$$0x.map($$0xx -> (xh)$$0xx.map(xh::b, xj::a), $$0xx -> $$0xx), $$0x -> {
            String $$1x = $$0x.d();
