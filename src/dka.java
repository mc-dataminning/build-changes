...
public class dka extends ddy {
   public static final MapCodec<dka> a = b(dka::new);
   public static final drz<dsg> b = drr.ab;
   public static final drz<dsg> c = drr.aa;
   public static final drz<dsg> d = drr.ac;
   public static final drz<dsg> e = drr.ad;
   public static final dsb f = drr.aT;
   public static final Map<it, drz<dsg>> g = Maps.newEnumMap(ImmutableMap.of(it.c, b, it.f, c, it.d, d, it.e, e));
   protected static final int h = 1;
   protected static final int i = 3;
   protected static final int j = 13;
   protected static final int k = 3;
   protected static final int l = 13;
   private static final evd m = ddy.a(3.0, 0.0, 3.0, 13.0, 1.0, 13.0);
   private static final Map<it, evd> n = Maps.newEnumMap(
      ImmutableMap.of(
         it.c,
         ddy.a(3.0, 0.0, 0.0, 13.0, 1.0, 13.0),
         it.d,
         ddy.a(3.0, 0.0, 3.0, 13.0, 1.0, 16.0),
         it.f,
         ddy.a(3.0, 0.0, 3.0, 16.0, 1.0, 13.0),
         it.e,
         ddy.a(0.0, 0.0, 3.0, 13.0, 1.0, 13.0)
      )
   );
   private static final Map<it, evd> o = Maps.newEnumMap(
      ImmutableMap.of(
         it.c,
         eva.a(n.get(it.c), ddy.a(3.0, 0.0, 0.0, 13.0, 16.0, 1.0)),
         it.d,
         eva.a(n.get(it.d), ddy.a(3.0, 0.0, 15.0, 13.0, 16.0, 16.0)),
         it.f,
         eva.a(n.get(it.f), ddy.a(15.0, 0.0, 3.0, 16.0, 16.0, 13.0)),
         it.e,
         eva.a(n.get(it.e), ddy.a(0.0, 0.0, 3.0, 1.0, 16.0, 13.0))
      )
   );
   private static final Map<drb, evd> F = Maps.newHashMap();
   private static final euk[] G = ac.a(new euk[16], $$0 -> {
      for (int $$1 = 0; $$1 <= 15; $$1++) {
         float $$2 = (float)$$1 / 15.0F;
         float $$3 = $$2 * 0.6F + ($$2 > 0.0F ? 0.4F : 0.3F);
         float $$4 = ayd.a($$2 * $$2 * 0.7F - 0.5F, 0.0F, 1.0F);
         float $$5 = ayd.a($$2 * $$2 * 0.6F - 0.7F, 0.0F, 1.0F);
         $$0[$$1] = new euk((double)$$3, (double)$$4, (double)$$5);
      }
   });
   ...
   public dka(dra.d $$0) {
      super($$0);
      this.k(this.E.b().a(b, dsg.c).a(c, dsg.c).a(d, dsg.c).a(e, dsg.c).a(f, Integer.valueOf(0)));
      this.I = this.n().a(b, dsg.b).a(c, dsg.b).a(d, dsg.b).a(e, dsg.b);
   ...
   private drb a(dad $$0, drb $$1, io $$2) {
      boolean $$3 = p($$1);
   ...
   private drb b(dad $$0, drb $$1, io $$2) {
      boolean $$3 = !$$0.a_($$2.c()).g($$0, $$2);

      for (it $$4 : it.c.a) {
         if (!$$1.c(g.get($$4)).a()) {
            dsg $$5 = this.a($$0, $$2, $$4, $$3);
            $$1 = $$1.a(g.get($$4), $$5);
         }
      }
   ...
   protected void a(drb $$0, day $$1, io $$2, int $$3, int $$4) {
      ...
      for (it $$6 : it.c.a) {
         dsg $$7 = $$0.c(g.get($$6));
         if ($$7 != dsg.c && !$$1.a_($$5.a($$2, $$6)).a(this)) {
            $$5.c(it.a);
            drb $$8 = $$1.a_($$5);
            if ($$8.a(this)) {
               io $$9 = $$5.a($$6.g());
   ...
   private dsg a(dad $$0, io $$1, it $$2) {
      return this.a($$0, $$1, $$2, !$$0.a_($$1.c()).g($$0, $$1));
   }

   private dsg a(dad $$0, io $$1, it $$2, boolean $$3) {
      io $$4 = $$1.a($$2);
      drb $$5 = $$0.a_($$4);
      if ($$3) {
         boolean $$6 = $$5.b() instanceof dml || this.a($$0, $$4, $$5);
         if ($$6 && m($$0.a_($$4.c()))) {
            if ($$5.d($$0, $$4, $$2.g())) {
               return dsg.a;
            }
      ...
      return !a($$5, $$2) && ($$5.g($$0, $$4) || !m($$0.a_($$4.d()))) ? dsg.c : dsg.b;
   }
   ...
   private boolean a(dad $$0, io $$1, drb $$2) {
      return $$2.d($$0, $$1, it.b) || $$2.a(dea.hc);
   }
   ...
   protected static boolean m(drb $$0) {
      return a($$0, null);
   }

   protected static boolean a(drb $$0, @Nullable it $$1) {
      if ($$0.a(dea.cw)) {
         return true;
      } else if ($$0.a(dea.eh)) {
         it $$2 = $$0.c(dkf.aE);
         ...
         return $$0.a(dea.kO) ? $$1 == $$0.c(djj.a) : $$0.m() && $$1 != null;
      }
   }
   ...
   public static int b(int $$0) {
      euk $$1 = G[$$0];
      return ayd.f((float)$$1.a(), (float)$$1.b(), (float)$$1.c());
   }

   private void a(dax $$0, ayk $$1, io $$2, euk $$3, it $$4, it $$5, float $$6, float $$7) {
      float $$8 = $$7 - $$6;
      if (!($$1.i() >= 0.2F * $$8)) {
         float $$9 = 0.4375F;
         float $$10 = $$6 + $$8 * $$1.i();
   ...
   private void a(dax $$0, io $$1, drb $$2, drb $$3) {
      for (it $$4 : it.c.a) {
         io $$5 = $$1.a($$4);
