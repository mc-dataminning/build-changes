...
public class dka extends dkd<Integer> {
   private final ImmutableSet<Integer> a;
   private final int b;
   private final int c;

   protected dka(String $$0, int $$1, int $$2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof dka $$1 && super.equals($$0)) {
   ...
   public static dka a(String $$0, int $$1, int $$2) {
      return new dka($$0, $$1, $$2);
   }
