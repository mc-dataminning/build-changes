...
public class dka {
   ...
   private final dka.a e;
   private final long f;

   public dka(dka.a $$0, long $$1) {
      this.e = $$0;
      this.f = $$1;
   }
   ...
   public dka a(dka.a $$0) {
      return new dka($$0, this.f);
   }

   public je<djy> a(iu $$0) {
      int $$1 = $$0.u() - 2;
      int $$2 = $$0.v() - 2;
      int $$3 = $$0.w() - 2;
      int $$4 = $$1 >> 2;
   ...
   public je<djy> a(double $$0, double $$1, double $$2) {
      int $$3 = jp.a(azm.a($$0));
      int $$4 = jp.a(azm.a($$1));
      int $$5 = jp.a(azm.a($$2));
      return this.a($$3, $$4, $$5);
   ...
   public interface a {
      je<djy> getNoiseBiome(int var1, int var2, int var3);
   }
}
