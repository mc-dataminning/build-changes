...
public class eeb<T> implements eed<T> {
   ...
   private eeb(jl<T> $$0, int $$1, eee<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private eeb(jl<T> $$0, T[] $$1, eee<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public eed<T> a(eee<T> $$0) {
      return new eeb<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
