...
public class eeb {
   private static final dxo a = dkf.hG.m();
   private static final dxo b = dkf.hH.m();
   private static final dxo c = dkf.iY.m();
   private static final dxo d = dkf.hK.m();
   private static final dxo e = dkf.hS.m();
   private static final dxo f = dkf.hU.m();
   private static final dxo g = dkf.hO.m();
   private static final dxo h = dkf.ja.m();
   private static final dxo i = dkf.ec.m();
   private final dxo j;
   private final int k;
   private final dxo[] l;
   private final est m;
   ...
   public eeb(edx $$0, dxo $$1, int $$2, edw $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(eds.P);
      this.l = a($$3.a(alp.b("clay_bands")));
      this.u = $$0.a(eds.N);
      this.v = $$0.a(eds.O);
      this.n = $$0.a(eds.Q);
      this.o = $$0.a(eds.R);
   ...
   public void a(edx $$0, did $$1, kd<dib> $$2, boolean $$3, eeg $$4, final dzj $$5, edn $$6, eea.o $$7) {
      ...
      eea.g $$13 = new eea.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      eea.u $$14 = $$7.apply($$13);
      jh.a $$15 = new jh.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(edj.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            jq<dib> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dii.C)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(edj.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<dxo> a(eea.o $$0, efk $$1, Function<jh, jq<dib>> $$2, dzj $$3, edn $$4, jh $$5, boolean $$6) {
      eea.g $$7 = new eea.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().e(mb.aI), $$1);
      eea.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dxo $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dzg $$0, int $$1, int $$2, int $$3, dhb $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dib $$1, dzg $$2, jh.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).l() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dkf.J) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(bac $$0, dxo[] $$1, int $$2, dxo $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dxo a(int $$0, int $$1, int $$2) {
