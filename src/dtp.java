...
public class dtp extends dua implements bso {
   ...
   public dtp(ji $$0, dwy $$1) {
      this($$0, $$1, ((die)$$1.b()).b());
   }

   public dtp(ji $$0, dwy $$1, cvn $$2) {
      super(duc.u, $$0, $$1);
      this.e = $$2;
   }
   ...
   protected void b(tq $$0, jt.a $$1) {
      ...
      if (!this.f.equals(dtr.a)) {
         $$0.a("patterns", (un)dtr.b.encodeStart($$1.a(ue.a), this.f).getOrThrow());
      }
