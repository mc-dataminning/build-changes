public class fdx extends ffh<bwb> implements fdz {
   private final fhx a;
   private final fhx b;
   private final fhx f;
   private final fhx g;
   ...
   public void a(bwb $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      this.a().e().forEach(fhx::c);
      float $$6 = $$3 * 20.0F * (float) (Math.PI / 180.0) + $$1;
      float $$7 = asb.b($$6) * (float) Math.PI * 0.15F + $$2;
      ...
      if ($$0.ge()) {
         ...
         float $$14 = asb.b($$13) * 16.0F * (float) (Math.PI / 180.0);
         float $$15 = $$0.F($$8);
         float $$16 = asb.b($$13) * 14.0F * (float) (Math.PI / 180.0);
         float $$17 = asb.b($$13) * 30.0F * (float) (Math.PI / 180.0);
      ...
      float $$18 = $$12 * asb.i($$10, (float) (-Math.PI / 3), -1.134464F);
      this.a.c = this.a.c + (float)Math.cos((double)$$9) * 0.25F * $$11;
      this.g.e = $$18;
      this.h.e = $$18;
      float $$19 = $$11 * (1.0F - $$12);
      float $$20 = 0.43633232F - asb.b($$9 + (float) (Math.PI * 3.0 / 2.0)) * (float) Math.PI * 0.075F * $$19;
      this.h.g = -$$20;
      this.g.g = $$20;
