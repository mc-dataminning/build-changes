...
public class fdx extends gvs {
   ...
   public void aP_() {
      int $$0 = this.m / 4 - 2;
      this.c(fhs.a(wu.c("mco.terms.buttons.agree"), $$0x -> this.E()).a(this.m / 4, g(12), $$0, 20).a());
      this.c(fhs.a(wu.c("mco.terms.buttons.disagree"), $$0x -> this.l.a(this.B)).a(this.m / 2 + 4, g(12), $$0, 20).a());
   }
   ...
   private void E() {
      ...
      try {
         $$0.j();
         this.l.a(new fdj(this.B, new fes(this.B, this.C)));
      } catch (fcp var3) {
