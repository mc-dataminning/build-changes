...
public class fdx {
   ...
   private static final Map<dur.a, String> e = ac.a(new EnumMap<>(dur.a.class), $$0 -> {
      $$0.put(dur.a.a, "SW");
      $$0.put(dur.a.b, "S");
      $$0.put(dur.a.c, "OW");
      $$0.put(dur.a.d, "O");
   ...
   private drf l;
   @Nullable
   private CompletableFuture<drf> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final bju r = new bju(1);
   private final bju s = new bju(bjz.values().length);
   private final bju t = new bju(1);
   private final bju u = new bju(1);
   private final Map<bjv, bju> v = Map.of(bjv.a, this.s);
   private final ffg w;
   private final ffi x;
   private final ffh y;
   private final fff z;
   ...
   public fdx(fbp $$0) {
      ...
      this.g = new fdx.a();
      this.h = $$0.h;
      this.w = new ffg(this.h, this.r);
      this.x = new ffi(this.h, this.s, () -> $$0.r.s().g());
      this.y = new ffh(this.h, this.t);
      this.z = new fff(this.h, this.u);
   }
   ...
   private void a(fdc $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.ax()) {
         ...
         cyx $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof aps ? ((aps)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, axk.g($$15.dC()), axk.g($$15.dE())));
         drf $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(czg.a, $$14);
            int $$30 = this.f.r.a(czg.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            drf $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dur.a $$33 : dur.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.al()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.ap();
                  long $$36 = $$31.u();
                  bny $$37 = new bny($$23.ak(), $$23.Z(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            czi.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<bqr> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(bqr.values())
   ...
   private static String a(il<czw> $$0) {
   ...
   private cyx r() {
      return (cyx)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.ae()))), this.f.r);
   }
   ...
   private drf s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dru.n, false).thenApply($$0x -> (drf)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", evb.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", fbp.Q().aO().k(), fbp.Q().aO().l(), evb.a()),
            evb.c(),
            evb.d()
         }
      );
      if (this.f.ax()) {
         ...
         if (this.i.c() == ery.a.b) {
            ...
            $$4.add(String.valueOf(kr.e.b($$6.b())));

            for (Entry<dqc<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == ery.a.b) {
            ...
            $$4.add(String.valueOf(kr.c.b($$9.a())));

            for (Entry<dqc<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
         ...
         if ($$11 != null) {
            ...
            $$4.add(String.valueOf(kr.g.b($$11.ai())));
         }
   ...
   private String a(Entry<dqc<?>, Comparable<?>> $$0) {
      dqc<?> $$1 = $$0.getKey();
