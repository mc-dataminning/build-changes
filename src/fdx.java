...
public abstract class fdx<T extends fdx<T>> {
   ...
   public fdx(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fdv.a();
         if ($$3 != null) {
         ...
         throw new ffe(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new ffe(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new ffe(var2.getMessage(), var2);
      }
   }
   ...
   public static fdx<?> a(String $$0) {
      return new fdx.b($$0, 5000, 60000);
   }

   public static fdx<?> a(String $$0, int $$1, int $$2) {
      return new fdx.b($$0, $$1, $$2);
   }

   public static fdx<?> b(String $$0, String $$1) {
      return new fdx.c($$0, $$1, 5000, 60000);
   }

   public static fdx<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fdx.c($$0, $$1, $$2, $$3);
   }

   public static fdx<?> b(String $$0) {
      return new fdx.a($$0, 5000, 60000);
   }

   public static fdx<?> c(String $$0, String $$1) {
      return new fdx.d($$0, $$1, 5000, 60000);
   }

   public static fdx<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fdx.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fdx<fdx.a> {
   ...
   public static class b extends fdx<fdx.b> {
   ...
   public static class c extends fdx<fdx.c> {
      ...
      public fdx.c f() {
         try {
            ...
            throw new ffe(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fdx<fdx.d> {
      private final String c;
