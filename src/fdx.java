...
public class fdx {
   public static List<fex> a(fdx.a... $$0) {
      for (fdx.a $$1 : $$0) {
         a($$1.j);
      }

      List<fex> $$2 = Lists.newArrayList();

      for (fdx.a $$3 : $$0) {
         $$2.add(new fex($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fex::a));
      return $$2;
   }
   ...
   public static List<fex> a() {
      return a(fdx.a.values());
   }
