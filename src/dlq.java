...
public class dlq {
   ...
   private static final int j = hs.a(16);
   ...
   private final cps p;
   private static final List<csq> q = List.of(csr.l, csr.L, csr.i, csr.b, csr.k, csr.I, csr.K, csr.fl, csr.dP, csr.iA, csr.j);
   protected static final double d = Double.MAX_VALUE;
   private boolean r;
   private final double[] s;
   private final List<List<hg<cqo>>> t;
   ...
   public static final Codec<dlq> e = RecordCodecBuilder.create(
         $$0 -> $$0.group(
      ...
      .comapFlatMap(dlq::a, Function.identity());

   private static DataResult<dlq> a(dlq $$0) {
      return $$0.s.length != o ? DataResult.error(() -> "heights has to be of length " + o) : DataResult.success($$0);
   }

   private dlq(int $$0, int $$1, Optional<double[]> $$2) {
      this.s = $$2.orElse(ac.a(new double[o], $$0x -> Arrays.fill($$0x, Double.MAX_VALUE)));
      this.u = new double[o][];
      ObjectArrayList<List<hg<cqo>>> $$3 = new ObjectArrayList(o);
      $$3.size(o);
      this.t = $$3;
      int $$4 = hz.c($$0);
      int $$5 = hz.c($$1) - $$4;
   ...
   @Nullable
   public static dlq a(aku $$0, int $$1, int $$2) {
      dha $$3 = $$0.a($$1, $$2);
      dlq $$4 = $$3.t();
      if ($$4 != null && $$3.k().b(dhf.f)) {
         $$4.a($$3, a($$0, $$1, $$2, false));
         return $$4;
      } else {
         return null;
   ...
   public static Set<hd> a(cqk $$0, int $$1, int $$2, boolean $$3) {
      Set<hd> $$4 = EnumSet.noneOf(hd.class);
   ...
   private void a(dha $$0, Set<hd> $$1) {
      if (!this.r) {
         if ($$1.contains(hd.a) || $$1.contains(hd.g) || $$1.contains(hd.h)) {
            this.a(a(0, 0), $$0, 0, 0);
         }
         ...
         if ($$1.contains(hd.c) && $$1.contains(hd.b)) {
            this.a(b(l, 0), $$0, 15, 0);
         }

         if ($$1.contains(hd.c) && $$1.contains(hd.e) && $$1.contains(hd.d)) {
   ...
   private void a(int $$0, dha $$1, int $$2, int $$3) {
      if (this.s[$$0] == Double.MAX_VALUE) {
         this.s[$$0] = (double)this.a($$1, $$2, $$3);
      }

      this.u[$$0] = this.a($$1, $$2, $$3, ars.a(this.s[$$0]));
      this.t.set($$0, this.b($$1, $$2, $$3));
   }

   private int a(dha $$0, int $$1, int $$2) {
      int $$3;
      if ($$0.b(dkn.a.a)) {
         $$3 = Math.min($$0.a(dkn.a.a, $$1, $$2) + 1, this.p.aj());
      } else {
         $$3 = this.p.aj();
      }
   ...
   private static double a(dha $$0, gw.a $$1) {
      return a($$0, (gw)$$1.c(hc.a)) ? 1.0 : -1.0;
   }

   private static double b(dha $$0, gw.a $$1) {
      double $$2 = 0.0;
   ...
   private double[] a(dha $$0, int $$1, int $$2, int $$3) {
   ...
   private List<hg<cqo>> b(dha $$0, int $$1, int $$2) {
      ObjectArrayList<hg<cqo>> $$3 = new ObjectArrayList(this.c());
      $$3.size(this.c());

      for (int $$4 = 0; $$4 < $$3.size(); $$4++) {
         int $$5 = $$4 + hs.a(this.p.C_());
         $$3.set($$4, $$0.getNoiseBiome(hs.a($$1), $$5, hs.a($$2)));
      }

      return $$3;
   }

   private static boolean a(dha $$0, gw $$1) {
      dfe $$2 = $$0.a_($$1);
      if ($$2.i()) {
         return false;
      } else if ($$2.a(apo.O)) {
         ...
         return $$2.a(csr.eU) || $$2.a(csr.eV) ? false : !$$2.k($$0, $$1).c();
      }
   }
   ...
   protected void a(int $$0, int $$1, int $$2, dlq.a $$3) {
      if ($$1 >= hs.a(this.p.C_()) && $$1 < hs.a(this.p.aj())) {
         int $$4 = $$1 - hs.a(this.p.C_());

         for (int $$5 = 0; $$5 < this.t.size(); $$5++) {
            if (this.t.get($$5) != null) {
               hg<cqo> $$6 = this.t.get($$5).get($$4);
               if ($$6 != null) {
   ...
   protected void a(int $$0, int $$1, dlq.c $$2) {
   ...
   protected void a(int $$0, int $$1, int $$2, int $$3, dlq.b $$4) {
      int $$5 = this.d();
   ...
   protected interface a {
      void consume(int var1, int var2, hg<cqo> var3);
   }
