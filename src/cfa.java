...
public class cfa extends cez {
   ...
   private static final akk<Byte> bX = ako.a(cfa.class, akm.a);
   private static final int bY = 1;
   private static final ceg bZ = ceg.b().a(4.0);
   public final bsp d = new bsp();
   public final bsp e = new bsp();
   @Nullable
   private iz ca;

   public cfa(bta<? extends cfa> $$0, dby $$1) {
      super($$0, $$1);
      if (!$$1.B) {
         this.w(true);
      }
   ...
   @Override
   public avz v() {
      return this.u() && this.ah.a(4) != 0 ? null : awa.bF;
   }
   ...
   public void l() {
      ...
      if (this.u()) {
         this.h(evr.b);
         this.p(this.du(), (double)ayz.a(this.dw()) + 1.0 - (double)this.dk(), this.dA());
      } else {
   ...
   protected void Z() {
      ...
      if (this.u()) {
         ...
         evr $$6 = this.ds();
         evr $$7 = $$6.b((Math.signum($$3) * 0.5 - $$6.c) * 0.1F, (Math.signum($$4) * 0.7F - $$6.d) * 0.1F, (Math.signum($$5) * 0.5 - $$6.e) * 0.1F);
         this.h($$7);
         float $$8 = (float)(ayz.d($$7.e, $$7.c) * 180.0F / (float)Math.PI) - 90.0F;
         float $$9 = ayz.g($$8 - this.dF());
         this.bq = 0.5F;
         this.r(this.dF() + $$9);
   ...
   public static boolean b(bta<cfa> $$0, dbz $$1, btt $$2, iz $$3, azh $$4) {
      if ($$3.v() >= $$1.z_()) {
         return false;
      } else {
         int $$5 = $$1.A($$3);
