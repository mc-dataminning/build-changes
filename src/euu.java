...
public class euu {
   ...
   public Optional<jh> a(jh $$0, boolean $$1, dzk $$2) {
      chj $$3 = this.n.z();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(chn.r), $$0, $$4, chj.b.c)
         .map(chk::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(dyk.I))
   ...
   public Optional<l.a> a(jh $$0, jm.a $$1) {
      ...
      for (jh.a $$11 : jh.a($$0, 16, jm.f, jm.d)) {
         int $$12 = Math.min($$8, this.n.a(edp.a.e, $$11.u(), $$11.w()));
      ...
      for (int $$24 = -1; $$24 < 3; $$24++) {
         for (int $$25 = -1; $$25 < 4; $$25++) {
            if ($$24 == -1 || $$24 == 2 || $$25 == -1 || $$25 == 3) {
               ...
               this.n.a($$10, dkn.cv.m(), 3);
            }
         }
      }

      dxu $$26 = dkn.eq.m().b(dpr.b, $$1);
