...
public class euu {
   ...
   public Optional<ji> a(ji $$0, boolean $$1, dzh $$2) {
      chc $$3 = this.n.A();
      int $$4 = $$1 ? 16 : 128;
      $$3.a(this.n, $$0, $$4);
      return $$3.b($$0x -> $$0x.a(chg.r), $$0, $$4, chc.b.c)
         .map(chd::g)
         .filter($$2::a)
         .filter($$0x -> this.n.a_($$0x).b(dyg.J))
   ...
   public Optional<l.a> a(ji $$0, jn.a $$1) {
      ...
      for (ji.a $$11 : ji.a($$0, 16, jn.f, jn.d)) {
         int $$12 = Math.min($$8, this.n.a(edo.a.e, $$11.u(), $$11.w()));
         if ($$7.a($$11) && $$7.a($$11.c($$2, 1))) {
            ...
            for (int $$13 = $$12; $$13 >= this.n.G_(); $$13--) {
               ...
               if (this.a($$11)) {
                  ...
                  while ($$13 > this.n.G_() && this.a($$11.c(jn.a))) {
                     $$13--;
                  }
