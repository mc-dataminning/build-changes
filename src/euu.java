...
public class euu {
   ...
   public void a(euu.b $$0, List<aog> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new euu.c($$0, $$1.stream().map(aog::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new euu.c(euu.b.c, ImmutableList.of());
      }

      this.b.c = new euu.a($$0);
   }
   ...
   static class c {
      private final euu.b a;
      private final List<String> b;
      @Nullable
      euu.a c;
      boolean d;

      c(euu.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
