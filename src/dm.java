...
public class dm extends dv<dm.a> {
   @Override
   public Codec<dm.a> a() {
      return dm.a.a;
   }

   public void a(ari $$0, bto $$1, bsg $$2, float $$3, float $$4, boolean $$5) {
      eth $$6 = bv.b($$0, $$1);
      this.a($$0, $$6x -> $$6x.a($$0, $$6, $$2, $$3, $$4, $$5));
   }

   public static record a(Optional<bg> b, Optional<bj> c, Optional<bg> d) implements dv.a {
      ...
      public boolean a(ari $$0, eth $$1, bsg $$2, float $$3, float $$4, boolean $$5) {
