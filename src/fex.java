...
public class fex {
   ...
   public void a(fgp $$0, String $$1, fhm.a $$2, etu $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  fex.b $$13 = new fex.b($$1.trim(), this.f, $$3, $$2);
                  fex.a $$14 = new fex.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        fex.c $$30 = new fex.c(this.f, $$2, $$0);
                        fex.a $$31 = new fex.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fgt(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, etu $$2) throws IOException {
      ...
      File $$15 = new File(fjx.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final etu d;
      private final fhm.a e;

      b(final String $$0, final File $$1, final etu $$2, final fhm.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((fex.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !fex.this.b && !fex.this.d) {
            try {
               fex.this.e = true;
               fex.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               fex.a.error("Error extracting archive", var3);
               fex.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      c(final File $$0, final fhm.a $$1, final fgp $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((fex.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !fex.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, fex.this.g);
                  fex.this.c = true;
               } else {
                  fex.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  fex.this.d = true;
               }
            } catch (IOException var3) {
               fex.a.error("Error copying resourcepack file: {}", var3.getMessage());
               fex.this.d = true;
            }
         }
      }
