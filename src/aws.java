...
public abstract class aws extends DataFix {
   private final String a;

   public aws(Schema $$0, String $$1) {
      super($$0, false);
      this.a = $$1;
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, String>> $$1 = DSL.named(bbq.y.typeName(), bcy.a());
      if (!Objects.equals($$0, $$1)) {
         ...
         TypeRewriteRule $$3 = this.fixTypeEverywhereTyped(
            this.a + " for block_state", this.getInputSchema().getType(bbq.u), $$0x -> $$0x.update(DSL.remainderFinder(), $$0xx -> {
