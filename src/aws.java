...
public class aws {
   ...
   public static final Codec<Object> b = a(axd.a);
   ...
   public static Codec<Matrix4f> g = Codec.FLOAT.listOf().comapFlatMap($$0 -> ac.a($$0, 16).map($$0x -> {
   ...
   public static final Codec<aws.g> p = Codec.STRING
      .comapFlatMap(
         $$0 -> $$0.startsWith("#") ? ajt.b($$0.substring(1)).map($$0x -> new aws.g($$0x, true)) : ajt.b($$0).map($$0x -> new aws.g($$0x, false)), aws.g::c
      );
   ...
   public static final Codec<PropertyMap> t = Codec.either(Codec.unboundedMap(Codec.STRING, Codec.STRING.listOf()), z.listOf()).xmap($$0 -> {
   ...
   public static final Codec<String> u = b(
      b(0, 16),
      (Function<String, DataResult<String>>)($$0 -> ayf.f($$0)
   ...
   private static final MapCodec<GameProfile> A = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(jf.e.fieldOf("id").forGetter(GameProfile::getId), u.fieldOf("name").forGetter(GameProfile::getName)).apply($$0, GameProfile::new)
   );
   public static final Codec<GameProfile> v = RecordCodecBuilder.create(
      $$0 -> $$0.group(A.forGetter(Function.identity()), t.optionalFieldOf("properties", new PropertyMap()).forGetter(GameProfile::getProperties))
            .apply($$0, ($$0x, $$1) -> {
               $$1.forEach(($$1x, $$2) -> $$0x.getProperties().put($$1x, $$2));
               return $$0x;
            })
   );
   public static final Codec<String> w = b(Codec.STRING, $$0 -> $$0.isEmpty() ? DataResult.error(() -> "Expected non-empty string") : DataResult.success($$0));
   ...
   public static Codec<String> y = b(
      Codec.STRING, $$0 -> !ajt.g($$0) ? DataResult.error(() -> "Invalid string to use as a resource path element: " + $$0) : DataResult.success($$0)
   );
   ...
   public static <F, S> aws.b<F, S> c(Codec<F> $$0, Codec<S> $$1) {
      return new aws.b<>($$0, $$1);
   }

   public static <K, V> aws.f<K, V> d(Codec<K> $$0, Codec<V> $$1) {
      return new aws.f<>($$0, $$1);
   }
   ...
   public static <T> Codec<ip<T>> b(Codec<ip<T>> $$0) {
      return b(
         $$0,
         (Function<ip<T>, DataResult<ip<T>>>)($$0x -> $$0x.c().right().filter(List::isEmpty).isPresent()
   ...
   public static <K, V> Codec<Map<K, V>> c(final Codec<K> $$0, final Function<K, Codec<? extends V>> $$1) {
      return new Codec<Map<K, V>>() {
         ...
         public <T> DataResult<Pair<Map<K, V>, T>> decode(DynamicOps<T> $$0x, T $$1x) {
            return $$0.getMap($$1).flatMap($$4 -> {
               Builder<K, V> $$5 = ImmutableMap.builder();
               java.util.stream.Stream.Builder<Pair<T, T>> $$6 = Stream.builder();
               DataResult<Unit> $$7 = $$4.entries().reduce(DataResult.success(Unit.INSTANCE, Lifecycle.stable()), ($$5x, $$6x) -> {
                  ...
                  $$9x.result().ifPresent($$1xxxxxxx -> $$5.put($$1xxxxxxx.getFirst(), $$1xxxxxxx.getSecond()));
                  $$9x.error().ifPresent($$2 -> $$6.add($$6x));
   ...
   static final class e<A> extends MapCodec<Optional<A>> {
      ...
      public boolean equals(Object $$0) {
         if (this == $$0) {
            ...
            return !($$0 instanceof aws.e<?> $$1) ? false : Objects.equals(this.a, $$1.a) && Objects.equals(this.b, $$1.b);
         }
      }
   ...
   public static record g(ajt a, boolean b) {
      @Override
      public String toString() {
         return this.c();
      }
