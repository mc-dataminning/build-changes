...
public class aws<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aws.this.get(this.b--);
      }

      @Override
      public void remove() {
         aws.this.remove(this.b + 1);
      }
   }
}
