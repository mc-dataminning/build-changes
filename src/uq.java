...
public class uq extends ul<ur> {
   private static final int b = 24;
   public static final vl<uq> a = new vl.b<uq>() {
      public uq a(DataInput $$0, uv $$1) throws IOException {
         return new uq(d($$0, $$1));
      }
   ...
   public boolean b(int $$0, vj $$1) {
      if ($$1 instanceof vc) {
         this.c = ArrayUtils.add(this.c, $$0, ((vc)$$1).g());
         return true;
      } else {
         return false;
      }
