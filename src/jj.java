...
public class jj {
   ...
   final Map<String, jk> e = new LinkedHashMap<>();
   private final ad f;
   private final boolean g;

   public jj(Path $$0, ad $$1, boolean $$2) {
      this.b = $$0;
   ...
   public void a() throws IOException {
      jl $$0 = new jl(this.b, this.d, this.f);
   ...
   public jj.a a(boolean $$0) {
      return new jj.a($$0, "vanilla", this.c);
   }

   public jj.a a(boolean $$0, String $$1) {
      Path $$2 = this.c.a(jm.b.a).resolve("minecraft").resolve("datapacks").resolve($$1);
      return new jj.a($$0, $$1, new jm($$2));
   }
   ...
   public class a {
      ...
      a(boolean $$1, String $$2, jm $$3) {
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
      }

      public <T extends jk> T a(jk.a<T> $$0) {
         T $$1 = $$0.create(this.d);
         String $$2 = this.c + "/" + $$1.a();
         if (!jj.this.d.add($$2)) {
