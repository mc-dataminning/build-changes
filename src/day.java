...
public abstract class day {
   ...
   public void a(bsy<?> $$0, @Nullable dbw $$1, azf $$2, iz $$3) {
         ...
         if (this.d > 0) {
            ...
            for (int $$5 = 0; $$5 < this.k; $$5++) {
               ...
               if ($$0.b($$7.get().a($$10, $$11, $$12))) {
                  ...
                  } else if (!buj.a($$7.get(), $$0, btr.c, $$13, $$0.E_())) {
                     continue;
                  }
                  ...
                  int $$16 = $$0.a(
                        dwh.b($$15.getClass()),
                        new evk((double)$$1.u(), (double)$$1.v(), (double)$$1.w(), (double)($$1.u() + 1), (double)($$1.v() + 1), (double)($$1.w() + 1))
                           .g((double)this.o),
                        bsx.f
                     )
                     .size();
   ...
   private void d(dbw $$0, iz $$1) {
      ...
      this.e.b($$2).ifPresent($$2x -> this.a($$0, $$1, (dcn)$$2x.b()));
      this.a($$0, $$1, 1);
   }

   public void a(@Nullable dbw $$0, iz $$1, ur $$2) {
      this.d = $$2.g("Delay");
      boolean $$3 = $$2.b("SpawnData", 10);
      if ($$3) {
         dcn $$4 = dcn.b.parse(vf.a, $$2.p("SpawnData")).resultOrPartial($$0x -> a.warn("Invalid SpawnData: {}", $$0x)).orElseGet(dcn::new);
         this.a($$0, $$1, $$4);
      }
      ...
      if ($$5) {
         ...
         this.e = dcn.c.parse(vf.a, $$6).resultOrPartial($$0x -> a.warn("Invalid SpawnPotentials list: {}", $$0x)).orElseGet(bpc::b);
      } else {
         this.e = bpc.a(this.f != null ? this.f : new dcn());
      }
   ...
   public ur a(ur $$0) {
      ...
      if (this.f != null) {
         $$0.a("SpawnData", (vo)dcn.b.encodeStart(vf.a, this.f).getOrThrow($$0x -> new IllegalStateException("Invalid SpawnData: " + $$0x)));
      }

      $$0.a("SpawnPotentials", (vo)dcn.c.encodeStart(vf.a, this.e).getOrThrow());
      return $$0;
   }

   @Nullable
   public bss b(dbw $$0, iz $$1) {
      if (this.l == null) {
         ...
         this.l = bsy.a($$2, $$0, Function.identity());
   ...
   protected void a(@Nullable dbw $$0, iz $$1, dcn $$2) {
      this.f = $$2;
   }

   private dcn a(@Nullable dbw $$0, azf $$1, iz $$2) {
      if (this.f != null) {
         return this.f;
      } else {
         this.a($$0, $$2, this.e.b($$1).map(bpe.b::b).orElseGet(dcn::new));
         return this.f;
      }
   }

   public abstract void a(dbw var1, iz var2, int var3);
