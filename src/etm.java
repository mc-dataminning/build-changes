...
public class etm extends gko {
   ...
   private volatile vf H = vf.c("mco.upload.preparing");
   ...
   public etm(long $$0, int $$1, etf $$2, egm $$3) {
      super(euz.a);
      this.C = $$0;
      this.D = $$1;
      this.A = $$2;
   ...
   @Override
   public void aN_() {
      this.N = this.d(exf.a(ve.k, $$0 -> this.D()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      this.N.k = false;
      this.O = this.d(exf.a(ve.e, $$0 -> this.E()).a((this.g - 200) / 2, this.h - 42, 200, 20).a());
      if (!this.M) {
         if (this.A.b == -1) {
            this.I();
         } else {
   ...
   private void D() {
      this.f.a(new esq(new eql(new fdf()), this.C));
   }
   ...
   private void d(ewt $$0) {
      ...
      $$0.a(this.i, vf.a("mco.upload.percent", this.I), this.g / 2, 84, 16777215);
   }
   ...
   private vf H() {
      ...
      $$0.add(this.H);
      if (this.I != null) {
         $$0.add(vf.a("mco.upload.percent", this.I));
      }
      ...
      new Thread(
            () -> {
               ...
               try {
                     ...
                     if ($$3 == null) {
                        ...
                        if (!$$3.c()) {
                           ...
                           if (this.J) {
                              ...
                              eqo $$11 = new eqo($$0, this.C, this.D, $$3, this.f.V(), aa.b().c(), this.E);
                              $$11.a($$1x -> {
                                 if ($$1x.a >= 200 && $$1x.a < 300) {
                                    ...
                                    this.a(vf.a("mco.upload.failed", $$1x.b));
                                 } else {
                                    this.a(vf.a("mco.upload.failed", $$1x.a));
                                 }
                              });
                              ...
                              long $$7 = $$0.length();
                              eqm $$8 = eqm.a($$7);
                              eqm $$9 = eqm.a(5368709120L);
                              if (eqm.b($$7, $$8).equals(eqm.b(5368709120L, $$9)) && $$8 != eqm.a) {
                                 eqm $$10 = eqm.values()[$$8.ordinal() - 1];
                                 this.a(
                                    vf.a("mco.upload.size.failure.line1", this.B.b()),
                                    vf.a("mco.upload.size.failure.line2", eqm.b($$7, $$10), eqm.b(5368709120L, $$10))
                                 );
                              } else {
                                 this.a(
                                    vf.a("mco.upload.size.failure.line1", this.B.b()),
                                    vf.a("mco.upload.size.failure.line2", eqm.b($$7, $$8), eqm.b(5368709120L, $$9))
                                 );
                              }
                           }
                        }
                  ...
                  this.a(vf.a("mco.upload.failed", var21.getMessage()));
               } catch (esd var22) {
                  this.a(vf.a("mco.upload.failed", var22.a.b()));
