...
public class etm extends gkp {
   ...
   public void aN_() {
      int $$0 = this.g / 4 - 2;
      this.d(exg.a(vf.c("mco.terms.buttons.agree"), $$0x -> this.D()).a(this.g / 4, g(12), $$0, 20).a());
      this.d(exg.a(vf.c("mco.terms.buttons.disagree"), $$0x -> this.f.a(this.w)).a(this.g / 2 + 4, g(12), $$0, 20).a());
   }
   ...
   private void D() {
      ...
      try {
         $$0.j();
         this.f.a(new esy(this.w, new euh(this.w, this.x)));
      } catch (ese var3) {
