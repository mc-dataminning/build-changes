...
public abstract class etm {
   ...
   public void a(dgv $$0, bvi $$1) {
      ...
      this.c = $$1;
      this.d.clear();
      this.e = ayz.d($$1.dr() + 1.0F);
      this.f = ayz.d($$1.ds() + 1.0F);
      this.g = ayz.d($$1.dr() + 1.0F);
   }
   ...
   public abstract etq a(ets var1, int var2, int var3, int var4, bvi var5);

   public abstract etq a(ets var1, int var2, int var3, int var4);

   public etq a(bvi $$0, ji $$1) {
      return this.a(new ets($$0.dW(), $$0), $$1.u(), $$1.v(), $$1.w());
   }
