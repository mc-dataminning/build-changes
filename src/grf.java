...
public class grf {
   ...
   public static class a extends Thread {
      private final grf.b a;
      private final InetAddress b;
      private final MulticastSocket c;

      public a(grf.b $$0) throws IOException {
         super("LanServerDetector #" + grf.a.incrementAndGet());
         this.a = $$0;
         this.setDaemon(true);
         this.setUncaughtExceptionHandler(new r(grf.b));
   ...
   public static class b {
      private final List<gre> a = Lists.newArrayList();
      private boolean b;

      @Nullable
      public synchronized List<gre> a() {
         if (this.b) {
            List<gre> $$0 = List.copyOf(this.a);
            this.b = false;
            return $$0;
         } else {
            return null;
