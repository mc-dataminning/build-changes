public class gbg extends gcb {
   private final gbw a;

   gbg(fxu $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbw $$7) {
   ...
   public void a() {
      ...
      if (!this.o) {
         this.b(this.a);
         cmw $$0 = this.c.a(this.g, this.h, this.i, 2.0, false);
         if ($$0 != null) {
            double $$1 = $$0.dw();
            if (this.h > $$1) {
   ...
   public static class a implements gbe<lm> {
      ...
      public gbb a(lm $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gbg($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
      }
   }
   ...
   public static class b implements gbe<lm> {
      ...
      public gbb a(lm $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbb $$8 = new gbg($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
