...
public class ei implements ek<ei>, en {
   ...
   public ei(eh $$0, feq $$1, fep $$2, arq $$3, int $$4, String $$5, wy $$6, MinecraftServer $$7, @Nullable bwf $$8) {
   ...
   public ei a(ef $$0) {
      return Objects.equals(this.m, $$0)
         ? this
         : new ei(this.d, this.e, this.o, this.f, this.g, this.h, this.i, this.j, this.l, this.k, $$0, this.n, this.p, this.q);
   }

   public ei a(ef $$0, BinaryOperator<ef> $$1) {
      ef $$2 = $$1.apply(this.m, $$0);
      return this.a($$2);
   }

   public ei a() {
      return !this.k && !this.d.o_()
         ? new ei(this.d, this.e, this.o, this.f, this.g, this.h, this.i, this.j, this.l, true, this.m, this.n, this.p, this.q)
         : this;
   }

   public ei a(int $$0) {
      return $$0 == this.g ? this : new ei(this.d, this.e, this.o, this.f, $$0, this.h, this.i, this.j, this.l, this.k, this.m, this.n, this.p, this.q);
   }
   ...
   public bwf g() throws CommandSyntaxException {
      if (this.l == null) {
         throw b.create();
      } else {
         return this.l;
   ...
   private void c(wy $$0) {
      ...
      if (this.d != this.j && this.j.aL().c(diw.n)) {
         this.j.a($$1);
      }
   }
   ...
   @Override
   public CommandDispatcher<ei> w() {
      return this.l().aE().a();
   }

   @Override
   public void a(CommandExceptionType $$0, Message $$1, boolean $$2, @Nullable hm $$3) {
      if ($$3 != null) {
         $$3.a($$1.getString());
      }
