...
public class ei implements ex<ei.a> {
   ...
   public static ti a(CommandContext<dt> $$0, String $$1) throws CommandSyntaxException {
      ei.a $$2 = (ei.a)$$0.getArgument($$1, ei.a.class);
      return $$2.a((dt)$$0.getSource());
   }

   public static void a(CommandContext<dt> $$0, String $$1, Consumer<tx> $$2) throws CommandSyntaxException {
   ...
   private static void a(Consumer<tx> $$0, dt $$1, tx $$2) {
      MinecraftServer $$3 = $$1.l();
      CompletableFuture<ald> $$4 = a($$1, $$2);
      ti $$5 = $$3.bd().decorate($$1.i(), $$2.c());
      $$1.o().append($$4x -> $$4.thenAcceptAsync($$3xx -> {
            tx $$4xx = $$2.a($$5).a($$3xx.e());
            $$0.accept($$4xx);
         }, $$4x));
   }

   private static void b(Consumer<tx> $$0, dt $$1, tx $$2) {
      td $$3 = $$1.l().bd();
      ti $$4 = $$3.decorate($$1.i(), $$2.c());
      $$0.accept($$2.a($$4));
   }

   private static CompletableFuture<ald> a(dt $$0, tx $$1) {
      ako $$2 = $$0.i();
      return $$2 != null && $$1.a($$2.cv()) ? $$2.V().a($$1.b()) : CompletableFuture.completedFuture(ald.a($$1.b()));
   }
   ...
   public static class a {
      ...
      ti a(dt $$0) throws CommandSyntaxException {
         return this.a($$0, $$0.c(2));
      }

      public ti a(dt $$0, boolean $$1) throws CommandSyntaxException {
         if (this.b.length != 0 && $$1) {
            tv $$2 = ti.b(this.a.substring(0, this.b[0].a()));
            int $$3 = this.b[0].a();
   ...
   public static class b {
      ...
      @Nullable
      public ti a(dt $$0) throws CommandSyntaxException {
