...
public class bt<V> {
   ...
   public static <V> bt<V> a(ht<V> $$0, Function<biq, Optional<V>> $$1) {
      return new bt<>($$0.q(), $$1);
   }

   public static <V> bt<V> a(Codec<V> $$0, Function<biq, Optional<V>> $$1) {
      return new bt<>($$0, $$1);
   }

   private bt(Codec<V> $$0, Function<biq, Optional<V>> $$1) {
      this.a = $$1;
   ...
   public static record a<V>(br.a b, Function<biq, Optional<V>> c, V d) implements br {
      @Override
