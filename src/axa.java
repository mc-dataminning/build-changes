...
public class axa<T> extends AbstractList<T> implements ayj<T> {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return axa.this.get(this.b--);
      }

      @Override
      public void remove() {
         axa.this.remove(this.b + 1);
      }
   }

   class b extends AbstractList<T> implements ayj<T> {
      private final axa<T> b;

      public b(final axa<T> $$0) {
         this.b = $$0;
      }
