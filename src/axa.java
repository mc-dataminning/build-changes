...
public class axa extends azn {
   public axa(Schema $$0, boolean $$1) {
      super($$0, $$1, "EntityHorseSaddleFix", ban.x, "EntityHorse");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      OpticFinder<Pair<String, String>> $$1 = DSL.fieldFinder("id", DSL.named(ban.z.typeName(), bbv.a()));
      Type<?> $$2 = this.getInputSchema().getTypeRaw(ban.t);
      ...
      if ($$4.isEmpty() && $$5.get("Saddle").asBoolean(false)) {
         ...
         $$6 = $$6.set($$1, Pair.of(ban.z.typeName(), "minecraft:saddle"));
