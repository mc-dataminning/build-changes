...
public class bbq extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bho.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bho.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bho.s);
