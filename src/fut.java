...
public class fut extends fti<byk> {
   public fut(ftj.a $$0) {
      super($$0);
   }

   public void a(byk $$0, float $$1, float $$2, elr $$3, fog $$4, int $$5) {
      $$3.a();
      $$3.a(a.d.rotationDegrees(180.0F - $$1));
      byl $$6 = $$0.q().a();
      float $$7 = 0.0625F;
      $$3.b(0.0625F, 0.0625F, 0.0625F);
      elv $$8 = $$4.getBuffer(foo.c(this.a($$0)));
      gaf $$9 = eqx.O().aD();
   ...
   private void a(elr $$0, elv $$1, byk $$2, int $$3, int $$4, fzg $$5, fzg $$6) {
      elr.a $$7 = $$0.c();
      Matrix4f $$8 = $$7.a();
      Matrix3f $$9 = $$7.b();
      ...
      for (int $$29 = 0; $$29 < $$25; $$29++) {
         for (int $$30 = 0; $$30 < $$26; $$30++) {
            ...
            int $$35 = $$2.dp();
            int $$36 = ary.a($$2.ds() + (double)(($$33 + $$34) / 2.0F / 16.0F));
            int $$37 = $$2.dv();
            hc $$38 = $$2.cD();
            if ($$38 == hc.c) {
               $$35 = ary.a($$2.dq() + (double)(($$31 + $$32) / 2.0F / 16.0F));
            }

            if ($$38 == hc.e) {
               $$37 = ary.a($$2.dw() - (double)(($$31 + $$32) / 2.0F / 16.0F));
            }
            ...
            int $$39 = foe.a($$2.dL(), new gw($$35, $$36, $$37));
   ...
   private void a(Matrix4f $$0, Matrix3f $$1, elv $$2, float $$3, float $$4, float $$5, float $$6, float $$7, int $$8, int $$9, int $$10, int $$11) {
      $$2.a($$0, $$3, $$4, $$7).a(255, 255, 255, 255).a($$5, $$6).c(fyx.d).b($$11).a($$1, (float)$$8, (float)$$9, (float)$$10).e();
   }
}
