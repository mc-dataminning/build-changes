...
public class fly {
   ...
   private void a(n $$0, xk $$1) {
      this.b.m.d().a(xk.i().b(xk.c("debug.prefix").a($$0, n.r)).b(xj.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(xk.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.t.s(2)) {
                  ...
                  this.b.t.j.d("gamemode " + ((dgw)MoreObjects.firstNonNull(this.b.r.i(), dgw.b)).b());
               }
            ...
            case 81:
               ...
               fnz $$3 = this.b.m.d();
               $$3.a(xk.c("debug.reload_chunks.help"));
               $$3.a(xk.c("debug.show_hitboxes.help"));
               $$3.a(xk.c("debug.copy_location.help"));
               $$3.a(xk.c("debug.clear_chat.help"));
               $$3.a(xk.c("debug.chunk_boundaries.help"));
               $$3.a(xk.c("debug.advanced_tooltips.help"));
               $$3.a(xk.c("debug.inspect.help"));
               $$3.a(xk.c("debug.profiling.help"));
               $$3.a(xk.c("debug.creative_spectator.help"));
               $$3.a(xk.c("debug.pause_focus.help"));
               $$3.a(xk.c("debug.help.help"));
               $$3.a(xk.c("debug.dump_dynamic_textures.help"));
               $$3.a(xk.c("debug.reload_resourcepacks.help"));
               $$3.a(xk.c("debug.pause.help"));
               $$3.a(xk.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.q.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.aa().a($$5);
               xk $$6 = xk.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new xi(xi.a.b, $$5.toFile().toString())));
   ...
   private void a(dxo $$0, jh $$1, @Nullable um $$2) {
   ...
   private void a(alp $$0, fbr $$1, @Nullable um $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = vb.c((vj)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aO().h()) {
         ...
         label197: {
            ...
            label153:
            if (!$$13) {
               if (this.b.z instanceof ftm $$14 && !$$14.l()) {
                  break label153;
               }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", azu.f((float)$$1 / 1000.0F));
            }
