...
public class fly {
   public static void a(gcv $$0, flw $$1, long $$2, float $$3, Vector3f $$4) {
      float $$5 = a($$1, $$2);

      for (Entry<String, List<flv>> $$6 : $$1.c().entrySet()) {
         Optional<gfc> $$7 = $$0.a($$6.getKey());
         List<flv> $$8 = $$6.getValue();
   ...
   private static float a(flw $$0, long $$1) {
