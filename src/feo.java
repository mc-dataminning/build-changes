...
public class feo extends fer<feo.b> {
   ...
   public feo(cfh $$0, chr $$1, boolean $$2) {
      super(new feo.b($$0), $$0.fS(), ve.a);
      $$0.bS = this.p;
      this.k = 136;
      this.c = 195;
      this.Y = $$2;
      ...
      if ($$0 == null && O.k() != cld.h.b && $$3 != cij.f) {
         ...
         if ($$0 == this.T && $$4) {
            ...
            if ($$0 == this.T) {
               ...
               this.f.s.a($$6, true);
               this.f.q.a($$6);
               this.f.q.a($$7, ((feo.c)$$0).a.e);
            } else if ($$3 == cij.e && !this.p.g().b()) {
               this.f.s.a(this.p.g(), true);
               this.f.q.a(this.p.g());
               this.p.b(cmx.f);
            } else {
               this.f.s.bR.a($$0 == null ? $$1 : ((feo.c)$$0).a.e, $$2, $$3, this.f.s);
               this.f.s.bR.d();
            }
   ...
   protected void aN_() {
      if (this.f.q.g()) {
         super.aN_();
         this.R = new exo(this.i, this.t + 82, this.u + 6, 80, 9, vf.c("itemGroup.search"));
         this.R.f(50);
         this.R.d(false);
         this.R.g(false);
         this.R.g(16777215);
   ...
   public boolean a(int $$0, int $$1, int $$2) {
      ...
      if (O.k() != cld.h.d) {
         ...
         boolean $$4 = eov.a($$0, $$1).e().isPresent();
         if ($$3 && $$4 && this.a($$0, $$1)) {
            this.V = true;
            return true;
         } else {
   ...
   private void a(cld $$0) {
      ...
      if (O.k() == cld.h.b) {
         ...
         for (int $$10 = 0; $$10 < $$9.i.size(); $$10++) {
            ...
            cjv $$26 = new feo.c($$9.i.get($$10), $$10, $$14, $$15);
            this.p.i.add($$26);
         }
   ...
   public List<vf> a(cmx $$0) {
      boolean $$1 = this.r != null && this.r instanceof feo.a;
   ...
   protected void a(ewt $$0, float $$1, int $$2, int $$3) {
      ...
      this.a($$0, O);
      if (O.k() == cld.h.b) {
         fez.a($$0, this.t + 73, this.u + 6, this.t + 105, this.u + 49, 20, 0.0625F, (float)$$2, (float)$$3, this.f.s);
      }
   }
   ...
   protected boolean a(ewt $$0, cld $$1, int $$2, int $$3) {
      int $$4 = this.b($$1);
      int $$5 = this.c($$1);
   ...
   public static void a(evh $$0, int $$1, boolean $$2, boolean $$3) {
      fsi $$4 = $$0.s;
      evd $$5 = $$0.aB();
      fsk $$6 = $$5.a($$1);
      if ($$2) {
   ...
   public static class b extends cia {
      ...
      public b(cfh $$0) {
         ...
         for (int $$2 = 0; $$2 < 5; $$2++) {
            for (int $$3 = 0; $$3 < 9; $$3++) {
               this.a(new feo.a(feo.L, $$2 * 9 + $$3, 9 + $$3 * 18, 18 + $$2 * 18));
            }
         }
