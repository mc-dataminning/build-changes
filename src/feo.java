...
public class feo {
   ...
   public static final feo.a bv;

   public static feo.a a(int $$0, int $$1) {
      return $$0 == -1 ? feo.b.b.a($$1) : feo.b.a.a($$0);
   }

   public static feo.a a(String $$0) {
      if (feo.a.e.containsKey($$0)) {
         return feo.a.e.get($$0);
      } else {
         for (feo.b $$1 : feo.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final feo.b b;
      private final int c;
      private final ayt<wp> d;
      static final Map<String, feo.a> e = Maps.newHashMap();

      a(String $$0, feo.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<feo.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, wp> g;

      private static void a(feo.b $$0, String $$1, int $$2) {
         feo.a $$3 = new feo.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public feo.a a(int $$0) {
         return (feo.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
