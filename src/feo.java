...
public class feo extends gxb {
   ...
   private Long Y;
   private long Z;
   private final fma aa = new fma(this);

   public feo(@Nullable ffl $$0, long $$1, int $$2, feh $$3, erg $$4) {
      super(fgb.a);
      this.I = $$0;
      this.J = $$1;
      this.K = $$2;
   ...
   @Override
   public void aN_() {
      this.U = this.aa.b(fin.a(xd.k, $$0x -> this.C()).a());
      this.U.k = false;
      this.V = this.aa.b(fin.a(xd.e, $$0x -> this.D()).a());
      if (!this.T) {
         if (this.G.b == -1) {
            this.T = true;
            this.F();
         } else {
            List<ffj> $$0 = new ArrayList<>();
            if (this.I != null) {
               $$0.add(this.I);
            }

            $$0.add(new ffr(this.J, this.G.b, () -> {
               if (!this.T) {
                  this.T = true;
                  this.m.execute(() -> {
                     this.m.a(this);
            ...
            this.m.a(new fdz(this.G, $$0.toArray(new ffj[0])));
         }
      }
   ...
   private void C() {
      this.m.a(new fds(new fbn(new fou()), this.J));
   }
                     ...
                     if ($$2 == null) {
                        ...
                        if (!$$2.c()) {
                           ...
                           if (this.Q) {
                              ...
                              fbq $$10 = new fbq($$0, this.J, this.K, $$2, this.m.X(), ab.b().c(), this.H.l().c(), this.L);
                              $$10.a($$0x -> {
                              ...
                              if (fbo.b($$6, $$7).equals(fbo.b(5368709120L, $$8)) && $$7 != fbo.a) {
                                 ...
                                 this.a(
                                    ...
                                    xe.a("mco.upload.size.failure.line2", fbo.b($$6, $$9), fbo.b(5368709120L, $$9))
                                 );
                              } else {
                                 this.a(
                                    xe.a("mco.upload.size.failure.line1", this.H.b()),
                                    xe.a("mco.upload.size.failure.line2", fbo.b($$6, $$7), fbo.b(5368709120L, $$8))
                                 );
                              }
                           }
                        }
