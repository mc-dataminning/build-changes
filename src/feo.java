...
public class feo {
   ...
   public void a(ffw $$0, String $$1, fgt.a $$2, etq $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  feo.b $$13 = new feo.b($$1.trim(), this.f, $$3, $$2);
                  feo.a $$14 = new feo.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        feo.c $$30 = new feo.c(this.f, $$2, $$0);
                        feo.a $$31 = new feo.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fga(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, etq $$2) throws IOException {
      ...
      File $$15 = new File(fji.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final etq d;
      private final fgt.a e;

      b(final String $$0, final File $$1, final etq $$2, final fgt.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((feo.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !feo.this.b && !feo.this.d) {
            try {
               feo.this.e = true;
               feo.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               feo.a.error("Error extracting archive", var3);
               feo.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final fgt.a c;
      private final ffw d;

      c(final File $$0, final fgt.a $$1, final ffw $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((feo.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !feo.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, feo.this.g);
                  feo.this.c = true;
               } else {
                  feo.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  feo.this.d = true;
               }
            } catch (IOException var3) {
               feo.a.error("Error copying resourcepack file: {}", var3.getMessage());
               feo.this.d = true;
            }
         }
      }
