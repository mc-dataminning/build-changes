public class gjv extends gjr {
   private final gjm a;
   private static final int b = 8;

   protected gjv(gfj $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, float $$7, gjm $$8) {
   ...
   public static class a implements giu<lw> {
      ...
      public gir a(lw $$0, gfj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         return new gjv($$1, $$2, $$3, $$4, $$5, $$6, $$7, 1.5F, this.a);
      }
   }
}
