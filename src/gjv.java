...
public class gjv {
   ...
   public gjv(gmk $$0, dff $$1, int $$2, git $$3) {
      this.a = $$3;
      this.b = $$1;
      this.a($$2);
      this.a($$0);
   ...
   @Nullable
   protected gmk.b a(jh $$0) {
      return this.a(kj.c($$0));
   }

   @Nullable
   protected gmk.b a(long $$0) {
      int $$1 = kj.b($$0);
      int $$2 = kj.c($$0);
      int $$3 = kj.d($$0);
      return this.b($$1, $$2, $$3);
   ...
   @Nullable
   private gmk.b b(int $$0, int $$1, int $$2) {
      if (!this.c($$0, $$1, $$2)) {
         return null;
      } else {
         int $$3 = $$1 - this.b.an();
