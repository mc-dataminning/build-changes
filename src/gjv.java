...
public class gjv {
   ...
   public gjo a(Vector3f $$0, Vector3f $$1, gjq $$2, gyd $$3, jm $$4, hau $$5, @Nullable gjr $$6, boolean $$7, int $$8) {
      gjs $$9 = $$2.d();
      if ($$5.c()) {
         $$9 = a($$2.d(), $$4, $$5.b());
      }
      ...
      return new gjo($$14, $$2.b(), $$15, $$3, $$7, $$8);
   }

   public static gjs a(gjs $$0, jm $$1, j $$2) {
      ...
      return new gjs(new float[]{$$14, $$18, $$15, $$19}, $$25);
   }

   private int[] a(gjs $$0, gyd $$1, jm $$2, float[] $$3, j $$4, @Nullable gjr $$5) {
      int[] $$6 = new int[32];
   ...
   private void a(int[] $$0, int $$1, jm $$2, gjs $$3, float[] $$4, gyd $$5, j $$6, @Nullable gjr $$7) {
      ghu.b $$8 = ghu.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, gyd $$3, gjs $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable gjr $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
