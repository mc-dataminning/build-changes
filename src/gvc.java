...
public class gvc {
   ...
   private final fgs n;
   private boolean o;
   private final ezf p = new ezf();
   private final ezg q = this.p.e();
   private final gvb r;
   private final gvd s = new gvd();
   private final guu t = new guu(this.p, this.s);
   private int u;
   private long v;
   private final AtomicReference<gvc.a> w = new AtomicReference<>(gvc.a.c);
   private final Map<gua, guu.a> x = Maps.newHashMap();
   private final Multimap<avq, gua> y = HashMultimap.create();
   private final List<gub> z = Lists.newArrayList();
   private final Map<gua, Integer> A = Maps.newHashMap();
   private final Map<gua, Integer> B = Maps.newHashMap();
   private final List<gve> C = Lists.newArrayList();
   private final List<gub> D = Lists.newArrayList();
   private final List<gtx> E = Lists.newArrayList();

   public gvc(gvf $$0, fgs $$1, auh $$2) {
      this.m = $$0;
      this.n = $$1;
      this.r = new gvb($$2);
   }
   ...
   public void d() {
      if (this.o) {
         this.s.a();
         this.x.values().forEach($$0 -> $$0.a(eze::f));
         this.x.clear();
         this.t.b();
         this.A.clear();
         this.z.clear();
   ...
   private boolean k() {
      if (this.p.h()) {
         ...
         if ($$1) {
            this.v = $$0;
            if (this.w.compareAndSet(gvc.a.c, gvc.a.a)) {
               String $$2 = this.n.at().c();
               ad.h().execute(() -> {
                  if ("".equals($$2)) {
                     if (this.p.c()) {
                        e.info("System default audio device has changed!");
                        this.w.compareAndSet(gvc.a.a, gvc.a.b);
                     }
                  ...
                  this.w.compareAndSet(gvc.a.a, gvc.a.c);
               });
            }
         }

         return this.w.compareAndSet(gvc.a.b, gvc.a.c);
      }
   }
   ...
   private void l() {
      this.u++;
      this.D.stream().filter(gua::s).forEach(this::c);
      this.D.clear();
      ...
      for (gub $$0 : this.z) {
         ...
         if ($$0.m()) {
            ...
            float $$1 = this.h($$0);
            float $$2 = this.g($$0);
            exc $$3 = new exc($$0.h(), $$0.i(), $$0.j());
            guu.a $$4 = this.x.get($$0);
            if ($$4 != null) {
               $$4.a($$3x -> {
                  $$3x.b($$1);
                  $$3x.a($$2);
      ...
      Iterator<Entry<gua, guu.a>> $$5 = this.x.entrySet().iterator();

      while ($$5.hasNext()) {
         Entry<gua, guu.a> $$6 = $$5.next();
         guu.a $$7 = $$6.getValue();
         gua $$8 = $$6.getKey();
      ...
      Iterator<Entry<gua, Integer>> $$11 = this.A.entrySet().iterator();

      while ($$11.hasNext()) {
         Entry<gua, Integer> $$12 = $$11.next();
         if (this.u >= $$12.getValue()) {
            gua $$13 = $$12.getKey();
            if ($$13 instanceof gub) {
               ((gub)$$13).q();
            }
   ...
   private static boolean d(gua $$0) {
      return $$0.e() > 0;
   }

   private static boolean e(gua $$0) {
      return $$0.d() && d($$0);
   }

   private static boolean f(gua $$0) {
      return $$0.d() && !d($$0);
   }

   public boolean b(gua $$0) {
      if (!this.o) {
         return false;
      } else {
               ...
               if ($$3 != gvf.e) {
                  if ($$3 == gvf.b) {
                     ...
                     if ($$7 == 0.0F && !$$0.r()) {
                        ...
                        exc $$11 = new exc($$0.h(), $$0.i(), $$0.j());
                        if (!this.C.isEmpty()) {
                           float $$12 = !$$10 && $$9 != gua.a.a ? $$5 : Float.POSITIVE_INFINITY;
   ...
   private float g(gua $$0) {
      return ayo.a($$0.g(), 0.5F, 2.0F);
   }

   private float h(gua $$0) {
   ...
   public void e() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(eze::d));
      }
   }

   public void f() {
      if (this.o) {
         this.t.a($$0 -> $$0.forEach(eze::e));
      }
   }
   ...
   public void a(ffy $$0) {
      if (this.o && $$0.h()) {
         ezh $$1 = new ezh($$0.b(), new exc($$0.l()), new exc($$0.m()));
