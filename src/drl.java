...
public class drl implements drn {
   public static final Codec<drl> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bhv.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bhv.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bhv.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bht.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bht.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public drl(int $$0, bhv $$1, bhv $$2, int $$3, int $$4, bhv $$5, bht $$6, bht $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
