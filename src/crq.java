...
public class crq {
   private static final List<crp> b = ac.a(new ArrayList<>(), $$0 -> {
      a($$0, "contents", 0);
      a($$0, "container.", 0, 54);
      a($$0, "hotbar.", 0, 9);
      a($$0, "inventory.", 9, 27);
   ...
   public static final Codec<crp> a = azt.b(() -> b.toArray(new crp[0]));
   private static final Function<String, crp> c = azt.a(b.toArray(new crp[0]), $$0 -> $$0);
   ...
   public static Stream<String> a() {
      return b.stream().map(azt::c);
   }

   public static Stream<String> b() {
      return b.stream().filter($$0 -> $$0.b() == 1).map(azt::c);
   }
}
