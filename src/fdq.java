...
public class fdq {
   ...
   private static final wg h = wg.c("chat.deleted_marker").a(n.h, n.u);
   private final fbp i;
   private final avy<String> j = new avy<>(100);
   private final List<fbj> k = Lists.newArrayList();
   private final List<fbj.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fdq.a> o = new ArrayList<>();
   ...
   public void a(fdc $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.k()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$8 = axk.f((float)this.f() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = axk.d((float)($$9 - 40) / $$7);
            ...
            if ($$32 > 0L) {
               ...
               $$0.a(-2, 0, $$8 + 4, 9, $$34 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, wg.a("chat.queue", $$32), 0, 1, 16777215 + ($$33 << 24));
               $$0.c().b();
            }
   ...
   private void a(fdc $$0, int $$1, int $$2, fbk.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(fbj.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean k() {
      return this.i.m.m().c() == cjr.c;
   }
   ...
   public void a(wg $$0) {
      this.a($$0, null, this.i.W() ? fbk.b() : fbk.a());
   }

   public void a(wg $$0, @Nullable ws $$1, @Nullable fbk $$2) {
      this.a($$0, $$2);
      this.a($$0, $$1, this.i.l.e(), $$2, false);
   }

   private void a(wg $$0, @Nullable fbk $$1) {
      String $$2 = $$0.getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$3 = x.a($$1, fbk::h);
      if ($$3 != null) {
         a.info("[{}] [CHAT] {}", $$3, $$2);
      } else {
         a.info("[CHAT] {}", $$2);
   ...
   private void a(wg $$0, @Nullable ws $$1, int $$2, @Nullable fbk $$3, boolean $$4) {
      int $$5 = axk.a((double)this.f() / this.h());
      if ($$3 != null && $$3.f() != null) {
         $$5 -= $$3.f().c + 4 + 2;
      }

      List<aww> $$6 = fdu.a($$0, $$5, this.i.h);
      boolean $$7 = this.e();
      ...
      for (int $$8 = 0; $$8 < $$6.size(); $$8++) {
         ...
         this.l.add(0, new fbj.a($$2, $$9, $$3, $$10));
      }
   ...
   @Nullable
   private fdq.a b(ws $$0) {
      int $$1 = this.i.l.e();
      ListIterator<fbj> $$2 = this.k.listIterator();
   ...
   private fbj a(fbj $$0) {
      return new fbj($$0.a(), h, null, fbk.a());
   }
   ...
   public boolean a(double $$0, double $$1) {
      if (this.e() && !this.i.m.Z && !this.k()) {
         ...
         if ($$2.c() == 0L) {
            ...
            if ($$3 <= (double)axk.a((double)this.f() / this.h()) && $$4 < 0.0 && $$4 > (double)axk.a(-9.0 * this.h())) {
               $$2.b();
               return true;
            } else {
               return false;
   ...
   @Nullable
   public xd b(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.e($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
         fbj.a $$5 = this.l.get($$4);
         return this.i.h.b().a($$5.b(), axk.a($$2));
      } else {
         return null;
      }
   }
   ...
   @Nullable
   public fbk c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, fbj.a $$1, fbk $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         fbk.a $$3 = $$2.f();
   ...
   private int e(double $$0, double $$1) {
      if (this.e() && !this.i.m.Z && !this.k()) {
         if (!($$0 < -4.0) && !($$0 > (double)axk.a((double)this.f() / this.h()))) {
            int $$2 = Math.min(this.j(), this.l.size());
            if ($$1 >= 0.0 && $$1 < (double)$$2) {
               int $$3 = axk.a($$1 + (double)this.m);
   ...
   public boolean e() {
      return this.i.y instanceof fie;
   }
   ...
   public static int a(double $$0) {
      int $$1 = 320;
      int $$2 = 40;
      return axk.a($$0 * 280.0 + 40.0);
   }

   public static int b(double $$0) {
      int $$1 = 180;
      int $$2 = 20;
      return axk.a($$0 * 160.0 + 20.0);
   }
