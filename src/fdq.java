...
public class fdq implements AutoCloseable {
   ...
   private fdq(int $$0, ali $$1) {
      this.b = $$1;
      this.c = $$0;
   }

   public static fdq a(ali $$0, fdq.a $$1, String $$2) throws giy.b {
      ...
      if (GlStateManager.glGetShaderi($$3, 35713) == 0) {
         ...
         throw new giy.b("Couldn't compile " + $$1.a() + " shader (" + $$0 + ") : " + $$4);
      } else {
         return new fdq($$3, $$0);
      }
   }
   ...
   public static enum a {
      ...
      private static final fdq.a[] c = values();
