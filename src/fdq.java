...
public enum fdq implements bag {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final bag.a<fdq> t = bag.a(fdq::values);
   public static final IntFunction<fdq> u = aya.a(fdq::a, values(), aya.a.a);
   private final int v;
   private final String w;

   private fdq(final int $$0, final String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
