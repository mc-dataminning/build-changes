...
public class fdq extends fda implements fnm.a {
   ...
   private final fnm z;
   private final Map<af, fdm> A = Maps.newLinkedHashMap();
   @Nullable
   private fdm B;
   private boolean C;
   ...
   protected void aN_() {
      ...
      if (this.B == null && !this.A.isEmpty()) {
         fdm $$0 = this.A.values().iterator().next();
         this.z.a($$0.c().b(), true);
      } else {
   ...
   public void a(ewt $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (fdm $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (fdm $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ag $$0) {
      fdm $$1 = fdm.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0.b(), $$1);
      }
   }
