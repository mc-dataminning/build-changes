...
public class ajv<C extends bpf> implements aju<Integer> {
   private static final Logger d = LogUtils.getLogger();
   protected final cll a = new cll();
   protected clg b;
   protected cpr<C> c;
   ...
   public void a(aqi $$0, @Nullable cxf<? extends cxd<C>> $$1, boolean $$2) {
      if ($$1 != null && $$0.I().b($$1)) {
         this.b = $$0.ga();
         if (this.b() || $$0.f()) {
            this.a.a();
            $$0.ga().a(this.a);
            this.c.a(this.a);
            if (this.a.a((cxd<?>)$$1.b(), null)) {
               this.a($$1, $$2);
            } else {
               this.a();
               $$0.d.b(new adl($$0.cc.j, $$1));
            }
   ...
   protected void a(cxf<? extends cxd<C>> $$0, boolean $$1) {
   ...
   private boolean b() {
      ...
      for (int $$2 = 0; $$2 < this.c.n() * this.c.o() + 1; $$2++) {
         if ($$2 != this.c.m()) {
            csz $$3 = this.c.b($$2).g().r();
            if (!$$3.d()) {
               int $$4 = this.b.e($$3);
               if ($$4 == -1 && $$0.size() <= $$1) {
                  for (csz $$5 : $$0) {
                     if (csz.b($$5, $$3) && $$5.G() != $$5.i() && $$5.G() + $$3.G() <= $$5.i()) {
                        $$5.g($$3.G());
                        $$3.e(0);
                        break;
                     }
