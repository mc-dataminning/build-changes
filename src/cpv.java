...
public abstract class cpv implements cpw, AutoCloseable {
   ...
   protected cpv(ecn $$0, aew<cpv> $$1, hu $$2, hg<dis> $$3, Supplier<bdp> $$4, boolean $$5, boolean $$6, long $$7, int $$8) {
      this.F = $$4;
      this.A = $$0;
      this.E = $$3;
      ...
      if (this.r($$0)) {
         ...
         if ($$6 == null) {
            ...
            if ($$7 == $$1) {
               ...
               if (($$2 & 2) != 0 && (!this.B || ($$2 & 4) == 0) && (this.B || $$4.D() != null && $$4.D().a(akk.c))) {
                  this.a($$0, $$6, $$1, $$2);
               }
   ...
   public dfj a_(gw $$0) {
      if (this.r($$0)) {
         ...
         dhq $$1 = this.d(hz.a($$0.u()), hz.a($$0.w()));
         return $$1.a_($$0);
      }
   }
   ...
   public void a(@Nullable biq $$0, gw $$1, apd $$2, apf $$3, float $$4, float $$5) {
      this.a($$0 instanceof cbu $$6 ? $$6 : null, $$1, $$2, $$3, $$4, $$5);
   }

   @Override
   public void a(@Nullable cbu $$0, gw $$1, apd $$2, apf $$3, float $$4, float $$5) {
      this.a($$0, (double)$$1.u() + 0.5, (double)$$1.v() + 0.5, (double)$$1.w() + 0.5, $$2, $$3, $$4, $$5);
   }

   public abstract void a(@Nullable cbu var1, double var2, double var4, double var6, hg<apd> var8, apf var9, float var10, float var11, long var12);

   public void a(@Nullable cbu $$0, double $$1, double $$2, double $$3, apd $$4, apf $$5, float $$6, float $$7, long $$8) {
      this.a($$0, $$1, $$2, $$3, jd.c.d($$4), $$5, $$6, $$7, $$8);
   }

   public abstract void a(@Nullable cbu var1, biq var2, hg<apd> var3, apf var4, float var5, float var6, long var7);

   public void a(@Nullable cbu $$0, double $$1, double $$2, double $$3, apd $$4, apf $$5, float $$6, float $$7) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$7, this.f.g());
   }

   public void a(@Nullable cbu $$0, biq $$1, apd $$2, apf $$3, float $$4, float $$5) {
      this.a($$0, $$1, jd.c.d($$2), $$3, $$4, $$5, this.f.g());
   }

   public void a(gw $$0, apd $$1, apf $$2, float $$3, float $$4, boolean $$5) {
   ...
   public boolean a(gw $$0, biq $$1, hc $$2) {
      if (this.r($$0)) {
         return false;
      } else {
         dhf $$3 = this.a(hz.a($$0.u()), hz.a($$0.w()), dhk.n, false);
   ...
   public void Q() {
      ...
      double $$2 = 0.5 + 2.0 * arx.a((double)arx.b(this.f(1.0F) * (float) (Math.PI * 2)), -0.25, 0.25);
   ...
   public float b(float $$0) {
      return arx.i($$0, this.x, this.y) * this.d($$0);
   }

   public void c(float $$0) {
      float $$1 = arx.a($$0, 0.0F, 1.0F);
      this.x = $$1;
      this.y = $$1;
   }

   public float d(float $$0) {
      return arx.i($$0, this.v, this.w);
   }
