...
public abstract class cpv {
   ...
   private final jr<cuq> l = jr.a();
   public final jr<crq> i = jr.a();
   private final List<cqn> m = Lists.newArrayList();
   private cuq n = cuq.l;
   private final jr<cuq> o = jr.a();
   ...
   protected cpv(@Nullable crc<?> $$0, int $$1) {
      this.s = $$0;
      this.j = $$1;
   }

   protected static boolean a(cqg $$0, cmy $$1, dfa $$2) {
   ...
   protected static void a(bqo $$0, int $$1) {
      int $$2 = $$0.b();
      if ($$2 < $$1) {
   ...
   public abstract cuq a(cmy var1, int var2);

   public void a(int $$0, int $$1, cqe $$2, cmy $$3) {
      try {
         this.b($$0, $$1, $$2, $$3);
   ...
   private void b(int $$0, int $$1, cqe $$2, cmy $$3) {
      cmx $$4 = $$3.gc();
      if ($$2 == cqe.f) {
         int $$5 = this.u;
         this.u = d($$1);
         ...
         if ($$0 == -999) {
            ...
            if (!this.a($$3, $$16, $$19, $$20, $$21)) {
               if ($$20.e()) {
                  if (!$$21.e()) {
                     int $$22 = $$16 == cqd.a ? $$21.I() : 1;
                     this.b($$19.b($$21, $$22));
                  }
               } else if ($$19.a($$3)) {
                  if ($$21.e()) {
                     int $$23 = $$16 == cqd.a ? $$20.I() : ($$20.I() + 1) / 2;
                     ...
                     Optional<cuq> $$26 = $$19.a($$20.I(), $$21.j() - $$21.I(), $$3);
                     $$26.ifPresent($$3x -> {
                        $$21.g($$3x.I());
                        $$19.a($$3, $$3x);
                     });
      ...
      } else if ($$2 == cqe.d && $$3.fP() && this.g().e() && $$0 >= 0) {
         crq $$32 = this.i.get($$0);
         if ($$32.h()) {
            cuq $$33 = $$32.g();
            this.b($$33.c($$33.j()));
   ...
   private boolean a(cmy $$0, cqd $$1, crq $$2, cuq $$3, cuq $$4) {
      cpm $$5 = $$0.dP().J();
   ...
   public abstract boolean a(cmy var1);
   ...
   public static boolean a(int $$0, cmy $$1) {
      if ($$0 == 0) {
         return true;
      } else {
   ...
   public static boolean a(@Nullable crq $$0, cuq $$1, boolean $$2) {
      ...
      return !$$3 && cuq.c($$1, $$0.g()) ? $$0.g().I() + ($$2 ? 0 : $$1.I()) <= $$1.j() : $$3;
   }
   ...
   public static int a(@Nullable dpi $$0) {
      return $$0 instanceof bqo ? b((bqo)$$0) : 0;
   }

   public static int b(@Nullable bqo $$0) {
      if ($$0 == null) {
         return 0;
      } else {
         float $$1 = 0.0F;
   ...
   public void a(cpv $$0) {
      Table<bqo, Integer, Integer> $$1 = HashBasedTable.create();
   ...
   public OptionalInt b(bqo $$0, int $$1) {
