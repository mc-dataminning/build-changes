...
public class wq implements ux<wp> {
   ...
   public wq(int $$0, UUID $$1, double $$2, double $$3, double $$4, float $$5, float $$6, bim<?> $$7, int $$8, ehd $$9, double $$10) {
      ...
      this.g = $$3;
      this.h = $$4;
      this.l = (byte)arp.d($$5 * 256.0F / 360.0F);
      this.m = (byte)arp.d($$6 * 256.0F / 360.0F);
      this.n = (byte)arp.a($$10 * 256.0 / 360.0);
      this.e = $$7;
      this.o = $$8;
      this.i = (int)(arp.a($$9.c, -3.9, 3.9) * 8000.0);
      this.j = (int)(arp.a($$9.d, -3.9, 3.9) * 8000.0);
      this.k = (int)(arp.a($$9.e, -3.9, 3.9) * 8000.0);
   }
