...
public class abb implements xz<aai> {
   public static final xq<us, abb> a = xz.a(abb::a, abb::new);
   ...
   private final int i;
   private final List<abb.b> j;

   public abb(RootCommandNode<dz> $$0) {
   ...
   private static void a(List<abb.b> $$0, BiPredicate<abb.b, IntSet> $$1) {
   ...
   private static void a(List<abb.b> $$0) {
      a($$0, abb.b::a);
      a($$0, abb.b::b);
   }
   ...
   private static List<abb.b> a(Object2IntMap<CommandNode<dz>> $$0) {
      ObjectArrayList<abb.b> $$1 = new ObjectArrayList($$0.size());
      $$1.size($$0.size());
   ...
   private static abb.b b(us $$0) {
      byte $$1 = $$0.readByte();
      int[] $$2 = $$0.c();
      int $$3 = ($$1 & 8) != 0 ? $$0.l() : 0;
      abb.e $$4 = a($$0, $$1);
      return new abb.b($$4, $$1, $$3, $$2);
   }

   @Nullable
   private static abb.e a(us $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
         ...
         if ($$5 == null) {
            ...
            hn.a<?> $$6 = $$5.b($$0);
            ajc $$7 = ($$1 & 16) != 0 ? $$0.q() : null;
            return new abb.a($$3, $$6, $$7);
         }
      } else if ($$2 == 1) {
         String $$8 = $$0.p();
         return new abb.c($$8);
   ...
   private static abb.b a(CommandNode<dz> $$0, Object2IntMap<CommandNode<dz>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<dz> a(dq $$0) {
      return (RootCommandNode<dz>)new abb.d($$0, this.j).a(this.i);
   }

   static class a implements abb.e {
      ...
      @Nullable
      private static ajc a(@Nullable SuggestionProvider<dz> $$0) {
         return $$0 != null ? hr.a($$0) : null;
      }

      a(String $$0, hn.a<?> $$1, @Nullable ajc $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(us $$0, hn.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends hn.a<A>> void a(us $$0, hn<A, T> $$1, hn.a<A> $$2) {
         $$0.c(kh.w.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
   ...
   static class b {
      ...
      b(@Nullable abb.e $$0, int $$1, int $$2, int[] $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
   ...
   static class c implements abb.e {
      private final String a;
