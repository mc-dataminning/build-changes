...
public class cpl extends cpq implements cpn {
   private static final ajx<cwp> a = akb.a(cpl.class, ajz.h);
   private static final ajx<OptionalInt> b = akb.a(cpl.class, ajz.v);
   private static final ajx<Boolean> c = akb.a(cpl.class, ajz.k);
   private int d;
   private int e;
   @Nullable
   private bvg f;

   public cpl(bur<? extends cpl> $$0, dgi $$1) {
      super($$0, $$1);
   }

   public cpl(dgi $$0, double $$1, double $$2, double $$3, cwp $$4) {
      super(bur.aa, $$0);
      this.d = 0;
      this.a_($$1, $$2, $$3);
      this.al.a(a, $$4.v());
   ...
   public cpl(dgi $$0, @Nullable buk $$1, double $$2, double $$3, double $$4, cwp $$5) {
      this($$0, $$2, $$3, $$4, $$5);
      this.c($$1);
   }

   public cpl(dgi $$0, cwp $$1, bvg $$2) {
      this($$0, $$2, $$2.dB(), $$2.dD(), $$2.dH(), $$1);
      this.al.a(b, OptionalInt.of($$2.ar()));
      this.f = $$2;
   }

   public cpl(dgi $$0, cwp $$1, double $$2, double $$3, double $$4, boolean $$5) {
      this($$0, $$2, $$3, $$4, $$1);
      this.al.a(c, $$5);
   }

   public cpl(dgi $$0, cwp $$1, buk $$2, double $$3, double $$4, double $$5, boolean $$6) {
      this($$0, $$1, $$3, $$4, $$5, $$6);
      this.c($$2);
   }
   ...
   public void h() {
      ...
      if (!this.ad && this.bL() && $$6.d() != fay.a.a) {
         this.b($$6);
         this.ar = true;
      }
      ...
      this.F();
      if (this.d == 0 && !this.bb()) {
         this.dW().a(null, this.dB(), this.dD(), this.dH(), awa.jp, awb.i, 3.0F, 1.0F);
      }
   ...
   private void e(arc $$0) {
      ...
      if ($$1 > 0.0F) {
         ...
         for (bvg $$6 : this.dW().a(bvg.class, this.cR().g(5.0))) {
            if ($$6 != this.f && !(this.g($$6) > 25.0)) {
               boolean $$7 = false;

               for (int $$8 = 0; $$8 < 2; $$8++) {
                  fba $$9 = new fba($$6.dB(), $$6.e(0.5 * (double)$$8), $$6.dH());
                  fay $$10 = this.dW().a(new dfq($$4, $$9, dfq.a.a, dfq.b.a, this));
                  if ($$10.d() == fay.a.a) {
                     $$7 = true;
                     break;
                  }
   ...
   public void a(tq $$0) {
      ...
      if ($$0.b("FireworksItem", 10)) {
         this.al.a(a, cwp.a(this.dY(), (un)$$0.p("FireworksItem")).orElseGet(cpl::v));
      } else {
         this.al.a(a, v());
      }
