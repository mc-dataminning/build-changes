...
public class cpl {
   ...
   static final List<chs<? extends chr<? super cpk>>> e = ImmutableList.of(chs.c, chs.f, chs.d, chs.z);
   ...
   protected static byj<?> a(cpk $$0, byj<cpk> $$1) {
      a($$1);
      b($$1);
      b($$0, $$1);
      $$1.a(Set.of(ctg.a));
   ...
   private static void a(byj<cpk> $$0) {
      $$0.a(ctg.a, 0, ImmutableList.of(new cbu(0.8F), new cag(45, 90)));
   }

   private static void b(byj<cpk> $$0) {
      $$0.a(
         ctg.b,
         ImmutableList.of(
            Pair.of(0, cbm.a(($$0x, $$1) -> $$1.eb().c(cgl.C))),
            Pair.of(1, cbm.a(($$0x, $$1) -> $$1.t())),
            Pair.of(2, new cpl.a(20, 40)),
            Pair.of(3, new cax(ImmutableList.of(Pair.of(new bzk(20, 100), 1), Pair.of(cas.a(0.6F), 2))))
         )
      );
   }

   private static void b(cpk $$0, byj<cpk> $$1) {
      $$1.a(
         ctg.k,
         ImmutableList.of(
            Pair.of(0, cbp.a(chr.a($$0, 100).negate()::test)), Pair.of(1, new cpo()), Pair.of(2, new cpn()), Pair.of(3, new cpp()), Pair.of(4, new cpq())
         ),
