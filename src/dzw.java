...
public class dzw extends dzz<dzv> {
   public dzw(Codec<dzv> $$0) {
      super($$0);
   }

   public boolean a(dzv $$0, azh $$1) {
      return $$1.i() <= $$0.l;
   }

   public boolean a(dzu $$0, dzv $$1, dty $$2, Function<iz, ji<dcx>> $$3, azh $$4, dxg $$5, dbf $$6, dtx $$7) {
      ...
      for (int $$10 = 0; $$10 < $$9; $$10++) {
         ...
         dzz.a $$17 = ($$1x, $$2x, $$3x, $$4x, $$5x) -> a($$2x, $$3x, $$4x, $$16);
         int $$18 = 1;
         if ($$4.a(4) == 0) {
   ...
   protected void a(
      dzu $$0, dzv $$1, dty $$2, Function<iz, ji<dcx>> $$3, dxg $$4, double $$5, double $$6, double $$7, float $$8, double $$9, dtx $$10, dzz.a $$11
   ) {
