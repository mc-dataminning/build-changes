...
public class dzw extends LongLinkedOpenHashSet {
   private final dzw.a a;

   public dzw(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new dzw.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = aro.f(60000000);
      private static final int b = aro.f(60000000);
