...
public class dzw<T> implements dzy<T> {
   ...
   private dzw(jv<T> $$0, int $$1, dzz<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private dzw(jv<T> $$0, T[] $$1, dzz<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   public dzy<T> a(dzz<T> $$0) {
      return new dzw<>(this.a, (T[])((Object[])this.b.clone()), $$0, this.d, this.e);
   }
}
