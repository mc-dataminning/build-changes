public class dzw {
   ...
   private int a(dhf $$0, int $$1, int $$2, int $$3) {
      int $$4 = hw.c($$0.g($$1) + 1);
      gw.a $$5 = this.e.d($$2, $$4, $$3);
      gw.a $$6 = this.f.a($$5, ha.a);
      dfj $$7 = csw.a.n();
   ...
   public boolean a(cpb $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(cpb $$0, int $$1, int $$2, gw $$3, dfj $$4, gw $$5, dfj $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(cpb $$0, gw $$1, dfj $$2) {
      gw.a $$3 = this.e.g($$1);
      gw.a $$4 = this.f.a($$1, ha.a);
      dfj $$5 = $$2;
   ...
   private static boolean a(cpb $$0, gw $$1, dfj $$2, gw $$3, dfj $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         eig $$5 = ead.a($$0, $$1, $$2, ha.a);
         eig $$6 = ead.a($$0, $$3, $$4, ha.b);
         return eid.b($$5, $$6);
      }
   }
