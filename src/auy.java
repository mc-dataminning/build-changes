...
public class auy extends azc {
   public auy(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", baa.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(baa.s, "minecraft:jukebox");
