...
public class auy implements auu {
   ...
   private final Map<String, auv> c;
   private final List<atr> d;

   public auy(att $$0, List<atr> $$1) {
      this.d = List.copyOf($$1);
      Map<String, auv> $$2 = new HashMap<>();
      List<String> $$3 = $$1.stream().flatMap($$1x -> $$1x.a($$0).stream()).distinct().toList();

      for (atr $$4 : $$1) {
         ave $$5 = this.a($$4);
         Set<String> $$6 = $$4.a($$0);
         Predicate<ali> $$7 = $$5 != null ? $$1x -> $$5.b($$1x.a()) : null;
   ...
   public Map<ali, avd> b(String $$0, Predicate<ali> $$1) {
      a($$0);
      Map<ali, avd> $$2 = new TreeMap<>();

      for (auv $$3 : this.c.values()) {
         $$2.putAll($$3.b($$0, $$1));
      }
   ...
   public Map<ali, List<avd>> c(String $$0, Predicate<ali> $$1) {
      a($$0);
      Map<ali, List<avd>> $$2 = new TreeMap<>();
