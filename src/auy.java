...
public class auy extends auw {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, auy.a> s;
   private final aus t;
   private long u;
   private final alb v;

   private auy(alb $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aut.c($$2, 7, $$0.getLength());
      }
   }
