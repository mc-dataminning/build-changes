...
public class chz extends btp implements cjt {
   private static final Logger cd = LogUtils.getLogger();
   public static final akj<Integer> b = akn.a(chz.class, akl.b);
   private static final cee ce = cee.a().a(64.0);
   ...
   public int d = -1;
   private final chx[] ck;
   public final chx e;
   private final chx cl;
   private final chx cm;
   private final chx cn;
   private final chx co;
   private final chx cp;
   private final chx cq;
   private final chx cr;
   public float bX;
   public float bY;
   public boolean bZ;
   public int ca;
   ...
   private dvv cs;
   private iz ct = iz.c;
   private final ciq cu;
   private int cv = 100;
   private float cw;
   private final eof[] cx = new eof[24];
   private final int[] cz = new int[24];
   private final eod cA = new eod();

   public chz(bsy<? extends chz> $$0, dbw $$1) {
      super(bsy.F, $$1);
      this.e = new chx(this, "head", 1.0F, 1.0F);
      this.cl = new chx(this, "neck", 3.0F, 3.0F);
      this.cm = new chx(this, "body", 5.0F, 3.0F);
      this.cn = new chx(this, "tail", 2.0F, 2.0F);
      this.co = new chx(this, "tail", 2.0F, 2.0F);
      this.cp = new chx(this, "tail", 2.0F, 2.0F);
      this.cq = new chx(this, "wing", 4.0F, 2.0F);
      this.cr = new chx(this, "wing", 4.0F, 2.0F);
      this.ck = new chx[]{this.e, this.cl, this.cm, this.cn, this.co, this.cp, this.cq, this.cr};
      this.t(this.eR());
      this.ag = true;
      this.au = true;
      this.cu = new ciq(this);
   }
   ...
   public static buu.a u() {
      return btp.A().a(buv.q, 200.0);
   }

   @Override
   public boolean aV() {
      float $$0 = ayx.b(this.bY * (float) (Math.PI * 2));
      float $$1 = ayx.b(this.bX * (float) (Math.PI * 2));
   ...
   public void aU() {
      if (this.dP().B && !this.aW()) {
         this.dP().a(this.du(), this.dw(), this.dA(), avz.id, this.de(), 5.0F, 0.8F + this.ah.i() * 0.3F, false);
      }
   }
   ...
   public double[] a(int $$0, float $$1) {
      ...
      double $$5 = this.c[$$2][0];
      double $$6 = ayx.d(this.c[$$3][0] - $$5);
      $$4[0] = $$5 + $$6 * (double)$$1;
      $$5 = this.c[$$2][1];
      $$6 = this.c[$$3][1] - $$5;
      $$4[1] = $$5 + $$6 * (double)$$1;
      $$4[2] = ayx.d((double)$$1, this.c[$$2][2], this.c[$$3][2]);
      return $$4;
   }
   ...
   public void n_() {
      ...
      if (this.dP().B) {
         ...
         if (!this.aW() && !this.cu.a().a() && --this.cv < 0) {
            this.dP().a(this.du(), this.dw(), this.dA(), avz.ie, this.de(), 2.5F, 0.8F + this.ah.i() * 0.3F, false);
            this.cv = 200 + this.ah.a(200);
         }
      }

      if (this.cs == null && this.dP() instanceof are $$0) {
         dvv $$1 = $$0.D();
         ...
         if (this.gg()) {
            ...
            if (this.dP().B) {
               ...
               if ($$9 != null) {
                  ...
                  if ($$15 > 0.0) {
                     $$11 = ayx.a($$11 / $$15, (double)(-$$14), (double)$$14);
                  }

                  this.h(this.ds().b(0.0, $$11 * 0.01, 0.0));
                  this.r(ayx.g(this.dF()));
                  evp $$16 = $$9.a(this.du(), this.dw(), this.dA()).d();
                  evp $$17 = new evp((double)ayx.a(this.dF() * (float) (Math.PI / 180.0)), this.ds().d, (double)(-ayx.b(this.dF() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$18 = Math.max(((float)$$17.b($$16) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$10) > 1.0E-5F || Math.abs($$12) > 1.0E-5F) {
                     float $$19 = ayx.a(ayx.g(180.0F - (float)ayx.d($$10, $$12) * (180.0F / (float)Math.PI) - this.dF()), -50.0F, 50.0F);
                     this.cb *= 0.8F;
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new evp(0.0, 0.0, -1.0));
                  if (this.bZ) {
            ...
            this.aY = this.dF();
            evp[] $$24 = new evp[this.ck.length];

            for (int $$25 = 0; $$25 < this.ck.length; $$25++) {
               $$24[$$25] = new evp(this.ck[$$25].du(), this.ck[$$25].dw(), this.ck[$$25].dA());
            }
            ...
            if (!this.dP().B && this.aO == 0) {
               this.b(this.dP().a(this, this.cq.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bsx.e));
               this.b(this.dP().a(this, this.cr.cK().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bsx.e));
               this.c(this.dP().a(this, this.e.cK().g(1.0), bsx.e));
               this.c(this.dP().a(this, this.cl.cK().g(1.0), bsx.e));
            }

            float $$32 = ayx.a(this.dF() * (float) (Math.PI / 180.0) - this.cb * 0.01F);
            float $$33 = ayx.b(this.dF() * (float) (Math.PI / 180.0) - this.cb * 0.01F);
            float $$34 = this.gp();
   ...
   private void a(chx $$0, double $$1, double $$2, double $$3) {
   ...
   private void gq() {
      ...
      if (this.ah.a(10) == 0) {
         List<chy> $$0 = this.dP().a(chy.class, this.cK().g(32.0));
         chy $$1 = null;
   ...
   private void b(List<bss> $$0) {
      ...
      for (bss $$3 : $$0) {
         if ($$3 instanceof btn) {
            ...
            if (!this.cu.a().a() && ((btn)$$3).en() < $$3.ai - 2) {
               $$3.a(this.dQ().b((btn)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bss> $$0) {
      for (bss $$1 : $$0) {
         if ($$1 instanceof btn) {
            $$1.a(this.dQ().b((btn)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dsa $$13 = this.dP().a_($$12);
               if (!$$13.i() && !$$13.a(awo.aD)) {
                  if (this.dP().ab().b(dbs.c) && !$$13.a(awo.aC)) {
   ...
   public boolean a(chx $$0, brl $$1, float $$2) {
      if (this.cu.a().i() == cip.j) {
         return false;
      } else {
         $$2 = this.cu.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof cmv || $$1.a(awq.z)) {
               float $$3 = this.eA();
               this.g($$1, $$2);
   ...
   protected boolean g(brl $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void eg() {
      ...
      if (this.dP() instanceof are) {
         if (this.ca > 150 && this.ca % 5 == 0 && $$3) {
            btd.a((are)this.dP(), this.dn(), ayx.d((float)$$4 * 0.08F));
         }
      ...
      this.a(bts.a, new evp(0.0, 0.1F, 0.0));
      if (this.ca == 200 && this.dP() instanceof are) {
         if ($$3) {
            btd.a((are)this.dP(), this.dn(), ayx.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cx[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$4;
            if ($$0 < 12) {
               $$3 = ayx.d(60.0F * ayx.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
               $$4 = ayx.d(60.0F * ayx.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
            } else if ($$0 < 20) {
               int $$2 = $$0 - 12;
               $$3 = ayx.d(40.0F * ayx.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$4 = ayx.d(40.0F * ayx.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$1 += 10;
            } else {
               int var7 = $$0 - 20;
               $$3 = ayx.d(20.0F * ayx.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
               $$4 = ayx.d(20.0F * ayx.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
            }

            int $$9 = Math.max(this.dP().z_() + 10, this.dP().a(dxs.a.f, new iz($$3, 0, $$4)).v() + $$1);
            this.cx[$$0] = new eof($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      eof $$5 = new eof(ayx.a($$0), ayx.a($$1), ayx.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public eoh a(int $$0, int $$1, @Nullable eof $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         eof $$4 = this.cx[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private eoh a(eof $$0, eof $$1) {
      List<eof> $$2 = Lists.newArrayList();
      eof $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new eoh($$2, new iz($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(ur $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cu.a(cip.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      cij $$3 = this.cu.a();
      cip<? extends cij> $$4 = $$3.i();
      double $$7;
      if ($$4 == cip.d || $$4 == cip.e) {
         iz $$5 = this.dP().a(dxs.a.f, eav.a(this.ct));
   ...
   public evp F(float $$0) {
      cij $$1 = this.cu.a();
      cip<? extends cij> $$2 = $$1.i();
      evp $$8;
      if ($$2 == cip.d || $$2 == cip.e) {
         iz $$3 = this.dP().a(dxs.a.f, eav.a(this.ct));
   ...
   public void a(chy $$0, iz $$1, brl $$2) {
      cmv $$3;
