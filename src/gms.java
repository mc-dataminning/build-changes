...
public class gms implements gmv.a, AutoCloseable {
   ...
   ewy[] f;
   @Nullable
   private final gms.a g;
   private final att h;

   public gms(akh $$0, gol $$1, ewy $$2, att $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      goj $$4 = $$3.a(goj.a).orElse(goj.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ewy[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = gmn.a(this.f, $$0);
   ...
   @Nullable
   private gms.a a(gol $$0, int $$1, int $$2, goj $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<gms.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new gms.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new gms.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<gms.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            gms.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new gms.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ewy[] $$4) {
   ...
   class a {
      ...
      a(List<gms.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * gms.this.c;
         int $$4 = this.b($$2) * gms.this.d;
         gms.this.a($$0, $$1, $$3, $$4, gms.this.f);
      }

      public gmu a() {
         return gms.this.new d(this, this.d ? gms.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ewy[] b = new ewy[gms.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = gms.this.c >> $$0;
            int $$2 = gms.this.d >> $$0;
            this.b[$$0] = new ewy($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, gms.d $$2) {
         gms.a $$3 = $$2.d;
         List<gms.b> $$4 = $$3.b;
         gms.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            gms.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(gms.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return gms.this.f[$$2].a($$3 + ($$0.a($$1) * gms.this.c >> $$2), $$4 + ($$0.b($$1) * gms.this.d >> $$2));
      }
   ...
   class d implements gmu {
      int b;
      int c;
      final gms.a d;
      @Nullable
      private final gms.c e;

      d(gms.a $$0, @Nullable gms.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
