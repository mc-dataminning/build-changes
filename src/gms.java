...
public class gms {
   ...
   public static class b extends goi {
      b(gjz $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
   ...
   static class c extends gnu {
      ...
      c(gjz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gnk $$7, god $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            gms.c $$0 = new gms.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements gnl<mb> {
      ...
      public gni a(mb $$0, gjz $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gms.c $$8 = new gms.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, foz.Q().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends gng {
      ...
      private int D;
      private final gnk E;
      private final List<dbr> F;
      private boolean G;

      public e(gjz $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gnk $$7, List<dbr> $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         ...
         if (this.D % 2 == 0 && this.D / 2 < this.F.size()) {
            ...
            int $$11 = $$9.getInt(0);
            gni $$12 = this.E.a(lx.P, this.g, this.h, this.i, 0.0, 0.0, 0.0);
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, IntList $$6, IntList $$7, boolean $$8, boolean $$9) {
         gms.c $$10 = (gms.c)this.E.a(lx.D, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
