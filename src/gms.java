...
public class gms {
   ...
   private final dgz b;
   private final gmt c;
   private final Map<ji, hjo> d = new HashMap<>();

   public gms(fmg $$0, dgz $$1, gmt $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
   }
      ...
      switch ($$0) {
         ...
         case 1038:
            ...
            if ($$3.h()) {
               ...
               fbx $$5 = $$3.b().e($$4.c(2.0));
               if ($$0 == 1023) {
                  this.b.a($$5.d, $$5.e, $$5.f, awa.DF, awb.f, 1.0F, 1.0F, false);
               } else if ($$0 == 1038) {
   ...
   public void b(int $$0, ji $$1, int $$2) {
      ...
      switch ($$0) {
         ...
         case 1009:
            ...
            break;
         case 1010:
            this.b.F_().e(mc.L).c($$2).ifPresent($$1x -> this.a($$1x, $$1));
            break;
         case 1011:
            this.b($$1);
            break;
         ...
         case 1019:
            ...
            break;
         case 1020:
            this.b.a($$1, awa.Et, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1021:
            this.b.a($$1, awa.Eu, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1022:
            this.b.a($$1, awa.Dx, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1024:
            this.b.a($$1, awa.DA, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1025:
            this.b.a($$1, awa.bJ, awb.g, 0.05F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1026:
            this.b.a($$1, awa.EC, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1027:
         ...
         case 1031:
            ...
            break;
         case 1032:
            this.a.ak().a(hjj.b(awa.vs, $$3.i() * 0.4F + 0.8F, 0.25F));
            break;
         case 1033:
         ...
         case 1035:
            ...
            break;
         case 1039:
            this.b.a($$1, awa.uf, awb.f, 0.3F, this.b.A.i() * 0.1F + 0.9F, false);
            break;
         case 1040:
            this.b.a($$1, awa.Ev, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1041:
         ...
         case 1043:
            ...
            break;
         case 1044:
            this.b.a($$1, awa.zh, awb.e, 1.0F, this.b.A.i() * 0.1F + 0.9F, false);
            break;
         case 1045:
         ...
         case 1047:
            ...
            break;
         case 1048:
            this.b.a($$1, awa.xM, awb.f, 2.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, false);
            break;
         case 1049:
         ...
         case 1050:
            ...
            break;
         case 1051:
            this.b.a($$1, awa.Dp, awb.e, 0.5F, 0.4F / (this.b.C_().i() * 0.4F + 0.8F), false);
            break;
         case 1500:
            dlp.a(this.b, $$1, $$2 > 0);
            break;
         case 1501:
            this.b.a($$1, awa.ot, awb.e, 0.5F, 2.6F + ($$3.i() - $$3.i()) * 0.8F, false);

            for (int $$60 = 0; $$60 < 8; $$60++) {
               this.b.a(lt.aa, (double)$$1.u() + $$3.j(), (double)$$1.v() + 1.2, (double)$$1.w() + $$3.j(), 0.0, 0.0, 0.0);
            }
            break;
         case 1502:
            this.b.a($$1, awa.wf, awb.e, 0.5F, 2.6F + ($$3.i() - $$3.i()) * 0.8F, false);

            for (int $$61 = 0; $$61 < 5; $$61++) {
               double $$62 = (double)$$1.u() + $$3.j() * 0.6 + 0.2;
               double $$63 = (double)$$1.v() + $$3.j() * 0.6 + 0.2;
               double $$64 = (double)$$1.w() + $$3.j() * 0.6 + 0.2;
               this.b.a(lt.ah, $$62, $$63, $$64, 0.0, 0.0, 0.0);
            }
            break;
         case 1503:
            ...
            for (int $$65 = 0; $$65 < 16; $$65++) {
               ...
               this.b.a(lt.ah, $$66, $$67, $$68, 0.0, 0.0, 0.0);
            }
            break;
         case 1504:
            dqa.a(this.b, $$1, this.b.a_($$1));
            break;
         case 1505:
            cvq.a(this.b, $$1, $$2);
         ...
         case 2007:
            ...
            for (int $$10 = 0; $$10 < 8; $$10++) {
               this.c.a(new lp(lt.U, new cxh(cxl.wq)), $$9.d, $$9.e, $$9.f, $$3.k() * 0.15, $$3.j() * 0.2, $$3.k() * 0.15);
            }

            float $$11 = (float)($$2 >> 16 & 0xFF) / 255.0F;
            float $$12 = (float)($$2 >> 8 & 0xFF) / 255.0F;
            float $$13 = (float)($$2 >> 0 & 0xFF) / 255.0F;
            lr $$14 = $$0 == 2007 ? lt.T : lt.p;
            ...
            for (int $$15 = 0; $$15 < 100; $$15++) {
               ...
               gkg $$21 = this.c.b($$14, $$14.a().b(), $$9.d + $$18 * 0.1, $$9.e + 0.3, $$9.f + $$20 * 0.1, $$18, $$19, $$20);
               if ($$21 != null) {
            ...
            this.b.a($$1, awa.zN, awb.g, 1.0F, $$3.i() * 0.1F + 0.9F, false);
            break;
         case 2003:
            ...
            for (int $$7 = 0; $$7 < 8; $$7++) {
               this.c.a(new lp(lt.U, new cxh(cxl.tr)), $$4, $$5, $$6, $$3.k() * 0.15, $$3.j() * 0.2, $$3.k() * 0.15);
            }

            for (double $$8 = 0.0; $$8 < Math.PI * 2; $$8 += Math.PI / 20) {
               this.c.a(lt.af, $$4 + Math.cos($$8) * 5.0, $$5 - 0.4, $$6 + Math.sin($$8) * 5.0, Math.cos($$8) * -5.0, 0.0, Math.sin($$8) * -5.0);
               this.c.a(lt.af, $$4 + Math.cos($$8) * 5.0, $$5 - 0.4, $$6 + Math.sin($$8) * 5.0, Math.cos($$8) * -7.0, 0.0, Math.sin($$8) * -7.0);
            }
            break;
         case 2004:
            for (int $$27 = 0; $$27 < 20; $$27++) {
               ...
               this.b.a(lt.ah, $$28, $$29, $$30, 0.0, 0.0, 0.0);
         ...
         case 2006:
            for (int $$69 = 0; $$69 < 200; $$69++) {
               ...
               gkg $$75 = this.c.b(lt.h, false, (double)$$1.u() + $$72 * 0.1, (double)$$1.v() + 0.3, (double)$$1.w() + $$74 * 0.1, $$72, $$73, $$74);
               if ($$75 != null) {
                  $$75.c($$70);
               }
            }
         ...
         case 3002:
            if ($$2 >= 0 && $$2 < jn.a.d.length) {
               azd.a(jn.a.d[$$2], this.b, $$1, 0.125, lt.aW, bsj.a(10, 19));
            } else {
               azd.a(this.b, $$1, lt.aW, bsj.a(3, 5));
            }
            break;
         case 3003:
            azd.a(this.b, $$1, lt.aU, bsj.a(3, 5));
            this.b.a($$1, awa.na, awb.e, 1.0F, 1.0F, false);
            break;
         case 3004:
            azd.a(this.b, $$1, lt.aV, bsj.a(3, 5));
            break;
         case 3005:
            azd.a(this.b, $$1, lt.aX, bsj.a(3, 5));
            break;
         case 3006:
            int $$36 = $$2 >> 6;
            if ($$36 > 0) {
               if ($$3.i() < 0.3F + (float)$$36 * 0.1F) {
                  ...
                  this.b.a($$1, awa.wE, awb.e, $$37, $$38, false);
               }

               byte $$39 = (byte)($$2 & 63);
               bsd $$40 = bsj.a(0, $$36);
               float $$41 = 0.005F;
               Supplier<fbx> $$42 = () -> new fbx(ayz.a($$3, -0.005F, 0.005F), ayz.a($$3, -0.005F, 0.005F), ayz.a($$3, -0.005F, 0.005F));
               if ($$39 == 0) {
                  for (jn $$43 : jn.values()) {
               ...
               this.b.a($$1, awa.wE, awb.e, 1.0F, 1.0F, false);
         ...
         case 3007:
            for (int $$57 = 0; $$57 < 10; $$57++) {
               this.b.a(new lw($$57 * 5), (double)$$1.u() + 0.5, (double)$$1.v() + drd.e, (double)$$1.w() + 0.5, 0.0, 0.0, 0.0);
            }

            dxq $$58 = this.b.a_($$1);
            boolean $$59 = $$58.b(dyg.I) && $$58.c(dyg.I);
            if (!$$59) {
               this.b.a((double)$$1.u() + 0.5, (double)$$1.v() + drd.e, (double)$$1.w() + 0.5, awa.xb, awb.e, 2.0F, 0.6F + this.b.A.i() * 0.4F, false);
            }
            break;
         case 3008:
            dxq $$25 = dke.a($$2);
            ...
            break;
         case 3009:
            azd.a(this.b, $$1, lt.aZ, bsj.a(3, 6));
            break;
         case 3011:
            dws.a(this.b, $$1, $$3, dws.a.a($$2).c);
            break;
         case 3012:
         ...
         case 3014:
            ...
            break;
         case 3015:
            if (this.b.c_($$1) instanceof dwy $$31) {
               dwy.a.a(this.b, $$31.aA_(), $$31.m(), $$31.c(), $$2 == 0 ? lt.aM : lt.N);
               this.b.a($$1, awa.By, awb.e, 1.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, true);
            }
            break;
         case 3016:
            dwy.a.a(this.b, $$1, $$2 == 0 ? lt.aM : lt.N);
            this.b.a($$1, awa.BC, awb.e, 1.0F, ($$3.i() - $$3.i()) * 0.2F + 1.0F, true);
            break;
         case 3017:
            dws.b(this.b, $$1, $$3);
            break;
         case 3018:
            for (int $$32 = 0; $$32 < 10; $$32++) {
               ...
               double $$34 = $$3.k() * 0.02;
               double $$35 = $$3.k() * 0.02;
               this.b.a(lt.ae, (double)$$1.u() + $$3.j(), (double)$$1.v() + $$3.j(), (double)$$1.w() + $$3.j(), $$33, $$34, $$35);
            }
   ...
   private void a(jr<cxn> $$0, ji $$1) {
      this.a($$1);
      cxn $$2 = $$0.a();
      avz $$3 = $$2.b().a();
      hjo $$4 = hjj.a($$3, fbx.b($$1));
      this.d.put($$1, $$4);
      this.a.ak().a($$4);
      this.a.m.a($$2.c());
   ...
   private void a(dgz $$0, ji $$1, boolean $$2) {
      for (bvy $$4 : $$0.a(bvy.class, new fbs($$1).g(3.0))) {
         $$4.a($$1, $$2);
      }
   }
}
