...
public class gms {
   ...
   public final Map<jm, gmt> c;
   public final gmu d;
   public final boolean e;
   public final int f;

   public gms(Vector3f $$0, Vector3f $$1, Map<jm, gmt> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gms(Vector3f $$0, Vector3f $$1, Map<jm, gmt> $$2, @Nullable gmu $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jm, gmt> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gms> {
      ...
      public gms a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         if ($$3.has("shade") && !azu.c($$3, "shade")) {
            ...
            return new gms($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gmu a(JsonObject $$0) {
         gmu $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<jm, gmt> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gmt> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jm, gmt> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gmt> $$2 = Maps.newEnumMap(jm.class);
         JsonObject $$3 = azu.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jm $$5 = this.a($$4.getKey());
            $$2.put($$5, (gmt)$$0.deserialize($$4.getValue(), gmt.class));
         }
