...
public abstract class fkf<E extends fkf.a<E>> extends fkc {
   protected static final int b = 6;
   private static final alc a = alc.b("widget/scroller");
   private static final alc m = alc.b("widget/scroller_background");
   private static final alc n = alc.b("textures/gui/menu_list_background.png");
   private static final alc o = alc.b("textures/gui/inworld_menu_list_background.png");
   protected final fil c;
   protected final int d;
   private final List<E> p = new fkf.b();
   ...
   public fkf(fil $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, xc.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = azd.a($$1 - (double)this.E()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
   ...
   public void b(fjx $$0, int $$1, int $$2, float $$3) {
      ...
      if (this.m()) {
         ...
         $$7 = azd.a($$7, 32, this.h - 8);
         int $$8 = (int)this.n() * (this.h - $$7) / this.p() + this.E();
         if ($$8 < this.E()) {
            $$8 = this.E();
         }

         $$0.a(ghq::B, m, $$6, this.E(), 6, this.w());
         $$0.a(ghq::B, a, $$6, $$8, 6, $$7);
      }
   ...
   protected void a(fjx $$0) {
      alc $$1 = this.c.s == null ? fqd.h : fqd.j;
      alc $$2 = this.c.s == null ? fqd.i : fqd.k;
      $$0.a(ghq::B, $$1, this.D(), this.E() - 2, 0.0F, 0.0F, this.y(), 2, 32, 2);
      $$0.a(ghq::B, $$2, this.D(), this.G(), 0.0F, 0.0F, this.y(), 2, 32, 2);
   }

   protected void b(fjx $$0) {
      alc $$1 = this.c.s == null ? n : o;
      $$0.a(ghq::B, $$1, this.D(), this.E(), (float)this.F(), (float)(this.G() + (int)this.n()), this.y(), this.w(), 32, 32);
   }
   ...
   public void a(double $$0) {
      this.q = azd.a($$0, 0.0, (double)this.p());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.E()) {
            ...
            int $$6 = this.h;
            int $$7 = azd.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(fop $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fop $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(fjx $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public fof.a u() {
      if (this.aM_()) {
         ...
         return this.v != null ? fof.a.b : fof.a.a;
      }
   }
   ...
   protected void a(foh $$0, E $$1) {
      List<E> $$2 = this.aI_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fog.b, xd.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fkf.a<E>> implements fmh {
      @Deprecated
      fkf<E> a;
      ...
      public abstract void a(fjx var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
