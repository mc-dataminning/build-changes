...
public class fkf {
   ...
   public void a(fkf.b $$0, List<atp> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new fkf.c($$0, $$1.stream().map(atp::b).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new fkf.c(fkf.b.c, ImmutableList.of());
      }

      this.b.c = new fkf.a($$0);
   }
   ...
   static class c {
      private final fkf.b a;
      private final List<String> b;
      @Nullable
      fkf.a c;
      boolean d;

      c(fkf.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
