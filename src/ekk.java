...
public class ekk {
   ...
   public static final ekk.a bv;

   public static ekk.a a(int $$0, int $$1) {
      return $$0 == -1 ? ekk.b.b.a($$1) : ekk.b.a.a($$0);
   }

   public static ekk.a a(String $$0) {
      if (ekk.a.e.containsKey($$0)) {
         return ekk.a.e.get($$0);
      } else {
         for (ekk.b $$1 : ekk.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static enum b {
      ...
      public ekk.a a(int $$0) {
         return (ekk.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
