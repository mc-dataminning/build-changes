...
public class elt {
   ...
   private static elt.c a(eju $$0, ayw $$1, int $$2, int $$3, int $$4, @Nullable ji $$5, int $$6, elu.a $$7) {
      int $$8 = $$1.a(100);
      if ($$8 >= 80) {
         ejh $$9 = elt.b.a($$0, $$1, $$2, $$3, $$4, $$5);
         if ($$9 != null) {
            return new elt.b($$6, $$9, $$5, $$7);
         }
      } else if ($$8 >= 70) {
         ejh $$10 = elt.e.a($$0, $$1, $$2, $$3, $$4, $$5);
         if ($$10 != null) {
            return new elt.e($$6, $$10, $$5, $$7);
         }
      } else {
         ejh $$11 = elt.a.a($$0, $$1, $$2, $$3, $$4, $$5);
         if ($$11 != null) {
            return new elt.a($$6, $$1, $$11, $$5, $$7);
         }
      }
   ...
   static elt.c a(ejt $$0, eju $$1, ayw $$2, int $$3, int $$4, int $$5, ji $$6, int $$7) {
      if ($$7 > 8) {
         return null;
      } else if (Math.abs($$3 - $$0.f().h()) <= 80 && Math.abs($$5 - $$0.f().j()) <= 80) {
         elu.a $$8 = ((elt.c)$$0).a;
         elt.c $$9 = a($$1, $$2, $$3, $$4, $$5, $$6, $$7 + 1, $$8);
         if ($$9 != null) {
            $$1.a($$9);
            $$9.a($$0, $$1, $$2);
         }
   ...
   public static class a extends elt.c {
      ...
      public a(int $$0, ayw $$1, ejh $$2, ji $$3, elu.a $$4) {
         super(ekg.a, $$0, $$4, $$2);
         this.a($$3);
         this.b = $$1.a(3) == 0;
      ...
      public static ejh a(eju $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5) {
         for (int $$6 = $$1.a(3) + 2; $$6 > 0; $$6--) {
            ...
            ejh $$11 = switch ($$5) {
               default -> new ejh(0, 0, -($$7 - 1), 2, 2, 0);
               case d -> new ejh(0, 0, 0, 2, 2, $$7 - 1);
               case e -> new ejh(-($$7 - 1), 0, 0, 0, 2, 2);
               case f -> new ejh(0, 0, 0, $$7 - 1, 2, 2);
            };
            $$11.a($$2, $$3, $$4);
            if ($$0.a($$11) == null) {
               return $$11;
      ...
      public void a(ejt $$0, eju $$1, ayw $$2) {
         ...
         if ($$5 != null) {
            switch ($$5) {
               ...
               default:
                  if ($$4 <= 1) {
                     elt.a($$0, $$1, $$2, this.f.h(), this.f.i() - 1 + $$2.a(3), this.f.j() - 1, $$5, $$3);
                  } else if ($$4 == 2) {
                     elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() - 1 + $$2.a(3), this.f.j(), ji.e, $$3);
                  } else {
                     elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() - 1 + $$2.a(3), this.f.j(), ji.f, $$3);
                  }
                  break;
               case d:
                  if ($$4 <= 1) {
                     elt.a($$0, $$1, $$2, this.f.h(), this.f.i() - 1 + $$2.a(3), this.f.m() + 1, $$5, $$3);
                  } else if ($$4 == 2) {
                     elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() - 1 + $$2.a(3), this.f.m() - 3, ji.e, $$3);
                  } else {
                     elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() - 1 + $$2.a(3), this.f.m() - 3, ji.f, $$3);
                  }
                  break;
               case e:
                  if ($$4 <= 1) {
                     elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() - 1 + $$2.a(3), this.f.j(), $$5, $$3);
                  } else if ($$4 == 2) {
                     elt.a($$0, $$1, $$2, this.f.h(), this.f.i() - 1 + $$2.a(3), this.f.j() - 1, ji.c, $$3);
                  } else {
                     elt.a($$0, $$1, $$2, this.f.h(), this.f.i() - 1 + $$2.a(3), this.f.m() + 1, ji.d, $$3);
                  }
                  break;
               case f:
                  if ($$4 <= 1) {
                     elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() - 1 + $$2.a(3), this.f.j(), $$5, $$3);
                  } else if ($$4 == 2) {
                     elt.a($$0, $$1, $$2, this.f.k() - 3, this.f.i() - 1 + $$2.a(3), this.f.j() - 1, ji.c, $$3);
                  } else {
                     elt.a($$0, $$1, $$2, this.f.k() - 3, this.f.i() - 1 + $$2.a(3), this.f.m() + 1, ji.d, $$3);
                  }
            }
         }
         ...
         if ($$3 < 8) {
            if ($$5 != ji.c && $$5 != ji.d) {
               for (int $$8 = this.f.h() + 3; $$8 + 3 <= this.f.k(); $$8 += 5) {
                  int $$9 = $$2.a(5);
                  if ($$9 == 0) {
                     elt.a($$0, $$1, $$2, $$8, this.f.i(), this.f.j() - 1, ji.c, $$3 + 1);
                  } else if ($$9 == 1) {
                     elt.a($$0, $$1, $$2, $$8, this.f.i(), this.f.m() + 1, ji.d, $$3 + 1);
                  }
               }
            } else {
               for (int $$6 = this.f.j() + 3; $$6 + 3 <= this.f.m(); $$6 += 5) {
                  int $$7 = $$2.a(5);
                  if ($$7 == 0) {
                     elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i(), $$6, ji.e, $$3 + 1);
                  } else if ($$7 == 1) {
                     elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i(), $$6, ji.f, $$3 + 1);
                  }
               }
            }
         }
      ...
      public void a(dds $$0, ddq $$1, duz $$2, ayw $$3, ejh $$4, dcd $$5, jd $$6) {
         if (!this.a($$0, $$4)) {
            ...
            for (int $$13 = 0; $$13 < this.h; $$13++) {
               ...
               this.a($$0, $$4, $$3, 0.05F, 2, 2, $$14 + 2);
               if ($$3.a(100) == 0) {
                  this.a($$0, $$4, $$3, 2, 0, $$14 - 1, erl.u);
               }

               if ($$3.a(100) == 0) {
                  this.a($$0, $$4, $$3, 0, 0, $$14 + 1, erl.u);
               }
      ...
      private void a(dds $$0, ejh $$1, int $$2, int $$3, int $$4) {
         dtc $$5 = this.a.b();
         dtc $$6 = this.a.d();
      ...
      protected void c(dds $$0, dtc $$1, int $$2, int $$3, int $$4, ejh $$5) {
         jd.a $$6 = this.b($$2, $$3, $$4);
         if ($$5.b($$6)) {
            int $$7 = $$6.v();
            int $$8 = 1;
      ...
      private void a(dds $$0, ejh $$1, int $$2, int $$3, int $$4, int $$5, int $$6, ayw $$7) {
      ...
      private void a(dds $$0, ejh $$1, ayw $$2, float $$3, int $$4, int $$5, int $$6) {
         if (this.b($$0, $$4, $$5, $$6, $$1) && $$2.i() < $$3 && this.a($$0, $$1, $$4, $$5, $$6, 2)) {
            this.a($$0, dga.bs.o(), $$4, $$5, $$6, $$1);
         }
      }

      private boolean a(dds $$0, ejh $$1, int $$2, int $$3, int $$4, int $$5) {
         jd.a $$6 = this.b($$2, $$3, $$4);
         int $$7 = 0;
   ...
   public static class b extends elt.c {
      private final ji b;
      private final boolean c;
      ...
      public b(int $$0, ejh $$1, @Nullable ji $$2, elu.a $$3) {
         super(ekg.b, $$0, $$3, $$1);
         this.b = $$2;
         this.c = $$1.e() > 3;
      }
      ...
      public static ejh a(eju $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5) {
         ...
         ejh $$11 = switch ($$5) {
            default -> new ejh(-1, 0, -4, 3, $$6, 0);
            case d -> new ejh(-1, 0, 0, 3, $$6, 4);
            case e -> new ejh(-4, 0, -1, 0, $$6, 3);
            case f -> new ejh(0, 0, -1, 4, $$6, 3);
         };
         $$11.a($$2, $$3, $$4);
      ...
      public void a(ejt $$0, eju $$1, ayw $$2) {
         ...
         switch (this.b) {
            case c:
            default:
               elt.a($$0, $$1, $$2, this.f.h() + 1, this.f.i(), this.f.j() - 1, ji.c, $$3);
               elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i(), this.f.j() + 1, ji.e, $$3);
               elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i(), this.f.j() + 1, ji.f, $$3);
               break;
            case d:
               elt.a($$0, $$1, $$2, this.f.h() + 1, this.f.i(), this.f.m() + 1, ji.d, $$3);
               elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i(), this.f.j() + 1, ji.e, $$3);
               elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i(), this.f.j() + 1, ji.f, $$3);
               break;
            case e:
         ...
         if (this.c) {
            if ($$2.h()) {
               elt.a($$0, $$1, $$2, this.f.h() + 1, this.f.i() + 3 + 1, this.f.j() - 1, ji.c, $$3);
            }

            if ($$2.h()) {
               elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() + 3 + 1, this.f.j() + 1, ji.e, $$3);
            }

            if ($$2.h()) {
               elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() + 3 + 1, this.f.j() + 1, ji.f, $$3);
            }

            if ($$2.h()) {
               elt.a($$0, $$1, $$2, this.f.h() + 1, this.f.i() + 3 + 1, this.f.m() + 1, ji.d, $$3);
            }
         }
      }
      ...
      private void a(dds $$0, ejh $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   abstract static class c extends ejt {
      protected elu.a a;

      public c(ekg $$0, int $$1, elu.a $$2, ejh $$3) {
         super($$0, $$1, $$3);
         this.a = $$2;
      }
      ...
      protected boolean a(dcc $$0, ejh $$1, int $$2, int $$3, int $$4, int $$5) {
         for (int $$6 = $$2; $$6 <= $$3; $$6++) {
      ...
      protected boolean a(dcx $$0, ejh $$1) {
      ...
      protected void a(dds $$0, ejh $$1, dtc $$2, int $$3, int $$4, int $$5) {
         if (this.b($$0, $$3, $$4, $$5, $$1)) {
            jd $$6 = this.b($$3, $$4, $$5);
            dtc $$7 = $$0.a_($$6);
            if (!$$7.d($$0, $$6, ji.b)) {
   ...
   public static class d extends elt.c {
      private final List<ejh> b = Lists.newLinkedList();

      public d(int $$0, ayw $$1, int $$2, int $$3, elu.a $$4) {
         super(ekg.c, $$0, $$4, new ejh($$2, 50, $$3, $$2 + 7 + $$1.a(6), 54 + $$1.a(6), $$3 + 7 + $$1.a(6)));
         this.a = $$4;
      }

      public d(ub $$0) {
         super(ekg.c, $$0);
         ejh.a.listOf().parse(up.a, $$0.c("Entrances", 11)).resultOrPartial(elt.b::error).ifPresent(this.b::addAll);
      }
      ...
      public void a(ejt $$0, eju $$1, ayw $$2) {
         ...
         while ($$5 < this.f.d()) {
            ...
            elt.c $$6 = elt.a($$0, $$1, $$2, this.f.h() + $$5, this.f.i() + $$2.a($$4) + 1, this.f.j() - 1, ji.c, $$3);
            if ($$6 != null) {
               ejh $$7 = $$6.f();
               this.b.add(new ejh($$7.h(), $$7.i(), this.f.j(), $$7.k(), $$7.l(), this.f.j() + 1));
            }
         ...
         while ($$5 < this.f.d()) {
            ...
            elt.c $$8 = elt.a($$0, $$1, $$2, this.f.h() + $$5, this.f.i() + $$2.a($$4) + 1, this.f.m() + 1, ji.d, $$3);
            if ($$8 != null) {
               ejh $$9 = $$8.f();
               this.b.add(new ejh($$9.h(), $$9.i(), this.f.m() - 1, $$9.k(), $$9.l(), this.f.m()));
            }
         ...
         while ($$5 < this.f.f()) {
            ...
            elt.c $$10 = elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i() + $$2.a($$4) + 1, this.f.j() + $$5, ji.e, $$3);
            if ($$10 != null) {
               ejh $$11 = $$10.f();
               this.b.add(new ejh(this.f.h(), $$11.i(), $$11.j(), this.f.h() + 1, $$11.l(), $$11.m()));
            }
         ...
         while ($$5 < this.f.f()) {
            ...
            ejt $$12 = elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i() + $$2.a($$4) + 1, this.f.j() + $$5, ji.f, $$3);
            if ($$12 != null) {
               ejh $$13 = $$12.f();
               this.b.add(new ejh(this.f.k() - 1, $$13.i(), $$13.j(), this.f.k(), $$13.l(), $$13.m()));
            }
      ...
      protected void a(ekf $$0, ub $$1) {
         super.a($$0, $$1);
         ejh.a.listOf().encodeStart(up.a, this.b).resultOrPartial(elt.b::error).ifPresent($$1x -> $$1.a("Entrances", $$1x));
      }
   }

   public static class e extends elt.c {
      public e(int $$0, ejh $$1, ji $$2, elu.a $$3) {
         super(ekg.d, $$0, $$3, $$1);
         this.a($$2);
      }
      ...
      public static ejh a(eju $$0, ayw $$1, int $$2, int $$3, int $$4, ji $$5) {
         ejh $$9 = switch ($$5) {
            default -> new ejh(0, -5, -8, 2, 2, 0);
            case d -> new ejh(0, -5, 0, 2, 2, 8);
            case e -> new ejh(-8, -5, 0, 0, 2, 2);
            case f -> new ejh(0, -5, 0, 8, 2, 2);
         };
         $$9.a($$2, $$3, $$4);
      ...
      public void a(ejt $$0, eju $$1, ayw $$2) {
         ...
         if ($$4 != null) {
            switch ($$4) {
               case c:
               default:
                  elt.a($$0, $$1, $$2, this.f.h(), this.f.i(), this.f.j() - 1, ji.c, $$3);
                  break;
               case d:
                  elt.a($$0, $$1, $$2, this.f.h(), this.f.i(), this.f.m() + 1, ji.d, $$3);
                  break;
               case e:
                  elt.a($$0, $$1, $$2, this.f.h() - 1, this.f.i(), this.f.j(), ji.e, $$3);
                  break;
               case f:
                  elt.a($$0, $$1, $$2, this.f.k() + 1, this.f.i(), this.f.j(), ji.f, $$3);
            }
         }
      }
