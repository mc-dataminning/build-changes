...
public class elt {
   ...
   public void a(end $$0, String $$1, eoa.a $$2, ebx $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  elt.b $$13 = new elt.b($$1.trim(), this.f, $$3, $$2);
                  elt.a $$14 = new elt.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        elt.c $$30 = new elt.c(this.f, $$2, $$0);
                        elt.a $$31 = new elt.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new enh(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ebx $$2) throws IOException {
      ...
      File $$15 = new File(eqm.O().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final ebx d;
      private final eoa.a e;

      b(String $$0, File $$1, ebx $$2, eoa.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((elt.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !elt.this.b && !elt.this.d) {
            try {
               elt.this.e = true;
               elt.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               elt.a.error("Error extracting archive", var3);
               elt.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final eoa.a c;
      private final end d;

      c(File $$0, eoa.a $$1, end $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((elt.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !elt.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, elt.this.g);
                  elt.this.c = true;
               } else {
                  elt.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  elt.this.d = true;
               }
            } catch (IOException var3) {
               elt.a.error("Error copying resourcepack file: {}", var3.getMessage());
               elt.this.d = true;
            }
         }
      }
