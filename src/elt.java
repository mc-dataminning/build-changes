...
public class elt extends elw {
   ...
   static final elt.b l = new elt.b(854, 480);

   public elt(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final elt.a[] e = values();
   ...
   static class b {
      ...
      static List<elt.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new elt.b($$0, $$1), elt.l) : ImmutableList.of(elt.l);
      }
