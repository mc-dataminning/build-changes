...
public class elt extends ely {
   ...
   public List<eke.a> a(dhg $$0, BiConsumer<jh, dxn> $$1, bam $$2, int $$3, jh $$4, ejo $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<elt.a> $$13 = Lists.newArrayList();
      $$13.add(new elt.a($$4.b($$12), $$11));
      ...
      List<eke.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dhg $$0, BiConsumer<jh, dxn> $$1, bam $$2, jh $$3, jh $$4, boolean $$5, ejo $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ...
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dqt.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dhg $$0, BiConsumer<jh, dxn> $$1, bam $$2, int $$3, jh $$4, List<elt.a> $$5, ejo $$6) {
      for (elt.a $$7 : $$5) {
         int $$8 = $$7.a();
