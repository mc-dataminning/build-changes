...
public class baw {
   ...
   private static final Optional<Object> b = Optional.of(bbh.a);

   private static boolean a(yd $$0, azl $$1, int $$2, char $$3) {
      return Character.isSurrogate($$3) ? $$1.accept($$2, $$0, 65533) : $$1.accept($$2, $$0, $$3);
   }

   public static boolean a(String $$0, yd $$1, azl $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean b(String $$0, yd $$1, azl $$2) {
      int $$3 = $$0.length();
   ...
   public static boolean c(String $$0, yd $$1, azl $$2) {
      return a($$0, 0, $$1, $$2);
   }

   public static boolean a(String $$0, int $$1, yd $$2, azl $$3) {
      return a($$0, $$1, $$2, $$2, $$3);
   }

   public static boolean a(String $$0, int $$1, yd $$2, yd $$3, azl $$4) {
      int $$5 = $$0.length();
      yd $$6 = $$2;
   ...
   public static boolean a(xl $$0, yd $$1, azl $$2) {
