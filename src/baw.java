...
public class baw extends bfm {
   public baw(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bgq.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bgq.s, "minecraft:jukebox");
