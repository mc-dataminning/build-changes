...
public class baw extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bgr.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bgr.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bgr.s);
