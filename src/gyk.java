...
public class gyk extends gvs<cjs, hem, ghn> {
   private static final Map<cjs.a, alg> a = Maps.newEnumMap(
      Map.of(
         cjs.a.a,
   ...
   public gyk(gwy.a $$0) {
      super($$0, new ghn($$0.a(gjs.bZ)), new ghn($$0.a(gjs.ca)), 0.9F);
      this.a(new hbi(this));
   }

   public alg a(hem $$0) {
      return a.getOrDefault($$0.a, a.get(cjs.a.a));
   }
   ...
   public void a(cjs $$0, hem $$1, float $$2) {
      super.a($$0, $$1, $$2);
      hdu.a($$0, $$1, this.h);
      $$1.a = $$0.gH();
      $$1.b = $$0.q() > 0;
   ...
   protected void a(hem $$0, fkd $$1, float $$2, float $$3) {
      super.a($$0, $$1, $$2, $$3);
      if ($$0.l > 0.0F) {
         float $$4 = azm.i($$0.l);
         int $$5 = azm.d($$0.l);
