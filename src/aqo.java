...
public class aqo<T> extends AbstractList<T> implements Serializable, Cloneable, Deque<T>, RandomAccess {
   ...
   class a implements Iterator<T> {
      ...
      @Override
      public T next() {
         return aqo.this.get(this.b--);
      }

      @Override
      public void remove() {
         aqo.this.remove(this.b + 1);
      }
   }
}
