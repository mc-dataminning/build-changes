...
public class aqo {
   ...
   public boolean a(dau $$0) {
      if ($$0 == this.b) {
         ...
         this.a($$0, this.e);
         this.d.y();
         this.d.e.ah().a(new adw(adw.a.c, this.d));
         this.c.e();
         if ($$0 == dau.b) {
            this.d.gE();
         }
   ...
   protected void a(dau $$0, @Nullable dau $$1) {
      this.e = $$1;
      this.b = $$0;
      $$0.a(this.d.gd());
   }
   ...
   private float a(drb $$0, io $$1, int $$2) {
      int $$3 = this.i - $$2;
   ...
   public void a(io $$0, ahh.a $$1, it $$2, int $$3, int $$4) {
      if (!this.d.a($$0, 1.0)) {
         ...
         this.d.d.b(new abz($$0, this.c.a_($$0)));
         ...
         if ($$1 == ahh.a.a) {
            ...
            if (!$$6.i() && $$5 >= 1.0F) {
               ...
               if (this.f) {
                  this.d.d.b(new abz(this.h, this.c.a_(this.h)));
   ...
   public boolean a(io $$0) {
      ...
      if (!this.d.eX().g().a($$1, this.c, $$0, this.d)) {
         ...
         dog $$2 = this.c.c_($$0);
         ddy $$3 = $$1.b();
         if ($$3 instanceof dhg && !this.d.gz()) {
            this.c.a($$0, $$1, $$1, 3);
            return false;
         } else if (this.d.a(this.c, $$0, this.b)) {
            return false;
         } else {
            drb $$4 = $$3.a(this.c, $$0, $$1, (clw)this.d);
