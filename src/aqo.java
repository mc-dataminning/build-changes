...
public class aqo extends aqn {
   ...
   private String q;
   private String r;
   private final Map<SocketAddress, aqo.a> s;
   private final aqj t;
   private long u;
   private final ahc v;

   private aqo(ahc $$0, int $$1) {
   ...
   private Boolean c(DatagramPacket $$0) {
      ...
      if (!this.s.containsKey($$1)) {
         ...
         byte[] $$2 = $$0.getData();
         return this.s.get($$1).a() == aqk.c($$2, 7, $$0.getLength());
      }
   }
