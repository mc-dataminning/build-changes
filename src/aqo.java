...
public class aqo<K> implements hj<K> {
   ...
   private aqo(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> aqo<A> c(int $$0) {
      return new aqo((int)((float)$$0 / 0.8F));
   }
   ...
   private int d(@Nullable K $$0) {
      return (arp.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public aqo<K> c() {
      return new aqo<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
