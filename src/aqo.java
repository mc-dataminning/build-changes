...
public class aqo {
   ...
   private static List<aqo.b> a(final Path $$0) throws IOException {
      try {
         final List<aqo.b> $$1 = new ArrayList<>();
   ...
   private static List<aqo.a> a(List<aqo.b> $$0) {
      List<aqo.a> $$1 = new ArrayList<>();
      Object2IntOpenHashMap<Path> $$2 = new Object2IntOpenHashMap();

      for (aqo.b $$3 : $$0) {
         int $$4 = $$2.addTo($$3.b.getParent(), 1);
         $$1.add(new aqo.a($$3.b, $$4));
      }
   ...
   static record a(Path b, int c) {
      public static final Comparator<aqo.a> a = Comparator.comparing(aqo.a::b).reversed();
   ...
   static record b(Path b, FileTime c) {
      public static final Comparator<aqo.b> a = Comparator.comparing(aqo.b::b).reversed();
