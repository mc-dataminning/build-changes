...
public class apb {
   ...
   private static int a(ew $$0, Collection<asi> $$1, alz $$2, axg $$3, fbs $$4, float $$5, float $$6, float $$7) throws CommandSyntaxException {
      ...
      for (asi $$12 : $$1) {
         ...
         if ($$16 > $$9) {
            ...
            $$17 = new fbs($$12.dA() + $$13 / $$19 * 2.0, $$12.dC() + $$14 / $$19 * 2.0, $$12.dG() + $$15 / $$19 * 2.0);
            $$18 = $$7;
         }
