...
public class eps {
   ...
   private final eps.a g;

   @Deprecated
   public static eps a(azl $$0, eps.a $$1) {
      return new eps($$0, $$1, false);
   }

   public static eps a(azl $$0, int $$1, double... $$2) {
      return b($$0, new eps.a($$1, new DoubleArrayList($$2)));
   }

   public static eps b(azl $$0, eps.a $$1) {
      return new eps($$0, $$1, true);
   }

   private eps(azl $$0, eps.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<eps.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(eps.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(eps.a::b))
               .apply($$0, eps.a::new)
      );
      public static final Codec<jn<eps.a>> b = aky.a(lv.aQ, a);
