...
public class eps {
   ...
   static class b {
      static final Optional<eps> a = Optional.ofNullable(a());
      ...
      private static eps a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new eps();
      }
   }
}
