...
public class eps extends epx {
   public static final MapCodec<eps> a = RecordCodecBuilder.mapCodec($$0 -> a($$0).apply($$0, eps::new));
   ...
   public List<eob.a> a(dkd $$0, BiConsumer<iv, ebe> $$1, azx $$2, int $$3, iv $$4, enl $$5) {
      int $$6 = 5;
      int $$7 = $$3 + 2;
      int $$8 = azo.a((double)$$7 * 0.618);
      a($$0, $$1, $$2, $$4.e(), $$5);
      double $$9 = 1.0;
      int $$10 = Math.min(1, azo.a(1.382 + Math.pow(1.0 * (double)$$7 / 13.0, 2.0)));
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<eps.a> $$13 = Lists.newArrayList();
      $$13.add(new eps.a($$4.b($$12), $$11));
      ...
      for (; $$12 >= 0; $$12--) {
         ...
         if (!($$14 < 0.0F)) {
            for (int $$15 = 0; $$15 < $$10; $$15++) {
               ...
               iv $$21 = $$4.b(azo.a($$19), $$12 - 1, azo.a($$20));
               iv $$22 = $$21.b(5);
      ...
      List<eob.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dkd $$0, BiConsumer<iv, ebe> $$1, azx $$2, iv $$3, iv $$4, boolean $$5, enl $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            iv $$13 = $$3.b(azo.d(0.5F + (float)$$12 * $$9), azo.d(0.5F + (float)$$12 * $$10), azo.d(0.5F + (float)$$12 * $$11));
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.c(dtv.d, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dkd $$0, BiConsumer<iv, ebe> $$1, azx $$2, int $$3, iv $$4, List<eps.a> $$5, enl $$6) {
      for (eps.a $$7 : $$5) {
         int $$8 = $$7.a();
