...
public class eyn {
   private static final aer a = new aer("advancements/title_box");
   ...
   private final arc r;
   private final int s;
   private final List<arc> t;
   private final eql u;
   @Nullable
   private eyn v;
   private final List<eyn> w = Lists.newArrayList();
   @Nullable
   private ag x;
   private final int y;
   private final int z;

   public eyn(eyl $$0, eql $$1, ae $$2, an $$3) {
      this.o = $$0;
      this.p = $$2;
      this.q = $$3;
      this.u = $$1;
      this.r = qm.a().a($$1.h.a($$3.a(), 163));
      this.y = arp.d($$3.f() * 28.0F);
      this.z = arp.d($$3.g() * 27.0F);
      int $$4 = $$2.i();
      int $$5 = String.valueOf($$4).length();
      int $$6 = $$4 > 1 ? $$1.h.b("  ") + $$1.h.b("0") * $$5 * 2 + $$1.h.b("/") : 0;
      int $$7 = 29 + $$1.h.a(this.r) + $$6;
      this.t = qm.a().a(this.a(th.a($$3.b().e(), ub.a.a($$3.e().b())), $$7));
   ...
   private static float a(eqx $$0, List<tj> $$1) {
      return (float)$$1.stream().mapToDouble($$0::a).max().orElse(0.0);
   }

   private List<tj> a(tf $$0, int $$1) {
      eqx $$2 = this.u.h.b();
      List<tj> $$3 = null;
      float $$4 = Float.MAX_VALUE;

      for (int $$5 : n) {
         List<tj> $$6 = $$2.b($$0, $$1 - $$5, ub.a);
   ...
   public void a(erv $$0, int $$1, int $$2, boolean $$3) {
      if (this.v != null) {
         int $$4 = $$1 + this.v.y + 13;
   ...
   public void a(erv $$0, int $$1, int $$2, float $$3, int $$4, int $$5) {
