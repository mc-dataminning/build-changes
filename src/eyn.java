...
public class eyn {
   ...
   public void a(int $$0, eyn.a $$1) {
      int $$2 = 0;

      while ($$2 < $$0) {
         ffj $$3 = this.a.b(this.e);
         if ($$3 == null) {
            break;
         }

         int $$4 = this.e--;
         if ($$3 instanceof ffk.a $$5 && !$$5.g().equals(this.g)) {
            if (this.a($$1, $$5)) {
               if (this.f > 0) {
   ...
   private boolean a(eyn.a $$0, ffk.a $$1) {
      tl $$2 = $$1.g();
      boolean $$3 = this.b.b($$2);
      if (this.c.test($$1)) {
         this.b.a($$2);
         if (this.d != null && !this.d.a($$2.j())) {
            $$0.a(sw.a("gui.chatSelection.join", $$1.f().getName()).a(n.o));
         }
