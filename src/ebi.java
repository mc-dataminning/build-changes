...
@Deprecated
public class ebi extends eat<ebi.a> {
   private static final drx a = dew.nc.n();

   public ebi(Codec<ebi.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eav<ebi.a> $$0) {
      iz $$1 = $$0.e();
      dco $$2 = $$0.b();
      azc $$3 = $$0.d();
      ebi.a $$4 = $$0.f();
   ...
   public static record a(eey b, eey c) implements ecx {
      public static final Codec<ebi.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eey.a.fieldOf("fluid").forGetter(ebi.a::a), eey.a.fieldOf("barrier").forGetter(ebi.a::b)).apply($$0, ebi.a::new)
      );
