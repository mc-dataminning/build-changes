...
public class ebi extends eay<ebh> {
   private static final float a = 0.06F;

   public ebi(Codec<ebh> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eba<ebh> $$0) {
      dct $$1 = $$0.b();
      iz $$2 = $$0.e();
      azh $$3 = $$0.d();
      dtz $$4 = $$0.c();
   ...
   private static boolean a(dct $$0, iz $$1, ebh $$2, boolean $$3) {
      if ($$0.a($$1, dsb.a::r)) {
         return true;
      } else {
   ...
   private void a(dct $$0, azh $$1, ebh $$2, iz $$3, int $$4, boolean $$5) {
      iz.a $$6 = new iz.a();
      dsc $$7 = $$2.c;
      int $$8 = $$5 ? 1 : 0;
   ...
   private void b(dct $$0, azh $$1, ebh $$2, iz $$3, int $$4, boolean $$5) {
      iz.a $$6 = new iz.a();
      boolean $$7 = $$2.d.a(dfb.kK);
   ...
   private void a(dbz $$0, azh $$1, ebh $$2, iz.a $$3, float $$4, float $$5, float $$6) {
      if ($$1.i() < $$4) {
         this.a($$0, $$3, $$2.e);
      } else if ($$1.i() < $$5) {
         this.a($$0, $$3, $$2.d);
   ...
   private void a(dbz $$0, azh $$1, iz $$2, dsc $$3, boolean $$4) {
      if ($$0.a_($$2.d()).a($$3.b())) {
         this.a($$0, $$2, $$3);
   ...
   private static void a(iz $$0, dbz $$1, azh $$2) {
      iz.a $$3 = $$0.j().c(je.a);
      if ($$1.u($$3)) {
         int $$4 = ayz.a($$2, 1, 5);
         if ($$2.a(7) == 0) {
