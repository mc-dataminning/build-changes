...
public class ebi {
   ...
   static class a implements ebi.i {
      @Override
      public boolean a(ebi.v $$0) {
         return $$0.c[ic.f.d()] && !$$0.b[ic.f.d()].d;
      }

      @Override
      public ebi.r a(ic $$0, ebi.v $$1, aup $$2) {
         $$1.d = true;
         $$1.b[ic.f.d()].d = true;
         return new ebi.k($$0, $$1);
      }
   }

   static class b implements ebi.i {
      @Override
      public boolean a(ebi.v $$0) {
      ...
      public ebi.r a(ic $$0, ebi.v $$1, aup $$2) {
         ...
         return new ebi.l($$0, $$1);
      }
   }

   static class c implements ebi.i {
      @Override
      public boolean a(ebi.v $$0) {
      ...
      public ebi.r a(ic $$0, ebi.v $$1, aup $$2) {
         $$1.d = true;
         $$1.b[ic.b.d()].d = true;
         return new ebi.m($$0, $$1);
      }
   }

   static class d implements ebi.i {
      @Override
      public boolean a(ebi.v $$0) {
      ...
      public ebi.r a(ic $$0, ebi.v $$1, aup $$2) {
         ...
         return new ebi.n($$0, $$1);
      }
   }

   static class e implements ebi.i {
      @Override
      public boolean a(ebi.v $$0) {
      ...
      public ebi.r a(ic $$0, ebi.v $$1, aup $$2) {
         ...
         $$3.d = true;
         $$3.b[ic.c.d()].d = true;
         return new ebi.o($$0, $$3);
      }
   }

   static class f implements ebi.i {
      @Override
      public boolean a(ebi.v $$0) {
         return true;
      }
      ...
      public ebi.r a(ic $$0, ebi.v $$1, aup $$2) {
         $$1.d = true;
         return new ebi.s($$0, $$1, $$2);
      }
   }

   static class g implements ebi.i {
      @Override
      public boolean a(ebi.v $$0) {
      ...
      public ebi.r a(ic $$0, ebi.v $$1, aup $$2) {
         $$1.d = true;
         return new ebi.t($$0, $$1);
      }
   }

   public static class h extends ebi.r {
      ...
      private ebi.v G;
      private ebi.v H;
      private final List<ebi.r> I = Lists.newArrayList();

      public h(aup $$0, int $$1, int $$2, ic $$3) {
         super(dzq.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<ebi.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new ebi.p($$3, this.G));
         this.I.add(new ebi.j($$3, this.H));
         List<ebi.i> $$5 = Lists.newArrayList();
         $$5.add(new ebi.b());
         $$5.add(new ebi.d());
         $$5.add(new ebi.e());
         $$5.add(new ebi.a());
         ...
         dyr $$10 = dyr.a(this.b(1, 1, 1), this.b(23, 8, 21));
         dyr $$11 = dyr.a(this.b(34, 1, 1), this.b(56, 8, 21));
         dyr $$12 = dyr.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new ebi.u($$3, $$10, $$13++));
         this.I.add(new ebi.u($$3, $$11, $$13++));
         this.I.add(new ebi.q($$3, $$12));
      }
      ...
      private List<ebi.v> b(aup $$0) {
         ebi.v[] $$1 = new ebi.v[75];
         ...
         ebi.v $$23 = new ebi.v(1003);
         ebi.v $$24 = new ebi.v(1001);
         ebi.v $$25 = new ebi.v(1002);
         $$1[v].a(ic.b, $$23);
         $$1[w].a(ic.d, $$24);
         $$1[x].a(ic.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<ebi.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, cud $$2, aup $$3, dyr $$4) {
         int $$5 = 24;
      ...
      private void a(cud $$0, aup $$1, dyr $$2) {
      ...
      private void b(cud $$0, aup $$1, dyr $$2) {
      ...
      private void c(cud $$0, aup $$1, dyr $$2) {
      ...
      private void d(cud $$0, aup $$1, dyr $$2) {
      ...
      private void e(cud $$0, aup $$1, dyr $$2) {
      ...
      private void f(cud $$0, aup $$1, dyr $$2) {
   ...
   interface i {
      boolean a(ebi.v var1);

      ebi.r a(ic var1, ebi.v var2, aup var3);
   }

   public static class j extends ebi.r {
      public j(ic $$0, ebi.v $$1) {
         super(dzq.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(cud $$0, cub $$1, dkx $$2, aup $$3, dyr $$4, csp $$5, hx $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, cwl.ch.o(), cwl.ch.o(), false);
   ...
   public static class k extends ebi.r {
      public k(ic $$0, ebi.v $$1) {
         super(dzq.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends ebi.r {
      public l(ic $$0, ebi.v $$1) {
         super(dzq.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends ebi.r {
      public m(ic $$0, ebi.v $$1) {
         super(dzq.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends ebi.r {
      public n(ic $$0, ebi.v $$1) {
         super(dzq.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends ebi.r {
      public o(ic $$0, ebi.v $$1) {
         super(dzq.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends ebi.r {
      public p(ic $$0, ebi.v $$1) {
         super(dzq.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends ebi.r {
      public q(ic $$0, dyr $$1) {
         super(dzq.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends dzd {
      protected static final dja b = cwl.hZ.o();
      protected static final dja c = cwl.ia.o();
      protected static final dja d = cwl.ib.o();
      protected static final dja h = c;
      protected static final dja i = cwl.ii.o();
      protected static final boolean j = true;
      protected static final dja k = cwl.G.o();
      protected static final Set<cwj> l = ImmutableSet.builder().add(cwl.dO).add(cwl.iC).add(cwl.mW).add(k.b()).build();
      ...
      public r(dzq $$0, ic $$1, int $$2, dyr $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(dzq $$0, int $$1, ic $$2, ebi.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static dyr a(ic $$0, ebi.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         dyr $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(cud $$0, dyr $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dja $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.A_() && $$11 != k) {
                        this.a($$0, cwl.a.o(), $$9, $$8, $$10, $$1);
                     } else {
                        this.a($$0, k, $$9, $$8, $$10, $$1);
                     }
                  }
      ...
      protected void a(cud $$0, dyr $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(cud $$0, dyr $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dja $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(dyr $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(cud $$0, dyr $$1, int $$2, int $$3, int $$4) {
         hx $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cby $$6 = blt.B.a((cti)$$0.E());
            if ($$6 != null) {
               $$6.b($$6.eM());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dm()), bmj.d, null, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends ebi.r {
      private int a;

      public s(ic $$0, ebi.v $$1, aup $$2) {
         super(dzq.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends ebi.r {
      public t(ic $$0, ebi.v $$1) {
         super(dzq.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends ebi.r {
      private int a;

      public u(ic $$0, dyr $$1, int $$2) {
         super(dzq.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
