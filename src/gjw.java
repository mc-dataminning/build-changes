...
public abstract class gjw implements zl {
   ...
   @Nullable
   protected String d;
   protected final hon e;
   @Nullable
   protected final fyb f;
   protected boolean g;
   private final List<gjw.a> m = new ArrayList<>();
   protected final Map<alg, byte[]> h;
   protected Map<String, String> i;
   protected aly j;

   protected gjw(foz $$0, vr $$1, gke $$2) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2.f();
      this.d = $$2.e();
   ...
   public void a(zs $$0) {
      ...
      if ($$2 == null) {
         ...
         String $$3 = $$0.f();
         boolean $$4 = $$0.g();
         gko.a $$5 = this.c != null ? this.c.b() : gko.a.c;
         if ($$5 != gko.a.c && (!$$4 || $$5 != gko.a.b)) {
            this.a.af().a($$1, $$2, $$3);
         } else {
   ...
   public void a(zv $$0) {
      ...
      if (this.c == null) {
         ...
         this.b.m();
         this.b.n();
         glr $$1 = new glr($$0.b(), $$0.e());
         fxa.a(Objects.requireNonNullElseGet(this.f, fyd::new), this.a, $$1, this.c, false, new gks(this.h));
      }
   }
   ...
   protected void e() {
      Iterator<gjw.a> $$0 = this.m.iterator();
   ...
   protected fyb b(vt $$0) {
      fyb $$1 = Objects.requireNonNullElseGet(this.f, () -> new gat(new fyd()));
      return (fyb)(this.c != null && this.c.e() ? new hpg($$1, k, $$0.a()) : new fxi($$1, k, $$0));
   }
   ...
   private void a(zf<? extends wk> $$0, BooleanSupplier $$1, Duration $$2) {
      if ($$1.getAsBoolean()) {
         ...
         this.m.add(new gjw.a($$0, $$1, af.c() + $$2.toMillis()));
      }
   }

   private fyb a(UUID $$0, URL $$1, String $$2, boolean $$3, @Nullable wy $$4) {
      fyb $$5 = this.a.z;
      return $$5 instanceof gjw.b $$6 ? $$6.a(this.a, $$0, $$1, $$2, $$3, $$4) : new gjw.b(this.a, $$5, List.of(new gjw.b.a($$0, $$1, $$2)), $$3, $$4);
   }
   ...
   class b extends fwz {
      private final List<gjw.b.a> s;
      @Nullable
      private final fyb u;

      b(final foz $$0, @Nullable final fyb $$1, final List<gjw.b.a> $$2, final boolean $$3, @Nullable final wy $$4) {
         super(
            $$5 -> {
               $$0.a($$1);
               hlw $$6 = $$0.af();
               if ($$5) {
                  ...
                  $$6.h();
                  if ($$3) {
                     gjw.this.b.a(wy.c("multiplayer.requiredTexturePrompt.disconnect"));
                  } else if (gjw.this.c != null) {
                     gjw.this.c.a(gko.a.b);
                  }
               }
            ...
            gjw.a($$3 ? wy.c("multiplayer.requiredTexturePrompt.line2").a(n.o, n.r) : wy.c("multiplayer.texturePrompt.line2"), $$4),
            $$3 ? wx.i : wx.f,
            $$3 ? wx.p : wx.g
         );
         this.s = $$2;
      ...
      public gjw.b a(foz $$0, UUID $$1, URL $$2, String $$3, boolean $$4, @Nullable wy $$5) {
         List<gjw.b.a> $$6 = ImmutableList.builderWithExpectedSize(this.s.size() + 1).addAll(this.s).add(new gjw.b.a($$1, $$2, $$3)).build();
         return gjw.this.new b($$0, this.u, $$6, $$4, $$5);
      }
