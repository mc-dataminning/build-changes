...
public abstract class gjw<T extends btn, M extends fty<T>> extends giu<T> implements gkr<T, M> {
   private static final Logger a = LogUtils.getLogger();
   private static final float h = 0.1F;
   protected M f;
   protected final List<gnh<T, M>> g = Lists.newArrayList();

   public gjw(giv.a $$0, M $$1, float $$2) {
      super($$0);
      this.f = $$1;
      this.d = $$2;
   }

   protected final boolean a(gnh<T, M> $$0) {
      return this.g.add($$0);
   }
   ...
   public void a(T $$0, float $$1, float $$2, ezw $$3, gdm $$4, int $$5) {
      ...
      this.f.d = $$0.bR();
      this.f.e = $$0.p_();
      float $$6 = ayx.j($$2, $$0.aZ, $$0.aY);
      float $$7 = ayx.j($$2, $$0.bb, $$0.ba);
      float $$8 = $$7 - $$6;
      if ($$0.bR() && $$0.dc() instanceof btn $$9) {
         $$6 = ayx.j($$2, $$9.aZ, $$9.aY);
         $$8 = $$7 - $$6;
         float $$10 = ayx.g($$8);
         if ($$10 < -85.0F) {
   ...
   @Nullable
   protected gdu a(T $$0, boolean $$1, boolean $$2, boolean $$3) {
      ale $$4 = this.a($$0);
      if ($$2) {
         return gdu.g($$4);
      } else if ($$1) {
         ...
         return $$3 ? gdu.r($$4) : null;
      }
   }

   public static int c(btn $$0, float $$1) {
      return goo.a(goo.a($$1), goo.a($$0.aO > 0 || $$0.aQ > 0));
   }
   ...
   protected boolean b(T $$0) {
      ...
      if ($$1 >= (double)($$2 * $$2)) {
         ...
         return ffd.M() && $$0 != $$3.an() && $$5 && !$$0.bS();
      }
   }

   public static boolean e(btn $$0) {
      if ($$0 instanceof cmv || $$0.ag()) {
