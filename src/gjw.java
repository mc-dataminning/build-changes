...
public class gjw extends gjr {
   ...
   gjw(gfj $$0, double $$1, double $$2, double $$3, ecu $$4, int $$5) {
   ...
   public static class a implements giu<ly> {
      private final gjm a;
      ...
      public gir a(ly $$0, gfj $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gjw $$8 = new gjw($$1, $$2, $$3, $$4, $$0.b(), $$0.c());
         $$8.a(this.a);
         $$8.e(1.0F);
         return $$8;
      }
