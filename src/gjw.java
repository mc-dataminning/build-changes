...
public record gjw(Map<String, String> c, Set<String> d) {
   public static final gjw a = new gjw(Map.of(), Set.of());
   public static final Codec<gjw> b = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               Codec.unboundedMap(Codec.STRING, Codec.STRING).optionalFieldOf("values", Map.of()).forGetter(gjw::d),
               Codec.STRING.listOf().xmap(Set::copyOf, List::copyOf).optionalFieldOf("flags", Set.of()).forGetter(gjw::e)
            )
            .apply($$0, gjw::new)
   );

   public static gjw.a a() {
      return new gjw.a();
   }
   ...
   public gjw a(gjw $$0) {
      if (this.c()) {
         ...
         $$2.addAll(this.d);
         $$2.addAll($$0.d);
         return new gjw($$1.buildKeepingLast(), $$2.build());
      }
   }
   ...
   public static class a {
      ...
      public gjw.a a(String $$0, String $$1) {
         if ($$1.isBlank()) {
      ...
      public gjw.a a(String $$0, float $$1) {
         this.a.put($$0, String.valueOf($$1));
         return this;
      }

      public gjw.a a(String $$0) {
         this.b.add($$0);
         return this;
      }

      public gjw a() {
         return new gjw(this.a.build(), this.b.build());
      }
   }
}
