...
public class eyj extends exl {
   ...
   public eyj(exc $$0, int $$1, int $$2, int $$3, int $$4, vg $$5, vg $$6) {
      super($$1, $$2, $$3, $$4, $$6);
      this.m = $$0;
      this.n = $$5;
      this.o = new eym($$0, $$3 - this.b());
      this.o.a(this::k);
   }
   ...
   @Override
   public void a(fbk $$0) {
      $$0.a(fbj.a, vg.a("gui.narrate.editBox", this.x(), this.j()));
   }
   ...
   protected void c(exe $$0, int $$1, int $$2, float $$3) {
      ...
      if ($$4.isEmpty() && !this.aK_()) {
         ...
         int $$5 = this.o.d();
         boolean $$6 = this.aK_() && (ac.b() - this.p) / 300L % 2L == 0L;
         boolean $$7 = $$5 < $$4.length();
         int $$8 = 0;
         int $$9 = 0;
         int $$10 = this.C() + this.a();

         for (eym.a $$11 : this.o.h()) {
   ...
   protected void a(exe $$0) {
      ...
      if (this.o.b()) {
         int $$1 = this.o.a();
         vg $$2 = vg.a("gui.multiLineEditBox.character_limit", this.o.c().length(), $$1);
   ...
   private void k() {
      double $$0 = this.c();
      eym.a $$1 = this.o.c((int)($$0 / 9.0));
      if (this.o.d() <= $$1.a()) {
         $$0 = (double)(this.o.g() * 9);
      } else {
         eym.a $$2 = this.o.c((int)(($$0 + (double)this.h) / 9.0) - 1);
         if (this.o.d() > $$2.b()) {
