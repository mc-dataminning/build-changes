...
public class eyj extends eym {
   ...
   static final eyj.b l = new eyj.b(854, 480);

   public eyj(int $$0, int $$1) {
      super(true);
   ...
   static enum a {
      ...
      private static final eyj.a[] e = values();
   ...
   static class b {
      ...
      static List<eyj.b> a(int $$0, int $$1) {
         RenderSystem.assertOnRenderThreadOrInit();
         int $$2 = RenderSystem.maxSupportedTextureSize();
         return $$0 > 0 && $$0 <= $$2 && $$1 > 0 && $$1 <= $$2 ? ImmutableList.of(new eyj.b($$0, $$1), eyj.l) : ImmutableList.of(eyj.l);
      }
