...
public class eyj {
   ...
   private void a(n $$0, vs $$1) {
      this.b.l.d().a(vs.i().b(vs.c("debug.prefix").a($$0, n.r)).b(vr.v).b($$1));
   }
   ...
   private void c(String $$0, Object... $$1) {
      this.a(vs.b(MessageFormat.format($$0, $$1)));
   }
         ...
         switch ($$0) {
            ...
            case 78:
               if (!this.b.s.m(2)) {
                  ...
                  this.b.s.cr.d("gamemode " + ((cwb)MoreObjects.firstNonNull(this.b.q.i(), cwb.b)).b());
               }
            ...
            case 81:
               ...
               fal $$3 = this.b.l.d();
               $$3.a(vs.c("debug.reload_chunks.help"));
               $$3.a(vs.c("debug.show_hitboxes.help"));
               $$3.a(vs.c("debug.copy_location.help"));
               $$3.a(vs.c("debug.clear_chat.help"));
               $$3.a(vs.c("debug.chunk_boundaries.help"));
               $$3.a(vs.c("debug.advanced_tooltips.help"));
               $$3.a(vs.c("debug.inspect.help"));
               $$3.a(vs.c("debug.profiling.help"));
               $$3.a(vs.c("debug.creative_spectator.help"));
               $$3.a(vs.c("debug.pause_focus.help"));
               $$3.a(vs.c("debug.help.help"));
               $$3.a(vs.c("debug.dump_dynamic_textures.help"));
               $$3.a(vs.c("debug.reload_resourcepacks.help"));
               $$3.a(vs.c("debug.pause.help"));
               $$3.a(vs.c("debug.gamemodes.help"));
               return true;
            case 83:
               Path $$4 = this.b.p.toPath().toAbsolutePath();
               Path $$5 = TextureUtil.getDebugTexturePath($$4);
               this.b.Z().a($$5);
               vs $$6 = vs.b($$4.relativize($$5).toString()).a(n.t).a($$1x -> $$1x.a(new vq(vq.a.b, $$5.toFile().toString())));
      ...
      if ($$2 != null) {
         switch ($$2.c()) {
            case b:
               ...
               if ($$0) {
                  if ($$1) {
                     this.b.s.cr.t().a($$3, $$2x -> {
                        this.a($$5, $$3, $$2x);
                        this.a("debug.inspect.server.block");
                     });
                  } else {
                     djl $$6 = $$4.c_($$3);
                     sy $$7 = $$6 != null ? $$6.d($$4.I_()) : null;
                     this.a($$5, $$3, $$7);
   ...
   private void a(dme $$0, ib $$1, @Nullable sy $$2) {
   ...
   private void a(ajc $$0, eov $$1, @Nullable sy $$2) {
      String $$4;
      if ($$2 != null) {
         $$2.r("UUID");
         $$2.r("Pos");
         $$2.r("Dimension");
         String $$3 = tn.c((tv)$$2).getString();
   ...
   public void a(long $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$0 == this.b.aN().i()) {
         boolean $$5 = ery.a(eyk.P().aN().i(), 292);
         if (this.d > 0L) {
            if (!ery.a(eyk.P().aN().i(), 67) || !$$5) {
               this.d = -1L;
            }
         } else if (ery.a(eyk.P().aN().i(), 67) && $$5) {
            this.g = true;
            this.d = ac.b();
            this.e = ac.b();
            this.f = 0L;
         ...
         if ($$3 == 1 && (!(this.b.y instanceof fhb) || ((fhb)$$6).k <= ac.b() - 20L)) {
            if (this.b.m.R.a($$1, $$2)) {
               this.b.aN().h();
            ...
            if (this.b.m.O.a($$1, $$2)) {
               ...
               eyv.a(this.b.p, this.b.g(), $$0x -> this.b.execute(() -> this.b.l.d().a($$0x)));
               return;
            }
         }

         if (this.b.aX().a() && this.b.m.s().c()) {
            boolean $$9 = $$6 == null || !($$6.aJ_() instanceof fat $$7) || !$$7.d();
            if ($$3 != 0 && $$1 == 66 && fgh.t() && $$9) {
               boolean $$10 = this.b.m.ap().c() == eym.a;
               this.b.m.ap().a(eym.a(this.b.m.ap().c().a() + 1));
               this.b.m.as();
               if ($$6 instanceof fgj) {
                  ((fgj)$$6).o();
               }
         ...
         label185: {
            ...
            label144:
            if (!$$13) {
               if (this.b.y instanceof fgc $$14 && !$$14.o()) {
                  break label144;
               }
      ...
      if ($$0 == this.b.aN().i()) {
         ...
         if ($$3 != null && this.b.aK() == null) {
            if (Character.charCount($$1) == 1) {
               fgh.a(() -> $$3.a((char)$$1, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
            } else {
               for (char $$4 : Character.toChars($$1)) {
                  fgh.a(() -> $$3.a($$4, $$2), "charTyped event handler", $$3.getClass().getCanonicalName());
               }
            }
         }
      }
      ...
      if (this.d > 0L) {
         ...
         if ($$2 >= 1000L) {
            if (this.f == 0L) {
               ...
               this.b("debug.crash.warning", awm.f((float)$$1 / 1000.0F));
            }
