...
public class eyj {
   private final List<ConcurrentLinkedQueue<eyi>> a = ImmutableList.of(
   ...
   public void a(eyi $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eyi> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eyi> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eyi> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eyi> j() {
