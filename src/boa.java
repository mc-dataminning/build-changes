...
public record boa<T>(bns<StringReader> a, bnq<T> b) {
   public Optional<T> a(bnv<StringReader> $$0) {
      return $$0.a(this.b);
   }

   public T a(StringReader $$0) throws CommandSyntaxException {
      bnt.a<StringReader> $$1 = new bnt.a<>();
      boe $$2 = new boe(this.a(), $$1, $$0);
      ...
      if ($$3.isPresent()) {
         ...
         if ($$4.size() == 1 && $$4.get(0) instanceof RuntimeException $$7) {
            ...
            throw new IllegalStateException("Failed to parse: " + $$1.a().stream().map(bnu::toString).collect(Collectors.joining(", ")));
         }
      }
   }
   ...
   public CompletableFuture<Suggestions> a(SuggestionsBuilder $$0) {
      ...
      bnt.a<StringReader> $$2 = new bnt.a<>();
      boe $$3 = new boe(this.a(), $$2, $$1);
      this.a($$3);
      List<bnu<StringReader>> $$4 = $$2.a();
      if ($$4.isEmpty()) {
         return $$0.buildFuture();
      } else {
         SuggestionsBuilder $$5 = $$0.createOffset($$2.b());

         for (bnu<StringReader> $$6 : $$4) {
            if ($$6.b() instanceof bod $$7) {
               fb.a($$7.a(), $$5);
            } else {
