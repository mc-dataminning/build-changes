...
public class boa {
   ...
   private static void a(boi $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<Pair<dux, bom<boc>>> $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.addProperty("durationNanosTotal", $$0.stream().mapToDouble($$0x -> (double)((bom)$$0x.getSecond()).f().toNanos()).sum());
      JsonArray $$2 = ac.a(new JsonArray(), $$1x -> $$1.add("status", $$1x));

      for (Pair<dux, bom<boc>> $$3 : $$0) {
         bom<boc> $$4 = (bom<boc>)$$3.getSecond();
         JsonObject $$5 = ac.a(new JsonObject(), $$2::add);
         $$5.addProperty("state", ((dux)$$3.getFirst()).toString());
   ...
   private JsonElement b(List<bok> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bnp.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bny $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), boa::a));
      $$1.add("chunksWritten", this.a($$0.m(), boa::a));
      return $$1;
   }
   ...
   private JsonElement c(bny $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), boa::a));
      $$1.add("received", this.a($$0.k(), boa::a));
      return $$1;
   }

   private <T> JsonElement a(boh<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement c(List<boe> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<boe>, ToDoubleFunction<boe>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, boe::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, boe::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, boe::c));
      return $$1;
   }
}
