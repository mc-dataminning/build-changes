...
public class bxt extends bxl {
   public static final float a = 0.02F;
   protected final bqq b;
   @Nullable
   protected bpv c;
   ...
   protected final Class<? extends bqo> f;
   protected final cbe g;

   public bxt(bqq $$0, Class<? extends bqo> $$1, float $$2) {
      this($$0, $$1, $$2, 0.02F);
   }

   public bxt(bqq $$0, Class<? extends bqo> $$1, float $$2, float $$3) {
      this($$0, $$1, $$2, $$3, false);
   }

   public bxt(bqq $$0, Class<? extends bqo> $$1, float $$2, float $$3, boolean $$4) {
      this.b = $$0;
      this.f = $$1;
      this.d = $$2;
      this.e = $$3;
      ...
      if ($$1 == cjt.class) {
         this.g = cbe.b().a((double)$$2).a($$1x -> bqa.b($$0).test($$1x));
      } else {
         this.g = cbe.b().a((double)$$2);
      }
   }
