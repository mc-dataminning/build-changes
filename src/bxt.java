...
public abstract class bxt {
   ...
   public bxt(bok $$0, cvr $$1) {
      this.a = $$0;
      this.b = $$1;
      int $$2 = awi.a($$0.g(bpp.i) * 16.0);
      this.v = this.a($$2);
   }
   ...
   protected abstract ehn a(int var1);
   ...
   @Nullable
   public final ehl a(double $$0, double $$1, double $$2, int $$3) {
      return this.a(hz.a($$0, $$1, $$2), $$3);
   }

   @Nullable
   public ehl a(Stream<hz> $$0, int $$1) {
      return this.a($$0.collect(Collectors.toSet()), 8, false, $$1);
   }

   @Nullable
   public ehl a(Set<hz> $$0, int $$1) {
   ...
   @Nullable
   protected ehl a(Set<hz> $$0, int $$1, boolean $$2, int $$3) {
      return this.a($$0, $$1, $$2, $$3, (float)this.a.g(bpp.i));
   }

   @Nullable
   protected ehl a(Set<hz> $$0, int $$1, boolean $$2, int $$3, float $$4) {
      if ($$0.isEmpty()) {
         return null;
         ...
         int $$6 = (int)($$4 + (float)$$1);
         cwe $$7 = new cwe(this.b, $$5.b(-$$6, -$$6, -$$6), $$5.b($$6, $$6, $$6));
         ehl $$8 = this.v.a($$7, this.a, $$0, $$4, $$3, this.u);
         this.b.ae().c();
         if ($$8 != null && $$8.l() != null) {
            this.s = $$8.l();
            this.t = $$3;
   ...
   public boolean a(@Nullable ehl $$0, double $$1) {
      if ($$0 == null) {
         this.c = null;
         return false;
      } else {
   ...
   public void c() {
      ...
      if (!this.l()) {
         if (this.a()) {
            ...
            if ($$0.d > $$1.d && !this.a.aC() && awi.a($$0.c) == awi.a($$1.c) && awi.a($$0.e) == awi.a($$1.e)) {
               this.c.a();
            }
         }
   ...
   protected double a(enz $$0) {
      hz $$1 = hz.a($$0);
      return this.b.a_($$1.d()).i() ? $$0.d : ehq.a(this.b, $$1);
   }
   ...
   private boolean c(enz $$0) {
      if (this.c.f() + 1 >= this.c.e()) {
         return false;
      } else {
         enz $$1 = enz.c(this.c.g());
         if (!$$0.a((it)$$1, 2.0)) {
            return false;
         } else if (this.a($$0, this.c.a(this.a))) {
            return true;
         } else {
            enz $$2 = enz.c(this.c.d(this.c.f() + 1));
            enz $$3 = $$1.d($$0);
            enz $$4 = $$2.d($$0);
            double $$5 = $$3.g();
            double $$6 = $$4.g();
   ...
   protected void U_() {
      if (this.c != null) {
         for (int $$0 = 0; $$0 < this.c.e(); $$0++) {
            ehj $$1 = this.c.a($$0);
            ehj $$2 = $$0 + 1 < this.c.e() ? this.c.a($$0 + 1) : null;
            dlj $$3 = this.b.a_(new hz($$1.a, $$1.b, $$1.c));
            if ($$3.a(aua.bk)) {
   ...
   public boolean b(ehh $$0) {
      return $$0 != ehh.n && $$0 != ehh.p && $$0 != ehh.d;
   }

   protected static boolean a(bok $$0, enz $$1, enz $$2, boolean $$3) {
      enz $$4 = new enz($$2.c, $$2.d + (double)$$0.dh() * 0.5, $$2.e);
      return $$0.dM().a(new cva($$1, $$4, cva.a.a, $$3 ? cva.b.c : cva.b.a, $$0)).c() == enx.a.a;
   }
   ...
   public boolean b(hz $$0) {
      if (this.m) {
         ...
         ehj $$1 = this.c.d();
         enz $$2 = new enz(((double)$$1.a + this.a.dr()) / 2.0, ((double)$$1.b + this.a.dt()) / 2.0, ((double)$$1.c + this.a.dx()) / 2.0);
