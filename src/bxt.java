...
public abstract class bxt extends bvu implements bhw, bkc, bkr, bku, bkz {
   ...
   private static final Predicate<bkj> cc = $$0 -> $$0 instanceof bxt && ((bxt)$$0).gy();
   private static final buv cd = buv.b().a(16.0).d().a(cc);
   private static final cnk ce = cnk.a(ckm.oI, ckm.qM, cuc.ij.k(), ckm.nF, ckm.tq, ckm.pm, ckm.pn);
   private static final afc<Byte> cv = aff.a(bxt.class, afe.a);
   ...
   protected bxt(bjx<? extends bxt> $$0, cqz $$1) {
      super($$0, $$1);
      this.t(1.0F);
      this.gA();
   }
   ...
   @Override
   protected void z() {
      this.bO.a(1, new brx(this, 1.2));
      this.bO.a(1, new bsi(this, 1.2));
      this.bO.a(2, new bqq(this, 1.0, bxt.class));
      this.bO.a(4, new brd(this, 1.0));
      this.bO.a(6, new bsr(this, 0.7));
   ...
   protected void gu() {
      ...
      this.bO.a(3, new bsm(this, 1.25, cnk.a(ckm.tq, ckm.pm, ckm.pn), false));
   }
   ...
   public void a(@Nullable aqe $$0) {
      this.cp.a(0, new ckj(ckm.mZ));
   }

   public void b(ccx $$0, ckj $$1) {
      if (this.l($$1)) {
         this.cp.a(1, $$1.c(1));
         if (!$$0.fT().d) {
            $$1.h(1);
   ...
   public int v(int $$0) {
      int $$1 = asy.a(this.gz() + $$0, 0, this.gF());
      this.u($$1);
      return $$1;
   }
      ...
      if (!$$1.k()) {
         ...
         if (this.bO() && this.ct) {
            ...
            if (this.cu > 5 && this.cu % 3 == 0) {
               ...
               this.a(aqd.ls, $$3.a() * 0.15F, $$3.b());
            }
         } else if (this.b($$3)) {
            this.a(aqd.ls, $$3.a() * 0.15F, $$3.b());
         } else {
            this.a(aqd.lr, $$3.a() * 0.15F, $$3.b());
         }
      }
   }

   private boolean b(dbl $$0) {
      return $$0 == dbl.b || $$0 == dbl.aP || $$0 == dbl.B || $$0 == dbl.aQ || $$0 == dbl.aO;
   }

   protected void a(dbl $$0) {
      this.a(aqd.lm, $$0.a() * 0.15F, $$0.b());
   }

   public static blo.a gE() {
      return bkl.A().a(blp.h).a(blp.l, 53.0).a(blp.m, 0.225F);
   }
   ...
   public void c_() {
      ...
      if (!this.dL().B && this.bv()) {
         ...
         if (this.gH()) {
            if (!this.gw() && !this.bO() && this.ag.a(300) == 0 && this.dL().a_(this.dl().d()).a(cuc.i)) {
               this.A(true);
            }
   ...
   protected void gG() {
      if (this.gy() && this.n_() && !this.gw()) {
         bkj $$0 = this.dL().a(bxt.class, cd, this, this.dq(), this.ds(), this.dw(), this.cG().g(16.0));
   ...
   protected eie j(bkj $$0) {
      return new eie($$0.dD() * 0.5F, $$0.dB());
   }
   ...
   protected eif b(ccx $$0, eif $$1) {
      if (this.aA() && this.cr == 0.0F && this.gx() && !this.cs) {
         ...
         return new eif((double)$$2, 0.0, (double)$$3);
      }
   }
   ...
   protected void b(float $$0, eif $$1) {
      ...
      this.au = true;
      if ($$1.e > 0.0) {
         float $$5 = asy.a(this.dB() * (float) (Math.PI / 180.0));
         float $$6 = asy.b(this.dB() * (float) (Math.PI / 180.0));
         this.f(this.do().b((double)(-0.4F * $$5 * $$0), 0.0, (double)(0.4F * $$6 * $$0)));
      }
   }

   protected void gL() {
      this.a(aqd.lo, 0.4F, 1.0F);
   }
   ...
   public void b(rt $$0) {
      ...
      if (!this.cp.a(0).b()) {
         $$0.a("SaddleItem", this.cp.a(0).b(new rt()));
      }
   }
   ...
   protected void a(bjo $$0, bxt $$1) {
      this.a($$0, $$1, blp.l, (double)bY, (double)bZ);
      this.a($$0, $$1, blp.h, (double)bW, (double)bX);
      this.a($$0, $$1, blp.m, (double)bT, (double)bU);
   }

   private void a(bjo $$0, bxt $$1, blk $$2, double $$3, double $$4) {
      double $$5 = a(this.c($$2), $$0.c($$2), $$3, $$4, this.ag);
      $$1.a($$2).a($$5);
   }

   static double a(double $$0, double $$1, double $$2, double $$3, ate $$4) {
      if ($$3 <= $$2) {
   ...
   public float F(float $$0) {
      return asy.i($$0, this.cI, this.cH);
   }

   public float G(float $$0) {
      return asy.i($$0, this.cK, this.cJ);
   }
   ...
   private blb a(final int $$0, final Predicate<ckj> $$1) {
      return new blb() {
         @Override
         public ckj a() {
            return bxt.this.cp.a($$0);
         }
   ...
   public blb a_(int $$0) {
      ...
      if ($$1 >= 0 && $$1 < 2 && $$1 < this.cp.b()) {
         if ($$1 == 0) {
            return this.a($$1, $$0x -> $$0x.b() || $$0x.a(ckm.mZ));
         }
      ...
      int $$2 = $$0 - 500 + 2;
      return $$2 >= 2 && $$2 < this.cp.b() ? blb.a(this.cp, $$2) : super.a_($$0);
   }
   ...
   private eif a(eif $$0, bkj $$1) {
      ...
      while (var10.hasNext()) {
         ...
         do {
            ...
            if (cet.a($$8)) {
               eia $$9 = $$1.e($$6);
               eif $$10 = new eif($$2, (double)$$5.v() + $$8, $$4);
               if (cet.a(this.dL(), $$1, $$9.c($$10))) {
                  $$1.b($$6);
                  return $$10;
               }
            }
   ...
   @Override
   public eif b(bkj $$0) {
      eif $$1 = a((double)this.df(), (double)$$0.df(), this.dB() + ($$0.fm() == bkd.b ? 90.0F : -90.0F));
      eif $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         eif $$3 = a((double)this.df(), (double)$$0.df(), this.dB() + ($$0.fm() == bkd.a ? 90.0F : -90.0F));
         eif $$4 = this.a($$3, $$0);
