...
public class fhh {
   ...
   private static final xp h = xp.c("chat.deleted_marker").a(n.h, n.u);
   private final ffh i;
   private final axm<String> j = new axm<>(100);
   private final List<ffb> k = Lists.newArrayList();
   private final List<ffb.a> l = Lists.newArrayList();
   private int m;
   private boolean n;
   private final List<fhh.a> o = new ArrayList<>();
   ...
   public void a(fgt $$0, int $$1, int $$2, int $$3, boolean $$4) {
      if (!this.l()) {
         int $$5 = this.j();
         int $$6 = this.l.size();
         if ($$6 > 0) {
            ...
            int $$8 = ayz.f((float)this.f() / $$7);
            int $$9 = $$0.b();
            $$0.c().a();
            $$0.c().b($$7, $$7, 1.0F);
            $$0.c().a(4.0F, 0.0F, 0.0F);
            int $$10 = ayz.d((float)($$9 - 40) / $$7);
            ...
            if ($$32 > 0L) {
               ...
               $$0.a(-2, 0, $$8 + 4, 9, $$34 << 24);
               $$0.c().a(0.0F, 0.0F, 50.0F);
               $$0.b(this.i.h, xp.a("chat.queue", $$32), 0, 1, 16777215 + ($$33 << 24));
               $$0.c().b();
            }
   ...
   private void a(fgt $$0, int $$1, int $$2, ffc.a $$3) {
      int $$4 = $$2 - $$3.d - 1;
      $$3.a($$0, $$1, $$4);
   }

   private int a(ffb.a $$0) {
      return this.i.h.a($$0.b()) + 4;
   }

   private boolean l() {
      return this.i.m.m().c() == cmx.c;
   }
   ...
   public void a(xp $$0) {
      this.a($$0, null, this.i.W() ? ffc.b() : ffc.a());
   }

   public void a(xp $$0, @Nullable yb $$1, @Nullable ffc $$2) {
      ffb $$3 = new ffb(this.i.l.e(), $$0, $$1, $$2);
      this.a($$3);
      this.b($$3);
      this.c($$3);
   }

   private void a(ffb $$0) {
      String $$1 = $$0.c().getString().replaceAll("\r", "\\\\r").replaceAll("\n", "\\\\n");
      String $$2 = x.a($$0.e(), ffc::h);
      if ($$2 != null) {
         a.info("[{}] [CHAT] {}", $$2, $$1);
      } else {
         a.info("[CHAT] {}", $$1);
   ...
   private void b(ffb $$0) {
      ...
      List<ayl> $$3 = fhl.a($$0.c(), $$1, this.i.h);
      boolean $$4 = this.e();
      ...
      for (int $$5 = 0; $$5 < $$3.size(); $$5++) {
         ...
         this.l.add(0, new ffb.a($$0.b(), $$6, $$0.e(), $$7));
      }
   ...
   @Nullable
   private fhh.a b(yb $$0) {
      int $$1 = this.i.l.e();
      ListIterator<ffb> $$2 = this.k.listIterator();
   ...
   private ffb d(ffb $$0) {
      return new ffb($$0.b(), h, null, ffc.a());
   }
   ...
   private void n() {
      ...
      for (ffb $$0 : Lists.reverse(this.k)) {
         this.b($$0);
      }
   }
   ...
   @Nullable
   public ffc c(double $$0, double $$1) {
      double $$2 = this.c($$0);
      double $$3 = this.d($$1);
      int $$4 = this.d($$2, $$3);
      if ($$4 >= 0 && $$4 < this.l.size()) {
   ...
   private boolean a(double $$0, ffb.a $$1, ffc $$2) {
      if ($$0 < 0.0) {
         return true;
      } else {
         ffc.a $$3 = $$2.f();
   ...
   public boolean e() {
      return this.i.y instanceof flv;
   }
   ...
   public fhh.b k() {
      return new fhh.b(List.copyOf(this.k), List.copyOf(this.j), List.copyOf(this.o));
   }

   public void a(fhh.b $$0) {
      this.j.clear();
      this.j.addAll($$0.b);
      this.o.clear();
      this.o.addAll($$0.c);
   ...
   public static class b {
      ...
      public b(List<ffb> $$0, List<String> $$1, List<fhh.a> $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
