...
public class fhh extends fgd<clg> {
   ...
   private fpc P;
   @Nullable
   private List<Pair<ij<dik>, cnn>> Q;
   private coz R = coz.h;
   private coz S = coz.h;
   private coz T = coz.h;
   private boolean U;
   ...
   protected void aQ_() {
      super.aQ_();
      this.P = this.f.aP().a(fpb.g).b("flag");
   }
   ...
   private void a(eyu $$0, ij<dik> $$1, int $$2, int $$3) {
      sw $$4 = new sw();
      tc $$5 = new dik.a().a(dil.a, cnn.h).a($$1, cnn.a).a();
      $$4.a("Patterns", $$5);
      coz $$6 = new coz(cpc.uS);
      cms.a($$6, div.t, $$4);
      esa $$7 = new esa();
      $$7.a();
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      ...
      if (this.U && $$4 > 0) {
         ...
         this.W = awh.a(this.W - $$5, 0.0F, 1.0F);
   ...
   private void J() {
      ...
      if ($$0.b()) {
         ...
         this.Q = dij.a(((cmp)$$0.d()).b(), dij.a($$0));
      }
      ...
      if (!coz.a($$1, this.R) || !coz.a($$2, this.S) || !coz.a($$3, this.T)) {
