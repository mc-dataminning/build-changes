...
public class fhh {
   ...
   private static final Map<dxp.a, String> e = ac.a(new EnumMap<>(dxp.a.class), $$0 -> {
      $$0.put(dxp.a.a, "SW");
      $$0.put(dxp.a.b, "S");
      $$0.put(dxp.a.c, "OW");
      $$0.put(dxp.a.d, "O");
   ...
   private dud l;
   @Nullable
   private CompletableFuture<dud> m;
   private boolean n;
   private boolean o;
   private boolean p;
   private boolean q;
   private final blp r = new blp(1);
   private final blp s = new blp(blu.values().length);
   private final blp t = new blp(1);
   private final blp u = new blp(1);
   private final Map<blq, blp> v = Map.of(blq.a, this.s);
   private final fiq w;
   private final fis x;
   private final fir y;
   private final fip z;
   ...
   public fhh(ffa $$0) {
      ...
      this.g = new fhh.a();
      this.h = $$0.h;
      this.w = new fiq(this.h, this.r);
      this.x = new fis(this.h, this.s, () -> $$0.r.s().g());
      this.y = new fir(this.h, this.t);
      this.z = new fip(this.h, this.u);
   }
   ...
   private void a(fgm $$0, List<String> $$1, boolean $$2) {
      int $$3 = 9;
   ...
   protected List<String> b() {
      ...
      if (this.f.aw()) {
         ...
         dbt $$23 = this.r();
         LongSet $$24 = (LongSet)($$23 instanceof arb ? ((arb)$$23).w() : LongSets.EMPTY_SET);
         ...
         $$25.add(String.format(Locale.ROOT, "Facing: %s (%s) (%.1f / %.1f)", $$16, $$21, ayu.g($$15.dF()), ayu.g($$15.dH())));
         dud $$27 = this.t();
         if ($$27.C()) {
            $$25.add("Waiting for chunk...");
         } else {
            int $$28 = this.f.r.i().p().a($$14, 0);
            int $$29 = this.f.r.a(dcc.a, $$14);
            int $$30 = this.f.r.a(dcc.b, $$14);
            $$25.add("Client Light: " + $$28 + " (" + $$29 + " sky, " + $$30 + " block)");
            dud $$31 = this.s();
            StringBuilder $$32 = new StringBuilder("CH");

            for (dxp.a $$33 : dxp.a.values()) {
               if ($$33.b()) {
            ...
            if ($$14.v() >= this.f.r.I_() && $$14.v() < this.f.r.am()) {
               ...
               if ($$31 != null) {
                  float $$35 = $$23.aq();
                  long $$36 = $$31.u();
                  bqn $$37 = new bqn($$23.al(), $$23.aa(), $$36, $$35);
         ...
         if ($$38 != null) {
            ...
            dce.d $$44 = $$39.n();
            if ($$44 != null) {
               Object2IntMap<btn> $$45 = $$44.b();
               int $$46 = $$44.a();
               $$25.add(
                  "SC: "
                     + $$46
                     + ", "
                     + Stream.of(btn.values())
   ...
   private static String a(ji<dcs> $$0) {
   ...
   private dbt r() {
      return (dbt)DataFixUtils.orElse(Optional.ofNullable(this.f.V()).flatMap($$0 -> Optional.ofNullable($$0.a(this.f.r.af()))), this.f.r);
   }
   ...
   private dud s() {
      if (this.m == null) {
         ...
         this.m = $$0.l().b(this.k.e, this.k.f, dus.n, false).thenApply($$0x -> (dud)$$0x.b(null));
      }
   ...
   protected List<String> c() {
      ...
      List<String> $$4 = Lists.newArrayList(
         new String[]{
            ...
            "",
            String.format(Locale.ROOT, "CPU: %s", eym.b()),
            "",
            String.format(Locale.ROOT, "Display: %dx%d (%s)", ffa.Q().aO().k(), ffa.Q().aO().l(), eym.a()),
            eym.c(),
            eym.d()
         }
      );
      if (this.f.aw()) {
         ...
         if (this.i.c() == evk.a.b) {
            ...
            for (Entry<dta<?>, Comparable<?>> $$7 : $$6.C().entrySet()) {
               $$4.add(this.a($$7));
            }
         ...
         if (this.j.c() == evk.a.b) {
            ...
            for (Entry<dta<?>, Comparable<?>> $$10 : $$9.C().entrySet()) {
               $$4.add(this.a($$10));
            }
   ...
   private String a(Entry<dta<?>, Comparable<?>> $$0) {
      dta<?> $$1 = $$0.getKey();
