...
public class fhh {
   ...
   private final ffw d;
   private final fao e;
   private final gef.a f;
   private final fhh.a g = new fhh.a();
   private final fhi h;
   private boolean i;

   private fhh(ffw $$0, fao $$1, gef.a $$2) {
      this.d = $$0;
      this.e = $$1;
      this.f = $$2;
      this.h = $$0.aG();
   ...
   public void a(int $$0, int $$1, int $$2, int $$3) {
      this.a(gen.D(), $$0, $$1, $$2, $$3);
   }

   public void a(gen $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$2 < $$1) {
         int $$5 = $$1;
         $$1 = $$2;
         $$2 = $$5;
   ...
   public void b(int $$0, int $$1, int $$2, int $$3) {
      this.b(gen.D(), $$0, $$1, $$2, $$3);
   }

   public void b(gen $$0, int $$1, int $$2, int $$3, int $$4) {
      if ($$3 < $$2) {
         int $$5 = $$2;
         $$2 = $$3;
         $$3 = $$5;
   ...
   public void c(int $$0, int $$1, int $$2, int $$3) {
      this.a(this.g.a(new fma($$0, $$1, $$2 - $$0, $$3 - $$1)));
   }
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a(gen.D(), $$0, $$1, $$2, $$3, $$4, $$5);
   }

   public void a(gen $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, 0, $$5);
   }

   public void a(gen $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
   ...
   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      this.a(gen.D(), $$0, $$1, $$2, $$3, $$5, $$6, $$4);
   }

   public void a(gen $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
      fas $$8 = this.f.getBuffer($$0);
      this.a($$8, $$1, $$2, $$3, $$4, $$7, $$5, $$6);
      this.g();
   }

   private void a(fas $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
   ...
   public void b(gen $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      Matrix4f $$6 = this.e.c().a();
      fas $$7 = this.f.getBuffer($$0);
   ...
   public void a(fhf $$0, String $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.b($$1) / 2, $$3, $$4);
   }

   public void a(fhf $$0, wu $$1, int $$2, int $$3, int $$4) {
      axs $$5 = $$1.g();
      this.b($$0, $$5, $$2 - $$0.a($$5) / 2, $$3, $$4);
   }

   public void a(fhf $$0, axs $$1, int $$2, int $$3, int $$4) {
      this.b($$0, $$1, $$2 - $$0.a($$1) / 2, $$3, $$4);
   }

   public int b(fhf $$0, @Nullable String $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fhf $$0, @Nullable String $$1, int $$2, int $$3, int $$4, boolean $$5) {
      if ($$1 == null) {
         return 0;
      } else {
         int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, fhf.a.a, 0, 15728880, $$0.a());
         this.g();
         return $$6;
      }
   }

   public int b(fhf $$0, axs $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fhf $$0, axs $$1, int $$2, int $$3, int $$4, boolean $$5) {
      int $$6 = $$0.a($$1, (float)$$2, (float)$$3, $$4, $$5, this.e.c().a(), this.f, fhf.a.a, 0, 15728880);
      this.g();
      return $$6;
   }

   public int b(fhf $$0, wu $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, true);
   }

   public int a(fhf $$0, wu $$1, int $$2, int $$3, int $$4, boolean $$5) {
      return this.a($$0, $$1.g(), $$2, $$3, $$4, $$5);
   }

   public void a(fhf $$0, wz $$1, int $$2, int $$3, int $$4, int $$5) {
      for (axs $$6 : $$0.c($$1, $$4)) {
   ...
   public int a(fhf $$0, wu $$1, int $$2, int $$3, int $$4, int $$5) {
      int $$6 = this.d.m.b(0.0F);
      if ($$6 != 0) {
         int $$7 = 2;
         this.a($$2 - 2, $$3 - 2, $$2 + $$4 + 2, $$3 + 9 + 2, axq.b.a($$6, $$5));
      }

      return this.a($$0, $$1, $$2, $$3, $$5, true);
   }

   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, gpq $$5) {
      this.a($$5, $$0, $$1, $$2, $$3, $$4);
   }

   public void a(int $$0, int $$1, int $$2, int $$3, int $$4, gpq $$5, float $$6, float $$7, float $$8, float $$9) {
   ...
   public void a(akk $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      gpq $$6 = this.h.a($$0);
      gri $$7 = this.h.a($$6);
      if ($$7 instanceof gri.b) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5);
      } else if ($$7 instanceof gri.c $$8) {
         this.a($$6, $$1, $$2, $$3, $$4, $$5, 0, 0, $$8.b(), $$8.c(), $$8.b(), $$8.c());
      } else if ($$7 instanceof gri.a $$9) {
   ...
   private void a(gpq $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9) {
      if ($$8 != 0 && $$9 != 0) {
         this.a(
            $$0.i(),
            $$5,
   ...
   private void a(gpq $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
      if ($$4 != 0 && $$5 != 0) {
   ...
   private void a(gpq $$0, gri.a $$1, int $$2, int $$3, int $$4, int $$5, int $$6) {
      gri.a.a $$7 = $$1.d();
   ...
   private void a(gpq $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, int $$8, int $$9, int $$10, int $$11) {
      if ($$4 > 0 && $$5 > 0) {
         if ($$8 > 0 && $$9 > 0) {
   ...
   public void a(cud $$0, int $$1, int $$2) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, 0);
   }

   public void a(cud $$0, int $$1, int $$2, int $$3) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3);
   }

   public void a(cud $$0, int $$1, int $$2, int $$3, int $$4) {
      this.a(this.d.s, this.d.r, $$0, $$1, $$2, $$3, $$4);
   }

   public void b(cud $$0, int $$1, int $$2) {
      this.b($$0, $$1, $$2, 0);
   }

   public void b(cud $$0, int $$1, int $$2, int $$3) {
      this.a(null, this.d.r, $$0, $$1, $$2, $$3);
   }

   public void a(btc $$0, cud $$1, int $$2, int $$3, int $$4) {
      this.a($$0, $$0.dR(), $$1, $$2, $$3, $$4);
   }

   private void a(@Nullable btc $$0, @Nullable dcg $$1, cud $$2, int $$3, int $$4, int $$5) {
      this.a($$0, $$1, $$2, $$3, $$4, $$5, 0);
   }

   private void a(@Nullable btc $$0, @Nullable dcg $$1, cud $$2, int $$3, int $$4, int $$5, int $$6) {
      if (!$$2.e()) {
         grr $$7 = this.d.ar().a($$2, $$1, $$0, $$5);
         this.e.a();
         ...
         try {
            ...
            this.d.ar().a($$2, cua.g, false, this.e, this.d(), 15728880, gph.d, $$7);
            this.e();
            if ($$8) {
               ezk.d();
            }
   ...
   public void a(fhf $$0, cud $$1, int $$2, int $$3) {
      this.a($$0, $$1, $$2, $$3, null);
   }

   public void a(fhf $$0, cud $$1, int $$2, int $$3, @Nullable String $$4) {
      if (!$$1.e()) {
         this.e.a();
         if ($$1.H() != 1 || $$4 != null) {
         ...
         if ($$1.p()) {
            ...
            int $$8 = $$2 + 2;
            int $$9 = $$3 + 13;
            this.a(gen.E(), $$8, $$9, $$8 + 13, $$9 + 2, -16777216);
            this.a(gen.E(), $$8, $$9, $$8 + $$6, $$9 + 1, $$7 | 0xFF000000);
         }

         gdh $$10 = this.d.s;
         float $$11 = $$10 == null ? 0.0F : $$10.gv().a($$1.g(), this.d.at().a(true));
         if ($$11 > 0.0F) {
            int $$12 = $$3 + ayg.d(16.0F * (1.0F - $$11));
            int $$13 = $$12 + ayg.f(16.0F * $$11);
            this.a(gen.E(), $$2, $$12, $$2 + 16, $$13, Integer.MAX_VALUE);
         }
   ...
   public void b(fhf $$0, cud $$1, int $$2, int $$3) {
      this.a($$0, fnl.a(this.d, $$1), $$1.b(), $$2, $$3);
   }

   public void a(fhf $$0, List<wu> $$1, Optional<cro> $$2, int $$3, int $$4) {
      List<fpu> $$5 = $$1.stream().map(wu::g).map(fpu::a).collect(ac.b());
      $$2.ifPresent($$1x -> $$5.add($$5.isEmpty() ? 0 : 1, fpu.a($$1x)));
      this.a($$0, $$5, $$3, $$4, fpw.a);
   }

   public void a(fhf $$0, wu $$1, int $$2, int $$3) {
      this.b($$0, List.of($$1.g()), $$2, $$3);
   }

   public void a(fhf $$0, List<wu> $$1, int $$2, int $$3) {
      this.b($$0, Lists.transform($$1, wu::g), $$2, $$3);
   }

   public void b(fhf $$0, List<? extends axs> $$1, int $$2, int $$3) {
      this.a($$0, $$1.stream().map(fpu::a).collect(Collectors.toList()), $$2, $$3, fpw.a);
   }

   public void a(fhf $$0, List<axs> $$1, fpv $$2, int $$3, int $$4) {
      this.a($$0, $$1.stream().map(fpu::a).collect(Collectors.toList()), $$3, $$4, $$2);
   }

   private void a(fhf $$0, List<fpu> $$1, int $$2, int $$3, fpv $$4) {
      if (!$$1.isEmpty()) {
         int $$5 = 0;
         int $$6 = $$1.size() == 1 ? -2 : 0;
   ...
   public void a(fhf $$0, @Nullable xr $$1, int $$2, int $$3) {
      if ($$1 != null && $$1.i() != null) {
         xa $$4 = $$1.i();
         xa.c $$5 = $$4.a(xa.a.b);
         if ($$5 != null) {
   ...
   static class a {
      private final Deque<fma> a = new ArrayDeque<>();

      public fma a(fma $$0) {
         fma $$1 = this.a.peekLast();
         if ($$1 != null) {
            fma $$2 = Objects.requireNonNullElse($$0.b($$1), fma.a());
            this.a.addLast($$2);
            return $$2;
         } else {
            this.a.addLast($$0);
