public class fhh extends ffh<bzr> implements fdz {
   private final fhx a;
   private final fhx b;
   private final fhx f;
   private final fhx g;
   ...
   public void a(bzr $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      this.a().e().forEach(fhx::c);
      this.j.f = $$4 * (float) (Math.PI / 180.0);
      this.j.e = $$5 * (float) (Math.PI / 180.0);
      float $$6 = ars.b($$3 * 5.5F * (float) (Math.PI / 180.0)) * 0.1F;
      ...
      this.i.f = 1.0995574F + ars.b($$3 * 45.836624F * (float) (Math.PI / 180.0)) * (float) (Math.PI / 180.0) * 16.2F;
      this.h.f = -this.i.f;
   ...
   private void a(cja $$0, cja $$1, float $$2) {
      if ($$0.b() && $$1.b()) {
         this.f.e = -1.2217305F;
   ...
   private void a(elk $$0, boolean $$1) {
      if ($$1) {
