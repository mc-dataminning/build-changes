...
public abstract class fhh<E extends fhh.a<E>> extends fhe {
   ...
   protected final ffn c;
   protected final int d;
   private final List<E> p = new fhh.b();
   ...
   public fhh(ffn $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wt.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected final E b(double $$0, double $$1) {
      ...
      int $$4 = $$3 - $$2;
      int $$5 = $$3 + $$2;
      int $$6 = aye.a($$1 - (double)this.E()) - this.f + (int)this.n() - 4;
      int $$7 = $$6 / this.d;
      return $$0 >= (double)$$4 && $$0 <= (double)$$5 && $$7 >= 0 && $$6 >= 0 && $$7 < this.l() ? this.aF_().get($$7) : null;
   }

   public void a(int $$0, fkz $$1) {
      this.b($$0, $$1.d(), $$1.c());
   }
   ...
   protected void a(fgz $$0) {
      RenderSystem.enableBlend();
      akk $$1 = this.c.r == null ? fnd.g : fnd.i;
      akk $$2 = this.c.r == null ? fnd.h : fnd.j;
   ...
   protected void e(E $$0) {
      this.b((double)(this.aF_().indexOf($$0) * this.d + this.d / 2 - this.h / 2));
   }
   ...
   public void a(double $$0) {
      this.q = aye.a($$0, 0.0, (double)this.p());
   }
   ...
   public boolean a(double $$0, double $$1, int $$2, double $$3, double $$4) {
      if (super.a($$0, $$1, $$2, $$3, $$4)) {
         ...
         if ($$1 < (double)this.E()) {
            ...
            int $$6 = this.h;
            int $$7 = aye.a((int)((float)($$6 * $$6) / (float)this.a()), 32, $$6 - 8);
   ...
   @Nullable
   protected E a(flq $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(flq $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   protected void a(fgz $$0, int $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   public flg.a u() {
      if (this.aJ_()) {
         ...
         return this.v != null ? flg.a.b : flg.a.a;
      }
   }
   ...
   protected void a(fli $$0, E $$1) {
      List<E> $$2 = this.aF_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(flh.b, wu.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fhh.a<E>> implements fji {
      @Deprecated
      fhh<E> a;
      ...
      public abstract void a(fgz var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
