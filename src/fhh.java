...
public class fhh extends exl.a<fhh> {
   private static final ahg f = new ahg("icon/draft_report");
   private static final int g = 10;
   private static final eys h = new eys(
   ...
   private static final eys i = new eys(new ahg("social_interactions/mute_button"), new ahg("social_interactions/mute_button_highlighted"));
   private static final eys j = new eys(new ahg("social_interactions/unmute_button"), new ahg("social_interactions/unmute_button_highlighted"));
   private final evh k;
   private final List<exd> l;
   ...
   public fhh(evh $$0, fhk $$1, UUID $$2, String $$3, Supplier<gfl> $$4, boolean $$5) {
      this.k = $$0;
      this.m = $$2;
      this.n = $$3;
      this.o = $$4;
      ...
      if ($$11 && $$10 && !$$9.e($$2)) {
         this.x = new exr(0, 0, 20, 20, h, $$3x -> $$6.a($$0, $$1, () -> $$0.a(new fhd($$1, $$6, this)), false), vf.c("gui.socialInteractions.report")) {
            @Override
            protected vt aK_() {
               return fhh.this.a(super.aK_());
            }
         };
         this.x.j = this.r;
         this.x.a(this.k());
         this.x.j(10);
         this.v = new exr(0, 0, 20, 20, i, $$3x -> {
            $$9.a($$2);
   ...
   private eyq k() {
      return !this.r ? eyq.a(E) : eyq.a(H, vf.a("gui.socialInteractions.narration.report", this.n));
   }
