...
public abstract class eop<M extends eoj<M>, S extends eom<M>> implements eol {
   public static final int a = 15;
   protected static final int b = 1;
   protected static final long c = eop.a.a(1);
   private static final int g = 512;
   protected static final ji[] d = ji.values();
   protected final dvj e;
   protected final S f;
   ...
   private final jd.a k = new jd.a();
   private static final int l = 2;
   private final long[] m = new long[2];
   private final dvi[] n = new dvi[2];

   protected eop(dvj $$0, S $$1) {
      this.e = $$0;
      this.f = $$1;
      this.c();
   }

   public static boolean a(dca $$0, jd $$1, dta $$2, dta $$3) {
      return $$3 == $$2 ? false : $$3.b($$0, $$1) != $$2.b($$0, $$1) || $$3.h() != $$2.h() || $$3.g() || $$2.g();
   }

   public static int a(dca $$0, dta $$1, jd $$2, dta $$3, jd $$4, ji $$5, int $$6) {
      boolean $$7 = a($$1);
      boolean $$8 = a($$3);
      if ($$7 && $$8) {
         return $$6;
      } else {
         exp $$9 = $$7 ? exm.a() : $$1.c($$0, $$2);
         exp $$10 = $$8 ? exm.a() : $$3.c($$0, $$4);
         return exm.b($$9, $$10, $$5) ? 16 : $$6;
      }
   }

   public static exp a(dca $$0, jd $$1, dta $$2, ji $$3) {
      return a($$2) ? exm.a() : $$2.a($$0, $$1, $$3);
   }
   ...
   protected dta c(jd $$0) {
      int $$1 = kf.a($$0.u());
      int $$2 = kf.a($$0.w());
      dvi $$3 = this.a($$1, $$2);
      return $$3 == null ? dfy.F.o() : $$3.a_($$0);
   }

   protected int a(dta $$0, jd $$1) {
      return Math.max(1, $$0.b(this.e.q(), $$1));
   }

   protected boolean a(long $$0, dta $$1, long $$2, dta $$3, ji $$4) {
      exp $$5 = this.a($$1, $$0, $$4);
      exp $$6 = this.a($$3, $$2, $$4.g());
      return exm.b($$5, $$6);
   }

   protected exp a(dta $$0, long $$1, ji $$2) {
      return a(this.e.q(), this.k.f($$1), $$0, $$2);
   }

   @Nullable
   protected dvi a(int $$0, int $$1) {
      long $$2 = dcb.c($$0, $$1);
   ...
   public void a(long $$0, @Nullable dvb $$1) {
      this.f.a($$0, $$1);
   }

   public void b(dcb $$0, boolean $$1) {
      this.f.c(kf.b($$0.e, $$0.f), $$1);
   }
   ...
   public static class a {
      ...
      public static long a(int $$0, ji $$1) {
         long $$2 = c(1008L, $$1);
         return a($$2, $$0);
      }
      ...
      public static long a(int $$0, boolean $$1, ji $$2) {
         long $$3 = c(1008L, $$2);
         if ($$1) {
            $$3 |= 1024L;
         }
      ...
      public static long b(int $$0, boolean $$1, ji $$2) {
         long $$3 = 0L;
         if ($$1) {
            $$3 |= 1024L;
         }
      ...
      public static boolean a(long $$0, ji $$1) {
      ...
      private static long b(long $$0, ji $$1) {
         return $$0 | 1L << $$1.ordinal() + 4;
      }

      private static long c(long $$0, ji $$1) {
         return $$0 & ~(1L << $$1.ordinal() + 4);
      }
   }
}
