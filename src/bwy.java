...
public abstract class bwy extends bwl {
   ...
   public bwy(bpw $$0, double $$1, int $$2) {
      this($$0, $$1, $$2, 1);
   }

   public bwy(bpw $$0, double $$1, int $$2, int $$3) {
      this.a = $$0;
      this.b = $$1;
      this.l = $$2;
      this.f = 0;
      this.m = $$3;
      this.a(EnumSet.of(bwl.a.a, bwl.a.c));
   }
   ...
   protected abstract boolean a(cxc var1, ib var2);
}
