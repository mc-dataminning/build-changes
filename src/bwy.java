...
public abstract class bwy<E extends bvf> implements bwz<E> {
   public static final int a = 60;
   protected final Map<cej<?>, cek> b;
   private bwy.a c = bwy.a.a;
   private long d;
   private final int e;
   private final int f;

   public bwy(Map<cej<?>, cek> $$0) {
      this($$0, 60);
   }

   public bwy(Map<cej<?>, cek> $$0, int $$1) {
      this($$0, $$1, $$1);
   }

   public bwy(Map<cej<?>, cek> $$0, int $$1, int $$2) {
      this.e = $$1;
      this.f = $$2;
      this.b = $$0;
   }
   ...
   protected boolean a(E $$0) {
      for (Entry<cej<?>, cek> $$1 : this.b.entrySet()) {
         cej<?> $$2 = $$1.getKey();
         cek $$3 = $$1.getValue();
         if (!$$0.ec().a($$2, $$3)) {
            return false;
