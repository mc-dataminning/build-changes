...
public abstract class bwy extends chs implements bwi {
   public static final int bZ = 144;
   private static final int cd = 2;
   private static final int ce = 3;
   private static final int cf = 1;
   protected static final alc<Byte> ca = alg.a(bwy.class, ale.a);
   protected static final alc<Optional<UUID>> cb = alg.a(bwy.class, ale.r);
   private boolean cg;

   protected bwy(bvm<? extends bwy> $$0, dha $$1) {
      super($$0, $$1);
   }
   ...
   @Override
   public void a(btv $$0) {
      if (this.dV() instanceof ash $$1 && $$1.N().b(dgw.n) && this.ah_() instanceof asi $$2) {
         $$2.a(this.eP().a());
      }
   ...
   public boolean go() {
      bwb $$0 = this.ah_();
      return $$0 != null && this.g((bvf)this.ah_()) >= 144.0;
   }
   ...
   public class a extends cds {
      public a(final double param3, final ayk<btx> bwy.this) {
         super(bwy.this, $$1, $$2);
      }
