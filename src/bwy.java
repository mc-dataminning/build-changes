...
public class bwy extends bii {
   private static final adz<Optional<gu>> c = aec.a(bwy.class, aeb.o);
   private static final adz<Boolean> d = aec.a(bwy.class, aeb.k);
   public int b;

   public bwy(bim<? extends bwy> $$0, cpl $$1) {
      super($$0, $$1);
      this.I = true;
      this.b = this.ag.a(100000);
   }

   public bwy(cpl $$0, double $$1, double $$2, double $$3) {
      this(bim.B, $$0);
      this.e($$1, $$2, $$3);
   }
      ...
      if (this.b($$0)) {
         ...
         if (!this.dF() && !this.dK().B) {
            ...
            if (!$$0.a(apn.l)) {
               ...
               this.dK().a(this, $$2, null, this.dp(), this.dr(), this.dv(), 6.0F, false, cpl.a.b);
            }
