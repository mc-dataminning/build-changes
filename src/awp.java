...
public class awp extends bav {
   public awp(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntityJukeboxFix", bbv.s, "minecraft:jukebox");
   }

   @Override
   protected Typed<?> a(Typed<?> $$0) {
      Type<?> $$1 = this.getInputSchema().getChoiceType(bbv.s, "minecraft:jukebox");
