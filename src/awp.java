...
public class awp extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> $$1 = this.getOutputSchema().getType(bbw.t);
      TaggedChoiceType<String> $$2 = this.getInputSchema().findChoiceType(bbw.s);
      TaggedChoiceType<String> $$3 = this.getOutputSchema().findChoiceType(bbw.s);
