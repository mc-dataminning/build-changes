...
public class awp extends baq {
   public static final Gson a = new GsonBuilder().registerTypeAdapter(vd.class, new JsonDeserializer<vd>() {
      public vr a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         if ($$0.isJsonPrimitive()) {
            return vd.b($$0.getAsString());
         } else if ($$0.isJsonArray()) {
            JsonArray $$3 = $$0.getAsJsonArray();
            vr $$4 = null;

            for (JsonElement $$5 : $$3) {
               vr $$6 = this.a($$5, $$5.getClass(), $$2);
               if ($$4 == null) {
                  $$4 = $$6;
               } else {
                  $$4.b($$6);
   ...
   public awp(Schema $$0, boolean $$1) {
      super($$0, $$1, "BlockEntitySignTextStrictJsonFix", bbq.s, "Sign");
   }
   ...
   private Dynamic<?> a(Dynamic<?> $$0, String $$1) {
      ...
      return $$0.set($$1, $$0.createString(vd.a.a($$3)));
   }
