public class ggx implements ggt<dqj> {
   private final glb a;
   ...
   public void a(dqj $$0, float $$1, fbc $$2, get $$3, int $$4, int $$5) {
      if ($$0.i() != null) {
         int $$6 = $$0.n().c(dtq.bv);
         if ($$6 > 0) {
            ji $$7 = $$0.d();
            if ($$7 != null) {
               ...
               if (!$$8.e()) {
                  ...
                  $$2.b(0.5F, 0.5F, 0.5F);
                  int $$11 = ger.a($$0.i(), $$0.n(), $$0.az_().a($$7));
                  this.a.a($$8, cul.i, $$11, gpw.d, $$2, $$3, $$0.i(), 0);
                  $$2.b();
               }
            }
         }
