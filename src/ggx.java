...
public class ggx implements ghc.a {
   ...
   private final ffh J;
   private final Map<iz, ggx.a> K = Maps.newHashMap();
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bsw $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dK();
      });
   }

   private void b(faa $$0, gdq $$1, double $$2, double $$3, double $$4) {
      iz $$5 = iz.a($$2, $$3, $$4);
   ...
   private void a(faa $$0, gdq $$1, ggx.a $$2) {
      int $$3 = 0;
   ...
   private void a(faa $$0, gdq $$1, aau.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         ghk.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(faa $$0, gdq $$1, aau.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(faa $$0, gdq $$1, String $$2, ggx.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }
   ...
   private void d() {
      ghc.a(this.J.an(), 8).ifPresent($$0 -> this.M = $$0.cz());
   }
