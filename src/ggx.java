...
public class ggx implements aip {
   ...
   private final AtomicReference<ggx.a> l = new AtomicReference<>(ggx.a.a);

   public ggx(vi $$0, fmg $$1, @Nullable ghn $$2, @Nullable fvi $$3, boolean $$4, @Nullable Duration $$5, Consumer<wp> $$6, @Nullable ghr $$7) {
      this.f = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a(ggx.a $$0) {
      ggx.a $$1 = this.l.updateAndGet($$1x -> {
         if (!$$0.f.contains($$1x)) {
   ...
   public void a(aiu $$0) {
      ...
      this.f
         .a(
            aba.d,
            new ggw(this.b, this.f, new ghd($$1, this.b.u().a(this.g, this.h, this.i), ghb.a().a(), csp.h, null, this.c, this.d, this.j, null, Map.of(), alm.a))
         );
      this.f.a(ajb.a);
      this.f.a(aba.b);
   ...
   public void a(vk $$0) {
      ...
      if (this.c != null && this.c.e()) {
         this.b.a(new hma(this.d, $$1, $$0.a()));
      } else {
         this.b.a(new fup(this.d, $$1, $$0));
      }
   }
   ...
   static enum a {
      ...
      private a(final wp $$0, final Set<ggx.a> $$1) {
         this.e = $$0;
         this.f = $$1;
      }
   }
