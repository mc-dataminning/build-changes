...
public class cet {
   ...
   private int g = aup.b(auw.a(), 0, 2);
   int h;
   private static final Codec<Pair<UUID, Integer>> i = RecordCodecBuilder.create(
      $$0 -> $$0.group(ja.a.fieldOf("uuid").forGetter(Pair::getFirst), atx.i.fieldOf("anger").forGetter(Pair::getSecond)).apply($$0, Pair::of)
   );
   private final Predicate<blw> j;
   @VisibleForTesting
   protected final ArrayList<blw> c;
   private final cet.a k;
   @VisibleForTesting
   protected final Object2IntMap<blw> d;
   @VisibleForTesting
   protected final Object2IntMap<UUID> e;

   public static Codec<cet> a(Predicate<blw> $$0) {
      return RecordCodecBuilder.create(
         $$1 -> $$1.group(i.listOf().fieldOf("suspects").orElse(Collections.emptyList()).forGetter(cet::b)).apply($$1, $$1x -> new cet($$0, $$1x))
      );
   }

   public cet(Predicate<blw> $$0, List<Pair<UUID, Integer>> $$1) {
      this.j = $$0;
      this.c = new ArrayList<>();
      this.k = new cet.a(this);
   ...
   public void a(ane $$0, Predicate<blw> $$1) {
      this.g--;
      if (this.g <= 0) {
         this.a($$0);
         this.g = 2;
      ...
      ObjectIterator<Entry<blw>> $$5 = this.d.object2IntEntrySet().iterator();

      while ($$5.hasNext()) {
         Entry<blw> $$6 = (Entry<blw>)$$5.next();
         int $$7 = $$6.getIntValue();
         blw $$8 = (blw)$$6.getKey();
         blw.c $$9 = $$8.dH();
   ...
   public int b(@Nullable blw $$0) {
      return $$0 == null ? this.h : this.d.getInt($$0);
   }

   public Optional<bmo> a() {
      return Optional.ofNullable(this.d()).filter($$0 -> $$0 instanceof bmo).map($$0 -> (bmo)$$0);
   }

   @VisibleForTesting
   protected static record a(cet a) implements Comparator<blw> {
      public int a(blw $$0, blw $$1) {
         if ($$0.equals($$1)) {
            return 0;
         } else {
            ...
            if ($$4 != $$5) {
               ...
               boolean $$6 = $$0 instanceof cfq;
               boolean $$7 = $$1 instanceof cfq;
               if ($$6 != $$7) {
                  return $$6 ? -1 : 1;
               } else {
