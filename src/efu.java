...
public class efu extends eef<ehi> {
   public efu(Codec<ehi> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eeh<ehi> $$0) {
      dfs $$1 = $$0.b();
      ehi $$2 = $$0.f();
      azr $$3 = $$0.d();
      jg $$4 = $$0.e();
      Predicate<dvd> $$5 = $$1x -> $$1x.a($$2.b);
      int $$6 = $$2.j.a($$3) + 1;
      int $$7 = $$2.j.a($$3) + 1;
      Set<jg> $$8 = this.a($$1, $$2, $$3, $$4, $$5, $$6, $$7);
      ...
      for (int $$12 = -$$5; $$12 <= $$5; $$12++) {
         ...
         for (int $$14 = -$$6; $$14 <= $$6; $$14++) {
            ...
            if (!$$17 && (!$$18 || $$1.k != 0.0F && !($$2.i() > $$1.k))) {
               ...
               for (int $$19 = 0; $$0.a($$7, dvc.a::l) && $$19 < $$1.h; $$19++) {
                  $$7.c($$9);
               }
   ...
   protected void a(eeh<ehi> $$0, dfs $$1, ehi $$2, azr $$3, Set<jg> $$4, int $$5, int $$6) {
      for (jg $$7 : $$4) {
         if ($$2.i > 0.0F && $$3.i() < $$2.i) {
            this.a($$1, $$2, $$0.c(), $$3, $$7);
         }
   ...
   protected boolean a(dfs $$0, ehi $$1, Predicate<dvd> $$2, azr $$3, jg.a $$4, int $$5) {
      for (int $$6 = 0; $$6 < $$5; $$6++) {
         dvd $$7 = $$1.c.a($$3, $$4);
         dvd $$8 = $$0.a_($$4);
         if (!$$7.a($$8.b())) {
