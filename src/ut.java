...
public class ut extends ul<uu> {
   private static final int b = 24;
   public static final vl<ut> a = new vl.b<ut>() {
      public ut a(DataInput $$0, uv $$1) throws IOException {
         return new ut(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof ut && Arrays.equals(this.c, ((ut)$$0).c);
   }
   ...
   public uu a(int $$0, uu $$1) {
      long $$2 = this.c[$$0];
      this.c[$$0] = $$1.f();
      return uu.a($$2);
   }

   public void b(int $$0, uu $$1) {
   ...
   public boolean b(int $$0, vj $$1) {
      if ($$1 instanceof vc) {
         this.c = ArrayUtils.add(this.c, $$0, ((vc)$$1).f());
         return true;
      } else {
         return false;
      }
