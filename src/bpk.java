...
public abstract class bpk<R extends Runnable> implements bos, bpm<R>, Executor {
   private final String b;
   private static final Logger c = LogUtils.getLogger();
   private final Queue<R> d = Queues.newConcurrentLinkedQueue();
   private int e;

   protected bpk(String $$0) {
      this.b = $$0;
      boq.a.a(this);
   }
   ...
   @Override
   public List<bop> bv() {
      return ImmutableList.of(bop.a(this.b + "-pending-tasks", boo.b, this::bx));
   }
}
