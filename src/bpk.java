...
public class bpk<T> implements Closeable {
   private static final Gson a = new Gson();
   private final Codec<T> b;
   final FileChannel c;
   private final AtomicInteger d = new AtomicInteger(1);

   public bpk(Codec<T> $$0, FileChannel $$1) {
      this.b = $$0;
      this.c = $$1;
   }

   public static <T> bpk<T> a(Codec<T> $$0, Path $$1) throws IOException {
   ...
   public bpl<T> a() throws IOException {
      if (this.d.get() <= 0) {
         throw new IOException("Event log has already been closed");
      } else {
         this.d.incrementAndGet();
         final bpl<T> $$0 = bpl.a(this.b, Channels.newReader(this.c, StandardCharsets.UTF_8));
         return new bpl<T>() {
            ...
            public T a() throws IOException {
               Object var1;
               try {
                  bpk.this.c.position(this.c);
                  var1 = $$0.a();
               } finally {
                  this.c = bpk.this.c.position();
               }
