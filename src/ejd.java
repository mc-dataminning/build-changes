...
public class ejd {
   ...
   @Nullable
   private String g;
   private static final ejd.a h = new ejd.a() {
      @Nullable
      @Override
      public ejc a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (ejg.a(this.d, "Get capabilities")) {
         ...
         int $$5 = this.i();
         int $$6 = aro.a((int)aro.c((float)$$5), 2, 8);
         int $$7 = aro.a($$5 - $$6, 8, 255);
         this.i = new ejd.b($$7);
         this.j = new ejd.b($$6);
         ALCapabilities $$8 = AL.createCapabilities($$2);
         ejg.a("Initialization");
         if (!$$8.AL_EXT_source_distance_model) {
            ...
            if (!$$8.AL_EXT_LINEAR_DISTANCE) {
               ...
               ejg.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !ejg.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public ejc a(ejd.c $$0) {
      return ($$0 == ejd.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements ejd.a {
      private final int a;
      private final Set<ejc> b = Sets.newIdentityHashSet();
      ...
      public ejc a() {
         if (this.b.size() >= this.a) {
            if (aa.aS) {
               ejd.a.warn("Maximum sound pool size {} reached", this.a);
            }
