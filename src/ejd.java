...
public class ejd extends ejh {
   public static final MapCodec<ejd> a = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               ...
               eiq.a.fieldOf("block_provider").forGetter($$0x -> $$0x.e),
               Codec.intRange(1, 16).fieldOf("required_empty_blocks").forGetter($$0x -> $$0x.f),
               ayt.a(jm.g.listOf()).fieldOf("directions").forGetter($$0x -> $$0x.g)
            )
            .apply($$0, ejd::new)
   );
   ...
   protected final eiq e;
   protected final int f;
   protected final List<jm> g;

   public ejd(float $$0, int $$1, int $$2, eiq $$3, int $$4, List<jm> $$5) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   private boolean a(ejh.a $$0, jh $$1, jm $$2) {
