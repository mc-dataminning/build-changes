...
public class ejd implements eiy {
   public static final Codec<ejd> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               mb.e.q().fieldOf("block").flatXmap(ejd::a, DataResult::success).orElse((dpj)dkg.fu).forGetter($$0x -> $$0x.b),
   ...
   public final jv<dke> h;
   private final ObjectArrayList<jn> i;

   private static DataResult<dpj> a(dke $$0) {
      return $$0 instanceof dpj $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface spreadeable block");
   }

   public ejd(dpj $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, jv<dke> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
