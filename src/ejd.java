...
public class ejd {
   ...
   public ejd(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public ejd(ht $$0, ht $$1) {
      this((double)$$0.u(), (double)$$0.v(), (double)$$0.w(), (double)$$1.u(), (double)$$1.v(), (double)$$1.w());
   }

   public ejd(eji $$0, eji $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static ejd a(dwn $$0) {
      return new ejd((double)$$0.g(), (double)$$0.h(), (double)$$0.i(), (double)($$0.j() + 1), (double)($$0.k() + 1), (double)($$0.l() + 1));
   }

   public static ejd a(eji $$0) {
      return new ejd($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public ejd a(double $$0) {
      return new ejd($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public ejd b(double $$0) {
      return new ejd(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public ejd c(double $$0) {
      return new ejd(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public ejd d(double $$0) {
      return new ejd(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public ejd e(double $$0) {
      return new ejd(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public ejd f(double $$0) {
      return new ejd(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public ejd b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public ejd c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public ejd d(double $$0, double $$1, double $$2) {
      return new ejd(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public ejd f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public ejd h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<eji> b(eji $$0, eji $$1) {
   ...
   @Nullable
   public static eje a(Iterable<ejd> $$0, eji $$1, eji $$2, ht $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new eje($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static hx a(ejd $$0, eji $$1, double[] $$2, @Nullable hx $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public eji f() {
      return new eji(ati.d(0.5, this.a, this.d), ati.d(0.5, this.b, this.e), ati.d(0.5, this.c, this.f));
   }

   public static ejd a(eji $$0, double $$1, double $$2, double $$3) {
      return new ejd($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
