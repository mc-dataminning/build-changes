...
public class bld extends Schema {
   ...
   protected static final HookFunction b = new HookFunction() {
      public <T> T apply(DynamicOps<T> $$0, T $$1) {
         return bld.a(new Dynamic($$0, $$1), bld.d, bld.a);
      }
   };
   ...
   protected static TypeTemplate a(Schema $$0) {
      return DSL.optionalFields("Equipment", DSL.list(bgh.t.in($$0)));
   }
   ...
   protected static void b(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("inTile", bgh.C.in($$0)));
   }

   protected static void c(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, String $$2) {
      $$0.register($$1, $$2, () -> DSL.optionalFields("DisplayTile", bgh.C.in($$0)));
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "Item", $$1x -> DSL.optionalFields("Item", bgh.t.in($$0)));
      $$0.registerSimple($$1, "XPOrb");
      b($$0, $$1, "ThrownEgg");
      $$0.registerSimple($$1, "LeashKnot");
      $$0.registerSimple($$1, "Painting");
      $$0.register($$1, "Arrow", $$1x -> DSL.optionalFields("inTile", bgh.C.in($$0)));
      $$0.register($$1, "TippedArrow", $$1x -> DSL.optionalFields("inTile", bgh.C.in($$0)));
      $$0.register($$1, "SpectralArrow", $$1x -> DSL.optionalFields("inTile", bgh.C.in($$0)));
      b($$0, $$1, "Snowball");
      b($$0, $$1, "Fireball");
      b($$0, $$1, "SmallFireball");
      b($$0, $$1, "ThrownEnderpearl");
      $$0.registerSimple($$1, "EyeOfEnderSignal");
      $$0.register($$1, "ThrownPotion", $$1x -> DSL.optionalFields("inTile", bgh.C.in($$0), "Potion", bgh.t.in($$0)));
      b($$0, $$1, "ThrownExpBottle");
      $$0.register($$1, "ItemFrame", $$1x -> DSL.optionalFields("Item", bgh.t.in($$0)));
      b($$0, $$1, "WitherSkull");
      $$0.registerSimple($$1, "PrimedTnt");
      $$0.register($$1, "FallingSand", $$1x -> DSL.optionalFields("Block", bgh.C.in($$0), "TileEntityData", bgh.s.in($$0)));
      $$0.register($$1, "FireworksRocketEntity", $$1x -> DSL.optionalFields("FireworksItem", bgh.t.in($$0)));
      $$0.registerSimple($$1, "Boat");
      $$0.register($$1, "Minecart", () -> DSL.optionalFields("DisplayTile", bgh.C.in($$0), "Items", DSL.list(bgh.t.in($$0))));
      c($$0, $$1, "MinecartRideable");
      $$0.register($$1, "MinecartChest", $$1x -> DSL.optionalFields("DisplayTile", bgh.C.in($$0), "Items", DSL.list(bgh.t.in($$0))));
      c($$0, $$1, "MinecartFurnace");
      c($$0, $$1, "MinecartTNT");
      $$0.register($$1, "MinecartSpawner", () -> DSL.optionalFields("DisplayTile", bgh.C.in($$0), bgh.F.in($$0)));
      $$0.register($$1, "MinecartHopper", $$1x -> DSL.optionalFields("DisplayTile", bgh.C.in($$0), "Items", DSL.list(bgh.t.in($$0))));
      ...
      a($$0, $$1, "Ghast");
      a($$0, $$1, "PigZombie");
      $$0.register($$1, "Enderman", $$1x -> DSL.optionalFields("carried", bgh.C.in($$0), a($$0)));
      a($$0, $$1, "CaveSpider");
      a($$0, $$1, "Silverfish");
      a($$0, $$1, "Blaze");
      a($$0, $$1, "LavaSlime");
      ...
      a($$0, $$1, "VillagerGolem");
      $$0.register(
         $$1, "EntityHorse", $$1x -> DSL.optionalFields("Items", DSL.list(bgh.t.in($$0)), "ArmorItem", bgh.t.in($$0), "SaddleItem", bgh.t.in($$0), a($$0))
      );
      a($$0, $$1, "Rabbit");
      $$0.register(
         $$1,
         "Villager",
         $$1x -> DSL.optionalFields("Inventory", DSL.list(bgh.t.in($$0)), "Offers", DSL.optionalFields("Recipes", DSL.list(bgh.x.in($$0))), a($$0))
      );
      $$0.registerSimple($$1, "EnderCrystal");
      $$0.register($$1, "AreaEffectCloud", $$1x -> DSL.optionalFields("Particle", bgh.y.in($$0)));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "RecordPlayer", $$1x -> DSL.optionalFields("RecordItem", bgh.t.in($$0)));
      d($$0, $$1, "Trap");
      d($$0, $$1, "Dropper");
      $$0.registerSimple($$1, "Sign");
      $$0.register($$1, "MobSpawner", $$1x -> bgh.F.in($$0));
      ...
      $$0.register($$1, "FlowerPot", $$1x -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), bgh.D.in($$0))));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bgh.b, () -> DSL.optionalFields("Inventory", DSL.list(bgh.t.in($$0)), "EnderItems", DSL.list(bgh.t.in($$0))));
      $$0.registerType(
         false,
         bgh.c,
         () -> DSL.fields(
      ...
      $$0.registerType(true, bgh.s, () -> DSL.optionalFields("components", bgh.w.in($$0), DSL.taggedChoiceLazy("id", DSL.string(), $$2)));
      $$0.registerType(true, bgh.A, () -> DSL.optionalFields("Riding", bgh.A.in($$0), bgh.B.in($$0)));
      $$0.registerType(false, bgh.z, () -> DSL.constType(bht.a()));
      $$0.registerType(true, bgh.B, () -> DSL.taggedChoiceLazy("id", DSL.string(), $$1));
      $$0.registerType(
         true,
         bgh.t,
         () -> DSL.hook(
               DSL.optionalFields(
                  "id",
                  DSL.or(DSL.constType(DSL.intType()), bgh.D.in($$0)),
                  "tag",
                  DSL.optionalFields(
                     new Pair[]{
      ...
      $$0.registerType(false, bgh.C, () -> DSL.or(DSL.constType(DSL.intType()), DSL.constType(bht.a())));
      $$0.registerType(false, bgh.D, () -> DSL.constType(bht.a()));
      ...
      $$0.registerType(false, bgh.H, DSL::remainder);
      $$0.registerType(false, bgh.I, DSL::remainder);
      $$0.registerType(true, bgh.F, DSL::remainder);
   ...
   protected static <T> T a(Dynamic<T> $$0, Map<String, String> $$1, Map<String, String> $$2) {
      return (T)$$0.update("tag", $$3 -> $$3.update("BlockEntityTag", $$2xx -> {
            String $$3x = $$0.get("id").asString().result().map(bht::a).orElse("minecraft:air");
            ...
            if ($$2xx.get("id").result().isPresent()) {
               ...
               String $$3x = bht.a($$0.get("id").asString(""));
               String $$4 = $$2.get($$3x);
