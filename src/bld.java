...
public class bld extends bkr {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:enderman", () -> DSL.optionalFields("carriedBlockState", biw.u.in($$0)));
      ...
      $$0.register($$1, "minecraft:commandblock_minecart", () -> DSL.optionalFields("DisplayState", biw.u.in($$0), "LastOutput", biw.z.in($$0)));
      ...
      $$0.register($$1, "minecraft:spawner_minecart", () -> DSL.optionalFields("DisplayState", biw.u.in($$0), biw.H.in($$0)));
