...
public class ekb {
   ...
   public static final ekb.a bv;

   public static ekb.a a(int $$0, int $$1) {
      return $$0 == -1 ? ekb.b.b.a($$1) : ekb.b.a.a($$0);
   }

   public static ekb.a a(String $$0) {
      if (ekb.a.e.containsKey($$0)) {
         return ekb.a.e.get($$0);
      } else {
         for (ekb.b $$1 : ekb.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      static final Map<String, ekb.a> e = Maps.newHashMap();

      a(String $$0, ekb.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<ekb.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, tf> g;

      private static void a(ekb.b $$0, String $$1, int $$2) {
         ekb.a $$3 = new ekb.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public ekb.a a(int $$0) {
         return (ekb.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
