...
public class ekb {
   ...
   private static final Queue<ekb.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ekb.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ekb::a), ejz::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ekb::a), ejz::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ekb.a(this.b) + ", type=" + ekb.b(this.c) + ", severity=" + ekb.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
