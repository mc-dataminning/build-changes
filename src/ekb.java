...
public class ekb implements dut.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<ekb> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final axg<ekb> a = axg.a(f);
   private final ekf g;
   private final ekf h;
   private final ekf i;
   ...
   public static ekb a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new ekb(new dwb(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private ekb(ekf $$0, ekf $$1, ekf $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public ekb(axt $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         ekf.a($$0, IntStream.rangeClosed(-15, 0)),
         ekf.a($$0, IntStream.rangeClosed(-15, 0)),
         ekf.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public ekb a(axt $$0) {
      return new ekb($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dut.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         ekc $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(ekf.b($$4 * $$13), ekf.b($$5 * $$13), ekf.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = ekf.b($$1 * $$13);
         double $$21 = ekf.b($$2 * $$13);
         double $$22 = ekf.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            ekc $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return axm.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
