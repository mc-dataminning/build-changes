...
public abstract class ekb {
   ...
   public ejd a() {
      if (this.c()) {
         ...
         return new ejd(this.b(hx.a.a), this.b(hx.a.b), this.b(hx.a.c), this.c(hx.a.a), this.c(hx.a.b), this.c(hx.a.c));
      }
   }

   public ekb b() {
      return this.c() ? ejy.a() : ejy.a(this.b(hx.a.a), this.b(hx.a.b), this.b(hx.a.c), this.c(hx.a.a), this.c(hx.a.b), this.c(hx.a.c));
   }
   ...
   public ekb a(double $$0, double $$1, double $$2) {
      return (ekb)(this.c() ? ejy.a() : new ejk(this.a, new ejx(this.a(hx.a.a), $$0), new ejx(this.a(hx.a.b), $$1), new ejx(this.a(hx.a.c), $$2)));
   }

   public ekb d() {
      ekb[] $$0 = new ekb[]{ejy.a()};
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0[0] = ejy.b($$0[0], ejy.a($$1, $$2, $$3, $$4, $$5, $$6), ejm.o));
      return $$0[0];
   }

   public void a(ejy.a $$0) {
      this.a
         .a(
   ...
   public List<ejd> e() {
      List<ejd> $$0 = Lists.newArrayList();
      this.b(($$1, $$2, $$3, $$4, $$5, $$6) -> $$0.add(new ejd($$1, $$2, $$3, $$4, $$5, $$6)));
      return $$0;
   }
   ...
   protected int a(hx.a $$0, double $$1) {
      return ati.a(0, this.a.c($$0) + 1, $$2 -> $$1 < this.a($$0, $$2)) - 1;
   }

   @Nullable
   public eje a(eji $$0, eji $$1, ht $$2) {
      if (this.c()) {
         return null;
      } else {
         eji $$3 = $$1.d($$0);
         if ($$3.g() < 1.0E-7) {
            ...
            return this.a.d(this.a(hx.a.a, $$4.c - (double)$$2.u()), this.a(hx.a.b, $$4.d - (double)$$2.v()), this.a(hx.a.c, $$4.e - (double)$$2.w()))
               ? new eje($$4, hx.a($$3.c, $$3.d, $$3.e).g(), $$2, true)
               : ejd.a(this.e(), $$0, $$1, $$2);
         }
      }
   }

   public Optional<eji> a(eji $$0) {
      if (this.c()) {
         return Optional.empty();
      } else {
         eji[] $$1 = new eji[1];
         this.b(($$2, $$3, $$4, $$5, $$6, $$7) -> {
            double $$8 = ati.a($$0.a(), $$2, $$5);
            double $$9 = ati.a($$0.b(), $$3, $$6);
            double $$10 = ati.a($$0.c(), $$4, $$7);
   ...
   public ekb a(hx $$0) {
      if (!this.c() && this != ejy.b()) {
         if (this.b != null) {
            ekb $$1 = this.b[$$0.ordinal()];
            if ($$1 != null) {
               return $$1;
            }
         } else {
   ...
   private ekb b(hx $$0) {
      ...
      if ($$2.size() == 2 && DoubleMath.fuzzyEquals($$2.getDouble(0), 0.0, 1.0E-7) && DoubleMath.fuzzyEquals($$2.getDouble(1), 1.0, 1.0E-7)) {
         ...
         return new ejz(this, $$1, $$4);
      }
   }

   public double a(hx.a $$0, ejd $$1, double $$2) {
      return this.a(hr.a($$0, hx.a.a), $$1, $$2);
   }

   protected double a(hr $$0, ejd $$1, double $$2) {
      if (this.c()) {
         return $$2;
