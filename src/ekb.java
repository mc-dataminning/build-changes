...
@Deprecated
public class ekb extends ejm<ekb.a> {
   private static final eah a = dmh.nI.m();

   public ekb(Codec<ekb.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(ejo<ekb.a> $$0) {
      iu $$1 = $$0.e();
      djz $$2 = $$0.b();
      azv $$3 = $$0.d();
      ekb.a $$4 = $$0.f();
   ...
   public static record a(enr b, enr c) implements elq {
      public static final Codec<ekb.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(enr.a.fieldOf("fluid").forGetter(ekb.a::a), enr.a.fieldOf("barrier").forGetter(ekb.a::b)).apply($$0, ekb.a::new)
      );
