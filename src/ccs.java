...
public class ccs extends ccv {
   private final bvz a;
   private final Predicate<bvz> b;
   @Nullable
   private bvz c;
   ...
   public ccs(bvz $$0, double $$1, float $$2, float $$3) {
      this.a = $$0;
   ...
   @Override
   public boolean b() {
      List<bvz> $$0 = this.a.dW().a(bvz.class, this.a.cR().g((double)this.i), this.b);
      if (!$$0.isEmpty()) {
         for (bvz $$1 : $$0) {
            if (!$$1.cp()) {
               this.c = $$1;
