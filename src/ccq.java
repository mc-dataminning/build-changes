...
public class ccq extends cco {
   ...
   public ccq(biw<? extends ccq> $$0, cpx $$1) {
      super($$0, $$1);
      this.af = true;
   }

   public ccq(cpx $$0, bji $$1, bis $$2, hc.a $$3) {
      this(biw.aH, $$0);
      this.b($$1);
      gw $$4 = $$1.dl();
   ...
   public void l() {
      ...
      if (!this.dL().B) {
         if (this.c == null && this.i != null) {
            this.c = ((aks)this.dL()).a(this.i);
            if (this.c == null) {
               this.i = null;
            }
         }

         if (this.c == null || !this.c.bv() || this.c instanceof cbw && this.c.M_()) {
            if (!this.aT()) {
               this.f(this.do().b(0.0, -0.04, 0.0));
            }
         } else {
            this.f = ary.a(this.f * 1.025, -1.0, 1.0);
            this.g = ary.a(this.g * 1.025, -1.0, 1.0);
            this.h = ary.a(this.h * 1.025, -1.0, 1.0);
            ehp $$0 = this.do();
   ...
   protected void a(ehm $$0) {
      ...
      bis $$1 = $$0.a();
      bis $$2 = this.v();
      bji $$3 = $$2 instanceof bji ? (bji)$$2 : null;
      boolean $$4 = $$1.a(this.dM().a(this, $$3), 4.0F);
      if ($$4) {
         this.a($$3, $$1);
         if ($$1 instanceof bji $$5) {
            $$5.b(new bif(bih.y, 200), (bis)MoreObjects.firstNonNull($$2, this));
         }
      }
   }
   ...
   protected void a(ehl $$0) {
      super.a($$0);
      ((aks)this.dL()).a(ix.x, this.dq(), this.ds(), this.dw(), 2, 0.2, 0.2, 0.2, 0.0);
      this.a(apf.vb, 1.0F, 1.0F);
   }

   private void s() {
      this.ak();
      this.dL().a(djv.o, this.dj(), djv.a.a(this));
   }
   ...
   public boolean a(bhq $$0, float $$1) {
      if (!this.dL().B) {
         this.a(apf.vc, 1.0F, 1.0F);
         ((aks)this.dL()).a(ix.g, this.dq(), this.ds(), this.dw(), 15, 0.2, 0.2, 0.2, 0.0);
         this.s();
      }
