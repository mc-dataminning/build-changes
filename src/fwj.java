...
public class fwj {
   ...
   public final Map<ie, fwk> c;
   public final fwl d;
   public final boolean e;

   public fwj(Vector3f $$0, Vector3f $$1, Map<ie, fwk> $$2, @Nullable fwl $$3, boolean $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<ie, fwk> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<fwj> {
      private static final boolean a = true;

      public fwj a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         JsonObject $$3 = $$0.getAsJsonObject();
         Vector3f $$4 = this.e($$3);
         Vector3f $$5 = this.d($$3);
         fwl $$6 = this.a($$3);
         Map<ie, fwk> $$7 = this.a($$2, $$3);
         if ($$3.has("shade") && !avx.c($$3, "shade")) {
            throw new JsonParseException("Expected shade to be a Boolean");
         } else {
            boolean $$8 = avx.a($$3, "shade", true);
            return new fwj($$4, $$5, $$7, $$6, $$8);
         }
      }

      @Nullable
      private fwl a(JsonObject $$0) {
         fwl $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<ie, fwk> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ie, fwk> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<ie, fwk> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<ie, fwk> $$2 = Maps.newEnumMap(ie.class);
         JsonObject $$3 = avx.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            ie $$5 = this.a($$4.getKey());
            $$2.put($$5, (fwk)$$0.deserialize($$4.getValue(), fwk.class));
         }
