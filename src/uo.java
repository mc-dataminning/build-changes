...
public class uo extends uq<up> {
   private static final int b = 24;
   public static final vq<uo> a = new vq.b<uo>() {
      public uo a(DataInput $$0, va $$1) throws IOException {
         return new uo(d($$0, $$1));
      }
   ...
   public boolean b(int $$0, vo $$1) {
      if ($$1 instanceof vh) {
         this.c = ArrayUtils.add(this.c, $$0, ((vh)$$1).i());
         return true;
      } else {
         return false;
      }
