...
public class uo implements DynamicOps<ux> {
   ...
   public <U> U a(DynamicOps<U> $$0, ux $$1) {
      switch ($$1.b()) {
         case 0:
            return (U)$$0.empty();
         case 1:
            return (U)$$0.createByte(((uq)$$1).i());
         case 2:
            return (U)$$0.createShort(((uq)$$1).h());
         case 3:
            return (U)$$0.createInt(((uq)$$1).g());
         case 4:
            return (U)$$0.createLong(((uq)$$1).f());
         case 5:
            return (U)$$0.createFloat(((uq)$$1).k());
         case 6:
            return (U)$$0.createDouble(((uq)$$1).j());
         case 7:
            return (U)$$0.createByteList(ByteBuffer.wrap(((tx)$$1).e()));
         case 8:
         ...
         case 11:
            return (U)$$0.createIntList(Arrays.stream(((ue)$$1).g()));
         case 12:
            return (U)$$0.createLongList(Arrays.stream(((uh)$$1).g()));
         default:
   ...
   public DataResult<ux> a(ux $$0, MapLike<ux> $$1) {
      if (!($$0 instanceof ua) && !($$0 instanceof uc)) {
         ...
         List<ux> $$4 = Lists.newArrayList();
         $$1.entries().forEach($$2x -> {
            ux $$3 = (ux)$$2x.getFirst();
            if (!($$3 instanceof uv)) {
               $$4.add($$3);
            } else {
               $$2.a($$3.s_(), (ux)$$2x.getSecond());
            }
         });
   ...
   public DataResult<MapLike<ux>> e(ux $$0) {
      return $$0 instanceof ua $$1 ? DataResult.success(new MapLike<ux>() {
         ...
         public Stream<Pair<ux, ux>> entries() {
            return $$1.e().stream().map($$1xx -> Pair.of(uo.this.a($$1xx), $$1.c($$1xx)));
         }
   ...
   public DataResult<Consumer<Consumer<ux>>> g(ux $$0) {
      if ($$0 instanceof ug $$1) {
         return $$1.f() == 10
            ? DataResult.success((Consumer<Consumer>)$$1x -> $$1.forEach($$1xx -> $$1.accept(a((ua)$$1xx))))
   ...
   class h extends AbstractStringBuilder<ux, ua> {
      ...
      protected DataResult<ux> a(ua $$0, ux $$1) {
         if ($$1 == null || $$1 == uc.b) {
            ...
            ua $$3 = new ua(Maps.newHashMap($$2.i()));

            for (Entry<String, ux> $$4 : $$0.i().entrySet()) {
