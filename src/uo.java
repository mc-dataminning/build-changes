...
public class uo extends uj<up> {
   private static final int b = 24;
   public static final vj<uo> a = new vj.b<uo>() {
      public uo a(DataInput $$0, ut $$1) throws IOException {
         return new uo(d($$0, $$1));
      }
   ...
   public boolean equals(Object $$0) {
      return this == $$0 ? true : $$0 instanceof uo && Arrays.equals(this.c, ((uo)$$0).c);
   }
   ...
   public up a(int $$0, up $$1) {
      int $$2 = this.c[$$0];
      this.c[$$0] = $$1.g();
      return up.a($$2);
   }

   public void b(int $$0, up $$1) {
   ...
   public boolean b(int $$0, vh $$1) {
      if ($$1 instanceof va) {
         this.c = ArrayUtils.add(this.c, $$0, ((va)$$1).g());
         return true;
      } else {
         return false;
      }
