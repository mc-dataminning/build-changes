...
public class uo implements un {
   ...
   public void a(uh $$0) {
      ...
      wg $$3 = wg.b($$1.substring(1, $$1.length() - 1)).a(e);
      this.t = wg.b($$2).b($$3).f($$2);
   }

   @Override
   public void a(tk $$0) {
      wg $$1 = wg.b("b").a(g);
      this.t = wg.b(String.valueOf($$0.l())).b($$1).a(f);
   }
   ...
   @Override
   public void a(tr $$0) {
      this.t = wg.b(String.valueOf($$0.l())).a(f);
   }
   ...
   public void a(tp $$0) {
      wg $$1 = wg.b("f").a(g);
      this.t = wg.b(String.valueOf($$0.k())).b($$1).a(f);
   }

   @Override
   public void a(tn $$0) {
      wg $$1 = wg.b("d").a(g);
      this.t = wg.b(String.valueOf($$0.j())).b($$1).a(f);
   }
   ...
   public void a(tj $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         wu $$5 = wg.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(tq $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         $$2.f(" ").b(wg.b(String.valueOf($$3[$$4])).a(f));
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
      }
   ...
   public void a(tt $$0) {
      ...
      for (int $$4 = 0; $$4 < $$3.length; $$4++) {
         wg $$5 = wg.b(String.valueOf($$3[$$4])).a(f);
         $$2.f(" ").b($$5).b($$1);
         if ($$4 != $$3.length - 1) {
            $$2.f(j);
         }
   ...
   public void a(ts $$0) {
      if ($$0.isEmpty()) {
         ...
         for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
            ...
            $$2.b(new uo(this.r, this.s).a($$0.k($$3)));
         }
         ...
         for (int $$5 = 0; $$5 < $$0.size(); $$5++) {
            wu $$6 = wg.b(Strings.repeat(this.r, this.s + 1));
            $$6.b(new uo(this.r, this.s + 1).a($$0.k($$5)));
            if ($$5 != $$0.size() - 1) {
   ...
   public void a(tm $$0) {
      if ($$0.g()) {
         ...
         while ($$4.hasNext()) {
            String $$5 = $$4.next();
            wu $$6 = wg.b(Strings.repeat(this.r, this.s + 1)).b(a($$5)).f(i).f(" ").b(new uo(this.r, this.s + 1).a($$0.c($$5)));
            if ($$4.hasNext()) {
               $$6.f(j).f(this.r.isEmpty() ? " " : "\n");
            }
   ...
   protected static wg a(String $$0) {
      if (h.matcher($$0).matches()) {
         return wg.b($$0).a(d);
      } else {
         String $$1 = uh.b($$0);
         String $$2 = $$1.substring(0, 1);
         wg $$3 = wg.b($$1.substring(1, $$1.length() - 1)).a(d);
         return wg.b($$2).b($$3).f($$2);
      }
   }
