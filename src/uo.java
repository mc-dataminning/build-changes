...
public class uo implements tf {
   public static final Object[] b = new Object[0];
   private static final ti c = ti.e("%");
   private static final ti d = ti.e("null");
   ...
   @Nullable
   private qn h;
   private List<ti> i = ImmutableList.of();
   private static final Pattern j = Pattern.compile("%(?:(\\d+)\\$)?([A-Za-z%]|$)");

   public uo(String $$0, @Nullable String $$1, Object[] $$2) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
   }
   ...
   private void d() {
      ...
      if ($$0 != this.h) {
         ...
         try {
            Builder<ti> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.i = $$2.build();
         } catch (up var4) {
            this.i = ImmutableList.of(ti.e($$1));
         }
      }
   }

   private void a(String $$0, Consumer<ti> $$1) {
      ...
      try {
         ...
         while ($$2.find($$4)) {
            ...
            if ("%".equals($$8) && "%%".equals($$9)) {
               ...
               if (!"s".equals($$8)) {
                  throw new up(this, "Unsupported format: '" + $$9 + "'");
               }
   ...
   private ti a(int $$0) {
      if ($$0 >= 0 && $$0 < this.g.length) {
         ...
         if ($$1 instanceof te) {
            ...
            return $$1 == null ? d : ti.e($$1.toString());
         }
      } else {
         throw new up(this, $$0);
      }
   ...
   public tr a(@Nullable ds $$0, @Nullable big $$1, int $$2) throws CommandSyntaxException {
      ...
      return tr.a(new uo(this.e, this.f, $$3));
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof uo $$1 && Objects.equals(this.e, $$1.e) && Objects.equals(this.f, $$1.f) && Arrays.equals(this.g, $$1.g)) {
            return true;
         }
