...
public class uo {
   ...
   public static ub a(Path $$0, uk $$1) throws IOException {
      ub var4;
      try (
   ...
   private static DataInputStream a(InputStream $$0) throws IOException {
      return new DataInputStream(new axx(new GZIPInputStream($$0)));
   }
   ...
   public static ub a(InputStream $$0, uk $$1) throws IOException {
      ub var3;
   ...
   public static void a(Path $$0, uv $$1, uk $$2) throws IOException {
      try (
         InputStream $$3 = Files.newInputStream($$0);
         InputStream $$4 = new axx($$3);
      ) {
         a($$4, $$1, $$2);
      }
   }

   public static void a(InputStream $$0, uv $$1, uk $$2) throws IOException {
      try (DataInputStream $$3 = a($$0)) {
         a((DataInput)$$3, $$1, $$2);
      }
   }

   public static void a(ub $$0, Path $$1) throws IOException {
      try (
   ...
   public static void a(ub $$0, OutputStream $$1) throws IOException {
      try (DataOutputStream $$2 = a($$1)) {
         a($$0, (DataOutput)$$2);
      }
   }

   public static void b(ub $$0, Path $$1) throws IOException {
      try (
         OutputStream $$2 = Files.newOutputStream($$1, a);
         OutputStream $$3 = new BufferedOutputStream($$2);
   ...
   @Nullable
   public static ub a(Path $$0) throws IOException {
      if (!Files.exists($$0)) {
         return null;
      } else {
         ub var3;
   ...
   public static ub a(DataInput $$0) throws IOException {
      return a($$0, uk.a());
   }

   public static ub a(DataInput $$0, uk $$1) throws IOException {
      uy $$2 = c($$0, $$1);
      if ($$2 instanceof ub) {
         return (ub)$$2;
      } else {
   ...
   public static void a(ub $$0, DataOutput $$1) throws IOException {
      c($$0, $$1);
   }

   public static void a(DataInput $$0, uv $$1, uk $$2) throws IOException {
   ...
   public static uy b(DataInput $$0, uk $$1) throws IOException {
      byte $$2 = $$0.readByte();
      return (uy)($$2 == 0 ? ud.b : a($$0, $$1, $$2));
   }
   ...
   private static uy c(DataInput $$0, uk $$1) throws IOException {
      byte $$2 = $$0.readByte();
      if ($$2 == 0) {
         return ud.b;
      } else {
   ...
   private static uy a(DataInput $$0, uk $$1, byte $$2) {
      try {
         return vb.a($$2).c($$0, $$1);
