...
public class dqy extends dpj {
   ...
   protected void a(us $$0, jk.a $$1) {
      ...
      try {
         this.k = dlo.valueOf($$0.l("rotation"));
      } catch (IllegalArgumentException var12) {
         this.k = dlo.a;
      }

      try {
         this.j = djy.valueOf($$0.l("mirror"));
      } catch (IllegalArgumentException var11) {
         this.j = djy.a;
      }

      try {
         this.l = dto.valueOf($$0.l("mode"));
   ...
   public void a(dto $$0) {
      this.l = $$0;
      dse $$1 = this.n.a_(this.ay_());
      if ($$1.a(dfd.pa)) {
         this.n.a(this.ay_(), $$1.a(dmz.b, $$0), 2);
      }
   }
   ...
   private Stream<iz> a(iz $$0, iz $$1) {
      return iz.d($$0, $$1)
         .filter($$0x -> this.n.a_($$0x).a(dfd.pa))
         .map(this.n::c_)
         .filter($$0x -> $$0x instanceof dqy)
         .map($$0x -> (dqy)$$0x)
         .filter($$0x -> $$0x.l == dto.c && Objects.equals(this.e, $$0x.e))
         .map(dpj::ay_);
   }

   private static Optional<eie> a(iz $$0, Stream<iz> $$1) {
   ...
   public boolean A() {
      return this.l != dto.a ? false : this.b(true);
   }
   ...
   public boolean b(boolean $$0) {
      if (this.e == null) {
         ...
         $$4.a(this.n, $$1, this.i, !this.m, dfd.kN);
         $$4.a(this.f);
         if ($$0) {
            try {
               return $$3.c(this.e);
   ...
   public boolean a(arf $$0) {
      if (this.l == dto.b && this.e != null) {
         emm $$1 = $$0.q().b(this.e).orElse(null);
         if ($$1 == null) {
            return false;
   ...
   private void a(arf $$0, emm $$1) {
      this.a($$1);
      emi $$2 = new emi().a(this.j).a(this.k).a(this.m);
      if (this.t < 1.0F) {
         $$2.b().a(new elq(ayz.a(this.t, 0.0F, 1.0F))).a(b(this.u));
      }
   ...
   public boolean C() {
      if (this.l == dto.b && !this.n.B && this.e != null) {
         arf $$0 = (arf)this.n;
         emn $$1 = $$0.q();
