...
public class ans {
   ...
   private static int b(et $$0) {
      ...
      coh $$1 = bsw.aC.a((dcu)$$0.e());
      if ($$1 == null) {
         $$0.b(wy.b("Pillager failed to spawn"));
         return 0;
      } else {
         $$1.w(true);
         $$1.a(bsx.f, cog.a($$0.v().b(lu.d)));
         $$1.a_($$0.d().c, $$0.d().d, $$0.d().e);
         $$1.a($$0.e(), $$0.e().d_(jd.a((jw)$$0.d())), btp.n, null);
         $$0.e().a_($$1);
         return 1;
      }
   }

   private static int a(et $$0, @Nullable wy $$1) {
      if ($$1 != null && $$1.getString().equals("local")) {
         aqt $$2 = $$0.e();
         eww $$3 = $$0.d().b(5.0, 0.0, 0.0);
         $$2.a(null, $$3.c, $$3.d, $$3.e, avo.vc, avp.g, 2.0F, 1.0F, $$2.z.g());
      }
