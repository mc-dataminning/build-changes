...
public class ans {
   ...
   private static final Dynamic2CommandExceptionType c = new Dynamic2CommandExceptionType(($$0, $$1) -> xk.b("commands.execute.blocks.toobig", $$0, $$1));
   private static final SimpleCommandExceptionType d = new SimpleCommandExceptionType(xk.c("commands.execute.conditional.fail"));
   private static final DynamicCommandExceptionType e = new DynamicCommandExceptionType($$0 -> xk.b("commands.execute.conditional.fail_count", $$0));
   @VisibleForTesting
   public static final Dynamic2CommandExceptionType a = new Dynamic2CommandExceptionType(
      ($$0, $$1) -> xk.b("commands.execute.function.instantiationFailure", $$0, $$1)
   );
   private static final SuggestionProvider<ew> f = ($$0, $$1) -> {
      alz.a $$2 = ((ew)$$0.getSource()).l().bc();
      return fb.a($$2.a(mb.bi), $$1);
   };
      ...
      $$0.register(
         (LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a(
                                       ...
                                       .then(ex.a("at").then(ex.a("targets", fj.b()).fork($$2, $$0x -> {
                                          ...
                                          for (bvb $$2x : fj.c($$0x, "targets")) {
                                             $$1x.add(((ew)$$0x.getSource()).a((arx)$$2x.dW()).a($$2x.du()).a($$2x.bU()));
                                          }
                                 ...
                                 .then(
                                    ((LiteralArgumentBuilder)((LiteralArgumentBuilder)ex.a("positioned")
                                       ...
                                       .then(ex.a("over").then(ex.a("heightmap", fm.a()).redirect($$2, $$0x -> {
                                          fbr $$1x = ((ew)$$0x.getSource()).d();
                                          arx $$2x = ((ew)$$0x.getSource()).e();
                                          double $$3 = $$1x.a();
                                          double $$4 = $$1x.c();
                                          if (!$$2x.b(kj.b($$3), kj.b($$4))) {
                                             throw gs.a.create();
                                          } else {
                                             int $$5 = $$2x.a(fm.a($$0x, "heightmap"), azu.a($$3), azu.a($$4));
                                             return ((ew)$$0x.getSource()).a(new fbr($$3, (double)$$5, $$4));
                                          }
                                       })))
                                 ))
                              .then(
         ...
         ex.a("bossbar")
            .then(
               ((RequiredArgumentBuilder)ex.a("id", fx.a())
                     .suggests(anc.a)
                     .then(ex.a("value").redirect($$0, $$1x -> a((ew)$$1x.getSource(), anc.a($$1x), true, $$2))))
                  .then(ex.a("max").redirect($$0, $$1x -> a((ew)$$1x.getSource(), anc.a($$1x), false, $$2)))
            )
      );
                                             ...
                                             ex.a("scale", DoubleArgumentType.doubleArg())
                                                .redirect(
                                                   ...
                                                   $$2xx -> a(
                                                         ...
                                                         $$3.a($$2xx),
                                                         fo.a($$2xx, "path"),
                                                         $$1xxx -> ur.a((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                         $$2
                                                      )
                                                )
                                          )
                                          ...
                                          ex.a("scale", DoubleArgumentType.doubleArg())
                                             .redirect(
                                                ...
                                                $$2xx -> a(
                                                      ...
                                                      $$3.a($$2xx),
                                                      fo.a($$2xx, "path"),
                                                      $$1xxx -> up.a((float)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                      $$2
                                                   )
                                             )
                                       )
                                       ...
                                       ex.a("scale", DoubleArgumentType.doubleArg())
                                          .redirect(
                                             ...
                                             $$2xx -> a(
                                                   ...
                                                   $$3.a($$2xx),
                                                   fo.a($$2xx, "path"),
                                                   $$1xxx -> ve.a((short)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                                   $$2
                                                )
                                          )
                                    )
                                    ...
                                    ex.a("scale", DoubleArgumentType.doubleArg())
                                       .redirect(
                                          ...
                                          $$2xx -> a(
                                                ...
                                                $$3.a($$2xx),
                                                fo.a($$2xx, "path"),
                                                $$1xxx -> uu.a((long)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale"))),
                                                $$2
                                             )
                                       )
                                 )
                                 ...
                                 ex.a("scale", DoubleArgumentType.doubleArg())
                                    .redirect(
                                       ...
                                       $$2xx -> a(
                                             ...
                                             $$3.a($$2xx),
                                             fo.a($$2xx, "path"),
                                             $$1xxx -> un.a((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")),
                                             $$2
                                          )
                                    )
                              )
                              ...
                              ex.a("scale", DoubleArgumentType.doubleArg())
                                 .redirect(
                                    ...
                                    $$2xx -> a(
                                          ...
                                          $$3.a($$2xx),
                                          fo.a($$2xx, "path"),
                                          $$1xxx -> uk.a((byte)((int)((double)$$1xxx * DoubleArgumentType.getDouble($$2xx, "scale")))),
                                          $$2
                                       )
                                 )
                           )
   ...
   private static ew a(ew $$0, Collection<fcv> $$1, fco $$2, boolean $$3) {
      fcw $$4 = $$0.l().aJ();
      return $$0.a(($$4x, $$5) -> {
         for (fcv $$6 : $$1) {
            fcu $$7 = $$4.c($$6, $$2);
   ...
   private static ew a(ew $$0, amr $$1, boolean $$2, boolean $$3) {
      return $$0.a(($$3x, $$4) -> {
         int $$5 = $$3 ? $$4 : ($$3x ? 1 : 0);
         if ($$2) {
            $$1.a($$5);
   ...
   private static ew a(ew $$0, aqh $$1, fo.g $$2, IntFunction<vj> $$3, boolean $$4) {
      return $$0.a(($$4x, $$5) -> {
         try {
            um $$6 = $$1.a();
            int $$7 = $$4 ? $$5 : ($$4x ? 1 : 0);
   ...
   private static boolean a(arx $$0, jh $$1) {
      dgf $$2 = new dgf($$1);
      dzt $$3 = $$0.m().a($$2.h, $$2.i);
      return $$3 == null ? false : $$3.F() == arm.d && $$0.c($$2.a());
   }
                                          ...
                                          ex.a("pos", gs.a())
                                             .then(
                                                a(
                                                   ...
                                                   ex.a("block", go.a($$3)),
                                                   $$2,
                                                   $$0x -> go.a($$0x, "block").test(new dxs(((ew)$$0x.getSource()).e(), gs.a($$0x, "pos"), true))
                                                )
                                             )
                                       )
                                 ))
                                       ...
                                       .then(
                                          ex.a("pos", gs.a())
                                             .then(
                                                a(
                                                   $$0,
                                                   ex.a("biome", fz.a($$3, mb.aI)),
                                                   $$2,
                                                   $$0x -> fz.a($$0x, "biome", mb.aI).test(((ew)$$0x.getSource()).e().t(gs.a($$0x, "pos")))
                                                )
                                             )
                                       )
                                 ))
                     ...
                     ex.a("entity")
                        .then(
                           ((RequiredArgumentBuilder)ex.a("entities", fj.b()).fork($$0, $$1x -> a($$1x, $$2, !fj.c($$1x, "entities").isEmpty())))
                              .executes(a($$2, (ans.b)($$0x -> fj.c($$0x, "entities").size())))
                        )
                  ))
               .then(ex.a("predicate").then(a($$0, ex.a("predicate", fy.c($$3)).suggests(f), $$2, $$0x -> a((ew)$$0x.getSource(), fy.c($$0x, "predicate"))))))
            .then(ex.a("function").then(ex.a("name", he.a()).suggests(anx.b).fork($$0, new ans.d($$2)))))
         .then(
                                 ...
                                 ex.a("slots", gf.a())
                                    .then(
                                       ((RequiredArgumentBuilder)ex.a("item_predicate", hi.a($$3))
                                          ...
                                          .executes(a($$2, (ans.b)($$0x -> a(fj.b($$0x, "entities"), gf.a($$0x, "slots"), hi.a($$0x, "item_predicate")))))
                                    )
                              )
                        )
                  ))
                              ...
                              ex.a("slots", gf.a())
                                 .then(
                                    ((RequiredArgumentBuilder)ex.a("item_predicate", hi.a($$3))
                                       ...
                                       .executes(
                                          a($$2, (ans.b)($$0x -> a((ew)$$0x.getSource(), gs.a($$0x, "pos"), gf.a($$0x, "slots"), hi.a($$0x, "item_predicate"))))
                                       )
                                 )
                           )
                     )
            ...
            $$4.a(
               ...
               $$3x -> $$3x.then(
                     ((RequiredArgumentBuilder)ex.a("path", fo.a()).fork($$0, $$2xx -> a($$2xx, $$2, a($$4.a($$2xx), fo.a($$2xx, "path")) > 0)))
                        .executes(a($$2, (ans.b)($$1xx -> a($$4.a($$1xx), fo.a($$1xx, "path")))))
                  )
            )
         );
      }
   ...
   private static int a(Iterable<? extends bvb> $$0, cur $$1, Predicate<cxg> $$2) {
      int $$3 = 0;
   ...
   private static int a(ew $$0, jh $$1, cur $$2, Predicate<cxg> $$3) throws CommandSyntaxException {
      int $$4 = 0;
      bst $$5 = aoc.a($$0, $$1, aoc.b);
      int $$6 = $$5.b();
      IntList $$7 = $$2.a();
   ...
   private static Command<ew> a(boolean $$0, ans.b $$1) {
      return $$0 ? $$1x -> {
         int $$2 = $$1.test($$1x);
         if ($$2 > 0) {
            ((ew)$$1x.getSource()).a(() -> xk.a("commands.execute.conditional.pass_count", $$2), false);
            return $$2;
         } else {
            throw d.create();
         }
         ...
         int $$2 = $$1.test($$1x);
         if ($$2 == 0) {
            ((ew)$$1x.getSource()).a(() -> xk.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw e.create($$2);
         }
   ...
   private static int a(aqh $$0, fo.g $$1) throws CommandSyntaxException {
      return $$1.b($$0.a());
   }

   private static boolean a(CommandContext<ew> $$0, ans.e $$1) throws CommandSyntaxException {
      fcv $$2 = gb.a($$0, "target");
      fco $$3 = fq.a($$0, "targetObjective");
      fcv $$4 = gb.a($$0, "source");
      fco $$5 = fq.a($$0, "sourceObjective");
      fcw $$6 = ((ew)$$0.getSource()).l().aJ();
      fcs $$7 = $$6.d($$2, $$3);
      fcs $$8 = $$6.d($$4, $$5);
   ...
   private static boolean a(CommandContext<ew> $$0, dj.d $$1) throws CommandSyntaxException {
      fcv $$2 = gb.a($$0, "target");
      fco $$3 = fq.a($$0, "targetObjective");
      fcw $$4 = ((ew)$$0.getSource()).l().aJ();
      fcs $$5 = $$4.d($$2, $$3);
      return $$5 == null ? false : $$1.d($$5.a());
   }

   private static boolean a(ew $$0, jq<ezr> $$1) {
      arx $$2 = $$0.e();
      ewl $$3 = new ewl.a($$2).a(ezc.f, $$0.d()).b(ezc.a, $$0.f()).a(ezb.d);
      ewi $$4 = new ewi.a($$3).a(Optional.empty());
      $$4.b(ewi.a($$1.a()));
      return $$1.a().test($$4);
   }
   ...
   private static ArgumentBuilder<ew, ?> a(CommandNode<ew> $$0, ArgumentBuilder<ew, ?> $$1, boolean $$2, ans.c $$3) {
      return $$1.fork($$0, $$2x -> a($$2x, $$2, $$3.test($$2x))).executes($$2x -> {
         if ($$2 == $$3.test($$2x)) {
            ((ew)$$2x.getSource()).a(() -> xk.c("commands.execute.conditional.pass"), false);
            return 1;
         } else {
            throw d.create();
         }
   ...
   private static int a(CommandContext<ew> $$0, boolean $$1) throws CommandSyntaxException {
      OptionalInt $$2 = c($$0, $$1);
      if ($$2.isPresent()) {
         ((ew)$$0.getSource()).a(() -> xk.a("commands.execute.conditional.pass_count", $$2.getAsInt()), false);
         return $$2.getAsInt();
      } else {
         throw d.create();
      }
   ...
   private static int b(CommandContext<ew> $$0, boolean $$1) throws CommandSyntaxException {
      ...
      if ($$2.isPresent()) {
         ...
         ((ew)$$0.getSource()).a(() -> xk.c("commands.execute.conditional.pass"), false);
         return 1;
      }
   }
   ...
   private static OptionalInt a(arx $$0, jh $$1, jh $$2, jh $$3, boolean $$4) throws CommandSyntaxException {
      env $$5 = env.a($$1, $$2);
      env $$6 = env.a($$3, $$3.a($$5.c()));
   ...
   private static RedirectModifier<ew> a(Function<bvb, Optional<bvb>> $$0) {
      return $$1 -> {
         ew $$2 = (ew)$$1.getSource();
         bvb $$3 = $$2.f();
   ...
   private static RedirectModifier<ew> b(Function<bvb, Stream<bvb>> $$0) {
      return $$1 -> {
         ew $$2 = (ew)$$1.getSource();
         bvb $$3 = $$2.f();
   ...
   private static LiteralArgumentBuilder<ew> a(CommandNode<ew> $$0, LiteralArgumentBuilder<ew> $$1) {
      return (LiteralArgumentBuilder<ew>)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)$$1.then(
                              ex.a("owner")
                                 .fork(
                                    $$0,
                                    a((Function<bvb, Optional<bvb>>)($$0x -> $$0x instanceof bwe $$1x ? Optional.ofNullable($$1x.ah_()) : Optional.empty()))
                                 )
                           ))
                           .then(
                              ex.a("leasher")
                                 .fork(
                                    $$0, a((Function<bvb, Optional<bvb>>)($$0x -> $$0x instanceof bvv $$1x ? Optional.ofNullable($$1x.A()) : Optional.empty()))
                                 )
                           ))
                        .then(
                           ex.a("target")
                              .fork(
                                 $$0, a((Function<bvb, Optional<bvb>>)($$0x -> $$0x instanceof bwv $$1x ? Optional.ofNullable($$1x.O_()) : Optional.empty()))
                              )
                        ))
                     .then(
                        ex.a("attacker")
                           .fork($$0, a((Function<bvb, Optional<bvb>>)($$0x -> $$0x instanceof buv $$1x ? Optional.ofNullable($$1x.am()) : Optional.empty())))
                     ))
                  .then(ex.a("vehicle").fork($$0, a((Function<bvb, Optional<bvb>>)($$0x -> Optional.ofNullable($$0x.dl()))))))
               .then(ex.a("controller").fork($$0, a((Function<bvb, Optional<bvb>>)($$0x -> Optional.ofNullable($$0x.cX()))))))
            .then(
               ex.a("origin").fork($$0, a((Function<bvb, Optional<bvb>>)($$0x -> $$0x instanceof bww $$1x ? Optional.ofNullable($$1x.p()) : Optional.empty())))
            ))
         .then(ex.a("passengers").fork($$0, b((Function<bvb, Stream<bvb>>)($$0x -> $$0x.cZ().stream()))));
   }

   private static ew a(ew $$0, jq.c<bvi<?>> $$1) throws CommandSyntaxException {
      bvb $$2 = apr.a($$0, $$1, $$0.d(), new um(), true);
      return $$0.a($$2);
   }

   public static <T extends ey<T>> void a(
      T $$0, List<T> $$1, Function<T, T> $$2, IntPredicate $$3, ContextChain<T> $$4, @Nullable um $$5, hx<T> $$6, ans.a<T, Collection<ik<T>>> $$7, hr $$8
   ) {
   ...
   static class d implements hu.a<ew> {
      ...
      public void a(ew $$0, List<ew> $$1, ContextChain<ew> $$2, hr $$3, hx<ew> $$4) {
         ans.a($$0, $$1, anx::a, this.a, $$2, null, $$4, $$0x -> he.a($$0x, "name"), $$3);
      }
   }
