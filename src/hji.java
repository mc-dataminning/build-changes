...
public record hji(List<alg> d, alg e, Map<String, alg> f, String g) implements hjc {
   static final Logger h = LogUtils.getLogger();
   public static final String b = "_";
   public static final MapCodec<hji> c = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
               Codec.list(alg.a).fieldOf("textures").forGetter(hji::b),
               alg.a.fieldOf("palette_key").forGetter(hji::c),
               Codec.unboundedMap(Codec.STRING, alg.a).fieldOf("permutations").forGetter(hji::d),
               Codec.STRING.optionalFieldOf("separator", "_").forGetter(hji::e)
            )
            .apply($$0, hji::new)
   );

   public hji(List<alg> $$0, alg $$1, Map<String, alg> $$2) {
      this($$0, $$1, $$2, "_");
   }
   ...
   static record a(hjh a, Supplier<IntUnaryOperator> b, alg c) implements hjc.b {
      @Nullable
      public hir a(hjb $$0) {
         Object var3;
         try {
            fik $$1 = this.a.a().a(this.b.get());
            return new hir(this.c, new hkk($$1.a(), $$1.b()), $$1, avf.a);
         } catch (IllegalArgumentException | IOException var7) {
            hji.h.error("unable to apply palette to {}", this.c, var7);
            var3 = null;
         } finally {
            this.a.b();
         }
