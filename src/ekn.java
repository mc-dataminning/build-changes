...
@Deprecated
public class ekn extends ejy<ekn.a> {
   private static final eat a = dmt.nI.m();

   public ekn(Codec<ekn.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eka<ekn.a> $$0) {
      iv $$1 = $$0.e();
      dkl $$2 = $$0.b();
      azv $$3 = $$0.d();
      ekn.a $$4 = $$0.f();
   ...
   public static record a(eod b, eod c) implements emc {
      public static final Codec<ekn.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eod.a.fieldOf("fluid").forGetter(ekn.a::a), eod.a.fieldOf("barrier").forGetter(ekn.a::b)).apply($$0, ekn.a::new)
      );
