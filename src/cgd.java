...
public class cgd extends cfr {
   ...
   public void c() {
      if (this.g == null) {
         ...
         if (this.e != null && this.e.c()) {
            ...
            this.f = new etf($$0, this.g.du() + $$5, $$1);
         }
         ...
         if (this.g.g(this.a) < 4096.0) {
            if (this.a.E(this.g)) {
               this.d++;
               etf $$8 = new etf(this.g.ds() - this.a.ds(), 0.0, this.g.dy() - this.a.dy()).d();
               etf $$9 = new etf((double)axw.a(this.a.dD() * (float) (Math.PI / 180.0)), 0.0, (double)(-axw.b(this.a.dD() * (float) (Math.PI / 180.0)))).d();
               float $$10 = (float)$$9.b($$8);
               float $$11 = (float)(Math.acos((double)$$10) * 180.0F / (float)Math.PI);
               $$11 += 0.5F;
               if (this.d >= 5 && $$11 >= 0.0F && $$11 < 10.0F) {
                  double $$12 = 1.0;
                  etf $$13 = this.a.f(1.0F);
                  ...
                  cku $$20 = new cku(this.a.dN(), this.a, $$17, $$18, $$19);
   ...
   public void a(bre $$0) {
      ...
      int $$9 = axw.a(this.g.du() + $$8);
      emd $$10 = new emd($$3, $$9, $$4);
