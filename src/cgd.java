...
public class cgd extends cke {
   private static final Predicate<bow> e = $$0 -> $$0.bA() && !($$0 instanceof cgd);
   ...
   public cgd(bpc<? extends cgd> $$0, cwz $$1) {
      super($$0, $$1);
      this.bM = 20;
      this.a(eiy.v, 0.0F);
   }
   ...
   protected void z() {
      ...
      this.bR.a(4, new bwv(this, 1.0, true));
      this.bR.a(5, new bxy(this, 0.4));
      this.bR.a(6, new bwt(this, cis.class, 6.0F));
      this.bR.a(10, new bwt(this, bpq.class, 8.0F));
      this.bS.a(2, new byd(this, cke.class).a());
      this.bS.a(3, new bye<>(this, cis.class, true));
      this.bS.a(4, new bye<>(this, cia.class, true, $$0 -> !$$0.o_()));
      this.bS.a(4, new bye<>(this, cbp.class, true));
   }

   @Override
   protected void R() {
      boolean $$0 = !(this.cN() instanceof bpq) || this.cN().ai().a(auq.c);
   ...
   public static bqu.a r() {
      return cfy.gt().a(bqv.q, 100.0).a(bqv.r, 0.3).a(bqv.n, 0.75).a(bqv.c, 12.0).a(bqv.d, 1.5).a(bqv.k, 32.0).a(bqv.v, 1.0);
   }
   ...
   public void m_() {
      ...
      if (this.bA()) {
         if (this.fd()) {
            ...
            double $$1 = this.f(bqv.r).b();
            this.f(bqv.r).a(aww.d(0.1, $$1, $$0));
         }

         if (this.P && this.dM().Z().b(cwv.c)) {
            boolean $$2 = false;
            epm $$3 = this.cH().g(0.2);
   ...
   private void gz() {
      if (this.bA()) {
         for (bpo $$1 : this.dM().a(bpo.class, this.cH().g(4.0), e)) {
            if (!($$1 instanceof cfg)) {
               $$1.a(this.dN().b((bpo)this), 6.0F);
            }
