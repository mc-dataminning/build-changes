...
public class duk<T> implements dum<T> {
   ...
   private duk(jn<T> $$0, int $$1, dun<T> $$2, List<T> $$3) {
      this.a = $$0;
   ...
   private duk(jn<T> $$0, T[] $$1, dun<T> $$2, int $$3, int $$4) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   @Override
   public dum<T> c() {
      return new duk<>(this.a, (T[])((Object[])this.b.clone()), this.c, this.d, this.e);
   }
}
