...
public class eec implements eee {
   public static final Codec<eec> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               ...
               bpv.b(1, 128).fieldOf("height").forGetter($$0x -> $$0x.c),
               bpv.b(1, 128).fieldOf("radius").forGetter($$0x -> $$0x.d),
               ...
               bpv.b(0, 128).fieldOf("dripstone_block_layer_thickness").forGetter($$0x -> $$0x.g),
               bpt.a(0.0F, 2.0F).fieldOf("density").forGetter($$0x -> $$0x.h),
               bpt.a(0.0F, 2.0F).fieldOf("wetness").forGetter($$0x -> $$0x.i),
   ...
   public eec(int $$0, bpv $$1, bpv $$2, int $$3, int $$4, bpv $$5, bpt $$6, bpt $$7, float $$8, int $$9, int $$10) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
