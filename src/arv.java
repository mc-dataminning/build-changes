...
public class arv {
   public static final Codec<arv> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(aqy.l.optionalFieldOf("namespace").forGetter($$0x -> $$0x.b), aqy.l.optionalFieldOf("path").forGetter($$0x -> $$0x.d))
            .apply($$0, arv::new)
   );
   ...
   private final Predicate<aer> f;

   private arv(Optional<Pattern> $$0, Optional<Pattern> $$1) {
      this.b = $$0;
