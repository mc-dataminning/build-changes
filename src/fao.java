...
public class fao {
   public static List<fbq> a(fao.a... $$0) {
      for (fao.a $$1 : $$0) {
         a($$1.j);
      }

      List<fbq> $$2 = Lists.newArrayList();

      for (fao.a $$3 : $$0) {
         $$2.add(new fbq($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fbq::a));
      return $$2;
   }
   ...
   public static List<fbq> a() {
      return a(fao.a.values());
   }
