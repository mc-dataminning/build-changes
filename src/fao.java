...
public class fao extends fak {
   private final List<far> c = new ArrayList<>();
   private final List<fao.a> d = new ArrayList<>();
   ...
   public <T extends far> T a(T $$0, int $$1, int $$2) {
      return this.a($$0, $$1, $$2, this.b());
   }

   public <T extends far> T a(T $$0, int $$1, int $$2, fas $$3) {
      return this.a($$0, $$1, $$2, 1, 1, $$3);
   }

   public <T extends far> T a(T $$0, int $$1, int $$2, Consumer<fas> $$3) {
      return this.a($$0, $$1, $$2, 1, 1, ac.a(this.b(), $$3));
   }

   public <T extends far> T a(T $$0, int $$1, int $$2, int $$3, int $$4) {
      return this.a($$0, $$1, $$2, $$3, $$4, this.b());
   }

   public <T extends far> T a(T $$0, int $$1, int $$2, int $$3, int $$4, fas $$5) {
      if ($$3 < 1) {
         throw new IllegalArgumentException("Occupied rows must be at least 1");
      } else if ($$4 < 1) {
         throw new IllegalArgumentException("Occupied columns must be at least 1");
      } else {
         this.d.add(new fao.a($$0, $$1, $$2, $$3, $$4, $$5));
         this.c.add($$0);
         return $$0;
      }
   }

   public <T extends far> T a(T $$0, int $$1, int $$2, int $$3, int $$4, Consumer<fas> $$5) {
   ...
   static class a extends fak.a {
      ...
      a(far $$0, int $$1, int $$2, int $$3, int $$4, fas $$5) {
         super($$0, $$5.h());
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
   ...
   public final class b {
      ...
      public <T extends far> T a(T $$0, int $$1) {
      ...
      public <T extends far> T a(T $$0, int $$1, fas $$2) {
         int $$3 = this.c / this.b;
         int $$4 = this.c % this.b;
         if ($$4 + $$1 > this.b) {
            $$3++;
