...
public class fao {
   ...
   public fao(PathMatcher $$0) {
      this.a = $$0;
   }

   public void a(Path $$0, List<fap> $$1) throws IOException {
   ...
   public List<fap> a(Path $$0) throws IOException {
      List<fap> $$1 = new ArrayList<>();
      this.a($$0, $$1);
      return $$1;
   }

   public List<fap> a(Path $$0, boolean $$1) throws IOException {
      List<fap> $$2 = new ArrayList<>();
   ...
   public void b(Path $$0, final List<fap> $$1) throws IOException {
