...
public interface lx {
   ...
   CompletableFuture<?> a(lv var1);

   String a();

   static <T> CompletableFuture<?> a(lv $$0, jl.a $$1, Codec<T> $$2, T $$3, Path $$4) {
      aki<JsonElement> $$5 = $$1.a(JsonOps.INSTANCE);
      JsonElement $$6 = (JsonElement)$$2.encodeStart($$5, $$3).getOrThrow();
      return a($$0, $$6, $$4);
   }

   static CompletableFuture<?> a(lv $$0, JsonElement $$1, Path $$2) {
   ...
   @FunctionalInterface
   public interface a<T extends lx> {
      T create(lz var1);
   }
}
