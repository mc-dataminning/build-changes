...
public record bhp(Instant a, String b, long c) {
   ...
   public static bhp a(RecordedEvent $$0) {
      ...
      return new bhp($$0.getStartTime(), $$2, $$0.getLong("allocated"));
   }

   public static bhp.a a(List<bhp> $$0) {
      Map<String, Double> $$1 = new TreeMap<>();
      Map<String, List<bhp>> $$2 = $$0.stream().collect(Collectors.groupingBy($$0x -> $$0x.b));
      $$2.forEach(($$1x, $$2x) -> {
         if ($$2x.size() >= 2) {
            bhp $$3 = (bhp)$$2x.get(0);
            bhp $$4 = (bhp)$$2x.get($$2x.size() - 1);
