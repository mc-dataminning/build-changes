...
public class bhp extends bgz {
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:arrow", $$1x -> DSL.optionalFields("inBlockState", bfp.u.in($$0)));
      a($$0, $$1, "minecraft:bat");
      a($$0, $$1, "minecraft:blaze");
      $$0.registerSimple($$1, "minecraft:boat");
      a($$0, $$1, "minecraft:cave_spider");
      $$0.register($$1, "minecraft:chest_minecart", $$1x -> DSL.optionalFields("DisplayState", bfp.u.in($$0), "Items", DSL.list(bfp.t.in($$0))));
      a($$0, $$1, "minecraft:chicken");
      $$0.register($$1, "minecraft:commandblock_minecart", $$1x -> DSL.optionalFields("DisplayState", bfp.u.in($$0)));
      a($$0, $$1, "minecraft:cow");
      a($$0, $$1, "minecraft:creeper");
      $$0.register($$1, "minecraft:donkey", $$1x -> DSL.optionalFields("Items", DSL.list(bfp.t.in($$0)), "SaddleItem", bfp.t.in($$0), bha.a($$0)));
      ...
      $$0.register($$1, "minecraft:enderman", $$1x -> DSL.optionalFields("carriedBlockState", bfp.u.in($$0), bha.a($$0)));
      ...
      $$0.register($$1, "minecraft:falling_block", $$1x -> DSL.optionalFields("BlockState", bfp.u.in($$0), "TileEntityData", bfp.s.in($$0)));
      $$0.registerSimple($$1, "minecraft:fireball");
      $$0.register($$1, "minecraft:fireworks_rocket", $$1x -> DSL.optionalFields("FireworksItem", bfp.t.in($$0)));
      $$0.register($$1, "minecraft:furnace_minecart", $$1x -> DSL.optionalFields("DisplayState", bfp.u.in($$0)));
      a($$0, $$1, "minecraft:ghast");
      a($$0, $$1, "minecraft:giant");
      a($$0, $$1, "minecraft:guardian");
      $$0.register($$1, "minecraft:hopper_minecart", $$1x -> DSL.optionalFields("DisplayState", bfp.u.in($$0), "Items", DSL.list(bfp.t.in($$0))));
      $$0.register($$1, "minecraft:horse", $$1x -> DSL.optionalFields("ArmorItem", bfp.t.in($$0), "SaddleItem", bfp.t.in($$0), bha.a($$0)));
      a($$0, $$1, "minecraft:husk");
      $$0.registerSimple($$1, "minecraft:illusion_illager");
      $$0.register($$1, "minecraft:item", $$1x -> DSL.optionalFields("Item", bfp.t.in($$0)));
      $$0.register($$1, "minecraft:item_frame", $$1x -> DSL.optionalFields("Item", bfp.t.in($$0)));
      ...
      $$0.register($$1, "minecraft:minecart", $$1x -> DSL.optionalFields("DisplayState", bfp.u.in($$0)));
      a($$0, $$1, "minecraft:mooshroom");
      $$0.register($$1, "minecraft:mule", $$1x -> DSL.optionalFields("Items", DSL.list(bfp.t.in($$0)), "SaddleItem", bfp.t.in($$0), bha.a($$0)));
      ...
      $$0.register($$1, "minecraft:skeleton_horse", $$1x -> DSL.optionalFields("SaddleItem", bfp.t.in($$0), bha.a($$0)));
      ...
      $$0.register($$1, "minecraft:spawner_minecart", $$1x -> DSL.optionalFields("DisplayState", bfp.u.in($$0), bfp.D.in($$0)));
      $$0.register($$1, "minecraft:spectral_arrow", $$1x -> DSL.optionalFields("inBlockState", bfp.u.in($$0)));
      a($$0, $$1, "minecraft:spider");
      a($$0, $$1, "minecraft:squid");
      a($$0, $$1, "minecraft:stray");
      $$0.registerSimple($$1, "minecraft:tnt");
      $$0.register($$1, "minecraft:tnt_minecart", $$1x -> DSL.optionalFields("DisplayState", bfp.u.in($$0)));
      a($$0, $$1, "minecraft:vex");
      $$0.register(
         $$1,
         "minecraft:villager",
      ...
      $$0.register($$1, "minecraft:zombie_horse", $$1x -> DSL.optionalFields("SaddleItem", bfp.t.in($$0), bha.a($$0)));
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema $$0) {
      ...
      $$0.register($$1, "minecraft:jukebox", $$1x -> DSL.optionalFields("RecordItem", bfp.t.in($$0)));
      b($$0, $$1, "minecraft:dispenser");
      b($$0, $$1, "minecraft:dropper");
      $$0.registerSimple($$1, "minecraft:sign");
      $$0.register($$1, "minecraft:mob_spawner", $$1x -> bfp.D.in($$0));
      $$0.register($$1, "minecraft:piston", $$1x -> DSL.optionalFields("blockState", bfp.u.in($$0)));
   ...
   public void registerTypes(Schema $$0, Map<String, Supplier<TypeTemplate>> $$1, Map<String, Supplier<TypeTemplate>> $$2) {
      ...
      $$0.registerType(false, bfp.H, () -> DSL.constType(a()));
      $$0.registerType(
         false,
         bfp.b,
         () -> aze.a(
      ...
      $$0.registerType(
         ...
         () -> DSL.fields(
               ...
               DSL.optionalFields(
                  ...
                  "Sections",
                  DSL.list(DSL.optionalFields("Palette", DSL.list(bfp.u.in($$0))))
               )
            )
      );
      $$0.registerType(true, bfp.s, () -> DSL.taggedChoiceLazy("id", a(), $$2));
      $$0.registerType(true, bfp.y, () -> DSL.optionalFields("Passengers", DSL.list(bfp.y.in($$0)), bfp.z.in($$0)));
      $$0.registerType(true, bfp.z, () -> DSL.taggedChoiceLazy("id", a(), $$1));
      $$0.registerType(
         true,
         bfp.t,
         () -> DSL.hook(
      ...
      $$0.registerType(
         ...
         () -> DSL.optionalFields(
               "entities",
               DSL.list(DSL.optionalFields("nbt", bfp.y.in($$0))),
               "blocks",
               DSL.list(DSL.optionalFields("nbt", bfp.s.in($$0))),
               "palette",
               DSL.list(bfp.u.in($$0))
            )
      );
      $$0.registerType(false, bfp.A, () -> DSL.constType(a()));
      $$0.registerType(false, bfp.B, () -> DSL.constType(a()));
      $$0.registerType(false, bfp.u, DSL::remainder);
      $$0.registerType(false, bfp.v, DSL::remainder);
      Supplier<TypeTemplate> $$3 = () -> DSL.compoundList(bfp.B.in($$0), DSL.constType(DSL.intType()));
      $$0.registerType(
         false,
         bfp.g,
         () -> DSL.optionalFields(
               "stats",
               aze.a(
                  Pair.of("minecraft:mined", DSL.compoundList(bfp.A.in($$0), DSL.constType(DSL.intType()))),
                  ...
                  Pair.of("minecraft:killed", DSL.compoundList(bfp.x.in($$0), DSL.constType(DSL.intType()))),
                  Pair.of("minecraft:killed_by", DSL.compoundList(bfp.x.in($$0), DSL.constType(DSL.intType()))),
      ...
      $$0.registerType(false, bfp.E, DSL::remainder);
      Map<String, Supplier<TypeTemplate>> $$4 = bho.a($$0);
      $$0.registerType(false, bfp.F, () -> DSL.hook(DSL.optionalFields("CriteriaType", DSL.taggedChoiceLazy("type", DSL.string(), $$4)), bho.c, bho.d));
      $$0.registerType(false, bfp.G, DSL::remainder);
      $$0.registerType(true, bfp.D, () -> DSL.optionalFields("SpawnPotentials", DSL.list(DSL.fields("Entity", bfp.y.in($$0))), "SpawnData", bfp.y.in($$0)));
      $$0.registerType(
         false,
         bfp.p,
         () -> DSL.optionalFields(
               "minecraft:adventure/adventuring_time",
               DSL.optionalFields("criteria", DSL.compoundList(bfp.I.in($$0), DSL.constType(DSL.string()))),
               "minecraft:adventure/kill_a_mob",
               DSL.optionalFields("criteria", DSL.compoundList(bfp.x.in($$0), DSL.constType(DSL.string()))),
      ...
      $$0.registerType(false, bfp.I, () -> DSL.constType(a()));
      $$0.registerType(false, bfp.x, () -> DSL.constType(a()));
