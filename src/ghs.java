...
public class ghs<T extends drz> implements ggz<T> {
   ...
   private void a(T $$0, Matrix4f $$1, fbm $$2) {
      float $$3 = this.c();
      float $$4 = this.b();
   ...
   private void a(T $$0, Matrix4f $$1, fbm $$2, float $$3, float $$4, float $$5, float $$6, float $$7, float $$8, float $$9, float $$10, ji $$11) {
      if ($$0.a($$11)) {
         $$2.a($$1, $$3, $$5, $$7);
         $$2.a($$1, $$4, $$5, $$8);
         $$2.a($$1, $$4, $$6, $$9);
