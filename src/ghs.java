...
public final class ghs {
   ...
   private static final ghs c = new ghs(HostAndPort.fromParts("server.invalid", 25565));

   public ghs(String $$0, int $$1) {
      this(HostAndPort.fromParts($$0, $$1));
   }

   private ghs(HostAndPort $$0) {
      this.b = $$0;
   }
   ...
   public static ghs a(String $$0) {
      if ($$0 == null) {
         return c;
      } else {
         try {
            HostAndPort $$1 = HostAndPort.fromString($$0).withDefaultPort(25565);
            return $$1.getHost().isEmpty() ? c : new ghs($$1);
         } catch (IllegalArgumentException var2) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return $$0 instanceof ghs ? this.b.equals(((ghs)$$0).b) : false;
      }
   }
