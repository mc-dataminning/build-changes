...
public class bmz implements bna {
   ...
   private static final bmz k = new bmz();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(bmy $$0) {
      URL $$1 = bmz.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, bmy $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final bnc a = new bnc(() -> bmz.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == bmz.this.l && $$0.getState() == RecordingState.STOPPED) {
