...
public class ug {
   ...
   private static int a(to $$0) {
      $$0.f().a_(null, $$0.d()).stream().forEach($$0x -> $$0x.a(bsw.c.b));
      $$0.e().c($$0.f());
      ue.a($$0.d(), $$0.f());
   ...
   private static int a(ep $$0, String $$1, int $$2, int $$3, int $$4) {
      if ($$2 <= 48 && $$3 <= 48 && $$4 <= 48) {
         arf $$5 = $$0.e();
         iz $$6 = a($$0).d();
         ue.a($$1.toLowerCase(), $$6, new kd($$2, $$3, $$4), dlo.a, $$5);
         iz $$7 = $$6.c();
         iz $$8 = $$7.b($$2 - 1, 0, $$4 - 1);
         iz.d($$7, $$8).forEach($$1x -> $$5.b($$1x, dfd.F.o()));
         ue.a($$6, new iz(1, 0, -1), dlo.a, $$5);
         return 0;
      } else {
   ...
   private static int a(ep $$0, String $$1) throws CommandSyntaxException {
      evp $$2 = (evp)$$0.h().a(10.0, 1.0F, false);
      iz $$3 = $$2.a();
      arf $$4 = $$0.e();
