...
public class ug extends ui<uh> {
   private static final int b = 24;
   public static final vi<ug> a = new vi.b<ug>() {
      public ug a(DataInput $$0, us $$1) throws IOException {
         return new ug(d($$0, $$1));
      }
   ...
   public boolean b(int $$0, vg $$1) {
      if ($$1 instanceof uz) {
         this.c = ArrayUtils.add(this.c, $$0, ((uz)$$1).i());
         return true;
      } else {
         return false;
      }
