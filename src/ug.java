...
public class ug implements sx {
   ...
   private void d() {
      ...
      if ($$0 != this.h) {
         ...
         try {
            Builder<ta> $$2 = ImmutableList.builder();
            this.a($$1, $$2::add);
            this.i = $$2.build();
         } catch (uh var4) {
            this.i = ImmutableList.of(ta.e($$1));
         }
      }
   }
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         if ($$0 instanceof ug $$1 && Objects.equals(this.e, $$1.e) && Objects.equals(this.f, $$1.f) && Arrays.equals(this.g, $$1.g)) {
            return true;
         }
