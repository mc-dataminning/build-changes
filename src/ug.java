...
public abstract class ug {
   ...
   private static volatile ug e = c();
   ...
   private static ug c() {
      ...
      return new ug() {
         ...
         @Override
         public ayy a(xo $$0) {
            return $$1 -> $$0.a(($$1x, $$2) -> bah.c($$2, $$1x, $$1) ? Optional.empty() : xo.a, yg.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = ug.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(azc.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract ayy a(xo var1);

   public List<ayy> a(List<xo> $$0) {
