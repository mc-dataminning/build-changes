...
public class drm<T> implements dru<T> {
   private final is<T> a;
   private final awj<T> b;
   private final drv<T> c;
   private final int d;

   public drm(is<T> $$0, int $$1, drv<T> $$2, List<T> $$3) {
      this($$0, $$1, $$2);
      $$3.forEach(this.b::d);
   }

   public drm(is<T> $$0, int $$1, drv<T> $$2) {
      this($$0, $$1, $$2, awj.c(1 << $$1));
   }

   private drm(is<T> $$0, int $$1, drv<T> $$2, awj<T> $$3) {
      this.a = $$0;
      this.d = $$1;
      this.c = $$2;
      this.b = $$3;
   ...
   @Override
   public dru<T> c() {
      return new drm<>(this.a, this.d, this.c, this.b.c());
   }
}
