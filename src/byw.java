public class byw extends byz {
   ...
   public byw(bta $$0, int $$1, boolean $$2) {
      super($$0);
      this.l = $$1;
      this.m = $$2;
   }
   ...
   public void a() {
      if (this.k == byz.a.b) {
         ...
         this.d.s(this.a(this.d.dF(), $$4, 90.0F));
         float $$5;
         if (this.d.aE()) {
            $$5 = (float)(this.h * this.d.g(bug.v));
         } else {
            $$5 = (float)(this.h * this.d.g(bug.l));
         }

         this.d.z($$5);
         double $$7 = Math.sqrt($$0 * $$0 + $$2 * $$2);
         if (Math.abs($$1) > 1.0E-5F || Math.abs($$7) > 1.0E-5F) {
            float $$8 = (float)(-(aye.d($$1, $$7) * 180.0F / (float)Math.PI));
            this.d.t(this.a(this.d.dH(), $$8, (float)this.l));
            this.d.E($$1 > 0.0 ? $$5 : -$$5);
         }
      } else {
         if (!this.m) {
