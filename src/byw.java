...
public class byw extends cab implements bzm {
   ...
   public static boolean a(biu<byw> $$0, cqk $$1, bjk $$2, gw $$3, asc $$4) {
      if (!$$1.b_($$3.d()).a(apx.a)) {
         ...
         he<cqt> $$5 = $$1.s($$3);
         boolean $$6 = $$1.ai() != bgv.a && a($$1, $$3, $$4) && ($$2 == bjk.c || $$1.b_($$3).a(apx.a));
         return $$5.a(apr.ao) ? $$4.a(15) == 0 && $$6 : $$4.a(40) == 0 && a($$1, $$3) && $$6;
      }
   }
   ...
   @Override
   protected apc w() {
      return this.aX() ? apd.gx : apd.gw;
   }

   @Override
   protected apc d(bho $$0) {
      return this.aX() ? apd.gB : apd.gA;
   }

   @Override
   protected apc l_() {
      return this.aX() ? apd.gz : apd.gy;
   }
   ...
   public void a(bjg $$0, float $$1) {
      ...
      this.a(apd.gC, 1.0F, 1.0F / (this.ef().i() * 0.4F + 0.8F));
      this.dL().b($$2);
   }
   ...
   static class d extends bpe {
      ...
      public void a() {
         ...
         if (this.l.gn() && this.l.aX()) {
            ...
            $$2 /= $$4;
            float $$5 = (float)(arw.d($$3, $$1) * 180.0F / (float)Math.PI) - 90.0F;
