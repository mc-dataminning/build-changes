...
public class byw {
   ...
   public static bwz<bvn> a(float $$0) {
      Long2LongMap $$1 = new Long2LongOpenHashMap();
      MutableLong $$2 = new MutableLong(0L);
      return cal.a(
         (Function<cal.b<bvn>, ? extends App<cal.c<bvn>, cao<bvn>>>)($$3 -> $$3.group($$3.c(cej.m), $$3.c(cej.b))
               .apply($$3, ($$3x, $$4) -> ($$4x, $$5, $$6) -> {
                     if ($$4x.ad() - $$2.getValue() < 20L) {
                        return false;
                     } else {
                        cgj $$7 = $$4x.A();
                        Optional<ji> $$8 = $$7.d($$0xxxx -> $$0xxxx.a(cgn.n), $$5.dw(), 48, cgj.b.c);
                        if (!$$8.isEmpty() && !($$8.get().j($$5.dw()) <= 4.0)) {
                           ...
                           Set<Pair<jr<cgm>, ji>> $$11 = $$7.b($$0xxxx -> $$0xxxx.a(cgn.n), $$10, $$5.dw(), 48, cgj.b.c).collect(Collectors.toSet());
                           etl $$12 = bwr.a($$5, $$11);
                           if ($$12 != null && $$12.j()) {
                              ji $$13 = $$12.l();
                              Optional<jr<cgm>> $$14 = $$7.c($$13);
                              if ($$14.isPresent()) {
                                 $$3x.a(new cem($$13, $$0, 1));
                                 agc.c($$4x, $$13);
                              }
