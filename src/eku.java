...
public class eku {
   ...
   private final eku.a g;

   @Deprecated
   public static eku a(ayd $$0, eku.a $$1) {
      return new eku($$0, $$1, false);
   }

   public static eku a(ayd $$0, int $$1, double... $$2) {
      return b($$0, new eku.a($$1, new DoubleArrayList($$2)));
   }

   public static eku b(ayd $$0, eku.a $$1) {
      return new eku($$0, $$1, true);
   }

   private eku(ayd $$0, eku.a $$1, boolean $$2) {
      int $$3 = $$1.c;
      DoubleList $$4 = $$1.d;
      this.g = $$1;
      if ($$2) {
   ...
   public static record a(int c, DoubleList d) {
      public static final Codec<eku.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(Codec.INT.fieldOf("firstOctave").forGetter(eku.a::a), Codec.DOUBLE.listOf().fieldOf("amplitudes").forGetter(eku.a::b))
               .apply($$0, eku.a::new)
      );
      public static final Codec<iv<eku.a>> b = akb.a(ld.aG, a);
