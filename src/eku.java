...
public enum eku implements auk {
   a(0, "list"),
   b(1, "sidebar"),
   c(2, "below_name"),
   ...
   public static final auk.a<eku> t = auk.a(eku::values);
   public static final IntFunction<eku> u = asj.a(eku::a, values(), asj.a.a);
   private final int v;
   private final String w;

   private eku(int $$0, String $$1) {
      this.v = $$0;
      this.w = $$1;
   }
