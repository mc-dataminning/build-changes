...
public class eku {
   ...
   static class a implements eku.i {
      @Override
      public boolean a(eku.v $$0) {
         return $$0.c[je.f.d()] && !$$0.b[je.f.d()].d;
      }

      @Override
      public eku.r a(je $$0, eku.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[je.f.d()].d = true;
         return new eku.k($$0, $$1);
      }
   }

   static class b implements eku.i {
      @Override
      public boolean a(eku.v $$0) {
      ...
      public eku.r a(je $$0, eku.v $$1, azh $$2) {
         ...
         return new eku.l($$0, $$1);
      }
   }

   static class c implements eku.i {
      @Override
      public boolean a(eku.v $$0) {
      ...
      public eku.r a(je $$0, eku.v $$1, azh $$2) {
         $$1.d = true;
         $$1.b[je.b.d()].d = true;
         return new eku.m($$0, $$1);
      }
   }

   static class d implements eku.i {
      @Override
      public boolean a(eku.v $$0) {
      ...
      public eku.r a(je $$0, eku.v $$1, azh $$2) {
         ...
         return new eku.n($$0, $$1);
      }
   }

   static class e implements eku.i {
      @Override
      public boolean a(eku.v $$0) {
      ...
      public eku.r a(je $$0, eku.v $$1, azh $$2) {
         ...
         $$3.d = true;
         $$3.b[je.c.d()].d = true;
         return new eku.o($$0, $$3);
      }
   }

   static class f implements eku.i {
      @Override
      public boolean a(eku.v $$0) {
         return true;
      }
      ...
      public eku.r a(je $$0, eku.v $$1, azh $$2) {
         $$1.d = true;
         return new eku.s($$0, $$1, $$2);
      }
   }

   static class g implements eku.i {
      @Override
      public boolean a(eku.v $$0) {
      ...
      public eku.r a(je $$0, eku.v $$1, azh $$2) {
         $$1.d = true;
         return new eku.t($$0, $$1);
      }
   }

   public static class h extends eku.r {
      ...
      private eku.v G;
      private eku.v H;
      private final List<eku.r> I = Lists.newArrayList();

      public h(azh $$0, int $$1, int $$2, je $$3) {
         super(ejc.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eku.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eku.p($$3, this.G));
         this.I.add(new eku.j($$3, this.H));
         List<eku.i> $$5 = Lists.newArrayList();
         $$5.add(new eku.b());
         $$5.add(new eku.d());
         $$5.add(new eku.e());
         $$5.add(new eku.a());
         ...
         eid $$10 = eid.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eid $$11 = eid.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eid $$12 = eid.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eku.u($$3, $$10, $$13++));
         this.I.add(new eku.u($$3, $$11, $$13++));
         this.I.add(new eku.q($$3, $$12));
      }
      ...
      private List<eku.v> b(azh $$0) {
         eku.v[] $$1 = new eku.v[75];
         ...
         eku.v $$23 = new eku.v(1003);
         eku.v $$24 = new eku.v(1001);
         eku.v $$25 = new eku.v(1002);
         $$1[v].a(je.b, $$23);
         $$1[w].a(je.d, $$24);
         $$1[x].a(je.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eku.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dcu $$2, azh $$3, eid $$4) {
         int $$5 = 24;
      ...
      private void a(dcu $$0, azh $$1, eid $$2) {
      ...
      private void b(dcu $$0, azh $$1, eid $$2) {
      ...
      private void c(dcu $$0, azh $$1, eid $$2) {
      ...
      private void d(dcu $$0, azh $$1, eid $$2) {
      ...
      private void e(dcu $$0, azh $$1, eid $$2) {
      ...
      private void f(dcu $$0, azh $$1, eid $$2) {
   ...
   interface i {
      boolean a(eku.v var1);

      eku.r a(je var1, eku.v var2, azh var3);
   }

   public static class j extends eku.r {
      public j(je $$0, eku.v $$1) {
         super(ejc.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dcu $$0, dcs $$1, dua $$2, azh $$3, eid $$4, dbg $$5, iz $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dfc.ch.o(), dfc.ch.o(), false);
   ...
   public static class k extends eku.r {
      public k(je $$0, eku.v $$1) {
         super(ejc.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eku.r {
      public l(je $$0, eku.v $$1) {
         super(ejc.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eku.r {
      public m(je $$0, eku.v $$1) {
         super(ejc.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eku.r {
      public n(je $$0, eku.v $$1) {
         super(ejc.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eku.r {
      public o(je $$0, eku.v $$1) {
         super(ejc.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eku.r {
      public p(je $$0, eku.v $$1) {
         super(ejc.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eku.r {
      public q(je $$0, eid $$1) {
         super(ejc.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends eip {
      protected static final dsd b = dfc.hZ.o();
      protected static final dsd c = dfc.ia.o();
      protected static final dsd d = dfc.ib.o();
      protected static final dsd h = c;
      protected static final dsd i = dfc.ii.o();
      protected static final boolean j = true;
      protected static final dsd k = dfc.G.o();
      protected static final Set<dfa> l = ImmutableSet.builder().add(dfc.dO).add(dfc.iC).add(dfc.mW).add(k.b()).build();
      ...
      public r(ejc $$0, je $$1, int $$2, eid $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(ejc $$0, int $$1, je $$2, eku.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eid a(je $$0, eku.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eid $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dcu $$0, eid $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dsd $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.z_() && $$11 != k) {
                        this.a($$0, dfc.a.o(), $$9, $$8, $$10, $$1);
                     } else {
                        this.a($$0, k, $$9, $$8, $$10, $$1);
                     }
                  }
      ...
      protected void a(dcu $$0, eid $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dcu $$0, eid $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dsd $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eid $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dcu $$0, eid $$1, int $$2, int $$3, int $$4) {
         iz $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjt $$6 = btb.D.a((dbz)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eR());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dp()), btu.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eku.r {
      private int a;

      public s(je $$0, eku.v $$1, azh $$2) {
         super(ejc.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eku.r {
      public t(je $$0, eku.v $$1) {
         super(ejc.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eku.r {
      private int a;

      public u(je $$0, eid $$1, int $$2) {
         super(ejc.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
