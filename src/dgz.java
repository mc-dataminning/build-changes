...
public class dgz implements dgb {
   ...
   private final btc j;
   private final dgc k;
   private final Map<coy, fbb> l = new HashMap<>();

   public dgz(ard $$0, @Nullable bum $$1, @Nullable btc $$2, @Nullable dgc $$3, fbb $$4, float $$5, boolean $$6, dgb.a $$7) {
      this.f = $$0;
      this.h = $$1;
      this.i = $$5;
      this.g = $$4;
   ...
   private dgc b(@Nullable bum $$0) {
      return (dgc)($$0 == null ? a : new dfz($$0));
   }

   public static float a(fbb $$0, bum $$1) {
      faw $$2 = $$1.cR();
         ...
         for (double $$10 = 0.0; $$10 <= 1.0; $$10 += $$3) {
            for (double $$11 = 0.0; $$11 <= 1.0; $$11 += $$4) {
               for (double $$12 = 0.0; $$12 <= 1.0; $$12 += $$5) {
                  ...
                  fbb $$16 = new fbb($$13 + $$6, $$14, $$15 + $$7);
                  if ($$1.dV().a(new dfr($$16, $$0, dfr.a.a, dfr.b.a, $$1)).d() == faz.a.a) {
                     $$8++;
                  }
   ...
   private void n() {
      ...
      for (bum $$8 : this.f.a_(this.h, new faw((double)$$1, (double)$$3, (double)$$5, (double)$$2, (double)$$4, (double)$$6))) {
         if (!$$8.a(this)) {
            double $$9 = Math.sqrt($$8.g(this.g)) / (double)$$0;
            if ($$9 <= 1.0) {
               double $$10 = $$8.dA() - this.g.d;
               double $$11 = ($$8 instanceof cle ? $$8.dC() : $$8.dE()) - this.g.e;
               ...
               if ($$13 != 0.0) {
                  ...
                  double $$19;
                  if ($$8 instanceof bvi $$18) {
                     $$19 = $$17 * (1.0 - $$18.h(bwq.i));
                  } else {
                     $$19 = $$17;
                  }
   ...
   private void b(List<ji> $$0) {
      for (ji $$1 : $$0) {
         if (this.f.A.a(3) == 0 && this.f.a_($$1).l() && this.f.a_($$1.e()).s()) {
            this.f.b($$1, dja.a(this.f, $$1));
         }
      }
   }

   public void i() {
      this.f.a(this.h, ebu.w, this.g);
      List<ji> $$0 = this.m();
      this.n();
      if (this.o()) {
         bou $$1 = bot.a();
   ...
   private static void a(List<dgz.a> $$0, cwq $$1, ji $$2) {
      for (dgz.a $$3 : $$0) {
         $$3.a($$1);
         if ($$1.f()) {
            return;
   ...
   private boolean o() {
      return this.e != dgb.a.a;
   }

   public Map<coy, fbb> j() {
      return this.l;
   }
   ...
   public boolean g() {
      if (this.e != dgb.a.d) {
         ...
         return this.h != null && this.h.aq() == but.s ? this.f.O().b(dgf.c) : true;
      }
   }

   @Override
   public boolean h() {
      boolean $$0 = this.f.O().b(dgf.c);
      boolean $$1 = this.h == null || !this.h.bj();
      boolean $$2 = this.h == null || this.h.aq() != but.s && this.h.aq() != but.bG;
