public abstract class fun<T extends cuq> extends ful<T> implements fxy {
   private final fxt<?> G;
   private boolean H;

   public fun(T $$0, fxt<?> $$1, cpv $$2, xv $$3) {
      super($$0, $$2, $$3);
      this.G = $$1;
   }
   ...
   protected abstract fsk G();

   private void M() {
      fsk $$0 = this.G();
      this.c(new fop($$0.a(), $$0.b(), 20, 18, fxt.a, $$0x -> {
         this.G.c();
         this.C = this.G.a(this.n, this.s);
         fsk $$1 = this.G();
         $$0x.c($$1.a(), $$1.b());
