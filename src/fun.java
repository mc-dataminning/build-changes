...
public class fun extends ftr {
   ...
   public fun(cps $$0, cxk $$1, btd $$2, dar $$3) {
      super(flq.a);
      this.z = $$0;
      this.A = $$1;
      this.R = $$2;
   ...
   protected void aT_() {
      this.T();
      this.O = this.c((fny)fny.a(xv.c("book.signButton"), $$0x -> {
         this.C = true;
         this.J();
      }).a(this.n / 2 - 100, 196, 98, 20).a());
      this.N = this.c((fny)fny.a(xu.d, $$0x -> {
         this.m.a(null);
         this.c(false);
      }).a(this.n / 2 + 2, 196, 98, 20).a());
      this.P = this.c((fny)fny.a(xv.c("book.finalizeButton"), $$0x -> {
         if (this.C) {
            this.c(true);
            this.m.a(null);
         }
      }).a(this.n / 2 - 100, 196, 98, 20).a());
      this.Q = this.c((fny)fny.a(xu.e, $$0x -> {
         if (this.C) {
            this.C = false;
         }
   ...
   private void c(boolean $$0) {
      if (this.B) {
         this.K();
         this.L();
         int $$1 = this.R == btd.a ? this.z.gg().j : 40;
         this.m.L().b(new aig($$1, this.F, $$0 ? Optional.of(this.G.trim()) : Optional.empty()));
      }
   }

   private void L() {
      this.A.b(ku.S, new dar(this.F.stream().map(asz::a).toList()));
   }
   ...
   public void b(fnl $$0, int $$1, int $$2, float $$3) {
      this.b($$0);
      $$0.a(glo::B, fuo.s, (this.n - 192) / 2, 2, 0.0F, 0.0F, 192, 192, 256, 256);
   }
   ...
   private void a(fnl $$0, gll[] $$1) {
      for (gll $$2 : $$1) {
         int $$3 = $$2.a();
         int $$4 = $$2.b();
         int $$5 = $$3 + $$2.c();
         int $$6 = $$4 + $$2.d();
         $$0.a(glo.J(), $$3, $$4, $$5, $$6, -16776961);
      }
   }
   ...
   private fun.a V() {
      ...
      if ($$0.isEmpty()) {
         ...
         List<gll> $$14 = Lists.newArrayList();
         if ($$1 != $$2) {
            int $$15 = Math.min($$1, $$2);
            int $$16 = Math.max($$1, $$2);
            int $$17 = a($$8, $$15);
         ...
         return new fun.a($$0, $$10, $$9, $$8, $$4.toArray(new fun.b[0]), $$14.toArray(new gll[0]));
      }
   }
   ...
   private gll a(String $$0, fmj $$1, int $$2, int $$3, int $$4, int $$5) {
   ...
   private gll a(fun.c $$0, fun.c $$1) {
      ...
      return new gll($$4, $$6, $$5 - $$4, $$7 - $$6);
   }

   static class a {
      static final fun.a a = new fun.a("", new fun.c(0, 0), true, new int[]{0}, new fun.b[]{new fun.b(ys.a, "", 0, 0)}, new gll[0]);
      ...
      public a(String $$0, fun.c $$1, boolean $$2, int[] $$3, fun.b[] $$4, gll[] $$5) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
