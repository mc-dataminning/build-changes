...
public class fun extends fuk {
   ...
   private final List<gjq> cK = Lists.newArrayList();
   private int cL = 0;
   private double cM;
   private double cN;
   private double cO;
   ...
   public fun(exh $$0, fpx $$1, fpy $$2, atv $$3, ewu $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.q());
      this.cs = $$0;
      this.cq = $$2;
      this.cI = $$3;
      ...
      this.cT = $$5;
      this.cU = $$6;
      this.cK.add(new gki(this, $$0.ai()));
      this.cK.add(new gjv(this));
      this.cK.add(new gju(this, $$0.ai(), $$1.G_()));
   }
   ...
   public boolean a(bno $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof cja) {
            this.cs.ai().a((gkg)(new gka(this, (cja)$$0, true)));
            this.cs.ai().a((gkg)(new gka(this, (cja)$$0, false)));
         }
   ...
   private void G() {
      ...
      if (this.au) {
         ...
         if (this.cz == 0.0F) {
            this.cs.ai().a(gkb.b(atk.ub, this.af.i() * 0.4F + 0.8F, 0.25F));
         }
   ...
   protected boolean fL() {
      ...
      if (this.P_()) {
         ...
         if (!$$0 && $$1) {
            ...
            this.cs.ai().a((gkg)(new gkj.b(this)));
         }
