...
public class fun extends fui<bvb, ffx<bvb>> {
   private static final Map<bvb.a, aeu> a = ac.a(Maps.newEnumMap(bvb.a.class), $$0 -> {
      $$0.put(bvb.a.a, new aeu("textures/entity/panda/panda.png"));
      $$0.put(bvb.a.b, new aeu("textures/entity/panda/lazy_panda.png"));
      $$0.put(bvb.a.c, new aeu("textures/entity/panda/worried_panda.png"));
      $$0.put(bvb.a.d, new aeu("textures/entity/panda/playful_panda.png"));
      $$0.put(bvb.a.e, new aeu("textures/entity/panda/brown_panda.png"));
      $$0.put(bvb.a.f, new aeu("textures/entity/panda/weak_panda.png"));
      $$0.put(bvb.a.g, new aeu("textures/entity/panda/aggressive_panda.png"));
   });

   public fun(ftc.a $$0) {
      super($$0, new ffx<>($$0.a(fhw.az)), 0.9F);
      this.a(new fxg(this, $$0.d()));
   }

   public aeu a(bvb $$0) {
      return a.getOrDefault($$0.gm(), a.get(bvb.a.a));
   }

   protected void a(bvb $$0, elk $$1, float $$2, float $$3, float $$4) {
      super.a($$0, $$1, $$2, $$3, $$4);
      if ($$0.bU > 0) {
         int $$5 = $$0.bU;
         int $$6 = $$5 + 1;
      ...
      if ($$24 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(ars.i($$24, $$0.dC(), $$0.dC() + 90.0F)));
      ...
      if ($$26 > 0.0F) {
         ...
         $$1.a(0.0F, $$27 * $$26, 0.0F);
         $$1.a(a.b.rotationDegrees(ars.i($$26, $$0.dC(), $$0.dC() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? ars.i($$3, $$0, $$1) : $$0;
   }
}
