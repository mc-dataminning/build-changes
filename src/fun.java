...
public class fun extends ftc<byo> {
   public fun(ftd.a $$0) {
      super($$0);
   }

   public void a(byo $$0, float $$1, float $$2, elj $$3, foa $$4, int $$5) {
      $$3.a();
      $$3.a(a.d.rotationDegrees(180.0F - $$1));
      byp $$6 = $$0.q().a();
      float $$7 = 0.0625F;
      $$3.b(0.0625F, 0.0625F, 0.0625F);
      eln $$8 = $$4.getBuffer(foi.c(this.a($$0)));
      fzz $$9 = eqp.O().aD();
   ...
   private void a(elj $$0, eln $$1, byo $$2, int $$3, int $$4, fza $$5, fza $$6) {
      elj.a $$7 = $$0.c();
      Matrix4f $$8 = $$7.a();
      Matrix3f $$9 = $$7.b();
      ...
      for (int $$29 = 0; $$29 < $$25; $$29++) {
         for (int $$30 = 0; $$30 < $$26; $$30++) {
            ...
            int $$35 = $$2.dp();
            int $$36 = asb.a($$2.ds() + (double)(($$33 + $$34) / 2.0F / 16.0F));
            int $$37 = $$2.dv();
            ha $$38 = $$2.cD();
            if ($$38 == ha.c) {
               $$35 = asb.a($$2.dq() + (double)(($$31 + $$32) / 2.0F / 16.0F));
            }

            if ($$38 == ha.e) {
               $$37 = asb.a($$2.dw() - (double)(($$31 + $$32) / 2.0F / 16.0F));
            }
            ...
            int $$39 = fny.a($$2.dL(), new gw($$35, $$36, $$37));
   ...
   private void a(Matrix4f $$0, Matrix3f $$1, eln $$2, float $$3, float $$4, float $$5, float $$6, float $$7, int $$8, int $$9, int $$10, int $$11) {
      $$2.a($$0, $$3, $$4, $$7).a(255, 255, 255, 255).a($$5, $$6).c(fyr.d).b($$11).a($$1, (float)$$8, (float)$$9, (float)$$10).e();
   }
}
