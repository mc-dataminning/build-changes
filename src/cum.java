...
public class cum extends cue {
   ...
   public void b() {
      if (this.c() instanceof arq $$0) {
         this.a.bd();
         iv var11 = this.a.j();
         eao $$3 = this.c().a_(var11);
         boolean $$4 = dmb.h($$3);
         this.a.a($$4);
         if ($$4) {
            this.a($$0);
            if ($$3.a(dmo.hI)) {
               this.a.a(var11.u(), var11.v(), var11.w(), $$3.c(dsp.d));
            }
         } else {
            this.a.e($$0);
         }
   ...
   public void a(arq $$0) {
      ...
      $$10 = new fex($$19 * $$15 / $$17, $$10.e, $$19 * $$16 / $$17);
      this.a($$10);
      bwi $$20 = this.a.cY();
      fex $$22;
      ...
      $$10 = this.e();
      this.a.a(bxn.a, new fex(azm.a($$36 * $$10.d, -$$37, $$37), 0.0, azm.a($$36 * $$10.f, -$$37, $$37)));
      ...
      fex $$38 = this.d(this.a.dz(), this.a.dB(), this.a.dF());
      if ($$38 != null && $$6 != null) {
   ...
   @Nullable
   public fex a(double $$0, double $$1, double $$2, double $$3) {
      int $$4 = azm.a($$0);
      int $$5 = azm.a($$1);
      int $$6 = azm.a($$2);
   ...
   public fex d(double $$0, double $$1, double $$2) {
      ...
      eao $$6 = this.c().a_(new iv($$3, $$4, $$5));
      if (dmb.h($$6)) {
         ebs $$7 = $$6.c(((dmb)$$6.b()).c());
         Pair<ka, ka> $$8 = ctw.a($$7);
         ka $$9 = (ka)$$8.getFirst();
   ...
   @Override
   public boolean d() {
      fes $$0 = this.a.cQ().c(0.2F, 0.0, 0.2F);
      if (this.a.y() && this.e().j() >= 0.01) {
         ...
         for (bwi $$3 : this.c().a_(this.a, $$0)) {
            if (!this.a.y($$3) && $$3.bF() && $$3 instanceof ctw) {
               $$3.h(this.a);
            }
         }
      }
   ...
   @Override
   public fex c(fex $$0) {
      return !Double.isNaN($$0.d) && !Double.isNaN($$0.e) && !Double.isNaN($$0.f) ? new fex(azm.a($$0.d, -0.4, 0.4), $$0.e, azm.a($$0.f, -0.4, 0.4)) : fex.c;
   }
