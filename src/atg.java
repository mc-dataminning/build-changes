...
class atg extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof atf && $$1 instanceof atf && $$0.equals($$1);
   }
   ...
   private static atf a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof atf) {
         return (atf)$$0;
      } else {
