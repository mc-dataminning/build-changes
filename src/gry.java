...
public class gry extends gsc<cju, gyh> {
   ...
   private static final gmh j = gmh.g(h);
   private static final gmh k = gmh.m(h);
   private static final gmh l = gmh.q(i);
   private static final gmh m = gmh.l(a);
   ...
   public gry(gsd.a $$0) {
      super($$0);
      this.f = 0.5F;
      this.o = new gew($$0.a(gfb.aJ));
   }

   public void a(gyh $$0, fft $$1, glx $$2, int $$3) {
      $$1.a();
      float $$4 = $$0.a(7).b();
      ...
      if ($$0.b > 0.0F) {
         ...
         ffx $$8 = $$2.getBuffer(gmh.p(b));
         this.o.a($$1, $$8, $$3, heh.d, $$7);
         ffx $$9 = $$2.getBuffer(k);
         this.o.a($$1, $$9, $$3, heh.a(0.0F, $$0.c));
      } else {
         ffx $$10 = $$2.getBuffer(j);
         this.o.a($$1, $$10, $$3, heh.a(0.0F, $$0.c));
      }

      ffx $$11 = $$2.getBuffer(l);
      this.o.a($$1, $$11, $$3, heh.d);
      if ($$0.b > 0.0F) {
         float $$12 = $$0.b / 200.0F;
         $$1.a();
         $$1.a(0.0F, -1.0F, -2.0F);
         a($$1, $$12, $$2.getBuffer(gmh.q()));
         a($$1, $$12, $$2.getBuffer(gmh.r()));
         $$1.b();
      }
   ...
   private static void a(fft $$0, float $$1, ffx $$2) {
      $$0.a();
   ...
   public static void a(float $$0, float $$1, float $$2, float $$3, fft $$4, glx $$5, int $$6) {
      ...
      for (int $$17 = 1; $$17 <= 8; $$17++) {
         ...
         $$9.a($$16, $$13 * 0.2F, $$14 * 0.2F, 0.0F).a(-16777216).a($$15, $$10).b(heh.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$13, $$14, $$8).a(-1).a($$15, $$11).b(heh.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$18, $$19, $$8).a(-1).a($$20, $$11).b(heh.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$18 * 0.2F, $$19 * 0.2F, 0.0F).a(-16777216).a($$20, $$10).b(heh.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$13 = $$18;
         $$14 = $$19;
         $$15 = $$20;
      }
   ...
   public void a(cju $$0, gyh $$1, float $$2) {
      super.a($$0, $$1, $$2);
      ...
      cjt $$3 = $$0.cb;
      if ($$3 != null) {
         faz $$4 = $$3.o($$2).b(0.0, (double)grx.a((float)$$3.a + $$2), 0.0);
         $$1.d = $$4.d($$0.o($$2));
      } else {
         $$1.d = null;
      }
      ...
      $$1.e = $$5 == ckk.d || $$5 == ckk.e;
      $$1.f = $$5.a();
      ji $$6 = $$0.dV().a(ecr.a.f, efw.a($$0.m()));
      $$1.g = $$6.b($$0.dt());
      $$1.h = $$0.eE() ? 0.0F : $$2;
      $$1.i.a($$0.b);
   }

   protected boolean a(cju $$0) {
      return false;
   }
}
