...
public final class ju {
   public static final Codec<UUID> a = Codec.INT_STREAM.comapFlatMap($$0 -> ad.a($$0, 4).map(ju::a), $$0 -> Arrays.stream(a($$0)));
   ...
   public static zc<ByteBuf, UUID> g = new zc<ByteBuf, UUID>() {
