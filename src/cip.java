...
public class cip {
   ...
   private static void b(bwi<cio> $$0) {
      $$0.a(cqo.a, 0, ImmutableList.of(new bzt(0.8F), new cip.a(4.0F), new byf(45, 90), new byj(), new bxf(cek.P), new bxf(cek.Q)));
   }
   ...
   public static class a extends bwu<cio> {
      ...
      protected void a(arc $$0, cio $$1, long $$2) {
         $$1.gE();
         super.b($$0, $$1, $$2);
      }
   }
   ...
   public static class b extends bwz<cio> {
      ...
      protected boolean a(arc $$0, cio $$1) {
