...
public class fgb extends ffl implements fpz.a {
   ...
   private final fpz z;
   private final Map<af, ffx> A = Maps.newLinkedHashMap();
   @Nullable
   private ffx B;
   private boolean C;
   ...
   protected void aQ_() {
      ...
      if (this.B == null && !this.A.isEmpty()) {
         ffx $$0 = this.A.values().iterator().next();
         this.z.a($$0.c().b(), true);
      } else {
   ...
   public void a(ezb $$0, int $$1, int $$2) {
      ...
      if (this.A.size() > 1) {
         for (ffx $$3 : this.A.values()) {
            $$3.a($$0, $$1, $$2, $$3 == this.B);
         }

         for (ffx $$4 : this.A.values()) {
            $$4.a($$0, $$1, $$2);
         }
      }
   ...
   @Override
   public void a(ag $$0) {
      ffx $$1 = ffx.a(this.f, this, this.A.size(), $$0);
      if ($$1 != null) {
         this.A.put($$0.b(), $$1);
      }
   }
