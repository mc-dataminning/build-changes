...
public record fgb(int i, int j, fgb.a k, fgb.b l, int m) {
   public static final int a = 32;
   private static final fgb[] n = new fgb[32];
   private static final List<fgb> o = new ArrayList<>(32);
   public static final fgb b = a(0, 0, fgb.a.a, fgb.b.a, 3);
   public static final fgb c = a(1, 0, fgb.a.b, fgb.b.c, 4);
   public static final fgb d = a(2, 0, fgb.a.a, fgb.b.d, 2);
   public static final fgb e = d;
   public static final fgb f = a(3, 1, fgb.a.e, fgb.b.d, 2);
   public static final fgb g = a(4, 2, fgb.a.e, fgb.b.d, 2);
   public static final fgb h = a(5, 0, fgb.a.c, fgb.b.b, 3);

   public fgb(int i, int j, fgb.a k, fgb.b l, int m) {
      if (i < 0 || i >= n.length) {
   ...
   public static fgb a(int $$0, int $$1, fgb.a $$2, fgb.b $$3, int $$4) {
      fgb $$5 = new fgb($$0, $$1, $$2, $$3, $$4);
      if (n[$$0] != null) {
   ...
   private boolean a(int $$0, fgb.b $$1) {
      return $$0 == 0 || $$1 == fgb.b.d;
   }
   ...
   public static Stream<fgb> b(int $$0) {
   ...
   public static enum b {
      ...
      private b(final String $$0, final fgb.b.a $$1) {
         this.f = $$0;
         this.g = $$1;
      }
