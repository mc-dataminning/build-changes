...
public class fgb {
   ...
   public static ffy a(ffy $$0) {
      return $$0;
   }

   public static ffy a(ffy $$0, ffy $$1) {
   ...
   static class a implements ffy {
      private final ffy a;
      private final ffy b;

      public a(ffy $$0, ffy $$1) {
         if ($$0 == $$1) {
   ...
   static record b(ffy[] a) implements ffy {
      b(ffy[] a) {
