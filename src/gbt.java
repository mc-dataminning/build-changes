public class gbt extends gcb {
   private static final azg a = azg.a();
   private final gbw b;
   private float F = 1.0F;

   gbt(fxu $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, gbw $$7) {
   ...
   public void a() {
      ...
      if (this.g()) {
         ...
         this.y = ayy.i(0.05F, this.y, this.F);
      }
   }
   ...
   public static class b implements gbe<lb> {
      private final gbw a;
      ...
      public gbb a(lb $$0, fxu $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gbb $$8 = new gbt($$1, $$2, $$3, $$4, $$5, $$6, $$7, this.a);
         $$8.a($$0.b(), $$0.c(), $$0.d());
         $$8.e($$0.e());
         return $$8;
      }
