public class gbt extends gbl<gyh> {
   public static final gew a = gew.scaling(2.35F);
   ...
   private final gen m;
   private final gen n;
   private final gen[] o = new gen[12];
   private final gen[] p;
   ...
   public static get a() {
      ...
      ges $$3 = ges.c().a(0, 0).a(-1.0F, -4.5F, -1.0F, 2.0F, 9.0F, 2.0F);
      ...
      for (int $$4 = 0; $$4 < 12; $$4++) {
         ...
         $$2.a(a($$4), $$3, gep.a($$5, $$6, $$7, $$8, $$9, $$10));
      }

      $$2.a("eye", ges.c().a(8, 0).a(-1.0F, 15.0F, 0.0F, 2.0F, 2.0F, 1.0F), gep.a(0.0F, 0.0F, -8.25F));
      gex $$11 = $$2.a("tail0", ges.c().a(40, 0).a(-2.0F, 14.0F, 7.0F, 4.0F, 4.0F, 8.0F), gep.a);
      gex $$12 = $$11.a("tail1", ges.c().a(0, 54).a(0.0F, 14.0F, 0.0F, 3.0F, 3.0F, 7.0F), gep.a(-1.5F, 0.5F, 14.0F));
      $$12.a("tail2", ges.c().a(41, 32).a(0.0F, 14.0F, 0.0F, 2.0F, 2.0F, 6.0F).a(25, 19).a(1.0F, 10.5F, 3.0F, 1.0F, 9.0F, 9.0F), gep.a(0.5F, 0.5F, 6.0F));
