...
public class fkn {
   ...
   public static void a(File $$0, fdb $$1, Consumer<xj> $$2) {
      a($$0, null, $$1, $$2);
   }

   public static void a(File $$0, @Nullable String $$1, fdb $$2, Consumer<xj> $$3) {
   ...
   private static void b(File $$0, @Nullable String $$1, fdb $$2, Consumer<xj> $$3) {
      fdr $$4 = a($$2);
      ...
      ae.h().execute(() -> {
         try {
            $$4.a($$6);
            xj $$3x = xj.b($$6.getName()).a(n.t).a($$1xx -> $$1xx.a(new xh(xh.a.b, $$6.getAbsolutePath())));
            $$3.accept(xj.a("screenshot.success", $$3x));
         } catch (Exception var7) {
            b.warn("Couldn't save screenshot", var7);
            $$3.accept(xj.a("screenshot.failure", var7.getMessage()));
         } finally {
            $$4.close();
         }
      });
   ...
   public static fdr a(fdb $$0) {
      int $$1 = $$0.c;
      int $$2 = $$0.d;
      fdr $$3 = new fdr($$1, $$2, false);
   ...
   public fkn(File $$0, int $$1, int $$2, int $$3) throws IOException {
      this.f = $$1;
      this.g = $$2;
      this.c = $$3;
