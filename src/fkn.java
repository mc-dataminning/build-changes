...
public class fkn {
   public static List<fly> a(fkn.a... $$0) {
      for (fkn.a $$1 : $$0) {
         a($$1.j);
      }

      List<fly> $$2 = Lists.newArrayList();

      for (fkn.a $$3 : $$0) {
         $$2.add(new fly($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fly::a));
      return $$2;
   }
   ...
   public static List<fly> a() {
      return a(fkn.a.values());
   }
