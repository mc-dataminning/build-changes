...
public class fkn {
   ...
   public fkn(Runnable $$0, Function<arw, ajh> $$1, arz $$2, Consumer<arz> $$3) {
      this.e = $$0;
      this.d = $$1;
      this.a = $$2;
   ...
   public Stream<fkn.a> a() {
      return this.c.stream().map($$0 -> new fkn.d($$0));
   }

   public Stream<fkn.a> b() {
      return this.b.stream().map($$0 -> new fkn.c($$0));
   }
   ...
   abstract class b implements fkn.a {
      private final arw b;
      ...
      @Override
      public ajh a() {
         return fkn.this.d.apply(this.b);
      }
