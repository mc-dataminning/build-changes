...
public class fkn {
   ...
   public static fkq a(BooleanConsumer $$0, BanDetails $$1) {
      return new fkq($$0, a($$1), b($$1), "https://aka.ms/mcjavamoderation", ww.m, true);
   }

   public static fkq a(Runnable $$0) {
   ...
   public static fkq a(String $$0, Runnable $$1) {
