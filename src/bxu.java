   ...
   public void c() {
      ...
      if ($$0 != null) {
         if (this.h > 25) {
            ...
            ehn $$2 = new ehn((double)arw.a(this.a.dB() * (float) (Math.PI / 180.0)), 0.0, (double)(-arw.b(this.a.dB() * (float) (Math.PI / 180.0)))).d();
            float $$3 = (float)$$2.b($$1);
            float $$4 = (float)(Math.acos((double)$$3) * 180.0F / (float)Math.PI) + 0.5F;
            if ($$4 < 0.0F || $$4 > 10.0F) {
               double $$5 = $$0.dq() - this.a.e.dq();
               double $$6 = $$0.dw() - this.a.e.dw();
               double $$7 = arw.a(arw.d(180.0 - arw.d($$5, $$6) * 180.0F / (float)Math.PI - (double)this.a.dB()), -100.0, 100.0);
               this.a.bW *= 0.8F;
