...
public class clc extends bul implements bwg {
   private static final ajy<cwp> c = akc.a(clc.class, aka.h);
   ...
   public clc(bus<? extends clc> $$0, dgi $$1) {
      super($$0, $$1);
      this.b = this.ae.i() * (float) Math.PI * 2.0F;
      this.v(this.ae.i() * 360.0F);
   }

   public clc(dgi $$0, double $$1, double $$2, double $$3, cwp $$4) {
      this($$0, $$1, $$2, $$3, $$4, $$0.A.j() * 0.2 - 0.1, 0.2, $$0.A.j() * 0.2 - 0.1);
   }

   public clc(dgi $$0, double $$1, double $$2, double $$3, cwp $$4, double $$5, double $$6, double $$7) {
      this(bus.aq, $$0);
      this.a_($$1, $$2, $$3);
      this.n($$5, $$6, $$7);
      this.a($$4);
   ...
   private void C() {
      if (this.D()) {
         for (clc $$1 : this.dV().a(clc.class, this.cR().c(0.5, 0.0, 0.5), $$0 -> $$0 != this && $$0.D())) {
            if ($$1.D()) {
               this.a($$1);
               if (this.dQ()) {
                  break;
   ...
   private static void a(clc $$0, cwp $$1, cwp $$2) {
      cwp $$3 = a($$1, $$2, 64);
      $$0.a($$3);
   }

   private static void a(clc $$0, cwp $$1, clc $$2, cwp $$3) {
      a($$0, $$1, $$3);
   ...
   public void a(tq $$0) {
      ...
      if ($$0.b("Item", 10)) {
         tq $$1 = $$0.p("Item");
         this.a(cwp.a(this.dX(), (un)$$1).orElse(cwp.j));
      } else {
         this.a(cwp.j);
      }
   ...
   @Override
   public bvz a_(int $$0) {
      return $$0 == 0 ? bvz.a(this::l, this::a) : super.a_($$0);
   }
}
