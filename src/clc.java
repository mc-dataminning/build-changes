...
public class clc extends bum {
   private static final Logger f = LogUtils.getLogger();
   private dwy g = djp.L.m();
   public int a;
   ...
   public tq c;
   public boolean d;
   protected static final ajy<ji> e = akc.a(clc.class, aka.o);

   public clc(but<? extends clc> $$0, dgj $$1) {
      super($$0, $$1);
   }

   private clc(dgj $$0, double $$1, double $$2, double $$3, dwy $$4) {
      this(but.X, $$0);
      this.g = $$4;
      this.I = true;
      this.a_($$1, $$2, $$3);
   ...
   public static clc a(dgj $$0, ji $$1, dwy $$2) {
      clc $$3 = new clc($$0, (double)$$1.u() + 0.5, (double)$$1.v(), (double)$$1.w() + 0.5, $$2.b(dxo.J) ? $$2.b(dxo.J, Boolean.valueOf(false)) : $$2);
      $$0.a($$1, $$2.y().g(), 3);
      $$0.b($$3);
      return $$3;
   }
   ...
   public void h() {
      if (this.g.l()) {
         ...
         if (this.dV() instanceof ard $$1 && (this.bL() || this.d)) {
            ji $$2 = this.dv();
            boolean $$3 = this.g.b() instanceof dkz;
            boolean $$4 = $$3 && this.dV().b_($$2).a(awv.a);
            double $$5 = this.dy().h();
            if ($$3 && $$5 > 1.0) {
               fax $$6 = this.dV().a(new dfr(new fbb(this.K, this.L, this.M), this.dt(), dfr.a.a, dfr.b.b, this));
               if ($$6.d() != faz.a.a && this.dV().b_($$6.b()).a(awv.a)) {
                  $$2 = $$6.b();
                  $$4 = true;
               }
            }
            ...
            if (!this.aJ() && !$$4) {
               ...
               if (!$$7.a(djp.bX)) {
                  if (!this.h) {
                     boolean $$8 = $$7.a(new dai(this.dV(), $$2, jn.a, cwq.j, jn.b));
                     boolean $$9 = dmk.n(this.dV().a_($$2.e())) && (!$$3 || !$$4);
                     boolean $$10 = this.g.a((dgm)this.dV(), $$2) && !$$9;
                     if ($$8 && $$10) {
                        if (this.g.b(dxo.J) && this.dV().b_($$2).a() == etb.c) {
                           this.g = this.g.b(dxo.J, Boolean.valueOf(true));
                        }
                        ...
                        if (this.dV().a($$2, this.g, 3)) {
                           ...
                           this.at();
                           if ($$0 instanceof dmj) {
                              ((dmj)$$0).a(this.dV(), $$2, this.g, $$7, this);
                           }
   ...
   public boolean a(float $$0, float $$1, btc $$2) {
      if (!this.i) {
         ...
         if ($$3 < 0) {
            ...
            Predicate<bum> $$4 = bur.e.and(bur.b);
            btc $$6 = this.g.b() instanceof dmj $$5 ? $$5.a(this) : this.dW().a(this);
   ...
   public yw<abl> a(arb $$0) {
      return new abm(this, $$0, djn.j(this.p()));
   }
