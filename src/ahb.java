...
public class ahb implements yw<agf> {
   public static final yn<vl, ahb> a = yw.a(ahb::a, ahb::new);
   private final int b;
   ...
   public static ahb a(bva $$0, boolean $$1) {
      return new ahb($$0.ar(), $$1, e);
   }

   public static ahb a(bva $$0, boolean $$1, bsx $$2) {
      return new ahb($$0.ar(), $$1, new ahb.d($$2));
   }

   public static ahb a(bva $$0, boolean $$1, bsx $$2, fbx $$3) {
