...
public class ftd<T extends cdg> extends fqd<T> {
   ...
   public static ftu a(ftq $$0) {
      ...
      ftv $$2 = $$1.a();
      float $$3 = 13.5F;
      ftv $$4 = $$2.a("head", ftr.c(), fto.a(-1.0F, 13.5F, -7.0F));
      $$4.a(
         "real_head",
         ftr.c()
            .a(0, 0)
      ...
      $$2.a("body", ftr.c().a(18, 14).a(-3.0F, -2.0F, -3.0F, 6.0F, 9.0F, 6.0F, $$0), fto.a(0.0F, 14.0F, 2.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      $$2.a("upper_body", ftr.c().a(21, 0).a(-3.0F, -3.0F, -3.0F, 8.0F, 6.0F, 7.0F, $$0), fto.a(-1.0F, 14.0F, -3.0F, (float) (Math.PI / 2), 0.0F, 0.0F));
      ftr $$5 = ftr.c().a(0, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0);
      $$2.a("right_hind_leg", $$5, fto.a(-2.5F, 16.0F, 7.0F));
      $$2.a("left_hind_leg", $$5, fto.a(0.5F, 16.0F, 7.0F));
      $$2.a("right_front_leg", $$5, fto.a(-2.5F, 16.0F, -4.0F));
      $$2.a("left_front_leg", $$5, fto.a(0.5F, 16.0F, -4.0F));
      ftv $$6 = $$2.a("tail", ftr.c(), fto.a(-1.0F, 12.0F, 8.0F, (float) (Math.PI / 5), 0.0F, 0.0F));
      $$6.a("real_tail", ftr.c().a(9, 18).a(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 2.0F, $$0), fto.a);
      return $$1;
   }
   ...
   public void a(T $$0, float $$1, float $$2, float $$3) {
      if ($$0.Y_()) {
         ...
         this.n.f = axk.b($$1 * 0.6662F) * 1.4F * $$2;
      }
      ...
      if ($$0.y()) {
         ...
         this.j.e = axk.b($$1 * 0.6662F) * 1.4F * $$2;
         this.k.e = axk.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.l.e = axk.b($$1 * 0.6662F + (float) Math.PI) * 1.4F * $$2;
         this.m.e = axk.b($$1 * 0.6662F) * 1.4F * $$2;
      }
