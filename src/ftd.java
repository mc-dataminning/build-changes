...
public class ftd {
   ...
   private static final wo e = wo.a("gui.banned.skin.description", wo.a(axu.n));

   public static ftf a(BooleanConsumer $$0, BanDetails $$1) {
      return new ftf($$0, a($$1), b($$1), axu.n, wn.m, true);
   }

   public static ftf a(Runnable $$0) {
      URI $$1 = axu.n;
      return new ftf($$2 -> {
         if ($$2) {
            af.m().a($$1);
   ...
   public static ftf a(String $$0, Runnable $$1) {
      URI $$2 = axu.n;
      return new ftf($$2x -> {
         if ($$2x) {
            af.m().a($$2);
         ...
         $$1.run();
      }, a, wo.a("gui.banned.name.description", wo.b($$0).a(n.o), wo.a(axu.n)), $$2, wn.m, true);
   }
   ...
   private static wo b(BanDetails $$0) {
      return wo.a("gui.banned.description", c($$0), d($$0), wo.a(axu.n));
   }
