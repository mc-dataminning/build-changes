...
public class ftd extends ful {
   ...
   @Nullable
   private fpe z;
   private final fsh A = new fsh(this, this.m(), 33);

   public ftd(fln $$0, Runnable $$1) {
      super(a);
      this.u = $$0;
      this.y = $$1;
      this.s = new fpk(true);
   ...
   @Override
   public void aR_() {
      fsl $$0 = this.A.c(fsl.d());
      $$0.c().b().a(4);
      this.z = $$0.a(new fpe(this.n, this.l, this.p), $$0x -> $$0x.a(8));
      if (this.u.av().a(this.u) instanceof fpa $$1) {
         this.q = $$1;
         this.q.j = this.v;
         $$0.a(this.q);
      }

      $$0.a(fox.b(150, $$0x -> this.a(new fxi(this, this.m.n)), false));
      $$0.a(fox.a(150, $$0x -> this.a(new fxl(this, this.m.n, this.m.ah())), false));
      this.A.b(fot.a(wo.j, $$0x -> this.aO_()).a());
      this.A.a(this::c);
      this.c();
   }
