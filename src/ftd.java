...
public class ftd {
   private static final ftp a = ftp.t(new ahg("textures/map/map_background.png"));
   private static final ftp b = ftp.t(new ahg("textures/map/map_background_checkerboard.png"));
   ...
   private final evi au;
   private cmy av = cmy.f;
   private cmy aw = cmy.f;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final fyl aB;
   private final fzl aC;

   public ftd(evi $$0, fyl $$1, fzl $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(bml $$0, cmy $$1, cmv $$2, boolean $$3, eqb $$4, fth $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dM(), $$6, gee.d, $$0.aj() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = auo.a($$1, 0.0F, 1.0F);
      return -auo.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(eqb $$0, fth $$1, int $$2, bmf $$3) {
      gdq $$4 = (gdq)this.aB.<fsg>a(this.au.s);
      $$0.a();
      float $$5 = $$3 == bmf.b ? 1.0F : -1.0F;
   ...
   private void a(eqb $$0, fth $$1, int $$2, float $$3, bmf $$4, float $$5, cmy $$6) {
      float $$7 = $$4 == bmf.b ? 1.0F : -1.0F;
      ...
      float $$8 = auo.c($$5);
      float $$9 = auo.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * auo.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * auo.a($$5 * (float) Math.PI);
   ...
   private void a(eqb $$0, fth $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = auo.c($$5);
      float $$7 = -0.2F * auo.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * auo.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = auo.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.av);
   }

   private void a(eqb $$0, fth $$1, int $$2, cmy $$3) {
      ...
      Integer $$4 = cnf.d($$3);
      egb $$5 = cnf.a($$4, this.au.r);
      eqf $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(eqb $$0, fth $$1, int $$2, float $$3, float $$4, bmf $$5) {
      boolean $$6 = $$5 != bmf.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = auo.c($$4);
      float $$9 = -0.3F * auo.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * auo.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * auo.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = auo.a($$4 * $$4 * (float) Math.PI);
      float $$13 = auo.a($$8 * (float) Math.PI);
   ...
   private void a(eqb $$0, float $$1, bmf $$2, cmy $$3) {
      float $$4 = (float)this.au.s.fq() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.r();
      if ($$5 < 0.8F) {
         float $$6 = auo.e(auo.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(eqb $$0, float $$1, bmf $$2, cmy $$3, float $$4) {
      this.b($$0, $$2, $$4);
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * auo.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != bmf.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(eqb $$0, bmf $$1, float $$2) {
      int $$3 = $$1 == bmf.b ? 1 : -1;
      float $$4 = auo.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = auo.a(auo.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(eqb $$0, bmf $$1, float $$2) {
      int $$3 = $$1 == bmf.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, eqb $$1, fth.a $$2, fsj $$3, int $$4) {
      float $$5 = $$3.x($$0);
      bka $$6 = (bka)MoreObjects.firstNonNull($$3.aG, bka.a);
      float $$7 = auo.i($$0, $$3.O, $$3.dE());
      ftd.a $$8 = a($$3);
      float $$9 = auo.i($$0, $$3.cu, $$3.cs);
      float $$10 = auo.i($$0, $$3.ct, $$3.cr);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bka.a ? $$5 : 0.0F;
         float $$12 = 1.0F - auo.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bka.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bka.b ? $$5 : 0.0F;
         float $$14 = 1.0F - auo.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bka.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static ftd.a a(fsj $$0) {
      cmy $$1 = $$0.eT();
      cmy $$2 = $$0.eU();
      boolean $$3 = $$1.a(cnb.or) || $$2.a(cnb.or);
      boolean $$4 = $$1.a(cnb.vM) || $$2.a(cnb.vM);
      if (!$$3 && !$$4) {
         return ftd.a.a;
      } else if ($$0.fn()) {
         return b($$0);
      } else {
         return a($$1) ? ftd.a.b : ftd.a.a;
      }
   }

   private static ftd.a b(fsj $$0) {
      cmy $$1 = $$0.fp();
      bka $$2 = $$0.fo();
      if (!$$1.a(cnb.or) && !$$1.a(cnb.vM)) {
         return $$2 == bka.a && a($$0.eU()) ? ftd.a.b : ftd.a.a;
      } else {
         return ftd.a.a($$2);
      }
   }
   ...
   private static boolean a(cmy $$0) {
      return $$0.a(cnb.vM) && clg.d($$0);
   }

   private void a(fsg $$0, float $$1, float $$2, bka $$3, float $$4, cmy $$5, float $$6, eqb $$7, fth $$8, int $$9) {
      if (!$$0.gq()) {
         boolean $$10 = $$3 == bka.a;
         bmf $$11 = $$10 ? $$0.fm() : $$0.fm().e();
         $$7.a();
         if ($$5.b()) {
            if ($$10 && !$$0.ce()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fn() && $$0.fq() > 0 && $$0.fo() == $$3) {
               ...
               float $$16 = $$15 / (float)clg.k($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = auo.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * auo.a(auo.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * auo.a(auo.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * auo.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cmv.e : cmv.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == bmf.b;
            if ($$0.fn() && $$0.fq() > 0 && $$0.fo() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               ...
               float $$36 = -0.4F * auo.a(auo.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * auo.a(auo.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * auo.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cmv.e : cmv.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.A()) {
         this.ax = auo.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = auo.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.B(1.0F);
         this.ax = this.ax + auo.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + auo.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
