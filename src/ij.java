...
public class ij {
   ...
   private static <A extends ArgumentType<?>> void a(JsonObject $$0, ih.a<A> $$1) {
      a($$0, $$1.a(), $$1);
   }

   private static <A extends ArgumentType<?>, T extends ih.a<A>> void a(JsonObject $$0, ih<A, T> $$1, ih.a<A> $$2) {
      $$1.a((T)$$2, $$0);
   }
   ...
   private static <T extends ArgumentType<?>> void a(JsonObject $$0, T $$1) {
      ...
      $$0.addProperty("parser", mh.u.b($$2.a()).toString());
