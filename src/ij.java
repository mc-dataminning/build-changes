...
public interface ij<T> {
   ...
   il<T> a(@Nullable uj var1, CommandDispatcher<T> var2) throws ey;
   ...
   static <T extends ex<T>> ij<T> a(alh $$0, CommandDispatcher<T> $$1, T $$2, List<String> $$3) {
      ik<T> $$4 = new ik<>();
   ...
   static <T extends ex<T>> hz<T> a(CommandDispatcher<T> $$0, T $$1, StringReader $$2) throws CommandSyntaxException {
      ...
      if ($$4.isEmpty()) {
         ...
         return new ib.c<>($$2.getString(), $$4.get());
      }
   }
}
