...
public class aga {
   ...
   public aga(String $$0, int $$1, MinecraftServer $$2) {
      this.c = $$0;
      this.d = $$1;
      this.e = $$2;
   }
   ...
   private Optional<aga.a> b(Scanner $$0) {
      aey<cqb> $$1 = (aey<cqb>)agj.a.get($$0.next());
      if ($$1 == null) {
         ...
         float $$5 = $$0.nextFloat();
         float $$6 = $$0.nextFloat();
         return Optional.of(new aga.a($$1, new ehh((double)$$2, (double)$$3, (double)$$4), new ehg($$6, $$5)));
      }
   }

   private void b(String $$0) {
      this.e.execute(() -> {
         List<aku> $$1 = this.e.ac().t();
         if (!$$1.isEmpty()) {
            aku $$2 = $$1.get(0);
            akt $$3 = this.e.D();
            dt $$4 = new dt($$2, ehh.a($$3.R()), ehg.a, $$3, 4, "", tk.a, this.e, $$2);
            du $$5 = this.e.aC();
            $$5.a($$4, $$0);
         }
      });
   ...
   static record a(aey<cqb> a, ehh b, ehg c) {
   }
}
