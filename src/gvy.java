...
public abstract class gvy<T extends bwd, S extends hcf> {
   protected static final float b = 0.025F;
   public static final int c = 24;
   protected final gvx d;
   private final frm a;
   protected float e;
   protected float f = 1.0F;
   private final S g = this.d();

   protected gvy(gvz.a $$0) {
      this.d = $$0.a();
      this.a = $$0.j();
   }
   ...
   public final int a(T $$0, float $$1) {
      iu $$2 = iu.a((jo)$$0.o($$1));
      return gpp.a(this.a($$0, $$2), this.b($$0, $$2));
   }

   protected int b(T $$0, iu $$1) {
      return $$0.dV().a(dje.a, $$1);
   }

   protected int a(T $$0, iu $$1) {
      return $$0.bY() ? 15 : $$0.dV().a(dje.b, $$1);
   }

   public boolean a(T $$0, gtl $$1, double $$2, double $$3, double $$4) {
      if (!$$0.k($$2, $$3, $$4)) {
         return false;
      } else if (!this.b($$0)) {
         return true;
      } else {
         fed $$5 = this.a($$0).g(0.5);
         if ($$5.e() || $$5.a() == 0.0) {
            $$5 = new fed($$0.dA() - 2.0, $$0.dC() - 2.0, $$0.dG() - 2.0, $$0.dA() + 2.0, $$0.dC() + 2.0, $$0.dG() + 2.0);
         }

         if ($$1.a($$5)) {
            return true;
         } else {
            if ($$0 instanceof bxa $$6) {
               bwd $$7 = $$6.C();
               if ($$7 != null) {
   ...
   private static void a(fjc $$0, gps $$1, hcf.a $$2) {
      float $$3 = 0.025F;
   ...
   protected void a(S $$0, wy $$1, fjc $$2, gps $$3, int $$4) {
      fei $$5 = $$0.E;
      if ($$5 != null) {
         boolean $$6 = !$$0.A;
         ...
         int $$11 = (int)(fos.Q().n.a(0.25F) * 255.0F) << 24;
         $$9.a($$1, $$10, (float)$$7, -2130706433, false, $$8, $$3, $$6 ? frm.a.b : frm.a.a, $$11, $$4);
         if ($$6) {
            $$9.a($$1, $$10, (float)$$7, -1, false, $$8, $$3, frm.a.a, 0, gpp.b($$4, 2));
         }
   ...
   public void a(T $$0, S $$1, float $$2) {
      $$1.r = azm.d((double)$$2, $$0.aa, $$0.dA());
      $$1.s = azm.d((double)$$2, $$0.ab, $$0.dC());
      $$1.t = azm.d((double)$$2, $$0.ac, $$0.dG());
      $$1.z = $$0.cp();
      $$1.u = (float)$$0.af + $$2;
      $$1.v = $$0.dq();
      $$1.w = $$0.dr();
      $$1.x = $$0.cS();
      if ($$0.bZ() && $$0.dk() instanceof ctk $$3 && $$3.f() instanceof ctz $$4 && $$4.o()) {
         double $$5 = azm.d((double)$$2, $$3.aa, $$3.dA());
         double $$6 = azm.d((double)$$2, $$3.ab, $$3.dC());
         double $$7 = azm.d((double)$$2, $$3.ac, $$3.dG());
         $$1.C = $$4.e($$2).d(new fei($$5, $$6, $$7));
      } else {
         $$1.C = null;
      }
      ...
      if ($$8) {
         $$1.D = this.c($$0);
         $$1.E = $$0.ds().a(bwe.c, 0, $$0.l($$2));
      } else {
         $$1.D = null;
      }

      $$1.A = $$0.cg();
      bwd $$10 = $$0 instanceof bxa $$9 ? $$9.C() : null;
      if ($$10 != null) {
         ...
         $$15.f = $$0.dV().a(dje.a, $$13);
         $$15.g = $$0.dV().a(dje.a, $$14);
      } else {
         $$1.F = null;
      }
