...
public class gvy implements gwf.a {
   ...
   private final frf w;
   private final Map<iw, gvy.a> x = new HashMap<>();
   private final Map<UUID, aai.a> y = new HashMap<>();
   @Nullable
   private UUID z;
   ...
   private void b(flq $$0, gsc $$1) {
      ...
      $$2.forEach(($$2x, $$3) -> {
         Set<String> $$4 = $$3.stream().map(agp::a).collect(Collectors.toSet());
         int $$5 = 1;
         a($$0, $$1, $$4.toString(), $$2x, $$5++, -256);
         a($$0, $$1, "Flower", $$2x, $$5++, -1);
         float $$6 = 0.05F;
         gwf.a($$0, $$1, $$2x, 0.05F, 0.8F, 0.8F, 0.0F, 0.3F);
      });
   }
   ...
   private static String a(Collection<UUID> $$0) {
      if ($$0.isEmpty()) {
         ...
         return $$0.size() > 3 ? $$0.size() + " bees" : $$0.stream().map(agp::a).collect(Collectors.toSet()).toString();
      }
   }

   private static void a(flq $$0, gsc $$1, iw $$2) {
      float $$3 = 0.05F;
      gwf.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(flq $$0, gsc $$1, iw $$2, List<String> $$3) {
      float $$4 = 0.05F;
      gwf.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(flq $$0, gsc $$1, aat.a $$2, Collection<UUID> $$3) {
      int $$4 = 0;
      if (!$$3.isEmpty()) {
   ...
   private void a(flq $$0, gsc $$1, aai.a $$2) {
      if ($$2.e() != null) {
         gwo.a($$0, $$1, $$2.e(), 0.5F, false, false, this.e().b().a(), this.e().b().b(), this.e().b().c());
      }
   }

   private void b(flq $$0, gsc $$1, aai.a $$2) {
      boolean $$3 = this.b($$2);
      int $$4 = 0;
   ...
   private static void a(flq $$0, gsc $$1, String $$2, aat.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a(), $$4, $$5);
   }

   private static void a(flq $$0, gsc $$1, String $$2, iw $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      gwf.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(flq $$0, gsc $$1, jq $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      iw $$9 = iw.a($$2);
      ...
      float $$13 = 0.5F;
      gwf.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }
   ...
   private Set<String> a(aat.a $$0) {
      return this.a($$0.a()).stream().map(agp::a).collect(Collectors.toSet());
   }

   private String a(aai.a $$0, iw $$1) {
   ...
   private Collection<UUID> a(iw $$0) {
      return this.y.values().stream().filter($$1 -> $$1.a($$0)).map(aai.a::b).collect(Collectors.toSet());
   }

   private Map<iw, List<String>> f() {
      Map<iw, List<String>> $$0 = Maps.newHashMap();

      for (aai.a $$1 : this.y.values()) {
   ...
   private void g() {
      gwf.a(this.w.ao(), 8).ifPresent($$0 -> this.z = $$0.cG());
   }
