...
class asp extends FileSystemProvider {
   ...
   public boolean isSameFile(Path $$0, Path $$1) {
      return $$0 instanceof aso && $$1 instanceof aso && $$0.equals($$1);
   }
   ...
   private static aso a(@Nullable Path $$0) {
      if ($$0 == null) {
         throw new NullPointerException();
      } else if ($$0 instanceof aso) {
         return (aso)$$0;
      } else {
