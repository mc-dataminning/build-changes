...
public class awj extends awh {
   ...
   public int a(Collection<daj<?>> $$0, ari $$1) {
      List<alc> $$2 = Lists.newArrayList();
      int $$3 = 0;
   ...
   public int b(Collection<daj<?>> $$0, ari $$1) {
      List<alc> $$2 = Lists.newArrayList();
      int $$3 = 0;
   ...
   private void a(aek.a $$0, ari $$1, List<alc> $$2) {
   ...
   private void a(ul $$0, Consumer<daj<?>> $$1, dal $$2) {
      for (int $$3 = 0; $$3 < $$0.size(); $$3++) {
         String $$4 = $$0.j($$3);

         try {
            alc $$5 = alc.a($$4);
            Optional<daj<?>> $$6 = $$2.a($$5);
            if ($$6.isEmpty()) {
