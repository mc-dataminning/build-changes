...
public class awj extends ath {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped("EntityUUIDFixes", this.getInputSchema().getType(this.a), $$0 -> {
         $$0 = $$0.update(DSL.remainderFinder(), awj::c);
         ...
         $$0 = this.a($$0, "minecraft:bee", awj::k);
         $$0 = this.a($$0, "minecraft:zombified_piglin", awj::k);
         $$0 = this.a($$0, "minecraft:fox", awj::j);
         $$0 = this.a($$0, "minecraft:item", awj::i);
         $$0 = this.a($$0, "minecraft:shulker_bullet", awj::h);
         $$0 = this.a($$0, "minecraft:area_effect_cloud", awj::g);
         $$0 = this.a($$0, "minecraft:zombie_villager", awj::f);
         $$0 = this.a($$0, "minecraft:evoker_fangs", awj::e);
         return this.a($$0, "minecraft:piglin", awj::d);
      });
   }
