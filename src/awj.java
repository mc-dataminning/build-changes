...
public class awj<K> implements is<K> {
   ...
   private awj(K[] $$0, int[] $$1, K[] $$2, int $$3, int $$4) {
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static <A> awj<A> c(int $$0) {
      return new awj((int)((float)$$0 / 0.8F));
   }
   ...
   private int e(@Nullable K $$0) {
      return (axm.g(System.identityHashCode($$0)) & 2147483647) % this.e.length;
   }
   ...
   public awj<K> c() {
      return new awj<>((K[])((Object[])this.e.clone()), (int[])this.f.clone(), (K[])((Object[])this.g.clone()), this.h, this.i);
   }
}
