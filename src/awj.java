...
public class awj extends awo {
   private static final Logger b = LogUtils.getLogger();
   private final MinecraftServer c;
   private final File d;
   private final Set<awk<?>> e = Sets.newHashSet();

   public awj(MinecraftServer $$0, File $$1) {
      this.c = $$0;
      this.d = $$1;
      if ($$1.isFile()) {
         try {
   ...
   private Set<awk<?>> d() {
      Set<awk<?>> $$0 = Sets.newHashSet(this.e);
      this.e.clear();
      return $$0;
   }
      ...
      try {
         ...
         label47: {
            try {
               ...
               if (!$$3.isJsonNull()) {
                  uf $$4 = a($$3.getAsJsonObject());
                  $$4 = bal.g.a($$0, $$4, uu.b($$4, 1343));
                  if (!$$4.b("stats", 10)) {
                     break label47;
                  }
   ...
   private <T> Optional<awk<T>> a(awm<T> $$0, String $$1) {
      return Optional.ofNullable(alb.c($$1)).flatMap($$0.b()::b).map($$0::b);
   }

   private static uf a(JsonObject $$0) {
      uf $$1 = new uf();
   ...
   protected String b() {
      Map<awm<?>, JsonObject> $$0 = Maps.newHashMap();
      ObjectIterator $$3 = this.a.object2IntEntrySet().iterator();

      while ($$3.hasNext()) {
         it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awk<?>> $$1 = (it.unimi.dsi.fastutil.objects.Object2IntMap.Entry<awk<?>>)$$3.next();
         awk<?> $$2 = (awk<?>)$$1.getKey();
      ...
      for (Entry<awm<?>, JsonObject> $$4 : $$0.entrySet()) {
         $$3x.add(lu.v.b($$4.getKey()).toString(), (JsonElement)$$4.getValue());
      }
   ...
   private static <T> alb b(awk<T> $$0) {
      return $$0.a().b().b($$0.b());
   }
   ...
   public void a(arh $$0) {
      Object2IntMap<awk<?>> $$1 = new Object2IntOpenHashMap();
