...
public class awj extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.a(this.getOutputSchema().getTypeRaw(ayp.F));
   }
   ...
   private <R> TypeRewriteRule a(Type<R> $$0) {
      ...
      OpticFinder<?> $$2 = DSL.namedChoice("minecraft:furnace", this.getInputSchema().getChoiceType(ayp.s, "minecraft:furnace"));
      OpticFinder<?> $$3 = DSL.namedChoice("minecraft:blast_furnace", this.getInputSchema().getChoiceType(ayp.s, "minecraft:blast_furnace"));
      OpticFinder<?> $$4 = DSL.namedChoice("minecraft:smoker", this.getInputSchema().getChoiceType(ayp.s, "minecraft:smoker"));
      Type<?> $$5 = this.getOutputSchema().getChoiceType(ayp.s, "minecraft:furnace");
      Type<?> $$6 = this.getOutputSchema().getChoiceType(ayp.s, "minecraft:blast_furnace");
      Type<?> $$7 = this.getOutputSchema().getChoiceType(ayp.s, "minecraft:smoker");
      Type<?> $$8 = this.getInputSchema().getType(ayp.s);
      Type<?> $$9 = this.getOutputSchema().getType(ayp.s);
