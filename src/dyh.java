public class dyh implements dbn {
   private int a;
   ...
   private boolean a(arf $$0, iz $$1, azh $$2, boolean $$3) {
      dse $$4 = $$0.a_($$1);
      if (!dcl.a($$0, $$1, $$4, $$4.u(), btc.aC)) {
         return false;
      } else if (!ckg.b(btc.aC, $$0, btv.p, $$1, $$2)) {
         return false;
      } else {
         ckg $$5 = btc.aC.a((dca)$$0);
         if ($$5 != null) {
            if ($$3) {
               $$5.w(true);
               $$5.gy();
