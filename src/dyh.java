...
public class dyh {
   private static final drx a = dew.hj.n();
   private static final drx b = dew.hk.n();
   private static final drx c = dew.iA.n();
   private static final drx d = dew.hn.n();
   private static final drx e = dew.hv.n();
   private static final drx f = dew.hx.n();
   private static final drx g = dew.hr.n();
   private static final drx h = dew.iC.n();
   private static final drx i = dew.dP.n();
   private final drx j;
   private final int k;
   private final drx[] l;
   private final emt m;
   ...
   public dyh(dyd $$0, drx $$1, int $$2, dyc $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dxy.P);
      this.l = a($$3.a(new alb("clay_bands")));
      this.u = $$0.a(dxy.N);
      this.v = $$0.a(dxy.O);
      this.n = $$0.a(dxy.Q);
      this.o = $$0.a(dxy.R);
   ...
   public void a(dyd $$0, dcu $$1, jv<dcs> $$2, boolean $$3, dym $$4, final dtt $$5, dxt $$6, dyg.o $$7) {
      ...
      dyg.g $$13 = new dyg.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dyg.u $$14 = $$7.apply($$13);
      iz.a $$15 = new iz.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dxp.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            ji<dcs> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dcz.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dxp.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<drx> a(dyg.o $$0, dzp $$1, Function<iz, ji<dcs>> $$2, dtt $$3, dxt $$4, iz $$5, boolean $$6) {
      dyg.g $$7 = new dyg.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(lq.az), $$1);
      dyg.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      drx $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dtq $$0, int $$1, int $$2, int $$3, dbv $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dcs $$1, dtq $$2, iz.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dew.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(azc $$0, drx[] $$1, int $$2, drx $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected drx a(int $$0, int $$1, int $$2) {
