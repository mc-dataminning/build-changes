...
public class brm extends brg {
   public static final MapCodec<brm> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static brm a(float $$0, float $$1, float $$2) {
      return new brm($$0, $$1, $$2);
   }

   private brm(float $$0, float $$1, float $$2) {
      this.b = $$0;
      this.d = $$1;
      this.e = $$2;
   }
