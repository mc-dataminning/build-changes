...
public record eee(eee.a a, byte b, byte c, byte d, @Nullable uv e) {
   public byte a() {
      return this.a.a();
   }
   ...
   public static enum a implements auk {
      ...
      A("red_x", true, false),
      B("village_desert", true, edb.w.ak, false, true),
      C("village_plains", true, edb.w.ak, false, true),
      D("village_savanna", true, edb.w.ak, false, true),
      E("village_snowy", true, edb.w.ak, false, true),
      F("village_taiga", true, edb.w.ak, false, true),
      G("jungle_temple", true, edb.w.ak, false, true),
      H("swamp_hut", true, edb.w.ak, false, true);

      public static final Codec<eee.a> I = auk.a(eee.a::values);
      ...
      public static eee.a a(byte $$0) {
         return values()[atq.a($$0, 0, values().length - 1)];
      }
