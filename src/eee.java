...
public class eee extends eeb {
   public static final MapCodec<eee> d = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public eee(int $$0, int $$1, int $$2) {
      this($$0, $$1, $$2, OptionalInt.empty());
   }

   public eee(int $$0, int $$1, int $$2, OptionalInt $$3) {
      super($$3);
      this.e = $$0;
      this.f = $$1;
      this.g = $$2;
