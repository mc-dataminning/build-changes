...
public class yb {
   ...
   public static final akt b = new akt("minecraft", "default");
   @Nullable
   final yd c;
   @Nullable
   final Boolean d;
   ...
   public static class b {
      public static final MapCodec<yb> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
                  axu.a(yd.a, "color").forGetter($$0x -> Optional.ofNullable($$0x.c)),
                  axu.a(Codec.BOOL, "bold").forGetter($$0x -> Optional.ofNullable($$0x.d)),
                  axu.a(Codec.BOOL, "italic").forGetter($$0x -> Optional.ofNullable($$0x.e)),
                  axu.a(Codec.BOOL, "underlined").forGetter($$0x -> Optional.ofNullable($$0x.f)),
                  axu.a(Codec.BOOL, "strikethrough").forGetter($$0x -> Optional.ofNullable($$0x.g)),
                  axu.a(Codec.BOOL, "obfuscated").forGetter($$0x -> Optional.ofNullable($$0x.h)),
                  axu.a(xc.a, "clickEvent").forGetter($$0x -> Optional.ofNullable($$0x.i)),
                  axu.a(xk.a, "hoverEvent").forGetter($$0x -> Optional.ofNullable($$0x.j)),
                  axu.a(Codec.STRING, "insertion").forGetter($$0x -> Optional.ofNullable($$0x.k)),
                  axu.a(akt.a, "font").forGetter($$0x -> Optional.ofNullable($$0x.l))
               )
               .apply($$0, yb::a)
      );
