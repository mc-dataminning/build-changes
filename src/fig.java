...
public class fig implements fiw {
   ...
   private CompletableFuture<Optional<cbo>> g;
   private Instant h = Instant.EPOCH;

   public fig(UserApiService $$0, UUID $$1, Path $$2) {
      this.e = $$0;
      this.f = $$2.resolve(d).resolve($$1 + ".json");
      this.g = CompletableFuture.<Optional<cbo>>supplyAsync(() -> this.c().filter($$0x -> !$$0x.c().b().a()), ac.f()).thenCompose(this::a);
   }
   ...
   @Override
   public boolean b() {
      return this.g.isDone() && Instant.now().isAfter(this.h) ? this.g.join().<Boolean>map(cbo::a).orElse(true) : false;
   }

   private CompletableFuture<Optional<cbo>> a(Optional<cbo> $$0) {
      ...
      if (Files.notExists(this.f)) {
         ...
         try {
            ...
            try (BufferedReader $$0 = Files.newBufferedReader(this.f)) {
               var2 = cbo.a.parse(JsonOps.INSTANCE, JsonParser.parseReader($$0)).result();
            }
   ...
   private void a(@Nullable cbo $$0) {
      ...
      if ($$0 != null) {
         if (aa.aS) {
            cbo.a.encodeStart(JsonOps.INSTANCE, $$0).result().ifPresent($$0x -> {
               try {
   ...
   private cbo a(UserApiService $$0) throws aqq, IOException {
      KeyPairResponse $$1 = $$0.getKeyPair();
      if ($$1 != null) {
         cbp.a $$2 = a($$1);
         return new cbo(aqp.a($$1.keyPair().privateKey()), new cbp($$2), Instant.parse($$1.refreshedAfter()));
      } else {
         throw new IOException("Could not retrieve profile key pair");
      }
   }

   private static cbp.a a(KeyPairResponse $$0) throws aqq {
      KeyPair $$1 = $$0.keyPair();
