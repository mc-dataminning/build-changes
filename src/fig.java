...
public class fig extends fhy<clv> implements fkb {
   private float x;
   private float y;
   private final fjv z = new fjv();
   private boolean A;
   private boolean B;

   public fig(cia $$0) {
      super($$0.bW, $$0.fV(), vs.c("container.crafting"));
      this.l = 97;
   }
   ...
   public void E() {
      if (this.f.q.f()) {
         this.f.a(new fhv(this.f.s, this.f.s.cr.y(), this.f.m.G().c()));
      } else {
         this.z.g();
      }
   }
   ...
   protected void aP_() {
      if (this.f.q.f()) {
         ...
         this.c(new faw(this.t + 104, this.h / 2 - 22, 20, 18, fjv.a, $$0 -> {
            this.z.e();
            this.t = this.z.a(this.g, this.c);
   ...
   public static void a(ezx $$0, int $$1, int $$2, int $$3, int $$4, int $$5, float $$6, float $$7, float $$8, box $$9) {
      ...
      $$9.aY = $$9.dz();
      float $$21 = $$9.dY();
      Vector3f $$22 = new Vector3f(0.0F, $$9.de() / 2.0F + $$6 * $$21, 0.0F);
      float $$23 = (float)$$5 / $$21;
   ...
   public static void a(ezx $$0, float $$1, float $$2, float $$3, Vector3f $$4, Quaternionf $$5, @Nullable Quaternionf $$6, box $$7) {
      $$0.c().a();
