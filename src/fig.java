...
public class fig {
   ...
   private static final Comparator<fyh> p = Comparator.<fyh>comparingInt($$0 -> $$0.e() == dbw.d ? 1 : 0)
      .thenComparing($$0 -> x.a($$0.h(), ewr::b, ""))
   ...
   private xp t;
   private boolean u;
   private final Map<UUID, fig.a> v = new Object2ObjectOpenHashMap();

   public fig(ffg $$0, fgr $$1) {
      this.q = $$0;
      this.r = $$1;
   }

   public xp a(fyh $$0) {
      return $$0.i() != null ? this.a($$0, $$0.i().f()) : this.a($$0, ewr.a($$0.h(), xp.b($$0.a().getName())));
   }

   private xp a(fyh $$0, yd $$1) {
      return $$0.e() == dbw.d ? $$1.a(n.u) : $$1;
   }
   ...
   public void a(fgs $$0, int $$1, eww $$2, @Nullable ewo $$3) {
      List<fyh> $$4 = this.b();
      List<fig.b> $$5 = new ArrayList<>($$4.size());
      int $$6 = this.q.h.b(" ");
      int $$7 = 0;
      int $$8 = 0;
      ...
      for (int $$36 = 0; $$36 < $$18; $$36++) {
         ...
         if ($$36 < $$4.size()) {
            ...
            GameProfile $$43 = $$41.a();
            if ($$21) {
               cmy $$44 = this.q.r.b($$43.getId());
               boolean $$45 = $$44 != null && gjz.e($$44);
               boolean $$46 = $$44 != null && $$44.a(cmz.g);
               fie.a($$0, $$41.g().a(), $$39, $$40, 8, $$46, $$45);
               $$39 += 9;
            }

            $$0.b(this.q.h, $$42.a, $$39, $$40, $$41.e() == dbw.d ? -1862270977 : -1);
            if ($$3 != null && $$41.e() != dbw.d) {
               int $$47 = $$39 + $$7 + 1;
               int $$48 = $$47 + $$22;
               if ($$48 - $$47 > 5) {
   ...
   protected void a(fgs $$0, int $$1, int $$2, int $$3, fyh $$4) {
      alf $$5;
      if ($$4.f() < 0) {
         $$5 = b;
      } else if ($$4.f() < 150) {
   ...
   private void a(ewo $$0, int $$1, fig.b $$2, int $$3, int $$4, UUID $$5, fgs $$6) {
      if ($$0.h() == ewz.a.b) {
   ...
   private void a(int $$0, int $$1, int $$2, UUID $$3, fgs $$4, int $$5) {
      fig.a $$6 = this.v.computeIfAbsent($$3, $$1x -> new fig.a($$5));
      $$6.a($$5, (long)this.r.e());
