public class ghn extends geu<hek> {
   public ghn(gjo $$0) {
      super($$0);
   }
   ...
   public void a(hek $$0) {
      ...
      } else if ($$3 == cqa.a && $$2 == 0.0F) {
         this.b($$0);
      } else if ($$3 == cqa.b) {
         gey.a(this.r, this.s, this.o, $$0.e == bxa.b);
      } else if ($$3 == cqa.c) {
         gey.a(this.r, this.s, $$0.c, $$0.K, $$0.e == bxa.b);
      } else if ($$3 == cqa.d) {
         this.o.e = 0.5F;
         this.o.f = 0.0F;
         if ($$0.e == bxa.a) {
   ...
   protected void a(hek $$0, float $$1) {
      float $$2 = $$0.H;
      if ($$2 > 0.0F && $$0.d == cqa.a) {
         gey.a(this.r, this.s, $$0.e, $$2, $$0.u);
      } else {
         super.a($$0, $$1);
      }
   }

   private void b(hek $$0) {
      if ($$0.e == bxa.a) {
         this.s.e = -1.8F;
      } else {
         this.r.e = -1.8F;
