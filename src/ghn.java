...
public class ghn extends ghs<chb> {
   private static final akn a = new akn("textures/entity/end_crystal/end_crystal.png");
   ...
   public void a(chb $$0, float $$1, float $$2, eyu $$3, gck $$4, int $$5) {
      $$3.a();
      float $$6 = a($$0, $$2);
   ...
   public static float a(chb $$0, float $$1) {
      float $$2 = (float)$$0.b + $$1;
      float $$3 = ayf.a($$2 * 0.2F) / 2.0F + 0.5F;
      $$3 = ($$3 * $$3 + $$3) * 0.4F;
      return $$3 - 1.4F;
   }
   ...
   public boolean a(chb $$0, gfo $$1, double $$2, double $$3, double $$4) {
