...
public class ghn implements ghb.a {
   private final ffg a;
   private double b = Double.MIN_VALUE;
   private List<bsv> c = Collections.emptyList();
   ...
   private void a(ezz $$0, gdp $$1, double $$2, double $$3, double $$4, bsv $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aE.ifPresent($$10 -> {
   ...
   private void a(iz $$0, ezz $$1, double $$2, double $$3, double $$4, gdp $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      gdn.a($$1, $$5.getBuffer(gdx.y()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      gdn.a(
         $$1,
         $$5.getBuffer(gdx.y()),
         this.a.r.a_($$0).b(this.a.r, $$0, evx.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
