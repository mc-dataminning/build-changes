...
public abstract class sg {
   ...
   private static volatile sg e = c();
   ...
   private static sg c() {
      ...
      return new sg() {
         ...
         @Override
         public atu a(vi $$0) {
            return $$1 -> $$0.a(($$1x, $$2xxx) -> avd.c($$2xxx, $$1x, $$1) ? Optional.empty() : vi.a, wa.a).isPresent();
         }
      };
   }

   private static void a(BiConsumer<String, String> $$0, String $$1) {
      try (InputStream $$2 = sg.class.getResourceAsStream($$1)) {
         a($$2, $$0);
   ...
   public static void a(InputStream $$0, BiConsumer<String, String> $$1) {
      ...
      for (Entry<String, JsonElement> $$3 : $$2.entrySet()) {
         String $$4 = d.matcher(aty.a($$3.getValue(), $$3.getKey())).replaceAll("%$1s");
         $$1.accept($$3.getKey(), $$4);
      }
   }
   ...
   public abstract atu a(vi var1);

   public List<atu> a(List<vi> $$0) {
