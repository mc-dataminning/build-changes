...
public class gki extends gkc<cft, fuy<cft>> {
   private static final Map<cft.a, ale> a = ac.a(Maps.newEnumMap(cft.a.class), $$0 -> {
      $$0.put(cft.a.a, new ale("textures/entity/panda/panda.png"));
      $$0.put(cft.a.b, new ale("textures/entity/panda/lazy_panda.png"));
      $$0.put(cft.a.c, new ale("textures/entity/panda/worried_panda.png"));
      $$0.put(cft.a.d, new ale("textures/entity/panda/playful_panda.png"));
      $$0.put(cft.a.e, new ale("textures/entity/panda/brown_panda.png"));
      $$0.put(cft.a.f, new ale("textures/entity/panda/weak_panda.png"));
      $$0.put(cft.a.g, new ale("textures/entity/panda/aggressive_panda.png"));
   });

   public gki(giw.a $$0) {
      super($$0, new fuy<>($$0.a(fwy.aF)), 0.9F);
      this.a(new gne(this, $$0.d()));
   }

   public ale a(cft $$0) {
      return a.getOrDefault($$0.gC(), a.get(cft.a.a));
   }

   protected void a(cft $$0, ezx $$1, float $$2, float $$3, float $$4, float $$5) {
      super.a($$0, $$1, $$2, $$3, $$4, $$5);
      if ($$0.bZ > 0) {
         int $$6 = $$0.bZ;
         int $$7 = $$6 + 1;
      ...
      if ($$25 > 0.0F) {
         ...
         $$1.a(a.b.rotationDegrees(ayy.i($$25, $$0.dH(), $$0.dH() + 90.0F)));
      ...
      if ($$27 > 0.0F) {
         ...
         $$1.a(0.0F, $$28 * $$27, 0.0F);
         $$1.a(a.b.rotationDegrees(ayy.i($$27, $$0.dH(), $$0.dH() + 180.0F)));
      }
   }

   private float a(float $$0, float $$1, int $$2, float $$3, float $$4) {
      return (float)$$2 < $$4 ? ayy.i($$3, $$0, $$1) : $$0;
   }
}
