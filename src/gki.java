...
public class gki {
   ...
   public void a(final gkg $$0, final Runnable $$1, final Runnable $$2) throws UnknownHostException {
      final glj $$3 = glj.a($$0.b);
      Optional<InetSocketAddress> $$4 = gll.a.a($$3).map(gli::d);
      if ($$4.isEmpty()) {
         this.a(fwt.b, $$0);
      } else {
   ...
   void a(InetSocketAddress $$0, final glj $$1, final gkg $$2) {
      ((Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group((EventLoopGroup)vr.e.get())).handler(new ChannelInitializer<Channel>() {
         protected void initChannel(Channel $$0) {
            ...
            $$0.pipeline().addLast(new ChannelHandler[]{new gjz($$1, ($$1xx, $$2xx, $$3, $$4, $$5) -> {
               $$2.a(gkg.b.d);
               $$2.h = wy.b($$2xx);
               $$2.d = wy.b($$3);
               $$2.c = gki.a($$4, $$5);
