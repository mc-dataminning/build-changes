...
public class ekj {
   ...
   private static final Queue<ekj.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile ekj.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(ekj::a), ekh::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(ekj::a), ekh::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + ekj.a(this.b) + ", type=" + ekj.b(this.c) + ", severity=" + ekj.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
