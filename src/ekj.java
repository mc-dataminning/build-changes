...
public class ekj {
   ...
   public ekj(@Nullable esb $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public uf a(uf $$0) {
      uf $$1 = $$0.p("Level");
      dcy $$2 = new dcy($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.e, $$2.f)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dcy.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dcy.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable esb $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ...
            try {
               $$2 = $$0.a($$1, bal.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               uf $$4 = $$2.p($$3);
               long $$5 = dcy.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if ($$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  uf $$14 = $$2.p($$13);
                  $$12.a(dcy.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static ekj a(ala<dds> $$0, @Nullable esb $$1) {
      if ($$0 == dds.h) {
         return new ekj(
            $$1,
         ...
         return new ekj($$1, $$2, $$2);
      } else if ($$0 == dds.j) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new ekj($$1, $$3, $$3);
      } else {
