...
public enum ekj {
   ...
   public List<anl<InputStream>> a(amh $$0) throws IOException {
      return List.of(
   ...
   public anl<InputStream> b(amh $$0) throws IOException {
      return this.a($$0, "minecraft.icns");
   }

   private anl<InputStream> a(amh $$0, String $$1) throws IOException {
      String[] $$2 = (String[])ArrayUtils.add(this.c, $$1);
      anl<InputStream> $$3 = $$0.a($$2);
      if ($$3 == null) {
