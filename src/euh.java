...
public class euh {
   ...
   public euh(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public euh(eum $$0, eum $$1) {
      this($$0.c, $$0.d, $$0.e, $$1.c, $$1.d, $$1.e);
   }

   public static euh a(ehd $$0) {
      return new euh((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static euh a(eum $$0) {
      return new euh($$0.c, $$0.d, $$0.e, $$0.c + 1.0, $$0.d + 1.0, $$0.e + 1.0);
   }

   public static euh a(io $$0, io $$1) {
      return new euh(
   ...
   public euh a(double $$0) {
      return new euh($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public euh b(double $$0) {
      return new euh(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public euh c(double $$0) {
      return new euh(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public euh d(double $$0) {
      return new euh(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public euh e(double $$0) {
      return new euh(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public euh f(double $$0) {
      return new euh(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public euh b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public euh c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public euh d(double $$0, double $$1, double $$2) {
      return new euh(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public euh f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public euh h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<eum> b(eum $$0, eum $$1) {
   ...
   @Nullable
   public static eui a(Iterable<euh> $$0, eum $$1, eum $$2, io $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new eui($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static it a(euh $$0, eum $$1, double[] $$2, @Nullable it $$3, double $$4, double $$5, double $$6) {
      if ($$4 > 1.0E-7) {
   ...
   public eum f() {
      return new eum(ayf.d(0.5, this.a, this.d), ayf.d(0.5, this.b, this.e), ayf.d(0.5, this.c, this.f));
   }

   public static euh a(eum $$0, double $$1, double $$2, double $$3) {
      return new euh($$0.c - $$1 / 2.0, $$0.d - $$2 / 2.0, $$0.e - $$3 / 2.0, $$0.c + $$1 / 2.0, $$0.d + $$2 / 2.0, $$0.e + $$3 / 2.0);
   }
}
