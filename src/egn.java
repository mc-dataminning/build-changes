...
public class egn extends egs {
   ...
   public List<efa.a> a(dcl $$0, BiConsumer<ja, dsk> $$1, ayo $$2, int $$3, ja $$4, eek $$5) {
      ...
      int $$11 = $$4.v() + $$8;
      int $$12 = $$7 - 5;
      List<egn.a> $$13 = Lists.newArrayList();
      $$13.add(new egn.a($$4.b($$12), $$11));
      ...
      List<efa.a> $$28 = Lists.newArrayList();
   ...
   private boolean a(dcl $$0, BiConsumer<ja, dsk> $$1, ayo $$2, ja $$3, ja $$4, boolean $$5, eek $$6) {
      if (!$$5 && Objects.equals($$3, $$4)) {
         ...
         for (int $$12 = 0; $$12 <= $$8; $$12++) {
            ...
            if ($$5) {
               this.a($$0, $$1, $$2, $$13, $$6, $$2x -> $$2x.b(dlt.i, this.a($$3, $$13)));
            } else if (!this.b($$0, $$13)) {
               return false;
            }
         }
   ...
   private void a(dcl $$0, BiConsumer<ja, dsk> $$1, ayo $$2, int $$3, ja $$4, List<egn.a> $$5, eek $$6) {
      for (egn.a $$7 : $$5) {
         int $$8 = $$7.a();
