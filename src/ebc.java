...
public class ebc implements eaz, AutoCloseable {
   ...
   private final bsb c;
   private final ebh d;
   private final SequencedMap<dgo, ebc.a> e = new LinkedHashMap<>();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected ebc(ebj $$0, Path $$1, boolean $$2) {
      this.d = new ebh($$0, $$1, $$2);
      this.c = new bsb(ebc.b.values().length, ae.h(), "IOWorker-" + $$0.c());
   }

   public boolean a(dgo $$0, int $$1) {
      dgo $$2 = new dgo($$0.h - $$1, $$0.i - $$1);
      dgo $$3 = new dgo($$0.h + $$1, $$0.i + $$1);
   ...
   public CompletableFuture<Void> a(dgo $$0, Supplier<ux> $$1) {
      return this.<CompletableFuture<Void>>a((Supplier<CompletableFuture<Void>>)(() -> {
         ux $$2 = $$1.get();
         ebc.a $$3 = this.e.computeIfAbsent($$0, $$1xx -> new ebc.a($$2));
         $$3.a = $$2;
         return $$3.b;
   ...
   public CompletableFuture<Optional<ux>> a(dgo $$0) {
      return this.a((ebc.c<Optional<ux>>)(() -> {
         ebc.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   public CompletableFuture<Void> a(boolean $$0) {
      CompletableFuture<Void> $$1 = this.<CompletableFuture<Void>>a(
         ...
         .thenCompose(Function.identity());
      return $$0 ? $$1.thenCompose($$0x -> this.a((ebc.c<Void>)(() -> {
            try {
               this.d.a();
               return null;
   ...
   @Override
   public CompletableFuture<Void> a(dgo $$0, vr $$1) {
      return this.a((ebc.c<Void>)(() -> {
         try {
            ebc.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(ebc.c<T> $$0) {
      return this.c.a(ebc.b.a.ordinal(), $$1 -> {
         if (!this.b.get()) {
            try {
               $$1.complete($$0.get());
            } catch (Exception var4) {
   ...
   private void b() {
      Entry<dgo, ebc.a> $$0 = this.e.pollFirstEntry();
      if ($$0 != null) {
   ...
   private void c() {
      this.c.a_(new bsd.c(ebc.b.b.ordinal(), this::b));
   }

   private void a(dgo $$0, ebc.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   private void d() {
      this.c.a(ebc.b.c.ordinal(), $$0 -> $$0.complete(bbk.a)).join();
   }
