...
public class ebc {
   private static final duo a = dhl.hj.o();
   private static final duo b = dhl.hk.o();
   private static final duo c = dhl.iA.o();
   private static final duo d = dhl.hn.o();
   private static final duo e = dhl.hv.o();
   private static final duo f = dhl.hx.o();
   private static final duo g = dhl.hr.o();
   private static final duo h = dhl.iC.o();
   private static final duo i = dhl.dP.o();
   private final duo j;
   private final int k;
   private final duo[] l;
   private final eps m;
   ...
   public ebc(eay $$0, duo $$1, int $$2, eax $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(eat.P);
      this.l = a($$3.a(alc.b("clay_bands")));
      this.u = $$0.a(eat.N);
      this.v = $$0.a(eat.O);
      this.n = $$0.a(eat.Q);
      this.o = $$0.a(eat.R);
   ...
   public void a(eay $$0, dfj $$1, ka<dfh> $$2, boolean $$3, ebh $$4, final dwk $$5, eao $$6, ebb.o $$7) {
      ...
      ebb.g $$13 = new ebb.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      ebb.u $$14 = $$7.apply($$13);
      je.a $$15 = new je.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(eak.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            jn<dfh> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(dfo.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(eak.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   @Deprecated
   public Optional<duo> a(ebb.o $$0, ecl $$1, Function<je, jn<dfh>> $$2, dwk $$3, eao $$4, je $$5, boolean $$6) {
      ebb.g $$7 = new ebb.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(lv.aG), $$1);
      ebb.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      duo $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dwh $$0, int $$1, int $$2, int $$3, dei $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, dfh $$1, dwh $$2, je.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).l() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(dhl.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(azl $$0, duo[] $$1, int $$2, duo $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected duo a(int $$0, int $$1, int $$2) {
