...
public class fw {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(sw.c("argument.item.tag.disallowed"));
   ...
   public static fw.a a(hg<cfu> $$0, StringReader $$1) throws CommandSyntaxException {
      int $$2 = $$1.getCursor();

      try {
         fw $$3 = new fw($$0, $$1, false);
         $$3.d();
         he<cfu> $$4 = (he<cfu>)$$3.j.left().orElseThrow(() -> new IllegalStateException("Parser returned unexpected tag name"));
   ...
   public static Either<fw.a, fw.b> b(hg<cfu> $$0, StringReader $$1) throws CommandSyntaxException {
      int $$2 = $$1.getCursor();
   ...
   private void a() throws CommandSyntaxException {
      ...
      acq $$1 = acq.a(this.h);
      Optional<? extends he<cfu>> $$2 = this.g.a(acp.a(jc.D, $$1));
   ...
   private void b() throws CommandSyntaxException {
      if (!this.i) {
         ...
         this.l = this::b;
         acq $$1 = acq.a(this.h);
         Optional<? extends hi<cfu>> $$2 = this.g.a(anl.a(jc.D, $$1));
   ...
   public static record a(he<cfu> a, @Nullable qr b) {
   }

   public static record b(hi<cfu> a, @Nullable qr b) {
   }
}
