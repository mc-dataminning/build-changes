...
public class ada implements zs<ach> {
   public static final zj<wi, ada> a = zs.a(ada::a, ada::new);
   ...
   public ada(RootCommandNode<fb> $$0) {
   ...
   private static List<ada.b> a(Object2IntMap<CommandNode<fb>> $$0) {
   ...
   @Nullable
   private static ada.e a(wi $$0, byte $$1) {
      int $$2 = $$1 & 3;
      if ($$2 == 2) {
         String $$3 = $$0.p();
         int $$4 = $$0.l();
   ...
   private static ada.b a(CommandNode<fb> $$0, Object2IntMap<CommandNode<fb>> $$1) {
      int $$2 = 0;
      int $$3;
   ...
   public RootCommandNode<fb> a(es $$0) {
      return (RootCommandNode<fb>)new ada.d($$0, this.j).a(this.i);
   }
   ...
   static class a implements ada.e {
      ...
      @Nullable
      private static all a(@Nullable SuggestionProvider<fb> $$0) {
         return $$0 != null ? iw.a($$0) : null;
      }

      a(String $$0, is.a<?> $$1, @Nullable all $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
      }
      ...
      private static <A extends ArgumentType<?>> void a(wi $$0, is.a<A> $$1) {
         a($$0, $$1.a(), $$1);
      }

      private static <A extends ArgumentType<?>, T extends is.a<A>> void a(wi $$0, is<A, T> $$1, is.a<A> $$2) {
         $$0.c(lz.u.a($$1));
         $$1.a((T)$$2, $$0);
      }
   }
