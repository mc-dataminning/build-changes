...
public class eks {
   ...
   static class a implements eks.i {
      @Override
      public boolean a(eks.v $$0) {
         return $$0.c[je.f.d()] && !$$0.b[je.f.d()].d;
      }

      @Override
      public eks.r a(je $$0, eks.v $$1, azg $$2) {
         $$1.d = true;
         $$1.b[je.f.d()].d = true;
         return new eks.k($$0, $$1);
      }
   }

   static class b implements eks.i {
      @Override
      public boolean a(eks.v $$0) {
      ...
      public eks.r a(je $$0, eks.v $$1, azg $$2) {
         ...
         return new eks.l($$0, $$1);
      }
   }

   static class c implements eks.i {
      @Override
      public boolean a(eks.v $$0) {
      ...
      public eks.r a(je $$0, eks.v $$1, azg $$2) {
         $$1.d = true;
         $$1.b[je.b.d()].d = true;
         return new eks.m($$0, $$1);
      }
   }

   static class d implements eks.i {
      @Override
      public boolean a(eks.v $$0) {
      ...
      public eks.r a(je $$0, eks.v $$1, azg $$2) {
         ...
         return new eks.n($$0, $$1);
      }
   }

   static class e implements eks.i {
      @Override
      public boolean a(eks.v $$0) {
      ...
      public eks.r a(je $$0, eks.v $$1, azg $$2) {
         ...
         $$3.d = true;
         $$3.b[je.c.d()].d = true;
         return new eks.o($$0, $$3);
      }
   }

   static class f implements eks.i {
      @Override
      public boolean a(eks.v $$0) {
         return true;
      }
      ...
      public eks.r a(je $$0, eks.v $$1, azg $$2) {
         $$1.d = true;
         return new eks.s($$0, $$1, $$2);
      }
   }

   static class g implements eks.i {
      @Override
      public boolean a(eks.v $$0) {
      ...
      public eks.r a(je $$0, eks.v $$1, azg $$2) {
         $$1.d = true;
         return new eks.t($$0, $$1);
      }
   }

   public static class h extends eks.r {
      ...
      private eks.v G;
      private eks.v H;
      private final List<eks.r> I = Lists.newArrayList();

      public h(azg $$0, int $$1, int $$2, je $$3) {
         super(eja.M, $$3, 0, a($$1, 39, $$2, $$3, 58, 23, 58));
         this.a($$3);
         List<eks.v> $$4 = this.b($$0);
         this.G.d = true;
         this.I.add(new eks.p($$3, this.G));
         this.I.add(new eks.j($$3, this.H));
         List<eks.i> $$5 = Lists.newArrayList();
         $$5.add(new eks.b());
         $$5.add(new eks.d());
         $$5.add(new eks.e());
         $$5.add(new eks.a());
         ...
         eib $$10 = eib.a(this.b(1, 1, 1), this.b(23, 8, 21));
         eib $$11 = eib.a(this.b(34, 1, 1), this.b(56, 8, 21));
         eib $$12 = eib.a(this.b(22, 13, 22), this.b(35, 17, 35));
         int $$13 = $$0.f();
         this.I.add(new eks.u($$3, $$10, $$13++));
         this.I.add(new eks.u($$3, $$11, $$13++));
         this.I.add(new eks.q($$3, $$12));
      }
      ...
      private List<eks.v> b(azg $$0) {
         eks.v[] $$1 = new eks.v[75];
         ...
         eks.v $$23 = new eks.v(1003);
         eks.v $$24 = new eks.v(1001);
         eks.v $$25 = new eks.v(1002);
         $$1[v].a(je.b, $$23);
         $$1[w].a(je.d, $$24);
         $$1[x].a(je.d, $$25);
         $$23.d = true;
         ...
         ObjectArrayList<eks.v> $$26 = new ObjectArrayList();
      ...
      private void a(boolean $$0, int $$1, dcs $$2, azg $$3, eib $$4) {
         int $$5 = 24;
      ...
      private void a(dcs $$0, azg $$1, eib $$2) {
      ...
      private void b(dcs $$0, azg $$1, eib $$2) {
      ...
      private void c(dcs $$0, azg $$1, eib $$2) {
      ...
      private void d(dcs $$0, azg $$1, eib $$2) {
      ...
      private void e(dcs $$0, azg $$1, eib $$2) {
      ...
      private void f(dcs $$0, azg $$1, eib $$2) {
   ...
   interface i {
      boolean a(eks.v var1);

      eks.r a(je var1, eks.v var2, azg var3);
   }

   public static class j extends eks.r {
      public j(je $$0, eks.v $$1) {
         super(eja.N, 1, $$0, $$1, 2, 2, 2);
      }
      ...
      public void a(dcs $$0, dcq $$1, dty $$2, azg $$3, eib $$4, dbe $$5, iz $$6) {
         ...
         this.a($$0, $$4, 7, 4, 7, 8, 5, 8, dfa.ch.o(), dfa.ch.o(), false);
   ...
   public static class k extends eks.r {
      public k(je $$0, eks.v $$1) {
         super(eja.O, 1, $$0, $$1, 2, 1, 1);
      }
   ...
   public static class l extends eks.r {
      public l(je $$0, eks.v $$1) {
         super(eja.P, 1, $$0, $$1, 2, 2, 1);
      }
   ...
   public static class m extends eks.r {
      public m(je $$0, eks.v $$1) {
         super(eja.Q, 1, $$0, $$1, 1, 2, 1);
      }
   ...
   public static class n extends eks.r {
      public n(je $$0, eks.v $$1) {
         super(eja.R, 1, $$0, $$1, 1, 2, 2);
      }
   ...
   public static class o extends eks.r {
      public o(je $$0, eks.v $$1) {
         super(eja.S, 1, $$0, $$1, 1, 1, 2);
      }
   ...
   public static class p extends eks.r {
      public p(je $$0, eks.v $$1) {
         super(eja.T, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class q extends eks.r {
      public q(je $$0, eib $$1) {
         super(eja.U, $$0, 1, $$1);
      }
   ...
   protected abstract static class r extends ein {
      protected static final dsb b = dfa.hZ.o();
      protected static final dsb c = dfa.ia.o();
      protected static final dsb d = dfa.ib.o();
      protected static final dsb h = c;
      protected static final dsb i = dfa.ii.o();
      protected static final boolean j = true;
      protected static final dsb k = dfa.G.o();
      protected static final Set<dey> l = ImmutableSet.builder().add(dfa.dO).add(dfa.iC).add(dfa.mW).add(k.b()).build();
      ...
      public r(eja $$0, je $$1, int $$2, eib $$3) {
         super($$0, $$2, $$3);
         this.a($$1);
      }

      protected r(eja $$0, int $$1, je $$2, eks.v $$3, int $$4, int $$5, int $$6) {
         super($$0, $$1, a($$2, $$3, $$4, $$5, $$6));
         this.a($$2);
         this.B = $$3;
      }

      private static eib a(je $$0, eks.v $$1, int $$2, int $$3, int $$4) {
         int $$5 = $$1.a;
         int $$6 = $$5 % 5;
         int $$7 = $$5 / 5 % 5;
         int $$8 = $$5 / 25;
         eib $$9 = a(0, 0, 0, $$0, $$2 * 8, $$3 * 4, $$4 * 8);
         switch ($$0) {
            case c:
               $$9.a($$6 * 8, $$8 * 4, -($$7 + $$4) * 8 + 1);
               break;
      ...
      protected void b(dcs $$0, eib $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7) {
         for (int $$8 = $$3; $$8 <= $$6; $$8++) {
            for (int $$9 = $$2; $$9 <= $$5; $$9++) {
               for (int $$10 = $$4; $$10 <= $$7; $$10++) {
                  dsb $$11 = this.a($$0, $$9, $$8, $$10, $$1);
                  if (!l.contains($$11.b())) {
                     if (this.b($$8) >= $$0.z_() && $$11 != k) {
                        this.a($$0, dfa.a.o(), $$9, $$8, $$10, $$1);
                     } else {
                        this.a($$0, k, $$9, $$8, $$10, $$1);
                     }
                  }
      ...
      protected void a(dcs $$0, eib $$1, int $$2, int $$3, boolean $$4) {
         if ($$4) {
      ...
      protected void a(dcs $$0, eib $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, dsb $$8) {
         for (int $$9 = $$3; $$9 <= $$6; $$9++) {
      ...
      protected boolean a(eib $$0, int $$1, int $$2, int $$3, int $$4) {
         int $$5 = this.a($$1, $$2);
         int $$6 = this.b($$1, $$2);
         int $$7 = this.a($$3, $$4);
         int $$8 = this.b($$3, $$4);
      ...
      protected void a(dcs $$0, eib $$1, int $$2, int $$3, int $$4) {
         iz $$5 = this.b($$2, $$3, $$4);
         if ($$1.b($$5)) {
            cjr $$6 = bsz.D.a((dbx)$$0.E());
            if ($$6 != null) {
               $$6.c($$6.eR());
               $$6.b((double)$$5.u() + 0.5, (double)$$5.v(), (double)$$5.w() + 0.5, 0.0F, 0.0F);
               $$6.a($$0, $$0.d_($$6.dp()), bts.d, null);
               $$0.a_($$6);
            }
         }
      }
   ...
   public static class s extends eks.r {
      private int a;

      public s(je $$0, eks.v $$1, azg $$2) {
         super(eja.V, 1, $$0, $$1, 1, 1, 1);
         this.a = $$2.a(3);
      }
   ...
   public static class t extends eks.r {
      public t(je $$0, eks.v $$1) {
         super(eja.W, 1, $$0, $$1, 1, 1, 1);
      }
   ...
   public static class u extends eks.r {
      private int a;

      public u(je $$0, eib $$1, int $$2) {
         super(eja.X, $$0, 1, $$1);
         this.a = $$2 & 1;
      }
