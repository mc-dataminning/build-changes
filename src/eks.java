...
public class eks extends ekm<ems> {
   private static final jc[] a = jc.values();

   public eks(Codec<ems> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eko<ems> $$0) {
      ems $$1 = $$0.f();
      azz $$2 = $$0.d();
      iw $$3 = $$0.e();
      dky $$4 = $$0.b();
      ...
      int $$8 = $$1.j.a($$2);
      eie $$9 = new eie(new ehg($$4.E()));
      ewt $$10 = ewt.a($$9, -4, 1.0);
      ...
      for (iw $$33 : iw.c($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<iw, Integer> $$37 : $$7) {
            $$35 += azq.f($$33.j((kb)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (iw $$38 : $$11) {
            $$36 += azq.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, dng.a.m(), $$32);
      ...
      for (iw $$44 : $$31) {
         ...
         for (jc $$46 : a) {
            ...
            ebg $$48 = $$4.a_($$47);
            if ($$45.b(ebw.I)) {
               $$45 = $$45.b(ebw.I, Boolean.valueOf($$48.y().b()));
            }
