...
public class eoe extends eop {
   ...
   public eof a() {
      ...
      if (this.f() && this.b.be()) {
         ...
         for (dsa $$2 = this.a.a($$1); $$2.a(dez.G); $$2 = this.a.a($$1)) {
            $$1.b(this.b.du(), (double)(++$$0), this.b.dA());
         }
      } else {
         $$0 = ayx.a(this.b.dw() + 0.5);
      }
   ...
   private boolean b(@Nullable eof $$0) {
      return $$0 != null && $$0.k >= 0.0F;
   }

   private boolean c(@Nullable eof $$0) {
      return $$0 != null && !$$0.i;
   }
   ...
   protected eok b(int $$0, int $$1, int $$2) {
      return (eok)this.l.computeIfAbsent(iz.a($$0, $$1, $$2), $$3 -> this.a(this.a, $$0, $$1, $$2, this.b));
   }

   @Override
   public eok a(eom $$0, int $$1, int $$2, int $$3) {
      eok $$4 = $$0.a($$1, $$2, $$3);
      if ($$4 == eok.b && $$2 >= $$0.a().I_() + 1) {
         iz $$5 = new iz($$1, $$2 - 1, $$3);
         eok $$6 = $$0.a($$5.u(), $$5.v(), $$5.w());
         if ($$6 == eok.o || $$6 == eok.i) {
            $$4 = eok.o;
         } else if ($$6 == eok.q) {
            $$4 = eok.q;
            ...
            $$4 = $$6 != eok.c && $$6 != eok.b && $$6 != eok.j ? eok.c : eok.b;
         }
      }
   ...
   private Iterable<iz> a(btp $$0) {
      ...
      if (!$$2) {
         ...
         evk $$6 = $$1.c($$4, $$5, $$3);
         return iz.a($$0.el(), 10, ayx.a($$6.a), ayx.a($$6.b), ayx.a($$6.c), ayx.a($$6.d), ayx.a($$6.e), ayx.a($$6.f));
      }
   }
}
