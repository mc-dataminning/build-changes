...
public class eoe implements AutoCloseable {
   private final eoe.a a;
   private int b;
   private int c;
   private int d;
   @Nullable
   ...
   private eog a(enw.a $$0, @Nullable ByteBuffer $$1) {
      boolean $$2 = false;
   ...
   @Nullable
   private RenderSystem.a b(enw.a $$0, @Nullable ByteBuffer $$1) {
      if ($$1 != null) {
   ...
   public void a(Matrix4f $$0, Matrix4f $$1, frn $$2) {
   ...
   private void b(Matrix4f $$0, Matrix4f $$1, frn $$2) {
      for (int $$3 = 0; $$3 < 12; $$3++) {
      ...
      if ($$2.o != null && (this.i == eog.b.a || this.i == eog.b.b)) {
