...
public class eoe {
   ...
   public eoe(@Nullable evw $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(dgn.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(dgn.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private void a(@Nullable evw $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ux $$2 = new ux();

            try {
               $$2 = $$0.a($$1, bbs.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               ux $$4 = $$2.p($$3);
               long $$5 = dgn.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
            ...
            if ($$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  ux $$14 = $$2.p($$13);
                  $$12.a(dgn.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static eoe a(aly<dhh> $$0, @Nullable evw $$1) {
      if ($$0 == dhh.i) {
         return new eoe(
            $$1,
         ...
         return new eoe($$1, $$2, $$2);
      } else if ($$0 == dhh.k) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new eoe($$1, $$3, $$3);
      } else {
