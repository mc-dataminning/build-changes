...
public class eoe implements dyn.d {
   private static final Codec<Double> e = Codec.doubleRange(0.001, 1000.0);
   private static final MapCodec<eoe> f = RecordCodecBuilder.mapCodec(
      $$0 -> $$0.group(
   ...
   public static final ayg<eoe> a = ayg.a(f);
   private final eoi g;
   private final eoi h;
   private final eoi i;
   ...
   public static eoe a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new eoe(new dzv(0L), $$0, $$1, $$2, $$3, $$4);
   }

   private eoe(eoi $$0, eoi $$1, eoi $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
      this.g = $$0;
      this.h = $$1;
      this.i = $$2;
      this.p = $$3;
   ...
   @VisibleForTesting
   public eoe(ayt $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
         eoi.a($$0, IntStream.rangeClosed(-15, 0)),
         eoi.a($$0, IntStream.rangeClosed(-15, 0)),
         eoi.a($$0, IntStream.rangeClosed(-7, 0)),
         $$1,
         $$2,
         $$3,
         $$4,
   ...
   public eoe a(ayt $$0) {
      return new eoe($$0, this.p, this.q, this.l, this.m, this.n);
   }
   ...
   public double a(dyn.b $$0) {
      ...
      for (int $$14 = 0; $$14 < 8; $$14++) {
         eof $$15 = this.i.a($$14);
         if ($$15 != null) {
            $$11 += $$15.a(eoi.b($$4 * $$13), eoi.b($$5 * $$13), eoi.b($$6 * $$13), $$8 * $$13, $$5 * $$13) / $$13;
         }
      ...
      for (int $$19 = 0; $$19 < 16; $$19++) {
         double $$20 = eoi.b($$1 * $$13);
         double $$21 = eoi.b($$2 * $$13);
         double $$22 = eoi.b($$3 * $$13);
         double $$23 = $$7 * $$13;
         if (!$$17) {
            eof $$24 = this.g.a($$19);
            if ($$24 != null) {
      ...
      return aym.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
