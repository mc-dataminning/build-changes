...
public class eoe implements dyr.d {
   ...
   public static final ayh<eoe> a = ayh.a(f);
   private final eoi g;
   private final eoi h;
   private final eoi i;
   ...
   public static eoe a(double $$0, double $$1, double $$2, double $$3, double $$4) {
      return new eoe(new dzz(0L), $$0, $$1, $$2, $$3, $$4);
   }
   ...
   @VisibleForTesting
   public eoe(ayw $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this(
   ...
   public double a(dyr.b $$0) {
      ...
      return ayo.b($$9 / 512.0, $$10 / 512.0, $$16) / 128.0;
   }
