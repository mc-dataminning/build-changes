...
public class aeu implements Comparable<aeu> {
   public static final Codec<aeu> a = Codec.STRING.comapFlatMap(aeu::b, aeu::toString).stable();
   private static final SimpleCommandExceptionType e = new SimpleCommandExceptionType(ti.c("argument.id.invalid"));
   ...
   protected aeu(String $$0, String $$1, @Nullable aeu.a $$2) {
      this.f = $$0;
      this.g = $$1;
   }

   public aeu(String $$0, String $$1) {
      this(c($$0, $$1), d($$0, $$1), null);
   }

   private aeu(String[] $$0) {
      this($$0[0], $$0[1]);
   }
   ...
   public static aeu a(String $$0, char $$1) {
      return new aeu(b($$0, $$1));
   }
   ...
   @Nullable
   public static aeu a(String $$0, String $$1) {
      try {
         return new aeu($$0, $$1);
      } catch (z var3) {
         return null;
   ...
   public static DataResult<aeu> b(String $$0) {
      try {
         return DataResult.success(new aeu($$0));
      } catch (z var2) {
   ...
   public aeu c(String $$0) {
      return new aeu(this.f, d(this.f, $$0), null);
   }

   public aeu a(UnaryOperator<String> $$0) {
      return this.c($$0.apply(this.g));
   }

   public aeu d(String $$0) {
      return this.c($$0 + this.g);
   }

   public aeu e(String $$0) {
   ...
   public boolean equals(Object $$0) {
      if (this == $$0) {
         ...
         return !($$0 instanceof aeu $$1) ? false : this.f.equals($$1.f) && this.g.equals($$1.g);
      }
   }
   ...
   public static aeu a(StringReader $$0) throws CommandSyntaxException {
      int $$1 = $$0.getCursor();
   ...
   public static class b implements JsonDeserializer<aeu>, JsonSerializer<aeu> {
      public aeu a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         return new aeu(arj.a($$0, "location"));
      }

      public JsonElement a(aeu $$0, Type $$1, JsonSerializationContext $$2) {
