...
public class aeu extends IOException {
   private final List<aeu.a> a = Lists.newArrayList();
   private final String b;

   public aeu(String $$0) {
      this.a.add(new aeu.a());
      this.b = $$0;
   }

   public aeu(String $$0, Throwable $$1) {
      super($$1);
      this.a.add(new aeu.a());
      this.b = $$0;
   }
   ...
   public static aeu a(Exception $$0) {
      if ($$0 instanceof aeu) {
         return (aeu)$$0;
      } else {
