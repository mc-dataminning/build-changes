...
public class gmt {
   ...
   public final Map<jm, gmu> c;
   public final gmv d;
   public final boolean e;
   public final int f;

   public gmt(Vector3f $$0, Vector3f $$1, Map<jm, gmu> $$2) {
      this($$0, $$1, $$2, null, true, 0);
   }

   public gmt(Vector3f $$0, Vector3f $$1, Map<jm, gmu> $$2, @Nullable gmv $$3, boolean $$4, int $$5) {
      this.a = $$0;
      this.b = $$1;
      this.c = $$2;
      this.d = $$3;
   ...
   private void a() {
      for (Entry<jm, gmu> $$0 : this.c.entrySet()) {
   ...
   protected static class a implements JsonDeserializer<gmt> {
      ...
      public gmt a(JsonElement $$0, Type $$1, JsonDeserializationContext $$2) throws JsonParseException {
         ...
         if ($$3.has("shade") && !azu.c($$3, "shade")) {
            ...
            return new gmt($$4, $$5, $$7, $$6, $$8, $$9);
         }
      }

      @Nullable
      private gmv a(JsonObject $$0) {
         gmv $$1 = null;
         if ($$0.has("rotation")) {
      ...
      private Map<jm, gmu> a(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gmu> $$2 = this.b($$0, $$1);
         if ($$2.isEmpty()) {
      ...
      private Map<jm, gmu> b(JsonDeserializationContext $$0, JsonObject $$1) {
         Map<jm, gmu> $$2 = Maps.newEnumMap(jm.class);
         JsonObject $$3 = azu.u($$1, "faces");

         for (Entry<String, JsonElement> $$4 : $$3.entrySet()) {
            jm $$5 = this.a($$4.getKey());
            $$2.put($$5, (gmu)$$0.deserialize($$4.getValue(), gmu.class));
         }
