...
public class gmt implements gmx.a {
   private final fjx a;
   private static final int b = axy.a(255, 0, 155, 155);
   private static final int c = axy.a(255, 255, 255, 0);
   ...
   public void a(fek $$0, gix $$1, double $$2, double $$3, double $$4) {
      ...
      for (int $$19 = this.a.s.I_(); $$19 <= this.a.s.al() + 1; $$19 += 2) {
      ...
      for (int $$24 = this.a.s.I_(); $$24 <= this.a.s.al() + 1; $$24 += 16) {
