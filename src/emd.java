...
public class emd {
   ...
   private final Map<String, Long2ObjectMap<ul>> e = Maps.newHashMap();
   private final Map<String, eml> f = Maps.newHashMap();
   private final List<String> g;
   private final List<String> h;

   public emd(@Nullable etv $$0, List<String> $$1, List<String> $$2) {
      this.g = $$1;
      this.h = $$2;
      this.a($$0);
      boolean $$3 = false;
   ...
   public ul a(ul $$0) {
      ul $$1 = $$0.p("Level");
      des $$2 = new des($$1.h("xPos"), $$1.h("zPos"));
      if (this.a($$2.g, $$2.h)) {
         $$0 = this.a($$0, $$2);
      }
   ...
   private boolean a(int $$0, int $$1, String $$2) {
      return !this.d ? false : this.e.get($$2) != null && this.f.get(a.get($$2)).b(des.c($$0, $$1));
   }
   ...
   private boolean a(int $$0, int $$1) {
      if (!this.d) {
         ...
         for (String $$2 : this.h) {
            if (this.e.get($$2) != null && this.f.get(a.get($$2)).c(des.c($$0, $$1))) {
               return true;
            }
         }
   ...
   private ul a(ul $$0, des $$1) {
      ul $$2 = $$0.p("Level");
      ul $$3 = $$2.p("Structures");
      ul $$4 = $$3.p("Starts");

      for (String $$5 : this.h) {
         Long2ObjectMap<ul> $$6 = this.e.get($$5);
         if ($$6 != null) {
            long $$7 = $$1.a();
   ...
   private void a(@Nullable etv $$0) {
      if ($$0 != null) {
         for (String $$1 : this.g) {
            ul $$2 = new ul();

            try {
               $$2 = $$0.a($$1, baw.o, 1493).p("data").p("Features");
               if ($$2.g()) {
                  continue;
               }
            ...
            for (String $$3 : $$2.e()) {
               ul $$4 = $$2.p($$3);
               long $$5 = des.c($$4.h("ChunkX"), $$4.h("ChunkZ"));
               ur $$6 = $$4.c("Children", 10);
               if (!$$6.isEmpty()) {
                  String $$7 = $$6.a(0).l("id");
                  String $$8 = b.get($$7);
                  if ($$8 != null) {
            ...
            if ($$11.b().isEmpty()) {
               ...
               for (String $$13 : $$2.e()) {
                  ul $$14 = $$2.p($$13);
                  $$12.a(des.c($$14.h("ChunkX"), $$14.h("ChunkZ")));
               }
            } else {
               this.f.put($$1, $$11);
            }
   ...
   public static emd a(ali<dfm> $$0, @Nullable etv $$1) {
      if ($$0 == dfm.i) {
         return new emd(
            $$1,
         ...
         return new emd($$1, $$2, $$2);
      } else if ($$0 == dfm.k) {
         List<String> $$3 = ImmutableList.of("EndCity");
         return new emd($$1, $$3, $$3);
      } else {
