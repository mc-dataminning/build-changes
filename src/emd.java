...
public abstract class emd<T extends emd<T>> {
   ...
   public emd(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = emb.a();
         if ($$3 != null) {
         ...
         throw new enm(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new enm(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new enm(var2.getMessage(), var2);
      }
   }
   ...
   public static emd<?> a(String $$0) {
      return new emd.b($$0, 5000, 60000);
   }

   public static emd<?> a(String $$0, int $$1, int $$2) {
      return new emd.b($$0, $$1, $$2);
   }

   public static emd<?> c(String $$0, String $$1) {
      return new emd.c($$0, $$1, 5000, 60000);
   }

   public static emd<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new emd.c($$0, $$1, $$2, $$3);
   }

   public static emd<?> b(String $$0) {
      return new emd.a($$0, 5000, 60000);
   }

   public static emd<?> d(String $$0, String $$1) {
      return new emd.d($$0, $$1, 5000, 60000);
   }

   public static emd<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new emd.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends emd<emd.a> {
   ...
   public static class b extends emd<emd.b> {
   ...
   public static class c extends emd<emd.c> {
      ...
      public emd.c f() {
         try {
            ...
            throw new enm(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends emd<emd.d> {
      private final String c;
