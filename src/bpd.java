...
public class bpd extends bpi {
   public static final MapCodec<bpd> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bpd a(float $$0, float $$1, int $$2, int $$3) {
      return new bpd($$0, $$1, $$2, $$3);
   }

   private bpd(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
   ...
   public static int a(aym $$0, float $$1, float $$2, float $$3, float $$4) {
      return (int)aye.a(aye.c($$0, $$1, $$2), $$3, $$4);
   }
