...
public class bpd {
   ...
   private bpd(Path $$0, String $$1) {
      this.d = $$0;
      this.e = $$1;
   }

   public static bpd a(Path $$0, String $$1) throws IOException {
      Files.createDirectories($$0);
      return new bpd($$0, $$1);
   }

   public bpd.d a() throws IOException {
      bpd.d var2;
      try (Stream<Path> $$0 = Files.list(this.d)) {
         var2 = new bpd.d($$0.filter($$0x -> Files.isRegularFile($$0x)).map(this::a).filter(Objects::nonNull).toList());
      }
   ...
   @Nullable
   private bpd.b a(Path $$0) {
      String $$1 = $$0.getFileName().toString();
      int $$2 = $$1.indexOf(46);
      if ($$2 == -1) {
         return null;
      } else {
         bpd.c $$3 = bpd.c.a($$1.substring(0, $$2));
         if ($$3 != null) {
            String $$4 = $$1.substring($$2);
            if ($$4.equals(this.e)) {
               return new bpd.e($$0, $$3);
            }

            if ($$4.equals(this.e + ".gz")) {
               return new bpd.a($$0, $$3);
            }
         }
   ...
   public bpd.e a(LocalDate $$0) throws IOException {
      int $$1 = 1;
      Set<bpd.c> $$2 = this.a().c();
      ...
      bpd.e $$4 = new bpd.e(this.d.resolve($$3.b(this.e)), $$3);
      Files.createFile($$4.c());
      return $$4;
   }

   public static record a(Path a, bpd.c b) implements bpd.b {
      @Nullable
      @Override
   ...
   public static record c(LocalDate a, int b) {
      ...
      @Nullable
      public static bpd.c a(String $$0) {
         int $$1 = $$0.indexOf("-");
         if ($$1 == -1) {
            return null;
         } else {
            ...
            try {
               return new bpd.c(LocalDate.parse($$2, c), Integer.parseInt($$3));
   ...
   public static class d implements Iterable<bpd.b> {
      private final List<bpd.b> a;

      d(List<bpd.b> $$0) {
         this.a = new ArrayList<>($$0);
      }

      public bpd.d a(LocalDate $$0, int $$1) {
         this.a.removeIf($$2 -> {
            bpd.c $$3 = $$2.d();
            ...
            if (!$$0.isBefore($$4)) {
               try {
                  ...
                  bpd.a.warn("Failed to delete expired event log file: {}", $$2.c(), var6);
               }
            }
      ...
      public bpd.d a() {
         ListIterator<bpd.b> $$0 = this.a.listIterator();
         ...
         while ($$0.hasNext()) {
            ...
            try {
               ...
               bpd.a.warn("Failed to compress event log file: {}", $$1.c(), var4);
            }
         }
      ...
      @Override
      public Iterator<bpd.b> iterator() {
         return this.a.iterator();
      }

      public Stream<bpd.b> b() {
         return this.a.stream();
      }

      public Set<bpd.c> c() {
         return this.a.stream().map(bpd.b::d).collect(Collectors.toSet());
      }
   }

   public static record e(Path a, bpd.c b) implements bpd.b {
