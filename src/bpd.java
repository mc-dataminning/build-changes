...
public abstract class bpd<C, V> implements box<StringReader, V>, bpe {
   private final bor<alz> b;
   protected final C a;

   protected bpd(bor<alz> $$0, C $$1) {
      this.b = $$0;
      this.a = $$1;
   }

   @Override
   public Optional<V> a(bow<StringReader> $$0) {
      $$0.b().skipWhitespace();
      int $$1 = $$0.c();
