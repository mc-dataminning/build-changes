...
public record bs(Optional<jv<dcy>> b, dk.d c) {
   ...
   public bs(jr<dcy> $$0, dk.d $$1) {
      this(Optional.of(jv.a($$0)), $$1);
   }

   public bs(jv<dcy> $$0, dk.d $$1) {
      this(Optional.of($$0), $$1);
   }

   public boolean a(dde $$0) {
      if (this.b.isPresent()) {
         for (jr<dcy> $$1 : this.b.get()) {
            if (this.a($$0, $$1)) {
               return true;
            }
         }
   ...
   private boolean a(dde $$0, jr<dcy> $$1) {
      int $$2 = $$0.a($$1);
      if ($$2 == 0) {
         return false;
      } else {
