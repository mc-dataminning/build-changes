...
public class ftv extends ftr {
   private static final xk b = xk.c("gui.stats");
   static final alp c = alp.b("container/slot");
   static final alp d = alp.b("statistics/header");
   static final alp s = alp.b("statistics/sort_up");
   static final alp u = alp.b("statistics/sort_down");
   private static final xk v = xk.c("multiplayer.downloadingStats");
   static final xk w = xk.c("stats.none");
   private static final xk x = xk.c("stat.generalButton");
   private static final xk y = xk.c("stat.itemsButton");
   private static final xk z = xk.c("stat.mobsButton");
   ...
   public void E() {
      ...
      $$1.a(fny.a(xj.d, $$0x -> this.aP_()).a(200).a());
   ...
   class a extends fov<ftv.a.a> {
      public a(final flz $$0) {
         ...
         ObjectArrayList<axc<alp>> $$1 = new ObjectArrayList(axf.i.iterator());
         $$1.sort(Comparator.comparing($$0x -> hcn.a(ftv.a($$0x))));
         ObjectListIterator var4 = $$1.iterator();

         while (var4.hasNext()) {
            axc<alp> $$2 = (axc<alp>)var4.next();
      ...
      class a extends fov.a<ftv.a.a> {
         ...
         @Override
         public xk a() {
            return xk.a("narrator.select", xk.i().b(this.c).b(xj.v).f(this.b()));
         }
      }
   }
   ...
   class b extends fov<ftv.b.a> {
      ...
      private final alp[] z = new alp[]{
         alp.b("statistics/block_mined"),
         alp.b("statistics/item_broken"),
         alp.b("statistics/item_crafted"),
         alp.b("statistics/item_used"),
         alp.b("statistics/item_picked_up"),
         alp.b("statistics/item_dropped")
      };
      protected final List<axe<dkd>> a;
      protected final List<axe<cxc>> m;
      ...
      public b(final flz $$0) {
         ...
         this.a.add(axf.a);
         this.m = Lists.newArrayList(new axe[]{axf.d, axf.b, axf.c, axf.e, axf.f});
         this.a(true, 22);
         Set<cxc> $$1 = Sets.newIdentityHashSet();

         for (cxc $$2 : ma.g) {
            boolean $$3 = false;

            for (axe<cxc> $$4 : this.m) {
      ...
      protected void a(fnl $$0, int $$1, int $$2) {
         ...
         for (int $$3 = 0; $$3 < this.z.length; $$3++) {
            alp $$4 = this.p == $$3 ? ftv.c : ftv.d;
            $$0.a(glq::H, $$4, $$1 + this.n($$3) - 18, $$2 + 1, 18, 18);
         }

         if (this.o != null) {
            int $$5 = this.n(this.b(this.o)) - 36;
            alp $$6 = this.q == 1 ? ftv.s : ftv.u;
            $$0.a(glq::H, $$6, $$1 + $$5, $$2 + 1, 18, 18);
         }

         for (int $$7 = 0; $$7 < this.z.length; $$7++) {
            int $$8 = this.p == $$7 ? 1 : 0;
            $$0.a(glq::H, this.z[$$7], $$1 + this.n($$7) - 18 + $$8, $$2 + 1 + $$8, 18, 18);
         }
      }
         ...
         public void a(fnl $$0, int $$1, int $$2, int $$3, int $$4, int $$5, int $$6, int $$7, boolean $$8, float $$9) {
            ...
            if (ftv.this.F != null) {
               ...
               for (int $$14 = 0; $$14 < ftv.this.F.m.size(); $$14++) {
                  this.a($$0, ftv.this.F.m.get($$14).b(this.b), $$3 + b.this.n($$14 + ftv.this.F.a.size()), $$2 + $$5 / 2 - 9 / 2, $$1 % 2 == 0);
               }
            }
         }

         protected void a(fnl $$0, @Nullable axc<?> $$1, int $$2, int $$3, boolean $$4) {
            xk $$5 = (xk)($$1 == null ? ftv.w : xk.b($$1.a(ftv.this.H.a($$1))));
            $$0.b(ftv.this.p, $$5, $$2 - ftv.this.p.a($$5), $$3, $$4 ? -1 : -4539718);
         }

         @Override
         public xk a() {
            return xk.a("narrator.select", this.b.m());
         }
      }
      ...
      class b implements Comparator<ftv.b.a> {
         public int a(ftv.b.a $$0, ftv.b.a $$1) {
            ...
            if (b.this.o == null) {
               ...
               axe<dkd> $$6 = (axe<dkd>)b.this.o;
               $$4 = $$2 instanceof cvm ? ftv.this.H.a($$6, ((cvm)$$2).d()) : -1;
               $$5 = $$3 instanceof cvm ? ftv.this.H.a($$6, ((cvm)$$3).d()) : -1;
            } else {
               axe<cxc> $$9 = (axe<cxc>)b.this.o;
               $$4 = ftv.this.H.a($$9, $$2);
               $$5 = ftv.this.H.a($$9, $$3);
            }

            return $$4 == $$5 ? b.this.q * Integer.compare(cxc.a($$2), cxc.a($$3)) : b.this.q * Integer.compare($$4, $$5);
         }
      }
   }
   ...
   class c extends fov<ftv.c.a> {
      public c(final flz $$0) {
         ...
         for (bvi<?> $$1 : ma.f) {
            if (ftv.this.H.a(axf.g.b($$1)) > 0 || ftv.this.H.a(axf.h.b($$1)) > 0) {
      ...
      class a extends fov.a<ftv.c.a> {
         ...
         public a(final bvi<?> $$0) {
            this.b = $$0.h();
            int $$1 = ftv.this.H.a(axf.g.b($$0));
            if ($$1 == 0) {
               this.c = xk.a("stat_type.minecraft.killed.none", this.b);
               this.e = false;
            } else {
               this.c = xk.a("stat_type.minecraft.killed", $$1, this.b);
               this.e = true;
            }

            int $$2 = ftv.this.H.a(axf.h.b($$0));
            if ($$2 == 0) {
               this.d = xk.a("stat_type.minecraft.killed_by.none", this.b);
               this.f = false;
            } else {
               this.d = xk.a("stat_type.minecraft.killed_by", this.b, $$2);
               this.f = true;
            }
         }
         ...
         @Override
         public xk a() {
            return xk.a("narrator.select", xj.a(this.c, this.d));
         }
      }
   }
}
