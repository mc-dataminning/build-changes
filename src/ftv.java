...
public class ftv {
   ...
   static final ThreadLocal<ftv.d> f = ThreadLocal.withInitial(ftv.d::new);

   public ftv(ewd $$0) {
      this.d = $$0;
   }

   public void a(csl $$0, ggg $$1, dja $$2, hx $$3, ept $$4, epx $$5, boolean $$6, aup $$7, long $$8, int $$9) {
      boolean $$10 = eva.M() && $$2.h() == 0 && $$1.a();
      elm $$11 = $$2.n($$0, $$3);
      $$4.a($$11.c, $$11.d, $$11.e);
   ...
   public void b(csl $$0, ggg $$1, dja $$2, hx $$3, ept $$4, epx $$5, boolean $$6, aup $$7, long $$8, int $$9) {
      ...
      for (ic $$14 : c) {
         $$7.b($$8);
         List<ftw> $$15 = $$1.a($$2, $$14, $$7);
         if (!$$15.isEmpty()) {
            $$13.a($$3, $$14);
            if (!$$6 || cwj.a($$2, $$0, $$3, $$14, $$13)) {
      ...
      $$7.b($$8);
      List<ftw> $$16 = $$1.a($$2, null, $$7);
      if (!$$16.isEmpty()) {
         this.a($$0, $$2, $$3, $$4, $$5, $$16, $$10, $$11, $$12, $$9);
      }
   }

   public void c(csl $$0, ggg $$1, dja $$2, hx $$3, ept $$4, epx $$5, boolean $$6, aup $$7, long $$8, int $$9) {
      BitSet $$10 = new BitSet(3);
      hx.a $$11 = $$3.j();

      for (ic $$12 : c) {
         $$7.b($$8);
         List<ftw> $$13 = $$1.a($$2, $$12, $$7);
         if (!$$13.isEmpty()) {
            $$11.a($$3, $$12);
            if (!$$6 || cwj.a($$2, $$0, $$3, $$12, $$11)) {
               int $$14 = fsx.a($$0, $$2, $$11);
      ...
      $$7.b($$8);
      List<ftw> $$15 = $$1.a($$2, null, $$7);
      if (!$$15.isEmpty()) {
         this.a($$0, $$2, $$3, -1, $$9, true, $$4, $$5, $$15, $$10);
      }
   }

   private void a(csl $$0, dja $$1, hx $$2, ept $$3, epx $$4, List<ftw> $$5, float[] $$6, BitSet $$7, ftv.b $$8, int $$9) {
      for (ftw $$10 : $$5) {
   ...
   private void a(
      csl $$0, dja $$1, hx $$2, epx $$3, ept.a $$4, ftw $$5, float $$6, float $$7, float $$8, float $$9, int $$10, int $$11, int $$12, int $$13, int $$14
   ) {
      float $$16;
      float $$17;
      float $$18;
   ...
   private void a(csl $$0, dja $$1, hx $$2, int[] $$3, ic $$4, @Nullable float[] $$5, BitSet $$6) {
      float $$7 = 32.0F;
      float $$8 = 32.0F;
      float $$9 = 32.0F;
      float $$10 = -32.0F;
   ...
   private void a(csl $$0, dja $$1, hx $$2, int $$3, int $$4, boolean $$5, ept $$6, epx $$7, List<ftw> $$8, BitSet $$9) {
      for (ftw $$10 : $$8) {
         if ($$5) {
   ...
   public void a(ept.a $$0, epx $$1, @Nullable dja $$2, ggg $$3, float $$4, float $$5, float $$6, int $$7, int $$8) {
      aup $$9 = aup.a();
      long $$10 = 42L;
   ...
   private static void a(ept.a $$0, epx $$1, float $$2, float $$3, float $$4, List<ftw> $$5, int $$6, int $$7) {
      for (ftw $$8 : $$5) {
         float $$9;
         float $$10;
         float $$11;
         if ($$8.c()) {
            $$9 = aui.a($$2, 0.0F, 1.0F);
            $$10 = aui.a($$3, 0.0F, 1.0F);
            $$11 = aui.a($$4, 0.0F, 1.0F);
         } else {
            $$9 = 1.0F;
            $$10 = 1.0F;
            $$11 = 1.0F;
   ...
   protected static enum a {
      a(
         ...
         0.5F,
         true,
         new ftv.e[]{ftv.e.k, ftv.e.d, ftv.e.k, ftv.e.j, ftv.e.e, ftv.e.j, ftv.e.e, ftv.e.d},
         new ftv.e[]{ftv.e.k, ftv.e.c, ftv.e.k, ftv.e.i, ftv.e.e, ftv.e.i, ftv.e.e, ftv.e.c},
         new ftv.e[]{ftv.e.l, ftv.e.c, ftv.e.l, ftv.e.i, ftv.e.f, ftv.e.i, ftv.e.f, ftv.e.c},
         new ftv.e[]{ftv.e.l, ftv.e.d, ftv.e.l, ftv.e.j, ftv.e.f, ftv.e.j, ftv.e.f, ftv.e.d}
      ),
      b(
         new ic[]{ic.f, ic.e, ic.c, ic.d},
         1.0F,
         true,
         new ftv.e[]{ftv.e.f, ftv.e.d, ftv.e.f, ftv.e.j, ftv.e.l, ftv.e.j, ftv.e.l, ftv.e.d},
         new ftv.e[]{ftv.e.f, ftv.e.c, ftv.e.f, ftv.e.i, ftv.e.l, ftv.e.i, ftv.e.l, ftv.e.c},
         new ftv.e[]{ftv.e.e, ftv.e.c, ftv.e.e, ftv.e.i, ftv.e.k, ftv.e.i, ftv.e.k, ftv.e.c},
         new ftv.e[]{ftv.e.e, ftv.e.d, ftv.e.e, ftv.e.j, ftv.e.k, ftv.e.j, ftv.e.k, ftv.e.d}
      ),
      c(
         new ic[]{ic.b, ic.a, ic.f, ic.e},
         0.8F,
         true,
         new ftv.e[]{ftv.e.b, ftv.e.k, ftv.e.b, ftv.e.e, ftv.e.h, ftv.e.e, ftv.e.h, ftv.e.k},
         new ftv.e[]{ftv.e.b, ftv.e.l, ftv.e.b, ftv.e.f, ftv.e.h, ftv.e.f, ftv.e.h, ftv.e.l},
         new ftv.e[]{ftv.e.a, ftv.e.l, ftv.e.a, ftv.e.f, ftv.e.g, ftv.e.f, ftv.e.g, ftv.e.l},
         new ftv.e[]{ftv.e.a, ftv.e.k, ftv.e.a, ftv.e.e, ftv.e.g, ftv.e.e, ftv.e.g, ftv.e.k}
      ),
      d(
         new ic[]{ic.e, ic.f, ic.a, ic.b},
         0.8F,
         true,
         new ftv.e[]{ftv.e.b, ftv.e.k, ftv.e.h, ftv.e.k, ftv.e.h, ftv.e.e, ftv.e.b, ftv.e.e},
         new ftv.e[]{ftv.e.a, ftv.e.k, ftv.e.g, ftv.e.k, ftv.e.g, ftv.e.e, ftv.e.a, ftv.e.e},
         new ftv.e[]{ftv.e.a, ftv.e.l, ftv.e.g, ftv.e.l, ftv.e.g, ftv.e.f, ftv.e.a, ftv.e.f},
         new ftv.e[]{ftv.e.b, ftv.e.l, ftv.e.h, ftv.e.l, ftv.e.h, ftv.e.f, ftv.e.b, ftv.e.f}
      ),
      e(
         new ic[]{ic.b, ic.a, ic.c, ic.d},
         0.6F,
         true,
         new ftv.e[]{ftv.e.b, ftv.e.d, ftv.e.b, ftv.e.j, ftv.e.h, ftv.e.j, ftv.e.h, ftv.e.d},
         new ftv.e[]{ftv.e.b, ftv.e.c, ftv.e.b, ftv.e.i, ftv.e.h, ftv.e.i, ftv.e.h, ftv.e.c},
         new ftv.e[]{ftv.e.a, ftv.e.c, ftv.e.a, ftv.e.i, ftv.e.g, ftv.e.i, ftv.e.g, ftv.e.c},
         new ftv.e[]{ftv.e.a, ftv.e.d, ftv.e.a, ftv.e.j, ftv.e.g, ftv.e.j, ftv.e.g, ftv.e.d}
      ),
      f(
         new ic[]{ic.a, ic.b, ic.c, ic.d},
         0.6F,
         true,
         new ftv.e[]{ftv.e.g, ftv.e.d, ftv.e.g, ftv.e.j, ftv.e.a, ftv.e.j, ftv.e.a, ftv.e.d},
         new ftv.e[]{ftv.e.g, ftv.e.c, ftv.e.g, ftv.e.i, ftv.e.a, ftv.e.i, ftv.e.a, ftv.e.c},
         new ftv.e[]{ftv.e.h, ftv.e.c, ftv.e.h, ftv.e.i, ftv.e.b, ftv.e.i, ftv.e.b, ftv.e.c},
         new ftv.e[]{ftv.e.h, ftv.e.d, ftv.e.h, ftv.e.j, ftv.e.b, ftv.e.j, ftv.e.b, ftv.e.d}
      );
      ...
      final ftv.e[] k;
      final ftv.e[] l;
      private static final ftv.a[] m = ac.a(new ftv.a[6], $$0 -> {
         $$0[ic.a.d()] = a;
         $$0[ic.b.d()] = b;
         $$0[ic.c.d()] = c;
         $$0[ic.d.d()] = d;
      ...
      private a(ic[] $$0, float $$1, boolean $$2, ftv.e[] $$3, ftv.e[] $$4, ftv.e[] $$5, ftv.e[] $$6) {
         this.g = $$0;
         this.h = $$2;
         this.i = $$3;
         this.j = $$4;
   ...
   static class b {
      ...
      public void a(csl $$0, dja $$1, hx $$2, ic $$3, float[] $$4, BitSet $$5, boolean $$6) {
         ...
         dja $$23 = $$0.a_($$9.a($$7, $$8.g[0]).c($$3));
         boolean $$24 = !$$23.p($$0, $$9) || $$23.b($$0, $$9) == 0;
         dja $$25 = $$0.a_($$9.a($$7, $$8.g[1]).c($$3));
         boolean $$26 = !$$25.p($$0, $$9) || $$25.b($$0, $$9) == 0;
         dja $$27 = $$0.a_($$9.a($$7, $$8.g[2]).c($$3));
         boolean $$28 = !$$27.p($$0, $$9) || $$27.b($$0, $$9) == 0;
         dja $$29 = $$0.a_($$9.a($$7, $$8.g[3]).c($$3));
   ...
   static enum c {
      ...
      final int i;
      final int j;
      private static final ftv.c[] k = ac.a(new ftv.c[6], $$0 -> {
         $$0[ic.a.d()] = a;
         $$0[ic.b.d()] = b;
         $$0[ic.c.d()] = c;
         $$0[ic.d.d()] = d;
   ...
   static class d {
      ...
      public float b(dja $$0, csl $$1, hx $$2) {
         long $$3 = $$2.a();
         if (this.a) {
