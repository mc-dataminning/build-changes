public class ftv<T extends cev> extends fug<T> {
   private float j;
   private float k;
   private float l;
   ...
   public void a(T $$0, float $$1, float $$2, float $$3, float $$4, float $$5) {
      ...
      boolean $$10 = $$0.gH();
      if ($$6) {
         this.a.f = 0.35F * ayf.a(0.6F * $$3);
         this.a.g = 0.35F * ayf.a(0.6F * $$3);
         this.h.e = -0.75F * ayf.a(0.3F * $$3);
         this.i.e = 0.75F * ayf.a(0.3F * $$3);
      } else {
         this.a.g = 0.0F;
      }
      ...
      if (this.j > 0.0F) {
         ...
         this.g.g = -0.5707964F;
         if ($$9) {
            this.a.e = (float) (Math.PI / 2) + 0.2F * ayf.a($$3 * 0.6F);
            this.h.e = -0.4F - 0.2F * ayf.a($$3 * 0.6F);
            this.i.e = -0.4F - 0.2F * ayf.a($$3 * 0.6F);
         }
      ...
      if (this.k > 0.0F) {
         this.f.e = -0.6F * ayf.a($$3 * 0.15F);
         this.g.e = 0.6F * ayf.a($$3 * 0.15F);
         this.h.e = 0.3F * ayf.a($$3 * 0.25F);
         this.i.e = -0.3F * ayf.a($$3 * 0.25F);
         this.a.e = ftt.a(this.a.e, (float) (Math.PI / 2), this.k);
      }

      if (this.l > 0.0F) {
         this.a.e = ftt.a(this.a.e, 2.0561945F, this.l);
         this.f.e = -0.5F * ayf.a($$3 * 0.5F);
         this.g.e = 0.5F * ayf.a($$3 * 0.5F);
         this.h.e = 0.5F * ayf.a($$3 * 0.5F);
         this.i.e = -0.5F * ayf.a($$3 * 0.5F);
      }
   }
}
