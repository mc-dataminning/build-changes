...
public class ftv extends fun<bze, ffk> {
   private static final aew a = new aew("textures/entity/guardian.png");
   private static final aew i = new aew("textures/entity/guardian_beam.png");
   ...
   private ehn a(bjg $$0, double $$1, float $$2) {
      double $$3 = arw.d((double)$$2, $$0.ac, $$0.dq());
      double $$4 = arw.d((double)$$2, $$0.ad, $$0.ds()) + $$1;
      double $$5 = arw.d((double)$$2, $$0.ae, $$0.dw());
   ...
   public void a(bze $$0, float $$1, float $$2, elp $$3, foe $$4, int $$5) {
      ...
      if ($$6 != null) {
         ...
         float $$23 = 0.2F;
         float $$24 = 0.282F;
         float $$25 = arw.b($$18 + (float) (Math.PI * 3.0 / 4.0)) * 0.282F;
         float $$26 = arw.a($$18 + (float) (Math.PI * 3.0 / 4.0)) * 0.282F;
         float $$27 = arw.b($$18 + (float) (Math.PI / 4)) * 0.282F;
         float $$28 = arw.a($$18 + (float) (Math.PI / 4)) * 0.282F;
         float $$29 = arw.b($$18 + ((float) Math.PI * 5.0F / 4.0F)) * 0.282F;
         float $$30 = arw.a($$18 + ((float) Math.PI * 5.0F / 4.0F)) * 0.282F;
         float $$31 = arw.b($$18 + ((float) Math.PI * 7.0F / 4.0F)) * 0.282F;
         float $$32 = arw.a($$18 + ((float) Math.PI * 7.0F / 4.0F)) * 0.282F;
         float $$33 = arw.b($$18 + (float) Math.PI) * 0.2F;
         float $$34 = arw.a($$18 + (float) Math.PI) * 0.2F;
         float $$35 = arw.b($$18 + 0.0F) * 0.2F;
         float $$36 = arw.a($$18 + 0.0F) * 0.2F;
         float $$37 = arw.b($$18 + (float) (Math.PI / 2)) * 0.2F;
         float $$38 = arw.a($$18 + (float) (Math.PI / 2)) * 0.2F;
         float $$39 = arw.b($$18 + (float) (Math.PI * 3.0 / 2.0)) * 0.2F;
         float $$40 = arw.a($$18 + (float) (Math.PI * 3.0 / 2.0)) * 0.2F;
         float $$42 = 0.0F;
         float $$43 = 0.4999F;
         float $$44 = -1.0F + $$9;
         float $$45 = $$14 * 2.5F + $$44;
