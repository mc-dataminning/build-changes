...
public abstract class eni<M extends enf<M>> {
   private final dcg i;
   ...
   protected final Long2ObjectMap<duc> g = Long2ObjectMaps.synchronize(new Long2ObjectOpenHashMap());
   private final LongSet k = new LongOpenHashSet();
   private final LongSet l = new LongOpenHashSet();
   protected volatile boolean h;

   protected eni(dcg $$0, duk $$1, M $$2) {
      this.i = $$0;
      this.a = $$1;
      this.d = $$2;
      this.c = $$2.b();
   ...
   @Nullable
   protected duc a(long $$0, boolean $$1) {
      return this.a($$1 ? this.d : this.c, $$0);
   }

   @Nullable
   protected duc a(M $$0, long $$1) {
      return $$0.c($$1);
   }

   @Nullable
   protected duc c(long $$0) {
      duc $$1 = this.d.c($$0);
      if ($$1 == null) {
         return null;
      } else {
   ...
   protected duc g(long $$0) {
      duc $$1 = (duc)this.g.get($$0);
      return $$1 != null ? $$1 : new duc();
   }
   ...
   protected void a(enl<M, ?> $$0) {
      if (this.h) {
         ...
         this.l.clear();
         ObjectIterator<Entry<duc>> $$5x = Long2ObjectMaps.fastIterator(this.g);

         while ($$5x.hasNext()) {
            Entry<duc> $$6 = (Entry<duc>)$$5x.next();
            long $$7 = $$6.getLongKey();
            if (this.b($$7)) {
               duc $$8 = (duc)$$6.getValue();
               if (this.d.c($$7) != $$8) {
                  this.d.a($$7, $$8);
                  this.e.add($$7);
               }
   ...
   protected void a(long $$0, @Nullable duc $$1) {
      if ($$1 != null) {
         this.g.put($$0, $$1);
         this.h = true;
      } else {
            ...
            for (int $$6 = -1; $$6 <= 1; $$6++) {
               for (int $$7 = -1; $$7 <= 1; $$7++) {
                  if ($$5 != 0 || $$6 != 0 || $$7 != 0) {
                     long $$8 = kb.a($$0, $$5, $$6, $$7);
                     byte $$9 = this.b.get($$8);
                     this.a($$8, eni.a.a($$9, eni.a.b($$9) + $$4));
                  }
               }
            }
         }
   ...
   public eni.b k(long $$0) {
      return eni.a.c(this.b.get($$0));
   }
   ...
   protected static class a {
      ...
      public static eni.b c(byte $$0) {
         if ($$0 == 0) {
            return eni.b.a;
         } else {
            return a($$0) ? eni.b.c : eni.b.b;
         }
      }
   }
