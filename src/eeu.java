...
public class eeu extends LongLinkedOpenHashSet {
   private final eeu.a a;

   public eeu(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new eeu.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = aup.f(60000000);
      private static final int b = aup.f(60000000);
