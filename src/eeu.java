...
public class eeu extends eec {
   private static final Codec<List<eeu.b>> b = arf.a(eeu.b.a.listOf(), (Function<List<eeu.b>, DataResult<List<eeu.b>>>)($$0 -> {
      Set<he<bib>> $$1 = new ObjectOpenHashSet();
   ...
   public static final Codec<eeu> a = RecordCodecBuilder.create(
      $$0 -> a($$0).and(arf.a(b, "effects", List.of()).forGetter($$0x -> $$0x.c)).apply($$0, eeu::new)
   );
   ...
   static record b(he<bib> b, egk c) {
      public static final Codec<eeu.b> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(jb.e.r().fieldOf("type").forGetter(eeu.b::a), egl.a.fieldOf("duration").forGetter(eeu.b::b)).apply($$0, eeu.b::new)
      );
