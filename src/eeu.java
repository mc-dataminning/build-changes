...
@Deprecated
public class eeu extends eef<eeu.a> {
   private static final dvd a = dia.nc.m();

   public eeu(Codec<eeu.a> $$0) {
      super($$0);
   }

   @Override
   public boolean a(eeh<eeu.a> $$0) {
      jg $$1 = $$0.e();
      dfs $$2 = $$0.b();
      azr $$3 = $$0.d();
      eeu.a $$4 = $$0.f();
   ...
   public static record a(eik b, eik c) implements egj {
      public static final Codec<eeu.a> a = RecordCodecBuilder.create(
         $$0 -> $$0.group(eik.a.fieldOf("fluid").forGetter(eeu.a::a), eik.a.fieldOf("barrier").forGetter(eeu.a::b)).apply($$0, eeu.a::new)
      );
