...
public class eoo {
   ...
   public static final eoo.a bv;

   public static eoo.a a(int $$0, int $$1) {
      return $$0 == -1 ? eoo.b.b.a($$1) : eoo.b.a.a($$0);
   }

   public static eoo.a a(String $$0) {
      if (eoo.a.e.containsKey($$0)) {
         return eoo.a.e.get($$0);
      } else {
         for (eoo.b $$1 : eoo.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final eoo.b b;
      private final int c;
      private final aud<vd> d;
      static final Map<String, eoo.a> e = Maps.newHashMap();

      a(String $$0, eoo.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new aud<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      a("key.keyboard", ($$0, $$1) -> {
         if ("key.keyboard.unknown".equals($$1)) {
            ...
            return $$2 != null ? vd.b($$2.toUpperCase(Locale.ROOT)) : vd.c($$1);
         }
      }),
      b("scancode", ($$0, $$1) -> {
         String $$2 = GLFW.glfwGetKeyName(-1, $$0);
         return $$2 != null ? vd.b($$2) : vd.c($$1);
      }),
      c("key.mouse", ($$0, $$1) -> sg.a().b($$1) ? vd.c($$1) : vd.a("key.mouse", $$0 + 1));

      private static final String d = "key.keyboard.unknown";
      private final Int2ObjectMap<eoo.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, vd> g;

      private static void a(eoo.b $$0, String $$1, int $$2) {
         eoo.a $$3 = new eoo.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }

      private b(String $$0, BiFunction<Integer, String, vd> $$1) {
         this.f = $$0;
         this.g = $$1;
      }

      public eoo.a a(int $$0) {
         return (eoo.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
