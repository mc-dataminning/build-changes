public class eoo {
   ...
   public boolean a(dcc $$0, int $$1, int $$2, int $$3) {
      int $$4 = $$2 + 1;
      int $$5 = c($$1, $$3);
      int $$6 = this.b($$5);
      if ($$4 < $$6) {
   ...
   private boolean a(dcc $$0, int $$1, int $$2, jd $$3, dtc $$4, jd $$5, dtc $$6) {
      int $$7 = $$3.v();
      if (a($$0, $$3, $$4, $$5, $$6)) {
         if ($$7 > $$2) {
            this.b($$1, $$7);
   ...
   private int a(dcc $$0, jd $$1, dtc $$2) {
      jd.a $$3 = this.e.g($$1);
   ...
   private static boolean a(dcc $$0, jd $$1, dtc $$2, jd $$3, dtc $$4) {
      if ($$4.b($$0, $$3) != 0) {
         return true;
      } else {
         exv $$5 = eov.a($$0, $$1, $$2, ji.a);
         exv $$6 = eov.a($$0, $$3, $$4, ji.b);
         return exs.b($$5, $$6);
      }
   }
