...
public class eoo {
   ...
   public void a(epy $$0, String $$1, equ.a $$2, ees $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eoo.b $$13 = new eoo.b($$1.trim(), this.f, $$3, $$2);
                  eoo.a $$14 = new eoo.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eoo.c $$30 = new eoo.c(this.f, $$2, $$0);
                        eoo.a $$31 = new eoo.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new eqc(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, ees $$2) throws IOException {
      ...
      File $$15 = new File(eti.N().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(String $$0, File $$1, ees $$2, equ.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eoo.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eoo.this.b && !eoo.this.d) {
            try {
               eoo.this.e = true;
               eoo.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eoo.a.error("Error extracting archive", var3);
               eoo.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final equ.a c;
      private final epy d;

      c(File $$0, equ.a $$1, epy $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eoo.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eoo.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eoo.this.g);
                  eoo.this.c = true;
               } else {
                  eoo.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eoo.this.d = true;
               }
            } catch (IOException var3) {
               eoo.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eoo.this.d = true;
            }
         }
      }
