...
public class cll extends cmq implements cmb {
   ...
   public cll(bur<? extends cll> $$0, dgh $$1) {
      super($$0, $$1);
   ...
   protected void p() {
      ...
      this.bS.a(6, new cll.e(this, 1.0, this.dV().P()));
      this.bS.a(7, new cdb(this, 1.0));
      this.bT.a(1, new cdw(this, cll.class).a(cms.class));
      this.bT.a(2, new cdx<>(this, cow.class, 10, true, false, ($$0, $$1) -> this.j($$0)));
   ...
   public static boolean a(bur<cll> $$0, dgy $$1, buq $$2, ji $$3, azh $$4) {
   ...
   protected void a(azh $$0, bsh $$1) {
      if ((double)$$0.i() > 0.9) {
         int $$2 = $$0.a(16);
         if ($$2 < 10) {
            this.a(bus.a, new cwo(cws.wS));
         } else {
            this.a(bus.a, new cwo(cws.rS));
         }
      }
   }
   ...
   protected boolean a(cwo $$0, cwo $$1, bus $$2) {
      return $$1.a(cws.wT) ? false : super.a($$0, $$1, $$2);
   }
   ...
   public void a(bvg $$0, float $$1) {
      cwo $$2 = this.eZ();
      cwo $$3 = $$2.a(cws.wS) ? $$2 : new cwo(cws.wS);
      cqc $$4 = new cqc(this.dV(), this, $$3);
      double $$5 = $$0.dA() - this.dA();
      double $$6 = $$0.e(0.3333333333333333) - $$4.dC();
      double $$7 = $$0.dG() - this.dG();
      double $$8 = Math.sqrt($$5 * $$5 + $$7 * $$7);
      if (this.dV() instanceof ard $$9) {
         cpp.a($$4, $$9, $$3, $$5, $$6 + $$8 * 0.2F, $$7, 1.6F, (float)(14 - this.dV().am().a() * 4));
      }
   ...
   static class e extends cce {
      ...
      public void a() {
         if (this.a.dC() < (double)(this.c - 1) && (this.a.P().k() || this.a.gu())) {
            faz $$0 = cgb.a(this.a, 4, 8, new faz(this.a.dA(), (double)(this.c - 1), this.a.dG()), (float) (Math.PI / 2));
            if ($$0 == null) {
               this.d = true;
               return;
            }
   ...
   static class f extends cdd {
      ...
      @Override
      public boolean b() {
         return super.b() && this.a.eZ().a(cws.wS);
      }
