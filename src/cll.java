...
public abstract class cll extends ciz implements bwz, bxq, bxt {
   ...
   private static final akj<Byte> ce = akn.a(cll.class, akl.a);
   ...
   protected cll(bwr<? extends cll> $$0, djh $$1) {
      super($$0, $$1);
      this.gS();
   }
   ...
   protected void D() {
      ...
      this.bD.a(2, new cdr(this, 1.0, cll.class));
   ...
   private boolean b(duj $$0) {
      return $$0 == duj.b || $$0 == duj.aV || $$0 == duj.B || $$0 == duj.aW || $$0 == duj.aU;
   }
   ...
   public void k_() {
      ...
      if (this.dU() instanceof arq $$0 && this.bI()) {
         ...
         if (this.gW()) {
            if (!this.gN() && !this.bY() && this.ae.a(300) == 0 && $$0.a_(this.du().e()).a(dmo.i)) {
               this.A(true);
            }
   ...
   protected void g(arq $$0) {
      if (this.gP() && this.n_() && !this.gN()) {
         bxj $$1 = $$0.a(cll.class, bQ, this, this.dz(), this.dB(), this.dF(), this.cQ().g(16.0));
   ...
   protected few i(bxj $$0) {
      return new few($$0.dM() * 0.5F, $$0.dK());
   }
   ...
   protected fex b(crj $$0, fex $$1) {
      if (this.aH() && this.ca == 0.0F && this.gO() && !this.cb) {
         ...
         return new fex((double)$$2, 0.0, (double)$$3);
      }
   }
   ...
   protected void b(float $$0, fex $$1) {
   ...
   private fex a(fex $$0, bxj $$1) {
      ...
      while (var10.hasNext()) {
         ...
         do {
            ...
            if (cuc.a($$8)) {
               fes $$9 = $$1.f($$6);
               fex $$10 = new fex($$2, (double)$$5.v() + $$8, $$4);
               if (cuc.a(this.dU(), $$1, $$9.c($$10))) {
                  $$1.b($$6);
                  return $$10;
               }
            }
   ...
   @Override
   public fex b(bxj $$0) {
      fex $$1 = a((double)this.dp(), (double)$$0.dp(), this.dK() + ($$0.fx() == bxa.b ? 90.0F : -90.0F));
      fex $$2 = this.a($$1, $$0);
      if ($$2 != null) {
         return $$2;
      } else {
         fex $$3 = a((double)this.dp(), (double)$$0.dp(), this.dK() + ($$0.fx() == bxa.a ? 90.0F : -90.0F));
         fex $$4 = this.a($$3, $$0);
   ...
   protected fex a(bwi $$0, bwl $$1, float $$2) {
      return super.a($$0, $$1, $$2)
         .e(new fex(0.0, 0.15 * (double)this.cs * (double)$$2, -0.7 * (double)this.cs * (double)$$2).b(-this.dK() * (float) (Math.PI / 180.0)));
   }
