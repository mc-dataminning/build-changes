...
public class etu {
   ...
   static class b {
      static final Optional<etu> a = Optional.ofNullable(a());
      ...
      private static etu a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new etu();
      }
   }
}
