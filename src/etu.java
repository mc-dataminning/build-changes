...
public class etu extends ety implements etw {
   ...
   public etu.c a() {
      return new etu.c(this.q, this.m, this.u, this.v);
   }
   ...
   public void a(eue.b $$0, eue $$1) {
      if (this.t) {
         ...
         this.q = $$0;
         this.a($$1);
         this.n = (euf)$$1.c().get(0);
         this.o = 0;
         this.h.rewind();
      }
   }

   private void a(eue $$0) {
      if (this.p != $$0) {
         this.p = $$0;
         boolean $$1 = $$0 == etx.k;
         boolean $$2 = $$0 == etx.j;
   ...
   private IntConsumer a(int $$0, eue.a $$1) {
   ...
   private etu.b q() {
      ...
      this.k += $$5;
      this.j++;
      etu.a $$9 = new etu.a(this.p, this.m, $$0, this.q, $$2, this.w, $$4);
      return new etu.b($$8, $$9);
   }
   ...
   public void e() {
      if (this.o != 0) {
         ...
         this.m++;
         this.m();
         if (this.q == eue.b.a || this.q == eue.b.b) {
            int $$0 = this.p.b();
   ...
   @Override
   public void f() {
      ImmutableList<euf> $$0 = this.p.c();
      this.o = (this.o + 1) % $$0.size();
      this.l = this.l + this.n.e();
      euf $$1 = (euf)$$0.get(this.o);
      this.n = $$1;
      if ($$1.b() == euf.b.e) {
         this.f();
      }

      if (this.a && this.n.b() == euf.b.c) {
         etw.super.a(this.b, this.c, this.d, this.e);
      }
   }
   ...
   public void a(
      ...
      if (this.a) {
         ...
         this.a($$14 + 4, etw.a($$11));
         this.a($$14 + 5, etw.a($$12));
         this.a($$14 + 6, etw.a($$13));
         this.l += $$14 + 8;
         this.e();
      } else {
   ...
   public static record a(eue a, int b, int c, eue.b d, eue.a e, boolean f, boolean g) {
   ...
   public static class c {
      ...
      c(eue.b $$0, int $$1, @Nullable Vector3f[] $$2, @Nullable euh $$3) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = $$3;
