...
public class ghk implements ghp.a {
   ...
   private final fft J;
   private final Map<ja, ghk.a> K = Maps.newHashMap();
   private final Map<UUID, zz.a> L = Maps.newHashMap();
   @Nullable
   private UUID M;
   ...
   private void b() {
      this.L.entrySet().removeIf($$0 -> {
         bsg $$1 = this.J.r.a($$0.getValue().b());
         return $$1 == null || $$1.dL();
      });
   }

   private void b(fam $$0, ged $$1, double $$2, double $$3, double $$4) {
      ja $$5 = ja.a($$2, $$3, $$4);
   ...
   private static void a(fam $$0, ged $$1, ja $$2) {
      float $$3 = 0.05F;
      ghp.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
   }

   private void a(fam $$0, ged $$1, ja $$2, List<String> $$3) {
      float $$4 = 0.05F;
      ghp.a($$0, $$1, $$2, 0.05F, 0.2F, 0.2F, 1.0F, 0.3F);
      a($$0, $$1, $$3 + "", $$2, 0, -256);
   ...
   private void a(fam $$0, ged $$1, ghk.a $$2) {
      int $$3 = 0;
   ...
   private void a(fam $$0, ged $$1, zz.a $$2, double $$3, double $$4, double $$5) {
      if ($$2.j() != null) {
         ghx.a($$0, $$1, $$2.j(), 0.5F, false, false, $$3, $$4, $$5);
      }
   }

   private void b(fam $$0, ged $$1, zz.a $$2, double $$3, double $$4, double $$5) {
      boolean $$6 = this.b($$2);
      int $$7 = 0;
   ...
   private static void a(fam $$0, ged $$1, String $$2, ghk.a $$3, int $$4, int $$5) {
      a($$0, $$1, $$2, $$3.a, $$4, $$5);
   }

   private static void a(fam $$0, ged $$1, String $$2, ja $$3, int $$4, int $$5) {
      double $$6 = 1.3;
      double $$7 = 0.2;
      double $$8 = (double)$$3.u() + 0.5;
      double $$9 = (double)$$3.v() + 1.3 + (double)$$4 * 0.2;
      double $$10 = (double)$$3.w() + 0.5;
      ghp.a($$0, $$1, $$2, $$8, $$9, $$10, $$5, 0.02F, true, 0.0F, true);
   }

   private static void a(fam $$0, ged $$1, jt $$2, int $$3, String $$4, int $$5, float $$6) {
      double $$7 = 2.4;
      double $$8 = 0.25;
      ja $$9 = ja.a($$2);
      ...
      float $$13 = 0.5F;
      ghp.a($$0, $$1, $$4, $$10, $$11, $$12, $$5, $$6, false, 0.5F, true);
   }

   private Set<String> b(ghk.a $$0) {
      return this.b($$0.a).stream().map(afx::a).collect(Collectors.toSet());
   }

   private Set<String> c(ghk.a $$0) {
      return this.c($$0.a).stream().map(afx::a).collect(Collectors.toSet());
   }

   private boolean b(zz.a $$0) {
      return Objects.equals(this.M, $$0.a());
   }

   private boolean c(zz.a $$0) {
      cmk $$1 = this.J.s;
      ja $$2 = ja.a($$1.dv(), $$0.h().b(), $$1.dB());
      ja $$3 = ja.a($$0.h());
      return $$2.a($$3, 30.0);
   }

   private Collection<UUID> b(ja $$0) {
      return this.L.values().stream().filter($$1 -> $$1.a($$0)).map(zz.a::a).collect(Collectors.toSet());
   }

   private Collection<UUID> c(ja $$0) {
      return this.L.values().stream().filter($$1 -> $$1.b($$0)).map(zz.a::a).collect(Collectors.toSet());
   }

   private Map<ja, List<String>> c() {
      Map<ja, List<String>> $$0 = Maps.newHashMap();

      for (zz.a $$1 : this.L.values()) {
         for (ja $$2 : Iterables.concat($$1.q(), $$1.r())) {
   ...
   private void d() {
      ghp.a(this.J.an(), 8).ifPresent($$0 -> this.M = $$0.cA());
   }
