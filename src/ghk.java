...
public class ghk implements ggy.a {
   private final ffd a;
   private double b = Double.MIN_VALUE;
   private List<bss> c = Collections.emptyList();
   ...
   private void a(ezw $$0, gdm $$1, double $$2, double $$3, double $$4, bss $$5, DoubleSupplier $$6, float $$7, float $$8, float $$9) {
      $$5.aE.ifPresent($$10 -> {
   ...
   private void a(iz $$0, ezw $$1, double $$2, double $$3, double $$4, gdm $$5, double $$6, float $$7, float $$8, float $$9) {
      ...
      gdk.a($$1, $$5.getBuffer(gdu.y()), $$10, $$11, $$12, $$13, $$14, $$15, $$7, $$8, $$9, 0.4F);
      gdk.a(
         $$1,
         $$5.getBuffer(gdu.y()),
         this.a.r.a_($$0).b(this.a.r, $$0, evu.a()).a((double)$$0.u(), (double)$$0.v(), (double)$$0.w()),
         -$$2,
         -$$3,
         -$$4,
         $$7,
