...
public class ghk implements ghc.a {
   private final Map<Integer, eol> a = Maps.newHashMap();
   ...
   public void a(int $$0, eol $$1, float $$2) {
      this.a.put($$0, $$1);
      this.c.put($$0, ac.c());
      this.b.put($$0, $$2);
   }
   ...
   public static void a(faa $$0, gdq $$1, eol $$2, float $$3, boolean $$4, boolean $$5, double $$6, double $$7, double $$8) {
      a($$0, $$1.getBuffer(gdy.a(6.0)), $$2, $$6, $$7, $$8);
      iz $$9 = $$2.l();
      if (a($$9, $$6, $$7, $$8) <= 80.0F) {
         ghc.a(
            $$0,
      ...
      if ($$5) {
         for (int $$17 = 0; $$17 < $$2.e(); $$17++) {
            ...
            if (a($$18.a(), $$6, $$7, $$8) <= 80.0F) {
               ghc.a($$0, $$1, String.valueOf($$18.l), (double)$$18.a + 0.5, (double)$$18.b + 0.75, (double)$$18.c + 0.5, -1, 0.02F, true, 0.0F, true);
               ghc.a(
                  $$0,
                  $$1,
   ...
   public static void a(faa $$0, fae $$1, eol $$2, double $$3, double $$4, double $$5) {
      for (int $$6 = 0; $$6 < $$2.e(); $$6++) {
         eoj $$7 = $$2.a($$6);
