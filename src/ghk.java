...
public class ghk {
   ...
   public ghk(gyd $$0, gye $$1) {
      this.f = $$0;
      this.e = $$1;
   }

   public void a(gwp $$0, fdi $$1, ghl $$2, boolean $$3, int $$4) {
      Matrix4f $$5 = $$1.c().a();
      fdm $$6 = $$2.getBuffer(ghv.t($$0.a));
      ...
      for (gwp.a $$8 : $$0.b) {
         if (!$$3 || $$8.e) {
            ...
            if ($$8.f != null) {
               ...
               float $$14 = azf.a(25.0F / $$13, 0.0F, 6.0F / 9.0F);
               $$1.a();
               $$1.a((float)$$8.b / 2.0F + 64.0F - $$13 * $$14 / 2.0F, (float)$$8.c / 2.0F + 64.0F + 4.0F, -0.025F);
               $$1.b($$14, $$14, 1.0F);
               $$1.a(0.0F, 0.0F, -0.1F);
               $$12.a($$8.f, 0.0F, 0.0F, -1, false, $$1.c().a(), $$2, fjz.a.a, Integer.MIN_VALUE, $$4);
               $$1.b();
            }
   ...
   public void a(esl $$0, esn $$1, gwp $$2) {
      $$2.a = this.e.b($$0, $$1);
      $$2.b.clear();
