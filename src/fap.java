...
public class fap {
   public static List<fbr> a(fap.a... $$0) {
      for (fap.a $$1 : $$0) {
         a($$1.j);
      }

      List<fbr> $$2 = Lists.newArrayList();

      for (fap.a $$3 : $$0) {
         $$2.add(new fbr($$3.i, a($$3.j)));
      }

      $$2.sort(Comparator.comparingInt(fbr::a));
      return $$2;
   }
   ...
   public static List<fbr> a() {
      return a(fap.a.values());
   }
