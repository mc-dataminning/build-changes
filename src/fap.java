...
public class fap extends ezd<cgc> {
   private static final aeu x = new aeu("container/stonecutter/scroller");
   private static final aeu y = new aeu("container/stonecutter/scroller_disabled");
   private static final aeu z = new aeu("container/stonecutter/recipe_selected");
   private static final aeu A = new aeu("container/stonecutter/recipe_highlighted");
   private static final aeu B = new aeu("container/stonecutter/recipe");
   private static final aeu C = new aeu("textures/gui/container/stonecutter.png");
      ...
      if (this.P) {
         ...
         for (int $$7 = this.O; $$7 < $$5 && $$7 < this.p.n(); $$7++) {
            ...
            if ($$1 >= $$9 && $$1 < $$9 + 16 && $$2 >= $$10 && $$2 < $$10 + 18) {
               $$0.b(this.i, $$6.get($$7).b().a(this.f.r.B_()), $$1, $$2);
            }
         }
      }
   }
   ...
   private void b(esa $$0, int $$1, int $$2, int $$3) {
      List<cmf<cmw>> $$4 = this.p.m();
      ...
      for (int $$5 = this.O; $$5 < $$3 && $$5 < this.p.n(); $$5++) {
         ...
         int $$8 = $$6 / 4;
         int $$9 = $$2 + $$8 * 18 + 2;
         $$0.a($$4.get($$5).b().a(this.f.r.B_()), $$7, $$9);
      }
   }
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      if (this.F()) {
         ...
         this.M = ars.a(this.M - $$5, 0.0F, 1.0F);
