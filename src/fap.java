...
public abstract class fap<T extends fap<T>> {
   ...
   public fap(String $$0, int $$1, int $$2) {
      try {
         this.b = $$0;
         Proxy $$3 = fan.a();
         if ($$3 != null) {
         ...
         throw new fby(var5.getMessage(), var5);
      } catch (IOException var6) {
         throw new fby(var6.getMessage(), var6);
      }
   }
   ...
   public int b() {
      try {
         ...
         throw new fby(var2.getMessage(), var2);
      }
   }
   ...
   public static fap<?> a(String $$0) {
      return new fap.b($$0, 5000, 60000);
   }

   public static fap<?> a(String $$0, int $$1, int $$2) {
      return new fap.b($$0, $$1, $$2);
   }

   public static fap<?> b(String $$0, String $$1) {
      return new fap.c($$0, $$1, 5000, 60000);
   }

   public static fap<?> a(String $$0, String $$1, int $$2, int $$3) {
      return new fap.c($$0, $$1, $$2, $$3);
   }

   public static fap<?> b(String $$0) {
      return new fap.a($$0, 5000, 60000);
   }

   public static fap<?> c(String $$0, String $$1) {
      return new fap.d($$0, $$1, 5000, 60000);
   }

   public static fap<?> b(String $$0, String $$1, int $$2, int $$3) {
      return new fap.d($$0, $$1, $$2, $$3);
   }
   ...
   public static class a extends fap<fap.a> {
   ...
   public static class b extends fap<fap.b> {
   ...
   public static class c extends fap<fap.c> {
      ...
      public fap.c f() {
         try {
            ...
            throw new fby(var3.getMessage(), var3);
         }
      }
   }

   public static class d extends fap<fap.d> {
      private final String c;
