...
public class ddh extends dcv {
   ...
   private static final csv[] h = new csv[]{csw.hZ, csw.ia, csw.ii, csw.ib};
   public int a;
   private float i;
   private boolean j;
   private boolean k;
   ...
   public static void a(cpv $$0, gw $$1, dfj $$2, ddh $$3) {
      $$3.a++;
      long $$4 = $$0.V();
      List<gw> $$5 = $$3.l;
      if ($$4 % 40L == 0L) {
   ...
   public static void b(cpv $$0, gw $$1, dfj $$2, ddh $$3) {
      $$3.a++;
      long $$4 = $$0.V();
      List<gw> $$5 = $$3.l;
      if ($$4 % 40L == 0L) {
         boolean $$6 = a($$0, $$1, $$5);
         if ($$6 != $$3.j) {
            apd $$7 = $$6 ? ape.eK : ape.eO;
            $$0.a(null, $$1, $$7, apf.e, 1.0F, 1.0F);
         }
      ...
      if ($$3.d()) {
         if ($$4 % 80L == 0L) {
            $$0.a(null, $$1, ape.eL, apf.e, 1.0F, 1.0F);
         }

         if ($$4 > $$3.r) {
            $$3.r = $$4 + 60L + (long)$$0.D_().a(40);
            $$0.a(null, $$1, ape.eM, apf.e, 1.0F, 1.0F);
         }
      }
   }

   private static void a(ddh $$0, List<gw> $$1) {
      $$0.a($$1.size() >= 42);
   }

   private static boolean a(cpv $$0, gw $$1, List<gw> $$2) {
      $$2.clear();
   ...
   private static void b(cpv $$0, gw $$1, List<gw> $$2) {
      int $$3 = $$2.size();
      int $$4 = $$3 / 7 * 16;
      int $$5 = $$1.u();
      int $$6 = $$1.v();
      int $$7 = $$1.w();
      ehi $$8 = new ehi((double)$$5, (double)$$6, (double)$$7, (double)($$5 + 1), (double)($$6 + 1), (double)($$7 + 1))
         .g((double)$$4)
   ...
   private static void a(cpv $$0, gw $$1, dfj $$2, List<gw> $$3, ddh $$4) {
      bjg $$5 = $$4.m;
      int $$6 = $$3.size();
      if ($$6 < 42) {
         $$4.m = null;
      ...
      if ($$4.m != null) {
         $$0.a(null, $$4.m.dq(), $$4.m.ds(), $$4.m.dw(), ape.eN, apf.e, 1.0F, 1.0F);
         $$4.m.a($$0.ag().o(), 4.0F);
      }
   ...
   private static ehi a(gw $$0) {
      int $$1 = $$0.u();
      int $$2 = $$0.v();
      int $$3 = $$0.w();
      return new ehi((double)$$1, (double)$$2, (double)$$3, (double)($$1 + 1), (double)($$2 + 1), (double)($$3 + 1)).g(8.0);
   }
   ...
   private static void a(cpv $$0, gw $$1, List<gw> $$2, @Nullable biq $$3, int $$4) {
      asc $$5 = $$0.z;
      double $$6 = (double)(arx.a((float)($$4 + 35) * 0.1F) / 2.0F + 0.5F);
      $$6 = ($$6 * $$6 + $$6) * 0.3F;
      ehn $$7 = new ehn((double)$$1.u() + 0.5, (double)$$1.v() + 1.5 + $$6, (double)$$1.w() + 0.5);
