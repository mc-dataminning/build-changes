...
public class ddh {
   public static <T> List<ddh.b> a(List<T> $$0, Function<T, List<jm<eho>>> $$1, boolean $$2) {
      Object2IntMap<eho> $$3 = new Object2IntOpenHashMap();
      MutableInt $$4 = new MutableInt(0);

      record a(int a, int b, eho c) {
      }
      ...
      for (T $$8 : $$0) {
         ...
         List<jm<eho>> $$10 = $$1.apply($$8);
         $$7 = Math.max($$7, $$10.size());

         for (int $$11 = 0; $$11 < $$10.size(); $$11++) {
            for (ji<eho> $$12 : $$10.get($$11)) {
               eho $$13 = $$12.a();
      ...
      Builder<ddh.b> $$25 = ImmutableList.builder();

      for (int $$26 = 0; $$26 < $$7; $$26++) {
         int $$27 = $$26;
         List<eho> $$28 = $$18.stream().filter($$1x -> $$1x.b() == $$27).map(a::c).collect(Collectors.toList());
         $$25.add(new ddh.b($$28));
      }
   ...
   public static record b(List<eho> a, ToIntFunction<eho> b) {
      b(List<eho> $$0) {
         this($$0, ac.h($$0));
      }
   }
