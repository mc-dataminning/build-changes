...
public class fyu extends ftx {
   ...
   private final frs w = new frs().a(10).b(20);

   public fyu(Collection<avd> $$0, BooleanConsumer $$1) {
      super(a);
      this.v = $$0;
      this.u = $$1;
   }
   ...
   protected void aT_() {
      ...
      frs.b $$0 = this.w.d(2);
      frw $$1 = $$0.b().b();
      $$0.a(new fpm(this.l, this.p), 2, $$1);
      foz $$2 = $$0.a(new foz(b, this.p).b(true), 2, $$1);
      $$2.d(310);
      $$0.a(foe.a(c, $$0x -> this.m.a(new fyu.a())).a(100).a(), 2, $$1);
      $$0.a(foe.a(xu.i, $$0x -> this.u.accept(true)).a());
      $$0.a(foe.a(xu.k, $$0x -> this.u.accept(false)).a());
      this.w.a($$1x -> {
   ...
   @Override
   protected void c() {
      frr.a(this.w, 0, 0, this.n, this.o, 0.5F, 0.5F);
   }
   ...
   class a extends ftx {
      ...
      protected void aT_() {
         this.c.a(b, this.p);
         this.d = this.c.c(new fyu.a.a(this.m, fyu.this.v));
         this.c.b(foe.a(xu.k, $$0 -> this.aP_()).a());
         this.c.a($$1 -> {
      ...
      class a extends fpb<fyu.a.b> {
         public a(final fmf $$0, final Collection<avd> $$1) {
            ...
            for (avd $$2 : $$1) {
               ...
               if (!$$3.isEmpty()) {
                  ...
                  this.b(a.this.new b($$4, $$5, foy.a(a.this.p, $$5, this.a())));
               }
            }
         }
      ...
      class b extends fpb.a<fyu.a.b> {
         private final xv b;
         private final xv c;
         private final foy d;

         b(final xv $$0, final xv $$1, final foy $$2) {
            this.b = $$0;
            this.c = $$1;
            this.d = $$2;
         }
