...
public class fyu implements fyx.a, AutoCloseable {
   ...
   ekk[] f;
   @Nullable
   private final fyu.a g;
   private final any h;

   public fyu(aez $$0, gan $$1, ekk $$2, any $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gal $$4 = $$3.a(gal.a).orElse(gal.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ekk[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = fyp.a(this.f, $$0);
   ...
   @Nullable
   private fyu.a a(gan $$0, int $$1, int $$2, gal $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<fyu.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new fyu.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new fyu.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<fyu.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            fyu.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new fyu.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ekk[] $$4) {
   ...
   class a {
      ...
      a(List<fyu.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * fyu.this.c;
         int $$4 = this.b($$2) * fyu.this.d;
         fyu.this.a($$0, $$1, $$3, $$4, fyu.this.f);
      }

      public fyw a() {
         return fyu.this.new d(this, this.d ? fyu.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ekk[] b = new ekk[fyu.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = fyu.this.c >> $$0;
            int $$2 = fyu.this.d >> $$0;
            this.b[$$0] = new ekk($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, fyu.d $$2) {
         fyu.a $$3 = $$2.d;
         List<fyu.b> $$4 = $$3.b;
         fyu.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            fyu.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(fyu.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return fyu.this.f[$$2].a($$3 + ($$0.a($$1) * fyu.this.c >> $$2), $$4 + ($$0.b($$1) * fyu.this.d >> $$2));
      }
   ...
   class d implements fyw {
      int b;
      int c;
      final fyu.a d;
      @Nullable
      private final fyu.c e;

      d(fyu.a $$0, @Nullable fyu.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
