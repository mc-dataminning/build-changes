...
public interface fyu {
   static fyu a(fza $$0, UserApiService $$1) {
      return new fyu.b($$0, $$1);
   }

   CompletableFuture<Unit> a(UUID var1, fzc var2, AbuseReport var3);
   ...
   public static record b(fza a, UserApiService b) implements fyu {
      ...
      @Override
      public CompletableFuture<Unit> a(UUID $$0, fzc $$1, AbuseReport $$2) {
         return CompletableFuture.supplyAsync(() -> {
            ...
            try {
               ...
               xp $$5 = this.a(var7);
               throw new CompletionException(new fyu.a($$5, var7));
            } catch (MinecraftClientException var8) {
               xp $$7 = this.a(var8);
               throw new CompletionException(new fyu.a($$7, var8));
            }
         }, ac.h());
      }
