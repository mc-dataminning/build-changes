...
public class fyu {
   ...
   public fyn a(Vector3f $$0, Vector3f $$1, fyp $$2, giz $$3, ih $$4, glh $$5, @Nullable fyq $$6, boolean $$7, ajh $$8) {
      fyr $$9 = $$2.e;
      if ($$5.c()) {
         $$9 = a($$2.e, $$4, $$5.b(), $$8);
      }
      ...
      $$9.a[0] = aww.i($$11, $$9.a[0], $$12);
      $$9.a[2] = aww.i($$11, $$9.a[2], $$12);
      $$9.a[1] = aww.i($$11, $$9.a[1], $$13);
      $$9.a[3] = aww.i($$11, $$9.a[3], $$13);
      ...
      return new fyn($$14, $$2.c, $$15, $$3, $$7);
   }

   public static fyr a(fyr $$0, ih $$1, j $$2, ajh $$3) {
      ...
      Vector3f $$25 = $$24.transform(new Vector3f(aww.b($$23), aww.a($$23), 0.0F));
      int $$26 = Math.floorMod(-((int)Math.round(Math.toDegrees(Math.atan2((double)$$25.y(), (double)$$25.x())) / 90.0)) * 90, 360);
      return new fyr(new float[]{$$15, $$19, $$16, $$20}, $$26);
   }

   private int[] a(fyr $$0, giz $$1, ih $$2, float[] $$3, j $$4, @Nullable fyq $$5, boolean $$6) {
      int[] $$7 = new int[32];
   ...
   private void a(int[] $$0, int $$1, ih $$2, fyr $$3, float[] $$4, giz $$5, j $$6, @Nullable fyq $$7, boolean $$8) {
      fxh.b $$9 = fxh.a($$2).a($$1);
   ...
   private void a(int[] $$0, int $$1, Vector3f $$2, giz $$3, fyr $$4) {
      int $$5 = $$1 * 8;
   ...
   private void a(Vector3f $$0, @Nullable fyq $$1) {
      if ($$1 != null) {
         Vector3f $$2;
         Vector3f $$3;
         switch ($$1.b()) {
   ...
   private void a(int[] $$0, ih $$1) {
      ...
      for (int $$10 = 0; $$10 < 4; $$10++) {
         ...
         for (int $$16 = 0; $$16 < 4; $$16++) {
            ...
            if (aww.a($$13, $$18) && aww.a($$14, $$19) && aww.a($$15, $$20)) {
               $$0[$$11 + 4] = $$2[$$17 + 4];
               $$0[$$11 + 4 + 1] = $$2[$$17 + 4 + 1];
            }
         }
