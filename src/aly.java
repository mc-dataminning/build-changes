...
public class aly extends alu {
   ...
   private final aly.b d;
   private final String e;

   aly(String $$0, aly.b $$1, boolean $$2, String $$3) {
      super($$0, $$2);
      this.d = $$1;
      this.e = $$3;
   }

   private static String b(amb $$0, aer $$1) {
   ...
   @Nullable
   private ane<InputStream> b(String $$0) {
      ZipFile $$1 = this.d.a();
      if ($$1 == null) {
         return null;
      } else {
         ZipEntry $$2 = $$1.getEntry(this.a($$0));
         return $$2 == null ? null : ane.create($$1, $$2);
      }
   }
   ...
   public static class a implements amu.c {
      ...
      public ama a(String $$0) {
         aly.b $$1 = new aly.b(this.a);
         return new aly($$0, $$1, this.b, "");
      }

      @Override
      public ama a(String $$0, amu.a $$1) {
         aly.b $$2 = new aly.b(this.a);
         ama $$3 = new aly($$0, $$2, this.b, "");
         List<String> $$4 = $$1.d();
         if ($$4.isEmpty()) {
            return $$3;
         } else {
            List<ama> $$5 = new ArrayList<>($$4.size());

            for (String $$6 : $$4) {
               $$5.add(new aly($$0, $$2, this.b, $$6));
            }
         ...
         if (this.c) {
            ...
            if (this.b == null) {
               try {
                  ...
                  aly.c.error("Failed to open pack {}", this.a, var2);
                  this.c = true;
                  return null;
               }
            }
