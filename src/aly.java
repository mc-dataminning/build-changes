...
public class aly {
   ...
   private final Queue<aly.a> b = new axq<>();
   private final Object2IntLinkedOpenHashMap<aly.b> c = new Object2IntLinkedOpenHashMap();
   ...
   public synchronized void a(String $$0, Throwable $$1) {
      ...
      this.b.add(new aly.a($$2, $$0, (Class<? extends Throwable>)$$1.getClass(), $$3));

      while (this.b.size() > 8) {
         this.b.remove();
      }

      aly.b $$4 = new aly.b($$0, (Class<? extends Throwable>)$$1.getClass());
   ...
   public synchronized String a() {
      ...
      if (!this.c.isEmpty()) {
         ...
         while (var6.hasNext()) {
            Entry<aly.b> $$3 = (Entry<aly.b>)var6.next();
            $$1.append("\t\t\t")
               .append(((aly.b)$$3.getKey()).a)
               .append(":")
               .append(((aly.b)$$3.getKey()).b)
               .append(" x ")
