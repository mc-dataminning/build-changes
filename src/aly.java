...
public class aly {
                        ...
                        ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)ef.a(
                                          ...
                                          .then(
                                             ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ef.a(
                                                                  ...
                                                                  .then(ef.a("pink").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.a.a))))
                                                               .then(ef.a("blue").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.a.b))))
                                                            .then(ef.a("red").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.a.c))))
                                                         .then(ef.a("green").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.a.d))))
                                                      .then(ef.a("yellow").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.a.e))))
                                                   .then(ef.a("purple").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.a.f))))
                                                .then(ef.a("white").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.a.g)))
                                          ))
                                       .then(
                                          ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)ef.a("style")
                                                         .then(ef.a("progress").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.b.a))))
                                                      .then(ef.a("notched_6").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.b.b))))
                                                   .then(ef.a("notched_10").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.b.c))))
                                                .then(ef.a("notched_12").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.b.d))))
                                             .then(ef.a("notched_20").executes($$0x -> a((ee)$$0x.getSource(), a($$0x), bpm.b.e)))
                                       ))
                                    .then(
                                       ef.a("value")
                                          .then(
   ...
   private static int d(ee $$0, aln $$1) {
      if ($$1.g().isEmpty()) {
         $$0.a(() -> wx.a("commands.bossbar.get.players.none", $$1.e()), true);
      } else {
         $$0.a(() -> wx.a("commands.bossbar.get.players.some", $$1.e(), $$1.g().size(), xa.b($$1.g(), cly::O_)), true);
      }

      return $$1.g().size();
   }

   private static int a(ee $$0, aln $$1, boolean $$2) throws CommandSyntaxException {
      if ($$1.f() == $$2) {
         if ($$2) {
            throw k.create();
         } else {
   ...
   private static int a(ee $$0, aln $$1, int $$2) throws CommandSyntaxException {
      if ($$1.c() == $$2) {
         throw h.create();
      } else {
         $$1.a($$2);
   ...
   private static int b(ee $$0, aln $$1, int $$2) throws CommandSyntaxException {
      if ($$1.d() == $$2) {
         throw i.create();
      } else {
         $$1.b($$2);
   ...
   private static int a(ee $$0, aln $$1, bpm.a $$2) throws CommandSyntaxException {
      if ($$1.k().equals($$2)) {
         throw f.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(ee $$0, aln $$1, bpm.b $$2) throws CommandSyntaxException {
      if ($$1.l().equals($$2)) {
         throw g.create();
      } else {
         $$1.a($$2);
   ...
   private static int a(ee $$0, aln $$1, wx $$2) throws CommandSyntaxException {
   ...
   private static int a(ee $$0, aln $$1, Collection<aqo> $$2) throws CommandSyntaxException {
      boolean $$3 = $$1.a($$2);
      if (!$$3) {
         throw d.create();
      } else {
         if ($$1.g().isEmpty()) {
            ...
            $$0.a(() -> wx.a("commands.bossbar.set.players.success.some", $$1.e(), $$2.size(), xa.b($$2, cly::O_)), true);
         }
   ...
   private static int a(ee $$0) {
      Collection<aln> $$1 = $$0.l().aN().b();
      if ($$1.isEmpty()) {
         $$0.a(() -> wx.c("commands.bossbar.list.bars.none"), false);
      } else {
         $$0.a(() -> wx.a("commands.bossbar.list.bars.some", $$1.size(), xa.b($$1, aln::e)), false);
      }

      return $$1.size();
   }

   private static int a(ee $$0, akn $$1, wx $$2) throws CommandSyntaxException {
      alo $$3 = $$0.l().aN();
      if ($$3.a($$1) != null) {
         throw b.create($$1.toString());
      } else {
         aln $$4 = $$3.a($$1, xa.a($$0, $$2, null, 0));
         $$0.a(() -> wx.a("commands.bossbar.create.success", $$4.e()), true);
         return $$3.b().size();
      }
   }

   private static int e(ee $$0, aln $$1) {
      alo $$2 = $$0.l().aN();
      $$1.b();
      $$2.a($$1);
   ...
   public static aln a(CommandContext<ee> $$0) throws CommandSyntaxException {
      akn $$1 = ff.c($$0, "id");
      aln $$2 = ((ee)$$0.getSource()).l().aN().a($$1);
      if ($$2 == null) {
