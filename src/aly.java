...
public class aly implements AutoCloseable {
   ...
   private aly(URL $$0, aly.c $$1, URL $$2, aly.b $$3, URL $$4, aly.b $$5, String $$6, aly.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? arr.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static aly a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = arr.a($$0);
            URI $$2 = new URI(arr.i($$1, "apiServer"));
            String $$3 = arr.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = arr.a($$1, "ruleId", 1);
               String $$5 = arr.a($$1, "serverId", "");
               String $$6 = arr.a($$1, "roomId", "Java:Chat");
               int $$7 = arr.a($$1, "hashesToDrop", -1);
               int $$8 = arr.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = arr.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, aly.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<alk> a(GameProfile $$0, String $$1, aly.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(alk.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = arr.a($$4, "response", false);
            if ($$5) {
               return alk.a($$1);
            } else {
               String $$6 = arr.a($$4, "hashed", null);
               if ($$6 == null) {
                  return alk.b($$1);
               } else {
                  JsonArray $$7 = arr.v($$4, "hashes");
                  tp $$8 = this.a($$1, $$7, $$2);
                  return new alk($$1, $$8);
               }
            }
   ...
   private tp a(String $$0, JsonArray $$1, aly.a $$2) {
      if ($$1.isEmpty()) {
         return tp.c;
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new aly.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public alx a(GameProfile $$0) {
      return new aly.d($$0);
   }
   ...
   public interface a {
      aly.a a = ($$0, $$1) -> false;
      aly.a b = ($$0, $$1) -> $$0.length() == $$1;

      static aly.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static aly.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements alx {
      private final GameProfile c;
      private final Executor d;

      d(GameProfile $$0) {
         this.c = $$0;
         bfx<Runnable> $$1 = bfx.a(aly.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         aly.this.a(this.c, aly.this.g, aly.this.h, this.d);
      }

      @Override
      public void b() {
         aly.this.a(this.c, aly.this.i, aly.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<alk>> a(List<String> $$0) {
         List<CompletableFuture<alk>> $$1 = $$0.stream().map($$0x -> aly.this.a(this.c, $$0x, aly.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.c($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<alk> a(String $$0) {
         return aly.this.a(this.c, $$0, aly.this.l, this.d);
      }
   }
