public abstract class fyl<T extends cwf> extends fyj<T> implements gby {
   private final gbt<?> G;
   private boolean H;

   public fyl(T $$0, gbt<?> $$1, cqx $$2, wy $$3) {
      super($$0, $$2, $$3);
      this.G = $$1;
   }
   ...
   protected abstract fwi G();

   private void M() {
      fwi $$0 = this.G();
      this.c(new fso($$0.a(), $$0.b(), 20, 18, gbt.a, $$0x -> {
         this.G.c();
         this.C = this.G.a(this.n, this.s);
         fwi $$1 = this.G();
         $$0x.c($$1.a(), $$1.b());
