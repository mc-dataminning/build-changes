...
public abstract class byl extends biw {
   private static final Logger e = LogUtils.getLogger();
   protected static final Predicate<biw> b = $$0 -> $$0 instanceof byl;
   private int f;
   protected gw c;
   protected ha d;

   protected byl(bja<? extends byl> $$0, cqb $$1) {
      super($$0, $$1);
      this.d = ha.d;
   }

   protected byl(bja<? extends byl> $$0, cqb $$1, gw $$2) {
      this($$0, $$1);
      this.c = $$2;
   }
   ...
   protected void y() {
      if (this.d != null) {
         ...
         $$8 /= 32.0;
         $$9 /= 32.0;
         this.a(new ehc($$0 - $$7, $$1 - $$8, $$2 - $$9, $$0 + $$7, $$1 + $$8, $$2 + $$9));
      }
   }
   ...
   public abstract void a(@Nullable biw var1);
