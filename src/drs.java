...
public class drs implements drn {
   public static final Codec<drs> a = RecordCodecBuilder.create(
      $$0 -> $$0.group(
               jy.f.q().fieldOf("block").flatXmap(drs::a, DataResult::success).orElse((czs)cuv.fg).forGetter($$0x -> $$0x.b),
   ...
   public final ig<cut> h;
   private final ObjectArrayList<hx> i;

   private static DataResult<czs> a(cut $$0) {
      return $$0 instanceof czs $$1 ? DataResult.success($$1) : DataResult.error(() -> "Growth block should be a multiface block");
   }

   public drs(czs $$0, int $$1, boolean $$2, boolean $$3, boolean $$4, float $$5, ig<cut> $$6) {
      this.b = $$0;
      this.c = $$1;
      this.d = $$2;
      this.e = $$3;
   ...
   public List<hx> a(ato $$0, hx $$1) {
      return ac.a(this.i.stream().filter($$1x -> $$1x != $$1), $$0);
   }

   public List<hx> a(ato $$0) {
