...
public class dla {
   private static final dez a = csm.hj.n();
   private static final dez b = csm.hk.n();
   private static final dez c = csm.iA.n();
   private static final dez d = csm.hn.n();
   private static final dez e = csm.hv.n();
   private static final dez f = csm.hx.n();
   private static final dez g = csm.hr.n();
   private static final dez h = csm.iC.n();
   private static final dez i = csm.dP.n();
   private final dez j;
   private final int k;
   private final dez[] l;
   private final dzf m;
   ...
   public dla(dkw $$0, dez $$1, int $$2, dkv $$3) {
      this.j = $$1;
      this.k = $$2;
      this.t = $$3;
      this.m = $$0.a(dkr.P);
   ...
   public void a(dkw $$0, cql $$1, hr<cqj> $$2, boolean $$3, dlf $$4, final dgv $$5, dkm $$6, dkz.o $$7) {
      ...
      dkz.g $$13 = new dkz.g(this, $$0, $$5, $$6, $$1::a, $$2, $$4);
      dkz.u $$14 = $$7.apply($$13);
      gu.a $$15 = new gu.a();
      ...
      for (int $$16 = 0; $$16 < 16; $$16++) {
         for (int $$17 = 0; $$17 < 16; $$17++) {
            int $$18 = $$10 + $$16;
            int $$19 = $$11 + $$17;
            int $$20 = $$5.a(dki.a.a, $$16, $$17) + 1;
            $$8.p($$18).r($$19);
            he<cqj> $$21 = $$1.a($$15.d($$18, $$3 ? 0 : $$20, $$19));
            if ($$21.a(cqq.B)) {
               this.a($$12, $$18, $$19, $$20, $$5);
            }

            int $$22 = $$5.a(dki.a.a, $$16, $$17) + 1;
            $$13.a($$18, $$19);
            int $$23 = 0;
   ...
   private boolean a(dez $$0) {
      return !$$0.i() && $$0.u().c();
   }

   @Deprecated
   public Optional<dez> a(dkz.o $$0, dmi $$1, Function<gu, he<cqj>> $$2, dgv $$3, dkm $$4, gu $$5, boolean $$6) {
      dkz.g $$7 = new dkz.g(this, $$1.d(), $$3, $$4, $$2, $$1.c().d(jc.ap), $$1);
      dkz.u $$8 = $$0.apply($$7);
      int $$9 = $$5.u();
      int $$10 = $$5.v();
      int $$11 = $$5.w();
      ...
      dez $$12 = $$8.tryApply($$9, $$10, $$11);
      return Optional.ofNullable($$12);
   }

   private void a(dgs $$0, int $$1, int $$2, int $$3, cpn $$4) {
      double $$5 = 0.2;
   ...
   private void a(int $$0, cqj $$1, dgs $$2, gu.a $$3, int $$4, int $$5, int $$6) {
      double $$7 = 1.28;
      ...
      if (!($$8 <= 1.8)) {
         ...
         for (int $$20 = Math.max($$6, (int)$$12 + 1); $$20 >= $$0; $$20--) {
            if ($$2.a($$20).i() && $$20 < (int)$$15 && $$16.j() > 0.01
               || $$2.a($$20).a(csm.G) && $$20 > (int)$$13 && $$20 < this.k && $$13 != 0.0 && $$16.j() > 0.15) {
               if ($$19 <= $$17 && $$20 > $$18) {
                  $$2.a($$20, i);
                  $$19++;
               } else {
   ...
   private static void a(aru $$0, dez[] $$1, int $$2, dez $$3) {
      int $$4 = $$0.a(6, 15);
   ...
   protected dez a(int $$0, int $$1, int $$2) {
