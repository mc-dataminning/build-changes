...
public class eqz {
   ...
   public void a(eqz.b $$0, List<amk> $$1) {
      this.c++;
      if (this.b != null && !this.b.d) {
         a.warn("Reload already ongoing, replacing");
      }

      this.b = new eqz.c($$0, $$1.stream().map(amk::a).collect(ImmutableList.toImmutableList()));
   }

   public void a(Throwable $$0) {
      if (this.b == null) {
         a.warn("Trying to signal reload recovery, but nothing was started");
         this.b = new eqz.c(eqz.b.c, ImmutableList.of());
      }

      this.b.c = new eqz.a($$0);
   }
   ...
   static class c {
      private final eqz.b a;
      private final List<String> b;
      @Nullable
      eqz.a c;
      boolean d;

      c(eqz.b $$0, List<String> $$1) {
         this.a = $$0;
         this.b = $$1;
      }
