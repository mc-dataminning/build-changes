...
public class eqz extends LongLinkedOpenHashSet {
   private final eqz.a a;

   public eqz(int $$0, float $$1) {
      super($$0, $$1);
      this.a = new eqz.a($$0 / 64, $$1);
   }
   ...
   protected static class a extends Long2LongLinkedOpenHashMap {
      private static final int a = azj.f(60000000);
      private static final int b = azj.f(60000000);
