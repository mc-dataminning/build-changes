...
public class eh implements ArgumentType<eh.g> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(sw.c("arguments.nbtpath.node.invalid"));
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(sw.c("arguments.nbtpath.too_deep"));
   ...
   public static eh.g a(CommandContext<ds> $$0, String $$1) {
