...
public record eh(@Nullable Float c, @Nullable Float d) {
   public static final eh a = new eh(null, null);
   public static final SimpleCommandExceptionType b = new SimpleCommandExceptionType(wu.c("argument.range.ints"));

   public static eh a(float $$0) {
      return new eh($$0, $$0);
   }

   public static eh a(float $$0, float $$1) {
      return new eh($$0, $$1);
   }

   public static eh b(float $$0) {
      return new eh($$0, null);
   }

   public static eh c(float $$0) {
      return new eh(null, $$0);
   }
   ...
   public static eh a(@Nullable JsonElement $$0) {
      if ($$0 == null || $$0.isJsonNull()) {
         return a;
      } else if (axu.b($$0)) {
         float $$1 = axu.e($$0, "value");
         return new eh($$1, $$1);
      } else {
         JsonObject $$2 = axu.m($$0, "value");
         Float $$3 = $$2.has("min") ? axu.m($$2, "min") : null;
         Float $$4 = $$2.has("max") ? axu.m($$2, "max") : null;
         return new eh($$3, $$4);
      }
   }

   public static eh a(StringReader $$0, boolean $$1) throws CommandSyntaxException {
      return a($$0, $$1, $$0x -> $$0x);
   }

   public static eh a(StringReader $$0, boolean $$1, Function<Float, Float> $$2) throws CommandSyntaxException {
      if (!$$0.canRead()) {
         throw de.a.createWithContext($$0);
      } else {
         int $$3 = $$0.getCursor();
         Float $$4 = a(b($$0, $$1), $$2);
         Float $$5;
