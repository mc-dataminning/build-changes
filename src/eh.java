...
public class eh implements ArgumentType<eh.a> {
   ...
   public static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(vg.c("argument.player.unknown"));

   public static Collection<GameProfile> a(CommandContext<ds> $$0, String $$1) throws CommandSyntaxException {
      return ((eh.a)$$0.getArgument($$1, eh.a.class)).getNames((ds)$$0.getSource());
   }
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> $$0, SuggestionsBuilder $$1) {
      if ($$0.getSource() instanceof dx) {
         ...
         return $$3.a($$1, $$1x -> dx.b(((dx)$$0.getSource()).q(), $$1x));
      } else {
