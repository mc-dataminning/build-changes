...
public abstract class dmx<C extends dmq> {
   ...
   protected boolean a(
      dms $$0, C $$1, dhf $$2, Function<gw, he<cqt>> $$3, dke $$4, double $$5, double $$6, double $$7, double $$8, double $$9, dhe $$10, dmx.a $$11
   ) {
      cpc $$12 = $$2.f();
      ...
      if (!(Math.abs($$5 - $$13) > $$15) && !(Math.abs($$7 - $$14) > $$15)) {
         int $$16 = $$12.d();
         int $$17 = $$12.e();
         int $$18 = Math.max(arw.a($$5 - $$8) - $$16 - 1, 0);
         int $$19 = Math.min(arw.a($$5 + $$8) - $$16, 15);
         int $$20 = Math.max(arw.a($$6 - $$9) - 1, $$0.a() + 1);
         int $$21 = $$2.y() ? 0 : 7;
         int $$22 = Math.min(arw.a($$6 + $$9) + 1, $$0.a() + $$0.b() - 1 - $$21);
         int $$23 = Math.max(arw.a($$7 - $$8) - $$17 - 1, 0);
         int $$24 = Math.min(arw.a($$7 + $$8) - $$17, 15);
         boolean $$25 = false;
         gw.a $$26 = new gw.a();
         gw.a $$27 = new gw.a();
   ...
   protected boolean a(dms $$0, C $$1, dhf $$2, Function<gw, he<cqt>> $$3, dhe $$4, gw.a $$5, gw.a $$6, dke $$7, MutableBoolean $$8) {
      dfj $$9 = $$2.a_($$5);
   ...
   public abstract boolean a(dms var1, C var2, dhf var3, Function<gw, he<cqt>> var4, asc var5, dke var6, cpc var7, dhe var8);
