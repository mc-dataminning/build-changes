...
public abstract class arq implements zy {
   ...
   public arq(MinecraftServer $$0, vs $$1, ari $$2) {
      this.d = $$0;
      this.e = $$1;
      this.j = ad.c();
      this.o = $$2.b();
   ...
   protected ari a(aqg $$0) {
      return new ari(this.i(), this.o, $$0, this.i);
   }
}
