...
public class arq {
   ...
   private static void a(aru $$0, aqu $$1, dvi $$2) {
      $$0.b(new adg($$2, $$1.y_(), null, null));
      dcd $$3 = $$2.f();
      agf.a($$1, $$3);
   }

   private List<dvi> a(aqb $$0, dcd $$1) {
      int $$2 = ayo.d(this.i);
      List<dvi> $$4;
   ...
   public void a(float $$0) {
      this.j--;
      this.h = Double.isNaN((double)$$0) ? 0.01F : ayo.a($$0, 0.01F, 64.0F);
      if (this.j == 0) {
         this.i = 1.0F;
      }
