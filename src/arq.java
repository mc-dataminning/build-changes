...
public class arq implements AutoCloseable {
   ...
   private arq(URL $$0, arq.c $$1, URL $$2, arq.b $$3, URL $$4, arq.b $$5, String $$6, arq.a $$7, int $$8) {
      this.k = $$6;
      this.l = $$7;
      this.e = $$0;
      this.f = $$1;
   ...
   private static String a(@Nullable JsonObject $$0, String $$1, String $$2) {
      return $$0 != null ? axu.a($$0, $$1, $$2) : $$2;
   }

   @Nullable
   public static arq a(String $$0) {
      if (Strings.isNullOrEmpty($$0)) {
         return null;
      } else {
         try {
            JsonObject $$1 = axu.a($$0);
            URI $$2 = new URI(axu.i($$1, "apiServer"));
            String $$3 = axu.i($$1, "apiKey");
            if ($$3.isEmpty()) {
               throw new IllegalArgumentException("Missing API key");
            } else {
               int $$4 = axu.a($$1, "ruleId", 1);
               String $$5 = axu.a($$1, "serverId", "");
               String $$6 = axu.a($$1, "roomId", "Java:Chat");
               int $$7 = axu.a($$1, "hashesToDrop", -1);
               int $$8 = axu.a($$1, "maxConcurrentRequests", 7);
               JsonObject $$9 = axu.a($$1, "endpoints", null);
   ...
   void a(GameProfile $$0, URL $$1, arq.b $$2, Executor $$3) {
      $$3.execute(() -> {
   ...
   CompletableFuture<arc> a(GameProfile $$0, String $$1, arq.a $$2, Executor $$3) {
      return $$1.isEmpty() ? CompletableFuture.completedFuture(arc.a) : CompletableFuture.supplyAsync(() -> {
         JsonObject $$3x = this.f.encode($$0, $$1);

         try {
            JsonObject $$4 = this.a($$3x, this.e);
            boolean $$5 = axu.a($$4, "response", false);
            if ($$5) {
               return arc.a($$1);
            } else {
               String $$6 = axu.a($$4, "hashed", null);
               if ($$6 == null) {
                  return arc.b($$1);
               } else {
                  JsonArray $$7 = axu.v($$4, "hashes");
                  wy $$8 = this.a($$1, $$7, $$2);
                  return new arc($$1, $$8);
               }
            }
   ...
   private wy a(String $$0, JsonArray $$1, arq.a $$2) {
      if ($$1.isEmpty()) {
         return wy.c;
   ...
   private HttpURLConnection c(JsonObject $$0, URL $$1) throws IOException {
      ...
      if ($$5 >= 200 && $$5 < 300) {
         ...
         throw new arq.e($$5 + " " + $$2.getResponseMessage());
      }
   }

   public arp a(GameProfile $$0) {
      return new arq.d($$0);
   }
   ...
   public interface a {
      arq.a a = ($$0, $$1) -> false;
      arq.a b = ($$0, $$1) -> $$0.length() == $$1;

      static arq.a ignoreOverThreshold(int $$0) {
         return ($$1, $$2) -> $$2 >= $$0;
      }

      static arq.a select(int $$0) {
         return switch ($$0) {
            case -1 -> a;
            case 0 -> b;
   ...
   class d implements arp {
      private final GameProfile c;
      private final Executor d;

      d(final GameProfile $$0) {
         this.c = $$0;
         bow<Runnable> $$1 = bow.a(arq.this.m, "chat stream for " + $$0.getName());
         this.d = $$1::a;
      }

      @Override
      public void a() {
         arq.this.a(this.c, arq.this.g, arq.this.h, this.d);
      }

      @Override
      public void b() {
         arq.this.a(this.c, arq.this.i, arq.this.j, this.d);
      }

      @Override
      public CompletableFuture<List<arc>> a(List<String> $$0) {
         List<CompletableFuture<arc>> $$1 = $$0.stream().map($$0x -> arq.this.a(this.c, $$0x, arq.this.l, this.d)).collect(ImmutableList.toImmutableList());
         return ac.e($$1).exceptionally($$0x -> ImmutableList.of());
      }

      @Override
      public CompletableFuture<arc> a(String $$0) {
         return arq.this.a(this.c, $$0, arq.this.l, this.d);
      }
   }
