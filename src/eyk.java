...
public class eyk {
   ...
   public void a(ezu $$0, String $$1, faq.a $$2, eob $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  eyk.b $$13 = new eyk.b($$1.trim(), this.f, $$3, $$2);
                  eyk.a $$14 = new eyk.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        eyk.c $$30 = new eyk.c(this.f, $$2, $$0);
                        eyk.a $$31 = new eyk.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new ezy(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eob $$2) throws IOException {
      ...
      File $$15 = new File(fde.Q().p.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      private final eob d;
      private final faq.a e;

      b(String $$0, File $$1, eob $$2, faq.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((eyk.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !eyk.this.b && !eyk.this.d) {
            try {
               eyk.this.e = true;
               eyk.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               eyk.a.error("Error extracting archive", var3);
               eyk.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      private final faq.a c;
      private final ezu d;

      c(File $$0, faq.a $$1, ezu $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((eyk.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !eyk.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, eyk.this.g);
                  eyk.this.c = true;
               } else {
                  eyk.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  eyk.this.d = true;
               }
            } catch (IOException var3) {
               eyk.a.error("Error copying resourcepack file: {}", var3.getMessage());
               eyk.this.d = true;
            }
         }
      }
