...
public class eyk {
   private final List<ConcurrentLinkedQueue<eyj>> a = ImmutableList.of(
   ...
   public void a(eyj $$0) {
      if (!this.b) {
         ...
         ConcurrentLinkedQueue<eyj> $$1 = this.i();
         $$1.add($$0);
      }
   }
   ...
   public ConcurrentLinkedQueue<eyj> h() {
      return this.a.get(this.f);
   }

   public ConcurrentLinkedQueue<eyj> i() {
      return this.a.get(this.c);
   }

   public ConcurrentLinkedQueue<eyj> j() {
