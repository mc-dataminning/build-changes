...
public class eyk implements PathMatcher {
   private static final Logger a = LogUtils.getLogger();
   private static final String b = "#";
   private final List<eyk.a> c;
   private final Map<String, PathMatcher> d = new ConcurrentHashMap<>();

   public eyk(List<eyk.a> $$0) {
      this.c = $$0;
   }
   ...
   public static eyk a(BufferedReader $$0) {
      return new eyk($$0.lines().flatMap($$0x -> eyk.a.a($$0x).stream()).toList());
   }

   public static record a(eyk.b a, String b) {
      public PathMatcher a(FileSystem $$0) {
         return this.a().compile($$0, this.b);
      }

      static Optional<eyk.a> a(String $$0) {
         if ($$0.isBlank() || $$0.startsWith("#")) {
            return Optional.empty();
         } else if (!$$0.startsWith("[")) {
            return Optional.of(new eyk.a(eyk.b.b, $$0));
         } else {
            ...
            if ($$1 == -1) {
               ...
               return switch ($$2) {
                  case "glob", "regex" -> Optional.of(new eyk.a(eyk.b.a, $$2 + ":" + $$3));
                  case "prefix" -> Optional.of(new eyk.a(eyk.b.b, $$3));
      ...
      static eyk.a b(String $$0) {
         return new eyk.a(eyk.b.a, "glob:" + $$0);
      }

      static eyk.a c(String $$0) {
         return new eyk.a(eyk.b.a, "regex:" + $$0);
      }

      static eyk.a d(String $$0) {
         return new eyk.a(eyk.b.b, $$0);
      }
   }

   @FunctionalInterface
   public interface b {
      eyk.b a = FileSystem::getPathMatcher;
      eyk.b b = ($$0, $$1) -> $$1x -> $$1x.toString().startsWith($$1);
