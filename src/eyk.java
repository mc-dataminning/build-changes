...
public class eyk {
   ...
   @Nullable
   private String g;
   private static final eyk.a h = new eyk.a() {
      @Nullable
      @Override
      public eyj a() {
         return null;
   ...
   public void a(@Nullable String $$0, boolean $$1) {
      ...
      if (eyn.a(this.d, "Get capabilities")) {
         ...
         if (eyn.a(this.d, "Create context")) {
            ...
            if (!$$8.AL_EXT_source_distance_model) {
               ...
               if (!$$8.AL_EXT_LINEAR_DISTANCE) {
                  ...
                  eyn.a("Enable per-source distance models");
   ...
   private static OptionalLong b(@Nullable String $$0) {
      ...
      return $$1 != 0L && !eyn.a($$1, "Open device") ? OptionalLong.of($$1) : OptionalLong.empty();
   }
   ...
   @Nullable
   public eyj a(eyk.c $$0) {
      return ($$0 == eyk.c.b ? this.j : this.i).a();
   }
   ...
   static class b implements eyk.a {
      private final int a;
      private final Set<eyj> b = Sets.newIdentityHashSet();
      ...
      public eyj a() {
         if (this.b.size() >= this.a) {
            if (aa.aU) {
               eyk.a.warn("Maximum sound pool size {} reached", this.a);
            }
