...
public abstract class eyk extends eui implements ets {
   ...
   public static final aew d = new aew("textures/gui/options_background.png");
   ...
   protected void b(ewi $$0) {
      List<ewg> $$1 = this.l.stream().filter(ewg::aD_).collect(Collectors.toList());
   ...
   public void b(List<arj> $$0) {
      this.a($$0, fbc.a, true);
   }

   public void a(List<arj> $$0, fbb $$1, boolean $$2) {
      if (this.z == null || $$2) {
   ...
   static record a(List<arj> a, fbb b) {
   }
