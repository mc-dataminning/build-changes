...
public class aii {
   ...
   static final fh b = new fh(cuv.a.o(), Collections.emptySet(), null);
                     ...
                     dv.a("to", fm.a())
                        .then(
                           ((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)((RequiredArgumentBuilder)dv.a(
                                             ...
                                             .executes(
                                                $$0x -> a((du)$$0x.getSource(), dwn.a(fm.a($$0x, "from"), fm.a($$0x, "to")), fj.a($$0x, "block"), aii.a.a, null)
                                             ))
                                          .then(
                                    ...
                                    .then(
                                       dv.a("outline")
                                          .executes(
                                             $$0x -> a((du)$$0x.getSource(), dwn.a(fm.a($$0x, "from"), fm.a($$0x, "to")), fj.a($$0x, "block"), aii.a.b, null)
                                          )
                                    ))
                                 .then(
                                    dv.a("hollow")
                                       .executes(
                                          $$0x -> a((du)$$0x.getSource(), dwn.a(fm.a($$0x, "from"), fm.a($$0x, "to")), fj.a($$0x, "block"), aii.a.c, null)
                                       )
                                 ))
                              .then(
                                 dv.a("destroy")
                                    .executes($$0x -> a((du)$$0x.getSource(), dwn.a(fm.a($$0x, "from"), fm.a($$0x, "to")), fj.a($$0x, "block"), aii.a.d, null))
                              )
                        )
                  )
            )
   ...
   private static int a(du $$0, dwn $$1, fh $$2, aii.a $$3, @Nullable Predicate<dha> $$4) throws CommandSyntaxException {
      int $$5 = $$1.c() * $$1.d() * $$1.e();
      int $$6 = $$0.f().X().c(cro.z);
      if ($$5 > $$6) {
         throw a.create($$6, $$5);
         ...
         for (ht $$10 : ht.b($$1.g(), $$1.h(), $$1.i(), $$1.j(), $$1.k(), $$1.l())) {
            if ($$4 == null || $$4.test(new dha($$8, $$10, true))) {
