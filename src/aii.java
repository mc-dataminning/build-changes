...
public class aii {
   private static final SimpleCommandExceptionType a = new SimpleCommandExceptionType(tn.c("commands.schedule.same_tick"));
   private static final DynamicCommandExceptionType b = new DynamicCommandExceptionType($$0 -> tn.a("commands.schedule.cleared.failure", $$0));
   ...
   private static int a(dt $$0, Pair<aey, Either<dp, Collection<dp>>> $$1, int $$2, boolean $$3) throws CommandSyntaxException {
      if ($$2 == 0) {
         throw a.create();
      } else {
         long $$4 = $$0.e().V() + (long)$$2;
         aey $$5 = (aey)$$1.getFirst();
         ehc<MinecraftServer> $$6 = $$0.l().aT().K().u();
         ((Either)$$1.getSecond()).ifLeft($$6x -> {
            ...
            $$6.a($$7, $$4, new egy($$5));
            $$0.a(() -> tn.a("commands.schedule.created.function", $$5, $$2, $$4), true);
         }).ifRight($$6x -> {
            String $$7 = "#" + $$5;
            if ($$3) {
               $$6.a($$7);
            ...
            $$6.a($$7, $$4, new egz($$5));
            $$0.a(() -> tn.a("commands.schedule.created.tag", $$5, $$2, $$4), true);
         });
   ...
   private static int a(dt $$0, String $$1) throws CommandSyntaxException {
      ...
      if ($$2 == 0) {
         ...
         $$0.a(() -> tn.a("commands.schedule.cleared.success", $$2, $$1), true);
         return $$2;
      }
   }
}
