...
public class dnt extends dnn<dps> {
   private static final ha[] a = ha.values();

   public dnt(Codec<dps> $$0) {
      super($$0);
   }

   @Override
   public boolean a(dnp<dps> $$0) {
      dps $$1 = $$0.f();
      aru $$2 = $$0.d();
      gu $$3 = $$0.e();
      cqg $$4 = $$0.b();
      int $$5 = $$1.l;
      int $$6 = $$1.n;
      List<Pair<gu, Integer>> $$7 = Lists.newLinkedList();
      int $$8 = $$1.j.a($$2);
      dli $$9 = new dli(new dkk($$4.A()));
      dzg $$10 = dzg.a($$9, -4, 1.0);
      List<gu> $$11 = Lists.newLinkedList();
      ...
      List<gu> $$31 = Lists.newArrayList();
      Predicate<dfa> $$32 = a($$1.c.g);
      ...
      for (gu $$33 : gu.a($$3.b($$5, $$5, $$5), $$3.b($$6, $$6, $$6))) {
         ...
         for (Pair<gu, Integer> $$37 : $$7) {
            $$35 += arp.f($$33.j((hz)$$37.getFirst()) + (double)((Integer)$$37.getSecond()).intValue()) + $$34;
         }

         for (gu $$38 : $$11) {
            $$36 += arp.f($$33.j($$38) + (double)$$15.d) + $$34;
         }

         if (!($$35 < $$19)) {
            if ($$21 && $$36 >= $$20 && $$35 < $$16) {
               this.a($$4, $$33, csn.a.n(), $$32);
      ...
      for (gu $$44 : $$31) {
         ...
         for (ha $$46 : a) {
            ...
            dfa $$48 = $$4.a_($$47);
            if ($$45.b(dfq.C)) {
               $$45 = $$45.a(dfq.C, Boolean.valueOf($$48.u().b()));
            }
