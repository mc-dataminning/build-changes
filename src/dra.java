...
public class dra extends dsv implements dtq {
   ...
   public dra(eag.d $$0) {
      super($$0);
      this.l(this.C.b().b(a, ja.b).b(c, Boolean.valueOf(false)).b(d, Boolean.valueOf(false)));
   }
   ...
   public void d(eah $$0, dja $$1, iu $$2) {
   ...
   public void a(eah $$0, dja $$1, iu $$2, azv $$3) {
      if ($$1.ag() && (long)$$1.A.a(200) <= $$1.ae() % 200L && $$2.v() == $$1.a(egg.a.b, $$2.u(), $$2.w()) - 1) {
         azq.a($$0.c(a).o(), $$1, $$2, 0.125, lx.aW, bto.a(1, 2));
      }
   }
