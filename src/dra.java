...
public class dra {
   ...
   public dra(daz $$0, io $$1, it $$2, boolean $$3) {
      this.b = $$0;
      this.c = $$1;
      this.i = $$2;
      this.d = $$3;
   ...
   public boolean a() {
      this.g.clear();
      this.h.clear();
      drd $$0 = this.b.a_(this.e);
      if (!dqw.a($$0, this.b, this.e, this.f, false, this.i)) {
         if (this.d && $$0.o() == enb.b) {
            this.h.add(this.e);
            return true;
         } else {
   ...
   private static boolean a(drd $$0) {
      return $$0.a(dec.hV) || $$0.a(dec.pg);
   }

   private static boolean a(drd $$0, drd $$1) {
      if ($$0.a(dec.pg) && $$1.a(dec.hV)) {
         return false;
      } else {
         return $$0.a(dec.hV) && $$1.a(dec.pg) ? false : a($$0) || a($$1);
      }
   }
   ...
   private boolean a(io $$0, it $$1) {
      ...
      if ($$2.i()) {
         return true;
      } else if (!dqw.a($$2, this.b, $$0, this.f, false, $$1)) {
         return true;
         ...
         if ($$3 + this.g.size() > 12) {
            ...
            while (a($$2)) {
               ...
               drd $$5 = $$2;
               $$2 = this.b.a_($$4);
               if ($$2.i() || !a($$5, $$2) || !dqw.a($$2, this.b, $$4, this.f, false, this.f.g()) || $$4.equals(this.c)) {
                  break;
               }
            ...
            while (true) {
               ...
               if (!dqw.a($$2, this.b, $$9, this.f, true, this.f) || $$9.equals(this.c)) {
                  return false;
               }
