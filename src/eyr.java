...
public class eyr {
   ...
   public static final eyr.a bv;

   public static eyr.a a(int $$0, int $$1) {
      return $$0 == -1 ? eyr.b.b.a($$1) : eyr.b.a.a($$0);
   }

   public static eyr.a a(String $$0) {
      if (eyr.a.e.containsKey($$0)) {
         return eyr.a.e.get($$0);
      } else {
         for (eyr.b $$1 : eyr.b.values()) {
            if ($$0.startsWith($$1.f)) {
   ...
   public static final class a {
      ...
      private final int c;
      private final ayr<xo> d;
      static final Map<String, eyr.a> e = Maps.newHashMap();

      a(String $$0, eyr.b $$1, int $$2) {
         this.a = $$0;
         this.b = $$1;
         this.c = $$2;
         this.d = new ayr<>(() -> $$1.g.apply($$2, $$0));
         e.put($$0, this);
      }
   ...
   public static enum b {
      ...
      private final Int2ObjectMap<eyr.a> e = new Int2ObjectOpenHashMap();
      final String f;
      final BiFunction<Integer, String, xo> g;

      private static void a(eyr.b $$0, String $$1, int $$2) {
         eyr.a $$3 = new eyr.a($$1, $$0, $$2);
         $$0.e.put($$2, $$3);
      }
      ...
      public eyr.a a(int $$0) {
         return (eyr.a)this.e.computeIfAbsent($$0, $$0x -> {
            int $$1 = $$0x;
            if (this == c) {
               $$1 = $$0x + 1;
            }
