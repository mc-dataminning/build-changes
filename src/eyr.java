...
public class eyr extends eyk {
   ...
   private static final aew b = new aew("textures/misc/vignette.png");
   ...
   private int z;
   private final eth A = new eth(false);

   public eyr(boolean $$0, Runnable $$1) {
      super(eqn.a);
      this.o = $$0;
      this.p = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, eyr.a $$1) {
      try (Reader $$2 = this.f.Z().openAsReader(new aew($$0))) {
         $$1.read($$2);
