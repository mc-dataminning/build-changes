...
public class eyr {
   ...
   private static final Queue<eyr.a> c = EvictingQueue.create(10);
   @Nullable
   private static volatile eyr.a d;
   ...
   public static void a(int $$0, boolean $$1) {
      ...
      if ($$0 > 0) {
         ...
         if ($$2.GL_KHR_debug) {
            ...
            KHRDebug.glDebugMessageCallback(GLX.make(GLDebugMessageCallback.create(eyr::a), eyp::a), 0L);
            ...
            ARBDebugOutput.glDebugMessageCallbackARB(GLX.make(GLDebugMessageARBCallback.create(eyr::a), eyp::a), 0L);
         }
      }
   }
   ...
   static class a {
      ...
      public String toString() {
         return "id=" + this.a + ", source=" + eyr.a(this.b) + ", type=" + eyr.b(this.c) + ", severity=" + eyr.c(this.d) + ", message='" + this.e + "'";
      }
   }
}
