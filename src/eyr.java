...
public class eyr {
   ...
   public eyr(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5) {
      this.a = Math.min($$0, $$3);
      this.b = Math.min($$1, $$4);
      this.c = Math.min($$2, $$5);
      this.d = Math.max($$0, $$3);
   ...
   public eyr(eyw $$0, eyw $$1) {
      this($$0.d, $$0.e, $$0.f, $$1.d, $$1.e, $$1.f);
   }

   public static eyr a(eky $$0) {
      return new eyr((double)$$0.h(), (double)$$0.i(), (double)$$0.j(), (double)($$0.k() + 1), (double)($$0.l() + 1), (double)($$0.m() + 1));
   }

   public static eyr a(eyw $$0) {
      return new eyr($$0.d, $$0.e, $$0.f, $$0.d + 1.0, $$0.e + 1.0, $$0.f + 1.0);
   }

   public static eyr a(jf $$0, jf $$1) {
      return new eyr(
   ...
   public eyr a(double $$0) {
      return new eyr($$0, this.b, this.c, this.d, this.e, this.f);
   }

   public eyr b(double $$0) {
      return new eyr(this.a, $$0, this.c, this.d, this.e, this.f);
   }

   public eyr c(double $$0) {
      return new eyr(this.a, this.b, $$0, this.d, this.e, this.f);
   }

   public eyr d(double $$0) {
      return new eyr(this.a, this.b, this.c, $$0, this.e, this.f);
   }

   public eyr e(double $$0) {
      return new eyr(this.a, this.b, this.c, this.d, $$0, this.f);
   }

   public eyr f(double $$0) {
      return new eyr(this.a, this.b, this.c, this.d, this.e, $$0);
   }
   ...
   public eyr b(double $$0, double $$1, double $$2) {
      double $$3 = this.a;
      double $$4 = this.b;
      double $$5 = this.c;
      double $$6 = this.d;
   ...
   public eyr c(double $$0, double $$1, double $$2) {
      double $$3 = this.a - $$0;
      double $$4 = this.b - $$1;
      double $$5 = this.c - $$2;
      double $$6 = this.d + $$0;
   ...
   public eyr d(double $$0, double $$1, double $$2) {
      return new eyr(this.a + $$0, this.b + $$1, this.c + $$2, this.d + $$0, this.e + $$1, this.f + $$2);
   }
   ...
   public eyr f(double $$0, double $$1, double $$2) {
      return this.c(-$$0, -$$1, -$$2);
   }

   public eyr h(double $$0) {
      return this.g(-$$0);
   }

   public Optional<eyw> b(eyw $$0, eyw $$1) {
      return a(this.a, this.b, this.c, this.d, this.e, this.f, $$0, $$1);
   }

   public static Optional<eyw> a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, eyw $$6, eyw $$7) {
      double[] $$8 = new double[]{1.0};
      double $$9 = $$7.d - $$6.d;
      double $$10 = $$7.e - $$6.e;
      double $$11 = $$7.f - $$6.f;
      jk $$12 = a($$0, $$1, $$2, $$3, $$4, $$5, $$6, $$8, null, $$9, $$10, $$11);
      if ($$12 == null) {
   ...
   @Nullable
   public static eys a(Iterable<eyr> $$0, eyw $$1, eyw $$2, jf $$3) {
      ...
      if ($$5 == null) {
         ...
         double $$10 = $$4[0];
         return new eys($$1.b($$10 * $$6, $$10 * $$7, $$10 * $$8), $$5, $$3, false);
      }
   }

   @Nullable
   private static jk a(eyr $$0, eyw $$1, double[] $$2, @Nullable jk $$3, double $$4, double $$5, double $$6) {
      return a($$0.a, $$0.b, $$0.c, $$0.d, $$0.e, $$0.f, $$1, $$2, $$3, $$4, $$5, $$6);
   }

   @Nullable
   private static jk a(
      double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, eyw $$6, double[] $$7, @Nullable jk $$8, double $$9, double $$10, double $$11
   ) {
      if ($$9 > 1.0E-7) {
         $$8 = a($$7, $$8, $$9, $$10, $$11, $$0, $$1, $$4, $$2, $$5, jk.e, $$6.d, $$6.e, $$6.f);
      } else if ($$9 < -1.0E-7) {
         $$8 = a($$7, $$8, $$9, $$10, $$11, $$3, $$1, $$4, $$2, $$5, jk.f, $$6.d, $$6.e, $$6.f);
      }

      if ($$10 > 1.0E-7) {
         $$8 = a($$7, $$8, $$10, $$11, $$9, $$1, $$2, $$5, $$0, $$3, jk.a, $$6.e, $$6.f, $$6.d);
      } else if ($$10 < -1.0E-7) {
         $$8 = a($$7, $$8, $$10, $$11, $$9, $$4, $$2, $$5, $$0, $$3, jk.b, $$6.e, $$6.f, $$6.d);
      }

      if ($$11 > 1.0E-7) {
         $$8 = a($$7, $$8, $$11, $$9, $$10, $$2, $$0, $$3, $$1, $$4, jk.c, $$6.f, $$6.d, $$6.e);
      } else if ($$11 < -1.0E-7) {
         $$8 = a($$7, $$8, $$11, $$9, $$10, $$5, $$0, $$3, $$1, $$4, jk.d, $$6.f, $$6.d, $$6.e);
      }
   ...
   public eyw f() {
      return new eyw(azf.d(0.5, this.a, this.d), azf.d(0.5, this.b, this.e), azf.d(0.5, this.c, this.f));
   }

   public eyw g() {
      return new eyw(this.a, this.b, this.c);
   }

   public eyw h() {
      return new eyw(this.d, this.e, this.f);
   }

   public static eyr a(eyw $$0, double $$1, double $$2, double $$3) {
      return new eyr($$0.d - $$1 / 2.0, $$0.e - $$2 / 2.0, $$0.f - $$3 / 2.0, $$0.d + $$1 / 2.0, $$0.e + $$2 / 2.0, $$0.f + $$3 / 2.0);
   }
}
