...
public abstract class fih<E extends fih.a<E>> extends fie {
   ...
   private final List<E> p = new fih.b();
   ...
   public fih(fgo $$0, int $$1, int $$2, int $$3, int $$4) {
      super(0, $$3, $$1, $$2, wy.a);
      this.c = $$0;
      this.d = $$4;
   }
   ...
   protected void a(fhz $$0) {
      RenderSystem.enableBlend();
      akr $$1 = this.c.r == null ? fod.g : fod.i;
      akr $$2 = this.c.r == null ? fod.h : fod.j;
   ...
   @Nullable
   protected E a(fmq $$0, Predicate<E> $$1) {
      return this.a($$0, $$1, this.h());
   }

   @Nullable
   protected E a(fmq $$0, Predicate<E> $$1, @Nullable E $$2) {
      int $$3 = switch ($$0) {
         case d, c -> 0;
         case a -> -1;
         case b -> 1;
   ...
   public fmg.a u() {
      if (this.aO_()) {
         ...
         return this.v != null ? fmg.a.b : fmg.a.a;
      }
   }
   ...
   protected void a(fmi $$0, E $$1) {
      List<E> $$2 = this.aK_();
      if ($$2.size() > 1) {
         int $$3 = $$2.indexOf($$1);
         if ($$3 != -1) {
            $$0.a(fmh.b, wz.a("narrator.position.list", $$3 + 1, $$2.size()));
         }
      }
   }

   protected abstract static class a<E extends fih.a<E>> implements fki {
      @Deprecated
      fih<E> a;
      ...
      public abstract void a(fhz var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10);
