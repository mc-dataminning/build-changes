...
public class end {
   ...
   static class b {
      static final Optional<end> a = Optional.ofNullable(a());

      private b() {
      }

      @Nullable
      private static end a() {
         return !GL.getCapabilities().GL_ARB_timer_query ? null : new end();
      }
   }
}
