...
public class gnl {
   ...
   public static gne a(Vector3f $$0, Vector3f $$1, gng $$2, hej $$3, jn $$4, hhb $$5, @Nullable gnh $$6, boolean $$7, int $$8) {
      gni $$9 = $$2.d();
      if ($$5.b()) {
         $$9 = a($$2.d(), $$4, $$5.a());
      }
   ...
   private static int[] a(gni $$0, hej $$1, jn $$2, float[] $$3, j $$4, @Nullable gnh $$5) {
      int[] $$6 = new int[32];
   ...
   private static void a(int[] $$0, int $$1, jn $$2, gni $$3, float[] $$4, hej $$5, j $$6, @Nullable gnh $$7) {
      gll.b $$8 = gll.a($$2).a($$1);
   ...
   private static void a(int[] $$0, int $$1, Vector3f $$2, hej $$3, gni $$4) {
      int $$5 = $$1 * 8;
