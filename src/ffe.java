...
public class ffe implements Comparable<ffe> {
   private static final Map<String, ffe> h = Maps.newHashMap();
   private static final Map<eyu.a, ffe> i = Maps.newHashMap();
   ...
   private final eyu.a m;
   private final String n;
   private eyu.a o;
   private boolean p;
   private int q;

   public static void a(eyu.a $$0) {
      ffe $$1 = i.get($$0);
      if ($$1 != null) {
         $$1.q++;
      }
   ...
   public static void a(eyu.a $$0, boolean $$1) {
      ffe $$2 = i.get($$0);
      if ($$2 != null) {
         $$2.a($$1);
      }
   ...
   public static void a() {
      for (ffe $$0 : h.values()) {
         if ($$0.o.a() == eyu.b.a && $$0.o.b() != eyu.bv.b()) {
            $$0.a(eyu.a(ffg.Q().aO().i(), $$0.o.b()));
         }
      }
   }
   ...
   public ffe(String $$0, int $$1, String $$2) {
      this($$0, eyu.b.a, $$1, $$2);
   }

   public ffe(String $$0, eyu.b $$1, int $$2, String $$3) {
      this.l = $$0;
      this.o = $$1.a($$2);
      this.m = this.o;
      this.n = $$3;
   ...
   public int a(ffe $$0) {
      return this.n.equals($$0.n) ? gqg.a(this.l).compareTo(gqg.a($$0.l)) : k.get(this.n).compareTo(k.get($$0.n));
   }
   ...
   public boolean b(ffe $$0) {
      return this.o.equals($$0.o);
   }

   public boolean j() {
      return this.o.equals(eyu.bv);
   }

   public boolean a(int $$0, int $$1) {
      return $$0 == eyu.bv.b() ? this.o.a() == eyu.b.b && this.o.b() == $$1 : this.o.a() == eyu.b.a && this.o.b() == $$0;
   }

   public boolean a(int $$0) {
      return this.o.a() == eyu.b.c && this.o.b() == $$0;
   }
