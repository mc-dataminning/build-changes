...
public class ffe extends fea<cjg> {
   ...
   private fmx P;
   @Nullable
   private List<Pair<ih<dgm>, clm>> Q;
   private cmy R = cmy.f;
   private cmy S = cmy.f;
   private cmy T = cmy.f;
   private boolean U;
   ...
   protected void aN_() {
      super.aN_();
      this.P = this.f.aP().a(fmw.f).b("flag");
   }
   ...
   protected void a(ewu $$0, float $$1, int $$2, int $$3) {
      ...
      if (this.Q != null && !this.V) {
         ...
         this.P.e = 0.0F;
         this.P.c = -32.0F;
         fvc.a($$0.c(), $$0.d(), 15728880, gee.d, this.P, ggs.f, true, this.Q);
         $$0.c().b();
         $$0.e();
      } else if (this.V) {
   ...
   private void a(ewu $$0, ih<dgm> $$1, int $$2, int $$3) {
      sn $$4 = new sn();
      st $$5 = new dgm.a().a(dgn.a, clm.h).a($$1, clm.a).a();
      $$4.a("Patterns", $$5);
      cmy $$6 = new cmy(cnb.uP);
      ckr.a($$6, dgx.t, $$4);
      eqb $$7 = new eqb();
      $$7.a();
      ...
      this.P.e = 0.0F;
      this.P.c = -32.0F;
      List<Pair<ih<dgm>, clm>> $$9 = dgl.a(clm.h, dgl.a($$6));
      fvc.a($$7, $$0.d(), 15728880, gee.d, this.P, ggs.f, true, $$9);
      $$7.b();
      $$0.e();
   }
   ...
   public boolean a(double $$0, double $$1, double $$2, double $$3) {
      ...
      if (this.U && $$4 > 0) {
         ...
         this.W = auo.a(this.W - $$5, 0.0F, 1.0F);
   ...
   private void I() {
      ...
      if ($$0.b()) {
         ...
         this.Q = dgl.a(((cko)$$0.d()).b(), dgl.a($$0));
      }
      ...
      if (!cmy.a($$1, this.R) || !cmy.a($$2, this.S) || !cmy.a($$3, this.T)) {
