...
public class ffe {
   ...
   public void a(fgw $$0, String $$1, fht.a $$2, eub $$3) {
      if (this.i == null) {
         this.i = new Thread(() -> {
            ...
            try {
               ...
               if ($$5.getStatusLine().getStatusCode() == 200) {
                  ...
                  ffe.b $$13 = new ffe.b($$1.trim(), this.f, $$3, $$2);
                  ffe.a $$14 = new ffe.a($$12);
                  $$14.a($$13);
               ...
               if (!this.d) {
                  if (!$$0.b.isEmpty() && !$$0.c.isEmpty()) {
                     try {
                        ...
                        ffe.c $$30 = new ffe.c(this.f, $$2, $$0);
                        ffe.a $$31 = new ffe.a($$29);
                        $$31.a($$30);
         ...
         this.i.setUncaughtExceptionHandler(new fha(a));
         this.i.start();
      }
   }
   ...
   void a(String $$0, @Nullable File $$1, eub $$2) throws IOException {
      ...
      File $$15 = new File(fke.Q().q.getAbsolutePath(), "saves");
   ...
   class b implements ActionListener {
      ...
      b(final String $$0, final File $$1, final eub $$2, final fht.a $$3) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
         this.e = $$3;
      ...
      public void actionPerformed(ActionEvent $$0) {
         this.e.a = ((ffe.a)$$0.getSource()).getByteCount();
         if (this.e.a >= this.e.b && !ffe.this.b && !ffe.this.d) {
            try {
               ffe.this.e = true;
               ffe.this.a(this.b, this.c, this.d);
            } catch (IOException var3) {
               ffe.a.error("Error extracting archive", var3);
               ffe.this.d = true;
            }
         }
      }
   ...
   class c implements ActionListener {
      ...
      c(final File $$0, final fht.a $$1, final fgw $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      @Override
      public void actionPerformed(ActionEvent $$0) {
         this.c.a = ((ffe.a)$$0.getSource()).getByteCount();
         if (this.c.a >= this.c.b && !ffe.this.b) {
            try {
               String $$1 = Hashing.sha1().hashBytes(Files.toByteArray(this.b)).toString();
               if ($$1.equals(this.d.c)) {
                  FileUtils.copyFile(this.b, ffe.this.g);
                  ffe.this.c = true;
               } else {
                  ffe.a.error("Resourcepack had wrong hash (expected {}, found {}). Deleting it.", this.d.c, $$1);
                  FileUtils.deleteQuietly(this.b);
                  ffe.this.d = true;
               }
            } catch (IOException var3) {
               ffe.a.error("Error copying resourcepack file: {}", var3.getMessage());
               ffe.this.d = true;
            }
         }
      }
