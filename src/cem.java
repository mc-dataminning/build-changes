...
public class cem extends cea {
   ...
   public cem(bxm $$0, double $$1, boolean $$2, int $$3, BooleanSupplier $$4) {
      this.a = $$0;
      this.b = $$1;
      this.e = $$2;
      this.g = $$3;
      ...
      if (!chy.a(this.a)) {
         ...
         if (this.e && this.a.dV().V()) {
            ...
            if (!$$0.a($$1, 6)) {
               ...
               feq $$2 = cia.a(this.a, 15, 7, $$2x -> {
                  if (!$$0.c($$2x)) {
                     return Double.NEGATIVE_INFINITY;
                  } else {
                     Optional<iu> $$3x = $$0.A().d($$0xx -> $$0xx.a(axm.b), this::a, $$2x, 10, cig.b.b);
               ...
               if ($$2 == null) {
                  ...
                  Optional<iu> $$3 = $$0.A().d($$0x -> $$0x.a(axm.b), this::a, iu.a((jo)$$2), 10, cig.b.b);
                  if ($$3.isEmpty()) {
                     return false;
                  } else {
                     this.d = $$3.get().j();
                     ...
                     $$4.b(true);
                     if (this.c == null) {
                        feq $$5 = chx.a(this.a, 10, 7, feq.c(this.d), (float) (Math.PI / 2));
                        if ($$5 == null) {
                           return false;
                        }
