...
public class byz extends bla implements cas {
   private static final Logger bY = LogUtils.getLogger();
   public static final afm<Integer> b = afp.a(byz.class, afo.b);
   private static final bvk bZ = bvk.a().a(64.0);
   ...
   public int d = -1;
   private final byx[] cf;
   public final byx e;
   private final byx cg;
   private final byx ch;
   private final byx ci;
   private final byx cj;
   private final byx ck;
   private final byx cl;
   private final byx cm;
   public float bS;
   public float bT;
   public boolean bU;
   public int bV;
   ...
   private dki cn;
   private ht co = ht.b;
   private final bzq cp;
   private int cq = 100;
   private float cr;
   private final ect[] cs = new ect[24];
   private final int[] ct = new int[24];
   private final ecq cu = new ecq();

   public byz(bkm<? extends byz> $$0, crs $$1) {
      super(bkm.C, $$1);
      this.e = new byx(this, "head", 1.0F, 1.0F);
      this.cg = new byx(this, "neck", 3.0F, 3.0F);
      this.ch = new byx(this, "body", 5.0F, 3.0F);
      this.ci = new byx(this, "tail", 2.0F, 2.0F);
      this.cj = new byx(this, "tail", 2.0F, 2.0F);
      this.ck = new byx(this, "tail", 2.0F, 2.0F);
      this.cl = new byx(this, "wing", 4.0F, 2.0F);
      this.cm = new byx(this, "wing", 4.0F, 2.0F);
      this.cf = new byx[]{this.e, this.cg, this.ch, this.ci, this.cj, this.ck, this.cl, this.cm};
      this.c(this.eL());
      this.af = true;
      this.at = true;
      this.cp = new bzq(this);
   }
   ...
   public static bmd.a t() {
      return bla.A().a(bme.l, 200.0);
   }

   @Override
   public boolean aR() {
      float $$0 = ati.b(this.bT * (float) (Math.PI * 2));
      float $$1 = ati.b(this.bS * (float) (Math.PI * 2));
   ...
   public void aQ() {
      if (this.dL().B && !this.aS()) {
         this.dL().a(this.dq(), this.ds(), this.dw(), aqn.ha, this.da(), 5.0F, 0.8F + this.ag.i() * 0.3F, false);
      }
   }
   ...
   public double[] a(int $$0, float $$1) {
      ...
      double $$5 = this.c[$$2][0];
      double $$6 = ati.d(this.c[$$3][0] - $$5);
      $$4[0] = $$5 + $$6 * (double)$$1;
      $$5 = this.c[$$2][1];
      $$6 = this.c[$$3][1] - $$5;
      $$4[1] = $$5 + $$6 * (double)$$1;
      $$4[2] = ati.d((double)$$1, this.c[$$2][2], this.c[$$3][2]);
      return $$4;
   }
   ...
   public void c_() {
      ...
      if (this.dL().B) {
         ...
         if (!this.aS() && !this.cp.a().a() && --this.cq < 0) {
            this.dL().a(this.dq(), this.ds(), this.dw(), aqn.hb, this.da(), 2.5F, 0.8F + this.ag.i() * 0.3F, false);
            this.cq = 200 + this.ag.a(200);
         }
      }

      if (this.cn == null && this.dL() instanceof ama $$0) {
         dki $$1 = $$0.B();
      ...
      if (this.ev()) {
         ...
         this.dL().a(js.x, this.dq() + (double)$$2, this.ds() + 2.0 + (double)$$3, this.dw() + (double)$$4, 0.0, 0.0, 0.0);
      } else {
         this.ge();
         eji $$5 = this.do();
         ...
         if (this.fU()) {
            ...
            if (this.dL().B) {
               ...
               if ($$9 != null) {
                  ...
                  if ($$15 > 0.0) {
                     $$11 = ati.a($$11 / $$15, (double)(-$$14), (double)$$14);
                  }

                  this.f(this.do().b(0.0, $$11 * 0.01, 0.0));
                  this.r(ati.g(this.dB()));
                  eji $$16 = $$9.a(this.dq(), this.ds(), this.dw()).d();
                  eji $$17 = new eji((double)ati.a(this.dB() * (float) (Math.PI / 180.0)), this.do().d, (double)(-ati.b(this.dB() * (float) (Math.PI / 180.0))))
                     .d();
                  float $$18 = Math.max(((float)$$17.b($$16) + 0.5F) / 1.5F, 0.0F);
                  if (Math.abs($$10) > 1.0E-5F || Math.abs($$12) > 1.0E-5F) {
                     float $$19 = ati.a(ati.g(180.0F - (float)ati.d($$10, $$12) * (180.0F / (float)Math.PI) - this.dB()), -50.0F, 50.0F);
                     this.bW *= 0.8F;
                  ...
                  float $$21 = 0.06F;
                  this.a(0.06F * ($$18 * $$20 + (1.0F - $$20)), new eji(0.0, 0.0, -1.0));
                  if (this.bU) {
                     this.a(ble.a, this.do().a(0.8F));
                  } else {
            ...
            this.aU = this.dB();
            eji[] $$24 = new eji[this.cf.length];

            for (int $$25 = 0; $$25 < this.cf.length; $$25++) {
               $$24[$$25] = new eji(this.cf[$$25].dq(), this.cf[$$25].ds(), this.cf[$$25].dw());
            }
            ...
            if (!this.dL().B && this.aK == 0) {
               this.b(this.dL().a(this, this.cl.cG().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bkl.e));
               this.b(this.dL().a(this, this.cm.cG().c(4.0, 2.0, 4.0).d(0.0, -2.0, 0.0), bkl.e));
               this.c(this.dL().a(this, this.e.cG().g(1.0), bkl.e));
               this.c(this.dL().a(this, this.cg.cG().g(1.0), bkl.e));
            }

            float $$32 = ati.a(this.dB() * (float) (Math.PI / 180.0) - this.bW * 0.01F);
            float $$33 = ati.b(this.dB() * (float) (Math.PI / 180.0) - this.bW * 0.01F);
            float $$34 = this.gd();
   ...
   private void a(byx $$0, double $$1, double $$2, double $$3) {
   ...
   private void ge() {
      ...
      if (this.ag.a(10) == 0) {
         List<byy> $$0 = this.dL().a(byy.class, this.cG().g(32.0));
         byy $$1 = null;
   ...
   private void b(List<bki> $$0) {
      ...
      for (bki $$3 : $$0) {
         if ($$3 instanceof bky) {
            ...
            if (!this.cp.a().a() && ((bky)$$3).eh() < $$3.ah - 2) {
               $$3.a(this.dM().b((bky)this), 5.0F);
               this.a(this, $$3);
            }
         }
      }
   ...
   private void c(List<bki> $$0) {
      for (bki $$1 : $$0) {
         if ($$1 instanceof bky) {
            $$1.a(this.dM().b((bky)this), 10.0F);
            this.a(this, $$1);
         }
      }
   }
      ...
      for (int $$9 = $$1; $$9 <= $$4; $$9++) {
         for (int $$10 = $$2; $$10 <= $$5; $$10++) {
            for (int $$11 = $$3; $$11 <= $$6; $$11++) {
               ...
               dgw $$13 = this.dL().a_($$12);
               if (!$$13.i() && !$$13.a(arc.aC)) {
                  if (this.dL().X().b(cro.c) && !$$13.a(arc.aB)) {
   ...
   public boolean a(byx $$0, bjg $$1, float $$2) {
      if (this.cp.a().i() == bzp.j) {
         return false;
      } else {
         $$2 = this.cp.a().a($$1, $$2);
         if ($$0 != this.e) {
         ...
         if ($$2 < 0.01F) {
            ...
            if ($$1.d() instanceof cdm || $$1.a(are.y)) {
               float $$3 = this.eu();
               this.g($$1, $$2);
   ...
   protected boolean g(bjg $$0, float $$1) {
      return super.a($$0, $$1);
   }
   ...
   protected void ea() {
      ...
      if (this.bV >= 180 && this.bV <= 200) {
         ...
         float $$2 = (this.ag.i() - 0.5F) * 8.0F;
         this.dL().a(js.w, this.dq() + (double)$$0, this.ds() + 2.0 + (double)$$1, this.dw() + (double)$$2, 0.0, 0.0, 0.0);
      }

      boolean $$3 = this.dL().X().b(cro.f);
      int $$4 = 500;
      ...
      if (this.dL() instanceof ama) {
         if (this.bV > 150 && this.bV % 5 == 0 && $$3) {
            bko.a((ama)this.dL(), this.dj(), ati.d((float)$$4 * 0.08F));
         }
      ...
      this.a(ble.a, new eji(0.0, 0.1F, 0.0));
      if (this.bV == 200 && this.dL() instanceof ama) {
         if ($$3) {
            bko.a((ama)this.dL(), this.dj(), ati.d((float)$$4 * 0.2F));
         }
   ...
   public int y() {
      if (this.cs[0] == null) {
         for (int $$0 = 0; $$0 < 24; $$0++) {
            ...
            int $$4;
            if ($$0 < 12) {
               $$3 = ati.d(60.0F * ati.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
               $$4 = ati.d(60.0F * ati.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 12) * (float)$$0)));
            } else if ($$0 < 20) {
               int $$2 = $$0 - 12;
               $$3 = ati.d(40.0F * ati.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$4 = ati.d(40.0F * ati.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 8) * (float)$$2)));
               $$1 += 10;
            } else {
               int var7 = $$0 - 20;
               $$3 = ati.d(20.0F * ati.b(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
               $$4 = ati.d(20.0F * ati.a(2.0F * ((float) -Math.PI + (float) (Math.PI / 4) * (float)var7)));
            }

            int $$9 = Math.max(this.dL().z_() + 10, this.dL().a(dmf.a.f, new ht($$3, 0, $$4)).v() + $$1);
            this.cs[$$0] = new ect($$3, $$9, $$4);
         }
   ...
   public int r(double $$0, double $$1, double $$2) {
      float $$3 = 10000.0F;
      int $$4 = 0;
      ect $$5 = new ect(ati.a($$0), ati.a($$1), ati.a($$2));
      int $$6 = 0;
   ...
   @Nullable
   public ecv a(int $$0, int $$1, @Nullable ect $$2) {
      for (int $$3 = 0; $$3 < 24; $$3++) {
         ect $$4 = this.cs[$$3];
         $$4.i = false;
         $$4.g = 0.0F;
   ...
   private ecv a(ect $$0, ect $$1) {
      List<ect> $$2 = Lists.newArrayList();
      ect $$3 = $$1;
      $$2.add(0, $$1);
      ...
      return new ecv($$2, new ht($$1.a, $$1.b, $$1.c), true);
   }
   ...
   public void a(rz $$0) {
      super.a($$0);
      if ($$0.e("DragonPhase")) {
         this.cp.a(bzp.a($$0.h("DragonPhase")));
      }
   ...
   public float a(int $$0, double[] $$1, double[] $$2) {
      bzj $$3 = this.cp.a();
      bzp<? extends bzj> $$4 = $$3.i();
      double $$7;
      if ($$4 == bzp.d || $$4 == bzp.e) {
         ht $$5 = this.dL().a(dmf.a.f, dpi.a(this.co));
   ...
   public eji D(float $$0) {
      bzj $$1 = this.cp.a();
      bzp<? extends bzj> $$2 = $$1.i();
      eji $$8;
      if ($$2 == bzp.d || $$2 == bzp.e) {
         ht $$3 = this.dL().a(dmf.a.f, dpi.a(this.co));
   ...
   public void a(byy $$0, ht $$1, bjg $$2) {
      cdm $$3;
      if ($$2.d() instanceof cdm) {
         $$3 = (cdm)$$2.d();
      } else {
