      ...
      if (!this.e().a($$0.q().G())) {
         ...
         if ($$1 == null) {
            ...
            if ($$2 == null) {
               ...
               dai $$8 = $$7.w();
               $$4.a($$5, $$3, this.a($$7), ape.e, ($$8.a() + 1.0F) / 2.0F, $$8.b() * 0.8F);
   ...
   public void a(byn $$0) {
      if (this.c instanceof czu) {
         ...
         if ($$2 != null && $$2.b("Items", 9)) {
            rc $$3 = $$2.c("Items", 10);
            cjh.a($$0, $$3.stream().map(qw.class::cast).map(cjf::a));
         }
      }
   }

   @Nullable
   public static qw a(cjf $$0) {
      return $$0.b("BlockEntityTag");
   }

   public static void a(cjf $$0, dcx<?> $$1, qw $$2) {
      if ($$2.g()) {
         $$0.c("BlockEntityTag");
      } else {
         dcv.a($$2, $$1);
