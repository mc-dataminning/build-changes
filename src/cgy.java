...
public class cgy extends chl implements buc, buh {
   ...
   public static final akk<Boolean> cc = ako.a(cgy.class, akm.k);
   public static final akk<Long> cd = ako.a(cgy.class, akm.c);
   public final bsr ce = new bsr();
   public final bsr cf = new bsr();
   public final bsr cg = new bsr();
   public final bsr ch = new bsr();
   public final bsr ci = new bsr();
   private static final bsz cH = bsz.b(btc.o.l(), btc.o.m() - 1.43F).b(0.845F);
   private int cI = 0;
   private int cJ = 0;

   public cgy(btc<? extends cgy> $$0, dca $$1) {
      super($$0, $$1);
      this.bP = new cgy.c();
      this.bO = new cgy.b();
      cdc $$2 = (cdc)this.K();
   ...
   public static buy.a s() {
      return gP().a(buz.q, 32.0).a(buz.r, 0.09F).a(buz.m, 0.42F).a(buz.v, 1.5);
   }
   ...
   @Override
   public bsz e(bud $$0) {
      return $$0 == bud.k ? cH.a(this.ed()) : super.e($$0);
   }
   ...
   protected float e(cmz $$0) {
      ...
      return (float)this.g(buz.r) + $$1;
   }

   @Override
   protected evs j(btr $$0) {
      return this.u() ? new evs(this.dH(), this.dF()) : super.j($$0);
   }

   @Override
   protected evt b(cmz $$0, evt $$1) {
      return this.u() ? evt.b : super.b($$0, $$1);
   }
   ...
   protected void b(float $$0, evt $$1) {
      ...
      this.i(this.bL().d(1.0, 0.0, 1.0).d().a((double)(22.2222F * $$0) * this.g(buz.r) * (double)this.aN()).b(0.0, (double)(1.4285F * $$0) * $$2, 0.0));
      this.cI = 55;
      this.w(true);
      this.av = true;
   }
   ...
   public boolean gq() {
      return this.g(this.gy() ? bud.a : bud.k);
   }
   ...
   public boolean a(cfh $$0) {
      if ($$0 != this && $$0 instanceof cgy $$1 && this.gX() && $$1.gX()) {
         return true;
      }
   ...
   @Nullable
   public cgy b(arf $$0, bsq $$1) {
      return btc.o.a((dca)$$0);
   }
   ...
   protected evt a(bsw $$0, bsz $$1, float $$2) {
      ...
      return new evt(0.0, (double)$$6, (double)($$5 * $$2)).b(-this.dF() * (float) (Math.PI / 180.0));
   }
   ...
   private double a(boolean $$0, float $$1, bsz $$2, float $$3) {
   ...
   public evt p(float $$0) {
      bsz $$1 = this.a(this.ar());
      float $$2 = this.ed();
      return new evt(0.0, this.a(true, $$0, $$1, $$2) - (double)(0.2F * $$2), (double)($$1.a() * 0.56F));
   }
   ...
   @Override
   protected bzn E() {
      return new cgy.a(this);
   }

   class a extends bzn {
      public a(final cgy $$0) {
         super($$0);
      }
   ...
   class c extends bzs {
      ...
      @Override
      public void a() {
         if (this.k == bzs.a.b && !cgy.this.gd() && cgy.this.gy() && !cgy.this.gA() && cgy.this.gq()) {
            cgy.this.gC();
         }
