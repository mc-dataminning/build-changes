...
public class fnj extends fne {
   ...
   public fnj(boolean $$0) {
      this($$0, null);
   }

   public fnj(boolean $$0, @Nullable fhw $$1) {
      super(b);
      this.x = $$0;
      this.A = Objects.requireNonNullElseGet($$1, () -> new fhw(false));
   }
   ...
   public static CompletableFuture<Void> a(gpb $$0, Executor $$1) {
      return CompletableFuture.allOf($$0.a(fhw.a, $$1), $$0.a(fhw.c, $$1), $$0.a(gdr.a, $$1), e.a($$0, $$1));
   }
   ...
   protected void aM_() {
      ...
      fik $$4 = this.c(fhj.a(20, $$0x -> this.m.a(new fmn(this, this.m.m, this.m.ag())), true));
      $$4.c(this.n / 2 - 124, $$3 + 72 + 12);
      this.c(fhf.a(xp.c("menu.options"), $$0x -> this.m.a(new fmv(this, this.m.m))).a(this.n / 2 - 100, $$3 + 72 + 12, 98, 20).a());
      this.c(fhf.a(xp.c("menu.quit"), $$0x -> this.m.q()).a(this.n / 2 + 2, $$3 + 72 + 12, 98, 20).a());
      fik $$5 = this.c(fhj.b(20, $$0x -> this.m.a(new flp(this, this.m.m)), true));
      $$5.c(this.n / 2 + 104, $$3 + 72 + 12);
      this.c(new fid($$1, this.o - 10, $$0, 10, c, $$0x -> this.m.a(new fma(this)), this.p));
      if (this.v == null) {
         this.v = new fcy();
      }
   ...
   private void a(int $$0, int $$1) {
      this.c(fhf.a(xp.c("menu.singleplayer"), $$0x -> this.m.a(new frz(this))).a(this.n / 2 - 100, $$0, 200, 20).a());
      xp $$2 = this.E();
      boolean $$3 = $$2 == null;
      fiq $$4 = $$2 != null ? fiq.a($$2) : null;
      this.c(fhf.a(xp.c("menu.multiplayer"), $$0x -> {
         fne $$1x = (fne)(this.m.m.v ? new fqc(this) : new fqd(this));
         this.m.a($$1x);
      }).a(this.n / 2 - 100, $$0 + $$1 * 1, 200, 20).a($$4).a()).j = $$3;
      this.c(fhf.a(xp.c("menu.online"), $$0x -> this.m.a(new fak(this))).a(this.n / 2 - 100, $$0 + $$1 * 2, 200, 20).a($$4).a()).j = $$3;
   }
   ...
   private void b(int $$0, int $$1) {
      boolean $$2 = this.F();
      this.c(fhf.a(xp.c("menu.playdemo"), $$1x -> {
         if ($$2) {
            this.m.x().a("Demo_World", () -> this.m.a(this));
         } else {
            this.m.x().a("Demo_World", MinecraftServer.d, dyt.b, eib::a, this);
         }
   ...
   private boolean F() {
      try {
         boolean var2;
         try (epx.c $$0 = this.m.m().e("Demo_World")) {
            var2 = $$0.m();
         }
   ...
   private void c(boolean $$0) {
      if ($$0) {
         try (epx.c $$1 = this.m.m().e("Demo_World")) {
            $$1.k();
         } catch (IOException var7) {
            fjn.b(this.m, "Demo_World");
   ...
   static record a(fgq a, fhy b, int c, int d) {
      public void a(fgs $$0, int $$1) {
