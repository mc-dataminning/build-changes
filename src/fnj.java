...
public class fnj extends fnb {
   ...
   private int F;
   private final fht G = new fht(false);

   public fnj(boolean $$0, Runnable $$1) {
      super(fev.a);
      this.v = $$0;
      this.w = $$1;
      if (!$$0) {
   ...
   private void a(String $$0, fnj.a $$1) {
