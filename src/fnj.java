...
public class fnj {
   ...
   private fnj(String $$0, @Nullable String[] $$1) {
      this.c = $$0;
      this.d = $$1;
   }
   ...
   public xa a() {
      if (!hmi.a(this.c)) {
         ...
         return this.d == null ? xa.c(this.c) : xa.a(this.c, this.d);
      }
   }

   public static fnj a(JsonObject $$0) {
      String $$1 = fpp.a("translationKey", $$0);
