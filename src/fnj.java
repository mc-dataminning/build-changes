...
public class fnj {
   ...
   public static class b extends fow {
      b(fkw $$0, double $$1, double $$2, double $$3) {
         super($$0, $$1, $$2, $$3);
         this.t = 4;
      }
      ...
      public float b(float $$0) {
         return 7.1F * ati.a(((float)this.s + $$0 - 1.0F) * 0.25F * (float) Math.PI);
      }
   }

   static class c extends foh {
      private boolean b;
      private boolean F;
      private final fnx G;
      private float H;
      ...
      c(fkw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fnx $$7, foq $$8) {
      ...
      public void a() {
         ...
         if (this.b && this.s < this.t / 2 && (this.s + this.t) % 2 == 0) {
            fnj.c $$0 = new fnj.c(this.c, this.g, this.h, this.i, 0.0, 0.0, 0.0, this.G, this.a);
            $$0.e(0.99F);
   ...
   public static class d implements fny<jv> {
      ...
      public fnv a(jv $$0, fkw $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         fnj.c $$8 = new fnj.c($$1, $$2, $$3, $$4, $$5, $$6, $$7, esr.N().g, this.a);
         $$8.e(0.99F);
         return $$8;
      }
   }

   public static class e extends fnt {
      private int a;
      private final fnx b;
      private sf D;
      private boolean E;

      public e(fkw $$0, double $$1, double $$2, double $$3, double $$4, double $$5, double $$6, fnx $$7, @Nullable rz $$8) {
         super($$0, $$1, $$2, $$3);
         this.j = $$4;
         this.k = $$5;
         this.l = $$6;
      ...
      public void a() {
         if (this.a == 0 && this.D != null) {
            ...
            this.c.a(this.g, this.h, this.i, $$4, aqo.i, 20.0F, 0.95F + this.r.i() * 0.1F, true);
         }

         if (this.a % 2 == 0 && this.D != null && this.a / 2 < this.D.size()) {
            int $$6 = this.a / 2;
            rz $$7 = this.D.a($$6);
            ckf.a $$8 = ckf.a.a($$7.f("Type"));
            boolean $$9 = $$7.q("Trail");
            ...
            fnv $$17 = this.b.a(js.J, this.g, this.h, this.i, 0.0, 0.0, 0.0);
            $$17.a($$14, $$15, $$16);
         }
         ...
         if (this.a > this.t) {
            if (this.E) {
               boolean $$18 = this.c();
               aqm $$19 = $$18 ? aqn.hP : aqn.hO;
               this.c.a(this.g, this.h, this.i, $$19, aqo.i, 20.0F, 0.9F + this.r.i() * 0.15F, true);
            }
      ...
      private void a(double $$0, double $$1, double $$2, double $$3, double $$4, double $$5, int[] $$6, int[] $$7, boolean $$8, boolean $$9) {
         fnj.c $$10 = (fnj.c)this.b.a(js.A, $$0, $$1, $$2, $$3, $$4, $$5);
         $$10.a($$8);
         $$10.b($$9);
         $$10.e(0.99F);
         ...
         for (int $$11 = 0; $$11 < 3; $$11++) {
            ...
            for (int $$15 = 1; $$15 < $$1.length; $$15++) {
               ...
               for (double $$18 = 0.25; $$18 <= 1.0; $$18 += 0.25) {
                  double $$19 = ati.d($$18, $$13, $$16) * $$0;
                  double $$20 = ati.d($$18, $$14, $$17) * $$0;
