...
public class fnj extends fnu {
   ...
   private static List<ProfileResult> a(JsonArray $$0) {
      ...
      MinecraftSessionService $$2 = frf.Q().am();

      for (JsonElement $$3 : $$0) {
         if ($$3.isJsonObject()) {
            UUID $$4 = fpr.a("playerId", $$3.getAsJsonObject(), null);
            if ($$4 != null && !frf.Q().b($$4)) {
               try {
