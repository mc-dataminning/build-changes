...
public class fyt implements fyw.a, AutoCloseable {
   ...
   ekl[] f;
   @Nullable
   private final fyt.a g;
   private final anr h;

   public fyt(aeu $$0, gam $$1, ekl $$2, anr $$3) {
      this.b = $$0;
      this.c = $$1.a();
      this.d = $$1.b();
      this.h = $$3;
      gak $$4 = $$3.a(gak.a).orElse(gak.e);
      this.g = this.a($$1, $$2.a(), $$2.b(), $$4);
      this.e = $$2;
      this.f = new ekl[]{this.e};
   }

   public void a(int $$0) {
      try {
         this.f = fyo.a(this.f, $$0);
   ...
   @Nullable
   private fyt.a a(gam $$0, int $$1, int $$2, gak $$3) {
      int $$4 = $$1 / $$0.a();
      int $$5 = $$2 / $$0.b();
      int $$6 = $$4 * $$5;
      List<fyt.b> $$7 = new ArrayList<>();
      $$3.a(($$1x, $$2x) -> $$7.add(new fyt.b($$1x, $$2x)));
      if ($$7.isEmpty()) {
         for (int $$8 = 0; $$8 < $$6; $$8++) {
            $$7.add(new fyt.b($$8, $$3.a()));
         }
      } else {
         int $$9 = 0;
         IntSet $$10 = new IntOpenHashSet();

         for (Iterator<fyt.b> $$11 = $$7.iterator(); $$11.hasNext(); $$9++) {
            fyt.b $$12 = $$11.next();
            boolean $$13 = true;
            if ($$12.b <= 0) {
      ...
      return $$7.size() <= 1 ? null : new fyt.a(ImmutableList.copyOf($$7), $$4, $$3.b());
   }

   void a(int $$0, int $$1, int $$2, int $$3, ekl[] $$4) {
   ...
   class a {
      ...
      a(List<fyt.b> $$0, int $$1, boolean $$2) {
         this.b = $$0;
         this.c = $$1;
         this.d = $$2;
      }
      ...
      void a(int $$0, int $$1, int $$2) {
         int $$3 = this.a($$2) * fyt.this.c;
         int $$4 = this.b($$2) * fyt.this.d;
         fyt.this.a($$0, $$1, $$3, $$4, fyt.this.f);
      }

      public fyv a() {
         return fyt.this.new d(this, this.d ? fyt.this.new c() : null);
      }
   ...
   final class c implements AutoCloseable {
      private final ekl[] b = new ekl[fyt.this.f.length];

      c() {
         for (int $$0 = 0; $$0 < this.b.length; $$0++) {
            int $$1 = fyt.this.c >> $$0;
            int $$2 = fyt.this.d >> $$0;
            this.b[$$0] = new ekl($$1, $$2, false);
         }
      }

      void a(int $$0, int $$1, fyt.d $$2) {
         fyt.a $$3 = $$2.d;
         List<fyt.b> $$4 = $$3.b;
         fyt.b $$5 = $$4.get($$2.b);
         ...
         if ($$7 != $$8) {
            ...
            fyt.this.a($$0, $$1, 0, 0, this.b);
         }
      }

      private int a(fyt.a $$0, int $$1, int $$2, int $$3, int $$4) {
         return fyt.this.f[$$2].a($$3 + ($$0.a($$1) * fyt.this.c >> $$2), $$4 + ($$0.b($$1) * fyt.this.d >> $$2));
      }
   ...
   class d implements fyv {
      int b;
      int c;
      final fyt.a d;
      @Nullable
      private final fyt.c e;

      d(fyt.a $$0, @Nullable fyt.c $$1) {
         this.d = $$0;
         this.e = $$1;
      }
