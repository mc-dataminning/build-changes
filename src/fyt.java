...
public class fyt extends fuk {
   ...
   protected void aR_() {
      ...
      this.c(fos.a(wo.k, $$0 -> this.aO_()).a(this.n / 2 - 155, this.o - 32, 150, 20).a());
      this.u = this.c(fos.a(wo.d, $$0 -> {
   ...
   public class a extends fpo<fyt.a.b> implements fys.a {
      ...
      public a(final fli $$1, final int $$2) {
      ...
      public class d extends fyt.a.b {
         ...
         @Nullable
         private final flc.a j;
         @Nullable
         private final List<ayl> k;
         private final boolean l;
         private final boolean m;

         public d(final int $$1, final wp $$2, final wp $$3, @Nullable final flc $$4, final boolean $$5, final boolean $$6) {
            this.f = $$1;
            this.j = x.a($$4, flc::f);
            this.k = $$4 != null && $$4.g() != null ? fyt.this.p.c($$4.g(), a.this.a()) : null;
            this.l = $$5;
            this.m = $$6;
            wu $$7 = fyt.this.p.a($$2, this.e() - fyt.this.p.a(wo.u));
            if ($$2 != $$7) {
               this.g = wu.a($$7, wo.u);
