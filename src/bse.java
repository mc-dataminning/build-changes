...
public class bse extends bsj {
   public static final MapCodec<bse> a = RecordCodecBuilder.mapCodec(
         $$0 -> $$0.group(
   ...
   public static bse a(float $$0, float $$1, int $$2, int $$3) {
      return new bse($$0, $$1, $$2, $$3);
   }

   private bse(float $$0, float $$1, int $$2, int $$3) {
      this.b = $$0;
      this.f = $$1;
      this.g = $$2;
      this.h = $$3;
