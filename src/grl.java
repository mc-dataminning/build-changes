...
public class grl extends grp<cku, gxt> {
   ...
   private static final glv j = glv.g(h);
   private static final glv k = glv.m(h);
   private static final glv l = glv.q(i);
   private static final glv m = glv.l(a);
   ...
   public grl(grq.a $$0) {
      super($$0);
      this.f = 0.5F;
      this.o = new gei($$0.a(gen.aG));
   }

   public void a(gxt $$0, fgs $$1, gll $$2, int $$3) {
      $$1.a();
      float $$4 = $$0.a(7).b();
      ...
      if ($$0.b > 0.0F) {
         ...
         fgw $$8 = $$2.getBuffer(glv.p(b));
         this.o.a($$1, $$8, $$3, hbc.d, $$7);
         fgw $$9 = $$2.getBuffer(k);
         this.o.a($$1, $$9, $$3, hbc.a(0.0F, $$0.c));
      } else {
         fgw $$10 = $$2.getBuffer(j);
         this.o.a($$1, $$10, $$3, hbc.a(0.0F, $$0.c));
      }

      fgw $$11 = $$2.getBuffer(l);
      this.o.a($$1, $$11, $$3, hbc.d);
      if ($$0.b > 0.0F) {
         float $$12 = $$0.b / 200.0F;
         $$1.a();
         $$1.a(0.0F, -1.0F, -2.0F);
         a($$1, $$12, $$2.getBuffer(glv.q()));
         a($$1, $$12, $$2.getBuffer(glv.r()));
         $$1.b();
      }
   ...
   private static void a(fgs $$0, float $$1, fgw $$2) {
      $$0.a();
   ...
   public static void a(float $$0, float $$1, float $$2, float $$3, fgs $$4, gll $$5, int $$6) {
      ...
      for (int $$17 = 1; $$17 <= 8; $$17++) {
         ...
         $$9.a($$16, $$13 * 0.2F, $$14 * 0.2F, 0.0F).a(-16777216).a($$15, $$10).b(hbc.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$13, $$14, $$8).a(-1).a($$15, $$11).b(hbc.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$18, $$19, $$8).a(-1).a($$20, $$11).b(hbc.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$9.a($$16, $$18 * 0.2F, $$19 * 0.2F, 0.0F).a(-16777216).a($$20, $$10).b(hbc.d).c($$6).b($$16, 0.0F, -1.0F, 0.0F);
         $$13 = $$18;
         $$14 = $$19;
         $$15 = $$20;
      }
   ...
   public void a(cku $$0, gxt $$1, float $$2) {
      super.a($$0, $$1, $$2);
      ...
      ckt $$3 = $$0.cc;
      if ($$3 != null) {
         fby $$4 = $$3.o($$2).b(0.0, (double)grk.a((float)$$3.a + $$2), 0.0);
         $$1.d = $$4.d($$0.o($$2));
      } else {
         $$1.d = null;
      }
      ...
      $$1.e = $$5 == clk.d || $$5 == clk.e;
      $$1.f = $$5.a();
      jh $$6 = $$0.dW().a(edq.a.f, egv.a($$0.m()));
      $$1.g = $$6.b($$0.du());
      $$1.h = $$0.eF() ? 0.0F : $$2;
      $$1.i.a($$0.b);
   }

   protected boolean a(cku $$0) {
      return false;
   }
}
