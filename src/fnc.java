...
public class fnc extends fnd {
   ...
   private final fhy C;
   private final fhy D;
   private final epw.c E;

   public fnc(fff $$0, BooleanConsumer $$1, epw.c $$2) {
      super(c);
      this.z = $$1;
      this.B = xp.a("recover_world.message", xp.b($$2.f()).a(n.h));
      this.C = new fhy(this.B, $$0.h);
      this.E = $$2;
      Exception $$3 = this.a($$2, false);
      Exception $$4 = this.a($$2, true);
      xp $$5 = xp.i().b(this.a($$2, false, $$3)).f("\n").b(this.a($$2, true, $$4));
      this.D = new fhy($$5, $$0.h);
      boolean $$6 = $$3 != null && $$4 == null;
      this.A.c().b();
      this.A.a(new fil(this.l, $$0.h));
      this.A.a(this.C.b(true));
      this.A.a(this.D);
      fkv $$7 = fkv.e().a(5);
      $$7.a(fhe.a(d, flu.b(this, "https://aka.ms/snapshotbugs?ref=game")).b(120, 20).a());
      $$7.a(fhe.a(r, $$1x -> this.a($$0)).b(120, 20).a($$6 ? null : fip.a(s)).a()).j = $$6;
      this.A.a($$7);
      this.A.a(fhe.a(xo.k, $$0x -> this.d()).b(120, 20).a());
      this.A.a(this::c);
   }
   ...
   private void a(fff $$0) {
      ...
      if ($$1 != null && $$2 == null) {
         $$0.d(new fmj(xp.c("recover_world.restoring")));
         fru.a(this.E);
         if (this.E.n()) {
            $$0.a(new flv(this.z, u, v, xo.j, xo.k));
         } else {
            $$0.a(new flp(() -> this.z.accept(false), u, w));
         }
      } else {
         a.error(
   ...
   private xp a(epw.c $$0, boolean $$1, @Nullable Exception $$2) {
      if ($$1 && $$2 instanceof FileNotFoundException) {
         return xp.i();
      } else {
         yd $$3 = xp.i();
         Instant $$4 = $$0.a($$1);
         yd $$5 = $$4 != null ? xp.b(fsd.a.format($$4)) : xp.c("recover_world.state_entry.unknown");
   ...
   @Nullable
   private Exception a(epw.c $$0, boolean $$1) {
      try {
         if (!$$1) {
            $$0.a($$0.h());
         } else {
