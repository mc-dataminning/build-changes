...
public class fnc extends fnd {
   ...
   private final fig C;
   private final fig D;
   private final eqc.c E;

   public fnc(ffn $$0, BooleanConsumer $$1, eqc.c $$2) {
      super(c);
      this.z = $$1;
      this.B = wu.a("recover_world.message", wu.b($$2.f()).a(n.h));
      this.C = new fig(this.B, $$0.h);
      this.E = $$2;
      Exception $$3 = this.a($$2, false);
      Exception $$4 = this.a($$2, true);
      wu $$5 = wu.i().b(this.a($$2, false, $$3)).f("\n").b(this.a($$2, true, $$4));
      this.D = new fig($$5, $$0.h);
      boolean $$6 = $$3 != null && $$4 == null;
      this.A.c().b();
      this.A.a(new fit(this.k, $$0.h));
      this.A.a(this.C.b(true));
      this.A.a(this.D);
      fld $$7 = fld.e().a(5);
      $$7.a(fhm.a(q, fma.b(this, "https://aka.ms/snapshotbugs?ref=game")).b(120, 20).a());
      $$7.a(fhm.a(r, $$1x -> this.a($$0)).b(120, 20).a($$6 ? null : fix.a(s)).a()).j = $$6;
      this.A.a($$7);
      this.A.a(fhm.a(wt.k, $$0x -> this.d()).b(120, 20).a());
      this.A.a(this::c);
   }
   ...
   private void a(ffn $$0) {
      ...
      if ($$1 != null && $$2 == null) {
         $$0.d(new fmo(wu.c("recover_world.restoring")));
         fsc.a(this.E);
         if (this.E.n()) {
            $$0.a(new fmb(this.z, u, v, wt.j, wt.k));
         } else {
            $$0.a(new flw(() -> this.z.accept(false), u, w));
         }
      } else {
         a.error(
   ...
   private wu a(eqc.c $$0, boolean $$1, @Nullable Exception $$2) {
      if ($$1 && $$2 instanceof FileNotFoundException) {
         return wu.i();
      } else {
         xi $$3 = wu.i();
         Instant $$4 = $$0.a($$1);
         xi $$5 = $$4 != null ? wu.b(fsl.a.format($$4)) : wu.c("recover_world.state_entry.unknown");
   ...
   @Nullable
   private Exception a(eqc.c $$0, boolean $$1) {
      try {
         if (!$$1) {
            $$0.a($$0.h());
         } else {
