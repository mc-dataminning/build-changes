...
public class fnc extends fmz {
   ...
   public final fit cn;
   private final apr cE;
   private final eqc cF;
   private final List<gbs> cG = Lists.newArrayList();
   private int cH = 0;
   private double cI;
   private double cJ;
   private double cK;
   ...
   public fnc(eqp $$0, fis $$1, fit $$2, apr $$3, eqc $$4, boolean $$5, boolean $$6) {
      super($$1, $$2.q());
      this.cp = $$0;
      this.cn = $$2;
      this.cE = $$3;
      ...
      this.cP = $$5;
      this.cQ = $$6;
      this.cG.add(new gck(this, $$0.ai()));
      this.cG.add(new gbx(this));
      this.cG.add(new gbw(this, $$0.ai(), $$1.E_()));
   }
   ...
   public boolean a(biw $$0, boolean $$1) {
      if (!super.a($$0, $$1)) {
         ...
         if ($$0 instanceof cdr) {
            this.cp.ai().a((gci)(new gcc(this, (cdr)$$0, true)));
            this.cp.ai().a((gci)(new gcc(this, (cdr)$$0, false)));
         }
   ...
   private void B() {
      ...
      if (this.v()) {
         ...
         this.cR++;
         boolean $$7 = asb.f($$2, $$3, $$4) > asb.k(2.0E-4) || this.cR >= 20;
   ...
   protected void h() {
      this.cn.b(new acg(this, acg.a.f, asb.d(this.t() * 100.0F)));
   }
   ...
   private boolean i(gw $$0) {
      ehc $$1 = this.cG();
      ehc $$2 = new ehc((double)$$0.u(), $$1.b, (double)$$0.w(), (double)$$0.u() + 1.0, $$1.e, (double)$$0.w() + 1.0).h(1.0E-7);
   ...
   @Override
   public bhd fo() {
      return Objects.requireNonNullElse(this.cW, bhd.a);
   }
   ...
   public void a(aef<?> $$0) {
      ...
      if (t.equals($$0)) {
         ...
         bhd $$2 = (this.an.b(t) & 2) > 0 ? bhd.b : bhd.a;
         if ($$1 && !this.cV) {
            this.c($$2);
         } else if (!$$1 && this.cV) {
            this.ft();
      ...
      if (ao.equals($$0) && this.fw() && !this.da) {
         this.cp.ai().a((gci)(new gby(this)));
      }
   }

   @Nullable
   public bjx s() {
      if (this.cZ() instanceof bjx $$0 && $$0.a()) {
         return $$0;
      }
   ...
   public void a(deh $$0, boolean $$1) {
      if ($$0 instanceof ddv $$2) {
         this.cp.a(new ezz($$2, $$1, this.cp.aQ()));
      } else {
         this.cp.a(new fam($$0, $$1, this.cp.aQ()));
      }
   }
   ...
   public void b_() {
      ...
      boolean $$1 = this.co.h;
      boolean $$2 = this.K();
      this.cO = !this.fT().b && !this.bY() && !this.bN() && this.g(bjy.f) && (this.bR() || !this.fD() && !this.g(bjy.a));
      float $$3 = asb.a(0.3F + cnw.b(this), 0.0F, 1.0F);
      this.co.a(this.u(), $$3);
      ...
      if (this.co.g && !$$10 && !$$0 && !this.fT().b && !this.bN() && !this.c_()) {
         cjl $$11 = this.c(bjb.e);
         if ($$11.a(cjo.nh) && cif.d($$11) && this.fX()) {
      ...
      if (this.a(aqa.a)) {
         int $$12 = this.M_() ? 10 : 1;
         this.db = asb.a(this.db + $$12, 0, 600);
      } else if (this.db > 0) {
         this.a(aqa.a);
         this.db = asb.a(this.db - 10, 0, 600);
      }
   ...
   private void E() {
      ...
      float $$0 = 0.0F;
      if (this.av) {
         if (this.cp.y != null && !this.cp.y.j() && !(this.cp.y instanceof exe)) {
            if (this.cp.y instanceof ezd) {
               this.q();
            }
         ...
         if (this.cv == 0.0F) {
            this.cp.ai().a(gcd.b(apg.sW, this.ag.i() * 0.4F + 0.8F, 0.25F));
         }

         $$0 = 0.0125F;
         this.av = false;
      } else if (this.a(bil.i) && !this.b(bil.i).a(60)) {
         $$0 = 0.006666667F;
      } else if (this.cv > 0.0F) {
         $$0 = -0.05F;
      }

      this.cv = asb.a(this.cv + $$0, 0.0F, 1.0F);
      this.J();
   }
   ...
   protected void f(float $$0, float $$1) {
      if (this.F()) {
         ehh $$2 = this.dj();
         ehh $$3 = $$2.b((double)$$0, 0.0, (double)$$1);
         ehh $$4 = new ehh((double)$$0, 0.0, (double)$$1);
         float $$5 = this.fe();
         float $$6 = (float)$$4.g();
         if ($$6 <= 0.001F) {
            ehg $$7 = this.co.a();
            ...
            $$4 = new ehh((double)($$8 * $$11 - $$9 * $$10), $$4.d, (double)($$9 * $$11 + $$8 * $$10));
            $$6 = (float)$$4.g();
            if ($$6 <= 0.001F) {
               return;
            }
         ...
         float $$12 = asb.i($$6);
         ehh $$13 = $$4.a((double)$$12);
         ehh $$14 = this.bG();
         float $$15 = (float)($$14.c * $$13.c + $$14.e * $$13.e);
         if (!($$15 < -0.15F)) {
            ehm $$16 = ehm.a(this);
            gw $$17 = gw.a(this.dq(), this.cG().e, this.dw());
            dfd $$18 = this.dL().a_($$17);
            if ($$18.b(this.dL(), $$17, $$16).c()) {
               $$17 = $$17.c();
               dfd $$19 = this.dL().a_($$17);
               if ($$19.b(this.dL(), $$17, $$16).c()) {
                  float $$20 = 7.0F;
                  float $$21 = 1.2F;
                  if (this.a(bil.h)) {
                     $$21 += (float)(this.b(bil.h).e() + 1) * 0.75F;
                  }

                  float $$22 = Math.max($$5 * 7.0F, 1.0F / $$12);
                  ehh $$24 = $$3.e($$13.a((double)$$22));
                  float $$25 = this.df();
                  float $$26 = this.dg();
                  ehc $$27 = new ehc($$2, $$24.b(0.0, (double)$$26, 0.0)).c((double)$$25, 0.0, (double)$$25);
                  ehh $$23 = $$2.b(0.0, 0.51F, 0.0);
                  $$24 = $$24.b(0.0, 0.51F, 0.0);
                  ehh $$28 = $$13.c(new ehh(0.0, 1.0, 0.0));
                  ehh $$29 = $$28.a((double)($$25 * 0.5F));
                  ehh $$30 = $$23.d($$29);
                  ehh $$31 = $$24.d($$29);
                  ehh $$32 = $$23.e($$29);
                  ehh $$33 = $$24.e($$29);
                  Iterable<eia> $$34 = this.dL().d(this, $$27);
                  Iterator<ehc> $$35 = StreamSupport.stream($$34.spliterator(), false).flatMap($$0x -> $$0x.e().stream()).iterator();
   ...
   protected boolean b(ehh $$0) {
      ...
      double $$2 = (double)asb.a($$1);
      double $$3 = (double)asb.b($$1);
      double $$4 = (double)this.bk * $$3 - (double)this.bm * $$2;
      double $$5 = (double)this.bm * $$3 + (double)this.bk * $$2;
      double $$6 = asb.k($$4) + asb.k($$5);
      double $$7 = asb.k($$0.c) + asb.k($$0.e);
   ...
   private boolean I() {
      return !this.bX() && this.K() && this.L() && !this.fn() && !this.a(bil.o) && (!this.bN() || this.c(this.cY())) && !this.fw();
   }

   private boolean c(biw $$0) {
      return $$0.dE() && $$0.cW();
   }
   ...
   public float A() {
      if (!this.a(aqa.a)) {
         ...
         if ((float)this.db >= 600.0F) {
            ...
            float $$2 = asb.a((float)this.db / 100.0F, 0.0F, 1.0F);
            float $$3 = (float)this.db < 100.0F ? 0.0F : asb.a(((float)this.db - 100.0F) / 500.0F, 0.0F, 1.0F);
   ...
   protected boolean fL() {
      ...
      if (this.M_()) {
         ...
         if (!$$0 && $$1) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apg.x, aph.i, 1.0F, 1.0F, false);
            this.cp.ai().a((gci)(new gcl.b(this)));
         }

         if ($$0 && !$$1) {
            this.dL().a(this.dq(), this.ds(), this.dw(), apg.y, aph.i, 1.0F, 1.0F, false);
         }
   ...
   public ehh q(float $$0) {
      if (this.cp.m.aw().a()) {
         float $$1 = asb.i($$0 * 0.5F, this.dB(), this.N) * (float) (Math.PI / 180.0);
         float $$2 = asb.i($$0 * 0.5F, this.dD(), this.O) * (float) (Math.PI / 180.0);
         double $$3 = this.fm() == bjg.b ? -1.0 : 1.0;
         ehh $$4 = new ehh(0.39 * $$3, -0.6, 0.3);
