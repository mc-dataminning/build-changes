...
public class fnc {
   private static final fno a = fno.r(new aep("textures/map/map_background.png"));
   private static final fno b = fno.r(new aep("textures/map/map_background_checkerboard.png"));
   ...
   private final eqn au;
   private ciw av = ciw.b;
   private ciw aw = ciw.b;
   private float ax;
   private float ay;
   private float az;
   private float aA;
   private final fsh aB;
   private final fth aC;

   public fnc(eqn $$0, fsh $$1, fth $$2) {
      this.au = $$0;
      this.aB = $$1;
      this.aC = $$2;
   }

   public void a(biw $$0, ciw $$1, cit $$2, boolean $$3, elh $$4, fng $$5, int $$6) {
      if (!$$1.b()) {
         this.aC.a($$0, $$1, $$2, $$3, $$4, $$5, $$0.dK(), $$6, fxx.d, $$0.ah() + $$2.ordinal());
      }
   }
   ...
   private float a(float $$0) {
      ...
      $$1 = aro.a($$1, 0.0F, 1.0F);
      return -aro.b($$1 * (float) Math.PI) * 0.5F + 0.5F;
   }

   private void a(elh $$0, fng $$1, int $$2, biq $$3) {
      fxj $$4 = (fxj)this.aB.<fmf>a(this.au.t);
      $$0.a();
      float $$5 = $$3 == biq.b ? 1.0F : -1.0F;
   ...
   private void a(elh $$0, fng $$1, int $$2, float $$3, biq $$4, float $$5, ciw $$6) {
      float $$7 = $$4 == biq.b ? 1.0F : -1.0F;
      ...
      float $$8 = aro.c($$5);
      float $$9 = aro.a($$8 * (float) Math.PI);
      float $$10 = -0.5F * $$9;
      float $$11 = 0.4F * aro.a($$8 * (float) (Math.PI * 2));
      float $$12 = -0.3F * aro.a($$5 * (float) Math.PI);
   ...
   private void a(elh $$0, fng $$1, int $$2, float $$3, float $$4, float $$5) {
      float $$6 = aro.c($$5);
      float $$7 = -0.2F * aro.a($$5 * (float) Math.PI);
      float $$8 = -0.4F * aro.a($$6 * (float) Math.PI);
      $$0.a(0.0F, -$$7 / 2.0F, $$8);
      float $$9 = this.a($$3);
      ...
      float $$10 = aro.a($$6 * (float) Math.PI);
      $$0.a(a.b.rotationDegrees($$10 * 20.0F));
      $$0.b(2.0F, 2.0F, 2.0F);
      this.a($$0, $$1, $$2, this.av);
   }

   private void a(elh $$0, fng $$1, int $$2, ciw $$3) {
      ...
      Integer $$4 = cjd.d($$3);
      ebl $$5 = cjd.a($$4, this.au.s);
      ell $$6 = $$1.getBuffer($$5 == null ? a : b);
      Matrix4f $$7 = $$0.c().a();
   ...
   private void a(elh $$0, fng $$1, int $$2, float $$3, float $$4, biq $$5) {
      boolean $$6 = $$5 != biq.a;
      float $$7 = $$6 ? 1.0F : -1.0F;
      float $$8 = aro.c($$4);
      float $$9 = -0.3F * aro.a($$8 * (float) Math.PI);
      float $$10 = 0.4F * aro.a($$8 * (float) (Math.PI * 2));
      float $$11 = -0.4F * aro.a($$4 * (float) Math.PI);
      $$0.a($$7 * ($$9 + 0.64000005F), $$10 + -0.6F + $$3 * -0.6F, $$11 + -0.71999997F);
      $$0.a(a.d.rotationDegrees($$7 * 45.0F));
      float $$12 = aro.a($$4 * $$4 * (float) Math.PI);
      float $$13 = aro.a($$8 * (float) Math.PI);
   ...
   private void a(elh $$0, float $$1, biq $$2, ciw $$3) {
      float $$4 = (float)this.au.t.fo() - $$1 + 1.0F;
      float $$5 = $$4 / (float)$$3.r();
      if ($$5 < 0.8F) {
         float $$6 = aro.e(aro.b($$4 / 4.0F * (float) Math.PI) * 0.1F);
         $$0.a(0.0F, $$6, 0.0F);
      }
   ...
   private void a(elh $$0, float $$1, biq $$2, ciw $$3, float $$4) {
      this.b($$0, $$2, $$4);
      float $$5 = (float)(this.au.t.fo() % 10);
      float $$6 = $$5 - $$1 + 1.0F;
      ...
      float $$11 = -15.0F;
      int $$12 = 2;
      float $$13 = -15.0F + 75.0F * aro.b($$7 * 2.0F * (float) Math.PI);
      if ($$2 != biq.b) {
         $$0.a(0.1, 0.83, 0.35);
   ...
   private void a(elh $$0, biq $$1, float $$2) {
      int $$3 = $$1 == biq.b ? 1 : -1;
      float $$4 = aro.a($$2 * $$2 * (float) Math.PI);
      $$0.a(a.d.rotationDegrees((float)$$3 * (45.0F + $$4 * -20.0F)));
      float $$5 = aro.a(aro.c($$2) * (float) Math.PI);
      $$0.a(a.f.rotationDegrees((float)$$3 * $$5 * -20.0F));
      $$0.a(a.b.rotationDegrees($$5 * -80.0F));
      $$0.a(a.d.rotationDegrees((float)$$3 * -45.0F));
   }

   private void b(elh $$0, biq $$1, float $$2) {
      int $$3 = $$1 == biq.b ? 1 : -1;
      $$0.a((float)$$3 * 0.56F, -0.52F + $$2 * -0.6F, -0.72F);
   }

   public void a(float $$0, elh $$1, fng.a $$2, fmi $$3, int $$4) {
      float $$5 = $$3.x($$0);
      bgn $$6 = (bgn)MoreObjects.firstNonNull($$3.aG, bgn.a);
      float $$7 = aro.i($$0, $$3.O, $$3.dC());
      fnc.a $$8 = a($$3);
      float $$9 = aro.i($$0, $$3.cs, $$3.cq);
      float $$10 = aro.i($$0, $$3.cr, $$3.cp);
      $$1.a(a.b.rotationDegrees(($$3.g($$0) - $$9) * 0.1F));
      $$1.a(a.d.rotationDegrees(($$3.h($$0) - $$10) * 0.1F));
      if ($$8.d) {
         float $$11 = $$6 == bgn.a ? $$5 : 0.0F;
         float $$12 = 1.0F - aro.i($$0, this.ay, this.ax);
         this.a($$3, $$0, $$7, bgn.a, $$11, this.av, $$12, $$1, $$2, $$4);
      }

      if ($$8.e) {
         float $$13 = $$6 == bgn.b ? $$5 : 0.0F;
         float $$14 = 1.0F - aro.i($$0, this.aA, this.az);
         this.a($$3, $$0, $$7, bgn.b, $$13, this.aw, $$14, $$1, $$2, $$4);
      }
   ...
   @VisibleForTesting
   static fnc.a a(fmi $$0) {
      ciw $$1 = $$0.eR();
      ciw $$2 = $$0.eS();
      boolean $$3 = $$1.a(ciz.nG) || $$2.a(ciz.nG);
      boolean $$4 = $$1.a(ciz.uZ) || $$2.a(ciz.uZ);
      if (!$$3 && !$$4) {
         return fnc.a.a;
      } else if ($$0.fl()) {
         return b($$0);
      } else {
         return a($$1) ? fnc.a.b : fnc.a.a;
      }
   }

   private static fnc.a b(fmi $$0) {
      ciw $$1 = $$0.fn();
      bgn $$2 = $$0.fm();
      if (!$$1.a(ciz.nG) && !$$1.a(ciz.uZ)) {
         return $$2 == bgn.a && a($$0.eS()) ? fnc.a.b : fnc.a.a;
      } else {
         return fnc.a.a($$2);
      }
   }
   ...
   private static boolean a(ciw $$0) {
      return $$0.a(ciz.uZ) && che.d($$0);
   }

   private void a(fmf $$0, float $$1, float $$2, bgn $$3, float $$4, ciw $$5, float $$6, elh $$7, fng $$8, int $$9) {
      if (!$$0.go()) {
         boolean $$10 = $$3 == bgn.a;
         biq $$11 = $$10 ? $$0.fk() : $$0.fk().e();
         $$7.a();
         if ($$5.b()) {
            if ($$10 && !$$0.cd()) {
               this.a($$7, $$8, $$9, $$6, $$4, $$11);
            ...
            if ($$0.fl() && $$0.fo() > 0 && $$0.fm() == $$3) {
               ...
               float $$15 = (float)$$5.r() - ((float)this.au.t.fo() - $$1 + 1.0F);
               float $$16 = $$15 / (float)che.k($$5);
               if ($$16 > 1.0F) {
                  $$16 = 1.0F;
               }

               if ($$16 > 0.1F) {
                  float $$17 = aro.a(($$15 - 0.1F) * 1.3F);
                  float $$18 = $$16 - 0.1F;
                  float $$19 = $$17 * $$18;
               ...
               float $$20 = -0.4F * aro.a(aro.c($$4) * (float) Math.PI);
               float $$21 = 0.2F * aro.a(aro.c($$4) * (float) (Math.PI * 2));
               float $$22 = -0.2F * aro.a($$4 * (float) Math.PI);
            ...
            this.a($$0, $$5, $$13 ? cit.e : cit.d, !$$13, $$7, $$8, $$9);
         } else {
            boolean $$23 = $$11 == biq.b;
            if ($$0.fl() && $$0.fo() > 0 && $$0.fm() == $$3) {
               int $$24 = $$23 ? 1 : -1;
               switch ($$5.s()) {
                  ...
                  case e:
                     ...
                     float $$25 = (float)$$5.r() - ((float)this.au.t.fo() - $$1 + 1.0F);
                     float $$26 = $$25 / 20.0F;
                  ...
                  case f:
                     ...
                     $$7.a(a.d.rotationDegrees((float)$$24 * 35.3F));
                     $$7.a(a.f.rotationDegrees((float)$$24 * -9.785F));
                     float $$30 = (float)$$5.r() - ((float)this.au.t.fo() - $$1 + 1.0F);
                     float $$31 = $$30 / 10.0F;
                     if ($$31 > 1.0F) {
                        $$31 = 1.0F;
                     }
               ...
               float $$36 = -0.4F * aro.a(aro.c($$4) * (float) Math.PI);
               float $$37 = 0.2F * aro.a(aro.c($$4) * (float) (Math.PI * 2));
               float $$38 = -0.2F * aro.a($$4 * (float) Math.PI);
               int $$39 = $$23 ? 1 : -1;
            ...
            this.a($$0, $$5, $$23 ? cit.e : cit.d, !$$23, $$7, $$8, $$9);
         }
   ...
   public void a() {
      ...
      if ($$0.x()) {
         this.ax = aro.a(this.ax - 0.4F, 0.0F, 1.0F);
         this.az = aro.a(this.az - 0.4F, 0.0F, 1.0F);
      } else {
         float $$3 = $$0.B(1.0F);
         this.ax = this.ax + aro.a((this.av == $$1 ? $$3 * $$3 * $$3 : 0.0F) - this.ax, -0.4F, 0.4F);
         this.az = this.az + aro.a((float)(this.aw == $$2 ? 1 : 0) - this.az, -0.4F, 0.4F);
      }
