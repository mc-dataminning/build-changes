...
public class brk implements brl {
   ...
   private static final brk k = new brk();
   @Nullable
   Recording l;
   private float m;
   ...
   public boolean a(brj $$0) {
      URL $$1 = brk.class.getResource("/flightrecorder-config.jfc");
      if ($$1 == null) {
   ...
   private boolean a(Reader $$0, brj $$1) {
      if (this.c()) {
   ...
   private void f() {
      FlightRecorder.addListener(new FlightRecorderListener() {
         final brn a = new brn(() -> brk.this.l = null);

         @Override
         public void recordingStateChanged(Recording $$0) {
            if ($$0 == brk.this.l && $$0.getState() == RecordingState.STOPPED) {
