...
public class brk {
   ...
   private final List<bri> d = Lists.newArrayList();
   private final btp e;
   private int f;
   private int g;
   private int h;
   ...
   public void a(brn $$0, float $$1) {
      this.c();
      brs $$2 = brs.a(this.e);
      bri $$3 = new bri($$0, $$1, $$2, this.e.ac);
      this.d.add($$3);
      this.f = this.e.ai;
      this.j = true;
   ...
   private static boolean a(brn $$0) {
      return $$0.d() instanceof btp;
   }

   private xp a(bsu $$0, xp $$1, String $$2, String $$3) {
      cup $$5 = $$0 instanceof btp $$4 ? $$4.eX() : cup.l;
      return !$$5.e() && $$5.b(km.g) ? xp.a($$2, this.e.O_(), $$1, $$5.G()) : xp.a($$3, this.e.O_(), $$1);
   }

   private xp a(bri $$0, @Nullable bsu $$1) {
      brn $$2 = $$0.a();
      if (!$$2.a(awr.n) && !$$2.a(awr.t)) {
         ...
         brs $$3 = Objects.requireNonNullElse($$0.c(), brs.a);
         return xp.a($$3.a(), this.e.O_());
      }
   }

   @Nullable
   private static xp a(@Nullable bsu $$0) {
   ...
   public xp a() {
      if (this.d.isEmpty()) {
         ...
         bri $$0 = this.d.get(this.d.size() - 1);
         brn $$1 = $$0.a();
         bri $$2 = this.d();
         brr $$3 = $$1.j().e();
         if ($$3 == brr.b && $$2 != null) {
