...
public class brk {
   ...
   private static void a(brs $$0, JsonObject $$1) {
      $$1.addProperty("protocolId", $$0.b());
      $$1.addProperty("packetId", $$0.c());
   }

   private static void a(brn $$0, JsonObject $$1) {
   ...
   private JsonElement a(List<brt> $$0) {
      JsonObject $$1 = new JsonObject();
      brx<brt> $$2 = brx.a($$0);
      JsonArray $$3 = new JsonArray();
      $$1.add("structure", $$3);
      $$0.stream().collect(Collectors.groupingBy(brt::c)).forEach(($$3x, $$4) -> {
         JsonObject $$5 = new JsonObject();
         $$3.add($$5);
         $$5.addProperty("name", $$3x);
         brx<brt> $$6 = brx.a((List<brt>)$$4);
         ...
         Function<brt, JsonElement> $$8 = $$0xx -> {
   ...
   private JsonElement c(List<brv> $$0) {
      if ($$0.isEmpty()) {
         ...
         Map<Integer, Double> $$4 = bqz.a($$2);
         $$4.forEach(($$1x, $$2x) -> $$1.addProperty("p" + $$1x, $$2x));
         return $$1;
      }
   }

   private JsonElement b(bri $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("write", this.a($$0.o()));
      $$1.add("read", this.a($$0.p()));
      $$1.add("chunksRead", this.a($$0.n(), brk::a));
      $$1.add("chunksWritten", this.a($$0.m(), brk::a));
      return $$1;
   }

   private JsonElement a(brp.a $$0) {
      JsonObject $$1 = new JsonObject();
   ...
   private JsonElement c(bri $$0) {
      JsonObject $$1 = new JsonObject();
      $$1.add("sent", this.a($$0.l(), brk::a));
      $$1.add("received", this.a($$0.k(), brk::a));
      return $$1;
   }

   private <T> JsonElement a(brr<T> $$0, BiConsumer<T, JsonObject> $$1) {
   ...
   private JsonElement d(List<bro> $$0) {
      JsonObject $$1 = new JsonObject();
      BiFunction<List<bro>, ToDoubleFunction<bro>, JsonObject> $$2 = ($$0x, $$1x) -> {
         JsonObject $$2x = new JsonObject();
      ...
      $$1.add("jvm", (JsonElement)$$2.apply($$0, bro::a));
      $$1.add("userJvm", (JsonElement)$$2.apply($$0, bro::b));
      $$1.add("system", (JsonElement)$$2.apply($$0, bro::c));
      return $$1;
   }
}
