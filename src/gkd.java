...
public class gkd extends gkg {
   gkd(gfy $$0, gkb $$1, double $$2, double $$3, double $$4) {
      super($$0, $$2, $$3 - 0.125, $$4);
      this.b(0.01F, 0.01F);
      this.a($$1);
   ...
   gkd(gfy $$0, gkb $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
   ...
   public static class a implements gjj<lx> {
      ...
      public gjg a(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         gkd $$12 = new gkd($$1, this.a, $$2, $$3, $$4, $$9, $$10, $$11);
         $$12.a(0.9F, 0.4F, 0.5F);
         return $$12;
      }
   }
   ...
   public static class b implements gjj<lx> {
      ...
      public gjg a(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         gkd $$8 = new gkd($$1, this.a, $$2, $$3, $$4, 0.0, -0.8F, 0.0) {
            @Override
   ...
   public static class d implements gjj<lx> {
      ...
      public gjg a(lx $$0, gfy $$1, double $$2, double $$3, double $$4, double $$5, double $$6, double $$7) {
         ...
         gkd $$9 = new gkd($$1, this.a, $$2, $$3, $$4, 0.0, $$8, 0.0);
         $$9.a(0.1F, 0.1F, 0.3F);
         $$9.b(0.001F, 0.001F);
         return $$9;
      }
