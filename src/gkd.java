public class gkd<T extends cou> extends gix<T> {
   private static final alf f = new alf("textures/entity/minecart.png");
   protected final fub<T> a;
   private final gej g;

   public gkd(giy.a $$0, fwz $$1) {
      super($$0);
      this.d = 0.7F;
      this.a = new fuw<>($$0.a($$1));
      this.g = $$0.c();
   }
   ...
   public void a(T $$0, float $$1, float $$2, ezz $$3, gdp $$4, int $$5) {
      ...
      if ($$14 != null) {
         evs $$16 = $$0.a($$10, $$11, $$12, 0.3F);
         evs $$17 = $$0.a($$10, $$11, $$12, -0.3F);
         if ($$16 == null) {
            $$16 = $$14;
         }
      ...
      fad $$24 = $$4.getBuffer(this.a.a(this.a($$0)));
      this.a.a($$3, $$24, $$5, gor.d, 1.0F, 1.0F, 1.0F, 1.0F);
      $$3.b();
   }
   ...
   protected void a(T $$0, float $$1, dsd $$2, ezz $$3, gdp $$4, int $$5) {
      this.g.a($$2, $$3, $$4, $$5, gor.d);
   }
}
