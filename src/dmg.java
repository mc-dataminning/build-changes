...
public class dmg extends dmp {
   ...
   private boolean c(dwx $$0, ard $$1, ji $$2, azh $$3) {
      if (!$$1.G_().j()) {
         return false;
   ...
   protected void a(dwx $$0, dgi $$1, ji $$2, bul $$3) {
      if (!$$1.B_() && $$1.am() != bsh.a && $$3 instanceof cgz $$4 && cgz.c($$0) && !$$4.b(bts.s)) {
         $$4.a(this.b());
      }
   }
   ...
   @Override
   public btq b() {
      return new btq(bts.s, 25);
   }

   public static enum a {
      a(true, bts.o, 11.0F, awa.jd, awa.je, 16545810),
      b(false, bts.i, 7.0F, awa.jf, awa.jg, 6250335);
      ...
      private a(final boolean $$0, final jr<bto> $$1, final float $$2, final avz $$3, final avz $$4, final int $$5) {
         this.c = $$0;
         this.d = $$1;
         this.e = $$2;
         this.f = $$3;
