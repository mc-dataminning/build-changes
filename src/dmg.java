...
public class dmg implements dmc, AutoCloseable {
   private static final Logger a = LogUtils.getLogger();
   private final AtomicBoolean b = new AtomicBoolean();
   private final bit<biv.b> c;
   private final dmj d;
   private final Map<csv, dmg.a> e = Maps.newLinkedHashMap();
   private final Long2ObjectLinkedOpenHashMap<CompletableFuture<BitSet>> f = new Long2ObjectLinkedOpenHashMap();
   private static final int g = 1024;

   protected dmg(Path $$0, boolean $$1, String $$2) {
      this.d = new dmj($$0, $$1);
      this.c = new bit<>(new biv.a(dmg.b.values().length), ac.g(), "IOWorker-" + $$2);
   }

   public boolean a(csv $$0, int $$1) {
      csv $$2 = new csv($$0.e - $$1, $$0.f - $$1);
      csv $$3 = new csv($$0.e + $$1, $$0.f + $$1);
   ...
   private CompletableFuture<BitSet> b(int $$0, int $$1) {
      return CompletableFuture.supplyAsync(() -> {
         ...
         csv $$3 = csv.b($$0, $$1);
         BitSet $$4 = new BitSet();
         csv.a($$2, $$3).forEach($$1xx -> {
            tr $$2x = new tr(new tt(ss.a, "DataVersion"), new tt(sn.b, "blending_data"));
            ...
            if ($$2x.d() instanceof sn $$5 && this.a($$5)) {
   ...
   public CompletableFuture<Void> a(csv $$0, @Nullable sn $$1) {
      return this.a(() -> {
         dmg.a $$2 = this.e.computeIfAbsent($$0, $$1xx -> new dmg.a($$1));
         $$2.a = $$1;
         return Either.left($$2.b);
      }).thenCompose(Function.identity());
   }

   public CompletableFuture<Optional<sn>> a(csv $$0) {
      return this.a(() -> {
         dmg.a $$1 = this.e.get($$0);
         if ($$1 != null) {
   ...
   @Override
   public CompletableFuture<Void> a(csv $$0, th $$1) {
      return this.a(() -> {
         try {
            dmg.a $$2 = this.e.get($$0);
            if ($$2 != null) {
               if ($$2.a != null) {
                  $$2.a.b($$1);
               }
   ...
   private <T> CompletableFuture<T> a(Supplier<Either<T, Exception>> $$0) {
      return this.c.c($$1 -> new biv.b(dmg.b.a.ordinal(), () -> {
            if (!this.b.get()) {
               $$1.a($$0.get());
            }
   ...
   private void a() {
      if (!this.e.isEmpty()) {
         Iterator<Entry<csv, dmg.a>> $$0 = this.e.entrySet().iterator();
         Entry<csv, dmg.a> $$1 = $$0.next();
         $$0.remove();
   ...
   private void b() {
      this.c.a(new biv.b(dmg.b.b.ordinal(), this::a));
   }

   private void a(csv $$0, dmg.a $$1) {
      try {
         this.d.a($$0, $$1.a);
         $$1.b.complete(null);
      } catch (Exception var4) {
   ...
   public void close() throws IOException {
      if (this.b.compareAndSet(false, true)) {
         this.c.b($$0 -> new biv.b(dmg.b.c.ordinal(), () -> $$0.a(avr.a))).join();
         this.c.close();
